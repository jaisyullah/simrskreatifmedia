  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbdetailstockopname" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbdetailstockopname_form();
	}

  // ---------- Validate namaitem_
  function do_ajax_form_tbdetailstockopname_validate_namaitem_(iNumLinha)
  {
  } // do_ajax_form_tbdetailstockopname_validate_namaitem_

  function do_ajax_form_tbdetailstockopname_validate_namaitem__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdetailstockopname_validate_namaitem__cb

  // ---------- Validate lokasi_depo_
  function do_ajax_form_tbdetailstockopname_validate_lokasi_depo_(iNumLinha)
  {
    var nomeCampo_lokasi_depo_ = "lokasi_depo_" + iNumLinha;
    var var_lokasi_depo_ = scAjaxGetFieldSelect(nomeCampo_lokasi_depo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdetailstockopname_validate_lokasi_depo_(var_lokasi_depo_, iNumLinha, var_script_case_init, do_ajax_form_tbdetailstockopname_validate_lokasi_depo__cb);
  } // do_ajax_form_tbdetailstockopname_validate_lokasi_depo_

  function do_ajax_form_tbdetailstockopname_validate_lokasi_depo__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "lokasi_depo_" + iLineNumber;
    }
    else
    {
      sFieldValid = "lokasi_depo_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "lokasi_depo_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "lokasi_depo_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdetailstockopname_validate_lokasi_depo__cb

  // ---------- Validate exp_date_
  function do_ajax_form_tbdetailstockopname_validate_exp_date_(iNumLinha)
  {
  } // do_ajax_form_tbdetailstockopname_validate_exp_date_

  function do_ajax_form_tbdetailstockopname_validate_exp_date__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "exp_date_" + iLineNumber;
    }
    else
    {
      sFieldValid = "exp_date_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "exp_date_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "exp_date_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdetailstockopname_validate_exp_date__cb

  // ---------- Validate stokawal_
  function do_ajax_form_tbdetailstockopname_validate_stokawal_(iNumLinha)
  {
    var nomeCampo_stokawal_ = "stokawal_" + iNumLinha;
    var var_stokawal_ = scAjaxGetFieldSelect(nomeCampo_stokawal_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdetailstockopname_validate_stokawal_(var_stokawal_, iNumLinha, var_script_case_init, do_ajax_form_tbdetailstockopname_validate_stokawal__cb);
  } // do_ajax_form_tbdetailstockopname_validate_stokawal_

  function do_ajax_form_tbdetailstockopname_validate_stokawal__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "stokawal_" + iLineNumber;
    }
    else
    {
      sFieldValid = "stokawal_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "stokawal_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "stokawal_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdetailstockopname_validate_stokawal__cb

  // ---------- Validate stokkoreksi_
  function do_ajax_form_tbdetailstockopname_validate_stokkoreksi_(iNumLinha)
  {
    var nomeCampo_stokkoreksi_ = "stokkoreksi_" + iNumLinha;
    var var_stokkoreksi_ = scAjaxGetFieldText(nomeCampo_stokkoreksi_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdetailstockopname_validate_stokkoreksi_(var_stokkoreksi_, iNumLinha, var_script_case_init, do_ajax_form_tbdetailstockopname_validate_stokkoreksi__cb);
  } // do_ajax_form_tbdetailstockopname_validate_stokkoreksi_

  function do_ajax_form_tbdetailstockopname_validate_stokkoreksi__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "stokkoreksi_" + iLineNumber;
    }
    else
    {
      sFieldValid = "stokkoreksi_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "stokkoreksi_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "stokkoreksi_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdetailstockopname_validate_stokkoreksi__cb

  // ---------- Validate stokakhir_
  function do_ajax_form_tbdetailstockopname_validate_stokakhir_(iNumLinha)
  {
    var nomeCampo_stokakhir_ = "stokakhir_" + iNumLinha;
    var var_stokakhir_ = scAjaxGetFieldText(nomeCampo_stokakhir_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdetailstockopname_validate_stokakhir_(var_stokakhir_, iNumLinha, var_script_case_init, do_ajax_form_tbdetailstockopname_validate_stokakhir__cb);
  } // do_ajax_form_tbdetailstockopname_validate_stokakhir_

  function do_ajax_form_tbdetailstockopname_validate_stokakhir__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "stokakhir_" + iLineNumber;
    }
    else
    {
      sFieldValid = "stokakhir_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "stokakhir_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "stokakhir_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdetailstockopname_validate_stokakhir__cb

  // ---------- Validate keterangan_
  function do_ajax_form_tbdetailstockopname_validate_keterangan_(iNumLinha)
  {
    var nomeCampo_keterangan_ = "keterangan_" + iNumLinha;
    var var_keterangan_ = scAjaxGetFieldText(nomeCampo_keterangan_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdetailstockopname_validate_keterangan_(var_keterangan_, iNumLinha, var_script_case_init, do_ajax_form_tbdetailstockopname_validate_keterangan__cb);
  } // do_ajax_form_tbdetailstockopname_validate_keterangan_

  function do_ajax_form_tbdetailstockopname_validate_keterangan__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdetailstockopname_validate_keterangan__cb

  // ---------- Validate id_
  function do_ajax_form_tbdetailstockopname_validate_id_(iNumLinha)
  {
    var nomeCampo_id_ = "id_" + iNumLinha;
    var var_id_ = scAjaxGetFieldHidden(nomeCampo_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdetailstockopname_validate_id_(var_id_, iNumLinha, var_script_case_init, do_ajax_form_tbdetailstockopname_validate_id__cb);
  } // do_ajax_form_tbdetailstockopname_validate_id_

  function do_ajax_form_tbdetailstockopname_validate_id__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdetailstockopname_validate_id__cb

  // ---------- Refresh namaitem_
  function do_ajax_form_tbdetailstockopname_refresh_namaitem_(iSeqForm)
  {
    var var_namaitem_ = scAjaxGetFieldText("namaitem_" + iSeqForm);
    var var_nmgp_refresh_row = iSeqForm;
    var var_nmgp_refresh_fields = "lokasi_depo_";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tbdetailstockopname_refresh_namaitem_(var_namaitem_, var_nmgp_refresh_row, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_tbdetailstockopname_refresh_namaitem__cb);
  } // do_ajax_form_tbdetailstockopname_refresh_namaitem_

  function do_ajax_form_tbdetailstockopname_refresh_namaitem__cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetVariables();
    do_ajax_form_tbdetailstockopname_refresh_lokasi_depo_();
    scAjaxShowDebug();
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdetailstockopname_refresh_namaitem__cb

  // ---------- Refresh lokasi_depo_
  function do_ajax_form_tbdetailstockopname_refresh_lokasi_depo_(iSeqForm)
  {
    var var_lokasi_depo_ = scAjaxGetFieldSelect("lokasi_depo_" + iSeqForm);
    var var_namaitem_ = scAjaxGetFieldText("namaitem_" + iSeqForm);
    var var_nmgp_refresh_row = iSeqForm;
    var var_nmgp_refresh_fields = "exp_date_";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tbdetailstockopname_refresh_lokasi_depo_(var_lokasi_depo_, var_namaitem_, var_nmgp_refresh_row, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_tbdetailstockopname_refresh_lokasi_depo__cb);
  } // do_ajax_form_tbdetailstockopname_refresh_lokasi_depo_

  function do_ajax_form_tbdetailstockopname_refresh_lokasi_depo__cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    scAjaxSetFields(false);
    scAjaxSetVariables();
    do_ajax_form_tbdetailstockopname_refresh_exp_date_();
    scAjaxShowDebug();
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdetailstockopname_refresh_lokasi_depo__cb

  // ---------- Refresh exp_date_
  function do_ajax_form_tbdetailstockopname_refresh_exp_date_(iSeqForm)
  {
    var var_exp_date_ = scAjaxGetFieldText("exp_date_" + iSeqForm);
    var var_namaitem_ = scAjaxGetFieldText("namaitem_" + iSeqForm);
    var var_lokasi_depo_ = scAjaxGetFieldSelect("lokasi_depo_" + iSeqForm);
    var var_nmgp_refresh_row = iSeqForm;
    var var_nmgp_refresh_fields = "stokawal_";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tbdetailstockopname_refresh_exp_date_(var_exp_date_, var_namaitem_, var_lokasi_depo_, var_nmgp_refresh_row, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_tbdetailstockopname_refresh_exp_date__cb);
  } // do_ajax_form_tbdetailstockopname_refresh_exp_date_

  function do_ajax_form_tbdetailstockopname_refresh_exp_date__cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdetailstockopname_refresh_exp_date__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_tbdetailstockopname_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_tbdetailstockopname_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tbdetailstockopname_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_tbdetailstockopname_add_new_line_cb);
  } // do_ajax_form_tbdetailstockopname_add_new_line

  function do_ajax_form_tbdetailstockopname_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
    ...
    nm_field_disabled("stokkoreksi_=disabled", "", iAjaxNewLine);
  } // do_ajax_form_tbdetailstockopname_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_tbdetailstockopname_backup_line(iNumLinha)
  {
    var var_id_ = scAjaxGetFieldHidden("id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdetailstockopname_backup_line(var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_tbdetailstockopname_backup_line_cb);
  } // do_ajax_form_tbdetailstockopname_backup_line

  function do_ajax_form_tbdetailstockopname_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_tbdetailstockopname_backup_line_cb

  function do_ajax_form_tbdetailstockopname_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_tbdetailstockopname_cancel_insert

  function do_ajax_form_tbdetailstockopname_cancel_update(iSeqVert)
  {
    do_ajax_form_tbdetailstockopname_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_tbdetailstockopname_cancel_update

  function do_ajax_form_tbdetailstockopname_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_tbdetailstockopname_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_tbdetailstockopname_table_refresh()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tbdetailstockopname_table_refresh(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbdetailstockopname_table_refresh_cb);
  } //  do_ajax_form_tbdetailstockopname_table_refresh

  function do_ajax_form_tbdetailstockopname_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_tbdetailstockopname_table_refresh_cb_after_alert);
  } // do_ajax_form_tbdetailstockopname_table_refresh_cb
  function do_ajax_form_tbdetailstockopname_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxSetNavStatus("t");
    sc_insert_open = false;
  } // do_ajax_form_tbdetailstockopname_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_tbdetailstockopname_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_tbdetailstockopname_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    var var_lokasi_depo_ = scAjaxGetFieldSelect("lokasi_depo_" + iNumLinha);
    var var_exp_date_ = scAjaxGetFieldText("exp_date_" + iNumLinha);
    var var_stokawal_ = scAjaxGetFieldSelect("stokawal_" + iNumLinha);
    var var_stokkoreksi_ = scAjaxGetFieldText("stokkoreksi_" + iNumLinha);
    var var_stokakhir_ = scAjaxGetFieldText("stokakhir_" + iNumLinha);
...
?>
    x_ajax_form_tbdetailstockopname_submit_form(var_namaitem_, var_lokasi_depo_, var_exp_date_, var_stokawal_, var_stokkoreksi_, var_stokakhir_, var_keterangan_, var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbdetailstockopname_submit_form_cb);
  } // do_ajax_form_tbdetailstockopname_submit_form

  function do_ajax_form_tbdetailstockopname_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("lokasi_depo_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("exp_date_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("stokawal_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("stokkoreksi_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("stokakhir_" + sc_num_ult_line);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_tbdetailstockopname_submit_form_cb_after_alert);
  } // do_ajax_form_tbdetailstockopname_submit_form_cb
  function do_ajax_form_tbdetailstockopname_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbdetailstockopname_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tbdetailstockopname_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_tbdetailstockopname_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("lokasi_depo_" + iNavForm);
      scAjaxHideErrorDisplay("exp_date_" + iNavForm);
      scAjaxHideErrorDisplay("stokawal_" + iNavForm);
      scAjaxHideErrorDisplay("stokkoreksi_" + iNavForm);
      scAjaxHideErrorDisplay("stokakhir_" + iNavForm);
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tbdetailstockopname_navigate_form(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbdetailstockopname_navigate_form_cb);
  } // do_ajax_form_tbdetailstockopname_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailstockopname']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbdetailstockopname_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbdetailstockopname_navigate_form_cb_after_alert);
  } // do_ajax_form_tbdetailstockopname_navigate_form_cb
  function do_ajax_form_tbdetailstockopname_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_tbdetailstockopname_navigate_form_cb_after_alert
  function sc_hide_form_tbdetailstockopname_form()
  {
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "lokasi_depo_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "exp_date_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "stokawal_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "stokkoreksi_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "stokakhir_" + iNumLinha;
    iTotCampos++;
    ...
    ajax_error_list["lokasi_depo_" + iNumLinha] = {"label": "Lokasi Depo<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["exp_date_" + iNumLinha] = {"label": "Exp Date<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["stokawal_" + iNumLinha] = {"label": "Stok Awal<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["stokkoreksi_" + iNumLinha] = {"label": "Stok Koreksi<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["stokakhir_" + iNumLinha] = {"label": "Stok Akhir<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_field_mult["lokasi_depo_"][iNumLinha] = "lokasi_depo_" + iNumLinha;
    ajax_field_mult["exp_date_"][iNumLinha] = "exp_date_" + iNumLinha;
    ajax_field_mult["stokawal_"][iNumLinha] = "stokawal_" + iNumLinha;
    ajax_field_mult["stokkoreksi_"][iNumLinha] = "stokkoreksi_" + iNumLinha;
    ajax_field_mult["stokakhir_"][iNumLinha] = "stokakhir_" + iNumLinha;
    ...
    ajax_field_id["lokasi_depo_" + iNumLinha] = new Array("hidden_field_label_lokasi_depo_", "hidden_field_data_lokasi_depo_" + iNumLinha);
    ajax_field_id["exp_date_" + iNumLinha] = new Array("hidden_field_label_exp_date_", "hidden_field_data_exp_date_" + iNumLinha);
    ajax_field_id["stokawal_" + iNumLinha] = new Array("hidden_field_label_stokawal_", "hidden_field_data_stokawal_" + iNumLinha);
    ajax_field_id["stokkoreksi_" + iNumLinha] = new Array("hidden_field_label_stokkoreksi_", "hidden_field_data_stokkoreksi_" + iNumLinha);
    ajax_field_id["stokakhir_" + iNumLinha] = new Array("hidden_field_label_stokakhir_", "hidden_field_data_stokakhir_" + iNumLinha);
    ...
    ajax_error_count["lokasi_depo_" + iNumLinha] = "off";
    ajax_error_count["exp_date_" + iNumLinha] = "off";
    ajax_error_count["stokawal_" + iNumLinha] = "off";
    ajax_error_count["stokkoreksi_" + iNumLinha] = "off";
    ajax_error_count["stokakhir_" + iNumLinha] = "off";
...
?>
    ...
    ajax_read_only["lokasi_depo_" + iNumLinha] = "off";
    ajax_read_only["exp_date_" + iNumLinha] = "off";
    ajax_read_only["stokawal_" + iNumLinha] = "off";
    ajax_read_only["stokkoreksi_" + iNumLinha] = "off";
    ajax_read_only["stokakhir_" + iNumLinha] = "off";
...
?>
    ...
    ajax_read_only["lokasi_depo_" + iNumLinha] = "on";
    ajax_read_only["exp_date_" + iNumLinha] = "on";
    ajax_read_only["stokawal_" + iNumLinha] = "on";
    ajax_read_only["stokkoreksi_" + iNumLinha] = "on";
    ajax_read_only["stokakhir_" + iNumLinha] = "on";
...
?>
  ...
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["lokasi_depo_" + iNumLinha] = null;
    ajax_error_list["exp_date_" + iNumLinha] = null;
    ajax_error_list["stokawal_" + iNumLinha] = null;
    ajax_error_list["stokkoreksi_" + iNumLinha] = null;
    ajax_error_list["stokakhir_" + iNumLinha] = null;
  ...
  var ajax_field_mult = {
    "namaitem_": new Array(),
    "lokasi_depo_": new Array(),
    "exp_date_": new Array(),
    "stokawal_": new Array(),
    "stokkoreksi_": new Array(),
    "stokakhir_": new Array(),
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["lokasi_depo_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["lokasi_depo_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["lokasi_depo_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["lokasi_depo_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["lokasi_depo_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["exp_date_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["exp_date_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["exp_date_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["exp_date_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["exp_date_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["stokawal_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["stokawal_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["stokawal_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["stokawal_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["stokawal_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["stokkoreksi_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["stokkoreksi_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["stokkoreksi_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["stokkoreksi_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["stokkoreksi_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["stokakhir_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["stokakhir_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["stokakhir_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["stokakhir_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["stokakhir_" + iNumLinha]["onfocus"] = new Array();
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['lokasi_depo_'])) ? $this->nmgp_cmp_readonly['lokasi_depo_'] : 'off';
?>
    scAjaxFieldRead("lokasi_depo_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['exp_date_'])) ? $this->nmgp_cmp_readonly['exp_date_'] : 'off';
?>
    scAjaxFieldRead("exp_date_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['stokawal_'])) ? $this->nmgp_cmp_readonly['stokawal_'] : 'off';
?>
    scAjaxFieldRead("stokawal_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['stokkoreksi_'])) ? $this->nmgp_cmp_readonly['stokkoreksi_'] : 'off';
?>
    scAjaxFieldRead("stokkoreksi_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['stokakhir_'])) ? $this->nmgp_cmp_readonly['stokakhir_'] : 'off';
?>
    scAjaxFieldRead("stokakhir_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
?>
  ...
  function mdCloseObjects(iSeq)
  {
    ...
    scAjaxFieldRead("lokasi_depo_" + iSeq, "on");
    scAjaxFieldRead("exp_date_" + iSeq, "on");
    scAjaxFieldRead("stokawal_" + iSeq, "on");
    scAjaxFieldRead("stokkoreksi_" + iSeq, "on");
    scAjaxFieldRead("stokakhir_" + iSeq, "on");
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["namaitem_" + iRow] || "on" == ajax_error_count["lokasi_depo_" + iRow] || "on" == ajax_error_count["exp_date_" + iRow] || "on" == ajax_error_count["stokawal_" + iRow] || "on" == ajax_error_count["stokkoreksi_" + iRow] || "on" == ajax_error_count["stokakhir_" + iRow] || "on" == ajax_error_count["keterangan_" + iRow] || "on" == ajax_error_count["id_" + iRow]))
    {
      ...
      $("#hidden_field_data_lokasi_depo_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_exp_date_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_stokawal_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_stokkoreksi_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_stokakhir_" + iRow).addClass("scFormErrorLine");
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["namaitem_" + iRow] && "off" == ajax_error_count["lokasi_depo_" + iRow] && "off" == ajax_error_count["exp_date_" + iRow] && "off" == ajax_error_count["stokawal_" + iRow] && "off" == ajax_error_count["stokkoreksi_" + iRow] && "off" == ajax_error_count["stokakhir_" + iRow] && "off" == ajax_error_count["keterangan_" + iRow] && "off" == ajax_error_count["id_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["namaitem_" + iRow] = "off";
        ajax_error_count["lokasi_depo_" + iRow] = "off";
        ajax_error_count["exp_date_" + iRow] = "off";
        ajax_error_count["stokawal_" + iRow] = "off";
        ajax_error_count["stokkoreksi_" + iRow] = "off";
        ajax_error_count["stokakhir_" + iRow] = "off";
      ...
      $("#hidden_field_data_lokasi_depo_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_exp_date_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_stokawal_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_stokkoreksi_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_stokakhir_" + iRow).removeClass("scFormErrorLine");
