  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbpemeriksaanrawatjalan" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbpemeriksaanrawatjalan_form();
	}

  // ---------- Validate namapemeriksaan_
  function do_ajax_form_tbpemeriksaanrawatjalan_validate_namapemeriksaan_(iNumLinha)
  {
    var nomeCampo_namapemeriksaan_ = "namapemeriksaan_" + iNumLinha;
    var var_namapemeriksaan_ = scAjaxGetFieldText(nomeCampo_namapemeriksaan_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbpemeriksaanrawatjalan_validate_namapemeriksaan_(var_namapemeriksaan_, iNumLinha, var_script_case_init, do_ajax_form_tbpemeriksaanrawatjalan_validate_namapemeriksaan__cb);
  } // do_ajax_form_tbpemeriksaanrawatjalan_validate_namapemeriksaan_

  function do_ajax_form_tbpemeriksaanrawatjalan_validate_namapemeriksaan__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "namapemeriksaan_" + iLineNumber;
    }
    else
    {
      sFieldValid = "namapemeriksaan_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "namapemeriksaan_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "namapemeriksaan_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbpemeriksaanrawatjalan_validate_namapemeriksaan__cb

  // ---------- Validate standardari_
  function do_ajax_form_tbpemeriksaanrawatjalan_validate_standardari_(iNumLinha)
  {
    var nomeCampo_standardari_ = "standardari_" + iNumLinha;
    var var_standardari_ = scAjaxGetFieldText(nomeCampo_standardari_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbpemeriksaanrawatjalan_validate_standardari_(var_standardari_, iNumLinha, var_script_case_init, do_ajax_form_tbpemeriksaanrawatjalan_validate_standardari__cb);
  } // do_ajax_form_tbpemeriksaanrawatjalan_validate_standardari_

  function do_ajax_form_tbpemeriksaanrawatjalan_validate_standardari__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "standardari_" + iLineNumber;
    }
    else
    {
      sFieldValid = "standardari_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "standardari_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "standardari_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbpemeriksaanrawatjalan_validate_standardari__cb

  // ---------- Validate standarsampai_
  function do_ajax_form_tbpemeriksaanrawatjalan_validate_standarsampai_(iNumLinha)
  {
    var nomeCampo_standarsampai_ = "standarsampai_" + iNumLinha;
    var var_standarsampai_ = scAjaxGetFieldText(nomeCampo_standarsampai_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbpemeriksaanrawatjalan_validate_standarsampai_(var_standarsampai_, iNumLinha, var_script_case_init, do_ajax_form_tbpemeriksaanrawatjalan_validate_standarsampai__cb);
  } // do_ajax_form_tbpemeriksaanrawatjalan_validate_standarsampai_

  function do_ajax_form_tbpemeriksaanrawatjalan_validate_standarsampai__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "standarsampai_" + iLineNumber;
    }
    else
    {
      sFieldValid = "standarsampai_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "standarsampai_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "standarsampai_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbpemeriksaanrawatjalan_validate_standarsampai__cb

  // ---------- Validate nilai_
  function do_ajax_form_tbpemeriksaanrawatjalan_validate_nilai_(iNumLinha)
  {
    var nomeCampo_nilai_ = "nilai_" + iNumLinha;
    var var_nilai_ = scAjaxGetFieldText(nomeCampo_nilai_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbpemeriksaanrawatjalan_validate_nilai_(var_nilai_, iNumLinha, var_script_case_init, do_ajax_form_tbpemeriksaanrawatjalan_validate_nilai__cb);
  } // do_ajax_form_tbpemeriksaanrawatjalan_validate_nilai_

  function do_ajax_form_tbpemeriksaanrawatjalan_validate_nilai__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "nilai_" + iLineNumber;
    }
    else
    {
      sFieldValid = "nilai_";
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "nilai_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "nilai_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbpemeriksaanrawatjalan_validate_nilai__cb

  // ---------- Validate dokter_
  function do_ajax_form_tbpemeriksaanrawatjalan_validate_dokter_(iNumLinha)
  {
    var nomeCampo_dokter_ = "dokter_" + iNumLinha;
    var var_dokter_ = scAjaxGetFieldSelect(nomeCampo_dokter_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbpemeriksaanrawatjalan_validate_dokter_(var_dokter_, iNumLinha, var_script_case_init, do_ajax_form_tbpemeriksaanrawatjalan_validate_dokter__cb);
  } // do_ajax_form_tbpemeriksaanrawatjalan_validate_dokter_

  function do_ajax_form_tbpemeriksaanrawatjalan_validate_dokter__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbpemeriksaanrawatjalan_validate_dokter__cb

  // ---------- Validate keterangan_
  function do_ajax_form_tbpemeriksaanrawatjalan_validate_keterangan_(iNumLinha)
  {
    var nomeCampo_keterangan_ = "keterangan_" + iNumLinha;
    var var_keterangan_ = scAjaxGetFieldText(nomeCampo_keterangan_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbpemeriksaanrawatjalan_validate_keterangan_(var_keterangan_, iNumLinha, var_script_case_init, do_ajax_form_tbpemeriksaanrawatjalan_validate_keterangan__cb);
  } // do_ajax_form_tbpemeriksaanrawatjalan_validate_keterangan_

  function do_ajax_form_tbpemeriksaanrawatjalan_validate_keterangan__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbpemeriksaanrawatjalan_validate_keterangan__cb

  // ---------- Validate tglperiksa_
  function do_ajax_form_tbpemeriksaanrawatjalan_validate_tglperiksa_(iNumLinha)
  {
    var nomeCampo_tglperiksa_ = "tglperiksa_" + iNumLinha;
    var var_tglperiksa_ = scAjaxGetFieldText(nomeCampo_tglperiksa_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbpemeriksaanrawatjalan_validate_tglperiksa_(var_tglperiksa_, iNumLinha, var_script_case_init, do_ajax_form_tbpemeriksaanrawatjalan_validate_tglperiksa__cb);
  } // do_ajax_form_tbpemeriksaanrawatjalan_validate_tglperiksa_

  function do_ajax_form_tbpemeriksaanrawatjalan_validate_tglperiksa__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbpemeriksaanrawatjalan_validate_tglperiksa__cb

  // ---------- Validate id_
  function do_ajax_form_tbpemeriksaanrawatjalan_validate_id_(iNumLinha)
  {
    var nomeCampo_id_ = "id_" + iNumLinha;
    var var_id_ = scAjaxGetFieldHidden(nomeCampo_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbpemeriksaanrawatjalan_validate_id_(var_id_, iNumLinha, var_script_case_init, do_ajax_form_tbpemeriksaanrawatjalan_validate_id__cb);
  } // do_ajax_form_tbpemeriksaanrawatjalan_validate_id_

  function do_ajax_form_tbpemeriksaanrawatjalan_validate_id__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbpemeriksaanrawatjalan_validate_id__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_tbpemeriksaanrawatjalan_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_tbpemeriksaanrawatjalan_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tbpemeriksaanrawatjalan_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_tbpemeriksaanrawatjalan_add_new_line_cb);
  } // do_ajax_form_tbpemeriksaanrawatjalan_add_new_line

  function do_ajax_form_tbpemeriksaanrawatjalan_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
    ...
    nm_field_disabled("standardari_=disabled;standarsampai_=disabled", "", iAjaxNewLine);
  } // do_ajax_form_tbpemeriksaanrawatjalan_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_tbpemeriksaanrawatjalan_backup_line(iNumLinha)
  {
    var var_id_ = scAjaxGetFieldHidden("id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbpemeriksaanrawatjalan_backup_line(var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_tbpemeriksaanrawatjalan_backup_line_cb);
  } // do_ajax_form_tbpemeriksaanrawatjalan_backup_line

  function do_ajax_form_tbpemeriksaanrawatjalan_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_tbpemeriksaanrawatjalan_backup_line_cb

  function do_ajax_form_tbpemeriksaanrawatjalan_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_tbpemeriksaanrawatjalan_cancel_insert

  function do_ajax_form_tbpemeriksaanrawatjalan_cancel_update(iSeqVert)
  {
    do_ajax_form_tbpemeriksaanrawatjalan_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_tbpemeriksaanrawatjalan_cancel_update

  function do_ajax_form_tbpemeriksaanrawatjalan_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_tbpemeriksaanrawatjalan_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_tbpemeriksaanrawatjalan_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_tbpemeriksaanrawatjalan_table_refresh(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbpemeriksaanrawatjalan_table_refresh_cb);
  } //  do_ajax_form_tbpemeriksaanrawatjalan_table_refresh

  function do_ajax_form_tbpemeriksaanrawatjalan_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_tbpemeriksaanrawatjalan_table_refresh_cb_after_alert);
  } // do_ajax_form_tbpemeriksaanrawatjalan_table_refresh_cb
  function do_ajax_form_tbpemeriksaanrawatjalan_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxSetNavStatus("t");
    sc_insert_open = false;
  } // do_ajax_form_tbpemeriksaanrawatjalan_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_tbpemeriksaanrawatjalan_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_tbpemeriksaanrawatjalan_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    sc_num_ult_line = iNumLinha;
    sc_num_ult_tr   = indexTR;
    scAjaxHideMessage();
    var var_namapemeriksaan_ = scAjaxGetFieldText("namapemeriksaan_" + iNumLinha);
    var var_standardari_ = scAjaxGetFieldText("standardari_" + iNumLinha);
    var var_standarsampai_ = scAjaxGetFieldText("standarsampai_" + iNumLinha);
    var var_nilai_ = scAjaxGetFieldText("nilai_" + iNumLinha);
    var var_dokter_ = scAjaxGetFieldSelect("dokter_" + iNumLinha);
...
?>
    x_ajax_form_tbpemeriksaanrawatjalan_submit_form(var_namapemeriksaan_, var_standardari_, var_standarsampai_, var_nilai_, var_dokter_, var_keterangan_, var_tglperiksa_, var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbpemeriksaanrawatjalan_submit_form_cb);
  } // do_ajax_form_tbpemeriksaanrawatjalan_submit_form

  function do_ajax_form_tbpemeriksaanrawatjalan_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("namapemeriksaan_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("standardari_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("standarsampai_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("nilai_" + sc_num_ult_line);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_tbpemeriksaanrawatjalan_submit_form_cb_after_alert);
  } // do_ajax_form_tbpemeriksaanrawatjalan_submit_form_cb
  function do_ajax_form_tbpemeriksaanrawatjalan_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbpemeriksaanrawatjalan_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tbpemeriksaanrawatjalan_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_tbpemeriksaanrawatjalan_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("namapemeriksaan_" + iNavForm);
      scAjaxHideErrorDisplay("standardari_" + iNavForm);
      scAjaxHideErrorDisplay("standarsampai_" + iNavForm);
      scAjaxHideErrorDisplay("nilai_" + iNavForm);
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tbpemeriksaanrawatjalan_navigate_form(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbpemeriksaanrawatjalan_navigate_form_cb);
  } // do_ajax_form_tbpemeriksaanrawatjalan_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbpemeriksaanrawatjalan']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbpemeriksaanrawatjalan_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbpemeriksaanrawatjalan_navigate_form_cb_after_alert);
  } // do_ajax_form_tbpemeriksaanrawatjalan_navigate_form_cb
  function do_ajax_form_tbpemeriksaanrawatjalan_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_tbpemeriksaanrawatjalan_navigate_form_cb_after_alert
  function sc_hide_form_tbpemeriksaanrawatjalan_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "namapemeriksaan_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "standardari_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "standarsampai_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "nilai_" + iNumLinha;
    iTotCampos++;
    ...
    iTotCampos++;
    ajax_error_list["namapemeriksaan_" + iNumLinha] = {"label": "Nama Pemeriksaan<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["standardari_" + iNumLinha] = {"label": "Standar Dari<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["standarsampai_" + iNumLinha] = {"label": "Standar Sampai<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["nilai_" + iNumLinha] = {"label": "Nilai<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_field_mult["namapemeriksaan_"][iNumLinha] = "namapemeriksaan_" + iNumLinha;
    ajax_field_mult["standardari_"][iNumLinha] = "standardari_" + iNumLinha;
    ajax_field_mult["standarsampai_"][iNumLinha] = "standarsampai_" + iNumLinha;
    ajax_field_mult["nilai_"][iNumLinha] = "nilai_" + iNumLinha;
    ...
    ajax_field_id["namapemeriksaan_" + iNumLinha] = new Array("hidden_field_label_namapemeriksaan_", "hidden_field_data_namapemeriksaan_" + iNumLinha);
    ajax_field_id["standardari_" + iNumLinha] = new Array("hidden_field_label_standardari_", "hidden_field_data_standardari_" + iNumLinha);
    ajax_field_id["standarsampai_" + iNumLinha] = new Array("hidden_field_label_standarsampai_", "hidden_field_data_standarsampai_" + iNumLinha);
    ajax_field_id["nilai_" + iNumLinha] = new Array("hidden_field_label_nilai_", "hidden_field_data_nilai_" + iNumLinha);
    ...
    ajax_error_count["namapemeriksaan_" + iNumLinha] = "off";
    ajax_error_count["standardari_" + iNumLinha] = "off";
    ajax_error_count["standarsampai_" + iNumLinha] = "off";
    ajax_error_count["nilai_" + iNumLinha] = "off";
...
{
?>
    ajax_read_only["namapemeriksaan_" + iNumLinha] = "off";
    ajax_read_only["standardari_" + iNumLinha] = "off";
    ajax_read_only["standarsampai_" + iNumLinha] = "off";
    ajax_read_only["nilai_" + iNumLinha] = "off";
    ajax_read_only["dokter_" + iNumLinha] = "off";
...
{
?>
    ajax_read_only["namapemeriksaan_" + iNumLinha] = "on";
    ajax_read_only["standardari_" + iNumLinha] = "on";
    ajax_read_only["standarsampai_" + iNumLinha] = "on";
    ajax_read_only["nilai_" + iNumLinha] = "on";
...
?>
  ...
  {
    ajax_error_list["namapemeriksaan_" + iNumLinha] = null;
    ajax_error_list["standardari_" + iNumLinha] = null;
    ajax_error_list["standarsampai_" + iNumLinha] = null;
    ajax_error_list["nilai_" + iNumLinha] = null;
  ...
  var ajax_field_mult = {
    "namapemeriksaan_": new Array(),
    "standardari_": new Array(),
    "standarsampai_": new Array(),
    "nilai_": new Array(),
    "dokter_": new Array(),
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["namapemeriksaan_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["namapemeriksaan_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["namapemeriksaan_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["namapemeriksaan_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["namapemeriksaan_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["standardari_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["standardari_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["standardari_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["standardari_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["standardari_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["standarsampai_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["standarsampai_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["standarsampai_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["standarsampai_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["standarsampai_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["nilai_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["nilai_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["nilai_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["nilai_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["nilai_" + iNumLinha]["onfocus"] = new Array();
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['namapemeriksaan_'])) ? $this->nmgp_cmp_readonly['namapemeriksaan_'] : 'off';
?>
    scAjaxFieldRead("namapemeriksaan_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['standardari_'])) ? $this->nmgp_cmp_readonly['standardari_'] : 'off';
?>
    scAjaxFieldRead("standardari_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['standarsampai_'])) ? $this->nmgp_cmp_readonly['standarsampai_'] : 'off';
?>
    scAjaxFieldRead("standarsampai_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['nilai_'])) ? $this->nmgp_cmp_readonly['nilai_'] : 'off';
?>
    scAjaxFieldRead("nilai_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['dokter_'])) ? $this->nmgp_cmp_readonly['dokter_'] : 'off';
?>
...
?>
  ...
  {
    scAjaxFieldRead("namapemeriksaan_" + iSeq, "on");
    scAjaxFieldRead("standardari_" + iSeq, "on");
    scAjaxFieldRead("standarsampai_" + iSeq, "on");
    scAjaxFieldRead("nilai_" + iSeq, "on");
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["namapemeriksaan_" + iRow] || "on" == ajax_error_count["standardari_" + iRow] || "on" == ajax_error_count["standarsampai_" + iRow] || "on" == ajax_error_count["nilai_" + iRow] || "on" == ajax_error_count["dokter_" + iRow] || "on" == ajax_error_count["keterangan_" + iRow] || "on" == ajax_error_count["tglperiksa_" + iRow] || "on" == ajax_error_count["id_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_namapemeriksaan_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_standardari_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_standarsampai_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_nilai_" + iRow).addClass("scFormErrorLine");
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["namapemeriksaan_" + iRow] && "off" == ajax_error_count["standardari_" + iRow] && "off" == ajax_error_count["standarsampai_" + iRow] && "off" == ajax_error_count["nilai_" + iRow] && "off" == ajax_error_count["dokter_" + iRow] && "off" == ajax_error_count["keterangan_" + iRow] && "off" == ajax_error_count["tglperiksa_" + iRow] && "off" == ajax_error_count["id_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["namapemeriksaan_" + iRow] = "off";
        ajax_error_count["standardari_" + iRow] = "off";
        ajax_error_count["standarsampai_" + iRow] = "off";
        ajax_error_count["nilai_" + iRow] = "off";
      ...
      $("#hidden_field_data_namapemeriksaan_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_standardari_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_standarsampai_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_nilai_" + iRow).removeClass("scFormErrorLine");
