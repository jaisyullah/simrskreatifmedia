...
<?php
   ...
   $Ord_Cmp = new grid_harga_lab_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_harga_lab_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_harga_lab']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_harga_lab']['ordem_select_orig'] = array();
   }
   ...
   {
       $tab_def_campos['sc_field_0'] = "a.labcode";
   }
   $tab_labels["sc_field_0"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_harga_lab']['labels']["sc_field_0"])) ? $_SESSION['sc_session'][$sc_init]['grid_harga_lab']['labels']["sc_field_0"] : "Kode Lab";
   ...
   {
       $tab_def_campos['nama'] = "b.nama";
   }
   $tab_labels["nama"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_harga_lab']['labels']["nama"])) ? $_SESSION['sc_session'][$sc_init]['grid_harga_lab']['labels']["nama"] : "Nama";
   ...
   $tab_labels["kategori"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_harga_lab']['labels']["kategori"])) ? $_SESSION['sc_session'][$sc_init]['grid_harga_lab']['labels']["kategori"] : "Kategori";
   ...
   $tab_labels["kelas"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_harga_lab']['labels']["kelas"])) ? $_SESSION['sc_session'][$sc_init]['grid_harga_lab']['labels']["kelas"] : "Kelas";
   ...
   {
       $tab_def_campos['tarif'] = "a.rate";
   }
   $tab_labels["tarif"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_harga_lab']['labels']["tarif"])) ? $_SESSION['sc_session'][$sc_init]['grid_harga_lab']['labels']["tarif"] : "Tarif";
   ...
   {
       $tab_def_campos['sc_field_1'] = "a.`SHARE`";
   }
   $tab_labels["sc_field_1"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_harga_lab']['labels']["sc_field_1"])) ? $_SESSION['sc_session'][$sc_init]['grid_harga_lab']['labels']["sc_field_1"] : "Share Dokter";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_harga_lab']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_harga_lab']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_harga_lab']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_harga_lab']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_harga_lab']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_harga_lab']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_harga_lab']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_harga_lab']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_harga_lab']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_harga_lab_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_harga_lab']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_harga_lab']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_harga_lab']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_harga_lab']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_harga_lab']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
