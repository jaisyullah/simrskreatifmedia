...
class grid_harga_lab_total
{
   ...
   function __construct($sc_page)
   {
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['grid_harga_lab']['campos_busca']) && !empty($_SESSION['sc_session'][$this->sc_page]['grid_harga_lab']['campos_busca']))
      { 
