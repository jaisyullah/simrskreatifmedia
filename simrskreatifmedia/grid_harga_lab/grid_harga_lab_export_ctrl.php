<?php
@session_start() ;
$_SESSION['scriptcase']['grid_harga_lab']['sc_process_barr'] = true;
require_once('../grid_harga_lab/index.php');
unset($_SESSION['scriptcase']['grid_harga_lab']['sc_process_barr']);
$ExportCtrl = new grid_harga_lab_export_control;
$ExportCtrl->Export_barr();

class grid_harga_lab_export_control
{
