<?php
@session_start() ;
$_SESSION['scriptcase']['chart_bysex_poli']['sc_process_barr'] = true;
require_once('../chart_bysex_poli/index.php');
unset($_SESSION['scriptcase']['chart_bysex_poli']['sc_process_barr']);
$ExportCtrl = new chart_bysex_poli_export_control;
$ExportCtrl->Export_barr();

class chart_bysex_poli_export_control
{
