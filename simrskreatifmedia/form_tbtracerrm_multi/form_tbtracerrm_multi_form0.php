<?php
class form_tbtracerrm_multi_form extends form_tbtracerrm_multi_apl
{
function Form_Init()
{
...
<?php
if ($this->Embutida_form && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtracerrm_multi']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtracerrm_multi']['sc_modal'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtracerrm_multi']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtracerrm_multi']['sc_redir_atualiz'] == 'ok')
{
?>
...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtracerrm_multi']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_tbtracerrm_multi/form_tbtracerrm_multi_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_tbtracerrm_multi_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_tbtracerrm_multi_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtracerrm_multi']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtracerrm_multi']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtracerrm_multi']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtracerrm_multi']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtracerrm_multi']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtracerrm_multi']['recarga'];
}
if ('novo' == $opcao_botoes && $this->Embutida_form)
{
    $opcao_botoes = 'inicio';
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtracerrm_multi']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtracerrm_multi']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
?>
...
<?php
 include_once("form_tbtracerrm_multi_js0.php");
?>
<script type="text/javascript"> 
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_tbtracerrm_multi'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_tbtracerrm_multi'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtracerrm_multi']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtracerrm_multi']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtracerrm_multi']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtracerrm_multi']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtracerrm_multi']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtracerrm_multi']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtracerrm_multi']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtracerrm_multi']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtracerrm_multi']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtracerrm_multi']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtracerrm_multi']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtracerrm_multi']['fast_search'][2] : "";
?> 
...
<?php
    ...
    if ($opcao_botoes != "novo") {
        $sCondStyle = ($this->nmgp_botoes['label'] == "on") ? '' : 'display: none;';
?>
       <?php echo nmButtonOutput($this->arr_buttons, "label", "scBtnFn_label()", "scBtnFn_label()", "sc_label_top", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtracerrm_multi']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtracerrm_multi']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtracerrm_multi']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtracerrm_multi']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtracerrm_multi']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtracerrm_multi']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtracerrm_multi']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtracerrm_multi']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtracerrm_multi']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtracerrm_multi']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtracerrm_multi']['ordem_cmp'] == "id")
      {
          $orderColName = "id";
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtracerrm_multi']['ordem_ord'] == " desc")
          {
...
{ 
   ...
   { 
       ob_start();
       $iStart = sizeof($this->form_vert_form_tbtracerrm_multi);
       $guarda_nmgp_opcao = $this->nmgp_opcao;
       $guarda_form_vert_form_tbtracerrm_multi = $this->form_vert_form_tbtracerrm_multi;
       $this->nmgp_opcao = 'novo';
   } 
   if ($this->Embutida_form && empty($this->form_vert_form_tbtracerrm_multi))
   {
       $sc_seq_vert = 0;
   }
           ...
           if ('novo' != $this->nmgp_opcao && !isset($this->nmgp_cmp_readonly['dokter_']))
           {
               $this->nmgp_cmp_readonly['dokter_'] = 'on';
           }
   foreach ($this->form_vert_form_tbtracerrm_multi as $sc_seq_vert => $sc_lixo)
   {
       $this->loadRecordState($sc_seq_vert);
       $this->penerima_ = $this->form_vert_form_tbtracerrm_multi[$sc_seq_vert]['penerima_'];
       $this->order_date_ = $this->form_vert_form_tbtracerrm_multi[$sc_seq_vert]['order_date_'];
       $this->process_date_ = $this->form_vert_form_tbtracerrm_multi[$sc_seq_vert]['process_date_'];
       $this->service_date_ = $this->form_vert_form_tbtracerrm_multi[$sc_seq_vert]['service_date_'];
       $this->returned_date_ = $this->form_vert_form_tbtracerrm_multi[$sc_seq_vert]['returned_date_'];
       $this->diagnosa_ = $this->form_vert_form_tbtracerrm_multi[$sc_seq_vert]['diagnosa_'];
       $this->sc_field_0_ = $this->form_vert_form_tbtracerrm_multi[$sc_seq_vert]['sc_field_0_'];
       ...
       elseif ($Line_Add)
       {
        ...
        $this->id_ = $this->form_vert_form_tbtracerrm_multi[$sc_seq_vert]['id_']; 
       $id_ = $this->id_; 
       if (!isset($this->nmgp_cmp_hidden['id_']))
       {
           $this->nmgp_cmp_hidden['id_'] = 'off';
       ...
       $this->sc_field_2_ = $this->form_vert_form_tbtracerrm_multi[$sc_seq_vert]['sc_field_2_']; 
       ...
       $this->jenis_ = $this->form_vert_form_tbtracerrm_multi[$sc_seq_vert]['jenis_']; 
       $jenis_ = $this->jenis_; 
       $sStyleHidden_jenis_ = '';
       ...
       $this->sc_field_1_ = $this->form_vert_form_tbtracerrm_multi[$sc_seq_vert]['sc_field_1_']; 
       ...
       $this->usia_ = $this->form_vert_form_tbtracerrm_multi[$sc_seq_vert]['usia_']; 
       $usia_ = $this->usia_; 
       $sStyleHidden_usia_ = '';
       ...
       $this->alamat_ = $this->form_vert_form_tbtracerrm_multi[$sc_seq_vert]['alamat_']; 
       ...
       $this->dokter_ = $this->form_vert_form_tbtracerrm_multi[$sc_seq_vert]['dokter_']; 
       ...
       if (/*($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir") || */(isset($this->nmgp_cmp_readonly["dokter_"]) &&  $this->nmgp_cmp_readonly["dokter_"] == "on"))
       {
       ...
       $this->lokasi_ = $this->form_vert_form_tbtracerrm_multi[$sc_seq_vert]['lokasi_']; 
       ...
       $this->status_ = $this->form_vert_form_tbtracerrm_multi[$sc_seq_vert]['status_']; 
...
<?php echo nmButtonOutput($this->arr_buttons, "bmd_novo", "do_ajax_form_tbtracerrm_multi_add_new_line(" . $sc_seq_vert . ")", "do_ajax_form_tbtracerrm_multi_add_new_line(" . $sc_seq_vert . ")", "sc_new_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
<?php }?>
<?php
  $Style_add_line = (!$Line_Add) ? "display: none" : "";
?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_form_tbtracerrm_multi_cancel_insert(" . $sc_seq_vert . ")", "do_ajax_form_tbtracerrm_multi_cancel_insert(" . $sc_seq_vert . ")", "sc_canceli_line_" . $sc_seq_vert . "", "", "", "" . $Style_add_line . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_form_tbtracerrm_multi_cancel_update(" . $sc_seq_vert . ")", "do_ajax_form_tbtracerrm_multi_cancel_update(" . $sc_seq_vert . ")", "sc_cancelu_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
 </TD>
   <?php }?>
...
<span id="id_read_on_alamat_<?php echo $sc_seq_vert ?>" class="sc-ui-readonly-alamat_<?php echo $sc_seq_vert ?> css_alamat__line" style="<?php echo $sStyleReadLab_alamat_; ?>"><?php echo $alamat__val; ?></span><span id="id_read_off_alamat_<?php echo $sc_seq_vert ?>" class="css_read_off_alamat_" style="white-space: nowrap;<?php echo $sStyleReadInp_alamat_; ?>">
 <textarea  class="sc-js-input scFormObjectOddMult css_alamat__obj" style="white-space: pre-wrap;" name="alamat_<?php echo $sc_seq_vert ?>" id="id_sc_field_alamat_<?php echo $sc_seq_vert ?>" rows="3" cols="30"
 alt="{datatype: 'text', maxLength: 150, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddMultWm', maskChars: '(){}[].,;:-+/ '}" >
<?php echo $alamat_; ?>
</textarea>
</span><?php } ?>
...
<input type="hidden" name="dokter_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($dokter_) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>
...
<?php if ($bTestReadOnly_dokter_ && ($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir") || (isset($this->nmgp_cmp_readonly["dokter_"]) &&  $this->nmgp_cmp_readonly["dokter_"] == "on")) { 

 ?>
<input type="hidden" name="dokter_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($dokter_) . "\"><span id=\"id_ajax_label_dokter_" . $sc_seq_vert . "\">" . $dokter_ . "</span>"; ?>
<?php } else { ?>
<span id="id_read_on_dokter_<?php echo $sc_seq_vert ?>" class="sc-ui-readonly-dokter_<?php echo $sc_seq_vert ?> css_dokter__line" style="<?php echo $sStyleReadLab_dokter_; ?>"><?php echo $this->dokter_; ?></span><span id="id_read_off_dokter_<?php echo $sc_seq_vert ?>" class="css_read_off_dokter_" style="white-space: nowrap;<?php echo $sStyleReadInp_dokter_; ?>">
 <input class="sc-js-input scFormObjectOddMult css_dokter__obj" style="" id="id_sc_field_dokter_<?php echo $sc_seq_vert ?>" type=text name="dokter_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($dokter_) ?>"
 size=10 maxlength=20 alt="{datatype: 'text', maxLength: 20, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddMultWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtracerrm_multi']['Lookup_status_'][] = '0'; ?>
 <option  value="1" <?php  if ($this->status_ == "1") { echo " selected" ;} ?>>Dalam Proses</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtracerrm_multi']['Lookup_status_'][] = '1'; ?>
 <option  value="2" <?php  if ($this->status_ == "2") { echo " selected" ;} ?>>Pelayanan</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtracerrm_multi']['Lookup_status_'][] = '2'; ?>
 <option  value="3" <?php  if ($this->status_ == "3") { echo " selected" ;} ?>>Sudah Kembali</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtracerrm_multi']['Lookup_status_'][] = '3'; ?>
 </select></span>
</span><?php  }?>
...
<?php   
   ...
   { 
       ...
       $this->form_vert_form_tbtracerrm_multi = $guarda_form_vert_form_tbtracerrm_multi;
   } 
   if ($Table_refresh) 
   { 
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtracerrm_multi']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtracerrm_multi']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtracerrm_multi']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtracerrm_multi']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtracerrm_multi']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtracerrm_multi']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtracerrm_multi']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtracerrm_multi']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtracerrm_multi']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<?php
if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtracerrm_multi']['run_modal']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtracerrm_multi']['run_modal'])
{
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtracerrm_multi']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtracerrm_multi']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_tbtracerrm_multi");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_tbtracerrm_multi");
 parent.scAjaxDetailHeight("form_tbtracerrm_multi", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
<script type="text/javascript">
	...
	function scBtnFn_label() {
		if ($("#sc_label_top").length && $("#sc_label_top").is(":visible")) {
			sc_btn_label()
			 return;
		}
	}
...
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtracerrm_multi']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
