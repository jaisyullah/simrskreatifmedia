  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbtracerrm_multi" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbtracerrm_multi_form();
	}

  // ---------- Validate id_
  function do_ajax_form_tbtracerrm_multi_validate_id_(iNumLinha)
  {
    var nomeCampo_id_ = "id_" + iNumLinha;
    var var_id_ = scAjaxGetFieldHidden(nomeCampo_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtracerrm_multi_validate_id_(var_id_, iNumLinha, var_script_case_init, do_ajax_form_tbtracerrm_multi_validate_id__cb);
  } // do_ajax_form_tbtracerrm_multi_validate_id_

  function do_ajax_form_tbtracerrm_multi_validate_id__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtracerrm_multi_validate_id__cb

  // ---------- Validate nostruk_
  function do_ajax_form_tbtracerrm_multi_validate_nostruk_(iNumLinha)
  {
    var nomeCampo_nostruk_ = "nostruk_" + iNumLinha;
    var var_nostruk_ = scAjaxGetFieldText(nomeCampo_nostruk_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtracerrm_multi_validate_nostruk_(var_nostruk_, iNumLinha, var_script_case_init, do_ajax_form_tbtracerrm_multi_validate_nostruk__cb);
  } // do_ajax_form_tbtracerrm_multi_validate_nostruk_

  function do_ajax_form_tbtracerrm_multi_validate_nostruk__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "nostruk_" + iLineNumber;
    }
    else
    {
      sFieldValid = "nostruk_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "nostruk_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "nostruk_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtracerrm_multi_validate_nostruk__cb

  // ---------- Validate sc_field_2_
  function do_ajax_form_tbtracerrm_multi_validate_sc_field_2_(iNumLinha)
  {
    var nomeCampo_sc_field_2_ = "sc_field_2_" + iNumLinha;
    var var_sc_field_2_ = scAjaxGetFieldText(nomeCampo_sc_field_2_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtracerrm_multi_validate_sc_field_2_(var_sc_field_2_, iNumLinha, var_script_case_init, do_ajax_form_tbtracerrm_multi_validate_sc_field_2__cb);
  } // do_ajax_form_tbtracerrm_multi_validate_sc_field_2_

  function do_ajax_form_tbtracerrm_multi_validate_sc_field_2__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtracerrm_multi_validate_sc_field_2__cb

  // ---------- Validate rm_
  function do_ajax_form_tbtracerrm_multi_validate_rm_(iNumLinha)
  {
    var nomeCampo_rm_ = "rm_" + iNumLinha;
    var var_rm_ = scAjaxGetFieldText(nomeCampo_rm_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtracerrm_multi_validate_rm_(var_rm_, iNumLinha, var_script_case_init, do_ajax_form_tbtracerrm_multi_validate_rm__cb);
  } // do_ajax_form_tbtracerrm_multi_validate_rm_

  function do_ajax_form_tbtracerrm_multi_validate_rm__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "rm_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "rm_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtracerrm_multi_validate_rm__cb

  // ---------- Validate jenis_
  function do_ajax_form_tbtracerrm_multi_validate_jenis_(iNumLinha)
  {
    var nomeCampo_jenis_ = "jenis_" + iNumLinha;
    var var_jenis_ = scAjaxGetFieldSelect(nomeCampo_jenis_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtracerrm_multi_validate_jenis_(var_jenis_, iNumLinha, var_script_case_init, do_ajax_form_tbtracerrm_multi_validate_jenis__cb);
  } // do_ajax_form_tbtracerrm_multi_validate_jenis_

  function do_ajax_form_tbtracerrm_multi_validate_jenis__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "jenis_" + iLineNumber;
    }
    else
    {
      sFieldValid = "jenis_";
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "jenis_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "jenis_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtracerrm_multi_validate_jenis__cb

  // ---------- Validate sc_field_1_
  function do_ajax_form_tbtracerrm_multi_validate_sc_field_1_(iNumLinha)
  {
    var nomeCampo_sc_field_1_ = "sc_field_1_" + iNumLinha;
    var var_sc_field_1_ = scAjaxGetFieldSelect(nomeCampo_sc_field_1_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtracerrm_multi_validate_sc_field_1_(var_sc_field_1_, iNumLinha, var_script_case_init, do_ajax_form_tbtracerrm_multi_validate_sc_field_1__cb);
  } // do_ajax_form_tbtracerrm_multi_validate_sc_field_1_

  function do_ajax_form_tbtracerrm_multi_validate_sc_field_1__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtracerrm_multi_validate_sc_field_1__cb

  // ---------- Validate usia_
  function do_ajax_form_tbtracerrm_multi_validate_usia_(iNumLinha)
  {
    var nomeCampo_usia_ = "usia_" + iNumLinha;
    var var_usia_ = scAjaxGetFieldText(nomeCampo_usia_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtracerrm_multi_validate_usia_(var_usia_, iNumLinha, var_script_case_init, do_ajax_form_tbtracerrm_multi_validate_usia__cb);
  } // do_ajax_form_tbtracerrm_multi_validate_usia_

  function do_ajax_form_tbtracerrm_multi_validate_usia__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtracerrm_multi_validate_usia__cb

  // ---------- Validate alamat_
  function do_ajax_form_tbtracerrm_multi_validate_alamat_(iNumLinha)
  {
    var nomeCampo_alamat_ = "alamat_" + iNumLinha;
    var var_alamat_ = scAjaxGetFieldText(nomeCampo_alamat_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtracerrm_multi_validate_alamat_(var_alamat_, iNumLinha, var_script_case_init, do_ajax_form_tbtracerrm_multi_validate_alamat__cb);
  } // do_ajax_form_tbtracerrm_multi_validate_alamat_

  function do_ajax_form_tbtracerrm_multi_validate_alamat__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "alamat_" + iLineNumber;
    }
    else
    {
      sFieldValid = "alamat_";
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "alamat_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "alamat_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtracerrm_multi_validate_alamat__cb

  // ---------- Validate dokter_
  function do_ajax_form_tbtracerrm_multi_validate_dokter_(iNumLinha)
  {
    var nomeCampo_dokter_ = "dokter_" + iNumLinha;
    var var_dokter_ = scAjaxGetFieldText(nomeCampo_dokter_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtracerrm_multi_validate_dokter_(var_dokter_, iNumLinha, var_script_case_init, do_ajax_form_tbtracerrm_multi_validate_dokter__cb);
  } // do_ajax_form_tbtracerrm_multi_validate_dokter_

  function do_ajax_form_tbtracerrm_multi_validate_dokter__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "dokter_" + iLineNumber;
    }
    else
    {
      sFieldValid = "dokter_";
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "dokter_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "dokter_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtracerrm_multi_validate_dokter__cb

  // ---------- Validate lokasi_
  function do_ajax_form_tbtracerrm_multi_validate_lokasi_(iNumLinha)
  {
    var nomeCampo_lokasi_ = "lokasi_" + iNumLinha;
    var var_lokasi_ = scAjaxGetFieldSelect(nomeCampo_lokasi_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtracerrm_multi_validate_lokasi_(var_lokasi_, iNumLinha, var_script_case_init, do_ajax_form_tbtracerrm_multi_validate_lokasi__cb);
  } // do_ajax_form_tbtracerrm_multi_validate_lokasi_

  function do_ajax_form_tbtracerrm_multi_validate_lokasi__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "lokasi_" + iLineNumber;
    }
    else
    {
      sFieldValid = "lokasi_";
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "lokasi_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "lokasi_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtracerrm_multi_validate_lokasi__cb

  // ---------- Validate status_
  function do_ajax_form_tbtracerrm_multi_validate_status_(iNumLinha)
  {
    var nomeCampo_status_ = "status_" + iNumLinha;
    var var_status_ = scAjaxGetFieldSelect(nomeCampo_status_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtracerrm_multi_validate_status_(var_status_, iNumLinha, var_script_case_init, do_ajax_form_tbtracerrm_multi_validate_status__cb);
  } // do_ajax_form_tbtracerrm_multi_validate_status_

  function do_ajax_form_tbtracerrm_multi_validate_status__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtracerrm_multi_validate_status__cb

  // ---------- Refresh nostruk_
  function do_ajax_form_tbtracerrm_multi_refresh_nostruk_(iSeqForm)
  {
    var var_nostruk_ = scAjaxGetFieldText("nostruk_" + iSeqForm);
    var var_nmgp_refresh_row = iSeqForm;
    var var_nmgp_refresh_fields = "jenis_";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tbtracerrm_multi_refresh_nostruk_(var_nostruk_, var_nmgp_refresh_row, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_tbtracerrm_multi_refresh_nostruk__cb);
  } // do_ajax_form_tbtracerrm_multi_refresh_nostruk_

  function do_ajax_form_tbtracerrm_multi_refresh_nostruk__cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtracerrm_multi_refresh_nostruk__cb

  // ---------- Refresh rm_
  function do_ajax_form_tbtracerrm_multi_refresh_rm_(iSeqForm)
  {
    var var_rm_ = scAjaxGetFieldText("rm_" + iSeqForm);
    var var_nostruk_ = scAjaxGetFieldText("nostruk_" + iSeqForm);
    var var_nmgp_refresh_row = iSeqForm;
    var var_nmgp_refresh_fields = "process_date__#fld#_returned_date__#fld#_alamat__#fld#_jenis_";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tbtracerrm_multi_refresh_rm_(var_rm_, var_nostruk_, var_nmgp_refresh_row, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_tbtracerrm_multi_refresh_rm__cb);
  } // do_ajax_form_tbtracerrm_multi_refresh_rm_

  function do_ajax_form_tbtracerrm_multi_refresh_rm__cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtracerrm_multi_refresh_rm__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_tbtracerrm_multi_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_tbtracerrm_multi_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tbtracerrm_multi_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_tbtracerrm_multi_add_new_line_cb);
  } // do_ajax_form_tbtracerrm_multi_add_new_line

  function do_ajax_form_tbtracerrm_multi_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
    ...
    nm_field_disabled("rm_=disabled;jenis_=disabled;sc_field_1_=disabled;usia_=disabled;alamat_=disabled;lokasi_=disabled", "", iAjaxNewLine);
  } // do_ajax_form_tbtracerrm_multi_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_tbtracerrm_multi_backup_line(iNumLinha)
  {
    var var_id_ = scAjaxGetFieldHidden("id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtracerrm_multi_backup_line(var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_tbtracerrm_multi_backup_line_cb);
  } // do_ajax_form_tbtracerrm_multi_backup_line

  function do_ajax_form_tbtracerrm_multi_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_tbtracerrm_multi_backup_line_cb

  function do_ajax_form_tbtracerrm_multi_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_tbtracerrm_multi_cancel_insert

  function do_ajax_form_tbtracerrm_multi_cancel_update(iSeqVert)
  {
    do_ajax_form_tbtracerrm_multi_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_tbtracerrm_multi_cancel_update

  function do_ajax_form_tbtracerrm_multi_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_tbtracerrm_multi_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_tbtracerrm_multi_table_refresh()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tbtracerrm_multi_table_refresh(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbtracerrm_multi_table_refresh_cb);
  } //  do_ajax_form_tbtracerrm_multi_table_refresh

  function do_ajax_form_tbtracerrm_multi_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_tbtracerrm_multi_table_refresh_cb_after_alert);
  } // do_ajax_form_tbtracerrm_multi_table_refresh_cb
  function do_ajax_form_tbtracerrm_multi_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_tbtracerrm_multi_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_tbtracerrm_multi_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_tbtracerrm_multi_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_id_ = scAjaxGetFieldHidden("id_" + iNumLinha);
    var var_nostruk_ = scAjaxGetFieldText("nostruk_" + iNumLinha);
    var var_sc_field_2_ = scAjaxGetFieldText("sc_field_2_" + iNumLinha);
    var var_rm_ = scAjaxGetFieldText("rm_" + iNumLinha);
    var var_jenis_ = scAjaxGetFieldSelect("jenis_" + iNumLinha);
    var var_sc_field_1_ = scAjaxGetFieldSelect("sc_field_1_" + iNumLinha);
    var var_usia_ = scAjaxGetFieldText("usia_" + iNumLinha);
    var var_alamat_ = scAjaxGetFieldText("alamat_" + iNumLinha);
    var var_dokter_ = scAjaxGetFieldText("dokter_" + iNumLinha);
    var var_lokasi_ = scAjaxGetFieldSelect("lokasi_" + iNumLinha);
...
?>
    x_ajax_form_tbtracerrm_multi_submit_form(var_id_, var_nostruk_, var_sc_field_2_, var_rm_, var_jenis_, var_sc_field_1_, var_usia_, var_alamat_, var_dokter_, var_lokasi_, var_status_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbtracerrm_multi_submit_form_cb);
  } // do_ajax_form_tbtracerrm_multi_submit_form

  function do_ajax_form_tbtracerrm_multi_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("nostruk_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("sc_field_2_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("rm_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("jenis_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("sc_field_1_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("usia_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("alamat_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("dokter_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("lokasi_" + sc_num_ult_line);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_tbtracerrm_multi_submit_form_cb_after_alert);
  } // do_ajax_form_tbtracerrm_multi_submit_form_cb
  function do_ajax_form_tbtracerrm_multi_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbtracerrm_multi_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tbtracerrm_multi_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("nostruk_" + iNavForm);
      scAjaxHideErrorDisplay("sc_field_2_" + iNavForm);
      scAjaxHideErrorDisplay("rm_" + iNavForm);
      scAjaxHideErrorDisplay("jenis_" + iNavForm);
      scAjaxHideErrorDisplay("sc_field_1_" + iNavForm);
      scAjaxHideErrorDisplay("usia_" + iNavForm);
      scAjaxHideErrorDisplay("alamat_" + iNavForm);
      scAjaxHideErrorDisplay("dokter_" + iNavForm);
      scAjaxHideErrorDisplay("lokasi_" + iNavForm);
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tbtracerrm_multi_navigate_form(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbtracerrm_multi_navigate_form_cb);
  } // do_ajax_form_tbtracerrm_multi_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtracerrm_multi']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbtracerrm_multi_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbtracerrm_multi_navigate_form_cb_after_alert);
  } // do_ajax_form_tbtracerrm_multi_navigate_form_cb
  function do_ajax_form_tbtracerrm_multi_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_tbtracerrm_multi_navigate_form_cb_after_alert
  function sc_hide_form_tbtracerrm_multi_form()
  {
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "nostruk_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "sc_field_2_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "rm_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "jenis_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "sc_field_1_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "usia_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "alamat_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "dokter_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "lokasi_" + iNumLinha;
    iTotCampos++;
    ...
    ajax_error_list["nostruk_" + iNumLinha] = {"label": "No Struk<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["sc_field_2_" + iNumLinha] = {"label": "Tgl. Minta<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["rm_" + iNumLinha] = {"label": "RM<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["jenis_" + iNumLinha] = {"label": "Jenis<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["sc_field_1_" + iNumLinha] = {"label": "Nama Pasien<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_error_list["alamat_" + iNumLinha] = {"label": "Alamat<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["dokter_" + iNumLinha] = {"label": "Dokter<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["lokasi_" + iNumLinha] = {"label": "Lokasi<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_field_mult["nostruk_"][iNumLinha] = "nostruk_" + iNumLinha;
    ajax_field_mult["sc_field_2_"][iNumLinha] = "sc_field_2_" + iNumLinha;
    ajax_field_mult["rm_"][iNumLinha] = "rm_" + iNumLinha;
    ajax_field_mult["jenis_"][iNumLinha] = "jenis_" + iNumLinha;
    ajax_field_mult["sc_field_1_"][iNumLinha] = "sc_field_1_" + iNumLinha;
    ajax_field_mult["usia_"][iNumLinha] = "usia_" + iNumLinha;
    ajax_field_mult["alamat_"][iNumLinha] = "alamat_" + iNumLinha;
    ajax_field_mult["dokter_"][iNumLinha] = "dokter_" + iNumLinha;
    ajax_field_mult["lokasi_"][iNumLinha] = "lokasi_" + iNumLinha;
    ...
    ajax_field_id["rm_" + iNumLinha] = new Array("hidden_field_label_rm_", "hidden_field_data_rm_" + iNumLinha);
    ajax_field_id["jenis_" + iNumLinha] = new Array("hidden_field_label_jenis_", "hidden_field_data_jenis_" + iNumLinha);
    ...
    ajax_field_id["alamat_" + iNumLinha] = new Array("hidden_field_label_alamat_", "hidden_field_data_alamat_" + iNumLinha);
    ajax_field_id["dokter_" + iNumLinha] = new Array("hidden_field_label_dokter_", "hidden_field_data_dokter_" + iNumLinha);
    ajax_field_id["lokasi_" + iNumLinha] = new Array("hidden_field_label_lokasi_", "hidden_field_data_lokasi_" + iNumLinha);
    ...
    ajax_error_count["nostruk_" + iNumLinha] = "off";
    ajax_error_count["sc_field_2_" + iNumLinha] = "off";
    ajax_error_count["rm_" + iNumLinha] = "off";
    ajax_error_count["jenis_" + iNumLinha] = "off";
    ajax_error_count["sc_field_1_" + iNumLinha] = "off";
    ajax_error_count["usia_" + iNumLinha] = "off";
    ajax_error_count["alamat_" + iNumLinha] = "off";
    ajax_error_count["dokter_" + iNumLinha] = "off";
    ajax_error_count["lokasi_" + iNumLinha] = "off";
...
?>
    ...
    ajax_read_only["nostruk_" + iNumLinha] = "on";
    ajax_read_only["sc_field_2_" + iNumLinha] = "on";
    ajax_read_only["rm_" + iNumLinha] = "on";
    ajax_read_only["jenis_" + iNumLinha] = "off";
    ajax_read_only["sc_field_1_" + iNumLinha] = "off";
    ajax_read_only["usia_" + iNumLinha] = "on";
    ajax_read_only["alamat_" + iNumLinha] = "off";
    ajax_read_only["dokter_" + iNumLinha] = "on";
    ajax_read_only["lokasi_" + iNumLinha] = "off";
...
?>
    ...
    ajax_read_only["sc_field_2_" + iNumLinha] = "on";
    ajax_read_only["rm_" + iNumLinha] = "on";
    ajax_read_only["jenis_" + iNumLinha] = "on";
    ajax_read_only["sc_field_1_" + iNumLinha] = "on";
    ajax_read_only["usia_" + iNumLinha] = "on";
    ajax_read_only["alamat_" + iNumLinha] = "on";
    ajax_read_only["dokter_" + iNumLinha] = "on";
    ajax_read_only["lokasi_" + iNumLinha] = "on";
...
?>
  ...
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["nostruk_" + iNumLinha] = null;
    ajax_error_list["sc_field_2_" + iNumLinha] = null;
    ajax_error_list["rm_" + iNumLinha] = null;
    ajax_error_list["jenis_" + iNumLinha] = null;
    ajax_error_list["sc_field_1_" + iNumLinha] = null;
    ajax_error_list["usia_" + iNumLinha] = null;
    ajax_error_list["alamat_" + iNumLinha] = null;
    ajax_error_list["dokter_" + iNumLinha] = null;
    ajax_error_list["lokasi_" + iNumLinha] = null;
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["nostruk_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["nostruk_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["nostruk_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["nostruk_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["nostruk_" + iNumLinha]["onfocus"] = new Array();
      ...
      ajax_error_list["rm_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["rm_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["rm_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["rm_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["rm_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["jenis_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["jenis_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["jenis_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["jenis_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["jenis_" + iNumLinha]["onfocus"] = new Array();
      ...
      ajax_error_list["alamat_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["alamat_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["alamat_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["alamat_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["alamat_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["dokter_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["dokter_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["dokter_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["dokter_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["dokter_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["lokasi_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["lokasi_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["lokasi_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["lokasi_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["lokasi_" + iNumLinha]["onfocus"] = new Array();
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['nostruk_'])) ? $this->nmgp_cmp_readonly['nostruk_'] : 'on';
?>
    scAjaxFieldRead("nostruk_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['sc_field_2_'])) ? $this->nmgp_cmp_readonly['sc_field_2_'] : 'on';
?>
    scAjaxFieldRead("sc_field_2_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['rm_'])) ? $this->nmgp_cmp_readonly['rm_'] : 'on';
?>
    scAjaxFieldRead("rm_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['jenis_'])) ? $this->nmgp_cmp_readonly['jenis_'] : 'off';
?>
    scAjaxFieldRead("jenis_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['usia_'])) ? $this->nmgp_cmp_readonly['usia_'] : 'on';
?>
    scAjaxFieldRead("usia_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['alamat_'])) ? $this->nmgp_cmp_readonly['alamat_'] : 'off';
?>
    scAjaxFieldRead("alamat_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['dokter_'])) ? $this->nmgp_cmp_readonly['dokter_'] : 'on';
?>
    scAjaxFieldRead("dokter_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['lokasi_'])) ? $this->nmgp_cmp_readonly['lokasi_'] : 'off';
?>
    scAjaxFieldRead("lokasi_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
?>
  ...
  function mdCloseObjects(iSeq)
  {
    ...
    scAjaxFieldRead("nostruk_" + iSeq, "on");
    scAjaxFieldRead("sc_field_2_" + iSeq, "on");
    scAjaxFieldRead("rm_" + iSeq, "on");
    scAjaxFieldRead("jenis_" + iSeq, "on");
    scAjaxFieldRead("sc_field_1_" + iSeq, "on");
    scAjaxFieldRead("usia_" + iSeq, "on");
    scAjaxFieldRead("alamat_" + iSeq, "on");
    scAjaxFieldRead("dokter_" + iSeq, "on");
    scAjaxFieldRead("lokasi_" + iSeq, "on");
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["id_" + iRow] || "on" == ajax_error_count["nostruk_" + iRow] || "on" == ajax_error_count["sc_field_2_" + iRow] || "on" == ajax_error_count["rm_" + iRow] || "on" == ajax_error_count["jenis_" + iRow] || "on" == ajax_error_count["sc_field_1_" + iRow] || "on" == ajax_error_count["usia_" + iRow] || "on" == ajax_error_count["alamat_" + iRow] || "on" == ajax_error_count["dokter_" + iRow] || "on" == ajax_error_count["lokasi_" + iRow] || "on" == ajax_error_count["status_" + iRow]))
    {
      ...
      $("#hidden_field_data_nostruk_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_field_2_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_rm_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_jenis_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_field_1_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_usia_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_alamat_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_dokter_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_lokasi_" + iRow).addClass("scFormErrorLine");
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["id_" + iRow] && "off" == ajax_error_count["nostruk_" + iRow] && "off" == ajax_error_count["sc_field_2_" + iRow] && "off" == ajax_error_count["rm_" + iRow] && "off" == ajax_error_count["jenis_" + iRow] && "off" == ajax_error_count["sc_field_1_" + iRow] && "off" == ajax_error_count["usia_" + iRow] && "off" == ajax_error_count["alamat_" + iRow] && "off" == ajax_error_count["dokter_" + iRow] && "off" == ajax_error_count["lokasi_" + iRow] && "off" == ajax_error_count["status_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["id_" + iRow] = "off";
        ajax_error_count["nostruk_" + iRow] = "off";
        ajax_error_count["sc_field_2_" + iRow] = "off";
        ajax_error_count["rm_" + iRow] = "off";
        ajax_error_count["jenis_" + iRow] = "off";
        ajax_error_count["sc_field_1_" + iRow] = "off";
        ajax_error_count["usia_" + iRow] = "off";
        ajax_error_count["alamat_" + iRow] = "off";
        ajax_error_count["dokter_" + iRow] = "off";
        ajax_error_count["lokasi_" + iRow] = "off";
      ...
      $("#hidden_field_data_nostruk_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_sc_field_2_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_rm_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_jenis_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_sc_field_1_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_usia_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_alamat_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_dokter_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_lokasi_" + iRow).removeClass("scFormErrorLine");
