<?php
class form_tbdetailrad_form extends form_tbdetailrad_apl
{
function Form_Init()
{
...
<HEAD>
 <TITLE><?php if ('novo' == $this->nmgp_opcao) { echo strip_tags("" . $this->Ini->Nm_lang['lang_othr_frmi_title'] . " tbdetailrad"); } else { echo strip_tags("" . $this->Ini->Nm_lang['lang_othr_frmu_title'] . " tbdetailrad"); } ?></TITLE>
...
<?php
if ($this->Embutida_form && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailrad']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailrad']['sc_modal'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailrad']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailrad']['sc_redir_atualiz'] == 'ok')
{
?>
...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailrad']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_tbdetailrad/form_tbdetailrad_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_tbdetailrad_sajax_js.php");
?>
<script type="text/javascript">
...
function navpage_atualiza(str_navpage)
{
 ...
 function nm_field_disabled_reset() {
  for (var i = 0; i < iAjaxNewLine; i++) {
    nm_field_disabled("rate_=enabled", "", i);
  }
 } // nm_field_disabled_reset
<?php

include_once('form_tbdetailrad_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailrad']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailrad']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailrad']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailrad']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailrad']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailrad']['recarga'];
}
if ('novo' == $opcao_botoes && $this->Embutida_form)
{
    $opcao_botoes = 'inicio';
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailrad']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailrad']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
?>
...
<?php
 include_once("form_tbdetailrad_js0.php");
?>
<script type="text/javascript"> 
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_tbdetailrad'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_tbdetailrad'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailrad']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailrad']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailrad']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailrad']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailrad']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<div class="scFormHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFormHeaderFont" style="float: left; text-transform: uppercase;"><?php if ($this->nmgp_opcao == "novo") { echo "" . $this->Ini->Nm_lang['lang_othr_frmi_title'] . " tbdetailrad"; } else { echo "" . $this->Ini->Nm_lang['lang_othr_frmu_title'] . " tbdetailrad"; } ?></div>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailrad']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailrad']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailrad']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailrad']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailrad']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailrad']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailrad']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailrad']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailrad']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailrad']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailrad']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailrad']['fast_search'][2] : "";
?> 
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailrad']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailrad']['run_iframe'] != "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailrad']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailrad']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailrad']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailrad']['run_iframe'] == "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailrad']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailrad']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailrad']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailrad']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailrad']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailrad']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailrad']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailrad']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailrad']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailrad']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailrad']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailrad']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
 ...
 ?>
   ...
   <?php if (isset($this->nmgp_cmp_hidden['radcode_']) && $this->nmgp_cmp_hidden['radcode_'] == 'off') { $sStyleHidden_radcode_ = 'display: none'; }
    ...
    <TD class="scFormLabelOddMult css_radcode__label" id="hidden_field_label_radcode_" style="<?php echo $sStyleHidden_radcode_; ?>" > <?php echo $this->nm_new_label['radcode_'] ?> <span class="scFormRequiredOddMult">*</span> </TD>
   <?php } ?>
...
{ 
   ...
   { 
       ob_start();
       $iStart = sizeof($this->form_vert_form_tbdetailrad);
       $guarda_nmgp_opcao = $this->nmgp_opcao;
       $guarda_form_vert_form_tbdetailrad = $this->form_vert_form_tbdetailrad;
       $this->nmgp_opcao = 'novo';
   } 
   if ($this->Embutida_form && empty($this->form_vert_form_tbdetailrad))
   {
       $sc_seq_vert = 0;
   }
   ...
   foreach ($this->form_vert_form_tbdetailrad as $sc_seq_vert => $sc_lixo)
   {
       $this->loadRecordState($sc_seq_vert);
       $this->trancode_ = $this->form_vert_form_tbdetailrad[$sc_seq_vert]['trancode_'];
       $this->docshare_ = $this->form_vert_form_tbdetailrad[$sc_seq_vert]['docshare_'];
       $this->tlc_ = $this->form_vert_form_tbdetailrad[$sc_seq_vert]['tlc_'];
       $this->includepaket_ = $this->form_vert_form_tbdetailrad[$sc_seq_vert]['includepaket_'];
       $this->basicrate_ = $this->form_vert_form_tbdetailrad[$sc_seq_vert]['basicrate_'];
       $this->markup_ = $this->form_vert_form_tbdetailrad[$sc_seq_vert]['markup_'];
       $this->hasil_ = $this->form_vert_form_tbdetailrad[$sc_seq_vert]['hasil_'];
       $this->inapclass_ = $this->form_vert_form_tbdetailrad[$sc_seq_vert]['inapclass_'];
       $this->pasien_ = $this->form_vert_form_tbdetailrad[$sc_seq_vert]['pasien_'];
       $this->penjamin_ = $this->form_vert_form_tbdetailrad[$sc_seq_vert]['penjamin_'];
       $this->kode_akun_ = $this->form_vert_form_tbdetailrad[$sc_seq_vert]['kode_akun_'];
       ...
       elseif ($Line_Add)
       {
        ...
        $this->radcode_ = $this->form_vert_form_tbdetailrad[$sc_seq_vert]['radcode_']; 
       ...
       $this->rate_ = $this->form_vert_form_tbdetailrad[$sc_seq_vert]['rate_']; 
       $rate_ = $this->rate_; 
       $sStyleHidden_rate_ = '';
       ...
       $this->disc_ = $this->form_vert_form_tbdetailrad[$sc_seq_vert]['disc_']; 
       $disc_ = $this->disc_; 
       $sStyleHidden_disc_ = '';
       ...
       $this->trandate_ = $this->form_vert_form_tbdetailrad[$sc_seq_vert]['trandate_'] . ' ' . $this->form_vert_form_tbdetailrad[$sc_seq_vert]['trandate__hora']; 
       ...
       $this->id_ = $this->form_vert_form_tbdetailrad[$sc_seq_vert]['id_']; 
       $id_ = $this->id_; 
       if (!isset($this->nmgp_cmp_hidden['id_']))
       {
           $this->nmgp_cmp_hidden['id_'] = 'off';
...
<?php echo nmButtonOutput($this->arr_buttons, "bmd_novo", "do_ajax_form_tbdetailrad_add_new_line(" . $sc_seq_vert . ")", "do_ajax_form_tbdetailrad_add_new_line(" . $sc_seq_vert . ")", "sc_new_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
<?php }?>
<?php
  $Style_add_line = (!$Line_Add) ? "display: none" : "";
?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_form_tbdetailrad_cancel_insert(" . $sc_seq_vert . ")", "do_ajax_form_tbdetailrad_cancel_insert(" . $sc_seq_vert . ")", "sc_canceli_line_" . $sc_seq_vert . "", "", "", "" . $Style_add_line . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_form_tbdetailrad_cancel_update(" . $sc_seq_vert . ")", "do_ajax_form_tbdetailrad_cancel_update(" . $sc_seq_vert . ")", "sc_cancelu_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
 </TD>
   <?php }?>
   <?php if (isset($this->nmgp_cmp_hidden['radcode_']) && $this->nmgp_cmp_hidden['radcode_'] == 'off') { $sc_hidden_yes++; ?>
<input type=hidden name="radcode_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($this->radcode_) . "\">"; ?>
...
else
{
   ...
   while (!empty($todo[$x])) 
   {
          ...
          if (isset($this->Embutida_ronly) && $this->Embutida_ronly && isset($this->radcode__1))
          {
              foreach ($this->radcode__1 as $tmp_radcode_)
              {
                  if (trim($tmp_radcode_) === trim($cadaselect[1])) { $radcode__look .= $cadaselect[0] . '__SC_BREAK_LINE__'; }
              }
          }
          elseif (trim($this->radcode_) === trim($cadaselect[1])) { $radcode__look .= $cadaselect[0]; } 
          $x++; 
   }

?>
<input type="hidden" name="radcode_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($radcode_) . "\">" . $radcode__look . ""; ?>
<?php } else { ?>
<?php
   $todo = $this->Form_lookup_radcode_();
   $x = 0 ; 
   $radcode__look = ""; 
   while (!empty($todo[$x])) 
   {
          ...
          if (empty($radcode__look))
          {
              $radcode__look = $this->radcode_;
          }
   $x = 0; 
   echo "<span id=\"id_read_on_radcode_" . $sc_seq_vert . "\" class=\"css_radcode__line\" style=\"" .  $sStyleReadLab_radcode_ . "\">" . $this->form_encode_input($radcode__look) . "</span><span id=\"id_read_off_radcode_" . $sc_seq_vert . "\" class=\"css_read_off_radcode_\" style=\"white-space: nowrap; " . $sStyleReadInp_radcode_ . "\">";
   echo " <span id=\"idAjaxSelect_radcode_" .  $sc_seq_vert . "\"><select class=\"sc-js-input scFormObjectOddMult css_radcode__obj\" style=\"\" id=\"id_sc_field_radcode_" . $sc_seq_vert . "\" name=\"radcode_" . $sc_seq_vert . "\" size=\"1\" alt=\"{type: 'select', enterTab: false}\">" ; 
   echo "\r" ; 
   ...
   while (!empty($todo[$x]) && !$nm_nao_carga) 
   {
          ...
          if (trim($this->radcode_) === trim($cadaselect[1])) 
          {
              echo " selected" ; 
          }
          if (strtoupper($cadaselect[2]) == "S") 
          {
              if (empty($this->radcode_)) 
              {
                  echo " selected" ;
              } 
           } 
...
<span id="id_read_on_rate_<?php echo $sc_seq_vert ?>" class="sc-ui-readonly-rate_<?php echo $sc_seq_vert ?> css_rate__line" style="<?php echo $sStyleReadLab_rate_; ?>"><?php echo $this->rate_; ?></span><span id="id_read_off_rate_<?php echo $sc_seq_vert ?>" class="css_read_off_rate_" style="white-space: nowrap;<?php echo $sStyleReadInp_rate_; ?>">
 ...
 size=19 alt="{datatype: 'currency', currencySymbol: '<?php echo $this->field_config['rate_']['symbol_mon']; ?>', currencyPosition: '<?php echo ((1 == $this->field_config['rate_']['format_pos'] || 3 == $this->field_config['rate_']['format_pos']) ? 'left' : 'right'); ?>', maxLength: 19, precision: 0, decimalSep: '<?php echo str_replace("'", "\'", $this->field_config['rate_']['symbol_dec']); ?>', thousandsSep: '<?php echo str_replace("'", "\'", $this->field_config['rate_']['symbol_grp']); ?>', thousandsFormat: <?php echo $this->field_config['rate_']['symbol_fmt']; ?>, manualDecimals: false, allowNegative: false, onlyNegative: false, negativePos: <?php echo (4 == $this->field_config['rate_']['format_neg'] ? "'suffix'" : "'prefix'") ?>, alignment: 'left', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddMultWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
...
<?php   
   ...
   { 
       ...
       $this->form_vert_form_tbdetailrad = $guarda_form_vert_form_tbdetailrad;
   } 
   if ($Table_refresh) 
   { 
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailrad']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailrad']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailrad']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailrad']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailrad']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailrad']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailrad']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailrad']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailrad']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<?php
if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailrad']['run_modal']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailrad']['run_modal'])
{
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailrad']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailrad']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_tbdetailrad");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_tbdetailrad");
 parent.scAjaxDetailHeight("form_tbdetailrad", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
<script type="text/javascript">
	function scBtnFn_sys_format_inc() {
		if ($("#sc_b_new_t.sc-unique-btn-1").length && $("#sc_b_new_t.sc-unique-btn-1").is(":visible")) {
			do_ajax_form_tbdetailrad_add_new_line(); return false;
			 return;
		}
...
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailrad']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
