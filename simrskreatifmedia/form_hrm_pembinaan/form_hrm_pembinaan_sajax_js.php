  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_hrm_pembinaan" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_hrm_pembinaan_form();
	}

  // ---------- Validate tgl_pembinaan_
  function do_ajax_form_hrm_pembinaan_validate_tgl_pembinaan_(iNumLinha)
  {
    var nomeCampo_tgl_pembinaan_ = "tgl_pembinaan_" + iNumLinha;
    var var_tgl_pembinaan_ = scAjaxGetFieldText(nomeCampo_tgl_pembinaan_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_pembinaan_validate_tgl_pembinaan_(var_tgl_pembinaan_, iNumLinha, var_script_case_init, do_ajax_form_hrm_pembinaan_validate_tgl_pembinaan__cb);
  } // do_ajax_form_hrm_pembinaan_validate_tgl_pembinaan_

  function do_ajax_form_hrm_pembinaan_validate_tgl_pembinaan__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "tgl_pembinaan_" + iLineNumber;
    }
    else
    {
      sFieldValid = "tgl_pembinaan_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "tgl_pembinaan_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "tgl_pembinaan_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_pembinaan_validate_tgl_pembinaan__cb

  // ---------- Validate perihal_
  function do_ajax_form_hrm_pembinaan_validate_perihal_(iNumLinha)
  {
    var nomeCampo_perihal_ = "perihal_" + iNumLinha;
    var var_perihal_ = scAjaxGetFieldText(nomeCampo_perihal_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_pembinaan_validate_perihal_(var_perihal_, iNumLinha, var_script_case_init, do_ajax_form_hrm_pembinaan_validate_perihal__cb);
  } // do_ajax_form_hrm_pembinaan_validate_perihal_

  function do_ajax_form_hrm_pembinaan_validate_perihal__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_pembinaan_validate_perihal__cb

  // ---------- Validate capaian_hasil_
  function do_ajax_form_hrm_pembinaan_validate_capaian_hasil_(iNumLinha)
  {
    var nomeCampo_capaian_hasil_ = "capaian_hasil_" + iNumLinha;
    var var_capaian_hasil_ = scAjaxGetFieldText(nomeCampo_capaian_hasil_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_pembinaan_validate_capaian_hasil_(var_capaian_hasil_, iNumLinha, var_script_case_init, do_ajax_form_hrm_pembinaan_validate_capaian_hasil__cb);
  } // do_ajax_form_hrm_pembinaan_validate_capaian_hasil_

  function do_ajax_form_hrm_pembinaan_validate_capaian_hasil__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "capaian_hasil_" + iLineNumber;
    }
    else
    {
      sFieldValid = "capaian_hasil_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "capaian_hasil_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "capaian_hasil_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_pembinaan_validate_capaian_hasil__cb

  // ---------- Validate id_
  function do_ajax_form_hrm_pembinaan_validate_id_(iNumLinha)
  {
    var nomeCampo_id_ = "id_" + iNumLinha;
    var var_id_ = scAjaxGetFieldHidden(nomeCampo_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_pembinaan_validate_id_(var_id_, iNumLinha, var_script_case_init, do_ajax_form_hrm_pembinaan_validate_id__cb);
  } // do_ajax_form_hrm_pembinaan_validate_id_

  function do_ajax_form_hrm_pembinaan_validate_id__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_pembinaan_validate_id__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_hrm_pembinaan_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_hrm_pembinaan_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_hrm_pembinaan_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_hrm_pembinaan_add_new_line_cb);
  } // do_ajax_form_hrm_pembinaan_add_new_line

  function do_ajax_form_hrm_pembinaan_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_hrm_pembinaan_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_hrm_pembinaan_backup_line(iNumLinha)
  {
    var var_id_ = scAjaxGetFieldHidden("id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_pembinaan_backup_line(var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_hrm_pembinaan_backup_line_cb);
  } // do_ajax_form_hrm_pembinaan_backup_line

  function do_ajax_form_hrm_pembinaan_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_hrm_pembinaan_backup_line_cb

  function do_ajax_form_hrm_pembinaan_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_hrm_pembinaan_cancel_insert

  function do_ajax_form_hrm_pembinaan_cancel_update(iSeqVert)
  {
    do_ajax_form_hrm_pembinaan_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_hrm_pembinaan_cancel_update

  function do_ajax_form_hrm_pembinaan_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_hrm_pembinaan_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_hrm_pembinaan_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_hrm_pembinaan_table_refresh(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_hrm_pembinaan_table_refresh_cb);
  } //  do_ajax_form_hrm_pembinaan_table_refresh

  function do_ajax_form_hrm_pembinaan_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_hrm_pembinaan_table_refresh_cb_after_alert);
  } // do_ajax_form_hrm_pembinaan_table_refresh_cb
  function do_ajax_form_hrm_pembinaan_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_hrm_pembinaan_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_hrm_pembinaan_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_hrm_pembinaan_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    sc_num_ult_line = iNumLinha;
    sc_num_ult_tr   = indexTR;
    scAjaxHideMessage();
    var var_tgl_pembinaan_ = scAjaxGetFieldText("tgl_pembinaan_" + iNumLinha);
    var var_perihal_ = scAjaxGetFieldText("perihal_" + iNumLinha);
    var var_capaian_hasil_ = scAjaxGetFieldText("capaian_hasil_" + iNumLinha);
    var var_id_ = scAjaxGetFieldHidden("id_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_hrm_pembinaan_submit_form(var_tgl_pembinaan_, var_perihal_, var_capaian_hasil_, var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_hrm_pembinaan_submit_form_cb);
  } // do_ajax_form_hrm_pembinaan_submit_form

  function do_ajax_form_hrm_pembinaan_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("tgl_pembinaan_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("perihal_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("capaian_hasil_" + sc_num_ult_line);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_hrm_pembinaan_submit_form_cb_after_alert);
  } // do_ajax_form_hrm_pembinaan_submit_form_cb
  function do_ajax_form_hrm_pembinaan_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_hrm_pembinaan_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_hrm_pembinaan_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_hrm_pembinaan_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("tgl_pembinaan_" + iNavForm);
      scAjaxHideErrorDisplay("perihal_" + iNavForm);
      scAjaxHideErrorDisplay("capaian_hasil_" + iNavForm);
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_hrm_pembinaan_navigate_form(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_hrm_pembinaan_navigate_form_cb);
  } // do_ajax_form_hrm_pembinaan_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_hrm_pembinaan']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_hrm_pembinaan_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_hrm_pembinaan_navigate_form_cb_after_alert);
  } // do_ajax_form_hrm_pembinaan_navigate_form_cb
  function do_ajax_form_hrm_pembinaan_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_hrm_pembinaan_navigate_form_cb_after_alert
  function sc_hide_form_hrm_pembinaan_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "tgl_pembinaan_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "perihal_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "capaian_hasil_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "id_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["tgl_pembinaan_" + iNumLinha] = {"label": "Tgl Pembinaan<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_error_list["capaian_hasil_" + iNumLinha] = {"label": "Capaian Hasil<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_field_mult["tgl_pembinaan_"][iNumLinha] = "tgl_pembinaan_" + iNumLinha;
    ajax_field_mult["perihal_"][iNumLinha] = "perihal_" + iNumLinha;
    ajax_field_mult["capaian_hasil_"][iNumLinha] = "capaian_hasil_" + iNumLinha;
    ajax_field_mult["id_"][iNumLinha] = "id_" + iNumLinha;
    ajax_field_id["tgl_pembinaan_" + iNumLinha] = new Array("hidden_field_label_tgl_pembinaan_", "hidden_field_data_tgl_pembinaan_" + iNumLinha);
    ajax_field_id["perihal_" + iNumLinha] = new Array("hidden_field_label_perihal_", "hidden_field_data_perihal_" + iNumLinha);
    ajax_field_id["capaian_hasil_" + iNumLinha] = new Array("hidden_field_label_capaian_hasil_", "hidden_field_data_capaian_hasil_" + iNumLinha);
    ajax_error_count["tgl_pembinaan_" + iNumLinha] = "off";
    ajax_error_count["perihal_" + iNumLinha] = "off";
    ajax_error_count["capaian_hasil_" + iNumLinha] = "off";
    ajax_error_count["id_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["tgl_pembinaan_" + iNumLinha] = "off";
    ajax_read_only["perihal_" + iNumLinha] = "off";
    ajax_read_only["capaian_hasil_" + iNumLinha] = "off";
...
{
?>
    ajax_read_only["tgl_pembinaan_" + iNumLinha] = "on";
    ajax_read_only["perihal_" + iNumLinha] = "on";
    ajax_read_only["capaian_hasil_" + iNumLinha] = "on";
    ajax_read_only["id_" + iNumLinha] = "on";
<?php
}
?>
  ...
  {
    ajax_error_list["tgl_pembinaan_" + iNumLinha] = null;
    ajax_error_list["perihal_" + iNumLinha] = null;
    ajax_error_list["capaian_hasil_" + iNumLinha] = null;
  ...
  var ajax_field_mult = {
    "tgl_pembinaan_": new Array(),
    "perihal_": new Array(),
    "capaian_hasil_": new Array(),
    "id_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["tgl_pembinaan_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["tgl_pembinaan_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["tgl_pembinaan_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["tgl_pembinaan_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["tgl_pembinaan_" + iNumLinha]["onfocus"] = new Array();
      ...
      ajax_error_list["capaian_hasil_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["capaian_hasil_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["capaian_hasil_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["capaian_hasil_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["capaian_hasil_" + iNumLinha]["onfocus"] = new Array();
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['tgl_pembinaan_'])) ? $this->nmgp_cmp_readonly['tgl_pembinaan_'] : 'off';
?>
    scAjaxFieldRead("tgl_pembinaan_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['capaian_hasil_'])) ? $this->nmgp_cmp_readonly['capaian_hasil_'] : 'off';
?>
    scAjaxFieldRead("capaian_hasil_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
?>
  ...
  {
    scAjaxFieldRead("tgl_pembinaan_" + iSeq, "on");
    scAjaxFieldRead("perihal_" + iSeq, "on");
    scAjaxFieldRead("capaian_hasil_" + iSeq, "on");
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["tgl_pembinaan_" + iRow] || "on" == ajax_error_count["perihal_" + iRow] || "on" == ajax_error_count["capaian_hasil_" + iRow] || "on" == ajax_error_count["id_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_tgl_pembinaan_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_perihal_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_capaian_hasil_" + iRow).addClass("scFormErrorLine");
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["tgl_pembinaan_" + iRow] && "off" == ajax_error_count["perihal_" + iRow] && "off" == ajax_error_count["capaian_hasil_" + iRow] && "off" == ajax_error_count["id_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["tgl_pembinaan_" + iRow] = "off";
        ajax_error_count["perihal_" + iRow] = "off";
        ajax_error_count["capaian_hasil_" + iRow] = "off";
      ...
      $("#hidden_field_data_tgl_pembinaan_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_perihal_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_capaian_hasil_" + iRow).removeClass("scFormErrorLine");
