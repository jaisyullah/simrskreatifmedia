<?php
@session_start() ;
$_SESSION['scriptcase']['pdfreport_tbpayment_ri']['sc_process_barr'] = true;
require_once('../pdfreport_tbpayment_ri/index.php');
unset($_SESSION['scriptcase']['pdfreport_tbpayment_ri']['sc_process_barr']);
$ExportCtrl = new pdfreport_tbpayment_ri_export_control;
$ExportCtrl->Export_barr();

class pdfreport_tbpayment_ri_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_chart_title'] ?> tbpayment_ri :: Excel</TITLE>
