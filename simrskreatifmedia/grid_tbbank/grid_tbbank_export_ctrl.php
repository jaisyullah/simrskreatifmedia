<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tbbank']['sc_process_barr'] = true;
require_once('../grid_tbbank/index.php');
unset($_SESSION['scriptcase']['grid_tbbank']['sc_process_barr']);
$ExportCtrl = new grid_tbbank_export_control;
$ExportCtrl->Export_barr();

class grid_tbbank_export_control
{
