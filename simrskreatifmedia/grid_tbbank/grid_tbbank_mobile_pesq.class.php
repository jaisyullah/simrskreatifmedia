...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_bankname_cond" name="bankname_cond" onChange="nm_campos_between(document.getElementById('id_vis_bankname'), this, 'bankname')">
      ...
      <br><span id="id_hide_bankname"  <?php echo $str_hide_bankname?>><?php
      if ($bankname != "")
      {
      $bankname_look = substr($this->Db->qstr($bankname), 1, -1); 
      $nmgp_def_dados = array(); 
