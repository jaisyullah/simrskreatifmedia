...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_lap_logistik"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_lap_logistik"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_lap_logistik']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_lap_logistik']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_lap_logistik']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_lap_logistik']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_lap_logistik']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_lap_logistik']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_lap_logistik']['embutida_filho'] as $ind => $sc_init)
          {
