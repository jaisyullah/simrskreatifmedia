<?php
@session_start() ;
$_SESSION['scriptcase']['grid_lap_logistik']['sc_process_barr'] = true;
require_once('../grid_lap_logistik/index.php');
unset($_SESSION['scriptcase']['grid_lap_logistik']['sc_process_barr']);
$ExportCtrl = new grid_lap_logistik_export_control;
$ExportCtrl->Export_barr();

class grid_lap_logistik_export_control
{
