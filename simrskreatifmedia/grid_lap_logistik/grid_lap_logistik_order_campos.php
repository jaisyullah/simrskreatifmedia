<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_lap_logistik']['glo_nm_path_imag_temp'] . "/sc_apl_default_simrskreatifmedia.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_lap_logistik_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_lap_logistik_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_lap_logistik']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_lap_logistik']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["nama"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_lap_logistik']['labels']["nama"])) ? $_SESSION['sc_session'][$sc_init]['grid_lap_logistik']['labels']["nama"] : "Nama";
   $tab_ger_campos['jenis'] = "on";
   $tab_def_campos['jenis'] = "Jenis";
   $tab_labels["jenis"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_lap_logistik']['labels']["jenis"])) ? $_SESSION['sc_session'][$sc_init]['grid_lap_logistik']['labels']["jenis"] : "Jenis";
   $tab_ger_campos['golongan'] = "on";
   $tab_def_campos['golongan'] = "Golongan";
   $tab_labels["golongan"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_lap_logistik']['labels']["golongan"])) ? $_SESSION['sc_session'][$sc_init]['grid_lap_logistik']['labels']["golongan"] : "Golongan";
   ...
   {
       $tab_def_campos['sc_field_0'] = "`Sisa Stok`";
   }
   $tab_labels["sc_field_0"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_lap_logistik']['labels']["sc_field_0"])) ? $_SESSION['sc_session'][$sc_init]['grid_lap_logistik']['labels']["sc_field_0"] : "Sisa Stok";
   ...
   {
       $tab_def_campos['sc_field_1'] = "`Satuan Box`";
   }
   $tab_labels["sc_field_1"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_lap_logistik']['labels']["sc_field_1"])) ? $_SESSION['sc_session'][$sc_init]['grid_lap_logistik']['labels']["sc_field_1"] : "Satuan Box";
   $tab_ger_campos['konversi'] = "on";
   $tab_def_campos['konversi'] = "Konversi";
   $tab_labels["konversi"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_lap_logistik']['labels']["konversi"])) ? $_SESSION['sc_session'][$sc_init]['grid_lap_logistik']['labels']["konversi"] : "Konversi";
   ...
   {
       $tab_def_campos['sc_field_2'] = "`Avg. Usage`";
   }
   $tab_labels["sc_field_2"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_lap_logistik']['labels']["sc_field_2"])) ? $_SESSION['sc_session'][$sc_init]['grid_lap_logistik']['labels']["sc_field_2"] : "Avg Usage";
   ...
   {
       $tab_def_campos['sc_field_3'] = "`Min Stok`";
   }
   $tab_labels["sc_field_3"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_lap_logistik']['labels']["sc_field_3"])) ? $_SESSION['sc_session'][$sc_init]['grid_lap_logistik']['labels']["sc_field_3"] : "Min Stok";
   ...
   {
       $tab_def_campos['sc_field_4'] = "`Max Stok`";
   }
   $tab_labels["sc_field_4"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_lap_logistik']['labels']["sc_field_4"])) ? $_SESSION['sc_session'][$sc_init]['grid_lap_logistik']['labels']["sc_field_4"] : "Max Stok";
   ...
   {
       $tab_def_campos['sc_field_5'] = "`Satuan Kecil`";
   }
   $tab_labels["sc_field_5"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_lap_logistik']['labels']["sc_field_5"])) ? $_SESSION['sc_session'][$sc_init]['grid_lap_logistik']['labels']["sc_field_5"] : "Satuan Kecil";
   $tab_ger_campos['dipesan'] = "on";
   $tab_def_campos['dipesan'] = "Dipesan";
   $tab_labels["dipesan"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_lap_logistik']['labels']["dipesan"])) ? $_SESSION['sc_session'][$sc_init]['grid_lap_logistik']['labels']["dipesan"] : "Dipesan";
   ...
   {
       $tab_def_campos['sc_field_6'] = "`Satuan Pesan`";
   }
   $tab_labels["sc_field_6"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_lap_logistik']['labels']["sc_field_6"])) ? $_SESSION['sc_session'][$sc_init]['grid_lap_logistik']['labels']["sc_field_6"] : "Satuan Pesan";
   $tab_ger_campos['principal'] = "on";
   $tab_def_campos['principal'] = "Principal";
   $tab_labels["principal"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_lap_logistik']['labels']["principal"])) ? $_SESSION['sc_session'][$sc_init]['grid_lap_logistik']['labels']["principal"] : "Principal";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_lap_logistik']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_lap_logistik']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_lap_logistik']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_lap_logistik']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_lap_logistik']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_lap_logistik']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_lap_logistik']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_lap_logistik']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_lap_logistik']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_lap_logistik_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_lap_logistik']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_lap_logistik']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_lap_logistik']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_lap_logistik']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_lap_logistik']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
