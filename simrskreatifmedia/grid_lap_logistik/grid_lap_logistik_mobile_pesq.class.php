...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "`sisa stok`";$Nm_numeric[] = "`avg_ usage`";$Nm_numeric[] = "`min stok`";$Nm_numeric[] = "`max stok`";$Nm_numeric[] = "dipesan";$Nm_numeric[] = "`sisa stok`";$Nm_numeric[] = "`avg_ usage`";$Nm_numeric[] = "`min stok`";$Nm_numeric[] = "`max stok`";$Nm_numeric[] = "dipesan";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_nama_cond" name="nama_cond" onChange="nm_campos_between(document.getElementById('id_vis_nama'), this, 'nama')">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_golongan_cond" name="golongan_cond" onChange="nm_campos_between(document.getElementById('id_vis_golongan'), this, 'golongan')">
      ...
      <br><span id="id_hide_golongan"  <?php echo $str_hide_golongan?>><?php
      if ($golongan != "")
      {
      $golongan_look = substr($this->Db->qstr($golongan), 1, -1); 
      $nmgp_def_dados = array(); 
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      ...
      <br><span id="id_hide_sc_field_0"  <?php echo $str_hide_sc_field_0?>><INPUT  type="text" id="SC_sc_field_0" name="sc_field_0" value="<?php echo NM_encode_input($sc_field_0) ?>" size=23 alt="{datatype: 'integer', maxLength: 23, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
