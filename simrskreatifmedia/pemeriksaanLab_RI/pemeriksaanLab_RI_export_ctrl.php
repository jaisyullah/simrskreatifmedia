<?php
@session_start() ;
$_SESSION['scriptcase']['pemeriksaanLab_RI']['sc_process_barr'] = true;
require_once('../pemeriksaanLab_RI/index.php');
unset($_SESSION['scriptcase']['pemeriksaanLab_RI']['sc_process_barr']);
$ExportCtrl = new pemeriksaanLab_RI_export_control;
$ExportCtrl->Export_barr();

class pemeriksaanLab_RI_export_control
{
