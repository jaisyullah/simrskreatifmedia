...
class pemeriksaanLab_RI_rtf
{
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "pemeriksaanLab_RI.rtf";
   }
   //---- 
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      $nm_raiz_img  = ""; 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pemeriksaanLab_RI']['rtf_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['pemeriksaanLab_RI']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['pemeriksaanLab_RI']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['pemeriksaanLab_RI']['rtf_name']);
      }
   ...
   function NM_export_tandai()
   {
         ...
         $this->tandai = str_replace('<', '&lt;', $this->tandai);
         $this->tandai = str_replace('>', '&gt;', $this->tandai);
         $this->Texto_tag .= "<td>" . $this->tandai . "</td>\r\n";
   }
   //----- satuan
   ...
   function NM_export_struklab()
   {
         ...
         $this->struklab = str_replace('<', '&lt;', $this->struklab);
         $this->struklab = str_replace('>', '&gt;', $this->struklab);
         $this->Texto_tag .= "<td>" . $this->struklab . "</td>\r\n";
   }
   //----- sc_field_0
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['pemeriksaanLab_RI']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['pemeriksaanLab_RI']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
