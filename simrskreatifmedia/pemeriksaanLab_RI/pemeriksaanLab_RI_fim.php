...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____pemeriksaanLab_RI"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____pemeriksaanLab_RI"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['pemeriksaanLab_RI']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['pemeriksaanLab_RI']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['pemeriksaanLab_RI']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['pemeriksaanLab_RI']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['pemeriksaanLab_RI']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['pemeriksaanLab_RI']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['pemeriksaanLab_RI']['embutida_filho'] as $ind => $sc_init)
          {
