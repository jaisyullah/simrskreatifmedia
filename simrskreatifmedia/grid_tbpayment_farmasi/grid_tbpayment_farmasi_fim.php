...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_tbpayment_farmasi"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_tbpayment_farmasi"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_pay_farmasi'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tbpayment_farmasi']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_tbpayment_farmasi']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tbpayment_farmasi']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_tbpayment_farmasi']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_tbpayment_farmasi']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_tbpayment_farmasi</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_tbpayment_farmasi']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_tbpayment_farmasi']['embutida_filho'] as $ind => $sc_init)
          {
