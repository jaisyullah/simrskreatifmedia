...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "tranDate";$Nm_datas[] = "tranDate";$Nm_datas[] = "paidDate";$Nm_datas[] = "paidDate";$Nm_numeric[] = "id";$Nm_numeric[] = "nostruk";$Nm_numeric[] = "jmltagihan";$Nm_numeric[] = "jmlbayar";$Nm_numeric[] = "deposit";$Nm_numeric[] = "potongan";$Nm_numeric[] = "hrsdibayar";
...
<HTML>
<HEAD>
 <TITLE> - History Pembayaran Farmasi</TITLE>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_nostruk_cond" name="nostruk_cond" onChange="nm_campos_between(document.getElementById('id_vis_nostruk'), this, 'nostruk')">
      ...
      <br><span id="id_hide_nostruk"  <?php echo $str_hide_nostruk?>><?php
      if ($nostruk != "")
      {
      $nostruk_look = substr($this->Db->qstr($nostruk), 1, -1); 
      $nmgp_def_dados = array(); 
