<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tbpayment_farmasi']['sc_process_barr'] = true;
require_once('../grid_tbpayment_farmasi/index.php');
unset($_SESSION['scriptcase']['grid_tbpayment_farmasi']['sc_process_barr']);
$ExportCtrl = new grid_tbpayment_farmasi_export_control;
$ExportCtrl->Export_barr();

class grid_tbpayment_farmasi_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - History Pembayaran Farmasi :: Excel</TITLE>
