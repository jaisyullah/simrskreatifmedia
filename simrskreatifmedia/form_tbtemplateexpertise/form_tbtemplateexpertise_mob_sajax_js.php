  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbtemplateexpertise_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbtemplateexpertise_mob_form();
	}

  // ---------- Validate id
  function do_ajax_form_tbtemplateexpertise_mob_validate_id()
  {
    var nomeCampo_id = "id";
    var var_id = scAjaxGetFieldHidden(nomeCampo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtemplateexpertise_mob_validate_id(var_id, var_script_case_init, do_ajax_form_tbtemplateexpertise_mob_validate_id_cb);
  } // do_ajax_form_tbtemplateexpertise_mob_validate_id

  function do_ajax_form_tbtemplateexpertise_mob_validate_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtemplateexpertise_mob_validate_id_cb

  // ---------- Validate nama
  function do_ajax_form_tbtemplateexpertise_mob_validate_nama()
  {
    var nomeCampo_nama = "nama";
    var var_nama = scAjaxGetFieldText(nomeCampo_nama);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtemplateexpertise_mob_validate_nama(var_nama, var_script_case_init, do_ajax_form_tbtemplateexpertise_mob_validate_nama_cb);
  } // do_ajax_form_tbtemplateexpertise_mob_validate_nama

  function do_ajax_form_tbtemplateexpertise_mob_validate_nama_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nama";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtemplateexpertise_mob_validate_nama_cb

  // ---------- Validate expertise
  function do_ajax_form_tbtemplateexpertise_mob_validate_expertise()
  {
    var nomeCampo_expertise = "expertise";
    var var_expertise = scAjaxGetFieldEditorHtml(nomeCampo_expertise);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtemplateexpertise_mob_validate_expertise(var_expertise, var_script_case_init, do_ajax_form_tbtemplateexpertise_mob_validate_expertise_cb);
  } // do_ajax_form_tbtemplateexpertise_mob_validate_expertise

  function do_ajax_form_tbtemplateexpertise_mob_validate_expertise_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "expertise";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtemplateexpertise_mob_validate_expertise_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tbtemplateexpertise_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tbtemplateexpertise_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id = scAjaxGetFieldHidden("id");
    var var_nama = scAjaxGetFieldText("nama");
    var var_expertise = scAjaxGetFieldEditorHtml("expertise");
    ...
    scAjaxProcOn();
    x_ajax_form_tbtemplateexpertise_mob_submit_form(var_id, var_nama, var_expertise, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbtemplateexpertise_mob_submit_form_cb);
  } // do_ajax_form_tbtemplateexpertise_mob_submit_form

  function do_ajax_form_tbtemplateexpertise_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("expertise");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tbtemplateexpertise_mob_submit_form_cb_after_alert);
  } // do_ajax_form_tbtemplateexpertise_mob_submit_form_cb
  function do_ajax_form_tbtemplateexpertise_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbtemplateexpertise_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tbtemplateexpertise_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_tbtemplateexpertise_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbtemplateexpertise_mob_navigate_form_cb);
  } // do_ajax_form_tbtemplateexpertise_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtemplateexpertise_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbtemplateexpertise_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbtemplateexpertise_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_tbtemplateexpertise_mob_navigate_form_cb
  function do_ajax_form_tbtemplateexpertise_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_tbtemplateexpertise_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_tbtemplateexpertise_mob_navigate_form_cb_after_alert
  function sc_hide_form_tbtemplateexpertise_mob_form()
  {
  ...
  var ajax_error_list = {
    ...
    "expertise": {"label": "Expertise", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  ajax_field_mult["expertise"][1] = "expertise";

  var ajax_field_id = {
    "nama": new Array("hidden_field_label_nama", "hidden_field_data_nama"),
    "expertise": new Array("hidden_field_label_expertise", "hidden_field_data_expertise")
  };
