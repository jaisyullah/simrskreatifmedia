  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbsoaprawatjalan_old" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbsoaprawatjalan_old_form();
	}

  // ---------- Validate tglsoap_
  function do_ajax_form_tbsoaprawatjalan_old_validate_tglsoap_(iNumLinha)
  {
    var nomeCampo_tglsoap_ = "tglsoap_" + iNumLinha;
    var var_tglsoap_ = scAjaxGetFieldText(nomeCampo_tglsoap_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbsoaprawatjalan_old_validate_tglsoap_(var_tglsoap_, iNumLinha, var_script_case_init, do_ajax_form_tbsoaprawatjalan_old_validate_tglsoap__cb);
  } // do_ajax_form_tbsoaprawatjalan_old_validate_tglsoap_

  function do_ajax_form_tbsoaprawatjalan_old_validate_tglsoap__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "tglsoap_" + iLineNumber;
    }
    else
    {
      sFieldValid = "tglsoap_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "tglsoap_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "tglsoap_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbsoaprawatjalan_old_validate_tglsoap__cb

  // ---------- Validate subject_
  function do_ajax_form_tbsoaprawatjalan_old_validate_subject_(iNumLinha)
  {
    var nomeCampo_subject_ = "subject_" + iNumLinha;
    var var_subject_ = scAjaxGetFieldText(nomeCampo_subject_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbsoaprawatjalan_old_validate_subject_(var_subject_, iNumLinha, var_script_case_init, do_ajax_form_tbsoaprawatjalan_old_validate_subject__cb);
  } // do_ajax_form_tbsoaprawatjalan_old_validate_subject_

  function do_ajax_form_tbsoaprawatjalan_old_validate_subject__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "subject_" + iLineNumber;
    }
    else
    {
      sFieldValid = "subject_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "subject_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "subject_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbsoaprawatjalan_old_validate_subject__cb

  // ---------- Validate object_
  function do_ajax_form_tbsoaprawatjalan_old_validate_object_(iNumLinha)
  {
    var nomeCampo_object_ = "object_" + iNumLinha;
    var var_object_ = scAjaxGetFieldText(nomeCampo_object_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbsoaprawatjalan_old_validate_object_(var_object_, iNumLinha, var_script_case_init, do_ajax_form_tbsoaprawatjalan_old_validate_object__cb);
  } // do_ajax_form_tbsoaprawatjalan_old_validate_object_

  function do_ajax_form_tbsoaprawatjalan_old_validate_object__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "object_" + iLineNumber;
    }
    else
    {
      sFieldValid = "object_";
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "object_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "object_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbsoaprawatjalan_old_validate_object__cb

  // ---------- Validate assesment_
  function do_ajax_form_tbsoaprawatjalan_old_validate_assesment_(iNumLinha)
  {
    var nomeCampo_assesment_ = "assesment_" + iNumLinha;
    var var_assesment_ = scAjaxGetFieldText(nomeCampo_assesment_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbsoaprawatjalan_old_validate_assesment_(var_assesment_, iNumLinha, var_script_case_init, do_ajax_form_tbsoaprawatjalan_old_validate_assesment__cb);
  } // do_ajax_form_tbsoaprawatjalan_old_validate_assesment_

  function do_ajax_form_tbsoaprawatjalan_old_validate_assesment__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "assesment_" + iLineNumber;
    }
    else
    {
      sFieldValid = "assesment_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "assesment_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "assesment_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbsoaprawatjalan_old_validate_assesment__cb

  // ---------- Validate plan_
  function do_ajax_form_tbsoaprawatjalan_old_validate_plan_(iNumLinha)
  {
    var nomeCampo_plan_ = "plan_" + iNumLinha;
    var var_plan_ = scAjaxGetFieldText(nomeCampo_plan_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbsoaprawatjalan_old_validate_plan_(var_plan_, iNumLinha, var_script_case_init, do_ajax_form_tbsoaprawatjalan_old_validate_plan__cb);
  } // do_ajax_form_tbsoaprawatjalan_old_validate_plan_

  function do_ajax_form_tbsoaprawatjalan_old_validate_plan__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "plan_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "plan_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbsoaprawatjalan_old_validate_plan__cb

  // ---------- Validate pelaksana_
  function do_ajax_form_tbsoaprawatjalan_old_validate_pelaksana_(iNumLinha)
  {
    var nomeCampo_pelaksana_ = "pelaksana_" + iNumLinha;
    var var_pelaksana_ = scAjaxGetFieldText(nomeCampo_pelaksana_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbsoaprawatjalan_old_validate_pelaksana_(var_pelaksana_, iNumLinha, var_script_case_init, do_ajax_form_tbsoaprawatjalan_old_validate_pelaksana__cb);
  } // do_ajax_form_tbsoaprawatjalan_old_validate_pelaksana_

  function do_ajax_form_tbsoaprawatjalan_old_validate_pelaksana__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbsoaprawatjalan_old_validate_pelaksana__cb

  // ---------- Validate id_
  function do_ajax_form_tbsoaprawatjalan_old_validate_id_(iNumLinha)
  {
    var nomeCampo_id_ = "id_" + iNumLinha;
    var var_id_ = scAjaxGetFieldHidden(nomeCampo_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbsoaprawatjalan_old_validate_id_(var_id_, iNumLinha, var_script_case_init, do_ajax_form_tbsoaprawatjalan_old_validate_id__cb);
  } // do_ajax_form_tbsoaprawatjalan_old_validate_id_

  function do_ajax_form_tbsoaprawatjalan_old_validate_id__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbsoaprawatjalan_old_validate_id__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_tbsoaprawatjalan_old_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_tbsoaprawatjalan_old_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tbsoaprawatjalan_old_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_tbsoaprawatjalan_old_add_new_line_cb);
  } // do_ajax_form_tbsoaprawatjalan_old_add_new_line

  function do_ajax_form_tbsoaprawatjalan_old_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
    ...
    nm_field_disabled("pelaksana_=disabled", "", iAjaxNewLine);
  } // do_ajax_form_tbsoaprawatjalan_old_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_tbsoaprawatjalan_old_backup_line(iNumLinha)
  {
    var var_id_ = scAjaxGetFieldHidden("id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbsoaprawatjalan_old_backup_line(var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_tbsoaprawatjalan_old_backup_line_cb);
  } // do_ajax_form_tbsoaprawatjalan_old_backup_line

  function do_ajax_form_tbsoaprawatjalan_old_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_tbsoaprawatjalan_old_backup_line_cb

  function do_ajax_form_tbsoaprawatjalan_old_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_tbsoaprawatjalan_old_cancel_insert

  function do_ajax_form_tbsoaprawatjalan_old_cancel_update(iSeqVert)
  {
    do_ajax_form_tbsoaprawatjalan_old_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_tbsoaprawatjalan_old_cancel_update

  function do_ajax_form_tbsoaprawatjalan_old_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_tbsoaprawatjalan_old_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_tbsoaprawatjalan_old_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_tbsoaprawatjalan_old_table_refresh(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbsoaprawatjalan_old_table_refresh_cb);
  } //  do_ajax_form_tbsoaprawatjalan_old_table_refresh

  function do_ajax_form_tbsoaprawatjalan_old_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_tbsoaprawatjalan_old_table_refresh_cb_after_alert);
  } // do_ajax_form_tbsoaprawatjalan_old_table_refresh_cb
  function do_ajax_form_tbsoaprawatjalan_old_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxSetNavStatus("t");
    sc_insert_open = false;
  } // do_ajax_form_tbsoaprawatjalan_old_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_tbsoaprawatjalan_old_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_tbsoaprawatjalan_old_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    sc_num_ult_line = iNumLinha;
    sc_num_ult_tr   = indexTR;
    scAjaxHideMessage();
    var var_tglsoap_ = scAjaxGetFieldText("tglsoap_" + iNumLinha);
    var var_subject_ = scAjaxGetFieldText("subject_" + iNumLinha);
    var var_object_ = scAjaxGetFieldText("object_" + iNumLinha);
    var var_assesment_ = scAjaxGetFieldText("assesment_" + iNumLinha);
    var var_plan_ = scAjaxGetFieldText("plan_" + iNumLinha);
    var var_pelaksana_ = scAjaxGetFieldText("pelaksana_" + iNumLinha);
    var var_id_ = scAjaxGetFieldHidden("id_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_tbsoaprawatjalan_old_submit_form(var_tglsoap_, var_subject_, var_object_, var_assesment_, var_plan_, var_pelaksana_, var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbsoaprawatjalan_old_submit_form_cb);
  } // do_ajax_form_tbsoaprawatjalan_old_submit_form

  function do_ajax_form_tbsoaprawatjalan_old_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("tglsoap_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("subject_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("object_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("assesment_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("plan_" + sc_num_ult_line);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_tbsoaprawatjalan_old_submit_form_cb_after_alert);
  } // do_ajax_form_tbsoaprawatjalan_old_submit_form_cb
  function do_ajax_form_tbsoaprawatjalan_old_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbsoaprawatjalan_old_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tbsoaprawatjalan_old_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_tbsoaprawatjalan_old_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("tglsoap_" + iNavForm);
      scAjaxHideErrorDisplay("subject_" + iNavForm);
      scAjaxHideErrorDisplay("object_" + iNavForm);
      scAjaxHideErrorDisplay("assesment_" + iNavForm);
      scAjaxHideErrorDisplay("plan_" + iNavForm);
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tbsoaprawatjalan_old_navigate_form(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbsoaprawatjalan_old_navigate_form_cb);
  } // do_ajax_form_tbsoaprawatjalan_old_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbsoaprawatjalan_old']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbsoaprawatjalan_old_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbsoaprawatjalan_old_navigate_form_cb_after_alert);
  } // do_ajax_form_tbsoaprawatjalan_old_navigate_form_cb
  function do_ajax_form_tbsoaprawatjalan_old_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_tbsoaprawatjalan_old_navigate_form_cb_after_alert
  function sc_hide_form_tbsoaprawatjalan_old_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "tglsoap_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "subject_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "object_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "assesment_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "plan_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "pelaksana_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "id_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["tglsoap_" + iNumLinha] = {"label": "Tgl SOAP<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["subject_" + iNumLinha] = {"label": "Subject<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["object_" + iNumLinha] = {"label": "Object<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["assesment_" + iNumLinha] = {"label": "Assesment<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["plan_" + iNumLinha] = {"label": "Plan<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_field_mult["tglsoap_"][iNumLinha] = "tglsoap_" + iNumLinha;
    ajax_field_mult["subject_"][iNumLinha] = "subject_" + iNumLinha;
    ajax_field_mult["object_"][iNumLinha] = "object_" + iNumLinha;
    ajax_field_mult["assesment_"][iNumLinha] = "assesment_" + iNumLinha;
    ajax_field_mult["plan_"][iNumLinha] = "plan_" + iNumLinha;
    ajax_field_mult["pelaksana_"][iNumLinha] = "pelaksana_" + iNumLinha;
    ajax_field_mult["id_"][iNumLinha] = "id_" + iNumLinha;
    ajax_field_id["tglsoap_" + iNumLinha] = new Array("hidden_field_label_tglsoap_", "hidden_field_data_tglsoap_" + iNumLinha);
    ajax_field_id["subject_" + iNumLinha] = new Array("hidden_field_label_subject_", "hidden_field_data_subject_" + iNumLinha);
    ajax_field_id["object_" + iNumLinha] = new Array("hidden_field_label_object_", "hidden_field_data_object_" + iNumLinha);
    ajax_field_id["assesment_" + iNumLinha] = new Array("hidden_field_label_assesment_", "hidden_field_data_assesment_" + iNumLinha);
    ajax_field_id["plan_" + iNumLinha] = new Array("hidden_field_label_plan_", "hidden_field_data_plan_" + iNumLinha);
    ajax_field_id["pelaksana_" + iNumLinha] = new Array("hidden_field_label_pelaksana_", "hidden_field_data_pelaksana_" + iNumLinha);
    ajax_error_count["tglsoap_" + iNumLinha] = "off";
    ajax_error_count["subject_" + iNumLinha] = "off";
    ajax_error_count["object_" + iNumLinha] = "off";
    ajax_error_count["assesment_" + iNumLinha] = "off";
    ajax_error_count["plan_" + iNumLinha] = "off";
...
{
?>
    ajax_read_only["tglsoap_" + iNumLinha] = "off";
    ajax_read_only["subject_" + iNumLinha] = "off";
    ajax_read_only["object_" + iNumLinha] = "off";
    ajax_read_only["assesment_" + iNumLinha] = "off";
    ajax_read_only["plan_" + iNumLinha] = "off";
...
{
?>
    ajax_read_only["tglsoap_" + iNumLinha] = "on";
    ajax_read_only["subject_" + iNumLinha] = "on";
    ajax_read_only["object_" + iNumLinha] = "on";
    ajax_read_only["assesment_" + iNumLinha] = "on";
    ajax_read_only["plan_" + iNumLinha] = "on";
...
?>
  ...
  {
    ajax_error_list["tglsoap_" + iNumLinha] = null;
    ajax_error_list["subject_" + iNumLinha] = null;
    ajax_error_list["object_" + iNumLinha] = null;
    ajax_error_list["assesment_" + iNumLinha] = null;
    ajax_error_list["plan_" + iNumLinha] = null;
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["tglsoap_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["tglsoap_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["tglsoap_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["tglsoap_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["tglsoap_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["subject_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["subject_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["subject_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["subject_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["subject_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["object_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["object_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["object_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["object_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["object_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["assesment_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["assesment_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["assesment_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["assesment_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["assesment_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["plan_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["plan_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["plan_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["plan_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["plan_" + iNumLinha]["onfocus"] = new Array();
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['tglsoap_'])) ? $this->nmgp_cmp_readonly['tglsoap_'] : 'off';
?>
    scAjaxFieldRead("tglsoap_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['subject_'])) ? $this->nmgp_cmp_readonly['subject_'] : 'off';
?>
    scAjaxFieldRead("subject_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['object_'])) ? $this->nmgp_cmp_readonly['object_'] : 'off';
?>
    scAjaxFieldRead("object_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['assesment_'])) ? $this->nmgp_cmp_readonly['assesment_'] : 'off';
?>
    scAjaxFieldRead("assesment_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['plan_'])) ? $this->nmgp_cmp_readonly['plan_'] : 'off';
?>
    scAjaxFieldRead("plan_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
?>
  ...
  {
    scAjaxFieldRead("tglsoap_" + iSeq, "on");
    scAjaxFieldRead("subject_" + iSeq, "on");
    scAjaxFieldRead("object_" + iSeq, "on");
    scAjaxFieldRead("assesment_" + iSeq, "on");
    scAjaxFieldRead("plan_" + iSeq, "on");
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["tglsoap_" + iRow] || "on" == ajax_error_count["subject_" + iRow] || "on" == ajax_error_count["object_" + iRow] || "on" == ajax_error_count["assesment_" + iRow] || "on" == ajax_error_count["plan_" + iRow] || "on" == ajax_error_count["pelaksana_" + iRow] || "on" == ajax_error_count["id_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_tglsoap_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_subject_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_object_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_assesment_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_plan_" + iRow).addClass("scFormErrorLine");
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["tglsoap_" + iRow] && "off" == ajax_error_count["subject_" + iRow] && "off" == ajax_error_count["object_" + iRow] && "off" == ajax_error_count["assesment_" + iRow] && "off" == ajax_error_count["plan_" + iRow] && "off" == ajax_error_count["pelaksana_" + iRow] && "off" == ajax_error_count["id_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["tglsoap_" + iRow] = "off";
        ajax_error_count["subject_" + iRow] = "off";
        ajax_error_count["object_" + iRow] = "off";
        ajax_error_count["assesment_" + iRow] = "off";
        ajax_error_count["plan_" + iRow] = "off";
      ...
      $("#hidden_field_data_tglsoap_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_subject_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_object_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_assesment_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_plan_" + iRow).removeClass("scFormErrorLine");
