...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_id_' + iSeqRow).bind('blur', function() { sc_form_tbrujukanlab_id__onblur(this, iSeqRow) })
                                 .bind('change', function() { sc_form_tbrujukanlab_id__onchange(this, iSeqRow) })
                                 .bind('focus', function() { sc_form_tbrujukanlab_id__onfocus(this, iSeqRow) });
  $('#id_sc_field_doccode_' + iSeqRow).bind('blur', function() { sc_form_tbrujukanlab_doccode__onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_form_tbrujukanlab_doccode__onchange(this, iSeqRow) })
                                      .bind('focus', function() { sc_form_tbrujukanlab_doccode__onfocus(this, iSeqRow) });
  $('#id_sc_field_labcode_' + iSeqRow).bind('blur', function() { sc_form_tbrujukanlab_labcode__onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_form_tbrujukanlab_labcode__onchange(this, iSeqRow) })
                                      .bind('focus', function() { sc_form_tbrujukanlab_labcode__onfocus(this, iSeqRow) });
  $('#id_sc_field_trandate_' + iSeqRow).bind('blur', function() { sc_form_tbrujukanlab_trandate__onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_form_tbrujukanlab_trandate__onchange(this, iSeqRow) })
                                       .bind('focus', function() { sc_form_tbrujukanlab_trandate__onfocus(this, iSeqRow) });
  $('#id_sc_field_trandate__hora' + iSeqRow).bind('blur', function() { sc_form_tbrujukanlab_trandate__hora_onblur(this, iSeqRow) })
                                            .bind('change', function() { sc_form_tbrujukanlab_trandate__hora_onchange(this, iSeqRow) })
                                            .bind('focus', function() { sc_form_tbrujukanlab_trandate__hora_onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_form_tbrujukanlab_id__onblur(oThis, iSeqRow) {
  do_ajax_form_tbrujukanlab_validate_id_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_tbrujukanlab_id__onchange(oThis, iSeqRow) {
  nm_check_insert(iSeqRow);
}

function sc_form_tbrujukanlab_id__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_form_tbrujukanlab_doccode__onblur(oThis, iSeqRow) {
  do_ajax_form_tbrujukanlab_validate_doccode_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_tbrujukanlab_doccode__onchange(oThis, iSeqRow) {
  nm_check_insert(iSeqRow);
}

function sc_form_tbrujukanlab_doccode__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_form_tbrujukanlab_labcode__onblur(oThis, iSeqRow) {
  do_ajax_form_tbrujukanlab_validate_labcode_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_tbrujukanlab_labcode__onchange(oThis, iSeqRow) {
  nm_check_insert(iSeqRow);
}

function sc_form_tbrujukanlab_labcode__onfocus(oThis, iSeqRow) {
  scCssFocus(oThis, iSeqRow);
}

function sc_form_tbrujukanlab_trandate__onblur(oThis, iSeqRow) {
  do_ajax_form_tbrujukanlab_validate_trandate_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_tbrujukanlab_trandate__hora_onblur(oThis, iSeqRow) {
  do_ajax_form_tbrujukanlab_validate_trandate_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_tbrujukanlab_trandate__onchange(oThis, iSeqRow) {
  nm_check_insert(iSeqRow);
}

function sc_form_tbrujukanlab_trandate__hora_onchange(oThis, iSeqRow) {
  nm_check_insert(iSeqRow);
}

function sc_form_tbrujukanlab_trandate__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_form_tbrujukanlab_trandate__hora_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}
...
function scHidePage(pageNo) {
	$("#id_form_tbrujukanlab_form" + pageNo).hide();
}
