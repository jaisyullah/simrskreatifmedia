...
class rekapKeseluruhan_master_ri_res_rtf
{
   var $Erro;
   var $Ini;
   var $Res;
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "rekapKeseluruhan_master_ri.rtf";
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['rekapKeseluruhan_master_ri']['rtf_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['rekapKeseluruhan_master_ri']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['rekapKeseluruhan_master_ri']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['rekapKeseluruhan_master_ri']['rtf_name']);
      }
   ...
   function gera_texto_tag()
   {
      ...
      $this->build_labels = $_SESSION['sc_session'][$this->Ini->sc_page]['rekapKeseluruhan_master_ri']['arr_export']['label'];
      $this->build_data   = $_SESSION['sc_session'][$this->Ini->sc_page]['rekapKeseluruhan_master_ri']['arr_export']['data'];
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['rekapKeseluruhan_master_ri']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['rekapKeseluruhan_master_ri']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
