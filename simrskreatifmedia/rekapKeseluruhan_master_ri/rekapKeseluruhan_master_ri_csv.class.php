...
class rekapKeseluruhan_master_ri_csv
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function grava_arquivo()
   {
	...
	noKartu,
      ...
      { 
          ...
          $this->Res = new rekapKeseluruhan_master_ri_res_csv();
          $this->prep_modulos("Res");
          $_SESSION['sc_session'][$this->Ini->sc_page]['rekapKeseluruhan_master_ri']['csv_res_grid'] = true;
          $this->Res->monta_csv();
      } 
      if (!$this->Ini->sc_export_ajax) {
      ...
      { 
          ...
          { 
              $str_zip    = "";
              $Arq_res    = $_SESSION['sc_session'][$this->Ini->sc_page]['rekapKeseluruhan_master_ri']['csv_res_file'];
              ...
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['rekapKeseluruhan_master_ri']['csv_res_grid']);
              unlink($_SESSION['sc_session'][$this->Ini->sc_page]['rekapKeseluruhan_master_ri']['csv_res_file']);
          }
          unlink($Arq_input);
