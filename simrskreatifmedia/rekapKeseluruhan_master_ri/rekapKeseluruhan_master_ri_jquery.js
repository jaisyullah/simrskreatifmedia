...
function ajax_navigate(opc, parm)
{
    ...
    return new Promise(function(resolve, reject) {$.ajax({
     ...
     .done(function(jsonNavigate) {
        ...
        document.getElementById('nmsc_iframe_liga_A_rekapKeseluruhan_master_ri').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_E_rekapKeseluruhan_master_ri').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_D_rekapKeseluruhan_master_ri').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_B_rekapKeseluruhan_master_ri').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_A_rekapKeseluruhan_master_ri').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_E_rekapKeseluruhan_master_ri').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_D_rekapKeseluruhan_master_ri').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_B_rekapKeseluruhan_master_ri').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_A_rekapKeseluruhan_master_ri').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_E_rekapKeseluruhan_master_ri').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_D_rekapKeseluruhan_master_ri').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_B_rekapKeseluruhan_master_ri').style.width  = '0px';
        if (oResp["redirInfo"]) {
           nmAjaxRedir(oResp);
        }
        if (oResp["setValue"]) {
