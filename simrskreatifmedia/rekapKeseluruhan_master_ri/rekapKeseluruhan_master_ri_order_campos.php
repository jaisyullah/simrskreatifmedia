...
<?php
   ...
   $Ord_Cmp = new rekapKeseluruhan_master_ri_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class rekapKeseluruhan_master_ri_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['rekapKeseluruhan_master_ri']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['rekapKeseluruhan_master_ri']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["trandate"]   = (isset($_SESSION['sc_session'][$sc_init]['rekapKeseluruhan_master_ri']['labels']["trandate"])) ? $_SESSION['sc_session'][$sc_init]['rekapKeseluruhan_master_ri']['labels']["trandate"] : "Tgl. Transaksi";
   $tab_ger_campos['trancode'] = "on";
   $tab_def_campos['trancode'] = "tranCode";
   $tab_labels["trancode"]   = (isset($_SESSION['sc_session'][$sc_init]['rekapKeseluruhan_master_ri']['labels']["trancode"])) ? $_SESSION['sc_session'][$sc_init]['rekapKeseluruhan_master_ri']['labels']["trancode"] : "Kode Pelayanan";
   $tab_ger_campos['custcode'] = "on";
   $tab_def_campos['custcode'] = "custCode";
   $tab_labels["custcode"]   = (isset($_SESSION['sc_session'][$sc_init]['rekapKeseluruhan_master_ri']['labels']["custcode"])) ? $_SESSION['sc_session'][$sc_init]['rekapKeseluruhan_master_ri']['labels']["custcode"] : "Pasien";
   $tab_ger_campos['dokter'] = "on";
   $tab_def_campos['dokter'] = "dokter";
   $tab_labels["dokter"]   = (isset($_SESSION['sc_session'][$sc_init]['rekapKeseluruhan_master_ri']['labels']["dokter"])) ? $_SESSION['sc_session'][$sc_init]['rekapKeseluruhan_master_ri']['labels']["dokter"] : "DPJP";
   $tab_ger_campos['jenispayment'] = "on";
   $tab_def_campos['jenispayment'] = "jenisPayment";
   $tab_labels["jenispayment"]   = (isset($_SESSION['sc_session'][$sc_init]['rekapKeseluruhan_master_ri']['labels']["jenispayment"])) ? $_SESSION['sc_session'][$sc_init]['rekapKeseluruhan_master_ri']['labels']["jenispayment"] : "Jenis Payment";
   ...
   {
       $tab_def_campos['tag'] = "sum(if(jmlTagihan<=jmlBayar,jmlTagihan,jmlBayar))";
   }
   $tab_labels["tag"]   = (isset($_SESSION['sc_session'][$sc_init]['rekapKeseluruhan_master_ri']['labels']["tag"])) ? $_SESSION['sc_session'][$sc_init]['rekapKeseluruhan_master_ri']['labels']["tag"] : "Tag";
   $tab_ger_campos['nostruk'] = "on";
   $tab_def_campos['nostruk'] = "noStruk";
   $tab_labels["nostruk"]   = (isset($_SESSION['sc_session'][$sc_init]['rekapKeseluruhan_master_ri']['labels']["nostruk"])) ? $_SESSION['sc_session'][$sc_init]['rekapKeseluruhan_master_ri']['labels']["nostruk"] : "No Struk";
   ...
   $tab_labels["kategori"]   = (isset($_SESSION['sc_session'][$sc_init]['rekapKeseluruhan_master_ri']['labels']["kategori"])) ? $_SESSION['sc_session'][$sc_init]['rekapKeseluruhan_master_ri']['labels']["kategori"] : "Kategori";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['rekapKeseluruhan_master_ri']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['rekapKeseluruhan_master_ri']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['rekapKeseluruhan_master_ri']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['rekapKeseluruhan_master_ri']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['rekapKeseluruhan_master_ri']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['rekapKeseluruhan_master_ri']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['rekapKeseluruhan_master_ri']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['rekapKeseluruhan_master_ri']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['rekapKeseluruhan_master_ri']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "rekapKeseluruhan_master_ri_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['rekapKeseluruhan_master_ri']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['rekapKeseluruhan_master_ri']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['rekapKeseluruhan_master_ri']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['rekapKeseluruhan_master_ri']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['rekapKeseluruhan_master_ri']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
