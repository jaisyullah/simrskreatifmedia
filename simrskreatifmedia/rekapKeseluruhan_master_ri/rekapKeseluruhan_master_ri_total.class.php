...
class rekapKeseluruhan_master_ri_total
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function __construct($sc_page)
   {
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['rekapKeseluruhan_master_ri']['campos_busca']) && !empty($_SESSION['sc_session'][$this->sc_page]['rekapKeseluruhan_master_ri']['campos_busca']))
      { 
   ...
   function quebra_geral_sc_free_total($res_limit=false)
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['rekapKeseluruhan_master_ri']['contr_total_geral'] == "OK") 
      { 
          return; 
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['rekapKeseluruhan_master_ri']['tot_geral'] = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
          $nm_comando = "select count(*), sum(if(jmlTagihan<=jmlBayar,jmlTagihan,jmlBayar)) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['rekapKeseluruhan_master_ri']['where_pesq']; 
      } 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['rekapKeseluruhan_master_ri']['tot_geral'][0] = "" . $this->Ini->Nm_lang['lang_msgs_totl'] . ""; 
      while (!$rt->EOF) 
      {
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['rekapKeseluruhan_master_ri']['tot_geral'][1])) 
         {
            $_SESSION['sc_session'][$this->Ini->sc_page]['rekapKeseluruhan_master_ri']['tot_geral'][1] = 1 ; 
         } 
         else
         {
            $_SESSION['sc_session'][$this->Ini->sc_page]['rekapKeseluruhan_master_ri']['tot_geral'][1] += 1 ; 
         } 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['rekapKeseluruhan_master_ri']['tot_geral'][2])) 
         {
            $rt->fields[1] = str_replace(",", ".", $rt->fields[1]);
            $rt->fields[1] = (string)$rt->fields[1]; 
            $_SESSION['sc_session'][$this->Ini->sc_page]['rekapKeseluruhan_master_ri']['tot_geral'][2] = $rt->fields[1]; 
         } 
         else
         {
            $rt->fields[1] = str_replace(",", ".", $rt->fields[1]);
      ...
      $rt->Close(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['rekapKeseluruhan_master_ri']['contr_total_geral'] = "OK";
   } 
