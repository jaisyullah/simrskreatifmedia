<?php
@session_start() ;
$_SESSION['scriptcase']['rekapKeseluruhan_master_ri']['sc_process_barr'] = true;
require_once('../rekapKeseluruhan_master_ri/index.php');
unset($_SESSION['scriptcase']['rekapKeseluruhan_master_ri']['sc_process_barr']);
$ExportCtrl = new rekapKeseluruhan_master_ri_export_control;
$ExportCtrl->Export_barr();

class rekapKeseluruhan_master_ri_export_control
{
