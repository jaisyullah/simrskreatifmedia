  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbtarifinap" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbtarifinap_form();
	}

  // ---------- Validate namakelas_
  function do_ajax_form_tbtarifinap_validate_namakelas_(iNumLinha)
  {
    var nomeCampo_namakelas_ = "namakelas_" + iNumLinha;
    var var_namakelas_ = scAjaxGetFieldText(nomeCampo_namakelas_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtarifinap_validate_namakelas_(var_namakelas_, iNumLinha, var_script_case_init, do_ajax_form_tbtarifinap_validate_namakelas__cb);
  } // do_ajax_form_tbtarifinap_validate_namakelas_

  function do_ajax_form_tbtarifinap_validate_namakelas__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "namakelas_" + iLineNumber;
    }
    else
    {
      sFieldValid = "namakelas_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "namakelas_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "namakelas_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtarifinap_validate_namakelas__cb

  // ---------- Validate tarifkamar_
  function do_ajax_form_tbtarifinap_validate_tarifkamar_(iNumLinha)
  {
    var nomeCampo_tarifkamar_ = "tarifkamar_" + iNumLinha;
    var var_tarifkamar_ = scAjaxGetFieldText(nomeCampo_tarifkamar_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtarifinap_validate_tarifkamar_(var_tarifkamar_, iNumLinha, var_script_case_init, do_ajax_form_tbtarifinap_validate_tarifkamar__cb);
  } // do_ajax_form_tbtarifinap_validate_tarifkamar_

  function do_ajax_form_tbtarifinap_validate_tarifkamar__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "tarifkamar_" + iLineNumber;
    }
    else
    {
      sFieldValid = "tarifkamar_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "tarifkamar_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "tarifkamar_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtarifinap_validate_tarifkamar__cb

  // ---------- Validate tarifkeperawatan_
  function do_ajax_form_tbtarifinap_validate_tarifkeperawatan_(iNumLinha)
  {
    var nomeCampo_tarifkeperawatan_ = "tarifkeperawatan_" + iNumLinha;
    var var_tarifkeperawatan_ = scAjaxGetFieldText(nomeCampo_tarifkeperawatan_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtarifinap_validate_tarifkeperawatan_(var_tarifkeperawatan_, iNumLinha, var_script_case_init, do_ajax_form_tbtarifinap_validate_tarifkeperawatan__cb);
  } // do_ajax_form_tbtarifinap_validate_tarifkeperawatan_

  function do_ajax_form_tbtarifinap_validate_tarifkeperawatan__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "tarifkeperawatan_" + iLineNumber;
    }
    else
    {
      sFieldValid = "tarifkeperawatan_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "tarifkeperawatan_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "tarifkeperawatan_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtarifinap_validate_tarifkeperawatan__cb

  // ---------- Validate citosiang_
  function do_ajax_form_tbtarifinap_validate_citosiang_(iNumLinha)
  {
    var nomeCampo_citosiang_ = "citosiang_" + iNumLinha;
    var var_citosiang_ = scAjaxGetFieldText(nomeCampo_citosiang_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtarifinap_validate_citosiang_(var_citosiang_, iNumLinha, var_script_case_init, do_ajax_form_tbtarifinap_validate_citosiang__cb);
  } // do_ajax_form_tbtarifinap_validate_citosiang_

  function do_ajax_form_tbtarifinap_validate_citosiang__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "citosiang_" + iLineNumber;
    }
    else
    {
      sFieldValid = "citosiang_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "citosiang_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "citosiang_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtarifinap_validate_citosiang__cb

  // ---------- Validate citomalam_
  function do_ajax_form_tbtarifinap_validate_citomalam_(iNumLinha)
  {
    var nomeCampo_citomalam_ = "citomalam_" + iNumLinha;
    var var_citomalam_ = scAjaxGetFieldText(nomeCampo_citomalam_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtarifinap_validate_citomalam_(var_citomalam_, iNumLinha, var_script_case_init, do_ajax_form_tbtarifinap_validate_citomalam__cb);
  } // do_ajax_form_tbtarifinap_validate_citomalam_

  function do_ajax_form_tbtarifinap_validate_citomalam__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "citomalam_" + iLineNumber;
    }
    else
    {
      sFieldValid = "citomalam_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "citomalam_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "citomalam_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtarifinap_validate_citomalam__cb

  // ---------- Validate citominggu_
  function do_ajax_form_tbtarifinap_validate_citominggu_(iNumLinha)
  {
    var nomeCampo_citominggu_ = "citominggu_" + iNumLinha;
    var var_citominggu_ = scAjaxGetFieldText(nomeCampo_citominggu_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtarifinap_validate_citominggu_(var_citominggu_, iNumLinha, var_script_case_init, do_ajax_form_tbtarifinap_validate_citominggu__cb);
  } // do_ajax_form_tbtarifinap_validate_citominggu_

  function do_ajax_form_tbtarifinap_validate_citominggu__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "citominggu_" + iLineNumber;
    }
    else
    {
      sFieldValid = "citominggu_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "citominggu_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "citominggu_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtarifinap_validate_citominggu__cb

  // ---------- Validate idtarifinap_
  function do_ajax_form_tbtarifinap_validate_idtarifinap_(iNumLinha)
  {
    var nomeCampo_idtarifinap_ = "idtarifinap_" + iNumLinha;
    var var_idtarifinap_ = scAjaxGetFieldHidden(nomeCampo_idtarifinap_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtarifinap_validate_idtarifinap_(var_idtarifinap_, iNumLinha, var_script_case_init, do_ajax_form_tbtarifinap_validate_idtarifinap__cb);
  } // do_ajax_form_tbtarifinap_validate_idtarifinap_

  function do_ajax_form_tbtarifinap_validate_idtarifinap__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "idtarifinap_" + iLineNumber;
    }
    else
    {
      sFieldValid = "idtarifinap_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "idtarifinap_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "idtarifinap_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtarifinap_validate_idtarifinap__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_tbtarifinap_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_tbtarifinap_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tbtarifinap_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_tbtarifinap_add_new_line_cb);
  } // do_ajax_form_tbtarifinap_add_new_line

  function do_ajax_form_tbtarifinap_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_tbtarifinap_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_tbtarifinap_backup_line(iNumLinha)
  {
    var var_idtarifinap_ = scAjaxGetFieldHidden("idtarifinap_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtarifinap_backup_line(var_idtarifinap_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_tbtarifinap_backup_line_cb);
  } // do_ajax_form_tbtarifinap_backup_line

  function do_ajax_form_tbtarifinap_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_tbtarifinap_backup_line_cb

  function do_ajax_form_tbtarifinap_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_tbtarifinap_cancel_insert

  function do_ajax_form_tbtarifinap_cancel_update(iSeqVert)
  {
    do_ajax_form_tbtarifinap_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_tbtarifinap_cancel_update

  function do_ajax_form_tbtarifinap_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_tbtarifinap_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_tbtarifinap_table_refresh()
  {
    var var_idtarifinap_ = document.F2.idtarifinap_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_tbtarifinap_table_refresh(var_idtarifinap_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbtarifinap_table_refresh_cb);
  } //  do_ajax_form_tbtarifinap_table_refresh

  function do_ajax_form_tbtarifinap_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.idtarifinap_.value = scAjaxGetKeyValue("idtarifinap_");
    ...
    scAjaxAlert(do_ajax_form_tbtarifinap_table_refresh_cb_after_alert);
  } // do_ajax_form_tbtarifinap_table_refresh_cb
  function do_ajax_form_tbtarifinap_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_tbtarifinap_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_tbtarifinap_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_tbtarifinap_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    sc_num_ult_line = iNumLinha;
    sc_num_ult_tr   = indexTR;
    scAjaxHideMessage();
    var var_namakelas_ = scAjaxGetFieldText("namakelas_" + iNumLinha);
    var var_tarifkamar_ = scAjaxGetFieldText("tarifkamar_" + iNumLinha);
    var var_tarifkeperawatan_ = scAjaxGetFieldText("tarifkeperawatan_" + iNumLinha);
    var var_citosiang_ = scAjaxGetFieldText("citosiang_" + iNumLinha);
    var var_citomalam_ = scAjaxGetFieldText("citomalam_" + iNumLinha);
    var var_citominggu_ = scAjaxGetFieldText("citominggu_" + iNumLinha);
    var var_idtarifinap_ = scAjaxGetFieldHidden("idtarifinap_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_tbtarifinap_submit_form(var_namakelas_, var_tarifkamar_, var_tarifkeperawatan_, var_citosiang_, var_citomalam_, var_citominggu_, var_idtarifinap_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbtarifinap_submit_form_cb);
  } // do_ajax_form_tbtarifinap_submit_form

  function do_ajax_form_tbtarifinap_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("namakelas_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("tarifkamar_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("tarifkeperawatan_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("citosiang_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("citomalam_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("citominggu_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("idtarifinap_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_tbtarifinap_submit_form_cb_after_alert);
  } // do_ajax_form_tbtarifinap_submit_form_cb
  function do_ajax_form_tbtarifinap_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbtarifinap_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tbtarifinap_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_tbtarifinap_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("namakelas_" + iNavForm);
      scAjaxHideErrorDisplay("tarifkamar_" + iNavForm);
      scAjaxHideErrorDisplay("tarifkeperawatan_" + iNavForm);
      scAjaxHideErrorDisplay("citosiang_" + iNavForm);
      scAjaxHideErrorDisplay("citomalam_" + iNavForm);
      scAjaxHideErrorDisplay("citominggu_" + iNavForm);
      scAjaxHideErrorDisplay("idtarifinap_" + iNavForm);
    }
    var var_idtarifinap_ = document.F2.idtarifinap_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tbtarifinap_navigate_form(var_idtarifinap_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbtarifinap_navigate_form_cb);
  } // do_ajax_form_tbtarifinap_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtarifinap']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbtarifinap_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.idtarifinap_.value = scAjaxGetKeyValue("idtarifinap_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbtarifinap_navigate_form_cb_after_alert);
  } // do_ajax_form_tbtarifinap_navigate_form_cb
  function do_ajax_form_tbtarifinap_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_tbtarifinap_navigate_form_cb_after_alert
  function sc_hide_form_tbtarifinap_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "namakelas_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "tarifkamar_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "tarifkeperawatan_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "citosiang_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "citomalam_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "citominggu_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "idtarifinap_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["namakelas_" + iNumLinha] = {"label": "Nama Kelas<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["tarifkamar_" + iNumLinha] = {"label": "Tarif Kamar<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["tarifkeperawatan_" + iNumLinha] = {"label": "Tarif Keperawatan<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["citosiang_" + iNumLinha] = {"label": "Cito Siang<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["citomalam_" + iNumLinha] = {"label": "Cito Malam<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["citominggu_" + iNumLinha] = {"label": "Cito Minggu<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["idtarifinap_" + iNumLinha] = {"label": "ID Tarif Inap<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["namakelas_"][iNumLinha] = "namakelas_" + iNumLinha;
    ajax_field_mult["tarifkamar_"][iNumLinha] = "tarifkamar_" + iNumLinha;
    ajax_field_mult["tarifkeperawatan_"][iNumLinha] = "tarifkeperawatan_" + iNumLinha;
    ajax_field_mult["citosiang_"][iNumLinha] = "citosiang_" + iNumLinha;
    ajax_field_mult["citomalam_"][iNumLinha] = "citomalam_" + iNumLinha;
    ajax_field_mult["citominggu_"][iNumLinha] = "citominggu_" + iNumLinha;
    ajax_field_mult["idtarifinap_"][iNumLinha] = "idtarifinap_" + iNumLinha;
    ajax_field_id["namakelas_" + iNumLinha] = new Array("hidden_field_label_namakelas_", "hidden_field_data_namakelas_" + iNumLinha);
    ajax_field_id["tarifkamar_" + iNumLinha] = new Array("hidden_field_label_tarifkamar_", "hidden_field_data_tarifkamar_" + iNumLinha);
    ajax_field_id["tarifkeperawatan_" + iNumLinha] = new Array("hidden_field_label_tarifkeperawatan_", "hidden_field_data_tarifkeperawatan_" + iNumLinha);
    ajax_field_id["citosiang_" + iNumLinha] = new Array("hidden_field_label_citosiang_", "hidden_field_data_citosiang_" + iNumLinha);
    ajax_field_id["citomalam_" + iNumLinha] = new Array("hidden_field_label_citomalam_", "hidden_field_data_citomalam_" + iNumLinha);
    ajax_field_id["citominggu_" + iNumLinha] = new Array("hidden_field_label_citominggu_", "hidden_field_data_citominggu_" + iNumLinha);
    ajax_error_count["namakelas_" + iNumLinha] = "off";
    ajax_error_count["tarifkamar_" + iNumLinha] = "off";
    ajax_error_count["tarifkeperawatan_" + iNumLinha] = "off";
    ajax_error_count["citosiang_" + iNumLinha] = "off";
    ajax_error_count["citomalam_" + iNumLinha] = "off";
    ajax_error_count["citominggu_" + iNumLinha] = "off";
    ajax_error_count["idtarifinap_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["namakelas_" + iNumLinha] = "off";
    ajax_read_only["tarifkamar_" + iNumLinha] = "off";
    ajax_read_only["tarifkeperawatan_" + iNumLinha] = "off";
    ajax_read_only["citosiang_" + iNumLinha] = "off";
    ajax_read_only["citomalam_" + iNumLinha] = "off";
    ajax_read_only["citominggu_" + iNumLinha] = "off";
    ajax_read_only["idtarifinap_" + iNumLinha] = "on";
<?php
}
else
{
?>
    ajax_read_only["namakelas_" + iNumLinha] = "on";
    ajax_read_only["tarifkamar_" + iNumLinha] = "on";
    ajax_read_only["tarifkeperawatan_" + iNumLinha] = "on";
    ajax_read_only["citosiang_" + iNumLinha] = "on";
    ajax_read_only["citomalam_" + iNumLinha] = "on";
    ajax_read_only["citominggu_" + iNumLinha] = "on";
    ajax_read_only["idtarifinap_" + iNumLinha] = "on";
<?php
}
?>
  ...
  {
    ajax_error_list["namakelas_" + iNumLinha] = null;
    ajax_error_list["tarifkamar_" + iNumLinha] = null;
    ajax_error_list["tarifkeperawatan_" + iNumLinha] = null;
    ajax_error_list["citosiang_" + iNumLinha] = null;
    ajax_error_list["citomalam_" + iNumLinha] = null;
    ajax_error_list["citominggu_" + iNumLinha] = null;
    ajax_error_list["idtarifinap_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "namakelas_": new Array(),
    "tarifkamar_": new Array(),
    "tarifkeperawatan_": new Array(),
    "citosiang_": new Array(),
    "citomalam_": new Array(),
    "citominggu_": new Array(),
    "idtarifinap_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["namakelas_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["namakelas_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["namakelas_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["namakelas_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["namakelas_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["tarifkamar_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["tarifkamar_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["tarifkamar_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["tarifkamar_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["tarifkamar_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["tarifkeperawatan_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["tarifkeperawatan_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["tarifkeperawatan_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["tarifkeperawatan_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["tarifkeperawatan_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["citosiang_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["citosiang_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["citosiang_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["citosiang_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["citosiang_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["citomalam_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["citomalam_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["citomalam_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["citomalam_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["citomalam_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["citominggu_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["citominggu_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["citominggu_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["citominggu_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["citominggu_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["idtarifinap_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["idtarifinap_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["idtarifinap_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["idtarifinap_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["idtarifinap_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['namakelas_'])) ? $this->nmgp_cmp_readonly['namakelas_'] : 'off';
?>
    scAjaxFieldRead("namakelas_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['tarifkamar_'])) ? $this->nmgp_cmp_readonly['tarifkamar_'] : 'off';
?>
    scAjaxFieldRead("tarifkamar_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['tarifkeperawatan_'])) ? $this->nmgp_cmp_readonly['tarifkeperawatan_'] : 'off';
?>
    scAjaxFieldRead("tarifkeperawatan_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['citosiang_'])) ? $this->nmgp_cmp_readonly['citosiang_'] : 'off';
?>
    scAjaxFieldRead("citosiang_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['citomalam_'])) ? $this->nmgp_cmp_readonly['citomalam_'] : 'off';
?>
    scAjaxFieldRead("citomalam_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['citominggu_'])) ? $this->nmgp_cmp_readonly['citominggu_'] : 'off';
?>
    scAjaxFieldRead("citominggu_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['idtarifinap_'])) ? $this->nmgp_cmp_readonly['idtarifinap_'] : 'on';
?>
    scAjaxFieldRead("idtarifinap_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("namakelas_" + iSeq, "on");
    scAjaxFieldRead("tarifkamar_" + iSeq, "on");
    scAjaxFieldRead("tarifkeperawatan_" + iSeq, "on");
    scAjaxFieldRead("citosiang_" + iSeq, "on");
    scAjaxFieldRead("citomalam_" + iSeq, "on");
    scAjaxFieldRead("citominggu_" + iSeq, "on");
    scAjaxFieldRead("idtarifinap_" + iSeq, "on");
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["namakelas_" + iRow] || "on" == ajax_error_count["tarifkamar_" + iRow] || "on" == ajax_error_count["tarifkeperawatan_" + iRow] || "on" == ajax_error_count["citosiang_" + iRow] || "on" == ajax_error_count["citomalam_" + iRow] || "on" == ajax_error_count["citominggu_" + iRow] || "on" == ajax_error_count["idtarifinap_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_namakelas_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_tarifkamar_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_tarifkeperawatan_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_citosiang_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_citomalam_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_citominggu_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_idtarifinap_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["namakelas_" + iRow] && "off" == ajax_error_count["tarifkamar_" + iRow] && "off" == ajax_error_count["tarifkeperawatan_" + iRow] && "off" == ajax_error_count["citosiang_" + iRow] && "off" == ajax_error_count["citomalam_" + iRow] && "off" == ajax_error_count["citominggu_" + iRow] && "off" == ajax_error_count["idtarifinap_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["namakelas_" + iRow] = "off";
        ajax_error_count["tarifkamar_" + iRow] = "off";
        ajax_error_count["tarifkeperawatan_" + iRow] = "off";
        ajax_error_count["citosiang_" + iRow] = "off";
        ajax_error_count["citomalam_" + iRow] = "off";
        ajax_error_count["citominggu_" + iRow] = "off";
        ajax_error_count["idtarifinap_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_namakelas_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_tarifkamar_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_tarifkeperawatan_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_citosiang_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_citomalam_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_citominggu_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_idtarifinap_" + iRow).removeClass("scFormErrorLine");
    }
  }
