...
$old_error_handler = set_error_handler("form_tbbhprawatjalan_scriptcase_error_handler");

function form_tbbhprawatjalan_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['form_tbbhprawatjalan']['contr_erro']) && $_SESSION['scriptcase']['form_tbbhprawatjalan']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_form_tbbhprawatjalan->contr_form_tbbhprawatjalan->Apl_com_erro = true;
            if ($inicial_form_tbbhprawatjalan->contr_form_tbbhprawatjalan->NM_ajax_flag)
            {
                $inicial_form_tbbhprawatjalan->contr_form_tbbhprawatjalan->NM_ajax_info['errList']['geral_form_tbbhprawatjalan'][] = $msg;
                return;
            }
            form_tbbhprawatjalan_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function form_tbbhprawatjalan_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['form_tbbhprawatjalan'])  && '' != $_SESSION['scriptcase']['error_icon']['form_tbbhprawatjalan'])  ? $_SESSION['scriptcase']['error_icon']['form_tbbhprawatjalan']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['form_tbbhprawatjalan']) && '' != $_SESSION['scriptcase']['error_span_title']['form_tbbhprawatjalan']) ? $_SESSION['scriptcase']['error_span_title']['form_tbbhprawatjalan'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['form_tbbhprawatjalan']) && '' != $_SESSION['scriptcase']['error_icon_title']['form_tbbhprawatjalan']) ? $_SESSION['scriptcase']['error_icon_title']['form_tbbhprawatjalan'] : '';
?>
...
<?php
    ...
    $_SESSION['scriptcase']['form_tbbhprawatjalan']['error_buffer'] .= ob_get_flush();
}
