...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____chart_byjenis_poli"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____chart_byjenis_poli"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['chart_byjenis_poli']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['chart_byjenis_poli']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['chart_byjenis_poli']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['chart_byjenis_poli']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['chart_byjenis_poli']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>chart_byjenis_poli</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['chart_byjenis_poli']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['chart_byjenis_poli']['embutida_filho'] as $ind => $sc_init)
          {
