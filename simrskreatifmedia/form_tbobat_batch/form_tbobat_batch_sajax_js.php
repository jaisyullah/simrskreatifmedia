  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbobat_batch" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbobat_batch_form();
	}

  // ---------- Validate namaitem_
  function do_ajax_form_tbobat_batch_validate_namaitem_(iNumLinha)
  {
    var nomeCampo_namaitem_ = "namaitem_" + iNumLinha;
    var var_namaitem_ = scAjaxGetFieldText(nomeCampo_namaitem_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbobat_batch_validate_namaitem_(var_namaitem_, iNumLinha, var_script_case_init, do_ajax_form_tbobat_batch_validate_namaitem__cb);
  } // do_ajax_form_tbobat_batch_validate_namaitem_

  function do_ajax_form_tbobat_batch_validate_namaitem__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "namaitem_" + iLineNumber;
    }
    else
    {
      sFieldValid = "namaitem_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "namaitem_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "namaitem_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbobat_batch_validate_namaitem__cb

  // ---------- Validate jenisbarang_
  function do_ajax_form_tbobat_batch_validate_jenisbarang_(iNumLinha)
  {
    var nomeCampo_jenisbarang_ = "jenisbarang_" + iNumLinha;
    var var_jenisbarang_ = scAjaxGetFieldSelect(nomeCampo_jenisbarang_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbobat_batch_validate_jenisbarang_(var_jenisbarang_, iNumLinha, var_script_case_init, do_ajax_form_tbobat_batch_validate_jenisbarang__cb);
  } // do_ajax_form_tbobat_batch_validate_jenisbarang_

  function do_ajax_form_tbobat_batch_validate_jenisbarang__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "jenisbarang_" + iLineNumber;
    }
    else
    {
      sFieldValid = "jenisbarang_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "jenisbarang_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "jenisbarang_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbobat_batch_validate_jenisbarang__cb

  // ---------- Validate kemasanbeli_
  function do_ajax_form_tbobat_batch_validate_kemasanbeli_(iNumLinha)
  {
    var nomeCampo_kemasanbeli_ = "kemasanbeli_" + iNumLinha;
    var var_kemasanbeli_ = scAjaxGetFieldSelect(nomeCampo_kemasanbeli_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbobat_batch_validate_kemasanbeli_(var_kemasanbeli_, iNumLinha, var_script_case_init, do_ajax_form_tbobat_batch_validate_kemasanbeli__cb);
  } // do_ajax_form_tbobat_batch_validate_kemasanbeli_

  function do_ajax_form_tbobat_batch_validate_kemasanbeli__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "kemasanbeli_" + iLineNumber;
    }
    else
    {
      sFieldValid = "kemasanbeli_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "kemasanbeli_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "kemasanbeli_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbobat_batch_validate_kemasanbeli__cb

  // ---------- Validate satuanterkecil_
  function do_ajax_form_tbobat_batch_validate_satuanterkecil_(iNumLinha)
  {
    var nomeCampo_satuanterkecil_ = "satuanterkecil_" + iNumLinha;
    var var_satuanterkecil_ = scAjaxGetFieldSelect(nomeCampo_satuanterkecil_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbobat_batch_validate_satuanterkecil_(var_satuanterkecil_, iNumLinha, var_script_case_init, do_ajax_form_tbobat_batch_validate_satuanterkecil__cb);
  } // do_ajax_form_tbobat_batch_validate_satuanterkecil_

  function do_ajax_form_tbobat_batch_validate_satuanterkecil__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "satuanterkecil_" + iLineNumber;
    }
    else
    {
      sFieldValid = "satuanterkecil_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "satuanterkecil_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "satuanterkecil_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbobat_batch_validate_satuanterkecil__cb

  // ---------- Validate generik_
  function do_ajax_form_tbobat_batch_validate_generik_(iNumLinha)
  {
    var nomeCampo_generik_ = "generik_" + iNumLinha;
    var var_generik_ = scAjaxGetFieldCheckbox(nomeCampo_generik_, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbobat_batch_validate_generik_(var_generik_, iNumLinha, var_script_case_init, do_ajax_form_tbobat_batch_validate_generik__cb);
  } // do_ajax_form_tbobat_batch_validate_generik_

  function do_ajax_form_tbobat_batch_validate_generik__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "generik_" + iLineNumber;
    }
    else
    {
      sFieldValid = "generik_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "generik_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "generik_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbobat_batch_validate_generik__cb

  // ---------- Validate paten_
  function do_ajax_form_tbobat_batch_validate_paten_(iNumLinha)
  {
    var nomeCampo_paten_ = "paten_" + iNumLinha;
    var var_paten_ = scAjaxGetFieldCheckbox(nomeCampo_paten_, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbobat_batch_validate_paten_(var_paten_, iNumLinha, var_script_case_init, do_ajax_form_tbobat_batch_validate_paten__cb);
  } // do_ajax_form_tbobat_batch_validate_paten_

  function do_ajax_form_tbobat_batch_validate_paten__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "paten_" + iLineNumber;
    }
    else
    {
      sFieldValid = "paten_";
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "paten_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "paten_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbobat_batch_validate_paten__cb

  // ---------- Validate jenisobat_
  function do_ajax_form_tbobat_batch_validate_jenisobat_(iNumLinha)
  {
    var nomeCampo_jenisobat_ = "jenisobat_" + iNumLinha;
    var var_jenisobat_ = scAjaxGetFieldText(nomeCampo_jenisobat_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbobat_batch_validate_jenisobat_(var_jenisobat_, iNumLinha, var_script_case_init, do_ajax_form_tbobat_batch_validate_jenisobat__cb);
  } // do_ajax_form_tbobat_batch_validate_jenisobat_

  function do_ajax_form_tbobat_batch_validate_jenisobat__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "jenisobat_" + iLineNumber;
    }
    else
    {
      sFieldValid = "jenisobat_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "jenisobat_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "jenisobat_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbobat_batch_validate_jenisobat__cb

  // ---------- Validate stokminimal_
  function do_ajax_form_tbobat_batch_validate_stokminimal_(iNumLinha)
  {
    var nomeCampo_stokminimal_ = "stokminimal_" + iNumLinha;
    var var_stokminimal_ = scAjaxGetFieldText(nomeCampo_stokminimal_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbobat_batch_validate_stokminimal_(var_stokminimal_, iNumLinha, var_script_case_init, do_ajax_form_tbobat_batch_validate_stokminimal__cb);
  } // do_ajax_form_tbobat_batch_validate_stokminimal_

  function do_ajax_form_tbobat_batch_validate_stokminimal__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "stokminimal_" + iLineNumber;
    }
    else
    {
      sFieldValid = "stokminimal_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "stokminimal_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "stokminimal_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbobat_batch_validate_stokminimal__cb

  // ---------- Validate max_
  function do_ajax_form_tbobat_batch_validate_max_(iNumLinha)
  {
    var nomeCampo_max_ = "max_" + iNumLinha;
    var var_max_ = scAjaxGetFieldText(nomeCampo_max_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbobat_batch_validate_max_(var_max_, iNumLinha, var_script_case_init, do_ajax_form_tbobat_batch_validate_max__cb);
  } // do_ajax_form_tbobat_batch_validate_max_

  function do_ajax_form_tbobat_batch_validate_max__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "max_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "max_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbobat_batch_validate_max__cb

  // ---------- Event onclick generik_
  function do_ajax_form_tbobat_batch_event_generik__onclick(iSeqForm)
  {
    var var_generik_ = scAjaxGetFieldCheckbox("generik_" + iSeqForm, ";");
    var var_paten_ = scAjaxGetFieldCheckbox("paten_" + iSeqForm, ";");
    var var_script_case_init = document.F2.script_case_init.value;
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_tbobat_batch_event_generik__onclick(var_generik_, var_paten_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_tbobat_batch_event_generik__onclick_cb);
  } // do_ajax_form_tbobat_batch_event_generik__onclick

  function do_ajax_form_tbobat_batch_event_generik__onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_tbobat_batch_event_generik__onclick_cb_after_alert);
  } // do_ajax_form_tbobat_batch_event_generik__onclick_cb
  function do_ajax_form_tbobat_batch_event_generik__onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_tbobat_batch_event_generik__onclick_cb_after_alert

  // ---------- Event onclick paten_
  function do_ajax_form_tbobat_batch_event_paten__onclick(iSeqForm)
  {
    var var_paten_ = scAjaxGetFieldCheckbox("paten_" + iSeqForm, ";");
    var var_generik_ = scAjaxGetFieldCheckbox("generik_" + iSeqForm, ";");
    var var_script_case_init = document.F2.script_case_init.value;
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_tbobat_batch_event_paten__onclick(var_paten_, var_generik_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_tbobat_batch_event_paten__onclick_cb);
  } // do_ajax_form_tbobat_batch_event_paten__onclick

  function do_ajax_form_tbobat_batch_event_paten__onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_tbobat_batch_event_paten__onclick_cb_after_alert);
  } // do_ajax_form_tbobat_batch_event_paten__onclick_cb
  function do_ajax_form_tbobat_batch_event_paten__onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_tbobat_batch_event_paten__onclick_cb_after_alert

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_tbobat_batch_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_tbobat_batch_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tbobat_batch_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_tbobat_batch_add_new_line_cb);
  } // do_ajax_form_tbobat_batch_add_new_line

  function do_ajax_form_tbobat_batch_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_tbobat_batch_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_tbobat_batch_backup_line(iNumLinha)
  {
    var var_id_ = scAjaxGetFieldText("id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbobat_batch_backup_line(var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_tbobat_batch_backup_line_cb);
  } // do_ajax_form_tbobat_batch_backup_line

  function do_ajax_form_tbobat_batch_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_tbobat_batch_backup_line_cb

  function do_ajax_form_tbobat_batch_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_tbobat_batch_cancel_insert

  function do_ajax_form_tbobat_batch_cancel_update(iSeqVert)
  {
    do_ajax_form_tbobat_batch_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_tbobat_batch_cancel_update

  function do_ajax_form_tbobat_batch_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_tbobat_batch_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_tbobat_batch_table_refresh()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tbobat_batch_table_refresh(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbobat_batch_table_refresh_cb);
  } //  do_ajax_form_tbobat_batch_table_refresh

  function do_ajax_form_tbobat_batch_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_tbobat_batch_table_refresh_cb_after_alert);
  } // do_ajax_form_tbobat_batch_table_refresh_cb
  function do_ajax_form_tbobat_batch_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_tbobat_batch_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_tbobat_batch_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_tbobat_batch_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    sc_num_ult_line = iNumLinha;
    sc_num_ult_tr   = indexTR;
    scAjaxHideMessage();
    var var_namaitem_ = scAjaxGetFieldText("namaitem_" + iNumLinha);
    var var_jenisbarang_ = scAjaxGetFieldSelect("jenisbarang_" + iNumLinha);
    var var_kemasanbeli_ = scAjaxGetFieldSelect("kemasanbeli_" + iNumLinha);
    var var_satuanterkecil_ = scAjaxGetFieldSelect("satuanterkecil_" + iNumLinha);
    var var_generik_ = scAjaxGetFieldCheckbox("generik_" + iNumLinha, ";");
    var var_paten_ = scAjaxGetFieldCheckbox("paten_" + iNumLinha, ";");
    var var_jenisobat_ = scAjaxGetFieldText("jenisobat_" + iNumLinha);
    var var_stokminimal_ = scAjaxGetFieldText("stokminimal_" + iNumLinha);
    var var_max_ = scAjaxGetFieldText("max_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_tbobat_batch_submit_form(var_namaitem_, var_jenisbarang_, var_kemasanbeli_, var_satuanterkecil_, var_generik_, var_paten_, var_jenisobat_, var_stokminimal_, var_max_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbobat_batch_submit_form_cb);
  } // do_ajax_form_tbobat_batch_submit_form

  function do_ajax_form_tbobat_batch_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("namaitem_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("jenisbarang_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("kemasanbeli_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("satuanterkecil_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("generik_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("paten_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("jenisobat_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("stokminimal_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("max_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_tbobat_batch_submit_form_cb_after_alert);
  } // do_ajax_form_tbobat_batch_submit_form_cb
  function do_ajax_form_tbobat_batch_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbobat_batch_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tbobat_batch_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    {
      scAjaxHideErrorDisplay("namaitem_" + iNavForm);
      scAjaxHideErrorDisplay("jenisbarang_" + iNavForm);
      scAjaxHideErrorDisplay("kemasanbeli_" + iNavForm);
      scAjaxHideErrorDisplay("satuanterkecil_" + iNavForm);
      scAjaxHideErrorDisplay("generik_" + iNavForm);
      scAjaxHideErrorDisplay("paten_" + iNavForm);
      scAjaxHideErrorDisplay("jenisobat_" + iNavForm);
      scAjaxHideErrorDisplay("stokminimal_" + iNavForm);
      scAjaxHideErrorDisplay("max_" + iNavForm);
    }
    var var_id_ = document.F2.id_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tbobat_batch_navigate_form(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbobat_batch_navigate_form_cb);
  } // do_ajax_form_tbobat_batch_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat_batch']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbobat_batch_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxClearErrors()
    $("#sc-ui-checkbox-generik_-control").prop("checked", false);
    $("#sc-ui-checkbox-paten_-control").prop("checked", false);
    sc_mupload_ok = true;
    scAjaxSetFields(false);
    scAjaxSetVariables();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbobat_batch_navigate_form_cb_after_alert);
  } // do_ajax_form_tbobat_batch_navigate_form_cb
  function do_ajax_form_tbobat_batch_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_tbobat_batch_navigate_form_cb_after_alert
  function sc_hide_form_tbobat_batch_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "namaitem_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "jenisbarang_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "kemasanbeli_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "satuanterkecil_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "generik_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "paten_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "jenisobat_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "stokminimal_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "max_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["namaitem_" + iNumLinha] = {"label": "Nama Item<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["jenisbarang_" + iNumLinha] = {"label": "Jenis Barang<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["kemasanbeli_" + iNumLinha] = {"label": "Kemasan Beli<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["satuanterkecil_" + iNumLinha] = {"label": "Satuan Terkecil<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["generik_" + iNumLinha] = {"label": "Generik<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["paten_" + iNumLinha] = {"label": "Paten<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["jenisobat_" + iNumLinha] = {"label": "Jenis Obat<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["stokminimal_" + iNumLinha] = {"label": "Stok Minimal<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["max_" + iNumLinha] = {"label": "Max<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["namaitem_"][iNumLinha] = "namaitem_" + iNumLinha;
    ajax_field_mult["jenisbarang_"][iNumLinha] = "jenisbarang_" + iNumLinha;
    ajax_field_mult["kemasanbeli_"][iNumLinha] = "kemasanbeli_" + iNumLinha;
    ajax_field_mult["satuanterkecil_"][iNumLinha] = "satuanterkecil_" + iNumLinha;
    ajax_field_mult["generik_"][iNumLinha] = "generik_" + iNumLinha;
    ajax_field_mult["paten_"][iNumLinha] = "paten_" + iNumLinha;
    ajax_field_mult["jenisobat_"][iNumLinha] = "jenisobat_" + iNumLinha;
    ajax_field_mult["stokminimal_"][iNumLinha] = "stokminimal_" + iNumLinha;
    ajax_field_mult["max_"][iNumLinha] = "max_" + iNumLinha;
    ajax_field_id["namaitem_" + iNumLinha] = new Array("hidden_field_label_namaitem_", "hidden_field_data_namaitem_" + iNumLinha);
    ajax_field_id["jenisbarang_" + iNumLinha] = new Array("hidden_field_label_jenisbarang_", "hidden_field_data_jenisbarang_" + iNumLinha);
    ajax_field_id["kemasanbeli_" + iNumLinha] = new Array("hidden_field_label_kemasanbeli_", "hidden_field_data_kemasanbeli_" + iNumLinha);
    ajax_field_id["satuanterkecil_" + iNumLinha] = new Array("hidden_field_label_satuanterkecil_", "hidden_field_data_satuanterkecil_" + iNumLinha);
    ajax_field_id["generik_" + iNumLinha] = new Array("hidden_field_label_generik_", "hidden_field_data_generik_" + iNumLinha);
    ajax_field_id["paten_" + iNumLinha] = new Array("hidden_field_label_paten_", "hidden_field_data_paten_" + iNumLinha);
    ajax_field_id["jenisobat_" + iNumLinha] = new Array("hidden_field_label_jenisobat_", "hidden_field_data_jenisobat_" + iNumLinha);
    ajax_field_id["stokminimal_" + iNumLinha] = new Array("hidden_field_label_stokminimal_", "hidden_field_data_stokminimal_" + iNumLinha);
    ajax_field_id["max_" + iNumLinha] = new Array("hidden_field_label_max_", "hidden_field_data_max_" + iNumLinha);
    ajax_error_count["namaitem_" + iNumLinha] = "off";
    ajax_error_count["jenisbarang_" + iNumLinha] = "off";
    ajax_error_count["kemasanbeli_" + iNumLinha] = "off";
    ajax_error_count["satuanterkecil_" + iNumLinha] = "off";
    ajax_error_count["generik_" + iNumLinha] = "off";
    ajax_error_count["paten_" + iNumLinha] = "off";
    ajax_error_count["jenisobat_" + iNumLinha] = "off";
    ajax_error_count["stokminimal_" + iNumLinha] = "off";
    ajax_error_count["max_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["namaitem_" + iNumLinha] = "off";
    ajax_read_only["jenisbarang_" + iNumLinha] = "off";
    ajax_read_only["kemasanbeli_" + iNumLinha] = "off";
    ajax_read_only["satuanterkecil_" + iNumLinha] = "off";
    ajax_read_only["generik_" + iNumLinha] = "off";
    ajax_read_only["paten_" + iNumLinha] = "off";
    ajax_read_only["jenisobat_" + iNumLinha] = "off";
    ajax_read_only["stokminimal_" + iNumLinha] = "off";
    ajax_read_only["max_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["namaitem_" + iNumLinha] = "on";
    ajax_read_only["jenisbarang_" + iNumLinha] = "on";
    ajax_read_only["kemasanbeli_" + iNumLinha] = "on";
    ajax_read_only["satuanterkecil_" + iNumLinha] = "on";
    ajax_read_only["generik_" + iNumLinha] = "on";
    ajax_read_only["paten_" + iNumLinha] = "on";
    ajax_read_only["jenisobat_" + iNumLinha] = "on";
    ajax_read_only["stokminimal_" + iNumLinha] = "on";
    ajax_read_only["max_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["namaitem_" + iNumLinha] = null;
    ajax_error_list["jenisbarang_" + iNumLinha] = null;
    ajax_error_list["kemasanbeli_" + iNumLinha] = null;
    ajax_error_list["satuanterkecil_" + iNumLinha] = null;
    ajax_error_list["generik_" + iNumLinha] = null;
    ajax_error_list["paten_" + iNumLinha] = null;
    ajax_error_list["jenisobat_" + iNumLinha] = null;
    ajax_error_list["stokminimal_" + iNumLinha] = null;
    ajax_error_list["max_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "namaitem_": new Array(),
    "jenisbarang_": new Array(),
    "kemasanbeli_": new Array(),
    "satuanterkecil_": new Array(),
    "generik_": new Array(),
    "paten_": new Array(),
    "jenisobat_": new Array(),
    "stokminimal_": new Array(),
    "max_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["namaitem_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["namaitem_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["namaitem_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["namaitem_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["namaitem_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["jenisbarang_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["jenisbarang_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["jenisbarang_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["jenisbarang_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["jenisbarang_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["kemasanbeli_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["kemasanbeli_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["kemasanbeli_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["kemasanbeli_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["kemasanbeli_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["satuanterkecil_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["satuanterkecil_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["satuanterkecil_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["satuanterkecil_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["satuanterkecil_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["generik_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["generik_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["generik_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["generik_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["generik_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["paten_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["paten_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["paten_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["paten_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["paten_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["jenisobat_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["jenisobat_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["jenisobat_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["jenisobat_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["jenisobat_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["stokminimal_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["stokminimal_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["stokminimal_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["stokminimal_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["stokminimal_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["max_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["max_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["max_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["max_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["max_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['namaitem_'])) ? $this->nmgp_cmp_readonly['namaitem_'] : 'off';
?>
    scAjaxFieldRead("namaitem_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['jenisbarang_'])) ? $this->nmgp_cmp_readonly['jenisbarang_'] : 'off';
?>
    scAjaxFieldRead("jenisbarang_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['kemasanbeli_'])) ? $this->nmgp_cmp_readonly['kemasanbeli_'] : 'off';
?>
    scAjaxFieldRead("kemasanbeli_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['satuanterkecil_'])) ? $this->nmgp_cmp_readonly['satuanterkecil_'] : 'off';
?>
    scAjaxFieldRead("satuanterkecil_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['generik_'])) ? $this->nmgp_cmp_readonly['generik_'] : 'off';
?>
    scAjaxFieldRead("generik_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['paten_'])) ? $this->nmgp_cmp_readonly['paten_'] : 'off';
?>
    scAjaxFieldRead("paten_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['jenisobat_'])) ? $this->nmgp_cmp_readonly['jenisobat_'] : 'off';
?>
    scAjaxFieldRead("jenisobat_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['stokminimal_'])) ? $this->nmgp_cmp_readonly['stokminimal_'] : 'off';
?>
    scAjaxFieldRead("stokminimal_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['max_'])) ? $this->nmgp_cmp_readonly['max_'] : 'off';
?>
    scAjaxFieldRead("max_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("namaitem_" + iSeq, "on");
    scAjaxFieldRead("jenisbarang_" + iSeq, "on");
    scAjaxFieldRead("kemasanbeli_" + iSeq, "on");
    scAjaxFieldRead("satuanterkecil_" + iSeq, "on");
    scAjaxFieldRead("generik_" + iSeq, "on");
    scAjaxFieldRead("paten_" + iSeq, "on");
    scAjaxFieldRead("jenisobat_" + iSeq, "on");
    scAjaxFieldRead("stokminimal_" + iSeq, "on");
    scAjaxFieldRead("max_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["namaitem_" + iRow] || "on" == ajax_error_count["jenisbarang_" + iRow] || "on" == ajax_error_count["kemasanbeli_" + iRow] || "on" == ajax_error_count["satuanterkecil_" + iRow] || "on" == ajax_error_count["generik_" + iRow] || "on" == ajax_error_count["paten_" + iRow] || "on" == ajax_error_count["jenisobat_" + iRow] || "on" == ajax_error_count["stokminimal_" + iRow] || "on" == ajax_error_count["max_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_namaitem_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_jenisbarang_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_kemasanbeli_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_satuanterkecil_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_generik_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_paten_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_jenisobat_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_stokminimal_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_max_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["namaitem_" + iRow] && "off" == ajax_error_count["jenisbarang_" + iRow] && "off" == ajax_error_count["kemasanbeli_" + iRow] && "off" == ajax_error_count["satuanterkecil_" + iRow] && "off" == ajax_error_count["generik_" + iRow] && "off" == ajax_error_count["paten_" + iRow] && "off" == ajax_error_count["jenisobat_" + iRow] && "off" == ajax_error_count["stokminimal_" + iRow] && "off" == ajax_error_count["max_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["namaitem_" + iRow] = "off";
        ajax_error_count["jenisbarang_" + iRow] = "off";
        ajax_error_count["kemasanbeli_" + iRow] = "off";
        ajax_error_count["satuanterkecil_" + iRow] = "off";
        ajax_error_count["generik_" + iRow] = "off";
        ajax_error_count["paten_" + iRow] = "off";
        ajax_error_count["jenisobat_" + iRow] = "off";
        ajax_error_count["stokminimal_" + iRow] = "off";
        ajax_error_count["max_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_namaitem_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_jenisbarang_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_kemasanbeli_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_satuanterkecil_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_generik_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_paten_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_jenisobat_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_stokminimal_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_max_" + iRow).removeClass("scFormErrorLine");
    }
  }
