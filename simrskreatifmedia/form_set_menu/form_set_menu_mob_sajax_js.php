  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_set_menu_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_set_menu_mob_form();
	}

  // ---------- Validate id
  function do_ajax_form_set_menu_mob_validate_id()
  {
    var nomeCampo_id = "id";
    var var_id = scAjaxGetFieldHidden(nomeCampo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_set_menu_mob_validate_id(var_id, var_script_case_init, do_ajax_form_set_menu_mob_validate_id_cb);
  } // do_ajax_form_set_menu_mob_validate_id

  function do_ajax_form_set_menu_mob_validate_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_set_menu_mob_validate_id_cb

  // ---------- Validate nama_set
  function do_ajax_form_set_menu_mob_validate_nama_set()
  {
    var nomeCampo_nama_set = "nama_set";
    var var_nama_set = scAjaxGetFieldText(nomeCampo_nama_set);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_set_menu_mob_validate_nama_set(var_nama_set, var_script_case_init, do_ajax_form_set_menu_mob_validate_nama_set_cb);
  } // do_ajax_form_set_menu_mob_validate_nama_set

  function do_ajax_form_set_menu_mob_validate_nama_set_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nama_set";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_set_menu_mob_validate_nama_set_cb

  // ---------- Validate menu_order
  function do_ajax_form_set_menu_mob_validate_menu_order()
  {
    var nomeCampo_menu_order = "menu_order";
    var var_menu_order = scAjaxGetFieldSelect(nomeCampo_menu_order);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_set_menu_mob_validate_menu_order(var_menu_order, var_script_case_init, do_ajax_form_set_menu_mob_validate_menu_order_cb);
  } // do_ajax_form_set_menu_mob_validate_menu_order

  function do_ajax_form_set_menu_mob_validate_menu_order_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "menu_order";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_set_menu_mob_validate_menu_order_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_set_menu_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_set_menu_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id = scAjaxGetFieldHidden("id");
    var var_nama_set = scAjaxGetFieldText("nama_set");
    var var_menu_order = scAjaxGetFieldSelect("menu_order");
    ...
    scAjaxProcOn();
    x_ajax_form_set_menu_mob_submit_form(var_id, var_nama_set, var_menu_order, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_set_menu_mob_submit_form_cb);
  } // do_ajax_form_set_menu_mob_submit_form

  function do_ajax_form_set_menu_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("nama_set");
      scAjaxHideErrorDisplay("menu_order");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_set_menu_mob_submit_form_cb_after_alert);
  } // do_ajax_form_set_menu_mob_submit_form_cb
  function do_ajax_form_set_menu_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_set_menu_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_set_menu_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_set_menu_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_set_menu_mob_navigate_form_cb);
  } // do_ajax_form_set_menu_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_set_menu_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_set_menu_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_set_menu_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_set_menu_mob_navigate_form_cb
  function do_ajax_form_set_menu_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_set_menu_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_set_menu_mob_navigate_form_cb_after_alert
  function sc_hide_form_set_menu_mob_form()
  {
  ...
  ajax_field_list[1] = "nama_set";
  ajax_field_list[2] = "menu_order";
  ...
  var ajax_error_list = {
    ...
    "nama_set": {"label": "Nama Set", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "menu_order": {"label": "Menu Order", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "id": new Array(),
    "nama_set": new Array(),
    "menu_order": new Array()
  };
  ajax_field_mult["id"][1] = "id";
  ajax_field_mult["nama_set"][1] = "nama_set";
  ajax_field_mult["menu_order"][1] = "menu_order";

  var ajax_field_id = {
    "id": new Array("hidden_field_label_id", "hidden_field_data_id"),
    "nama_set": new Array("hidden_field_label_nama_set", "hidden_field_data_nama_set"),
    "menu_order": new Array("hidden_field_label_menu_order", "hidden_field_data_menu_order")
  };
