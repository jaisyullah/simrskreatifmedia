...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____tabs_histori_bayar"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____tabs_histori_bayar"]);
   }
   ...
   if (isset($_SESSION['scriptcase']['sc_aba_iframe']['tabs_histori_bayar']))
   {
       unset($_SESSION['scriptcase']['sc_aba_iframe']['tabs_histori_bayar']);
   }
   $fecha_janela = false;
   if (isset($_SESSION['sc_session'][$script_case_init]['tabs_histori_bayar']['sc_outra_jan']) && $_SESSION['sc_session'][$script_case_init]['tabs_histori_bayar']['sc_outra_jan'])
   {
       $fecha_janela = true;
   }
   $fecha_modal = false;
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['tabs_histori_bayar']['aba_saida']) && $_SESSION['sc_session'][$script_case_init]['tabs_histori_bayar']['aba_saida'] == "modal")
   {
       unset($_SESSION['sc_session'][$script_case_init]['tabs_histori_bayar']['aba_saida']);
       $fecha_modal = true;
   }
