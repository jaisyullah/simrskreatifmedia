<?php
@session_start() ;
$_SESSION['scriptcase']['chart_bysex_lab']['sc_process_barr'] = true;
require_once('../chart_bysex_lab/index.php');
unset($_SESSION['scriptcase']['chart_bysex_lab']['sc_process_barr']);
$ExportCtrl = new chart_bysex_lab_export_control;
$ExportCtrl->Export_barr();

class chart_bysex_lab_export_control
{
