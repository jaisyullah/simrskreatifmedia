<?php
class form_tbtracerrm_proses_form extends form_tbtracerrm_proses_apl
{
function Form_Init()
{
...
<?php
if ($this->Embutida_form && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtracerrm_proses']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtracerrm_proses']['sc_modal'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtracerrm_proses']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtracerrm_proses']['sc_redir_atualiz'] == 'ok')
{
?>
...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtracerrm_proses']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_tbtracerrm_proses/form_tbtracerrm_proses_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_tbtracerrm_proses_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_tbtracerrm_proses_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtracerrm_proses']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtracerrm_proses']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtracerrm_proses']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtracerrm_proses']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtracerrm_proses']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtracerrm_proses']['recarga'];
}
if ('novo' == $opcao_botoes && $this->Embutida_form)
{
    $opcao_botoes = 'inicio';
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtracerrm_proses']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtracerrm_proses']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
?>
...
<?php
 include_once("form_tbtracerrm_proses_js0.php");
?>
<script type="text/javascript"> 
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_tbtracerrm_proses'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_tbtracerrm_proses'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtracerrm_proses']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtracerrm_proses']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtracerrm_proses']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtracerrm_proses']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtracerrm_proses']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtracerrm_proses']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtracerrm_proses']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtracerrm_proses']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtracerrm_proses']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtracerrm_proses']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtracerrm_proses']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtracerrm_proses']['fast_search'][2] : "";
?> 
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtracerrm_proses']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtracerrm_proses']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtracerrm_proses']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtracerrm_proses']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtracerrm_proses']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtracerrm_proses']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtracerrm_proses']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtracerrm_proses']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtracerrm_proses']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtracerrm_proses']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtracerrm_proses']['ordem_cmp'] == "id")
      {
          $orderColName = "id";
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtracerrm_proses']['ordem_ord'] == " desc")
          {
...
{ 
   ...
   { 
       ob_start();
       $iStart = sizeof($this->form_vert_form_tbtracerrm_proses);
       $guarda_nmgp_opcao = $this->nmgp_opcao;
       $guarda_form_vert_form_tbtracerrm_proses = $this->form_vert_form_tbtracerrm_proses;
       $this->nmgp_opcao = 'novo';
   } 
   if ($this->Embutida_form && empty($this->form_vert_form_tbtracerrm_proses))
   {
       $sc_seq_vert = 0;
   }
   ...
   foreach ($this->form_vert_form_tbtracerrm_proses as $sc_seq_vert => $sc_lixo)
   {
       $this->loadRecordState($sc_seq_vert);
       $this->penerima_ = $this->form_vert_form_tbtracerrm_proses[$sc_seq_vert]['penerima_'];
       $this->order_date_ = $this->form_vert_form_tbtracerrm_proses[$sc_seq_vert]['order_date_'];
       $this->process_date_ = $this->form_vert_form_tbtracerrm_proses[$sc_seq_vert]['process_date_'];
       $this->service_date_ = $this->form_vert_form_tbtracerrm_proses[$sc_seq_vert]['service_date_'];
       $this->returned_date_ = $this->form_vert_form_tbtracerrm_proses[$sc_seq_vert]['returned_date_'];
       $this->diagnosa_ = $this->form_vert_form_tbtracerrm_proses[$sc_seq_vert]['diagnosa_'];
       $this->sc_field_0_ = $this->form_vert_form_tbtracerrm_proses[$sc_seq_vert]['sc_field_0_'];
       ...
       elseif ($Line_Add)
       {
        ...
        $this->id_ = $this->form_vert_form_tbtracerrm_proses[$sc_seq_vert]['id_']; 
       $id_ = $this->id_; 
       if (!isset($this->nmgp_cmp_hidden['id_']))
       {
           $this->nmgp_cmp_hidden['id_'] = 'off';
       ...
       $this->sc_field_2_ = $this->form_vert_form_tbtracerrm_proses[$sc_seq_vert]['sc_field_2_']; 
       ...
       $this->jenis_ = $this->form_vert_form_tbtracerrm_proses[$sc_seq_vert]['jenis_']; 
       $jenis_ = $this->jenis_; 
       $sStyleHidden_jenis_ = '';
       ...
       $this->sc_field_1_ = $this->form_vert_form_tbtracerrm_proses[$sc_seq_vert]['sc_field_1_']; 
       ...
       $this->usia_ = $this->form_vert_form_tbtracerrm_proses[$sc_seq_vert]['usia_']; 
       $usia_ = $this->usia_; 
       $sStyleHidden_usia_ = '';
       ...
       $this->alamat_ = $this->form_vert_form_tbtracerrm_proses[$sc_seq_vert]['alamat_']; 
       ...
       $this->lokasi_ = $this->form_vert_form_tbtracerrm_proses[$sc_seq_vert]['lokasi_']; 
       ...
       $this->status_ = $this->form_vert_form_tbtracerrm_proses[$sc_seq_vert]['status_']; 
...
<?php echo nmButtonOutput($this->arr_buttons, "bmd_novo", "do_ajax_form_tbtracerrm_proses_add_new_line(" . $sc_seq_vert . ")", "do_ajax_form_tbtracerrm_proses_add_new_line(" . $sc_seq_vert . ")", "sc_new_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
<?php }?>
<?php
  $Style_add_line = (!$Line_Add) ? "display: none" : "";
?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_form_tbtracerrm_proses_cancel_insert(" . $sc_seq_vert . ")", "do_ajax_form_tbtracerrm_proses_cancel_insert(" . $sc_seq_vert . ")", "sc_canceli_line_" . $sc_seq_vert . "", "", "", "" . $Style_add_line . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_form_tbtracerrm_proses_cancel_update(" . $sc_seq_vert . ")", "do_ajax_form_tbtracerrm_proses_cancel_update(" . $sc_seq_vert . ")", "sc_cancelu_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
 </TD>
   <?php }?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtracerrm_proses']['Lookup_status_'][] = '0'; ?>
 <option  value="1" <?php  if ($this->status_ == "1") { echo " selected" ;} ?>>Dalam Proses</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtracerrm_proses']['Lookup_status_'][] = '1'; ?>
 <option  value="2" <?php  if ($this->status_ == "2") { echo " selected" ;} ?>>Pelayanan</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtracerrm_proses']['Lookup_status_'][] = '2'; ?>
 <option  value="3" <?php  if ($this->status_ == "3") { echo " selected" ;} ?>>Sudah Kembali</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtracerrm_proses']['Lookup_status_'][] = '3'; ?>
 </select></span>
</span><?php  }?>
...
<?php   
   ...
   { 
       ...
       $this->form_vert_form_tbtracerrm_proses = $guarda_form_vert_form_tbtracerrm_proses;
   } 
   if ($Table_refresh) 
   { 
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtracerrm_proses']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtracerrm_proses']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtracerrm_proses']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtracerrm_proses']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtracerrm_proses']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtracerrm_proses']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtracerrm_proses']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtracerrm_proses']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtracerrm_proses']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<?php
if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtracerrm_proses']['run_modal']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtracerrm_proses']['run_modal'])
{
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtracerrm_proses']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtracerrm_proses']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_tbtracerrm_proses");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_tbtracerrm_proses");
 parent.scAjaxDetailHeight("form_tbtracerrm_proses", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtracerrm_proses']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
