...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "jam";$Nm_datas[] = "jam";$Nm_numeric[] = "grupid";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_grupid_cond" name="grupid_cond" onChange="nm_campos_between(document.getElementById('id_vis_grupid'), this, 'grupid')">
      ...
      <br><span id="id_hide_grupid"  <?php echo $str_hide_grupid?>><?php
      if ($grupid != "")
      {
      $grupid_look = substr($this->Db->qstr($grupid), 1, -1); 
      $nmgp_def_dados = array(); 
