<?php
@session_start() ;
$_SESSION['scriptcase']['grid_akun_header']['sc_process_barr'] = true;
require_once('../grid_akun_header/index.php');
unset($_SESSION['scriptcase']['grid_akun_header']['sc_process_barr']);
$ExportCtrl = new grid_akun_header_export_control;
$ExportCtrl->Export_barr();

class grid_akun_header_export_control
{
