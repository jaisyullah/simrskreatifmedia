...
<?php
   ...
   $Ord_Cmp = new grid_akun_header_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_akun_header_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_akun_header']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_akun_header']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_akun_header']['labels']["id"])) ? $_SESSION['sc_session'][$sc_init]['grid_akun_header']['labels']["id"] : "Id";
   $tab_ger_campos['nama'] = "on";
   $tab_def_campos['nama'] = "nama";
   $tab_labels["nama"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_akun_header']['labels']["nama"])) ? $_SESSION['sc_session'][$sc_init]['grid_akun_header']['labels']["nama"] : "Nama";
   $tab_ger_campos['grupid'] = "on";
   $tab_def_campos['grupid'] = "grupid";
   $tab_labels["grupid"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_akun_header']['labels']["grupid"])) ? $_SESSION['sc_session'][$sc_init]['grid_akun_header']['labels']["grupid"] : "Grupid";
   $tab_ger_campos['jenis'] = "on";
   $tab_def_campos['jenis'] = "jenis";
   $tab_labels["jenis"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_akun_header']['labels']["jenis"])) ? $_SESSION['sc_session'][$sc_init]['grid_akun_header']['labels']["jenis"] : "Jenis";
   $tab_ger_campos['modal'] = "on";
   $tab_def_campos['modal'] = "modal";
   $tab_labels["modal"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_akun_header']['labels']["modal"])) ? $_SESSION['sc_session'][$sc_init]['grid_akun_header']['labels']["modal"] : "Modal";
   $tab_ger_campos['keterangan'] = "on";
   $tab_def_campos['keterangan'] = "keterangan";
   $tab_labels["keterangan"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_akun_header']['labels']["keterangan"])) ? $_SESSION['sc_session'][$sc_init]['grid_akun_header']['labels']["keterangan"] : "Keterangan";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_akun_header']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_akun_header']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_akun_header']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_akun_header']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_akun_header']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_akun_header']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_akun_header']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_akun_header']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_akun_header']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_akun_header_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_akun_header']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_akun_header']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_akun_header']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_akun_header']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_akun_header']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
