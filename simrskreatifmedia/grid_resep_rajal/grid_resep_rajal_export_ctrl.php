<?php
@session_start() ;
$_SESSION['scriptcase']['grid_resep_rajal']['sc_process_barr'] = true;
require_once('../grid_resep_rajal/index.php');
unset($_SESSION['scriptcase']['grid_resep_rajal']['sc_process_barr']);
$ExportCtrl = new grid_resep_rajal_export_control;
$ExportCtrl->Export_barr();

class grid_resep_rajal_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - Pelayanan Resep Rawat Jalan :: Excel</TITLE>
