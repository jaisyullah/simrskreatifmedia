...
<?php
   ...
   $Ord_Cmp = new grid_resep_rajal_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_resep_rajal_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_resep_rajal']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_resep_rajal']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["trandate"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_resep_rajal']['labels']["trandate"])) ? $_SESSION['sc_session'][$sc_init]['grid_resep_rajal']['labels']["trandate"] : "Tgl Transaksi";
   $tab_ger_campos['doctor'] = "on";
   $tab_def_campos['doctor'] = "doctor";
   $tab_labels["doctor"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_resep_rajal']['labels']["doctor"])) ? $_SESSION['sc_session'][$sc_init]['grid_resep_rajal']['labels']["doctor"] : "DPJP";
   $tab_ger_campos['custcode'] = "on";
   $tab_def_campos['custcode'] = "custCode";
   $tab_labels["custcode"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_resep_rajal']['labels']["custcode"])) ? $_SESSION['sc_session'][$sc_init]['grid_resep_rajal']['labels']["custcode"] : "No RM";
   $tab_ger_campos['bayar'] = "on";
   $tab_def_campos['bayar'] = "bayar";
   $tab_labels["bayar"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_resep_rajal']['labels']["bayar"])) ? $_SESSION['sc_session'][$sc_init]['grid_resep_rajal']['labels']["bayar"] : "Jenis Bayar";
   $tab_ger_campos['trancode'] = "on";
   $tab_def_campos['trancode'] = "tranCode";
   $tab_labels["trancode"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_resep_rajal']['labels']["trancode"])) ? $_SESSION['sc_session'][$sc_init]['grid_resep_rajal']['labels']["trancode"] : "Kode Transaksi";
   $tab_ger_campos['kategori'] = "on";
   $tab_def_campos['kategori'] = "Kategori";
   $tab_labels["kategori"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_resep_rajal']['labels']["kategori"])) ? $_SESSION['sc_session'][$sc_init]['grid_resep_rajal']['labels']["kategori"] : "Kategori";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_resep_rajal']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_resep_rajal']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_resep_rajal']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_resep_rajal']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_resep_rajal']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_resep_rajal']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_resep_rajal']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_resep_rajal']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_resep_rajal']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_resep_rajal_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_resep_rajal']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_resep_rajal']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_resep_rajal']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_resep_rajal']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_resep_rajal']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
