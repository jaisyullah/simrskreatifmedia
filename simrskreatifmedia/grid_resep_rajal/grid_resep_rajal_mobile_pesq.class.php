...
<HTML>
<HEAD>
 <TITLE> - Pelayanan Resep Rawat Jalan</TITLE>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_doctor_cond" name="doctor_cond" onChange="nm_campos_between(document.getElementById('id_vis_doctor'), this, 'doctor')">
      ...
      <br><span id="id_hide_doctor"  <?php echo $str_hide_doctor?>><?php
      if ($doctor != "")
      {
      $doctor_look = substr($this->Db->qstr($doctor), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_custcode_cond" name="custcode_cond" onChange="nm_campos_between(document.getElementById('id_vis_custcode'), this, 'custcode')">
      ...
      <br><span id="id_hide_custcode"  <?php echo $str_hide_custcode?>><?php
      if ($custcode != "")
      {
      $custcode_look = substr($this->Db->qstr($custcode), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_bayar_cond" name="bayar_cond" onChange="nm_campos_between(document.getElementById('id_vis_bayar'), this, 'bayar')">
      ...
      <br><span id="id_hide_bayar"  <?php echo $str_hide_bayar?>><?php
      if ($bayar != "")
      {
      $bayar_look = substr($this->Db->qstr($bayar), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_trandate_cond" name="trandate_cond" onChange="nm_campos_between(document.getElementById('id_vis_trandate'), this, 'trandate')">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_kategori_cond" name="kategori_cond" onChange="nm_campos_between(document.getElementById('id_vis_kategori'), this, 'kategori')">
      ...
      <br><span id="id_hide_kategori"  <?php echo $str_hide_kategori?>><?php
      if ($kategori != "")
      {
      $kategori_look = substr($this->Db->qstr($kategori), 1, -1); 
      $nmgp_def_dados = array(); 
