...
class grid_resep_rajal_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['path_libs_php'] = $this->Ini->path_lib_php;
      ...
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search_change_fil")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['campos_busca'] = array(); 
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_resep_rajal_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_resep_rajal_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_resep_rajal_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_doctor')
      {
          $doctor = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_doctor($doctor);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_bayar')
      {
          $bayar = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_bayar($bayar);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - Pelayanan Resep Rawat Jalan</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_resep_rajal/grid_resep_rajal_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_resep_rajal_ajax_search.js"></script>
 <script type="text/javascript" src="grid_resep_rajal_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_resep_rajal_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_resep_rajal']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_resep_rajal']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_doctor_cond#NMF#' + search_get_sel_txt('SC_doctor_cond') + '@NMF@';
  str_out += 'SC_doctor#NMF#' + search_get_text('SC_doctor') + '@NMF@';
  str_out += 'id_ac_doctor#NMF#' + search_get_text('id_ac_doctor') + '@NMF@';
  ...
  str_out += 'SC_bayar_cond#NMF#' + search_get_sel_txt('SC_bayar_cond') + '@NMF@';
  str_out += 'SC_bayar#NMF#' + search_get_text('SC_bayar') + '@NMF@';
  str_out += 'id_ac_bayar#NMF#' + search_get_text('id_ac_bayar') + '@NMF@';
  ...
  str_out += 'id_ac_kategori#NMF#' + search_get_text('id_ac_kategori') + '@NMF@';
   ...
   $("#id_ac_doctor").autocomplete({
     ...
     $.ajax({
       ...
       data: {
          ...
          nmgp_parms: "NM_ajax_opcao?#?autocomp_doctor",
          max_itens: "10",
          cod_desc: "N",
   ...
   $("#id_ac_bayar").autocomplete({
     ...
     $.ajax({
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_bayar",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div class="scFilterHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFilterHeaderFont" style="float: left; text-transform: uppercase;"><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - Pelayanan Resep Rawat Jalan</div>
...
<?php
   ...
   function monta_form()
   {
      global 
             ...
             $doctor_cond, $doctor, $doctor_autocomp,
             $custcode_cond, $custcode, $custcode_autocomp,
             $bayar_cond, $bayar, $bayar_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          $trancode = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['campos_busca']['trancode']; 
          $trancode_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['campos_busca']['trancode_cond']; 
          $doctor = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['campos_busca']['doctor']; 
          $doctor_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['campos_busca']['doctor_cond']; 
          $custcode = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['campos_busca']['custcode']; 
          $custcode_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['campos_busca']['custcode_cond']; 
          $bayar = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['campos_busca']['bayar']; 
          $bayar_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['campos_busca']['bayar_cond']; 
          $trandate_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['campos_busca']['trandate_dia']; 
          $trandate_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['campos_busca']['trandate_mes']; 
          $trandate_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['campos_busca']['trandate_ano']; 
          $trandate_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['campos_busca']['trandate_input_2_dia']; 
          $trandate_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['campos_busca']['trandate_input_2_mes']; 
          $trandate_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['campos_busca']['trandate_input_2_ano']; 
          $trandate_hor = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['campos_busca']['trandate_hor']; 
          $trandate_min = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['campos_busca']['trandate_min']; 
          $trandate_seg = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['campos_busca']['trandate_seg']; 
          $trandate_input_2_hor = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['campos_busca']['trandate_input_2_hor']; 
          $trandate_input_2_min = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['campos_busca']['trandate_input_2_min']; 
          $trandate_input_2_seg = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['campos_busca']['trandate_input_2_seg']; 
          $trandate_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['campos_busca']['trandate_cond']; 
          $kategori = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['campos_busca']['kategori']; 
          $kategori_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['campos_busca']['kategori_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['campos_busca']['NM_operador']; 
      } 
      if (!isset($trancode_cond) || empty($trancode_cond))
      {
         $trancode_cond = "qp";
      }
      if (!isset($doctor_cond) || empty($doctor_cond))
      {
         $doctor_cond = "qp";
      }
      ...
      if (!isset($bayar_cond) || empty($bayar_cond))
      {
         $bayar_cond = "qp";
      }
      ...
      if (!isset($kategori_cond) || empty($kategori_cond))
      {
         $kategori_cond = "qp";
      }
      ...
      $str_hide_doctor = (in_array($doctor_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_custcode = (in_array($custcode_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_bayar = (in_array($bayar_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      $str_display_doctor = ('bw' == $doctor_cond) ? $display_aberto : $display_fechado;
      $str_display_custcode = ('bw' == $custcode_cond) ? $display_aberto : $display_fechado;
      $str_display_bayar = ('bw' == $bayar_cond) ? $display_aberto : $display_fechado;
      ...
      if (!isset($bayar) || $bayar == "")
      {
          $bayar = "";
      }
      if (isset($bayar) && !empty($bayar))
      {
         $tmp_pos = strpos($bayar, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $bayar = substr($bayar, 0, $tmp_pos);
         }
      }
...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_trancode" name="trancode_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 75, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_doctor_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['doctor'])) ? $this->New_label['doctor'] : "DPJP"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_doctor_cond" name="doctor_cond" onChange="nm_campos_between(document.getElementById('id_vis_doctor'), this, 'doctor')">
       <OPTION value="qp" <?php if ("qp" == $doctor_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $doctor_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $doctor_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $doctor_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_doctor" <?php echo $str_hide_doctor?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['doctor'])) ? $this->New_label['doctor'] : "DPJP";
 $nmgp_tab_label .= "doctor?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      {
          $sAutocompValue = $doctor;
      }
?>
<INPUT  type="text" id="SC_doctor" name="doctor" value="<?php echo NM_encode_input($doctor) ?>"  size=50 alt="{datatype: 'text', maxLength: 150, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_doctor" name="doctor_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 150, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
     ...
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_custcode_cond" name="custcode_cond" onChange="nm_campos_between(document.getElementById('id_vis_custcode'), this, 'custcode')">
...
?>
<INPUT  type="text" id="SC_custcode" name="custcode" value="<?php echo NM_encode_input($custcode) ?>"  size=24 alt="{datatype: 'text', maxLength: 24, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_custcode" name="custcode_autocomp" size="24"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 24, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_bayar_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['bayar'])) ? $this->New_label['bayar'] : "Jenis Bayar"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_bayar_cond" name="bayar_cond" onChange="nm_campos_between(document.getElementById('id_vis_bayar'), this, 'bayar')">
       <OPTION value="qp" <?php if ("qp" == $bayar_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $bayar_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $bayar_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $bayar_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_bayar" <?php echo $str_hide_bayar?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['bayar'])) ? $this->New_label['bayar'] : "Jenis Bayar";
 $nmgp_tab_label .= "bayar?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      {
          $sAutocompValue = $bayar;
      }
?>
<INPUT  type="text" id="SC_bayar" name="bayar" value="<?php echo NM_encode_input($bayar) ?>"  size=50 alt="{datatype: 'text', maxLength: 60, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_bayar" name="bayar_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 60, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
     ...
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_trandate_cond" name="trandate_cond" onChange="nm_campos_between(document.getElementById('id_vis_trandate'), this, 'trandate')">
...
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_trandate_input_2_dia" name="trandate_input_2_dia" value="<?php echo NM_encode_input($trandate_input_2_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_trandate_input_2_mes" name="trandate_input_2_mes" value="<?php echo NM_encode_input($trandate_input_2_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_trandate_input_2_hor" name="trandate_input_2_hor" value="<?php echo NM_encode_input($trandate_input_2_hor); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_trandate_input_2_min" name="trandate_input_2_min" value="<?php echo NM_encode_input($trandate_input_2_min); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_trandate_input_2_seg" name="trandate_input_2_seg" value="<?php echo NM_encode_input($trandate_input_2_seg); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
?>
      ...
      <TD id='SC_kategori_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['kategori'])) ? $this->New_label['kategori'] : "Kategori"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_kategori_cond" name="kategori_cond" onChange="nm_campos_between(document.getElementById('id_vis_kategori'), this, 'kategori')">
       <OPTION value="qp" <?php if ("qp" == $kategori_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $kategori_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $kategori_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $kategori_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
...
?>
<INPUT  type="text" id="SC_kategori" name="kategori" value="<?php echo NM_encode_input($kategori) ?>"  size=15 alt="{datatype: 'text', maxLength: 15, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_kategori" name="kategori_autocomp" size="15"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 15, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if ($_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
<?php
   if (is_file("grid_resep_rajal_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_resep_rajal']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_resep_rajal']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.doctor_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_doctor'), document.F1.doctor_cond, 'doctor');
   document.F1.doctor.value = "";
   document.F1.doctor_autocomp.value = "";
   ...
   document.F1.bayar_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_bayar'), document.F1.bayar_cond, 'bayar');
   document.F1.bayar.value = "";
   document.F1.bayar_autocomp.value = "";
   ...
   document.F1.kategori_cond.value = 'qp';
 ...
 {
    $('#SC_trandate_dia').bind('change', function() {sc_grid_resep_rajal_valida_dia(this)});
    $('#SC_trandate_hor').bind('change', function() {sc_grid_resep_rajal_valida_hora(this)});
    $('#SC_trandate_input_2_dia').bind('change', function() {sc_grid_resep_rajal_valida_dia(this)});
    $('#SC_trandate_input_2_hor').bind('change', function() {sc_grid_resep_rajal_valida_hora(this)});
    $('#SC_trandate_input_2_mes').bind('change', function() {sc_grid_resep_rajal_valida_mes(this)});
    $('#SC_trandate_input_2_min').bind('change', function() {sc_grid_resep_rajal_valida_min(this)});
    $('#SC_trandate_input_2_seg').bind('change', function() {sc_grid_resep_rajal_valida_seg(this)});
    $('#SC_trandate_mes').bind('change', function() {sc_grid_resep_rajal_valida_mes(this)});
    $('#SC_trandate_min').bind('change', function() {sc_grid_resep_rajal_valida_min(this)});
    $('#SC_trandate_seg').bind('change', function() {sc_grid_resep_rajal_valida_seg(this)});
 }
 function sc_grid_resep_rajal_valida_dia(obj)
 {
 ...
 function sc_grid_resep_rajal_valida_mes(obj)
 {
 ...
 function sc_grid_resep_rajal_valida_hora(obj)
 {
 ...
 function sc_grid_resep_rajal_valida_min(obj)
 {
 ...
 function sc_grid_resep_rajal_valida_seg(obj)
 {
     if (obj.value != "" && (obj.value < 0 || obj.value > 59))
     {
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['where_orig']))
      {
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['where_orig'];
      }
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_doctor_cond'] = 'cond';
      $tp_fields['SC_doctor'] = 'text_aut';
      $tp_fields['id_ac_doctor'] = 'text_aut';
      $tp_fields['SC_custcode_cond'] = 'cond';
      $tp_fields['SC_custcode'] = 'text_aut';
      $tp_fields['id_ac_custcode'] = 'text_aut';
      $tp_fields['SC_bayar_cond'] = 'cond';
      $tp_fields['SC_bayar'] = 'text_aut';
      $tp_fields['id_ac_bayar'] = 'text_aut';
      ...
      $tp_fields['id_ac_kategori'] = 'text_aut';
   ...
   {
      global $trancode_cond, $trancode, $trancode_autocomp,
             $doctor_cond, $doctor, $doctor_autocomp,
             $custcode_cond, $custcode, $custcode_autocomp,
             $bayar_cond, $bayar, $bayar_autocomp,
             $trandate_cond, $trandate, $trandate_dia, $trandate_mes, $trandate_ano, $trandate_hor, $trandate_min, $trandate_seg, $trandate_input_2_dia, $trandate_input_2_mes, $trandate_input_2_ano, $trandate_input_2_min, $trandate_input_2_hor, $trandate_input_2_seg,
             $kategori_cond, $kategori, $kategori_autocomp, $nmgp_tab_label;
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['campos_busca'] as $Cmps => $Vals)
          {
              $$Cmps = $Vals;
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['grid_pesq'] = array();
      if (!empty($trancode_autocomp) && empty($trancode))
      {
          $trancode = $trancode_autocomp;
      }
      if (!empty($doctor_autocomp) && empty($doctor))
      {
          $doctor = $doctor_autocomp;
      }
      if (!empty($custcode_autocomp) && empty($custcode))
      {
          $custcode = $custcode_autocomp;
      }
      if (!empty($bayar_autocomp) && empty($bayar))
      {
          $bayar = $bayar_autocomp;
      }
      ...
      $doctor_cond_salva = $doctor_cond; 
      if (!isset($doctor_input_2) || $doctor_input_2 == "")
      {
          $doctor_input_2 = $doctor;
      }
      ...
      $bayar_cond_salva = $bayar_cond; 
      if (!isset($bayar_input_2) || $bayar_input_2 == "")
      {
          $bayar_input_2 = $bayar;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['Grid_search']  = array(); 
      $I_Grid = 0;
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['campos_busca']['trancode'] = $trancode; 
      if (is_array($trancode) && !empty($trancode))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['Grid_search'][$I_Grid]['val'][0] = $trancode;
      }
      elseif ($trancode_cond_salva == "nu" || $trancode_cond_salva == "nn" || $trancode_cond_salva == "ep" || $trancode_cond_salva == "ne" || !empty($trancode))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['Grid_search'][$I_Grid]['val'][0][0] = $trancode;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['campos_busca']['trancode_cond'] = $trancode_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['Grid_search'][$I_Grid]['cmp'] = "trancode"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['Grid_search'][$I_Grid]['opc'] = $trancode_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['grid_pesq']['trancode'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['campos_busca']['doctor'] = $doctor; 
      if (is_array($doctor) && !empty($doctor))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['Grid_search'][$I_Grid]['val'][0] = $doctor;
      }
      elseif ($doctor_cond_salva == "nu" || $doctor_cond_salva == "nn" || $doctor_cond_salva == "ep" || $doctor_cond_salva == "ne" || !empty($doctor))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['Grid_search'][$I_Grid]['val'][0][0] = $doctor;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['campos_busca']['doctor_cond'] = $doctor_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['Grid_search'][$I_Grid]['cmp'] = "doctor"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['Grid_search'][$I_Grid]['opc'] = $doctor_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['grid_pesq']['doctor'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['campos_busca']['custcode'] = $custcode; 
      if (is_array($custcode) && !empty($custcode))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['Grid_search'][$I_Grid]['val'][0] = $custcode;
      }
      elseif ($custcode_cond_salva == "nu" || $custcode_cond_salva == "nn" || $custcode_cond_salva == "ep" || $custcode_cond_salva == "ne" || !empty($custcode))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['Grid_search'][$I_Grid]['val'][0][0] = $custcode;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['campos_busca']['custcode_cond'] = $custcode_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['Grid_search'][$I_Grid]['cmp'] = "custcode"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['Grid_search'][$I_Grid]['opc'] = $custcode_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['grid_pesq']['custcode'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['campos_busca']['bayar'] = $bayar; 
      if (is_array($bayar) && !empty($bayar))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['Grid_search'][$I_Grid]['val'][0] = $bayar;
      }
      elseif ($bayar_cond_salva == "nu" || $bayar_cond_salva == "nn" || $bayar_cond_salva == "ep" || $bayar_cond_salva == "ne" || !empty($bayar))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['Grid_search'][$I_Grid]['val'][0][0] = $bayar;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['campos_busca']['bayar_cond'] = $bayar_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['Grid_search'][$I_Grid]['cmp'] = "bayar"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['Grid_search'][$I_Grid]['opc'] = $bayar_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['grid_pesq']['bayar'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['campos_busca']['trandate_dia'] = $trandate_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['campos_busca']['trandate_mes'] = $trandate_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['campos_busca']['trandate_ano'] = $trandate_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['campos_busca']['trandate_input_2_dia'] = $trandate_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['campos_busca']['trandate_input_2_mes'] = $trandate_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['campos_busca']['trandate_input_2_ano'] = $trandate_input_2_ano; 
      ...
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['Grid_search'][$I_Grid]['val'][0][] = "D:" . $trandate_dia;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['Grid_search'][$I_Grid]['val'][0][] = "M:" . $trandate_mes;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['Grid_search'][$I_Grid]['val'][0][] = "Y:" . $trandate_ano;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['Grid_search'][$I_Grid]['val'][1][] = "D:" . $trandate_input_2_dia;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['Grid_search'][$I_Grid]['val'][1][] = "M:" . $trandate_input_2_mes;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['Grid_search'][$I_Grid]['val'][1][] = "Y:" . $trandate_input_2_ano;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['campos_busca']['trandate_hor'] = $trandate_hor; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['campos_busca']['trandate_min'] = $trandate_min; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['campos_busca']['trandate_seg'] = $trandate_seg; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['campos_busca']['trandate_input_2_hor'] = $trandate_input_2_hor; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['campos_busca']['trandate_input_2_min'] = $trandate_input_2_min; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['campos_busca']['trandate_input_2_seg'] = $trandate_input_2_seg; 
      ...
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['Grid_search'][$I_Grid]['val'][0][] = "H:" . $trandate_hor;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['Grid_search'][$I_Grid]['val'][0][] = "I:" . $trandate_min;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['Grid_search'][$I_Grid]['val'][0][] = "S:" . $trandate_seg;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['Grid_search'][$I_Grid]['val'][1][] = "H:" . $trandate_input_2_hor;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['Grid_search'][$I_Grid]['val'][1][] = "I:" . $trandate_input_2_min;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['Grid_search'][$I_Grid]['val'][1][] = "S:" . $trandate_input_2_seg;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['campos_busca']['trandate_cond'] = $trandate_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['Grid_search'][$I_Grid]['cmp'] = "trandate"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['Grid_search'][$I_Grid]['opc'] = $trandate_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['grid_pesq']['trandate'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['campos_busca']['kategori'] = $kategori; 
      if (is_array($kategori) && !empty($kategori))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['Grid_search'][$I_Grid]['val'][0] = $kategori;
      }
      elseif ($kategori_cond_salva == "nu" || $kategori_cond_salva == "nn" || $kategori_cond_salva == "ep" || $kategori_cond_salva == "ne" || !empty($kategori))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['Grid_search'][$I_Grid]['val'][0][0] = $kategori;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['campos_busca']['kategori_cond'] = $kategori_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['Grid_search'][$I_Grid]['cmp'] = "kategori"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['Grid_search'][$I_Grid]['opc'] = $kategori_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['grid_pesq']['kategori'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['doctor'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['doctor'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['doctor'] = $doctor;
      }
      $custcode_look = substr($this->Db->qstr($custcode), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct custCode from (SELECT 	z.tranCode, 	z.doctor, 	z.custCode, 	z.bayar, 	z.tranDate, 	z.Kategori FROM 	( 	SELECT 		a.tranCode, 		c.doctor, 		c.custCode, 		c.bayar AS bayar, 		a.tranDate, 		'IGD' AS Kategori  	FROM 		tbreseprawatigd a 		LEFT JOIN tbdetailigd b ON b.tranCode = a.tranCode 		LEFT JOIN tbantrian c ON c.struckNo = b.noStruk UNION ALL 	SELECT 		a.tranCode, 		c.doctor, 		c.custCode, 		c.bayar AS bayar, 		a.tranDate, 		'Poli' AS Kategori  	FROM 		tbreseprawatjalan a 		LEFT JOIN tbdetailrawatjalan b ON b.tranCode = a.tranCode 		LEFT JOIN tbantrian c ON c.struckNo = b.noStruk UNION ALL 	SELECT 		a.trancode AS tranCode, 		c.doctor, 		c.custCode, 		c.pembayaran AS bayar, 		a.tranDate, 		'OK/VK' AS Kategori  	FROM 		tbdetailresepokvk a 		LEFT JOIN ( 		SELECT 			x.inapCode AS inapCode, 			x.tranCode AS tranCode  		FROM 			( SELECT inapCode, tranCode FROM tbdetailok UNION ALL SELECT inapCode, tranCode FROM tbdetailvk ) x  		) b ON b.tranCode = a.tranCode 		LEFT JOIN tbadmrawatinap c ON c.tranCode = b.inapCode  	) z  GROUP BY 	z.tranCode ) nm_sel_esp where custCode = '$custcode_look'"; 
      ...
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['bayar'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['bayar'] = $bayar;
      }
      $kategori_look = substr($this->Db->qstr($kategori), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct Kategori from (SELECT 	z.tranCode, 	z.doctor, 	z.custCode, 	z.bayar, 	z.tranDate, 	z.Kategori FROM 	( 	SELECT 		a.tranCode, 		c.doctor, 		c.custCode, 		c.bayar AS bayar, 		a.tranDate, 		'IGD' AS Kategori  	FROM 		tbreseprawatigd a 		LEFT JOIN tbdetailigd b ON b.tranCode = a.tranCode 		LEFT JOIN tbantrian c ON c.struckNo = b.noStruk UNION ALL 	SELECT 		a.tranCode, 		c.doctor, 		c.custCode, 		c.bayar AS bayar, 		a.tranDate, 		'Poli' AS Kategori  	FROM 		tbreseprawatjalan a 		LEFT JOIN tbdetailrawatjalan b ON b.tranCode = a.tranCode 		LEFT JOIN tbantrian c ON c.struckNo = b.noStruk UNION ALL 	SELECT 		a.trancode AS tranCode, 		c.doctor, 		c.custCode, 		c.pembayaran AS bayar, 		a.tranDate, 		'OK/VK' AS Kategori  	FROM 		tbdetailresepokvk a 		LEFT JOIN ( 		SELECT 			x.inapCode AS inapCode, 			x.tranCode AS tranCode  		FROM 			( SELECT inapCode, tranCode FROM tbdetailok UNION ALL SELECT inapCode, tranCode FROM tbdetailvk ) x  		) b ON b.tranCode = a.tranCode 		LEFT JOIN tbadmrawatinap c ON c.tranCode = b.inapCode  	) z  GROUP BY 	z.tranCode ) nm_sel_esp where Kategori = '$kategori_look'"; 
      ...
      //----- $doctor
      $this->Date_part = false;
      if (isset($doctor) || $doctor_cond == "nu" || $doctor_cond == "nn" || $doctor_cond == "ep" || $doctor_cond == "ne")
      {
         $this->monta_condicao("doctor", $doctor_cond, $doctor, "", "doctor");
      }
      ...
      //----- $bayar
      $this->Date_part = false;
      if (isset($bayar) || $bayar_cond == "nu" || $bayar_cond == "nn" || $bayar_cond == "ep" || $bayar_cond == "ne")
      {
         $this->monta_condicao("bayar", $bayar_cond, $bayar, "", "bayar");
      }
      ...
      if ($trandate_cond != "bi_TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['campos_busca']['trandate'] = $val[0];
          ...
          if ($trandate_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['campos_busca']['trandate_input_2'] = $val[1];
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['grid_pesq']['trandate']['label'] = $nmgp_tab_label['trandate'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['grid_pesq']['trandate']['descr'] = $nmgp_tab_label['trandate'] . " " . $this->Ini->Nm_lang['lang_srch_ever'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['grid_pesq']['trandate']['hint']  = $nmgp_tab_label['trandate'] . " " . $this->Ini->Nm_lang['lang_srch_ever'];
      }
   ...
   function finaliza_resultado_ajax()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['where_pesq'] = $this->comando;
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['where_pesq_fast'])) 
       {
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['where_pesq'])) 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['where_pesq_fast'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['where_pesq'] = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['where_pesq_fast'] . ")";
           }
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['cond_dyn_search'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resep_rajal']['cond_pesq'] .= $this->NM_operador;
