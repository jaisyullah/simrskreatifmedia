<?php
@session_start() ;
$_SESSION['scriptcase']['av_los']['sc_process_barr'] = true;
require_once('../av_los/index.php');
unset($_SESSION['scriptcase']['av_los']['sc_process_barr']);
$ExportCtrl = new av_los_export_control;
$ExportCtrl->Export_barr();

class av_los_export_control
{
