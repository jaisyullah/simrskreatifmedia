...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____av_los"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____av_los"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['av_los']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['av_los']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['av_los']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['av_los']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['av_los']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['av_los']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['av_los']['embutida_filho'] as $ind => $sc_init)
          {
