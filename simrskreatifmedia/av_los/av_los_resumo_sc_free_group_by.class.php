...
class av_los_resumo
{
   ...
   var $count_ger;
   var $sum_bor;
   var $sc_proc_quebra_a_tglkeluar;
   var $count_a_tglkeluar;
   var $sum_a_tglkeluar_bor;
   ...
   function __construct($tipo = "")
   {
      ...
      $this->array_total_a_tglkeluar = array();
   ...
   function initializeButtons()
   {
      ...
      $this->nmgp_botoes['chart_exit'] = isset($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['dashboard_info']['under_dashboard'] ? "off" : "on";

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['av_los'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['av_los'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['av_los']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['av_los']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['av_los']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
   ...
   { 
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['export_progress_step']     = 'image';
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['export_progress_step'] = 'end';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['av_los']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['resumo_search']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['resumo_search']))
      { 
         $this->res_contr = new av_los_apl();
      ...
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['where_pesq_filtro'];
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['campos_busca']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['campos_busca']))
     { 
         $Busca_temp = $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['campos_busca'];
         ...
         {
             ob_start();
             $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['chart_combination_type'] = $_POST['fc_chart_type'];
         }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['pivot_y_axys']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['pivot_y_axys']))
       {
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['pivot_x_axys']             = array();
           $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['pivot_y_axys']             = array();
           $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['summarizing_fields_order'] = array();
           $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['comb_field_display_type']  = array();
           $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['chart_display_values']     = array();

           $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['chart_combination_type']        = 'bar3d';
           $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['chart_combination_order_rule']  = 'asc';
           $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['chart_combination_order_field'] = 'label';
           $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['chart_combination_order_rule_groupby']["a_tglkeluar"]  = 'asc';
           $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['chart_combination_order_field_groupby']["a_tglkeluar"] = 'label';

           $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['pivot_y_axys'][0] = 0;

           $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['SC_Gb_Free_cmp']["a_tglkeluar"] = 'a_tglkeluar';

           $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['SC_Gb_Free_sql']['a_tglkeluar']["a.tglKeluar"] = 'asc';

           $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['comb_field_display_type'][2] = '';

           $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['chart_display_values'][2] = null;


           $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['summarizing_fields_order']['sc_free_group_by'][] = 2;
       }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['pesq_tab_label']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['pesq_tab_label'] = "";
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['grid_search_add']))
      {
          $this->monta_css();
          $nmgp_tab_label = $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['pesq_tab_label'];
          ...
          $Seq_grid      = $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['grid_search_add']['seq'];
          $Cmp_grid      = $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['grid_search_add']['cmp'];
          ...
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['grid_search_add']);
          exit;
      }
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['res_hrz'];
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']) && !$this->NM_export)
      {
          foreach ($_SESSION['scriptcase']['sc_aba_iframe'] as $aba => $apls_aba)
          {
              if (in_array("av_los", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['where_resumo'] = "";
      }
      $this->inicializa_vars();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['contr_total_geral'] == "OK")
      {
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
          {
              $Arr_tot_name = "array_total_" . $cmp_gb;
              $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['arr_total'][$cmp_gb];
          }
      }
      else
      {
      ...
      $Sv_tot_ger = $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['tot_geral'];
      $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['contr_total_geral'] = "N";
      $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['SC_Ind_Groupby'];
      $tp_tot = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['Res_search_metric_use']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['Res_search_metric_use'])) ? true : false;
      $this->Total->$Gb_geral($tp_tot);
      $this->array_total_geral = array();
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['tot_geral'][2];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['tot_geral'][1] == 0)
      {
          $this->NM_res_sem_reg = true;
      }
      if (isset($Sv_tot_ger))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['tot_geral'] = $Sv_tot_ger;
          unset($Sv_tot_ger);
      }
      $this->compat_arrays();
      $this->resumo_init();
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['json_use_label'])
       {
          $Lab_a_tglkeluar = "a.tglKeluar";
       }
       else
       {
          $Lab_a_tglkeluar = "Tgl Keluar";
          $Lab_a_tglkeluar =  sprintf("" . $this->Ini->Nm_lang['lang_othr_chart_title_YYYYMM'] . " a.tglKeluar", $Lab_a_tglkeluar);
       }
       $prep_field = array();
       $prep_field['a_tglkeluar'] = $Lab_a_tglkeluar;
       $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['labels']['a_tglkeluar'] = $Lab_a_tglkeluar; 
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
          $Str_gb .= ($Str_gb == "") ? "" : ",";
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['labels']['a_tglkeluar']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['labels']['a_tglkeluar'] = "Tgl Keluar"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['labels']['bor']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['labels']['bor'] = "BOR"; 
       }
       //-----
       $ix = 0;
       $this->comp_field_nm = array();
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['summarizing_fields_order']['sc_free_group_by']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['summarizing_fields_order']['sc_free_group_by'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['summarizing_fields_order']['sc_free_group_by'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['summarizing_fields_display']['sc_free_group_by'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['summarizing_fields_display']['sc_free_group_by'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['summarizing_fields_display']['sc_free_group_by'] as $i_sum => $d_sum)
           {
      ...
      eval ($Str_gb);
       ...
       $Arr_parms = array();
       $Arr_parms['a_tglkeluar']['alin'] = "''";
       $Arr_parms['a_tglkeluar']['link'] = "S";
       $Arr_parms['a_tglkeluar']['fill'] = "true";
       $Arr_parms['a_tglkeluar']['order'] = "value";
       $Arr_parms['a_tglkeluar']['order_start'] = 'asc';
       $Arr_parms['a_tglkeluar']['order_invert'] = 'false';
       $Arr_parms['a_tglkeluar']['order_enabled'] = 'true';
       //-----
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
       ...
       //-----
       $prep_links_fl = array();
       $prep_links_fl['a_tglkeluar'] = array(0 => 'a_tglkeluar', 1 => '@aspass@');
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['SC_Gb_Free_cmp'] as $cmp_gb => $col_sql)
       {
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['pivot_tabular_label'];
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@av_los@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function makeTabular(&$a_data)
   {
       ...
       {
           $a_labels = array();
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['proc_pdf_vert'])
   {
     $this->comp_tab_hover = true;
   }
   ...
   function buildChart()
   {
       ...
       $prep_chart_config = array(
           ...
           '1' => array(
               ...
               'label_x'  => $this->getChartText(strip_tags($Lab_a_tglkeluar)),
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['summarizing_fields_order']['sc_free_group_by'] as $i_summ_order)
       {
                   ...
                   foreach ($this->sc_comb_quick_index[$i_index_summ] as $i_index_comb_groupby)
                   {
                       ...
                       if (!isset($a_chart_combinations[$s_comb_index]))
                       {
                           $a_chart_combinations[$s_comb_index] = array(
                               ...
                               'label_x'     => '',
                               'label_y'     => '',
                               'xml_pholder' => sizeof($this->comp_y_axys) > $i_index_group + 1 ? 'sc_av_los_' . session_id() . '_!!!C_' . ($i_index_group + 1) . '_' . $s_index_comb . ('' == $s_index_comb ? '' : '_') . '__SC_PLACEHOLDER__!!!.json' : '',
                               'xml'         => 'sc_av_los_' . session_id() . '_!!!C_' . $i_index_group . '_' . $s_index_comb . '!!!.json',
                           );
                       }
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['pivot_charts']    = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['pivot_orig']      = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['comb_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['comb_table_def']  = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['anlt_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['anlt_table_def']  = array();
	...
	function filterChartsByGroupbyLevel() {
		...
		if (isset($nmgp_opcao) && ('pdf' == $nmgp_opcao || 'pdf_res' == $nmgp_opcao) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['chart_level']) && '' !== $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['chart_level']) {
			$applyFilter = true;
		}
		elseif (isset($nmgp_opcao) && 'image_res' == $nmgp_opcao && isset($_POST['chart_level']) && '' !== $_POST['chart_level']) {
			$applyFilter = true;
			$_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['chart_level'] = $_POST['chart_level'];
		}
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['pivot_charts'] = $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['pivot_orig'];

		if ($applyFilter) {
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['pivot_charts'] as $chartIndex => $chartData) {
				...
				if ($groupbyLevel > $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['chart_level']) {
					unset($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['pivot_charts'][$chartIndex]);
				}
			}
		}

		$this->comp_chart_data = $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['pivot_charts'];
	}
	...
	function filterChartsBySummarization() {
		...
		if (isset($nmgp_opcao) && ('pdf' == $nmgp_opcao || 'pdf_res' == $nmgp_opcao)) {
			...
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['summarizing_fields_display']['sc_free_group_by'] as $fieldIndex => $fieldData) {
	...
	function filterChartsByMultiseries() {
		...
		if ($applyFilter && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['summarizing_drill_down']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['summarizing_drill_down'])) {
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['pivot_charts'] as $chartIndex => $chartData) {
				$indexParts = explode('|', $chartIndex);
           ...
           foreach ($a_totals as $i_total => $values)
           {
               ...
               if (isset($this->comp_chart_config[$key_config]))
               {
                   ...
                   foreach ($a_keys as $tmp_key)
                   {
                       ...
                       $xml_links[]  = $this->getFusionLink('sc_av_los_' . session_id() . '_!!!' . implode('_', array_merge(array($group + 1, $i_total), $link_index)) . '!!!.json');
                   }
                   ...
                   $this->comp_chart_data[$key_data]['xml']        = $this->getFusionLink('sc_av_los_' . session_id() . '_!!!' . implode('_', array_merge(array($group, $i_total), $param)) . '!!!.json');
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['embutida'])
                   {
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['proc_pdf_vert']){ 
   ...
   {
       if (!$res_chart && $this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['json_use_format']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['json_use_format'])
       {
           return $valor_campo;
       }
   ...
   function resumo_init()
   {
      ...
      $this->monta_html_ini();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
      {
      ...
      { 
         ...
         { 
             $seq_search = 1;
             foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['grid_pesq'] as $cmp => $def)
             {
                $Seq_grid      = $seq_search;
                $Cmp_grid      = $cmp;
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
               if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['av_los']))
               {
                   $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['av_los']) . "_";
               } 
           } 
           else 
           { 
               if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['av_los']))
               {
                   $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['av_los']) . "_";
               } 
           }
       }
   ...
   function resumo_final()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['ajax_nav'])
      {
   ...
   {
      $this->Tot_ger = false;
      require_once($this->Ini->path_aplicacao . "av_los_total.class.php"); 
      $this->Print_All = $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['print_all'];
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['doc_word'] || $this->Ini->sc_export_ajax_img)
      { 
      ...
      $this->Total   = new av_los_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['tot_geral'] as $ind => $val)
      {
          if ($ind > 0)
          {
      ...
      $this->array_total_a_tglkeluar = $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['arr_total']['a_tglkeluar'];
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['dashboard_refresh_after_chart'] = 'resumo';
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['doc_word'])
{
      ...
      { 
           ...
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"av_los_ajax.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\">\r\n");
           ...
           $nm_saida->saida(" </script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"av_los_jquery.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"av_los_message.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"../_lib/lib/js/scInput.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"../_lib/lib/js/jquery.scInput.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"../_lib/lib/js/jquery.scInput2.js\"></script>\r\n");
   ...
   { 
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['num_css']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['num_css'] = rand(0, 1000);
      }
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_av_los_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_av_los_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_av_los_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['num_css'] . '.css');
...
$nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "av_los/av_los_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\">\r\n");
           ...
           $nm_saida->saida("         dataType: \"html\",\r\n");
           $nm_saida->saida("         url: \"av_los_save_grid.php\",\r\n");
           ...
           $nm_saida->saida("     }\r\n");
           $nm_saida->saida("   </script>\r\n");
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['ajax_nav'] && !$this->Ini->sc_export_ajax && !$this->Ini->Export_html_zip && !$_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['doc_word'])
      {
           $nm_saida->saida("   <script type=\"text/javascript\"> \r\n");
          ...
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['grid_pesq']))
          { 
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['doc_word']) 
      {
      ...
      {
          $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['dashboard_info']['remove_margin'] ? ' style="margin: 0"' : '';
          $nm_saida->saida(" <BODY class=\"" . $this->css_scGridPage . "\"" . $remove_margin . ">\r\n");
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['embutida'])
      {
...
;
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top_normal()
   {
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['ajax_nav'] && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['where_resumo_search']))
      {
          $this->NM_res_sem_reg = false;
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['embutida'])
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['pdf'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "Rpdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "av_los/av_los_config_pdf.php?nm_opc=pdf&nm_target=0&nm_cor=cor&papel=8&orientacao=1&bookmarks=1&largura=1200&conf_larg=S&conf_fonte=10&grafico=S&sc_ver_93=" . s . "&nm_tem_gb=s&nm_res_cons=s&nm_ini_pdf_res=chart&nm_all_modules=chart&password=n&summary_export_columns=N&pdf_zip=N&origem=chart&language=id&conf_socor=N&is_chart_app=Y&nm_label_group=N&nm_all_cab=S&nm_all_label=S&nm_orient_grid=2&script_case_init=" . $this->Ini->sc_page . "&app_name=av_los&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "av_los/av_los_config_print.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=N&nm_opc=resumo&nm_cor=CO&nm_res_cons=s&nm_ini_prt_res=chart&nm_all_modules=chart&password=n&origem=chart&language=id&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         ...
         if (is_file("av_los_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
            $Arq_WebHelp = file("av_los_help.txt"); 
   ...
   function monta_html_fim()
   {
      ...
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['av_los']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['av_los']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
$nm_saida->saida("       scJs_alert('" . $mensagem . "', $jsonParams);\r\n");
      ...
      elseif ($this->Ini->Export_html_zip || ($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['opcao'] == "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['graf_pdf'] == "S"))
      {
          $this->grafico_pdf();
      }
      else
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'av_los_config_pivot.php?nome_apl=av_los&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=id&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   $nm_saida->saida("                  action=\"av_los_iframe_prt.php\" \r\n");
   ...
   $nm_saida->saida("   </form> \r\n");
          ...
          $nm_saida->saida("               document.Fprint.action = \"av_los_export_ctrl.php\";\r\n");
          $nm_saida->saida("           }\r\n");
          $nm_saida->saida("           else\r\n");
          $nm_saida->saida("           {\r\n");
   ...
   $nm_saida->saida("           document.Fexport.nmgp_tot_xls.value = tot_xls;\r\n");
          ...
          $nm_saida->saida("           $('#TB_window').remove();\r\n");
          $nm_saida->saida("           $('body').append(\"<div id='TB_window'></div>\");\r\n");
          $nm_saida->saida("               nm_submit_modal(\"" . $this->Ini->path_link . "av_los/av_los_export_email.php?script_case_init={$this->Ini->sc_page}&path_img={$this->Ini->path_img_global}&path_btn={$this->Ini->path_botoes}&sType=\" + str_type +\"&sAdd=__E__nm_xml_tag=\" + xml_tag + \"__E__nm_xml_label=\" + xml_label + \"&KeepThis=true&TB_iframe=true&modal=true\", bol_param);\r\n");
          $nm_saida->saida("       }\r\n");
          $nm_saida->saida("       else\r\n");
          $nm_saida->saida("       {\r\n");
          ...
          $nm_saida->saida("       document.Fexport.action = \"av_los_export_ctrl.php\";\r\n");
      ...
      if (!extension_loaded("zip"))
      {
          ...
          $nm_saida->saida("       document.F3.SC_module_export.value = z;\r\n");
          $nm_saida->saida("  }\r\n");
      $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['av_los_iframe_params'] = array(
      ...
      $Md5_pdf    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@av_los@SC_par@" . md5($prep_parm_pdf);
      $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['Md5_pdf'][md5($prep_parm_pdf)] = $prep_parm_pdf;
...
;
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_av_los_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "av_los/av_los_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
...
//--- 
 function grafico_pdf()
 {
   ...
   $this->Graf->Ini    = $this->Ini;
   $this->Graf->Lookup = $this->Lookup;
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['pivot_charts']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['skip_charts']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['skip_charts']))
   {
 ...
 { 
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['pivot_charts'] as $chart_index => $chart_data)
       {
 ...
 { 
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['this_chart_label'] = '';
           $this->Graf->monta_grafico($chart_index, 'pdf');
           if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['this_chart_label']) {
               $nm_saida->saida("<script type=\"text/javascript\">$(\"#$random_id\").html(\"{$_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['this_chart_label']}\")</script>\r\n");
           }
       ...
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['charts_html']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['charts_html'])
       {
            $nm_saida->saida("<script type=\"text/javascript\">\r\n");
            $nm_saida->saida("{$_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['charts_html']}\r\n");
            $nm_saida->saida("</script>\r\n");
       }
   }
       $nm_saida->saida("</body>\r\n");
...
//--- 
 ...
 {
   global $nm_saida, $nm_lang;
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['chart_list']))
   {
       $prim_graf = true;
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['chart_list'] as $arr_chart)
       {
           if (!$prim_graf)
           {
               $nm_saida->saida("<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>\r\n");
...
//--- 
 function grafico_bot()
 {
   ...
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['pivot_charts']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['graf_bot'] = true;
       $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['graf_first'] = true;
       require_once($this->Ini->path_aplicacao . $this->Ini->Apl_grafico); 
       $this->Graf  = new av_los_grafico();
       $this->Graf->Db     = $this->Db;
       $this->Graf->Erro   = $this->Erro;
       ...
       $nm_saida->saida("<TR>\r\n");
       $iChartCount = 1;
       $iChartTotal = sizeof($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['pivot_charts']);
       $sChartLang  = isset($this->Ini->Nm_lang['lang_pdff_pcht']) ? $this->Ini->Nm_lang['lang_pdff_pcht'] : 'Generating chart';
       if (!NM_is_utf8($sChartLang))
       {
           $sChartLang = sc_convert_encoding($sChartLang, "UTF-8", $_SESSION['scriptcase']['charset']);
      ...
      if ($bPDF && (!isset($this->progress_fp) || !$this->progress_fp))
      {
       ...
       $nm_saida->saida("</TD>\r\n");
       $nm_saida->saida("</TR>\r\n");
       $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['graf_bot'] = false;
       if ($bPDF && isset($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['charts_html']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['charts_html'])
       {
           $nm_saida->saida("<script type=\"text/javascript\">\r\n");
           $nm_saida->saida("{$_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['charts_html']}\r\n");
           $nm_saida->saida("</script>\r\n");
...
//--- 
   ...
   {
      global $nm_saida;
      $nm_saida->saida(" <TR><TD id=\"id_resumo_search\" valign=\"top\" style=\"display:none;\">\r\n");
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['ajax_nav'])
       { 
           $_SESSION['scriptcase']['saida_html'] = "";
       } 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['ajax_nav'])
       { 
           $this->Ini->Arr_result['setDisplay'][] = array('field' => 'id_resumo_search', 'value' => 'none');
           $this->Ini->Arr_result['setValue'][] = array('field' => 'id_resumo_search', 'value' => NM_charset_to_utf8($_SESSION['scriptcase']['saida_html']));
           $_SESSION['scriptcase']['saida_html'] = "";
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['resumo_search_look']))
           { 
               $this->Ini->Arr_result['setArr'][] = array('var' => 'Tab_obj_res_combo', 'value' => '');
               foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['resumo_search_look'] as $cada_combo => $opcs_combo)
               { 
               ...
               if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['resumo_search_look']))
               { 
   ...
   {
       global $nm_saida;
       $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['res_search_label'] = array();
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['resumo_search']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['resumo_search']         = array();
           $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['resumo_search_look']    = array();
       ...
       $lin_obj  = $this->resumo_search_a_tglKeluar_SC_1();
   ...
   function resumo_search_a_tglKeluar_SC_1()
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['resumo_search']['a_tglKeluar_SC_1']))
       {
       ...
       $lin_obj .= "Tahun";
       $Cod_Btn  = nmButtonOutput($this->arr_buttons, "blimparsummaryfield", "nm_proc_res_search('a_tglKeluar_SC_1', '', '', '', 'clear_search_obj', '', '');", "nm_proc_res_search('a_tglKeluar_SC_1', '', '', '', 'clear_search_obj', '', '');", "a_tglKeluar_SC_1_clear", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
       $lin_obj .= "<span id=\"btn_clear_a_tglKeluar_SC_1\" style='float:right; display: none;' class='scGridSummarySearchLabelclean'>". $Cod_Btn ."</span>"; 
       $lin_obj .= "     </div>";
       $lin_obj  .= "   <div class='scGridSummarySearchObjeto' id=\"id_tab_a_tglKeluar_SC_1\" style=\" \">";
       $lin_obj  .= "   <select class=\"css_toolbar_obj\" style=\"vertical-align: middle;\" id=\"a_tglKeluar_SC_1\" name=\"a_tglKeluar_SC_1\" onChange=\"nm_proc_res_search('a_tglKeluar_SC_1', 'a.tglKeluar', 'select', 'dth', 'eql', 'actual', 'YYYY');\" onClick=\"ajax_res_fill_combo('a_tglKeluar_SC_1');\">";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['resumo_search_look']['a_tglKeluar_SC_1']))
       {
           $result_look = $this->Lookup->lookup_res_a_tglKeluar_SC_1();
           foreach ($result_look['set_option'] as $ind => $opcs)
           {
               $selected  = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['resumo_search_look']['a_tglKeluar_SC_1']) && in_array($opcs['opt'], $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['resumo_search_look']['a_tglKeluar_SC_1'])) ? " selected" : "";
   ...
   function JS_resumo_search()
   {
       ...
       $nm_saida->saida("         $('#a_tglKeluar_SC_1').SumoSelect({ csvDispCount: 3, selectAll:true, placeholder: '" . $this->Ini->Nm_lang['lang_search_select_summary'] . "', captionFormat:'{0} " . $this->Ini->Nm_lang['lang_btns_selected_summary'] . "', captionFormatAllSelected: '" . $this->Ini->Nm_lang['lang_btns_all_of_them_summary'] . "', locale : ['" . $this->Ini->Nm_lang['lang_btns_ok_summary'] . "', '" . $this->Ini->Nm_lang['lang_btns_cancel_summary'] . "', '" . $this->Ini->Nm_lang['lang_btns_all_selected_summary'] . "'] });\r\n");
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['resumo_search_look']))
       { 
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['resumo_search_look'] as $cada_combo => $opcs_combo)
           { 
...
$nm_saida->saida("             }\r\n");
   ...
   //---- 
   function adiciona_registro($sum_bor, $quebra_a_tglkeluar, $quebra_a_tglkeluar_orig)
   {
      $contr_arr = "";
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
          $Name_orig  = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['SC_Gb_Free_orig'][$cmp_gb])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['SC_Gb_Free_orig'][$cmp_gb] : $cmp_gb;
      ...
      if (empty($this->array_total_geral))
      {
         ...
         $this->array_total_geral[1] = $sum_bor;
      }
      else
      {
   ...
   function compat_arrays()
   {
      ...
      {
          $Arr_gb[]   = $cmp_gb;
          $Arr_name[] = "_SESSION['sc_session'][" . $this->Ini->sc_page . "]['av_los']['arr_total']['" .$cmp_gb . "']" . $Control;
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     { 
         $nmgp_select = "SELECT str_replace (convert(char(10),a.tglKeluar,102), '.', '-') + ' ' + convert(char(8),a.tglKeluar,20) as a_tglkeluar, SUM( DATEDIFF( a.tglKeluar,b.tglMasuk ) ) / count( * ) as bor from " . $this->Ini->nm_tabela; 
     } 
     elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
     { 
         $nmgp_select = "SELECT a.tglKeluar as a_tglkeluar, SUM( DATEDIFF( a.tglKeluar,b.tglMasuk ) ) / count( * ) as bor from " . $this->Ini->nm_tabela; 
     } 
     elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
     { 
         $nmgp_select = "SELECT convert(char(23),a.tglKeluar,121) as a_tglkeluar, SUM( DATEDIFF( a.tglKeluar,b.tglMasuk ) ) / count( * ) as bor from " . $this->Ini->nm_tabela; 
     } 
     else 
     { 
         $nmgp_select = "SELECT a.tglKeluar as a_tglkeluar, SUM( DATEDIFF( a.tglKeluar,b.tglMasuk ) ) / count( * ) as bor from " . $this->Ini->nm_tabela; 
     } 
     $nmgp_select .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['where_pesq']; 
     $nmgp_select .= " group by date_format( a.tglKeluar, '%Y-%m' )"; 
     $campos_order = "";
     foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['SC_Gb_Free_sql'] as $cmp_var => $resto)
     {
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->a_tglkeluar = $rs_res->fields[0] ;  
            $this->bor = $rs_res->fields[1] ;  
            $this->bor =  str_replace(",", ".", $this->bor);
            $this->a_tglkeluar_orig = $this->a_tglkeluar;
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->bor, $this->a_tglkeluar, $this->a_tglkeluar_orig);
            }
   }
//
   ...
   function totaliza_php_sc_free_group_by()
   {
      ...
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['where_pesq_filtro'];
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['contr_total_geral'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['contr_array_resumo'] == "OK")
      {
          return;
      }
      //----- 
      ...
      { 
         $nmgp_select = "SELECT EXTEND(a.tglKeluar, YEAR TO FRACTION) as a_tglkeluar, SUM( DATEDIFF( a.tglKeluar,b.tglMasuk ) ) / count( * ) as bor from " . $this->Ini->nm_tabela; 
      } 
      else 
      { 
         $nmgp_select = "SELECT a.tglKeluar as a_tglkeluar, SUM( DATEDIFF( a.tglKeluar,b.tglMasuk ) ) / count( * ) as bor from " . $this->Ini->nm_tabela; 
   ...
   $nmgp_order_by = ""; 
   $campos_order_select = "";
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['ordem_select'] as $campo => $ordem) 
   {
        if ($campo != $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['ordem_grid']) 
        {
   ...
   $campos_order = "";
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['ordem_quebra'] as $campo => $resto) 
   {
       foreach($resto as $sqldef => $ordem) 
       {
           $format       = $this->Ini->Get_Gb_date_format($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['SC_Ind_Groupby'], $campo);
           $campos_order = $this->Ini->Get_date_order_groupby($sqldef, $ordem, $format, $campos_order);
       }
   }
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['ordem_grid'])) 
   { 
       if (!empty($campos_order)) 
       { 
           $campos_order .= ", ";
       } 
       $nmgp_order_by = " order by " . $campos_order . $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['ordem_grid'] . $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['ordem_desc']; 
   } 
   ...
   $nmgp_select .= $nmgp_order_by; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['order_grid'] = $nmgp_order_by;
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nmgp_select; 
      ...
      {
         $this->a_tglkeluar = $this->rs_grid->fields[0] ;  
         $this->rs_grid->fields[1] =  str_replace(",", ".", $this->rs_grid->fields[1]);  
         $this->bor = $this->rs_grid->fields[1] ;  
         $this->bor = (string)$this->bor;  
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['SC_Gb_Free_orig']))
         {
             foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['SC_Gb_Free_orig'] as $Cmp_clone => $Cmp_orig)
             {
                 $this->$Cmp_clone = $this->$Cmp_orig;
             }
         }
         $a_tglkeluar_orig = $this->a_tglkeluar;
         $this->arg_sum_a_tglkeluar = " = " . $this->Db->qstr($this->a_tglkeluar);
         $this->adiciona_registro(NM_encode_input(sc_strip_script($this->bor)), NM_encode_input(sc_strip_script($this->a_tglkeluar)), NM_encode_input(sc_strip_script($a_tglkeluar_orig)));
         $this->rs_grid->MoveNext();
      }
      $this->finaliza_arrays();
      $this->rs_grid->Close();
      $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['tot_geral'][2] = $this->array_total_geral[1];
      $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['contr_array_resumo'] = "OK";
      $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['tot_geral'][0] = "" . $this->Ini->Nm_lang['lang_msgs_totl'] . "";
      $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['tot_geral'][1] = $this->array_total_geral[0];
      $count_ger = $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['tot_geral'][1];
      $sum_bor = $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['tot_geral'][2];
      $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['contr_total_geral'] = "OK";
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['SC_Ind_Groupby'] == "sc_free_group_by")
      {
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
          {
              eval ('$_SESSION["sc_session"][' . $this->Ini->sc_page . ']["av_los"]["arr_total"]["' . $cmp_gb . '"] = $this->array_total_' .  $cmp_gb . ';');
          }
      }
   }
   ...
   function html_grid_search()
   {
       ...
       $tmp = $_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['cond_pesq'];
       $pos = strrpos($tmp, "##*@@");
       if ($pos !== false)
       {
       ...
       $str_display = empty($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['grid_pesq'])?'none':'';
       if(!$_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['ajax_nav'])
       {
          $nm_saida->saida("   <tr id=\"NM_Grid_Search\" ajax='' style='display:" . $str_display . "'>\r\n");
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['ajax_nav'] && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['grid_pesq']))
       { 
           $_SESSION['scriptcase']['saida_html'] = "";
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['grid_pesq'] as $cmp => $def)
           {
           ...
           if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['save_grid']))
           {
               return;
           }
           else
       ...
       $nm_saida->saida("            <input type=\"hidden\" name=\"parm\" value=\"\"/> \r\n");
            if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['grid_pesq']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['grid_pesq']))
            {
                foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['grid_pesq'] as $cmp => $def)
                {
                    if (isset($def['label'])) {
       ...
       { 
           ...
           $_SESSION['scriptcase']['saida_html'] = "";
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['save_grid']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['grid_pesq']))
           { 
   ...
   function grid_search_add_tag()
   {
       ...
       if (count($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['grid_pesq']) < 0)
       {
           $lin_obj .= "<table id='id_grid_search_all_cmp' cellpadding=0 cellspacing=0>";
           foreach ($All_cmp_search as $cada_cmp)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['av_los']['grid_pesq'][$cada_cmp]))
               {
                   $lin_obj .= "  <tr>";
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "simrskreatifmedia/av_los";
