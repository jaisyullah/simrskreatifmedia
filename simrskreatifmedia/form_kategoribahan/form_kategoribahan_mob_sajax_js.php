  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_kategoribahan_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_kategoribahan_mob_form();
	}

  // ---------- Validate kategoricode
  function do_ajax_form_kategoribahan_mob_validate_kategoricode()
  {
    var nomeCampo_kategoricode = "kategoricode";
    var var_kategoricode = scAjaxGetFieldText(nomeCampo_kategoricode);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_kategoribahan_mob_validate_kategoricode(var_kategoricode, var_script_case_init, do_ajax_form_kategoribahan_mob_validate_kategoricode_cb);
  } // do_ajax_form_kategoribahan_mob_validate_kategoricode

  function do_ajax_form_kategoribahan_mob_validate_kategoricode_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "kategoricode";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_kategoribahan_mob_validate_kategoricode_cb

  // ---------- Validate namakategori
  function do_ajax_form_kategoribahan_mob_validate_namakategori()
  {
    var nomeCampo_namakategori = "namakategori";
    var var_namakategori = scAjaxGetFieldText(nomeCampo_namakategori);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_kategoribahan_mob_validate_namakategori(var_namakategori, var_script_case_init, do_ajax_form_kategoribahan_mob_validate_namakategori_cb);
  } // do_ajax_form_kategoribahan_mob_validate_namakategori

  function do_ajax_form_kategoribahan_mob_validate_namakategori_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "namakategori";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_kategoribahan_mob_validate_namakategori_cb

  // ---------- Validate keterangan
  function do_ajax_form_kategoribahan_mob_validate_keterangan()
  {
    var nomeCampo_keterangan = "keterangan";
    var var_keterangan = scAjaxGetFieldText(nomeCampo_keterangan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_kategoribahan_mob_validate_keterangan(var_keterangan, var_script_case_init, do_ajax_form_kategoribahan_mob_validate_keterangan_cb);
  } // do_ajax_form_kategoribahan_mob_validate_keterangan

  function do_ajax_form_kategoribahan_mob_validate_keterangan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_kategoribahan_mob_validate_keterangan_cb

  // ---------- Validate aktif
  function do_ajax_form_kategoribahan_mob_validate_aktif()
  {
    var nomeCampo_aktif = "aktif";
    var var_aktif = scAjaxGetFieldRadio(nomeCampo_aktif);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_kategoribahan_mob_validate_aktif(var_aktif, var_script_case_init, do_ajax_form_kategoribahan_mob_validate_aktif_cb);
  } // do_ajax_form_kategoribahan_mob_validate_aktif

  function do_ajax_form_kategoribahan_mob_validate_aktif_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "aktif";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_kategoribahan_mob_validate_aktif_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_kategoribahan_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_kategoribahan_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_kategoricode = scAjaxGetFieldText("kategoricode");
    var var_namakategori = scAjaxGetFieldText("namakategori");
    ...
    scAjaxProcOn();
    x_ajax_form_kategoribahan_mob_submit_form(var_kategoricode, var_namakategori, var_keterangan, var_aktif, var_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_kategoribahan_mob_submit_form_cb);
  } // do_ajax_form_kategoribahan_mob_submit_form

  function do_ajax_form_kategoribahan_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("kategoricode");
      scAjaxHideErrorDisplay("namakategori");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_kategoribahan_mob_submit_form_cb_after_alert);
  } // do_ajax_form_kategoribahan_mob_submit_form_cb
  function do_ajax_form_kategoribahan_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_kategoribahan_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_kategoribahan_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_kategoribahan_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_kategoribahan_mob_navigate_form_cb);
  } // do_ajax_form_kategoribahan_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_kategoribahan_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_kategoribahan_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_kategoribahan_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_kategoribahan_mob_navigate_form_cb
  function do_ajax_form_kategoribahan_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_kategoribahan_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_kategoribahan_mob_navigate_form_cb_after_alert
  function sc_hide_form_kategoribahan_mob_form()
  {
  ...
  ajax_field_list[0] = "kategoricode";
  ajax_field_list[1] = "namakategori";
  ...
  var ajax_error_list = {
    "kategoricode": {"label": "Kode Kategori", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "namakategori": {"label": "Kategori Bahan", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  var ajax_field_mult = {
    "kategoricode": new Array(),
    "namakategori": new Array(),
    "keterangan": new Array(),
    "aktif": new Array()
  };
  ajax_field_mult["kategoricode"][1] = "kategoricode";
  ajax_field_mult["namakategori"][1] = "namakategori";
  ajax_field_mult["keterangan"][1] = "keterangan";
  ajax_field_mult["aktif"][1] = "aktif";

  var ajax_field_id = {
    "kategoricode": new Array("hidden_field_label_kategoricode", "hidden_field_data_kategoricode"),
    "namakategori": new Array("hidden_field_label_namakategori", "hidden_field_data_namakategori"),
