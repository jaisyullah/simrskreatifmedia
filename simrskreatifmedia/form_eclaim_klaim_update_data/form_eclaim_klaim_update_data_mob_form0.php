...
?>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_eclaim_klaim_update_data_mob']['embutida_pdf']))
 {
 ?>
...
<?php
include_once("form_eclaim_klaim_update_data_mob_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_eclaim_klaim_update_data_mob_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_eclaim_klaim_update_data_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_eclaim_klaim_update_data_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_eclaim_klaim_update_data_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_eclaim_klaim_update_data_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_eclaim_klaim_update_data_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_eclaim_klaim_update_data_mob']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_eclaim_klaim_update_data_mob']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_eclaim_klaim_update_data_mob']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
?>
<body class="scFormPage" style="<?php echo $remove_margin . $str_iframe_body; ?>">
<?php

if (isset($_SESSION['scriptcase']['form_eclaim_klaim_update_data']['error_buffer']) && '' != $_SESSION['scriptcase']['form_eclaim_klaim_update_data']['error_buffer'])
{
    echo $_SESSION['scriptcase']['form_eclaim_klaim_update_data']['error_buffer'];
}
...
<?php
 include_once("form_eclaim_klaim_update_data_mob_js0.php");
?>
<script type="text/javascript"> 
...
<form  name="F1" method="post" 
               action="form_eclaim_klaim_update_data_mob.php" 
               target="_self">
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_eclaim_klaim_update_data_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_eclaim_klaim_update_data_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_eclaim_klaim_update_data_mob']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_eclaim_klaim_update_data_mob']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_eclaim_klaim_update_data_mob']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_eclaim_klaim_update_data_mob']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['form_eclaim_klaim_update_data_mob']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<?php
  ...
  {
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_eclaim_klaim_update_data_mob']['where_filter']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['form_eclaim_klaim_update_data_mob']['empty_filter'] = true;
       }
  }
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_nomor_sep_line" id="hidden_field_data_nomor_sep" style="<?php echo $sStyleHidden_nomor_sep; ?>"> <span class="scFormLabelOddFormat css_nomor_sep_label"><span id="id_label_nomor_sep"><?php echo $this->nm_new_label['nomor_sep']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_nomor_kartu_line" id="hidden_field_data_nomor_kartu" style="<?php echo $sStyleHidden_nomor_kartu; ?>"> <span class="scFormLabelOddFormat css_nomor_kartu_label"><span id="id_label_nomor_kartu"><?php echo $this->nm_new_label['nomor_kartu']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_tgl_masuk_line" id="hidden_field_data_tgl_masuk" style="<?php echo $sStyleHidden_tgl_masuk; ?>"> <span class="scFormLabelOddFormat css_tgl_masuk_label"><span id="id_label_tgl_masuk"><?php echo $this->nm_new_label['tgl_masuk']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_tgl_pulang_line" id="hidden_field_data_tgl_pulang" style="<?php echo $sStyleHidden_tgl_pulang; ?>"> <span class="scFormLabelOddFormat css_tgl_pulang_label"><span id="id_label_tgl_pulang"><?php echo $this->nm_new_label['tgl_pulang']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_jenis_rawat_line" id="hidden_field_data_jenis_rawat" style="<?php echo $sStyleHidden_jenis_rawat; ?>"> <span class="scFormLabelOddFormat css_jenis_rawat_label"><span id="id_label_jenis_rawat"><?php echo $this->nm_new_label['jenis_rawat']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_kelas_rawat_line" id="hidden_field_data_kelas_rawat" style="<?php echo $sStyleHidden_kelas_rawat; ?>"> <span class="scFormLabelOddFormat css_kelas_rawat_label"><span id="id_label_kelas_rawat"><?php echo $this->nm_new_label['kelas_rawat']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_adl_sub_acute_line" id="hidden_field_data_adl_sub_acute" style="<?php echo $sStyleHidden_adl_sub_acute; ?>"> <span class="scFormLabelOddFormat css_adl_sub_acute_label"><span id="id_label_adl_sub_acute"><?php echo $this->nm_new_label['adl_sub_acute']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_adl_chronic_line" id="hidden_field_data_adl_chronic" style="<?php echo $sStyleHidden_adl_chronic; ?>"> <span class="scFormLabelOddFormat css_adl_chronic_label"><span id="id_label_adl_chronic"><?php echo $this->nm_new_label['adl_chronic']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_icu_indikator_line" id="hidden_field_data_icu_indikator" style="<?php echo $sStyleHidden_icu_indikator; ?>"> <span class="scFormLabelOddFormat css_icu_indikator_label"><span id="id_label_icu_indikator"><?php echo $this->nm_new_label['icu_indikator']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_icu_los_line" id="hidden_field_data_icu_los" style="<?php echo $sStyleHidden_icu_los; ?>"> <span class="scFormLabelOddFormat css_icu_los_label"><span id="id_label_icu_los"><?php echo $this->nm_new_label['icu_los']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_ventilator_hour_line" id="hidden_field_data_ventilator_hour" style="<?php echo $sStyleHidden_ventilator_hour; ?>"> <span class="scFormLabelOddFormat css_ventilator_hour_label"><span id="id_label_ventilator_hour"><?php echo $this->nm_new_label['ventilator_hour']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_upgrade_class_ind_line" id="hidden_field_data_upgrade_class_ind" style="<?php echo $sStyleHidden_upgrade_class_ind; ?>"> <span class="scFormLabelOddFormat css_upgrade_class_ind_label"><span id="id_label_upgrade_class_ind"><?php echo $this->nm_new_label['upgrade_class_ind']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_upgrade_class_class_line" id="hidden_field_data_upgrade_class_class" style="<?php echo $sStyleHidden_upgrade_class_class; ?>"> <span class="scFormLabelOddFormat css_upgrade_class_class_label"><span id="id_label_upgrade_class_class"><?php echo $this->nm_new_label['upgrade_class_class']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_upgrade_class_los_line" id="hidden_field_data_upgrade_class_los" style="<?php echo $sStyleHidden_upgrade_class_los; ?>"> <span class="scFormLabelOddFormat css_upgrade_class_los_label"><span id="id_label_upgrade_class_los"><?php echo $this->nm_new_label['upgrade_class_los']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_add_payment_pct_line" id="hidden_field_data_add_payment_pct" style="<?php echo $sStyleHidden_add_payment_pct; ?>"> <span class="scFormLabelOddFormat css_add_payment_pct_label"><span id="id_label_add_payment_pct"><?php echo $this->nm_new_label['add_payment_pct']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_birth_weight_line" id="hidden_field_data_birth_weight" style="<?php echo $sStyleHidden_birth_weight; ?>"> <span class="scFormLabelOddFormat css_birth_weight_label"><span id="id_label_birth_weight"><?php echo $this->nm_new_label['birth_weight']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_discharge_status_line" id="hidden_field_data_discharge_status" style="<?php echo $sStyleHidden_discharge_status; ?>"> <span class="scFormLabelOddFormat css_discharge_status_label"><span id="id_label_discharge_status"><?php echo $this->nm_new_label['discharge_status']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_diagnosa_line" id="hidden_field_data_diagnosa" style="<?php echo $sStyleHidden_diagnosa; ?>"> <span class="scFormLabelOddFormat css_diagnosa_label"><span id="id_label_diagnosa"><?php echo $this->nm_new_label['diagnosa']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_procedure_line" id="hidden_field_data_procedure" style="<?php echo $sStyleHidden_procedure; ?>"> <span class="scFormLabelOddFormat css_procedure_label"><span id="id_label_procedure"><?php echo $this->nm_new_label['procedure']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_tarif_rs_prosedur_non_bedah_line" id="hidden_field_data_tarif_rs_prosedur_non_bedah" style="<?php echo $sStyleHidden_tarif_rs_prosedur_non_bedah; ?>"> <span class="scFormLabelOddFormat css_tarif_rs_prosedur_non_bedah_label"><span id="id_label_tarif_rs_prosedur_non_bedah"><?php echo $this->nm_new_label['tarif_rs_prosedur_non_bedah']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_tarif_rs_prosedur_bedah_line" id="hidden_field_data_tarif_rs_prosedur_bedah" style="<?php echo $sStyleHidden_tarif_rs_prosedur_bedah; ?>"> <span class="scFormLabelOddFormat css_tarif_rs_prosedur_bedah_label"><span id="id_label_tarif_rs_prosedur_bedah"><?php echo $this->nm_new_label['tarif_rs_prosedur_bedah']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_tarif_rs_konsultasi_line" id="hidden_field_data_tarif_rs_konsultasi" style="<?php echo $sStyleHidden_tarif_rs_konsultasi; ?>"> <span class="scFormLabelOddFormat css_tarif_rs_konsultasi_label"><span id="id_label_tarif_rs_konsultasi"><?php echo $this->nm_new_label['tarif_rs_konsultasi']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_tarif_rs_tenaga_ahli_line" id="hidden_field_data_tarif_rs_tenaga_ahli" style="<?php echo $sStyleHidden_tarif_rs_tenaga_ahli; ?>"> <span class="scFormLabelOddFormat css_tarif_rs_tenaga_ahli_label"><span id="id_label_tarif_rs_tenaga_ahli"><?php echo $this->nm_new_label['tarif_rs_tenaga_ahli']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_tarif_rs_keperawatan_line" id="hidden_field_data_tarif_rs_keperawatan" style="<?php echo $sStyleHidden_tarif_rs_keperawatan; ?>"> <span class="scFormLabelOddFormat css_tarif_rs_keperawatan_label"><span id="id_label_tarif_rs_keperawatan"><?php echo $this->nm_new_label['tarif_rs_keperawatan']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_tarif_rs_penunjang_line" id="hidden_field_data_tarif_rs_penunjang" style="<?php echo $sStyleHidden_tarif_rs_penunjang; ?>"> <span class="scFormLabelOddFormat css_tarif_rs_penunjang_label"><span id="id_label_tarif_rs_penunjang"><?php echo $this->nm_new_label['tarif_rs_penunjang']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_tarif_rs_radiologi_line" id="hidden_field_data_tarif_rs_radiologi" style="<?php echo $sStyleHidden_tarif_rs_radiologi; ?>"> <span class="scFormLabelOddFormat css_tarif_rs_radiologi_label"><span id="id_label_tarif_rs_radiologi"><?php echo $this->nm_new_label['tarif_rs_radiologi']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_tarif_rs_laboratorium_line" id="hidden_field_data_tarif_rs_laboratorium" style="<?php echo $sStyleHidden_tarif_rs_laboratorium; ?>"> <span class="scFormLabelOddFormat css_tarif_rs_laboratorium_label"><span id="id_label_tarif_rs_laboratorium"><?php echo $this->nm_new_label['tarif_rs_laboratorium']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_tarif_rs_pelayanan_darah_line" id="hidden_field_data_tarif_rs_pelayanan_darah" style="<?php echo $sStyleHidden_tarif_rs_pelayanan_darah; ?>"> <span class="scFormLabelOddFormat css_tarif_rs_pelayanan_darah_label"><span id="id_label_tarif_rs_pelayanan_darah"><?php echo $this->nm_new_label['tarif_rs_pelayanan_darah']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_tarif_rs_rehabilitasi_line" id="hidden_field_data_tarif_rs_rehabilitasi" style="<?php echo $sStyleHidden_tarif_rs_rehabilitasi; ?>"> <span class="scFormLabelOddFormat css_tarif_rs_rehabilitasi_label"><span id="id_label_tarif_rs_rehabilitasi"><?php echo $this->nm_new_label['tarif_rs_rehabilitasi']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_tarif_rs_kamar_line" id="hidden_field_data_tarif_rs_kamar" style="<?php echo $sStyleHidden_tarif_rs_kamar; ?>"> <span class="scFormLabelOddFormat css_tarif_rs_kamar_label"><span id="id_label_tarif_rs_kamar"><?php echo $this->nm_new_label['tarif_rs_kamar']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_tarif_rs_rawat_intensif_line" id="hidden_field_data_tarif_rs_rawat_intensif" style="<?php echo $sStyleHidden_tarif_rs_rawat_intensif; ?>"> <span class="scFormLabelOddFormat css_tarif_rs_rawat_intensif_label"><span id="id_label_tarif_rs_rawat_intensif"><?php echo $this->nm_new_label['tarif_rs_rawat_intensif']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_tarif_rs_obat_line" id="hidden_field_data_tarif_rs_obat" style="<?php echo $sStyleHidden_tarif_rs_obat; ?>"> <span class="scFormLabelOddFormat css_tarif_rs_obat_label"><span id="id_label_tarif_rs_obat"><?php echo $this->nm_new_label['tarif_rs_obat']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_tarif_rs_alkes_line" id="hidden_field_data_tarif_rs_alkes" style="<?php echo $sStyleHidden_tarif_rs_alkes; ?>"> <span class="scFormLabelOddFormat css_tarif_rs_alkes_label"><span id="id_label_tarif_rs_alkes"><?php echo $this->nm_new_label['tarif_rs_alkes']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_tarif_rs_bmhp_line" id="hidden_field_data_tarif_rs_bmhp" style="<?php echo $sStyleHidden_tarif_rs_bmhp; ?>"> <span class="scFormLabelOddFormat css_tarif_rs_bmhp_label"><span id="id_label_tarif_rs_bmhp"><?php echo $this->nm_new_label['tarif_rs_bmhp']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_tarif_rs_sewa_alat_line" id="hidden_field_data_tarif_rs_sewa_alat" style="<?php echo $sStyleHidden_tarif_rs_sewa_alat; ?>"> <span class="scFormLabelOddFormat css_tarif_rs_sewa_alat_label"><span id="id_label_tarif_rs_sewa_alat"><?php echo $this->nm_new_label['tarif_rs_sewa_alat']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_tarif_poli_eks_line" id="hidden_field_data_tarif_poli_eks" style="<?php echo $sStyleHidden_tarif_poli_eks; ?>"> <span class="scFormLabelOddFormat css_tarif_poli_eks_label"><span id="id_label_tarif_poli_eks"><?php echo $this->nm_new_label['tarif_poli_eks']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_nama_dokter_line" id="hidden_field_data_nama_dokter" style="<?php echo $sStyleHidden_nama_dokter; ?>"> <span class="scFormLabelOddFormat css_nama_dokter_label"><span id="id_label_nama_dokter"><?php echo $this->nm_new_label['nama_dokter']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_kode_tarif_line" id="hidden_field_data_kode_tarif" style="<?php echo $sStyleHidden_kode_tarif; ?>"> <span class="scFormLabelOddFormat css_kode_tarif_label"><span id="id_label_kode_tarif"><?php echo $this->nm_new_label['kode_tarif']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_payor_id_line" id="hidden_field_data_payor_id" style="<?php echo $sStyleHidden_payor_id; ?>"> <span class="scFormLabelOddFormat css_payor_id_label"><span id="id_label_payor_id"><?php echo $this->nm_new_label['payor_id']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_payor_cd_line" id="hidden_field_data_payor_cd" style="<?php echo $sStyleHidden_payor_cd; ?>"> <span class="scFormLabelOddFormat css_payor_cd_label"><span id="id_label_payor_cd"><?php echo $this->nm_new_label['payor_cd']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_cob_cd_line" id="hidden_field_data_cob_cd" style="<?php echo $sStyleHidden_cob_cd; ?>"> <span class="scFormLabelOddFormat css_cob_cd_label"><span id="id_label_cob_cd"><?php echo $this->nm_new_label['cob_cd']; ?></span></span><br>
...
<?php
           if (($nm_apl_dependente != 1) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_eclaim_klaim_update_data_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_eclaim_klaim_update_data_mob']['dashboard_info']['under_dashboard'])) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_eclaim_klaim_update_data_mob']['nm_run_menu']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_eclaim_klaim_update_data_mob']['nm_run_menu'] != 1))) {
...
<?php
           if (($nm_apl_dependente == 1) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_eclaim_klaim_update_data_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_eclaim_klaim_update_data_mob']['dashboard_info']['under_dashboard']))) {
        $sCondStyle = ($this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_eclaim_klaim_update_data_mob']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_eclaim_klaim_update_data_mob']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_eclaim_klaim_update_data_mob");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_eclaim_klaim_update_data_mob");
 parent.scAjaxDetailHeight("form_eclaim_klaim_update_data_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_eclaim_klaim_update_data_mob']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
