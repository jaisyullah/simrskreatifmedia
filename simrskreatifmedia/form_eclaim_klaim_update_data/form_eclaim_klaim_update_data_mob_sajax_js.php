  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_eclaim_klaim_update_data_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_eclaim_klaim_update_data_mob_form();
	}

  // ---------- Validate nomor_sep
  function do_ajax_form_eclaim_klaim_update_data_mob_validate_nomor_sep()
  {
    var nomeCampo_nomor_sep = "nomor_sep";
    var var_nomor_sep = scAjaxGetFieldText(nomeCampo_nomor_sep);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_eclaim_klaim_update_data_mob_validate_nomor_sep(var_nomor_sep, var_script_case_init, do_ajax_form_eclaim_klaim_update_data_mob_validate_nomor_sep_cb);
  } // do_ajax_form_eclaim_klaim_update_data_mob_validate_nomor_sep

  function do_ajax_form_eclaim_klaim_update_data_mob_validate_nomor_sep_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_eclaim_klaim_update_data_mob_validate_nomor_sep_cb

  // ---------- Validate nomor_kartu
  function do_ajax_form_eclaim_klaim_update_data_mob_validate_nomor_kartu()
  {
    var nomeCampo_nomor_kartu = "nomor_kartu";
    var var_nomor_kartu = scAjaxGetFieldText(nomeCampo_nomor_kartu);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_eclaim_klaim_update_data_mob_validate_nomor_kartu(var_nomor_kartu, var_script_case_init, do_ajax_form_eclaim_klaim_update_data_mob_validate_nomor_kartu_cb);
  } // do_ajax_form_eclaim_klaim_update_data_mob_validate_nomor_kartu

  function do_ajax_form_eclaim_klaim_update_data_mob_validate_nomor_kartu_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_eclaim_klaim_update_data_mob_validate_nomor_kartu_cb

  // ---------- Validate tgl_masuk
  function do_ajax_form_eclaim_klaim_update_data_mob_validate_tgl_masuk()
  {
    var nomeCampo_tgl_masuk = "tgl_masuk";
    var var_tgl_masuk = scAjaxGetFieldText(nomeCampo_tgl_masuk);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_eclaim_klaim_update_data_mob_validate_tgl_masuk(var_tgl_masuk, var_script_case_init, do_ajax_form_eclaim_klaim_update_data_mob_validate_tgl_masuk_cb);
  } // do_ajax_form_eclaim_klaim_update_data_mob_validate_tgl_masuk

  function do_ajax_form_eclaim_klaim_update_data_mob_validate_tgl_masuk_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_eclaim_klaim_update_data_mob_validate_tgl_masuk_cb

  // ---------- Validate tgl_pulang
  function do_ajax_form_eclaim_klaim_update_data_mob_validate_tgl_pulang()
  {
    var nomeCampo_tgl_pulang = "tgl_pulang";
    var var_tgl_pulang = scAjaxGetFieldText(nomeCampo_tgl_pulang);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_eclaim_klaim_update_data_mob_validate_tgl_pulang(var_tgl_pulang, var_script_case_init, do_ajax_form_eclaim_klaim_update_data_mob_validate_tgl_pulang_cb);
  } // do_ajax_form_eclaim_klaim_update_data_mob_validate_tgl_pulang

  function do_ajax_form_eclaim_klaim_update_data_mob_validate_tgl_pulang_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_eclaim_klaim_update_data_mob_validate_tgl_pulang_cb

  // ---------- Validate jenis_rawat
  function do_ajax_form_eclaim_klaim_update_data_mob_validate_jenis_rawat()
  {
    var nomeCampo_jenis_rawat = "jenis_rawat";
    var var_jenis_rawat = scAjaxGetFieldText(nomeCampo_jenis_rawat);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_eclaim_klaim_update_data_mob_validate_jenis_rawat(var_jenis_rawat, var_script_case_init, do_ajax_form_eclaim_klaim_update_data_mob_validate_jenis_rawat_cb);
  } // do_ajax_form_eclaim_klaim_update_data_mob_validate_jenis_rawat

  function do_ajax_form_eclaim_klaim_update_data_mob_validate_jenis_rawat_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_eclaim_klaim_update_data_mob_validate_jenis_rawat_cb

  // ---------- Validate kelas_rawat
  function do_ajax_form_eclaim_klaim_update_data_mob_validate_kelas_rawat()
  {
    var nomeCampo_kelas_rawat = "kelas_rawat";
    var var_kelas_rawat = scAjaxGetFieldText(nomeCampo_kelas_rawat);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_eclaim_klaim_update_data_mob_validate_kelas_rawat(var_kelas_rawat, var_script_case_init, do_ajax_form_eclaim_klaim_update_data_mob_validate_kelas_rawat_cb);
  } // do_ajax_form_eclaim_klaim_update_data_mob_validate_kelas_rawat

  function do_ajax_form_eclaim_klaim_update_data_mob_validate_kelas_rawat_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_eclaim_klaim_update_data_mob_validate_kelas_rawat_cb

  // ---------- Validate adl_sub_acute
  function do_ajax_form_eclaim_klaim_update_data_mob_validate_adl_sub_acute()
  {
    var nomeCampo_adl_sub_acute = "adl_sub_acute";
    var var_adl_sub_acute = scAjaxGetFieldText(nomeCampo_adl_sub_acute);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_eclaim_klaim_update_data_mob_validate_adl_sub_acute(var_adl_sub_acute, var_script_case_init, do_ajax_form_eclaim_klaim_update_data_mob_validate_adl_sub_acute_cb);
  } // do_ajax_form_eclaim_klaim_update_data_mob_validate_adl_sub_acute

  function do_ajax_form_eclaim_klaim_update_data_mob_validate_adl_sub_acute_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_eclaim_klaim_update_data_mob_validate_adl_sub_acute_cb

  // ---------- Validate adl_chronic
  function do_ajax_form_eclaim_klaim_update_data_mob_validate_adl_chronic()
  {
    var nomeCampo_adl_chronic = "adl_chronic";
    var var_adl_chronic = scAjaxGetFieldText(nomeCampo_adl_chronic);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_eclaim_klaim_update_data_mob_validate_adl_chronic(var_adl_chronic, var_script_case_init, do_ajax_form_eclaim_klaim_update_data_mob_validate_adl_chronic_cb);
  } // do_ajax_form_eclaim_klaim_update_data_mob_validate_adl_chronic

  function do_ajax_form_eclaim_klaim_update_data_mob_validate_adl_chronic_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_eclaim_klaim_update_data_mob_validate_adl_chronic_cb

  // ---------- Validate icu_indikator
  function do_ajax_form_eclaim_klaim_update_data_mob_validate_icu_indikator()
  {
    var nomeCampo_icu_indikator = "icu_indikator";
    var var_icu_indikator = scAjaxGetFieldText(nomeCampo_icu_indikator);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_eclaim_klaim_update_data_mob_validate_icu_indikator(var_icu_indikator, var_script_case_init, do_ajax_form_eclaim_klaim_update_data_mob_validate_icu_indikator_cb);
  } // do_ajax_form_eclaim_klaim_update_data_mob_validate_icu_indikator

  function do_ajax_form_eclaim_klaim_update_data_mob_validate_icu_indikator_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_eclaim_klaim_update_data_mob_validate_icu_indikator_cb

  // ---------- Validate icu_los
  function do_ajax_form_eclaim_klaim_update_data_mob_validate_icu_los()
  {
    var nomeCampo_icu_los = "icu_los";
    var var_icu_los = scAjaxGetFieldText(nomeCampo_icu_los);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_eclaim_klaim_update_data_mob_validate_icu_los(var_icu_los, var_script_case_init, do_ajax_form_eclaim_klaim_update_data_mob_validate_icu_los_cb);
  } // do_ajax_form_eclaim_klaim_update_data_mob_validate_icu_los

  function do_ajax_form_eclaim_klaim_update_data_mob_validate_icu_los_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "icu_los";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_eclaim_klaim_update_data_mob_validate_icu_los_cb

  // ---------- Validate ventilator_hour
  function do_ajax_form_eclaim_klaim_update_data_mob_validate_ventilator_hour()
  {
    var nomeCampo_ventilator_hour = "ventilator_hour";
    var var_ventilator_hour = scAjaxGetFieldText(nomeCampo_ventilator_hour);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_eclaim_klaim_update_data_mob_validate_ventilator_hour(var_ventilator_hour, var_script_case_init, do_ajax_form_eclaim_klaim_update_data_mob_validate_ventilator_hour_cb);
  } // do_ajax_form_eclaim_klaim_update_data_mob_validate_ventilator_hour

  function do_ajax_form_eclaim_klaim_update_data_mob_validate_ventilator_hour_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_eclaim_klaim_update_data_mob_validate_ventilator_hour_cb

  // ---------- Validate upgrade_class_ind
  function do_ajax_form_eclaim_klaim_update_data_mob_validate_upgrade_class_ind()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_eclaim_klaim_update_data_mob_validate_upgrade_class_ind(var_upgrade_class_ind, var_script_case_init, do_ajax_form_eclaim_klaim_update_data_mob_validate_upgrade_class_ind_cb);
  } // do_ajax_form_eclaim_klaim_update_data_mob_validate_upgrade_class_ind

  function do_ajax_form_eclaim_klaim_update_data_mob_validate_upgrade_class_ind_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_eclaim_klaim_update_data_mob_validate_upgrade_class_ind_cb

  // ---------- Validate upgrade_class_class
  function do_ajax_form_eclaim_klaim_update_data_mob_validate_upgrade_class_class()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_eclaim_klaim_update_data_mob_validate_upgrade_class_class(var_upgrade_class_class, var_script_case_init, do_ajax_form_eclaim_klaim_update_data_mob_validate_upgrade_class_class_cb);
  } // do_ajax_form_eclaim_klaim_update_data_mob_validate_upgrade_class_class

  function do_ajax_form_eclaim_klaim_update_data_mob_validate_upgrade_class_class_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_eclaim_klaim_update_data_mob_validate_upgrade_class_class_cb

  // ---------- Validate upgrade_class_los
  function do_ajax_form_eclaim_klaim_update_data_mob_validate_upgrade_class_los()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_eclaim_klaim_update_data_mob_validate_upgrade_class_los(var_upgrade_class_los, var_script_case_init, do_ajax_form_eclaim_klaim_update_data_mob_validate_upgrade_class_los_cb);
  } // do_ajax_form_eclaim_klaim_update_data_mob_validate_upgrade_class_los

  function do_ajax_form_eclaim_klaim_update_data_mob_validate_upgrade_class_los_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_eclaim_klaim_update_data_mob_validate_upgrade_class_los_cb

  // ---------- Validate add_payment_pct
  function do_ajax_form_eclaim_klaim_update_data_mob_validate_add_payment_pct()
  {
    var nomeCampo_add_payment_pct = "add_payment_pct";
    var var_add_payment_pct = scAjaxGetFieldText(nomeCampo_add_payment_pct);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_eclaim_klaim_update_data_mob_validate_add_payment_pct(var_add_payment_pct, var_script_case_init, do_ajax_form_eclaim_klaim_update_data_mob_validate_add_payment_pct_cb);
  } // do_ajax_form_eclaim_klaim_update_data_mob_validate_add_payment_pct

  function do_ajax_form_eclaim_klaim_update_data_mob_validate_add_payment_pct_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_eclaim_klaim_update_data_mob_validate_add_payment_pct_cb

  // ---------- Validate birth_weight
  function do_ajax_form_eclaim_klaim_update_data_mob_validate_birth_weight()
  {
    var nomeCampo_birth_weight = "birth_weight";
    var var_birth_weight = scAjaxGetFieldText(nomeCampo_birth_weight);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_eclaim_klaim_update_data_mob_validate_birth_weight(var_birth_weight, var_script_case_init, do_ajax_form_eclaim_klaim_update_data_mob_validate_birth_weight_cb);
  } // do_ajax_form_eclaim_klaim_update_data_mob_validate_birth_weight

  function do_ajax_form_eclaim_klaim_update_data_mob_validate_birth_weight_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_eclaim_klaim_update_data_mob_validate_birth_weight_cb

  // ---------- Validate discharge_status
  function do_ajax_form_eclaim_klaim_update_data_mob_validate_discharge_status()
  {
    var nomeCampo_discharge_status = "discharge_status";
    var var_discharge_status = scAjaxGetFieldText(nomeCampo_discharge_status);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_eclaim_klaim_update_data_mob_validate_discharge_status(var_discharge_status, var_script_case_init, do_ajax_form_eclaim_klaim_update_data_mob_validate_discharge_status_cb);
  } // do_ajax_form_eclaim_klaim_update_data_mob_validate_discharge_status

  function do_ajax_form_eclaim_klaim_update_data_mob_validate_discharge_status_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_eclaim_klaim_update_data_mob_validate_discharge_status_cb

  // ---------- Validate diagnosa
  function do_ajax_form_eclaim_klaim_update_data_mob_validate_diagnosa()
  {
    var nomeCampo_diagnosa = "diagnosa";
    var var_diagnosa = scAjaxGetFieldText(nomeCampo_diagnosa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_eclaim_klaim_update_data_mob_validate_diagnosa(var_diagnosa, var_script_case_init, do_ajax_form_eclaim_klaim_update_data_mob_validate_diagnosa_cb);
  } // do_ajax_form_eclaim_klaim_update_data_mob_validate_diagnosa

  function do_ajax_form_eclaim_klaim_update_data_mob_validate_diagnosa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_eclaim_klaim_update_data_mob_validate_diagnosa_cb

  // ---------- Validate procedure
  function do_ajax_form_eclaim_klaim_update_data_mob_validate_procedure()
  {
    var nomeCampo_procedure = "procedure";
    var var_procedure = scAjaxGetFieldText(nomeCampo_procedure);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_eclaim_klaim_update_data_mob_validate_procedure(var_procedure, var_script_case_init, do_ajax_form_eclaim_klaim_update_data_mob_validate_procedure_cb);
  } // do_ajax_form_eclaim_klaim_update_data_mob_validate_procedure

  function do_ajax_form_eclaim_klaim_update_data_mob_validate_procedure_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_eclaim_klaim_update_data_mob_validate_procedure_cb

  // ---------- Validate tarif_rs_prosedur_non_bedah
  function do_ajax_form_eclaim_klaim_update_data_mob_validate_tarif_rs_prosedur_non_bedah()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_eclaim_klaim_update_data_mob_validate_tarif_rs_prosedur_non_bedah(var_tarif_rs_prosedur_non_bedah, var_script_case_init, do_ajax_form_eclaim_klaim_update_data_mob_validate_tarif_rs_prosedur_non_bedah_cb);
  } // do_ajax_form_eclaim_klaim_update_data_mob_validate_tarif_rs_prosedur_non_bedah

  function do_ajax_form_eclaim_klaim_update_data_mob_validate_tarif_rs_prosedur_non_bedah_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_eclaim_klaim_update_data_mob_validate_tarif_rs_prosedur_non_bedah_cb

  // ---------- Validate tarif_rs_prosedur_bedah
  function do_ajax_form_eclaim_klaim_update_data_mob_validate_tarif_rs_prosedur_bedah()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_eclaim_klaim_update_data_mob_validate_tarif_rs_prosedur_bedah(var_tarif_rs_prosedur_bedah, var_script_case_init, do_ajax_form_eclaim_klaim_update_data_mob_validate_tarif_rs_prosedur_bedah_cb);
  } // do_ajax_form_eclaim_klaim_update_data_mob_validate_tarif_rs_prosedur_bedah

  function do_ajax_form_eclaim_klaim_update_data_mob_validate_tarif_rs_prosedur_bedah_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_eclaim_klaim_update_data_mob_validate_tarif_rs_prosedur_bedah_cb

  // ---------- Validate tarif_rs_konsultasi
  function do_ajax_form_eclaim_klaim_update_data_mob_validate_tarif_rs_konsultasi()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_eclaim_klaim_update_data_mob_validate_tarif_rs_konsultasi(var_tarif_rs_konsultasi, var_script_case_init, do_ajax_form_eclaim_klaim_update_data_mob_validate_tarif_rs_konsultasi_cb);
  } // do_ajax_form_eclaim_klaim_update_data_mob_validate_tarif_rs_konsultasi

  function do_ajax_form_eclaim_klaim_update_data_mob_validate_tarif_rs_konsultasi_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_eclaim_klaim_update_data_mob_validate_tarif_rs_konsultasi_cb

  // ---------- Validate tarif_rs_tenaga_ahli
  function do_ajax_form_eclaim_klaim_update_data_mob_validate_tarif_rs_tenaga_ahli()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_eclaim_klaim_update_data_mob_validate_tarif_rs_tenaga_ahli(var_tarif_rs_tenaga_ahli, var_script_case_init, do_ajax_form_eclaim_klaim_update_data_mob_validate_tarif_rs_tenaga_ahli_cb);
  } // do_ajax_form_eclaim_klaim_update_data_mob_validate_tarif_rs_tenaga_ahli

  function do_ajax_form_eclaim_klaim_update_data_mob_validate_tarif_rs_tenaga_ahli_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_eclaim_klaim_update_data_mob_validate_tarif_rs_tenaga_ahli_cb

  // ---------- Validate tarif_rs_keperawatan
  function do_ajax_form_eclaim_klaim_update_data_mob_validate_tarif_rs_keperawatan()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_eclaim_klaim_update_data_mob_validate_tarif_rs_keperawatan(var_tarif_rs_keperawatan, var_script_case_init, do_ajax_form_eclaim_klaim_update_data_mob_validate_tarif_rs_keperawatan_cb);
  } // do_ajax_form_eclaim_klaim_update_data_mob_validate_tarif_rs_keperawatan

  function do_ajax_form_eclaim_klaim_update_data_mob_validate_tarif_rs_keperawatan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_eclaim_klaim_update_data_mob_validate_tarif_rs_keperawatan_cb

  // ---------- Validate tarif_rs_penunjang
  function do_ajax_form_eclaim_klaim_update_data_mob_validate_tarif_rs_penunjang()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_eclaim_klaim_update_data_mob_validate_tarif_rs_penunjang(var_tarif_rs_penunjang, var_script_case_init, do_ajax_form_eclaim_klaim_update_data_mob_validate_tarif_rs_penunjang_cb);
  } // do_ajax_form_eclaim_klaim_update_data_mob_validate_tarif_rs_penunjang

  function do_ajax_form_eclaim_klaim_update_data_mob_validate_tarif_rs_penunjang_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_eclaim_klaim_update_data_mob_validate_tarif_rs_penunjang_cb

  // ---------- Validate tarif_rs_radiologi
  function do_ajax_form_eclaim_klaim_update_data_mob_validate_tarif_rs_radiologi()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_eclaim_klaim_update_data_mob_validate_tarif_rs_radiologi(var_tarif_rs_radiologi, var_script_case_init, do_ajax_form_eclaim_klaim_update_data_mob_validate_tarif_rs_radiologi_cb);
  } // do_ajax_form_eclaim_klaim_update_data_mob_validate_tarif_rs_radiologi

  function do_ajax_form_eclaim_klaim_update_data_mob_validate_tarif_rs_radiologi_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_eclaim_klaim_update_data_mob_validate_tarif_rs_radiologi_cb

  // ---------- Validate tarif_rs_laboratorium
  function do_ajax_form_eclaim_klaim_update_data_mob_validate_tarif_rs_laboratorium()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_eclaim_klaim_update_data_mob_validate_tarif_rs_laboratorium(var_tarif_rs_laboratorium, var_script_case_init, do_ajax_form_eclaim_klaim_update_data_mob_validate_tarif_rs_laboratorium_cb);
  } // do_ajax_form_eclaim_klaim_update_data_mob_validate_tarif_rs_laboratorium

  function do_ajax_form_eclaim_klaim_update_data_mob_validate_tarif_rs_laboratorium_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_eclaim_klaim_update_data_mob_validate_tarif_rs_laboratorium_cb

  // ---------- Validate tarif_rs_pelayanan_darah
  function do_ajax_form_eclaim_klaim_update_data_mob_validate_tarif_rs_pelayanan_darah()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_eclaim_klaim_update_data_mob_validate_tarif_rs_pelayanan_darah(var_tarif_rs_pelayanan_darah, var_script_case_init, do_ajax_form_eclaim_klaim_update_data_mob_validate_tarif_rs_pelayanan_darah_cb);
  } // do_ajax_form_eclaim_klaim_update_data_mob_validate_tarif_rs_pelayanan_darah

  function do_ajax_form_eclaim_klaim_update_data_mob_validate_tarif_rs_pelayanan_darah_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_eclaim_klaim_update_data_mob_validate_tarif_rs_pelayanan_darah_cb

  // ---------- Validate tarif_rs_rehabilitasi
  function do_ajax_form_eclaim_klaim_update_data_mob_validate_tarif_rs_rehabilitasi()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_eclaim_klaim_update_data_mob_validate_tarif_rs_rehabilitasi(var_tarif_rs_rehabilitasi, var_script_case_init, do_ajax_form_eclaim_klaim_update_data_mob_validate_tarif_rs_rehabilitasi_cb);
  } // do_ajax_form_eclaim_klaim_update_data_mob_validate_tarif_rs_rehabilitasi

  function do_ajax_form_eclaim_klaim_update_data_mob_validate_tarif_rs_rehabilitasi_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_eclaim_klaim_update_data_mob_validate_tarif_rs_rehabilitasi_cb

  // ---------- Validate tarif_rs_kamar
  function do_ajax_form_eclaim_klaim_update_data_mob_validate_tarif_rs_kamar()
  {
    var nomeCampo_tarif_rs_kamar = "tarif_rs_kamar";
    var var_tarif_rs_kamar = scAjaxGetFieldText(nomeCampo_tarif_rs_kamar);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_eclaim_klaim_update_data_mob_validate_tarif_rs_kamar(var_tarif_rs_kamar, var_script_case_init, do_ajax_form_eclaim_klaim_update_data_mob_validate_tarif_rs_kamar_cb);
  } // do_ajax_form_eclaim_klaim_update_data_mob_validate_tarif_rs_kamar

  function do_ajax_form_eclaim_klaim_update_data_mob_validate_tarif_rs_kamar_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_eclaim_klaim_update_data_mob_validate_tarif_rs_kamar_cb

  // ---------- Validate tarif_rs_rawat_intensif
  function do_ajax_form_eclaim_klaim_update_data_mob_validate_tarif_rs_rawat_intensif()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_eclaim_klaim_update_data_mob_validate_tarif_rs_rawat_intensif(var_tarif_rs_rawat_intensif, var_script_case_init, do_ajax_form_eclaim_klaim_update_data_mob_validate_tarif_rs_rawat_intensif_cb);
  } // do_ajax_form_eclaim_klaim_update_data_mob_validate_tarif_rs_rawat_intensif

  function do_ajax_form_eclaim_klaim_update_data_mob_validate_tarif_rs_rawat_intensif_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_eclaim_klaim_update_data_mob_validate_tarif_rs_rawat_intensif_cb

  // ---------- Validate tarif_rs_obat
  function do_ajax_form_eclaim_klaim_update_data_mob_validate_tarif_rs_obat()
  {
    var nomeCampo_tarif_rs_obat = "tarif_rs_obat";
    var var_tarif_rs_obat = scAjaxGetFieldText(nomeCampo_tarif_rs_obat);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_eclaim_klaim_update_data_mob_validate_tarif_rs_obat(var_tarif_rs_obat, var_script_case_init, do_ajax_form_eclaim_klaim_update_data_mob_validate_tarif_rs_obat_cb);
  } // do_ajax_form_eclaim_klaim_update_data_mob_validate_tarif_rs_obat

  function do_ajax_form_eclaim_klaim_update_data_mob_validate_tarif_rs_obat_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_eclaim_klaim_update_data_mob_validate_tarif_rs_obat_cb

  // ---------- Validate tarif_rs_alkes
  function do_ajax_form_eclaim_klaim_update_data_mob_validate_tarif_rs_alkes()
  {
    var nomeCampo_tarif_rs_alkes = "tarif_rs_alkes";
    var var_tarif_rs_alkes = scAjaxGetFieldText(nomeCampo_tarif_rs_alkes);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_eclaim_klaim_update_data_mob_validate_tarif_rs_alkes(var_tarif_rs_alkes, var_script_case_init, do_ajax_form_eclaim_klaim_update_data_mob_validate_tarif_rs_alkes_cb);
  } // do_ajax_form_eclaim_klaim_update_data_mob_validate_tarif_rs_alkes

  function do_ajax_form_eclaim_klaim_update_data_mob_validate_tarif_rs_alkes_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_eclaim_klaim_update_data_mob_validate_tarif_rs_alkes_cb

  // ---------- Validate tarif_rs_bmhp
  function do_ajax_form_eclaim_klaim_update_data_mob_validate_tarif_rs_bmhp()
  {
    var nomeCampo_tarif_rs_bmhp = "tarif_rs_bmhp";
    var var_tarif_rs_bmhp = scAjaxGetFieldText(nomeCampo_tarif_rs_bmhp);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_eclaim_klaim_update_data_mob_validate_tarif_rs_bmhp(var_tarif_rs_bmhp, var_script_case_init, do_ajax_form_eclaim_klaim_update_data_mob_validate_tarif_rs_bmhp_cb);
  } // do_ajax_form_eclaim_klaim_update_data_mob_validate_tarif_rs_bmhp

  function do_ajax_form_eclaim_klaim_update_data_mob_validate_tarif_rs_bmhp_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_eclaim_klaim_update_data_mob_validate_tarif_rs_bmhp_cb

  // ---------- Validate tarif_rs_sewa_alat
  function do_ajax_form_eclaim_klaim_update_data_mob_validate_tarif_rs_sewa_alat()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_eclaim_klaim_update_data_mob_validate_tarif_rs_sewa_alat(var_tarif_rs_sewa_alat, var_script_case_init, do_ajax_form_eclaim_klaim_update_data_mob_validate_tarif_rs_sewa_alat_cb);
  } // do_ajax_form_eclaim_klaim_update_data_mob_validate_tarif_rs_sewa_alat

  function do_ajax_form_eclaim_klaim_update_data_mob_validate_tarif_rs_sewa_alat_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_eclaim_klaim_update_data_mob_validate_tarif_rs_sewa_alat_cb

  // ---------- Validate tarif_poli_eks
  function do_ajax_form_eclaim_klaim_update_data_mob_validate_tarif_poli_eks()
  {
    var nomeCampo_tarif_poli_eks = "tarif_poli_eks";
    var var_tarif_poli_eks = scAjaxGetFieldText(nomeCampo_tarif_poli_eks);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_eclaim_klaim_update_data_mob_validate_tarif_poli_eks(var_tarif_poli_eks, var_script_case_init, do_ajax_form_eclaim_klaim_update_data_mob_validate_tarif_poli_eks_cb);
  } // do_ajax_form_eclaim_klaim_update_data_mob_validate_tarif_poli_eks

  function do_ajax_form_eclaim_klaim_update_data_mob_validate_tarif_poli_eks_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_eclaim_klaim_update_data_mob_validate_tarif_poli_eks_cb

  // ---------- Validate nama_dokter
  function do_ajax_form_eclaim_klaim_update_data_mob_validate_nama_dokter()
  {
    var nomeCampo_nama_dokter = "nama_dokter";
    var var_nama_dokter = scAjaxGetFieldText(nomeCampo_nama_dokter);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_eclaim_klaim_update_data_mob_validate_nama_dokter(var_nama_dokter, var_script_case_init, do_ajax_form_eclaim_klaim_update_data_mob_validate_nama_dokter_cb);
  } // do_ajax_form_eclaim_klaim_update_data_mob_validate_nama_dokter

  function do_ajax_form_eclaim_klaim_update_data_mob_validate_nama_dokter_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_eclaim_klaim_update_data_mob_validate_nama_dokter_cb

  // ---------- Validate kode_tarif
  function do_ajax_form_eclaim_klaim_update_data_mob_validate_kode_tarif()
  {
    var nomeCampo_kode_tarif = "kode_tarif";
    var var_kode_tarif = scAjaxGetFieldText(nomeCampo_kode_tarif);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_eclaim_klaim_update_data_mob_validate_kode_tarif(var_kode_tarif, var_script_case_init, do_ajax_form_eclaim_klaim_update_data_mob_validate_kode_tarif_cb);
  } // do_ajax_form_eclaim_klaim_update_data_mob_validate_kode_tarif

  function do_ajax_form_eclaim_klaim_update_data_mob_validate_kode_tarif_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_eclaim_klaim_update_data_mob_validate_kode_tarif_cb

  // ---------- Validate payor_id
  function do_ajax_form_eclaim_klaim_update_data_mob_validate_payor_id()
  {
    var nomeCampo_payor_id = "payor_id";
    var var_payor_id = scAjaxGetFieldText(nomeCampo_payor_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_eclaim_klaim_update_data_mob_validate_payor_id(var_payor_id, var_script_case_init, do_ajax_form_eclaim_klaim_update_data_mob_validate_payor_id_cb);
  } // do_ajax_form_eclaim_klaim_update_data_mob_validate_payor_id

  function do_ajax_form_eclaim_klaim_update_data_mob_validate_payor_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_eclaim_klaim_update_data_mob_validate_payor_id_cb

  // ---------- Validate payor_cd
  function do_ajax_form_eclaim_klaim_update_data_mob_validate_payor_cd()
  {
    var nomeCampo_payor_cd = "payor_cd";
    var var_payor_cd = scAjaxGetFieldText(nomeCampo_payor_cd);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_eclaim_klaim_update_data_mob_validate_payor_cd(var_payor_cd, var_script_case_init, do_ajax_form_eclaim_klaim_update_data_mob_validate_payor_cd_cb);
  } // do_ajax_form_eclaim_klaim_update_data_mob_validate_payor_cd

  function do_ajax_form_eclaim_klaim_update_data_mob_validate_payor_cd_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_eclaim_klaim_update_data_mob_validate_payor_cd_cb

  // ---------- Validate cob_cd
  function do_ajax_form_eclaim_klaim_update_data_mob_validate_cob_cd()
  {
    var nomeCampo_cob_cd = "cob_cd";
    var var_cob_cd = scAjaxGetFieldText(nomeCampo_cob_cd);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_eclaim_klaim_update_data_mob_validate_cob_cd(var_cob_cd, var_script_case_init, do_ajax_form_eclaim_klaim_update_data_mob_validate_cob_cd_cb);
  } // do_ajax_form_eclaim_klaim_update_data_mob_validate_cob_cd

  function do_ajax_form_eclaim_klaim_update_data_mob_validate_cob_cd_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cob_cd";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_eclaim_klaim_update_data_mob_validate_cob_cd_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_eclaim_klaim_update_data_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_eclaim_klaim_update_data_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_eclaim_klaim_update_data_mob_submit_form_cb_after_alert);
  } // do_ajax_form_eclaim_klaim_update_data_mob_submit_form_cb
  function do_ajax_form_eclaim_klaim_update_data_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_eclaim_klaim_update_data_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_eclaim_klaim_update_data_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_form_eclaim_klaim_update_data_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_eclaim_klaim_update_data_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_eclaim_klaim_update_data_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_eclaim_klaim_update_data_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_eclaim_klaim_update_data_mob_navigate_form_cb
  function do_ajax_form_eclaim_klaim_update_data_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_eclaim_klaim_update_data_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_eclaim_klaim_update_data_mob_navigate_form_cb_after_alert
  function sc_hide_form_eclaim_klaim_update_data_mob_form()
  {
