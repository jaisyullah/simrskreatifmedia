...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_tgl_masuk_hora' + iSeqRow).bind('blur', function() { sc_form_eclaim_klaim_update_data_tgl_masuk_onblur(this, iSeqRow) })
                                            .bind('focus', function() { sc_form_eclaim_klaim_update_data_tgl_masuk_onfocus(this, iSeqRow) });
  ...
  $('#id_sc_field_tgl_pulang_hora' + iSeqRow).bind('blur', function() { sc_form_eclaim_klaim_update_data_tgl_pulang_onblur(this, iSeqRow) })
                                             .bind('focus', function() { sc_form_eclaim_klaim_update_data_tgl_pulang_onfocus(this, iSeqRow) });
...
function scHidePage(pageNo) {
	$("#id_form_eclaim_klaim_update_data_mob_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_tgl_masuk" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_eclaim_klaim_update_data_mob_validate_tgl_masuk(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_tgl_pulang" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_eclaim_klaim_update_data_mob_validate_tgl_pulang(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
