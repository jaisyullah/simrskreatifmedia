  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbtemplatesoap_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbtemplatesoap_mob_form();
	}

  // ---------- Validate id
  function do_ajax_form_tbtemplatesoap_mob_validate_id()
  {
    var nomeCampo_id = "id";
    var var_id = scAjaxGetFieldHidden(nomeCampo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtemplatesoap_mob_validate_id(var_id, var_script_case_init, do_ajax_form_tbtemplatesoap_mob_validate_id_cb);
  } // do_ajax_form_tbtemplatesoap_mob_validate_id

  function do_ajax_form_tbtemplatesoap_mob_validate_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtemplatesoap_mob_validate_id_cb

  // ---------- Validate namasoap
  function do_ajax_form_tbtemplatesoap_mob_validate_namasoap()
  {
    var nomeCampo_namasoap = "namasoap";
    var var_namasoap = scAjaxGetFieldText(nomeCampo_namasoap);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtemplatesoap_mob_validate_namasoap(var_namasoap, var_script_case_init, do_ajax_form_tbtemplatesoap_mob_validate_namasoap_cb);
  } // do_ajax_form_tbtemplatesoap_mob_validate_namasoap

  function do_ajax_form_tbtemplatesoap_mob_validate_namasoap_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "namasoap";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtemplatesoap_mob_validate_namasoap_cb

  // ---------- Validate subject
  function do_ajax_form_tbtemplatesoap_mob_validate_subject()
  {
    var nomeCampo_subject = "subject";
    var var_subject = scAjaxGetFieldText(nomeCampo_subject);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtemplatesoap_mob_validate_subject(var_subject, var_script_case_init, do_ajax_form_tbtemplatesoap_mob_validate_subject_cb);
  } // do_ajax_form_tbtemplatesoap_mob_validate_subject

  function do_ajax_form_tbtemplatesoap_mob_validate_subject_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "subject";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtemplatesoap_mob_validate_subject_cb

  // ---------- Validate object
  function do_ajax_form_tbtemplatesoap_mob_validate_object()
  {
    var nomeCampo_object = "object";
    var var_object = scAjaxGetFieldText(nomeCampo_object);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtemplatesoap_mob_validate_object(var_object, var_script_case_init, do_ajax_form_tbtemplatesoap_mob_validate_object_cb);
  } // do_ajax_form_tbtemplatesoap_mob_validate_object

  function do_ajax_form_tbtemplatesoap_mob_validate_object_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "object";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtemplatesoap_mob_validate_object_cb

  // ---------- Validate assessment
  function do_ajax_form_tbtemplatesoap_mob_validate_assessment()
  {
    var nomeCampo_assessment = "assessment";
    var var_assessment = scAjaxGetFieldText(nomeCampo_assessment);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtemplatesoap_mob_validate_assessment(var_assessment, var_script_case_init, do_ajax_form_tbtemplatesoap_mob_validate_assessment_cb);
  } // do_ajax_form_tbtemplatesoap_mob_validate_assessment

  function do_ajax_form_tbtemplatesoap_mob_validate_assessment_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "assessment";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtemplatesoap_mob_validate_assessment_cb

  // ---------- Validate plan
  function do_ajax_form_tbtemplatesoap_mob_validate_plan()
  {
    var nomeCampo_plan = "plan";
    var var_plan = scAjaxGetFieldText(nomeCampo_plan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtemplatesoap_mob_validate_plan(var_plan, var_script_case_init, do_ajax_form_tbtemplatesoap_mob_validate_plan_cb);
  } // do_ajax_form_tbtemplatesoap_mob_validate_plan

  function do_ajax_form_tbtemplatesoap_mob_validate_plan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "plan";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtemplatesoap_mob_validate_plan_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tbtemplatesoap_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tbtemplatesoap_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id = scAjaxGetFieldHidden("id");
    var var_namasoap = scAjaxGetFieldText("namasoap");
    var var_subject = scAjaxGetFieldText("subject");
    var var_object = scAjaxGetFieldText("object");
    var var_assessment = scAjaxGetFieldText("assessment");
    var var_plan = scAjaxGetFieldText("plan");
    ...
    scAjaxProcOn();
    x_ajax_form_tbtemplatesoap_mob_submit_form(var_id, var_namasoap, var_subject, var_object, var_assessment, var_plan, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbtemplatesoap_mob_submit_form_cb);
  } // do_ajax_form_tbtemplatesoap_mob_submit_form

  function do_ajax_form_tbtemplatesoap_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("namasoap");
      scAjaxHideErrorDisplay("subject");
      scAjaxHideErrorDisplay("object");
      scAjaxHideErrorDisplay("assessment");
      scAjaxHideErrorDisplay("plan");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tbtemplatesoap_mob_submit_form_cb_after_alert);
  } // do_ajax_form_tbtemplatesoap_mob_submit_form_cb
  function do_ajax_form_tbtemplatesoap_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbtemplatesoap_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tbtemplatesoap_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_tbtemplatesoap_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbtemplatesoap_mob_navigate_form_cb);
  } // do_ajax_form_tbtemplatesoap_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtemplatesoap_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbtemplatesoap_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbtemplatesoap_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_tbtemplatesoap_mob_navigate_form_cb
  function do_ajax_form_tbtemplatesoap_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_tbtemplatesoap_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_tbtemplatesoap_mob_navigate_form_cb_after_alert
  function sc_hide_form_tbtemplatesoap_mob_form()
  {
  ...
  ajax_field_list[1] = "namasoap";
  ajax_field_list[2] = "subject";
  ajax_field_list[3] = "object";
  ajax_field_list[4] = "assessment";
  ajax_field_list[5] = "plan";
  ...
  var ajax_error_list = {
    ...
    "namasoap": {"label": "Nama SOAP", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "subject": {"label": "Subject", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "object": {"label": "Object", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "assessment": {"label": "Assessment", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "plan": {"label": "Plan", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  ajax_field_mult["namasoap"][1] = "namasoap";
  ajax_field_mult["subject"][1] = "subject";
  ajax_field_mult["object"][1] = "object";
  ajax_field_mult["assessment"][1] = "assessment";
  ajax_field_mult["plan"][1] = "plan";

  var ajax_field_id = {
    "id": new Array("hidden_field_label_id", "hidden_field_data_id"),
    "namasoap": new Array("hidden_field_label_namasoap", "hidden_field_data_namasoap"),
    "subject": new Array("hidden_field_label_subject", "hidden_field_data_subject"),
    "object": new Array("hidden_field_label_object", "hidden_field_data_object"),
    "assessment": new Array("hidden_field_label_assessment", "hidden_field_data_assessment"),
    "plan": new Array("hidden_field_label_plan", "hidden_field_data_plan")
  };
