...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____stok_terkini"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____stok_terkini"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['stok_terkini']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['stok_terkini']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['stok_terkini']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['stok_terkini']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['stok_terkini']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['stok_terkini']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['stok_terkini']['embutida_filho'] as $ind => $sc_init)
          {
