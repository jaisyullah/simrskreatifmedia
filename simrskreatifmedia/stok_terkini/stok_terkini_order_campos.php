...
<?php
   ...
   $Ord_Cmp = new stok_terkini_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class stok_terkini_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['stok_terkini']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['stok_terkini']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["namaitem"]   = (isset($_SESSION['sc_session'][$sc_init]['stok_terkini']['labels']["namaitem"])) ? $_SESSION['sc_session'][$sc_init]['stok_terkini']['labels']["namaitem"] : "Nama Item";
   $tab_ger_campos['hargajual'] = "on";
   $tab_def_campos['hargajual'] = "hargaJual";
   $tab_labels["hargajual"]   = (isset($_SESSION['sc_session'][$sc_init]['stok_terkini']['labels']["hargajual"])) ? $_SESSION['sc_session'][$sc_init]['stok_terkini']['labels']["hargajual"] : "Harga Jual (28%)";
   $tab_ger_campos['stok'] = "on";
   $tab_def_campos['stok'] = "stok";
   $tab_labels["stok"]   = (isset($_SESSION['sc_session'][$sc_init]['stok_terkini']['labels']["stok"])) ? $_SESSION['sc_session'][$sc_init]['stok_terkini']['labels']["stok"] : "Stok";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['stok_terkini']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['stok_terkini']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['stok_terkini']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['stok_terkini']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['stok_terkini']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['stok_terkini']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['stok_terkini']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['stok_terkini']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['stok_terkini']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "stok_terkini_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['stok_terkini']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['stok_terkini']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['stok_terkini']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['stok_terkini']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['stok_terkini']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
