<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_select_ranap']['glo_nm_path_imag_temp'] . "/sc_apl_default_simrskreatifmedia.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_select_ranap_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_select_ranap_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_select_ranap']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_select_ranap']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["tglkeluar"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_select_ranap']['labels']["tglkeluar"])) ? $_SESSION['sc_session'][$sc_init]['grid_select_ranap']['labels']["tglkeluar"] : "Tgl Keluar";
   ...
   $tab_labels["rm"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_select_ranap']['labels']["rm"])) ? $_SESSION['sc_session'][$sc_init]['grid_select_ranap']['labels']["rm"] : "RM";
   ...
   $tab_labels["nama"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_select_ranap']['labels']["nama"])) ? $_SESSION['sc_session'][$sc_init]['grid_select_ranap']['labels']["nama"] : "Nama";
   ...
   $tab_labels["dokter"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_select_ranap']['labels']["dokter"])) ? $_SESSION['sc_session'][$sc_init]['grid_select_ranap']['labels']["dokter"] : "Dokter";
   ...
   $tab_labels["jenis"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_select_ranap']['labels']["jenis"])) ? $_SESSION['sc_session'][$sc_init]['grid_select_ranap']['labels']["jenis"] : "Jenis";
   ...
   $tab_labels["carakeluar"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_select_ranap']['labels']["carakeluar"])) ? $_SESSION['sc_session'][$sc_init]['grid_select_ranap']['labels']["carakeluar"] : "Cara Keluar";
   ...
   $tab_labels["selesai"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_select_ranap']['labels']["selesai"])) ? $_SESSION['sc_session'][$sc_init]['grid_select_ranap']['labels']["selesai"] : "Checkout";
   ...
   $tab_labels["kode"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_select_ranap']['labels']["kode"])) ? $_SESSION['sc_session'][$sc_init]['grid_select_ranap']['labels']["kode"] : "Kode Pelayanan";
   ...
   {
       $tab_def_campos['struk'] = "a.noStruk";
   }
   $tab_labels["struk"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_select_ranap']['labels']["struk"])) ? $_SESSION['sc_session'][$sc_init]['grid_select_ranap']['labels']["struk"] : "Struk Register";
   ...
   {
       $tab_def_campos['lunas'] = "";
   }
   $tab_labels["lunas"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_select_ranap']['labels']["lunas"])) ? $_SESSION['sc_session'][$sc_init]['grid_select_ranap']['labels']["lunas"] : "Lunas";
   $tab_ger_campos['jenis'] = "none";
   $tab_ger_campos['lunas'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_select_ranap']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_select_ranap']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_select_ranap']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_select_ranap']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_select_ranap']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_select_ranap']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_select_ranap']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_select_ranap']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_select_ranap']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_select_ranap_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_select_ranap']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_select_ranap']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_select_ranap']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_select_ranap']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_select_ranap']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
