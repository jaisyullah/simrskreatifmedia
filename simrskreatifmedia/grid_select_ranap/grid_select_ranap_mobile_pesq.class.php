...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "a.tglKeluar";$Nm_datas[] = "a_tglKeluar";$Nm_numeric[] = "a_nostruk";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_rm"  <?php echo $str_hide_rm?>><?php
      if ($rm != "")
      {
      $rm_look = substr($this->Db->qstr($rm), 1, -1); 
      $nmgp_def_dados = array(); 
