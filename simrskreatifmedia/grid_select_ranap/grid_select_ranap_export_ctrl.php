<?php
@session_start() ;
$_SESSION['scriptcase']['grid_select_ranap']['sc_process_barr'] = true;
require_once('../grid_select_ranap/index.php');
unset($_SESSION['scriptcase']['grid_select_ranap']['sc_process_barr']);
$ExportCtrl = new grid_select_ranap_export_control;
$ExportCtrl->Export_barr();

class grid_select_ranap_export_control
{
