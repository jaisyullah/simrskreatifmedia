  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_hrm_penghargaan" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_hrm_penghargaan_form();
	}

  // ---------- Validate jenis_
  function do_ajax_form_hrm_penghargaan_validate_jenis_(iNumLinha)
  {
    var nomeCampo_jenis_ = "jenis_" + iNumLinha;
    var var_jenis_ = scAjaxGetFieldText(nomeCampo_jenis_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_penghargaan_validate_jenis_(var_jenis_, iNumLinha, var_script_case_init, do_ajax_form_hrm_penghargaan_validate_jenis__cb);
  } // do_ajax_form_hrm_penghargaan_validate_jenis_

  function do_ajax_form_hrm_penghargaan_validate_jenis__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_penghargaan_validate_jenis__cb

  // ---------- Validate tgl_penghargaan_
  function do_ajax_form_hrm_penghargaan_validate_tgl_penghargaan_(iNumLinha)
  {
    var nomeCampo_tgl_penghargaan_ = "tgl_penghargaan_" + iNumLinha;
    var var_tgl_penghargaan_ = scAjaxGetFieldText(nomeCampo_tgl_penghargaan_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_penghargaan_validate_tgl_penghargaan_(var_tgl_penghargaan_, iNumLinha, var_script_case_init, do_ajax_form_hrm_penghargaan_validate_tgl_penghargaan__cb);
  } // do_ajax_form_hrm_penghargaan_validate_tgl_penghargaan_

  function do_ajax_form_hrm_penghargaan_validate_tgl_penghargaan__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "tgl_penghargaan_" + iLineNumber;
    }
    else
    {
      sFieldValid = "tgl_penghargaan_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "tgl_penghargaan_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "tgl_penghargaan_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_penghargaan_validate_tgl_penghargaan__cb

  // ---------- Validate id_
  function do_ajax_form_hrm_penghargaan_validate_id_(iNumLinha)
  {
    var nomeCampo_id_ = "id_" + iNumLinha;
    var var_id_ = scAjaxGetFieldHidden(nomeCampo_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_penghargaan_validate_id_(var_id_, iNumLinha, var_script_case_init, do_ajax_form_hrm_penghargaan_validate_id__cb);
  } // do_ajax_form_hrm_penghargaan_validate_id_

  function do_ajax_form_hrm_penghargaan_validate_id__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_penghargaan_validate_id__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_hrm_penghargaan_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_hrm_penghargaan_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_hrm_penghargaan_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_hrm_penghargaan_add_new_line_cb);
  } // do_ajax_form_hrm_penghargaan_add_new_line

  function do_ajax_form_hrm_penghargaan_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_hrm_penghargaan_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_hrm_penghargaan_backup_line(iNumLinha)
  {
    var var_id_ = scAjaxGetFieldHidden("id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_penghargaan_backup_line(var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_hrm_penghargaan_backup_line_cb);
  } // do_ajax_form_hrm_penghargaan_backup_line

  function do_ajax_form_hrm_penghargaan_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_hrm_penghargaan_backup_line_cb

  function do_ajax_form_hrm_penghargaan_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_hrm_penghargaan_cancel_insert

  function do_ajax_form_hrm_penghargaan_cancel_update(iSeqVert)
  {
    do_ajax_form_hrm_penghargaan_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_hrm_penghargaan_cancel_update

  function do_ajax_form_hrm_penghargaan_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_hrm_penghargaan_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_hrm_penghargaan_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_hrm_penghargaan_table_refresh(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_hrm_penghargaan_table_refresh_cb);
  } //  do_ajax_form_hrm_penghargaan_table_refresh

  function do_ajax_form_hrm_penghargaan_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_hrm_penghargaan_table_refresh_cb_after_alert);
  } // do_ajax_form_hrm_penghargaan_table_refresh_cb
  function do_ajax_form_hrm_penghargaan_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_hrm_penghargaan_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_hrm_penghargaan_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_hrm_penghargaan_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    var var_tgl_penghargaan_ = scAjaxGetFieldText("tgl_penghargaan_" + iNumLinha);
    var var_id_ = scAjaxGetFieldHidden("id_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_hrm_penghargaan_submit_form(var_jenis_, var_tgl_penghargaan_, var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_hrm_penghargaan_submit_form_cb);
  } // do_ajax_form_hrm_penghargaan_submit_form

  function do_ajax_form_hrm_penghargaan_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("tgl_penghargaan_" + sc_num_ult_line);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_hrm_penghargaan_submit_form_cb_after_alert);
  } // do_ajax_form_hrm_penghargaan_submit_form_cb
  function do_ajax_form_hrm_penghargaan_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_hrm_penghargaan_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_hrm_penghargaan_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_hrm_penghargaan_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("tgl_penghargaan_" + iNavForm);
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_hrm_penghargaan_navigate_form(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_hrm_penghargaan_navigate_form_cb);
  } // do_ajax_form_hrm_penghargaan_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_hrm_penghargaan']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_hrm_penghargaan_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_hrm_penghargaan_navigate_form_cb_after_alert);
  } // do_ajax_form_hrm_penghargaan_navigate_form_cb
  function do_ajax_form_hrm_penghargaan_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_hrm_penghargaan_navigate_form_cb_after_alert
  function sc_hide_form_hrm_penghargaan_form()
  {
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "tgl_penghargaan_" + iNumLinha;
    iTotCampos++;
    ...
    ajax_error_list["tgl_penghargaan_" + iNumLinha] = {"label": "Tgl Penghargaan<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_field_mult["tgl_penghargaan_"][iNumLinha] = "tgl_penghargaan_" + iNumLinha;
    ...
    ajax_field_id["tgl_penghargaan_" + iNumLinha] = new Array("hidden_field_label_tgl_penghargaan_", "hidden_field_data_tgl_penghargaan_" + iNumLinha);
    ajax_error_count["jenis_" + iNumLinha] = "off";
    ajax_error_count["tgl_penghargaan_" + iNumLinha] = "off";
...
?>
    ...
    ajax_read_only["tgl_penghargaan_" + iNumLinha] = "off";
...
?>
    ...
    ajax_read_only["tgl_penghargaan_" + iNumLinha] = "on";
    ajax_read_only["id_" + iNumLinha] = "on";
<?php
}
?>
  ...
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["tgl_penghargaan_" + iNumLinha] = null;
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["tgl_penghargaan_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["tgl_penghargaan_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["tgl_penghargaan_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["tgl_penghargaan_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["tgl_penghargaan_" + iNumLinha]["onfocus"] = new Array();
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['tgl_penghargaan_'])) ? $this->nmgp_cmp_readonly['tgl_penghargaan_'] : 'off';
?>
    scAjaxFieldRead("tgl_penghargaan_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
?>
  ...
  function mdCloseObjects(iSeq)
  {
    ...
    scAjaxFieldRead("tgl_penghargaan_" + iSeq, "on");
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["jenis_" + iRow] || "on" == ajax_error_count["tgl_penghargaan_" + iRow] || "on" == ajax_error_count["id_" + iRow]))
    {
      ...
      $("#hidden_field_data_tgl_penghargaan_" + iRow).addClass("scFormErrorLine");
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["jenis_" + iRow] && "off" == ajax_error_count["tgl_penghargaan_" + iRow] && "off" == ajax_error_count["id_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["jenis_" + iRow] = "off";
        ajax_error_count["tgl_penghargaan_" + iRow] = "off";
      ...
      $("#hidden_field_data_tgl_penghargaan_" + iRow).removeClass("scFormErrorLine");
