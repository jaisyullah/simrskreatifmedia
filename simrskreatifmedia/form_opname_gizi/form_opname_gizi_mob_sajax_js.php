  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_opname_gizi_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_opname_gizi_mob_form();
	}

  // ---------- Validate id
  function do_ajax_form_opname_gizi_mob_validate_id()
  {
    var nomeCampo_id = "id";
    var var_id = scAjaxGetFieldHidden(nomeCampo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_opname_gizi_mob_validate_id(var_id, var_script_case_init, do_ajax_form_opname_gizi_mob_validate_id_cb);
  } // do_ajax_form_opname_gizi_mob_validate_id

  function do_ajax_form_opname_gizi_mob_validate_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_opname_gizi_mob_validate_id_cb

  // ---------- Validate opnamecode
  function do_ajax_form_opname_gizi_mob_validate_opnamecode()
  {
    var nomeCampo_opnamecode = "opnamecode";
    var var_opnamecode = scAjaxGetFieldText(nomeCampo_opnamecode);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_opname_gizi_mob_validate_opnamecode(var_opnamecode, var_script_case_init, do_ajax_form_opname_gizi_mob_validate_opnamecode_cb);
  } // do_ajax_form_opname_gizi_mob_validate_opnamecode

  function do_ajax_form_opname_gizi_mob_validate_opnamecode_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "opnamecode";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_opname_gizi_mob_validate_opnamecode_cb

  // ---------- Validate date
  function do_ajax_form_opname_gizi_mob_validate_date()
  {
    var nomeCampo_date = "date";
    var var_date = scAjaxGetFieldText(nomeCampo_date);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_opname_gizi_mob_validate_date(var_date, var_script_case_init, do_ajax_form_opname_gizi_mob_validate_date_cb);
  } // do_ajax_form_opname_gizi_mob_validate_date

  function do_ajax_form_opname_gizi_mob_validate_date_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "date";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_opname_gizi_mob_validate_date_cb

  // ---------- Validate keterangan
  function do_ajax_form_opname_gizi_mob_validate_keterangan()
  {
    var nomeCampo_keterangan = "keterangan";
    var var_keterangan = scAjaxGetFieldText(nomeCampo_keterangan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_opname_gizi_mob_validate_keterangan(var_keterangan, var_script_case_init, do_ajax_form_opname_gizi_mob_validate_keterangan_cb);
  } // do_ajax_form_opname_gizi_mob_validate_keterangan

  function do_ajax_form_opname_gizi_mob_validate_keterangan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_opname_gizi_mob_validate_keterangan_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_opname_gizi_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_opname_gizi_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id = scAjaxGetFieldHidden("id");
    var var_opnamecode = scAjaxGetFieldText("opnamecode");
    ...
    scAjaxProcOn();
    x_ajax_form_opname_gizi_mob_submit_form(var_id, var_opnamecode, var_date, var_keterangan, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_opname_gizi_mob_submit_form_cb);
  } // do_ajax_form_opname_gizi_mob_submit_form

  function do_ajax_form_opname_gizi_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("opnamecode");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_opname_gizi_mob_submit_form_cb_after_alert);
  } // do_ajax_form_opname_gizi_mob_submit_form_cb
  function do_ajax_form_opname_gizi_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_opname_gizi_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_opname_gizi_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_opname_gizi_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_opname_gizi_mob_navigate_form_cb);
  } // do_ajax_form_opname_gizi_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_opname_gizi_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_opname_gizi_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_opname_gizi_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_opname_gizi_mob_navigate_form_cb
  function do_ajax_form_opname_gizi_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_opname_gizi_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_opname_gizi_mob_navigate_form_cb_after_alert
  function sc_hide_form_opname_gizi_mob_form()
  {
  ...
  ajax_field_list[1] = "opnamecode";
  ajax_field_list[2] = "date";
  ...
  var ajax_error_list = {
    ...
    "opnamecode": {"label": "Opnamecode", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  var ajax_field_mult = {
    "id": new Array(),
    "opnamecode": new Array(),
    "date": new Array(),
    "keterangan": new Array()
  };
  ajax_field_mult["id"][1] = "id";
  ajax_field_mult["opnamecode"][1] = "opnamecode";
  ...
  var ajax_field_id = {
    ...
    "opnamecode": new Array("hidden_field_label_opnamecode", "hidden_field_data_opnamecode"),
