<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tbinstansi']['sc_process_barr'] = true;
require_once('../grid_tbinstansi/index.php');
unset($_SESSION['scriptcase']['grid_tbinstansi']['sc_process_barr']);
$ExportCtrl = new grid_tbinstansi_export_control;
$ExportCtrl->Export_barr();

class grid_tbinstansi_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - Instansi Penjamin :: Excel</TITLE>
