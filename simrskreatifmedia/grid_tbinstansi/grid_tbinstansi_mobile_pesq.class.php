...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_address"  <?php echo $str_hide_address?>><?php
      if ($address != "")
      {
      $address_look = substr($this->Db->qstr($address), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_instcode"  <?php echo $str_hide_instcode?>><?php
      if ($instcode != "")
      {
      $instcode_look = substr($this->Db->qstr($instcode), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_init"  <?php echo $str_hide_init?>><?php
      if ($init != "")
      {
      $init_look = substr($this->Db->qstr($init), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_city"  <?php echo $str_hide_city?>><?php
      if ($city != "")
      {
      $city_look = substr($this->Db->qstr($city), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_phone"  <?php echo $str_hide_phone?>><?php
      if ($phone != "")
      {
      $phone_look = substr($this->Db->qstr($phone), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_fax"  <?php echo $str_hide_fax?>><?php
      if ($fax != "")
      {
      $fax_look = substr($this->Db->qstr($fax), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_cp"  <?php echo $str_hide_cp?>><?php
      if ($cp != "")
      {
      $cp_look = substr($this->Db->qstr($cp), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_limit"  <?php echo $str_hide_limit?>><?php
      if ($limit != "")
      {
      $limit_look = substr($this->Db->qstr($limit), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_discount"  <?php echo $str_hide_discount?>><?php
      if ($discount != "")
      {
      $discount_look = substr($this->Db->qstr($discount), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_policy"  <?php echo $str_hide_policy?>><?php
      if ($policy != "")
      {
      $policy_look = substr($this->Db->qstr($policy), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_itemtype"  <?php echo $str_hide_itemtype?>><?php
      if ($itemtype != "")
      {
      $itemtype_look = substr($this->Db->qstr($itemtype), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_tempo"  <?php echo $str_hide_tempo?>><?php
      if ($tempo != "")
      {
      $tempo_look = substr($this->Db->qstr($tempo), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_asuransi"  <?php echo $str_hide_asuransi?>><?php
      if ($asuransi != "")
      {
      $asuransi_look = substr($this->Db->qstr($asuransi), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_marginobat"  <?php echo $str_hide_marginobat?>><?php
      if ($marginobat != "")
      {
      $marginobat_look = substr($this->Db->qstr($marginobat), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_markuptindakan"  <?php echo $str_hide_markuptindakan?>><?php
      if ($markuptindakan != "")
      {
      $markuptindakan_look = substr($this->Db->qstr($markuptindakan), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_markupobat"  <?php echo $str_hide_markupobat?>><?php
      if ($markupobat != "")
      {
      $markupobat_look = substr($this->Db->qstr($markupobat), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_markuplab"  <?php echo $str_hide_markuplab?>><?php
      if ($markuplab != "")
      {
      $markuplab_look = substr($this->Db->qstr($markuplab), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_markuprad"  <?php echo $str_hide_markuprad?>><?php
      if ($markuprad != "")
      {
      $markuprad_look = substr($this->Db->qstr($markuprad), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_admpolitype"  <?php echo $str_hide_admpolitype?>><?php
      if ($admpolitype != "")
      {
      $admpolitype_look = substr($this->Db->qstr($admpolitype), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_adminaptype"  <?php echo $str_hide_adminaptype?>><?php
      if ($adminaptype != "")
      {
      $adminaptype_look = substr($this->Db->qstr($adminaptype), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_admpolibaru"  <?php echo $str_hide_admpolibaru?>><?php
      if ($admpolibaru != "")
      {
      $admpolibaru_look = substr($this->Db->qstr($admpolibaru), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_admpolilama"  <?php echo $str_hide_admpolilama?>><?php
      if ($admpolilama != "")
      {
      $admpolilama_look = substr($this->Db->qstr($admpolilama), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_adminap"  <?php echo $str_hide_adminap?>><?php
      if ($adminap != "")
      {
      $adminap_look = substr($this->Db->qstr($adminap), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_sc_field_2"  <?php echo $str_hide_sc_field_2?>>
<?php
  $Form_base = "ddmmyyyy";
  $date_format_show = "";
  $Str_date = str_replace("a", "y", strtolower($_SESSION['scriptcase']['reg_conf']['date_format']));
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_marginpma"  <?php echo $str_hide_marginpma?>><?php
      if ($marginpma != "")
      {
      $marginpma_look = substr($this->Db->qstr($marginpma), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_withpma"  <?php echo $str_hide_withpma?>><?php
      if ($withpma != "")
      {
      $withpma_look = substr($this->Db->qstr($withpma), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_forminternal"  <?php echo $str_hide_forminternal?>><?php
      if ($forminternal != "")
      {
      $forminternal_look = substr($this->Db->qstr($forminternal), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_vacc"  <?php echo $str_hide_vacc?>><?php
      if ($vacc != "")
      {
      $vacc_look = substr($this->Db->qstr($vacc), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_extcode"  <?php echo $str_hide_extcode?>><?php
      if ($extcode != "")
      {
      $extcode_look = substr($this->Db->qstr($extcode), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_umum"  <?php echo $str_hide_umum?>><?php
      if ($umum != "")
      {
      $umum_look = substr($this->Db->qstr($umum), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_autoshow"  <?php echo $str_hide_autoshow?>><?php
      if ($autoshow != "")
      {
      $autoshow_look = substr($this->Db->qstr($autoshow), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_bpjs"  <?php echo $str_hide_bpjs?>><?php
      if ($bpjs != "")
      {
      $bpjs_look = substr($this->Db->qstr($bpjs), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_caracode"  <?php echo $str_hide_caracode?>><?php
      if ($caracode != "")
      {
      $caracode_look = substr($this->Db->qstr($caracode), 1, -1); 
      $nmgp_def_dados = array(); 
