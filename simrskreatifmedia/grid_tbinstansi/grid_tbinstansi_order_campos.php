<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_tbinstansi']['glo_nm_path_imag_temp'] . "/sc_apl_default_simrskreatifmedia.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_tbinstansi_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_tbinstansi_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbinstansi']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tbinstansi']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['instcode'] = "instCode";
   $tab_labels["instcode"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbinstansi']['labels']["instcode"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbinstansi']['labels']["instcode"] : "Kode Instansi";
   $tab_ger_campos['init'] = "on";
   $tab_def_campos['init'] = "init";
   $tab_labels["init"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbinstansi']['labels']["init"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbinstansi']['labels']["init"] : "Inisial";
   $tab_ger_campos['name'] = "on";
   $tab_def_campos['name'] = "name";
   $tab_labels["name"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbinstansi']['labels']["name"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbinstansi']['labels']["name"] : "Nama Instansi";
   $tab_ger_campos['tempo'] = "on";
   $tab_def_campos['tempo'] = "tempo";
   $tab_labels["tempo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbinstansi']['labels']["tempo"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbinstansi']['labels']["tempo"] : "Jatuh Tempo (Hari)";
   $tab_ger_campos['address'] = "on";
   $tab_def_campos['address'] = "address";
   $tab_labels["address"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbinstansi']['labels']["address"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbinstansi']['labels']["address"] : "Alamat";
   $tab_ger_campos['city'] = "on";
   $tab_def_campos['city'] = "city";
   $tab_labels["city"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbinstansi']['labels']["city"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbinstansi']['labels']["city"] : "Kota";
   $tab_ger_campos['phone'] = "on";
   $tab_def_campos['phone'] = "phone";
   $tab_labels["phone"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbinstansi']['labels']["phone"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbinstansi']['labels']["phone"] : "Telepon";
   $tab_ger_campos['cp'] = "on";
   $tab_def_campos['cp'] = "cp";
   $tab_labels["cp"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbinstansi']['labels']["cp"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbinstansi']['labels']["cp"] : "Kontak Person";
   ...
   {
       $tab_def_campos['sc_field_0'] = "date(joinDate)";
   }
   $tab_labels["sc_field_0"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbinstansi']['labels']["sc_field_0"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbinstansi']['labels']["sc_field_0"] : "Awal Kontrak";
   ...
   {
       $tab_def_campos['sc_field_1'] = "date(expDate)";
   }
   $tab_labels["sc_field_1"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbinstansi']['labels']["sc_field_1"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbinstansi']['labels']["sc_field_1"] : "Kontrak Habis";
   ...
   {
       $tab_def_campos['sc_field_2'] = "date(lastUpdated)";
   }
   $tab_labels["sc_field_2"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbinstansi']['labels']["sc_field_2"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbinstansi']['labels']["sc_field_2"] : "Terakhir Diupdate";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_tbinstansi']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_tbinstansi']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_tbinstansi']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbinstansi']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tbinstansi']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_tbinstansi']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_tbinstansi']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_tbinstansi']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_tbinstansi']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - Instansi Penjamin</TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_tbinstansi_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_tbinstansi']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_tbinstansi']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_tbinstansi']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_tbinstansi']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_tbinstansi']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
