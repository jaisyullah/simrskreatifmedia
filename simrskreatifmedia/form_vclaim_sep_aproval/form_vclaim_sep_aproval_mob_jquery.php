...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_nokartu' + iSeqRow).bind('blur', function() { sc_form_vclaim_sep_aproval_nokartu_onblur(this, iSeqRow) })
                                     .bind('focus', function() { sc_form_vclaim_sep_aproval_nokartu_onfocus(this, iSeqRow) });
  $('#id_sc_field_tglsep' + iSeqRow).bind('blur', function() { sc_form_vclaim_sep_aproval_tglsep_onblur(this, iSeqRow) })
                                    .bind('focus', function() { sc_form_vclaim_sep_aproval_tglsep_onfocus(this, iSeqRow) });
  $('#id_sc_field_jnspelayanan' + iSeqRow).bind('blur', function() { sc_form_vclaim_sep_aproval_jnspelayanan_onblur(this, iSeqRow) })
                                          .bind('focus', function() { sc_form_vclaim_sep_aproval_jnspelayanan_onfocus(this, iSeqRow) });
  $('#id_sc_field_user' + iSeqRow).bind('blur', function() { sc_form_vclaim_sep_aproval_user_onblur(this, iSeqRow) })
                                  .bind('focus', function() { sc_form_vclaim_sep_aproval_user_onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_form_vclaim_sep_aproval_nokartu_onblur(oThis, iSeqRow) {
  do_ajax_form_vclaim_sep_aproval_mob_validate_nokartu();
  scCssBlur(oThis);
}

function sc_form_vclaim_sep_aproval_nokartu_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_vclaim_sep_aproval_tglsep_onblur(oThis, iSeqRow) {
  do_ajax_form_vclaim_sep_aproval_mob_validate_tglsep();
  scCssBlur(oThis);
}

function sc_form_vclaim_sep_aproval_tglsep_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_vclaim_sep_aproval_jnspelayanan_onblur(oThis, iSeqRow) {
  do_ajax_form_vclaim_sep_aproval_mob_validate_jnspelayanan();
  scCssBlur(oThis);
}

function sc_form_vclaim_sep_aproval_jnspelayanan_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_vclaim_sep_aproval_user_onblur(oThis, iSeqRow) {
  do_ajax_form_vclaim_sep_aproval_mob_validate_user();
  scCssBlur(oThis);
}

function sc_form_vclaim_sep_aproval_user_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function scHidePage(pageNo) {
	$("#id_form_vclaim_sep_aproval_mob_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_tglsep" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_vclaim_sep_aproval_mob_validate_tglsep(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
