<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tbdetailigd']['sc_process_barr'] = true;
require_once('../grid_tbdetailigd/index.php');
unset($_SESSION['scriptcase']['grid_tbdetailigd']['sc_process_barr']);
$ExportCtrl = new grid_tbdetailigd_export_control;
$ExportCtrl->Export_barr();

class grid_tbdetailigd_export_control
{
