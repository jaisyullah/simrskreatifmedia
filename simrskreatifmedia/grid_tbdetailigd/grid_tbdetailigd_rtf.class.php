...
class grid_tbdetailigd_rtf
{
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "grid_tbdetailigd.rtf";
   }
   //---- 
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      $nm_raiz_img  = ""; 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailigd']['rtf_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailigd']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailigd']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailigd']['rtf_name']);
      }
...
$_SESSION['scriptcase']['grid_tbdetailigd']['contr_erro'] = 'off'; 
   ...
   function NM_export_jamdaftar()
   {
         ...
         $this->jamdaftar = str_replace('<', '&lt;', $this->jamdaftar);
         $this->jamdaftar = str_replace('>', '&gt;', $this->jamdaftar);
         $this->Texto_tag .= "<td>" . $this->jamdaftar . "</td>\r\n";
   }
   //----- tglkeluar
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailigd']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailigd']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
