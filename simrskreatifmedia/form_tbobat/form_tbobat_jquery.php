...
function displayChange_field_stock(row, status) {
	if ("on" == status && typeof $("#nmsc_iframe_liga_form_tbstockobat")[0].contentWindow.scRecreateSelect2 === "function") {
		$("#nmsc_iframe_liga_form_tbstockobat")[0].contentWindow.scRecreateSelect2();
	}
}

function displayChange_field_margin(row, status) {
	if ("on" == status && typeof $("#nmsc_iframe_liga_form_tbdetailmargin")[0].contentWindow.scRecreateSelect2 === "function") {
		$("#nmsc_iframe_liga_form_tbdetailmargin")[0].contentWindow.scRecreateSelect2();
	}
}
...
function scHidePage(pageNo) {
	$("#id_form_tbobat_form" + pageNo).hide();
}
