...
$old_error_handler = set_error_handler("form_tbobat_scriptcase_error_handler");

function form_tbobat_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['form_tbobat']['contr_erro']) && $_SESSION['scriptcase']['form_tbobat']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_form_tbobat->contr_form_tbobat->Apl_com_erro = true;
            if ($inicial_form_tbobat->contr_form_tbobat->NM_ajax_flag)
            {
                $inicial_form_tbobat->contr_form_tbobat->NM_ajax_info['errList']['geral_form_tbobat'][] = $msg;
                return;
            }
            form_tbobat_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function form_tbobat_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['form_tbobat'])  && '' != $_SESSION['scriptcase']['error_icon']['form_tbobat'])  ? $_SESSION['scriptcase']['error_icon']['form_tbobat']  : "";
        $sCloseIcon      = (isset($_SESSION['scriptcase']['error_close']['form_tbobat']) && '' != $_SESSION['scriptcase']['error_close']['form_tbobat']) ? $_SESSION['scriptcase']['error_close']['form_tbobat'] : "<td><input class=\"scButton_default\" type=\"button\" onClick=\"document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false\" value=\"X\" /></td>";

        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['form_tbobat']) && '' != $_SESSION['scriptcase']['error_span_title']['form_tbobat']) ? $_SESSION['scriptcase']['error_span_title']['form_tbobat'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['form_tbobat']) && '' != $_SESSION['scriptcase']['error_icon_title']['form_tbobat']) ? $_SESSION['scriptcase']['error_icon_title']['form_tbobat'] : '';
?>
