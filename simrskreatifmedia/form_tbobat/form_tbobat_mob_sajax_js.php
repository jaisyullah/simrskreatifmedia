  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbobat_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbobat_mob_form();
	}

  // ---------- Validate kodeitem
  function do_ajax_form_tbobat_mob_validate_kodeitem()
  {
    var nomeCampo_kodeitem = "kodeitem";
    var var_kodeitem = scAjaxGetFieldText(nomeCampo_kodeitem);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbobat_mob_validate_kodeitem(var_kodeitem, var_script_case_init, do_ajax_form_tbobat_mob_validate_kodeitem_cb);
  } // do_ajax_form_tbobat_mob_validate_kodeitem

  function do_ajax_form_tbobat_mob_validate_kodeitem_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbobat_mob_validate_kodeitem_cb

  // ---------- Validate namaitem
  function do_ajax_form_tbobat_mob_validate_namaitem()
  {
    var nomeCampo_namaitem = "namaitem";
    var var_namaitem = scAjaxGetFieldText(nomeCampo_namaitem);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbobat_mob_validate_namaitem(var_namaitem, var_script_case_init, do_ajax_form_tbobat_mob_validate_namaitem_cb);
  } // do_ajax_form_tbobat_mob_validate_namaitem

  function do_ajax_form_tbobat_mob_validate_namaitem_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbobat_mob_validate_namaitem_cb

  // ---------- Validate jenisbarang
  function do_ajax_form_tbobat_mob_validate_jenisbarang()
  {
    var nomeCampo_jenisbarang = "jenisbarang";
    var var_jenisbarang = scAjaxGetFieldSelect(nomeCampo_jenisbarang);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbobat_mob_validate_jenisbarang(var_jenisbarang, var_script_case_init, do_ajax_form_tbobat_mob_validate_jenisbarang_cb);
  } // do_ajax_form_tbobat_mob_validate_jenisbarang

  function do_ajax_form_tbobat_mob_validate_jenisbarang_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbobat_mob_validate_jenisbarang_cb

  // ---------- Validate stokminimal
  function do_ajax_form_tbobat_mob_validate_stokminimal()
  {
    var nomeCampo_stokminimal = "stokminimal";
    var var_stokminimal = scAjaxGetFieldText(nomeCampo_stokminimal);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbobat_mob_validate_stokminimal(var_stokminimal, var_script_case_init, do_ajax_form_tbobat_mob_validate_stokminimal_cb);
  } // do_ajax_form_tbobat_mob_validate_stokminimal

  function do_ajax_form_tbobat_mob_validate_stokminimal_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbobat_mob_validate_stokminimal_cb

  // ---------- Validate max
  function do_ajax_form_tbobat_mob_validate_max()
  {
    var nomeCampo_max = "max";
    var var_max = scAjaxGetFieldText(nomeCampo_max);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbobat_mob_validate_max(var_max, var_script_case_init, do_ajax_form_tbobat_mob_validate_max_cb);
  } // do_ajax_form_tbobat_mob_validate_max

  function do_ajax_form_tbobat_mob_validate_max_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "max";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbobat_mob_validate_max_cb

  // ---------- Validate satuanterkecil
  function do_ajax_form_tbobat_mob_validate_satuanterkecil()
  {
    var nomeCampo_satuanterkecil = "satuanterkecil";
    var var_satuanterkecil = scAjaxGetFieldSelect(nomeCampo_satuanterkecil);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbobat_mob_validate_satuanterkecil(var_satuanterkecil, var_script_case_init, do_ajax_form_tbobat_mob_validate_satuanterkecil_cb);
  } // do_ajax_form_tbobat_mob_validate_satuanterkecil

  function do_ajax_form_tbobat_mob_validate_satuanterkecil_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbobat_mob_validate_satuanterkecil_cb

  // ---------- Validate aktif
  function do_ajax_form_tbobat_mob_validate_aktif()
  {
    var nomeCampo_aktif = "aktif";
    var var_aktif = scAjaxGetFieldRadio(nomeCampo_aktif);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbobat_mob_validate_aktif(var_aktif, var_script_case_init, do_ajax_form_tbobat_mob_validate_aktif_cb);
  } // do_ajax_form_tbobat_mob_validate_aktif

  function do_ajax_form_tbobat_mob_validate_aktif_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "aktif";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbobat_mob_validate_aktif_cb

  // ---------- Validate hargajual
  function do_ajax_form_tbobat_mob_validate_hargajual()
  {
    var nomeCampo_hargajual = "hargajual";
    var var_hargajual = scAjaxGetFieldText(nomeCampo_hargajual);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbobat_mob_validate_hargajual(var_hargajual, var_script_case_init, do_ajax_form_tbobat_mob_validate_hargajual_cb);
  } // do_ajax_form_tbobat_mob_validate_hargajual

  function do_ajax_form_tbobat_mob_validate_hargajual_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbobat_mob_validate_hargajual_cb

  // ---------- Validate kemasanbeli
  function do_ajax_form_tbobat_mob_validate_kemasanbeli()
  {
    var nomeCampo_kemasanbeli = "kemasanbeli";
    var var_kemasanbeli = scAjaxGetFieldSelect(nomeCampo_kemasanbeli);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbobat_mob_validate_kemasanbeli(var_kemasanbeli, var_script_case_init, do_ajax_form_tbobat_mob_validate_kemasanbeli_cb);
  } // do_ajax_form_tbobat_mob_validate_kemasanbeli

  function do_ajax_form_tbobat_mob_validate_kemasanbeli_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbobat_mob_validate_kemasanbeli_cb

  // ---------- Validate satuanisi
  function do_ajax_form_tbobat_mob_validate_satuanisi()
  {
    var nomeCampo_satuanisi = "satuanisi";
    var var_satuanisi = scAjaxGetFieldText(nomeCampo_satuanisi);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbobat_mob_validate_satuanisi(var_satuanisi, var_script_case_init, do_ajax_form_tbobat_mob_validate_satuanisi_cb);
  } // do_ajax_form_tbobat_mob_validate_satuanisi

  function do_ajax_form_tbobat_mob_validate_satuanisi_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbobat_mob_validate_satuanisi_cb

  // ---------- Validate generik
  function do_ajax_form_tbobat_mob_validate_generik()
  {
    var nomeCampo_generik = "generik";
    var var_generik = scAjaxGetFieldSelect(nomeCampo_generik);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbobat_mob_validate_generik(var_generik, var_script_case_init, do_ajax_form_tbobat_mob_validate_generik_cb);
  } // do_ajax_form_tbobat_mob_validate_generik

  function do_ajax_form_tbobat_mob_validate_generik_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "generik";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbobat_mob_validate_generik_cb

  // ---------- Validate paten
  function do_ajax_form_tbobat_mob_validate_paten()
  {
    var nomeCampo_paten = "paten";
    var var_paten = scAjaxGetFieldSelect(nomeCampo_paten);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbobat_mob_validate_paten(var_paten, var_script_case_init, do_ajax_form_tbobat_mob_validate_paten_cb);
  } // do_ajax_form_tbobat_mob_validate_paten

  function do_ajax_form_tbobat_mob_validate_paten_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "paten";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbobat_mob_validate_paten_cb

  // ---------- Validate keterangan
  function do_ajax_form_tbobat_mob_validate_keterangan()
  {
    var nomeCampo_keterangan = "keterangan";
    var var_keterangan = scAjaxGetFieldText(nomeCampo_keterangan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbobat_mob_validate_keterangan(var_keterangan, var_script_case_init, do_ajax_form_tbobat_mob_validate_keterangan_cb);
  } // do_ajax_form_tbobat_mob_validate_keterangan

  function do_ajax_form_tbobat_mob_validate_keterangan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbobat_mob_validate_keterangan_cb

  // ---------- Validate id_fornas
  function do_ajax_form_tbobat_mob_validate_id_fornas()
  {
    var nomeCampo_id_fornas = "id_fornas";
    var var_id_fornas = scAjaxGetFieldSelect(nomeCampo_id_fornas);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbobat_mob_validate_id_fornas(var_id_fornas, var_script_case_init, do_ajax_form_tbobat_mob_validate_id_fornas_cb);
  } // do_ajax_form_tbobat_mob_validate_id_fornas

  function do_ajax_form_tbobat_mob_validate_id_fornas_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbobat_mob_validate_id_fornas_cb

  // ---------- Validate stock
  function do_ajax_form_tbobat_mob_validate_stock()
  {
    var nomeCampo_stock = "stock";
    var var_stock = scAjaxGetFieldText(nomeCampo_stock);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbobat_mob_validate_stock(var_stock, var_script_case_init, do_ajax_form_tbobat_mob_validate_stock_cb);
  } // do_ajax_form_tbobat_mob_validate_stock

  function do_ajax_form_tbobat_mob_validate_stock_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "stock";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbobat_mob_validate_stock_cb

  // ---------- Validate margin
  function do_ajax_form_tbobat_mob_validate_margin()
  {
    var nomeCampo_margin = "margin";
    var var_margin = scAjaxGetFieldText(nomeCampo_margin);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbobat_mob_validate_margin(var_margin, var_script_case_init, do_ajax_form_tbobat_mob_validate_margin_cb);
  } // do_ajax_form_tbobat_mob_validate_margin

  function do_ajax_form_tbobat_mob_validate_margin_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "margin";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbobat_mob_validate_margin_cb

  // ---------- Validate grid_his_buy
  function do_ajax_form_tbobat_mob_validate_grid_his_buy()
  {
    var nomeCampo_grid_his_buy = "grid_his_buy";
    var var_grid_his_buy = scAjaxGetFieldText(nomeCampo_grid_his_buy);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbobat_mob_validate_grid_his_buy(var_grid_his_buy, var_script_case_init, do_ajax_form_tbobat_mob_validate_grid_his_buy_cb);
  } // do_ajax_form_tbobat_mob_validate_grid_his_buy

  function do_ajax_form_tbobat_mob_validate_grid_his_buy_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbobat_mob_validate_grid_his_buy_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tbobat_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tbobat_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_tbobat_mob_submit_form(var_kodeitem, var_namaitem, var_jenisbarang, var_stokminimal, var_max, var_satuanterkecil, var_aktif, var_hargajual, var_kemasanbeli, var_satuanisi, var_generik, var_paten, var_keterangan, var_id_fornas, var_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbobat_mob_submit_form_cb);
  } // do_ajax_form_tbobat_mob_submit_form

  function do_ajax_form_tbobat_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tbobat_mob_submit_form_cb_after_alert);
  } // do_ajax_form_tbobat_mob_submit_form_cb
  function do_ajax_form_tbobat_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbobat_mob_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_tbstockobat_mob"] = "off";
  scStatusDetail["form_tbdetailmargin_mob"] = "off";
  scStatusDetail["grid_his_obat"] = "off";

  function do_ajax_form_tbobat_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    scStatusDetail["form_tbstockobat_mob"] = "on";
    scStatusDetail["form_tbdetailmargin_mob"] = "on";
    scStatusDetail["grid_his_obat"] = "on";
    x_ajax_form_tbobat_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbobat_mob_navigate_form_cb);
  } // do_ajax_form_tbobat_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbobat_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_tbstockobat_mob"] && "nmsc_iframe_liga_form_tbstockobat_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_tbstockobat_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_tbstockobat_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_tbstockobat_mob').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_tbstockobat_mob').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_tbstockobat_mob').style.display = "none";
    }
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_tbdetailmargin_mob"] && "nmsc_iframe_liga_form_tbdetailmargin_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_tbdetailmargin_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_tbdetailmargin_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_tbdetailmargin_mob').contentWindow.nm_move('apl_detalhe', true, '500');
        document.getElementById('nmsc_iframe_liga_form_tbdetailmargin_mob').style.height = "500";
        document.getElementById('nmsc_iframe_liga_form_tbdetailmargin_mob').style.display = "none";
    }
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbobat_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_tbobat_mob_navigate_form_cb
  function do_ajax_form_tbobat_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_tbobat_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
    scAjaxProcOff();
  } // do_ajax_form_tbobat_mob_navigate_form_cb_after_alert
  function sc_hide_form_tbobat_mob_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_tbstockobat_mob"] && "off" == scStatusDetail["form_tbdetailmargin_mob"] && "off" == scStatusDetail["grid_his_obat"])
    {
      return true;
    }
    return false;
