...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['embutida_pdf']))
 {
 ?>
...
<?php
include_once("form_tbobat_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_tbobat_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
?>
...
<?php
 include_once("form_tbobat_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_tbobat'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_tbobat'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['fast_search'][2] : "";
?> 
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['run_iframe'] != "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['run_iframe'] == "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_kodeitem_label" id="hidden_field_label_kodeitem" style="<?php echo $sStyleHidden_kodeitem; ?>"><span id="id_label_kodeitem"><?php echo $this->nm_new_label['kodeitem']; ?></span></TD>
    <TD class="scFormDataOdd css_kodeitem_line" id="hidden_field_data_kodeitem" style="<?php echo $sStyleHidden_kodeitem; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_kodeitem_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_namaitem_label" id="hidden_field_label_namaitem" style="<?php echo $sStyleHidden_namaitem; ?>"><span id="id_label_namaitem"><?php echo $this->nm_new_label['namaitem']; ?></span></TD>
    <TD class="scFormDataOdd css_namaitem_line" id="hidden_field_data_namaitem" style="<?php echo $sStyleHidden_namaitem; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_namaitem_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_jenisbarang_label" id="hidden_field_label_jenisbarang" style="<?php echo $sStyleHidden_jenisbarang; ?>"><span id="id_label_jenisbarang"><?php echo $this->nm_new_label['jenisbarang']; ?></span></TD>
    <TD class="scFormDataOdd css_jenisbarang_line" id="hidden_field_data_jenisbarang" style="<?php echo $sStyleHidden_jenisbarang; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_jenisbarang_line" style="vertical-align: top;padding: 0px">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['Lookup_jenisbarang'][] = ''; ?>
 <option value=""></option>
 <option  value="OBAT" <?php  if ($this->jenisbarang == "OBAT") { echo " selected" ;} ?>>OBAT</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['Lookup_jenisbarang'][] = 'OBAT'; ?>
 <option  value="ALKES" <?php  if ($this->jenisbarang == "ALKES") { echo " selected" ;} ?>>ALKES</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['Lookup_jenisbarang'][] = 'ALKES'; ?>
 <option  value="LAB" <?php  if ($this->jenisbarang == "LAB") { echo " selected" ;} ?>>LAB</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['Lookup_jenisbarang'][] = 'LAB'; ?>
 <option  value="DENTAL" <?php  if ($this->jenisbarang == "DENTAL") { echo " selected" ;} ?>>DENTAL</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['Lookup_jenisbarang'][] = 'DENTAL'; ?>
 </select></span>
</span><?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_stokminimal_label" id="hidden_field_label_stokminimal" style="<?php echo $sStyleHidden_stokminimal; ?>"><span id="id_label_stokminimal"><?php echo $this->nm_new_label['stokminimal']; ?></span></TD>
    <TD class="scFormDataOdd css_stokminimal_line" id="hidden_field_data_stokminimal" style="<?php echo $sStyleHidden_stokminimal; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_stokminimal_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_max_label" id="hidden_field_label_max" style="<?php echo $sStyleHidden_max; ?>"><span id="id_label_max"><?php echo $this->nm_new_label['max']; ?></span></TD>
    <TD class="scFormDataOdd css_max_line" id="hidden_field_data_max" style="<?php echo $sStyleHidden_max; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_max_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_satuanterkecil_label" id="hidden_field_label_satuanterkecil" style="<?php echo $sStyleHidden_satuanterkecil; ?>"><span id="id_label_satuanterkecil"><?php echo $this->nm_new_label['satuanterkecil']; ?></span></TD>
    <TD class="scFormDataOdd css_satuanterkecil_line" id="hidden_field_data_satuanterkecil" style="<?php echo $sStyleHidden_satuanterkecil; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_satuanterkecil_line" style="vertical-align: top;padding: 0px">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['Lookup_aktif'][] = 'Y'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['Lookup_aktif'][] = 'N'; ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_hargajual_label" id="hidden_field_label_hargajual" style="<?php echo $sStyleHidden_hargajual; ?>"><span id="id_label_hargajual"><?php echo $this->nm_new_label['hargajual']; ?></span></TD>
    <TD class="scFormDataOdd css_hargajual_line" id="hidden_field_data_hargajual" style="<?php echo $sStyleHidden_hargajual; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_hargajual_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_kemasanbeli_label" id="hidden_field_label_kemasanbeli" style="<?php echo $sStyleHidden_kemasanbeli; ?>"><span id="id_label_kemasanbeli"><?php echo $this->nm_new_label['kemasanbeli']; ?></span></TD>
    <TD class="scFormDataOdd css_kemasanbeli_line" id="hidden_field_data_kemasanbeli" style="<?php echo $sStyleHidden_kemasanbeli; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_kemasanbeli_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_satuanisi_label" id="hidden_field_label_satuanisi" style="<?php echo $sStyleHidden_satuanisi; ?>"><span id="id_label_satuanisi"><?php echo $this->nm_new_label['satuanisi']; ?></span></TD>
    <TD class="scFormDataOdd css_satuanisi_line" id="hidden_field_data_satuanisi" style="<?php echo $sStyleHidden_satuanisi; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_satuanisi_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_generik_label" id="hidden_field_label_generik" style="<?php echo $sStyleHidden_generik; ?>"><span id="id_label_generik"><?php echo $this->nm_new_label['generik']; ?></span></TD>
    <TD class="scFormDataOdd css_generik_line" id="hidden_field_data_generik" style="<?php echo $sStyleHidden_generik; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_generik_line" style="vertical-align: top;padding: 0px">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['Lookup_generik'][] = ''; ?>
 <option value=""></option>
 <option  value="1" <?php  if ($this->generik == "1") { echo " selected" ;} ?>>Ya</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['Lookup_generik'][] = '1'; ?>
 <option  value="0" <?php  if ($this->generik == "0") { echo " selected" ;} ?>>Tidak</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['Lookup_generik'][] = '0'; ?>
 </select></span>
</span><?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_paten_label" id="hidden_field_label_paten" style="<?php echo $sStyleHidden_paten; ?>"><span id="id_label_paten"><?php echo $this->nm_new_label['paten']; ?></span></TD>
    <TD class="scFormDataOdd css_paten_line" id="hidden_field_data_paten" style="<?php echo $sStyleHidden_paten; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_paten_line" style="vertical-align: top;padding: 0px">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['Lookup_paten'][] = '1'; ?>
 <option  value="0" <?php  if ($this->paten == "0") { echo " selected" ;} ?>>Tidak</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['Lookup_paten'][] = '0'; ?>
 </select></span>
</span><?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_id_fornas_label" id="hidden_field_label_id_fornas" style="<?php echo $sStyleHidden_id_fornas; ?>"><span id="id_label_id_fornas"><?php echo $this->nm_new_label['id_fornas']; ?></span></TD>
    <TD class="scFormDataOdd css_id_fornas_line" id="hidden_field_data_id_fornas" style="<?php echo $sStyleHidden_id_fornas; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_id_fornas_line" style="vertical-align: top;padding: 0px">
...
<ul class="scTabLine">
<li id="id_tabs_3_3" class="scTabActive"><a href="javascript: sc_control_tabs_3(3)">Stock</a></li>
<li id="id_tabs_3_4" class="scTabInactive"><a href="javascript: sc_control_tabs_3(4)">Margin</a></li>
<li id="id_tabs_3_5" class="scTabInactive"><a href="javascript: sc_control_tabs_3(5)">History Harga</a></li>
</ul>
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_Stock'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_Stock'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['form_tbstockobat_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_Stock'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['form_tbstockobat_script_case_init'] = $this->Ini->sc_page;
 }
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['form_tbstockobat_script_case_init'] ]['form_tbstockobat']['embutida_proc']  = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['form_tbstockobat_script_case_init'] ]['form_tbstockobat']['embutida_form']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['form_tbstockobat_script_case_init'] ]['form_tbstockobat']['embutida_call']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['form_tbstockobat_script_case_init'] ]['form_tbstockobat']['embutida_multi'] = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['form_tbstockobat_script_case_init'] ]['form_tbstockobat']['embutida_liga_form_insert'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['form_tbstockobat_script_case_init'] ]['form_tbstockobat']['embutida_liga_form_update'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['form_tbstockobat_script_case_init'] ]['form_tbstockobat']['embutida_liga_form_delete'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['form_tbstockobat_script_case_init'] ]['form_tbstockobat']['embutida_liga_form_btn_nav'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['form_tbstockobat_script_case_init'] ]['form_tbstockobat']['embutida_liga_grid_edit'] = '';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['form_tbstockobat_script_case_init'] ]['form_tbstockobat']['embutida_liga_grid_edit_link'] = '';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['form_tbstockobat_script_case_init'] ]['form_tbstockobat']['embutida_liga_qtd_reg'] = '10';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['form_tbstockobat_script_case_init'] ]['form_tbstockobat']['embutida_liga_tp_pag'] = 'parcial';
 ...
 if ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['form_tbstockobat_script_case_init'] ]['form_tbobat']['total'] < 0)
 {
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_tbobat_empty.htm' : $this->Ini->link_form_tbstockobat_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_session=' . session_id() . '&script_case_detail=Y';
if (isset($this->Ini->sc_lig_target['C_@scinf_Stock']) && 'nmsc_iframe_liga_form_tbstockobat' != $this->Ini->sc_lig_target['C_@scinf_Stock'])
{
    if ('novo' != $this->nmgp_opcao)
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_Stock'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['form_tbstockobat_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
{
?>
<iframe border="0" id="nmsc_iframe_liga_form_tbstockobat"  marginWidth="0" marginHeight="0" frameborder="0" valign="top" height="100" width="100%" name="nmsc_iframe_liga_form_tbstockobat"  scrolling="auto" src="<?php echo $sDetailSrc; ?>"></iframe>
<?php
}
?>
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_margin'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_margin'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['form_tbdetailmargin_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_margin'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['form_tbdetailmargin_script_case_init'] = $this->Ini->sc_page;
 }
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['form_tbdetailmargin_script_case_init'] ]['form_tbdetailmargin']['embutida_proc']  = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['form_tbdetailmargin_script_case_init'] ]['form_tbdetailmargin']['embutida_form']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['form_tbdetailmargin_script_case_init'] ]['form_tbdetailmargin']['embutida_call']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['form_tbdetailmargin_script_case_init'] ]['form_tbdetailmargin']['embutida_multi'] = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['form_tbdetailmargin_script_case_init'] ]['form_tbdetailmargin']['embutida_liga_form_insert'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['form_tbdetailmargin_script_case_init'] ]['form_tbdetailmargin']['embutida_liga_form_update'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['form_tbdetailmargin_script_case_init'] ]['form_tbdetailmargin']['embutida_liga_form_delete'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['form_tbdetailmargin_script_case_init'] ]['form_tbdetailmargin']['embutida_liga_form_btn_nav'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['form_tbdetailmargin_script_case_init'] ]['form_tbdetailmargin']['embutida_liga_grid_edit'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['form_tbdetailmargin_script_case_init'] ]['form_tbdetailmargin']['embutida_liga_grid_edit_link'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['form_tbdetailmargin_script_case_init'] ]['form_tbdetailmargin']['embutida_liga_qtd_reg'] = '10';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['form_tbdetailmargin_script_case_init'] ]['form_tbdetailmargin']['embutida_liga_tp_pag'] = 'parcial';
 ...
 if ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['form_tbdetailmargin_script_case_init'] ]['form_tbobat']['total'] < 0)
 {
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_tbobat_empty.htm' : $this->Ini->link_form_tbdetailmargin_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_session=' . session_id() . '&script_case_detail=Y&sc_ifr_height=500';
if (isset($this->Ini->sc_lig_target['C_@scinf_margin']) && 'nmsc_iframe_liga_form_tbdetailmargin' != $this->Ini->sc_lig_target['C_@scinf_margin'])
{
    if ('novo' != $this->nmgp_opcao)
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_margin'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['form_tbdetailmargin_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
{
?>
<iframe border="0" id="nmsc_iframe_liga_form_tbdetailmargin"  marginWidth="0" marginHeight="0" frameborder="0" valign="top" height="500" width="100%" name="nmsc_iframe_liga_form_tbdetailmargin"  scrolling="auto" src="<?php echo $sDetailSrc; ?>"></iframe>
<?php
}
?>
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_grid_his_buy'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_grid_his_buy'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['grid_his_obat_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_grid_his_buy'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['grid_his_obat_script_case_init'] = $this->Ini->sc_page;
 }
 ...
 if (isset($this->Ini->sc_lig_md5["grid_his_obat"]) && $this->Ini->sc_lig_md5["grid_his_obat"] == "S") {
     ...
     $Md5_Lig    = "@SC_par@" . $this->form_encode_input($this->Ini->sc_page) . "@SC_par@form_tbobat@SC_par@" . md5($Parms_Lig);
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['Lig_Md5'][md5($Parms_Lig)] = $Parms_Lig;
 } else {
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_tbobat_empty.htm' : $this->Ini->link_grid_his_obat_cons . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_session=' . session_id() . '&script_case_detail=Y&sc_ifr_height=1000' . $parms_lig_cons;
if (isset($this->Ini->sc_lig_target['C_@scinf_grid_his_buy']) && 'nmsc_iframe_liga_grid_his_obat' != $this->Ini->sc_lig_target['C_@scinf_grid_his_buy'])
{
    if ('novo' != $this->nmgp_opcao)
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_grid_his_buy'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['grid_his_obat_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_tbobat");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_tbobat");
 parent.scAjaxDetailHeight("form_tbobat", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
