  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbobat" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbobat_form();
	}

  // ---------- Validate kodeitem
  function do_ajax_form_tbobat_validate_kodeitem()
  {
    var nomeCampo_kodeitem = "kodeitem";
    var var_kodeitem = scAjaxGetFieldText(nomeCampo_kodeitem);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbobat_validate_kodeitem(var_kodeitem, var_script_case_init, do_ajax_form_tbobat_validate_kodeitem_cb);
  } // do_ajax_form_tbobat_validate_kodeitem

  function do_ajax_form_tbobat_validate_kodeitem_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "kodeitem";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbobat_validate_kodeitem_cb

  // ---------- Validate namaitem
  function do_ajax_form_tbobat_validate_namaitem()
  {
    var nomeCampo_namaitem = "namaitem";
    var var_namaitem = scAjaxGetFieldText(nomeCampo_namaitem);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbobat_validate_namaitem(var_namaitem, var_script_case_init, do_ajax_form_tbobat_validate_namaitem_cb);
  } // do_ajax_form_tbobat_validate_namaitem

  function do_ajax_form_tbobat_validate_namaitem_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "namaitem";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbobat_validate_namaitem_cb

  // ---------- Validate jenisbarang
  function do_ajax_form_tbobat_validate_jenisbarang()
  {
    var nomeCampo_jenisbarang = "jenisbarang";
    var var_jenisbarang = scAjaxGetFieldSelect(nomeCampo_jenisbarang);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbobat_validate_jenisbarang(var_jenisbarang, var_script_case_init, do_ajax_form_tbobat_validate_jenisbarang_cb);
  } // do_ajax_form_tbobat_validate_jenisbarang

  function do_ajax_form_tbobat_validate_jenisbarang_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "jenisbarang";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbobat_validate_jenisbarang_cb

  // ---------- Validate stokminimal
  function do_ajax_form_tbobat_validate_stokminimal()
  {
    var nomeCampo_stokminimal = "stokminimal";
    var var_stokminimal = scAjaxGetFieldText(nomeCampo_stokminimal);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbobat_validate_stokminimal(var_stokminimal, var_script_case_init, do_ajax_form_tbobat_validate_stokminimal_cb);
  } // do_ajax_form_tbobat_validate_stokminimal

  function do_ajax_form_tbobat_validate_stokminimal_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "stokminimal";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbobat_validate_stokminimal_cb

  // ---------- Validate max
  function do_ajax_form_tbobat_validate_max()
  {
    var nomeCampo_max = "max";
    var var_max = scAjaxGetFieldText(nomeCampo_max);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbobat_validate_max(var_max, var_script_case_init, do_ajax_form_tbobat_validate_max_cb);
  } // do_ajax_form_tbobat_validate_max

  function do_ajax_form_tbobat_validate_max_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "max";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbobat_validate_max_cb

  // ---------- Validate satuanterkecil
  function do_ajax_form_tbobat_validate_satuanterkecil()
  {
    var nomeCampo_satuanterkecil = "satuanterkecil";
    var var_satuanterkecil = scAjaxGetFieldSelect(nomeCampo_satuanterkecil);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbobat_validate_satuanterkecil(var_satuanterkecil, var_script_case_init, do_ajax_form_tbobat_validate_satuanterkecil_cb);
  } // do_ajax_form_tbobat_validate_satuanterkecil

  function do_ajax_form_tbobat_validate_satuanterkecil_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "satuanterkecil";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbobat_validate_satuanterkecil_cb

  // ---------- Validate aktif
  function do_ajax_form_tbobat_validate_aktif()
  {
    var nomeCampo_aktif = "aktif";
    var var_aktif = scAjaxGetFieldRadio(nomeCampo_aktif);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbobat_validate_aktif(var_aktif, var_script_case_init, do_ajax_form_tbobat_validate_aktif_cb);
  } // do_ajax_form_tbobat_validate_aktif

  function do_ajax_form_tbobat_validate_aktif_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "aktif";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbobat_validate_aktif_cb

  // ---------- Validate hargajual
  function do_ajax_form_tbobat_validate_hargajual()
  {
    var nomeCampo_hargajual = "hargajual";
    var var_hargajual = scAjaxGetFieldText(nomeCampo_hargajual);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbobat_validate_hargajual(var_hargajual, var_script_case_init, do_ajax_form_tbobat_validate_hargajual_cb);
  } // do_ajax_form_tbobat_validate_hargajual

  function do_ajax_form_tbobat_validate_hargajual_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "hargajual";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbobat_validate_hargajual_cb

  // ---------- Validate kemasanbeli
  function do_ajax_form_tbobat_validate_kemasanbeli()
  {
    var nomeCampo_kemasanbeli = "kemasanbeli";
    var var_kemasanbeli = scAjaxGetFieldSelect(nomeCampo_kemasanbeli);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbobat_validate_kemasanbeli(var_kemasanbeli, var_script_case_init, do_ajax_form_tbobat_validate_kemasanbeli_cb);
  } // do_ajax_form_tbobat_validate_kemasanbeli

  function do_ajax_form_tbobat_validate_kemasanbeli_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "kemasanbeli";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbobat_validate_kemasanbeli_cb

  // ---------- Validate satuanisi
  function do_ajax_form_tbobat_validate_satuanisi()
  {
    var nomeCampo_satuanisi = "satuanisi";
    var var_satuanisi = scAjaxGetFieldText(nomeCampo_satuanisi);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbobat_validate_satuanisi(var_satuanisi, var_script_case_init, do_ajax_form_tbobat_validate_satuanisi_cb);
  } // do_ajax_form_tbobat_validate_satuanisi

  function do_ajax_form_tbobat_validate_satuanisi_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "satuanisi";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbobat_validate_satuanisi_cb

  // ---------- Validate generik
  function do_ajax_form_tbobat_validate_generik()
  {
    var nomeCampo_generik = "generik";
    var var_generik = scAjaxGetFieldSelect(nomeCampo_generik);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbobat_validate_generik(var_generik, var_script_case_init, do_ajax_form_tbobat_validate_generik_cb);
  } // do_ajax_form_tbobat_validate_generik

  function do_ajax_form_tbobat_validate_generik_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "generik";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbobat_validate_generik_cb

  // ---------- Validate paten
  function do_ajax_form_tbobat_validate_paten()
  {
    var nomeCampo_paten = "paten";
    var var_paten = scAjaxGetFieldSelect(nomeCampo_paten);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbobat_validate_paten(var_paten, var_script_case_init, do_ajax_form_tbobat_validate_paten_cb);
  } // do_ajax_form_tbobat_validate_paten

  function do_ajax_form_tbobat_validate_paten_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "paten";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbobat_validate_paten_cb

  // ---------- Validate keterangan
  function do_ajax_form_tbobat_validate_keterangan()
  {
    var nomeCampo_keterangan = "keterangan";
    var var_keterangan = scAjaxGetFieldText(nomeCampo_keterangan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbobat_validate_keterangan(var_keterangan, var_script_case_init, do_ajax_form_tbobat_validate_keterangan_cb);
  } // do_ajax_form_tbobat_validate_keterangan

  function do_ajax_form_tbobat_validate_keterangan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbobat_validate_keterangan_cb

  // ---------- Validate id_fornas
  function do_ajax_form_tbobat_validate_id_fornas()
  {
    var nomeCampo_id_fornas = "id_fornas";
    var var_id_fornas = scAjaxGetFieldSelect(nomeCampo_id_fornas);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbobat_validate_id_fornas(var_id_fornas, var_script_case_init, do_ajax_form_tbobat_validate_id_fornas_cb);
  } // do_ajax_form_tbobat_validate_id_fornas

  function do_ajax_form_tbobat_validate_id_fornas_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id_fornas";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbobat_validate_id_fornas_cb

  // ---------- Validate stock
  function do_ajax_form_tbobat_validate_stock()
  {
    var nomeCampo_stock = "stock";
    var var_stock = scAjaxGetFieldText(nomeCampo_stock);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbobat_validate_stock(var_stock, var_script_case_init, do_ajax_form_tbobat_validate_stock_cb);
  } // do_ajax_form_tbobat_validate_stock

  function do_ajax_form_tbobat_validate_stock_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "stock";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbobat_validate_stock_cb

  // ---------- Validate margin
  function do_ajax_form_tbobat_validate_margin()
  {
    var nomeCampo_margin = "margin";
    var var_margin = scAjaxGetFieldText(nomeCampo_margin);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbobat_validate_margin(var_margin, var_script_case_init, do_ajax_form_tbobat_validate_margin_cb);
  } // do_ajax_form_tbobat_validate_margin

  function do_ajax_form_tbobat_validate_margin_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "margin";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbobat_validate_margin_cb

  // ---------- Validate grid_his_buy
  function do_ajax_form_tbobat_validate_grid_his_buy()
  {
    var nomeCampo_grid_his_buy = "grid_his_buy";
    var var_grid_his_buy = scAjaxGetFieldText(nomeCampo_grid_his_buy);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbobat_validate_grid_his_buy(var_grid_his_buy, var_script_case_init, do_ajax_form_tbobat_validate_grid_his_buy_cb);
  } // do_ajax_form_tbobat_validate_grid_his_buy

  function do_ajax_form_tbobat_validate_grid_his_buy_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "grid_his_buy";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbobat_validate_grid_his_buy_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tbobat_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tbobat_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_kodeitem = scAjaxGetFieldText("kodeitem");
    var var_namaitem = scAjaxGetFieldText("namaitem");
    var var_jenisbarang = scAjaxGetFieldSelect("jenisbarang");
    var var_stokminimal = scAjaxGetFieldText("stokminimal");
    var var_max = scAjaxGetFieldText("max");
    var var_satuanterkecil = scAjaxGetFieldSelect("satuanterkecil");
    var var_aktif = scAjaxGetFieldRadio("aktif");
    var var_hargajual = scAjaxGetFieldText("hargajual");
    var var_kemasanbeli = scAjaxGetFieldSelect("kemasanbeli");
    var var_satuanisi = scAjaxGetFieldText("satuanisi");
    var var_generik = scAjaxGetFieldSelect("generik");
    var var_paten = scAjaxGetFieldSelect("paten");
    var var_keterangan = scAjaxGetFieldText("keterangan");
    var var_id_fornas = scAjaxGetFieldSelect("id_fornas");
    ...
    scAjaxProcOn();
    x_ajax_form_tbobat_submit_form(var_kodeitem, var_namaitem, var_jenisbarang, var_stokminimal, var_max, var_satuanterkecil, var_aktif, var_hargajual, var_kemasanbeli, var_satuanisi, var_generik, var_paten, var_keterangan, var_id_fornas, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbobat_submit_form_cb);
  } // do_ajax_form_tbobat_submit_form

  function do_ajax_form_tbobat_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("kodeitem");
      scAjaxHideErrorDisplay("namaitem");
      scAjaxHideErrorDisplay("jenisbarang");
      scAjaxHideErrorDisplay("stokminimal");
      scAjaxHideErrorDisplay("max");
      scAjaxHideErrorDisplay("satuanterkecil");
      scAjaxHideErrorDisplay("aktif");
      scAjaxHideErrorDisplay("hargajual");
      scAjaxHideErrorDisplay("kemasanbeli");
      scAjaxHideErrorDisplay("satuanisi");
      scAjaxHideErrorDisplay("generik");
      scAjaxHideErrorDisplay("paten");
      scAjaxHideErrorDisplay("keterangan");
      scAjaxHideErrorDisplay("id_fornas");
      scAjaxHideErrorDisplay("stock");
      scAjaxHideErrorDisplay("margin");
      scAjaxHideErrorDisplay("grid_his_buy");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tbobat_submit_form_cb_after_alert);
  } // do_ajax_form_tbobat_submit_form_cb
  function do_ajax_form_tbobat_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbobat_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_tbstockobat"] = "off";
  scStatusDetail["form_tbdetailmargin"] = "off";
  scStatusDetail["grid_his_obat"] = "off";

  function do_ajax_form_tbobat_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    scStatusDetail["form_tbstockobat"] = "on";
    scStatusDetail["form_tbdetailmargin"] = "on";
    scStatusDetail["grid_his_obat"] = "on";
    x_ajax_form_tbobat_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbobat_navigate_form_cb);
  } // do_ajax_form_tbobat_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbobat']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbobat_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_tbstockobat"] && "nmsc_iframe_liga_form_tbstockobat" != scMasterDetailIframe["nmsc_iframe_liga_form_tbstockobat"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_tbstockobat"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_tbstockobat').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_tbstockobat').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_tbstockobat').style.display = "none";
    }
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_tbdetailmargin"] && "nmsc_iframe_liga_form_tbdetailmargin" != scMasterDetailIframe["nmsc_iframe_liga_form_tbdetailmargin"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_tbdetailmargin"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_tbdetailmargin').contentWindow.nm_move('apl_detalhe', true, '500');
        document.getElementById('nmsc_iframe_liga_form_tbdetailmargin').style.height = "500";
        document.getElementById('nmsc_iframe_liga_form_tbdetailmargin').style.display = "none";
    }
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_grid_his_obat"] && "nmsc_iframe_liga_grid_his_obat" != scMasterDetailIframe["nmsc_iframe_liga_grid_his_obat"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_grid_his_obat"]);
    }
    else {
        if (oResp["navSummary"].reg_tot != 0) {
            document.getElementById('nmsc_iframe_liga_grid_his_obat').contentWindow.nm_move('apl_detalhe', true, '1000');
        }
    }
    scAjaxSetBtnVars();
    ...
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbobat_navigate_form_cb_after_alert);
  } // do_ajax_form_tbobat_navigate_form_cb
  function do_ajax_form_tbobat_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_tbobat_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    scAjaxProcOff();
  } // do_ajax_form_tbobat_navigate_form_cb_after_alert
  function sc_hide_form_tbobat_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_tbstockobat"] && "off" == scStatusDetail["form_tbdetailmargin"] && "off" == scStatusDetail["grid_his_obat"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[0] = "kodeitem";
  ajax_field_list[1] = "namaitem";
  ajax_field_list[2] = "jenisbarang";
  ajax_field_list[3] = "stokminimal";
  ajax_field_list[4] = "max";
  ajax_field_list[5] = "satuanterkecil";
  ajax_field_list[6] = "aktif";
  ajax_field_list[7] = "hargajual";
  ajax_field_list[8] = "kemasanbeli";
  ajax_field_list[9] = "satuanisi";
  ajax_field_list[10] = "generik";
  ajax_field_list[11] = "paten";
  ajax_field_list[12] = "keterangan";
  ajax_field_list[13] = "id_fornas";
  ajax_field_list[14] = "stock";
  ajax_field_list[15] = "margin";
  ajax_field_list[16] = "grid_his_buy";
  ...
  var ajax_error_list = {
    "kodeitem": {"label": "Kode Item", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "namaitem": {"label": "Nama Item", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "jenisbarang": {"label": "Jenis Barang", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "stokminimal": {"label": "Stok Minimal", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "max": {"label": "Stok Maks", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "satuanterkecil": {"label": "Satuan Terkecil", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "aktif": {"label": "Aktif ?", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "hargajual": {"label": "Harga Jual", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "kemasanbeli": {"label": "Kemasan Box", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "satuanisi": {"label": "Satuan Isi", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "generik": {"label": "Generik", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "paten": {"label": "Paten", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "id_fornas": {"label": "Fornas", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "stock": {"label": "Stock", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "margin": {"label": "", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "grid_his_buy": {"label": "grid_his_buy", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "kodeitem": new Array(),
    "namaitem": new Array(),
    "jenisbarang": new Array(),
    "stokminimal": new Array(),
    "max": new Array(),
    "satuanterkecil": new Array(),
    "aktif": new Array(),
    "hargajual": new Array(),
    "kemasanbeli": new Array(),
    "satuanisi": new Array(),
    "generik": new Array(),
    "paten": new Array(),
    ...
    "stock": new Array(),
    "margin": new Array(),
    "grid_his_buy": new Array()
  };
  ajax_field_mult["kodeitem"][1] = "kodeitem";
  ajax_field_mult["namaitem"][1] = "namaitem";
  ajax_field_mult["jenisbarang"][1] = "jenisbarang";
  ajax_field_mult["stokminimal"][1] = "stokminimal";
  ajax_field_mult["max"][1] = "max";
  ajax_field_mult["satuanterkecil"][1] = "satuanterkecil";
  ajax_field_mult["aktif"][1] = "aktif";
  ajax_field_mult["hargajual"][1] = "hargajual";
  ajax_field_mult["kemasanbeli"][1] = "kemasanbeli";
  ajax_field_mult["satuanisi"][1] = "satuanisi";
  ajax_field_mult["generik"][1] = "generik";
  ajax_field_mult["paten"][1] = "paten";
  ajax_field_mult["keterangan"][1] = "keterangan";
  ajax_field_mult["id_fornas"][1] = "id_fornas";
  ajax_field_mult["stock"][1] = "stock";
  ajax_field_mult["margin"][1] = "margin";
  ajax_field_mult["grid_his_buy"][1] = "grid_his_buy";

  var ajax_field_id = {
    "kodeitem": new Array("hidden_field_label_kodeitem", "hidden_field_data_kodeitem"),
    "namaitem": new Array("hidden_field_label_namaitem", "hidden_field_data_namaitem"),
    "jenisbarang": new Array("hidden_field_label_jenisbarang", "hidden_field_data_jenisbarang"),
    "stokminimal": new Array("hidden_field_label_stokminimal", "hidden_field_data_stokminimal"),
    "max": new Array("hidden_field_label_max", "hidden_field_data_max"),
    "satuanterkecil": new Array("hidden_field_label_satuanterkecil", "hidden_field_data_satuanterkecil"),
    "aktif": new Array("hidden_field_label_aktif", "hidden_field_data_aktif"),
    "hargajual": new Array("hidden_field_label_hargajual", "hidden_field_data_hargajual"),
    "kemasanbeli": new Array("hidden_field_label_kemasanbeli", "hidden_field_data_kemasanbeli"),
    "satuanisi": new Array("hidden_field_label_satuanisi", "hidden_field_data_satuanisi"),
    "generik": new Array("hidden_field_label_generik", "hidden_field_data_generik"),
    "paten": new Array("hidden_field_label_paten", "hidden_field_data_paten"),
    "keterangan": new Array("hidden_field_label_keterangan", "hidden_field_data_keterangan"),
    "id_fornas": new Array("hidden_field_label_id_fornas", "hidden_field_data_id_fornas"),
    "stock": new Array("hidden_field_label_stock", "hidden_field_data_stock"),
    "margin": new Array("hidden_field_label_margin", "hidden_field_data_margin"),
    "grid_his_buy": new Array("hidden_field_label_grid_his_buy", "hidden_field_data_grid_his_buy")
  };
