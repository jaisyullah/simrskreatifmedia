<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tbreqitemHis']['sc_process_barr'] = true;
require_once('../grid_tbreqitemHis/index.php');
unset($_SESSION['scriptcase']['grid_tbreqitemHis']['sc_process_barr']);
$ExportCtrl = new grid_tbreqitemHis_export_control;
$ExportCtrl->Export_barr();

class grid_tbreqitemHis_export_control
{
