<?php
@session_start() ;
$_SESSION['scriptcase']['grid_bybayar_poli']['sc_process_barr'] = true;
require_once('../grid_bybayar_poli/index.php');
unset($_SESSION['scriptcase']['grid_bybayar_poli']['sc_process_barr']);
$ExportCtrl = new grid_bybayar_poli_export_control;
$ExportCtrl->Export_barr();

class grid_bybayar_poli_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_title'] ?> Statistik Rawat Jalan :: Excel</TITLE>
