...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_jam_hora' + iSeqRow).bind('blur', function() { sc_form_akun_header_jam_onblur(this, iSeqRow) })
                                      .bind('focus', function() { sc_form_akun_header_jam_onfocus(this, iSeqRow) });
} // scJQEventsAdd
...
function scHidePage(pageNo) {
	$("#id_form_akun_header_mob_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_jam" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_akun_header_mob_validate_jam(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
