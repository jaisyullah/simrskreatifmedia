  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_akun_header" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_akun_header_form();
	}

  // ---------- Validate id
  function do_ajax_form_akun_header_validate_id()
  {
    var nomeCampo_id = "id";
    var var_id = scAjaxGetFieldText(nomeCampo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_akun_header_validate_id(var_id, var_script_case_init, do_ajax_form_akun_header_validate_id_cb);
  } // do_ajax_form_akun_header_validate_id

  function do_ajax_form_akun_header_validate_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_akun_header_validate_id_cb

  // ---------- Validate nama
  function do_ajax_form_akun_header_validate_nama()
  {
    var nomeCampo_nama = "nama";
    var var_nama = scAjaxGetFieldText(nomeCampo_nama);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_akun_header_validate_nama(var_nama, var_script_case_init, do_ajax_form_akun_header_validate_nama_cb);
  } // do_ajax_form_akun_header_validate_nama

  function do_ajax_form_akun_header_validate_nama_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nama";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_akun_header_validate_nama_cb

  // ---------- Validate grupid
  function do_ajax_form_akun_header_validate_grupid()
  {
    var nomeCampo_grupid = "grupid";
    var var_grupid = scAjaxGetFieldText(nomeCampo_grupid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_akun_header_validate_grupid(var_grupid, var_script_case_init, do_ajax_form_akun_header_validate_grupid_cb);
  } // do_ajax_form_akun_header_validate_grupid

  function do_ajax_form_akun_header_validate_grupid_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "grupid";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_akun_header_validate_grupid_cb

  // ---------- Validate jenis
  function do_ajax_form_akun_header_validate_jenis()
  {
    var nomeCampo_jenis = "jenis";
    var var_jenis = scAjaxGetFieldText(nomeCampo_jenis);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_akun_header_validate_jenis(var_jenis, var_script_case_init, do_ajax_form_akun_header_validate_jenis_cb);
  } // do_ajax_form_akun_header_validate_jenis

  function do_ajax_form_akun_header_validate_jenis_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "jenis";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_akun_header_validate_jenis_cb

  // ---------- Validate modal
  function do_ajax_form_akun_header_validate_modal()
  {
    var nomeCampo_modal = "modal";
    var var_modal = scAjaxGetFieldText(nomeCampo_modal);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_akun_header_validate_modal(var_modal, var_script_case_init, do_ajax_form_akun_header_validate_modal_cb);
  } // do_ajax_form_akun_header_validate_modal

  function do_ajax_form_akun_header_validate_modal_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "modal";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_akun_header_validate_modal_cb

  // ---------- Validate keterangan
  function do_ajax_form_akun_header_validate_keterangan()
  {
    var nomeCampo_keterangan = "keterangan";
    var var_keterangan = scAjaxGetFieldText(nomeCampo_keterangan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_akun_header_validate_keterangan(var_keterangan, var_script_case_init, do_ajax_form_akun_header_validate_keterangan_cb);
  } // do_ajax_form_akun_header_validate_keterangan

  function do_ajax_form_akun_header_validate_keterangan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_akun_header_validate_keterangan_cb

  // ---------- Validate user
  function do_ajax_form_akun_header_validate_user()
  {
    var nomeCampo_user = "user";
    var var_user = scAjaxGetFieldText(nomeCampo_user);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_akun_header_validate_user(var_user, var_script_case_init, do_ajax_form_akun_header_validate_user_cb);
  } // do_ajax_form_akun_header_validate_user

  function do_ajax_form_akun_header_validate_user_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "user";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_akun_header_validate_user_cb

  // ---------- Validate jam
  function do_ajax_form_akun_header_validate_jam()
  {
    var nomeCampo_jam = "jam";
    var var_jam = scAjaxGetFieldText(nomeCampo_jam);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_akun_header_validate_jam(var_jam, var_script_case_init, do_ajax_form_akun_header_validate_jam_cb);
  } // do_ajax_form_akun_header_validate_jam

  function do_ajax_form_akun_header_validate_jam_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "jam";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_akun_header_validate_jam_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_akun_header_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_akun_header_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_akun_header_submit_form(var_id, var_nama, var_grupid, var_jenis, var_modal, var_keterangan, var_user, var_jam, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_akun_header_submit_form_cb);
  } // do_ajax_form_akun_header_submit_form

  function do_ajax_form_akun_header_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_akun_header_submit_form_cb_after_alert);
  } // do_ajax_form_akun_header_submit_form_cb
  function do_ajax_form_akun_header_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_akun_header_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_akun_header_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_akun_header_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_akun_header_navigate_form_cb);
  } // do_ajax_form_akun_header_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_akun_header']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_akun_header_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_akun_header_navigate_form_cb_after_alert);
  } // do_ajax_form_akun_header_navigate_form_cb
  function do_ajax_form_akun_header_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_akun_header_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_akun_header_navigate_form_cb_after_alert
  function sc_hide_form_akun_header_form()
  {
