...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbbu_form();
	}

  // ---------- Validate id_bu
  function do_ajax_form_tbbu_validate_id_bu()
  {
    var nomeCampo_id_bu = "id_bu";
    var var_id_bu = scAjaxGetFieldHidden(nomeCampo_id_bu);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbbu_validate_id_bu(var_id_bu, var_script_case_init, do_ajax_form_tbbu_validate_id_bu_cb);
  } // do_ajax_form_tbbu_validate_id_bu

  function do_ajax_form_tbbu_validate_id_bu_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbbu_validate_id_bu_cb

  // ---------- Validate nama_bu
  function do_ajax_form_tbbu_validate_nama_bu()
  {
    var nomeCampo_nama_bu = "nama_bu";
    var var_nama_bu = scAjaxGetFieldText(nomeCampo_nama_bu);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbbu_validate_nama_bu(var_nama_bu, var_script_case_init, do_ajax_form_tbbu_validate_nama_bu_cb);
  } // do_ajax_form_tbbu_validate_nama_bu

  function do_ajax_form_tbbu_validate_nama_bu_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nama_bu";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbbu_validate_nama_bu_cb

  // ---------- Validate alamat_bu
  function do_ajax_form_tbbu_validate_alamat_bu()
  {
    var nomeCampo_alamat_bu = "alamat_bu";
    var var_alamat_bu = scAjaxGetFieldText(nomeCampo_alamat_bu);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbbu_validate_alamat_bu(var_alamat_bu, var_script_case_init, do_ajax_form_tbbu_validate_alamat_bu_cb);
  } // do_ajax_form_tbbu_validate_alamat_bu

  function do_ajax_form_tbbu_validate_alamat_bu_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbbu_validate_alamat_bu_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tbbu_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tbbu_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_tbbu_submit_form(var_id_bu, var_nama_bu, var_alamat_bu, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbbu_submit_form_cb);
  } // do_ajax_form_tbbu_submit_form

  function do_ajax_form_tbbu_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tbbu_submit_form_cb_after_alert);
  } // do_ajax_form_tbbu_submit_form_cb
  function do_ajax_form_tbbu_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbbu_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tbbu_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_tbbu_navigate_form(var_id_bu, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbbu_navigate_form_cb);
  } // do_ajax_form_tbbu_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbu']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbbu_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbbu_navigate_form_cb_after_alert);
  } // do_ajax_form_tbbu_navigate_form_cb
  function do_ajax_form_tbbu_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_tbbu_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_tbbu_navigate_form_cb_after_alert
  function sc_hide_form_tbbu_form()
  {
