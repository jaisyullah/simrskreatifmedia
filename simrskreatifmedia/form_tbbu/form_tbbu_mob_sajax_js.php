  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbbu_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbbu_mob_form();
	}

  // ---------- Validate id_bu
  function do_ajax_form_tbbu_mob_validate_id_bu()
  {
    var nomeCampo_id_bu = "id_bu";
    var var_id_bu = scAjaxGetFieldHidden(nomeCampo_id_bu);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbbu_mob_validate_id_bu(var_id_bu, var_script_case_init, do_ajax_form_tbbu_mob_validate_id_bu_cb);
  } // do_ajax_form_tbbu_mob_validate_id_bu

  function do_ajax_form_tbbu_mob_validate_id_bu_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbbu_mob_validate_id_bu_cb

  // ---------- Validate nama_bu
  function do_ajax_form_tbbu_mob_validate_nama_bu()
  {
    var nomeCampo_nama_bu = "nama_bu";
    var var_nama_bu = scAjaxGetFieldText(nomeCampo_nama_bu);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbbu_mob_validate_nama_bu(var_nama_bu, var_script_case_init, do_ajax_form_tbbu_mob_validate_nama_bu_cb);
  } // do_ajax_form_tbbu_mob_validate_nama_bu

  function do_ajax_form_tbbu_mob_validate_nama_bu_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nama_bu";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbbu_mob_validate_nama_bu_cb

  // ---------- Validate alamat_bu
  function do_ajax_form_tbbu_mob_validate_alamat_bu()
  {
    var nomeCampo_alamat_bu = "alamat_bu";
    var var_alamat_bu = scAjaxGetFieldText(nomeCampo_alamat_bu);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbbu_mob_validate_alamat_bu(var_alamat_bu, var_script_case_init, do_ajax_form_tbbu_mob_validate_alamat_bu_cb);
  } // do_ajax_form_tbbu_mob_validate_alamat_bu

  function do_ajax_form_tbbu_mob_validate_alamat_bu_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "alamat_bu";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbbu_mob_validate_alamat_bu_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tbbu_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tbbu_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id_bu = scAjaxGetFieldHidden("id_bu");
    var var_nama_bu = scAjaxGetFieldText("nama_bu");
    var var_alamat_bu = scAjaxGetFieldText("alamat_bu");
    ...
    scAjaxProcOn();
    x_ajax_form_tbbu_mob_submit_form(var_id_bu, var_nama_bu, var_alamat_bu, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbbu_mob_submit_form_cb);
  } // do_ajax_form_tbbu_mob_submit_form

  function do_ajax_form_tbbu_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("id_bu");
      scAjaxHideErrorDisplay("nama_bu");
      scAjaxHideErrorDisplay("alamat_bu");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tbbu_mob_submit_form_cb_after_alert);
  } // do_ajax_form_tbbu_mob_submit_form_cb
  function do_ajax_form_tbbu_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbbu_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tbbu_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("nama_bu");
    scAjaxHideErrorDisplay("alamat_bu");
    var var_id_bu = document.F2.id_bu.value;
    ...
    scAjaxProcOn();
    x_ajax_form_tbbu_mob_navigate_form(var_id_bu, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbbu_mob_navigate_form_cb);
  } // do_ajax_form_tbbu_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbu_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbbu_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.id_bu.value = scAjaxGetKeyValue("id_bu");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbbu_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_tbbu_mob_navigate_form_cb
  function do_ajax_form_tbbu_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_tbbu_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_tbbu_mob_navigate_form_cb_after_alert
  function sc_hide_form_tbbu_mob_form()
  {
  ...
  ajax_field_list[0] = "id_bu";
  ajax_field_list[1] = "nama_bu";
  ajax_field_list[2] = "alamat_bu";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "id_bu": {"label": "ID Perusahaan", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "nama_bu": {"label": "Nama Perusahaan", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "alamat_bu": {"label": "Alamat Perusahaan", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  ajax_field_mult["id_bu"][1] = "id_bu";
  ajax_field_mult["nama_bu"][1] = "nama_bu";
  ajax_field_mult["alamat_bu"][1] = "alamat_bu";

  var ajax_field_id = {
    "id_bu": new Array("hidden_field_label_id_bu", "hidden_field_data_id_bu"),
    "nama_bu": new Array("hidden_field_label_nama_bu", "hidden_field_data_nama_bu"),
    "alamat_bu": new Array("hidden_field_label_alamat_bu", "hidden_field_data_alamat_bu")
  };
