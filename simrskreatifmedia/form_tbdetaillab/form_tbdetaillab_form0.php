<?php
class form_tbdetaillab_form extends form_tbdetaillab_apl
{
function Form_Init()
{
...
<HEAD>
 <TITLE><?php if ('novo' == $this->nmgp_opcao) { echo strip_tags("" . $this->Ini->Nm_lang['lang_othr_frmi_title'] . " tbdetaillab"); } else { echo strip_tags("" . $this->Ini->Nm_lang['lang_othr_frmu_title'] . " tbdetaillab"); } ?></TITLE>
...
<?php
if ($this->Embutida_form && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetaillab']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetaillab']['sc_modal'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetaillab']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetaillab']['sc_redir_atualiz'] == 'ok')
{
?>
...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetaillab']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_tbdetaillab/form_tbdetaillab_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_tbdetaillab_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_tbdetaillab_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetaillab']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetaillab']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetaillab']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetaillab']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetaillab']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetaillab']['recarga'];
}
if ('novo' == $opcao_botoes && $this->Embutida_form)
{
    $opcao_botoes = 'inicio';
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetaillab']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetaillab']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
?>
...
<?php
 include_once("form_tbdetaillab_js0.php");
?>
<script type="text/javascript"> 
nmdg_enter_tab = true;
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_tbdetaillab'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_tbdetaillab'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetaillab']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetaillab']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetaillab']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetaillab']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetaillab']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<div class="scFormHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFormHeaderFont" style="float: left; text-transform: uppercase;"><?php if ($this->nmgp_opcao == "novo") { echo "" . $this->Ini->Nm_lang['lang_othr_frmi_title'] . " tbdetaillab"; } else { echo "" . $this->Ini->Nm_lang['lang_othr_frmu_title'] . " tbdetaillab"; } ?></div>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetaillab']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetaillab']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetaillab']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetaillab']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetaillab']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetaillab']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetaillab']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetaillab']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetaillab']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetaillab']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetaillab']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetaillab']['fast_search'][2] : "";
?> 
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetaillab']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetaillab']['run_iframe'] != "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetaillab']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetaillab']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetaillab']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetaillab']['run_iframe'] == "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetaillab']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetaillab']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetaillab']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetaillab']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetaillab']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetaillab']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetaillab']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetaillab']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetaillab']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetaillab']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetaillab']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetaillab']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
 ...
 ?>
   ...
   <?php if (isset($this->nmgp_cmp_hidden['labcode_']) && $this->nmgp_cmp_hidden['labcode_'] == 'off') { $sStyleHidden_labcode_ = 'display: none'; }
      ...
      if (!isset($this->nm_new_label['labcode_'])) {
          $this->nm_new_label['labcode_'] = "Pemeriksaan"; } ?>

    <TD class="scFormLabelOddMult css_labcode__label" id="hidden_field_label_labcode_" style="<?php echo $sStyleHidden_labcode_; ?>" > <?php echo $this->nm_new_label['labcode_'] ?> <span class="scFormRequiredOddMult">*</span> </TD>
   <?php } ?>
...
{ 
   ...
   { 
       ob_start();
       $iStart = sizeof($this->form_vert_form_tbdetaillab);
       $guarda_nmgp_opcao = $this->nmgp_opcao;
       $guarda_form_vert_form_tbdetaillab = $this->form_vert_form_tbdetaillab;
       $this->nmgp_opcao = 'novo';
   } 
   if ($this->Embutida_form && empty($this->form_vert_form_tbdetaillab))
   {
       $sc_seq_vert = 0;
   }
           if ('novo' != $this->nmgp_opcao && !isset($this->nmgp_cmp_readonly['rate_']))
           {
               $this->nmgp_cmp_readonly['rate_'] = 'on';
           }
           if ('novo' != $this->nmgp_opcao && !isset($this->nmgp_cmp_readonly['id_']))
           {
               $this->nmgp_cmp_readonly['id_'] = 'on';
           }
   foreach ($this->form_vert_form_tbdetaillab as $sc_seq_vert => $sc_lixo)
   {
       $this->loadRecordState($sc_seq_vert);
       $this->trancode_ = $this->form_vert_form_tbdetaillab[$sc_seq_vert]['trancode_'];
       $this->paket_ = $this->form_vert_form_tbdetaillab[$sc_seq_vert]['paket_'];
       $this->includepaket_ = $this->form_vert_form_tbdetaillab[$sc_seq_vert]['includepaket_'];
       $this->basicrate_ = $this->form_vert_form_tbdetaillab[$sc_seq_vert]['basicrate_'];
       $this->markup_ = $this->form_vert_form_tbdetaillab[$sc_seq_vert]['markup_'];
       $this->inapclass_ = $this->form_vert_form_tbdetaillab[$sc_seq_vert]['inapclass_'];
       $this->penjamin_ = $this->form_vert_form_tbdetaillab[$sc_seq_vert]['penjamin_'];
       $this->pasien_ = $this->form_vert_form_tbdetaillab[$sc_seq_vert]['pasien_'];
       $this->tlc_ = $this->form_vert_form_tbdetaillab[$sc_seq_vert]['tlc_'];
       $this->urutinput_ = $this->form_vert_form_tbdetaillab[$sc_seq_vert]['urutinput_'];
       $this->rujukan_ = $this->form_vert_form_tbdetaillab[$sc_seq_vert]['rujukan_'];
       $this->labtujuan_ = $this->form_vert_form_tbdetaillab[$sc_seq_vert]['labtujuan_'];
       $this->rateori_ = $this->form_vert_form_tbdetaillab[$sc_seq_vert]['rateori_'];
       $this->kode_akun_ = $this->form_vert_form_tbdetaillab[$sc_seq_vert]['kode_akun_'];
       ...
       elseif ($Line_Add)
       {
        ...
        $this->labcode_ = $this->form_vert_form_tbdetaillab[$sc_seq_vert]['labcode_']; 
       ...
       $this->rate_ = $this->form_vert_form_tbdetaillab[$sc_seq_vert]['rate_']; 
       $rate_ = $this->rate_; 
       $sStyleHidden_rate_ = '';
       ...
       $sStyleReadInp_rate_ = '';
       if (/*($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir") || */(isset($this->nmgp_cmp_readonly["rate_"]) &&  $this->nmgp_cmp_readonly["rate_"] == "on"))
       {
       ...
       $this->disc_ = $this->form_vert_form_tbdetaillab[$sc_seq_vert]['disc_']; 
       $disc_ = $this->disc_; 
       $sStyleHidden_disc_ = '';
       ...
       $this->trandate_ = $this->form_vert_form_tbdetaillab[$sc_seq_vert]['trandate_'] . ' ' . $this->form_vert_form_tbdetaillab[$sc_seq_vert]['trandate__hora']; 
       $trandate_ = $this->trandate_; 
       $this->trandate__hora = $this->form_vert_form_tbdetaillab[$sc_seq_vert]['trandate__hora']; 
       ...
       $this->id_ = $this->form_vert_form_tbdetaillab[$sc_seq_vert]['id_']; 
       $id_ = $this->id_; 
       if (!isset($this->nmgp_cmp_hidden['id_']))
       {
           $this->nmgp_cmp_hidden['id_'] = 'off';
...
<?php echo nmButtonOutput($this->arr_buttons, "bmd_novo", "do_ajax_form_tbdetaillab_add_new_line(" . $sc_seq_vert . ")", "do_ajax_form_tbdetaillab_add_new_line(" . $sc_seq_vert . ")", "sc_new_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
<?php }?>
<?php
  $Style_add_line = (!$Line_Add) ? "display: none" : "";
?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_form_tbdetaillab_cancel_insert(" . $sc_seq_vert . ")", "do_ajax_form_tbdetaillab_cancel_insert(" . $sc_seq_vert . ")", "sc_canceli_line_" . $sc_seq_vert . "", "", "", "" . $Style_add_line . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_form_tbdetaillab_cancel_update(" . $sc_seq_vert . ")", "do_ajax_form_tbdetaillab_cancel_update(" . $sc_seq_vert . ")", "sc_cancelu_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
 </TD>
   <?php }?>
   <?php if (isset($this->nmgp_cmp_hidden['labcode_']) && $this->nmgp_cmp_hidden['labcode_'] == 'off') { $sc_hidden_yes++; ?>
<input type=hidden name="labcode_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($this->labcode_) . "\">"; ?>
...
else
{
   ...
   while (!empty($todo[$x])) 
   {
          ...
          if (isset($this->Embutida_ronly) && $this->Embutida_ronly && isset($this->labcode__1))
          {
              foreach ($this->labcode__1 as $tmp_labcode_)
              {
                  if (trim($tmp_labcode_) === trim($cadaselect[1])) { $labcode__look .= $cadaselect[0] . '__SC_BREAK_LINE__'; }
              }
          }
          elseif (trim($this->labcode_) === trim($cadaselect[1])) { $labcode__look .= $cadaselect[0]; } 
          $x++; 
   }

?>
<input type="hidden" name="labcode_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($labcode_) . "\">" . $labcode__look . ""; ?>
<?php } else { ?>
<?php
   $todo = $this->Form_lookup_labcode_();
   $x = 0 ; 
   $labcode__look = ""; 
   while (!empty($todo[$x])) 
   {
          ...
          if (empty($labcode__look))
          {
              $labcode__look = $this->labcode_;
          }
   $x = 0; 
   echo "<span id=\"id_read_on_labcode_" . $sc_seq_vert . "\" class=\"css_labcode__line\" style=\"" .  $sStyleReadLab_labcode_ . "\">" . $this->form_encode_input($labcode__look) . "</span><span id=\"id_read_off_labcode_" . $sc_seq_vert . "\" class=\"css_read_off_labcode_\" style=\"white-space: nowrap; " . $sStyleReadInp_labcode_ . "\">";
   echo " <span id=\"idAjaxSelect_labcode_" .  $sc_seq_vert . "\"><select class=\"sc-js-input scFormObjectOddMult css_labcode__obj\" style=\"\" id=\"id_sc_field_labcode_" . $sc_seq_vert . "\" name=\"labcode_" . $sc_seq_vert . "\" size=\"1\" alt=\"{type: 'select', enterTab: true}\">" ; 
   echo "\r" ; 
   ...
   while (!empty($todo[$x]) && !$nm_nao_carga) 
   {
          ...
          if (trim($this->labcode_) === trim($cadaselect[1])) 
          {
              echo " selected" ; 
          }
          if (strtoupper($cadaselect[2]) == "S") 
          {
              if (empty($this->labcode_)) 
              {
                  echo " selected" ;
              } 
           } 
...
<?php if ($bTestReadOnly_rate_ && ($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir") || (isset($this->nmgp_cmp_readonly["rate_"]) &&  $this->nmgp_cmp_readonly["rate_"] == "on")) { 

 ?>
<input type="hidden" name="rate_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($rate_) . "\"><span id=\"id_ajax_label_rate_" . $sc_seq_vert . "\">" . $rate_ . "</span>"; ?>
<?php } else { ?>
...
<span class='trigger-picker-<?php echo $miniCalendarButton[1]; ?>'>
 ...
 size=18 alt="{datatype: 'datetime', dateSep: '<?php echo $this->field_config['trandate_']['date_sep']; ?>', dateFormat: '<?php echo $this->field_config['trandate_']['date_format']; ?>', timeSep: '<?php echo $this->field_config['trandate_']['time_sep']; ?>', enterTab: true, enterSubmit: false, autoTab: true, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddMultWm', maskChars: '(){}[].,;:-+/ '}" ></span>
<?php
...
<?php   
   ...
   { 
       ...
       $this->form_vert_form_tbdetaillab = $guarda_form_vert_form_tbdetaillab;
   } 
   if ($Table_refresh) 
   { 
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetaillab']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetaillab']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetaillab']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetaillab']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetaillab']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetaillab']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetaillab']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetaillab']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetaillab']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<?php
if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetaillab']['run_modal']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetaillab']['run_modal'])
{
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetaillab']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetaillab']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_tbdetaillab");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_tbdetaillab");
 parent.scAjaxDetailHeight("form_tbdetaillab", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
<script type="text/javascript">
	function scBtnFn_sys_format_inc() {
		if ($("#sc_b_new_t.sc-unique-btn-1").length && $("#sc_b_new_t.sc-unique-btn-1").is(":visible")) {
			do_ajax_form_tbdetaillab_add_new_line(); return false;
			 return;
		}
...
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetaillab']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
