...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_map_transaksi_jurnal"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_map_transaksi_jurnal"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_map_transaksi_jurnal'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_map_transaksi_jurnal']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_map_transaksi_jurnal']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_map_transaksi_jurnal']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_map_transaksi_jurnal']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_map_transaksi_jurnal']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_map_transaksi_jurnal</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_map_transaksi_jurnal']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_map_transaksi_jurnal']['embutida_filho'] as $ind => $sc_init)
          {
