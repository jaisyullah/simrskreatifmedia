...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_id_jns_transaksi_cond" name="id_jns_transaksi_cond" onChange="nm_campos_between(document.getElementById('id_vis_id_jns_transaksi'), this, 'id_jns_transaksi')">
      ...
      <br><span id="id_hide_id_jns_transaksi"  <?php echo $str_hide_id_jns_transaksi?>><?php
      if ($id_jns_transaksi != "")
      {
      $id_jns_transaksi_look = substr($this->Db->qstr($id_jns_transaksi), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_id_akun_cond" name="id_akun_cond" onChange="nm_campos_between(document.getElementById('id_vis_id_akun'), this, 'id_akun')">
      ...
      <br><span id="id_hide_id_akun"  <?php echo $str_hide_id_akun?>><?php
      if ($id_akun != "")
      {
      $id_akun_look = substr($this->Db->qstr($id_akun), 1, -1); 
      $nmgp_def_dados = array(); 
