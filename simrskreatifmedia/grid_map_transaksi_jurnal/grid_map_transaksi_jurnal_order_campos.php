...
<?php
   ...
   $Ord_Cmp = new grid_map_transaksi_jurnal_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_map_transaksi_jurnal_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_map_transaksi_jurnal']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_map_transaksi_jurnal']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_map_transaksi_jurnal']['labels']["id"])) ? $_SESSION['sc_session'][$sc_init]['grid_map_transaksi_jurnal']['labels']["id"] : "Id";
   $tab_ger_campos['id_jns_transaksi'] = "on";
   $tab_def_campos['id_jns_transaksi'] = "id_jns_transaksi";
   $tab_labels["id_jns_transaksi"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_map_transaksi_jurnal']['labels']["id_jns_transaksi"])) ? $_SESSION['sc_session'][$sc_init]['grid_map_transaksi_jurnal']['labels']["id_jns_transaksi"] : "Jenis Transaksi";
   $tab_ger_campos['id_akun'] = "on";
   $tab_def_campos['id_akun'] = "id_akun";
   $tab_labels["id_akun"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_map_transaksi_jurnal']['labels']["id_akun"])) ? $_SESSION['sc_session'][$sc_init]['grid_map_transaksi_jurnal']['labels']["id_akun"] : "Akun";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_map_transaksi_jurnal']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_map_transaksi_jurnal']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_map_transaksi_jurnal']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_map_transaksi_jurnal']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_map_transaksi_jurnal']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_map_transaksi_jurnal']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_map_transaksi_jurnal']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_map_transaksi_jurnal']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_map_transaksi_jurnal']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_map_transaksi_jurnal_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_map_transaksi_jurnal']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_map_transaksi_jurnal']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_map_transaksi_jurnal']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_map_transaksi_jurnal']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_map_transaksi_jurnal']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
