<?php
@session_start() ;
$_SESSION['scriptcase']['grid_map_transaksi_jurnal']['sc_process_barr'] = true;
require_once('../grid_map_transaksi_jurnal/index.php');
unset($_SESSION['scriptcase']['grid_map_transaksi_jurnal']['sc_process_barr']);
$ExportCtrl = new grid_map_transaksi_jurnal_export_control;
$ExportCtrl->Export_barr();

class grid_map_transaksi_jurnal_export_control
{
