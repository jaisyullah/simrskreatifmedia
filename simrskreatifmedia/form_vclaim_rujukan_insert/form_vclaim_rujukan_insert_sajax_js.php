  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_vclaim_rujukan_insert" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_vclaim_rujukan_insert_form();
	}

  // ---------- Validate nosep
  function do_ajax_form_vclaim_rujukan_insert_validate_nosep()
  {
    var nomeCampo_nosep = "nosep";
    var var_nosep = scAjaxGetFieldText(nomeCampo_nosep);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_rujukan_insert_validate_nosep(var_nosep, var_script_case_init, do_ajax_form_vclaim_rujukan_insert_validate_nosep_cb);
  } // do_ajax_form_vclaim_rujukan_insert_validate_nosep

  function do_ajax_form_vclaim_rujukan_insert_validate_nosep_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_rujukan_insert_validate_nosep_cb

  // ---------- Validate tglrujukan
  function do_ajax_form_vclaim_rujukan_insert_validate_tglrujukan()
  {
    var nomeCampo_tglrujukan = "tglrujukan";
    var var_tglrujukan = scAjaxGetFieldText(nomeCampo_tglrujukan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_rujukan_insert_validate_tglrujukan(var_tglrujukan, var_script_case_init, do_ajax_form_vclaim_rujukan_insert_validate_tglrujukan_cb);
  } // do_ajax_form_vclaim_rujukan_insert_validate_tglrujukan

  function do_ajax_form_vclaim_rujukan_insert_validate_tglrujukan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_rujukan_insert_validate_tglrujukan_cb

  // ---------- Validate ppkdirujuk
  function do_ajax_form_vclaim_rujukan_insert_validate_ppkdirujuk()
  {
    var nomeCampo_ppkdirujuk = "ppkdirujuk";
    var var_ppkdirujuk = scAjaxGetFieldText(nomeCampo_ppkdirujuk);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_rujukan_insert_validate_ppkdirujuk(var_ppkdirujuk, var_script_case_init, do_ajax_form_vclaim_rujukan_insert_validate_ppkdirujuk_cb);
  } // do_ajax_form_vclaim_rujukan_insert_validate_ppkdirujuk

  function do_ajax_form_vclaim_rujukan_insert_validate_ppkdirujuk_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ppkdirujuk";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_rujukan_insert_validate_ppkdirujuk_cb

  // ---------- Validate nmppkdirujuk
  function do_ajax_form_vclaim_rujukan_insert_validate_nmppkdirujuk()
  {
    var nomeCampo_nmppkdirujuk = "nmppkdirujuk";
    var var_nmppkdirujuk = scAjaxGetFieldText(nomeCampo_nmppkdirujuk);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_rujukan_insert_validate_nmppkdirujuk(var_nmppkdirujuk, var_script_case_init, do_ajax_form_vclaim_rujukan_insert_validate_nmppkdirujuk_cb);
  } // do_ajax_form_vclaim_rujukan_insert_validate_nmppkdirujuk

  function do_ajax_form_vclaim_rujukan_insert_validate_nmppkdirujuk_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nmppkdirujuk";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_rujukan_insert_validate_nmppkdirujuk_cb

  // ---------- Validate jnspelayanan
  function do_ajax_form_vclaim_rujukan_insert_validate_jnspelayanan()
  {
    var nomeCampo_jnspelayanan = "jnspelayanan";
    var var_jnspelayanan = scAjaxGetFieldSelect(nomeCampo_jnspelayanan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_rujukan_insert_validate_jnspelayanan(var_jnspelayanan, var_script_case_init, do_ajax_form_vclaim_rujukan_insert_validate_jnspelayanan_cb);
  } // do_ajax_form_vclaim_rujukan_insert_validate_jnspelayanan

  function do_ajax_form_vclaim_rujukan_insert_validate_jnspelayanan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_rujukan_insert_validate_jnspelayanan_cb

  // ---------- Validate catatan
  function do_ajax_form_vclaim_rujukan_insert_validate_catatan()
  {
    var nomeCampo_catatan = "catatan";
    var var_catatan = scAjaxGetFieldText(nomeCampo_catatan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_rujukan_insert_validate_catatan(var_catatan, var_script_case_init, do_ajax_form_vclaim_rujukan_insert_validate_catatan_cb);
  } // do_ajax_form_vclaim_rujukan_insert_validate_catatan

  function do_ajax_form_vclaim_rujukan_insert_validate_catatan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "catatan";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_rujukan_insert_validate_catatan_cb

  // ---------- Validate diagrujukan
  function do_ajax_form_vclaim_rujukan_insert_validate_diagrujukan()
  {
    var nomeCampo_diagrujukan = "diagrujukan";
    var var_diagrujukan = scAjaxGetFieldText(nomeCampo_diagrujukan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_rujukan_insert_validate_diagrujukan(var_diagrujukan, var_script_case_init, do_ajax_form_vclaim_rujukan_insert_validate_diagrujukan_cb);
  } // do_ajax_form_vclaim_rujukan_insert_validate_diagrujukan

  function do_ajax_form_vclaim_rujukan_insert_validate_diagrujukan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "diagrujukan";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_rujukan_insert_validate_diagrujukan_cb

  // ---------- Validate nmdiagrujukan
  function do_ajax_form_vclaim_rujukan_insert_validate_nmdiagrujukan()
  {
  } // do_ajax_form_vclaim_rujukan_insert_validate_nmdiagrujukan

  function do_ajax_form_vclaim_rujukan_insert_validate_nmdiagrujukan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nmdiagrujukan";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_rujukan_insert_validate_nmdiagrujukan_cb

  // ---------- Validate tiperujukan
  function do_ajax_form_vclaim_rujukan_insert_validate_tiperujukan()
  {
    var nomeCampo_tiperujukan = "tiperujukan";
    var var_tiperujukan = scAjaxGetFieldSelect(nomeCampo_tiperujukan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_rujukan_insert_validate_tiperujukan(var_tiperujukan, var_script_case_init, do_ajax_form_vclaim_rujukan_insert_validate_tiperujukan_cb);
  } // do_ajax_form_vclaim_rujukan_insert_validate_tiperujukan

  function do_ajax_form_vclaim_rujukan_insert_validate_tiperujukan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tiperujukan";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_rujukan_insert_validate_tiperujukan_cb

  // ---------- Validate polirujukan
  function do_ajax_form_vclaim_rujukan_insert_validate_polirujukan()
  {
    var nomeCampo_polirujukan = "polirujukan";
    var var_polirujukan = scAjaxGetFieldText(nomeCampo_polirujukan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_rujukan_insert_validate_polirujukan(var_polirujukan, var_script_case_init, do_ajax_form_vclaim_rujukan_insert_validate_polirujukan_cb);
  } // do_ajax_form_vclaim_rujukan_insert_validate_polirujukan

  function do_ajax_form_vclaim_rujukan_insert_validate_polirujukan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "polirujukan";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_rujukan_insert_validate_polirujukan_cb

  // ---------- Validate nmpolirujukan
  function do_ajax_form_vclaim_rujukan_insert_validate_nmpolirujukan()
  {
    var nomeCampo_nmpolirujukan = "nmpolirujukan";
    var var_nmpolirujukan = scAjaxGetFieldText(nomeCampo_nmpolirujukan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_rujukan_insert_validate_nmpolirujukan(var_nmpolirujukan, var_script_case_init, do_ajax_form_vclaim_rujukan_insert_validate_nmpolirujukan_cb);
  } // do_ajax_form_vclaim_rujukan_insert_validate_nmpolirujukan

  function do_ajax_form_vclaim_rujukan_insert_validate_nmpolirujukan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nmpolirujukan";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_rujukan_insert_validate_nmpolirujukan_cb

  // ---------- Validate user
  function do_ajax_form_vclaim_rujukan_insert_validate_user()
  {
    var nomeCampo_user = "user";
    var var_user = scAjaxGetFieldText(nomeCampo_user);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_rujukan_insert_validate_user(var_user, var_script_case_init, do_ajax_form_vclaim_rujukan_insert_validate_user_cb);
  } // do_ajax_form_vclaim_rujukan_insert_validate_user

  function do_ajax_form_vclaim_rujukan_insert_validate_user_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "user";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_rujukan_insert_validate_user_cb

  // ---------- Event onclick scajaxbutton_sc_btn_0
  function do_ajax_form_vclaim_rujukan_insert_event_scajaxbutton_sc_btn_0_onclick()
  {
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_vclaim_rujukan_insert_event_scajaxbutton_sc_btn_0_onclick(var_script_case_init, do_ajax_form_vclaim_rujukan_insert_event_scajaxbutton_sc_btn_0_onclick_cb);
  } // do_ajax_form_vclaim_rujukan_insert_event_scajaxbutton_sc_btn_0_onclick

  function do_ajax_form_vclaim_rujukan_insert_event_scajaxbutton_sc_btn_0_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_vclaim_rujukan_insert_event_scajaxbutton_sc_btn_0_onclick_cb_after_alert);
  } // do_ajax_form_vclaim_rujukan_insert_event_scajaxbutton_sc_btn_0_onclick_cb
  function do_ajax_form_vclaim_rujukan_insert_event_scajaxbutton_sc_btn_0_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_vclaim_rujukan_insert_event_scajaxbutton_sc_btn_0_onclick_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_vclaim_rujukan_insert_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_vclaim_rujukan_insert_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_nosep = scAjaxGetFieldText("nosep");
    var var_tglrujukan = scAjaxGetFieldText("tglrujukan");
    var var_ppkdirujuk = scAjaxGetFieldText("ppkdirujuk");
    var var_nmppkdirujuk = scAjaxGetFieldText("nmppkdirujuk");
    var var_jnspelayanan = scAjaxGetFieldSelect("jnspelayanan");
    var var_catatan = scAjaxGetFieldText("catatan");
    var var_diagrujukan = scAjaxGetFieldText("diagrujukan");
    var var_nmdiagrujukan = scAjaxGetFieldText("nmdiagrujukan");
    var var_tiperujukan = scAjaxGetFieldSelect("tiperujukan");
    var var_polirujukan = scAjaxGetFieldText("polirujukan");
    var var_nmpolirujukan = scAjaxGetFieldText("nmpolirujukan");
    ...
    scAjaxProcOn();
    x_ajax_form_vclaim_rujukan_insert_submit_form(var_nosep, var_tglrujukan, var_ppkdirujuk, var_nmppkdirujuk, var_jnspelayanan, var_catatan, var_diagrujukan, var_nmdiagrujukan, var_tiperujukan, var_polirujukan, var_nmpolirujukan, var_user, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_vclaim_rujukan_insert_submit_form_cb);
  } // do_ajax_form_vclaim_rujukan_insert_submit_form

  function do_ajax_form_vclaim_rujukan_insert_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_vclaim_rujukan_insert_submit_form_cb_after_alert);
  } // do_ajax_form_vclaim_rujukan_insert_submit_form_cb
  function do_ajax_form_vclaim_rujukan_insert_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_vclaim_rujukan_insert_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_vclaim_rujukan_insert_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_form_vclaim_rujukan_insert_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_rujukan_insert']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_vclaim_rujukan_insert_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_vclaim_rujukan_insert_navigate_form_cb_after_alert);
  } // do_ajax_form_vclaim_rujukan_insert_navigate_form_cb
  function do_ajax_form_vclaim_rujukan_insert_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_vclaim_rujukan_insert_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_vclaim_rujukan_insert_navigate_form_cb_after_alert
  function sc_hide_form_vclaim_rujukan_insert_form()
  {
  ...
  ajax_field_list[1] = "tglrujukan";
  ajax_field_list[2] = "ppkdirujuk";
  ajax_field_list[3] = "nmppkdirujuk";
  ajax_field_list[4] = "jnspelayanan";
  ajax_field_list[5] = "catatan";
  ajax_field_list[6] = "diagrujukan";
  ajax_field_list[7] = "nmdiagrujukan";
  ajax_field_list[8] = "tiperujukan";
  ajax_field_list[9] = "polirujukan";
  ajax_field_list[10] = "nmpolirujukan";
  ajax_field_list[11] = "user";
  ...
  var ajax_error_list = {
    ...
    "ppkdirujuk": {"label": "PPK Dirujuk", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "nmppkdirujuk": {"label": "Nama PPK Dirujuk", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "diagrujukan": {"label": "Diagnosa Rujukan", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "nmdiagrujukan": {"label": "Nama Diagnosa Rujukan", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "tiperujukan": {"label": "Tipe Rujukan", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "polirujukan": {"label": "Poli Rujukan", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "nmpolirujukan": {"label": "Nama Poli Rujukan", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  var ajax_field_mult = {
    ...
    "ppkdirujuk": new Array(),
    "nmppkdirujuk": new Array(),
    "jnspelayanan": new Array(),
    "catatan": new Array(),
    "diagrujukan": new Array(),
    "nmdiagrujukan": new Array(),
    "tiperujukan": new Array(),
    "polirujukan": new Array(),
    "nmpolirujukan": new Array(),
    "user": new Array()
  };
  ajax_field_mult["nosep"][1] = "nosep";
  ajax_field_mult["tglrujukan"][1] = "tglrujukan";
  ajax_field_mult["ppkdirujuk"][1] = "ppkdirujuk";
  ajax_field_mult["nmppkdirujuk"][1] = "nmppkdirujuk";
  ajax_field_mult["jnspelayanan"][1] = "jnspelayanan";
  ajax_field_mult["catatan"][1] = "catatan";
  ajax_field_mult["diagrujukan"][1] = "diagrujukan";
  ajax_field_mult["nmdiagrujukan"][1] = "nmdiagrujukan";
  ajax_field_mult["tiperujukan"][1] = "tiperujukan";
  ajax_field_mult["polirujukan"][1] = "polirujukan";
  ajax_field_mult["nmpolirujukan"][1] = "nmpolirujukan";
  ...
  var ajax_field_id = {
    ...
    "ppkdirujuk": new Array("hidden_field_label_ppkdirujuk", "hidden_field_data_ppkdirujuk"),
    "nmppkdirujuk": new Array("hidden_field_label_nmppkdirujuk", "hidden_field_data_nmppkdirujuk"),
    ...
    "diagrujukan": new Array("hidden_field_label_diagrujukan", "hidden_field_data_diagrujukan"),
    "nmdiagrujukan": new Array("hidden_field_label_nmdiagrujukan", "hidden_field_data_nmdiagrujukan"),
    "tiperujukan": new Array("hidden_field_label_tiperujukan", "hidden_field_data_tiperujukan"),
    "polirujukan": new Array("hidden_field_label_polirujukan", "hidden_field_data_polirujukan"),
    "nmpolirujukan": new Array("hidden_field_label_nmpolirujukan", "hidden_field_data_nmpolirujukan")
  };
