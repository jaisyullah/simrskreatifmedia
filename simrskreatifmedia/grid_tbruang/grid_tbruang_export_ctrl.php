<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tbruang']['sc_process_barr'] = true;
require_once('../grid_tbruang/index.php');
unset($_SESSION['scriptcase']['grid_tbruang']['sc_process_barr']);
$ExportCtrl = new grid_tbruang_export_control;
$ExportCtrl->Export_barr();

class grid_tbruang_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - Manajemen Ruangan :: Excel</TITLE>
