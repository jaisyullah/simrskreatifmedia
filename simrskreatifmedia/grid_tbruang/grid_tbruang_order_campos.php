...
<?php
   ...
   $Ord_Cmp = new grid_tbruang_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_tbruang_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbruang']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tbruang']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['idruang'] = "idRuang";
   $tab_labels["idruang"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbruang']['labels']["idruang"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbruang']['labels']["idruang"] : "ID Ruang";
   $tab_ger_campos['namaruang'] = "on";
   $tab_def_campos['namaruang'] = "namaRuang";
   $tab_labels["namaruang"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbruang']['labels']["namaruang"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbruang']['labels']["namaruang"] : "Nama Ruang";
   $tab_ger_campos['kelas'] = "on";
   $tab_def_campos['kelas'] = "kelas";
   $tab_labels["kelas"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbruang']['labels']["kelas"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbruang']['labels']["kelas"] : "Kelas";
   ...
   $tab_labels["sc_field_0"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbruang']['labels']["sc_field_0"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbruang']['labels']["sc_field_0"] : "Jumlah Bed";
   ...
   $tab_labels["tersedia"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbruang']['labels']["tersedia"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbruang']['labels']["tersedia"] : "Tersedia";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_tbruang']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_tbruang']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_tbruang']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbruang']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tbruang']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_tbruang']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_tbruang']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_tbruang']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_tbruang']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_tbruang_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_tbruang']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_tbruang']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_tbruang']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_tbruang']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_tbruang']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
