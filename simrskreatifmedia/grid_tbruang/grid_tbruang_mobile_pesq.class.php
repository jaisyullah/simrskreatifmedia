...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "idruang";$Nm_numeric[] = "idruang";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_idruang_cond" name="idruang_cond" onChange="nm_campos_between(document.getElementById('id_vis_idruang'), this, 'idruang')">
      ...
      <br><span id="id_hide_idruang"  <?php echo $str_hide_idruang?>><?php
      if ($idruang != "")
      {
      $idruang_look = substr($this->Db->qstr($idruang), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_namaruang_cond" name="namaruang_cond" onChange="nm_campos_between(document.getElementById('id_vis_namaruang'), this, 'namaruang')">
      ...
      <br><span id="id_hide_namaruang"  <?php echo $str_hide_namaruang?>><?php
      if ($namaruang != "")
      {
      $namaruang_look = substr($this->Db->qstr($namaruang), 1, -1); 
      $nmgp_def_dados = array(); 
