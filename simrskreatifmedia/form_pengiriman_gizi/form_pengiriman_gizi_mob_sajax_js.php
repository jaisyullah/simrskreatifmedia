  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_pengiriman_gizi_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_pengiriman_gizi_mob_form();
	}

  // ---------- Validate jadwal
  function do_ajax_form_pengiriman_gizi_mob_validate_jadwal()
  {
    var nomeCampo_jadwal = "jadwal";
    var var_jadwal = scAjaxGetFieldSelect(nomeCampo_jadwal);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pengiriman_gizi_mob_validate_jadwal(var_jadwal, var_script_case_init, do_ajax_form_pengiriman_gizi_mob_validate_jadwal_cb);
  } // do_ajax_form_pengiriman_gizi_mob_validate_jadwal

  function do_ajax_form_pengiriman_gizi_mob_validate_jadwal_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pengiriman_gizi_mob_validate_jadwal_cb

  // ---------- Validate tgl_kirim
  function do_ajax_form_pengiriman_gizi_mob_validate_tgl_kirim()
  {
    var nomeCampo_tgl_kirim = "tgl_kirim";
    var var_tgl_kirim = scAjaxGetFieldText(nomeCampo_tgl_kirim);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pengiriman_gizi_mob_validate_tgl_kirim(var_tgl_kirim, var_script_case_init, do_ajax_form_pengiriman_gizi_mob_validate_tgl_kirim_cb);
  } // do_ajax_form_pengiriman_gizi_mob_validate_tgl_kirim

  function do_ajax_form_pengiriman_gizi_mob_validate_tgl_kirim_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tgl_kirim";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pengiriman_gizi_mob_validate_tgl_kirim_cb

  // ---------- Validate detailpenggunaan
  function do_ajax_form_pengiriman_gizi_mob_validate_detailpenggunaan()
  {
    var nomeCampo_detailpenggunaan = "detailpenggunaan";
    var var_detailpenggunaan = scAjaxGetFieldText(nomeCampo_detailpenggunaan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pengiriman_gizi_mob_validate_detailpenggunaan(var_detailpenggunaan, var_script_case_init, do_ajax_form_pengiriman_gizi_mob_validate_detailpenggunaan_cb);
  } // do_ajax_form_pengiriman_gizi_mob_validate_detailpenggunaan

  function do_ajax_form_pengiriman_gizi_mob_validate_detailpenggunaan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "detailpenggunaan";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pengiriman_gizi_mob_validate_detailpenggunaan_cb

  // ---------- Validate detailpengiriman
  function do_ajax_form_pengiriman_gizi_mob_validate_detailpengiriman()
  {
    var nomeCampo_detailpengiriman = "detailpengiriman";
    var var_detailpengiriman = scAjaxGetFieldText(nomeCampo_detailpengiriman);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pengiriman_gizi_mob_validate_detailpengiriman(var_detailpengiriman, var_script_case_init, do_ajax_form_pengiriman_gizi_mob_validate_detailpengiriman_cb);
  } // do_ajax_form_pengiriman_gizi_mob_validate_detailpengiriman

  function do_ajax_form_pengiriman_gizi_mob_validate_detailpengiriman_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "detailpengiriman";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pengiriman_gizi_mob_validate_detailpengiriman_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_pengiriman_gizi_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_pengiriman_gizi_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_jadwal = scAjaxGetFieldSelect("jadwal");
    var var_tgl_kirim = scAjaxGetFieldText("tgl_kirim");
    ...
    scAjaxProcOn();
    x_ajax_form_pengiriman_gizi_mob_submit_form(var_jadwal, var_tgl_kirim, var_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_pengiriman_gizi_mob_submit_form_cb);
  } // do_ajax_form_pengiriman_gizi_mob_submit_form

  function do_ajax_form_pengiriman_gizi_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("tgl_kirim");
      scAjaxHideErrorDisplay("detailpenggunaan");
      scAjaxHideErrorDisplay("detailpengiriman");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_pengiriman_gizi_mob_submit_form_cb_after_alert);
  } // do_ajax_form_pengiriman_gizi_mob_submit_form_cb
  function do_ajax_form_pengiriman_gizi_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_pengiriman_gizi_mob_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_penggunaan_mob"] = "off";
  scStatusDetail["form_detailpengiriman_gizi_mob"] = "off";

  function do_ajax_form_pengiriman_gizi_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    scStatusDetail["form_penggunaan_mob"] = "on";
    scStatusDetail["form_detailpengiriman_gizi_mob"] = "on";
    x_ajax_form_pengiriman_gizi_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_pengiriman_gizi_mob_navigate_form_cb);
  } // do_ajax_form_pengiriman_gizi_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_pengiriman_gizi_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_pengiriman_gizi_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_penggunaan_mob"] && "nmsc_iframe_liga_form_penggunaan_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_penggunaan_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_penggunaan_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_penggunaan_mob').contentWindow.nm_move('apl_detalhe', true, '400px');
        document.getElementById('nmsc_iframe_liga_form_penggunaan_mob').style.height = "400px";
        document.getElementById('nmsc_iframe_liga_form_penggunaan_mob').style.display = "none";
    }
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_detailpengiriman_gizi_mob"] && "nmsc_iframe_liga_form_detailpengiriman_gizi_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_detailpengiriman_gizi_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_detailpengiriman_gizi_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_detailpengiriman_gizi_mob').contentWindow.nm_move('apl_detalhe', true, '400px');
        document.getElementById('nmsc_iframe_liga_form_detailpengiriman_gizi_mob').style.height = "400px";
        document.getElementById('nmsc_iframe_liga_form_detailpengiriman_gizi_mob').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_pengiriman_gizi_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_pengiriman_gizi_mob_navigate_form_cb
  function do_ajax_form_pengiriman_gizi_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_pengiriman_gizi_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_pengiriman_gizi_mob_navigate_form_cb_after_alert
  function sc_hide_form_pengiriman_gizi_mob_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_penggunaan_mob"] && "off" == scStatusDetail["form_detailpengiriman_gizi_mob"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[0] = "jadwal";
  ajax_field_list[1] = "tgl_kirim";
  ajax_field_list[2] = "detailpenggunaan";
  ajax_field_list[3] = "detailpengiriman";
  ...
  var ajax_error_list = {
    ...
    "tgl_kirim": {"label": "Tgl Kirim", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "detailpenggunaan": {"label": "", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "detailpengiriman": {"label": "", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "jadwal": new Array(),
    "tgl_kirim": new Array(),
    "detailpenggunaan": new Array(),
    "detailpengiriman": new Array()
  };
  ajax_field_mult["jadwal"][1] = "jadwal";
  ajax_field_mult["tgl_kirim"][1] = "tgl_kirim";
  ajax_field_mult["detailpenggunaan"][1] = "detailpenggunaan";
  ajax_field_mult["detailpengiriman"][1] = "detailpengiriman";

  var ajax_field_id = {
    "jadwal": new Array("hidden_field_label_jadwal", "hidden_field_data_jadwal"),
    "tgl_kirim": new Array("hidden_field_label_tgl_kirim", "hidden_field_data_tgl_kirim"),
    "detailpenggunaan": new Array("hidden_field_label_detailpenggunaan", "hidden_field_data_detailpenggunaan"),
    "detailpengiriman": new Array("hidden_field_label_detailpengiriman", "hidden_field_data_detailpengiriman")
  };

  var ajax_read_only = {
    "jadwal": "off",
    "tgl_kirim": "off",
    "detailpenggunaan": "off",
    "detailpengiriman": "off"
  };
