  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_pengiriman_gizi" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_pengiriman_gizi_form();
	}

  // ---------- Validate jadwal
  function do_ajax_form_pengiriman_gizi_validate_jadwal()
  {
    var nomeCampo_jadwal = "jadwal";
    var var_jadwal = scAjaxGetFieldSelect(nomeCampo_jadwal);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pengiriman_gizi_validate_jadwal(var_jadwal, var_script_case_init, do_ajax_form_pengiriman_gizi_validate_jadwal_cb);
  } // do_ajax_form_pengiriman_gizi_validate_jadwal

  function do_ajax_form_pengiriman_gizi_validate_jadwal_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pengiriman_gizi_validate_jadwal_cb

  // ---------- Validate tgl_kirim
  function do_ajax_form_pengiriman_gizi_validate_tgl_kirim()
  {
    var nomeCampo_tgl_kirim = "tgl_kirim";
    var var_tgl_kirim = scAjaxGetFieldText(nomeCampo_tgl_kirim);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pengiriman_gizi_validate_tgl_kirim(var_tgl_kirim, var_script_case_init, do_ajax_form_pengiriman_gizi_validate_tgl_kirim_cb);
  } // do_ajax_form_pengiriman_gizi_validate_tgl_kirim

  function do_ajax_form_pengiriman_gizi_validate_tgl_kirim_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pengiriman_gizi_validate_tgl_kirim_cb

  // ---------- Validate detailpenggunaan
  function do_ajax_form_pengiriman_gizi_validate_detailpenggunaan()
  {
    var nomeCampo_detailpenggunaan = "detailpenggunaan";
    var var_detailpenggunaan = scAjaxGetFieldText(nomeCampo_detailpenggunaan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pengiriman_gizi_validate_detailpenggunaan(var_detailpenggunaan, var_script_case_init, do_ajax_form_pengiriman_gizi_validate_detailpenggunaan_cb);
  } // do_ajax_form_pengiriman_gizi_validate_detailpenggunaan

  function do_ajax_form_pengiriman_gizi_validate_detailpenggunaan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pengiriman_gizi_validate_detailpenggunaan_cb

  // ---------- Validate detailpengiriman
  function do_ajax_form_pengiriman_gizi_validate_detailpengiriman()
  {
    var nomeCampo_detailpengiriman = "detailpengiriman";
    var var_detailpengiriman = scAjaxGetFieldText(nomeCampo_detailpengiriman);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pengiriman_gizi_validate_detailpengiriman(var_detailpengiriman, var_script_case_init, do_ajax_form_pengiriman_gizi_validate_detailpengiriman_cb);
  } // do_ajax_form_pengiriman_gizi_validate_detailpengiriman

  function do_ajax_form_pengiriman_gizi_validate_detailpengiriman_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pengiriman_gizi_validate_detailpengiriman_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_pengiriman_gizi_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_pengiriman_gizi_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_pengiriman_gizi_submit_form(var_jadwal, var_tgl_kirim, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_pengiriman_gizi_submit_form_cb);
  } // do_ajax_form_pengiriman_gizi_submit_form

  function do_ajax_form_pengiriman_gizi_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_pengiriman_gizi_submit_form_cb_after_alert);
  } // do_ajax_form_pengiriman_gizi_submit_form_cb
  function do_ajax_form_pengiriman_gizi_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_pengiriman_gizi_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_penggunaan"] = "off";
  scStatusDetail["form_detailpengiriman_gizi"] = "off";

  function do_ajax_form_pengiriman_gizi_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    scStatusDetail["form_penggunaan"] = "on";
    scStatusDetail["form_detailpengiriman_gizi"] = "on";
    x_ajax_form_pengiriman_gizi_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_pengiriman_gizi_navigate_form_cb);
  } // do_ajax_form_pengiriman_gizi_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_pengiriman_gizi']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_pengiriman_gizi_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_penggunaan"] && "nmsc_iframe_liga_form_penggunaan" != scMasterDetailIframe["nmsc_iframe_liga_form_penggunaan"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_penggunaan"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_penggunaan').contentWindow.nm_move('apl_detalhe', true, '400px');
        document.getElementById('nmsc_iframe_liga_form_penggunaan').style.height = "400px";
        document.getElementById('nmsc_iframe_liga_form_penggunaan').style.display = "none";
    }
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_detailpengiriman_gizi"] && "nmsc_iframe_liga_form_detailpengiriman_gizi" != scMasterDetailIframe["nmsc_iframe_liga_form_detailpengiriman_gizi"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_detailpengiriman_gizi"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_detailpengiriman_gizi').contentWindow.nm_move('apl_detalhe', true, '400px');
        document.getElementById('nmsc_iframe_liga_form_detailpengiriman_gizi').style.height = "400px";
        document.getElementById('nmsc_iframe_liga_form_detailpengiriman_gizi').style.display = "none";
    }
    scAjaxSetBtnVars();
    sc_change_tabs(true, 'hidden_bloco_1', 'id_tabs_1_1');
    sc_change_tabs(false, 'hidden_bloco_2', 'id_tabs_1_2');
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_pengiriman_gizi_navigate_form_cb_after_alert);
  } // do_ajax_form_pengiriman_gizi_navigate_form_cb
  function do_ajax_form_pengiriman_gizi_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_pengiriman_gizi_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_pengiriman_gizi_navigate_form_cb_after_alert
  function sc_hide_form_pengiriman_gizi_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_penggunaan"] && "off" == scStatusDetail["form_detailpengiriman_gizi"])
    {
      return true;
    }
    return false;
