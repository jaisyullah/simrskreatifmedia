...
function displayChange_field_detailpenggunaan(row, status) {
	if ("on" == status && typeof $("#nmsc_iframe_liga_form_penggunaan")[0].contentWindow.scRecreateSelect2 === "function") {
		$("#nmsc_iframe_liga_form_penggunaan")[0].contentWindow.scRecreateSelect2();
	}
}

function displayChange_field_detailpengiriman(row, status) {
	if ("on" == status && typeof $("#nmsc_iframe_liga_form_detailpengiriman_gizi")[0].contentWindow.scRecreateSelect2 === "function") {
		$("#nmsc_iframe_liga_form_detailpengiriman_gizi")[0].contentWindow.scRecreateSelect2();
	}
}
...
function scHidePage(pageNo) {
	$("#id_form_pengiriman_gizi_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_tgl_kirim" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_pengiriman_gizi_validate_tgl_kirim(iSeqRow);
    },
    numberOfMonths: 1,
    changeMonth: true,
    changeYear: true,
