  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbbillruang_adm" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbbillruang_adm_form();
	}

  // ---------- Validate check_in_
  function do_ajax_form_tbbillruang_adm_validate_check_in_(iNumLinha)
  {
    var nomeCampo_check_in_ = "check_in_" + iNumLinha;
    var nomeCampo_check_in__hora = "check_in__hora" + iNumLinha;
    var var_check_in_ = scAjaxGetFieldText(nomeCampo_check_in_);
    var var_check_in__hora = scAjaxGetFieldText(nomeCampo_check_in__hora);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbbillruang_adm_validate_check_in_(var_check_in_, var_check_in__hora, iNumLinha, var_script_case_init, do_ajax_form_tbbillruang_adm_validate_check_in__cb);
  } // do_ajax_form_tbbillruang_adm_validate_check_in_

  function do_ajax_form_tbbillruang_adm_validate_check_in__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "check_in_" + iLineNumber;
    }
    else
    {
      sFieldValid = "check_in_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "check_in_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "check_in_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbbillruang_adm_validate_check_in__cb

  // ---------- Validate check_out_
  function do_ajax_form_tbbillruang_adm_validate_check_out_(iNumLinha)
  {
    var nomeCampo_check_out_ = "check_out_" + iNumLinha;
    var nomeCampo_check_out__hora = "check_out__hora" + iNumLinha;
    var var_check_out_ = scAjaxGetFieldText(nomeCampo_check_out_);
    var var_check_out__hora = scAjaxGetFieldText(nomeCampo_check_out__hora);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbbillruang_adm_validate_check_out_(var_check_out_, var_check_out__hora, iNumLinha, var_script_case_init, do_ajax_form_tbbillruang_adm_validate_check_out__cb);
  } // do_ajax_form_tbbillruang_adm_validate_check_out_

  function do_ajax_form_tbbillruang_adm_validate_check_out__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "check_out_" + iLineNumber;
    }
    else
    {
      sFieldValid = "check_out_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "check_out_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "check_out_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbbillruang_adm_validate_check_out__cb

  // ---------- Validate lama_
  function do_ajax_form_tbbillruang_adm_validate_lama_(iNumLinha)
  {
    var nomeCampo_lama_ = "lama_" + iNumLinha;
    var var_lama_ = scAjaxGetFieldText(nomeCampo_lama_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbbillruang_adm_validate_lama_(var_lama_, iNumLinha, var_script_case_init, do_ajax_form_tbbillruang_adm_validate_lama__cb);
  } // do_ajax_form_tbbillruang_adm_validate_lama_

  function do_ajax_form_tbbillruang_adm_validate_lama__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "lama_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "lama_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbbillruang_adm_validate_lama__cb

  // ---------- Validate bed_
  function do_ajax_form_tbbillruang_adm_validate_bed_(iNumLinha)
  {
    var nomeCampo_bed_ = "bed_" + iNumLinha;
    var var_bed_ = scAjaxGetFieldSelect(nomeCampo_bed_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbbillruang_adm_validate_bed_(var_bed_, iNumLinha, var_script_case_init, do_ajax_form_tbbillruang_adm_validate_bed__cb);
  } // do_ajax_form_tbbillruang_adm_validate_bed_

  function do_ajax_form_tbbillruang_adm_validate_bed__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbbillruang_adm_validate_bed__cb

  // ---------- Validate rate_
  function do_ajax_form_tbbillruang_adm_validate_rate_(iNumLinha)
  {
    var nomeCampo_rate_ = "rate_" + iNumLinha;
    var var_rate_ = scAjaxGetFieldText(nomeCampo_rate_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbbillruang_adm_validate_rate_(var_rate_, iNumLinha, var_script_case_init, do_ajax_form_tbbillruang_adm_validate_rate__cb);
  } // do_ajax_form_tbbillruang_adm_validate_rate_

  function do_ajax_form_tbbillruang_adm_validate_rate__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbbillruang_adm_validate_rate__cb

  // ---------- Validate disc_
  function do_ajax_form_tbbillruang_adm_validate_disc_(iNumLinha)
  {
    var nomeCampo_disc_ = "disc_" + iNumLinha;
    var var_disc_ = scAjaxGetFieldText(nomeCampo_disc_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbbillruang_adm_validate_disc_(var_disc_, iNumLinha, var_script_case_init, do_ajax_form_tbbillruang_adm_validate_disc__cb);
  } // do_ajax_form_tbbillruang_adm_validate_disc_

  function do_ajax_form_tbbillruang_adm_validate_disc__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbbillruang_adm_validate_disc__cb

  // ---------- Validate keperawatan_
  function do_ajax_form_tbbillruang_adm_validate_keperawatan_(iNumLinha)
  {
    var nomeCampo_keperawatan_ = "keperawatan_" + iNumLinha;
    var var_keperawatan_ = scAjaxGetFieldText(nomeCampo_keperawatan_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbbillruang_adm_validate_keperawatan_(var_keperawatan_, iNumLinha, var_script_case_init, do_ajax_form_tbbillruang_adm_validate_keperawatan__cb);
  } // do_ajax_form_tbbillruang_adm_validate_keperawatan_

  function do_ajax_form_tbbillruang_adm_validate_keperawatan__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "keperawatan_" + iLineNumber;
    }
    else
    {
      sFieldValid = "keperawatan_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "keperawatan_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "keperawatan_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbbillruang_adm_validate_keperawatan__cb

  // ---------- Validate id_
  function do_ajax_form_tbbillruang_adm_validate_id_(iNumLinha)
  {
    var nomeCampo_id_ = "id_" + iNumLinha;
    var var_id_ = scAjaxGetFieldHidden(nomeCampo_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbbillruang_adm_validate_id_(var_id_, iNumLinha, var_script_case_init, do_ajax_form_tbbillruang_adm_validate_id__cb);
  } // do_ajax_form_tbbillruang_adm_validate_id_

  function do_ajax_form_tbbillruang_adm_validate_id__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbbillruang_adm_validate_id__cb

  // ---------- Validate trandate_
  function do_ajax_form_tbbillruang_adm_validate_trandate_(iNumLinha)
  {
    var nomeCampo_trandate_ = "trandate_" + iNumLinha;
    var var_trandate_ = scAjaxGetFieldText(nomeCampo_trandate_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbbillruang_adm_validate_trandate_(var_trandate_, iNumLinha, var_script_case_init, do_ajax_form_tbbillruang_adm_validate_trandate__cb);
  } // do_ajax_form_tbbillruang_adm_validate_trandate_

  function do_ajax_form_tbbillruang_adm_validate_trandate__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbbillruang_adm_validate_trandate__cb

  // ---------- Validate trancode_
  function do_ajax_form_tbbillruang_adm_validate_trancode_(iNumLinha)
  {
    var nomeCampo_trancode_ = "trancode_" + iNumLinha;
    var var_trancode_ = scAjaxGetFieldText(nomeCampo_trancode_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbbillruang_adm_validate_trancode_(var_trancode_, iNumLinha, var_script_case_init, do_ajax_form_tbbillruang_adm_validate_trancode__cb);
  } // do_ajax_form_tbbillruang_adm_validate_trancode_

  function do_ajax_form_tbbillruang_adm_validate_trancode__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbbillruang_adm_validate_trancode__cb

  // ---------- Validate sc_field_0_
  function do_ajax_form_tbbillruang_adm_validate_sc_field_0_(iNumLinha)
  {
    var nomeCampo_sc_field_0_ = "sc_field_0_" + iNumLinha;
    var var_sc_field_0_ = scAjaxGetFieldText(nomeCampo_sc_field_0_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbbillruang_adm_validate_sc_field_0_(var_sc_field_0_, iNumLinha, var_script_case_init, do_ajax_form_tbbillruang_adm_validate_sc_field_0__cb);
  } // do_ajax_form_tbbillruang_adm_validate_sc_field_0_

  function do_ajax_form_tbbillruang_adm_validate_sc_field_0__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbbillruang_adm_validate_sc_field_0__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_tbbillruang_adm_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_tbbillruang_adm_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tbbillruang_adm_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_tbbillruang_adm_add_new_line_cb);
  } // do_ajax_form_tbbillruang_adm_add_new_line

  function do_ajax_form_tbbillruang_adm_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_tbbillruang_adm_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_tbbillruang_adm_backup_line(iNumLinha)
  {
    var var_id_ = scAjaxGetFieldHidden("id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbbillruang_adm_backup_line(var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_tbbillruang_adm_backup_line_cb);
  } // do_ajax_form_tbbillruang_adm_backup_line

  function do_ajax_form_tbbillruang_adm_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_tbbillruang_adm_backup_line_cb

  function do_ajax_form_tbbillruang_adm_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_tbbillruang_adm_cancel_insert

  function do_ajax_form_tbbillruang_adm_cancel_update(iSeqVert)
  {
    do_ajax_form_tbbillruang_adm_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_tbbillruang_adm_cancel_update

  function do_ajax_form_tbbillruang_adm_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_tbbillruang_adm_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_tbbillruang_adm_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_tbbillruang_adm_table_refresh(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbbillruang_adm_table_refresh_cb);
  } //  do_ajax_form_tbbillruang_adm_table_refresh

  function do_ajax_form_tbbillruang_adm_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_tbbillruang_adm_table_refresh_cb_after_alert);
  } // do_ajax_form_tbbillruang_adm_table_refresh_cb
  function do_ajax_form_tbbillruang_adm_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxSetNavStatus("t");
    sc_insert_open = false;
  } // do_ajax_form_tbbillruang_adm_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_tbbillruang_adm_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_tbbillruang_adm_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    sc_num_ult_line = iNumLinha;
    sc_num_ult_tr   = indexTR;
    scAjaxHideMessage();
    var var_check_in_ = scAjaxGetFieldText("check_in_" + iNumLinha);
    var var_check_in__hora = scAjaxGetFieldText("check_in__hora" + iNumLinha);
    var var_check_out_ = scAjaxGetFieldText("check_out_" + iNumLinha);
    var var_check_out__hora = scAjaxGetFieldText("check_out__hora" + iNumLinha);
    var var_lama_ = scAjaxGetFieldText("lama_" + iNumLinha);
    var var_bed_ = scAjaxGetFieldSelect("bed_" + iNumLinha);
    var var_rate_ = scAjaxGetFieldText("rate_" + iNumLinha);
    var var_disc_ = scAjaxGetFieldText("disc_" + iNumLinha);
    var var_keperawatan_ = scAjaxGetFieldText("keperawatan_" + iNumLinha);
    var var_id_ = scAjaxGetFieldHidden("id_" + iNumLinha);
...
?>
    x_ajax_form_tbbillruang_adm_submit_form(var_check_in_, var_check_in__hora, var_check_out_, var_check_out__hora, var_lama_, var_bed_, var_rate_, var_disc_, var_keperawatan_, var_id_, var_trandate_, var_trancode_, var_sc_field_0_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbbillruang_adm_submit_form_cb);
  } // do_ajax_form_tbbillruang_adm_submit_form

  function do_ajax_form_tbbillruang_adm_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("check_in_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("check_out_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("lama_" + sc_num_ult_line);
      ...
      scAjaxHideErrorDisplay("keperawatan_" + sc_num_ult_line);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_tbbillruang_adm_submit_form_cb_after_alert);
  } // do_ajax_form_tbbillruang_adm_submit_form_cb
  function do_ajax_form_tbbillruang_adm_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbbillruang_adm_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tbbillruang_adm_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_tbbillruang_adm_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("check_in_" + iNavForm);
      scAjaxHideErrorDisplay("check_out_" + iNavForm);
      scAjaxHideErrorDisplay("lama_" + iNavForm);
      scAjaxHideErrorDisplay("bed_" + iNavForm);
      scAjaxHideErrorDisplay("rate_" + iNavForm);
      scAjaxHideErrorDisplay("disc_" + iNavForm);
      scAjaxHideErrorDisplay("keperawatan_" + iNavForm);
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tbbillruang_adm_navigate_form(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbbillruang_adm_navigate_form_cb);
  } // do_ajax_form_tbbillruang_adm_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbillruang_adm']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbbillruang_adm_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbbillruang_adm_navigate_form_cb_after_alert);
  } // do_ajax_form_tbbillruang_adm_navigate_form_cb
  function do_ajax_form_tbbillruang_adm_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_tbbillruang_adm_navigate_form_cb_after_alert
  function sc_hide_form_tbbillruang_adm_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "check_in_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "check_out_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "lama_" + iNumLinha;
    iTotCampos++;
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "keperawatan_" + iNumLinha;
    iTotCampos++;
    ...
    iTotCampos++;
    ajax_field_Dt_Hr[iTotDt_Hr] = "check_in__hora" + iNumLinha;
    iTotDt_Hr++;
    ajax_field_Dt_Hr[iTotDt_Hr] = "check_out__hora" + iNumLinha;
    iTotDt_Hr++;
    ajax_error_list["check_in_" + iNumLinha] = {"label": "Check In<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["check_out_" + iNumLinha] = {"label": "Check Out<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["lama_" + iNumLinha] = {"label": "LOS<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["bed_" + iNumLinha] = {"label": "Ruang / Bed<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["rate_" + iNumLinha] = {"label": "Biaya @<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_error_list["keperawatan_" + iNumLinha] = {"label": "Tarif Keperawatan<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_error_list["trancode_" + iNumLinha] = {"label": "Kode<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["sc_field_0_" + iNumLinha] = {"label": "Kelas Adm.<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["check_in_"][iNumLinha] = "check_in_" + iNumLinha;
    ajax_field_mult["check_out_"][iNumLinha] = "check_out_" + iNumLinha;
    ajax_field_mult["lama_"][iNumLinha] = "lama_" + iNumLinha;
    ...
    ajax_field_mult["keperawatan_"][iNumLinha] = "keperawatan_" + iNumLinha;
    ...
    ajax_field_id["check_in_" + iNumLinha] = new Array("hidden_field_label_check_in_", "hidden_field_data_check_in_" + iNumLinha);
    ajax_field_id["check_out_" + iNumLinha] = new Array("hidden_field_label_check_out_", "hidden_field_data_check_out_" + iNumLinha);
    ajax_field_id["lama_" + iNumLinha] = new Array("hidden_field_label_lama_", "hidden_field_data_lama_" + iNumLinha);
    ...
    ajax_field_id["keperawatan_" + iNumLinha] = new Array("hidden_field_label_keperawatan_", "hidden_field_data_keperawatan_" + iNumLinha);
    ...
    ajax_error_count["check_in_" + iNumLinha] = "off";
    ajax_error_count["check_out_" + iNumLinha] = "off";
    ajax_error_count["lama_" + iNumLinha] = "off";
    ajax_error_count["bed_" + iNumLinha] = "off";
    ajax_error_count["rate_" + iNumLinha] = "off";
    ajax_error_count["disc_" + iNumLinha] = "off";
    ajax_error_count["keperawatan_" + iNumLinha] = "off";
...
{
?>
    ajax_read_only["check_in_" + iNumLinha] = "off";
    ajax_read_only["check_out_" + iNumLinha] = "off";
    ajax_read_only["lama_" + iNumLinha] = "off";
    ajax_read_only["bed_" + iNumLinha] = "off";
    ajax_read_only["rate_" + iNumLinha] = "off";
    ajax_read_only["disc_" + iNumLinha] = "off";
    ajax_read_only["keperawatan_" + iNumLinha] = "off";
    ...
    ajax_read_only["check_in__hora" + iNumLinha] = "off";
    ajax_read_only["check_out__hora" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["check_in_" + iNumLinha] = "on";
    ajax_read_only["check_out_" + iNumLinha] = "on";
    ajax_read_only["lama_" + iNumLinha] = "on";
    ajax_read_only["bed_" + iNumLinha] = "on";
    ajax_read_only["rate_" + iNumLinha] = "on";
    ajax_read_only["disc_" + iNumLinha] = "on";
    ajax_read_only["keperawatan_" + iNumLinha] = "on";
    ajax_read_only["id_" + iNumLinha] = "on";
    ajax_read_only["trandate_" + iNumLinha] = "on";
    ajax_read_only["trancode_" + iNumLinha] = "on";
    ajax_read_only["sc_field_0_" + iNumLinha] = "on";
    ajax_read_only["check_in__hora" + iNumLinha] = "on";
    ajax_read_only["check_out__hora" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["check_in_" + iNumLinha] = null;
    ajax_error_list["check_out_" + iNumLinha] = null;
    ajax_error_list["lama_" + iNumLinha] = null;
    ajax_error_list["bed_" + iNumLinha] = null;
    ajax_error_list["rate_" + iNumLinha] = null;
    ajax_error_list["disc_" + iNumLinha] = null;
    ajax_error_list["keperawatan_" + iNumLinha] = null;
  ...
  var ajax_field_mult = {
    "check_in_": new Array(),
    "check_out_": new Array(),
    "lama_": new Array(),
    "bed_": new Array(),
    "rate_": new Array(),
    "disc_": new Array(),
    "keperawatan_": new Array(),
    "id_": new Array(),
    "trandate_": new Array(),
    "trancode_": new Array(),
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["check_in_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["check_in_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["check_in_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["check_in_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["check_in_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["check_out_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["check_out_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["check_out_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["check_out_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["check_out_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["lama_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["lama_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["lama_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["lama_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["lama_" + iNumLinha]["onfocus"] = new Array();
      ...
      ajax_error_list["keperawatan_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["keperawatan_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["keperawatan_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["keperawatan_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["keperawatan_" + iNumLinha]["onfocus"] = new Array();
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['check_in_'])) ? $this->nmgp_cmp_readonly['check_in_'] : 'off';
?>
    scAjaxFieldRead("check_in_" + iSeq, "<?php echo $NM_contr_readonly ?>");
    scAjaxFieldRead("check_in__hora" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['check_out_'])) ? $this->nmgp_cmp_readonly['check_out_'] : 'off';
?>
    scAjaxFieldRead("check_out_" + iSeq, "<?php echo $NM_contr_readonly ?>");
    scAjaxFieldRead("check_out__hora" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['lama_'])) ? $this->nmgp_cmp_readonly['lama_'] : 'off';
?>
    scAjaxFieldRead("lama_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['keperawatan_'])) ? $this->nmgp_cmp_readonly['keperawatan_'] : 'off';
?>
    scAjaxFieldRead("keperawatan_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['sc_field_0_'])) ? $this->nmgp_cmp_readonly['sc_field_0_'] : 'on';
?>
  ...
  {
    scAjaxFieldRead("check_in_" + iSeq, "on");
    scAjaxFieldRead("check_in__hora" + iSeq, "on");
    scAjaxFieldRead("check_out_" + iSeq, "on");
    scAjaxFieldRead("check_out__hora" + iSeq, "on");
    scAjaxFieldRead("lama_" + iSeq, "on");
    scAjaxFieldRead("bed_" + iSeq, "on");
    scAjaxFieldRead("rate_" + iSeq, "on");
    scAjaxFieldRead("disc_" + iSeq, "on");
    scAjaxFieldRead("keperawatan_" + iSeq, "on");
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["check_in_" + iRow] || "on" == ajax_error_count["check_out_" + iRow] || "on" == ajax_error_count["lama_" + iRow] || "on" == ajax_error_count["bed_" + iRow] || "on" == ajax_error_count["rate_" + iRow] || "on" == ajax_error_count["disc_" + iRow] || "on" == ajax_error_count["keperawatan_" + iRow] || "on" == ajax_error_count["id_" + iRow] || "on" == ajax_error_count["trandate_" + iRow] || "on" == ajax_error_count["trancode_" + iRow] || "on" == ajax_error_count["sc_field_0_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_check_in_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_check_out_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_lama_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_bed_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_rate_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_disc_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_keperawatan_" + iRow).addClass("scFormErrorLine");
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["check_in_" + iRow] && "off" == ajax_error_count["check_out_" + iRow] && "off" == ajax_error_count["lama_" + iRow] && "off" == ajax_error_count["bed_" + iRow] && "off" == ajax_error_count["rate_" + iRow] && "off" == ajax_error_count["disc_" + iRow] && "off" == ajax_error_count["keperawatan_" + iRow] && "off" == ajax_error_count["id_" + iRow] && "off" == ajax_error_count["trandate_" + iRow] && "off" == ajax_error_count["trancode_" + iRow] && "off" == ajax_error_count["sc_field_0_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["check_in_" + iRow] = "off";
        ajax_error_count["check_out_" + iRow] = "off";
        ajax_error_count["lama_" + iRow] = "off";
        ajax_error_count["bed_" + iRow] = "off";
        ajax_error_count["rate_" + iRow] = "off";
        ajax_error_count["disc_" + iRow] = "off";
        ajax_error_count["keperawatan_" + iRow] = "off";
      ...
      $("#hidden_field_data_check_in_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_check_out_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_lama_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_bed_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_rate_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_disc_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_keperawatan_" + iRow).removeClass("scFormErrorLine");
