<?php
class form_tbbillruang_adm_form extends form_tbbillruang_adm_apl
{
function Form_Init()
{
...
<?php
if ($this->Embutida_form && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbillruang_adm']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbillruang_adm']['sc_modal'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbillruang_adm']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbillruang_adm']['sc_redir_atualiz'] == 'ok')
{
?>
...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbillruang_adm']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_tbbillruang_adm/form_tbbillruang_adm_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_tbbillruang_adm_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_tbbillruang_adm_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbillruang_adm']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbillruang_adm']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbillruang_adm']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbillruang_adm']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbillruang_adm']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbillruang_adm']['recarga'];
}
if ('novo' == $opcao_botoes && $this->Embutida_form)
{
    $opcao_botoes = 'inicio';
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbillruang_adm']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbillruang_adm']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
?>
...
<?php
 include_once("form_tbbillruang_adm_js0.php");
?>
<script type="text/javascript"> 
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_tbbillruang_adm'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_tbbillruang_adm'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbillruang_adm']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbillruang_adm']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbillruang_adm']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbillruang_adm']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbillruang_adm']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbillruang_adm']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbillruang_adm']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbillruang_adm']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbillruang_adm']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbillruang_adm']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbillruang_adm']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbillruang_adm']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbillruang_adm']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbillruang_adm']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbillruang_adm']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbillruang_adm']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbillruang_adm']['fast_search'][2] : "";
?> 
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbillruang_adm']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbillruang_adm']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbillruang_adm']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbillruang_adm']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbillruang_adm']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbillruang_adm']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbillruang_adm']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbillruang_adm']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbillruang_adm']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbillruang_adm']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
{ 
   ...
   { 
       ob_start();
       $iStart = sizeof($this->form_vert_form_tbbillruang_adm);
       $guarda_nmgp_opcao = $this->nmgp_opcao;
       $guarda_form_vert_form_tbbillruang_adm = $this->form_vert_form_tbbillruang_adm;
       $this->nmgp_opcao = 'novo';
   } 
   if ($this->Embutida_form && empty($this->form_vert_form_tbbillruang_adm))
   {
       $sc_seq_vert = 0;
   }
   ...
   foreach ($this->form_vert_form_tbbillruang_adm as $sc_seq_vert => $sc_lixo)
   {
       $this->loadRecordState($sc_seq_vert);
       $this->custcode_ = $this->form_vert_form_tbbillruang_adm[$sc_seq_vert]['custcode_'];
       $this->status_ = $this->form_vert_form_tbbillruang_adm[$sc_seq_vert]['status_'];
       $this->kelasbayar_ = $this->form_vert_form_tbbillruang_adm[$sc_seq_vert]['kelasbayar_'];
       ...
       elseif ($Line_Add)
       {
        ...
        $this->check_in_ = $this->form_vert_form_tbbillruang_adm[$sc_seq_vert]['check_in_']; 
       $check_in_ = $this->check_in_; 
       $this->check_in__hora = $this->form_vert_form_tbbillruang_adm[$sc_seq_vert]['check_in__hora']; 
       ...
       $this->check_out_ = $this->form_vert_form_tbbillruang_adm[$sc_seq_vert]['check_out_']; 
       $check_out_ = $this->check_out_; 
       $this->check_out__hora = $this->form_vert_form_tbbillruang_adm[$sc_seq_vert]['check_out__hora']; 
       ...
       $this->lama_ = $this->form_vert_form_tbbillruang_adm[$sc_seq_vert]['lama_']; 
       $lama_ = $this->lama_; 
       $sStyleHidden_lama_ = '';
       ...
       $this->bed_ = $this->form_vert_form_tbbillruang_adm[$sc_seq_vert]['bed_']; 
       $bed_ = $this->bed_; 
       $sStyleHidden_bed_ = '';
       ...
       $this->rate_ = $this->form_vert_form_tbbillruang_adm[$sc_seq_vert]['rate_']; 
       $rate_ = $this->rate_; 
       $sStyleHidden_rate_ = '';
       ...
       $this->disc_ = $this->form_vert_form_tbbillruang_adm[$sc_seq_vert]['disc_']; 
       $disc_ = $this->disc_; 
       $sStyleHidden_disc_ = '';
       ...
       $this->keperawatan_ = $this->form_vert_form_tbbillruang_adm[$sc_seq_vert]['keperawatan_']; 
       ...
       $this->id_ = $this->form_vert_form_tbbillruang_adm[$sc_seq_vert]['id_']; 
       $id_ = $this->id_; 
       if (!isset($this->nmgp_cmp_hidden['id_']))
       {
           $this->nmgp_cmp_hidden['id_'] = 'off';
       ...
       $this->trandate_ = $this->form_vert_form_tbbillruang_adm[$sc_seq_vert]['trandate_'] . ' ' . $this->form_vert_form_tbbillruang_adm[$sc_seq_vert]['trandate__hora']; 
       ...
       $this->trancode_ = $this->form_vert_form_tbbillruang_adm[$sc_seq_vert]['trancode_']; 
       ...
       $this->sc_field_0_ = $this->form_vert_form_tbbillruang_adm[$sc_seq_vert]['sc_field_0_']; 
...
<?php echo nmButtonOutput($this->arr_buttons, "bmd_novo", "do_ajax_form_tbbillruang_adm_add_new_line(" . $sc_seq_vert . ")", "do_ajax_form_tbbillruang_adm_add_new_line(" . $sc_seq_vert . ")", "sc_new_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
<?php }?>
<?php
  $Style_add_line = (!$Line_Add) ? "display: none" : "";
?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_form_tbbillruang_adm_cancel_insert(" . $sc_seq_vert . ")", "do_ajax_form_tbbillruang_adm_cancel_insert(" . $sc_seq_vert . ")", "sc_canceli_line_" . $sc_seq_vert . "", "", "", "" . $Style_add_line . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_form_tbbillruang_adm_cancel_update(" . $sc_seq_vert . ")", "do_ajax_form_tbbillruang_adm_cancel_update(" . $sc_seq_vert . ")", "sc_cancelu_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
 </TD>
   <?php }?>
...
<span id="id_read_on_keperawatan_<?php echo $sc_seq_vert ?>" class="sc-ui-readonly-keperawatan_<?php echo $sc_seq_vert ?> css_keperawatan__line" style="<?php echo $sStyleReadLab_keperawatan_; ?>"><?php echo $this->keperawatan_; ?></span><span id="id_read_off_keperawatan_<?php echo $sc_seq_vert ?>" class="css_read_off_keperawatan_" style="white-space: nowrap;<?php echo $sStyleReadInp_keperawatan_; ?>">
 ...
 size=12 alt="{datatype: 'currency', currencySymbol: '<?php echo $this->field_config['keperawatan_']['symbol_mon']; ?>', currencyPosition: '<?php echo ((1 == $this->field_config['keperawatan_']['format_pos'] || 3 == $this->field_config['keperawatan_']['format_pos']) ? 'left' : 'right'); ?>', maxLength: 12, precision: 0, decimalSep: '<?php echo str_replace("'", "\'", $this->field_config['keperawatan_']['symbol_dec']); ?>', thousandsSep: '<?php echo str_replace("'", "\'", $this->field_config['keperawatan_']['symbol_grp']); ?>', thousandsFormat: <?php echo $this->field_config['keperawatan_']['symbol_fmt']; ?>, manualDecimals: false, allowNegative: false, onlyNegative: false, negativePos: <?php echo (4 == $this->field_config['keperawatan_']['format_neg'] ? "'suffix'" : "'prefix'") ?>, alignment: 'left', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddMultWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
...
<?php   
   ...
   { 
       ...
       $this->form_vert_form_tbbillruang_adm = $guarda_form_vert_form_tbbillruang_adm;
   } 
   if ($Table_refresh) 
   { 
...
<?php
if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbillruang_adm']['run_modal']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbillruang_adm']['run_modal'])
{
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbillruang_adm']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbillruang_adm']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_tbbillruang_adm");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_tbbillruang_adm");
 parent.scAjaxDetailHeight("form_tbbillruang_adm", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
<script type="text/javascript">
	function scBtnFn_sys_format_inc() {
		if ($("#sc_b_new_t.sc-unique-btn-1").length && $("#sc_b_new_t.sc-unique-btn-1").is(":visible")) {
			do_ajax_form_tbbillruang_adm_add_new_line(); return false;
			 return;
		}
...
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbillruang_adm']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
