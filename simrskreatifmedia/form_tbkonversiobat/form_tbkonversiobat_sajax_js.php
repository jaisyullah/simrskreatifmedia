  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbkonversiobat" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbkonversiobat_form();
	}

  // ---------- Validate konversisatuan_
  function do_ajax_form_tbkonversiobat_validate_konversisatuan_(iNumLinha)
  {
    var nomeCampo_konversisatuan_ = "konversisatuan_" + iNumLinha;
    var var_konversisatuan_ = scAjaxGetFieldText(nomeCampo_konversisatuan_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbkonversiobat_validate_konversisatuan_(var_konversisatuan_, iNumLinha, var_script_case_init, do_ajax_form_tbkonversiobat_validate_konversisatuan__cb);
  } // do_ajax_form_tbkonversiobat_validate_konversisatuan_

  function do_ajax_form_tbkonversiobat_validate_konversisatuan__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "konversisatuan_" + iLineNumber;
    }
    else
    {
      sFieldValid = "konversisatuan_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "konversisatuan_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "konversisatuan_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbkonversiobat_validate_konversisatuan__cb

  // ---------- Validate nilaikonversi_
  function do_ajax_form_tbkonversiobat_validate_nilaikonversi_(iNumLinha)
  {
    var nomeCampo_nilaikonversi_ = "nilaikonversi_" + iNumLinha;
    var var_nilaikonversi_ = scAjaxGetFieldText(nomeCampo_nilaikonversi_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbkonversiobat_validate_nilaikonversi_(var_nilaikonversi_, iNumLinha, var_script_case_init, do_ajax_form_tbkonversiobat_validate_nilaikonversi__cb);
  } // do_ajax_form_tbkonversiobat_validate_nilaikonversi_

  function do_ajax_form_tbkonversiobat_validate_nilaikonversi__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "nilaikonversi_" + iLineNumber;
    }
    else
    {
      sFieldValid = "nilaikonversi_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "nilaikonversi_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "nilaikonversi_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbkonversiobat_validate_nilaikonversi__cb

  // ---------- Validate satuandefault_
  function do_ajax_form_tbkonversiobat_validate_satuandefault_(iNumLinha)
  {
    var nomeCampo_satuandefault_ = "satuandefault_" + iNumLinha;
    var var_satuandefault_ = scAjaxGetFieldText(nomeCampo_satuandefault_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbkonversiobat_validate_satuandefault_(var_satuandefault_, iNumLinha, var_script_case_init, do_ajax_form_tbkonversiobat_validate_satuandefault__cb);
  } // do_ajax_form_tbkonversiobat_validate_satuandefault_

  function do_ajax_form_tbkonversiobat_validate_satuandefault__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "satuandefault_" + iLineNumber;
    }
    else
    {
      sFieldValid = "satuandefault_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "satuandefault_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "satuandefault_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbkonversiobat_validate_satuandefault__cb

  // ---------- Validate id_
  function do_ajax_form_tbkonversiobat_validate_id_(iNumLinha)
  {
    var nomeCampo_id_ = "id_" + iNumLinha;
    var var_id_ = scAjaxGetFieldHidden(nomeCampo_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbkonversiobat_validate_id_(var_id_, iNumLinha, var_script_case_init, do_ajax_form_tbkonversiobat_validate_id__cb);
  } // do_ajax_form_tbkonversiobat_validate_id_

  function do_ajax_form_tbkonversiobat_validate_id__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbkonversiobat_validate_id__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_tbkonversiobat_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_tbkonversiobat_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tbkonversiobat_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_tbkonversiobat_add_new_line_cb);
  } // do_ajax_form_tbkonversiobat_add_new_line

  function do_ajax_form_tbkonversiobat_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_tbkonversiobat_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_tbkonversiobat_backup_line(iNumLinha)
  {
    var var_id_ = scAjaxGetFieldHidden("id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbkonversiobat_backup_line(var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_tbkonversiobat_backup_line_cb);
  } // do_ajax_form_tbkonversiobat_backup_line

  function do_ajax_form_tbkonversiobat_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_tbkonversiobat_backup_line_cb

  function do_ajax_form_tbkonversiobat_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_tbkonversiobat_cancel_insert

  function do_ajax_form_tbkonversiobat_cancel_update(iSeqVert)
  {
    do_ajax_form_tbkonversiobat_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_tbkonversiobat_cancel_update

  function do_ajax_form_tbkonversiobat_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_tbkonversiobat_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_tbkonversiobat_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_tbkonversiobat_table_refresh(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbkonversiobat_table_refresh_cb);
  } //  do_ajax_form_tbkonversiobat_table_refresh

  function do_ajax_form_tbkonversiobat_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_tbkonversiobat_table_refresh_cb_after_alert);
  } // do_ajax_form_tbkonversiobat_table_refresh_cb
  function do_ajax_form_tbkonversiobat_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_tbkonversiobat_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_tbkonversiobat_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_tbkonversiobat_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    sc_num_ult_line = iNumLinha;
    sc_num_ult_tr   = indexTR;
    scAjaxHideMessage();
    var var_konversisatuan_ = scAjaxGetFieldText("konversisatuan_" + iNumLinha);
    var var_nilaikonversi_ = scAjaxGetFieldText("nilaikonversi_" + iNumLinha);
    var var_satuandefault_ = scAjaxGetFieldText("satuandefault_" + iNumLinha);
    var var_id_ = scAjaxGetFieldHidden("id_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_tbkonversiobat_submit_form(var_konversisatuan_, var_nilaikonversi_, var_satuandefault_, var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbkonversiobat_submit_form_cb);
  } // do_ajax_form_tbkonversiobat_submit_form

  function do_ajax_form_tbkonversiobat_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("konversisatuan_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("nilaikonversi_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("satuandefault_" + sc_num_ult_line);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_tbkonversiobat_submit_form_cb_after_alert);
  } // do_ajax_form_tbkonversiobat_submit_form_cb
  function do_ajax_form_tbkonversiobat_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbkonversiobat_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tbkonversiobat_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_tbkonversiobat_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("konversisatuan_" + iNavForm);
      scAjaxHideErrorDisplay("nilaikonversi_" + iNavForm);
      scAjaxHideErrorDisplay("satuandefault_" + iNavForm);
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tbkonversiobat_navigate_form(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbkonversiobat_navigate_form_cb);
  } // do_ajax_form_tbkonversiobat_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbkonversiobat']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbkonversiobat_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbkonversiobat_navigate_form_cb_after_alert);
  } // do_ajax_form_tbkonversiobat_navigate_form_cb
  function do_ajax_form_tbkonversiobat_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_tbkonversiobat_navigate_form_cb_after_alert
  function sc_hide_form_tbkonversiobat_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "konversisatuan_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "nilaikonversi_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "satuandefault_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "id_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["konversisatuan_" + iNumLinha] = {"label": "Konversi Satuan<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["nilaikonversi_" + iNumLinha] = {"label": "Nilai Konversi<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["satuandefault_" + iNumLinha] = {"label": "Satuan Default<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_field_mult["konversisatuan_"][iNumLinha] = "konversisatuan_" + iNumLinha;
    ajax_field_mult["nilaikonversi_"][iNumLinha] = "nilaikonversi_" + iNumLinha;
    ajax_field_mult["satuandefault_"][iNumLinha] = "satuandefault_" + iNumLinha;
    ajax_field_mult["id_"][iNumLinha] = "id_" + iNumLinha;
    ajax_field_id["konversisatuan_" + iNumLinha] = new Array("hidden_field_label_konversisatuan_", "hidden_field_data_konversisatuan_" + iNumLinha);
    ajax_field_id["nilaikonversi_" + iNumLinha] = new Array("hidden_field_label_nilaikonversi_", "hidden_field_data_nilaikonversi_" + iNumLinha);
    ajax_field_id["satuandefault_" + iNumLinha] = new Array("hidden_field_label_satuandefault_", "hidden_field_data_satuandefault_" + iNumLinha);
    ajax_error_count["konversisatuan_" + iNumLinha] = "off";
    ajax_error_count["nilaikonversi_" + iNumLinha] = "off";
    ajax_error_count["satuandefault_" + iNumLinha] = "off";
    ajax_error_count["id_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["konversisatuan_" + iNumLinha] = "off";
    ajax_read_only["nilaikonversi_" + iNumLinha] = "off";
    ajax_read_only["satuandefault_" + iNumLinha] = "off";
...
{
?>
    ajax_read_only["konversisatuan_" + iNumLinha] = "on";
    ajax_read_only["nilaikonversi_" + iNumLinha] = "on";
    ajax_read_only["satuandefault_" + iNumLinha] = "on";
    ajax_read_only["id_" + iNumLinha] = "on";
<?php
}
?>
  ...
  {
    ajax_error_list["konversisatuan_" + iNumLinha] = null;
    ajax_error_list["nilaikonversi_" + iNumLinha] = null;
    ajax_error_list["satuandefault_" + iNumLinha] = null;
  ...
  var ajax_field_mult = {
    "konversisatuan_": new Array(),
    "nilaikonversi_": new Array(),
    "satuandefault_": new Array(),
    "id_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["konversisatuan_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["konversisatuan_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["konversisatuan_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["konversisatuan_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["konversisatuan_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["nilaikonversi_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["nilaikonversi_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["nilaikonversi_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["nilaikonversi_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["nilaikonversi_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["satuandefault_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["satuandefault_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["satuandefault_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["satuandefault_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["satuandefault_" + iNumLinha]["onfocus"] = new Array();
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['konversisatuan_'])) ? $this->nmgp_cmp_readonly['konversisatuan_'] : 'off';
?>
    scAjaxFieldRead("konversisatuan_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['nilaikonversi_'])) ? $this->nmgp_cmp_readonly['nilaikonversi_'] : 'off';
?>
    scAjaxFieldRead("nilaikonversi_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['satuandefault_'])) ? $this->nmgp_cmp_readonly['satuandefault_'] : 'off';
?>
    scAjaxFieldRead("satuandefault_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
?>
  ...
  {
    scAjaxFieldRead("konversisatuan_" + iSeq, "on");
    scAjaxFieldRead("nilaikonversi_" + iSeq, "on");
    scAjaxFieldRead("satuandefault_" + iSeq, "on");
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["konversisatuan_" + iRow] || "on" == ajax_error_count["nilaikonversi_" + iRow] || "on" == ajax_error_count["satuandefault_" + iRow] || "on" == ajax_error_count["id_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_konversisatuan_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_nilaikonversi_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_satuandefault_" + iRow).addClass("scFormErrorLine");
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["konversisatuan_" + iRow] && "off" == ajax_error_count["nilaikonversi_" + iRow] && "off" == ajax_error_count["satuandefault_" + iRow] && "off" == ajax_error_count["id_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["konversisatuan_" + iRow] = "off";
        ajax_error_count["nilaikonversi_" + iRow] = "off";
        ajax_error_count["satuandefault_" + iRow] = "off";
      ...
      $("#hidden_field_data_konversisatuan_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_nilaikonversi_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_satuandefault_" + iRow).removeClass("scFormErrorLine");
