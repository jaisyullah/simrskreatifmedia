...
class grid_bybayar_igd_resumo
{
   ...
   function initializeButtons()
   {
      ...
      $this->nmgp_botoes['chart_exit'] = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['dashboard_info']['under_dashboard'] ? "off" : "on";
   ...
   { 
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['grid_bybayar_igd']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['grid_bybayar_igd']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['resumo_search']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['resumo_search']))
      { 
         $this->res_contr = new grid_bybayar_igd_apl();
     ...
     { 
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['res_hrz'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['where_resumo'] = "";
      }
      $this->inicializa_vars();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['contr_total_geral'] == "OK")
      {
          $this->array_total_bayar = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['arr_total']['bayar'];
      }
      else
      {
          $this->array_total_bayar = array();
      ...
      $Sv_tot_ger = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['tot_geral'];
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['contr_total_geral'] = "N";
      $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['SC_Ind_Groupby'];
      $tp_tot = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['Res_search_metric_use']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['Res_search_metric_use'])) ? true : false;
      $this->Total->$Gb_geral($tp_tot);
      $this->array_total_geral = array();
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['tot_geral'][1];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['tot_geral'][1] == 0)
      {
          $this->NM_res_sem_reg = true;
      }
      if (isset($Sv_tot_ger))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['tot_geral'] = $Sv_tot_ger;
          unset($Sv_tot_ger);
      }
      $this->resumo_init();
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          $this->drawMatrix();
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['arr_total']['bayar'] = $this->array_total_bayar;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['json_use_label'])
       {
          $Lab_bayar = "bayar";
       }
       else
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['labels']['bayar']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['labels']['bayar'] = "Bayar"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['labels']['tgl']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['labels']['tgl'] = "Tgl"; 
       }
       //-----
       $this->comp_field_nm = array(
           'bayar' => 0,
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['summarizing_fields_order']['Tgl']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['summarizing_fields_order']['Tgl'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['summarizing_fields_order']['Tgl'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['summarizing_fields_display']['Tgl'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['summarizing_fields_display']['Tgl'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['summarizing_fields_display']['Tgl'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['summarizing_fields_display']['Tgl'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['summarizing_fields_display']['Tgl'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['summarizing_fields_display']['Tgl'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['summarizing_fields_display']['Tgl'] as $i_sum => $d_sum)
           {
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['pivot_order_level'] = -1;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['pivot_tabular_label'];
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_bybayar_igd@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function buildChart()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['pivot_charts']    = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['pivot_orig']      = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['comb_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['comb_table_def']  = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['anlt_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['anlt_table_def']  = array();
	...
	function filterChartsByGroupbyLevel() {
		...
		if (isset($nmgp_opcao) && ('pdf' == $nmgp_opcao || 'pdf_res' == $nmgp_opcao) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['chart_level']) && '' !== $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['chart_level']) {
			$applyFilter = true;
		}
		elseif (isset($nmgp_opcao) && 'image_res' == $nmgp_opcao && isset($_POST['chart_level']) && '' !== $_POST['chart_level']) {
			$applyFilter = true;
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['chart_level'] = $_POST['chart_level'];
		}
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['pivot_charts'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['pivot_orig'];

		if ($applyFilter) {
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['pivot_charts'] as $chartIndex => $chartData) {
				...
				if ($groupbyLevel > $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['chart_level']) {
					unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['pivot_charts'][$chartIndex]);
				}
			}
		}

		$this->comp_chart_data = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['pivot_charts'];
	}
           ...
           foreach ($a_totals as $i_total => $values)
           {
               ...
               if (isset($this->comp_chart_config[$key_config]))
               {
                   ...
                   foreach ($a_keys as $tmp_key)
                   {
                       ...
                       $xml_links[]  = $this->getFusionLink('sc_grid_bybayar_igd_' . session_id() . '_!!!' . implode('_', array_merge(array($group + 1, $i_total), $link_index)) . '!!!.json');
                   }
                   ...
                   $this->comp_chart_data[$key_data]['xml']        = $this->getFusionLink('sc_grid_bybayar_igd_' . session_id() . '_!!!' . implode('_', array_merge(array($group, $i_total), $param)) . '!!!.json');
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['proc_pdf_vert']){ 
   ...
   {
       if (!$res_chart && $this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['json_use_format']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['json_use_format'])
       {
           return $valor_campo;
       }
   ...
   function resumo_init()
   {
      ...
      {
         $this->monta_html_ini();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['opcao'] != "pdf" && $_SESSION['scriptcase']['proc_mobile'])
         {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function inicializa_vars()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         require_once($this->Ini->path_aplicacao . "grid_bybayar_igd_total.class.php"); 
      }
      ...
      $this->Total   = new grid_bybayar_igd_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['arr_total'][$cmp_gb];
      }
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['dashboard_refresh_after_chart'] = 'resumo';
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['doc_word'])
{
   ...
   { 
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_bybayar_igd_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grid_bybayar_igd_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_bybayar_igd_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['num_css'] . '.css');
...
$nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_bybayar_igd/grid_bybayar_igd_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\">\r\n");
           ...
           $nm_saida->saida("     }\r\n");
           $nm_saida->saida("   </script>\r\n");
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['ajax_nav'] && !$this->Ini->sc_export_ajax && !$this->Ini->Export_html_zip && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['doc_word'])
      {
           $nm_saida->saida("   <script type=\"text/javascript\"> \r\n");
          ...
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['grid_pesq']))
          { 
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['doc_word']) 
      {
      ...
      {
          $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['dashboard_info']['remove_margin'] ? ' style="margin: 0"' : '';
          $nm_saida->saida(" <BODY class=\"" . $this->css_scGridPage . "\"" . $remove_margin . ">\r\n");
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['embutida'])
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top_mobile()
   {
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['ajax_nav'] && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['where_resumo_search']))
      {
          $this->NM_res_sem_reg = false;
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['embutida'])
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['pdf'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "Rpdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_bybayar_igd/grid_bybayar_igd_config_pdf.php?nm_opc=pdf_res&nm_target=0&nm_cor=cor&papel=8&orientacao=1&bookmarks=1&largura=1200&conf_larg=S&conf_fonte=10&grafico=S&sc_ver_93=" . s . "&nm_tem_gb=s&nm_res_cons=s&nm_ini_pdf_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&summary_export_columns=S&nm_label_group=N&nm_all_cab=S&nm_all_label=S&pdf_zip=N&nm_orient_grid=2&origem=res&language=id&conf_socor=N&script_case_init=" . $this->Ini->sc_page . "&app_name=grid_bybayar_igd&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['word'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "Rword_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_bybayar_igd/grid_bybayar_igd_config_word.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_cor=CO&nm_res_cons=s&nm_ini_word_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&origem=res&language=id&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['xls'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bexcel", "", "", "Rxls_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_bybayar_igd/grid_bybayar_igd_config_xls.php?script_case_init=" . $this->Ini->sc_page . "&app_name=grid_bybayar_igd&nm_tp_xls=xlsx&nm_tot_xls=S&nm_tot_xls=S&nm_res_cons=s&nm_ini_xls_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&summary_export_columns=S&origem=res&language=&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['xml'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bxml", "", "", "Rxml_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_bybayar_igd/grid_bybayar_igd_config_xml.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=s&nm_ini_xml_res=grid,resume,chart&nm_all_modules=grid,resume,chart&nm_xml_tag=tag&nm_xml_label=S&language=&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['csv'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcsv", "", "", "Rcsv_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_bybayar_igd/grid_bybayar_igd_config_csv.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_res_cons=s&nm_ini_csv_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&nm_delim_line=1&nm_delim_col=1&nm_delim_dados=1&nm_label_csv=N&language=&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if ($this->nmgp_botoes['chart_detail'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("grid_bybayar_igd_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
   ...
   function monta_html_fim()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['print_all'])
      {
          $this->grafico_pdf();
      }
      $nm_saida->saida("</TABLE>\r\n");
      $nm_saida->saida("<link rel=\"stylesheet\" type=\"text/css\" href=\"../_lib/css/" . $this->Ini->str_schema_all . "_sweetalert.css\" />\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_bybayar_igd']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_bybayar_igd']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'grid_bybayar_igd_config_pivot.php?nome_apl=grid_bybayar_igd&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=id&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_bybayar_igd_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "grid_bybayar_igd/grid_bybayar_igd_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
...
//--- 
   function monta_resumo_search()
   {
      ...
      $this->html_resumo_search();
       ...
       { 
           ...
           $_SESSION['scriptcase']['saida_html'] = "";
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['resumo_search_look']))
           { 
               $this->Ini->Arr_result['setArr'][] = array('var' => 'Tab_obj_res_combo', 'value' => '');
               foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['resumo_search_look'] as $cada_combo => $opcs_combo)
               { 
               ...
               if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['resumo_search_look']))
               { 
   ...
   {
       global $nm_saida;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['res_search_label'] = array();
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['resumo_search']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['resumo_search']         = array();
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['resumo_search_look']    = array();
   ...
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['resumo_search']['Tgl_SC_1']))
       {
       ...
       $disabled  = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['resumo_search_look']['Tgl_SC_1'])) ? "" : " disabled";
       $lin_obj  .= "   <option value='__NM__' selected='selected'" . $disabled . ">" . $this->Ini->Nm_lang['lang_search_select_summary'] . "</option>";
       $selected  = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['resumo_search_look']['Tgl_SC_1']) && in_array('month_jan', $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['resumo_search_look']['Tgl_SC_1'])) ? " selected" : "";
       $lin_obj  .= "   <option value=\"month_jan\"" . $selected . ">" . $this->Ini->Nm_lang['lang_mnth_janu'] . "</option>";
       $selected  = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['resumo_search_look']['Tgl_SC_1']) && in_array('month_feb', $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['resumo_search_look']['Tgl_SC_1'])) ? " selected" : "";
       $lin_obj  .= "   <option value=\"month_feb\"" . $selected . ">" . $this->Ini->Nm_lang['lang_mnth_febr'] . "</option>";
       $selected  = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['resumo_search_look']['Tgl_SC_1']) && in_array('month_mar', $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['resumo_search_look']['Tgl_SC_1'])) ? " selected" : "";
       $lin_obj  .= "   <option value=\"month_mar\"" . $selected . ">" . $this->Ini->Nm_lang['lang_mnth_marc'] . "</option>";
       $selected  = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['resumo_search_look']['Tgl_SC_1']) && in_array('month_apr', $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['resumo_search_look']['Tgl_SC_1'])) ? " selected" : "";
       $lin_obj  .= "   <option value=\"month_apr\"" . $selected . ">" . $this->Ini->Nm_lang['lang_mnth_apri'] . "</option>";
       $selected  = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['resumo_search_look']['Tgl_SC_1']) && in_array('month_may', $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['resumo_search_look']['Tgl_SC_1'])) ? " selected" : "";
       $lin_obj  .= "   <option value=\"month_may\"" . $selected . ">" . $this->Ini->Nm_lang['lang_mnth_mayy'] . "</option>";
       $selected  = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['resumo_search_look']['Tgl_SC_1']) && in_array('month_jun', $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['resumo_search_look']['Tgl_SC_1'])) ? " selected" : "";
       $lin_obj  .= "   <option value=\"month_jun\"" . $selected . ">" . $this->Ini->Nm_lang['lang_mnth_june'] . "</option>";
       $selected  = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['resumo_search_look']['Tgl_SC_1']) && in_array('month_jul', $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['resumo_search_look']['Tgl_SC_1'])) ? " selected" : "";
       $lin_obj  .= "   <option value=\"month_jul\"" . $selected . ">" . $this->Ini->Nm_lang['lang_mnth_july'] . "</option>";
       $selected  = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['resumo_search_look']['Tgl_SC_1']) && in_array('month_aug', $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['resumo_search_look']['Tgl_SC_1'])) ? " selected" : "";
       $lin_obj  .= "   <option value=\"month_aug\"" . $selected . ">" . $this->Ini->Nm_lang['lang_mnth_augu'] . "</option>";
       $selected  = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['resumo_search_look']['Tgl_SC_1']) && in_array('month_sep', $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['resumo_search_look']['Tgl_SC_1'])) ? " selected" : "";
       $lin_obj  .= "   <option value=\"month_sep\"" . $selected . ">" . $this->Ini->Nm_lang['lang_mnth_sept'] . "</option>";
       $selected  = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['resumo_search_look']['Tgl_SC_1']) && in_array('month_oct', $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['resumo_search_look']['Tgl_SC_1'])) ? " selected" : "";
       $lin_obj  .= "   <option value=\"month_oct\"" . $selected . ">" . $this->Ini->Nm_lang['lang_mnth_octo'] . "</option>";
       $selected  = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['resumo_search_look']['Tgl_SC_1']) && in_array('month_nov', $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['resumo_search_look']['Tgl_SC_1'])) ? " selected" : "";
       $lin_obj  .= "   <option value=\"month_nov\"" . $selected . ">" . $this->Ini->Nm_lang['lang_mnth_nove'] . "</option>";
       $selected  = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['resumo_search_look']['Tgl_SC_1']) && in_array('month_dec', $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bybayar_igd']['resumo_search_look']['Tgl_SC_1'])) ? " selected" : "";
