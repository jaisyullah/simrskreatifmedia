...
function displayChange_field_pendidikan(row, status) {
	if ("on" == status && typeof $("#nmsc_iframe_liga_form_hrm_pendidikan")[0].contentWindow.scRecreateSelect2 === "function") {
		$("#nmsc_iframe_liga_form_hrm_pendidikan")[0].contentWindow.scRecreateSelect2();
	}
}

function displayChange_field_jabatan(row, status) {
	if ("on" == status && typeof $("#nmsc_iframe_liga_form_hrm_jabatan_karyawan")[0].contentWindow.scRecreateSelect2 === "function") {
		$("#nmsc_iframe_liga_form_hrm_jabatan_karyawan")[0].contentWindow.scRecreateSelect2();
	}
}

function displayChange_field_sc_field_0(row, status) {
	if ("on" == status && typeof $("#nmsc_iframe_liga_form_hrm_kontrak_kerja")[0].contentWindow.scRecreateSelect2 === "function") {
		$("#nmsc_iframe_liga_form_hrm_kontrak_kerja")[0].contentWindow.scRecreateSelect2();
	}
}
...
function displayChange_field_peringatan(row, status) {
	if ("on" == status && typeof $("#nmsc_iframe_liga_form_hrm_peringatan")[0].contentWindow.scRecreateSelect2 === "function") {
		$("#nmsc_iframe_liga_form_hrm_peringatan")[0].contentWindow.scRecreateSelect2();
	}
}

function displayChange_field_penilaian(row, status) {
	if ("on" == status && typeof $("#nmsc_iframe_liga_form_hrm_penilaian")[0].contentWindow.scRecreateSelect2 === "function") {
		$("#nmsc_iframe_liga_form_hrm_penilaian")[0].contentWindow.scRecreateSelect2();
	}
}

function displayChange_field_pembinaan(row, status) {
	if ("on" == status && typeof $("#nmsc_iframe_liga_form_hrm_pembinaan")[0].contentWindow.scRecreateSelect2 === "function") {
		$("#nmsc_iframe_liga_form_hrm_pembinaan")[0].contentWindow.scRecreateSelect2();
	}
}

function displayChange_field_sc_field_2(row, status) {
	if ("on" == status && typeof $("#nmsc_iframe_liga_form_hrm_ikatan_dinas")[0].contentWindow.scRecreateSelect2 === "function") {
		$("#nmsc_iframe_liga_form_hrm_ikatan_dinas")[0].contentWindow.scRecreateSelect2();
	}
}

function displayChange_field_penugasan(row, status) {
	if ("on" == status && typeof $("#nmsc_iframe_liga_form_hrm_penugasan")[0].contentWindow.scRecreateSelect2 === "function") {
		$("#nmsc_iframe_liga_form_hrm_penugasan")[0].contentWindow.scRecreateSelect2();
	}
}

function displayChange_field_penghargaan(row, status) {
	if ("on" == status && typeof $("#nmsc_iframe_liga_form_hrm_penghargaan")[0].contentWindow.scRecreateSelect2 === "function") {
		$("#nmsc_iframe_liga_form_hrm_penghargaan")[0].contentWindow.scRecreateSelect2();
	}
}
...
function scHidePage(pageNo) {
	$("#id_form_hrm_karyawan_form" + pageNo).hide();
}
...
function scJQUploadAdd(iSeqRow) {
  $("#id_sc_field_foto" + iSeqRow).fileupload({
    datatype: "json",
    url: "form_hrm_karyawan_ul_save.php",
    dropZone: "",
    formData: function() {
      return [
