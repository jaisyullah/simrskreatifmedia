  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbrujukanlab_old" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbrujukanlab_old_form();
	}

  // ---------- Validate labcode_
  function do_ajax_form_tbrujukanlab_old_validate_labcode_(iNumLinha)
  {
  } // do_ajax_form_tbrujukanlab_old_validate_labcode_

  function do_ajax_form_tbrujukanlab_old_validate_labcode__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbrujukanlab_old_validate_labcode__cb

  // ---------- Validate doccode_
  function do_ajax_form_tbrujukanlab_old_validate_doccode_(iNumLinha)
  {
    var nomeCampo_doccode_ = "doccode_" + iNumLinha;
    var var_doccode_ = scAjaxGetFieldSelect(nomeCampo_doccode_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbrujukanlab_old_validate_doccode_(var_doccode_, iNumLinha, var_script_case_init, do_ajax_form_tbrujukanlab_old_validate_doccode__cb);
  } // do_ajax_form_tbrujukanlab_old_validate_doccode_

  function do_ajax_form_tbrujukanlab_old_validate_doccode__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbrujukanlab_old_validate_doccode__cb

  // ---------- Validate trandate_
  function do_ajax_form_tbrujukanlab_old_validate_trandate_(iNumLinha)
  {
    var nomeCampo_trandate_ = "trandate_" + iNumLinha;
    var var_trandate_ = scAjaxGetFieldText(nomeCampo_trandate_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbrujukanlab_old_validate_trandate_(var_trandate_, iNumLinha, var_script_case_init, do_ajax_form_tbrujukanlab_old_validate_trandate__cb);
  } // do_ajax_form_tbrujukanlab_old_validate_trandate_

  function do_ajax_form_tbrujukanlab_old_validate_trandate__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbrujukanlab_old_validate_trandate__cb

  // ---------- Validate id_
  function do_ajax_form_tbrujukanlab_old_validate_id_(iNumLinha)
  {
    var nomeCampo_id_ = "id_" + iNumLinha;
    var var_id_ = scAjaxGetFieldHidden(nomeCampo_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbrujukanlab_old_validate_id_(var_id_, iNumLinha, var_script_case_init, do_ajax_form_tbrujukanlab_old_validate_id__cb);
  } // do_ajax_form_tbrujukanlab_old_validate_id_

  function do_ajax_form_tbrujukanlab_old_validate_id__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbrujukanlab_old_validate_id__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_tbrujukanlab_old_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_tbrujukanlab_old_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tbrujukanlab_old_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_tbrujukanlab_old_add_new_line_cb);
  } // do_ajax_form_tbrujukanlab_old_add_new_line

  function do_ajax_form_tbrujukanlab_old_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_tbrujukanlab_old_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_tbrujukanlab_old_backup_line(iNumLinha)
  {
    var var_id_ = scAjaxGetFieldHidden("id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbrujukanlab_old_backup_line(var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_tbrujukanlab_old_backup_line_cb);
  } // do_ajax_form_tbrujukanlab_old_backup_line

  function do_ajax_form_tbrujukanlab_old_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_tbrujukanlab_old_backup_line_cb

  function do_ajax_form_tbrujukanlab_old_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_tbrujukanlab_old_cancel_insert

  function do_ajax_form_tbrujukanlab_old_cancel_update(iSeqVert)
  {
    do_ajax_form_tbrujukanlab_old_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_tbrujukanlab_old_cancel_update

  function do_ajax_form_tbrujukanlab_old_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_tbrujukanlab_old_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_tbrujukanlab_old_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_tbrujukanlab_old_table_refresh(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbrujukanlab_old_table_refresh_cb);
  } //  do_ajax_form_tbrujukanlab_old_table_refresh

  function do_ajax_form_tbrujukanlab_old_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_tbrujukanlab_old_table_refresh_cb_after_alert);
  } // do_ajax_form_tbrujukanlab_old_table_refresh_cb
  function do_ajax_form_tbrujukanlab_old_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_tbrujukanlab_old_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_tbrujukanlab_old_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_tbrujukanlab_old_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
...
?>
    x_ajax_form_tbrujukanlab_old_submit_form(var_labcode_, var_doccode_, var_trandate_, var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbrujukanlab_old_submit_form_cb);
  } // do_ajax_form_tbrujukanlab_old_submit_form

  function do_ajax_form_tbrujukanlab_old_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_tbrujukanlab_old_submit_form_cb_after_alert);
  } // do_ajax_form_tbrujukanlab_old_submit_form_cb
  function do_ajax_form_tbrujukanlab_old_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbrujukanlab_old_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tbrujukanlab_old_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_tbrujukanlab_old_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tbrujukanlab_old_navigate_form(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbrujukanlab_old_navigate_form_cb);
  } // do_ajax_form_tbrujukanlab_old_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbrujukanlab_old']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbrujukanlab_old_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbrujukanlab_old_navigate_form_cb_after_alert);
  } // do_ajax_form_tbrujukanlab_old_navigate_form_cb
  function do_ajax_form_tbrujukanlab_old_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_tbrujukanlab_old_navigate_form_cb_after_alert
  function sc_hide_form_tbrujukanlab_old_form()
  {
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_error_list["labcode_" + iNumLinha] = {"label": "Nama Pemeriksaan<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["labcode_" + iRow] || "on" == ajax_error_count["doccode_" + iRow] || "on" == ajax_error_count["trandate_" + iRow] || "on" == ajax_error_count["id_" + iRow]))
    {
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["labcode_" + iRow] && "off" == ajax_error_count["doccode_" + iRow] && "off" == ajax_error_count["trandate_" + iRow] && "off" == ajax_error_count["id_" + iRow]))
    {
      if (bErrorRow)
      {
