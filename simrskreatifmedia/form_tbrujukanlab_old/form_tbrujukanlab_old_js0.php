...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_tbrujukanlab_old"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
function scForm_inline_submit(y, z) {
	Nm_Proc_Atualiz = true;
	do_ajax_form_tbrujukanlab_old_submit_form(y, z);
...
{
   nm_field_disabled("labcode_=disabled;doccode_=disabled;trandate_=disabled", "U");
