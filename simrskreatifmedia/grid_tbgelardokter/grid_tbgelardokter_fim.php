...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_tbgelardokter"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_tbgelardokter"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_tbgelardokter'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tbgelardokter']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_tbgelardokter']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tbgelardokter']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_tbgelardokter']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_tbgelardokter']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_tbgelardokter</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_tbgelardokter']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_tbgelardokter']['embutida_filho'] as $ind => $sc_init)
          {
