<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tbgelardokter']['sc_process_barr'] = true;
require_once('../grid_tbgelardokter/index.php');
unset($_SESSION['scriptcase']['grid_tbgelardokter']['sc_process_barr']);
$ExportCtrl = new grid_tbgelardokter_export_control;
$ExportCtrl->Export_barr();

class grid_tbgelardokter_export_control
{
