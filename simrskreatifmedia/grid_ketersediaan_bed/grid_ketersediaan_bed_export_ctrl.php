<?php
@session_start() ;
$_SESSION['scriptcase']['grid_ketersediaan_bed']['sc_process_barr'] = true;
require_once('../grid_ketersediaan_bed/index.php');
unset($_SESSION['scriptcase']['grid_ketersediaan_bed']['sc_process_barr']);
$ExportCtrl = new grid_ketersediaan_bed_export_control;
$ExportCtrl->Export_barr();

class grid_ketersediaan_bed_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - Ketersediaan Bed :: Excel</TITLE>
