...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_kelas"  <?php echo $str_hide_kelas?>><?php
      if ($kelas != "")
      {
      $kelas_look = substr($this->Db->qstr($kelas), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_idbed"  <?php echo $str_hide_idbed?>><?php
      if ($idbed != "")
      {
      $idbed_look = substr($this->Db->qstr($idbed), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_nobed"  <?php echo $str_hide_nobed?>><?php
      if ($nobed != "")
      {
      $nobed_look = substr($this->Db->qstr($nobed), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_ruang"  <?php echo $str_hide_ruang?>><?php
      if ($ruang != "")
      {
      $ruang_look = substr($this->Db->qstr($ruang), 1, -1); 
      $nmgp_def_dados = array(); 
