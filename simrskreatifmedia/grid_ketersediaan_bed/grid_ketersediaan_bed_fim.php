...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_ketersediaan_bed"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_ketersediaan_bed"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_ketersediaan_bed']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_ketersediaan_bed']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_ketersediaan_bed']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_ketersediaan_bed']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_ketersediaan_bed']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_ketersediaan_bed</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_ketersediaan_bed']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_ketersediaan_bed']['embutida_filho'] as $ind => $sc_init)
          {
