...
?>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['embutida_pdf']))
 {
 ?>
...
<?php
include_once("form_vclaim_sep_hapus_mob_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_vclaim_sep_hapus_mob_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
?>
<body class="scFormPage" style="<?php echo $remove_margin . $str_iframe_body; ?>">
<?php

if (isset($_SESSION['scriptcase']['form_vclaim_sep_hapus']['error_buffer']) && '' != $_SESSION['scriptcase']['form_vclaim_sep_hapus']['error_buffer'])
{
    echo $_SESSION['scriptcase']['form_vclaim_sep_hapus']['error_buffer'];
}
...
<?php
 include_once("form_vclaim_sep_hapus_mob_js0.php");
?>
<script type="text/javascript"> 
...
<form  name="F1" method="post" 
               action="form_vclaim_sep_hapus_mob.php" 
               target="_self">
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_vclaim_sep_hapus_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_vclaim_sep_hapus_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<?php
  ...
  {
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['where_filter']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['empty_filter'] = true;
       }
  }
?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['Lookup_jnspelayanan'][] = '1'; ?>
 <option  value="2" <?php  if ($this->jnspelayanan == "2") { echo " selected" ;} ?>>Rawat Jalan</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['Lookup_jnspelayanan'][] = '2'; ?>
 </select></span>
</span><?php  }?>
 </TD>
   <?php }?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['Lookup_klsrawat'][] = '1'; ?>
 <option  value="2" <?php  if ($this->klsrawat == "2") { echo " selected" ;} ?>>Kelas 2</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['Lookup_klsrawat'][] = '2'; ?>
 <option  value="3" <?php  if ($this->klsrawat == "3") { echo " selected" ;} ?>>Kelas 3</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['Lookup_klsrawat'][] = '3'; ?>
 </select></span>
</span><?php  }?>
 </TD>
   <?php }?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['Lookup_asalrujukan'][] = '1'; ?>
 <option  value="2" <?php  if ($this->asalrujukan == "2") { echo " selected" ;} ?>>Faskes 2</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['Lookup_asalrujukan'][] = '2'; ?>
 </select></span>
</span><?php  }?>
 </TD>
   <?php }?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['Lookup_polieksekutif'][] = '0'; ?>
 <option  value="1" <?php  if ($this->polieksekutif == "1") { echo " selected" ;} ?>>Ya</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['Lookup_polieksekutif'][] = '1'; ?>
 </select></span>
</span><?php  }?>
 </TD>
   <?php }?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['Lookup_cob'][] = '0'; ?>
 <option  value="1" <?php  if ($this->cob == "1") { echo " selected" ;} ?>>Ya</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['Lookup_cob'][] = '1'; ?>
 </select></span>
</span><?php  }?>
 </TD>
   <?php }?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['Lookup_kejadianlakalantas'][] = '0'; ?>
 <option  value="1" <?php  if ($this->kejadianlakalantas == "1") { echo " selected" ;} ?>>Ya</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['Lookup_kejadianlakalantas'][] = '1'; ?>
 </select></span>
</span><?php  }?>
 </TD>
   <?php }?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['Lookup_penjaminlakalantas'][] = '1'; ?>
 <option  value="2" <?php  if ($this->penjaminlakalantas == "2") { echo " selected" ;} ?>>BPJS KETENAGAKERJAAN</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['Lookup_penjaminlakalantas'][] = '2'; ?>
 <option  value="3" <?php  if ($this->penjaminlakalantas == "3") { echo " selected" ;} ?>>TASPEN, PT</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['Lookup_penjaminlakalantas'][] = '3'; ?>
 <option  value="4" <?php  if ($this->penjaminlakalantas == "4") { echo " selected" ;} ?>>ASABRI,PT</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['Lookup_penjaminlakalantas'][] = '4'; ?>
 </select></span>
</span><?php  }?>
 </TD>
   <?php }?>
...
?>
       <?php echo nmButtonOutput($this->arr_buttons, "bok", "scBtnFn_sys_format_ok()", "scBtnFn_sys_format_ok()", "sub_form_b", "", "Hapus", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "sc-unique-btn-4", "", "");?>
...
<?php
           if (($nm_apl_dependente != 1) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['dashboard_info']['under_dashboard'])) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['nm_run_menu']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['nm_run_menu'] != 1))) {
...
<?php
           if (($nm_apl_dependente == 1) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['dashboard_info']['under_dashboard']))) {
        $sCondStyle = ($this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_vclaim_sep_hapus_mob");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_vclaim_sep_hapus_mob");
 parent.scAjaxDetailHeight("form_vclaim_sep_hapus_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
