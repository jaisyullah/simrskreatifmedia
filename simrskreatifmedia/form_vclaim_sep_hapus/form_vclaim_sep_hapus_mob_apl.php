<?php
//
class form_vclaim_sep_hapus_mob_apl
{
...
//----- 
   function ini_controle()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['form_vclaim_sep_hapus_mob']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['form_vclaim_sep_hapus_mob']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_vclaim_sep_hapus_mob']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_vclaim_sep_hapus_mob']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_vclaim_sep_hapus_mob']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_vclaim_sep_hapus_mob']['sc_redir_insert'] = $this->sc_redir_insert;
          }
      } 
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_vclaim_sep_hapus_mob']['parms']))
      {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_vclaim_sep_hapus_mob']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_vclaim_sep_hapus_mob']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_vclaim_sep_hapus_mob']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_vclaim_sep_hapus_mob']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_vclaim_sep_hapus_mob']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_vclaim_sep_hapus_mob']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_vclaim_sep_hapus_mob']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_vclaim_sep_hapus_mob']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_vclaim_sep_hapus_mob_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("id");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['initialize'];
          if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_vclaim_sep_hapus']))
          {
              foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_vclaim_sep_hapus'] as $I_conf => $Conf_opt)
              {
                  $_SESSION['scriptcase']['sc_apl_conf']['form_vclaim_sep_hapus_mob'][$I_conf]  = $Conf_opt;
              }
          }
      } 
      else 
      ...
      $_SESSION['sc_session'][$script_case_init]['form_vclaim_sep_hapus_mob']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_vclaim_sep_hapus_mob']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_vclaim_sep_hapus_mob'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_vclaim_sep_hapus_mob']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_vclaim_sep_hapus_mob']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_vclaim_sep_hapus_mob') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_vclaim_sep_hapus_mob']['label'] = "Hapus SEP";
          ...
          elseif ($this->Ini->sc_page == $this->sc_init_menu)
          {
              ...
              {
                  if ($apl == "form_vclaim_sep_hapus_mob")
                  {
                      $achou = true;
                  }
                  elseif ($achou)
      ...
      $_SESSION['scriptcase']['error_icon']['form_vclaim_sep_hapus_mob']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Rhino__NM__nm_scriptcase9_Rhino_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_vclaim_sep_hapus_mob'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['embutida_call'] : $this->Embutida_call;

       $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_hapus_mob']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_hapus_mob']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_hapus_mob']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_hapus_mob']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_hapus_mob']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_hapus_mob']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_hapus_mob']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_hapus_mob']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_hapus_mob']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_hapus_mob']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_hapus_mob']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_hapus_mob']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_hapus_mob']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_vclaim_sep_hapus_mob']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_vclaim_sep_hapus_mob']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_hapus_mob']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_hapus_mob']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_hapus_mob']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_vclaim_sep_hapus_mob']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_vclaim_sep_hapus_mob']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_hapus_mob']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_hapus_mob']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_vclaim_sep_hapus_mob']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_vclaim_sep_hapus_mob']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_hapus_mob']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_hapus_mob']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_hapus_mob']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_hapus_mob']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_hapus_mob']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_hapus_mob']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_hapus_mob']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_hapus_mob']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_hapus_mob']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_hapus_mob']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_hapus_mob']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_hapus_mob']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_hapus_mob']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_hapus_mob']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_hapus_mob']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_hapus_mob']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_hapus_mob']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_hapus_mob']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_hapus_mob']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_hapus_mob']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_vclaim_sep_hapus_mob']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_vclaim_sep_hapus_mob']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_vclaim_sep_hapus_mob']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_hapus_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_hapus_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_hapus_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_hapus_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_hapus_mob']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_hapus_mob']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_hapus_mob']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_hapus_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_hapus_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_hapus_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_hapus_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_hapus_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_hapus_mob']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_hapus_mob']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_hapus_mob']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_hapus_mob']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_hapus_mob']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_hapus_mob']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_hapus_mob']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_hapus_mob']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_hapus_mob']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_hapus_mob']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_hapus_mob']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_hapus_mob']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_hapus_mob']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_hapus_mob']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_hapus_mob']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_hapus_mob']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_hapus_mob']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_hapus_mob']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_hapus_mob']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_hapus_mob']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_hapus_mob']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_hapus_mob']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_hapus_mob']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_hapus_mob']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_hapus_mob']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_hapus_mob']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_hapus_mob']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_hapus_mob']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_vclaim_sep_hapus_mob'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_vclaim_sep_hapus_mob'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_vclaim_sep_hapus_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['form_vclaim_sep_hapus_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['form_vclaim_sep_hapus_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['form_vclaim_sep_hapus_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_vclaim_sep_hapus_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['form_vclaim_sep_hapus_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['form_vclaim_sep_hapus_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_vclaim_sep_hapus_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['form_vclaim_sep_hapus_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['form_vclaim_sep_hapus_mob']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_vclaim_sep_hapus_mob']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_vclaim_sep_hapus_mob']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_vclaim_sep_hapus_mob']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_vclaim_sep_hapus_mob']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_vclaim_sep_hapus_mob']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_vclaim_sep_hapus_mob']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_vclaim_sep_hapus_mob']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_vclaim_sep_hapus_mob']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['form_vclaim_sep_hapus_mob']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['dados_form'];
      }
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("form_vclaim_sep_hapus_mob", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (isset($_GET['nm_cal_display']))
      {
          ...
          { 
              include_once($this->Ini->path_embutida . 'form_vclaim_sep_hapus/form_vclaim_sep_hapus_mob_calendar.php');
          }
          else
          { 
              include_once($this->Ini->path_aplicacao . 'form_vclaim_sep_hapus_mob_calendar.php');
          }
          exit;
      }

      if (is_file($this->Ini->path_aplicacao . 'form_vclaim_sep_hapus_mob_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_vclaim_sep_hapus_mob_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      if ($this->Embutida_proc)
      { 
          require_once($this->Ini->path_embutida . 'form_vclaim_sep_hapus/form_vclaim_sep_hapus_mob_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_vclaim_sep_hapus_mob_erro.class.php"); 
      }
      $this->Erro      = new form_vclaim_sep_hapus_mob_erro();
      $this->Erro->Ini = $this->Ini;
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_vclaim_sep_hapus_mob']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_vclaim_sep_hapus_mob']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_vclaim_sep_hapus_mob']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['opc_ant'];
      } 
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['final'];
      }
      else
      {
      }
...
//
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['dados_select'];
     }
   }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
      ...
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "recarga_mobile" || $this->nmgp_opcao == "muda_form") 
      {
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['dados_select']['nosep']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->nosep = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['dados_select']['nosep'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['dados_select']['tglsep']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->tglsep = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['dados_select']['tglsep'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['dados_select']['ppkpelayanan']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->ppkpelayanan = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['dados_select']['ppkpelayanan'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['dados_select']['nmppkpelayanan']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->nmppkpelayanan = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['dados_select']['nmppkpelayanan'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['dados_select']['jnspelayanan']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->jnspelayanan = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['dados_select']['jnspelayanan'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['dados_select']['klsrawat']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->klsrawat = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['dados_select']['klsrawat'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['dados_select']['nomr']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->nomr = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['dados_select']['nomr'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['dados_select']['asalrujukan']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->asalrujukan = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['dados_select']['asalrujukan'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['dados_select']['norujukan']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->norujukan = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['dados_select']['norujukan'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['dados_select']['tglrujukan']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->tglrujukan = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['dados_select']['tglrujukan'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['dados_select']['ppkrujukan']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->ppkrujukan = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['dados_select']['ppkrujukan'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['dados_select']['nmppkrujukan']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->nmppkrujukan = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['dados_select']['nmppkrujukan'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['dados_select']['catatan']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->catatan = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['dados_select']['catatan'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['dados_select']['diagawal']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->diagawal = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['dados_select']['diagawal'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['dados_select']['nmdiagawal']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->nmdiagawal = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['dados_select']['nmdiagawal'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['dados_select']['politujuan']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->politujuan = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['dados_select']['politujuan'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['dados_select']['nmpolitujuan']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->nmpolitujuan = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['dados_select']['nmpolitujuan'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['dados_select']['polieksekutif']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->polieksekutif = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['dados_select']['polieksekutif'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['dados_select']['cob']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->cob = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['dados_select']['cob'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['dados_select']['kejadianlakalantas']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->kejadianlakalantas = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['dados_select']['kejadianlakalantas'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['dados_select']['penjaminlakalantas']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->penjaminlakalantas = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['dados_select']['penjaminlakalantas'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['dados_select']['lokasilakalantas']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->lokasilakalantas = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['dados_select']['lokasilakalantas'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['dados_select']['notelp']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->notelp = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['dados_select']['notelp'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['dados_select']['user']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->user = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['dados_select']['user'];
          } 
...
//
      if (!isset($nm_form_submit) && $this->nmgp_opcao != "nada")
      {
          ...
          $this->nmpolitujuan = "" ;  
          $this->nosep = "" ;  
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['dados_form']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['dados_form']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['dados_form'] as $NM_campo => $NM_valor)
              {
                  $$NM_campo = $NM_valor;
              }
          }
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['recarga'] = $this->nmgp_opcao;
      }
      if ($Campos_Crit != "" || !empty($Campos_Falta) || $this->Campos_Mens_erro != "" || $campos_erro != "" || !isset($this->bok) || $this->bok != "OK" || $this->nmgp_opcao == "recarga")
      {
          ...
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['campos']))
              { 
                  $nokartu = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['campos'][0]; 
                  $nama = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['campos'][1]; 
                  $nik = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['campos'][2]; 
                  $keterangan = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['campos'][3]; 
                  $sex = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['campos'][4]; 
                  $umursaatpelayanan = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['campos'][5]; 
                  $kodehakkelas = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['campos'][6]; 
                  $keteranganhakkelas = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['campos'][7]; 
                  $kodejenispeserta = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['campos'][8]; 
                  $keteranganjenispeserta = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['campos'][9]; 
                  $kdprovider = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['campos'][10]; 
                  $nmprovider = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['campos'][11]; 
                  $tglcetakkartu = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['campos'][12]; 
                  $tgltat = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['campos'][13]; 
                  $tgltmt = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['campos'][14]; 
                  $nosep = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['campos'][15]; 
                  $tglsep = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['campos'][16]; 
                  $ppkpelayanan = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['campos'][17]; 
                  $nmppkpelayanan = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['campos'][18]; 
                  $jnspelayanan = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['campos'][19]; 
                  $klsrawat = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['campos'][20]; 
                  $nomr = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['campos'][21]; 
                  $asalrujukan = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['campos'][22]; 
                  $norujukan = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['campos'][23]; 
                  $tglrujukan = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['campos'][24]; 
                  $ppkrujukan = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['campos'][25]; 
                  $nmppkrujukan = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['campos'][26]; 
                  $catatan = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['campos'][27]; 
                  $diagawal = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['campos'][28]; 
                  $nmdiagawal = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['campos'][29]; 
                  $politujuan = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['campos'][30]; 
                  $nmpolitujuan = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['campos'][31]; 
                  $polieksekutif = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['campos'][32]; 
                  $cob = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['campos'][33]; 
                  $kejadianlakalantas = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['campos'][34]; 
                  $penjaminlakalantas = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['campos'][35]; 
                  $lokasilakalantas = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['campos'][36]; 
                  $notelp = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['campos'][37]; 
                  $user = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['campos'][38]; 
              } 
          }
          $this->nm_gera_html();
      }
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['campos'] = array(); 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['campos'][0] = $this->nokartu; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['campos'][1] = $this->nama; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['campos'][2] = $this->nik; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['campos'][3] = $this->keterangan; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['campos'][4] = $this->sex; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['campos'][5] = $this->umursaatpelayanan; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['campos'][6] = $this->kodehakkelas; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['campos'][7] = $this->keteranganhakkelas; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['campos'][8] = $this->kodejenispeserta; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['campos'][9] = $this->keteranganjenispeserta; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['campos'][10] = $this->kdprovider; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['campos'][11] = $this->nmprovider; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['campos'][12] = $this->tglcetakkartu; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['campos'][13] = $this->tgltat; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['campos'][14] = $this->tgltmt; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['campos'][15] = $this->nosep; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['campos'][16] = $this->tglsep; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['campos'][17] = $this->ppkpelayanan; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['campos'][18] = $this->nmppkpelayanan; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['campos'][19] = $this->jnspelayanan; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['campos'][20] = $this->klsrawat; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['campos'][21] = $this->nomr; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['campos'][22] = $this->asalrujukan; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['campos'][23] = $this->norujukan; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['campos'][24] = $this->tglrujukan; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['campos'][25] = $this->ppkrujukan; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['campos'][26] = $this->nmppkrujukan; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['campos'][27] = $this->catatan; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['campos'][28] = $this->diagawal; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['campos'][29] = $this->nmdiagawal; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['campos'][30] = $this->politujuan; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['campos'][31] = $this->nmpolitujuan; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['campos'][32] = $this->polieksekutif; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['campos'][33] = $this->cob; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['campos'][34] = $this->kejadianlakalantas; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['campos'][35] = $this->penjaminlakalantas; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['campos'][36] = $this->lokasilakalantas; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['campos'][37] = $this->notelp; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['campos'][38] = $this->user; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['redir'] == "redir")
          {
          ...
          {
              $contr_menu = "";
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['iframe_menu'])
              {
                  $contr_menu = "glo_menu";
              }
              if (isset($_SESSION['scriptcase']['sc_ult_apl_menu']) && in_array("form_vclaim_sep_hapus_mob", $_SESSION['scriptcase']['sc_ult_apl_menu']))
              {
                  $this->nmgp_redireciona_form("form_vclaim_sep_hapus_mob_fim.php", $this->nm_location, $contr_menu); 
              }
              else
              {
                  $this->nm_gera_html();
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "form_vclaim_sep_hapus_mob.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob'][$path_doc_md5][1] = $Zip_name;
?>
<HTML<?php echo $_SESSION['scriptcase']['reg_conf']['html_dir'] ?>>
<HEAD>
 <TITLE><?php echo strip_tags("Hapus SEP") ?></TITLE>
...
<form name="Fdown" method="get" action="form_vclaim_sep_hapus_mob_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="form_vclaim_sep_hapus_mob"> 
<input type="hidden" name="nm_name_doc" value="<?php echo $path_doc_md5 ?>"> 
</form>
<form name="F0" method=post action="form_vclaim_sep_hapus_mob.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
...
//---------------------------------------------------------
     ...
     if ('' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_form_vclaim_sep_hapus_mob']) || !is_array($this->NM_ajax_info['errList']['geral_form_vclaim_sep_hapus_mob']))
              {
                  $this->NM_ajax_info['errList']['geral_form_vclaim_sep_hapus_mob'] = array();
              }
              $this->NM_ajax_info['errList']['geral_form_vclaim_sep_hapus_mob'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
...
//---
      ...
      if (empty($Campos_Crit) && empty($Campos_Falta) && empty($this->Campos_Mens_erro))
      {
          ...
          {
              $_SESSION['scriptcase']['form_vclaim_sep_hapus_mob']['contr_erro'] = 'on';
...
$cust_request = 'DELETE';
$conf		  = $this->rc_conf();
$url_rest	  = $conf['base_api_url'].'sep/delete';
...
$_SESSION['scriptcase']['form_vclaim_sep_hapus_mob']['contr_erro'] = 'off'; 
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['dados_form'] = $this->nmgp_dados_form;
   }
...
$aLookup[] = array(form_vclaim_sep_hapus_mob_pack_protect_string('1') => form_vclaim_sep_hapus_mob_pack_protect_string("Rawat Inap"));
$aLookup[] = array(form_vclaim_sep_hapus_mob_pack_protect_string('2') => form_vclaim_sep_hapus_mob_pack_protect_string("Rawat Jalan"));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['Lookup_jnspelayanan'][] = '1';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['Lookup_jnspelayanan'][] = '2';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['jnspelayanan']['valList'][$i] = form_vclaim_sep_hapus_mob_pack_protect_string($v);
          }
...
$aLookup[] = array(form_vclaim_sep_hapus_mob_pack_protect_string('1') => form_vclaim_sep_hapus_mob_pack_protect_string("Kelas 1"));
$aLookup[] = array(form_vclaim_sep_hapus_mob_pack_protect_string('2') => form_vclaim_sep_hapus_mob_pack_protect_string("Kelas 2"));
$aLookup[] = array(form_vclaim_sep_hapus_mob_pack_protect_string('3') => form_vclaim_sep_hapus_mob_pack_protect_string("Kelas 3"));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['Lookup_klsrawat'][] = '1';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['Lookup_klsrawat'][] = '2';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['Lookup_klsrawat'][] = '3';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['klsrawat']['valList'][$i] = form_vclaim_sep_hapus_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_vclaim_sep_hapus_mob_pack_protect_string('1') => form_vclaim_sep_hapus_mob_pack_protect_string("Faskes 1"));
$aLookup[] = array(form_vclaim_sep_hapus_mob_pack_protect_string('2') => form_vclaim_sep_hapus_mob_pack_protect_string("Faskes 2"));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['Lookup_asalrujukan'][] = '1';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['Lookup_asalrujukan'][] = '2';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['asalrujukan']['valList'][$i] = form_vclaim_sep_hapus_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_vclaim_sep_hapus_mob_pack_protect_string('0') => form_vclaim_sep_hapus_mob_pack_protect_string("Tidak"));
$aLookup[] = array(form_vclaim_sep_hapus_mob_pack_protect_string('1') => form_vclaim_sep_hapus_mob_pack_protect_string("Ya"));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['Lookup_polieksekutif'][] = '0';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['Lookup_polieksekutif'][] = '1';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['polieksekutif']['valList'][$i] = form_vclaim_sep_hapus_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_vclaim_sep_hapus_mob_pack_protect_string('0') => form_vclaim_sep_hapus_mob_pack_protect_string("Tidak"));
$aLookup[] = array(form_vclaim_sep_hapus_mob_pack_protect_string('1') => form_vclaim_sep_hapus_mob_pack_protect_string("Ya"));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['Lookup_cob'][] = '0';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['Lookup_cob'][] = '1';
          $aLookupOrig = $aLookup;
          $sSelComp = "name=\"cob\"";
          ...
          {
              $this->NM_ajax_info['fldList']['cob']['valList'][$i] = form_vclaim_sep_hapus_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_vclaim_sep_hapus_mob_pack_protect_string('0') => form_vclaim_sep_hapus_mob_pack_protect_string("Tidak"));
$aLookup[] = array(form_vclaim_sep_hapus_mob_pack_protect_string('1') => form_vclaim_sep_hapus_mob_pack_protect_string("Ya"));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['Lookup_kejadianlakalantas'][] = '0';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['Lookup_kejadianlakalantas'][] = '1';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['kejadianlakalantas']['valList'][$i] = form_vclaim_sep_hapus_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_vclaim_sep_hapus_mob_pack_protect_string('1') => form_vclaim_sep_hapus_mob_pack_protect_string("JASA RAHARJA"));
$aLookup[] = array(form_vclaim_sep_hapus_mob_pack_protect_string('2') => form_vclaim_sep_hapus_mob_pack_protect_string("BPJS KETENAGAKERJAAN"));
$aLookup[] = array(form_vclaim_sep_hapus_mob_pack_protect_string('3') => form_vclaim_sep_hapus_mob_pack_protect_string("TASPEN, PT"));
$aLookup[] = array(form_vclaim_sep_hapus_mob_pack_protect_string('4') => form_vclaim_sep_hapus_mob_pack_protect_string("ASABRI,PT"));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['Lookup_penjaminlakalantas'][] = '1';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['Lookup_penjaminlakalantas'][] = '2';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['Lookup_penjaminlakalantas'][] = '3';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['Lookup_penjaminlakalantas'][] = '4';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['penjaminlakalantas']['valList'][$i] = form_vclaim_sep_hapus_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   function ajax_return_values_user($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
    ...
    $this->nm_formatar_campos();
        $this->initFormPages();
    include_once("form_vclaim_sep_hapus_mob_form0.php");
        $this->hideFormPages();
 }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['table_refresh'])
        {
   ...
   function jqueryButtonText($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['csrf_token'];
    }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "form_vclaim_sep_hapus_mob_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_vclaim_sep_hapus_mob_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['masterValue']))
{
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['dashboard_info']['under_dashboard']) {
?>
var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['dashboard_info']['parent_widget']; ?>']");
if (dbParentFrame && dbParentFrame[0] && dbParentFrame[0].contentWindow.scAjaxDetailValue)
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['masterValue'] as $cmp_master => $val_master)
        {
?>
...
function nmgp_redireciona_form($nm_apl_dest, $nm_apl_retorno, $nm_apl_parms, $nm_target="", $opc="", $alt_modal=430, $larg_modal=630)
{
   ...
   if (is_array($nm_apl_parms))
   {
       ...
       foreach ($nm_apl_parms as $par => $val)
       {
           ...
           elseif (substr($val, 0, 1) == "[")
           {
               $tmp_parms .= $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob'][substr($val, 1, -1)];
           }
           else
           {
               $tmp_parms .= $val;
   ...
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['opcao'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus_mob']['retorno_edit'] = "";
   }
