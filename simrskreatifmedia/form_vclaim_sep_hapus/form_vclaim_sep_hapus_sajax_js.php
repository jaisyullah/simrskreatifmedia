  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_vclaim_sep_hapus" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_vclaim_sep_hapus_form();
	}

  // ---------- Validate nokartu
  function do_ajax_form_vclaim_sep_hapus_validate_nokartu()
  {
    var nomeCampo_nokartu = "nokartu";
    var var_nokartu = scAjaxGetFieldText(nomeCampo_nokartu);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_sep_hapus_validate_nokartu(var_nokartu, var_script_case_init, do_ajax_form_vclaim_sep_hapus_validate_nokartu_cb);
  } // do_ajax_form_vclaim_sep_hapus_validate_nokartu

  function do_ajax_form_vclaim_sep_hapus_validate_nokartu_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_sep_hapus_validate_nokartu_cb

  // ---------- Validate nama
  function do_ajax_form_vclaim_sep_hapus_validate_nama()
  {
    var nomeCampo_nama = "nama";
    var var_nama = scAjaxGetFieldText(nomeCampo_nama);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_sep_hapus_validate_nama(var_nama, var_script_case_init, do_ajax_form_vclaim_sep_hapus_validate_nama_cb);
  } // do_ajax_form_vclaim_sep_hapus_validate_nama

  function do_ajax_form_vclaim_sep_hapus_validate_nama_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nama";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_sep_hapus_validate_nama_cb

  // ---------- Validate nik
  function do_ajax_form_vclaim_sep_hapus_validate_nik()
  {
    var nomeCampo_nik = "nik";
    var var_nik = scAjaxGetFieldText(nomeCampo_nik);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_sep_hapus_validate_nik(var_nik, var_script_case_init, do_ajax_form_vclaim_sep_hapus_validate_nik_cb);
  } // do_ajax_form_vclaim_sep_hapus_validate_nik

  function do_ajax_form_vclaim_sep_hapus_validate_nik_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nik";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_sep_hapus_validate_nik_cb

  // ---------- Validate keterangan
  function do_ajax_form_vclaim_sep_hapus_validate_keterangan()
  {
    var nomeCampo_keterangan = "keterangan";
    var var_keterangan = scAjaxGetFieldText(nomeCampo_keterangan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_sep_hapus_validate_keterangan(var_keterangan, var_script_case_init, do_ajax_form_vclaim_sep_hapus_validate_keterangan_cb);
  } // do_ajax_form_vclaim_sep_hapus_validate_keterangan

  function do_ajax_form_vclaim_sep_hapus_validate_keterangan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_sep_hapus_validate_keterangan_cb

  // ---------- Validate sex
  function do_ajax_form_vclaim_sep_hapus_validate_sex()
  {
    var nomeCampo_sex = "sex";
    var var_sex = scAjaxGetFieldText(nomeCampo_sex);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_sep_hapus_validate_sex(var_sex, var_script_case_init, do_ajax_form_vclaim_sep_hapus_validate_sex_cb);
  } // do_ajax_form_vclaim_sep_hapus_validate_sex

  function do_ajax_form_vclaim_sep_hapus_validate_sex_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sex";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_sep_hapus_validate_sex_cb

  // ---------- Validate umursaatpelayanan
  function do_ajax_form_vclaim_sep_hapus_validate_umursaatpelayanan()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_sep_hapus_validate_umursaatpelayanan(var_umursaatpelayanan, var_script_case_init, do_ajax_form_vclaim_sep_hapus_validate_umursaatpelayanan_cb);
  } // do_ajax_form_vclaim_sep_hapus_validate_umursaatpelayanan

  function do_ajax_form_vclaim_sep_hapus_validate_umursaatpelayanan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_sep_hapus_validate_umursaatpelayanan_cb

  // ---------- Validate kodehakkelas
  function do_ajax_form_vclaim_sep_hapus_validate_kodehakkelas()
  {
    var nomeCampo_kodehakkelas = "kodehakkelas";
    var var_kodehakkelas = scAjaxGetFieldText(nomeCampo_kodehakkelas);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_sep_hapus_validate_kodehakkelas(var_kodehakkelas, var_script_case_init, do_ajax_form_vclaim_sep_hapus_validate_kodehakkelas_cb);
  } // do_ajax_form_vclaim_sep_hapus_validate_kodehakkelas

  function do_ajax_form_vclaim_sep_hapus_validate_kodehakkelas_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_sep_hapus_validate_kodehakkelas_cb

  // ---------- Validate keteranganhakkelas
  function do_ajax_form_vclaim_sep_hapus_validate_keteranganhakkelas()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_sep_hapus_validate_keteranganhakkelas(var_keteranganhakkelas, var_script_case_init, do_ajax_form_vclaim_sep_hapus_validate_keteranganhakkelas_cb);
  } // do_ajax_form_vclaim_sep_hapus_validate_keteranganhakkelas

  function do_ajax_form_vclaim_sep_hapus_validate_keteranganhakkelas_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_sep_hapus_validate_keteranganhakkelas_cb

  // ---------- Validate kodejenispeserta
  function do_ajax_form_vclaim_sep_hapus_validate_kodejenispeserta()
  {
    var nomeCampo_kodejenispeserta = "kodejenispeserta";
    var var_kodejenispeserta = scAjaxGetFieldText(nomeCampo_kodejenispeserta);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_sep_hapus_validate_kodejenispeserta(var_kodejenispeserta, var_script_case_init, do_ajax_form_vclaim_sep_hapus_validate_kodejenispeserta_cb);
  } // do_ajax_form_vclaim_sep_hapus_validate_kodejenispeserta

  function do_ajax_form_vclaim_sep_hapus_validate_kodejenispeserta_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_sep_hapus_validate_kodejenispeserta_cb

  // ---------- Validate keteranganjenispeserta
  function do_ajax_form_vclaim_sep_hapus_validate_keteranganjenispeserta()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_sep_hapus_validate_keteranganjenispeserta(var_keteranganjenispeserta, var_script_case_init, do_ajax_form_vclaim_sep_hapus_validate_keteranganjenispeserta_cb);
  } // do_ajax_form_vclaim_sep_hapus_validate_keteranganjenispeserta

  function do_ajax_form_vclaim_sep_hapus_validate_keteranganjenispeserta_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_sep_hapus_validate_keteranganjenispeserta_cb

  // ---------- Validate kdprovider
  function do_ajax_form_vclaim_sep_hapus_validate_kdprovider()
  {
    var nomeCampo_kdprovider = "kdprovider";
    var var_kdprovider = scAjaxGetFieldText(nomeCampo_kdprovider);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_sep_hapus_validate_kdprovider(var_kdprovider, var_script_case_init, do_ajax_form_vclaim_sep_hapus_validate_kdprovider_cb);
  } // do_ajax_form_vclaim_sep_hapus_validate_kdprovider

  function do_ajax_form_vclaim_sep_hapus_validate_kdprovider_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_sep_hapus_validate_kdprovider_cb

  // ---------- Validate nmprovider
  function do_ajax_form_vclaim_sep_hapus_validate_nmprovider()
  {
    var nomeCampo_nmprovider = "nmprovider";
    var var_nmprovider = scAjaxGetFieldText(nomeCampo_nmprovider);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_sep_hapus_validate_nmprovider(var_nmprovider, var_script_case_init, do_ajax_form_vclaim_sep_hapus_validate_nmprovider_cb);
  } // do_ajax_form_vclaim_sep_hapus_validate_nmprovider

  function do_ajax_form_vclaim_sep_hapus_validate_nmprovider_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_sep_hapus_validate_nmprovider_cb

  // ---------- Validate tglcetakkartu
  function do_ajax_form_vclaim_sep_hapus_validate_tglcetakkartu()
  {
    var nomeCampo_tglcetakkartu = "tglcetakkartu";
    var var_tglcetakkartu = scAjaxGetFieldText(nomeCampo_tglcetakkartu);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_sep_hapus_validate_tglcetakkartu(var_tglcetakkartu, var_script_case_init, do_ajax_form_vclaim_sep_hapus_validate_tglcetakkartu_cb);
  } // do_ajax_form_vclaim_sep_hapus_validate_tglcetakkartu

  function do_ajax_form_vclaim_sep_hapus_validate_tglcetakkartu_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_sep_hapus_validate_tglcetakkartu_cb

  // ---------- Validate tgltat
  function do_ajax_form_vclaim_sep_hapus_validate_tgltat()
  {
    var nomeCampo_tgltat = "tgltat";
    var var_tgltat = scAjaxGetFieldText(nomeCampo_tgltat);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_sep_hapus_validate_tgltat(var_tgltat, var_script_case_init, do_ajax_form_vclaim_sep_hapus_validate_tgltat_cb);
  } // do_ajax_form_vclaim_sep_hapus_validate_tgltat

  function do_ajax_form_vclaim_sep_hapus_validate_tgltat_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tgltat";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_sep_hapus_validate_tgltat_cb

  // ---------- Validate tgltmt
  function do_ajax_form_vclaim_sep_hapus_validate_tgltmt()
  {
    var nomeCampo_tgltmt = "tgltmt";
    var var_tgltmt = scAjaxGetFieldText(nomeCampo_tgltmt);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_sep_hapus_validate_tgltmt(var_tgltmt, var_script_case_init, do_ajax_form_vclaim_sep_hapus_validate_tgltmt_cb);
  } // do_ajax_form_vclaim_sep_hapus_validate_tgltmt

  function do_ajax_form_vclaim_sep_hapus_validate_tgltmt_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tgltmt";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_sep_hapus_validate_tgltmt_cb

  // ---------- Validate nosep
  function do_ajax_form_vclaim_sep_hapus_validate_nosep()
  {
    var nomeCampo_nosep = "nosep";
    var var_nosep = scAjaxGetFieldText(nomeCampo_nosep);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_sep_hapus_validate_nosep(var_nosep, var_script_case_init, do_ajax_form_vclaim_sep_hapus_validate_nosep_cb);
  } // do_ajax_form_vclaim_sep_hapus_validate_nosep

  function do_ajax_form_vclaim_sep_hapus_validate_nosep_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nosep";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_sep_hapus_validate_nosep_cb

  // ---------- Validate tglsep
  function do_ajax_form_vclaim_sep_hapus_validate_tglsep()
  {
    var nomeCampo_tglsep = "tglsep";
    var var_tglsep = scAjaxGetFieldText(nomeCampo_tglsep);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_sep_hapus_validate_tglsep(var_tglsep, var_script_case_init, do_ajax_form_vclaim_sep_hapus_validate_tglsep_cb);
  } // do_ajax_form_vclaim_sep_hapus_validate_tglsep

  function do_ajax_form_vclaim_sep_hapus_validate_tglsep_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tglsep";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_sep_hapus_validate_tglsep_cb

  // ---------- Validate ppkpelayanan
  function do_ajax_form_vclaim_sep_hapus_validate_ppkpelayanan()
  {
    var nomeCampo_ppkpelayanan = "ppkpelayanan";
    var var_ppkpelayanan = scAjaxGetFieldText(nomeCampo_ppkpelayanan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_sep_hapus_validate_ppkpelayanan(var_ppkpelayanan, var_script_case_init, do_ajax_form_vclaim_sep_hapus_validate_ppkpelayanan_cb);
  } // do_ajax_form_vclaim_sep_hapus_validate_ppkpelayanan

  function do_ajax_form_vclaim_sep_hapus_validate_ppkpelayanan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_sep_hapus_validate_ppkpelayanan_cb

  // ---------- Validate nmppkpelayanan
  function do_ajax_form_vclaim_sep_hapus_validate_nmppkpelayanan()
  {
    var nomeCampo_nmppkpelayanan = "nmppkpelayanan";
    var var_nmppkpelayanan = scAjaxGetFieldText(nomeCampo_nmppkpelayanan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_sep_hapus_validate_nmppkpelayanan(var_nmppkpelayanan, var_script_case_init, do_ajax_form_vclaim_sep_hapus_validate_nmppkpelayanan_cb);
  } // do_ajax_form_vclaim_sep_hapus_validate_nmppkpelayanan

  function do_ajax_form_vclaim_sep_hapus_validate_nmppkpelayanan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_sep_hapus_validate_nmppkpelayanan_cb

  // ---------- Validate jnspelayanan
  function do_ajax_form_vclaim_sep_hapus_validate_jnspelayanan()
  {
    var nomeCampo_jnspelayanan = "jnspelayanan";
    var var_jnspelayanan = scAjaxGetFieldSelect(nomeCampo_jnspelayanan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_sep_hapus_validate_jnspelayanan(var_jnspelayanan, var_script_case_init, do_ajax_form_vclaim_sep_hapus_validate_jnspelayanan_cb);
  } // do_ajax_form_vclaim_sep_hapus_validate_jnspelayanan

  function do_ajax_form_vclaim_sep_hapus_validate_jnspelayanan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_sep_hapus_validate_jnspelayanan_cb

  // ---------- Validate klsrawat
  function do_ajax_form_vclaim_sep_hapus_validate_klsrawat()
  {
    var nomeCampo_klsrawat = "klsrawat";
    var var_klsrawat = scAjaxGetFieldSelect(nomeCampo_klsrawat);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_sep_hapus_validate_klsrawat(var_klsrawat, var_script_case_init, do_ajax_form_vclaim_sep_hapus_validate_klsrawat_cb);
  } // do_ajax_form_vclaim_sep_hapus_validate_klsrawat

  function do_ajax_form_vclaim_sep_hapus_validate_klsrawat_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_sep_hapus_validate_klsrawat_cb

  // ---------- Validate nomr
  function do_ajax_form_vclaim_sep_hapus_validate_nomr()
  {
    var nomeCampo_nomr = "nomr";
    var var_nomr = scAjaxGetFieldText(nomeCampo_nomr);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_sep_hapus_validate_nomr(var_nomr, var_script_case_init, do_ajax_form_vclaim_sep_hapus_validate_nomr_cb);
  } // do_ajax_form_vclaim_sep_hapus_validate_nomr

  function do_ajax_form_vclaim_sep_hapus_validate_nomr_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nomr";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_sep_hapus_validate_nomr_cb

  // ---------- Validate asalrujukan
  function do_ajax_form_vclaim_sep_hapus_validate_asalrujukan()
  {
    var nomeCampo_asalrujukan = "asalrujukan";
    var var_asalrujukan = scAjaxGetFieldSelect(nomeCampo_asalrujukan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_sep_hapus_validate_asalrujukan(var_asalrujukan, var_script_case_init, do_ajax_form_vclaim_sep_hapus_validate_asalrujukan_cb);
  } // do_ajax_form_vclaim_sep_hapus_validate_asalrujukan

  function do_ajax_form_vclaim_sep_hapus_validate_asalrujukan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_sep_hapus_validate_asalrujukan_cb

  // ---------- Validate norujukan
  function do_ajax_form_vclaim_sep_hapus_validate_norujukan()
  {
    var nomeCampo_norujukan = "norujukan";
    var var_norujukan = scAjaxGetFieldText(nomeCampo_norujukan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_sep_hapus_validate_norujukan(var_norujukan, var_script_case_init, do_ajax_form_vclaim_sep_hapus_validate_norujukan_cb);
  } // do_ajax_form_vclaim_sep_hapus_validate_norujukan

  function do_ajax_form_vclaim_sep_hapus_validate_norujukan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_sep_hapus_validate_norujukan_cb

  // ---------- Validate tglrujukan
  function do_ajax_form_vclaim_sep_hapus_validate_tglrujukan()
  {
    var nomeCampo_tglrujukan = "tglrujukan";
    var var_tglrujukan = scAjaxGetFieldText(nomeCampo_tglrujukan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_sep_hapus_validate_tglrujukan(var_tglrujukan, var_script_case_init, do_ajax_form_vclaim_sep_hapus_validate_tglrujukan_cb);
  } // do_ajax_form_vclaim_sep_hapus_validate_tglrujukan

  function do_ajax_form_vclaim_sep_hapus_validate_tglrujukan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_sep_hapus_validate_tglrujukan_cb

  // ---------- Validate ppkrujukan
  function do_ajax_form_vclaim_sep_hapus_validate_ppkrujukan()
  {
    var nomeCampo_ppkrujukan = "ppkrujukan";
    var var_ppkrujukan = scAjaxGetFieldText(nomeCampo_ppkrujukan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_sep_hapus_validate_ppkrujukan(var_ppkrujukan, var_script_case_init, do_ajax_form_vclaim_sep_hapus_validate_ppkrujukan_cb);
  } // do_ajax_form_vclaim_sep_hapus_validate_ppkrujukan

  function do_ajax_form_vclaim_sep_hapus_validate_ppkrujukan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_sep_hapus_validate_ppkrujukan_cb

  // ---------- Validate nmppkrujukan
  function do_ajax_form_vclaim_sep_hapus_validate_nmppkrujukan()
  {
    var nomeCampo_nmppkrujukan = "nmppkrujukan";
    var var_nmppkrujukan = scAjaxGetFieldText(nomeCampo_nmppkrujukan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_sep_hapus_validate_nmppkrujukan(var_nmppkrujukan, var_script_case_init, do_ajax_form_vclaim_sep_hapus_validate_nmppkrujukan_cb);
  } // do_ajax_form_vclaim_sep_hapus_validate_nmppkrujukan

  function do_ajax_form_vclaim_sep_hapus_validate_nmppkrujukan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_sep_hapus_validate_nmppkrujukan_cb

  // ---------- Validate catatan
  function do_ajax_form_vclaim_sep_hapus_validate_catatan()
  {
    var nomeCampo_catatan = "catatan";
    var var_catatan = scAjaxGetFieldText(nomeCampo_catatan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_sep_hapus_validate_catatan(var_catatan, var_script_case_init, do_ajax_form_vclaim_sep_hapus_validate_catatan_cb);
  } // do_ajax_form_vclaim_sep_hapus_validate_catatan

  function do_ajax_form_vclaim_sep_hapus_validate_catatan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "catatan";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_sep_hapus_validate_catatan_cb

  // ---------- Validate diagawal
  function do_ajax_form_vclaim_sep_hapus_validate_diagawal()
  {
    var nomeCampo_diagawal = "diagawal";
    var var_diagawal = scAjaxGetFieldText(nomeCampo_diagawal);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_sep_hapus_validate_diagawal(var_diagawal, var_script_case_init, do_ajax_form_vclaim_sep_hapus_validate_diagawal_cb);
  } // do_ajax_form_vclaim_sep_hapus_validate_diagawal

  function do_ajax_form_vclaim_sep_hapus_validate_diagawal_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_sep_hapus_validate_diagawal_cb

  // ---------- Validate nmdiagawal
  function do_ajax_form_vclaim_sep_hapus_validate_nmdiagawal()
  {
    var nomeCampo_nmdiagawal = "nmdiagawal";
    var var_nmdiagawal = scAjaxGetFieldText(nomeCampo_nmdiagawal);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_sep_hapus_validate_nmdiagawal(var_nmdiagawal, var_script_case_init, do_ajax_form_vclaim_sep_hapus_validate_nmdiagawal_cb);
  } // do_ajax_form_vclaim_sep_hapus_validate_nmdiagawal

  function do_ajax_form_vclaim_sep_hapus_validate_nmdiagawal_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_sep_hapus_validate_nmdiagawal_cb

  // ---------- Validate politujuan
  function do_ajax_form_vclaim_sep_hapus_validate_politujuan()
  {
    var nomeCampo_politujuan = "politujuan";
    var var_politujuan = scAjaxGetFieldText(nomeCampo_politujuan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_sep_hapus_validate_politujuan(var_politujuan, var_script_case_init, do_ajax_form_vclaim_sep_hapus_validate_politujuan_cb);
  } // do_ajax_form_vclaim_sep_hapus_validate_politujuan

  function do_ajax_form_vclaim_sep_hapus_validate_politujuan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_sep_hapus_validate_politujuan_cb

  // ---------- Validate nmpolitujuan
  function do_ajax_form_vclaim_sep_hapus_validate_nmpolitujuan()
  {
    var nomeCampo_nmpolitujuan = "nmpolitujuan";
    var var_nmpolitujuan = scAjaxGetFieldText(nomeCampo_nmpolitujuan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_sep_hapus_validate_nmpolitujuan(var_nmpolitujuan, var_script_case_init, do_ajax_form_vclaim_sep_hapus_validate_nmpolitujuan_cb);
  } // do_ajax_form_vclaim_sep_hapus_validate_nmpolitujuan

  function do_ajax_form_vclaim_sep_hapus_validate_nmpolitujuan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_sep_hapus_validate_nmpolitujuan_cb

  // ---------- Validate polieksekutif
  function do_ajax_form_vclaim_sep_hapus_validate_polieksekutif()
  {
    var nomeCampo_polieksekutif = "polieksekutif";
    var var_polieksekutif = scAjaxGetFieldSelect(nomeCampo_polieksekutif);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_sep_hapus_validate_polieksekutif(var_polieksekutif, var_script_case_init, do_ajax_form_vclaim_sep_hapus_validate_polieksekutif_cb);
  } // do_ajax_form_vclaim_sep_hapus_validate_polieksekutif

  function do_ajax_form_vclaim_sep_hapus_validate_polieksekutif_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_sep_hapus_validate_polieksekutif_cb

  // ---------- Validate cob
  function do_ajax_form_vclaim_sep_hapus_validate_cob()
  {
    var nomeCampo_cob = "cob";
    var var_cob = scAjaxGetFieldSelect(nomeCampo_cob);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_sep_hapus_validate_cob(var_cob, var_script_case_init, do_ajax_form_vclaim_sep_hapus_validate_cob_cb);
  } // do_ajax_form_vclaim_sep_hapus_validate_cob

  function do_ajax_form_vclaim_sep_hapus_validate_cob_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cob";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_sep_hapus_validate_cob_cb

  // ---------- Validate kejadianlakalantas
  function do_ajax_form_vclaim_sep_hapus_validate_kejadianlakalantas()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_sep_hapus_validate_kejadianlakalantas(var_kejadianlakalantas, var_script_case_init, do_ajax_form_vclaim_sep_hapus_validate_kejadianlakalantas_cb);
  } // do_ajax_form_vclaim_sep_hapus_validate_kejadianlakalantas

  function do_ajax_form_vclaim_sep_hapus_validate_kejadianlakalantas_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_sep_hapus_validate_kejadianlakalantas_cb

  // ---------- Validate penjaminlakalantas
  function do_ajax_form_vclaim_sep_hapus_validate_penjaminlakalantas()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_sep_hapus_validate_penjaminlakalantas(var_penjaminlakalantas, var_script_case_init, do_ajax_form_vclaim_sep_hapus_validate_penjaminlakalantas_cb);
  } // do_ajax_form_vclaim_sep_hapus_validate_penjaminlakalantas

  function do_ajax_form_vclaim_sep_hapus_validate_penjaminlakalantas_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_sep_hapus_validate_penjaminlakalantas_cb

  // ---------- Validate lokasilakalantas
  function do_ajax_form_vclaim_sep_hapus_validate_lokasilakalantas()
  {
    var nomeCampo_lokasilakalantas = "lokasilakalantas";
    var var_lokasilakalantas = scAjaxGetFieldText(nomeCampo_lokasilakalantas);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_sep_hapus_validate_lokasilakalantas(var_lokasilakalantas, var_script_case_init, do_ajax_form_vclaim_sep_hapus_validate_lokasilakalantas_cb);
  } // do_ajax_form_vclaim_sep_hapus_validate_lokasilakalantas

  function do_ajax_form_vclaim_sep_hapus_validate_lokasilakalantas_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_sep_hapus_validate_lokasilakalantas_cb

  // ---------- Validate notelp
  function do_ajax_form_vclaim_sep_hapus_validate_notelp()
  {
    var nomeCampo_notelp = "notelp";
    var var_notelp = scAjaxGetFieldText(nomeCampo_notelp);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_sep_hapus_validate_notelp(var_notelp, var_script_case_init, do_ajax_form_vclaim_sep_hapus_validate_notelp_cb);
  } // do_ajax_form_vclaim_sep_hapus_validate_notelp

  function do_ajax_form_vclaim_sep_hapus_validate_notelp_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "notelp";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_sep_hapus_validate_notelp_cb

  // ---------- Validate user
  function do_ajax_form_vclaim_sep_hapus_validate_user()
  {
    var nomeCampo_user = "user";
    var var_user = scAjaxGetFieldText(nomeCampo_user);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_sep_hapus_validate_user(var_user, var_script_case_init, do_ajax_form_vclaim_sep_hapus_validate_user_cb);
  } // do_ajax_form_vclaim_sep_hapus_validate_user

  function do_ajax_form_vclaim_sep_hapus_validate_user_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "user";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_sep_hapus_validate_user_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_vclaim_sep_hapus_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_vclaim_sep_hapus_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_vclaim_sep_hapus_submit_form_cb_after_alert);
  } // do_ajax_form_vclaim_sep_hapus_submit_form_cb
  function do_ajax_form_vclaim_sep_hapus_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_vclaim_sep_hapus_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_vclaim_sep_hapus_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_form_vclaim_sep_hapus_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_hapus']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_vclaim_sep_hapus_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_vclaim_sep_hapus_navigate_form_cb_after_alert);
  } // do_ajax_form_vclaim_sep_hapus_navigate_form_cb
  function do_ajax_form_vclaim_sep_hapus_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_vclaim_sep_hapus_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_vclaim_sep_hapus_navigate_form_cb_after_alert
  function sc_hide_form_vclaim_sep_hapus_form()
  {
