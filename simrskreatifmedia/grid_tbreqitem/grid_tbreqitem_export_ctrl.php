<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tbreqitem']['sc_process_barr'] = true;
require_once('../grid_tbreqitem/index.php');
unset($_SESSION['scriptcase']['grid_tbreqitem']['sc_process_barr']);
$ExportCtrl = new grid_tbreqitem_export_control;
$ExportCtrl->Export_barr();

class grid_tbreqitem_export_control
{
