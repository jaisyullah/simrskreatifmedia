  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbsigna" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbsigna_form();
	}

  // ---------- Validate id
  function do_ajax_form_tbsigna_validate_id()
  {
    var nomeCampo_id = "id";
    var var_id = scAjaxGetFieldHidden(nomeCampo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbsigna_validate_id(var_id, var_script_case_init, do_ajax_form_tbsigna_validate_id_cb);
  } // do_ajax_form_tbsigna_validate_id

  function do_ajax_form_tbsigna_validate_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbsigna_validate_id_cb

  // ---------- Validate signacode
  function do_ajax_form_tbsigna_validate_signacode()
  {
    var nomeCampo_signacode = "signacode";
    var var_signacode = scAjaxGetFieldText(nomeCampo_signacode);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbsigna_validate_signacode(var_signacode, var_script_case_init, do_ajax_form_tbsigna_validate_signacode_cb);
  } // do_ajax_form_tbsigna_validate_signacode

  function do_ajax_form_tbsigna_validate_signacode_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbsigna_validate_signacode_cb

  // ---------- Validate signaname
  function do_ajax_form_tbsigna_validate_signaname()
  {
    var nomeCampo_signaname = "signaname";
    var var_signaname = scAjaxGetFieldText(nomeCampo_signaname);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbsigna_validate_signaname(var_signaname, var_script_case_init, do_ajax_form_tbsigna_validate_signaname_cb);
  } // do_ajax_form_tbsigna_validate_signaname

  function do_ajax_form_tbsigna_validate_signaname_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbsigna_validate_signaname_cb

  // ---------- Validate poli
  function do_ajax_form_tbsigna_validate_poli()
  {
    var nomeCampo_poli = "poli";
    var var_poli = scAjaxGetFieldText(nomeCampo_poli);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbsigna_validate_poli(var_poli, var_script_case_init, do_ajax_form_tbsigna_validate_poli_cb);
  } // do_ajax_form_tbsigna_validate_poli

  function do_ajax_form_tbsigna_validate_poli_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "poli";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbsigna_validate_poli_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tbsigna_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tbsigna_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_tbsigna_submit_form(var_id, var_signacode, var_signaname, var_poli, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbsigna_submit_form_cb);
  } // do_ajax_form_tbsigna_submit_form

  function do_ajax_form_tbsigna_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tbsigna_submit_form_cb_after_alert);
  } // do_ajax_form_tbsigna_submit_form_cb
  function do_ajax_form_tbsigna_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbsigna_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tbsigna_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_tbsigna_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbsigna_navigate_form_cb);
  } // do_ajax_form_tbsigna_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbsigna']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbsigna_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbsigna_navigate_form_cb_after_alert);
  } // do_ajax_form_tbsigna_navigate_form_cb
  function do_ajax_form_tbsigna_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_tbsigna_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_tbsigna_navigate_form_cb_after_alert
  function sc_hide_form_tbsigna_form()
  {
