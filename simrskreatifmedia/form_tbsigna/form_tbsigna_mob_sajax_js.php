  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbsigna_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbsigna_mob_form();
	}

  // ---------- Validate id
  function do_ajax_form_tbsigna_mob_validate_id()
  {
    var nomeCampo_id = "id";
    var var_id = scAjaxGetFieldHidden(nomeCampo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbsigna_mob_validate_id(var_id, var_script_case_init, do_ajax_form_tbsigna_mob_validate_id_cb);
  } // do_ajax_form_tbsigna_mob_validate_id

  function do_ajax_form_tbsigna_mob_validate_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbsigna_mob_validate_id_cb

  // ---------- Validate signacode
  function do_ajax_form_tbsigna_mob_validate_signacode()
  {
    var nomeCampo_signacode = "signacode";
    var var_signacode = scAjaxGetFieldText(nomeCampo_signacode);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbsigna_mob_validate_signacode(var_signacode, var_script_case_init, do_ajax_form_tbsigna_mob_validate_signacode_cb);
  } // do_ajax_form_tbsigna_mob_validate_signacode

  function do_ajax_form_tbsigna_mob_validate_signacode_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "signacode";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbsigna_mob_validate_signacode_cb

  // ---------- Validate signaname
  function do_ajax_form_tbsigna_mob_validate_signaname()
  {
    var nomeCampo_signaname = "signaname";
    var var_signaname = scAjaxGetFieldText(nomeCampo_signaname);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbsigna_mob_validate_signaname(var_signaname, var_script_case_init, do_ajax_form_tbsigna_mob_validate_signaname_cb);
  } // do_ajax_form_tbsigna_mob_validate_signaname

  function do_ajax_form_tbsigna_mob_validate_signaname_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "signaname";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbsigna_mob_validate_signaname_cb

  // ---------- Validate poli
  function do_ajax_form_tbsigna_mob_validate_poli()
  {
    var nomeCampo_poli = "poli";
    var var_poli = scAjaxGetFieldText(nomeCampo_poli);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbsigna_mob_validate_poli(var_poli, var_script_case_init, do_ajax_form_tbsigna_mob_validate_poli_cb);
  } // do_ajax_form_tbsigna_mob_validate_poli

  function do_ajax_form_tbsigna_mob_validate_poli_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "poli";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbsigna_mob_validate_poli_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tbsigna_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tbsigna_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id = scAjaxGetFieldHidden("id");
    var var_signacode = scAjaxGetFieldText("signacode");
    var var_signaname = scAjaxGetFieldText("signaname");
    ...
    scAjaxProcOn();
    x_ajax_form_tbsigna_mob_submit_form(var_id, var_signacode, var_signaname, var_poli, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbsigna_mob_submit_form_cb);
  } // do_ajax_form_tbsigna_mob_submit_form

  function do_ajax_form_tbsigna_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("signacode");
      scAjaxHideErrorDisplay("signaname");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tbsigna_mob_submit_form_cb_after_alert);
  } // do_ajax_form_tbsigna_mob_submit_form_cb
  function do_ajax_form_tbsigna_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbsigna_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tbsigna_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_tbsigna_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbsigna_mob_navigate_form_cb);
  } // do_ajax_form_tbsigna_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbsigna_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbsigna_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbsigna_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_tbsigna_mob_navigate_form_cb
  function do_ajax_form_tbsigna_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_tbsigna_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_tbsigna_mob_navigate_form_cb_after_alert
  function sc_hide_form_tbsigna_mob_form()
  {
  ...
  ajax_field_list[1] = "signacode";
  ajax_field_list[2] = "signaname";
  ajax_field_list[3] = "poli";
  ...
  var ajax_error_list = {
    ...
    "signacode": {"label": "Signa Code", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "signaname": {"label": "Signa Name", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  ajax_field_mult["signacode"][1] = "signacode";
  ajax_field_mult["signaname"][1] = "signaname";
  ajax_field_mult["poli"][1] = "poli";

  var ajax_field_id = {
    "id": new Array("hidden_field_label_id", "hidden_field_data_id"),
    "signacode": new Array("hidden_field_label_signacode", "hidden_field_data_signacode"),
    "signaname": new Array("hidden_field_label_signaname", "hidden_field_data_signaname"),
