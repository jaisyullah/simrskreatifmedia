...
class grid_antrian_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_antrian']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_antrian_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_antrian_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_antrian_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      }
      ...
      if ($this->NM_ajax_opcao == "ajax_refresh_field")
      {
          ...
          if (in_array("doctor", $NMcmp_refr))
          {
              $list = array();
              $nmgp_def_dados = $this->lookup_ajax_doctor($poly);
              ...
              $this->Arr_result['set_option'][] = array('field' => 'SC_doctor', 'value' => $list);
          }
      }
   }
   function lookup_ajax_doctor($poly)
   {
      $tmp_pos = strpos($poly, "##@@");
      if ($tmp_pos !== false)
      {
      ...
      { 
          $nm_comando = "SELECT docCode, gelar + name + ',' + spec  FROM tbdoctor WHERE poli = '$poly' ORDER BY gelar, name, spec" ; 
      } 
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
      { 
          $nm_comando = "SELECT docCode, concat(gelar, name,',', spec)  FROM tbdoctor WHERE poli = '$poly' ORDER BY gelar, name, spec" ; 
      } 
      ...
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_antrian']['psq_check_ret']['doctor'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_antrian']['psq_check_ret']['doctor'][] = trim($rs->fields[0]);
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $Nm_datas[] = "regDate";$Nm_datas[] = "regDate";$Nm_datas[] = "hta";$Nm_datas[] = "hta";$Nm_datas[] = "handled";$Nm_datas[] = "handled";$Nm_datas[] = "instExpiry";$Nm_datas[] = "instExpiry";$Nm_datas[] = "paid";$Nm_datas[] = "paid";
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_antrian']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_antrian']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_antrian']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_antrian']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_antrian']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_antrian']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_antrian']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_antrian']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_antrian']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_antrian']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_antrian']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_antrian']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_antrian']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_antrian']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_antrian']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_antrian']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_antrian']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
   ...
   $NM_retorno = "./";
    if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_antrian']['proc_res'])) 
    {
...
<?php
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_antrian']['proc_res']) 
    {
?>
if (parent.document.getElementById('nmsc_iframe_grid_antrian').contentWindow.nm_gp_submit_ajax)
{
   parent.document.getElementById('nmsc_iframe_grid_antrian').contentWindow.nm_gp_submit_ajax('inicio', 'save_grid');
}
else
{
   parent.document.getElementById('nmsc_iframe_grid_antrian').src = 'index.php?nmgp_opcao=pesq&script_case_init=<?php echo NM_encode_input($this->Ini->sc_page) ?>&script_case_session=<?php echo session_id() ?>';
}
<?php
    }
    else
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - Antrian Dokter</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_antrian/grid_antrian_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_antrian_ajax_search.js"></script>
 <script type="text/javascript" src="grid_antrian_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_antrian_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_antrian']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_antrian']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
?>
 ...
 function nm_refresh_poly(Proc_on)
 {
   var parms  = "";
   var fields = "doctor";
   parms += 'poly#NMF#' + search_get_select('SC_poly') + '@NMF@';
...
<?php
   ...
   function monta_form()
   {
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_antrian']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_antrian']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_antrian']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_antrian']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $regdate_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_antrian']['campos_busca']['regdate_dia']; 
          $regdate_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_antrian']['campos_busca']['regdate_mes']; 
          $regdate_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_antrian']['campos_busca']['regdate_ano']; 
          $regdate_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_antrian']['campos_busca']['regdate_input_2_dia']; 
          $regdate_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_antrian']['campos_busca']['regdate_input_2_mes']; 
          $regdate_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_antrian']['campos_busca']['regdate_input_2_ano']; 
          $regdate_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_antrian']['campos_busca']['regdate_cond']; 
          $poly = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_antrian']['campos_busca']['poly']; 
          $poly_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_antrian']['campos_busca']['poly_cond']; 
          $doctor = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_antrian']['campos_busca']['doctor']; 
          $doctor_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_antrian']['campos_busca']['doctor_cond']; 
          $status = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_antrian']['campos_busca']['status']; 
          $status_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_antrian']['campos_busca']['status_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_antrian']['campos_busca']['NM_operador']; 
      } 
...
?>
    ...
    <TR>
     <TD colspan="3" height="20" class="scFilterBlockBack">
      ...
      <TD id='SC_regdate_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['regdate'])) ? $this->New_label['regdate'] : "Periode Tanggal"; ?></TD>
      ...
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_regdate" <?php echo $str_hide_regdate?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['regdate'])) ? $this->New_label['regdate'] : "Periode Tanggal";
...
?>
    ...
    <TR>
     <TD colspan="3" height="20" class="scFilterBlockBack">
      <TABLE border="0" cellpadding="0" cellspacing="0" width="100%" height="100%">
       <TR>
        <TD class="scFilterBlockFont css_blk_1"><?php echo $Img_tit_blk_i ?>Cari berdasarkan data<?php echo $Img_tit_blk_f ?></TD>
      ...
      <TD id='SC_poly_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['poly'])) ? $this->New_label['poly'] : "Poli"; ?></TD>
...
<?php
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_antrian']['psq_check_ret']['poly'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_antrian']['psq_check_ret']['poly'][] = trim($rs->fields[0]);
...
?>
   <span id="idAjaxSelect_poly">
      <SELECT class="scFilterObjectOdd" id="SC_poly" name="poly" onChange="nm_refresh_poly();" size="1">
       <OPTION value=""></OPTION>
<?php
...
?>
    ...
    <TR>
     <TD colspan="3" height="20" class="scFilterBlockBack">
      <TABLE border="0" cellpadding="0" cellspacing="0" width="100%" height="100%">
       <TR>
        <TD class="scFilterBlockFont css_blk_2"><?php echo $Img_tit_blk_i ?>Status<?php echo $Img_tit_blk_f ?></TD>
...
<?php
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_antrian']['psq_check_ret']['status'] = array();
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_antrian']['psq_check_ret']['status'][] = "Antre";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_antrian']['psq_check_ret']['status'][] = "Batal";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_antrian']['psq_check_ret']['status'][] = "Pelayanan";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_antrian']['psq_check_ret']['status'][] = "Selesai";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_antrian']['psq_check_ret']['status'][] = "Lengkap";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_antrian']['psq_check_ret']['status'][] = "Mutasi RI";
 ?>

<TABLE style="padding: 0px; spacing: 0px; border-width: 0px;"><TR>
  <TD class="scFilterFieldFontOdd"><INPUT class="scFilterObjectOdd" type="checkbox" id="SC_status" name="status[]" value="Antre##@@Antre"  <?php if (in_array("Antre", $status))  { echo " checked" ;} ?><?php  if (empty($status)) { echo " checked" ;} ?>>Antre</TD>
  <TD class="scFilterFieldFontOdd"><INPUT class="scFilterObjectOdd" type="checkbox" id="SC_status" name="status[]" value="Batal##@@Batal"  <?php if (in_array("Batal", $status))  { echo " checked" ;} ?>>Batal</TD>
  <TD class="scFilterFieldFontOdd"><INPUT class="scFilterObjectOdd" type="checkbox" id="SC_status" name="status[]" value="Pelayanan##@@Pelayanan"  <?php if (in_array("Pelayanan", $status))  { echo " checked" ;} ?>>Pelayanan</TD>
  <TD class="scFilterFieldFontOdd"><INPUT class="scFilterObjectOdd" type="checkbox" id="SC_status" name="status[]" value="Selesai##@@Selesai"  <?php if (in_array("Selesai", $status))  { echo " checked" ;} ?>>Selesai</TD>
</TR>
<TR>
  <TD class="scFilterFieldFontOdd"><INPUT class="scFilterObjectOdd" type="checkbox" id="SC_status" name="status[]" value="Lengkap##@@Lengkap"  <?php if (in_array("Lengkap", $status))  { echo " checked" ;} ?>>Lengkap</TD>
  <TD class="scFilterFieldFontOdd"><INPUT class="scFilterObjectOdd" type="checkbox" id="SC_status" name="status[]" value="Mutasi RI##@@Mutasi RI"  <?php if (in_array("Mutasi RI", $status))  { echo " checked" ;} ?>>Mutasi RI</TD>
</TR><TR>
 <TD colspan=4>
...
?>
<?php
   if (is_file("grid_antrian_help.txt"))
   {
...
?>
<?php
   if ($nm_apl_dependente == 1 || (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_antrian']['opc_psq'] && !$this->aba_iframe))
   {
...
<?php
       ...
       elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_antrian']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_antrian']['dashboard_info']['under_dashboard'])
       { }
       else 
       { 
?>
...
<?php
   ...
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_antrian']['opc_psq'])
   {
...
{
?>
<iframe id="nmsc_iframe_grid_antrian" frameborder="0" marginwidth="0px" marginheight="0px" topmargin="0px" leftmargin="0px" align="center" height="1500px" name="nm_iframe_grid_antrian" scrolling="auto" src="index.php?nmgp_opcao=pesq&script_case_init=<?php echo NM_encode_input($this->Ini->sc_page) ?>&script_case_session=<?php echo session_id() ?>" width="100%"></iframe>
<?php
}
else
{
...
?>
<iframe id="nmsc_iframe_grid_antrian_pesq"  name="nm_iframe_grid_antrian_pesq" style= "display: none;" frameborder="0" marginwidth="0px" marginheight="0px" topmargin="0px" leftmargin="0px" src=""></iframe>
</td></tr></table></td></tr>
</TABLE>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_antrian']['orig_pesq'] == "grid")
   {
...
?>
 ...
 {
    document.F1.target = "nm_iframe_grid_antrian_pesq";
    document.F1.submit();
 }
 function nm_move()
 {
     document.getElementById('nmsc_iframe_grid_antrian').contentWindow.nm_move('igual');
 }
 function limpa_form()
 {
   document.F1.reset();
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "simrskreatifmedia/grid_antrian";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_antrian']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_antrian']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_antrian']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function trata_campos()
   {
      ...
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_antrian']['psq_check_ret']['poly'])) {
      ...
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_antrian']['psq_check_ret']['doctor'])) {
      ...
      if (is_array($status)) {
          foreach ($status as $I => $Val) {
              ...
              if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && trim($L_lookup) != '' && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_antrian']['psq_check_ret']['status'])) {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_antrian']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_antrian']['campos_busca']['regdate_dia'] = $regdate_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_antrian']['campos_busca']['regdate_mes'] = $regdate_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_antrian']['campos_busca']['regdate_ano'] = $regdate_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_antrian']['campos_busca']['regdate_input_2_dia'] = $regdate_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_antrian']['campos_busca']['regdate_input_2_mes'] = $regdate_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_antrian']['campos_busca']['regdate_input_2_ano'] = $regdate_input_2_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_antrian']['campos_busca']['regdate_cond'] = $regdate_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_antrian']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_antrian']['campos_busca']['poly'] = $poly; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_antrian']['campos_busca']['poly_cond'] = $poly_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_antrian']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_antrian']['campos_busca']['doctor'] = $doctor; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_antrian']['campos_busca']['doctor_cond'] = $doctor_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_antrian']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_antrian']['campos_busca']['status'] = $status; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_antrian']['campos_busca']['status_cond'] = $status_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_antrian']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_antrian']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_antrian']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      ...
      $this->cmp_formatado['status'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_antrian']['campos_busca']['status'];
      ...
      if ($regdate_cond != "bi_TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_antrian']['campos_busca']['regdate'] = $val[0];
          ...
          if ($regdate_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_antrian']['campos_busca']['regdate_input_2'] = $val[1];
      ...
      if (is_array($status) && count($status) != 0)
      {
         ...
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_antrian']['cond_pesq'] .= $nmgp_tab_label['status'] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
      }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_antrian']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_antrian']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_antrian']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_antrian']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_antrian']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_antrian']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_antrian']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_antrian']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_antrian']['cond_pesq'] .= $this->NM_operador;
