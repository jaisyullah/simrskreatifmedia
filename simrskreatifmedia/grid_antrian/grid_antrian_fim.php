...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_antrian"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_antrian"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_antrian']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_antrian']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_antrian']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_antrian']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_antrian']['sc_modal']);
           if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_antrian']['opc_psq']))
           {
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_antrian']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_antrian']['embutida_filho'] as $ind => $sc_init)
          {
