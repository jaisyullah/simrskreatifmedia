<?php
@session_start() ;
$_SESSION['scriptcase']['grid_antrian']['sc_process_barr'] = true;
require_once('../grid_antrian/index.php');
unset($_SESSION['scriptcase']['grid_antrian']['sc_process_barr']);
$ExportCtrl = new grid_antrian_export_control;
$ExportCtrl->Export_barr();

class grid_antrian_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - Antrian Dokter :: Excel</TITLE>
