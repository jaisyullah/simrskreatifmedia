<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_antrian']['glo_nm_path_imag_temp'] . "/sc_apl_default_simrskreatifmedia.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_antrian_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_antrian_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_antrian']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_antrian']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["custcode"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_antrian']['labels']["custcode"])) ? $_SESSION['sc_session'][$sc_init]['grid_antrian']['labels']["custcode"] : "No. RM";
   $tab_ger_campos['poly'] = "on";
   $tab_def_campos['poly'] = "poly";
   $tab_labels["poly"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_antrian']['labels']["poly"])) ? $_SESSION['sc_session'][$sc_init]['grid_antrian']['labels']["poly"] : "Poli";
...
ORDER BY name, salut";
   ...
   $tab_labels["sc_field_0"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_antrian']['labels']["sc_field_0"])) ? $_SESSION['sc_session'][$sc_init]['grid_antrian']['labels']["sc_field_0"] : "Nama Pasien";
   ...
   $tab_labels["sc_field_1"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_antrian']['labels']["sc_field_1"])) ? $_SESSION['sc_session'][$sc_init]['grid_antrian']['labels']["sc_field_1"] : "Tgl. Lahir";
   ...
   {
       $tab_def_campos['phone'] = "SELECT sc_concat(phone,' / ', hp) 
FROM tbcustomer 
WHERE custCode = '{custCode}' 
ORDER BY phone, hp";
   }
   $tab_labels["phone"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_antrian']['labels']["phone"])) ? $_SESSION['sc_session'][$sc_init]['grid_antrian']['labels']["phone"] : "No Telp/HP";
   $tab_ger_campos['doctor'] = "on";
   $tab_def_campos['doctor'] = "doctor";
   $tab_labels["doctor"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_antrian']['labels']["doctor"])) ? $_SESSION['sc_session'][$sc_init]['grid_antrian']['labels']["doctor"] : "Dokter";
   $tab_ger_campos['queue'] = "on";
   $tab_def_campos['queue'] = "queue";
   $tab_labels["queue"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_antrian']['labels']["queue"])) ? $_SESSION['sc_session'][$sc_init]['grid_antrian']['labels']["queue"] : "Antrian";
   $tab_ger_campos['regdate'] = "on";
   $tab_def_campos['regdate'] = "regDate";
   $tab_labels["regdate"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_antrian']['labels']["regdate"])) ? $_SESSION['sc_session'][$sc_init]['grid_antrian']['labels']["regdate"] : "Tgl Daftar";
   $tab_ger_campos['regtime'] = "on";
   $tab_def_campos['regtime'] = "regTime";
   $tab_labels["regtime"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_antrian']['labels']["regtime"])) ? $_SESSION['sc_session'][$sc_init]['grid_antrian']['labels']["regtime"] : "Waktu Daftar";
   $tab_ger_campos['handled'] = "on";
   $tab_def_campos['handled'] = "handled";
   $tab_labels["handled"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_antrian']['labels']["handled"])) ? $_SESSION['sc_session'][$sc_init]['grid_antrian']['labels']["handled"] : "Selesai";
   $tab_ger_campos['bayar'] = "on";
   $tab_def_campos['bayar'] = "bayar";
   $tab_labels["bayar"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_antrian']['labels']["bayar"])) ? $_SESSION['sc_session'][$sc_init]['grid_antrian']['labels']["bayar"] : "Bayar";
   $tab_ger_campos['inst'] = "on";
   $tab_def_campos['inst'] = "inst";
   $tab_labels["inst"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_antrian']['labels']["inst"])) ? $_SESSION['sc_session'][$sc_init]['grid_antrian']['labels']["inst"] : "Penanggung";
   $tab_ger_campos['status'] = "on";
   $tab_def_campos['status'] = "status";
   $tab_labels["status"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_antrian']['labels']["status"])) ? $_SESSION['sc_session'][$sc_init]['grid_antrian']['labels']["status"] : "Status";
   $tab_ger_campos['struckno'] = "on";
   $tab_def_campos['struckno'] = "struckNo";
   $tab_labels["struckno"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_antrian']['labels']["struckno"])) ? $_SESSION['sc_session'][$sc_init]['grid_antrian']['labels']["struckno"] : "No Struk";
   $tab_ger_campos['sc_field_0'] = "none";
   $tab_ger_campos['sc_field_1'] = "none";
   $tab_ger_campos['phone'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_antrian']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_antrian']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_antrian']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_antrian']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_antrian']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_antrian']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_antrian']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_antrian']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_antrian']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - Antrian Dokter</TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_antrian_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_antrian']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_antrian']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_antrian']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_antrian']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_antrian']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
