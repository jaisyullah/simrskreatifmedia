...
function ajax_navigate(opc, parm)
{
    ...
    return new Promise(function(resolve, reject) {$.ajax({
     ...
     .done(function(jsonNavigate) {
        ...
        document.getElementById('nmsc_iframe_liga_A_grid_antrian').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_E_grid_antrian').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_D_grid_antrian').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_B_grid_antrian').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_A_grid_antrian').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_E_grid_antrian').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_D_grid_antrian').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_B_grid_antrian').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_A_grid_antrian').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_E_grid_antrian').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_D_grid_antrian').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_B_grid_antrian').style.width  = '0px';
        if (oResp["redirInfo"]) {
           nmAjaxRedir(oResp);
        }
        if (oResp["setValue"]) {
          for (i = 0; i < oResp["setValue"].length; i++) {
            if ("sc_grid_body" == oResp["setValue"][i]["field"] && !scrollNavigateReload) {
              $("#sc-ui-grid-body-f32b50ee > tbody").append(oResp["setValue"][i]["value"]);
            }
            else {
