<?php
@session_start() ;
$_SESSION['scriptcase']['chart_byjenis_ranap']['sc_process_barr'] = true;
require_once('../chart_byjenis_ranap/index.php');
unset($_SESSION['scriptcase']['chart_byjenis_ranap']['sc_process_barr']);
$ExportCtrl = new chart_byjenis_ranap_export_control;
$ExportCtrl->Export_barr();

class chart_byjenis_ranap_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_chart_title'] ?> Statistik Rawat Inap :: Excel</TITLE>
