...
class cetak_label_rj_rtf
{
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "cetak_label_rj.rtf";
   }
   //---- 
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      $nm_raiz_img  = ""; 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cetak_label_rj']['rtf_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['cetak_label_rj']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['cetak_label_rj']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['cetak_label_rj']['rtf_name']);
      }
...
$_SESSION['scriptcase']['cetak_label_rj']['contr_erro'] = 'off'; 
   ...
   {
         $this->tl1 = html_entity_decode($this->tl1, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->tl1 = strip_tags($this->tl1);
         if (!NM_is_utf8($this->tl1))
         {
             $this->tl1 = sc_convert_encoding($this->tl1, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->tl1 = str_replace('<', '&lt;', $this->tl1);
         $this->tl1 = str_replace('>', '&gt;', $this->tl1);
         $this->Texto_tag .= "<td>" . $this->tl1 . "</td>\r\n";
   }
   //----- tl2
   function NM_export_tl2()
   {
         $this->tl2 = html_entity_decode($this->tl2, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->tl2 = strip_tags($this->tl2);
         if (!NM_is_utf8($this->tl2))
         {
             $this->tl2 = sc_convert_encoding($this->tl2, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->tl2 = str_replace('<', '&lt;', $this->tl2);
         $this->tl2 = str_replace('>', '&gt;', $this->tl2);
         $this->Texto_tag .= "<td>" . $this->tl2 . "</td>\r\n";
   }
   //----- tl3
   function NM_export_tl3()
   {
         $this->tl3 = html_entity_decode($this->tl3, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->tl3 = strip_tags($this->tl3);
         if (!NM_is_utf8($this->tl3))
         {
             $this->tl3 = sc_convert_encoding($this->tl3, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->tl3 = str_replace('<', '&lt;', $this->tl3);
         $this->tl3 = str_replace('>', '&gt;', $this->tl3);
         $this->Texto_tag .= "<td>" . $this->tl3 . "</td>\r\n";
   }
   //----- tl4
   function NM_export_tl4()
   {
         $this->tl4 = html_entity_decode($this->tl4, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->tl4 = strip_tags($this->tl4);
         if (!NM_is_utf8($this->tl4))
         {
             $this->tl4 = sc_convert_encoding($this->tl4, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->tl4 = str_replace('<', '&lt;', $this->tl4);
         $this->tl4 = str_replace('>', '&gt;', $this->tl4);
         $this->Texto_tag .= "<td>" . $this->tl4 . "</td>\r\n";
   }
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['cetak_label_rj']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['cetak_label_rj']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
