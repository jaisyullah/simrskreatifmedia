<?php
@session_start() ;
$_SESSION['scriptcase']['cetak_label_rj']['sc_process_barr'] = true;
require_once('../cetak_label_rj/index.php');
unset($_SESSION['scriptcase']['cetak_label_rj']['sc_process_barr']);
$ExportCtrl = new cetak_label_rj_export_control;
$ExportCtrl->Export_barr();

class cetak_label_rj_export_control
{
