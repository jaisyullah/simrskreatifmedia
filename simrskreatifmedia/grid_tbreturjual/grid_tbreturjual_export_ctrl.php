<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tbreturjual']['sc_process_barr'] = true;
require_once('../grid_tbreturjual/index.php');
unset($_SESSION['scriptcase']['grid_tbreturjual']['sc_process_barr']);
$ExportCtrl = new grid_tbreturjual_export_control;
$ExportCtrl->Export_barr();

class grid_tbreturjual_export_control
{
