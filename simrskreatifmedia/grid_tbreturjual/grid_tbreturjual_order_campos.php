...
<?php
   ...
   $Ord_Cmp = new grid_tbreturjual_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_tbreturjual_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbreturjual']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tbreturjual']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['koderetur'] = "kodeRetur";
   $tab_labels["koderetur"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbreturjual']['labels']["koderetur"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbreturjual']['labels']["koderetur"] : "Kode Retur";
   $tab_ger_campos['keterangan'] = "on";
   $tab_def_campos['keterangan'] = "keterangan";
   $tab_labels["keterangan"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbreturjual']['labels']["keterangan"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbreturjual']['labels']["keterangan"] : "Keterangan";
   $tab_ger_campos['tglretur'] = "on";
   $tab_def_campos['tglretur'] = "tglRetur";
   $tab_labels["tglretur"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbreturjual']['labels']["tglretur"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbreturjual']['labels']["tglretur"] : "Tgl Retur";
   $tab_ger_campos['kodetran'] = "on";
   $tab_def_campos['kodetran'] = "kodeTran";
   $tab_labels["kodetran"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbreturjual']['labels']["kodetran"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbreturjual']['labels']["kodetran"] : "Kode Transaksi";
   $tab_ger_campos['statusretur'] = "on";
   $tab_def_campos['statusretur'] = "statusRetur";
   $tab_labels["statusretur"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbreturjual']['labels']["statusretur"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbreturjual']['labels']["statusretur"] : "Status Retur";
   $tab_ger_campos['user_verif'] = "on";
   $tab_def_campos['user_verif'] = "user_verif";
   $tab_labels["user_verif"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbreturjual']['labels']["user_verif"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbreturjual']['labels']["user_verif"] : "User Verif";
   $tab_ger_campos['tglverif'] = "on";
   $tab_def_campos['tglverif'] = "tglVerif";
   $tab_labels["tglverif"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbreturjual']['labels']["tglverif"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbreturjual']['labels']["tglverif"] : "Tgl Verif";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_tbreturjual']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_tbreturjual']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_tbreturjual']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbreturjual']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tbreturjual']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_tbreturjual']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_tbreturjual']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_tbreturjual']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_tbreturjual']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_tbreturjual_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_tbreturjual']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_tbreturjual']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_tbreturjual']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_tbreturjual']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_tbreturjual']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
