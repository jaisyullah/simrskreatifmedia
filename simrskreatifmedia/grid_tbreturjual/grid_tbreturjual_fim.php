...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_tbreturjual"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_tbreturjual"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_tbreturjual'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tbreturjual']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_tbreturjual']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tbreturjual']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_tbreturjual']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_tbreturjual']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_tbreturjual']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_tbreturjual']['embutida_filho'] as $ind => $sc_init)
          {
