...
<?php
   ...
   $Ord_Cmp = new grid_hrm_kontrak_kerja_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_hrm_kontrak_kerja_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_hrm_kontrak_kerja']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_hrm_kontrak_kerja']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_hrm_kontrak_kerja']['labels']["id"])) ? $_SESSION['sc_session'][$sc_init]['grid_hrm_kontrak_kerja']['labels']["id"] : "Id";
   $tab_ger_campos['id_karyawan'] = "on";
   $tab_def_campos['id_karyawan'] = "id_karyawan";
   $tab_labels["id_karyawan"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_hrm_kontrak_kerja']['labels']["id_karyawan"])) ? $_SESSION['sc_session'][$sc_init]['grid_hrm_kontrak_kerja']['labels']["id_karyawan"] : "Karyawan";
   $tab_ger_campos['no_kontrak'] = "on";
   $tab_def_campos['no_kontrak'] = "no_kontrak";
   $tab_labels["no_kontrak"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_hrm_kontrak_kerja']['labels']["no_kontrak"])) ? $_SESSION['sc_session'][$sc_init]['grid_hrm_kontrak_kerja']['labels']["no_kontrak"] : "No Kontrak";
   $tab_ger_campos['tanggal_awal'] = "on";
   $tab_def_campos['tanggal_awal'] = "tanggal_awal";
   $tab_labels["tanggal_awal"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_hrm_kontrak_kerja']['labels']["tanggal_awal"])) ? $_SESSION['sc_session'][$sc_init]['grid_hrm_kontrak_kerja']['labels']["tanggal_awal"] : "Tanggal Awal";
   $tab_ger_campos['tanggal_akhir'] = "on";
   $tab_def_campos['tanggal_akhir'] = "tanggal_akhir";
   $tab_labels["tanggal_akhir"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_hrm_kontrak_kerja']['labels']["tanggal_akhir"])) ? $_SESSION['sc_session'][$sc_init]['grid_hrm_kontrak_kerja']['labels']["tanggal_akhir"] : "Tanggal Akhir";
   $tab_ger_campos['tmt_kerja'] = "on";
   $tab_def_campos['tmt_kerja'] = "tmt_kerja";
   $tab_labels["tmt_kerja"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_hrm_kontrak_kerja']['labels']["tmt_kerja"])) ? $_SESSION['sc_session'][$sc_init]['grid_hrm_kontrak_kerja']['labels']["tmt_kerja"] : "Tmt Kerja";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_hrm_kontrak_kerja']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_hrm_kontrak_kerja']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_hrm_kontrak_kerja']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_hrm_kontrak_kerja']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_hrm_kontrak_kerja']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_hrm_kontrak_kerja']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_hrm_kontrak_kerja']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_hrm_kontrak_kerja']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_hrm_kontrak_kerja']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_hrm_kontrak_kerja_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_hrm_kontrak_kerja']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_hrm_kontrak_kerja']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_hrm_kontrak_kerja']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_hrm_kontrak_kerja']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_hrm_kontrak_kerja']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
