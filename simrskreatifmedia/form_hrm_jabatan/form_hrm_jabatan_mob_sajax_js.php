  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_hrm_jabatan_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_hrm_jabatan_mob_form();
	}

  // ---------- Validate id
  function do_ajax_form_hrm_jabatan_mob_validate_id()
  {
    var nomeCampo_id = "id";
    var var_id = scAjaxGetFieldHidden(nomeCampo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_jabatan_mob_validate_id(var_id, var_script_case_init, do_ajax_form_hrm_jabatan_mob_validate_id_cb);
  } // do_ajax_form_hrm_jabatan_mob_validate_id

  function do_ajax_form_hrm_jabatan_mob_validate_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_jabatan_mob_validate_id_cb

  // ---------- Validate deskripsi
  function do_ajax_form_hrm_jabatan_mob_validate_deskripsi()
  {
    var nomeCampo_deskripsi = "deskripsi";
    var var_deskripsi = scAjaxGetFieldText(nomeCampo_deskripsi);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_jabatan_mob_validate_deskripsi(var_deskripsi, var_script_case_init, do_ajax_form_hrm_jabatan_mob_validate_deskripsi_cb);
  } // do_ajax_form_hrm_jabatan_mob_validate_deskripsi

  function do_ajax_form_hrm_jabatan_mob_validate_deskripsi_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_jabatan_mob_validate_deskripsi_cb

  // ---------- Validate keterangan
  function do_ajax_form_hrm_jabatan_mob_validate_keterangan()
  {
    var nomeCampo_keterangan = "keterangan";
    var var_keterangan = scAjaxGetFieldText(nomeCampo_keterangan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_jabatan_mob_validate_keterangan(var_keterangan, var_script_case_init, do_ajax_form_hrm_jabatan_mob_validate_keterangan_cb);
  } // do_ajax_form_hrm_jabatan_mob_validate_keterangan

  function do_ajax_form_hrm_jabatan_mob_validate_keterangan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_jabatan_mob_validate_keterangan_cb

  // ---------- Validate parent_id
  function do_ajax_form_hrm_jabatan_mob_validate_parent_id()
  {
    var nomeCampo_parent_id = "parent_id";
    var var_parent_id = scAjaxGetFieldText(nomeCampo_parent_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_jabatan_mob_validate_parent_id(var_parent_id, var_script_case_init, do_ajax_form_hrm_jabatan_mob_validate_parent_id_cb);
  } // do_ajax_form_hrm_jabatan_mob_validate_parent_id

  function do_ajax_form_hrm_jabatan_mob_validate_parent_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "parent_id";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_jabatan_mob_validate_parent_id_cb

  // ---------- Validate job_desc
  function do_ajax_form_hrm_jabatan_mob_validate_job_desc()
  {
    var nomeCampo_job_desc = "job_desc";
    var var_job_desc = scAjaxGetFieldEditorHtml(nomeCampo_job_desc);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_jabatan_mob_validate_job_desc(var_job_desc, var_script_case_init, do_ajax_form_hrm_jabatan_mob_validate_job_desc_cb);
  } // do_ajax_form_hrm_jabatan_mob_validate_job_desc

  function do_ajax_form_hrm_jabatan_mob_validate_job_desc_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "job_desc";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_jabatan_mob_validate_job_desc_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_hrm_jabatan_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_hrm_jabatan_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    var var_parent_id = scAjaxGetFieldText("parent_id");
    var var_job_desc = scAjaxGetFieldEditorHtml("job_desc");
    ...
    scAjaxProcOn();
    x_ajax_form_hrm_jabatan_mob_submit_form(var_id, var_deskripsi, var_keterangan, var_parent_id, var_job_desc, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_hrm_jabatan_mob_submit_form_cb);
  } // do_ajax_form_hrm_jabatan_mob_submit_form

  function do_ajax_form_hrm_jabatan_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("parent_id");
      scAjaxHideErrorDisplay("job_desc");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_hrm_jabatan_mob_submit_form_cb_after_alert);
  } // do_ajax_form_hrm_jabatan_mob_submit_form_cb
  function do_ajax_form_hrm_jabatan_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_hrm_jabatan_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_hrm_jabatan_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_hrm_jabatan_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_hrm_jabatan_mob_navigate_form_cb);
  } // do_ajax_form_hrm_jabatan_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_hrm_jabatan_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_hrm_jabatan_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_hrm_jabatan_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_hrm_jabatan_mob_navigate_form_cb
  function do_ajax_form_hrm_jabatan_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_hrm_jabatan_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_hrm_jabatan_mob_navigate_form_cb_after_alert
  function sc_hide_form_hrm_jabatan_mob_form()
  {
  ...
  ajax_field_list[3] = "parent_id";
  ajax_field_list[4] = "job_desc";
  ...
  var ajax_error_list = {
    ...
    "parent_id": {"label": "Parent ID", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "job_desc": {"label": "Job Desc", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  ajax_field_mult["parent_id"][1] = "parent_id";
  ajax_field_mult["job_desc"][1] = "job_desc";
  ...
  var ajax_field_id = {
    ...
    "parent_id": new Array("hidden_field_label_parent_id", "hidden_field_data_parent_id"),
    "job_desc": new Array("hidden_field_label_job_desc", "hidden_field_data_job_desc")
  };
