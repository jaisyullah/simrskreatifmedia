  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_detailadm" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_detailadm_form();
	}

  // ---------- Validate namaadm_
  function do_ajax_form_detailadm_validate_namaadm_(iNumLinha)
  {
    var nomeCampo_namaadm_ = "namaadm_" + iNumLinha;
    var var_namaadm_ = scAjaxGetFieldSelect(nomeCampo_namaadm_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detailadm_validate_namaadm_(var_namaadm_, iNumLinha, var_script_case_init, do_ajax_form_detailadm_validate_namaadm__cb);
  } // do_ajax_form_detailadm_validate_namaadm_

  function do_ajax_form_detailadm_validate_namaadm__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "namaadm_" + iLineNumber;
    }
    else
    {
      sFieldValid = "namaadm_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "namaadm_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "namaadm_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detailadm_validate_namaadm__cb

  // ---------- Validate diskon_
  function do_ajax_form_detailadm_validate_diskon_(iNumLinha)
  {
    var nomeCampo_diskon_ = "diskon_" + iNumLinha;
    var var_diskon_ = scAjaxGetFieldText(nomeCampo_diskon_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detailadm_validate_diskon_(var_diskon_, iNumLinha, var_script_case_init, do_ajax_form_detailadm_validate_diskon__cb);
  } // do_ajax_form_detailadm_validate_diskon_

  function do_ajax_form_detailadm_validate_diskon__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detailadm_validate_diskon__cb

  // ---------- Validate tgladm_
  function do_ajax_form_detailadm_validate_tgladm_(iNumLinha)
  {
    var nomeCampo_tgladm_ = "tgladm_" + iNumLinha;
    var var_tgladm_ = scAjaxGetFieldText(nomeCampo_tgladm_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detailadm_validate_tgladm_(var_tgladm_, iNumLinha, var_script_case_init, do_ajax_form_detailadm_validate_tgladm__cb);
  } // do_ajax_form_detailadm_validate_tgladm_

  function do_ajax_form_detailadm_validate_tgladm__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "tgladm_" + iLineNumber;
    }
    else
    {
      sFieldValid = "tgladm_";
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "tgladm_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "tgladm_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detailadm_validate_tgladm__cb

  // ---------- Validate id_
  function do_ajax_form_detailadm_validate_id_(iNumLinha)
  {
    var nomeCampo_id_ = "id_" + iNumLinha;
    var var_id_ = scAjaxGetFieldHidden(nomeCampo_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detailadm_validate_id_(var_id_, iNumLinha, var_script_case_init, do_ajax_form_detailadm_validate_id__cb);
  } // do_ajax_form_detailadm_validate_id_

  function do_ajax_form_detailadm_validate_id__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detailadm_validate_id__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_detailadm_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_detailadm_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_detailadm_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_detailadm_add_new_line_cb);
  } // do_ajax_form_detailadm_add_new_line

  function do_ajax_form_detailadm_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
    ...
    nm_field_disabled("tgladm_=disabled", "", iAjaxNewLine);
  } // do_ajax_form_detailadm_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_detailadm_backup_line(iNumLinha)
  {
    var var_id_ = scAjaxGetFieldHidden("id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detailadm_backup_line(var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_detailadm_backup_line_cb);
  } // do_ajax_form_detailadm_backup_line

  function do_ajax_form_detailadm_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_detailadm_backup_line_cb

  function do_ajax_form_detailadm_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_detailadm_cancel_insert

  function do_ajax_form_detailadm_cancel_update(iSeqVert)
  {
    do_ajax_form_detailadm_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_detailadm_cancel_update

  function do_ajax_form_detailadm_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_detailadm_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_detailadm_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_detailadm_table_refresh(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_detailadm_table_refresh_cb);
  } //  do_ajax_form_detailadm_table_refresh

  function do_ajax_form_detailadm_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_detailadm_table_refresh_cb_after_alert);
  } // do_ajax_form_detailadm_table_refresh_cb
  function do_ajax_form_detailadm_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_detailadm_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_detailadm_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_detailadm_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    sc_num_ult_line = iNumLinha;
    sc_num_ult_tr   = indexTR;
    scAjaxHideMessage();
    var var_namaadm_ = scAjaxGetFieldSelect("namaadm_" + iNumLinha);
    var var_diskon_ = scAjaxGetFieldText("diskon_" + iNumLinha);
    var var_tgladm_ = scAjaxGetFieldText("tgladm_" + iNumLinha);
    var var_id_ = scAjaxGetFieldHidden("id_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_detailadm_submit_form(var_namaadm_, var_diskon_, var_tgladm_, var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_detailadm_submit_form_cb);
  } // do_ajax_form_detailadm_submit_form

  function do_ajax_form_detailadm_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("namaadm_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("diskon_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("tgladm_" + sc_num_ult_line);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_detailadm_submit_form_cb_after_alert);
  } // do_ajax_form_detailadm_submit_form_cb
  function do_ajax_form_detailadm_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_detailadm_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_detailadm_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_detailadm_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("namaadm_" + iNavForm);
      scAjaxHideErrorDisplay("diskon_" + iNavForm);
      scAjaxHideErrorDisplay("tgladm_" + iNavForm);
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_detailadm_navigate_form(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_detailadm_navigate_form_cb);
  } // do_ajax_form_detailadm_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_detailadm']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_detailadm_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_detailadm_navigate_form_cb_after_alert);
  } // do_ajax_form_detailadm_navigate_form_cb
  function do_ajax_form_detailadm_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_detailadm_navigate_form_cb_after_alert
  function sc_hide_form_detailadm_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "namaadm_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "diskon_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "tgladm_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "id_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["namaadm_" + iNumLinha] = {"label": "Nama Administrasi<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_error_list["tgladm_" + iNumLinha] = {"label": "Tgl Administrasi<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_field_mult["namaadm_"][iNumLinha] = "namaadm_" + iNumLinha;
    ajax_field_mult["diskon_"][iNumLinha] = "diskon_" + iNumLinha;
    ajax_field_mult["tgladm_"][iNumLinha] = "tgladm_" + iNumLinha;
    ajax_field_mult["id_"][iNumLinha] = "id_" + iNumLinha;
    ajax_field_id["namaadm_" + iNumLinha] = new Array("hidden_field_label_namaadm_", "hidden_field_data_namaadm_" + iNumLinha);
    ajax_field_id["diskon_" + iNumLinha] = new Array("hidden_field_label_diskon_", "hidden_field_data_diskon_" + iNumLinha);
    ajax_field_id["tgladm_" + iNumLinha] = new Array("hidden_field_label_tgladm_", "hidden_field_data_tgladm_" + iNumLinha);
    ajax_error_count["namaadm_" + iNumLinha] = "off";
    ajax_error_count["diskon_" + iNumLinha] = "off";
    ajax_error_count["tgladm_" + iNumLinha] = "off";
    ajax_error_count["id_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["namaadm_" + iNumLinha] = "off";
    ajax_read_only["diskon_" + iNumLinha] = "off";
    ajax_read_only["tgladm_" + iNumLinha] = "off";
...
{
?>
    ajax_read_only["namaadm_" + iNumLinha] = "on";
    ajax_read_only["diskon_" + iNumLinha] = "on";
    ajax_read_only["tgladm_" + iNumLinha] = "on";
    ajax_read_only["id_" + iNumLinha] = "on";
<?php
}
?>
  ...
  {
    ajax_error_list["namaadm_" + iNumLinha] = null;
    ajax_error_list["diskon_" + iNumLinha] = null;
    ajax_error_list["tgladm_" + iNumLinha] = null;
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["namaadm_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["namaadm_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["namaadm_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["namaadm_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["namaadm_" + iNumLinha]["onfocus"] = new Array();
      ...
      ajax_error_list["tgladm_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["tgladm_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["tgladm_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["tgladm_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["tgladm_" + iNumLinha]["onfocus"] = new Array();
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['namaadm_'])) ? $this->nmgp_cmp_readonly['namaadm_'] : 'off';
?>
    scAjaxFieldRead("namaadm_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['tgladm_'])) ? $this->nmgp_cmp_readonly['tgladm_'] : 'off';
?>
    scAjaxFieldRead("tgladm_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
?>
  ...
  {
    scAjaxFieldRead("namaadm_" + iSeq, "on");
    scAjaxFieldRead("diskon_" + iSeq, "on");
    scAjaxFieldRead("tgladm_" + iSeq, "on");
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["namaadm_" + iRow] || "on" == ajax_error_count["diskon_" + iRow] || "on" == ajax_error_count["tgladm_" + iRow] || "on" == ajax_error_count["id_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_namaadm_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_diskon_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_tgladm_" + iRow).addClass("scFormErrorLine");
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["namaadm_" + iRow] && "off" == ajax_error_count["diskon_" + iRow] && "off" == ajax_error_count["tgladm_" + iRow] && "off" == ajax_error_count["id_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["namaadm_" + iRow] = "off";
        ajax_error_count["diskon_" + iRow] = "off";
        ajax_error_count["tgladm_" + iRow] = "off";
      ...
      $("#hidden_field_data_namaadm_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_diskon_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_tgladm_" + iRow).removeClass("scFormErrorLine");
