...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "id";$Nm_numeric[] = "kasbon";$Nm_numeric[] = "terlambat";$Nm_numeric[] = "alfa_izin";$Nm_numeric[] = "parkir";$Nm_numeric[] = "periode_remunerasi";$Nm_numeric[] = "id_karyawan";$Nm_numeric[] = "id";$Nm_numeric[] = "kasbon";$Nm_numeric[] = "terlambat";$Nm_numeric[] = "alfa_izin";$Nm_numeric[] = "parkir";$Nm_numeric[] = "periode_remunerasi";$Nm_numeric[] = "id_karyawan";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_alfa_izin_cond" name="alfa_izin_cond" onChange="nm_campos_between(document.getElementById('id_vis_alfa_izin'), this, 'alfa_izin')">
      ...
      <br><span id="id_hide_alfa_izin"  <?php echo $str_hide_alfa_izin?>><?php
      if ($alfa_izin != "")
      {
      $alfa_izin_look = substr($this->Db->qstr($alfa_izin), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_kasbon_cond" name="kasbon_cond" onChange="nm_campos_between(document.getElementById('id_vis_kasbon'), this, 'kasbon')">
      ...
      <br><span id="id_hide_kasbon"  <?php echo $str_hide_kasbon?>><?php
      if ($kasbon != "")
      {
      $kasbon_look = substr($this->Db->qstr($kasbon), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_terlambat_cond" name="terlambat_cond" onChange="nm_campos_between(document.getElementById('id_vis_terlambat'), this, 'terlambat')">
      ...
      <br><span id="id_hide_terlambat"  <?php echo $str_hide_terlambat?>><?php
      if ($terlambat != "")
      {
      $terlambat_look = substr($this->Db->qstr($terlambat), 1, -1); 
      $nmgp_def_dados = array(); 
