...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranlab_inap_mob']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
  <input type="hidden" name="script_case_session" value="<?php echo $this->form_encode_input(session_id()); ?>"> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_tbtranlab_inap_mob"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
function sc_btn_Batal_ok()
{
    ...
    document.F1.action = "form_tbtranlab_inap_mob.php";
...
{ 
   var sob_iframe = '';
<?php 
if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranlab_inap_mob']['embutida_form']) {
...
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranlab_inap_mob']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranlab_inap_mob']['sc_modal']) {
    echo "   sob_iframe += 'parent.';\r\n";
}
?>
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranlab_inap_mob']['where_detal']))
  {
?>  
...
{
   nm_field_disabled("trancode=disabled;custage=disabled;diag=disabled", "");
   nm_field_disabled("custcode=disabled;instcode=disabled;struk=disabled;sc_field_1=disabled;sc_field_0=disabled;alamat=disabled;poli=disabled;doccode=disabled;docname=disabled", "U");
