...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_trandate_hora' + iSeqRow).bind('blur', function() { sc_form_tbtranlab_inap_trandate_onblur(this, iSeqRow) })
                                           .bind('focus', function() { sc_form_tbtranlab_inap_trandate_onfocus(this, iSeqRow) });
  ...
  $('#id_sc_field_finishdate_hora' + iSeqRow).bind('blur', function() { sc_form_tbtranlab_inap_finishdate_onblur(this, iSeqRow) })
                                             .bind('focus', function() { sc_form_tbtranlab_inap_finishdate_onfocus(this, iSeqRow) });
  ...
  $('#id_sc_field_proyeksidate_hora' + iSeqRow).bind('blur', function() { sc_form_tbtranlab_inap_proyeksidate_onblur(this, iSeqRow) })
                                               .bind('focus', function() { sc_form_tbtranlab_inap_proyeksidate_onfocus(this, iSeqRow) });
...
function scHidePage(pageNo) {
	$("#id_form_tbtranlab_inap_mob_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_trandate" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_tbtranlab_inap_mob_validate_trandate(iSeqRow);
    },
    numberOfMonths: 1,
    changeMonth: true,
    changeYear: true,
...
?>
  ...
  $("#id_sc_field_proyeksidate" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_tbtranlab_inap_mob_validate_proyeksidate(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_finishdate" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_tbtranlab_inap_mob_validate_finishdate(iSeqRow);
    },
    numberOfMonths: 1,
    changeMonth: true,
    changeYear: true,
...
?>
  ...
  $("#id_sc_field_enterdate" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_tbtranlab_inap_mob_validate_enterdate(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_takendate" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_tbtranlab_inap_mob_validate_takendate(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
