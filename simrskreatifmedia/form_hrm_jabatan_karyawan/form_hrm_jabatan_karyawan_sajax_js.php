  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_hrm_jabatan_karyawan" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_hrm_jabatan_karyawan_form();
	}

  // ---------- Validate id_jabatan_
  function do_ajax_form_hrm_jabatan_karyawan_validate_id_jabatan_(iNumLinha)
  {
    var nomeCampo_id_jabatan_ = "id_jabatan_" + iNumLinha;
    var var_id_jabatan_ = scAjaxGetFieldSelect(nomeCampo_id_jabatan_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_jabatan_karyawan_validate_id_jabatan_(var_id_jabatan_, iNumLinha, var_script_case_init, do_ajax_form_hrm_jabatan_karyawan_validate_id_jabatan__cb);
  } // do_ajax_form_hrm_jabatan_karyawan_validate_id_jabatan_

  function do_ajax_form_hrm_jabatan_karyawan_validate_id_jabatan__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "id_jabatan_" + iLineNumber;
    }
    else
    {
      sFieldValid = "id_jabatan_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "id_jabatan_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "id_jabatan_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_jabatan_karyawan_validate_id_jabatan__cb

  // ---------- Validate tanggal_awal_
  function do_ajax_form_hrm_jabatan_karyawan_validate_tanggal_awal_(iNumLinha)
  {
    var nomeCampo_tanggal_awal_ = "tanggal_awal_" + iNumLinha;
    var var_tanggal_awal_ = scAjaxGetFieldText(nomeCampo_tanggal_awal_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_jabatan_karyawan_validate_tanggal_awal_(var_tanggal_awal_, iNumLinha, var_script_case_init, do_ajax_form_hrm_jabatan_karyawan_validate_tanggal_awal__cb);
  } // do_ajax_form_hrm_jabatan_karyawan_validate_tanggal_awal_

  function do_ajax_form_hrm_jabatan_karyawan_validate_tanggal_awal__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "tanggal_awal_" + iLineNumber;
    }
    else
    {
      sFieldValid = "tanggal_awal_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "tanggal_awal_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "tanggal_awal_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_jabatan_karyawan_validate_tanggal_awal__cb

  // ---------- Validate tanggal_akhir_
  function do_ajax_form_hrm_jabatan_karyawan_validate_tanggal_akhir_(iNumLinha)
  {
    var nomeCampo_tanggal_akhir_ = "tanggal_akhir_" + iNumLinha;
    var var_tanggal_akhir_ = scAjaxGetFieldText(nomeCampo_tanggal_akhir_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_jabatan_karyawan_validate_tanggal_akhir_(var_tanggal_akhir_, iNumLinha, var_script_case_init, do_ajax_form_hrm_jabatan_karyawan_validate_tanggal_akhir__cb);
  } // do_ajax_form_hrm_jabatan_karyawan_validate_tanggal_akhir_

  function do_ajax_form_hrm_jabatan_karyawan_validate_tanggal_akhir__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "tanggal_akhir_" + iLineNumber;
    }
    else
    {
      sFieldValid = "tanggal_akhir_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "tanggal_akhir_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "tanggal_akhir_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_jabatan_karyawan_validate_tanggal_akhir__cb

  // ---------- Validate keterangan_
  function do_ajax_form_hrm_jabatan_karyawan_validate_keterangan_(iNumLinha)
  {
    var nomeCampo_keterangan_ = "keterangan_" + iNumLinha;
    var var_keterangan_ = scAjaxGetFieldText(nomeCampo_keterangan_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_jabatan_karyawan_validate_keterangan_(var_keterangan_, iNumLinha, var_script_case_init, do_ajax_form_hrm_jabatan_karyawan_validate_keterangan__cb);
  } // do_ajax_form_hrm_jabatan_karyawan_validate_keterangan_

  function do_ajax_form_hrm_jabatan_karyawan_validate_keterangan__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_jabatan_karyawan_validate_keterangan__cb

  // ---------- Validate sc_field_0_
  function do_ajax_form_hrm_jabatan_karyawan_validate_sc_field_0_(iNumLinha)
  {
    var nomeCampo_sc_field_0_ = "sc_field_0_" + iNumLinha;
    var var_sc_field_0_ = scAjaxGetFieldText(nomeCampo_sc_field_0_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_jabatan_karyawan_validate_sc_field_0_(var_sc_field_0_, iNumLinha, var_script_case_init, do_ajax_form_hrm_jabatan_karyawan_validate_sc_field_0__cb);
  } // do_ajax_form_hrm_jabatan_karyawan_validate_sc_field_0_

  function do_ajax_form_hrm_jabatan_karyawan_validate_sc_field_0__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_jabatan_karyawan_validate_sc_field_0__cb

  // ---------- Validate id_
  function do_ajax_form_hrm_jabatan_karyawan_validate_id_(iNumLinha)
  {
    var nomeCampo_id_ = "id_" + iNumLinha;
    var var_id_ = scAjaxGetFieldHidden(nomeCampo_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_jabatan_karyawan_validate_id_(var_id_, iNumLinha, var_script_case_init, do_ajax_form_hrm_jabatan_karyawan_validate_id__cb);
  } // do_ajax_form_hrm_jabatan_karyawan_validate_id_

  function do_ajax_form_hrm_jabatan_karyawan_validate_id__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_jabatan_karyawan_validate_id__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_hrm_jabatan_karyawan_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_hrm_jabatan_karyawan_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_hrm_jabatan_karyawan_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_hrm_jabatan_karyawan_add_new_line_cb);
  } // do_ajax_form_hrm_jabatan_karyawan_add_new_line

  function do_ajax_form_hrm_jabatan_karyawan_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_hrm_jabatan_karyawan_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_hrm_jabatan_karyawan_backup_line(iNumLinha)
  {
    var var_id_ = scAjaxGetFieldHidden("id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_jabatan_karyawan_backup_line(var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_hrm_jabatan_karyawan_backup_line_cb);
  } // do_ajax_form_hrm_jabatan_karyawan_backup_line

  function do_ajax_form_hrm_jabatan_karyawan_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_hrm_jabatan_karyawan_backup_line_cb

  function do_ajax_form_hrm_jabatan_karyawan_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_hrm_jabatan_karyawan_cancel_insert

  function do_ajax_form_hrm_jabatan_karyawan_cancel_update(iSeqVert)
  {
    do_ajax_form_hrm_jabatan_karyawan_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_hrm_jabatan_karyawan_cancel_update

  function do_ajax_form_hrm_jabatan_karyawan_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_hrm_jabatan_karyawan_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_hrm_jabatan_karyawan_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_hrm_jabatan_karyawan_table_refresh(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_hrm_jabatan_karyawan_table_refresh_cb);
  } //  do_ajax_form_hrm_jabatan_karyawan_table_refresh

  function do_ajax_form_hrm_jabatan_karyawan_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_hrm_jabatan_karyawan_table_refresh_cb_after_alert);
  } // do_ajax_form_hrm_jabatan_karyawan_table_refresh_cb
  function do_ajax_form_hrm_jabatan_karyawan_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_hrm_jabatan_karyawan_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_hrm_jabatan_karyawan_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_hrm_jabatan_karyawan_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    sc_num_ult_line = iNumLinha;
    sc_num_ult_tr   = indexTR;
    scAjaxHideMessage();
    var var_id_jabatan_ = scAjaxGetFieldSelect("id_jabatan_" + iNumLinha);
    var var_tanggal_awal_ = scAjaxGetFieldText("tanggal_awal_" + iNumLinha);
    var var_tanggal_akhir_ = scAjaxGetFieldText("tanggal_akhir_" + iNumLinha);
...
?>
    x_ajax_form_hrm_jabatan_karyawan_submit_form(var_id_jabatan_, var_tanggal_awal_, var_tanggal_akhir_, var_keterangan_, var_sc_field_0_, var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_hrm_jabatan_karyawan_submit_form_cb);
  } // do_ajax_form_hrm_jabatan_karyawan_submit_form

  function do_ajax_form_hrm_jabatan_karyawan_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("id_jabatan_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("tanggal_awal_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("tanggal_akhir_" + sc_num_ult_line);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_hrm_jabatan_karyawan_submit_form_cb_after_alert);
  } // do_ajax_form_hrm_jabatan_karyawan_submit_form_cb
  function do_ajax_form_hrm_jabatan_karyawan_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_hrm_jabatan_karyawan_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_hrm_jabatan_karyawan_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_hrm_jabatan_karyawan_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("id_jabatan_" + iNavForm);
      scAjaxHideErrorDisplay("tanggal_awal_" + iNavForm);
      scAjaxHideErrorDisplay("tanggal_akhir_" + iNavForm);
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_hrm_jabatan_karyawan_navigate_form(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_hrm_jabatan_karyawan_navigate_form_cb);
  } // do_ajax_form_hrm_jabatan_karyawan_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_hrm_jabatan_karyawan']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_hrm_jabatan_karyawan_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_hrm_jabatan_karyawan_navigate_form_cb_after_alert);
  } // do_ajax_form_hrm_jabatan_karyawan_navigate_form_cb
  function do_ajax_form_hrm_jabatan_karyawan_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_hrm_jabatan_karyawan_navigate_form_cb_after_alert
  function sc_hide_form_hrm_jabatan_karyawan_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "id_jabatan_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "tanggal_awal_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "tanggal_akhir_" + iNumLinha;
    iTotCampos++;
    ...
    iTotCampos++;
    ajax_error_list["id_jabatan_" + iNumLinha] = {"label": "Jabatan<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["tanggal_awal_" + iNumLinha] = {"label": "Tanggal Awal<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["tanggal_akhir_" + iNumLinha] = {"label": "Tanggal Akhir<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_error_list["sc_field_0_" + iNumLinha] = {"label": "Job Desc<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_field_mult["id_jabatan_"][iNumLinha] = "id_jabatan_" + iNumLinha;
    ajax_field_mult["tanggal_awal_"][iNumLinha] = "tanggal_awal_" + iNumLinha;
    ajax_field_mult["tanggal_akhir_"][iNumLinha] = "tanggal_akhir_" + iNumLinha;
    ...
    ajax_field_id["id_jabatan_" + iNumLinha] = new Array("hidden_field_label_id_jabatan_", "hidden_field_data_id_jabatan_" + iNumLinha);
    ajax_field_id["tanggal_awal_" + iNumLinha] = new Array("hidden_field_label_tanggal_awal_", "hidden_field_data_tanggal_awal_" + iNumLinha);
    ajax_field_id["tanggal_akhir_" + iNumLinha] = new Array("hidden_field_label_tanggal_akhir_", "hidden_field_data_tanggal_akhir_" + iNumLinha);
    ...
    ajax_error_count["id_jabatan_" + iNumLinha] = "off";
    ajax_error_count["tanggal_awal_" + iNumLinha] = "off";
    ajax_error_count["tanggal_akhir_" + iNumLinha] = "off";
...
{
?>
    ajax_read_only["id_jabatan_" + iNumLinha] = "off";
    ajax_read_only["tanggal_awal_" + iNumLinha] = "off";
    ajax_read_only["tanggal_akhir_" + iNumLinha] = "off";
...
{
?>
    ajax_read_only["id_jabatan_" + iNumLinha] = "on";
    ajax_read_only["tanggal_awal_" + iNumLinha] = "on";
    ajax_read_only["tanggal_akhir_" + iNumLinha] = "on";
...
?>
  ...
  {
    ajax_error_list["id_jabatan_" + iNumLinha] = null;
    ajax_error_list["tanggal_awal_" + iNumLinha] = null;
    ajax_error_list["tanggal_akhir_" + iNumLinha] = null;
  ...
  var ajax_field_mult = {
    "id_jabatan_": new Array(),
    "tanggal_awal_": new Array(),
    "tanggal_akhir_": new Array(),
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["id_jabatan_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["id_jabatan_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["id_jabatan_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["id_jabatan_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["id_jabatan_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["tanggal_awal_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["tanggal_awal_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["tanggal_awal_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["tanggal_awal_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["tanggal_awal_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["tanggal_akhir_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["tanggal_akhir_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["tanggal_akhir_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["tanggal_akhir_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["tanggal_akhir_" + iNumLinha]["onfocus"] = new Array();
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['id_jabatan_'])) ? $this->nmgp_cmp_readonly['id_jabatan_'] : 'off';
?>
    scAjaxFieldRead("id_jabatan_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['tanggal_awal_'])) ? $this->nmgp_cmp_readonly['tanggal_awal_'] : 'off';
?>
    scAjaxFieldRead("tanggal_awal_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['tanggal_akhir_'])) ? $this->nmgp_cmp_readonly['tanggal_akhir_'] : 'off';
?>
    scAjaxFieldRead("tanggal_akhir_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
?>
  ...
  {
    scAjaxFieldRead("id_jabatan_" + iSeq, "on");
    scAjaxFieldRead("tanggal_awal_" + iSeq, "on");
    scAjaxFieldRead("tanggal_akhir_" + iSeq, "on");
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["id_jabatan_" + iRow] || "on" == ajax_error_count["tanggal_awal_" + iRow] || "on" == ajax_error_count["tanggal_akhir_" + iRow] || "on" == ajax_error_count["keterangan_" + iRow] || "on" == ajax_error_count["sc_field_0_" + iRow] || "on" == ajax_error_count["id_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_id_jabatan_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_tanggal_awal_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_tanggal_akhir_" + iRow).addClass("scFormErrorLine");
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["id_jabatan_" + iRow] && "off" == ajax_error_count["tanggal_awal_" + iRow] && "off" == ajax_error_count["tanggal_akhir_" + iRow] && "off" == ajax_error_count["keterangan_" + iRow] && "off" == ajax_error_count["sc_field_0_" + iRow] && "off" == ajax_error_count["id_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["id_jabatan_" + iRow] = "off";
        ajax_error_count["tanggal_awal_" + iRow] = "off";
        ajax_error_count["tanggal_akhir_" + iRow] = "off";
      ...
      $("#hidden_field_data_id_jabatan_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_tanggal_awal_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_tanggal_akhir_" + iRow).removeClass("scFormErrorLine");
