<?php
@session_start() ;
$_SESSION['scriptcase']['historiRJ']['sc_process_barr'] = true;
require_once('../historiRJ/index.php');
unset($_SESSION['scriptcase']['historiRJ']['sc_process_barr']);
$ExportCtrl = new historiRJ_export_control;
$ExportCtrl->Export_barr();

class historiRJ_export_control
{
