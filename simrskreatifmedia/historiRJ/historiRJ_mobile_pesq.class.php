...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "b.regDate";$Nm_datas[] = "b_regDate";$Nm_datas[] = "b.hta";$Nm_datas[] = "b_hta";$Nm_datas[] = "a.tglKeluar";$Nm_datas[] = "a_tglKeluar";$Nm_numeric[] = "a_nostruk";$Nm_numeric[] = "a_resikojatuh";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_hta_cond" name="hta_cond" onChange="nm_campos_between(document.getElementById('id_vis_hta'), this, 'hta')">
      ...
      <br><span id="id_hide_hta"  <?php echo $str_hide_hta?>>
<?php
  $Form_base = "ddmmyyyyhhiiss";
  $date_format_show = "";
  $Str_date = str_replace("a", "y", strtolower($_SESSION['scriptcase']['reg_conf']['date_format']));
...
?>
 ...
 <?php echo $date_format_show ?>         </SPAN>
                  <br />
        <SPAN id="id_vis_hta"  <?php echo $str_display_hta; ?> class="scFilterFieldFontEven">
         <?php echo $date_sep_bw ?> 
         <BR>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_tglkeluar_cond" name="tglkeluar_cond" onChange="nm_campos_between(document.getElementById('id_vis_tglkeluar'), this, 'tglkeluar')">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_carakeluar_cond" name="carakeluar_cond" onChange="nm_campos_between(document.getElementById('id_vis_carakeluar'), this, 'carakeluar')">
      ...
      <br><span id="id_hide_carakeluar"  <?php echo $str_hide_carakeluar?>><?php
      if ($carakeluar != "")
      {
      $carakeluar_look = substr($this->Db->qstr($carakeluar), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_alasankeluar_cond" name="alasankeluar_cond" onChange="nm_campos_between(document.getElementById('id_vis_alasankeluar'), this, 'alasankeluar')">
      ...
      <br><span id="id_hide_alasankeluar"  <?php echo $str_hide_alasankeluar?>><?php
      if ($alasankeluar != "")
      {
      $alasankeluar_look = substr($this->Db->qstr($alasankeluar), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_nostruk_cond" name="nostruk_cond" onChange="nm_campos_between(document.getElementById('id_vis_nostruk'), this, 'nostruk')">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_resikojatuh_cond" name="resikojatuh_cond" onChange="nm_campos_between(document.getElementById('id_vis_resikojatuh'), this, 'resikojatuh')">
      ...
      <br><span id="id_hide_resikojatuh"  <?php echo $str_hide_resikojatuh?>><?php
      if ($resikojatuh != "")
      {
      $resikojatuh_look = substr($this->Db->qstr($resikojatuh), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_icd2_cond" name="icd2_cond" onChange="nm_campos_between(document.getElementById('id_vis_icd2'), this, 'icd2')">
      ...
      <br><span id="id_hide_icd2"  <?php echo $str_hide_icd2?>><?php
      if ($icd2 != "")
      {
      $icd2_look = substr($this->Db->qstr($icd2), 1, -1); 
      $nmgp_def_dados = array(); 
