...
<?php
   ...
   $Ord_Cmp = new historiRJ_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class historiRJ_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['historiRJ']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['historiRJ']['ordem_select_orig'] = array();
   }
   ...
   {
       $tab_def_campos['tglmasuk'] = "b.regDate";
   }
   $tab_labels["tglmasuk"]   = (isset($_SESSION['sc_session'][$sc_init]['historiRJ']['labels']["tglmasuk"])) ? $_SESSION['sc_session'][$sc_init]['historiRJ']['labels']["tglmasuk"] : "Tgl Masuk";
   ...
   $tab_labels["dokter"]   = (isset($_SESSION['sc_session'][$sc_init]['historiRJ']['labels']["dokter"])) ? $_SESSION['sc_session'][$sc_init]['historiRJ']['labels']["dokter"] : "Dokter";
   ...
   {
       $tab_def_campos['poli'] = "b.poly";
   }
   $tab_labels["poli"]   = (isset($_SESSION['sc_session'][$sc_init]['historiRJ']['labels']["poli"])) ? $_SESSION['sc_session'][$sc_init]['historiRJ']['labels']["poli"] : "Poli";
   $tab_ger_campos['hta'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['hta'] = "hta";
   }
   else
   {
       $tab_def_campos['hta'] = "b.hta";
   }
   $tab_labels["hta"]   = (isset($_SESSION['sc_session'][$sc_init]['historiRJ']['labels']["hta"])) ? $_SESSION['sc_session'][$sc_init]['historiRJ']['labels']["hta"] : "HTA";
   ...
   $tab_labels["diagnosa1"]   = (isset($_SESSION['sc_session'][$sc_init]['historiRJ']['labels']["diagnosa1"])) ? $_SESSION['sc_session'][$sc_init]['historiRJ']['labels']["diagnosa1"] : "Diagnosa";
   ...
   $tab_labels["icd1"]   = (isset($_SESSION['sc_session'][$sc_init]['historiRJ']['labels']["icd1"])) ? $_SESSION['sc_session'][$sc_init]['historiRJ']['labels']["icd1"] : "Kode ICD";
   ...
   $tab_labels["selesai"]   = (isset($_SESSION['sc_session'][$sc_init]['historiRJ']['labels']["selesai"])) ? $_SESSION['sc_session'][$sc_init]['historiRJ']['labels']["selesai"] : "Selesai";
   ...
   $tab_labels["detail"]   = (isset($_SESSION['sc_session'][$sc_init]['historiRJ']['labels']["detail"])) ? $_SESSION['sc_session'][$sc_init]['historiRJ']['labels']["detail"] : "Histori Poli, Item, Lab, Rad, SOAP";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['historiRJ']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['historiRJ']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['historiRJ']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['historiRJ']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['historiRJ']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['historiRJ']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['historiRJ']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['historiRJ']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['historiRJ']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "historiRJ_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['historiRJ']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['historiRJ']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['historiRJ']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['historiRJ']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['historiRJ']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
