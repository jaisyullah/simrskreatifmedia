...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_tanggal_hora' + iSeqRow).bind('blur', function() { sc_form_hrm_overtime_tanggal_hora_onblur(this, iSeqRow) })
                                          .bind('focus', function() { sc_form_hrm_overtime_tanggal_hora_onfocus(this, iSeqRow) });
...
function sc_form_hrm_overtime_tanggal_hora_onblur(oThis, iSeqRow) {
  do_ajax_form_hrm_overtime_validate_tanggal();
  scCssBlur(oThis);
}
...
function sc_form_hrm_overtime_tanggal_hora_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function scHidePage(pageNo) {
	$("#id_form_hrm_overtime_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_tanggal" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_hrm_overtime_validate_tanggal(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
