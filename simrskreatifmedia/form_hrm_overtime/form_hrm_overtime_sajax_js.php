  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_hrm_overtime" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_hrm_overtime_form();
	}

  // ---------- Validate id
  function do_ajax_form_hrm_overtime_validate_id()
  {
    var nomeCampo_id = "id";
    var var_id = scAjaxGetFieldHidden(nomeCampo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_overtime_validate_id(var_id, var_script_case_init, do_ajax_form_hrm_overtime_validate_id_cb);
  } // do_ajax_form_hrm_overtime_validate_id

  function do_ajax_form_hrm_overtime_validate_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_overtime_validate_id_cb

  // ---------- Validate id_karyawan
  function do_ajax_form_hrm_overtime_validate_id_karyawan()
  {
    var nomeCampo_id_karyawan = "id_karyawan";
    var var_id_karyawan = scAjaxGetFieldSelect(nomeCampo_id_karyawan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_overtime_validate_id_karyawan(var_id_karyawan, var_script_case_init, do_ajax_form_hrm_overtime_validate_id_karyawan_cb);
  } // do_ajax_form_hrm_overtime_validate_id_karyawan

  function do_ajax_form_hrm_overtime_validate_id_karyawan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_overtime_validate_id_karyawan_cb

  // ---------- Validate durasi
  function do_ajax_form_hrm_overtime_validate_durasi()
  {
    var nomeCampo_durasi = "durasi";
    var var_durasi = scAjaxGetFieldText(nomeCampo_durasi);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_overtime_validate_durasi(var_durasi, var_script_case_init, do_ajax_form_hrm_overtime_validate_durasi_cb);
  } // do_ajax_form_hrm_overtime_validate_durasi

  function do_ajax_form_hrm_overtime_validate_durasi_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "durasi";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_overtime_validate_durasi_cb

  // ---------- Validate tarif
  function do_ajax_form_hrm_overtime_validate_tarif()
  {
    var nomeCampo_tarif = "tarif";
    var var_tarif = scAjaxGetFieldText(nomeCampo_tarif);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_overtime_validate_tarif(var_tarif, var_script_case_init, do_ajax_form_hrm_overtime_validate_tarif_cb);
  } // do_ajax_form_hrm_overtime_validate_tarif

  function do_ajax_form_hrm_overtime_validate_tarif_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tarif";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_overtime_validate_tarif_cb

  // ---------- Validate tanggal
  function do_ajax_form_hrm_overtime_validate_tanggal()
  {
    var nomeCampo_tanggal = "tanggal";
    var var_tanggal = scAjaxGetFieldText(nomeCampo_tanggal);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_overtime_validate_tanggal(var_tanggal, var_script_case_init, do_ajax_form_hrm_overtime_validate_tanggal_cb);
  } // do_ajax_form_hrm_overtime_validate_tanggal

  function do_ajax_form_hrm_overtime_validate_tanggal_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tanggal";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_overtime_validate_tanggal_cb

  // ---------- Validate disetujui_oleh
  function do_ajax_form_hrm_overtime_validate_disetujui_oleh()
  {
    var nomeCampo_disetujui_oleh = "disetujui_oleh";
    var var_disetujui_oleh = scAjaxGetFieldText(nomeCampo_disetujui_oleh);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_overtime_validate_disetujui_oleh(var_disetujui_oleh, var_script_case_init, do_ajax_form_hrm_overtime_validate_disetujui_oleh_cb);
  } // do_ajax_form_hrm_overtime_validate_disetujui_oleh

  function do_ajax_form_hrm_overtime_validate_disetujui_oleh_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "disetujui_oleh";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_overtime_validate_disetujui_oleh_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_hrm_overtime_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_hrm_overtime_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id = scAjaxGetFieldHidden("id");
    var var_id_karyawan = scAjaxGetFieldSelect("id_karyawan");
    var var_durasi = scAjaxGetFieldText("durasi");
    var var_tarif = scAjaxGetFieldText("tarif");
    var var_tanggal = scAjaxGetFieldText("tanggal");
    var var_disetujui_oleh = scAjaxGetFieldText("disetujui_oleh");
    ...
    scAjaxProcOn();
    x_ajax_form_hrm_overtime_submit_form(var_id, var_id_karyawan, var_durasi, var_tarif, var_tanggal, var_disetujui_oleh, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_hrm_overtime_submit_form_cb);
  } // do_ajax_form_hrm_overtime_submit_form

  function do_ajax_form_hrm_overtime_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("durasi");
      scAjaxHideErrorDisplay("tarif");
      scAjaxHideErrorDisplay("tanggal");
      scAjaxHideErrorDisplay("disetujui_oleh");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_hrm_overtime_submit_form_cb_after_alert);
  } // do_ajax_form_hrm_overtime_submit_form_cb
  function do_ajax_form_hrm_overtime_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_hrm_overtime_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_hrm_overtime_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_hrm_overtime_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_hrm_overtime_navigate_form_cb);
  } // do_ajax_form_hrm_overtime_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_hrm_overtime']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_hrm_overtime_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_hrm_overtime_navigate_form_cb_after_alert);
  } // do_ajax_form_hrm_overtime_navigate_form_cb
  function do_ajax_form_hrm_overtime_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_hrm_overtime_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_hrm_overtime_navigate_form_cb_after_alert
  function sc_hide_form_hrm_overtime_form()
  {
  ...
  ajax_field_list[2] = "durasi";
  ajax_field_list[3] = "tarif";
  ajax_field_list[4] = "tanggal";
  ajax_field_list[5] = "disetujui_oleh";
  ...
  var ajax_error_list = {
    ...
    "durasi": {"label": "Durasi (Jam)", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "tarif": {"label": "Tarif (Rp/Jam)", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "tanggal": {"label": "Tanggal", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "disetujui_oleh": {"label": "Disetujui Oleh", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_id = {
    ...
    "durasi": new Array("hidden_field_label_durasi", "hidden_field_data_durasi"),
