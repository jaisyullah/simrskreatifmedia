  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_hrm_overtime_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_hrm_overtime_mob_form();
	}

  // ---------- Validate id
  function do_ajax_form_hrm_overtime_mob_validate_id()
  {
    var nomeCampo_id = "id";
    var var_id = scAjaxGetFieldHidden(nomeCampo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_overtime_mob_validate_id(var_id, var_script_case_init, do_ajax_form_hrm_overtime_mob_validate_id_cb);
  } // do_ajax_form_hrm_overtime_mob_validate_id

  function do_ajax_form_hrm_overtime_mob_validate_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_overtime_mob_validate_id_cb

  // ---------- Validate id_karyawan
  function do_ajax_form_hrm_overtime_mob_validate_id_karyawan()
  {
    var nomeCampo_id_karyawan = "id_karyawan";
    var var_id_karyawan = scAjaxGetFieldSelect(nomeCampo_id_karyawan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_overtime_mob_validate_id_karyawan(var_id_karyawan, var_script_case_init, do_ajax_form_hrm_overtime_mob_validate_id_karyawan_cb);
  } // do_ajax_form_hrm_overtime_mob_validate_id_karyawan

  function do_ajax_form_hrm_overtime_mob_validate_id_karyawan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_overtime_mob_validate_id_karyawan_cb

  // ---------- Validate durasi
  function do_ajax_form_hrm_overtime_mob_validate_durasi()
  {
    var nomeCampo_durasi = "durasi";
    var var_durasi = scAjaxGetFieldText(nomeCampo_durasi);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_overtime_mob_validate_durasi(var_durasi, var_script_case_init, do_ajax_form_hrm_overtime_mob_validate_durasi_cb);
  } // do_ajax_form_hrm_overtime_mob_validate_durasi

  function do_ajax_form_hrm_overtime_mob_validate_durasi_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "durasi";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_overtime_mob_validate_durasi_cb

  // ---------- Validate tarif
  function do_ajax_form_hrm_overtime_mob_validate_tarif()
  {
    var nomeCampo_tarif = "tarif";
    var var_tarif = scAjaxGetFieldText(nomeCampo_tarif);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_overtime_mob_validate_tarif(var_tarif, var_script_case_init, do_ajax_form_hrm_overtime_mob_validate_tarif_cb);
  } // do_ajax_form_hrm_overtime_mob_validate_tarif

  function do_ajax_form_hrm_overtime_mob_validate_tarif_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tarif";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_overtime_mob_validate_tarif_cb

  // ---------- Validate tanggal
  function do_ajax_form_hrm_overtime_mob_validate_tanggal()
  {
    var nomeCampo_tanggal = "tanggal";
    var var_tanggal = scAjaxGetFieldText(nomeCampo_tanggal);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_overtime_mob_validate_tanggal(var_tanggal, var_script_case_init, do_ajax_form_hrm_overtime_mob_validate_tanggal_cb);
  } // do_ajax_form_hrm_overtime_mob_validate_tanggal

  function do_ajax_form_hrm_overtime_mob_validate_tanggal_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tanggal";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_overtime_mob_validate_tanggal_cb

  // ---------- Validate disetujui_oleh
  function do_ajax_form_hrm_overtime_mob_validate_disetujui_oleh()
  {
    var nomeCampo_disetujui_oleh = "disetujui_oleh";
    var var_disetujui_oleh = scAjaxGetFieldText(nomeCampo_disetujui_oleh);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_overtime_mob_validate_disetujui_oleh(var_disetujui_oleh, var_script_case_init, do_ajax_form_hrm_overtime_mob_validate_disetujui_oleh_cb);
  } // do_ajax_form_hrm_overtime_mob_validate_disetujui_oleh

  function do_ajax_form_hrm_overtime_mob_validate_disetujui_oleh_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_overtime_mob_validate_disetujui_oleh_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_hrm_overtime_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_hrm_overtime_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_hrm_overtime_mob_submit_form(var_id, var_id_karyawan, var_durasi, var_tarif, var_tanggal, var_disetujui_oleh, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_hrm_overtime_mob_submit_form_cb);
  } // do_ajax_form_hrm_overtime_mob_submit_form

  function do_ajax_form_hrm_overtime_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_hrm_overtime_mob_submit_form_cb_after_alert);
  } // do_ajax_form_hrm_overtime_mob_submit_form_cb
  function do_ajax_form_hrm_overtime_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_hrm_overtime_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_hrm_overtime_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_hrm_overtime_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_hrm_overtime_mob_navigate_form_cb);
  } // do_ajax_form_hrm_overtime_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_hrm_overtime_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_hrm_overtime_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_hrm_overtime_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_hrm_overtime_mob_navigate_form_cb
  function do_ajax_form_hrm_overtime_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_hrm_overtime_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_hrm_overtime_mob_navigate_form_cb_after_alert
  function sc_hide_form_hrm_overtime_mob_form()
  {
