<?php
@session_start() ;
$_SESSION['scriptcase']['grid_kota']['sc_process_barr'] = true;
require_once('../grid_kota/index.php');
unset($_SESSION['scriptcase']['grid_kota']['sc_process_barr']);
$ExportCtrl = new grid_kota_export_control;
$ExportCtrl->Export_barr();

class grid_kota_export_control
{
