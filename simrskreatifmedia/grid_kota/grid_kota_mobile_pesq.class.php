...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_province_id_cond" name="province_id_cond" onChange="nm_campos_between(document.getElementById('id_vis_province_id'), this, 'province_id')">
      ...
      <br><span id="id_hide_province_id"  <?php echo $str_hide_province_id?>><?php
      if ($province_id != "")
      {
      $province_id_look = substr($this->Db->qstr($province_id), 1, -1); 
      $nmgp_def_dados = array(); 
