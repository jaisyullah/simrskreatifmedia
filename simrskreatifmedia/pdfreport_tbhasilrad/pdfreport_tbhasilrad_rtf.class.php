...
class pdfreport_tbhasilrad_rtf
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "pdfreport_tbhasilrad.rtf";
   }
   //---- 
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      $nm_raiz_img  = ""; 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_tbhasilrad']['rtf_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_tbhasilrad']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_tbhasilrad']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_tbhasilrad']['rtf_name']);
      }
...
$_SESSION['scriptcase']['pdfreport_tbhasilrad']['contr_erro'] = 'off'; 
   ...
   function NM_export_a_struk()
   {
         ...
         $this->a_struk = str_replace('<', '&lt;', $this->a_struk);
         $this->a_struk = str_replace('>', '&gt;', $this->a_struk);
         $this->Texto_tag .= "<td>" . $this->a_struk . "</td>\r\n";
   }
   //----- sc_field_0
   ...
   function NM_export_tglperiksa()
   {
         ...
         $this->tglperiksa = str_replace('>', '&gt;', $this->tglperiksa);
         $this->Texto_tag .= "<td>" . $this->tglperiksa . "</td>\r\n";
   }
   //----- tglselesai
   function NM_export_tglselesai()
   {
         ...
         $this->tglselesai = str_replace('<', '&lt;', $this->tglselesai);
         $this->tglselesai = str_replace('>', '&gt;', $this->tglselesai);
         $this->Texto_tag .= "<td>" . $this->tglselesai . "</td>\r\n";
   }
   //----- hasil
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_tbhasilrad']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_tbhasilrad']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
