<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tbreq']['sc_process_barr'] = true;
require_once('../grid_tbreq/index.php');
unset($_SESSION['scriptcase']['grid_tbreq']['sc_process_barr']);
$ExportCtrl = new grid_tbreq_export_control;
$ExportCtrl->Export_barr();

class grid_tbreq_export_control
{
