...
<?php
   ...
   $Ord_Cmp = new grid_tbreq_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_tbreq_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbreq']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tbreq']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["pocode"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbreq']['labels']["pocode"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbreq']['labels']["pocode"] : "Kode Transaksi";
   $tab_ger_campos['pesandate'] = "on";
   $tab_def_campos['pesandate'] = "pesanDate";
   $tab_labels["pesandate"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbreq']['labels']["pesandate"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbreq']['labels']["pesandate"] : "Tgl. Pesan";
   $tab_ger_campos['jatuhtempo'] = "on";
   $tab_def_campos['jatuhtempo'] = "jatuhTempo";
   $tab_labels["jatuhtempo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbreq']['labels']["jatuhtempo"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbreq']['labels']["jatuhtempo"] : "Tgl. Jatuh Tempo";
   $tab_ger_campos['pbf'] = "on";
   $tab_def_campos['pbf'] = "pbf";
   $tab_labels["pbf"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbreq']['labels']["pbf"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbreq']['labels']["pbf"] : "Supplier";
   $tab_ger_campos['total'] = "on";
   $tab_def_campos['total'] = "total";
   $tab_labels["total"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbreq']['labels']["total"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbreq']['labels']["total"] : "Total";
   $tab_ger_campos['status'] = "on";
   $tab_def_campos['status'] = "status";
   $tab_labels["status"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbreq']['labels']["status"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbreq']['labels']["status"] : "Status";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_tbreq']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_tbreq']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_tbreq']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbreq']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tbreq']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_tbreq']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_tbreq']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_tbreq']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_tbreq']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_tbreq_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_tbreq']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_tbreq']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_tbreq']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_tbreq']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_tbreq']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
