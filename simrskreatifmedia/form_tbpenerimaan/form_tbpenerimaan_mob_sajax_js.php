  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbpenerimaan_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbpenerimaan_mob_form();
	}

  // ---------- Validate reqcode
  function do_ajax_form_tbpenerimaan_mob_validate_reqcode()
  {
    var nomeCampo_reqcode = "reqcode";
    var var_reqcode = scAjaxGetFieldText(nomeCampo_reqcode);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbpenerimaan_mob_validate_reqcode(var_reqcode, var_script_case_init, do_ajax_form_tbpenerimaan_mob_validate_reqcode_cb);
  } // do_ajax_form_tbpenerimaan_mob_validate_reqcode

  function do_ajax_form_tbpenerimaan_mob_validate_reqcode_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbpenerimaan_mob_validate_reqcode_cb

  // ---------- Validate pocode
  function do_ajax_form_tbpenerimaan_mob_validate_pocode()
  {
    var nomeCampo_pocode = "pocode";
    var var_pocode = scAjaxGetFieldText(nomeCampo_pocode);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbpenerimaan_mob_validate_pocode(var_pocode, var_script_case_init, do_ajax_form_tbpenerimaan_mob_validate_pocode_cb);
  } // do_ajax_form_tbpenerimaan_mob_validate_pocode

  function do_ajax_form_tbpenerimaan_mob_validate_pocode_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pocode";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbpenerimaan_mob_validate_pocode_cb

  // ---------- Validate total
  function do_ajax_form_tbpenerimaan_mob_validate_total()
  {
    var nomeCampo_total = "total";
    var var_total = scAjaxGetFieldText(nomeCampo_total);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbpenerimaan_mob_validate_total(var_total, var_script_case_init, do_ajax_form_tbpenerimaan_mob_validate_total_cb);
  } // do_ajax_form_tbpenerimaan_mob_validate_total

  function do_ajax_form_tbpenerimaan_mob_validate_total_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "total";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbpenerimaan_mob_validate_total_cb

  // ---------- Validate pesandate
  function do_ajax_form_tbpenerimaan_mob_validate_pesandate()
  {
    var nomeCampo_pesandate = "pesandate";
    var var_pesandate = scAjaxGetFieldText(nomeCampo_pesandate);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbpenerimaan_mob_validate_pesandate(var_pesandate, var_script_case_init, do_ajax_form_tbpenerimaan_mob_validate_pesandate_cb);
  } // do_ajax_form_tbpenerimaan_mob_validate_pesandate

  function do_ajax_form_tbpenerimaan_mob_validate_pesandate_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pesandate";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbpenerimaan_mob_validate_pesandate_cb

  // ---------- Validate status
  function do_ajax_form_tbpenerimaan_mob_validate_status()
  {
    var nomeCampo_status = "status";
    var var_status = scAjaxGetFieldSelect(nomeCampo_status);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbpenerimaan_mob_validate_status(var_status, var_script_case_init, do_ajax_form_tbpenerimaan_mob_validate_status_cb);
  } // do_ajax_form_tbpenerimaan_mob_validate_status

  function do_ajax_form_tbpenerimaan_mob_validate_status_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "status";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbpenerimaan_mob_validate_status_cb

  // ---------- Validate jatuhtempo
  function do_ajax_form_tbpenerimaan_mob_validate_jatuhtempo()
  {
    var nomeCampo_jatuhtempo = "jatuhtempo";
    var var_jatuhtempo = scAjaxGetFieldText(nomeCampo_jatuhtempo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbpenerimaan_mob_validate_jatuhtempo(var_jatuhtempo, var_script_case_init, do_ajax_form_tbpenerimaan_mob_validate_jatuhtempo_cb);
  } // do_ajax_form_tbpenerimaan_mob_validate_jatuhtempo

  function do_ajax_form_tbpenerimaan_mob_validate_jatuhtempo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "jatuhtempo";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbpenerimaan_mob_validate_jatuhtempo_cb

  // ---------- Validate note
  function do_ajax_form_tbpenerimaan_mob_validate_note()
  {
    var nomeCampo_note = "note";
    var var_note = scAjaxGetFieldText(nomeCampo_note);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbpenerimaan_mob_validate_note(var_note, var_script_case_init, do_ajax_form_tbpenerimaan_mob_validate_note_cb);
  } // do_ajax_form_tbpenerimaan_mob_validate_note

  function do_ajax_form_tbpenerimaan_mob_validate_note_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "note";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbpenerimaan_mob_validate_note_cb

  // ---------- Validate orderdate
  function do_ajax_form_tbpenerimaan_mob_validate_orderdate()
  {
    var nomeCampo_orderdate = "orderdate";
    var var_orderdate = scAjaxGetFieldText(nomeCampo_orderdate);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbpenerimaan_mob_validate_orderdate(var_orderdate, var_script_case_init, do_ajax_form_tbpenerimaan_mob_validate_orderdate_cb);
  } // do_ajax_form_tbpenerimaan_mob_validate_orderdate

  function do_ajax_form_tbpenerimaan_mob_validate_orderdate_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "orderdate";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbpenerimaan_mob_validate_orderdate_cb

  // ---------- Validate totalreal
  function do_ajax_form_tbpenerimaan_mob_validate_totalreal()
  {
    var nomeCampo_totalreal = "totalreal";
    var var_totalreal = scAjaxGetFieldText(nomeCampo_totalreal);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbpenerimaan_mob_validate_totalreal(var_totalreal, var_script_case_init, do_ajax_form_tbpenerimaan_mob_validate_totalreal_cb);
  } // do_ajax_form_tbpenerimaan_mob_validate_totalreal

  function do_ajax_form_tbpenerimaan_mob_validate_totalreal_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "totalreal";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbpenerimaan_mob_validate_totalreal_cb

  // ---------- Validate ppn
  function do_ajax_form_tbpenerimaan_mob_validate_ppn()
  {
    var nomeCampo_ppn = "ppn";
    var var_ppn = scAjaxGetFieldText(nomeCampo_ppn);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbpenerimaan_mob_validate_ppn(var_ppn, var_script_case_init, do_ajax_form_tbpenerimaan_mob_validate_ppn_cb);
  } // do_ajax_form_tbpenerimaan_mob_validate_ppn

  function do_ajax_form_tbpenerimaan_mob_validate_ppn_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ppn";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbpenerimaan_mob_validate_ppn_cb

  // ---------- Validate datangdate
  function do_ajax_form_tbpenerimaan_mob_validate_datangdate()
  {
    var nomeCampo_datangdate = "datangdate";
    var var_datangdate = scAjaxGetFieldText(nomeCampo_datangdate);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbpenerimaan_mob_validate_datangdate(var_datangdate, var_script_case_init, do_ajax_form_tbpenerimaan_mob_validate_datangdate_cb);
  } // do_ajax_form_tbpenerimaan_mob_validate_datangdate

  function do_ajax_form_tbpenerimaan_mob_validate_datangdate_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "datangdate";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbpenerimaan_mob_validate_datangdate_cb

  // ---------- Validate pbf
  function do_ajax_form_tbpenerimaan_mob_validate_pbf()
  {
    var nomeCampo_pbf = "pbf";
    var var_pbf = scAjaxGetFieldSelect(nomeCampo_pbf);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbpenerimaan_mob_validate_pbf(var_pbf, var_script_case_init, do_ajax_form_tbpenerimaan_mob_validate_pbf_cb);
  } // do_ajax_form_tbpenerimaan_mob_validate_pbf

  function do_ajax_form_tbpenerimaan_mob_validate_pbf_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pbf";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbpenerimaan_mob_validate_pbf_cb

  // ---------- Validate non_pbf
  function do_ajax_form_tbpenerimaan_mob_validate_non_pbf()
  {
    var nomeCampo_non_pbf = "non_pbf";
    var var_non_pbf = scAjaxGetFieldText(nomeCampo_non_pbf);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbpenerimaan_mob_validate_non_pbf(var_non_pbf, var_script_case_init, do_ajax_form_tbpenerimaan_mob_validate_non_pbf_cb);
  } // do_ajax_form_tbpenerimaan_mob_validate_non_pbf

  function do_ajax_form_tbpenerimaan_mob_validate_non_pbf_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "non_pbf";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbpenerimaan_mob_validate_non_pbf_cb

  // ---------- Validate fakturno
  function do_ajax_form_tbpenerimaan_mob_validate_fakturno()
  {
    var nomeCampo_fakturno = "fakturno";
    var var_fakturno = scAjaxGetFieldText(nomeCampo_fakturno);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbpenerimaan_mob_validate_fakturno(var_fakturno, var_script_case_init, do_ajax_form_tbpenerimaan_mob_validate_fakturno_cb);
  } // do_ajax_form_tbpenerimaan_mob_validate_fakturno

  function do_ajax_form_tbpenerimaan_mob_validate_fakturno_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fakturno";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbpenerimaan_mob_validate_fakturno_cb

  // ---------- Validate tglbast
  function do_ajax_form_tbpenerimaan_mob_validate_tglbast()
  {
    var nomeCampo_tglbast = "tglbast";
    var var_tglbast = scAjaxGetFieldText(nomeCampo_tglbast);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbpenerimaan_mob_validate_tglbast(var_tglbast, var_script_case_init, do_ajax_form_tbpenerimaan_mob_validate_tglbast_cb);
  } // do_ajax_form_tbpenerimaan_mob_validate_tglbast

  function do_ajax_form_tbpenerimaan_mob_validate_tglbast_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tglbast";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbpenerimaan_mob_validate_tglbast_cb

  // ---------- Validate nobast
  function do_ajax_form_tbpenerimaan_mob_validate_nobast()
  {
    var nomeCampo_nobast = "nobast";
    var var_nobast = scAjaxGetFieldText(nomeCampo_nobast);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbpenerimaan_mob_validate_nobast(var_nobast, var_script_case_init, do_ajax_form_tbpenerimaan_mob_validate_nobast_cb);
  } // do_ajax_form_tbpenerimaan_mob_validate_nobast

  function do_ajax_form_tbpenerimaan_mob_validate_nobast_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nobast";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbpenerimaan_mob_validate_nobast_cb

  // ---------- Validate detailpo
  function do_ajax_form_tbpenerimaan_mob_validate_detailpo()
  {
    var nomeCampo_detailpo = "detailpo";
    var var_detailpo = scAjaxGetFieldText(nomeCampo_detailpo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbpenerimaan_mob_validate_detailpo(var_detailpo, var_script_case_init, do_ajax_form_tbpenerimaan_mob_validate_detailpo_cb);
  } // do_ajax_form_tbpenerimaan_mob_validate_detailpo

  function do_ajax_form_tbpenerimaan_mob_validate_detailpo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "detailpo";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbpenerimaan_mob_validate_detailpo_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tbpenerimaan_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tbpenerimaan_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_reqcode = scAjaxGetFieldText("reqcode");
    var var_pocode = scAjaxGetFieldText("pocode");
    var var_total = scAjaxGetFieldText("total");
    var var_pesandate = scAjaxGetFieldText("pesandate");
    var var_status = scAjaxGetFieldSelect("status");
    var var_jatuhtempo = scAjaxGetFieldText("jatuhtempo");
    var var_note = scAjaxGetFieldText("note");
    var var_orderdate = scAjaxGetFieldText("orderdate");
    var var_totalreal = scAjaxGetFieldText("totalreal");
    var var_ppn = scAjaxGetFieldText("ppn");
    var var_datangdate = scAjaxGetFieldText("datangdate");
    var var_pbf = scAjaxGetFieldSelect("pbf");
    var var_non_pbf = scAjaxGetFieldText("non_pbf");
    var var_fakturno = scAjaxGetFieldText("fakturno");
    var var_tglbast = scAjaxGetFieldText("tglbast");
    var var_nobast = scAjaxGetFieldText("nobast");
    ...
    scAjaxProcOn();
    x_ajax_form_tbpenerimaan_mob_submit_form(var_reqcode, var_pocode, var_total, var_pesandate, var_status, var_jatuhtempo, var_note, var_orderdate, var_totalreal, var_ppn, var_datangdate, var_pbf, var_non_pbf, var_fakturno, var_tglbast, var_nobast, var_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbpenerimaan_mob_submit_form_cb);
  } // do_ajax_form_tbpenerimaan_mob_submit_form

  function do_ajax_form_tbpenerimaan_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("reqcode");
      scAjaxHideErrorDisplay("pocode");
      scAjaxHideErrorDisplay("total");
      scAjaxHideErrorDisplay("pesandate");
      scAjaxHideErrorDisplay("status");
      scAjaxHideErrorDisplay("jatuhtempo");
      scAjaxHideErrorDisplay("note");
      scAjaxHideErrorDisplay("orderdate");
      scAjaxHideErrorDisplay("totalreal");
      scAjaxHideErrorDisplay("ppn");
      scAjaxHideErrorDisplay("datangdate");
      scAjaxHideErrorDisplay("pbf");
      scAjaxHideErrorDisplay("non_pbf");
      scAjaxHideErrorDisplay("fakturno");
      scAjaxHideErrorDisplay("tglbast");
      scAjaxHideErrorDisplay("nobast");
      scAjaxHideErrorDisplay("detailpo");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tbpenerimaan_mob_submit_form_cb_after_alert);
  } // do_ajax_form_tbpenerimaan_mob_submit_form_cb
  function do_ajax_form_tbpenerimaan_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbpenerimaan_mob_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_tbpopenerimaan_mob"] = "off";

  function do_ajax_form_tbpenerimaan_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    scStatusDetail["form_tbpopenerimaan_mob"] = "on";
    x_ajax_form_tbpenerimaan_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbpenerimaan_mob_navigate_form_cb);
  } // do_ajax_form_tbpenerimaan_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbpenerimaan_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbpenerimaan_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_tbpopenerimaan_mob"] && "nmsc_iframe_liga_form_tbpopenerimaan_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_tbpopenerimaan_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_tbpopenerimaan_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_tbpopenerimaan_mob').contentWindow.nm_move('apl_detalhe', true, '1000');
        document.getElementById('nmsc_iframe_liga_form_tbpopenerimaan_mob').style.height = "1000";
        document.getElementById('nmsc_iframe_liga_form_tbpopenerimaan_mob').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbpenerimaan_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_tbpenerimaan_mob_navigate_form_cb
  function do_ajax_form_tbpenerimaan_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_tbpenerimaan_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_tbpenerimaan_mob_navigate_form_cb_after_alert
  function sc_hide_form_tbpenerimaan_mob_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_tbpopenerimaan_mob"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[0] = "reqcode";
  ajax_field_list[1] = "pocode";
  ajax_field_list[2] = "total";
  ajax_field_list[3] = "pesandate";
  ajax_field_list[4] = "status";
  ajax_field_list[5] = "jatuhtempo";
  ajax_field_list[6] = "note";
  ajax_field_list[7] = "orderdate";
  ajax_field_list[8] = "totalreal";
  ajax_field_list[9] = "ppn";
  ajax_field_list[10] = "datangdate";
  ajax_field_list[11] = "pbf";
  ajax_field_list[12] = "non_pbf";
  ajax_field_list[13] = "fakturno";
  ajax_field_list[14] = "tglbast";
  ajax_field_list[15] = "nobast";
  ajax_field_list[16] = "detailpo";
  ...
  var ajax_error_list = {
    "reqcode": {"label": "Kode Permintaan", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "pocode": {"label": "Kode PO", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "total": {"label": "Total Pesan", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "pesandate": {"label": "Tgl. Pesan", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "status": {"label": "Status", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "jatuhtempo": {"label": "Jatuh Tempo", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "note": {"label": "Catatan", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "orderdate": {"label": "Order Date", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "totalreal": {"label": "Total Terima", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "ppn": {"label": "Ppn", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "datangdate": {"label": "Tgl. Datang", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "pbf": {"label": "Supplier", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "non_pbf": {"label": "Non-PBF", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "fakturno": {"label": "Faktur No", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "tglbast": {"label": "Tgl Bast", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "nobast": {"label": "No Bast", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "detailpo": {"label": "", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    ...
    "pesandate": new Array(),
    "status": new Array(),
    "jatuhtempo": new Array(),
    "note": new Array(),
    "orderdate": new Array(),
    "totalreal": new Array(),
    "ppn": new Array(),
    "datangdate": new Array(),
    "pbf": new Array(),
    "non_pbf": new Array(),
    "fakturno": new Array(),
    "tglbast": new Array(),
  ...
  ajax_field_mult["reqcode"][1] = "reqcode";
  ajax_field_mult["pocode"][1] = "pocode";
  ajax_field_mult["total"][1] = "total";
  ajax_field_mult["pesandate"][1] = "pesandate";
  ajax_field_mult["status"][1] = "status";
  ajax_field_mult["jatuhtempo"][1] = "jatuhtempo";
  ajax_field_mult["note"][1] = "note";
  ajax_field_mult["orderdate"][1] = "orderdate";
  ajax_field_mult["totalreal"][1] = "totalreal";
  ajax_field_mult["ppn"][1] = "ppn";
  ajax_field_mult["datangdate"][1] = "datangdate";
  ajax_field_mult["pbf"][1] = "pbf";
  ajax_field_mult["non_pbf"][1] = "non_pbf";
  ajax_field_mult["fakturno"][1] = "fakturno";
  ajax_field_mult["tglbast"][1] = "tglbast";
  ajax_field_mult["nobast"][1] = "nobast";
  ajax_field_mult["detailpo"][1] = "detailpo";

  var ajax_field_id = {
    "reqcode": new Array("hidden_field_label_reqcode", "hidden_field_data_reqcode"),
    "pocode": new Array("hidden_field_label_pocode", "hidden_field_data_pocode"),
    "total": new Array("hidden_field_label_total", "hidden_field_data_total"),
    "pesandate": new Array("hidden_field_label_pesandate", "hidden_field_data_pesandate"),
    "status": new Array("hidden_field_label_status", "hidden_field_data_status"),
    "jatuhtempo": new Array("hidden_field_label_jatuhtempo", "hidden_field_data_jatuhtempo"),
    "note": new Array("hidden_field_label_note", "hidden_field_data_note"),
    "orderdate": new Array("hidden_field_label_orderdate", "hidden_field_data_orderdate"),
    "totalreal": new Array("hidden_field_label_totalreal", "hidden_field_data_totalreal"),
    "ppn": new Array("hidden_field_label_ppn", "hidden_field_data_ppn"),
    "datangdate": new Array("hidden_field_label_datangdate", "hidden_field_data_datangdate"),
    "pbf": new Array("hidden_field_label_pbf", "hidden_field_data_pbf"),
    "non_pbf": new Array("hidden_field_label_non_pbf", "hidden_field_data_non_pbf"),
    "fakturno": new Array("hidden_field_label_fakturno", "hidden_field_data_fakturno"),
    "tglbast": new Array("hidden_field_label_tglbast", "hidden_field_data_tglbast"),
    "nobast": new Array("hidden_field_label_nobast", "hidden_field_data_nobast"),
    "detailpo": new Array("hidden_field_label_detailpo", "hidden_field_data_detailpo")
  };
