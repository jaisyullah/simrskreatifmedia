...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbpenerimaan']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
  <input type="hidden" name="script_case_session" value="<?php echo $this->form_encode_input(session_id()); ?>"> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_tbpenerimaan"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
{
  nm_gp_submit('<?php echo $this->Ini->link_ro_item; ?>', '<?php echo $this->nm_location; ?>', '<?php echo "id_po*scin' + var_btn_sc_btn_0_id_po + '*scouttran_code*scin' + var_btn_sc_btn_0_tran_code + '*scout"; ?>', '', '_blank', '0', '0', 'ro_item');
}
var var_btn_sc_btn_1_id_po = "<?php echo $this->form_encode_input($this->nmgp_dados_form['id']); ?>";
var var_btn_sc_btn_1_tran_code = "<?php echo $this->form_encode_input($this->nmgp_dados_form['pocode']); ?>";
...
{
  nm_gp_submit('<?php echo $this->Ini->link_ro_potrait; ?>', '<?php echo $this->nm_location; ?>', '<?php echo "id_po*scin' + var_btn_sc_btn_1_id_po + '*scouttran_code*scin' + var_btn_sc_btn_1_tran_code + '*scout"; ?>', '', '_blank', '0', '0', 'ro_potrait');
}
var var_btn_CetakPO_id_po = "<?php echo $this->form_encode_input($this->nmgp_dados_form['id']); ?>";
var var_btn_CetakPO_tran_code = "<?php echo $this->form_encode_input($this->nmgp_dados_form['pocode']); ?>";
function sc_btn_CetakPO()
{
    if (scEventControl_active("")) {
      setTimeout(function() { sc_btn_CetakPO(); }, 500);
      return;
    }
    sc_btn_CetakPO_ok();
}
function sc_btn_CetakPO_cancel()
{
}
function sc_btn_CetakPO_ok()
{
  nm_gp_submit('<?php echo $this->Ini->link_po_item; ?>', '<?php echo $this->nm_location; ?>', '<?php echo "id_po*scin' + var_btn_CetakPO_id_po + '*scouttran_code*scin' + var_btn_CetakPO_tran_code + '*scout"; ?>', '', '_blank', '0', '0', 'po_item');
}
var var_btn_sc_btn_2_id_po = "<?php echo $this->form_encode_input($this->nmgp_dados_form['id']); ?>";
var var_btn_sc_btn_2_tran_code = "<?php echo $this->form_encode_input($this->nmgp_dados_form['pocode']); ?>";
...
{
  nm_gp_submit('<?php echo $this->Ini->link_bast_po; ?>', '<?php echo $this->nm_location; ?>', '<?php echo "id_po*scin' + var_btn_sc_btn_2_id_po + '*scouttran_code*scin' + var_btn_sc_btn_2_tran_code + '*scout"; ?>', '', '_blank', '0', '0', 'bast_po');
}
 NM_tp_critica(1);
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbpenerimaan']['where_detal']))
  {
?>  
...
{
   nm_field_disabled("pocode=disabled;total=disabled", "");
   nm_field_disabled("status=disabled;datangdate=disabled;fakturno=disabled", "I");
   nm_field_disabled("pesandate=disabled", "U");
