...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "id";$Nm_numeric[] = "hargapaket";$Nm_numeric[] = "id";$Nm_numeric[] = "hargapaket";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_hargapaket_cond" name="hargapaket_cond" onChange="nm_campos_between(document.getElementById('id_vis_hargapaket'), this, 'hargapaket')">
      ...
      <br><span id="id_hide_hargapaket"  <?php echo $str_hide_hargapaket?>><?php
      if ($hargapaket != "")
      {
      $hargapaket_look = substr($this->Db->qstr($hargapaket), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_kodepaket_cond" name="kodepaket_cond" onChange="nm_campos_between(document.getElementById('id_vis_kodepaket'), this, 'kodepaket')">
      ...
      <br><span id="id_hide_kodepaket"  <?php echo $str_hide_kodepaket?>><?php
      if ($kodepaket != "")
      {
      $kodepaket_look = substr($this->Db->qstr($kodepaket), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_namapaket_cond" name="namapaket_cond" onChange="nm_campos_between(document.getElementById('id_vis_namapaket'), this, 'namapaket')">
      ...
      <br><span id="id_hide_namapaket"  <?php echo $str_hide_namapaket?>><?php
      if ($namapaket != "")
      {
      $namapaket_look = substr($this->Db->qstr($namapaket), 1, -1); 
      $nmgp_def_dados = array(); 
