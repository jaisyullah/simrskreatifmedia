...
class grid_tbpaket_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpaket']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_tbpaket_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_tbpaket_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_tbpaket_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_hargapaket')
      {
          $hargapaket = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_hargapaket($hargapaket);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_kodepaket')
      {
          $kodepaket = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_kodepaket($kodepaket);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_namapaket')
      {
          $namapaket = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_namapaket($namapaket);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function lookup_ajax_hargapaket($hargapaket)
   {
      $hargapaket = str_replace($_SESSION['scriptcase']['reg_conf']['grup_num'], "", $hargapaket);
      $hargapaket = substr($this->Db->qstr($hargapaket), 1, -1);
            $hargapaket_look = substr($this->Db->qstr($hargapaket), 1, -1); 
      $nmgp_def_dados = array(); 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct hargaPaket from " . $this->Ini->nm_tabela . " where   CAST (hargaPaket AS TEXT)  like '%" . $hargapaket . "%' order by hargaPaket"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct hargaPaket from " . $this->Ini->nm_tabela . " where   CAST (hargaPaket AS VARCHAR)  like '%" . $hargapaket . "%' order by hargaPaket"; 
      }
      else
      {
          $nm_comando = "select distinct hargaPaket from " . $this->Ini->nm_tabela . " where  hargaPaket like '%" . $hargapaket . "%' order by hargaPaket"; 
      }
      unset($cmp1,$cmp2);
   ...
   function lookup_ajax_kodepaket($kodepaket)
   {
      $kodepaket = substr($this->Db->qstr($kodepaket), 1, -1);
            $kodepaket_look = substr($this->Db->qstr($kodepaket), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct kodePaket from " . $this->Ini->nm_tabela . " where  kodePaket like '%" . $kodepaket . "%' order by kodePaket"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
   ...
   function lookup_ajax_namapaket($namapaket)
   {
      $namapaket = substr($this->Db->qstr($namapaket), 1, -1);
            $namapaket_look = substr($this->Db->qstr($namapaket), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct namaPaket from " . $this->Ini->nm_tabela . " where  namaPaket like '%" . $namapaket . "%' order by namaPaket"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpaket']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpaket']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpaket']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpaket']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpaket']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpaket']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpaket']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpaket']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpaket']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpaket']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpaket']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpaket']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpaket']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpaket']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpaket']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE>Manajemen Tarif Paket</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_tbpaket/grid_tbpaket_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_tbpaket_ajax_search.js"></script>
 <script type="text/javascript" src="grid_tbpaket_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_tbpaket_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_tbpaket']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_tbpaket']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_hargapaket_cond#NMF#' + search_get_sel_txt('SC_hargapaket_cond') + '@NMF@';
  str_out += 'SC_hargapaket#NMF#' + search_get_text('SC_hargapaket') + '@NMF@';
  str_out += 'id_ac_hargapaket#NMF#' + search_get_text('id_ac_hargapaket') + '@NMF@';
  ...
  str_out += 'SC_kodepaket_cond#NMF#' + search_get_sel_txt('SC_kodepaket_cond') + '@NMF@';
  str_out += 'SC_kodepaket#NMF#' + search_get_text('SC_kodepaket') + '@NMF@';
  str_out += 'id_ac_kodepaket#NMF#' + search_get_text('id_ac_kodepaket') + '@NMF@';
  str_out += 'SC_namapaket_cond#NMF#' + search_get_sel_txt('SC_namapaket_cond') + '@NMF@';
  str_out += 'SC_namapaket#NMF#' + search_get_text('SC_namapaket') + '@NMF@';
  str_out += 'id_ac_namapaket#NMF#' + search_get_text('id_ac_namapaket') + '@NMF@';
   ...
   $("#id_ac_kodepaket").autocomplete({
     ...
     $.ajax({
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_kodepaket",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_kodepaket").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     focus: function (event, ui) {
     ...
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_kodepaket").val( $(this).val() );
       }
     }
   });
   $("#id_ac_namapaket").autocomplete({
     minLength: 1,
     source: function (request, response) {
     $.ajax({
       url: "index.php",
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_namapaket",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_namapaket").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     focus: function (event, ui) {
     ...
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_namapaket").val( $(this).val() );
       }
     }
   });
   $("#id_ac_hargapaket").autocomplete({
     minLength: 1,
     source: function (request, response) {
     $.ajax({
       url: "index.php",
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_hargapaket",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_hargapaket").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     focus: function (event, ui) {
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpaket']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div class="scFilterHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFilterHeaderFont" style="float: left; text-transform: uppercase;">Manajemen Tarif Paket</div>
...
<?php
   ...
   {
      global 
             $hargapaket_cond, $hargapaket, $hargapaket_autocomp,
             $id_cond, $id, $id_autocomp,
             $kodepaket_cond, $kodepaket, $kodepaket_autocomp,
             $namapaket_cond, $namapaket, $namapaket_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpaket']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpaket']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpaket']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpaket']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $hargapaket = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpaket']['campos_busca']['hargapaket']; 
          $hargapaket_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpaket']['campos_busca']['hargapaket_cond']; 
          $id = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpaket']['campos_busca']['id']; 
          $id_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpaket']['campos_busca']['id_cond']; 
          $kodepaket = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpaket']['campos_busca']['kodepaket']; 
          $kodepaket_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpaket']['campos_busca']['kodepaket_cond']; 
          $namapaket = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpaket']['campos_busca']['namapaket']; 
          $namapaket_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpaket']['campos_busca']['namapaket_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpaket']['campos_busca']['NM_operador']; 
      } 
      if (!isset($hargapaket_cond) || empty($hargapaket_cond))
      {
         $hargapaket_cond = "gt";
      }
      ...
      if (!isset($kodepaket_cond) || empty($kodepaket_cond))
      {
         $kodepaket_cond = "qp";
      }
      if (!isset($namapaket_cond) || empty($namapaket_cond))
      {
         $namapaket_cond = "qp";
      }
      ...
      $str_hide_hargapaket = (in_array($hargapaket_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_id = (in_array($id_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_kodepaket = (in_array($kodepaket_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_namapaket = (in_array($namapaket_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      if (!isset($hargapaket) || $hargapaket == "")
      {
          $hargapaket = "";
      }
      if (isset($hargapaket) && !empty($hargapaket))
      {
         $tmp_pos = strpos($hargapaket, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $hargapaket = substr($hargapaket, 0, $tmp_pos);
         }
      }
      if (!isset($id) || $id == "")
      {
      ...
      if (!isset($kodepaket) || $kodepaket == "")
      {
          $kodepaket = "";
      }
      if (isset($kodepaket) && !empty($kodepaket))
      {
         $tmp_pos = strpos($kodepaket, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $kodepaket = substr($kodepaket, 0, $tmp_pos);
         }
      }
      ...
      if (isset($namapaket) && !empty($namapaket))
      {
         $tmp_pos = strpos($namapaket, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $namapaket = substr($namapaket, 0, $tmp_pos);
         }
      }
?>
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_hargapaket_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['hargapaket'])) ? $this->New_label['hargapaket'] : "Harga Paket"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_hargapaket_cond" name="hargapaket_cond" onChange="nm_campos_between(document.getElementById('id_vis_hargapaket'), this, 'hargapaket')">
       <OPTION value="gt" <?php if ("gt" == $hargapaket_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $hargapaket_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $hargapaket_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_hargapaket" <?php echo $str_hide_hargapaket?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['hargapaket'])) ? $this->New_label['hargapaket'] : "Harga Paket";
 $nmgp_tab_label .= "hargapaket?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
...
<?php
      ...
      $hargapaket_look = substr($this->Db->qstr($hargapaket), 1, -1); 
      $nmgp_def_dados = array(); 
   if (is_numeric($hargapaket))
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct hargaPaket from " . $this->Ini->nm_tabela . " where hargaPaket = $hargapaket_look order by hargaPaket"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct hargaPaket from " . $this->Ini->nm_tabela . " where hargaPaket = $hargapaket_look order by hargaPaket"; 
      ...
      if (isset($nmgp_def_dados[0][$hargapaket]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$hargapaket];
      }
      else
      {
            nmgp_Form_Num_Val($hargapaket, ".", ",", "0", "S", "2", "", "N:3", "-") ; 
          $sAutocompValue = $hargapaket;
      }
?>
<INPUT  type="text" id="SC_hargapaket" name="hargapaket" value="<?php echo NM_encode_input($hargapaket) ?>" size=8 alt="{datatype: 'integer', maxLength: 8, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_hargapaket" name="hargapaket_autocomp" size="8"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 8, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
...
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_id" name="id_autocomp" size="5"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 5, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
      ...
      <TD id='SC_kodepaket_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['kodepaket'])) ? $this->New_label['kodepaket'] : "Kode Paket"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_kodepaket_cond" name="kodepaket_cond" onChange="nm_campos_between(document.getElementById('id_vis_kodepaket'), this, 'kodepaket')">
       <OPTION value="qp" <?php if ("qp" == $kodepaket_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $kodepaket_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $kodepaket_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $kodepaket_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_kodepaket" <?php echo $str_hide_kodepaket?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['kodepaket'])) ? $this->New_label['kodepaket'] : "Kode Paket";
 $nmgp_tab_label .= "kodepaket?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      $kodepaket_look = substr($this->Db->qstr($kodepaket), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct kodePaket from " . $this->Ini->nm_tabela . " where kodePaket = '$kodepaket_look' order by kodePaket"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      if (isset($nmgp_def_dados[0][$kodepaket]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$kodepaket];
      }
      else
      {
          $sAutocompValue = $kodepaket;
      }
?>
<INPUT  type="text" id="SC_kodepaket" name="kodepaket" value="<?php echo NM_encode_input($kodepaket) ?>"  size=8 alt="{datatype: 'text', maxLength: 8, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_kodepaket" name="kodepaket_autocomp" size="8"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 8, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_namapaket_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['namapaket'])) ? $this->New_label['namapaket'] : "Nama Paket"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_namapaket_cond" name="namapaket_cond" onChange="nm_campos_between(document.getElementById('id_vis_namapaket'), this, 'namapaket')">
       <OPTION value="qp" <?php if ("qp" == $namapaket_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $namapaket_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $namapaket_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $namapaket_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_namapaket" <?php echo $str_hide_namapaket?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['namapaket'])) ? $this->New_label['namapaket'] : "Nama Paket";
 $nmgp_tab_label .= "namapaket?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      $namapaket_look = substr($this->Db->qstr($namapaket), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct namaPaket from " . $this->Ini->nm_tabela . " where namaPaket = '$namapaket_look' order by namaPaket"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      if (isset($nmgp_def_dados[0][$namapaket]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$namapaket];
      }
      else
      {
          $sAutocompValue = $namapaket;
      }
?>
<INPUT  type="text" id="SC_namapaket" name="namapaket" value="<?php echo NM_encode_input($namapaket) ?>"  size=50 alt="{datatype: 'text', maxLength: 100, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_namapaket" name="namapaket_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 100, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
?>
<?php
   if (is_file("grid_tbpaket_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_tbpaket']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_tbpaket']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpaket']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.hargapaket_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_hargapaket'), document.F1.hargapaket_cond, 'hargapaket');
   document.F1.hargapaket.value = "";
   document.F1.hargapaket_autocomp.value = "";
   ...
   document.F1.kodepaket_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_kodepaket'), document.F1.kodepaket_cond, 'kodepaket');
   document.F1.kodepaket.value = "";
   document.F1.kodepaket_autocomp.value = "";
   document.F1.namapaket_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_namapaket'), document.F1.namapaket_cond, 'namapaket');
   document.F1.namapaket.value = "";
   document.F1.namapaket_autocomp.value = "";
 }
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "simrskreatifmedia/grid_tbpaket";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpaket']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpaket']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpaket']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_hargapaket_cond'] = 'cond';
      $tp_fields['SC_hargapaket'] = 'text_aut';
      $tp_fields['id_ac_hargapaket'] = 'text_aut';
      $tp_fields['SC_id_cond'] = 'cond';
      $tp_fields['SC_id'] = 'text_aut';
      $tp_fields['id_ac_id'] = 'text_aut';
      $tp_fields['SC_kodepaket_cond'] = 'cond';
      $tp_fields['SC_kodepaket'] = 'text_aut';
      $tp_fields['id_ac_kodepaket'] = 'text_aut';
      $tp_fields['SC_namapaket_cond'] = 'cond';
      $tp_fields['SC_namapaket'] = 'text_aut';
      $tp_fields['id_ac_namapaket'] = 'text_aut';
   ...
   {
      global $hargapaket_cond, $hargapaket, $hargapaket_autocomp,
             $id_cond, $id, $id_autocomp,
             $kodepaket_cond, $kodepaket, $kodepaket_autocomp,
             $namapaket_cond, $namapaket, $namapaket_autocomp, $nmgp_tab_label;

      $C_formatado = true;
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_conv_dados.php", "F", "nm_conv_limpa_dado") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
      if (!empty($hargapaket_autocomp) && empty($hargapaket))
      {
          $hargapaket = $hargapaket_autocomp;
      }
      if (!empty($id_autocomp) && empty($id))
      {
          $id = $id_autocomp;
      }
      if (!empty($kodepaket_autocomp) && empty($kodepaket))
      {
          $kodepaket = $kodepaket_autocomp;
      }
      if (!empty($namapaket_autocomp) && empty($namapaket))
      {
          $namapaket = $namapaket_autocomp;
      }
      $hargapaket_cond_salva = $hargapaket_cond; 
      if (!isset($hargapaket_input_2) || $hargapaket_input_2 == "")
      {
          $hargapaket_input_2 = $hargapaket;
      }
      ...
      $kodepaket_cond_salva = $kodepaket_cond; 
      if (!isset($kodepaket_input_2) || $kodepaket_input_2 == "")
      {
          $kodepaket_input_2 = $kodepaket;
      }
      $namapaket_cond_salva = $namapaket_cond; 
      if (!isset($namapaket_input_2) || $namapaket_input_2 == "")
      {
          $namapaket_input_2 = $namapaket;
      }
      if ($hargapaket_cond != "in")
      {
          nm_limpa_numero($hargapaket, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($id_cond != "in")
      {
          nm_limpa_numero($id, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpaket']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpaket']['campos_busca']['hargapaket'] = $hargapaket; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpaket']['campos_busca']['hargapaket_cond'] = $hargapaket_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpaket']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpaket']['campos_busca']['id'] = $id; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpaket']['campos_busca']['id_cond'] = $id_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpaket']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpaket']['campos_busca']['kodepaket'] = $kodepaket; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpaket']['campos_busca']['kodepaket_cond'] = $kodepaket_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpaket']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpaket']['campos_busca']['namapaket'] = $namapaket; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpaket']['campos_busca']['namapaket_cond'] = $namapaket_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpaket']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpaket']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpaket']['campos_busca'] = $Temp_Busca;
      }
      if ($hargapaket_cond != "in" && $hargapaket_cond != "bw" && !empty($hargapaket) && !is_numeric($hargapaket))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Harga Paket";
      }
      if ($hargapaket_cond == "bw" && ((!empty($hargapaket) && !is_numeric($hargapaket)) || (!empty($hargapaket_input_2) && !is_numeric($hargapaket_input_2)) ))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Harga Paket";
      }
   ...
   { 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['hargapaket'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['hargapaket'] = $cmp1;
      }
      else
      {
          $cmp1 = $hargapaket;
   ...
   { 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['kodepaket'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['kodepaket'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['kodepaket'] = $kodepaket;
      }
      $namapaket_look = substr($this->Db->qstr($namapaket), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct namaPaket from " . $this->Ini->nm_tabela . " where namaPaket = '$namapaket_look' order by namaPaket"; 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['namapaket'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['namapaket'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['namapaket'] = $namapaket;
      }

      //----- $hargapaket
      $this->Date_part = false;
      if (isset($hargapaket) || $hargapaket_cond == "nu" || $hargapaket_cond == "nn" || $hargapaket_cond == "ep" || $hargapaket_cond == "ne")
      {
         $this->monta_condicao("hargaPaket", $hargapaket_cond, $hargapaket, "", "hargapaket");
      }
      ...
      //----- $kodepaket
      $this->Date_part = false;
      if (isset($kodepaket) || $kodepaket_cond == "nu" || $kodepaket_cond == "nn" || $kodepaket_cond == "ep" || $kodepaket_cond == "ne")
      {
         $this->monta_condicao("kodePaket", $kodepaket_cond, $kodepaket, "", "kodepaket");
      }

      //----- $namapaket
      $this->Date_part = false;
      if (isset($namapaket) || $namapaket_cond == "nu" || $namapaket_cond == "nn" || $namapaket_cond == "ep" || $namapaket_cond == "ne")
      {
         $this->monta_condicao("namaPaket", $namapaket_cond, $namapaket, "", "namapaket");
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpaket']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpaket']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpaket']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpaket']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpaket']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpaket']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpaket']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpaket']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpaket']['cond_pesq'] .= $this->NM_operador;
