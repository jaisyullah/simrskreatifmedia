...
<?php
   ...
   $Ord_Cmp = new grid_tbpaket_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_tbpaket_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbpaket']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tbpaket']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbpaket']['labels']["id"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbpaket']['labels']["id"] : "ID";
   $tab_ger_campos['kodepaket'] = "on";
   $tab_def_campos['kodepaket'] = "kodePaket";
   $tab_labels["kodepaket"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbpaket']['labels']["kodepaket"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbpaket']['labels']["kodepaket"] : "Kode Paket";
   $tab_ger_campos['namapaket'] = "on";
   $tab_def_campos['namapaket'] = "namaPaket";
   $tab_labels["namapaket"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbpaket']['labels']["namapaket"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbpaket']['labels']["namapaket"] : "Nama Paket";
   $tab_ger_campos['hargapaket'] = "on";
   $tab_def_campos['hargapaket'] = "hargaPaket";
   $tab_labels["hargapaket"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbpaket']['labels']["hargapaket"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbpaket']['labels']["hargapaket"] : "Harga Paket";
   $tab_ger_campos['aktif'] = "on";
   $tab_def_campos['aktif'] = "aktif";
   $tab_labels["aktif"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbpaket']['labels']["aktif"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbpaket']['labels']["aktif"] : "Aktif";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_tbpaket']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_tbpaket']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_tbpaket']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbpaket']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tbpaket']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_tbpaket']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_tbpaket']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_tbpaket']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_tbpaket']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_tbpaket_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_tbpaket']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_tbpaket']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_tbpaket']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_tbpaket']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_tbpaket']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
