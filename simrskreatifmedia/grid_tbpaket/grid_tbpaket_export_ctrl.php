<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tbpaket']['sc_process_barr'] = true;
require_once('../grid_tbpaket/index.php');
unset($_SESSION['scriptcase']['grid_tbpaket']['sc_process_barr']);
$ExportCtrl = new grid_tbpaket_export_control;
$ExportCtrl->Export_barr();

class grid_tbpaket_export_control
{
