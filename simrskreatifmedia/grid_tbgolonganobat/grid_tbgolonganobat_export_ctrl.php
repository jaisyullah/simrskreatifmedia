<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tbgolonganobat']['sc_process_barr'] = true;
require_once('../grid_tbgolonganobat/index.php');
unset($_SESSION['scriptcase']['grid_tbgolonganobat']['sc_process_barr']);
$ExportCtrl = new grid_tbgolonganobat_export_control;
$ExportCtrl->Export_barr();

class grid_tbgolonganobat_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - Golongan Obat :: Excel</TITLE>
