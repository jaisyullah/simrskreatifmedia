...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_tbgolonganobat"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_tbgolonganobat"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_tbgolonganobat'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tbgolonganobat']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_tbgolonganobat']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tbgolonganobat']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_tbgolonganobat']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_tbgolonganobat']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_tbgolonganobat</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_tbgolonganobat']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_tbgolonganobat']['embutida_filho'] as $ind => $sc_init)
          {
