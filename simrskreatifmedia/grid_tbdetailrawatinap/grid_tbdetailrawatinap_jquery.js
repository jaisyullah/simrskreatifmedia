...
function ajax_navigate(opc, parm)
{
    ...
    return new Promise(function(resolve, reject) {$.ajax({
     ...
     .done(function(jsonNavigate) {
        ...
        document.getElementById('nmsc_iframe_liga_A_grid_tbdetailrawatinap').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_E_grid_tbdetailrawatinap').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_D_grid_tbdetailrawatinap').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_B_grid_tbdetailrawatinap').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_A_grid_tbdetailrawatinap').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_E_grid_tbdetailrawatinap').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_D_grid_tbdetailrawatinap').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_B_grid_tbdetailrawatinap').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_A_grid_tbdetailrawatinap').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_E_grid_tbdetailrawatinap').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_D_grid_tbdetailrawatinap').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_B_grid_tbdetailrawatinap').style.width  = '0px';
        if (oResp["redirInfo"]) {
           nmAjaxRedir(oResp);
        }
        if (oResp["setValue"]) {
          for (i = 0; i < oResp["setValue"].length; i++) {
            if ("sc_grid_body" == oResp["setValue"][i]["field"] && !scrollNavigateReload) {
              $("#sc-ui-grid-body-f0316136 > tbody").append(oResp["setValue"][i]["value"]);
            }
            else {
