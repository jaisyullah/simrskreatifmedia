<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_tbdetailrawatinap']['glo_nm_path_imag_temp'] . "/sc_apl_default_simrskreatifmedia.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_tbdetailrawatinap_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_tbdetailrawatinap_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatinap']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatinap']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["trancode"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatinap']['labels']["trancode"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatinap']['labels']["trancode"] : "Kode";
   ...
   {
       $tab_def_campos['custcode'] = "a.custCode";
   }
   $tab_labels["custcode"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatinap']['labels']["custcode"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatinap']['labels']["custcode"] : "No RM";
   ...
   {
       $tab_def_campos['nama'] = "concat(c.name,', ',c.salut)";
   }
   $tab_labels["nama"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatinap']['labels']["nama"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatinap']['labels']["nama"] : "Nama Pasien";
   $tab_ger_campos['umur'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['umur'] = "Umur";
   }
   else
   {
       $tab_def_campos['umur'] = "";
   }
   $tab_labels["umur"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatinap']['labels']["umur"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatinap']['labels']["umur"] : "Umur";
   ...
   $tab_labels["sc_field_3"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatinap']['labels']["sc_field_3"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatinap']['labels']["sc_field_3"] : "Tgl. Lahir";
   ...
   $tab_labels["dokter"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatinap']['labels']["dokter"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatinap']['labels']["dokter"] : "DPJP";
   ...
   {
       $tab_def_campos['ruanginap'] = "select sc_concat(c.ruang,' (Bed ',c.noBed,')') as 'Ruang/Bed' from tbadmrawatinap a left join tbdetailrawatinap b on b.tranCode = a.tranCode left join tbbed c on c.idBed = a.bed where a.tranCode = '{tranCode}'";
   }
   $tab_labels["ruanginap"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatinap']['labels']["ruanginap"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatinap']['labels']["ruanginap"] : "Ruang / Bed";
   $tab_ger_campos['selesai'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['selesai'] = "selesai";
   }
   else
   {
       $tab_def_campos['selesai'] = "a.selesai";
   }
   $tab_labels["selesai"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatinap']['labels']["selesai"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatinap']['labels']["selesai"] : "Selesai";
   ...
   $tab_labels["carakeluar"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatinap']['labels']["carakeluar"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatinap']['labels']["carakeluar"] : "Cara Keluar";
   ...
   {
       $tab_def_campos['sc_field_2'] = "SELECT tglMasuk 
FROM tbadmrawatinap 
WHERE tranCode = '{tranCode}' 
ORDER BY tglMasuk";
   }
   $tab_labels["sc_field_2"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatinap']['labels']["sc_field_2"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatinap']['labels']["sc_field_2"] : "Tgl. Masuk";
   ...
   $tab_labels["tglkeluar"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatinap']['labels']["tglkeluar"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatinap']['labels']["tglkeluar"] : "Tgl Keluar";
   $tab_ger_campos['jeniskeluar'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['jeniskeluar'] = "jeniskeluar";
   }
   else
   {
       $tab_def_campos['jeniskeluar'] = "a.jenisKeluar";
   }
   $tab_labels["jeniskeluar"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatinap']['labels']["jeniskeluar"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatinap']['labels']["jeniskeluar"] : "Jenis Keluar";
   ...
   {
       $tab_def_campos['jenis'] = "";
   }
   $tab_labels["jenis"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatinap']['labels']["jenis"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatinap']['labels']["jenis"] : "Jenis";
   ...
   $tab_labels["sc_field_4"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatinap']['labels']["sc_field_4"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatinap']['labels']["sc_field_4"] : "Hak Kelas";
   $tab_ger_campos['umur'] = "none";
   $tab_ger_campos['sc_field_3'] = "none";
   $tab_ger_campos['ruanginap'] = "none";
   $tab_ger_campos['sc_field_2'] = "none";
   $tab_ger_campos['jenis'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatinap']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatinap']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatinap']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatinap']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatinap']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatinap']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatinap']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatinap']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatinap']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_tbdetailrawatinap_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatinap']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatinap']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatinap']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatinap']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatinap']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
