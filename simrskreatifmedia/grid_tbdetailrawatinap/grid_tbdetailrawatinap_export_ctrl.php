<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tbdetailrawatinap']['sc_process_barr'] = true;
require_once('../grid_tbdetailrawatinap/index.php');
unset($_SESSION['scriptcase']['grid_tbdetailrawatinap']['sc_process_barr']);
$ExportCtrl = new grid_tbdetailrawatinap_export_control;
$ExportCtrl->Export_barr();

class grid_tbdetailrawatinap_export_control
{
