...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_tbdetailrawatinap"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_tbdetailrawatinap"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tbdetailrawatinap']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_tbdetailrawatinap']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tbdetailrawatinap']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_tbdetailrawatinap']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_tbdetailrawatinap']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_tbdetailrawatinap</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_tbdetailrawatinap']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_tbdetailrawatinap']['embutida_filho'] as $ind => $sc_init)
          {
