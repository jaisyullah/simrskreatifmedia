...
<HEAD>
 <TITLE><?php if ('novo' == $this->nmgp_opcao) { echo strip_tags("" . $this->Ini->Nm_lang['lang_othr_frmi_titl'] . " - tbfisikigd"); } else { echo strip_tags("" . $this->Ini->Nm_lang['lang_othr_frmu_titl'] . " - tbfisikigd"); } ?></TITLE>
...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbfisikigd']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_tbfisikigd/form_tbfisikigd_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_tbfisikigd_sajax_js.php");
?>
<script type="text/javascript">
...
function nav_desliga_img()
{
 ...
 function nm_field_disabled(Fields, Opt) {
  ...
  for (i=0; i < Field.length; i++)
  {
     ...
     if (F_name == "tglperiksa")
     {
        $('input[name="tglperiksa"]').prop("disabled", F_opc);
        if (F_opc == "disabled" || F_opc == true) {
            $('input[name="tglperiksa"]').addClass("scFormInputDisabled");
        }
        else {
            $('input[name="tglperiksa"]').removeClass("scFormInputDisabled");
        }
     }
  }
 } // nm_field_disabled
...
include_once('form_tbfisikigd_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbfisikigd']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbfisikigd']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbfisikigd']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbfisikigd']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbfisikigd']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbfisikigd']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbfisikigd']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbfisikigd']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
?>
...
<?php
 include_once("form_tbfisikigd_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbfisikigd']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbfisikigd']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_tbfisikigd'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_tbfisikigd'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbfisikigd']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbfisikigd']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbfisikigd']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbfisikigd']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbfisikigd']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<div class="scFormHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFormHeaderFont" style="float: left; text-transform: uppercase;"><?php if ($this->nmgp_opcao == "novo") { echo "" . $this->Ini->Nm_lang['lang_othr_frmi_titl'] . " - tbfisikigd"; } else { echo "" . $this->Ini->Nm_lang['lang_othr_frmu_titl'] . " - tbfisikigd"; } ?></div>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbfisikigd']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbfisikigd']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbfisikigd']['run_iframe'] != "R")
{
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbfisikigd']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbfisikigd']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbfisikigd']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbfisikigd']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbfisikigd']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbfisikigd']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbfisikigd']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbfisikigd']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbfisikigd']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbfisikigd']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tinggi_label" id="hidden_field_label_tinggi" style="<?php echo $sStyleHidden_tinggi; ?>"><span id="id_label_tinggi"><?php echo $this->nm_new_label['tinggi']; ?></span></TD>
    <TD class="scFormDataOdd css_tinggi_line" id="hidden_field_data_tinggi" style="<?php echo $sStyleHidden_tinggi; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tinggi_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_berat_label" id="hidden_field_label_berat" style="<?php echo $sStyleHidden_berat; ?>"><span id="id_label_berat"><?php echo $this->nm_new_label['berat']; ?></span></TD>
    <TD class="scFormDataOdd css_berat_line" id="hidden_field_data_berat" style="<?php echo $sStyleHidden_berat; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_berat_line" style="vertical-align: top;padding: 0px">
...
<span id="id_read_on_berat" class="sc-ui-readonly-berat css_berat_line" style="<?php echo $sStyleReadLab_berat; ?>"><?php echo $this->berat; ?></span><span id="id_read_off_berat" class="css_read_off_berat" style="white-space: nowrap;<?php echo $sStyleReadInp_berat; ?>">
 ...
 size=6 alt="{datatype: 'decimal', maxLength: 3, precision: 1, decimalSep: '<?php echo str_replace("'", "\'", $this->field_config['berat']['symbol_dec']); ?>', thousandsSep: '<?php echo str_replace("'", "\'", $this->field_config['berat']['symbol_grp']); ?>', thousandsFormat: <?php echo $this->field_config['berat']['symbol_fmt']; ?>, manualDecimals: false, allowNegative: false, onlyNegative: false, negativePos: <?php echo (4 == $this->field_config['berat']['format_neg'] ? "'suffix'" : "'prefix'") ?>, alignment: 'left', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: 'mis. 60', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
<span class="css_berat_label scFormDataHelpOdd">&nbsp;kg
</span></td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_berat_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_berat_text"></span></td></tr></table></td></tr></table></TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_detakjantung_label" id="hidden_field_label_detakjantung" style="<?php echo $sStyleHidden_detakjantung; ?>"><span id="id_label_detakjantung"><?php echo $this->nm_new_label['detakjantung']; ?></span></TD>
    <TD class="scFormDataOdd css_detakjantung_line" id="hidden_field_data_detakjantung" style="<?php echo $sStyleHidden_detakjantung; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_detakjantung_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tekanandarah_label" id="hidden_field_label_tekanandarah" style="<?php echo $sStyleHidden_tekanandarah; ?>"><span id="id_label_tekanandarah"><?php echo $this->nm_new_label['tekanandarah']; ?></span></TD>
    <TD class="scFormDataOdd css_tekanandarah_line" id="hidden_field_data_tekanandarah" style="<?php echo $sStyleHidden_tekanandarah; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tekanandarah_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_suhu_label" id="hidden_field_label_suhu" style="<?php echo $sStyleHidden_suhu; ?>"><span id="id_label_suhu"><?php echo $this->nm_new_label['suhu']; ?></span></TD>
    <TD class="scFormDataOdd css_suhu_line" id="hidden_field_data_suhu" style="<?php echo $sStyleHidden_suhu; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_suhu_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_nafas_label" id="hidden_field_label_nafas" style="<?php echo $sStyleHidden_nafas; ?>"><span id="id_label_nafas"><?php echo $this->nm_new_label['nafas']; ?></span></TD>
    <TD class="scFormDataOdd css_nafas_line" id="hidden_field_data_nafas" style="<?php echo $sStyleHidden_nafas; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_nafas_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_keluhan_label" id="hidden_field_label_keluhan" style="<?php echo $sStyleHidden_keluhan; ?>"><span id="id_label_keluhan"><?php echo $this->nm_new_label['keluhan']; ?></span></TD>
    <TD class="scFormDataOdd css_keluhan_line" id="hidden_field_data_keluhan" style="<?php echo $sStyleHidden_keluhan; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_keluhan_line" style="vertical-align: top;padding: 0px">
<?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_pemeriksa_label" id="hidden_field_label_pemeriksa" style="<?php echo $sStyleHidden_pemeriksa; ?>"><span id="id_label_pemeriksa"><?php echo $this->nm_new_label['pemeriksa']; ?></span></TD>
    <TD class="scFormDataOdd css_pemeriksa_line" id="hidden_field_data_pemeriksa" style="<?php echo $sStyleHidden_pemeriksa; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_pemeriksa_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tglperiksa_label" id="hidden_field_label_tglperiksa" style="<?php echo $sStyleHidden_tglperiksa; ?>"><span id="id_label_tglperiksa"><?php echo $this->nm_new_label['tglperiksa']; ?></span></TD>
    <TD class="scFormDataOdd css_tglperiksa_line" id="hidden_field_data_tglperiksa" style="<?php echo $sStyleHidden_tglperiksa; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tglperiksa_line" style="vertical-align: top;padding: 0px">
...
<?php } else { ?>
<span id="id_read_on_tglperiksa" class="sc-ui-readonly-tglperiksa css_tglperiksa_line" style="<?php echo $sStyleReadLab_tglperiksa; ?>"><?php echo $tglperiksa; ?></span><span id="id_read_off_tglperiksa" class="css_read_off_tglperiksa" style="white-space: nowrap;<?php echo $sStyleReadInp_tglperiksa; ?>">
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbfisikigd']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbfisikigd']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_tbfisikigd");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_tbfisikigd");
 parent.scAjaxDetailHeight("form_tbfisikigd", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbfisikigd']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
