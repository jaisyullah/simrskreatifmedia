<?php
class form_tbreseprawatigd_old_form extends form_tbreseprawatigd_old_apl
{
function Form_Init()
{
...
<HEAD>
 <TITLE><?php if ('novo' == $this->nmgp_opcao) { echo strip_tags("" . $this->Ini->Nm_lang['lang_othr_frmi_titl'] . " - tbreseprawatigd"); } else { echo strip_tags("" . $this->Ini->Nm_lang['lang_othr_frmu_titl'] . " - tbreseprawatigd"); } ?></TITLE>
...
<?php
if ($this->Embutida_form && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatigd_old']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatigd_old']['sc_modal'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatigd_old']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatigd_old']['sc_redir_atualiz'] == 'ok')
{
?>
...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatigd_old']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_tbreseprawatigd_old/form_tbreseprawatigd_old_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_tbreseprawatigd_old_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_tbreseprawatigd_old_jquery.php');
...
?>
 ...
 function addAutocomplete(elem) {
  ...
  $(".sc-ui-autocomp-item_", elem).on("focus", function() {
   ...
   width: "300px",
   ajax: {
    url: "form_tbreseprawatigd_old.php",
    dataType: "json",
   ...
   var sId = $(this).attr("id").substr(6), sRow = "item_" != sId ? sId.substr(5) : "";
   sc_form_tbreseprawatigd_old_item__onfocus("id_sc_field_" + sId, sRow);
  ...
  var iSeq_jenisaturanpakai_ = $(".sc-ui-autocomp-jenisaturanpakai_", elem).attr("id").substr(23);

  $(".sc-ui-autocomp-jenisaturanpakai_", elem).on("focus", function() {
   var sId = $(this).attr("id").substr(6);
   scEventControl_data[sId]["autocomp"] = true;
  }).on("blur", function() {
   var sId = $(this).attr("id").substr(6), sRow = "jenisaturanpakai_" != sId ? sId.substr(17) : "";
   if ("" == $(this).val()) {
    $("#id_sc_field_" + sId).val("");
   }
   scEventControl_data[sId]["autocomp"] = false;
   ...
   ajax: {
    ...
    data: function (params) {
     var query = {
      term: params.term,
      nmgp_opcao: "ajax_autocomp",
      nmgp_parms: "NM_ajax_opcao?#?autocomp_jenisaturanpakai_",
      script_case_init: document.F2.script_case_init.value
     }
     return query;
    }
   ...
   var sId = $(this).attr("id").substr(6), sRow = "jenisaturanpakai_" != sId ? sId.substr(17) : "";
   sc_form_tbreseprawatigd_old_jenisaturanpakai__onfocus("id_sc_field_" + sId, sRow);
  }).on("select2:close", function(e) {
   var sId = $(this).attr("id").substr(6);
   $("#id_sc_field_" + sId).trigger("blur");
  }).on("select2:select", function(e) {
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatigd_old']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatigd_old']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatigd_old']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatigd_old']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatigd_old']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatigd_old']['recarga'];
}
if ('novo' == $opcao_botoes && $this->Embutida_form)
{
    $opcao_botoes = 'inicio';
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatigd_old']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatigd_old']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
?>
...
<?php
 include_once("form_tbreseprawatigd_old_js0.php");
?>
<script type="text/javascript"> 
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_tbreseprawatigd_old'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_tbreseprawatigd_old'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatigd_old']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatigd_old']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatigd_old']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatigd_old']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatigd_old']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<div class="scFormHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFormHeaderFont" style="float: left; text-transform: uppercase;"><?php if ($this->nmgp_opcao == "novo") { echo "" . $this->Ini->Nm_lang['lang_othr_frmi_titl'] . " - tbreseprawatigd"; } else { echo "" . $this->Ini->Nm_lang['lang_othr_frmu_titl'] . " - tbreseprawatigd"; } ?></div>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatigd_old']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatigd_old']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatigd_old']['run_iframe'] != "R")
{
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatigd_old']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatigd_old']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatigd_old']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatigd_old']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatigd_old']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatigd_old']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatigd_old']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatigd_old']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatigd_old']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatigd_old']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
 ...
 ?>
   ...
   <?php if (isset($this->nmgp_cmp_hidden['biaya_']) && $this->nmgp_cmp_hidden['biaya_'] == 'off') { $sStyleHidden_biaya_ = 'display: none'; }
      ...
      if (!isset($this->nm_new_label['biaya_'])) {
          $this->nm_new_label['biaya_'] = "Harga"; } ?>
...
{ 
   ...
   { 
       ob_start();
       $iStart = sizeof($this->form_vert_form_tbreseprawatigd_old);
       $guarda_nmgp_opcao = $this->nmgp_opcao;
       $guarda_form_vert_form_tbreseprawatigd_old = $this->form_vert_form_tbreseprawatigd_old;
       $this->nmgp_opcao = 'novo';
   } 
   if ($this->Embutida_form && empty($this->form_vert_form_tbreseprawatigd_old))
   {
       $sc_seq_vert = 0;
   }
   ...
   foreach ($this->form_vert_form_tbreseprawatigd_old as $sc_seq_vert => $sc_lixo)
   {
       $this->loadRecordState($sc_seq_vert);
       $this->trancode_ = $this->form_vert_form_tbreseprawatigd_old[$sc_seq_vert]['trancode_'];
       $this->retur_ = $this->form_vert_form_tbreseprawatigd_old[$sc_seq_vert]['retur_'];
       $this->kode_akun_ = $this->form_vert_form_tbreseprawatigd_old[$sc_seq_vert]['kode_akun_'];
       ...
       $this->satuan_ = $this->form_vert_form_tbreseprawatigd_old[$sc_seq_vert]['satuan_']; 
       ...
       $this->stok_ = $this->form_vert_form_tbreseprawatigd_old[$sc_seq_vert]['stok_']; 
       $stok_ = $this->stok_; 
       $sStyleHidden_stok_ = '';
       ...
       $this->biaya_ = $this->form_vert_form_tbreseprawatigd_old[$sc_seq_vert]['biaya_']; 
       $biaya_ = $this->biaya_; 
       $sStyleHidden_biaya_ = '';
       ...
       $this->jumlah_ = $this->form_vert_form_tbreseprawatigd_old[$sc_seq_vert]['jumlah_']; 
       ...
       $this->signa_ = $this->form_vert_form_tbreseprawatigd_old[$sc_seq_vert]['signa_']; 
       $signa_ = $this->signa_; 
       $sStyleHidden_signa_ = '';
       ...
       $this->jenisaturanpakai_ = $this->form_vert_form_tbreseprawatigd_old[$sc_seq_vert]['jenisaturanpakai_']; 
       ...
       $this->diskon_ = $this->form_vert_form_tbreseprawatigd_old[$sc_seq_vert]['diskon_']; 
       ...
       $this->id_ = $this->form_vert_form_tbreseprawatigd_old[$sc_seq_vert]['id_']; 
       $id_ = $this->id_; 
       if (!isset($this->nmgp_cmp_hidden['id_']))
       {
           $this->nmgp_cmp_hidden['id_'] = 'off';
       ...
       $this->trandate_ = $this->form_vert_form_tbreseprawatigd_old[$sc_seq_vert]['trandate_'] . ' ' . $this->form_vert_form_tbreseprawatigd_old[$sc_seq_vert]['trandate__hora']; 
...
<?php echo nmButtonOutput($this->arr_buttons, "bmd_novo", "do_ajax_form_tbreseprawatigd_old_add_new_line(" . $sc_seq_vert . ")", "do_ajax_form_tbreseprawatigd_old_add_new_line(" . $sc_seq_vert . ")", "sc_new_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
<?php }?>
<?php
  $Style_add_line = (!$Line_Add) ? "display: none" : "";
?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_form_tbreseprawatigd_old_cancel_insert(" . $sc_seq_vert . ")", "do_ajax_form_tbreseprawatigd_old_cancel_insert(" . $sc_seq_vert . ")", "sc_canceli_line_" . $sc_seq_vert . "", "", "", "" . $Style_add_line . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_form_tbreseprawatigd_old_cancel_update(" . $sc_seq_vert . ")", "do_ajax_form_tbreseprawatigd_old_cancel_update(" . $sc_seq_vert . ")", "sc_cancelu_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
 </TD>
   <?php }?>
...
$aLookup = array();
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
$sAutocompValue = (isset($aLookup[0][$this->jenisaturanpakai_])) ? $aLookup[0][$this->jenisaturanpakai_] : $this->jenisaturanpakai_;
$jenisaturanpakai__look = (isset($aLookup[0][$this->jenisaturanpakai_])) ? $aLookup[0][$this->jenisaturanpakai_] : $this->jenisaturanpakai_;
?>
<span id="id_read_on_jenisaturanpakai_<?php echo $sc_seq_vert ?>" class="sc-ui-readonly-jenisaturanpakai_<?php echo $sc_seq_vert ?> css_jenisaturanpakai__line" style="<?php echo $sStyleReadLab_jenisaturanpakai_; ?>"><?php echo str_replace("<", "&lt;", $jenisaturanpakai__look); ?></span><span id="id_read_off_jenisaturanpakai_<?php echo $sc_seq_vert ?>" class="css_read_off_jenisaturanpakai_" style="white-space: nowrap;<?php echo $sStyleReadInp_jenisaturanpakai_; ?>">
 <input class="sc-js-input scFormObjectOddMult css_jenisaturanpakai__obj" style="display: none;" id="id_sc_field_jenisaturanpakai_<?php echo $sc_seq_vert ?>" type=text name="jenisaturanpakai_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($jenisaturanpakai_) ?>"
...
$aLookup = array();
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
$sAutocompValue = (isset($aLookup[0][$this->jenisaturanpakai_])) ? $aLookup[0][$this->jenisaturanpakai_] : '';
$jenisaturanpakai__look = (isset($aLookup[0][$this->jenisaturanpakai_])) ? $aLookup[0][$this->jenisaturanpakai_] : '';
?>
<select id="id_ac_jenisaturanpakai_<?php echo $sc_seq_vert; ?>" class="scFormObjectOddMult sc-ui-autocomp-jenisaturanpakai_ css_jenisaturanpakai__obj"><?php if ('' != $this->jenisaturanpakai_) { ?><option value="<?php echo $this->jenisaturanpakai_ ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select></span><?php } ?>
...
<?php   
   ...
   { 
       ...
       $this->form_vert_form_tbreseprawatigd_old = $guarda_form_vert_form_tbreseprawatigd_old;
   } 
   if ($Table_refresh) 
   { 
...
<?php
if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatigd_old']['run_modal']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatigd_old']['run_modal'])
{
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatigd_old']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatigd_old']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_tbreseprawatigd_old");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_tbreseprawatigd_old");
 parent.scAjaxDetailHeight("form_tbreseprawatigd_old", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
<script type="text/javascript">
	function scBtnFn_sys_format_inc() {
		if ($("#sc_b_new_t.sc-unique-btn-1").length && $("#sc_b_new_t.sc-unique-btn-1").is(":visible")) {
			do_ajax_form_tbreseprawatigd_old_add_new_line(); return false;
			 return;
		}
...
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatigd_old']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
