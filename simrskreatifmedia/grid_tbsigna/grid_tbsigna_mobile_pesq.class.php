...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_signacode_cond" name="signacode_cond" onChange="nm_campos_between(document.getElementById('id_vis_signacode'), this, 'signacode')">
      ...
      <br><span id="id_hide_signacode"  <?php echo $str_hide_signacode?>><?php
      if ($signacode != "")
      {
      $signacode_look = substr($this->Db->qstr($signacode), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_signaname_cond" name="signaname_cond" onChange="nm_campos_between(document.getElementById('id_vis_signaname'), this, 'signaname')">
      ...
      <br><span id="id_hide_signaname"  <?php echo $str_hide_signaname?>><?php
      if ($signaname != "")
      {
      $signaname_look = substr($this->Db->qstr($signaname), 1, -1); 
      $nmgp_def_dados = array(); 
