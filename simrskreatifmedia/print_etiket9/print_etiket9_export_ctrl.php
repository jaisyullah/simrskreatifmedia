<?php
@session_start() ;
$_SESSION['scriptcase']['print_etiket9']['sc_process_barr'] = true;
require_once('../print_etiket9/index.php');
unset($_SESSION['scriptcase']['print_etiket9']['sc_process_barr']);
$ExportCtrl = new print_etiket9_export_control;
$ExportCtrl->Export_barr();

class print_etiket9_export_control
{
