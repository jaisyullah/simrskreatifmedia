<?php
   include_once('form_vclaim_sep_surat_session.php');
   @session_start() ;
   $_SESSION['scriptcase']['form_vclaim_sep_surat']['glo_nm_perfil']          = "conn_mysql";
   $_SESSION['scriptcase']['form_vclaim_sep_surat']['glo_nm_path_prod']       = "";
   $_SESSION['scriptcase']['form_vclaim_sep_surat']['glo_nm_path_conf']       = "";
   $_SESSION['scriptcase']['form_vclaim_sep_surat']['glo_nm_path_imagens']    = "";
   $_SESSION['scriptcase']['form_vclaim_sep_surat']['glo_nm_path_imag_temp']  = "";
   $_SESSION['scriptcase']['form_vclaim_sep_surat']['glo_nm_path_doc']        = "";
    ...
    //check prod
    if(empty($_SESSION['scriptcase']['form_vclaim_sep_surat']['glo_nm_path_prod']))
    {
            /*check prod*/$_SESSION['scriptcase']['form_vclaim_sep_surat']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
    }
    //check img
    if(empty($_SESSION['scriptcase']['form_vclaim_sep_surat']['glo_nm_path_imagens']))
    {
            /*check img*/$_SESSION['scriptcase']['form_vclaim_sep_surat']['glo_nm_path_imagens'] = $str_path_apl_url . "_lib/file/img";
    }
    //check tmp
    if(empty($_SESSION['scriptcase']['form_vclaim_sep_surat']['glo_nm_path_imag_temp']))
    {
            /*check tmp*/$_SESSION['scriptcase']['form_vclaim_sep_surat']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
    }
    //check doc
    if(empty($_SESSION['scriptcase']['form_vclaim_sep_surat']['glo_nm_path_doc']))
    {
            /*check doc*/$_SESSION['scriptcase']['form_vclaim_sep_surat']['glo_nm_path_doc'] = $str_path_apl_dir . "_lib/file/doc";
    }
    //end check publication with the prod
//
class form_vclaim_sep_surat_ini
{
   var $nm_cod_apl;
   var $nm_nome_apl;
   var $nm_seguranca;
...
//
   function init($Tp_init = "")
   {
      ...
      $_SESSION['sc_session'][$this->sc_page]['form_vclaim_sep_surat']['decimal_db'] = "."; 
      $this->nm_cod_apl      = "form_vclaim_sep_surat"; 
      $this->nm_nome_apl     = ""; 
      $this->nm_seguranca    = ""; 
      ...
      $this->nm_dt_criacao   = "20180603"; 
      $this->nm_hr_criacao   = "155246"; 
...
// 
      ...
      $this->sc_protocolo    = "";
      $this->path_prod       = $_SESSION['scriptcase']['form_vclaim_sep_surat']['glo_nm_path_prod'];
      $this->path_conf       = $_SESSION['scriptcase']['form_vclaim_sep_surat']['glo_nm_path_conf'];
      $this->path_imagens    = $_SESSION['scriptcase']['form_vclaim_sep_surat']['glo_nm_path_imagens'];
      $this->path_imag_temp  = $_SESSION['scriptcase']['form_vclaim_sep_surat']['glo_nm_path_imag_temp'];
      $this->path_doc        = $_SESSION['scriptcase']['form_vclaim_sep_surat']['glo_nm_path_doc'];
      ...
      $this->path_aplicacao  = substr($this->path_aplicacao, 0, strrpos($this->path_aplicacao, '/')) . '/form_vclaim_sep_surat';
      ...
      if (isset($_SESSION['scriptcase']['form_vclaim_sep_surat']['session_timeout']['lang'])) {
          $this->str_lang = $_SESSION['scriptcase']['form_vclaim_sep_surat']['session_timeout']['lang'];
      }
      elseif (!isset($_SESSION['scriptcase']['form_vclaim_sep_surat']['actual_lang']) || $_SESSION['scriptcase']['form_vclaim_sep_surat']['actual_lang'] != $this->str_lang) {
          $_SESSION['scriptcase']['form_vclaim_sep_surat']['actual_lang'] = $this->str_lang;
      ...
      {
          include_once("form_vclaim_sep_surat_json.php");
      }
      $this->SC_Link_View = (isset($_SESSION['sc_session'][$this->sc_page]['form_vclaim_sep_surat']['SC_Link_View'])) ? $_SESSION['sc_session'][$this->sc_page]['form_vclaim_sep_surat']['SC_Link_View'] : false;
      if (isset($_GET['SC_Link_View']) && !empty($_GET['SC_Link_View']) && is_numeric($_GET['SC_Link_View']))
      {
          if ($_SESSION['sc_session'][$this->sc_page]['form_vclaim_sep_surat']['embutida'])
          {
              $this->SC_Link_View = true;
              $_SESSION['sc_session'][$this->sc_page]['form_vclaim_sep_surat']['SC_Link_View'] = true;
          }
      }
      if (isset($_POST['nmgp_opcao']) && $_POST['nmgp_opcao'] == "ajax_save_ancor")
      {
          $_SESSION['sc_session'][$this->sc_page]['form_vclaim_sep_surat']['ancor_save'] = $_POST['ancor_save'];
...
<?php
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['form_vclaim_sep_surat']['dashboard_info']['under_dashboard']))
      {
          $_SESSION['sc_session'][$this->sc_page]['form_vclaim_sep_surat']['dashboard_info']['under_dashboard'] = false;
          $_SESSION['sc_session'][$this->sc_page]['form_vclaim_sep_surat']['dashboard_info']['dashboard_app']   = '';
          $_SESSION['sc_session'][$this->sc_page]['form_vclaim_sep_surat']['dashboard_info']['own_widget']      = '';
          $_SESSION['sc_session'][$this->sc_page]['form_vclaim_sep_surat']['dashboard_info']['parent_widget']   = '';
          $_SESSION['sc_session'][$this->sc_page]['form_vclaim_sep_surat']['dashboard_info']['compact_mode']    = false;
          $_SESSION['sc_session'][$this->sc_page]['form_vclaim_sep_surat']['dashboard_info']['remove_margin']   = false;
      }
      if (isset($_GET['under_dashboard']) && 1 == $_GET['under_dashboard'])
      {
          if (isset($_GET['own_widget']) && 'dbifrm_widget' == substr($_GET['own_widget'], 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['form_vclaim_sep_surat']['dashboard_info']['own_widget'] = $_GET['own_widget'];
              $_SESSION['sc_session'][$this->sc_page]['form_vclaim_sep_surat']['dashboard_info']['under_dashboard'] = true;
              if (isset($_GET['dashboard_app'])) {
                  $_SESSION['sc_session'][$this->sc_page]['form_vclaim_sep_surat']['dashboard_info']['dashboard_app'] = $_GET['dashboard_app'];
              }
              if (isset($_GET['parent_widget'])) {
                  $_SESSION['sc_session'][$this->sc_page]['form_vclaim_sep_surat']['dashboard_info']['parent_widget'] = $_GET['parent_widget'];
              }
              if (isset($_GET['compact_mode'])) {
                  $_SESSION['sc_session'][$this->sc_page]['form_vclaim_sep_surat']['dashboard_info']['compact_mode'] = 1 == $_GET['compact_mode'];
              }
              if (isset($_GET['remove_margin'])) {
                  $_SESSION['sc_session'][$this->sc_page]['form_vclaim_sep_surat']['dashboard_info']['remove_margin'] = 1 == $_GET['remove_margin'];
              }
          }
      }
      elseif (isset($under_dashboard) && 1 == $under_dashboard)
      {
          if (isset($own_widget) && 'dbifrm_widget' == substr($own_widget, 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['form_vclaim_sep_surat']['dashboard_info']['own_widget'] = $own_widget;
              $_SESSION['sc_session'][$this->sc_page]['form_vclaim_sep_surat']['dashboard_info']['under_dashboard'] = true;
              if (isset($dashboard_app)) {
                  $_SESSION['sc_session'][$this->sc_page]['form_vclaim_sep_surat']['dashboard_info']['dashboard_app'] = $dashboard_app;
              }
              if (isset($parent_widget)) {
                  $_SESSION['sc_session'][$this->sc_page]['form_vclaim_sep_surat']['dashboard_info']['parent_widget'] = $parent_widget;
              }
              if (isset($compact_mode)) {
                  $_SESSION['sc_session'][$this->sc_page]['form_vclaim_sep_surat']['dashboard_info']['compact_mode'] = 1 == $compact_mode;
              }
              if (isset($remove_margin)) {
                  $_SESSION['sc_session'][$this->sc_page]['form_vclaim_sep_surat']['dashboard_info']['remove_margin'] = 1 == $remove_margin;
              }
          }
      }
      if (!isset($_SESSION['sc_session'][$this->sc_page]['form_vclaim_sep_surat']['dashboard_info']['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['form_vclaim_sep_surat']['dashboard_info']['maximized'] = false;
      }
      if (isset($_GET['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['form_vclaim_sep_surat']['dashboard_info']['maximized'] = 1 == $_GET['maximized'];
      }
      if ($_SESSION['sc_session'][$this->sc_page]['form_vclaim_sep_surat']['dashboard_info']['under_dashboard'])
      {
          $sTmpDashboardApp = $_SESSION['sc_session'][$this->sc_page]['form_vclaim_sep_surat']['dashboard_info']['dashboard_app'];
          if ('' != $sTmpDashboardApp && isset($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["form_vclaim_sep_surat"]))
          {
              foreach ($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["form_vclaim_sep_surat"] as $sTmpTargetLink => $sTmpTargetWidget)
              {
      ...
      if (!is_file($this->root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
      {
          ...
          unset($_SESSION['scriptcase']['form_vclaim_sep_surat']['glo_nm_conexao']);
      }
      ...
      if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['form_vclaim_sep_surat']['session_timeout']['redir']))
      {
      ...
      $_SESSION['sc_session'][$this->sc_page]['form_vclaim_sep_surat']['path_doc'] = $this->path_doc; 
      ...
      if (!is_dir($this->root . $this->path_prod))
      {
          ...
          echo " </tr>";
          echo "</table>";
          if (!$_SESSION['sc_session'][$script_case_init]['form_vclaim_sep_surat']['iframe_menu'] && (!isset($_SESSION['sc_session'][$script_case_init]['form_vclaim_sep_surat']['sc_outra_jan']) || !$_SESSION['sc_session'][$script_case_init]['form_vclaim_sep_surat']['sc_outra_jan'])) 
          { 
...
// 
      include_once($this->path_aplicacao . "form_vclaim_sep_surat_erro.class.php"); 
      $this->Erro = new form_vclaim_sep_surat_erro();
      include_once($this->path_adodb . "/adodb.inc.php"); 
      $this->sc_Include($this->path_libs . "/nm_sec_prod.php", "F", "nm_reg_prod") ; 
      $this->sc_Include($this->path_libs . "/nm_ini_perfil.php", "F", "perfil_lib") ; 
// 
 if(function_exists('set_php_timezone')) set_php_timezone('form_vclaim_sep_surat'); 
// 
      ...
      if (isset($_SESSION['scriptcase']['form_vclaim_sep_surat']['session_timeout']['redir'])) {
          ...
          if ($_SESSION['scriptcase']['form_vclaim_sep_surat']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "  </HEAD>\r\n";
              $SS_cod_html .= "   <body>\r\n";
          }
          else {
              ...
              $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['form_vclaim_sep_surat']['session_timeout']['redir'] . "');\">\r\n";
              $SS_cod_html .= "     </form>\r\n";
          ...
          if ($_SESSION['scriptcase']['form_vclaim_sep_surat']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['form_vclaim_sep_surat']['session_timeout']['redir'] . "');\r\n";
          }
          ...
          $SS_cod_html .= " </body>\r\n";
          $SS_cod_html .= "</HTML>\r\n";
          unset($_SESSION['scriptcase']['form_vclaim_sep_surat']['session_timeout']);
          unset($_SESSION['sc_session']);
      }
   ...
   function prep_conect()
   {
      if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
      {
          ...
          {
              if (isset($_SESSION['scriptcase']['form_vclaim_sep_surat']['glo_nm_conexao']) && $_SESSION['scriptcase']['form_vclaim_sep_surat']['glo_nm_conexao'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['form_vclaim_sep_surat']['glo_nm_conexao'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['form_vclaim_sep_surat']['glo_nm_perfil']) && $_SESSION['scriptcase']['form_vclaim_sep_surat']['glo_nm_perfil'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['form_vclaim_sep_surat']['glo_nm_perfil'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['form_vclaim_sep_surat']['glo_con_' . $NM_con_orig]))
              {
                  $_SESSION['scriptcase']['form_vclaim_sep_surat']['glo_con_' . $NM_con_orig] = $NM_con_dest;
              }
          }
      }
      $con_devel             = (isset($_SESSION['scriptcase']['form_vclaim_sep_surat']['glo_nm_conexao'])) ? $_SESSION['scriptcase']['form_vclaim_sep_surat']['glo_nm_conexao'] : ""; 
      $perfil_trab           = ""; 
      $this->nm_falta_var    = ""; 
      $this->nm_falta_var_db = ""; 
      $nm_crit_perfil        = false;
      if (isset($_SESSION['scriptcase']['form_vclaim_sep_surat']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['form_vclaim_sep_surat']['glo_nm_conexao']))
      {
          ob_start();
      ...
      if (isset($_SESSION['scriptcase']['form_vclaim_sep_surat']['glo_nm_perfil']) && !empty($_SESSION['scriptcase']['form_vclaim_sep_surat']['glo_nm_perfil']))
      {
          $perfil_trab = $_SESSION['scriptcase']['form_vclaim_sep_surat']['glo_nm_perfil'];
      }
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['form_vclaim_sep_surat']['embutida_init']) || !$_SESSION['sc_session'][$this->sc_page]['form_vclaim_sep_surat']['embutida_init']) 
      {
          if (!isset($_SESSION['nama_rs'])) 
          {
              $this->nm_falta_var .= "nama_rs; ";
          }
          if (!isset($_SESSION['no_sep'])) 
          {
              $this->nm_falta_var .= "no_sep; ";
          }
          if (!isset($_SESSION['tgl_sep'])) 
          {
              $this->nm_falta_var .= "tgl_sep; ";
          }
          if (!isset($_SESSION['no_kartu'])) 
          {
              $this->nm_falta_var .= "no_kartu; ";
          }
          if (!isset($_SESSION['jenis_peserta'])) 
          {
              $this->nm_falta_var .= "jenis_peserta; ";
          }
          ...
          {
              $this->nm_falta_var .= "tgl_lahir; ";
          }
          if (!isset($_SESSION['cob'])) 
          {
              $this->nm_falta_var .= "cob; ";
          }
          if (!isset($_SESSION['jns_kelamin'])) 
          {
              $this->nm_falta_var .= "jns_kelamin; ";
          }
          if (!isset($_SESSION['jns_layanan'])) 
          {
              $this->nm_falta_var .= "jns_layanan; ";
          }
          if (!isset($_SESSION['poli_tujuan'])) 
          {
              $this->nm_falta_var .= "poli_tujuan; ";
          }
          if (!isset($_SESSION['kelas_rawat'])) 
          {
              $this->nm_falta_var .= "kelas_rawat; ";
          }
          if (!isset($_SESSION['asal_faskes'])) 
          {
              $this->nm_falta_var .= "asal_faskes; ";
          }
          if (!isset($_SESSION['diagnosa'])) 
          {
              $this->nm_falta_var .= "diagnosa; ";
          }
          if (!isset($_SESSION['catatan'])) 
          {
              $this->nm_falta_var .= "catatan; ";
          }
      }
// 
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['form_vclaim_sep_surat']['decimal_db'] = $_SESSION['scriptcase']['glo_decimal_db']; 
      }
      if (isset($_SESSION['scriptcase']['glo_date_separator']) && !empty($_SESSION['scriptcase']['glo_date_separator']))
      {
          ...
          if (strlen($SC_temp) == 2)
          {
              $_SESSION['sc_session'][$this->sc_page]['form_vclaim_sep_surat']['SC_sep_date']  = substr($SC_temp, 0, 1); 
              $_SESSION['sc_session'][$this->sc_page]['form_vclaim_sep_surat']['SC_sep_date1'] = substr($SC_temp, 1, 1); 
          }
          else
           {
              $_SESSION['sc_session'][$this->sc_page]['form_vclaim_sep_surat']['SC_sep_date']  = $SC_temp; 
              $_SESSION['sc_session'][$this->sc_page]['form_vclaim_sep_surat']['SC_sep_date1'] = $SC_temp; 
          }
          $this->date_delim  = $_SESSION['sc_session'][$this->sc_page]['form_vclaim_sep_surat']['SC_sep_date'];
          $this->date_delim1 = $_SESSION['sc_session'][$this->sc_page]['form_vclaim_sep_surat']['SC_sep_date1'];
      }
// 
...
<?php
   ...
   function conectDB()
   {
      ...
      if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['form_vclaim_sep_surat']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['form_vclaim_sep_surat']['glo_nm_conexao']))
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['form_vclaim_sep_surat']['glo_nm_conexao'], $this->root . $this->path_prod, 'simrskreatifmedia', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
...
// 
   ...
   function sc_Sql_Protect($var, $tp, $conex="")
   {
       ...
       if ($tp == "date")
       {
           ...
           if (isset($_SESSION['sc_session'][$this->sc_page]['form_vclaim_sep_surat']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->sc_page]['form_vclaim_sep_surat']['SC_sep_date']))
           {
               $delim  = $_SESSION['sc_session'][$this->sc_page]['form_vclaim_sep_surat']['SC_sep_date'];
               $delim1 = $_SESSION['sc_session'][$this->sc_page]['form_vclaim_sep_surat']['SC_sep_date1'];
           }
   ...
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['form_vclaim_sep_surat']['SC_Gb_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['form_vclaim_sep_surat']['SC_Gb_date_format'][$GB][$cmp] : "";
   }

   function Get_Gb_prefix_date_format($GB, $cmp)
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['form_vclaim_sep_surat']['SC_Gb_prefix_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['form_vclaim_sep_surat']['SC_Gb_prefix_date_format'][$GB][$cmp] : "";
   }
...
//===============================================================================
//
class form_vclaim_sep_surat_apl
{
   var $Ini;
   var $Erro;
   var $Db;
...
//----- 
   function controle()
   {
      ...
      $this->Ini = new form_vclaim_sep_surat_ini(); 
      $this->Ini->init();
      $this->Change_Menu = false;
      if (isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_surat']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_surat']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_vclaim_sep_surat']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_vclaim_sep_surat'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_vclaim_sep_surat']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_vclaim_sep_surat']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_vclaim_sep_surat') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_vclaim_sep_surat']['label'] = "" . $this->Ini->Nm_lang['lang_othr_blank_title'] . "";
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_vclaim_sep_surat']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_vclaim_sep_surat']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['form_vclaim_sep_surat']['exit'];
      ...
      $this->Db = $this->Ini->Db; 
      include_once($this->Ini->path_aplicacao . "form_vclaim_sep_surat_erro.class.php"); 
      $this->Erro      = new form_vclaim_sep_surat_erro();
      $this->Erro->Ini = $this->Ini;
//
      $_SESSION['scriptcase']['form_vclaim_sep_surat']['contr_erro'] = 'on';
	...
	<body>		
		...
		<div id="print_area">
			<table>
				<tr>
					<td style="width:206px;">
						<img src="<?php echo sc_url_library('prj','bootstrap3','bootstrap3/img/logo_bpjs_kesehatan.png'); ?>" alt="logo" width="200">
					</td>
					<td style="padding-left:50px;">
						<p style="margin-top:0px;margin-bottom:5px;text-align:center;font-size:18px;font-weight:bold;">SURAT ELIGIBILITAS PASIEN</p>
						<p style="margin-top:4px;text-align:center;font-size:14px;font-weight:bold;"><?php echo $this->sc_temp_nama_rs; ?></p>
					</td>
				</tr>
			</table>
			...
			<table style="margin-top:5px;">
				<tr>
					<td style="padding:2px 3px 2px 3px;">No. SEP</td>
					<td style="padding:2px 3px 2px 10px;"><?php echo $this->sc_temp_no_sep; ?></td>
				</tr>
				<tr>
					<td style="padding:2px 3px 2px 3px;">Tgl. SEP</td>
					<td style="padding:2px 3px 2px 10px;"><?php echo $this->sc_temp_tgl_sep; ?></td>
				</tr>
				<tr>
					<td style="padding:2px 3px 2px 3px;">No. Kartu</td>
					<td style="padding:2px 3px 2px 10px;"><?php echo $this->sc_temp_no_kartu; ?></td>
					<td style="padding:2px 3px 2px 10px;">Peserta</td>
					<td style="padding:2px 3px 2px 10px;"><?php echo $this->sc_temp_jenis_peserta; ?></td>
				</tr>
				<tr>
					<td style="padding:2px 3px 2px 3px;">Nama Peserta</td>
					<td style="padding:2px 3px 2px 10px;"><?php echo $this->sc_temp_nama; ?></td>
				</tr>
				<tr>
					<td style="padding:2px 3px 2px 3px;">Tgl. Lahir</td>
					<td style="padding:2px 3px 2px 10px;"><?php echo $this->sc_temp_tgl_lahir; ?></td>
					<td style="padding:2px 3px 2px 10px;">COB</td>
					<td style="padding:2px 3px 2px 10px;"><?php echo $this->sc_temp_cob; ?></td>
				</tr>
				<tr>
					<td style="padding:2px 3px 2px 3px;">Jns. Kelamin</td>
					<td style="padding:2px 3px 2px 10px;"><?php echo $this->sc_temp_jns_kelamin; ?></td>
					<td style="padding:2px 3px 2px 10px;">Jns. Rawat</td>
					<td style="padding:2px 3px 2px 10px;"><?php echo $this->sc_temp_jns_layanan; ?></td>
				</tr>
				<tr>
					<td style="padding:2px 3px 2px 3px;">Poli Tujuan</td>
					<td style="padding:2px 3px 2px 10px;"><?php echo $this->sc_temp_poli_tujuan; ?></td>
					<td style="padding:2px 3px 2px 10px;">Kls. Rawat</td>
					<td style="padding:2px 3px 2px 10px;"><?php echo $this->sc_temp_kelas_rawat; ?></td>
				</tr>
				
				<tr>
					<td style="padding:2px 3px 2px 3px;">Asal Faskes Tk. 1</td>
					<td style="padding:2px 3px 2px 10px;"><?php echo $this->sc_temp_asal_faskes; ?></td>
				</tr>
				<tr>
					<td style="padding:2px 3px 2px 3px;">Diagnosa Awal</td>
					<td style="padding:2px 3px 2px 10px;"><?php echo $this->sc_temp_diagnosa; ?></td>				
				</tr>
				<tr>
					<td style="padding:2px 3px 2px 3px;">Catatan</td>
					<td style="padding:2px 3px 2px 10px;"><?php echo $this->sc_temp_catatan; ?></td>
					<td style="padding:2px 3px 2px 30px;">Pasien</td>
					<td style="padding:2px 3px 2px 30px;">Petugas</td>
				</tr>
				<tr>
					<td style="padding:2px 3px 2px 3px;"></td>
					<td style="padding:2px 3px 2px 10px;"></td>
					<td style="padding:2px 3px 2px 30px;">Keluarga Pasien</td>
					<td style="padding:2px 3px 2px 30px;">BPJS Kesehatan</td>
				</tr>
				<tr>
					<td colspan="2" style="padding:2px 3px 2px 3px;font-size:11px;">
						<i>*Saya menyetujui BPJS Kesehatan menggunakan informasi Medis Pasien jika diperlukan</i>
					</td>
					<td style="padding:2px 3px 2px 50px;"></td>
					<td style="padding:2px 3px 2px 30px;"></td>
				</tr>
				<tr>
					<td colspan="2" style="padding:2px 3px 2px 3px;font-size:11px;">
				...
				<tr>
					<td colspan="2" style="padding:2px 3px 2px 3px;font-size:11px;"></td>
					<td style="padding:2px 3px 2px 30px;"><hr></td>
					<td style="padding:2px 3px 2px 30px;"><hr></td>
				</tr>
			</table>
		</div>	
		<br>
		<a href="javascript:printDiv('print_area')" class="myButton">Cetak</a>&nbsp;&nbsp; <a href="<?php echo $this->Ini->path_link . "" . SC_dir_app_name('grid_response_insert_sep') . "/?script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&nmgp_url_saida=" . $this->nm_location; ?>" class="myBlue">Kembali</a>
		</center>
	</body>
</html>
<?php
...
$_SESSION['scriptcase']['form_vclaim_sep_surat']['contr_erro'] = 'off'; 
//--- 
       $this->Db->Close(); 
       if ($this->Change_Menu)
       {
...
//======= =========================
   ...
   if (!empty($_POST))
   {
       foreach ($_POST as $nmgp_var => $nmgp_val)
       {
            ...
            nm_limpa_str_form_vclaim_sep_surat($nmgp_val);
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['form_vclaim_sep_surat']['glo_nm_path_imag_temp'] . "/sc_apl_default_simrskreatifmedia.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['form_vclaim_sep_surat']['glo_nm_path_imag_temp'] . "/sc_apl_default_simrskreatifmedia.txt"));
       }
       if (isset($apl_def)) {
           if ($apl_def[0] != "form_vclaim_sep_surat") {
               $_SESSION['scriptcase']['sem_session'] = true;
               if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                   $_SESSION['scriptcase']['form_vclaim_sep_surat']['session_timeout']['redir'] = $apl_def[0];
               }
               else {
                   $_SESSION['scriptcase']['form_vclaim_sep_surat']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
               }
               $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
               $_SESSION['scriptcase']['form_vclaim_sep_surat']['session_timeout']['redir_tp'] = $Redir_tp;
           }
           if (isset($_COOKIE['sc_actual_lang_simrskreatifmedia'])) {
               $_SESSION['scriptcase']['form_vclaim_sep_surat']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_simrskreatifmedia'];
           }
       }
   }
   ...
   if (isset($_POST["nama_rs"])) 
   {
       ...
       nm_limpa_str_form_vclaim_sep_surat($_SESSION["nama_rs"]);
   }
   ...
   if (isset($_POST["no_sep"])) 
   {
       ...
       nm_limpa_str_form_vclaim_sep_surat($_SESSION["no_sep"]);
   }
   ...
   if (isset($_POST["tgl_sep"])) 
   {
       ...
       nm_limpa_str_form_vclaim_sep_surat($_SESSION["tgl_sep"]);
   }
   ...
   if (isset($_POST["no_kartu"])) 
   {
       ...
       nm_limpa_str_form_vclaim_sep_surat($_SESSION["no_kartu"]);
   }
   ...
   if (isset($_POST["jenis_peserta"])) 
   {
       ...
       nm_limpa_str_form_vclaim_sep_surat($_SESSION["jenis_peserta"]);
   }
   ...
   if (isset($_POST["nama"])) 
   {
       ...
       nm_limpa_str_form_vclaim_sep_surat($_SESSION["nama"]);
   }
   if (isset($_GET["nama"])) 
   {
   ...
   if (isset($_POST["tgl_lahir"])) 
   {
       ...
       nm_limpa_str_form_vclaim_sep_surat($_SESSION["tgl_lahir"]);
   }
   ...
   if (isset($_POST["cob"])) 
   {
       ...
       nm_limpa_str_form_vclaim_sep_surat($_SESSION["cob"]);
   }
   if (isset($_GET["cob"])) 
   {
   ...
   if (isset($_POST["jns_kelamin"])) 
   {
       ...
       nm_limpa_str_form_vclaim_sep_surat($_SESSION["jns_kelamin"]);
   }
   ...
   if (isset($_POST["jns_layanan"])) 
   {
       ...
       nm_limpa_str_form_vclaim_sep_surat($_SESSION["jns_layanan"]);
   }
   ...
   if (isset($_POST["poli_tujuan"])) 
   {
       ...
       nm_limpa_str_form_vclaim_sep_surat($_SESSION["poli_tujuan"]);
   }
   ...
   if (isset($_POST["kelas_rawat"])) 
   {
       ...
       nm_limpa_str_form_vclaim_sep_surat($_SESSION["kelas_rawat"]);
   }
   ...
   if (isset($_POST["asal_faskes"])) 
   {
       ...
       nm_limpa_str_form_vclaim_sep_surat($_SESSION["asal_faskes"]);
   }
   ...
   if (isset($_POST["diagnosa"])) 
   {
       ...
       nm_limpa_str_form_vclaim_sep_surat($_SESSION["diagnosa"]);
   }
   ...
   if (isset($_POST["catatan"])) 
   {
       ...
       nm_limpa_str_form_vclaim_sep_surat($_SESSION["catatan"]);
   }
   ...
   $salva_iframe = false;
   if (isset($_SESSION['sc_session'][$script_case_init]['form_vclaim_sep_surat']['iframe_menu']))
   {
       $salva_iframe = $_SESSION['sc_session'][$script_case_init]['form_vclaim_sep_surat']['iframe_menu'];
       unset($_SESSION['sc_session'][$script_case_init]['form_vclaim_sep_surat']['iframe_menu']);
   }
   if (isset($nm_run_menu) && $nm_run_menu == 1)
   {
        ...
        $_SESSION['scriptcase']['sc_apl_menu_atual'] = "form_vclaim_sep_surat";
        $achou = false;
        if (isset($_SESSION['sc_session'][$script_case_init]))
        {
            foreach ($_SESSION['sc_session'][$script_case_init] as $nome_apl => $resto)
            {
                if ($nome_apl == 'form_vclaim_sep_surat' || $achou)
                {
        ...
        $_SESSION['sc_session'][$script_case_init]['form_vclaim_sep_surat']['iframe_menu'] = true;
   }
   else
   {
       $_SESSION['sc_session'][$script_case_init]['form_vclaim_sep_surat']['iframe_menu'] = $salva_iframe;
   }

   if (!isset($_SESSION['sc_session'][$script_case_init]['form_vclaim_sep_surat']['initialize']))
   {
       $_SESSION['sc_session'][$script_case_init]['form_vclaim_sep_surat']['initialize'] = true;
   }
   elseif (!isset($_SERVER['HTTP_REFERER']))
   {
       $_SESSION['sc_session'][$script_case_init]['form_vclaim_sep_surat']['initialize'] = false;
   }
   ...
   else
   {
       ...
       if ('form_vclaim_sep_surat' == $sReferer || 'form_vclaim_sep_surat_' == substr($sReferer, 0, 22))
       {
           $_SESSION['sc_session'][$script_case_init]['form_vclaim_sep_surat']['initialize'] = false;
       }
       else
   ...
   if (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'form_vclaim_sep_surat')
   {
       $_SESSION['sc_session'][$script_case_init]['form_vclaim_sep_surat']['sc_outra_jan'] = true;
        unset($_SESSION['scriptcase']['sc_outra_jan']);
   }
   $_SESSION['sc_session'][$script_case_init]['form_vclaim_sep_surat']['menu_desenv'] = false;   
   if (!defined("SC_ERROR_HANDLER"))
   {
       define("SC_ERROR_HANDLER", 1);
       include_once(dirname(__FILE__) . "/form_vclaim_sep_surat_erro.php");
   }
   if (!empty($nmgp_parms)) 
   { 
       ...
       while (!empty($todo[$ix]))
       {
            ...
            if (1 < sizeof($cadapar))
            {
                ...
                nm_limpa_str_form_vclaim_sep_surat($cadapar[1]);
   ...
   $contr_form_vclaim_sep_surat = new form_vclaim_sep_surat_apl();
   $contr_form_vclaim_sep_surat->controle();
//
   function nm_limpa_str_form_vclaim_sep_surat(&$str)
   {
