...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbadmrawatinap']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
  <input type="hidden" name="script_case_session" value="<?php echo $this->form_encode_input(session_id()); ?>"> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_tbadmrawatinap"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
{
  tb_show('', '<?php echo $this->Ini->link_grid_bedInfo_cons; ?>?script_case_init=<?php echo $this->Ini->sc_page; ?>&script_case_session=<?php echo session_id() ?>&nmgp_url_saida=modal&nmgp_parms=<?php echo "NMSC_inicial*scininicio*scoutNMSC_paginacao*scinFULL*scout"; ?>&nmgp_outra_jan=true&TB_iframe=true&height=600&width=800&modal=true', '');
}
var var_btn_sc_btn_1_biaya_trancode = "<?php echo $this->form_encode_input($this->nmgp_dados_form['trancode']); ?>";
...
{
  nm_gp_submit('<?php echo $this->Ini->link_pdfreport_surat_kesanggupan_cons; ?>', '<?php echo $this->nm_location; ?>', '<?php echo "biaya_trancode*scin' + var_btn_sc_btn_1_biaya_trancode + '*scout"; ?>', 'inicio', '_blank', '0', '0', 'pdfreport_surat_kesanggupan');
}
var var_btn_sc_btn_2_biaya_trancode = "<?php echo $this->form_encode_input($this->nmgp_dados_form['trancode']); ?>";
...
{
  nm_gp_submit('<?php echo $this->Ini->link_pdfreport_surat_naikkelas_cons; ?>', '<?php echo $this->nm_location; ?>', '<?php echo "biaya_trancode*scin' + var_btn_sc_btn_2_biaya_trancode + '*scout"; ?>', 'inicio', '_blank', '0', '0', 'pdfreport_surat_naikkelas');
}
var var_btn_sc_btn_3_norm = "<?php echo $this->form_encode_input($this->nmgp_dados_form['custcode']); ?>";
function sc_btn_sc_btn_3()
{
    if (scEventControl_active("")) {
      setTimeout(function() { sc_btn_sc_btn_3(); }, 500);
      return;
    }
    sc_btn_sc_btn_3_ok();
}
function sc_btn_sc_btn_3_cancel()
{
}
function sc_btn_sc_btn_3_ok()
{
  nm_gp_submit('<?php echo $this->Ini->link_label; ?>', '<?php echo $this->nm_location; ?>', '<?php echo "norm*scin' + var_btn_sc_btn_3_norm + '*scout"; ?>', '', '_blank', '0', '0', 'label');
}
var Crtl_btn_sc_btn_4 = false;
function sc_btn_sc_btn_4()
{
    if (scEventControl_active("")) {
      setTimeout(function() { sc_btn_sc_btn_4(); }, 500);
      return;
    }
    if (Crtl_btn_sc_btn_4) {return;}
    scJs_confirm("<?php echo html_entity_decode('Batalkan Pendaftaran Rawat Inap Pasien ? Tindakan tidak dapat diurungkan !?', ENT_COMPAT, $_SESSION['scriptcase']['charset']); ?>", sc_btn_sc_btn_4_ok, sc_btn_sc_btn_4_cancel)
}
function sc_btn_sc_btn_4_cancel()
{
}
function sc_btn_sc_btn_4_ok()
{
    Crtl_btn_sc_btn_4 = true;
    document.F1.nmgp_parms.value = "nmgp_opcao?#?formphp?@?nm_call_php?#?sc_btn_4?@?";
    document.F1.action = "./";
    document.F1.target = "_self";
    document.F1.submit();
}
var var_btn_sc_btn_5_trancode = "<?php echo $this->form_encode_input($this->nmgp_dados_form['trancode']); ?>";
var var_btn_sc_btn_5_kelasinap = "<?php echo $this->form_encode_input($this->nmgp_dados_form['kelas']); ?>";
var var_btn_sc_btn_5_ruangasal = "<?php echo $this->form_encode_input($this->nmgp_dados_form['bed']); ?>";
var var_btn_sc_btn_5_custcode = "<?php echo $this->form_encode_input($this->nmgp_dados_form['custcode']); ?>";
function sc_btn_sc_btn_5()
{
    if (scEventControl_active("")) {
      setTimeout(function() { sc_btn_sc_btn_5(); }, 500);
      return;
    }
    scJs_confirm("<?php echo html_entity_decode('Pemnidahan tanpa menambah biling ruangan, sudah benar ?', ENT_COMPAT, $_SESSION['scriptcase']['charset']); ?>", sc_btn_sc_btn_5_ok, sc_btn_sc_btn_5_cancel);
}
function sc_btn_sc_btn_5_cancel()
{
}
function sc_btn_sc_btn_5_ok()
{
      nm_gp_submit('<?php echo $this->Ini->link_gantiBed_edit; ?>', '<?php echo $this->nm_location; ?>', '<?php echo "trancode*scin' + var_btn_sc_btn_5_trancode + '*scoutkelasinap*scin' + var_btn_sc_btn_5_kelasinap + '*scoutruangasal*scin' + var_btn_sc_btn_5_ruangasal + '*scoutcustcode*scin' + var_btn_sc_btn_5_custcode + '*scoutNM_btn_insert*scinN*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinN*scoutNM_btn_navega*scinN*scout"; ?>', '', '_self', '0', '0', 'gantiBed');
}
var var_btn_sc_btn_6_trancode = "<?php echo $this->form_encode_input($this->nmgp_dados_form['trancode']); ?>";
var var_btn_sc_btn_6_kelasinap = "<?php echo $this->form_encode_input($this->nmgp_dados_form['kelas']); ?>";
var var_btn_sc_btn_6_ruangasal = "<?php echo $this->form_encode_input($this->nmgp_dados_form['bed']); ?>";
var var_btn_sc_btn_6_custcode = "<?php echo $this->form_encode_input($this->nmgp_dados_form['custcode']); ?>";
function sc_btn_sc_btn_6()
{
    if (scEventControl_active("")) {
      setTimeout(function() { sc_btn_sc_btn_6(); }, 500);
      return;
    }
    scJs_confirm("<?php echo html_entity_decode('Tindakan ini akan menambah Tagihan Pasien, Sudah Benar ?', ENT_COMPAT, $_SESSION['scriptcase']['charset']); ?>", sc_btn_sc_btn_6_ok, sc_btn_sc_btn_6_cancel);
}
function sc_btn_sc_btn_6_cancel()
{
}
function sc_btn_sc_btn_6_ok()
{
      nm_gp_submit('<?php echo $this->Ini->link_gantiRuang_edit; ?>', '<?php echo $this->nm_location; ?>', '<?php echo "trancode*scin' + var_btn_sc_btn_6_trancode + '*scoutkelasinap*scin' + var_btn_sc_btn_6_kelasinap + '*scoutruangasal*scin' + var_btn_sc_btn_6_ruangasal + '*scoutcustcode*scin' + var_btn_sc_btn_6_custcode + '*scoutNM_btn_insert*scinN*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinN*scoutNM_btn_navega*scinN*scout"; ?>', '', '_self', '0', '0', 'gantiRuang');
}
 NM_tp_critica(1);
...
{ 
   var sob_iframe = '';
<?php 
if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbadmrawatinap']['embutida_form']) {
...
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbadmrawatinap']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbadmrawatinap']['sc_modal']) {
    echo "   sob_iframe += 'parent.';\r\n";
}
?>
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbadmrawatinap']['where_detal']))
  {
?>  
...
{
   nm_field_disabled("trancode=disabled;sc_field_0=disabled", "");
   nm_field_disabled("custcode=disabled;bed=disabled;provider=disabled;idprovider=disabled;caramasuk=disabled;unitasal=disabled;hotel=disabled", "U");
   
}
function sc_exib_ocult_pag(N_pagina)
{
    document.getElementById('form_tbadmrawatinap_form0').style.width='1px';
    document.getElementById('form_tbadmrawatinap_form0').style.height='0px';
    document.getElementById('form_tbadmrawatinap_form0').style.display='none';
    document.getElementById('form_tbadmrawatinap_form0').style.overflow='scroll';
    document.getElementById('form_tbadmrawatinap_form1').style.width='1px';
    document.getElementById('form_tbadmrawatinap_form1').style.height='0px';
    document.getElementById('form_tbadmrawatinap_form1').style.display='none';
    document.getElementById('form_tbadmrawatinap_form1').style.overflow='scroll';
   ...
   if ("form_tbadmrawatinap_form1" == N_pagina) {
