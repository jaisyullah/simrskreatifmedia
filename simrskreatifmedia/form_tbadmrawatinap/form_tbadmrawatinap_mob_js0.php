...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbadmrawatinap_mob']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
  <input type="hidden" name="script_case_session" value="<?php echo $this->form_encode_input(session_id()); ?>"> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_tbadmrawatinap_mob"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
function sc_btn_sc_btn_4_ok()
{
    ...
    document.F1.action = "form_tbadmrawatinap_mob.php";
...
{ 
   var sob_iframe = '';
<?php 
if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbadmrawatinap_mob']['embutida_form']) {
...
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbadmrawatinap_mob']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbadmrawatinap_mob']['sc_modal']) {
    echo "   sob_iframe += 'parent.';\r\n";
}
?>
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbadmrawatinap_mob']['where_detal']))
  {
?>  
...
{
    document.getElementById('form_tbadmrawatinap_mob_form0').style.width='1px';
    document.getElementById('form_tbadmrawatinap_mob_form0').style.height='0px';
    document.getElementById('form_tbadmrawatinap_mob_form0').style.display='none';
    document.getElementById('form_tbadmrawatinap_mob_form0').style.overflow='scroll';
    document.getElementById('form_tbadmrawatinap_mob_form1').style.width='1px';
    document.getElementById('form_tbadmrawatinap_mob_form1').style.height='0px';
    document.getElementById('form_tbadmrawatinap_mob_form1').style.display='none';
    document.getElementById('form_tbadmrawatinap_mob_form1').style.overflow='scroll';
   ...
   if ("form_tbadmrawatinap_mob_form1" == N_pagina) {
