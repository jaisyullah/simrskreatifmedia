...
function scFocusField(sField) {
  ...
  if ($oField.length > 0) {
    switch ($oField[0].name) {
      ...
      case 'hotel':
      case 'waitinglist':
        sc_exib_ocult_pag('form_tbadmrawatinap_mob_form0');
        break;
      case 'detailadm':
      case 'detailruang':
        sc_exib_ocult_pag('form_tbadmrawatinap_mob_form1');
        break;
    }
  }
...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_tglmasuk_hora' + iSeqRow).bind('blur', function() { sc_form_tbadmrawatinap_tglmasuk_onblur(this, iSeqRow) })
                                           .bind('focus', function() { sc_form_tbadmrawatinap_tglmasuk_onfocus(this, iSeqRow) });
...
function displayChange_field_detailruang(row, status) {
	if ("on" == status && typeof $("#nmsc_iframe_liga_form_tbbillruang_adm_mob")[0].contentWindow.scRecreateSelect2 === "function") {
		$("#nmsc_iframe_liga_form_tbbillruang_adm_mob")[0].contentWindow.scRecreateSelect2();
	}
}
...
function scHidePage(pageNo) {
	$("#id_form_tbadmrawatinap_mob_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_tglmasuk" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_tbadmrawatinap_mob_validate_tglmasuk(iSeqRow);
    },
    numberOfMonths: 1,
    changeMonth: true,
    changeYear: true,
