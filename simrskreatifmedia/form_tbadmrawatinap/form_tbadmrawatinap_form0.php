...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbadmrawatinap']['embutida_pdf']))
 {
 ?>
...
include_once('form_tbadmrawatinap_jquery.php');
...
?>
 ...
 function addAutocomplete(elem) {
  ...
  $(".sc-ui-autocomp-provider", elem).on("focus", function() {
   ...
   var sId = $(this).attr("id").substr(6), sRow = "provider" != sId ? sId.substr(8) : "";
   sc_form_tbadmrawatinap_provider_onfocus("id_sc_field_" + sId, sRow);
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbadmrawatinap']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbadmrawatinap']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbadmrawatinap']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbadmrawatinap']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbadmrawatinap']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbadmrawatinap']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbadmrawatinap']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbadmrawatinap']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
?>
...
<?php
 include_once("form_tbadmrawatinap_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbadmrawatinap']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbadmrawatinap']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_tbadmrawatinap'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_tbadmrawatinap'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbadmrawatinap']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbadmrawatinap']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbadmrawatinap']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbadmrawatinap']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbadmrawatinap']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbadmrawatinap']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbadmrawatinap']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbadmrawatinap']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbadmrawatinap']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbadmrawatinap']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbadmrawatinap']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbadmrawatinap']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbadmrawatinap']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbadmrawatinap']['fast_search'][2] : "";
?> 
...
<?php
        ...
        $sCondStyle = '';
?>
       <?php echo nmButtonOutput($this->arr_buttons, "group_group_3", "scBtnGrpShow('group_3_t')", "scBtnGrpShow('group_3_t')", "sc_btgp_btn_group_3_t", "", "Cetak", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "__sc_grp__");?>
 
<?php
echo nmButtonGroupTableOutput($this->arr_buttons, "group_group_3", 'group_3', 't', '', 'ini');
    if (($opcao_botoes != "novo") && ($opcao_botoes != "novo")) {
        $sCondStyle = ($this->nmgp_botoes['sc_btn_1'] == "on") ? '' : 'display: none;';
?>
         <div class="scBtnGrpText scBtnGrpClick"  style="<?php echo $sCondStyle; ?>" id="gbl_sc_sc_btn_1_top">
<?php echo nmButtonOutput($this->arr_buttons, "sc_btn_1", "scBtnFn_sc_btn_1()", "scBtnFn_sc_btn_1()", "sc_sc_btn_1_top", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "group_3");?>
  </div>
...
?>
         <div class="scBtnGrpText scBtnGrpClick"  style="<?php echo $sCondStyle; ?>" id="gbl_sc_sc_btn_2_top">
<?php echo nmButtonOutput($this->arr_buttons, "sc_btn_2", "scBtnFn_sc_btn_2()", "scBtnFn_sc_btn_2()", "sc_sc_btn_2_top", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "group_3");?>
  </div>
...
?>
         <div class="scBtnGrpText scBtnGrpClick"  style="<?php echo $sCondStyle; ?>" id="gbl_sc_sc_btn_3_top">
<?php echo nmButtonOutput($this->arr_buttons, "sc_btn_3", "scBtnFn_sc_btn_3()", "scBtnFn_sc_btn_3()", "sc_sc_btn_3_top", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "group_3");?>
  </div>
...
<?php
    ...
    if (($opcao_botoes != "novo") && ($opcao_botoes != "novo")) {
        $sCondStyle = ($this->nmgp_botoes['sc_btn_5'] == "on") ? '' : 'display: none;';
?>
       <?php echo nmButtonOutput($this->arr_buttons, "sc_btn_5", "scBtnFn_sc_btn_5()", "scBtnFn_sc_btn_5()", "sc_sc_btn_5_top", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
...
<?php
    ...
    if (($opcao_botoes != "novo") && ($opcao_botoes != "novo")) {
        $sCondStyle = ($this->nmgp_botoes['sc_btn_6'] == "on") ? '' : 'display: none;';
?>
       <?php echo nmButtonOutput($this->arr_buttons, "sc_btn_6", "scBtnFn_sc_btn_6()", "scBtnFn_sc_btn_6()", "sc_sc_btn_6_top", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbadmrawatinap']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbadmrawatinap']['run_iframe'] != "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbadmrawatinap']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbadmrawatinap']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbadmrawatinap']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbadmrawatinap']['run_iframe'] == "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbadmrawatinap']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbadmrawatinap']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbadmrawatinap']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbadmrawatinap']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbadmrawatinap']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbadmrawatinap']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbadmrawatinap']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbadmrawatinap']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbadmrawatinap']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbadmrawatinap']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbadmrawatinap']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbadmrawatinap']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
?>
<script type="text/javascript">
var pag_ativa = "form_tbadmrawatinap_form0";
</script>
<ul class="scTabLine sc-ui-page-tab-line">
<?php
    $this->tabCssClass = array(
        'form_tbadmrawatinap_form0' => array(
            'title' => "Pendaftaran Rawat Inap",
            'class' => empty($nmgp_num_form) || $nmgp_num_form == "form_tbadmrawatinap_form0" ? "scTabActive" : "scTabInactive",
        ),
        'form_tbadmrawatinap_form1' => array(
            'title' => "Biaya",
            'class' => $nmgp_num_form == "form_tbadmrawatinap_form1" ? "scTabActive" : "scTabInactive",
        ),
    );
        if (!empty($this->Ini->nm_hidden_pages)) {
                foreach ($this->Ini->nm_hidden_pages as $pageName => $pageStatus) {
                        if ('Pendaftaran Rawat Inap' == $pageName && 'off' == $pageStatus) {
                                $this->tabCssClass['form_tbadmrawatinap_form0']['class'] = 'scTabInactive';
                        }
                        if ('Biaya' == $pageName && 'off' == $pageStatus) {
                                $this->tabCssClass['form_tbadmrawatinap_form1']['class'] = 'scTabInactive';
                        }
                }
...
?>
<?php
    $css_celula = $this->tabCssClass["form_tbadmrawatinap_form0"]['class'];
?>
   <li id="id_form_tbadmrawatinap_form0" class="<?php echo $css_celula; ?> sc-form-page">
    <a href="javascript: sc_exib_ocult_pag ('form_tbadmrawatinap_form0')">
     Pendaftaran Rawat Inap
    </a>
   </li>
<?php
    $css_celula = $this->tabCssClass["form_tbadmrawatinap_form1"]['class'];
?>
   <li id="id_form_tbadmrawatinap_form1" class="<?php echo $css_celula; ?> sc-form-page">
    <a href="javascript: sc_exib_ocult_pag ('form_tbadmrawatinap_form1')">
     Biaya
    </a>
   </li>
</ul>
...
<div id="form_tbadmrawatinap_form0" style='display: none; width: 1px; height: 0px; overflow: scroll'>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_custcode_label" id="hidden_field_label_custcode" style="<?php echo $sStyleHidden_custcode; ?>"><span id="id_label_custcode"><?php echo $this->nm_new_label['custcode']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbadmrawatinap']['php_cmp_required']['custcode']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbadmrawatinap']['php_cmp_required']['custcode'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<span id="id_read_on_custcode" class="sc-ui-readonly-custcode css_custcode_line" style="<?php echo $sStyleReadLab_custcode; ?>"><?php echo $this->custcode; ?></span><span id="id_read_off_custcode" class="css_read_off_custcode" style="white-space: nowrap;<?php echo $sStyleReadInp_custcode; ?>">
 ...
 size=6 maxlength=6 alt="{datatype: 'text', maxLength: 6, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php
   $Sc_iframe_master = ($this->Embutida_call) ? 'nmgp_iframe_ret*scinnmsc_iframe_liga_form_tbadmrawatinap*scout' : '';
   if (isset($this->Ini->sc_lig_md5["grid_tbcustomer"]) && $this->Ini->sc_lig_md5["grid_tbcustomer"] == "S") {
       ...
       $Md5_Lig    = "@SC_par@" . $this->form_encode_input($this->Ini->sc_page) . "@SC_par@form_tbadmrawatinap@SC_par@" . md5($Parms_Lig);
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbadmrawatinap']['Lig_Md5'][md5($Parms_Lig)] = $Parms_Lig;
   } else {
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_penjamin_label" id="hidden_field_label_penjamin" style="<?php echo $sStyleHidden_penjamin; ?>"><span id="id_label_penjamin"><?php echo $this->nm_new_label['penjamin']; ?></span></TD>
    <TD class="scFormDataOdd css_penjamin_line" id="hidden_field_data_penjamin" style="<?php echo $sStyleHidden_penjamin; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_penjamin_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_hubpenjamin_label" id="hidden_field_label_hubpenjamin" style="<?php echo $sStyleHidden_hubpenjamin; ?>"><span id="id_label_hubpenjamin"><?php echo $this->nm_new_label['hubpenjamin']; ?></span></TD>
    <TD class="scFormDataOdd css_hubpenjamin_line" id="hidden_field_data_hubpenjamin" style="<?php echo $sStyleHidden_hubpenjamin; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_hubpenjamin_line" style="vertical-align: top;padding: 0px">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbadmrawatinap']['Lookup_hubpenjamin'][] = 'AYAH'; ?>
 <option  value="IBU" <?php  if ($this->hubpenjamin == "IBU") { echo " selected" ;} ?>>IBU</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbadmrawatinap']['Lookup_hubpenjamin'][] = 'IBU'; ?>
 <option  value="ANAK" <?php  if ($this->hubpenjamin == "ANAK") { echo " selected" ;} ?>>ANAK</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbadmrawatinap']['Lookup_hubpenjamin'][] = 'ANAK'; ?>
 <option  value="SUAMI" <?php  if ($this->hubpenjamin == "SUAMI") { echo " selected" ;} ?>>SUAMI</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbadmrawatinap']['Lookup_hubpenjamin'][] = 'SUAMI'; ?>
 <option  value="ISTRI" <?php  if ($this->hubpenjamin == "ISTRI") { echo " selected" ;} ?>>ISTRI</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbadmrawatinap']['Lookup_hubpenjamin'][] = 'ISTRI'; ?>
 <option  value="SAUDARA KANDUNG" <?php  if ($this->hubpenjamin == "SAUDARA KANDUNG") { echo " selected" ;} ?>>SAUDARA KANDUNG</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbadmrawatinap']['Lookup_hubpenjamin'][] = 'SAUDARA KANDUNG'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbadmrawatinap']['Lookup_hubpenjamin'][] = 'SAUDARA TIDAK KANDUNG'; ?>
 </select></span>
</span><?php  }?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbadmrawatinap']['Lookup_status'][] = 'Daftar'; ?>
 <option  value="Pelayanan" <?php  if ($this->status == "Pelayanan") { echo " selected" ;} ?>>Pelayanan</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbadmrawatinap']['Lookup_status'][] = 'Pelayanan'; ?>
 <option  value="Batal" <?php  if ($this->status == "Batal") { echo " selected" ;} ?>>Batal</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbadmrawatinap']['Lookup_status'][] = 'Batal'; ?>
 </select></span>
</span><?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_admision_label" id="hidden_field_label_admision" style="<?php echo $sStyleHidden_admision; ?>"><span id="id_label_admision"><?php echo $this->nm_new_label['admision']; ?></span></TD>
    <TD class="scFormDataOdd css_admision_line" id="hidden_field_data_admision" style="<?php echo $sStyleHidden_admision; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_admision_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tglmasuk_hora_label" id="hidden_field_label_tglmasuk" style="<?php echo $sStyleHidden_tglmasuk; ?>"><span id="id_label_tglmasuk"><?php echo $this->nm_new_label['tglmasuk']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbadmrawatinap']['php_cmp_required']['tglmasuk']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbadmrawatinap']['php_cmp_required']['tglmasuk'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_tglmasuk_hora_line" id="hidden_field_data_tglmasuk" style="<?php echo $sStyleHidden_tglmasuk; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tglmasuk_hora_line" style="vertical-align: top;padding: 0px">
...
<span class='trigger-picker-<?php echo $miniCalendarButton[1]; ?>'>
 ...
 size=18 alt="{datatype: 'date', dateSep: '<?php echo $this->field_config['tglmasuk']['date_sep']; ?>', dateFormat: '<?php echo $this->field_config['tglmasuk']['date_format']; ?>', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span>
<?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_doctor_label" id="hidden_field_label_doctor" style="<?php echo $sStyleHidden_doctor; ?>"><span id="id_label_doctor"><?php echo $this->nm_new_label['doctor']; ?></span></TD>
    <TD class="scFormDataOdd css_doctor_line" id="hidden_field_data_doctor" style="<?php echo $sStyleHidden_doctor; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_doctor_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_kelas_label" id="hidden_field_label_kelas" style="<?php echo $sStyleHidden_kelas; ?>"><span id="id_label_kelas"><?php echo $this->nm_new_label['kelas']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbadmrawatinap']['php_cmp_required']['kelas']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbadmrawatinap']['php_cmp_required']['kelas'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_kelas_line" id="hidden_field_data_kelas" style="<?php echo $sStyleHidden_kelas; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_kelas_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_bed_label" id="hidden_field_label_bed" style="<?php echo $sStyleHidden_bed; ?>"><span id="id_label_bed"><?php echo $this->nm_new_label['bed']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbadmrawatinap']['php_cmp_required']['bed']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbadmrawatinap']['php_cmp_required']['bed'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_bed_line" id="hidden_field_data_bed" style="<?php echo $sStyleHidden_bed; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_bed_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_diagnosa1_label" id="hidden_field_label_diagnosa1" style="<?php echo $sStyleHidden_diagnosa1; ?>"><span id="id_label_diagnosa1"><?php echo $this->nm_new_label['diagnosa1']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbadmrawatinap']['php_cmp_required']['diagnosa1']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbadmrawatinap']['php_cmp_required']['diagnosa1'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_struckno_label" id="hidden_field_label_struckno" style="<?php echo $sStyleHidden_struckno; ?>"><span id="id_label_struckno"><?php echo $this->nm_new_label['struckno']; ?></span></TD>
    <TD class="scFormDataOdd css_struckno_line" id="hidden_field_data_struckno" style="<?php echo $sStyleHidden_struckno; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_struckno_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_pembayaran_label" id="hidden_field_label_pembayaran" style="<?php echo $sStyleHidden_pembayaran; ?>"><span id="id_label_pembayaran"><?php echo $this->nm_new_label['pembayaran']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbadmrawatinap']['php_cmp_required']['pembayaran']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbadmrawatinap']['php_cmp_required']['pembayaran'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_pembayaran_line" id="hidden_field_data_pembayaran" style="<?php echo $sStyleHidden_pembayaran; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_pembayaran_line" style="vertical-align: top;padding: 0px">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbadmrawatinap']['Lookup_pembayaran'][] = ''; ?>
 <option value=""></option>
 <option  value="UMUM" <?php  if ($this->pembayaran == "UMUM") { echo " selected" ;} ?><?php  if (empty($this->pembayaran)) { echo " selected" ;} ?>>UMUM</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbadmrawatinap']['Lookup_pembayaran'][] = 'UMUM'; ?>
 <option  value="ASURANSI" <?php  if ($this->pembayaran == "ASURANSI") { echo " selected" ;} ?>>ASURANSI</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbadmrawatinap']['Lookup_pembayaran'][] = 'ASURANSI'; ?>
 <option  value="BPJS" <?php  if ($this->pembayaran == "BPJS") { echo " selected" ;} ?>>BPJS</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbadmrawatinap']['Lookup_pembayaran'][] = 'BPJS'; ?>
 <option  value="BANSOS" <?php  if ($this->pembayaran == "BANSOS") { echo " selected" ;} ?>>BANSOS</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbadmrawatinap']['Lookup_pembayaran'][] = 'BANSOS'; ?>
 <option  value="JAMPERU" <?php  if ($this->pembayaran == "JAMPERU") { echo " selected" ;} ?>>JAMPERU</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbadmrawatinap']['Lookup_pembayaran'][] = 'JAMPERU'; ?>
 <option  value="TUNAI PAKET" <?php  if ($this->pembayaran == "TUNAI PAKET") { echo " selected" ;} ?>>TUNAI PAKET</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbadmrawatinap']['Lookup_pembayaran'][] = 'TUNAI PAKET'; ?>
 <option  value="TUNAI PROMO" <?php  if ($this->pembayaran == "TUNAI PROMO") { echo " selected" ;} ?>>TUNAI PROMO</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbadmrawatinap']['Lookup_pembayaran'][] = 'TUNAI PROMO'; ?>
 </select></span>
</span><?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_paket_label" id="hidden_field_label_paket" style="<?php echo $sStyleHidden_paket; ?>"><span id="id_label_paket"><?php echo $this->nm_new_label['paket']; ?></span></TD>
    <TD class="scFormDataOdd css_paket_line" id="hidden_field_data_paket" style="<?php echo $sStyleHidden_paket; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_paket_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_provider_label" id="hidden_field_label_provider" style="<?php echo $sStyleHidden_provider; ?>"><span id="id_label_provider"><?php echo $this->nm_new_label['provider']; ?></span></TD>
    <TD class="scFormDataOdd css_provider_line" id="hidden_field_data_provider" style="<?php echo $sStyleHidden_provider; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_provider_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_idprovider_label" id="hidden_field_label_idprovider" style="<?php echo $sStyleHidden_idprovider; ?>"><span id="id_label_idprovider"><?php echo $this->nm_new_label['idprovider']; ?></span></TD>
    <TD class="scFormDataOdd css_idprovider_line" id="hidden_field_data_idprovider" style="<?php echo $sStyleHidden_idprovider; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_idprovider_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_caramasuk_label" id="hidden_field_label_caramasuk" style="<?php echo $sStyleHidden_caramasuk; ?>"><span id="id_label_caramasuk"><?php echo $this->nm_new_label['caramasuk']; ?></span></TD>
    <TD class="scFormDataOdd css_caramasuk_line" id="hidden_field_data_caramasuk" style="<?php echo $sStyleHidden_caramasuk; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_caramasuk_line" style="vertical-align: top;padding: 0px">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbadmrawatinap']['Lookup_caramasuk'][] = 'BARU'; ?>
 <option  value="IGD" <?php  if ($this->caramasuk == "IGD") { echo " selected" ;} ?>>IGD</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbadmrawatinap']['Lookup_caramasuk'][] = 'IGD'; ?>
 <option  value="RAWAT JALAN" <?php  if ($this->caramasuk == "RAWAT JALAN") { echo " selected" ;} ?>>RAWAT JALAN</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbadmrawatinap']['Lookup_caramasuk'][] = 'RAWAT JALAN'; ?>
 <option  value="RUJUKAN" <?php  if ($this->caramasuk == "RUJUKAN") { echo " selected" ;} ?>>RUJUKAN</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbadmrawatinap']['Lookup_caramasuk'][] = 'RUJUKAN'; ?>
 </select></span>
</span><?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_unitasal_label" id="hidden_field_label_unitasal" style="<?php echo $sStyleHidden_unitasal; ?>"><span id="id_label_unitasal"><?php echo $this->nm_new_label['unitasal']; ?></span></TD>
    <TD class="scFormDataOdd css_unitasal_line" id="hidden_field_data_unitasal" style="<?php echo $sStyleHidden_unitasal; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_unitasal_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_perujuk_label" id="hidden_field_label_perujuk" style="<?php echo $sStyleHidden_perujuk; ?>"><span id="id_label_perujuk"><?php echo $this->nm_new_label['perujuk']; ?></span></TD>
    <TD class="scFormDataOdd css_perujuk_line" id="hidden_field_data_perujuk" style="<?php echo $sStyleHidden_perujuk; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_perujuk_line" style="vertical-align: top;padding: 0px">
...
?> 
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_hotel_label" id="hidden_field_label_hotel" style="<?php echo $sStyleHidden_hotel; ?>"><span id="id_label_hotel"><?php echo $this->nm_new_label['hotel']; ?></span></TD>
    <TD class="scFormDataOdd css_hotel_line" id="hidden_field_data_hotel" style="<?php echo $sStyleHidden_hotel; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_hotel_line" style="vertical-align: top;padding: 0px">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbadmrawatinap']['Lookup_hotel'][] = 'Y'; ?>
...
?> 
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_waitinglist_label" id="hidden_field_label_waitinglist" style="<?php echo $sStyleHidden_waitinglist; ?>"><span id="id_label_waitinglist"><?php echo $this->nm_new_label['waitinglist']; ?></span></TD>
    <TD class="scFormDataOdd css_waitinglist_line" id="hidden_field_data_waitinglist" style="<?php echo $sStyleHidden_waitinglist; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_waitinglist_line" style="vertical-align: top;padding: 0px">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbadmrawatinap']['Lookup_waitinglist'][] = 'Y'; ?>
