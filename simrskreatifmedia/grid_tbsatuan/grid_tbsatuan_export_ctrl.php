<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tbsatuan']['sc_process_barr'] = true;
require_once('../grid_tbsatuan/index.php');
unset($_SESSION['scriptcase']['grid_tbsatuan']['sc_process_barr']);
$ExportCtrl = new grid_tbsatuan_export_control;
$ExportCtrl->Export_barr();

class grid_tbsatuan_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_title'] ?> tbsatuan :: Excel</TITLE>
