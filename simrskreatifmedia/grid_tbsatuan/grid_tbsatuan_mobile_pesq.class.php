...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_satuanobat_cond" name="satuanobat_cond" onChange="nm_campos_between(document.getElementById('id_vis_satuanobat'), this, 'satuanobat')">
      ...
      <br><span id="id_hide_satuanobat"  <?php echo $str_hide_satuanobat?>><?php
      if ($satuanobat != "")
      {
      $satuanobat_look = substr($this->Db->qstr($satuanobat), 1, -1); 
      $nmgp_def_dados = array(); 
