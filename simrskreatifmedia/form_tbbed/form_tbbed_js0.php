<form name="F2" method=post 
               action="./" 
               target="_self"> 
<input type="hidden" name="idbed_" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['idbed_']); ?>">
<input type="hidden" name="nobed_" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['nobed_']); ?>">
<input type="hidden" name="ruang_" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['ruang_']); ?>">
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_tbbed"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
function scForm_inline_submit(y, z) {
	Nm_Proc_Atualiz = true;
	do_ajax_form_tbbed_submit_form(y, z);
...
{
   nm_field_disabled("kelas_=disabled", "");
