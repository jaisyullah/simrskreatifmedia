  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbbed" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbbed_form();
	}

  // ---------- Validate ruang_
  function do_ajax_form_tbbed_validate_ruang_(iNumLinha)
  {
    var nomeCampo_ruang_ = "ruang_" + iNumLinha;
    var var_ruang_ = scAjaxGetFieldSelect(nomeCampo_ruang_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbbed_validate_ruang_(var_ruang_, iNumLinha, var_script_case_init, do_ajax_form_tbbed_validate_ruang__cb);
  } // do_ajax_form_tbbed_validate_ruang_

  function do_ajax_form_tbbed_validate_ruang__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "ruang_" + iLineNumber;
    }
    else
    {
      sFieldValid = "ruang_";
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "ruang_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "ruang_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbbed_validate_ruang__cb

  // ---------- Validate nobed_
  function do_ajax_form_tbbed_validate_nobed_(iNumLinha)
  {
    var nomeCampo_nobed_ = "nobed_" + iNumLinha;
    var var_nobed_ = scAjaxGetFieldText(nomeCampo_nobed_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbbed_validate_nobed_(var_nobed_, iNumLinha, var_script_case_init, do_ajax_form_tbbed_validate_nobed__cb);
  } // do_ajax_form_tbbed_validate_nobed_

  function do_ajax_form_tbbed_validate_nobed__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "nobed_" + iLineNumber;
    }
    else
    {
      sFieldValid = "nobed_";
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "nobed_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "nobed_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbbed_validate_nobed__cb

  // ---------- Validate kelas_
  function do_ajax_form_tbbed_validate_kelas_(iNumLinha)
  {
    var nomeCampo_kelas_ = "kelas_" + iNumLinha;
    var var_kelas_ = scAjaxGetFieldSelect(nomeCampo_kelas_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbbed_validate_kelas_(var_kelas_, iNumLinha, var_script_case_init, do_ajax_form_tbbed_validate_kelas__cb);
  } // do_ajax_form_tbbed_validate_kelas_

  function do_ajax_form_tbbed_validate_kelas__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbbed_validate_kelas__cb

  // ---------- Validate custcode_
  function do_ajax_form_tbbed_validate_custcode_(iNumLinha)
  {
    var nomeCampo_custcode_ = "custcode_" + iNumLinha;
    var var_custcode_ = scAjaxGetFieldText(nomeCampo_custcode_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbbed_validate_custcode_(var_custcode_, iNumLinha, var_script_case_init, do_ajax_form_tbbed_validate_custcode__cb);
  } // do_ajax_form_tbbed_validate_custcode_

  function do_ajax_form_tbbed_validate_custcode__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbbed_validate_custcode__cb

  // ---------- Validate aktif_
  function do_ajax_form_tbbed_validate_aktif_(iNumLinha)
  {
    var nomeCampo_aktif_ = "aktif_" + iNumLinha;
    var var_aktif_ = scAjaxGetFieldSelect(nomeCampo_aktif_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbbed_validate_aktif_(var_aktif_, iNumLinha, var_script_case_init, do_ajax_form_tbbed_validate_aktif__cb);
  } // do_ajax_form_tbbed_validate_aktif_

  function do_ajax_form_tbbed_validate_aktif__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "aktif_" + iLineNumber;
    }
    else
    {
      sFieldValid = "aktif_";
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "aktif_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "aktif_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbbed_validate_aktif__cb

  // ---------- Validate idbed_
  function do_ajax_form_tbbed_validate_idbed_(iNumLinha)
  {
    var nomeCampo_idbed_ = "idbed_" + iNumLinha;
    var var_idbed_ = scAjaxGetFieldHidden(nomeCampo_idbed_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbbed_validate_idbed_(var_idbed_, iNumLinha, var_script_case_init, do_ajax_form_tbbed_validate_idbed__cb);
  } // do_ajax_form_tbbed_validate_idbed_

  function do_ajax_form_tbbed_validate_idbed__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "idbed_" + iLineNumber;
    }
    else
    {
      sFieldValid = "idbed_";
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "idbed_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "idbed_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbbed_validate_idbed__cb

  // ---------- Refresh kelas_
  function do_ajax_form_tbbed_refresh_kelas_(iSeqForm)
  {
    var var_kelas_ = scAjaxGetFieldSelect("kelas_" + iSeqForm);
    var var_nmgp_refresh_row = iSeqForm;
    var var_nmgp_refresh_fields = "ruang_";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tbbed_refresh_kelas_(var_kelas_, var_nmgp_refresh_row, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_tbbed_refresh_kelas__cb);
  } // do_ajax_form_tbbed_refresh_kelas_

  function do_ajax_form_tbbed_refresh_kelas__cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbbed_refresh_kelas__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_tbbed_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_tbbed_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tbbed_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_tbbed_add_new_line_cb);
  } // do_ajax_form_tbbed_add_new_line

  function do_ajax_form_tbbed_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
    ...
    nm_field_disabled("kelas_=disabled", "", iAjaxNewLine);
  } // do_ajax_form_tbbed_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_tbbed_backup_line(iNumLinha)
  {
    var var_idbed_ = scAjaxGetFieldHidden("idbed_" + iNumLinha);
    var var_nobed_ = scAjaxGetFieldText("nobed_" + iNumLinha);
    var var_ruang_ = scAjaxGetFieldSelect("ruang_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbbed_backup_line(var_idbed_, var_nobed_, var_ruang_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_tbbed_backup_line_cb);
  } // do_ajax_form_tbbed_backup_line

  function do_ajax_form_tbbed_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_tbbed_backup_line_cb

  function do_ajax_form_tbbed_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_tbbed_cancel_insert

  function do_ajax_form_tbbed_cancel_update(iSeqVert)
  {
    do_ajax_form_tbbed_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_tbbed_cancel_update

  function do_ajax_form_tbbed_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_tbbed_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_tbbed_table_refresh()
  {
    var var_idbed_ = document.F2.idbed_.value;
    var var_nobed_ = document.F2.nobed_.value;
    var var_ruang_ = document.F2.ruang_.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tbbed_table_refresh(var_idbed_, var_nobed_, var_ruang_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbbed_table_refresh_cb);
  } //  do_ajax_form_tbbed_table_refresh

  function do_ajax_form_tbbed_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.idbed_.value = scAjaxGetKeyValue("idbed_");
    document.F2.nobed_.value = scAjaxGetKeyValue("nobed_");
    document.F2.ruang_.value = scAjaxGetKeyValue("ruang_");
    ...
    scAjaxAlert(do_ajax_form_tbbed_table_refresh_cb_after_alert);
  } // do_ajax_form_tbbed_table_refresh_cb
  function do_ajax_form_tbbed_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_tbbed_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_tbbed_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_tbbed_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    var var_aktif_ = scAjaxGetFieldSelect("aktif_" + iNumLinha);
    var var_idbed_ = scAjaxGetFieldHidden("idbed_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_tbbed_submit_form(var_ruang_, var_nobed_, var_kelas_, var_custcode_, var_aktif_, var_idbed_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbbed_submit_form_cb);
  } // do_ajax_form_tbbed_submit_form

  function do_ajax_form_tbbed_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("ruang_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("nobed_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("kelas_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("custcode_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("aktif_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("idbed_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_tbbed_submit_form_cb_after_alert);
  } // do_ajax_form_tbbed_submit_form_cb
  function do_ajax_form_tbbed_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbbed_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tbbed_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_tbbed_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("ruang_" + iNavForm);
      scAjaxHideErrorDisplay("nobed_" + iNavForm);
      scAjaxHideErrorDisplay("kelas_" + iNavForm);
      scAjaxHideErrorDisplay("custcode_" + iNavForm);
      scAjaxHideErrorDisplay("aktif_" + iNavForm);
      scAjaxHideErrorDisplay("idbed_" + iNavForm);
    }
    var var_idbed_ = document.F2.idbed_.value;
    var var_nobed_ = document.F2.nobed_.value;
    var var_ruang_ = document.F2.ruang_.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tbbed_navigate_form(var_idbed_, var_nobed_, var_ruang_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbbed_navigate_form_cb);
  } // do_ajax_form_tbbed_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbed']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbbed_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.idbed_.value = scAjaxGetKeyValue("idbed_" + var_last_index);
    document.F2.nobed_.value = scAjaxGetKeyValue("nobed_" + var_last_index);
    document.F2.ruang_.value = scAjaxGetKeyValue("ruang_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbbed_navigate_form_cb_after_alert);
  } // do_ajax_form_tbbed_navigate_form_cb
  function do_ajax_form_tbbed_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_tbbed_navigate_form_cb_after_alert
  function sc_hide_form_tbbed_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "ruang_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "nobed_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "kelas_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "custcode_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "aktif_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "idbed_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["ruang_" + iNumLinha] = {"label": "Ruang<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["nobed_" + iNumLinha] = {"label": "No Bed<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_error_list["custcode_" + iNumLinha] = {"label": "Terisi Oleh<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["aktif_" + iNumLinha] = {"label": "Aktif<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["idbed_" + iNumLinha] = {"label": "Id Bed<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["ruang_"][iNumLinha] = "ruang_" + iNumLinha;
    ajax_field_mult["nobed_"][iNumLinha] = "nobed_" + iNumLinha;
    ajax_field_mult["kelas_"][iNumLinha] = "kelas_" + iNumLinha;
    ajax_field_mult["custcode_"][iNumLinha] = "custcode_" + iNumLinha;
    ajax_field_mult["aktif_"][iNumLinha] = "aktif_" + iNumLinha;
    ajax_field_mult["idbed_"][iNumLinha] = "idbed_" + iNumLinha;
    ajax_field_id["ruang_" + iNumLinha] = new Array("hidden_field_label_ruang_", "hidden_field_data_ruang_" + iNumLinha);
    ajax_field_id["nobed_" + iNumLinha] = new Array("hidden_field_label_nobed_", "hidden_field_data_nobed_" + iNumLinha);
    ajax_field_id["kelas_" + iNumLinha] = new Array("hidden_field_label_kelas_", "hidden_field_data_kelas_" + iNumLinha);
    ajax_field_id["custcode_" + iNumLinha] = new Array("hidden_field_label_custcode_", "hidden_field_data_custcode_" + iNumLinha);
    ajax_field_id["aktif_" + iNumLinha] = new Array("hidden_field_label_aktif_", "hidden_field_data_aktif_" + iNumLinha);
    ajax_error_count["ruang_" + iNumLinha] = "off";
    ajax_error_count["nobed_" + iNumLinha] = "off";
    ajax_error_count["kelas_" + iNumLinha] = "off";
    ajax_error_count["custcode_" + iNumLinha] = "off";
    ajax_error_count["aktif_" + iNumLinha] = "off";
    ajax_error_count["idbed_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["ruang_" + iNumLinha] = "on";
    ajax_read_only["nobed_" + iNumLinha] = "on";
    ajax_read_only["kelas_" + iNumLinha] = "off";
    ajax_read_only["custcode_" + iNumLinha] = "off";
    ajax_read_only["aktif_" + iNumLinha] = "off";
    ajax_read_only["idbed_" + iNumLinha] = "on";
<?php
}
else
{
?>
    ...
    ajax_read_only["aktif_" + iNumLinha] = "on";
    ajax_read_only["idbed_" + iNumLinha] = "on";
<?php
}
?>
  ...
  {
    ajax_error_list["ruang_" + iNumLinha] = null;
    ajax_error_list["nobed_" + iNumLinha] = null;
    ajax_error_list["kelas_" + iNumLinha] = null;
    ajax_error_list["custcode_" + iNumLinha] = null;
    ajax_error_list["aktif_" + iNumLinha] = null;
    ajax_error_list["idbed_" + iNumLinha] = null;
  }
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["ruang_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["ruang_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["ruang_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["ruang_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["ruang_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["nobed_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["nobed_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["nobed_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["nobed_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["nobed_" + iNumLinha]["onfocus"] = new Array();
      ...
      ajax_error_list["aktif_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["aktif_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["aktif_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["aktif_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["aktif_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["idbed_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["idbed_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["idbed_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["idbed_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["idbed_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['ruang_'])) ? $this->nmgp_cmp_readonly['ruang_'] : 'on';
?>
    scAjaxFieldRead("ruang_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['nobed_'])) ? $this->nmgp_cmp_readonly['nobed_'] : 'on';
?>
    scAjaxFieldRead("nobed_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['aktif_'])) ? $this->nmgp_cmp_readonly['aktif_'] : 'off';
?>
    scAjaxFieldRead("aktif_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['idbed_'])) ? $this->nmgp_cmp_readonly['idbed_'] : 'on';
?>
    scAjaxFieldRead("idbed_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("ruang_" + iSeq, "on");
    scAjaxFieldRead("nobed_" + iSeq, "on");
    scAjaxFieldRead("kelas_" + iSeq, "on");
    scAjaxFieldRead("custcode_" + iSeq, "on");
    scAjaxFieldRead("aktif_" + iSeq, "on");
    scAjaxFieldRead("idbed_" + iSeq, "on");
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["ruang_" + iRow] || "on" == ajax_error_count["nobed_" + iRow] || "on" == ajax_error_count["kelas_" + iRow] || "on" == ajax_error_count["custcode_" + iRow] || "on" == ajax_error_count["aktif_" + iRow] || "on" == ajax_error_count["idbed_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_ruang_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_nobed_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_kelas_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_custcode_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_aktif_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_idbed_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["ruang_" + iRow] && "off" == ajax_error_count["nobed_" + iRow] && "off" == ajax_error_count["kelas_" + iRow] && "off" == ajax_error_count["custcode_" + iRow] && "off" == ajax_error_count["aktif_" + iRow] && "off" == ajax_error_count["idbed_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["ruang_" + iRow] = "off";
        ajax_error_count["nobed_" + iRow] = "off";
        ajax_error_count["kelas_" + iRow] = "off";
        ajax_error_count["custcode_" + iRow] = "off";
        ajax_error_count["aktif_" + iRow] = "off";
        ajax_error_count["idbed_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_ruang_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_nobed_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_kelas_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_custcode_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_aktif_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_idbed_" + iRow).removeClass("scFormErrorLine");
    }
  }
