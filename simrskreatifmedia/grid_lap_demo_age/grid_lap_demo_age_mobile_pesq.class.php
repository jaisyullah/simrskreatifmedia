...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "jumlah";$Nm_numeric[] = "jumlah";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_range_umur_cond" name="range_umur_cond" onChange="nm_campos_between(document.getElementById('id_vis_range_umur'), this, 'range_umur')">
      ...
      <br><span id="id_hide_range_umur"  <?php echo $str_hide_range_umur?>><?php
      if ($range_umur != "")
      {
      $range_umur_look = substr($this->Db->qstr($range_umur), 1, -1); 
      $nmgp_def_dados = array(); 
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      ...
      <br><span id="id_hide_jumlah"  <?php echo $str_hide_jumlah?>><INPUT  type="text" id="SC_jumlah" name="jumlah" value="<?php echo NM_encode_input($jumlah) ?>" size=19 alt="{datatype: 'integer', maxLength: 19, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
