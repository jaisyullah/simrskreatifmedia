...
class grid_lap_demo_age_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   var $count_ger;
   var $sum_jumlah;
   var $sc_proc_quebra_range_umur;
   var $count_range_umur;
   var $sum_range_umur_jumlah;
   ...
   function __construct($tipo = "")
   {
      ...
      $this->array_total_range_umur = array();
   ...
   function initializeButtons()
   {
      ...
      $this->nmgp_botoes['chart_exit'] = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['dashboard_info']['under_dashboard'] ? "off" : "on";

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['grid_lap_demo_age'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['grid_lap_demo_age'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_lap_demo_age']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_lap_demo_age']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['grid_lap_demo_age']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
   ...
   { 
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['grid_lap_demo_age']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['grid_lap_demo_age']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
      ...
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['where_pesq_filtro'];
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['campos_busca']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['campos_busca']))
     { 
         $Busca_temp = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['campos_busca'];
         if ($_SESSION['scriptcase']['charset'] != "UTF-8")
         {
             $Busca_temp = NM_conv_charset($Busca_temp, $_SESSION['scriptcase']['charset'], "UTF-8");
         }
       $this->range_umur = $Busca_temp['range_umur']; 
       $tmp_pos = strpos($this->range_umur, "##@@");
       if ($tmp_pos !== false && !is_array($this->range_umur))
       {
           $this->range_umur = substr($this->range_umur, 0, $tmp_pos);
       }
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['pesq_tab_label']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['pesq_tab_label'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['pesq_tab_label'] .= "range_umur?#?" . "Range Umur" . "?@?";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['pesq_tab_label'] .= "jumlah?#?" . "Jumlah" . "?@?";
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['grid_search_add']))
      {
          $this->monta_css();
          $nmgp_tab_label = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['pesq_tab_label'];
          ...
          $Seq_grid      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['grid_search_add']['seq'];
          $Cmp_grid      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['grid_search_add']['cmp'];
          ...
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['grid_search_add']);
          exit;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['dyn_search_aut_comp']))
      {
          ob_start();
          $NM_func_aut_comp = "lookup_ajax_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['dyn_search_aut_comp']['cmp'];
          ...
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['dyn_search_aut_comp']);
          exit;
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['opcao'] != "pdf")
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['res_hrz'];
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']) && !$this->NM_export)
      {
          foreach ($_SESSION['scriptcase']['sc_aba_iframe'] as $aba => $apls_aba)
          {
              if (in_array("grid_lap_demo_age", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['where_resumo'] = "";
      }
      $this->inicializa_vars();
      $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['SC_Ind_Groupby'];
      $this->Total->$Gb_geral();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['contr_total_geral'] == "OK")
      {
          $this->array_total_range_umur = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['arr_total']['range_umur'];
      }
      else
      {
          $this->array_total_range_umur = array();
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['tot_geral'][2];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['tot_geral'][1] == 0)
      {
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['arr_total']['range_umur'] = $this->array_total_range_umur;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['json_use_label'])
       {
          $Lab_range_umur = "range_umur";
       }
       else
       {
          $Lab_range_umur = "Range Umur";
       }
       $this->comp_field = array(
           $Lab_range_umur,
       );

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['labels']['range_umur']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['labels']['range_umur'] = "Range Umur"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['labels']['jumlah']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['labels']['jumlah'] = "Jumlah"; 
       }
       //-----
       $this->comp_field_nm = array(
           'range_umur' => 0,
       ...
       //-----
       $this->comp_sum = array(
           2 => "Jumlah (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")",
       );
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['summarizing_fields_order']['range_umur']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['summarizing_fields_order']['range_umur'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['summarizing_fields_order']['range_umur'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['summarizing_fields_display']['range_umur'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['summarizing_fields_display']['range_umur'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['summarizing_fields_display']['range_umur'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['summarizing_fields_display']['range_umur'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['summarizing_fields_display']['range_umur'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['summarizing_fields_display']['range_umur'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['summarizing_fields_display']['range_umur'] as $i_sum => $d_sum)
           {
       ...
       //-----
       $this->comp_sum_lnk = array(
           2 => array('field' => "jumlah", 'show' => true),
       );
       ...
       //-----
       foreach ($this->array_total_range_umur as $i_range_umur => $d_range_umur) {
           if (!in_array($i_range_umur, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_range_umur[3] ] = $d_range_umur[2];
               $this->comp_label[0][ $d_range_umur[3] ] = $d_range_umur[2];
           }
       }
       ...
       //-----
       $this->comp_links_fl = array(
           array('name' => 'range_umur', 'prot' => '@aspass@'),
       );
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['pivot_order_level'] = -1;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['pivot_tabular_label'];
       ...
       //-----
       foreach ($this->comp_label[0] as $i_range_umur => $l_range_umur) {
           if (isset($this->array_total_range_umur[$i_range_umur])) {
               $this->comp_group[$i_range_umur] = array();
           }
       }
   ...
   function getCompData($level, $params = array()) {
       if (0 == $level) {
           $return = $this->array_total_range_umur;
       }
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_lap_demo_age@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function makeTabular(&$a_data)
   {
       ...
       {
           $a_labels = array();
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['proc_pdf_vert'])
   {
     $this->comp_tab_hover = true;
   }
   ...
   function buildChart()
   {
       ...
       $this->comp_chart_config = array(
           '0|1' => array(
               ...
               'label_x'  => $this->getChartText(strip_tags($Lab_range_umur)),
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['pivot_charts']    = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['pivot_orig']      = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['comb_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['comb_table_def']  = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['anlt_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['anlt_table_def']  = array();
	...
	function filterChartsByGroupbyLevel() {
		...
		if (isset($nmgp_opcao) && ('pdf' == $nmgp_opcao || 'pdf_res' == $nmgp_opcao) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['chart_level']) && '' !== $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['chart_level']) {
			$applyFilter = true;
		}
		elseif (isset($nmgp_opcao) && 'image_res' == $nmgp_opcao && isset($_POST['chart_level']) && '' !== $_POST['chart_level']) {
			$applyFilter = true;
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['chart_level'] = $_POST['chart_level'];
		}
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['pivot_charts'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['pivot_orig'];

		if ($applyFilter) {
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['pivot_charts'] as $chartIndex => $chartData) {
				...
				if ($groupbyLevel > $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['chart_level']) {
					unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['pivot_charts'][$chartIndex]);
				}
			}
		}

		$this->comp_chart_data = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['pivot_charts'];
	}
           ...
           foreach ($a_totals as $i_total => $values)
           {
               ...
               if (isset($this->comp_chart_config[$key_config]))
               {
                   ...
                   foreach ($a_keys as $tmp_key)
                   {
                       ...
                       $xml_links[]  = $this->getFusionLink('sc_grid_lap_demo_age_' . session_id() . '_!!!' . implode('_', array_merge(array($group + 1, $i_total), $link_index)) . '!!!.json');
                   }
                   ...
                   $this->comp_chart_data[$key_data]['xml']        = $this->getFusionLink('sc_grid_lap_demo_age_' . session_id() . '_!!!' . implode('_', array_merge(array($group, $i_total), $param)) . '!!!.json');
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['embutida'])
                   {
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['proc_pdf_vert']){ 
   ...
   {
       if (!$res_chart && $this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['json_use_format']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['json_use_format'])
       {
           return $valor_campo;
       }
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
         ...
         { 
            ...
            { 
                $seq_search = 1;
                foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['grid_pesq'] as $cmp => $def)
                {
                   $Seq_grid      = $seq_search;
                   $Cmp_grid      = $cmp;
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
               if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['grid_lap_demo_age']))
               {
                   $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['grid_lap_demo_age']) . "_";
               } 
           } 
           else 
           { 
               if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['grid_lap_demo_age']))
               {
                   $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['grid_lap_demo_age']) . "_";
               } 
           }
       }
   ...
   function resumo_final()
   {
      ...
      if (!$this->NM_res_sem_reg && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['opcao'] != "pdf")
      {
          $this->grafico_bot();
      }
      if ("out" == $this->NM_tipo)
   ...
   function inicializa_vars()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         require_once($this->Ini->path_aplicacao . "grid_lap_demo_age_total.class.php"); 
      }
      $this->Print_All = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['print_all'];
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['doc_word'] || $this->Ini->sc_export_ajax_img)
      { 
      ...
      $this->Total   = new grid_lap_demo_age_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      $this->Total->Calc_resumo_range_umur("res");
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['arr_total'][$cmp_gb];
      }
      ksort($this->array_total_range_umur);
      if ("out" == $this->NM_tipo)
      {
         $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['SC_Ind_Groupby'];
         $this->Total->$Gb_geral();
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['dashboard_refresh_after_chart'] = 'resumo';
      $nm_saida->saida("<HTML" . $_SESSION['scriptcase']['reg_conf']['html_dir'] . ">\r\n");
      $nm_saida->saida("<HEAD>\r\n");
      $nm_saida->saida(" <TITLE>DATA DEMOGRAFI BERDASARKAN USIA</TITLE>\r\n");
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['doc_word'])
{
      ...
      { 
           ...
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"grid_lap_demo_age_ajax.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\">\r\n");
           ...
           $nm_saida->saida(" </script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"grid_lap_demo_age_jquery.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"grid_lap_demo_age_message.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"../_lib/lib/js/scInput.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"../_lib/lib/js/jquery.scInput.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"../_lib/lib/js/jquery.scInput2.js\"></script>\r\n");
   ...
   { 
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['num_css']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['num_css'] = rand(0, 1000);
      }
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_lap_demo_age_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grid_lap_demo_age_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_lap_demo_age_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['num_css'] . '.css');
...
$nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_lap_demo_age/grid_lap_demo_age_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\">\r\n");
           ...
           $nm_saida->saida("         dataType: \"html\",\r\n");
           $nm_saida->saida("         url: \"grid_lap_demo_age_save_grid.php\",\r\n");
           ...
           $nm_saida->saida("     }\r\n");
           $nm_saida->saida("   </script>\r\n");
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['ajax_nav'] && !$this->Ini->sc_export_ajax && !$this->Ini->Export_html_zip && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['doc_word'])
      {
           $nm_saida->saida("   <script type=\"text/javascript\"> \r\n");
          ...
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['grid_pesq']))
          { 
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['doc_word']) 
      {
      ...
      {
          $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['dashboard_info']['remove_margin'] ? ' style="margin: 0"' : '';
          $nm_saida->saida(" <BODY class=\"" . $this->css_scGridPage . "\"" . $remove_margin . ">\r\n");
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['embutida'])
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top_normal()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['pdf'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "Rpdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_lap_demo_age/grid_lap_demo_age_config_pdf.php?nm_opc=pdf_res&nm_target=0&nm_cor=cor&papel=8&orientacao=1&bookmarks=1&largura=1200&conf_larg=S&conf_fonte=10&grafico=S&sc_ver_93=" . s . "&nm_tem_gb=s&nm_res_cons=s&nm_ini_pdf_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&summary_export_columns=S&nm_label_group=N&nm_all_cab=S&nm_all_label=S&pdf_zip=N&nm_orient_grid=2&origem=res&language=id&conf_socor=N&script_case_init=" . $this->Ini->sc_page . "&app_name=grid_lap_demo_age&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['xls'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bexcel", "", "", "Rxls_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_lap_demo_age/grid_lap_demo_age_config_xls.php?script_case_init=" . $this->Ini->sc_page . "&app_name=grid_lap_demo_age&nm_tp_xls=xlsx&nm_tot_xls=N&nm_tot_xls=N&nm_res_cons=s&nm_ini_xls_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&summary_export_columns=S&origem=res&language=&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['xml'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bxml", "", "", "Rxml_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_lap_demo_age/grid_lap_demo_age_config_xml.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=s&nm_ini_xml_res=grid,resume,chart&nm_all_modules=grid,resume,chart&nm_xml_tag=tag&nm_xml_label=S&language=&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_lap_demo_age/grid_lap_demo_age_config_print.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_opc=resumo&nm_cor=CO&nm_res_cons=s&nm_ini_prt_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&origem=res&language=id&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      {
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bconf_graf", "", "", "Rgraf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_lap_demo_age/grid_lap_demo_age_config_graf_flash.php?nome_apl=grid_lap_demo_age&campo_apl=nm_resumo_graf&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=id&tp_apl=ger_gra&KeepThis=true&TB_iframe=true&height=450&width=400&modal=true", "", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
      }
      if ($this->nmgp_botoes['chart_detail'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("grid_lap_demo_age_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
            $Arq_WebHelp = file("grid_lap_demo_age_help.txt"); 
   ...
   function monta_html_fim()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['print_all'])
      {
          $this->grafico_pdf();
      }
      $nm_saida->saida("</TABLE>\r\n");
      $nm_saida->saida("<link rel=\"stylesheet\" type=\"text/css\" href=\"../_lib/css/" . $this->Ini->str_schema_all . "_sweetalert.css\" />\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_lap_demo_age']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_lap_demo_age']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
$nm_saida->saida("       scJs_alert('" . $mensagem . "', $jsonParams);\r\n");
      ...
      elseif ($this->Ini->Export_html_zip || ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['opcao'] == "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['graf_pdf'] == "S"))
      {
          $this->grafico_pdf();
      }
      else
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'grid_lap_demo_age_config_pivot.php?nome_apl=grid_lap_demo_age&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=id&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   $nm_saida->saida("                  action=\"grid_lap_demo_age_iframe_prt.php\" \r\n");
   ...
   $nm_saida->saida("   </form> \r\n");
          ...
          $nm_saida->saida("               nm_submit_modal(\"" . $this->Ini->path_link . "grid_lap_demo_age/grid_lap_demo_age_export_email.php?script_case_init={$this->Ini->sc_page}&path_img={$this->Ini->path_img_global}&path_btn={$this->Ini->path_botoes}&sType=\"+ str_type +\"&sAdd=__E__nmgp_cor_word=\" + cor + \"__E__SC_module_export=\" + SC_module_export + \"__E__nmgp_password=\" + password + \"&KeepThis=true&TB_iframe=true&modal=true\", bol_param);\r\n");
          $nm_saida->saida("       }\r\n");
          $nm_saida->saida("       else\r\n");
          $nm_saida->saida("       {\r\n");
          ...
          $nm_saida->saida("           {\r\n");
          $nm_saida->saida("               document.Fdoc_word.action = \"grid_lap_demo_age_export_ctrl.php\";\r\n");
          $nm_saida->saida("           }\r\n");
          ...
          $nm_saida->saida("               document.Fprint.action = \"grid_lap_demo_age_export_ctrl.php\";\r\n");
          $nm_saida->saida("           }\r\n");
          $nm_saida->saida("           else\r\n");
          $nm_saida->saida("           {\r\n");
   ...
   $nm_saida->saida("           document.Fexport.nmgp_tot_xls.value = tot_xls;\r\n");
          ...
          $nm_saida->saida("           {\r\n");
          $nm_saida->saida("               document.Fexport.action = \"grid_lap_demo_age_export_ctrl.php\";\r\n");
          $nm_saida->saida("           }\r\n");
      ...
      if (!extension_loaded("zip"))
      {
          ...
          $nm_saida->saida("       document.F3.SC_module_export.value = z;\r\n");
          $nm_saida->saida("  }\r\n");
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['grid_lap_demo_age_iframe_params'] = array(
      ...
      $Md5_pdf    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_lap_demo_age@SC_par@" . md5($prep_parm_pdf);
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['Md5_pdf'][md5($prep_parm_pdf)] = $prep_parm_pdf;
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_lap_demo_age_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "grid_lap_demo_age/grid_lap_demo_age_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       $this->Print_All = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['print_all'];
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['pdf_res'])
       {
           $nm_saida->saida("<TR>\r\n");
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
...
//--- 
 function grafico_pdf()
 {
   ...
   $this->Graf->Ini    = $this->Ini;
   $this->Graf->Lookup = $this->Lookup;
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['pivot_charts']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['skip_charts']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['skip_charts']))
   {
 ...
 { 
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['pivot_charts'] as $chart_index => $chart_data)
       {
           if (!$prim_graf)
           {
 ...
 { 
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['this_chart_label'] = '';
       ...
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['charts_html']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['charts_html'])
       {
            $nm_saida->saida("<script type=\"text/javascript\">\r\n");
            $nm_saida->saida("{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['charts_html']}\r\n");
            $nm_saida->saida("</script>\r\n");
       }
   }
       $nm_saida->saida("</body>\r\n");
...
//--- 
 ...
 {
   global $nm_saida, $nm_lang;
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['chart_list']))
   {
       $prim_graf = true;
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['chart_list'] as $arr_chart)
       {
           if (!$prim_graf)
           {
               $nm_saida->saida("<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>\r\n");
...
//--- 
 function grafico_bot()
 {
   ...
   $bPDF = false;
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['pivot_charts']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['graf_bot'] = true;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['graf_first'] = true;
       require_once($this->Ini->path_aplicacao . $this->Ini->Apl_grafico); 
       $this->Graf  = new grid_lap_demo_age_grafico();
       $this->Graf->Db     = $this->Db;
       $this->Graf->Erro   = $this->Erro;
      ...
      if (isset($_POST['nmgp_opcao']) && 'ajax_navigate' == $_POST['nmgp_opcao'] && isset($_POST['opc']) && ('grid_search_res' == $_POST['opc'] || 'resumo_search' == $_POST['opc'])) {
       ...
       $nm_saida->saida("<TR>\r\n");
       $iChartCount = 1;
       $iChartTotal = sizeof($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['pivot_charts']);
       $sChartLang  = isset($this->Ini->Nm_lang['lang_pdff_pcht']) ? $this->Ini->Nm_lang['lang_pdff_pcht'] : 'Generating chart';
       if (!NM_is_utf8($sChartLang))
       {
           $sChartLang = sc_convert_encoding($sChartLang, "UTF-8", $_SESSION['scriptcase']['charset']);
      ...
      if ($bPDF && (!isset($this->progress_fp) || !$this->progress_fp))
      {
       ...
       $nm_saida->saida("</TR>\r\n");
      if (isset($_POST['nmgp_opcao']) && 'ajax_navigate' == $_POST['nmgp_opcao'] && isset($_POST['opc']) && 'resumo' == $_POST['opc']) {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['new_charts'] = $_SESSION['scriptcase']['saida_html'];
      ...
      if (isset($_POST['nmgp_opcao']) && 'ajax_navigate' == $_POST['nmgp_opcao'] && isset($_POST['opc']) && ('grid_search_res' == $_POST['opc'] || 'resumo_search' == $_POST['opc'])) {
       ...
       $nm_saida->saida("</TABLE>\r\n");
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['graf_bot'] = false;
       if ($bPDF && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['charts_html']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['charts_html'])
       {
           $nm_saida->saida("<script type=\"text/javascript\">\r\n");
           $nm_saida->saida("{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['charts_html']}\r\n");
           $nm_saida->saida("</script>\r\n");
...
//--- 
   ...
   {
      global $nm_saida;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
      ...
      { 
        ...
        if ($_SESSION['scriptcase']['charset'] != "UTF-8")
        {
          ...
          $range_umur = $Busca_temp['range_umur']; 
          $tmp_pos = strpos($range_umur, "##@@");
          if ($tmp_pos !== false && !is_array($range_umur))
          {
              $range_umur = substr($range_umur, 0, $tmp_pos);
          }
      ...
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['cond_pesq']))
      {  
          $pos       = 0;
          $trab_pos  = false;
          $pos_tmp   = true; 
          $tmp       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['cond_pesq'];
          while ($pos_tmp)
          {
             $pos = strpos($tmp, "##*@@", $pos);
             if ($pos !== false)
          ...
          $nm_cond_filtro_or  = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['cond_pesq'], $trab_pos + 5) == "or")  ? " " . trim($this->Ini->Nm_lang['lang_srch_orr_cond']) . " " : "";
          $nm_cond_filtro_and = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['cond_pesq'], $trab_pos + 5) == "and") ? " " . trim($this->Ini->Nm_lang['lang_srch_and_cond']) . " " : "";
          $nm_cab_filtro   = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['cond_pesq'], 0, $trab_pos);
     ...
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['proc_pdf_vert']) {
      ...
      $nm_saida->saida("    <div class=\"" . $this->css_scGridHeaderFont . "\" style=\"float: left; text-transform: uppercase;\">DATA DEMOGRAFI BERDASARKAN USIA</div>\r\n");
   ...
   //---- 
   function adiciona_registro($sum_jumlah, $quebra_range_umur, $quebra_range_umur_orig)
   {
      //----- Range Umur
      if (!isset($this->array_total_range_umur[$quebra_range_umur_orig]))
      {
         $this->array_total_range_umur[$quebra_range_umur_orig][0] = 1;
         $this->array_total_range_umur[$quebra_range_umur_orig][1] = $sum_jumlah;
         $this->array_total_range_umur[$quebra_range_umur_orig][2] = $quebra_range_umur;
         $this->array_total_range_umur[$quebra_range_umur_orig][3] = $quebra_range_umur_orig;
      }
      else
      {
         $this->array_total_range_umur[$quebra_range_umur_orig][0]++;
         $this->array_total_range_umur[$quebra_range_umur_orig][1] += $sum_jumlah;
      }
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     { 
         $nmgp_select = "SELECT range_umur, jumlah from (SELECT CASE 		 	WHEN 		umur <= 5 THEN 			'0 - 5'  			WHEN umur BETWEEN 6  			AND 19 THEN 				'6 - 19'  				WHEN umur BETWEEN 20  				AND 39 THEN 					'20 - 39'  					WHEN umur BETWEEN 41  					AND 49 THEN 						'41 - 49'  						WHEN umur BETWEEN 51  						AND 60 THEN 							'51 - 60'  							WHEN umur > 60 THEN 							'> dari 60'  							WHEN umur IS NULL THEN 							'(NULL)'  						END AS range_umur, 						COUNT( * ) AS jumlah  					FROM 						( SELECT custCode, NAME, birthDate, TIMESTAMPDIFF( YEAR, birthDate, CURDATE( ) ) AS umur FROM tbcustomer ) AS dummy_table  					GROUP BY 						range_umur  				) nm_sel_esp"; 
     } 
     ...
     $nmgp_select .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['where_pesq']; 
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('', 'range_umur');
     $campos_order = $this->Ini->Get_date_order_groupby("range_umur", 'asc', $format, $campos_order);
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->range_umur = $rs_res->fields[0] ;  
            $this->jumlah = $rs_res->fields[1] ;  
            $this->range_umur_orig = $this->range_umur;
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->jumlah, $this->range_umur, $this->range_umur_orig);
            }
   }
//
   ...
   function html_grid_search()
   {
       ...
       $str_display = empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['grid_pesq'])?'none':'';
       if(!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['ajax_nav'])
       {
          $nm_saida->saida("   <tr id=\"NM_Grid_Search\" ajax='' style='display:" . $str_display . "'>\r\n");
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['ajax_nav'] && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['grid_pesq']))
       { 
           $_SESSION['scriptcase']['saida_html'] = "";
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['grid_pesq'] as $cmp => $def)
           {
           ...
           if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['save_grid']))
           {
               return;
           }
           else
       ...
       $nm_saida->saida("            <input type=\"hidden\" name=\"parm\" value=\"\"/> \r\n");
            if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['grid_pesq']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['grid_pesq']))
            {
                foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['grid_pesq'] as $cmp => $def)
                {
                    if (isset($def['label'])) {
                        ...
                        if ($cmp == "range_umur")
                        {
                           $this->grid_search_dat[$this->grid_search_seq] = "range_umur";
                           $lin_obj = $this->grid_search_range_umur($this->grid_search_seq, 'N', $def['opc'], $def['val'], $def['label']);
                           $nm_saida->saida("" . $lin_obj . "\r\n");
                        }
                        if ($cmp == "jumlah")
                        {
       ...
       { 
           ...
           $_SESSION['scriptcase']['saida_html'] = "";
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['save_grid']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['grid_pesq']))
           { 
   ...
   {
       $lin_obj  = "";
       $All_cmp_search = array('range_umur','jumlah');
       $nmgp_tab_label = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['pesq_tab_label'];
       if (!empty($nmgp_tab_label))
       {
          $nm_tab_campos = explode("?@?", $nmgp_tab_label);
       ...
       if (count($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['grid_pesq']) < 2)
       {
           $lin_obj .= "<table id='id_grid_search_all_cmp' cellpadding=0 cellspacing=0>";
           foreach ($All_cmp_search as $cada_cmp)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_age']['grid_pesq'][$cada_cmp]))
               {
                   $lin_obj .= "  <tr>";
   ...
   function grid_search_range_umur($ind, $ajax, $opc="", $val=array(), $label='')
   {
       $lin_obj  = "";
       $lin_obj .= "     <div class='scGridFilterTagListFilter' id='grid_search_range_umur_" . $ind . "' style='display:none'>";
       ...
       $lin_obj .= "       <select id='grid_search_range_umur_cond_" . $ind . "' name='cond_grid_search_range_umur_" . $ind . "' class='" . $this->css_scAppDivToolbarInput . "' style='vertical-align: middle;' onChange='grid_search_hide_input(\"range_umur\", $ind)'>";
       ...
       $lin_obj .= "       <span id=\"grid_range_umur_" . $ind . "\" style=\"display:" . $display_in_1 . "\">";
       $val_cmp = (isset($val[0][0])) ? $val[0][0] : "";
       $range_umur = $val_cmp;
       if ($range_umur != "")
       {
       $range_umur_look = substr($this->Db->qstr($range_umur), 1, -1); 
       $nmgp_def_dados = array(); 
       $nm_comando = "select distinct range_umur from (SELECT CASE 		 	WHEN 		umur <= 5 THEN 			'0 - 5'  			WHEN umur BETWEEN 6  			AND 19 THEN 				'6 - 19'  				WHEN umur BETWEEN 20  				AND 39 THEN 					'20 - 39'  					WHEN umur BETWEEN 41  					AND 49 THEN 						'41 - 49'  						WHEN umur BETWEEN 51  						AND 60 THEN 							'51 - 60'  							WHEN umur > 60 THEN 							'> dari 60'  							WHEN umur IS NULL THEN 							'(NULL)'  						END AS range_umur, 						COUNT( * ) AS jumlah  					FROM 						( SELECT custCode, NAME, birthDate, TIMESTAMPDIFF( YEAR, birthDate, CURDATE( ) ) AS umur FROM tbcustomer ) AS dummy_table  					GROUP BY 						range_umur  				) nm_sel_esp where range_umur = '$range_umur_look'"; 
      ...
      if ($rs = $this->Db->SelectLimit($nm_comando, 10, 0)) 
       ...
       if (isset($nmgp_def_dados[0][$range_umur]))
       {
           $sAutocompValue = $nmgp_def_dados[0][$range_umur];
       }
       else
       {
       ...
       $val_cmp = (isset($val[0][0])) ? $val[0][0] : "";
       $lin_obj .= "     <input  type=\"text\" class='sc-js-input " . $this->css_scAppDivToolbarInput . "' id='grid_search_range_umur_val_" . $ind . "' name='val_grid_search_range_umur_" . $ind . "' value=\"" . NM_encode_input($val_cmp) . "\" size=27 alt=\"{datatype: 'text', maxLength: 27, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}\" style='display: none'>";
       $tmp_pos = strpos($val_cmp, "##@@");
       if ($tmp_pos !== false) {
           $val_cmp = substr($val_cmp, ($tmp_pos + 4));
           $sAutocompValue = substr($sAutocompValue, ($tmp_pos + 4));
       }
       $lin_obj .= "     <input class='sc-js-input " . $this->css_scAppDivToolbarInput . "' type='text' id='id_ac_grid_range_umur" . $ind . "' name='val_grid_search_range_umur_autocomp" . $ind . "' size='27' value='" . NM_encode_input($sAutocompValue) . "' alt=\"{datatype: 'text', maxLength: 27, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}\">";
       $lin_obj .= "       </span>";
       $lin_obj .= "          </div>";
   ...
   function grid_search_jumlah($ind, $ajax, $opc="", $val=array(), $label='')
   {
       ...
       $lin_obj .= "     <input  type=\"text\" class='sc-js-input " . $this->css_scAppDivToolbarInput . "' id='grid_search_jumlah_val_" . $ind . "' name='val_grid_search_jumlah_" . $ind . "' value=\"" . NM_encode_input($val_cmp) . "\" size=19 alt=\"{datatype: 'decimal', maxLength: 19, precision: 0, decimalSep: '" . $_SESSION['scriptcase']['reg_conf']['dec_num'] . "', thousandsSep: '" . $_SESSION['scriptcase']['reg_conf']['grup_num'] . "', allowNegative: false, onlyNegative: false, enterTab: false}\">";
       $lin_obj .= "       </span>";
       $lin_obj .= "          </div>";
       $lin_obj .= "          <div class='scGridFilterTagListFilterBar'>";
       $lin_obj .= nmButtonOutput($this->arr_buttons, "bapply_appdiv", "closeAllTags();setTimeout(function() {nm_proc_grid_search($ind, 'proc_grid_search', 'grid_search_res')}, 200);", "closeAllTags();setTimeout(function() {nm_proc_grid_search($ind, 'proc_grid_search', 'grid_search_res')}, 200);", "grid_search_apply_" . $ind . "", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
   ...
   function lookup_ajax_range_umur($range_umur)
   {
       $range_umur = substr($this->Db->qstr($range_umur), 1, -1);
       $this->NM_case_insensitive = false;
       $range_umur_look = substr($this->Db->qstr($range_umur), 1, -1); 
       $nmgp_def_dados = array(); 
       $nm_comando = "select distinct range_umur from (SELECT CASE 		 	WHEN 		umur <= 5 THEN 			'0 - 5'  			WHEN umur BETWEEN 6  			AND 19 THEN 				'6 - 19'  				WHEN umur BETWEEN 20  				AND 39 THEN 					'20 - 39'  					WHEN umur BETWEEN 41  					AND 49 THEN 						'41 - 49'  						WHEN umur BETWEEN 51  						AND 60 THEN 							'51 - 60'  							WHEN umur > 60 THEN 							'> dari 60'  							WHEN umur IS NULL THEN 							'(NULL)'  						END AS range_umur, 						COUNT( * ) AS jumlah  					FROM 						( SELECT custCode, NAME, birthDate, TIMESTAMPDIFF( YEAR, birthDate, CURDATE( ) ) AS umur FROM tbcustomer ) AS dummy_table  					GROUP BY 						range_umur  				) nm_sel_esp where  range_umur like '%" . $range_umur . "%'"; 
       $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
       $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->SelectLimit($nm_comando, 10, 0)) 
       { 
          ...
          { 
            ...
            $cmp1 = grid_lap_demo_age_pack_protect_string($cmp1);
            $nmgp_def_dados[] = array($cmp1 => $cmp1); 
             $rs->MoveNext(); 
          } 
          $rs->Close(); 
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "simrskreatifmedia/grid_lap_demo_age";
   ...
   function JS_grid_search()
   {
       ...
       $nm_saida->saida("             {\r\n");
       $nm_saida->saida("                 tmp = Tab_obj_grid_search[i];\r\n");
       $nm_saida->saida("                 if (tmp == 'range_umur')\r\n");
       $nm_saida->saida("                 {\r\n");
       $nm_saida->saida("                      var x_range_umur = i;\r\n");
       $nm_saida->saida("                      $(\"#id_ac_grid_range_umur\" + i).autocomplete({\r\n");
       ...
       $nm_saida->saida("                             field: \"range_umur\",\r\n");
       ...
       $nm_saida->saida("                          $(\"#grid_search_range_umur_val_\" + x_range_umur).val(ui.item.value);\r\n");
       ...
       $nm_saida->saida("                             $(\"#grid_search_range_umur_val_\" + x_range_umur).val( $(this).val() );\r\n");
       $nm_saida->saida("                          }\r\n");
       $nm_saida->saida("                        }\r\n");
       $nm_saida->saida("                      });\r\n");
       $nm_saida->saida("                 }\r\n");
       ...
       $nm_saida->saida("                 if (Tab_obj_grid_search[i] == 'range_umur')\r\n");
       $nm_saida->saida("                 {\r\n");
