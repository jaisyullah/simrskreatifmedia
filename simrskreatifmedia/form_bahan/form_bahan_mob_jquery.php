...
function displayChange_field_detailstok(row, status) {
	if ("on" == status && typeof $("#nmsc_iframe_liga_form_stock_gizi_mob")[0].contentWindow.scRecreateSelect2 === "function") {
		$("#nmsc_iframe_liga_form_stock_gizi_mob")[0].contentWindow.scRecreateSelect2();
	}
}

function displayChange_field_historyharga(row, status) {
	if ("on" == status && typeof $("#nmsc_iframe_liga_form_hisharga_gizi_mob")[0].contentWindow.scRecreateSelect2 === "function") {
		$("#nmsc_iframe_liga_form_hisharga_gizi_mob")[0].contentWindow.scRecreateSelect2();
	}
}
...
function scHidePage(pageNo) {
	$("#id_form_bahan_mob_form" + pageNo).hide();
}
