  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_bahan" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_bahan_form();
	}

  // ---------- Validate bahancode
  function do_ajax_form_bahan_validate_bahancode()
  {
    var nomeCampo_bahancode = "bahancode";
    var var_bahancode = scAjaxGetFieldText(nomeCampo_bahancode);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_bahan_validate_bahancode(var_bahancode, var_script_case_init, do_ajax_form_bahan_validate_bahancode_cb);
  } // do_ajax_form_bahan_validate_bahancode

  function do_ajax_form_bahan_validate_bahancode_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_bahan_validate_bahancode_cb

  // ---------- Validate nama
  function do_ajax_form_bahan_validate_nama()
  {
    var nomeCampo_nama = "nama";
    var var_nama = scAjaxGetFieldText(nomeCampo_nama);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_bahan_validate_nama(var_nama, var_script_case_init, do_ajax_form_bahan_validate_nama_cb);
  } // do_ajax_form_bahan_validate_nama

  function do_ajax_form_bahan_validate_nama_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nama";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_bahan_validate_nama_cb

  // ---------- Validate kategori
  function do_ajax_form_bahan_validate_kategori()
  {
    var nomeCampo_kategori = "kategori";
    var var_kategori = scAjaxGetFieldSelect(nomeCampo_kategori);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_bahan_validate_kategori(var_kategori, var_script_case_init, do_ajax_form_bahan_validate_kategori_cb);
  } // do_ajax_form_bahan_validate_kategori

  function do_ajax_form_bahan_validate_kategori_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_bahan_validate_kategori_cb

  // ---------- Validate jenis
  function do_ajax_form_bahan_validate_jenis()
  {
    var nomeCampo_jenis = "jenis";
    var var_jenis = scAjaxGetFieldSelect(nomeCampo_jenis);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_bahan_validate_jenis(var_jenis, var_script_case_init, do_ajax_form_bahan_validate_jenis_cb);
  } // do_ajax_form_bahan_validate_jenis

  function do_ajax_form_bahan_validate_jenis_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "jenis";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_bahan_validate_jenis_cb

  // ---------- Validate satuan
  function do_ajax_form_bahan_validate_satuan()
  {
    var nomeCampo_satuan = "satuan";
    var var_satuan = scAjaxGetFieldSelect(nomeCampo_satuan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_bahan_validate_satuan(var_satuan, var_script_case_init, do_ajax_form_bahan_validate_satuan_cb);
  } // do_ajax_form_bahan_validate_satuan

  function do_ajax_form_bahan_validate_satuan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "satuan";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_bahan_validate_satuan_cb

  // ---------- Validate keterangan
  function do_ajax_form_bahan_validate_keterangan()
  {
    var nomeCampo_keterangan = "keterangan";
    var var_keterangan = scAjaxGetFieldText(nomeCampo_keterangan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_bahan_validate_keterangan(var_keterangan, var_script_case_init, do_ajax_form_bahan_validate_keterangan_cb);
  } // do_ajax_form_bahan_validate_keterangan

  function do_ajax_form_bahan_validate_keterangan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_bahan_validate_keterangan_cb

  // ---------- Validate aktif
  function do_ajax_form_bahan_validate_aktif()
  {
    var nomeCampo_aktif = "aktif";
    var var_aktif = scAjaxGetFieldRadio(nomeCampo_aktif);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_bahan_validate_aktif(var_aktif, var_script_case_init, do_ajax_form_bahan_validate_aktif_cb);
  } // do_ajax_form_bahan_validate_aktif

  function do_ajax_form_bahan_validate_aktif_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "aktif";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_bahan_validate_aktif_cb

  // ---------- Validate detailstok
  function do_ajax_form_bahan_validate_detailstok()
  {
    var nomeCampo_detailstok = "detailstok";
    var var_detailstok = scAjaxGetFieldText(nomeCampo_detailstok);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_bahan_validate_detailstok(var_detailstok, var_script_case_init, do_ajax_form_bahan_validate_detailstok_cb);
  } // do_ajax_form_bahan_validate_detailstok

  function do_ajax_form_bahan_validate_detailstok_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_bahan_validate_detailstok_cb

  // ---------- Validate historyharga
  function do_ajax_form_bahan_validate_historyharga()
  {
    var nomeCampo_historyharga = "historyharga";
    var var_historyharga = scAjaxGetFieldText(nomeCampo_historyharga);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_bahan_validate_historyharga(var_historyharga, var_script_case_init, do_ajax_form_bahan_validate_historyharga_cb);
  } // do_ajax_form_bahan_validate_historyharga

  function do_ajax_form_bahan_validate_historyharga_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_bahan_validate_historyharga_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_bahan_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_bahan_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_bahan_submit_form(var_bahancode, var_nama, var_kategori, var_jenis, var_satuan, var_keterangan, var_aktif, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_bahan_submit_form_cb);
  } // do_ajax_form_bahan_submit_form

  function do_ajax_form_bahan_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_bahan_submit_form_cb_after_alert);
  } // do_ajax_form_bahan_submit_form_cb
  function do_ajax_form_bahan_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_bahan_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_stock_gizi"] = "off";
  scStatusDetail["form_hisharga_gizi"] = "off";

  function do_ajax_form_bahan_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    scStatusDetail["form_stock_gizi"] = "on";
    scStatusDetail["form_hisharga_gizi"] = "on";
    x_ajax_form_bahan_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_bahan_navigate_form_cb);
  } // do_ajax_form_bahan_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_bahan']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_bahan_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_stock_gizi"] && "nmsc_iframe_liga_form_stock_gizi" != scMasterDetailIframe["nmsc_iframe_liga_form_stock_gizi"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_stock_gizi"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_stock_gizi').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_stock_gizi').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_stock_gizi').style.display = "none";
    }
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_hisharga_gizi"] && "nmsc_iframe_liga_form_hisharga_gizi" != scMasterDetailIframe["nmsc_iframe_liga_form_hisharga_gizi"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_hisharga_gizi"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_hisharga_gizi').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_hisharga_gizi').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_hisharga_gizi').style.display = "none";
    }
    scAjaxSetBtnVars();
    sc_change_tabs(true, 'hidden_bloco_1', 'id_tabs_1_1');
    sc_change_tabs(false, 'hidden_bloco_2', 'id_tabs_1_2');
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_bahan_navigate_form_cb_after_alert);
  } // do_ajax_form_bahan_navigate_form_cb
  function do_ajax_form_bahan_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_bahan_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_bahan_navigate_form_cb_after_alert
  function sc_hide_form_bahan_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_stock_gizi"] && "off" == scStatusDetail["form_hisharga_gizi"])
    {
      return true;
    }
    return false;
