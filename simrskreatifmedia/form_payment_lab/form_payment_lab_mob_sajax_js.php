  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_payment_lab_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_payment_lab_mob_form();
	}

  // ---------- Validate trancode
  function do_ajax_form_payment_lab_mob_validate_trancode()
  {
    var nomeCampo_trancode = "trancode";
    var var_trancode = scAjaxGetFieldText(nomeCampo_trancode);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_payment_lab_mob_validate_trancode(var_trancode, var_script_case_init, do_ajax_form_payment_lab_mob_validate_trancode_cb);
  } // do_ajax_form_payment_lab_mob_validate_trancode

  function do_ajax_form_payment_lab_mob_validate_trancode_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_payment_lab_mob_validate_trancode_cb

  // ---------- Validate nostruk
  function do_ajax_form_payment_lab_mob_validate_nostruk()
  {
    var nomeCampo_nostruk = "nostruk";
    var var_nostruk = scAjaxGetFieldSelect(nomeCampo_nostruk);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_payment_lab_mob_validate_nostruk(var_nostruk, var_script_case_init, do_ajax_form_payment_lab_mob_validate_nostruk_cb);
  } // do_ajax_form_payment_lab_mob_validate_nostruk

  function do_ajax_form_payment_lab_mob_validate_nostruk_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nostruk";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_payment_lab_mob_validate_nostruk_cb

  // ---------- Validate custcode
  function do_ajax_form_payment_lab_mob_validate_custcode()
  {
    var nomeCampo_custcode = "custcode";
    var var_custcode = scAjaxGetFieldSelect(nomeCampo_custcode);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_payment_lab_mob_validate_custcode(var_custcode, var_script_case_init, do_ajax_form_payment_lab_mob_validate_custcode_cb);
  } // do_ajax_form_payment_lab_mob_validate_custcode

  function do_ajax_form_payment_lab_mob_validate_custcode_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_payment_lab_mob_validate_custcode_cb

  // ---------- Validate sc_field_1
  function do_ajax_form_payment_lab_mob_validate_sc_field_1()
  {
    var nomeCampo_sc_field_1 = "sc_field_1";
    var var_sc_field_1 = scAjaxGetFieldSelect(nomeCampo_sc_field_1);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_payment_lab_mob_validate_sc_field_1(var_sc_field_1, var_script_case_init, do_ajax_form_payment_lab_mob_validate_sc_field_1_cb);
  } // do_ajax_form_payment_lab_mob_validate_sc_field_1

  function do_ajax_form_payment_lab_mob_validate_sc_field_1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_payment_lab_mob_validate_sc_field_1_cb

  // ---------- Validate dokter
  function do_ajax_form_payment_lab_mob_validate_dokter()
  {
    var nomeCampo_dokter = "dokter";
    var var_dokter = scAjaxGetFieldSelect(nomeCampo_dokter);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_payment_lab_mob_validate_dokter(var_dokter, var_script_case_init, do_ajax_form_payment_lab_mob_validate_dokter_cb);
  } // do_ajax_form_payment_lab_mob_validate_dokter

  function do_ajax_form_payment_lab_mob_validate_dokter_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "dokter";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_payment_lab_mob_validate_dokter_cb

  // ---------- Validate jmltagihan
  function do_ajax_form_payment_lab_mob_validate_jmltagihan()
  {
    var nomeCampo_jmltagihan = "jmltagihan";
    var var_jmltagihan = scAjaxGetFieldText(nomeCampo_jmltagihan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_payment_lab_mob_validate_jmltagihan(var_jmltagihan, var_script_case_init, do_ajax_form_payment_lab_mob_validate_jmltagihan_cb);
  } // do_ajax_form_payment_lab_mob_validate_jmltagihan

  function do_ajax_form_payment_lab_mob_validate_jmltagihan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_payment_lab_mob_validate_jmltagihan_cb

  // ---------- Validate jmlbayar
  function do_ajax_form_payment_lab_mob_validate_jmlbayar()
  {
    var nomeCampo_jmlbayar = "jmlbayar";
    var var_jmlbayar = scAjaxGetFieldText(nomeCampo_jmlbayar);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_payment_lab_mob_validate_jmlbayar(var_jmlbayar, var_script_case_init, do_ajax_form_payment_lab_mob_validate_jmlbayar_cb);
  } // do_ajax_form_payment_lab_mob_validate_jmlbayar

  function do_ajax_form_payment_lab_mob_validate_jmlbayar_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_payment_lab_mob_validate_jmlbayar_cb

  // ---------- Validate deposit
  function do_ajax_form_payment_lab_mob_validate_deposit()
  {
    var nomeCampo_deposit = "deposit";
    var var_deposit = scAjaxGetFieldText(nomeCampo_deposit);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_payment_lab_mob_validate_deposit(var_deposit, var_script_case_init, do_ajax_form_payment_lab_mob_validate_deposit_cb);
  } // do_ajax_form_payment_lab_mob_validate_deposit

  function do_ajax_form_payment_lab_mob_validate_deposit_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "deposit";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_payment_lab_mob_validate_deposit_cb

  // ---------- Validate potongan
  function do_ajax_form_payment_lab_mob_validate_potongan()
  {
    var nomeCampo_potongan = "potongan";
    var var_potongan = scAjaxGetFieldText(nomeCampo_potongan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_payment_lab_mob_validate_potongan(var_potongan, var_script_case_init, do_ajax_form_payment_lab_mob_validate_potongan_cb);
  } // do_ajax_form_payment_lab_mob_validate_potongan

  function do_ajax_form_payment_lab_mob_validate_potongan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_payment_lab_mob_validate_potongan_cb

  // ---------- Validate hrsdibayar
  function do_ajax_form_payment_lab_mob_validate_hrsdibayar()
  {
    var nomeCampo_hrsdibayar = "hrsdibayar";
    var var_hrsdibayar = scAjaxGetFieldText(nomeCampo_hrsdibayar);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_payment_lab_mob_validate_hrsdibayar(var_hrsdibayar, var_script_case_init, do_ajax_form_payment_lab_mob_validate_hrsdibayar_cb);
  } // do_ajax_form_payment_lab_mob_validate_hrsdibayar

  function do_ajax_form_payment_lab_mob_validate_hrsdibayar_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_payment_lab_mob_validate_hrsdibayar_cb

  // ---------- Validate terimadari
  function do_ajax_form_payment_lab_mob_validate_terimadari()
  {
    var nomeCampo_terimadari = "terimadari";
    var var_terimadari = scAjaxGetFieldSelect(nomeCampo_terimadari);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_payment_lab_mob_validate_terimadari(var_terimadari, var_script_case_init, do_ajax_form_payment_lab_mob_validate_terimadari_cb);
  } // do_ajax_form_payment_lab_mob_validate_terimadari

  function do_ajax_form_payment_lab_mob_validate_terimadari_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_payment_lab_mob_validate_terimadari_cb

  // ---------- Validate jenispayment
  function do_ajax_form_payment_lab_mob_validate_jenispayment()
  {
    var nomeCampo_jenispayment = "jenispayment";
    var var_jenispayment = scAjaxGetFieldSelect(nomeCampo_jenispayment);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_payment_lab_mob_validate_jenispayment(var_jenispayment, var_script_case_init, do_ajax_form_payment_lab_mob_validate_jenispayment_cb);
  } // do_ajax_form_payment_lab_mob_validate_jenispayment

  function do_ajax_form_payment_lab_mob_validate_jenispayment_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_payment_lab_mob_validate_jenispayment_cb

  // ---------- Validate instansipenjamin
  function do_ajax_form_payment_lab_mob_validate_instansipenjamin()
  {
    var nomeCampo_instansipenjamin = "instansipenjamin";
    var var_instansipenjamin = scAjaxGetFieldText(nomeCampo_instansipenjamin);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_payment_lab_mob_validate_instansipenjamin(var_instansipenjamin, var_script_case_init, do_ajax_form_payment_lab_mob_validate_instansipenjamin_cb);
  } // do_ajax_form_payment_lab_mob_validate_instansipenjamin

  function do_ajax_form_payment_lab_mob_validate_instansipenjamin_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_payment_lab_mob_validate_instansipenjamin_cb

  // ---------- Validate bankdebit
  function do_ajax_form_payment_lab_mob_validate_bankdebit()
  {
    var nomeCampo_bankdebit = "bankdebit";
    var var_bankdebit = scAjaxGetFieldText(nomeCampo_bankdebit);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_payment_lab_mob_validate_bankdebit(var_bankdebit, var_script_case_init, do_ajax_form_payment_lab_mob_validate_bankdebit_cb);
  } // do_ajax_form_payment_lab_mob_validate_bankdebit

  function do_ajax_form_payment_lab_mob_validate_bankdebit_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_payment_lab_mob_validate_bankdebit_cb

  // ---------- Validate nokartu
  function do_ajax_form_payment_lab_mob_validate_nokartu()
  {
    var nomeCampo_nokartu = "nokartu";
    var var_nokartu = scAjaxGetFieldText(nomeCampo_nokartu);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_payment_lab_mob_validate_nokartu(var_nokartu, var_script_case_init, do_ajax_form_payment_lab_mob_validate_nokartu_cb);
  } // do_ajax_form_payment_lab_mob_validate_nokartu

  function do_ajax_form_payment_lab_mob_validate_nokartu_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nokartu";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_payment_lab_mob_validate_nokartu_cb

  // ---------- Validate sc_field_0
  function do_ajax_form_payment_lab_mob_validate_sc_field_0()
  {
    var nomeCampo_sc_field_0 = "sc_field_0";
    var var_sc_field_0 = scAjaxGetFieldText(nomeCampo_sc_field_0);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_payment_lab_mob_validate_sc_field_0(var_sc_field_0, var_script_case_init, do_ajax_form_payment_lab_mob_validate_sc_field_0_cb);
  } // do_ajax_form_payment_lab_mob_validate_sc_field_0

  function do_ajax_form_payment_lab_mob_validate_sc_field_0_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_payment_lab_mob_validate_sc_field_0_cb

  // ---------- Validate detailpemeriksaan
  function do_ajax_form_payment_lab_mob_validate_detailpemeriksaan()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_payment_lab_mob_validate_detailpemeriksaan(var_detailpemeriksaan, var_script_case_init, do_ajax_form_payment_lab_mob_validate_detailpemeriksaan_cb);
  } // do_ajax_form_payment_lab_mob_validate_detailpemeriksaan

  function do_ajax_form_payment_lab_mob_validate_detailpemeriksaan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_payment_lab_mob_validate_detailpemeriksaan_cb

  // ---------- Refresh trancode
  function do_ajax_form_payment_lab_mob_refresh_trancode()
  {
    ...
    scAjaxProcOn(true);
    x_ajax_form_payment_lab_mob_refresh_trancode(var_trancode, var_custcode, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_payment_lab_mob_refresh_trancode_cb);
  } // do_ajax_form_payment_lab_mob_refresh_trancode

  function do_ajax_form_payment_lab_mob_refresh_trancode_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_payment_lab_mob_refresh_trancode_cb

  // ---------- Event onclick scajaxbutton_sc_btn_1
  function do_ajax_form_payment_lab_mob_event_scajaxbutton_sc_btn_1_onclick()
  {
    var var_trancode = scAjaxGetFieldText("trancode");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_payment_lab_mob_event_scajaxbutton_sc_btn_1_onclick(var_trancode, var_jmltagihan, var_hrsdibayar, var_deposit, var_jmlbayar, var_potongan, var_script_case_init, do_ajax_form_payment_lab_mob_event_scajaxbutton_sc_btn_1_onclick_cb);
  } // do_ajax_form_payment_lab_mob_event_scajaxbutton_sc_btn_1_onclick

  function do_ajax_form_payment_lab_mob_event_scajaxbutton_sc_btn_1_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_payment_lab_mob_event_scajaxbutton_sc_btn_1_onclick_cb_after_alert);
  } // do_ajax_form_payment_lab_mob_event_scajaxbutton_sc_btn_1_onclick_cb
  function do_ajax_form_payment_lab_mob_event_scajaxbutton_sc_btn_1_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_payment_lab_mob_event_scajaxbutton_sc_btn_1_onclick_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_payment_lab_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_payment_lab_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_trancode = scAjaxGetFieldText("trancode");
    ...
    scAjaxProcOn();
    x_ajax_form_payment_lab_mob_submit_form(var_trancode, var_nostruk, var_custcode, var_sc_field_1, var_dokter, var_jmltagihan, var_jmlbayar, var_deposit, var_potongan, var_hrsdibayar, var_terimadari, var_jenispayment, var_instansipenjamin, var_bankdebit, var_nokartu, var_sc_field_0, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_payment_lab_mob_submit_form_cb);
  } // do_ajax_form_payment_lab_mob_submit_form

  function do_ajax_form_payment_lab_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_payment_lab_mob_submit_form_cb_after_alert);
  } // do_ajax_form_payment_lab_mob_submit_form_cb
  function do_ajax_form_payment_lab_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_payment_lab_mob_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_tbdetaillab_mob"] = "off";

  function do_ajax_form_payment_lab_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    x_ajax_form_payment_lab_mob_navigate_form(var_trancode, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_payment_lab_mob_navigate_form_cb);
  } // do_ajax_form_payment_lab_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_lab_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_payment_lab_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_payment_lab_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_payment_lab_mob_navigate_form_cb
  function do_ajax_form_payment_lab_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_payment_lab_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_payment_lab_mob_navigate_form_cb_after_alert
  function sc_hide_form_payment_lab_mob_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_tbdetaillab_mob"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[16] = "detailpemeriksaan";
