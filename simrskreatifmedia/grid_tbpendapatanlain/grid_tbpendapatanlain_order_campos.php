...
<?php
   ...
   $Ord_Cmp = new grid_tbpendapatanlain_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_tbpendapatanlain_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbpendapatanlain']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tbpendapatanlain']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["trandate"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbpendapatanlain']['labels']["trandate"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbpendapatanlain']['labels']["trandate"] : "Tgl. Transaksi";
   $tab_ger_campos['trancode'] = "on";
   $tab_def_campos['trancode'] = "trancode";
   $tab_labels["trancode"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbpendapatanlain']['labels']["trancode"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbpendapatanlain']['labels']["trancode"] : "Kode Transaksi";
   $tab_ger_campos['jenis'] = "on";
   $tab_def_campos['jenis'] = "jenis";
   $tab_labels["jenis"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbpendapatanlain']['labels']["jenis"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbpendapatanlain']['labels']["jenis"] : "Jenis Pembayaran";
   $tab_ger_campos['keterangan'] = "on";
   $tab_def_campos['keterangan'] = "keterangan";
   $tab_labels["keterangan"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbpendapatanlain']['labels']["keterangan"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbpendapatanlain']['labels']["keterangan"] : "Keterangan";
   $tab_ger_campos['dari'] = "on";
   $tab_def_campos['dari'] = "dari";
   $tab_labels["dari"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbpendapatanlain']['labels']["dari"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbpendapatanlain']['labels']["dari"] : "Terima Dari";
   $tab_ger_campos['total'] = "on";
   $tab_def_campos['total'] = "total";
   $tab_labels["total"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbpendapatanlain']['labels']["total"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbpendapatanlain']['labels']["total"] : "Jumlah";
   $tab_ger_campos['kasir'] = "on";
   $tab_def_campos['kasir'] = "kasir";
   $tab_labels["kasir"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbpendapatanlain']['labels']["kasir"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbpendapatanlain']['labels']["kasir"] : "Kasir";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_tbpendapatanlain']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_tbpendapatanlain']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_tbpendapatanlain']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbpendapatanlain']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tbpendapatanlain']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_tbpendapatanlain']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_tbpendapatanlain']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_tbpendapatanlain']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_tbpendapatanlain']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_tbpendapatanlain_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_tbpendapatanlain']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_tbpendapatanlain']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_tbpendapatanlain']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_tbpendapatanlain']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_tbpendapatanlain']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
