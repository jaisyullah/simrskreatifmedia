<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tbpendapatanlain']['sc_process_barr'] = true;
require_once('../grid_tbpendapatanlain/index.php');
unset($_SESSION['scriptcase']['grid_tbpendapatanlain']['sc_process_barr']);
$ExportCtrl = new grid_tbpendapatanlain_export_control;
$ExportCtrl->Export_barr();

class grid_tbpendapatanlain_export_control
{
