...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "trandate";$Nm_datas[] = "trandate";$Nm_numeric[] = "total";$Nm_numeric[] = "deleted";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_dari_cond" name="dari_cond" onChange="nm_campos_between(document.getElementById('id_vis_dari'), this, 'dari')">
      ...
      <br><span id="id_hide_dari"  <?php echo $str_hide_dari?>><?php
      if ($dari != "")
      {
      $dari_look = substr($this->Db->qstr($dari), 1, -1); 
      $nmgp_def_dados = array(); 
