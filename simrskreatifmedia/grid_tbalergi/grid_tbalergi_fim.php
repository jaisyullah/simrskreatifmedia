...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_tbalergi"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_tbalergi"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_tbalergi'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tbalergi']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_tbalergi']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tbalergi']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_tbalergi']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_tbalergi']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_tbalergi']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_tbalergi']['embutida_filho'] as $ind => $sc_init)
          {
