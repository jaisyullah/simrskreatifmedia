...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "alergi";$Nm_numeric[] = "note";$Nm_numeric[] = "alergi";$Nm_numeric[] = "note";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_note_cond" name="note_cond" onChange="nm_campos_between(document.getElementById('id_vis_note'), this, 'note')">
      ...
      <br><span id="id_hide_note"  <?php echo $str_hide_note?>><?php
      if ($note != "")
      {
      $note_look = substr($this->Db->qstr($note), 1, -1); 
      $nmgp_def_dados = array(); 
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      ...
      <br><span id="id_hide_description"  <?php echo $str_hide_description?>><?php
      if ($description != "")
      {
      $description_look = substr($this->Db->qstr($description), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_alergi_cond" name="alergi_cond" onChange="nm_campos_between(document.getElementById('id_vis_alergi'), this, 'alergi')">
      ...
      <br><span id="id_hide_alergi"  <?php echo $str_hide_alergi?>><?php
      if ($alergi != "")
      {
      $alergi_look = substr($this->Db->qstr($alergi), 1, -1); 
      $nmgp_def_dados = array(); 
