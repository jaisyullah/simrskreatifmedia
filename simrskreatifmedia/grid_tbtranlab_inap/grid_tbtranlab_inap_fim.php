...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_tbtranlab_inap"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_tbtranlab_inap"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tbtranlab_inap']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_tbtranlab_inap']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tbtranlab_inap']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_tbtranlab_inap']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_tbtranlab_inap']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_tbtranlab_inap</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_tbtranlab_inap']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_tbtranlab_inap']['embutida_filho'] as $ind => $sc_init)
          {
