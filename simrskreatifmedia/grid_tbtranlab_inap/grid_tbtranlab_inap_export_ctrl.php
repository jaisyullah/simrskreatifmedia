<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tbtranlab_inap']['sc_process_barr'] = true;
require_once('../grid_tbtranlab_inap/index.php');
unset($_SESSION['scriptcase']['grid_tbtranlab_inap']['sc_process_barr']);
$ExportCtrl = new grid_tbtranlab_inap_export_control;
$ExportCtrl->Export_barr();

class grid_tbtranlab_inap_export_control
{
