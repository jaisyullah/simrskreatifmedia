...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_name"  <?php echo $str_hide_name?>><INPUT  type="text" id="SC_name" name="name" value="<?php echo NM_encode_input($name) ?>"  size=25 alt="{datatype: 'text', maxLength: 40, allowedChars: '', lettersCase: 'upper', autoTab: false, enterTab: false}" onChange="nm_submit_form()" class="sc-js-input scFilterObjectEven">
 </TD>
