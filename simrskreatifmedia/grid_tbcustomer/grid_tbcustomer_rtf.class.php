...
class grid_tbcustomer_rtf
{
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "grid_tbcustomer.rtf";
   }
   //---- 
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      $nm_raiz_img  = ""; 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcustomer']['rtf_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcustomer']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcustomer']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcustomer']['rtf_name']);
      }
...
$_SESSION['scriptcase']['grid_tbcustomer']['contr_erro'] = 'off'; 
   ...
   {
         if (!NM_is_utf8($this->hismedis))
         {
             $this->hismedis = sc_convert_encoding($this->hismedis, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->hismedis = str_replace('<', '&lt;', $this->hismedis);
         $this->hismedis = str_replace('>', '&gt;', $this->hismedis);
         $this->Texto_tag .= "<td>" . $this->hismedis . "</td>\r\n";
   }
   //----- identitas
   function NM_export_identitas()
   {
         if (!NM_is_utf8($this->identitas))
         {
             $this->identitas = sc_convert_encoding($this->identitas, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->identitas = str_replace('<', '&lt;', $this->identitas);
         $this->identitas = str_replace('>', '&gt;', $this->identitas);
         $this->Texto_tag .= "<td>" . $this->identitas . "</td>\r\n";
   }
   //----- name
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcustomer']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbcustomer']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - Identitas Pasien :: RTF</TITLE>
