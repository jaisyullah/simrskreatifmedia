...
//  
   function lookup_typename(&$conteudo , $typename) 
   {   
      ...
      $nm_comando = "select name from tbinstansi where instCode = '" . substr($this->Db->qstr($typename), 1 , -1) . "' order by name" ; 
      $conteudo = "" ; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rx = $this->Db->Execute($nm_comando)) 
