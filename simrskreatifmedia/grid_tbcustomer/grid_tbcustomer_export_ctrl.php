<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tbcustomer']['sc_process_barr'] = true;
require_once('../grid_tbcustomer/index.php');
unset($_SESSION['scriptcase']['grid_tbcustomer']['sc_process_barr']);
$ExportCtrl = new grid_tbcustomer_export_control;
$ExportCtrl->Export_barr();

class grid_tbcustomer_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - Identitas Pasien :: Excel</TITLE>
