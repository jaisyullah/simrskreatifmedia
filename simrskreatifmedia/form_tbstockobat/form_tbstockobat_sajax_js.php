  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbstockobat" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbstockobat_form();
	}

  // ---------- Validate id_
  function do_ajax_form_tbstockobat_validate_id_(iNumLinha)
  {
    var nomeCampo_id_ = "id_" + iNumLinha;
    var var_id_ = scAjaxGetFieldHidden(nomeCampo_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbstockobat_validate_id_(var_id_, iNumLinha, var_script_case_init, do_ajax_form_tbstockobat_validate_id__cb);
  } // do_ajax_form_tbstockobat_validate_id_

  function do_ajax_form_tbstockobat_validate_id__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbstockobat_validate_id__cb

  // ---------- Validate kodeitem_
  function do_ajax_form_tbstockobat_validate_kodeitem_(iNumLinha)
  {
    var nomeCampo_kodeitem_ = "kodeitem_" + iNumLinha;
    var var_kodeitem_ = scAjaxGetFieldSelect(nomeCampo_kodeitem_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbstockobat_validate_kodeitem_(var_kodeitem_, iNumLinha, var_script_case_init, do_ajax_form_tbstockobat_validate_kodeitem__cb);
  } // do_ajax_form_tbstockobat_validate_kodeitem_

  function do_ajax_form_tbstockobat_validate_kodeitem__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "kodeitem_" + iLineNumber;
    }
    else
    {
      sFieldValid = "kodeitem_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "kodeitem_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "kodeitem_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbstockobat_validate_kodeitem__cb

  // ---------- Validate satuan_
  function do_ajax_form_tbstockobat_validate_satuan_(iNumLinha)
  {
    var nomeCampo_satuan_ = "satuan_" + iNumLinha;
    var var_satuan_ = scAjaxGetFieldSelect(nomeCampo_satuan_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbstockobat_validate_satuan_(var_satuan_, iNumLinha, var_script_case_init, do_ajax_form_tbstockobat_validate_satuan__cb);
  } // do_ajax_form_tbstockobat_validate_satuan_

  function do_ajax_form_tbstockobat_validate_satuan__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbstockobat_validate_satuan__cb

  // ---------- Validate currentstock_
  function do_ajax_form_tbstockobat_validate_currentstock_(iNumLinha)
  {
    var nomeCampo_currentstock_ = "currentstock_" + iNumLinha;
    var var_currentstock_ = scAjaxGetFieldText(nomeCampo_currentstock_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbstockobat_validate_currentstock_(var_currentstock_, iNumLinha, var_script_case_init, do_ajax_form_tbstockobat_validate_currentstock__cb);
  } // do_ajax_form_tbstockobat_validate_currentstock_

  function do_ajax_form_tbstockobat_validate_currentstock__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "currentstock_" + iLineNumber;
    }
    else
    {
      sFieldValid = "currentstock_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "currentstock_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "currentstock_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbstockobat_validate_currentstock__cb

  // ---------- Validate depo_
  function do_ajax_form_tbstockobat_validate_depo_(iNumLinha)
  {
    var nomeCampo_depo_ = "depo_" + iNumLinha;
    var var_depo_ = scAjaxGetFieldSelect(nomeCampo_depo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbstockobat_validate_depo_(var_depo_, iNumLinha, var_script_case_init, do_ajax_form_tbstockobat_validate_depo__cb);
  } // do_ajax_form_tbstockobat_validate_depo_

  function do_ajax_form_tbstockobat_validate_depo__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "depo_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "depo_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbstockobat_validate_depo__cb

  // ---------- Validate expdate_
  function do_ajax_form_tbstockobat_validate_expdate_(iNumLinha)
  {
    var nomeCampo_expdate_ = "expdate_" + iNumLinha;
    var var_expdate_ = scAjaxGetFieldText(nomeCampo_expdate_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbstockobat_validate_expdate_(var_expdate_, iNumLinha, var_script_case_init, do_ajax_form_tbstockobat_validate_expdate__cb);
  } // do_ajax_form_tbstockobat_validate_expdate_

  function do_ajax_form_tbstockobat_validate_expdate__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbstockobat_validate_expdate__cb

  // ---------- Validate batchno_
  function do_ajax_form_tbstockobat_validate_batchno_(iNumLinha)
  {
    var nomeCampo_batchno_ = "batchno_" + iNumLinha;
    var var_batchno_ = scAjaxGetFieldText(nomeCampo_batchno_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbstockobat_validate_batchno_(var_batchno_, iNumLinha, var_script_case_init, do_ajax_form_tbstockobat_validate_batchno__cb);
  } // do_ajax_form_tbstockobat_validate_batchno_

  function do_ajax_form_tbstockobat_validate_batchno__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbstockobat_validate_batchno__cb

  // ---------- Refresh kodeitem_
  function do_ajax_form_tbstockobat_refresh_kodeitem_(iSeqForm)
  {
    var var_kodeitem_ = scAjaxGetFieldSelect("kodeitem_" + iSeqForm);
    var var_nmgp_refresh_row = iSeqForm;
    var var_nmgp_refresh_fields = "batchno_";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tbstockobat_refresh_kodeitem_(var_kodeitem_, var_nmgp_refresh_row, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_tbstockobat_refresh_kodeitem__cb);
  } // do_ajax_form_tbstockobat_refresh_kodeitem_

  function do_ajax_form_tbstockobat_refresh_kodeitem__cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbstockobat_refresh_kodeitem__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_tbstockobat_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_tbstockobat_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tbstockobat_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_tbstockobat_add_new_line_cb);
  } // do_ajax_form_tbstockobat_add_new_line

  function do_ajax_form_tbstockobat_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_tbstockobat_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_tbstockobat_backup_line(iNumLinha)
  {
    var var_id_ = scAjaxGetFieldHidden("id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbstockobat_backup_line(var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_tbstockobat_backup_line_cb);
  } // do_ajax_form_tbstockobat_backup_line

  function do_ajax_form_tbstockobat_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_tbstockobat_backup_line_cb

  function do_ajax_form_tbstockobat_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_tbstockobat_cancel_insert

  function do_ajax_form_tbstockobat_cancel_update(iSeqVert)
  {
    do_ajax_form_tbstockobat_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_tbstockobat_cancel_update

  function do_ajax_form_tbstockobat_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_tbstockobat_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_tbstockobat_table_refresh()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tbstockobat_table_refresh(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbstockobat_table_refresh_cb);
  } //  do_ajax_form_tbstockobat_table_refresh

  function do_ajax_form_tbstockobat_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_tbstockobat_table_refresh_cb_after_alert);
  } // do_ajax_form_tbstockobat_table_refresh_cb
  function do_ajax_form_tbstockobat_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_tbstockobat_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_tbstockobat_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_tbstockobat_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_id_ = scAjaxGetFieldHidden("id_" + iNumLinha);
    var var_kodeitem_ = scAjaxGetFieldSelect("kodeitem_" + iNumLinha);
    var var_satuan_ = scAjaxGetFieldSelect("satuan_" + iNumLinha);
    var var_currentstock_ = scAjaxGetFieldText("currentstock_" + iNumLinha);
    var var_depo_ = scAjaxGetFieldSelect("depo_" + iNumLinha);
...
?>
    x_ajax_form_tbstockobat_submit_form(var_id_, var_kodeitem_, var_satuan_, var_currentstock_, var_depo_, var_expdate_, var_batchno_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbstockobat_submit_form_cb);
  } // do_ajax_form_tbstockobat_submit_form

  function do_ajax_form_tbstockobat_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("kodeitem_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("satuan_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("currentstock_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("depo_" + sc_num_ult_line);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_tbstockobat_submit_form_cb_after_alert);
  } // do_ajax_form_tbstockobat_submit_form_cb
  function do_ajax_form_tbstockobat_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbstockobat_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tbstockobat_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("kodeitem_" + iNavForm);
      scAjaxHideErrorDisplay("satuan_" + iNavForm);
      scAjaxHideErrorDisplay("currentstock_" + iNavForm);
      scAjaxHideErrorDisplay("depo_" + iNavForm);
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tbstockobat_navigate_form(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbstockobat_navigate_form_cb);
  } // do_ajax_form_tbstockobat_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbstockobat']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbstockobat_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbstockobat_navigate_form_cb_after_alert);
  } // do_ajax_form_tbstockobat_navigate_form_cb
  function do_ajax_form_tbstockobat_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_tbstockobat_navigate_form_cb_after_alert
  function sc_hide_form_tbstockobat_form()
  {
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "kodeitem_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "satuan_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "currentstock_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "depo_" + iNumLinha;
    iTotCampos++;
    ...
    ajax_error_list["kodeitem_" + iNumLinha] = {"label": "Kode Item<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_error_list["currentstock_" + iNumLinha] = {"label": "Stock<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["depo_" + iNumLinha] = {"label": "Depo<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["expdate_" + iNumLinha] = {"label": "Tgl Kadaluarsa<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_field_mult["kodeitem_"][iNumLinha] = "kodeitem_" + iNumLinha;
    ajax_field_mult["satuan_"][iNumLinha] = "satuan_" + iNumLinha;
    ajax_field_mult["currentstock_"][iNumLinha] = "currentstock_" + iNumLinha;
    ajax_field_mult["depo_"][iNumLinha] = "depo_" + iNumLinha;
    ajax_field_mult["expdate_"][iNumLinha] = "expdate_" + iNumLinha;
    ajax_field_mult["batchno_"][iNumLinha] = "batchno_" + iNumLinha;
    ajax_field_id["kodeitem_" + iNumLinha] = new Array("hidden_field_label_kodeitem_", "hidden_field_data_kodeitem_" + iNumLinha);
    ajax_field_id["satuan_" + iNumLinha] = new Array("hidden_field_label_satuan_", "hidden_field_data_satuan_" + iNumLinha);
    ajax_field_id["currentstock_" + iNumLinha] = new Array("hidden_field_label_currentstock_", "hidden_field_data_currentstock_" + iNumLinha);
    ajax_field_id["depo_" + iNumLinha] = new Array("hidden_field_label_depo_", "hidden_field_data_depo_" + iNumLinha);
    ...
    ajax_error_count["kodeitem_" + iNumLinha] = "off";
    ajax_error_count["satuan_" + iNumLinha] = "off";
    ajax_error_count["currentstock_" + iNumLinha] = "off";
    ajax_error_count["depo_" + iNumLinha] = "off";
...
?>
    ...
    ajax_read_only["kodeitem_" + iNumLinha] = "off";
    ajax_read_only["satuan_" + iNumLinha] = "off";
    ajax_read_only["currentstock_" + iNumLinha] = "off";
    ajax_read_only["depo_" + iNumLinha] = "off";
...
?>
    ajax_read_only["id_" + iNumLinha] = "on";
    ajax_read_only["kodeitem_" + iNumLinha] = "on";
    ajax_read_only["satuan_" + iNumLinha] = "on";
    ajax_read_only["currentstock_" + iNumLinha] = "on";
    ajax_read_only["depo_" + iNumLinha] = "on";
...
?>
  ...
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["kodeitem_" + iNumLinha] = null;
    ajax_error_list["satuan_" + iNumLinha] = null;
    ajax_error_list["currentstock_" + iNumLinha] = null;
    ajax_error_list["depo_" + iNumLinha] = null;
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["kodeitem_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["kodeitem_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["kodeitem_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["kodeitem_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["kodeitem_" + iNumLinha]["onfocus"] = new Array();
      ...
      ajax_error_list["currentstock_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["currentstock_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["currentstock_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["currentstock_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["currentstock_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["depo_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["depo_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["depo_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["depo_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["depo_" + iNumLinha]["onfocus"] = new Array();
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['kodeitem_'])) ? $this->nmgp_cmp_readonly['kodeitem_'] : 'off';
?>
    scAjaxFieldRead("kodeitem_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['currentstock_'])) ? $this->nmgp_cmp_readonly['currentstock_'] : 'off';
?>
    scAjaxFieldRead("currentstock_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['depo_'])) ? $this->nmgp_cmp_readonly['depo_'] : 'off';
?>
    scAjaxFieldRead("depo_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
?>
  ...
  function mdCloseObjects(iSeq)
  {
    ...
    scAjaxFieldRead("kodeitem_" + iSeq, "on");
    scAjaxFieldRead("satuan_" + iSeq, "on");
    scAjaxFieldRead("currentstock_" + iSeq, "on");
    scAjaxFieldRead("depo_" + iSeq, "on");
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["id_" + iRow] || "on" == ajax_error_count["kodeitem_" + iRow] || "on" == ajax_error_count["satuan_" + iRow] || "on" == ajax_error_count["currentstock_" + iRow] || "on" == ajax_error_count["depo_" + iRow] || "on" == ajax_error_count["expdate_" + iRow] || "on" == ajax_error_count["batchno_" + iRow]))
    {
      ...
      $("#hidden_field_data_kodeitem_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_satuan_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_currentstock_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_depo_" + iRow).addClass("scFormErrorLine");
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["id_" + iRow] && "off" == ajax_error_count["kodeitem_" + iRow] && "off" == ajax_error_count["satuan_" + iRow] && "off" == ajax_error_count["currentstock_" + iRow] && "off" == ajax_error_count["depo_" + iRow] && "off" == ajax_error_count["expdate_" + iRow] && "off" == ajax_error_count["batchno_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["id_" + iRow] = "off";
        ajax_error_count["kodeitem_" + iRow] = "off";
        ajax_error_count["satuan_" + iRow] = "off";
        ajax_error_count["currentstock_" + iRow] = "off";
        ajax_error_count["depo_" + iRow] = "off";
      ...
      $("#hidden_field_data_kodeitem_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_satuan_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_currentstock_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_depo_" + iRow).removeClass("scFormErrorLine");
