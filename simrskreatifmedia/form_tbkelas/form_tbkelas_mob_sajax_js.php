  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbkelas_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbkelas_mob_form();
	}

  // ---------- Validate idkelas
  function do_ajax_form_tbkelas_mob_validate_idkelas()
  {
    var nomeCampo_idkelas = "idkelas";
    var var_idkelas = scAjaxGetFieldHidden(nomeCampo_idkelas);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbkelas_mob_validate_idkelas(var_idkelas, var_script_case_init, do_ajax_form_tbkelas_mob_validate_idkelas_cb);
  } // do_ajax_form_tbkelas_mob_validate_idkelas

  function do_ajax_form_tbkelas_mob_validate_idkelas_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbkelas_mob_validate_idkelas_cb

  // ---------- Validate namakelas
  function do_ajax_form_tbkelas_mob_validate_namakelas()
  {
    var nomeCampo_namakelas = "namakelas";
    var var_namakelas = scAjaxGetFieldText(nomeCampo_namakelas);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbkelas_mob_validate_namakelas(var_namakelas, var_script_case_init, do_ajax_form_tbkelas_mob_validate_namakelas_cb);
  } // do_ajax_form_tbkelas_mob_validate_namakelas

  function do_ajax_form_tbkelas_mob_validate_namakelas_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "namakelas";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbkelas_mob_validate_namakelas_cb

  // ---------- Validate fasilitas
  function do_ajax_form_tbkelas_mob_validate_fasilitas()
  {
    var nomeCampo_fasilitas = "fasilitas";
    var var_fasilitas = scAjaxGetFieldText(nomeCampo_fasilitas);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbkelas_mob_validate_fasilitas(var_fasilitas, var_script_case_init, do_ajax_form_tbkelas_mob_validate_fasilitas_cb);
  } // do_ajax_form_tbkelas_mob_validate_fasilitas

  function do_ajax_form_tbkelas_mob_validate_fasilitas_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fasilitas";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbkelas_mob_validate_fasilitas_cb

  // ---------- Validate tarifkamar
  function do_ajax_form_tbkelas_mob_validate_tarifkamar()
  {
    var nomeCampo_tarifkamar = "tarifkamar";
    var var_tarifkamar = scAjaxGetFieldText(nomeCampo_tarifkamar);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbkelas_mob_validate_tarifkamar(var_tarifkamar, var_script_case_init, do_ajax_form_tbkelas_mob_validate_tarifkamar_cb);
  } // do_ajax_form_tbkelas_mob_validate_tarifkamar

  function do_ajax_form_tbkelas_mob_validate_tarifkamar_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tarifkamar";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbkelas_mob_validate_tarifkamar_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tbkelas_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tbkelas_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_idkelas = scAjaxGetFieldHidden("idkelas");
    var var_namakelas = scAjaxGetFieldText("namakelas");
    var var_fasilitas = scAjaxGetFieldText("fasilitas");
    ...
    scAjaxProcOn();
    x_ajax_form_tbkelas_mob_submit_form(var_idkelas, var_namakelas, var_fasilitas, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbkelas_mob_submit_form_cb);
  } // do_ajax_form_tbkelas_mob_submit_form

  function do_ajax_form_tbkelas_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("idkelas");
      scAjaxHideErrorDisplay("namakelas");
      scAjaxHideErrorDisplay("fasilitas");
      scAjaxHideErrorDisplay("tarifkamar");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tbkelas_mob_submit_form_cb_after_alert);
  } // do_ajax_form_tbkelas_mob_submit_form_cb
  function do_ajax_form_tbkelas_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbkelas_mob_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_tbtarifinap_mob"] = "off";

  function do_ajax_form_tbkelas_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("fasilitas");
    scAjaxHideErrorDisplay("tarifkamar");
    var var_idkelas = document.F2.idkelas.value;
    ...
    scAjaxProcOn();
    scStatusDetail["form_tbtarifinap_mob"] = "on";
    x_ajax_form_tbkelas_mob_navigate_form(var_idkelas, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbkelas_mob_navigate_form_cb);
  } // do_ajax_form_tbkelas_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbkelas_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbkelas_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.idkelas.value = scAjaxGetKeyValue("idkelas");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_tbtarifinap_mob"] && "nmsc_iframe_liga_form_tbtarifinap_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_tbtarifinap_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_tbtarifinap_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_tbtarifinap_mob').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_tbtarifinap_mob').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_tbtarifinap_mob').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbkelas_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_tbkelas_mob_navigate_form_cb
  function do_ajax_form_tbkelas_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_tbkelas_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_tbkelas_mob_navigate_form_cb_after_alert
  function sc_hide_form_tbkelas_mob_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_tbtarifinap_mob"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[0] = "idkelas";
  ajax_field_list[1] = "namakelas";
  ajax_field_list[2] = "fasilitas";
  ajax_field_list[3] = "tarifkamar";
  ...
  var ajax_error_list = {
    "idkelas": {"label": "ID Kelas", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "namakelas": {"label": "Nama Kelas", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "fasilitas": {"label": "Fasilitas", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "tarifkamar": {"label": "", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    ...
    "namakelas": new Array(),
    "fasilitas": new Array(),
    "tarifkamar": new Array()
  };
  ajax_field_mult["idkelas"][1] = "idkelas";
  ajax_field_mult["namakelas"][1] = "namakelas";
  ajax_field_mult["fasilitas"][1] = "fasilitas";
  ajax_field_mult["tarifkamar"][1] = "tarifkamar";

  var ajax_field_id = {
    "idkelas": new Array("hidden_field_label_idkelas", "hidden_field_data_idkelas"),
    "namakelas": new Array("hidden_field_label_namakelas", "hidden_field_data_namakelas"),
    "fasilitas": new Array("hidden_field_label_fasilitas", "hidden_field_data_fasilitas"),
    "tarifkamar": new Array("hidden_field_label_tarifkamar", "hidden_field_data_tarifkamar")
  };
