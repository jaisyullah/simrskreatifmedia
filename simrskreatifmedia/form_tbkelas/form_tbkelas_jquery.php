...
function displayChange_field_tarifkamar(row, status) {
	if ("on" == status && typeof $("#nmsc_iframe_liga_form_tbtarifinap")[0].contentWindow.scRecreateSelect2 === "function") {
		$("#nmsc_iframe_liga_form_tbtarifinap")[0].contentWindow.scRecreateSelect2();
	}
}
...
function scHidePage(pageNo) {
	$("#id_form_tbkelas_form" + pageNo).hide();
}
