  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbsettindakan_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbsettindakan_mob_form();
	}

  // ---------- Validate set_tindakan
  function do_ajax_form_tbsettindakan_mob_validate_set_tindakan()
  {
    var nomeCampo_set_tindakan = "set_tindakan";
    var var_set_tindakan = scAjaxGetFieldText(nomeCampo_set_tindakan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbsettindakan_mob_validate_set_tindakan(var_set_tindakan, var_script_case_init, do_ajax_form_tbsettindakan_mob_validate_set_tindakan_cb);
  } // do_ajax_form_tbsettindakan_mob_validate_set_tindakan

  function do_ajax_form_tbsettindakan_mob_validate_set_tindakan_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbsettindakan_mob_validate_set_tindakan_cb

  // ---------- Validate poli
  function do_ajax_form_tbsettindakan_mob_validate_poli()
  {
    var nomeCampo_poli = "poli";
    var var_poli = scAjaxGetFieldSelect(nomeCampo_poli);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbsettindakan_mob_validate_poli(var_poli, var_script_case_init, do_ajax_form_tbsettindakan_mob_validate_poli_cb);
  } // do_ajax_form_tbsettindakan_mob_validate_poli

  function do_ajax_form_tbsettindakan_mob_validate_poli_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "poli";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbsettindakan_mob_validate_poli_cb

  // ---------- Validate aktif
  function do_ajax_form_tbsettindakan_mob_validate_aktif()
  {
    var nomeCampo_aktif = "aktif";
    var var_aktif = scAjaxGetFieldCheckbox(nomeCampo_aktif, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbsettindakan_mob_validate_aktif(var_aktif, var_script_case_init, do_ajax_form_tbsettindakan_mob_validate_aktif_cb);
  } // do_ajax_form_tbsettindakan_mob_validate_aktif

  function do_ajax_form_tbsettindakan_mob_validate_aktif_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "aktif";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbsettindakan_mob_validate_aktif_cb

  // ---------- Validate kode_tind
  function do_ajax_form_tbsettindakan_mob_validate_kode_tind()
  {
    var nomeCampo_kode_tind = "kode_tind";
    var var_kode_tind = scAjaxGetFieldSelect(nomeCampo_kode_tind);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbsettindakan_mob_validate_kode_tind(var_kode_tind, var_script_case_init, do_ajax_form_tbsettindakan_mob_validate_kode_tind_cb);
  } // do_ajax_form_tbsettindakan_mob_validate_kode_tind

  function do_ajax_form_tbsettindakan_mob_validate_kode_tind_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbsettindakan_mob_validate_kode_tind_cb

  // ---------- Refresh poli
  function do_ajax_form_tbsettindakan_mob_refresh_poli()
  {
    var var_poli = scAjaxGetFieldSelect("poli");
    var var_nmgp_refresh_fields = "kode_tind";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tbsettindakan_mob_refresh_poli(var_poli, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_tbsettindakan_mob_refresh_poli_cb);
  } // do_ajax_form_tbsettindakan_mob_refresh_poli

  function do_ajax_form_tbsettindakan_mob_refresh_poli_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbsettindakan_mob_refresh_poli_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tbsettindakan_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tbsettindakan_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    var var_kode_tind = scAjaxGetFieldSelect("kode_tind");
    ...
    scAjaxProcOn();
    x_ajax_form_tbsettindakan_mob_submit_form(var_set_tindakan, var_poli, var_aktif, var_kode_tind, var_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbsettindakan_mob_submit_form_cb);
  } // do_ajax_form_tbsettindakan_mob_submit_form

  function do_ajax_form_tbsettindakan_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tbsettindakan_mob_submit_form_cb_after_alert);
  } // do_ajax_form_tbsettindakan_mob_submit_form_cb
  function do_ajax_form_tbsettindakan_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbsettindakan_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tbsettindakan_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tbsettindakan_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbsettindakan_mob_navigate_form_cb);
  } // do_ajax_form_tbsettindakan_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbsettindakan_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbsettindakan_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbsettindakan_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_tbsettindakan_mob_navigate_form_cb
  function do_ajax_form_tbsettindakan_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_tbsettindakan_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_tbsettindakan_mob_navigate_form_cb_after_alert
  function sc_hide_form_tbsettindakan_mob_form()
  {
