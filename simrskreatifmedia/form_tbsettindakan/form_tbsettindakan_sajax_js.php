  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbsettindakan" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbsettindakan_form();
	}

  // ---------- Validate set_tindakan
  function do_ajax_form_tbsettindakan_validate_set_tindakan()
  {
    var nomeCampo_set_tindakan = "set_tindakan";
    var var_set_tindakan = scAjaxGetFieldText(nomeCampo_set_tindakan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbsettindakan_validate_set_tindakan(var_set_tindakan, var_script_case_init, do_ajax_form_tbsettindakan_validate_set_tindakan_cb);
  } // do_ajax_form_tbsettindakan_validate_set_tindakan

  function do_ajax_form_tbsettindakan_validate_set_tindakan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "set_tindakan";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbsettindakan_validate_set_tindakan_cb

  // ---------- Validate poli
  function do_ajax_form_tbsettindakan_validate_poli()
  {
    var nomeCampo_poli = "poli";
    var var_poli = scAjaxGetFieldSelect(nomeCampo_poli);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbsettindakan_validate_poli(var_poli, var_script_case_init, do_ajax_form_tbsettindakan_validate_poli_cb);
  } // do_ajax_form_tbsettindakan_validate_poli

  function do_ajax_form_tbsettindakan_validate_poli_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "poli";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbsettindakan_validate_poli_cb

  // ---------- Validate aktif
  function do_ajax_form_tbsettindakan_validate_aktif()
  {
    var nomeCampo_aktif = "aktif";
    var var_aktif = scAjaxGetFieldCheckbox(nomeCampo_aktif, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbsettindakan_validate_aktif(var_aktif, var_script_case_init, do_ajax_form_tbsettindakan_validate_aktif_cb);
  } // do_ajax_form_tbsettindakan_validate_aktif

  function do_ajax_form_tbsettindakan_validate_aktif_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "aktif";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbsettindakan_validate_aktif_cb

  // ---------- Validate kode_tind
  function do_ajax_form_tbsettindakan_validate_kode_tind()
  {
    var nomeCampo_kode_tind = "kode_tind";
    nm_pack(nomeCampo_kode_tind + '_dest', nomeCampo_kode_tind);
    var var_kode_tind = scAjaxGetFieldText(nomeCampo_kode_tind);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbsettindakan_validate_kode_tind(var_kode_tind, var_script_case_init, do_ajax_form_tbsettindakan_validate_kode_tind_cb);
  } // do_ajax_form_tbsettindakan_validate_kode_tind

  function do_ajax_form_tbsettindakan_validate_kode_tind_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "kode_tind";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbsettindakan_validate_kode_tind_cb

  // ---------- Refresh poli
  function do_ajax_form_tbsettindakan_refresh_poli()
  {
    var var_poli = scAjaxGetFieldSelect("poli");
    var var_nmgp_refresh_fields = "kode_tind";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tbsettindakan_refresh_poli(var_poli, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_tbsettindakan_refresh_poli_cb);
  } // do_ajax_form_tbsettindakan_refresh_poli

  function do_ajax_form_tbsettindakan_refresh_poli_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbsettindakan_refresh_poli_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tbsettindakan_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tbsettindakan_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_set_tindakan = scAjaxGetFieldText("set_tindakan");
    var var_poli = scAjaxGetFieldSelect("poli");
    var var_aktif = scAjaxGetFieldCheckbox("aktif", ";");
    nm_pack("kode_tind_dest", "kode_tind");
    var var_kode_tind = scAjaxGetFieldText("kode_tind");
    ...
    scAjaxProcOn();
    x_ajax_form_tbsettindakan_submit_form(var_set_tindakan, var_poli, var_aktif, var_kode_tind, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbsettindakan_submit_form_cb);
  } // do_ajax_form_tbsettindakan_submit_form

  function do_ajax_form_tbsettindakan_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("set_tindakan");
      scAjaxHideErrorDisplay("poli");
      scAjaxHideErrorDisplay("aktif");
      scAjaxHideErrorDisplay("kode_tind");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tbsettindakan_submit_form_cb_after_alert);
  } // do_ajax_form_tbsettindakan_submit_form_cb
  function do_ajax_form_tbsettindakan_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbsettindakan_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tbsettindakan_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tbsettindakan_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbsettindakan_navigate_form_cb);
  } // do_ajax_form_tbsettindakan_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbsettindakan']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbsettindakan_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbsettindakan_navigate_form_cb_after_alert);
  } // do_ajax_form_tbsettindakan_navigate_form_cb
  function do_ajax_form_tbsettindakan_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_tbsettindakan_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_tbsettindakan_navigate_form_cb_after_alert
  function sc_hide_form_tbsettindakan_form()
  {
  ...
  ajax_field_list[0] = "set_tindakan";
  ajax_field_list[1] = "poli";
  ajax_field_list[2] = "aktif";
  ajax_field_list[3] = "kode_tind";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "set_tindakan": {"label": "Nama Set", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "kode_tind": {"label": "Tindakan", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "set_tindakan": new Array(),
    "poli": new Array(),
    "aktif": new Array(),
    "kode_tind": new Array()
  };
  ajax_field_mult["set_tindakan"][1] = "set_tindakan";
  ajax_field_mult["poli"][1] = "poli";
  ajax_field_mult["aktif"][1] = "aktif";
  ajax_field_mult["kode_tind"][1] = "kode_tind";

  var ajax_field_id = {
    "set_tindakan": new Array("hidden_field_label_set_tindakan", "hidden_field_data_set_tindakan"),
    ...
    "kode_tind": new Array("hidden_field_label_kode_tind", "hidden_field_data_kode_tind")
  };
