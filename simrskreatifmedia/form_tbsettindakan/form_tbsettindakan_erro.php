...
$old_error_handler = set_error_handler("form_tbsettindakan_scriptcase_error_handler");

function form_tbsettindakan_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['form_tbsettindakan']['contr_erro']) && $_SESSION['scriptcase']['form_tbsettindakan']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_form_tbsettindakan->contr_form_tbsettindakan->Apl_com_erro = true;
            if ($inicial_form_tbsettindakan->contr_form_tbsettindakan->NM_ajax_flag)
            {
                $inicial_form_tbsettindakan->contr_form_tbsettindakan->NM_ajax_info['errList']['geral_form_tbsettindakan'][] = $msg;
                return;
            }
            form_tbsettindakan_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function form_tbsettindakan_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['form_tbsettindakan'])  && '' != $_SESSION['scriptcase']['error_icon']['form_tbsettindakan'])  ? $_SESSION['scriptcase']['error_icon']['form_tbsettindakan']  : "";
        $sCloseIcon      = (isset($_SESSION['scriptcase']['error_close']['form_tbsettindakan']) && '' != $_SESSION['scriptcase']['error_close']['form_tbsettindakan']) ? $_SESSION['scriptcase']['error_close']['form_tbsettindakan'] : "<td><input class=\"scButton_default\" type=\"button\" onClick=\"document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false\" value=\"X\" /></td>";

        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['form_tbsettindakan']) && '' != $_SESSION['scriptcase']['error_span_title']['form_tbsettindakan']) ? $_SESSION['scriptcase']['error_span_title']['form_tbsettindakan'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['form_tbsettindakan']) && '' != $_SESSION['scriptcase']['error_icon_title']['form_tbsettindakan']) ? $_SESSION['scriptcase']['error_icon_title']['form_tbsettindakan'] : '';
?>
