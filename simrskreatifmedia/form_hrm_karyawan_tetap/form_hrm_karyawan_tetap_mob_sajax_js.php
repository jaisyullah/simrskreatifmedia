  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_hrm_karyawan_tetap_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_hrm_karyawan_tetap_mob_form();
	}

  // ---------- Validate id
  function do_ajax_form_hrm_karyawan_tetap_mob_validate_id()
  {
    var nomeCampo_id = "id";
    var var_id = scAjaxGetFieldHidden(nomeCampo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_karyawan_tetap_mob_validate_id(var_id, var_script_case_init, do_ajax_form_hrm_karyawan_tetap_mob_validate_id_cb);
  } // do_ajax_form_hrm_karyawan_tetap_mob_validate_id

  function do_ajax_form_hrm_karyawan_tetap_mob_validate_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_karyawan_tetap_mob_validate_id_cb

  // ---------- Validate id_karyawan
  function do_ajax_form_hrm_karyawan_tetap_mob_validate_id_karyawan()
  {
    var nomeCampo_id_karyawan = "id_karyawan";
    var var_id_karyawan = scAjaxGetFieldSelect(nomeCampo_id_karyawan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_karyawan_tetap_mob_validate_id_karyawan(var_id_karyawan, var_script_case_init, do_ajax_form_hrm_karyawan_tetap_mob_validate_id_karyawan_cb);
  } // do_ajax_form_hrm_karyawan_tetap_mob_validate_id_karyawan

  function do_ajax_form_hrm_karyawan_tetap_mob_validate_id_karyawan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_karyawan_tetap_mob_validate_id_karyawan_cb

  // ---------- Validate no_skep
  function do_ajax_form_hrm_karyawan_tetap_mob_validate_no_skep()
  {
    var nomeCampo_no_skep = "no_skep";
    var var_no_skep = scAjaxGetFieldText(nomeCampo_no_skep);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_karyawan_tetap_mob_validate_no_skep(var_no_skep, var_script_case_init, do_ajax_form_hrm_karyawan_tetap_mob_validate_no_skep_cb);
  } // do_ajax_form_hrm_karyawan_tetap_mob_validate_no_skep

  function do_ajax_form_hrm_karyawan_tetap_mob_validate_no_skep_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "no_skep";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_karyawan_tetap_mob_validate_no_skep_cb

  // ---------- Validate tanggal_skep
  function do_ajax_form_hrm_karyawan_tetap_mob_validate_tanggal_skep()
  {
    var nomeCampo_tanggal_skep = "tanggal_skep";
    var var_tanggal_skep = scAjaxGetFieldText(nomeCampo_tanggal_skep);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_karyawan_tetap_mob_validate_tanggal_skep(var_tanggal_skep, var_script_case_init, do_ajax_form_hrm_karyawan_tetap_mob_validate_tanggal_skep_cb);
  } // do_ajax_form_hrm_karyawan_tetap_mob_validate_tanggal_skep

  function do_ajax_form_hrm_karyawan_tetap_mob_validate_tanggal_skep_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tanggal_skep";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_karyawan_tetap_mob_validate_tanggal_skep_cb

  // ---------- Validate keterangan
  function do_ajax_form_hrm_karyawan_tetap_mob_validate_keterangan()
  {
    var nomeCampo_keterangan = "keterangan";
    var var_keterangan = scAjaxGetFieldText(nomeCampo_keterangan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_karyawan_tetap_mob_validate_keterangan(var_keterangan, var_script_case_init, do_ajax_form_hrm_karyawan_tetap_mob_validate_keterangan_cb);
  } // do_ajax_form_hrm_karyawan_tetap_mob_validate_keterangan

  function do_ajax_form_hrm_karyawan_tetap_mob_validate_keterangan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_karyawan_tetap_mob_validate_keterangan_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_hrm_karyawan_tetap_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_hrm_karyawan_tetap_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id = scAjaxGetFieldHidden("id");
    var var_id_karyawan = scAjaxGetFieldSelect("id_karyawan");
    var var_no_skep = scAjaxGetFieldText("no_skep");
    var var_tanggal_skep = scAjaxGetFieldText("tanggal_skep");
    ...
    scAjaxProcOn();
    x_ajax_form_hrm_karyawan_tetap_mob_submit_form(var_id, var_id_karyawan, var_no_skep, var_tanggal_skep, var_keterangan, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_hrm_karyawan_tetap_mob_submit_form_cb);
  } // do_ajax_form_hrm_karyawan_tetap_mob_submit_form

  function do_ajax_form_hrm_karyawan_tetap_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("no_skep");
      scAjaxHideErrorDisplay("tanggal_skep");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_hrm_karyawan_tetap_mob_submit_form_cb_after_alert);
  } // do_ajax_form_hrm_karyawan_tetap_mob_submit_form_cb
  function do_ajax_form_hrm_karyawan_tetap_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_hrm_karyawan_tetap_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_hrm_karyawan_tetap_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_hrm_karyawan_tetap_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_hrm_karyawan_tetap_mob_navigate_form_cb);
  } // do_ajax_form_hrm_karyawan_tetap_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_hrm_karyawan_tetap_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_hrm_karyawan_tetap_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_hrm_karyawan_tetap_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_hrm_karyawan_tetap_mob_navigate_form_cb
  function do_ajax_form_hrm_karyawan_tetap_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_hrm_karyawan_tetap_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_hrm_karyawan_tetap_mob_navigate_form_cb_after_alert
  function sc_hide_form_hrm_karyawan_tetap_mob_form()
  {
  ...
  ajax_field_list[2] = "no_skep";
  ajax_field_list[3] = "tanggal_skep";
  ...
  var ajax_error_list = {
    ...
    "no_skep": {"label": "No Skep", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "tanggal_skep": {"label": "Tanggal Skep", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  var ajax_field_mult = {
    ...
    "no_skep": new Array(),
    "tanggal_skep": new Array(),
    "keterangan": new Array()
  };
  ajax_field_mult["id"][1] = "id";
  ajax_field_mult["id_karyawan"][1] = "id_karyawan";
  ajax_field_mult["no_skep"][1] = "no_skep";
  ajax_field_mult["tanggal_skep"][1] = "tanggal_skep";
  ...
  var ajax_field_id = {
    ...
    "no_skep": new Array("hidden_field_label_no_skep", "hidden_field_data_no_skep"),
    "tanggal_skep": new Array("hidden_field_label_tanggal_skep", "hidden_field_data_tanggal_skep"),
