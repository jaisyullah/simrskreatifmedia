...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_tipe_cond" name="tipe_cond" onChange="nm_campos_between(document.getElementById('id_vis_tipe'), this, 'tipe')">
      ...
      <br><span id="id_hide_tipe"  <?php echo $str_hide_tipe?>><?php
      if ($tipe != "")
      {
      $tipe_look = substr($this->Db->qstr($tipe), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_headerid_cond" name="headerid_cond" onChange="nm_campos_between(document.getElementById('id_vis_headerid'), this, 'headerid')">
      ...
      <br><span id="id_hide_headerid"  <?php echo $str_hide_headerid?>><?php
      if ($headerid != "")
      {
      $headerid_look = substr($this->Db->qstr($headerid), 1, -1); 
      $nmgp_def_dados = array(); 
