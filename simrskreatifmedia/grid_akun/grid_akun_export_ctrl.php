<?php
@session_start() ;
$_SESSION['scriptcase']['grid_akun']['sc_process_barr'] = true;
require_once('../grid_akun/index.php');
unset($_SESSION['scriptcase']['grid_akun']['sc_process_barr']);
$ExportCtrl = new grid_akun_export_control;
$ExportCtrl->Export_barr();

class grid_akun_export_control
{
