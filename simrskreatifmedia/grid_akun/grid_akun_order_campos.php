...
<?php
   ...
   $Ord_Cmp = new grid_akun_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_akun_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_akun']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_akun']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_akun']['labels']["id"])) ? $_SESSION['sc_session'][$sc_init]['grid_akun']['labels']["id"] : "Id";
   $tab_ger_campos['nama'] = "on";
   $tab_def_campos['nama'] = "nama";
   $tab_labels["nama"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_akun']['labels']["nama"])) ? $_SESSION['sc_session'][$sc_init]['grid_akun']['labels']["nama"] : "Nama";
   $tab_ger_campos['headerid'] = "on";
   $tab_def_campos['headerid'] = "headerid";
   $tab_labels["headerid"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_akun']['labels']["headerid"])) ? $_SESSION['sc_session'][$sc_init]['grid_akun']['labels']["headerid"] : "Headerid";
   $tab_ger_campos['tipe'] = "on";
   $tab_def_campos['tipe'] = "tipe";
   $tab_labels["tipe"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_akun']['labels']["tipe"])) ? $_SESSION['sc_session'][$sc_init]['grid_akun']['labels']["tipe"] : "Tipe";
   $tab_ger_campos['user'] = "on";
   $tab_def_campos['user'] = "user";
   $tab_labels["user"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_akun']['labels']["user"])) ? $_SESSION['sc_session'][$sc_init]['grid_akun']['labels']["user"] : "User";
   $tab_ger_campos['jam'] = "on";
   $tab_def_campos['jam'] = "jam";
   $tab_labels["jam"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_akun']['labels']["jam"])) ? $_SESSION['sc_session'][$sc_init]['grid_akun']['labels']["jam"] : "Jam";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_akun']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_akun']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_akun']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_akun']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_akun']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_akun']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_akun']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_akun']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_akun']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_akun_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_akun']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_akun']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_akun']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_akun']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_akun']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
