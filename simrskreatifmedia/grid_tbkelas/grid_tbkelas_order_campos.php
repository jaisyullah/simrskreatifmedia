...
<?php
   ...
   $Ord_Cmp = new grid_tbkelas_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_tbkelas_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbkelas']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tbkelas']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['idkelas'] = "idKelas";
   $tab_labels["idkelas"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbkelas']['labels']["idkelas"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbkelas']['labels']["idkelas"] : "ID Kelas";
   $tab_ger_campos['namakelas'] = "on";
   $tab_def_campos['namakelas'] = "namaKelas";
   $tab_labels["namakelas"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbkelas']['labels']["namakelas"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbkelas']['labels']["namakelas"] : "Nama Kelas";
   $tab_ger_campos['fasilitas'] = "on";
   $tab_def_campos['fasilitas'] = "fasilitas";
   $tab_labels["fasilitas"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbkelas']['labels']["fasilitas"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbkelas']['labels']["fasilitas"] : "Fasilitas";
   ...
   {
       $tab_def_campos['harga'] = "";
   }
   $tab_labels["harga"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbkelas']['labels']["harga"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbkelas']['labels']["harga"] : "Harga";
   $tab_ger_campos['keperawatan'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['keperawatan'] = "Keperawatan";
   }
   else
   {
       $tab_def_campos['keperawatan'] = "";
   }
   $tab_labels["keperawatan"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbkelas']['labels']["keperawatan"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbkelas']['labels']["keperawatan"] : "Keperawatan";
   $tab_ger_campos['harga'] = "none";
   $tab_ger_campos['keperawatan'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_tbkelas']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_tbkelas']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_tbkelas']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbkelas']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tbkelas']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_tbkelas']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_tbkelas']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_tbkelas']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_tbkelas']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_tbkelas_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_tbkelas']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_tbkelas']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_tbkelas']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_tbkelas']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_tbkelas']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
