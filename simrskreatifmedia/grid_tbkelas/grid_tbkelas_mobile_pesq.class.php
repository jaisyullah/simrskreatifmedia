...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "idkelas";$Nm_numeric[] = "";$Nm_numeric[] = "idkelas";$Nm_numeric[] = "";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_idkelas"  <?php echo $str_hide_idkelas?>><?php
      if ($idkelas != "")
      {
      $idkelas_look = substr($this->Db->qstr($idkelas), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_namakelas"  <?php echo $str_hide_namakelas?>><?php
      if ($namakelas != "")
      {
      $namakelas_look = substr($this->Db->qstr($namakelas), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_fasilitas"  <?php echo $str_hide_fasilitas?>><?php
      if ($fasilitas != "")
      {
      $fasilitas_look = substr($this->Db->qstr($fasilitas), 1, -1); 
      $nmgp_def_dados = array(); 
