...
class grid_tbkelas_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbkelas']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_tbkelas_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_tbkelas_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_tbkelas_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_idkelas')
      {
          $idkelas = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_idkelas($idkelas);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_fasilitas')
      {
          $fasilitas = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_fasilitas($fasilitas);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function lookup_ajax_idkelas($idkelas)
   {
      $idkelas = str_replace($_SESSION['scriptcase']['reg_conf']['grup_num'], "", $idkelas);
      $idkelas = substr($this->Db->qstr($idkelas), 1, -1);
            $idkelas_look = substr($this->Db->qstr($idkelas), 1, -1); 
      $nmgp_def_dados = array(); 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct idKelas from " . $this->Ini->nm_tabela . " where   CAST (idKelas AS TEXT)  like '%" . $idkelas . "%' order by idKelas"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct idKelas from " . $this->Ini->nm_tabela . " where   CAST (idKelas AS VARCHAR)  like '%" . $idkelas . "%' order by idKelas"; 
      }
      else
      {
          $nm_comando = "select distinct idKelas from " . $this->Ini->nm_tabela . " where  idKelas like '%" . $idkelas . "%' order by idKelas"; 
      }
      unset($cmp1,$cmp2);
   ...
   function lookup_ajax_fasilitas($fasilitas)
   {
      $fasilitas = substr($this->Db->qstr($fasilitas), 1, -1);
            $fasilitas_look = substr($this->Db->qstr($fasilitas), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct fasilitas from " . $this->Ini->nm_tabela . " where  fasilitas like '%" . $fasilitas . "%' order by fasilitas"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbkelas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbkelas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbkelas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbkelas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbkelas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbkelas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbkelas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbkelas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbkelas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbkelas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbkelas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbkelas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbkelas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbkelas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbkelas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - Kelas</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_tbkelas/grid_tbkelas_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_tbkelas_ajax_search.js"></script>
 <script type="text/javascript" src="grid_tbkelas_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_tbkelas_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_tbkelas']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_tbkelas']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_idkelas_cond#NMF#' + search_get_sel_txt('SC_idkelas_cond') + '@NMF@';
  str_out += 'SC_idkelas#NMF#' + search_get_text('SC_idkelas') + '@NMF@';
  str_out += 'id_ac_idkelas#NMF#' + search_get_text('id_ac_idkelas') + '@NMF@';
  ...
  str_out += 'SC_fasilitas_cond#NMF#' + search_get_sel_txt('SC_fasilitas_cond') + '@NMF@';
  str_out += 'SC_fasilitas#NMF#' + search_get_text('SC_fasilitas') + '@NMF@';
  str_out += 'id_ac_fasilitas#NMF#' + search_get_text('id_ac_fasilitas') + '@NMF@';
   ...
   $("#id_ac_idkelas").autocomplete({
     ...
     $.ajax({
       ...
       data: {
          ...
          nmgp_parms: "NM_ajax_opcao?#?autocomp_idkelas",
          max_itens: "10",
          cod_desc: "N",
   ...
   $("#id_ac_fasilitas").autocomplete({
     ...
     $.ajax({
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_fasilitas",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_fasilitas").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     focus: function (event, ui) {
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbkelas']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div class="scFilterHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFilterHeaderFont" style="float: left; text-transform: uppercase;"><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - Kelas</div>
...
<?php
   ...
   {
      global 
             $idkelas_cond, $idkelas, $idkelas_autocomp,
             $namakelas_cond, $namakelas, $namakelas_autocomp,
             $fasilitas_cond, $fasilitas, $fasilitas_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbkelas']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbkelas']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbkelas']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbkelas']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $idkelas = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbkelas']['campos_busca']['idkelas']; 
          $idkelas_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbkelas']['campos_busca']['idkelas_cond']; 
          $namakelas = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbkelas']['campos_busca']['namakelas']; 
          $namakelas_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbkelas']['campos_busca']['namakelas_cond']; 
          $fasilitas = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbkelas']['campos_busca']['fasilitas']; 
          $fasilitas_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbkelas']['campos_busca']['fasilitas_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbkelas']['campos_busca']['NM_operador']; 
      } 
      $display_aberto  = "style=display:";
      $display_fechado = "style=display:none";
      $opc_hide_input = array("nu","nn","ep","ne");
      $str_hide_idkelas = (in_array($idkelas_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_namakelas = (in_array($namakelas_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_fasilitas = (in_array($fasilitas_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      if (!isset($idkelas) || $idkelas == "")
      {
          $idkelas = "";
      }
      if (isset($idkelas) && !empty($idkelas))
      {
         $tmp_pos = strpos($idkelas, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $idkelas = substr($idkelas, 0, $tmp_pos);
         }
      }
      ...
      if (!isset($fasilitas) || $fasilitas == "")
      {
          $fasilitas = "";
      }
      if (isset($fasilitas) && !empty($fasilitas))
      {
         $tmp_pos = strpos($fasilitas, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $fasilitas = substr($fasilitas, 0, $tmp_pos);
         }
      }
?>
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_idkelas_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['idkelas'])) ? $this->New_label['idkelas'] : "ID Kelas"; ?></TD>
      
      <INPUT type="hidden" id="SC_idkelas_cond" name="idkelas_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_idkelas" <?php echo $str_hide_idkelas?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['idkelas'])) ? $this->New_label['idkelas'] : "ID Kelas";
 $nmgp_tab_label .= "idkelas?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
...
<?php
      ...
      $idkelas_look = substr($this->Db->qstr($idkelas), 1, -1); 
      $nmgp_def_dados = array(); 
   if (is_numeric($idkelas))
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct idKelas from " . $this->Ini->nm_tabela . " where idKelas = $idkelas_look order by idKelas"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct idKelas from " . $this->Ini->nm_tabela . " where idKelas = $idkelas_look order by idKelas"; 
      ...
      if (isset($nmgp_def_dados[0][$idkelas]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$idkelas];
      }
      else
      {
            nmgp_Form_Num_Val($idkelas, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          $sAutocompValue = $idkelas;
      }
?>
<INPUT  type="text" id="SC_idkelas" name="idkelas" value="<?php echo NM_encode_input($idkelas) ?>" size=5 alt="{datatype: 'integer', maxLength: 5, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_idkelas" name="idkelas_autocomp" size="5"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 5, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
      ...
      <TD id='SC_namakelas_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['namakelas'])) ? $this->New_label['namakelas'] : "Nama Kelas"; ?></TD>
      
      <INPUT type="hidden" id="SC_namakelas_cond" name="namakelas_cond" value="eq">
...
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_namakelas" name="namakelas_autocomp" size="25"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 25, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_fasilitas_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['fasilitas'])) ? $this->New_label['fasilitas'] : "Fasilitas"; ?></TD>
      
      <INPUT type="hidden" id="SC_fasilitas_cond" name="fasilitas_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_fasilitas" <?php echo $str_hide_fasilitas?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['fasilitas'])) ? $this->New_label['fasilitas'] : "Fasilitas";
 $nmgp_tab_label .= "fasilitas?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      $fasilitas_look = substr($this->Db->qstr($fasilitas), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct fasilitas from " . $this->Ini->nm_tabela . " where fasilitas = '$fasilitas_look' order by fasilitas"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      if (isset($nmgp_def_dados[0][$fasilitas]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$fasilitas];
      }
      else
      {
          $sAutocompValue = $fasilitas;
      }
?>
<INPUT  type="text" id="SC_fasilitas" name="fasilitas" value="<?php echo NM_encode_input($fasilitas) ?>"  size=50 alt="{datatype: 'text', maxLength: 500, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_fasilitas" name="fasilitas_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 500, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
?>
<?php
   if (is_file("grid_tbkelas_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_tbkelas']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_tbkelas']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbkelas']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   nm_campos_between(document.getElementById('id_vis_idkelas'), document.F1.idkelas_cond, 'idkelas');
   document.F1.idkelas.value = "";
   document.F1.idkelas_autocomp.value = "";
   ...
   nm_campos_between(document.getElementById('id_vis_fasilitas'), document.F1.fasilitas_cond, 'fasilitas');
   document.F1.fasilitas.value = "";
   document.F1.fasilitas_autocomp.value = "";
 }
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "simrskreatifmedia/grid_tbkelas";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbkelas']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbkelas']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbkelas']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_idkelas_cond'] = 'cond';
      $tp_fields['SC_idkelas'] = 'text_aut';
      $tp_fields['id_ac_idkelas'] = 'text_aut';
      $tp_fields['SC_namakelas_cond'] = 'cond';
      $tp_fields['SC_namakelas'] = 'text_aut';
      $tp_fields['id_ac_namakelas'] = 'text_aut';
      $tp_fields['SC_fasilitas_cond'] = 'cond';
      $tp_fields['SC_fasilitas'] = 'text_aut';
      $tp_fields['id_ac_fasilitas'] = 'text_aut';
   ...
   {
      global $idkelas_cond, $idkelas, $idkelas_autocomp,
             $namakelas_cond, $namakelas, $namakelas_autocomp,
             $fasilitas_cond, $fasilitas, $fasilitas_autocomp, $nmgp_tab_label;

      $C_formatado = true;
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_conv_dados.php", "F", "nm_conv_limpa_dado") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
      if (!empty($idkelas_autocomp) && empty($idkelas))
      {
          $idkelas = $idkelas_autocomp;
      }
      if (!empty($namakelas_autocomp) && empty($namakelas))
      {
          $namakelas = $namakelas_autocomp;
      }
      if (!empty($fasilitas_autocomp) && empty($fasilitas))
      {
          $fasilitas = $fasilitas_autocomp;
      }
      $idkelas_cond_salva = $idkelas_cond; 
      if (!isset($idkelas_input_2) || $idkelas_input_2 == "")
      {
          $idkelas_input_2 = $idkelas;
      }
      ...
      $fasilitas_cond_salva = $fasilitas_cond; 
      if (!isset($fasilitas_input_2) || $fasilitas_input_2 == "")
      {
          $fasilitas_input_2 = $fasilitas;
      }
      if ($idkelas_cond != "in")
      {
          nm_limpa_numero($idkelas, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbkelas']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbkelas']['campos_busca']['idkelas'] = $idkelas; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbkelas']['campos_busca']['idkelas_cond'] = $idkelas_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbkelas']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbkelas']['campos_busca']['namakelas'] = $namakelas; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbkelas']['campos_busca']['namakelas_cond'] = $namakelas_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbkelas']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbkelas']['campos_busca']['fasilitas'] = $fasilitas; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbkelas']['campos_busca']['fasilitas_cond'] = $fasilitas_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbkelas']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbkelas']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbkelas']['campos_busca'] = $Temp_Busca;
      }
      if ($idkelas_cond != "in" && $idkelas_cond != "bw" && !empty($idkelas) && !is_numeric($idkelas))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : ID Kelas";
      }
      if ($idkelas_cond == "bw" && ((!empty($idkelas) && !is_numeric($idkelas)) || (!empty($idkelas_input_2) && !is_numeric($idkelas_input_2)) ))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : ID Kelas";
      }
      if (!empty($this->Campos_Mens_erro)) 
   ...
   { 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['idkelas'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['idkelas'] = $cmp1;
      }
      else
      {
          $cmp1 = $idkelas;
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['fasilitas'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['fasilitas'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['fasilitas'] = $fasilitas;
      }

      //----- $idkelas
      $this->Date_part = false;
      if (isset($idkelas) || $idkelas_cond == "nu" || $idkelas_cond == "nn" || $idkelas_cond == "ep" || $idkelas_cond == "ne")
      {
         $this->monta_condicao("idKelas", $idkelas_cond, $idkelas, "", "idkelas");
      }
      ...
      //----- $fasilitas
      $this->Date_part = false;
      if (isset($fasilitas) || $fasilitas_cond == "nu" || $fasilitas_cond == "nn" || $fasilitas_cond == "ep" || $fasilitas_cond == "ne")
      {
         $this->monta_condicao("fasilitas", $fasilitas_cond, $fasilitas, "", "fasilitas");
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbkelas']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbkelas']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbkelas']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbkelas']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbkelas']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbkelas']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbkelas']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbkelas']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbkelas']['cond_pesq'] .= $this->NM_operador;
