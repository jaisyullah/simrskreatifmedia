...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "rate";$Nm_numeric[] = "jumlah";$Nm_numeric[] = "disc";$Nm_numeric[] = "rate";$Nm_numeric[] = "jumlah";$Nm_numeric[] = "disc";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_itemcode_cond" name="itemcode_cond" onChange="nm_campos_between(document.getElementById('id_vis_itemcode'), this, 'itemcode')">
      ...
      <br><span id="id_hide_itemcode"  <?php echo $str_hide_itemcode?>><?php
      if ($itemcode != "")
      {
      $itemcode_look = substr($this->Db->qstr($itemcode), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_sediaan_cond" name="sediaan_cond" onChange="nm_campos_between(document.getElementById('id_vis_sediaan'), this, 'sediaan')">
      ...
      <br><span id="id_hide_sediaan"  <?php echo $str_hide_sediaan?>><?php
      if ($sediaan != "")
      {
      $sediaan_look = substr($this->Db->qstr($sediaan), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_rate_cond" name="rate_cond" onChange="nm_campos_between(document.getElementById('id_vis_rate'), this, 'rate')">
