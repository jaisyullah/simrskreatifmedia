...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____detailItemBebas"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____detailItemBebas"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['detailItemBebas']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['detailItemBebas']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['detailItemBebas']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['detailItemBebas']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['detailItemBebas']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['detailItemBebas']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['detailItemBebas']['embutida_filho'] as $ind => $sc_init)
          {
