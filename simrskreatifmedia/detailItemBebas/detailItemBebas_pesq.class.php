...
class detailItemBebas_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['path_libs_php'] = $this->Ini->path_lib_php;
      ...
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search_change_fil")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['campos_busca'] = array(); 
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . detailItemBebas_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . detailItemBebas_pack_protect_string($Tipo_filter[0]) . "\">.." . detailItemBebas_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_itemcode')
      {
          $itemcode = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_itemcode($itemcode);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_sediaan')
      {
          $sediaan = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_sediaan($sediaan);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
          ...
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['grid_pesq'][$campo_join]);
              return;
          }
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_title'] ?> tbitemdrugsell</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>detailItemBebas/detailItemBebas_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="detailItemBebas_ajax_search.js"></script>
 <script type="text/javascript" src="detailItemBebas_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="detailItemBebas_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['detailItemBebas']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['detailItemBebas']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_itemcode_cond#NMF#' + search_get_sel_txt('SC_itemcode_cond') + '@NMF@';
  str_out += 'SC_itemcode#NMF#' + search_get_text('SC_itemcode') + '@NMF@';
  str_out += 'id_ac_itemcode#NMF#' + search_get_text('id_ac_itemcode') + '@NMF@';
  str_out += 'SC_sediaan_cond#NMF#' + search_get_sel_txt('SC_sediaan_cond') + '@NMF@';
  str_out += 'SC_sediaan#NMF#' + search_get_text('SC_sediaan') + '@NMF@';
  str_out += 'id_ac_sediaan#NMF#' + search_get_text('id_ac_sediaan') + '@NMF@';
  str_out += 'SC_rate_cond#NMF#' + search_get_sel_txt('SC_rate_cond') + '@NMF@';
  str_out += 'SC_rate#NMF#' + search_get_text('SC_rate') + '@NMF@';
   ...
   $("#id_ac_itemcode").autocomplete({
     ...
     $.ajax({
       ...
       data: {
          ...
          nmgp_parms: "NM_ajax_opcao?#?autocomp_itemcode",
          max_itens: "10",
          cod_desc: "N",
     ...
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_itemcode").val( $(this).val() );
       }
     }
   });
   $("#id_ac_sediaan").autocomplete({
     minLength: 1,
     source: function (request, response) {
     $.ajax({
       url: "index.php",
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_sediaan",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div class="scFilterHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFilterHeaderFont" style="float: left; text-transform: uppercase;"><?php echo $this->Ini->Nm_lang['lang_othr_srch_title'] ?> tbitemdrugsell</div>
...
<?php
   ...
   {
      global 
             $itemcode_cond, $itemcode, $itemcode_autocomp,
             $sediaan_cond, $sediaan, $sediaan_autocomp,
             $rate_cond, $rate,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          $itemcode = $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['campos_busca']['itemcode']; 
          $itemcode_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['campos_busca']['itemcode_cond']; 
          $sediaan = $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['campos_busca']['sediaan']; 
          $sediaan_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['campos_busca']['sediaan_cond']; 
          $rate = $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['campos_busca']['rate']; 
          $rate_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['campos_busca']['rate_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['campos_busca']['NM_operador']; 
          if (strtoupper($rate_cond) != "II" && strtoupper($rate_cond) != "QP" && strtoupper($rate_cond) != "NP" && strtoupper($rate_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($rate, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
      } 
      if (!isset($itemcode_cond) || empty($itemcode_cond))
      {
         $itemcode_cond = "qp";
      }
      if (!isset($sediaan_cond) || empty($sediaan_cond))
      {
         $sediaan_cond = "qp";
      }
      if (!isset($rate_cond) || empty($rate_cond))
      {
         $rate_cond = "gt";
      }
      ...
      $str_hide_itemcode = (in_array($itemcode_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_sediaan = (in_array($sediaan_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_rate = (in_array($rate_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      {
         $tmp_pos = strpos($itemcode, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $itemcode = substr($itemcode, 0, $tmp_pos);
         }
      }
      if (!isset($sediaan) || $sediaan == "")
      {
          $sediaan = "";
      }
      if (isset($sediaan) && !empty($sediaan))
      {
         $tmp_pos = strpos($sediaan, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $sediaan = substr($sediaan, 0, $tmp_pos);
         }
      }
      if (!isset($rate) || $rate == "")
      {
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_itemcode_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['itemcode'])) ? $this->New_label['itemcode'] : "Nama Item"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_itemcode_cond" name="itemcode_cond" onChange="nm_campos_between(document.getElementById('id_vis_itemcode'), this, 'itemcode')">
       <OPTION value="qp" <?php if ("qp" == $itemcode_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $itemcode_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $itemcode_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $itemcode_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_itemcode" <?php echo $str_hide_itemcode?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['itemcode'])) ? $this->New_label['itemcode'] : "Nama Item";
 $nmgp_tab_label .= "itemcode?#?" . $SC_Label . "?@?";
...
<?php
      ...
      {
          $sAutocompValue = $itemcode;
      }
?>
<INPUT  type="text" id="SC_itemcode" name="itemcode" value="<?php echo NM_encode_input($itemcode) ?>"  size=10 alt="{datatype: 'text', maxLength: 10, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_itemcode" name="itemcode_autocomp" size="10"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 10, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_sediaan_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['sediaan'])) ? $this->New_label['sediaan'] : "Sediaan"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_sediaan_cond" name="sediaan_cond" onChange="nm_campos_between(document.getElementById('id_vis_sediaan'), this, 'sediaan')">
       <OPTION value="qp" <?php if ("qp" == $sediaan_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $sediaan_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $sediaan_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $sediaan_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_sediaan" <?php echo $str_hide_sediaan?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['sediaan'])) ? $this->New_label['sediaan'] : "Sediaan";
 $nmgp_tab_label .= "sediaan?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      {
          $sAutocompValue = $sediaan;
      }
?>
<INPUT  type="text" id="SC_sediaan" name="sediaan" value="<?php echo NM_encode_input($sediaan) ?>"  size=50 alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_sediaan" name="sediaan_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_rate_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['rate'])) ? $this->New_label['rate'] : "Harga"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_rate_cond" name="rate_cond" onChange="nm_campos_between(document.getElementById('id_vis_rate'), this, 'rate')">
       <OPTION value="gt" <?php if ("gt" == $rate_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $rate_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $rate_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_rate" <?php echo $str_hide_rate?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['rate'])) ? $this->New_label['rate'] : "Harga";
 $nmgp_tab_label .= "rate?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<INPUT  type="text" id="SC_rate" name="rate" value="<?php echo NM_encode_input($rate) ?>" size=15 alt="{datatype: 'integer', maxLength: 15, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if ($_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
<?php
   if (is_file("detailItemBebas_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['detailItemBebas']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['detailItemBebas']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.itemcode_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_itemcode'), document.F1.itemcode_cond, 'itemcode');
   document.F1.itemcode.value = "";
   document.F1.itemcode_autocomp.value = "";
   document.F1.sediaan_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_sediaan'), document.F1.sediaan_cond, 'sediaan');
   document.F1.sediaan.value = "";
   document.F1.sediaan_autocomp.value = "";
   document.F1.rate_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_rate'), document.F1.rate_cond, 'rate');
   document.F1.rate.value = "";
 }
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['where_orig'] = "";
      }
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          $this->comando = "";
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['where_orig'];
      }
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_itemcode_cond'] = 'cond';
      $tp_fields['SC_itemcode'] = 'text_aut';
      $tp_fields['id_ac_itemcode'] = 'text_aut';
      $tp_fields['SC_sediaan_cond'] = 'cond';
      $tp_fields['SC_sediaan'] = 'text_aut';
      $tp_fields['id_ac_sediaan'] = 'text_aut';
      $tp_fields['SC_rate_cond'] = 'cond';
      $tp_fields['SC_rate'] = 'text';
   ...
   {
      global $itemcode_cond, $itemcode, $itemcode_autocomp,
             $sediaan_cond, $sediaan, $sediaan_autocomp,
             $rate_cond, $rate, $nmgp_tab_label;
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['campos_busca'] as $Cmps => $Vals)
          {
              $$Cmps = $Vals;
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['grid_pesq'] = array();
      if (!empty($itemcode_autocomp) && empty($itemcode))
      {
          $itemcode = $itemcode_autocomp;
      }
      if (!empty($sediaan_autocomp) && empty($sediaan))
      {
          $sediaan = $sediaan_autocomp;
      }
      $itemcode_cond_salva = $itemcode_cond; 
      if (!isset($itemcode_input_2) || $itemcode_input_2 == "")
      {
          $itemcode_input_2 = $itemcode;
      }
      $sediaan_cond_salva = $sediaan_cond; 
      if (!isset($sediaan_input_2) || $sediaan_input_2 == "")
      {
          $sediaan_input_2 = $sediaan;
      }
      $rate_cond_salva = $rate_cond; 
      if (!isset($rate_input_2) || $rate_input_2 == "")
      {
          $rate_input_2 = $rate;
      }
      if ($rate_cond != "in")
      {
          nm_limpa_numero($rate, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['Grid_search']  = array(); 
      $I_Grid = 0;
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['campos_busca']['itemcode'] = $itemcode; 
      if (is_array($itemcode) && !empty($itemcode))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['Grid_search'][$I_Grid]['val'][0] = $itemcode;
      }
      elseif ($itemcode_cond_salva == "nu" || $itemcode_cond_salva == "nn" || $itemcode_cond_salva == "ep" || $itemcode_cond_salva == "ne" || !empty($itemcode))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['Grid_search'][$I_Grid]['val'][0][0] = $itemcode;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['campos_busca']['itemcode_cond'] = $itemcode_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['Grid_search'][$I_Grid]['cmp'] = "itemcode"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['Grid_search'][$I_Grid]['opc'] = $itemcode_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['grid_pesq']['itemcode'] = $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['campos_busca']['sediaan'] = $sediaan; 
      if (is_array($sediaan) && !empty($sediaan))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['Grid_search'][$I_Grid]['val'][0] = $sediaan;
      }
      elseif ($sediaan_cond_salva == "nu" || $sediaan_cond_salva == "nn" || $sediaan_cond_salva == "ep" || $sediaan_cond_salva == "ne" || !empty($sediaan))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['Grid_search'][$I_Grid]['val'][0][0] = $sediaan;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['campos_busca']['sediaan_cond'] = $sediaan_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['Grid_search'][$I_Grid]['cmp'] = "sediaan"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['Grid_search'][$I_Grid]['opc'] = $sediaan_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['grid_pesq']['sediaan'] = $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['campos_busca']['rate'] = $rate; 
      if (is_array($rate) && !empty($rate))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['Grid_search'][$I_Grid]['val'][0] = $rate;
      }
      elseif ($rate_cond_salva == "nu" || $rate_cond_salva == "nn" || $rate_cond_salva == "ep" || $rate_cond_salva == "ne" || !empty($rate))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['Grid_search'][$I_Grid]['val'][0][0] = $rate;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['campos_busca']['rate_cond'] = $rate_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['Grid_search'][$I_Grid]['cmp'] = "rate"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['Grid_search'][$I_Grid]['opc'] = $rate_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['grid_pesq']['rate'] = $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['itemcode'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['itemcode'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['itemcode'] = $itemcode;
      }
      $sediaan_look = substr($this->Db->qstr($sediaan), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct sediaan from " . $this->Ini->nm_tabela . " where trancode = '" . $_SESSION['kodeBebas'] . "' and sediaan = '$sediaan_look' order by sediaan"; 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['sediaan'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['sediaan'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['sediaan'] = $sediaan;
      }
      $Conteudo = $rate;
      if (strtoupper($rate_cond) != "II" && strtoupper($rate_cond) != "QP" && strtoupper($rate_cond) != "NP" && strtoupper($rate_cond) != "IN") 
      { 
      ...
      $this->cmp_formatado['rate'] = $Conteudo;

      //----- $itemcode
      $this->Date_part = false;
      if (isset($itemcode) || $itemcode_cond == "nu" || $itemcode_cond == "nn" || $itemcode_cond == "ep" || $itemcode_cond == "ne")
      {
         $this->monta_condicao("itemcode", $itemcode_cond, $itemcode, "", "itemcode");
      }

      //----- $sediaan
      $this->Date_part = false;
      if (isset($sediaan) || $sediaan_cond == "nu" || $sediaan_cond == "nn" || $sediaan_cond == "ep" || $sediaan_cond == "ne")
      {
         $this->monta_condicao("sediaan", $sediaan_cond, $sediaan, "", "sediaan");
      }

      //----- $rate
      $this->Date_part = false;
      if (isset($rate) || $rate_cond == "nu" || $rate_cond == "nn" || $rate_cond == "ep" || $rate_cond == "ne")
      {
         $this->monta_condicao("rate", $rate_cond, $rate, "", "rate");
      }
   }
   ...
   function finaliza_resultado_ajax()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['where_pesq'] = $this->comando;
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['where_pesq_fast'])) 
       {
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['where_pesq'])) 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['where_pesq_fast'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['where_pesq'] = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['where_pesq_fast'] . ")";
           }
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['cond_dyn_search'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['cond_pesq'] .= $this->NM_operador;
