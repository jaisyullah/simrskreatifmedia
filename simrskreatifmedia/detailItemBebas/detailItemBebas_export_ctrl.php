<?php
@session_start() ;
$_SESSION['scriptcase']['detailItemBebas']['sc_process_barr'] = true;
require_once('../detailItemBebas/index.php');
unset($_SESSION['scriptcase']['detailItemBebas']['sc_process_barr']);
$ExportCtrl = new detailItemBebas_export_control;
$ExportCtrl->Export_barr();

class detailItemBebas_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_title'] ?> tbitemdrugsell :: Excel</TITLE>
