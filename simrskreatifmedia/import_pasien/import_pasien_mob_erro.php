...
$old_error_handler = set_error_handler("import_pasien_mob_scriptcase_error_handler");

function import_pasien_mob_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['import_pasien_mob']['contr_erro']) && $_SESSION['scriptcase']['import_pasien_mob']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_import_pasien_mob->contr_import_pasien_mob->Apl_com_erro = true;
            if ($inicial_import_pasien_mob->contr_import_pasien_mob->NM_ajax_flag)
            {
                $inicial_import_pasien_mob->contr_import_pasien_mob->NM_ajax_info['errList']['geral_import_pasien_mob'][] = $msg;
                return;
            }
            import_pasien_mob_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function import_pasien_mob_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['import_pasien_mob'])  && '' != $_SESSION['scriptcase']['error_icon']['import_pasien_mob'])  ? $_SESSION['scriptcase']['error_icon']['import_pasien_mob']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['import_pasien_mob']) && '' != $_SESSION['scriptcase']['error_span_title']['import_pasien_mob']) ? $_SESSION['scriptcase']['error_span_title']['import_pasien_mob'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['import_pasien_mob']) && '' != $_SESSION['scriptcase']['error_icon_title']['import_pasien_mob']) ? $_SESSION['scriptcase']['error_icon_title']['import_pasien_mob'] : '';
?>
