  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tabel_piutang_transaksi" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tabel_piutang_transaksi_form();
	}

  // ---------- Validate supplier
  function do_ajax_form_tabel_piutang_transaksi_validate_supplier()
  {
    var nomeCampo_supplier = "supplier";
    var var_supplier = scAjaxGetFieldSelect(nomeCampo_supplier);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tabel_piutang_transaksi_validate_supplier(var_supplier, var_script_case_init, do_ajax_form_tabel_piutang_transaksi_validate_supplier_cb);
  } // do_ajax_form_tabel_piutang_transaksi_validate_supplier

  function do_ajax_form_tabel_piutang_transaksi_validate_supplier_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tabel_piutang_transaksi_validate_supplier_cb

  // ---------- Validate nominal
  function do_ajax_form_tabel_piutang_transaksi_validate_nominal()
  {
    var nomeCampo_nominal = "nominal";
    var var_nominal = scAjaxGetFieldText(nomeCampo_nominal);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tabel_piutang_transaksi_validate_nominal(var_nominal, var_script_case_init, do_ajax_form_tabel_piutang_transaksi_validate_nominal_cb);
  } // do_ajax_form_tabel_piutang_transaksi_validate_nominal

  function do_ajax_form_tabel_piutang_transaksi_validate_nominal_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nominal";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tabel_piutang_transaksi_validate_nominal_cb

  // ---------- Validate kd_giro
  function do_ajax_form_tabel_piutang_transaksi_validate_kd_giro()
  {
    var nomeCampo_kd_giro = "kd_giro";
    var var_kd_giro = scAjaxGetFieldText(nomeCampo_kd_giro);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tabel_piutang_transaksi_validate_kd_giro(var_kd_giro, var_script_case_init, do_ajax_form_tabel_piutang_transaksi_validate_kd_giro_cb);
  } // do_ajax_form_tabel_piutang_transaksi_validate_kd_giro

  function do_ajax_form_tabel_piutang_transaksi_validate_kd_giro_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "kd_giro";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tabel_piutang_transaksi_validate_kd_giro_cb

  // ---------- Validate note
  function do_ajax_form_tabel_piutang_transaksi_validate_note()
  {
    var nomeCampo_note = "note";
    var var_note = scAjaxGetFieldText(nomeCampo_note);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tabel_piutang_transaksi_validate_note(var_note, var_script_case_init, do_ajax_form_tabel_piutang_transaksi_validate_note_cb);
  } // do_ajax_form_tabel_piutang_transaksi_validate_note

  function do_ajax_form_tabel_piutang_transaksi_validate_note_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "note";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tabel_piutang_transaksi_validate_note_cb

  // ---------- Validate tgl
  function do_ajax_form_tabel_piutang_transaksi_validate_tgl()
  {
    var nomeCampo_tgl = "tgl";
    var var_tgl = scAjaxGetFieldText(nomeCampo_tgl);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tabel_piutang_transaksi_validate_tgl(var_tgl, var_script_case_init, do_ajax_form_tabel_piutang_transaksi_validate_tgl_cb);
  } // do_ajax_form_tabel_piutang_transaksi_validate_tgl

  function do_ajax_form_tabel_piutang_transaksi_validate_tgl_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tgl";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tabel_piutang_transaksi_validate_tgl_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tabel_piutang_transaksi_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tabel_piutang_transaksi_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_tabel_piutang_transaksi_submit_form(var_supplier, var_nominal, var_kd_giro, var_note, var_tgl, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tabel_piutang_transaksi_submit_form_cb);
  } // do_ajax_form_tabel_piutang_transaksi_submit_form

  function do_ajax_form_tabel_piutang_transaksi_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tabel_piutang_transaksi_submit_form_cb_after_alert);
  } // do_ajax_form_tabel_piutang_transaksi_submit_form_cb
  function do_ajax_form_tabel_piutang_transaksi_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tabel_piutang_transaksi_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tabel_piutang_transaksi_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_tabel_piutang_transaksi_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tabel_piutang_transaksi_navigate_form_cb);
  } // do_ajax_form_tabel_piutang_transaksi_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tabel_piutang_transaksi']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tabel_piutang_transaksi_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tabel_piutang_transaksi_navigate_form_cb_after_alert);
  } // do_ajax_form_tabel_piutang_transaksi_navigate_form_cb
  function do_ajax_form_tabel_piutang_transaksi_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_tabel_piutang_transaksi_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_tabel_piutang_transaksi_navigate_form_cb_after_alert
  function sc_hide_form_tabel_piutang_transaksi_form()
  {
