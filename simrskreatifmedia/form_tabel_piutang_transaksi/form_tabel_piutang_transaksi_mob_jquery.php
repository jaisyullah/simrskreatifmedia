...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_tgl_hora' + iSeqRow).bind('blur', function() { sc_form_tabel_piutang_transaksi_tgl_onblur(this, iSeqRow) })
                                      .bind('focus', function() { sc_form_tabel_piutang_transaksi_tgl_onfocus(this, iSeqRow) });
} // scJQEventsAdd
...
function scHidePage(pageNo) {
	$("#id_form_tabel_piutang_transaksi_mob_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_tgl" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_tabel_piutang_transaksi_mob_validate_tgl(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
