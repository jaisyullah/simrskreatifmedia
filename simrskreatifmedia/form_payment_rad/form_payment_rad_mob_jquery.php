...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_trancode' + iSeqRow).bind('blur', function() { sc_form_payment_rad_trancode_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_form_payment_rad_trancode_onchange(this, iSeqRow) })
                                      .bind('focus', function() { sc_form_payment_rad_trancode_onfocus(this, iSeqRow) });
  $('#id_sc_field_nostruk' + iSeqRow).bind('blur', function() { sc_form_payment_rad_nostruk_onblur(this, iSeqRow) })
                                     .bind('focus', function() { sc_form_payment_rad_nostruk_onfocus(this, iSeqRow) });
  $('#id_sc_field_custcode' + iSeqRow).bind('blur', function() { sc_form_payment_rad_custcode_onblur(this, iSeqRow) })
                                      .bind('focus', function() { sc_form_payment_rad_custcode_onfocus(this, iSeqRow) });
  $('#id_sc_field_dokter' + iSeqRow).bind('blur', function() { sc_form_payment_rad_dokter_onblur(this, iSeqRow) })
                                    .bind('focus', function() { sc_form_payment_rad_dokter_onfocus(this, iSeqRow) });
  $('#id_sc_field_jmltagihan' + iSeqRow).bind('blur', function() { sc_form_payment_rad_jmltagihan_onblur(this, iSeqRow) })
                                        .bind('focus', function() { sc_form_payment_rad_jmltagihan_onfocus(this, iSeqRow) });
  $('#id_sc_field_jmlbayar' + iSeqRow).bind('blur', function() { sc_form_payment_rad_jmlbayar_onblur(this, iSeqRow) })
                                      .bind('focus', function() { sc_form_payment_rad_jmlbayar_onfocus(this, iSeqRow) });
  $('#id_sc_field_deposit' + iSeqRow).bind('blur', function() { sc_form_payment_rad_deposit_onblur(this, iSeqRow) })
                                     .bind('focus', function() { sc_form_payment_rad_deposit_onfocus(this, iSeqRow) });
  $('#id_sc_field_potongan' + iSeqRow).bind('blur', function() { sc_form_payment_rad_potongan_onblur(this, iSeqRow) })
                                      .bind('focus', function() { sc_form_payment_rad_potongan_onfocus(this, iSeqRow) });
  $('#id_sc_field_hrsdibayar' + iSeqRow).bind('blur', function() { sc_form_payment_rad_hrsdibayar_onblur(this, iSeqRow) })
                                        .bind('focus', function() { sc_form_payment_rad_hrsdibayar_onfocus(this, iSeqRow) });
  $('#id_sc_field_terimadari' + iSeqRow).bind('blur', function() { sc_form_payment_rad_terimadari_onblur(this, iSeqRow) })
                                        .bind('focus', function() { sc_form_payment_rad_terimadari_onfocus(this, iSeqRow) });
  $('#id_sc_field_jenispayment' + iSeqRow).bind('blur', function() { sc_form_payment_rad_jenispayment_onblur(this, iSeqRow) })
                                          .bind('focus', function() { sc_form_payment_rad_jenispayment_onfocus(this, iSeqRow) });
  $('#id_sc_field_instansipenjamin' + iSeqRow).bind('blur', function() { sc_form_payment_rad_instansipenjamin_onblur(this, iSeqRow) })
                                              .bind('focus', function() { sc_form_payment_rad_instansipenjamin_onfocus(this, iSeqRow) });
  $('#id_sc_field_bankdebit' + iSeqRow).bind('blur', function() { sc_form_payment_rad_bankdebit_onblur(this, iSeqRow) })
                                       .bind('focus', function() { sc_form_payment_rad_bankdebit_onfocus(this, iSeqRow) });
  $('#id_sc_field_nokartu' + iSeqRow).bind('blur', function() { sc_form_payment_rad_nokartu_onblur(this, iSeqRow) })
                                     .bind('focus', function() { sc_form_payment_rad_nokartu_onfocus(this, iSeqRow) });
  $('#id_sc_field_sc_field_0' + iSeqRow).bind('blur', function() { sc_form_payment_rad_sc_field_0_onblur(this, iSeqRow) })
                                        .bind('focus', function() { sc_form_payment_rad_sc_field_0_onfocus(this, iSeqRow) });
  $('#id_sc_field_nopayment' + iSeqRow).bind('blur', function() { sc_form_payment_rad_nopayment_onblur(this, iSeqRow) })
                                       .bind('focus', function() { sc_form_payment_rad_nopayment_onfocus(this, iSeqRow) });
  $('#id_sc_field_sc_field_1' + iSeqRow).bind('blur', function() { sc_form_payment_rad_sc_field_1_onblur(this, iSeqRow) })
                                        .bind('focus', function() { sc_form_payment_rad_sc_field_1_onfocus(this, iSeqRow) });
  $('#id_sc_field_detailpemeriksaan' + iSeqRow).bind('blur', function() { sc_form_payment_rad_detailpemeriksaan_onblur(this, iSeqRow) })
                                               .bind('focus', function() { sc_form_payment_rad_detailpemeriksaan_onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_form_payment_rad_trancode_onblur(oThis, iSeqRow) {
  do_ajax_form_payment_rad_mob_validate_trancode();
  scCssBlur(oThis);
}

function sc_form_payment_rad_trancode_onchange(oThis, iSeqRow) {
  do_ajax_form_payment_rad_mob_refresh_trancode();
}

function sc_form_payment_rad_trancode_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_payment_rad_nostruk_onblur(oThis, iSeqRow) {
  do_ajax_form_payment_rad_mob_validate_nostruk();
  scCssBlur(oThis);
}

function sc_form_payment_rad_nostruk_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_payment_rad_custcode_onblur(oThis, iSeqRow) {
  do_ajax_form_payment_rad_mob_validate_custcode();
  scCssBlur(oThis);
}

function sc_form_payment_rad_custcode_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_payment_rad_dokter_onblur(oThis, iSeqRow) {
  do_ajax_form_payment_rad_mob_validate_dokter();
  scCssBlur(oThis);
}

function sc_form_payment_rad_dokter_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_payment_rad_jmltagihan_onblur(oThis, iSeqRow) {
  do_ajax_form_payment_rad_mob_validate_jmltagihan();
  scCssBlur(oThis);
}

function sc_form_payment_rad_jmltagihan_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_payment_rad_jmlbayar_onblur(oThis, iSeqRow) {
  do_ajax_form_payment_rad_mob_validate_jmlbayar();
  scCssBlur(oThis);
}

function sc_form_payment_rad_jmlbayar_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_payment_rad_deposit_onblur(oThis, iSeqRow) {
  do_ajax_form_payment_rad_mob_validate_deposit();
  scCssBlur(oThis);
}

function sc_form_payment_rad_deposit_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_payment_rad_potongan_onblur(oThis, iSeqRow) {
  do_ajax_form_payment_rad_mob_validate_potongan();
  scCssBlur(oThis);
}

function sc_form_payment_rad_potongan_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_payment_rad_hrsdibayar_onblur(oThis, iSeqRow) {
  do_ajax_form_payment_rad_mob_validate_hrsdibayar();
  scCssBlur(oThis);
}

function sc_form_payment_rad_hrsdibayar_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_payment_rad_terimadari_onblur(oThis, iSeqRow) {
  do_ajax_form_payment_rad_mob_validate_terimadari();
  scCssBlur(oThis);
}

function sc_form_payment_rad_terimadari_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_payment_rad_jenispayment_onblur(oThis, iSeqRow) {
  do_ajax_form_payment_rad_mob_validate_jenispayment();
  scCssBlur(oThis);
}

function sc_form_payment_rad_jenispayment_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_payment_rad_instansipenjamin_onblur(oThis, iSeqRow) {
  do_ajax_form_payment_rad_mob_validate_instansipenjamin();
  scCssBlur(oThis);
}

function sc_form_payment_rad_instansipenjamin_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_payment_rad_bankdebit_onblur(oThis, iSeqRow) {
  do_ajax_form_payment_rad_mob_validate_bankdebit();
  scCssBlur(oThis);
}

function sc_form_payment_rad_bankdebit_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_payment_rad_nokartu_onblur(oThis, iSeqRow) {
  do_ajax_form_payment_rad_mob_validate_nokartu();
  scCssBlur(oThis);
}

function sc_form_payment_rad_nokartu_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_payment_rad_sc_field_0_onblur(oThis, iSeqRow) {
  do_ajax_form_payment_rad_mob_validate_sc_field_0();
  scCssBlur(oThis);
}

function sc_form_payment_rad_sc_field_0_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_payment_rad_nopayment_onblur(oThis, iSeqRow) {
  do_ajax_form_payment_rad_mob_validate_nopayment();
  scCssBlur(oThis);
}

function sc_form_payment_rad_nopayment_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_payment_rad_sc_field_1_onblur(oThis, iSeqRow) {
  do_ajax_form_payment_rad_mob_validate_sc_field_1();
  scCssBlur(oThis);
}

function sc_form_payment_rad_sc_field_1_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_payment_rad_detailpemeriksaan_onblur(oThis, iSeqRow) {
  do_ajax_form_payment_rad_mob_validate_detailpemeriksaan();
  scCssBlur(oThis);
}

function sc_form_payment_rad_detailpemeriksaan_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function scHidePage(pageNo) {
	$("#id_form_payment_rad_mob_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_trandate" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_payment_rad_mob_validate_trandate(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_paiddate" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_payment_rad_mob_validate_paiddate(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
