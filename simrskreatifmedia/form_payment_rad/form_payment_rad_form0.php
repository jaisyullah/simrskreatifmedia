...
<HEAD>
 <TITLE><?php if ('novo' == $this->nmgp_opcao) { echo strip_tags("" . $this->Ini->Nm_lang['lang_othr_frmi_titl'] . " - Pembayaran Radiologi"); } else { echo strip_tags("" . $this->Ini->Nm_lang['lang_othr_frmu_titl'] . " - Pembayaran Radiologi"); } ?></TITLE>
...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_rad']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_payment_rad/form_payment_rad_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_payment_rad_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_payment_rad_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_rad']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_rad']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_rad']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_rad']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_rad']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_rad']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_rad']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_rad']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
?>
...
<?php
 include_once("form_payment_rad_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_rad']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_rad']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_payment_rad'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_payment_rad'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_rad']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_rad']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_rad']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_rad']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_rad']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<div class="scFormHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFormHeaderFont" style="float: left; text-transform: uppercase;"><?php if ($this->nmgp_opcao == "novo") { echo "" . $this->Ini->Nm_lang['lang_othr_frmi_titl'] . " - Pembayaran Radiologi"; } else { echo "" . $this->Ini->Nm_lang['lang_othr_frmu_titl'] . " - Pembayaran Radiologi"; } ?></div>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_rad']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_rad']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_rad']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_rad']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_rad']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_rad']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_rad']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_rad']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_rad']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_rad']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_rad']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_rad']['fast_search'][2] : "";
?> 
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_rad']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_rad']['run_iframe'] != "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_rad']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_rad']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_rad']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_rad']['run_iframe'] == "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_rad']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_rad']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_rad']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_rad']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_rad']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_rad']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_rad']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_rad']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_rad']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_rad']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_rad']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_rad']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_trancode_label" id="hidden_field_label_trancode" style="<?php echo $sStyleHidden_trancode; ?>"><span id="id_label_trancode"><?php echo $this->nm_new_label['trancode']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_rad']['php_cmp_required']['trancode']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_rad']['php_cmp_required']['trancode'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<span id="id_read_on_trancode" class="sc-ui-readonly-trancode css_trancode_line" style="<?php echo $sStyleReadLab_trancode; ?>"><?php echo $this->trancode; ?></span><span id="id_read_off_trancode" class="css_read_off_trancode" style="white-space: nowrap;<?php echo $sStyleReadInp_trancode; ?>">
 ...
 size=20 maxlength=20 alt="{datatype: 'text', maxLength: 20, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php
   $Sc_iframe_master = ($this->Embutida_call) ? 'nmgp_iframe_ret*scinnmsc_iframe_liga_form_payment_rad*scout' : '';
   if (isset($this->Ini->sc_lig_md5["grid_select_rad"]) && $this->Ini->sc_lig_md5["grid_select_rad"] == "S") {
       $Parms_Lig  = "nmgp_url_saida*scin*scoutnmgp_parms_ret*scinF1,trancode,trancode*scoutnm_evt_ret_busca*scinsc_form_payment_rad_trancode_onchange(this)*scout" . $Sc_iframe_master;
       $Md5_Lig    = "@SC_par@" . $this->form_encode_input($this->Ini->sc_page) . "@SC_par@form_payment_rad@SC_par@" . md5($Parms_Lig);
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_rad']['Lig_Md5'][md5($Parms_Lig)] = $Parms_Lig;
   } else {
       $Md5_Lig  = "nmgp_url_saida*scin*scoutnmgp_parms_ret*scinF1,trancode,trancode*scoutnm_evt_ret_busca*scinsc_form_payment_rad_trancode_onchange(this)*scout" . $Sc_iframe_master;
   }
?>
...
<span id="id_read_on_potongan" class="sc-ui-readonly-potongan css_potongan_line" style="<?php echo $sStyleReadLab_potongan; ?>"><?php echo $this->potongan; ?></span><span id="id_read_off_potongan" class="css_read_off_potongan" style="white-space: nowrap;<?php echo $sStyleReadInp_potongan; ?>">
 ...
 size=8 alt="{datatype: 'currency', currencySymbol: '<?php echo $this->field_config['potongan']['symbol_mon']; ?>', currencyPosition: '<?php echo ((1 == $this->field_config['potongan']['format_pos'] || 3 == $this->field_config['potongan']['format_pos']) ? 'left' : 'right'); ?>', maxLength: 8, precision: 0, decimalSep: '<?php echo str_replace("'", "\'", $this->field_config['potongan']['symbol_dec']); ?>', thousandsSep: '<?php echo str_replace("'", "\'", $this->field_config['potongan']['symbol_grp']); ?>', thousandsFormat: <?php echo $this->field_config['potongan']['symbol_fmt']; ?>, manualDecimals: false, allowNegative: false, onlyNegative: false, negativePos: <?php echo (4 == $this->field_config['potongan']['format_neg'] ? "'suffix'" : "'prefix'") ?>, enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    ...
    {
        $this->nm_new_label['hrsdibayar'] = "Harus Dibayar";
    }
?>
<?php
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
...
<input type=hidden name="terimadari" value="<?php echo $this->form_encode_input($this->terimadari) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>
...
else
{
   ...
   while (!empty($todo[$x])) 
   {
          $cadaselect = explode("?#?", $todo[$x]) ; 
          if ($cadaselect[1] == "@ ") {$cadaselect[1]= trim($cadaselect[1]); } ; 
          if (isset($this->Embutida_ronly) && $this->Embutida_ronly && isset($this->terimadari_1))
          {
              foreach ($this->terimadari_1 as $tmp_terimadari)
              {
                  if (trim($tmp_terimadari) === trim($cadaselect[1])) { $terimadari_look .= $cadaselect[0] . '__SC_BREAK_LINE__'; }
              }
          }
          elseif (trim($this->terimadari) === trim($cadaselect[1])) { $terimadari_look .= $cadaselect[0]; } 
          $x++; 
   }

?>
<input type="hidden" name="terimadari" value="<?php echo $this->form_encode_input($terimadari) . "\">" . $terimadari_look . ""; ?>
<?php } else { ?>
<?php
   $todo = $this->Form_lookup_terimadari();
   $x = 0 ; 
   $terimadari_look = ""; 
   while (!empty($todo[$x])) 
   {
          ...
          if (empty($terimadari_look))
          {
              $terimadari_look = $this->terimadari;
          }
   $x = 0; 
   echo "<span id=\"id_read_on_terimadari\" class=\"css_terimadari_line\" style=\"" .  $sStyleReadLab_terimadari . "\">" . $this->form_encode_input($terimadari_look) . "</span><span id=\"id_read_off_terimadari\" class=\"css_read_off_terimadari\" style=\"white-space: nowrap; " . $sStyleReadInp_terimadari . "\">";
   echo " <span id=\"idAjaxSelect_terimadari\"><select class=\"sc-js-input scFormObjectOdd css_terimadari_obj\" style=\"\" id=\"id_sc_field_terimadari\" name=\"terimadari\" size=\"1\" alt=\"{type: 'select', enterTab: false}\">" ; 
   echo "\r" ; 
   while (!empty($todo[$x]) && !$nm_nao_carga) 
   {
          $cadaselect = explode("?#?", $todo[$x]) ; 
          if ($cadaselect[1] == "@ ") {$cadaselect[1]= trim($cadaselect[1]); } ; 
          echo "  <option value=\"$cadaselect[1]\"" ; 
          if (trim($this->terimadari) === trim($cadaselect[1])) 
          {
              echo " selected" ; 
          }
          if (strtoupper($cadaselect[2]) == "S") 
          {
              if (empty($this->terimadari)) 
              {
                  echo " selected" ;
              } 
           } 
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_rad']['Lookup_jenispayment'][] = 'TUNAI'; ?>
 <option  value="KARTU KREDIT" <?php  if ($this->jenispayment == "KARTU KREDIT") { echo " selected" ;} ?>>KARTU KREDIT</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_rad']['Lookup_jenispayment'][] = 'KARTU KREDIT'; ?>
 <option  value="KARTU DEBIT" <?php  if ($this->jenispayment == "KARTU DEBIT") { echo " selected" ;} ?>>KARTU DEBIT</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_rad']['Lookup_jenispayment'][] = 'KARTU DEBIT'; ?>
 <option  value="ASURANSI" <?php  if ($this->jenispayment == "ASURANSI") { echo " selected" ;} ?>>ASURANSI</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_rad']['Lookup_jenispayment'][] = 'ASURANSI'; ?>
 <option  value="KARYAWAN" <?php  if ($this->jenispayment == "KARYAWAN") { echo " selected" ;} ?>>KARYAWAN</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_rad']['Lookup_jenispayment'][] = 'KARYAWAN'; ?>
 <option  value="KOMBINASI" <?php  if ($this->jenispayment == "KOMBINASI") { echo " selected" ;} ?>>KOMBINASI</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_rad']['Lookup_jenispayment'][] = 'KOMBINASI'; ?>
 </select></span>
</span><?php  }?>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    ...
    {
        $this->nm_new_label['instansipenjamin'] = "Instansi Penjamin";
    }
?>
<?php
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
...
<?php } else { ?>
<span id="id_read_on_instansipenjamin" class="sc-ui-readonly-instansipenjamin css_instansipenjamin_line" style="<?php echo $sStyleReadLab_instansipenjamin; ?>"><?php echo $this->instansipenjamin; ?></span><span id="id_read_off_instansipenjamin" class="css_read_off_instansipenjamin" style="white-space: nowrap;<?php echo $sStyleReadInp_instansipenjamin; ?>">
 <input class="sc-js-input scFormObjectOdd css_instansipenjamin_obj" style="" id="id_sc_field_instansipenjamin" type=text name="instansipenjamin" value="<?php echo $this->form_encode_input($instansipenjamin) ?>"
...
<input type="hidden" name="bankdebit" value="<?php echo $this->form_encode_input($bankdebit) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>
...
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["bankdebit"]) &&  $this->nmgp_cmp_readonly["bankdebit"] == "on") { 
 ...
 ?>
<input type="hidden" name="bankdebit" value="<?php echo $this->form_encode_input($bankdebit) . "\">" . $bankdebit . ""; ?>
<?php } else { ?>
<span id="id_read_on_bankdebit" class="sc-ui-readonly-bankdebit css_bankdebit_line" style="<?php echo $sStyleReadLab_bankdebit; ?>"><?php echo $this->bankdebit; ?></span><span id="id_read_off_bankdebit" class="css_read_off_bankdebit" style="white-space: nowrap;<?php echo $sStyleReadInp_bankdebit; ?>">
 <input class="sc-js-input scFormObjectOdd css_bankdebit_obj" style="" id="id_sc_field_bankdebit" type=text name="bankdebit" value="<?php echo $this->form_encode_input($bankdebit) ?>"
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_nopayment_line" id="hidden_field_data_nopayment" style="<?php echo $sStyleHidden_nopayment; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_nopayment_line" style="vertical-align: top;padding: 0px">
...
<TABLE align="center" id="hidden_bloco_3" class="scFormTable" width="100%" style="height: 100%;"><?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    if (!isset($this->nm_new_label['detailpemeriksaan']))
    {
        $this->nm_new_label['detailpemeriksaan'] = "PEMERIKSAAN";
    }
?>
<?php
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
   $nm_img_fun_cel  = ($nm_img_fun_cel  == $this->Ini->img_fun_imp    ? $this->Ini->img_fun_par  : $this->Ini->img_fun_imp);
   $detailpemeriksaan = $this->detailpemeriksaan;
   $sStyleHidden_detailpemeriksaan = '';
   if (isset($this->nmgp_cmp_hidden['detailpemeriksaan']) && $this->nmgp_cmp_hidden['detailpemeriksaan'] == 'off')
   {
       unset($this->nmgp_cmp_hidden['detailpemeriksaan']);
       $sStyleHidden_detailpemeriksaan = 'display: none;';
   }
   $bTestReadOnly = true;
   $sStyleReadLab_detailpemeriksaan = 'display: none;';
   $sStyleReadInp_detailpemeriksaan = '';
   if (/*$this->nmgp_opcao != "novo" && */isset($this->nmgp_cmp_readonly['detailpemeriksaan']) && $this->nmgp_cmp_readonly['detailpemeriksaan'] == 'on')
   {
       $bTestReadOnly = false;
       unset($this->nmgp_cmp_readonly['detailpemeriksaan']);
       $sStyleReadLab_detailpemeriksaan = '';
       $sStyleReadInp_detailpemeriksaan = 'display: none;';
   }
?>
<?php if (isset($this->nmgp_cmp_hidden['detailpemeriksaan']) && $this->nmgp_cmp_hidden['detailpemeriksaan'] == 'off') { $sc_hidden_yes++;  ?>
<input type="hidden" name="detailpemeriksaan" value="<?php echo $this->form_encode_input($detailpemeriksaan) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormLabelOdd scUiLabelWidthFix css_detailpemeriksaan_label" id="hidden_field_label_detailpemeriksaan" style="<?php echo $sStyleHidden_detailpemeriksaan; ?>"><span id="id_label_detailpemeriksaan"><?php echo $this->nm_new_label['detailpemeriksaan']; ?></span></TD>
    <TD class="scFormDataOdd css_detailpemeriksaan_line" id="hidden_field_data_detailpemeriksaan" style="<?php echo $sStyleHidden_detailpemeriksaan; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td width="100%" class="scFormDataFontOdd css_detailpemeriksaan_line" style="vertical-align: top;padding: 0px">
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_rad']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_detailPemeriksaan'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_rad']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_detailPemeriksaan'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_rad']['form_tbdetailrad_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_rad']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_detailPemeriksaan'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_rad']['form_tbdetailrad_script_case_init'] = $this->Ini->sc_page;
 }
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_rad']['form_tbdetailrad_script_case_init'] ]['form_tbdetailrad']['embutida_proc']  = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_rad']['form_tbdetailrad_script_case_init'] ]['form_tbdetailrad']['embutida_form']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_rad']['form_tbdetailrad_script_case_init'] ]['form_tbdetailrad']['embutida_call']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_rad']['form_tbdetailrad_script_case_init'] ]['form_tbdetailrad']['embutida_multi'] = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_rad']['form_tbdetailrad_script_case_init'] ]['form_tbdetailrad']['embutida_liga_form_insert'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_rad']['form_tbdetailrad_script_case_init'] ]['form_tbdetailrad']['embutida_liga_form_update'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_rad']['form_tbdetailrad_script_case_init'] ]['form_tbdetailrad']['embutida_liga_form_delete'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_rad']['form_tbdetailrad_script_case_init'] ]['form_tbdetailrad']['embutida_liga_form_btn_nav'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_rad']['form_tbdetailrad_script_case_init'] ]['form_tbdetailrad']['embutida_liga_grid_edit'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_rad']['form_tbdetailrad_script_case_init'] ]['form_tbdetailrad']['embutida_liga_grid_edit_link'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_rad']['form_tbdetailrad_script_case_init'] ]['form_tbdetailrad']['embutida_liga_qtd_reg'] = '10';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_rad']['form_tbdetailrad_script_case_init'] ]['form_tbdetailrad']['embutida_liga_tp_pag'] = 'parcial';
 ...
 if ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_rad']['form_tbdetailrad_script_case_init'] ]['form_payment_rad']['total'] < 0)
 {
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_payment_rad_empty.htm' : $this->Ini->link_form_tbdetailrad_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_session=' . session_id() . '&script_case_detail=Y';
if (isset($this->Ini->sc_lig_target['C_@scinf_detailPemeriksaan']) && 'nmsc_iframe_liga_form_tbdetailrad' != $this->Ini->sc_lig_target['C_@scinf_detailPemeriksaan'])
{
    if ('novo' != $this->nmgp_opcao)
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_rad']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_detailPemeriksaan'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_rad']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_rad']['form_tbdetailrad_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
    scOpenMasterDetail("<?php echo $this->Ini->sc_lig_target['C_@scinf_detailPemeriksaan'] ?>", "<?php echo $sDetailSrc; ?>");
});
</script>
<?php
}
...
?>
</td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_detailpemeriksaan_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_detailpemeriksaan_text"></span></td></tr></table></td></tr></table></TD>
   <?php }?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_rad']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_rad']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_rad']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_rad']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_rad']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_rad']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_rad']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_rad']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_rad']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_rad']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_rad']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_payment_rad");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_payment_rad");
 parent.scAjaxDetailHeight("form_payment_rad", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_rad']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
