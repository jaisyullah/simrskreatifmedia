  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbpaket" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbpaket_form();
	}

  // ---------- Validate kodepaket
  function do_ajax_form_tbpaket_validate_kodepaket()
  {
    var nomeCampo_kodepaket = "kodepaket";
    var var_kodepaket = scAjaxGetFieldText(nomeCampo_kodepaket);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbpaket_validate_kodepaket(var_kodepaket, var_script_case_init, do_ajax_form_tbpaket_validate_kodepaket_cb);
  } // do_ajax_form_tbpaket_validate_kodepaket

  function do_ajax_form_tbpaket_validate_kodepaket_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbpaket_validate_kodepaket_cb

  // ---------- Validate hargapaket
  function do_ajax_form_tbpaket_validate_hargapaket()
  {
    var nomeCampo_hargapaket = "hargapaket";
    var var_hargapaket = scAjaxGetFieldText(nomeCampo_hargapaket);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbpaket_validate_hargapaket(var_hargapaket, var_script_case_init, do_ajax_form_tbpaket_validate_hargapaket_cb);
  } // do_ajax_form_tbpaket_validate_hargapaket

  function do_ajax_form_tbpaket_validate_hargapaket_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbpaket_validate_hargapaket_cb

  // ---------- Validate namapaket
  function do_ajax_form_tbpaket_validate_namapaket()
  {
    var nomeCampo_namapaket = "namapaket";
    var var_namapaket = scAjaxGetFieldText(nomeCampo_namapaket);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbpaket_validate_namapaket(var_namapaket, var_script_case_init, do_ajax_form_tbpaket_validate_namapaket_cb);
  } // do_ajax_form_tbpaket_validate_namapaket

  function do_ajax_form_tbpaket_validate_namapaket_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbpaket_validate_namapaket_cb

  // ---------- Validate aktif
  function do_ajax_form_tbpaket_validate_aktif()
  {
    var nomeCampo_aktif = "aktif";
    var var_aktif = scAjaxGetFieldSelect(nomeCampo_aktif);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbpaket_validate_aktif(var_aktif, var_script_case_init, do_ajax_form_tbpaket_validate_aktif_cb);
  } // do_ajax_form_tbpaket_validate_aktif

  function do_ajax_form_tbpaket_validate_aktif_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "aktif";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbpaket_validate_aktif_cb

  // ---------- Validate unit
  function do_ajax_form_tbpaket_validate_unit()
  {
    var nomeCampo_unit = "unit";
    var var_unit = scAjaxGetFieldText(nomeCampo_unit);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbpaket_validate_unit(var_unit, var_script_case_init, do_ajax_form_tbpaket_validate_unit_cb);
  } // do_ajax_form_tbpaket_validate_unit

  function do_ajax_form_tbpaket_validate_unit_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "unit";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbpaket_validate_unit_cb

  // ---------- Validate akomodasi
  function do_ajax_form_tbpaket_validate_akomodasi()
  {
    var nomeCampo_akomodasi = "akomodasi";
    var var_akomodasi = scAjaxGetFieldText(nomeCampo_akomodasi);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbpaket_validate_akomodasi(var_akomodasi, var_script_case_init, do_ajax_form_tbpaket_validate_akomodasi_cb);
  } // do_ajax_form_tbpaket_validate_akomodasi

  function do_ajax_form_tbpaket_validate_akomodasi_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbpaket_validate_akomodasi_cb

  // ---------- Validate tindakan
  function do_ajax_form_tbpaket_validate_tindakan()
  {
    var nomeCampo_tindakan = "tindakan";
    var var_tindakan = scAjaxGetFieldText(nomeCampo_tindakan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbpaket_validate_tindakan(var_tindakan, var_script_case_init, do_ajax_form_tbpaket_validate_tindakan_cb);
  } // do_ajax_form_tbpaket_validate_tindakan

  function do_ajax_form_tbpaket_validate_tindakan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbpaket_validate_tindakan_cb

  // ---------- Validate sc_field_0
  function do_ajax_form_tbpaket_validate_sc_field_0()
  {
    var nomeCampo_sc_field_0 = "sc_field_0";
    var var_sc_field_0 = scAjaxGetFieldText(nomeCampo_sc_field_0);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbpaket_validate_sc_field_0(var_sc_field_0, var_script_case_init, do_ajax_form_tbpaket_validate_sc_field_0_cb);
  } // do_ajax_form_tbpaket_validate_sc_field_0

  function do_ajax_form_tbpaket_validate_sc_field_0_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbpaket_validate_sc_field_0_cb

  // ---------- Validate sc_field_1
  function do_ajax_form_tbpaket_validate_sc_field_1()
  {
    var nomeCampo_sc_field_1 = "sc_field_1";
    var var_sc_field_1 = scAjaxGetFieldText(nomeCampo_sc_field_1);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbpaket_validate_sc_field_1(var_sc_field_1, var_script_case_init, do_ajax_form_tbpaket_validate_sc_field_1_cb);
  } // do_ajax_form_tbpaket_validate_sc_field_1

  function do_ajax_form_tbpaket_validate_sc_field_1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbpaket_validate_sc_field_1_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tbpaket_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tbpaket_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_tbpaket_submit_form(var_kodepaket, var_hargapaket, var_namapaket, var_aktif, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbpaket_submit_form_cb);
  } // do_ajax_form_tbpaket_submit_form

  function do_ajax_form_tbpaket_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tbpaket_submit_form_cb_after_alert);
  } // do_ajax_form_tbpaket_submit_form_cb
  function do_ajax_form_tbpaket_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbpaket_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_tbdetailpaket1"] = "off";
  scStatusDetail["form_tbdetailpaket2"] = "off";
  scStatusDetail["form_tbdetailpaket3"] = "off";
  scStatusDetail["form_tbdetailpaket4"] = "off";
  scStatusDetail["form_tbdetailpaket5"] = "off";

  function do_ajax_form_tbpaket_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    scStatusDetail["form_tbdetailpaket1"] = "on";
    scStatusDetail["form_tbdetailpaket2"] = "on";
    scStatusDetail["form_tbdetailpaket3"] = "on";
    scStatusDetail["form_tbdetailpaket4"] = "on";
    scStatusDetail["form_tbdetailpaket5"] = "on";
    x_ajax_form_tbpaket_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbpaket_navigate_form_cb);
  } // do_ajax_form_tbpaket_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbpaket']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbpaket_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_tbdetailpaket1"] && "nmsc_iframe_liga_form_tbdetailpaket1" != scMasterDetailIframe["nmsc_iframe_liga_form_tbdetailpaket1"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_tbdetailpaket1"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_tbdetailpaket1').contentWindow.nm_move('apl_detalhe', true, '1000');
        document.getElementById('nmsc_iframe_liga_form_tbdetailpaket1').style.height = "1000";
        document.getElementById('nmsc_iframe_liga_form_tbdetailpaket1').style.display = "none";
    }
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_tbdetailpaket2"] && "nmsc_iframe_liga_form_tbdetailpaket2" != scMasterDetailIframe["nmsc_iframe_liga_form_tbdetailpaket2"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_tbdetailpaket2"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_tbdetailpaket2').contentWindow.nm_move('apl_detalhe', true, '1000');
        document.getElementById('nmsc_iframe_liga_form_tbdetailpaket2').style.height = "1000";
        document.getElementById('nmsc_iframe_liga_form_tbdetailpaket2').style.display = "none";
    }
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_tbdetailpaket3"] && "nmsc_iframe_liga_form_tbdetailpaket3" != scMasterDetailIframe["nmsc_iframe_liga_form_tbdetailpaket3"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_tbdetailpaket3"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_tbdetailpaket3').contentWindow.nm_move('apl_detalhe', true, '1000');
        document.getElementById('nmsc_iframe_liga_form_tbdetailpaket3').style.height = "1000";
        document.getElementById('nmsc_iframe_liga_form_tbdetailpaket3').style.display = "none";
    }
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_tbdetailpaket4"] && "nmsc_iframe_liga_form_tbdetailpaket4" != scMasterDetailIframe["nmsc_iframe_liga_form_tbdetailpaket4"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_tbdetailpaket4"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_tbdetailpaket4').contentWindow.nm_move('apl_detalhe', true, '1000');
        document.getElementById('nmsc_iframe_liga_form_tbdetailpaket4').style.height = "1000";
        document.getElementById('nmsc_iframe_liga_form_tbdetailpaket4').style.display = "none";
    }
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_tbdetailpaket5"] && "nmsc_iframe_liga_form_tbdetailpaket5" != scMasterDetailIframe["nmsc_iframe_liga_form_tbdetailpaket5"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_tbdetailpaket5"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_tbdetailpaket5').contentWindow.nm_move('apl_detalhe', true, '1000');
        document.getElementById('nmsc_iframe_liga_form_tbdetailpaket5').style.height = "1000";
        document.getElementById('nmsc_iframe_liga_form_tbdetailpaket5').style.display = "none";
    }
    scAjaxSetBtnVars();
    ...
    sc_change_tabs(false, 'hidden_bloco_5', 'id_tabs_1_5');
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbpaket_navigate_form_cb_after_alert);
  } // do_ajax_form_tbpaket_navigate_form_cb
  function do_ajax_form_tbpaket_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_tbpaket_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_tbpaket_navigate_form_cb_after_alert
  function sc_hide_form_tbpaket_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_tbdetailpaket1"] && "off" == scStatusDetail["form_tbdetailpaket2"] && "off" == scStatusDetail["form_tbdetailpaket3"] && "off" == scStatusDetail["form_tbdetailpaket4"] && "off" == scStatusDetail["form_tbdetailpaket5"])
    {
      return true;
    }
    return false;
