<?php
@session_start() ;
$_SESSION['scriptcase']['his_grid_poli_farmasi']['sc_process_barr'] = true;
require_once('../his_grid_poli_farmasi/index.php');
unset($_SESSION['scriptcase']['his_grid_poli_farmasi']['sc_process_barr']);
$ExportCtrl = new his_grid_poli_farmasi_export_control;
$ExportCtrl->Export_barr();

class his_grid_poli_farmasi_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_title'] ?> tbreseprawatjalan :: Excel</TITLE>
