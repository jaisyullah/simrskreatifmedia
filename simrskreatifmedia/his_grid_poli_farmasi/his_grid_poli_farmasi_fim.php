...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____his_grid_poli_farmasi"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____his_grid_poli_farmasi"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['his_grid_poli_farmasi']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['his_grid_poli_farmasi']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['his_grid_poli_farmasi']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['his_grid_poli_farmasi']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['his_grid_poli_farmasi']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>his_grid_poli_farmasi</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['his_grid_poli_farmasi']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['his_grid_poli_farmasi']['embutida_filho'] as $ind => $sc_init)
          {
