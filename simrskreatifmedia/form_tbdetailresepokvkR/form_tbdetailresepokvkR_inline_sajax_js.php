  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbdetailresepokvkR_inline" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbdetailresepokvkR_inline_form();
	}

  // ---------- Validate item_
  function do_ajax_form_tbdetailresepokvkR_inline_validate_item_()
  {
    var nomeCampo_item_ = "item_";
    var var_item_ = scAjaxGetFieldSelect(nomeCampo_item_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdetailresepokvkR_inline_validate_item_(var_item_, var_script_case_init, do_ajax_form_tbdetailresepokvkR_inline_validate_item__cb);
  } // do_ajax_form_tbdetailresepokvkR_inline_validate_item_

  function do_ajax_form_tbdetailresepokvkR_inline_validate_item__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdetailresepokvkR_inline_validate_item__cb

  // ---------- Validate jumlah_
  function do_ajax_form_tbdetailresepokvkR_inline_validate_jumlah_()
  {
    var nomeCampo_jumlah_ = "jumlah_";
    var var_jumlah_ = scAjaxGetFieldText(nomeCampo_jumlah_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdetailresepokvkR_inline_validate_jumlah_(var_jumlah_, var_script_case_init, do_ajax_form_tbdetailresepokvkR_inline_validate_jumlah__cb);
  } // do_ajax_form_tbdetailresepokvkR_inline_validate_jumlah_

  function do_ajax_form_tbdetailresepokvkR_inline_validate_jumlah__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "jumlah_";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdetailresepokvkR_inline_validate_jumlah__cb

  // ---------- Validate satuan_
  function do_ajax_form_tbdetailresepokvkR_inline_validate_satuan_()
  {
    var nomeCampo_satuan_ = "satuan_";
    var var_satuan_ = scAjaxGetFieldSelect(nomeCampo_satuan_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdetailresepokvkR_inline_validate_satuan_(var_satuan_, var_script_case_init, do_ajax_form_tbdetailresepokvkR_inline_validate_satuan__cb);
  } // do_ajax_form_tbdetailresepokvkR_inline_validate_satuan_

  function do_ajax_form_tbdetailresepokvkR_inline_validate_satuan__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "satuan_";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdetailresepokvkR_inline_validate_satuan__cb

  // ---------- Validate biaya_
  function do_ajax_form_tbdetailresepokvkR_inline_validate_biaya_()
  {
    var nomeCampo_biaya_ = "biaya_";
    var var_biaya_ = scAjaxGetFieldText(nomeCampo_biaya_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdetailresepokvkR_inline_validate_biaya_(var_biaya_, var_script_case_init, do_ajax_form_tbdetailresepokvkR_inline_validate_biaya__cb);
  } // do_ajax_form_tbdetailresepokvkR_inline_validate_biaya_

  function do_ajax_form_tbdetailresepokvkR_inline_validate_biaya__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "biaya_";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdetailresepokvkR_inline_validate_biaya__cb

  // ---------- Validate diskon_
  function do_ajax_form_tbdetailresepokvkR_inline_validate_diskon_()
  {
    var nomeCampo_diskon_ = "diskon_";
    var var_diskon_ = scAjaxGetFieldText(nomeCampo_diskon_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdetailresepokvkR_inline_validate_diskon_(var_diskon_, var_script_case_init, do_ajax_form_tbdetailresepokvkR_inline_validate_diskon__cb);
  } // do_ajax_form_tbdetailresepokvkR_inline_validate_diskon_

  function do_ajax_form_tbdetailresepokvkR_inline_validate_diskon__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "diskon_";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdetailresepokvkR_inline_validate_diskon__cb

  // ---------- Validate signa_
  function do_ajax_form_tbdetailresepokvkR_inline_validate_signa_()
  {
    var nomeCampo_signa_ = "signa_";
    var var_signa_ = scAjaxGetFieldSelect(nomeCampo_signa_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdetailresepokvkR_inline_validate_signa_(var_signa_, var_script_case_init, do_ajax_form_tbdetailresepokvkR_inline_validate_signa__cb);
  } // do_ajax_form_tbdetailresepokvkR_inline_validate_signa_

  function do_ajax_form_tbdetailresepokvkR_inline_validate_signa__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "signa_";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdetailresepokvkR_inline_validate_signa__cb

  // ---------- Validate trandate_
  function do_ajax_form_tbdetailresepokvkR_inline_validate_trandate_()
  {
    var nomeCampo_trandate_ = "trandate_";
    var var_trandate_ = scAjaxGetFieldText(nomeCampo_trandate_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdetailresepokvkR_inline_validate_trandate_(var_trandate_, var_script_case_init, do_ajax_form_tbdetailresepokvkR_inline_validate_trandate__cb);
  } // do_ajax_form_tbdetailresepokvkR_inline_validate_trandate_

  function do_ajax_form_tbdetailresepokvkR_inline_validate_trandate__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdetailresepokvkR_inline_validate_trandate__cb

  // ---------- Validate id_
  function do_ajax_form_tbdetailresepokvkR_inline_validate_id_()
  {
    var nomeCampo_id_ = "id_";
    var var_id_ = scAjaxGetFieldHidden(nomeCampo_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdetailresepokvkR_inline_validate_id_(var_id_, var_script_case_init, do_ajax_form_tbdetailresepokvkR_inline_validate_id__cb);
  } // do_ajax_form_tbdetailresepokvkR_inline_validate_id_

  function do_ajax_form_tbdetailresepokvkR_inline_validate_id__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id_";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdetailresepokvkR_inline_validate_id__cb

  // ---------- Validate trancode_
  function do_ajax_form_tbdetailresepokvkR_inline_validate_trancode_()
  {
    var nomeCampo_trancode_ = "trancode_";
    var var_trancode_ = scAjaxGetFieldText(nomeCampo_trancode_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdetailresepokvkR_inline_validate_trancode_(var_trancode_, var_script_case_init, do_ajax_form_tbdetailresepokvkR_inline_validate_trancode__cb);
  } // do_ajax_form_tbdetailresepokvkR_inline_validate_trancode_

  function do_ajax_form_tbdetailresepokvkR_inline_validate_trancode__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdetailresepokvkR_inline_validate_trancode__cb

  // ---------- Validate terpakai_
  function do_ajax_form_tbdetailresepokvkR_inline_validate_terpakai_()
  {
    var nomeCampo_terpakai_ = "terpakai_";
    var var_terpakai_ = scAjaxGetFieldText(nomeCampo_terpakai_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdetailresepokvkR_inline_validate_terpakai_(var_terpakai_, var_script_case_init, do_ajax_form_tbdetailresepokvkR_inline_validate_terpakai__cb);
  } // do_ajax_form_tbdetailresepokvkR_inline_validate_terpakai_

  function do_ajax_form_tbdetailresepokvkR_inline_validate_terpakai__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdetailresepokvkR_inline_validate_terpakai__cb

  // ---------- Refresh item_
  function do_ajax_form_tbdetailresepokvkR_inline_refresh_item_()
  {
    var var_item_ = scAjaxGetFieldSelect("item_");
    var var_nmgp_refresh_fields = "satuan_";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tbdetailresepokvkR_inline_refresh_item_(var_item_, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_tbdetailresepokvkR_inline_refresh_item__cb);
  } // do_ajax_form_tbdetailresepokvkR_inline_refresh_item_

  function do_ajax_form_tbdetailresepokvkR_inline_refresh_item__cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdetailresepokvkR_inline_refresh_item__cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tbdetailresepokvkR_inline_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tbdetailresepokvkR_inline_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_item_ = scAjaxGetFieldSelect("item_");
    var var_jumlah_ = scAjaxGetFieldText("jumlah_");
    var var_satuan_ = scAjaxGetFieldSelect("satuan_");
    var var_biaya_ = scAjaxGetFieldText("biaya_");
    var var_diskon_ = scAjaxGetFieldText("diskon_");
    var var_signa_ = scAjaxGetFieldSelect("signa_");
    var var_trandate_ = scAjaxGetFieldText("trandate_");
    var var_id_ = scAjaxGetFieldHidden("id_");
    var var_trancode_ = scAjaxGetFieldText("trancode_");
    var var_terpakai_ = scAjaxGetFieldText("terpakai_");
    ...
    scAjaxProcOn();
    x_ajax_form_tbdetailresepokvkR_inline_submit_form(var_item_, var_jumlah_, var_satuan_, var_biaya_, var_diskon_, var_signa_, var_trandate_, var_id_, var_trancode_, var_terpakai_, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbdetailresepokvkR_inline_submit_form_cb);
  } // do_ajax_form_tbdetailresepokvkR_inline_submit_form

  function do_ajax_form_tbdetailresepokvkR_inline_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("item_");
      scAjaxHideErrorDisplay("jumlah_");
      scAjaxHideErrorDisplay("satuan_");
      scAjaxHideErrorDisplay("biaya_");
      scAjaxHideErrorDisplay("diskon_");
      scAjaxHideErrorDisplay("signa_");
      scAjaxHideErrorDisplay("trandate_");
      scAjaxHideErrorDisplay("id_");
      scAjaxHideErrorDisplay("trancode_");
      scAjaxHideErrorDisplay("terpakai_");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tbdetailresepokvkR_inline_submit_form_cb_after_alert);
  } // do_ajax_form_tbdetailresepokvkR_inline_submit_form_cb
  function do_ajax_form_tbdetailresepokvkR_inline_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbdetailresepokvkR_inline_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tbdetailresepokvkR_inline_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tbdetailresepokvkR_inline_navigate_form(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbdetailresepokvkR_inline_navigate_form_cb);
  } // do_ajax_form_tbdetailresepokvkR_inline_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailresepokvkR_inline']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbdetailresepokvkR_inline_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbdetailresepokvkR_inline_navigate_form_cb_after_alert);
  } // do_ajax_form_tbdetailresepokvkR_inline_navigate_form_cb
  function do_ajax_form_tbdetailresepokvkR_inline_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_tbdetailresepokvkR_inline_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_tbdetailresepokvkR_inline_navigate_form_cb_after_alert
  function sc_hide_form_tbdetailresepokvkR_inline_form()
  {
  ...
  ajax_field_list[0] = "item_";
  ajax_field_list[1] = "jumlah_";
  ajax_field_list[2] = "satuan_";
  ajax_field_list[3] = "biaya_";
  ajax_field_list[4] = "diskon_";
  ajax_field_list[5] = "signa_";
  ajax_field_list[6] = "trandate_";
  ajax_field_list[7] = "id_";
  ajax_field_list[8] = "trancode_";
  ajax_field_list[9] = "terpakai_";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "item_": {"label": "Item", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "jumlah_": {"label": "Jumlah", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "satuan_": {"label": "Satuan", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "biaya_": {"label": "Biaya", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "diskon_": {"label": "Diskon", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "signa_": {"label": "Signa", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "trandate_": {"label": "Tgl. Transaksi", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "id_": {"label": "ID", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "trancode_": {"label": "Tran Code", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "terpakai_": {"label": "Terpakai", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  ajax_field_mult["item_"][1] = "item_";
  ajax_field_mult["jumlah_"][1] = "jumlah_";
  ajax_field_mult["satuan_"][1] = "satuan_";
  ajax_field_mult["biaya_"][1] = "biaya_";
  ajax_field_mult["diskon_"][1] = "diskon_";
  ajax_field_mult["signa_"][1] = "signa_";
  ajax_field_mult["trandate_"][1] = "trandate_";
  ajax_field_mult["id_"][1] = "id_";
  ajax_field_mult["trancode_"][1] = "trancode_";
  ajax_field_mult["terpakai_"][1] = "terpakai_";

  var ajax_field_id = {
    "item_": new Array("hidden_field_label_item_", "hidden_field_data_item_"),
    "jumlah_": new Array("hidden_field_label_jumlah_", "hidden_field_data_jumlah_"),
    "satuan_": new Array("hidden_field_label_satuan_", "hidden_field_data_satuan_"),
    "biaya_": new Array("hidden_field_label_biaya_", "hidden_field_data_biaya_"),
    "diskon_": new Array("hidden_field_label_diskon_", "hidden_field_data_diskon_"),
    "signa_": new Array("hidden_field_label_signa_", "hidden_field_data_signa_"),
    "trandate_": new Array("hidden_field_label_trandate_", "hidden_field_data_trandate_"),
    "terpakai_": new Array("hidden_field_label_terpakai_", "hidden_field_data_terpakai_")
  };
