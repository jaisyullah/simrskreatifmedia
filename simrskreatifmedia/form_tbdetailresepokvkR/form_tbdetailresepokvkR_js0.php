...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_tbdetailresepokvkR"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
var var_btn_Validasi_struk_okvk = "<?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailresepokvkR']['dados_form'][$sc_seq_vert]['trancode_'])?>";
...
function scForm_inline_submit(y, z) {
	Nm_Proc_Atualiz = true;
	do_ajax_form_tbdetailresepokvkR_submit_form(y, z);
