...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailresepokvkR_inline']['embutida_pdf']))
 {
 ?>
...
<?php
include_once("form_tbdetailresepokvkR_inline_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_tbdetailresepokvkR_inline_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailresepokvkR_inline']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailresepokvkR_inline']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailresepokvkR_inline']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailresepokvkR_inline']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailresepokvkR_inline']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailresepokvkR_inline']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailresepokvkR_inline']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailresepokvkR_inline']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
?>
<body class="scFormPage" style="<?php echo $remove_margin . $str_iframe_body; ?>">
<?php

if (isset($_SESSION['scriptcase']['form_tbdetailresepokvkR']['error_buffer']) && '' != $_SESSION['scriptcase']['form_tbdetailresepokvkR']['error_buffer'])
{
    echo $_SESSION['scriptcase']['form_tbdetailresepokvkR']['error_buffer'];
}
...
<?php
 include_once("form_tbdetailresepokvkR_inline_js0.php");
?>
<script type="text/javascript"> 
...
<form  name="F1" method="post" 
               action="form_tbdetailresepokvkR_inline.php" 
               target="_self">
<input type="hidden" name="nmgp_url_saida" value="">
<?php
if ('novo' == $this->nmgp_opcao || 'incluir' == $this->nmgp_opcao)
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailresepokvkR_inline']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailresepokvkR_inline']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_tbdetailresepokvkR_inline'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_tbdetailresepokvkR_inline'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailresepokvkR_inline']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailresepokvkR_inline']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailresepokvkR_inline']['run_iframe'] != "R")
{
?>
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailresepokvkR_inline']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailresepokvkR_inline']['run_iframe'] != "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailresepokvkR_inline']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailresepokvkR_inline']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailresepokvkR_inline']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailresepokvkR_inline']['run_iframe'] == "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailresepokvkR_inline']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailresepokvkR_inline']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailresepokvkR_inline']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailresepokvkR_inline']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailresepokvkR_inline']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailresepokvkR_inline']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailresepokvkR_inline']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailresepokvkR_inline']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailresepokvkR_inline']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailresepokvkR_inline']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<input type=hidden name="item_" value="<?php echo $this->form_encode_input($this->item_) . "\">"; ?>
...
?>
<input type="hidden" name="item_" value="<?php echo $this->form_encode_input($item_) . "\">" . $item__look . ""; ?>
<?php } else { ?>
<?php
   ...
   $x = 0; 
   echo "<span id=\"id_read_on_item_\" class=\"css_item__line\" style=\"" .  $sStyleReadLab_item_ . "\">" . $this->form_encode_input($item__look) . "</span><span id=\"id_read_off_item_\" class=\"css_read_off_item_\" style=\"white-space: nowrap; " . $sStyleReadInp_item_ . "\">";
   echo " <span id=\"idAjaxSelect_item_\"><select class=\"sc-js-input scFormObjectOdd css_item__obj\" style=\"\" id=\"id_sc_field_item_\" name=\"item_\" size=\"1\" alt=\"{type: 'select', enterTab: false}\">" ; 
   echo "\r" ; 
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_biaya__line" id="hidden_field_data_biaya_" style="<?php echo $sStyleHidden_biaya_; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_biaya__line" style="vertical-align: top;padding: 0px">
...
<span class="css_diskon__label scFormDataHelpOdd">&nbsp;%
</span></td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_diskon__frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_diskon__text"></span></td></tr></table></td></tr></table></TD>
   <?php }?>
...
<input type=hidden name="signa_" value="<?php echo $this->form_encode_input($this->signa_) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>
...
?>
<input type="hidden" name="signa_" value="<?php echo $this->form_encode_input($signa_) . "\">" . $signa__look . ""; ?>
<?php } else { ?>
<?php
   ...
   $x = 0; 
   echo "<span id=\"id_read_on_signa_\" class=\"css_signa__line\" style=\"" .  $sStyleReadLab_signa_ . "\">" . $this->form_encode_input($signa__look) . "</span><span id=\"id_read_off_signa_\" class=\"css_read_off_signa_\" style=\"white-space: nowrap; " . $sStyleReadInp_signa_ . "\">";
   echo " <span id=\"idAjaxSelect_signa_\"><select class=\"sc-js-input scFormObjectOdd css_signa__obj\" style=\"\" id=\"id_sc_field_signa_\" name=\"signa_\" size=\"1\" alt=\"{type: 'select', enterTab: false}\">" ; 
   echo "\r" ; 
   while (!empty($todo[$x]) && !$nm_nao_carga) 
   {
          $cadaselect = explode("?#?", $todo[$x]) ; 
...
<?php
   ...
   if (/*$this->nmgp_opcao != "novo" && */isset($this->nmgp_cmp_readonly['trancode_']) && $this->nmgp_cmp_readonly['trancode_'] == 'on')
   {
       $bTestReadOnly = false;
...
<input type="hidden" name="trancode_" value="<?php echo $this->form_encode_input($trancode_) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormLabelOdd scUiLabelWidthFix css_trancode__label" id="hidden_field_label_trancode_" style="<?php echo $sStyleHidden_trancode_; ?>"><span id="id_label_trancode_"><?php echo $this->nm_new_label['trancode_']; ?></span></TD>
    <TD class="scFormDataOdd css_trancode__line" id="hidden_field_data_trancode_" style="<?php echo $sStyleHidden_trancode_; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_trancode__line" style="vertical-align: top;padding: 0px">
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["trancode_"]) &&  $this->nmgp_cmp_readonly["trancode_"] == "on") { 

 ?>
<input type="hidden" name="trancode_" value="<?php echo $this->form_encode_input($trancode_) . "\">" . $trancode_ . ""; ?>
<?php } else { ?>
<span id="id_read_on_trancode_" class="sc-ui-readonly-trancode_ css_trancode__line" style="<?php echo $sStyleReadLab_trancode_; ?>"><?php echo $this->trancode_; ?></span><span id="id_read_off_trancode_" class="css_read_off_trancode_" style="white-space: nowrap;<?php echo $sStyleReadInp_trancode_; ?>">
 <input class="sc-js-input scFormObjectOdd css_trancode__obj" style="" id="id_sc_field_trancode_" type=text name="trancode_" value="<?php echo $this->form_encode_input($trancode_) ?>"
...
</td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_trancode__frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_trancode__text"></span></td></tr></table></td></tr></table></TD>
   <?php }?>
...
<span id="id_read_on_terpakai_" class="sc-ui-readonly-terpakai_ css_terpakai__line" style="<?php echo $sStyleReadLab_terpakai_; ?>"><?php echo $this->terpakai_; ?></span><span id="id_read_off_terpakai_" class="css_read_off_terpakai_" style="white-space: nowrap;<?php echo $sStyleReadInp_terpakai_; ?>">
 <input class="sc-js-input scFormObjectOdd css_terpakai__obj" style="" id="id_sc_field_terpakai_" type=text name="terpakai_" value="<?php echo $this->form_encode_input($terpakai_) ?>"
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailresepokvkR_inline']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailresepokvkR_inline']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailresepokvkR_inline']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailresepokvkR_inline']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailresepokvkR_inline']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailresepokvkR_inline']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailresepokvkR_inline']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailresepokvkR_inline']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailresepokvkR_inline']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailresepokvkR_inline']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailresepokvkR_inline']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_tbdetailresepokvkR_inline");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_tbdetailresepokvkR_inline");
 parent.scAjaxDetailHeight("form_tbdetailresepokvkR_inline", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailresepokvkR_inline']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
