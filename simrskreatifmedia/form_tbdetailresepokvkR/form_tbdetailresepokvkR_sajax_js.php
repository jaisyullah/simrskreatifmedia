  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbdetailresepokvkR" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbdetailresepokvkR_form();
	}

  // ---------- Validate item_
  function do_ajax_form_tbdetailresepokvkR_validate_item_(iNumLinha)
  {
    var nomeCampo_item_ = "item_" + iNumLinha;
    var var_item_ = scAjaxGetFieldSelect(nomeCampo_item_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdetailresepokvkR_validate_item_(var_item_, iNumLinha, var_script_case_init, do_ajax_form_tbdetailresepokvkR_validate_item__cb);
  } // do_ajax_form_tbdetailresepokvkR_validate_item_

  function do_ajax_form_tbdetailresepokvkR_validate_item__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdetailresepokvkR_validate_item__cb

  // ---------- Validate jumlah_
  function do_ajax_form_tbdetailresepokvkR_validate_jumlah_(iNumLinha)
  {
    var nomeCampo_jumlah_ = "jumlah_" + iNumLinha;
    var var_jumlah_ = scAjaxGetFieldText(nomeCampo_jumlah_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdetailresepokvkR_validate_jumlah_(var_jumlah_, iNumLinha, var_script_case_init, do_ajax_form_tbdetailresepokvkR_validate_jumlah__cb);
  } // do_ajax_form_tbdetailresepokvkR_validate_jumlah_

  function do_ajax_form_tbdetailresepokvkR_validate_jumlah__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdetailresepokvkR_validate_jumlah__cb

  // ---------- Validate satuan_
  function do_ajax_form_tbdetailresepokvkR_validate_satuan_(iNumLinha)
  {
    var nomeCampo_satuan_ = "satuan_" + iNumLinha;
    var var_satuan_ = scAjaxGetFieldSelect(nomeCampo_satuan_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdetailresepokvkR_validate_satuan_(var_satuan_, iNumLinha, var_script_case_init, do_ajax_form_tbdetailresepokvkR_validate_satuan__cb);
  } // do_ajax_form_tbdetailresepokvkR_validate_satuan_

  function do_ajax_form_tbdetailresepokvkR_validate_satuan__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdetailresepokvkR_validate_satuan__cb

  // ---------- Validate biaya_
  function do_ajax_form_tbdetailresepokvkR_validate_biaya_(iNumLinha)
  {
    var nomeCampo_biaya_ = "biaya_" + iNumLinha;
    var var_biaya_ = scAjaxGetFieldText(nomeCampo_biaya_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdetailresepokvkR_validate_biaya_(var_biaya_, iNumLinha, var_script_case_init, do_ajax_form_tbdetailresepokvkR_validate_biaya__cb);
  } // do_ajax_form_tbdetailresepokvkR_validate_biaya_

  function do_ajax_form_tbdetailresepokvkR_validate_biaya__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdetailresepokvkR_validate_biaya__cb

  // ---------- Validate diskon_
  function do_ajax_form_tbdetailresepokvkR_validate_diskon_(iNumLinha)
  {
    var nomeCampo_diskon_ = "diskon_" + iNumLinha;
    var var_diskon_ = scAjaxGetFieldText(nomeCampo_diskon_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdetailresepokvkR_validate_diskon_(var_diskon_, iNumLinha, var_script_case_init, do_ajax_form_tbdetailresepokvkR_validate_diskon__cb);
  } // do_ajax_form_tbdetailresepokvkR_validate_diskon_

  function do_ajax_form_tbdetailresepokvkR_validate_diskon__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdetailresepokvkR_validate_diskon__cb

  // ---------- Validate signa_
  function do_ajax_form_tbdetailresepokvkR_validate_signa_(iNumLinha)
  {
    var nomeCampo_signa_ = "signa_" + iNumLinha;
    var var_signa_ = scAjaxGetFieldSelect(nomeCampo_signa_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdetailresepokvkR_validate_signa_(var_signa_, iNumLinha, var_script_case_init, do_ajax_form_tbdetailresepokvkR_validate_signa__cb);
  } // do_ajax_form_tbdetailresepokvkR_validate_signa_

  function do_ajax_form_tbdetailresepokvkR_validate_signa__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdetailresepokvkR_validate_signa__cb

  // ---------- Validate trandate_
  function do_ajax_form_tbdetailresepokvkR_validate_trandate_(iNumLinha)
  {
    var nomeCampo_trandate_ = "trandate_" + iNumLinha;
    var var_trandate_ = scAjaxGetFieldText(nomeCampo_trandate_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdetailresepokvkR_validate_trandate_(var_trandate_, iNumLinha, var_script_case_init, do_ajax_form_tbdetailresepokvkR_validate_trandate__cb);
  } // do_ajax_form_tbdetailresepokvkR_validate_trandate_

  function do_ajax_form_tbdetailresepokvkR_validate_trandate__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdetailresepokvkR_validate_trandate__cb

  // ---------- Validate id_
  function do_ajax_form_tbdetailresepokvkR_validate_id_(iNumLinha)
  {
    var nomeCampo_id_ = "id_" + iNumLinha;
    var var_id_ = scAjaxGetFieldHidden(nomeCampo_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdetailresepokvkR_validate_id_(var_id_, iNumLinha, var_script_case_init, do_ajax_form_tbdetailresepokvkR_validate_id__cb);
  } // do_ajax_form_tbdetailresepokvkR_validate_id_

  function do_ajax_form_tbdetailresepokvkR_validate_id__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdetailresepokvkR_validate_id__cb

  // ---------- Validate trancode_
  function do_ajax_form_tbdetailresepokvkR_validate_trancode_(iNumLinha)
  {
    var nomeCampo_trancode_ = "trancode_" + iNumLinha;
    var var_trancode_ = scAjaxGetFieldText(nomeCampo_trancode_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdetailresepokvkR_validate_trancode_(var_trancode_, iNumLinha, var_script_case_init, do_ajax_form_tbdetailresepokvkR_validate_trancode__cb);
  } // do_ajax_form_tbdetailresepokvkR_validate_trancode_

  function do_ajax_form_tbdetailresepokvkR_validate_trancode__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdetailresepokvkR_validate_trancode__cb

  // ---------- Validate terpakai_
  function do_ajax_form_tbdetailresepokvkR_validate_terpakai_(iNumLinha)
  {
    var nomeCampo_terpakai_ = "terpakai_" + iNumLinha;
    var var_terpakai_ = scAjaxGetFieldText(nomeCampo_terpakai_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdetailresepokvkR_validate_terpakai_(var_terpakai_, iNumLinha, var_script_case_init, do_ajax_form_tbdetailresepokvkR_validate_terpakai__cb);
  } // do_ajax_form_tbdetailresepokvkR_validate_terpakai_

  function do_ajax_form_tbdetailresepokvkR_validate_terpakai__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "terpakai_" + iLineNumber;
    }
    else
    {
      sFieldValid = "terpakai_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "terpakai_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "terpakai_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdetailresepokvkR_validate_terpakai__cb

  // ---------- Refresh item_
  function do_ajax_form_tbdetailresepokvkR_refresh_item_(iSeqForm)
  {
    ...
    scAjaxProcOn(true);
    x_ajax_form_tbdetailresepokvkR_refresh_item_(var_item_, var_nmgp_refresh_row, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_tbdetailresepokvkR_refresh_item__cb);
  } // do_ajax_form_tbdetailresepokvkR_refresh_item_

  function do_ajax_form_tbdetailresepokvkR_refresh_item__cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdetailresepokvkR_refresh_item__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_tbdetailresepokvkR_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_tbdetailresepokvkR_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tbdetailresepokvkR_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_tbdetailresepokvkR_add_new_line_cb);
  } // do_ajax_form_tbdetailresepokvkR_add_new_line

  function do_ajax_form_tbdetailresepokvkR_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_tbdetailresepokvkR_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_tbdetailresepokvkR_backup_line(iNumLinha)
  {
    var var_id_ = scAjaxGetFieldHidden("id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdetailresepokvkR_backup_line(var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_tbdetailresepokvkR_backup_line_cb);
  } // do_ajax_form_tbdetailresepokvkR_backup_line

  function do_ajax_form_tbdetailresepokvkR_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_tbdetailresepokvkR_backup_line_cb

  function do_ajax_form_tbdetailresepokvkR_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_tbdetailresepokvkR_cancel_insert

  function do_ajax_form_tbdetailresepokvkR_cancel_update(iSeqVert)
  {
    do_ajax_form_tbdetailresepokvkR_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_tbdetailresepokvkR_cancel_update

  function do_ajax_form_tbdetailresepokvkR_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_tbdetailresepokvkR_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_tbdetailresepokvkR_table_refresh()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tbdetailresepokvkR_table_refresh(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbdetailresepokvkR_table_refresh_cb);
  } //  do_ajax_form_tbdetailresepokvkR_table_refresh

  function do_ajax_form_tbdetailresepokvkR_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_tbdetailresepokvkR_table_refresh_cb_after_alert);
  } // do_ajax_form_tbdetailresepokvkR_table_refresh_cb
  function do_ajax_form_tbdetailresepokvkR_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_tbdetailresepokvkR_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_tbdetailresepokvkR_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_tbdetailresepokvkR_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    var var_terpakai_ = scAjaxGetFieldText("terpakai_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_tbdetailresepokvkR_submit_form(var_item_, var_jumlah_, var_satuan_, var_biaya_, var_diskon_, var_signa_, var_trandate_, var_id_, var_trancode_, var_terpakai_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbdetailresepokvkR_submit_form_cb);
  } // do_ajax_form_tbdetailresepokvkR_submit_form

  function do_ajax_form_tbdetailresepokvkR_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("terpakai_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_tbdetailresepokvkR_submit_form_cb_after_alert);
  } // do_ajax_form_tbdetailresepokvkR_submit_form_cb
  function do_ajax_form_tbdetailresepokvkR_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbdetailresepokvkR_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tbdetailresepokvkR_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_tbdetailresepokvkR_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("terpakai_" + iNavForm);
    }
    var var_id_ = document.F2.id_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tbdetailresepokvkR_navigate_form(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbdetailresepokvkR_navigate_form_cb);
  } // do_ajax_form_tbdetailresepokvkR_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailresepokvkR']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbdetailresepokvkR_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbdetailresepokvkR_navigate_form_cb_after_alert);
  } // do_ajax_form_tbdetailresepokvkR_navigate_form_cb
  function do_ajax_form_tbdetailresepokvkR_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_tbdetailresepokvkR_navigate_form_cb_after_alert
  function sc_hide_form_tbdetailresepokvkR_form()
  {
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "terpakai_" + iNumLinha;
    iTotCampos++;
    ...
    ajax_error_list["terpakai_" + iNumLinha] = {"label": "Terpakai<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_field_mult["terpakai_"][iNumLinha] = "terpakai_" + iNumLinha;
    ...
    ajax_field_id["terpakai_" + iNumLinha] = new Array("hidden_field_label_terpakai_", "hidden_field_data_terpakai_" + iNumLinha);
    ...
    ajax_error_count["terpakai_" + iNumLinha] = "off";
<?php
...
?>
    ...
    ajax_read_only["terpakai_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ...
    ajax_read_only["terpakai_" + iNumLinha] = "on";
<?php
}
?>
  }
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["terpakai_" + iNumLinha] = null;
  }
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["terpakai_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["terpakai_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["terpakai_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["terpakai_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["terpakai_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['terpakai_'])) ? $this->nmgp_cmp_readonly['terpakai_'] : 'off';
?>
    scAjaxFieldRead("terpakai_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }
  ...
  function mdCloseObjects(iSeq)
  {
    ...
    scAjaxFieldRead("terpakai_" + iSeq, "on");
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["item_" + iRow] || "on" == ajax_error_count["jumlah_" + iRow] || "on" == ajax_error_count["satuan_" + iRow] || "on" == ajax_error_count["biaya_" + iRow] || "on" == ajax_error_count["diskon_" + iRow] || "on" == ajax_error_count["signa_" + iRow] || "on" == ajax_error_count["trandate_" + iRow] || "on" == ajax_error_count["id_" + iRow] || "on" == ajax_error_count["trancode_" + iRow] || "on" == ajax_error_count["terpakai_" + iRow]))
    {
      ...
      $("#hidden_field_data_terpakai_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["item_" + iRow] && "off" == ajax_error_count["jumlah_" + iRow] && "off" == ajax_error_count["satuan_" + iRow] && "off" == ajax_error_count["biaya_" + iRow] && "off" == ajax_error_count["diskon_" + iRow] && "off" == ajax_error_count["signa_" + iRow] && "off" == ajax_error_count["trandate_" + iRow] && "off" == ajax_error_count["id_" + iRow] && "off" == ajax_error_count["trancode_" + iRow] && "off" == ajax_error_count["terpakai_" + iRow]))
    {
      if (bErrorRow)
      {
        ...
        ajax_error_count["terpakai_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_terpakai_" + iRow).removeClass("scFormErrorLine");
    }
  }
