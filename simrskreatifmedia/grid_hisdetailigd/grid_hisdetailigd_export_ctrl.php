<?php
@session_start() ;
$_SESSION['scriptcase']['grid_hisdetailigd']['sc_process_barr'] = true;
require_once('../grid_hisdetailigd/index.php');
unset($_SESSION['scriptcase']['grid_hisdetailigd']['sc_process_barr']);
$ExportCtrl = new grid_hisdetailigd_export_control;
$ExportCtrl->Export_barr();

class grid_hisdetailigd_export_control
{
