<?php
@session_start() ;
$_SESSION['scriptcase']['pendapatanKasir_rekap']['sc_process_barr'] = true;
require_once('../pendapatanKasir_rekap/index.php');
unset($_SESSION['scriptcase']['pendapatanKasir_rekap']['sc_process_barr']);
$ExportCtrl = new pendapatanKasir_rekap_export_control;
$ExportCtrl->Export_barr();

class pendapatanKasir_rekap_export_control
{
