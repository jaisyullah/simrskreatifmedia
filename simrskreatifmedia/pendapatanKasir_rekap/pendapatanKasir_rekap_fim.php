...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____pendapatanKasir_rekap"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____pendapatanKasir_rekap"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['pendapatanKasir_rekap']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['pendapatanKasir_rekap']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['pendapatanKasir_rekap']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['pendapatanKasir_rekap']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['pendapatanKasir_rekap']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>pendapatanKasir_rekap</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['pendapatanKasir_rekap']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['pendapatanKasir_rekap']['embutida_filho'] as $ind => $sc_init)
          {
