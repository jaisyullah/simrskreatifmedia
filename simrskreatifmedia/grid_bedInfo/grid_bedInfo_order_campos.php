...
<?php
   ...
   $Ord_Cmp = new grid_bedInfo_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_bedInfo_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_bedInfo']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_bedInfo']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["ruang"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_bedInfo']['labels']["ruang"])) ? $_SESSION['sc_session'][$sc_init]['grid_bedInfo']['labels']["ruang"] : "Ruang";
   $tab_ger_campos['kelas'] = "on";
   $tab_def_campos['kelas'] = "kelas";
   $tab_labels["kelas"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_bedInfo']['labels']["kelas"])) ? $_SESSION['sc_session'][$sc_init]['grid_bedInfo']['labels']["kelas"] : "Kelas";
   $tab_ger_campos['tersedia'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['tersedia'] = "Tersedia";
   }
   else
   {
       $tab_def_campos['tersedia'] = "";
   }
   $tab_labels["tersedia"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_bedInfo']['labels']["tersedia"])) ? $_SESSION['sc_session'][$sc_init]['grid_bedInfo']['labels']["tersedia"] : "Tersedia";
   $tab_ger_campos['terisi'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['terisi'] = "Terisi";
   }
   else
   {
       $tab_def_campos['terisi'] = "";
   }
   $tab_labels["terisi"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_bedInfo']['labels']["terisi"])) ? $_SESSION['sc_session'][$sc_init]['grid_bedInfo']['labels']["terisi"] : "Terisi";
   ...
   {
       $tab_def_campos['jumlah'] = "";
   }
   $tab_labels["jumlah"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_bedInfo']['labels']["jumlah"])) ? $_SESSION['sc_session'][$sc_init]['grid_bedInfo']['labels']["jumlah"] : "Jumlah";
   $tab_ger_campos['tersedia'] = "none";
   $tab_ger_campos['terisi'] = "none";
   $tab_ger_campos['jumlah'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_bedInfo']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_bedInfo']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_bedInfo']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_bedInfo']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_bedInfo']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_bedInfo']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_bedInfo']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_bedInfo']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_bedInfo']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_bedInfo_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_bedInfo']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_bedInfo']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_bedInfo']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_bedInfo']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_bedInfo']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
