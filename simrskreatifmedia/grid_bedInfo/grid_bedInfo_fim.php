...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_bedInfo"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_bedInfo"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_bedInfo']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_bedInfo']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_bedInfo']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_bedInfo']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_bedInfo']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_bedInfo']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_bedInfo']['embutida_filho'] as $ind => $sc_init)
          {
