<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tbceklab']['sc_process_barr'] = true;
require_once('../grid_tbceklab/index.php');
unset($_SESSION['scriptcase']['grid_tbceklab']['sc_process_barr']);
$ExportCtrl = new grid_tbceklab_export_control;
$ExportCtrl->Export_barr();

class grid_tbceklab_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - Pemeriksaan Lab :: Excel</TITLE>
