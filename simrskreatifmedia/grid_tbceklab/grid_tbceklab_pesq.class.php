...
class grid_tbceklab_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbceklab']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_tbceklab_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_tbceklab_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_tbceklab_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_ceklab')
      {
          $ceklab = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_ceklab($ceklab);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_namalab')
      {
          $namalab = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_namalab($namalab);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function lookup_ajax_ceklab($ceklab)
   {
      $ceklab = substr($this->Db->qstr($ceklab), 1, -1);
            $ceklab_look = substr($this->Db->qstr($ceklab), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct cekLab from " . $this->Ini->nm_tabela . " where  cekLab like '%" . $ceklab . "%' order by cekLab"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
   ...
   function lookup_ajax_namalab($namalab)
   {
      $namalab = substr($this->Db->qstr($namalab), 1, -1);
            $namalab_look = substr($this->Db->qstr($namalab), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct namaLab from " . $this->Ini->nm_tabela . " where  namaLab like '%" . $namalab . "%' order by namaLab"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbceklab']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbceklab']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbceklab']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbceklab']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbceklab']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbceklab']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbceklab']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbceklab']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbceklab']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbceklab']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbceklab']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbceklab']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbceklab']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbceklab']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbceklab']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - Pemeriksaan Lab</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_tbceklab/grid_tbceklab_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_tbceklab_ajax_search.js"></script>
 <script type="text/javascript" src="grid_tbceklab_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_tbceklab_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_tbceklab']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_tbceklab']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_ceklab_cond#NMF#' + search_get_sel_txt('SC_ceklab_cond') + '@NMF@';
  str_out += 'SC_ceklab#NMF#' + search_get_text('SC_ceklab') + '@NMF@';
  str_out += 'id_ac_ceklab#NMF#' + search_get_text('id_ac_ceklab') + '@NMF@';
  str_out += 'SC_namalab_cond#NMF#' + search_get_sel_txt('SC_namalab_cond') + '@NMF@';
  str_out += 'SC_namalab#NMF#' + search_get_text('SC_namalab') + '@NMF@';
  str_out += 'id_ac_namalab#NMF#' + search_get_text('id_ac_namalab') + '@NMF@';
   ...
   $("#id_ac_ceklab").autocomplete({
     ...
     $.ajax({
       ...
       data: {
          ...
          nmgp_parms: "NM_ajax_opcao?#?autocomp_ceklab",
          max_itens: "10",
          cod_desc: "N",
     ...
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_ceklab").val( $(this).val() );
       }
     }
   });
   $("#id_ac_namalab").autocomplete({
     minLength: 1,
     source: function (request, response) {
     $.ajax({
       url: "index.php",
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_namalab",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbceklab']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div class="scFilterHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFilterHeaderFont" style="float: left; text-transform: uppercase;"><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - Pemeriksaan Lab</div>
...
<?php
   ...
   function monta_form()
   {
      global 
             ...
             $ceklab_cond, $ceklab, $ceklab_autocomp,
             $namalab_cond, $namalab, $namalab_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbceklab']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbceklab']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbceklab']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbceklab']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $jenis = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbceklab']['campos_busca']['jenis']; 
          $jenis_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbceklab']['campos_busca']['jenis_cond']; 
          $id = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbceklab']['campos_busca']['id']; 
          $id_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbceklab']['campos_busca']['id_cond']; 
          $ceklab = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbceklab']['campos_busca']['ceklab']; 
          $ceklab_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbceklab']['campos_busca']['ceklab_cond']; 
          $namalab = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbceklab']['campos_busca']['namalab']; 
          $namalab_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbceklab']['campos_busca']['namalab_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbceklab']['campos_busca']['NM_operador']; 
      } 
      ...
      if (!isset($ceklab_cond) || empty($ceklab_cond))
      {
         $ceklab_cond = "qp";
      }
      if (!isset($namalab_cond) || empty($namalab_cond))
      {
         $namalab_cond = "qp";
      }
      ...
      $str_hide_ceklab = (in_array($ceklab_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_namalab = (in_array($namalab_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      if (!isset($ceklab) || $ceklab == "")
      {
          $ceklab = "";
      }
      if (isset($ceklab) && !empty($ceklab))
      {
         $tmp_pos = strpos($ceklab, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $ceklab = substr($ceklab, 0, $tmp_pos);
         }
      }
      if (!isset($namalab) || $namalab == "")
      {
          $namalab = "";
      }
      if (isset($namalab) && !empty($namalab))
      {
         $tmp_pos = strpos($namalab, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $namalab = substr($namalab, 0, $tmp_pos);
         }
      }
?>
 <TR align="center">
...
?>
<INPUT  type="text" id="SC_jenis" name="jenis" value="<?php echo NM_encode_input($jenis) ?>"  size=35 alt="{datatype: 'text', maxLength: 35, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_jenis" name="jenis_autocomp" size="35"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 35, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_id" name="id_autocomp" size="5"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 5, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
      ...
      <TD id='SC_ceklab_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['ceklab'])) ? $this->New_label['ceklab'] : "Kode Lab"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_ceklab_cond" name="ceklab_cond" onChange="nm_campos_between(document.getElementById('id_vis_ceklab'), this, 'ceklab')">
       <OPTION value="qp" <?php if ("qp" == $ceklab_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $ceklab_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $ceklab_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $ceklab_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_ceklab" <?php echo $str_hide_ceklab?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['ceklab'])) ? $this->New_label['ceklab'] : "Kode Lab";
 $nmgp_tab_label .= "ceklab?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      $ceklab_look = substr($this->Db->qstr($ceklab), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct cekLab from " . $this->Ini->nm_tabela . " where cekLab = '$ceklab_look' order by cekLab"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      if (isset($nmgp_def_dados[0][$ceklab]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$ceklab];
      }
      else
      {
          $sAutocompValue = $ceklab;
      }
?>
<INPUT  type="text" id="SC_ceklab" name="ceklab" value="<?php echo NM_encode_input($ceklab) ?>"  size=8 alt="{datatype: 'text', maxLength: 8, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_ceklab" name="ceklab_autocomp" size="8"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 8, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_namalab_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['namalab'])) ? $this->New_label['namalab'] : "Nama Pemeriksaan Lab"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_namalab_cond" name="namalab_cond" onChange="nm_campos_between(document.getElementById('id_vis_namalab'), this, 'namalab')">
       <OPTION value="qp" <?php if ("qp" == $namalab_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $namalab_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $namalab_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $namalab_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_namalab" <?php echo $str_hide_namalab?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['namalab'])) ? $this->New_label['namalab'] : "Nama Pemeriksaan Lab";
 $nmgp_tab_label .= "namalab?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      $namalab_look = substr($this->Db->qstr($namalab), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct namaLab from " . $this->Ini->nm_tabela . " where namaLab = '$namalab_look' order by namaLab"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      if (isset($nmgp_def_dados[0][$namalab]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$namalab];
      }
      else
      {
          $sAutocompValue = $namalab;
      }
?>
<INPUT  type="text" id="SC_namalab" name="namalab" value="<?php echo NM_encode_input($namalab) ?>"  size=50 alt="{datatype: 'text', maxLength: 150, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_namalab" name="namalab_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 150, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
?>
<?php
   if (is_file("grid_tbceklab_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_tbceklab']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_tbceklab']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbceklab']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.ceklab_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_ceklab'), document.F1.ceklab_cond, 'ceklab');
   document.F1.ceklab.value = "";
   document.F1.ceklab_autocomp.value = "";
   document.F1.namalab_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_namalab'), document.F1.namalab_cond, 'namalab');
   document.F1.namalab.value = "";
   document.F1.namalab_autocomp.value = "";
 }
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "simrskreatifmedia/grid_tbceklab";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbceklab']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbceklab']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbceklab']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_ceklab_cond'] = 'cond';
      $tp_fields['SC_ceklab'] = 'text_aut';
      $tp_fields['id_ac_ceklab'] = 'text_aut';
      $tp_fields['SC_namalab_cond'] = 'cond';
      $tp_fields['SC_namalab'] = 'text_aut';
      $tp_fields['id_ac_namalab'] = 'text_aut';
   ...
   function trata_campos()
   {
      global $jenis_cond, $jenis, $jenis_autocomp,
             $id_cond, $id, $id_autocomp,
             $ceklab_cond, $ceklab, $ceklab_autocomp,
             $namalab_cond, $namalab, $namalab_autocomp, $nmgp_tab_label;
      ...
      if (!empty($ceklab_autocomp) && empty($ceklab))
      {
          $ceklab = $ceklab_autocomp;
      }
      if (!empty($namalab_autocomp) && empty($namalab))
      {
          $namalab = $namalab_autocomp;
      }
      ...
      $ceklab_cond_salva = $ceklab_cond; 
      if (!isset($ceklab_input_2) || $ceklab_input_2 == "")
      {
          $ceklab_input_2 = $ceklab;
      }
      $namalab_cond_salva = $namalab_cond; 
      if (!isset($namalab_input_2) || $namalab_input_2 == "")
      {
          $namalab_input_2 = $namalab;
      }
      if ($id_cond != "in")
      {
          nm_limpa_numero($id, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbceklab']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbceklab']['campos_busca']['jenis'] = $jenis; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbceklab']['campos_busca']['jenis_cond'] = $jenis_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbceklab']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbceklab']['campos_busca']['id'] = $id; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbceklab']['campos_busca']['id_cond'] = $id_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbceklab']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbceklab']['campos_busca']['ceklab'] = $ceklab; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbceklab']['campos_busca']['ceklab_cond'] = $ceklab_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbceklab']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbceklab']['campos_busca']['namalab'] = $namalab; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbceklab']['campos_busca']['namalab_cond'] = $namalab_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbceklab']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbceklab']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbceklab']['campos_busca'] = $Temp_Busca;
      }
   ...
   { 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['ceklab'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['ceklab'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['ceklab'] = $ceklab;
      }
      $namalab_look = substr($this->Db->qstr($namalab), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct namaLab from " . $this->Ini->nm_tabela . " where namaLab = '$namalab_look' order by namaLab"; 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['namalab'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['namalab'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['namalab'] = $namalab;
      }
      ...
      //----- $ceklab
      $this->Date_part = false;
      if (isset($ceklab) || $ceklab_cond == "nu" || $ceklab_cond == "nn" || $ceklab_cond == "ep" || $ceklab_cond == "ne")
      {
         $this->monta_condicao("cekLab", $ceklab_cond, $ceklab, "", "ceklab");
      }

      //----- $namalab
      $this->Date_part = false;
      if (isset($namalab) || $namalab_cond == "nu" || $namalab_cond == "nn" || $namalab_cond == "ep" || $namalab_cond == "ne")
      {
         $this->monta_condicao("namaLab", $namalab_cond, $namalab, "", "namalab");
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbceklab']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbceklab']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbceklab']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbceklab']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbceklab']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbceklab']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbceklab']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbceklab']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbceklab']['cond_pesq'] .= $this->NM_operador;
