...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_ceklab_cond" name="ceklab_cond" onChange="nm_campos_between(document.getElementById('id_vis_ceklab'), this, 'ceklab')">
      ...
      <br><span id="id_hide_ceklab"  <?php echo $str_hide_ceklab?>><?php
      if ($ceklab != "")
      {
      $ceklab_look = substr($this->Db->qstr($ceklab), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_namalab_cond" name="namalab_cond" onChange="nm_campos_between(document.getElementById('id_vis_namalab'), this, 'namalab')">
      ...
      <br><span id="id_hide_namalab"  <?php echo $str_hide_namalab?>><?php
      if ($namalab != "")
      {
      $namalab_look = substr($this->Db->qstr($namalab), 1, -1); 
      $nmgp_def_dados = array(); 
