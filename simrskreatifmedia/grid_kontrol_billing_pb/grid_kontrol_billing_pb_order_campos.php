...
<?php
   ...
   $Ord_Cmp = new grid_kontrol_billing_pb_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_kontrol_billing_pb_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_kontrol_billing_pb']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_kontrol_billing_pb']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["trandate"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_kontrol_billing_pb']['labels']["trandate"])) ? $_SESSION['sc_session'][$sc_init]['grid_kontrol_billing_pb']['labels']["trandate"] : "Tgl Transaksi";
   $tab_ger_campos['trancode'] = "on";
   $tab_def_campos['trancode'] = "trancode";
   $tab_labels["trancode"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_kontrol_billing_pb']['labels']["trancode"])) ? $_SESSION['sc_session'][$sc_init]['grid_kontrol_billing_pb']['labels']["trancode"] : "Kode Transaksi";
   $tab_ger_campos['struk'] = "on";
   $tab_def_campos['struk'] = "struk";
   $tab_labels["struk"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_kontrol_billing_pb']['labels']["struk"])) ? $_SESSION['sc_session'][$sc_init]['grid_kontrol_billing_pb']['labels']["struk"] : "No Struk";
   $tab_ger_campos['resep'] = "on";
   $tab_def_campos['resep'] = "resep";
   $tab_labels["resep"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_kontrol_billing_pb']['labels']["resep"])) ? $_SESSION['sc_session'][$sc_init]['grid_kontrol_billing_pb']['labels']["resep"] : "Resep ?";
   $tab_ger_campos['pasien'] = "on";
   $tab_def_campos['pasien'] = "pasien";
   $tab_labels["pasien"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_kontrol_billing_pb']['labels']["pasien"])) ? $_SESSION['sc_session'][$sc_init]['grid_kontrol_billing_pb']['labels']["pasien"] : "Pasien ?";
   $tab_ger_campos['extname'] = "on";
   $tab_def_campos['extname'] = "extname";
   $tab_labels["extname"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_kontrol_billing_pb']['labels']["extname"])) ? $_SESSION['sc_session'][$sc_init]['grid_kontrol_billing_pb']['labels']["extname"] : "Nama Pembeli";
   $tab_ger_campos['custname'] = "on";
   $tab_def_campos['custname'] = "custname";
   $tab_labels["custname"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_kontrol_billing_pb']['labels']["custname"])) ? $_SESSION['sc_session'][$sc_init]['grid_kontrol_billing_pb']['labels']["custname"] : "Nama Pasien";
   ...
   $tab_labels["sc_field_0"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_kontrol_billing_pb']['labels']["sc_field_0"])) ? $_SESSION['sc_session'][$sc_init]['grid_kontrol_billing_pb']['labels']["sc_field_0"] : "Total";
   ...
   $tab_labels["status"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_kontrol_billing_pb']['labels']["status"])) ? $_SESSION['sc_session'][$sc_init]['grid_kontrol_billing_pb']['labels']["status"] : "Status";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_kontrol_billing_pb']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_kontrol_billing_pb']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_kontrol_billing_pb']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_kontrol_billing_pb']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_kontrol_billing_pb']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_kontrol_billing_pb']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_kontrol_billing_pb']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_kontrol_billing_pb']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_kontrol_billing_pb']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_kontrol_billing_pb_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_kontrol_billing_pb']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_kontrol_billing_pb']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_kontrol_billing_pb']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_kontrol_billing_pb']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_kontrol_billing_pb']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
