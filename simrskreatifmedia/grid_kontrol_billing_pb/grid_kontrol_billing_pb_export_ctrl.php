<?php
@session_start() ;
$_SESSION['scriptcase']['grid_kontrol_billing_pb']['sc_process_barr'] = true;
require_once('../grid_kontrol_billing_pb/index.php');
unset($_SESSION['scriptcase']['grid_kontrol_billing_pb']['sc_process_barr']);
$ExportCtrl = new grid_kontrol_billing_pb_export_control;
$ExportCtrl->Export_barr();

class grid_kontrol_billing_pb_export_control
{
