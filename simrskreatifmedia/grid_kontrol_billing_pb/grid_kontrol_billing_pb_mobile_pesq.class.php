...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "trandate";$Nm_datas[] = "trandate";$Nm_numeric[] = "id";$Nm_numeric[] = "total";$Nm_numeric[] = "deleted";$Nm_numeric[] = "iskaryawan";$Nm_numeric[] = "";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_extname"  <?php echo $str_hide_extname?>>
<?php
...
?>
   <span id="idAjaxSelect_extname">
      <SELECT class="scFilterObjectEven" id="SC_extname" name="extname[]"  size="1" multiple>
       <OPTION value=""></OPTION>
<?php
...
<?php
   ...
   function css_obj_select_ajax($Obj)
   {
      switch ($Obj)
      {
         case "extname" : return ('class="scFilterObjectEven"'); break;
         default       : return ("");
      }
   }
