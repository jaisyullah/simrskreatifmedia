<?php
class grid_kontrol_billing_pb_grid
{
   var $Ini;
   var $Erro;
   var $Db;
...
//--- 
 function monta_grid($linhas = 0)
 {
   ...
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_kontrol_billing_pb']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_kontrol_billing_pb']['field_display']))
   {
       foreach ($_SESSION['scriptcase']['sc_apl_conf']['grid_kontrol_billing_pb']['field_display'] as $NM_cada_field => $NM_cada_opc)
       {
           $this->NM_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
       }
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['usr_cmp_sel']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['usr_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['usr_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           $this->NM_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
       }
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           $this->NM_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
       }
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['embutida_init'])
   { 
        return; 
   } 
   $this->inicializa();
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['charts_html'] = '';
   ...
   { 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['SC_Ind_Groupby'] != "sc_free_total")
      {
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['embutida'])
       { 
           include_once($this->Ini->path_embutida . "grid_kontrol_billing_pb/" . $this->Ini->Apl_resumo); 
       } 
       else 
       { 
           include_once($this->Ini->path_aplicacao . $this->Ini->Apl_resumo); 
       } 
       $this->Res         = new grid_kontrol_billing_pb_resumo();
       $this->Res->Db     = $this->Db;
       $this->Res->Erro   = $this->Erro;
       $this->Res->Ini    = $this->Ini;
       $this->Res->Lookup = $this->Lookup;
      }
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['proc_pdf_vert'])
            {
            } 
            else
            {
       ...
       $nmgrp_apl_opcao= (isset($_SESSION['sc_session']['scriptcase']['embutida_form_pdf']['grid_kontrol_billing_pb'])) ? "pdf" : $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opcao'];
       if ($nmgrp_apl_opcao != "pdf")
       { 
           $this->nmgp_barra_top();
           $this->nmgp_embbed_placeholder_top();
       } 
       if ($nmgrp_apl_opcao != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opcao_print'] != 'print')
       { 
           if ($this->Ini->grid_search_change_fil)
           { 
               $seq_search = 1;
               foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['grid_pesq'] as $cmp => $def)
               {
                  $Seq_grid      = $seq_search;
                  $Cmp_grid      = $cmp;
       ...
       unset ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['save_grid']);
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['pdf_res'] && (!isset($_GET['flash_graf']) || 'chart' != $_GET['flash_graf']))
       {
           $this->grid();
       }
       if ($nmgrp_apl_opcao != "pdf")
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['print_all'] && empty($this->nm_grid_sem_reg) && ($Gera_res || $Gera_graf) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['SC_Ind_Groupby'] != "sc_free_total")
       { 
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opcao'] == "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['SC_Ind_Groupby'] != "sc_free_total")
       { 
       ...
       if (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opcao'] == "pdf")
       { 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opcao_print'] == "print")
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opcao'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opcao_ant'];
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opcao_print'] = "";
   }
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opcao_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opcao'];
 }
...
//
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['Ind_lig_mult'])) {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['Ind_lig_mult'] = 0;
   }
   $this->Img_embbed      = false;
   $this->nm_data         = new nm_data("id");
   $this->pdf_label_group = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opc_pdf']['label_group'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opc_pdf']['label_group'] : "S";
   $this->pdf_all_cab     = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opc_pdf']['all_cab']))     ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opc_pdf']['all_cab'] : "N";
   $this->pdf_all_label   = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opc_pdf']['all_label']))   ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opc_pdf']['all_label'] : "N";
   ...
   $this->Css_Cmp = array();
   $NM_css = file($this->Ini->root . $this->Ini->path_link . "grid_kontrol_billing_pb/grid_kontrol_billing_pb_grid_" .strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css");
   ...
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['pesq_tab_label']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['pesq_tab_label'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['pesq_tab_label'] .= "trandate?#?" . "Tgl Transaksi" . "?@?";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['pesq_tab_label'] .= "extname?#?" . "Nama Pembeli" . "?@?";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['grid_search_add']))
   {
       $nmgp_tab_label = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['pesq_tab_label'];
       ...
       $Seq_grid      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['grid_search_add']['seq'];
       $Cmp_grid      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['grid_search_add']['cmp'];
       ...
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['grid_search_add']);
       exit;
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['embutida'])
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['Lig_Md5']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['Lig_Md5'] = array();
       }
   }
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opcao'] != 'print')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['Lig_Md5'] = array();
   }
   $this->force_toolbar = false;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['force_toolbar']))
   { 
       $this->force_toolbar = true;
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['force_toolbar']);
   } 
       $this->Tem_tab_vert = false;
   $this->width_tabula_quebra  = "0px";
   $this->width_tabula_display = "none";
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_kontrol_billing_pb']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_kontrol_billing_pb']['lig_edit'] != '')
   {
       if ($_SESSION['scriptcase']['sc_apl_conf']['grid_kontrol_billing_pb']['lig_edit'] == "on")  {$_SESSION['scriptcase']['sc_apl_conf']['grid_kontrol_billing_pb']['lig_edit'] = "S";}
       if ($_SESSION['scriptcase']['sc_apl_conf']['grid_kontrol_billing_pb']['lig_edit'] == "off") {$_SESSION['scriptcase']['sc_apl_conf']['grid_kontrol_billing_pb']['lig_edit'] = "N";}
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['grid_kontrol_billing_pb']['lig_edit'];
   }
   $this->grid_emb_form      = false;
   $this->grid_emb_form_full = false;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['embutida_form']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['embutida_form'])
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['embutida_form_full']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['embutida_form_full'])
       {
       ...
       else
       {
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['mostra_edit'] = "N";
       }
   }
   if ($this->Ini->SC_Link_View || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opc_psq'])
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['mostra_edit'] = "N";
   }
   $this->NM_cont_body   = 0; 
   ...
   { 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['ind_tree'] = 0;
   }
   elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['emb_tree_no']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['emb_tree_no'])
   { 
       $this->NM_emb_tree_no = true; 
   }
   $this->aba_iframe = false;
   $this->Print_All = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['print_all'];
   if ($this->Print_All)
   {
   ...
   if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
   {
       ...
       {
           if (in_array("grid_kontrol_billing_pb", $apls_aba))
           {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
   {
       $this->aba_iframe = true;
   }
   $_SESSION['scriptcase']['refresh']['grid_kontrol_billing_pb']['init']  = $this->Ini->sc_page;
   $_SESSION['scriptcase']['refresh']['grid_kontrol_billing_pb']['opcao'] = 'igual';
   ...
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_kontrol_billing_pb']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_kontrol_billing_pb']['btn_display']))
   {
       foreach ($_SESSION['scriptcase']['sc_apl_conf']['grid_kontrol_billing_pb']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
       {
           $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
       }
   }
   $this->Proc_link_res = false;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['where_resumo']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['where_resumo'])) 
   { 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['doc_word'] || $this->Ini->sc_export_ajax_img)
   { 
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['campos_busca']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['campos_busca']))
   { 
       $Busca_temp = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['campos_busca'];
       ...
       $this->extname = $Busca_temp['extname']; 
       $tmp_pos = strpos($this->extname, "##@@");
       if ($tmp_pos !== false && !is_array($this->extname))
       {
           $this->extname = substr($this->extname, 0, $tmp_pos);
       }
   } 
   else 
   { 
   ...
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['where_pesq_filtro'];
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opcao'] == "muda_qt_linhas")
   { 
       unset($rec);
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opcao'] == "muda_rec_linhas")
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opcao'] = "muda_qt_linhas";
   } 

   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['dashboard_info']['maximized']) {
       $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['dashboard_info']['dashboard_app'];
       if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['grid_kontrol_billing_pb'])) {
           $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['grid_kontrol_billing_pb'];
...
//
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['embutida'])
   { 
       include_once($this->Ini->path_embutida . "grid_kontrol_billing_pb/grid_kontrol_billing_pb_total.class.php"); 
   } 
   else 
   { 
       include_once($this->Ini->path_aplicacao . "grid_kontrol_billing_pb_total.class.php"); 
   } 
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['embutida'])
   { 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['embutida_pdf'] != "pdf")  
       { 
   ...
   { 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['embutida_pdf'] = $_SESSION['scriptcase']['contr_link_emb'];
   } 
   $this->Tot         = new grid_kontrol_billing_pb_total($this->Ini->sc_page);
   $this->Tot->Db     = $this->Db;
   $this->Tot->Erro   = $this->Erro;
   $this->Tot->Ini    = $this->Ini;
   $this->Tot->Lookup = $this->Lookup;
   if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['qt_lin_grid']))
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['qt_lin_grid'] = 10;
   }   
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_kontrol_billing_pb']['rows']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_kontrol_billing_pb']['rows']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['qt_lin_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['grid_kontrol_billing_pb']['rows'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['grid_kontrol_billing_pb']['rows']);
   }
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_kontrol_billing_pb']['cols']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_kontrol_billing_pb']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['qt_col_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['grid_kontrol_billing_pb']['cols'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['grid_kontrol_billing_pb']['cols']);
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opc_liga']['rows']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['qt_lin_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opc_liga']['rows'];  
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opc_liga']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['qt_col_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opc_liga']['cols'];  
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opcao'] == "muda_qt_linhas") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opcao']  = "igual" ;  
       ...
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['qt_lin_grid'] = $nmgp_quant_linhas ;  
       } 
   }   
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['qt_reg_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['qt_lin_grid']; 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['SC_Ind_Groupby'] == "sc_free_total") 
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['ordem_select']))  
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['ordem_select'] = array(); 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['ordem_select']['trancode'] = 'DESC'; 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['ordem_select_orig'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['ordem_select']; 
       } 
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['SC_Ind_Groupby'] == "sc_free_total") 
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['ordem_quebra']))  
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['ordem_quebra'] = array(); 
       } 
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['ordem_grid']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['ordem_grid'] = "" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['ordem_ant']  = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['ordem_desc'] = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['ordem_cmp']  = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['ordem_label'] = "";  
   }   
   if (!empty($nmgp_ordem))  
   { 
       ...
       { 
           ...
           foreach($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['ordem_quebra'] as $campo => $resto) 
           {
               foreach($resto as $sqldef => $ordem) 
               {
                   ...
                   { 
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['ordem_quebra'][$campo][$nmgp_ordem] = $ordem;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['ordem_cmp'] = $nmgp_ordem;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['ordem_label'] = trim($ordem);
                   }   
               }   
           }   
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['ordem_grid'] = $nmgp_ordem  ; 
           }
       }
   }   
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opcao'] == "ordem")  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opcao'] = "inicio" ;  
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['ordem_ant'] == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['ordem_grid'])  
       { 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['ordem_desc'] != " desc")  
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['ordem_desc'] = " desc" ; 
           } 
           else   
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['ordem_desc'] = " asc" ;  
           } 
       } 
       else 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['ordem_desc'] = $this->Cmps_ord_def[$nmgp_ordem];  
       } 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['ordem_label'] = trim($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['ordem_desc']);  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['ordem_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['ordem_grid'];  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['ordem_cmp'] = $nmgp_ordem;  
   }  
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['inicio']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['inicio'] = 0 ;  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['final']  = 0 ;  
   }   
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opc_edit'])  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opc_edit'] = false;  
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opcao'] != "inicio") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opcao'] = "edit" ; 
       } 
   }   
   if (!empty($nmgp_parms) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opcao'] != "pdf")   
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opcao'] = "igual";
       $rec = "ini";
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['where_orig']) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['prim_cons'] || !empty($nmgp_parms))  
   { 
   ...
   {   
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['where_pesq'] .= $this->nm_where_dinamico;
   }   
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['where_pesq_filtro'];
...
//--------- 
//
   $nmgp_opc_orig = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opcao']; 
   if (isset($rec)) 
   { 
       if ($rec == "ini") 
       { 
       ...
       elseif ($rec == "fim") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opcao'] = "final" ; 
       } 
       else 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opcao'] = "avanca" ; 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['final'] = $rec; 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['final'] > 0) 
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['final']-- ; 
           } 
       } 
   } 
   $this->NM_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opcao']; 
   if ($this->NM_opcao == "print") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opcao_print'] = "print" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opcao']       = "igual" ; 
...
// 
   $this->count_ger = 0;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['tot_geral'][1])) 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['tot_geral'][1] ;  
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opcao'] == "final" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['qt_reg_grid'] == "all") 
   { 
       $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['SC_Ind_Groupby'];
       $this->Tot->$Gb_geral();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['tot_geral'][1] ;  
       $this->count_ger = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['tot_geral'][1];
   } 
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['where_dinamic']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['where_dinamic'] != $this->nm_where_dinamico)  
   { 
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['tot_geral']);
   } 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['where_dinamic'] = $this->nm_where_dinamico;  
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['tot_geral']) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['where_pesq_ant'] || $nmgp_opc_orig == "edit") 
   { 
       ...
       $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['SC_Ind_Groupby'];
       $this->Tot->$Gb_geral();
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['contr_array_resumo']))  
       { 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['tot_geral'][1] ;  
   $this->count_ger = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['tot_geral'][1];
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['qt_reg_grid'] == "all") 
   { 
        $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['qt_reg_grid'] = $this->count_ger;
        $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opcao']       = "inicio";
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opcao'] == "inicio" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opcao'] == "pesq") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['inicio'] = 0 ; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opcao'] == "final") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['sc_total'] - $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['qt_reg_grid']; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['inicio'] < 0) 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['inicio'] = 0 ; 
       } 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opcao'] == "retorna") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['qt_reg_grid']; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['inicio'] < 0) 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['inicio'] = 0 ; 
       } 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opcao'] == "avanca" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['sc_total'] >  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['final']) 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['final']; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opcao_print'] != "print" && substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opcao'], 0, 7) != "detalhe" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opcao'] != "pdf") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opcao'] = "igual"; 
   } 
   $this->Rec_ini = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['qt_reg_grid']; 
   if ($this->Rec_ini < 0) 
   { 
       $this->Rec_ini = 0; 
   } 
   $this->Rec_fim = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['inicio'] + $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['qt_reg_grid'] + 1; 
   if ($this->Rec_fim > $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['sc_total']) 
   { 
       $this->Rec_fim = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['sc_total']; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['inicio'] > 0) 
   { 
       $this->Rec_ini++ ; 
   } 
   $this->nmgp_reg_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['inicio']; 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['inicio'] > 0) 
   { 
       $this->nmgp_reg_start--; 
   } 
...
//----- 
   ...
   { 
       $nmgp_select = "SELECT str_replace (convert(char(10),trandate,102), '.', '-') + ' ' + convert(char(8),trandate,20), trancode, struk, resep, pasien, extname, custname, docname, doccode, resepno, total, id from " . $this->Ini->nm_tabela; 
   } 
   elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
   { 
       $nmgp_select = "SELECT trandate, trancode, struk, resep, pasien, extname, custname, docname, doccode, resepno, total, id from " . $this->Ini->nm_tabela; 
   } 
   elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
   { 
       $nmgp_select = "SELECT convert(char(23),trandate,121), trancode, struk, resep, pasien, extname, custname, docname, doccode, resepno, total, id from " . $this->Ini->nm_tabela; 
   } 
   ...
   { 
       $nmgp_select = "SELECT EXTEND(trandate, YEAR TO FRACTION), trancode, struk, resep, pasien, extname, custname, docname, doccode, resepno, total, id from " . $this->Ini->nm_tabela; 
   } 
   else 
   { 
       $nmgp_select = "SELECT trandate, trancode, struk, resep, pasien, extname, custname, docname, doccode, resepno, total, id from " . $this->Ini->nm_tabela; 
   } 
   $nmgp_select .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['where_pesq']; 
   $nmgp_order_by = ""; 
   $campos_order_select = "";
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['ordem_select'] as $campo => $ordem) 
   {
        if ($campo != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['ordem_grid']) 
        {
   ...
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['ordem_quebra'] as $campo => $resto) 
   {
       foreach($resto as $sqldef => $ordem) 
       {
           $format       = $this->Ini->Get_Gb_date_format($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['SC_Ind_Groupby'], $campo);
           $campos_order = $this->Ini->Get_date_order_groupby($sqldef, $ordem, $format, $campos_order);
       }
   }
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['ordem_grid'])) 
   { 
       if (!empty($campos_order)) 
       { 
           $campos_order .= ", ";
       } 
       $nmgp_order_by = " order by " . $campos_order . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['ordem_grid'] . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['ordem_desc']; 
   } 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['order_grid'] = $nmgp_order_by;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opcao'] == "pdf" || $this->Ini->Apl_paginacao == "FULL")
   {
   ...
   {
       $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, " . ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['qt_reg_grid'] + 2) . ", $this->nmgp_reg_start)" ; 
       $this->rs_grid = $this->Db->SelectLimit($nmgp_select, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['qt_reg_grid'] + 2, $this->nmgp_reg_start) ; 
   }  
   ...
   { 
       ...
       $this->docname = $this->rs_grid->fields[7] ;  
       $this->doccode = $this->rs_grid->fields[8] ;  
       $this->resepno = $this->rs_grid->fields[9] ;  
       $this->total = $this->rs_grid->fields[10] ;  
       $this->total =  str_replace(",", ".", $this->total);
       $this->total = (string)$this->total;
       $this->id = $this->rs_grid->fields[11] ;  
       $this->id = (string)$this->id;
       $GLOBALS["doccode"] = $this->rs_grid->fields[8] ;  
       $this->SC_seq_register = $this->nmgp_reg_start ; 
       $this->SC_seq_page = 0;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['final'] = $this->nmgp_reg_start ; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['inicio'] != 0 && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opcao'] != "pdf") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['final']++ ; 
           $this->SC_seq_register = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['final']; 
   ...
   $this->nmgp_reg_inicial = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['final'] + 1;
   $this->nmgp_reg_final   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['final'] + $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['qt_reg_grid'];
   $this->nmgp_reg_final   = ($this->nmgp_reg_final > $this->count_ger) ? $this->count_ger : $this->nmgp_reg_final;
// 
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['embutida'])
   { 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['doc_word'] && !$this->Ini->sc_export_ajax)
       {
           ...
           $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['word_return']);
       ...
       if ($this->Ini->Proc_print && $this->Ini->Export_html_zip  && !$this->Ini->sc_export_ajax)
       {
           ...
           $this->pb->initialize();
           $this->pb->setReturnUrl("./");
           $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['print_return']);
           $this->pb->setTotalSteps($this->count_ger);
       }
       if (!$this->Ini->sc_export_ajax && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opcao'] == "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['pdf_res'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['embutida_pdf'] != "pdf")
       {
           //---------- Gauge ----------
?>
...
<?php
           ...
           $this->progress_pdf     = 0;
           $this->progress_res     = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['pivot_charts']) ? sizeof($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['pivot_charts']) : 0;
...
$nm_saida->saida("                        <link rel=\"shortcut icon\" href=\"\">\r\n");
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['embutida'])
       { 
           $css_body = "";
       } 
       else 
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['ajax_nav'] && !$this->Ini->sc_export_ajax)
       { 
           ...
           $nm_saida->saida("   <script type=\"text/javascript\" src=\"grid_kontrol_billing_pb_jquery.js\"></script>\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\" src=\"grid_kontrol_billing_pb_ajax.js\"></script>\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\" src=\"grid_kontrol_billing_pb_message.js\"></script>\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\">\r\n");
           ...
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['embutida'] || $this->Ini->Apl_paginacao == "FULL")
           {
               $nm_saida->saida("   var scQtReg  = " . NM_encode_input($this->count_ger) . ";\r\n");
           }
           else
           {
               $nm_saida->saida("   var scQtReg  = " . NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['qt_reg_grid']) . ";\r\n");
           }
           ...
           $nm_saida->saida("   var gridHeaders = $(\".sc-ui-grid-header-row-grid_kontrol_billing_pb-1\"), headerDisplayed = true;\r\n");
           ...
           $nm_saida->saida("   tableOriginal = document.getElementById(\"sc-ui-grid-body-6d6fad9a\");\r\n");
           ...
           if ($nmgrp_apl_opcao != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opcao_print'] != 'print' && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['grid_pesq']))
           { 
           ...
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['ancor_save']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['ancor_save']))
           {
               $nm_saida->saida("       var catTopPosition = jQuery('#SC_ancor" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['ancor_save'] . "').offset().top;\r\n");
               $nm_saida->saida("       jQuery('html, body').animate({scrollTop:catTopPosition}, 'fast');\r\n");
               $nm_saida->saida("       $('#SC_ancor" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['ancor_save'] . "').addClass('" . $this->css_scGridFieldOver . "');\r\n");
               unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['ancor_save']);
           }
           if (!$this->Ini->SC_Link_View && $this->nmgp_botoes['qsearch'] == "on")
           {
           ...
           $nm_saida->saida("       dataType: \"html\",\r\n");
           $nm_saida->saida("       url: \"grid_kontrol_billing_pb_save_grid.php\",\r\n");
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['num_css']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['num_css'] = rand(0, 1000);
       }
       $write_css = true;
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['embutida'] && !$this->Print_All && $this->NM_opcao != "print" && $this->NM_opcao != "pdf")
       {
           $write_css = false;
       }
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['embutida_pdf']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['embutida_pdf'])
       {
           $write_css = true;
       }
       if ($write_css) {$NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_kontrol_billing_pb_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['num_css'] . '.css', 'w');}
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['embutida'])
       {
 ...
 { 
       ...
       {
           $nm_saida->saida("  <style type=\"text/css\">\r\n");
           $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_kontrol_billing_pb_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['num_css'] . '.css');
           foreach ($NM_css as $cada_css)
           {
       ...
       {
           $nm_saida->saida("   <link rel=\"stylesheet\" href=\"" . $this->Ini->path_imag_temp . "/sc_css_grid_kontrol_billing_pb_grid_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['num_css'] . ".css\" type=\"text/css\" media=\"screen\" />\r\n");
           $nm_saida->saida("   <link rel=\"stylesheet\" href=\"../_lib/css/" . $_SESSION['scriptcase']['erro']['str_schema'] . "\" type=\"text/css\" media=\"screen\" />\r\n");
           $nm_saida->saida("   <link rel=\"stylesheet\" href=\"../_lib/css/" . $_SESSION['scriptcase']['erro']['str_schema_dir'] . "\" type=\"text/css\" media=\"screen\" />\r\n");
       }
       ...
       if (!$write_css)
       {
           $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_kontrol_billing_pb/grid_kontrol_billing_pb_grid_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
       }
       else
       {
           $nm_saida->saida("  <style type=\"text/css\">\r\n");
  ...
  if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['proc_pdf_vert'])
  {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['embutida'] && $this->Ini->nm_ger_css_emb)
   {
       ...
       foreach ($NM_css as $cada_css)
       {
           $cada_css = ".grid_kontrol_billing_pb_" . substr($cada_css, 1);
              $nm_saida->saida("  " . str_replace("\r\n", "", $cada_css) . "\r\n");
       }
           $nm_saida->saida("  </style>\r\n");
   }
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['embutida'])
   { 
       if (!$this->Ini->Export_html_zip && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['doc_word'] && ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opcao_print'] == "print")) 
       {
           if ($this->Print_All) 
           {
               $nm_saida->saida(" <link rel=\"stylesheet\" type=\"text/css\" href=\"../_lib/buttons/" . $this->Ini->Str_btn_css . "\" /> \r\n");
           }
           $nm_saida->saida("  <body class=\"" . $this->css_scGridPage . "\" " . $str_iframe_body . " style=\"-webkit-print-color-adjust: exact;" . $css_body . "\" onload=\"javascript:setTimeout(function(){ window.location = '" . $this->Ini->path_link . "grid_kontrol_billing_pb/index.php';},30000);\">\r\n");
       ...
       {
          $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
           $nm_saida->saida("  <body class=\"" . $this->css_scGridPage . "\" " . $str_iframe_body . " style=\"" . $remove_margin. $css_body . "\" onload=\"javascript:setTimeout(function(){ window.location = '" . $this->Ini->path_link . "grid_kontrol_billing_pb/index.php';},30000);\">\r\n");
       }
       $nm_saida->saida("  " . $this->Ini->Ajax_result_set . "\r\n");
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opcao'] != "pdf" && !$this->Print_All)
       { 
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['doc_word'])
       { 
   ...
   else
   {
       ...
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opcao'] != "pdf" && 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opcao_print'] != "print") 
       { 
           $nm_saida->saida("    <TR>\r\n");
           $nm_saida->saida("    <TD  colspan=3 style=\"padding: 0px; border-width: 0px; vertical-align: top;\">\r\n");
           $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_A_grid_kontrol_billing_pb\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" name=\"nm_iframe_liga_A_grid_kontrol_billing_pb\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
           $nm_saida->saida("    </TD>\r\n");
           $nm_saida->saida("    </TR>\r\n");
           $nm_saida->saida("    <TR>\r\n");
           $nm_saida->saida("    <TD style=\"padding: 0px; border-width: 0px; vertical-align: top;\">\r\n");
           $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_E_grid_kontrol_billing_pb\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" name=\"nm_iframe_liga_E_grid_kontrol_billing_pb\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
           $nm_saida->saida("    </TD>\r\n");
           $nm_saida->saida("    <td style=\"padding: 0px;  vertical-align: top;\"><table style=\"padding: 0px; border-spacing: 0px; border-width: 0px; vertical-align: top;\" width=\"100%\"><tr>\r\n");
           $nm_saida->saida("    <TD colspan=3 style=\"padding: 0px; border-width: 0px; vertical-align: top;\" width=1>\r\n");
      $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_AL_grid_kontrol_billing_pb\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" name=\"nm_iframe_liga_AL_grid_kontrol_billing_pb\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
           $nm_saida->saida("    </TD>\r\n");
           $nm_saida->saida("    </TR>\r\n");
        } 
   }  
 ...
 {  
   ...
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['SC_herda_css'] == "N")
   {
       if (($this->NM_opcao == "print" && $GLOBALS['nmgp_cor_print'] == "PB") || ($this->NM_opcao == "pdf" &&  $GLOBALS['nmgp_tipo_pdf'] == "pb") || ($_SESSION['scriptcase']['contr_link_emb'] == "pdf" &&  $GLOBALS['nmgp_tipo_pdf'] == "pb")) 
       { 
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['grid_kontrol_billing_pb']))
           {
               $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['grid_kontrol_billing_pb']) . "_";
           } 
       } 
       else 
       { 
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['grid_kontrol_billing_pb']))
           {
               $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['grid_kontrol_billing_pb']) . "_";
           } 
       }
   }
   $temp_css  = explode("/", $compl_css);
   ...
   $compl_css_emb = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['embutida']) ? "grid_kontrol_billing_pb_" : "";
   $this->css_sep = " ";
...
// 
 function label_grid($linhas = 0)
 {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['exibe_titulos'] != "S")
   { 
   } 
   else 
   { 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['embutida_label'])
      { 
   ...
   $nm_saida->saida("    <TR id=\"tit_grid_kontrol_billing_pb__SCCS__" . $nm_seq_titulos . "\" align=\"center\" class=\"" . $this->css_scGridLabel . " sc-ui-grid-header-row sc-ui-grid-header-row-grid_kontrol_billing_pb-" . $tmp_header_row . "\">\r\n");
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['embutida_label']) { 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opc_psq']) { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_resepno_label'] . "\" >&nbsp;</TD>\r\n");
   } 
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opcao'] != "pdf") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_resepno_label'] . "\" >&nbsp;</TD>\r\n");
   } 
   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['field_order'] as $Cada_label)
   { 
   ...
   $nm_saida->saida("</TR>\r\n");
     ...
     { 
         ...
         { 
             ...
             foreach ($NM_css as $cada_css)
             {
                 $css_emb .= ".grid_kontrol_billing_pb_" . substr($cada_css, 1);
             }
             $css_emb .= "</style>";
             $Cod_Html = $css_emb . $Cod_Html;
             $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['cols_emb'] = count($Nm_temp) - 1;
             if ($contr_embutida) 
             { 
     ...
     $NM_seq_lab = 1;
     foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['labels'] as $NM_cmp => $NM_lab)
     {
         if (empty($NM_lab) || $NM_lab == "&nbsp;")
         {
             $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['labels'][$NM_cmp] = "No_Label" . $NM_seq_lab;
             $NM_seq_lab++;
         }
     } 
   } 
 ...
 function NM_label_trancode()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opcao'] != "pdf")
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['ordem_cmp'] == 'trancode')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['ordem_label'] == "desc")
          {
 ...
 function NM_label_struk()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['ordem_cmp'] == 'struk')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_resep()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['ordem_cmp'] == 'resep')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 {
   global $nm_saida;
   $SC_Label = (isset($this->New_label['extname'])) ? $this->New_label['extname'] : "Nama Pembeli"; 
 ...
 {
   global $nm_saida;
   $SC_Label = (isset($this->New_label['sc_field_0'])) ? $this->New_label['sc_field_0'] : "Total"; 
 ...
 function NM_label_docname()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['ordem_cmp'] == 'docname')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_doccode()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['ordem_cmp'] == 'doccode')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_resepno()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['ordem_cmp'] == 'resepno')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
...
//----- 
 function grid($linhas = 0)
 {
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['rows_emb'] = 0;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['embutida'])
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['ini_cor_grid']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['ini_cor_grid'] == "impar")
       {
           $this->Ini->qual_linha = "impar";
           unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['ini_cor_grid']);
       }
   }
...
// 
   $SC_Label = (isset($this->New_label['trandate'])) ? $this->New_label['trandate'] : "Tgl Transaksi"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['labels']['trandate'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['trancode'])) ? $this->New_label['trancode'] : "Kode Transaksi"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['labels']['trancode'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['struk'])) ? $this->New_label['struk'] : "No Struk"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['labels']['struk'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['resep'])) ? $this->New_label['resep'] : "Resep ?"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['labels']['resep'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['pasien'])) ? $this->New_label['pasien'] : "Pasien ?"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['labels']['pasien'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['extname'])) ? $this->New_label['extname'] : "Nama Pembeli"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['labels']['extname'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['custname'])) ? $this->New_label['custname'] : "Nama Pasien"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['labels']['custname'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['sc_field_0'])) ? $this->New_label['sc_field_0'] : "Total"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['labels']['sc_field_0'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['status'])) ? $this->New_label['status'] : "Status"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['labels']['status'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['docname'])) ? $this->New_label['docname'] : "Nama Dokter"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['labels']['docname'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['doccode'])) ? $this->New_label['doccode'] : "Dokter"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['labels']['doccode'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['resepno'])) ? $this->New_label['resepno'] : "No Resep"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['labels']['resepno'] = $SC_Label; 
   if (!$this->grid_emb_form && isset($_SESSION['scriptcase']['sc_apl_conf']['grid_kontrol_billing_pb']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_kontrol_billing_pb']['lig_edit'] != '')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['grid_kontrol_billing_pb']['lig_edit'];
   }
   if (!empty($this->nm_grid_sem_reg))
   {
       ...
       {
           $this->Lin_impressas++;
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['embutida_grid'])
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['cols_emb']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['cols_emb']))
               {
                   $cont_col = 0;
                   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['field_order'] as $cada_field)
                   {
                       $cont_col++;
                   }
               ...
               {
                   $NM_span_sem_reg  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['cols_emb'];
               }
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['rows_emb']++;
           ...
           {
               $nm_saida->saida("<table id=\"apl_grid_kontrol_billing_pb#?#$nm_seq_execucoes\" width=\"100%\" style=\"padding: 0px; border-spacing: 0px; border-width: 0px; vertical-align: top;\">\r\n");
               $nm_saida->saida("  <tr><td class=\"" . $this->css_scGridTabelaTd . " " . "\" style=\"font-family:" . $this->Ini->texto_fonte_tipo_impar . ";font-size:12px;color:#000000;\"><table style=\"padding: 0px; border-spacing: 0px; border-width: 0px; vertical-align: top;\" width=\"100%\">\r\n");
               $nm_id_aplicacao = "";
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['cab_embutida'] != "S")
               {
      ...
      $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_EL_grid_kontrol_billing_pb\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" name=\"nm_iframe_liga_EL_grid_kontrol_billing_pb\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
               $nm_saida->saida("    </TD>\r\n");
           ...
           { 
               $this->force_toolbar = true;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['force_toolbar'] = true;
           } 
           ...
           { 
               ...
               $this->Ini->Arr_result['setSrc'][] = array('field' => 'nmsc_iframe_liga_A_grid_kontrol_billing_pb', 'value' => 'NM_Blank_Page.htm');
               $this->Ini->Arr_result['setSrc'][] = array('field' => 'nmsc_iframe_liga_D_grid_kontrol_billing_pb', 'value' => 'NM_Blank_Page.htm');
               $this->Ini->Arr_result['setSrc'][] = array('field' => 'nmsc_iframe_liga_E_grid_kontrol_billing_pb', 'value' => 'NM_Blank_Page.htm');
               $_SESSION['scriptcase']['saida_html'] = "";
           } 
           $nm_saida->saida("  </td></tr>\r\n");
           if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opcao'] != "pdf" &&
      ...
      $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_DL_grid_kontrol_billing_pb\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" name=\"nm_iframe_liga_DL_grid_kontrol_billing_pb\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
               $nm_saida->saida("</TD>\r\n");
               $nm_saida->saida("    <TD style=\"padding: 0px; border-width: 0px; vertical-align: top;\">\r\n");
               $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_D_grid_kontrol_billing_pb\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" name=\"nm_iframe_liga_D_grid_kontrol_billing_pb\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
               $nm_saida->saida("    </TD>\r\n");
               $nm_saida->saida("    </TR>\r\n");
           } 
       $nm_saida->saida("</TABLE>\r\n");
...
else
{
      ...
      $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_EL_grid_kontrol_billing_pb\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" name=\"nm_iframe_liga_EL_grid_kontrol_billing_pb\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
       ...
       $nm_id_aplicacao = " id=\"apl_grid_kontrol_billing_pb#?#1\"";
   } 
   $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opcao'] == "pdf") ? "padding: 0px !important;" : "";
if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['proc_pdf_vert'])
{
}
else
...
if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['proc_pdf']) { 
 ...
 if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['proc_pdf']) { 
   ...
   $nm_saida->saida("   <TABLE class=\"" . $this->css_scGridTabela . "\" id=\"sc-ui-grid-body-6d6fad9a\" align=\"center\" " . $nm_id_aplicacao . " width=\"100%\">\r\n");
 }
 if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['proc_pdf_vert']) { 
    $nm_saida->saida("</thead>\r\n");
 }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['proc_pdf'] && $this->pdf_all_label != "S" && $this->pdf_label_group != "S") 
   { 
      $this->label_grid($linhas);
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['embutida_grid'])
...
// 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['Config_Page_break_PDF'] = "N";
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['Page_break_PDF']))
   {
       if (isset($this->Break_pag_pdf[$_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['SC_Ind_Groupby']]))
       {
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['SC_Ind_Groupby'] == "sc_free_group_by")
           {
               foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['SC_Gb_Free_cmp'] as $Cmp_gb => $resto)
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['Page_break_PDF'][$Cmp_gb] = $this->Break_pag_pdf['sc_free_group_by'][$Cmp_gb];
               }
           }
           else
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['Page_break_PDF'] = $this->Break_pag_pdf[$_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['SC_Ind_Groupby']];
           }
       }
       else
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['Page_break_PDF'] = array();
       }
   }
   ...
   while (!$this->rs_grid->EOF && $nm_quant_linhas < $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['qt_reg_grid'] && ($linhas == 0 || $linhas > $this->Lin_impressas)) 
   {  
          $this->Rows_span = 1;
          ...
          //---------- Gauge ----------
          if (!$this->Ini->sc_export_ajax && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opcao'] == "pdf" && -1 < $this->progress_grid)
          {
              $this->progress_now++;
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['SC_Ind_Groupby'] != "sc_free_total")
         {
          ...
          $GLOBALS["doccode"] = $this->rs_grid->fields[8] ;  
          $this->SC_seq_page++; 
          $this->SC_seq_register = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['final'] + 1; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['rows_emb']++;
          $this->sc_proc_grid = true;
          $_SESSION['scriptcase']['grid_kontrol_billing_pb']['contr_erro'] = 'on';
...
$this->sc_field_0  = $this->total +($this->total *(10/100));
$_SESSION['scriptcase']['grid_kontrol_billing_pb']['contr_erro'] = 'off';
          ...
          $seq_det =  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['final']; 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['embutida_grid'])
          {
             $NM_destaque ="";
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opc_psq'])
          {
              $temp = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['dado_psq_ret'];
 ...
 if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['mostra_edit'] != "N"){ 
              ...
              if (isset($this->Ini->sc_lig_md5["form_tbdrugsell"]) && $this->Ini->sc_lig_md5["form_tbdrugsell"] == "S")
              {
                  ...
                  if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['dashboard_info']['under_dashboard'] && isset($linkTarget))
                  {
                      if ('' != $Parms_Edt && '?@?' != substr($Parms_Edt, -3) && '*scout' != substr($Parms_Edt, -6))
                      {
                          $Parms_Edt .= '*scout';
                      }
                      $Parms_Edt .= 'under_dashboard*scin1*scoutdashboard_app*scin' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['dashboard_info']['dashboard_app'] . '*scoutown_widget*scin' . $linkTarget . '*scoutparent_widget*scin' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['dashboard_info']['own_widget'] . '*scoutcompact_mode*scin' . ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['dashboard_info']['compact_mode'] ? '1' : '0') . '*scoutremove_margin*scin' . ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['dashboard_info']['remove_margin'] ? '1' : '0');
                  }
                  $Md5_Edt    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_kontrol_billing_pb@SC_par@" . md5($Parms_Edt);
                  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['Lig_Md5'][md5($Parms_Edt)] = $Parms_Edt;
              }
              else
              {
 ...
 if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['mostra_edit'] == "N"){ 
          ...
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['field_order'] as $Cada_col)
          { 
              $NM_func_grid = "NM_grid_" . $Cada_col;
              $this->$NM_func_grid();
          } 
          $nm_saida->saida("</TR>\r\n");
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['embutida_grid'] && $this->nm_prim_linha)
          { 
              $nm_saida->saida("##NM@@"); 
   ...
   { 
       ...
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['exibe_total'] == "S")
       { 
           $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['SC_Ind_Groupby'] . "_top";
           $this->$Gb_geral() ;
       } 
   }  
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['embutida_grid'])
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opcao'] != "pdf" && empty($this->nm_grid_sem_reg) && 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opcao_print'] != "print") 
   { 
       $nm_saida->saida("</TABLE></TD>\r\n");
       $nm_saida->saida("<TD style=\"padding: 0px; border-width: 0px;\" valign=\"top\" width=1>\r\n");
 ...
 function NM_grid_sc_field_0()
 {
      ...
      if (!isset($this->NM_cmp_hidden['sc_field_0']) || $this->NM_cmp_hidden['sc_field_0'] != "off") { 
          ...
          { 
              nmgp_Form_Num_Val($conteudo, ".", "", "0", "S", "1", "Rp", "V:3:3", "-") ; 
          } 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['proc_pdf'])
          {
              $this->SC_nowrap = "";
 ...
 function NM_calc_span()
 {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['embutida_pdf'] == "pdf")
   {
       $this->NM_colspan--;
   } 
 ...
 function nm_quebra_pagina($nm_parms)
 {
    ...
    if (($this->Ini->nm_limite_lin > 0 && $this->Ini->nm_cont_lin > $this->Ini->nm_limite_lin) || $nm_parms == "pagina" || $nm_parms == "resumo" || $nm_parms == "total")
    {
        ...
        if ($this->Print_All)
        {
            if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['print_navigator']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['print_navigator'] == "Netscape")
            {
        ...
        if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['proc_pdf'] && $nm_parms != "resumo" && $nm_parms != "pagina" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['embutida_grid'])
        {
            $this->label_grid();
        }
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['proc_pdf'] && $this->pdf_label_group != "S" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['embutida_grid'])
        {
            $this->nm_inicio_pag = 0;
        }
    }
 ...
 function quebra_geral_sc_free_total_bot() 
 {
   ...
   function nmgp_barra_top_normal()
   {
      ...
      if (!$this->Ini->SC_Link_View && $this->nmgp_botoes['qsearch'] == "on")
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['fast_search'][2] : "";
      ...
      if ($this->nmgp_botoes['sel_col'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
      $pos_path = strrpos($this->Ini->path_prod, "/");
      $path_fields = $this->Ini->root . substr($this->Ini->path_prod, 0, $pos_path) . "/conf/fields/";
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcolumns", "scBtnSelCamposShow('" . $this->Ini->path_link . "grid_kontrol_billing_pb/grid_kontrol_billing_pb_sel_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&path_fields=" . $path_fields . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "scBtnSelCamposShow('" . $this->Ini->path_link . "grid_kontrol_billing_pb/grid_kontrol_billing_pb_sel_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&path_fields=" . $path_fields . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "selcmp_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
              $NM_btn = true;
      }
      if ($this->nmgp_botoes['sort_col'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          ...
          else
          {
              ...
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bsort", "scBtnOrderCamposShow('" . $this->Ini->path_link . "grid_kontrol_billing_pb/grid_kontrol_billing_pb_order_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&use_alias=" . $UseAlias . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "scBtnOrderCamposShow('" . $this->Ini->path_link . "grid_kontrol_billing_pb/grid_kontrol_billing_pb_order_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&use_alias=" . $UseAlias . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "ordcmp_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
              $NM_btn = true;
      }
      if ($this->nmgp_botoes['group_1'] == "on" && !$this->grid_emb_form)
      {
          ...
          $nm_saida->saida("           $Cod_Btn\r\n");
      if ($this->nmgp_botoes['pdf'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['SC_Ind_Groupby'] == "sc_free_group_by" && empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['SC_Gb_Free_cmp']))
      {
          $Tem_pdf_res = "n";
      }
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "pdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_kontrol_billing_pb/grid_kontrol_billing_pb_config_pdf.php?nm_opc=pdf&nm_target=0&nm_cor=cor&papel=1&lpapel=279&apapel=216&orientacao=1&bookmarks=1&largura=1200&conf_larg=S&conf_fonte=10&grafico=XX&sc_ver_93=" . s . "&nm_tem_gb=" . $Tem_gb_pdf . "&nm_res_cons=" . $Tem_pdf_res . "&nm_ini_pdf_res=grid,resume,chart&nm_all_modules=grid,resume,chart&nm_label_group=S&nm_all_cab=N&nm_all_label=N&nm_orient_grid=2&password=n&summary_export_columns=N&pdf_zip=N&origem=cons&language=id&conf_socor=N&script_case_init=" . $this->Ini->sc_page . "&app_name=grid_kontrol_billing_pb&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      ...
      if ($this->nmgp_botoes['word'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $Tem_word_res = "n";
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['SC_Ind_Groupby'] != "sc_free_total")
          ...
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "word_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_kontrol_billing_pb/grid_kontrol_billing_pb_config_word.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=N&nm_cor=AM&nm_res_cons=" . $Tem_word_res . "&nm_ini_word_res=grid&nm_all_modules=grid,resume,chart&password=n&origem=cons&language=id&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      if ($this->nmgp_botoes['xls'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $Tem_xls_res = "n";
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['SC_Ind_Groupby'] != "sc_free_total")
      ...
      if ($this->nmgp_botoes['xml'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $Tem_xml_res = "n";
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['SC_Ind_Groupby'] != "sc_free_total")
      ...
      if ($this->nmgp_botoes['csv'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $Tem_csv_res = "n";
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['SC_Ind_Groupby'] != "sc_free_total")
      ...
      if ($this->nmgp_botoes['rtf'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
      ...
      if ($this->nmgp_botoes['print'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $Tem_pdf_res = "n";
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['SC_Ind_Groupby'] != "sc_free_total")
          {
      ...
      if (!$this->Ini->SC_Link_View && $this->nmgp_botoes['filter'] == "on"  && !$this->grid_emb_form)
      {
        ...
        if (!$this->Ini->SC_Link_View && $this->nmgp_botoes['new'] == "on" && $this->nmgp_botoes['insert'] == "on" && !$this->grid_emb_form)
        {
           ...
           if (isset($this->Ini->sc_lig_md5["form_tbdrugsell"]) && $this->Ini->sc_lig_md5["form_tbdrugsell"] == "S") {
               ...
               $Md5_Lig    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_kontrol_billing_pb@SC_par@" . md5($Parms_Lig);
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['Lig_Md5'][md5($Parms_Lig)] = $Parms_Lig;
           } else {
        ...
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['SC_Ind_Groupby'] != "sc_free_total")
        {
          if ($this->nmgp_botoes['summary'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
          {
          ...
          if (is_file("grid_kontrol_billing_pb_help.txt") && !$this->grid_emb_form)
          {
             $Arq_WebHelp = file("grid_kontrol_billing_pb_help.txt"); 
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['b_sair'] || $this->grid_emb_form || $this->grid_emb_form_full || (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['dashboard_info']['under_dashboard']))
      {
      ...
      {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['sc_modal'])
        {
   ...
   function nmgp_barra_bot_normal()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opcao_print'] != "print") 
      {
          ...
          {
              $Reg_Page  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['qt_lin_grid'];
          ...
          if (empty($this->nm_grid_sem_reg) && $this->nmgp_botoes['qtline'] == "on" && $this->Ini->Apl_paginacao != "FULL")
          {
              ...
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['qt_lin_grid'] == 10) ? " selected" : "";
              $nm_saida->saida("           <option value=\"10\" " . $obj_sel . ">10</option>\r\n");
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['qt_lin_grid'] == 20) ? " selected" : "";
              $nm_saida->saida("           <option value=\"20\" " . $obj_sel . ">20</option>\r\n");
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['qt_lin_grid'] == 50) ? " selected" : "";
          ...
          $nm_saida->saida("         </td> \r\n");
          $nm_saida->saida("          <td class=\"" . $this->css_scGridToolbarPadd . "\" nowrap valign=\"middle\" align=\"center\" width=\"33%\"> \r\n");
          if ($this->nmgp_botoes['first'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opc_liga']['nav']))
          {
              if ($this->Rec_ini == 0)
              {
          ...
          if ($this->nmgp_botoes['back'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opc_liga']['nav']))
          {
              if ($this->Rec_ini == 0)
              {
          ...
          if (empty($this->nm_grid_sem_reg) && $this->nmgp_botoes['navpage'] == "on" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opc_liga']['nav']) && $this->Ini->Apl_paginacao != "FULL" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['qt_lin_grid'] != "all")
          {
              $Reg_Page  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['qt_lin_grid'];
              $Max_link   = 5;
          ...
          if ($this->nmgp_botoes['forward'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opc_liga']['nav']))
          {
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcons_avanca", "nm_gp_submit_rec('" . $this->Rec_fim . "');", "nm_gp_submit_rec('" . $this->Rec_fim . "');", "forward_bot", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
              $NM_btn = true;
          }
          if ($this->nmgp_botoes['last'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opc_liga']['nav']))
          {
   ...
   function html_grid_search()
   {
       ...
       $tmp = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['cond_pesq'];
       $pos = strrpos($tmp, "##*@@");
       if ($pos !== false)
       {
       ...
       $str_display = empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['grid_pesq'])?'none':'';
       if(!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['ajax_nav'])
       {
          $nm_saida->saida("   <tr id=\"NM_Grid_Search\" ajax='' style='display:" . $str_display . "'>\r\n");
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['ajax_nav'] && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['grid_pesq']))
       { 
           $_SESSION['scriptcase']['saida_html'] = "";
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['grid_pesq'] as $cmp => $def)
           {
           ...
           if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['save_grid']))
           {
               return;
           }
           else
       ...
       $nm_saida->saida("            <input type=\"hidden\" name=\"parm\" value=\"\"/> \r\n");
            if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['grid_pesq']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['grid_pesq']))
            {
                foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['grid_pesq'] as $cmp => $def)
                {
                    if (isset($def['label'])) {
                        ...
                        if ($cmp == "extname")
                        {
                           $this->grid_search_dat[$this->grid_search_seq] = "extname";
                           $lin_obj = $this->grid_search_extname($this->grid_search_seq, 'N', $def['opc'], $def['val'], $def['label']);
                           $nm_saida->saida("" . $lin_obj . "\r\n");
                        }
       ...
       { 
           ...
           $_SESSION['scriptcase']['saida_html'] = "";
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['save_grid']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['grid_pesq']))
           { 
   ...
   {
       global $nm_saida;
       $this->Cmps_select2_grid = array('extname');
       $lin_obj  = "";
   ...
   {
       $lin_obj  = "";
       $All_cmp_search = array('trandate','extname');
       $nmgp_tab_label = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['pesq_tab_label'];
       if (!empty($nmgp_tab_label))
       {
          $nm_tab_campos = explode("?@?", $nmgp_tab_label);
       ...
       if (count($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['grid_pesq']) < 2)
       {
           $lin_obj .= "<table id='id_grid_search_all_cmp' cellpadding=0 cellspacing=0>";
           foreach ($All_cmp_search as $cada_cmp)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['grid_pesq'][$cada_cmp]))
               {
                   $lin_obj .= "  <tr>";
   ...
   function grid_search_extname($ind, $ajax, $opc="", $val=array(), $label='')
   {
       $lin_obj  = "";
       $lin_obj .= "     <div class='scGridFilterTagListFilter' id='grid_search_extname_" . $ind . "' style='display:none'>";
       $lin_obj .= "         <div class='scGridFilterTagListFilterLabel'>". NM_encode_input($label) ." <span class='scGridFilterTagListFilterLabelClose' onclick='closeAllTags(this);'></span></div>";
       $lin_obj .= "         <div class='scGridFilterTagListFilterInputs'>";
       if (empty($opc))
       {
       ...
       $lin_obj .= "       <select id='grid_search_extname_cond_" . $ind . "' name='cond_grid_search_extname_" . $ind . "' class='" . $this->css_scAppDivToolbarInput . "' style='vertical-align: middle; display: none'>";
       ...
       $lin_obj .= "       <span id=\"grid_extname_" . $ind . "\" style=\"display:" . $display_in_1 . "\">";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['psq_check_ret']['extname'] = array();
       $extname_look = substr($this->Db->qstr($extname), 1, -1); 
       $nmgp_def_dados  = ""; 
       $nmgp_def_dados .= "?#??#?N?@?"; 
       $nm_comando = "SELECT extname, extname  FROM tbdrugsell  GROUP BY extname"; 
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
       { 
          while (!$rs->EOF) 
          { 
             $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['psq_check_ret']['extname'][] = trim($rs->fields[0]);
       ...
       $lin_obj .= "    <SELECT class='" . $this->css_scAppDivToolbarInput . "' style='height : auto;' id=\"grid_search_extname_val_" . $ind . "\" name=\"val_grid_search_extname_" . $ind . "[]\"  size=1 multiple>";
       $delimitador = "##@@";
       ...
       foreach ($nm_opcoes as $nm_opcao)
       {
          if (!empty($nm_opcao))
          {
             ...
             {
                $extname_sel = ("S" == $nm_opc_sel) ? " selected" : "";
             }
             $lin_obj .= "       <OPTION value=\"" . NM_encode_input($nm_opc_cod . $delimitador . $nm_opc_val) . "\"" . $extname_sel . ">" . $nm_opc_val . "</OPTION>";
          }
       }
       $lin_obj .= "    </SELECT>";
       $lin_obj .= "       </span>";
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "simrskreatifmedia/grid_kontrol_billing_pb";
   ...
   function JS_grid_search()
   {
       ...
       $nm_saida->saida("     function Sc_carga_select2_grid_extname(SEQ)\r\n");
       $nm_saida->saida("     {\r\n");
       $nm_saida->saida("      $(\"#grid_search_extname_val_\" + SEQ).select2(\r\n");
       $nm_saida->saida("        {\r\n");
       ...
       $nm_saida->saida("                 }\r\n");
       $nm_saida->saida("                 if (Tab_obj_grid_search[i] == 'extname')\r\n");
       $nm_saida->saida("                 {\r\n");
...
$nm_saida->saida("             }\r\n");
 ...
 function nm_fim_grid($flag_apaga_pdf_log = TRUE)
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['embutida'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']))
   {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opcao'] != "pdf" &&
        $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opcao_print'] != "print" && !$this->Print_All) 
   { 
      $nm_saida->saida("     <tr><td colspan=3  class=\"" . $this->css_scGridTabelaTd . "\" style=\"vertical-align: top\"> \r\n");
      $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_B_grid_kontrol_billing_pb\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" name=\"nm_iframe_liga_B_grid_kontrol_billing_pb\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
      $nm_saida->saida("     </td></tr> \r\n");
   } 
   $nm_saida->saida("   </TABLE>\r\n");
   $nm_saida->saida("   </div>\r\n");
   ...
   $nm_saida->saida("   </body>\r\n");
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opcao'] == "pdf" || $this->Print_All)
   { 
   $nm_saida->saida("   </HTML>\r\n");
        return;
   } 
   ...
   if ($this->Rec_ini == 0 && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
   { 
   ...
   elseif ($this->Rec_ini == 0 && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opcao'] != "pdf" && $_SESSION['scriptcase']['proc_mobile'])
   { 
       $nm_saida->saida("   document.getElementById('first_bot').disabled = true;\r\n");
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['ajax_nav'])
       {
   ...
   $nm_saida->saida("   if (typeof(scSetFixedHeaders) === typeof(function(){})) scSetFixedHeaders();\r\n");
   $nm_saida->saida("  });\r\n");
   if ($this->rs_grid->EOF && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opcao'] != "pdf")
   {
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opcao'] != "pdf" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opc_liga']['nav']) && !$_SESSION['scriptcase']['proc_mobile'])
       { 
           { 
       ...
       elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opcao'] != "pdf" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['opc_liga']['nav']) && $_SESSION['scriptcase']['proc_mobile'])
       { 
           { 
               $nm_saida->saida("   document.getElementById('forward_bot').disabled = true;\r\n");
               $nm_saida->saida("   document.getElementById('forward_bot').className = \"scButton_" . $this->arr_buttons['bcons_avanca']['style'] . " disabled\";\r\n");
   ...
   if ($this->grid_emb_form || $this->grid_emb_form_full)
   {
       ...
       $nm_saida->saida("         setTimeout(\"parent.scAjaxDetailHeight('grid_kontrol_billing_pb', $(document).innerHeight())\",50);\r\n");
       $nm_saida->saida("      }\r\n");
       $nm_saida->saida("   </script>\r\n");
   }
   $nm_saida->saida("   </HTML>\r\n");
...
//--- 
 function form_navegacao()
 {
   ...
   $nm_saida->saida("    <input type=\"hidden\" name=\"SC_lig_apl_orig\" value=\"grid_kontrol_billing_pb\"/>\r\n");
   ...
   $nm_saida->saida("                     action=\"grid_kontrol_billing_pb_pesq.class.php\" \r\n");
   $nm_saida->saida("                     target=\"_self\" style=\"display: none\"> \r\n");
   $nm_saida->saida("    <input type=\"hidden\" name=\"script_case_init\" value=\"" . NM_encode_input($this->Ini->sc_page) . "\"/> \r\n");
   $nm_saida->saida("    <input type=\"hidden\" name=\"script_case_session\" value=\"" . NM_encode_input(session_id()) . "\"/> \r\n");
   $nm_saida->saida("   </form> \r\n");
   ...
   $nm_saida->saida("                     action=\"grid_kontrol_billing_pb_iframe_prt.php\" \r\n");
   ...
   $nm_saida->saida("               nm_submit_modal(\"" . $this->Ini->path_link . "grid_kontrol_billing_pb/grid_kontrol_billing_pb_export_email.php?script_case_init={$this->Ini->sc_page}&path_img={$this->Ini->path_img_global}&path_btn={$this->Ini->path_botoes}&sType=\"+ str_type +\"&sAdd=__E__nmgp_cor_word=\" + cor + \"__E__SC_module_export=\" + SC_module_export + \"__E__nmgp_password=\" + password + \"&KeepThis=true&TB_iframe=true&modal=true\", bol_param);\r\n");
   $nm_saida->saida("       }\r\n");
   $nm_saida->saida("       else\r\n");
   $nm_saida->saida("       {\r\n");
   ...
   $nm_saida->saida("           document.Fdoc_word.action = \"grid_kontrol_billing_pb_export_ctrl.php\";\r\n");
   ...
   $nm_saida->saida("      {\r\n");
   $nm_saida->saida("          NM_ancor_ult_lig = ancor;\r\n");
   $nm_saida->saida("          par_modal = '?script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&nmgp_outra_jan=true&nmgp_url_saida=modal&SC_lig_apl_orig=grid_kontrol_billing_pb';\r\n");
   $nm_saida->saida("          if (opc != null && opc != '') \r\n");
   $nm_saida->saida("          {\r\n");
   ...
   $nm_saida->saida("          return;\r\n");
   $nm_saida->saida("      }\r\n");
   $nm_saida->saida("      if (pos == \"A\") {obj = document.getElementById('nmsc_iframe_liga_A_grid_kontrol_billing_pb');} \r\n");
   $nm_saida->saida("      if (pos == \"B\") {obj = document.getElementById('nmsc_iframe_liga_B_grid_kontrol_billing_pb');} \r\n");
   $nm_saida->saida("      if (pos == \"E\") {obj = document.getElementById('nmsc_iframe_liga_E_grid_kontrol_billing_pb');} \r\n");
   $nm_saida->saida("      if (pos == \"D\") {obj = document.getElementById('nmsc_iframe_liga_D_grid_kontrol_billing_pb');} \r\n");
   ...
   $nm_saida->saida("           document.F3.SC_module_export.value = z;\r\n");
   $nm_saida->saida("       }\r\n");
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['grid_kontrol_billing_pb_iframe_params'] = array(
   ...
   $Md5_pdf    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_kontrol_billing_pb@SC_par@" . md5($prep_parm_pdf);
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['Md5_pdf'][md5($prep_parm_pdf)] = $prep_parm_pdf;
   ...
   $nm_saida->saida("               document.Fprint.action = \"grid_kontrol_billing_pb_export_ctrl.php\";\r\n");
   $nm_saida->saida("           }\r\n");
   $nm_saida->saida("           else\r\n");
   $nm_saida->saida("           {\r\n");
   ...
   $nm_saida->saida("           document.Fexport.action = \"grid_kontrol_billing_pb_export_ctrl.php\";\r\n");
   ...
   $nm_saida->saida("   {\r\n");
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['form_psq_ret']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['campo_psq_ret']) )
   {
      $nm_saida->saida("      if (document.Fpesq.nm_ret_psq.value != \"\")\r\n");
      $nm_saida->saida("      {\r\n");
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['sc_modal'])
      {
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['iframe_ret_cap']))
         {
             $Iframe_cap = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['iframe_ret_cap'];
             unset($_SESSION['sc_session'][$script_case_init]['grid_kontrol_billing_pb']['iframe_ret_cap']);
             $nm_saida->saida("           var Obj_Form  = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['campo_psq_ret'] . ";\r\n");
             $nm_saida->saida("           var Obj_Form1 = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['form_psq_ret'] . "." . str_replace("_autocomp", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['campo_psq_ret']) . ";\r\n");
             $nm_saida->saida("           var Obj_Doc   = parent.document.getElementById('" . $Iframe_cap . "').contentWindow;\r\n");
             $nm_saida->saida("           if (parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['campo_psq_ret'] . "\"))\r\n");
             $nm_saida->saida("           {\r\n");
             $nm_saida->saida("               var Obj_Readonly = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['campo_psq_ret'] . "\");\r\n");
             $nm_saida->saida("           }\r\n");
         }
         else
         {
             $nm_saida->saida("          var Obj_Form  = parent.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['campo_psq_ret'] . ";\r\n");
             $nm_saida->saida("          var Obj_Form1 = parent.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['form_psq_ret'] . "." . str_replace("_autocomp", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['campo_psq_ret']) . ";\r\n");
             $nm_saida->saida("          var Obj_Doc   = parent;\r\n");
             $nm_saida->saida("          if (parent.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['campo_psq_ret'] . "\"))\r\n");
             $nm_saida->saida("          {\r\n");
             $nm_saida->saida("              var Obj_Readonly = parent.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['campo_psq_ret'] . "\");\r\n");
             $nm_saida->saida("          }\r\n");
         }
      }
      else
      {
          $nm_saida->saida("          var Obj_Form  = opener.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['campo_psq_ret'] . ";\r\n");
          $nm_saida->saida("          var Obj_Form1 = opener.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['form_psq_ret'] . "." . str_replace("_autocomp", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['campo_psq_ret']) . ";\r\n");
          $nm_saida->saida("          var Obj_Doc   = opener;\r\n");
          $nm_saida->saida("          if (opener.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['campo_psq_ret'] . "\"))\r\n");
          $nm_saida->saida("          {\r\n");
          $nm_saida->saida("              var Obj_Readonly = opener.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['campo_psq_ret'] . "\");\r\n");
          $nm_saida->saida("          }\r\n");
      }
          $nm_saida->saida("          else\r\n");
          $nm_saida->saida("          {\r\n");
      ...
      $nm_saida->saida("              }\r\n");
     if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['js_apos_busca']))
     {
      $nm_saida->saida("              if (Obj_Doc." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['js_apos_busca'] . ")\r\n");
      $nm_saida->saida("              {\r\n");
      $nm_saida->saida("                  Obj_Doc." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['js_apos_busca'] . "();\r\n");
      $nm_saida->saida("              }\r\n");
   ...
   $nm_saida->saida("      document.F5.action = \"grid_kontrol_billing_pb_fim.php\";\r\n");
   ...
   $nm_saida->saida("   }\r\n");
   if (($this->grid_emb_form || $this->grid_emb_form_full) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kontrol_billing_pb']['reg_start']))
   {
       $nm_saida->saida("      $(document).ready(function(){\r\n");
       $nm_saida->saida("         setTimeout(\"parent.scAjaxDetailStatus('grid_kontrol_billing_pb')\",50);\r\n");
       $nm_saida->saida("         setTimeout(\"parent.scAjaxDetailHeight('grid_kontrol_billing_pb', $(document).innerHeight())\",50);\r\n");
       $nm_saida->saida("      })\r\n");
   }
