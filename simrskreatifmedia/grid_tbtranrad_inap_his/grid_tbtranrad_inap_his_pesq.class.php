...
class grid_tbtranrad_inap_his_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_inap_his']['path_libs_php'] = $this->Ini->path_lib_php;
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_inap_his']['prim_vez']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_inap_his']['prim_vez'] = "S";
      }
   ...
   function init()
   {
    ...
    if (!$this->NM_ajax_flag && (!isset($bprocessa) || $bprocessa != "pesq"))
    {
      global $trandate_cond, $trandate, $trandate_dia, $trandate_mes, $trandate_ano, $trandate_input_2_dia, $trandate_input_2_mes, $trandate_input_2_ano,
             $docname_cond, $docname,
             $status_cond, $status;
      $_SESSION['scriptcase']['grid_tbtranrad_inap_his']['contr_erro'] = 'on';
 $trandate  = date("Y-m-d");
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_tbtranrad_inap_his_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_tbtranrad_inap_his_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_tbtranrad_inap_his_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_inap_his']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_inap_his']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_inap_his']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_inap_his']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_inap_his']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_inap_his']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_inap_his']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_inap_his']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_inap_his']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_inap_his']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_inap_his']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_inap_his']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_inap_his']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_inap_his']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_inap_his']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_inap_his']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_inap_his']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
   ...
   $NM_retorno = "./";
    if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_inap_his']['proc_res'])) 
    {
...
<?php
    if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_inap_his']['prim_vez'] == "N" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_inap_his']['proc_res']) 
    {
?>
if (parent.document.getElementById('nmsc_iframe_grid_tbtranrad_inap_his').contentWindow.nm_gp_submit_ajax)
{
   parent.document.getElementById('nmsc_iframe_grid_tbtranrad_inap_his').contentWindow.nm_gp_submit_ajax('inicio', 'save_grid');
}
else
{
   parent.document.getElementById('nmsc_iframe_grid_tbtranrad_inap_his').src = 'index.php?nmgp_opcao=pesq&script_case_init=<?php echo NM_encode_input($this->Ini->sc_page) ?>&script_case_session=<?php echo session_id() ?>';
}
<?php
    }
    else
...
<?php
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_inap_his']['prim_vez'] = "N";
?>
</SCRIPT>
</BODY>
</HTML>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_tbtranrad_inap_his/grid_tbtranrad_inap_his_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_tbtranrad_inap_his_ajax_search.js"></script>
 <script type="text/javascript" src="grid_tbtranrad_inap_his_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_tbtranrad_inap_his_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_tbtranrad_inap_his']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_tbtranrad_inap_his']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
function scJQCalendarAdd() {
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_docname#NMF#' + search_get_selmult('SC_docname') + '@NMF@';
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_inap_his']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<?php
   ...
   function monta_form()
   {
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_inap_his']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_inap_his']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_inap_his']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_inap_his']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $trandate_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_inap_his']['campos_busca']['trandate_dia']; 
          $trandate_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_inap_his']['campos_busca']['trandate_mes']; 
          $trandate_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_inap_his']['campos_busca']['trandate_ano']; 
          $trandate_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_inap_his']['campos_busca']['trandate_input_2_dia']; 
          $trandate_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_inap_his']['campos_busca']['trandate_input_2_mes']; 
          $trandate_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_inap_his']['campos_busca']['trandate_input_2_ano']; 
          $trandate_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_inap_his']['campos_busca']['trandate_cond']; 
          $docname = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_inap_his']['campos_busca']['docname']; 
          $docname_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_inap_his']['campos_busca']['docname_cond']; 
          $status = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_inap_his']['campos_busca']['status']; 
          $status_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_inap_his']['campos_busca']['status_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_inap_his']['campos_busca']['NM_operador']; 
      } 
      ...
      $str_display_docname = ('bw' == $docname_cond) ? $display_aberto : $display_fechado;
      ...
      if (is_array($docname) && !empty($docname))
      {
         $tmp_array = array();
         $docname_val_str = "";
         foreach ($docname as $tmp_val_cmp)
         {
            if ("" != $docname_val_str)
            {
               $docname_val_str .= ",";
...
<select class="scFilterObjectOdd" id="SC_trandate_ano" name="trandate_ano">
  <option value=""></option>
<?php
  $Combo_ano_ini = 1901;
  ...
  {
?>
  <option value="<?php echo $I_ano; ?>"<?php  if ($trandate_ano == $I_ano) { echo " selected" ;} ?>><?php echo $I_ano; ?></option>
<?php
  }
?>
</select>
...
<select class="scFilterObjectOdd" id="SC_trandate_input_2_ano" name="trandate_input_2_ano">
  <option value=""></option>
<?php
  $Combo_ano_ini = 1901;
  $Combo_ano_end = date('Y') + 10;
  ...
  {
?>
  <option value="<?php echo $I_ano; ?>"<?php  if ($trandate_input_2_ano == $I_ano) { echo " selected" ;} ?>><?php echo $I_ano; ?></option>
<?php
  }
?>
</select>
...
<?php
      ...
      { 
          $nm_comando = "SELECT name, gelar + ' ' + name + ', ' + spec  FROM tbdoctor  ORDER BY gelar, name, spec" ; 
      } 
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
      { 
          $nm_comando = "SELECT name, concat(gelar,' ', name,', ', spec)  FROM tbdoctor  ORDER BY gelar, name, spec" ; 
      } 
      ...
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_inap_his']['psq_check_ret']['docname'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_inap_his']['psq_check_ret']['docname'][] = trim($rs->fields[0]);
...
?>
   <span id="idAjaxSelect_docname">
      <SELECT class="scFilterObjectOdd" id="SC_docname" name="docname[]"  size="1" multiple>
<?php
      ...
      foreach ($nm_opcoes as $nm_opcao)
      {
         if (!empty($nm_opcao))
         {
            ...
            {
               $docname_sel = "";
               foreach ($docname as $Dados)
               {
                   if ($Dados === $nm_opc_cod)
                   {
                       $docname_sel = "selected";
                       break;
                   }
               }
            }
            ...
            {
               $docname_sel = ("S" == $nm_opc_sel) ? "selected" : "";
            }
            $nm_sc_valor = $nm_opc_val;
            $nm_opc_val = $nm_sc_valor;
?>
       <OPTION value="<?php echo NM_encode_input($nm_opc_cod . $delimitador . $nm_opc_val); ?>" <?php echo $docname_sel; ?>><?php echo $nm_opc_val; ?></OPTION>
<?php
         }
      }
?>
...
<?php
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_inap_his']['psq_check_ret']['status'] = array();
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_inap_his']['psq_check_ret']['status'][] = "0";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_inap_his']['psq_check_ret']['status'][] = "1";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_inap_his']['psq_check_ret']['status'][] = "2";
 ?>

<TABLE style="padding: 0px; spacing: 0px; border-width: 0px;"><TR>
  <TD class="scFilterFieldFontOdd"><INPUT class="scFilterObjectOdd" type="checkbox" id="SC_status" name="status[]" value="0##@@Daftar"  <?php if (in_array("0", $status))  { echo " checked" ;} ?>>Daftar</TD>
</TR>
<TR>
  <TD class="scFilterFieldFontOdd"><INPUT class="scFilterObjectOdd" type="checkbox" id="SC_status" name="status[]" value="1##@@Selesai"  <?php if (in_array("1", $status))  { echo " checked" ;} ?>>Selesai</TD>
</TR>
<TR>
  <TD class="scFilterFieldFontOdd"><INPUT class="scFilterObjectOdd" type="checkbox" id="SC_status" name="status[]" value="2##@@Lengkap"  <?php if (in_array("2", $status))  { echo " checked" ;} ?>>Lengkap</TD>
</TR><TR>
 <TD colspan=1>
...
?>
<?php
   if (is_file("grid_tbtranrad_inap_his_help.txt"))
   {
...
?>
<?php
   if ($nm_apl_dependente == 1 || (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_inap_his']['opc_psq'] && !$this->aba_iframe))
   {
...
<?php
       ...
       elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_inap_his']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_inap_his']['dashboard_info']['under_dashboard'])
       { }
       else 
       { 
?>
...
<?php
   ...
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_inap_his']['opc_psq'])
   {
...
<?php
    if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_inap_his']['prim_vez'] == "N") 
    {
?>
       <iframe id="nmsc_iframe_grid_tbtranrad_inap_his" frameborder="0" marginwidth="0px" marginheight="0px" topmargin="0px" leftmargin="0px" align="center" height="1500px" name="nm_iframe_grid_tbtranrad_inap_his" scrolling="auto" src="index.php?nmgp_opcao=pesq&script_case_init=<?php echo NM_encode_input($this->Ini->sc_page) ?>&script_case_session=<?php echo session_id() ?>" width="100%"></iframe>
<?php
    }
    else
    {
?>
       <iframe id="nmsc_iframe_grid_tbtranrad_inap_his" frameborder="0" marginwidth="0px" marginheight="0px" topmargin="0px" leftmargin="0px" align="center" height="1500px" name="nm_iframe_grid_tbtranrad_inap_his" scrolling="auto" src="" width="100%"></iframe>
<?php
    }
?>
<iframe id="nmsc_iframe_grid_tbtranrad_inap_his_pesq"  name="nm_iframe_grid_tbtranrad_inap_his_pesq" style= "display: none;" frameborder="0" marginwidth="0px" marginheight="0px" topmargin="0px" leftmargin="0px" src=""></iframe>
</td></tr></table></td></tr>
</TABLE>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_inap_his']['orig_pesq'] == "grid")
   {
...
?>
 ...
 {
    document.F1.target = "nm_iframe_grid_tbtranrad_inap_his_pesq";
    document.F1.submit();
 }
 function nm_move()
 {
     document.getElementById('nmsc_iframe_grid_tbtranrad_inap_his').contentWindow.nm_move('igual');
 }
 function limpa_form()
 {
   document.F1.reset();
   ...
   {
      if (document.F1.elements[i].name == 'docname[]')
      {
 ...
 {
    if (Field == 'all' || Field == 'docname') {
       Sc_carga_select2_docname();
    }
 }
 function Sc_carga_select2_docname()
 {
  $("#SC_docname").select2(
    {
      language: {
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "simrskreatifmedia/grid_tbtranrad_inap_his";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_inap_his']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_inap_his']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_inap_his']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro($nmgp_save_origem)
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "grid_tbtranrad_inap_his/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function trata_campos()
   {
      ...
      if (is_array($docname)) {
          foreach ($docname as $I => $Val) {
              ...
              if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && trim($L_lookup) != '' && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_inap_his']['psq_check_ret']['docname'])) {
                  if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "Nama Dokter : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
                  break;
              }
          }
      }
      if (is_array($status)) {
          foreach ($status as $I => $Val) {
              ...
              if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && trim($L_lookup) != '' && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_inap_his']['psq_check_ret']['status'])) {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_inap_his']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_inap_his']['campos_busca']['trandate_dia'] = $trandate_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_inap_his']['campos_busca']['trandate_mes'] = $trandate_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_inap_his']['campos_busca']['trandate_ano'] = $trandate_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_inap_his']['campos_busca']['trandate_input_2_dia'] = $trandate_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_inap_his']['campos_busca']['trandate_input_2_mes'] = $trandate_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_inap_his']['campos_busca']['trandate_input_2_ano'] = $trandate_input_2_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_inap_his']['campos_busca']['trandate_cond'] = $trandate_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_inap_his']['campos_busca']['docname'] = $docname; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_inap_his']['campos_busca']['docname_cond'] = $docname_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_inap_his']['campos_busca']['status'] = $status; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_inap_his']['campos_busca']['status_cond'] = $status_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_inap_his']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_inap_his']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      }
      $this->cmp_formatado['docname'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_inap_his']['campos_busca']['docname'];
      $this->cmp_formatado['docname_input_2'] = $docname_input_2;
      $this->cmp_formatado['status'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_inap_his']['campos_busca']['status'];
      ...
      if ($trandate_cond != "bi_TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_inap_his']['campos_busca']['trandate'] = $val[0];
          ...
          if ($trandate_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_inap_his']['campos_busca']['trandate_input_2'] = $val[1];
      ...
      $this->Date_part = false;
      $nm_aspas = "'";
      if ($docname_cond == "nu" || $docname_cond == "nn" || $docname_cond == "ep" || $docname_cond == "ne")
      {
          $docname = array();
      }
      if (is_array($docname) && count($docname) != 0)
      {
         foreach ($docname as $i => $dados)
         {
      ...
      {
         $this->and_or();
         if ($docname_cond == "df" || $docname_cond == "np")
         {
             $this->comando        .= " docname not in (";
             $this->comando_sum    .= " tbtranrad.docname not in (";
             $this->comando_filtro .= " docname not in (";
         }
         else
         {
             $this->comando        .= " docname in (";
             $this->comando_sum    .= " tbtranrad.docname in (";
             $this->comando_filtro .= " docname in (";
         }
         $x                     = count($docname);
         $xx                    = 0;
         $nm_cond               = "";
         ...
         $Lang_descr_final = isset($Lang_descr[$docname_cond]) ? $Lang_descr[$docname_cond] : $this->Ini->Nm_lang['lang_srch_like'];
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_inap_his']['cond_pesq'] .= $nmgp_tab_label['docname'] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
      }
      elseif (isset($docname) || $docname_cond == "nu" || $docname_cond == "nn" || $docname_cond == "ep" || $docname_cond == "ne")
      {
      ...
      if (is_array($status) && count($status) != 0)
      {
         ...
         if ($status_cond == "df" || $status_cond == "np")
         {
             ...
             $this->comando_sum    .= " tbtranrad.status not in (";
             $this->comando_filtro .= " status not in (";
         }
         else
         {
             $this->comando        .= " status in (";
             $this->comando_sum    .= " tbtranrad.status in (";
         ...
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_inap_his']['cond_pesq'] .= $nmgp_tab_label['status'] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
      }
   ...
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_inap_his']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_inap_his']['cond_dyn_search'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_inap_his']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_inap_his']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_inap_his']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_inap_his']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_inap_his']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_inap_his']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_inap_his']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_inap_his']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_inap_his']['cond_pesq'] .= $this->NM_operador;
   ...
   function css_obj_select_ajax($Obj)
   {
      switch ($Obj)
      {
         case "docname" : return ('class="scFilterObjectOdd"'); break;
         default       : return ("");
      }
   }
