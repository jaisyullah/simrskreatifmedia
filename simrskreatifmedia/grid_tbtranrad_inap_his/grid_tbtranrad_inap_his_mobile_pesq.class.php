...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_docname"  <?php echo $str_hide_docname?>>
<?php
...
?>
   <span id="idAjaxSelect_docname">
      <SELECT class="scFilterObjectEven" id="SC_docname" name="docname[]"  size="1" multiple>
<?php
...
<?php
   ...
   function css_obj_select_ajax($Obj)
   {
      switch ($Obj)
      {
         case "docname" : return ('class="scFilterObjectEven"'); break;
         default       : return ("");
      }
   }
