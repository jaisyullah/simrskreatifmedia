<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tbtranrad_inap_his']['sc_process_barr'] = true;
require_once('../grid_tbtranrad_inap_his/index.php');
unset($_SESSION['scriptcase']['grid_tbtranrad_inap_his']['sc_process_barr']);
$ExportCtrl = new grid_tbtranrad_inap_his_export_control;
$ExportCtrl->Export_barr();

class grid_tbtranrad_inap_his_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_title'] ?> Transaksi Radiologi :: Excel</TITLE>
