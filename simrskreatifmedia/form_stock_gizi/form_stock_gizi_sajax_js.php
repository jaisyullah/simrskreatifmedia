  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_stock_gizi" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_stock_gizi_form();
	}

  // ---------- Validate tgl_masuk_
  function do_ajax_form_stock_gizi_validate_tgl_masuk_(iNumLinha)
  {
    var nomeCampo_tgl_masuk_ = "tgl_masuk_" + iNumLinha;
    var var_tgl_masuk_ = scAjaxGetFieldText(nomeCampo_tgl_masuk_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_stock_gizi_validate_tgl_masuk_(var_tgl_masuk_, iNumLinha, var_script_case_init, do_ajax_form_stock_gizi_validate_tgl_masuk__cb);
  } // do_ajax_form_stock_gizi_validate_tgl_masuk_

  function do_ajax_form_stock_gizi_validate_tgl_masuk__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "tgl_masuk_" + iLineNumber;
    }
    else
    {
      sFieldValid = "tgl_masuk_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "tgl_masuk_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "tgl_masuk_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_stock_gizi_validate_tgl_masuk__cb

  // ---------- Validate current_stock_
  function do_ajax_form_stock_gizi_validate_current_stock_(iNumLinha)
  {
    var nomeCampo_current_stock_ = "current_stock_" + iNumLinha;
    var var_current_stock_ = scAjaxGetFieldText(nomeCampo_current_stock_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_stock_gizi_validate_current_stock_(var_current_stock_, iNumLinha, var_script_case_init, do_ajax_form_stock_gizi_validate_current_stock__cb);
  } // do_ajax_form_stock_gizi_validate_current_stock_

  function do_ajax_form_stock_gizi_validate_current_stock__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "current_stock_" + iLineNumber;
    }
    else
    {
      sFieldValid = "current_stock_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "current_stock_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "current_stock_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_stock_gizi_validate_current_stock__cb

  // ---------- Validate id_
  function do_ajax_form_stock_gizi_validate_id_(iNumLinha)
  {
    var nomeCampo_id_ = "id_" + iNumLinha;
    var var_id_ = scAjaxGetFieldHidden(nomeCampo_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_stock_gizi_validate_id_(var_id_, iNumLinha, var_script_case_init, do_ajax_form_stock_gizi_validate_id__cb);
  } // do_ajax_form_stock_gizi_validate_id_

  function do_ajax_form_stock_gizi_validate_id__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_stock_gizi_validate_id__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_stock_gizi_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_stock_gizi_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_stock_gizi_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_stock_gizi_add_new_line_cb);
  } // do_ajax_form_stock_gizi_add_new_line

  function do_ajax_form_stock_gizi_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_stock_gizi_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_stock_gizi_backup_line(iNumLinha)
  {
    var var_id_ = scAjaxGetFieldHidden("id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_stock_gizi_backup_line(var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_stock_gizi_backup_line_cb);
  } // do_ajax_form_stock_gizi_backup_line

  function do_ajax_form_stock_gizi_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_stock_gizi_backup_line_cb

  function do_ajax_form_stock_gizi_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_stock_gizi_cancel_insert

  function do_ajax_form_stock_gizi_cancel_update(iSeqVert)
  {
    do_ajax_form_stock_gizi_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_stock_gizi_cancel_update

  function do_ajax_form_stock_gizi_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_stock_gizi_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_stock_gizi_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_stock_gizi_table_refresh(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_stock_gizi_table_refresh_cb);
  } //  do_ajax_form_stock_gizi_table_refresh

  function do_ajax_form_stock_gizi_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_stock_gizi_table_refresh_cb_after_alert);
  } // do_ajax_form_stock_gizi_table_refresh_cb
  function do_ajax_form_stock_gizi_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_stock_gizi_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_stock_gizi_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_stock_gizi_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    sc_num_ult_line = iNumLinha;
    sc_num_ult_tr   = indexTR;
    scAjaxHideMessage();
    var var_tgl_masuk_ = scAjaxGetFieldText("tgl_masuk_" + iNumLinha);
    var var_current_stock_ = scAjaxGetFieldText("current_stock_" + iNumLinha);
    var var_id_ = scAjaxGetFieldHidden("id_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_stock_gizi_submit_form(var_tgl_masuk_, var_current_stock_, var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_stock_gizi_submit_form_cb);
  } // do_ajax_form_stock_gizi_submit_form

  function do_ajax_form_stock_gizi_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("tgl_masuk_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("current_stock_" + sc_num_ult_line);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_stock_gizi_submit_form_cb_after_alert);
  } // do_ajax_form_stock_gizi_submit_form_cb
  function do_ajax_form_stock_gizi_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_stock_gizi_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_stock_gizi_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_stock_gizi_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("tgl_masuk_" + iNavForm);
      scAjaxHideErrorDisplay("current_stock_" + iNavForm);
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_stock_gizi_navigate_form(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_stock_gizi_navigate_form_cb);
  } // do_ajax_form_stock_gizi_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_stock_gizi']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_stock_gizi_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_stock_gizi_navigate_form_cb_after_alert);
  } // do_ajax_form_stock_gizi_navigate_form_cb
  function do_ajax_form_stock_gizi_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_stock_gizi_navigate_form_cb_after_alert
  function sc_hide_form_stock_gizi_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "tgl_masuk_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "current_stock_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "id_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["tgl_masuk_" + iNumLinha] = {"label": "Tgl Masuk<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["current_stock_" + iNumLinha] = {"label": "Current Stock<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_field_mult["tgl_masuk_"][iNumLinha] = "tgl_masuk_" + iNumLinha;
    ajax_field_mult["current_stock_"][iNumLinha] = "current_stock_" + iNumLinha;
    ajax_field_mult["id_"][iNumLinha] = "id_" + iNumLinha;
    ajax_field_id["tgl_masuk_" + iNumLinha] = new Array("hidden_field_label_tgl_masuk_", "hidden_field_data_tgl_masuk_" + iNumLinha);
    ajax_field_id["current_stock_" + iNumLinha] = new Array("hidden_field_label_current_stock_", "hidden_field_data_current_stock_" + iNumLinha);
    ajax_error_count["tgl_masuk_" + iNumLinha] = "off";
    ajax_error_count["current_stock_" + iNumLinha] = "off";
    ajax_error_count["id_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["tgl_masuk_" + iNumLinha] = "off";
    ajax_read_only["current_stock_" + iNumLinha] = "off";
...
{
?>
    ajax_read_only["tgl_masuk_" + iNumLinha] = "on";
    ajax_read_only["current_stock_" + iNumLinha] = "on";
    ajax_read_only["id_" + iNumLinha] = "on";
<?php
}
?>
  ...
  {
    ajax_error_list["tgl_masuk_" + iNumLinha] = null;
    ajax_error_list["current_stock_" + iNumLinha] = null;
  ...
  var ajax_field_mult = {
    "tgl_masuk_": new Array(),
    "current_stock_": new Array(),
    "id_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["tgl_masuk_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["tgl_masuk_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["tgl_masuk_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["tgl_masuk_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["tgl_masuk_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["current_stock_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["current_stock_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["current_stock_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["current_stock_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["current_stock_" + iNumLinha]["onfocus"] = new Array();
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['tgl_masuk_'])) ? $this->nmgp_cmp_readonly['tgl_masuk_'] : 'off';
?>
    scAjaxFieldRead("tgl_masuk_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['current_stock_'])) ? $this->nmgp_cmp_readonly['current_stock_'] : 'off';
?>
    scAjaxFieldRead("current_stock_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
?>
  ...
  {
    scAjaxFieldRead("tgl_masuk_" + iSeq, "on");
    scAjaxFieldRead("current_stock_" + iSeq, "on");
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["tgl_masuk_" + iRow] || "on" == ajax_error_count["current_stock_" + iRow] || "on" == ajax_error_count["id_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_tgl_masuk_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_current_stock_" + iRow).addClass("scFormErrorLine");
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["tgl_masuk_" + iRow] && "off" == ajax_error_count["current_stock_" + iRow] && "off" == ajax_error_count["id_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["tgl_masuk_" + iRow] = "off";
        ajax_error_count["current_stock_" + iRow] = "off";
      ...
      $("#hidden_field_data_tgl_masuk_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_current_stock_" + iRow).removeClass("scFormErrorLine");
