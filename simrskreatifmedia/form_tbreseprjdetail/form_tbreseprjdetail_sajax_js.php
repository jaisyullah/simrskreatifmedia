  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbreseprjdetail" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbreseprjdetail_form();
	}

  // ---------- Validate item_
  function do_ajax_form_tbreseprjdetail_validate_item_(iNumLinha)
  {
  } // do_ajax_form_tbreseprjdetail_validate_item_

  function do_ajax_form_tbreseprjdetail_validate_item__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbreseprjdetail_validate_item__cb

  // ---------- Validate satuan_
  function do_ajax_form_tbreseprjdetail_validate_satuan_(iNumLinha)
  {
    var nomeCampo_satuan_ = "satuan_" + iNumLinha;
    var var_satuan_ = scAjaxGetFieldSelect(nomeCampo_satuan_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbreseprjdetail_validate_satuan_(var_satuan_, iNumLinha, var_script_case_init, do_ajax_form_tbreseprjdetail_validate_satuan__cb);
  } // do_ajax_form_tbreseprjdetail_validate_satuan_

  function do_ajax_form_tbreseprjdetail_validate_satuan__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbreseprjdetail_validate_satuan__cb

  // ---------- Validate jumlah_
  function do_ajax_form_tbreseprjdetail_validate_jumlah_(iNumLinha)
  {
    var nomeCampo_jumlah_ = "jumlah_" + iNumLinha;
    var var_jumlah_ = scAjaxGetFieldText(nomeCampo_jumlah_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbreseprjdetail_validate_jumlah_(var_jumlah_, iNumLinha, var_script_case_init, do_ajax_form_tbreseprjdetail_validate_jumlah__cb);
  } // do_ajax_form_tbreseprjdetail_validate_jumlah_

  function do_ajax_form_tbreseprjdetail_validate_jumlah__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbreseprjdetail_validate_jumlah__cb

  // ---------- Validate aturanpakai1_
  function do_ajax_form_tbreseprjdetail_validate_aturanpakai1_(iNumLinha)
  {
    var nomeCampo_aturanpakai1_ = "aturanpakai1_" + iNumLinha;
    var var_aturanpakai1_ = scAjaxGetFieldText(nomeCampo_aturanpakai1_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbreseprjdetail_validate_aturanpakai1_(var_aturanpakai1_, iNumLinha, var_script_case_init, do_ajax_form_tbreseprjdetail_validate_aturanpakai1__cb);
  } // do_ajax_form_tbreseprjdetail_validate_aturanpakai1_

  function do_ajax_form_tbreseprjdetail_validate_aturanpakai1__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "aturanpakai1_" + iLineNumber;
    }
    else
    {
      sFieldValid = "aturanpakai1_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "aturanpakai1_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "aturanpakai1_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbreseprjdetail_validate_aturanpakai1__cb

  // ---------- Validate aturanpakai2_
  function do_ajax_form_tbreseprjdetail_validate_aturanpakai2_(iNumLinha)
  {
    var nomeCampo_aturanpakai2_ = "aturanpakai2_" + iNumLinha;
    var var_aturanpakai2_ = scAjaxGetFieldText(nomeCampo_aturanpakai2_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbreseprjdetail_validate_aturanpakai2_(var_aturanpakai2_, iNumLinha, var_script_case_init, do_ajax_form_tbreseprjdetail_validate_aturanpakai2__cb);
  } // do_ajax_form_tbreseprjdetail_validate_aturanpakai2_

  function do_ajax_form_tbreseprjdetail_validate_aturanpakai2__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "aturanpakai2_" + iLineNumber;
    }
    else
    {
      sFieldValid = "aturanpakai2_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "aturanpakai2_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "aturanpakai2_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbreseprjdetail_validate_aturanpakai2__cb

  // ---------- Validate stok_
  function do_ajax_form_tbreseprjdetail_validate_stok_(iNumLinha)
  {
    var nomeCampo_stok_ = "stok_" + iNumLinha;
    var var_stok_ = scAjaxGetFieldSelect(nomeCampo_stok_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbreseprjdetail_validate_stok_(var_stok_, iNumLinha, var_script_case_init, do_ajax_form_tbreseprjdetail_validate_stok__cb);
  } // do_ajax_form_tbreseprjdetail_validate_stok_

  function do_ajax_form_tbreseprjdetail_validate_stok__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbreseprjdetail_validate_stok__cb

  // ---------- Validate biaya_
  function do_ajax_form_tbreseprjdetail_validate_biaya_(iNumLinha)
  {
    var nomeCampo_biaya_ = "biaya_" + iNumLinha;
    var var_biaya_ = scAjaxGetFieldText(nomeCampo_biaya_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbreseprjdetail_validate_biaya_(var_biaya_, iNumLinha, var_script_case_init, do_ajax_form_tbreseprjdetail_validate_biaya__cb);
  } // do_ajax_form_tbreseprjdetail_validate_biaya_

  function do_ajax_form_tbreseprjdetail_validate_biaya__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbreseprjdetail_validate_biaya__cb

  // ---------- Validate hargajual_
  function do_ajax_form_tbreseprjdetail_validate_hargajual_(iNumLinha)
  {
    var nomeCampo_hargajual_ = "hargajual_" + iNumLinha;
    var var_hargajual_ = scAjaxGetFieldSelect(nomeCampo_hargajual_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbreseprjdetail_validate_hargajual_(var_hargajual_, iNumLinha, var_script_case_init, do_ajax_form_tbreseprjdetail_validate_hargajual__cb);
  } // do_ajax_form_tbreseprjdetail_validate_hargajual_

  function do_ajax_form_tbreseprjdetail_validate_hargajual__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "hargajual_" + iLineNumber;
    }
    else
    {
      sFieldValid = "hargajual_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "hargajual_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "hargajual_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbreseprjdetail_validate_hargajual__cb

  // ---------- Validate id_
  function do_ajax_form_tbreseprjdetail_validate_id_(iNumLinha)
  {
    var nomeCampo_id_ = "id_" + iNumLinha;
    var var_id_ = scAjaxGetFieldHidden(nomeCampo_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbreseprjdetail_validate_id_(var_id_, iNumLinha, var_script_case_init, do_ajax_form_tbreseprjdetail_validate_id__cb);
  } // do_ajax_form_tbreseprjdetail_validate_id_

  function do_ajax_form_tbreseprjdetail_validate_id__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbreseprjdetail_validate_id__cb

  // ---------- Refresh item_
  function do_ajax_form_tbreseprjdetail_refresh_item_(iSeqForm)
  {
    var var_item_ = scAjaxGetFieldText("item_" + iSeqForm);
    var var_nmgp_refresh_row = iSeqForm;
    var var_nmgp_refresh_fields = "satuan__#fld#_stok__#fld#_hargajual_";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tbreseprjdetail_refresh_item_(var_item_, var_nmgp_refresh_row, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_tbreseprjdetail_refresh_item__cb);
  } // do_ajax_form_tbreseprjdetail_refresh_item_

  function do_ajax_form_tbreseprjdetail_refresh_item__cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbreseprjdetail_refresh_item__cb

  // ---------- Event onchange item_
  function do_ajax_form_tbreseprjdetail_event_item__onchange(iSeqForm)
  {
    var var_item_ = scAjaxGetFieldText("item_" + iSeqForm);
    var var_biaya_ = scAjaxGetFieldText("biaya_" + iSeqForm);
    var var_hargajual_ = scAjaxGetFieldSelect("hargajual_" + iSeqForm);
    var var_script_case_init = document.F2.script_case_init.value;
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_tbreseprjdetail_event_item__onchange(var_item_, var_biaya_, var_hargajual_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_tbreseprjdetail_event_item__onchange_cb);
  } // do_ajax_form_tbreseprjdetail_event_item__onchange

  function do_ajax_form_tbreseprjdetail_event_item__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_tbreseprjdetail_event_item__onchange_cb_after_alert);
  } // do_ajax_form_tbreseprjdetail_event_item__onchange_cb
  function do_ajax_form_tbreseprjdetail_event_item__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    do_ajax_form_tbreseprjdetail_refresh_item_(iLineNumber);
    scAjaxRedir();
  } // do_ajax_form_tbreseprjdetail_event_item__onchange_cb_after_alert

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_tbreseprjdetail_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_tbreseprjdetail_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tbreseprjdetail_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_tbreseprjdetail_add_new_line_cb);
  } // do_ajax_form_tbreseprjdetail_add_new_line

  function do_ajax_form_tbreseprjdetail_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_tbreseprjdetail_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_tbreseprjdetail_backup_line(iNumLinha)
  {
    var var_id_ = scAjaxGetFieldHidden("id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbreseprjdetail_backup_line(var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_tbreseprjdetail_backup_line_cb);
  } // do_ajax_form_tbreseprjdetail_backup_line

  function do_ajax_form_tbreseprjdetail_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_tbreseprjdetail_backup_line_cb

  function do_ajax_form_tbreseprjdetail_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_tbreseprjdetail_cancel_insert

  function do_ajax_form_tbreseprjdetail_cancel_update(iSeqVert)
  {
    do_ajax_form_tbreseprjdetail_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_tbreseprjdetail_cancel_update

  function do_ajax_form_tbreseprjdetail_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_tbreseprjdetail_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_tbreseprjdetail_table_refresh()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tbreseprjdetail_table_refresh(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbreseprjdetail_table_refresh_cb);
  } //  do_ajax_form_tbreseprjdetail_table_refresh

  function do_ajax_form_tbreseprjdetail_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_tbreseprjdetail_table_refresh_cb_after_alert);
  } // do_ajax_form_tbreseprjdetail_table_refresh_cb
  function do_ajax_form_tbreseprjdetail_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxSetNavStatus("t");
    sc_insert_open = false;
  } // do_ajax_form_tbreseprjdetail_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_tbreseprjdetail_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_tbreseprjdetail_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    var var_aturanpakai1_ = scAjaxGetFieldText("aturanpakai1_" + iNumLinha);
    var var_aturanpakai2_ = scAjaxGetFieldText("aturanpakai2_" + iNumLinha);
    var var_stok_ = scAjaxGetFieldSelect("stok_" + iNumLinha);
    var var_biaya_ = scAjaxGetFieldText("biaya_" + iNumLinha);
    var var_hargajual_ = scAjaxGetFieldSelect("hargajual_" + iNumLinha);
    var var_id_ = scAjaxGetFieldHidden("id_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_tbreseprjdetail_submit_form(var_item_, var_satuan_, var_jumlah_, var_aturanpakai1_, var_aturanpakai2_, var_stok_, var_biaya_, var_hargajual_, var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbreseprjdetail_submit_form_cb);
  } // do_ajax_form_tbreseprjdetail_submit_form

  function do_ajax_form_tbreseprjdetail_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("aturanpakai1_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("aturanpakai2_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("stok_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("biaya_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("hargajual_" + sc_num_ult_line);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_tbreseprjdetail_submit_form_cb_after_alert);
  } // do_ajax_form_tbreseprjdetail_submit_form_cb
  function do_ajax_form_tbreseprjdetail_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbreseprjdetail_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tbreseprjdetail_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_tbreseprjdetail_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("aturanpakai1_" + iNavForm);
      scAjaxHideErrorDisplay("aturanpakai2_" + iNavForm);
      scAjaxHideErrorDisplay("stok_" + iNavForm);
      scAjaxHideErrorDisplay("biaya_" + iNavForm);
      scAjaxHideErrorDisplay("hargajual_" + iNavForm);
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tbreseprjdetail_navigate_form(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbreseprjdetail_navigate_form_cb);
  } // do_ajax_form_tbreseprjdetail_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprjdetail']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbreseprjdetail_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbreseprjdetail_navigate_form_cb_after_alert);
  } // do_ajax_form_tbreseprjdetail_navigate_form_cb
  function do_ajax_form_tbreseprjdetail_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_tbreseprjdetail_navigate_form_cb_after_alert
  function sc_hide_form_tbreseprjdetail_form()
  {
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "aturanpakai1_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "aturanpakai2_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "stok_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "biaya_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "hargajual_" + iNumLinha;
    iTotCampos++;
    ...
    ajax_error_list["aturanpakai1_" + iNumLinha] = {"label": "Signa (kali)<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["aturanpakai2_" + iNumLinha] = {"label": "Signa (hari)<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_error_list["hargajual_" + iNumLinha] = {"label": "hargaJual<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_field_mult["aturanpakai1_"][iNumLinha] = "aturanpakai1_" + iNumLinha;
    ajax_field_mult["aturanpakai2_"][iNumLinha] = "aturanpakai2_" + iNumLinha;
    ajax_field_mult["stok_"][iNumLinha] = "stok_" + iNumLinha;
    ajax_field_mult["biaya_"][iNumLinha] = "biaya_" + iNumLinha;
    ajax_field_mult["hargajual_"][iNumLinha] = "hargajual_" + iNumLinha;
    ...
    ajax_field_id["aturanpakai1_" + iNumLinha] = new Array("hidden_field_label_aturanpakai1_", "hidden_field_data_aturanpakai1_" + iNumLinha);
    ajax_field_id["aturanpakai2_" + iNumLinha] = new Array("hidden_field_label_aturanpakai2_", "hidden_field_data_aturanpakai2_" + iNumLinha);
    ...
    ajax_field_id["hargajual_" + iNumLinha] = new Array("hidden_field_label_hargajual_", "hidden_field_data_hargajual_" + iNumLinha);
    ajax_error_count["item_" + iNumLinha] = "off";
    ajax_error_count["satuan_" + iNumLinha] = "off";
    ajax_error_count["jumlah_" + iNumLinha] = "off";
    ajax_error_count["aturanpakai1_" + iNumLinha] = "off";
    ajax_error_count["aturanpakai2_" + iNumLinha] = "off";
    ajax_error_count["stok_" + iNumLinha] = "off";
    ajax_error_count["biaya_" + iNumLinha] = "off";
    ajax_error_count["hargajual_" + iNumLinha] = "off";
...
?>
    ...
    ajax_read_only["aturanpakai1_" + iNumLinha] = "off";
    ajax_read_only["aturanpakai2_" + iNumLinha] = "off";
    ajax_read_only["stok_" + iNumLinha] = "off";
    ajax_read_only["biaya_" + iNumLinha] = "off";
    ajax_read_only["hargajual_" + iNumLinha] = "off";
...
?>
    ...
    ajax_read_only["aturanpakai1_" + iNumLinha] = "on";
    ajax_read_only["aturanpakai2_" + iNumLinha] = "on";
    ajax_read_only["stok_" + iNumLinha] = "on";
    ajax_read_only["biaya_" + iNumLinha] = "on";
    ajax_read_only["hargajual_" + iNumLinha] = "on";
    ajax_read_only["id_" + iNumLinha] = "on";
<?php
}
?>
  ...
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["aturanpakai1_" + iNumLinha] = null;
    ajax_error_list["aturanpakai2_" + iNumLinha] = null;
    ajax_error_list["stok_" + iNumLinha] = null;
    ajax_error_list["biaya_" + iNumLinha] = null;
    ajax_error_list["hargajual_" + iNumLinha] = null;
  ...
  var ajax_field_mult = {
    ...
    "satuan_": new Array(),
    "jumlah_": new Array(),
    "aturanpakai1_": new Array(),
    "aturanpakai2_": new Array(),
    "stok_": new Array(),
    "biaya_": new Array(),
    "hargajual_": new Array(),
    "id_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["aturanpakai1_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["aturanpakai1_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["aturanpakai1_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["aturanpakai1_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["aturanpakai1_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["aturanpakai2_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["aturanpakai2_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["aturanpakai2_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["aturanpakai2_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["aturanpakai2_" + iNumLinha]["onfocus"] = new Array();
      ...
      ajax_error_list["hargajual_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["hargajual_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["hargajual_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["hargajual_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["hargajual_" + iNumLinha]["onfocus"] = new Array();
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['aturanpakai1_'])) ? $this->nmgp_cmp_readonly['aturanpakai1_'] : 'off';
?>
    scAjaxFieldRead("aturanpakai1_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['aturanpakai2_'])) ? $this->nmgp_cmp_readonly['aturanpakai2_'] : 'off';
?>
    scAjaxFieldRead("aturanpakai2_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['hargajual_'])) ? $this->nmgp_cmp_readonly['hargajual_'] : 'off';
?>
    scAjaxFieldRead("hargajual_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
?>
  ...
  function mdCloseObjects(iSeq)
  {
    ...
    scAjaxFieldRead("aturanpakai1_" + iSeq, "on");
    scAjaxFieldRead("aturanpakai2_" + iSeq, "on");
    scAjaxFieldRead("stok_" + iSeq, "on");
    scAjaxFieldRead("biaya_" + iSeq, "on");
    scAjaxFieldRead("hargajual_" + iSeq, "on");
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["item_" + iRow] || "on" == ajax_error_count["satuan_" + iRow] || "on" == ajax_error_count["jumlah_" + iRow] || "on" == ajax_error_count["aturanpakai1_" + iRow] || "on" == ajax_error_count["aturanpakai2_" + iRow] || "on" == ajax_error_count["stok_" + iRow] || "on" == ajax_error_count["biaya_" + iRow] || "on" == ajax_error_count["hargajual_" + iRow] || "on" == ajax_error_count["id_" + iRow]))
    {
      ...
      $("#hidden_field_data_aturanpakai1_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_aturanpakai2_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_stok_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_biaya_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_hargajual_" + iRow).addClass("scFormErrorLine");
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["item_" + iRow] && "off" == ajax_error_count["satuan_" + iRow] && "off" == ajax_error_count["jumlah_" + iRow] && "off" == ajax_error_count["aturanpakai1_" + iRow] && "off" == ajax_error_count["aturanpakai2_" + iRow] && "off" == ajax_error_count["stok_" + iRow] && "off" == ajax_error_count["biaya_" + iRow] && "off" == ajax_error_count["hargajual_" + iRow] && "off" == ajax_error_count["id_" + iRow]))
    {
      if (bErrorRow)
      {
        ...
        ajax_error_count["aturanpakai1_" + iRow] = "off";
        ajax_error_count["aturanpakai2_" + iRow] = "off";
        ajax_error_count["stok_" + iRow] = "off";
        ajax_error_count["biaya_" + iRow] = "off";
        ajax_error_count["hargajual_" + iRow] = "off";
      ...
      $("#hidden_field_data_aturanpakai1_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_aturanpakai2_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_stok_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_biaya_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_hargajual_" + iRow).removeClass("scFormErrorLine");
