  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_hrm_ikatan_dinas" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_hrm_ikatan_dinas_form();
	}

  // ---------- Validate tgl_mulai_
  function do_ajax_form_hrm_ikatan_dinas_validate_tgl_mulai_(iNumLinha)
  {
    var nomeCampo_tgl_mulai_ = "tgl_mulai_" + iNumLinha;
    var var_tgl_mulai_ = scAjaxGetFieldText(nomeCampo_tgl_mulai_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_ikatan_dinas_validate_tgl_mulai_(var_tgl_mulai_, iNumLinha, var_script_case_init, do_ajax_form_hrm_ikatan_dinas_validate_tgl_mulai__cb);
  } // do_ajax_form_hrm_ikatan_dinas_validate_tgl_mulai_

  function do_ajax_form_hrm_ikatan_dinas_validate_tgl_mulai__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "tgl_mulai_" + iLineNumber;
    }
    else
    {
      sFieldValid = "tgl_mulai_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "tgl_mulai_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "tgl_mulai_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_ikatan_dinas_validate_tgl_mulai__cb

  // ---------- Validate tgl_selesai_
  function do_ajax_form_hrm_ikatan_dinas_validate_tgl_selesai_(iNumLinha)
  {
    var nomeCampo_tgl_selesai_ = "tgl_selesai_" + iNumLinha;
    var var_tgl_selesai_ = scAjaxGetFieldText(nomeCampo_tgl_selesai_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_ikatan_dinas_validate_tgl_selesai_(var_tgl_selesai_, iNumLinha, var_script_case_init, do_ajax_form_hrm_ikatan_dinas_validate_tgl_selesai__cb);
  } // do_ajax_form_hrm_ikatan_dinas_validate_tgl_selesai_

  function do_ajax_form_hrm_ikatan_dinas_validate_tgl_selesai__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "tgl_selesai_" + iLineNumber;
    }
    else
    {
      sFieldValid = "tgl_selesai_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "tgl_selesai_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "tgl_selesai_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_ikatan_dinas_validate_tgl_selesai__cb

  // ---------- Validate lampiran_
  function do_ajax_form_hrm_ikatan_dinas_validate_lampiran_(iNumLinha)
  {
    var nomeCampo_lampiran_ = "lampiran_" + iNumLinha;
    var var_lampiran_ = scAjaxGetFieldText(nomeCampo_lampiran_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_ikatan_dinas_validate_lampiran_(var_lampiran_, iNumLinha, var_script_case_init, do_ajax_form_hrm_ikatan_dinas_validate_lampiran__cb);
  } // do_ajax_form_hrm_ikatan_dinas_validate_lampiran_

  function do_ajax_form_hrm_ikatan_dinas_validate_lampiran__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_ikatan_dinas_validate_lampiran__cb

  // ---------- Validate id_
  function do_ajax_form_hrm_ikatan_dinas_validate_id_(iNumLinha)
  {
    var nomeCampo_id_ = "id_" + iNumLinha;
    var var_id_ = scAjaxGetFieldHidden(nomeCampo_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_ikatan_dinas_validate_id_(var_id_, iNumLinha, var_script_case_init, do_ajax_form_hrm_ikatan_dinas_validate_id__cb);
  } // do_ajax_form_hrm_ikatan_dinas_validate_id_

  function do_ajax_form_hrm_ikatan_dinas_validate_id__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_ikatan_dinas_validate_id__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_hrm_ikatan_dinas_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_hrm_ikatan_dinas_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_hrm_ikatan_dinas_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_hrm_ikatan_dinas_add_new_line_cb);
  } // do_ajax_form_hrm_ikatan_dinas_add_new_line

  function do_ajax_form_hrm_ikatan_dinas_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_hrm_ikatan_dinas_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_hrm_ikatan_dinas_backup_line(iNumLinha)
  {
    var var_id_ = scAjaxGetFieldHidden("id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_ikatan_dinas_backup_line(var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_hrm_ikatan_dinas_backup_line_cb);
  } // do_ajax_form_hrm_ikatan_dinas_backup_line

  function do_ajax_form_hrm_ikatan_dinas_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_hrm_ikatan_dinas_backup_line_cb

  function do_ajax_form_hrm_ikatan_dinas_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_hrm_ikatan_dinas_cancel_insert

  function do_ajax_form_hrm_ikatan_dinas_cancel_update(iSeqVert)
  {
    do_ajax_form_hrm_ikatan_dinas_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_hrm_ikatan_dinas_cancel_update

  function do_ajax_form_hrm_ikatan_dinas_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_hrm_ikatan_dinas_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_hrm_ikatan_dinas_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_hrm_ikatan_dinas_table_refresh(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_hrm_ikatan_dinas_table_refresh_cb);
  } //  do_ajax_form_hrm_ikatan_dinas_table_refresh

  function do_ajax_form_hrm_ikatan_dinas_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_hrm_ikatan_dinas_table_refresh_cb_after_alert);
  } // do_ajax_form_hrm_ikatan_dinas_table_refresh_cb
  function do_ajax_form_hrm_ikatan_dinas_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_hrm_ikatan_dinas_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_hrm_ikatan_dinas_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_hrm_ikatan_dinas_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    sc_num_ult_line = iNumLinha;
    sc_num_ult_tr   = indexTR;
    scAjaxHideMessage();
    var var_tgl_mulai_ = scAjaxGetFieldText("tgl_mulai_" + iNumLinha);
    var var_tgl_selesai_ = scAjaxGetFieldText("tgl_selesai_" + iNumLinha);
...
?>
    x_ajax_form_hrm_ikatan_dinas_submit_form(var_tgl_mulai_, var_tgl_selesai_, var_lampiran_, var_id_, var_lampiran__ul_name, var_lampiran__ul_type, var_lampiran__salva, var_lampiran__limpa, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_hrm_ikatan_dinas_submit_form_cb);
  } // do_ajax_form_hrm_ikatan_dinas_submit_form

  function do_ajax_form_hrm_ikatan_dinas_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("tgl_mulai_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("tgl_selesai_" + sc_num_ult_line);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_hrm_ikatan_dinas_submit_form_cb_after_alert);
  } // do_ajax_form_hrm_ikatan_dinas_submit_form_cb
  function do_ajax_form_hrm_ikatan_dinas_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_hrm_ikatan_dinas_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_hrm_ikatan_dinas_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_hrm_ikatan_dinas_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("tgl_mulai_" + iNavForm);
      scAjaxHideErrorDisplay("tgl_selesai_" + iNavForm);
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_hrm_ikatan_dinas_navigate_form(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_hrm_ikatan_dinas_navigate_form_cb);
  } // do_ajax_form_hrm_ikatan_dinas_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_hrm_ikatan_dinas']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_hrm_ikatan_dinas_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_hrm_ikatan_dinas_navigate_form_cb_after_alert);
  } // do_ajax_form_hrm_ikatan_dinas_navigate_form_cb
  function do_ajax_form_hrm_ikatan_dinas_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_hrm_ikatan_dinas_navigate_form_cb_after_alert
  function sc_hide_form_hrm_ikatan_dinas_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "tgl_mulai_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "tgl_selesai_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "lampiran_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "id_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["tgl_mulai_" + iNumLinha] = {"label": "Tgl Mulai<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["tgl_selesai_" + iNumLinha] = {"label": "Tgl Selesai<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_field_mult["tgl_mulai_"][iNumLinha] = "tgl_mulai_" + iNumLinha;
    ajax_field_mult["tgl_selesai_"][iNumLinha] = "tgl_selesai_" + iNumLinha;
    ajax_field_mult["lampiran_"][iNumLinha] = "lampiran_" + iNumLinha;
    ajax_field_mult["id_"][iNumLinha] = "id_" + iNumLinha;
    ajax_field_id["tgl_mulai_" + iNumLinha] = new Array("hidden_field_label_tgl_mulai_", "hidden_field_data_tgl_mulai_" + iNumLinha);
    ajax_field_id["tgl_selesai_" + iNumLinha] = new Array("hidden_field_label_tgl_selesai_", "hidden_field_data_tgl_selesai_" + iNumLinha);
    ajax_field_id["lampiran_" + iNumLinha] = new Array("hidden_field_label_lampiran_", "hidden_field_data_lampiran_" + iNumLinha);
    ajax_error_count["tgl_mulai_" + iNumLinha] = "off";
    ajax_error_count["tgl_selesai_" + iNumLinha] = "off";
...
{
?>
    ajax_read_only["tgl_mulai_" + iNumLinha] = "off";
    ajax_read_only["tgl_selesai_" + iNumLinha] = "off";
...
{
?>
    ajax_read_only["tgl_mulai_" + iNumLinha] = "on";
    ajax_read_only["tgl_selesai_" + iNumLinha] = "on";
...
?>
  ...
  {
    ajax_error_list["tgl_mulai_" + iNumLinha] = null;
    ajax_error_list["tgl_selesai_" + iNumLinha] = null;
  ...
  var ajax_field_mult = {
    "tgl_mulai_": new Array(),
    "tgl_selesai_": new Array(),
    "lampiran_": new Array(),
    "id_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["tgl_mulai_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["tgl_mulai_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["tgl_mulai_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["tgl_mulai_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["tgl_mulai_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["tgl_selesai_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["tgl_selesai_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["tgl_selesai_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["tgl_selesai_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["tgl_selesai_" + iNumLinha]["onfocus"] = new Array();
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['tgl_mulai_'])) ? $this->nmgp_cmp_readonly['tgl_mulai_'] : 'off';
?>
    scAjaxFieldRead("tgl_mulai_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['tgl_selesai_'])) ? $this->nmgp_cmp_readonly['tgl_selesai_'] : 'off';
?>
    scAjaxFieldRead("tgl_selesai_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
?>
  ...
  {
    scAjaxFieldRead("tgl_mulai_" + iSeq, "on");
    scAjaxFieldRead("tgl_selesai_" + iSeq, "on");
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["tgl_mulai_" + iRow] || "on" == ajax_error_count["tgl_selesai_" + iRow] || "on" == ajax_error_count["lampiran_" + iRow] || "on" == ajax_error_count["id_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_tgl_mulai_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_tgl_selesai_" + iRow).addClass("scFormErrorLine");
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["tgl_mulai_" + iRow] && "off" == ajax_error_count["tgl_selesai_" + iRow] && "off" == ajax_error_count["lampiran_" + iRow] && "off" == ajax_error_count["id_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["tgl_mulai_" + iRow] = "off";
        ajax_error_count["tgl_selesai_" + iRow] = "off";
      ...
      $("#hidden_field_data_tgl_mulai_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_tgl_selesai_" + iRow).removeClass("scFormErrorLine");
