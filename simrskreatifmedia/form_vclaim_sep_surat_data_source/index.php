<?php
   include_once('form_vclaim_sep_surat_data_source_session.php');
   @session_start() ;
   $_SESSION['scriptcase']['form_vclaim_sep_surat_data_source']['glo_nm_perfil']          = "conn_mysql";
   $_SESSION['scriptcase']['form_vclaim_sep_surat_data_source']['glo_nm_path_prod']       = "";
   $_SESSION['scriptcase']['form_vclaim_sep_surat_data_source']['glo_nm_path_conf']       = "";
   $_SESSION['scriptcase']['form_vclaim_sep_surat_data_source']['glo_nm_path_imagens']    = "";
   $_SESSION['scriptcase']['form_vclaim_sep_surat_data_source']['glo_nm_path_imag_temp']  = "";
   $_SESSION['scriptcase']['form_vclaim_sep_surat_data_source']['glo_nm_path_doc']        = "";
    ...
    //check prod
    if(empty($_SESSION['scriptcase']['form_vclaim_sep_surat_data_source']['glo_nm_path_prod']))
    {
            /*check prod*/$_SESSION['scriptcase']['form_vclaim_sep_surat_data_source']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
    }
    //check img
    if(empty($_SESSION['scriptcase']['form_vclaim_sep_surat_data_source']['glo_nm_path_imagens']))
    {
            /*check img*/$_SESSION['scriptcase']['form_vclaim_sep_surat_data_source']['glo_nm_path_imagens'] = $str_path_apl_url . "_lib/file/img";
    }
    //check tmp
    if(empty($_SESSION['scriptcase']['form_vclaim_sep_surat_data_source']['glo_nm_path_imag_temp']))
    {
            /*check tmp*/$_SESSION['scriptcase']['form_vclaim_sep_surat_data_source']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
    }
    //check doc
    if(empty($_SESSION['scriptcase']['form_vclaim_sep_surat_data_source']['glo_nm_path_doc']))
    {
            /*check doc*/$_SESSION['scriptcase']['form_vclaim_sep_surat_data_source']['glo_nm_path_doc'] = $str_path_apl_dir . "_lib/file/doc";
    }
    //end check publication with the prod
//
class form_vclaim_sep_surat_data_source_ini
{
   var $nm_cod_apl;
   var $nm_nome_apl;
   var $nm_seguranca;
...
//
   function init($Tp_init = "")
   {
      ...
      $_SESSION['sc_session'][$this->sc_page]['form_vclaim_sep_surat_data_source']['decimal_db'] = "."; 
      $this->nm_cod_apl      = "form_vclaim_sep_surat_data_source"; 
      $this->nm_nome_apl     = ""; 
      $this->nm_seguranca    = ""; 
...
// 
      ...
      $this->sc_protocolo    = "";
      $this->path_prod       = $_SESSION['scriptcase']['form_vclaim_sep_surat_data_source']['glo_nm_path_prod'];
      $this->path_conf       = $_SESSION['scriptcase']['form_vclaim_sep_surat_data_source']['glo_nm_path_conf'];
      $this->path_imagens    = $_SESSION['scriptcase']['form_vclaim_sep_surat_data_source']['glo_nm_path_imagens'];
      $this->path_imag_temp  = $_SESSION['scriptcase']['form_vclaim_sep_surat_data_source']['glo_nm_path_imag_temp'];
      $this->path_doc        = $_SESSION['scriptcase']['form_vclaim_sep_surat_data_source']['glo_nm_path_doc'];
      ...
      $this->path_aplicacao  = substr($this->path_aplicacao, 0, strrpos($this->path_aplicacao, '/')) . '/form_vclaim_sep_surat_data_source';
      ...
      if (isset($_SESSION['scriptcase']['form_vclaim_sep_surat_data_source']['session_timeout']['lang'])) {
          $this->str_lang = $_SESSION['scriptcase']['form_vclaim_sep_surat_data_source']['session_timeout']['lang'];
      }
      elseif (!isset($_SESSION['scriptcase']['form_vclaim_sep_surat_data_source']['actual_lang']) || $_SESSION['scriptcase']['form_vclaim_sep_surat_data_source']['actual_lang'] != $this->str_lang) {
          $_SESSION['scriptcase']['form_vclaim_sep_surat_data_source']['actual_lang'] = $this->str_lang;
      ...
      {
          include_once("form_vclaim_sep_surat_data_source_json.php");
      }
      $this->SC_Link_View = (isset($_SESSION['sc_session'][$this->sc_page]['form_vclaim_sep_surat_data_source']['SC_Link_View'])) ? $_SESSION['sc_session'][$this->sc_page]['form_vclaim_sep_surat_data_source']['SC_Link_View'] : false;
      if (isset($_GET['SC_Link_View']) && !empty($_GET['SC_Link_View']) && is_numeric($_GET['SC_Link_View']))
      {
          if ($_SESSION['sc_session'][$this->sc_page]['form_vclaim_sep_surat_data_source']['embutida'])
          {
              $this->SC_Link_View = true;
              $_SESSION['sc_session'][$this->sc_page]['form_vclaim_sep_surat_data_source']['SC_Link_View'] = true;
          }
      }
      if (isset($_POST['nmgp_opcao']) && $_POST['nmgp_opcao'] == "ajax_save_ancor")
      {
          $_SESSION['sc_session'][$this->sc_page]['form_vclaim_sep_surat_data_source']['ancor_save'] = $_POST['ancor_save'];
...
<?php
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['form_vclaim_sep_surat_data_source']['dashboard_info']['under_dashboard']))
      {
          $_SESSION['sc_session'][$this->sc_page]['form_vclaim_sep_surat_data_source']['dashboard_info']['under_dashboard'] = false;
          $_SESSION['sc_session'][$this->sc_page]['form_vclaim_sep_surat_data_source']['dashboard_info']['dashboard_app']   = '';
          $_SESSION['sc_session'][$this->sc_page]['form_vclaim_sep_surat_data_source']['dashboard_info']['own_widget']      = '';
          $_SESSION['sc_session'][$this->sc_page]['form_vclaim_sep_surat_data_source']['dashboard_info']['parent_widget']   = '';
          $_SESSION['sc_session'][$this->sc_page]['form_vclaim_sep_surat_data_source']['dashboard_info']['compact_mode']    = false;
          $_SESSION['sc_session'][$this->sc_page]['form_vclaim_sep_surat_data_source']['dashboard_info']['remove_margin']   = false;
      }
      if (isset($_GET['under_dashboard']) && 1 == $_GET['under_dashboard'])
      {
          if (isset($_GET['own_widget']) && 'dbifrm_widget' == substr($_GET['own_widget'], 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['form_vclaim_sep_surat_data_source']['dashboard_info']['own_widget'] = $_GET['own_widget'];
              $_SESSION['sc_session'][$this->sc_page]['form_vclaim_sep_surat_data_source']['dashboard_info']['under_dashboard'] = true;
              if (isset($_GET['dashboard_app'])) {
                  $_SESSION['sc_session'][$this->sc_page]['form_vclaim_sep_surat_data_source']['dashboard_info']['dashboard_app'] = $_GET['dashboard_app'];
              }
              if (isset($_GET['parent_widget'])) {
                  $_SESSION['sc_session'][$this->sc_page]['form_vclaim_sep_surat_data_source']['dashboard_info']['parent_widget'] = $_GET['parent_widget'];
              }
              if (isset($_GET['compact_mode'])) {
                  $_SESSION['sc_session'][$this->sc_page]['form_vclaim_sep_surat_data_source']['dashboard_info']['compact_mode'] = 1 == $_GET['compact_mode'];
              }
              if (isset($_GET['remove_margin'])) {
                  $_SESSION['sc_session'][$this->sc_page]['form_vclaim_sep_surat_data_source']['dashboard_info']['remove_margin'] = 1 == $_GET['remove_margin'];
              }
          }
      }
      elseif (isset($under_dashboard) && 1 == $under_dashboard)
      {
          if (isset($own_widget) && 'dbifrm_widget' == substr($own_widget, 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['form_vclaim_sep_surat_data_source']['dashboard_info']['own_widget'] = $own_widget;
              $_SESSION['sc_session'][$this->sc_page]['form_vclaim_sep_surat_data_source']['dashboard_info']['under_dashboard'] = true;
              if (isset($dashboard_app)) {
                  $_SESSION['sc_session'][$this->sc_page]['form_vclaim_sep_surat_data_source']['dashboard_info']['dashboard_app'] = $dashboard_app;
              }
              if (isset($parent_widget)) {
                  $_SESSION['sc_session'][$this->sc_page]['form_vclaim_sep_surat_data_source']['dashboard_info']['parent_widget'] = $parent_widget;
              }
              if (isset($compact_mode)) {
                  $_SESSION['sc_session'][$this->sc_page]['form_vclaim_sep_surat_data_source']['dashboard_info']['compact_mode'] = 1 == $compact_mode;
              }
              if (isset($remove_margin)) {
                  $_SESSION['sc_session'][$this->sc_page]['form_vclaim_sep_surat_data_source']['dashboard_info']['remove_margin'] = 1 == $remove_margin;
              }
          }
      }
      if (!isset($_SESSION['sc_session'][$this->sc_page]['form_vclaim_sep_surat_data_source']['dashboard_info']['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['form_vclaim_sep_surat_data_source']['dashboard_info']['maximized'] = false;
      }
      if (isset($_GET['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['form_vclaim_sep_surat_data_source']['dashboard_info']['maximized'] = 1 == $_GET['maximized'];
      }
      if ($_SESSION['sc_session'][$this->sc_page]['form_vclaim_sep_surat_data_source']['dashboard_info']['under_dashboard'])
      {
          $sTmpDashboardApp = $_SESSION['sc_session'][$this->sc_page]['form_vclaim_sep_surat_data_source']['dashboard_info']['dashboard_app'];
          if ('' != $sTmpDashboardApp && isset($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["form_vclaim_sep_surat_data_source"]))
          {
              foreach ($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["form_vclaim_sep_surat_data_source"] as $sTmpTargetLink => $sTmpTargetWidget)
              {
      ...
      if (!is_file($this->root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
      {
          ...
          unset($_SESSION['scriptcase']['form_vclaim_sep_surat_data_source']['glo_nm_conexao']);
      }
      ...
      if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['form_vclaim_sep_surat_data_source']['session_timeout']['redir']))
      {
      ...
      $_SESSION['sc_session'][$this->sc_page]['form_vclaim_sep_surat_data_source']['path_doc'] = $this->path_doc; 
      ...
      if (!is_dir($this->root . $this->path_prod))
      {
          ...
          echo " </tr>";
          echo "</table>";
          if (!$_SESSION['sc_session'][$script_case_init]['form_vclaim_sep_surat_data_source']['iframe_menu'] && (!isset($_SESSION['sc_session'][$script_case_init]['form_vclaim_sep_surat_data_source']['sc_outra_jan']) || !$_SESSION['sc_session'][$script_case_init]['form_vclaim_sep_surat_data_source']['sc_outra_jan'])) 
          { 
...
// 
      include_once($this->path_aplicacao . "form_vclaim_sep_surat_data_source_erro.class.php"); 
      $this->Erro = new form_vclaim_sep_surat_data_source_erro();
      include_once($this->path_adodb . "/adodb.inc.php"); 
      $this->sc_Include($this->path_libs . "/nm_sec_prod.php", "F", "nm_reg_prod") ; 
      $this->sc_Include($this->path_libs . "/nm_ini_perfil.php", "F", "perfil_lib") ; 
// 
 if(function_exists('set_php_timezone')) set_php_timezone('form_vclaim_sep_surat_data_source'); 
// 
      ...
      if (isset($_SESSION['scriptcase']['form_vclaim_sep_surat_data_source']['session_timeout']['redir'])) {
          ...
          if ($_SESSION['scriptcase']['form_vclaim_sep_surat_data_source']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "  </HEAD>\r\n";
              $SS_cod_html .= "   <body>\r\n";
          }
          else {
              ...
              $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['form_vclaim_sep_surat_data_source']['session_timeout']['redir'] . "');\">\r\n";
              $SS_cod_html .= "     </form>\r\n";
          ...
          if ($_SESSION['scriptcase']['form_vclaim_sep_surat_data_source']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['form_vclaim_sep_surat_data_source']['session_timeout']['redir'] . "');\r\n";
          }
          ...
          $SS_cod_html .= " </body>\r\n";
          $SS_cod_html .= "</HTML>\r\n";
          unset($_SESSION['scriptcase']['form_vclaim_sep_surat_data_source']['session_timeout']);
          unset($_SESSION['sc_session']);
      }
      ...
      $_SESSION['sc_session'][$this->sc_page]['form_vclaim_sep_surat_data_source']['seq_dir'] = 0; 
      $_SESSION['sc_session'][$this->sc_page]['form_vclaim_sep_surat_data_source']['sub_dir'] = array(); 
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
      $this->conectDB();
   ...
   function prep_conect()
   {
      if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
      {
          ...
          {
              if (isset($_SESSION['scriptcase']['form_vclaim_sep_surat_data_source']['glo_nm_conexao']) && $_SESSION['scriptcase']['form_vclaim_sep_surat_data_source']['glo_nm_conexao'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['form_vclaim_sep_surat_data_source']['glo_nm_conexao'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['form_vclaim_sep_surat_data_source']['glo_nm_perfil']) && $_SESSION['scriptcase']['form_vclaim_sep_surat_data_source']['glo_nm_perfil'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['form_vclaim_sep_surat_data_source']['glo_nm_perfil'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['form_vclaim_sep_surat_data_source']['glo_con_' . $NM_con_orig]))
              {
                  $_SESSION['scriptcase']['form_vclaim_sep_surat_data_source']['glo_con_' . $NM_con_orig] = $NM_con_dest;
              }
          }
      }
      $con_devel             = (isset($_SESSION['scriptcase']['form_vclaim_sep_surat_data_source']['glo_nm_conexao'])) ? $_SESSION['scriptcase']['form_vclaim_sep_surat_data_source']['glo_nm_conexao'] : ""; 
      $perfil_trab           = ""; 
      $this->nm_falta_var    = ""; 
      $this->nm_falta_var_db = ""; 
      $nm_crit_perfil        = false;
      if (isset($_SESSION['scriptcase']['form_vclaim_sep_surat_data_source']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['form_vclaim_sep_surat_data_source']['glo_nm_conexao']))
      {
          ob_start();
      ...
      if (isset($_SESSION['scriptcase']['form_vclaim_sep_surat_data_source']['glo_nm_perfil']) && !empty($_SESSION['scriptcase']['form_vclaim_sep_surat_data_source']['glo_nm_perfil']))
      {
          $perfil_trab = $_SESSION['scriptcase']['form_vclaim_sep_surat_data_source']['glo_nm_perfil'];
      }
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['form_vclaim_sep_surat_data_source']['embutida_init']) || !$_SESSION['sc_session'][$this->sc_page]['form_vclaim_sep_surat_data_source']['embutida_init']) 
      {
      }
// 
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['form_vclaim_sep_surat_data_source']['decimal_db'] = $_SESSION['scriptcase']['glo_decimal_db']; 
      }
      if (isset($_SESSION['scriptcase']['glo_date_separator']) && !empty($_SESSION['scriptcase']['glo_date_separator']))
      {
          ...
          if (strlen($SC_temp) == 2)
          {
              $_SESSION['sc_session'][$this->sc_page]['form_vclaim_sep_surat_data_source']['SC_sep_date']  = substr($SC_temp, 0, 1); 
              $_SESSION['sc_session'][$this->sc_page]['form_vclaim_sep_surat_data_source']['SC_sep_date1'] = substr($SC_temp, 1, 1); 
          }
          else
           {
              $_SESSION['sc_session'][$this->sc_page]['form_vclaim_sep_surat_data_source']['SC_sep_date']  = $SC_temp; 
              $_SESSION['sc_session'][$this->sc_page]['form_vclaim_sep_surat_data_source']['SC_sep_date1'] = $SC_temp; 
          }
          $this->date_delim  = $_SESSION['sc_session'][$this->sc_page]['form_vclaim_sep_surat_data_source']['SC_sep_date'];
          $this->date_delim1 = $_SESSION['sc_session'][$this->sc_page]['form_vclaim_sep_surat_data_source']['SC_sep_date1'];
      }
// 
...
<?php
   ...
   function conectDB()
   {
      ...
      if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['form_vclaim_sep_surat_data_source']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['form_vclaim_sep_surat_data_source']['glo_nm_conexao']))
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['form_vclaim_sep_surat_data_source']['glo_nm_conexao'], $this->root . $this->path_prod, 'simrskreatifmedia', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
...
// 
   ...
   function sc_Sql_Protect($var, $tp, $conex="")
   {
       ...
       if ($tp == "date")
       {
           ...
           if (isset($_SESSION['sc_session'][$this->sc_page]['form_vclaim_sep_surat_data_source']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->sc_page]['form_vclaim_sep_surat_data_source']['SC_sep_date']))
           {
               $delim  = $_SESSION['sc_session'][$this->sc_page]['form_vclaim_sep_surat_data_source']['SC_sep_date'];
               $delim1 = $_SESSION['sc_session'][$this->sc_page]['form_vclaim_sep_surat_data_source']['SC_sep_date1'];
           }
   ...
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['form_vclaim_sep_surat_data_source']['SC_Gb_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['form_vclaim_sep_surat_data_source']['SC_Gb_date_format'][$GB][$cmp] : "";
   }

   function Get_Gb_prefix_date_format($GB, $cmp)
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['form_vclaim_sep_surat_data_source']['SC_Gb_prefix_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['form_vclaim_sep_surat_data_source']['SC_Gb_prefix_date_format'][$GB][$cmp] : "";
   }
...
//===============================================================================
//
class form_vclaim_sep_surat_data_source_apl
{
   var $Ini;
   var $Erro;
   var $Db;
...
//----- 
   function controle()
   {
      ...
      $this->Ini = new form_vclaim_sep_surat_data_source_ini(); 
      $this->Ini->init();
      $this->Change_Menu = false;
      if (isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_surat_data_source']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_surat_data_source']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_vclaim_sep_surat_data_source']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_vclaim_sep_surat_data_source'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_vclaim_sep_surat_data_source']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_vclaim_sep_surat_data_source']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_vclaim_sep_surat_data_source') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_vclaim_sep_surat_data_source']['label'] = "" . $this->Ini->Nm_lang['lang_othr_blank_title'] . "";
          ...
          elseif ($this->Ini->sc_page == $this->sc_init_menu)
          {
              ...
              {
                  if ($apl == "form_vclaim_sep_surat_data_source")
                  {
                      $achou = true;
                  }
                  elseif ($achou)
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_vclaim_sep_surat_data_source']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_vclaim_sep_surat_data_source']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['form_vclaim_sep_surat_data_source']['exit'];
      ...
      $this->Db = $this->Ini->Db; 
      include_once($this->Ini->path_aplicacao . "form_vclaim_sep_surat_data_source_erro.class.php"); 
      $this->Erro      = new form_vclaim_sep_surat_data_source_erro();
      $this->Erro->Ini = $this->Ini;
//
      $_SESSION['scriptcase']['form_vclaim_sep_surat_data_source']['contr_erro'] = 'on';
if (!isset($_SESSION['catatan'])) {$_SESSION['catatan'] = "";}
if (!isset($this->sc_temp_catatan)) {$this->sc_temp_catatan = (isset($_SESSION['catatan'])) ? $_SESSION['catatan'] : "";}
if (!isset($_SESSION['diagnosa'])) {$_SESSION['diagnosa'] = "";}
if (!isset($this->sc_temp_diagnosa)) {$this->sc_temp_diagnosa = (isset($_SESSION['diagnosa'])) ? $_SESSION['diagnosa'] : "";}
if (!isset($_SESSION['asal_faskes'])) {$_SESSION['asal_faskes'] = "";}
if (!isset($this->sc_temp_asal_faskes)) {$this->sc_temp_asal_faskes = (isset($_SESSION['asal_faskes'])) ? $_SESSION['asal_faskes'] : "";}
if (!isset($_SESSION['kelas_rawat'])) {$_SESSION['kelas_rawat'] = "";}
if (!isset($this->sc_temp_kelas_rawat)) {$this->sc_temp_kelas_rawat = (isset($_SESSION['kelas_rawat'])) ? $_SESSION['kelas_rawat'] : "";}
if (!isset($_SESSION['poli_tujuan'])) {$_SESSION['poli_tujuan'] = "";}
if (!isset($this->sc_temp_poli_tujuan)) {$this->sc_temp_poli_tujuan = (isset($_SESSION['poli_tujuan'])) ? $_SESSION['poli_tujuan'] : "";}
if (!isset($_SESSION['jns_layanan'])) {$_SESSION['jns_layanan'] = "";}
if (!isset($this->sc_temp_jns_layanan)) {$this->sc_temp_jns_layanan = (isset($_SESSION['jns_layanan'])) ? $_SESSION['jns_layanan'] : "";}
if (!isset($_SESSION['jns_kelamin'])) {$_SESSION['jns_kelamin'] = "";}
if (!isset($this->sc_temp_jns_kelamin)) {$this->sc_temp_jns_kelamin = (isset($_SESSION['jns_kelamin'])) ? $_SESSION['jns_kelamin'] : "";}
if (!isset($_SESSION['cob'])) {$_SESSION['cob'] = "";}
if (!isset($this->sc_temp_cob)) {$this->sc_temp_cob = (isset($_SESSION['cob'])) ? $_SESSION['cob'] : "";}
if (!isset($_SESSION['tgl_lahir'])) {$_SESSION['tgl_lahir'] = "";}
if (!isset($this->sc_temp_tgl_lahir)) {$this->sc_temp_tgl_lahir = (isset($_SESSION['tgl_lahir'])) ? $_SESSION['tgl_lahir'] : "";}
if (!isset($_SESSION['nama'])) {$_SESSION['nama'] = "";}
if (!isset($this->sc_temp_nama)) {$this->sc_temp_nama = (isset($_SESSION['nama'])) ? $_SESSION['nama'] : "";}
if (!isset($_SESSION['jenis_peserta'])) {$_SESSION['jenis_peserta'] = "";}
if (!isset($this->sc_temp_jenis_peserta)) {$this->sc_temp_jenis_peserta = (isset($_SESSION['jenis_peserta'])) ? $_SESSION['jenis_peserta'] : "";}
if (!isset($_SESSION['no_kartu'])) {$_SESSION['no_kartu'] = "";}
if (!isset($this->sc_temp_no_kartu)) {$this->sc_temp_no_kartu = (isset($_SESSION['no_kartu'])) ? $_SESSION['no_kartu'] : "";}
if (!isset($_SESSION['tgl_sep'])) {$_SESSION['tgl_sep'] = "";}
if (!isset($this->sc_temp_tgl_sep)) {$this->sc_temp_tgl_sep = (isset($_SESSION['tgl_sep'])) ? $_SESSION['tgl_sep'] : "";}
if (!isset($_SESSION['no_sep'])) {$_SESSION['no_sep'] = "";}
if (!isset($this->sc_temp_no_sep)) {$this->sc_temp_no_sep = (isset($_SESSION['no_sep'])) ? $_SESSION['no_sep'] : "";}
if (!isset($_SESSION['nama_rs'])) {$_SESSION['nama_rs'] = "";}
if (!isset($this->sc_temp_nama_rs)) {$this->sc_temp_nama_rs = (isset($_SESSION['nama_rs'])) ? $_SESSION['nama_rs'] : "";}
  $no_sep = $_GET['no_sep'];

$sSQL = "SELECT value FROM app_setting WHERE name = 'nama_institusi'";
...
$sSQL = "SELECT r.no_sep, r.tgl_sep, r.no_kartu, r.jenis_peserta, r.nama, r.tanggal_lahir, i.cob, r.kelamin, r.jenis_pelayanan, r.poli, r.kelas_rawat, r.ppk_perujuk_nama, r.diagnosa, r.catatan FROM vclaim_sep_response r LEFT JOIN vclaim_sep_insert i ON r.no_kunjungan = i.no_rujukan WHERE r.no_sep = '".$no_sep."' AND is_delete = 0 LIMIT 1";
...
if(!empty($this->dataset )){
	...
	foreach($this->dataset  as $set){
		...
		$this->sc_temp_nama_rs		= $nama_rs;
		$this->sc_temp_no_sep		= $set[0];
		$this->sc_temp_tgl_sep		= $set[1];
		$this->sc_temp_no_kartu		= $set[2];
		$this->sc_temp_jenis_peserta	= $set[3];
		$this->sc_temp_nama			= $set[4];
		$this->sc_temp_tgl_lahir		= $set[5];
		$this->sc_temp_cob			= $set[6];
		$this->sc_temp_jns_kelamin	= $set[7];
		$this->sc_temp_jns_layanan	= $set[8];
		$this->sc_temp_poli_tujuan	= $set[9];
		$this->sc_temp_kelas_rawat	= $set[10];
		$this->sc_temp_asal_faskes	= $set[11];
		$this->sc_temp_diagnosa		= $set[12];
		$this->sc_temp_catatan		= $set[13];
...
;
	...
	$fields 	  = '';
	$cust_request = 'GET';
	$url_rest	  = $conf['vclaim_api_url'].'sep/'.$no_sep;
	$content_type = 'application/x-www-form-urlencoded';
	$result 	  = $this->vclaim_client($conf,$content_type,$cust_request,$url_rest,$fields);
	$ar   		  = json_decode($result,true);
	
	$this->sc_temp_nama_rs		= $nama_rs;
	$this->sc_temp_no_sep		= $ar['response']['noSep'];
	$this->sc_temp_tgl_sep		= $ar['response']['tglSep'];
	$this->sc_temp_no_kartu		= $ar['response']['noKartu'];
	$this->sc_temp_jenis_peserta	= $ar['response']['jnsPeserta'];
	$this->sc_temp_nama			= $ar['response']['nama'];
	$this->sc_temp_tgl_lahir		= $ar['response']['tglLahir'];
	$this->sc_temp_cob			= $ar['response']['-'];
	$this->sc_temp_jns_kelamin	= $ar['response']['kelamin'];
	$this->sc_temp_jns_layanan	= $ar['response']['jnsPelayanan'];
	$this->sc_temp_poli_tujuan	= $ar['response']['poli'];
	$this->sc_temp_kelas_rawat	= $ar['response']['kelasRawat'];
	$this->sc_temp_asal_faskes	= $ar['response']['-'];
	$this->sc_temp_diagnosa		= $ar['response']['diagnosa'];
	$this->sc_temp_catatan		= $ar['response']['catatan'];
	
}

 if (isset($this->sc_temp_nama_rs)) {$_SESSION['nama_rs'] = $this->sc_temp_nama_rs;}
 if (isset($this->sc_temp_no_sep)) {$_SESSION['no_sep'] = $this->sc_temp_no_sep;}
 if (isset($this->sc_temp_tgl_sep)) {$_SESSION['tgl_sep'] = $this->sc_temp_tgl_sep;}
 if (isset($this->sc_temp_no_kartu)) {$_SESSION['no_kartu'] = $this->sc_temp_no_kartu;}
 if (isset($this->sc_temp_jenis_peserta)) {$_SESSION['jenis_peserta'] = $this->sc_temp_jenis_peserta;}
 if (isset($this->sc_temp_nama)) {$_SESSION['nama'] = $this->sc_temp_nama;}
 if (isset($this->sc_temp_tgl_lahir)) {$_SESSION['tgl_lahir'] = $this->sc_temp_tgl_lahir;}
 if (isset($this->sc_temp_cob)) {$_SESSION['cob'] = $this->sc_temp_cob;}
 if (isset($this->sc_temp_jns_kelamin)) {$_SESSION['jns_kelamin'] = $this->sc_temp_jns_kelamin;}
 if (isset($this->sc_temp_jns_layanan)) {$_SESSION['jns_layanan'] = $this->sc_temp_jns_layanan;}
 if (isset($this->sc_temp_poli_tujuan)) {$_SESSION['poli_tujuan'] = $this->sc_temp_poli_tujuan;}
 if (isset($this->sc_temp_kelas_rawat)) {$_SESSION['kelas_rawat'] = $this->sc_temp_kelas_rawat;}
 if (isset($this->sc_temp_asal_faskes)) {$_SESSION['asal_faskes'] = $this->sc_temp_asal_faskes;}
 if (isset($this->sc_temp_diagnosa)) {$_SESSION['diagnosa'] = $this->sc_temp_diagnosa;}
 if (isset($this->sc_temp_catatan)) {$_SESSION['catatan'] = $this->sc_temp_catatan;}
...
if (isset($this->sc_temp_diagnosa)) {$_SESSION['diagnosa'] = $this->sc_temp_diagnosa;}
if (isset($this->sc_temp_catatan)) {$_SESSION['catatan'] = $this->sc_temp_catatan;}
$_SESSION['scriptcase']['form_vclaim_sep_surat_data_source']['contr_erro'] = 'off'; 
//--- 
       $this->Db->Close(); 
       if ($this->Change_Menu)
       {
   ...
   function nmgp_redireciona_form($nm_apl_dest, $nm_apl_retorno, $nm_apl_parms, $nm_target="", $alt_modal=0, $larg_modal=0, $opc="")
   {
      if (is_array($nm_apl_parms))
      {
          ...
          foreach ($nm_apl_parms as $par => $val)
          {
              ...
              elseif (substr($val, 0, 1) == "[")
              {
                  $tmp_parms .= $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_surat_data_source'][substr($val, 1, -1)];
              }
              else
              {
                  $tmp_parms .= $val;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_surat_data_source']['iframe_print']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_surat_data_source']['iframe_print'] )
      {
          $target = "_parent";
      }
   ?>
...
//======= =========================
   ...
   if (!empty($_POST))
   {
       foreach ($_POST as $nmgp_var => $nmgp_val)
       {
            ...
            nm_limpa_str_form_vclaim_sep_surat_data_source($nmgp_val);
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['form_vclaim_sep_surat_data_source']['glo_nm_path_imag_temp'] . "/sc_apl_default_simrskreatifmedia.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['form_vclaim_sep_surat_data_source']['glo_nm_path_imag_temp'] . "/sc_apl_default_simrskreatifmedia.txt"));
       }
       if (isset($apl_def)) {
           if ($apl_def[0] != "form_vclaim_sep_surat_data_source") {
               $_SESSION['scriptcase']['sem_session'] = true;
               if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                   $_SESSION['scriptcase']['form_vclaim_sep_surat_data_source']['session_timeout']['redir'] = $apl_def[0];
               }
               else {
                   $_SESSION['scriptcase']['form_vclaim_sep_surat_data_source']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
               }
               $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
               $_SESSION['scriptcase']['form_vclaim_sep_surat_data_source']['session_timeout']['redir_tp'] = $Redir_tp;
           }
           if (isset($_COOKIE['sc_actual_lang_simrskreatifmedia'])) {
               $_SESSION['scriptcase']['form_vclaim_sep_surat_data_source']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_simrskreatifmedia'];
           }
       }
   }
   ...
   {
       $_SESSION["nama_rs"] = $_POST["nama_rs"];
       nm_limpa_str_form_vclaim_sep_surat_data_source($_SESSION["nama_rs"]);
   }
   if (isset($_GET["nama_rs"])) 
   {
       $_SESSION["nama_rs"] = $_GET["nama_rs"];
       nm_limpa_str_form_vclaim_sep_surat_data_source($_SESSION["nama_rs"]);
   }
   if (!isset($_SESSION["nama_rs"])) 
   {
       $_SESSION["nama_rs"] = "";
   }
   if (isset($_POST["no_sep"])) 
   {
       $_SESSION["no_sep"] = $_POST["no_sep"];
       nm_limpa_str_form_vclaim_sep_surat_data_source($_SESSION["no_sep"]);
   }
   if (isset($_GET["no_sep"])) 
   {
       $_SESSION["no_sep"] = $_GET["no_sep"];
       nm_limpa_str_form_vclaim_sep_surat_data_source($_SESSION["no_sep"]);
   }
   if (!isset($_SESSION["no_sep"])) 
   {
       $_SESSION["no_sep"] = "";
   }
   if (isset($_POST["tgl_sep"])) 
   {
       $_SESSION["tgl_sep"] = $_POST["tgl_sep"];
       nm_limpa_str_form_vclaim_sep_surat_data_source($_SESSION["tgl_sep"]);
   }
   if (isset($_GET["tgl_sep"])) 
   {
       $_SESSION["tgl_sep"] = $_GET["tgl_sep"];
       nm_limpa_str_form_vclaim_sep_surat_data_source($_SESSION["tgl_sep"]);
   }
   if (!isset($_SESSION["tgl_sep"])) 
   {
       $_SESSION["tgl_sep"] = "";
   }
   if (isset($_POST["no_kartu"])) 
   {
       $_SESSION["no_kartu"] = $_POST["no_kartu"];
       nm_limpa_str_form_vclaim_sep_surat_data_source($_SESSION["no_kartu"]);
   }
   if (isset($_GET["no_kartu"])) 
   {
       $_SESSION["no_kartu"] = $_GET["no_kartu"];
       nm_limpa_str_form_vclaim_sep_surat_data_source($_SESSION["no_kartu"]);
   }
   ...
   if (isset($_POST["jenis_peserta"])) 
   {
       $_SESSION["jenis_peserta"] = $_POST["jenis_peserta"];
       nm_limpa_str_form_vclaim_sep_surat_data_source($_SESSION["jenis_peserta"]);
   }
   if (isset($_GET["jenis_peserta"])) 
   {
       $_SESSION["jenis_peserta"] = $_GET["jenis_peserta"];
       nm_limpa_str_form_vclaim_sep_surat_data_source($_SESSION["jenis_peserta"]);
   }
   if (!isset($_SESSION["jenis_peserta"])) 
   {
       $_SESSION["jenis_peserta"] = "";
   }
   if (isset($_POST["nama"])) 
   {
       $_SESSION["nama"] = $_POST["nama"];
       nm_limpa_str_form_vclaim_sep_surat_data_source($_SESSION["nama"]);
   }
   if (isset($_GET["nama"])) 
   {
   ...
   if (isset($_POST["tgl_lahir"])) 
   {
       ...
       nm_limpa_str_form_vclaim_sep_surat_data_source($_SESSION["tgl_lahir"]);
   }
   if (isset($_GET["tgl_lahir"])) 
   {
       $_SESSION["tgl_lahir"] = $_GET["tgl_lahir"];
       nm_limpa_str_form_vclaim_sep_surat_data_source($_SESSION["tgl_lahir"]);
   }
   ...
   if (isset($_POST["cob"])) 
   {
       ...
       nm_limpa_str_form_vclaim_sep_surat_data_source($_SESSION["cob"]);
   }
   if (isset($_GET["cob"])) 
   {
       $_SESSION["cob"] = $_GET["cob"];
       nm_limpa_str_form_vclaim_sep_surat_data_source($_SESSION["cob"]);
   }
   ...
   {
       $_SESSION["jns_kelamin"] = $_POST["jns_kelamin"];
       nm_limpa_str_form_vclaim_sep_surat_data_source($_SESSION["jns_kelamin"]);
   }
   if (isset($_GET["jns_kelamin"])) 
   {
       $_SESSION["jns_kelamin"] = $_GET["jns_kelamin"];
       nm_limpa_str_form_vclaim_sep_surat_data_source($_SESSION["jns_kelamin"]);
   }
   if (!isset($_SESSION["jns_kelamin"])) 
   {
       $_SESSION["jns_kelamin"] = "";
   }
   if (isset($_POST["jns_layanan"])) 
   {
       $_SESSION["jns_layanan"] = $_POST["jns_layanan"];
       nm_limpa_str_form_vclaim_sep_surat_data_source($_SESSION["jns_layanan"]);
   }
   if (isset($_GET["jns_layanan"])) 
   {
       $_SESSION["jns_layanan"] = $_GET["jns_layanan"];
       nm_limpa_str_form_vclaim_sep_surat_data_source($_SESSION["jns_layanan"]);
   }
   if (!isset($_SESSION["jns_layanan"])) 
   {
       $_SESSION["jns_layanan"] = "";
   }
   if (isset($_POST["poli_tujuan"])) 
   {
       $_SESSION["poli_tujuan"] = $_POST["poli_tujuan"];
       nm_limpa_str_form_vclaim_sep_surat_data_source($_SESSION["poli_tujuan"]);
   }
   if (isset($_GET["poli_tujuan"])) 
   {
       $_SESSION["poli_tujuan"] = $_GET["poli_tujuan"];
       nm_limpa_str_form_vclaim_sep_surat_data_source($_SESSION["poli_tujuan"]);
   }
   if (!isset($_SESSION["poli_tujuan"])) 
   {
       $_SESSION["poli_tujuan"] = "";
   }
   if (isset($_POST["kelas_rawat"])) 
   {
       $_SESSION["kelas_rawat"] = $_POST["kelas_rawat"];
       nm_limpa_str_form_vclaim_sep_surat_data_source($_SESSION["kelas_rawat"]);
   }
   if (isset($_GET["kelas_rawat"])) 
   {
       $_SESSION["kelas_rawat"] = $_GET["kelas_rawat"];
       nm_limpa_str_form_vclaim_sep_surat_data_source($_SESSION["kelas_rawat"]);
   }
   if (!isset($_SESSION["kelas_rawat"])) 
   {
       $_SESSION["kelas_rawat"] = "";
   }
   if (isset($_POST["asal_faskes"])) 
   {
       $_SESSION["asal_faskes"] = $_POST["asal_faskes"];
       nm_limpa_str_form_vclaim_sep_surat_data_source($_SESSION["asal_faskes"]);
   }
   if (isset($_GET["asal_faskes"])) 
   {
       $_SESSION["asal_faskes"] = $_GET["asal_faskes"];
       nm_limpa_str_form_vclaim_sep_surat_data_source($_SESSION["asal_faskes"]);
   }
   if (!isset($_SESSION["asal_faskes"])) 
   {
       $_SESSION["asal_faskes"] = "";
   }
   if (isset($_POST["diagnosa"])) 
   {
       $_SESSION["diagnosa"] = $_POST["diagnosa"];
       nm_limpa_str_form_vclaim_sep_surat_data_source($_SESSION["diagnosa"]);
   }
   if (isset($_GET["diagnosa"])) 
   {
       $_SESSION["diagnosa"] = $_GET["diagnosa"];
       nm_limpa_str_form_vclaim_sep_surat_data_source($_SESSION["diagnosa"]);
   }
   ...
   if (isset($_POST["catatan"])) 
   {
       ...
       nm_limpa_str_form_vclaim_sep_surat_data_source($_SESSION["catatan"]);
   }
   if (isset($_GET["catatan"])) 
   {
       $_SESSION["catatan"] = $_GET["catatan"];
       nm_limpa_str_form_vclaim_sep_surat_data_source($_SESSION["catatan"]);
   }
   ...
   $salva_iframe = false;
   if (isset($_SESSION['sc_session'][$script_case_init]['form_vclaim_sep_surat_data_source']['iframe_menu']))
   {
       $salva_iframe = $_SESSION['sc_session'][$script_case_init]['form_vclaim_sep_surat_data_source']['iframe_menu'];
       unset($_SESSION['sc_session'][$script_case_init]['form_vclaim_sep_surat_data_source']['iframe_menu']);
   }
   if (isset($nm_run_menu) && $nm_run_menu == 1)
   {
        ...
        $_SESSION['scriptcase']['sc_apl_menu_atual'] = "form_vclaim_sep_surat_data_source";
        $achou = false;
        if (isset($_SESSION['sc_session'][$script_case_init]))
        {
            foreach ($_SESSION['sc_session'][$script_case_init] as $nome_apl => $resto)
            {
                if ($nome_apl == 'form_vclaim_sep_surat_data_source' || $achou)
                {
        ...
        $_SESSION['sc_session'][$script_case_init]['form_vclaim_sep_surat_data_source']['iframe_menu'] = true;
   }
   else
   {
       $_SESSION['sc_session'][$script_case_init]['form_vclaim_sep_surat_data_source']['iframe_menu'] = $salva_iframe;
   }

   if (!isset($_SESSION['sc_session'][$script_case_init]['form_vclaim_sep_surat_data_source']['initialize']))
   {
       $_SESSION['sc_session'][$script_case_init]['form_vclaim_sep_surat_data_source']['initialize'] = true;
   }
   elseif (!isset($_SERVER['HTTP_REFERER']))
   {
       $_SESSION['sc_session'][$script_case_init]['form_vclaim_sep_surat_data_source']['initialize'] = false;
   }
   ...
   else
   {
       ...
       if ('form_vclaim_sep_surat_data_source' == $sReferer || 'form_vclaim_sep_surat_data_source_' == substr($sReferer, 0, 34))
       {
           $_SESSION['sc_session'][$script_case_init]['form_vclaim_sep_surat_data_source']['initialize'] = false;
       }
       else
   ...
   if (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'form_vclaim_sep_surat_data_source')
   {
       $_SESSION['sc_session'][$script_case_init]['form_vclaim_sep_surat_data_source']['sc_outra_jan'] = true;
        unset($_SESSION['scriptcase']['sc_outra_jan']);
   }
   $_SESSION['sc_session'][$script_case_init]['form_vclaim_sep_surat_data_source']['menu_desenv'] = false;   
   if (!defined("SC_ERROR_HANDLER"))
   {
       define("SC_ERROR_HANDLER", 1);
       include_once(dirname(__FILE__) . "/form_vclaim_sep_surat_data_source_erro.php");
   }
   if (!empty($nmgp_parms)) 
   { 
       ...
       while (!empty($todo[$ix]))
       {
            ...
            if (1 < sizeof($cadapar))
            {
                ...
                nm_limpa_str_form_vclaim_sep_surat_data_source($cadapar[1]);
       ...
       if (isset($tgl_sep)) 
       {
           $_SESSION['tgl_sep'] = $tgl_sep;
           nm_limpa_str_form_vclaim_sep_surat_data_source($_SESSION["tgl_sep"]);
       }
       if (isset($no_kartu)) 
       {
           $_SESSION['no_kartu'] = $no_kartu;
           nm_limpa_str_form_vclaim_sep_surat_data_source($_SESSION["no_kartu"]);
       }
       if (isset($jenis_peserta)) 
       {
           $_SESSION['jenis_peserta'] = $jenis_peserta;
           nm_limpa_str_form_vclaim_sep_surat_data_source($_SESSION["jenis_peserta"]);
       }
       if (isset($nama)) 
       {
       ...
       if (isset($jns_kelamin)) 
       {
           $_SESSION['jns_kelamin'] = $jns_kelamin;
           nm_limpa_str_form_vclaim_sep_surat_data_source($_SESSION["jns_kelamin"]);
       }
       if (isset($jns_layanan)) 
       {
           $_SESSION['jns_layanan'] = $jns_layanan;
           nm_limpa_str_form_vclaim_sep_surat_data_source($_SESSION["jns_layanan"]);
       }
       if (isset($poli_tujuan)) 
       {
           $_SESSION['poli_tujuan'] = $poli_tujuan;
           nm_limpa_str_form_vclaim_sep_surat_data_source($_SESSION["poli_tujuan"]);
       }
       if (isset($kelas_rawat)) 
       {
           $_SESSION['kelas_rawat'] = $kelas_rawat;
           nm_limpa_str_form_vclaim_sep_surat_data_source($_SESSION["kelas_rawat"]);
       }
       if (isset($asal_faskes)) 
       {
           $_SESSION['asal_faskes'] = $asal_faskes;
           nm_limpa_str_form_vclaim_sep_surat_data_source($_SESSION["asal_faskes"]);
       }
       if (isset($diagnosa)) 
       {
   ...
   $contr_form_vclaim_sep_surat_data_source = new form_vclaim_sep_surat_data_source_apl();
   $contr_form_vclaim_sep_surat_data_source->controle();
//
   function nm_limpa_str_form_vclaim_sep_surat_data_source(&$str)
   {
