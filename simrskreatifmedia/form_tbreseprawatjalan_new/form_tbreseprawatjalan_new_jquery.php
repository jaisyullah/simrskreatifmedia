...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_id_' + iSeqRow).bind('blur', function() { sc_form_tbreseprawatjalan_new_id__onblur(this, iSeqRow) })
                                 .bind('change', function() { sc_form_tbreseprawatjalan_new_id__onchange(this, iSeqRow) })
                                 .bind('focus', function() { sc_form_tbreseprawatjalan_new_id__onfocus(this, iSeqRow) });
  $('#id_sc_field_item_' + iSeqRow).bind('blur', function() { sc_form_tbreseprawatjalan_new_item__onblur(this, iSeqRow) })
                                   .bind('change', function() { sc_form_tbreseprawatjalan_new_item__onchange(this, iSeqRow) })
                                   .bind('focus', function() { sc_form_tbreseprawatjalan_new_item__onfocus(this, iSeqRow) });
  $('#id_sc_field_satuan_' + iSeqRow).bind('blur', function() { sc_form_tbreseprawatjalan_new_satuan__onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_form_tbreseprawatjalan_new_satuan__onchange(this, iSeqRow) })
                                     .bind('focus', function() { sc_form_tbreseprawatjalan_new_satuan__onfocus(this, iSeqRow) });
  $('#id_sc_field_jumlah_' + iSeqRow).bind('blur', function() { sc_form_tbreseprawatjalan_new_jumlah__onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_form_tbreseprawatjalan_new_jumlah__onchange(this, iSeqRow) })
                                     .bind('focus', function() { sc_form_tbreseprawatjalan_new_jumlah__onfocus(this, iSeqRow) });
  $('#id_sc_field_signa_' + iSeqRow).bind('blur', function() { sc_form_tbreseprawatjalan_new_signa__onblur(this, iSeqRow) })
                                    .bind('change', function() { sc_form_tbreseprawatjalan_new_signa__onchange(this, iSeqRow) })
                                    .bind('focus', function() { sc_form_tbreseprawatjalan_new_signa__onfocus(this, iSeqRow) });
  $('#id_sc_field_jenisaturanpakai_' + iSeqRow).bind('blur', function() { sc_form_tbreseprawatjalan_new_jenisaturanpakai__onblur(this, iSeqRow) })
                                               .bind('change', function() { sc_form_tbreseprawatjalan_new_jenisaturanpakai__onchange(this, iSeqRow) })
                                               .bind('focus', function() { sc_form_tbreseprawatjalan_new_jenisaturanpakai__onfocus(this, iSeqRow) });
  $('#id_sc_field_biaya_' + iSeqRow).bind('blur', function() { sc_form_tbreseprawatjalan_new_biaya__onblur(this, iSeqRow) })
                                    .bind('change', function() { sc_form_tbreseprawatjalan_new_biaya__onchange(this, iSeqRow) })
                                    .bind('focus', function() { sc_form_tbreseprawatjalan_new_biaya__onfocus(this, iSeqRow) });
  $('#id_sc_field_diskon_' + iSeqRow).bind('blur', function() { sc_form_tbreseprawatjalan_new_diskon__onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_form_tbreseprawatjalan_new_diskon__onchange(this, iSeqRow) })
                                     .bind('focus', function() { sc_form_tbreseprawatjalan_new_diskon__onfocus(this, iSeqRow) });
  $('#id_sc_field_retur_' + iSeqRow).bind('blur', function() { sc_form_tbreseprawatjalan_new_retur__onblur(this, iSeqRow) })
                                    .bind('change', function() { sc_form_tbreseprawatjalan_new_retur__onchange(this, iSeqRow) })
                                    .bind('focus', function() { sc_form_tbreseprawatjalan_new_retur__onfocus(this, iSeqRow) });
  $('#id_sc_field_id_tr_' + iSeqRow).bind('blur', function() { sc_form_tbreseprawatjalan_new_id_tr__onblur(this, iSeqRow) })
                                    .bind('change', function() { sc_form_tbreseprawatjalan_new_id_tr__onchange(this, iSeqRow) })
                                    .bind('focus', function() { sc_form_tbreseprawatjalan_new_id_tr__onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_form_tbreseprawatjalan_new_id__onblur(oThis, iSeqRow) {
  do_ajax_form_tbreseprawatjalan_new_validate_id_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_tbreseprawatjalan_new_id__onchange(oThis, iSeqRow) {
  nm_check_insert(iSeqRow);
}

function sc_form_tbreseprawatjalan_new_id__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_form_tbreseprawatjalan_new_item__onblur(oThis, iSeqRow) {
  do_ajax_form_tbreseprawatjalan_new_validate_item_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_tbreseprawatjalan_new_item__onchange(oThis, iSeqRow) {
  do_ajax_form_tbreseprawatjalan_new_refresh_item_(iSeqRow);
  nm_check_insert(iSeqRow);
}

function sc_form_tbreseprawatjalan_new_item__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_form_tbreseprawatjalan_new_satuan__onblur(oThis, iSeqRow) {
  do_ajax_form_tbreseprawatjalan_new_validate_satuan_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_tbreseprawatjalan_new_satuan__onchange(oThis, iSeqRow) {
  nm_check_insert(iSeqRow);
}

function sc_form_tbreseprawatjalan_new_satuan__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_form_tbreseprawatjalan_new_jumlah__onblur(oThis, iSeqRow) {
  do_ajax_form_tbreseprawatjalan_new_validate_jumlah_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_tbreseprawatjalan_new_jumlah__onchange(oThis, iSeqRow) {
  nm_check_insert(iSeqRow);
}

function sc_form_tbreseprawatjalan_new_jumlah__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_form_tbreseprawatjalan_new_signa__onblur(oThis, iSeqRow) {
  do_ajax_form_tbreseprawatjalan_new_validate_signa_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_tbreseprawatjalan_new_signa__onchange(oThis, iSeqRow) {
  nm_check_insert(iSeqRow);
}

function sc_form_tbreseprawatjalan_new_signa__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_form_tbreseprawatjalan_new_jenisaturanpakai__onblur(oThis, iSeqRow) {
  do_ajax_form_tbreseprawatjalan_new_validate_jenisaturanpakai_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_tbreseprawatjalan_new_jenisaturanpakai__onchange(oThis, iSeqRow) {
  nm_check_insert(iSeqRow);
}

function sc_form_tbreseprawatjalan_new_jenisaturanpakai__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_form_tbreseprawatjalan_new_biaya__onblur(oThis, iSeqRow) {
  do_ajax_form_tbreseprawatjalan_new_validate_biaya_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_tbreseprawatjalan_new_biaya__onchange(oThis, iSeqRow) {
  nm_check_insert(iSeqRow);
}

function sc_form_tbreseprawatjalan_new_biaya__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_form_tbreseprawatjalan_new_diskon__onblur(oThis, iSeqRow) {
  do_ajax_form_tbreseprawatjalan_new_validate_diskon_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_tbreseprawatjalan_new_diskon__onchange(oThis, iSeqRow) {
  nm_check_insert(iSeqRow);
}

function sc_form_tbreseprawatjalan_new_diskon__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_form_tbreseprawatjalan_new_retur__onblur(oThis, iSeqRow) {
  do_ajax_form_tbreseprawatjalan_new_validate_retur_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_tbreseprawatjalan_new_retur__onchange(oThis, iSeqRow) {
  nm_check_insert(iSeqRow);
}

function sc_form_tbreseprawatjalan_new_retur__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_form_tbreseprawatjalan_new_id_tr__onblur(oThis, iSeqRow) {
  do_ajax_form_tbreseprawatjalan_new_validate_id_tr_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_tbreseprawatjalan_new_id_tr__onchange(oThis, iSeqRow) {
  nm_check_insert(iSeqRow);
}

function sc_form_tbreseprawatjalan_new_id_tr__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}
...
function displayChange_field_signa_(row, status) {
	if ("on" == status) {
		if ("all" == row) {
			var fieldList = $(".css_signa___obj");
			for (var i = 0; i < fieldList.length; i++) {
				$($(fieldList[i]).attr("id")).select2("destroy");
			}
		}
		else {
			$("#id_sc_field_signa_" + row).select2("destroy");
		}
		scJQSelect2Add(row, "signa_");
	}
}
...
function scRecreateSelect2() {
	...
	displayChange_field_signa_("all", "on");
}
...
function scHidePage(pageNo) {
	$("#id_form_tbreseprawatjalan_new_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_trandate_" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_tbreseprawatjalan_new_validate_trandate_(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
function scJQDDCheckBoxAdd(iSeqRow, bForce) {
  scJQDDCheckBoxAdd_jenisaturanpakai_(iSeqRow, bForce);
} // scJQDDCheckBoxAdd

function scJQDDCheckBoxAdd_jenisaturanpakai_(iSeqRow, bForce) {
  if (bForce || null == sc_ddfield_closed["jenisaturanpakai_" + iSeqRow]) {
    sc_ddfield_closed["jenisaturanpakai_" + iSeqRow] = true;
  }
  if ($("#id_sc_field_jenisaturanpakai_" + iSeqRow).filter(":visible").length > 0 && sc_ddfield_closed["jenisaturanpakai_" + iSeqRow]) {
    sc_ddfield_closed["jenisaturanpakai_" + iSeqRow] = false;
    $("#id_sc_field_jenisaturanpakai_" + iSeqRow).dropdownchecklist({
      bgiframe: true,
...
} // scJQDDCheckBoxAdd_jenisaturanpakai_
...
function scJQSelect2Add(seqRow, specificField) {
  ...
  if (null == specificField || "signa_" == specificField) {
    scJQSelect2Add_signa_(seqRow);
  }
} // scJQSelect2Add
...
function scJQSelect2Add_signa_(seqRow) {
  var elemSelector = "all" == seqRow ? ".css_signa__obj" : "#id_sc_field_signa_" + seqRow;
  $(elemSelector).select2(
    {
      containerCssClass: 'css_signa__obj',
      dropdownCssClass: 'css_signa__obj',
      language: {
        noResults: function() {
          return "<?php echo $this->Ini->Nm_lang['lang_autocomp_notfound'] ?>";
        },
...
function scJQElementsAdd(iLine) {
  ...
  setTimeout(function () { if ('function' == typeof displayChange_field_signa_) { displayChange_field_signa_(iLine, "on"); } }, 150);
} // scJQElementsAdd
