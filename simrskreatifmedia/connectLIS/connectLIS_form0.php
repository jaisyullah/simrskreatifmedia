...
.sc-button-image.disabled img {
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['connectLIS']['embutida_pdf']))
 {
 ?>
...
<?php
include_once("connectLIS_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('connectLIS_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['connectLIS']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['connectLIS']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['connectLIS']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['connectLIS']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['connectLIS']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['connectLIS']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['connectLIS']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['connectLIS']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
?>
...
<?php
 include_once("connectLIS_js0.php");
?>
<script type="text/javascript"> 
...
<?php
$_SESSION['scriptcase']['error_span_title']['connectLIS'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['connectLIS'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
           if ($opcao_botoes != "novo") {
        $sCondStyle = ($this->nmgp_botoes['Disconnect'] == "on") ? '' : 'display: none;';
?>
       <?php echo nmButtonOutput($this->arr_buttons, "disconnect", "scBtnFn_Disconnect()", "scBtnFn_Disconnect()", "sc_Disconnect_top", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
...
<?php
  ...
  {
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['connectLIS']['where_filter']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['connectLIS']['empty_filter'] = true;
       }
  }
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_instrumentid_label" id="hidden_field_label_instrumentid" style="<?php echo $sStyleHidden_instrumentid; ?>"><span id="id_label_instrumentid"><?php echo $this->nm_new_label['instrumentid']; ?></span></TD>
    <TD class="scFormDataOdd css_instrumentid_line" id="hidden_field_data_instrumentid" style="<?php echo $sStyleHidden_instrumentid; ?>">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['connectLIS']['Lookup_instrumentid'][] = ''; ?>
 </select></span>
</span><?php  }?>
</TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_port_label" id="hidden_field_label_port" style="<?php echo $sStyleHidden_port; ?>"><span id="id_label_port"><?php echo $this->nm_new_label['port']; ?></span></TD>
    <TD class="scFormDataOdd css_port_line" id="hidden_field_data_port" style="<?php echo $sStyleHidden_port; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_baud_label" id="hidden_field_label_baud" style="<?php echo $sStyleHidden_baud; ?>"><span id="id_label_baud"><?php echo $this->nm_new_label['baud']; ?></span></TD>
    <TD class="scFormDataOdd css_baud_line" id="hidden_field_data_baud" style="<?php echo $sStyleHidden_baud; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_parity_label" id="hidden_field_label_parity" style="<?php echo $sStyleHidden_parity; ?>"><span id="id_label_parity"><?php echo $this->nm_new_label['parity']; ?></span></TD>
    <TD class="scFormDataOdd css_parity_line" id="hidden_field_data_parity" style="<?php echo $sStyleHidden_parity; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_stopbit_label" id="hidden_field_label_stopbit" style="<?php echo $sStyleHidden_stopbit; ?>"><span id="id_label_stopbit"><?php echo $this->nm_new_label['stopbit']; ?></span></TD>
    <TD class="scFormDataOdd css_stopbit_line" id="hidden_field_data_stopbit" style="<?php echo $sStyleHidden_stopbit; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_databit_label" id="hidden_field_label_databit" style="<?php echo $sStyleHidden_databit; ?>"><span id="id_label_databit"><?php echo $this->nm_new_label['databit']; ?></span></TD>
    <TD class="scFormDataOdd css_databit_line" id="hidden_field_data_databit" style="<?php echo $sStyleHidden_databit; ?>">
...
<?php
           if (($nm_apl_dependente != 1) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['connectLIS']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['connectLIS']['dashboard_info']['under_dashboard'])) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['connectLIS']['nm_run_menu']) || $_SESSION['sc_session'][$this->Ini->sc_page]['connectLIS']['nm_run_menu'] != 1))) {
...
<?php
           if (($nm_apl_dependente == 1) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['connectLIS']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['connectLIS']['dashboard_info']['under_dashboard']))) {
        $sCondStyle = ($this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['connectLIS']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['connectLIS']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("connectLIS");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("connectLIS");
 parent.scAjaxDetailHeight("connectLIS", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['connectLIS']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
