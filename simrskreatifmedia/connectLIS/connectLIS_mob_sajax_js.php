  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_connectLIS_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_connectLIS_mob_form();
	}

  // ---------- Validate instrumentid
  function do_ajax_connectLIS_mob_validate_instrumentid()
  {
    var nomeCampo_instrumentid = "instrumentid";
    var var_instrumentid = scAjaxGetFieldSelect(nomeCampo_instrumentid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_connectLIS_mob_validate_instrumentid(var_instrumentid, var_script_case_init, do_ajax_connectLIS_mob_validate_instrumentid_cb);
  } // do_ajax_connectLIS_mob_validate_instrumentid

  function do_ajax_connectLIS_mob_validate_instrumentid_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "instrumentid";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_connectLIS_mob_validate_instrumentid_cb

  // ---------- Validate port
  function do_ajax_connectLIS_mob_validate_port()
  {
    var nomeCampo_port = "port";
    var var_port = scAjaxGetFieldText(nomeCampo_port);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_connectLIS_mob_validate_port(var_port, var_script_case_init, do_ajax_connectLIS_mob_validate_port_cb);
  } // do_ajax_connectLIS_mob_validate_port

  function do_ajax_connectLIS_mob_validate_port_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "port";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_connectLIS_mob_validate_port_cb

  // ---------- Validate baud
  function do_ajax_connectLIS_mob_validate_baud()
  {
    var nomeCampo_baud = "baud";
    var var_baud = scAjaxGetFieldText(nomeCampo_baud);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_connectLIS_mob_validate_baud(var_baud, var_script_case_init, do_ajax_connectLIS_mob_validate_baud_cb);
  } // do_ajax_connectLIS_mob_validate_baud

  function do_ajax_connectLIS_mob_validate_baud_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "baud";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_connectLIS_mob_validate_baud_cb

  // ---------- Validate parity
  function do_ajax_connectLIS_mob_validate_parity()
  {
    var nomeCampo_parity = "parity";
    var var_parity = scAjaxGetFieldText(nomeCampo_parity);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_connectLIS_mob_validate_parity(var_parity, var_script_case_init, do_ajax_connectLIS_mob_validate_parity_cb);
  } // do_ajax_connectLIS_mob_validate_parity

  function do_ajax_connectLIS_mob_validate_parity_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "parity";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_connectLIS_mob_validate_parity_cb

  // ---------- Validate stopbit
  function do_ajax_connectLIS_mob_validate_stopbit()
  {
    var nomeCampo_stopbit = "stopbit";
    var var_stopbit = scAjaxGetFieldText(nomeCampo_stopbit);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_connectLIS_mob_validate_stopbit(var_stopbit, var_script_case_init, do_ajax_connectLIS_mob_validate_stopbit_cb);
  } // do_ajax_connectLIS_mob_validate_stopbit

  function do_ajax_connectLIS_mob_validate_stopbit_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "stopbit";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_connectLIS_mob_validate_stopbit_cb

  // ---------- Validate databit
  function do_ajax_connectLIS_mob_validate_databit()
  {
    var nomeCampo_databit = "databit";
    var var_databit = scAjaxGetFieldText(nomeCampo_databit);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_connectLIS_mob_validate_databit(var_databit, var_script_case_init, do_ajax_connectLIS_mob_validate_databit_cb);
  } // do_ajax_connectLIS_mob_validate_databit

  function do_ajax_connectLIS_mob_validate_databit_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "databit";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_connectLIS_mob_validate_databit_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_connectLIS_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_connectLIS_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_instrumentid = scAjaxGetFieldSelect("instrumentid");
    var var_port = scAjaxGetFieldText("port");
    var var_baud = scAjaxGetFieldText("baud");
    var var_parity = scAjaxGetFieldText("parity");
    var var_stopbit = scAjaxGetFieldText("stopbit");
    var var_databit = scAjaxGetFieldText("databit");
    ...
    scAjaxProcOn();
    x_ajax_connectLIS_mob_submit_form(var_instrumentid, var_port, var_baud, var_parity, var_stopbit, var_databit, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_connectLIS_mob_submit_form_cb);
  } // do_ajax_connectLIS_mob_submit_form

  function do_ajax_connectLIS_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_connectLIS_mob_submit_form_cb_after_alert);
  } // do_ajax_connectLIS_mob_submit_form_cb
  function do_ajax_connectLIS_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_connectLIS_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_connectLIS_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_connectLIS_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['connectLIS_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_connectLIS_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_connectLIS_mob_navigate_form_cb_after_alert);
  } // do_ajax_connectLIS_mob_navigate_form_cb
  function do_ajax_connectLIS_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_connectLIS_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_connectLIS_mob_navigate_form_cb_after_alert
  function sc_hide_connectLIS_mob_form()
  {
  ...
  ajax_field_list[0] = "instrumentid";
  ajax_field_list[1] = "port";
  ajax_field_list[2] = "baud";
  ajax_field_list[3] = "parity";
  ajax_field_list[4] = "stopbit";
  ajax_field_list[5] = "databit";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "instrumentid": {"label": "Nama Instrument", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "port": {"label": "Port", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "baud": {"label": "Baud", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "parity": {"label": "Parity", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "stopbit": {"label": "Stop Bit", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "databit": {"label": "Data Bit", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  ajax_field_mult["instrumentid"][1] = "instrumentid";
  ajax_field_mult["port"][1] = "port";
  ajax_field_mult["baud"][1] = "baud";
  ajax_field_mult["parity"][1] = "parity";
  ajax_field_mult["stopbit"][1] = "stopbit";
  ajax_field_mult["databit"][1] = "databit";

  var ajax_field_id = {
    "instrumentid": new Array("hidden_field_label_instrumentid", "hidden_field_data_instrumentid"),
    "port": new Array("hidden_field_label_port", "hidden_field_data_port"),
    "baud": new Array("hidden_field_label_baud", "hidden_field_data_baud"),
    "parity": new Array("hidden_field_label_parity", "hidden_field_data_parity"),
    "stopbit": new Array("hidden_field_label_stopbit", "hidden_field_data_stopbit"),
    "databit": new Array("hidden_field_label_databit", "hidden_field_data_databit")
  };
