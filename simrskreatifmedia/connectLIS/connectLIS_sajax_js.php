  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_connectLIS" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_connectLIS_form();
	}

  // ---------- Validate instrumentid
  function do_ajax_connectLIS_validate_instrumentid()
  {
    var nomeCampo_instrumentid = "instrumentid";
    var var_instrumentid = scAjaxGetFieldSelect(nomeCampo_instrumentid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_connectLIS_validate_instrumentid(var_instrumentid, var_script_case_init, do_ajax_connectLIS_validate_instrumentid_cb);
  } // do_ajax_connectLIS_validate_instrumentid

  function do_ajax_connectLIS_validate_instrumentid_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_connectLIS_validate_instrumentid_cb

  // ---------- Validate port
  function do_ajax_connectLIS_validate_port()
  {
    var nomeCampo_port = "port";
    var var_port = scAjaxGetFieldText(nomeCampo_port);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_connectLIS_validate_port(var_port, var_script_case_init, do_ajax_connectLIS_validate_port_cb);
  } // do_ajax_connectLIS_validate_port

  function do_ajax_connectLIS_validate_port_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "port";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_connectLIS_validate_port_cb

  // ---------- Validate baud
  function do_ajax_connectLIS_validate_baud()
  {
    var nomeCampo_baud = "baud";
    var var_baud = scAjaxGetFieldText(nomeCampo_baud);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_connectLIS_validate_baud(var_baud, var_script_case_init, do_ajax_connectLIS_validate_baud_cb);
  } // do_ajax_connectLIS_validate_baud

  function do_ajax_connectLIS_validate_baud_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "baud";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_connectLIS_validate_baud_cb

  // ---------- Validate parity
  function do_ajax_connectLIS_validate_parity()
  {
    var nomeCampo_parity = "parity";
    var var_parity = scAjaxGetFieldText(nomeCampo_parity);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_connectLIS_validate_parity(var_parity, var_script_case_init, do_ajax_connectLIS_validate_parity_cb);
  } // do_ajax_connectLIS_validate_parity

  function do_ajax_connectLIS_validate_parity_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "parity";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_connectLIS_validate_parity_cb

  // ---------- Validate stopbit
  function do_ajax_connectLIS_validate_stopbit()
  {
    var nomeCampo_stopbit = "stopbit";
    var var_stopbit = scAjaxGetFieldText(nomeCampo_stopbit);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_connectLIS_validate_stopbit(var_stopbit, var_script_case_init, do_ajax_connectLIS_validate_stopbit_cb);
  } // do_ajax_connectLIS_validate_stopbit

  function do_ajax_connectLIS_validate_stopbit_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "stopbit";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_connectLIS_validate_stopbit_cb

  // ---------- Validate databit
  function do_ajax_connectLIS_validate_databit()
  {
    var nomeCampo_databit = "databit";
    var var_databit = scAjaxGetFieldText(nomeCampo_databit);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_connectLIS_validate_databit(var_databit, var_script_case_init, do_ajax_connectLIS_validate_databit_cb);
  } // do_ajax_connectLIS_validate_databit

  function do_ajax_connectLIS_validate_databit_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "databit";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_connectLIS_validate_databit_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_connectLIS_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_connectLIS_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_connectLIS_submit_form(var_instrumentid, var_port, var_baud, var_parity, var_stopbit, var_databit, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_connectLIS_submit_form_cb);
  } // do_ajax_connectLIS_submit_form

  function do_ajax_connectLIS_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_connectLIS_submit_form_cb_after_alert);
  } // do_ajax_connectLIS_submit_form_cb
  function do_ajax_connectLIS_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_connectLIS_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_connectLIS_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_connectLIS_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['connectLIS']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_connectLIS_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_connectLIS_navigate_form_cb_after_alert);
  } // do_ajax_connectLIS_navigate_form_cb
  function do_ajax_connectLIS_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_connectLIS_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_connectLIS_navigate_form_cb_after_alert
  function sc_hide_connectLIS_form()
  {
