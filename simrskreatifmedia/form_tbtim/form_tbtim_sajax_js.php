  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbtim" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbtim_form();
	}

  // ---------- Validate posisi_
  function do_ajax_form_tbtim_validate_posisi_(iNumLinha)
  {
    var nomeCampo_posisi_ = "posisi_" + iNumLinha;
    var var_posisi_ = scAjaxGetFieldSelect(nomeCampo_posisi_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtim_validate_posisi_(var_posisi_, iNumLinha, var_script_case_init, do_ajax_form_tbtim_validate_posisi__cb);
  } // do_ajax_form_tbtim_validate_posisi_

  function do_ajax_form_tbtim_validate_posisi__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "posisi_" + iLineNumber;
    }
    else
    {
      sFieldValid = "posisi_";
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "posisi_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "posisi_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtim_validate_posisi__cb

  // ---------- Validate code_
  function do_ajax_form_tbtim_validate_code_(iNumLinha)
  {
    var nomeCampo_code_ = "code_" + iNumLinha;
    var var_code_ = scAjaxGetFieldSelect(nomeCampo_code_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtim_validate_code_(var_code_, iNumLinha, var_script_case_init, do_ajax_form_tbtim_validate_code__cb);
  } // do_ajax_form_tbtim_validate_code_

  function do_ajax_form_tbtim_validate_code__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "code_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "code_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtim_validate_code__cb

  // ---------- Validate actcode_
  function do_ajax_form_tbtim_validate_actcode_(iNumLinha)
  {
    var nomeCampo_actcode_ = "actcode_" + iNumLinha;
    var var_actcode_ = scAjaxGetFieldSelect(nomeCampo_actcode_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtim_validate_actcode_(var_actcode_, iNumLinha, var_script_case_init, do_ajax_form_tbtim_validate_actcode__cb);
  } // do_ajax_form_tbtim_validate_actcode_

  function do_ajax_form_tbtim_validate_actcode__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "actcode_" + iLineNumber;
    }
    else
    {
      sFieldValid = "actcode_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "actcode_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "actcode_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtim_validate_actcode__cb

  // ---------- Validate penolong_
  function do_ajax_form_tbtim_validate_penolong_(iNumLinha)
  {
    var nomeCampo_penolong_ = "penolong_" + iNumLinha;
    var var_penolong_ = scAjaxGetFieldCheckbox(nomeCampo_penolong_, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtim_validate_penolong_(var_penolong_, iNumLinha, var_script_case_init, do_ajax_form_tbtim_validate_penolong__cb);
  } // do_ajax_form_tbtim_validate_penolong_

  function do_ajax_form_tbtim_validate_penolong__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "penolong_" + iLineNumber;
    }
    else
    {
      sFieldValid = "penolong_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "penolong_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "penolong_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtim_validate_penolong__cb

  // ---------- Validate disc_
  function do_ajax_form_tbtim_validate_disc_(iNumLinha)
  {
    var nomeCampo_disc_ = "disc_" + iNumLinha;
    var var_disc_ = scAjaxGetFieldText(nomeCampo_disc_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtim_validate_disc_(var_disc_, iNumLinha, var_script_case_init, do_ajax_form_tbtim_validate_disc__cb);
  } // do_ajax_form_tbtim_validate_disc_

  function do_ajax_form_tbtim_validate_disc__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtim_validate_disc__cb

  // ---------- Validate id_
  function do_ajax_form_tbtim_validate_id_(iNumLinha)
  {
    var nomeCampo_id_ = "id_" + iNumLinha;
    var var_id_ = scAjaxGetFieldHidden(nomeCampo_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtim_validate_id_(var_id_, iNumLinha, var_script_case_init, do_ajax_form_tbtim_validate_id__cb);
  } // do_ajax_form_tbtim_validate_id_

  function do_ajax_form_tbtim_validate_id__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtim_validate_id__cb

  // ---------- Validate kelas_
  function do_ajax_form_tbtim_validate_kelas_(iNumLinha)
  {
    var nomeCampo_kelas_ = "kelas_" + iNumLinha;
    var var_kelas_ = scAjaxGetFieldSelect(nomeCampo_kelas_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtim_validate_kelas_(var_kelas_, iNumLinha, var_script_case_init, do_ajax_form_tbtim_validate_kelas__cb);
  } // do_ajax_form_tbtim_validate_kelas_

  function do_ajax_form_tbtim_validate_kelas__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtim_validate_kelas__cb

  // ---------- Refresh code_
  function do_ajax_form_tbtim_refresh_code_(iSeqForm)
  {
    var var_code_ = scAjaxGetFieldSelect("code_" + iSeqForm);
    var var_nmgp_refresh_row = iSeqForm;
    var var_nmgp_refresh_fields = "actcode_";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tbtim_refresh_code_(var_code_, var_nmgp_refresh_row, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_tbtim_refresh_code__cb);
  } // do_ajax_form_tbtim_refresh_code_

  function do_ajax_form_tbtim_refresh_code__cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtim_refresh_code__cb

  // ---------- Event onchange posisi_
  function do_ajax_form_tbtim_event_posisi__onchange(iSeqForm)
  {
    var var_posisi_ = scAjaxGetFieldSelect("posisi_" + iSeqForm);
    var var_penolong_ = scAjaxGetFieldCheckbox("penolong_" + iSeqForm, ";");
    var var_script_case_init = document.F2.script_case_init.value;
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_tbtim_event_posisi__onchange(var_posisi_, var_penolong_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_tbtim_event_posisi__onchange_cb);
  } // do_ajax_form_tbtim_event_posisi__onchange

  function do_ajax_form_tbtim_event_posisi__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_tbtim_event_posisi__onchange_cb_after_alert);
  } // do_ajax_form_tbtim_event_posisi__onchange_cb
  function do_ajax_form_tbtim_event_posisi__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_tbtim_event_posisi__onchange_cb_after_alert

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_tbtim_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_tbtim_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tbtim_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_tbtim_add_new_line_cb);
  } // do_ajax_form_tbtim_add_new_line

  function do_ajax_form_tbtim_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_tbtim_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_tbtim_backup_line(iNumLinha)
  {
    var var_id_ = scAjaxGetFieldHidden("id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtim_backup_line(var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_tbtim_backup_line_cb);
  } // do_ajax_form_tbtim_backup_line

  function do_ajax_form_tbtim_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_tbtim_backup_line_cb

  function do_ajax_form_tbtim_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_tbtim_cancel_insert

  function do_ajax_form_tbtim_cancel_update(iSeqVert)
  {
    do_ajax_form_tbtim_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_tbtim_cancel_update

  function do_ajax_form_tbtim_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_tbtim_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_tbtim_table_refresh()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tbtim_table_refresh(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbtim_table_refresh_cb);
  } //  do_ajax_form_tbtim_table_refresh

  function do_ajax_form_tbtim_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_tbtim_table_refresh_cb_after_alert);
  } // do_ajax_form_tbtim_table_refresh_cb
  function do_ajax_form_tbtim_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_tbtim_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_tbtim_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_tbtim_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    sc_num_ult_line = iNumLinha;
    sc_num_ult_tr   = indexTR;
    scAjaxHideMessage();
    var var_posisi_ = scAjaxGetFieldSelect("posisi_" + iNumLinha);
    var var_code_ = scAjaxGetFieldSelect("code_" + iNumLinha);
    var var_actcode_ = scAjaxGetFieldSelect("actcode_" + iNumLinha);
    var var_penolong_ = scAjaxGetFieldCheckbox("penolong_" + iNumLinha, ";");
...
?>
    x_ajax_form_tbtim_submit_form(var_posisi_, var_code_, var_actcode_, var_penolong_, var_disc_, var_id_, var_kelas_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbtim_submit_form_cb);
  } // do_ajax_form_tbtim_submit_form

  function do_ajax_form_tbtim_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("posisi_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("code_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("actcode_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("penolong_" + sc_num_ult_line);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_tbtim_submit_form_cb_after_alert);
  } // do_ajax_form_tbtim_submit_form_cb
  function do_ajax_form_tbtim_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbtim_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tbtim_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_tbtim_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("posisi_" + iNavForm);
      scAjaxHideErrorDisplay("code_" + iNavForm);
      scAjaxHideErrorDisplay("actcode_" + iNavForm);
      scAjaxHideErrorDisplay("penolong_" + iNavForm);
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tbtim_navigate_form(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbtim_navigate_form_cb);
  } // do_ajax_form_tbtim_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtim']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbtim_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbtim_navigate_form_cb_after_alert);
  } // do_ajax_form_tbtim_navigate_form_cb
  function do_ajax_form_tbtim_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_tbtim_navigate_form_cb_after_alert
  function sc_hide_form_tbtim_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "posisi_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "code_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "actcode_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "penolong_" + iNumLinha;
    iTotCampos++;
    ...
    iTotCampos++;
    ajax_error_list["posisi_" + iNumLinha] = {"label": "Posisi<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["code_" + iNumLinha] = {"label": "Nama<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["actcode_" + iNumLinha] = {"label": "Tindakan<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["penolong_" + iNumLinha] = {"label": "Penolong ?<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_field_mult["posisi_"][iNumLinha] = "posisi_" + iNumLinha;
    ajax_field_mult["code_"][iNumLinha] = "code_" + iNumLinha;
    ajax_field_mult["actcode_"][iNumLinha] = "actcode_" + iNumLinha;
    ajax_field_mult["penolong_"][iNumLinha] = "penolong_" + iNumLinha;
    ...
    ajax_field_id["posisi_" + iNumLinha] = new Array("hidden_field_label_posisi_", "hidden_field_data_posisi_" + iNumLinha);
    ajax_field_id["code_" + iNumLinha] = new Array("hidden_field_label_code_", "hidden_field_data_code_" + iNumLinha);
    ajax_field_id["actcode_" + iNumLinha] = new Array("hidden_field_label_actcode_", "hidden_field_data_actcode_" + iNumLinha);
    ajax_field_id["penolong_" + iNumLinha] = new Array("hidden_field_label_penolong_", "hidden_field_data_penolong_" + iNumLinha);
    ajax_field_id["disc_" + iNumLinha] = new Array("hidden_field_label_disc_", "hidden_field_data_disc_" + iNumLinha);
    ajax_error_count["posisi_" + iNumLinha] = "off";
    ajax_error_count["code_" + iNumLinha] = "off";
    ajax_error_count["actcode_" + iNumLinha] = "off";
    ajax_error_count["penolong_" + iNumLinha] = "off";
...
{
?>
    ajax_read_only["posisi_" + iNumLinha] = "off";
    ajax_read_only["code_" + iNumLinha] = "off";
    ajax_read_only["actcode_" + iNumLinha] = "off";
    ajax_read_only["penolong_" + iNumLinha] = "off";
...
{
?>
    ajax_read_only["posisi_" + iNumLinha] = "on";
    ajax_read_only["code_" + iNumLinha] = "on";
    ajax_read_only["actcode_" + iNumLinha] = "on";
    ajax_read_only["penolong_" + iNumLinha] = "on";
...
?>
  ...
  {
    ajax_error_list["posisi_" + iNumLinha] = null;
    ajax_error_list["code_" + iNumLinha] = null;
    ajax_error_list["actcode_" + iNumLinha] = null;
    ajax_error_list["penolong_" + iNumLinha] = null;
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["posisi_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["posisi_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["posisi_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["posisi_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["posisi_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["code_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["code_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["code_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["code_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["code_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["actcode_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["actcode_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["actcode_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["actcode_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["actcode_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["penolong_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["penolong_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["penolong_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["penolong_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["penolong_" + iNumLinha]["onfocus"] = new Array();
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['posisi_'])) ? $this->nmgp_cmp_readonly['posisi_'] : 'off';
?>
    scAjaxFieldRead("posisi_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['code_'])) ? $this->nmgp_cmp_readonly['code_'] : 'off';
?>
    scAjaxFieldRead("code_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['actcode_'])) ? $this->nmgp_cmp_readonly['actcode_'] : 'off';
?>
    scAjaxFieldRead("actcode_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['penolong_'])) ? $this->nmgp_cmp_readonly['penolong_'] : 'off';
?>
    scAjaxFieldRead("penolong_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
?>
  ...
  {
    scAjaxFieldRead("posisi_" + iSeq, "on");
    scAjaxFieldRead("code_" + iSeq, "on");
    scAjaxFieldRead("actcode_" + iSeq, "on");
    scAjaxFieldRead("penolong_" + iSeq, "on");
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["posisi_" + iRow] || "on" == ajax_error_count["code_" + iRow] || "on" == ajax_error_count["actcode_" + iRow] || "on" == ajax_error_count["penolong_" + iRow] || "on" == ajax_error_count["disc_" + iRow] || "on" == ajax_error_count["id_" + iRow] || "on" == ajax_error_count["kelas_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_posisi_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_code_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_actcode_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_penolong_" + iRow).addClass("scFormErrorLine");
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["posisi_" + iRow] && "off" == ajax_error_count["code_" + iRow] && "off" == ajax_error_count["actcode_" + iRow] && "off" == ajax_error_count["penolong_" + iRow] && "off" == ajax_error_count["disc_" + iRow] && "off" == ajax_error_count["id_" + iRow] && "off" == ajax_error_count["kelas_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["posisi_" + iRow] = "off";
        ajax_error_count["code_" + iRow] = "off";
        ajax_error_count["actcode_" + iRow] = "off";
        ajax_error_count["penolong_" + iRow] = "off";
      ...
      $("#hidden_field_data_posisi_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_code_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_actcode_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_penolong_" + iRow).removeClass("scFormErrorLine");
