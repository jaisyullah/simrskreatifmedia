  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbtim_inline" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbtim_inline_form();
	}

  // ---------- Validate posisi_
  function do_ajax_form_tbtim_inline_validate_posisi_()
  {
    var nomeCampo_posisi_ = "posisi_";
    var var_posisi_ = scAjaxGetFieldSelect(nomeCampo_posisi_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtim_inline_validate_posisi_(var_posisi_, var_script_case_init, do_ajax_form_tbtim_inline_validate_posisi__cb);
  } // do_ajax_form_tbtim_inline_validate_posisi_

  function do_ajax_form_tbtim_inline_validate_posisi__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtim_inline_validate_posisi__cb

  // ---------- Validate code_
  function do_ajax_form_tbtim_inline_validate_code_()
  {
    var nomeCampo_code_ = "code_";
    var var_code_ = scAjaxGetFieldSelect(nomeCampo_code_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtim_inline_validate_code_(var_code_, var_script_case_init, do_ajax_form_tbtim_inline_validate_code__cb);
  } // do_ajax_form_tbtim_inline_validate_code_

  function do_ajax_form_tbtim_inline_validate_code__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "code_";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtim_inline_validate_code__cb

  // ---------- Validate actcode_
  function do_ajax_form_tbtim_inline_validate_actcode_()
  {
    var nomeCampo_actcode_ = "actcode_";
    var var_actcode_ = scAjaxGetFieldSelect(nomeCampo_actcode_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtim_inline_validate_actcode_(var_actcode_, var_script_case_init, do_ajax_form_tbtim_inline_validate_actcode__cb);
  } // do_ajax_form_tbtim_inline_validate_actcode_

  function do_ajax_form_tbtim_inline_validate_actcode__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtim_inline_validate_actcode__cb

  // ---------- Validate penolong_
  function do_ajax_form_tbtim_inline_validate_penolong_()
  {
    var nomeCampo_penolong_ = "penolong_";
    var var_penolong_ = scAjaxGetFieldCheckbox(nomeCampo_penolong_, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtim_inline_validate_penolong_(var_penolong_, var_script_case_init, do_ajax_form_tbtim_inline_validate_penolong__cb);
  } // do_ajax_form_tbtim_inline_validate_penolong_

  function do_ajax_form_tbtim_inline_validate_penolong__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtim_inline_validate_penolong__cb

  // ---------- Validate disc_
  function do_ajax_form_tbtim_inline_validate_disc_()
  {
    var nomeCampo_disc_ = "disc_";
    var var_disc_ = scAjaxGetFieldText(nomeCampo_disc_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtim_inline_validate_disc_(var_disc_, var_script_case_init, do_ajax_form_tbtim_inline_validate_disc__cb);
  } // do_ajax_form_tbtim_inline_validate_disc_

  function do_ajax_form_tbtim_inline_validate_disc__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "disc_";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtim_inline_validate_disc__cb

  // ---------- Validate id_
  function do_ajax_form_tbtim_inline_validate_id_()
  {
    var nomeCampo_id_ = "id_";
    var var_id_ = scAjaxGetFieldHidden(nomeCampo_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtim_inline_validate_id_(var_id_, var_script_case_init, do_ajax_form_tbtim_inline_validate_id__cb);
  } // do_ajax_form_tbtim_inline_validate_id_

  function do_ajax_form_tbtim_inline_validate_id__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id_";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtim_inline_validate_id__cb

  // ---------- Validate kelas_
  function do_ajax_form_tbtim_inline_validate_kelas_()
  {
    var nomeCampo_kelas_ = "kelas_";
    var var_kelas_ = scAjaxGetFieldSelect(nomeCampo_kelas_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtim_inline_validate_kelas_(var_kelas_, var_script_case_init, do_ajax_form_tbtim_inline_validate_kelas__cb);
  } // do_ajax_form_tbtim_inline_validate_kelas_

  function do_ajax_form_tbtim_inline_validate_kelas__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "kelas_";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtim_inline_validate_kelas__cb

  // ---------- Refresh code_
  function do_ajax_form_tbtim_inline_refresh_code_()
  {
    var var_code_ = scAjaxGetFieldSelect("code_");
    var var_nmgp_refresh_fields = "actcode_";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tbtim_inline_refresh_code_(var_code_, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_tbtim_inline_refresh_code__cb);
  } // do_ajax_form_tbtim_inline_refresh_code_

  function do_ajax_form_tbtim_inline_refresh_code__cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtim_inline_refresh_code__cb

  // ---------- Event onchange posisi_
  function do_ajax_form_tbtim_inline_event_posisi__onchange()
  {
    var var_posisi_ = scAjaxGetFieldSelect("posisi_");
    var var_penolong_ = scAjaxGetFieldCheckbox("penolong_", ";");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tbtim_inline_event_posisi__onchange(var_posisi_, var_penolong_, var_script_case_init, do_ajax_form_tbtim_inline_event_posisi__onchange_cb);
  } // do_ajax_form_tbtim_inline_event_posisi__onchange

  function do_ajax_form_tbtim_inline_event_posisi__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "posisi_";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_tbtim_inline_event_posisi__onchange_cb_after_alert);
  } // do_ajax_form_tbtim_inline_event_posisi__onchange_cb
  function do_ajax_form_tbtim_inline_event_posisi__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_tbtim_inline_event_posisi__onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tbtim_inline_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tbtim_inline_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_posisi_ = scAjaxGetFieldSelect("posisi_");
    var var_code_ = scAjaxGetFieldSelect("code_");
    var var_actcode_ = scAjaxGetFieldSelect("actcode_");
    var var_penolong_ = scAjaxGetFieldCheckbox("penolong_", ";");
    ...
    scAjaxProcOn();
    x_ajax_form_tbtim_inline_submit_form(var_posisi_, var_code_, var_actcode_, var_penolong_, var_disc_, var_id_, var_kelas_, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbtim_inline_submit_form_cb);
  } // do_ajax_form_tbtim_inline_submit_form

  function do_ajax_form_tbtim_inline_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("posisi_");
      scAjaxHideErrorDisplay("code_");
      scAjaxHideErrorDisplay("actcode_");
      scAjaxHideErrorDisplay("penolong_");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tbtim_inline_submit_form_cb_after_alert);
  } // do_ajax_form_tbtim_inline_submit_form_cb
  function do_ajax_form_tbtim_inline_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbtim_inline_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tbtim_inline_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tbtim_inline_navigate_form(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbtim_inline_navigate_form_cb);
  } // do_ajax_form_tbtim_inline_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtim_inline']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbtim_inline_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbtim_inline_navigate_form_cb_after_alert);
  } // do_ajax_form_tbtim_inline_navigate_form_cb
  function do_ajax_form_tbtim_inline_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_tbtim_inline_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_tbtim_inline_navigate_form_cb_after_alert
  function sc_hide_form_tbtim_inline_form()
  {
  ...
  ajax_field_list[0] = "posisi_";
  ajax_field_list[1] = "code_";
  ajax_field_list[2] = "actcode_";
  ajax_field_list[3] = "penolong_";
  ajax_field_list[4] = "disc_";
  ajax_field_list[5] = "id_";
  ajax_field_list[6] = "kelas_";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "posisi_": {"label": "Posisi", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "code_": {"label": "Nama", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "actcode_": {"label": "Tindakan", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "penolong_": {"label": "Penolong ?", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  ajax_field_mult["posisi_"][1] = "posisi_";
  ajax_field_mult["code_"][1] = "code_";
  ajax_field_mult["actcode_"][1] = "actcode_";
  ajax_field_mult["penolong_"][1] = "penolong_";
  ajax_field_mult["disc_"][1] = "disc_";
  ajax_field_mult["id_"][1] = "id_";
  ajax_field_mult["kelas_"][1] = "kelas_";

  var ajax_field_id = {
    "posisi_": new Array("hidden_field_label_posisi_", "hidden_field_data_posisi_"),
    "code_": new Array("hidden_field_label_code_", "hidden_field_data_code_"),
    "actcode_": new Array("hidden_field_label_actcode_", "hidden_field_data_actcode_"),
    "penolong_": new Array("hidden_field_label_penolong_", "hidden_field_data_penolong_"),
