<?php
@session_start() ;
$_SESSION['scriptcase']['grid_opname_gizi']['sc_process_barr'] = true;
require_once('../grid_opname_gizi/index.php');
unset($_SESSION['scriptcase']['grid_opname_gizi']['sc_process_barr']);
$ExportCtrl = new grid_opname_gizi_export_control;
$ExportCtrl->Export_barr();

class grid_opname_gizi_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - opname_gizi :: Excel</TITLE>
