...
class grid_opname_gizi_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_opname_gizi']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_opname_gizi_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_opname_gizi_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_opname_gizi_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_opnamecode')
      {
          $opnamecode = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_opnamecode($opnamecode);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function lookup_ajax_opnamecode($opnamecode)
   {
      $opnamecode = substr($this->Db->qstr($opnamecode), 1, -1);
            $opnamecode_look = substr($this->Db->qstr($opnamecode), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct opnamecode from " . $this->Ini->nm_tabela . " where  opnamecode like '%" . $opnamecode . "%' order by opnamecode"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_opname_gizi']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_opname_gizi']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_opname_gizi']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_opname_gizi']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_opname_gizi']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_opname_gizi']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_opname_gizi']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_opname_gizi']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_opname_gizi']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_opname_gizi']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_opname_gizi']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_opname_gizi']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_opname_gizi']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_opname_gizi']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_opname_gizi']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_opname_gizi']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_opname_gizi']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - opname_gizi</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_opname_gizi/grid_opname_gizi_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_opname_gizi_ajax_search.js"></script>
 <script type="text/javascript" src="grid_opname_gizi_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_opname_gizi_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_opname_gizi']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_opname_gizi']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_opnamecode_cond#NMF#' + search_get_sel_txt('SC_opnamecode_cond') + '@NMF@';
  str_out += 'SC_opnamecode#NMF#' + search_get_text('SC_opnamecode') + '@NMF@';
  str_out += 'id_ac_opnamecode#NMF#' + search_get_text('id_ac_opnamecode') + '@NMF@';
   ...
   $("#id_ac_opnamecode").autocomplete({
     ...
     $.ajax({
       ...
       data: {
          ...
          nmgp_parms: "NM_ajax_opcao?#?autocomp_opnamecode",
          max_itens: "10",
          cod_desc: "N",
     ...
     select: function (event, ui) {
       $("#SC_opnamecode").val(ui.item.value);
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_opname_gizi']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div class="scFilterHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFilterHeaderFont" style="float: left; text-transform: uppercase;"><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - opname_gizi</div>
...
<?php
   ...
   function monta_form()
   {
      global 
             ...
             $opnamecode_cond, $opnamecode, $opnamecode_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_opname_gizi']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_opname_gizi']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_opname_gizi']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_opname_gizi']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $keterangan = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_opname_gizi']['campos_busca']['keterangan']; 
          $keterangan_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_opname_gizi']['campos_busca']['keterangan_cond']; 
          $id = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_opname_gizi']['campos_busca']['id']; 
          $id_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_opname_gizi']['campos_busca']['id_cond']; 
          $opnamecode = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_opname_gizi']['campos_busca']['opnamecode']; 
          $opnamecode_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_opname_gizi']['campos_busca']['opnamecode_cond']; 
          $date_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_opname_gizi']['campos_busca']['date_dia']; 
          $date_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_opname_gizi']['campos_busca']['date_mes']; 
          $date_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_opname_gizi']['campos_busca']['date_ano']; 
          $date_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_opname_gizi']['campos_busca']['date_input_2_dia']; 
          $date_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_opname_gizi']['campos_busca']['date_input_2_mes']; 
          $date_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_opname_gizi']['campos_busca']['date_input_2_ano']; 
          $date_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_opname_gizi']['campos_busca']['date_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_opname_gizi']['campos_busca']['NM_operador']; 
      } 
      ...
      if (!isset($opnamecode_cond) || empty($opnamecode_cond))
      {
         $opnamecode_cond = "qp";
      }
      ...
      $str_hide_opnamecode = (in_array($opnamecode_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      $str_display_opnamecode = ('bw' == $opnamecode_cond) ? $display_aberto : $display_fechado;
      ...
      if (!isset($opnamecode) || $opnamecode == "")
      {
          $opnamecode = "";
      }
      if (isset($opnamecode) && !empty($opnamecode))
      {
         $tmp_pos = strpos($opnamecode, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $opnamecode = substr($opnamecode, 0, $tmp_pos);
         }
      }
      if (!isset($date) || $date == "")
      {
...
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_id" name="id_autocomp" size="5"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 5, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
      ...
      <TD id='SC_opnamecode_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['opnamecode'])) ? $this->New_label['opnamecode'] : "Opnamecode"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_opnamecode_cond" name="opnamecode_cond" onChange="nm_campos_between(document.getElementById('id_vis_opnamecode'), this, 'opnamecode')">
       <OPTION value="qp" <?php if ("qp" == $opnamecode_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $opnamecode_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $opnamecode_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $opnamecode_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_opnamecode" <?php echo $str_hide_opnamecode?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['opnamecode'])) ? $this->New_label['opnamecode'] : "Opnamecode";
 $nmgp_tab_label .= "opnamecode?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      $opnamecode_look = substr($this->Db->qstr($opnamecode), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct opnamecode from " . $this->Ini->nm_tabela . " where opnamecode = '$opnamecode_look' order by opnamecode"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      if (isset($nmgp_def_dados[0][$opnamecode]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$opnamecode];
      }
      else
      {
          $sAutocompValue = $opnamecode;
      }
?>
<INPUT  type="text" id="SC_opnamecode" name="opnamecode" value="<?php echo NM_encode_input($opnamecode) ?>"  size=15 alt="{datatype: 'text', maxLength: 15, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_opnamecode" name="opnamecode_autocomp" size="15"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 15, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_date_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['date'])) ? $this->New_label['date'] : "Date"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_date_cond" name="date_cond" onChange="nm_campos_between(document.getElementById('id_vis_date'), this, 'date')">
       <OPTION value="eq" <?php if ("eq" == $date_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="gt" <?php if ("gt" == $date_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $date_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $date_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
...
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_date_dia" name="date_dia" value="<?php echo NM_encode_input($date_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_date_mes" name="date_mes" value="<?php echo NM_encode_input($date_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_date_ano" name="date_ano" value="<?php echo NM_encode_input($date_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 </span>
...
?>
        <SPAN id="id_css_date"  class="scFilterFieldFontEven">
 <?php echo $date_format_show ?>         </SPAN>
                 </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_date"  <?php echo $str_display_date; ?> class="scFilterFieldFontEven">
...
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_date_input_2_dia" name="date_input_2_dia" value="<?php echo NM_encode_input($date_input_2_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_date_input_2_mes" name="date_input_2_mes" value="<?php echo NM_encode_input($date_input_2_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_date_input_2_ano" name="date_input_2_ano" value="<?php echo NM_encode_input($date_input_2_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 </span>
...
?>
<?php
   if (is_file("grid_opname_gizi_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_opname_gizi']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_opname_gizi']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_opname_gizi']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.opnamecode_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_opnamecode'), document.F1.opnamecode_cond, 'opnamecode');
   document.F1.opnamecode.value = "";
   document.F1.opnamecode_autocomp.value = "";
   document.F1.date_cond.value = 'eq';
 ...
 {
    $('#SC_date_dia').bind('change', function() {sc_grid_opname_gizi_valida_dia(this)});
    $('#SC_date_input_2_dia').bind('change', function() {sc_grid_opname_gizi_valida_dia(this)});
    $('#SC_date_input_2_mes').bind('change', function() {sc_grid_opname_gizi_valida_mes(this)});
    $('#SC_date_mes').bind('change', function() {sc_grid_opname_gizi_valida_mes(this)});
 }
 function sc_grid_opname_gizi_valida_dia(obj)
 {
 ...
 function sc_grid_opname_gizi_valida_mes(obj)
 {
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "simrskreatifmedia/grid_opname_gizi";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_opname_gizi']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_opname_gizi']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_opname_gizi']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_opnamecode_cond'] = 'cond';
      $tp_fields['SC_opnamecode'] = 'text_aut';
      $tp_fields['id_ac_opnamecode'] = 'text_aut';
   ...
   function trata_campos()
   {
      global $keterangan_cond, $keterangan, $keterangan_autocomp,
             $id_cond, $id, $id_autocomp,
             $opnamecode_cond, $opnamecode, $opnamecode_autocomp,
             $date_cond, $date, $date_dia, $date_mes, $date_ano, $date_input_2_dia, $date_input_2_mes, $date_input_2_ano, $nmgp_tab_label;
      ...
      if (!empty($opnamecode_autocomp) && empty($opnamecode))
      {
          $opnamecode = $opnamecode_autocomp;
      }
      ...
      $opnamecode_cond_salva = $opnamecode_cond; 
      if (!isset($opnamecode_input_2) || $opnamecode_input_2 == "")
      {
          $opnamecode_input_2 = $opnamecode;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_opname_gizi']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_opname_gizi']['campos_busca']['keterangan'] = $keterangan; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_opname_gizi']['campos_busca']['keterangan_cond'] = $keterangan_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_opname_gizi']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_opname_gizi']['campos_busca']['id'] = $id; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_opname_gizi']['campos_busca']['id_cond'] = $id_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_opname_gizi']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_opname_gizi']['campos_busca']['opnamecode'] = $opnamecode; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_opname_gizi']['campos_busca']['opnamecode_cond'] = $opnamecode_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_opname_gizi']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_opname_gizi']['campos_busca']['date_dia'] = $date_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_opname_gizi']['campos_busca']['date_mes'] = $date_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_opname_gizi']['campos_busca']['date_ano'] = $date_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_opname_gizi']['campos_busca']['date_input_2_dia'] = $date_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_opname_gizi']['campos_busca']['date_input_2_mes'] = $date_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_opname_gizi']['campos_busca']['date_input_2_ano'] = $date_input_2_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_opname_gizi']['campos_busca']['date_cond'] = $date_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_opname_gizi']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_opname_gizi']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_opname_gizi']['campos_busca'] = $Temp_Busca;
      }
   ...
   { 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['opnamecode'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['opnamecode'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['opnamecode'] = $opnamecode;
      }
      ...
      //----- $opnamecode
      $this->Date_part = false;
      if (isset($opnamecode) || $opnamecode_cond == "nu" || $opnamecode_cond == "nn" || $opnamecode_cond == "ep" || $opnamecode_cond == "ne")
      {
         $this->monta_condicao("opnamecode", $opnamecode_cond, $opnamecode, "", "opnamecode");
      }
      ...
      if ($date_cond != "bi_TP")
      {
          ...
          {
              $this->nm_prep_date($val, "DT", "DATE", $date_cond, "", "data");
          }
          if (!$this->Date_part) {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_opname_gizi']['campos_busca']['date'] = $val[0];
          $this->nm_data->SetaData($this->cmp_formatado['date'], "YYYY-MM-DD");
          $this->cmp_formatado['date'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DT", "dmY"));
          if ($date_cond == "BW")
          {
              if (!$this->Date_part) {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_opname_gizi']['campos_busca']['date_input_2'] = $val[1];
              $this->nm_data->SetaData($this->cmp_formatado['date_input_2'], "YYYY-MM-DD");
              $this->cmp_formatado['date_input_2'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DT", "dmY"));
          }
          if (!empty($Dtxt) || $date_cond == "NU" || $date_cond == "NN"|| $date_cond == "EP"|| $date_cond == "NE")
          {
              $this->monta_condicao("`date`", $date_cond, $date, $date_input_2, 'date', 'DATE');
          }
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_opname_gizi']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_opname_gizi']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_opname_gizi']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_opname_gizi']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_opname_gizi']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_opname_gizi']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_opname_gizi']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_opname_gizi']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_opname_gizi']['cond_pesq'] .= $this->NM_operador;
