...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "`date`";$Nm_datas[] = "`date`";$Nm_numeric[] = "id";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_opnamecode_cond" name="opnamecode_cond" onChange="nm_campos_between(document.getElementById('id_vis_opnamecode'), this, 'opnamecode')">
      ...
      <br><span id="id_hide_opnamecode"  <?php echo $str_hide_opnamecode?>><?php
      if ($opnamecode != "")
      {
      $opnamecode_look = substr($this->Db->qstr($opnamecode), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_date_cond" name="date_cond" onChange="nm_campos_between(document.getElementById('id_vis_date'), this, 'date')">
      ...
      <br><span id="id_hide_date"  <?php echo $str_hide_date?>>
<?php
  $Form_base = "ddmmyyyy";
  $date_format_show = "";
...
?>
 ...
 <?php echo $date_format_show ?>         </SPAN>
                  <br />
        <SPAN id="id_vis_date"  <?php echo $str_display_date; ?> class="scFilterFieldFontEven">
