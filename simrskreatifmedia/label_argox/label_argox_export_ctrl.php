<?php
@session_start() ;
$_SESSION['scriptcase']['label_argox']['sc_process_barr'] = true;
require_once('../label_argox/index.php');
unset($_SESSION['scriptcase']['label_argox']['sc_process_barr']);
$ExportCtrl = new label_argox_export_control;
$ExportCtrl->Export_barr();

class label_argox_export_control
{
