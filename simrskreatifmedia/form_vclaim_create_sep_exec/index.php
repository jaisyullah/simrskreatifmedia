<?php
   include_once('form_vclaim_create_sep_exec_session.php');
   @session_start() ;
   $_SESSION['scriptcase']['form_vclaim_create_sep_exec']['glo_nm_perfil']          = "conn_mysql";
   $_SESSION['scriptcase']['form_vclaim_create_sep_exec']['glo_nm_path_prod']       = "";
   $_SESSION['scriptcase']['form_vclaim_create_sep_exec']['glo_nm_path_conf']       = "";
   $_SESSION['scriptcase']['form_vclaim_create_sep_exec']['glo_nm_path_imagens']    = "";
   $_SESSION['scriptcase']['form_vclaim_create_sep_exec']['glo_nm_path_imag_temp']  = "";
   $_SESSION['scriptcase']['form_vclaim_create_sep_exec']['glo_nm_path_doc']        = "";
    ...
    //check prod
    if(empty($_SESSION['scriptcase']['form_vclaim_create_sep_exec']['glo_nm_path_prod']))
    {
            /*check prod*/$_SESSION['scriptcase']['form_vclaim_create_sep_exec']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
    }
    //check img
    if(empty($_SESSION['scriptcase']['form_vclaim_create_sep_exec']['glo_nm_path_imagens']))
    {
            /*check img*/$_SESSION['scriptcase']['form_vclaim_create_sep_exec']['glo_nm_path_imagens'] = $str_path_apl_url . "_lib/file/img";
    }
    //check tmp
    if(empty($_SESSION['scriptcase']['form_vclaim_create_sep_exec']['glo_nm_path_imag_temp']))
    {
            /*check tmp*/$_SESSION['scriptcase']['form_vclaim_create_sep_exec']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
    }
    //check doc
    if(empty($_SESSION['scriptcase']['form_vclaim_create_sep_exec']['glo_nm_path_doc']))
    {
            /*check doc*/$_SESSION['scriptcase']['form_vclaim_create_sep_exec']['glo_nm_path_doc'] = $str_path_apl_dir . "_lib/file/doc";
    }
    //end check publication with the prod
//
class form_vclaim_create_sep_exec_ini
{
   var $nm_cod_apl;
   var $nm_nome_apl;
   var $nm_seguranca;
...
//
   function init($Tp_init = "")
   {
      ...
      $_SESSION['sc_session'][$this->sc_page]['form_vclaim_create_sep_exec']['decimal_db'] = "."; 
      $this->nm_cod_apl      = "form_vclaim_create_sep_exec"; 
      $this->nm_nome_apl     = ""; 
      $this->nm_seguranca    = ""; 
      ...
      $this->nm_dt_criacao   = "20180823"; 
      $this->nm_hr_criacao   = "064809"; 
...
// 
      ...
      $this->sc_protocolo    = "";
      $this->path_prod       = $_SESSION['scriptcase']['form_vclaim_create_sep_exec']['glo_nm_path_prod'];
      $this->path_conf       = $_SESSION['scriptcase']['form_vclaim_create_sep_exec']['glo_nm_path_conf'];
      $this->path_imagens    = $_SESSION['scriptcase']['form_vclaim_create_sep_exec']['glo_nm_path_imagens'];
      $this->path_imag_temp  = $_SESSION['scriptcase']['form_vclaim_create_sep_exec']['glo_nm_path_imag_temp'];
      $this->path_doc        = $_SESSION['scriptcase']['form_vclaim_create_sep_exec']['glo_nm_path_doc'];
      ...
      $this->path_aplicacao  = substr($this->path_aplicacao, 0, strrpos($this->path_aplicacao, '/')) . '/form_vclaim_create_sep_exec';
      ...
      if (isset($_SESSION['scriptcase']['form_vclaim_create_sep_exec']['session_timeout']['lang'])) {
          $this->str_lang = $_SESSION['scriptcase']['form_vclaim_create_sep_exec']['session_timeout']['lang'];
      }
      elseif (!isset($_SESSION['scriptcase']['form_vclaim_create_sep_exec']['actual_lang']) || $_SESSION['scriptcase']['form_vclaim_create_sep_exec']['actual_lang'] != $this->str_lang) {
          $_SESSION['scriptcase']['form_vclaim_create_sep_exec']['actual_lang'] = $this->str_lang;
      ...
      {
          include_once("form_vclaim_create_sep_exec_json.php");
      }
      $this->SC_Link_View = (isset($_SESSION['sc_session'][$this->sc_page]['form_vclaim_create_sep_exec']['SC_Link_View'])) ? $_SESSION['sc_session'][$this->sc_page]['form_vclaim_create_sep_exec']['SC_Link_View'] : false;
      if (isset($_GET['SC_Link_View']) && !empty($_GET['SC_Link_View']) && is_numeric($_GET['SC_Link_View']))
      {
          if ($_SESSION['sc_session'][$this->sc_page]['form_vclaim_create_sep_exec']['embutida'])
          {
              $this->SC_Link_View = true;
              $_SESSION['sc_session'][$this->sc_page]['form_vclaim_create_sep_exec']['SC_Link_View'] = true;
          }
      }
      if (isset($_POST['nmgp_opcao']) && $_POST['nmgp_opcao'] == "ajax_save_ancor")
      {
          $_SESSION['sc_session'][$this->sc_page]['form_vclaim_create_sep_exec']['ancor_save'] = $_POST['ancor_save'];
...
<?php
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['form_vclaim_create_sep_exec']['dashboard_info']['under_dashboard']))
      {
          $_SESSION['sc_session'][$this->sc_page]['form_vclaim_create_sep_exec']['dashboard_info']['under_dashboard'] = false;
          $_SESSION['sc_session'][$this->sc_page]['form_vclaim_create_sep_exec']['dashboard_info']['dashboard_app']   = '';
          $_SESSION['sc_session'][$this->sc_page]['form_vclaim_create_sep_exec']['dashboard_info']['own_widget']      = '';
          $_SESSION['sc_session'][$this->sc_page]['form_vclaim_create_sep_exec']['dashboard_info']['parent_widget']   = '';
          $_SESSION['sc_session'][$this->sc_page]['form_vclaim_create_sep_exec']['dashboard_info']['compact_mode']    = false;
          $_SESSION['sc_session'][$this->sc_page]['form_vclaim_create_sep_exec']['dashboard_info']['remove_margin']   = false;
      }
      if (isset($_GET['under_dashboard']) && 1 == $_GET['under_dashboard'])
      {
          if (isset($_GET['own_widget']) && 'dbifrm_widget' == substr($_GET['own_widget'], 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['form_vclaim_create_sep_exec']['dashboard_info']['own_widget'] = $_GET['own_widget'];
              $_SESSION['sc_session'][$this->sc_page]['form_vclaim_create_sep_exec']['dashboard_info']['under_dashboard'] = true;
              if (isset($_GET['dashboard_app'])) {
                  $_SESSION['sc_session'][$this->sc_page]['form_vclaim_create_sep_exec']['dashboard_info']['dashboard_app'] = $_GET['dashboard_app'];
              }
              if (isset($_GET['parent_widget'])) {
                  $_SESSION['sc_session'][$this->sc_page]['form_vclaim_create_sep_exec']['dashboard_info']['parent_widget'] = $_GET['parent_widget'];
              }
              if (isset($_GET['compact_mode'])) {
                  $_SESSION['sc_session'][$this->sc_page]['form_vclaim_create_sep_exec']['dashboard_info']['compact_mode'] = 1 == $_GET['compact_mode'];
              }
              if (isset($_GET['remove_margin'])) {
                  $_SESSION['sc_session'][$this->sc_page]['form_vclaim_create_sep_exec']['dashboard_info']['remove_margin'] = 1 == $_GET['remove_margin'];
              }
          }
      }
      elseif (isset($under_dashboard) && 1 == $under_dashboard)
      {
          if (isset($own_widget) && 'dbifrm_widget' == substr($own_widget, 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['form_vclaim_create_sep_exec']['dashboard_info']['own_widget'] = $own_widget;
              $_SESSION['sc_session'][$this->sc_page]['form_vclaim_create_sep_exec']['dashboard_info']['under_dashboard'] = true;
              if (isset($dashboard_app)) {
                  $_SESSION['sc_session'][$this->sc_page]['form_vclaim_create_sep_exec']['dashboard_info']['dashboard_app'] = $dashboard_app;
              }
              if (isset($parent_widget)) {
                  $_SESSION['sc_session'][$this->sc_page]['form_vclaim_create_sep_exec']['dashboard_info']['parent_widget'] = $parent_widget;
              }
              if (isset($compact_mode)) {
                  $_SESSION['sc_session'][$this->sc_page]['form_vclaim_create_sep_exec']['dashboard_info']['compact_mode'] = 1 == $compact_mode;
              }
              if (isset($remove_margin)) {
                  $_SESSION['sc_session'][$this->sc_page]['form_vclaim_create_sep_exec']['dashboard_info']['remove_margin'] = 1 == $remove_margin;
              }
          }
      }
      if (!isset($_SESSION['sc_session'][$this->sc_page]['form_vclaim_create_sep_exec']['dashboard_info']['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['form_vclaim_create_sep_exec']['dashboard_info']['maximized'] = false;
      }
      if (isset($_GET['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['form_vclaim_create_sep_exec']['dashboard_info']['maximized'] = 1 == $_GET['maximized'];
      }
      if ($_SESSION['sc_session'][$this->sc_page]['form_vclaim_create_sep_exec']['dashboard_info']['under_dashboard'])
      {
          $sTmpDashboardApp = $_SESSION['sc_session'][$this->sc_page]['form_vclaim_create_sep_exec']['dashboard_info']['dashboard_app'];
          if ('' != $sTmpDashboardApp && isset($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["form_vclaim_create_sep_exec"]))
          {
              foreach ($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["form_vclaim_create_sep_exec"] as $sTmpTargetLink => $sTmpTargetWidget)
              {
      ...
      if (!is_file($this->root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
      {
          ...
          unset($_SESSION['scriptcase']['form_vclaim_create_sep_exec']['glo_nm_conexao']);
      }
      ...
      if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['form_vclaim_create_sep_exec']['session_timeout']['redir']))
      {
      ...
      $_SESSION['sc_session'][$this->sc_page]['form_vclaim_create_sep_exec']['path_doc'] = $this->path_doc; 
      ...
      if (!is_dir($this->root . $this->path_prod))
      {
          ...
          echo " </tr>";
          echo "</table>";
          if (!$_SESSION['sc_session'][$script_case_init]['form_vclaim_create_sep_exec']['iframe_menu'] && (!isset($_SESSION['sc_session'][$script_case_init]['form_vclaim_create_sep_exec']['sc_outra_jan']) || !$_SESSION['sc_session'][$script_case_init]['form_vclaim_create_sep_exec']['sc_outra_jan'])) 
          { 
...
// 
      include_once($this->path_aplicacao . "form_vclaim_create_sep_exec_erro.class.php"); 
      $this->Erro = new form_vclaim_create_sep_exec_erro();
      include_once($this->path_adodb . "/adodb.inc.php"); 
      $this->sc_Include($this->path_libs . "/nm_sec_prod.php", "F", "nm_reg_prod") ; 
      $this->sc_Include($this->path_libs . "/nm_ini_perfil.php", "F", "perfil_lib") ; 
// 
 if(function_exists('set_php_timezone')) set_php_timezone('form_vclaim_create_sep_exec'); 
// 
      ...
      if (isset($_SESSION['scriptcase']['form_vclaim_create_sep_exec']['session_timeout']['redir'])) {
          ...
          if ($_SESSION['scriptcase']['form_vclaim_create_sep_exec']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "  </HEAD>\r\n";
              $SS_cod_html .= "   <body>\r\n";
          }
          else {
              ...
              $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['form_vclaim_create_sep_exec']['session_timeout']['redir'] . "');\">\r\n";
              $SS_cod_html .= "     </form>\r\n";
          ...
          if ($_SESSION['scriptcase']['form_vclaim_create_sep_exec']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['form_vclaim_create_sep_exec']['session_timeout']['redir'] . "');\r\n";
          }
          ...
          $SS_cod_html .= " </body>\r\n";
          $SS_cod_html .= "</HTML>\r\n";
          unset($_SESSION['scriptcase']['form_vclaim_create_sep_exec']['session_timeout']);
          unset($_SESSION['sc_session']);
      }
      ...
      $_SESSION['sc_session'][$this->sc_page]['form_vclaim_create_sep_exec']['seq_dir'] = 0; 
      $_SESSION['sc_session'][$this->sc_page]['form_vclaim_create_sep_exec']['sub_dir'] = array(); 
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
      $this->conectDB();
   ...
   function prep_conect()
   {
      if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
      {
          ...
          {
              if (isset($_SESSION['scriptcase']['form_vclaim_create_sep_exec']['glo_nm_conexao']) && $_SESSION['scriptcase']['form_vclaim_create_sep_exec']['glo_nm_conexao'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['form_vclaim_create_sep_exec']['glo_nm_conexao'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['form_vclaim_create_sep_exec']['glo_nm_perfil']) && $_SESSION['scriptcase']['form_vclaim_create_sep_exec']['glo_nm_perfil'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['form_vclaim_create_sep_exec']['glo_nm_perfil'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['form_vclaim_create_sep_exec']['glo_con_' . $NM_con_orig]))
              {
                  $_SESSION['scriptcase']['form_vclaim_create_sep_exec']['glo_con_' . $NM_con_orig] = $NM_con_dest;
              }
          }
      }
      $con_devel             = (isset($_SESSION['scriptcase']['form_vclaim_create_sep_exec']['glo_nm_conexao'])) ? $_SESSION['scriptcase']['form_vclaim_create_sep_exec']['glo_nm_conexao'] : ""; 
      $perfil_trab           = ""; 
      $this->nm_falta_var    = ""; 
      $this->nm_falta_var_db = ""; 
      $nm_crit_perfil        = false;
      if (isset($_SESSION['scriptcase']['form_vclaim_create_sep_exec']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['form_vclaim_create_sep_exec']['glo_nm_conexao']))
      {
          ob_start();
      ...
      if (isset($_SESSION['scriptcase']['form_vclaim_create_sep_exec']['glo_nm_perfil']) && !empty($_SESSION['scriptcase']['form_vclaim_create_sep_exec']['glo_nm_perfil']))
      {
          $perfil_trab = $_SESSION['scriptcase']['form_vclaim_create_sep_exec']['glo_nm_perfil'];
      }
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['form_vclaim_create_sep_exec']['embutida_init']) || !$_SESSION['sc_session'][$this->sc_page]['form_vclaim_create_sep_exec']['embutida_init']) 
      {
      }
// 
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['form_vclaim_create_sep_exec']['decimal_db'] = $_SESSION['scriptcase']['glo_decimal_db']; 
      }
      if (isset($_SESSION['scriptcase']['glo_date_separator']) && !empty($_SESSION['scriptcase']['glo_date_separator']))
      {
          ...
          if (strlen($SC_temp) == 2)
          {
              $_SESSION['sc_session'][$this->sc_page]['form_vclaim_create_sep_exec']['SC_sep_date']  = substr($SC_temp, 0, 1); 
              $_SESSION['sc_session'][$this->sc_page]['form_vclaim_create_sep_exec']['SC_sep_date1'] = substr($SC_temp, 1, 1); 
          }
          else
           {
              $_SESSION['sc_session'][$this->sc_page]['form_vclaim_create_sep_exec']['SC_sep_date']  = $SC_temp; 
              $_SESSION['sc_session'][$this->sc_page]['form_vclaim_create_sep_exec']['SC_sep_date1'] = $SC_temp; 
          }
          $this->date_delim  = $_SESSION['sc_session'][$this->sc_page]['form_vclaim_create_sep_exec']['SC_sep_date'];
          $this->date_delim1 = $_SESSION['sc_session'][$this->sc_page]['form_vclaim_create_sep_exec']['SC_sep_date1'];
      }
// 
...
<?php
   ...
   function conectDB()
   {
      ...
      if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['form_vclaim_create_sep_exec']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['form_vclaim_create_sep_exec']['glo_nm_conexao']))
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['form_vclaim_create_sep_exec']['glo_nm_conexao'], $this->root . $this->path_prod, 'simrskreatifmedia', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
...
// 
   ...
   function sc_Sql_Protect($var, $tp, $conex="")
   {
       ...
       if ($tp == "date")
       {
           ...
           if (isset($_SESSION['sc_session'][$this->sc_page]['form_vclaim_create_sep_exec']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->sc_page]['form_vclaim_create_sep_exec']['SC_sep_date']))
           {
               $delim  = $_SESSION['sc_session'][$this->sc_page]['form_vclaim_create_sep_exec']['SC_sep_date'];
               $delim1 = $_SESSION['sc_session'][$this->sc_page]['form_vclaim_create_sep_exec']['SC_sep_date1'];
           }
   ...
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['form_vclaim_create_sep_exec']['SC_Gb_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['form_vclaim_create_sep_exec']['SC_Gb_date_format'][$GB][$cmp] : "";
   }

   function Get_Gb_prefix_date_format($GB, $cmp)
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['form_vclaim_create_sep_exec']['SC_Gb_prefix_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['form_vclaim_create_sep_exec']['SC_Gb_prefix_date_format'][$GB][$cmp] : "";
   }
...
//===============================================================================
//
class form_vclaim_create_sep_exec_apl
{
   var $Ini;
   var $Erro;
   var $Db;
...
//----- 
   function controle()
   {
      ...
      $this->Ini = new form_vclaim_create_sep_exec_ini(); 
      $this->Ini->init();
      $this->Change_Menu = false;
      if (isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_create_sep_exec']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_create_sep_exec']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_vclaim_create_sep_exec']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_vclaim_create_sep_exec'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_vclaim_create_sep_exec']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_vclaim_create_sep_exec']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_vclaim_create_sep_exec') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_vclaim_create_sep_exec']['label'] = "" . $this->Ini->Nm_lang['lang_othr_blank_title'] . "";
          ...
          elseif ($this->Ini->sc_page == $this->sc_init_menu)
          {
              ...
              {
                  if ($apl == "form_vclaim_create_sep_exec")
                  {
                      $achou = true;
                  }
                  elseif ($achou)
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_vclaim_create_sep_exec']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_vclaim_create_sep_exec']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['form_vclaim_create_sep_exec']['exit'];
      ...
      $this->Db = $this->Ini->Db; 
      include_once($this->Ini->path_aplicacao . "form_vclaim_create_sep_exec_erro.class.php"); 
      $this->Erro      = new form_vclaim_create_sep_exec_erro();
      $this->Erro->Ini = $this->Ini;
//
      $_SESSION['scriptcase']['form_vclaim_create_sep_exec']['contr_erro'] = 'on';
  $no_kartu  			= $_POST['no_kartu'];
$jns_pelayanan		= $_POST['jns_pelayanan'];
$kelas_rawat		= $_POST['kelas_rawat'];
$katarak			= $_POST['katarak'];
$tmp_no_sep_suplesi	= $_POST['no_sep_suplesi'];
$poli_eksekutif  	= $_POST['poli_eksekutif'];
$poli_tujuan_kode 	= $_POST['poli_tujuan_kode'];
$asal_rujukan  		= $_POST['asal_rujukan'];
$ppk_rujukan_kode  	= $_POST['ppk_rujukan_kode'];
$ppk_rujukan_nama  	= $_POST['ppk_rujukan_nama'];
$tgl_rujukan  		= $_POST['tgl_rujukan'];
$no_kunjungan  		= $_POST['no_kunjungan'];
$no_surat  			= $_POST['no_surat'];
$kode_dpjp  		= $_POST['kode_dpjp'];
$tgl_sep  			= $_POST['tgl_sep'];
$no_mr  			= $_POST['no_mr'];
$cob  				= $_POST['cob'];
$diag_awal_kode  	= $_POST['diag_awal_kode'];
$no_telp  			= $_POST['no_telp'];
$catatan  			= $_POST['catatan'];
$opsi_laka_lantas	= $_POST['opsi_laka_lantas'];
$penjamin_1  		= ($_POST['penjamin_1'] == "1") ? "1" : "";	  
$penjamin_2  		= ($_POST['penjamin_2'] == "2") ? ",2" : "";
$penjamin_3  		= ($_POST['penjamin_3'] == "3") ? ",3" : "";
$penjamin_4  		= ($_POST['penjamin_4'] == "4") ? ",4" : "";
...
$keterangan_laka	= $_POST['keterangan_laka'];
$tmp_penjamin		= $penjamin_1.$penjamin_2.$penjamin_3.$penjamin_4;

if(substr($tmp_penjamin,0,1) == ','){
	$penjamin = ltrim($tmp_penjamin,",");
}else{
	$penjamin = $tmp_penjamin;
}

$suplesi			= $_POST['suplesi'];
$no_sep_suplesi		= ($suplesi == "1") ? $tmp_no_sep_suplesi : "";

if($opsi_laka_lantas == '0'){
	$penjamin 		 = '';
	$tgl_kejadian  	 = '';
	$kd_propinsi  	 = '';
	$kd_kabupaten  	 = '';
...
$sSQL = "SELECT value FROM app_setting WHERE name = 'kode_faskes'";
...
$insert_table  = 'vclaim_sep_insert';
$insert_fields = array(
	
	'no_kartu' 				=> "'$no_kartu'",
	'tgl_sep' 				=> "'$tgl_sep'",
	'ppk_pelayanan' 		=> "'$kode_ppk'",
	'jenis_pelayanan' 		=> "'$jns_pelayanan'",
	'kelas_rawat' 			=> "'$kelas_rawat'",
	'no_mr' 				=> "'$no_mr'",
	'asal_rujukan' 			=> "'$asal_rujukan'",
	'tanggal_rujukan' 		=> "'$tgl_rujukan'",
	'no_rujukan' 			=> "'$no_kunjungan'",
	'ppk_rujukan' 			=> "'$ppk_rujukan_kode'",
	'catatan' 				=> "'$catatan'",
	'diagnosa_awal' 		=> "'$diag_awal_kode'",
	'poli' 					=> "'$poli_tujuan_kode'",
	'poli_eksekutif' 		=> "'$poli_eksekutif'",
	'cob' 					=> "'$cob'",
	'katarak' 				=> "'$katarak'",
	'laka_lantas' 			=> "'$opsi_laka_lantas'",
	'penjamin' 				=> "'$penjamin'",
	'tanggal_kejadian' 		=> "'$tgl_kejadian'",
	'keterangan_laka' 		=> "'$keterangan_laka'",
	'suplesi' 				=> "'$suplesi'",
	'no_sep_suplesi' 		=> "'$no_sep_suplesi'",
	'kode_provinsi_laka'	=> "'$kd_propinsi'",
	'kode_kabupaten_laka'	=> "'$kd_kabupaten'",
	'kode_kecamatan_laka' 	=> "'$kd_kecamatan'",
	'no_surat_skdp' 		=> "'$no_surat'",
	'kode_dpjp_skdp' 		=> "'$kode_dpjp'",
	'no_telepon' 			=> "'$no_telp'",
	'user' 					=> "'".$conf['app_user']."'",
...
$req_message  = $ar['metaData']['message'];


if($req_status == "200"){	
	
	$no_sep				= $ar['response']['sep']['noSep'];
	$tgl_sep			= $ar['response']['sep']['tglSep'];	
	$catatan			= $ar['response']['sep']['catatan'];
	$diag_awal_kode		= $ar['response']['sep']['diagnosa'];
	$jns_pelayanan		= $ar['response']['sep']['jnsPelayanan'];
	$kelas_rawat		= $ar['response']['sep']['kelasRawat'];
	$penjamin			= $ar['response']['sep']['penjamin'];
	$asuransi			= $ar['response']['sep']['peserta']['asuransi'];
	$jenis_peserta		= $ar['response']['sep']['peserta']['jnsPeserta'];
	$kelamin			= $ar['response']['sep']['peserta']['kelamin'];
	$nama				= $ar['response']['sep']['peserta']['nama'];
	$no_kartu			= $ar['response']['sep']['peserta']['noKartu'];
	$no_mr				= $ar['response']['sep']['peserta']['noMr'];
	$tanggal_lahir		= $ar['response']['sep']['peserta']['tglLahir'];
	$poli_tujuan_kode	= $ar['response']['sep']['poli'];
	$poli_eksekutif		= $ar['response']['sep']['poliEksekutif'];
	...
	$insert_table  = 'vclaim_sep_response';
	$insert_fields = array(
		...
		'ppk_perujuk'					=> "'".$ppk_rujukan_kode."'",
		'ppk_perujuk_nama'				=> "'".$ppk_rujukan_nama."'",
		'catatan'						=> "'".$catatan."'",
		'diagnosa'						=> "'".$diag_awal_kode."'",
		'jenis_pelayanan'				=> "'".$jns_pelayanan."'",
		'kelas_rawat'					=> "'".$kelas_rawat."'",
		'penjamin'						=> "'".$penjamin."'",
		'asuransi'						=> "'".$asuransi."'",
		'hak_kelas'						=> "'".$kelas_rawat."'",
		...
		'update_tanggal_pulang'			=> "0",
		'tanggal_update_tanggal_pulang'	=> "NULL",
		'cetak'							=> "0",
		'tanggal_cetak'					=> "NULL",
		'is_delete'						=> "0",
		'tanggal_delete'				=> "NULL",
	...
	$resp['code']	 = $req_status;
	$resp['message'] = $req_message;
	$resp['no_sep']  = $ar['response']['sep']['noSep'];
	$resp['alert']	 = 'success';
	...
	$keterangan		= 'Insert SEP';
	$insert_table	= 'vclaim_response_log';
	$insert_fields	= array(
...
$_SESSION['scriptcase']['form_vclaim_create_sep_exec']['contr_erro'] = 'off'; 
//--- 
       $this->Db->Close(); 
       if ($this->Change_Menu)
       {
...
//======= =========================
   ...
   if (!empty($_POST))
   {
       foreach ($_POST as $nmgp_var => $nmgp_val)
       {
            ...
            nm_limpa_str_form_vclaim_create_sep_exec($nmgp_val);
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['form_vclaim_create_sep_exec']['glo_nm_path_imag_temp'] . "/sc_apl_default_simrskreatifmedia.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['form_vclaim_create_sep_exec']['glo_nm_path_imag_temp'] . "/sc_apl_default_simrskreatifmedia.txt"));
       }
       if (isset($apl_def)) {
           if ($apl_def[0] != "form_vclaim_create_sep_exec") {
               $_SESSION['scriptcase']['sem_session'] = true;
               if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                   $_SESSION['scriptcase']['form_vclaim_create_sep_exec']['session_timeout']['redir'] = $apl_def[0];
               }
               else {
                   $_SESSION['scriptcase']['form_vclaim_create_sep_exec']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
               }
               $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
               $_SESSION['scriptcase']['form_vclaim_create_sep_exec']['session_timeout']['redir_tp'] = $Redir_tp;
           }
           if (isset($_COOKIE['sc_actual_lang_simrskreatifmedia'])) {
               $_SESSION['scriptcase']['form_vclaim_create_sep_exec']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_simrskreatifmedia'];
           }
       }
   }
   ...
   $salva_iframe = false;
   if (isset($_SESSION['sc_session'][$script_case_init]['form_vclaim_create_sep_exec']['iframe_menu']))
   {
       $salva_iframe = $_SESSION['sc_session'][$script_case_init]['form_vclaim_create_sep_exec']['iframe_menu'];
       unset($_SESSION['sc_session'][$script_case_init]['form_vclaim_create_sep_exec']['iframe_menu']);
   }
   if (isset($nm_run_menu) && $nm_run_menu == 1)
   {
        ...
        $_SESSION['scriptcase']['sc_apl_menu_atual'] = "form_vclaim_create_sep_exec";
        $achou = false;
        if (isset($_SESSION['sc_session'][$script_case_init]))
        {
            foreach ($_SESSION['sc_session'][$script_case_init] as $nome_apl => $resto)
            {
                if ($nome_apl == 'form_vclaim_create_sep_exec' || $achou)
                {
        ...
        $_SESSION['sc_session'][$script_case_init]['form_vclaim_create_sep_exec']['iframe_menu'] = true;
   }
   else
   {
       $_SESSION['sc_session'][$script_case_init]['form_vclaim_create_sep_exec']['iframe_menu'] = $salva_iframe;
   }

   if (!isset($_SESSION['sc_session'][$script_case_init]['form_vclaim_create_sep_exec']['initialize']))
   {
       $_SESSION['sc_session'][$script_case_init]['form_vclaim_create_sep_exec']['initialize'] = true;
   }
   elseif (!isset($_SERVER['HTTP_REFERER']))
   {
       $_SESSION['sc_session'][$script_case_init]['form_vclaim_create_sep_exec']['initialize'] = false;
   }
   ...
   else
   {
       ...
       if ('form_vclaim_create_sep_exec' == $sReferer || 'form_vclaim_create_sep_exec_' == substr($sReferer, 0, 28))
       {
           $_SESSION['sc_session'][$script_case_init]['form_vclaim_create_sep_exec']['initialize'] = false;
       }
       else
   ...
   if (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'form_vclaim_create_sep_exec')
   {
       $_SESSION['sc_session'][$script_case_init]['form_vclaim_create_sep_exec']['sc_outra_jan'] = true;
        unset($_SESSION['scriptcase']['sc_outra_jan']);
   }
   $_SESSION['sc_session'][$script_case_init]['form_vclaim_create_sep_exec']['menu_desenv'] = false;   
   if (!defined("SC_ERROR_HANDLER"))
   {
       define("SC_ERROR_HANDLER", 1);
       include_once(dirname(__FILE__) . "/form_vclaim_create_sep_exec_erro.php");
   }
   if (!empty($nmgp_parms)) 
   { 
       ...
       while (!empty($todo[$ix]))
       {
            ...
            if (1 < sizeof($cadapar))
            {
                ...
                nm_limpa_str_form_vclaim_create_sep_exec($cadapar[1]);
   ...
   $contr_form_vclaim_create_sep_exec = new form_vclaim_create_sep_exec_apl();
   $contr_form_vclaim_create_sep_exec->controle();
//
   function nm_limpa_str_form_vclaim_create_sep_exec(&$str)
   {
