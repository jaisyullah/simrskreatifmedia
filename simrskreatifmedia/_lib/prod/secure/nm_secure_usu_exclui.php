...
if (isset($HTTP_GET_VARS["login"]))
{
    ...
    $nm_naveg .= "</DIV>\n";
    $mensagem  = "Você está prestes a excluir o Usuário do sistema.";
...
else
{
    ...
    $mensagem = ($resultado) ? "Usuário excluído." : "Erro na exclusão.";
}
...
<TABLE ALIGN="center" BORDER="0" CELLSPACING="1" CELLPADDING="2" BGCOLOR="<?php echo $html_cor_fundo_borda; ?>">
  <TR ALIGN="center" BGCOLOR="<?php echo $html_cor_fundo_titulo; ?>">
    <TD><FONT FACE="Verdana, Arial, sans-serif" SIZE="2" COLOR="<?php echo $html_cor_texto_titulo; ?>"><B>Excluir Usuário: <?php echo $usu_log; ?></B></FONT></TD>
  </TR>
