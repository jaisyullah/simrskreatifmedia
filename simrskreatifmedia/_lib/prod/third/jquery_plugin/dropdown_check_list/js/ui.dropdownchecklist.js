...
*/
    ...
    $.widget("ui.dropdownchecklist", {
        ...
        _appendDropContainer: function( controlItem ) {
            ...
            /* sc_fix wrapper.addClass("ui-widget"); */
            // assign an id
            ...
            /* sc_fix container.addClass("ui-dropdownchecklist-dropcontainer ui-widget-content"); */
		...
		_handleFocus: function(e,focusIn,forDropdown) {
			...
			if (forDropdown && !self.dropWrapper.isOpen) {
				...
				e.stopImmediatePropagation();
				if (focusIn) {
					/* sc_fix self.controlSelector.addClass("ui-state-hover"); */
					if ($.ui.dropdownchecklist.gLastOpened != null) {
						$.ui.dropdownchecklist.gLastOpened._toggleDropContainer( false );
					}
				} else {
					/* sc_fix self.controlSelector.removeClass("ui-state-hover"); */
				}
        ...
        _appendControl: function() {
            ...
            var wrapper = $("<span/>");
            /* sc_fix wrapper.addClass("ui-dropdownchecklist ui-dropdownchecklist-selector-wrapper ui-widget"); */
            ...
            var control = $("<span/>");
            /* sc_fix control.addClass("ui-dropdownchecklist-selector ui-state-default"); */
            control.addClass("ui-dropdownchecklist-selector");
            ...
            wrapper.hover(
	            function() {
	                if (!self.disabled) {
	                    /* sc_fix control.addClass("ui-state-hover"); */
	                }
	            }
	        , 	function() {
	                if (!self.disabled) {
	                    /* sc_fix control.removeClass("ui-state-hover"); */
	                }
	            }
	        );
        ...
        _createDropItem: function(index, tabIndex, value, text, optCss, checked, disabled, indent) {
			...
			/* sc_fix item.addClass("ui-state-default"); */
			if (disabled) {
            ...
            item.hover(
            	function(e) {
            		var anItem = $(this);
                	/* sc_fix if (!anItem.hasClass("ui-state-disabled")) { anItem.addClass("ui-state-hover"); } */
            	}
            , 	function(e) {
            		var anItem = $(this);
                	/* sc_fix anItem.removeClass("ui-state-hover"); */
            	}
            );
...
**********/
		...
		_createGroupItem: function(text,disabled) {
			var self = this;
			var group = $("<div />");
			/* sc_fix group.addClass("ui-dropdownchecklist-group ui-widget-header"); */
		...
		_createCloseItem: function(text) {
			var self = this;
			var closeItem = $("<div />");
			/* sc_fix closeItem.addClass("ui-state-default ui-dropdownchecklist-close ui-dropdownchecklist-item"); */
            ...
            closeItem.hover(
            	function(e) { /* sc_fix $(this).addClass("ui-state-hover"); */ }
            , 	function(e) { /* sc_fix $(this).removeClass("ui-state-hover"); */ }
            );
	        // do not let the focus wander around
        ...
        _toggleDropContainer: function( makeOpen ) {
            ...
            var hide = function(instance) {
                if ((instance != null) && instance.dropWrapper.isOpen ){
	                ...
	                /* sc_fix aControl.removeClass("ui-state-active"); */
	                /* sc_fix aControl.removeClass("ui-state-hover"); */
...
****/
	                ...
	                var aControl = instance.controlSelector;
	                /* sc_fix aControl.addClass("ui-state-active"); */
	                /* sc_fix aControl.removeClass("ui-state-hover"); */
