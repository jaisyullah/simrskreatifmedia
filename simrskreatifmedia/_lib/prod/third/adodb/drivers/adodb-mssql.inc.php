...
order by constraint_name, referenced_table_name, keyno";
	...
	function _connect($argHostname, $argUsername, $argPassword, $argDatabasename, $argDatabaseEncoding = '')
	{
	...
	// returns true or false
	function _pconnect($argHostname, $argUsername, $argPassword, $argDatabasename, $argDatabaseEncoding = '')
	{
		if (!function_exists('mssql_pconnect')) return null;
