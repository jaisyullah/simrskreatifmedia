        ...
        (function () {
            ...
            this.jKanban = function () {
                ...
                this.addElement = function (boardID, element) {
                    ...
                    var itemText = element.items;

                    nodeItem.innerHTML += '<span id="'+ itemText.id +'" class="'+ itemText.class +'" data-type="'+ itemText.type +'">' + itemText.title + '</span>';
                    //add function
                ...
                this.addBoards = function (boards) {
                    ...
                    for (var boardkey in boards) {
                        ...
                        for (var itemkey in board.item) {
                            ...
                            var nodeItem = document.createElement('div');
                            nodeItem.classList.add('kanban-item',itemKanban.class);
                            nodeItem.dataset.eid = itemKanban.id;
                            // nodeItem.innerHTML = itemKanban.items;

                            for (var itemTextKey in itemKanban.items) {
                                var itemText = itemKanban.items[itemTextKey];
                                var itemContent = itemText.title;

                                if(itemText.type === 'image') {
                                    itemContent = '<img src="'+ itemText.imgSrc +'">';
                                }

                                nodeItem.innerHTML += '<span id="'+ itemText.id +'" class="'+ itemText.class +'" data-type="'+ itemText.type +'" data-content="'+ itemContent +'">' + itemContent + '</span>';
                            }
