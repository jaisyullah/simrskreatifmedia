...
<?php
   ...
   $Ord_Cmp = new grid_tabel_piutang_transaksi_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_tabel_piutang_transaksi_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tabel_piutang_transaksi']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tabel_piutang_transaksi']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tabel_piutang_transaksi']['labels']["id"])) ? $_SESSION['sc_session'][$sc_init]['grid_tabel_piutang_transaksi']['labels']["id"] : "ID";
   $tab_ger_campos['supplier'] = "on";
   $tab_def_campos['supplier'] = "supplier";
   $tab_labels["supplier"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tabel_piutang_transaksi']['labels']["supplier"])) ? $_SESSION['sc_session'][$sc_init]['grid_tabel_piutang_transaksi']['labels']["supplier"] : "Supplier";
   $tab_ger_campos['nominal'] = "on";
   $tab_def_campos['nominal'] = "nominal";
   $tab_labels["nominal"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tabel_piutang_transaksi']['labels']["nominal"])) ? $_SESSION['sc_session'][$sc_init]['grid_tabel_piutang_transaksi']['labels']["nominal"] : "Nominal";
   $tab_ger_campos['kd_giro'] = "on";
   $tab_def_campos['kd_giro'] = "kd_giro";
   $tab_labels["kd_giro"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tabel_piutang_transaksi']['labels']["kd_giro"])) ? $_SESSION['sc_session'][$sc_init]['grid_tabel_piutang_transaksi']['labels']["kd_giro"] : "Kode Giro";
   $tab_ger_campos['tgl'] = "on";
   $tab_def_campos['tgl'] = "tgl";
   $tab_labels["tgl"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tabel_piutang_transaksi']['labels']["tgl"])) ? $_SESSION['sc_session'][$sc_init]['grid_tabel_piutang_transaksi']['labels']["tgl"] : "Tgl";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_tabel_piutang_transaksi']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_tabel_piutang_transaksi']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_tabel_piutang_transaksi']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tabel_piutang_transaksi']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tabel_piutang_transaksi']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_tabel_piutang_transaksi']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_tabel_piutang_transaksi']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_tabel_piutang_transaksi']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_tabel_piutang_transaksi']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_tabel_piutang_transaksi_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_tabel_piutang_transaksi']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_tabel_piutang_transaksi']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_tabel_piutang_transaksi']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_tabel_piutang_transaksi']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_tabel_piutang_transaksi']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
