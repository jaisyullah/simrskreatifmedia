...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "tgl";$Nm_datas[] = "tgl";$Nm_numeric[] = "id";$Nm_numeric[] = "nominal";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_supplier_cond" name="supplier_cond" onChange="nm_campos_between(document.getElementById('id_vis_supplier'), this, 'supplier')">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_nominal_cond" name="nominal_cond" onChange="nm_campos_between(document.getElementById('id_vis_nominal'), this, 'nominal')">
