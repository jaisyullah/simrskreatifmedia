<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tabel_piutang_transaksi']['sc_process_barr'] = true;
require_once('../grid_tabel_piutang_transaksi/index.php');
unset($_SESSION['scriptcase']['grid_tabel_piutang_transaksi']['sc_process_barr']);
$ExportCtrl = new grid_tabel_piutang_transaksi_export_control;
$ExportCtrl->Export_barr();

class grid_tabel_piutang_transaksi_export_control
{
