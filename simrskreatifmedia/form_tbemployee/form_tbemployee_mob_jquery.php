...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_dob_hora' + iSeqRow).bind('blur', function() { sc_form_tbemployee_dob_onblur(this, iSeqRow) })
                                      .bind('focus', function() { sc_form_tbemployee_dob_onfocus(this, iSeqRow) });
  ...
  $('#id_sc_field_lastupdate_hora' + iSeqRow).bind('blur', function() { sc_form_tbemployee_lastupdate_onblur(this, iSeqRow) })
                                             .bind('focus', function() { sc_form_tbemployee_lastupdate_onfocus(this, iSeqRow) });
  ...
  $('#id_sc_field_enterdate_hora' + iSeqRow).bind('blur', function() { sc_form_tbemployee_enterdate_onblur(this, iSeqRow) })
                                            .bind('focus', function() { sc_form_tbemployee_enterdate_onfocus(this, iSeqRow) });
  ...
  $('#id_sc_field_resigndate_hora' + iSeqRow).bind('blur', function() { sc_form_tbemployee_resigndate_onblur(this, iSeqRow) })
                                             .bind('focus', function() { sc_form_tbemployee_resigndate_onfocus(this, iSeqRow) });
...
function scHidePage(pageNo) {
	$("#id_form_tbemployee_mob_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_dob" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_tbemployee_mob_validate_dob(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_lastupdate" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_tbemployee_mob_validate_lastupdate(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_enterdate" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_tbemployee_mob_validate_enterdate(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_resigndate" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_tbemployee_mob_validate_resigndate(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
