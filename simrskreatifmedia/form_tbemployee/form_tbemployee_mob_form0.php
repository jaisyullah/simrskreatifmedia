...
?>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbemployee_mob']['embutida_pdf']))
 {
 ?>
...
<?php
include_once("form_tbemployee_mob_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_tbemployee_mob_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbemployee_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbemployee_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbemployee_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbemployee_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbemployee_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbemployee_mob']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbemployee_mob']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbemployee_mob']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
?>
<body class="scFormPage" style="<?php echo $remove_margin . $str_iframe_body; ?>">
<?php

if (isset($_SESSION['scriptcase']['form_tbemployee']['error_buffer']) && '' != $_SESSION['scriptcase']['form_tbemployee']['error_buffer'])
{
    echo $_SESSION['scriptcase']['form_tbemployee']['error_buffer'];
}
...
<?php
 include_once("form_tbemployee_mob_js0.php");
?>
<script type="text/javascript"> 
...
<form  name="F1" method="post" 
               action="form_tbemployee_mob.php" 
               target="_self">
<input type="hidden" name="nmgp_url_saida" value="">
<?php
if ('novo' == $this->nmgp_opcao || 'incluir' == $this->nmgp_opcao)
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbemployee_mob']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbemployee_mob']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_tbemployee_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_tbemployee_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbemployee_mob']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbemployee_mob']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbemployee_mob']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbemployee_mob']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbemployee_mob']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbemployee_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbemployee_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbemployee_mob']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbemployee_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbemployee_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbemployee_mob']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbemployee_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbemployee_mob']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbemployee_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbemployee_mob']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbemployee_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbemployee_mob']['fast_search'][2] : "";
?> 
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbemployee_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbemployee_mob']['run_iframe'] != "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbemployee_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbemployee_mob']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbemployee_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbemployee_mob']['run_iframe'] == "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbemployee_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbemployee_mob']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbemployee_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbemployee_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbemployee_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbemployee_mob']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbemployee_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbemployee_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbemployee_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbemployee_mob']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbemployee_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbemployee_mob']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_staffcode_line" id="hidden_field_data_staffcode" style="<?php echo $sStyleHidden_staffcode; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_staffcode_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_staffcode_label"><span id="id_label_staffcode"><?php echo $this->nm_new_label['staffcode']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbemployee_mob']['php_cmp_required']['staffcode']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbemployee_mob']['php_cmp_required']['staffcode'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_appcode_line" id="hidden_field_data_appcode" style="<?php echo $sStyleHidden_appcode; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_appcode_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_appcode_label"><span id="id_label_appcode"><?php echo $this->nm_new_label['appcode']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_staffname_line" id="hidden_field_data_staffname" style="<?php echo $sStyleHidden_staffname; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_staffname_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_staffname_label"><span id="id_label_staffname"><?php echo $this->nm_new_label['staffname']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_surname_line" id="hidden_field_data_surname" style="<?php echo $sStyleHidden_surname; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_surname_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_surname_label"><span id="id_label_surname"><?php echo $this->nm_new_label['surname']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_pob_line" id="hidden_field_data_pob" style="<?php echo $sStyleHidden_pob; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_pob_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_pob_label"><span id="id_label_pob"><?php echo $this->nm_new_label['pob']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_dob_line" id="hidden_field_data_dob" style="<?php echo $sStyleHidden_dob; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_dob_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_dob_label"><span id="id_label_dob"><?php echo $this->nm_new_label['dob']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbemployee_mob']['php_cmp_required']['dob']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbemployee_mob']['php_cmp_required']['dob'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_addressktp_line" id="hidden_field_data_addressktp" style="<?php echo $sStyleHidden_addressktp; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_addressktp_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_addressktp_label"><span id="id_label_addressktp"><?php echo $this->nm_new_label['addressktp']; ?></span></span><br>
<?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_cityktp_line" id="hidden_field_data_cityktp" style="<?php echo $sStyleHidden_cityktp; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_cityktp_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_cityktp_label"><span id="id_label_cityktp"><?php echo $this->nm_new_label['cityktp']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_statustinggal_line" id="hidden_field_data_statustinggal" style="<?php echo $sStyleHidden_statustinggal; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_statustinggal_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_statustinggal_label"><span id="id_label_statustinggal"><?php echo $this->nm_new_label['statustinggal']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_marstatus_line" id="hidden_field_data_marstatus" style="<?php echo $sStyleHidden_marstatus; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_marstatus_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_marstatus_label"><span id="id_label_marstatus"><?php echo $this->nm_new_label['marstatus']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_suku_line" id="hidden_field_data_suku" style="<?php echo $sStyleHidden_suku; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_suku_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_suku_label"><span id="id_label_suku"><?php echo $this->nm_new_label['suku']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_wn_line" id="hidden_field_data_wn" style="<?php echo $sStyleHidden_wn; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_wn_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_wn_label"><span id="id_label_wn"><?php echo $this->nm_new_label['wn']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_simtype_line" id="hidden_field_data_simtype" style="<?php echo $sStyleHidden_simtype; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_simtype_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_simtype_label"><span id="id_label_simtype"><?php echo $this->nm_new_label['simtype']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_simno_line" id="hidden_field_data_simno" style="<?php echo $sStyleHidden_simno; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_simno_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_simno_label"><span id="id_label_simno"><?php echo $this->nm_new_label['simno']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_ktp_line" id="hidden_field_data_ktp" style="<?php echo $sStyleHidden_ktp; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_ktp_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_ktp_label"><span id="id_label_ktp"><?php echo $this->nm_new_label['ktp']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_npwp_line" id="hidden_field_data_npwp" style="<?php echo $sStyleHidden_npwp; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_npwp_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_npwp_label"><span id="id_label_npwp"><?php echo $this->nm_new_label['npwp']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_hobby_line" id="hidden_field_data_hobby" style="<?php echo $sStyleHidden_hobby; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_hobby_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_hobby_label"><span id="id_label_hobby"><?php echo $this->nm_new_label['hobby']; ?></span></span><br>
<?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_lastupdate_line" id="hidden_field_data_lastupdate" style="<?php echo $sStyleHidden_lastupdate; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_lastupdate_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_lastupdate_label"><span id="id_label_lastupdate"><?php echo $this->nm_new_label['lastupdate']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_nipman_line" id="hidden_field_data_nipman" style="<?php echo $sStyleHidden_nipman; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_nipman_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_nipman_label"><span id="id_label_nipman"><?php echo $this->nm_new_label['nipman']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_department_line" id="hidden_field_data_department" style="<?php echo $sStyleHidden_department; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_department_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_department_label"><span id="id_label_department"><?php echo $this->nm_new_label['department']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_fp_line" id="hidden_field_data_fp" style="<?php echo $sStyleHidden_fp; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fp_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_fp_label"><span id="id_label_fp"><?php echo $this->nm_new_label['fp']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_enterdate_line" id="hidden_field_data_enterdate" style="<?php echo $sStyleHidden_enterdate; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_enterdate_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_enterdate_label"><span id="id_label_enterdate"><?php echo $this->nm_new_label['enterdate']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_resigndate_line" id="hidden_field_data_resigndate" style="<?php echo $sStyleHidden_resigndate; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_resigndate_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_resigndate_label"><span id="id_label_resigndate"><?php echo $this->nm_new_label['resigndate']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_resignnote_line" id="hidden_field_data_resignnote" style="<?php echo $sStyleHidden_resignnote; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_resignnote_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_resignnote_label"><span id="id_label_resignnote"><?php echo $this->nm_new_label['resignnote']; ?></span></span><br>
<?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_iscompleted_line" id="hidden_field_data_iscompleted" style="<?php echo $sStyleHidden_iscompleted; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_iscompleted_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_iscompleted_label"><span id="id_label_iscompleted"><?php echo $this->nm_new_label['iscompleted']; ?></span></span><br>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbemployee_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbemployee_mob']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbemployee_mob']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbemployee_mob']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbemployee_mob']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbemployee_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbemployee_mob']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbemployee_mob']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbemployee_mob']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_tbemployee_mob");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_tbemployee_mob");
 parent.scAjaxDetailHeight("form_tbemployee_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbemployee_mob']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
