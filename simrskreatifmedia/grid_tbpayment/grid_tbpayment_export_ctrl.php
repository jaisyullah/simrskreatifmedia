<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tbpayment']['sc_process_barr'] = true;
require_once('../grid_tbpayment/index.php');
unset($_SESSION['scriptcase']['grid_tbpayment']['sc_process_barr']);
$ExportCtrl = new grid_tbpayment_export_control;
$ExportCtrl->Export_barr();

class grid_tbpayment_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - History Pembayaran Poli :: Excel</TITLE>
