<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_tbpayment']['glo_nm_path_imag_temp'] . "/sc_apl_default_simrskreatifmedia.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_tbpayment_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_tbpayment_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbpayment']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tbpayment']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["tglbayar"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbpayment']['labels']["tglbayar"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbpayment']['labels']["tglbayar"] : "Tgl Bayar";
   $tab_ger_campos['nopayment'] = "on";
   $tab_def_campos['nopayment'] = "noPayment";
   $tab_labels["nopayment"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbpayment']['labels']["nopayment"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbpayment']['labels']["nopayment"] : "No Payment";
   $tab_ger_campos['nostruk'] = "on";
   $tab_def_campos['nostruk'] = "noStruk";
   $tab_labels["nostruk"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbpayment']['labels']["nostruk"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbpayment']['labels']["nostruk"] : "No Struk";
   $tab_ger_campos['trancode'] = "on";
   $tab_def_campos['trancode'] = "tranCode";
   $tab_labels["trancode"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbpayment']['labels']["trancode"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbpayment']['labels']["trancode"] : "Kode Transaksi";
   $tab_ger_campos['custcode'] = "on";
   $tab_def_campos['custcode'] = "custCode";
   $tab_labels["custcode"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbpayment']['labels']["custcode"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbpayment']['labels']["custcode"] : "No. RM";
...
ORDER BY name, salut";
   ...
   $tab_labels["sc_field_1"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbpayment']['labels']["sc_field_1"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbpayment']['labels']["sc_field_1"] : "Nama Pasien";
...
ORDER BY diagnosa1";
   ...
   $tab_labels["diagnosa"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbpayment']['labels']["diagnosa"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbpayment']['labels']["diagnosa"] : "Diagnosa";
   $tab_ger_campos['jmlbayar'] = "on";
   $tab_def_campos['jmlbayar'] = "jmlBayar";
   $tab_labels["jmlbayar"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbpayment']['labels']["jmlbayar"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbpayment']['labels']["jmlbayar"] : "Jml Bayar";
   $tab_ger_campos['jenispayment'] = "on";
   $tab_def_campos['jenispayment'] = "jenisPayment";
   $tab_labels["jenispayment"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbpayment']['labels']["jenispayment"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbpayment']['labels']["jenispayment"] : "Jenis Payment";
   $tab_ger_campos['kasir'] = "on";
   $tab_def_campos['kasir'] = "kasir";
   $tab_labels["kasir"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbpayment']['labels']["kasir"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbpayment']['labels']["kasir"] : "Kasir";
   $tab_ger_campos['totals'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['totals'] = "totals";
   }
   else
   {
       $tab_def_campos['totals'] = "if(jmlTagihan<=jmlBayar,jmlTagihan,jmlBayar)";
   }
   $tab_labels["totals"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbpayment']['labels']["totals"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbpayment']['labels']["totals"] : "Total Tagihan";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_tbpayment']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_tbpayment']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_tbpayment']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbpayment']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tbpayment']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_tbpayment']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_tbpayment']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_tbpayment']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_tbpayment']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - History Pembayaran Poli</TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_tbpayment_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_tbpayment']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_tbpayment']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_tbpayment']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_tbpayment']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_tbpayment']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
