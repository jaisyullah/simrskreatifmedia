...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_deskripsi_rkk_cond" name="deskripsi_rkk_cond" onChange="nm_campos_between(document.getElementById('id_vis_deskripsi_rkk'), this, 'deskripsi_rkk')">
      ...
      <br><span id="id_hide_deskripsi_rkk"  <?php echo $str_hide_deskripsi_rkk?>><?php
      if ($deskripsi_rkk != "")
      {
      $deskripsi_rkk_look = substr($this->Db->qstr($deskripsi_rkk), 1, -1); 
      $nmgp_def_dados = array(); 
