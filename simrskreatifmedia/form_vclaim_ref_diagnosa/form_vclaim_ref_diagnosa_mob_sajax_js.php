  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_vclaim_ref_diagnosa_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_vclaim_ref_diagnosa_mob_form();
	}

  // ---------- Validate kode_nama_diagnosa
  function do_ajax_form_vclaim_ref_diagnosa_mob_validate_kode_nama_diagnosa()
  {
    var nomeCampo_kode_nama_diagnosa = "kode_nama_diagnosa";
    var var_kode_nama_diagnosa = scAjaxGetFieldText(nomeCampo_kode_nama_diagnosa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_ref_diagnosa_mob_validate_kode_nama_diagnosa(var_kode_nama_diagnosa, var_script_case_init, do_ajax_form_vclaim_ref_diagnosa_mob_validate_kode_nama_diagnosa_cb);
  } // do_ajax_form_vclaim_ref_diagnosa_mob_validate_kode_nama_diagnosa

  function do_ajax_form_vclaim_ref_diagnosa_mob_validate_kode_nama_diagnosa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "kode_nama_diagnosa";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_ref_diagnosa_mob_validate_kode_nama_diagnosa_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_vclaim_ref_diagnosa_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_vclaim_ref_diagnosa_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_kode_nama_diagnosa = scAjaxGetFieldText("kode_nama_diagnosa");
    ...
    scAjaxProcOn();
    x_ajax_form_vclaim_ref_diagnosa_mob_submit_form(var_kode_nama_diagnosa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_vclaim_ref_diagnosa_mob_submit_form_cb);
  } // do_ajax_form_vclaim_ref_diagnosa_mob_submit_form

  function do_ajax_form_vclaim_ref_diagnosa_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_vclaim_ref_diagnosa_mob_submit_form_cb_after_alert);
  } // do_ajax_form_vclaim_ref_diagnosa_mob_submit_form_cb
  function do_ajax_form_vclaim_ref_diagnosa_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_vclaim_ref_diagnosa_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_vclaim_ref_diagnosa_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_form_vclaim_ref_diagnosa_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_ref_diagnosa_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_vclaim_ref_diagnosa_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_vclaim_ref_diagnosa_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_vclaim_ref_diagnosa_mob_navigate_form_cb
  function do_ajax_form_vclaim_ref_diagnosa_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_vclaim_ref_diagnosa_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_vclaim_ref_diagnosa_mob_navigate_form_cb_after_alert
  function sc_hide_form_vclaim_ref_diagnosa_mob_form()
  {
  ...
  ajax_field_list[0] = "kode_nama_diagnosa";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "kode_nama_diagnosa": {"label": "Kode/Nama", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "kode_nama_diagnosa": new Array()
  };
  ajax_field_mult["kode_nama_diagnosa"][1] = "kode_nama_diagnosa";

  var ajax_field_id = {
    "kode_nama_diagnosa": new Array("hidden_field_label_kode_nama_diagnosa", "hidden_field_data_kode_nama_diagnosa")
  };

  var ajax_read_only = {
    "kode_nama_diagnosa": "off"
  };
