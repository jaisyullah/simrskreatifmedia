<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tbantrian']['sc_process_barr'] = true;
require_once('../grid_tbantrian/index.php');
unset($_SESSION['scriptcase']['grid_tbantrian']['sc_process_barr']);
$ExportCtrl = new grid_tbantrian_export_control;
$ExportCtrl->Export_barr();

class grid_tbantrian_export_control
{
