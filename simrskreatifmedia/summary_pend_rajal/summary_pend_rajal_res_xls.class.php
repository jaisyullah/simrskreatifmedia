...
class summary_pend_rajal_res_xls
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_xls()
   {
      ...
      $this->grava_arquivo();
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['summary_pend_rajal']['xls_res_grid']))
      {
          return;
      }
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['summary_pend_rajal']['xls_res_grid']) && !$this->Ini->sc_export_ajax) {
   ...
   function grava_arquivo()
   {
      ...
      $this->comp_field   = $_SESSION['sc_session'][$this->Ini->sc_page]['summary_pend_rajal']['pivot_group_by'];
      ...
      $this->array_titulos = $_SESSION['sc_session'][$this->Ini->sc_page]['summary_pend_rajal']['arr_export']['label'];
      $this->array_linhas  = $_SESSION['sc_session'][$this->Ini->sc_page]['summary_pend_rajal']['arr_export']['data'];
      $b_display = false;
      $contr_rowspan = array();
      $contr_colspan = array();
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['summary_pend_rajal']['xls_res_grid']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['summary_pend_rajal']['xls_res_sheet'] = $this->Xls_f;
      }
