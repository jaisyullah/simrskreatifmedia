...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____summary_pend_rajal"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____summary_pend_rajal"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['summary_pend_rajal']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['summary_pend_rajal']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['summary_pend_rajal']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['summary_pend_rajal']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['summary_pend_rajal']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>summary_pend_rajal</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['summary_pend_rajal']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['summary_pend_rajal']['embutida_filho'] as $ind => $sc_init)
          {
