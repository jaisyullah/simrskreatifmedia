<?php
@session_start() ;
$_SESSION['scriptcase']['summary_pend_rajal']['sc_process_barr'] = true;
require_once('../summary_pend_rajal/index.php');
unset($_SESSION['scriptcase']['summary_pend_rajal']['sc_process_barr']);
$ExportCtrl = new summary_pend_rajal_export_control;
$ExportCtrl->Export_barr();

class summary_pend_rajal_export_control
{
