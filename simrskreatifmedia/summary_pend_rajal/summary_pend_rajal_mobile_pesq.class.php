...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_judul_cond" name="judul_cond" onChange="nm_campos_between(document.getElementById('id_vis_judul'), this, 'judul')">
      ...
      <br><span id="id_hide_judul"  <?php echo $str_hide_judul?>><?php
      if ($judul != "")
      {
      $judul_look = substr($this->Db->qstr($judul), 1, -1); 
      $nmgp_def_dados = array(); 
