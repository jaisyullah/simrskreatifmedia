<?php
@session_start() ;
$_SESSION['scriptcase']['pdfreport_tbpayment']['sc_process_barr'] = true;
require_once('../pdfreport_tbpayment/index.php');
unset($_SESSION['scriptcase']['pdfreport_tbpayment']['sc_process_barr']);
$ExportCtrl = new pdfreport_tbpayment_export_control;
$ExportCtrl->Export_barr();

class pdfreport_tbpayment_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_chart_title'] ?> tbpayment :: Excel</TITLE>
