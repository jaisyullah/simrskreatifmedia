...
class grid_tbtranrad_his_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   { 
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['grid_tbtranrad_his']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['grid_tbtranrad_his']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['where_resumo']);
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['proc_res'] = true;
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['res_hrz'];
      $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
      $dir_raiz          = substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['where_resumo'] = "";
      }
      $this->inicializa_vars();
      $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['SC_Ind_Groupby'];
      $this->Total->$Gb_geral();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['contr_total_geral'] == "OK")
      {
          $this->array_total_trandate = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['arr_total']['trandate'];
      }
      else
      {
          $this->array_total_trandate = array();
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['tot_geral'][1] == 0)
      {
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          $this->drawMatrix();
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['arr_total']['trandate'] = $this->array_total_trandate;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['json_use_label'])
       {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['labels']['trancode']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['labels']['trancode'] = "Kode Transaksi"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['labels']['struk']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['labels']['struk'] = "No Struk"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['labels']['custcode']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['labels']['custcode'] = "No. RM"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['labels']['nama']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['labels']['nama'] = "Nama"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['labels']['sc_field_0']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['labels']['sc_field_0'] = "J/K"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['labels']['docname']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['labels']['docname'] = "Nama Dokter"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['labels']['note']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['labels']['note'] = "Catatan"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['labels']['trandate']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['labels']['trandate'] = "Tgl. Transaksi"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['labels']['finishdate']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['labels']['finishdate'] = "Tgl. Selesai"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['labels']['inapcode']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['labels']['inapcode'] = "Kode Inap"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['labels']['source']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['labels']['source'] = "Source"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['labels']['doccode']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['labels']['doccode'] = "Doccode"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['labels']['periksacode']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['labels']['periksacode'] = "Periksacode"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['labels']['enterdate']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['labels']['enterdate'] = "Enterdate"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['labels']['status']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['labels']['status'] = "Status"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['labels']['contrast']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['labels']['contrast'] = "Contrast"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['labels']['keterangan']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['labels']['keterangan'] = "Keterangan"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['labels']['deleted']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['labels']['deleted'] = "Deleted"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['labels']['tlc']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['labels']['tlc'] = "Tlc"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['labels']['custtlc']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['labels']['custtlc'] = "Custtlc"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['labels']['poli']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['labels']['poli'] = "Poli"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['labels']['diag']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['labels']['diag'] = "Diag"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['labels']['jalancode']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['labels']['jalancode'] = "Jalancode"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['labels']['periksaname']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['labels']['periksaname'] = "Periksaname"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['labels']['instcode']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['labels']['instcode'] = "Instcode"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['labels']['jenisinst']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['labels']['jenisinst'] = "Jenisinst"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['labels']['inapclass']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['labels']['inapclass'] = "Inapclass"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['labels']['tipehasil']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['labels']['tipehasil'] = "Tipehasil"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['labels']['urutno']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['labels']['urutno'] = "Urutno"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['labels']['bucode']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['labels']['bucode'] = "Bucode"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['labels']['buname']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['labels']['buname'] = "Buname"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['labels']['asal']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['labels']['asal'] = "Asal"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['labels']['inst']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['labels']['inst'] = "Inst"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['labels']['tujuan']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['labels']['tujuan'] = "Tujuan"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['labels']['petugas']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['labels']['petugas'] = "Petugas"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['labels']['asallayanan']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['labels']['asallayanan'] = "Asallayanan"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['labels']['sep']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['labels']['sep'] = "Sep"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['labels']['kelompoktarif']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['labels']['kelompoktarif'] = "Kelompoktarif"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['labels']['ispl']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['labels']['ispl'] = "Ispl"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['labels']['plcode']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['labels']['plcode'] = "Plcode"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['labels']['plname']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['labels']['plname'] = "Plname"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['labels']['plsex']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['labels']['plsex'] = "Plsex"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['labels']['statusberkas']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['labels']['statusberkas'] = "Statusberkas"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['labels']['statusberkasdate']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['labels']['statusberkasdate'] = "Statusberkasdate"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['labels']['picberkas']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['labels']['picberkas'] = "Picberkas"; 
       }
       //-----
       $this->comp_field_nm = array(
           'trandate' => 0,
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['summarizing_fields_order']['byTglTran']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['summarizing_fields_order']['byTglTran'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['summarizing_fields_order']['byTglTran'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['summarizing_fields_display']['byTglTran'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['summarizing_fields_display']['byTglTran'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['summarizing_fields_display']['byTglTran'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['summarizing_fields_display']['byTglTran'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['summarizing_fields_display']['byTglTran'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['summarizing_fields_display']['byTglTran'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['summarizing_fields_display']['byTglTran'] as $i_sum => $d_sum)
           {
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['pivot_order_level'] = -1;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['pivot_tabular_label'];
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_tbtranrad_his@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function buildChart()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['pivot_charts']    = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['pivot_orig']      = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['comb_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['comb_table_def']  = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['anlt_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['anlt_table_def']  = array();
	...
	function filterChartsByGroupbyLevel() {
		...
		if (isset($nmgp_opcao) && ('pdf' == $nmgp_opcao || 'pdf_res' == $nmgp_opcao) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['chart_level']) && '' !== $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['chart_level']) {
			$applyFilter = true;
		}
		elseif (isset($nmgp_opcao) && 'image_res' == $nmgp_opcao && isset($_POST['chart_level']) && '' !== $_POST['chart_level']) {
			$applyFilter = true;
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['chart_level'] = $_POST['chart_level'];
		}
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['pivot_charts'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['pivot_orig'];

		if ($applyFilter) {
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['pivot_charts'] as $chartIndex => $chartData) {
				...
				if ($groupbyLevel > $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['chart_level']) {
					unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['pivot_charts'][$chartIndex]);
				}
			}
		}

		$this->comp_chart_data = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['pivot_charts'];
	}
           ...
           foreach ($a_totals as $i_total => $values)
           {
               ...
               if (isset($this->comp_chart_config[$key_config]))
               {
                   ...
                   foreach ($a_keys as $tmp_key)
                   {
                       ...
                       $xml_links[]  = $this->getFusionLink('sc_grid_tbtranrad_his_' . session_id() . '_!!!' . implode('_', array_merge(array($group + 1, $i_total), $link_index)) . '!!!.json');
                   }
                   ...
                   $this->comp_chart_data[$key_data]['xml']        = $this->getFusionLink('sc_grid_tbtranrad_his_' . session_id() . '_!!!' . implode('_', array_merge(array($group, $i_total), $param)) . '!!!.json');
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['proc_pdf_vert']){ 
   ...
   {
       if (!$res_chart && $this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['json_use_format']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['json_use_format'])
       {
           return $valor_campo;
       }
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         $this->monta_html_ini();
         $this->monta_cabecalho();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function inicializa_vars()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         require_once($this->Ini->path_aplicacao . "grid_tbtranrad_his_total.class.php"); 
      }
      ...
      $this->Total   = new grid_tbtranrad_his_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['arr_total'][$cmp_gb];
      }
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['dashboard_refresh_after_chart'] = 'resumo';
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['doc_word'])
{
   ...
   { 
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_tbtranrad_his_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grid_tbtranrad_his_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_tbtranrad_his_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['num_css'] . '.css');
...
$nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_tbtranrad_his/grid_tbtranrad_his_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\">\r\n");
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['doc_word']) 
      {
      ...
      {
          $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['dashboard_info']['remove_margin'] ? ' style="margin: 0"' : '';
          $nm_saida->saida(" <BODY class=\"" . $this->css_scGridPage . "\"" . $remove_margin . ">\r\n");
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['embutida'])
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top_normal()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['pdf'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "Rpdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_tbtranrad_his/grid_tbtranrad_his_config_pdf.php?nm_opc=pdf_res&nm_target=0&nm_cor=cor&papel=1&orientacao=1&bookmarks=1&largura=1200&conf_larg=S&conf_fonte=10&grafico=S&sc_ver_93=" . s . "&nm_tem_gb=s&nm_res_cons=s&nm_ini_pdf_res=resume,chart&nm_all_modules=grid,resume,chart&password=n&summary_export_columns=N&nm_label_group=S&nm_all_cab=N&nm_all_label=N&pdf_zip=N&nm_orient_grid=2&origem=res&language=id&conf_socor=N&script_case_init=" . $this->Ini->sc_page . "&app_name=grid_tbtranrad_his&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if ($this->nmgp_botoes['chart_detail'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("grid_tbtranrad_his_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
   ...
   function monta_html_fim()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['print_all'])
      {
          $this->grafico_pdf();
      }
      $nm_saida->saida("</TABLE>\r\n");
      $nm_saida->saida("<link rel=\"stylesheet\" type=\"text/css\" href=\"../_lib/css/" . $this->Ini->str_schema_all . "_sweetalert.css\" />\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_tbtranrad_his']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_tbtranrad_his']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'grid_tbtranrad_his_config_pivot.php?nome_apl=grid_tbtranrad_his&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=id&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_tbtranrad_his_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "grid_tbtranrad_his/grid_tbtranrad_his_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
...
//--- 
   ...
   {
      global $nm_saida;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtranrad_his']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
