...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_tbtranrad_his"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_tbtranrad_his"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tbtranrad_his']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_tbtranrad_his']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tbtranrad_his']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_tbtranrad_his']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_tbtranrad_his']['sc_modal']);
           if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tbtranrad_his']['opc_psq']))
           {
...
<HTML>
<HEAD>
 <TITLE>grid_tbtranrad_his</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_tbtranrad_his']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_tbtranrad_his']['embutida_filho'] as $ind => $sc_init)
          {
