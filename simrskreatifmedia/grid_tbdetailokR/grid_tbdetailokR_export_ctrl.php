<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tbdetailokR']['sc_process_barr'] = true;
require_once('../grid_tbdetailokR/index.php');
unset($_SESSION['scriptcase']['grid_tbdetailokR']['sc_process_barr']);
$ExportCtrl = new grid_tbdetailokR_export_control;
$ExportCtrl->Export_barr();

class grid_tbdetailokR_export_control
{
