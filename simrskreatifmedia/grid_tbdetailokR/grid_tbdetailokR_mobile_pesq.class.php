...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "birthDate";$Nm_datas[] = "birthDate";$Nm_datas[] = "anesTime";$Nm_datas[] = "anesTime";$Nm_datas[] = "desinfecttime";$Nm_datas[] = "desinfecttime";$Nm_datas[] = "operTime";$Nm_datas[] = "operTime";$Nm_datas[] = "tutupLukaTime";$Nm_datas[] = "tutupLukaTime";$Nm_datas[] = "rrOutTime";$Nm_datas[] = "rrOutTime";$Nm_datas[] = "tranDate";$Nm_datas[] = "tranDate";$Nm_datas[] = "entryDate";$Nm_datas[] = "entryDate";$Nm_datas[] = "awalObs";$Nm_datas[] = "awalObs";$Nm_datas[] = "akhirObs";$Nm_datas[] = "akhirObs";$Nm_numeric[] = "id";$Nm_numeric[] = "babybirth";$Nm_numeric[] = "bb";$Nm_numeric[] = "tb";$Nm_numeric[] = "lingkar";$Nm_numeric[] = "hidup";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_desinfecttime"  <?php echo $str_hide_desinfecttime?>>
<?php
  $Form_base = "ddmmyyyyhhiiss";
  $date_format_show = "";
  $Str_date = str_replace("a", "y", strtolower($_SESSION['scriptcase']['reg_conf']['date_format']));
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_opertime"  <?php echo $str_hide_opertime?>>
<?php
  $Form_base = "ddmmyyyyhhiiss";
  $date_format_show = "";
  $Str_date = str_replace("a", "y", strtolower($_SESSION['scriptcase']['reg_conf']['date_format']));
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_tutuplukatime"  <?php echo $str_hide_tutuplukatime?>>
<?php
  $Form_base = "ddmmyyyyhhiiss";
  $date_format_show = "";
  $Str_date = str_replace("a", "y", strtolower($_SESSION['scriptcase']['reg_conf']['date_format']));
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_rrouttime"  <?php echo $str_hide_rrouttime?>>
<?php
  $Form_base = "ddmmyyyyhhiiss";
  $date_format_show = "";
  $Str_date = str_replace("a", "y", strtolower($_SESSION['scriptcase']['reg_conf']['date_format']));
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_tindakanrr"  <?php echo $str_hide_tindakanrr?>><?php
      if ($tindakanrr != "")
      {
      $tindakanrr_look = substr($this->Db->qstr($tindakanrr), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_vc"  <?php echo $str_hide_vc?>><?php
      if ($vc != "")
      {
      $vc_look = substr($this->Db->qstr($vc), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_cultur"  <?php echo $str_hide_cultur?>><?php
      if ($cultur != "")
      {
      $cultur_look = substr($this->Db->qstr($cultur), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_sewa"  <?php echo $str_hide_sewa?>><?php
      if ($sewa != "")
      {
      $sewa_look = substr($this->Db->qstr($sewa), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_asa"  <?php echo $str_hide_asa?>><?php
      if ($asa != "")
      {
      $asa_look = substr($this->Db->qstr($asa), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_entrydate"  <?php echo $str_hide_entrydate?>>
<?php
  $Form_base = "ddmmyyyyhhiiss";
  $date_format_show = "";
  $Str_date = str_replace("a", "y", strtolower($_SESSION['scriptcase']['reg_conf']['date_format']));
