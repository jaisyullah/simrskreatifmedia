...
class grid_tbdetailokR_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['path_libs_php'] = $this->Ini->path_lib_php;
   ...
   function init()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['opcao'] = "igual";
   }
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_tbdetailokR_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_tbdetailokR_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_tbdetailokR_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_tindakanrr')
      {
          $tindakanrr = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_tindakanrr($tindakanrr);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_vc')
      {
          $vc = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_vc($vc);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_cultur')
      {
          $cultur = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_cultur($cultur);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_sewa')
      {
          $sewa = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_sewa($sewa);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_asa')
      {
          $asa = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_asa($asa);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function lookup_ajax_tindakanrr($tindakanrr)
   {
      $tindakanrr = substr($this->Db->qstr($tindakanrr), 1, -1);
            $tindakanrr_look = substr($this->Db->qstr($tindakanrr), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct tindakanrr from " . $this->Ini->nm_tabela . " where  tindakanrr like '%" . $tindakanrr . "%' order by tindakanrr"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
   ...
   function lookup_ajax_vc($vc)
   {
      $vc = substr($this->Db->qstr($vc), 1, -1);
            $vc_look = substr($this->Db->qstr($vc), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct VC from " . $this->Ini->nm_tabela . " where  VC like '%" . $vc . "%' order by VC"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
   ...
   function lookup_ajax_cultur($cultur)
   {
      $cultur = substr($this->Db->qstr($cultur), 1, -1);
            $cultur_look = substr($this->Db->qstr($cultur), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct Cultur from " . $this->Ini->nm_tabela . " where  Cultur like '%" . $cultur . "%' order by Cultur"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
   ...
   function lookup_ajax_sewa($sewa)
   {
      $sewa = substr($this->Db->qstr($sewa), 1, -1);
            $sewa_look = substr($this->Db->qstr($sewa), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct Sewa from " . $this->Ini->nm_tabela . " where  Sewa like '%" . $sewa . "%' order by Sewa"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
   ...
   function lookup_ajax_asa($asa)
   {
      $asa = substr($this->Db->qstr($asa), 1, -1);
            $asa_look = substr($this->Db->qstr($asa), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct ASA from " . $this->Ini->nm_tabela . " where  ASA like '%" . $asa . "%' order by ASA"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['decimal_db'] == ".")
         {
            $nm_aspas  = "";
            $nm_aspas1 = "";
         }
      ...
      $Nm_datas[] = "birthDate";$Nm_datas[] = "birthDate";$Nm_datas[] = "anesTime";$Nm_datas[] = "anesTime";$Nm_datas[] = "desinfecttime";$Nm_datas[] = "desinfecttime";$Nm_datas[] = "operTime";$Nm_datas[] = "operTime";$Nm_datas[] = "tutupLukaTime";$Nm_datas[] = "tutupLukaTime";$Nm_datas[] = "rrOutTime";$Nm_datas[] = "rrOutTime";$Nm_datas[] = "tranDate";$Nm_datas[] = "tranDate";$Nm_datas[] = "entryDate";$Nm_datas[] = "entryDate";$Nm_datas[] = "awalObs";$Nm_datas[] = "awalObs";$Nm_datas[] = "akhirObs";$Nm_datas[] = "akhirObs";
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['SC_sep_date']))
          {
              $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['SC_sep_date'];
              $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['SC_sep_date1'];
          }
      }
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - Kamar Operasi</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_tbdetailokR/grid_tbdetailokR_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_tbdetailokR_ajax_search.js"></script>
 <script type="text/javascript" src="grid_tbdetailokR_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_tbdetailokR_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_tbdetailokR']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_tbdetailokR']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
if (count($this->nm_mens_alert) || count($this->Ini->nm_mens_alert)) {
   ...
   if (isset($this->nm_mens_alert) && !empty($this->nm_mens_alert))
   {
       foreach ($this->nm_mens_alert as $i_alert => $mensagem)
       {
           ...
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['ajax_nav'])
           { 
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_desinfecttime_cond#NMF#' + search_get_sel_txt('SC_desinfecttime_cond') + '@NMF@';
  str_out += 'SC_desinfecttime_dia#NMF#' + search_get_sel_txt('SC_desinfecttime_dia') + '@NMF@';
  str_out += 'SC_desinfecttime_mes#NMF#' + search_get_sel_txt('SC_desinfecttime_mes') + '@NMF@';
  str_out += 'SC_desinfecttime_ano#NMF#' + search_get_sel_txt('SC_desinfecttime_ano') + '@NMF@';
  str_out += 'SC_desinfecttime_input_2_dia#NMF#' + search_get_sel_txt('SC_desinfecttime_input_2_dia') + '@NMF@';
  str_out += 'SC_desinfecttime_input_2_mes#NMF#' + search_get_sel_txt('SC_desinfecttime_input_2_mes') + '@NMF@';
  str_out += 'SC_desinfecttime_input_2_ano#NMF#' + search_get_sel_txt('SC_desinfecttime_input_2_ano') + '@NMF@';
  str_out += 'SC_desinfecttime_hor#NMF#' + search_get_sel_txt('SC_desinfecttime_hor') + '@NMF@';
  str_out += 'SC_desinfecttime_min#NMF#' + search_get_sel_txt('SC_desinfecttime_min') + '@NMF@';
  str_out += 'SC_desinfecttime_seg#NMF#' + search_get_sel_txt('SC_desinfecttime_seg') + '@NMF@';
  str_out += 'SC_desinfecttime_input_2_hor#NMF#' + search_get_sel_txt('SC_desinfecttime_input_2_hor') + '@NMF@';
  str_out += 'SC_desinfecttime_input_2_min#NMF#' + search_get_sel_txt('SC_desinfecttime_input_2_min') + '@NMF@';
  str_out += 'SC_desinfecttime_input_2_seg#NMF#' + search_get_sel_txt('SC_desinfecttime_input_2_seg') + '@NMF@';
  str_out += 'SC_opertime_cond#NMF#' + search_get_sel_txt('SC_opertime_cond') + '@NMF@';
  str_out += 'SC_opertime_dia#NMF#' + search_get_sel_txt('SC_opertime_dia') + '@NMF@';
  str_out += 'SC_opertime_mes#NMF#' + search_get_sel_txt('SC_opertime_mes') + '@NMF@';
  str_out += 'SC_opertime_ano#NMF#' + search_get_sel_txt('SC_opertime_ano') + '@NMF@';
  str_out += 'SC_opertime_input_2_dia#NMF#' + search_get_sel_txt('SC_opertime_input_2_dia') + '@NMF@';
  str_out += 'SC_opertime_input_2_mes#NMF#' + search_get_sel_txt('SC_opertime_input_2_mes') + '@NMF@';
  str_out += 'SC_opertime_input_2_ano#NMF#' + search_get_sel_txt('SC_opertime_input_2_ano') + '@NMF@';
  str_out += 'SC_opertime_hor#NMF#' + search_get_sel_txt('SC_opertime_hor') + '@NMF@';
  str_out += 'SC_opertime_min#NMF#' + search_get_sel_txt('SC_opertime_min') + '@NMF@';
  str_out += 'SC_opertime_seg#NMF#' + search_get_sel_txt('SC_opertime_seg') + '@NMF@';
  str_out += 'SC_opertime_input_2_hor#NMF#' + search_get_sel_txt('SC_opertime_input_2_hor') + '@NMF@';
  str_out += 'SC_opertime_input_2_min#NMF#' + search_get_sel_txt('SC_opertime_input_2_min') + '@NMF@';
  str_out += 'SC_opertime_input_2_seg#NMF#' + search_get_sel_txt('SC_opertime_input_2_seg') + '@NMF@';
  str_out += 'SC_tutuplukatime_cond#NMF#' + search_get_sel_txt('SC_tutuplukatime_cond') + '@NMF@';
  str_out += 'SC_tutuplukatime_dia#NMF#' + search_get_sel_txt('SC_tutuplukatime_dia') + '@NMF@';
  str_out += 'SC_tutuplukatime_mes#NMF#' + search_get_sel_txt('SC_tutuplukatime_mes') + '@NMF@';
  str_out += 'SC_tutuplukatime_ano#NMF#' + search_get_sel_txt('SC_tutuplukatime_ano') + '@NMF@';
  str_out += 'SC_tutuplukatime_input_2_dia#NMF#' + search_get_sel_txt('SC_tutuplukatime_input_2_dia') + '@NMF@';
  str_out += 'SC_tutuplukatime_input_2_mes#NMF#' + search_get_sel_txt('SC_tutuplukatime_input_2_mes') + '@NMF@';
  str_out += 'SC_tutuplukatime_input_2_ano#NMF#' + search_get_sel_txt('SC_tutuplukatime_input_2_ano') + '@NMF@';
  str_out += 'SC_tutuplukatime_hor#NMF#' + search_get_sel_txt('SC_tutuplukatime_hor') + '@NMF@';
  str_out += 'SC_tutuplukatime_min#NMF#' + search_get_sel_txt('SC_tutuplukatime_min') + '@NMF@';
  str_out += 'SC_tutuplukatime_seg#NMF#' + search_get_sel_txt('SC_tutuplukatime_seg') + '@NMF@';
  str_out += 'SC_tutuplukatime_input_2_hor#NMF#' + search_get_sel_txt('SC_tutuplukatime_input_2_hor') + '@NMF@';
  str_out += 'SC_tutuplukatime_input_2_min#NMF#' + search_get_sel_txt('SC_tutuplukatime_input_2_min') + '@NMF@';
  str_out += 'SC_tutuplukatime_input_2_seg#NMF#' + search_get_sel_txt('SC_tutuplukatime_input_2_seg') + '@NMF@';
  str_out += 'SC_rrouttime_cond#NMF#' + search_get_sel_txt('SC_rrouttime_cond') + '@NMF@';
  str_out += 'SC_rrouttime_dia#NMF#' + search_get_sel_txt('SC_rrouttime_dia') + '@NMF@';
  str_out += 'SC_rrouttime_mes#NMF#' + search_get_sel_txt('SC_rrouttime_mes') + '@NMF@';
  str_out += 'SC_rrouttime_ano#NMF#' + search_get_sel_txt('SC_rrouttime_ano') + '@NMF@';
  str_out += 'SC_rrouttime_input_2_dia#NMF#' + search_get_sel_txt('SC_rrouttime_input_2_dia') + '@NMF@';
  str_out += 'SC_rrouttime_input_2_mes#NMF#' + search_get_sel_txt('SC_rrouttime_input_2_mes') + '@NMF@';
  str_out += 'SC_rrouttime_input_2_ano#NMF#' + search_get_sel_txt('SC_rrouttime_input_2_ano') + '@NMF@';
  str_out += 'SC_rrouttime_hor#NMF#' + search_get_sel_txt('SC_rrouttime_hor') + '@NMF@';
  str_out += 'SC_rrouttime_min#NMF#' + search_get_sel_txt('SC_rrouttime_min') + '@NMF@';
  str_out += 'SC_rrouttime_seg#NMF#' + search_get_sel_txt('SC_rrouttime_seg') + '@NMF@';
  str_out += 'SC_rrouttime_input_2_hor#NMF#' + search_get_sel_txt('SC_rrouttime_input_2_hor') + '@NMF@';
  str_out += 'SC_rrouttime_input_2_min#NMF#' + search_get_sel_txt('SC_rrouttime_input_2_min') + '@NMF@';
  str_out += 'SC_rrouttime_input_2_seg#NMF#' + search_get_sel_txt('SC_rrouttime_input_2_seg') + '@NMF@';
  str_out += 'SC_tindakanrr_cond#NMF#' + search_get_sel_txt('SC_tindakanrr_cond') + '@NMF@';
  str_out += 'SC_tindakanrr#NMF#' + search_get_text('SC_tindakanrr') + '@NMF@';
  str_out += 'id_ac_tindakanrr#NMF#' + search_get_text('id_ac_tindakanrr') + '@NMF@';
  ...
  str_out += 'SC_vc_cond#NMF#' + search_get_sel_txt('SC_vc_cond') + '@NMF@';
  str_out += 'SC_vc#NMF#' + search_get_text('SC_vc') + '@NMF@';
  str_out += 'id_ac_vc#NMF#' + search_get_text('id_ac_vc') + '@NMF@';
  str_out += 'SC_cultur_cond#NMF#' + search_get_sel_txt('SC_cultur_cond') + '@NMF@';
  str_out += 'SC_cultur#NMF#' + search_get_text('SC_cultur') + '@NMF@';
  str_out += 'id_ac_cultur#NMF#' + search_get_text('id_ac_cultur') + '@NMF@';
  str_out += 'SC_sewa_cond#NMF#' + search_get_sel_txt('SC_sewa_cond') + '@NMF@';
  str_out += 'SC_sewa#NMF#' + search_get_text('SC_sewa') + '@NMF@';
  str_out += 'id_ac_sewa#NMF#' + search_get_text('id_ac_sewa') + '@NMF@';
  str_out += 'SC_asa_cond#NMF#' + search_get_sel_txt('SC_asa_cond') + '@NMF@';
  str_out += 'SC_asa#NMF#' + search_get_text('SC_asa') + '@NMF@';
  str_out += 'id_ac_asa#NMF#' + search_get_text('id_ac_asa') + '@NMF@';
  ...
  str_out += 'SC_entrydate_cond#NMF#' + search_get_sel_txt('SC_entrydate_cond') + '@NMF@';
  str_out += 'SC_entrydate_dia#NMF#' + search_get_sel_txt('SC_entrydate_dia') + '@NMF@';
  str_out += 'SC_entrydate_mes#NMF#' + search_get_sel_txt('SC_entrydate_mes') + '@NMF@';
  str_out += 'SC_entrydate_ano#NMF#' + search_get_sel_txt('SC_entrydate_ano') + '@NMF@';
  str_out += 'SC_entrydate_input_2_dia#NMF#' + search_get_sel_txt('SC_entrydate_input_2_dia') + '@NMF@';
  str_out += 'SC_entrydate_input_2_mes#NMF#' + search_get_sel_txt('SC_entrydate_input_2_mes') + '@NMF@';
  str_out += 'SC_entrydate_input_2_ano#NMF#' + search_get_sel_txt('SC_entrydate_input_2_ano') + '@NMF@';
  str_out += 'SC_entrydate_hor#NMF#' + search_get_sel_txt('SC_entrydate_hor') + '@NMF@';
  str_out += 'SC_entrydate_min#NMF#' + search_get_sel_txt('SC_entrydate_min') + '@NMF@';
  str_out += 'SC_entrydate_seg#NMF#' + search_get_sel_txt('SC_entrydate_seg') + '@NMF@';
  str_out += 'SC_entrydate_input_2_hor#NMF#' + search_get_sel_txt('SC_entrydate_input_2_hor') + '@NMF@';
  str_out += 'SC_entrydate_input_2_min#NMF#' + search_get_sel_txt('SC_entrydate_input_2_min') + '@NMF@';
  str_out += 'SC_entrydate_input_2_seg#NMF#' + search_get_sel_txt('SC_entrydate_input_2_seg') + '@NMF@';
   ...
   $("#id_ac_tindakanrr").autocomplete({
     ...
     $.ajax({
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_tindakanrr",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_tindakanrr").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     focus: function (event, ui) {
   ...
   $("#id_ac_vc").autocomplete({
     ...
     $.ajax({
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_vc",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
   ...
   $("#id_ac_cultur").autocomplete({
     ...
     $.ajax({
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_cultur",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_cultur").val( $(this).val() );
       }
     }
   });
   $("#id_ac_sewa").autocomplete({
     minLength: 1,
     source: function (request, response) {
     $.ajax({
       url: "index.php",
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_sewa",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_sewa").val( $(this).val() );
       }
     }
   });
   $("#id_ac_asa").autocomplete({
     minLength: 1,
     source: function (request, response) {
     $.ajax({
       url: "index.php",
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_asa",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div class="scFilterHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFilterHeaderFont" style="float: left; text-transform: uppercase;"><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - Kamar Operasi</div>
...
<?php
   ...
   function monta_form()
   {
      global 
             ...
             $desinfecttime_cond, $desinfecttime, $desinfecttime_dia, $desinfecttime_mes, $desinfecttime_ano, $desinfecttime_hor, $desinfecttime_min, $desinfecttime_seg,
             $opertime_cond, $opertime, $opertime_dia, $opertime_mes, $opertime_ano, $opertime_hor, $opertime_min, $opertime_seg,
             $tutuplukatime_cond, $tutuplukatime, $tutuplukatime_dia, $tutuplukatime_mes, $tutuplukatime_ano, $tutuplukatime_hor, $tutuplukatime_min, $tutuplukatime_seg,
             $rrouttime_cond, $rrouttime, $rrouttime_dia, $rrouttime_mes, $rrouttime_ano, $rrouttime_hor, $rrouttime_min, $rrouttime_seg,
             $tindakanrr_cond, $tindakanrr, $tindakanrr_autocomp,
             $pa_cond, $pa, $pa_autocomp,
             $cito_cond, $cito, $cito_autocomp,
             $vc_cond, $vc, $vc_autocomp,
             $cultur_cond, $cultur, $cultur_autocomp,
             $sewa_cond, $sewa, $sewa_autocomp,
             $asa_cond, $asa, $asa_autocomp,
             ...
             $entrydate_cond, $entrydate, $entrydate_dia, $entrydate_mes, $entrydate_ano, $entrydate_hor, $entrydate_min, $entrydate_seg,
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_tbdetailokR']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_tbdetailokR']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['grid_tbdetailokR']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("grid_tbdetailokR", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $babybirth = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['babybirth']; 
          $babybirth_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['babybirth_cond']; 
          $id = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['id']; 
          $id_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['id_cond']; 
          $trancode = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['trancode']; 
          $trancode_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['trancode_cond']; 
          $custcode = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['custcode']; 
          $custcode_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['custcode_cond']; 
          $birthdate_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['birthdate_dia']; 
          $birthdate_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['birthdate_mes']; 
          $birthdate_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['birthdate_ano']; 
          $birthdate_hor = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['birthdate_hor']; 
          $birthdate_min = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['birthdate_min']; 
          $birthdate_seg = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['birthdate_seg']; 
          $birthdate_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['birthdate_cond']; 
          $birthtime = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['birthtime']; 
          $birthtime_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['birthtime_cond']; 
          $bb = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['bb']; 
          $bb_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['bb_cond']; 
          $tb = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['tb']; 
          $tb_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['tb_cond']; 
          $lingkar = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['lingkar']; 
          $lingkar_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['lingkar_cond']; 
          $hidup = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['hidup']; 
          $hidup_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['hidup_cond']; 
          $anestime_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['anestime_dia']; 
          $anestime_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['anestime_mes']; 
          $anestime_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['anestime_ano']; 
          $anestime_hor = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['anestime_hor']; 
          $anestime_min = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['anestime_min']; 
          $anestime_seg = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['anestime_seg']; 
          $anestime_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['anestime_cond']; 
          $desinfecttime_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['desinfecttime_dia']; 
          $desinfecttime_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['desinfecttime_mes']; 
          $desinfecttime_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['desinfecttime_ano']; 
          $desinfecttime_hor = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['desinfecttime_hor']; 
          $desinfecttime_min = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['desinfecttime_min']; 
          $desinfecttime_seg = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['desinfecttime_seg']; 
          $desinfecttime_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['desinfecttime_cond']; 
          $opertime_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['opertime_dia']; 
          $opertime_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['opertime_mes']; 
          $opertime_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['opertime_ano']; 
          $opertime_hor = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['opertime_hor']; 
          $opertime_min = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['opertime_min']; 
          $opertime_seg = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['opertime_seg']; 
          $opertime_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['opertime_cond']; 
          $tutuplukatime_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['tutuplukatime_dia']; 
          $tutuplukatime_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['tutuplukatime_mes']; 
          $tutuplukatime_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['tutuplukatime_ano']; 
          $tutuplukatime_hor = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['tutuplukatime_hor']; 
          $tutuplukatime_min = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['tutuplukatime_min']; 
          $tutuplukatime_seg = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['tutuplukatime_seg']; 
          $tutuplukatime_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['tutuplukatime_cond']; 
          $rrouttime_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['rrouttime_dia']; 
          $rrouttime_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['rrouttime_mes']; 
          $rrouttime_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['rrouttime_ano']; 
          $rrouttime_hor = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['rrouttime_hor']; 
          $rrouttime_min = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['rrouttime_min']; 
          $rrouttime_seg = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['rrouttime_seg']; 
          $rrouttime_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['rrouttime_cond']; 
          $tindakanrr = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['tindakanrr']; 
          $tindakanrr_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['tindakanrr_cond']; 
          $pa = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['pa']; 
          $pa_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['pa_cond']; 
          $cito = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['cito']; 
          $cito_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['cito_cond']; 
          $vc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['vc']; 
          $vc_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['vc_cond']; 
          $cultur = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['cultur']; 
          $cultur_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['cultur_cond']; 
          $sewa = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['sewa']; 
          $sewa_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['sewa_cond']; 
          $asa = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['asa']; 
          $asa_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['asa_cond']; 
          $diagpre = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['diagpre']; 
          $diagpre_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['diagpre_cond']; 
          $diagpost = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['diagpost']; 
          $diagpost_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['diagpost_cond']; 
          $trandate_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['trandate_dia']; 
          $trandate_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['trandate_mes']; 
          $trandate_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['trandate_ano']; 
          $trandate_hor = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['trandate_hor']; 
          $trandate_min = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['trandate_min']; 
          $trandate_seg = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['trandate_seg']; 
          $trandate_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['trandate_cond']; 
          $entrydate_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['entrydate_dia']; 
          $entrydate_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['entrydate_mes']; 
          $entrydate_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['entrydate_ano']; 
          $entrydate_hor = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['entrydate_hor']; 
          $entrydate_min = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['entrydate_min']; 
          $entrydate_seg = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['entrydate_seg']; 
          $entrydate_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['entrydate_cond']; 
          $class = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['class']; 
          $class_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['class_cond']; 
          $inapcode = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['inapcode']; 
          $inapcode_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['inapcode_cond']; 
          $awalobs_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['awalobs_dia']; 
          $awalobs_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['awalobs_mes']; 
          $awalobs_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['awalobs_ano']; 
          $awalobs_hor = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['awalobs_hor']; 
          $awalobs_min = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['awalobs_min']; 
          $awalobs_seg = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['awalobs_seg']; 
          $awalobs_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['awalobs_cond']; 
          $akhirobs_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['akhirobs_dia']; 
          $akhirobs_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['akhirobs_mes']; 
          $akhirobs_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['akhirobs_ano']; 
          $akhirobs_hor = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['akhirobs_hor']; 
          $akhirobs_min = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['akhirobs_min']; 
          $akhirobs_seg = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['akhirobs_seg']; 
          $akhirobs_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['akhirobs_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['NM_operador']; 
      } 
      ...
      $str_hide_desinfecttime = (in_array($desinfecttime_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_opertime = (in_array($opertime_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_tutuplukatime = (in_array($tutuplukatime_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_rrouttime = (in_array($rrouttime_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_tindakanrr = (in_array($tindakanrr_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      $str_hide_vc = (in_array($vc_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_cultur = (in_array($cultur_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_sewa = (in_array($sewa_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_asa = (in_array($asa_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      $str_hide_entrydate = (in_array($entrydate_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      if (!isset($desinfecttime) || $desinfecttime == "")
      {
          $desinfecttime = "";
      }
      if (isset($desinfecttime) && !empty($desinfecttime))
      {
         $tmp_pos = strpos($desinfecttime, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $desinfecttime = substr($desinfecttime, 0, $tmp_pos);
         }
      }
      if (!isset($opertime) || $opertime == "")
      {
          $opertime = "";
      }
      if (isset($opertime) && !empty($opertime))
      {
         $tmp_pos = strpos($opertime, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $opertime = substr($opertime, 0, $tmp_pos);
         }
      }
      if (!isset($tutuplukatime) || $tutuplukatime == "")
      {
          $tutuplukatime = "";
      }
      if (isset($tutuplukatime) && !empty($tutuplukatime))
      {
         $tmp_pos = strpos($tutuplukatime, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $tutuplukatime = substr($tutuplukatime, 0, $tmp_pos);
         }
      }
      if (!isset($rrouttime) || $rrouttime == "")
      {
          $rrouttime = "";
      }
      if (isset($rrouttime) && !empty($rrouttime))
      {
         $tmp_pos = strpos($rrouttime, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $rrouttime = substr($rrouttime, 0, $tmp_pos);
         }
      }
      if (!isset($tindakanrr) || $tindakanrr == "")
      {
          $tindakanrr = "";
      }
      if (isset($tindakanrr) && !empty($tindakanrr))
      {
         $tmp_pos = strpos($tindakanrr, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $tindakanrr = substr($tindakanrr, 0, $tmp_pos);
         }
      }
      if (!isset($pa) || $pa == "")
      {
      ...
      if (isset($vc) && !empty($vc))
      {
         ...
         {
         $vc = substr($vc, 0, $tmp_pos);
         }
      }
      if (!isset($cultur) || $cultur == "")
      {
          $cultur = "";
      }
      if (isset($cultur) && !empty($cultur))
      {
         $tmp_pos = strpos($cultur, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $cultur = substr($cultur, 0, $tmp_pos);
         }
      }
      if (!isset($sewa) || $sewa == "")
      {
      ...
      {
         $tmp_pos = strpos($entrydate, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $entrydate = substr($entrydate, 0, $tmp_pos);
         }
      }
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_babybirth_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['babybirth'])) ? $this->New_label['babybirth'] : "Baby Birth"; ?></TD>
      
      <INPUT type="hidden" id="SC_babybirth_cond" name="babybirth_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_babybirth" <?php echo $str_hide_babybirth?> valign="top">
...
?>
<INPUT  type="text" id="SC_babybirth" name="babybirth" value="<?php echo NM_encode_input($babybirth) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_babybirth" name="babybirth_autocomp" size="11"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
...
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_id" name="id_autocomp" size="5"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 5, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
      ...
      <TD id='SC_trancode_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['trancode'])) ? $this->New_label['trancode'] : "Kode Transaksi"; ?></TD>
...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_trancode" name="trancode_autocomp" size="11"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 11, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_custcode_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['custcode'])) ? $this->New_label['custcode'] : "Pasien"; ?></TD>
...
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_custcode" name="custcode_autocomp" size="8"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 8, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_birthdate_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['birthdate'])) ? $this->New_label['birthdate'] : "Birth Date"; ?></TD>
      
      <INPUT type="hidden" id="SC_birthdate_cond" name="birthdate_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_birthdate" <?php echo $str_hide_birthdate?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
...
?>
 ...
 <?php echo $date_format_show ?>         </SPAN>
      ...
      <TD id='SC_birthtime_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['birthtime'])) ? $this->New_label['birthtime'] : "Birth Time"; ?></TD>
      
      <INPUT type="hidden" id="SC_birthtime_cond" name="birthtime_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_birthtime" <?php echo $str_hide_birthtime?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
...
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_birthtime" name="birthtime_autocomp" size="10"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 10, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_bb_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['bb'])) ? $this->New_label['bb'] : "Bb"; ?></TD>
      
      <INPUT type="hidden" id="SC_bb_cond" name="bb_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_bb" <?php echo $str_hide_bb?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_bb" name="bb_autocomp" size="12"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 12, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
      ...
      <TD id='SC_tb_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['tb'])) ? $this->New_label['tb'] : "Tb"; ?></TD>
      
      <INPUT type="hidden" id="SC_tb_cond" name="tb_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_tb" <?php echo $str_hide_tb?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
...
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_tb" name="tb_autocomp" size="12"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 12, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
      ...
      <TD id='SC_lingkar_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['lingkar'])) ? $this->New_label['lingkar'] : "Lingkar"; ?></TD>
      
      <INPUT type="hidden" id="SC_lingkar_cond" name="lingkar_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_lingkar" <?php echo $str_hide_lingkar?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_lingkar" name="lingkar_autocomp" size="12"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 12, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
      ...
      <TD id='SC_hidup_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['hidup'])) ? $this->New_label['hidup'] : "Hidup"; ?></TD>
      
      <INPUT type="hidden" id="SC_hidup_cond" name="hidup_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_hidup" <?php echo $str_hide_hidup?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
...
?>
<INPUT  type="text" id="SC_hidup" name="hidup" value="<?php echo NM_encode_input($hidup) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_hidup" name="hidup_autocomp" size="11"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
      ...
      <TD id='SC_anestime_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['anestime'])) ? $this->New_label['anestime'] : "Anes Time"; ?></TD>
      
      <INPUT type="hidden" id="SC_anestime_cond" name="anestime_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_anestime" <?php echo $str_hide_anestime?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
...
?>
 ...
 <?php echo $date_format_show ?>         </SPAN>
      ...
      <TD id='SC_desinfecttime_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['desinfecttime'])) ? $this->New_label['desinfecttime'] : "Desinfecttime"; ?></TD>
      
      <INPUT type="hidden" id="SC_desinfecttime_cond" name="desinfecttime_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_desinfecttime" <?php echo $str_hide_desinfecttime?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['desinfecttime'])) ? $this->New_label['desinfecttime'] : "Desinfecttime";
 $nmgp_tab_label .= "desinfecttime?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
  ...
  {
?>
<span id='id_date_part_desinfecttime_DD' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_desinfecttime_dia" name="desinfecttime_dia" value="<?php echo NM_encode_input($desinfecttime_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_desinfecttime_MM' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_desinfecttime_mes" name="desinfecttime_mes" value="<?php echo NM_encode_input($desinfecttime_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_desinfecttime_AAAA' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_desinfecttime_ano" name="desinfecttime_ano" value="<?php echo NM_encode_input($desinfecttime_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 </span>
...
<?php
  ...
  {
?>
<span id='id_date_part_desinfecttime_HH' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_desinfecttime_hor" name="desinfecttime_hor" value="<?php echo NM_encode_input($desinfecttime_hor); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_desinfecttime_II' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_desinfecttime_min" name="desinfecttime_min" value="<?php echo NM_encode_input($desinfecttime_min); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_desinfecttime_SS' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_desinfecttime_seg" name="desinfecttime_seg" value="<?php echo NM_encode_input($desinfecttime_seg); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
?>
        <SPAN id="id_css_desinfecttime"  class="scFilterFieldFontEven">
 <?php echo $date_format_show ?>         </SPAN>
      ...
      <TD id='SC_opertime_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['opertime'])) ? $this->New_label['opertime'] : "Oper Time"; ?></TD>
      
      <INPUT type="hidden" id="SC_opertime_cond" name="opertime_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_opertime" <?php echo $str_hide_opertime?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['opertime'])) ? $this->New_label['opertime'] : "Oper Time";
 $nmgp_tab_label .= "opertime?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
  ...
  {
?>
<span id='id_date_part_opertime_DD' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_opertime_dia" name="opertime_dia" value="<?php echo NM_encode_input($opertime_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_opertime_MM' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_opertime_mes" name="opertime_mes" value="<?php echo NM_encode_input($opertime_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_opertime_AAAA' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_opertime_ano" name="opertime_ano" value="<?php echo NM_encode_input($opertime_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 </span>
...
<?php
  ...
  {
?>
<span id='id_date_part_opertime_HH' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_opertime_hor" name="opertime_hor" value="<?php echo NM_encode_input($opertime_hor); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_opertime_II' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_opertime_min" name="opertime_min" value="<?php echo NM_encode_input($opertime_min); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_opertime_SS' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_opertime_seg" name="opertime_seg" value="<?php echo NM_encode_input($opertime_seg); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
?>
        <SPAN id="id_css_opertime"  class="scFilterFieldFontOdd">
 <?php echo $date_format_show ?>         </SPAN>
      ...
      <TD id='SC_tutuplukatime_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['tutuplukatime'])) ? $this->New_label['tutuplukatime'] : "Tutup Luka Time"; ?></TD>
      
      <INPUT type="hidden" id="SC_tutuplukatime_cond" name="tutuplukatime_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_tutuplukatime" <?php echo $str_hide_tutuplukatime?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['tutuplukatime'])) ? $this->New_label['tutuplukatime'] : "Tutup Luka Time";
 $nmgp_tab_label .= "tutuplukatime?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
  ...
  {
?>
<span id='id_date_part_tutuplukatime_DD' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_tutuplukatime_dia" name="tutuplukatime_dia" value="<?php echo NM_encode_input($tutuplukatime_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_tutuplukatime_MM' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_tutuplukatime_mes" name="tutuplukatime_mes" value="<?php echo NM_encode_input($tutuplukatime_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_tutuplukatime_AAAA' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_tutuplukatime_ano" name="tutuplukatime_ano" value="<?php echo NM_encode_input($tutuplukatime_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 </span>
...
<?php
  ...
  {
?>
<span id='id_date_part_tutuplukatime_HH' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_tutuplukatime_hor" name="tutuplukatime_hor" value="<?php echo NM_encode_input($tutuplukatime_hor); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_tutuplukatime_II' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_tutuplukatime_min" name="tutuplukatime_min" value="<?php echo NM_encode_input($tutuplukatime_min); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_tutuplukatime_SS' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_tutuplukatime_seg" name="tutuplukatime_seg" value="<?php echo NM_encode_input($tutuplukatime_seg); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
?>
        <SPAN id="id_css_tutuplukatime"  class="scFilterFieldFontEven">
 <?php echo $date_format_show ?>         </SPAN>
      ...
      <TD id='SC_rrouttime_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['rrouttime'])) ? $this->New_label['rrouttime'] : "Rr Out Time"; ?></TD>
      
      <INPUT type="hidden" id="SC_rrouttime_cond" name="rrouttime_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_rrouttime" <?php echo $str_hide_rrouttime?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['rrouttime'])) ? $this->New_label['rrouttime'] : "Rr Out Time";
 $nmgp_tab_label .= "rrouttime?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
  ...
  {
?>
<span id='id_date_part_rrouttime_DD' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_rrouttime_dia" name="rrouttime_dia" value="<?php echo NM_encode_input($rrouttime_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_rrouttime_MM' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_rrouttime_mes" name="rrouttime_mes" value="<?php echo NM_encode_input($rrouttime_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_rrouttime_AAAA' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_rrouttime_ano" name="rrouttime_ano" value="<?php echo NM_encode_input($rrouttime_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 </span>
...
<?php
  ...
  {
?>
<span id='id_date_part_rrouttime_HH' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_rrouttime_hor" name="rrouttime_hor" value="<?php echo NM_encode_input($rrouttime_hor); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_rrouttime_II' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_rrouttime_min" name="rrouttime_min" value="<?php echo NM_encode_input($rrouttime_min); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_rrouttime_SS' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_rrouttime_seg" name="rrouttime_seg" value="<?php echo NM_encode_input($rrouttime_seg); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
?>
        <SPAN id="id_css_rrouttime"  class="scFilterFieldFontOdd">
 <?php echo $date_format_show ?>         </SPAN>
      ...
      <TD id='SC_tindakanrr_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['tindakanrr'])) ? $this->New_label['tindakanrr'] : "Tindakanrr"; ?></TD>
      
      <INPUT type="hidden" id="SC_tindakanrr_cond" name="tindakanrr_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_tindakanrr" <?php echo $str_hide_tindakanrr?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['tindakanrr'])) ? $this->New_label['tindakanrr'] : "Tindakanrr";
 $nmgp_tab_label .= "tindakanrr?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      $tindakanrr_look = substr($this->Db->qstr($tindakanrr), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct tindakanrr from " . $this->Ini->nm_tabela . " where tindakanrr = '$tindakanrr_look' order by tindakanrr"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      if (isset($nmgp_def_dados[0][$tindakanrr]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$tindakanrr];
      }
      else
      {
          $sAutocompValue = $tindakanrr;
      }
?>
<INPUT  type="text" id="SC_tindakanrr" name="tindakanrr" value="<?php echo NM_encode_input($tindakanrr) ?>"  size=50 alt="{datatype: 'text', maxLength: 100, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_tindakanrr" name="tindakanrr_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 100, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_pa_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['pa'])) ? $this->New_label['pa'] : "PA"; ?></TD>
      
      <INPUT type="hidden" id="SC_pa_cond" name="pa_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_pa" <?php echo $str_hide_pa?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_pa" name="pa_autocomp" size="10"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 10, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_cito_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['cito'])) ? $this->New_label['cito'] : "Cito"; ?></TD>
      
      <INPUT type="hidden" id="SC_cito_cond" name="cito_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_cito" <?php echo $str_hide_cito?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
...
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_cito" name="cito_autocomp" size="15"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 15, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_vc_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['vc'])) ? $this->New_label['vc'] : "VC"; ?></TD>
      
      <INPUT type="hidden" id="SC_vc_cond" name="vc_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_vc" <?php echo $str_hide_vc?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['vc'])) ? $this->New_label['vc'] : "VC";
 $nmgp_tab_label .= "vc?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      $vc_look = substr($this->Db->qstr($vc), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct VC from " . $this->Ini->nm_tabela . " where VC = '$vc_look' order by VC"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      if (isset($nmgp_def_dados[0][$vc]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$vc];
      }
      else
      {
          $sAutocompValue = $vc;
...
?>
<INPUT  type="text" id="SC_vc" name="vc" value="<?php echo NM_encode_input($vc) ?>"  size=10 alt="{datatype: 'text', maxLength: 10, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_vc" name="vc_autocomp" size="10"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 10, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_cultur_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['cultur'])) ? $this->New_label['cultur'] : "Cultur"; ?></TD>
      
      <INPUT type="hidden" id="SC_cultur_cond" name="cultur_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_cultur" <?php echo $str_hide_cultur?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['cultur'])) ? $this->New_label['cultur'] : "Cultur";
 $nmgp_tab_label .= "cultur?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      $cultur_look = substr($this->Db->qstr($cultur), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct Cultur from " . $this->Ini->nm_tabela . " where Cultur = '$cultur_look' order by Cultur"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      if (isset($nmgp_def_dados[0][$cultur]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$cultur];
      }
      else
      {
          $sAutocompValue = $cultur;
      }
?>
<INPUT  type="text" id="SC_cultur" name="cultur" value="<?php echo NM_encode_input($cultur) ?>"  size=10 alt="{datatype: 'text', maxLength: 10, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_cultur" name="cultur_autocomp" size="10"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 10, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_sewa_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['sewa'])) ? $this->New_label['sewa'] : "Sewa"; ?></TD>
      
      <INPUT type="hidden" id="SC_sewa_cond" name="sewa_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_sewa" <?php echo $str_hide_sewa?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['sewa'])) ? $this->New_label['sewa'] : "Sewa";
 $nmgp_tab_label .= "sewa?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      $sewa_look = substr($this->Db->qstr($sewa), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct Sewa from " . $this->Ini->nm_tabela . " where Sewa = '$sewa_look' order by Sewa"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      if (isset($nmgp_def_dados[0][$sewa]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$sewa];
      }
      else
      {
          $sAutocompValue = $sewa;
...
?>
<INPUT  type="text" id="SC_sewa" name="sewa" value="<?php echo NM_encode_input($sewa) ?>"  size=10 alt="{datatype: 'text', maxLength: 10, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_sewa" name="sewa_autocomp" size="10"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 10, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_asa_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['asa'])) ? $this->New_label['asa'] : "ASA"; ?></TD>
      
      <INPUT type="hidden" id="SC_asa_cond" name="asa_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_asa" <?php echo $str_hide_asa?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['asa'])) ? $this->New_label['asa'] : "ASA";
 $nmgp_tab_label .= "asa?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      $asa_look = substr($this->Db->qstr($asa), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct ASA from " . $this->Ini->nm_tabela . " where ASA = '$asa_look' order by ASA"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      if (isset($nmgp_def_dados[0][$asa]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$asa];
      }
      else
      {
          $sAutocompValue = $asa;
...
?>
<INPUT  type="text" id="SC_asa" name="asa" value="<?php echo NM_encode_input($asa) ?>"  size=20 alt="{datatype: 'text', maxLength: 20, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_asa" name="asa_autocomp" size="20"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 20, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_diagpre_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['diagpre'])) ? $this->New_label['diagpre'] : "Diagnosa Pre Op"; ?></TD>
      
      <INPUT type="hidden" id="SC_diagpre_cond" name="diagpre_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_diagpre" <?php echo $str_hide_diagpre?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_diagpre" name="diagpre_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 200, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_diagpost_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['diagpost'])) ? $this->New_label['diagpost'] : "Diagnosa Post Op"; ?></TD>
      
      <INPUT type="hidden" id="SC_diagpost_cond" name="diagpost_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_diagpost" <?php echo $str_hide_diagpost?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
...
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_diagpost" name="diagpost_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 200, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_trandate_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['trandate'])) ? $this->New_label['trandate'] : "Tran Date"; ?></TD>
...
?>
 ...
 <?php echo $date_format_show ?>         </SPAN>
      ...
      <TD id='SC_entrydate_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['entrydate'])) ? $this->New_label['entrydate'] : "Tgl. Masuk OK"; ?></TD>
      
      <INPUT type="hidden" id="SC_entrydate_cond" name="entrydate_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_entrydate" <?php echo $str_hide_entrydate?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['entrydate'])) ? $this->New_label['entrydate'] : "Tgl. Masuk OK";
 $nmgp_tab_label .= "entrydate?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
  ...
  {
?>
<span id='id_date_part_entrydate_DD' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_entrydate_dia" name="entrydate_dia" value="<?php echo NM_encode_input($entrydate_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_entrydate_MM' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_entrydate_mes" name="entrydate_mes" value="<?php echo NM_encode_input($entrydate_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_entrydate_AAAA' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_entrydate_ano" name="entrydate_ano" value="<?php echo NM_encode_input($entrydate_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 </span>
...
<?php
  ...
  {
?>
<span id='id_date_part_entrydate_HH' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_entrydate_hor" name="entrydate_hor" value="<?php echo NM_encode_input($entrydate_hor); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_entrydate_II' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_entrydate_min" name="entrydate_min" value="<?php echo NM_encode_input($entrydate_min); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_entrydate_SS' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_entrydate_seg" name="entrydate_seg" value="<?php echo NM_encode_input($entrydate_seg); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
?>
        <SPAN id="id_css_entrydate"  class="scFilterFieldFontEven">
 <?php echo $date_format_show ?>         </SPAN>
      ...
      <TD id='SC_class_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['class'])) ? $this->New_label['class'] : "Class"; ?></TD>
      
      <INPUT type="hidden" id="SC_class_cond" name="class_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_class" <?php echo $str_hide_class?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_class" name="class_autocomp" size="15"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 15, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_inapcode_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['inapcode'])) ? $this->New_label['inapcode'] : "Kode Inap"; ?></TD>
      
      <INPUT type="hidden" id="SC_inapcode_cond" name="inapcode_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_inapcode" <?php echo $str_hide_inapcode?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
...
?>
<INPUT  type="text" id="SC_inapcode" name="inapcode" value="<?php echo NM_encode_input($inapcode) ?>"  size=15 alt="{datatype: 'text', maxLength: 15, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_inapcode" name="inapcode_autocomp" size="15"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 15, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_awalobs_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['awalobs'])) ? $this->New_label['awalobs'] : "Awal Obs"; ?></TD>
      
      <INPUT type="hidden" id="SC_awalobs_cond" name="awalobs_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_awalobs" <?php echo $str_hide_awalobs?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
...
?>
 ...
 <?php echo $date_format_show ?>         </SPAN>
      ...
      <TD id='SC_akhirobs_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['akhirobs'])) ? $this->New_label['akhirobs'] : "Akhir Obs"; ?></TD>
      
      <INPUT type="hidden" id="SC_akhirobs_cond" name="akhirobs_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_akhirobs" <?php echo $str_hide_akhirobs?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
...
?>
<?php
   if (is_file("grid_tbdetailokR_help.txt"))
   {
      $Arq_WebHelp = file("grid_tbdetailokR_help.txt"); 
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_tbdetailokR']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_tbdetailokR']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_tbdetailokR']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_tbdetailokR']['start'] == 'filter')
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   nm_campos_between(document.getElementById('id_vis_desinfecttime'), document.F1.desinfecttime_cond, 'desinfecttime');
   document.F1.desinfecttime_dia.value = "";
   document.F1.desinfecttime_mes.value = "";
   document.F1.desinfecttime_ano.value = "";
   document.F1.desinfecttime_hor.value = "";
   document.F1.desinfecttime_min.value = "";
   document.F1.desinfecttime_seg.value = "";
   nm_campos_between(document.getElementById('id_vis_opertime'), document.F1.opertime_cond, 'opertime');
   document.F1.opertime_dia.value = "";
   document.F1.opertime_mes.value = "";
   document.F1.opertime_ano.value = "";
   document.F1.opertime_hor.value = "";
   document.F1.opertime_min.value = "";
   document.F1.opertime_seg.value = "";
   nm_campos_between(document.getElementById('id_vis_tutuplukatime'), document.F1.tutuplukatime_cond, 'tutuplukatime');
   document.F1.tutuplukatime_dia.value = "";
   document.F1.tutuplukatime_mes.value = "";
   document.F1.tutuplukatime_ano.value = "";
   document.F1.tutuplukatime_hor.value = "";
   document.F1.tutuplukatime_min.value = "";
   document.F1.tutuplukatime_seg.value = "";
   nm_campos_between(document.getElementById('id_vis_rrouttime'), document.F1.rrouttime_cond, 'rrouttime');
   document.F1.rrouttime_dia.value = "";
   document.F1.rrouttime_mes.value = "";
   document.F1.rrouttime_ano.value = "";
   document.F1.rrouttime_hor.value = "";
   document.F1.rrouttime_min.value = "";
   document.F1.rrouttime_seg.value = "";
   nm_campos_between(document.getElementById('id_vis_tindakanrr'), document.F1.tindakanrr_cond, 'tindakanrr');
   document.F1.tindakanrr.value = "";
   document.F1.tindakanrr_autocomp.value = "";
   ...
   nm_campos_between(document.getElementById('id_vis_vc'), document.F1.vc_cond, 'vc');
   document.F1.vc.value = "";
   document.F1.vc_autocomp.value = "";
   nm_campos_between(document.getElementById('id_vis_cultur'), document.F1.cultur_cond, 'cultur');
   document.F1.cultur.value = "";
   document.F1.cultur_autocomp.value = "";
   nm_campos_between(document.getElementById('id_vis_sewa'), document.F1.sewa_cond, 'sewa');
   document.F1.sewa.value = "";
   document.F1.sewa_autocomp.value = "";
   nm_campos_between(document.getElementById('id_vis_asa'), document.F1.asa_cond, 'asa');
   document.F1.asa.value = "";
   document.F1.asa_autocomp.value = "";
   ...
   nm_campos_between(document.getElementById('id_vis_entrydate'), document.F1.entrydate_cond, 'entrydate');
   document.F1.entrydate_dia.value = "";
   document.F1.entrydate_mes.value = "";
   document.F1.entrydate_ano.value = "";
   document.F1.entrydate_hor.value = "";
   document.F1.entrydate_min.value = "";
   document.F1.entrydate_seg.value = "";
 ...
 {
    $('#SC_akhirobs_dia').bind('change', function() {sc_grid_tbdetailokR_valida_dia(this)});
    $('#SC_akhirobs_hor').bind('change', function() {sc_grid_tbdetailokR_valida_hora(this)});
    $('#SC_akhirobs_mes').bind('change', function() {sc_grid_tbdetailokR_valida_mes(this)});
    $('#SC_akhirobs_min').bind('change', function() {sc_grid_tbdetailokR_valida_min(this)});
    $('#SC_akhirobs_seg').bind('change', function() {sc_grid_tbdetailokR_valida_seg(this)});
    $('#SC_anestime_dia').bind('change', function() {sc_grid_tbdetailokR_valida_dia(this)});
    $('#SC_anestime_hor').bind('change', function() {sc_grid_tbdetailokR_valida_hora(this)});
    $('#SC_anestime_mes').bind('change', function() {sc_grid_tbdetailokR_valida_mes(this)});
    $('#SC_anestime_min').bind('change', function() {sc_grid_tbdetailokR_valida_min(this)});
    $('#SC_anestime_seg').bind('change', function() {sc_grid_tbdetailokR_valida_seg(this)});
    $('#SC_awalobs_dia').bind('change', function() {sc_grid_tbdetailokR_valida_dia(this)});
    $('#SC_awalobs_hor').bind('change', function() {sc_grid_tbdetailokR_valida_hora(this)});
    $('#SC_awalobs_mes').bind('change', function() {sc_grid_tbdetailokR_valida_mes(this)});
    $('#SC_awalobs_min').bind('change', function() {sc_grid_tbdetailokR_valida_min(this)});
    $('#SC_awalobs_seg').bind('change', function() {sc_grid_tbdetailokR_valida_seg(this)});
    $('#SC_birthdate_dia').bind('change', function() {sc_grid_tbdetailokR_valida_dia(this)});
    $('#SC_birthdate_hor').bind('change', function() {sc_grid_tbdetailokR_valida_hora(this)});
    $('#SC_birthdate_mes').bind('change', function() {sc_grid_tbdetailokR_valida_mes(this)});
    $('#SC_birthdate_min').bind('change', function() {sc_grid_tbdetailokR_valida_min(this)});
    $('#SC_birthdate_seg').bind('change', function() {sc_grid_tbdetailokR_valida_seg(this)});
    $('#SC_desinfecttime_dia').bind('change', function() {sc_grid_tbdetailokR_valida_dia(this)});
    $('#SC_desinfecttime_hor').bind('change', function() {sc_grid_tbdetailokR_valida_hora(this)});
    $('#SC_desinfecttime_mes').bind('change', function() {sc_grid_tbdetailokR_valida_mes(this)});
    $('#SC_desinfecttime_min').bind('change', function() {sc_grid_tbdetailokR_valida_min(this)});
    $('#SC_desinfecttime_seg').bind('change', function() {sc_grid_tbdetailokR_valida_seg(this)});
    $('#SC_entrydate_dia').bind('change', function() {sc_grid_tbdetailokR_valida_dia(this)});
    $('#SC_entrydate_hor').bind('change', function() {sc_grid_tbdetailokR_valida_hora(this)});
    $('#SC_entrydate_mes').bind('change', function() {sc_grid_tbdetailokR_valida_mes(this)});
    $('#SC_entrydate_min').bind('change', function() {sc_grid_tbdetailokR_valida_min(this)});
    $('#SC_entrydate_seg').bind('change', function() {sc_grid_tbdetailokR_valida_seg(this)});
    $('#SC_opertime_dia').bind('change', function() {sc_grid_tbdetailokR_valida_dia(this)});
    $('#SC_opertime_hor').bind('change', function() {sc_grid_tbdetailokR_valida_hora(this)});
    $('#SC_opertime_mes').bind('change', function() {sc_grid_tbdetailokR_valida_mes(this)});
    $('#SC_opertime_min').bind('change', function() {sc_grid_tbdetailokR_valida_min(this)});
    $('#SC_opertime_seg').bind('change', function() {sc_grid_tbdetailokR_valida_seg(this)});
    $('#SC_rrouttime_dia').bind('change', function() {sc_grid_tbdetailokR_valida_dia(this)});
    $('#SC_rrouttime_hor').bind('change', function() {sc_grid_tbdetailokR_valida_hora(this)});
    $('#SC_rrouttime_mes').bind('change', function() {sc_grid_tbdetailokR_valida_mes(this)});
    $('#SC_rrouttime_min').bind('change', function() {sc_grid_tbdetailokR_valida_min(this)});
    $('#SC_rrouttime_seg').bind('change', function() {sc_grid_tbdetailokR_valida_seg(this)});
    $('#SC_trandate_dia').bind('change', function() {sc_grid_tbdetailokR_valida_dia(this)});
    $('#SC_trandate_hor').bind('change', function() {sc_grid_tbdetailokR_valida_hora(this)});
    $('#SC_trandate_mes').bind('change', function() {sc_grid_tbdetailokR_valida_mes(this)});
    $('#SC_trandate_min').bind('change', function() {sc_grid_tbdetailokR_valida_min(this)});
    $('#SC_trandate_seg').bind('change', function() {sc_grid_tbdetailokR_valida_seg(this)});
    $('#SC_tutuplukatime_dia').bind('change', function() {sc_grid_tbdetailokR_valida_dia(this)});
    $('#SC_tutuplukatime_hor').bind('change', function() {sc_grid_tbdetailokR_valida_hora(this)});
    $('#SC_tutuplukatime_mes').bind('change', function() {sc_grid_tbdetailokR_valida_mes(this)});
    $('#SC_tutuplukatime_min').bind('change', function() {sc_grid_tbdetailokR_valida_min(this)});
    $('#SC_tutuplukatime_seg').bind('change', function() {sc_grid_tbdetailokR_valida_seg(this)});
 }
 function sc_grid_tbdetailokR_valida_dia(obj)
 {
 ...
 function sc_grid_tbdetailokR_valida_mes(obj)
 {
 ...
 function sc_grid_tbdetailokR_valida_hora(obj)
 {
 ...
 function sc_grid_tbdetailokR_valida_min(obj)
 {
 ...
 function sc_grid_tbdetailokR_valida_seg(obj)
 {
     if (obj.value != "" && (obj.value < 0 || obj.value > 59))
     {
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "simrskreatifmedia/grid_tbdetailokR";
   ...
   function inicializa_vars()
   {
      ...
      $this->nm_data = new nm_data("id");
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['cond_pesq'] = "";
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_desinfecttime_cond'] = 'cond';
      $tp_fields['SC_desinfecttime_dia'] = 'text';
      $tp_fields['SC_desinfecttime_mes'] = 'text';
      $tp_fields['SC_desinfecttime_ano'] = 'text';
      $tp_fields['SC_desinfecttime_input_2_dia'] = 'text';
      $tp_fields['SC_desinfecttime_input_2_mes'] = 'text';
      $tp_fields['SC_desinfecttime_input_2_ano'] = 'text';
      $tp_fields['SC_desinfecttime_hor'] = 'text';
      $tp_fields['SC_desinfecttime_min'] = 'text';
      $tp_fields['SC_desinfecttime_seg'] = 'text';
      $tp_fields['SC_desinfecttime_input_2_hor'] = 'text';
      $tp_fields['SC_desinfecttime_input_2_min'] = 'text';
      $tp_fields['SC_desinfecttime_input_2_seg'] = 'text';
      $tp_fields['SC_opertime_cond'] = 'cond';
      $tp_fields['SC_opertime_dia'] = 'text';
      $tp_fields['SC_opertime_mes'] = 'text';
      $tp_fields['SC_opertime_ano'] = 'text';
      $tp_fields['SC_opertime_input_2_dia'] = 'text';
      $tp_fields['SC_opertime_input_2_mes'] = 'text';
      $tp_fields['SC_opertime_input_2_ano'] = 'text';
      $tp_fields['SC_opertime_hor'] = 'text';
      $tp_fields['SC_opertime_min'] = 'text';
      $tp_fields['SC_opertime_seg'] = 'text';
      $tp_fields['SC_opertime_input_2_hor'] = 'text';
      $tp_fields['SC_opertime_input_2_min'] = 'text';
      $tp_fields['SC_opertime_input_2_seg'] = 'text';
      $tp_fields['SC_tutuplukatime_cond'] = 'cond';
      $tp_fields['SC_tutuplukatime_dia'] = 'text';
      $tp_fields['SC_tutuplukatime_mes'] = 'text';
      $tp_fields['SC_tutuplukatime_ano'] = 'text';
      $tp_fields['SC_tutuplukatime_input_2_dia'] = 'text';
      $tp_fields['SC_tutuplukatime_input_2_mes'] = 'text';
      $tp_fields['SC_tutuplukatime_input_2_ano'] = 'text';
      $tp_fields['SC_tutuplukatime_hor'] = 'text';
      $tp_fields['SC_tutuplukatime_min'] = 'text';
      $tp_fields['SC_tutuplukatime_seg'] = 'text';
      $tp_fields['SC_tutuplukatime_input_2_hor'] = 'text';
      $tp_fields['SC_tutuplukatime_input_2_min'] = 'text';
      $tp_fields['SC_tutuplukatime_input_2_seg'] = 'text';
      $tp_fields['SC_rrouttime_cond'] = 'cond';
      $tp_fields['SC_rrouttime_dia'] = 'text';
      $tp_fields['SC_rrouttime_mes'] = 'text';
      $tp_fields['SC_rrouttime_ano'] = 'text';
      $tp_fields['SC_rrouttime_input_2_dia'] = 'text';
      $tp_fields['SC_rrouttime_input_2_mes'] = 'text';
      $tp_fields['SC_rrouttime_input_2_ano'] = 'text';
      $tp_fields['SC_rrouttime_hor'] = 'text';
      $tp_fields['SC_rrouttime_min'] = 'text';
      $tp_fields['SC_rrouttime_seg'] = 'text';
      $tp_fields['SC_rrouttime_input_2_hor'] = 'text';
      $tp_fields['SC_rrouttime_input_2_min'] = 'text';
      $tp_fields['SC_rrouttime_input_2_seg'] = 'text';
      $tp_fields['SC_tindakanrr_cond'] = 'cond';
      $tp_fields['SC_tindakanrr'] = 'text_aut';
      $tp_fields['id_ac_tindakanrr'] = 'text_aut';
      ...
      $tp_fields['SC_vc_cond'] = 'cond';
      $tp_fields['SC_vc'] = 'text_aut';
      $tp_fields['id_ac_vc'] = 'text_aut';
      $tp_fields['SC_cultur_cond'] = 'cond';
      $tp_fields['SC_cultur'] = 'text_aut';
      $tp_fields['id_ac_cultur'] = 'text_aut';
      $tp_fields['SC_sewa_cond'] = 'cond';
      $tp_fields['SC_sewa'] = 'text_aut';
      $tp_fields['id_ac_sewa'] = 'text_aut';
      $tp_fields['SC_asa_cond'] = 'cond';
      $tp_fields['SC_asa'] = 'text_aut';
      $tp_fields['id_ac_asa'] = 'text_aut';
      ...
      $tp_fields['SC_entrydate_cond'] = 'cond';
      $tp_fields['SC_entrydate_dia'] = 'text';
      $tp_fields['SC_entrydate_mes'] = 'text';
      $tp_fields['SC_entrydate_ano'] = 'text';
      $tp_fields['SC_entrydate_input_2_dia'] = 'text';
      $tp_fields['SC_entrydate_input_2_mes'] = 'text';
      $tp_fields['SC_entrydate_input_2_ano'] = 'text';
      $tp_fields['SC_entrydate_hor'] = 'text';
      $tp_fields['SC_entrydate_min'] = 'text';
      $tp_fields['SC_entrydate_seg'] = 'text';
      $tp_fields['SC_entrydate_input_2_hor'] = 'text';
      $tp_fields['SC_entrydate_input_2_min'] = 'text';
      $tp_fields['SC_entrydate_input_2_seg'] = 'text';
   ...
   function trata_campos()
   {
      global $babybirth_cond, $babybirth, $babybirth_autocomp,
             ...
             $inapcode_cond, $inapcode, $inapcode_autocomp,
             $awalobs_cond, $awalobs, $awalobs_dia, $awalobs_mes, $awalobs_ano, $awalobs_hor, $awalobs_min, $awalobs_seg,
             $akhirobs_cond, $akhirobs, $akhirobs_dia, $akhirobs_mes, $akhirobs_ano, $akhirobs_hor, $akhirobs_min, $akhirobs_seg, $nmgp_tab_label;
      ...
      if (!empty($tindakanrr_autocomp) && empty($tindakanrr))
      {
          $tindakanrr = $tindakanrr_autocomp;
      }
      ...
      if (!empty($vc_autocomp) && empty($vc))
      {
          $vc = $vc_autocomp;
      }
      if (!empty($cultur_autocomp) && empty($cultur))
      {
          $cultur = $cultur_autocomp;
      }
      if (!empty($sewa_autocomp) && empty($sewa))
      {
          $sewa = $sewa_autocomp;
      }
      if (!empty($asa_autocomp) && empty($asa))
      {
          $asa = $asa_autocomp;
      }
      ...
      $desinfecttime_cond_salva = $desinfecttime_cond; 
      $opertime_cond_salva = $opertime_cond; 
      $tutuplukatime_cond_salva = $tutuplukatime_cond; 
      $rrouttime_cond_salva = $rrouttime_cond; 
      $tindakanrr_cond_salva = $tindakanrr_cond; 
      if (!isset($tindakanrr_input_2) || $tindakanrr_input_2 == "")
      {
          $tindakanrr_input_2 = $tindakanrr;
      }
      ...
      $vc_cond_salva = $vc_cond; 
      if (!isset($vc_input_2) || $vc_input_2 == "")
      {
          $vc_input_2 = $vc;
      }
      $cultur_cond_salva = $cultur_cond; 
      if (!isset($cultur_input_2) || $cultur_input_2 == "")
      {
          $cultur_input_2 = $cultur;
      }
      $sewa_cond_salva = $sewa_cond; 
      if (!isset($sewa_input_2) || $sewa_input_2 == "")
      {
          $sewa_input_2 = $sewa;
      }
      $asa_cond_salva = $asa_cond; 
      if (!isset($asa_input_2) || $asa_input_2 == "")
      {
          $asa_input_2 = $asa;
      }
      ...
      $entrydate_cond_salva = $entrydate_cond; 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['babybirth'] = $babybirth; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['babybirth_cond'] = $babybirth_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['id'] = $id; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['id_cond'] = $id_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['trancode'] = $trancode; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['trancode_cond'] = $trancode_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['custcode'] = $custcode; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['custcode_cond'] = $custcode_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['birthdate_dia'] = $birthdate_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['birthdate_mes'] = $birthdate_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['birthdate_ano'] = $birthdate_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['birthdate_hor'] = $birthdate_hor; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['birthdate_min'] = $birthdate_min; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['birthdate_seg'] = $birthdate_seg; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['birthdate_cond'] = $birthdate_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['birthtime'] = $birthtime; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['birthtime_cond'] = $birthtime_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['bb'] = $bb; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['bb_cond'] = $bb_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['tb'] = $tb; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['tb_cond'] = $tb_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['lingkar'] = $lingkar; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['lingkar_cond'] = $lingkar_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['hidup'] = $hidup; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['hidup_cond'] = $hidup_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['anestime_dia'] = $anestime_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['anestime_mes'] = $anestime_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['anestime_ano'] = $anestime_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['anestime_hor'] = $anestime_hor; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['anestime_min'] = $anestime_min; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['anestime_seg'] = $anestime_seg; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['anestime_cond'] = $anestime_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['desinfecttime_dia'] = $desinfecttime_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['desinfecttime_mes'] = $desinfecttime_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['desinfecttime_ano'] = $desinfecttime_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['desinfecttime_hor'] = $desinfecttime_hor; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['desinfecttime_min'] = $desinfecttime_min; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['desinfecttime_seg'] = $desinfecttime_seg; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['desinfecttime_cond'] = $desinfecttime_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['opertime_dia'] = $opertime_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['opertime_mes'] = $opertime_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['opertime_ano'] = $opertime_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['opertime_hor'] = $opertime_hor; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['opertime_min'] = $opertime_min; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['opertime_seg'] = $opertime_seg; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['opertime_cond'] = $opertime_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['tutuplukatime_dia'] = $tutuplukatime_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['tutuplukatime_mes'] = $tutuplukatime_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['tutuplukatime_ano'] = $tutuplukatime_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['tutuplukatime_hor'] = $tutuplukatime_hor; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['tutuplukatime_min'] = $tutuplukatime_min; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['tutuplukatime_seg'] = $tutuplukatime_seg; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['tutuplukatime_cond'] = $tutuplukatime_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['rrouttime_dia'] = $rrouttime_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['rrouttime_mes'] = $rrouttime_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['rrouttime_ano'] = $rrouttime_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['rrouttime_hor'] = $rrouttime_hor; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['rrouttime_min'] = $rrouttime_min; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['rrouttime_seg'] = $rrouttime_seg; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['rrouttime_cond'] = $rrouttime_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['tindakanrr'] = $tindakanrr; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['tindakanrr_cond'] = $tindakanrr_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['pa'] = $pa; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['pa_cond'] = $pa_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['cito'] = $cito; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['cito_cond'] = $cito_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['vc'] = $vc; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['vc_cond'] = $vc_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['cultur'] = $cultur; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['cultur_cond'] = $cultur_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['sewa'] = $sewa; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['sewa_cond'] = $sewa_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['asa'] = $asa; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['asa_cond'] = $asa_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['diagpre'] = $diagpre; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['diagpre_cond'] = $diagpre_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['diagpost'] = $diagpost; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['diagpost_cond'] = $diagpost_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['trandate_dia'] = $trandate_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['trandate_mes'] = $trandate_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['trandate_ano'] = $trandate_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['trandate_hor'] = $trandate_hor; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['trandate_min'] = $trandate_min; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['trandate_seg'] = $trandate_seg; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['trandate_cond'] = $trandate_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['entrydate_dia'] = $entrydate_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['entrydate_mes'] = $entrydate_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['entrydate_ano'] = $entrydate_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['entrydate_hor'] = $entrydate_hor; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['entrydate_min'] = $entrydate_min; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['entrydate_seg'] = $entrydate_seg; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['entrydate_cond'] = $entrydate_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['class'] = $class; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['class_cond'] = $class_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['inapcode'] = $inapcode; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['inapcode_cond'] = $inapcode_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['awalobs_dia'] = $awalobs_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['awalobs_mes'] = $awalobs_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['awalobs_ano'] = $awalobs_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['awalobs_hor'] = $awalobs_hor; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['awalobs_min'] = $awalobs_min; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['awalobs_seg'] = $awalobs_seg; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['awalobs_cond'] = $awalobs_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['akhirobs_dia'] = $akhirobs_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['akhirobs_mes'] = $akhirobs_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['akhirobs_ano'] = $akhirobs_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['akhirobs_hor'] = $akhirobs_hor; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['akhirobs_min'] = $akhirobs_min; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['akhirobs_seg'] = $akhirobs_seg; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['akhirobs_cond'] = $akhirobs_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca'] = $Temp_Busca;
      }
   ...
   { 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['tindakanrr'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['tindakanrr'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['tindakanrr'] = $tindakanrr;
      }
      $pa_look = substr($this->Db->qstr($pa), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct PA from " . $this->Ini->nm_tabela . " where PA = '$pa_look' order by PA"; 
      ...
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['vc'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['vc'] = $vc;
      }
      $cultur_look = substr($this->Db->qstr($cultur), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct Cultur from " . $this->Ini->nm_tabela . " where Cultur = '$cultur_look' order by Cultur"; 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['cultur'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['cultur'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['cultur'] = $cultur;
      }
      $sewa_look = substr($this->Db->qstr($sewa), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct Sewa from " . $this->Ini->nm_tabela . " where Sewa = '$sewa_look' order by Sewa"; 
      ...
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['sewa'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['sewa'] = $sewa;
      }
      $asa_look = substr($this->Db->qstr($asa), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct ASA from " . $this->Ini->nm_tabela . " where ASA = '$asa_look' order by ASA"; 
      ...
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['asa'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['asa'] = $asa;
      }
      $diagpre_look = substr($this->Db->qstr($diagpre), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct diagPre from " . $this->Ini->nm_tabela . " where diagPre = '$diagpre_look' order by diagPre"; 
      ...
      if ($birthdate_cond != "bi_TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['birthdate'] = $val[0];
          ...
          if ($birthdate_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['birthdate_input_2'] = $val[1];
      ...
      if ($anestime_cond != "bi_TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['anestime'] = $val[0];
          ...
          if ($anestime_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['anestime_input_2'] = $val[1];
      ...
      //----- $desinfecttime
      $this->Date_part = false;
      if ($desinfecttime_cond != "bi_TP")
      {
          $desinfecttime_cond = strtoupper($desinfecttime_cond);
          $Dtxt = "";
          $val  = array();
          $Dtxt .= $desinfecttime_ano;
          $Dtxt .= $desinfecttime_mes;
          $Dtxt .= $desinfecttime_dia;
          $Dtxt .= $desinfecttime_hor;
          $Dtxt .= $desinfecttime_min;
          $Dtxt .= $desinfecttime_seg;
          $val[0]['ano'] = $desinfecttime_ano;
          $val[0]['mes'] = $desinfecttime_mes;
          $val[0]['dia'] = $desinfecttime_dia;
          $val[0]['hor'] = $desinfecttime_hor;
          $val[0]['min'] = $desinfecttime_min;
          $val[0]['seg'] = $desinfecttime_seg;
          if ($desinfecttime_cond == "BW")
          {
              $val[1]['ano'] = $desinfecttime_input_2_ano;
              $val[1]['mes'] = $desinfecttime_input_2_mes;
              $val[1]['dia'] = $desinfecttime_input_2_dia;
              $val[1]['hor'] = $desinfecttime_input_2_hor;
              $val[1]['min'] = $desinfecttime_input_2_min;
              $val[1]['seg'] = $desinfecttime_input_2_seg;
          }
          $this->Operador_date_part = "";
          $this->Lang_date_part     = "";
          $this->nm_prep_date($val, "DH", "DATETIME", $desinfecttime_cond, "", "datahora");
          if (!$this->Date_part) {
              $val[0] = $this->Ini->sc_Date_Protect($val[0]);
          }
          $desinfecttime = $val[0];
          $this->cmp_formatado['desinfecttime'] = $val[0];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['desinfecttime'] = $val[0];
          $this->nm_data->SetaData($this->cmp_formatado['desinfecttime'], "YYYY-MM-DD HH:II:SS");
          $this->cmp_formatado['desinfecttime'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DH", "dmY his"));
          if ($desinfecttime_cond == "BW")
          {
              if (!$this->Date_part) {
                  $val[1] = $this->Ini->sc_Date_Protect($val[1]);
              }
              $desinfecttime_input_2     = $val[1];
              $this->cmp_formatado['desinfecttime_input_2'] = $val[1];
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['desinfecttime_input_2'] = $val[1];
              $this->nm_data->SetaData($this->cmp_formatado['desinfecttime_input_2'], "YYYY-MM-DD HH:II:SS");
              $this->cmp_formatado['desinfecttime_input_2'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DH", "dmY his"));
          }
          if (!empty($Dtxt) || $desinfecttime_cond == "NU" || $desinfecttime_cond == "NN"|| $desinfecttime_cond == "EP"|| $desinfecttime_cond == "NE")
          {
              $this->monta_condicao("desinfecttime", $desinfecttime_cond, $desinfecttime, $desinfecttime_input_2, 'desinfecttime', 'DATETIME');
          }
      }

      //----- $opertime
      $this->Date_part = false;
      if ($opertime_cond != "bi_TP")
      {
          $opertime_cond = strtoupper($opertime_cond);
          $Dtxt = "";
          $val  = array();
          $Dtxt .= $opertime_ano;
          $Dtxt .= $opertime_mes;
          ...
          $Dtxt .= $opertime_min;
          $Dtxt .= $opertime_seg;
          $val[0]['ano'] = $opertime_ano;
          $val[0]['mes'] = $opertime_mes;
          $val[0]['dia'] = $opertime_dia;
          $val[0]['hor'] = $opertime_hor;
          $val[0]['min'] = $opertime_min;
          $val[0]['seg'] = $opertime_seg;
          if ($opertime_cond == "BW")
          {
              $val[1]['ano'] = $opertime_input_2_ano;
              $val[1]['mes'] = $opertime_input_2_mes;
              $val[1]['dia'] = $opertime_input_2_dia;
              $val[1]['hor'] = $opertime_input_2_hor;
              $val[1]['min'] = $opertime_input_2_min;
              $val[1]['seg'] = $opertime_input_2_seg;
          }
          $this->Operador_date_part = "";
          $this->Lang_date_part     = "";
          $this->nm_prep_date($val, "DH", "DATETIME", $opertime_cond, "", "datahora");
          if (!$this->Date_part) {
              $val[0] = $this->Ini->sc_Date_Protect($val[0]);
          }
          $opertime = $val[0];
          $this->cmp_formatado['opertime'] = $val[0];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['opertime'] = $val[0];
          $this->nm_data->SetaData($this->cmp_formatado['opertime'], "YYYY-MM-DD HH:II:SS");
          $this->cmp_formatado['opertime'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DH", "dmY his"));
          if ($opertime_cond == "BW")
          {
              if (!$this->Date_part) {
                  $val[1] = $this->Ini->sc_Date_Protect($val[1]);
              }
              $opertime_input_2     = $val[1];
              $this->cmp_formatado['opertime_input_2'] = $val[1];
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['opertime_input_2'] = $val[1];
              $this->nm_data->SetaData($this->cmp_formatado['opertime_input_2'], "YYYY-MM-DD HH:II:SS");
              $this->cmp_formatado['opertime_input_2'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DH", "dmY his"));
          }
          if (!empty($Dtxt) || $opertime_cond == "NU" || $opertime_cond == "NN"|| $opertime_cond == "EP"|| $opertime_cond == "NE")
          {
              $this->monta_condicao("operTime", $opertime_cond, $opertime, $opertime_input_2, 'opertime', 'DATETIME');
          }
      }

      //----- $tutuplukatime
      $this->Date_part = false;
      if ($tutuplukatime_cond != "bi_TP")
      {
          $tutuplukatime_cond = strtoupper($tutuplukatime_cond);
          $Dtxt = "";
          $val  = array();
          $Dtxt .= $tutuplukatime_ano;
          $Dtxt .= $tutuplukatime_mes;
          $Dtxt .= $tutuplukatime_dia;
          $Dtxt .= $tutuplukatime_hor;
          $Dtxt .= $tutuplukatime_min;
          $Dtxt .= $tutuplukatime_seg;
          $val[0]['ano'] = $tutuplukatime_ano;
          $val[0]['mes'] = $tutuplukatime_mes;
          $val[0]['dia'] = $tutuplukatime_dia;
          $val[0]['hor'] = $tutuplukatime_hor;
          $val[0]['min'] = $tutuplukatime_min;
          $val[0]['seg'] = $tutuplukatime_seg;
          if ($tutuplukatime_cond == "BW")
          {
              $val[1]['ano'] = $tutuplukatime_input_2_ano;
              $val[1]['mes'] = $tutuplukatime_input_2_mes;
              $val[1]['dia'] = $tutuplukatime_input_2_dia;
              $val[1]['hor'] = $tutuplukatime_input_2_hor;
              $val[1]['min'] = $tutuplukatime_input_2_min;
              $val[1]['seg'] = $tutuplukatime_input_2_seg;
          }
          $this->Operador_date_part = "";
          $this->Lang_date_part     = "";
          $this->nm_prep_date($val, "DH", "DATETIME", $tutuplukatime_cond, "", "datahora");
          if (!$this->Date_part) {
              $val[0] = $this->Ini->sc_Date_Protect($val[0]);
          }
          $tutuplukatime = $val[0];
          $this->cmp_formatado['tutuplukatime'] = $val[0];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['tutuplukatime'] = $val[0];
          $this->nm_data->SetaData($this->cmp_formatado['tutuplukatime'], "YYYY-MM-DD HH:II:SS");
          $this->cmp_formatado['tutuplukatime'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DH", "dmY his"));
          if ($tutuplukatime_cond == "BW")
          {
              if (!$this->Date_part) {
                  $val[1] = $this->Ini->sc_Date_Protect($val[1]);
              }
              $tutuplukatime_input_2     = $val[1];
              $this->cmp_formatado['tutuplukatime_input_2'] = $val[1];
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['tutuplukatime_input_2'] = $val[1];
              $this->nm_data->SetaData($this->cmp_formatado['tutuplukatime_input_2'], "YYYY-MM-DD HH:II:SS");
              $this->cmp_formatado['tutuplukatime_input_2'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DH", "dmY his"));
          }
          if (!empty($Dtxt) || $tutuplukatime_cond == "NU" || $tutuplukatime_cond == "NN"|| $tutuplukatime_cond == "EP"|| $tutuplukatime_cond == "NE")
          {
              $this->monta_condicao("tutupLukaTime", $tutuplukatime_cond, $tutuplukatime, $tutuplukatime_input_2, 'tutuplukatime', 'DATETIME');
          }
      }

      //----- $rrouttime
      $this->Date_part = false;
      if ($rrouttime_cond != "bi_TP")
      {
          $rrouttime_cond = strtoupper($rrouttime_cond);
          $Dtxt = "";
          $val  = array();
          $Dtxt .= $rrouttime_ano;
          $Dtxt .= $rrouttime_mes;
          ...
          $Dtxt .= $rrouttime_min;
          $Dtxt .= $rrouttime_seg;
          $val[0]['ano'] = $rrouttime_ano;
          $val[0]['mes'] = $rrouttime_mes;
          $val[0]['dia'] = $rrouttime_dia;
          $val[0]['hor'] = $rrouttime_hor;
          $val[0]['min'] = $rrouttime_min;
          $val[0]['seg'] = $rrouttime_seg;
          if ($rrouttime_cond == "BW")
          {
              $val[1]['ano'] = $rrouttime_input_2_ano;
              $val[1]['mes'] = $rrouttime_input_2_mes;
              $val[1]['dia'] = $rrouttime_input_2_dia;
              $val[1]['hor'] = $rrouttime_input_2_hor;
              $val[1]['min'] = $rrouttime_input_2_min;
              $val[1]['seg'] = $rrouttime_input_2_seg;
          }
          $this->Operador_date_part = "";
          $this->Lang_date_part     = "";
          $this->nm_prep_date($val, "DH", "DATETIME", $rrouttime_cond, "", "datahora");
          if (!$this->Date_part) {
              $val[0] = $this->Ini->sc_Date_Protect($val[0]);
          }
          $rrouttime = $val[0];
          $this->cmp_formatado['rrouttime'] = $val[0];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['rrouttime'] = $val[0];
          $this->nm_data->SetaData($this->cmp_formatado['rrouttime'], "YYYY-MM-DD HH:II:SS");
          $this->cmp_formatado['rrouttime'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DH", "dmY his"));
          if ($rrouttime_cond == "BW")
          {
              if (!$this->Date_part) {
                  $val[1] = $this->Ini->sc_Date_Protect($val[1]);
              }
              $rrouttime_input_2     = $val[1];
              $this->cmp_formatado['rrouttime_input_2'] = $val[1];
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['rrouttime_input_2'] = $val[1];
              $this->nm_data->SetaData($this->cmp_formatado['rrouttime_input_2'], "YYYY-MM-DD HH:II:SS");
              $this->cmp_formatado['rrouttime_input_2'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DH", "dmY his"));
          }
          if (!empty($Dtxt) || $rrouttime_cond == "NU" || $rrouttime_cond == "NN"|| $rrouttime_cond == "EP"|| $rrouttime_cond == "NE")
          {
              $this->monta_condicao("rrOutTime", $rrouttime_cond, $rrouttime, $rrouttime_input_2, 'rrouttime', 'DATETIME');
          }
      }

      //----- $tindakanrr
      $this->Date_part = false;
      if (isset($tindakanrr) || $tindakanrr_cond == "nu" || $tindakanrr_cond == "nn" || $tindakanrr_cond == "ep" || $tindakanrr_cond == "ne")
      {
         $this->monta_condicao("tindakanrr", $tindakanrr_cond, $tindakanrr, "", "tindakanrr");
      }
      ...
      //----- $vc
      $this->Date_part = false;
      if (isset($vc) || $vc_cond == "nu" || $vc_cond == "nn" || $vc_cond == "ep" || $vc_cond == "ne")
      {
         $this->monta_condicao("VC", $vc_cond, $vc, "", "vc");
      }

      //----- $cultur
      $this->Date_part = false;
      if (isset($cultur) || $cultur_cond == "nu" || $cultur_cond == "nn" || $cultur_cond == "ep" || $cultur_cond == "ne")
      {
         $this->monta_condicao("Cultur", $cultur_cond, $cultur, "", "cultur");
      }

      //----- $sewa
      $this->Date_part = false;
      if (isset($sewa) || $sewa_cond == "nu" || $sewa_cond == "nn" || $sewa_cond == "ep" || $sewa_cond == "ne")
      {
         $this->monta_condicao("Sewa", $sewa_cond, $sewa, "", "sewa");
      }

      //----- $asa
      $this->Date_part = false;
      if (isset($asa) || $asa_cond == "nu" || $asa_cond == "nn" || $asa_cond == "ep" || $asa_cond == "ne")
      {
         $this->monta_condicao("ASA", $asa_cond, $asa, "", "asa");
      }
      ...
      if ($trandate_cond != "bi_TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['trandate'] = $val[0];
          ...
          if ($trandate_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['trandate_input_2'] = $val[1];
      ...
      //----- $entrydate
      $this->Date_part = false;
      if ($entrydate_cond != "bi_TP")
      {
          $entrydate_cond = strtoupper($entrydate_cond);
          $Dtxt = "";
          $val  = array();
          $Dtxt .= $entrydate_ano;
          $Dtxt .= $entrydate_mes;
          ...
          $Dtxt .= $entrydate_min;
          $Dtxt .= $entrydate_seg;
          $val[0]['ano'] = $entrydate_ano;
          $val[0]['mes'] = $entrydate_mes;
          $val[0]['dia'] = $entrydate_dia;
          $val[0]['hor'] = $entrydate_hor;
          $val[0]['min'] = $entrydate_min;
          $val[0]['seg'] = $entrydate_seg;
          if ($entrydate_cond == "BW")
          {
              $val[1]['ano'] = $entrydate_input_2_ano;
              $val[1]['mes'] = $entrydate_input_2_mes;
              $val[1]['dia'] = $entrydate_input_2_dia;
              $val[1]['hor'] = $entrydate_input_2_hor;
              $val[1]['min'] = $entrydate_input_2_min;
              $val[1]['seg'] = $entrydate_input_2_seg;
          }
          $this->Operador_date_part = "";
          $this->Lang_date_part     = "";
          $this->nm_prep_date($val, "DH", "DATETIME", $entrydate_cond, "", "datahora");
          if (!$this->Date_part) {
              $val[0] = $this->Ini->sc_Date_Protect($val[0]);
          }
          $entrydate = $val[0];
          $this->cmp_formatado['entrydate'] = $val[0];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['entrydate'] = $val[0];
          $this->nm_data->SetaData($this->cmp_formatado['entrydate'], "YYYY-MM-DD HH:II:SS");
          $this->cmp_formatado['entrydate'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DH", "dmY his"));
          if ($entrydate_cond == "BW")
          {
              if (!$this->Date_part) {
                  $val[1] = $this->Ini->sc_Date_Protect($val[1]);
              }
              $entrydate_input_2     = $val[1];
              $this->cmp_formatado['entrydate_input_2'] = $val[1];
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['entrydate_input_2'] = $val[1];
              $this->nm_data->SetaData($this->cmp_formatado['entrydate_input_2'], "YYYY-MM-DD HH:II:SS");
              $this->cmp_formatado['entrydate_input_2'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DH", "dmY his"));
          }
          if (!empty($Dtxt) || $entrydate_cond == "NU" || $entrydate_cond == "NN"|| $entrydate_cond == "EP"|| $entrydate_cond == "NE")
          {
              $this->monta_condicao("entryDate", $entrydate_cond, $entrydate, $entrydate_input_2, 'entrydate', 'DATETIME');
          }
      }
      ...
      if ($awalobs_cond != "bi_TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['awalobs'] = $val[0];
          ...
          if ($awalobs_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['awalobs_input_2'] = $val[1];
      ...
      if ($akhirobs_cond != "bi_TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['akhirobs'] = $val[0];
          ...
          if ($akhirobs_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']['akhirobs_input_2'] = $val[1];
   ...
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['where_pesq_fast'] = "";
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['fast_search']);
      if ("" == $this->comando_filtro)
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['where_orig'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['where_pesq']         = $this->comando . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['opcao']              = "pesq";
      if ("" == $this->comando_filtro)
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['where_pesq_filtro'] = "";
      }
      else
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['cond_pesq'] .= $this->NM_operador;
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['contr_array_resumo'] = "NAO";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['contr_total_geral']  = "NAO";
         unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['tot_geral']);
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['where_pesq_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailokR']['where_pesq'];
