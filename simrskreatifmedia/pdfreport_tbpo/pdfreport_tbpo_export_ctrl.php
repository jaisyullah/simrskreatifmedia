<?php
@session_start() ;
$_SESSION['scriptcase']['pdfreport_tbpo']['sc_process_barr'] = true;
require_once('../pdfreport_tbpo/index.php');
unset($_SESSION['scriptcase']['pdfreport_tbpo']['sc_process_barr']);
$ExportCtrl = new pdfreport_tbpo_export_control;
$ExportCtrl->Export_barr();

class pdfreport_tbpo_export_control
{
