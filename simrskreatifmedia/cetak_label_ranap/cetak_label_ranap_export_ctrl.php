<?php
@session_start() ;
$_SESSION['scriptcase']['cetak_label_ranap']['sc_process_barr'] = true;
require_once('../cetak_label_ranap/index.php');
unset($_SESSION['scriptcase']['cetak_label_ranap']['sc_process_barr']);
$ExportCtrl = new cetak_label_ranap_export_control;
$ExportCtrl->Export_barr();

class cetak_label_ranap_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_chart_titl'] ?> -  :: Excel</TITLE>
