  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbdetailokR_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbdetailokR_mob_form();
	}

  // ---------- Validate inapcode
  function do_ajax_form_tbdetailokR_mob_validate_inapcode()
  {
    var nomeCampo_inapcode = "inapcode";
    var var_inapcode = scAjaxGetFieldText(nomeCampo_inapcode);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdetailokR_mob_validate_inapcode(var_inapcode, var_script_case_init, do_ajax_form_tbdetailokR_mob_validate_inapcode_cb);
  } // do_ajax_form_tbdetailokR_mob_validate_inapcode

  function do_ajax_form_tbdetailokR_mob_validate_inapcode_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdetailokR_mob_validate_inapcode_cb

  // ---------- Validate trancode
  function do_ajax_form_tbdetailokR_mob_validate_trancode()
  {
    var nomeCampo_trancode = "trancode";
    var var_trancode = scAjaxGetFieldText(nomeCampo_trancode);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdetailokR_mob_validate_trancode(var_trancode, var_script_case_init, do_ajax_form_tbdetailokR_mob_validate_trancode_cb);
  } // do_ajax_form_tbdetailokR_mob_validate_trancode

  function do_ajax_form_tbdetailokR_mob_validate_trancode_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdetailokR_mob_validate_trancode_cb

  // ---------- Validate custcode
  function do_ajax_form_tbdetailokR_mob_validate_custcode()
  {
    var nomeCampo_custcode = "custcode";
    var var_custcode = scAjaxGetFieldSelect(nomeCampo_custcode);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdetailokR_mob_validate_custcode(var_custcode, var_script_case_init, do_ajax_form_tbdetailokR_mob_validate_custcode_cb);
  } // do_ajax_form_tbdetailokR_mob_validate_custcode

  function do_ajax_form_tbdetailokR_mob_validate_custcode_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdetailokR_mob_validate_custcode_cb

  // ---------- Validate class
  function do_ajax_form_tbdetailokR_mob_validate_class()
  {
    var nomeCampo_class = "class";
    var var_class = scAjaxGetFieldSelect(nomeCampo_class);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdetailokR_mob_validate_class(var_class, var_script_case_init, do_ajax_form_tbdetailokR_mob_validate_class_cb);
  } // do_ajax_form_tbdetailokR_mob_validate_class

  function do_ajax_form_tbdetailokR_mob_validate_class_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "class";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdetailokR_mob_validate_class_cb

  // ---------- Validate entrydate
  function do_ajax_form_tbdetailokR_mob_validate_entrydate()
  {
    var nomeCampo_entrydate = "entrydate";
    var var_entrydate = scAjaxGetFieldText(nomeCampo_entrydate);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdetailokR_mob_validate_entrydate(var_entrydate, var_script_case_init, do_ajax_form_tbdetailokR_mob_validate_entrydate_cb);
  } // do_ajax_form_tbdetailokR_mob_validate_entrydate

  function do_ajax_form_tbdetailokR_mob_validate_entrydate_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdetailokR_mob_validate_entrydate_cb

  // ---------- Validate detailresep
  function do_ajax_form_tbdetailokR_mob_validate_detailresep()
  {
    var nomeCampo_detailresep = "detailresep";
    var var_detailresep = scAjaxGetFieldText(nomeCampo_detailresep);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdetailokR_mob_validate_detailresep(var_detailresep, var_script_case_init, do_ajax_form_tbdetailokR_mob_validate_detailresep_cb);
  } // do_ajax_form_tbdetailokR_mob_validate_detailresep

  function do_ajax_form_tbdetailokR_mob_validate_detailresep_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdetailokR_mob_validate_detailresep_cb

  // ---------- Refresh inapcode
  function do_ajax_form_tbdetailokR_mob_refresh_inapcode()
  {
    var var_inapcode = scAjaxGetFieldText("inapcode");
    var var_nmgp_refresh_fields = "custcode_#fld#_entrydate";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tbdetailokR_mob_refresh_inapcode(var_inapcode, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_tbdetailokR_mob_refresh_inapcode_cb);
  } // do_ajax_form_tbdetailokR_mob_refresh_inapcode

  function do_ajax_form_tbdetailokR_mob_refresh_inapcode_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdetailokR_mob_refresh_inapcode_cb

  // ---------- Event onchange anestime
  function do_ajax_form_tbdetailokR_mob_event_anestime_onchange()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tbdetailokR_mob_event_anestime_onchange(var_signouttime, var_opertime, var_opertime_hora, var_timeouttime, var_anestime, var_anestime_hora, var_script_case_init, do_ajax_form_tbdetailokR_mob_event_anestime_onchange_cb);
  } // do_ajax_form_tbdetailokR_mob_event_anestime_onchange

  function do_ajax_form_tbdetailokR_mob_event_anestime_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_tbdetailokR_mob_event_anestime_onchange_cb_after_alert);
  } // do_ajax_form_tbdetailokR_mob_event_anestime_onchange_cb
  function do_ajax_form_tbdetailokR_mob_event_anestime_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_tbdetailokR_mob_event_anestime_onchange_cb_after_alert

  // ---------- Event onclick babybirth
  function do_ajax_form_tbdetailokR_mob_event_babybirth_onclick()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tbdetailokR_mob_event_babybirth_onclick(var_lingkar, var_tb, var_bb, var_birthtime, var_birthdate, var_birthdate_hora, var_hidup, var_script_case_init, do_ajax_form_tbdetailokR_mob_event_babybirth_onclick_cb);
  } // do_ajax_form_tbdetailokR_mob_event_babybirth_onclick

  function do_ajax_form_tbdetailokR_mob_event_babybirth_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_tbdetailokR_mob_event_babybirth_onclick_cb_after_alert);
  } // do_ajax_form_tbdetailokR_mob_event_babybirth_onclick_cb
  function do_ajax_form_tbdetailokR_mob_event_babybirth_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_tbdetailokR_mob_event_babybirth_onclick_cb_after_alert

  // ---------- Event onclick observasi
  function do_ajax_form_tbdetailokR_mob_event_observasi_onclick()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tbdetailokR_mob_event_observasi_onclick(var_observasi, var_awalobs, var_awalobs_hora, var_inapcode, var_script_case_init, do_ajax_form_tbdetailokR_mob_event_observasi_onclick_cb);
  } // do_ajax_form_tbdetailokR_mob_event_observasi_onclick

  function do_ajax_form_tbdetailokR_mob_event_observasi_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_tbdetailokR_mob_event_observasi_onclick_cb_after_alert);
  } // do_ajax_form_tbdetailokR_mob_event_observasi_onclick_cb
  function do_ajax_form_tbdetailokR_mob_event_observasi_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_tbdetailokR_mob_event_observasi_onclick_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tbdetailokR_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tbdetailokR_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_inapcode = scAjaxGetFieldText("inapcode");
    ...
    scAjaxProcOn();
    x_ajax_form_tbdetailokR_mob_submit_form(var_inapcode, var_trancode, var_custcode, var_class, var_entrydate, var_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbdetailokR_mob_submit_form_cb);
  } // do_ajax_form_tbdetailokR_mob_submit_form

  function do_ajax_form_tbdetailokR_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tbdetailokR_mob_submit_form_cb_after_alert);
  } // do_ajax_form_tbdetailokR_mob_submit_form_cb
  function do_ajax_form_tbdetailokR_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbdetailokR_mob_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_tbdetailresepokvkR_mob"] = "off";

  function do_ajax_form_tbdetailokR_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    scStatusDetail["form_tbdetailresepokvkR_mob"] = "on";
    x_ajax_form_tbdetailokR_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbdetailokR_mob_navigate_form_cb);
  } // do_ajax_form_tbdetailokR_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailokR_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbdetailokR_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_tbdetailresepokvkR_mob"] && "nmsc_iframe_liga_form_tbdetailresepokvkR_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_tbdetailresepokvkR_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_tbdetailresepokvkR_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_tbdetailresepokvkR_mob').contentWindow.nm_move('apl_detalhe', true, '500');
        document.getElementById('nmsc_iframe_liga_form_tbdetailresepokvkR_mob').style.height = "500";
        document.getElementById('nmsc_iframe_liga_form_tbdetailresepokvkR_mob').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbdetailokR_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_tbdetailokR_mob_navigate_form_cb
  function do_ajax_form_tbdetailokR_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_tbdetailokR_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_tbdetailokR_mob_navigate_form_cb_after_alert
  function sc_hide_form_tbdetailokR_mob_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_tbdetailresepokvkR_mob"])
    {
      return true;
    }
    return false;
  ...
  var ajax_field_id = {
    ...
    "entrydate": new Array("hidden_field_label_entrydate", "hidden_field_data_entrydate"),
