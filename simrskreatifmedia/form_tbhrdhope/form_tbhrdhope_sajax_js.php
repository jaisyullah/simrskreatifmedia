  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbhrdhope" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbhrdhope_form();
	}

  // ---------- Validate penghasilansbl_
  function do_ajax_form_tbhrdhope_validate_penghasilansbl_(iNumLinha)
  {
    var nomeCampo_penghasilansbl_ = "penghasilansbl_" + iNumLinha;
    var var_penghasilansbl_ = scAjaxGetFieldText(nomeCampo_penghasilansbl_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbhrdhope_validate_penghasilansbl_(var_penghasilansbl_, iNumLinha, var_script_case_init, do_ajax_form_tbhrdhope_validate_penghasilansbl__cb);
  } // do_ajax_form_tbhrdhope_validate_penghasilansbl_

  function do_ajax_form_tbhrdhope_validate_penghasilansbl__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "penghasilansbl_" + iLineNumber;
    }
    else
    {
      sFieldValid = "penghasilansbl_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "penghasilansbl_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "penghasilansbl_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbhrdhope_validate_penghasilansbl__cb

  // ---------- Validate penghasilaningin_
  function do_ajax_form_tbhrdhope_validate_penghasilaningin_(iNumLinha)
  {
    var nomeCampo_penghasilaningin_ = "penghasilaningin_" + iNumLinha;
    var var_penghasilaningin_ = scAjaxGetFieldText(nomeCampo_penghasilaningin_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbhrdhope_validate_penghasilaningin_(var_penghasilaningin_, iNumLinha, var_script_case_init, do_ajax_form_tbhrdhope_validate_penghasilaningin__cb);
  } // do_ajax_form_tbhrdhope_validate_penghasilaningin_

  function do_ajax_form_tbhrdhope_validate_penghasilaningin__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "penghasilaningin_" + iLineNumber;
    }
    else
    {
      sFieldValid = "penghasilaningin_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "penghasilaningin_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "penghasilaningin_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbhrdhope_validate_penghasilaningin__cb

  // ---------- Validate fasilitassbl_
  function do_ajax_form_tbhrdhope_validate_fasilitassbl_(iNumLinha)
  {
    var nomeCampo_fasilitassbl_ = "fasilitassbl_" + iNumLinha;
    var var_fasilitassbl_ = scAjaxGetFieldText(nomeCampo_fasilitassbl_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbhrdhope_validate_fasilitassbl_(var_fasilitassbl_, iNumLinha, var_script_case_init, do_ajax_form_tbhrdhope_validate_fasilitassbl__cb);
  } // do_ajax_form_tbhrdhope_validate_fasilitassbl_

  function do_ajax_form_tbhrdhope_validate_fasilitassbl__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "fasilitassbl_" + iLineNumber;
    }
    else
    {
      sFieldValid = "fasilitassbl_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "fasilitassbl_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "fasilitassbl_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbhrdhope_validate_fasilitassbl__cb

  // ---------- Validate fasilitasingin_
  function do_ajax_form_tbhrdhope_validate_fasilitasingin_(iNumLinha)
  {
    var nomeCampo_fasilitasingin_ = "fasilitasingin_" + iNumLinha;
    var var_fasilitasingin_ = scAjaxGetFieldText(nomeCampo_fasilitasingin_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbhrdhope_validate_fasilitasingin_(var_fasilitasingin_, iNumLinha, var_script_case_init, do_ajax_form_tbhrdhope_validate_fasilitasingin__cb);
  } // do_ajax_form_tbhrdhope_validate_fasilitasingin_

  function do_ajax_form_tbhrdhope_validate_fasilitasingin__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "fasilitasingin_" + iLineNumber;
    }
    else
    {
      sFieldValid = "fasilitasingin_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "fasilitasingin_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "fasilitasingin_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbhrdhope_validate_fasilitasingin__cb

  // ---------- Validate id_
  function do_ajax_form_tbhrdhope_validate_id_(iNumLinha)
  {
    var nomeCampo_id_ = "id_" + iNumLinha;
    var var_id_ = scAjaxGetFieldHidden(nomeCampo_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbhrdhope_validate_id_(var_id_, iNumLinha, var_script_case_init, do_ajax_form_tbhrdhope_validate_id__cb);
  } // do_ajax_form_tbhrdhope_validate_id_

  function do_ajax_form_tbhrdhope_validate_id__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbhrdhope_validate_id__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_tbhrdhope_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_tbhrdhope_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tbhrdhope_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_tbhrdhope_add_new_line_cb);
  } // do_ajax_form_tbhrdhope_add_new_line

  function do_ajax_form_tbhrdhope_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_tbhrdhope_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_tbhrdhope_backup_line(iNumLinha)
  {
    var var_id_ = scAjaxGetFieldHidden("id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbhrdhope_backup_line(var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_tbhrdhope_backup_line_cb);
  } // do_ajax_form_tbhrdhope_backup_line

  function do_ajax_form_tbhrdhope_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_tbhrdhope_backup_line_cb

  function do_ajax_form_tbhrdhope_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_tbhrdhope_cancel_insert

  function do_ajax_form_tbhrdhope_cancel_update(iSeqVert)
  {
    do_ajax_form_tbhrdhope_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_tbhrdhope_cancel_update

  function do_ajax_form_tbhrdhope_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_tbhrdhope_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_tbhrdhope_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_tbhrdhope_table_refresh(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbhrdhope_table_refresh_cb);
  } //  do_ajax_form_tbhrdhope_table_refresh

  function do_ajax_form_tbhrdhope_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_tbhrdhope_table_refresh_cb_after_alert);
  } // do_ajax_form_tbhrdhope_table_refresh_cb
  function do_ajax_form_tbhrdhope_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxSetNavStatus("t");
    sc_insert_open = false;
  } // do_ajax_form_tbhrdhope_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_tbhrdhope_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_tbhrdhope_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    sc_num_ult_line = iNumLinha;
    sc_num_ult_tr   = indexTR;
    scAjaxHideMessage();
    var var_penghasilansbl_ = scAjaxGetFieldText("penghasilansbl_" + iNumLinha);
    var var_penghasilaningin_ = scAjaxGetFieldText("penghasilaningin_" + iNumLinha);
    var var_fasilitassbl_ = scAjaxGetFieldText("fasilitassbl_" + iNumLinha);
    var var_fasilitasingin_ = scAjaxGetFieldText("fasilitasingin_" + iNumLinha);
    var var_id_ = scAjaxGetFieldHidden("id_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_tbhrdhope_submit_form(var_penghasilansbl_, var_penghasilaningin_, var_fasilitassbl_, var_fasilitasingin_, var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbhrdhope_submit_form_cb);
  } // do_ajax_form_tbhrdhope_submit_form

  function do_ajax_form_tbhrdhope_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("penghasilansbl_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("penghasilaningin_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("fasilitassbl_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("fasilitasingin_" + sc_num_ult_line);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_tbhrdhope_submit_form_cb_after_alert);
  } // do_ajax_form_tbhrdhope_submit_form_cb
  function do_ajax_form_tbhrdhope_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbhrdhope_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tbhrdhope_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_tbhrdhope_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("penghasilansbl_" + iNavForm);
      scAjaxHideErrorDisplay("penghasilaningin_" + iNavForm);
      scAjaxHideErrorDisplay("fasilitassbl_" + iNavForm);
      scAjaxHideErrorDisplay("fasilitasingin_" + iNavForm);
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tbhrdhope_navigate_form(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbhrdhope_navigate_form_cb);
  } // do_ajax_form_tbhrdhope_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrdhope']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbhrdhope_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbhrdhope_navigate_form_cb_after_alert);
  } // do_ajax_form_tbhrdhope_navigate_form_cb
  function do_ajax_form_tbhrdhope_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_tbhrdhope_navigate_form_cb_after_alert
  function sc_hide_form_tbhrdhope_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "penghasilansbl_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "penghasilaningin_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "fasilitassbl_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "fasilitasingin_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "id_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["penghasilansbl_" + iNumLinha] = {"label": "Penghasilan Sebelumnya<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["penghasilaningin_" + iNumLinha] = {"label": "Penghasilan yang Diinginkan<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["fasilitassbl_" + iNumLinha] = {"label": "Fasilitas Sebelumnya<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["fasilitasingin_" + iNumLinha] = {"label": "Fasilitas yang Diinginkan<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_field_mult["penghasilansbl_"][iNumLinha] = "penghasilansbl_" + iNumLinha;
    ajax_field_mult["penghasilaningin_"][iNumLinha] = "penghasilaningin_" + iNumLinha;
    ajax_field_mult["fasilitassbl_"][iNumLinha] = "fasilitassbl_" + iNumLinha;
    ajax_field_mult["fasilitasingin_"][iNumLinha] = "fasilitasingin_" + iNumLinha;
    ajax_field_mult["id_"][iNumLinha] = "id_" + iNumLinha;
    ajax_field_id["penghasilansbl_" + iNumLinha] = new Array("hidden_field_label_penghasilansbl_", "hidden_field_data_penghasilansbl_" + iNumLinha);
    ajax_field_id["penghasilaningin_" + iNumLinha] = new Array("hidden_field_label_penghasilaningin_", "hidden_field_data_penghasilaningin_" + iNumLinha);
    ajax_field_id["fasilitassbl_" + iNumLinha] = new Array("hidden_field_label_fasilitassbl_", "hidden_field_data_fasilitassbl_" + iNumLinha);
    ajax_field_id["fasilitasingin_" + iNumLinha] = new Array("hidden_field_label_fasilitasingin_", "hidden_field_data_fasilitasingin_" + iNumLinha);
    ajax_error_count["penghasilansbl_" + iNumLinha] = "off";
    ajax_error_count["penghasilaningin_" + iNumLinha] = "off";
    ajax_error_count["fasilitassbl_" + iNumLinha] = "off";
    ajax_error_count["fasilitasingin_" + iNumLinha] = "off";
    ajax_error_count["id_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["penghasilansbl_" + iNumLinha] = "off";
    ajax_read_only["penghasilaningin_" + iNumLinha] = "off";
    ajax_read_only["fasilitassbl_" + iNumLinha] = "off";
    ajax_read_only["fasilitasingin_" + iNumLinha] = "off";
...
{
?>
    ajax_read_only["penghasilansbl_" + iNumLinha] = "on";
    ajax_read_only["penghasilaningin_" + iNumLinha] = "on";
    ajax_read_only["fasilitassbl_" + iNumLinha] = "on";
    ajax_read_only["fasilitasingin_" + iNumLinha] = "on";
    ajax_read_only["id_" + iNumLinha] = "on";
<?php
}
?>
  ...
  {
    ajax_error_list["penghasilansbl_" + iNumLinha] = null;
    ajax_error_list["penghasilaningin_" + iNumLinha] = null;
    ajax_error_list["fasilitassbl_" + iNumLinha] = null;
    ajax_error_list["fasilitasingin_" + iNumLinha] = null;
  ...
  var ajax_field_mult = {
    "penghasilansbl_": new Array(),
    "penghasilaningin_": new Array(),
    "fasilitassbl_": new Array(),
    "fasilitasingin_": new Array(),
    "id_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["penghasilansbl_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["penghasilansbl_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["penghasilansbl_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["penghasilansbl_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["penghasilansbl_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["penghasilaningin_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["penghasilaningin_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["penghasilaningin_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["penghasilaningin_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["penghasilaningin_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["fasilitassbl_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["fasilitassbl_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["fasilitassbl_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["fasilitassbl_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["fasilitassbl_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["fasilitasingin_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["fasilitasingin_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["fasilitasingin_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["fasilitasingin_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["fasilitasingin_" + iNumLinha]["onfocus"] = new Array();
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['penghasilansbl_'])) ? $this->nmgp_cmp_readonly['penghasilansbl_'] : 'off';
?>
    scAjaxFieldRead("penghasilansbl_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['penghasilaningin_'])) ? $this->nmgp_cmp_readonly['penghasilaningin_'] : 'off';
?>
    scAjaxFieldRead("penghasilaningin_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['fasilitassbl_'])) ? $this->nmgp_cmp_readonly['fasilitassbl_'] : 'off';
?>
    scAjaxFieldRead("fasilitassbl_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['fasilitasingin_'])) ? $this->nmgp_cmp_readonly['fasilitasingin_'] : 'off';
?>
    scAjaxFieldRead("fasilitasingin_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
?>
  ...
  {
    scAjaxFieldRead("penghasilansbl_" + iSeq, "on");
    scAjaxFieldRead("penghasilaningin_" + iSeq, "on");
    scAjaxFieldRead("fasilitassbl_" + iSeq, "on");
    scAjaxFieldRead("fasilitasingin_" + iSeq, "on");
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["penghasilansbl_" + iRow] || "on" == ajax_error_count["penghasilaningin_" + iRow] || "on" == ajax_error_count["fasilitassbl_" + iRow] || "on" == ajax_error_count["fasilitasingin_" + iRow] || "on" == ajax_error_count["id_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_penghasilansbl_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_penghasilaningin_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_fasilitassbl_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_fasilitasingin_" + iRow).addClass("scFormErrorLine");
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["penghasilansbl_" + iRow] && "off" == ajax_error_count["penghasilaningin_" + iRow] && "off" == ajax_error_count["fasilitassbl_" + iRow] && "off" == ajax_error_count["fasilitasingin_" + iRow] && "off" == ajax_error_count["id_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["penghasilansbl_" + iRow] = "off";
        ajax_error_count["penghasilaningin_" + iRow] = "off";
        ajax_error_count["fasilitassbl_" + iRow] = "off";
        ajax_error_count["fasilitasingin_" + iRow] = "off";
      ...
      $("#hidden_field_data_penghasilansbl_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_penghasilaningin_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_fasilitassbl_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_fasilitasingin_" + iRow).removeClass("scFormErrorLine");
