  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbtranrad" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbtranrad_form();
	}

  // ---------- Validate id
  function do_ajax_form_tbtranrad_validate_id()
  {
    var nomeCampo_id = "id";
    var var_id = scAjaxGetFieldHidden(nomeCampo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtranrad_validate_id(var_id, var_script_case_init, do_ajax_form_tbtranrad_validate_id_cb);
  } // do_ajax_form_tbtranrad_validate_id

  function do_ajax_form_tbtranrad_validate_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtranrad_validate_id_cb

  // ---------- Validate trancode
  function do_ajax_form_tbtranrad_validate_trancode()
  {
    var nomeCampo_trancode = "trancode";
    var var_trancode = scAjaxGetFieldText(nomeCampo_trancode);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtranrad_validate_trancode(var_trancode, var_script_case_init, do_ajax_form_tbtranrad_validate_trancode_cb);
  } // do_ajax_form_tbtranrad_validate_trancode

  function do_ajax_form_tbtranrad_validate_trancode_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtranrad_validate_trancode_cb

  // ---------- Validate trandate
  function do_ajax_form_tbtranrad_validate_trandate()
  {
    var nomeCampo_trandate = "trandate";
    var var_trandate = scAjaxGetFieldText(nomeCampo_trandate);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtranrad_validate_trandate(var_trandate, var_script_case_init, do_ajax_form_tbtranrad_validate_trandate_cb);
  } // do_ajax_form_tbtranrad_validate_trandate

  function do_ajax_form_tbtranrad_validate_trandate_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtranrad_validate_trandate_cb

  // ---------- Validate custcode
  function do_ajax_form_tbtranrad_validate_custcode()
  {
    var nomeCampo_custcode = "custcode";
    var var_custcode = scAjaxGetFieldText(nomeCampo_custcode);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtranrad_validate_custcode(var_custcode, var_script_case_init, do_ajax_form_tbtranrad_validate_custcode_cb);
  } // do_ajax_form_tbtranrad_validate_custcode

  function do_ajax_form_tbtranrad_validate_custcode_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtranrad_validate_custcode_cb

  // ---------- Validate inapcode
  function do_ajax_form_tbtranrad_validate_inapcode()
  {
    var nomeCampo_inapcode = "inapcode";
    var var_inapcode = scAjaxGetFieldText(nomeCampo_inapcode);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtranrad_validate_inapcode(var_inapcode, var_script_case_init, do_ajax_form_tbtranrad_validate_inapcode_cb);
  } // do_ajax_form_tbtranrad_validate_inapcode

  function do_ajax_form_tbtranrad_validate_inapcode_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtranrad_validate_inapcode_cb

  // ---------- Validate instcode
  function do_ajax_form_tbtranrad_validate_instcode()
  {
    var nomeCampo_instcode = "instcode";
    var var_instcode = scAjaxGetFieldSelect(nomeCampo_instcode);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtranrad_validate_instcode(var_instcode, var_script_case_init, do_ajax_form_tbtranrad_validate_instcode_cb);
  } // do_ajax_form_tbtranrad_validate_instcode

  function do_ajax_form_tbtranrad_validate_instcode_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtranrad_validate_instcode_cb

  // ---------- Validate sc_field_1
  function do_ajax_form_tbtranrad_validate_sc_field_1()
  {
    var nomeCampo_sc_field_1 = "sc_field_1";
    var var_sc_field_1 = scAjaxGetFieldSelect(nomeCampo_sc_field_1);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtranrad_validate_sc_field_1(var_sc_field_1, var_script_case_init, do_ajax_form_tbtranrad_validate_sc_field_1_cb);
  } // do_ajax_form_tbtranrad_validate_sc_field_1

  function do_ajax_form_tbtranrad_validate_sc_field_1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtranrad_validate_sc_field_1_cb

  // ---------- Validate struk
  function do_ajax_form_tbtranrad_validate_struk()
  {
    var nomeCampo_struk = "struk";
    var var_struk = scAjaxGetFieldSelect(nomeCampo_struk);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtranrad_validate_struk(var_struk, var_script_case_init, do_ajax_form_tbtranrad_validate_struk_cb);
  } // do_ajax_form_tbtranrad_validate_struk

  function do_ajax_form_tbtranrad_validate_struk_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "struk";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtranrad_validate_struk_cb

  // ---------- Validate sc_field_0
  function do_ajax_form_tbtranrad_validate_sc_field_0()
  {
    var nomeCampo_sc_field_0 = "sc_field_0";
    var var_sc_field_0 = scAjaxGetFieldSelect(nomeCampo_sc_field_0);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtranrad_validate_sc_field_0(var_sc_field_0, var_script_case_init, do_ajax_form_tbtranrad_validate_sc_field_0_cb);
  } // do_ajax_form_tbtranrad_validate_sc_field_0

  function do_ajax_form_tbtranrad_validate_sc_field_0_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtranrad_validate_sc_field_0_cb

  // ---------- Validate usia
  function do_ajax_form_tbtranrad_validate_usia()
  {
    var nomeCampo_usia = "usia";
    var var_usia = scAjaxGetFieldText(nomeCampo_usia);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtranrad_validate_usia(var_usia, var_script_case_init, do_ajax_form_tbtranrad_validate_usia_cb);
  } // do_ajax_form_tbtranrad_validate_usia

  function do_ajax_form_tbtranrad_validate_usia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "usia";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtranrad_validate_usia_cb

  // ---------- Validate alamat
  function do_ajax_form_tbtranrad_validate_alamat()
  {
    var nomeCampo_alamat = "alamat";
    var var_alamat = scAjaxGetFieldSelect(nomeCampo_alamat);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtranrad_validate_alamat(var_alamat, var_script_case_init, do_ajax_form_tbtranrad_validate_alamat_cb);
  } // do_ajax_form_tbtranrad_validate_alamat

  function do_ajax_form_tbtranrad_validate_alamat_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "alamat";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtranrad_validate_alamat_cb

  // ---------- Validate poli
  function do_ajax_form_tbtranrad_validate_poli()
  {
    var nomeCampo_poli = "poli";
    var var_poli = scAjaxGetFieldSelect(nomeCampo_poli);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtranrad_validate_poli(var_poli, var_script_case_init, do_ajax_form_tbtranrad_validate_poli_cb);
  } // do_ajax_form_tbtranrad_validate_poli

  function do_ajax_form_tbtranrad_validate_poli_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "poli";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtranrad_validate_poli_cb

  // ---------- Validate docname
  function do_ajax_form_tbtranrad_validate_docname()
  {
    var nomeCampo_docname = "docname";
    var var_docname = scAjaxGetFieldSelect(nomeCampo_docname);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtranrad_validate_docname(var_docname, var_script_case_init, do_ajax_form_tbtranrad_validate_docname_cb);
  } // do_ajax_form_tbtranrad_validate_docname

  function do_ajax_form_tbtranrad_validate_docname_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "docname";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtranrad_validate_docname_cb

  // ---------- Validate doccode
  function do_ajax_form_tbtranrad_validate_doccode()
  {
    var nomeCampo_doccode = "doccode";
    var var_doccode = scAjaxGetFieldSelect(nomeCampo_doccode);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtranrad_validate_doccode(var_doccode, var_script_case_init, do_ajax_form_tbtranrad_validate_doccode_cb);
  } // do_ajax_form_tbtranrad_validate_doccode

  function do_ajax_form_tbtranrad_validate_doccode_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "doccode";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtranrad_validate_doccode_cb

  // ---------- Validate diag
  function do_ajax_form_tbtranrad_validate_diag()
  {
    var nomeCampo_diag = "diag";
    var var_diag = scAjaxGetFieldText(nomeCampo_diag);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtranrad_validate_diag(var_diag, var_script_case_init, do_ajax_form_tbtranrad_validate_diag_cb);
  } // do_ajax_form_tbtranrad_validate_diag

  function do_ajax_form_tbtranrad_validate_diag_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "diag";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtranrad_validate_diag_cb

  // ---------- Validate contrast
  function do_ajax_form_tbtranrad_validate_contrast()
  {
    var nomeCampo_contrast = "contrast";
    var var_contrast = scAjaxGetFieldSelect(nomeCampo_contrast);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtranrad_validate_contrast(var_contrast, var_script_case_init, do_ajax_form_tbtranrad_validate_contrast_cb);
  } // do_ajax_form_tbtranrad_validate_contrast

  function do_ajax_form_tbtranrad_validate_contrast_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtranrad_validate_contrast_cb

  // ---------- Validate note
  function do_ajax_form_tbtranrad_validate_note()
  {
    var nomeCampo_note = "note";
    var var_note = scAjaxGetFieldText(nomeCampo_note);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtranrad_validate_note(var_note, var_script_case_init, do_ajax_form_tbtranrad_validate_note_cb);
  } // do_ajax_form_tbtranrad_validate_note

  function do_ajax_form_tbtranrad_validate_note_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "note";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtranrad_validate_note_cb

  // ---------- Validate status
  function do_ajax_form_tbtranrad_validate_status()
  {
    var nomeCampo_status = "status";
    var var_status = scAjaxGetFieldSelect(nomeCampo_status);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtranrad_validate_status(var_status, var_script_case_init, do_ajax_form_tbtranrad_validate_status_cb);
  } // do_ajax_form_tbtranrad_validate_status

  function do_ajax_form_tbtranrad_validate_status_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "status";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtranrad_validate_status_cb

  // ---------- Validate detailrad
  function do_ajax_form_tbtranrad_validate_detailrad()
  {
    var nomeCampo_detailrad = "detailrad";
    var var_detailrad = scAjaxGetFieldText(nomeCampo_detailrad);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtranrad_validate_detailrad(var_detailrad, var_script_case_init, do_ajax_form_tbtranrad_validate_detailrad_cb);
  } // do_ajax_form_tbtranrad_validate_detailrad

  function do_ajax_form_tbtranrad_validate_detailrad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtranrad_validate_detailrad_cb

  // ---------- Refresh custcode
  function do_ajax_form_tbtranrad_refresh_custcode()
  {
    ...
    scAjaxProcOn(true);
    x_ajax_form_tbtranrad_refresh_custcode(var_custcode, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_tbtranrad_refresh_custcode_cb);
  } // do_ajax_form_tbtranrad_refresh_custcode

  function do_ajax_form_tbtranrad_refresh_custcode_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtranrad_refresh_custcode_cb

  // ---------- Refresh instcode
  function do_ajax_form_tbtranrad_refresh_instcode()
  {
    var var_instcode = scAjaxGetFieldSelect("instcode");
    var var_nmgp_refresh_fields = "sc_field_1";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tbtranrad_refresh_instcode(var_instcode, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_tbtranrad_refresh_instcode_cb);
  } // do_ajax_form_tbtranrad_refresh_instcode

  function do_ajax_form_tbtranrad_refresh_instcode_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtranrad_refresh_instcode_cb

  // ---------- Refresh struk
  function do_ajax_form_tbtranrad_refresh_struk()
  {
    var var_struk = scAjaxGetFieldSelect("struk");
    var var_nmgp_refresh_fields = "doccode_#fld#_docname_#fld#_poli";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tbtranrad_refresh_struk(var_struk, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_tbtranrad_refresh_struk_cb);
  } // do_ajax_form_tbtranrad_refresh_struk

  function do_ajax_form_tbtranrad_refresh_struk_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtranrad_refresh_struk_cb

  // ---------- Event onchange custcode
  function do_ajax_form_tbtranrad_event_custcode_onchange()
  {
    var var_custcode = scAjaxGetFieldText("custcode");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tbtranrad_event_custcode_onchange(var_custcode, var_usia, var_struk, var_diag, var_script_case_init, do_ajax_form_tbtranrad_event_custcode_onchange_cb);
  } // do_ajax_form_tbtranrad_event_custcode_onchange

  function do_ajax_form_tbtranrad_event_custcode_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "custcode";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_tbtranrad_event_custcode_onchange_cb_after_alert);
  } // do_ajax_form_tbtranrad_event_custcode_onchange_cb
  function do_ajax_form_tbtranrad_event_custcode_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    do_ajax_form_tbtranrad_refresh_custcode();
  ...
  } // do_ajax_form_tbtranrad_event_custcode_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tbtranrad_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tbtranrad_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_tbtranrad_submit_form(var_id, var_trancode, var_trandate, var_custcode, var_inapcode, var_instcode, var_sc_field_1, var_struk, var_sc_field_0, var_usia, var_alamat, var_poli, var_docname, var_doccode, var_diag, var_contrast, var_note, var_status, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbtranrad_submit_form_cb);
  } // do_ajax_form_tbtranrad_submit_form

  function do_ajax_form_tbtranrad_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tbtranrad_submit_form_cb_after_alert);
  } // do_ajax_form_tbtranrad_submit_form_cb
  function do_ajax_form_tbtranrad_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbtranrad_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_tbdetailrad"] = "off";

  function do_ajax_form_tbtranrad_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    x_ajax_form_tbtranrad_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbtranrad_navigate_form_cb);
  } // do_ajax_form_tbtranrad_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbtranrad_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbtranrad_navigate_form_cb_after_alert);
  } // do_ajax_form_tbtranrad_navigate_form_cb
  function do_ajax_form_tbtranrad_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_tbtranrad_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_tbtranrad_navigate_form_cb_after_alert
  function sc_hide_form_tbtranrad_form()
  {
