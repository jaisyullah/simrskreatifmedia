...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "terpakai";$Nm_numeric[] = "";$Nm_numeric[] = "terpakai";$Nm_numeric[] = "";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_item_cond" name="item_cond" onChange="nm_campos_between(document.getElementById('id_vis_item'), this, 'item')">
      ...
      <br><span id="id_hide_item"  <?php echo $str_hide_item?>><?php
      if ($item != "")
      {
      $item_look = substr($this->Db->qstr($item), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_namaitem_cond" name="namaitem_cond" onChange="nm_campos_between(document.getElementById('id_vis_namaitem'), this, 'namaitem')">
      ...
      <br><span id="id_hide_namaitem"  <?php echo $str_hide_namaitem?>><?php
      if ($namaitem != "")
      {
      $namaitem_look = substr($this->Db->qstr($namaitem), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_terpakai_cond" name="terpakai_cond" onChange="nm_campos_between(document.getElementById('id_vis_terpakai'), this, 'terpakai')">
      ...
      <br><span id="id_hide_terpakai"  <?php echo $str_hide_terpakai?>><INPUT  type="text" id="SC_terpakai" name="terpakai" value="<?php echo NM_encode_input($terpakai) ?>" size=19 alt="{datatype: 'integer', maxLength: 19, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_ket_cond" name="ket_cond" onChange="nm_campos_between(document.getElementById('id_vis_ket'), this, 'ket')">
      ...
      <br><span id="id_hide_ket"  <?php echo $str_hide_ket?>><?php
      if ($ket != "")
      {
      $ket_look = substr($this->Db->qstr($ket), 1, -1); 
      $nmgp_def_dados = array(); 
