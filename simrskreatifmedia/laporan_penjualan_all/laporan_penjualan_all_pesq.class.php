...
class laporan_penjualan_all_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['path_libs_php'] = $this->Ini->path_lib_php;
      ...
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search_change_fil")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['campos_busca'] = array(); 
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . laporan_penjualan_all_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . laporan_penjualan_all_pack_protect_string($Tipo_filter[0]) . "\">.." . laporan_penjualan_all_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_ket')
      {
          $ket = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_ket($ket);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
          ...
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['grid_pesq'][$campo_join]);
              return;
          }
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>laporan_penjualan_all/laporan_penjualan_all_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="laporan_penjualan_all_ajax_search.js"></script>
 <script type="text/javascript" src="laporan_penjualan_all_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="laporan_penjualan_all_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['laporan_penjualan_all']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['laporan_penjualan_all']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_terpakai_cond#NMF#' + search_get_sel_txt('SC_terpakai_cond') + '@NMF@';
  str_out += 'SC_terpakai#NMF#' + search_get_text('SC_terpakai') + '@NMF@';
  str_out += 'SC_ket_cond#NMF#' + search_get_sel_txt('SC_ket_cond') + '@NMF@';
  str_out += 'SC_ket#NMF#' + search_get_text('SC_ket') + '@NMF@';
  str_out += 'id_ac_ket#NMF#' + search_get_text('id_ac_ket') + '@NMF@';
   ...
   $("#id_ac_ket").autocomplete({
     ...
     $.ajax({
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_ket",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<?php
   ...
   function monta_form()
   {
      global 
             ...
             $terpakai_cond, $terpakai,
             $ket_cond, $ket, $ket_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          $item = $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['campos_busca']['item']; 
          $item_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['campos_busca']['item_cond']; 
          $namaitem = $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['campos_busca']['namaitem']; 
          $namaitem_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['campos_busca']['namaitem_cond']; 
          $terpakai = $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['campos_busca']['terpakai']; 
          $terpakai_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['campos_busca']['terpakai_cond']; 
          $ket = $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['campos_busca']['ket']; 
          $ket_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['campos_busca']['ket_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['campos_busca']['NM_operador']; 
          if (strtoupper($terpakai_cond) != "II" && strtoupper($terpakai_cond) != "QP" && strtoupper($terpakai_cond) != "NP" && strtoupper($terpakai_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($terpakai, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
      } 
      if (!isset($item_cond) || empty($item_cond))
      {
         $item_cond = "qp";
      }
      if (!isset($namaitem_cond) || empty($namaitem_cond))
      {
         $namaitem_cond = "qp";
      }
      if (!isset($terpakai_cond) || empty($terpakai_cond))
      {
         $terpakai_cond = "gt";
      }
      if (!isset($ket_cond) || empty($ket_cond))
      {
         $ket_cond = "qp";
      }
      ...
      $str_hide_terpakai = (in_array($terpakai_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_ket = (in_array($ket_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      if (!isset($terpakai) || $terpakai == "")
      {
          $terpakai = "";
      }
      if (isset($terpakai) && !empty($terpakai))
      {
         $tmp_pos = strpos($terpakai, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $terpakai = substr($terpakai, 0, $tmp_pos);
         }
      }
      if (!isset($ket) || $ket == "")
      {
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_item_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['item'])) ? $this->New_label['item'] : "Kode Item"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_item_cond" name="item_cond" onChange="nm_campos_between(document.getElementById('id_vis_item'), this, 'item')">
       <OPTION value="qp" <?php if ("qp" == $item_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $item_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $item_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $item_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
...
?>
<INPUT  type="text" id="SC_item" name="item" value="<?php echo NM_encode_input($item) ?>"  size=50 alt="{datatype: 'text', maxLength: 450, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_item" name="item_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 450, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
     ...
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_namaitem_cond" name="namaitem_cond" onChange="nm_campos_between(document.getElementById('id_vis_namaitem'), this, 'namaitem')">
       <OPTION value="qp" <?php if ("qp" == $namaitem_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $namaitem_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $namaitem_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $namaitem_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
...
?>
<INPUT  type="text" id="SC_namaitem" name="namaitem" value="<?php echo NM_encode_input($namaitem) ?>"  size=50 alt="{datatype: 'text', maxLength: 450, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_namaitem" name="namaitem_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 450, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_terpakai_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['terpakai'])) ? $this->New_label['terpakai'] : "Terpakai"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_terpakai_cond" name="terpakai_cond" onChange="nm_campos_between(document.getElementById('id_vis_terpakai'), this, 'terpakai')">
       <OPTION value="gt" <?php if ("gt" == $terpakai_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $terpakai_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $terpakai_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_terpakai" <?php echo $str_hide_terpakai?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['terpakai'])) ? $this->New_label['terpakai'] : "Terpakai";
 $nmgp_tab_label .= "terpakai?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<INPUT  type="text" id="SC_terpakai" name="terpakai" value="<?php echo NM_encode_input($terpakai) ?>" size=19 alt="{datatype: 'integer', maxLength: 19, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
      ...
      <TD id='SC_ket_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['ket'])) ? $this->New_label['ket'] : "Keterangan"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_ket_cond" name="ket_cond" onChange="nm_campos_between(document.getElementById('id_vis_ket'), this, 'ket')">
       <OPTION value="qp" <?php if ("qp" == $ket_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $ket_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $ket_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $ket_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_ket" <?php echo $str_hide_ket?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['ket'])) ? $this->New_label['ket'] : "Keterangan";
 $nmgp_tab_label .= "ket?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<INPUT  type="text" id="SC_ket" name="ket" value="<?php echo NM_encode_input($ket) ?>"  size=12 alt="{datatype: 'text', maxLength: 12, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_ket" name="ket_autocomp" size="12"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 12, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if ($_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
<?php
   if (is_file("laporan_penjualan_all_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['laporan_penjualan_all']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['laporan_penjualan_all']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.item_cond.value = 'qp';
   ...
   document.F1.namaitem_cond.value = 'qp';
   ...
   document.F1.terpakai_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_terpakai'), document.F1.terpakai_cond, 'terpakai');
   document.F1.terpakai.value = "";
   document.F1.ket_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_ket'), document.F1.ket_cond, 'ket');
   document.F1.ket.value = "";
   document.F1.ket_autocomp.value = "";
 }
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['where_orig']))
      {
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['where_orig'];
      }
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro($nmgp_save_origem)
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "laporan_penjualan_all/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_terpakai_cond'] = 'cond';
      $tp_fields['SC_terpakai'] = 'text';
      $tp_fields['SC_ket_cond'] = 'cond';
      $tp_fields['SC_ket'] = 'text_aut';
      $tp_fields['id_ac_ket'] = 'text_aut';
   ...
   function trata_campos()
   {
      global $item_cond, $item, $item_autocomp,
             $namaitem_cond, $namaitem, $namaitem_autocomp,
             $terpakai_cond, $terpakai,
             $ket_cond, $ket, $ket_autocomp, $nmgp_tab_label;
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['campos_busca'] as $Cmps => $Vals)
          {
              $$Cmps = $Vals;
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['grid_pesq'] = array();
      ...
      if (!empty($ket_autocomp) && empty($ket))
      {
          $ket = $ket_autocomp;
      }
      ...
      $terpakai_cond_salva = $terpakai_cond; 
      if (!isset($terpakai_input_2) || $terpakai_input_2 == "")
      {
          $terpakai_input_2 = $terpakai;
      }
      $ket_cond_salva = $ket_cond; 
      if (!isset($ket_input_2) || $ket_input_2 == "")
      {
          $ket_input_2 = $ket;
      }
      if ($terpakai_cond != "in")
      {
          nm_limpa_numero($terpakai, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['Grid_search']  = array(); 
      $I_Grid = 0;
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['campos_busca']['item'] = $item; 
      if (is_array($item) && !empty($item))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['Grid_search'][$I_Grid]['val'][0] = $item;
      }
      elseif ($item_cond_salva == "nu" || $item_cond_salva == "nn" || $item_cond_salva == "ep" || $item_cond_salva == "ne" || !empty($item))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['Grid_search'][$I_Grid]['val'][0][0] = $item;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['campos_busca']['item_cond'] = $item_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['Grid_search'][$I_Grid]['cmp'] = "item"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['Grid_search'][$I_Grid]['opc'] = $item_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['grid_pesq']['item'] = $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['campos_busca']['namaitem'] = $namaitem; 
      if (is_array($namaitem) && !empty($namaitem))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['Grid_search'][$I_Grid]['val'][0] = $namaitem;
      }
      elseif ($namaitem_cond_salva == "nu" || $namaitem_cond_salva == "nn" || $namaitem_cond_salva == "ep" || $namaitem_cond_salva == "ne" || !empty($namaitem))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['Grid_search'][$I_Grid]['val'][0][0] = $namaitem;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['campos_busca']['namaitem_cond'] = $namaitem_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['Grid_search'][$I_Grid]['cmp'] = "namaitem"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['Grid_search'][$I_Grid]['opc'] = $namaitem_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['grid_pesq']['namaitem'] = $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['campos_busca']['terpakai'] = $terpakai; 
      if (is_array($terpakai) && !empty($terpakai))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['Grid_search'][$I_Grid]['val'][0] = $terpakai;
      }
      elseif ($terpakai_cond_salva == "nu" || $terpakai_cond_salva == "nn" || $terpakai_cond_salva == "ep" || $terpakai_cond_salva == "ne" || !empty($terpakai))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['Grid_search'][$I_Grid]['val'][0][0] = $terpakai;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['campos_busca']['terpakai_cond'] = $terpakai_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['Grid_search'][$I_Grid]['cmp'] = "terpakai"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['Grid_search'][$I_Grid]['opc'] = $terpakai_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['grid_pesq']['terpakai'] = $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['campos_busca']['ket'] = $ket; 
      if (is_array($ket) && !empty($ket))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['Grid_search'][$I_Grid]['val'][0] = $ket;
      }
      elseif ($ket_cond_salva == "nu" || $ket_cond_salva == "nn" || $ket_cond_salva == "ep" || $ket_cond_salva == "ne" || !empty($ket))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['Grid_search'][$I_Grid]['val'][0][0] = $ket;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['campos_busca']['ket_cond'] = $ket_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['Grid_search'][$I_Grid]['cmp'] = "ket"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['Grid_search'][$I_Grid]['opc'] = $ket_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['grid_pesq']['ket'] = $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      ...
      $this->cmp_formatado['terpakai'] = $Conteudo;
      $ket_look = substr($this->Db->qstr($ket), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct KET from (SELECT 	z.item, 	y.namaItem, 	z.terpakai, 	z.KET FROM 	(SELECT 		itemcode as item, 		jumlah as terpakai, 		'POB' AS KET  	FROM 		tbitemdrugsell UNION ALL 	SELECT 		item, 		jumlah - 	IF 		( retur IS NULL, 0, retur ) AS terpakai, 		'Poli' AS KET  	FROM 		tbreseprawatjalan UNION ALL 	SELECT 		item, 		jumlah - 	IF 		( retur IS NULL, 0, retur ) AS terpakai, 		'IGD' AS KET  	FROM 		tbreseprawatigd UNION ALL 	SELECT 		item, 		jumlah - 	IF 		( retur IS NULL, 0, retur ) AS terpakai, 		'RI' AS KET  	FROM 		tbreseprawatinap UNION ALL 	SELECT 		item, 	IF 		( terpakai IS NULL, jumlah, terpakai ) AS terpakai, 		'VK' AS KET  	FROM 		tbdetailresepokvk  	WHERE 		tranCode LIKE 'VK%' UNION ALL 	SELECT 		item, 	IF 		( terpakai IS NULL, jumlah, terpakai ) AS terpakai, 		'OK' AS KET  	FROM 		tbdetailresepokvk  	WHERE 		tranCode LIKE 'OK%'  	) z 	LEFT JOIN tbobat y ON y.kodeItem = z.item  ) nm_sel_esp where KET = '$ket_look'"; 
      unset($cmp1,$cmp2);
      ...
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['ket'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['ket'] = $ket;
      }
      ...
      //----- $terpakai
      $this->Date_part = false;
      if (isset($terpakai) || $terpakai_cond == "nu" || $terpakai_cond == "nn" || $terpakai_cond == "ep" || $terpakai_cond == "ne")
      {
         $this->monta_condicao("terpakai", $terpakai_cond, $terpakai, "", "terpakai");
      }

      //----- $ket
      $this->Date_part = false;
      if (isset($ket) || $ket_cond == "nu" || $ket_cond == "nn" || $ket_cond == "ep" || $ket_cond == "ne")
      {
         $this->monta_condicao("KET", $ket_cond, $ket, "", "ket");
      }
   }
   ...
   function finaliza_resultado_ajax()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['where_pesq'] = $this->comando;
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['where_pesq_fast'])) 
       {
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['where_pesq'])) 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['where_pesq_fast'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['where_pesq'] = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['where_pesq_fast'] . ")";
           }
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['cond_dyn_search'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_penjualan_all']['cond_pesq'] .= $this->NM_operador;
