...
<?php
   ...
   $Ord_Cmp = new laporan_penjualan_all_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class laporan_penjualan_all_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['laporan_penjualan_all']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['laporan_penjualan_all']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["item"]   = (isset($_SESSION['sc_session'][$sc_init]['laporan_penjualan_all']['labels']["item"])) ? $_SESSION['sc_session'][$sc_init]['laporan_penjualan_all']['labels']["item"] : "Kode Item";
   $tab_ger_campos['namaitem'] = "on";
   $tab_def_campos['namaitem'] = "namaItem";
   $tab_labels["namaitem"]   = (isset($_SESSION['sc_session'][$sc_init]['laporan_penjualan_all']['labels']["namaitem"])) ? $_SESSION['sc_session'][$sc_init]['laporan_penjualan_all']['labels']["namaitem"] : "Nama Item";
   $tab_ger_campos['terpakai'] = "on";
   $tab_def_campos['terpakai'] = "terpakai";
   $tab_labels["terpakai"]   = (isset($_SESSION['sc_session'][$sc_init]['laporan_penjualan_all']['labels']["terpakai"])) ? $_SESSION['sc_session'][$sc_init]['laporan_penjualan_all']['labels']["terpakai"] : "Terpakai";
   $tab_ger_campos['ket'] = "on";
   $tab_def_campos['ket'] = "KET";
   $tab_labels["ket"]   = (isset($_SESSION['sc_session'][$sc_init]['laporan_penjualan_all']['labels']["ket"])) ? $_SESSION['sc_session'][$sc_init]['laporan_penjualan_all']['labels']["ket"] : "Keterangan";
   ...
   $tab_labels["sc_field_0"]   = (isset($_SESSION['sc_session'][$sc_init]['laporan_penjualan_all']['labels']["sc_field_0"])) ? $_SESSION['sc_session'][$sc_init]['laporan_penjualan_all']['labels']["sc_field_0"] : "HJA RAJAL";
   ...
   $tab_labels["total"]   = (isset($_SESSION['sc_session'][$sc_init]['laporan_penjualan_all']['labels']["total"])) ? $_SESSION['sc_session'][$sc_init]['laporan_penjualan_all']['labels']["total"] : "Total";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['laporan_penjualan_all']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['laporan_penjualan_all']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['laporan_penjualan_all']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['laporan_penjualan_all']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['laporan_penjualan_all']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['laporan_penjualan_all']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['laporan_penjualan_all']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['laporan_penjualan_all']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['laporan_penjualan_all']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "laporan_penjualan_all_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['laporan_penjualan_all']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['laporan_penjualan_all']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['laporan_penjualan_all']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['laporan_penjualan_all']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['laporan_penjualan_all']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
