...
class laporan_penjualan_all_total
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function __construct($sc_page)
   {
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['laporan_penjualan_all']['campos_busca']) && !empty($_SESSION['sc_session'][$this->sc_page]['laporan_penjualan_all']['campos_busca']))
      { 
