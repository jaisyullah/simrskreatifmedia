<?php
@session_start() ;
$_SESSION['scriptcase']['laporan_penjualan_all']['sc_process_barr'] = true;
require_once('../laporan_penjualan_all/index.php');
unset($_SESSION['scriptcase']['laporan_penjualan_all']['sc_process_barr']);
$ExportCtrl = new laporan_penjualan_all_export_control;
$ExportCtrl->Export_barr();

class laporan_penjualan_all_export_control
{
