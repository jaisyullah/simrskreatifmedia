<?php
@session_start() ;
$_SESSION['scriptcase']['pdfreport_tbhasillab']['sc_process_barr'] = true;
require_once('../pdfreport_tbhasillab/index.php');
unset($_SESSION['scriptcase']['pdfreport_tbhasillab']['sc_process_barr']);
$ExportCtrl = new pdfreport_tbhasillab_export_control;
$ExportCtrl->Export_barr();

class pdfreport_tbhasillab_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_chart_title'] ?> tbhasillab :: Excel</TITLE>
