<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tbreseprawatinap_new']['sc_process_barr'] = true;
require_once('../grid_tbreseprawatinap_new/index.php');
unset($_SESSION['scriptcase']['grid_tbreseprawatinap_new']['sc_process_barr']);
$ExportCtrl = new grid_tbreseprawatinap_new_export_control;
$ExportCtrl->Export_barr();

class grid_tbreseprawatinap_new_export_control
{
