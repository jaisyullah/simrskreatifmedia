<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_tbreseprawatinap_new']['glo_nm_path_imag_temp'] . "/sc_apl_default_simrskreatifmedia.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_tbreseprawatinap_new_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_tbreseprawatinap_new_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbreseprawatinap_new']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tbreseprawatinap_new']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["strukresep"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbreseprawatinap_new']['labels']["strukresep"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbreseprawatinap_new']['labels']["strukresep"] : "Struk Resep";
   ...
   $tab_labels["trandate"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbreseprawatinap_new']['labels']["trandate"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbreseprawatinap_new']['labels']["trandate"] : "Tran Date";
...
ORDER BY custCode";
   ...
   $tab_labels["sc_field_0"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbreseprawatinap_new']['labels']["sc_field_0"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbreseprawatinap_new']['labels']["sc_field_0"] : "No RM";
   ...
   $tab_labels["nama"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbreseprawatinap_new']['labels']["nama"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbreseprawatinap_new']['labels']["nama"] : "Nama";
   ...
   $tab_labels["umur"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbreseprawatinap_new']['labels']["umur"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbreseprawatinap_new']['labels']["umur"] : "Umur";
   ...
   $tab_labels["bed"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbreseprawatinap_new']['labels']["bed"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbreseprawatinap_new']['labels']["bed"] : "Bed";
   ...
   $tab_labels["trancode"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbreseprawatinap_new']['labels']["trancode"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbreseprawatinap_new']['labels']["trancode"] : "Tran Code";
   ...
   $tab_labels["jenis"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbreseprawatinap_new']['labels']["jenis"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbreseprawatinap_new']['labels']["jenis"] : "Jenis";
   ...
   $tab_labels["status"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbreseprawatinap_new']['labels']["status"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbreseprawatinap_new']['labels']["status"] : "Status Bayar";
   ...
   $tab_labels["detail"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbreseprawatinap_new']['labels']["detail"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbreseprawatinap_new']['labels']["detail"] : "Detail";
   ...
   $tab_labels["sc_field_1"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbreseprawatinap_new']['labels']["sc_field_1"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbreseprawatinap_new']['labels']["sc_field_1"] : "Verified Status";
   ...
   $tab_labels["verifyby"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbreseprawatinap_new']['labels']["verifyby"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbreseprawatinap_new']['labels']["verifyby"] : "Verify Oleh";
   ...
   $tab_labels["etiket"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbreseprawatinap_new']['labels']["etiket"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbreseprawatinap_new']['labels']["etiket"] : "Etiket";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_tbreseprawatinap_new']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_tbreseprawatinap_new']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_tbreseprawatinap_new']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbreseprawatinap_new']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tbreseprawatinap_new']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_tbreseprawatinap_new']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_tbreseprawatinap_new']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_tbreseprawatinap_new']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_tbreseprawatinap_new']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_tbreseprawatinap_new_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_tbreseprawatinap_new']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_tbreseprawatinap_new']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_tbreseprawatinap_new']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_tbreseprawatinap_new']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_tbreseprawatinap_new']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
