<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tbtemplateexpertise']['sc_process_barr'] = true;
require_once('../grid_tbtemplateexpertise/index.php');
unset($_SESSION['scriptcase']['grid_tbtemplateexpertise']['sc_process_barr']);
$ExportCtrl = new grid_tbtemplateexpertise_export_control;
$ExportCtrl->Export_barr();

class grid_tbtemplateexpertise_export_control
{
