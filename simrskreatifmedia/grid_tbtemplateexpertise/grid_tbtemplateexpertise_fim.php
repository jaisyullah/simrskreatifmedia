...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_tbtemplateexpertise"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_tbtemplateexpertise"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_tbtemplateexpertise'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tbtemplateexpertise']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_tbtemplateexpertise']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tbtemplateexpertise']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_tbtemplateexpertise']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_tbtemplateexpertise']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_tbtemplateexpertise</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_tbtemplateexpertise']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_tbtemplateexpertise']['embutida_filho'] as $ind => $sc_init)
          {
