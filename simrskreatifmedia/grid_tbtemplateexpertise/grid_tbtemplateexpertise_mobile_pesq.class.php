...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_expertise_cond" name="expertise_cond" onChange="nm_campos_between(document.getElementById('id_vis_expertise'), this, 'expertise')">
      ...
      <br><span id="id_hide_expertise"  <?php echo $str_hide_expertise?>><INPUT  type="text" id="SC_expertise" name="expertise" value="<?php echo NM_encode_input($expertise) ?>" size="50" maxlength="32767" class="scFilterObjectOdd">
 </TD>
