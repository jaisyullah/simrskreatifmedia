<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tblab']['sc_process_barr'] = true;
require_once('../grid_tblab/index.php');
unset($_SESSION['scriptcase']['grid_tblab']['sc_process_barr']);
$ExportCtrl = new grid_tblab_export_control;
$ExportCtrl->Export_barr();

class grid_tblab_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_title'] ?> Cek Lab :: Excel</TITLE>
