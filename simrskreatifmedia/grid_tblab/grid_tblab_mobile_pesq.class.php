...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "lastupdated";$Nm_datas[] = "lastupdated";$Nm_numeric[] = "rate";$Nm_numeric[] = "tipehasil";$Nm_numeric[] = "sub";$Nm_numeric[] = "deleted";$Nm_numeric[] = "isnew";$Nm_numeric[] = "urut";$Nm_numeric[] = "urutsub";$Nm_numeric[] = "id";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_subname_cond" name="subname_cond" onChange="nm_campos_between(document.getElementById('id_vis_subname'), this, 'subname')">
      ...
      <br><span id="id_hide_subname"  <?php echo $str_hide_subname?>><?php
      if ($subname != "")
      {
      $subname_look = substr($this->Db->qstr($subname), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_labcode_cond" name="labcode_cond" onChange="nm_campos_between(document.getElementById('id_vis_labcode'), this, 'labcode')">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_kategori_cond" name="kategori_cond" onChange="nm_campos_between(document.getElementById('id_vis_kategori'), this, 'kategori')">
