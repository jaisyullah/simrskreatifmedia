  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbjenislain_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbjenislain_mob_form();
	}

  // ---------- Validate code
  function do_ajax_form_tbjenislain_mob_validate_code()
  {
    var nomeCampo_code = "code";
    var var_code = scAjaxGetFieldText(nomeCampo_code);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbjenislain_mob_validate_code(var_code, var_script_case_init, do_ajax_form_tbjenislain_mob_validate_code_cb);
  } // do_ajax_form_tbjenislain_mob_validate_code

  function do_ajax_form_tbjenislain_mob_validate_code_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbjenislain_mob_validate_code_cb

  // ---------- Validate name
  function do_ajax_form_tbjenislain_mob_validate_name()
  {
    var nomeCampo_name = "name";
    var var_name = scAjaxGetFieldText(nomeCampo_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbjenislain_mob_validate_name(var_name, var_script_case_init, do_ajax_form_tbjenislain_mob_validate_name_cb);
  } // do_ajax_form_tbjenislain_mob_validate_name

  function do_ajax_form_tbjenislain_mob_validate_name_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "name";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbjenislain_mob_validate_name_cb

  // ---------- Validate deleted
  function do_ajax_form_tbjenislain_mob_validate_deleted()
  {
    var nomeCampo_deleted = "deleted";
    var var_deleted = scAjaxGetFieldText(nomeCampo_deleted);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbjenislain_mob_validate_deleted(var_deleted, var_script_case_init, do_ajax_form_tbjenislain_mob_validate_deleted_cb);
  } // do_ajax_form_tbjenislain_mob_validate_deleted

  function do_ajax_form_tbjenislain_mob_validate_deleted_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "deleted";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbjenislain_mob_validate_deleted_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tbjenislain_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tbjenislain_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_code = scAjaxGetFieldText("code");
    var var_name = scAjaxGetFieldText("name");
    var var_deleted = scAjaxGetFieldText("deleted");
    ...
    scAjaxProcOn();
    x_ajax_form_tbjenislain_mob_submit_form(var_code, var_name, var_deleted, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbjenislain_mob_submit_form_cb);
  } // do_ajax_form_tbjenislain_mob_submit_form

  function do_ajax_form_tbjenislain_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("deleted");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tbjenislain_mob_submit_form_cb_after_alert);
  } // do_ajax_form_tbjenislain_mob_submit_form_cb
  function do_ajax_form_tbjenislain_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbjenislain_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tbjenislain_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_tbjenislain_mob_navigate_form(var_code, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbjenislain_mob_navigate_form_cb);
  } // do_ajax_form_tbjenislain_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbjenislain_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbjenislain_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbjenislain_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_tbjenislain_mob_navigate_form_cb
  function do_ajax_form_tbjenislain_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_tbjenislain_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_tbjenislain_mob_navigate_form_cb_after_alert
  function sc_hide_form_tbjenislain_mob_form()
  {
  ...
  ajax_field_list[0] = "code";
  ajax_field_list[1] = "name";
  ajax_field_list[2] = "deleted";
  ...
  var ajax_error_list = {
    ...
    "deleted": {"label": "Deleted", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  ajax_field_mult["deleted"][1] = "deleted";
  ...
  var ajax_field_id = {
    ...
    "deleted": new Array("hidden_field_label_deleted", "hidden_field_data_deleted")
  };
