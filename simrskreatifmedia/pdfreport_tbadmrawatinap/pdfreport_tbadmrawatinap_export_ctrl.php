<?php
@session_start() ;
$_SESSION['scriptcase']['pdfreport_tbadmrawatinap']['sc_process_barr'] = true;
require_once('../pdfreport_tbadmrawatinap/index.php');
unset($_SESSION['scriptcase']['pdfreport_tbadmrawatinap']['sc_process_barr']);
$ExportCtrl = new pdfreport_tbadmrawatinap_export_control;
$ExportCtrl->Export_barr();

class pdfreport_tbadmrawatinap_export_control
{
