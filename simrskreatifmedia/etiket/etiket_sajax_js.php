...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate sc_field_0
  function do_ajax_etiket_validate_sc_field_0()
  {
    var nomeCampo_sc_field_0 = "sc_field_0";
    var var_sc_field_0 = scAjaxGetFieldText(nomeCampo_sc_field_0);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_etiket_validate_sc_field_0(var_sc_field_0, var_script_case_init, do_ajax_etiket_validate_sc_field_0_cb);
  } // do_ajax_etiket_validate_sc_field_0

  function do_ajax_etiket_validate_sc_field_0_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_etiket_validate_sc_field_0_cb

  // ---------- Validate sc_field_1
  function do_ajax_etiket_validate_sc_field_1()
  {
    var nomeCampo_sc_field_1 = "sc_field_1";
    var var_sc_field_1 = scAjaxGetFieldText(nomeCampo_sc_field_1);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_etiket_validate_sc_field_1(var_sc_field_1, var_script_case_init, do_ajax_etiket_validate_sc_field_1_cb);
  } // do_ajax_etiket_validate_sc_field_1

  function do_ajax_etiket_validate_sc_field_1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_etiket_validate_sc_field_1_cb

  // ---------- Validate sc_field_2
  function do_ajax_etiket_validate_sc_field_2()
  {
    var nomeCampo_sc_field_2 = "sc_field_2";
    var var_sc_field_2 = scAjaxGetFieldText(nomeCampo_sc_field_2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_etiket_validate_sc_field_2(var_sc_field_2, var_script_case_init, do_ajax_etiket_validate_sc_field_2_cb);
  } // do_ajax_etiket_validate_sc_field_2

  function do_ajax_etiket_validate_sc_field_2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_etiket_validate_sc_field_2_cb

  // ---------- Validate sc_field_3
  function do_ajax_etiket_validate_sc_field_3()
  {
    var nomeCampo_sc_field_3 = "sc_field_3";
    var var_sc_field_3 = scAjaxGetFieldText(nomeCampo_sc_field_3);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_etiket_validate_sc_field_3(var_sc_field_3, var_script_case_init, do_ajax_etiket_validate_sc_field_3_cb);
  } // do_ajax_etiket_validate_sc_field_3

  function do_ajax_etiket_validate_sc_field_3_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_etiket_validate_sc_field_3_cb

  // ---------- Validate sc_field_4
  function do_ajax_etiket_validate_sc_field_4()
  {
    var nomeCampo_sc_field_4 = "sc_field_4";
    var var_sc_field_4 = scAjaxGetFieldText(nomeCampo_sc_field_4);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_etiket_validate_sc_field_4(var_sc_field_4, var_script_case_init, do_ajax_etiket_validate_sc_field_4_cb);
  } // do_ajax_etiket_validate_sc_field_4

  function do_ajax_etiket_validate_sc_field_4_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_etiket_validate_sc_field_4_cb

  // ---------- Validate sc_field_5
  function do_ajax_etiket_validate_sc_field_5()
  {
    var nomeCampo_sc_field_5 = "sc_field_5";
    var var_sc_field_5 = scAjaxGetFieldText(nomeCampo_sc_field_5);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_etiket_validate_sc_field_5(var_sc_field_5, var_script_case_init, do_ajax_etiket_validate_sc_field_5_cb);
  } // do_ajax_etiket_validate_sc_field_5

  function do_ajax_etiket_validate_sc_field_5_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_etiket_validate_sc_field_5_cb

  // ---------- Validate sc_field_6
  function do_ajax_etiket_validate_sc_field_6()
  {
    var nomeCampo_sc_field_6 = "sc_field_6";
    var var_sc_field_6 = scAjaxGetFieldText(nomeCampo_sc_field_6);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_etiket_validate_sc_field_6(var_sc_field_6, var_script_case_init, do_ajax_etiket_validate_sc_field_6_cb);
  } // do_ajax_etiket_validate_sc_field_6

  function do_ajax_etiket_validate_sc_field_6_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sc_field_6";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_etiket_validate_sc_field_6_cb

  // ---------- Validate sc_field_7
  function do_ajax_etiket_validate_sc_field_7()
  {
    var nomeCampo_sc_field_7 = "sc_field_7";
    var var_sc_field_7 = scAjaxGetFieldText(nomeCampo_sc_field_7);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_etiket_validate_sc_field_7(var_sc_field_7, var_script_case_init, do_ajax_etiket_validate_sc_field_7_cb);
  } // do_ajax_etiket_validate_sc_field_7

  function do_ajax_etiket_validate_sc_field_7_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sc_field_7";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_etiket_validate_sc_field_7_cb

  // ---------- Validate sc_field_8
  function do_ajax_etiket_validate_sc_field_8()
  {
    var nomeCampo_sc_field_8 = "sc_field_8";
    var var_sc_field_8 = scAjaxGetFieldText(nomeCampo_sc_field_8);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_etiket_validate_sc_field_8(var_sc_field_8, var_script_case_init, do_ajax_etiket_validate_sc_field_8_cb);
  } // do_ajax_etiket_validate_sc_field_8

  function do_ajax_etiket_validate_sc_field_8_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sc_field_8";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_etiket_validate_sc_field_8_cb

  // ---------- Validate sc_field_9
  function do_ajax_etiket_validate_sc_field_9()
  {
    var nomeCampo_sc_field_9 = "sc_field_9";
    var var_sc_field_9 = scAjaxGetFieldText(nomeCampo_sc_field_9);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_etiket_validate_sc_field_9(var_sc_field_9, var_script_case_init, do_ajax_etiket_validate_sc_field_9_cb);
  } // do_ajax_etiket_validate_sc_field_9

  function do_ajax_etiket_validate_sc_field_9_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sc_field_9";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_etiket_validate_sc_field_9_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_etiket_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_etiket_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_sc_field_0 = "";
    ...
    scAjaxProcOn();
    x_ajax_etiket_submit_form(var_sc_field_0, var_sc_field_1, var_sc_field_2, var_sc_field_3, var_sc_field_4, var_sc_field_5, var_sc_field_6, var_sc_field_7, var_sc_field_8, var_sc_field_9, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_etiket_submit_form_cb);
  } // do_ajax_etiket_submit_form

  function do_ajax_etiket_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_etiket_submit_form_cb_after_alert);
  } // do_ajax_etiket_submit_form_cb
  function do_ajax_etiket_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_etiket_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_etiket_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_etiket_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['etiket']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_etiket_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_etiket_navigate_form_cb_after_alert);
  } // do_ajax_etiket_navigate_form_cb
  function do_ajax_etiket_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_etiket_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_etiket_navigate_form_cb_after_alert
  function sc_hide_etiket_form()
  {
  ...
  ajax_field_list[3] = "sc_field_3";
  ajax_field_list[4] = "sc_field_4";
  ajax_field_list[5] = "sc_field_5";
  ajax_field_list[6] = "sc_field_6";
  ajax_field_list[7] = "sc_field_7";
  ajax_field_list[8] = "sc_field_8";
  ajax_field_list[9] = "sc_field_9";
  ...
  var ajax_error_list = {
    "sc_field_0": {"label": "1", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "sc_field_1": {"label": "2", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "sc_field_2": {"label": "3", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "sc_field_3": {"label": "4", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "sc_field_4": {"label": "5", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "sc_field_5": {"label": "6", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "sc_field_6": {"label": "7", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "sc_field_7": {"label": "8", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "sc_field_8": {"label": "9", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "sc_field_9": {"label": "10", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    ...
    "sc_field_6": new Array(),
    "sc_field_7": new Array(),
    "sc_field_8": new Array(),
    "sc_field_9": new Array()
  };
  ...
  ajax_field_mult["sc_field_6"][1] = "sc_field_6";
  ajax_field_mult["sc_field_7"][1] = "sc_field_7";
  ajax_field_mult["sc_field_8"][1] = "sc_field_8";
  ajax_field_mult["sc_field_9"][1] = "sc_field_9";
  ...
  var ajax_field_id = {
    ...
    "sc_field_6": new Array("hidden_field_label_sc_field_6", "hidden_field_data_sc_field_6"),
    "sc_field_7": new Array("hidden_field_label_sc_field_7", "hidden_field_data_sc_field_7"),
    "sc_field_8": new Array("hidden_field_label_sc_field_8", "hidden_field_data_sc_field_8"),
    "sc_field_9": new Array("hidden_field_label_sc_field_9", "hidden_field_data_sc_field_9")
  };
