...
$old_error_handler = set_error_handler("etiket_mob_scriptcase_error_handler");

function etiket_mob_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['etiket_mob']['contr_erro']) && $_SESSION['scriptcase']['etiket_mob']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_etiket_mob->contr_etiket_mob->Apl_com_erro = true;
            if ($inicial_etiket_mob->contr_etiket_mob->NM_ajax_flag)
            {
                $inicial_etiket_mob->contr_etiket_mob->NM_ajax_info['errList']['geral_etiket_mob'][] = $msg;
                return;
            }
            etiket_mob_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function etiket_mob_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['etiket_mob'])  && '' != $_SESSION['scriptcase']['error_icon']['etiket_mob'])  ? $_SESSION['scriptcase']['error_icon']['etiket_mob']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['etiket_mob']) && '' != $_SESSION['scriptcase']['error_span_title']['etiket_mob']) ? $_SESSION['scriptcase']['error_span_title']['etiket_mob'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['etiket_mob']) && '' != $_SESSION['scriptcase']['error_icon_title']['etiket_mob']) ? $_SESSION['scriptcase']['error_icon_title']['etiket_mob'] : '';
?>
...
<?php
    ...
    $_SESSION['scriptcase']['etiket']['error_buffer'] .= ob_get_flush();
}
