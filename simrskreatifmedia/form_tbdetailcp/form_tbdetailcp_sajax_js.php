  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbdetailcp" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbdetailcp_form();
	}

  // ---------- Validate id_
  function do_ajax_form_tbdetailcp_validate_id_(iNumLinha)
  {
    var nomeCampo_id_ = "id_" + iNumLinha;
    var var_id_ = scAjaxGetFieldHidden(nomeCampo_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdetailcp_validate_id_(var_id_, iNumLinha, var_script_case_init, do_ajax_form_tbdetailcp_validate_id__cb);
  } // do_ajax_form_tbdetailcp_validate_id_

  function do_ajax_form_tbdetailcp_validate_id__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdetailcp_validate_id__cb

  // ---------- Validate desc_
  function do_ajax_form_tbdetailcp_validate_desc_(iNumLinha)
  {
    var nomeCampo_desc_ = "desc_" + iNumLinha;
    var var_desc_ = scAjaxGetFieldText(nomeCampo_desc_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdetailcp_validate_desc_(var_desc_, iNumLinha, var_script_case_init, do_ajax_form_tbdetailcp_validate_desc__cb);
  } // do_ajax_form_tbdetailcp_validate_desc_

  function do_ajax_form_tbdetailcp_validate_desc__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdetailcp_validate_desc__cb

  // ---------- Validate jenisdesc_
  function do_ajax_form_tbdetailcp_validate_jenisdesc_(iNumLinha)
  {
    var nomeCampo_jenisdesc_ = "jenisdesc_" + iNumLinha;
    var var_jenisdesc_ = scAjaxGetFieldSelect(nomeCampo_jenisdesc_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdetailcp_validate_jenisdesc_(var_jenisdesc_, iNumLinha, var_script_case_init, do_ajax_form_tbdetailcp_validate_jenisdesc__cb);
  } // do_ajax_form_tbdetailcp_validate_jenisdesc_

  function do_ajax_form_tbdetailcp_validate_jenisdesc__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "jenisdesc_" + iLineNumber;
    }
    else
    {
      sFieldValid = "jenisdesc_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "jenisdesc_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "jenisdesc_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdetailcp_validate_jenisdesc__cb

  // ---------- Validate refdesc_
  function do_ajax_form_tbdetailcp_validate_refdesc_(iNumLinha)
  {
    var nomeCampo_refdesc_ = "refdesc_" + iNumLinha;
    var var_refdesc_ = scAjaxGetFieldText(nomeCampo_refdesc_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdetailcp_validate_refdesc_(var_refdesc_, iNumLinha, var_script_case_init, do_ajax_form_tbdetailcp_validate_refdesc__cb);
  } // do_ajax_form_tbdetailcp_validate_refdesc_

  function do_ajax_form_tbdetailcp_validate_refdesc__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "refdesc_" + iLineNumber;
    }
    else
    {
      sFieldValid = "refdesc_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "refdesc_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "refdesc_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdetailcp_validate_refdesc__cb

  // ---------- Validate days_
  function do_ajax_form_tbdetailcp_validate_days_(iNumLinha)
  {
    var nomeCampo_days_ = "days_" + iNumLinha;
    var var_days_ = scAjaxGetFieldText(nomeCampo_days_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdetailcp_validate_days_(var_days_, iNumLinha, var_script_case_init, do_ajax_form_tbdetailcp_validate_days__cb);
  } // do_ajax_form_tbdetailcp_validate_days_

  function do_ajax_form_tbdetailcp_validate_days__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "days_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "days_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdetailcp_validate_days__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_tbdetailcp_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_tbdetailcp_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tbdetailcp_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_tbdetailcp_add_new_line_cb);
  } // do_ajax_form_tbdetailcp_add_new_line

  function do_ajax_form_tbdetailcp_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_tbdetailcp_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_tbdetailcp_backup_line(iNumLinha)
  {
    var var_id_ = scAjaxGetFieldHidden("id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdetailcp_backup_line(var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_tbdetailcp_backup_line_cb);
  } // do_ajax_form_tbdetailcp_backup_line

  function do_ajax_form_tbdetailcp_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_tbdetailcp_backup_line_cb

  function do_ajax_form_tbdetailcp_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_tbdetailcp_cancel_insert

  function do_ajax_form_tbdetailcp_cancel_update(iSeqVert)
  {
    do_ajax_form_tbdetailcp_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_tbdetailcp_cancel_update

  function do_ajax_form_tbdetailcp_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_tbdetailcp_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_tbdetailcp_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_tbdetailcp_table_refresh(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbdetailcp_table_refresh_cb);
  } //  do_ajax_form_tbdetailcp_table_refresh

  function do_ajax_form_tbdetailcp_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_tbdetailcp_table_refresh_cb_after_alert);
  } // do_ajax_form_tbdetailcp_table_refresh_cb
  function do_ajax_form_tbdetailcp_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_tbdetailcp_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_tbdetailcp_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_tbdetailcp_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_id_ = scAjaxGetFieldHidden("id_" + iNumLinha);
    var var_desc_ = scAjaxGetFieldText("desc_" + iNumLinha);
    var var_jenisdesc_ = scAjaxGetFieldSelect("jenisdesc_" + iNumLinha);
    var var_refdesc_ = scAjaxGetFieldText("refdesc_" + iNumLinha);
    var var_days_ = scAjaxGetFieldText("days_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_tbdetailcp_submit_form(var_id_, var_desc_, var_jenisdesc_, var_refdesc_, var_days_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbdetailcp_submit_form_cb);
  } // do_ajax_form_tbdetailcp_submit_form

  function do_ajax_form_tbdetailcp_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("jenisdesc_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("refdesc_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("days_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_tbdetailcp_submit_form_cb_after_alert);
  } // do_ajax_form_tbdetailcp_submit_form_cb
  function do_ajax_form_tbdetailcp_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbdetailcp_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tbdetailcp_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_tbdetailcp_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("jenisdesc_" + iNavForm);
      scAjaxHideErrorDisplay("refdesc_" + iNavForm);
      scAjaxHideErrorDisplay("days_" + iNavForm);
    }
    var var_id_ = document.F2.id_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tbdetailcp_navigate_form(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbdetailcp_navigate_form_cb);
  } // do_ajax_form_tbdetailcp_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailcp']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbdetailcp_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbdetailcp_navigate_form_cb_after_alert);
  } // do_ajax_form_tbdetailcp_navigate_form_cb
  function do_ajax_form_tbdetailcp_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_tbdetailcp_navigate_form_cb_after_alert
  function sc_hide_form_tbdetailcp_form()
  {
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "jenisdesc_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "refdesc_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "days_" + iNumLinha;
    iTotCampos++;
    ...
    ajax_error_list["desc_" + iNumLinha] = {"label": "Deskripsi<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["jenisdesc_" + iNumLinha] = {"label": "Jenis<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["refdesc_" + iNumLinha] = {"label": "Nama Referensi<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["days_" + iNumLinha] = {"label": "Hari ke-<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["id_"][iNumLinha] = "id_" + iNumLinha;
    ajax_field_mult["desc_"][iNumLinha] = "desc_" + iNumLinha;
    ajax_field_mult["jenisdesc_"][iNumLinha] = "jenisdesc_" + iNumLinha;
    ajax_field_mult["refdesc_"][iNumLinha] = "refdesc_" + iNumLinha;
    ajax_field_mult["days_"][iNumLinha] = "days_" + iNumLinha;
    ajax_field_id["desc_" + iNumLinha] = new Array("hidden_field_label_desc_", "hidden_field_data_desc_" + iNumLinha);
    ajax_field_id["jenisdesc_" + iNumLinha] = new Array("hidden_field_label_jenisdesc_", "hidden_field_data_jenisdesc_" + iNumLinha);
    ajax_field_id["refdesc_" + iNumLinha] = new Array("hidden_field_label_refdesc_", "hidden_field_data_refdesc_" + iNumLinha);
    ajax_field_id["days_" + iNumLinha] = new Array("hidden_field_label_days_", "hidden_field_data_days_" + iNumLinha);
    ajax_error_count["id_" + iNumLinha] = "off";
    ajax_error_count["desc_" + iNumLinha] = "off";
    ajax_error_count["jenisdesc_" + iNumLinha] = "off";
    ajax_error_count["refdesc_" + iNumLinha] = "off";
    ajax_error_count["days_" + iNumLinha] = "off";
<?php
...
?>
    ...
    ajax_read_only["jenisdesc_" + iNumLinha] = "off";
    ajax_read_only["refdesc_" + iNumLinha] = "off";
    ajax_read_only["days_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ...
    ajax_read_only["jenisdesc_" + iNumLinha] = "on";
    ajax_read_only["refdesc_" + iNumLinha] = "on";
    ajax_read_only["days_" + iNumLinha] = "on";
<?php
}
?>
  }
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["jenisdesc_" + iNumLinha] = null;
    ajax_error_list["refdesc_" + iNumLinha] = null;
    ajax_error_list["days_" + iNumLinha] = null;
  }
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["jenisdesc_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["jenisdesc_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["jenisdesc_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["jenisdesc_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["jenisdesc_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["refdesc_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["refdesc_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["refdesc_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["refdesc_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["refdesc_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["days_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["days_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["days_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["days_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["days_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['jenisdesc_'])) ? $this->nmgp_cmp_readonly['jenisdesc_'] : 'off';
?>
    scAjaxFieldRead("jenisdesc_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['refdesc_'])) ? $this->nmgp_cmp_readonly['refdesc_'] : 'off';
?>
    scAjaxFieldRead("refdesc_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['days_'])) ? $this->nmgp_cmp_readonly['days_'] : 'off';
?>
    scAjaxFieldRead("days_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }
  ...
  function mdCloseObjects(iSeq)
  {
    ...
    scAjaxFieldRead("jenisdesc_" + iSeq, "on");
    scAjaxFieldRead("refdesc_" + iSeq, "on");
    scAjaxFieldRead("days_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["id_" + iRow] || "on" == ajax_error_count["desc_" + iRow] || "on" == ajax_error_count["jenisdesc_" + iRow] || "on" == ajax_error_count["refdesc_" + iRow] || "on" == ajax_error_count["days_" + iRow]))
    {
      ...
      $("#hidden_field_data_jenisdesc_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_refdesc_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_days_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["id_" + iRow] && "off" == ajax_error_count["desc_" + iRow] && "off" == ajax_error_count["jenisdesc_" + iRow] && "off" == ajax_error_count["refdesc_" + iRow] && "off" == ajax_error_count["days_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["id_" + iRow] = "off";
        ajax_error_count["desc_" + iRow] = "off";
        ajax_error_count["jenisdesc_" + iRow] = "off";
        ajax_error_count["refdesc_" + iRow] = "off";
        ajax_error_count["days_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_jenisdesc_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_refdesc_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_days_" + iRow).removeClass("scFormErrorLine");
    }
  }
