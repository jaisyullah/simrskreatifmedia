...
class kartu_stok_old_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok_old']['path_libs_php'] = $this->Ini->path_lib_php;
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok_old']['prim_vez']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok_old']['prim_vez'] = "S";
      }
   ...
   function init()
   {
    ...
    {
      global $sc_field_1_cond, $sc_field_1, $sc_field_1_dia, $sc_field_1_mes, $sc_field_1_ano, $sc_field_1_input_2_dia, $sc_field_1_input_2_mes, $sc_field_1_input_2_ano;
      $_SESSION['scriptcase']['kartu_stok_old']['contr_erro'] = 'on';
 $sc_field_1  = date("Y-m-d");
$_SESSION['scriptcase']['kartu_stok_old']['contr_erro'] = 'off'; 
      if (isset($sc_field_1_day))
      {
          $sc_field_1_dia = $sc_field_1_day; 
      }
      if (isset($sc_field_1_month))
      {
          $sc_field_1_mes = $sc_field_1_month; 
      }
      if (isset($sc_field_1_year))
      {
          $sc_field_1_ano = $sc_field_1_year; 
      }
      if (isset($sc_field_1))
      {
          $sc_field_1 = str_replace("0000", "", $sc_field_1);
          $sc_field_1 = str_replace("-00", "-", $sc_field_1);
          $sc_field_1XX = explode("-", $sc_field_1);
          if (isset($sc_field_1XX[2]))
          {
              $sc_field_1_dia = $sc_field_1XX[2]; 
          }
          if (isset($sc_field_1XX[1]))
          {
              $sc_field_1_mes = $sc_field_1XX[1]; 
          }
          if (isset($sc_field_1XX[0]))
          {
              $sc_field_1_ano = $sc_field_1XX[0]; 
          }
      }
      if (isset($sc_field_1_input_2_day))
      {
          $sc_field_1_input_2_dia = $sc_field_1_input_2_day; 
      }
      if (isset($sc_field_1_input_2_month))
      {
          $sc_field_1_input_2_mes = $sc_field_1_input_2_month; 
      }
      if (isset($sc_field_1_input_2_year))
      {
          $sc_field_1_input_2_ano = $sc_field_1_input_2_year; 
      }
      if (isset($sc_field_1_2))
      {
          $sc_field_1_2 = str_replace("0000", "", $sc_field_1_2);
          $sc_field_1_2 = str_replace("-00", "-", $sc_field_1_2);
          $sc_field_1XX = explode("-", $sc_field_1_2);
          if (isset($sc_field_1XX[2]))
          {
              $sc_field_1_input_2_dia = $sc_field_1XX[2]; 
          }
          if (isset($sc_field_1XX[1]))
          {
              $sc_field_1_input_2_mes = $sc_field_1XX[1]; 
          }
          if (isset($sc_field_1XX[0]))
          {
              $sc_field_1_input_2_ano = $sc_field_1XX[0]; 
          }
      }
    }
   }
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . kartu_stok_old_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . kartu_stok_old_pack_protect_string($Tipo_filter[0]) . "\">.." . kartu_stok_old_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "`Tgl. Kadaluarsa`";$Nm_datas[] = "`Tgl_ Kadaluarsa`";$Nm_datas[] = "`Tgl. Transaksi`";$Nm_datas[] = "`Tgl_ Transaksi`";
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok_old']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok_old']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok_old']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok_old']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok_old']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok_old']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok_old']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok_old']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok_old']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok_old']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok_old']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok_old']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok_old']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok_old']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok_old']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok_old']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok_old']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
   ...
   $NM_retorno = "./";
    if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok_old']['proc_res'])) 
    {
...
<?php
    if ($_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok_old']['prim_vez'] == "N" && !$_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok_old']['proc_res']) 
    {
?>
if (parent.document.getElementById('nmsc_iframe_kartu_stok_old').contentWindow.nm_gp_submit_ajax)
{
   parent.document.getElementById('nmsc_iframe_kartu_stok_old').contentWindow.nm_gp_submit_ajax('inicio', 'save_grid');
}
else
{
   parent.document.getElementById('nmsc_iframe_kartu_stok_old').src = 'index.php?nmgp_opcao=pesq&script_case_init=<?php echo NM_encode_input($this->Ini->sc_page) ?>&script_case_session=<?php echo session_id() ?>';
}
<?php
    }
    else
...
<?php
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok_old']['prim_vez'] = "N";
?>
</SCRIPT>
</BODY>
</HTML>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>kartu_stok_old/kartu_stok_old_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="kartu_stok_old_ajax_search.js"></script>
 <script type="text/javascript" src="kartu_stok_old_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="kartu_stok_old_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['kartu_stok_old']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['kartu_stok_old']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
function scJQCalendarAdd() {
  $("#sc_sc_field_1_jq").datepicker({
    beforeShow: function(input, inst) {
          var_dt_ini  = document.getElementById('SC_sc_field_1_dia').value + '/';
          var_dt_ini += document.getElementById('SC_sc_field_1_mes').value + '/';
          var_dt_ini += document.getElementById('SC_sc_field_1_ano').value;
          document.getElementById('sc_sc_field_1_jq').value = var_dt_ini;
    },
    onClose: function(dateText, inst) {
          aParts  = dateText.split("/");
          document.getElementById('SC_sc_field_1_dia').value = aParts[0];
          document.getElementById('SC_sc_field_1_mes').value = aParts[1];
          document.getElementById('SC_sc_field_1_ano').value = aParts[2];
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
  ...
  $("#sc_sc_field_1_jq2").datepicker({
    beforeShow: function(input, inst) {
          var_dt_ini  = document.getElementById('SC_sc_field_1_input_2_dia').value + '/';
          var_dt_ini += document.getElementById('SC_sc_field_1_input_2_mes').value + '/';
          var_dt_ini += document.getElementById('SC_sc_field_1_input_2_ano').value;
          document.getElementById('sc_sc_field_1_jq2').value = var_dt_ini;
    },
    onClose: function(dateText, inst) {
          aParts  = dateText.split("/");
          document.getElementById('SC_sc_field_1_input_2_dia').value = aParts[0];
          document.getElementById('SC_sc_field_1_input_2_mes').value = aParts[1];
          document.getElementById('SC_sc_field_1_input_2_ano').value = aParts[2];
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_tgl. transaksi_cond#NMF#' + search_get_sel_txt('SC_sc_field_1_cond') + '@NMF@';
  str_out += 'SC_tgl. transaksi_dia#NMF#' + search_get_sel_txt('SC_sc_field_1_dia') + '@NMF@';
  str_out += 'SC_tgl. transaksi_mes#NMF#' + search_get_sel_txt('SC_sc_field_1_mes') + '@NMF@';
  str_out += 'SC_tgl. transaksi_ano#NMF#' + search_get_sel_txt('SC_sc_field_1_ano') + '@NMF@';
  str_out += 'SC_tgl. transaksi_input_2_dia#NMF#' + search_get_sel_txt('SC_sc_field_1_input_2_dia') + '@NMF@';
  str_out += 'SC_tgl. transaksi_input_2_mes#NMF#' + search_get_sel_txt('SC_sc_field_1_input_2_mes') + '@NMF@';
  str_out += 'SC_tgl. transaksi_input_2_ano#NMF#' + search_get_sel_txt('SC_sc_field_1_input_2_ano') + '@NMF@';
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok_old']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<?php
   ...
   {
      global 
             $sc_field_1_cond, $sc_field_1, $sc_field_1_dia, $sc_field_1_mes, $sc_field_1_ano, $sc_field_1_input_2_dia, $sc_field_1_input_2_mes, $sc_field_1_input_2_ano,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok_old']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok_old']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok_old']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok_old']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $sc_field_1_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok_old']['campos_busca']['sc_field_1_dia']; 
          $sc_field_1_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok_old']['campos_busca']['sc_field_1_mes']; 
          $sc_field_1_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok_old']['campos_busca']['sc_field_1_ano']; 
          $sc_field_1_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok_old']['campos_busca']['sc_field_1_input_2_dia']; 
          $sc_field_1_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok_old']['campos_busca']['sc_field_1_input_2_mes']; 
          $sc_field_1_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok_old']['campos_busca']['sc_field_1_input_2_ano']; 
          $sc_field_1_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok_old']['campos_busca']['sc_field_1_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok_old']['campos_busca']['NM_operador']; 
      } 
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_sc_field_1_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['sc_field_1'])) ? $this->New_label['sc_field_1'] : "Tgl Transaksi"; ?></TD>
...
<span id='id_date_part_sc_field_1_DD' style='display: inline-block'>
         ...
         <SELECT class="scFilterObjectOdd" id="SC_sc_field_1_dia" name="sc_field_1_dia">
          <OPTION value=""></OPTION>
          <OPTION value="01" <?php if ("01" == $sc_field_1_dia) { echo "selected"; } ?>>01</OPTION>
          <OPTION value="02" <?php if ("02" == $sc_field_1_dia) { echo "selected"; } ?>>02</OPTION>
          <OPTION value="03" <?php if ("03" == $sc_field_1_dia) { echo "selected"; } ?>>03</OPTION>
          <OPTION value="04" <?php if ("04" == $sc_field_1_dia) { echo "selected"; } ?>>04</OPTION>
          <OPTION value="05" <?php if ("05" == $sc_field_1_dia) { echo "selected"; } ?>>05</OPTION>
          <OPTION value="06" <?php if ("06" == $sc_field_1_dia) { echo "selected"; } ?>>06</OPTION>
          <OPTION value="07" <?php if ("07" == $sc_field_1_dia) { echo "selected"; } ?>>07</OPTION>
          <OPTION value="08" <?php if ("08" == $sc_field_1_dia) { echo "selected"; } ?>>08</OPTION>
          <OPTION value="09" <?php if ("09" == $sc_field_1_dia) { echo "selected"; } ?>>09</OPTION>
          <OPTION value="10" <?php if ("10" == $sc_field_1_dia) { echo "selected"; } ?>>10</OPTION>
          <OPTION value="11" <?php if ("11" == $sc_field_1_dia) { echo "selected"; } ?>>11</OPTION>
          <OPTION value="12" <?php if ("12" == $sc_field_1_dia) { echo "selected"; } ?>>12</OPTION>
          <OPTION value="13" <?php if ("13" == $sc_field_1_dia) { echo "selected"; } ?>>13</OPTION>
          <OPTION value="14" <?php if ("14" == $sc_field_1_dia) { echo "selected"; } ?>>14</OPTION>
          <OPTION value="15" <?php if ("15" == $sc_field_1_dia) { echo "selected"; } ?>>15</OPTION>
          <OPTION value="16" <?php if ("16" == $sc_field_1_dia) { echo "selected"; } ?>>16</OPTION>
          <OPTION value="17" <?php if ("17" == $sc_field_1_dia) { echo "selected"; } ?>>17</OPTION>
          <OPTION value="18" <?php if ("18" == $sc_field_1_dia) { echo "selected"; } ?>>18</OPTION>
          <OPTION value="19" <?php if ("19" == $sc_field_1_dia) { echo "selected"; } ?>>19</OPTION>
          <OPTION value="20" <?php if ("20" == $sc_field_1_dia) { echo "selected"; } ?>>20</OPTION>
          <OPTION value="21" <?php if ("21" == $sc_field_1_dia) { echo "selected"; } ?>>21</OPTION>
          <OPTION value="22" <?php if ("22" == $sc_field_1_dia) { echo "selected"; } ?>>22</OPTION>
          <OPTION value="23" <?php if ("23" == $sc_field_1_dia) { echo "selected"; } ?>>23</OPTION>
          <OPTION value="24" <?php if ("24" == $sc_field_1_dia) { echo "selected"; } ?>>24</OPTION>
          <OPTION value="25" <?php if ("25" == $sc_field_1_dia) { echo "selected"; } ?>>25</OPTION>
          <OPTION value="26" <?php if ("26" == $sc_field_1_dia) { echo "selected"; } ?>>26</OPTION>
          <OPTION value="27" <?php if ("27" == $sc_field_1_dia) { echo "selected"; } ?>>27</OPTION>
          <OPTION value="28" <?php if ("28" == $sc_field_1_dia) { echo "selected"; } ?>>28</OPTION>
          <OPTION value="29" <?php if ("29" == $sc_field_1_dia) { echo "selected"; } ?>>29</OPTION>
          <OPTION value="30" <?php if ("30" == $sc_field_1_dia) { echo "selected"; } ?>>30</OPTION>
          <OPTION value="31" <?php if ("31" == $sc_field_1_dia) { echo "selected"; } ?>>31</OPTION>
         </SELECT>
         </span>
...
<span id='id_date_part_sc_field_1_MM' style='display: inline-block'>
         ...
         <SELECT class="scFilterObjectOdd" id="SC_sc_field_1_mes" name="sc_field_1_mes">
          <OPTION value=""></OPTION>
          <OPTION value="01" <?php if ("01" == $sc_field_1_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][0] ?></OPTION>
          <OPTION value="02" <?php if ("02" == $sc_field_1_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][1] ?></OPTION>
          <OPTION value="03" <?php if ("03" == $sc_field_1_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][2] ?></OPTION>
          <OPTION value="04" <?php if ("04" == $sc_field_1_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][3] ?></OPTION>
          <OPTION value="05" <?php if ("05" == $sc_field_1_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][4] ?></OPTION>
          <OPTION value="06" <?php if ("06" == $sc_field_1_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][5] ?></OPTION>
          <OPTION value="07" <?php if ("07" == $sc_field_1_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][6] ?></OPTION>
          <OPTION value="08" <?php if ("08" == $sc_field_1_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][7] ?></OPTION>
          <OPTION value="09" <?php if ("09" == $sc_field_1_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][8] ?></OPTION>
          <OPTION value="10" <?php if ("10" == $sc_field_1_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][9] ?></OPTION>
          <OPTION value="11" <?php if ("11" == $sc_field_1_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][10] ?></OPTION>
          <OPTION value="12" <?php if ("12" == $sc_field_1_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][11] ?></OPTION>
         </SELECT>
         </span>
...
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_sc_field_1_ano" name="sc_field_1_ano" value="<?php echo NM_encode_input($sc_field_1_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 <INPUT type="hidden" id="sc_sc_field_1_jq">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_sc_field_1_input_2_DD' style='display: inline-block'>

         <SELECT class="scFilterObjectOdd" id="SC_sc_field_1_input_2_dia" name="sc_field_1_input_2_dia">
          <OPTION value=""></OPTION>
          <OPTION value="01" <?php if ("01" == $sc_field_1_input_2_dia) { echo "selected"; } ?>>01</OPTION>
          <OPTION value="02" <?php if ("02" == $sc_field_1_input_2_dia) { echo "selected"; } ?>>02</OPTION>
          <OPTION value="03" <?php if ("03" == $sc_field_1_input_2_dia) { echo "selected"; } ?>>03</OPTION>
          <OPTION value="04" <?php if ("04" == $sc_field_1_input_2_dia) { echo "selected"; } ?>>04</OPTION>
          <OPTION value="05" <?php if ("05" == $sc_field_1_input_2_dia) { echo "selected"; } ?>>05</OPTION>
          <OPTION value="06" <?php if ("06" == $sc_field_1_input_2_dia) { echo "selected"; } ?>>06</OPTION>
          <OPTION value="07" <?php if ("07" == $sc_field_1_input_2_dia) { echo "selected"; } ?>>07</OPTION>
          <OPTION value="08" <?php if ("08" == $sc_field_1_input_2_dia) { echo "selected"; } ?>>08</OPTION>
          <OPTION value="09" <?php if ("09" == $sc_field_1_input_2_dia) { echo "selected"; } ?>>09</OPTION>
          <OPTION value="10" <?php if ("10" == $sc_field_1_input_2_dia) { echo "selected"; } ?>>10</OPTION>
          <OPTION value="11" <?php if ("11" == $sc_field_1_input_2_dia) { echo "selected"; } ?>>11</OPTION>
          <OPTION value="12" <?php if ("12" == $sc_field_1_input_2_dia) { echo "selected"; } ?>>12</OPTION>
          <OPTION value="13" <?php if ("13" == $sc_field_1_input_2_dia) { echo "selected"; } ?>>13</OPTION>
          <OPTION value="14" <?php if ("14" == $sc_field_1_input_2_dia) { echo "selected"; } ?>>14</OPTION>
          <OPTION value="15" <?php if ("15" == $sc_field_1_input_2_dia) { echo "selected"; } ?>>15</OPTION>
          <OPTION value="16" <?php if ("16" == $sc_field_1_input_2_dia) { echo "selected"; } ?>>16</OPTION>
          <OPTION value="17" <?php if ("17" == $sc_field_1_input_2_dia) { echo "selected"; } ?>>17</OPTION>
          <OPTION value="18" <?php if ("18" == $sc_field_1_input_2_dia) { echo "selected"; } ?>>18</OPTION>
          <OPTION value="19" <?php if ("19" == $sc_field_1_input_2_dia) { echo "selected"; } ?>>19</OPTION>
          <OPTION value="20" <?php if ("20" == $sc_field_1_input_2_dia) { echo "selected"; } ?>>20</OPTION>
          <OPTION value="21" <?php if ("21" == $sc_field_1_input_2_dia) { echo "selected"; } ?>>21</OPTION>
          <OPTION value="22" <?php if ("22" == $sc_field_1_input_2_dia) { echo "selected"; } ?>>22</OPTION>
          <OPTION value="23" <?php if ("23" == $sc_field_1_input_2_dia) { echo "selected"; } ?>>23</OPTION>
          <OPTION value="24" <?php if ("24" == $sc_field_1_input_2_dia) { echo "selected"; } ?>>24</OPTION>
          <OPTION value="25" <?php if ("25" == $sc_field_1_input_2_dia) { echo "selected"; } ?>>25</OPTION>
          <OPTION value="26" <?php if ("26" == $sc_field_1_input_2_dia) { echo "selected"; } ?>>26</OPTION>
          <OPTION value="27" <?php if ("27" == $sc_field_1_input_2_dia) { echo "selected"; } ?>>27</OPTION>
          <OPTION value="28" <?php if ("28" == $sc_field_1_input_2_dia) { echo "selected"; } ?>>28</OPTION>
          <OPTION value="29" <?php if ("29" == $sc_field_1_input_2_dia) { echo "selected"; } ?>>29</OPTION>
          <OPTION value="30" <?php if ("30" == $sc_field_1_input_2_dia) { echo "selected"; } ?>>30</OPTION>
          <OPTION value="31" <?php if ("31" == $sc_field_1_input_2_dia) { echo "selected"; } ?>>31</OPTION>
         </SELECT>
         </span>
...
<?php
  ...
  {
?>
<span id='id_date_part_sc_field_1_input_2_MM' style='display: inline-block'>

         <SELECT class="scFilterObjectOdd" id="SC_sc_field_1_input_2_mes" name="sc_field_1_input_2_mes">
          <OPTION value=""></OPTION>
          <OPTION value="01" <?php if ("01" == $sc_field_1_input_2_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][0] ?></OPTION>
          <OPTION value="02" <?php if ("02" == $sc_field_1_input_2_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][1] ?></OPTION>
          <OPTION value="03" <?php if ("03" == $sc_field_1_input_2_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][2] ?></OPTION>
          <OPTION value="04" <?php if ("04" == $sc_field_1_input_2_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][3] ?></OPTION>
          <OPTION value="05" <?php if ("05" == $sc_field_1_input_2_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][4] ?></OPTION>
          <OPTION value="06" <?php if ("06" == $sc_field_1_input_2_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][5] ?></OPTION>
          <OPTION value="07" <?php if ("07" == $sc_field_1_input_2_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][6] ?></OPTION>
          <OPTION value="08" <?php if ("08" == $sc_field_1_input_2_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][7] ?></OPTION>
          <OPTION value="09" <?php if ("09" == $sc_field_1_input_2_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][8] ?></OPTION>
          <OPTION value="10" <?php if ("10" == $sc_field_1_input_2_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][9] ?></OPTION>
          <OPTION value="11" <?php if ("11" == $sc_field_1_input_2_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][10] ?></OPTION>
          <OPTION value="12" <?php if ("12" == $sc_field_1_input_2_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][11] ?></OPTION>
         </SELECT>
         </span>
...
<?php
  ...
  {
?>
<span id='id_date_part_sc_field_1_input_2_AAAA' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_sc_field_1_input_2_ano" name="sc_field_1_input_2_ano" value="<?php echo NM_encode_input($sc_field_1_input_2_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 <INPUT type="hidden" id="sc_sc_field_1_jq2">
</span>
...
?>
<?php
   if (is_file("kartu_stok_old_help.txt"))
   {
...
?>
<?php
   if ($nm_apl_dependente == 1 || (!$_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok_old']['opc_psq'] && !$this->aba_iframe))
   {
...
<?php
       ...
       elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok_old']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok_old']['dashboard_info']['under_dashboard'])
       { }
       else 
       { 
?>
...
<?php
   ...
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok_old']['opc_psq'])
   {
...
<?php
    if ($_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok_old']['prim_vez'] == "N") 
    {
?>
       <iframe id="nmsc_iframe_kartu_stok_old" frameborder="0" marginwidth="0px" marginheight="0px" topmargin="0px" leftmargin="0px" align="center" height="1500px" name="nm_iframe_kartu_stok_old" scrolling="auto" src="index.php?nmgp_opcao=pesq&script_case_init=<?php echo NM_encode_input($this->Ini->sc_page) ?>&script_case_session=<?php echo session_id() ?>" width="100%"></iframe>
<?php
    }
    else
    {
?>
       <iframe id="nmsc_iframe_kartu_stok_old" frameborder="0" marginwidth="0px" marginheight="0px" topmargin="0px" leftmargin="0px" align="center" height="1500px" name="nm_iframe_kartu_stok_old" scrolling="auto" src="" width="100%"></iframe>
<?php
    }
?>
<iframe id="nmsc_iframe_kartu_stok_old_pesq"  name="nm_iframe_kartu_stok_old_pesq" style= "display: none;" frameborder="0" marginwidth="0px" marginheight="0px" topmargin="0px" leftmargin="0px" src=""></iframe>
</td></tr></table></td></tr>
</TABLE>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok_old']['orig_pesq'] == "grid")
   {
...
?>
 ...
 {
    document.F1.target = "nm_iframe_kartu_stok_old_pesq";
    document.F1.submit();
 }
 function nm_move()
 {
     document.getElementById('nmsc_iframe_kartu_stok_old').contentWindow.nm_move('igual');
 }
 function limpa_form()
 {
   document.F1.reset();
   ...
   document.F1.sc_field_1_input_2_dia.value = "";
   document.F1.sc_field_1_input_2_mes.value = "";
   document.F1.sc_field_1_input_2_ano.value = "";
 }
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "simrskreatifmedia/kartu_stok_old";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok_old']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok_old']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok_old']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tb_fields_esp['SC_tgl. transaksi_cond'] = 'SC_sc_field_1_cond';
      $tb_fields_esp['SC_tgl. transaksi_dia'] = 'SC_sc_field_1_dia';
      $tb_fields_esp['SC_tgl. transaksi_mes'] = 'SC_sc_field_1_mes';
      $tb_fields_esp['SC_tgl. transaksi_ano'] = 'SC_sc_field_1_ano';
      $tb_fields_esp['SC_tgl. transaksi_input_2_dia'] = 'SC_sc_field_1_input_2_dia';
      $tb_fields_esp['SC_tgl. transaksi_input_2_mes'] = 'SC_sc_field_1_input_2_mes';
      $tb_fields_esp['SC_tgl. transaksi_input_2_ano'] = 'SC_sc_field_1_input_2_ano';
      if (is_file($NM_patch))
      {
          $SC_V8    = false;
   ...
   {
      global $sc_field_1_cond, $sc_field_1, $sc_field_1_dia, $sc_field_1_mes, $sc_field_1_ano, $sc_field_1_input_2_dia, $sc_field_1_input_2_mes, $sc_field_1_input_2_ano, $nmgp_tab_label;
      ...
      if (!isset($sc_field_1_input_2_dia) || $sc_field_1_input_2_dia == "")
      {
          $sc_field_1_input_2_dia = $sc_field_1_dia;
      }
      if (!isset($sc_field_1_input_2_mes) || $sc_field_1_input_2_mes == "")
      {
          $sc_field_1_input_2_mes = $sc_field_1_mes;
      }
      if (!isset($sc_field_1_input_2_ano) || $sc_field_1_input_2_ano == "")
      {
          $sc_field_1_input_2_ano = $sc_field_1_ano;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok_old']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok_old']['campos_busca']['sc_field_1_dia'] = $sc_field_1_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok_old']['campos_busca']['sc_field_1_mes'] = $sc_field_1_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok_old']['campos_busca']['sc_field_1_ano'] = $sc_field_1_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok_old']['campos_busca']['sc_field_1_input_2_dia'] = $sc_field_1_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok_old']['campos_busca']['sc_field_1_input_2_mes'] = $sc_field_1_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok_old']['campos_busca']['sc_field_1_input_2_ano'] = $sc_field_1_input_2_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok_old']['campos_busca']['sc_field_1_cond'] = $sc_field_1_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok_old']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok_old']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      ...
      if ($sc_field_1_cond != "bi_TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok_old']['campos_busca']['sc_field_1'] = $val[0];
          $this->nm_data->SetaData($this->cmp_formatado['sc_field_1'], "YYYY-MM-DD HH:II:SS");
          $this->cmp_formatado['sc_field_1'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DH", "dmY"));
          if ($sc_field_1_cond == "BW")
          {
              if (!$this->Date_part) {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok_old']['campos_busca']['sc_field_1_input_2'] = $val[1];
              $this->nm_data->SetaData($this->cmp_formatado['sc_field_1_input_2'], "YYYY-MM-DD HH:II:SS");
              $this->cmp_formatado['sc_field_1_input_2'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DH", "dmY"));
          }
          if (!empty($Dtxt) || $sc_field_1_cond == "NU" || $sc_field_1_cond == "NN"|| $sc_field_1_cond == "EP"|| $sc_field_1_cond == "NE")
          {
              $this->monta_condicao("`Tgl. Transaksi`", $sc_field_1_cond, $sc_field_1, $sc_field_1_input_2, 'sc_field_1', 'DATETIME');
          }
      }
   }
   ...
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok_old']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok_old']['cond_dyn_search'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok_old']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok_old']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok_old']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok_old']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok_old']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok_old']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok_old']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok_old']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok_old']['cond_pesq'] .= $this->NM_operador;
