...
<?php
   ...
   $Ord_Cmp = new kartu_stok_old_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class kartu_stok_old_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['kartu_stok_old']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['kartu_stok_old']['ordem_select_orig'] = array();
   }
   ...
   {
       $tab_def_campos['sc_field_0'] = "`Tgl. Kadaluarsa`";
   }
   $tab_labels["sc_field_0"]   = (isset($_SESSION['sc_session'][$sc_init]['kartu_stok_old']['labels']["sc_field_0"])) ? $_SESSION['sc_session'][$sc_init]['kartu_stok_old']['labels']["sc_field_0"] : "Tgl Kadaluarsa";
   ...
   {
       $tab_def_campos['sc_field_1'] = "`Tgl. Transaksi`";
   }
   $tab_labels["sc_field_1"]   = (isset($_SESSION['sc_session'][$sc_init]['kartu_stok_old']['labels']["sc_field_1"])) ? $_SESSION['sc_session'][$sc_init]['kartu_stok_old']['labels']["sc_field_1"] : "Tgl Transaksi";
   ...
   {
       $tab_def_campos['sc_field_2'] = "`No. Transaksi`";
   }
   $tab_labels["sc_field_2"]   = (isset($_SESSION['sc_session'][$sc_init]['kartu_stok_old']['labels']["sc_field_2"])) ? $_SESSION['sc_session'][$sc_init]['kartu_stok_old']['labels']["sc_field_2"] : "No Transaksi";
   $tab_ger_campos['kategori'] = "on";
   $tab_def_campos['kategori'] = "Kategori";
   $tab_labels["kategori"]   = (isset($_SESSION['sc_session'][$sc_init]['kartu_stok_old']['labels']["kategori"])) ? $_SESSION['sc_session'][$sc_init]['kartu_stok_old']['labels']["kategori"] : "Kategori";
   $tab_ger_campos['deskripsi'] = "on";
   $tab_def_campos['deskripsi'] = "Deskripsi";
   $tab_labels["deskripsi"]   = (isset($_SESSION['sc_session'][$sc_init]['kartu_stok_old']['labels']["deskripsi"])) ? $_SESSION['sc_session'][$sc_init]['kartu_stok_old']['labels']["deskripsi"] : "Deskripsi";
   $tab_ger_campos['masuk'] = "on";
   $tab_def_campos['masuk'] = "Masuk";
   $tab_labels["masuk"]   = (isset($_SESSION['sc_session'][$sc_init]['kartu_stok_old']['labels']["masuk"])) ? $_SESSION['sc_session'][$sc_init]['kartu_stok_old']['labels']["masuk"] : "Masuk";
   $tab_ger_campos['keluar'] = "on";
   $tab_def_campos['keluar'] = "Keluar";
   $tab_labels["keluar"]   = (isset($_SESSION['sc_session'][$sc_init]['kartu_stok_old']['labels']["keluar"])) ? $_SESSION['sc_session'][$sc_init]['kartu_stok_old']['labels']["keluar"] : "Keluar";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['kartu_stok_old']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['kartu_stok_old']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['kartu_stok_old']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['kartu_stok_old']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['kartu_stok_old']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['kartu_stok_old']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['kartu_stok_old']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['kartu_stok_old']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['kartu_stok_old']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "kartu_stok_old_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['kartu_stok_old']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['kartu_stok_old']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['kartu_stok_old']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['kartu_stok_old']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['kartu_stok_old']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
