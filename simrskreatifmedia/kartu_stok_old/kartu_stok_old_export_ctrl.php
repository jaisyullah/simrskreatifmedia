<?php
@session_start() ;
$_SESSION['scriptcase']['kartu_stok_old']['sc_process_barr'] = true;
require_once('../kartu_stok_old/index.php');
unset($_SESSION['scriptcase']['kartu_stok_old']['sc_process_barr']);
$ExportCtrl = new kartu_stok_old_export_control;
$ExportCtrl->Export_barr();

class kartu_stok_old_export_control
{
