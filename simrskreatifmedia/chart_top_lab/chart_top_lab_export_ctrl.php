<?php
@session_start() ;
$_SESSION['scriptcase']['chart_top_lab']['sc_process_barr'] = true;
require_once('../chart_top_lab/index.php');
unset($_SESSION['scriptcase']['chart_top_lab']['sc_process_barr']);
$ExportCtrl = new chart_top_lab_export_control;
$ExportCtrl->Export_barr();

class chart_top_lab_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_chart_title'] ?> Statistik 10 Pemeriksaan :: Excel</TITLE>
