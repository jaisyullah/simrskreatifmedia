...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "hargajual";$Nm_numeric[] = "`sum( x_masuk - x_jumlah )`";$Nm_numeric[] = "hargajual";$Nm_numeric[] = "`sum( x_masuk - x_jumlah )`";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_namaitem_cond" name="namaitem_cond" onChange="nm_campos_between(document.getElementById('id_vis_namaitem'), this, 'namaitem')">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_hargajual_cond" name="hargajual_cond" onChange="nm_campos_between(document.getElementById('id_vis_hargajual'), this, 'hargajual')">
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      ...
      <br><span id="id_hide_sc_field_0"  <?php echo $str_hide_sc_field_0?>><INPUT  type="text" id="SC_sc_field_0" name="sc_field_0" value="<?php echo NM_encode_input($sc_field_0) ?>" size=23 alt="{datatype: 'integer', maxLength: 23, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
