...
<?php
   ...
   $Ord_Cmp = new stok_terkini_old_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class stok_terkini_old_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['stok_terkini_old']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['stok_terkini_old']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["namaitem"]   = (isset($_SESSION['sc_session'][$sc_init]['stok_terkini_old']['labels']["namaitem"])) ? $_SESSION['sc_session'][$sc_init]['stok_terkini_old']['labels']["namaitem"] : "Nama Item";
   $tab_ger_campos['hargajual'] = "on";
   $tab_def_campos['hargajual'] = "hargaJual";
   $tab_labels["hargajual"]   = (isset($_SESSION['sc_session'][$sc_init]['stok_terkini_old']['labels']["hargajual"])) ? $_SESSION['sc_session'][$sc_init]['stok_terkini_old']['labels']["hargajual"] : "Harga Jual (28%)";
   ...
   {
       $tab_def_campos['sc_field_0'] = "`sum( x.masuk - x.jumlah )`";
   }
   $tab_labels["sc_field_0"]   = (isset($_SESSION['sc_session'][$sc_init]['stok_terkini_old']['labels']["sc_field_0"])) ? $_SESSION['sc_session'][$sc_init]['stok_terkini_old']['labels']["sc_field_0"] : "Stok Akhir";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['stok_terkini_old']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['stok_terkini_old']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['stok_terkini_old']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['stok_terkini_old']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['stok_terkini_old']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['stok_terkini_old']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['stok_terkini_old']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['stok_terkini_old']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['stok_terkini_old']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "stok_terkini_old_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['stok_terkini_old']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['stok_terkini_old']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['stok_terkini_old']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['stok_terkini_old']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['stok_terkini_old']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
