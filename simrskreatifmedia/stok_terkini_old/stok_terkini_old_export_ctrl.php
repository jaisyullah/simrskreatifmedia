<?php
@session_start() ;
$_SESSION['scriptcase']['stok_terkini_old']['sc_process_barr'] = true;
require_once('../stok_terkini_old/index.php');
unset($_SESSION['scriptcase']['stok_terkini_old']['sc_process_barr']);
$ExportCtrl = new stok_terkini_old_export_control;
$ExportCtrl->Export_barr();

class stok_terkini_old_export_control
{
