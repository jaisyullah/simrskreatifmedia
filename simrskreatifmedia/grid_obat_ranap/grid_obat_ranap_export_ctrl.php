<?php
@session_start() ;
$_SESSION['scriptcase']['grid_obat_ranap']['sc_process_barr'] = true;
require_once('../grid_obat_ranap/index.php');
unset($_SESSION['scriptcase']['grid_obat_ranap']['sc_process_barr']);
$ExportCtrl = new grid_obat_ranap_export_control;
$ExportCtrl->Export_barr();

class grid_obat_ranap_export_control
{
