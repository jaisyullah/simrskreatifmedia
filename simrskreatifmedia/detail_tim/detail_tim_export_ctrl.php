<?php
@session_start() ;
$_SESSION['scriptcase']['detail_tim']['sc_process_barr'] = true;
require_once('../detail_tim/index.php');
unset($_SESSION['scriptcase']['detail_tim']['sc_process_barr']);
$ExportCtrl = new detail_tim_export_control;
$ExportCtrl->Export_barr();

class detail_tim_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_title'] ?> tbtim :: Excel</TITLE>
