...
class detail_tim_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['path_libs_php'] = $this->Ini->path_lib_php;
      ...
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search_change_fil")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['campos_busca'] = array(); 
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . detail_tim_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . detail_tim_pack_protect_string($Tipo_filter[0]) . "\">.." . detail_tim_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_posisi')
      {
          $posisi = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_posisi($posisi);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_actcode')
      {
          $actcode = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_actcode($actcode);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_penolong')
      {
          $penolong = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_penolong($penolong);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_title'] ?> tbtim</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>detail_tim/detail_tim_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="detail_tim_ajax_search.js"></script>
 <script type="text/javascript" src="detail_tim_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="detail_tim_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['detail_tim']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['detail_tim']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_posisi_cond#NMF#' + search_get_sel_txt('SC_posisi_cond') + '@NMF@';
  str_out += 'SC_posisi#NMF#' + search_get_text('SC_posisi') + '@NMF@';
  str_out += 'id_ac_posisi#NMF#' + search_get_text('id_ac_posisi') + '@NMF@';
  ...
  str_out += 'SC_actcode_cond#NMF#' + search_get_sel_txt('SC_actcode_cond') + '@NMF@';
  str_out += 'SC_actcode#NMF#' + search_get_text('SC_actcode') + '@NMF@';
  str_out += 'id_ac_actcode#NMF#' + search_get_text('id_ac_actcode') + '@NMF@';
  str_out += 'SC_penolong_cond#NMF#' + search_get_sel_txt('SC_penolong_cond') + '@NMF@';
  str_out += 'SC_penolong#NMF#' + search_get_text('SC_penolong') + '@NMF@';
  str_out += 'id_ac_penolong#NMF#' + search_get_text('id_ac_penolong') + '@NMF@';
   ...
   $("#id_ac_posisi").autocomplete({
     ...
     $.ajax({
       ...
       data: {
          ...
          nmgp_parms: "NM_ajax_opcao?#?autocomp_posisi",
          max_itens: "10",
          cod_desc: "N",
   ...
   $("#id_ac_actcode").autocomplete({
     ...
     $.ajax({
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_actcode",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_actcode").val( $(this).val() );
       }
     }
   });
   $("#id_ac_penolong").autocomplete({
     minLength: 1,
     source: function (request, response) {
     $.ajax({
       url: "index.php",
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_penolong",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div class="scFilterHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFilterHeaderFont" style="float: left; text-transform: uppercase;"><?php echo $this->Ini->Nm_lang['lang_othr_srch_title'] ?> tbtim</div>
...
<?php
   ...
   {
      global 
             $posisi_cond, $posisi, $posisi_autocomp,
             $code_cond, $code, $code_autocomp,
             $actcode_cond, $actcode, $actcode_autocomp,
             $penolong_cond, $penolong, $penolong_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          $posisi = $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['campos_busca']['posisi']; 
          $posisi_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['campos_busca']['posisi_cond']; 
          $code = $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['campos_busca']['code']; 
          $code_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['campos_busca']['code_cond']; 
          $actcode = $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['campos_busca']['actcode']; 
          $actcode_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['campos_busca']['actcode_cond']; 
          $penolong = $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['campos_busca']['penolong']; 
          $penolong_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['campos_busca']['penolong_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['campos_busca']['NM_operador']; 
      } 
      if (!isset($posisi_cond) || empty($posisi_cond))
      {
         $posisi_cond = "qp";
      }
      ...
      if (!isset($actcode_cond) || empty($actcode_cond))
      {
         $actcode_cond = "qp";
      }
      if (!isset($penolong_cond) || empty($penolong_cond))
      {
         $penolong_cond = "qp";
      }
      ...
      $str_hide_posisi = (in_array($posisi_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_code = (in_array($code_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_actcode = (in_array($actcode_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_penolong = (in_array($penolong_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      if (!isset($posisi) || $posisi == "")
      {
          $posisi = "";
      }
      if (isset($posisi) && !empty($posisi))
      {
         $tmp_pos = strpos($posisi, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $posisi = substr($posisi, 0, $tmp_pos);
         }
      }
      if (!isset($code) || $code == "")
      {
      ...
      if (!isset($actcode) || $actcode == "")
      {
          $actcode = "";
      }
      if (isset($actcode) && !empty($actcode))
      {
         $tmp_pos = strpos($actcode, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $actcode = substr($actcode, 0, $tmp_pos);
         }
      }
      if (!isset($penolong) || $penolong == "")
      {
          $penolong = "";
      }
      if (isset($penolong) && !empty($penolong))
      {
         $tmp_pos = strpos($penolong, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $penolong = substr($penolong, 0, $tmp_pos);
         }
      }
?>
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_posisi_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['posisi'])) ? $this->New_label['posisi'] : "Posisi"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_posisi_cond" name="posisi_cond" onChange="nm_campos_between(document.getElementById('id_vis_posisi'), this, 'posisi')">
       <OPTION value="qp" <?php if ("qp" == $posisi_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $posisi_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $posisi_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $posisi_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_posisi" <?php echo $str_hide_posisi?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['posisi'])) ? $this->New_label['posisi'] : "Posisi";
 $nmgp_tab_label .= "posisi?#?" . $SC_Label . "?@?";
...
<?php
      ...
      {
          $sAutocompValue = $posisi;
      }
?>
<INPUT  type="text" id="SC_posisi" name="posisi" value="<?php echo NM_encode_input($posisi) ?>"  size=50 alt="{datatype: 'text', maxLength: 100, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_posisi" name="posisi_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 100, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_code_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['code'])) ? $this->New_label['code'] : "Pelaksana"; ?></TD>
...
?>
<INPUT  type="text" id="SC_code" name="code" value="<?php echo NM_encode_input($code) ?>"  size=10 alt="{datatype: 'text', maxLength: 10, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_code" name="code_autocomp" size="10"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 10, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_actcode_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['actcode'])) ? $this->New_label['actcode'] : "Jasa Tindakan"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_actcode_cond" name="actcode_cond" onChange="nm_campos_between(document.getElementById('id_vis_actcode'), this, 'actcode')">
       <OPTION value="qp" <?php if ("qp" == $actcode_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $actcode_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $actcode_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $actcode_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_actcode" <?php echo $str_hide_actcode?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['actcode'])) ? $this->New_label['actcode'] : "Jasa Tindakan";
 $nmgp_tab_label .= "actcode?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      {
          $sAutocompValue = $actcode;
      }
?>
<INPUT  type="text" id="SC_actcode" name="actcode" value="<?php echo NM_encode_input($actcode) ?>"  size=15 alt="{datatype: 'text', maxLength: 15, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_actcode" name="actcode_autocomp" size="15"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 15, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_penolong_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['penolong'])) ? $this->New_label['penolong'] : "Penolong"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_penolong_cond" name="penolong_cond" onChange="nm_campos_between(document.getElementById('id_vis_penolong'), this, 'penolong')">
       <OPTION value="qp" <?php if ("qp" == $penolong_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $penolong_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $penolong_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $penolong_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_penolong" <?php echo $str_hide_penolong?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['penolong'])) ? $this->New_label['penolong'] : "Penolong";
 $nmgp_tab_label .= "penolong?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      {
          $sAutocompValue = $penolong;
      }
?>
<INPUT  type="text" id="SC_penolong" name="penolong" value="<?php echo NM_encode_input($penolong) ?>"  size=1 alt="{datatype: 'text', maxLength: 1, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_penolong" name="penolong_autocomp" size="1"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 1, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if ($_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
<?php
   if (is_file("detail_tim_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['detail_tim']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['detail_tim']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.posisi_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_posisi'), document.F1.posisi_cond, 'posisi');
   document.F1.posisi.value = "";
   document.F1.posisi_autocomp.value = "";
   ...
   document.F1.actcode_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_actcode'), document.F1.actcode_cond, 'actcode');
   document.F1.actcode.value = "";
   document.F1.actcode_autocomp.value = "";
   document.F1.penolong_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_penolong'), document.F1.penolong_cond, 'penolong');
   document.F1.penolong.value = "";
   document.F1.penolong_autocomp.value = "";
 }
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['where_orig'] = "";
      }
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          $this->comando = "";
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['where_orig'];
      }
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_posisi_cond'] = 'cond';
      $tp_fields['SC_posisi'] = 'text_aut';
      $tp_fields['id_ac_posisi'] = 'text_aut';
      $tp_fields['SC_code_cond'] = 'cond';
      $tp_fields['SC_code'] = 'text_aut';
      $tp_fields['id_ac_code'] = 'text_aut';
      $tp_fields['SC_actcode_cond'] = 'cond';
      $tp_fields['SC_actcode'] = 'text_aut';
      $tp_fields['id_ac_actcode'] = 'text_aut';
      $tp_fields['SC_penolong_cond'] = 'cond';
      $tp_fields['SC_penolong'] = 'text_aut';
      $tp_fields['id_ac_penolong'] = 'text_aut';
   ...
   {
      global $posisi_cond, $posisi, $posisi_autocomp,
             $code_cond, $code, $code_autocomp,
             $actcode_cond, $actcode, $actcode_autocomp,
             $penolong_cond, $penolong, $penolong_autocomp, $nmgp_tab_label;
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['campos_busca'] as $Cmps => $Vals)
          {
              $$Cmps = $Vals;
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['grid_pesq'] = array();
      if (!empty($posisi_autocomp) && empty($posisi))
      {
          $posisi = $posisi_autocomp;
      }
      if (!empty($code_autocomp) && empty($code))
      {
          $code = $code_autocomp;
      }
      if (!empty($actcode_autocomp) && empty($actcode))
      {
          $actcode = $actcode_autocomp;
      }
      if (!empty($penolong_autocomp) && empty($penolong))
      {
          $penolong = $penolong_autocomp;
      }
      $posisi_cond_salva = $posisi_cond; 
      if (!isset($posisi_input_2) || $posisi_input_2 == "")
      {
          $posisi_input_2 = $posisi;
      }
      ...
      $actcode_cond_salva = $actcode_cond; 
      if (!isset($actcode_input_2) || $actcode_input_2 == "")
      {
          $actcode_input_2 = $actcode;
      }
      $penolong_cond_salva = $penolong_cond; 
      if (!isset($penolong_input_2) || $penolong_input_2 == "")
      {
          $penolong_input_2 = $penolong;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['Grid_search']  = array(); 
      $I_Grid = 0;
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['campos_busca']['posisi'] = $posisi; 
      if (is_array($posisi) && !empty($posisi))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['Grid_search'][$I_Grid]['val'][0] = $posisi;
      }
      elseif ($posisi_cond_salva == "nu" || $posisi_cond_salva == "nn" || $posisi_cond_salva == "ep" || $posisi_cond_salva == "ne" || !empty($posisi))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['Grid_search'][$I_Grid]['val'][0][0] = $posisi;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['campos_busca']['posisi_cond'] = $posisi_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['Grid_search'][$I_Grid]['cmp'] = "posisi"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['Grid_search'][$I_Grid]['opc'] = $posisi_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['grid_pesq']['posisi'] = $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['campos_busca']['code'] = $code; 
      if (is_array($code) && !empty($code))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['Grid_search'][$I_Grid]['val'][0] = $code;
      }
      elseif ($code_cond_salva == "nu" || $code_cond_salva == "nn" || $code_cond_salva == "ep" || $code_cond_salva == "ne" || !empty($code))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['Grid_search'][$I_Grid]['val'][0][0] = $code;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['campos_busca']['code_cond'] = $code_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['Grid_search'][$I_Grid]['cmp'] = "code"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['Grid_search'][$I_Grid]['opc'] = $code_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['grid_pesq']['code'] = $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['campos_busca']['actcode'] = $actcode; 
      if (is_array($actcode) && !empty($actcode))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['Grid_search'][$I_Grid]['val'][0] = $actcode;
      }
      elseif ($actcode_cond_salva == "nu" || $actcode_cond_salva == "nn" || $actcode_cond_salva == "ep" || $actcode_cond_salva == "ne" || !empty($actcode))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['Grid_search'][$I_Grid]['val'][0][0] = $actcode;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['campos_busca']['actcode_cond'] = $actcode_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['Grid_search'][$I_Grid]['cmp'] = "actcode"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['Grid_search'][$I_Grid]['opc'] = $actcode_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['grid_pesq']['actcode'] = $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['campos_busca']['penolong'] = $penolong; 
      if (is_array($penolong) && !empty($penolong))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['Grid_search'][$I_Grid]['val'][0] = $penolong;
      }
      elseif ($penolong_cond_salva == "nu" || $penolong_cond_salva == "nn" || $penolong_cond_salva == "ep" || $penolong_cond_salva == "ne" || !empty($penolong))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['Grid_search'][$I_Grid]['val'][0][0] = $penolong;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['campos_busca']['penolong_cond'] = $penolong_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['Grid_search'][$I_Grid]['cmp'] = "penolong"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['Grid_search'][$I_Grid]['opc'] = $penolong_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['grid_pesq']['penolong'] = $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['posisi'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['posisi'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['posisi'] = $posisi;
      }
      $code_look = substr($this->Db->qstr($code), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct `code` from " . $this->Ini->nm_tabela . " where trancode = '" . $_SESSION['kodetran'] . "' and `code` = '$code_look' order by `code`"; 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['actcode'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['actcode'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['actcode'] = $actcode;
      }
      $penolong_look = substr($this->Db->qstr($penolong), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct penolong from " . $this->Ini->nm_tabela . " where trancode = '" . $_SESSION['kodetran'] . "' and penolong = '$penolong_look' order by penolong"; 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['penolong'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['penolong'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['penolong'] = $penolong;
      }

      //----- $posisi
      $this->Date_part = false;
      if (isset($posisi) || $posisi_cond == "nu" || $posisi_cond == "nn" || $posisi_cond == "ep" || $posisi_cond == "ne")
      {
         $this->monta_condicao("posisi", $posisi_cond, $posisi, "", "posisi");
      }
      ...
      //----- $actcode
      $this->Date_part = false;
      if (isset($actcode) || $actcode_cond == "nu" || $actcode_cond == "nn" || $actcode_cond == "ep" || $actcode_cond == "ne")
      {
         $this->monta_condicao("actcode", $actcode_cond, $actcode, "", "actcode");
      }

      //----- $penolong
      $this->Date_part = false;
      if (isset($penolong) || $penolong_cond == "nu" || $penolong_cond == "nn" || $penolong_cond == "ep" || $penolong_cond == "ne")
      {
         $this->monta_condicao("penolong", $penolong_cond, $penolong, "", "penolong");
      }
   }
   ...
   function finaliza_resultado_ajax()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['where_pesq'] = $this->comando;
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['where_pesq_fast'])) 
       {
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['where_pesq'])) 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['where_pesq_fast'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['where_pesq'] = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['where_pesq_fast'] . ")";
           }
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['cond_dyn_search'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['detail_tim']['cond_pesq'] .= $this->NM_operador;
