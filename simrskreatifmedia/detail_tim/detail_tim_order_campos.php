...
<?php
   ...
   $Ord_Cmp = new detail_tim_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class detail_tim_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['detail_tim']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['detail_tim']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['posisi'] = "posisi";
   $tab_labels["posisi"]   = (isset($_SESSION['sc_session'][$sc_init]['detail_tim']['labels']["posisi"])) ? $_SESSION['sc_session'][$sc_init]['detail_tim']['labels']["posisi"] : "Posisi";
   $tab_ger_campos['code'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['code'] = "sc_def_col_1";
   }
   else
   {
       $tab_def_campos['code'] = "`code`";
   }
   $tab_labels["code"]   = (isset($_SESSION['sc_session'][$sc_init]['detail_tim']['labels']["code"])) ? $_SESSION['sc_session'][$sc_init]['detail_tim']['labels']["code"] : "Pelaksana";
   $tab_ger_campos['actcode'] = "on";
   $tab_def_campos['actcode'] = "actcode";
   $tab_labels["actcode"]   = (isset($_SESSION['sc_session'][$sc_init]['detail_tim']['labels']["actcode"])) ? $_SESSION['sc_session'][$sc_init]['detail_tim']['labels']["actcode"] : "Jasa Tindakan";
   $tab_ger_campos['penolong'] = "on";
   $tab_def_campos['penolong'] = "penolong";
   $tab_labels["penolong"]   = (isset($_SESSION['sc_session'][$sc_init]['detail_tim']['labels']["penolong"])) ? $_SESSION['sc_session'][$sc_init]['detail_tim']['labels']["penolong"] : "Penolong";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['detail_tim']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['detail_tim']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['detail_tim']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['detail_tim']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['detail_tim']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['detail_tim']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['detail_tim']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['detail_tim']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['detail_tim']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "detail_tim_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['detail_tim']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['detail_tim']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['detail_tim']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['detail_tim']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['detail_tim']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
