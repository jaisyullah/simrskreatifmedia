...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_posisi_cond" name="posisi_cond" onChange="nm_campos_between(document.getElementById('id_vis_posisi'), this, 'posisi')">
      ...
      <br><span id="id_hide_posisi"  <?php echo $str_hide_posisi?>><?php
      if ($posisi != "")
      {
      $posisi_look = substr($this->Db->qstr($posisi), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_actcode_cond" name="actcode_cond" onChange="nm_campos_between(document.getElementById('id_vis_actcode'), this, 'actcode')">
      ...
      <br><span id="id_hide_actcode"  <?php echo $str_hide_actcode?>><?php
      if ($actcode != "")
      {
      $actcode_look = substr($this->Db->qstr($actcode), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_penolong_cond" name="penolong_cond" onChange="nm_campos_between(document.getElementById('id_vis_penolong'), this, 'penolong')">
      ...
      <br><span id="id_hide_penolong"  <?php echo $str_hide_penolong?>><?php
      if ($penolong != "")
      {
      $penolong_look = substr($this->Db->qstr($penolong), 1, -1); 
      $nmgp_def_dados = array(); 
