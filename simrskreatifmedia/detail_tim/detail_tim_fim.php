...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____detail_tim"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____detail_tim"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['detail_tim']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['detail_tim']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['detail_tim']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['detail_tim']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['detail_tim']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['detail_tim']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['detail_tim']['embutida_filho'] as $ind => $sc_init)
          {
