<?php
@session_start() ;
$_SESSION['scriptcase']['cetak_form_pasien']['sc_process_barr'] = true;
require_once('../cetak_form_pasien/index.php');
unset($_SESSION['scriptcase']['cetak_form_pasien']['sc_process_barr']);
$ExportCtrl = new cetak_form_pasien_export_control;
$ExportCtrl->Export_barr();

class cetak_form_pasien_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_chart_titl'] ?> - tbcustomer :: Excel</TITLE>
