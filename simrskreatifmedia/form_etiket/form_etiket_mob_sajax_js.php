  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_etiket_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_etiket_mob_form();
	}

  // ---------- Validate id
  function do_ajax_form_etiket_mob_validate_id()
  {
    var nomeCampo_id = "id";
    var var_id = scAjaxGetFieldText(nomeCampo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_etiket_mob_validate_id(var_id, var_script_case_init, do_ajax_form_etiket_mob_validate_id_cb);
  } // do_ajax_form_etiket_mob_validate_id

  function do_ajax_form_etiket_mob_validate_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_etiket_mob_validate_id_cb

  // ---------- Validate etiket
  function do_ajax_form_etiket_mob_validate_etiket()
  {
    var nomeCampo_etiket = "etiket";
    var var_etiket = scAjaxGetFieldRadio(nomeCampo_etiket);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_etiket_mob_validate_etiket(var_etiket, var_script_case_init, do_ajax_form_etiket_mob_validate_etiket_cb);
  } // do_ajax_form_etiket_mob_validate_etiket

  function do_ajax_form_etiket_mob_validate_etiket_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "etiket";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_etiket_mob_validate_etiket_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_etiket_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_etiket_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id = scAjaxGetFieldText("id");
    var var_etiket = scAjaxGetFieldRadio("etiket");
    ...
    scAjaxProcOn();
    x_ajax_form_etiket_mob_submit_form(var_id, var_etiket, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_etiket_mob_submit_form_cb);
  } // do_ajax_form_etiket_mob_submit_form

  function do_ajax_form_etiket_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_etiket_mob_submit_form_cb_after_alert);
  } // do_ajax_form_etiket_mob_submit_form_cb
  function do_ajax_form_etiket_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_etiket_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_etiket_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_etiket_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_etiket_mob_navigate_form_cb);
  } // do_ajax_form_etiket_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiket_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_etiket_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_etiket_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_etiket_mob_navigate_form_cb
  function do_ajax_form_etiket_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_etiket_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_etiket_mob_navigate_form_cb_after_alert
  function sc_hide_form_etiket_mob_form()
  {
  ...
  var ajax_error_list = {
    ...
    "etiket": {"label": "Etiket", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  ajax_field_mult["etiket"][1] = "etiket";

  var ajax_field_id = {
    "id": new Array("hidden_field_label_id", "hidden_field_data_id"),
    "etiket": new Array("hidden_field_label_etiket", "hidden_field_data_etiket")
  };
