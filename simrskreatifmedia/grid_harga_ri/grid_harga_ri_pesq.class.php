...
class grid_harga_ri_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_harga_ri']['path_libs_php'] = $this->Ini->path_lib_php;
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_harga_ri']['prim_vez']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_harga_ri']['prim_vez'] = "S";
      }
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_harga_ri_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_harga_ri_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_harga_ri_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function lookup_ajax_tindakan($tindakan)
   {
      ...
      $nm_comando = "select distinct b.namaTindakan from " . $this->Ini->nm_tabela . " where aktif = 'Y' and  b.namaTindakan like '%" . $tindakan . "%' order by b.namaTindakan"; 
      unset($cmp1,$cmp2);
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_harga_ri']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_harga_ri']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_harga_ri']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_harga_ri']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_harga_ri']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_harga_ri']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_harga_ri']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_harga_ri']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_harga_ri']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_harga_ri']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_harga_ri']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_harga_ri']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_harga_ri']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_harga_ri']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_harga_ri']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
   ...
   $NM_retorno = "./";
    if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_harga_ri']['proc_res'])) 
    {
...
<?php
    if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_harga_ri']['prim_vez'] == "N" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_harga_ri']['proc_res']) 
    {
?>
if (parent.document.getElementById('nmsc_iframe_grid_harga_ri').contentWindow.nm_gp_submit_ajax)
{
   parent.document.getElementById('nmsc_iframe_grid_harga_ri').contentWindow.nm_gp_submit_ajax('inicio', 'save_grid');
}
else
{
   parent.document.getElementById('nmsc_iframe_grid_harga_ri').src = 'index.php?nmgp_opcao=pesq&script_case_init=<?php echo NM_encode_input($this->Ini->sc_page) ?>&script_case_session=<?php echo session_id() ?>';
}
<?php
    }
    else
...
<?php
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_harga_ri']['prim_vez'] = "N";
?>
</SCRIPT>
</BODY>
</HTML>
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_title'] ?> Harga Tindakan Inap</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_harga_ri/grid_harga_ri_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_harga_ri_ajax_search.js"></script>
 <script type="text/javascript" src="grid_harga_ri_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_harga_ri_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_harga_ri']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_harga_ri']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'id_ac_tindakan#NMF#' + search_get_title('select2-id_ac_tindakan-container') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
  $(".sc-ui-autocomp-tindakan").on("focus", function() {
  }).on("blur", function() {
   ...
   $("#SC_tindakan").val(e.params.data.id);
  });
 });
</script>
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_harga_ri']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div class="scFilterHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFilterHeaderFont" style="float: left; text-transform: uppercase;"><?php echo $this->Ini->Nm_lang['lang_othr_srch_title'] ?> Harga Tindakan Inap</div>
...
<?php
   ...
   function monta_form()
   {
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_harga_ri']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_harga_ri']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_harga_ri']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_harga_ri']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $tindakan = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_harga_ri']['campos_busca']['tindakan']; 
          $tindakan_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_harga_ri']['campos_busca']['tindakan_cond']; 
          $poli = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_harga_ri']['campos_busca']['poli']; 
          $poli_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_harga_ri']['campos_busca']['poli_cond']; 
          $kelas = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_harga_ri']['campos_busca']['kelas']; 
          $kelas_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_harga_ri']['campos_busca']['kelas_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_harga_ri']['campos_busca']['NM_operador']; 
      } 
...
<?php
      ...
      $tindakan_look = substr($this->Db->qstr($tindakan), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct b.namaTindakan from " . $this->Ini->nm_tabela . " where aktif = 'Y' and b.namaTindakan = '$tindakan_look' order by b.namaTindakan"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
...
?>
<INPUT  type="text" id="SC_tindakan" name="tindakan" value="<?php echo NM_encode_input($tindakan) ?>"  size=50 alt="{datatype: 'text', maxLength: 765, allowedChars: '', lettersCase: 'upper', autoTab: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-tindakan" id="id_ac_tindakan" name="tindakan_autocomp"><?php if ('' !=  $tindakan) { ?><option value="<?php echo $tindakan ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
...
<?php
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_harga_ri']['psq_check_ret']['poli'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_harga_ri']['psq_check_ret']['poli'][] = trim($rs->fields[0]);
...
?>
   <span id="idAjaxSelect_poli">
      <SELECT class="scFilterObjectEven" id="SC_poli" name="poli[]"  size="1" multiple>
<?php
...
<?php
      ...
      $nmgp_def_dados = "" ; 
      $nm_comando = "SELECT namaKelas, namaKelas  FROM tbkelas  ORDER BY idKelas ASC"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_harga_ri']['psq_check_ret']['kelas'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_harga_ri']['psq_check_ret']['kelas'][] = trim($rs->fields[0]);
            $nmgp_def_dados .= trim($rs->fields[1]) . "?#?" ; 
            $nmgp_def_dados .= trim($rs->fields[0]) . "?#?N?@?" ; 
            $rs->MoveNext() ; 
         } 
...
?>
   <span id="idAjaxSelect_kelas">
      <SELECT class="scFilterObjectOdd" id="SC_kelas" name="kelas[]"  size="1" multiple>
<?php
      $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
      $nm_opcoes  = explode("?@?", $nm_opcoesx);
      foreach ($nm_opcoes as $nm_opcao)
...
?>
<?php
   if (is_file("grid_harga_ri_help.txt"))
   {
...
?>
<?php
   if ($nm_apl_dependente == 1 || (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_harga_ri']['opc_psq'] && !$this->aba_iframe))
   {
...
<?php
       ...
       elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_harga_ri']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_harga_ri']['dashboard_info']['under_dashboard'])
       { }
       else 
       { 
?>
...
<?php
   ...
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_harga_ri']['opc_psq'])
   {
...
<?php
    if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_harga_ri']['prim_vez'] == "N") 
    {
?>
       <iframe id="nmsc_iframe_grid_harga_ri" frameborder="0" marginwidth="0px" marginheight="0px" topmargin="0px" leftmargin="0px" align="center" height="1500px" name="nm_iframe_grid_harga_ri" scrolling="auto" src="index.php?nmgp_opcao=pesq&script_case_init=<?php echo NM_encode_input($this->Ini->sc_page) ?>&script_case_session=<?php echo session_id() ?>" width="100%"></iframe>
<?php
    }
    else
    {
?>
       <iframe id="nmsc_iframe_grid_harga_ri" frameborder="0" marginwidth="0px" marginheight="0px" topmargin="0px" leftmargin="0px" align="center" height="1500px" name="nm_iframe_grid_harga_ri" scrolling="auto" src="" width="100%"></iframe>
<?php
    }
?>
<iframe id="nmsc_iframe_grid_harga_ri_pesq"  name="nm_iframe_grid_harga_ri_pesq" style= "display: none;" frameborder="0" marginwidth="0px" marginheight="0px" topmargin="0px" leftmargin="0px" src=""></iframe>
</td></tr></table></td></tr>
</TABLE>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_harga_ri']['orig_pesq'] == "grid")
   {
...
?>
 ...
 {
    document.F1.target = "nm_iframe_grid_harga_ri_pesq";
    document.F1.submit();
 }
 function nm_move()
 {
     document.getElementById('nmsc_iframe_grid_harga_ri').contentWindow.nm_move('igual');
 }
 function limpa_form()
 {
   document.F1.reset();
   ...
   $('#SC_poli').dropdownchecklist('destroy');
    $('#SC_poli option').each(function() {
       $(this).attr('selected',false);
    });
   nm_campos_between(document.getElementById('id_vis_kelas'), document.F1.kelas_cond, 'kelas');
   $('#SC_kelas').dropdownchecklist('destroy');
    $('#SC_kelas option').each(function() {
       $(this).attr('selected',false);
    });
   Sc_carga_ddcheckbox('all');
   Sc_carga_select2('all');
 }
 function Sc_carga_ddcheckbox(Field)
 {
    if (Field == 'all' || Field == 'poli') {
       Sc_carga_ddcheckbox_poli();
    }
    if (Field == 'all' || Field == 'kelas') {
       Sc_carga_ddcheckbox_kelas();
    }
 }
 function Sc_carga_ddcheckbox_poli()
 {
    $("#SC_poli").dropdownchecklist({
       bgiframe: true,
 ...
 function Sc_carga_ddcheckbox_kelas()
 {
    $("#SC_kelas").dropdownchecklist({
       bgiframe: true,
       closeRadioOnClick: true,
       maxDropHeight: 150,
       icon: { placement: 'right' }
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "simrskreatifmedia/grid_harga_ri";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_harga_ri']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_harga_ri']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_harga_ri']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['id_ac_tindakan'] = 'select2_aut';
      $tp_fields['SC_poli_cond'] = 'cond';
      $tp_fields['SC_poli'] = 'ddcheckbox';
      $tp_fields['SC_kelas_cond'] = 'cond';
      $tp_fields['SC_kelas'] = 'ddcheckbox';
   ...
   {
      global $tindakan_cond, $tindakan, $tindakan_autocomp,
             $poli_cond, $poli,
             $kelas_cond, $kelas, $nmgp_tab_label;
      ...
      if (is_array($poli)) {
          foreach ($poli as $I => $Val) {
              ...
              if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && trim($L_lookup) != '' && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_harga_ri']['psq_check_ret']['poli'])) {
      ...
      if (is_array($kelas)) {
          foreach ($kelas as $I => $Val) {
              ...
              if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && trim($L_lookup) != '' && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_harga_ri']['psq_check_ret']['kelas'])) {
                  if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "Kelas : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
                  break;
              }
          }
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_harga_ri']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_harga_ri']['campos_busca']['tindakan'] = $tindakan; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_harga_ri']['campos_busca']['tindakan_cond'] = $tindakan_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_harga_ri']['campos_busca']['poli'] = $poli; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_harga_ri']['campos_busca']['poli_cond'] = $poli_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_harga_ri']['campos_busca']['kelas'] = $kelas; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_harga_ri']['campos_busca']['kelas_cond'] = $kelas_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_harga_ri']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_harga_ri']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      ...
      $this->cmp_formatado['poli'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_harga_ri']['campos_busca']['poli'];
      $this->cmp_formatado['poli_input_2'] = $poli_input_2;
      $this->cmp_formatado['kelas'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_harga_ri']['campos_busca']['kelas'];
      ...
      {
         $this->monta_condicao("b.namaTindakan", $tindakan_cond, $tindakan, "", "tindakan");
      }
      ...
      if (is_array($poli) && count($poli) != 0)
      {
         ...
         {
             $this->comando        .= " b.jenisTindakan not in (";
             $this->comando_sum    .= " .b.jenisTindakan not in (";
             $this->comando_filtro .= " b.jenisTindakan not in (";
         }
         else
         {
             $this->comando        .= " b.jenisTindakan in (";
             $this->comando_sum    .= " .b.jenisTindakan in (";
             $this->comando_filtro .= " b.jenisTindakan in (";
         }
         $x                     = count($poli);
         $xx                    = 0;
         $nm_cond               = "";
         ...
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_harga_ri']['cond_pesq'] .= $nmgp_tab_label['poli'] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
      }
      elseif (isset($poli) || $poli_cond == "nu" || $poli_cond == "nn" || $poli_cond == "ep" || $poli_cond == "ne")
      {
         $this->monta_condicao("b.jenisTindakan", $poli_cond, $poli, "", "poli");
      }
      ...
      if (is_array($kelas) && count($kelas) != 0)
      {
         ...
         {
             $this->comando        .= " a.kelas not in (";
             $this->comando_sum    .= " .a.kelas not in (";
             $this->comando_filtro .= " a.kelas not in (";
         }
         else
         {
             $this->comando        .= " a.kelas in (";
             $this->comando_sum    .= " .a.kelas in (";
             $this->comando_filtro .= " a.kelas in (";
         }
         $x                     = count($kelas);
         $xx                    = 0;
         $nm_cond               = "";
         ...
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_harga_ri']['cond_pesq'] .= $nmgp_tab_label['kelas'] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
      }
   ...
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_harga_ri']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_harga_ri']['cond_dyn_search'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_harga_ri']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_harga_ri']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_harga_ri']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_harga_ri']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_harga_ri']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_harga_ri']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_harga_ri']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_harga_ri']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_harga_ri']['cond_pesq'] .= $this->NM_operador;
   ...
   function css_obj_select_ajax($Obj)
   {
      switch ($Obj)
      {
         case "poli" : return ('class="scFilterObjectEven"'); break;
         case "kelas" : return ('class="scFilterObjectOdd"'); break;
         default       : return ("");
      }
   }
