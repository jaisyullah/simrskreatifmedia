<?php
@session_start() ;
$_SESSION['scriptcase']['grid_histbdetailok']['sc_process_barr'] = true;
require_once('../grid_histbdetailok/index.php');
unset($_SESSION['scriptcase']['grid_histbdetailok']['sc_process_barr']);
$ExportCtrl = new grid_histbdetailok_export_control;
$ExportCtrl->Export_barr();

class grid_histbdetailok_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - Kamar Operasi :: Excel</TITLE>
