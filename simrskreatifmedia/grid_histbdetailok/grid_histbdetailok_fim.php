...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_histbdetailok"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_histbdetailok"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_tbdetailok'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_histbdetailok']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_histbdetailok']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_histbdetailok']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_histbdetailok']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_histbdetailok']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_histbdetailok</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_histbdetailok']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_histbdetailok']['embutida_filho'] as $ind => $sc_init)
          {
