  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_change_password_it" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_change_password_it_form();
	}

  // ---------- Validate username
  function do_ajax_change_password_it_validate_username()
  {
    var nomeCampo_username = "username";
    var var_username = scAjaxGetFieldSelect(nomeCampo_username);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_change_password_it_validate_username(var_username, var_script_case_init, do_ajax_change_password_it_validate_username_cb);
  } // do_ajax_change_password_it_validate_username

  function do_ajax_change_password_it_validate_username_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_change_password_it_validate_username_cb

  // ---------- Validate pswd
  function do_ajax_change_password_it_validate_pswd()
  {
    var nomeCampo_pswd = "pswd";
    var var_pswd = scAjaxGetFieldText(nomeCampo_pswd);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_change_password_it_validate_pswd(var_pswd, var_script_case_init, do_ajax_change_password_it_validate_pswd_cb);
  } // do_ajax_change_password_it_validate_pswd

  function do_ajax_change_password_it_validate_pswd_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pswd";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_change_password_it_validate_pswd_cb

  // ---------- Validate confirm_pswd
  function do_ajax_change_password_it_validate_confirm_pswd()
  {
    var nomeCampo_confirm_pswd = "confirm_pswd";
    var var_confirm_pswd = scAjaxGetFieldText(nomeCampo_confirm_pswd);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_change_password_it_validate_confirm_pswd(var_confirm_pswd, var_script_case_init, do_ajax_change_password_it_validate_confirm_pswd_cb);
  } // do_ajax_change_password_it_validate_confirm_pswd

  function do_ajax_change_password_it_validate_confirm_pswd_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_change_password_it_validate_confirm_pswd_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_change_password_it_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_change_password_it_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_change_password_it_submit_form(var_username, var_pswd, var_confirm_pswd, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_change_password_it_submit_form_cb);
  } // do_ajax_change_password_it_submit_form

  function do_ajax_change_password_it_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_change_password_it_submit_form_cb_after_alert);
  } // do_ajax_change_password_it_submit_form_cb
  function do_ajax_change_password_it_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_change_password_it_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_change_password_it_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_change_password_it_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['change_password_it']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_change_password_it_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_change_password_it_navigate_form_cb_after_alert);
  } // do_ajax_change_password_it_navigate_form_cb
  function do_ajax_change_password_it_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_change_password_it_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_change_password_it_navigate_form_cb_after_alert
  function sc_hide_change_password_it_form()
  {
