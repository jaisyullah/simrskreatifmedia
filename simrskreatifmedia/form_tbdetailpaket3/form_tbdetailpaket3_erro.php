...
$old_error_handler = set_error_handler("form_tbdetailpaket3_scriptcase_error_handler");

function form_tbdetailpaket3_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['form_tbdetailpaket3']['contr_erro']) && $_SESSION['scriptcase']['form_tbdetailpaket3']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_form_tbdetailpaket3->contr_form_tbdetailpaket3->Apl_com_erro = true;
            if ($inicial_form_tbdetailpaket3->contr_form_tbdetailpaket3->NM_ajax_flag)
            {
                $inicial_form_tbdetailpaket3->contr_form_tbdetailpaket3->NM_ajax_info['errList']['geral_form_tbdetailpaket3'][] = $msg;
                return;
            }
            form_tbdetailpaket3_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function form_tbdetailpaket3_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['form_tbdetailpaket3'])  && '' != $_SESSION['scriptcase']['error_icon']['form_tbdetailpaket3'])  ? $_SESSION['scriptcase']['error_icon']['form_tbdetailpaket3']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['form_tbdetailpaket3']) && '' != $_SESSION['scriptcase']['error_span_title']['form_tbdetailpaket3']) ? $_SESSION['scriptcase']['error_span_title']['form_tbdetailpaket3'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['form_tbdetailpaket3']) && '' != $_SESSION['scriptcase']['error_icon_title']['form_tbdetailpaket3']) ? $_SESSION['scriptcase']['error_icon_title']['form_tbdetailpaket3'] : '';
?>
...
<?php
    ...
    $_SESSION['scriptcase']['form_tbdetailpaket3']['error_buffer'] .= ob_get_flush();
}
