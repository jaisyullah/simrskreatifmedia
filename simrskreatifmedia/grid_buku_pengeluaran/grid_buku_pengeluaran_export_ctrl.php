<?php
@session_start() ;
$_SESSION['scriptcase']['grid_buku_pengeluaran']['sc_process_barr'] = true;
require_once('../grid_buku_pengeluaran/index.php');
unset($_SESSION['scriptcase']['grid_buku_pengeluaran']['sc_process_barr']);
$ExportCtrl = new grid_buku_pengeluaran_export_control;
$ExportCtrl->Export_barr();

class grid_buku_pengeluaran_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_title'] ?> buku_pengeluaran :: Excel</TITLE>
