...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "tanggal";$Nm_datas[] = "tanggal";$Nm_numeric[] = "id";$Nm_numeric[] = "id_hutang";$Nm_numeric[] = "jumlah_bayar";$Nm_numeric[] = "jenis_pembayaran";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_id_hutang_cond" name="id_hutang_cond" onChange="nm_campos_between(document.getElementById('id_vis_id_hutang'), this, 'id_hutang')">
      ...
      <br><span id="id_hide_id_hutang"  <?php echo $str_hide_id_hutang?>><?php
      if ($id_hutang != "")
      {
      $id_hutang_look = substr($this->Db->qstr($id_hutang), 1, -1); 
      $nmgp_def_dados = array(); 
