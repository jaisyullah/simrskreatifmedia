...
<?php
   ...
   $Ord_Cmp = new grid_buku_pengeluaran_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_buku_pengeluaran_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_buku_pengeluaran']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_buku_pengeluaran']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_buku_pengeluaran']['labels']["id"])) ? $_SESSION['sc_session'][$sc_init]['grid_buku_pengeluaran']['labels']["id"] : "Id";
   $tab_ger_campos['id_hutang'] = "on";
   $tab_def_campos['id_hutang'] = "id_hutang";
   $tab_labels["id_hutang"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_buku_pengeluaran']['labels']["id_hutang"])) ? $_SESSION['sc_session'][$sc_init]['grid_buku_pengeluaran']['labels']["id_hutang"] : "Id Hutang";
   $tab_ger_campos['no_referensi'] = "on";
   $tab_def_campos['no_referensi'] = "no_referensi";
   $tab_labels["no_referensi"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_buku_pengeluaran']['labels']["no_referensi"])) ? $_SESSION['sc_session'][$sc_init]['grid_buku_pengeluaran']['labels']["no_referensi"] : "No Referensi";
   $tab_ger_campos['keterangan'] = "on";
   $tab_def_campos['keterangan'] = "keterangan";
   $tab_labels["keterangan"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_buku_pengeluaran']['labels']["keterangan"])) ? $_SESSION['sc_session'][$sc_init]['grid_buku_pengeluaran']['labels']["keterangan"] : "Keterangan";
   $tab_ger_campos['tanggal'] = "on";
   $tab_def_campos['tanggal'] = "tanggal";
   $tab_labels["tanggal"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_buku_pengeluaran']['labels']["tanggal"])) ? $_SESSION['sc_session'][$sc_init]['grid_buku_pengeluaran']['labels']["tanggal"] : "Tanggal";
   $tab_ger_campos['jumlah_bayar'] = "on";
   $tab_def_campos['jumlah_bayar'] = "jumlah_bayar";
   $tab_labels["jumlah_bayar"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_buku_pengeluaran']['labels']["jumlah_bayar"])) ? $_SESSION['sc_session'][$sc_init]['grid_buku_pengeluaran']['labels']["jumlah_bayar"] : "Jumlah Bayar";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_buku_pengeluaran']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_buku_pengeluaran']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_buku_pengeluaran']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_buku_pengeluaran']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_buku_pengeluaran']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_buku_pengeluaran']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_buku_pengeluaran']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_buku_pengeluaran']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_buku_pengeluaran']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_buku_pengeluaran_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_buku_pengeluaran']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_buku_pengeluaran']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_buku_pengeluaran']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_buku_pengeluaran']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_buku_pengeluaran']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
