<?php
@session_start() ;
$_SESSION['scriptcase']['Laporan_Stok_Persediaan']['sc_process_barr'] = true;
require_once('../Laporan_Stok_Persediaan/index.php');
unset($_SESSION['scriptcase']['Laporan_Stok_Persediaan']['sc_process_barr']);
$ExportCtrl = new Laporan_Stok_Persediaan_export_control;
$ExportCtrl->Export_barr();

class Laporan_Stok_Persediaan_export_control
{
