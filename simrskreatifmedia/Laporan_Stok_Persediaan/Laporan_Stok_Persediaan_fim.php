...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____Laporan_Stok_Persediaan"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____Laporan_Stok_Persediaan"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['Laporan_Stok_Persediaan']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['Laporan_Stok_Persediaan']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['Laporan_Stok_Persediaan']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['Laporan_Stok_Persediaan']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['Laporan_Stok_Persediaan']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>Laporan_Stok_Persediaan</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['Laporan_Stok_Persediaan']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['Laporan_Stok_Persediaan']['embutida_filho'] as $ind => $sc_init)
          {
