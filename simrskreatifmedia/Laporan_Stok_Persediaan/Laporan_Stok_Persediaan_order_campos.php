...
<?php
   ...
   $Ord_Cmp = new Laporan_Stok_Persediaan_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class Laporan_Stok_Persediaan_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['Laporan_Stok_Persediaan']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['Laporan_Stok_Persediaan']['ordem_select_orig'] = array();
   }
   ...
   {
       $tab_def_campos['sc_field_0'] = "b.namaItem";
   }
   $tab_labels["sc_field_0"]   = (isset($_SESSION['sc_session'][$sc_init]['Laporan_Stok_Persediaan']['labels']["sc_field_0"])) ? $_SESSION['sc_session'][$sc_init]['Laporan_Stok_Persediaan']['labels']["sc_field_0"] : "Nama Item";
   ...
   {
       $tab_def_campos['stok'] = "a.currentStock";
   }
   $tab_labels["stok"]   = (isset($_SESSION['sc_session'][$sc_init]['Laporan_Stok_Persediaan']['labels']["stok"])) ? $_SESSION['sc_session'][$sc_init]['Laporan_Stok_Persediaan']['labels']["stok"] : "Stok";
   $tab_ger_campos['depo'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['depo'] = "depo";
   }
   else
   {
       $tab_def_campos['depo'] = "c.namaDepo";
   }
   $tab_labels["depo"]   = (isset($_SESSION['sc_session'][$sc_init]['Laporan_Stok_Persediaan']['labels']["depo"])) ? $_SESSION['sc_session'][$sc_init]['Laporan_Stok_Persediaan']['labels']["depo"] : "Depo";
   $tab_ger_campos['hja'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['hja'] = "hja";
   }
   else
   {
       $tab_def_campos['hja'] = "b.hargaJual";
   }
   $tab_labels["hja"]   = (isset($_SESSION['sc_session'][$sc_init]['Laporan_Stok_Persediaan']['labels']["hja"])) ? $_SESSION['sc_session'][$sc_init]['Laporan_Stok_Persediaan']['labels']["hja"] : "HJA";
   ...
   {
       $tab_def_campos['total'] = "( b.hargaJual * a.currentStock )";
   }
   $tab_labels["total"]   = (isset($_SESSION['sc_session'][$sc_init]['Laporan_Stok_Persediaan']['labels']["total"])) ? $_SESSION['sc_session'][$sc_init]['Laporan_Stok_Persediaan']['labels']["total"] : "Total";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['Laporan_Stok_Persediaan']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['Laporan_Stok_Persediaan']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['Laporan_Stok_Persediaan']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['Laporan_Stok_Persediaan']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['Laporan_Stok_Persediaan']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['Laporan_Stok_Persediaan']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['Laporan_Stok_Persediaan']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['Laporan_Stok_Persediaan']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['Laporan_Stok_Persediaan']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "Laporan_Stok_Persediaan_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['Laporan_Stok_Persediaan']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['Laporan_Stok_Persediaan']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['Laporan_Stok_Persediaan']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['Laporan_Stok_Persediaan']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['Laporan_Stok_Persediaan']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
