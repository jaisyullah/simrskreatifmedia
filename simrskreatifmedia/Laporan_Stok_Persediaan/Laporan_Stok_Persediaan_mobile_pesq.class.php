...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "a_currentstock";$Nm_numeric[] = "b_hargajual";$Nm_numeric[] = "( b_hargajual * a_currentstock )";$Nm_numeric[] = "a_currentstock";$Nm_numeric[] = "b_hargajual";$Nm_numeric[] = "( b_hargajual * a_currentstock )";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_stok_cond" name="stok_cond" onChange="nm_campos_between(document.getElementById('id_vis_stok'), this, 'stok')">
      ...
      <br><span id="id_hide_stok"  <?php echo $str_hide_stok?>><INPUT  type="text" id="SC_stok" name="stok" value="<?php echo NM_encode_input($stok) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_depo_cond" name="depo_cond" onChange="nm_campos_between(document.getElementById('id_vis_depo'), this, 'depo')">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_hja_cond" name="hja_cond" onChange="nm_campos_between(document.getElementById('id_vis_hja'), this, 'hja')">
