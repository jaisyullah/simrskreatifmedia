...
class Laporan_Stok_Persediaan_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['path_libs_php'] = $this->Ini->path_lib_php;
      ...
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search_change_fil")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['campos_busca'] = array(); 
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . Laporan_Stok_Persediaan_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . Laporan_Stok_Persediaan_pack_protect_string($Tipo_filter[0]) . "\">.." . Laporan_Stok_Persediaan_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
          ...
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['grid_pesq'][$campo_join]);
              return;
          }
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>Laporan_Stok_Persediaan/Laporan_Stok_Persediaan_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="Laporan_Stok_Persediaan_ajax_search.js"></script>
 <script type="text/javascript" src="Laporan_Stok_Persediaan_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="Laporan_Stok_Persediaan_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['Laporan_Stok_Persediaan']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['Laporan_Stok_Persediaan']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_nama item_cond#NMF#' + search_get_sel_txt('SC_sc_field_0_cond') + '@NMF@';
  str_out += 'SC_nama item#NMF#' + search_get_text('SC_sc_field_0') + '@NMF@';
  str_out += 'id_ac_nama item#NMF#' + search_get_text('id_ac_sc_field_0') + '@NMF@';
  ...
  str_out += 'SC_hja_cond#NMF#' + search_get_sel_txt('SC_hja_cond') + '@NMF@';
  str_out += 'SC_hja#NMF#' + search_get_text('SC_hja') + '@NMF@';
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<?php
   ...
   function monta_form()
   {
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          $sc_field_0 = $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['campos_busca']['sc_field_0']; 
          $sc_field_0_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['campos_busca']['sc_field_0_cond']; 
          $stok = $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['campos_busca']['stok']; 
          $stok_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['campos_busca']['stok_cond']; 
          $depo = $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['campos_busca']['depo']; 
          $depo_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['campos_busca']['depo_cond']; 
          $hja = $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['campos_busca']['hja']; 
          $hja_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['campos_busca']['hja_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['campos_busca']['NM_operador']; 
          if (strtoupper($stok_cond) != "II" && strtoupper($stok_cond) != "QP" && strtoupper($stok_cond) != "NP" && strtoupper($stok_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($stok, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
          if (strtoupper($hja_cond) != "II" && strtoupper($hja_cond) != "QP" && strtoupper($hja_cond) != "NP" && strtoupper($hja_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($hja, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'], $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
      } 
      ...
      if (!isset($stok_cond) || empty($stok_cond))
      {
         $stok_cond = "gt";
      }
      ...
      if (!isset($hja_cond) || empty($hja_cond))
      {
         $hja_cond = "gt";
      }
      ...
      $str_hide_hja = (in_array($hja_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_sc_field_0_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['sc_field_0'])) ? $this->New_label['sc_field_0'] : "Nama Item"; ?></TD>
...
?>
<INPUT  type="text" id="SC_sc_field_0" name="sc_field_0" value="<?php echo NM_encode_input($sc_field_0) ?>"  size=50 alt="{datatype: 'text', maxLength: 450, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_sc_field_0" name="sc_field_0_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 450, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
     ...
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_stok_cond" name="stok_cond" onChange="nm_campos_between(document.getElementById('id_vis_stok'), this, 'stok')">
       <OPTION value="gt" <?php if ("gt" == $stok_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $stok_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $stok_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
...
?>
<INPUT  type="text" id="SC_stok" name="stok" value="<?php echo NM_encode_input($stok) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
      ...
      <TD id='SC_depo_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['depo'])) ? $this->New_label['depo'] : "Depo"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_depo_cond" name="depo_cond" onChange="nm_campos_between(document.getElementById('id_vis_depo'), this, 'depo')">
...
?>
<INPUT  type="text" id="SC_depo" name="depo" value="<?php echo NM_encode_input($depo) ?>"  size=50 alt="{datatype: 'text', maxLength: 90, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_depo" name="depo_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 90, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_hja_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['hja'])) ? $this->New_label['hja'] : "HJA"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_hja_cond" name="hja_cond" onChange="nm_campos_between(document.getElementById('id_vis_hja'), this, 'hja')">
       <OPTION value="gt" <?php if ("gt" == $hja_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $hja_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $hja_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_hja" <?php echo $str_hide_hja?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['hja'])) ? $this->New_label['hja'] : "HJA";
 $nmgp_tab_label .= "hja?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if ($_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
<?php
   if (is_file("Laporan_Stok_Persediaan_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['Laporan_Stok_Persediaan']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['Laporan_Stok_Persediaan']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.stok_cond.value = 'gt';
   ...
   document.F1.hja_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_hja'), document.F1.hja_cond, 'hja');
   document.F1.hja.value = "";
 }
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['where_orig']))
      {
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['where_orig'];
      }
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro($nmgp_save_origem)
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "Laporan_Stok_Persediaan/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_hja_cond'] = 'cond';
      $tp_fields['SC_hja'] = 'text';
      $tp_fields['SC_NM_operador'] = 'text';
      $tb_fields_esp['SC_nama item_cond'] = 'SC_sc_field_0_cond';
      $tb_fields_esp['SC_nama item'] = 'SC_sc_field_0';
      $tb_fields_esp['text_aut'] = 'id_ac_nama item';
      $tb_fields_esp['id_ac_nama item'] = 'id_ac_sc_field_0';
      if (is_file($NM_patch))
      {
          $SC_V8    = false;
   ...
   function trata_campos()
   {
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['campos_busca'] as $Cmps => $Vals)
          {
              $$Cmps = $Vals;
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['grid_pesq'] = array();
      ...
      $hja_cond_salva = $hja_cond; 
      if (!isset($hja_input_2) || $hja_input_2 == "")
      {
          $hja_input_2 = $hja;
      }
      if ($stok_cond != "in")
      {
          nm_limpa_numero($stok, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($hja_cond != "in")
      {
          nm_limpa_numero($hja, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['Grid_search']  = array(); 
      $I_Grid = 0;
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['campos_busca']['sc_field_0'] = $sc_field_0; 
      if (is_array($sc_field_0) && !empty($sc_field_0))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['Grid_search'][$I_Grid]['val'][0] = $sc_field_0;
      }
      ...
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['Grid_search'][$I_Grid]['val'][0][0] = $sc_field_0;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['campos_busca']['sc_field_0_cond'] = $sc_field_0_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['Grid_search'][$I_Grid]['cmp'] = "sc_field_0"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['Grid_search'][$I_Grid]['opc'] = $sc_field_0_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['grid_pesq']['sc_field_0'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['campos_busca']['stok'] = $stok; 
      if (is_array($stok) && !empty($stok))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['Grid_search'][$I_Grid]['val'][0] = $stok;
      }
      elseif ($stok_cond_salva == "nu" || $stok_cond_salva == "nn" || $stok_cond_salva == "ep" || $stok_cond_salva == "ne" || !empty($stok))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['Grid_search'][$I_Grid]['val'][0][0] = $stok;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['campos_busca']['stok_cond'] = $stok_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['Grid_search'][$I_Grid]['cmp'] = "stok"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['Grid_search'][$I_Grid]['opc'] = $stok_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['grid_pesq']['stok'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['campos_busca']['depo'] = $depo; 
      if (is_array($depo) && !empty($depo))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['Grid_search'][$I_Grid]['val'][0] = $depo;
      }
      elseif ($depo_cond_salva == "nu" || $depo_cond_salva == "nn" || $depo_cond_salva == "ep" || $depo_cond_salva == "ne" || !empty($depo))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['Grid_search'][$I_Grid]['val'][0][0] = $depo;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['campos_busca']['depo_cond'] = $depo_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['Grid_search'][$I_Grid]['cmp'] = "depo"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['Grid_search'][$I_Grid]['opc'] = $depo_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['grid_pesq']['depo'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['campos_busca']['hja'] = $hja; 
      if (is_array($hja) && !empty($hja))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['Grid_search'][$I_Grid]['val'][0] = $hja;
      }
      elseif ($hja_cond_salva == "nu" || $hja_cond_salva == "nn" || $hja_cond_salva == "ep" || $hja_cond_salva == "ne" || !empty($hja))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['Grid_search'][$I_Grid]['val'][0][0] = $hja;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['campos_busca']['hja_cond'] = $hja_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['Grid_search'][$I_Grid]['cmp'] = "hja"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['Grid_search'][$I_Grid]['opc'] = $hja_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['grid_pesq']['hja'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['campos_busca'] = $Temp_Busca;
      }
      if ($hja_cond != "in" && $hja_cond != "bw" && !empty($hja) && !is_numeric($hja))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : HJA";
      }
      if ($hja_cond == "bw" && ((!empty($hja) && !is_numeric($hja)) || (!empty($hja_input_2) && !is_numeric($hja_input_2)) ))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : HJA";
      }
      if (!empty($this->Campos_Mens_erro)) 
      ...
      $this->cmp_formatado['hja'] = $Conteudo;

      //----- $sc_field_0
      $this->Date_part = false;
      if (isset($sc_field_0) || $sc_field_0_cond == "nu" || $sc_field_0_cond == "nn" || $sc_field_0_cond == "ep" || $sc_field_0_cond == "ne")
      {
         $this->monta_condicao("b.namaItem", $sc_field_0_cond, $sc_field_0, "", "sc_field_0");
      }

      //----- $stok
      $this->Date_part = false;
      if (isset($stok) || $stok_cond == "nu" || $stok_cond == "nn" || $stok_cond == "ep" || $stok_cond == "ne")
      {
         $this->monta_condicao("a.currentStock", $stok_cond, $stok, "", "stok");
      }
      ...
      {
         $this->monta_condicao("c.namaDepo", $depo_cond, $depo, "", "depo");
      }

      //----- $hja
      $this->Date_part = false;
      if (isset($hja) || $hja_cond == "nu" || $hja_cond == "nn" || $hja_cond == "ep" || $hja_cond == "ne")
      {
         $this->monta_condicao("b.hargaJual", $hja_cond, $hja, "", "hja");
      }
   }
   ...
   function finaliza_resultado_ajax()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['where_pesq'] = $this->comando;
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['where_pesq_fast'])) 
       {
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['where_pesq'])) 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['where_pesq_fast'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['where_pesq'] = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['where_pesq_fast'] . ")";
           }
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['cond_dyn_search'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['Laporan_Stok_Persediaan']['cond_pesq'] .= $this->NM_operador;
