...
<?php
   ...
   $Ord_Cmp = new grid_tbradiologirate_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_tbradiologirate_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbradiologirate']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tbradiologirate']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["radcode"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbradiologirate']['labels']["radcode"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbradiologirate']['labels']["radcode"] : "Radcode";
   $tab_ger_campos['kelas'] = "on";
   $tab_def_campos['kelas'] = "kelas";
   $tab_labels["kelas"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbradiologirate']['labels']["kelas"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbradiologirate']['labels']["kelas"] : "Kelas";
   $tab_ger_campos['ratecon'] = "on";
   $tab_def_campos['ratecon'] = "ratecon";
   $tab_labels["ratecon"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbradiologirate']['labels']["ratecon"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbradiologirate']['labels']["ratecon"] : "Ratecon";
   $tab_ger_campos['ratenoncon'] = "on";
   $tab_def_campos['ratenoncon'] = "ratenoncon";
   $tab_labels["ratenoncon"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbradiologirate']['labels']["ratenoncon"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbradiologirate']['labels']["ratenoncon"] : "Ratenoncon";
   $tab_ger_campos['share'] = "on";
   $tab_def_campos['share'] = "share";
   $tab_labels["share"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbradiologirate']['labels']["share"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbradiologirate']['labels']["share"] : "Share";
   $tab_ger_campos['docsharecon'] = "on";
   $tab_def_campos['docsharecon'] = "docsharecon";
   $tab_labels["docsharecon"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbradiologirate']['labels']["docsharecon"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbradiologirate']['labels']["docsharecon"] : "Docsharecon";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_tbradiologirate']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_tbradiologirate']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_tbradiologirate']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbradiologirate']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tbradiologirate']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_tbradiologirate']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_tbradiologirate']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_tbradiologirate']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_tbradiologirate']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_tbradiologirate_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_tbradiologirate']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_tbradiologirate']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_tbradiologirate']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_tbradiologirate']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_tbradiologirate']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
