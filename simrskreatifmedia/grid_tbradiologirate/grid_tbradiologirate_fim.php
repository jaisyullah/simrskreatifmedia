...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_tbradiologirate"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_tbradiologirate"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_tbradiologirate'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tbradiologirate']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_tbradiologirate']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tbradiologirate']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_tbradiologirate']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_tbradiologirate']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_tbradiologirate</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_tbradiologirate']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_tbradiologirate']['embutida_filho'] as $ind => $sc_init)
          {
