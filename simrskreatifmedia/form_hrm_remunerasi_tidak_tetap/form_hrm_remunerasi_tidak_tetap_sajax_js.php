  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_hrm_remunerasi_tidak_tetap" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_hrm_remunerasi_tidak_tetap_form();
	}

  // ---------- Validate id
  function do_ajax_form_hrm_remunerasi_tidak_tetap_validate_id()
  {
    var nomeCampo_id = "id";
    var var_id = scAjaxGetFieldHidden(nomeCampo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_remunerasi_tidak_tetap_validate_id(var_id, var_script_case_init, do_ajax_form_hrm_remunerasi_tidak_tetap_validate_id_cb);
  } // do_ajax_form_hrm_remunerasi_tidak_tetap_validate_id

  function do_ajax_form_hrm_remunerasi_tidak_tetap_validate_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_remunerasi_tidak_tetap_validate_id_cb

  // ---------- Validate id_karyawan
  function do_ajax_form_hrm_remunerasi_tidak_tetap_validate_id_karyawan()
  {
    var nomeCampo_id_karyawan = "id_karyawan";
    var var_id_karyawan = scAjaxGetFieldSelect(nomeCampo_id_karyawan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_remunerasi_tidak_tetap_validate_id_karyawan(var_id_karyawan, var_script_case_init, do_ajax_form_hrm_remunerasi_tidak_tetap_validate_id_karyawan_cb);
  } // do_ajax_form_hrm_remunerasi_tidak_tetap_validate_id_karyawan

  function do_ajax_form_hrm_remunerasi_tidak_tetap_validate_id_karyawan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_remunerasi_tidak_tetap_validate_id_karyawan_cb

  // ---------- Validate tunj_masa_kerja
  function do_ajax_form_hrm_remunerasi_tidak_tetap_validate_tunj_masa_kerja()
  {
    var nomeCampo_tunj_masa_kerja = "tunj_masa_kerja";
    var var_tunj_masa_kerja = scAjaxGetFieldText(nomeCampo_tunj_masa_kerja);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_remunerasi_tidak_tetap_validate_tunj_masa_kerja(var_tunj_masa_kerja, var_script_case_init, do_ajax_form_hrm_remunerasi_tidak_tetap_validate_tunj_masa_kerja_cb);
  } // do_ajax_form_hrm_remunerasi_tidak_tetap_validate_tunj_masa_kerja

  function do_ajax_form_hrm_remunerasi_tidak_tetap_validate_tunj_masa_kerja_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_remunerasi_tidak_tetap_validate_tunj_masa_kerja_cb

  // ---------- Validate lembur
  function do_ajax_form_hrm_remunerasi_tidak_tetap_validate_lembur()
  {
    var nomeCampo_lembur = "lembur";
    var var_lembur = scAjaxGetFieldText(nomeCampo_lembur);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_remunerasi_tidak_tetap_validate_lembur(var_lembur, var_script_case_init, do_ajax_form_hrm_remunerasi_tidak_tetap_validate_lembur_cb);
  } // do_ajax_form_hrm_remunerasi_tidak_tetap_validate_lembur

  function do_ajax_form_hrm_remunerasi_tidak_tetap_validate_lembur_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "lembur";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_remunerasi_tidak_tetap_validate_lembur_cb

  // ---------- Validate insentif
  function do_ajax_form_hrm_remunerasi_tidak_tetap_validate_insentif()
  {
    var nomeCampo_insentif = "insentif";
    var var_insentif = scAjaxGetFieldText(nomeCampo_insentif);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_remunerasi_tidak_tetap_validate_insentif(var_insentif, var_script_case_init, do_ajax_form_hrm_remunerasi_tidak_tetap_validate_insentif_cb);
  } // do_ajax_form_hrm_remunerasi_tidak_tetap_validate_insentif

  function do_ajax_form_hrm_remunerasi_tidak_tetap_validate_insentif_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_remunerasi_tidak_tetap_validate_insentif_cb

  // ---------- Validate periode_remunerasi
  function do_ajax_form_hrm_remunerasi_tidak_tetap_validate_periode_remunerasi()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_remunerasi_tidak_tetap_validate_periode_remunerasi(var_periode_remunerasi, var_script_case_init, do_ajax_form_hrm_remunerasi_tidak_tetap_validate_periode_remunerasi_cb);
  } // do_ajax_form_hrm_remunerasi_tidak_tetap_validate_periode_remunerasi

  function do_ajax_form_hrm_remunerasi_tidak_tetap_validate_periode_remunerasi_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_remunerasi_tidak_tetap_validate_periode_remunerasi_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_hrm_remunerasi_tidak_tetap_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_hrm_remunerasi_tidak_tetap_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_hrm_remunerasi_tidak_tetap_submit_form(var_id, var_id_karyawan, var_tunj_masa_kerja, var_lembur, var_insentif, var_periode_remunerasi, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_hrm_remunerasi_tidak_tetap_submit_form_cb);
  } // do_ajax_form_hrm_remunerasi_tidak_tetap_submit_form

  function do_ajax_form_hrm_remunerasi_tidak_tetap_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_hrm_remunerasi_tidak_tetap_submit_form_cb_after_alert);
  } // do_ajax_form_hrm_remunerasi_tidak_tetap_submit_form_cb
  function do_ajax_form_hrm_remunerasi_tidak_tetap_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_hrm_remunerasi_tidak_tetap_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_hrm_remunerasi_tidak_tetap_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_hrm_remunerasi_tidak_tetap_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_hrm_remunerasi_tidak_tetap_navigate_form_cb);
  } // do_ajax_form_hrm_remunerasi_tidak_tetap_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_hrm_remunerasi_tidak_tetap']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_hrm_remunerasi_tidak_tetap_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_hrm_remunerasi_tidak_tetap_navigate_form_cb_after_alert);
  } // do_ajax_form_hrm_remunerasi_tidak_tetap_navigate_form_cb
  function do_ajax_form_hrm_remunerasi_tidak_tetap_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_hrm_remunerasi_tidak_tetap_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_hrm_remunerasi_tidak_tetap_navigate_form_cb_after_alert
  function sc_hide_form_hrm_remunerasi_tidak_tetap_form()
  {
