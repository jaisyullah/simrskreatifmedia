<?php
@session_start() ;
$_SESSION['scriptcase']['pdfreport_sticker_makan_batch']['sc_process_barr'] = true;
require_once('../pdfreport_sticker_makan_batch/index.php');
unset($_SESSION['scriptcase']['pdfreport_sticker_makan_batch']['sc_process_barr']);
$ExportCtrl = new pdfreport_sticker_makan_batch_export_control;
$ExportCtrl->Export_barr();

class pdfreport_sticker_makan_batch_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_chart_titl'] ?> - inventaris :: Excel</TITLE>
