...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_strukresep_cond" name="strukresep_cond" onChange="nm_campos_between(document.getElementById('id_vis_strukresep'), this, 'strukresep')">
      ...
      <br><span id="id_hide_strukresep"  <?php echo $str_hide_strukresep?>><?php
      if ($strukresep != "")
      {
      $strukresep_look = substr($this->Db->qstr($strukresep), 1, -1); 
      $nmgp_def_dados = array(); 
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      ...
      <br><span id="id_hide_nama"  <?php echo $str_hide_nama?>><INPUT  type="text" id="SC_nama" name="nama" value="<?php echo NM_encode_input($nama) ?>"  size=50 alt="{datatype: 'text', maxLength: 156, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
