<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tbresepranap']['sc_process_barr'] = true;
require_once('../grid_tbresepranap/index.php');
unset($_SESSION['scriptcase']['grid_tbresepranap']['sc_process_barr']);
$ExportCtrl = new grid_tbresepranap_export_control;
$ExportCtrl->Export_barr();

class grid_tbresepranap_export_control
{
