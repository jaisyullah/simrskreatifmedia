...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_trancode' + iSeqRow).bind('blur', function() { sc_form_tbdetailvkR_trancode_onblur(this, iSeqRow) })
                                      .bind('focus', function() { sc_form_tbdetailvkR_trancode_onfocus(this, iSeqRow) });
  $('#id_sc_field_custcode' + iSeqRow).bind('blur', function() { sc_form_tbdetailvkR_custcode_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_form_tbdetailvkR_custcode_onchange(this, iSeqRow) })
                                      .bind('focus', function() { sc_form_tbdetailvkR_custcode_onfocus(this, iSeqRow) });
  $('#id_sc_field_class' + iSeqRow).bind('blur', function() { sc_form_tbdetailvkR_class_onblur(this, iSeqRow) })
                                   .bind('focus', function() { sc_form_tbdetailvkR_class_onfocus(this, iSeqRow) });
  $('#id_sc_field_inapcode' + iSeqRow).bind('blur', function() { sc_form_tbdetailvkR_inapcode_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_form_tbdetailvkR_inapcode_onchange(this, iSeqRow) })
                                      .bind('focus', function() { sc_form_tbdetailvkR_inapcode_onfocus(this, iSeqRow) });
  $('#id_sc_field_nama' + iSeqRow).bind('blur', function() { sc_form_tbdetailvkR_nama_onblur(this, iSeqRow) })
                                  .bind('focus', function() { sc_form_tbdetailvkR_nama_onfocus(this, iSeqRow) });
  $('#id_sc_field_resepvk' + iSeqRow).bind('blur', function() { sc_form_tbdetailvkR_resepvk_onblur(this, iSeqRow) })
                                     .bind('focus', function() { sc_form_tbdetailvkR_resepvk_onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_form_tbdetailvkR_trancode_onblur(oThis, iSeqRow) {
  do_ajax_form_tbdetailvkR_mob_validate_trancode();
  scCssBlur(oThis);
}

function sc_form_tbdetailvkR_trancode_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_tbdetailvkR_custcode_onblur(oThis, iSeqRow) {
  do_ajax_form_tbdetailvkR_mob_validate_custcode();
  scCssBlur(oThis);
}

function sc_form_tbdetailvkR_custcode_onchange(oThis, iSeqRow) {
  do_ajax_form_tbdetailvkR_mob_refresh_custcode();
}

function sc_form_tbdetailvkR_custcode_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_tbdetailvkR_class_onblur(oThis, iSeqRow) {
  do_ajax_form_tbdetailvkR_mob_validate_class();
  scCssBlur(oThis);
}

function sc_form_tbdetailvkR_class_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_tbdetailvkR_inapcode_onblur(oThis, iSeqRow) {
  do_ajax_form_tbdetailvkR_mob_validate_inapcode();
  scCssBlur(oThis);
}

function sc_form_tbdetailvkR_inapcode_onchange(oThis, iSeqRow) {
  do_ajax_form_tbdetailvkR_mob_refresh_inapcode();
}

function sc_form_tbdetailvkR_inapcode_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_tbdetailvkR_nama_onblur(oThis, iSeqRow) {
  do_ajax_form_tbdetailvkR_mob_validate_nama();
  scCssBlur(oThis);
}

function sc_form_tbdetailvkR_nama_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_tbdetailvkR_resepvk_onblur(oThis, iSeqRow) {
  do_ajax_form_tbdetailvkR_mob_validate_resepvk();
  scCssBlur(oThis);
}

function sc_form_tbdetailvkR_resepvk_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function scHidePage(pageNo) {
	$("#id_form_tbdetailvkR_mob_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_birthdate" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_tbdetailvkR_mob_validate_birthdate(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_anestime" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_tbdetailvkR_mob_validate_anestime(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_intime" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_tbdetailvkR_mob_validate_intime(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_outtime" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_tbdetailvkR_mob_validate_outtime(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_trandate" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_tbdetailvkR_mob_validate_trandate(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_awalobs" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_tbdetailvkR_mob_validate_awalobs(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_akhirobs" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_tbdetailvkR_mob_validate_akhirobs(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
