  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbdetailvkR" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbdetailvkR_form();
	}

  // ---------- Validate inapcode
  function do_ajax_form_tbdetailvkR_validate_inapcode()
  {
    var nomeCampo_inapcode = "inapcode";
    var var_inapcode = scAjaxGetFieldText(nomeCampo_inapcode);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdetailvkR_validate_inapcode(var_inapcode, var_script_case_init, do_ajax_form_tbdetailvkR_validate_inapcode_cb);
  } // do_ajax_form_tbdetailvkR_validate_inapcode

  function do_ajax_form_tbdetailvkR_validate_inapcode_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdetailvkR_validate_inapcode_cb

  // ---------- Validate trancode
  function do_ajax_form_tbdetailvkR_validate_trancode()
  {
    var nomeCampo_trancode = "trancode";
    var var_trancode = scAjaxGetFieldText(nomeCampo_trancode);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdetailvkR_validate_trancode(var_trancode, var_script_case_init, do_ajax_form_tbdetailvkR_validate_trancode_cb);
  } // do_ajax_form_tbdetailvkR_validate_trancode

  function do_ajax_form_tbdetailvkR_validate_trancode_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdetailvkR_validate_trancode_cb

  // ---------- Validate custcode
  function do_ajax_form_tbdetailvkR_validate_custcode()
  {
    var nomeCampo_custcode = "custcode";
    var var_custcode = scAjaxGetFieldSelect(nomeCampo_custcode);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdetailvkR_validate_custcode(var_custcode, var_script_case_init, do_ajax_form_tbdetailvkR_validate_custcode_cb);
  } // do_ajax_form_tbdetailvkR_validate_custcode

  function do_ajax_form_tbdetailvkR_validate_custcode_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdetailvkR_validate_custcode_cb

  // ---------- Validate nama
  function do_ajax_form_tbdetailvkR_validate_nama()
  {
    var nomeCampo_nama = "nama";
    var var_nama = scAjaxGetFieldSelect(nomeCampo_nama);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdetailvkR_validate_nama(var_nama, var_script_case_init, do_ajax_form_tbdetailvkR_validate_nama_cb);
  } // do_ajax_form_tbdetailvkR_validate_nama

  function do_ajax_form_tbdetailvkR_validate_nama_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nama";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdetailvkR_validate_nama_cb

  // ---------- Validate class
  function do_ajax_form_tbdetailvkR_validate_class()
  {
    var nomeCampo_class = "class";
    var var_class = scAjaxGetFieldSelect(nomeCampo_class);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdetailvkR_validate_class(var_class, var_script_case_init, do_ajax_form_tbdetailvkR_validate_class_cb);
  } // do_ajax_form_tbdetailvkR_validate_class

  function do_ajax_form_tbdetailvkR_validate_class_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "class";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdetailvkR_validate_class_cb

  // ---------- Validate resepvk
  function do_ajax_form_tbdetailvkR_validate_resepvk()
  {
    var nomeCampo_resepvk = "resepvk";
    var var_resepvk = scAjaxGetFieldText(nomeCampo_resepvk);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdetailvkR_validate_resepvk(var_resepvk, var_script_case_init, do_ajax_form_tbdetailvkR_validate_resepvk_cb);
  } // do_ajax_form_tbdetailvkR_validate_resepvk

  function do_ajax_form_tbdetailvkR_validate_resepvk_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "resepvk";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdetailvkR_validate_resepvk_cb

  // ---------- Refresh inapcode
  function do_ajax_form_tbdetailvkR_refresh_inapcode()
  {
    var var_inapcode = scAjaxGetFieldText("inapcode");
    var var_nmgp_refresh_fields = "class_#fld#_custcode";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tbdetailvkR_refresh_inapcode(var_inapcode, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_tbdetailvkR_refresh_inapcode_cb);
  } // do_ajax_form_tbdetailvkR_refresh_inapcode

  function do_ajax_form_tbdetailvkR_refresh_inapcode_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetVariables();
    do_ajax_form_tbdetailvkR_refresh_custcode();
    scAjaxShowDebug();
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdetailvkR_refresh_inapcode_cb

  // ---------- Refresh custcode
  function do_ajax_form_tbdetailvkR_refresh_custcode()
  {
    var var_custcode = scAjaxGetFieldSelect("custcode");
    var var_nmgp_refresh_fields = "nama";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tbdetailvkR_refresh_custcode(var_custcode, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_tbdetailvkR_refresh_custcode_cb);
  } // do_ajax_form_tbdetailvkR_refresh_custcode

  function do_ajax_form_tbdetailvkR_refresh_custcode_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdetailvkR_refresh_custcode_cb

  // ---------- Event onclick babybirth
  function do_ajax_form_tbdetailvkR_event_babybirth_onclick()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tbdetailvkR_event_babybirth_onclick(var_lingkar, var_tb, var_bb, var_birthtime, var_birthdate, var_birthdate_hora, var_hidup, var_script_case_init, do_ajax_form_tbdetailvkR_event_babybirth_onclick_cb);
  } // do_ajax_form_tbdetailvkR_event_babybirth_onclick

  function do_ajax_form_tbdetailvkR_event_babybirth_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_tbdetailvkR_event_babybirth_onclick_cb_after_alert);
  } // do_ajax_form_tbdetailvkR_event_babybirth_onclick_cb
  function do_ajax_form_tbdetailvkR_event_babybirth_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_tbdetailvkR_event_babybirth_onclick_cb_after_alert

  // ---------- Event onclick observasi
  function do_ajax_form_tbdetailvkR_event_observasi_onclick()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tbdetailvkR_event_observasi_onclick(var_tindobservasi, var_akhirobs, var_akhirobs_hora, var_awalobs, var_awalobs_hora, var_script_case_init, do_ajax_form_tbdetailvkR_event_observasi_onclick_cb);
  } // do_ajax_form_tbdetailvkR_event_observasi_onclick

  function do_ajax_form_tbdetailvkR_event_observasi_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_tbdetailvkR_event_observasi_onclick_cb_after_alert);
  } // do_ajax_form_tbdetailvkR_event_observasi_onclick_cb
  function do_ajax_form_tbdetailvkR_event_observasi_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_tbdetailvkR_event_observasi_onclick_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tbdetailvkR_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tbdetailvkR_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_inapcode = scAjaxGetFieldText("inapcode");
    ...
    scAjaxProcOn();
    x_ajax_form_tbdetailvkR_submit_form(var_inapcode, var_trancode, var_custcode, var_nama, var_class, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbdetailvkR_submit_form_cb);
  } // do_ajax_form_tbdetailvkR_submit_form

  function do_ajax_form_tbdetailvkR_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tbdetailvkR_submit_form_cb_after_alert);
  } // do_ajax_form_tbdetailvkR_submit_form_cb
  function do_ajax_form_tbdetailvkR_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbdetailvkR_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_tbdetailresepokvkR"] = "off";

  function do_ajax_form_tbdetailvkR_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    x_ajax_form_tbdetailvkR_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbdetailvkR_navigate_form_cb);
  } // do_ajax_form_tbdetailvkR_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailvkR']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbdetailvkR_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbdetailvkR_navigate_form_cb_after_alert);
  } // do_ajax_form_tbdetailvkR_navigate_form_cb
  function do_ajax_form_tbdetailvkR_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_tbdetailvkR_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_tbdetailvkR_navigate_form_cb_after_alert
  function sc_hide_form_tbdetailvkR_form()
  {
