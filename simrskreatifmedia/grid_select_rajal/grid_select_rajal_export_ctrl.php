<?php
@session_start() ;
$_SESSION['scriptcase']['grid_select_rajal']['sc_process_barr'] = true;
require_once('../grid_select_rajal/index.php');
unset($_SESSION['scriptcase']['grid_select_rajal']['sc_process_barr']);
$ExportCtrl = new grid_select_rajal_export_control;
$ExportCtrl->Export_barr();

class grid_select_rajal_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - Antrian :: Excel</TITLE>
