...
<?php
   ...
   $Ord_Cmp = new grid_select_rajal_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_select_rajal_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_select_rajal']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_select_rajal']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["custcode"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_select_rajal']['labels']["custcode"])) ? $_SESSION['sc_session'][$sc_init]['grid_select_rajal']['labels']["custcode"] : "No. RM";
...
ORDER BY name, salut";
   ...
   $tab_labels["nama"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_select_rajal']['labels']["nama"])) ? $_SESSION['sc_session'][$sc_init]['grid_select_rajal']['labels']["nama"] : "Nama";
   $tab_ger_campos['doctor'] = "on";
   $tab_def_campos['doctor'] = "doctor";
   $tab_labels["doctor"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_select_rajal']['labels']["doctor"])) ? $_SESSION['sc_session'][$sc_init]['grid_select_rajal']['labels']["doctor"] : "Dokter";
   $tab_ger_campos['queue'] = "on";
   $tab_def_campos['queue'] = "queue";
   $tab_labels["queue"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_select_rajal']['labels']["queue"])) ? $_SESSION['sc_session'][$sc_init]['grid_select_rajal']['labels']["queue"] : "No. Antrian";
   $tab_ger_campos['struckno'] = "on";
   $tab_def_campos['struckno'] = "struckNo";
   $tab_labels["struckno"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_select_rajal']['labels']["struckno"])) ? $_SESSION['sc_session'][$sc_init]['grid_select_rajal']['labels']["struckno"] : "No. Struk";
   ...
   {
       $tab_def_campos['sc_field_0'] = "concat(date(regDate),' ',regTime)";
   }
   $tab_labels["sc_field_0"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_select_rajal']['labels']["sc_field_0"])) ? $_SESSION['sc_session'][$sc_init]['grid_select_rajal']['labels']["sc_field_0"] : "Waktu Daftar";
   $tab_ger_campos['bayar'] = "on";
   $tab_def_campos['bayar'] = "bayar";
   $tab_labels["bayar"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_select_rajal']['labels']["bayar"])) ? $_SESSION['sc_session'][$sc_init]['grid_select_rajal']['labels']["bayar"] : "Bayar";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_select_rajal']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_select_rajal']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_select_rajal']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_select_rajal']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_select_rajal']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_select_rajal']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_select_rajal']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_select_rajal']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_select_rajal']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_select_rajal_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_select_rajal']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_select_rajal']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_select_rajal']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_select_rajal']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_select_rajal']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
