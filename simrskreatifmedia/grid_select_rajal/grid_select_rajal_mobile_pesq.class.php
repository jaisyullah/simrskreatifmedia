...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "queue";$Nm_numeric[] = "struckno";$Nm_numeric[] = "queue";$Nm_numeric[] = "struckno";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_queue_cond" name="queue_cond" onChange="nm_campos_between(document.getElementById('id_vis_queue'), this, 'queue')">
      ...
      <br><span id="id_hide_queue"  <?php echo $str_hide_queue?>><?php
      if ($queue != "")
      {
      $queue_look = substr($this->Db->qstr($queue), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_struckno_cond" name="struckno_cond" onChange="nm_campos_between(document.getElementById('id_vis_struckno'), this, 'struckno')">
      ...
      <br><span id="id_hide_struckno"  <?php echo $str_hide_struckno?>><?php
      if ($struckno != "")
      {
      $struckno_look = substr($this->Db->qstr($struckno), 1, -1); 
      $nmgp_def_dados = array(); 
