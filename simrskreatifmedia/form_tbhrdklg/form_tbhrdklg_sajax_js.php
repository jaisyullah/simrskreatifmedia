  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbhrdklg" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbhrdklg_form();
	}

  // ---------- Validate hub_
  function do_ajax_form_tbhrdklg_validate_hub_(iNumLinha)
  {
    var nomeCampo_hub_ = "hub_" + iNumLinha;
    var var_hub_ = scAjaxGetFieldSelect(nomeCampo_hub_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbhrdklg_validate_hub_(var_hub_, iNumLinha, var_script_case_init, do_ajax_form_tbhrdklg_validate_hub__cb);
  } // do_ajax_form_tbhrdklg_validate_hub_

  function do_ajax_form_tbhrdklg_validate_hub__cb(sResp)
  {
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "hub_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "hub_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbhrdklg_validate_hub__cb

  // ---------- Validate tgllahir_
  function do_ajax_form_tbhrdklg_validate_tgllahir_(iNumLinha)
  {
    var nomeCampo_tgllahir_ = "tgllahir_" + iNumLinha;
    var var_tgllahir_ = scAjaxGetFieldText(nomeCampo_tgllahir_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbhrdklg_validate_tgllahir_(var_tgllahir_, iNumLinha, var_script_case_init, do_ajax_form_tbhrdklg_validate_tgllahir__cb);
  } // do_ajax_form_tbhrdklg_validate_tgllahir_

  function do_ajax_form_tbhrdklg_validate_tgllahir__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "tgllahir_" + iLineNumber;
    }
    else
    {
      sFieldValid = "tgllahir_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "tgllahir_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "tgllahir_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbhrdklg_validate_tgllahir__cb

  // ---------- Validate pendidikan_
  function do_ajax_form_tbhrdklg_validate_pendidikan_(iNumLinha)
  {
    var nomeCampo_pendidikan_ = "pendidikan_" + iNumLinha;
    var var_pendidikan_ = scAjaxGetFieldText(nomeCampo_pendidikan_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbhrdklg_validate_pendidikan_(var_pendidikan_, iNumLinha, var_script_case_init, do_ajax_form_tbhrdklg_validate_pendidikan__cb);
  } // do_ajax_form_tbhrdklg_validate_pendidikan_

  function do_ajax_form_tbhrdklg_validate_pendidikan__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "pendidikan_" + iLineNumber;
    }
    else
    {
      sFieldValid = "pendidikan_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "pendidikan_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "pendidikan_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbhrdklg_validate_pendidikan__cb

  // ---------- Validate pekerjaan_
  function do_ajax_form_tbhrdklg_validate_pekerjaan_(iNumLinha)
  {
    var nomeCampo_pekerjaan_ = "pekerjaan_" + iNumLinha;
    var var_pekerjaan_ = scAjaxGetFieldText(nomeCampo_pekerjaan_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbhrdklg_validate_pekerjaan_(var_pekerjaan_, iNumLinha, var_script_case_init, do_ajax_form_tbhrdklg_validate_pekerjaan__cb);
  } // do_ajax_form_tbhrdklg_validate_pekerjaan_

  function do_ajax_form_tbhrdklg_validate_pekerjaan__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "pekerjaan_" + iLineNumber;
    }
    else
    {
      sFieldValid = "pekerjaan_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "pekerjaan_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "pekerjaan_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbhrdklg_validate_pekerjaan__cb

  // ---------- Validate id_
  function do_ajax_form_tbhrdklg_validate_id_(iNumLinha)
  {
    var nomeCampo_id_ = "id_" + iNumLinha;
    var var_id_ = scAjaxGetFieldText(nomeCampo_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbhrdklg_validate_id_(var_id_, iNumLinha, var_script_case_init, do_ajax_form_tbhrdklg_validate_id__cb);
  } // do_ajax_form_tbhrdklg_validate_id_

  function do_ajax_form_tbhrdklg_validate_id__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbhrdklg_validate_id__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_tbhrdklg_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_tbhrdklg_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tbhrdklg_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_tbhrdklg_add_new_line_cb);
  } // do_ajax_form_tbhrdklg_add_new_line

  function do_ajax_form_tbhrdklg_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_tbhrdklg_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_tbhrdklg_backup_line(iNumLinha)
  {
    var var_id_ = scAjaxGetFieldText("id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbhrdklg_backup_line(var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_tbhrdklg_backup_line_cb);
  } // do_ajax_form_tbhrdklg_backup_line

  function do_ajax_form_tbhrdklg_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_tbhrdklg_backup_line_cb

  function do_ajax_form_tbhrdklg_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_tbhrdklg_cancel_insert

  function do_ajax_form_tbhrdklg_cancel_update(iSeqVert)
  {
    do_ajax_form_tbhrdklg_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_tbhrdklg_cancel_update

  function do_ajax_form_tbhrdklg_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_tbhrdklg_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_tbhrdklg_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_tbhrdklg_table_refresh(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbhrdklg_table_refresh_cb);
  } //  do_ajax_form_tbhrdklg_table_refresh

  function do_ajax_form_tbhrdklg_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_tbhrdklg_table_refresh_cb_after_alert);
  } // do_ajax_form_tbhrdklg_table_refresh_cb
  function do_ajax_form_tbhrdklg_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxSetNavStatus("t");
    sc_insert_open = false;
  } // do_ajax_form_tbhrdklg_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_tbhrdklg_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_tbhrdklg_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    sc_num_ult_line = iNumLinha;
    sc_num_ult_tr   = indexTR;
    scAjaxHideMessage();
    var var_hub_ = scAjaxGetFieldSelect("hub_" + iNumLinha);
    var var_tgllahir_ = scAjaxGetFieldText("tgllahir_" + iNumLinha);
    var var_pendidikan_ = scAjaxGetFieldText("pendidikan_" + iNumLinha);
    var var_pekerjaan_ = scAjaxGetFieldText("pekerjaan_" + iNumLinha);
    var var_id_ = scAjaxGetFieldText("id_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_tbhrdklg_submit_form(var_hub_, var_tgllahir_, var_pendidikan_, var_pekerjaan_, var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbhrdklg_submit_form_cb);
  } // do_ajax_form_tbhrdklg_submit_form

  function do_ajax_form_tbhrdklg_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("hub_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("tgllahir_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("pendidikan_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("pekerjaan_" + sc_num_ult_line);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_tbhrdklg_submit_form_cb_after_alert);
  } // do_ajax_form_tbhrdklg_submit_form_cb
  function do_ajax_form_tbhrdklg_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbhrdklg_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tbhrdklg_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_tbhrdklg_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("hub_" + iNavForm);
      scAjaxHideErrorDisplay("tgllahir_" + iNavForm);
      scAjaxHideErrorDisplay("pendidikan_" + iNavForm);
      scAjaxHideErrorDisplay("pekerjaan_" + iNavForm);
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tbhrdklg_navigate_form(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbhrdklg_navigate_form_cb);
  } // do_ajax_form_tbhrdklg_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrdklg']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbhrdklg_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbhrdklg_navigate_form_cb_after_alert);
  } // do_ajax_form_tbhrdklg_navigate_form_cb
  function do_ajax_form_tbhrdklg_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_tbhrdklg_navigate_form_cb_after_alert
  function sc_hide_form_tbhrdklg_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "hub_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "tgllahir_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "pendidikan_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "pekerjaan_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "id_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["hub_" + iNumLinha] = {"label": "Hubungan<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["tgllahir_" + iNumLinha] = {"label": "Tgl Lahir<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["pendidikan_" + iNumLinha] = {"label": "Pendidikan<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["pekerjaan_" + iNumLinha] = {"label": "Pekerjaan<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_field_mult["hub_"][iNumLinha] = "hub_" + iNumLinha;
    ajax_field_mult["tgllahir_"][iNumLinha] = "tgllahir_" + iNumLinha;
    ajax_field_mult["pendidikan_"][iNumLinha] = "pendidikan_" + iNumLinha;
    ajax_field_mult["pekerjaan_"][iNumLinha] = "pekerjaan_" + iNumLinha;
    ajax_field_mult["id_"][iNumLinha] = "id_" + iNumLinha;
    ajax_field_id["hub_" + iNumLinha] = new Array("hidden_field_label_hub_", "hidden_field_data_hub_" + iNumLinha);
    ajax_field_id["tgllahir_" + iNumLinha] = new Array("hidden_field_label_tgllahir_", "hidden_field_data_tgllahir_" + iNumLinha);
    ajax_field_id["pendidikan_" + iNumLinha] = new Array("hidden_field_label_pendidikan_", "hidden_field_data_pendidikan_" + iNumLinha);
    ajax_field_id["pekerjaan_" + iNumLinha] = new Array("hidden_field_label_pekerjaan_", "hidden_field_data_pekerjaan_" + iNumLinha);
    ajax_error_count["hub_" + iNumLinha] = "off";
    ajax_error_count["tgllahir_" + iNumLinha] = "off";
    ajax_error_count["pendidikan_" + iNumLinha] = "off";
    ajax_error_count["pekerjaan_" + iNumLinha] = "off";
    ajax_error_count["id_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["hub_" + iNumLinha] = "off";
    ajax_read_only["tgllahir_" + iNumLinha] = "off";
    ajax_read_only["pendidikan_" + iNumLinha] = "off";
    ajax_read_only["pekerjaan_" + iNumLinha] = "off";
...
{
?>
    ajax_read_only["hub_" + iNumLinha] = "on";
    ajax_read_only["tgllahir_" + iNumLinha] = "on";
    ajax_read_only["pendidikan_" + iNumLinha] = "on";
    ajax_read_only["pekerjaan_" + iNumLinha] = "on";
    ajax_read_only["id_" + iNumLinha] = "on";
<?php
}
?>
  ...
  {
    ajax_error_list["hub_" + iNumLinha] = null;
    ajax_error_list["tgllahir_" + iNumLinha] = null;
    ajax_error_list["pendidikan_" + iNumLinha] = null;
    ajax_error_list["pekerjaan_" + iNumLinha] = null;
  ...
  var ajax_field_mult = {
    "hub_": new Array(),
    "tgllahir_": new Array(),
    "pendidikan_": new Array(),
    "pekerjaan_": new Array(),
    "id_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["hub_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["hub_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["hub_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["hub_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["hub_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["tgllahir_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["tgllahir_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["tgllahir_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["tgllahir_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["tgllahir_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["pendidikan_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["pendidikan_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["pendidikan_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["pendidikan_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["pendidikan_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["pekerjaan_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["pekerjaan_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["pekerjaan_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["pekerjaan_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["pekerjaan_" + iNumLinha]["onfocus"] = new Array();
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['hub_'])) ? $this->nmgp_cmp_readonly['hub_'] : 'off';
?>
    scAjaxFieldRead("hub_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['tgllahir_'])) ? $this->nmgp_cmp_readonly['tgllahir_'] : 'off';
?>
    scAjaxFieldRead("tgllahir_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['pendidikan_'])) ? $this->nmgp_cmp_readonly['pendidikan_'] : 'off';
?>
    scAjaxFieldRead("pendidikan_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['pekerjaan_'])) ? $this->nmgp_cmp_readonly['pekerjaan_'] : 'off';
?>
    scAjaxFieldRead("pekerjaan_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
?>
  ...
  {
    scAjaxFieldRead("hub_" + iSeq, "on");
    scAjaxFieldRead("tgllahir_" + iSeq, "on");
    scAjaxFieldRead("pendidikan_" + iSeq, "on");
    scAjaxFieldRead("pekerjaan_" + iSeq, "on");
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["hub_" + iRow] || "on" == ajax_error_count["tgllahir_" + iRow] || "on" == ajax_error_count["pendidikan_" + iRow] || "on" == ajax_error_count["pekerjaan_" + iRow] || "on" == ajax_error_count["id_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_hub_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_tgllahir_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_pendidikan_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_pekerjaan_" + iRow).addClass("scFormErrorLine");
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["hub_" + iRow] && "off" == ajax_error_count["tgllahir_" + iRow] && "off" == ajax_error_count["pendidikan_" + iRow] && "off" == ajax_error_count["pekerjaan_" + iRow] && "off" == ajax_error_count["id_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["hub_" + iRow] = "off";
        ajax_error_count["tgllahir_" + iRow] = "off";
        ajax_error_count["pendidikan_" + iRow] = "off";
        ajax_error_count["pekerjaan_" + iRow] = "off";
      ...
      $("#hidden_field_data_hub_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_tgllahir_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_pendidikan_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_pekerjaan_" + iRow).removeClass("scFormErrorLine");
