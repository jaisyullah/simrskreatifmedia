<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tbnpo']['sc_process_barr'] = true;
require_once('../grid_tbnpo/index.php');
unset($_SESSION['scriptcase']['grid_tbnpo']['sc_process_barr']);
$ExportCtrl = new grid_tbnpo_export_control;
$ExportCtrl->Export_barr();

class grid_tbnpo_export_control
{
