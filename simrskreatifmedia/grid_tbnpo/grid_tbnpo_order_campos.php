...
<?php
   ...
   $Ord_Cmp = new grid_tbnpo_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_tbnpo_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbnpo']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tbnpo']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['npocode'] = "npoCode";
   $tab_labels["npocode"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbnpo']['labels']["npocode"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbnpo']['labels']["npocode"] : "Kode PO External";
   $tab_ger_campos['alasan'] = "on";
   $tab_def_campos['alasan'] = "alasan";
   $tab_labels["alasan"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbnpo']['labels']["alasan"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbnpo']['labels']["alasan"] : "Alasan PO External";
   $tab_ger_campos['pj'] = "on";
   $tab_def_campos['pj'] = "pj";
   $tab_labels["pj"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbnpo']['labels']["pj"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbnpo']['labels']["pj"] : "Penanggun Jawab";
   $tab_ger_campos['npodate'] = "on";
   $tab_def_campos['npodate'] = "npoDate";
   $tab_labels["npodate"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbnpo']['labels']["npodate"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbnpo']['labels']["npodate"] : "Tgl. PO";
   $tab_ger_campos['selesai'] = "on";
   $tab_def_campos['selesai'] = "selesai";
   $tab_labels["selesai"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbnpo']['labels']["selesai"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbnpo']['labels']["selesai"] : "Selesai";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_tbnpo']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_tbnpo']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_tbnpo']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbnpo']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tbnpo']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_tbnpo']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_tbnpo']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_tbnpo']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_tbnpo']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_tbnpo_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_tbnpo']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_tbnpo']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_tbnpo']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_tbnpo']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_tbnpo']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
