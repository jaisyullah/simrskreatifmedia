...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "npoDate";$Nm_datas[] = "npoDate";$Nm_numeric[] = "id";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_pj_cond" name="pj_cond" onChange="nm_campos_between(document.getElementById('id_vis_pj'), this, 'pj')">
      ...
      <br><span id="id_hide_pj"  <?php echo $str_hide_pj?>><?php
      if ($pj != "")
      {
      $pj_look = substr($this->Db->qstr($pj), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_npocode_cond" name="npocode_cond" onChange="nm_campos_between(document.getElementById('id_vis_npocode'), this, 'npocode')">
      ...
      <br><span id="id_hide_npocode"  <?php echo $str_hide_npocode?>><?php
      if ($npocode != "")
      {
      $npocode_look = substr($this->Db->qstr($npocode), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_alasan_cond" name="alasan_cond" onChange="nm_campos_between(document.getElementById('id_vis_alasan'), this, 'alasan')">
      ...
      <br><span id="id_hide_alasan"  <?php echo $str_hide_alasan?>><?php
      if ($alasan != "")
      {
      $alasan_look = substr($this->Db->qstr($alasan), 1, -1); 
      $nmgp_def_dados = array(); 
