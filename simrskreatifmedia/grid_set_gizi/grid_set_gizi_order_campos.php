...
<?php
   ...
   $Ord_Cmp = new grid_set_gizi_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_set_gizi_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_set_gizi']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_set_gizi']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['gizi'] = "gizi";
   $tab_labels["gizi"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_set_gizi']['labels']["gizi"])) ? $_SESSION['sc_session'][$sc_init]['grid_set_gizi']['labels']["gizi"] : "Gizi";
   $tab_ger_campos['jadwal'] = "on";
   $tab_def_campos['jadwal'] = "jadwal";
   $tab_labels["jadwal"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_set_gizi']['labels']["jadwal"])) ? $_SESSION['sc_session'][$sc_init]['grid_set_gizi']['labels']["jadwal"] : "Jadwal";
   $tab_ger_campos['mp'] = "on";
   $tab_def_campos['mp'] = "mp";
   $tab_labels["mp"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_set_gizi']['labels']["mp"])) ? $_SESSION['sc_session'][$sc_init]['grid_set_gizi']['labels']["mp"] : "MP";
   $tab_ger_campos['ln'] = "on";
   $tab_def_campos['ln'] = "ln";
   $tab_labels["ln"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_set_gizi']['labels']["ln"])) ? $_SESSION['sc_session'][$sc_init]['grid_set_gizi']['labels']["ln"] : "LN";
   $tab_ger_campos['lh'] = "on";
   $tab_def_campos['lh'] = "lh";
   $tab_labels["lh"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_set_gizi']['labels']["lh"])) ? $_SESSION['sc_session'][$sc_init]['grid_set_gizi']['labels']["lh"] : "LH";
   $tab_ger_campos['syr'] = "on";
   $tab_def_campos['syr'] = "syr";
   $tab_labels["syr"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_set_gizi']['labels']["syr"])) ? $_SESSION['sc_session'][$sc_init]['grid_set_gizi']['labels']["syr"] : "Syr";
   $tab_ger_campos['ekstra'] = "on";
   $tab_def_campos['ekstra'] = "ekstra";
   $tab_labels["ekstra"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_set_gizi']['labels']["ekstra"])) ? $_SESSION['sc_session'][$sc_init]['grid_set_gizi']['labels']["ekstra"] : "Ekstra";
   $tab_ger_campos['buah'] = "on";
   $tab_def_campos['buah'] = "buah";
   $tab_labels["buah"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_set_gizi']['labels']["buah"])) ? $_SESSION['sc_session'][$sc_init]['grid_set_gizi']['labels']["buah"] : "Buah";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_set_gizi']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_set_gizi']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_set_gizi']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_set_gizi']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_set_gizi']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_set_gizi']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_set_gizi']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_set_gizi']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_set_gizi']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_set_gizi_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_set_gizi']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_set_gizi']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_set_gizi']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_set_gizi']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_set_gizi']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
