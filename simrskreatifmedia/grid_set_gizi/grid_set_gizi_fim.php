...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_set_gizi"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_set_gizi"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_set_gizi'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_set_gizi']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_set_gizi']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_set_gizi']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_set_gizi']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_set_gizi']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_set_gizi']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_set_gizi']['embutida_filho'] as $ind => $sc_init)
          {
