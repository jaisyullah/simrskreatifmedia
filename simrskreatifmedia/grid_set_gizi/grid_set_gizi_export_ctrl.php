<?php
@session_start() ;
$_SESSION['scriptcase']['grid_set_gizi']['sc_process_barr'] = true;
require_once('../grid_set_gizi/index.php');
unset($_SESSION['scriptcase']['grid_set_gizi']['sc_process_barr']);
$ExportCtrl = new grid_set_gizi_export_control;
$ExportCtrl->Export_barr();

class grid_set_gizi_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_title'] ?> set_gizi :: Excel</TITLE>
