...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_ln_cond" name="ln_cond" onChange="nm_campos_between(document.getElementById('id_vis_ln'), this, 'ln')">
      ...
      <br><span id="id_hide_ln"  <?php echo $str_hide_ln?>><?php
      if ($ln != "")
      {
      $ln_look = substr($this->Db->qstr($ln), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_gizi_cond" name="gizi_cond" onChange="nm_campos_between(document.getElementById('id_vis_gizi'), this, 'gizi')">
      ...
      <br><span id="id_hide_gizi"  <?php echo $str_hide_gizi?>><?php
      if ($gizi != "")
      {
      $gizi_look = substr($this->Db->qstr($gizi), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_mp_cond" name="mp_cond" onChange="nm_campos_between(document.getElementById('id_vis_mp'), this, 'mp')">
      ...
      <br><span id="id_hide_mp"  <?php echo $str_hide_mp?>><?php
      if ($mp != "")
      {
      $mp_look = substr($this->Db->qstr($mp), 1, -1); 
      $nmgp_def_dados = array(); 
