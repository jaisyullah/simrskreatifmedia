...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_dokter_cond" name="dokter_cond" onChange="nm_campos_between(document.getElementById('id_vis_dokter'), this, 'dokter')">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_tglmasuk_cond" name="tglmasuk_cond" onChange="nm_campos_between(document.getElementById('id_vis_tglmasuk'), this, 'tglmasuk')">
      ...
      <br><span id="id_hide_tglmasuk"  <?php echo $str_hide_tglmasuk?>>
<?php
...
?>
 ...
 <?php echo $date_format_show ?>         </SPAN>
                  <br />
        <SPAN id="id_vis_tglmasuk"  <?php echo $str_display_tglmasuk; ?> class="scFilterFieldFontEven">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_poli_cond" name="poli_cond" onChange="nm_campos_between(document.getElementById('id_vis_poli'), this, 'poli')">
      ...
      <br><span id="id_hide_poli"  <?php echo $str_hide_poli?>><?php
      if ($poli != "")
      {
      $poli_look = substr($this->Db->qstr($poli), 1, -1); 
      $nmgp_def_dados = array(); 
