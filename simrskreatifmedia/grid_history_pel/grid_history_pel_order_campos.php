...
<?php
   ...
   $Ord_Cmp = new grid_history_pel_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_history_pel_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_history_pel']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_history_pel']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["tglmasuk"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_history_pel']['labels']["tglmasuk"])) ? $_SESSION['sc_session'][$sc_init]['grid_history_pel']['labels']["tglmasuk"] : "Tgl Masuk";
   $tab_ger_campos['trancode'] = "on";
   $tab_def_campos['trancode'] = "tranCode";
   $tab_labels["trancode"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_history_pel']['labels']["trancode"])) ? $_SESSION['sc_session'][$sc_init]['grid_history_pel']['labels']["trancode"] : "Tran Code";
   $tab_ger_campos['poli'] = "on";
   $tab_def_campos['poli'] = "poli";
   $tab_labels["poli"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_history_pel']['labels']["poli"])) ? $_SESSION['sc_session'][$sc_init]['grid_history_pel']['labels']["poli"] : "Poli";
   $tab_ger_campos['dokter'] = "on";
   $tab_def_campos['dokter'] = "dokter";
   $tab_labels["dokter"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_history_pel']['labels']["dokter"])) ? $_SESSION['sc_session'][$sc_init]['grid_history_pel']['labels']["dokter"] : "Dokter";
   $tab_ger_campos['carakeluar'] = "on";
   $tab_def_campos['carakeluar'] = "caraKeluar";
   $tab_labels["carakeluar"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_history_pel']['labels']["carakeluar"])) ? $_SESSION['sc_session'][$sc_init]['grid_history_pel']['labels']["carakeluar"] : "Cara Keluar";
   $tab_ger_campos['rm'] = "on";
   $tab_def_campos['rm'] = "RM";
   $tab_labels["rm"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_history_pel']['labels']["rm"])) ? $_SESSION['sc_session'][$sc_init]['grid_history_pel']['labels']["rm"] : "RM";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_history_pel']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_history_pel']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_history_pel']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_history_pel']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_history_pel']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_history_pel']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_history_pel']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_history_pel']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_history_pel']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_history_pel_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_history_pel']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_history_pel']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_history_pel']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_history_pel']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_history_pel']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
