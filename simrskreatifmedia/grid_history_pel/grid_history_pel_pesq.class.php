...
class grid_history_pel_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['path_libs_php'] = $this->Ini->path_lib_php;
      ...
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search_change_fil")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['campos_busca'] = array(); 
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_history_pel_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_history_pel_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_history_pel_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "tglMasuk";$Nm_datas[] = "tglMasuk";
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_history_pel/grid_history_pel_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_history_pel_ajax_search.js"></script>
 <script type="text/javascript" src="grid_history_pel_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_history_pel_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_history_pel']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_history_pel']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<?php
   ...
   function monta_form()
   {
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          $dokter = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['campos_busca']['dokter']; 
          $dokter_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['campos_busca']['dokter_cond']; 
          $tglmasuk_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['campos_busca']['tglmasuk_dia']; 
          $tglmasuk_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['campos_busca']['tglmasuk_mes']; 
          $tglmasuk_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['campos_busca']['tglmasuk_ano']; 
          $tglmasuk_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['campos_busca']['tglmasuk_input_2_dia']; 
          $tglmasuk_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['campos_busca']['tglmasuk_input_2_mes']; 
          $tglmasuk_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['campos_busca']['tglmasuk_input_2_ano']; 
          $tglmasuk_hor = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['campos_busca']['tglmasuk_hor']; 
          $tglmasuk_min = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['campos_busca']['tglmasuk_min']; 
          $tglmasuk_seg = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['campos_busca']['tglmasuk_seg']; 
          $tglmasuk_input_2_hor = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['campos_busca']['tglmasuk_input_2_hor']; 
          $tglmasuk_input_2_min = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['campos_busca']['tglmasuk_input_2_min']; 
          $tglmasuk_input_2_seg = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['campos_busca']['tglmasuk_input_2_seg']; 
          $tglmasuk_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['campos_busca']['tglmasuk_cond']; 
          $trancode = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['campos_busca']['trancode']; 
          $trancode_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['campos_busca']['trancode_cond']; 
          $poli = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['campos_busca']['poli']; 
          $poli_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['campos_busca']['poli_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['campos_busca']['NM_operador']; 
      } 
  ...
  <TD width="100%" height="">
   ...
   <tr>
     ...
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_dokter_cond" name="dokter_cond" onChange="nm_campos_between(document.getElementById('id_vis_dokter'), this, 'dokter')">
...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_dokter" name="dokter_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 75, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_tglmasuk_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['tglmasuk'])) ? $this->New_label['tglmasuk'] : "Tgl Masuk"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_tglmasuk_cond" name="tglmasuk_cond" onChange="nm_campos_between(document.getElementById('id_vis_tglmasuk'), this, 'tglmasuk')">
...
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_tglmasuk_dia" name="tglmasuk_dia" value="<?php echo NM_encode_input($tglmasuk_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_tglmasuk_mes" name="tglmasuk_mes" value="<?php echo NM_encode_input($tglmasuk_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_tglmasuk_ano" name="tglmasuk_ano" value="<?php echo NM_encode_input($tglmasuk_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 </span>
...
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_tglmasuk_hor" name="tglmasuk_hor" value="<?php echo NM_encode_input($tglmasuk_hor); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_tglmasuk_min" name="tglmasuk_min" value="<?php echo NM_encode_input($tglmasuk_min); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_tglmasuk_seg" name="tglmasuk_seg" value="<?php echo NM_encode_input($tglmasuk_seg); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
?>
        <SPAN id="id_css_tglmasuk"  class="scFilterFieldFontEven">
 <?php echo $date_format_show ?>         </SPAN>
                 </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_tglmasuk"  <?php echo $str_display_tglmasuk; ?> class="scFilterFieldFontEven">
...
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_tglmasuk_input_2_dia" name="tglmasuk_input_2_dia" value="<?php echo NM_encode_input($tglmasuk_input_2_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_tglmasuk_input_2_mes" name="tglmasuk_input_2_mes" value="<?php echo NM_encode_input($tglmasuk_input_2_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_tglmasuk_input_2_ano" name="tglmasuk_input_2_ano" value="<?php echo NM_encode_input($tglmasuk_input_2_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 </span>
...
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_tglmasuk_input_2_hor" name="tglmasuk_input_2_hor" value="<?php echo NM_encode_input($tglmasuk_input_2_hor); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_tglmasuk_input_2_min" name="tglmasuk_input_2_min" value="<?php echo NM_encode_input($tglmasuk_input_2_min); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_tglmasuk_input_2_seg" name="tglmasuk_input_2_seg" value="<?php echo NM_encode_input($tglmasuk_input_2_seg); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_trancode" name="trancode_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 75, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_poli_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['poli'])) ? $this->New_label['poli'] : "Poli"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_poli_cond" name="poli_cond" onChange="nm_campos_between(document.getElementById('id_vis_poli'), this, 'poli')">
...
?>
<INPUT  type="text" id="SC_poli" name="poli" value="<?php echo NM_encode_input($poli) ?>"  size=50 alt="{datatype: 'text', maxLength: 150, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_poli" name="poli_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 150, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if ($_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
<?php
   if (is_file("grid_history_pel_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_history_pel']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_history_pel']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['orig_pesq'] == "grid")
   {
...
?>
 ...
 {
    $('#SC_tglmasuk_dia').bind('change', function() {sc_grid_history_pel_valida_dia(this)});
    $('#SC_tglmasuk_hor').bind('change', function() {sc_grid_history_pel_valida_hora(this)});
    $('#SC_tglmasuk_input_2_dia').bind('change', function() {sc_grid_history_pel_valida_dia(this)});
    $('#SC_tglmasuk_input_2_hor').bind('change', function() {sc_grid_history_pel_valida_hora(this)});
    $('#SC_tglmasuk_input_2_mes').bind('change', function() {sc_grid_history_pel_valida_mes(this)});
    $('#SC_tglmasuk_input_2_min').bind('change', function() {sc_grid_history_pel_valida_min(this)});
    $('#SC_tglmasuk_input_2_seg').bind('change', function() {sc_grid_history_pel_valida_seg(this)});
    $('#SC_tglmasuk_mes').bind('change', function() {sc_grid_history_pel_valida_mes(this)});
    $('#SC_tglmasuk_min').bind('change', function() {sc_grid_history_pel_valida_min(this)});
    $('#SC_tglmasuk_seg').bind('change', function() {sc_grid_history_pel_valida_seg(this)});
 }
 function sc_grid_history_pel_valida_dia(obj)
 {
 ...
 function sc_grid_history_pel_valida_mes(obj)
 {
 ...
 function sc_grid_history_pel_valida_hora(obj)
 {
 ...
 function sc_grid_history_pel_valida_min(obj)
 {
 ...
 function sc_grid_history_pel_valida_seg(obj)
 {
     if (obj.value != "" && (obj.value < 0 || obj.value > 59))
     {
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['where_orig']))
      {
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['where_orig'];
      }
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   {
      global $dokter_cond, $dokter, $dokter_autocomp,
             $tglmasuk_cond, $tglmasuk, $tglmasuk_dia, $tglmasuk_mes, $tglmasuk_ano, $tglmasuk_hor, $tglmasuk_min, $tglmasuk_seg, $tglmasuk_input_2_dia, $tglmasuk_input_2_mes, $tglmasuk_input_2_ano, $tglmasuk_input_2_min, $tglmasuk_input_2_hor, $tglmasuk_input_2_seg,
             $trancode_cond, $trancode, $trancode_autocomp,
             $poli_cond, $poli, $poli_autocomp, $nmgp_tab_label;
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['campos_busca'] as $Cmps => $Vals)
          {
              $$Cmps = $Vals;
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['grid_pesq'] = array();
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['Grid_search']  = array(); 
      $I_Grid = 0;
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['campos_busca']['dokter'] = $dokter; 
      if (is_array($dokter) && !empty($dokter))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['Grid_search'][$I_Grid]['val'][0] = $dokter;
      }
      elseif ($dokter_cond_salva == "nu" || $dokter_cond_salva == "nn" || $dokter_cond_salva == "ep" || $dokter_cond_salva == "ne" || !empty($dokter))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['Grid_search'][$I_Grid]['val'][0][0] = $dokter;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['campos_busca']['dokter_cond'] = $dokter_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['Grid_search'][$I_Grid]['cmp'] = "dokter"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['Grid_search'][$I_Grid]['opc'] = $dokter_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['grid_pesq']['dokter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['campos_busca']['tglmasuk_dia'] = $tglmasuk_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['campos_busca']['tglmasuk_mes'] = $tglmasuk_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['campos_busca']['tglmasuk_ano'] = $tglmasuk_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['campos_busca']['tglmasuk_input_2_dia'] = $tglmasuk_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['campos_busca']['tglmasuk_input_2_mes'] = $tglmasuk_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['campos_busca']['tglmasuk_input_2_ano'] = $tglmasuk_input_2_ano; 
      ...
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['Grid_search'][$I_Grid]['val'][0][] = "D:" . $tglmasuk_dia;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['Grid_search'][$I_Grid]['val'][0][] = "M:" . $tglmasuk_mes;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['Grid_search'][$I_Grid]['val'][0][] = "Y:" . $tglmasuk_ano;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['Grid_search'][$I_Grid]['val'][1][] = "D:" . $tglmasuk_input_2_dia;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['Grid_search'][$I_Grid]['val'][1][] = "M:" . $tglmasuk_input_2_mes;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['Grid_search'][$I_Grid]['val'][1][] = "Y:" . $tglmasuk_input_2_ano;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['campos_busca']['tglmasuk_hor'] = $tglmasuk_hor; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['campos_busca']['tglmasuk_min'] = $tglmasuk_min; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['campos_busca']['tglmasuk_seg'] = $tglmasuk_seg; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['campos_busca']['tglmasuk_input_2_hor'] = $tglmasuk_input_2_hor; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['campos_busca']['tglmasuk_input_2_min'] = $tglmasuk_input_2_min; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['campos_busca']['tglmasuk_input_2_seg'] = $tglmasuk_input_2_seg; 
      ...
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['Grid_search'][$I_Grid]['val'][0][] = "H:" . $tglmasuk_hor;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['Grid_search'][$I_Grid]['val'][0][] = "I:" . $tglmasuk_min;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['Grid_search'][$I_Grid]['val'][0][] = "S:" . $tglmasuk_seg;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['Grid_search'][$I_Grid]['val'][1][] = "H:" . $tglmasuk_input_2_hor;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['Grid_search'][$I_Grid]['val'][1][] = "I:" . $tglmasuk_input_2_min;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['Grid_search'][$I_Grid]['val'][1][] = "S:" . $tglmasuk_input_2_seg;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['campos_busca']['tglmasuk_cond'] = $tglmasuk_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['Grid_search'][$I_Grid]['cmp'] = "tglmasuk"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['Grid_search'][$I_Grid]['opc'] = $tglmasuk_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['grid_pesq']['tglmasuk'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['campos_busca']['trancode'] = $trancode; 
      if (is_array($trancode) && !empty($trancode))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['Grid_search'][$I_Grid]['val'][0] = $trancode;
      }
      elseif ($trancode_cond_salva == "nu" || $trancode_cond_salva == "nn" || $trancode_cond_salva == "ep" || $trancode_cond_salva == "ne" || !empty($trancode))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['Grid_search'][$I_Grid]['val'][0][0] = $trancode;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['campos_busca']['trancode_cond'] = $trancode_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['Grid_search'][$I_Grid]['cmp'] = "trancode"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['Grid_search'][$I_Grid]['opc'] = $trancode_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['grid_pesq']['trancode'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['campos_busca']['poli'] = $poli; 
      if (is_array($poli) && !empty($poli))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['Grid_search'][$I_Grid]['val'][0] = $poli;
      }
      elseif ($poli_cond_salva == "nu" || $poli_cond_salva == "nn" || $poli_cond_salva == "ep" || $poli_cond_salva == "ne" || !empty($poli))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['Grid_search'][$I_Grid]['val'][0][0] = $poli;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['campos_busca']['poli_cond'] = $poli_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['Grid_search'][$I_Grid]['cmp'] = "poli"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['Grid_search'][$I_Grid]['opc'] = $poli_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['grid_pesq']['poli'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      ...
      if ($tglmasuk_cond != "bi_TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['campos_busca']['tglmasuk'] = $val[0];
          ...
          if ($tglmasuk_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['campos_busca']['tglmasuk_input_2'] = $val[1];
          ...
          {
              $this->monta_condicao("tglMasuk", $tglmasuk_cond, $tglmasuk, $tglmasuk_input_2, 'tglmasuk', 'DATETIME');
          }
      }
      else
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['grid_pesq']['tglmasuk']['label'] = $nmgp_tab_label['tglmasuk'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['grid_pesq']['tglmasuk']['descr'] = $nmgp_tab_label['tglmasuk'] . " " . $this->Ini->Nm_lang['lang_srch_ever'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['grid_pesq']['tglmasuk']['hint']  = $nmgp_tab_label['tglmasuk'] . " " . $this->Ini->Nm_lang['lang_srch_ever'];
      }
      ...
      {
         $this->monta_condicao("poli", $poli_cond, $poli, "", "poli");
      }
   }
   ...
   function finaliza_resultado_ajax()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['where_pesq'] = $this->comando;
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['where_pesq_fast'])) 
       {
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['where_pesq'])) 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['where_pesq_fast'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['where_pesq'] = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['where_pesq_fast'] . ")";
           }
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['cond_dyn_search'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_history_pel']['cond_pesq'] .= $this->NM_operador;
