<?php
@session_start() ;
$_SESSION['scriptcase']['grid_history_pel']['sc_process_barr'] = true;
require_once('../grid_history_pel/index.php');
unset($_SESSION['scriptcase']['grid_history_pel']['sc_process_barr']);
$ExportCtrl = new grid_history_pel_export_control;
$ExportCtrl->Export_barr();

class grid_history_pel_export_control
{
