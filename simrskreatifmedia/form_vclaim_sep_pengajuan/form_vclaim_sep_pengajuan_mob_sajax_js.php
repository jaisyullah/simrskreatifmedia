  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_vclaim_sep_pengajuan_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_vclaim_sep_pengajuan_mob_form();
	}

  // ---------- Validate nokartu
  function do_ajax_form_vclaim_sep_pengajuan_mob_validate_nokartu()
  {
    var nomeCampo_nokartu = "nokartu";
    var var_nokartu = scAjaxGetFieldText(nomeCampo_nokartu);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_sep_pengajuan_mob_validate_nokartu(var_nokartu, var_script_case_init, do_ajax_form_vclaim_sep_pengajuan_mob_validate_nokartu_cb);
  } // do_ajax_form_vclaim_sep_pengajuan_mob_validate_nokartu

  function do_ajax_form_vclaim_sep_pengajuan_mob_validate_nokartu_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_sep_pengajuan_mob_validate_nokartu_cb

  // ---------- Validate tglsep
  function do_ajax_form_vclaim_sep_pengajuan_mob_validate_tglsep()
  {
    var nomeCampo_tglsep = "tglsep";
    var var_tglsep = scAjaxGetFieldText(nomeCampo_tglsep);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_sep_pengajuan_mob_validate_tglsep(var_tglsep, var_script_case_init, do_ajax_form_vclaim_sep_pengajuan_mob_validate_tglsep_cb);
  } // do_ajax_form_vclaim_sep_pengajuan_mob_validate_tglsep

  function do_ajax_form_vclaim_sep_pengajuan_mob_validate_tglsep_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tglsep";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_sep_pengajuan_mob_validate_tglsep_cb

  // ---------- Validate jnspelayanan
  function do_ajax_form_vclaim_sep_pengajuan_mob_validate_jnspelayanan()
  {
    var nomeCampo_jnspelayanan = "jnspelayanan";
    var var_jnspelayanan = scAjaxGetFieldSelect(nomeCampo_jnspelayanan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_sep_pengajuan_mob_validate_jnspelayanan(var_jnspelayanan, var_script_case_init, do_ajax_form_vclaim_sep_pengajuan_mob_validate_jnspelayanan_cb);
  } // do_ajax_form_vclaim_sep_pengajuan_mob_validate_jnspelayanan

  function do_ajax_form_vclaim_sep_pengajuan_mob_validate_jnspelayanan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_sep_pengajuan_mob_validate_jnspelayanan_cb

  // ---------- Validate user
  function do_ajax_form_vclaim_sep_pengajuan_mob_validate_user()
  {
    var nomeCampo_user = "user";
    var var_user = scAjaxGetFieldText(nomeCampo_user);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_sep_pengajuan_mob_validate_user(var_user, var_script_case_init, do_ajax_form_vclaim_sep_pengajuan_mob_validate_user_cb);
  } // do_ajax_form_vclaim_sep_pengajuan_mob_validate_user

  function do_ajax_form_vclaim_sep_pengajuan_mob_validate_user_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "user";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_sep_pengajuan_mob_validate_user_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_vclaim_sep_pengajuan_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_vclaim_sep_pengajuan_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_vclaim_sep_pengajuan_mob_submit_form(var_nokartu, var_tglsep, var_jnspelayanan, var_user, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_vclaim_sep_pengajuan_mob_submit_form_cb);
  } // do_ajax_form_vclaim_sep_pengajuan_mob_submit_form

  function do_ajax_form_vclaim_sep_pengajuan_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_vclaim_sep_pengajuan_mob_submit_form_cb_after_alert);
  } // do_ajax_form_vclaim_sep_pengajuan_mob_submit_form_cb
  function do_ajax_form_vclaim_sep_pengajuan_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_vclaim_sep_pengajuan_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_vclaim_sep_pengajuan_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_form_vclaim_sep_pengajuan_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_pengajuan_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_vclaim_sep_pengajuan_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_vclaim_sep_pengajuan_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_vclaim_sep_pengajuan_mob_navigate_form_cb
  function do_ajax_form_vclaim_sep_pengajuan_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_vclaim_sep_pengajuan_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_vclaim_sep_pengajuan_mob_navigate_form_cb_after_alert
  function sc_hide_form_vclaim_sep_pengajuan_mob_form()
  {
  ...
  ajax_field_list[2] = "jnspelayanan";
