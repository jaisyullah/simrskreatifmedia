...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_tbpo"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_tbpo"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tbpo']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_tbpo']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tbpo']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_tbpo']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_tbpo']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_tbpo']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_tbpo']['embutida_filho'] as $ind => $sc_init)
          {
