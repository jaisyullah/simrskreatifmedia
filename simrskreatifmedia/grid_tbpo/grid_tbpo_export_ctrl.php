<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tbpo']['sc_process_barr'] = true;
require_once('../grid_tbpo/index.php');
unset($_SESSION['scriptcase']['grid_tbpo']['sc_process_barr']);
$ExportCtrl = new grid_tbpo_export_control;
$ExportCtrl->Export_barr();

class grid_tbpo_export_control
{
