  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_hrm_potongan_tidak_tetap" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_hrm_potongan_tidak_tetap_form();
	}

  // ---------- Validate id
  function do_ajax_form_hrm_potongan_tidak_tetap_validate_id()
  {
    var nomeCampo_id = "id";
    var var_id = scAjaxGetFieldHidden(nomeCampo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_potongan_tidak_tetap_validate_id(var_id, var_script_case_init, do_ajax_form_hrm_potongan_tidak_tetap_validate_id_cb);
  } // do_ajax_form_hrm_potongan_tidak_tetap_validate_id

  function do_ajax_form_hrm_potongan_tidak_tetap_validate_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_potongan_tidak_tetap_validate_id_cb

  // ---------- Validate id_karyawan
  function do_ajax_form_hrm_potongan_tidak_tetap_validate_id_karyawan()
  {
    var nomeCampo_id_karyawan = "id_karyawan";
    var var_id_karyawan = scAjaxGetFieldSelect(nomeCampo_id_karyawan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_potongan_tidak_tetap_validate_id_karyawan(var_id_karyawan, var_script_case_init, do_ajax_form_hrm_potongan_tidak_tetap_validate_id_karyawan_cb);
  } // do_ajax_form_hrm_potongan_tidak_tetap_validate_id_karyawan

  function do_ajax_form_hrm_potongan_tidak_tetap_validate_id_karyawan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_potongan_tidak_tetap_validate_id_karyawan_cb

  // ---------- Validate kasbon
  function do_ajax_form_hrm_potongan_tidak_tetap_validate_kasbon()
  {
    var nomeCampo_kasbon = "kasbon";
    var var_kasbon = scAjaxGetFieldText(nomeCampo_kasbon);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_potongan_tidak_tetap_validate_kasbon(var_kasbon, var_script_case_init, do_ajax_form_hrm_potongan_tidak_tetap_validate_kasbon_cb);
  } // do_ajax_form_hrm_potongan_tidak_tetap_validate_kasbon

  function do_ajax_form_hrm_potongan_tidak_tetap_validate_kasbon_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "kasbon";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_potongan_tidak_tetap_validate_kasbon_cb

  // ---------- Validate terlambat
  function do_ajax_form_hrm_potongan_tidak_tetap_validate_terlambat()
  {
    var nomeCampo_terlambat = "terlambat";
    var var_terlambat = scAjaxGetFieldText(nomeCampo_terlambat);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_potongan_tidak_tetap_validate_terlambat(var_terlambat, var_script_case_init, do_ajax_form_hrm_potongan_tidak_tetap_validate_terlambat_cb);
  } // do_ajax_form_hrm_potongan_tidak_tetap_validate_terlambat

  function do_ajax_form_hrm_potongan_tidak_tetap_validate_terlambat_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "terlambat";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_potongan_tidak_tetap_validate_terlambat_cb

  // ---------- Validate alfa_izin
  function do_ajax_form_hrm_potongan_tidak_tetap_validate_alfa_izin()
  {
    var nomeCampo_alfa_izin = "alfa_izin";
    var var_alfa_izin = scAjaxGetFieldText(nomeCampo_alfa_izin);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_potongan_tidak_tetap_validate_alfa_izin(var_alfa_izin, var_script_case_init, do_ajax_form_hrm_potongan_tidak_tetap_validate_alfa_izin_cb);
  } // do_ajax_form_hrm_potongan_tidak_tetap_validate_alfa_izin

  function do_ajax_form_hrm_potongan_tidak_tetap_validate_alfa_izin_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "alfa_izin";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_potongan_tidak_tetap_validate_alfa_izin_cb

  // ---------- Validate parkir
  function do_ajax_form_hrm_potongan_tidak_tetap_validate_parkir()
  {
    var nomeCampo_parkir = "parkir";
    var var_parkir = scAjaxGetFieldText(nomeCampo_parkir);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_potongan_tidak_tetap_validate_parkir(var_parkir, var_script_case_init, do_ajax_form_hrm_potongan_tidak_tetap_validate_parkir_cb);
  } // do_ajax_form_hrm_potongan_tidak_tetap_validate_parkir

  function do_ajax_form_hrm_potongan_tidak_tetap_validate_parkir_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "parkir";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_potongan_tidak_tetap_validate_parkir_cb

  // ---------- Validate periode_remunerasi
  function do_ajax_form_hrm_potongan_tidak_tetap_validate_periode_remunerasi()
  {
    var nomeCampo_periode_remunerasi = "periode_remunerasi";
    var var_periode_remunerasi = scAjaxGetFieldSelect(nomeCampo_periode_remunerasi);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_potongan_tidak_tetap_validate_periode_remunerasi(var_periode_remunerasi, var_script_case_init, do_ajax_form_hrm_potongan_tidak_tetap_validate_periode_remunerasi_cb);
  } // do_ajax_form_hrm_potongan_tidak_tetap_validate_periode_remunerasi

  function do_ajax_form_hrm_potongan_tidak_tetap_validate_periode_remunerasi_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "periode_remunerasi";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_potongan_tidak_tetap_validate_periode_remunerasi_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_hrm_potongan_tidak_tetap_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_hrm_potongan_tidak_tetap_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id = scAjaxGetFieldHidden("id");
    var var_id_karyawan = scAjaxGetFieldSelect("id_karyawan");
    var var_kasbon = scAjaxGetFieldText("kasbon");
    var var_terlambat = scAjaxGetFieldText("terlambat");
    var var_alfa_izin = scAjaxGetFieldText("alfa_izin");
    var var_parkir = scAjaxGetFieldText("parkir");
    var var_periode_remunerasi = scAjaxGetFieldSelect("periode_remunerasi");
    ...
    scAjaxProcOn();
    x_ajax_form_hrm_potongan_tidak_tetap_submit_form(var_id, var_id_karyawan, var_kasbon, var_terlambat, var_alfa_izin, var_parkir, var_periode_remunerasi, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_hrm_potongan_tidak_tetap_submit_form_cb);
  } // do_ajax_form_hrm_potongan_tidak_tetap_submit_form

  function do_ajax_form_hrm_potongan_tidak_tetap_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("kasbon");
      scAjaxHideErrorDisplay("terlambat");
      scAjaxHideErrorDisplay("alfa_izin");
      scAjaxHideErrorDisplay("parkir");
      scAjaxHideErrorDisplay("periode_remunerasi");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_hrm_potongan_tidak_tetap_submit_form_cb_after_alert);
  } // do_ajax_form_hrm_potongan_tidak_tetap_submit_form_cb
  function do_ajax_form_hrm_potongan_tidak_tetap_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_hrm_potongan_tidak_tetap_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_hrm_potongan_tidak_tetap_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_hrm_potongan_tidak_tetap_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_hrm_potongan_tidak_tetap_navigate_form_cb);
  } // do_ajax_form_hrm_potongan_tidak_tetap_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_hrm_potongan_tidak_tetap']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_hrm_potongan_tidak_tetap_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_hrm_potongan_tidak_tetap_navigate_form_cb_after_alert);
  } // do_ajax_form_hrm_potongan_tidak_tetap_navigate_form_cb
  function do_ajax_form_hrm_potongan_tidak_tetap_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_hrm_potongan_tidak_tetap_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_hrm_potongan_tidak_tetap_navigate_form_cb_after_alert
  function sc_hide_form_hrm_potongan_tidak_tetap_form()
  {
  ...
  ajax_field_list[2] = "kasbon";
  ajax_field_list[3] = "terlambat";
  ajax_field_list[4] = "alfa_izin";
  ajax_field_list[5] = "parkir";
  ajax_field_list[6] = "periode_remunerasi";
  ...
  var ajax_error_list = {
    ...
    "kasbon": {"label": "Kasbon", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "terlambat": {"label": "Terlambat", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "alfa_izin": {"label": "Alfa Izin", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "parkir": {"label": "Parkir", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "periode_remunerasi": {"label": "Periode Remunerasi", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    ...
    "alfa_izin": new Array(),
    "parkir": new Array(),
    "periode_remunerasi": new Array()
  };
  ajax_field_mult["id"][1] = "id";
  ajax_field_mult["id_karyawan"][1] = "id_karyawan";
  ajax_field_mult["kasbon"][1] = "kasbon";
  ajax_field_mult["terlambat"][1] = "terlambat";
  ajax_field_mult["alfa_izin"][1] = "alfa_izin";
  ajax_field_mult["parkir"][1] = "parkir";
  ajax_field_mult["periode_remunerasi"][1] = "periode_remunerasi";
  ...
  var ajax_field_id = {
    ...
    "kasbon": new Array("hidden_field_label_kasbon", "hidden_field_data_kasbon"),
    "terlambat": new Array("hidden_field_label_terlambat", "hidden_field_data_terlambat"),
    "alfa_izin": new Array("hidden_field_label_alfa_izin", "hidden_field_data_alfa_izin"),
    "parkir": new Array("hidden_field_label_parkir", "hidden_field_data_parkir"),
    "periode_remunerasi": new Array("hidden_field_label_periode_remunerasi", "hidden_field_data_periode_remunerasi")
  };
