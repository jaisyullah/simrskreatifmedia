...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_roomname_cond" name="roomname_cond" onChange="nm_campos_between(document.getElementById('id_vis_roomname'), this, 'roomname')">
      ...
      <br><span id="id_hide_roomname"  <?php echo $str_hide_roomname?>><?php
      if ($roomname != "")
      {
      $roomname_look = substr($this->Db->qstr($roomname), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_tindakan_cond" name="tindakan_cond" onChange="nm_campos_between(document.getElementById('id_vis_tindakan'), this, 'tindakan')">
      ...
      <br><span id="id_hide_tindakan"  <?php echo $str_hide_tindakan?>><?php
      if ($tindakan != "")
      {
      $tindakan_look = substr($this->Db->qstr($tindakan), 1, -1); 
      $nmgp_def_dados = array(); 
