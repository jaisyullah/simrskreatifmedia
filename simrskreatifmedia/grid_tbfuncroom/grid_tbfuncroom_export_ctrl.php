<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tbfuncroom']['sc_process_barr'] = true;
require_once('../grid_tbfuncroom/index.php');
unset($_SESSION['scriptcase']['grid_tbfuncroom']['sc_process_barr']);
$ExportCtrl = new grid_tbfuncroom_export_control;
$ExportCtrl->Export_barr();

class grid_tbfuncroom_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_title'] ?> tbfuncroom :: Excel</TITLE>
