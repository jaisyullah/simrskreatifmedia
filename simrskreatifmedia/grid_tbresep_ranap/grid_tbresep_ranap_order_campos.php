...
<?php
   ...
   $Ord_Cmp = new grid_tbresep_ranap_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_tbresep_ranap_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbresep_ranap']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tbresep_ranap']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["strukresep"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbresep_ranap']['labels']["strukresep"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbresep_ranap']['labels']["strukresep"] : "Struk Resep";
   $tab_ger_campos['trandate'] = "on";
   $tab_def_campos['trandate'] = "tranDate";
   $tab_labels["trandate"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbresep_ranap']['labels']["trandate"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbresep_ranap']['labels']["trandate"] : "Tgl Transaksi";
   $tab_ger_campos['trancode'] = "on";
   $tab_def_campos['trancode'] = "tranCode";
   $tab_labels["trancode"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbresep_ranap']['labels']["trancode"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbresep_ranap']['labels']["trancode"] : "KodeTransaksi";
   ...
   $tab_labels["nama"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbresep_ranap']['labels']["nama"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbresep_ranap']['labels']["nama"] : "Nama Pasien";
   ...
   $tab_labels["bayar"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbresep_ranap']['labels']["bayar"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbresep_ranap']['labels']["bayar"] : "Bayar";
   ...
   $tab_labels["dpjp"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbresep_ranap']['labels']["dpjp"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbresep_ranap']['labels']["dpjp"] : "DPJP";
   ...
   $tab_labels["sc_field_1"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbresep_ranap']['labels']["sc_field_1"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbresep_ranap']['labels']["sc_field_1"] : "Ruang Bed";
   ...
   $tab_labels["detail"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbresep_ranap']['labels']["detail"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbresep_ranap']['labels']["detail"] : "Detail";
   $tab_ger_campos['verif'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['verif'] = "Verif";
   }
   else
   {
       $tab_def_campos['verif'] = "";
   }
   $tab_labels["verif"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbresep_ranap']['labels']["verif"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbresep_ranap']['labels']["verif"] : "Verif";
   ...
   $tab_labels["sc_field_0"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbresep_ranap']['labels']["sc_field_0"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbresep_ranap']['labels']["sc_field_0"] : "Verif Oleh";
   $tab_ger_campos['nama'] = "none";
   $tab_ger_campos['bayar'] = "none";
   $tab_ger_campos['dpjp'] = "none";
   $tab_ger_campos['sc_field_1'] = "none";
   $tab_ger_campos['detail'] = "none";
   $tab_ger_campos['verif'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_tbresep_ranap']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_tbresep_ranap']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_tbresep_ranap']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbresep_ranap']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tbresep_ranap']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_tbresep_ranap']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_tbresep_ranap']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_tbresep_ranap']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_tbresep_ranap']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_tbresep_ranap_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_tbresep_ranap']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_tbresep_ranap']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_tbresep_ranap']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_tbresep_ranap']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_tbresep_ranap']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
