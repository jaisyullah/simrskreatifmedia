<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tbresep_ranap']['sc_process_barr'] = true;
require_once('../grid_tbresep_ranap/index.php');
unset($_SESSION['scriptcase']['grid_tbresep_ranap']['sc_process_barr']);
$ExportCtrl = new grid_tbresep_ranap_export_control;
$ExportCtrl->Export_barr();

class grid_tbresep_ranap_export_control
{
