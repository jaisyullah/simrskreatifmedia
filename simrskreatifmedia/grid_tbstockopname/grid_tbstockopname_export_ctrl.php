<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tbstockopname']['sc_process_barr'] = true;
require_once('../grid_tbstockopname/index.php');
unset($_SESSION['scriptcase']['grid_tbstockopname']['sc_process_barr']);
$ExportCtrl = new grid_tbstockopname_export_control;
$ExportCtrl->Export_barr();

class grid_tbstockopname_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - Stok Opname :: Excel</TITLE>
