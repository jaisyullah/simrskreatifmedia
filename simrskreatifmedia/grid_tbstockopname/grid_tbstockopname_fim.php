...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_tbstockopname"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_tbstockopname"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_tbstockopname'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tbstockopname']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_tbstockopname']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tbstockopname']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_tbstockopname']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_tbstockopname']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_tbstockopname</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_tbstockopname']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_tbstockopname']['embutida_filho'] as $ind => $sc_init)
          {
