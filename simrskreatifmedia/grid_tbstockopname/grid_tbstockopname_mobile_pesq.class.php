...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "tglSo";$Nm_datas[] = "tglSo";$Nm_numeric[] = "id";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_socode"  <?php echo $str_hide_socode?>><?php
      if ($socode != "")
      {
      $socode_look = substr($this->Db->qstr($socode), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_tglso"  <?php echo $str_hide_tglso?>>
<?php
  $Form_base = "ddmmyyyy";
  $date_format_show = "";
