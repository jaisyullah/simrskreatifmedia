...
class grid_tbstockopname_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockopname']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_tbstockopname_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_tbstockopname_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_tbstockopname_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockopname']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockopname']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockopname']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockopname']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockopname']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockopname']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockopname']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockopname']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockopname']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockopname']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockopname']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockopname']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockopname']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockopname']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockopname']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockopname']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockopname']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - Stok Opname</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_tbstockopname/grid_tbstockopname_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_tbstockopname_ajax_search.js"></script>
 <script type="text/javascript" src="grid_tbstockopname_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_tbstockopname_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_tbstockopname']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_tbstockopname']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_tglso_cond#NMF#' + search_get_sel_txt('SC_tglso_cond') + '@NMF@';
  str_out += 'SC_tglso_dia#NMF#' + search_get_sel_txt('SC_tglso_dia') + '@NMF@';
  str_out += 'SC_tglso_mes#NMF#' + search_get_sel_txt('SC_tglso_mes') + '@NMF@';
  str_out += 'SC_tglso_ano#NMF#' + search_get_sel_txt('SC_tglso_ano') + '@NMF@';
  str_out += 'SC_tglso_input_2_dia#NMF#' + search_get_sel_txt('SC_tglso_input_2_dia') + '@NMF@';
  str_out += 'SC_tglso_input_2_mes#NMF#' + search_get_sel_txt('SC_tglso_input_2_mes') + '@NMF@';
  str_out += 'SC_tglso_input_2_ano#NMF#' + search_get_sel_txt('SC_tglso_input_2_ano') + '@NMF@';
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockopname']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div class="scFilterHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFilterHeaderFont" style="float: left; text-transform: uppercase;"><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - Stok Opname</div>
...
<?php
   ...
   function monta_form()
   {
      global 
             ...
             $tglso_cond, $tglso, $tglso_dia, $tglso_mes, $tglso_ano,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockopname']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockopname']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockopname']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockopname']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $id = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockopname']['campos_busca']['id']; 
          $id_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockopname']['campos_busca']['id_cond']; 
          $socode = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockopname']['campos_busca']['socode']; 
          $socode_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockopname']['campos_busca']['socode_cond']; 
          $tglso_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockopname']['campos_busca']['tglso_dia']; 
          $tglso_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockopname']['campos_busca']['tglso_mes']; 
          $tglso_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockopname']['campos_busca']['tglso_ano']; 
          $tglso_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockopname']['campos_busca']['tglso_cond']; 
          $keterangan = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockopname']['campos_busca']['keterangan']; 
          $keterangan_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockopname']['campos_busca']['keterangan_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockopname']['campos_busca']['NM_operador']; 
      } 
      ...
      $str_hide_tglso = (in_array($tglso_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      if (!isset($tglso) || $tglso == "")
      {
          $tglso = "";
      }
      if (isset($tglso) && !empty($tglso))
      {
         $tmp_pos = strpos($tglso, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $tglso = substr($tglso, 0, $tmp_pos);
         }
      }
...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_id" name="id_autocomp" size="5"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 5, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
      ...
      <TD id='SC_socode_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['socode'])) ? $this->New_label['socode'] : "So Code"; ?></TD>
      
      <INPUT type="hidden" id="SC_socode_cond" name="socode_cond" value="eq">
...
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_socode" name="socode_autocomp" size="15"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 15, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_tglso_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['tglso'])) ? $this->New_label['tglso'] : "Tgl So"; ?></TD>
      
      <INPUT type="hidden" id="SC_tglso_cond" name="tglso_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_tglso" <?php echo $str_hide_tglso?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['tglso'])) ? $this->New_label['tglso'] : "Tgl So";
 $nmgp_tab_label .= "tglso?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
  ...
  {
?>
<span id='id_date_part_tglso_DD' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_tglso_dia" name="tglso_dia" value="<?php echo NM_encode_input($tglso_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_tglso_MM' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_tglso_mes" name="tglso_mes" value="<?php echo NM_encode_input($tglso_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_tglso_AAAA' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_tglso_ano" name="tglso_ano" value="<?php echo NM_encode_input($tglso_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 </span>
...
?>
        <SPAN id="id_css_tglso"  class="scFilterFieldFontOdd">
...
?>
<?php
   if (is_file("grid_tbstockopname_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_tbstockopname']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_tbstockopname']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockopname']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   nm_campos_between(document.getElementById('id_vis_tglso'), document.F1.tglso_cond, 'tglso');
   document.F1.tglso_dia.value = "";
   document.F1.tglso_mes.value = "";
   document.F1.tglso_ano.value = "";
 ...
 {
    $('#SC_tglso_dia').bind('change', function() {sc_grid_tbstockopname_valida_dia(this)});
    $('#SC_tglso_mes').bind('change', function() {sc_grid_tbstockopname_valida_mes(this)});
 }
 function sc_grid_tbstockopname_valida_dia(obj)
 {
 ...
 function sc_grid_tbstockopname_valida_mes(obj)
 {
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "simrskreatifmedia/grid_tbstockopname";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockopname']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockopname']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockopname']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_tglso_cond'] = 'cond';
      $tp_fields['SC_tglso_dia'] = 'text';
      $tp_fields['SC_tglso_mes'] = 'text';
      $tp_fields['SC_tglso_ano'] = 'text';
      $tp_fields['SC_tglso_input_2_dia'] = 'text';
      $tp_fields['SC_tglso_input_2_mes'] = 'text';
      $tp_fields['SC_tglso_input_2_ano'] = 'text';
   ...
   function trata_campos()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockopname']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockopname']['campos_busca']['id'] = $id; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockopname']['campos_busca']['id_cond'] = $id_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockopname']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockopname']['campos_busca']['socode'] = $socode; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockopname']['campos_busca']['socode_cond'] = $socode_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockopname']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockopname']['campos_busca']['tglso_dia'] = $tglso_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockopname']['campos_busca']['tglso_mes'] = $tglso_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockopname']['campos_busca']['tglso_ano'] = $tglso_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockopname']['campos_busca']['tglso_cond'] = $tglso_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockopname']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockopname']['campos_busca']['keterangan'] = $keterangan; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockopname']['campos_busca']['keterangan_cond'] = $keterangan_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockopname']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockopname']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockopname']['campos_busca'] = $Temp_Busca;
      }
   ...
   { 
      ...
      if ($tglso_cond != "bi_TP")
      {
          $tglso_cond = strtoupper($tglso_cond);
          $Dtxt = "";
          $val  = array();
          $Dtxt .= $tglso_ano;
          $Dtxt .= $tglso_mes;
          ...
          if ($tglso_cond == "BW")
          {
              $val[1]['ano'] = $tglso_input_2_ano;
              $val[1]['mes'] = $tglso_input_2_mes;
              $val[1]['dia'] = $tglso_input_2_dia;
          }
          $this->Operador_date_part = "";
          $this->Lang_date_part     = "";
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_oracle))
          {
              $this->nm_prep_date($val, "DT", "DATETIME", $tglso_cond, "", "data");
          }
          else
          {
              $this->nm_prep_date($val, "DT", "DATE", $tglso_cond, "", "data");
          }
          if (!$this->Date_part) {
              $val[0] = $this->Ini->sc_Date_Protect($val[0]);
          }
          $tglso = $val[0];
          $this->cmp_formatado['tglso'] = $val[0];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockopname']['campos_busca']['tglso'] = $val[0];
          $this->nm_data->SetaData($this->cmp_formatado['tglso'], "YYYY-MM-DD");
          $this->cmp_formatado['tglso'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DT", "dmY"));
          if ($tglso_cond == "BW")
          {
              if (!$this->Date_part) {
              ...
              $tglso_input_2     = $val[1];
              $this->cmp_formatado['tglso_input_2'] = $val[1];
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockopname']['campos_busca']['tglso_input_2'] = $val[1];
              $this->nm_data->SetaData($this->cmp_formatado['tglso_input_2'], "YYYY-MM-DD");
              $this->cmp_formatado['tglso_input_2'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DT", "dmY"));
          }
          if (!empty($Dtxt) || $tglso_cond == "NU" || $tglso_cond == "NN"|| $tglso_cond == "EP"|| $tglso_cond == "NE")
          {
              $this->monta_condicao("tglSo", $tglso_cond, $tglso, $tglso_input_2, 'tglso', 'DATE');
          }
      }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockopname']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockopname']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockopname']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockopname']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockopname']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockopname']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockopname']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockopname']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockopname']['cond_pesq'] .= $this->NM_operador;
