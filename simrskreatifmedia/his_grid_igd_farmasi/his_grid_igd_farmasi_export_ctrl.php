<?php
@session_start() ;
$_SESSION['scriptcase']['his_grid_igd_farmasi']['sc_process_barr'] = true;
require_once('../his_grid_igd_farmasi/index.php');
unset($_SESSION['scriptcase']['his_grid_igd_farmasi']['sc_process_barr']);
$ExportCtrl = new his_grid_igd_farmasi_export_control;
$ExportCtrl->Export_barr();

class his_grid_igd_farmasi_export_control
{
