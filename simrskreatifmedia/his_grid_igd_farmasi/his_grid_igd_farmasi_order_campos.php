...
<?php
   ...
   $Ord_Cmp = new his_grid_igd_farmasi_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class his_grid_igd_farmasi_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['his_grid_igd_farmasi']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['his_grid_igd_farmasi']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["trancode"]   = (isset($_SESSION['sc_session'][$sc_init]['his_grid_igd_farmasi']['labels']["trancode"])) ? $_SESSION['sc_session'][$sc_init]['his_grid_igd_farmasi']['labels']["trancode"] : "Tran Code";
   ...
   $tab_labels["trandate"]   = (isset($_SESSION['sc_session'][$sc_init]['his_grid_igd_farmasi']['labels']["trandate"])) ? $_SESSION['sc_session'][$sc_init]['his_grid_igd_farmasi']['labels']["trandate"] : "Tran Date";
   ...
   $tab_labels["rm"]   = (isset($_SESSION['sc_session'][$sc_init]['his_grid_igd_farmasi']['labels']["rm"])) ? $_SESSION['sc_session'][$sc_init]['his_grid_igd_farmasi']['labels']["rm"] : "RM";
   ...
   $tab_labels["nama"]   = (isset($_SESSION['sc_session'][$sc_init]['his_grid_igd_farmasi']['labels']["nama"])) ? $_SESSION['sc_session'][$sc_init]['his_grid_igd_farmasi']['labels']["nama"] : "Nama";
   ...
   $tab_labels["umur"]   = (isset($_SESSION['sc_session'][$sc_init]['his_grid_igd_farmasi']['labels']["umur"])) ? $_SESSION['sc_session'][$sc_init]['his_grid_igd_farmasi']['labels']["umur"] : "Umur";
   ...
   $tab_labels["jenis"]   = (isset($_SESSION['sc_session'][$sc_init]['his_grid_igd_farmasi']['labels']["jenis"])) ? $_SESSION['sc_session'][$sc_init]['his_grid_igd_farmasi']['labels']["jenis"] : "Jenis";
   ...
   $tab_labels["status"]   = (isset($_SESSION['sc_session'][$sc_init]['his_grid_igd_farmasi']['labels']["status"])) ? $_SESSION['sc_session'][$sc_init]['his_grid_igd_farmasi']['labels']["status"] : "Status";
   ...
   $tab_labels["detail"]   = (isset($_SESSION['sc_session'][$sc_init]['his_grid_igd_farmasi']['labels']["detail"])) ? $_SESSION['sc_session'][$sc_init]['his_grid_igd_farmasi']['labels']["detail"] : "Detail";
   ...
   $tab_labels["sc_field_0"]   = (isset($_SESSION['sc_session'][$sc_init]['his_grid_igd_farmasi']['labels']["sc_field_0"])) ? $_SESSION['sc_session'][$sc_init]['his_grid_igd_farmasi']['labels']["sc_field_0"] : "Verified Status";
   ...
   $tab_labels["verifyby"]   = (isset($_SESSION['sc_session'][$sc_init]['his_grid_igd_farmasi']['labels']["verifyby"])) ? $_SESSION['sc_session'][$sc_init]['his_grid_igd_farmasi']['labels']["verifyby"] : "Verify Oleh";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['his_grid_igd_farmasi']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['his_grid_igd_farmasi']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['his_grid_igd_farmasi']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['his_grid_igd_farmasi']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['his_grid_igd_farmasi']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['his_grid_igd_farmasi']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['his_grid_igd_farmasi']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['his_grid_igd_farmasi']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['his_grid_igd_farmasi']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "his_grid_igd_farmasi_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['his_grid_igd_farmasi']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['his_grid_igd_farmasi']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['his_grid_igd_farmasi']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['his_grid_igd_farmasi']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['his_grid_igd_farmasi']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
