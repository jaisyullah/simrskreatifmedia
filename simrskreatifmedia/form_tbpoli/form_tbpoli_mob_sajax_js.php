  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbpoli_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbpoli_mob_form();
	}

  // ---------- Validate polycode
  function do_ajax_form_tbpoli_mob_validate_polycode()
  {
    var nomeCampo_polycode = "polycode";
    var var_polycode = scAjaxGetFieldText(nomeCampo_polycode);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbpoli_mob_validate_polycode(var_polycode, var_script_case_init, do_ajax_form_tbpoli_mob_validate_polycode_cb);
  } // do_ajax_form_tbpoli_mob_validate_polycode

  function do_ajax_form_tbpoli_mob_validate_polycode_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "polycode";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbpoli_mob_validate_polycode_cb

  // ---------- Validate name
  function do_ajax_form_tbpoli_mob_validate_name()
  {
    var nomeCampo_name = "name";
    var var_name = scAjaxGetFieldText(nomeCampo_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbpoli_mob_validate_name(var_name, var_script_case_init, do_ajax_form_tbpoli_mob_validate_name_cb);
  } // do_ajax_form_tbpoli_mob_validate_name

  function do_ajax_form_tbpoli_mob_validate_name_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "name";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbpoli_mob_validate_name_cb

  // ---------- Validate note
  function do_ajax_form_tbpoli_mob_validate_note()
  {
    var nomeCampo_note = "note";
    var var_note = scAjaxGetFieldText(nomeCampo_note);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbpoli_mob_validate_note(var_note, var_script_case_init, do_ajax_form_tbpoli_mob_validate_note_cb);
  } // do_ajax_form_tbpoli_mob_validate_note

  function do_ajax_form_tbpoli_mob_validate_note_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "note";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbpoli_mob_validate_note_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tbpoli_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tbpoli_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_polycode = scAjaxGetFieldText("polycode");
    ...
    scAjaxProcOn();
    x_ajax_form_tbpoli_mob_submit_form(var_polycode, var_name, var_note, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbpoli_mob_submit_form_cb);
  } // do_ajax_form_tbpoli_mob_submit_form

  function do_ajax_form_tbpoli_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("polycode");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tbpoli_mob_submit_form_cb_after_alert);
  } // do_ajax_form_tbpoli_mob_submit_form_cb
  function do_ajax_form_tbpoli_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbpoli_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tbpoli_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("name");
    scAjaxHideErrorDisplay("note");
    var var_polycode = document.F2.polycode.value;
    ...
    scAjaxProcOn();
    x_ajax_form_tbpoli_mob_navigate_form(var_polycode, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbpoli_mob_navigate_form_cb);
  } // do_ajax_form_tbpoli_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbpoli_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbpoli_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.polycode.value = scAjaxGetKeyValue("polycode");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbpoli_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_tbpoli_mob_navigate_form_cb
  function do_ajax_form_tbpoli_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_tbpoli_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_tbpoli_mob_navigate_form_cb_after_alert
  function sc_hide_form_tbpoli_mob_form()
  {
  ...
  var ajax_error_list = {
    "polycode": {"label": "Kode Poli", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  ajax_field_mult["polycode"][1] = "polycode";
  ajax_field_mult["name"][1] = "name";
  ajax_field_mult["note"][1] = "note";

  var ajax_field_id = {
    "polycode": new Array("hidden_field_label_polycode", "hidden_field_data_polycode"),
