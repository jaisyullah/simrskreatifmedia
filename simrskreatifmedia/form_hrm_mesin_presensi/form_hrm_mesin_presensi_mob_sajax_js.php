  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_hrm_mesin_presensi_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_hrm_mesin_presensi_mob_form();
	}

  // ---------- Validate id
  function do_ajax_form_hrm_mesin_presensi_mob_validate_id()
  {
    var nomeCampo_id = "id";
    var var_id = scAjaxGetFieldHidden(nomeCampo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_mesin_presensi_mob_validate_id(var_id, var_script_case_init, do_ajax_form_hrm_mesin_presensi_mob_validate_id_cb);
  } // do_ajax_form_hrm_mesin_presensi_mob_validate_id

  function do_ajax_form_hrm_mesin_presensi_mob_validate_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_mesin_presensi_mob_validate_id_cb

  // ---------- Validate nama_mesin
  function do_ajax_form_hrm_mesin_presensi_mob_validate_nama_mesin()
  {
    var nomeCampo_nama_mesin = "nama_mesin";
    var var_nama_mesin = scAjaxGetFieldText(nomeCampo_nama_mesin);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_mesin_presensi_mob_validate_nama_mesin(var_nama_mesin, var_script_case_init, do_ajax_form_hrm_mesin_presensi_mob_validate_nama_mesin_cb);
  } // do_ajax_form_hrm_mesin_presensi_mob_validate_nama_mesin

  function do_ajax_form_hrm_mesin_presensi_mob_validate_nama_mesin_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_mesin_presensi_mob_validate_nama_mesin_cb

  // ---------- Validate keterangan
  function do_ajax_form_hrm_mesin_presensi_mob_validate_keterangan()
  {
    var nomeCampo_keterangan = "keterangan";
    var var_keterangan = scAjaxGetFieldText(nomeCampo_keterangan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_mesin_presensi_mob_validate_keterangan(var_keterangan, var_script_case_init, do_ajax_form_hrm_mesin_presensi_mob_validate_keterangan_cb);
  } // do_ajax_form_hrm_mesin_presensi_mob_validate_keterangan

  function do_ajax_form_hrm_mesin_presensi_mob_validate_keterangan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_mesin_presensi_mob_validate_keterangan_cb

  // ---------- Validate ip
  function do_ajax_form_hrm_mesin_presensi_mob_validate_ip()
  {
    var nomeCampo_ip = "ip";
    var var_ip = scAjaxGetFieldText(nomeCampo_ip);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_mesin_presensi_mob_validate_ip(var_ip, var_script_case_init, do_ajax_form_hrm_mesin_presensi_mob_validate_ip_cb);
  } // do_ajax_form_hrm_mesin_presensi_mob_validate_ip

  function do_ajax_form_hrm_mesin_presensi_mob_validate_ip_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ip";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_mesin_presensi_mob_validate_ip_cb

  // ---------- Validate key
  function do_ajax_form_hrm_mesin_presensi_mob_validate_key()
  {
    var nomeCampo_key = "key";
    var var_key = scAjaxGetFieldText(nomeCampo_key);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_mesin_presensi_mob_validate_key(var_key, var_script_case_init, do_ajax_form_hrm_mesin_presensi_mob_validate_key_cb);
  } // do_ajax_form_hrm_mesin_presensi_mob_validate_key

  function do_ajax_form_hrm_mesin_presensi_mob_validate_key_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "key";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_mesin_presensi_mob_validate_key_cb

  // ---------- Validate status
  function do_ajax_form_hrm_mesin_presensi_mob_validate_status()
  {
    var nomeCampo_status = "status";
    var var_status = scAjaxGetFieldText(nomeCampo_status);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_mesin_presensi_mob_validate_status(var_status, var_script_case_init, do_ajax_form_hrm_mesin_presensi_mob_validate_status_cb);
  } // do_ajax_form_hrm_mesin_presensi_mob_validate_status

  function do_ajax_form_hrm_mesin_presensi_mob_validate_status_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "status";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_mesin_presensi_mob_validate_status_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_hrm_mesin_presensi_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_hrm_mesin_presensi_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_hrm_mesin_presensi_mob_submit_form(var_id, var_nama_mesin, var_keterangan, var_ip, var_key, var_status, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_hrm_mesin_presensi_mob_submit_form_cb);
  } // do_ajax_form_hrm_mesin_presensi_mob_submit_form

  function do_ajax_form_hrm_mesin_presensi_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_hrm_mesin_presensi_mob_submit_form_cb_after_alert);
  } // do_ajax_form_hrm_mesin_presensi_mob_submit_form_cb
  function do_ajax_form_hrm_mesin_presensi_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_hrm_mesin_presensi_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_hrm_mesin_presensi_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_hrm_mesin_presensi_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_hrm_mesin_presensi_mob_navigate_form_cb);
  } // do_ajax_form_hrm_mesin_presensi_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_hrm_mesin_presensi_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_hrm_mesin_presensi_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_hrm_mesin_presensi_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_hrm_mesin_presensi_mob_navigate_form_cb
  function do_ajax_form_hrm_mesin_presensi_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_hrm_mesin_presensi_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_hrm_mesin_presensi_mob_navigate_form_cb_after_alert
  function sc_hide_form_hrm_mesin_presensi_mob_form()
  {
