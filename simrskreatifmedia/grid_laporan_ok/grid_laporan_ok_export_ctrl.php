<?php
@session_start() ;
$_SESSION['scriptcase']['grid_laporan_ok']['sc_process_barr'] = true;
require_once('../grid_laporan_ok/index.php');
unset($_SESSION['scriptcase']['grid_laporan_ok']['sc_process_barr']);
$ExportCtrl = new grid_laporan_ok_export_control;
$ExportCtrl->Export_barr();

class grid_laporan_ok_export_control
{
