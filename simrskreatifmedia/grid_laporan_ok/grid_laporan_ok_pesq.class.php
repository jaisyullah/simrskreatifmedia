...
class grid_laporan_ok_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_ok']['path_libs_php'] = $this->Ini->path_lib_php;
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_ok']['prim_vez']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_ok']['prim_vez'] = "S";
      }
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_laporan_ok_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_laporan_ok_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_laporan_ok_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_tindakan')
      {
          $tindakan = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_tindakan($tindakan);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function lookup_ajax_tindakan($tindakan)
   {
      ...
      $nm_comando = "select distinct a.funcRoom from " . $this->Ini->nm_tabela . " where  a.funcRoom like '%" . $tindakan . "%' order by a.funcRoom"; 
      unset($cmp1,$cmp2);
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "a.operTime";$Nm_datas[] = "a_operTime";$Nm_datas[] = "a.signinTime";$Nm_datas[] = "a_signinTime";$Nm_datas[] = "a.signoutTime";$Nm_datas[] = "a_signoutTime";
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_ok']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_ok']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_ok']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_ok']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_ok']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_ok']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_ok']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_ok']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_ok']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_ok']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_ok']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_ok']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_ok']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_ok']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_ok']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_ok']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_ok']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
   ...
   $NM_retorno = "./";
    if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_ok']['proc_res'])) 
    {
...
<?php
    if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_ok']['prim_vez'] == "N" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_ok']['proc_res']) 
    {
?>
if (parent.document.getElementById('nmsc_iframe_grid_laporan_ok').contentWindow.nm_gp_submit_ajax)
{
   parent.document.getElementById('nmsc_iframe_grid_laporan_ok').contentWindow.nm_gp_submit_ajax('inicio', 'save_grid');
}
else
{
   parent.document.getElementById('nmsc_iframe_grid_laporan_ok').src = 'index.php?nmgp_opcao=pesq&script_case_init=<?php echo NM_encode_input($this->Ini->sc_page) ?>&script_case_session=<?php echo session_id() ?>';
}
<?php
    }
    else
...
<?php
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_ok']['prim_vez'] = "N";
?>
</SCRIPT>
</BODY>
</HTML>
...
<HEAD>
 <TITLE>Daftar Pasien OK (Kamar Operasi)</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_laporan_ok/grid_laporan_ok_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_laporan_ok_ajax_search.js"></script>
 <script type="text/javascript" src="grid_laporan_ok_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_laporan_ok_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_laporan_ok']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_laporan_ok']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
function scJQCalendarAdd() {
  $("#sc_sc_field_3_jq").datepicker({
    beforeShow: function(input, inst) {
          var_dt_ini  = document.getElementById('SC_sc_field_3_dia').value + '/';
          var_dt_ini += document.getElementById('SC_sc_field_3_mes').value + '/';
          var_dt_ini += document.getElementById('SC_sc_field_3_ano').value;
          document.getElementById('sc_sc_field_3_jq').value = var_dt_ini;
    },
    onClose: function(dateText, inst) {
          aParts  = dateText.split("/");
          document.getElementById('SC_sc_field_3_dia').value = aParts[0];
          document.getElementById('SC_sc_field_3_mes').value = aParts[1];
          document.getElementById('SC_sc_field_3_ano').value = aParts[2];
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
  ...
  $("#sc_sc_field_3_jq2").datepicker({
    beforeShow: function(input, inst) {
          var_dt_ini  = document.getElementById('SC_sc_field_3_input_2_dia').value + '/';
          var_dt_ini += document.getElementById('SC_sc_field_3_input_2_mes').value + '/';
          var_dt_ini += document.getElementById('SC_sc_field_3_input_2_ano').value;
          document.getElementById('sc_sc_field_3_jq2').value = var_dt_ini;
    },
    onClose: function(dateText, inst) {
          aParts  = dateText.split("/");
          document.getElementById('SC_sc_field_3_input_2_dia').value = aParts[0];
          document.getElementById('SC_sc_field_3_input_2_mes').value = aParts[1];
          document.getElementById('SC_sc_field_3_input_2_ano').value = aParts[2];
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_tgl. tindakan_cond#NMF#' + search_get_sel_txt('SC_sc_field_3_cond') + '@NMF@';
  str_out += 'SC_tgl. tindakan_dia#NMF#' + search_get_sel_txt('SC_sc_field_3_dia') + '@NMF@';
  str_out += 'SC_tgl. tindakan_mes#NMF#' + search_get_sel_txt('SC_sc_field_3_mes') + '@NMF@';
  str_out += 'SC_tgl. tindakan_ano#NMF#' + search_get_sel_txt('SC_sc_field_3_ano') + '@NMF@';
  str_out += 'SC_tgl. tindakan_input_2_dia#NMF#' + search_get_sel_txt('SC_sc_field_3_input_2_dia') + '@NMF@';
  str_out += 'SC_tgl. tindakan_input_2_mes#NMF#' + search_get_sel_txt('SC_sc_field_3_input_2_mes') + '@NMF@';
  str_out += 'SC_tgl. tindakan_input_2_ano#NMF#' + search_get_sel_txt('SC_sc_field_3_input_2_ano') + '@NMF@';
  str_out += 'SC_tindakan_cond#NMF#' + search_get_sel_txt('SC_tindakan_cond') + '@NMF@';
  str_out += 'SC_tindakan#NMF#' + search_get_text('SC_tindakan') + '@NMF@';
  str_out += 'id_ac_tindakan#NMF#' + search_get_text('id_ac_tindakan') + '@NMF@';
   ...
   $("#id_ac_tindakan").autocomplete({
     ...
     $.ajax({
       ...
       data: {
          ...
          nmgp_parms: "NM_ajax_opcao?#?autocomp_tindakan",
          max_itens: "10",
          cod_desc: "N",
...
<?php
   ...
   {
      global 
             $sc_field_3_cond, $sc_field_3, $sc_field_3_dia, $sc_field_3_mes, $sc_field_3_ano, $sc_field_3_input_2_dia, $sc_field_3_input_2_mes, $sc_field_3_input_2_ano,
             $tindakan_cond, $tindakan, $tindakan_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_ok']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_ok']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_ok']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_ok']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $sc_field_3_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_ok']['campos_busca']['sc_field_3_dia']; 
          $sc_field_3_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_ok']['campos_busca']['sc_field_3_mes']; 
          $sc_field_3_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_ok']['campos_busca']['sc_field_3_ano']; 
          $sc_field_3_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_ok']['campos_busca']['sc_field_3_input_2_dia']; 
          $sc_field_3_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_ok']['campos_busca']['sc_field_3_input_2_mes']; 
          $sc_field_3_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_ok']['campos_busca']['sc_field_3_input_2_ano']; 
          $sc_field_3_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_ok']['campos_busca']['sc_field_3_cond']; 
          $tindakan = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_ok']['campos_busca']['tindakan']; 
          $tindakan_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_ok']['campos_busca']['tindakan_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_ok']['campos_busca']['NM_operador']; 
      } 
      if (!isset($sc_field_3_cond) || empty($sc_field_3_cond))
      {
         $sc_field_3_cond = "bw";
      }
      ...
      $str_hide_sc_field_3 = (in_array($sc_field_3_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_tindakan = (in_array($tindakan_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      $str_display_sc_field_3 = ('bw' == $sc_field_3_cond) ? $display_aberto : $display_fechado;
      $str_display_tindakan = ('bw' == $tindakan_cond) ? $display_aberto : $display_fechado;

      if (!isset($sc_field_3) || $sc_field_3 == "")
      {
          $sc_field_3 = "";
      }
      if (isset($sc_field_3) && !empty($sc_field_3))
      {
         $tmp_pos = strpos($sc_field_3, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $sc_field_3 = substr($sc_field_3, 0, $tmp_pos);
         }
      }
      if (!isset($tindakan) || $tindakan == "")
      {
          $tindakan = "";
      }
      if (isset($tindakan) && !empty($tindakan))
      {
         $tmp_pos = strpos($tindakan, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $tindakan = substr($tindakan, 0, $tmp_pos);
         }
      }
?>
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_sc_field_3_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['sc_field_3'])) ? $this->New_label['sc_field_3'] : "Tgl Tindakan"; ?></TD>
      
      <INPUT type="hidden" id="SC_sc_field_3_cond" name="sc_field_3_cond" value="bw">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_sc_field_3" <?php echo $str_hide_sc_field_3?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['sc_field_3'])) ? $this->New_label['sc_field_3'] : "Tgl Tindakan";
 $nmgp_tab_label .= "sc_field_3?#?" . $SC_Label . "?@?";
...
<?php
  ...
  {
?>
<span id='id_date_part_sc_field_3_DD' style='display: inline-block'>

         <SELECT class="scFilterObjectOdd" id="SC_sc_field_3_dia" name="sc_field_3_dia">
          <OPTION value=""></OPTION>
          <OPTION value="01" <?php if ("01" == $sc_field_3_dia) { echo "selected"; } ?>>01</OPTION>
          <OPTION value="02" <?php if ("02" == $sc_field_3_dia) { echo "selected"; } ?>>02</OPTION>
          <OPTION value="03" <?php if ("03" == $sc_field_3_dia) { echo "selected"; } ?>>03</OPTION>
          <OPTION value="04" <?php if ("04" == $sc_field_3_dia) { echo "selected"; } ?>>04</OPTION>
          <OPTION value="05" <?php if ("05" == $sc_field_3_dia) { echo "selected"; } ?>>05</OPTION>
          <OPTION value="06" <?php if ("06" == $sc_field_3_dia) { echo "selected"; } ?>>06</OPTION>
          <OPTION value="07" <?php if ("07" == $sc_field_3_dia) { echo "selected"; } ?>>07</OPTION>
          <OPTION value="08" <?php if ("08" == $sc_field_3_dia) { echo "selected"; } ?>>08</OPTION>
          <OPTION value="09" <?php if ("09" == $sc_field_3_dia) { echo "selected"; } ?>>09</OPTION>
          <OPTION value="10" <?php if ("10" == $sc_field_3_dia) { echo "selected"; } ?>>10</OPTION>
          <OPTION value="11" <?php if ("11" == $sc_field_3_dia) { echo "selected"; } ?>>11</OPTION>
          <OPTION value="12" <?php if ("12" == $sc_field_3_dia) { echo "selected"; } ?>>12</OPTION>
          <OPTION value="13" <?php if ("13" == $sc_field_3_dia) { echo "selected"; } ?>>13</OPTION>
          <OPTION value="14" <?php if ("14" == $sc_field_3_dia) { echo "selected"; } ?>>14</OPTION>
          <OPTION value="15" <?php if ("15" == $sc_field_3_dia) { echo "selected"; } ?>>15</OPTION>
          <OPTION value="16" <?php if ("16" == $sc_field_3_dia) { echo "selected"; } ?>>16</OPTION>
          <OPTION value="17" <?php if ("17" == $sc_field_3_dia) { echo "selected"; } ?>>17</OPTION>
          <OPTION value="18" <?php if ("18" == $sc_field_3_dia) { echo "selected"; } ?>>18</OPTION>
          <OPTION value="19" <?php if ("19" == $sc_field_3_dia) { echo "selected"; } ?>>19</OPTION>
          <OPTION value="20" <?php if ("20" == $sc_field_3_dia) { echo "selected"; } ?>>20</OPTION>
          <OPTION value="21" <?php if ("21" == $sc_field_3_dia) { echo "selected"; } ?>>21</OPTION>
          <OPTION value="22" <?php if ("22" == $sc_field_3_dia) { echo "selected"; } ?>>22</OPTION>
          <OPTION value="23" <?php if ("23" == $sc_field_3_dia) { echo "selected"; } ?>>23</OPTION>
          <OPTION value="24" <?php if ("24" == $sc_field_3_dia) { echo "selected"; } ?>>24</OPTION>
          <OPTION value="25" <?php if ("25" == $sc_field_3_dia) { echo "selected"; } ?>>25</OPTION>
          <OPTION value="26" <?php if ("26" == $sc_field_3_dia) { echo "selected"; } ?>>26</OPTION>
          <OPTION value="27" <?php if ("27" == $sc_field_3_dia) { echo "selected"; } ?>>27</OPTION>
          <OPTION value="28" <?php if ("28" == $sc_field_3_dia) { echo "selected"; } ?>>28</OPTION>
          <OPTION value="29" <?php if ("29" == $sc_field_3_dia) { echo "selected"; } ?>>29</OPTION>
          <OPTION value="30" <?php if ("30" == $sc_field_3_dia) { echo "selected"; } ?>>30</OPTION>
          <OPTION value="31" <?php if ("31" == $sc_field_3_dia) { echo "selected"; } ?>>31</OPTION>
         </SELECT>
         </span>
...
<?php
  ...
  {
?>
<span id='id_date_part_sc_field_3_MM' style='display: inline-block'>

         <SELECT class="scFilterObjectOdd" id="SC_sc_field_3_mes" name="sc_field_3_mes">
          <OPTION value=""></OPTION>
          <OPTION value="01" <?php if ("01" == $sc_field_3_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][0] ?></OPTION>
          <OPTION value="02" <?php if ("02" == $sc_field_3_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][1] ?></OPTION>
          <OPTION value="03" <?php if ("03" == $sc_field_3_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][2] ?></OPTION>
          <OPTION value="04" <?php if ("04" == $sc_field_3_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][3] ?></OPTION>
          <OPTION value="05" <?php if ("05" == $sc_field_3_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][4] ?></OPTION>
          <OPTION value="06" <?php if ("06" == $sc_field_3_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][5] ?></OPTION>
          <OPTION value="07" <?php if ("07" == $sc_field_3_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][6] ?></OPTION>
          <OPTION value="08" <?php if ("08" == $sc_field_3_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][7] ?></OPTION>
          <OPTION value="09" <?php if ("09" == $sc_field_3_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][8] ?></OPTION>
          <OPTION value="10" <?php if ("10" == $sc_field_3_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][9] ?></OPTION>
          <OPTION value="11" <?php if ("11" == $sc_field_3_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][10] ?></OPTION>
          <OPTION value="12" <?php if ("12" == $sc_field_3_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][11] ?></OPTION>
         </SELECT>
         </span>
...
<?php
  ...
  {
?>
<span id='id_date_part_sc_field_3_AAAA' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_sc_field_3_ano" name="sc_field_3_ano" value="<?php echo NM_encode_input($sc_field_3_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 <INPUT type="hidden" id="sc_sc_field_3_jq">
</span>
...
?>
       ...
       <TR valign="top">
        <TD id="id_vis_sc_field_3"  <?php echo $str_display_sc_field_3; ?> class="scFilterFieldFontOdd">
...
<?php
  ...
  {
?>
<span id='id_date_part_sc_field_3_input_2_DD' style='display: inline-block'>

         <SELECT class="scFilterObjectOdd" id="SC_sc_field_3_input_2_dia" name="sc_field_3_input_2_dia">
          <OPTION value=""></OPTION>
          <OPTION value="01" <?php if ("01" == $sc_field_3_input_2_dia) { echo "selected"; } ?>>01</OPTION>
          <OPTION value="02" <?php if ("02" == $sc_field_3_input_2_dia) { echo "selected"; } ?>>02</OPTION>
          <OPTION value="03" <?php if ("03" == $sc_field_3_input_2_dia) { echo "selected"; } ?>>03</OPTION>
          <OPTION value="04" <?php if ("04" == $sc_field_3_input_2_dia) { echo "selected"; } ?>>04</OPTION>
          <OPTION value="05" <?php if ("05" == $sc_field_3_input_2_dia) { echo "selected"; } ?>>05</OPTION>
          <OPTION value="06" <?php if ("06" == $sc_field_3_input_2_dia) { echo "selected"; } ?>>06</OPTION>
          <OPTION value="07" <?php if ("07" == $sc_field_3_input_2_dia) { echo "selected"; } ?>>07</OPTION>
          <OPTION value="08" <?php if ("08" == $sc_field_3_input_2_dia) { echo "selected"; } ?>>08</OPTION>
          <OPTION value="09" <?php if ("09" == $sc_field_3_input_2_dia) { echo "selected"; } ?>>09</OPTION>
          <OPTION value="10" <?php if ("10" == $sc_field_3_input_2_dia) { echo "selected"; } ?>>10</OPTION>
          <OPTION value="11" <?php if ("11" == $sc_field_3_input_2_dia) { echo "selected"; } ?>>11</OPTION>
          <OPTION value="12" <?php if ("12" == $sc_field_3_input_2_dia) { echo "selected"; } ?>>12</OPTION>
          <OPTION value="13" <?php if ("13" == $sc_field_3_input_2_dia) { echo "selected"; } ?>>13</OPTION>
          <OPTION value="14" <?php if ("14" == $sc_field_3_input_2_dia) { echo "selected"; } ?>>14</OPTION>
          <OPTION value="15" <?php if ("15" == $sc_field_3_input_2_dia) { echo "selected"; } ?>>15</OPTION>
          <OPTION value="16" <?php if ("16" == $sc_field_3_input_2_dia) { echo "selected"; } ?>>16</OPTION>
          <OPTION value="17" <?php if ("17" == $sc_field_3_input_2_dia) { echo "selected"; } ?>>17</OPTION>
          <OPTION value="18" <?php if ("18" == $sc_field_3_input_2_dia) { echo "selected"; } ?>>18</OPTION>
          <OPTION value="19" <?php if ("19" == $sc_field_3_input_2_dia) { echo "selected"; } ?>>19</OPTION>
          <OPTION value="20" <?php if ("20" == $sc_field_3_input_2_dia) { echo "selected"; } ?>>20</OPTION>
          <OPTION value="21" <?php if ("21" == $sc_field_3_input_2_dia) { echo "selected"; } ?>>21</OPTION>
          <OPTION value="22" <?php if ("22" == $sc_field_3_input_2_dia) { echo "selected"; } ?>>22</OPTION>
          <OPTION value="23" <?php if ("23" == $sc_field_3_input_2_dia) { echo "selected"; } ?>>23</OPTION>
          <OPTION value="24" <?php if ("24" == $sc_field_3_input_2_dia) { echo "selected"; } ?>>24</OPTION>
          <OPTION value="25" <?php if ("25" == $sc_field_3_input_2_dia) { echo "selected"; } ?>>25</OPTION>
          <OPTION value="26" <?php if ("26" == $sc_field_3_input_2_dia) { echo "selected"; } ?>>26</OPTION>
          <OPTION value="27" <?php if ("27" == $sc_field_3_input_2_dia) { echo "selected"; } ?>>27</OPTION>
          <OPTION value="28" <?php if ("28" == $sc_field_3_input_2_dia) { echo "selected"; } ?>>28</OPTION>
          <OPTION value="29" <?php if ("29" == $sc_field_3_input_2_dia) { echo "selected"; } ?>>29</OPTION>
          <OPTION value="30" <?php if ("30" == $sc_field_3_input_2_dia) { echo "selected"; } ?>>30</OPTION>
          <OPTION value="31" <?php if ("31" == $sc_field_3_input_2_dia) { echo "selected"; } ?>>31</OPTION>
         </SELECT>
         </span>
...
<?php
  ...
  {
?>
<span id='id_date_part_sc_field_3_input_2_MM' style='display: inline-block'>

         <SELECT class="scFilterObjectOdd" id="SC_sc_field_3_input_2_mes" name="sc_field_3_input_2_mes">
          <OPTION value=""></OPTION>
          <OPTION value="01" <?php if ("01" == $sc_field_3_input_2_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][0] ?></OPTION>
          <OPTION value="02" <?php if ("02" == $sc_field_3_input_2_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][1] ?></OPTION>
          <OPTION value="03" <?php if ("03" == $sc_field_3_input_2_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][2] ?></OPTION>
          <OPTION value="04" <?php if ("04" == $sc_field_3_input_2_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][3] ?></OPTION>
          <OPTION value="05" <?php if ("05" == $sc_field_3_input_2_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][4] ?></OPTION>
          <OPTION value="06" <?php if ("06" == $sc_field_3_input_2_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][5] ?></OPTION>
          <OPTION value="07" <?php if ("07" == $sc_field_3_input_2_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][6] ?></OPTION>
          <OPTION value="08" <?php if ("08" == $sc_field_3_input_2_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][7] ?></OPTION>
          <OPTION value="09" <?php if ("09" == $sc_field_3_input_2_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][8] ?></OPTION>
          <OPTION value="10" <?php if ("10" == $sc_field_3_input_2_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][9] ?></OPTION>
          <OPTION value="11" <?php if ("11" == $sc_field_3_input_2_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][10] ?></OPTION>
          <OPTION value="12" <?php if ("12" == $sc_field_3_input_2_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][11] ?></OPTION>
         </SELECT>
         </span>
...
<?php
  ...
  {
?>
<span id='id_date_part_sc_field_3_input_2_AAAA' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_sc_field_3_input_2_ano" name="sc_field_3_input_2_ano" value="<?php echo NM_encode_input($sc_field_3_input_2_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 <INPUT type="hidden" id="sc_sc_field_3_jq2">
</span>
...
?>
      ...
      <TD id='SC_tindakan_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['tindakan'])) ? $this->New_label['tindakan'] : "Tindakan"; ?></TD>
      
      <INPUT type="hidden" id="SC_tindakan_cond" name="tindakan_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_tindakan" <?php echo $str_hide_tindakan?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['tindakan'])) ? $this->New_label['tindakan'] : "Tindakan";
 $nmgp_tab_label .= "tindakan?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      $tindakan_look = substr($this->Db->qstr($tindakan), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct a.funcRoom from " . $this->Ini->nm_tabela . " where a.funcRoom = '$tindakan_look' order by a.funcRoom"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      {
          $sAutocompValue = $tindakan;
      }
?>
<INPUT  type="text" id="SC_tindakan" name="tindakan" value="<?php echo NM_encode_input($tindakan) ?>"  size=50 alt="{datatype: 'text', maxLength: 150, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_tindakan" name="tindakan_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 150, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
?>
<?php
   if (is_file("grid_laporan_ok_help.txt"))
   {
...
?>
<?php
   if ($nm_apl_dependente == 1 || (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_ok']['opc_psq'] && !$this->aba_iframe))
   {
...
<?php
       ...
       elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_ok']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_ok']['dashboard_info']['under_dashboard'])
       { }
       else 
       { 
?>
...
<?php
   ...
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_ok']['opc_psq'])
   {
...
<?php
    if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_ok']['prim_vez'] == "N") 
    {
?>
       <iframe id="nmsc_iframe_grid_laporan_ok" frameborder="0" marginwidth="0px" marginheight="0px" topmargin="0px" leftmargin="0px" align="center" height="1500px" name="nm_iframe_grid_laporan_ok" scrolling="auto" src="index.php?nmgp_opcao=pesq&script_case_init=<?php echo NM_encode_input($this->Ini->sc_page) ?>&script_case_session=<?php echo session_id() ?>" width="100%"></iframe>
<?php
    }
    else
    {
?>
       <iframe id="nmsc_iframe_grid_laporan_ok" frameborder="0" marginwidth="0px" marginheight="0px" topmargin="0px" leftmargin="0px" align="center" height="1500px" name="nm_iframe_grid_laporan_ok" scrolling="auto" src="" width="100%"></iframe>
<?php
    }
?>
<iframe id="nmsc_iframe_grid_laporan_ok_pesq"  name="nm_iframe_grid_laporan_ok_pesq" style= "display: none;" frameborder="0" marginwidth="0px" marginheight="0px" topmargin="0px" leftmargin="0px" src=""></iframe>
</td></tr></table></td></tr>
</TABLE>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_ok']['orig_pesq'] == "grid")
   {
...
?>
 ...
 {
    document.F1.target = "nm_iframe_grid_laporan_ok_pesq";
    document.F1.submit();
 }
 function nm_move()
 {
     document.getElementById('nmsc_iframe_grid_laporan_ok').contentWindow.nm_move('igual');
 }
 function limpa_form()
 {
   document.F1.reset();
   ...
   document.F1.sc_field_3_cond.value = 'bw';
   nm_campos_between(document.getElementById('id_vis_sc_field_3'), document.F1.sc_field_3_cond, 'sc_field_3');
   document.F1.sc_field_3_dia.value = "";
   document.F1.sc_field_3_mes.value = "";
   document.F1.sc_field_3_ano.value = "";
   document.F1.sc_field_3_input_2_dia.value = "";
   document.F1.sc_field_3_input_2_mes.value = "";
   document.F1.sc_field_3_input_2_ano.value = "";
   nm_campos_between(document.getElementById('id_vis_tindakan'), document.F1.tindakan_cond, 'tindakan');
   document.F1.tindakan.value = "";
   document.F1.tindakan_autocomp.value = "";
 }
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "simrskreatifmedia/grid_laporan_ok";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_ok']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_ok']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_ok']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_sc_field_3_cond'] = 'cond';
      $tp_fields['SC_sc_field_3_dia'] = 'text';
      $tp_fields['SC_sc_field_3_mes'] = 'text';
      $tp_fields['SC_sc_field_3_ano'] = 'text';
      $tp_fields['SC_sc_field_3_input_2_dia'] = 'text';
      $tp_fields['SC_sc_field_3_input_2_mes'] = 'text';
      $tp_fields['SC_sc_field_3_input_2_ano'] = 'text';
      $tp_fields['SC_tindakan_cond'] = 'cond';
      $tp_fields['SC_tindakan'] = 'text_aut';
      $tp_fields['id_ac_tindakan'] = 'text_aut';
      $tp_fields['SC_NM_operador'] = 'text';
      $tb_fields_esp['SC_tgl. tindakan_cond'] = 'SC_sc_field_3_cond';
      $tb_fields_esp['SC_tgl. tindakan_dia'] = 'SC_sc_field_3_dia';
      $tb_fields_esp['SC_tgl. tindakan_mes'] = 'SC_sc_field_3_mes';
      $tb_fields_esp['SC_tgl. tindakan_ano'] = 'SC_sc_field_3_ano';
      $tb_fields_esp['SC_tgl. tindakan_input_2_dia'] = 'SC_sc_field_3_input_2_dia';
      $tb_fields_esp['SC_tgl. tindakan_input_2_mes'] = 'SC_sc_field_3_input_2_mes';
      $tb_fields_esp['SC_tgl. tindakan_input_2_ano'] = 'SC_sc_field_3_input_2_ano';
      if (is_file($NM_patch))
      {
          $SC_V8    = false;
   ...
   {
      global $sc_field_3_cond, $sc_field_3, $sc_field_3_dia, $sc_field_3_mes, $sc_field_3_ano, $sc_field_3_input_2_dia, $sc_field_3_input_2_mes, $sc_field_3_input_2_ano,
             $tindakan_cond, $tindakan, $tindakan_autocomp, $nmgp_tab_label;

      $C_formatado = true;
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_conv_dados.php", "F", "nm_conv_limpa_dado") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
      if (!empty($tindakan_autocomp) && empty($tindakan))
      {
          $tindakan = $tindakan_autocomp;
      }
      $sc_field_3_cond_salva = $sc_field_3_cond; 
      if (!isset($sc_field_3_input_2_dia) || $sc_field_3_input_2_dia == "")
      {
          $sc_field_3_input_2_dia = $sc_field_3_dia;
      }
      if (!isset($sc_field_3_input_2_mes) || $sc_field_3_input_2_mes == "")
      {
          $sc_field_3_input_2_mes = $sc_field_3_mes;
      }
      if (!isset($sc_field_3_input_2_ano) || $sc_field_3_input_2_ano == "")
      {
          $sc_field_3_input_2_ano = $sc_field_3_ano;
      }
      $tindakan_cond_salva = $tindakan_cond; 
      if (!isset($tindakan_input_2) || $tindakan_input_2 == "")
      {
          $tindakan_input_2 = $tindakan;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_ok']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_ok']['campos_busca']['sc_field_3_dia'] = $sc_field_3_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_ok']['campos_busca']['sc_field_3_mes'] = $sc_field_3_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_ok']['campos_busca']['sc_field_3_ano'] = $sc_field_3_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_ok']['campos_busca']['sc_field_3_input_2_dia'] = $sc_field_3_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_ok']['campos_busca']['sc_field_3_input_2_mes'] = $sc_field_3_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_ok']['campos_busca']['sc_field_3_input_2_ano'] = $sc_field_3_input_2_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_ok']['campos_busca']['sc_field_3_cond'] = $sc_field_3_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_ok']['campos_busca']['tindakan'] = $tindakan; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_ok']['campos_busca']['tindakan_cond'] = $tindakan_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_ok']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_ok']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['tindakan'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['tindakan'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['tindakan'] = $tindakan;
      }

      //----- $sc_field_3
      $this->Date_part = false;
      if ($sc_field_3_cond != "bi_TP")
      {
          $sc_field_3_cond = strtoupper($sc_field_3_cond);
          $Dtxt = "";
          $val  = array();
          $Dtxt .= $sc_field_3_ano;
          $Dtxt .= $sc_field_3_mes;
          $Dtxt .= $sc_field_3_dia;
          $val[0]['ano'] = $sc_field_3_ano;
          $val[0]['mes'] = $sc_field_3_mes;
          $val[0]['dia'] = $sc_field_3_dia;
          if ($sc_field_3_cond == "BW")
          {
              $val[1]['ano'] = $sc_field_3_input_2_ano;
              $val[1]['mes'] = $sc_field_3_input_2_mes;
              $val[1]['dia'] = $sc_field_3_input_2_dia;
          }
          $this->Operador_date_part = "";
          $this->Lang_date_part     = "";
          $this->nm_prep_date($val, "DT", "DATETIME", $sc_field_3_cond, "", "data");
          if (!$this->Date_part) {
              $val[0] = $this->Ini->sc_Date_Protect($val[0]);
          }
          $sc_field_3 = $val[0];
          $this->cmp_formatado['sc_field_3'] = $val[0];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_ok']['campos_busca']['sc_field_3'] = $val[0];
          $this->nm_data->SetaData($this->cmp_formatado['sc_field_3'], "YYYY-MM-DD HH:II:SS");
          $this->cmp_formatado['sc_field_3'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DH", "dmY"));
          if ($sc_field_3_cond == "BW")
          {
              if (!$this->Date_part) {
                  $val[1] = $this->Ini->sc_Date_Protect($val[1]);
              }
              $sc_field_3_input_2     = $val[1];
              $this->cmp_formatado['sc_field_3_input_2'] = $val[1];
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_ok']['campos_busca']['sc_field_3_input_2'] = $val[1];
              $this->nm_data->SetaData($this->cmp_formatado['sc_field_3_input_2'], "YYYY-MM-DD HH:II:SS");
              $this->cmp_formatado['sc_field_3_input_2'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DH", "dmY"));
          }
          if (!empty($Dtxt) || $sc_field_3_cond == "NU" || $sc_field_3_cond == "NN"|| $sc_field_3_cond == "EP"|| $sc_field_3_cond == "NE")
          {
              $this->monta_condicao("a.operTime", $sc_field_3_cond, $sc_field_3, $sc_field_3_input_2, 'sc_field_3', 'DATETIME');
          }
      }

      //----- $tindakan
      $this->Date_part = false;
      if (isset($tindakan) || $tindakan_cond == "nu" || $tindakan_cond == "nn" || $tindakan_cond == "ep" || $tindakan_cond == "ne")
      {
         $this->monta_condicao("a.funcRoom", $tindakan_cond, $tindakan, "", "tindakan");
      }
   }
   ...
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_ok']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_ok']['cond_dyn_search'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_ok']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_ok']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_ok']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_ok']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_ok']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_ok']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_ok']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_ok']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_ok']['cond_pesq'] .= $this->NM_operador;
