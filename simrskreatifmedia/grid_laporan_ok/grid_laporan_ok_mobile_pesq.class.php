...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_sc_field_3"  <?php echo $str_hide_sc_field_3?>>
<?php
  $Form_base = "ddmmyyyy";
  $date_format_show = "";
...
?>
          ...
          <BR>
        <SPAN id="id_vis_sc_field_3"  <?php echo $str_display_sc_field_3; ?> class="scFilterFieldFontOdd">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_tindakan"  <?php echo $str_hide_tindakan?>><?php
      if ($tindakan != "")
      {
      $tindakan_look = substr($this->Db->qstr($tindakan), 1, -1); 
      $nmgp_def_dados = array(); 
...
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_tindakan" name="tindakan_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 150, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
