...
<?php
   ...
   $Ord_Cmp = new grid_laporan_ok_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_laporan_ok_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_laporan_ok']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_laporan_ok']['ordem_select_orig'] = array();
   }
   ...
   {
       $tab_def_campos['sc_field_1'] = "concat( b.NAME,' ',b.salut )";
   }
   $tab_labels["sc_field_1"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_laporan_ok']['labels']["sc_field_1"])) ? $_SESSION['sc_session'][$sc_init]['grid_laporan_ok']['labels']["sc_field_1"] : "Nama Pasien";
   ...
   {
       $tab_def_campos['sc_field_2'] = "a.custCode";
   }
   $tab_labels["sc_field_2"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_laporan_ok']['labels']["sc_field_2"])) ? $_SESSION['sc_session'][$sc_init]['grid_laporan_ok']['labels']["sc_field_2"] : "No RM";
   ...
   {
       $tab_def_campos['diagnosa'] = "SELECT sc_concat('Pre: ',diagPre,' | Post: ',diagPost)
FROM tbdetailok 
WHERE tranCode= '{Kode Transaksi}' 
ORDER BY diagPre, diagPost";
   }
   $tab_labels["diagnosa"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_laporan_ok']['labels']["diagnosa"])) ? $_SESSION['sc_session'][$sc_init]['grid_laporan_ok']['labels']["diagnosa"] : "Diagnosa";
   ...
   {
       $tab_def_campos['tindakan'] = "a.funcRoom";
   }
   $tab_labels["tindakan"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_laporan_ok']['labels']["tindakan"])) ? $_SESSION['sc_session'][$sc_init]['grid_laporan_ok']['labels']["tindakan"] : "Tindakan";
   ...
   {
       $tab_def_campos['sc_field_3'] = "a.operTime";
   }
   $tab_labels["sc_field_3"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_laporan_ok']['labels']["sc_field_3"])) ? $_SESSION['sc_session'][$sc_init]['grid_laporan_ok']['labels']["sc_field_3"] : "Tgl Tindakan";
   ...
   {
       $tab_def_campos['sc_field_4'] = "a.signinTime";
   }
   $tab_labels["sc_field_4"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_laporan_ok']['labels']["sc_field_4"])) ? $_SESSION['sc_session'][$sc_init]['grid_laporan_ok']['labels']["sc_field_4"] : "Jam Masuk";
   ...
   {
       $tab_def_campos['sc_field_5'] = "a.signoutTime";
   }
   $tab_labels["sc_field_5"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_laporan_ok']['labels']["sc_field_5"])) ? $_SESSION['sc_session'][$sc_init]['grid_laporan_ok']['labels']["sc_field_5"] : "Jam Keluar";
   $tab_ger_campos['detailtim'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['detailtim'] = "detailTim";
   }
   else
   {
       $tab_def_campos['detailtim'] = "";
   }
   $tab_labels["detailtim"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_laporan_ok']['labels']["detailtim"])) ? $_SESSION['sc_session'][$sc_init]['grid_laporan_ok']['labels']["detailtim"] : "Detail Tim";
   $tab_ger_campos['diagnosa'] = "none";
   $tab_ger_campos['detailtim'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_laporan_ok']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_laporan_ok']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_laporan_ok']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_laporan_ok']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_laporan_ok']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_laporan_ok']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_laporan_ok']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_laporan_ok']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_laporan_ok']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_laporan_ok_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_laporan_ok']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_laporan_ok']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_laporan_ok']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_laporan_ok']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_laporan_ok']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
