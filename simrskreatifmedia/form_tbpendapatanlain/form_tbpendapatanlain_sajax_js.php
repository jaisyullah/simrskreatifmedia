  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbpendapatanlain" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbpendapatanlain_form();
	}

  // ---------- Validate trancode
  function do_ajax_form_tbpendapatanlain_validate_trancode()
  {
    var nomeCampo_trancode = "trancode";
    var var_trancode = scAjaxGetFieldText(nomeCampo_trancode);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbpendapatanlain_validate_trancode(var_trancode, var_script_case_init, do_ajax_form_tbpendapatanlain_validate_trancode_cb);
  } // do_ajax_form_tbpendapatanlain_validate_trancode

  function do_ajax_form_tbpendapatanlain_validate_trancode_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbpendapatanlain_validate_trancode_cb

  // ---------- Validate custcode
  function do_ajax_form_tbpendapatanlain_validate_custcode()
  {
    var nomeCampo_custcode = "custcode";
    var var_custcode = scAjaxGetFieldText(nomeCampo_custcode);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbpendapatanlain_validate_custcode(var_custcode, var_script_case_init, do_ajax_form_tbpendapatanlain_validate_custcode_cb);
  } // do_ajax_form_tbpendapatanlain_validate_custcode

  function do_ajax_form_tbpendapatanlain_validate_custcode_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbpendapatanlain_validate_custcode_cb

  // ---------- Validate keterangan
  function do_ajax_form_tbpendapatanlain_validate_keterangan()
  {
    var nomeCampo_keterangan = "keterangan";
    var var_keterangan = scAjaxGetFieldText(nomeCampo_keterangan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbpendapatanlain_validate_keterangan(var_keterangan, var_script_case_init, do_ajax_form_tbpendapatanlain_validate_keterangan_cb);
  } // do_ajax_form_tbpendapatanlain_validate_keterangan

  function do_ajax_form_tbpendapatanlain_validate_keterangan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbpendapatanlain_validate_keterangan_cb

  // ---------- Validate dari
  function do_ajax_form_tbpendapatanlain_validate_dari()
  {
    var nomeCampo_dari = "dari";
    var var_dari = scAjaxGetFieldText(nomeCampo_dari);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbpendapatanlain_validate_dari(var_dari, var_script_case_init, do_ajax_form_tbpendapatanlain_validate_dari_cb);
  } // do_ajax_form_tbpendapatanlain_validate_dari

  function do_ajax_form_tbpendapatanlain_validate_dari_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "dari";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbpendapatanlain_validate_dari_cb

  // ---------- Validate total
  function do_ajax_form_tbpendapatanlain_validate_total()
  {
    var nomeCampo_total = "total";
    var var_total = scAjaxGetFieldText(nomeCampo_total);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbpendapatanlain_validate_total(var_total, var_script_case_init, do_ajax_form_tbpendapatanlain_validate_total_cb);
  } // do_ajax_form_tbpendapatanlain_validate_total

  function do_ajax_form_tbpendapatanlain_validate_total_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "total";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbpendapatanlain_validate_total_cb

  // ---------- Validate jenispayment
  function do_ajax_form_tbpendapatanlain_validate_jenispayment()
  {
    var nomeCampo_jenispayment = "jenispayment";
    var var_jenispayment = scAjaxGetFieldSelect(nomeCampo_jenispayment);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbpendapatanlain_validate_jenispayment(var_jenispayment, var_script_case_init, do_ajax_form_tbpendapatanlain_validate_jenispayment_cb);
  } // do_ajax_form_tbpendapatanlain_validate_jenispayment

  function do_ajax_form_tbpendapatanlain_validate_jenispayment_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbpendapatanlain_validate_jenispayment_cb

  // ---------- Validate edc1
  function do_ajax_form_tbpendapatanlain_validate_edc1()
  {
    var nomeCampo_edc1 = "edc1";
    var var_edc1 = scAjaxGetFieldSelect(nomeCampo_edc1);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbpendapatanlain_validate_edc1(var_edc1, var_script_case_init, do_ajax_form_tbpendapatanlain_validate_edc1_cb);
  } // do_ajax_form_tbpendapatanlain_validate_edc1

  function do_ajax_form_tbpendapatanlain_validate_edc1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "edc1";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbpendapatanlain_validate_edc1_cb

  // ---------- Validate edc2
  function do_ajax_form_tbpendapatanlain_validate_edc2()
  {
    var nomeCampo_edc2 = "edc2";
    var var_edc2 = scAjaxGetFieldSelect(nomeCampo_edc2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbpendapatanlain_validate_edc2(var_edc2, var_script_case_init, do_ajax_form_tbpendapatanlain_validate_edc2_cb);
  } // do_ajax_form_tbpendapatanlain_validate_edc2

  function do_ajax_form_tbpendapatanlain_validate_edc2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "edc2";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbpendapatanlain_validate_edc2_cb

  // ---------- Validate kasir
  function do_ajax_form_tbpendapatanlain_validate_kasir()
  {
    var nomeCampo_kasir = "kasir";
    var var_kasir = scAjaxGetFieldText(nomeCampo_kasir);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbpendapatanlain_validate_kasir(var_kasir, var_script_case_init, do_ajax_form_tbpendapatanlain_validate_kasir_cb);
  } // do_ajax_form_tbpendapatanlain_validate_kasir

  function do_ajax_form_tbpendapatanlain_validate_kasir_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "kasir";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbpendapatanlain_validate_kasir_cb

  // ---------- Refresh custcode
  function do_ajax_form_tbpendapatanlain_refresh_custcode()
  {
    var var_custcode = scAjaxGetFieldText("custcode");
    var var_nmgp_refresh_fields = "dari";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tbpendapatanlain_refresh_custcode(var_custcode, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_tbpendapatanlain_refresh_custcode_cb);
  } // do_ajax_form_tbpendapatanlain_refresh_custcode

  function do_ajax_form_tbpendapatanlain_refresh_custcode_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbpendapatanlain_refresh_custcode_cb

  // ---------- Event onchange custcode
  function do_ajax_form_tbpendapatanlain_event_custcode_onchange()
  {
    var var_custcode = scAjaxGetFieldText("custcode");
    var var_dari = scAjaxGetFieldText("dari");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tbpendapatanlain_event_custcode_onchange(var_custcode, var_dari, var_script_case_init, do_ajax_form_tbpendapatanlain_event_custcode_onchange_cb);
  } // do_ajax_form_tbpendapatanlain_event_custcode_onchange

  function do_ajax_form_tbpendapatanlain_event_custcode_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "custcode";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_tbpendapatanlain_event_custcode_onchange_cb_after_alert);
  } // do_ajax_form_tbpendapatanlain_event_custcode_onchange_cb
  function do_ajax_form_tbpendapatanlain_event_custcode_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    do_ajax_form_tbpendapatanlain_refresh_custcode();
  ...
  } // do_ajax_form_tbpendapatanlain_event_custcode_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tbpendapatanlain_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tbpendapatanlain_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_tbpendapatanlain_submit_form(var_trancode, var_custcode, var_keterangan, var_dari, var_total, var_jenispayment, var_edc1, var_edc2, var_kasir, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbpendapatanlain_submit_form_cb);
  } // do_ajax_form_tbpendapatanlain_submit_form

  function do_ajax_form_tbpendapatanlain_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tbpendapatanlain_submit_form_cb_after_alert);
  } // do_ajax_form_tbpendapatanlain_submit_form_cb
  function do_ajax_form_tbpendapatanlain_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbpendapatanlain_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tbpendapatanlain_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tbpendapatanlain_navigate_form(var_trancode, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbpendapatanlain_navigate_form_cb);
  } // do_ajax_form_tbpendapatanlain_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbpendapatanlain']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbpendapatanlain_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbpendapatanlain_navigate_form_cb_after_alert);
  } // do_ajax_form_tbpendapatanlain_navigate_form_cb
  function do_ajax_form_tbpendapatanlain_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_tbpendapatanlain_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_tbpendapatanlain_navigate_form_cb_after_alert
  function sc_hide_form_tbpendapatanlain_form()
  {
