...
$old_error_handler = set_error_handler("form_tbpendapatanlain_scriptcase_error_handler");

function form_tbpendapatanlain_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['form_tbpendapatanlain']['contr_erro']) && $_SESSION['scriptcase']['form_tbpendapatanlain']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_form_tbpendapatanlain->contr_form_tbpendapatanlain->Apl_com_erro = true;
            if ($inicial_form_tbpendapatanlain->contr_form_tbpendapatanlain->NM_ajax_flag)
            {
                $inicial_form_tbpendapatanlain->contr_form_tbpendapatanlain->NM_ajax_info['errList']['geral_form_tbpendapatanlain'][] = $msg;
                return;
            }
            form_tbpendapatanlain_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function form_tbpendapatanlain_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['form_tbpendapatanlain'])  && '' != $_SESSION['scriptcase']['error_icon']['form_tbpendapatanlain'])  ? $_SESSION['scriptcase']['error_icon']['form_tbpendapatanlain']  : "";
        $sCloseIcon      = (isset($_SESSION['scriptcase']['error_close']['form_tbpendapatanlain']) && '' != $_SESSION['scriptcase']['error_close']['form_tbpendapatanlain']) ? $_SESSION['scriptcase']['error_close']['form_tbpendapatanlain'] : "<td><input class=\"scButton_default\" type=\"button\" onClick=\"document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false\" value=\"X\" /></td>";

        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['form_tbpendapatanlain']) && '' != $_SESSION['scriptcase']['error_span_title']['form_tbpendapatanlain']) ? $_SESSION['scriptcase']['error_span_title']['form_tbpendapatanlain'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['form_tbpendapatanlain']) && '' != $_SESSION['scriptcase']['error_icon_title']['form_tbpendapatanlain']) ? $_SESSION['scriptcase']['error_icon_title']['form_tbpendapatanlain'] : '';
?>
