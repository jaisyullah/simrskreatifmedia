...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbpendapatanlain']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
  <input type="hidden" name="script_case_session" value="<?php echo $this->form_encode_input(session_id()); ?>"> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_tbpendapatanlain"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
?> 
var var_btn_sc_btn_0_payno = "<?php echo $this->form_encode_input($this->nmgp_dados_form['trancode']); ?>";
function sc_btn_sc_btn_0()
{
    ...
    scJs_confirm("<?php echo html_entity_decode('Apakah Anda ingin cetak kwitansi pembayaran ?', ENT_COMPAT, $_SESSION['scriptcase']['charset']); ?>", sc_btn_sc_btn_0_ok, sc_btn_sc_btn_0_cancel);
}
...
{
      nm_gp_submit('<?php echo $this->Ini->link_cetak_lain; ?>', '<?php echo $this->nm_location; ?>', '<?php echo "payno*scin' + var_btn_sc_btn_0_payno + '*scout"; ?>', '', '_blank', '0', '0', 'cetak_lain');
}
 NM_tp_critica(1);
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbpendapatanlain']['where_detal']))
  {
?>  
...
{
   nm_field_disabled("kasir=disabled", "");
