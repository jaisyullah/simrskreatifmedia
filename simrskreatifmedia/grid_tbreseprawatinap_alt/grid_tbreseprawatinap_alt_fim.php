...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_tbreseprawatinap_alt"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_tbreseprawatinap_alt"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_tbreseprawatinap'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tbreseprawatinap_alt']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_tbreseprawatinap_alt']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tbreseprawatinap_alt']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_tbreseprawatinap_alt']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_tbreseprawatinap_alt']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_tbreseprawatinap_alt</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_tbreseprawatinap_alt']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_tbreseprawatinap_alt']['embutida_filho'] as $ind => $sc_init)
          {
