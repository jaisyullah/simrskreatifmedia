...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "tranDate";$Nm_datas[] = "tranDate";$Nm_numeric[] = "id";$Nm_numeric[] = "jumlah";$Nm_numeric[] = "biaya";$Nm_numeric[] = "diskon";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_satuan_cond" name="satuan_cond" onChange="nm_campos_between(document.getElementById('id_vis_satuan'), this, 'satuan')">
      ...
      <br><span id="id_hide_satuan"  <?php echo $str_hide_satuan?>><?php
      if ($satuan != "")
      {
      $satuan_look = substr($this->Db->qstr($satuan), 1, -1); 
      $nmgp_def_dados = array(); 
