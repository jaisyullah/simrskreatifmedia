<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tbreseprawatinap_alt']['sc_process_barr'] = true;
require_once('../grid_tbreseprawatinap_alt/index.php');
unset($_SESSION['scriptcase']['grid_tbreseprawatinap_alt']['sc_process_barr']);
$ExportCtrl = new grid_tbreseprawatinap_alt_export_control;
$ExportCtrl->Export_barr();

class grid_tbreseprawatinap_alt_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_title'] ?> tbreseprawatinap :: Excel</TITLE>
