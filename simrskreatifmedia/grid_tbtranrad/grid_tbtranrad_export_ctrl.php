<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tbtranrad']['sc_process_barr'] = true;
require_once('../grid_tbtranrad/index.php');
unset($_SESSION['scriptcase']['grid_tbtranrad']['sc_process_barr']);
$ExportCtrl = new grid_tbtranrad_export_control;
$ExportCtrl->Export_barr();

class grid_tbtranrad_export_control
{
