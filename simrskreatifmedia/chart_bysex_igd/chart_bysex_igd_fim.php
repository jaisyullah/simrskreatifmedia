...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____chart_bysex_igd"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____chart_bysex_igd"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['chart_bysex_igd']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['chart_bysex_igd']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['chart_bysex_igd']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['chart_bysex_igd']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['chart_bysex_igd']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['chart_bysex_igd']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['chart_bysex_igd']['embutida_filho'] as $ind => $sc_init)
          {
