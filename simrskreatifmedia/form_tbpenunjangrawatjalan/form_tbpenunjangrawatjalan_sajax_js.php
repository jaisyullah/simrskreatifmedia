  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbpenunjangrawatjalan" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbpenunjangrawatjalan_form();
	}

  // ---------- Validate jenispenunjang_
  function do_ajax_form_tbpenunjangrawatjalan_validate_jenispenunjang_(iNumLinha)
  {
    var nomeCampo_jenispenunjang_ = "jenispenunjang_" + iNumLinha;
    var var_jenispenunjang_ = scAjaxGetFieldSelect(nomeCampo_jenispenunjang_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbpenunjangrawatjalan_validate_jenispenunjang_(var_jenispenunjang_, iNumLinha, var_script_case_init, do_ajax_form_tbpenunjangrawatjalan_validate_jenispenunjang__cb);
  } // do_ajax_form_tbpenunjangrawatjalan_validate_jenispenunjang_

  function do_ajax_form_tbpenunjangrawatjalan_validate_jenispenunjang__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "jenispenunjang_" + iLineNumber;
    }
    else
    {
      sFieldValid = "jenispenunjang_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "jenispenunjang_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "jenispenunjang_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbpenunjangrawatjalan_validate_jenispenunjang__cb

  // ---------- Validate pemeriksaanpenunjang_
  function do_ajax_form_tbpenunjangrawatjalan_validate_pemeriksaanpenunjang_(iNumLinha)
  {
  } // do_ajax_form_tbpenunjangrawatjalan_validate_pemeriksaanpenunjang_

  function do_ajax_form_tbpenunjangrawatjalan_validate_pemeriksaanpenunjang__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "pemeriksaanpenunjang_" + iLineNumber;
    }
    else
    {
      sFieldValid = "pemeriksaanpenunjang_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "pemeriksaanpenunjang_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "pemeriksaanpenunjang_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbpenunjangrawatjalan_validate_pemeriksaanpenunjang__cb

  // ---------- Validate jumlah_
  function do_ajax_form_tbpenunjangrawatjalan_validate_jumlah_(iNumLinha)
  {
    var nomeCampo_jumlah_ = "jumlah_" + iNumLinha;
    var var_jumlah_ = scAjaxGetFieldText(nomeCampo_jumlah_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbpenunjangrawatjalan_validate_jumlah_(var_jumlah_, iNumLinha, var_script_case_init, do_ajax_form_tbpenunjangrawatjalan_validate_jumlah__cb);
  } // do_ajax_form_tbpenunjangrawatjalan_validate_jumlah_

  function do_ajax_form_tbpenunjangrawatjalan_validate_jumlah__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbpenunjangrawatjalan_validate_jumlah__cb

  // ---------- Validate id_
  function do_ajax_form_tbpenunjangrawatjalan_validate_id_(iNumLinha)
  {
    var nomeCampo_id_ = "id_" + iNumLinha;
    var var_id_ = scAjaxGetFieldHidden(nomeCampo_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbpenunjangrawatjalan_validate_id_(var_id_, iNumLinha, var_script_case_init, do_ajax_form_tbpenunjangrawatjalan_validate_id__cb);
  } // do_ajax_form_tbpenunjangrawatjalan_validate_id_

  function do_ajax_form_tbpenunjangrawatjalan_validate_id__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbpenunjangrawatjalan_validate_id__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_tbpenunjangrawatjalan_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_tbpenunjangrawatjalan_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tbpenunjangrawatjalan_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_tbpenunjangrawatjalan_add_new_line_cb);
  } // do_ajax_form_tbpenunjangrawatjalan_add_new_line

  function do_ajax_form_tbpenunjangrawatjalan_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_tbpenunjangrawatjalan_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_tbpenunjangrawatjalan_backup_line(iNumLinha)
  {
    var var_id_ = scAjaxGetFieldHidden("id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbpenunjangrawatjalan_backup_line(var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_tbpenunjangrawatjalan_backup_line_cb);
  } // do_ajax_form_tbpenunjangrawatjalan_backup_line

  function do_ajax_form_tbpenunjangrawatjalan_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_tbpenunjangrawatjalan_backup_line_cb

  function do_ajax_form_tbpenunjangrawatjalan_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_tbpenunjangrawatjalan_cancel_insert

  function do_ajax_form_tbpenunjangrawatjalan_cancel_update(iSeqVert)
  {
    do_ajax_form_tbpenunjangrawatjalan_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_tbpenunjangrawatjalan_cancel_update

  function do_ajax_form_tbpenunjangrawatjalan_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_tbpenunjangrawatjalan_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_tbpenunjangrawatjalan_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_tbpenunjangrawatjalan_table_refresh(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbpenunjangrawatjalan_table_refresh_cb);
  } //  do_ajax_form_tbpenunjangrawatjalan_table_refresh

  function do_ajax_form_tbpenunjangrawatjalan_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_tbpenunjangrawatjalan_table_refresh_cb_after_alert);
  } // do_ajax_form_tbpenunjangrawatjalan_table_refresh_cb
  function do_ajax_form_tbpenunjangrawatjalan_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxSetNavStatus("t");
    sc_insert_open = false;
  } // do_ajax_form_tbpenunjangrawatjalan_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_tbpenunjangrawatjalan_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_tbpenunjangrawatjalan_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    sc_num_ult_line = iNumLinha;
    sc_num_ult_tr   = indexTR;
    scAjaxHideMessage();
    var var_jenispenunjang_ = scAjaxGetFieldSelect("jenispenunjang_" + iNumLinha);
    var var_pemeriksaanpenunjang_ = scAjaxGetFieldText("pemeriksaanpenunjang_" + iNumLinha);
...
?>
    x_ajax_form_tbpenunjangrawatjalan_submit_form(var_jenispenunjang_, var_pemeriksaanpenunjang_, var_jumlah_, var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbpenunjangrawatjalan_submit_form_cb);
  } // do_ajax_form_tbpenunjangrawatjalan_submit_form

  function do_ajax_form_tbpenunjangrawatjalan_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("jenispenunjang_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("pemeriksaanpenunjang_" + sc_num_ult_line);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_tbpenunjangrawatjalan_submit_form_cb_after_alert);
  } // do_ajax_form_tbpenunjangrawatjalan_submit_form_cb
  function do_ajax_form_tbpenunjangrawatjalan_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbpenunjangrawatjalan_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tbpenunjangrawatjalan_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_tbpenunjangrawatjalan_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("jenispenunjang_" + iNavForm);
      scAjaxHideErrorDisplay("pemeriksaanpenunjang_" + iNavForm);
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tbpenunjangrawatjalan_navigate_form(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbpenunjangrawatjalan_navigate_form_cb);
  } // do_ajax_form_tbpenunjangrawatjalan_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbpenunjangrawatjalan']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbpenunjangrawatjalan_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbpenunjangrawatjalan_navigate_form_cb_after_alert);
  } // do_ajax_form_tbpenunjangrawatjalan_navigate_form_cb
  function do_ajax_form_tbpenunjangrawatjalan_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_tbpenunjangrawatjalan_navigate_form_cb_after_alert
  function sc_hide_form_tbpenunjangrawatjalan_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "jenispenunjang_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "pemeriksaanpenunjang_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "jumlah_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "id_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["jenispenunjang_" + iNumLinha] = {"label": "Jenis Penunjang<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["pemeriksaanpenunjang_" + iNumLinha] = {"label": "Pemeriksaan Penunjang<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_field_mult["jenispenunjang_"][iNumLinha] = "jenispenunjang_" + iNumLinha;
    ajax_field_mult["pemeriksaanpenunjang_"][iNumLinha] = "pemeriksaanpenunjang_" + iNumLinha;
    ajax_field_mult["jumlah_"][iNumLinha] = "jumlah_" + iNumLinha;
    ajax_field_mult["id_"][iNumLinha] = "id_" + iNumLinha;
    ajax_field_id["jenispenunjang_" + iNumLinha] = new Array("hidden_field_label_jenispenunjang_", "hidden_field_data_jenispenunjang_" + iNumLinha);
    ajax_field_id["pemeriksaanpenunjang_" + iNumLinha] = new Array("hidden_field_label_pemeriksaanpenunjang_", "hidden_field_data_pemeriksaanpenunjang_" + iNumLinha);
    ajax_field_id["jumlah_" + iNumLinha] = new Array("hidden_field_label_jumlah_", "hidden_field_data_jumlah_" + iNumLinha);
    ajax_error_count["jenispenunjang_" + iNumLinha] = "off";
    ajax_error_count["pemeriksaanpenunjang_" + iNumLinha] = "off";
...
{
?>
    ajax_read_only["jenispenunjang_" + iNumLinha] = "off";
    ajax_read_only["pemeriksaanpenunjang_" + iNumLinha] = "off";
...
{
?>
    ajax_read_only["jenispenunjang_" + iNumLinha] = "on";
    ajax_read_only["pemeriksaanpenunjang_" + iNumLinha] = "on";
...
?>
  ...
  {
    ajax_error_list["jenispenunjang_" + iNumLinha] = null;
    ajax_error_list["pemeriksaanpenunjang_" + iNumLinha] = null;
  ...
  var ajax_field_mult = {
    "jenispenunjang_": new Array(),
    "pemeriksaanpenunjang_": new Array(),
    "jumlah_": new Array(),
    "id_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["jenispenunjang_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["jenispenunjang_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["jenispenunjang_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["jenispenunjang_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["jenispenunjang_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["pemeriksaanpenunjang_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["pemeriksaanpenunjang_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["pemeriksaanpenunjang_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["pemeriksaanpenunjang_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["pemeriksaanpenunjang_" + iNumLinha]["onfocus"] = new Array();
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['jenispenunjang_'])) ? $this->nmgp_cmp_readonly['jenispenunjang_'] : 'off';
?>
    scAjaxFieldRead("jenispenunjang_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['pemeriksaanpenunjang_'])) ? $this->nmgp_cmp_readonly['pemeriksaanpenunjang_'] : 'off';
?>
    scAjaxFieldRead("pemeriksaanpenunjang_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
?>
  ...
  {
    scAjaxFieldRead("jenispenunjang_" + iSeq, "on");
    scAjaxFieldRead("pemeriksaanpenunjang_" + iSeq, "on");
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["jenispenunjang_" + iRow] || "on" == ajax_error_count["pemeriksaanpenunjang_" + iRow] || "on" == ajax_error_count["jumlah_" + iRow] || "on" == ajax_error_count["id_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_jenispenunjang_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_pemeriksaanpenunjang_" + iRow).addClass("scFormErrorLine");
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["jenispenunjang_" + iRow] && "off" == ajax_error_count["pemeriksaanpenunjang_" + iRow] && "off" == ajax_error_count["jumlah_" + iRow] && "off" == ajax_error_count["id_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["jenispenunjang_" + iRow] = "off";
        ajax_error_count["pemeriksaanpenunjang_" + iRow] = "off";
      ...
      $("#hidden_field_data_jenispenunjang_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_pemeriksaanpenunjang_" + iRow).removeClass("scFormErrorLine");
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("pemeriksaanpenunjang_" == sIndex)
    {
