  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbfornas_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbfornas_mob_form();
	}

  // ---------- Validate id
  function do_ajax_form_tbfornas_mob_validate_id()
  {
    var nomeCampo_id = "id";
    var var_id = scAjaxGetFieldHidden(nomeCampo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbfornas_mob_validate_id(var_id, var_script_case_init, do_ajax_form_tbfornas_mob_validate_id_cb);
  } // do_ajax_form_tbfornas_mob_validate_id

  function do_ajax_form_tbfornas_mob_validate_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbfornas_mob_validate_id_cb

  // ---------- Validate nama_obat
  function do_ajax_form_tbfornas_mob_validate_nama_obat()
  {
    var nomeCampo_nama_obat = "nama_obat";
    var var_nama_obat = scAjaxGetFieldText(nomeCampo_nama_obat);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbfornas_mob_validate_nama_obat(var_nama_obat, var_script_case_init, do_ajax_form_tbfornas_mob_validate_nama_obat_cb);
  } // do_ajax_form_tbfornas_mob_validate_nama_obat

  function do_ajax_form_tbfornas_mob_validate_nama_obat_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nama_obat";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbfornas_mob_validate_nama_obat_cb

  // ---------- Validate satuan
  function do_ajax_form_tbfornas_mob_validate_satuan()
  {
    var nomeCampo_satuan = "satuan";
    var var_satuan = scAjaxGetFieldText(nomeCampo_satuan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbfornas_mob_validate_satuan(var_satuan, var_script_case_init, do_ajax_form_tbfornas_mob_validate_satuan_cb);
  } // do_ajax_form_tbfornas_mob_validate_satuan

  function do_ajax_form_tbfornas_mob_validate_satuan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "satuan";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbfornas_mob_validate_satuan_cb

  // ---------- Validate keterangan
  function do_ajax_form_tbfornas_mob_validate_keterangan()
  {
    var nomeCampo_keterangan = "keterangan";
    var var_keterangan = scAjaxGetFieldText(nomeCampo_keterangan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbfornas_mob_validate_keterangan(var_keterangan, var_script_case_init, do_ajax_form_tbfornas_mob_validate_keterangan_cb);
  } // do_ajax_form_tbfornas_mob_validate_keterangan

  function do_ajax_form_tbfornas_mob_validate_keterangan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbfornas_mob_validate_keterangan_cb

  // ---------- Validate maks_usage
  function do_ajax_form_tbfornas_mob_validate_maks_usage()
  {
    var nomeCampo_maks_usage = "maks_usage";
    var var_maks_usage = scAjaxGetFieldText(nomeCampo_maks_usage);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbfornas_mob_validate_maks_usage(var_maks_usage, var_script_case_init, do_ajax_form_tbfornas_mob_validate_maks_usage_cb);
  } // do_ajax_form_tbfornas_mob_validate_maks_usage

  function do_ajax_form_tbfornas_mob_validate_maks_usage_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "maks_usage";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbfornas_mob_validate_maks_usage_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tbfornas_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tbfornas_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id = scAjaxGetFieldHidden("id");
    var var_nama_obat = scAjaxGetFieldText("nama_obat");
    var var_satuan = scAjaxGetFieldText("satuan");
    var var_keterangan = scAjaxGetFieldText("keterangan");
    var var_maks_usage = scAjaxGetFieldText("maks_usage");
    ...
    scAjaxProcOn();
    x_ajax_form_tbfornas_mob_submit_form(var_id, var_nama_obat, var_satuan, var_keterangan, var_maks_usage, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbfornas_mob_submit_form_cb);
  } // do_ajax_form_tbfornas_mob_submit_form

  function do_ajax_form_tbfornas_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("nama_obat");
      scAjaxHideErrorDisplay("satuan");
      scAjaxHideErrorDisplay("keterangan");
      scAjaxHideErrorDisplay("maks_usage");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tbfornas_mob_submit_form_cb_after_alert);
  } // do_ajax_form_tbfornas_mob_submit_form_cb
  function do_ajax_form_tbfornas_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbfornas_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tbfornas_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_tbfornas_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbfornas_mob_navigate_form_cb);
  } // do_ajax_form_tbfornas_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbfornas_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbfornas_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbfornas_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_tbfornas_mob_navigate_form_cb
  function do_ajax_form_tbfornas_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_tbfornas_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_tbfornas_mob_navigate_form_cb_after_alert
  function sc_hide_form_tbfornas_mob_form()
  {
  ...
  ajax_field_list[1] = "nama_obat";
  ajax_field_list[2] = "satuan";
  ajax_field_list[3] = "keterangan";
  ajax_field_list[4] = "maks_usage";
  ...
  var ajax_error_list = {
    ...
    "nama_obat": {"label": "Nama Obat", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "maks_usage": {"label": "Maks Usage", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    ...
    "maks_usage": new Array()
  };
  ajax_field_mult["id"][1] = "id";
  ajax_field_mult["nama_obat"][1] = "nama_obat";
  ajax_field_mult["satuan"][1] = "satuan";
  ajax_field_mult["keterangan"][1] = "keterangan";
  ajax_field_mult["maks_usage"][1] = "maks_usage";

  var ajax_field_id = {
    "id": new Array("hidden_field_label_id", "hidden_field_data_id"),
    "nama_obat": new Array("hidden_field_label_nama_obat", "hidden_field_data_nama_obat"),
    ...
    "maks_usage": new Array("hidden_field_label_maks_usage", "hidden_field_data_maks_usage")
  };
