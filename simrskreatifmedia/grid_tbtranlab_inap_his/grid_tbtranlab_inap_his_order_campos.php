<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_tbtranlab_inap_his']['glo_nm_path_imag_temp'] . "/sc_apl_default_simrskreatifmedia.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_tbtranlab_inap_his_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_tbtranlab_inap_his_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbtranlab_inap_his']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tbtranlab_inap_his']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["trancode"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbtranlab_inap_his']['labels']["trancode"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbtranlab_inap_his']['labels']["trancode"] : "Kode Transaksi";
   $tab_ger_campos['struk'] = "on";
   $tab_def_campos['struk'] = "struk";
   $tab_labels["struk"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbtranlab_inap_his']['labels']["struk"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbtranlab_inap_his']['labels']["struk"] : "No Struk";
   $tab_ger_campos['custcode'] = "on";
   $tab_def_campos['custcode'] = "custcode";
   $tab_labels["custcode"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbtranlab_inap_his']['labels']["custcode"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbtranlab_inap_his']['labels']["custcode"] : "No. RM";
...
ORDER BY name, salut";
   ...
   $tab_labels["nama"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbtranlab_inap_his']['labels']["nama"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbtranlab_inap_his']['labels']["nama"] : "Nama";
...
ORDER BY sex";
   ...
   $tab_labels["sc_field_0"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbtranlab_inap_his']['labels']["sc_field_0"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbtranlab_inap_his']['labels']["sc_field_0"] : "J/K";
   $tab_ger_campos['inapcode'] = "on";
   $tab_def_campos['inapcode'] = "inapcode";
   $tab_labels["inapcode"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbtranlab_inap_his']['labels']["inapcode"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbtranlab_inap_his']['labels']["inapcode"] : "Kode Inap";
   $tab_ger_campos['docname'] = "on";
   $tab_def_campos['docname'] = "docname";
   $tab_labels["docname"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbtranlab_inap_his']['labels']["docname"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbtranlab_inap_his']['labels']["docname"] : "Nama Dokter";
   $tab_ger_campos['trandate'] = "on";
   $tab_def_campos['trandate'] = "trandate";
   $tab_labels["trandate"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbtranlab_inap_his']['labels']["trandate"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbtranlab_inap_his']['labels']["trandate"] : "Tgl. Transaksi";
   $tab_ger_campos['takendate'] = "on";
   $tab_def_campos['takendate'] = "takendate";
   $tab_labels["takendate"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbtranlab_inap_his']['labels']["takendate"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbtranlab_inap_his']['labels']["takendate"] : "Tgl. Diambil";
   $tab_ger_campos['finishdate'] = "on";
   $tab_def_campos['finishdate'] = "finishdate";
   $tab_labels["finishdate"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbtranlab_inap_his']['labels']["finishdate"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbtranlab_inap_his']['labels']["finishdate"] : "Tgl. Selesai";
   $tab_ger_campos['status'] = "on";
   $tab_def_campos['status'] = "status";
   $tab_labels["status"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbtranlab_inap_his']['labels']["status"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbtranlab_inap_his']['labels']["status"] : "Status";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_tbtranlab_inap_his']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_tbtranlab_inap_his']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_tbtranlab_inap_his']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbtranlab_inap_his']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tbtranlab_inap_his']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_tbtranlab_inap_his']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_tbtranlab_inap_his']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_tbtranlab_inap_his']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_tbtranlab_inap_his']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_tbtranlab_inap_his_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_tbtranlab_inap_his']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_tbtranlab_inap_his']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_tbtranlab_inap_his']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_tbtranlab_inap_his']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_tbtranlab_inap_his']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
