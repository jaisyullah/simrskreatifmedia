...
class grid_usulanpengadaan_gizi_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usulanpengadaan_gizi']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_usulanpengadaan_gizi_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_usulanpengadaan_gizi_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_usulanpengadaan_gizi_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_nopo')
      {
          $nopo = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_nopo($nopo);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_usulancode')
      {
          $usulancode = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_usulancode($usulancode);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function lookup_ajax_nopo($nopo)
   {
      $nopo = substr($this->Db->qstr($nopo), 1, -1);
            $nopo_look = substr($this->Db->qstr($nopo), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct noPO from " . $this->Ini->nm_tabela . " where selesai <> 'C' and  noPO like '%" . $nopo . "%' order by noPO"; 
      unset($cmp1,$cmp2);
   ...
   function lookup_ajax_id($id)
   {
      ...
      {
          $nm_comando = "select distinct id from " . $this->Ini->nm_tabela . " where selesai <> 'C' and   CAST (id AS TEXT)  like '%" . $id . "%' order by id"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct id from " . $this->Ini->nm_tabela . " where selesai <> 'C' and   CAST (id AS VARCHAR)  like '%" . $id . "%' order by id"; 
      }
      else
      {
          $nm_comando = "select distinct id from " . $this->Ini->nm_tabela . " where selesai <> 'C' and  id like '%" . $id . "%' order by id"; 
      }
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
   ...
   function lookup_ajax_usulancode($usulancode)
   {
      $usulancode = substr($this->Db->qstr($usulancode), 1, -1);
            $usulancode_look = substr($this->Db->qstr($usulancode), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct usulancode from " . $this->Ini->nm_tabela . " where selesai <> 'C' and  usulancode like '%" . $usulancode . "%' order by usulancode"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
   ...
   function lookup_ajax_keterangan($keterangan)
   {
      ...
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct keterangan from " . $this->Ini->nm_tabela . " where selesai <> 'C' and  keterangan like '%" . $keterangan . "%' order by keterangan"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $Nm_datas[] = "orderdate";$Nm_datas[] = "orderdate";$Nm_datas[] = "pic_date";$Nm_datas[] = "pic_date";$Nm_datas[] = "spv_date";$Nm_datas[] = "spv_date";$Nm_datas[] = "wk_date";$Nm_datas[] = "wk_date";
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usulanpengadaan_gizi']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usulanpengadaan_gizi']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         $nome_sum = "usulanpengadaan_gizi.$nome";
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usulanpengadaan_gizi']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usulanpengadaan_gizi']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usulanpengadaan_gizi']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usulanpengadaan_gizi']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usulanpengadaan_gizi']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usulanpengadaan_gizi']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usulanpengadaan_gizi']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usulanpengadaan_gizi']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usulanpengadaan_gizi']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usulanpengadaan_gizi']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usulanpengadaan_gizi']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usulanpengadaan_gizi']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usulanpengadaan_gizi']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usulanpengadaan_gizi']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usulanpengadaan_gizi']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - usulan pengadaan gizi</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_usulanpengadaan_gizi/grid_usulanpengadaan_gizi_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_usulanpengadaan_gizi_ajax_search.js"></script>
 <script type="text/javascript" src="grid_usulanpengadaan_gizi_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_usulanpengadaan_gizi_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_usulanpengadaan_gizi']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_usulanpengadaan_gizi']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_nopo_cond#NMF#' + search_get_sel_txt('SC_nopo_cond') + '@NMF@';
  str_out += 'SC_nopo#NMF#' + search_get_text('SC_nopo') + '@NMF@';
  str_out += 'id_ac_nopo#NMF#' + search_get_text('id_ac_nopo') + '@NMF@';
  ...
  str_out += 'SC_usulancode_cond#NMF#' + search_get_sel_txt('SC_usulancode_cond') + '@NMF@';
  str_out += 'SC_usulancode#NMF#' + search_get_text('SC_usulancode') + '@NMF@';
  str_out += 'id_ac_usulancode#NMF#' + search_get_text('id_ac_usulancode') + '@NMF@';
   ...
   $("#id_ac_usulancode").autocomplete({
     ...
     $.ajax({
       ...
       data: {
          ...
          nmgp_parms: "NM_ajax_opcao?#?autocomp_usulancode",
          max_itens: "10",
          cod_desc: "N",
     ...
     select: function (event, ui) {
       $("#SC_usulancode").val(ui.item.value);
   ...
   $("#id_ac_nopo").autocomplete({
     ...
     $.ajax({
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_nopo",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usulanpengadaan_gizi']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div class="scFilterHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFilterHeaderFont" style="float: left; text-transform: uppercase;"><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - usulan pengadaan gizi</div>
...
<?php
   ...
   {
      global 
             $nopo_cond, $nopo, $nopo_autocomp,
             $id_cond, $id, $id_autocomp,
             $usulancode_cond, $usulancode, $usulancode_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usulanpengadaan_gizi']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usulanpengadaan_gizi']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usulanpengadaan_gizi']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usulanpengadaan_gizi']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $nopo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usulanpengadaan_gizi']['campos_busca']['nopo']; 
          $nopo_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usulanpengadaan_gizi']['campos_busca']['nopo_cond']; 
          $id = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usulanpengadaan_gizi']['campos_busca']['id']; 
          $id_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usulanpengadaan_gizi']['campos_busca']['id_cond']; 
          $usulancode = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usulanpengadaan_gizi']['campos_busca']['usulancode']; 
          $usulancode_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usulanpengadaan_gizi']['campos_busca']['usulancode_cond']; 
          $keterangan = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usulanpengadaan_gizi']['campos_busca']['keterangan']; 
          $keterangan_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usulanpengadaan_gizi']['campos_busca']['keterangan_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usulanpengadaan_gizi']['campos_busca']['NM_operador']; 
      } 
      if (!isset($nopo_cond) || empty($nopo_cond))
      {
         $nopo_cond = "qp";
      }
      ...
      if (!isset($usulancode_cond) || empty($usulancode_cond))
      {
         $usulancode_cond = "qp";
      }
      ...
      $str_hide_nopo = (in_array($nopo_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_id = (in_array($id_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_usulancode = (in_array($usulancode_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      if (!isset($usulancode) || $usulancode == "")
      {
          $usulancode = "";
      }
      if (isset($usulancode) && !empty($usulancode))
      {
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_nopo_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['nopo'])) ? $this->New_label['nopo'] : "No PO"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_nopo_cond" name="nopo_cond" onChange="nm_campos_between(document.getElementById('id_vis_nopo'), this, 'nopo')">
       <OPTION value="qp" <?php if ("qp" == $nopo_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $nopo_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $nopo_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $nopo_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_nopo" <?php echo $str_hide_nopo?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['nopo'])) ? $this->New_label['nopo'] : "No PO";
 $nmgp_tab_label .= "nopo?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
...
<?php
      ...
      $nopo_look = substr($this->Db->qstr($nopo), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct noPO from " . $this->Ini->nm_tabela . " where selesai <> 'C' and noPO = '$nopo_look' order by noPO"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      if (isset($nmgp_def_dados[0][$nopo]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$nopo];
      }
      else
      {
          $sAutocompValue = $nopo;
...
?>
<INPUT  type="text" id="SC_nopo" name="nopo" value="<?php echo NM_encode_input($nopo) ?>"  size=35 alt="{datatype: 'text', maxLength: 35, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_nopo" name="nopo_autocomp" size="35"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 35, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
<?php
   ...
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct id from " . $this->Ini->nm_tabela . " where selesai <> 'C' and id = $id_look order by id"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct id from " . $this->Ini->nm_tabela . " where selesai <> 'C' and id = $id_look order by id"; 
...
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_id" name="id_autocomp" size="5"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 5, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
      ...
      <TD id='SC_usulancode_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['usulancode'])) ? $this->New_label['usulancode'] : "Kode Usulan"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_usulancode_cond" name="usulancode_cond" onChange="nm_campos_between(document.getElementById('id_vis_usulancode'), this, 'usulancode')">
       <OPTION value="qp" <?php if ("qp" == $usulancode_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $usulancode_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $usulancode_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $usulancode_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_usulancode" <?php echo $str_hide_usulancode?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['usulancode'])) ? $this->New_label['usulancode'] : "Kode Usulan";
 $nmgp_tab_label .= "usulancode?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      $usulancode_look = substr($this->Db->qstr($usulancode), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct usulancode from " . $this->Ini->nm_tabela . " where selesai <> 'C' and usulancode = '$usulancode_look' order by usulancode"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      if (isset($nmgp_def_dados[0][$usulancode]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$usulancode];
      }
      else
      {
          $sAutocompValue = $usulancode;
      }
?>
<INPUT  type="text" id="SC_usulancode" name="usulancode" value="<?php echo NM_encode_input($usulancode) ?>"  size=15 alt="{datatype: 'text', maxLength: 15, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_usulancode" name="usulancode_autocomp" size="15"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 15, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
<?php
      ...
      $keterangan_look = substr($this->Db->qstr($keterangan), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct keterangan from " . $this->Ini->nm_tabela . " where selesai <> 'C' and keterangan = '$keterangan_look' order by keterangan"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
...
?>
<?php
   if (is_file("grid_usulanpengadaan_gizi_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_usulanpengadaan_gizi']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_usulanpengadaan_gizi']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usulanpengadaan_gizi']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.nopo_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_nopo'), document.F1.nopo_cond, 'nopo');
   document.F1.nopo.value = "";
   document.F1.nopo_autocomp.value = "";
   ...
   document.F1.usulancode_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_usulancode'), document.F1.usulancode_cond, 'usulancode');
   document.F1.usulancode.value = "";
   document.F1.usulancode_autocomp.value = "";
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "simrskreatifmedia/grid_usulanpengadaan_gizi";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usulanpengadaan_gizi']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usulanpengadaan_gizi']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usulanpengadaan_gizi']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro($nmgp_save_origem)
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "grid_usulanpengadaan_gizi/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_nopo_cond'] = 'cond';
      $tp_fields['SC_nopo'] = 'text_aut';
      $tp_fields['id_ac_nopo'] = 'text_aut';
      $tp_fields['SC_id_cond'] = 'cond';
      $tp_fields['SC_id'] = 'text_aut';
      $tp_fields['id_ac_id'] = 'text_aut';
      $tp_fields['SC_usulancode_cond'] = 'cond';
      $tp_fields['SC_usulancode'] = 'text_aut';
      $tp_fields['id_ac_usulancode'] = 'text_aut';
   ...
   {
      global $nopo_cond, $nopo, $nopo_autocomp,
             $id_cond, $id, $id_autocomp,
             $usulancode_cond, $usulancode, $usulancode_autocomp,
      ...
      if (!empty($nopo_autocomp) && empty($nopo))
      {
          $nopo = $nopo_autocomp;
      }
      ...
      if (!empty($usulancode_autocomp) && empty($usulancode))
      {
          $usulancode = $usulancode_autocomp;
      }
      if (!empty($keterangan_autocomp) && empty($keterangan))
      {
          $keterangan = $keterangan_autocomp;
      }
      $nopo_cond_salva = $nopo_cond; 
      if (!isset($nopo_input_2) || $nopo_input_2 == "")
      {
          $nopo_input_2 = $nopo;
      }
      ...
      $usulancode_cond_salva = $usulancode_cond; 
      if (!isset($usulancode_input_2) || $usulancode_input_2 == "")
      {
          $usulancode_input_2 = $usulancode;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usulanpengadaan_gizi']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usulanpengadaan_gizi']['campos_busca']['nopo'] = $nopo; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usulanpengadaan_gizi']['campos_busca']['nopo_cond'] = $nopo_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usulanpengadaan_gizi']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usulanpengadaan_gizi']['campos_busca']['id'] = $id; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usulanpengadaan_gizi']['campos_busca']['id_cond'] = $id_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usulanpengadaan_gizi']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usulanpengadaan_gizi']['campos_busca']['usulancode'] = $usulancode; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usulanpengadaan_gizi']['campos_busca']['usulancode_cond'] = $usulancode_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usulanpengadaan_gizi']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usulanpengadaan_gizi']['campos_busca']['keterangan'] = $keterangan; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usulanpengadaan_gizi']['campos_busca']['keterangan_cond'] = $keterangan_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usulanpengadaan_gizi']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usulanpengadaan_gizi']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usulanpengadaan_gizi']['campos_busca'] = $Temp_Busca;
      }
      ...
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['nopo'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['nopo'] = $nopo;
      }
      $id_look = substr($this->Db->qstr($id), 1, -1); 
      $nmgp_def_dados = array(); 
   if (is_numeric($id))
   { 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['usulancode'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['usulancode'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['usulancode'] = $usulancode;
      }
      $keterangan_look = substr($this->Db->qstr($keterangan), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct keterangan from " . $this->Ini->nm_tabela . " where selesai <> 'C' and keterangan = '$keterangan_look' order by keterangan"; 
      ...
      if (isset($nopo) || $nopo_cond == "nu" || $nopo_cond == "nn" || $nopo_cond == "ep" || $nopo_cond == "ne")
      {
         $this->monta_condicao("noPO", $nopo_cond, $nopo, "", "nopo");
      }
      ...
      //----- $usulancode
      $this->Date_part = false;
      if (isset($usulancode) || $usulancode_cond == "nu" || $usulancode_cond == "nn" || $usulancode_cond == "ep" || $usulancode_cond == "ne")
      {
         $this->monta_condicao("usulancode", $usulancode_cond, $usulancode, "", "usulancode");
      }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usulanpengadaan_gizi']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usulanpengadaan_gizi']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usulanpengadaan_gizi']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usulanpengadaan_gizi']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usulanpengadaan_gizi']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usulanpengadaan_gizi']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usulanpengadaan_gizi']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usulanpengadaan_gizi']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usulanpengadaan_gizi']['cond_pesq'] .= $this->NM_operador;
