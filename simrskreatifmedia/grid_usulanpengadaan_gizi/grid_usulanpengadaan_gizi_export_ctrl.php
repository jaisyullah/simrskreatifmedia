<?php
@session_start() ;
$_SESSION['scriptcase']['grid_usulanpengadaan_gizi']['sc_process_barr'] = true;
require_once('../grid_usulanpengadaan_gizi/index.php');
unset($_SESSION['scriptcase']['grid_usulanpengadaan_gizi']['sc_process_barr']);
$ExportCtrl = new grid_usulanpengadaan_gizi_export_control;
$ExportCtrl->Export_barr();

class grid_usulanpengadaan_gizi_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - usulan pengadaan gizi :: Excel</TITLE>
