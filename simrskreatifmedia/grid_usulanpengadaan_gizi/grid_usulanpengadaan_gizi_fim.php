...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_usulanpengadaan_gizi"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_usulanpengadaan_gizi"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_usulanpengadaan_gizi']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_usulanpengadaan_gizi']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_usulanpengadaan_gizi']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_usulanpengadaan_gizi']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_usulanpengadaan_gizi']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_usulanpengadaan_gizi</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_usulanpengadaan_gizi']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_usulanpengadaan_gizi']['embutida_filho'] as $ind => $sc_init)
          {
