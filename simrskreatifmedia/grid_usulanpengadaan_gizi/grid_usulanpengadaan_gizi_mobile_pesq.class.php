...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "orderdate";$Nm_datas[] = "orderdate";$Nm_datas[] = "pic_date";$Nm_datas[] = "pic_date";$Nm_datas[] = "spv_date";$Nm_datas[] = "spv_date";$Nm_datas[] = "wk_date";$Nm_datas[] = "wk_date";$Nm_numeric[] = "id";$Nm_numeric[] = "";
...
<HTML>
<HEAD>
 <TITLE> - usulan pengadaan gizi</TITLE>
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_nopo_cond" name="nopo_cond" onChange="nm_campos_between(document.getElementById('id_vis_nopo'), this, 'nopo')">
      ...
      <br><span id="id_hide_nopo"  <?php echo $str_hide_nopo?>><?php
      if ($nopo != "")
      {
      $nopo_look = substr($this->Db->qstr($nopo), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_usulancode_cond" name="usulancode_cond" onChange="nm_campos_between(document.getElementById('id_vis_usulancode'), this, 'usulancode')">
      ...
      <br><span id="id_hide_usulancode"  <?php echo $str_hide_usulancode?>><?php
      if ($usulancode != "")
      {
      $usulancode_look = substr($this->Db->qstr($usulancode), 1, -1); 
      $nmgp_def_dados = array(); 
