<?php
@session_start() ;
$_SESSION['scriptcase']['print_etiket5']['sc_process_barr'] = true;
require_once('../print_etiket5/index.php');
unset($_SESSION['scriptcase']['print_etiket5']['sc_process_barr']);
$ExportCtrl = new print_etiket5_export_control;
$ExportCtrl->Export_barr();

class print_etiket5_export_control
{
