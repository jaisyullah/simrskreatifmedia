...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcustomer_mob']['embutida_pdf']))
 {
 ?>
...
include_once('form_tbcustomer_mob_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcustomer_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcustomer_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcustomer_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcustomer_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcustomer_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcustomer_mob']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcustomer_mob']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcustomer_mob']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
?>
<body class="scFormPage" style="<?php echo $remove_margin . $str_iframe_body; ?>">
<?php

if (isset($_SESSION['scriptcase']['form_tbcustomer']['error_buffer']) && '' != $_SESSION['scriptcase']['form_tbcustomer']['error_buffer'])
{
    echo $_SESSION['scriptcase']['form_tbcustomer']['error_buffer'];
}
...
<?php
 include_once("form_tbcustomer_mob_js0.php");
?>
<script type="text/javascript"> 
...
<form  name="F1" method="post" 
               action="form_tbcustomer_mob.php" 
               target="_self">
<input type="hidden" name="nmgp_url_saida" value="">
<?php
if ('novo' == $this->nmgp_opcao || 'incluir' == $this->nmgp_opcao)
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcustomer_mob']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcustomer_mob']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_tbcustomer_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_tbcustomer_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcustomer_mob']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcustomer_mob']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcustomer_mob']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcustomer_mob']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcustomer_mob']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcustomer_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcustomer_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcustomer_mob']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcustomer_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcustomer_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcustomer_mob']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcustomer_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcustomer_mob']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcustomer_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcustomer_mob']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcustomer_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcustomer_mob']['fast_search'][2] : "";
?> 
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcustomer_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcustomer_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcustomer_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcustomer_mob']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcustomer_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcustomer_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcustomer_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcustomer_mob']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcustomer_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcustomer_mob']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_salut_line" id="hidden_field_data_salut" style="<?php echo $sStyleHidden_salut; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_salut_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_salut_label"><span id="id_label_salut"><?php echo $this->nm_new_label['salut']; ?></span></span><br>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcustomer_mob']['Lookup_salut'][] = ''; ?>
 <option value=""></option>
 <option  value="AN." <?php  if ($this->salut == "AN.") { echo " selected" ;} ?>>AN.</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcustomer_mob']['Lookup_salut'][] = 'AN.'; ?>
 <option  value="NN." <?php  if ($this->salut == "NN.") { echo " selected" ;} ?>>NN.</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcustomer_mob']['Lookup_salut'][] = 'NN.'; ?>
 <option  value="NY." <?php  if ($this->salut == "NY.") { echo " selected" ;} ?>>NY.</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcustomer_mob']['Lookup_salut'][] = 'NY.'; ?>
 <option  value="SDR." <?php  if ($this->salut == "SDR.") { echo " selected" ;} ?>>SDR.</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcustomer_mob']['Lookup_salut'][] = 'SDR.'; ?>
 <option  value="TN." <?php  if ($this->salut == "TN.") { echo " selected" ;} ?>>TN.</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcustomer_mob']['Lookup_salut'][] = 'TN.'; ?>
 </select></span>
</span><?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_birthplace_line" id="hidden_field_data_birthplace" style="<?php echo $sStyleHidden_birthplace; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_birthplace_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_birthplace_label"><span id="id_label_birthplace"><?php echo $this->nm_new_label['birthplace']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_birthdate_line" id="hidden_field_data_birthdate" style="<?php echo $sStyleHidden_birthdate; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_birthdate_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_birthdate_label"><span id="id_label_birthdate"><?php echo $this->nm_new_label['birthdate']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_sex_line" id="hidden_field_data_sex" style="<?php echo $sStyleHidden_sex; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_sex_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_sex_label"><span id="id_label_sex"><?php echo $this->nm_new_label['sex']; ?></span></span><br>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcustomer_mob']['Lookup_sex'][] = 'L'; ?>
 <option  value="P" <?php  if ($this->sex == "P") { echo " selected" ;} ?>>Perempuan</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcustomer_mob']['Lookup_sex'][] = 'P'; ?>
 </select></span>
</span><?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_address_line" id="hidden_field_data_address" style="<?php echo $sStyleHidden_address; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_address_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_address_label"><span id="id_label_address"><?php echo $this->nm_new_label['address']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcustomer_mob']['php_cmp_required']['address']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcustomer_mob']['php_cmp_required']['address'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
<?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rt_line" id="hidden_field_data_rt" style="<?php echo $sStyleHidden_rt; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rt_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rt_label"><span id="id_label_rt"><?php echo $this->nm_new_label['rt']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rw_line" id="hidden_field_data_rw" style="<?php echo $sStyleHidden_rw; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rw_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rw_label"><span id="id_label_rw"><?php echo $this->nm_new_label['rw']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_city_line" id="hidden_field_data_city" style="<?php echo $sStyleHidden_city; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_city_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_city_label"><span id="id_label_city"><?php echo $this->nm_new_label['city']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcustomer_mob']['php_cmp_required']['city']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcustomer_mob']['php_cmp_required']['city'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_kecamatan_line" id="hidden_field_data_kecamatan" style="<?php echo $sStyleHidden_kecamatan; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_kecamatan_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_kecamatan_label"><span id="id_label_kecamatan"><?php echo $this->nm_new_label['kecamatan']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcustomer_mob']['php_cmp_required']['kecamatan']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcustomer_mob']['php_cmp_required']['kecamatan'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_kelurahan_line" id="hidden_field_data_kelurahan" style="<?php echo $sStyleHidden_kelurahan; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_kelurahan_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_kelurahan_label"><span id="id_label_kelurahan"><?php echo $this->nm_new_label['kelurahan']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcustomer_mob']['php_cmp_required']['kelurahan']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcustomer_mob']['php_cmp_required']['kelurahan'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_hp_line" id="hidden_field_data_hp" style="<?php echo $sStyleHidden_hp; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_hp_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_hp_label"><span id="id_label_hp"><?php echo $this->nm_new_label['hp']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_blood_line" id="hidden_field_data_blood" style="<?php echo $sStyleHidden_blood; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_blood_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_blood_label"><span id="id_label_blood"><?php echo $this->nm_new_label['blood']; ?></span></span><br>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcustomer_mob']['Lookup_blood'][] = ''; ?>
 <option value=""></option>
 <option  value="A" <?php  if ($this->blood == "A") { echo " selected" ;} ?>>A</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcustomer_mob']['Lookup_blood'][] = 'A'; ?>
 <option  value="B" <?php  if ($this->blood == "B") { echo " selected" ;} ?>>B</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcustomer_mob']['Lookup_blood'][] = 'B'; ?>
 <option  value="AB" <?php  if ($this->blood == "AB") { echo " selected" ;} ?>>AB</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcustomer_mob']['Lookup_blood'][] = 'AB'; ?>
 <option  value="O" <?php  if ($this->blood == "O") { echo " selected" ;} ?>>O</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcustomer_mob']['Lookup_blood'][] = 'O'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcustomer_mob']['Lookup_blood'][] = 'Tidak Tahu'; ?>
 </select></span>
</span><?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_spouse_line" id="hidden_field_data_spouse" style="<?php echo $sStyleHidden_spouse; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_spouse_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_spouse_label"><span id="id_label_spouse"><?php echo $this->nm_new_label['spouse']; ?></span></span><br>
...
<?php $sStyleHidden_spouse_dumb = ('' == $sStyleHidden_spouse) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_spouse_dumb" style="<?php echo $sStyleHidden_spouse_dumb; ?>"></TD>
   </tr>
<?php $sc_hidden_no = 1; ?>
</TABLE></div><!-- bloco_f -->
   </td>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_idno_line" id="hidden_field_data_idno" style="<?php echo $sStyleHidden_idno; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_idno_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_idno_label"><span id="id_label_idno"><?php echo $this->nm_new_label['idno']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_religion_line" id="hidden_field_data_religion" style="<?php echo $sStyleHidden_religion; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_religion_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_religion_label"><span id="id_label_religion"><?php echo $this->nm_new_label['religion']; ?></span></span><br>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcustomer_mob']['Lookup_religion'][] = ''; ?>
 <option value=""></option>
 <option  value="ISLAM" <?php  if ($this->religion == "ISLAM") { echo " selected" ;} ?>>ISLAM</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcustomer_mob']['Lookup_religion'][] = 'ISLAM'; ?>
 <option  value="BUDHA" <?php  if ($this->religion == "BUDHA") { echo " selected" ;} ?>>BUDHA</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcustomer_mob']['Lookup_religion'][] = 'BUDHA'; ?>
 <option  value="HINDU" <?php  if ($this->religion == "HINDU") { echo " selected" ;} ?>>HINDU</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcustomer_mob']['Lookup_religion'][] = 'HINDU'; ?>
 <option  value="KATOLIK" <?php  if ($this->religion == "KATOLIK") { echo " selected" ;} ?>>KATOLIK</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcustomer_mob']['Lookup_religion'][] = 'KATOLIK'; ?>
 <option  value="KRISTEN" <?php  if ($this->religion == "KRISTEN") { echo " selected" ;} ?>>KRISTEN</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcustomer_mob']['Lookup_religion'][] = 'KRISTEN'; ?>
 <option  value="LAIN-LAIN" <?php  if ($this->religion == "LAIN-LAIN") { echo " selected" ;} ?>>LAIN-LAIN</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcustomer_mob']['Lookup_religion'][] = 'LAIN-LAIN'; ?>
 </select></span>
</span><?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_job_line" id="hidden_field_data_job" style="<?php echo $sStyleHidden_job; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_job_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_job_label"><span id="id_label_job"><?php echo $this->nm_new_label['job']; ?></span></span><br>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcustomer_mob']['Lookup_job'][] = ''; ?>
 <option value=""></option>
 <option  value="BURUH" <?php  if ($this->job == "BURUH") { echo " selected" ;} ?>>BURUH</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcustomer_mob']['Lookup_job'][] = 'BURUH'; ?>
 <option  value="DIBAWAH UMUR" <?php  if ($this->job == "DIBAWAH UMUR") { echo " selected" ;} ?>>DIBAWAH UMUR</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcustomer_mob']['Lookup_job'][] = 'DIBAWAH UMUR'; ?>
 <option  value="IBU RT" <?php  if ($this->job == "IBU RT") { echo " selected" ;} ?>>IBU RT</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcustomer_mob']['Lookup_job'][] = 'IBU RT'; ?>
 <option  value="KARYAWAN SWASTA" <?php  if ($this->job == "KARYAWAN SWASTA") { echo " selected" ;} ?>>KARYAWAN SWASTA</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcustomer_mob']['Lookup_job'][] = 'KARYAWAN SWASTA'; ?>
 <option  value="LAIN-LAIN" <?php  if ($this->job == "LAIN-LAIN") { echo " selected" ;} ?>>LAIN-LAIN</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcustomer_mob']['Lookup_job'][] = 'LAIN-LAIN'; ?>
 <option  value="MAHASISWA/I" <?php  if ($this->job == "MAHASISWA/I") { echo " selected" ;} ?>>MAHASISWA/I</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcustomer_mob']['Lookup_job'][] = 'MAHASISWA/I'; ?>
 <option  value="PEDAGANG" <?php  if ($this->job == "PEDAGANG") { echo " selected" ;} ?>>PEDAGANG</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcustomer_mob']['Lookup_job'][] = 'PEDAGANG'; ?>
 <option  value="PELAJAR" <?php  if ($this->job == "PELAJAR") { echo " selected" ;} ?>>PELAJAR</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcustomer_mob']['Lookup_job'][] = 'PELAJAR'; ?>
 <option  value="PETANI" <?php  if ($this->job == "PETANI") { echo " selected" ;} ?>>PETANI</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcustomer_mob']['Lookup_job'][] = 'PETANI'; ?>
 </select></span>
</span><?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_father_line" id="hidden_field_data_father" style="<?php echo $sStyleHidden_father; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_father_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_father_label"><span id="id_label_father"><?php echo $this->nm_new_label['father']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_mother_line" id="hidden_field_data_mother" style="<?php echo $sStyleHidden_mother; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_mother_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_mother_label"><span id="id_label_mother"><?php echo $this->nm_new_label['mother']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_penanggung_line" id="hidden_field_data_penanggung" style="<?php echo $sStyleHidden_penanggung; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_penanggung_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_penanggung_label"><span id="id_label_penanggung"><?php echo $this->nm_new_label['penanggung']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_bu_line" id="hidden_field_data_bu" style="<?php echo $sStyleHidden_bu; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_bu_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_bu_label"><span id="id_label_bu"><?php echo $this->nm_new_label['bu']; ?></span></span><br>
...
<span id="id_read_on_bu" class="sc-ui-readonly-bu css_bu_line" style="<?php echo $sStyleReadLab_bu; ?>"><?php echo $this->bu; ?></span><span id="id_read_off_bu" class="css_read_off_bu" style="white-space: nowrap;<?php echo $sStyleReadInp_bu; ?>">
 ...
 size=25 maxlength=50 alt="{datatype: 'text', maxLength: 50, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php
   $Sc_iframe_master = ($this->Embutida_call) ? 'nmgp_iframe_ret*scinnmsc_iframe_liga_form_tbcustomer_mob*scout' : '';
   if (isset($this->Ini->sc_lig_md5["grid_tbbu"]) && $this->Ini->sc_lig_md5["grid_tbbu"] == "S") {
       ...
       $Md5_Lig    = "@SC_par@" . $this->form_encode_input($this->Ini->sc_page) . "@SC_par@form_tbcustomer_mob@SC_par@" . md5($Parms_Lig);
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcustomer_mob']['Lig_Md5'][md5($Parms_Lig)] = $Parms_Lig;
   } else {
...
<?php if (!$this->Ini->Export_img_zip) { ?><?php echo nmButtonOutput($this->arr_buttons, "bform_captura", "scModalCapture('" . $this->Ini->link_grid_tbbu_cons_psq . "?script_case_init=" . $this->Ini->sc_page . "&script_case_session=" . session_id() . "&nmgp_parms=" . $Md5_Lig . "&SC_lig_apl_orig=form_tbcustomer_mob&KeepThis=true&TB_iframe=true&height=600&width=800&modal=true')", "scModalCapture('" . $this->Ini->link_grid_tbbu_cons_psq . "?script_case_init=" . $this->Ini->sc_page . "&script_case_session=" . session_id() . "&nmgp_parms=" . $Md5_Lig . "&SC_lig_apl_orig=form_tbcustomer_mob&KeepThis=true&TB_iframe=true&height=600&width=800&modal=true')", "cap_bu", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
<?php } ?>
<?php } ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_education_line" id="hidden_field_data_education" style="<?php echo $sStyleHidden_education; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_education_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_education_label"><span id="id_label_education"><?php echo $this->nm_new_label['education']; ?></span></span><br>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcustomer_mob']['Lookup_education'][] = 'SMA'; ?>
 <option  value="SMP" <?php  if ($this->education == "SMP") { echo " selected" ;} ?>>SMP</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcustomer_mob']['Lookup_education'][] = 'SMP'; ?>
 <option  value="SD" <?php  if ($this->education == "SD") { echo " selected" ;} ?>>SD</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcustomer_mob']['Lookup_education'][] = 'SD'; ?>
 <option  value="Belum/Tidak Tamat SD" <?php  if ($this->education == "Belum/Tidak Tamat SD") { echo " selected" ;} ?>>Belum/Tidak Tamat SD</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcustomer_mob']['Lookup_education'][] = 'Belum/Tidak Tamat SD'; ?>
 <option  value="Diploma" <?php  if ($this->education == "Diploma") { echo " selected" ;} ?>>Diploma</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcustomer_mob']['Lookup_education'][] = 'Diploma'; ?>
 <option  value="Sarjana" <?php  if ($this->education == "Sarjana") { echo " selected" ;} ?>>Sarjana</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcustomer_mob']['Lookup_education'][] = 'Sarjana'; ?>
 <option  value="Pasca Sarjana" <?php  if ($this->education == "Pasca Sarjana") { echo " selected" ;} ?>>Pasca Sarjana</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcustomer_mob']['Lookup_education'][] = 'Pasca Sarjana'; ?>
 <option  value="Tidak Sekolah" <?php  if ($this->education == "Tidak Sekolah") { echo " selected" ;} ?>>Tidak Sekolah</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcustomer_mob']['Lookup_education'][] = 'Tidak Sekolah'; ?>
 </select></span>
</span><?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_registerdate_line" id="hidden_field_data_registerdate" style="<?php echo $sStyleHidden_registerdate; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_registerdate_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_registerdate_label"><span id="id_label_registerdate"><?php echo $this->nm_new_label['registerdate']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_hta_line" id="hidden_field_data_hta" style="<?php echo $sStyleHidden_hta; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_hta_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_hta_label"><span id="id_label_hta"><?php echo $this->nm_new_label['hta']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_isdead_line" id="hidden_field_data_isdead" style="<?php echo $sStyleHidden_isdead; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_isdead_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_isdead_label"><span id="id_label_isdead"><?php echo $this->nm_new_label['isdead']; ?></span></span><br>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcustomer_mob']['Lookup_isdead'][] = '1'; ?>
 <option  value="0" <?php  if ($this->isdead == "0") { echo " selected" ;} ?><?php  if (empty($this->isdead)) { echo " selected" ;} ?>>Tidak</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcustomer_mob']['Lookup_isdead'][] = '0'; ?>
 </select></span>
</span><?php  }?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcustomer_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcustomer_mob']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcustomer_mob']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcustomer_mob']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcustomer_mob']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcustomer_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcustomer_mob']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcustomer_mob']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcustomer_mob']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_tbcustomer_mob");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_tbcustomer_mob");
 parent.scAjaxDetailHeight("form_tbcustomer_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcustomer_mob']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
