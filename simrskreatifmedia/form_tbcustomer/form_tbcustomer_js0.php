...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcustomer']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
  <input type="hidden" name="script_case_session" value="<?php echo $this->form_encode_input(session_id()); ?>"> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_tbcustomer"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
?> 
var var_btn_sc_btn_0_var_custcode = "<?php echo $this->form_encode_input($this->nmgp_dados_form['custcode']); ?>";
function sc_btn_sc_btn_0()
{
    ...
    scJs_confirm("<?php echo html_entity_decode('Anda ingin mencetak Identitas Pasien ?', ENT_COMPAT, $_SESSION['scriptcase']['charset']); ?>", sc_btn_sc_btn_0_ok, sc_btn_sc_btn_0_cancel);
}
...
{
      nm_gp_submit('<?php echo $this->Ini->link_cetak_form_pasien_cons; ?>', '<?php echo $this->nm_location; ?>', '<?php echo "var_custcode*scin' + var_btn_sc_btn_0_var_custcode + '*scout"; ?>', 'inicio', '_blank', '0', '0', 'cetak_form_pasien');
}
var var_btn_sc_btn_1_var_custcode = "<?php echo $this->form_encode_input($this->nmgp_dados_form['custcode']); ?>";
...
{
  nm_gp_submit('<?php echo $this->Ini->link_pdfreport_kartu_cons; ?>', '<?php echo $this->nm_location; ?>', '<?php echo "var_custcode*scin' + var_btn_sc_btn_1_var_custcode + '*scout"; ?>', 'inicio', '_blank', '0', '0', 'pdfreport_kartu');
}
function sc_btn_sc_btn_2()
{
    ...
    scJs_confirm("<?php echo html_entity_decode('Apakah Anda yakin ingin membuat RM Bayi Laki-laki ?', ENT_COMPAT, $_SESSION['scriptcase']['charset']); ?>", sc_btn_sc_btn_2_ok, sc_btn_sc_btn_2_cancel)
}
...
{
    document.F1.nmgp_parms.value = "nmgp_opcao?#?formphp?@?nm_call_php?#?sc_btn_2?@?";
    document.F1.action = "./";
...
function sc_btn_sc_btn_3()
{
    ...
    scJs_confirm("<?php echo html_entity_decode('Apakah Anda yakin ingin membuat RM Bayi Perempuan ?', ENT_COMPAT, $_SESSION['scriptcase']['charset']); ?>", sc_btn_sc_btn_3_ok, sc_btn_sc_btn_3_cancel)
}
...
{
    document.F1.nmgp_parms.value = "nmgp_opcao?#?formphp?@?nm_call_php?#?sc_btn_3?@?";
    document.F1.action = "./";
    document.F1.target = "_blank";
    document.F1.submit();
}
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbcustomer']['where_detal']))
  {
?>  
...
{
   nm_field_disabled("custcode=disabled;hta=disabled", "");
