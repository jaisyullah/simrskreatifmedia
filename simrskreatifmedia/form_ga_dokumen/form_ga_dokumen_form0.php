...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ga_dokumen']['embutida_pdf']))
 {
 ?>
...
<?php
include_once("form_ga_dokumen_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_ga_dokumen_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_ga_dokumen']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_ga_dokumen']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_ga_dokumen']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_ga_dokumen']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_ga_dokumen']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ga_dokumen']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ga_dokumen']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ga_dokumen']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
?>
...
<?php
 include_once("form_ga_dokumen_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_ga_dokumen']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_ga_dokumen']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_ga_dokumen'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_ga_dokumen'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_ga_dokumen']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ga_dokumen']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ga_dokumen']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_ga_dokumen']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ga_dokumen']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ga_dokumen']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ga_dokumen']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_ga_dokumen']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ga_dokumen']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_ga_dokumen']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ga_dokumen']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_ga_dokumen']['fast_search'][2] : "";
?> 
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ga_dokumen']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ga_dokumen']['run_iframe'] != "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ga_dokumen']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_ga_dokumen']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ga_dokumen']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ga_dokumen']['run_iframe'] == "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ga_dokumen']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_ga_dokumen']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ga_dokumen']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_ga_dokumen']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ga_dokumen']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ga_dokumen']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ga_dokumen']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_ga_dokumen']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ga_dokumen']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ga_dokumen']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_ga_dokumen']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ga_dokumen']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_nama_dok_label" id="hidden_field_label_nama_dok" style="<?php echo $sStyleHidden_nama_dok; ?>"><span id="id_label_nama_dok"><?php echo $this->nm_new_label['nama_dok']; ?></span></TD>
    <TD class="scFormDataOdd css_nama_dok_line" id="hidden_field_data_nama_dok" style="<?php echo $sStyleHidden_nama_dok; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_nama_dok_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_sifat_label" id="hidden_field_label_sifat" style="<?php echo $sStyleHidden_sifat; ?>"><span id="id_label_sifat"><?php echo $this->nm_new_label['sifat']; ?></span></TD>
    <TD class="scFormDataOdd css_sifat_line" id="hidden_field_data_sifat" style="<?php echo $sStyleHidden_sifat; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_sifat_line" style="vertical-align: top;padding: 0px">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ga_dokumen']['Lookup_sifat'][] = 'Biasa'; ?>
 <option  value="Penting" <?php  if ($this->sifat == "Penting") { echo " selected" ;} ?>>Penting</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ga_dokumen']['Lookup_sifat'][] = 'Penting'; ?>
 <option  value="Rahasia" <?php  if ($this->sifat == "Rahasia") { echo " selected" ;} ?>>Rahasia</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ga_dokumen']['Lookup_sifat'][] = 'Rahasia'; ?>
 </select></span>
</span><?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
<?php  $this->unit_1 = explode(";", trim($this->unit)) ; ?>
    ...
    <TD class="scFormDataOdd css_unit_line" id="hidden_field_data_unit" style="<?php echo $sStyleHidden_unit; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_unit_line" style="vertical-align: top;padding: 0px">
...
<?php
   ...
   echo " <span id=\"idAjaxSelect_unit\"><select class=\"sc-js-input scFormObjectOdd css_unit_obj\" style=\"\" id=\"id_sc_field_unit\" name=\"unit_orig\" size=\"7\" multiple onDblClick=\"nm_add_sel('unit_orig', 'unit_dest', null);  \" alt=\"{type: 'select', enterTab: false}\">" ; 
   echo "\r" ; 
   while (!empty($todo[$x]) && !$nm_nao_carga) 
   {
          $cadaselect = explode("?#?", $todo[$x]) ; 
   ...
   echo "<div class='scBtnPassField' id='unit_all_right'>";
   echo         $sCondStyle = '';
?>
       <?php echo nmButtonOutput($this->arr_buttons, "bpassfld_rightall", "nm_add_all('unit_orig', 'unit_dest', null);    return false;", "nm_add_all('unit_orig', 'unit_dest', null);    return false;", "Bbpassfld_rightall", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
...
;
   ...
   echo         $sCondStyle = '';
?>
       <?php echo nmButtonOutput($this->arr_buttons, "bpassfld_right", "nm_add_sel('unit_orig', 'unit_dest', null);    return false;", "nm_add_sel('unit_orig', 'unit_dest', null);    return false;", "Bbpassfld_righ", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
...
;
   ...
   echo         $sCondStyle = '';
?>
       <?php echo nmButtonOutput($this->arr_buttons, "bpassfld_left", "nm_del_sel('unit_dest', 'unit_orig', null);    return false;", "nm_del_sel('unit_dest', 'unit_orig', null);    return false;", "Bbpassfld_left", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
 
<?php
;
   echo "</div>";
   echo "<div class='scBtnPassField' id='unit_all_left'>";
   echo         $sCondStyle = '';
?>
       <?php echo nmButtonOutput($this->arr_buttons, "bpassfld_leftall", "nm_del_all('unit_dest', 'unit_orig', null);    return false;", "nm_del_all('unit_dest', 'unit_orig', null);    return false;", "Bbpassfld_leftall", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
...
;
   ...
   echo "</td>";
   echo "<td>";
   echo " <select class=\"sc-js-input scFormObjectOdd css_unit_obj\" style=\"\" name=\"unit_dest\"  onBlur=\"scCssBlur(this);\"  onFocus=\"scCssFocus(this);\"  size=7 multiple onDblClick=\"nm_del_sel('unit_dest', 'unit_orig', null);  \" alt=\"{type: 'select', enterTab: false}\">";
   $x = 0 ; 
   while (!empty($todo[$x])) 
   {
          $cadaselect = explode("?#?", $todo[$x]) ; 
   ...
   echo " </select>" ; 
   echo " <input type=\"hidden\" name=\"unit\" value=\"\">" ; 
   echo "</td></tr></table>";
   echo " <script>document.F1.unit_dest.selectedIndex = -1;</script>" ; 
   echo "\r" ; 
   echo "</span>";
?> 
<?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
<?php  $this->karyawan_1 = explode(";", trim($this->karyawan)) ; ?>
    <TD class="scFormLabelOdd scUiLabelWidthFix css_karyawan_label" id="hidden_field_label_karyawan" style="<?php echo $sStyleHidden_karyawan; ?>"><span id="id_label_karyawan"><?php echo $this->nm_new_label['karyawan']; ?></span></TD>
    <TD class="scFormDataOdd css_karyawan_line" id="hidden_field_data_karyawan" style="<?php echo $sStyleHidden_karyawan; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_karyawan_line" style="vertical-align: top;padding: 0px">
...
<?php
   ...
   echo "<table style=\"display: inline-block\"><tr><td>" ; 
   echo " <span id=\"idAjaxSelect_karyawan\"><select class=\"sc-js-input scFormObjectOdd css_karyawan_obj\" style=\"\" id=\"id_sc_field_karyawan\" name=\"karyawan_orig\" size=\"7\" multiple onDblClick=\"nm_add_sel('karyawan_orig', 'karyawan_dest', null);  \" alt=\"{type: 'select', enterTab: false}\">" ; 
   echo "\r" ; 
   while (!empty($todo[$x]) && !$nm_nao_carga) 
   {
          $cadaselect = explode("?#?", $todo[$x]) ; 
          if ($cadaselect[1] == "@ ") {$cadaselect[1]= trim($cadaselect[1]); } ; 
          echo "  <option value=\"$cadaselect[1]\"" ; 
          foreach ($this->karyawan_1 as $Dados)
          {
              if ($Dados === $cadaselect[1])
              {
                  echo " disabled=\"disabled\" style=\"color: #A0A0A0\"";
   ...
   echo "</td>";
   echo "<td align=\"center\">";
   echo "<div class='scBtnPassField' id='karyawan_all_right'>";
   echo         $sCondStyle = '';
?>
       <?php echo nmButtonOutput($this->arr_buttons, "bpassfld_rightall", "nm_add_all('karyawan_orig', 'karyawan_dest', null);    return false;", "nm_add_all('karyawan_orig', 'karyawan_dest', null);    return false;", "Bbpassfld_rightall", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
...
;
   ...
   echo         $sCondStyle = '';
?>
       <?php echo nmButtonOutput($this->arr_buttons, "bpassfld_right", "nm_add_sel('karyawan_orig', 'karyawan_dest', null);    return false;", "nm_add_sel('karyawan_orig', 'karyawan_dest', null);    return false;", "Bbpassfld_righ", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
...
;
   ...
   echo         $sCondStyle = '';
?>
       <?php echo nmButtonOutput($this->arr_buttons, "bpassfld_left", "nm_del_sel('karyawan_dest', 'karyawan_orig', null);    return false;", "nm_del_sel('karyawan_dest', 'karyawan_orig', null);    return false;", "Bbpassfld_left", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
 
<?php
;
   echo "</div>";
   echo "<div class='scBtnPassField' id='karyawan_all_left'>";
   echo         $sCondStyle = '';
?>
       <?php echo nmButtonOutput($this->arr_buttons, "bpassfld_leftall", "nm_del_all('karyawan_dest', 'karyawan_orig', null);    return false;", "nm_del_all('karyawan_dest', 'karyawan_orig', null);    return false;", "Bbpassfld_leftall", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
...
;
   ...
   echo "</td>";
   echo "<td>";
   echo " <select class=\"sc-js-input scFormObjectOdd css_karyawan_obj\" style=\"\" name=\"karyawan_dest\"  onBlur=\"scCssBlur(this);\"  onFocus=\"scCssFocus(this);\"  size=7 multiple onDblClick=\"nm_del_sel('karyawan_dest', 'karyawan_orig', null);  \" alt=\"{type: 'select', enterTab: false}\">";
   $x = 0 ; 
   while (!empty($todo[$x])) 
   {
          $cadaselect = explode("?#?", $todo[$x]) ; 
   ...
   echo " </select>" ; 
   echo " <input type=\"hidden\" name=\"karyawan\" value=\"\">" ; 
   echo "</td></tr></table>";
   echo " <script>document.F1.karyawan_dest.selectedIndex = -1;</script>" ; 
   echo "\r" ; 
   echo "</span>";
?> 
<?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_masa_berlaku_label" id="hidden_field_label_masa_berlaku" style="<?php echo $sStyleHidden_masa_berlaku; ?>"><span id="id_label_masa_berlaku"><?php echo $this->nm_new_label['masa_berlaku']; ?></span></TD>
    <TD class="scFormDataOdd css_masa_berlaku_line" id="hidden_field_data_masa_berlaku" style="<?php echo $sStyleHidden_masa_berlaku; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_masa_berlaku_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_lampiran_label" id="hidden_field_label_lampiran" style="<?php echo $sStyleHidden_lampiran; ?>"><span id="id_label_lampiran"><?php echo $this->nm_new_label['lampiran']; ?></span></TD>
    <TD class="scFormDataOdd css_lampiran_line" id="hidden_field_data_lampiran" style="<?php echo $sStyleHidden_lampiran; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_lampiran_line" style="vertical-align: top;padding: 0px">
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ga_dokumen']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ga_dokumen']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_ga_dokumen']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_ga_dokumen']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_ga_dokumen']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ga_dokumen']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ga_dokumen']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ga_dokumen']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ga_dokumen']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ga_dokumen']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_ga_dokumen']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_ga_dokumen");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_ga_dokumen");
 parent.scAjaxDetailHeight("form_ga_dokumen", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ga_dokumen']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
