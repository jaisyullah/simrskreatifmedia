  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_ga_dokumen_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_ga_dokumen_mob_form();
	}

  // ---------- Validate nama_dok
  function do_ajax_form_ga_dokumen_mob_validate_nama_dok()
  {
    var nomeCampo_nama_dok = "nama_dok";
    var var_nama_dok = scAjaxGetFieldText(nomeCampo_nama_dok);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ga_dokumen_mob_validate_nama_dok(var_nama_dok, var_script_case_init, do_ajax_form_ga_dokumen_mob_validate_nama_dok_cb);
  } // do_ajax_form_ga_dokumen_mob_validate_nama_dok

  function do_ajax_form_ga_dokumen_mob_validate_nama_dok_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ga_dokumen_mob_validate_nama_dok_cb

  // ---------- Validate jenis
  function do_ajax_form_ga_dokumen_mob_validate_jenis()
  {
    var nomeCampo_jenis = "jenis";
    var var_jenis = scAjaxGetFieldSelect(nomeCampo_jenis);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ga_dokumen_mob_validate_jenis(var_jenis, var_script_case_init, do_ajax_form_ga_dokumen_mob_validate_jenis_cb);
  } // do_ajax_form_ga_dokumen_mob_validate_jenis

  function do_ajax_form_ga_dokumen_mob_validate_jenis_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "jenis";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ga_dokumen_mob_validate_jenis_cb

  // ---------- Validate sifat
  function do_ajax_form_ga_dokumen_mob_validate_sifat()
  {
    var nomeCampo_sifat = "sifat";
    var var_sifat = scAjaxGetFieldSelect(nomeCampo_sifat);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ga_dokumen_mob_validate_sifat(var_sifat, var_script_case_init, do_ajax_form_ga_dokumen_mob_validate_sifat_cb);
  } // do_ajax_form_ga_dokumen_mob_validate_sifat

  function do_ajax_form_ga_dokumen_mob_validate_sifat_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sifat";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ga_dokumen_mob_validate_sifat_cb

  // ---------- Validate unit
  function do_ajax_form_ga_dokumen_mob_validate_unit()
  {
    var nomeCampo_unit = "unit";
    var var_unit = scAjaxGetFieldSelect(nomeCampo_unit);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ga_dokumen_mob_validate_unit(var_unit, var_script_case_init, do_ajax_form_ga_dokumen_mob_validate_unit_cb);
  } // do_ajax_form_ga_dokumen_mob_validate_unit

  function do_ajax_form_ga_dokumen_mob_validate_unit_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "unit";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ga_dokumen_mob_validate_unit_cb

  // ---------- Validate karyawan
  function do_ajax_form_ga_dokumen_mob_validate_karyawan()
  {
    var nomeCampo_karyawan = "karyawan";
    var var_karyawan = scAjaxGetFieldSelect(nomeCampo_karyawan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ga_dokumen_mob_validate_karyawan(var_karyawan, var_script_case_init, do_ajax_form_ga_dokumen_mob_validate_karyawan_cb);
  } // do_ajax_form_ga_dokumen_mob_validate_karyawan

  function do_ajax_form_ga_dokumen_mob_validate_karyawan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ga_dokumen_mob_validate_karyawan_cb

  // ---------- Validate masa_berlaku
  function do_ajax_form_ga_dokumen_mob_validate_masa_berlaku()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ga_dokumen_mob_validate_masa_berlaku(var_masa_berlaku, var_masa_berlaku_dia, var_masa_berlaku_mes, var_masa_berlaku_ano, var_script_case_init, do_ajax_form_ga_dokumen_mob_validate_masa_berlaku_cb);
  } // do_ajax_form_ga_dokumen_mob_validate_masa_berlaku

  function do_ajax_form_ga_dokumen_mob_validate_masa_berlaku_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ga_dokumen_mob_validate_masa_berlaku_cb

  // ---------- Validate lampiran
  function do_ajax_form_ga_dokumen_mob_validate_lampiran()
  {
    var nomeCampo_lampiran = "lampiran";
    var var_lampiran = scAjaxGetFieldText(nomeCampo_lampiran);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ga_dokumen_mob_validate_lampiran(var_lampiran, var_script_case_init, do_ajax_form_ga_dokumen_mob_validate_lampiran_cb);
  } // do_ajax_form_ga_dokumen_mob_validate_lampiran

  function do_ajax_form_ga_dokumen_mob_validate_lampiran_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ga_dokumen_mob_validate_lampiran_cb

  // ---------- Validate keterangan
  function do_ajax_form_ga_dokumen_mob_validate_keterangan()
  {
    var nomeCampo_keterangan = "keterangan";
    var var_keterangan = scAjaxGetFieldText(nomeCampo_keterangan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ga_dokumen_mob_validate_keterangan(var_keterangan, var_script_case_init, do_ajax_form_ga_dokumen_mob_validate_keterangan_cb);
  } // do_ajax_form_ga_dokumen_mob_validate_keterangan

  function do_ajax_form_ga_dokumen_mob_validate_keterangan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ga_dokumen_mob_validate_keterangan_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_ga_dokumen_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_ga_dokumen_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    var var_karyawan = scAjaxGetFieldSelect("karyawan");
    ...
    scAjaxProcOn();
    x_ajax_form_ga_dokumen_mob_submit_form(var_nama_dok, var_jenis, var_sifat, var_unit, var_karyawan, var_masa_berlaku_mes, var_masa_berlaku_dia, var_masa_berlaku_ano, var_lampiran, var_keterangan, var_id, var_lampiran_ul_name, var_lampiran_ul_type, var_lampiran_salva, var_lampiran_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_ga_dokumen_mob_submit_form_cb);
  } // do_ajax_form_ga_dokumen_mob_submit_form

  function do_ajax_form_ga_dokumen_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_ga_dokumen_mob_submit_form_cb_after_alert);
  } // do_ajax_form_ga_dokumen_mob_submit_form_cb
  function do_ajax_form_ga_dokumen_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_ga_dokumen_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_ga_dokumen_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_ga_dokumen_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_ga_dokumen_mob_navigate_form_cb);
  } // do_ajax_form_ga_dokumen_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_ga_dokumen_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_ga_dokumen_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_ga_dokumen_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_ga_dokumen_mob_navigate_form_cb
  function do_ajax_form_ga_dokumen_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_ga_dokumen_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_ga_dokumen_mob_navigate_form_cb_after_alert
  function sc_hide_form_ga_dokumen_mob_form()
  {
