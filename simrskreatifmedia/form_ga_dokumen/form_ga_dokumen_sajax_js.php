  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_ga_dokumen" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_ga_dokumen_form();
	}

  // ---------- Validate nama_dok
  function do_ajax_form_ga_dokumen_validate_nama_dok()
  {
    var nomeCampo_nama_dok = "nama_dok";
    var var_nama_dok = scAjaxGetFieldText(nomeCampo_nama_dok);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ga_dokumen_validate_nama_dok(var_nama_dok, var_script_case_init, do_ajax_form_ga_dokumen_validate_nama_dok_cb);
  } // do_ajax_form_ga_dokumen_validate_nama_dok

  function do_ajax_form_ga_dokumen_validate_nama_dok_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nama_dok";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ga_dokumen_validate_nama_dok_cb

  // ---------- Validate jenis
  function do_ajax_form_ga_dokumen_validate_jenis()
  {
    var nomeCampo_jenis = "jenis";
    var var_jenis = scAjaxGetFieldSelect(nomeCampo_jenis);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ga_dokumen_validate_jenis(var_jenis, var_script_case_init, do_ajax_form_ga_dokumen_validate_jenis_cb);
  } // do_ajax_form_ga_dokumen_validate_jenis

  function do_ajax_form_ga_dokumen_validate_jenis_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "jenis";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ga_dokumen_validate_jenis_cb

  // ---------- Validate sifat
  function do_ajax_form_ga_dokumen_validate_sifat()
  {
    var nomeCampo_sifat = "sifat";
    var var_sifat = scAjaxGetFieldSelect(nomeCampo_sifat);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ga_dokumen_validate_sifat(var_sifat, var_script_case_init, do_ajax_form_ga_dokumen_validate_sifat_cb);
  } // do_ajax_form_ga_dokumen_validate_sifat

  function do_ajax_form_ga_dokumen_validate_sifat_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sifat";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ga_dokumen_validate_sifat_cb

  // ---------- Validate unit
  function do_ajax_form_ga_dokumen_validate_unit()
  {
    var nomeCampo_unit = "unit";
    nm_pack(nomeCampo_unit + '_dest', nomeCampo_unit);
    var var_unit = scAjaxGetFieldText(nomeCampo_unit);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ga_dokumen_validate_unit(var_unit, var_script_case_init, do_ajax_form_ga_dokumen_validate_unit_cb);
  } // do_ajax_form_ga_dokumen_validate_unit

  function do_ajax_form_ga_dokumen_validate_unit_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "unit";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ga_dokumen_validate_unit_cb

  // ---------- Validate karyawan
  function do_ajax_form_ga_dokumen_validate_karyawan()
  {
    var nomeCampo_karyawan = "karyawan";
    nm_pack(nomeCampo_karyawan + '_dest', nomeCampo_karyawan);
    var var_karyawan = scAjaxGetFieldText(nomeCampo_karyawan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ga_dokumen_validate_karyawan(var_karyawan, var_script_case_init, do_ajax_form_ga_dokumen_validate_karyawan_cb);
  } // do_ajax_form_ga_dokumen_validate_karyawan

  function do_ajax_form_ga_dokumen_validate_karyawan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "karyawan";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ga_dokumen_validate_karyawan_cb

  // ---------- Validate masa_berlaku
  function do_ajax_form_ga_dokumen_validate_masa_berlaku()
  {
    var nomeCampo_masa_berlaku = "masa_berlaku";
    var nomeCampo_masa_berlaku_dia = "masa_berlaku_dia";
    var nomeCampo_masa_berlaku_mes = "masa_berlaku_mes";
    var nomeCampo_masa_berlaku_ano = "masa_berlaku_ano";
    var var_masa_berlaku = scAjaxGetFieldText(nomeCampo_masa_berlaku);
    var var_masa_berlaku_dia = scAjaxGetFieldText(nomeCampo_masa_berlaku_dia);
    var var_masa_berlaku_mes = scAjaxGetFieldText(nomeCampo_masa_berlaku_mes);
    var var_masa_berlaku_ano = scAjaxGetFieldText(nomeCampo_masa_berlaku_ano);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ga_dokumen_validate_masa_berlaku(var_masa_berlaku, var_masa_berlaku_dia, var_masa_berlaku_mes, var_masa_berlaku_ano, var_script_case_init, do_ajax_form_ga_dokumen_validate_masa_berlaku_cb);
  } // do_ajax_form_ga_dokumen_validate_masa_berlaku

  function do_ajax_form_ga_dokumen_validate_masa_berlaku_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "masa_berlaku";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ga_dokumen_validate_masa_berlaku_cb

  // ---------- Validate lampiran
  function do_ajax_form_ga_dokumen_validate_lampiran()
  {
    var nomeCampo_lampiran = "lampiran";
    var var_lampiran = scAjaxGetFieldText(nomeCampo_lampiran);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ga_dokumen_validate_lampiran(var_lampiran, var_script_case_init, do_ajax_form_ga_dokumen_validate_lampiran_cb);
  } // do_ajax_form_ga_dokumen_validate_lampiran

  function do_ajax_form_ga_dokumen_validate_lampiran_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "lampiran";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ga_dokumen_validate_lampiran_cb

  // ---------- Validate keterangan
  function do_ajax_form_ga_dokumen_validate_keterangan()
  {
    var nomeCampo_keterangan = "keterangan";
    var var_keterangan = scAjaxGetFieldText(nomeCampo_keterangan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ga_dokumen_validate_keterangan(var_keterangan, var_script_case_init, do_ajax_form_ga_dokumen_validate_keterangan_cb);
  } // do_ajax_form_ga_dokumen_validate_keterangan

  function do_ajax_form_ga_dokumen_validate_keterangan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ga_dokumen_validate_keterangan_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_ga_dokumen_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_ga_dokumen_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_nama_dok = scAjaxGetFieldText("nama_dok");
    var var_jenis = scAjaxGetFieldSelect("jenis");
    var var_sifat = scAjaxGetFieldSelect("sifat");
    nm_pack("unit_dest", "unit");
    var var_unit = scAjaxGetFieldText("unit");
    nm_pack("karyawan_dest", "karyawan");
    var var_karyawan = scAjaxGetFieldText("karyawan");
    var var_masa_berlaku_mes = scAjaxGetFieldSelect("masa_berlaku_mes");
    var var_masa_berlaku_dia = scAjaxGetFieldSelect("masa_berlaku_dia");
    var var_masa_berlaku_ano = scAjaxGetFieldText("masa_berlaku_ano");
    var var_lampiran = scAjaxGetFieldText("lampiran");
    var var_keterangan = scAjaxGetFieldText("keterangan");
    var var_lampiran_ul_name = scAjaxSpecCharProtect(document.F1.lampiran_ul_name.value);//.replace(/[+]/g, "__NM_PLUS__");
    var var_lampiran_ul_type = document.F1.lampiran_ul_type.value;
    var var_lampiran_salva = scAjaxSpecCharProtect(document.F1.lampiran_salva.value);//.replace(/[+]/g, "__NM_PLUS__");
    var var_lampiran_limpa = document.F1.lampiran_limpa.checked ? "S" : "N";
    ...
    scAjaxProcOn();
    x_ajax_form_ga_dokumen_submit_form(var_nama_dok, var_jenis, var_sifat, var_unit, var_karyawan, var_masa_berlaku_mes, var_masa_berlaku_dia, var_masa_berlaku_ano, var_lampiran, var_keterangan, var_lampiran_ul_name, var_lampiran_ul_type, var_lampiran_salva, var_lampiran_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_ga_dokumen_submit_form_cb);
  } // do_ajax_form_ga_dokumen_submit_form

  function do_ajax_form_ga_dokumen_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("nama_dok");
      scAjaxHideErrorDisplay("jenis");
      scAjaxHideErrorDisplay("sifat");
      scAjaxHideErrorDisplay("unit");
      scAjaxHideErrorDisplay("karyawan");
      scAjaxHideErrorDisplay("masa_berlaku");
      scAjaxHideErrorDisplay("lampiran");
...
?>
    ...
    if (!scAjaxHasError())
    {
      ...
      if (document.F1.lampiran_limpa && document.F1.lampiran_limpa.checked)
      {
        var oImgTemp = {0: {"value" : ""}};
        scAjaxSetFieldDocument("lampiran", oImgTemp, "", "");
      }
      else if (document.getElementById("id_ajax_doc_lampiran") && "" != document.getElementById("id_ajax_doc_lampiran").innerHTML)
      {
        document.getElementById("id_ajax_doc_lampiran").style.display = "";
      }
    }
    scAjaxShowDebug();
    scAjaxSetDisplay();
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_ga_dokumen_submit_form_cb_after_alert);
  } // do_ajax_form_ga_dokumen_submit_form_cb
  function do_ajax_form_ga_dokumen_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_ga_dokumen_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_ga_dokumen_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_ga_dokumen_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_ga_dokumen_navigate_form_cb);
  } // do_ajax_form_ga_dokumen_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_ga_dokumen']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_ga_dokumen_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_ga_dokumen_navigate_form_cb_after_alert);
  } // do_ajax_form_ga_dokumen_navigate_form_cb
  function do_ajax_form_ga_dokumen_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_ga_dokumen_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_ga_dokumen_navigate_form_cb_after_alert
  function sc_hide_form_ga_dokumen_form()
  {
  ...
  ajax_field_list[0] = "nama_dok";
  ajax_field_list[1] = "jenis";
  ajax_field_list[2] = "sifat";
  ajax_field_list[3] = "unit";
  ajax_field_list[4] = "karyawan";
  ajax_field_list[5] = "masa_berlaku";
  ajax_field_list[6] = "lampiran";
  ajax_field_list[7] = "keterangan";
  ...
  var ajax_error_list = {
    "nama_dok": {"label": "Nama Dokumen", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "jenis": {"label": "Jenis Dokumen", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "sifat": {"label": "Sifat", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "unit": {"label": "Unit", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "karyawan": {"label": "Karyawan", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "masa_berlaku": {"label": "Masa Berlaku", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "lampiran": {"label": "Lampiran", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  var ajax_field_mult = {
    ...
    "unit": new Array(),
    "karyawan": new Array(),
    "masa_berlaku": new Array(),
    "lampiran": new Array(),
    "keterangan": new Array()
  };
  ajax_field_mult["nama_dok"][1] = "nama_dok";
  ajax_field_mult["jenis"][1] = "jenis";
  ajax_field_mult["sifat"][1] = "sifat";
  ajax_field_mult["unit"][1] = "unit";
  ajax_field_mult["karyawan"][1] = "karyawan";
  ajax_field_mult["masa_berlaku"][1] = "masa_berlaku";
  ajax_field_mult["lampiran"][1] = "lampiran";
  ajax_field_mult["keterangan"][1] = "keterangan";

  var ajax_field_id = {
    "nama_dok": new Array("hidden_field_label_nama_dok", "hidden_field_data_nama_dok"),
    "jenis": new Array("hidden_field_label_jenis", "hidden_field_data_jenis"),
    "sifat": new Array("hidden_field_label_sifat", "hidden_field_data_sifat"),
    "unit": new Array("hidden_field_label_unit", "hidden_field_data_unit"),
    "karyawan": new Array("hidden_field_label_karyawan", "hidden_field_data_karyawan"),
    "masa_berlaku": new Array("hidden_field_label_masa_berlaku", "hidden_field_data_masa_berlaku"),
    "lampiran": new Array("hidden_field_label_lampiran", "hidden_field_data_lampiran"),
