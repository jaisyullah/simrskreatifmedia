...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailigdF']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
  <input type="hidden" name="script_case_session" value="<?php echo $this->form_encode_input(session_id()); ?>"> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_tbdetailigdF"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
?> 
var var_btn_sc_btn_0_struknya = "<?php echo $this->form_encode_input($this->nmgp_dados_form['nostruk']); ?>";
...
{
  nm_gp_submit('<?php echo $this->Ini->link_copy_resep_igd; ?>', '<?php echo $this->nm_location; ?>', '<?php echo "struknya*scin' + var_btn_sc_btn_0_struknya + '*scout"; ?>', '', '_blank', '0', '0', 'copy_resep_igd');
}
var var_btn_sc_btn_1_struknya = "<?php echo $this->form_encode_input($this->nmgp_dados_form['trancode']); ?>";
...
{
  nm_gp_submit('<?php echo $this->Ini->link_obat_igd; ?>', '<?php echo $this->nm_location; ?>', '<?php echo "struknya*scin' + var_btn_sc_btn_1_struknya + '*scout"; ?>', '', '_blank', '0', '0', 'obat_igd');
}
 NM_tp_critica(1);
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailigdF']['where_detal']))
  {
?>  
...
{
   nm_field_disabled("trancode=disabled", "");
