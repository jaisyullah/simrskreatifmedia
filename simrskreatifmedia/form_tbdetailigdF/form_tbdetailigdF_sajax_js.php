  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbdetailigdF" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbdetailigdF_form();
	}

  // ---------- Validate trancode
  function do_ajax_form_tbdetailigdF_validate_trancode()
  {
    var nomeCampo_trancode = "trancode";
    var var_trancode = scAjaxGetFieldText(nomeCampo_trancode);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdetailigdF_validate_trancode(var_trancode, var_script_case_init, do_ajax_form_tbdetailigdF_validate_trancode_cb);
  } // do_ajax_form_tbdetailigdF_validate_trancode

  function do_ajax_form_tbdetailigdF_validate_trancode_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdetailigdF_validate_trancode_cb

  // ---------- Validate nostruk
  function do_ajax_form_tbdetailigdF_validate_nostruk()
  {
    var nomeCampo_nostruk = "nostruk";
    var var_nostruk = scAjaxGetFieldText(nomeCampo_nostruk);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdetailigdF_validate_nostruk(var_nostruk, var_script_case_init, do_ajax_form_tbdetailigdF_validate_nostruk_cb);
  } // do_ajax_form_tbdetailigdF_validate_nostruk

  function do_ajax_form_tbdetailigdF_validate_nostruk_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nostruk";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdetailigdF_validate_nostruk_cb

  // ---------- Validate custcode
  function do_ajax_form_tbdetailigdF_validate_custcode()
  {
    var nomeCampo_custcode = "custcode";
    var var_custcode = scAjaxGetFieldSelect(nomeCampo_custcode);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdetailigdF_validate_custcode(var_custcode, var_script_case_init, do_ajax_form_tbdetailigdF_validate_custcode_cb);
  } // do_ajax_form_tbdetailigdF_validate_custcode

  function do_ajax_form_tbdetailigdF_validate_custcode_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdetailigdF_validate_custcode_cb

  // ---------- Validate sc_field_0
  function do_ajax_form_tbdetailigdF_validate_sc_field_0()
  {
    var nomeCampo_sc_field_0 = "sc_field_0";
    var var_sc_field_0 = scAjaxGetFieldSelect(nomeCampo_sc_field_0);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdetailigdF_validate_sc_field_0(var_sc_field_0, var_script_case_init, do_ajax_form_tbdetailigdF_validate_sc_field_0_cb);
  } // do_ajax_form_tbdetailigdF_validate_sc_field_0

  function do_ajax_form_tbdetailigdF_validate_sc_field_0_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdetailigdF_validate_sc_field_0_cb

  // ---------- Validate dokter
  function do_ajax_form_tbdetailigdF_validate_dokter()
  {
    var nomeCampo_dokter = "dokter";
    var var_dokter = scAjaxGetFieldSelect(nomeCampo_dokter);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdetailigdF_validate_dokter(var_dokter, var_script_case_init, do_ajax_form_tbdetailigdF_validate_dokter_cb);
  } // do_ajax_form_tbdetailigdF_validate_dokter

  function do_ajax_form_tbdetailigdF_validate_dokter_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "dokter";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdetailigdF_validate_dokter_cb

  // ---------- Validate diagnosa1
  function do_ajax_form_tbdetailigdF_validate_diagnosa1()
  {
    var nomeCampo_diagnosa1 = "diagnosa1";
    var var_diagnosa1 = scAjaxGetFieldText(nomeCampo_diagnosa1);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdetailigdF_validate_diagnosa1(var_diagnosa1, var_script_case_init, do_ajax_form_tbdetailigdF_validate_diagnosa1_cb);
  } // do_ajax_form_tbdetailigdF_validate_diagnosa1

  function do_ajax_form_tbdetailigdF_validate_diagnosa1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdetailigdF_validate_diagnosa1_cb

  // ---------- Validate icd1
  function do_ajax_form_tbdetailigdF_validate_icd1()
  {
  } // do_ajax_form_tbdetailigdF_validate_icd1

  function do_ajax_form_tbdetailigdF_validate_icd1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "icd1";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdetailigdF_validate_icd1_cb

  // ---------- Validate diagnosa2
  function do_ajax_form_tbdetailigdF_validate_diagnosa2()
  {
    var nomeCampo_diagnosa2 = "diagnosa2";
    var var_diagnosa2 = scAjaxGetFieldText(nomeCampo_diagnosa2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdetailigdF_validate_diagnosa2(var_diagnosa2, var_script_case_init, do_ajax_form_tbdetailigdF_validate_diagnosa2_cb);
  } // do_ajax_form_tbdetailigdF_validate_diagnosa2

  function do_ajax_form_tbdetailigdF_validate_diagnosa2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdetailigdF_validate_diagnosa2_cb

  // ---------- Validate icd2
  function do_ajax_form_tbdetailigdF_validate_icd2()
  {
  } // do_ajax_form_tbdetailigdF_validate_icd2

  function do_ajax_form_tbdetailigdF_validate_icd2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "icd2";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdetailigdF_validate_icd2_cb

  // ---------- Validate selesai
  function do_ajax_form_tbdetailigdF_validate_selesai()
  {
    var nomeCampo_selesai = "selesai";
    var var_selesai = scAjaxGetFieldSelect(nomeCampo_selesai);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdetailigdF_validate_selesai(var_selesai, var_script_case_init, do_ajax_form_tbdetailigdF_validate_selesai_cb);
  } // do_ajax_form_tbdetailigdF_validate_selesai

  function do_ajax_form_tbdetailigdF_validate_selesai_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "selesai";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdetailigdF_validate_selesai_cb

  // ---------- Validate tglkeluar
  function do_ajax_form_tbdetailigdF_validate_tglkeluar()
  {
    var nomeCampo_tglkeluar = "tglkeluar";
    var var_tglkeluar = scAjaxGetFieldText(nomeCampo_tglkeluar);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdetailigdF_validate_tglkeluar(var_tglkeluar, var_script_case_init, do_ajax_form_tbdetailigdF_validate_tglkeluar_cb);
  } // do_ajax_form_tbdetailigdF_validate_tglkeluar

  function do_ajax_form_tbdetailigdF_validate_tglkeluar_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdetailigdF_validate_tglkeluar_cb

  // ---------- Validate carakeluar
  function do_ajax_form_tbdetailigdF_validate_carakeluar()
  {
    var nomeCampo_carakeluar = "carakeluar";
    var var_carakeluar = scAjaxGetFieldSelect(nomeCampo_carakeluar);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdetailigdF_validate_carakeluar(var_carakeluar, var_script_case_init, do_ajax_form_tbdetailigdF_validate_carakeluar_cb);
  } // do_ajax_form_tbdetailigdF_validate_carakeluar

  function do_ajax_form_tbdetailigdF_validate_carakeluar_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdetailigdF_validate_carakeluar_cb

  // ---------- Validate alasankeluar
  function do_ajax_form_tbdetailigdF_validate_alasankeluar()
  {
    var nomeCampo_alasankeluar = "alasankeluar";
    var var_alasankeluar = scAjaxGetFieldText(nomeCampo_alasankeluar);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdetailigdF_validate_alasankeluar(var_alasankeluar, var_script_case_init, do_ajax_form_tbdetailigdF_validate_alasankeluar_cb);
  } // do_ajax_form_tbdetailigdF_validate_alasankeluar

  function do_ajax_form_tbdetailigdF_validate_alasankeluar_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdetailigdF_validate_alasankeluar_cb

  // ---------- Validate resep
  function do_ajax_form_tbdetailigdF_validate_resep()
  {
    var nomeCampo_resep = "resep";
    var var_resep = scAjaxGetFieldText(nomeCampo_resep);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdetailigdF_validate_resep(var_resep, var_script_case_init, do_ajax_form_tbdetailigdF_validate_resep_cb);
  } // do_ajax_form_tbdetailigdF_validate_resep

  function do_ajax_form_tbdetailigdF_validate_resep_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "resep";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdetailigdF_validate_resep_cb

  // ---------- Refresh trancode
  function do_ajax_form_tbdetailigdF_refresh_trancode()
  {
    ...
    scAjaxProcOn(true);
    x_ajax_form_tbdetailigdF_refresh_trancode(var_trancode, var_nostruk, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_tbdetailigdF_refresh_trancode_cb);
  } // do_ajax_form_tbdetailigdF_refresh_trancode

  function do_ajax_form_tbdetailigdF_refresh_trancode_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdetailigdF_refresh_trancode_cb

  // ---------- Refresh nostruk
  function do_ajax_form_tbdetailigdF_refresh_nostruk()
  {
    var var_nostruk = scAjaxGetFieldText("nostruk");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tbdetailigdF_refresh_nostruk(var_nostruk, var_custcode, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_tbdetailigdF_refresh_nostruk_cb);
  } // do_ajax_form_tbdetailigdF_refresh_nostruk

  function do_ajax_form_tbdetailigdF_refresh_nostruk_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdetailigdF_refresh_nostruk_cb

  // ---------- Refresh custcode
  function do_ajax_form_tbdetailigdF_refresh_custcode()
  {
    var var_custcode = scAjaxGetFieldSelect("custcode");
    var var_nmgp_refresh_fields = "sc_field_0";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tbdetailigdF_refresh_custcode(var_custcode, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_tbdetailigdF_refresh_custcode_cb);
  } // do_ajax_form_tbdetailigdF_refresh_custcode

  function do_ajax_form_tbdetailigdF_refresh_custcode_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdetailigdF_refresh_custcode_cb

  // ---------- Event onchange selesai
  function do_ajax_form_tbdetailigdF_event_selesai_onchange()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tbdetailigdF_event_selesai_onchange(var_selesai, var_tglkeluar, var_carakeluar, var_alasankeluar, var_trancode, var_script_case_init, do_ajax_form_tbdetailigdF_event_selesai_onchange_cb);
  } // do_ajax_form_tbdetailigdF_event_selesai_onchange

  function do_ajax_form_tbdetailigdF_event_selesai_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "selesai";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_tbdetailigdF_event_selesai_onchange_cb_after_alert);
  } // do_ajax_form_tbdetailigdF_event_selesai_onchange_cb
  function do_ajax_form_tbdetailigdF_event_selesai_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_tbdetailigdF_event_selesai_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tbdetailigdF_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tbdetailigdF_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_trancode = scAjaxGetFieldText("trancode");
    ...
    scAjaxProcOn();
    x_ajax_form_tbdetailigdF_submit_form(var_trancode, var_nostruk, var_custcode, var_sc_field_0, var_dokter, var_diagnosa1, var_icd1, var_diagnosa2, var_icd2, var_selesai, var_tglkeluar, var_carakeluar, var_alasankeluar, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbdetailigdF_submit_form_cb);
  } // do_ajax_form_tbdetailigdF_submit_form

  function do_ajax_form_tbdetailigdF_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tbdetailigdF_submit_form_cb_after_alert);
  } // do_ajax_form_tbdetailigdF_submit_form_cb
  function do_ajax_form_tbdetailigdF_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbdetailigdF_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_tbreseprawatigdF"] = "off";

  function do_ajax_form_tbdetailigdF_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    scStatusDetail["form_tbreseprawatigdF"] = "on";
    x_ajax_form_tbdetailigdF_navigate_form(var_nostruk, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbdetailigdF_navigate_form_cb);
  } // do_ajax_form_tbdetailigdF_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailigdF']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbdetailigdF_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_tbreseprawatigdF"] && "nmsc_iframe_liga_form_tbreseprawatigdF" != scMasterDetailIframe["nmsc_iframe_liga_form_tbreseprawatigdF"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_tbreseprawatigdF"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_tbreseprawatigdF').contentWindow.nm_move('apl_detalhe', true, '500');
        document.getElementById('nmsc_iframe_liga_form_tbreseprawatigdF').style.height = "500";
        document.getElementById('nmsc_iframe_liga_form_tbreseprawatigdF').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbdetailigdF_navigate_form_cb_after_alert);
  } // do_ajax_form_tbdetailigdF_navigate_form_cb
  function do_ajax_form_tbdetailigdF_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_tbdetailigdF_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_tbdetailigdF_navigate_form_cb_after_alert
  function sc_hide_form_tbdetailigdF_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_tbreseprawatigdF"])
    {
      return true;
    }
    return false;
