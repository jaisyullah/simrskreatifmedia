  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbracikan" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbracikan_form();
	}

  // ---------- Validate racikancode
  function do_ajax_form_tbracikan_validate_racikancode()
  {
    var nomeCampo_racikancode = "racikancode";
    var var_racikancode = scAjaxGetFieldText(nomeCampo_racikancode);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbracikan_validate_racikancode(var_racikancode, var_script_case_init, do_ajax_form_tbracikan_validate_racikancode_cb);
  } // do_ajax_form_tbracikan_validate_racikancode

  function do_ajax_form_tbracikan_validate_racikancode_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbracikan_validate_racikancode_cb

  // ---------- Validate jasaresep
  function do_ajax_form_tbracikan_validate_jasaresep()
  {
    var nomeCampo_jasaresep = "jasaresep";
    var var_jasaresep = scAjaxGetFieldText(nomeCampo_jasaresep);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbracikan_validate_jasaresep(var_jasaresep, var_script_case_init, do_ajax_form_tbracikan_validate_jasaresep_cb);
  } // do_ajax_form_tbracikan_validate_jasaresep

  function do_ajax_form_tbracikan_validate_jasaresep_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbracikan_validate_jasaresep_cb

  // ---------- Validate signakali
  function do_ajax_form_tbracikan_validate_signakali()
  {
  } // do_ajax_form_tbracikan_validate_signakali

  function do_ajax_form_tbracikan_validate_signakali_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbracikan_validate_signakali_cb

  // ---------- Validate jenisaturanpakai
  function do_ajax_form_tbracikan_validate_jenisaturanpakai()
  {
  } // do_ajax_form_tbracikan_validate_jenisaturanpakai

  function do_ajax_form_tbracikan_validate_jenisaturanpakai_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbracikan_validate_jenisaturanpakai_cb

  // ---------- Validate totalracikan
  function do_ajax_form_tbracikan_validate_totalracikan()
  {
    var nomeCampo_totalracikan = "totalracikan";
    var var_totalracikan = scAjaxGetFieldText(nomeCampo_totalracikan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbracikan_validate_totalracikan(var_totalracikan, var_script_case_init, do_ajax_form_tbracikan_validate_totalracikan_cb);
  } // do_ajax_form_tbracikan_validate_totalracikan

  function do_ajax_form_tbracikan_validate_totalracikan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbracikan_validate_totalracikan_cb

  // ---------- Validate hargatotal
  function do_ajax_form_tbracikan_validate_hargatotal()
  {
    var nomeCampo_hargatotal = "hargatotal";
    var var_hargatotal = scAjaxGetFieldText(nomeCampo_hargatotal);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbracikan_validate_hargatotal(var_hargatotal, var_script_case_init, do_ajax_form_tbracikan_validate_hargatotal_cb);
  } // do_ajax_form_tbracikan_validate_hargatotal

  function do_ajax_form_tbracikan_validate_hargatotal_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbracikan_validate_hargatotal_cb

  // ---------- Validate detail
  function do_ajax_form_tbracikan_validate_detail()
  {
    var nomeCampo_detail = "detail";
    var var_detail = scAjaxGetFieldText(nomeCampo_detail);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbracikan_validate_detail(var_detail, var_script_case_init, do_ajax_form_tbracikan_validate_detail_cb);
  } // do_ajax_form_tbracikan_validate_detail

  function do_ajax_form_tbracikan_validate_detail_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "detail";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbracikan_validate_detail_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tbracikan_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tbracikan_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_tbracikan_submit_form(var_racikancode, var_jasaresep, var_signakali, var_jenisaturanpakai, var_totalracikan, var_hargatotal, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbracikan_submit_form_cb);
  } // do_ajax_form_tbracikan_submit_form

  function do_ajax_form_tbracikan_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tbracikan_submit_form_cb_after_alert);
  } // do_ajax_form_tbracikan_submit_form_cb
  function do_ajax_form_tbracikan_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbracikan_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_tbdetailracikan"] = "off";

  function do_ajax_form_tbracikan_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    scStatusDetail["form_tbdetailracikan"] = "on";
    x_ajax_form_tbracikan_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbracikan_navigate_form_cb);
  } // do_ajax_form_tbracikan_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbracikan']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbracikan_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_tbdetailracikan"] && "nmsc_iframe_liga_form_tbdetailracikan" != scMasterDetailIframe["nmsc_iframe_liga_form_tbdetailracikan"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_tbdetailracikan"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_tbdetailracikan').contentWindow.nm_move('apl_detalhe', true, '500');
        document.getElementById('nmsc_iframe_liga_form_tbdetailracikan').style.height = "500";
        document.getElementById('nmsc_iframe_liga_form_tbdetailracikan').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbracikan_navigate_form_cb_after_alert);
  } // do_ajax_form_tbracikan_navigate_form_cb
  function do_ajax_form_tbracikan_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_tbracikan_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_tbracikan_navigate_form_cb_after_alert
  function sc_hide_form_tbracikan_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_tbdetailracikan"])
    {
      return true;
    }
    return false;
