  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbracikan_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbracikan_mob_form();
	}

  // ---------- Validate racikancode
  function do_ajax_form_tbracikan_mob_validate_racikancode()
  {
    var nomeCampo_racikancode = "racikancode";
    var var_racikancode = scAjaxGetFieldText(nomeCampo_racikancode);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbracikan_mob_validate_racikancode(var_racikancode, var_script_case_init, do_ajax_form_tbracikan_mob_validate_racikancode_cb);
  } // do_ajax_form_tbracikan_mob_validate_racikancode

  function do_ajax_form_tbracikan_mob_validate_racikancode_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "racikancode";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbracikan_mob_validate_racikancode_cb

  // ---------- Validate jasaresep
  function do_ajax_form_tbracikan_mob_validate_jasaresep()
  {
    var nomeCampo_jasaresep = "jasaresep";
    var var_jasaresep = scAjaxGetFieldText(nomeCampo_jasaresep);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbracikan_mob_validate_jasaresep(var_jasaresep, var_script_case_init, do_ajax_form_tbracikan_mob_validate_jasaresep_cb);
  } // do_ajax_form_tbracikan_mob_validate_jasaresep

  function do_ajax_form_tbracikan_mob_validate_jasaresep_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "jasaresep";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbracikan_mob_validate_jasaresep_cb

  // ---------- Validate signakali
  function do_ajax_form_tbracikan_mob_validate_signakali()
  {
  } // do_ajax_form_tbracikan_mob_validate_signakali

  function do_ajax_form_tbracikan_mob_validate_signakali_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "signakali";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbracikan_mob_validate_signakali_cb

  // ---------- Validate jenisaturanpakai
  function do_ajax_form_tbracikan_mob_validate_jenisaturanpakai()
  {
  } // do_ajax_form_tbracikan_mob_validate_jenisaturanpakai

  function do_ajax_form_tbracikan_mob_validate_jenisaturanpakai_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbracikan_mob_validate_jenisaturanpakai_cb

  // ---------- Validate totalracikan
  function do_ajax_form_tbracikan_mob_validate_totalracikan()
  {
    var nomeCampo_totalracikan = "totalracikan";
    var var_totalracikan = scAjaxGetFieldText(nomeCampo_totalracikan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbracikan_mob_validate_totalracikan(var_totalracikan, var_script_case_init, do_ajax_form_tbracikan_mob_validate_totalracikan_cb);
  } // do_ajax_form_tbracikan_mob_validate_totalracikan

  function do_ajax_form_tbracikan_mob_validate_totalracikan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "totalracikan";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbracikan_mob_validate_totalracikan_cb

  // ---------- Validate hargatotal
  function do_ajax_form_tbracikan_mob_validate_hargatotal()
  {
    var nomeCampo_hargatotal = "hargatotal";
    var var_hargatotal = scAjaxGetFieldText(nomeCampo_hargatotal);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbracikan_mob_validate_hargatotal(var_hargatotal, var_script_case_init, do_ajax_form_tbracikan_mob_validate_hargatotal_cb);
  } // do_ajax_form_tbracikan_mob_validate_hargatotal

  function do_ajax_form_tbracikan_mob_validate_hargatotal_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "hargatotal";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbracikan_mob_validate_hargatotal_cb

  // ---------- Validate detail
  function do_ajax_form_tbracikan_mob_validate_detail()
  {
    var nomeCampo_detail = "detail";
    var var_detail = scAjaxGetFieldText(nomeCampo_detail);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbracikan_mob_validate_detail(var_detail, var_script_case_init, do_ajax_form_tbracikan_mob_validate_detail_cb);
  } // do_ajax_form_tbracikan_mob_validate_detail

  function do_ajax_form_tbracikan_mob_validate_detail_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "detail";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbracikan_mob_validate_detail_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tbracikan_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tbracikan_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_racikancode = scAjaxGetFieldText("racikancode");
    var var_jasaresep = scAjaxGetFieldText("jasaresep");
    var var_signakali = scAjaxGetFieldText("signakali");
    var var_jenisaturanpakai = scAjaxGetFieldText("jenisaturanpakai");
    var var_totalracikan = scAjaxGetFieldText("totalracikan");
    var var_hargatotal = scAjaxGetFieldText("hargatotal");
    ...
    scAjaxProcOn();
    x_ajax_form_tbracikan_mob_submit_form(var_racikancode, var_jasaresep, var_signakali, var_jenisaturanpakai, var_totalracikan, var_hargatotal, var_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbracikan_mob_submit_form_cb);
  } // do_ajax_form_tbracikan_mob_submit_form

  function do_ajax_form_tbracikan_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("racikancode");
      scAjaxHideErrorDisplay("jasaresep");
      scAjaxHideErrorDisplay("signakali");
      scAjaxHideErrorDisplay("jenisaturanpakai");
      scAjaxHideErrorDisplay("totalracikan");
      scAjaxHideErrorDisplay("hargatotal");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tbracikan_mob_submit_form_cb_after_alert);
  } // do_ajax_form_tbracikan_mob_submit_form_cb
  function do_ajax_form_tbracikan_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbracikan_mob_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_tbdetailracikan_mob"] = "off";

  function do_ajax_form_tbracikan_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    scStatusDetail["form_tbdetailracikan_mob"] = "on";
    x_ajax_form_tbracikan_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbracikan_mob_navigate_form_cb);
  } // do_ajax_form_tbracikan_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbracikan_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbracikan_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_tbdetailracikan_mob"] && "nmsc_iframe_liga_form_tbdetailracikan_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_tbdetailracikan_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_tbdetailracikan_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_tbdetailracikan_mob').contentWindow.nm_move('apl_detalhe', true, '500');
        document.getElementById('nmsc_iframe_liga_form_tbdetailracikan_mob').style.height = "500";
        document.getElementById('nmsc_iframe_liga_form_tbdetailracikan_mob').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbracikan_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_tbracikan_mob_navigate_form_cb
  function do_ajax_form_tbracikan_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_tbracikan_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_tbracikan_mob_navigate_form_cb_after_alert
  function sc_hide_form_tbracikan_mob_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_tbdetailracikan_mob"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[0] = "racikancode";
  ajax_field_list[1] = "jasaresep";
  ajax_field_list[2] = "signakali";
  ajax_field_list[3] = "jenisaturanpakai";
  ajax_field_list[4] = "totalracikan";
  ajax_field_list[5] = "hargatotal";
  ajax_field_list[6] = "detail";
  ...
  var ajax_error_list = {
    "racikancode": {"label": "Kode Resep", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "jasaresep": {"label": "Jasa Resep", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "signakali": {"label": "Signa", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "jenisaturanpakai": {"label": "Aturan Pakai", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "totalracikan": {"label": "Total Racikan", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "hargatotal": {"label": "Harga Total", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  var ajax_field_mult = {
    "racikancode": new Array(),
    "jasaresep": new Array(),
    "signakali": new Array(),
    "jenisaturanpakai": new Array(),
    "totalracikan": new Array(),
    "hargatotal": new Array(),
    "detail": new Array()
  };
  ajax_field_mult["racikancode"][1] = "racikancode";
  ajax_field_mult["jasaresep"][1] = "jasaresep";
  ajax_field_mult["signakali"][1] = "signakali";
  ajax_field_mult["jenisaturanpakai"][1] = "jenisaturanpakai";
  ajax_field_mult["totalracikan"][1] = "totalracikan";
  ajax_field_mult["hargatotal"][1] = "hargatotal";
  ajax_field_mult["detail"][1] = "detail";

  var ajax_field_id = {
    "racikancode": new Array("hidden_field_label_racikancode", "hidden_field_data_racikancode"),
    "jasaresep": new Array("hidden_field_label_jasaresep", "hidden_field_data_jasaresep"),
    "signakali": new Array("hidden_field_label_signakali", "hidden_field_data_signakali"),
    "jenisaturanpakai": new Array("hidden_field_label_jenisaturanpakai", "hidden_field_data_jenisaturanpakai"),
    "totalracikan": new Array("hidden_field_label_totalracikan", "hidden_field_data_totalracikan"),
    "hargatotal": new Array("hidden_field_label_hargatotal", "hidden_field_data_hargatotal"),
