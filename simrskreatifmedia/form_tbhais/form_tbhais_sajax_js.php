  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbhais" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbhais_form();
	}

  // ---------- Validate trancode
  function do_ajax_form_tbhais_validate_trancode()
  {
    var nomeCampo_trancode = "trancode";
    var var_trancode = scAjaxGetFieldText(nomeCampo_trancode);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbhais_validate_trancode(var_trancode, var_script_case_init, do_ajax_form_tbhais_validate_trancode_cb);
  } // do_ajax_form_tbhais_validate_trancode

  function do_ajax_form_tbhais_validate_trancode_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbhais_validate_trancode_cb

  // ---------- Validate custcode
  function do_ajax_form_tbhais_validate_custcode()
  {
    var nomeCampo_custcode = "custcode";
    var var_custcode = scAjaxGetFieldSelect(nomeCampo_custcode);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbhais_validate_custcode(var_custcode, var_script_case_init, do_ajax_form_tbhais_validate_custcode_cb);
  } // do_ajax_form_tbhais_validate_custcode

  function do_ajax_form_tbhais_validate_custcode_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbhais_validate_custcode_cb

  // ---------- Validate trandate
  function do_ajax_form_tbhais_validate_trandate()
  {
    var nomeCampo_trandate = "trandate";
    var var_trandate = scAjaxGetFieldText(nomeCampo_trandate);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbhais_validate_trandate(var_trandate, var_script_case_init, do_ajax_form_tbhais_validate_trandate_cb);
  } // do_ajax_form_tbhais_validate_trandate

  function do_ajax_form_tbhais_validate_trandate_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbhais_validate_trandate_cb

  // ---------- Validate deku
  function do_ajax_form_tbhais_validate_deku()
  {
    var nomeCampo_deku = "deku";
    var var_deku = scAjaxGetFieldSelect(nomeCampo_deku);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbhais_validate_deku(var_deku, var_script_case_init, do_ajax_form_tbhais_validate_deku_cb);
  } // do_ajax_form_tbhais_validate_deku

  function do_ajax_form_tbhais_validate_deku_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "deku";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbhais_validate_deku_cb

  // ---------- Validate ett
  function do_ajax_form_tbhais_validate_ett()
  {
    var nomeCampo_ett = "ett";
    var var_ett = scAjaxGetFieldText(nomeCampo_ett);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbhais_validate_ett(var_ett, var_script_case_init, do_ajax_form_tbhais_validate_ett_cb);
  } // do_ajax_form_tbhais_validate_ett

  function do_ajax_form_tbhais_validate_ett_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ett";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbhais_validate_ett_cb

  // ---------- Validate cvl
  function do_ajax_form_tbhais_validate_cvl()
  {
    var nomeCampo_cvl = "cvl";
    var var_cvl = scAjaxGetFieldText(nomeCampo_cvl);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbhais_validate_cvl(var_cvl, var_script_case_init, do_ajax_form_tbhais_validate_cvl_cb);
  } // do_ajax_form_tbhais_validate_cvl

  function do_ajax_form_tbhais_validate_cvl_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cvl";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbhais_validate_cvl_cb

  // ---------- Validate ivl
  function do_ajax_form_tbhais_validate_ivl()
  {
    var nomeCampo_ivl = "ivl";
    var var_ivl = scAjaxGetFieldText(nomeCampo_ivl);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbhais_validate_ivl(var_ivl, var_script_case_init, do_ajax_form_tbhais_validate_ivl_cb);
  } // do_ajax_form_tbhais_validate_ivl

  function do_ajax_form_tbhais_validate_ivl_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ivl";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbhais_validate_ivl_cb

  // ---------- Validate uc
  function do_ajax_form_tbhais_validate_uc()
  {
    var nomeCampo_uc = "uc";
    var var_uc = scAjaxGetFieldText(nomeCampo_uc);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbhais_validate_uc(var_uc, var_script_case_init, do_ajax_form_tbhais_validate_uc_cb);
  } // do_ajax_form_tbhais_validate_uc

  function do_ajax_form_tbhais_validate_uc_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "uc";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbhais_validate_uc_cb

  // ---------- Validate sputum
  function do_ajax_form_tbhais_validate_sputum()
  {
    var nomeCampo_sputum = "sputum";
    var var_sputum = scAjaxGetFieldText(nomeCampo_sputum);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbhais_validate_sputum(var_sputum, var_script_case_init, do_ajax_form_tbhais_validate_sputum_cb);
  } // do_ajax_form_tbhais_validate_sputum

  function do_ajax_form_tbhais_validate_sputum_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sputum";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbhais_validate_sputum_cb

  // ---------- Validate darah
  function do_ajax_form_tbhais_validate_darah()
  {
    var nomeCampo_darah = "darah";
    var var_darah = scAjaxGetFieldText(nomeCampo_darah);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbhais_validate_darah(var_darah, var_script_case_init, do_ajax_form_tbhais_validate_darah_cb);
  } // do_ajax_form_tbhais_validate_darah

  function do_ajax_form_tbhais_validate_darah_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "darah";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbhais_validate_darah_cb

  // ---------- Validate urine
  function do_ajax_form_tbhais_validate_urine()
  {
    var nomeCampo_urine = "urine";
    var var_urine = scAjaxGetFieldText(nomeCampo_urine);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbhais_validate_urine(var_urine, var_script_case_init, do_ajax_form_tbhais_validate_urine_cb);
  } // do_ajax_form_tbhais_validate_urine

  function do_ajax_form_tbhais_validate_urine_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "urine";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbhais_validate_urine_cb

  // ---------- Validate antibiotik
  function do_ajax_form_tbhais_validate_antibiotik()
  {
    var nomeCampo_antibiotik = "antibiotik";
    var var_antibiotik = scAjaxGetFieldText(nomeCampo_antibiotik);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbhais_validate_antibiotik(var_antibiotik, var_script_case_init, do_ajax_form_tbhais_validate_antibiotik_cb);
  } // do_ajax_form_tbhais_validate_antibiotik

  function do_ajax_form_tbhais_validate_antibiotik_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "antibiotik";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbhais_validate_antibiotik_cb

  // ---------- Validate vap
  function do_ajax_form_tbhais_validate_vap()
  {
    var nomeCampo_vap = "vap";
    var var_vap = scAjaxGetFieldText(nomeCampo_vap);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbhais_validate_vap(var_vap, var_script_case_init, do_ajax_form_tbhais_validate_vap_cb);
  } // do_ajax_form_tbhais_validate_vap

  function do_ajax_form_tbhais_validate_vap_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "vap";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbhais_validate_vap_cb

  // ---------- Validate iad
  function do_ajax_form_tbhais_validate_iad()
  {
    var nomeCampo_iad = "iad";
    var var_iad = scAjaxGetFieldText(nomeCampo_iad);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbhais_validate_iad(var_iad, var_script_case_init, do_ajax_form_tbhais_validate_iad_cb);
  } // do_ajax_form_tbhais_validate_iad

  function do_ajax_form_tbhais_validate_iad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "iad";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbhais_validate_iad_cb

  // ---------- Validate pleb
  function do_ajax_form_tbhais_validate_pleb()
  {
    var nomeCampo_pleb = "pleb";
    var var_pleb = scAjaxGetFieldText(nomeCampo_pleb);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbhais_validate_pleb(var_pleb, var_script_case_init, do_ajax_form_tbhais_validate_pleb_cb);
  } // do_ajax_form_tbhais_validate_pleb

  function do_ajax_form_tbhais_validate_pleb_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pleb";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbhais_validate_pleb_cb

  // ---------- Validate isk
  function do_ajax_form_tbhais_validate_isk()
  {
    var nomeCampo_isk = "isk";
    var var_isk = scAjaxGetFieldText(nomeCampo_isk);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbhais_validate_isk(var_isk, var_script_case_init, do_ajax_form_tbhais_validate_isk_cb);
  } // do_ajax_form_tbhais_validate_isk

  function do_ajax_form_tbhais_validate_isk_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "isk";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbhais_validate_isk_cb

  // ---------- Refresh trancode
  function do_ajax_form_tbhais_refresh_trancode()
  {
    var var_trancode = scAjaxGetFieldText("trancode");
    var var_nmgp_refresh_fields = "custcode";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tbhais_refresh_trancode(var_trancode, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_tbhais_refresh_trancode_cb);
  } // do_ajax_form_tbhais_refresh_trancode

  function do_ajax_form_tbhais_refresh_trancode_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbhais_refresh_trancode_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tbhais_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tbhais_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_trancode = scAjaxGetFieldText("trancode");
    ...
    var var_deku = scAjaxGetFieldSelect("deku");
    var var_ett = scAjaxGetFieldText("ett");
    var var_cvl = scAjaxGetFieldText("cvl");
    var var_ivl = scAjaxGetFieldText("ivl");
    var var_uc = scAjaxGetFieldText("uc");
    var var_sputum = scAjaxGetFieldText("sputum");
    var var_darah = scAjaxGetFieldText("darah");
    var var_urine = scAjaxGetFieldText("urine");
    var var_antibiotik = scAjaxGetFieldText("antibiotik");
    var var_vap = scAjaxGetFieldText("vap");
    var var_iad = scAjaxGetFieldText("iad");
    var var_pleb = scAjaxGetFieldText("pleb");
    var var_isk = scAjaxGetFieldText("isk");
    ...
    scAjaxProcOn();
    x_ajax_form_tbhais_submit_form(var_trancode, var_custcode, var_trandate, var_deku, var_ett, var_cvl, var_ivl, var_uc, var_sputum, var_darah, var_urine, var_antibiotik, var_vap, var_iad, var_pleb, var_isk, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbhais_submit_form_cb);
  } // do_ajax_form_tbhais_submit_form

  function do_ajax_form_tbhais_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("deku");
      scAjaxHideErrorDisplay("ett");
      scAjaxHideErrorDisplay("cvl");
      scAjaxHideErrorDisplay("ivl");
      scAjaxHideErrorDisplay("uc");
      scAjaxHideErrorDisplay("sputum");
      scAjaxHideErrorDisplay("darah");
      scAjaxHideErrorDisplay("urine");
      scAjaxHideErrorDisplay("antibiotik");
      scAjaxHideErrorDisplay("vap");
      scAjaxHideErrorDisplay("iad");
      scAjaxHideErrorDisplay("pleb");
      scAjaxHideErrorDisplay("isk");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tbhais_submit_form_cb_after_alert);
  } // do_ajax_form_tbhais_submit_form_cb
  function do_ajax_form_tbhais_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbhais_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tbhais_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tbhais_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbhais_navigate_form_cb);
  } // do_ajax_form_tbhais_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhais']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbhais_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbhais_navigate_form_cb_after_alert);
  } // do_ajax_form_tbhais_navigate_form_cb
  function do_ajax_form_tbhais_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_tbhais_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_tbhais_navigate_form_cb_after_alert
  function sc_hide_form_tbhais_form()
  {
  ...
  ajax_field_list[3] = "deku";
  ajax_field_list[4] = "ett";
  ajax_field_list[5] = "cvl";
  ajax_field_list[6] = "ivl";
  ajax_field_list[7] = "uc";
  ajax_field_list[8] = "sputum";
  ajax_field_list[9] = "darah";
  ajax_field_list[10] = "urine";
  ajax_field_list[11] = "antibiotik";
  ajax_field_list[12] = "vap";
  ajax_field_list[13] = "iad";
  ajax_field_list[14] = "pleb";
  ajax_field_list[15] = "isk";
  ...
  var ajax_error_list = {
    "trancode": {"label": "Kode Ranap", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "custcode": {"label": "Pasien", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "deku": {"label": "Deku", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "ett": {"label": "ETT", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "cvl": {"label": "CVL", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "ivl": {"label": "IVL", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "uc": {"label": "UC", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "sputum": {"label": "Sputum", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "darah": {"label": "Darah", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "urine": {"label": "Urine", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "antibiotik": {"label": "Antibiotik", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "vap": {"label": "VAP", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "iad": {"label": "IAD", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "pleb": {"label": "PLEB", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "isk": {"label": "ISK", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  ajax_field_mult["deku"][1] = "deku";
  ajax_field_mult["ett"][1] = "ett";
  ajax_field_mult["cvl"][1] = "cvl";
  ajax_field_mult["ivl"][1] = "ivl";
  ajax_field_mult["uc"][1] = "uc";
  ajax_field_mult["sputum"][1] = "sputum";
  ajax_field_mult["darah"][1] = "darah";
  ajax_field_mult["urine"][1] = "urine";
  ajax_field_mult["antibiotik"][1] = "antibiotik";
  ajax_field_mult["vap"][1] = "vap";
  ajax_field_mult["iad"][1] = "iad";
  ajax_field_mult["pleb"][1] = "pleb";
  ajax_field_mult["isk"][1] = "isk";
  ...
  var ajax_field_id = {
    ...
    "deku": new Array("hidden_field_label_deku", "hidden_field_data_deku"),
    "ett": new Array("hidden_field_label_ett", "hidden_field_data_ett"),
    "cvl": new Array("hidden_field_label_cvl", "hidden_field_data_cvl"),
    "ivl": new Array("hidden_field_label_ivl", "hidden_field_data_ivl"),
    "uc": new Array("hidden_field_label_uc", "hidden_field_data_uc"),
    "sputum": new Array("hidden_field_label_sputum", "hidden_field_data_sputum"),
    "darah": new Array("hidden_field_label_darah", "hidden_field_data_darah"),
    "urine": new Array("hidden_field_label_urine", "hidden_field_data_urine"),
    "antibiotik": new Array("hidden_field_label_antibiotik", "hidden_field_data_antibiotik"),
    "vap": new Array("hidden_field_label_vap", "hidden_field_data_vap"),
    "iad": new Array("hidden_field_label_iad", "hidden_field_data_iad"),
    "pleb": new Array("hidden_field_label_pleb", "hidden_field_data_pleb"),
    "isk": new Array("hidden_field_label_isk", "hidden_field_data_isk")
  };
