...
class grid_jenisbahan_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jenisbahan']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_jenisbahan_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_jenisbahan_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_jenisbahan_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_jeniscode')
      {
          $jeniscode = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_jeniscode($jeniscode);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_namajenis')
      {
          $namajenis = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_namajenis($namajenis);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function lookup_ajax_jeniscode($jeniscode)
   {
      $jeniscode = substr($this->Db->qstr($jeniscode), 1, -1);
            $jeniscode_look = substr($this->Db->qstr($jeniscode), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct jeniscode from " . $this->Ini->nm_tabela . " where  jeniscode like '%" . $jeniscode . "%' order by jeniscode"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
   ...
   function lookup_ajax_namajenis($namajenis)
   {
      $namajenis = substr($this->Db->qstr($namajenis), 1, -1);
            $namajenis_look = substr($this->Db->qstr($namajenis), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct namajenis from " . $this->Ini->nm_tabela . " where  namajenis like '%" . $namajenis . "%' order by namajenis"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jenisbahan']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jenisbahan']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jenisbahan']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jenisbahan']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jenisbahan']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jenisbahan']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jenisbahan']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jenisbahan']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jenisbahan']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jenisbahan']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jenisbahan']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jenisbahan']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jenisbahan']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jenisbahan']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jenisbahan']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - jenisbahan</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_jenisbahan/grid_jenisbahan_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_jenisbahan_ajax_search.js"></script>
 <script type="text/javascript" src="grid_jenisbahan_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_jenisbahan_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_jenisbahan']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_jenisbahan']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_jeniscode_cond#NMF#' + search_get_sel_txt('SC_jeniscode_cond') + '@NMF@';
  str_out += 'SC_jeniscode#NMF#' + search_get_text('SC_jeniscode') + '@NMF@';
  str_out += 'id_ac_jeniscode#NMF#' + search_get_text('id_ac_jeniscode') + '@NMF@';
  str_out += 'SC_namajenis_cond#NMF#' + search_get_sel_txt('SC_namajenis_cond') + '@NMF@';
  str_out += 'SC_namajenis#NMF#' + search_get_text('SC_namajenis') + '@NMF@';
  str_out += 'id_ac_namajenis#NMF#' + search_get_text('id_ac_namajenis') + '@NMF@';
   ...
   $("#id_ac_jeniscode").autocomplete({
     ...
     $.ajax({
       ...
       data: {
          ...
          nmgp_parms: "NM_ajax_opcao?#?autocomp_jeniscode",
          max_itens: "10",
          cod_desc: "N",
     ...
     select: function (event, ui) {
       $("#SC_jeniscode").val(ui.item.value);
     ...
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_jeniscode").val( $(this).val() );
       }
     }
   });
   $("#id_ac_namajenis").autocomplete({
     minLength: 1,
     source: function (request, response) {
     $.ajax({
       url: "index.php",
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_namajenis",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_namajenis").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     focus: function (event, ui) {
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jenisbahan']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div class="scFilterHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFilterHeaderFont" style="float: left; text-transform: uppercase;"><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - jenisbahan</div>
...
<?php
   ...
   function monta_form()
   {
      global 
             ...
             $jeniscode_cond, $jeniscode, $jeniscode_autocomp,
             $namajenis_cond, $namajenis, $namajenis_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jenisbahan']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jenisbahan']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jenisbahan']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jenisbahan']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $keterangan = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jenisbahan']['campos_busca']['keterangan']; 
          $keterangan_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jenisbahan']['campos_busca']['keterangan_cond']; 
          $id = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jenisbahan']['campos_busca']['id']; 
          $id_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jenisbahan']['campos_busca']['id_cond']; 
          $jeniscode = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jenisbahan']['campos_busca']['jeniscode']; 
          $jeniscode_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jenisbahan']['campos_busca']['jeniscode_cond']; 
          $namajenis = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jenisbahan']['campos_busca']['namajenis']; 
          $namajenis_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jenisbahan']['campos_busca']['namajenis_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jenisbahan']['campos_busca']['NM_operador']; 
      } 
      ...
      if (!isset($jeniscode_cond) || empty($jeniscode_cond))
      {
         $jeniscode_cond = "qp";
      }
      if (!isset($namajenis_cond) || empty($namajenis_cond))
      {
         $namajenis_cond = "qp";
      }
      ...
      $str_hide_jeniscode = (in_array($jeniscode_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_namajenis = (in_array($namajenis_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      if (isset($jeniscode) && !empty($jeniscode))
      {
         $tmp_pos = strpos($jeniscode, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $jeniscode = substr($jeniscode, 0, $tmp_pos);
         }
      }
      if (!isset($namajenis) || $namajenis == "")
      {
          $namajenis = "";
      }
      if (isset($namajenis) && !empty($namajenis))
      {
         $tmp_pos = strpos($namajenis, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $namajenis = substr($namajenis, 0, $tmp_pos);
         }
      }
?>
 <TR align="center">
...
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_id" name="id_autocomp" size="5"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 5, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
      ...
      <TD id='SC_jeniscode_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['jeniscode'])) ? $this->New_label['jeniscode'] : "Jeniscode"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_jeniscode_cond" name="jeniscode_cond" onChange="nm_campos_between(document.getElementById('id_vis_jeniscode'), this, 'jeniscode')">
       <OPTION value="qp" <?php if ("qp" == $jeniscode_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $jeniscode_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $jeniscode_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $jeniscode_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_jeniscode" <?php echo $str_hide_jeniscode?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['jeniscode'])) ? $this->New_label['jeniscode'] : "Jeniscode";
 $nmgp_tab_label .= "jeniscode?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      $jeniscode_look = substr($this->Db->qstr($jeniscode), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct jeniscode from " . $this->Ini->nm_tabela . " where jeniscode = '$jeniscode_look' order by jeniscode"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      if (isset($nmgp_def_dados[0][$jeniscode]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$jeniscode];
      }
      else
      {
          $sAutocompValue = $jeniscode;
      }
?>
<INPUT  type="text" id="SC_jeniscode" name="jeniscode" value="<?php echo NM_encode_input($jeniscode) ?>"  size=15 alt="{datatype: 'text', maxLength: 15, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_jeniscode" name="jeniscode_autocomp" size="15"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 15, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_namajenis_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['namajenis'])) ? $this->New_label['namajenis'] : "Namajenis"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_namajenis_cond" name="namajenis_cond" onChange="nm_campos_between(document.getElementById('id_vis_namajenis'), this, 'namajenis')">
       <OPTION value="qp" <?php if ("qp" == $namajenis_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $namajenis_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $namajenis_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $namajenis_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_namajenis" <?php echo $str_hide_namajenis?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['namajenis'])) ? $this->New_label['namajenis'] : "Namajenis";
 $nmgp_tab_label .= "namajenis?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      $namajenis_look = substr($this->Db->qstr($namajenis), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct namajenis from " . $this->Ini->nm_tabela . " where namajenis = '$namajenis_look' order by namajenis"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      if (isset($nmgp_def_dados[0][$namajenis]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$namajenis];
      }
      else
      {
          $sAutocompValue = $namajenis;
      }
?>
<INPUT  type="text" id="SC_namajenis" name="namajenis" value="<?php echo NM_encode_input($namajenis) ?>"  size=50 alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_namajenis" name="namajenis_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
?>
<?php
   if (is_file("grid_jenisbahan_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_jenisbahan']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_jenisbahan']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jenisbahan']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.jeniscode_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_jeniscode'), document.F1.jeniscode_cond, 'jeniscode');
   document.F1.jeniscode.value = "";
   document.F1.jeniscode_autocomp.value = "";
   document.F1.namajenis_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_namajenis'), document.F1.namajenis_cond, 'namajenis');
   document.F1.namajenis.value = "";
   document.F1.namajenis_autocomp.value = "";
 }
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "simrskreatifmedia/grid_jenisbahan";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jenisbahan']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jenisbahan']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jenisbahan']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_jeniscode_cond'] = 'cond';
      $tp_fields['SC_jeniscode'] = 'text_aut';
      $tp_fields['id_ac_jeniscode'] = 'text_aut';
      $tp_fields['SC_namajenis_cond'] = 'cond';
      $tp_fields['SC_namajenis'] = 'text_aut';
      $tp_fields['id_ac_namajenis'] = 'text_aut';
   ...
   function trata_campos()
   {
      global $keterangan_cond, $keterangan, $keterangan_autocomp,
             $id_cond, $id, $id_autocomp,
             $jeniscode_cond, $jeniscode, $jeniscode_autocomp,
             $namajenis_cond, $namajenis, $namajenis_autocomp, $nmgp_tab_label;
      ...
      if (!empty($jeniscode_autocomp) && empty($jeniscode))
      {
          $jeniscode = $jeniscode_autocomp;
      }
      if (!empty($namajenis_autocomp) && empty($namajenis))
      {
          $namajenis = $namajenis_autocomp;
      }
      ...
      $jeniscode_cond_salva = $jeniscode_cond; 
      if (!isset($jeniscode_input_2) || $jeniscode_input_2 == "")
      {
          $jeniscode_input_2 = $jeniscode;
      }
      $namajenis_cond_salva = $namajenis_cond; 
      if (!isset($namajenis_input_2) || $namajenis_input_2 == "")
      {
          $namajenis_input_2 = $namajenis;
      }
      if ($id_cond != "in")
      {
          nm_limpa_numero($id, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jenisbahan']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jenisbahan']['campos_busca']['keterangan'] = $keterangan; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jenisbahan']['campos_busca']['keterangan_cond'] = $keterangan_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jenisbahan']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jenisbahan']['campos_busca']['id'] = $id; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jenisbahan']['campos_busca']['id_cond'] = $id_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jenisbahan']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jenisbahan']['campos_busca']['jeniscode'] = $jeniscode; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jenisbahan']['campos_busca']['jeniscode_cond'] = $jeniscode_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jenisbahan']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jenisbahan']['campos_busca']['namajenis'] = $namajenis; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jenisbahan']['campos_busca']['namajenis_cond'] = $namajenis_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jenisbahan']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jenisbahan']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jenisbahan']['campos_busca'] = $Temp_Busca;
      }
   ...
   { 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['jeniscode'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['jeniscode'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['jeniscode'] = $jeniscode;
      }
      $namajenis_look = substr($this->Db->qstr($namajenis), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct namajenis from " . $this->Ini->nm_tabela . " where namajenis = '$namajenis_look' order by namajenis"; 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['namajenis'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['namajenis'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['namajenis'] = $namajenis;
      }
      ...
      //----- $jeniscode
      $this->Date_part = false;
      if (isset($jeniscode) || $jeniscode_cond == "nu" || $jeniscode_cond == "nn" || $jeniscode_cond == "ep" || $jeniscode_cond == "ne")
      {
         $this->monta_condicao("jeniscode", $jeniscode_cond, $jeniscode, "", "jeniscode");
      }

      //----- $namajenis
      $this->Date_part = false;
      if (isset($namajenis) || $namajenis_cond == "nu" || $namajenis_cond == "nn" || $namajenis_cond == "ep" || $namajenis_cond == "ne")
      {
         $this->monta_condicao("namajenis", $namajenis_cond, $namajenis, "", "namajenis");
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jenisbahan']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jenisbahan']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jenisbahan']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jenisbahan']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jenisbahan']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jenisbahan']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jenisbahan']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jenisbahan']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jenisbahan']['cond_pesq'] .= $this->NM_operador;
