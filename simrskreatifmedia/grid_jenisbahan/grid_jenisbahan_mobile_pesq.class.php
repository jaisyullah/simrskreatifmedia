...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_jeniscode_cond" name="jeniscode_cond" onChange="nm_campos_between(document.getElementById('id_vis_jeniscode'), this, 'jeniscode')">
      ...
      <br><span id="id_hide_jeniscode"  <?php echo $str_hide_jeniscode?>><?php
      if ($jeniscode != "")
      {
      $jeniscode_look = substr($this->Db->qstr($jeniscode), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_namajenis_cond" name="namajenis_cond" onChange="nm_campos_between(document.getElementById('id_vis_namajenis'), this, 'namajenis')">
      ...
      <br><span id="id_hide_namajenis"  <?php echo $str_hide_namajenis?>><?php
      if ($namajenis != "")
      {
      $namajenis_look = substr($this->Db->qstr($namajenis), 1, -1); 
      $nmgp_def_dados = array(); 
