<?php
@session_start() ;
$_SESSION['scriptcase']['grid_jenisbahan']['sc_process_barr'] = true;
require_once('../grid_jenisbahan/index.php');
unset($_SESSION['scriptcase']['grid_jenisbahan']['sc_process_barr']);
$ExportCtrl = new grid_jenisbahan_export_control;
$ExportCtrl->Export_barr();

class grid_jenisbahan_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - jenisbahan :: Excel</TITLE>
