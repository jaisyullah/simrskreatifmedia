...
<HEAD>
 <TITLE><?php if ('novo' == $this->nmgp_opcao) { echo strip_tags("" . $this->Ini->Nm_lang['lang_othr_frmi_titl'] . ""); } else { echo strip_tags("Update Rujukan"); } ?></TITLE>
...
.sc-button-image.disabled img {
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_rujukan_update']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_vclaim_rujukan_update/form_vclaim_rujukan_update_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_vclaim_rujukan_update_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_vclaim_rujukan_update_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_rujukan_update']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_rujukan_update']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_rujukan_update']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_rujukan_update']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_rujukan_update']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_rujukan_update']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_rujukan_update']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_rujukan_update']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
?>
...
<?php
 include_once("form_vclaim_rujukan_update_js0.php");
?>
<script type="text/javascript"> 
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_vclaim_rujukan_update'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_vclaim_rujukan_update'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_rujukan_update']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_rujukan_update']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_rujukan_update']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_rujukan_update']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_rujukan_update']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<div class="scFormHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFormHeaderFont" style="float: left; text-transform: uppercase;"><?php if ($this->nmgp_opcao == "novo") { echo "" . $this->Ini->Nm_lang['lang_othr_frmi_titl'] . ""; } else { echo "Update Rujukan"; } ?></div>
...
<?php
  ...
  {
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_rujukan_update']['where_filter']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_rujukan_update']['empty_filter'] = true;
       }
  }
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_ppkdirujuk_label" id="hidden_field_label_ppkdirujuk" style="<?php echo $sStyleHidden_ppkdirujuk; ?>"><span id="id_label_ppkdirujuk"><?php echo $this->nm_new_label['ppkdirujuk']; ?></span></TD>
    <TD class="scFormDataOdd css_ppkdirujuk_line" id="hidden_field_data_ppkdirujuk" style="<?php echo $sStyleHidden_ppkdirujuk; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_nmppkdirujuk_label" id="hidden_field_label_nmppkdirujuk" style="<?php echo $sStyleHidden_nmppkdirujuk; ?>"><span id="id_label_nmppkdirujuk"><?php echo $this->nm_new_label['nmppkdirujuk']; ?></span></TD>
    <TD class="scFormDataOdd css_nmppkdirujuk_line" id="hidden_field_data_nmppkdirujuk" style="<?php echo $sStyleHidden_nmppkdirujuk; ?>">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_rujukan_update']['Lookup_jnspelayanan'][] = '1'; ?>
 <option  value="2" <?php  if ($this->jnspelayanan == "2") { echo " selected" ;} ?>>Rawat Jalan</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_rujukan_update']['Lookup_jnspelayanan'][] = '2'; ?>
 </select></span>
</span><?php  }?>
</TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_diagrujukan_label" id="hidden_field_label_diagrujukan" style="<?php echo $sStyleHidden_diagrujukan; ?>"><span id="id_label_diagrujukan"><?php echo $this->nm_new_label['diagrujukan']; ?></span></TD>
    <TD class="scFormDataOdd css_diagrujukan_line" id="hidden_field_data_diagrujukan" style="<?php echo $sStyleHidden_diagrujukan; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_nmdiagrujukan_label" id="hidden_field_label_nmdiagrujukan" style="<?php echo $sStyleHidden_nmdiagrujukan; ?>"><span id="id_label_nmdiagrujukan"><?php echo $this->nm_new_label['nmdiagrujukan']; ?></span></TD>
    <TD class="scFormDataOdd css_nmdiagrujukan_line" id="hidden_field_data_nmdiagrujukan" style="<?php echo $sStyleHidden_nmdiagrujukan; ?>">
...
<?php } else { ?>
<span id="id_read_on_nmdiagrujukan" class="sc-ui-readonly-nmdiagrujukan css_nmdiagrujukan_line" style="<?php echo $sStyleReadLab_nmdiagrujukan; ?>"><?php echo $this->nmdiagrujukan; ?></span><span id="id_read_off_nmdiagrujukan" class="css_read_off_nmdiagrujukan" style="white-space: nowrap;<?php echo $sStyleReadInp_nmdiagrujukan; ?>">
 <input class="sc-js-input scFormObjectOdd css_nmdiagrujukan_obj" style="" id="id_sc_field_nmdiagrujukan" type=text name="nmdiagrujukan" value="<?php echo $this->form_encode_input($nmdiagrujukan) ?>"
 size=40 maxlength=100 alt="{datatype: 'text', maxLength: 100, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
</TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tiperujukan_label" id="hidden_field_label_tiperujukan" style="<?php echo $sStyleHidden_tiperujukan; ?>"><span id="id_label_tiperujukan"><?php echo $this->nm_new_label['tiperujukan']; ?></span></TD>
    <TD class="scFormDataOdd css_tiperujukan_line" id="hidden_field_data_tiperujukan" style="<?php echo $sStyleHidden_tiperujukan; ?>">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_rujukan_update']['Lookup_tiperujukan'][] = '0'; ?>
 <option  value="1" <?php  if ($this->tiperujukan == "1") { echo " selected" ;} ?>>Partial</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_rujukan_update']['Lookup_tiperujukan'][] = '1'; ?>
 <option  value="2" <?php  if ($this->tiperujukan == "2") { echo " selected" ;} ?>>Rujuk Balik</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_rujukan_update']['Lookup_tiperujukan'][] = '2'; ?>
 </select></span>
</span><?php  }?>
</TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_polirujukan_label" id="hidden_field_label_polirujukan" style="<?php echo $sStyleHidden_polirujukan; ?>"><span id="id_label_polirujukan"><?php echo $this->nm_new_label['polirujukan']; ?></span></TD>
    <TD class="scFormDataOdd css_polirujukan_line" id="hidden_field_data_polirujukan" style="<?php echo $sStyleHidden_polirujukan; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_nmpolirujukan_label" id="hidden_field_label_nmpolirujukan" style="<?php echo $sStyleHidden_nmpolirujukan; ?>"><span id="id_label_nmpolirujukan"><?php echo $this->nm_new_label['nmpolirujukan']; ?></span></TD>
    <TD class="scFormDataOdd css_nmpolirujukan_line" id="hidden_field_data_nmpolirujukan" style="<?php echo $sStyleHidden_nmpolirujukan; ?>">
...
<?php
           if (($nm_apl_dependente != 1) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_rujukan_update']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_rujukan_update']['dashboard_info']['under_dashboard'])) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_rujukan_update']['nm_run_menu']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_rujukan_update']['nm_run_menu'] != 1))) {
...
<?php
           if (($nm_apl_dependente == 1) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_rujukan_update']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_rujukan_update']['dashboard_info']['under_dashboard']))) {
        $sCondStyle = ($this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_rujukan_update']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_rujukan_update']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_vclaim_rujukan_update");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_vclaim_rujukan_update");
 parent.scAjaxDetailHeight("form_vclaim_rujukan_update", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_rujukan_update']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
