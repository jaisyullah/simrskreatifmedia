  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_vclaim_rujukan_update_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_vclaim_rujukan_update_mob_form();
	}

  // ---------- Validate norujukan
  function do_ajax_form_vclaim_rujukan_update_mob_validate_norujukan()
  {
    var nomeCampo_norujukan = "norujukan";
    var var_norujukan = scAjaxGetFieldText(nomeCampo_norujukan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_rujukan_update_mob_validate_norujukan(var_norujukan, var_script_case_init, do_ajax_form_vclaim_rujukan_update_mob_validate_norujukan_cb);
  } // do_ajax_form_vclaim_rujukan_update_mob_validate_norujukan

  function do_ajax_form_vclaim_rujukan_update_mob_validate_norujukan_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_rujukan_update_mob_validate_norujukan_cb

  // ---------- Validate ppkdirujuk
  function do_ajax_form_vclaim_rujukan_update_mob_validate_ppkdirujuk()
  {
    var nomeCampo_ppkdirujuk = "ppkdirujuk";
    var var_ppkdirujuk = scAjaxGetFieldText(nomeCampo_ppkdirujuk);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_rujukan_update_mob_validate_ppkdirujuk(var_ppkdirujuk, var_script_case_init, do_ajax_form_vclaim_rujukan_update_mob_validate_ppkdirujuk_cb);
  } // do_ajax_form_vclaim_rujukan_update_mob_validate_ppkdirujuk

  function do_ajax_form_vclaim_rujukan_update_mob_validate_ppkdirujuk_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_rujukan_update_mob_validate_ppkdirujuk_cb

  // ---------- Validate nmppkdirujuk
  function do_ajax_form_vclaim_rujukan_update_mob_validate_nmppkdirujuk()
  {
    var nomeCampo_nmppkdirujuk = "nmppkdirujuk";
    var var_nmppkdirujuk = scAjaxGetFieldText(nomeCampo_nmppkdirujuk);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_rujukan_update_mob_validate_nmppkdirujuk(var_nmppkdirujuk, var_script_case_init, do_ajax_form_vclaim_rujukan_update_mob_validate_nmppkdirujuk_cb);
  } // do_ajax_form_vclaim_rujukan_update_mob_validate_nmppkdirujuk

  function do_ajax_form_vclaim_rujukan_update_mob_validate_nmppkdirujuk_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_rujukan_update_mob_validate_nmppkdirujuk_cb

  // ---------- Validate jnspelayanan
  function do_ajax_form_vclaim_rujukan_update_mob_validate_jnspelayanan()
  {
    var nomeCampo_jnspelayanan = "jnspelayanan";
    var var_jnspelayanan = scAjaxGetFieldSelect(nomeCampo_jnspelayanan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_rujukan_update_mob_validate_jnspelayanan(var_jnspelayanan, var_script_case_init, do_ajax_form_vclaim_rujukan_update_mob_validate_jnspelayanan_cb);
  } // do_ajax_form_vclaim_rujukan_update_mob_validate_jnspelayanan

  function do_ajax_form_vclaim_rujukan_update_mob_validate_jnspelayanan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_rujukan_update_mob_validate_jnspelayanan_cb

  // ---------- Validate catatan
  function do_ajax_form_vclaim_rujukan_update_mob_validate_catatan()
  {
    var nomeCampo_catatan = "catatan";
    var var_catatan = scAjaxGetFieldText(nomeCampo_catatan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_rujukan_update_mob_validate_catatan(var_catatan, var_script_case_init, do_ajax_form_vclaim_rujukan_update_mob_validate_catatan_cb);
  } // do_ajax_form_vclaim_rujukan_update_mob_validate_catatan

  function do_ajax_form_vclaim_rujukan_update_mob_validate_catatan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "catatan";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_rujukan_update_mob_validate_catatan_cb

  // ---------- Validate diagrujukan
  function do_ajax_form_vclaim_rujukan_update_mob_validate_diagrujukan()
  {
    var nomeCampo_diagrujukan = "diagrujukan";
    var var_diagrujukan = scAjaxGetFieldText(nomeCampo_diagrujukan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_rujukan_update_mob_validate_diagrujukan(var_diagrujukan, var_script_case_init, do_ajax_form_vclaim_rujukan_update_mob_validate_diagrujukan_cb);
  } // do_ajax_form_vclaim_rujukan_update_mob_validate_diagrujukan

  function do_ajax_form_vclaim_rujukan_update_mob_validate_diagrujukan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_rujukan_update_mob_validate_diagrujukan_cb

  // ---------- Validate nmdiagrujukan
  function do_ajax_form_vclaim_rujukan_update_mob_validate_nmdiagrujukan()
  {
    var nomeCampo_nmdiagrujukan = "nmdiagrujukan";
    var var_nmdiagrujukan = scAjaxGetFieldText(nomeCampo_nmdiagrujukan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_rujukan_update_mob_validate_nmdiagrujukan(var_nmdiagrujukan, var_script_case_init, do_ajax_form_vclaim_rujukan_update_mob_validate_nmdiagrujukan_cb);
  } // do_ajax_form_vclaim_rujukan_update_mob_validate_nmdiagrujukan

  function do_ajax_form_vclaim_rujukan_update_mob_validate_nmdiagrujukan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_rujukan_update_mob_validate_nmdiagrujukan_cb

  // ---------- Validate tiperujukan
  function do_ajax_form_vclaim_rujukan_update_mob_validate_tiperujukan()
  {
    var nomeCampo_tiperujukan = "tiperujukan";
    var var_tiperujukan = scAjaxGetFieldSelect(nomeCampo_tiperujukan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_rujukan_update_mob_validate_tiperujukan(var_tiperujukan, var_script_case_init, do_ajax_form_vclaim_rujukan_update_mob_validate_tiperujukan_cb);
  } // do_ajax_form_vclaim_rujukan_update_mob_validate_tiperujukan

  function do_ajax_form_vclaim_rujukan_update_mob_validate_tiperujukan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_rujukan_update_mob_validate_tiperujukan_cb

  // ---------- Validate polirujukan
  function do_ajax_form_vclaim_rujukan_update_mob_validate_polirujukan()
  {
    var nomeCampo_polirujukan = "polirujukan";
    var var_polirujukan = scAjaxGetFieldText(nomeCampo_polirujukan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_rujukan_update_mob_validate_polirujukan(var_polirujukan, var_script_case_init, do_ajax_form_vclaim_rujukan_update_mob_validate_polirujukan_cb);
  } // do_ajax_form_vclaim_rujukan_update_mob_validate_polirujukan

  function do_ajax_form_vclaim_rujukan_update_mob_validate_polirujukan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_rujukan_update_mob_validate_polirujukan_cb

  // ---------- Validate nmpolirujukan
  function do_ajax_form_vclaim_rujukan_update_mob_validate_nmpolirujukan()
  {
    var nomeCampo_nmpolirujukan = "nmpolirujukan";
    var var_nmpolirujukan = scAjaxGetFieldText(nomeCampo_nmpolirujukan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_rujukan_update_mob_validate_nmpolirujukan(var_nmpolirujukan, var_script_case_init, do_ajax_form_vclaim_rujukan_update_mob_validate_nmpolirujukan_cb);
  } // do_ajax_form_vclaim_rujukan_update_mob_validate_nmpolirujukan

  function do_ajax_form_vclaim_rujukan_update_mob_validate_nmpolirujukan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_rujukan_update_mob_validate_nmpolirujukan_cb

  // ---------- Validate user
  function do_ajax_form_vclaim_rujukan_update_mob_validate_user()
  {
    var nomeCampo_user = "user";
    var var_user = scAjaxGetFieldText(nomeCampo_user);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_rujukan_update_mob_validate_user(var_user, var_script_case_init, do_ajax_form_vclaim_rujukan_update_mob_validate_user_cb);
  } // do_ajax_form_vclaim_rujukan_update_mob_validate_user

  function do_ajax_form_vclaim_rujukan_update_mob_validate_user_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "user";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_rujukan_update_mob_validate_user_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_vclaim_rujukan_update_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_vclaim_rujukan_update_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_vclaim_rujukan_update_mob_submit_form(var_norujukan, var_ppkdirujuk, var_nmppkdirujuk, var_jnspelayanan, var_catatan, var_diagrujukan, var_nmdiagrujukan, var_tiperujukan, var_polirujukan, var_nmpolirujukan, var_user, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_vclaim_rujukan_update_mob_submit_form_cb);
  } // do_ajax_form_vclaim_rujukan_update_mob_submit_form

  function do_ajax_form_vclaim_rujukan_update_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_vclaim_rujukan_update_mob_submit_form_cb_after_alert);
  } // do_ajax_form_vclaim_rujukan_update_mob_submit_form_cb
  function do_ajax_form_vclaim_rujukan_update_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_vclaim_rujukan_update_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_vclaim_rujukan_update_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_form_vclaim_rujukan_update_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_rujukan_update_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_vclaim_rujukan_update_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_vclaim_rujukan_update_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_vclaim_rujukan_update_mob_navigate_form_cb
  function do_ajax_form_vclaim_rujukan_update_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_vclaim_rujukan_update_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_vclaim_rujukan_update_mob_navigate_form_cb_after_alert
  function sc_hide_form_vclaim_rujukan_update_mob_form()
  {
