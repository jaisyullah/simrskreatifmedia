...
.sc-button-image.disabled img {
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_rujukan_update_mob']['embutida_pdf']))
 {
 ?>
...
<?php
include_once("form_vclaim_rujukan_update_mob_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_vclaim_rujukan_update_mob_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_rujukan_update_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_rujukan_update_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_rujukan_update_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_rujukan_update_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_rujukan_update_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_rujukan_update_mob']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_rujukan_update_mob']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_rujukan_update_mob']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
?>
<body class="scFormPage" style="<?php echo $remove_margin . $str_iframe_body; ?>">
<?php

if (isset($_SESSION['scriptcase']['form_vclaim_rujukan_update']['error_buffer']) && '' != $_SESSION['scriptcase']['form_vclaim_rujukan_update']['error_buffer'])
{
    echo $_SESSION['scriptcase']['form_vclaim_rujukan_update']['error_buffer'];
}
...
<?php
 include_once("form_vclaim_rujukan_update_mob_js0.php");
?>
<script type="text/javascript"> 
...
<form  name="F1" method="post" 
               action="form_vclaim_rujukan_update_mob.php" 
               target="_self">
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_vclaim_rujukan_update_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_vclaim_rujukan_update_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_rujukan_update_mob']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_rujukan_update_mob']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_rujukan_update_mob']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_rujukan_update_mob']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_rujukan_update_mob']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<?php
  ...
  {
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_rujukan_update_mob']['where_filter']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_rujukan_update_mob']['empty_filter'] = true;
       }
  }
?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_rujukan_update_mob']['Lookup_jnspelayanan'][] = '1'; ?>
 <option  value="2" <?php  if ($this->jnspelayanan == "2") { echo " selected" ;} ?>>Rawat Jalan</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_rujukan_update_mob']['Lookup_jnspelayanan'][] = '2'; ?>
 </select></span>
</span><?php  }?>
 </TD>
   <?php }?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_rujukan_update_mob']['Lookup_tiperujukan'][] = '0'; ?>
 <option  value="1" <?php  if ($this->tiperujukan == "1") { echo " selected" ;} ?>>Partial</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_rujukan_update_mob']['Lookup_tiperujukan'][] = '1'; ?>
 <option  value="2" <?php  if ($this->tiperujukan == "2") { echo " selected" ;} ?>>Rujuk Balik</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_rujukan_update_mob']['Lookup_tiperujukan'][] = '2'; ?>
 </select></span>
</span><?php  }?>
 </TD>
   <?php }?>
...
<?php
           if (($nm_apl_dependente != 1) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_rujukan_update_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_rujukan_update_mob']['dashboard_info']['under_dashboard'])) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_rujukan_update_mob']['nm_run_menu']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_rujukan_update_mob']['nm_run_menu'] != 1))) {
...
<?php
           if (($nm_apl_dependente == 1) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_rujukan_update_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_rujukan_update_mob']['dashboard_info']['under_dashboard']))) {
        $sCondStyle = ($this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_rujukan_update_mob']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_rujukan_update_mob']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_vclaim_rujukan_update_mob");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_vclaim_rujukan_update_mob");
 parent.scAjaxDetailHeight("form_vclaim_rujukan_update_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_rujukan_update_mob']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
