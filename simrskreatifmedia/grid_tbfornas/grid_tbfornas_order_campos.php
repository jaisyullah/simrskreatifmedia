...
<?php
   ...
   $Ord_Cmp = new grid_tbfornas_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_tbfornas_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbfornas']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tbfornas']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbfornas']['labels']["id"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbfornas']['labels']["id"] : "ID";
   $tab_ger_campos['nama_obat'] = "on";
   $tab_def_campos['nama_obat'] = "nama_obat";
   $tab_labels["nama_obat"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbfornas']['labels']["nama_obat"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbfornas']['labels']["nama_obat"] : "Nama Obat";
   $tab_ger_campos['satuan'] = "on";
   $tab_def_campos['satuan'] = "satuan";
   $tab_labels["satuan"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbfornas']['labels']["satuan"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbfornas']['labels']["satuan"] : "Satuan";
   $tab_ger_campos['keterangan'] = "on";
   $tab_def_campos['keterangan'] = "keterangan";
   $tab_labels["keterangan"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbfornas']['labels']["keterangan"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbfornas']['labels']["keterangan"] : "Keterangan";
   $tab_ger_campos['maks_usage'] = "on";
   $tab_def_campos['maks_usage'] = "maks_usage";
   $tab_labels["maks_usage"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbfornas']['labels']["maks_usage"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbfornas']['labels']["maks_usage"] : "Maks Usage";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_tbfornas']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_tbfornas']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_tbfornas']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbfornas']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tbfornas']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_tbfornas']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_tbfornas']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_tbfornas']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_tbfornas']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_tbfornas_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_tbfornas']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_tbfornas']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_tbfornas']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_tbfornas']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_tbfornas']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
