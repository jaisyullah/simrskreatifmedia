...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_nama_obat_cond" name="nama_obat_cond" onChange="nm_campos_between(document.getElementById('id_vis_nama_obat'), this, 'nama_obat')">
      ...
      <br><span id="id_hide_nama_obat"  <?php echo $str_hide_nama_obat?>><?php
      if ($nama_obat != "")
      {
      $nama_obat_look = substr($this->Db->qstr($nama_obat), 1, -1); 
      $nmgp_def_dados = array(); 
