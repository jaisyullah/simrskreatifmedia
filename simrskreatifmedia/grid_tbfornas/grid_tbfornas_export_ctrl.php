<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tbfornas']['sc_process_barr'] = true;
require_once('../grid_tbfornas/index.php');
unset($_SESSION['scriptcase']['grid_tbfornas']['sc_process_barr']);
$ExportCtrl = new grid_tbfornas_export_control;
$ExportCtrl->Export_barr();

class grid_tbfornas_export_control
{
