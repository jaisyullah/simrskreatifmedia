   ...
   function grava_arquivo()
   {
     global $nm_lang;
      ...
      { 
          ...
          $this->Res = new berkas_klaim_elek_res_csv();
          $this->prep_modulos("Res");
          $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['csv_res_grid'] = true;
          $this->Res->monta_csv();
      } 
      if (!$this->Ini->sc_export_ajax) {
      ...
      { 
          ...
          { 
              $str_zip    = "";
              $Arq_res    = $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['csv_res_file'];
              ...
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['csv_res_grid']);
              unlink($_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['csv_res_file']);
          }
          unlink($Arq_input);
