...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____berkas_klaim_elek"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____berkas_klaim_elek"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['berkas_klaim_elek']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['berkas_klaim_elek']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['berkas_klaim_elek']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['berkas_klaim_elek']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['berkas_klaim_elek']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['berkas_klaim_elek']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['berkas_klaim_elek']['embutida_filho'] as $ind => $sc_init)
          {
