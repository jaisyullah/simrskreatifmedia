<?php
@session_start() ;
$_SESSION['scriptcase']['berkas_klaim_elek']['sc_process_barr'] = true;
require_once('../berkas_klaim_elek/index.php');
unset($_SESSION['scriptcase']['berkas_klaim_elek']['sc_process_barr']);
$ExportCtrl = new berkas_klaim_elek_export_control;
$ExportCtrl->Export_barr();

class berkas_klaim_elek_export_control
{
