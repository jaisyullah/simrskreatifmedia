<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['berkas_klaim_elek']['glo_nm_path_imag_temp'] . "/sc_apl_default_simrskreatifmedia.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new berkas_klaim_elek_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class berkas_klaim_elek_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['berkas_klaim_elek']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['berkas_klaim_elek']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["sc_field_0"]   = (isset($_SESSION['sc_session'][$sc_init]['berkas_klaim_elek']['labels']["sc_field_0"])) ? $_SESSION['sc_session'][$sc_init]['berkas_klaim_elek']['labels']["sc_field_0"] : "No RM";
   ...
   {
       $tab_def_campos['sc_field_1'] = "concat( f.NAME,', ',f.salut )";
   }
   $tab_labels["sc_field_1"]   = (isset($_SESSION['sc_session'][$sc_init]['berkas_klaim_elek']['labels']["sc_field_1"])) ? $_SESSION['sc_session'][$sc_init]['berkas_klaim_elek']['labels']["sc_field_1"] : "Nama Pasien";
   ...
   {
       $tab_def_campos['sc_field_2'] = "a.idProvider";
   }
   $tab_labels["sc_field_2"]   = (isset($_SESSION['sc_session'][$sc_init]['berkas_klaim_elek']['labels']["sc_field_2"])) ? $_SESSION['sc_session'][$sc_init]['berkas_klaim_elek']['labels']["sc_field_2"] : "No BPJS";
   ...
   {
       $tab_def_campos['dpjp'] = "concat( g.gelar,' ',g.NAME,', ',g.spec )";
   }
   $tab_labels["dpjp"]   = (isset($_SESSION['sc_session'][$sc_init]['berkas_klaim_elek']['labels']["dpjp"])) ? $_SESSION['sc_session'][$sc_init]['berkas_klaim_elek']['labels']["dpjp"] : "DPJP";
   ...
   {
       $tab_def_campos['sc_field_3'] = "a.tglMasuk";
   }
   $tab_labels["sc_field_3"]   = (isset($_SESSION['sc_session'][$sc_init]['berkas_klaim_elek']['labels']["sc_field_3"])) ? $_SESSION['sc_session'][$sc_init]['berkas_klaim_elek']['labels']["sc_field_3"] : "Tgl Masuk";
   ...
   {
       $tab_def_campos['sc_field_4'] = "b.tglKeluar";
   }
   $tab_labels["sc_field_4"]   = (isset($_SESSION['sc_session'][$sc_init]['berkas_klaim_elek']['labels']["sc_field_4"])) ? $_SESSION['sc_session'][$sc_init]['berkas_klaim_elek']['labels']["sc_field_4"] : "Tgl Keluar";
   ...
   {
       $tab_def_campos['sc_field_5'] = "a.kelas";
   }
   $tab_labels["sc_field_5"]   = (isset($_SESSION['sc_session'][$sc_init]['berkas_klaim_elek']['labels']["sc_field_5"])) ? $_SESSION['sc_session'][$sc_init]['berkas_klaim_elek']['labels']["sc_field_5"] : "Kelas Rawat";
   ...
   {
       $tab_def_campos['diagnosa'] = "a.icd1";
   }
   $tab_labels["diagnosa"]   = (isset($_SESSION['sc_session'][$sc_init]['berkas_klaim_elek']['labels']["diagnosa"])) ? $_SESSION['sc_session'][$sc_init]['berkas_klaim_elek']['labels']["diagnosa"] : "Diagnosa";
   ...
   {
       $tab_def_campos['sc_field_6'] = "c.trancode";
   }
   $tab_labels["sc_field_6"]   = (isset($_SESSION['sc_session'][$sc_init]['berkas_klaim_elek']['labels']["sc_field_6"])) ? $_SESSION['sc_session'][$sc_init]['berkas_klaim_elek']['labels']["sc_field_6"] : "Hasil Lab";
   ...
   {
       $tab_def_campos['sc_field_7'] = "d.trancode";
   }
   $tab_labels["sc_field_7"]   = (isset($_SESSION['sc_session'][$sc_init]['berkas_klaim_elek']['labels']["sc_field_7"])) ? $_SESSION['sc_session'][$sc_init]['berkas_klaim_elek']['labels']["sc_field_7"] : "Hasil Rad";
   ...
   {
       $tab_def_campos['sc_field_8'] = "e.tranCode";
   }
   $tab_labels["sc_field_8"]   = (isset($_SESSION['sc_session'][$sc_init]['berkas_klaim_elek']['labels']["sc_field_8"])) ? $_SESSION['sc_session'][$sc_init]['berkas_klaim_elek']['labels']["sc_field_8"] : "Billing Inap";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['berkas_klaim_elek']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['berkas_klaim_elek']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['berkas_klaim_elek']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['berkas_klaim_elek']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['berkas_klaim_elek']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['berkas_klaim_elek']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['berkas_klaim_elek']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['berkas_klaim_elek']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['berkas_klaim_elek']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "berkas_klaim_elek_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['berkas_klaim_elek']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['berkas_klaim_elek']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['berkas_klaim_elek']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['berkas_klaim_elek']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['berkas_klaim_elek']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
