...
class berkas_klaim_elek_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['path_libs_php'] = $this->Ini->path_lib_php;
      ...
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search_change_fil")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['campos_busca'] = array(); 
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . berkas_klaim_elek_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . berkas_klaim_elek_pack_protect_string($Tipo_filter[0]) . "\">.." . berkas_klaim_elek_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_sc_field_2')
      {
          $sc_field_2 = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_sc_field_2($sc_field_2);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "a.tglMasuk";$Nm_datas[] = "a_tglMasuk";$Nm_datas[] = "b.tglKeluar";$Nm_datas[] = "b_tglKeluar";
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE>Elektronik Berkas BPJS</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>berkas_klaim_elek/berkas_klaim_elek_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="berkas_klaim_elek_ajax_search.js"></script>
 <script type="text/javascript" src="berkas_klaim_elek_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="berkas_klaim_elek_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['berkas_klaim_elek']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['berkas_klaim_elek']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_nama pasien_cond#NMF#' + search_get_sel_txt('SC_sc_field_1_cond') + '@NMF@';
  str_out += 'SC_nama pasien#NMF#' + search_get_text('SC_sc_field_1') + '@NMF@';
  str_out += 'SC_no bpjs_cond#NMF#' + search_get_sel_txt('SC_sc_field_2_cond') + '@NMF@';
  str_out += 'SC_no bpjs#NMF#' + search_get_text('SC_sc_field_2') + '@NMF@';
  str_out += 'id_ac_no bpjs#NMF#' + search_get_text('id_ac_sc_field_2') + '@NMF@';
   ...
   $("#id_ac_sc_field_2").autocomplete({
     ...
     $.ajax({
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_sc_field_2",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_sc_field_2").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     focus: function (event, ui) {
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div class="scFilterHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFilterHeaderFont" style="float: left; text-transform: uppercase;">Elektronik Berkas BPJS</div>
...
<?php
   ...
   function monta_form()
   {
      global 
             ...
             $sc_field_2_cond, $sc_field_2, $sc_field_2_autocomp,
             $dpjp_cond, $dpjp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          $sc_field_0 = $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['campos_busca']['sc_field_0']; 
          $sc_field_0_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['campos_busca']['sc_field_0_cond']; 
          $sc_field_1 = $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['campos_busca']['sc_field_1']; 
          $sc_field_1_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['campos_busca']['sc_field_1_cond']; 
          $sc_field_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['campos_busca']['sc_field_2']; 
          $sc_field_2_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['campos_busca']['sc_field_2_cond']; 
          $dpjp = $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['campos_busca']['dpjp']; 
          $dpjp_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['campos_busca']['dpjp_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['campos_busca']['NM_operador']; 
      } 
...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_sc_field_0" name="sc_field_0_autocomp" size="6"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 6, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_sc_field_1_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['sc_field_1'])) ? $this->New_label['sc_field_1'] : "Nama Pasien"; ?></TD>
...
?>
<INPUT  type="text" id="SC_sc_field_1" name="sc_field_1" value="<?php echo NM_encode_input($sc_field_1) ?>"  size=50 alt="{datatype: 'text', maxLength: 52, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
      ...
      <TD id='SC_sc_field_2_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['sc_field_2'])) ? $this->New_label['sc_field_2'] : "No BPJS"; ?></TD>
     <TD class="scFilterFieldOdd"> 
...
<?php
      ...
      {
          $sAutocompValue = $sc_field_2;
      }
?>
<INPUT  type="text" id="SC_sc_field_2" name="sc_field_2" value="<?php echo NM_encode_input($sc_field_2) ?>"  size=30 alt="{datatype: 'text', maxLength: 30, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_sc_field_2" name="sc_field_2_autocomp" size="30"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 30, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
?>
<INPUT  type="text" id="SC_dpjp" name="dpjp" value="<?php echo NM_encode_input($dpjp) ?>"  size=50 alt="{datatype: 'text', maxLength: 73, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if ($_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
<?php
   if (is_file("berkas_klaim_elek_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['berkas_klaim_elek']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['berkas_klaim_elek']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.sc_field_2_autocomp.value = "";
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['where_orig'] = "";
      }
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          $this->comando = "";
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['where_orig'];
      }
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_sc_field_2'] = 'text_aut';
      $tp_fields['id_ac_sc_field_2'] = 'text_aut';
      ...
      $tb_fields_esp['SC_nama pasien_cond'] = 'SC_sc_field_1_cond';
      $tb_fields_esp['SC_nama pasien'] = 'SC_sc_field_1';
      $tb_fields_esp['SC_no bpjs_cond'] = 'SC_sc_field_2_cond';
      $tb_fields_esp['SC_no bpjs'] = 'SC_sc_field_2';
      $tb_fields_esp['text_aut'] = 'id_ac_no bpjs';
      $tb_fields_esp['id_ac_no bpjs'] = 'id_ac_sc_field_2';
      if (is_file($NM_patch))
      {
          $SC_V8    = false;
   ...
   function trata_campos()
   {
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['campos_busca'] as $Cmps => $Vals)
          {
              $$Cmps = $Vals;
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['grid_pesq'] = array();
      if (!empty($sc_field_0_autocomp) && empty($sc_field_0))
      {
          $sc_field_0 = $sc_field_0_autocomp;
      }
      if (!empty($sc_field_2_autocomp) && empty($sc_field_2))
      {
          $sc_field_2 = $sc_field_2_autocomp;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['Grid_search']  = array(); 
      $I_Grid = 0;
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['campos_busca']['sc_field_0'] = $sc_field_0; 
      if (is_array($sc_field_0) && !empty($sc_field_0))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['Grid_search'][$I_Grid]['val'][0] = $sc_field_0;
      }
      ...
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['Grid_search'][$I_Grid]['val'][0][0] = $sc_field_0;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['campos_busca']['sc_field_0_cond'] = $sc_field_0_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['Grid_search'][$I_Grid]['cmp'] = "sc_field_0"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['Grid_search'][$I_Grid]['opc'] = $sc_field_0_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['grid_pesq']['sc_field_0'] = $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['campos_busca']['sc_field_1'] = $sc_field_1; 
      if (is_array($sc_field_1) && !empty($sc_field_1))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['Grid_search'][$I_Grid]['val'][0] = $sc_field_1;
      }
      ...
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['Grid_search'][$I_Grid]['val'][0][0] = $sc_field_1;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['campos_busca']['sc_field_1_cond'] = $sc_field_1_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['Grid_search'][$I_Grid]['cmp'] = "sc_field_1"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['Grid_search'][$I_Grid]['opc'] = $sc_field_1_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['grid_pesq']['sc_field_1'] = $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['campos_busca']['sc_field_2'] = $sc_field_2; 
      if (is_array($sc_field_2) && !empty($sc_field_2))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['Grid_search'][$I_Grid]['val'][0] = $sc_field_2;
      }
      ...
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['Grid_search'][$I_Grid]['val'][0][0] = $sc_field_2;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['campos_busca']['sc_field_2_cond'] = $sc_field_2_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['Grid_search'][$I_Grid]['cmp'] = "sc_field_2"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['Grid_search'][$I_Grid]['opc'] = $sc_field_2_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['grid_pesq']['sc_field_2'] = $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['campos_busca']['dpjp'] = $dpjp; 
      if (is_array($dpjp) && !empty($dpjp))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['Grid_search'][$I_Grid]['val'][0] = $dpjp;
      }
      elseif ($dpjp_cond_salva == "nu" || $dpjp_cond_salva == "nn" || $dpjp_cond_salva == "ep" || $dpjp_cond_salva == "ne" || !empty($dpjp))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['Grid_search'][$I_Grid]['val'][0][0] = $dpjp;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['campos_busca']['dpjp_cond'] = $dpjp_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['Grid_search'][$I_Grid]['cmp'] = "dpjp"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['Grid_search'][$I_Grid]['opc'] = $dpjp_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['grid_pesq']['dpjp'] = $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['sc_field_2'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['sc_field_2'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['sc_field_2'] = $sc_field_2;
      }
      $Conteudo = $dpjp;
      ...
      {
         $this->monta_condicao("concat( f.NAME,', ',f.salut )", $sc_field_1_cond, $sc_field_1, "", "sc_field_1");
      }
      ...
      {
         $this->monta_condicao("a.idProvider", $sc_field_2_cond, $sc_field_2, "", "sc_field_2");
      }
      ...
      {
         $this->monta_condicao("concat( g.gelar,' ',g.NAME,', ',g.spec )", $dpjp_cond, $dpjp, "", "dpjp");
      }
   }
   ...
   function finaliza_resultado_ajax()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['where_pesq'] = $this->comando;
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['where_pesq_fast'])) 
       {
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['where_pesq'])) 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['where_pesq_fast'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['where_pesq'] = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['where_pesq_fast'] . ")";
           }
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['cond_dyn_search'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['berkas_klaim_elek']['cond_pesq'] .= $this->NM_operador;
