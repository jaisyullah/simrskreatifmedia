<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tbhistoripo']['sc_process_barr'] = true;
require_once('../grid_tbhistoripo/index.php');
unset($_SESSION['scriptcase']['grid_tbhistoripo']['sc_process_barr']);
$ExportCtrl = new grid_tbhistoripo_export_control;
$ExportCtrl->Export_barr();

class grid_tbhistoripo_export_control
{
