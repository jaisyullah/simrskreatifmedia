<?php
@session_start() ;
$_SESSION['scriptcase']['print_etiket7']['sc_process_barr'] = true;
require_once('../print_etiket7/index.php');
unset($_SESSION['scriptcase']['print_etiket7']['sc_process_barr']);
$ExportCtrl = new print_etiket7_export_control;
$ExportCtrl->Export_barr();

class print_etiket7_export_control
{
