  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbdetailformulaobat" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbdetailformulaobat_form();
	}

  // ---------- Validate kodeitem_
  function do_ajax_form_tbdetailformulaobat_validate_kodeitem_(iNumLinha)
  {
    var nomeCampo_kodeitem_ = "kodeitem_" + iNumLinha;
    var var_kodeitem_ = scAjaxGetFieldSelect(nomeCampo_kodeitem_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdetailformulaobat_validate_kodeitem_(var_kodeitem_, iNumLinha, var_script_case_init, do_ajax_form_tbdetailformulaobat_validate_kodeitem__cb);
  } // do_ajax_form_tbdetailformulaobat_validate_kodeitem_

  function do_ajax_form_tbdetailformulaobat_validate_kodeitem__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdetailformulaobat_validate_kodeitem__cb

  // ---------- Validate jumlah_
  function do_ajax_form_tbdetailformulaobat_validate_jumlah_(iNumLinha)
  {
    var nomeCampo_jumlah_ = "jumlah_" + iNumLinha;
    var var_jumlah_ = scAjaxGetFieldText(nomeCampo_jumlah_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdetailformulaobat_validate_jumlah_(var_jumlah_, iNumLinha, var_script_case_init, do_ajax_form_tbdetailformulaobat_validate_jumlah__cb);
  } // do_ajax_form_tbdetailformulaobat_validate_jumlah_

  function do_ajax_form_tbdetailformulaobat_validate_jumlah__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdetailformulaobat_validate_jumlah__cb

  // ---------- Validate signa_
  function do_ajax_form_tbdetailformulaobat_validate_signa_(iNumLinha)
  {
    var nomeCampo_signa_ = "signa_" + iNumLinha;
    var var_signa_ = scAjaxGetFieldSelect(nomeCampo_signa_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdetailformulaobat_validate_signa_(var_signa_, iNumLinha, var_script_case_init, do_ajax_form_tbdetailformulaobat_validate_signa__cb);
  } // do_ajax_form_tbdetailformulaobat_validate_signa_

  function do_ajax_form_tbdetailformulaobat_validate_signa__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdetailformulaobat_validate_signa__cb

  // ---------- Validate id_
  function do_ajax_form_tbdetailformulaobat_validate_id_(iNumLinha)
  {
    var nomeCampo_id_ = "id_" + iNumLinha;
    var var_id_ = scAjaxGetFieldHidden(nomeCampo_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdetailformulaobat_validate_id_(var_id_, iNumLinha, var_script_case_init, do_ajax_form_tbdetailformulaobat_validate_id__cb);
  } // do_ajax_form_tbdetailformulaobat_validate_id_

  function do_ajax_form_tbdetailformulaobat_validate_id__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdetailformulaobat_validate_id__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_tbdetailformulaobat_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_tbdetailformulaobat_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tbdetailformulaobat_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_tbdetailformulaobat_add_new_line_cb);
  } // do_ajax_form_tbdetailformulaobat_add_new_line

  function do_ajax_form_tbdetailformulaobat_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_tbdetailformulaobat_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_tbdetailformulaobat_backup_line(iNumLinha)
  {
    var var_id_ = scAjaxGetFieldHidden("id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdetailformulaobat_backup_line(var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_tbdetailformulaobat_backup_line_cb);
  } // do_ajax_form_tbdetailformulaobat_backup_line

  function do_ajax_form_tbdetailformulaobat_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_tbdetailformulaobat_backup_line_cb

  function do_ajax_form_tbdetailformulaobat_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_tbdetailformulaobat_cancel_insert

  function do_ajax_form_tbdetailformulaobat_cancel_update(iSeqVert)
  {
    do_ajax_form_tbdetailformulaobat_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_tbdetailformulaobat_cancel_update

  function do_ajax_form_tbdetailformulaobat_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_tbdetailformulaobat_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_tbdetailformulaobat_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_tbdetailformulaobat_table_refresh(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbdetailformulaobat_table_refresh_cb);
  } //  do_ajax_form_tbdetailformulaobat_table_refresh

  function do_ajax_form_tbdetailformulaobat_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_tbdetailformulaobat_table_refresh_cb_after_alert);
  } // do_ajax_form_tbdetailformulaobat_table_refresh_cb
  function do_ajax_form_tbdetailformulaobat_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_tbdetailformulaobat_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_tbdetailformulaobat_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_tbdetailformulaobat_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
...
?>
    x_ajax_form_tbdetailformulaobat_submit_form(var_kodeitem_, var_jumlah_, var_signa_, var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbdetailformulaobat_submit_form_cb);
  } // do_ajax_form_tbdetailformulaobat_submit_form

  function do_ajax_form_tbdetailformulaobat_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_tbdetailformulaobat_submit_form_cb_after_alert);
  } // do_ajax_form_tbdetailformulaobat_submit_form_cb
  function do_ajax_form_tbdetailformulaobat_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbdetailformulaobat_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tbdetailformulaobat_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_tbdetailformulaobat_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tbdetailformulaobat_navigate_form(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbdetailformulaobat_navigate_form_cb);
  } // do_ajax_form_tbdetailformulaobat_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailformulaobat']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbdetailformulaobat_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbdetailformulaobat_navigate_form_cb_after_alert);
  } // do_ajax_form_tbdetailformulaobat_navigate_form_cb
  function do_ajax_form_tbdetailformulaobat_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_tbdetailformulaobat_navigate_form_cb_after_alert
  function sc_hide_form_tbdetailformulaobat_form()
  {
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["kodeitem_" + iRow] || "on" == ajax_error_count["jumlah_" + iRow] || "on" == ajax_error_count["signa_" + iRow] || "on" == ajax_error_count["id_" + iRow]))
    {
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["kodeitem_" + iRow] && "off" == ajax_error_count["jumlah_" + iRow] && "off" == ajax_error_count["signa_" + iRow] && "off" == ajax_error_count["id_" + iRow]))
    {
      if (bErrorRow)
      {
