...
class grid_tbdetailrawatjalan_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatjalan']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_tbdetailrawatjalan_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_tbdetailrawatjalan_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_tbdetailrawatjalan_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatjalan']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatjalan']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatjalan']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatjalan']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatjalan']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatjalan']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatjalan']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatjalan']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatjalan']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatjalan']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatjalan']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatjalan']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatjalan']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatjalan']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatjalan']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatjalan']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatjalan']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_tbdetailrawatjalan/grid_tbdetailrawatjalan_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_tbdetailrawatjalan_ajax_search.js"></script>
 <script type="text/javascript" src="grid_tbdetailrawatjalan_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_tbdetailrawatjalan_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_tbdetailrawatjalan']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_tbdetailrawatjalan']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
<?php
   ...
   function monta_form()
   {
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatjalan']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatjalan']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatjalan']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatjalan']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $tgldaftar_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatjalan']['campos_busca']['tgldaftar_dia']; 
          $tgldaftar_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatjalan']['campos_busca']['tgldaftar_mes']; 
          $tgldaftar_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatjalan']['campos_busca']['tgldaftar_ano']; 
          $tgldaftar_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatjalan']['campos_busca']['tgldaftar_input_2_dia']; 
          $tgldaftar_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatjalan']['campos_busca']['tgldaftar_input_2_mes']; 
          $tgldaftar_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatjalan']['campos_busca']['tgldaftar_input_2_ano']; 
          $tgldaftar_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatjalan']['campos_busca']['tgldaftar_cond']; 
          $poli = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatjalan']['campos_busca']['poli']; 
          $poli_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatjalan']['campos_busca']['poli_cond']; 
          $dokter = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatjalan']['campos_busca']['dokter']; 
          $dokter_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatjalan']['campos_busca']['dokter_cond']; 
          $statuspasien = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatjalan']['campos_busca']['statuspasien']; 
          $statuspasien_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatjalan']['campos_busca']['statuspasien_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatjalan']['campos_busca']['NM_operador']; 
      } 
...
<?php
      ...
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatjalan']['psq_check_ret']['poli'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatjalan']['psq_check_ret']['poli'][] = trim($rs->fields[0]);
...
<?php
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatjalan']['psq_check_ret']['dokter'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatjalan']['psq_check_ret']['dokter'][] = trim($rs->fields[0]);
            $nmgp_def_dados .= trim($rs->fields[1]) . "?#?" ; 
            $nmgp_def_dados .= trim($rs->fields[0]) . "?#?N?@?" ; 
            $rs->MoveNext() ; 
         } 
...
<?php
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatjalan']['psq_check_ret']['statuspasien'] = array();
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatjalan']['psq_check_ret']['statuspasien'][] = "Daftar";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatjalan']['psq_check_ret']['statuspasien'][] = "Pelayanan";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatjalan']['psq_check_ret']['statuspasien'][] = "Selesai";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatjalan']['psq_check_ret']['statuspasien'][] = "Lengkap";
 ?>
...
?>
<?php
   if (is_file("grid_tbdetailrawatjalan_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_tbdetailrawatjalan']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_tbdetailrawatjalan']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatjalan']['orig_pesq'] == "grid")
   {
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "simrskreatifmedia/grid_tbdetailrawatjalan";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatjalan']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatjalan']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatjalan']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro($nmgp_save_origem)
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "grid_tbdetailrawatjalan/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function trata_campos()
   {
      ...
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatjalan']['psq_check_ret']['poli'])) {
      ...
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatjalan']['psq_check_ret']['dokter'])) {
      ...
      if (is_array($statuspasien)) {
          foreach ($statuspasien as $I => $Val) {
              ...
              if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && trim($L_lookup) != '' && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatjalan']['psq_check_ret']['statuspasien'])) {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatjalan']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatjalan']['campos_busca']['tgldaftar_dia'] = $tgldaftar_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatjalan']['campos_busca']['tgldaftar_mes'] = $tgldaftar_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatjalan']['campos_busca']['tgldaftar_ano'] = $tgldaftar_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatjalan']['campos_busca']['tgldaftar_input_2_dia'] = $tgldaftar_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatjalan']['campos_busca']['tgldaftar_input_2_mes'] = $tgldaftar_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatjalan']['campos_busca']['tgldaftar_input_2_ano'] = $tgldaftar_input_2_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatjalan']['campos_busca']['tgldaftar_cond'] = $tgldaftar_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatjalan']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatjalan']['campos_busca']['poli'] = $poli; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatjalan']['campos_busca']['poli_cond'] = $poli_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatjalan']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatjalan']['campos_busca']['dokter'] = $dokter; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatjalan']['campos_busca']['dokter_cond'] = $dokter_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatjalan']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatjalan']['campos_busca']['statuspasien'] = $statuspasien; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatjalan']['campos_busca']['statuspasien_cond'] = $statuspasien_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatjalan']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatjalan']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatjalan']['campos_busca'] = $Temp_Busca;
      }
      $poli_LKP = $poli;
      $Tmp_pos = strpos($poli, "##@@");
      if ($Tmp_pos !== false)
...
$_SESSION['scriptcase']['grid_tbdetailrawatjalan']['contr_erro'] = 'off'; 
      ...
      $this->cmp_formatado['statuspasien'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatjalan']['campos_busca']['statuspasien'];
      ...
      if ($tgldaftar_cond != "bi_TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatjalan']['campos_busca']['tgldaftar'] = $val[0];
          ...
          if ($tgldaftar_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatjalan']['campos_busca']['tgldaftar_input_2'] = $val[1];
      ...
      if (is_array($statuspasien) && count($statuspasien) != 0)
      {
         ...
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatjalan']['cond_pesq'] .= $nmgp_tab_label['statuspasien'] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
      }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatjalan']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatjalan']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatjalan']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatjalan']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatjalan']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatjalan']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatjalan']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatjalan']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatjalan']['cond_pesq'] .= $this->NM_operador;
