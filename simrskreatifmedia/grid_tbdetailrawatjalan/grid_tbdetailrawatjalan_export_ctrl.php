<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tbdetailrawatjalan']['sc_process_barr'] = true;
require_once('../grid_tbdetailrawatjalan/index.php');
unset($_SESSION['scriptcase']['grid_tbdetailrawatjalan']['sc_process_barr']);
$ExportCtrl = new grid_tbdetailrawatjalan_export_control;
$ExportCtrl->Export_barr();

class grid_tbdetailrawatjalan_export_control
{
