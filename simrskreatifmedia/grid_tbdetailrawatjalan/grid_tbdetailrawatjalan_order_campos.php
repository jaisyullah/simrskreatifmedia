<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_tbdetailrawatjalan']['glo_nm_path_imag_temp'] . "/sc_apl_default_simrskreatifmedia.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_tbdetailrawatjalan_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_tbdetailrawatjalan_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatjalan']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatjalan']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["trancode"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatjalan']['labels']["trancode"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatjalan']['labels']["trancode"] : "Kode Transaksi";
   ...
   $tab_labels["custcode"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatjalan']['labels']["custcode"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatjalan']['labels']["custcode"] : "No RM";
...
ORDER BY name, salut";
   ...
   $tab_labels["sc_field_0"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatjalan']['labels']["sc_field_0"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatjalan']['labels']["sc_field_0"] : "Nama Pasien";
   ...
   $tab_labels["dokter"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatjalan']['labels']["dokter"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatjalan']['labels']["dokter"] : "Dokter";
   ...
   $tab_labels["selesai"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatjalan']['labels']["selesai"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatjalan']['labels']["selesai"] : "Selesai";
   ...
   $tab_labels["tglkeluar"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatjalan']['labels']["tglkeluar"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatjalan']['labels']["tglkeluar"] : "Tgl Keluar";
   $tab_ger_campos['diagnosa1'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['diagnosa1'] = "diagnosa1";
   }
   else
   {
       $tab_def_campos['diagnosa1'] = "a.diagnosa1";
   }
   $tab_labels["diagnosa1"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatjalan']['labels']["diagnosa1"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatjalan']['labels']["diagnosa1"] : "Diagnosa";
   $tab_ger_campos['icd1'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['icd1'] = "icd1";
   }
   else
   {
       $tab_def_campos['icd1'] = "a.icd1";
   }
   $tab_labels["icd1"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatjalan']['labels']["icd1"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatjalan']['labels']["icd1"] : "Kode ICD";
   ...
   {
       $tab_def_campos['nostruk'] = "a.noStruk";
   }
   $tab_labels["nostruk"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatjalan']['labels']["nostruk"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatjalan']['labels']["nostruk"] : "No Struk";
   $tab_ger_campos['statuspasien'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['statuspasien'] = "statuspasien";
   }
   else
   {
       $tab_def_campos['statuspasien'] = "b.`status`";
   }
   $tab_labels["statuspasien"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatjalan']['labels']["statuspasien"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatjalan']['labels']["statuspasien"] : "Status Pasien";
   ...
   $tab_labels["jenis"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatjalan']['labels']["jenis"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatjalan']['labels']["jenis"] : "Jenis";
   $tab_ger_campos['antrian'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['antrian'] = "Antrian";
   }
   else
   {
       $tab_def_campos['antrian'] = "SELECT queue 
FROM tbantrian 
WHERE struckNo = '{noStruk}' 
ORDER BY queue";
   }
   $tab_labels["antrian"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatjalan']['labels']["antrian"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatjalan']['labels']["antrian"] : "No Antrian";
   ...
   $tab_labels["umur"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatjalan']['labels']["umur"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatjalan']['labels']["umur"] : "Umur";
   $tab_ger_campos['sc_field_0'] = "none";
   $tab_ger_campos['jenis'] = "none";
   $tab_ger_campos['antrian'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatjalan']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatjalan']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatjalan']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatjalan']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatjalan']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatjalan']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatjalan']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatjalan']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatjalan']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - Pelayanan Rawat Jalan</TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_tbdetailrawatjalan_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatjalan']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatjalan']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatjalan']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatjalan']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatjalan']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
