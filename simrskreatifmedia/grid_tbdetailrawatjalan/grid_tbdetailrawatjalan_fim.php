...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_tbdetailrawatjalan"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_tbdetailrawatjalan"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tbdetailrawatjalan']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_tbdetailrawatjalan']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tbdetailrawatjalan']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_tbdetailrawatjalan']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_tbdetailrawatjalan']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_tbdetailrawatjalan</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_tbdetailrawatjalan']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_tbdetailrawatjalan']['embutida_filho'] as $ind => $sc_init)
          {
