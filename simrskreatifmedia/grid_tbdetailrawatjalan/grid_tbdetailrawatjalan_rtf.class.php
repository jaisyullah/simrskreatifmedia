...
class grid_tbdetailrawatjalan_rtf
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "grid_tbdetailrawatjalan.rtf";
   }
   //---- 
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      $nm_raiz_img  = ""; 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatjalan']['rtf_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatjalan']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatjalan']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatjalan']['rtf_name']);
      }
...
$_SESSION['scriptcase']['grid_tbdetailrawatjalan']['contr_erro'] = 'off'; 
   ...
   {
         if (!NM_is_utf8($this->antrian))
         {
             $this->antrian = sc_convert_encoding($this->antrian, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->antrian = str_replace('<', '&lt;', $this->antrian);
         $this->antrian = str_replace('>', '&gt;', $this->antrian);
         $this->Texto_tag .= "<td>" . $this->antrian . "</td>\r\n";
   }
   //----- umur
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatjalan']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatjalan']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - Pelayanan Rawat Jalan :: RTF</TITLE>
