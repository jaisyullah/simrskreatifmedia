...
<?php
   ...
   $Ord_Cmp = new grid_supplier_gizi_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_supplier_gizi_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_supplier_gizi']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_supplier_gizi']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['suppcode'] = "suppcode";
   $tab_labels["suppcode"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_supplier_gizi']['labels']["suppcode"])) ? $_SESSION['sc_session'][$sc_init]['grid_supplier_gizi']['labels']["suppcode"] : "Suppcode";
   $tab_ger_campos['alamat'] = "on";
   $tab_def_campos['alamat'] = "alamat";
   $tab_labels["alamat"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_supplier_gizi']['labels']["alamat"])) ? $_SESSION['sc_session'][$sc_init]['grid_supplier_gizi']['labels']["alamat"] : "Alamat";
   $tab_ger_campos['telp'] = "on";
   $tab_def_campos['telp'] = "telp";
   $tab_labels["telp"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_supplier_gizi']['labels']["telp"])) ? $_SESSION['sc_session'][$sc_init]['grid_supplier_gizi']['labels']["telp"] : "Telp";
   $tab_ger_campos['cp'] = "on";
   $tab_def_campos['cp'] = "cp";
   $tab_labels["cp"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_supplier_gizi']['labels']["cp"])) ? $_SESSION['sc_session'][$sc_init]['grid_supplier_gizi']['labels']["cp"] : "Cp";
   $tab_ger_campos['telp_cp'] = "on";
   $tab_def_campos['telp_cp'] = "telp_cp";
   $tab_labels["telp_cp"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_supplier_gizi']['labels']["telp_cp"])) ? $_SESSION['sc_session'][$sc_init]['grid_supplier_gizi']['labels']["telp_cp"] : "Telp Cp";
   $tab_ger_campos['no_rek'] = "on";
   $tab_def_campos['no_rek'] = "no_rek";
   $tab_labels["no_rek"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_supplier_gizi']['labels']["no_rek"])) ? $_SESSION['sc_session'][$sc_init]['grid_supplier_gizi']['labels']["no_rek"] : "No Rek";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_supplier_gizi']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_supplier_gizi']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_supplier_gizi']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_supplier_gizi']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_supplier_gizi']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_supplier_gizi']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_supplier_gizi']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_supplier_gizi']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_supplier_gizi']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_supplier_gizi_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_supplier_gizi']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_supplier_gizi']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_supplier_gizi']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_supplier_gizi']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_supplier_gizi']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
