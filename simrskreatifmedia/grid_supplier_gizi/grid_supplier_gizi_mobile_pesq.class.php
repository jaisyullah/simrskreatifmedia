...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_suppcode_cond" name="suppcode_cond" onChange="nm_campos_between(document.getElementById('id_vis_suppcode'), this, 'suppcode')">
      ...
      <br><span id="id_hide_suppcode"  <?php echo $str_hide_suppcode?>><?php
      if ($suppcode != "")
      {
      $suppcode_look = substr($this->Db->qstr($suppcode), 1, -1); 
      $nmgp_def_dados = array(); 
