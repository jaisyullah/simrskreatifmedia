<?php
@session_start() ;
$_SESSION['scriptcase']['grid_supplier_gizi']['sc_process_barr'] = true;
require_once('../grid_supplier_gizi/index.php');
unset($_SESSION['scriptcase']['grid_supplier_gizi']['sc_process_barr']);
$ExportCtrl = new grid_supplier_gizi_export_control;
$ExportCtrl->Export_barr();

class grid_supplier_gizi_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - supplier_gizi :: Excel</TITLE>
