...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____pemeriksaanLab_rj"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____pemeriksaanLab_rj"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['pemeriksaanLab_rj']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['pemeriksaanLab_rj']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['pemeriksaanLab_rj']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['pemeriksaanLab_rj']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['pemeriksaanLab_rj']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['pemeriksaanLab_rj']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['pemeriksaanLab_rj']['embutida_filho'] as $ind => $sc_init)
          {
