<?php
@session_start() ;
$_SESSION['scriptcase']['pemeriksaanLab_rj']['sc_process_barr'] = true;
require_once('../pemeriksaanLab_rj/index.php');
unset($_SESSION['scriptcase']['pemeriksaanLab_rj']['sc_process_barr']);
$ExportCtrl = new pemeriksaanLab_rj_export_control;
$ExportCtrl->Export_barr();

class pemeriksaanLab_rj_export_control
{
