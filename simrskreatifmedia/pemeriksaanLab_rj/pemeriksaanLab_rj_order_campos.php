...
<?php
   ...
   $Ord_Cmp = new pemeriksaanLab_rj_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class pemeriksaanLab_rj_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['pemeriksaanLab_rj']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['pemeriksaanLab_rj']['ordem_select_orig'] = array();
   }
   ...
   {
       $tab_def_campos['kategori'] = "a.kategori";
   }
   $tab_labels["kategori"]   = (isset($_SESSION['sc_session'][$sc_init]['pemeriksaanLab_rj']['labels']["kategori"])) ? $_SESSION['sc_session'][$sc_init]['pemeriksaanLab_rj']['labels']["kategori"] : "Kategori";
   ...
   {
       $tab_def_campos['sc_field_1'] = "a.subname";
   }
   $tab_labels["sc_field_1"]   = (isset($_SESSION['sc_session'][$sc_init]['pemeriksaanLab_rj']['labels']["sc_field_1"])) ? $_SESSION['sc_session'][$sc_init]['pemeriksaanLab_rj']['labels']["sc_field_1"] : "Sub Pemeriksaan";
   ...
   {
       $tab_def_campos['sc_field_2'] = "a.rujukan";
   }
   $tab_labels["sc_field_2"]   = (isset($_SESSION['sc_session'][$sc_init]['pemeriksaanLab_rj']['labels']["sc_field_2"])) ? $_SESSION['sc_session'][$sc_init]['pemeriksaanLab_rj']['labels']["sc_field_2"] : "Nil Rujukan";
   $tab_ger_campos['hasil'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['hasil'] = "hasil";
   }
   else
   {
       $tab_def_campos['hasil'] = "a.hasil";
   }
   $tab_labels["hasil"]   = (isset($_SESSION['sc_session'][$sc_init]['pemeriksaanLab_rj']['labels']["hasil"])) ? $_SESSION['sc_session'][$sc_init]['pemeriksaanLab_rj']['labels']["hasil"] : "Hasil";
   $tab_ger_campos['tandai'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['tandai'] = "tandai";
   }
   else
   {
       $tab_def_campos['tandai'] = "a.marked";
   }
   $tab_labels["tandai"]   = (isset($_SESSION['sc_session'][$sc_init]['pemeriksaanLab_rj']['labels']["tandai"])) ? $_SESSION['sc_session'][$sc_init]['pemeriksaanLab_rj']['labels']["tandai"] : "Tandai";
   ...
   {
       $tab_def_campos['satuan'] = "a.satuan";
   }
   $tab_labels["satuan"]   = (isset($_SESSION['sc_session'][$sc_init]['pemeriksaanLab_rj']['labels']["satuan"])) ? $_SESSION['sc_session'][$sc_init]['pemeriksaanLab_rj']['labels']["satuan"] : "Satuan";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['pemeriksaanLab_rj']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['pemeriksaanLab_rj']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['pemeriksaanLab_rj']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['pemeriksaanLab_rj']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['pemeriksaanLab_rj']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['pemeriksaanLab_rj']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['pemeriksaanLab_rj']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['pemeriksaanLab_rj']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['pemeriksaanLab_rj']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "pemeriksaanLab_rj_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['pemeriksaanLab_rj']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['pemeriksaanLab_rj']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['pemeriksaanLab_rj']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['pemeriksaanLab_rj']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['pemeriksaanLab_rj']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
