...
function ajax_navigate(opc, parm)
{
    ...
    return new Promise(function(resolve, reject) {$.ajax({
     ...
     .done(function(jsonNavigate) {
        ...
        document.getElementById('nmsc_iframe_liga_A_sec_grid_sec_users_groups').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_E_sec_grid_sec_users_groups').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_D_sec_grid_sec_users_groups').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_B_sec_grid_sec_users_groups').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_A_sec_grid_sec_users_groups').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_E_sec_grid_sec_users_groups').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_D_sec_grid_sec_users_groups').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_B_sec_grid_sec_users_groups').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_A_sec_grid_sec_users_groups').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_E_sec_grid_sec_users_groups').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_D_sec_grid_sec_users_groups').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_B_sec_grid_sec_users_groups').style.width  = '0px';
        if (oResp["redirInfo"]) {
           nmAjaxRedir(oResp);
        }
        if (oResp["setValue"]) {
