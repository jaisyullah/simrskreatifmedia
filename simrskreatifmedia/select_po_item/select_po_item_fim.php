...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____select_po_item"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____select_po_item"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['select_po_item']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['select_po_item']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['select_po_item']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['select_po_item']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['select_po_item']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['select_po_item']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['select_po_item']['embutida_filho'] as $ind => $sc_init)
          {
