...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "id";$Nm_numeric[] = "jumlah";$Nm_numeric[] = "isi";$Nm_numeric[] = "harga";$Nm_numeric[] = "disc";$Nm_numeric[] = "id";$Nm_numeric[] = "jumlah";$Nm_numeric[] = "isi";$Nm_numeric[] = "harga";$Nm_numeric[] = "disc";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      ...
      <br><span id="id_hide_id"  <?php echo $str_hide_id?>><INPUT  type="text" id="SC_id" name="id" value="<?php echo NM_encode_input($id) ?>" size=5 alt="{datatype: 'integer', maxLength: 5, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_po_cond" name="po_cond" onChange="nm_campos_between(document.getElementById('id_vis_po'), this, 'po')">
