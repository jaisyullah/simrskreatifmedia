...
<?php
   ...
   $Ord_Cmp = new select_po_item_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class select_po_item_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['select_po_item']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['select_po_item']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["id"]   = (isset($_SESSION['sc_session'][$sc_init]['select_po_item']['labels']["id"])) ? $_SESSION['sc_session'][$sc_init]['select_po_item']['labels']["id"] : "Id";
   $tab_ger_campos['po'] = "on";
   $tab_def_campos['po'] = "po";
   $tab_labels["po"]   = (isset($_SESSION['sc_session'][$sc_init]['select_po_item']['labels']["po"])) ? $_SESSION['sc_session'][$sc_init]['select_po_item']['labels']["po"] : "Po";
   $tab_ger_campos['item'] = "on";
   $tab_def_campos['item'] = "item";
   $tab_labels["item"]   = (isset($_SESSION['sc_session'][$sc_init]['select_po_item']['labels']["item"])) ? $_SESSION['sc_session'][$sc_init]['select_po_item']['labels']["item"] : "Item";
   $tab_ger_campos['jumlah'] = "on";
   $tab_def_campos['jumlah'] = "jumlah";
   $tab_labels["jumlah"]   = (isset($_SESSION['sc_session'][$sc_init]['select_po_item']['labels']["jumlah"])) ? $_SESSION['sc_session'][$sc_init]['select_po_item']['labels']["jumlah"] : "Jumlah";
   $tab_ger_campos['kemasan'] = "on";
   $tab_def_campos['kemasan'] = "kemasan";
   $tab_labels["kemasan"]   = (isset($_SESSION['sc_session'][$sc_init]['select_po_item']['labels']["kemasan"])) ? $_SESSION['sc_session'][$sc_init]['select_po_item']['labels']["kemasan"] : "Kemasan";
   $tab_ger_campos['isi'] = "on";
   $tab_def_campos['isi'] = "isi";
   $tab_labels["isi"]   = (isset($_SESSION['sc_session'][$sc_init]['select_po_item']['labels']["isi"])) ? $_SESSION['sc_session'][$sc_init]['select_po_item']['labels']["isi"] : "Isi";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['select_po_item']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['select_po_item']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['select_po_item']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['select_po_item']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['select_po_item']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['select_po_item']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['select_po_item']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['select_po_item']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['select_po_item']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "select_po_item_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['select_po_item']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['select_po_item']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['select_po_item']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['select_po_item']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['select_po_item']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
