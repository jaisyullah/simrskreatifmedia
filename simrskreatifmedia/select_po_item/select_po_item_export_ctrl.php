<?php
@session_start() ;
$_SESSION['scriptcase']['select_po_item']['sc_process_barr'] = true;
require_once('../select_po_item/index.php');
unset($_SESSION['scriptcase']['select_po_item']['sc_process_barr']);
$ExportCtrl = new select_po_item_export_control;
$ExportCtrl->Export_barr();

class select_po_item_export_control
{
