...
class grid_insentive_rtf
{
   ...
   function NM_export_tgltindakan()
   {
         ...
         $this->tgltindakan = str_replace('<', '&lt;', $this->tgltindakan);
         $this->tgltindakan = str_replace('>', '&gt;', $this->tgltindakan);
         $this->Texto_tag .= "<td>" . $this->tgltindakan . "</td>\r\n";
   }
   //----- dokcode
   function NM_export_dokcode()
   {
         ...
         $this->dokcode = str_replace('<', '&lt;', $this->dokcode);
         $this->dokcode = str_replace('>', '&gt;', $this->dokcode);
         $this->Texto_tag .= "<td>" . $this->dokcode . "</td>\r\n";
   }
   //----- tindakan
   ...
   function NM_export_insentive()
   {
         ...
         $this->insentive = str_replace('<', '&lt;', $this->insentive);
         $this->insentive = str_replace('>', '&gt;', $this->insentive);
         $this->Texto_tag .= "<td>" . $this->insentive . "</td>\r\n";
   }
   //----- diskon
