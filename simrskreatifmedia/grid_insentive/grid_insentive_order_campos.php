...
<?php
   ...
   $Ord_Cmp = new grid_insentive_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_insentive_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_insentive']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_insentive']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['tgltindakan'] = "tglTindakan";
   $tab_labels["tgltindakan"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_insentive']['labels']["tgltindakan"])) ? $_SESSION['sc_session'][$sc_init]['grid_insentive']['labels']["tgltindakan"] : "Tgl Tindakan";
   $tab_ger_campos['dokcode'] = "on";
   $tab_def_campos['dokcode'] = "dokCode";
   $tab_labels["dokcode"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_insentive']['labels']["dokcode"])) ? $_SESSION['sc_session'][$sc_init]['grid_insentive']['labels']["dokcode"] : "Dokter";
   $tab_ger_campos['tindakan'] = "on";
   $tab_def_campos['tindakan'] = "Tindakan";
   $tab_labels["tindakan"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_insentive']['labels']["tindakan"])) ? $_SESSION['sc_session'][$sc_init]['grid_insentive']['labels']["tindakan"] : "Tindakan";
   $tab_ger_campos['pasien'] = "on";
   $tab_def_campos['pasien'] = "Pasien";
   $tab_labels["pasien"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_insentive']['labels']["pasien"])) ? $_SESSION['sc_session'][$sc_init]['grid_insentive']['labels']["pasien"] : "Pasien";
   $tab_ger_campos['kode'] = "on";
   $tab_def_campos['kode'] = "Kode";
   $tab_labels["kode"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_insentive']['labels']["kode"])) ? $_SESSION['sc_session'][$sc_init]['grid_insentive']['labels']["kode"] : "Kode";
   $tab_ger_campos['deskripsi'] = "on";
   $tab_def_campos['deskripsi'] = "Deskripsi";
   $tab_labels["deskripsi"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_insentive']['labels']["deskripsi"])) ? $_SESSION['sc_session'][$sc_init]['grid_insentive']['labels']["deskripsi"] : "Deskripsi";
   $tab_ger_campos['insentive'] = "on";
   $tab_def_campos['insentive'] = "Insentive";
   $tab_labels["insentive"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_insentive']['labels']["insentive"])) ? $_SESSION['sc_session'][$sc_init]['grid_insentive']['labels']["insentive"] : "Insentive";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_insentive']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_insentive']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_insentive']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_insentive']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_insentive']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_insentive']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_insentive']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_insentive']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_insentive']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_insentive_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_insentive']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_insentive']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_insentive']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_insentive']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_insentive']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
