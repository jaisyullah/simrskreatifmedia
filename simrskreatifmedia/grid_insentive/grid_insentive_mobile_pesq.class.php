...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "tglTindakan";$Nm_datas[] = "tglTindakan";$Nm_numeric[] = "insentive";$Nm_numeric[] = "diskon";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_tgltindakan"  <?php echo $str_hide_tgltindakan?>>
<?php
  $Form_base = "ddmmyyyy";
  $date_format_show = "";
...
?>
          ...
          <BR>
        <SPAN id="id_vis_tgltindakan"  <?php echo $str_display_tgltindakan; ?> class="scFilterFieldFontOdd">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_dokcode"  <?php echo $str_hide_dokcode?>>
<?php
...
?>
   <span id="idAjaxSelect_dokcode">
      <SELECT class="scFilterObjectEven" id="SC_dokcode" name="dokcode[]"  size="1" multiple>
       <OPTION value=""></OPTION>
<?php
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_deskripsi"  <?php echo $str_hide_deskripsi?>> 
<?php
...
<?php
   ...
   function css_obj_select_ajax($Obj)
   {
      switch ($Obj)
      {
         case "dokcode" : return ('class="scFilterObjectEven"'); break;
         default       : return ("");
      }
   }
