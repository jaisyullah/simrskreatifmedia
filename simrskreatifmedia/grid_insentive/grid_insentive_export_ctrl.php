<?php
@session_start() ;
$_SESSION['scriptcase']['grid_insentive']['sc_process_barr'] = true;
require_once('../grid_insentive/index.php');
unset($_SESSION['scriptcase']['grid_insentive']['sc_process_barr']);
$ExportCtrl = new grid_insentive_export_control;
$ExportCtrl->Export_barr();

class grid_insentive_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_title'] ?> - Insentif Paramedis :: Excel</TITLE>
