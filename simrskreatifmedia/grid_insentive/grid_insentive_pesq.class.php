...
class grid_insentive_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_insentive']['path_libs_php'] = $this->Ini->path_lib_php;
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_insentive']['prim_vez']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_insentive']['prim_vez'] = "S";
      }
   ...
   function init()
   {
    ...
    {
      global $tgltindakan_cond, $tgltindakan, $tgltindakan_dia, $tgltindakan_mes, $tgltindakan_ano, $tgltindakan_input_2_dia, $tgltindakan_input_2_mes, $tgltindakan_input_2_ano,
             $dokcode_cond, $dokcode,
             $deskripsi_cond, $deskripsi;
      $_SESSION['scriptcase']['grid_insentive']['contr_erro'] = 'on';
 $tgltindakan  = date('Y-m-d');
$tgltindakan_2  = date('Y-m-d');
$_SESSION['scriptcase']['grid_insentive']['contr_erro'] = 'off'; 
      if (isset($tgltindakan_day))
      {
          $tgltindakan_dia = $tgltindakan_day; 
      }
      if (isset($tgltindakan_month))
      {
          $tgltindakan_mes = $tgltindakan_month; 
      }
      if (isset($tgltindakan_year))
      {
          $tgltindakan_ano = $tgltindakan_year; 
      }
      if (isset($tgltindakan))
      {
          $tgltindakan = str_replace("0000", "", $tgltindakan);
          $tgltindakan = str_replace("-00", "-", $tgltindakan);
          $tgltindakanXX = explode("-", $tgltindakan);
          if (isset($tgltindakanXX[2]))
          {
              $tgltindakan_dia = $tgltindakanXX[2]; 
          }
          if (isset($tgltindakanXX[1]))
          {
              $tgltindakan_mes = $tgltindakanXX[1]; 
          }
          if (isset($tgltindakanXX[0]))
          {
              $tgltindakan_ano = $tgltindakanXX[0]; 
          }
      }
      if (isset($tgltindakan_input_2_day))
      {
          $tgltindakan_input_2_dia = $tgltindakan_input_2_day; 
      }
      if (isset($tgltindakan_input_2_month))
      {
          $tgltindakan_input_2_mes = $tgltindakan_input_2_month; 
      }
      if (isset($tgltindakan_input_2_year))
      {
          $tgltindakan_input_2_ano = $tgltindakan_input_2_year; 
      }
      if (isset($tgltindakan_2))
      {
          $tgltindakan_2 = str_replace("0000", "", $tgltindakan_2);
          $tgltindakan_2 = str_replace("-00", "-", $tgltindakan_2);
          $tgltindakanXX = explode("-", $tgltindakan_2);
          if (isset($tgltindakanXX[2]))
          {
              $tgltindakan_input_2_dia = $tgltindakanXX[2]; 
          }
          if (isset($tgltindakanXX[1]))
          {
              $tgltindakan_input_2_mes = $tgltindakanXX[1]; 
          }
          if (isset($tgltindakanXX[0]))
          {
              $tgltindakan_input_2_ano = $tgltindakanXX[0]; 
          }
      }
    }
   }
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_insentive_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_insentive_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_insentive_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $Nm_datas[] = "tglTindakan";$Nm_datas[] = "tglTindakan";
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_insentive']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_insentive']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_insentive']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_insentive']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_insentive']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_insentive']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_insentive']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_insentive']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_insentive']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_insentive']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_insentive']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_insentive']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_insentive']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_insentive']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_insentive']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_insentive']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_insentive']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
   ...
   $NM_retorno = "./";
    if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_insentive']['proc_res'])) 
    {
...
<?php
    if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_insentive']['prim_vez'] == "N" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_insentive']['proc_res']) 
    {
?>
if (parent.document.getElementById('nmsc_iframe_grid_insentive').contentWindow.nm_gp_submit_ajax)
{
   parent.document.getElementById('nmsc_iframe_grid_insentive').contentWindow.nm_gp_submit_ajax('inicio', 'save_grid');
}
else
{
   parent.document.getElementById('nmsc_iframe_grid_insentive').src = 'index.php?nmgp_opcao=pesq&script_case_init=<?php echo NM_encode_input($this->Ini->sc_page) ?>&script_case_session=<?php echo session_id() ?>';
}
<?php
    }
    else
...
<?php
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_insentive']['prim_vez'] = "N";
?>
</SCRIPT>
</BODY>
</HTML>
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_title'] ?> - Insentif Paramedis</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_insentive/grid_insentive_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_insentive_ajax_search.js"></script>
 <script type="text/javascript" src="grid_insentive_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_insentive_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_insentive']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_insentive']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
function scJQCalendarAdd() {
  $("#sc_tgltindakan_jq").datepicker({
    beforeShow: function(input, inst) {
          var_dt_ini  = document.getElementById('SC_tgltindakan_dia').value + '/';
          var_dt_ini += document.getElementById('SC_tgltindakan_mes').value + '/';
          var_dt_ini += document.getElementById('SC_tgltindakan_ano').value;
          document.getElementById('sc_tgltindakan_jq').value = var_dt_ini;
    },
    onClose: function(dateText, inst) {
          aParts  = dateText.split("/");
          document.getElementById('SC_tgltindakan_dia').value = aParts[0];
          document.getElementById('SC_tgltindakan_mes').value = aParts[1];
          document.getElementById('SC_tgltindakan_ano').value = aParts[2];
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
  ...
  $("#sc_tgltindakan_jq2").datepicker({
    beforeShow: function(input, inst) {
          var_dt_ini  = document.getElementById('SC_tgltindakan_input_2_dia').value + '/';
          var_dt_ini += document.getElementById('SC_tgltindakan_input_2_mes').value + '/';
          var_dt_ini += document.getElementById('SC_tgltindakan_input_2_ano').value;
          document.getElementById('sc_tgltindakan_jq2').value = var_dt_ini;
    },
    onClose: function(dateText, inst) {
          aParts  = dateText.split("/");
          document.getElementById('SC_tgltindakan_input_2_dia').value = aParts[0];
          document.getElementById('SC_tgltindakan_input_2_mes').value = aParts[1];
          document.getElementById('SC_tgltindakan_input_2_ano').value = aParts[2];
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_tgltindakan_cond#NMF#' + search_get_sel_txt('SC_tgltindakan_cond') + '@NMF@';
  str_out += 'SC_tgltindakan_dia#NMF#' + search_get_sel_txt('SC_tgltindakan_dia') + '@NMF@';
  str_out += 'SC_tgltindakan_mes#NMF#' + search_get_sel_txt('SC_tgltindakan_mes') + '@NMF@';
  str_out += 'SC_tgltindakan_ano#NMF#' + search_get_sel_txt('SC_tgltindakan_ano') + '@NMF@';
  str_out += 'SC_tgltindakan_input_2_dia#NMF#' + search_get_sel_txt('SC_tgltindakan_input_2_dia') + '@NMF@';
  str_out += 'SC_tgltindakan_input_2_mes#NMF#' + search_get_sel_txt('SC_tgltindakan_input_2_mes') + '@NMF@';
  str_out += 'SC_tgltindakan_input_2_ano#NMF#' + search_get_sel_txt('SC_tgltindakan_input_2_ano') + '@NMF@';
  str_out += 'SC_dokcode_cond#NMF#' + search_get_sel_txt('SC_dokcode_cond') + '@NMF@';
  str_out += 'SC_dokcode#NMF#' + search_get_selmult('SC_dokcode') + '@NMF@';
  str_out += 'SC_deskripsi_cond#NMF#' + search_get_sel_txt('SC_deskripsi_cond') + '@NMF@';
  str_out += 'SC_deskripsi#NMF#' + search_get_selmult('SC_deskripsi') + '@NMF@';
...
<?php
   ...
   {
      global 
             $tgltindakan_cond, $tgltindakan, $tgltindakan_dia, $tgltindakan_mes, $tgltindakan_ano, $tgltindakan_input_2_dia, $tgltindakan_input_2_mes, $tgltindakan_input_2_ano,
             $dokcode_cond, $dokcode,
             $deskripsi_cond, $deskripsi,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_insentive']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_insentive']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_insentive']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_insentive']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $tgltindakan_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_insentive']['campos_busca']['tgltindakan_dia']; 
          $tgltindakan_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_insentive']['campos_busca']['tgltindakan_mes']; 
          $tgltindakan_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_insentive']['campos_busca']['tgltindakan_ano']; 
          $tgltindakan_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_insentive']['campos_busca']['tgltindakan_input_2_dia']; 
          $tgltindakan_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_insentive']['campos_busca']['tgltindakan_input_2_mes']; 
          $tgltindakan_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_insentive']['campos_busca']['tgltindakan_input_2_ano']; 
          $tgltindakan_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_insentive']['campos_busca']['tgltindakan_cond']; 
          $dokcode = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_insentive']['campos_busca']['dokcode']; 
          $dokcode_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_insentive']['campos_busca']['dokcode_cond']; 
          $deskripsi = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_insentive']['campos_busca']['deskripsi']; 
          $deskripsi_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_insentive']['campos_busca']['deskripsi_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_insentive']['campos_busca']['NM_operador']; 
      } 
      if (!isset($tgltindakan_cond) || empty($tgltindakan_cond))
      {
         $tgltindakan_cond = "bw";
      }
      ...
      $str_hide_tgltindakan = (in_array($tgltindakan_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_dokcode = (in_array($dokcode_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_deskripsi = (in_array($deskripsi_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      $str_display_tgltindakan = ('bw' == $tgltindakan_cond) ? $display_aberto : $display_fechado;
      $str_display_dokcode = ('bw' == $dokcode_cond) ? $display_aberto : $display_fechado;
      $str_display_deskripsi = ('bw' == $deskripsi_cond) ? $display_aberto : $display_fechado;

      // dokcode
      if (is_array($dokcode) && !empty($dokcode))
      {
         $tmp_array = array();
         $dokcode_val_str = "";
         foreach ($dokcode as $tmp_val_cmp)
         {
            if ("" != $dokcode_val_str)
            {
               $dokcode_val_str .= ",";
      ...
      if (is_array($deskripsi) && !empty($deskripsi))
      {
         $tmp_array = array();
         $deskripsi_val_str = "";
         foreach ($deskripsi as $tmp_val_cmp)
         {
            if ("" != $deskripsi_val_str)
            {
               $deskripsi_val_str .= ",";
            }
            $tmp_pos = strpos($tmp_val_cmp, "##@@");
      ...
      if (!isset($tgltindakan) || $tgltindakan == "")
      {
          $tgltindakan = "";
      }
      if (isset($tgltindakan) && !empty($tgltindakan))
      {
         $tmp_pos = strpos($tgltindakan, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $tgltindakan = substr($tgltindakan, 0, $tmp_pos);
         }
      }
      if (!isset($dokcode) || $dokcode == "")
      {
          $dokcode = array();
      }
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_tgltindakan_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['tgltindakan'])) ? $this->New_label['tgltindakan'] : "Tgl Tindakan"; ?></TD>
      
      <INPUT type="hidden" id="SC_tgltindakan_cond" name="tgltindakan_cond" value="bw">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_tgltindakan" <?php echo $str_hide_tgltindakan?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['tgltindakan'])) ? $this->New_label['tgltindakan'] : "Tgl Tindakan";
 $nmgp_tab_label .= "tgltindakan?#?" . $SC_Label . "?@?";
...
<?php
  ...
  {
?>
<span id='id_date_part_tgltindakan_DD' style='display: inline-block'>

         <SELECT class="scFilterObjectOdd" id="SC_tgltindakan_dia" name="tgltindakan_dia">
          <OPTION value=""></OPTION>
          <OPTION value="01" <?php if ("01" == $tgltindakan_dia) { echo "selected"; } ?>>01</OPTION>
          <OPTION value="02" <?php if ("02" == $tgltindakan_dia) { echo "selected"; } ?>>02</OPTION>
          <OPTION value="03" <?php if ("03" == $tgltindakan_dia) { echo "selected"; } ?>>03</OPTION>
          <OPTION value="04" <?php if ("04" == $tgltindakan_dia) { echo "selected"; } ?>>04</OPTION>
          <OPTION value="05" <?php if ("05" == $tgltindakan_dia) { echo "selected"; } ?>>05</OPTION>
          <OPTION value="06" <?php if ("06" == $tgltindakan_dia) { echo "selected"; } ?>>06</OPTION>
          <OPTION value="07" <?php if ("07" == $tgltindakan_dia) { echo "selected"; } ?>>07</OPTION>
          <OPTION value="08" <?php if ("08" == $tgltindakan_dia) { echo "selected"; } ?>>08</OPTION>
          <OPTION value="09" <?php if ("09" == $tgltindakan_dia) { echo "selected"; } ?>>09</OPTION>
          <OPTION value="10" <?php if ("10" == $tgltindakan_dia) { echo "selected"; } ?>>10</OPTION>
          <OPTION value="11" <?php if ("11" == $tgltindakan_dia) { echo "selected"; } ?>>11</OPTION>
          <OPTION value="12" <?php if ("12" == $tgltindakan_dia) { echo "selected"; } ?>>12</OPTION>
          <OPTION value="13" <?php if ("13" == $tgltindakan_dia) { echo "selected"; } ?>>13</OPTION>
          <OPTION value="14" <?php if ("14" == $tgltindakan_dia) { echo "selected"; } ?>>14</OPTION>
          <OPTION value="15" <?php if ("15" == $tgltindakan_dia) { echo "selected"; } ?>>15</OPTION>
          <OPTION value="16" <?php if ("16" == $tgltindakan_dia) { echo "selected"; } ?>>16</OPTION>
          <OPTION value="17" <?php if ("17" == $tgltindakan_dia) { echo "selected"; } ?>>17</OPTION>
          <OPTION value="18" <?php if ("18" == $tgltindakan_dia) { echo "selected"; } ?>>18</OPTION>
          <OPTION value="19" <?php if ("19" == $tgltindakan_dia) { echo "selected"; } ?>>19</OPTION>
          <OPTION value="20" <?php if ("20" == $tgltindakan_dia) { echo "selected"; } ?>>20</OPTION>
          <OPTION value="21" <?php if ("21" == $tgltindakan_dia) { echo "selected"; } ?>>21</OPTION>
          <OPTION value="22" <?php if ("22" == $tgltindakan_dia) { echo "selected"; } ?>>22</OPTION>
          <OPTION value="23" <?php if ("23" == $tgltindakan_dia) { echo "selected"; } ?>>23</OPTION>
          <OPTION value="24" <?php if ("24" == $tgltindakan_dia) { echo "selected"; } ?>>24</OPTION>
          <OPTION value="25" <?php if ("25" == $tgltindakan_dia) { echo "selected"; } ?>>25</OPTION>
          <OPTION value="26" <?php if ("26" == $tgltindakan_dia) { echo "selected"; } ?>>26</OPTION>
          <OPTION value="27" <?php if ("27" == $tgltindakan_dia) { echo "selected"; } ?>>27</OPTION>
          <OPTION value="28" <?php if ("28" == $tgltindakan_dia) { echo "selected"; } ?>>28</OPTION>
          <OPTION value="29" <?php if ("29" == $tgltindakan_dia) { echo "selected"; } ?>>29</OPTION>
          <OPTION value="30" <?php if ("30" == $tgltindakan_dia) { echo "selected"; } ?>>30</OPTION>
          <OPTION value="31" <?php if ("31" == $tgltindakan_dia) { echo "selected"; } ?>>31</OPTION>
         </SELECT>
         </span>
...
<?php
  ...
  {
?>
<span id='id_date_part_tgltindakan_MM' style='display: inline-block'>

         <SELECT class="scFilterObjectOdd" id="SC_tgltindakan_mes" name="tgltindakan_mes">
          <OPTION value=""></OPTION>
          <OPTION value="01" <?php if ("01" == $tgltindakan_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][0] ?></OPTION>
          <OPTION value="02" <?php if ("02" == $tgltindakan_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][1] ?></OPTION>
          <OPTION value="03" <?php if ("03" == $tgltindakan_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][2] ?></OPTION>
          <OPTION value="04" <?php if ("04" == $tgltindakan_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][3] ?></OPTION>
          <OPTION value="05" <?php if ("05" == $tgltindakan_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][4] ?></OPTION>
          <OPTION value="06" <?php if ("06" == $tgltindakan_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][5] ?></OPTION>
          <OPTION value="07" <?php if ("07" == $tgltindakan_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][6] ?></OPTION>
          <OPTION value="08" <?php if ("08" == $tgltindakan_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][7] ?></OPTION>
          <OPTION value="09" <?php if ("09" == $tgltindakan_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][8] ?></OPTION>
          <OPTION value="10" <?php if ("10" == $tgltindakan_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][9] ?></OPTION>
          <OPTION value="11" <?php if ("11" == $tgltindakan_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][10] ?></OPTION>
          <OPTION value="12" <?php if ("12" == $tgltindakan_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][11] ?></OPTION>
         </SELECT>
         </span>
...
<?php
  ...
  {
?>
<span id='id_date_part_tgltindakan_AAAA' style='display: inline-block'>
<select class="scFilterObjectOdd" id="SC_tgltindakan_ano" name="tgltindakan_ano">
  <option value=""></option>
<?php
  $Combo_ano_ini = 1901;
  ...
  {
?>
  <option value="<?php echo $I_ano; ?>"<?php  if ($tgltindakan_ano == $I_ano) { echo " selected" ;} ?>><?php echo $I_ano; ?></option>
<?php
  }
?>
</select>
<INPUT type="hidden" id="sc_tgltindakan_jq">
</span>
...
?>
       ...
       <TR valign="top">
        <TD id="id_vis_tgltindakan"  <?php echo $str_display_tgltindakan; ?> class="scFilterFieldFontOdd">
...
<?php
  ...
  {
?>
<span id='id_date_part_tgltindakan_input_2_DD' style='display: inline-block'>

         <SELECT class="scFilterObjectOdd" id="SC_tgltindakan_input_2_dia" name="tgltindakan_input_2_dia">
          <OPTION value=""></OPTION>
          <OPTION value="01" <?php if ("01" == $tgltindakan_input_2_dia) { echo "selected"; } ?>>01</OPTION>
          <OPTION value="02" <?php if ("02" == $tgltindakan_input_2_dia) { echo "selected"; } ?>>02</OPTION>
          <OPTION value="03" <?php if ("03" == $tgltindakan_input_2_dia) { echo "selected"; } ?>>03</OPTION>
          <OPTION value="04" <?php if ("04" == $tgltindakan_input_2_dia) { echo "selected"; } ?>>04</OPTION>
          <OPTION value="05" <?php if ("05" == $tgltindakan_input_2_dia) { echo "selected"; } ?>>05</OPTION>
          <OPTION value="06" <?php if ("06" == $tgltindakan_input_2_dia) { echo "selected"; } ?>>06</OPTION>
          <OPTION value="07" <?php if ("07" == $tgltindakan_input_2_dia) { echo "selected"; } ?>>07</OPTION>
          <OPTION value="08" <?php if ("08" == $tgltindakan_input_2_dia) { echo "selected"; } ?>>08</OPTION>
          <OPTION value="09" <?php if ("09" == $tgltindakan_input_2_dia) { echo "selected"; } ?>>09</OPTION>
          <OPTION value="10" <?php if ("10" == $tgltindakan_input_2_dia) { echo "selected"; } ?>>10</OPTION>
          <OPTION value="11" <?php if ("11" == $tgltindakan_input_2_dia) { echo "selected"; } ?>>11</OPTION>
          <OPTION value="12" <?php if ("12" == $tgltindakan_input_2_dia) { echo "selected"; } ?>>12</OPTION>
          <OPTION value="13" <?php if ("13" == $tgltindakan_input_2_dia) { echo "selected"; } ?>>13</OPTION>
          <OPTION value="14" <?php if ("14" == $tgltindakan_input_2_dia) { echo "selected"; } ?>>14</OPTION>
          <OPTION value="15" <?php if ("15" == $tgltindakan_input_2_dia) { echo "selected"; } ?>>15</OPTION>
          <OPTION value="16" <?php if ("16" == $tgltindakan_input_2_dia) { echo "selected"; } ?>>16</OPTION>
          <OPTION value="17" <?php if ("17" == $tgltindakan_input_2_dia) { echo "selected"; } ?>>17</OPTION>
          <OPTION value="18" <?php if ("18" == $tgltindakan_input_2_dia) { echo "selected"; } ?>>18</OPTION>
          <OPTION value="19" <?php if ("19" == $tgltindakan_input_2_dia) { echo "selected"; } ?>>19</OPTION>
          <OPTION value="20" <?php if ("20" == $tgltindakan_input_2_dia) { echo "selected"; } ?>>20</OPTION>
          <OPTION value="21" <?php if ("21" == $tgltindakan_input_2_dia) { echo "selected"; } ?>>21</OPTION>
          <OPTION value="22" <?php if ("22" == $tgltindakan_input_2_dia) { echo "selected"; } ?>>22</OPTION>
          <OPTION value="23" <?php if ("23" == $tgltindakan_input_2_dia) { echo "selected"; } ?>>23</OPTION>
          <OPTION value="24" <?php if ("24" == $tgltindakan_input_2_dia) { echo "selected"; } ?>>24</OPTION>
          <OPTION value="25" <?php if ("25" == $tgltindakan_input_2_dia) { echo "selected"; } ?>>25</OPTION>
          <OPTION value="26" <?php if ("26" == $tgltindakan_input_2_dia) { echo "selected"; } ?>>26</OPTION>
          <OPTION value="27" <?php if ("27" == $tgltindakan_input_2_dia) { echo "selected"; } ?>>27</OPTION>
          <OPTION value="28" <?php if ("28" == $tgltindakan_input_2_dia) { echo "selected"; } ?>>28</OPTION>
          <OPTION value="29" <?php if ("29" == $tgltindakan_input_2_dia) { echo "selected"; } ?>>29</OPTION>
          <OPTION value="30" <?php if ("30" == $tgltindakan_input_2_dia) { echo "selected"; } ?>>30</OPTION>
          <OPTION value="31" <?php if ("31" == $tgltindakan_input_2_dia) { echo "selected"; } ?>>31</OPTION>
         </SELECT>
         </span>
...
<?php
  ...
  {
?>
<span id='id_date_part_tgltindakan_input_2_MM' style='display: inline-block'>

         <SELECT class="scFilterObjectOdd" id="SC_tgltindakan_input_2_mes" name="tgltindakan_input_2_mes">
          <OPTION value=""></OPTION>
          <OPTION value="01" <?php if ("01" == $tgltindakan_input_2_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][0] ?></OPTION>
          <OPTION value="02" <?php if ("02" == $tgltindakan_input_2_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][1] ?></OPTION>
          <OPTION value="03" <?php if ("03" == $tgltindakan_input_2_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][2] ?></OPTION>
          <OPTION value="04" <?php if ("04" == $tgltindakan_input_2_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][3] ?></OPTION>
          <OPTION value="05" <?php if ("05" == $tgltindakan_input_2_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][4] ?></OPTION>
          <OPTION value="06" <?php if ("06" == $tgltindakan_input_2_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][5] ?></OPTION>
          <OPTION value="07" <?php if ("07" == $tgltindakan_input_2_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][6] ?></OPTION>
          <OPTION value="08" <?php if ("08" == $tgltindakan_input_2_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][7] ?></OPTION>
          <OPTION value="09" <?php if ("09" == $tgltindakan_input_2_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][8] ?></OPTION>
          <OPTION value="10" <?php if ("10" == $tgltindakan_input_2_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][9] ?></OPTION>
          <OPTION value="11" <?php if ("11" == $tgltindakan_input_2_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][10] ?></OPTION>
          <OPTION value="12" <?php if ("12" == $tgltindakan_input_2_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][11] ?></OPTION>
         </SELECT>
         </span>
...
<?php
  ...
  {
?>
<span id='id_date_part_tgltindakan_input_2_AAAA' style='display: inline-block'>
<select class="scFilterObjectOdd" id="SC_tgltindakan_input_2_ano" name="tgltindakan_input_2_ano">
  <option value=""></option>
<?php
  $Combo_ano_ini = 1901;
  $Combo_ano_end = date('Y') + 10;
  ...
  {
?>
  <option value="<?php echo $I_ano; ?>"<?php  if ($tgltindakan_input_2_ano == $I_ano) { echo " selected" ;} ?>><?php echo $I_ano; ?></option>
<?php
  }
?>
</select>
<INPUT type="hidden" id="sc_tgltindakan_jq2">
</span>
...
?>
      ...
      <TD id='SC_dokcode_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['dokcode'])) ? $this->New_label['dokcode'] : "Dokter"; ?></TD>
      
      <INPUT type="hidden" id="SC_dokcode_cond" name="dokcode_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_dokcode" <?php echo $str_hide_dokcode?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['dokcode'])) ? $this->New_label['dokcode'] : "Dokter";
 $nmgp_tab_label .= "dokcode?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      $dokcode_look = substr($this->Db->qstr($dokcode), 1, -1); 
      $nmgp_def_dados = "" ; 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      { 
          $nm_comando = "SELECT gelar + name + ', ' + spec  FROM tbdoctor  ORDER BY gelar, name, spec" ; 
      } 
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
      { 
          $nm_comando = "SELECT concat(gelar, name,', ', spec)  FROM tbdoctor  ORDER BY gelar, name, spec" ; 
      } 
      ...
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_insentive']['psq_check_ret']['dokcode'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_insentive']['psq_check_ret']['dokcode'][] = trim($rs->fields[0]);
...
?>
   <span id="idAjaxSelect_dokcode">
      <SELECT class="scFilterObjectOdd" id="SC_dokcode" name="dokcode[]"  size="1" multiple>
       <OPTION value=""></OPTION>
<?php
      ...
      foreach ($nm_opcoes as $nm_opcao)
      {
         if (!empty($nm_opcao))
         {
            ...
            {
               $dokcode_sel = "";
               foreach ($dokcode as $Dados)
               {
                   if ($Dados === $nm_opc_cod)
                   {
                       $dokcode_sel = "selected";
                       break;
                   }
               }
            }
            ...
            {
               $dokcode_sel = ("S" == $nm_opc_sel) ? "selected" : "";
            }
            $nm_sc_valor = $nm_opc_val;
            $nm_opc_val = $nm_sc_valor;
?>
       <OPTION value="<?php echo NM_encode_input($nm_opc_cod . $delimitador . $nm_opc_val); ?>" <?php echo $dokcode_sel; ?>><?php echo $nm_opc_val; ?></OPTION>
<?php
         }
      }
?>
...
?>
      ...
      <INPUT type="hidden" id="SC_deskripsi_cond" name="deskripsi_cond" value="eq">
...
<?php
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_insentive']['psq_check_ret']['deskripsi'] = array();
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_insentive']['psq_check_ret']['deskripsi'][] = "Tind. Poli";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_insentive']['psq_check_ret']['deskripsi'][] = "Visite Ranap";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_insentive']['psq_check_ret']['deskripsi'][] = "Tind. OK";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_insentive']['psq_check_ret']['deskripsi'][] = "Tind. VK";
 ?>
<?php if (!isset($deskripsi)) {$deskripsi = explode(";", $deskripsi);} ?>
 <SELECT class="scFilterObjectOdd" id="SC_deskripsi" name="deskripsi[]"  size="1" multiple>
 <OPTION value="Tind. Poli##@@Tind. Poli" <?php if (in_array("Tind. Poli", $deskripsi)) { echo " selected" ;} ?>>Tind. Poli</option>
 <OPTION value="Visite Ranap##@@Visite Ranap" <?php if (in_array("Visite Ranap", $deskripsi)) { echo " selected" ;} ?>>Visite Ranap</option>
 <OPTION value="Tind. OK##@@Tind. OK" <?php if (in_array("Tind. OK", $deskripsi)) { echo " selected" ;} ?>>Tind. OK</option>
 <OPTION value="Tind. VK##@@Tind. VK" <?php if (in_array("Tind. VK", $deskripsi)) { echo " selected" ;} ?>>Tind. VK</option>
 </SELECT>
...
?>
<?php
   if (is_file("grid_insentive_help.txt"))
   {
...
?>
<?php
   if ($nm_apl_dependente == 1 || (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_insentive']['opc_psq'] && !$this->aba_iframe))
   {
...
<?php
       ...
       elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_insentive']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_insentive']['dashboard_info']['under_dashboard'])
       { }
       else 
       { 
?>
...
<?php
   ...
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_insentive']['opc_psq'])
   {
...
<?php
    if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_insentive']['prim_vez'] == "N") 
    {
?>
       <iframe id="nmsc_iframe_grid_insentive" frameborder="0" marginwidth="0px" marginheight="0px" topmargin="0px" leftmargin="0px" align="center" height="1500px" name="nm_iframe_grid_insentive" scrolling="auto" src="index.php?nmgp_opcao=pesq&script_case_init=<?php echo NM_encode_input($this->Ini->sc_page) ?>&script_case_session=<?php echo session_id() ?>" width="100%"></iframe>
<?php
    }
    else
    {
?>
       <iframe id="nmsc_iframe_grid_insentive" frameborder="0" marginwidth="0px" marginheight="0px" topmargin="0px" leftmargin="0px" align="center" height="1500px" name="nm_iframe_grid_insentive" scrolling="auto" src="" width="100%"></iframe>
<?php
    }
?>
<iframe id="nmsc_iframe_grid_insentive_pesq"  name="nm_iframe_grid_insentive_pesq" style= "display: none;" frameborder="0" marginwidth="0px" marginheight="0px" topmargin="0px" leftmargin="0px" src=""></iframe>
</td></tr></table></td></tr>
</TABLE>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_insentive']['orig_pesq'] == "grid")
   {
...
?>
 ...
 {
    document.F1.target = "nm_iframe_grid_insentive_pesq";
    document.F1.submit();
 }
 function nm_move()
 {
     document.getElementById('nmsc_iframe_grid_insentive').contentWindow.nm_move('igual');
 }
 function limpa_form()
 {
   document.F1.reset();
   ...
   document.F1.tgltindakan_cond.value = 'bw';
   nm_campos_between(document.getElementById('id_vis_tgltindakan'), document.F1.tgltindakan_cond, 'tgltindakan');
   document.F1.tgltindakan_dia.value = "";
   document.F1.tgltindakan_mes.value = "";
   document.F1.tgltindakan_ano.value = "";
   document.F1.tgltindakan_input_2_dia.value = "";
   document.F1.tgltindakan_input_2_mes.value = "";
   document.F1.tgltindakan_input_2_ano.value = "";
   nm_campos_between(document.getElementById('id_vis_dokcode'), document.F1.dokcode_cond, 'dokcode');
   for (i = 0; i < document.F1.elements.length; i++)
   {
      if (document.F1.elements[i].name == 'dokcode[]')
      {
   ...
   for (i = 0; i < document.F1.elements.length; i++)
   {
      if (document.F1.elements[i].name == 'deskripsi[]')
      {
          while (document.F1.elements[i].selectedIndex != -1)
          {
              aa = document.F1.elements[i].selectedIndex;
 ...
 {
    if (Field == 'all' || Field == 'dokcode') {
       Sc_carga_select2_dokcode();
    }
    if (Field == 'all' || Field == 'deskripsi') {
       Sc_carga_select2_deskripsi();
    }
 }
 function Sc_carga_select2_dokcode()
 {
  $("#SC_dokcode").select2(
    {
      language: {
 ...
 function Sc_carga_select2_deskripsi()
 {
  $("#SC_deskripsi").select2(
    {
      language: {
        noResults: function() {
          return "<?php echo $this->Ini->Nm_lang['lang_autocomp_notfound'] ?>";
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "simrskreatifmedia/grid_insentive";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_insentive']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_insentive']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_insentive']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_tgltindakan_cond'] = 'cond';
      $tp_fields['SC_tgltindakan_dia'] = 'text';
      $tp_fields['SC_tgltindakan_mes'] = 'text';
      $tp_fields['SC_tgltindakan_ano'] = 'text';
      $tp_fields['SC_tgltindakan_input_2_dia'] = 'text';
      $tp_fields['SC_tgltindakan_input_2_mes'] = 'text';
      $tp_fields['SC_tgltindakan_input_2_ano'] = 'text';
      $tp_fields['SC_dokcode_cond'] = 'cond';
      $tp_fields['SC_dokcode'] = 'selmult';
      $tp_fields['SC_deskripsi_cond'] = 'cond';
      $tp_fields['SC_deskripsi'] = 'selmult';
   ...
   function trata_campos()
   {
      global $tgltindakan_cond, $tgltindakan, $tgltindakan_dia, $tgltindakan_mes, $tgltindakan_ano, $tgltindakan_input_2_dia, $tgltindakan_input_2_mes, $tgltindakan_input_2_ano,
             $dokcode_cond, $dokcode,
             $deskripsi_cond, $deskripsi, $nmgp_tab_label;

      $C_formatado = true;
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_conv_dados.php", "F", "nm_conv_limpa_dado") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
      $tgltindakan_cond_salva = $tgltindakan_cond; 
      if (!isset($tgltindakan_input_2_dia) || $tgltindakan_input_2_dia == "")
      {
          $tgltindakan_input_2_dia = $tgltindakan_dia;
      }
      if (!isset($tgltindakan_input_2_mes) || $tgltindakan_input_2_mes == "")
      {
          $tgltindakan_input_2_mes = $tgltindakan_mes;
      }
      if (!isset($tgltindakan_input_2_ano) || $tgltindakan_input_2_ano == "")
      {
          $tgltindakan_input_2_ano = $tgltindakan_ano;
      }
      $dokcode_cond_salva = $dokcode_cond; 
      if (!isset($dokcode_input_2) || $dokcode_input_2 == "")
      {
          $dokcode_input_2 = $dokcode;
      }
      ...
      if (is_array($dokcode)) {
          foreach ($dokcode as $I => $Val) {
              ...
              if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && trim($L_lookup) != '' && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_insentive']['psq_check_ret']['dokcode'])) {
      ...
      if (is_array($deskripsi)) {
          foreach ($deskripsi as $I => $Val) {
              ...
              if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && trim($L_lookup) != '' && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_insentive']['psq_check_ret']['deskripsi'])) {
                  if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "Deskripsi : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
                  break;
              }
          }
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_insentive']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_insentive']['campos_busca']['tgltindakan_dia'] = $tgltindakan_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_insentive']['campos_busca']['tgltindakan_mes'] = $tgltindakan_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_insentive']['campos_busca']['tgltindakan_ano'] = $tgltindakan_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_insentive']['campos_busca']['tgltindakan_input_2_dia'] = $tgltindakan_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_insentive']['campos_busca']['tgltindakan_input_2_mes'] = $tgltindakan_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_insentive']['campos_busca']['tgltindakan_input_2_ano'] = $tgltindakan_input_2_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_insentive']['campos_busca']['tgltindakan_cond'] = $tgltindakan_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_insentive']['campos_busca']['dokcode'] = $dokcode; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_insentive']['campos_busca']['dokcode_cond'] = $dokcode_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_insentive']['campos_busca']['deskripsi'] = $deskripsi; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_insentive']['campos_busca']['deskripsi_cond'] = $deskripsi_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_insentive']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_insentive']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      }
      $this->cmp_formatado['dokcode'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_insentive']['campos_busca']['dokcode'];
      $this->cmp_formatado['dokcode_input_2'] = $dokcode_input_2;
      $this->cmp_formatado['deskripsi'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_insentive']['campos_busca']['deskripsi'];
      $this->cmp_formatado['deskripsi_input_2'] = $deskripsi_input_2;

      //----- $tgltindakan
      $this->Date_part = false;
      if ($tgltindakan_cond != "bi_TP")
      {
          $tgltindakan_cond = strtoupper($tgltindakan_cond);
          $Dtxt = "";
          $val  = array();
          $Dtxt .= $tgltindakan_ano;
          $Dtxt .= $tgltindakan_mes;
          $Dtxt .= $tgltindakan_dia;
          $val[0]['ano'] = $tgltindakan_ano;
          $val[0]['mes'] = $tgltindakan_mes;
          $val[0]['dia'] = $tgltindakan_dia;
          if ($tgltindakan_cond == "BW")
          {
              $val[1]['ano'] = $tgltindakan_input_2_ano;
              $val[1]['mes'] = $tgltindakan_input_2_mes;
              $val[1]['dia'] = $tgltindakan_input_2_dia;
          }
          $this->Operador_date_part = "";
          $this->Lang_date_part     = "";
          $this->nm_prep_date($val, "DT", "DATETIME", $tgltindakan_cond, "", "data");
          if (!$this->Date_part) {
              $val[0] = $this->Ini->sc_Date_Protect($val[0]);
          }
          $tgltindakan = $val[0];
          $this->cmp_formatado['tgltindakan'] = $val[0];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_insentive']['campos_busca']['tgltindakan'] = $val[0];
          $this->nm_data->SetaData($this->cmp_formatado['tgltindakan'], "YYYY-MM-DD HH:II:SS");
          $this->cmp_formatado['tgltindakan'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DH", "dmY"));
          if ($tgltindakan_cond == "BW")
          {
              if (!$this->Date_part) {
                  $val[1] = $this->Ini->sc_Date_Protect($val[1]);
              }
              $tgltindakan_input_2     = $val[1];
              $this->cmp_formatado['tgltindakan_input_2'] = $val[1];
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_insentive']['campos_busca']['tgltindakan_input_2'] = $val[1];
              $this->nm_data->SetaData($this->cmp_formatado['tgltindakan_input_2'], "YYYY-MM-DD HH:II:SS");
              $this->cmp_formatado['tgltindakan_input_2'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DH", "dmY"));
          }
          if (!empty($Dtxt) || $tgltindakan_cond == "NU" || $tgltindakan_cond == "NN"|| $tgltindakan_cond == "EP"|| $tgltindakan_cond == "NE")
          {
              $this->monta_condicao("tglTindakan", $tgltindakan_cond, $tgltindakan, $tgltindakan_input_2, 'tgltindakan', 'DATETIME');
          }
      }
      ...
      $this->Date_part = false;
      $nm_aspas = "'";
      if ($dokcode_cond == "nu" || $dokcode_cond == "nn" || $dokcode_cond == "ep" || $dokcode_cond == "ne")
      {
          $dokcode = array();
      }
      if (is_array($dokcode) && count($dokcode) != 0)
      {
         foreach ($dokcode as $i => $dados)
         {
      ...
      {
         $this->and_or();
         if ($dokcode_cond == "df" || $dokcode_cond == "np")
         {
             $this->comando        .= " dokCode not in (";
             $this->comando_sum    .= " .dokCode not in (";
             $this->comando_filtro .= " dokCode not in (";
         }
         else
         {
             $this->comando        .= " dokCode in (";
             $this->comando_sum    .= " .dokCode in (";
             $this->comando_filtro .= " dokCode in (";
         }
         $x                     = count($dokcode);
         $xx                    = 0;
         $nm_cond               = "";
         ...
         $Lang_descr_final = isset($Lang_descr[$dokcode_cond]) ? $Lang_descr[$dokcode_cond] : $this->Ini->Nm_lang['lang_srch_like'];
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_insentive']['cond_pesq'] .= $nmgp_tab_label['dokcode'] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
      }
      elseif (isset($dokcode) || $dokcode_cond == "nu" || $dokcode_cond == "nn" || $dokcode_cond == "ep" || $dokcode_cond == "ne")
      {
         $this->monta_condicao("dokCode", $dokcode_cond, $dokcode, "", "dokcode");
      }

      //----- $deskripsi
      $this->Date_part = false;
      $nm_aspas = "'";
      if ($deskripsi_cond == "nu" || $deskripsi_cond == "nn" || $deskripsi_cond == "ep" || $deskripsi_cond == "ne")
      {
          $deskripsi = array();
      }
      if (is_array($deskripsi) && count($deskripsi) != 0)
      {
         foreach ($deskripsi as $i => $dados)
         {
            $tmp_pos = strpos($dados, "##@@");
            if (($tmp_pos === false && $dados == "") || $tmp_pos == 0)
            {
      ...
      {
         $this->and_or();
         if ($deskripsi_cond == "df" || $deskripsi_cond == "np")
         {
             $this->comando        .= " Deskripsi not in (";
             $this->comando_sum    .= " .Deskripsi not in (";
             $this->comando_filtro .= " Deskripsi not in (";
         }
         else
         {
             $this->comando        .= " Deskripsi in (";
             $this->comando_sum    .= " .Deskripsi in (";
             $this->comando_filtro .= " Deskripsi in (";
         }
         $x                     = count($deskripsi);
         $xx                    = 0;
         $nm_cond               = "";
         ...
         $Lang_descr['df'] = $this->Ini->Nm_lang['lang_srch_diff'];
         $Lang_descr['np'] = $this->Ini->Nm_lang['lang_srch_not_like'];
         $Lang_descr_final = isset($Lang_descr[$deskripsi_cond]) ? $Lang_descr[$deskripsi_cond] : $this->Ini->Nm_lang['lang_srch_like'];
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_insentive']['cond_pesq'] .= $nmgp_tab_label['deskripsi'] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
      }
      elseif (isset($deskripsi) || $deskripsi_cond == "nu" || $deskripsi_cond == "nn" || $deskripsi_cond == "ep" || $deskripsi_cond == "ne")
      {
   ...
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_insentive']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_insentive']['cond_dyn_search'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_insentive']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_insentive']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_insentive']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_insentive']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_insentive']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_insentive']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_insentive']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_insentive']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_insentive']['cond_pesq'] .= $this->NM_operador;
   ...
   function css_obj_select_ajax($Obj)
   {
      switch ($Obj)
      {
         case "dokcode" : return ('class="scFilterObjectOdd"'); break;
         default       : return ("");
      }
   }
