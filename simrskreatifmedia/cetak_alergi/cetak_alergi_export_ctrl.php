<?php
@session_start() ;
$_SESSION['scriptcase']['cetak_alergi']['sc_process_barr'] = true;
require_once('../cetak_alergi/index.php');
unset($_SESSION['scriptcase']['cetak_alergi']['sc_process_barr']);
$ExportCtrl = new cetak_alergi_export_control;
$ExportCtrl->Export_barr();

class cetak_alergi_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_chart_titl'] ?> - tbalergi :: Excel</TITLE>
