  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbdiagnosarawatinap" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbdiagnosarawatinap_form();
	}

  // ---------- Validate kodeicdx_
  function do_ajax_form_tbdiagnosarawatinap_validate_kodeicdx_(iNumLinha)
  {
    var nomeCampo_kodeicdx_ = "kodeicdx_" + iNumLinha;
    var var_kodeicdx_ = scAjaxGetFieldSelect(nomeCampo_kodeicdx_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdiagnosarawatinap_validate_kodeicdx_(var_kodeicdx_, iNumLinha, var_script_case_init, do_ajax_form_tbdiagnosarawatinap_validate_kodeicdx__cb);
  } // do_ajax_form_tbdiagnosarawatinap_validate_kodeicdx_

  function do_ajax_form_tbdiagnosarawatinap_validate_kodeicdx__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdiagnosarawatinap_validate_kodeicdx__cb

  // ---------- Validate namadiagnosa_
  function do_ajax_form_tbdiagnosarawatinap_validate_namadiagnosa_(iNumLinha)
  {
  } // do_ajax_form_tbdiagnosarawatinap_validate_namadiagnosa_

  function do_ajax_form_tbdiagnosarawatinap_validate_namadiagnosa__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdiagnosarawatinap_validate_namadiagnosa__cb

  // ---------- Validate jenisdiagnosa_
  function do_ajax_form_tbdiagnosarawatinap_validate_jenisdiagnosa_(iNumLinha)
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdiagnosarawatinap_validate_jenisdiagnosa_(var_jenisdiagnosa_, iNumLinha, var_script_case_init, do_ajax_form_tbdiagnosarawatinap_validate_jenisdiagnosa__cb);
  } // do_ajax_form_tbdiagnosarawatinap_validate_jenisdiagnosa_

  function do_ajax_form_tbdiagnosarawatinap_validate_jenisdiagnosa__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdiagnosarawatinap_validate_jenisdiagnosa__cb

  // ---------- Validate keterangan_
  function do_ajax_form_tbdiagnosarawatinap_validate_keterangan_(iNumLinha)
  {
    var nomeCampo_keterangan_ = "keterangan_" + iNumLinha;
    var var_keterangan_ = scAjaxGetFieldText(nomeCampo_keterangan_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdiagnosarawatinap_validate_keterangan_(var_keterangan_, iNumLinha, var_script_case_init, do_ajax_form_tbdiagnosarawatinap_validate_keterangan__cb);
  } // do_ajax_form_tbdiagnosarawatinap_validate_keterangan_

  function do_ajax_form_tbdiagnosarawatinap_validate_keterangan__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdiagnosarawatinap_validate_keterangan__cb

  // ---------- Validate tgldiagnosa_
  function do_ajax_form_tbdiagnosarawatinap_validate_tgldiagnosa_(iNumLinha)
  {
    var nomeCampo_tgldiagnosa_ = "tgldiagnosa_" + iNumLinha;
    var var_tgldiagnosa_ = scAjaxGetFieldText(nomeCampo_tgldiagnosa_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdiagnosarawatinap_validate_tgldiagnosa_(var_tgldiagnosa_, iNumLinha, var_script_case_init, do_ajax_form_tbdiagnosarawatinap_validate_tgldiagnosa__cb);
  } // do_ajax_form_tbdiagnosarawatinap_validate_tgldiagnosa_

  function do_ajax_form_tbdiagnosarawatinap_validate_tgldiagnosa__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdiagnosarawatinap_validate_tgldiagnosa__cb

  // ---------- Validate trancode_
  function do_ajax_form_tbdiagnosarawatinap_validate_trancode_(iNumLinha)
  {
    var nomeCampo_trancode_ = "trancode_" + iNumLinha;
    var var_trancode_ = scAjaxGetFieldText(nomeCampo_trancode_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdiagnosarawatinap_validate_trancode_(var_trancode_, iNumLinha, var_script_case_init, do_ajax_form_tbdiagnosarawatinap_validate_trancode__cb);
  } // do_ajax_form_tbdiagnosarawatinap_validate_trancode_

  function do_ajax_form_tbdiagnosarawatinap_validate_trancode__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdiagnosarawatinap_validate_trancode__cb

  // ---------- Refresh namadiagnosa_
  function do_ajax_form_tbdiagnosarawatinap_refresh_namadiagnosa_(iSeqForm)
  {
    ...
    scAjaxProcOn(true);
    x_ajax_form_tbdiagnosarawatinap_refresh_namadiagnosa_(var_namadiagnosa_, var_nmgp_refresh_row, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_tbdiagnosarawatinap_refresh_namadiagnosa__cb);
  } // do_ajax_form_tbdiagnosarawatinap_refresh_namadiagnosa_

  function do_ajax_form_tbdiagnosarawatinap_refresh_namadiagnosa__cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdiagnosarawatinap_refresh_namadiagnosa__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_tbdiagnosarawatinap_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_tbdiagnosarawatinap_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tbdiagnosarawatinap_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_tbdiagnosarawatinap_add_new_line_cb);
  } // do_ajax_form_tbdiagnosarawatinap_add_new_line

  function do_ajax_form_tbdiagnosarawatinap_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
    ...
    nm_field_disabled("tgldiagnosa_=disabled", "", iAjaxNewLine);
  } // do_ajax_form_tbdiagnosarawatinap_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_tbdiagnosarawatinap_backup_line(iNumLinha)
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdiagnosarawatinap_backup_line(var_trancode_, var_jenisdiagnosa_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_tbdiagnosarawatinap_backup_line_cb);
  } // do_ajax_form_tbdiagnosarawatinap_backup_line

  function do_ajax_form_tbdiagnosarawatinap_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_tbdiagnosarawatinap_backup_line_cb

  function do_ajax_form_tbdiagnosarawatinap_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_tbdiagnosarawatinap_cancel_insert

  function do_ajax_form_tbdiagnosarawatinap_cancel_update(iSeqVert)
  {
    do_ajax_form_tbdiagnosarawatinap_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_tbdiagnosarawatinap_cancel_update

  function do_ajax_form_tbdiagnosarawatinap_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_tbdiagnosarawatinap_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_tbdiagnosarawatinap_table_refresh()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tbdiagnosarawatinap_table_refresh(var_trancode_, var_jenisdiagnosa_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbdiagnosarawatinap_table_refresh_cb);
  } //  do_ajax_form_tbdiagnosarawatinap_table_refresh

  function do_ajax_form_tbdiagnosarawatinap_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_tbdiagnosarawatinap_table_refresh_cb_after_alert);
  } // do_ajax_form_tbdiagnosarawatinap_table_refresh_cb
  function do_ajax_form_tbdiagnosarawatinap_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxSetNavStatus("t");
    sc_insert_open = false;
  } // do_ajax_form_tbdiagnosarawatinap_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_tbdiagnosarawatinap_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_tbdiagnosarawatinap_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
...
?>
    x_ajax_form_tbdiagnosarawatinap_submit_form(var_kodeicdx_, var_namadiagnosa_, var_jenisdiagnosa_, var_keterangan_, var_tgldiagnosa_, var_trancode_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbdiagnosarawatinap_submit_form_cb);
  } // do_ajax_form_tbdiagnosarawatinap_submit_form

  function do_ajax_form_tbdiagnosarawatinap_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_tbdiagnosarawatinap_submit_form_cb_after_alert);
  } // do_ajax_form_tbdiagnosarawatinap_submit_form_cb
  function do_ajax_form_tbdiagnosarawatinap_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbdiagnosarawatinap_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tbdiagnosarawatinap_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_tbdiagnosarawatinap_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tbdiagnosarawatinap_navigate_form(var_trancode_, var_jenisdiagnosa_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbdiagnosarawatinap_navigate_form_cb);
  } // do_ajax_form_tbdiagnosarawatinap_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdiagnosarawatinap']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbdiagnosarawatinap_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbdiagnosarawatinap_navigate_form_cb_after_alert);
  } // do_ajax_form_tbdiagnosarawatinap_navigate_form_cb
  function do_ajax_form_tbdiagnosarawatinap_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_tbdiagnosarawatinap_navigate_form_cb_after_alert
  function sc_hide_form_tbdiagnosarawatinap_form()
  {
