...
$old_error_handler = set_error_handler("form_tbdiagnosarawatinap_scriptcase_error_handler");

function form_tbdiagnosarawatinap_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['form_tbdiagnosarawatinap']['contr_erro']) && $_SESSION['scriptcase']['form_tbdiagnosarawatinap']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_form_tbdiagnosarawatinap->contr_form_tbdiagnosarawatinap->Apl_com_erro = true;
            if ($inicial_form_tbdiagnosarawatinap->contr_form_tbdiagnosarawatinap->NM_ajax_flag)
            {
                $inicial_form_tbdiagnosarawatinap->contr_form_tbdiagnosarawatinap->NM_ajax_info['errList']['geral_form_tbdiagnosarawatinap'][] = $msg;
                return;
            }
            form_tbdiagnosarawatinap_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function form_tbdiagnosarawatinap_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['form_tbdiagnosarawatinap'])  && '' != $_SESSION['scriptcase']['error_icon']['form_tbdiagnosarawatinap'])  ? $_SESSION['scriptcase']['error_icon']['form_tbdiagnosarawatinap']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['form_tbdiagnosarawatinap']) && '' != $_SESSION['scriptcase']['error_span_title']['form_tbdiagnosarawatinap']) ? $_SESSION['scriptcase']['error_span_title']['form_tbdiagnosarawatinap'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['form_tbdiagnosarawatinap']) && '' != $_SESSION['scriptcase']['error_icon_title']['form_tbdiagnosarawatinap']) ? $_SESSION['scriptcase']['error_icon_title']['form_tbdiagnosarawatinap'] : '';
?>
...
<?php
    ...
    $_SESSION['scriptcase']['form_tbdiagnosarawatinap']['error_buffer'] .= ob_get_flush();
}
