  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_hrm_user_presensi_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_hrm_user_presensi_mob_form();
	}

  // ---------- Validate id
  function do_ajax_form_hrm_user_presensi_mob_validate_id()
  {
    var nomeCampo_id = "id";
    var var_id = scAjaxGetFieldHidden(nomeCampo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_user_presensi_mob_validate_id(var_id, var_script_case_init, do_ajax_form_hrm_user_presensi_mob_validate_id_cb);
  } // do_ajax_form_hrm_user_presensi_mob_validate_id

  function do_ajax_form_hrm_user_presensi_mob_validate_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_user_presensi_mob_validate_id_cb

  // ---------- Validate id_presensi
  function do_ajax_form_hrm_user_presensi_mob_validate_id_presensi()
  {
    var nomeCampo_id_presensi = "id_presensi";
    var var_id_presensi = scAjaxGetFieldText(nomeCampo_id_presensi);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_user_presensi_mob_validate_id_presensi(var_id_presensi, var_script_case_init, do_ajax_form_hrm_user_presensi_mob_validate_id_presensi_cb);
  } // do_ajax_form_hrm_user_presensi_mob_validate_id_presensi

  function do_ajax_form_hrm_user_presensi_mob_validate_id_presensi_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_user_presensi_mob_validate_id_presensi_cb

  // ---------- Validate user_name
  function do_ajax_form_hrm_user_presensi_mob_validate_user_name()
  {
    var nomeCampo_user_name = "user_name";
    var var_user_name = scAjaxGetFieldText(nomeCampo_user_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_user_presensi_mob_validate_user_name(var_user_name, var_script_case_init, do_ajax_form_hrm_user_presensi_mob_validate_user_name_cb);
  } // do_ajax_form_hrm_user_presensi_mob_validate_user_name

  function do_ajax_form_hrm_user_presensi_mob_validate_user_name_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_user_presensi_mob_validate_user_name_cb

  // ---------- Validate privilege
  function do_ajax_form_hrm_user_presensi_mob_validate_privilege()
  {
    var nomeCampo_privilege = "privilege";
    var var_privilege = scAjaxGetFieldText(nomeCampo_privilege);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_user_presensi_mob_validate_privilege(var_privilege, var_script_case_init, do_ajax_form_hrm_user_presensi_mob_validate_privilege_cb);
  } // do_ajax_form_hrm_user_presensi_mob_validate_privilege

  function do_ajax_form_hrm_user_presensi_mob_validate_privilege_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "privilege";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_user_presensi_mob_validate_privilege_cb

  // ---------- Validate id_mesin
  function do_ajax_form_hrm_user_presensi_mob_validate_id_mesin()
  {
    var nomeCampo_id_mesin = "id_mesin";
    var var_id_mesin = scAjaxGetFieldText(nomeCampo_id_mesin);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_user_presensi_mob_validate_id_mesin(var_id_mesin, var_script_case_init, do_ajax_form_hrm_user_presensi_mob_validate_id_mesin_cb);
  } // do_ajax_form_hrm_user_presensi_mob_validate_id_mesin

  function do_ajax_form_hrm_user_presensi_mob_validate_id_mesin_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id_mesin";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_user_presensi_mob_validate_id_mesin_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_hrm_user_presensi_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_hrm_user_presensi_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    var var_privilege = scAjaxGetFieldText("privilege");
    var var_id_mesin = scAjaxGetFieldText("id_mesin");
    ...
    scAjaxProcOn();
    x_ajax_form_hrm_user_presensi_mob_submit_form(var_id, var_id_presensi, var_user_name, var_privilege, var_id_mesin, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_hrm_user_presensi_mob_submit_form_cb);
  } // do_ajax_form_hrm_user_presensi_mob_submit_form

  function do_ajax_form_hrm_user_presensi_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("privilege");
      scAjaxHideErrorDisplay("id_mesin");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_hrm_user_presensi_mob_submit_form_cb_after_alert);
  } // do_ajax_form_hrm_user_presensi_mob_submit_form_cb
  function do_ajax_form_hrm_user_presensi_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_hrm_user_presensi_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_hrm_user_presensi_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_hrm_user_presensi_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_hrm_user_presensi_mob_navigate_form_cb);
  } // do_ajax_form_hrm_user_presensi_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_hrm_user_presensi_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_hrm_user_presensi_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_hrm_user_presensi_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_hrm_user_presensi_mob_navigate_form_cb
  function do_ajax_form_hrm_user_presensi_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_hrm_user_presensi_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_hrm_user_presensi_mob_navigate_form_cb_after_alert
  function sc_hide_form_hrm_user_presensi_mob_form()
  {
  ...
  ajax_field_list[1] = "id_presensi";
  ajax_field_list[2] = "user_name";
  ajax_field_list[3] = "privilege";
  ajax_field_list[4] = "id_mesin";
  ...
  var ajax_error_list = {
    ...
    "user_name": {"label": "User Name", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "privilege": {"label": "Privilege", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "id_mesin": {"label": "Id Mesin", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  ajax_field_mult["privilege"][1] = "privilege";
  ajax_field_mult["id_mesin"][1] = "id_mesin";
  ...
  var ajax_field_id = {
    ...
    "privilege": new Array("hidden_field_label_privilege", "hidden_field_data_privilege"),
    "id_mesin": new Array("hidden_field_label_id_mesin", "hidden_field_data_id_mesin")
  };
