  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_hrm_user_presensi" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_hrm_user_presensi_form();
	}

  // ---------- Validate id
  function do_ajax_form_hrm_user_presensi_validate_id()
  {
    var nomeCampo_id = "id";
    var var_id = scAjaxGetFieldHidden(nomeCampo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_user_presensi_validate_id(var_id, var_script_case_init, do_ajax_form_hrm_user_presensi_validate_id_cb);
  } // do_ajax_form_hrm_user_presensi_validate_id

  function do_ajax_form_hrm_user_presensi_validate_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_user_presensi_validate_id_cb

  // ---------- Validate id_presensi
  function do_ajax_form_hrm_user_presensi_validate_id_presensi()
  {
    var nomeCampo_id_presensi = "id_presensi";
    var var_id_presensi = scAjaxGetFieldText(nomeCampo_id_presensi);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_user_presensi_validate_id_presensi(var_id_presensi, var_script_case_init, do_ajax_form_hrm_user_presensi_validate_id_presensi_cb);
  } // do_ajax_form_hrm_user_presensi_validate_id_presensi

  function do_ajax_form_hrm_user_presensi_validate_id_presensi_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_user_presensi_validate_id_presensi_cb

  // ---------- Validate user_name
  function do_ajax_form_hrm_user_presensi_validate_user_name()
  {
    var nomeCampo_user_name = "user_name";
    var var_user_name = scAjaxGetFieldText(nomeCampo_user_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_user_presensi_validate_user_name(var_user_name, var_script_case_init, do_ajax_form_hrm_user_presensi_validate_user_name_cb);
  } // do_ajax_form_hrm_user_presensi_validate_user_name

  function do_ajax_form_hrm_user_presensi_validate_user_name_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_user_presensi_validate_user_name_cb

  // ---------- Validate privilege
  function do_ajax_form_hrm_user_presensi_validate_privilege()
  {
    var nomeCampo_privilege = "privilege";
    var var_privilege = scAjaxGetFieldText(nomeCampo_privilege);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_user_presensi_validate_privilege(var_privilege, var_script_case_init, do_ajax_form_hrm_user_presensi_validate_privilege_cb);
  } // do_ajax_form_hrm_user_presensi_validate_privilege

  function do_ajax_form_hrm_user_presensi_validate_privilege_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_user_presensi_validate_privilege_cb

  // ---------- Validate id_mesin
  function do_ajax_form_hrm_user_presensi_validate_id_mesin()
  {
    var nomeCampo_id_mesin = "id_mesin";
    var var_id_mesin = scAjaxGetFieldText(nomeCampo_id_mesin);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_user_presensi_validate_id_mesin(var_id_mesin, var_script_case_init, do_ajax_form_hrm_user_presensi_validate_id_mesin_cb);
  } // do_ajax_form_hrm_user_presensi_validate_id_mesin

  function do_ajax_form_hrm_user_presensi_validate_id_mesin_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_user_presensi_validate_id_mesin_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_hrm_user_presensi_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_hrm_user_presensi_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_hrm_user_presensi_submit_form(var_id, var_id_presensi, var_user_name, var_privilege, var_id_mesin, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_hrm_user_presensi_submit_form_cb);
  } // do_ajax_form_hrm_user_presensi_submit_form

  function do_ajax_form_hrm_user_presensi_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_hrm_user_presensi_submit_form_cb_after_alert);
  } // do_ajax_form_hrm_user_presensi_submit_form_cb
  function do_ajax_form_hrm_user_presensi_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_hrm_user_presensi_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_hrm_user_presensi_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_hrm_user_presensi_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_hrm_user_presensi_navigate_form_cb);
  } // do_ajax_form_hrm_user_presensi_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_hrm_user_presensi']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_hrm_user_presensi_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_hrm_user_presensi_navigate_form_cb_after_alert);
  } // do_ajax_form_hrm_user_presensi_navigate_form_cb
  function do_ajax_form_hrm_user_presensi_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_hrm_user_presensi_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_hrm_user_presensi_navigate_form_cb_after_alert
  function sc_hide_form_hrm_user_presensi_form()
  {
