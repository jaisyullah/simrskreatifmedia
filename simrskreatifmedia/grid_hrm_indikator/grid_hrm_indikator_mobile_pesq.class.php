...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_indikator_cond" name="indikator_cond" onChange="nm_campos_between(document.getElementById('id_vis_indikator'), this, 'indikator')">
      ...
      <br><span id="id_hide_indikator"  <?php echo $str_hide_indikator?>><?php
      if ($indikator != "")
      {
      $indikator_look = substr($this->Db->qstr($indikator), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_aktif_cond" name="aktif_cond" onChange="nm_campos_between(document.getElementById('id_vis_aktif'), this, 'aktif')">
