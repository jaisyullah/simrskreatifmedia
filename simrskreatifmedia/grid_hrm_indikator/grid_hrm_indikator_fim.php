...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_hrm_indikator"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_hrm_indikator"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_hrm_indikator'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_hrm_indikator']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_hrm_indikator']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_hrm_indikator']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_hrm_indikator']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_hrm_indikator']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_hrm_indikator</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_hrm_indikator']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_hrm_indikator']['embutida_filho'] as $ind => $sc_init)
          {
