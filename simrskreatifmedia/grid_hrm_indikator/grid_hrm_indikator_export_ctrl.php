<?php
@session_start() ;
$_SESSION['scriptcase']['grid_hrm_indikator']['sc_process_barr'] = true;
require_once('../grid_hrm_indikator/index.php');
unset($_SESSION['scriptcase']['grid_hrm_indikator']['sc_process_barr']);
$ExportCtrl = new grid_hrm_indikator_export_control;
$ExportCtrl->Export_barr();

class grid_hrm_indikator_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_title'] ?> hrm_indikator :: Excel</TITLE>
