...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_tran_okvk"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_tran_okvk"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tran_okvk']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_tran_okvk']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tran_okvk']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_tran_okvk']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_tran_okvk']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_tran_okvk']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_tran_okvk']['embutida_filho'] as $ind => $sc_init)
          {
