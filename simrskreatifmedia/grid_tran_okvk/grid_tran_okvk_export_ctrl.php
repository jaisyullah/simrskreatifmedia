<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tran_okvk']['sc_process_barr'] = true;
require_once('../grid_tran_okvk/index.php');
unset($_SESSION['scriptcase']['grid_tran_okvk']['sc_process_barr']);
$ExportCtrl = new grid_tran_okvk_export_control;
$ExportCtrl->Export_barr();

class grid_tran_okvk_export_control
{
