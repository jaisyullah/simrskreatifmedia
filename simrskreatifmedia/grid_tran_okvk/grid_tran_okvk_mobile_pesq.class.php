...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "`Tgl Transaksi`";$Nm_datas[] = "`Tgl Transaksi`";$Nm_numeric[] = "`bayi lahir`";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_rm_cond" name="rm_cond" onChange="nm_campos_between(document.getElementById('id_vis_rm'), this, 'rm')">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_cito_cond" name="cito_cond" onChange="nm_campos_between(document.getElementById('id_vis_cito'), this, 'cito')">
      ...
      <br><span id="id_hide_cito"  <?php echo $str_hide_cito?>><?php
      if ($cito != "")
      {
      $cito_look = substr($this->Db->qstr($cito), 1, -1); 
      $nmgp_def_dados = array(); 
