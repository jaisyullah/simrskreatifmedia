...
<?php
   ...
   $Ord_Cmp = new grid_tran_okvk_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_tran_okvk_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tran_okvk']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tran_okvk']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["kode"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tran_okvk']['labels']["kode"])) ? $_SESSION['sc_session'][$sc_init]['grid_tran_okvk']['labels']["kode"] : "Kode";
   $tab_ger_campos['rm'] = "on";
   $tab_def_campos['rm'] = "RM";
   $tab_labels["rm"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tran_okvk']['labels']["rm"])) ? $_SESSION['sc_session'][$sc_init]['grid_tran_okvk']['labels']["rm"] : "RM";
   ...
   {
       $tab_def_campos['sc_field_0'] = "`Bayi Lahir`";
   }
   $tab_labels["sc_field_0"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tran_okvk']['labels']["sc_field_0"])) ? $_SESSION['sc_session'][$sc_init]['grid_tran_okvk']['labels']["sc_field_0"] : "Bayi Lahir";
   $tab_ger_campos['cito'] = "on";
   $tab_def_campos['cito'] = "Cito";
   $tab_labels["cito"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tran_okvk']['labels']["cito"])) ? $_SESSION['sc_session'][$sc_init]['grid_tran_okvk']['labels']["cito"] : "Cito";
   $tab_ger_campos['diagpre'] = "on";
   $tab_def_campos['diagpre'] = "diagPre";
   $tab_labels["diagpre"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tran_okvk']['labels']["diagpre"])) ? $_SESSION['sc_session'][$sc_init]['grid_tran_okvk']['labels']["diagpre"] : "Diag Pre";
   $tab_ger_campos['tindakan'] = "on";
   $tab_def_campos['tindakan'] = "Tindakan";
   $tab_labels["tindakan"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tran_okvk']['labels']["tindakan"])) ? $_SESSION['sc_session'][$sc_init]['grid_tran_okvk']['labels']["tindakan"] : "Tindakan";
   ...
   $tab_labels["detail"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tran_okvk']['labels']["detail"])) ? $_SESSION['sc_session'][$sc_init]['grid_tran_okvk']['labels']["detail"] : "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_tran_okvk']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_tran_okvk']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_tran_okvk']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tran_okvk']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tran_okvk']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_tran_okvk']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_tran_okvk']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_tran_okvk']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_tran_okvk']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_tran_okvk_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_tran_okvk']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_tran_okvk']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_tran_okvk']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_tran_okvk']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_tran_okvk']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
