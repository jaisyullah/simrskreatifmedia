...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_lap_gizi"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_lap_gizi"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_lap_gizi']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_lap_gizi']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_lap_gizi']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_lap_gizi']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_lap_gizi']['sc_modal']);
           if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_lap_gizi']['opc_psq']))
           {
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_lap_gizi']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_lap_gizi']['embutida_filho'] as $ind => $sc_init)
          {
