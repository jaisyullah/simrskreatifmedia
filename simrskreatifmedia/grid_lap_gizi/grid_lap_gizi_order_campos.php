...
<?php
   ...
   $Ord_Cmp = new grid_lap_gizi_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_lap_gizi_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_lap_gizi']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_lap_gizi']['ordem_select_orig'] = array();
   }
   ...
   {
       $tab_def_campos['tgl'] = "b.tgl_kirim";
   }
   $tab_labels["tgl"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_lap_gizi']['labels']["tgl"])) ? $_SESSION['sc_session'][$sc_init]['grid_lap_gizi']['labels']["tgl"] : "Tgl";
   ...
   {
       $tab_def_campos['jadwal'] = "b.jadwal";
   }
   $tab_labels["jadwal"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_lap_gizi']['labels']["jadwal"])) ? $_SESSION['sc_session'][$sc_init]['grid_lap_gizi']['labels']["jadwal"] : "Jadwal";
   ...
   {
       $tab_def_campos['nama'] = "concat( a.nama_pasien,', ',a.gelar )";
   }
   $tab_labels["nama"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_lap_gizi']['labels']["nama"])) ? $_SESSION['sc_session'][$sc_init]['grid_lap_gizi']['labels']["nama"] : "Nama";
   $tab_ger_campos['diet'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['diet'] = "diet";
   }
   else
   {
       $tab_def_campos['diet'] = "a.diet";
   }
   $tab_labels["diet"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_lap_gizi']['labels']["diet"])) ? $_SESSION['sc_session'][$sc_init]['grid_lap_gizi']['labels']["diet"] : "Diet";
   ...
   {
       $tab_def_campos['tl'] = "a.tgl_lahir";
   }
   $tab_labels["tl"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_lap_gizi']['labels']["tl"])) ? $_SESSION['sc_session'][$sc_init]['grid_lap_gizi']['labels']["tl"] : "TL";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_lap_gizi']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_lap_gizi']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_lap_gizi']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_lap_gizi']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_lap_gizi']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_lap_gizi']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_lap_gizi']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_lap_gizi']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_lap_gizi']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_lap_gizi_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_lap_gizi']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_lap_gizi']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_lap_gizi']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_lap_gizi']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_lap_gizi']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
