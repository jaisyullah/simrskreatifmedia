...
$old_error_handler = set_error_handler("get_list_pasien_ranap_mob_scriptcase_error_handler");

function get_list_pasien_ranap_mob_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['get_list_pasien_ranap_mob']['contr_erro']) && $_SESSION['scriptcase']['get_list_pasien_ranap_mob']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_get_list_pasien_ranap_mob->contr_get_list_pasien_ranap_mob->Apl_com_erro = true;
            if ($inicial_get_list_pasien_ranap_mob->contr_get_list_pasien_ranap_mob->NM_ajax_flag)
            {
                $inicial_get_list_pasien_ranap_mob->contr_get_list_pasien_ranap_mob->NM_ajax_info['errList']['geral_get_list_pasien_ranap_mob'][] = $msg;
                return;
            }
            get_list_pasien_ranap_mob_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function get_list_pasien_ranap_mob_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['get_list_pasien_ranap_mob'])  && '' != $_SESSION['scriptcase']['error_icon']['get_list_pasien_ranap_mob'])  ? $_SESSION['scriptcase']['error_icon']['get_list_pasien_ranap_mob']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['get_list_pasien_ranap_mob']) && '' != $_SESSION['scriptcase']['error_span_title']['get_list_pasien_ranap_mob']) ? $_SESSION['scriptcase']['error_span_title']['get_list_pasien_ranap_mob'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['get_list_pasien_ranap_mob']) && '' != $_SESSION['scriptcase']['error_icon_title']['get_list_pasien_ranap_mob']) ? $_SESSION['scriptcase']['error_icon_title']['get_list_pasien_ranap_mob'] : '';
?>
