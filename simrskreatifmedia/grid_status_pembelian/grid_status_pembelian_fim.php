...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_status_pembelian"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_status_pembelian"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_status_pembelian']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_status_pembelian']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_status_pembelian']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_status_pembelian']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_status_pembelian']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_status_pembelian</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_status_pembelian']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_status_pembelian']['embutida_filho'] as $ind => $sc_init)
          {
