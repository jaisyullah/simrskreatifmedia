...
<?php
   ...
   $Ord_Cmp = new grid_status_pembelian_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_status_pembelian_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_status_pembelian']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_status_pembelian']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['nomor'] = "Nomor";
   $tab_labels["nomor"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_status_pembelian']['labels']["nomor"])) ? $_SESSION['sc_session'][$sc_init]['grid_status_pembelian']['labels']["nomor"] : "No";
   $tab_ger_campos['vendor'] = "on";
   $tab_def_campos['vendor'] = "vendor";
   $tab_labels["vendor"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_status_pembelian']['labels']["vendor"])) ? $_SESSION['sc_session'][$sc_init]['grid_status_pembelian']['labels']["vendor"] : "Perusahaan/Vendor";
   $tab_ger_campos['faktur'] = "on";
   $tab_def_campos['faktur'] = "faktur";
   $tab_labels["faktur"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_status_pembelian']['labels']["faktur"])) ? $_SESSION['sc_session'][$sc_init]['grid_status_pembelian']['labels']["faktur"] : "No Faktur";
   $tab_ger_campos['jthtempo'] = "on";
   $tab_def_campos['jthtempo'] = "jthTempo";
   $tab_labels["jthtempo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_status_pembelian']['labels']["jthtempo"])) ? $_SESSION['sc_session'][$sc_init]['grid_status_pembelian']['labels']["jthtempo"] : "Jatuh Tempo";
   $tab_ger_campos['nobast'] = "on";
   $tab_def_campos['nobast'] = "noBast";
   $tab_labels["nobast"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_status_pembelian']['labels']["nobast"])) ? $_SESSION['sc_session'][$sc_init]['grid_status_pembelian']['labels']["nobast"] : "No BAST";
   $tab_ger_campos['s_po'] = "on";
   $tab_def_campos['s_po'] = "s_po";
   $tab_labels["s_po"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_status_pembelian']['labels']["s_po"])) ? $_SESSION['sc_session'][$sc_init]['grid_status_pembelian']['labels']["s_po"] : "Status PO";
   $tab_ger_campos['s_bast'] = "on";
   $tab_def_campos['s_bast'] = "s_bast";
   $tab_labels["s_bast"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_status_pembelian']['labels']["s_bast"])) ? $_SESSION['sc_session'][$sc_init]['grid_status_pembelian']['labels']["s_bast"] : "Status BAST";
   $tab_ger_campos['s_ro'] = "on";
   $tab_def_campos['s_ro'] = "s_ro";
   $tab_labels["s_ro"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_status_pembelian']['labels']["s_ro"])) ? $_SESSION['sc_session'][$sc_init]['grid_status_pembelian']['labels']["s_ro"] : "Status RO";
   $tab_ger_campos['keterangan'] = "on";
   $tab_def_campos['keterangan'] = "Keterangan";
   $tab_labels["keterangan"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_status_pembelian']['labels']["keterangan"])) ? $_SESSION['sc_session'][$sc_init]['grid_status_pembelian']['labels']["keterangan"] : "Keterangan";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_status_pembelian']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_status_pembelian']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_status_pembelian']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_status_pembelian']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_status_pembelian']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_status_pembelian']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_status_pembelian']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_status_pembelian']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_status_pembelian']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_status_pembelian_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_status_pembelian']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_status_pembelian']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_status_pembelian']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_status_pembelian']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_status_pembelian']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
