<?php
@session_start() ;
$_SESSION['scriptcase']['grid_status_pembelian']['sc_process_barr'] = true;
require_once('../grid_status_pembelian/index.php');
unset($_SESSION['scriptcase']['grid_status_pembelian']['sc_process_barr']);
$ExportCtrl = new grid_status_pembelian_export_control;
$ExportCtrl->Export_barr();

class grid_status_pembelian_export_control
{
