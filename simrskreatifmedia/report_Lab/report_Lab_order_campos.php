<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['report_Lab']['glo_nm_path_imag_temp'] . "/sc_apl_default_simrskreatifmedia.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new report_Lab_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class report_Lab_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['report_Lab']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['report_Lab']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["tgltransaksi"]   = (isset($_SESSION['sc_session'][$sc_init]['report_Lab']['labels']["tgltransaksi"])) ? $_SESSION['sc_session'][$sc_init]['report_Lab']['labels']["tgltransaksi"] : "Tgl Transaksi";
   ...
   $tab_labels["pemeriksaan"]   = (isset($_SESSION['sc_session'][$sc_init]['report_Lab']['labels']["pemeriksaan"])) ? $_SESSION['sc_session'][$sc_init]['report_Lab']['labels']["pemeriksaan"] : "Pemeriksaan";
   ...
   $tab_labels["kategori"]   = (isset($_SESSION['sc_session'][$sc_init]['report_Lab']['labels']["kategori"])) ? $_SESSION['sc_session'][$sc_init]['report_Lab']['labels']["kategori"] : "Kategori";
   ...
   $tab_labels["pasien"]   = (isset($_SESSION['sc_session'][$sc_init]['report_Lab']['labels']["pasien"])) ? $_SESSION['sc_session'][$sc_init]['report_Lab']['labels']["pasien"] : "Pasien";
   ...
   $tab_labels["poli"]   = (isset($_SESSION['sc_session'][$sc_init]['report_Lab']['labels']["poli"])) ? $_SESSION['sc_session'][$sc_init]['report_Lab']['labels']["poli"] : "Poli";
   ...
   {
       $tab_def_campos['penjamin'] = "c.instcode";
   }
   $tab_labels["penjamin"]   = (isset($_SESSION['sc_session'][$sc_init]['report_Lab']['labels']["penjamin"])) ? $_SESSION['sc_session'][$sc_init]['report_Lab']['labels']["penjamin"] : "Penjamin";
   ...
   $tab_labels["nostruk"]   = (isset($_SESSION['sc_session'][$sc_init]['report_Lab']['labels']["nostruk"])) ? $_SESSION['sc_session'][$sc_init]['report_Lab']['labels']["nostruk"] : "No Struk";
   ...
   $tab_labels["kode"]   = (isset($_SESSION['sc_session'][$sc_init]['report_Lab']['labels']["kode"])) ? $_SESSION['sc_session'][$sc_init]['report_Lab']['labels']["kode"] : "Kode Tran Lab";
   $tab_ger_campos['koderanap'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['koderanap'] = "koderanap";
   }
   else
   {
       $tab_def_campos['koderanap'] = "c.inapcode";
   }
   $tab_labels["koderanap"]   = (isset($_SESSION['sc_session'][$sc_init]['report_Lab']['labels']["koderanap"])) ? $_SESSION['sc_session'][$sc_init]['report_Lab']['labels']["koderanap"] : "Kode Ranap";
   ...
   $tab_labels["klsranap"]   = (isset($_SESSION['sc_session'][$sc_init]['report_Lab']['labels']["klsranap"])) ? $_SESSION['sc_session'][$sc_init]['report_Lab']['labels']["klsranap"] : "Kelas Rawat";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['report_Lab']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['report_Lab']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['report_Lab']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['report_Lab']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['report_Lab']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['report_Lab']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['report_Lab']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['report_Lab']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['report_Lab']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "report_Lab_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['report_Lab']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['report_Lab']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['report_Lab']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['report_Lab']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['report_Lab']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
