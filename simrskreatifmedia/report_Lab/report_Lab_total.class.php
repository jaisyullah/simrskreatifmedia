...
class report_Lab_total
{
   ...
   function __construct($sc_page)
   {
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['report_Lab']['campos_busca']) && !empty($_SESSION['sc_session'][$this->sc_page]['report_Lab']['campos_busca']))
      { 
   ...
   {
      global $nada, $nm_lang ;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['report_Lab']['contr_total_geral'] == "OK") 
      { 
          return; 
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_Lab']['tot_geral'] = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
          $nm_comando = "select count(*) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['report_Lab']['where_pesq']; 
      } 
      ...
      $nm_comando .= " group by a.trancode, 	a.labcode"; 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_Lab']['tot_geral'][0] = "" . $this->Ini->Nm_lang['lang_msgs_totl'] . ""; 
      while (!$rt->EOF) 
      {
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['report_Lab']['tot_geral'][1])) 
         {
            $_SESSION['sc_session'][$this->Ini->sc_page]['report_Lab']['tot_geral'][1] = 1 ; 
         } 
         else
         {
            $_SESSION['sc_session'][$this->Ini->sc_page]['report_Lab']['tot_geral'][1] += 1 ; 
      ...
      $rt->Close(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_Lab']['contr_total_geral'] = "OK";
   } 
