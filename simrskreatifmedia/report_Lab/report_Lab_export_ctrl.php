<?php
@session_start() ;
$_SESSION['scriptcase']['report_Lab']['sc_process_barr'] = true;
require_once('../report_Lab/index.php');
unset($_SESSION['scriptcase']['report_Lab']['sc_process_barr']);
$ExportCtrl = new report_Lab_export_control;
$ExportCtrl->Export_barr();

class report_Lab_export_control
{
