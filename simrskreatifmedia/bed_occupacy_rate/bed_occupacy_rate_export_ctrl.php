<?php
@session_start() ;
$_SESSION['scriptcase']['bed_occupacy_rate']['sc_process_barr'] = true;
require_once('../bed_occupacy_rate/index.php');
unset($_SESSION['scriptcase']['bed_occupacy_rate']['sc_process_barr']);
$ExportCtrl = new bed_occupacy_rate_export_control;
$ExportCtrl->Export_barr();

class bed_occupacy_rate_export_control
{
