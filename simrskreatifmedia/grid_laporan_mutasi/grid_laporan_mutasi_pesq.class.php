...
class grid_laporan_mutasi_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_mutasi']['path_libs_php'] = $this->Ini->path_lib_php;
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_mutasi']['prim_vez']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_mutasi']['prim_vez'] = "S";
      }
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_laporan_mutasi_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_laporan_mutasi_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_laporan_mutasi_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $Nm_datas[] = "b.tglReq";$Nm_datas[] = "b_tglReq";
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_mutasi']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_mutasi']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_mutasi']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_mutasi']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_mutasi']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_mutasi']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_mutasi']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_mutasi']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_mutasi']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_mutasi']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_mutasi']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_mutasi']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_mutasi']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_mutasi']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_mutasi']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_mutasi']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_mutasi']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
   ...
   $NM_retorno = "./";
    if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_mutasi']['proc_res'])) 
    {
...
<?php
    if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_mutasi']['prim_vez'] == "N" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_mutasi']['proc_res']) 
    {
?>
if (parent.document.getElementById('nmsc_iframe_grid_laporan_mutasi').contentWindow.nm_gp_submit_ajax)
{
   parent.document.getElementById('nmsc_iframe_grid_laporan_mutasi').contentWindow.nm_gp_submit_ajax('inicio', 'save_grid');
}
else
{
   parent.document.getElementById('nmsc_iframe_grid_laporan_mutasi').src = 'index.php?nmgp_opcao=pesq&script_case_init=<?php echo NM_encode_input($this->Ini->sc_page) ?>&script_case_session=<?php echo session_id() ?>';
}
<?php
    }
    else
...
<?php
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_mutasi']['prim_vez'] = "N";
?>
</SCRIPT>
</BODY>
</HTML>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_laporan_mutasi/grid_laporan_mutasi_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_laporan_mutasi_ajax_search.js"></script>
 <script type="text/javascript" src="grid_laporan_mutasi_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_laporan_mutasi_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_laporan_mutasi']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_laporan_mutasi']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
function scJQCalendarAdd() {
  $("#sc_tanggal_jq").datepicker({
    beforeShow: function(input, inst) {
          var_dt_ini  = document.getElementById('SC_tanggal_dia').value + '/';
          var_dt_ini += document.getElementById('SC_tanggal_mes').value + '/';
          var_dt_ini += document.getElementById('SC_tanggal_ano').value;
          document.getElementById('sc_tanggal_jq').value = var_dt_ini;
    },
    onClose: function(dateText, inst) {
          aParts  = dateText.split("/");
          document.getElementById('SC_tanggal_dia').value = aParts[0];
          document.getElementById('SC_tanggal_mes').value = aParts[1];
          document.getElementById('SC_tanggal_ano').value = aParts[2];
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
  ...
  $("#sc_tanggal_jq2").datepicker({
    beforeShow: function(input, inst) {
          var_dt_ini  = document.getElementById('SC_tanggal_input_2_dia').value + '/';
          var_dt_ini += document.getElementById('SC_tanggal_input_2_mes').value + '/';
          var_dt_ini += document.getElementById('SC_tanggal_input_2_ano').value;
          document.getElementById('sc_tanggal_jq2').value = var_dt_ini;
    },
    onClose: function(dateText, inst) {
          aParts  = dateText.split("/");
          document.getElementById('SC_tanggal_input_2_dia').value = aParts[0];
          document.getElementById('SC_tanggal_input_2_mes').value = aParts[1];
          document.getElementById('SC_tanggal_input_2_ano').value = aParts[2];
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_obat_cond#NMF#' + search_get_sel_txt('SC_obat_cond') + '@NMF@';
  str_out += 'SC_obat#NMF#' + search_get_select('SC_obat') + '@NMF@';
  str_out += 'SC_depo tujuan_cond#NMF#' + search_get_sel_txt('SC_sc_field_1_cond') + '@NMF@';
  str_out += 'SC_depo tujuan#NMF#' + search_get_select('SC_sc_field_1') + '@NMF@';
...
<?php
   ...
   function monta_form()
   {
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_mutasi']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_mutasi']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_mutasi']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_mutasi']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $tanggal_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_mutasi']['campos_busca']['tanggal_dia']; 
          $tanggal_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_mutasi']['campos_busca']['tanggal_mes']; 
          $tanggal_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_mutasi']['campos_busca']['tanggal_ano']; 
          $tanggal_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_mutasi']['campos_busca']['tanggal_input_2_dia']; 
          $tanggal_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_mutasi']['campos_busca']['tanggal_input_2_mes']; 
          $tanggal_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_mutasi']['campos_busca']['tanggal_input_2_ano']; 
          $tanggal_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_mutasi']['campos_busca']['tanggal_cond']; 
          $obat = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_mutasi']['campos_busca']['obat']; 
          $obat_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_mutasi']['campos_busca']['obat_cond']; 
          $sc_field_1 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_mutasi']['campos_busca']['sc_field_1']; 
          $sc_field_1_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_mutasi']['campos_busca']['sc_field_1_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_mutasi']['campos_busca']['NM_operador']; 
      } 
      ...
      $str_hide_obat = (in_array($obat_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      $str_display_obat = ('bw' == $obat_cond) ? $display_aberto : $display_fechado;
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_tanggal_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['tanggal'])) ? $this->New_label['tanggal'] : "Tanggal Transaksi"; ?></TD>
      
      <INPUT type="hidden" id="SC_tanggal_cond" name="tanggal_cond" value="bw">
      ...
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_tanggal" <?php echo $str_hide_tanggal?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['tanggal'])) ? $this->New_label['tanggal'] : "Tanggal Transaksi";
...
<span id='id_date_part_tanggal_DD' style='display: inline-block'>
         ...
         <SELECT class="scFilterObjectOdd" id="SC_tanggal_dia" name="tanggal_dia">
          <OPTION value=""></OPTION>
          <OPTION value="01" <?php if ("01" == $tanggal_dia) { echo "selected"; } ?>>01</OPTION>
          <OPTION value="02" <?php if ("02" == $tanggal_dia) { echo "selected"; } ?>>02</OPTION>
          <OPTION value="03" <?php if ("03" == $tanggal_dia) { echo "selected"; } ?>>03</OPTION>
          <OPTION value="04" <?php if ("04" == $tanggal_dia) { echo "selected"; } ?>>04</OPTION>
          <OPTION value="05" <?php if ("05" == $tanggal_dia) { echo "selected"; } ?>>05</OPTION>
          <OPTION value="06" <?php if ("06" == $tanggal_dia) { echo "selected"; } ?>>06</OPTION>
          <OPTION value="07" <?php if ("07" == $tanggal_dia) { echo "selected"; } ?>>07</OPTION>
          <OPTION value="08" <?php if ("08" == $tanggal_dia) { echo "selected"; } ?>>08</OPTION>
          <OPTION value="09" <?php if ("09" == $tanggal_dia) { echo "selected"; } ?>>09</OPTION>
          <OPTION value="10" <?php if ("10" == $tanggal_dia) { echo "selected"; } ?>>10</OPTION>
          <OPTION value="11" <?php if ("11" == $tanggal_dia) { echo "selected"; } ?>>11</OPTION>
          <OPTION value="12" <?php if ("12" == $tanggal_dia) { echo "selected"; } ?>>12</OPTION>
          <OPTION value="13" <?php if ("13" == $tanggal_dia) { echo "selected"; } ?>>13</OPTION>
          <OPTION value="14" <?php if ("14" == $tanggal_dia) { echo "selected"; } ?>>14</OPTION>
          <OPTION value="15" <?php if ("15" == $tanggal_dia) { echo "selected"; } ?>>15</OPTION>
          <OPTION value="16" <?php if ("16" == $tanggal_dia) { echo "selected"; } ?>>16</OPTION>
          <OPTION value="17" <?php if ("17" == $tanggal_dia) { echo "selected"; } ?>>17</OPTION>
          <OPTION value="18" <?php if ("18" == $tanggal_dia) { echo "selected"; } ?>>18</OPTION>
          <OPTION value="19" <?php if ("19" == $tanggal_dia) { echo "selected"; } ?>>19</OPTION>
          <OPTION value="20" <?php if ("20" == $tanggal_dia) { echo "selected"; } ?>>20</OPTION>
          <OPTION value="21" <?php if ("21" == $tanggal_dia) { echo "selected"; } ?>>21</OPTION>
          <OPTION value="22" <?php if ("22" == $tanggal_dia) { echo "selected"; } ?>>22</OPTION>
          <OPTION value="23" <?php if ("23" == $tanggal_dia) { echo "selected"; } ?>>23</OPTION>
          <OPTION value="24" <?php if ("24" == $tanggal_dia) { echo "selected"; } ?>>24</OPTION>
          <OPTION value="25" <?php if ("25" == $tanggal_dia) { echo "selected"; } ?>>25</OPTION>
          <OPTION value="26" <?php if ("26" == $tanggal_dia) { echo "selected"; } ?>>26</OPTION>
          <OPTION value="27" <?php if ("27" == $tanggal_dia) { echo "selected"; } ?>>27</OPTION>
          <OPTION value="28" <?php if ("28" == $tanggal_dia) { echo "selected"; } ?>>28</OPTION>
          <OPTION value="29" <?php if ("29" == $tanggal_dia) { echo "selected"; } ?>>29</OPTION>
          <OPTION value="30" <?php if ("30" == $tanggal_dia) { echo "selected"; } ?>>30</OPTION>
          <OPTION value="31" <?php if ("31" == $tanggal_dia) { echo "selected"; } ?>>31</OPTION>
         </SELECT>
         </span>
...
<span id='id_date_part_tanggal_MM' style='display: inline-block'>
         ...
         <SELECT class="scFilterObjectOdd" id="SC_tanggal_mes" name="tanggal_mes">
          <OPTION value=""></OPTION>
          <OPTION value="01" <?php if ("01" == $tanggal_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][0] ?></OPTION>
          <OPTION value="02" <?php if ("02" == $tanggal_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][1] ?></OPTION>
          <OPTION value="03" <?php if ("03" == $tanggal_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][2] ?></OPTION>
          <OPTION value="04" <?php if ("04" == $tanggal_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][3] ?></OPTION>
          <OPTION value="05" <?php if ("05" == $tanggal_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][4] ?></OPTION>
          <OPTION value="06" <?php if ("06" == $tanggal_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][5] ?></OPTION>
          <OPTION value="07" <?php if ("07" == $tanggal_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][6] ?></OPTION>
          <OPTION value="08" <?php if ("08" == $tanggal_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][7] ?></OPTION>
          <OPTION value="09" <?php if ("09" == $tanggal_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][8] ?></OPTION>
          <OPTION value="10" <?php if ("10" == $tanggal_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][9] ?></OPTION>
          <OPTION value="11" <?php if ("11" == $tanggal_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][10] ?></OPTION>
          <OPTION value="12" <?php if ("12" == $tanggal_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][11] ?></OPTION>
         </SELECT>
         </span>
...
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_tanggal_ano" name="tanggal_ano" value="<?php echo NM_encode_input($tanggal_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 <INPUT type="hidden" id="sc_tanggal_jq">
</span>
...
<span id='id_date_part_tanggal_input_2_DD' style='display: inline-block'>
         ...
         <SELECT class="scFilterObjectOdd" id="SC_tanggal_input_2_dia" name="tanggal_input_2_dia">
          <OPTION value=""></OPTION>
          <OPTION value="01" <?php if ("01" == $tanggal_input_2_dia) { echo "selected"; } ?>>01</OPTION>
          <OPTION value="02" <?php if ("02" == $tanggal_input_2_dia) { echo "selected"; } ?>>02</OPTION>
          <OPTION value="03" <?php if ("03" == $tanggal_input_2_dia) { echo "selected"; } ?>>03</OPTION>
          <OPTION value="04" <?php if ("04" == $tanggal_input_2_dia) { echo "selected"; } ?>>04</OPTION>
          <OPTION value="05" <?php if ("05" == $tanggal_input_2_dia) { echo "selected"; } ?>>05</OPTION>
          <OPTION value="06" <?php if ("06" == $tanggal_input_2_dia) { echo "selected"; } ?>>06</OPTION>
          <OPTION value="07" <?php if ("07" == $tanggal_input_2_dia) { echo "selected"; } ?>>07</OPTION>
          <OPTION value="08" <?php if ("08" == $tanggal_input_2_dia) { echo "selected"; } ?>>08</OPTION>
          <OPTION value="09" <?php if ("09" == $tanggal_input_2_dia) { echo "selected"; } ?>>09</OPTION>
          <OPTION value="10" <?php if ("10" == $tanggal_input_2_dia) { echo "selected"; } ?>>10</OPTION>
          <OPTION value="11" <?php if ("11" == $tanggal_input_2_dia) { echo "selected"; } ?>>11</OPTION>
          <OPTION value="12" <?php if ("12" == $tanggal_input_2_dia) { echo "selected"; } ?>>12</OPTION>
          <OPTION value="13" <?php if ("13" == $tanggal_input_2_dia) { echo "selected"; } ?>>13</OPTION>
          <OPTION value="14" <?php if ("14" == $tanggal_input_2_dia) { echo "selected"; } ?>>14</OPTION>
          <OPTION value="15" <?php if ("15" == $tanggal_input_2_dia) { echo "selected"; } ?>>15</OPTION>
          <OPTION value="16" <?php if ("16" == $tanggal_input_2_dia) { echo "selected"; } ?>>16</OPTION>
          <OPTION value="17" <?php if ("17" == $tanggal_input_2_dia) { echo "selected"; } ?>>17</OPTION>
          <OPTION value="18" <?php if ("18" == $tanggal_input_2_dia) { echo "selected"; } ?>>18</OPTION>
          <OPTION value="19" <?php if ("19" == $tanggal_input_2_dia) { echo "selected"; } ?>>19</OPTION>
          <OPTION value="20" <?php if ("20" == $tanggal_input_2_dia) { echo "selected"; } ?>>20</OPTION>
          <OPTION value="21" <?php if ("21" == $tanggal_input_2_dia) { echo "selected"; } ?>>21</OPTION>
          <OPTION value="22" <?php if ("22" == $tanggal_input_2_dia) { echo "selected"; } ?>>22</OPTION>
          <OPTION value="23" <?php if ("23" == $tanggal_input_2_dia) { echo "selected"; } ?>>23</OPTION>
          <OPTION value="24" <?php if ("24" == $tanggal_input_2_dia) { echo "selected"; } ?>>24</OPTION>
          <OPTION value="25" <?php if ("25" == $tanggal_input_2_dia) { echo "selected"; } ?>>25</OPTION>
          <OPTION value="26" <?php if ("26" == $tanggal_input_2_dia) { echo "selected"; } ?>>26</OPTION>
          <OPTION value="27" <?php if ("27" == $tanggal_input_2_dia) { echo "selected"; } ?>>27</OPTION>
          <OPTION value="28" <?php if ("28" == $tanggal_input_2_dia) { echo "selected"; } ?>>28</OPTION>
          <OPTION value="29" <?php if ("29" == $tanggal_input_2_dia) { echo "selected"; } ?>>29</OPTION>
          <OPTION value="30" <?php if ("30" == $tanggal_input_2_dia) { echo "selected"; } ?>>30</OPTION>
          <OPTION value="31" <?php if ("31" == $tanggal_input_2_dia) { echo "selected"; } ?>>31</OPTION>
         </SELECT>
         </span>
...
<span id='id_date_part_tanggal_input_2_MM' style='display: inline-block'>
         ...
         <SELECT class="scFilterObjectOdd" id="SC_tanggal_input_2_mes" name="tanggal_input_2_mes">
          <OPTION value=""></OPTION>
          <OPTION value="01" <?php if ("01" == $tanggal_input_2_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][0] ?></OPTION>
          <OPTION value="02" <?php if ("02" == $tanggal_input_2_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][1] ?></OPTION>
          <OPTION value="03" <?php if ("03" == $tanggal_input_2_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][2] ?></OPTION>
          <OPTION value="04" <?php if ("04" == $tanggal_input_2_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][3] ?></OPTION>
          <OPTION value="05" <?php if ("05" == $tanggal_input_2_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][4] ?></OPTION>
          <OPTION value="06" <?php if ("06" == $tanggal_input_2_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][5] ?></OPTION>
          <OPTION value="07" <?php if ("07" == $tanggal_input_2_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][6] ?></OPTION>
          <OPTION value="08" <?php if ("08" == $tanggal_input_2_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][7] ?></OPTION>
          <OPTION value="09" <?php if ("09" == $tanggal_input_2_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][8] ?></OPTION>
          <OPTION value="10" <?php if ("10" == $tanggal_input_2_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][9] ?></OPTION>
          <OPTION value="11" <?php if ("11" == $tanggal_input_2_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][10] ?></OPTION>
          <OPTION value="12" <?php if ("12" == $tanggal_input_2_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][11] ?></OPTION>
         </SELECT>
         </span>
...
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_tanggal_input_2_ano" name="tanggal_input_2_ano" value="<?php echo NM_encode_input($tanggal_input_2_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 <INPUT type="hidden" id="sc_tanggal_jq2">
</span>
...
?>
      ...
      <TD id='SC_obat_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['obat'])) ? $this->New_label['obat'] : "Obat"; ?></TD>
      
      <INPUT type="hidden" id="SC_obat_cond" name="obat_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_obat" <?php echo $str_hide_obat?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['obat'])) ? $this->New_label['obat'] : "Obat";
 $nmgp_tab_label .= "obat?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      $obat_look = substr($this->Db->qstr($obat), 1, -1); 
      $nmgp_def_dados = "" ; 
      $nm_comando = "SELECT namaItem, namaItem  FROM tbobat  ORDER BY namaItem"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_mutasi']['psq_check_ret']['obat'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_mutasi']['psq_check_ret']['obat'][] = trim($rs->fields[0]);
...
?>
   <span id="idAjaxSelect_obat">
      <SELECT class="scFilterObjectOdd" id="SC_obat" name="obat"  size="1">
       <OPTION value=""></OPTION>
<?php
      ...
      foreach ($nm_opcoes as $nm_opcao)
      {
         if (!empty($nm_opcao))
         {
            ...
            if ("" != $obat)
            {
                    $obat_sel = ($nm_opc_cod === $obat) ? "selected" : "";
            }
            else
            {
               $obat_sel = ("S" == $nm_opc_sel) ? "selected" : "";
            }
            $nm_sc_valor = $nm_opc_val;
            $nm_opc_val = $nm_sc_valor;
?>
       <OPTION value="<?php echo NM_encode_input($nm_opc_cod . $delimitador . $nm_opc_val); ?>" <?php echo $obat_sel; ?>><?php echo $nm_opc_val; ?></OPTION>
<?php
         }
      }
?>
...
?>
      ...
      <TD id='SC_sc_field_1_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['sc_field_1'])) ? $this->New_label['sc_field_1'] : "Depo Tujuan"; ?></TD>
...
<?php
      ...
      $nmgp_def_dados = "" ; 
      $nm_comando = "SELECT namaDepo, namaDepo  FROM tbdepo  ORDER BY namaDepo"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_mutasi']['psq_check_ret']['sc_field_1'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_mutasi']['psq_check_ret']['sc_field_1'][] = trim($rs->fields[0]);
            $nmgp_def_dados .= trim($rs->fields[1]) . "?#?" ; 
            $nmgp_def_dados .= trim($rs->fields[0]) . "?#?N?@?" ; 
            $rs->MoveNext() ; 
         } 
...
?>
   <span id="idAjaxSelect_sc_field_1">
      <SELECT class="scFilterObjectOdd" id="SC_sc_field_1" name="sc_field_1"  size="1">
       <OPTION value=""></OPTION>
<?php
      $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
      $nm_opcoes  = explode("?@?", $nm_opcoesx);
      foreach ($nm_opcoes as $nm_opcao)
      {
         if (!empty($nm_opcao))
         {
            ...
            if ("" != $sc_field_1)
            {
                    $sc_field_1_sel = ($nm_opc_cod === $sc_field_1) ? "selected" : "";
            }
            else
            {
               $sc_field_1_sel = ("S" == $nm_opc_sel) ? "selected" : "";
            }
            $nm_sc_valor = $nm_opc_val;
            $nm_opc_val = $nm_sc_valor;
?>
       <OPTION value="<?php echo NM_encode_input($nm_opc_cod . $delimitador . $nm_opc_val); ?>" <?php echo $sc_field_1_sel; ?>><?php echo $nm_opc_val; ?></OPTION>
<?php
         }
      }
?>
...
?>
<?php
   if (is_file("grid_laporan_mutasi_help.txt"))
   {
...
?>
<?php
   if ($nm_apl_dependente == 1 || (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_mutasi']['opc_psq'] && !$this->aba_iframe))
   {
...
<?php
       ...
       elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_mutasi']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_mutasi']['dashboard_info']['under_dashboard'])
       { }
       else 
       { 
?>
...
<?php
   ...
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_mutasi']['opc_psq'])
   {
...
<?php
    if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_mutasi']['prim_vez'] == "N") 
    {
?>
       <iframe id="nmsc_iframe_grid_laporan_mutasi" frameborder="0" marginwidth="0px" marginheight="0px" topmargin="0px" leftmargin="0px" align="center" height="1500px" name="nm_iframe_grid_laporan_mutasi" scrolling="auto" src="index.php?nmgp_opcao=pesq&script_case_init=<?php echo NM_encode_input($this->Ini->sc_page) ?>&script_case_session=<?php echo session_id() ?>" width="100%"></iframe>
<?php
    }
    else
    {
?>
       <iframe id="nmsc_iframe_grid_laporan_mutasi" frameborder="0" marginwidth="0px" marginheight="0px" topmargin="0px" leftmargin="0px" align="center" height="1500px" name="nm_iframe_grid_laporan_mutasi" scrolling="auto" src="" width="100%"></iframe>
<?php
    }
?>
<iframe id="nmsc_iframe_grid_laporan_mutasi_pesq"  name="nm_iframe_grid_laporan_mutasi_pesq" style= "display: none;" frameborder="0" marginwidth="0px" marginheight="0px" topmargin="0px" leftmargin="0px" src=""></iframe>
</td></tr></table></td></tr>
</TABLE>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_mutasi']['orig_pesq'] == "grid")
   {
...
?>
 ...
 {
    document.F1.target = "nm_iframe_grid_laporan_mutasi_pesq";
    document.F1.submit();
 }
 function nm_move()
 {
     document.getElementById('nmsc_iframe_grid_laporan_mutasi').contentWindow.nm_move('igual');
 }
 function limpa_form()
 {
   document.F1.reset();
   ...
   document.F1.tanggal_cond.value = 'bw';
   ...
   nm_campos_between(document.getElementById('id_vis_obat'), document.F1.obat_cond, 'obat');
   document.F1.obat.value = "";
 ...
 function Sc_carga_select2(Field)
 {
    if (Field == 'all' || Field == 'sc_field_1') {
       Sc_carga_select2_sc_field_1();
    }
    if (Field == 'all' || Field == 'obat') {
       Sc_carga_select2_obat();
    }
 }
 function Sc_carga_select2_sc_field_1()
 {
  $("#SC_sc_field_1").select2(
    {
      language: {
        noResults: function() {
 ...
 function Sc_carga_select2_obat()
 {
  $("#SC_obat").select2(
    {
      language: {
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "simrskreatifmedia/grid_laporan_mutasi";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_mutasi']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_mutasi']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_mutasi']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_obat_cond'] = 'cond';
      $tp_fields['SC_obat'] = 'select';
      $tp_fields['SC_sc_field_1_cond'] = 'cond';
      $tp_fields['SC_sc_field_1'] = 'select';
      $tp_fields['SC_NM_operador'] = 'text';
      $tb_fields_esp['SC_depo tujuan_cond'] = 'SC_sc_field_1_cond';
      $tb_fields_esp['SC_depo tujuan'] = 'SC_sc_field_1';
      if (is_file($NM_patch))
      {
          $SC_V8    = false;
   ...
   function trata_campos()
   {
      global $tanggal_cond, $tanggal, $tanggal_dia, $tanggal_mes, $tanggal_ano, $tanggal_input_2_dia, $tanggal_input_2_mes, $tanggal_input_2_ano,
             $obat_cond, $obat,
             $sc_field_1_cond, $sc_field_1, $nmgp_tab_label;
      ...
      $obat_cond_salva = $obat_cond; 
      if (!isset($obat_input_2) || $obat_input_2 == "")
      {
          $obat_input_2 = $obat;
      }
      ...
      if ($tmp_pos === false) {
          ...
          $L_lookup = substr($obat, 0, $tmp_pos);
      }
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_mutasi']['psq_check_ret']['obat'])) {
          if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "Obat : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
      }
      $tmp_pos = strpos($sc_field_1, "##@@");
      if ($tmp_pos === false) {
          $L_lookup = $sc_field_1;
          ...
          $L_lookup = substr($sc_field_1, 0, $tmp_pos);
      }
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_mutasi']['psq_check_ret']['sc_field_1'])) {
          if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "Depo Tujuan : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_mutasi']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_mutasi']['campos_busca']['tanggal_dia'] = $tanggal_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_mutasi']['campos_busca']['tanggal_mes'] = $tanggal_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_mutasi']['campos_busca']['tanggal_ano'] = $tanggal_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_mutasi']['campos_busca']['tanggal_input_2_dia'] = $tanggal_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_mutasi']['campos_busca']['tanggal_input_2_mes'] = $tanggal_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_mutasi']['campos_busca']['tanggal_input_2_ano'] = $tanggal_input_2_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_mutasi']['campos_busca']['tanggal_cond'] = $tanggal_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_mutasi']['campos_busca']['obat'] = $obat; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_mutasi']['campos_busca']['obat_cond'] = $obat_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_mutasi']['campos_busca']['sc_field_1'] = $sc_field_1; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_mutasi']['campos_busca']['sc_field_1_cond'] = $sc_field_1_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_mutasi']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_mutasi']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      ...
      $this->cmp_formatado['obat'] = $Conteudo;
      $Conteudo = $sc_field_1;
      if (strpos($Conteudo, "##@@") !== false)
      {
          $Conteudo = substr($Conteudo, strpos($Conteudo, "##@@") + 4);
      ...
      if ($tanggal_cond != "bi_TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_mutasi']['campos_busca']['tanggal'] = $val[0];
          $this->nm_data->SetaData($this->cmp_formatado['tanggal'], "YYYY-MM-DD HH:II:SS");
          $this->cmp_formatado['tanggal'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DH", "dmY"));
          if ($tanggal_cond == "BW")
          {
              if (!$this->Date_part) {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_mutasi']['campos_busca']['tanggal_input_2'] = $val[1];
              $this->nm_data->SetaData($this->cmp_formatado['tanggal_input_2'], "YYYY-MM-DD HH:II:SS");
              $this->cmp_formatado['tanggal_input_2'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DH", "dmY"));
          }
          if (!empty($Dtxt) || $tanggal_cond == "NU" || $tanggal_cond == "NN"|| $tanggal_cond == "EP"|| $tanggal_cond == "NE")
          {
              $this->monta_condicao("b.tglReq", $tanggal_cond, $tanggal, $tanggal_input_2, 'tanggal', 'DATETIME');
          }
      }
      ...
      if (isset($obat))
      {
         $this->monta_condicao("c.namaItem", $obat_cond, $obat, "", "obat");
      }
      ...
      if (isset($sc_field_1))
      {
         $this->monta_condicao("d.namaDepo", $sc_field_1_cond, $sc_field_1, "", "sc_field_1");
      }
   }
   ...
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_mutasi']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_mutasi']['cond_dyn_search'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_mutasi']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_mutasi']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_mutasi']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_mutasi']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_mutasi']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_mutasi']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_mutasi']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_mutasi']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_laporan_mutasi']['cond_pesq'] .= $this->NM_operador;
   ...
   function css_obj_select_ajax($Obj)
   {
      switch ($Obj)
      {
         case "obat" : return ('class="scFilterObjectOdd"'); break;
         case "sc_field_1" : return ('class="scFilterObjectOdd"'); break;
         default       : return ("");
      }
   }
