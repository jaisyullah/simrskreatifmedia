...
<?php
   ...
   $Ord_Cmp = new grid_laporan_mutasi_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_laporan_mutasi_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_laporan_mutasi']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_laporan_mutasi']['ordem_select_orig'] = array();
   }
   ...
   {
       $tab_def_campos['kode'] = "a.kodeReq";
   }
   $tab_labels["kode"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_laporan_mutasi']['labels']["kode"])) ? $_SESSION['sc_session'][$sc_init]['grid_laporan_mutasi']['labels']["kode"] : "Kode";
   $tab_ger_campos['tanggal'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['tanggal'] = "tanggal";
   }
   else
   {
       $tab_def_campos['tanggal'] = "b.tglReq";
   }
   $tab_labels["tanggal"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_laporan_mutasi']['labels']["tanggal"])) ? $_SESSION['sc_session'][$sc_init]['grid_laporan_mutasi']['labels']["tanggal"] : "Tanggal";
   ...
   {
       $tab_def_campos['sc_field_0'] = "'Gudang Farmasi'";
   }
   $tab_labels["sc_field_0"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_laporan_mutasi']['labels']["sc_field_0"])) ? $_SESSION['sc_session'][$sc_init]['grid_laporan_mutasi']['labels']["sc_field_0"] : "Depo Asal";
   ...
   {
       $tab_def_campos['sc_field_1'] = "d.namaDepo";
   }
   $tab_labels["sc_field_1"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_laporan_mutasi']['labels']["sc_field_1"])) ? $_SESSION['sc_session'][$sc_init]['grid_laporan_mutasi']['labels']["sc_field_1"] : "Depo Tujuan";
   $tab_ger_campos['obat'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['obat'] = "obat";
   }
   else
   {
       $tab_def_campos['obat'] = "c.namaItem";
   }
   $tab_labels["obat"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_laporan_mutasi']['labels']["obat"])) ? $_SESSION['sc_session'][$sc_init]['grid_laporan_mutasi']['labels']["obat"] : "Obat";
   ...
   {
       $tab_def_campos['sc_field_2'] = "a.permintaan";
   }
   $tab_labels["sc_field_2"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_laporan_mutasi']['labels']["sc_field_2"])) ? $_SESSION['sc_session'][$sc_init]['grid_laporan_mutasi']['labels']["sc_field_2"] : "Qty Minta";
   ...
   {
       $tab_def_campos['sc_field_3'] = "a.realisasi";
   }
   $tab_labels["sc_field_3"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_laporan_mutasi']['labels']["sc_field_3"])) ? $_SESSION['sc_session'][$sc_init]['grid_laporan_mutasi']['labels']["sc_field_3"] : "Qty Beri";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_laporan_mutasi']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_laporan_mutasi']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_laporan_mutasi']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_laporan_mutasi']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_laporan_mutasi']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_laporan_mutasi']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_laporan_mutasi']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_laporan_mutasi']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_laporan_mutasi']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_laporan_mutasi_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_laporan_mutasi']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_laporan_mutasi']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_laporan_mutasi']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_laporan_mutasi']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_laporan_mutasi']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
