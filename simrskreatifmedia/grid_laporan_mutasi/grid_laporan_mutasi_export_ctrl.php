<?php
@session_start() ;
$_SESSION['scriptcase']['grid_laporan_mutasi']['sc_process_barr'] = true;
require_once('../grid_laporan_mutasi/index.php');
unset($_SESSION['scriptcase']['grid_laporan_mutasi']['sc_process_barr']);
$ExportCtrl = new grid_laporan_mutasi_export_control;
$ExportCtrl->Export_barr();

class grid_laporan_mutasi_export_control
{
