...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "b.tglReq";$Nm_datas[] = "b_tglReq";$Nm_numeric[] = "a_permintaan";$Nm_numeric[] = "a_realisasi";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_tanggal"  <?php echo $str_hide_tanggal?>>
<?php
  $Form_base = "ddmmyyyy";
  $date_format_show = "";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_obat"  <?php echo $str_hide_obat?>>
<?php
...
?>
   <span id="idAjaxSelect_obat">
      <SELECT class="scFilterObjectEven" id="SC_obat" name="obat"  size="1">
       <OPTION value=""></OPTION>
<?php
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_sc_field_1"  <?php echo $str_hide_sc_field_1?>>
<?php
...
<?php
   ...
   function css_obj_select_ajax($Obj)
   {
      switch ($Obj)
      {
         case "obat" : return ('class="scFilterObjectEven"'); break;
