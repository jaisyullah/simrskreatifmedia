<?php
@session_start() ;
$_SESSION['scriptcase']['print_etiket']['sc_process_barr'] = true;
require_once('../print_etiket/index.php');
unset($_SESSION['scriptcase']['print_etiket']['sc_process_barr']);
$ExportCtrl = new print_etiket_export_control;
$ExportCtrl->Export_barr();

class print_etiket_export_control
{
