...
class print_etiket_rtf
{
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      $nm_raiz_img  = ""; 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['print_etiket']['rtf_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['print_etiket']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['print_etiket']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['print_etiket']['rtf_name']);
      }
...
$_SESSION['scriptcase']['print_etiket']['contr_erro'] = 'off'; 
   ...
   function NM_export_signa()
   {
         ...
         $this->look_signa = str_replace('<', '&lt;', $this->look_signa);
         $this->look_signa = str_replace('>', '&gt;', $this->look_signa);
         $this->Texto_tag .= "<td>" . $this->look_signa . "</td>\r\n";
   }
   //----- jenisaturanpakai
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['print_etiket']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['print_etiket']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
