  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbpopict" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbpopict_form();
	}

  // ---------- Validate gambar_
  function do_ajax_form_tbpopict_validate_gambar_(iNumLinha)
  {
    var nomeCampo_gambar_ = "gambar_" + iNumLinha;
    var var_gambar_ = scAjaxGetFieldText(nomeCampo_gambar_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbpopict_validate_gambar_(var_gambar_, iNumLinha, var_script_case_init, do_ajax_form_tbpopict_validate_gambar__cb);
  } // do_ajax_form_tbpopict_validate_gambar_

  function do_ajax_form_tbpopict_validate_gambar__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "gambar_" + iLineNumber;
    }
    else
    {
      sFieldValid = "gambar_";
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "gambar_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "gambar_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbpopict_validate_gambar__cb

  // ---------- Validate id_
  function do_ajax_form_tbpopict_validate_id_(iNumLinha)
  {
    var nomeCampo_id_ = "id_" + iNumLinha;
    var var_id_ = scAjaxGetFieldHidden(nomeCampo_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbpopict_validate_id_(var_id_, iNumLinha, var_script_case_init, do_ajax_form_tbpopict_validate_id__cb);
  } // do_ajax_form_tbpopict_validate_id_

  function do_ajax_form_tbpopict_validate_id__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbpopict_validate_id__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_tbpopict_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_tbpopict_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tbpopict_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_tbpopict_add_new_line_cb);
  } // do_ajax_form_tbpopict_add_new_line

  function do_ajax_form_tbpopict_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
    ...
    eval("var_ajax_img_gambar_" + iAjaxNewLine + " = '';");
  } // do_ajax_form_tbpopict_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_tbpopict_backup_line(iNumLinha)
  {
    var var_id_ = scAjaxGetFieldHidden("id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbpopict_backup_line(var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_tbpopict_backup_line_cb);
  } // do_ajax_form_tbpopict_backup_line

  function do_ajax_form_tbpopict_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_tbpopict_backup_line_cb

  function do_ajax_form_tbpopict_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_tbpopict_cancel_insert

  function do_ajax_form_tbpopict_cancel_update(iSeqVert)
  {
    do_ajax_form_tbpopict_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_tbpopict_cancel_update

  function do_ajax_form_tbpopict_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_tbpopict_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_tbpopict_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_tbpopict_table_refresh(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbpopict_table_refresh_cb);
  } //  do_ajax_form_tbpopict_table_refresh

  function do_ajax_form_tbpopict_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_tbpopict_table_refresh_cb_after_alert);
  } // do_ajax_form_tbpopict_table_refresh_cb
  function do_ajax_form_tbpopict_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_tbpopict_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_tbpopict_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_tbpopict_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    sc_num_ult_line = iNumLinha;
    sc_num_ult_tr   = indexTR;
    scAjaxHideMessage();
    var var_gambar_ = scAjaxGetFieldText("gambar_" + iNumLinha);
    var var_id_ = scAjaxGetFieldHidden("id_" + iNumLinha);
    var var_gambar__ul_name = scAjaxSpecCharProtect(eval('document.F1.gambar__ul_name' + iNumLinha + '.value'));
    var var_gambar__ul_type = eval('document.F1.gambar__ul_type' + iNumLinha + '.value');
    var var_gambar__salva = document.F1.elements["gambar_" + iNumLinha + "_salva"] ? eval('document.F1.gambar_' + iNumLinha + '_salva.value') : "";
    var var_gambar__limpa = eval('document.F1.gambar__limpa' + iNumLinha + '.checked') ? "S" : "N";
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_tbpopict_submit_form(var_gambar_, var_id_, var_gambar__ul_name, var_gambar__ul_type, var_gambar__salva, var_gambar__limpa, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbpopict_submit_form_cb);
  } // do_ajax_form_tbpopict_submit_form

  function do_ajax_form_tbpopict_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("gambar_" + sc_num_ult_line);
...
<?php
        ...
        {
?>
          if (document.F1.elements["gambar__limpa" + sc_num_ult_line] && document.F1.elements["gambar__limpa" + sc_num_ult_line].checked)
          {
            var oImgTemp = {0: {"value" : ""}};
            scAjaxSetFieldImage("gambar_" + sc_num_ult_line, oImgTemp, "", "", "", "N");
            document.F1.elements["gambar__limpa" + sc_num_ult_line].checked = false;
          }
<?php
        }
?>
      }
      eval("if (document.F1.gambar__ul_name" + sc_num_ult_line + ") document.F1.gambar__ul_name" + sc_num_ult_line + ".value = ''");
      eval("if (document.F1.gambar__ul_type" + sc_num_ult_line + ") document.F1.gambar__ul_type" + sc_num_ult_line + ".value = ''");
    }
    scAjaxSetSummary();
    scAjaxSetNavpage();
    scAjaxShowDebug();
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_tbpopict_submit_form_cb_after_alert);
  } // do_ajax_form_tbpopict_submit_form_cb
  function do_ajax_form_tbpopict_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbpopict_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tbpopict_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_tbpopict_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("gambar_" + iNavForm);
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tbpopict_navigate_form(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbpopict_navigate_form_cb);
  } // do_ajax_form_tbpopict_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbpopict']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbpopict_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    {
      eval("if (document.F1.gambar__ul_name" + iImg + ") document.F1.gambar__ul_name" + iImg + ".value = ''");
      eval("if (document.F1.gambar__ul_type" + iImg + ") document.F1.gambar__ul_type" + iImg + ".value = ''");
    }
    scAjaxSetBtnVars();
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbpopict_navigate_form_cb_after_alert);
  } // do_ajax_form_tbpopict_navigate_form_cb
  function do_ajax_form_tbpopict_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_tbpopict_navigate_form_cb_after_alert
  function sc_hide_form_tbpopict_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "gambar_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "id_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["gambar_" + iNumLinha] = {"label": "Gambar<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_field_mult["gambar_"][iNumLinha] = "gambar_" + iNumLinha;
    ajax_field_mult["id_"][iNumLinha] = "id_" + iNumLinha;
    ajax_field_id["gambar_" + iNumLinha] = new Array("hidden_field_label_gambar_", "hidden_field_data_gambar_" + iNumLinha);
    ajax_error_count["gambar_" + iNumLinha] = "off";
    ajax_error_count["id_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["gambar_" + iNumLinha] = "off";
...
{
?>
    ajax_read_only["gambar_" + iNumLinha] = "on";
    ajax_read_only["id_" + iNumLinha] = "on";
<?php
}
?>
  ...
  {
    ajax_error_list["gambar_" + iNumLinha] = null;
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["gambar_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["gambar_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["gambar_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["gambar_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["gambar_" + iNumLinha]["onfocus"] = new Array();
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['gambar_'])) ? $this->nmgp_cmp_readonly['gambar_'] : 'off';
?>
    scAjaxFieldRead("gambar_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
?>
  ...
  {
    scAjaxFieldRead("gambar_" + iSeq, "on");
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["gambar_" + iRow] || "on" == ajax_error_count["id_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_gambar_" + iRow).addClass("scFormErrorLine");
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["gambar_" + iRow] && "off" == ajax_error_count["id_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["gambar_" + iRow] = "off";
      ...
      $("#hidden_field_data_gambar_" + iRow).removeClass("scFormErrorLine");
