...
<?php
   ...
   $Ord_Cmp = new grid_hrm_overtime_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_hrm_overtime_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_hrm_overtime']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_hrm_overtime']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_hrm_overtime']['labels']["id"])) ? $_SESSION['sc_session'][$sc_init]['grid_hrm_overtime']['labels']["id"] : "Id";
   $tab_ger_campos['id_karyawan'] = "on";
   $tab_def_campos['id_karyawan'] = "id_karyawan";
   $tab_labels["id_karyawan"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_hrm_overtime']['labels']["id_karyawan"])) ? $_SESSION['sc_session'][$sc_init]['grid_hrm_overtime']['labels']["id_karyawan"] : "Id Karyawan";
   $tab_ger_campos['durasi'] = "on";
   $tab_def_campos['durasi'] = "durasi";
   $tab_labels["durasi"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_hrm_overtime']['labels']["durasi"])) ? $_SESSION['sc_session'][$sc_init]['grid_hrm_overtime']['labels']["durasi"] : "Durasi";
   $tab_ger_campos['tarif'] = "on";
   $tab_def_campos['tarif'] = "tarif";
   $tab_labels["tarif"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_hrm_overtime']['labels']["tarif"])) ? $_SESSION['sc_session'][$sc_init]['grid_hrm_overtime']['labels']["tarif"] : "Tarif";
   $tab_ger_campos['tanggal'] = "on";
   $tab_def_campos['tanggal'] = "tanggal";
   $tab_labels["tanggal"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_hrm_overtime']['labels']["tanggal"])) ? $_SESSION['sc_session'][$sc_init]['grid_hrm_overtime']['labels']["tanggal"] : "Tanggal";
   $tab_ger_campos['disetujui_oleh'] = "on";
   $tab_def_campos['disetujui_oleh'] = "disetujui_oleh";
   $tab_labels["disetujui_oleh"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_hrm_overtime']['labels']["disetujui_oleh"])) ? $_SESSION['sc_session'][$sc_init]['grid_hrm_overtime']['labels']["disetujui_oleh"] : "Disetujui Oleh";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_hrm_overtime']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_hrm_overtime']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_hrm_overtime']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_hrm_overtime']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_hrm_overtime']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_hrm_overtime']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_hrm_overtime']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_hrm_overtime']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_hrm_overtime']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_hrm_overtime_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_hrm_overtime']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_hrm_overtime']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_hrm_overtime']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_hrm_overtime']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_hrm_overtime']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
