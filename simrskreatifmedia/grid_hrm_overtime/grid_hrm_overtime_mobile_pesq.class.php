...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "tanggal";$Nm_datas[] = "tanggal";$Nm_numeric[] = "id";$Nm_numeric[] = "id_karyawan";$Nm_numeric[] = "durasi";$Nm_numeric[] = "tarif";$Nm_numeric[] = "disetujui_oleh";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_tarif_cond" name="tarif_cond" onChange="nm_campos_between(document.getElementById('id_vis_tarif'), this, 'tarif')">
      ...
      <br><span id="id_hide_tarif"  <?php echo $str_hide_tarif?>><?php
      if ($tarif != "")
      {
      $tarif_look = substr($this->Db->qstr($tarif), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_durasi_cond" name="durasi_cond" onChange="nm_campos_between(document.getElementById('id_vis_durasi'), this, 'durasi')">
      ...
      <br><span id="id_hide_durasi"  <?php echo $str_hide_durasi?>><?php
      if ($durasi != "")
      {
      $durasi_look = substr($this->Db->qstr($durasi), 1, -1); 
      $nmgp_def_dados = array(); 
