<?php
@session_start() ;
$_SESSION['scriptcase']['grid_evaluasi_penerimaan']['sc_process_barr'] = true;
require_once('../grid_evaluasi_penerimaan/index.php');
unset($_SESSION['scriptcase']['grid_evaluasi_penerimaan']['sc_process_barr']);
$ExportCtrl = new grid_evaluasi_penerimaan_export_control;
$ExportCtrl->Export_barr();

class grid_evaluasi_penerimaan_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_title'] ?> Evaluasi Penerimaan Barang :: Excel</TITLE>
