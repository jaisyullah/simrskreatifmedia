...
<?php
   ...
   $Ord_Cmp = new grid_evaluasi_penerimaan_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_evaluasi_penerimaan_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_evaluasi_penerimaan']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_evaluasi_penerimaan']['ordem_select_orig'] = array();
   }
   ...
   {
       $tab_def_campos['item'] = "c.namaItem";
   }
   $tab_labels["item"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_evaluasi_penerimaan']['labels']["item"])) ? $_SESSION['sc_session'][$sc_init]['grid_evaluasi_penerimaan']['labels']["item"] : "Item";
   ...
   {
       $tab_def_campos['satuan'] = "a.kemasan";
   }
   $tab_labels["satuan"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_evaluasi_penerimaan']['labels']["satuan"])) ? $_SESSION['sc_session'][$sc_init]['grid_evaluasi_penerimaan']['labels']["satuan"] : "Satuan";
   $tab_ger_campos['perencanaan'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['perencanaan'] = "perencanaan";
   }
   else
   {
       $tab_def_campos['perencanaan'] = "a.jumlah";
   }
   $tab_labels["perencanaan"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_evaluasi_penerimaan']['labels']["perencanaan"])) ? $_SESSION['sc_session'][$sc_init]['grid_evaluasi_penerimaan']['labels']["perencanaan"] : "Perencanaan";
   ...
   {
       $tab_def_campos['sc_field_0'] = "a.jmlTerima";
   }
   $tab_labels["sc_field_0"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_evaluasi_penerimaan']['labels']["sc_field_0"])) ? $_SESSION['sc_session'][$sc_init]['grid_evaluasi_penerimaan']['labels']["sc_field_0"] : "Realisasi Penerimaan";
   ...
   {
       $tab_def_campos['selisih'] = "a.jmlTerima - a.jumlah";
   }
   $tab_labels["selisih"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_evaluasi_penerimaan']['labels']["selisih"])) ? $_SESSION['sc_session'][$sc_init]['grid_evaluasi_penerimaan']['labels']["selisih"] : "Selisih";
   ...
   {
       $tab_def_campos['sc_field_1'] = "round( ( a.jmlTerima / a.jumlah ) * 100 )";
   }
   $tab_labels["sc_field_1"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_evaluasi_penerimaan']['labels']["sc_field_1"])) ? $_SESSION['sc_session'][$sc_init]['grid_evaluasi_penerimaan']['labels']["sc_field_1"] : "Service Level (%)";
   $tab_ger_campos['tgl_terima'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['tgl_terima'] = "tgl_terima";
   }
   else
   {
       $tab_def_campos['tgl_terima'] = "b.datangDate";
   }
   $tab_labels["tgl_terima"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_evaluasi_penerimaan']['labels']["tgl_terima"])) ? $_SESSION['sc_session'][$sc_init]['grid_evaluasi_penerimaan']['labels']["tgl_terima"] : "Tgl Terima";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_evaluasi_penerimaan']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_evaluasi_penerimaan']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_evaluasi_penerimaan']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_evaluasi_penerimaan']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_evaluasi_penerimaan']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_evaluasi_penerimaan']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_evaluasi_penerimaan']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_evaluasi_penerimaan']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_evaluasi_penerimaan']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_evaluasi_penerimaan_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_evaluasi_penerimaan']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_evaluasi_penerimaan']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_evaluasi_penerimaan']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_evaluasi_penerimaan']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_evaluasi_penerimaan']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
