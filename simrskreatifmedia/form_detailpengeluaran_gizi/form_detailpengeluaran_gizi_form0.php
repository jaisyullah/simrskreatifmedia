<?php
class form_detailpengeluaran_gizi_form extends form_detailpengeluaran_gizi_apl
{
function Form_Init()
{
...
<HEAD>
 <TITLE><?php if ('novo' == $this->nmgp_opcao) { echo strip_tags("" . $this->Ini->Nm_lang['lang_othr_frmi_titl'] . " - detailpengeluaran_gizi"); } else { echo strip_tags("" . $this->Ini->Nm_lang['lang_othr_frmu_titl'] . " - detailpengeluaran_gizi"); } ?></TITLE>
...
<?php
if ($this->Embutida_form && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detailpengeluaran_gizi']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detailpengeluaran_gizi']['sc_modal'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detailpengeluaran_gizi']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detailpengeluaran_gizi']['sc_redir_atualiz'] == 'ok')
{
?>
...
.sc-button-image.disabled img {
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detailpengeluaran_gizi']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_detailpengeluaran_gizi/form_detailpengeluaran_gizi_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_detailpengeluaran_gizi_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_detailpengeluaran_gizi_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_detailpengeluaran_gizi']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_detailpengeluaran_gizi']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_detailpengeluaran_gizi']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_detailpengeluaran_gizi']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_detailpengeluaran_gizi']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detailpengeluaran_gizi']['recarga'];
}
if ('novo' == $opcao_botoes && $this->Embutida_form)
{
    $opcao_botoes = 'inicio';
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detailpengeluaran_gizi']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detailpengeluaran_gizi']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
?>
...
<?php
 include_once("form_detailpengeluaran_gizi_js0.php");
?>
<script type="text/javascript"> 
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_detailpengeluaran_gizi'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_detailpengeluaran_gizi'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detailpengeluaran_gizi']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_detailpengeluaran_gizi']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_detailpengeluaran_gizi']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_detailpengeluaran_gizi']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['form_detailpengeluaran_gizi']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<div class="scFormHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFormHeaderFont" style="float: left; text-transform: uppercase;"><?php if ($this->nmgp_opcao == "novo") { echo "" . $this->Ini->Nm_lang['lang_othr_frmi_titl'] . " - detailpengeluaran_gizi"; } else { echo "" . $this->Ini->Nm_lang['lang_othr_frmu_titl'] . " - detailpengeluaran_gizi"; } ?></div>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_detailpengeluaran_gizi']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detailpengeluaran_gizi']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detailpengeluaran_gizi']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_detailpengeluaran_gizi']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detailpengeluaran_gizi']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detailpengeluaran_gizi']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detailpengeluaran_gizi']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_detailpengeluaran_gizi']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detailpengeluaran_gizi']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_detailpengeluaran_gizi']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detailpengeluaran_gizi']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_detailpengeluaran_gizi']['fast_search'][2] : "";
?> 
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detailpengeluaran_gizi']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detailpengeluaran_gizi']['run_iframe'] != "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detailpengeluaran_gizi']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_detailpengeluaran_gizi']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_detailpengeluaran_gizi']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_detailpengeluaran_gizi']['run_iframe'] == "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detailpengeluaran_gizi']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_detailpengeluaran_gizi']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detailpengeluaran_gizi']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_detailpengeluaran_gizi']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detailpengeluaran_gizi']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detailpengeluaran_gizi']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detailpengeluaran_gizi']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_detailpengeluaran_gizi']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_detailpengeluaran_gizi']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_detailpengeluaran_gizi']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_detailpengeluaran_gizi']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detailpengeluaran_gizi']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
 ...
 ?>
   ...
   <?php if (isset($this->nmgp_cmp_hidden['kondisi_']) && $this->nmgp_cmp_hidden['kondisi_'] == 'off') { $sStyleHidden_kondisi_ = 'display: none'; }
      ...
      if (!isset($this->nm_new_label['kondisi_'])) {
          $this->nm_new_label['kondisi_'] = "Kondisi"; } ?>
...
{ 
   ...
   { 
       ob_start();
       $iStart = sizeof($this->form_vert_form_detailpengeluaran_gizi);
       $guarda_nmgp_opcao = $this->nmgp_opcao;
       $guarda_form_vert_form_detailpengeluaran_gizi = $this->form_vert_form_detailpengeluaran_gizi;
       $this->nmgp_opcao = 'novo';
   } 
   if ($this->Embutida_form && empty($this->form_vert_form_detailpengeluaran_gizi))
   {
       $sc_seq_vert = 0;
   }
   ...
   foreach ($this->form_vert_form_detailpengeluaran_gizi as $sc_seq_vert => $sc_lixo)
   {
       $this->loadRecordState($sc_seq_vert);
       $this->pengeluarancode_ = $this->form_vert_form_detailpengeluaran_gizi[$sc_seq_vert]['pengeluarancode_'];
       ...
       elseif ($Line_Add)
       {
        ...
        $this->bahan_ = $this->form_vert_form_detailpengeluaran_gizi[$sc_seq_vert]['bahan_']; 
       $bahan_ = $this->bahan_; 
       $sStyleHidden_bahan_ = '';
       ...
       $this->satuan_ = $this->form_vert_form_detailpengeluaran_gizi[$sc_seq_vert]['satuan_']; 
       ...
       $this->jumlah_ = $this->form_vert_form_detailpengeluaran_gizi[$sc_seq_vert]['jumlah_']; 
       ...
       $this->kondisi_ = $this->form_vert_form_detailpengeluaran_gizi[$sc_seq_vert]['kondisi_']; 
       ...
       $this->keterangan_ = $this->form_vert_form_detailpengeluaran_gizi[$sc_seq_vert]['keterangan_']; 
       ...
       $this->id_ = $this->form_vert_form_detailpengeluaran_gizi[$sc_seq_vert]['id_']; 
       $id_ = $this->id_; 
       if (!isset($this->nmgp_cmp_hidden['id_']))
       {
           $this->nmgp_cmp_hidden['id_'] = 'off';
...
<?php echo nmButtonOutput($this->arr_buttons, "bmd_novo", "do_ajax_form_detailpengeluaran_gizi_add_new_line(" . $sc_seq_vert . ")", "do_ajax_form_detailpengeluaran_gizi_add_new_line(" . $sc_seq_vert . ")", "sc_new_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
<?php }?>
<?php
  $Style_add_line = (!$Line_Add) ? "display: none" : "";
?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_form_detailpengeluaran_gizi_cancel_insert(" . $sc_seq_vert . ")", "do_ajax_form_detailpengeluaran_gizi_cancel_insert(" . $sc_seq_vert . ")", "sc_canceli_line_" . $sc_seq_vert . "", "", "", "" . $Style_add_line . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_form_detailpengeluaran_gizi_cancel_update(" . $sc_seq_vert . ")", "do_ajax_form_detailpengeluaran_gizi_cancel_update(" . $sc_seq_vert . ")", "sc_cancelu_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
 </TD>
   <?php }?>
...
<input type="hidden" name="kondisi_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($kondisi_) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>
...
<?php if ($bTestReadOnly_kondisi_ && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["kondisi_"]) &&  $this->nmgp_cmp_readonly["kondisi_"] == "on") { 
 ...
 ?>
<input type="hidden" name="kondisi_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($kondisi_) . "\">" . $kondisi_ . ""; ?>
<?php } else { ?>
<span id="id_read_on_kondisi_<?php echo $sc_seq_vert ?>" class="sc-ui-readonly-kondisi_<?php echo $sc_seq_vert ?> css_kondisi__line" style="<?php echo $sStyleReadLab_kondisi_; ?>"><?php echo $this->kondisi_; ?></span><span id="id_read_off_kondisi_<?php echo $sc_seq_vert ?>" class="css_read_off_kondisi_" style="white-space: nowrap;<?php echo $sStyleReadInp_kondisi_; ?>">
 <input class="sc-js-input scFormObjectOddMult css_kondisi__obj" style="" id="id_sc_field_kondisi_<?php echo $sc_seq_vert ?>" type=text name="kondisi_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($kondisi_) ?>"
...
<?php   
   ...
   { 
       ...
       $this->form_vert_form_detailpengeluaran_gizi = $guarda_form_vert_form_detailpengeluaran_gizi;
   } 
   if ($Table_refresh) 
   { 
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detailpengeluaran_gizi']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detailpengeluaran_gizi']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_detailpengeluaran_gizi']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_detailpengeluaran_gizi']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_detailpengeluaran_gizi']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detailpengeluaran_gizi']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detailpengeluaran_gizi']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detailpengeluaran_gizi']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detailpengeluaran_gizi']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<?php
if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detailpengeluaran_gizi']['run_modal']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_detailpengeluaran_gizi']['run_modal'])
{
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detailpengeluaran_gizi']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_detailpengeluaran_gizi']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_detailpengeluaran_gizi");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_detailpengeluaran_gizi");
 parent.scAjaxDetailHeight("form_detailpengeluaran_gizi", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
<script type="text/javascript">
	function scBtnFn_sys_format_inc() {
		if ($("#sc_b_new_t.sc-unique-btn-1").length && $("#sc_b_new_t.sc-unique-btn-1").is(":visible")) {
			do_ajax_form_detailpengeluaran_gizi_add_new_line(); return false;
			 return;
		}
...
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_detailpengeluaran_gizi']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
