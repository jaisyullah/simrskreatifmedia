  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_detailpengeluaran_gizi" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_detailpengeluaran_gizi_form();
	}

  // ---------- Validate bahan_
  function do_ajax_form_detailpengeluaran_gizi_validate_bahan_(iNumLinha)
  {
    var nomeCampo_bahan_ = "bahan_" + iNumLinha;
    var var_bahan_ = scAjaxGetFieldText(nomeCampo_bahan_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detailpengeluaran_gizi_validate_bahan_(var_bahan_, iNumLinha, var_script_case_init, do_ajax_form_detailpengeluaran_gizi_validate_bahan__cb);
  } // do_ajax_form_detailpengeluaran_gizi_validate_bahan_

  function do_ajax_form_detailpengeluaran_gizi_validate_bahan__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detailpengeluaran_gizi_validate_bahan__cb

  // ---------- Validate satuan_
  function do_ajax_form_detailpengeluaran_gizi_validate_satuan_(iNumLinha)
  {
    var nomeCampo_satuan_ = "satuan_" + iNumLinha;
    var var_satuan_ = scAjaxGetFieldText(nomeCampo_satuan_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detailpengeluaran_gizi_validate_satuan_(var_satuan_, iNumLinha, var_script_case_init, do_ajax_form_detailpengeluaran_gizi_validate_satuan__cb);
  } // do_ajax_form_detailpengeluaran_gizi_validate_satuan_

  function do_ajax_form_detailpengeluaran_gizi_validate_satuan__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detailpengeluaran_gizi_validate_satuan__cb

  // ---------- Validate jumlah_
  function do_ajax_form_detailpengeluaran_gizi_validate_jumlah_(iNumLinha)
  {
    var nomeCampo_jumlah_ = "jumlah_" + iNumLinha;
    var var_jumlah_ = scAjaxGetFieldText(nomeCampo_jumlah_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detailpengeluaran_gizi_validate_jumlah_(var_jumlah_, iNumLinha, var_script_case_init, do_ajax_form_detailpengeluaran_gizi_validate_jumlah__cb);
  } // do_ajax_form_detailpengeluaran_gizi_validate_jumlah_

  function do_ajax_form_detailpengeluaran_gizi_validate_jumlah__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detailpengeluaran_gizi_validate_jumlah__cb

  // ---------- Validate kondisi_
  function do_ajax_form_detailpengeluaran_gizi_validate_kondisi_(iNumLinha)
  {
    var nomeCampo_kondisi_ = "kondisi_" + iNumLinha;
    var var_kondisi_ = scAjaxGetFieldText(nomeCampo_kondisi_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detailpengeluaran_gizi_validate_kondisi_(var_kondisi_, iNumLinha, var_script_case_init, do_ajax_form_detailpengeluaran_gizi_validate_kondisi__cb);
  } // do_ajax_form_detailpengeluaran_gizi_validate_kondisi_

  function do_ajax_form_detailpengeluaran_gizi_validate_kondisi__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "kondisi_" + iLineNumber;
    }
    else
    {
      sFieldValid = "kondisi_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "kondisi_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "kondisi_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detailpengeluaran_gizi_validate_kondisi__cb

  // ---------- Validate keterangan_
  function do_ajax_form_detailpengeluaran_gizi_validate_keterangan_(iNumLinha)
  {
    var nomeCampo_keterangan_ = "keterangan_" + iNumLinha;
    var var_keterangan_ = scAjaxGetFieldText(nomeCampo_keterangan_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detailpengeluaran_gizi_validate_keterangan_(var_keterangan_, iNumLinha, var_script_case_init, do_ajax_form_detailpengeluaran_gizi_validate_keterangan__cb);
  } // do_ajax_form_detailpengeluaran_gizi_validate_keterangan_

  function do_ajax_form_detailpengeluaran_gizi_validate_keterangan__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detailpengeluaran_gizi_validate_keterangan__cb

  // ---------- Validate id_
  function do_ajax_form_detailpengeluaran_gizi_validate_id_(iNumLinha)
  {
    var nomeCampo_id_ = "id_" + iNumLinha;
    var var_id_ = scAjaxGetFieldHidden(nomeCampo_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detailpengeluaran_gizi_validate_id_(var_id_, iNumLinha, var_script_case_init, do_ajax_form_detailpengeluaran_gizi_validate_id__cb);
  } // do_ajax_form_detailpengeluaran_gizi_validate_id_

  function do_ajax_form_detailpengeluaran_gizi_validate_id__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detailpengeluaran_gizi_validate_id__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_detailpengeluaran_gizi_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_detailpengeluaran_gizi_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_detailpengeluaran_gizi_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_detailpengeluaran_gizi_add_new_line_cb);
  } // do_ajax_form_detailpengeluaran_gizi_add_new_line

  function do_ajax_form_detailpengeluaran_gizi_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_detailpengeluaran_gizi_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_detailpengeluaran_gizi_backup_line(iNumLinha)
  {
    var var_id_ = scAjaxGetFieldHidden("id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detailpengeluaran_gizi_backup_line(var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_detailpengeluaran_gizi_backup_line_cb);
  } // do_ajax_form_detailpengeluaran_gizi_backup_line

  function do_ajax_form_detailpengeluaran_gizi_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_detailpengeluaran_gizi_backup_line_cb

  function do_ajax_form_detailpengeluaran_gizi_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_detailpengeluaran_gizi_cancel_insert

  function do_ajax_form_detailpengeluaran_gizi_cancel_update(iSeqVert)
  {
    do_ajax_form_detailpengeluaran_gizi_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_detailpengeluaran_gizi_cancel_update

  function do_ajax_form_detailpengeluaran_gizi_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_detailpengeluaran_gizi_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_detailpengeluaran_gizi_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_detailpengeluaran_gizi_table_refresh(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_detailpengeluaran_gizi_table_refresh_cb);
  } //  do_ajax_form_detailpengeluaran_gizi_table_refresh

  function do_ajax_form_detailpengeluaran_gizi_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_detailpengeluaran_gizi_table_refresh_cb_after_alert);
  } // do_ajax_form_detailpengeluaran_gizi_table_refresh_cb
  function do_ajax_form_detailpengeluaran_gizi_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_detailpengeluaran_gizi_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_detailpengeluaran_gizi_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_detailpengeluaran_gizi_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    var var_kondisi_ = scAjaxGetFieldText("kondisi_" + iNumLinha);
...
?>
    x_ajax_form_detailpengeluaran_gizi_submit_form(var_bahan_, var_satuan_, var_jumlah_, var_kondisi_, var_keterangan_, var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_detailpengeluaran_gizi_submit_form_cb);
  } // do_ajax_form_detailpengeluaran_gizi_submit_form

  function do_ajax_form_detailpengeluaran_gizi_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("kondisi_" + sc_num_ult_line);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_detailpengeluaran_gizi_submit_form_cb_after_alert);
  } // do_ajax_form_detailpengeluaran_gizi_submit_form_cb
  function do_ajax_form_detailpengeluaran_gizi_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_detailpengeluaran_gizi_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_detailpengeluaran_gizi_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_detailpengeluaran_gizi_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("kondisi_" + iNavForm);
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_detailpengeluaran_gizi_navigate_form(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_detailpengeluaran_gizi_navigate_form_cb);
  } // do_ajax_form_detailpengeluaran_gizi_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_detailpengeluaran_gizi']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_detailpengeluaran_gizi_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_detailpengeluaran_gizi_navigate_form_cb_after_alert);
  } // do_ajax_form_detailpengeluaran_gizi_navigate_form_cb
  function do_ajax_form_detailpengeluaran_gizi_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_detailpengeluaran_gizi_navigate_form_cb_after_alert
  function sc_hide_form_detailpengeluaran_gizi_form()
  {
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "kondisi_" + iNumLinha;
    iTotCampos++;
    ...
    ajax_error_list["kondisi_" + iNumLinha] = {"label": "Kondisi<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_field_mult["kondisi_"][iNumLinha] = "kondisi_" + iNumLinha;
    ...
    ajax_field_id["kondisi_" + iNumLinha] = new Array("hidden_field_label_kondisi_", "hidden_field_data_kondisi_" + iNumLinha);
    ...
    ajax_error_count["kondisi_" + iNumLinha] = "off";
...
?>
    ...
    ajax_read_only["kondisi_" + iNumLinha] = "off";
...
?>
    ...
    ajax_read_only["kondisi_" + iNumLinha] = "on";
...
?>
  ...
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["kondisi_" + iNumLinha] = null;
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["kondisi_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["kondisi_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["kondisi_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["kondisi_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["kondisi_" + iNumLinha]["onfocus"] = new Array();
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['kondisi_'])) ? $this->nmgp_cmp_readonly['kondisi_'] : 'off';
?>
    scAjaxFieldRead("kondisi_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
?>
  ...
  function mdCloseObjects(iSeq)
  {
    ...
    scAjaxFieldRead("kondisi_" + iSeq, "on");
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["bahan_" + iRow] || "on" == ajax_error_count["satuan_" + iRow] || "on" == ajax_error_count["jumlah_" + iRow] || "on" == ajax_error_count["kondisi_" + iRow] || "on" == ajax_error_count["keterangan_" + iRow] || "on" == ajax_error_count["id_" + iRow]))
    {
      ...
      $("#hidden_field_data_kondisi_" + iRow).addClass("scFormErrorLine");
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["bahan_" + iRow] && "off" == ajax_error_count["satuan_" + iRow] && "off" == ajax_error_count["jumlah_" + iRow] && "off" == ajax_error_count["kondisi_" + iRow] && "off" == ajax_error_count["keterangan_" + iRow] && "off" == ajax_error_count["id_" + iRow]))
    {
      if (bErrorRow)
      {
        ...
        ajax_error_count["kondisi_" + iRow] = "off";
      ...
      $("#hidden_field_data_kondisi_" + iRow).removeClass("scFormErrorLine");
