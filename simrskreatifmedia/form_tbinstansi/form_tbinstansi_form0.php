...
?>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbinstansi']['embutida_pdf']))
 {
 ?>
...
<?php
include_once("form_tbinstansi_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_tbinstansi_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbinstansi']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbinstansi']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbinstansi']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbinstansi']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbinstansi']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbinstansi']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbinstansi']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbinstansi']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
?>
...
<?php
 include_once("form_tbinstansi_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbinstansi']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbinstansi']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_tbinstansi'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_tbinstansi'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbinstansi']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbinstansi']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbinstansi']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbinstansi']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbinstansi']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbinstansi']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbinstansi']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbinstansi']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbinstansi']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbinstansi']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbinstansi']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbinstansi']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbinstansi']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbinstansi']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbinstansi']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbinstansi']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbinstansi']['fast_search'][2] : "";
?> 
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbinstansi']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbinstansi']['run_iframe'] != "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbinstansi']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbinstansi']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbinstansi']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbinstansi']['run_iframe'] == "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbinstansi']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbinstansi']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbinstansi']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbinstansi']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbinstansi']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbinstansi']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbinstansi']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbinstansi']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbinstansi']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbinstansi']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbinstansi']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbinstansi']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_instcode_label" id="hidden_field_label_instcode" style="<?php echo $sStyleHidden_instcode; ?>"><span id="id_label_instcode"><?php echo $this->nm_new_label['instcode']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbinstansi']['php_cmp_required']['instcode']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbinstansi']['php_cmp_required']['instcode'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_instcode_line" id="hidden_field_data_instcode" style="<?php echo $sStyleHidden_instcode; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_instcode_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_init_label" id="hidden_field_label_init" style="<?php echo $sStyleHidden_init; ?>"><span id="id_label_init"><?php echo $this->nm_new_label['init']; ?></span></TD>
    <TD class="scFormDataOdd css_init_line" id="hidden_field_data_init" style="<?php echo $sStyleHidden_init; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_init_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_limit_label" id="hidden_field_label_limit" style="<?php echo $sStyleHidden_limit; ?>"><span id="id_label_limit"><?php echo $this->nm_new_label['limit']; ?></span></TD>
    <TD class="scFormDataOdd css_limit_line" id="hidden_field_data_limit" style="<?php echo $sStyleHidden_limit; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_limit_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_discount_line" id="hidden_field_data_discount" style="<?php echo $sStyleHidden_discount; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_discount_line" style="vertical-align: top;padding: 0px">
...
<ul class="scTabLine">
<li id="id_tabs_1_1" class="scTabActive"><a href="javascript: sc_control_tabs_1(1)">Kontak</a></li>
<li id="id_tabs_1_2" class="scTabInactive"><a href="javascript: sc_control_tabs_1(2)">Kontrak</a></li>
<li id="id_tabs_1_3" class="scTabInactive"><a href="javascript: sc_control_tabs_1(3)">Ketentuan</a></li>
</ul>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_joindate_line" id="hidden_field_data_joindate" style="<?php echo $sStyleHidden_joindate; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_joindate_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_expdate_label" id="hidden_field_label_expdate" style="<?php echo $sStyleHidden_expdate; ?>"><span id="id_label_expdate"><?php echo $this->nm_new_label['expdate']; ?></span></TD>
    <TD class="scFormDataOdd css_expdate_line" id="hidden_field_data_expdate" style="<?php echo $sStyleHidden_expdate; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_expdate_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_marginobat_label" id="hidden_field_label_marginobat" style="<?php echo $sStyleHidden_marginobat; ?>"><span id="id_label_marginobat"><?php echo $this->nm_new_label['marginobat']; ?></span></TD>
    <TD class="scFormDataOdd css_marginobat_line" id="hidden_field_data_marginobat" style="<?php echo $sStyleHidden_marginobat; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_marginobat_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_markuptindakan_label" id="hidden_field_label_markuptindakan" style="<?php echo $sStyleHidden_markuptindakan; ?>"><span id="id_label_markuptindakan"><?php echo $this->nm_new_label['markuptindakan']; ?></span></TD>
    <TD class="scFormDataOdd css_markuptindakan_line" id="hidden_field_data_markuptindakan" style="<?php echo $sStyleHidden_markuptindakan; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_markuptindakan_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_markupobat_label" id="hidden_field_label_markupobat" style="<?php echo $sStyleHidden_markupobat; ?>"><span id="id_label_markupobat"><?php echo $this->nm_new_label['markupobat']; ?></span></TD>
    <TD class="scFormDataOdd css_markupobat_line" id="hidden_field_data_markupobat" style="<?php echo $sStyleHidden_markupobat; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_markupobat_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_markuplab_label" id="hidden_field_label_markuplab" style="<?php echo $sStyleHidden_markuplab; ?>"><span id="id_label_markuplab"><?php echo $this->nm_new_label['markuplab']; ?></span></TD>
    <TD class="scFormDataOdd css_markuplab_line" id="hidden_field_data_markuplab" style="<?php echo $sStyleHidden_markuplab; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_markuplab_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_markuprad_label" id="hidden_field_label_markuprad" style="<?php echo $sStyleHidden_markuprad; ?>"><span id="id_label_markuprad"><?php echo $this->nm_new_label['markuprad']; ?></span></TD>
    <TD class="scFormDataOdd css_markuprad_line" id="hidden_field_data_markuprad" style="<?php echo $sStyleHidden_markuprad; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_markuprad_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_admpolitype_label" id="hidden_field_label_admpolitype" style="<?php echo $sStyleHidden_admpolitype; ?>"><span id="id_label_admpolitype"><?php echo $this->nm_new_label['admpolitype']; ?></span></TD>
    <TD class="scFormDataOdd css_admpolitype_line" id="hidden_field_data_admpolitype" style="<?php echo $sStyleHidden_admpolitype; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_admpolitype_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_adminaptype_label" id="hidden_field_label_adminaptype" style="<?php echo $sStyleHidden_adminaptype; ?>"><span id="id_label_adminaptype"><?php echo $this->nm_new_label['adminaptype']; ?></span></TD>
    <TD class="scFormDataOdd css_adminaptype_line" id="hidden_field_data_adminaptype" style="<?php echo $sStyleHidden_adminaptype; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_adminaptype_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_admpolibaru_label" id="hidden_field_label_admpolibaru" style="<?php echo $sStyleHidden_admpolibaru; ?>"><span id="id_label_admpolibaru"><?php echo $this->nm_new_label['admpolibaru']; ?></span></TD>
    <TD class="scFormDataOdd css_admpolibaru_line" id="hidden_field_data_admpolibaru" style="<?php echo $sStyleHidden_admpolibaru; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_admpolibaru_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_admpolilama_label" id="hidden_field_label_admpolilama" style="<?php echo $sStyleHidden_admpolilama; ?>"><span id="id_label_admpolilama"><?php echo $this->nm_new_label['admpolilama']; ?></span></TD>
    <TD class="scFormDataOdd css_admpolilama_line" id="hidden_field_data_admpolilama" style="<?php echo $sStyleHidden_admpolilama; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_admpolilama_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_adminap_label" id="hidden_field_label_adminap" style="<?php echo $sStyleHidden_adminap; ?>"><span id="id_label_adminap"><?php echo $this->nm_new_label['adminap']; ?></span></TD>
    <TD class="scFormDataOdd css_adminap_line" id="hidden_field_data_adminap" style="<?php echo $sStyleHidden_adminap; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_adminap_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_marginpma_label" id="hidden_field_label_marginpma" style="<?php echo $sStyleHidden_marginpma; ?>"><span id="id_label_marginpma"><?php echo $this->nm_new_label['marginpma']; ?></span></TD>
    <TD class="scFormDataOdd css_marginpma_line" id="hidden_field_data_marginpma" style="<?php echo $sStyleHidden_marginpma; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_marginpma_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_withpma_label" id="hidden_field_label_withpma" style="<?php echo $sStyleHidden_withpma; ?>"><span id="id_label_withpma"><?php echo $this->nm_new_label['withpma']; ?></span></TD>
    <TD class="scFormDataOdd css_withpma_line" id="hidden_field_data_withpma" style="<?php echo $sStyleHidden_withpma; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_withpma_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_policy_label" id="hidden_field_label_policy" style="<?php echo $sStyleHidden_policy; ?>"><span id="id_label_policy"><?php echo $this->nm_new_label['policy']; ?></span></TD>
    <TD class="scFormDataOdd css_policy_line" id="hidden_field_data_policy" style="<?php echo $sStyleHidden_policy; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_policy_line" style="vertical-align: top;padding: 0px">
<?php
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbinstansi']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbinstansi']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbinstansi']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbinstansi']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbinstansi']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbinstansi']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbinstansi']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbinstansi']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbinstansi']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbinstansi']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbinstansi']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_tbinstansi");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_tbinstansi");
 parent.scAjaxDetailHeight("form_tbinstansi", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbinstansi']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
