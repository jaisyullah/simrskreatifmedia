...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_joindate_hora' + iSeqRow).bind('blur', function() { sc_form_tbinstansi_joindate_onblur(this, iSeqRow) })
                                           .bind('focus', function() { sc_form_tbinstansi_joindate_onfocus(this, iSeqRow) });
  ...
  $('#id_sc_field_expdate_hora' + iSeqRow).bind('blur', function() { sc_form_tbinstansi_expdate_onblur(this, iSeqRow) })
                                          .bind('focus', function() { sc_form_tbinstansi_expdate_onfocus(this, iSeqRow) });
  ...
  $('#id_sc_field_lastupdated_hora' + iSeqRow).bind('blur', function() { sc_form_tbinstansi_lastupdated_onblur(this, iSeqRow) })
                                              .bind('focus', function() { sc_form_tbinstansi_lastupdated_onfocus(this, iSeqRow) });
...
function scHidePage(pageNo) {
	$("#id_form_tbinstansi_mob_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_lastupdated" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_tbinstansi_mob_validate_lastupdated(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_joindate" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_tbinstansi_mob_validate_joindate(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_expdate" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_tbinstansi_mob_validate_expdate(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
