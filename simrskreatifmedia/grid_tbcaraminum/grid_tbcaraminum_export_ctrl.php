<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tbcaraminum']['sc_process_barr'] = true;
require_once('../grid_tbcaraminum/index.php');
unset($_SESSION['scriptcase']['grid_tbcaraminum']['sc_process_barr']);
$ExportCtrl = new grid_tbcaraminum_export_control;
$ExportCtrl->Export_barr();

class grid_tbcaraminum_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - Instruksi Penggunaan :: Excel</TITLE>
