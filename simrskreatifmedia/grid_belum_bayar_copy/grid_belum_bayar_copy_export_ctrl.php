<?php
@session_start() ;
$_SESSION['scriptcase']['grid_belum_bayar_copy']['sc_process_barr'] = true;
require_once('../grid_belum_bayar_copy/index.php');
unset($_SESSION['scriptcase']['grid_belum_bayar_copy']['sc_process_barr']);
$ExportCtrl = new grid_belum_bayar_copy_export_control;
$ExportCtrl->Export_barr();

class grid_belum_bayar_copy_export_control
{
