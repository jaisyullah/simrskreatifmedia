...
<?php
   ...
   $Ord_Cmp = new grid_belum_bayar_copy_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_belum_bayar_copy_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_belum_bayar_copy']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_belum_bayar_copy']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["kode"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_belum_bayar_copy']['labels']["kode"])) ? $_SESSION['sc_session'][$sc_init]['grid_belum_bayar_copy']['labels']["kode"] : "Kode";
   $tab_ger_campos['jenis'] = "on";
   $tab_def_campos['jenis'] = "Jenis";
   $tab_labels["jenis"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_belum_bayar_copy']['labels']["jenis"])) ? $_SESSION['sc_session'][$sc_init]['grid_belum_bayar_copy']['labels']["jenis"] : "Jenis";
   $tab_ger_campos['pasien'] = "on";
   $tab_def_campos['pasien'] = "Pasien";
   $tab_labels["pasien"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_belum_bayar_copy']['labels']["pasien"])) ? $_SESSION['sc_session'][$sc_init]['grid_belum_bayar_copy']['labels']["pasien"] : "Pasien";
   $tab_ger_campos['dpjp'] = "on";
   $tab_def_campos['dpjp'] = "DPJP";
   $tab_labels["dpjp"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_belum_bayar_copy']['labels']["dpjp"])) ? $_SESSION['sc_session'][$sc_init]['grid_belum_bayar_copy']['labels']["dpjp"] : "DPJP";
   $tab_ger_campos['selesai'] = "on";
   $tab_def_campos['selesai'] = "Selesai";
   $tab_labels["selesai"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_belum_bayar_copy']['labels']["selesai"])) ? $_SESSION['sc_session'][$sc_init]['grid_belum_bayar_copy']['labels']["selesai"] : "Selesai";
   $tab_ger_campos['tglkeluar'] = "on";
   $tab_def_campos['tglkeluar'] = "TglKeluar";
   $tab_labels["tglkeluar"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_belum_bayar_copy']['labels']["tglkeluar"])) ? $_SESSION['sc_session'][$sc_init]['grid_belum_bayar_copy']['labels']["tglkeluar"] : "Tgl Selesai Tindakan";
   $tab_ger_campos['struk'] = "on";
   $tab_def_campos['struk'] = "Struk";
   $tab_labels["struk"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_belum_bayar_copy']['labels']["struk"])) ? $_SESSION['sc_session'][$sc_init]['grid_belum_bayar_copy']['labels']["struk"] : "Struk";
   ...
   $tab_labels["status"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_belum_bayar_copy']['labels']["status"])) ? $_SESSION['sc_session'][$sc_init]['grid_belum_bayar_copy']['labels']["status"] : "status";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_belum_bayar_copy']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_belum_bayar_copy']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_belum_bayar_copy']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_belum_bayar_copy']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_belum_bayar_copy']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_belum_bayar_copy']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_belum_bayar_copy']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_belum_bayar_copy']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_belum_bayar_copy']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_belum_bayar_copy_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_belum_bayar_copy']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_belum_bayar_copy']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_belum_bayar_copy']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_belum_bayar_copy']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_belum_bayar_copy']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
