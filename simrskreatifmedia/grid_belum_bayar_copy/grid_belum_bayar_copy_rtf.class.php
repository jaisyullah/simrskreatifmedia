...
class grid_belum_bayar_copy_rtf
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "grid_belum_bayar_copy.rtf";
   }
   //---- 
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      $nm_raiz_img  = ""; 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_belum_bayar_copy']['rtf_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_belum_bayar_copy']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_belum_bayar_copy']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_belum_bayar_copy']['rtf_name']);
      }
...
$_SESSION['scriptcase']['grid_belum_bayar_copy']['contr_erro'] = 'off'; 
   ...
   function NM_export_pasien()
   {
         ...
         $this->look_pasien = str_replace('<', '&lt;', $this->look_pasien);
         $this->look_pasien = str_replace('>', '&gt;', $this->look_pasien);
         $this->Texto_tag .= "<td>" . $this->look_pasien . "</td>\r\n";
   }
   //----- dpjp
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_belum_bayar_copy']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_belum_bayar_copy']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<HEAD>
 <TITLE>Daftar Belum Bayar :: RTF</TITLE>
