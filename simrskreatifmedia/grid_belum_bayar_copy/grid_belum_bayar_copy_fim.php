...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_belum_bayar_copy"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_belum_bayar_copy"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_belum_bayar_copy']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_belum_bayar_copy']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_belum_bayar_copy']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_belum_bayar_copy']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_belum_bayar_copy']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_belum_bayar_copy</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_belum_bayar_copy']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_belum_bayar_copy']['embutida_filho'] as $ind => $sc_init)
          {
