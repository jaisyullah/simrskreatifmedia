...
<?php
   ...
   $Ord_Cmp = new grid_hrm_remunerasi_tetap_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_hrm_remunerasi_tetap_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_hrm_remunerasi_tetap']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_hrm_remunerasi_tetap']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_hrm_remunerasi_tetap']['labels']["id"])) ? $_SESSION['sc_session'][$sc_init]['grid_hrm_remunerasi_tetap']['labels']["id"] : "Id";
   $tab_ger_campos['id_karyawan'] = "on";
   $tab_def_campos['id_karyawan'] = "id_karyawan";
   $tab_labels["id_karyawan"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_hrm_remunerasi_tetap']['labels']["id_karyawan"])) ? $_SESSION['sc_session'][$sc_init]['grid_hrm_remunerasi_tetap']['labels']["id_karyawan"] : "Karyawan";
   $tab_ger_campos['gaji_pokok'] = "on";
   $tab_def_campos['gaji_pokok'] = "gaji_pokok";
   $tab_labels["gaji_pokok"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_hrm_remunerasi_tetap']['labels']["gaji_pokok"])) ? $_SESSION['sc_session'][$sc_init]['grid_hrm_remunerasi_tetap']['labels']["gaji_pokok"] : "Gaji Pokok";
   $tab_ger_campos['tunj_struktural'] = "on";
   $tab_def_campos['tunj_struktural'] = "tunj_struktural";
   $tab_labels["tunj_struktural"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_hrm_remunerasi_tetap']['labels']["tunj_struktural"])) ? $_SESSION['sc_session'][$sc_init]['grid_hrm_remunerasi_tetap']['labels']["tunj_struktural"] : "Tunj Struktural";
   $tab_ger_campos['tunj_fungsional'] = "on";
   $tab_def_campos['tunj_fungsional'] = "tunj_fungsional";
   $tab_labels["tunj_fungsional"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_hrm_remunerasi_tetap']['labels']["tunj_fungsional"])) ? $_SESSION['sc_session'][$sc_init]['grid_hrm_remunerasi_tetap']['labels']["tunj_fungsional"] : "Tunj Fungsional";
   $tab_ger_campos['tunj_keluarga'] = "on";
   $tab_def_campos['tunj_keluarga'] = "tunj_keluarga";
   $tab_labels["tunj_keluarga"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_hrm_remunerasi_tetap']['labels']["tunj_keluarga"])) ? $_SESSION['sc_session'][$sc_init]['grid_hrm_remunerasi_tetap']['labels']["tunj_keluarga"] : "Tunj Keluarga";
   $tab_ger_campos['tunj_transport_makan'] = "on";
   $tab_def_campos['tunj_transport_makan'] = "tunj_transport_makan";
   $tab_labels["tunj_transport_makan"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_hrm_remunerasi_tetap']['labels']["tunj_transport_makan"])) ? $_SESSION['sc_session'][$sc_init]['grid_hrm_remunerasi_tetap']['labels']["tunj_transport_makan"] : "Tunj Transport Makan";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_hrm_remunerasi_tetap']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_hrm_remunerasi_tetap']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_hrm_remunerasi_tetap']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_hrm_remunerasi_tetap']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_hrm_remunerasi_tetap']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_hrm_remunerasi_tetap']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_hrm_remunerasi_tetap']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_hrm_remunerasi_tetap']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_hrm_remunerasi_tetap']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_hrm_remunerasi_tetap_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_hrm_remunerasi_tetap']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_hrm_remunerasi_tetap']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_hrm_remunerasi_tetap']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_hrm_remunerasi_tetap']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_hrm_remunerasi_tetap']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
