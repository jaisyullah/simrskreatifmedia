  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_jurnal_detail" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_jurnal_detail_form();
	}

  // ---------- Validate id_
  function do_ajax_form_jurnal_detail_validate_id_(iNumLinha)
  {
    var nomeCampo_id_ = "id_" + iNumLinha;
    var var_id_ = scAjaxGetFieldHidden(nomeCampo_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jurnal_detail_validate_id_(var_id_, iNumLinha, var_script_case_init, do_ajax_form_jurnal_detail_validate_id__cb);
  } // do_ajax_form_jurnal_detail_validate_id_

  function do_ajax_form_jurnal_detail_validate_id__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jurnal_detail_validate_id__cb

  // ---------- Validate akun_
  function do_ajax_form_jurnal_detail_validate_akun_(iNumLinha)
  {
    var nomeCampo_akun_ = "akun_" + iNumLinha;
    var var_akun_ = scAjaxGetFieldSelect(nomeCampo_akun_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jurnal_detail_validate_akun_(var_akun_, iNumLinha, var_script_case_init, do_ajax_form_jurnal_detail_validate_akun__cb);
  } // do_ajax_form_jurnal_detail_validate_akun_

  function do_ajax_form_jurnal_detail_validate_akun__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jurnal_detail_validate_akun__cb

  // ---------- Validate nominal_
  function do_ajax_form_jurnal_detail_validate_nominal_(iNumLinha)
  {
    var nomeCampo_nominal_ = "nominal_" + iNumLinha;
    var var_nominal_ = scAjaxGetFieldText(nomeCampo_nominal_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jurnal_detail_validate_nominal_(var_nominal_, iNumLinha, var_script_case_init, do_ajax_form_jurnal_detail_validate_nominal__cb);
  } // do_ajax_form_jurnal_detail_validate_nominal_

  function do_ajax_form_jurnal_detail_validate_nominal__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jurnal_detail_validate_nominal__cb

  // ---------- Validate flag_
  function do_ajax_form_jurnal_detail_validate_flag_(iNumLinha)
  {
    var nomeCampo_flag_ = "flag_" + iNumLinha;
    var var_flag_ = scAjaxGetFieldSelect(nomeCampo_flag_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jurnal_detail_validate_flag_(var_flag_, iNumLinha, var_script_case_init, do_ajax_form_jurnal_detail_validate_flag__cb);
  } // do_ajax_form_jurnal_detail_validate_flag_

  function do_ajax_form_jurnal_detail_validate_flag__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jurnal_detail_validate_flag__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_jurnal_detail_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_jurnal_detail_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_jurnal_detail_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_jurnal_detail_add_new_line_cb);
  } // do_ajax_form_jurnal_detail_add_new_line

  function do_ajax_form_jurnal_detail_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_jurnal_detail_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_jurnal_detail_backup_line(iNumLinha)
  {
    var var_id_ = scAjaxGetFieldHidden("id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jurnal_detail_backup_line(var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_jurnal_detail_backup_line_cb);
  } // do_ajax_form_jurnal_detail_backup_line

  function do_ajax_form_jurnal_detail_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_jurnal_detail_backup_line_cb

  function do_ajax_form_jurnal_detail_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_jurnal_detail_cancel_insert

  function do_ajax_form_jurnal_detail_cancel_update(iSeqVert)
  {
    do_ajax_form_jurnal_detail_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_jurnal_detail_cancel_update

  function do_ajax_form_jurnal_detail_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_jurnal_detail_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_jurnal_detail_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_jurnal_detail_table_refresh(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_jurnal_detail_table_refresh_cb);
  } //  do_ajax_form_jurnal_detail_table_refresh

  function do_ajax_form_jurnal_detail_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_jurnal_detail_table_refresh_cb_after_alert);
  } // do_ajax_form_jurnal_detail_table_refresh_cb
  function do_ajax_form_jurnal_detail_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_jurnal_detail_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_jurnal_detail_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_jurnal_detail_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
...
?>
    x_ajax_form_jurnal_detail_submit_form(var_id_, var_akun_, var_nominal_, var_flag_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_jurnal_detail_submit_form_cb);
  } // do_ajax_form_jurnal_detail_submit_form

  function do_ajax_form_jurnal_detail_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_jurnal_detail_submit_form_cb_after_alert);
  } // do_ajax_form_jurnal_detail_submit_form_cb
  function do_ajax_form_jurnal_detail_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_jurnal_detail_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_jurnal_detail_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_jurnal_detail_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_jurnal_detail_navigate_form(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_jurnal_detail_navigate_form_cb);
  } // do_ajax_form_jurnal_detail_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_jurnal_detail']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_jurnal_detail_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_jurnal_detail_navigate_form_cb_after_alert);
  } // do_ajax_form_jurnal_detail_navigate_form_cb
  function do_ajax_form_jurnal_detail_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_jurnal_detail_navigate_form_cb_after_alert
  function sc_hide_form_jurnal_detail_form()
  {
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["id_" + iRow] || "on" == ajax_error_count["akun_" + iRow] || "on" == ajax_error_count["nominal_" + iRow] || "on" == ajax_error_count["flag_" + iRow]))
    {
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["id_" + iRow] && "off" == ajax_error_count["akun_" + iRow] && "off" == ajax_error_count["nominal_" + iRow] && "off" == ajax_error_count["flag_" + iRow]))
    {
      if (bErrorRow)
      {
