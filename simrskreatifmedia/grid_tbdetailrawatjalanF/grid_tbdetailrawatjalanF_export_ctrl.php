<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tbdetailrawatjalanF']['sc_process_barr'] = true;
require_once('../grid_tbdetailrawatjalanF/index.php');
unset($_SESSION['scriptcase']['grid_tbdetailrawatjalanF']['sc_process_barr']);
$ExportCtrl = new grid_tbdetailrawatjalanF_export_control;
$ExportCtrl->Export_barr();

class grid_tbdetailrawatjalanF_export_control
{
