<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tbreseprawatinap']['sc_process_barr'] = true;
require_once('../grid_tbreseprawatinap/index.php');
unset($_SESSION['scriptcase']['grid_tbreseprawatinap']['sc_process_barr']);
$ExportCtrl = new grid_tbreseprawatinap_export_control;
$ExportCtrl->Export_barr();

class grid_tbreseprawatinap_export_control
{
