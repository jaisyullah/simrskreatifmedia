...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_tbreseprawatinap"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_tbreseprawatinap"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tbreseprawatinap']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_tbreseprawatinap']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tbreseprawatinap']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_tbreseprawatinap']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_tbreseprawatinap']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_tbreseprawatinap</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_tbreseprawatinap']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_tbreseprawatinap']['embutida_filho'] as $ind => $sc_init)
          {
