<?php
class grid_diagnosa_detail_lookup
{
//  
...
//  
   function lookup_icd1(&$conteudo , $icd1) 
   {   
      static $save_conteudo = "" ; 
      static $save_conteudo1 = "" ; 
      $tst_cache = $icd1; 
      ...
      $save_conteudo = $tst_cache ; 
      $nm_comando = "select descEng from tbicd where icd = '" . substr($this->Db->qstr($icd1), 1 , -1) . "' order by descEng" ; 
      $conteudo = "" ; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rx = $this->Db->Execute($nm_comando)) 
...
//  
   function lookup_regDate_sex(&$sex) 
   {
      $conteudo = "" ; 
      if ($sex == "L")
      { 
