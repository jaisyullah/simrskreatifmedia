...
<?php
   ...
   $Ord_Cmp = new grid_diagnosa_detail_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_diagnosa_detail_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_diagnosa_detail']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_diagnosa_detail']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["regdate"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_diagnosa_detail']['labels']["regdate"])) ? $_SESSION['sc_session'][$sc_init]['grid_diagnosa_detail']['labels']["regdate"] : "Tgl. Daftar";
   $tab_ger_campos['custcode'] = "on";
   $tab_def_campos['custcode'] = "custCode";
   $tab_labels["custcode"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_diagnosa_detail']['labels']["custcode"])) ? $_SESSION['sc_session'][$sc_init]['grid_diagnosa_detail']['labels']["custcode"] : "Pasien / No RM";
   $tab_ger_campos['diagnosa1'] = "on";
   $tab_def_campos['diagnosa1'] = "diagnosa1";
   $tab_labels["diagnosa1"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_diagnosa_detail']['labels']["diagnosa1"])) ? $_SESSION['sc_session'][$sc_init]['grid_diagnosa_detail']['labels']["diagnosa1"] : "Diagnosa Teks";
   $tab_ger_campos['icd1'] = "on";
   $tab_def_campos['icd1'] = "icd1";
   $tab_labels["icd1"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_diagnosa_detail']['labels']["icd1"])) ? $_SESSION['sc_session'][$sc_init]['grid_diagnosa_detail']['labels']["icd1"] : "ICD";
   $tab_ger_campos['sex'] = "on";
   $tab_def_campos['sex'] = "sex";
   $tab_labels["sex"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_diagnosa_detail']['labels']["sex"])) ? $_SESSION['sc_session'][$sc_init]['grid_diagnosa_detail']['labels']["sex"] : "Jenis Kelamin";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_diagnosa_detail']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_diagnosa_detail']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_diagnosa_detail']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_diagnosa_detail']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_diagnosa_detail']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_diagnosa_detail']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_diagnosa_detail']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_diagnosa_detail']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_diagnosa_detail']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_diagnosa_detail_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_diagnosa_detail']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_diagnosa_detail']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_diagnosa_detail']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_diagnosa_detail']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_diagnosa_detail']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
