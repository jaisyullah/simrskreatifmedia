<?php
@session_start() ;
$_SESSION['scriptcase']['grid_diagnosa_detail']['sc_process_barr'] = true;
require_once('../grid_diagnosa_detail/index.php');
unset($_SESSION['scriptcase']['grid_diagnosa_detail']['sc_process_barr']);
$ExportCtrl = new grid_diagnosa_detail_export_control;
$ExportCtrl->Export_barr();

class grid_diagnosa_detail_export_control
{
