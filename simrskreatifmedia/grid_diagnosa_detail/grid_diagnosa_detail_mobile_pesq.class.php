...
<select class="sc-js-input scFilterObjectEven sc-ui-autocomp-diagnosa1" id="id_ac_diagnosa1" name="diagnosa1_autocomp"><?php if ('' !=  $diagnosa1) { ?><option value="<?php echo $diagnosa1 ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_icd1"  <?php echo $str_hide_icd1?>><?php
      if ($icd1 != "")
      {
      $icd1_look = substr($this->Db->qstr($icd1), 1, -1); 
      $nmgp_def_dados = array(); 
...
<?php
 ...
 <SELECT class="scFilterObjectEven" id="SC_sex"  name="sex"  size="1">
 <OPTION value=""></option>
