<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tbpenerimaan']['sc_process_barr'] = true;
require_once('../grid_tbpenerimaan/index.php');
unset($_SESSION['scriptcase']['grid_tbpenerimaan']['sc_process_barr']);
$ExportCtrl = new grid_tbpenerimaan_export_control;
$ExportCtrl->Export_barr();

class grid_tbpenerimaan_export_control
{
