...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbpo_10_6']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
  <input type="hidden" name="script_case_session" value="<?php echo $this->form_encode_input(session_id()); ?>"> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_tbpo_10_6"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
{
  nm_gp_submit('<?php echo $this->Ini->link_po_item; ?>', '<?php echo $this->nm_location; ?>', '<?php echo "id_po*scin' + var_btn_sc_btn_0_id_po + '*scouttran_code*scin' + var_btn_sc_btn_0_tran_code + '*scout"; ?>', '', '_blank', '0', '0', 'po_item');
}
...
function sc_btn_sc_btn_1()
{
    ...
    scJs_confirm("<?php echo html_entity_decode('Apakah Anda akan mencetak BAST PO ?', ENT_COMPAT, $_SESSION['scriptcase']['charset']); ?>", sc_btn_sc_btn_1_ok, sc_btn_sc_btn_1_cancel);
}
...
{
      nm_gp_submit('<?php echo $this->Ini->link_bast_po; ?>', '<?php echo $this->nm_location; ?>', '<?php echo "id_po*scin' + var_btn_sc_btn_1_id_po + '*scouttran_code*scin' + var_btn_sc_btn_1_tran_code + '*scout"; ?>', '', '_blank', '0', '0', 'bast_po');
}
 NM_tp_critica(1);
...
{ 
   var sob_iframe = '';
<?php 
if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbpo_10_6']['embutida_form']) {
...
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbpo_10_6']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbpo_10_6']['sc_modal']) {
    echo "   sob_iframe += 'parent.';\r\n";
}
?>
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbpo_10_6']['where_detal']))
  {
?>  
...
{
   nm_field_disabled("pocode=disabled;total=disabled;datangdate=disabled;fakturno=disabled", "");
   nm_field_disabled("status=disabled", "I");
   nm_field_disabled("pesandate=disabled;pbf=disabled", "U");
