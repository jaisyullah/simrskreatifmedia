...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_datangdate_hora' + iSeqRow).bind('blur', function() { sc_form_tbpo_10_6_datangdate_hora_onblur(this, iSeqRow) })
                                             .bind('focus', function() { sc_form_tbpo_10_6_datangdate_hora_onfocus(this, iSeqRow) });
  ...
  $('#id_sc_field_jatuhtempo_hora' + iSeqRow).bind('blur', function() { sc_form_tbpo_10_6_jatuhtempo_hora_onblur(this, iSeqRow) })
                                             .bind('focus', function() { sc_form_tbpo_10_6_jatuhtempo_hora_onfocus(this, iSeqRow) });
  ...
  $('#id_sc_field_trandate_hora' + iSeqRow).bind('blur', function() { sc_form_tbpo_10_6_trandate_hora_onblur(this, iSeqRow) })
                                           .bind('focus', function() { sc_form_tbpo_10_6_trandate_hora_onfocus(this, iSeqRow) });
  ...
  $('#id_sc_field_tglbast_hora' + iSeqRow).bind('blur', function() { sc_form_tbpo_10_6_tglbast_hora_onblur(this, iSeqRow) })
                                          .bind('focus', function() { sc_form_tbpo_10_6_tglbast_hora_onfocus(this, iSeqRow) });
...
function sc_form_tbpo_10_6_datangdate_hora_onblur(oThis, iSeqRow) {
  do_ajax_form_tbpo_10_6_validate_datangdate();
  scCssBlur(oThis);
}
...
function sc_form_tbpo_10_6_datangdate_hora_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function sc_form_tbpo_10_6_jatuhtempo_hora_onblur(oThis, iSeqRow) {
  do_ajax_form_tbpo_10_6_validate_jatuhtempo();
  scCssBlur(oThis);
}
...
function sc_form_tbpo_10_6_jatuhtempo_hora_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function sc_form_tbpo_10_6_trandate_hora_onblur(oThis, iSeqRow) {
  do_ajax_form_tbpo_10_6_validate_trandate();
  scCssBlur(oThis);
}
...
function sc_form_tbpo_10_6_trandate_hora_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function sc_form_tbpo_10_6_tglbast_hora_onblur(oThis, iSeqRow) {
  do_ajax_form_tbpo_10_6_validate_tglbast();
  scCssBlur(oThis);
}
...
function sc_form_tbpo_10_6_tglbast_hora_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function scHidePage(pageNo) {
	$("#id_form_tbpo_10_6_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_pesandate" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_tbpo_10_6_validate_pesandate(iSeqRow);
    },
    numberOfMonths: 1,
    changeMonth: true,
    changeYear: true,
...
?>
  ...
  $("#id_sc_field_jatuhtempo" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_tbpo_10_6_validate_jatuhtempo(iSeqRow);
    },
    numberOfMonths: 1,
    changeMonth: true,
    changeYear: true,
...
?>
  ...
  $("#id_sc_field_orderdate" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_tbpo_10_6_validate_orderdate(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_datangdate" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_tbpo_10_6_validate_datangdate(iSeqRow);
    },
    numberOfMonths: 1,
    changeMonth: true,
    changeYear: true,
...
?>
  ...
  $("#id_sc_field_tglbast" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_tbpo_10_6_validate_tglbast(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
