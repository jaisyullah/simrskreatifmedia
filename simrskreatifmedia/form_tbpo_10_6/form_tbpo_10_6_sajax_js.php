  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbpo_10_6" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbpo_10_6_form();
	}

  // ---------- Validate reqcode
  function do_ajax_form_tbpo_10_6_validate_reqcode()
  {
    var nomeCampo_reqcode = "reqcode";
    var var_reqcode = scAjaxGetFieldText(nomeCampo_reqcode);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbpo_10_6_validate_reqcode(var_reqcode, var_script_case_init, do_ajax_form_tbpo_10_6_validate_reqcode_cb);
  } // do_ajax_form_tbpo_10_6_validate_reqcode

  function do_ajax_form_tbpo_10_6_validate_reqcode_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbpo_10_6_validate_reqcode_cb

  // ---------- Validate pocode
  function do_ajax_form_tbpo_10_6_validate_pocode()
  {
    var nomeCampo_pocode = "pocode";
    var var_pocode = scAjaxGetFieldText(nomeCampo_pocode);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbpo_10_6_validate_pocode(var_pocode, var_script_case_init, do_ajax_form_tbpo_10_6_validate_pocode_cb);
  } // do_ajax_form_tbpo_10_6_validate_pocode

  function do_ajax_form_tbpo_10_6_validate_pocode_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pocode";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbpo_10_6_validate_pocode_cb

  // ---------- Validate total
  function do_ajax_form_tbpo_10_6_validate_total()
  {
    var nomeCampo_total = "total";
    var var_total = scAjaxGetFieldText(nomeCampo_total);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbpo_10_6_validate_total(var_total, var_script_case_init, do_ajax_form_tbpo_10_6_validate_total_cb);
  } // do_ajax_form_tbpo_10_6_validate_total

  function do_ajax_form_tbpo_10_6_validate_total_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "total";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbpo_10_6_validate_total_cb

  // ---------- Validate pesandate
  function do_ajax_form_tbpo_10_6_validate_pesandate()
  {
    var nomeCampo_pesandate = "pesandate";
    var var_pesandate = scAjaxGetFieldText(nomeCampo_pesandate);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbpo_10_6_validate_pesandate(var_pesandate, var_script_case_init, do_ajax_form_tbpo_10_6_validate_pesandate_cb);
  } // do_ajax_form_tbpo_10_6_validate_pesandate

  function do_ajax_form_tbpo_10_6_validate_pesandate_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbpo_10_6_validate_pesandate_cb

  // ---------- Validate status
  function do_ajax_form_tbpo_10_6_validate_status()
  {
    var nomeCampo_status = "status";
    var var_status = scAjaxGetFieldSelect(nomeCampo_status);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbpo_10_6_validate_status(var_status, var_script_case_init, do_ajax_form_tbpo_10_6_validate_status_cb);
  } // do_ajax_form_tbpo_10_6_validate_status

  function do_ajax_form_tbpo_10_6_validate_status_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "status";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbpo_10_6_validate_status_cb

  // ---------- Validate jatuhtempo
  function do_ajax_form_tbpo_10_6_validate_jatuhtempo()
  {
    var nomeCampo_jatuhtempo = "jatuhtempo";
    var var_jatuhtempo = scAjaxGetFieldText(nomeCampo_jatuhtempo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbpo_10_6_validate_jatuhtempo(var_jatuhtempo, var_script_case_init, do_ajax_form_tbpo_10_6_validate_jatuhtempo_cb);
  } // do_ajax_form_tbpo_10_6_validate_jatuhtempo

  function do_ajax_form_tbpo_10_6_validate_jatuhtempo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbpo_10_6_validate_jatuhtempo_cb

  // ---------- Validate note
  function do_ajax_form_tbpo_10_6_validate_note()
  {
    var nomeCampo_note = "note";
    var var_note = scAjaxGetFieldText(nomeCampo_note);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbpo_10_6_validate_note(var_note, var_script_case_init, do_ajax_form_tbpo_10_6_validate_note_cb);
  } // do_ajax_form_tbpo_10_6_validate_note

  function do_ajax_form_tbpo_10_6_validate_note_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "note";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbpo_10_6_validate_note_cb

  // ---------- Validate trandate
  function do_ajax_form_tbpo_10_6_validate_trandate()
  {
    var nomeCampo_trandate = "trandate";
    var var_trandate = scAjaxGetFieldText(nomeCampo_trandate);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbpo_10_6_validate_trandate(var_trandate, var_script_case_init, do_ajax_form_tbpo_10_6_validate_trandate_cb);
  } // do_ajax_form_tbpo_10_6_validate_trandate

  function do_ajax_form_tbpo_10_6_validate_trandate_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbpo_10_6_validate_trandate_cb

  // ---------- Validate orderdate
  function do_ajax_form_tbpo_10_6_validate_orderdate()
  {
    var nomeCampo_orderdate = "orderdate";
    var var_orderdate = scAjaxGetFieldText(nomeCampo_orderdate);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbpo_10_6_validate_orderdate(var_orderdate, var_script_case_init, do_ajax_form_tbpo_10_6_validate_orderdate_cb);
  } // do_ajax_form_tbpo_10_6_validate_orderdate

  function do_ajax_form_tbpo_10_6_validate_orderdate_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbpo_10_6_validate_orderdate_cb

  // ---------- Validate pbf
  function do_ajax_form_tbpo_10_6_validate_pbf()
  {
  } // do_ajax_form_tbpo_10_6_validate_pbf

  function do_ajax_form_tbpo_10_6_validate_pbf_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pbf";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbpo_10_6_validate_pbf_cb

  // ---------- Validate datangdate
  function do_ajax_form_tbpo_10_6_validate_datangdate()
  {
    var nomeCampo_datangdate = "datangdate";
    var var_datangdate = scAjaxGetFieldText(nomeCampo_datangdate);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbpo_10_6_validate_datangdate(var_datangdate, var_script_case_init, do_ajax_form_tbpo_10_6_validate_datangdate_cb);
  } // do_ajax_form_tbpo_10_6_validate_datangdate

  function do_ajax_form_tbpo_10_6_validate_datangdate_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbpo_10_6_validate_datangdate_cb

  // ---------- Validate fakturno
  function do_ajax_form_tbpo_10_6_validate_fakturno()
  {
    var nomeCampo_fakturno = "fakturno";
    var var_fakturno = scAjaxGetFieldText(nomeCampo_fakturno);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbpo_10_6_validate_fakturno(var_fakturno, var_script_case_init, do_ajax_form_tbpo_10_6_validate_fakturno_cb);
  } // do_ajax_form_tbpo_10_6_validate_fakturno

  function do_ajax_form_tbpo_10_6_validate_fakturno_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbpo_10_6_validate_fakturno_cb

  // ---------- Validate tglbast
  function do_ajax_form_tbpo_10_6_validate_tglbast()
  {
    var nomeCampo_tglbast = "tglbast";
    var var_tglbast = scAjaxGetFieldText(nomeCampo_tglbast);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbpo_10_6_validate_tglbast(var_tglbast, var_script_case_init, do_ajax_form_tbpo_10_6_validate_tglbast_cb);
  } // do_ajax_form_tbpo_10_6_validate_tglbast

  function do_ajax_form_tbpo_10_6_validate_tglbast_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tglbast";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbpo_10_6_validate_tglbast_cb

  // ---------- Validate nobast
  function do_ajax_form_tbpo_10_6_validate_nobast()
  {
    var nomeCampo_nobast = "nobast";
    var var_nobast = scAjaxGetFieldText(nomeCampo_nobast);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbpo_10_6_validate_nobast(var_nobast, var_script_case_init, do_ajax_form_tbpo_10_6_validate_nobast_cb);
  } // do_ajax_form_tbpo_10_6_validate_nobast

  function do_ajax_form_tbpo_10_6_validate_nobast_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nobast";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbpo_10_6_validate_nobast_cb

  // ---------- Validate detailpo
  function do_ajax_form_tbpo_10_6_validate_detailpo()
  {
    var nomeCampo_detailpo = "detailpo";
    var var_detailpo = scAjaxGetFieldText(nomeCampo_detailpo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbpo_10_6_validate_detailpo(var_detailpo, var_script_case_init, do_ajax_form_tbpo_10_6_validate_detailpo_cb);
  } // do_ajax_form_tbpo_10_6_validate_detailpo

  function do_ajax_form_tbpo_10_6_validate_detailpo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbpo_10_6_validate_detailpo_cb

  // ---------- Validate gambar
  function do_ajax_form_tbpo_10_6_validate_gambar()
  {
    var nomeCampo_gambar = "gambar";
    var var_gambar = scAjaxGetFieldText(nomeCampo_gambar);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbpo_10_6_validate_gambar(var_gambar, var_script_case_init, do_ajax_form_tbpo_10_6_validate_gambar_cb);
  } // do_ajax_form_tbpo_10_6_validate_gambar

  function do_ajax_form_tbpo_10_6_validate_gambar_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "gambar";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbpo_10_6_validate_gambar_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tbpo_10_6_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tbpo_10_6_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    var var_pbf = scAjaxGetFieldText("pbf");
    ...
    scAjaxProcOn();
    x_ajax_form_tbpo_10_6_submit_form(var_reqcode, var_pocode, var_total, var_pesandate, var_status, var_jatuhtempo, var_note, var_trandate, var_orderdate, var_pbf, var_datangdate, var_fakturno, var_tglbast, var_nobast, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbpo_10_6_submit_form_cb);
  } // do_ajax_form_tbpo_10_6_submit_form

  function do_ajax_form_tbpo_10_6_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tbpo_10_6_submit_form_cb_after_alert);
  } // do_ajax_form_tbpo_10_6_submit_form_cb
  function do_ajax_form_tbpo_10_6_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbpo_10_6_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_tbpodetail"] = "off";
  scStatusDetail["form_tbpopict"] = "off";

  function do_ajax_form_tbpo_10_6_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    x_ajax_form_tbpo_10_6_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbpo_10_6_navigate_form_cb);
  } // do_ajax_form_tbpo_10_6_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbpo_10_6']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbpo_10_6_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbpo_10_6_navigate_form_cb_after_alert);
  } // do_ajax_form_tbpo_10_6_navigate_form_cb
  function do_ajax_form_tbpo_10_6_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_tbpo_10_6_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_tbpo_10_6_navigate_form_cb_after_alert
  function sc_hide_form_tbpo_10_6_form()
  {
  ...
  ajax_field_list[11] = "fakturno";
  ajax_field_list[12] = "tglbast";
  ajax_field_list[13] = "nobast";
  ajax_field_list[14] = "detailpo";
  ajax_field_list[15] = "gambar";
