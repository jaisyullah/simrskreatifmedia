  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_jenisbahan_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_jenisbahan_mob_form();
	}

  // ---------- Validate jeniscode
  function do_ajax_form_jenisbahan_mob_validate_jeniscode()
  {
    var nomeCampo_jeniscode = "jeniscode";
    var var_jeniscode = scAjaxGetFieldText(nomeCampo_jeniscode);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jenisbahan_mob_validate_jeniscode(var_jeniscode, var_script_case_init, do_ajax_form_jenisbahan_mob_validate_jeniscode_cb);
  } // do_ajax_form_jenisbahan_mob_validate_jeniscode

  function do_ajax_form_jenisbahan_mob_validate_jeniscode_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "jeniscode";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jenisbahan_mob_validate_jeniscode_cb

  // ---------- Validate namajenis
  function do_ajax_form_jenisbahan_mob_validate_namajenis()
  {
    var nomeCampo_namajenis = "namajenis";
    var var_namajenis = scAjaxGetFieldText(nomeCampo_namajenis);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jenisbahan_mob_validate_namajenis(var_namajenis, var_script_case_init, do_ajax_form_jenisbahan_mob_validate_namajenis_cb);
  } // do_ajax_form_jenisbahan_mob_validate_namajenis

  function do_ajax_form_jenisbahan_mob_validate_namajenis_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "namajenis";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jenisbahan_mob_validate_namajenis_cb

  // ---------- Validate keterangan
  function do_ajax_form_jenisbahan_mob_validate_keterangan()
  {
    var nomeCampo_keterangan = "keterangan";
    var var_keterangan = scAjaxGetFieldText(nomeCampo_keterangan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jenisbahan_mob_validate_keterangan(var_keterangan, var_script_case_init, do_ajax_form_jenisbahan_mob_validate_keterangan_cb);
  } // do_ajax_form_jenisbahan_mob_validate_keterangan

  function do_ajax_form_jenisbahan_mob_validate_keterangan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jenisbahan_mob_validate_keterangan_cb

  // ---------- Validate aktif
  function do_ajax_form_jenisbahan_mob_validate_aktif()
  {
    var nomeCampo_aktif = "aktif";
    var var_aktif = scAjaxGetFieldRadio(nomeCampo_aktif);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jenisbahan_mob_validate_aktif(var_aktif, var_script_case_init, do_ajax_form_jenisbahan_mob_validate_aktif_cb);
  } // do_ajax_form_jenisbahan_mob_validate_aktif

  function do_ajax_form_jenisbahan_mob_validate_aktif_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "aktif";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jenisbahan_mob_validate_aktif_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_jenisbahan_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_jenisbahan_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_jeniscode = scAjaxGetFieldText("jeniscode");
    var var_namajenis = scAjaxGetFieldText("namajenis");
    ...
    scAjaxProcOn();
    x_ajax_form_jenisbahan_mob_submit_form(var_jeniscode, var_namajenis, var_keterangan, var_aktif, var_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_jenisbahan_mob_submit_form_cb);
  } // do_ajax_form_jenisbahan_mob_submit_form

  function do_ajax_form_jenisbahan_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("jeniscode");
      scAjaxHideErrorDisplay("namajenis");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_jenisbahan_mob_submit_form_cb_after_alert);
  } // do_ajax_form_jenisbahan_mob_submit_form_cb
  function do_ajax_form_jenisbahan_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_jenisbahan_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_jenisbahan_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_jenisbahan_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_jenisbahan_mob_navigate_form_cb);
  } // do_ajax_form_jenisbahan_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_jenisbahan_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_jenisbahan_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_jenisbahan_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_jenisbahan_mob_navigate_form_cb
  function do_ajax_form_jenisbahan_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_jenisbahan_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_jenisbahan_mob_navigate_form_cb_after_alert
  function sc_hide_form_jenisbahan_mob_form()
  {
  ...
  ajax_field_list[0] = "jeniscode";
  ajax_field_list[1] = "namajenis";
  ...
  var ajax_error_list = {
    "jeniscode": {"label": "Kode Jenis", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "namajenis": {"label": "Jenis Bahan", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  ajax_field_mult["jeniscode"][1] = "jeniscode";
  ajax_field_mult["namajenis"][1] = "namajenis";
  ajax_field_mult["keterangan"][1] = "keterangan";
  ajax_field_mult["aktif"][1] = "aktif";

  var ajax_field_id = {
    "jeniscode": new Array("hidden_field_label_jeniscode", "hidden_field_data_jeniscode"),
    "namajenis": new Array("hidden_field_label_namajenis", "hidden_field_data_namajenis"),
