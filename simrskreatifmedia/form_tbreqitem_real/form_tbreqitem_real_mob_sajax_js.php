  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbreqitem_real_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbreqitem_real_mob_form();
	}

  // ---------- Validate kodereq
  function do_ajax_form_tbreqitem_real_mob_validate_kodereq()
  {
    var nomeCampo_kodereq = "kodereq";
    var var_kodereq = scAjaxGetFieldText(nomeCampo_kodereq);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbreqitem_real_mob_validate_kodereq(var_kodereq, var_script_case_init, do_ajax_form_tbreqitem_real_mob_validate_kodereq_cb);
  } // do_ajax_form_tbreqitem_real_mob_validate_kodereq

  function do_ajax_form_tbreqitem_real_mob_validate_kodereq_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbreqitem_real_mob_validate_kodereq_cb

  // ---------- Validate unit
  function do_ajax_form_tbreqitem_real_mob_validate_unit()
  {
    var nomeCampo_unit = "unit";
    var var_unit = scAjaxGetFieldSelect(nomeCampo_unit);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbreqitem_real_mob_validate_unit(var_unit, var_script_case_init, do_ajax_form_tbreqitem_real_mob_validate_unit_cb);
  } // do_ajax_form_tbreqitem_real_mob_validate_unit

  function do_ajax_form_tbreqitem_real_mob_validate_unit_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "unit";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbreqitem_real_mob_validate_unit_cb

  // ---------- Validate tglreq
  function do_ajax_form_tbreqitem_real_mob_validate_tglreq()
  {
    var nomeCampo_tglreq = "tglreq";
    var var_tglreq = scAjaxGetFieldText(nomeCampo_tglreq);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbreqitem_real_mob_validate_tglreq(var_tglreq, var_script_case_init, do_ajax_form_tbreqitem_real_mob_validate_tglreq_cb);
  } // do_ajax_form_tbreqitem_real_mob_validate_tglreq

  function do_ajax_form_tbreqitem_real_mob_validate_tglreq_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tglreq";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbreqitem_real_mob_validate_tglreq_cb

  // ---------- Validate selesai
  function do_ajax_form_tbreqitem_real_mob_validate_selesai()
  {
    var nomeCampo_selesai = "selesai";
    var var_selesai = scAjaxGetFieldSelect(nomeCampo_selesai);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbreqitem_real_mob_validate_selesai(var_selesai, var_script_case_init, do_ajax_form_tbreqitem_real_mob_validate_selesai_cb);
  } // do_ajax_form_tbreqitem_real_mob_validate_selesai

  function do_ajax_form_tbreqitem_real_mob_validate_selesai_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "selesai";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbreqitem_real_mob_validate_selesai_cb

  // ---------- Validate detailreq
  function do_ajax_form_tbreqitem_real_mob_validate_detailreq()
  {
    var nomeCampo_detailreq = "detailreq";
    var var_detailreq = scAjaxGetFieldText(nomeCampo_detailreq);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbreqitem_real_mob_validate_detailreq(var_detailreq, var_script_case_init, do_ajax_form_tbreqitem_real_mob_validate_detailreq_cb);
  } // do_ajax_form_tbreqitem_real_mob_validate_detailreq

  function do_ajax_form_tbreqitem_real_mob_validate_detailreq_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "detailreq";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbreqitem_real_mob_validate_detailreq_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tbreqitem_real_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tbreqitem_real_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_kodereq = scAjaxGetFieldText("kodereq");
    var var_unit = scAjaxGetFieldSelect("unit");
    var var_tglreq = scAjaxGetFieldText("tglreq");
    ...
    scAjaxProcOn();
    x_ajax_form_tbreqitem_real_mob_submit_form(var_kodereq, var_unit, var_tglreq, var_selesai, var_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbreqitem_real_mob_submit_form_cb);
  } // do_ajax_form_tbreqitem_real_mob_submit_form

  function do_ajax_form_tbreqitem_real_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("kodereq");
      scAjaxHideErrorDisplay("unit");
      scAjaxHideErrorDisplay("tglreq");
      scAjaxHideErrorDisplay("selesai");
      scAjaxHideErrorDisplay("detailreq");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tbreqitem_real_mob_submit_form_cb_after_alert);
  } // do_ajax_form_tbreqitem_real_mob_submit_form_cb
  function do_ajax_form_tbreqitem_real_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbreqitem_real_mob_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_tbdetailreqitem_real_mob"] = "off";

  function do_ajax_form_tbreqitem_real_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    scStatusDetail["form_tbdetailreqitem_real_mob"] = "on";
    x_ajax_form_tbreqitem_real_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbreqitem_real_mob_navigate_form_cb);
  } // do_ajax_form_tbreqitem_real_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreqitem_real_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbreqitem_real_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_tbdetailreqitem_real_mob"] && "nmsc_iframe_liga_form_tbdetailreqitem_real_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_tbdetailreqitem_real_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_tbdetailreqitem_real_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_tbdetailreqitem_real_mob').contentWindow.nm_move('apl_detalhe', true, '500');
        document.getElementById('nmsc_iframe_liga_form_tbdetailreqitem_real_mob').style.height = "500";
        document.getElementById('nmsc_iframe_liga_form_tbdetailreqitem_real_mob').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbreqitem_real_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_tbreqitem_real_mob_navigate_form_cb
  function do_ajax_form_tbreqitem_real_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_tbreqitem_real_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_tbreqitem_real_mob_navigate_form_cb_after_alert
  function sc_hide_form_tbreqitem_real_mob_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_tbdetailreqitem_real_mob"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[0] = "kodereq";
  ajax_field_list[1] = "unit";
  ajax_field_list[2] = "tglreq";
  ajax_field_list[3] = "selesai";
  ajax_field_list[4] = "detailreq";
  ...
  var ajax_error_list = {
    "kodereq": {"label": "Kode Permintaan", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "unit": {"label": "Unit", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "tglreq": {"label": "Tgl Permintaan", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "selesai": {"label": "Selesai", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "detailreq": {"label": "detailReq", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  ajax_field_mult["kodereq"][1] = "kodereq";
  ajax_field_mult["unit"][1] = "unit";
  ajax_field_mult["tglreq"][1] = "tglreq";
  ajax_field_mult["selesai"][1] = "selesai";
  ajax_field_mult["detailreq"][1] = "detailreq";

  var ajax_field_id = {
    "kodereq": new Array("hidden_field_label_kodereq", "hidden_field_data_kodereq"),
    "unit": new Array("hidden_field_label_unit", "hidden_field_data_unit"),
    "tglreq": new Array("hidden_field_label_tglreq", "hidden_field_data_tglreq"),
    "selesai": new Array("hidden_field_label_selesai", "hidden_field_data_selesai"),
    "detailreq": new Array("hidden_field_label_detailreq", "hidden_field_data_detailreq")
  };
