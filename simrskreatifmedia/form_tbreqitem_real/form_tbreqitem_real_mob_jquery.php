...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_tglreq_hora' + iSeqRow).bind('blur', function() { sc_form_tbreqitem_real_tglreq_onblur(this, iSeqRow) })
                                         .bind('focus', function() { sc_form_tbreqitem_real_tglreq_onfocus(this, iSeqRow) });
...
function displayChange_field_detailreq(row, status) {
	if ("on" == status && typeof $("#nmsc_iframe_liga_form_tbdetailreqitem_real_mob")[0].contentWindow.scRecreateSelect2 === "function") {
		$("#nmsc_iframe_liga_form_tbdetailreqitem_real_mob")[0].contentWindow.scRecreateSelect2();
	}
}
...
function scHidePage(pageNo) {
	$("#id_form_tbreqitem_real_mob_form" + pageNo).hide();
}
