  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbitemdrugsell" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbitemdrugsell_form();
	}

  // ---------- Validate itemcode_
  function do_ajax_form_tbitemdrugsell_validate_itemcode_(iNumLinha)
  {
    var nomeCampo_itemcode_ = "itemcode_" + iNumLinha;
    var var_itemcode_ = scAjaxGetFieldSelect(nomeCampo_itemcode_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbitemdrugsell_validate_itemcode_(var_itemcode_, iNumLinha, var_script_case_init, do_ajax_form_tbitemdrugsell_validate_itemcode__cb);
  } // do_ajax_form_tbitemdrugsell_validate_itemcode_

  function do_ajax_form_tbitemdrugsell_validate_itemcode__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "itemcode_" + iLineNumber;
    }
    else
    {
      sFieldValid = "itemcode_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "itemcode_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "itemcode_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbitemdrugsell_validate_itemcode__cb

  // ---------- Validate stok_
  function do_ajax_form_tbitemdrugsell_validate_stok_(iNumLinha)
  {
    var nomeCampo_stok_ = "stok_" + iNumLinha;
    var var_stok_ = scAjaxGetFieldSelect(nomeCampo_stok_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbitemdrugsell_validate_stok_(var_stok_, iNumLinha, var_script_case_init, do_ajax_form_tbitemdrugsell_validate_stok__cb);
  } // do_ajax_form_tbitemdrugsell_validate_stok_

  function do_ajax_form_tbitemdrugsell_validate_stok__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbitemdrugsell_validate_stok__cb

  // ---------- Validate jumlah_
  function do_ajax_form_tbitemdrugsell_validate_jumlah_(iNumLinha)
  {
    var nomeCampo_jumlah_ = "jumlah_" + iNumLinha;
    var var_jumlah_ = scAjaxGetFieldText(nomeCampo_jumlah_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbitemdrugsell_validate_jumlah_(var_jumlah_, iNumLinha, var_script_case_init, do_ajax_form_tbitemdrugsell_validate_jumlah__cb);
  } // do_ajax_form_tbitemdrugsell_validate_jumlah_

  function do_ajax_form_tbitemdrugsell_validate_jumlah__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbitemdrugsell_validate_jumlah__cb

  // ---------- Validate disc_
  function do_ajax_form_tbitemdrugsell_validate_disc_(iNumLinha)
  {
    var nomeCampo_disc_ = "disc_" + iNumLinha;
    var var_disc_ = scAjaxGetFieldText(nomeCampo_disc_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbitemdrugsell_validate_disc_(var_disc_, iNumLinha, var_script_case_init, do_ajax_form_tbitemdrugsell_validate_disc__cb);
  } // do_ajax_form_tbitemdrugsell_validate_disc_

  function do_ajax_form_tbitemdrugsell_validate_disc__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbitemdrugsell_validate_disc__cb

  // ---------- Validate rate_
  function do_ajax_form_tbitemdrugsell_validate_rate_(iNumLinha)
  {
    var nomeCampo_rate_ = "rate_" + iNumLinha;
    var var_rate_ = scAjaxGetFieldText(nomeCampo_rate_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbitemdrugsell_validate_rate_(var_rate_, iNumLinha, var_script_case_init, do_ajax_form_tbitemdrugsell_validate_rate__cb);
  } // do_ajax_form_tbitemdrugsell_validate_rate_

  function do_ajax_form_tbitemdrugsell_validate_rate__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbitemdrugsell_validate_rate__cb

  // ---------- Validate sediaan_
  function do_ajax_form_tbitemdrugsell_validate_sediaan_(iNumLinha)
  {
    var nomeCampo_sediaan_ = "sediaan_" + iNumLinha;
    var var_sediaan_ = scAjaxGetFieldSelect(nomeCampo_sediaan_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbitemdrugsell_validate_sediaan_(var_sediaan_, iNumLinha, var_script_case_init, do_ajax_form_tbitemdrugsell_validate_sediaan__cb);
  } // do_ajax_form_tbitemdrugsell_validate_sediaan_

  function do_ajax_form_tbitemdrugsell_validate_sediaan__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "sediaan_" + iLineNumber;
    }
    else
    {
      sFieldValid = "sediaan_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "sediaan_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "sediaan_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbitemdrugsell_validate_sediaan__cb

  // ---------- Validate id_
  function do_ajax_form_tbitemdrugsell_validate_id_(iNumLinha)
  {
    var nomeCampo_id_ = "id_" + iNumLinha;
    var var_id_ = scAjaxGetFieldHidden(nomeCampo_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbitemdrugsell_validate_id_(var_id_, iNumLinha, var_script_case_init, do_ajax_form_tbitemdrugsell_validate_id__cb);
  } // do_ajax_form_tbitemdrugsell_validate_id_

  function do_ajax_form_tbitemdrugsell_validate_id__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbitemdrugsell_validate_id__cb

  // ---------- Refresh itemcode_
  function do_ajax_form_tbitemdrugsell_refresh_itemcode_(iSeqForm)
  {
    var var_itemcode_ = scAjaxGetFieldSelect("itemcode_" + iSeqForm);
    var var_nmgp_refresh_row = iSeqForm;
    var var_nmgp_refresh_fields = "sediaan__#fld#_stok_";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tbitemdrugsell_refresh_itemcode_(var_itemcode_, var_nmgp_refresh_row, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_tbitemdrugsell_refresh_itemcode__cb);
  } // do_ajax_form_tbitemdrugsell_refresh_itemcode_

  function do_ajax_form_tbitemdrugsell_refresh_itemcode__cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbitemdrugsell_refresh_itemcode__cb

  // ---------- Event onchange itemcode_
  function do_ajax_form_tbitemdrugsell_event_itemcode__onchange(iSeqForm)
  {
    var var_itemcode_ = scAjaxGetFieldSelect("itemcode_" + iSeqForm);
    var var_rate_ = scAjaxGetFieldText("rate_" + iSeqForm);
    var var_script_case_init = document.F2.script_case_init.value;
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_tbitemdrugsell_event_itemcode__onchange(var_itemcode_, var_rate_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_tbitemdrugsell_event_itemcode__onchange_cb);
  } // do_ajax_form_tbitemdrugsell_event_itemcode__onchange

  function do_ajax_form_tbitemdrugsell_event_itemcode__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_tbitemdrugsell_event_itemcode__onchange_cb_after_alert);
  } // do_ajax_form_tbitemdrugsell_event_itemcode__onchange_cb
  function do_ajax_form_tbitemdrugsell_event_itemcode__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    do_ajax_form_tbitemdrugsell_refresh_itemcode_(iLineNumber);
    scAjaxRedir();
  } // do_ajax_form_tbitemdrugsell_event_itemcode__onchange_cb_after_alert

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_tbitemdrugsell_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_tbitemdrugsell_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tbitemdrugsell_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_tbitemdrugsell_add_new_line_cb);
  } // do_ajax_form_tbitemdrugsell_add_new_line

  function do_ajax_form_tbitemdrugsell_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_tbitemdrugsell_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_tbitemdrugsell_backup_line(iNumLinha)
  {
    var var_id_ = scAjaxGetFieldHidden("id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbitemdrugsell_backup_line(var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_tbitemdrugsell_backup_line_cb);
  } // do_ajax_form_tbitemdrugsell_backup_line

  function do_ajax_form_tbitemdrugsell_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_tbitemdrugsell_backup_line_cb

  function do_ajax_form_tbitemdrugsell_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_tbitemdrugsell_cancel_insert

  function do_ajax_form_tbitemdrugsell_cancel_update(iSeqVert)
  {
    do_ajax_form_tbitemdrugsell_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_tbitemdrugsell_cancel_update

  function do_ajax_form_tbitemdrugsell_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_tbitemdrugsell_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_tbitemdrugsell_table_refresh()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tbitemdrugsell_table_refresh(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbitemdrugsell_table_refresh_cb);
  } //  do_ajax_form_tbitemdrugsell_table_refresh

  function do_ajax_form_tbitemdrugsell_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_tbitemdrugsell_table_refresh_cb_after_alert);
  } // do_ajax_form_tbitemdrugsell_table_refresh_cb
  function do_ajax_form_tbitemdrugsell_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_tbitemdrugsell_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_tbitemdrugsell_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_tbitemdrugsell_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    sc_num_ult_line = iNumLinha;
    sc_num_ult_tr   = indexTR;
    scAjaxHideMessage();
    var var_itemcode_ = scAjaxGetFieldSelect("itemcode_" + iNumLinha);
    ...
    var var_sediaan_ = scAjaxGetFieldSelect("sediaan_" + iNumLinha);
    var var_id_ = scAjaxGetFieldHidden("id_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_tbitemdrugsell_submit_form(var_itemcode_, var_stok_, var_jumlah_, var_disc_, var_rate_, var_sediaan_, var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbitemdrugsell_submit_form_cb);
  } // do_ajax_form_tbitemdrugsell_submit_form

  function do_ajax_form_tbitemdrugsell_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("itemcode_" + sc_num_ult_line);
      ...
      scAjaxHideErrorDisplay("sediaan_" + sc_num_ult_line);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_tbitemdrugsell_submit_form_cb_after_alert);
  } // do_ajax_form_tbitemdrugsell_submit_form_cb
  function do_ajax_form_tbitemdrugsell_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbitemdrugsell_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tbitemdrugsell_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_tbitemdrugsell_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("itemcode_" + iNavForm);
      ...
      scAjaxHideErrorDisplay("sediaan_" + iNavForm);
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tbitemdrugsell_navigate_form(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbitemdrugsell_navigate_form_cb);
  } // do_ajax_form_tbitemdrugsell_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbitemdrugsell']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbitemdrugsell_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbitemdrugsell_navigate_form_cb_after_alert);
  } // do_ajax_form_tbitemdrugsell_navigate_form_cb
  function do_ajax_form_tbitemdrugsell_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_tbitemdrugsell_navigate_form_cb_after_alert
  function sc_hide_form_tbitemdrugsell_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "itemcode_" + iNumLinha;
    iTotCampos++;
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "sediaan_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "id_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["itemcode_" + iNumLinha] = {"label": "Item / Obat<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_error_list["rate_" + iNumLinha] = {"label": "Harga<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["sediaan_" + iNumLinha] = {"label": "Sediaan<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_field_mult["itemcode_"][iNumLinha] = "itemcode_" + iNumLinha;
    ...
    ajax_field_mult["sediaan_"][iNumLinha] = "sediaan_" + iNumLinha;
    ajax_field_mult["id_"][iNumLinha] = "id_" + iNumLinha;
    ajax_field_id["itemcode_" + iNumLinha] = new Array("hidden_field_label_itemcode_", "hidden_field_data_itemcode_" + iNumLinha);
    ...
    ajax_field_id["sediaan_" + iNumLinha] = new Array("hidden_field_label_sediaan_", "hidden_field_data_sediaan_" + iNumLinha);
    ajax_error_count["itemcode_" + iNumLinha] = "off";
    ...
    ajax_error_count["sediaan_" + iNumLinha] = "off";
    ajax_error_count["id_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["itemcode_" + iNumLinha] = "off";
    ...
    ajax_read_only["sediaan_" + iNumLinha] = "off";
...
{
?>
    ajax_read_only["itemcode_" + iNumLinha] = "on";
    ...
    ajax_read_only["sediaan_" + iNumLinha] = "on";
    ajax_read_only["id_" + iNumLinha] = "on";
<?php
}
?>
  ...
  {
    ajax_error_list["itemcode_" + iNumLinha] = null;
    ...
    ajax_error_list["sediaan_" + iNumLinha] = null;
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["itemcode_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["itemcode_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["itemcode_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["itemcode_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["itemcode_" + iNumLinha]["onfocus"] = new Array();
      ...
      ajax_error_list["sediaan_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["sediaan_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["sediaan_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["sediaan_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["sediaan_" + iNumLinha]["onfocus"] = new Array();
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['itemcode_'])) ? $this->nmgp_cmp_readonly['itemcode_'] : 'off';
?>
    scAjaxFieldRead("itemcode_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['sediaan_'])) ? $this->nmgp_cmp_readonly['sediaan_'] : 'off';
?>
    scAjaxFieldRead("sediaan_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["itemcode_" + iRow] || "on" == ajax_error_count["stok_" + iRow] || "on" == ajax_error_count["jumlah_" + iRow] || "on" == ajax_error_count["disc_" + iRow] || "on" == ajax_error_count["rate_" + iRow] || "on" == ajax_error_count["sediaan_" + iRow] || "on" == ajax_error_count["id_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_itemcode_" + iRow).addClass("scFormErrorLine");
      ...
      $("#hidden_field_data_sediaan_" + iRow).addClass("scFormErrorLine");
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["itemcode_" + iRow] && "off" == ajax_error_count["stok_" + iRow] && "off" == ajax_error_count["jumlah_" + iRow] && "off" == ajax_error_count["disc_" + iRow] && "off" == ajax_error_count["rate_" + iRow] && "off" == ajax_error_count["sediaan_" + iRow] && "off" == ajax_error_count["id_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["itemcode_" + iRow] = "off";
        ...
        ajax_error_count["sediaan_" + iRow] = "off";
      ...
      $("#hidden_field_data_itemcode_" + iRow).removeClass("scFormErrorLine");
      ...
      $("#hidden_field_data_sediaan_" + iRow).removeClass("scFormErrorLine");
