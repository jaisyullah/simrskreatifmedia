<?php
class form_tbitemdrugsell_form extends form_tbitemdrugsell_apl
{
function Form_Init()
{
...
<?php
if ($this->Embutida_form && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbitemdrugsell']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbitemdrugsell']['sc_modal'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbitemdrugsell']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbitemdrugsell']['sc_redir_atualiz'] == 'ok')
{
?>
...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbitemdrugsell']['embutida_pdf']))
 {
 ?>
...
<?php
include_once("form_tbitemdrugsell_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_tbitemdrugsell_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbitemdrugsell']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbitemdrugsell']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbitemdrugsell']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbitemdrugsell']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbitemdrugsell']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbitemdrugsell']['recarga'];
}
if ('novo' == $opcao_botoes && $this->Embutida_form)
{
    $opcao_botoes = 'inicio';
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbitemdrugsell']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbitemdrugsell']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
?>
...
<?php
 include_once("form_tbitemdrugsell_js0.php");
?>
<script type="text/javascript"> 
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_tbitemdrugsell'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_tbitemdrugsell'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbitemdrugsell']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbitemdrugsell']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbitemdrugsell']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbitemdrugsell']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbitemdrugsell']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<div class="scFormHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFormHeaderFont" style="float: left; text-transform: uppercase;"><?php if ($this->nmgp_opcao == "novo") { echo "" . $this->Ini->Nm_lang['lang_othr_frmi_title'] . " tbitemdrugsell"; } else { echo "" . $this->Ini->Nm_lang['lang_othr_frmu_title'] . " tbitemdrugsell"; } ?></div>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbitemdrugsell']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbitemdrugsell']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbitemdrugsell']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbitemdrugsell']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbitemdrugsell']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbitemdrugsell']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbitemdrugsell']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbitemdrugsell']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbitemdrugsell']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbitemdrugsell']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbitemdrugsell']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbitemdrugsell']['fast_search'][2] : "";
?> 
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbitemdrugsell']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbitemdrugsell']['run_iframe'] != "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbitemdrugsell']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbitemdrugsell']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbitemdrugsell']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbitemdrugsell']['run_iframe'] == "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbitemdrugsell']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbitemdrugsell']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbitemdrugsell']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbitemdrugsell']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbitemdrugsell']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbitemdrugsell']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbitemdrugsell']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbitemdrugsell']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbitemdrugsell']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbitemdrugsell']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbitemdrugsell']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbitemdrugsell']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
 ...
 ?>
   ...
   <?php if ($this->Embutida_form && $this->nmgp_botoes['insert'] != "on") {?>
    <TD class="scFormLabelOddMult"  width="10"> &nbsp; </TD>
   <?php }?>
   <?php if (isset($this->nmgp_cmp_hidden['itemcode_']) && $this->nmgp_cmp_hidden['itemcode_'] == 'off') { $sStyleHidden_itemcode_ = 'display: none'; }
      if (1 || !isset($this->nmgp_cmp_hidden['itemcode_']) || $this->nmgp_cmp_hidden['itemcode_'] == 'on') {
      if (!isset($this->nm_new_label['itemcode_'])) {
          $this->nm_new_label['itemcode_'] = "Item / Obat"; } ?>

    <TD class="scFormLabelOddMult css_itemcode__label" id="hidden_field_label_itemcode_" style="<?php echo $sStyleHidden_itemcode_; ?>" > <?php echo $this->nm_new_label['itemcode_'] ?> </TD>
   <?php } ?>
   ...
   <?php if (isset($this->nmgp_cmp_hidden['sediaan_']) && $this->nmgp_cmp_hidden['sediaan_'] == 'off') { $sStyleHidden_sediaan_ = 'display: none'; }
      if (1 || !isset($this->nmgp_cmp_hidden['sediaan_']) || $this->nmgp_cmp_hidden['sediaan_'] == 'on') {
      if (!isset($this->nm_new_label['sediaan_'])) {
          $this->nm_new_label['sediaan_'] = "Sediaan"; } ?>

    <TD class="scFormLabelOddMult css_sediaan__label" id="hidden_field_label_sediaan_" style="<?php echo $sStyleHidden_sediaan_; ?>" > <?php echo $this->nm_new_label['sediaan_'] ?> </TD>
   <?php } ?>
...
{ 
   ...
   { 
       ob_start();
       $iStart = sizeof($this->form_vert_form_tbitemdrugsell);
       $guarda_nmgp_opcao = $this->nmgp_opcao;
       $guarda_form_vert_form_tbitemdrugsell = $this->form_vert_form_tbitemdrugsell;
       $this->nmgp_opcao = 'novo';
   } 
   if ($this->Embutida_form && empty($this->form_vert_form_tbitemdrugsell))
   {
       $sc_seq_vert = 0;
   }
   ...
   foreach ($this->form_vert_form_tbitemdrugsell as $sc_seq_vert => $sc_lixo)
   {
       $this->loadRecordState($sc_seq_vert);
       $this->trancode_ = $this->form_vert_form_tbitemdrugsell[$sc_seq_vert]['trancode_'];
       $this->itemname_ = $this->form_vert_form_tbitemdrugsell[$sc_seq_vert]['itemname_'];
       $this->kemasan_ = $this->form_vert_form_tbitemdrugsell[$sc_seq_vert]['kemasan_'];
       $this->ratebeli_ = $this->form_vert_form_tbitemdrugsell[$sc_seq_vert]['ratebeli_'];
       if (isset($this->Embutida_ronly) && $this->Embutida_ronly && !$Line_Add)
       {
           $this->nmgp_cmp_readonly['itemcode_'] = true;
           ...
           $this->nmgp_cmp_readonly['sediaan_'] = true;
           $this->nmgp_cmp_readonly['id_'] = true;
       }
       elseif ($Line_Add)
       {
           if (!isset($this->nmgp_cmp_readonly['itemcode_']) || $this->nmgp_cmp_readonly['itemcode_'] != "on") {$this->nmgp_cmp_readonly['itemcode_'] = false;}
           ...
           if (!isset($this->nmgp_cmp_readonly['sediaan_']) || $this->nmgp_cmp_readonly['sediaan_'] != "on") {$this->nmgp_cmp_readonly['sediaan_'] = false;}
       ...
       if (isset($sCheckRead_itemcode_))
       {
           unset($sCheckRead_itemcode_);
       }
       if (isset($this->nmgp_cmp_readonly['itemcode_']))
       {
           $sCheckRead_itemcode_ = $this->nmgp_cmp_readonly['itemcode_'];
       }
       ...
       $bTestReadOnly_itemcode_ = true;
       $sStyleReadLab_itemcode_ = 'display: none;';
       $sStyleReadInp_itemcode_ = '';
       if (isset($this->nmgp_cmp_readonly['itemcode_']) && $this->nmgp_cmp_readonly['itemcode_'] == 'on')
       {
           $bTestReadOnly_itemcode_ = false;
           unset($this->nmgp_cmp_readonly['itemcode_']);
           $sStyleReadLab_itemcode_ = '';
           $sStyleReadInp_itemcode_ = 'display: none;';
       }
       $this->stok_ = $this->form_vert_form_tbitemdrugsell[$sc_seq_vert]['stok_']; 
       $stok_ = $this->stok_; 
       $sStyleHidden_stok_ = '';
       ...
       $this->jumlah_ = $this->form_vert_form_tbitemdrugsell[$sc_seq_vert]['jumlah_']; 
       ...
       $this->disc_ = $this->form_vert_form_tbitemdrugsell[$sc_seq_vert]['disc_']; 
       $disc_ = $this->disc_; 
       $sStyleHidden_disc_ = '';
       ...
       $this->rate_ = $this->form_vert_form_tbitemdrugsell[$sc_seq_vert]['rate_']; 
       $rate_ = $this->rate_; 
       $sStyleHidden_rate_ = '';
       ...
       $this->sediaan_ = $this->form_vert_form_tbitemdrugsell[$sc_seq_vert]['sediaan_']; 
       $sediaan_ = $this->sediaan_; 
       $sStyleHidden_sediaan_ = '';
       if (isset($sCheckRead_sediaan_))
       {
           unset($sCheckRead_sediaan_);
       }
       if (isset($this->nmgp_cmp_readonly['sediaan_']))
       {
           $sCheckRead_sediaan_ = $this->nmgp_cmp_readonly['sediaan_'];
       }
       ...
       $bTestReadOnly_sediaan_ = true;
       $sStyleReadLab_sediaan_ = 'display: none;';
       $sStyleReadInp_sediaan_ = '';
       if (isset($this->nmgp_cmp_readonly['sediaan_']) && $this->nmgp_cmp_readonly['sediaan_'] == 'on')
       {
           $bTestReadOnly_sediaan_ = false;
           unset($this->nmgp_cmp_readonly['sediaan_']);
           $sStyleReadLab_sediaan_ = '';
           $sStyleReadInp_sediaan_ = 'display: none;';
       }
       $this->id_ = $this->form_vert_form_tbitemdrugsell[$sc_seq_vert]['id_']; 
       $id_ = $this->id_; 
       if (!isset($this->nmgp_cmp_hidden['id_']))
       {
           $this->nmgp_cmp_hidden['id_'] = 'off';
...
<?php echo nmButtonOutput($this->arr_buttons, "bmd_novo", "do_ajax_form_tbitemdrugsell_add_new_line(" . $sc_seq_vert . ")", "do_ajax_form_tbitemdrugsell_add_new_line(" . $sc_seq_vert . ")", "sc_new_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
<?php }?>
<?php
  $Style_add_line = (!$Line_Add) ? "display: none" : "";
?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_form_tbitemdrugsell_cancel_insert(" . $sc_seq_vert . ")", "do_ajax_form_tbitemdrugsell_cancel_insert(" . $sc_seq_vert . ")", "sc_canceli_line_" . $sc_seq_vert . "", "", "", "" . $Style_add_line . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_form_tbitemdrugsell_cancel_update(" . $sc_seq_vert . ")", "do_ajax_form_tbitemdrugsell_cancel_update(" . $sc_seq_vert . ")", "sc_cancelu_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
 </TD>
   <?php }?>
   <?php if (isset($this->nmgp_cmp_hidden['itemcode_']) && $this->nmgp_cmp_hidden['itemcode_'] == 'off') { $sc_hidden_yes++; ?>
<input type=hidden name="itemcode_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($this->itemcode_) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormDataOddMult css_itemcode__line" id="hidden_field_data_itemcode_<?php echo $sc_seq_vert; ?>" style="<?php echo $sStyleHidden_itemcode_; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOddMult css_itemcode__line" style="vertical-align: top;padding: 0px">
<?php if ($bTestReadOnly_itemcode_ && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["itemcode_"]) &&  $this->nmgp_cmp_readonly["itemcode_"] == "on") { 
...
?>
<input type="hidden" name="itemcode_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($itemcode_) . "\">" . $itemcode__look . ""; ?>
<?php } else { ?>
<?php
   ...
   $x = 0; 
   echo "<span id=\"id_read_on_itemcode_" . $sc_seq_vert . "\" class=\"css_itemcode__line\" style=\"" .  $sStyleReadLab_itemcode_ . "\">" . $this->form_encode_input($itemcode__look) . "</span><span id=\"id_read_off_itemcode_" . $sc_seq_vert . "\" class=\"css_read_off_itemcode_\" style=\"white-space: nowrap; " . $sStyleReadInp_itemcode_ . "\">";
   echo " <span id=\"idAjaxSelect_itemcode_" .  $sc_seq_vert . "\"><select class=\"sc-js-input scFormObjectOddMult css_itemcode__obj\" style=\"\" id=\"id_sc_field_itemcode_" . $sc_seq_vert . "\" name=\"itemcode_" . $sc_seq_vert . "\" size=\"1\" alt=\"{type: 'select', enterTab: false}\">" ; 
   echo "\r" ; 
...
?> 
<?php  }?>
</td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_itemcode_<?php echo $sc_seq_vert; ?>_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_itemcode_<?php echo $sc_seq_vert; ?>_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
<input type=hidden name="sediaan_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($this->sediaan_) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormDataOddMult css_sediaan__line" id="hidden_field_data_sediaan_<?php echo $sc_seq_vert; ?>" style="<?php echo $sStyleHidden_sediaan_; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOddMult css_sediaan__line" style="vertical-align: top;padding: 0px">
<?php if ($bTestReadOnly_sediaan_ && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["sediaan_"]) &&  $this->nmgp_cmp_readonly["sediaan_"] == "on") { 
...
?>
<input type="hidden" name="sediaan_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($sediaan_) . "\">" . $sediaan__look . ""; ?>
<?php } else { ?>
<?php
   ...
   $x = 0; 
   echo "<span id=\"id_read_on_sediaan_" . $sc_seq_vert . "\" class=\"css_sediaan__line\" style=\"" .  $sStyleReadLab_sediaan_ . "\">" . $this->form_encode_input($sediaan__look) . "</span><span id=\"id_read_off_sediaan_" . $sc_seq_vert . "\" class=\"css_read_off_sediaan_\" style=\"white-space: nowrap; " . $sStyleReadInp_sediaan_ . "\">";
   echo " <span id=\"idAjaxSelect_sediaan_" .  $sc_seq_vert . "\"><select class=\"sc-js-input scFormObjectOddMult css_sediaan__obj\" style=\"\" id=\"id_sc_field_sediaan_" . $sc_seq_vert . "\" name=\"sediaan_" . $sc_seq_vert . "\" size=\"1\" alt=\"{type: 'select', enterTab: false}\">" ; 
   echo "\r" ; 
   while (!empty($todo[$x]) && !$nm_nao_carga) 
   {
          $cadaselect = explode("?#?", $todo[$x]) ; 
...
?> 
<?php  }?>
</td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_sediaan_<?php echo $sc_seq_vert; ?>_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_sediaan_<?php echo $sc_seq_vert; ?>_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
<?php   
        if (isset($sCheckRead_itemcode_))
       {
           $this->nmgp_cmp_readonly['itemcode_'] = $sCheckRead_itemcode_;
       }
       if ('display: none;' == $sStyleHidden_itemcode_)
       {
           $this->nmgp_cmp_hidden['itemcode_'] = 'off';
       }
       if (isset($sCheckRead_stok_))
       {
       ...
       if (isset($sCheckRead_sediaan_))
       {
           $this->nmgp_cmp_readonly['sediaan_'] = $sCheckRead_sediaan_;
       }
       if ('display: none;' == $sStyleHidden_sediaan_)
       {
           $this->nmgp_cmp_hidden['sediaan_'] = 'off';
       }
       if (isset($sCheckRead_id_))
       {
   ...
   { 
       ...
       $this->form_vert_form_tbitemdrugsell = $guarda_form_vert_form_tbitemdrugsell;
   } 
   if ($Table_refresh) 
   { 
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbitemdrugsell']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbitemdrugsell']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbitemdrugsell']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbitemdrugsell']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbitemdrugsell']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbitemdrugsell']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbitemdrugsell']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbitemdrugsell']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbitemdrugsell']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<?php
if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbitemdrugsell']['run_modal']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbitemdrugsell']['run_modal'])
{
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbitemdrugsell']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbitemdrugsell']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_tbitemdrugsell");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_tbitemdrugsell");
 parent.scAjaxDetailHeight("form_tbitemdrugsell", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbitemdrugsell']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
