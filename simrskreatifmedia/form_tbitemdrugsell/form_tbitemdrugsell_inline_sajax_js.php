  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbitemdrugsell_inline" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbitemdrugsell_inline_form();
	}

  // ---------- Validate itemcode_
  function do_ajax_form_tbitemdrugsell_inline_validate_itemcode_()
  {
    var nomeCampo_itemcode_ = "itemcode_";
    var var_itemcode_ = scAjaxGetFieldSelect(nomeCampo_itemcode_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbitemdrugsell_inline_validate_itemcode_(var_itemcode_, var_script_case_init, do_ajax_form_tbitemdrugsell_inline_validate_itemcode__cb);
  } // do_ajax_form_tbitemdrugsell_inline_validate_itemcode_

  function do_ajax_form_tbitemdrugsell_inline_validate_itemcode__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbitemdrugsell_inline_validate_itemcode__cb

  // ---------- Validate stok_
  function do_ajax_form_tbitemdrugsell_inline_validate_stok_()
  {
    var nomeCampo_stok_ = "stok_";
    var var_stok_ = scAjaxGetFieldSelect(nomeCampo_stok_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbitemdrugsell_inline_validate_stok_(var_stok_, var_script_case_init, do_ajax_form_tbitemdrugsell_inline_validate_stok__cb);
  } // do_ajax_form_tbitemdrugsell_inline_validate_stok_

  function do_ajax_form_tbitemdrugsell_inline_validate_stok__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "stok_";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbitemdrugsell_inline_validate_stok__cb

  // ---------- Validate jumlah_
  function do_ajax_form_tbitemdrugsell_inline_validate_jumlah_()
  {
    var nomeCampo_jumlah_ = "jumlah_";
    var var_jumlah_ = scAjaxGetFieldText(nomeCampo_jumlah_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbitemdrugsell_inline_validate_jumlah_(var_jumlah_, var_script_case_init, do_ajax_form_tbitemdrugsell_inline_validate_jumlah__cb);
  } // do_ajax_form_tbitemdrugsell_inline_validate_jumlah_

  function do_ajax_form_tbitemdrugsell_inline_validate_jumlah__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "jumlah_";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbitemdrugsell_inline_validate_jumlah__cb

  // ---------- Validate disc_
  function do_ajax_form_tbitemdrugsell_inline_validate_disc_()
  {
    var nomeCampo_disc_ = "disc_";
    var var_disc_ = scAjaxGetFieldText(nomeCampo_disc_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbitemdrugsell_inline_validate_disc_(var_disc_, var_script_case_init, do_ajax_form_tbitemdrugsell_inline_validate_disc__cb);
  } // do_ajax_form_tbitemdrugsell_inline_validate_disc_

  function do_ajax_form_tbitemdrugsell_inline_validate_disc__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "disc_";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbitemdrugsell_inline_validate_disc__cb

  // ---------- Validate rate_
  function do_ajax_form_tbitemdrugsell_inline_validate_rate_()
  {
    var nomeCampo_rate_ = "rate_";
    var var_rate_ = scAjaxGetFieldText(nomeCampo_rate_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbitemdrugsell_inline_validate_rate_(var_rate_, var_script_case_init, do_ajax_form_tbitemdrugsell_inline_validate_rate__cb);
  } // do_ajax_form_tbitemdrugsell_inline_validate_rate_

  function do_ajax_form_tbitemdrugsell_inline_validate_rate__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "rate_";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbitemdrugsell_inline_validate_rate__cb

  // ---------- Validate sediaan_
  function do_ajax_form_tbitemdrugsell_inline_validate_sediaan_()
  {
    var nomeCampo_sediaan_ = "sediaan_";
    var var_sediaan_ = scAjaxGetFieldSelect(nomeCampo_sediaan_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbitemdrugsell_inline_validate_sediaan_(var_sediaan_, var_script_case_init, do_ajax_form_tbitemdrugsell_inline_validate_sediaan__cb);
  } // do_ajax_form_tbitemdrugsell_inline_validate_sediaan_

  function do_ajax_form_tbitemdrugsell_inline_validate_sediaan__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbitemdrugsell_inline_validate_sediaan__cb

  // ---------- Validate id_
  function do_ajax_form_tbitemdrugsell_inline_validate_id_()
  {
    var nomeCampo_id_ = "id_";
    var var_id_ = scAjaxGetFieldHidden(nomeCampo_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbitemdrugsell_inline_validate_id_(var_id_, var_script_case_init, do_ajax_form_tbitemdrugsell_inline_validate_id__cb);
  } // do_ajax_form_tbitemdrugsell_inline_validate_id_

  function do_ajax_form_tbitemdrugsell_inline_validate_id__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id_";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbitemdrugsell_inline_validate_id__cb

  // ---------- Refresh itemcode_
  function do_ajax_form_tbitemdrugsell_inline_refresh_itemcode_()
  {
    var var_itemcode_ = scAjaxGetFieldSelect("itemcode_");
    var var_nmgp_refresh_fields = "sediaan__#fld#_stok_";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tbitemdrugsell_inline_refresh_itemcode_(var_itemcode_, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_tbitemdrugsell_inline_refresh_itemcode__cb);
  } // do_ajax_form_tbitemdrugsell_inline_refresh_itemcode_

  function do_ajax_form_tbitemdrugsell_inline_refresh_itemcode__cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbitemdrugsell_inline_refresh_itemcode__cb

  // ---------- Event onchange itemcode_
  function do_ajax_form_tbitemdrugsell_inline_event_itemcode__onchange()
  {
    var var_itemcode_ = scAjaxGetFieldSelect("itemcode_");
    var var_rate_ = scAjaxGetFieldText("rate_");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tbitemdrugsell_inline_event_itemcode__onchange(var_itemcode_, var_rate_, var_script_case_init, do_ajax_form_tbitemdrugsell_inline_event_itemcode__onchange_cb);
  } // do_ajax_form_tbitemdrugsell_inline_event_itemcode__onchange

  function do_ajax_form_tbitemdrugsell_inline_event_itemcode__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "itemcode_";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_tbitemdrugsell_inline_event_itemcode__onchange_cb_after_alert);
  } // do_ajax_form_tbitemdrugsell_inline_event_itemcode__onchange_cb
  function do_ajax_form_tbitemdrugsell_inline_event_itemcode__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    do_ajax_form_tbitemdrugsell_inline_refresh_itemcode_();
    scAjaxRedir();
  } // do_ajax_form_tbitemdrugsell_inline_event_itemcode__onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tbitemdrugsell_inline_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tbitemdrugsell_inline_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_itemcode_ = scAjaxGetFieldSelect("itemcode_");
    var var_stok_ = scAjaxGetFieldSelect("stok_");
    var var_jumlah_ = scAjaxGetFieldText("jumlah_");
    var var_disc_ = scAjaxGetFieldText("disc_");
    var var_rate_ = scAjaxGetFieldText("rate_");
    var var_sediaan_ = scAjaxGetFieldSelect("sediaan_");
    ...
    scAjaxProcOn();
    x_ajax_form_tbitemdrugsell_inline_submit_form(var_itemcode_, var_stok_, var_jumlah_, var_disc_, var_rate_, var_sediaan_, var_id_, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbitemdrugsell_inline_submit_form_cb);
  } // do_ajax_form_tbitemdrugsell_inline_submit_form

  function do_ajax_form_tbitemdrugsell_inline_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("itemcode_");
      scAjaxHideErrorDisplay("stok_");
      scAjaxHideErrorDisplay("jumlah_");
      scAjaxHideErrorDisplay("disc_");
      scAjaxHideErrorDisplay("rate_");
      scAjaxHideErrorDisplay("sediaan_");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tbitemdrugsell_inline_submit_form_cb_after_alert);
  } // do_ajax_form_tbitemdrugsell_inline_submit_form_cb
  function do_ajax_form_tbitemdrugsell_inline_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbitemdrugsell_inline_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tbitemdrugsell_inline_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tbitemdrugsell_inline_navigate_form(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbitemdrugsell_inline_navigate_form_cb);
  } // do_ajax_form_tbitemdrugsell_inline_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbitemdrugsell_inline']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbitemdrugsell_inline_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbitemdrugsell_inline_navigate_form_cb_after_alert);
  } // do_ajax_form_tbitemdrugsell_inline_navigate_form_cb
  function do_ajax_form_tbitemdrugsell_inline_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_tbitemdrugsell_inline_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_tbitemdrugsell_inline_navigate_form_cb_after_alert
  function sc_hide_form_tbitemdrugsell_inline_form()
  {
  ...
  ajax_field_list[0] = "itemcode_";
  ajax_field_list[1] = "stok_";
  ajax_field_list[2] = "jumlah_";
  ajax_field_list[3] = "disc_";
  ajax_field_list[4] = "rate_";
  ajax_field_list[5] = "sediaan_";
  ajax_field_list[6] = "id_";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "itemcode_": {"label": "Item / Obat", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "disc_": {"label": "Diskon", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "rate_": {"label": "Harga", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "sediaan_": {"label": "Sediaan", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  ajax_field_mult["itemcode_"][1] = "itemcode_";
  ajax_field_mult["stok_"][1] = "stok_";
  ajax_field_mult["jumlah_"][1] = "jumlah_";
  ajax_field_mult["disc_"][1] = "disc_";
  ajax_field_mult["rate_"][1] = "rate_";
  ajax_field_mult["sediaan_"][1] = "sediaan_";
  ajax_field_mult["id_"][1] = "id_";

  var ajax_field_id = {
    "itemcode_": new Array("hidden_field_label_itemcode_", "hidden_field_data_itemcode_"),
    ...
    "disc_": new Array("hidden_field_label_disc_", "hidden_field_data_disc_"),
    "rate_": new Array("hidden_field_label_rate_", "hidden_field_data_rate_"),
    "sediaan_": new Array("hidden_field_label_sediaan_", "hidden_field_data_sediaan_")
  };
