...
$old_error_handler = set_error_handler("ambilFormula_endos_scriptcase_error_handler");

function ambilFormula_endos_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['ambilFormula_endos']['contr_erro']) && $_SESSION['scriptcase']['ambilFormula_endos']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_ambilFormula_endos->contr_ambilFormula_endos->Apl_com_erro = true;
            if ($inicial_ambilFormula_endos->contr_ambilFormula_endos->NM_ajax_flag)
            {
                $inicial_ambilFormula_endos->contr_ambilFormula_endos->NM_ajax_info['errList']['geral_ambilFormula_endos'][] = $msg;
                return;
            }
            ambilFormula_endos_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function ambilFormula_endos_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['ambilFormula_endos'])  && '' != $_SESSION['scriptcase']['error_icon']['ambilFormula_endos'])  ? $_SESSION['scriptcase']['error_icon']['ambilFormula_endos']  : "";
        $sCloseIcon      = (isset($_SESSION['scriptcase']['error_close']['ambilFormula_endos']) && '' != $_SESSION['scriptcase']['error_close']['ambilFormula_endos']) ? $_SESSION['scriptcase']['error_close']['ambilFormula_endos'] : "<td><input class=\"scButton_default\" type=\"button\" onClick=\"document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false\" value=\"X\" /></td>";

        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['ambilFormula_endos']) && '' != $_SESSION['scriptcase']['error_span_title']['ambilFormula_endos']) ? $_SESSION['scriptcase']['error_span_title']['ambilFormula_endos'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['ambilFormula_endos']) && '' != $_SESSION['scriptcase']['error_icon_title']['ambilFormula_endos']) ? $_SESSION['scriptcase']['error_icon_title']['ambilFormula_endos'] : '';
?>
...
<?php
    ...
    $_SESSION['scriptcase']['ambilFormula_endos']['error_buffer'] .= ob_get_flush();
}
