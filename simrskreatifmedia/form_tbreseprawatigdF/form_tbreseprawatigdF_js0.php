...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_tbreseprawatigdF"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
function scForm_inline_submit(y, z) {
	Nm_Proc_Atualiz = true;
	do_ajax_form_tbreseprawatigdF_submit_form(y, z);
...
{
   nm_field_disabled("trandate_=disabled", "");
   nm_field_disabled("biaya_=disabled", "U");
