<?php
@session_start() ;
$_SESSION['scriptcase']['chart_detail_dokter']['sc_process_barr'] = true;
require_once('../chart_detail_dokter/index.php');
unset($_SESSION['scriptcase']['chart_detail_dokter']['sc_process_barr']);
$ExportCtrl = new chart_detail_dokter_export_control;
$ExportCtrl->Export_barr();

class chart_detail_dokter_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_chart_title'] ?> tbantrian :: Excel</TITLE>
