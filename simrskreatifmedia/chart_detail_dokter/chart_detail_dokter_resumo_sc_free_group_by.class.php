...
class chart_detail_dokter_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function initializeButtons()
   {
      ...
      $this->nmgp_botoes['chart_exit'] = isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['dashboard_info']['under_dashboard'] ? "off" : "on";

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['chart_detail_dokter'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['chart_detail_dokter'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['chart_detail_dokter']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['chart_detail_dokter']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['chart_detail_dokter']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
   ...
   { 
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['export_progress_step']     = 'image';
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['export_progress_step'] = 'end';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['chart_detail_dokter']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
      ...
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['where_pesq_filtro'];
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['campos_busca']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['campos_busca']))
     { 
         $Busca_temp = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['campos_busca'];
         ...
         {
             ob_start();
             $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['chart_combination_type'] = $_POST['fc_chart_type'];
         }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['pivot_y_axys']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['pivot_y_axys']))
       {
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['pivot_x_axys']             = array();
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['pivot_y_axys']             = array();
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['summarizing_fields_order'] = array();
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['comb_field_display_type']  = array();
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['chart_display_values']     = array();

           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['chart_combination_type']        = 'column2d';
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['chart_combination_order_rule']  = 'asc';
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['chart_combination_order_field'] = 'label';
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['chart_combination_order_rule_groupby']["regdate"]  = 'asc';
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['chart_combination_order_field_groupby']["regdate"] = 'label';
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['chart_combination_order_rule_groupby']["doctor"]  = 'asc';
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['chart_combination_order_field_groupby']["doctor"] = 'label';

           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['pivot_y_axys'][0] = 0;
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['pivot_y_axys'][1] = 1;
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['comb_field_display_type'][2] = '';

           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['chart_display_values'][2] = null;


           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['summarizing_fields_order']['sc_free_group_by'][] = 2;
       }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['pesq_tab_label']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['pesq_tab_label'] = "";
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['grid_search_add']))
      {
          $this->monta_css();
          $nmgp_tab_label = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['pesq_tab_label'];
          ...
          $Seq_grid      = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['grid_search_add']['seq'];
          $Cmp_grid      = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['grid_search_add']['cmp'];
          ...
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['grid_search_add']);
          exit;
      }
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['res_hrz'];
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']) && !$this->NM_export)
      {
          foreach ($_SESSION['scriptcase']['sc_aba_iframe'] as $aba => $apls_aba)
          {
              if (in_array("chart_detail_dokter", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['where_resumo'] = "";
      }
      $this->inicializa_vars();
      $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['SC_Ind_Groupby'];
      $this->Total->$Gb_geral();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['contr_total_geral'] == "OK")
      {
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
          {
              $Arr_tot_name = "array_total_" . $cmp_gb;
              $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['arr_total'][$cmp_gb];
          }
      }
      else
      {
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['tot_geral'][1];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['tot_geral'][1] == 0)
      {
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['arr_total']['regdate'] = $this->array_total_regdate;
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['arr_total']['doctor'] = $this->array_total_doctor;
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['json_use_label'])
       {
          $Lab_regdate = "regDate";
          $Lab_doctor = "doctor";
       }
       ...
       {
          $Lab_regdate = "Reg Date";
          $Lab_regdate =  sprintf("" . $this->Ini->Nm_lang['lang_othr_chart_title_YYYYMM'] . " Daftar", $Lab_regdate);
          $Lab_doctor = "Doctor";
       }
       $prep_field = array();
       $prep_field['regdate'] = $Lab_regdate;
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['labels']['regdate'] = $Lab_regdate; 
       $prep_field['doctor'] = $Lab_doctor;
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['labels']['doctor'] = $Lab_doctor; 
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
          $Str_gb .= ($Str_gb == "") ? "" : ",";
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['labels']['custcode']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['labels']['custcode'] = "Cust Code"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['labels']['poly']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['labels']['poly'] = "Poly"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['labels']['doctor']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['labels']['doctor'] = "Doctor"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['labels']['queue']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['labels']['queue'] = "Queue"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['labels']['regdate']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['labels']['regdate'] = "Reg Date"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['labels']['regtime']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['labels']['regtime'] = "Reg Time"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['labels']['struckno']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['labels']['struckno'] = "Struck No"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['labels']['status']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['labels']['status'] = "Status"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['labels']['hta']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['labels']['hta'] = "Hta"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['labels']['handled']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['labels']['handled'] = "Handled"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['labels']['viaphone']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['labels']['viaphone'] = "Via Phone"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['labels']['note']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['labels']['note'] = "Note"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['labels']['inst']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['labels']['inst'] = "Inst"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['labels']['jenis']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['labels']['jenis'] = "Jenis"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['labels']['bayar']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['labels']['bayar'] = "Bayar"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['labels']['instcode']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['labels']['instcode'] = "Inst Code"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['labels']['member']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['labels']['member'] = "Member"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['labels']['tlc']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['labels']['tlc'] = "Tlc"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['labels']['instno']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['labels']['instno'] = "Inst No"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['labels']['instexpiry']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['labels']['instexpiry'] = "Inst Expiry"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['labels']['paid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['labels']['paid'] = "Paid"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['labels']['custtlc']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['labels']['custtlc'] = "Cust Tlc"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['labels']['shift']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['labels']['shift'] = "Shift"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['labels']['bu']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['labels']['bu'] = "Bu"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['labels']['bucode']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['labels']['bucode'] = "Bu Code"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['labels']['ruang']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['labels']['ruang'] = "Ruang"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['labels']['statusrm']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['labels']['statusrm'] = "Status Rm"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['labels']['sep']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['labels']['sep'] = "Sep"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['labels']['caracode']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['labels']['caracode'] = "Cara Code"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['labels']['regtype']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['labels']['regtype'] = "Reg Type"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['labels']['asalrujukan']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['labels']['asalrujukan'] = "Asal Rujukan"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['labels']['asalcode']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['labels']['asalcode'] = "Asal Code"; 
       }
       //-----
       $ix = 0;
       $this->comp_field_nm = array();
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['summarizing_fields_order']['sc_free_group_by']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['summarizing_fields_order']['sc_free_group_by'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['summarizing_fields_order']['sc_free_group_by'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['summarizing_fields_display']['sc_free_group_by'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['summarizing_fields_display']['sc_free_group_by'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['summarizing_fields_display']['sc_free_group_by'] as $i_sum => $d_sum)
           {
      ...
      eval ($Str_gb);
       ...
       $Arr_parms = array();
       $Arr_parms['regdate']['alin'] = "''";
       $Arr_parms['regdate']['link'] = "S";
       $Arr_parms['doctor']['alin'] = "''";
       $Arr_parms['doctor']['link'] = "S";
       $Arr_parms['regdate']['fill'] = "true";
       $Arr_parms['regdate']['order'] = "value";
       $Arr_parms['regdate']['order_start'] = 'asc';
       $Arr_parms['regdate']['order_invert'] = 'false';
       $Arr_parms['regdate']['order_enabled'] = 'true';
       $Arr_parms['doctor']['fill'] = "true";
       $Arr_parms['doctor']['order'] = "label";
       $Arr_parms['doctor']['order_start'] = 'asc';
       $Arr_parms['doctor']['order_invert'] = 'false';
       $Arr_parms['doctor']['order_enabled'] = 'true';
       //-----
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
       ...
       //-----
       $prep_links_fl = array();
       $prep_links_fl['regdate'] = array(0 => 'regdate', 1 => '@aspass@');
       $prep_links_fl['doctor'] = array(0 => 'doctor', 1 => '@aspass@');
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['SC_Gb_Free_cmp'] as $cmp_gb => $col_sql)
       {
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['pivot_tabular_label'];
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@chart_detail_dokter@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function makeTabular(&$a_data)
   {
       ...
       {
           $a_labels = array();
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['proc_pdf_vert'])
   {
     $this->comp_tab_hover = true;
   }
   ...
   function buildChart()
   {
       ...
       $prep_chart_config = array(
           ...
           '1' => array(
               ...
               'label_x'  => $this->getChartText(strip_tags($Lab_regdate)),
           ...
           '1' => array(
               ...
               'field_x'  => 'doctor',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_doctor)),
               'label_y'  => $this->getChartText(strip_tags("" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . "")),
               'format'   => $this->formatChartValue(1),
           ),
           ),
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['summarizing_fields_order']['sc_free_group_by'] as $i_summ_order)
       {
                   ...
                   foreach ($this->sc_comb_quick_index[$i_index_summ] as $i_index_comb_groupby)
                   {
                       ...
                       if (!isset($a_chart_combinations[$s_comb_index]))
                       {
                           $a_chart_combinations[$s_comb_index] = array(
                               ...
                               'label_x'     => '',
                               'label_y'     => '',
                               'xml_pholder' => sizeof($this->comp_y_axys) > $i_index_group + 1 ? 'sc_chart_detail_dokter_' . session_id() . '_!!!C_' . ($i_index_group + 1) . '_' . $s_index_comb . ('' == $s_index_comb ? '' : '_') . '__SC_PLACEHOLDER__!!!.json' : '',
                               'xml'         => 'sc_chart_detail_dokter_' . session_id() . '_!!!C_' . $i_index_group . '_' . $s_index_comb . '!!!.json',
                           );
                       }
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['pivot_charts']    = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['pivot_orig']      = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['comb_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['comb_table_def']  = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['anlt_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['anlt_table_def']  = array();
	...
	function filterChartsByGroupbyLevel() {
		...
		if (isset($nmgp_opcao) && ('pdf' == $nmgp_opcao || 'pdf_res' == $nmgp_opcao) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['chart_level']) && '' !== $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['chart_level']) {
			$applyFilter = true;
		}
		elseif (isset($nmgp_opcao) && 'image_res' == $nmgp_opcao && isset($_POST['chart_level']) && '' !== $_POST['chart_level']) {
			$applyFilter = true;
			$_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['chart_level'] = $_POST['chart_level'];
		}
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['pivot_charts'] = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['pivot_orig'];

		if ($applyFilter) {
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['pivot_charts'] as $chartIndex => $chartData) {
				...
				if ($groupbyLevel > $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['chart_level']) {
					unset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['pivot_charts'][$chartIndex]);
				}
			}
		}

		$this->comp_chart_data = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['pivot_charts'];
	}
	...
	function filterChartsBySummarization() {
		...
		if (isset($nmgp_opcao) && ('pdf' == $nmgp_opcao || 'pdf_res' == $nmgp_opcao)) {
			...
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['summarizing_fields_display']['sc_free_group_by'] as $fieldIndex => $fieldData) {
	...
	function filterChartsByMultiseries() {
		...
		if ($applyFilter && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['summarizing_drill_down']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['summarizing_drill_down'])) {
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['pivot_charts'] as $chartIndex => $chartData) {
				$indexParts = explode('|', $chartIndex);
           ...
           foreach ($a_totals as $i_total => $values)
           {
               ...
               if (isset($this->comp_chart_config[$key_config]))
               {
                   ...
                   foreach ($a_keys as $tmp_key)
                   {
                       ...
                       $xml_links[]  = $this->getFusionLink('sc_chart_detail_dokter_' . session_id() . '_!!!' . implode('_', array_merge(array($group + 1, $i_total), $link_index)) . '!!!.json');
                   }
                   ...
                   $this->comp_chart_data[$key_data]['xml']        = $this->getFusionLink('sc_chart_detail_dokter_' . session_id() . '_!!!' . implode('_', array_merge(array($group, $i_total), $param)) . '!!!.json');
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['embutida'])
                   {
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['proc_pdf_vert']){ 
   ...
   {
       if (!$res_chart && $this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['json_use_format']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['json_use_format'])
       {
           return $valor_campo;
       }
   ...
   function resumo_init()
   {
      ...
      $this->monta_html_ini();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
      {
      ...
      { 
         ...
         { 
             $seq_search = 1;
             foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['grid_pesq'] as $cmp => $def)
             {
                $Seq_grid      = $seq_search;
                $Cmp_grid      = $cmp;
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
               if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['chart_detail_dokter']))
               {
                   $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['chart_detail_dokter']) . "_";
               } 
           } 
           else 
           { 
               if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['chart_detail_dokter']))
               {
                   $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['chart_detail_dokter']) . "_";
               } 
           }
       }
   ...
   function resumo_final()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['ajax_nav'])
      {
   ...
   {
      $this->Tot_ger = false;
      require_once($this->Ini->path_aplicacao . "chart_detail_dokter_total.class.php"); 
      $this->Print_All = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['print_all'];
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['doc_word'] || $this->Ini->sc_export_ajax_img)
      { 
      ...
      $this->Total   = new chart_detail_dokter_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['arr_total'][$cmp_gb];
      }
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['dashboard_refresh_after_chart'] = 'resumo';
      $nm_saida->saida("<HTML" . $_SESSION['scriptcase']['reg_conf']['html_dir'] . ">\r\n");
      $nm_saida->saida("<HEAD>\r\n");
      $nm_saida->saida(" <TITLE>" . $this->Ini->Nm_lang['lang_othr_chart_title'] . " tbantrian</TITLE>\r\n");
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['doc_word'])
{
      ...
      { 
           ...
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"chart_detail_dokter_ajax.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\">\r\n");
           ...
           $nm_saida->saida(" </script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"chart_detail_dokter_jquery.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"chart_detail_dokter_message.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"../_lib/lib/js/scInput.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"../_lib/lib/js/jquery.scInput.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"../_lib/lib/js/jquery.scInput2.js\"></script>\r\n");
   ...
   { 
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['num_css']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['num_css'] = rand(0, 1000);
      }
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_chart_detail_dokter_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_chart_detail_dokter_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_chart_detail_dokter_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['num_css'] . '.css');
...
$nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "chart_detail_dokter/chart_detail_dokter_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\">\r\n");
           ...
           $nm_saida->saida("         dataType: \"html\",\r\n");
           $nm_saida->saida("         url: \"chart_detail_dokter_save_grid.php\",\r\n");
           ...
           $nm_saida->saida("     }\r\n");
           $nm_saida->saida("   </script>\r\n");
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['ajax_nav'] && !$this->Ini->sc_export_ajax && !$this->Ini->Export_html_zip && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['doc_word'])
      {
           $nm_saida->saida("   <script type=\"text/javascript\"> \r\n");
          ...
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['grid_pesq']))
          { 
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['doc_word']) 
      {
      ...
      {
          $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['dashboard_info']['remove_margin'] ? ' style="margin: 0"' : '';
          $nm_saida->saida(" <BODY class=\"" . $this->css_scGridPage . "\"" . $remove_margin . ">\r\n");
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['embutida'])
      {
      ...
      $nm_saida->saida("function scChartImageExportShow(exportType) {\r\n");
          $nm_saida->saida("  scShowCombinationImage(" . count($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['Labels_GB']) . ", exportType, '');\r\n");
      $nm_saida->saida("}\r\n");
...
;
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top_normal()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['pdf'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "Rpdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "chart_detail_dokter/chart_detail_dokter_config_pdf.php?nm_opc=pdf&nm_target=0&nm_cor=cor&papel=1&orientacao=1&bookmarks=1&largura=1200&conf_larg=S&conf_fonte=10&grafico=S&sc_ver_93=" . s . "&nm_tem_gb=s&nm_res_cons=s&nm_ini_pdf_res=chart&nm_all_modules=chart&password=n&summary_export_columns=N&pdf_zip=N&origem=chart&language=id&conf_socor=N&is_chart_app=Y&nm_label_group=S&nm_all_cab=N&nm_all_label=N&nm_orient_grid=2&script_case_init=" . $this->Ini->sc_page . "&app_name=chart_detail_dokter&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "chart_detail_dokter/chart_detail_dokter_config_print.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=N&nm_opc=resumo&nm_cor=PB&nm_res_cons=s&nm_ini_prt_res=&nm_all_modules=chart&password=n&origem=chart&language=id&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         ...
         if (is_file("chart_detail_dokter_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
            $Arq_WebHelp = file("chart_detail_dokter_help.txt"); 
   ...
   function monta_html_fim()
   {
      ...
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['chart_detail_dokter']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['chart_detail_dokter']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
$nm_saida->saida("       scJs_alert('" . $mensagem . "', $jsonParams);\r\n");
      ...
      elseif ($this->Ini->Export_html_zip || ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['opcao'] == "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['graf_pdf'] == "S"))
      {
          $this->grafico_pdf();
      }
      else
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'chart_detail_dokter_config_pivot.php?nome_apl=chart_detail_dokter&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=id&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   $nm_saida->saida("                  action=\"chart_detail_dokter_iframe_prt.php\" \r\n");
   ...
   $nm_saida->saida("   </form> \r\n");
          ...
          $nm_saida->saida("               document.Fprint.action = \"chart_detail_dokter_export_ctrl.php\";\r\n");
          $nm_saida->saida("           }\r\n");
          $nm_saida->saida("           else\r\n");
          $nm_saida->saida("           {\r\n");
   ...
   $nm_saida->saida("           document.Fexport.nmgp_tot_xls.value = tot_xls;\r\n");
          ...
          $nm_saida->saida("       document.Fexport.action = \"chart_detail_dokter_export_ctrl.php\";\r\n");
      ...
      if (!extension_loaded("zip"))
      {
          ...
          $nm_saida->saida("       document.F3.SC_module_export.value = z;\r\n");
          $nm_saida->saida("  }\r\n");
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['chart_detail_dokter_iframe_params'] = array(
      ...
      $Md5_pdf    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@chart_detail_dokter@SC_par@" . md5($prep_parm_pdf);
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['Md5_pdf'][md5($prep_parm_pdf)] = $prep_parm_pdf;
...
;
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_chart_detail_dokter_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "chart_detail_dokter/chart_detail_dokter_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
...
//--- 
 function grafico_pdf()
 {
   ...
   $this->Graf->Ini    = $this->Ini;
   $this->Graf->Lookup = $this->Lookup;
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['pivot_charts']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['skip_charts']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['skip_charts']))
   {
 ...
 { 
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['pivot_charts'] as $chart_index => $chart_data)
       {
 ...
 { 
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['this_chart_label'] = '';
           $this->Graf->monta_grafico($chart_index, 'pdf');
           if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['this_chart_label']) {
               $nm_saida->saida("<script type=\"text/javascript\">$(\"#$random_id\").html(\"{$_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['this_chart_label']}\")</script>\r\n");
           }
       ...
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['charts_html']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['charts_html'])
       {
            $nm_saida->saida("<script type=\"text/javascript\">\r\n");
            $nm_saida->saida("{$_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['charts_html']}\r\n");
            $nm_saida->saida("</script>\r\n");
       }
   }
       $nm_saida->saida("</body>\r\n");
...
//--- 
 ...
 {
   global $nm_saida, $nm_lang;
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['chart_list']))
   {
       $prim_graf = true;
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['chart_list'] as $arr_chart)
       {
           if (!$prim_graf)
           {
               $nm_saida->saida("<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>\r\n");
...
//--- 
 function grafico_bot()
 {
   ...
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['pivot_charts']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['graf_bot'] = true;
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['graf_first'] = true;
       require_once($this->Ini->path_aplicacao . $this->Ini->Apl_grafico); 
       $this->Graf  = new chart_detail_dokter_grafico();
       $this->Graf->Db     = $this->Db;
       $this->Graf->Erro   = $this->Erro;
       ...
       $nm_saida->saida("<TR>\r\n");
       $iChartCount = 1;
       $iChartTotal = sizeof($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['pivot_charts']);
       $sChartLang  = isset($this->Ini->Nm_lang['lang_pdff_pcht']) ? $this->Ini->Nm_lang['lang_pdff_pcht'] : 'Generating chart';
       if (!NM_is_utf8($sChartLang))
       {
           $sChartLang = sc_convert_encoding($sChartLang, "UTF-8", $_SESSION['scriptcase']['charset']);
      ...
      if ($bPDF && (!isset($this->progress_fp) || !$this->progress_fp))
      {
       ...
       $nm_saida->saida("</TD>\r\n");
       $nm_saida->saida("</TR>\r\n");
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['graf_bot'] = false;
       if ($bPDF && isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['charts_html']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['charts_html'])
       {
           $nm_saida->saida("<script type=\"text/javascript\">\r\n");
           $nm_saida->saida("{$_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['charts_html']}\r\n");
           $nm_saida->saida("</script>\r\n");
...
//--- 
   ...
   //---- 
   function adiciona_registro($quebra_regdate, $quebra_doctor, $quebra_regdate_orig, $quebra_doctor_orig)
   {
      $contr_arr = "";
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
          $Name_orig  = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['SC_Gb_Free_orig'][$cmp_gb])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['SC_Gb_Free_orig'][$cmp_gb] : $cmp_gb;
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     $nmgp_select .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['where_pesq']; 
     $campos_order = "";
     foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['SC_Gb_Free_sql'] as $cmp_var => $resto)
     {
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->poly = $rs_res->fields[1] ;  
            $this->doctor = $rs_res->fields[2] ;  
            $this->queue = $rs_res->fields[3] ;  
            $this->regdate = $rs_res->fields[4] ;  
            $this->regtime = $rs_res->fields[5] ;  
            $this->struckno = $rs_res->fields[6] ;  
            $this->status = $rs_res->fields[7] ;  
            $this->hta = $rs_res->fields[8] ;  
            $this->handled = $rs_res->fields[9] ;  
            $this->viaphone = $rs_res->fields[10] ;  
            $this->note = $rs_res->fields[11] ;  
            $this->inst = $rs_res->fields[12] ;  
            $this->jenis = $rs_res->fields[13] ;  
            $this->bayar = $rs_res->fields[14] ;  
            $this->instcode = $rs_res->fields[15] ;  
            $this->member = $rs_res->fields[16] ;  
            $this->tlc = $rs_res->fields[17] ;  
            $this->instno = $rs_res->fields[18] ;  
            $this->instexpiry = $rs_res->fields[19] ;  
            $this->paid = $rs_res->fields[20] ;  
            $this->custtlc = $rs_res->fields[21] ;  
            $this->shift = $rs_res->fields[22] ;  
            $this->bu = $rs_res->fields[23] ;  
            $this->bucode = $rs_res->fields[24] ;  
            $this->ruang = $rs_res->fields[25] ;  
            $this->statusrm = $rs_res->fields[26] ;  
            $this->sep = $rs_res->fields[27] ;  
            $this->caracode = $rs_res->fields[28] ;  
            $this->regtype = $rs_res->fields[29] ;  
            $this->asalrujukan = $rs_res->fields[30] ;  
            $this->asalcode = $rs_res->fields[31] ;  
            $this->regdate_orig = $this->regdate;
            $this->doctor_orig = $this->doctor;
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->regdate, $this->doctor, $this->regdate_orig,  $this->doctor_orig);
            }
   }
//
   ...
   function html_grid_search()
   {
       ...
       $tmp = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['cond_pesq'];
       $pos = strrpos($tmp, "##*@@");
       if ($pos !== false)
       {
       ...
       $str_display = empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['grid_pesq'])?'none':'';
       if(!$_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['ajax_nav'])
       {
          $nm_saida->saida("   <tr id=\"NM_Grid_Search\" ajax='' style='display:" . $str_display . "'>\r\n");
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['ajax_nav'] && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['grid_pesq']))
       { 
           $_SESSION['scriptcase']['saida_html'] = "";
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['grid_pesq'] as $cmp => $def)
           {
           ...
           if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['save_grid']))
           {
               return;
           }
           else
       ...
       $nm_saida->saida("            <input type=\"hidden\" name=\"parm\" value=\"\"/> \r\n");
            if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['grid_pesq']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['grid_pesq']))
            {
                foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['grid_pesq'] as $cmp => $def)
                {
                    if (isset($def['label'])) {
       ...
       { 
           ...
           $_SESSION['scriptcase']['saida_html'] = "";
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['save_grid']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['grid_pesq']))
           { 
   ...
   function grid_search_add_tag()
   {
       ...
       if (count($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['grid_pesq']) < 0)
       {
           $lin_obj .= "<table id='id_grid_search_all_cmp' cellpadding=0 cellspacing=0>";
           foreach ($All_cmp_search as $cada_cmp)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_detail_dokter']['grid_pesq'][$cada_cmp]))
               {
                   $lin_obj .= "  <tr>";
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "simrskreatifmedia/chart_detail_dokter";
