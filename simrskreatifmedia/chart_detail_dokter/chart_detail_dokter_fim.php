...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____chart_detail_dokter"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____chart_detail_dokter"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['chart_detail_dokter']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['chart_detail_dokter']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['chart_detail_dokter']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['chart_detail_dokter']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['chart_detail_dokter']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>chart_detail_dokter</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['chart_detail_dokter']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['chart_detail_dokter']['embutida_filho'] as $ind => $sc_init)
          {
