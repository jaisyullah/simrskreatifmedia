  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbtracerrm_returned" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbtracerrm_returned_form();
	}

  // ---------- Validate id_
  function do_ajax_form_tbtracerrm_returned_validate_id_(iNumLinha)
  {
    var nomeCampo_id_ = "id_" + iNumLinha;
    var var_id_ = scAjaxGetFieldHidden(nomeCampo_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtracerrm_returned_validate_id_(var_id_, iNumLinha, var_script_case_init, do_ajax_form_tbtracerrm_returned_validate_id__cb);
  } // do_ajax_form_tbtracerrm_returned_validate_id_

  function do_ajax_form_tbtracerrm_returned_validate_id__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtracerrm_returned_validate_id__cb

  // ---------- Validate nostruk_
  function do_ajax_form_tbtracerrm_returned_validate_nostruk_(iNumLinha)
  {
    var nomeCampo_nostruk_ = "nostruk_" + iNumLinha;
    var var_nostruk_ = scAjaxGetFieldText(nomeCampo_nostruk_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtracerrm_returned_validate_nostruk_(var_nostruk_, iNumLinha, var_script_case_init, do_ajax_form_tbtracerrm_returned_validate_nostruk__cb);
  } // do_ajax_form_tbtracerrm_returned_validate_nostruk_

  function do_ajax_form_tbtracerrm_returned_validate_nostruk__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtracerrm_returned_validate_nostruk__cb

  // ---------- Validate sc_field_2_
  function do_ajax_form_tbtracerrm_returned_validate_sc_field_2_(iNumLinha)
  {
    var nomeCampo_sc_field_2_ = "sc_field_2_" + iNumLinha;
    var var_sc_field_2_ = scAjaxGetFieldText(nomeCampo_sc_field_2_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtracerrm_returned_validate_sc_field_2_(var_sc_field_2_, iNumLinha, var_script_case_init, do_ajax_form_tbtracerrm_returned_validate_sc_field_2__cb);
  } // do_ajax_form_tbtracerrm_returned_validate_sc_field_2_

  function do_ajax_form_tbtracerrm_returned_validate_sc_field_2__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtracerrm_returned_validate_sc_field_2__cb

  // ---------- Validate rm_
  function do_ajax_form_tbtracerrm_returned_validate_rm_(iNumLinha)
  {
    var nomeCampo_rm_ = "rm_" + iNumLinha;
    var var_rm_ = scAjaxGetFieldText(nomeCampo_rm_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtracerrm_returned_validate_rm_(var_rm_, iNumLinha, var_script_case_init, do_ajax_form_tbtracerrm_returned_validate_rm__cb);
  } // do_ajax_form_tbtracerrm_returned_validate_rm_

  function do_ajax_form_tbtracerrm_returned_validate_rm__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtracerrm_returned_validate_rm__cb

  // ---------- Validate jenis_
  function do_ajax_form_tbtracerrm_returned_validate_jenis_(iNumLinha)
  {
    var nomeCampo_jenis_ = "jenis_" + iNumLinha;
    var var_jenis_ = scAjaxGetFieldSelect(nomeCampo_jenis_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtracerrm_returned_validate_jenis_(var_jenis_, iNumLinha, var_script_case_init, do_ajax_form_tbtracerrm_returned_validate_jenis__cb);
  } // do_ajax_form_tbtracerrm_returned_validate_jenis_

  function do_ajax_form_tbtracerrm_returned_validate_jenis__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtracerrm_returned_validate_jenis__cb

  // ---------- Validate sc_field_1_
  function do_ajax_form_tbtracerrm_returned_validate_sc_field_1_(iNumLinha)
  {
    var nomeCampo_sc_field_1_ = "sc_field_1_" + iNumLinha;
    var var_sc_field_1_ = scAjaxGetFieldSelect(nomeCampo_sc_field_1_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtracerrm_returned_validate_sc_field_1_(var_sc_field_1_, iNumLinha, var_script_case_init, do_ajax_form_tbtracerrm_returned_validate_sc_field_1__cb);
  } // do_ajax_form_tbtracerrm_returned_validate_sc_field_1_

  function do_ajax_form_tbtracerrm_returned_validate_sc_field_1__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtracerrm_returned_validate_sc_field_1__cb

  // ---------- Validate usia_
  function do_ajax_form_tbtracerrm_returned_validate_usia_(iNumLinha)
  {
    var nomeCampo_usia_ = "usia_" + iNumLinha;
    var var_usia_ = scAjaxGetFieldText(nomeCampo_usia_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtracerrm_returned_validate_usia_(var_usia_, iNumLinha, var_script_case_init, do_ajax_form_tbtracerrm_returned_validate_usia__cb);
  } // do_ajax_form_tbtracerrm_returned_validate_usia_

  function do_ajax_form_tbtracerrm_returned_validate_usia__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtracerrm_returned_validate_usia__cb

  // ---------- Validate alamat_
  function do_ajax_form_tbtracerrm_returned_validate_alamat_(iNumLinha)
  {
    var nomeCampo_alamat_ = "alamat_" + iNumLinha;
    var var_alamat_ = scAjaxGetFieldText(nomeCampo_alamat_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtracerrm_returned_validate_alamat_(var_alamat_, iNumLinha, var_script_case_init, do_ajax_form_tbtracerrm_returned_validate_alamat__cb);
  } // do_ajax_form_tbtracerrm_returned_validate_alamat_

  function do_ajax_form_tbtracerrm_returned_validate_alamat__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtracerrm_returned_validate_alamat__cb

  // ---------- Validate lokasi_
  function do_ajax_form_tbtracerrm_returned_validate_lokasi_(iNumLinha)
  {
    var nomeCampo_lokasi_ = "lokasi_" + iNumLinha;
    var var_lokasi_ = scAjaxGetFieldSelect(nomeCampo_lokasi_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtracerrm_returned_validate_lokasi_(var_lokasi_, iNumLinha, var_script_case_init, do_ajax_form_tbtracerrm_returned_validate_lokasi__cb);
  } // do_ajax_form_tbtracerrm_returned_validate_lokasi_

  function do_ajax_form_tbtracerrm_returned_validate_lokasi__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtracerrm_returned_validate_lokasi__cb

  // ---------- Validate status_
  function do_ajax_form_tbtracerrm_returned_validate_status_(iNumLinha)
  {
    var nomeCampo_status_ = "status_" + iNumLinha;
    var var_status_ = scAjaxGetFieldSelect(nomeCampo_status_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtracerrm_returned_validate_status_(var_status_, iNumLinha, var_script_case_init, do_ajax_form_tbtracerrm_returned_validate_status__cb);
  } // do_ajax_form_tbtracerrm_returned_validate_status_

  function do_ajax_form_tbtracerrm_returned_validate_status__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtracerrm_returned_validate_status__cb

  // ---------- Refresh rm_
  function do_ajax_form_tbtracerrm_returned_refresh_rm_(iSeqForm)
  {
    ...
    scAjaxProcOn(true);
    x_ajax_form_tbtracerrm_returned_refresh_rm_(var_rm_, var_nmgp_refresh_row, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_tbtracerrm_returned_refresh_rm__cb);
  } // do_ajax_form_tbtracerrm_returned_refresh_rm_

  function do_ajax_form_tbtracerrm_returned_refresh_rm__cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtracerrm_returned_refresh_rm__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_tbtracerrm_returned_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_tbtracerrm_returned_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tbtracerrm_returned_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_tbtracerrm_returned_add_new_line_cb);
  } // do_ajax_form_tbtracerrm_returned_add_new_line

  function do_ajax_form_tbtracerrm_returned_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_tbtracerrm_returned_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_tbtracerrm_returned_backup_line(iNumLinha)
  {
    var var_id_ = scAjaxGetFieldHidden("id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtracerrm_returned_backup_line(var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_tbtracerrm_returned_backup_line_cb);
  } // do_ajax_form_tbtracerrm_returned_backup_line

  function do_ajax_form_tbtracerrm_returned_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_tbtracerrm_returned_backup_line_cb

  function do_ajax_form_tbtracerrm_returned_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_tbtracerrm_returned_cancel_insert

  function do_ajax_form_tbtracerrm_returned_cancel_update(iSeqVert)
  {
    do_ajax_form_tbtracerrm_returned_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_tbtracerrm_returned_cancel_update

  function do_ajax_form_tbtracerrm_returned_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_tbtracerrm_returned_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_tbtracerrm_returned_table_refresh()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tbtracerrm_returned_table_refresh(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbtracerrm_returned_table_refresh_cb);
  } //  do_ajax_form_tbtracerrm_returned_table_refresh

  function do_ajax_form_tbtracerrm_returned_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_tbtracerrm_returned_table_refresh_cb_after_alert);
  } // do_ajax_form_tbtracerrm_returned_table_refresh_cb
  function do_ajax_form_tbtracerrm_returned_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_tbtracerrm_returned_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_tbtracerrm_returned_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_tbtracerrm_returned_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
...
?>
    x_ajax_form_tbtracerrm_returned_submit_form(var_id_, var_nostruk_, var_sc_field_2_, var_rm_, var_jenis_, var_sc_field_1_, var_usia_, var_alamat_, var_lokasi_, var_status_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbtracerrm_returned_submit_form_cb);
  } // do_ajax_form_tbtracerrm_returned_submit_form

  function do_ajax_form_tbtracerrm_returned_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_tbtracerrm_returned_submit_form_cb_after_alert);
  } // do_ajax_form_tbtracerrm_returned_submit_form_cb
  function do_ajax_form_tbtracerrm_returned_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbtracerrm_returned_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tbtracerrm_returned_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tbtracerrm_returned_navigate_form(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbtracerrm_returned_navigate_form_cb);
  } // do_ajax_form_tbtracerrm_returned_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtracerrm_returned']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbtracerrm_returned_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbtracerrm_returned_navigate_form_cb_after_alert);
  } // do_ajax_form_tbtracerrm_returned_navigate_form_cb
  function do_ajax_form_tbtracerrm_returned_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_tbtracerrm_returned_navigate_form_cb_after_alert
  function sc_hide_form_tbtracerrm_returned_form()
  {
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["id_" + iRow] || "on" == ajax_error_count["nostruk_" + iRow] || "on" == ajax_error_count["sc_field_2_" + iRow] || "on" == ajax_error_count["rm_" + iRow] || "on" == ajax_error_count["jenis_" + iRow] || "on" == ajax_error_count["sc_field_1_" + iRow] || "on" == ajax_error_count["usia_" + iRow] || "on" == ajax_error_count["alamat_" + iRow] || "on" == ajax_error_count["lokasi_" + iRow] || "on" == ajax_error_count["status_" + iRow]))
    {
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["id_" + iRow] && "off" == ajax_error_count["nostruk_" + iRow] && "off" == ajax_error_count["sc_field_2_" + iRow] && "off" == ajax_error_count["rm_" + iRow] && "off" == ajax_error_count["jenis_" + iRow] && "off" == ajax_error_count["sc_field_1_" + iRow] && "off" == ajax_error_count["usia_" + iRow] && "off" == ajax_error_count["alamat_" + iRow] && "off" == ajax_error_count["lokasi_" + iRow] && "off" == ajax_error_count["status_" + iRow]))
    {
      if (bErrorRow)
      {
