...
.sc-button-image.disabled img {
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['ambilFormula']['embutida_pdf']))
 {
 ?>
...
<?php
include_once("ambilFormula_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('ambilFormula_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['ambilFormula']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['ambilFormula']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['ambilFormula']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['ambilFormula']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['ambilFormula']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['ambilFormula']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['ambilFormula']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['ambilFormula']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
?>
...
<?php
 include_once("ambilFormula_js0.php");
?>
<script type="text/javascript"> 
...
<?php
$_SESSION['scriptcase']['error_span_title']['ambilFormula'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['ambilFormula'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['ambilFormula']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['ambilFormula']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['ambilFormula']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['ambilFormula']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['ambilFormula']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<?php
  ...
  {
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['ambilFormula']['where_filter']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['ambilFormula']['empty_filter'] = true;
       }
  }
?>
...
<?php
           if (($nm_apl_dependente != 1) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['ambilFormula']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['ambilFormula']['dashboard_info']['under_dashboard'])) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['ambilFormula']['nm_run_menu']) || $_SESSION['sc_session'][$this->Ini->sc_page]['ambilFormula']['nm_run_menu'] != 1))) {
...
<?php
           if (($nm_apl_dependente == 1) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['ambilFormula']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['ambilFormula']['dashboard_info']['under_dashboard']))) {
        $sCondStyle = ($this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['ambilFormula']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['ambilFormula']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("ambilFormula");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("ambilFormula");
 parent.scAjaxDetailHeight("ambilFormula", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['ambilFormula']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
