...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_sc_field_0' + iSeqRow).bind('blur', function() { sc_ambilFormula_sc_field_0_onblur(this, iSeqRow) })
                                        .bind('focus', function() { sc_ambilFormula_sc_field_0_onfocus(this, iSeqRow) });
  $('#id_sc_field_sc_field_1' + iSeqRow).bind('blur', function() { sc_ambilFormula_sc_field_1_onblur(this, iSeqRow) })
                                        .bind('focus', function() { sc_ambilFormula_sc_field_1_onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_ambilFormula_sc_field_0_onblur(oThis, iSeqRow) {
  do_ajax_ambilFormula_mob_validate_sc_field_0();
  scCssBlur(oThis);
}

function sc_ambilFormula_sc_field_0_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_ambilFormula_sc_field_1_onblur(oThis, iSeqRow) {
  do_ajax_ambilFormula_mob_validate_sc_field_1();
  scCssBlur(oThis);
}

function sc_ambilFormula_sc_field_1_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function scHidePage(pageNo) {
	$("#id_ambilFormula_mob_form" + pageNo).hide();
}
