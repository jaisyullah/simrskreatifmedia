<?php
@session_start() ;
$_SESSION['scriptcase']['grid_set_menu']['sc_process_barr'] = true;
require_once('../grid_set_menu/index.php');
unset($_SESSION['scriptcase']['grid_set_menu']['sc_process_barr']);
$ExportCtrl = new grid_set_menu_export_control;
$ExportCtrl->Export_barr();

class grid_set_menu_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - Set Menu :: Excel</TITLE>
