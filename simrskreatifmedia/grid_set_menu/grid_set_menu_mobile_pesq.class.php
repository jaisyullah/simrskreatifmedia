...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_nama_set_cond" name="nama_set_cond" onChange="nm_campos_between(document.getElementById('id_vis_nama_set'), this, 'nama_set')">
      ...
      <br><span id="id_hide_nama_set"  <?php echo $str_hide_nama_set?>><?php
      if ($nama_set != "")
      {
      $nama_set_look = substr($this->Db->qstr($nama_set), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_menu_order_cond" name="menu_order_cond" onChange="nm_campos_between(document.getElementById('id_vis_menu_order'), this, 'menu_order')">
      ...
      <br><span id="id_hide_menu_order"  <?php echo $str_hide_menu_order?>><?php
      if ($menu_order != "")
      {
      $menu_order_look = substr($this->Db->qstr($menu_order), 1, -1); 
      $nmgp_def_dados = array(); 
