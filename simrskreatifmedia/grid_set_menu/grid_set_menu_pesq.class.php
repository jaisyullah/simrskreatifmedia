...
class grid_set_menu_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_menu']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_set_menu_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_set_menu_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_set_menu_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_nama_set')
      {
          $nama_set = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_nama_set($nama_set);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_menu_order')
      {
          $menu_order = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_menu_order($menu_order);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function lookup_ajax_nama_set($nama_set)
   {
      $nama_set = substr($this->Db->qstr($nama_set), 1, -1);
            $nama_set_look = substr($this->Db->qstr($nama_set), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct nama_set from " . $this->Ini->nm_tabela . " where  nama_set like '%" . $nama_set . "%' order by nama_set"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
   ...
   function lookup_ajax_menu_order($menu_order)
   {
      $menu_order = substr($this->Db->qstr($menu_order), 1, -1);
            $menu_order_look = substr($this->Db->qstr($menu_order), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct menu_order from " . $this->Ini->nm_tabela . " where  menu_order like '%" . $menu_order . "%' order by menu_order"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_menu']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_menu']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_menu']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_menu']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_menu']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_menu']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_menu']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_menu']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_menu']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_menu']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_menu']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_menu']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_menu']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_menu']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_menu']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - Set Menu</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_set_menu/grid_set_menu_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_set_menu_ajax_search.js"></script>
 <script type="text/javascript" src="grid_set_menu_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_set_menu_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_set_menu']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_set_menu']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_nama_set_cond#NMF#' + search_get_sel_txt('SC_nama_set_cond') + '@NMF@';
  str_out += 'SC_nama_set#NMF#' + search_get_text('SC_nama_set') + '@NMF@';
  str_out += 'id_ac_nama_set#NMF#' + search_get_text('id_ac_nama_set') + '@NMF@';
  str_out += 'SC_menu_order_cond#NMF#' + search_get_sel_txt('SC_menu_order_cond') + '@NMF@';
  str_out += 'SC_menu_order#NMF#' + search_get_text('SC_menu_order') + '@NMF@';
  str_out += 'id_ac_menu_order#NMF#' + search_get_text('id_ac_menu_order') + '@NMF@';
   ...
   $("#id_ac_nama_set").autocomplete({
     ...
     $.ajax({
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_nama_set",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_nama_set").val( $(this).val() );
       }
     }
   });
   $("#id_ac_menu_order").autocomplete({
     minLength: 1,
     source: function (request, response) {
     $.ajax({
       url: "index.php",
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_menu_order",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_menu_order").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     focus: function (event, ui) {
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_menu']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div class="scFilterHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFilterHeaderFont" style="float: left; text-transform: uppercase;"><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - Set Menu</div>
...
<?php
   ...
   function monta_form()
   {
      global 
             ...
             $nama_set_cond, $nama_set, $nama_set_autocomp,
             $menu_order_cond, $menu_order, $menu_order_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_menu']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_menu']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_menu']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_menu']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $id = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_menu']['campos_busca']['id']; 
          $id_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_menu']['campos_busca']['id_cond']; 
          $nama_set = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_menu']['campos_busca']['nama_set']; 
          $nama_set_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_menu']['campos_busca']['nama_set_cond']; 
          $menu_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_menu']['campos_busca']['menu_order']; 
          $menu_order_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_menu']['campos_busca']['menu_order_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_menu']['campos_busca']['NM_operador']; 
      } 
      if (!isset($id_cond) || empty($id_cond))
      {
         $id_cond = "gt";
      }
      if (!isset($nama_set_cond) || empty($nama_set_cond))
      {
         $nama_set_cond = "qp";
      }
      if (!isset($menu_order_cond) || empty($menu_order_cond))
      {
         $menu_order_cond = "qp";
      }
      ...
      $str_hide_nama_set = (in_array($nama_set_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_menu_order = (in_array($menu_order_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      if (!isset($nama_set) || $nama_set == "")
      {
          $nama_set = "";
      }
      if (isset($nama_set) && !empty($nama_set))
      {
         $tmp_pos = strpos($nama_set, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $nama_set = substr($nama_set, 0, $tmp_pos);
         }
      }
      if (!isset($menu_order) || $menu_order == "")
      {
          $menu_order = "";
      }
      if (isset($menu_order) && !empty($menu_order))
      {
         $tmp_pos = strpos($menu_order, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $menu_order = substr($menu_order, 0, $tmp_pos);
         }
      }
?>
 <TR align="center">
...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_id" name="id_autocomp" size="10"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 10, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
      ...
      <TD id='SC_nama_set_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['nama_set'])) ? $this->New_label['nama_set'] : "Nama Set"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_nama_set_cond" name="nama_set_cond" onChange="nm_campos_between(document.getElementById('id_vis_nama_set'), this, 'nama_set')">
       <OPTION value="qp" <?php if ("qp" == $nama_set_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $nama_set_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $nama_set_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $nama_set_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_nama_set" <?php echo $str_hide_nama_set?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['nama_set'])) ? $this->New_label['nama_set'] : "Nama Set";
 $nmgp_tab_label .= "nama_set?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      $nama_set_look = substr($this->Db->qstr($nama_set), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct nama_set from " . $this->Ini->nm_tabela . " where nama_set = '$nama_set_look' order by nama_set"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      if (isset($nmgp_def_dados[0][$nama_set]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$nama_set];
      }
      else
      {
          $sAutocompValue = $nama_set;
      }
?>
<INPUT  type="text" id="SC_nama_set" name="nama_set" value="<?php echo NM_encode_input($nama_set) ?>"  size=25 alt="{datatype: 'text', maxLength: 25, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_nama_set" name="nama_set_autocomp" size="25"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 25, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_menu_order_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['menu_order'])) ? $this->New_label['menu_order'] : "Menu Order"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_menu_order_cond" name="menu_order_cond" onChange="nm_campos_between(document.getElementById('id_vis_menu_order'), this, 'menu_order')">
       <OPTION value="qp" <?php if ("qp" == $menu_order_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $menu_order_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $menu_order_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $menu_order_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_menu_order" <?php echo $str_hide_menu_order?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['menu_order'])) ? $this->New_label['menu_order'] : "Menu Order";
 $nmgp_tab_label .= "menu_order?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      $menu_order_look = substr($this->Db->qstr($menu_order), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct menu_order from " . $this->Ini->nm_tabela . " where menu_order = '$menu_order_look' order by menu_order"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      if (isset($nmgp_def_dados[0][$menu_order]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$menu_order];
      }
      else
      {
          $sAutocompValue = $menu_order;
      }
?>
<INPUT  type="text" id="SC_menu_order" name="menu_order" value="<?php echo NM_encode_input($menu_order) ?>"  size=50 alt="{datatype: 'text', maxLength: 500, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_menu_order" name="menu_order_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 500, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
?>
<?php
   if (is_file("grid_set_menu_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_set_menu']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_set_menu']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_menu']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.nama_set_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_nama_set'), document.F1.nama_set_cond, 'nama_set');
   document.F1.nama_set.value = "";
   document.F1.nama_set_autocomp.value = "";
   document.F1.menu_order_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_menu_order'), document.F1.menu_order_cond, 'menu_order');
   document.F1.menu_order.value = "";
   document.F1.menu_order_autocomp.value = "";
 }
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "simrskreatifmedia/grid_set_menu";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_menu']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_menu']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_menu']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_nama_set_cond'] = 'cond';
      $tp_fields['SC_nama_set'] = 'text_aut';
      $tp_fields['id_ac_nama_set'] = 'text_aut';
      $tp_fields['SC_menu_order_cond'] = 'cond';
      $tp_fields['SC_menu_order'] = 'text_aut';
      $tp_fields['id_ac_menu_order'] = 'text_aut';
   ...
   function trata_campos()
   {
      global $id_cond, $id, $id_autocomp,
             $nama_set_cond, $nama_set, $nama_set_autocomp,
             $menu_order_cond, $menu_order, $menu_order_autocomp, $nmgp_tab_label;
      ...
      if (!empty($nama_set_autocomp) && empty($nama_set))
      {
          $nama_set = $nama_set_autocomp;
      }
      if (!empty($menu_order_autocomp) && empty($menu_order))
      {
          $menu_order = $menu_order_autocomp;
      }
      ...
      $nama_set_cond_salva = $nama_set_cond; 
      if (!isset($nama_set_input_2) || $nama_set_input_2 == "")
      {
          $nama_set_input_2 = $nama_set;
      }
      $menu_order_cond_salva = $menu_order_cond; 
      if (!isset($menu_order_input_2) || $menu_order_input_2 == "")
      {
          $menu_order_input_2 = $menu_order;
      }
      if ($id_cond != "in")
      {
          nm_limpa_numero($id, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_menu']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_menu']['campos_busca']['id'] = $id; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_menu']['campos_busca']['id_cond'] = $id_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_menu']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_menu']['campos_busca']['nama_set'] = $nama_set; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_menu']['campos_busca']['nama_set_cond'] = $nama_set_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_menu']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_menu']['campos_busca']['menu_order'] = $menu_order; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_menu']['campos_busca']['menu_order_cond'] = $menu_order_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_menu']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_menu']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_menu']['campos_busca'] = $Temp_Busca;
      }
   ...
   { 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['nama_set'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['nama_set'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['nama_set'] = $nama_set;
      }
      $menu_order_look = substr($this->Db->qstr($menu_order), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct menu_order from " . $this->Ini->nm_tabela . " where menu_order = '$menu_order_look' order by menu_order"; 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['menu_order'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['menu_order'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['menu_order'] = $menu_order;
      }
      ...
      //----- $nama_set
      $this->Date_part = false;
      if (isset($nama_set) || $nama_set_cond == "nu" || $nama_set_cond == "nn" || $nama_set_cond == "ep" || $nama_set_cond == "ne")
      {
         $this->monta_condicao("nama_set", $nama_set_cond, $nama_set, "", "nama_set");
      }

      //----- $menu_order
      $this->Date_part = false;
      if (isset($menu_order) || $menu_order_cond == "nu" || $menu_order_cond == "nn" || $menu_order_cond == "ep" || $menu_order_cond == "ne")
      {
         $this->monta_condicao("menu_order", $menu_order_cond, $menu_order, "", "menu_order");
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_menu']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_menu']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_menu']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_menu']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_menu']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_menu']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_menu']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_menu']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_menu']['cond_pesq'] .= $this->NM_operador;
