...
.sc-button-image.disabled img {
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['ambilFormula_okvk']['embutida_pdf']))
 {
 ?>
...
<?php
include_once("ambilFormula_okvk_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('ambilFormula_okvk_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['ambilFormula_okvk']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['ambilFormula_okvk']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['ambilFormula_okvk']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['ambilFormula_okvk']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['ambilFormula_okvk']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['ambilFormula_okvk']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['ambilFormula_okvk']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['ambilFormula_okvk']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
?>
...
<?php
 include_once("ambilFormula_okvk_js0.php");
?>
<script type="text/javascript"> 
...
<?php
$_SESSION['scriptcase']['error_span_title']['ambilFormula_okvk'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['ambilFormula_okvk'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['ambilFormula_okvk']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['ambilFormula_okvk']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['ambilFormula_okvk']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['ambilFormula_okvk']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['ambilFormula_okvk']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<?php
  ...
  {
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['ambilFormula_okvk']['where_filter']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['ambilFormula_okvk']['empty_filter'] = true;
       }
  }
?>
...
<?php
           if (($nm_apl_dependente != 1) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['ambilFormula_okvk']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['ambilFormula_okvk']['dashboard_info']['under_dashboard'])) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['ambilFormula_okvk']['nm_run_menu']) || $_SESSION['sc_session'][$this->Ini->sc_page]['ambilFormula_okvk']['nm_run_menu'] != 1))) {
...
<?php
           if (($nm_apl_dependente == 1) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['ambilFormula_okvk']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['ambilFormula_okvk']['dashboard_info']['under_dashboard']))) {
        $sCondStyle = ($this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['ambilFormula_okvk']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['ambilFormula_okvk']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("ambilFormula_okvk");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("ambilFormula_okvk");
 parent.scAjaxDetailHeight("ambilFormula_okvk", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['ambilFormula_okvk']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
