...
$old_error_handler = set_error_handler("ambilFormula_okvk_scriptcase_error_handler");

function ambilFormula_okvk_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['ambilFormula_okvk']['contr_erro']) && $_SESSION['scriptcase']['ambilFormula_okvk']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_ambilFormula_okvk->contr_ambilFormula_okvk->Apl_com_erro = true;
            if ($inicial_ambilFormula_okvk->contr_ambilFormula_okvk->NM_ajax_flag)
            {
                $inicial_ambilFormula_okvk->contr_ambilFormula_okvk->NM_ajax_info['errList']['geral_ambilFormula_okvk'][] = $msg;
                return;
            }
            ambilFormula_okvk_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function ambilFormula_okvk_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['ambilFormula_okvk'])  && '' != $_SESSION['scriptcase']['error_icon']['ambilFormula_okvk'])  ? $_SESSION['scriptcase']['error_icon']['ambilFormula_okvk']  : "";
        $sCloseIcon      = (isset($_SESSION['scriptcase']['error_close']['ambilFormula_okvk']) && '' != $_SESSION['scriptcase']['error_close']['ambilFormula_okvk']) ? $_SESSION['scriptcase']['error_close']['ambilFormula_okvk'] : "<td><input class=\"scButton_default\" type=\"button\" onClick=\"document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false\" value=\"X\" /></td>";

        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['ambilFormula_okvk']) && '' != $_SESSION['scriptcase']['error_span_title']['ambilFormula_okvk']) ? $_SESSION['scriptcase']['error_span_title']['ambilFormula_okvk'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['ambilFormula_okvk']) && '' != $_SESSION['scriptcase']['error_icon_title']['ambilFormula_okvk']) ? $_SESSION['scriptcase']['error_icon_title']['ambilFormula_okvk'] : '';
?>
