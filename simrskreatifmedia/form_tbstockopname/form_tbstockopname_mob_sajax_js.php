  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbstockopname_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbstockopname_mob_form();
	}

  // ---------- Validate socode
  function do_ajax_form_tbstockopname_mob_validate_socode()
  {
    var nomeCampo_socode = "socode";
    var var_socode = scAjaxGetFieldText(nomeCampo_socode);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbstockopname_mob_validate_socode(var_socode, var_script_case_init, do_ajax_form_tbstockopname_mob_validate_socode_cb);
  } // do_ajax_form_tbstockopname_mob_validate_socode

  function do_ajax_form_tbstockopname_mob_validate_socode_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbstockopname_mob_validate_socode_cb

  // ---------- Validate tglso
  function do_ajax_form_tbstockopname_mob_validate_tglso()
  {
    var nomeCampo_tglso = "tglso";
    var var_tglso = scAjaxGetFieldText(nomeCampo_tglso);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbstockopname_mob_validate_tglso(var_tglso, var_script_case_init, do_ajax_form_tbstockopname_mob_validate_tglso_cb);
  } // do_ajax_form_tbstockopname_mob_validate_tglso

  function do_ajax_form_tbstockopname_mob_validate_tglso_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tglso";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbstockopname_mob_validate_tglso_cb

  // ---------- Validate keterangan
  function do_ajax_form_tbstockopname_mob_validate_keterangan()
  {
    var nomeCampo_keterangan = "keterangan";
    var var_keterangan = scAjaxGetFieldText(nomeCampo_keterangan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbstockopname_mob_validate_keterangan(var_keterangan, var_script_case_init, do_ajax_form_tbstockopname_mob_validate_keterangan_cb);
  } // do_ajax_form_tbstockopname_mob_validate_keterangan

  function do_ajax_form_tbstockopname_mob_validate_keterangan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbstockopname_mob_validate_keterangan_cb

  // ---------- Validate detailso
  function do_ajax_form_tbstockopname_mob_validate_detailso()
  {
    var nomeCampo_detailso = "detailso";
    var var_detailso = scAjaxGetFieldText(nomeCampo_detailso);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbstockopname_mob_validate_detailso(var_detailso, var_script_case_init, do_ajax_form_tbstockopname_mob_validate_detailso_cb);
  } // do_ajax_form_tbstockopname_mob_validate_detailso

  function do_ajax_form_tbstockopname_mob_validate_detailso_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "detailso";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbstockopname_mob_validate_detailso_cb

  // ---------- Validate selesai
  function do_ajax_form_tbstockopname_mob_validate_selesai()
  {
    var nomeCampo_selesai = "selesai";
    var var_selesai = scAjaxGetFieldSelect(nomeCampo_selesai);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbstockopname_mob_validate_selesai(var_selesai, var_script_case_init, do_ajax_form_tbstockopname_mob_validate_selesai_cb);
  } // do_ajax_form_tbstockopname_mob_validate_selesai

  function do_ajax_form_tbstockopname_mob_validate_selesai_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "selesai";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbstockopname_mob_validate_selesai_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tbstockopname_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tbstockopname_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_socode = scAjaxGetFieldText("socode");
    var var_tglso = scAjaxGetFieldText("tglso");
    ...
    scAjaxProcOn();
    x_ajax_form_tbstockopname_mob_submit_form(var_socode, var_tglso, var_keterangan, var_selesai, var_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbstockopname_mob_submit_form_cb);
  } // do_ajax_form_tbstockopname_mob_submit_form

  function do_ajax_form_tbstockopname_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("socode");
      scAjaxHideErrorDisplay("tglso");
      scAjaxHideErrorDisplay("keterangan");
      scAjaxHideErrorDisplay("detailso");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tbstockopname_mob_submit_form_cb_after_alert);
  } // do_ajax_form_tbstockopname_mob_submit_form_cb
  function do_ajax_form_tbstockopname_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbstockopname_mob_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_tbdetailstockopname_mob"] = "off";

  function do_ajax_form_tbstockopname_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    scStatusDetail["form_tbdetailstockopname_mob"] = "on";
    x_ajax_form_tbstockopname_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbstockopname_mob_navigate_form_cb);
  } // do_ajax_form_tbstockopname_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbstockopname_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbstockopname_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_tbdetailstockopname_mob"] && "nmsc_iframe_liga_form_tbdetailstockopname_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_tbdetailstockopname_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_tbdetailstockopname_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_tbdetailstockopname_mob').contentWindow.nm_move('apl_detalhe', true, '500');
        document.getElementById('nmsc_iframe_liga_form_tbdetailstockopname_mob').style.height = "500";
        document.getElementById('nmsc_iframe_liga_form_tbdetailstockopname_mob').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbstockopname_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_tbstockopname_mob_navigate_form_cb
  function do_ajax_form_tbstockopname_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_tbstockopname_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_tbstockopname_mob_navigate_form_cb_after_alert
  function sc_hide_form_tbstockopname_mob_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_tbdetailstockopname_mob"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[0] = "socode";
  ajax_field_list[1] = "tglso";
  ajax_field_list[2] = "keterangan";
  ajax_field_list[3] = "detailso";
  ajax_field_list[4] = "selesai";
  ...
  var ajax_error_list = {
    "socode": {"label": "Kode SO", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "tglso": {"label": "Tgl SO", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "detailso": {"label": "", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  ajax_field_mult["socode"][1] = "socode";
  ajax_field_mult["tglso"][1] = "tglso";
  ajax_field_mult["keterangan"][1] = "keterangan";
  ajax_field_mult["detailso"][1] = "detailso";
  ajax_field_mult["selesai"][1] = "selesai";

  var ajax_field_id = {
    "socode": new Array("hidden_field_label_socode", "hidden_field_data_socode"),
    "tglso": new Array("hidden_field_label_tglso", "hidden_field_data_tglso"),
    "keterangan": new Array("hidden_field_label_keterangan", "hidden_field_data_keterangan"),
    "detailso": new Array("hidden_field_label_detailso", "hidden_field_data_detailso"),
