  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbstockopname" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbstockopname_form();
	}

  // ---------- Validate socode
  function do_ajax_form_tbstockopname_validate_socode()
  {
    var nomeCampo_socode = "socode";
    var var_socode = scAjaxGetFieldText(nomeCampo_socode);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbstockopname_validate_socode(var_socode, var_script_case_init, do_ajax_form_tbstockopname_validate_socode_cb);
  } // do_ajax_form_tbstockopname_validate_socode

  function do_ajax_form_tbstockopname_validate_socode_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbstockopname_validate_socode_cb

  // ---------- Validate tglso
  function do_ajax_form_tbstockopname_validate_tglso()
  {
    var nomeCampo_tglso = "tglso";
    var var_tglso = scAjaxGetFieldText(nomeCampo_tglso);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbstockopname_validate_tglso(var_tglso, var_script_case_init, do_ajax_form_tbstockopname_validate_tglso_cb);
  } // do_ajax_form_tbstockopname_validate_tglso

  function do_ajax_form_tbstockopname_validate_tglso_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tglso";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbstockopname_validate_tglso_cb

  // ---------- Validate keterangan
  function do_ajax_form_tbstockopname_validate_keterangan()
  {
    var nomeCampo_keterangan = "keterangan";
    var var_keterangan = scAjaxGetFieldText(nomeCampo_keterangan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbstockopname_validate_keterangan(var_keterangan, var_script_case_init, do_ajax_form_tbstockopname_validate_keterangan_cb);
  } // do_ajax_form_tbstockopname_validate_keterangan

  function do_ajax_form_tbstockopname_validate_keterangan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbstockopname_validate_keterangan_cb

  // ---------- Validate detailso
  function do_ajax_form_tbstockopname_validate_detailso()
  {
    var nomeCampo_detailso = "detailso";
    var var_detailso = scAjaxGetFieldText(nomeCampo_detailso);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbstockopname_validate_detailso(var_detailso, var_script_case_init, do_ajax_form_tbstockopname_validate_detailso_cb);
  } // do_ajax_form_tbstockopname_validate_detailso

  function do_ajax_form_tbstockopname_validate_detailso_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbstockopname_validate_detailso_cb

  // ---------- Validate selesai
  function do_ajax_form_tbstockopname_validate_selesai()
  {
    var nomeCampo_selesai = "selesai";
    var var_selesai = scAjaxGetFieldSelect(nomeCampo_selesai);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbstockopname_validate_selesai(var_selesai, var_script_case_init, do_ajax_form_tbstockopname_validate_selesai_cb);
  } // do_ajax_form_tbstockopname_validate_selesai

  function do_ajax_form_tbstockopname_validate_selesai_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "selesai";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbstockopname_validate_selesai_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tbstockopname_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tbstockopname_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_tbstockopname_submit_form(var_socode, var_tglso, var_keterangan, var_selesai, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbstockopname_submit_form_cb);
  } // do_ajax_form_tbstockopname_submit_form

  function do_ajax_form_tbstockopname_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tbstockopname_submit_form_cb_after_alert);
  } // do_ajax_form_tbstockopname_submit_form_cb
  function do_ajax_form_tbstockopname_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbstockopname_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_tbdetailstockopname"] = "off";

  function do_ajax_form_tbstockopname_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    scStatusDetail["form_tbdetailstockopname"] = "on";
    x_ajax_form_tbstockopname_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbstockopname_navigate_form_cb);
  } // do_ajax_form_tbstockopname_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbstockopname']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbstockopname_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_tbdetailstockopname"] && "nmsc_iframe_liga_form_tbdetailstockopname" != scMasterDetailIframe["nmsc_iframe_liga_form_tbdetailstockopname"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_tbdetailstockopname"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_tbdetailstockopname').contentWindow.nm_move('apl_detalhe', true, '500');
        document.getElementById('nmsc_iframe_liga_form_tbdetailstockopname').style.height = "500";
        document.getElementById('nmsc_iframe_liga_form_tbdetailstockopname').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbstockopname_navigate_form_cb_after_alert);
  } // do_ajax_form_tbstockopname_navigate_form_cb
  function do_ajax_form_tbstockopname_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_tbstockopname_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_tbstockopname_navigate_form_cb_after_alert
  function sc_hide_form_tbstockopname_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_tbdetailstockopname"])
    {
      return true;
    }
    return false;
