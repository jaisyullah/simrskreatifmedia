...
function displayChange_field_detailso(row, status) {
	if ("on" == status && typeof $("#nmsc_iframe_liga_form_tbdetailstockopname")[0].contentWindow.scRecreateSelect2 === "function") {
		$("#nmsc_iframe_liga_form_tbdetailstockopname")[0].contentWindow.scRecreateSelect2();
	}
}
...
function scHidePage(pageNo) {
	$("#id_form_tbstockopname_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_tglso" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_tbstockopname_validate_tglso(iSeqRow);
    },
    numberOfMonths: 1,
    changeMonth: true,
    changeYear: true,
