<?php
@session_start() ;
$_SESSION['scriptcase']['grid_hrm_mesin_presensi']['sc_process_barr'] = true;
require_once('../grid_hrm_mesin_presensi/index.php');
unset($_SESSION['scriptcase']['grid_hrm_mesin_presensi']['sc_process_barr']);
$ExportCtrl = new grid_hrm_mesin_presensi_export_control;
$ExportCtrl->Export_barr();

class grid_hrm_mesin_presensi_export_control
{
