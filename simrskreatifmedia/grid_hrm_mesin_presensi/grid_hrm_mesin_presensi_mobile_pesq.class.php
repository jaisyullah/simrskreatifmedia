...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_ip_cond" name="ip_cond" onChange="nm_campos_between(document.getElementById('id_vis_ip'), this, 'ip')">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_nama_mesin_cond" name="nama_mesin_cond" onChange="nm_campos_between(document.getElementById('id_vis_nama_mesin'), this, 'nama_mesin')">
      ...
      <br><span id="id_hide_nama_mesin"  <?php echo $str_hide_nama_mesin?>><?php
      if ($nama_mesin != "")
      {
      $nama_mesin_look = substr($this->Db->qstr($nama_mesin), 1, -1); 
      $nmgp_def_dados = array(); 
