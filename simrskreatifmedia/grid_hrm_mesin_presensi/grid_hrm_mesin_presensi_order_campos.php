...
<?php
   ...
   $Ord_Cmp = new grid_hrm_mesin_presensi_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_hrm_mesin_presensi_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_hrm_mesin_presensi']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_hrm_mesin_presensi']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_hrm_mesin_presensi']['labels']["id"])) ? $_SESSION['sc_session'][$sc_init]['grid_hrm_mesin_presensi']['labels']["id"] : "Id";
   $tab_ger_campos['nama_mesin'] = "on";
   $tab_def_campos['nama_mesin'] = "nama_mesin";
   $tab_labels["nama_mesin"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_hrm_mesin_presensi']['labels']["nama_mesin"])) ? $_SESSION['sc_session'][$sc_init]['grid_hrm_mesin_presensi']['labels']["nama_mesin"] : "Nama Mesin";
   $tab_ger_campos['keterangan'] = "on";
   $tab_def_campos['keterangan'] = "keterangan";
   $tab_labels["keterangan"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_hrm_mesin_presensi']['labels']["keterangan"])) ? $_SESSION['sc_session'][$sc_init]['grid_hrm_mesin_presensi']['labels']["keterangan"] : "Keterangan";
   $tab_ger_campos['ip'] = "on";
   $tab_def_campos['ip'] = "ip";
   $tab_labels["ip"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_hrm_mesin_presensi']['labels']["ip"])) ? $_SESSION['sc_session'][$sc_init]['grid_hrm_mesin_presensi']['labels']["ip"] : "Ip";
   $tab_ger_campos['key'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['key'] = "sc_def_col_1";
   }
   else
   {
       $tab_def_campos['key'] = "`key`";
   }
   $tab_labels["key"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_hrm_mesin_presensi']['labels']["key"])) ? $_SESSION['sc_session'][$sc_init]['grid_hrm_mesin_presensi']['labels']["key"] : "Key";
   $tab_ger_campos['status'] = "on";
   $tab_def_campos['status'] = "status";
   $tab_labels["status"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_hrm_mesin_presensi']['labels']["status"])) ? $_SESSION['sc_session'][$sc_init]['grid_hrm_mesin_presensi']['labels']["status"] : "Status";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_hrm_mesin_presensi']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_hrm_mesin_presensi']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_hrm_mesin_presensi']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_hrm_mesin_presensi']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_hrm_mesin_presensi']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_hrm_mesin_presensi']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_hrm_mesin_presensi']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_hrm_mesin_presensi']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_hrm_mesin_presensi']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_hrm_mesin_presensi_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_hrm_mesin_presensi']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_hrm_mesin_presensi']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_hrm_mesin_presensi']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_hrm_mesin_presensi']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_hrm_mesin_presensi']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
