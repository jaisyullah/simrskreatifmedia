...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "idtarifinap";$Nm_numeric[] = "tarifkamar";$Nm_numeric[] = "tarifkeperawatan";$Nm_numeric[] = "tarifvisitumum";$Nm_numeric[] = "tarifvisitspesialis";$Nm_numeric[] = "citoumum";$Nm_numeric[] = "citospesialis";$Nm_numeric[] = "idtarifinap";$Nm_numeric[] = "tarifkamar";$Nm_numeric[] = "tarifkeperawatan";$Nm_numeric[] = "tarifvisitumum";$Nm_numeric[] = "tarifvisitspesialis";$Nm_numeric[] = "citoumum";$Nm_numeric[] = "citospesialis";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_tarifkeperawatan_cond" name="tarifkeperawatan_cond" onChange="nm_campos_between(document.getElementById('id_vis_tarifkeperawatan'), this, 'tarifkeperawatan')">
      ...
      <br><span id="id_hide_tarifkeperawatan"  <?php echo $str_hide_tarifkeperawatan?>><?php
      if ($tarifkeperawatan != "")
      {
      $tarifkeperawatan_look = substr($this->Db->qstr($tarifkeperawatan), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_idtarifinap_cond" name="idtarifinap_cond" onChange="nm_campos_between(document.getElementById('id_vis_idtarifinap'), this, 'idtarifinap')">
      ...
      <br><span id="id_hide_idtarifinap"  <?php echo $str_hide_idtarifinap?>><?php
      if ($idtarifinap != "")
      {
      $idtarifinap_look = substr($this->Db->qstr($idtarifinap), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_namakelas_cond" name="namakelas_cond" onChange="nm_campos_between(document.getElementById('id_vis_namakelas'), this, 'namakelas')">
      ...
      <br><span id="id_hide_namakelas"  <?php echo $str_hide_namakelas?>><?php
      if ($namakelas != "")
      {
      $namakelas_look = substr($this->Db->qstr($namakelas), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_tarifkamar_cond" name="tarifkamar_cond" onChange="nm_campos_between(document.getElementById('id_vis_tarifkamar'), this, 'tarifkamar')">
      ...
      <br><span id="id_hide_tarifkamar"  <?php echo $str_hide_tarifkamar?>><?php
      if ($tarifkamar != "")
      {
      $tarifkamar_look = substr($this->Db->qstr($tarifkamar), 1, -1); 
      $nmgp_def_dados = array(); 
