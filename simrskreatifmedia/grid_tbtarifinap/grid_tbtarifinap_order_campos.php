...
<?php
   ...
   $Ord_Cmp = new grid_tbtarifinap_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_tbtarifinap_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbtarifinap']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tbtarifinap']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['idtarifinap'] = "idTarifInap";
   $tab_labels["idtarifinap"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbtarifinap']['labels']["idtarifinap"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbtarifinap']['labels']["idtarifinap"] : "Id Tarif Inap";
   $tab_ger_campos['namakelas'] = "on";
   $tab_def_campos['namakelas'] = "namaKelas";
   $tab_labels["namakelas"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbtarifinap']['labels']["namakelas"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbtarifinap']['labels']["namakelas"] : "Nama Kelas";
   $tab_ger_campos['tarifkamar'] = "on";
   $tab_def_campos['tarifkamar'] = "tarifKamar";
   $tab_labels["tarifkamar"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbtarifinap']['labels']["tarifkamar"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbtarifinap']['labels']["tarifkamar"] : "Tarif Kamar";
   $tab_ger_campos['tarifkeperawatan'] = "on";
   $tab_def_campos['tarifkeperawatan'] = "tarifKeperawatan";
   $tab_labels["tarifkeperawatan"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbtarifinap']['labels']["tarifkeperawatan"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbtarifinap']['labels']["tarifkeperawatan"] : "Tarif Keperawatan";
   $tab_ger_campos['tarifvisitumum'] = "on";
   $tab_def_campos['tarifvisitumum'] = "tarifVisitUmum";
   $tab_labels["tarifvisitumum"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbtarifinap']['labels']["tarifvisitumum"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbtarifinap']['labels']["tarifvisitumum"] : "Tarif Visit Umum";
   $tab_ger_campos['tarifvisitspesialis'] = "on";
   $tab_def_campos['tarifvisitspesialis'] = "tarifVisitSpesialis";
   $tab_labels["tarifvisitspesialis"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbtarifinap']['labels']["tarifvisitspesialis"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbtarifinap']['labels']["tarifvisitspesialis"] : "Tarif Visit Spesialis";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_tbtarifinap']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_tbtarifinap']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_tbtarifinap']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbtarifinap']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tbtarifinap']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_tbtarifinap']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_tbtarifinap']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_tbtarifinap']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_tbtarifinap']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_tbtarifinap_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_tbtarifinap']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_tbtarifinap']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_tbtarifinap']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_tbtarifinap']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_tbtarifinap']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
