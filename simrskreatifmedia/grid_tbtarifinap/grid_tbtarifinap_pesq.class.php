...
class grid_tbtarifinap_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifinap']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_tbtarifinap_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_tbtarifinap_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_tbtarifinap_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_tarifkeperawatan')
      {
          $tarifkeperawatan = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_tarifkeperawatan($tarifkeperawatan);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_idtarifinap')
      {
          $idtarifinap = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_idtarifinap($idtarifinap);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_namakelas')
      {
          $namakelas = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_namakelas($namakelas);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_tarifkamar')
      {
          $tarifkamar = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_tarifkamar($tarifkamar);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function lookup_ajax_tarifkeperawatan($tarifkeperawatan)
   {
      $tarifkeperawatan = str_replace($_SESSION['scriptcase']['reg_conf']['grup_num'], "", $tarifkeperawatan);
      $tarifkeperawatan = substr($this->Db->qstr($tarifkeperawatan), 1, -1);
            $tarifkeperawatan_look = substr($this->Db->qstr($tarifkeperawatan), 1, -1); 
      $nmgp_def_dados = array(); 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct tarifKeperawatan from " . $this->Ini->nm_tabela . " where   CAST (tarifKeperawatan AS TEXT)  like '%" . $tarifkeperawatan . "%' order by tarifKeperawatan"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct tarifKeperawatan from " . $this->Ini->nm_tabela . " where   CAST (tarifKeperawatan AS VARCHAR)  like '%" . $tarifkeperawatan . "%' order by tarifKeperawatan"; 
      }
      else
      {
          $nm_comando = "select distinct tarifKeperawatan from " . $this->Ini->nm_tabela . " where  tarifKeperawatan like '%" . $tarifkeperawatan . "%' order by tarifKeperawatan"; 
      }
      unset($cmp1,$cmp2);
   ...
   function lookup_ajax_idtarifinap($idtarifinap)
   {
      $idtarifinap = str_replace($_SESSION['scriptcase']['reg_conf']['grup_num'], "", $idtarifinap);
      $idtarifinap = substr($this->Db->qstr($idtarifinap), 1, -1);
            $idtarifinap_look = substr($this->Db->qstr($idtarifinap), 1, -1); 
      $nmgp_def_dados = array(); 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct idTarifInap from " . $this->Ini->nm_tabela . " where   CAST (idTarifInap AS TEXT)  like '%" . $idtarifinap . "%' order by idTarifInap"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct idTarifInap from " . $this->Ini->nm_tabela . " where   CAST (idTarifInap AS VARCHAR)  like '%" . $idtarifinap . "%' order by idTarifInap"; 
      }
      else
      {
          $nm_comando = "select distinct idTarifInap from " . $this->Ini->nm_tabela . " where  idTarifInap like '%" . $idtarifinap . "%' order by idTarifInap"; 
      }
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
   ...
   function lookup_ajax_namakelas($namakelas)
   {
      $namakelas = substr($this->Db->qstr($namakelas), 1, -1);
            $namakelas_look = substr($this->Db->qstr($namakelas), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct namaKelas from " . $this->Ini->nm_tabela . " where  namaKelas like '%" . $namakelas . "%' order by namaKelas"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
   ...
   function lookup_ajax_tarifkamar($tarifkamar)
   {
      $tarifkamar = str_replace($_SESSION['scriptcase']['reg_conf']['grup_num'], "", $tarifkamar);
      $tarifkamar = substr($this->Db->qstr($tarifkamar), 1, -1);
            $tarifkamar_look = substr($this->Db->qstr($tarifkamar), 1, -1); 
      $nmgp_def_dados = array(); 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct tarifKamar from " . $this->Ini->nm_tabela . " where   CAST (tarifKamar AS TEXT)  like '%" . $tarifkamar . "%' order by tarifKamar"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct tarifKamar from " . $this->Ini->nm_tabela . " where   CAST (tarifKamar AS VARCHAR)  like '%" . $tarifkamar . "%' order by tarifKamar"; 
      }
      else
      {
          $nm_comando = "select distinct tarifKamar from " . $this->Ini->nm_tabela . " where  tarifKamar like '%" . $tarifkamar . "%' order by tarifKamar"; 
      }
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifinap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifinap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifinap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifinap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifinap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifinap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifinap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifinap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifinap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifinap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifinap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifinap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifinap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifinap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifinap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - tbtarifinap</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_tbtarifinap/grid_tbtarifinap_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_tbtarifinap_ajax_search.js"></script>
 <script type="text/javascript" src="grid_tbtarifinap_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_tbtarifinap_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_tbtarifinap']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_tbtarifinap']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_tarifkeperawatan_cond#NMF#' + search_get_sel_txt('SC_tarifkeperawatan_cond') + '@NMF@';
  str_out += 'SC_tarifkeperawatan#NMF#' + search_get_text('SC_tarifkeperawatan') + '@NMF@';
  str_out += 'id_ac_tarifkeperawatan#NMF#' + search_get_text('id_ac_tarifkeperawatan') + '@NMF@';
  str_out += 'SC_idtarifinap_cond#NMF#' + search_get_sel_txt('SC_idtarifinap_cond') + '@NMF@';
  str_out += 'SC_idtarifinap#NMF#' + search_get_text('SC_idtarifinap') + '@NMF@';
  str_out += 'id_ac_idtarifinap#NMF#' + search_get_text('id_ac_idtarifinap') + '@NMF@';
  str_out += 'SC_namakelas_cond#NMF#' + search_get_sel_txt('SC_namakelas_cond') + '@NMF@';
  str_out += 'SC_namakelas#NMF#' + search_get_text('SC_namakelas') + '@NMF@';
  str_out += 'id_ac_namakelas#NMF#' + search_get_text('id_ac_namakelas') + '@NMF@';
  str_out += 'SC_tarifkamar_cond#NMF#' + search_get_sel_txt('SC_tarifkamar_cond') + '@NMF@';
  str_out += 'SC_tarifkamar#NMF#' + search_get_text('SC_tarifkamar') + '@NMF@';
  str_out += 'id_ac_tarifkamar#NMF#' + search_get_text('id_ac_tarifkamar') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
   $("#id_ac_idtarifinap").autocomplete({
     minLength: 1,
     ...
     $.ajax({
       ...
       data: {
          ...
          nmgp_parms: "NM_ajax_opcao?#?autocomp_idtarifinap",
          max_itens: "10",
          cod_desc: "N",
     ...
     select: function (event, ui) {
       $("#SC_idtarifinap").val(ui.item.value);
     ...
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_idtarifinap").val( $(this).val() );
       }
     }
   });
   $("#id_ac_namakelas").autocomplete({
     minLength: 1,
     source: function (request, response) {
     $.ajax({
       url: "index.php",
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_namakelas",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_namakelas").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     focus: function (event, ui) {
     ...
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_namakelas").val( $(this).val() );
       }
     }
   });
   $("#id_ac_tarifkamar").autocomplete({
     minLength: 1,
     source: function (request, response) {
     $.ajax({
       url: "index.php",
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_tarifkamar",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_tarifkamar").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     focus: function (event, ui) {
     ...
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_tarifkamar").val( $(this).val() );
       }
     }
   });
   $("#id_ac_tarifkeperawatan").autocomplete({
     minLength: 1,
     source: function (request, response) {
     $.ajax({
       url: "index.php",
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_tarifkeperawatan",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_tarifkeperawatan").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     focus: function (event, ui) {
     ...
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_tarifkeperawatan").val( $(this).val() );
       }
     }
   });
 });
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifinap']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div class="scFilterHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFilterHeaderFont" style="float: left; text-transform: uppercase;"><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - tbtarifinap</div>
...
<?php
   ...
   {
      global 
             $tarifkeperawatan_cond, $tarifkeperawatan, $tarifkeperawatan_autocomp,
             $idtarifinap_cond, $idtarifinap, $idtarifinap_autocomp,
             $namakelas_cond, $namakelas, $namakelas_autocomp,
             $tarifkamar_cond, $tarifkamar, $tarifkamar_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifinap']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifinap']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifinap']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifinap']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $tarifkeperawatan = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifinap']['campos_busca']['tarifkeperawatan']; 
          $tarifkeperawatan_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifinap']['campos_busca']['tarifkeperawatan_cond']; 
          $idtarifinap = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifinap']['campos_busca']['idtarifinap']; 
          $idtarifinap_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifinap']['campos_busca']['idtarifinap_cond']; 
          $namakelas = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifinap']['campos_busca']['namakelas']; 
          $namakelas_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifinap']['campos_busca']['namakelas_cond']; 
          $tarifkamar = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifinap']['campos_busca']['tarifkamar']; 
          $tarifkamar_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifinap']['campos_busca']['tarifkamar_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifinap']['campos_busca']['NM_operador']; 
      } 
      if (!isset($tarifkeperawatan_cond) || empty($tarifkeperawatan_cond))
      {
         $tarifkeperawatan_cond = "gt";
      }
      if (!isset($idtarifinap_cond) || empty($idtarifinap_cond))
      {
         $idtarifinap_cond = "gt";
      }
      if (!isset($namakelas_cond) || empty($namakelas_cond))
      {
         $namakelas_cond = "qp";
      }
      if (!isset($tarifkamar_cond) || empty($tarifkamar_cond))
      {
         $tarifkamar_cond = "gt";
      }
      ...
      $str_hide_tarifkeperawatan = (in_array($tarifkeperawatan_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_idtarifinap = (in_array($idtarifinap_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_namakelas = (in_array($namakelas_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_tarifkamar = (in_array($tarifkamar_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      if (!isset($tarifkeperawatan) || $tarifkeperawatan == "")
      {
          $tarifkeperawatan = "";
      }
      if (isset($tarifkeperawatan) && !empty($tarifkeperawatan))
      {
         $tmp_pos = strpos($tarifkeperawatan, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $tarifkeperawatan = substr($tarifkeperawatan, 0, $tmp_pos);
         }
      }
      if (!isset($idtarifinap) || $idtarifinap == "")
      {
          $idtarifinap = "";
      }
      if (isset($idtarifinap) && !empty($idtarifinap))
      {
         $tmp_pos = strpos($idtarifinap, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $idtarifinap = substr($idtarifinap, 0, $tmp_pos);
         }
      }
      if (!isset($namakelas) || $namakelas == "")
      {
          $namakelas = "";
      }
      if (isset($namakelas) && !empty($namakelas))
      {
         $tmp_pos = strpos($namakelas, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $namakelas = substr($namakelas, 0, $tmp_pos);
         }
      }
      if (!isset($tarifkamar) || $tarifkamar == "")
      {
          $tarifkamar = "";
      }
      if (isset($tarifkamar) && !empty($tarifkamar))
      {
         $tmp_pos = strpos($tarifkamar, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $tarifkamar = substr($tarifkamar, 0, $tmp_pos);
         }
      }
?>
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_tarifkeperawatan_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['tarifkeperawatan'])) ? $this->New_label['tarifkeperawatan'] : "Tarif Keperawatan"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_tarifkeperawatan_cond" name="tarifkeperawatan_cond" onChange="nm_campos_between(document.getElementById('id_vis_tarifkeperawatan'), this, 'tarifkeperawatan')">
       <OPTION value="gt" <?php if ("gt" == $tarifkeperawatan_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $tarifkeperawatan_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $tarifkeperawatan_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_tarifkeperawatan" <?php echo $str_hide_tarifkeperawatan?> valign="top">
 ...
 $nmgp_tab_label .= "tarifkeperawatan?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
...
<?php
      ...
      $tarifkeperawatan_look = substr($this->Db->qstr($tarifkeperawatan), 1, -1); 
      $nmgp_def_dados = array(); 
   if (is_numeric($tarifkeperawatan))
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct tarifKeperawatan from " . $this->Ini->nm_tabela . " where tarifKeperawatan = $tarifkeperawatan_look order by tarifKeperawatan"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct tarifKeperawatan from " . $this->Ini->nm_tabela . " where tarifKeperawatan = $tarifkeperawatan_look order by tarifKeperawatan"; 
      ...
      if (isset($nmgp_def_dados[0][$tarifkeperawatan]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$tarifkeperawatan];
      }
      else
      {
            nmgp_Form_Num_Val($tarifkeperawatan, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          $sAutocompValue = $tarifkeperawatan;
      }
?>
<INPUT  type="text" id="SC_tarifkeperawatan" name="tarifkeperawatan" value="<?php echo NM_encode_input($tarifkeperawatan) ?>" size=7 alt="{datatype: 'integer', maxLength: 7, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_tarifkeperawatan" name="tarifkeperawatan_autocomp" size="7"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 7, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
      ...
      <TD id='SC_idtarifinap_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['idtarifinap'])) ? $this->New_label['idtarifinap'] : "Id Tarif Inap"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_idtarifinap_cond" name="idtarifinap_cond" onChange="nm_campos_between(document.getElementById('id_vis_idtarifinap'), this, 'idtarifinap')">
       <OPTION value="gt" <?php if ("gt" == $idtarifinap_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $idtarifinap_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $idtarifinap_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_idtarifinap" <?php echo $str_hide_idtarifinap?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['idtarifinap'])) ? $this->New_label['idtarifinap'] : "Id Tarif Inap";
 $nmgp_tab_label .= "idtarifinap?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      $idtarifinap_look = substr($this->Db->qstr($idtarifinap), 1, -1); 
      $nmgp_def_dados = array(); 
   if (is_numeric($idtarifinap))
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct idTarifInap from " . $this->Ini->nm_tabela . " where idTarifInap = $idtarifinap_look order by idTarifInap"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct idTarifInap from " . $this->Ini->nm_tabela . " where idTarifInap = $idtarifinap_look order by idTarifInap"; 
      ...
      if (isset($nmgp_def_dados[0][$idtarifinap]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$idtarifinap];
      }
      else
      {
            nmgp_Form_Num_Val($idtarifinap, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          $sAutocompValue = $idtarifinap;
      }
?>
<INPUT  type="text" id="SC_idtarifinap" name="idtarifinap" value="<?php echo NM_encode_input($idtarifinap) ?>" size=5 alt="{datatype: 'integer', maxLength: 5, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_idtarifinap" name="idtarifinap_autocomp" size="5"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 5, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
      ...
      <TD id='SC_namakelas_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['namakelas'])) ? $this->New_label['namakelas'] : "Nama Kelas"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_namakelas_cond" name="namakelas_cond" onChange="nm_campos_between(document.getElementById('id_vis_namakelas'), this, 'namakelas')">
       <OPTION value="qp" <?php if ("qp" == $namakelas_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $namakelas_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $namakelas_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $namakelas_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_namakelas" <?php echo $str_hide_namakelas?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['namakelas'])) ? $this->New_label['namakelas'] : "Nama Kelas";
 $nmgp_tab_label .= "namakelas?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      $namakelas_look = substr($this->Db->qstr($namakelas), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct namaKelas from " . $this->Ini->nm_tabela . " where namaKelas = '$namakelas_look' order by namaKelas"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      if (isset($nmgp_def_dados[0][$namakelas]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$namakelas];
      }
      else
      {
          $sAutocompValue = $namakelas;
      }
?>
<INPUT  type="text" id="SC_namakelas" name="namakelas" value="<?php echo NM_encode_input($namakelas) ?>"  size=25 alt="{datatype: 'text', maxLength: 25, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_namakelas" name="namakelas_autocomp" size="25"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 25, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_tarifkamar_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['tarifkamar'])) ? $this->New_label['tarifkamar'] : "Tarif Kamar"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_tarifkamar_cond" name="tarifkamar_cond" onChange="nm_campos_between(document.getElementById('id_vis_tarifkamar'), this, 'tarifkamar')">
       <OPTION value="gt" <?php if ("gt" == $tarifkamar_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $tarifkamar_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $tarifkamar_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_tarifkamar" <?php echo $str_hide_tarifkamar?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['tarifkamar'])) ? $this->New_label['tarifkamar'] : "Tarif Kamar";
 $nmgp_tab_label .= "tarifkamar?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      $tarifkamar_look = substr($this->Db->qstr($tarifkamar), 1, -1); 
      $nmgp_def_dados = array(); 
   if (is_numeric($tarifkamar))
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct tarifKamar from " . $this->Ini->nm_tabela . " where tarifKamar = $tarifkamar_look order by tarifKamar"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct tarifKamar from " . $this->Ini->nm_tabela . " where tarifKamar = $tarifkamar_look order by tarifKamar"; 
      ...
      if (isset($nmgp_def_dados[0][$tarifkamar]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$tarifkamar];
      }
      else
      {
            nmgp_Form_Num_Val($tarifkamar, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          $sAutocompValue = $tarifkamar;
      }
?>
<INPUT  type="text" id="SC_tarifkamar" name="tarifkamar" value="<?php echo NM_encode_input($tarifkamar) ?>" size=8 alt="{datatype: 'integer', maxLength: 8, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_tarifkamar" name="tarifkamar_autocomp" size="8"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 8, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
...
?>
<?php
   if (is_file("grid_tbtarifinap_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_tbtarifinap']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_tbtarifinap']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifinap']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.tarifkeperawatan_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_tarifkeperawatan'), document.F1.tarifkeperawatan_cond, 'tarifkeperawatan');
   document.F1.tarifkeperawatan.value = "";
   document.F1.tarifkeperawatan_autocomp.value = "";
   document.F1.idtarifinap_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_idtarifinap'), document.F1.idtarifinap_cond, 'idtarifinap');
   document.F1.idtarifinap.value = "";
   document.F1.idtarifinap_autocomp.value = "";
   document.F1.namakelas_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_namakelas'), document.F1.namakelas_cond, 'namakelas');
   document.F1.namakelas.value = "";
   document.F1.namakelas_autocomp.value = "";
   document.F1.tarifkamar_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_tarifkamar'), document.F1.tarifkamar_cond, 'tarifkamar');
   document.F1.tarifkamar.value = "";
   document.F1.tarifkamar_autocomp.value = "";
 }
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "simrskreatifmedia/grid_tbtarifinap";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifinap']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifinap']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifinap']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_tarifkeperawatan_cond'] = 'cond';
      $tp_fields['SC_tarifkeperawatan'] = 'text_aut';
      $tp_fields['id_ac_tarifkeperawatan'] = 'text_aut';
      $tp_fields['SC_idtarifinap_cond'] = 'cond';
      $tp_fields['SC_idtarifinap'] = 'text_aut';
      $tp_fields['id_ac_idtarifinap'] = 'text_aut';
      $tp_fields['SC_namakelas_cond'] = 'cond';
      $tp_fields['SC_namakelas'] = 'text_aut';
      $tp_fields['id_ac_namakelas'] = 'text_aut';
      $tp_fields['SC_tarifkamar_cond'] = 'cond';
      $tp_fields['SC_tarifkamar'] = 'text_aut';
      $tp_fields['id_ac_tarifkamar'] = 'text_aut';
   ...
   {
      global $tarifkeperawatan_cond, $tarifkeperawatan, $tarifkeperawatan_autocomp,
             $idtarifinap_cond, $idtarifinap, $idtarifinap_autocomp,
             $namakelas_cond, $namakelas, $namakelas_autocomp,
             $tarifkamar_cond, $tarifkamar, $tarifkamar_autocomp, $nmgp_tab_label;

      $C_formatado = true;
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_conv_dados.php", "F", "nm_conv_limpa_dado") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
      if (!empty($tarifkeperawatan_autocomp) && empty($tarifkeperawatan))
      {
          $tarifkeperawatan = $tarifkeperawatan_autocomp;
      }
      if (!empty($idtarifinap_autocomp) && empty($idtarifinap))
      {
          $idtarifinap = $idtarifinap_autocomp;
      }
      if (!empty($namakelas_autocomp) && empty($namakelas))
      {
          $namakelas = $namakelas_autocomp;
      }
      if (!empty($tarifkamar_autocomp) && empty($tarifkamar))
      {
          $tarifkamar = $tarifkamar_autocomp;
      }
      $tarifkeperawatan_cond_salva = $tarifkeperawatan_cond; 
      if (!isset($tarifkeperawatan_input_2) || $tarifkeperawatan_input_2 == "")
      {
          $tarifkeperawatan_input_2 = $tarifkeperawatan;
      }
      $idtarifinap_cond_salva = $idtarifinap_cond; 
      if (!isset($idtarifinap_input_2) || $idtarifinap_input_2 == "")
      {
          $idtarifinap_input_2 = $idtarifinap;
      }
      $namakelas_cond_salva = $namakelas_cond; 
      if (!isset($namakelas_input_2) || $namakelas_input_2 == "")
      {
          $namakelas_input_2 = $namakelas;
      }
      $tarifkamar_cond_salva = $tarifkamar_cond; 
      if (!isset($tarifkamar_input_2) || $tarifkamar_input_2 == "")
      {
          $tarifkamar_input_2 = $tarifkamar;
      }
      if ($tarifkeperawatan_cond != "in")
      {
          nm_limpa_numero($tarifkeperawatan, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($idtarifinap_cond != "in")
      {
          nm_limpa_numero($idtarifinap, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($tarifkamar_cond != "in")
      {
          nm_limpa_numero($tarifkamar, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifinap']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifinap']['campos_busca']['tarifkeperawatan'] = $tarifkeperawatan; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifinap']['campos_busca']['tarifkeperawatan_cond'] = $tarifkeperawatan_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifinap']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifinap']['campos_busca']['idtarifinap'] = $idtarifinap; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifinap']['campos_busca']['idtarifinap_cond'] = $idtarifinap_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifinap']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifinap']['campos_busca']['namakelas'] = $namakelas; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifinap']['campos_busca']['namakelas_cond'] = $namakelas_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifinap']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifinap']['campos_busca']['tarifkamar'] = $tarifkamar; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifinap']['campos_busca']['tarifkamar_cond'] = $tarifkamar_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifinap']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifinap']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifinap']['campos_busca'] = $Temp_Busca;
      }
      if ($tarifkeperawatan_cond != "in" && $tarifkeperawatan_cond != "bw" && !empty($tarifkeperawatan) && !is_numeric($tarifkeperawatan))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Tarif Keperawatan";
      }
      if ($tarifkeperawatan_cond == "bw" && ((!empty($tarifkeperawatan) && !is_numeric($tarifkeperawatan)) || (!empty($tarifkeperawatan_input_2) && !is_numeric($tarifkeperawatan_input_2)) ))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Tarif Keperawatan";
      }
      if ($idtarifinap_cond != "in" && $idtarifinap_cond != "bw" && !empty($idtarifinap) && !is_numeric($idtarifinap))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Id Tarif Inap";
      }
      if ($idtarifinap_cond == "bw" && ((!empty($idtarifinap) && !is_numeric($idtarifinap)) || (!empty($idtarifinap_input_2) && !is_numeric($idtarifinap_input_2)) ))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Id Tarif Inap";
      }
      if ($tarifkamar_cond != "in" && $tarifkamar_cond != "bw" && !empty($tarifkamar) && !is_numeric($tarifkamar))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Tarif Kamar";
      }
      if ($tarifkamar_cond == "bw" && ((!empty($tarifkamar) && !is_numeric($tarifkamar)) || (!empty($tarifkamar_input_2) && !is_numeric($tarifkamar_input_2)) ))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Tarif Kamar";
      }
      if (!empty($this->Campos_Mens_erro)) 
   ...
   { 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['tarifkeperawatan'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['tarifkeperawatan'] = $cmp1;
      }
      else
      {
          $cmp1 = $tarifkeperawatan;
   ...
   { 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['idtarifinap'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['idtarifinap'] = $cmp1;
      }
      else
      {
          $cmp1 = $idtarifinap;
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['namakelas'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['namakelas'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['namakelas'] = $namakelas;
      }
      $tarifkamar_look = substr($this->Db->qstr($tarifkamar), 1, -1); 
      $nmgp_def_dados = array(); 
   if (is_numeric($tarifkamar))
   { 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['tarifkamar'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['tarifkamar'] = $cmp1;
      }
      else
      {
          $cmp1 = $tarifkamar;
      ...
      if (isset($tarifkeperawatan) || $tarifkeperawatan_cond == "nu" || $tarifkeperawatan_cond == "nn" || $tarifkeperawatan_cond == "ep" || $tarifkeperawatan_cond == "ne")
      {
         $this->monta_condicao("tarifKeperawatan", $tarifkeperawatan_cond, $tarifkeperawatan, "", "tarifkeperawatan");
      }

      //----- $idtarifinap
      $this->Date_part = false;
      if (isset($idtarifinap) || $idtarifinap_cond == "nu" || $idtarifinap_cond == "nn" || $idtarifinap_cond == "ep" || $idtarifinap_cond == "ne")
      {
         $this->monta_condicao("idTarifInap", $idtarifinap_cond, $idtarifinap, "", "idtarifinap");
      }

      //----- $namakelas
      $this->Date_part = false;
      if (isset($namakelas) || $namakelas_cond == "nu" || $namakelas_cond == "nn" || $namakelas_cond == "ep" || $namakelas_cond == "ne")
      {
         $this->monta_condicao("namaKelas", $namakelas_cond, $namakelas, "", "namakelas");
      }

      //----- $tarifkamar
      $this->Date_part = false;
      if (isset($tarifkamar) || $tarifkamar_cond == "nu" || $tarifkamar_cond == "nn" || $tarifkamar_cond == "ep" || $tarifkamar_cond == "ne")
      {
         $this->monta_condicao("tarifKamar", $tarifkamar_cond, $tarifkamar, "", "tarifkamar");
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifinap']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifinap']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifinap']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifinap']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifinap']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifinap']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifinap']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifinap']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifinap']['cond_pesq'] .= $this->NM_operador;
