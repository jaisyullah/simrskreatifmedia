...
?>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_period_income_summary']['embutida_pdf']))
 {
 ?>
...
<?php
include_once("form_period_income_summary_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_period_income_summary_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_period_income_summary']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_period_income_summary']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_period_income_summary']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_period_income_summary']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_period_income_summary']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_period_income_summary']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_period_income_summary']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_period_income_summary']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
?>
...
<?php
 include_once("form_period_income_summary_js0.php");
?>
<script type="text/javascript"> 
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_period_income_summary'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_period_income_summary'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_period_income_summary']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_period_income_summary']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_period_income_summary']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_period_income_summary']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['form_period_income_summary']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<?php
  ...
  {
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_period_income_summary']['where_filter']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['form_period_income_summary']['empty_filter'] = true;
       }
  }
?>
...
<?php
           if (($nm_apl_dependente != 1) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_period_income_summary']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_period_income_summary']['dashboard_info']['under_dashboard'])) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_period_income_summary']['nm_run_menu']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_period_income_summary']['nm_run_menu'] != 1))) {
...
<?php
           if (($nm_apl_dependente == 1) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_period_income_summary']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_period_income_summary']['dashboard_info']['under_dashboard']))) {
        $sCondStyle = ($this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_period_income_summary']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_period_income_summary']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_period_income_summary");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_period_income_summary");
 parent.scAjaxDetailHeight("form_period_income_summary", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_period_income_summary']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
