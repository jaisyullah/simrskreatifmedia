...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "openrate";$Nm_numeric[] = "lockdiag";$Nm_numeric[] = "openitemrate";$Nm_numeric[] = "tindwithnote";$Nm_numeric[] = "aktif";$Nm_numeric[] = "openrate";$Nm_numeric[] = "lockdiag";$Nm_numeric[] = "openitemrate";$Nm_numeric[] = "tindwithnote";$Nm_numeric[] = "aktif";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_polycode_cond" name="polycode_cond" onChange="nm_campos_between(document.getElementById('id_vis_polycode'), this, 'polycode')">
      ...
      <br><span id="id_hide_polycode"  <?php echo $str_hide_polycode?>><?php
      if ($polycode != "")
      {
      $polycode_look = substr($this->Db->qstr($polycode), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_headname_cond" name="headname_cond" onChange="nm_campos_between(document.getElementById('id_vis_headname'), this, 'headname')">
      ...
      <br><span id="id_hide_headname"  <?php echo $str_hide_headname?>><?php
      if ($headname != "")
      {
      $headname_look = substr($this->Db->qstr($headname), 1, -1); 
      $nmgp_def_dados = array(); 
