...
class grid_tbpoli_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpoli']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_tbpoli_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_tbpoli_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_tbpoli_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_polycode')
      {
          $polycode = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_polycode($polycode);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_headname')
      {
          $headname = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_headname($headname);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function lookup_ajax_polycode($polycode)
   {
      $polycode = substr($this->Db->qstr($polycode), 1, -1);
            $polycode_look = substr($this->Db->qstr($polycode), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct polyCode from " . $this->Ini->nm_tabela . " where  polyCode like '%" . $polycode . "%' order by polyCode"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
   ...
   function lookup_ajax_headname($headname)
   {
      $headname = substr($this->Db->qstr($headname), 1, -1);
            $headname_look = substr($this->Db->qstr($headname), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct headName from " . $this->Ini->nm_tabela . " where  headName like '%" . $headname . "%' order by headName"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpoli']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpoli']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpoli']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpoli']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpoli']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpoli']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpoli']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpoli']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpoli']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpoli']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpoli']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpoli']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpoli']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpoli']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpoli']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - Poliklinik</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_tbpoli/grid_tbpoli_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_tbpoli_ajax_search.js"></script>
 <script type="text/javascript" src="grid_tbpoli_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_tbpoli_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_tbpoli']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_tbpoli']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_polycode_cond#NMF#' + search_get_sel_txt('SC_polycode_cond') + '@NMF@';
  str_out += 'SC_polycode#NMF#' + search_get_text('SC_polycode') + '@NMF@';
  str_out += 'id_ac_polycode#NMF#' + search_get_text('id_ac_polycode') + '@NMF@';
  ...
  str_out += 'SC_headname_cond#NMF#' + search_get_sel_txt('SC_headname_cond') + '@NMF@';
  str_out += 'SC_headname#NMF#' + search_get_text('SC_headname') + '@NMF@';
  str_out += 'id_ac_headname#NMF#' + search_get_text('id_ac_headname') + '@NMF@';
   ...
   $("#id_ac_polycode").autocomplete({
     ...
     $.ajax({
       ...
       data: {
          ...
          nmgp_parms: "NM_ajax_opcao?#?autocomp_polycode",
          max_itens: "10",
          cod_desc: "N",
   ...
   $("#id_ac_headname").autocomplete({
     ...
     $.ajax({
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_headname",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpoli']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div class="scFilterHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFilterHeaderFont" style="float: left; text-transform: uppercase;"><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - Poliklinik</div>
...
<?php
   ...
   function monta_form()
   {
      global 
             ...
             $polycode_cond, $polycode, $polycode_autocomp,
             $name_cond, $name, $name_autocomp,
             $headname_cond, $headname, $headname_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpoli']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpoli']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpoli']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpoli']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $note = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpoli']['campos_busca']['note']; 
          $note_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpoli']['campos_busca']['note_cond']; 
          $polycode = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpoli']['campos_busca']['polycode']; 
          $polycode_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpoli']['campos_busca']['polycode_cond']; 
          $name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpoli']['campos_busca']['name']; 
          $name_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpoli']['campos_busca']['name_cond']; 
          $headname = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpoli']['campos_busca']['headname']; 
          $headname_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpoli']['campos_busca']['headname_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpoli']['campos_busca']['NM_operador']; 
      } 
      if (!isset($note_cond) || empty($note_cond))
      {
         $note_cond = "qp";
      }
      if (!isset($polycode_cond) || empty($polycode_cond))
      {
         $polycode_cond = "qp";
      }
      ...
      if (!isset($headname_cond) || empty($headname_cond))
      {
         $headname_cond = "qp";
      }
      ...
      $str_hide_polycode = (in_array($polycode_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_name = (in_array($name_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_headname = (in_array($headname_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      if (!isset($polycode) || $polycode == "")
      {
          $polycode = "";
      }
      if (isset($polycode) && !empty($polycode))
      {
         $tmp_pos = strpos($polycode, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $polycode = substr($polycode, 0, $tmp_pos);
         }
      }
      if (!isset($name) || $name == "")
      {
      ...
      if (!isset($headname) || $headname == "")
      {
          $headname = "";
      }
      if (isset($headname) && !empty($headname))
      {
         $tmp_pos = strpos($headname, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $headname = substr($headname, 0, $tmp_pos);
         }
      }
?>
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_note_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['note'])) ? $this->New_label['note'] : "Keterangan"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_note_cond" name="note_cond" onChange="nm_campos_between(document.getElementById('id_vis_note'), this, 'note')">
       ...
       <OPTION value="np" <?php if ("np" == $note_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $note_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $note_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
...
?>
<INPUT  type="text" id="SC_note" name="note" value="<?php echo NM_encode_input($note) ?>"  size=50 alt="{datatype: 'text', maxLength: 200, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_note" name="note_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 200, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_polycode_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['polycode'])) ? $this->New_label['polycode'] : "Kode Poli"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_polycode_cond" name="polycode_cond" onChange="nm_campos_between(document.getElementById('id_vis_polycode'), this, 'polycode')">
       <OPTION value="qp" <?php if ("qp" == $polycode_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $polycode_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $polycode_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $polycode_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_polycode" <?php echo $str_hide_polycode?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['polycode'])) ? $this->New_label['polycode'] : "Kode Poli";
 $nmgp_tab_label .= "polycode?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      $polycode_look = substr($this->Db->qstr($polycode), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct polyCode from " . $this->Ini->nm_tabela . " where polyCode = '$polycode_look' order by polyCode"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      if (isset($nmgp_def_dados[0][$polycode]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$polycode];
      }
      else
      {
          $sAutocompValue = $polycode;
      }
?>
<INPUT  type="text" id="SC_polycode" name="polycode" value="<?php echo NM_encode_input($polycode) ?>"  size=6 alt="{datatype: 'text', maxLength: 6, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_polycode" name="polycode_autocomp" size="6"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 6, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_name_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['name'])) ? $this->New_label['name'] : "Nama Poli"; ?></TD>
     <TD class="scFilterFieldOdd"> 
...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_name" name="name_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 100, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_headname_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['headname'])) ? $this->New_label['headname'] : "Head Name"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_headname_cond" name="headname_cond" onChange="nm_campos_between(document.getElementById('id_vis_headname'), this, 'headname')">
       <OPTION value="qp" <?php if ("qp" == $headname_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $headname_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $headname_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $headname_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_headname" <?php echo $str_hide_headname?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['headname'])) ? $this->New_label['headname'] : "Head Name";
 $nmgp_tab_label .= "headname?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      $headname_look = substr($this->Db->qstr($headname), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct headName from " . $this->Ini->nm_tabela . " where headName = '$headname_look' order by headName"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      if (isset($nmgp_def_dados[0][$headname]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$headname];
      }
      else
      {
          $sAutocompValue = $headname;
      }
?>
<INPUT  type="text" id="SC_headname" name="headname" value="<?php echo NM_encode_input($headname) ?>"  size=8 alt="{datatype: 'text', maxLength: 8, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_headname" name="headname_autocomp" size="8"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 8, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
?>
<?php
   if (is_file("grid_tbpoli_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_tbpoli']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_tbpoli']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpoli']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.note_cond.value = 'qp';
   ...
   document.F1.polycode_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_polycode'), document.F1.polycode_cond, 'polycode');
   document.F1.polycode.value = "";
   document.F1.polycode_autocomp.value = "";
   ...
   document.F1.headname_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_headname'), document.F1.headname_cond, 'headname');
   document.F1.headname.value = "";
   document.F1.headname_autocomp.value = "";
 }
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "simrskreatifmedia/grid_tbpoli";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpoli']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpoli']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpoli']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_polycode_cond'] = 'cond';
      $tp_fields['SC_polycode'] = 'text_aut';
      $tp_fields['id_ac_polycode'] = 'text_aut';
      $tp_fields['SC_name_cond'] = 'cond';
      $tp_fields['SC_name'] = 'text_aut';
      $tp_fields['id_ac_name'] = 'text_aut';
      $tp_fields['SC_headname_cond'] = 'cond';
      $tp_fields['SC_headname'] = 'text_aut';
      $tp_fields['id_ac_headname'] = 'text_aut';
   ...
   function trata_campos()
   {
      global $note_cond, $note, $note_autocomp,
             $polycode_cond, $polycode, $polycode_autocomp,
             $name_cond, $name, $name_autocomp,
             $headname_cond, $headname, $headname_autocomp, $nmgp_tab_label;
      ...
      if (!empty($polycode_autocomp) && empty($polycode))
      {
          $polycode = $polycode_autocomp;
      }
      if (!empty($name_autocomp) && empty($name))
      {
          $name = $name_autocomp;
      }
      if (!empty($headname_autocomp) && empty($headname))
      {
          $headname = $headname_autocomp;
      }
      ...
      $polycode_cond_salva = $polycode_cond; 
      if (!isset($polycode_input_2) || $polycode_input_2 == "")
      {
          $polycode_input_2 = $polycode;
      }
      ...
      $headname_cond_salva = $headname_cond; 
      if (!isset($headname_input_2) || $headname_input_2 == "")
      {
          $headname_input_2 = $headname;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpoli']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpoli']['campos_busca']['note'] = $note; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpoli']['campos_busca']['note_cond'] = $note_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpoli']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpoli']['campos_busca']['polycode'] = $polycode; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpoli']['campos_busca']['polycode_cond'] = $polycode_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpoli']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpoli']['campos_busca']['name'] = $name; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpoli']['campos_busca']['name_cond'] = $name_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpoli']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpoli']['campos_busca']['headname'] = $headname; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpoli']['campos_busca']['headname_cond'] = $headname_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpoli']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpoli']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpoli']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['polycode'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['polycode'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['polycode'] = $polycode;
      }
      $name_look = substr($this->Db->qstr($name), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct name from " . $this->Ini->nm_tabela . " where name = '$name_look' order by name"; 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['headname'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['headname'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['headname'] = $headname;
      }
      ...
      //----- $polycode
      $this->Date_part = false;
      if (isset($polycode) || $polycode_cond == "nu" || $polycode_cond == "nn" || $polycode_cond == "ep" || $polycode_cond == "ne")
      {
         $this->monta_condicao("polyCode", $polycode_cond, $polycode, "", "polycode");
      }
      ...
      //----- $headname
      $this->Date_part = false;
      if (isset($headname) || $headname_cond == "nu" || $headname_cond == "nn" || $headname_cond == "ep" || $headname_cond == "ne")
      {
         $this->monta_condicao("headName", $headname_cond, $headname, "", "headname");
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpoli']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpoli']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpoli']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpoli']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpoli']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpoli']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpoli']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpoli']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpoli']['cond_pesq'] .= $this->NM_operador;
