<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tbpoli']['sc_process_barr'] = true;
require_once('../grid_tbpoli/index.php');
unset($_SESSION['scriptcase']['grid_tbpoli']['sc_process_barr']);
$ExportCtrl = new grid_tbpoli_export_control;
$ExportCtrl->Export_barr();

class grid_tbpoli_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - Poliklinik :: Excel</TITLE>
