<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tbadministrasi']['sc_process_barr'] = true;
require_once('../grid_tbadministrasi/index.php');
unset($_SESSION['scriptcase']['grid_tbadministrasi']['sc_process_barr']);
$ExportCtrl = new grid_tbadministrasi_export_control;
$ExportCtrl->Export_barr();

class grid_tbadministrasi_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - Setting Administrasi :: Excel</TITLE>
