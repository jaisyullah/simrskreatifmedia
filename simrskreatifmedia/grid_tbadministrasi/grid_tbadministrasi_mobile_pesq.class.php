...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "id";$Nm_numeric[] = "tarifadm";$Nm_numeric[] = "id";$Nm_numeric[] = "tarifadm";
...
<HTML>
<HEAD>
 <TITLE> - Setting Administrasi</TITLE>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_biayaadm_cond" name="biayaadm_cond" onChange="nm_campos_between(document.getElementById('id_vis_biayaadm'), this, 'biayaadm')">
      ...
      <br><span id="id_hide_biayaadm"  <?php echo $str_hide_biayaadm?>><?php
      if ($biayaadm != "")
      {
      $biayaadm_look = substr($this->Db->qstr($biayaadm), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_tarifadm_cond" name="tarifadm_cond" onChange="nm_campos_between(document.getElementById('id_vis_tarifadm'), this, 'tarifadm')">
      ...
      <br><span id="id_hide_tarifadm"  <?php echo $str_hide_tarifadm?>><?php
      if ($tarifadm != "")
      {
      $tarifadm_look = substr($this->Db->qstr($tarifadm), 1, -1); 
      $nmgp_def_dados = array(); 
