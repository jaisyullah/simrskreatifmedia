...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_tbadministrasi"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_tbadministrasi"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_tbadministrasi'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tbadministrasi']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_tbadministrasi']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tbadministrasi']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_tbadministrasi']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_tbadministrasi']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_tbadministrasi</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_tbadministrasi']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_tbadministrasi']['embutida_filho'] as $ind => $sc_init)
          {
