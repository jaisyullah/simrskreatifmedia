...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "id_bu";$Nm_numeric[] = "id_bu";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_id_bu_cond" name="id_bu_cond" onChange="nm_campos_between(document.getElementById('id_vis_id_bu'), this, 'id_bu')">
      ...
      <br><span id="id_hide_id_bu"  <?php echo $str_hide_id_bu?>><?php
      if ($id_bu != "")
      {
      $id_bu_look = substr($this->Db->qstr($id_bu), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_nama_bu_cond" name="nama_bu_cond" onChange="nm_campos_between(document.getElementById('id_vis_nama_bu'), this, 'nama_bu')">
      ...
      <br><span id="id_hide_nama_bu"  <?php echo $str_hide_nama_bu?>><?php
      if ($nama_bu != "")
      {
      $nama_bu_look = substr($this->Db->qstr($nama_bu), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_alamat_bu_cond" name="alamat_bu_cond" onChange="nm_campos_between(document.getElementById('id_vis_alamat_bu'), this, 'alamat_bu')">
      ...
      <br><span id="id_hide_alamat_bu"  <?php echo $str_hide_alamat_bu?>><?php
      if ($alamat_bu != "")
      {
      $alamat_bu_look = substr($this->Db->qstr($alamat_bu), 1, -1); 
      $nmgp_def_dados = array(); 
