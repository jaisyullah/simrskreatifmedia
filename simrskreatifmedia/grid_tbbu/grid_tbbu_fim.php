...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_tbbu"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_tbbu"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_tbbu'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tbbu']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_tbbu']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tbbu']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_tbbu']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_tbbu']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_tbbu']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_tbbu']['embutida_filho'] as $ind => $sc_init)
          {
