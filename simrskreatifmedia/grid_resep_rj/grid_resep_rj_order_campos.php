...
<?php
   ...
   $Ord_Cmp = new grid_resep_rj_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_resep_rj_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_resep_rj']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_resep_rj']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_resep_rj']['labels']["id"])) ? $_SESSION['sc_session'][$sc_init]['grid_resep_rj']['labels']["id"] : "Id";
   $tab_ger_campos['trancode'] = "on";
   $tab_def_campos['trancode'] = "tranCode";
   $tab_labels["trancode"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_resep_rj']['labels']["trancode"])) ? $_SESSION['sc_session'][$sc_init]['grid_resep_rj']['labels']["trancode"] : "Tran Code";
   $tab_ger_campos['item'] = "on";
   $tab_def_campos['item'] = "item";
   $tab_labels["item"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_resep_rj']['labels']["item"])) ? $_SESSION['sc_session'][$sc_init]['grid_resep_rj']['labels']["item"] : "Item";
   $tab_ger_campos['satuan'] = "on";
   $tab_def_campos['satuan'] = "satuan";
   $tab_labels["satuan"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_resep_rj']['labels']["satuan"])) ? $_SESSION['sc_session'][$sc_init]['grid_resep_rj']['labels']["satuan"] : "Satuan";
   $tab_ger_campos['jumlah'] = "on";
   $tab_def_campos['jumlah'] = "jumlah";
   $tab_labels["jumlah"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_resep_rj']['labels']["jumlah"])) ? $_SESSION['sc_session'][$sc_init]['grid_resep_rj']['labels']["jumlah"] : "Jumlah";
   $tab_ger_campos['aturanpakai1'] = "on";
   $tab_def_campos['aturanpakai1'] = "aturanPakai1";
   $tab_labels["aturanpakai1"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_resep_rj']['labels']["aturanpakai1"])) ? $_SESSION['sc_session'][$sc_init]['grid_resep_rj']['labels']["aturanpakai1"] : "Aturan Pakai 1";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_resep_rj']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_resep_rj']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_resep_rj']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_resep_rj']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_resep_rj']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_resep_rj']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_resep_rj']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_resep_rj']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_resep_rj']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_resep_rj_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_resep_rj']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_resep_rj']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_resep_rj']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_resep_rj']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_resep_rj']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
