...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbro_mob']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_tbro/form_tbro_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_tbro_mob_sajax_js.php");
?>
<script type="text/javascript">
 ...
 function nm_field_disabled(Fields, Opt) {
  ...
  for (i=0; i < Field.length; i++)
  {
     ...
     if (F_name == "pocode")
     {
        ...
        $('input[id="cap_pocode"]').prop("disabled", F_opc);
        if (F_opc == "disabled" || F_opc == true) {
            $('#cap_pocode').hide();
        }
        else {
...
include_once('form_tbro_mob_jquery.php');
 ...
 function toggleBlock(e) {
  ...
  if (show_block[block_id]) {
    if ("hidden_bloco_2" == block_id) {
      scAjaxDetailHeight("form_tbrodetail", "500");
      if (typeof $("#nmsc_iframe_liga_form_tbrodetail")[0].contentWindow.scQuickSearchInit === "function") {
        $("#nmsc_iframe_liga_form_tbrodetail")[0].contentWindow.scQuickSearchInit(false, '');
      }
    }
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbro_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbro_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbro_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbro_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbro_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbro_mob']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbro_mob']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbro_mob']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
?>
<body class="scFormPage" style="<?php echo $remove_margin . $str_iframe_body; ?>">
<?php

if (isset($_SESSION['scriptcase']['form_tbro']['error_buffer']) && '' != $_SESSION['scriptcase']['form_tbro']['error_buffer'])
{
    echo $_SESSION['scriptcase']['form_tbro']['error_buffer'];
}
...
<?php
 include_once("form_tbro_mob_js0.php");
?>
<script type="text/javascript"> 
...
<form  name="F1" method="post" 
               action="form_tbro_mob.php" 
               target="_self">
<input type="hidden" name="nmgp_url_saida" value="">
<?php
if ('novo' == $this->nmgp_opcao || 'incluir' == $this->nmgp_opcao)
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbro_mob']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbro_mob']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_tbro_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_tbro_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbro_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbro_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbro_mob']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbro_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbro_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbro_mob']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbro_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbro_mob']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbro_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbro_mob']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbro_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbro_mob']['fast_search'][2] : "";
?> 
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbro_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbro_mob']['run_iframe'] != "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbro_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbro_mob']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbro_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbro_mob']['run_iframe'] == "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbro_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbro_mob']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbro_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbro_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbro_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbro_mob']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbro_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbro_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbro_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbro_mob']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbro_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbro_mob']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<span id="id_read_on_pocode" class="sc-ui-readonly-pocode css_pocode_line" style="<?php echo $sStyleReadLab_pocode; ?>"><?php echo $this->pocode; ?></span><span id="id_read_off_pocode" class="css_read_off_pocode" style="white-space: nowrap;<?php echo $sStyleReadInp_pocode; ?>">
 ...
 size=11 maxlength=11 alt="{datatype: 'text', maxLength: 11, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '(auto)', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php
   $Sc_iframe_master = ($this->Embutida_call) ? 'nmgp_iframe_ret*scinnmsc_iframe_liga_form_tbro_mob*scout' : '';
   if (isset($this->Ini->sc_lig_md5["grid_tbpo"]) && $this->Ini->sc_lig_md5["grid_tbpo"] == "S") {
       $Parms_Lig  = "nmgp_url_saida*scin*scoutnmgp_parms_ret*scinF1,pocode,pocode*scoutnm_evt_ret_busca*scin*scout" . $Sc_iframe_master;
       $Md5_Lig    = "@SC_par@" . $this->form_encode_input($this->Ini->sc_page) . "@SC_par@form_tbro_mob@SC_par@" . md5($Parms_Lig);
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbro_mob']['Lig_Md5'][md5($Parms_Lig)] = $Parms_Lig;
   } else {
       $Md5_Lig  = "nmgp_url_saida*scin*scoutnmgp_parms_ret*scinF1,pocode,pocode*scoutnm_evt_ret_busca*scin*scout" . $Sc_iframe_master;
   }
?>

<?php if (!$this->Ini->Export_img_zip) { ?><?php echo nmButtonOutput($this->arr_buttons, "bform_captura", "nm_submit_cap('" . $this->Ini->link_grid_tbpo_cons_psq. "', '" . $Md5_Lig . "')", "nm_submit_cap('" . $this->Ini->link_grid_tbpo_cons_psq. "', '" . $Md5_Lig . "')", "cap_pocode", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
<?php } ?>
<?php } ?>
...
?>
   ...
   <?php
    if (!isset($this->nm_new_label['rocode']))
    {
        $this->nm_new_label['rocode'] = "Ro Code";
    }
?>
<?php
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
   ...
   $rocode = $this->rocode;
   $sStyleHidden_rocode = '';
   if (isset($this->nmgp_cmp_hidden['rocode']) && $this->nmgp_cmp_hidden['rocode'] == 'off')
   {
       unset($this->nmgp_cmp_hidden['rocode']);
       $sStyleHidden_rocode = 'display: none;';
   }
   $bTestReadOnly = true;
   $sStyleReadLab_rocode = 'display: none;';
   $sStyleReadInp_rocode = '';
   if (/*$this->nmgp_opcao != "novo" && */isset($this->nmgp_cmp_readonly['rocode']) && $this->nmgp_cmp_readonly['rocode'] == 'on')
   {
       $bTestReadOnly = false;
       unset($this->nmgp_cmp_readonly['rocode']);
       $sStyleReadLab_rocode = '';
       $sStyleReadInp_rocode = 'display: none;';
   }
?>
<?php if (isset($this->nmgp_cmp_hidden['rocode']) && $this->nmgp_cmp_hidden['rocode'] == 'off') { $sc_hidden_yes++;  ?>
<input type="hidden" name="rocode" value="<?php echo $this->form_encode_input($rocode) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormDataOdd css_rocode_line" id="hidden_field_data_rocode" style="<?php echo $sStyleHidden_rocode; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rocode_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rocode_label"><span id="id_label_rocode"><?php echo $this->nm_new_label['rocode']; ?></span></span><br>
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["rocode"]) &&  $this->nmgp_cmp_readonly["rocode"] == "on") { 

 ?>
<input type="hidden" name="rocode" value="<?php echo $this->form_encode_input($rocode) . "\">" . $rocode . ""; ?>
<?php } else { ?>
<span id="id_read_on_rocode" class="sc-ui-readonly-rocode css_rocode_line" style="<?php echo $sStyleReadLab_rocode; ?>"><?php echo $this->rocode; ?></span><span id="id_read_off_rocode" class="css_read_off_rocode" style="white-space: nowrap;<?php echo $sStyleReadInp_rocode; ?>">
 <input class="sc-js-input scFormObjectOdd css_rocode_obj" style="" id="id_sc_field_rocode" type=text name="rocode" value="<?php echo $this->form_encode_input($rocode) ?>"
...
</td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_rocode_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_rocode_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbro_mob']['Lookup_status'][] = 'Open'; ?>
 <option  value="Proses" <?php  if ($this->status == "Proses") { echo " selected" ;} ?>>Proses</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbro_mob']['Lookup_status'][] = 'Proses'; ?>
 <option  value="Batal" <?php  if ($this->status == "Batal") { echo " selected" ;} ?>>Batal</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbro_mob']['Lookup_status'][] = 'Batal'; ?>
 </select></span>
</span><?php  }?>
...
<span id="id_read_on_note" class="sc-ui-readonly-note css_note_line" style="<?php echo $sStyleReadLab_note; ?>"><?php echo $note_val; ?></span><span id="id_read_off_note" class="css_read_off_note" style="white-space: nowrap;<?php echo $sStyleReadInp_note; ?>">
 <textarea  class="sc-js-input scFormObjectOdd css_note_obj" style="white-space: pre-wrap;" name="note" id="id_sc_field_note" rows="2" cols="15"
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    if (!isset($this->nm_new_label['sender']))
    {
        $this->nm_new_label['sender'] = "Pengirim";
    }
?>
<?php
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
   ...
   $sender = $this->sender;
   $sStyleHidden_sender = '';
   if (isset($this->nmgp_cmp_hidden['sender']) && $this->nmgp_cmp_hidden['sender'] == 'off')
   {
       unset($this->nmgp_cmp_hidden['sender']);
       $sStyleHidden_sender = 'display: none;';
   }
   $bTestReadOnly = true;
   $sStyleReadLab_sender = 'display: none;';
   $sStyleReadInp_sender = '';
   if (/*$this->nmgp_opcao != "novo" && */isset($this->nmgp_cmp_readonly['sender']) && $this->nmgp_cmp_readonly['sender'] == 'on')
   {
       $bTestReadOnly = false;
       unset($this->nmgp_cmp_readonly['sender']);
       $sStyleReadLab_sender = '';
       $sStyleReadInp_sender = 'display: none;';
   }
?>
<?php if (isset($this->nmgp_cmp_hidden['sender']) && $this->nmgp_cmp_hidden['sender'] == 'off') { $sc_hidden_yes++;  ?>
<input type="hidden" name="sender" value="<?php echo $this->form_encode_input($sender) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormDataOdd css_sender_line" id="hidden_field_data_sender" style="<?php echo $sStyleHidden_sender; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_sender_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_sender_label"><span id="id_label_sender"><?php echo $this->nm_new_label['sender']; ?></span></span><br>
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["sender"]) &&  $this->nmgp_cmp_readonly["sender"] == "on") { 

 ?>
<input type="hidden" name="sender" value="<?php echo $this->form_encode_input($sender) . "\">" . $sender . ""; ?>
<?php } else { ?>
<span id="id_read_on_sender" class="sc-ui-readonly-sender css_sender_line" style="<?php echo $sStyleReadLab_sender; ?>"><?php echo $this->sender; ?></span><span id="id_read_off_sender" class="css_read_off_sender" style="white-space: nowrap;<?php echo $sStyleReadInp_sender; ?>">
 <input class="sc-js-input scFormObjectOdd css_sender_obj" style="" id="id_sc_field_sender" type=text name="sender" value="<?php echo $this->form_encode_input($sender) ?>"
 size=15 maxlength=50 alt="{datatype: 'text', maxLength: 50, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: 'upper', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
</td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_sender_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_sender_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
<?php $sStyleHidden_sender_dumb = ('' == $sStyleHidden_sender) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_sender_dumb" style="<?php echo $sStyleHidden_sender_dumb; ?>"></TD>
   </tr>
<?php $sc_hidden_no = 1; ?>
</TABLE></div><!-- bloco_f -->
   </td>
...
<TABLE align="center" id="hidden_bloco_2" class="scFormTable" width="100%" style="height: 100%;"><?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    if (!isset($this->nm_new_label['detailro']))
    {
        $this->nm_new_label['detailro'] = "detailRO";
    }
?>
<?php
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
   $nm_img_fun_cel  = ($nm_img_fun_cel  == $this->Ini->img_fun_imp    ? $this->Ini->img_fun_par  : $this->Ini->img_fun_imp);
   $detailro = $this->detailro;
   $sStyleHidden_detailro = '';
   if (isset($this->nmgp_cmp_hidden['detailro']) && $this->nmgp_cmp_hidden['detailro'] == 'off')
   {
       unset($this->nmgp_cmp_hidden['detailro']);
       $sStyleHidden_detailro = 'display: none;';
   }
   $bTestReadOnly = true;
   $sStyleReadLab_detailro = 'display: none;';
   $sStyleReadInp_detailro = '';
   if (/*$this->nmgp_opcao != "novo" && */isset($this->nmgp_cmp_readonly['detailro']) && $this->nmgp_cmp_readonly['detailro'] == 'on')
   {
       $bTestReadOnly = false;
       unset($this->nmgp_cmp_readonly['detailro']);
       $sStyleReadLab_detailro = '';
       $sStyleReadInp_detailro = 'display: none;';
   }
?>
<?php if (isset($this->nmgp_cmp_hidden['detailro']) && $this->nmgp_cmp_hidden['detailro'] == 'off') { $sc_hidden_yes++;  ?>
<input type="hidden" name="detailro" value="<?php echo $this->form_encode_input($detailro) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormDataOdd css_detailro_line" id="hidden_field_data_detailro" style="<?php echo $sStyleHidden_detailro; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td width="100%" class="scFormDataFontOdd css_detailro_line" style="vertical-align: top;padding: 0px">
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbro_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_detailRO'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbro_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_detailRO'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbro_mob']['form_tbrodetail_mob_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbro_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_detailRO'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbro_mob']['form_tbrodetail_mob_script_case_init'] = $this->Ini->sc_page;
 }
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbro_mob']['form_tbrodetail_mob_script_case_init'] ]['form_tbrodetail_mob']['embutida_proc']  = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbro_mob']['form_tbrodetail_mob_script_case_init'] ]['form_tbrodetail_mob']['embutida_form']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbro_mob']['form_tbrodetail_mob_script_case_init'] ]['form_tbrodetail_mob']['embutida_call']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbro_mob']['form_tbrodetail_mob_script_case_init'] ]['form_tbrodetail_mob']['embutida_multi'] = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbro_mob']['form_tbrodetail_mob_script_case_init'] ]['form_tbrodetail_mob']['embutida_liga_form_insert'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbro_mob']['form_tbrodetail_mob_script_case_init'] ]['form_tbrodetail_mob']['embutida_liga_form_update'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbro_mob']['form_tbrodetail_mob_script_case_init'] ]['form_tbrodetail_mob']['embutida_liga_form_delete'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbro_mob']['form_tbrodetail_mob_script_case_init'] ]['form_tbrodetail_mob']['embutida_liga_form_btn_nav'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbro_mob']['form_tbrodetail_mob_script_case_init'] ]['form_tbrodetail_mob']['embutida_liga_grid_edit'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbro_mob']['form_tbrodetail_mob_script_case_init'] ]['form_tbrodetail_mob']['embutida_liga_grid_edit_link'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbro_mob']['form_tbrodetail_mob_script_case_init'] ]['form_tbrodetail_mob']['embutida_liga_qtd_reg'] = '';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbro_mob']['form_tbrodetail_mob_script_case_init'] ]['form_tbrodetail_mob']['embutida_liga_tp_pag'] = 'total';
 ...
 if ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbro_mob']['form_tbrodetail_mob_script_case_init'] ]['form_tbro_mob']['total'] < 0)
 {
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_tbro_mob_empty.htm' : $this->Ini->link_form_tbrodetail_mob_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_session=' . session_id() . '&script_case_detail=Y&sc_ifr_height=500';
...
if (isset($this->Ini->sc_lig_target['C_@scinf_detailRO']) && 'nmsc_iframe_liga_form_tbrodetail_mob' != $this->Ini->sc_lig_target['C_@scinf_detailRO'])
{
    if ('novo' != $this->nmgp_opcao)
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbro_mob']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_detailRO'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbro_mob']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbro_mob']['form_tbrodetail_mob_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
    scOpenMasterDetail("<?php echo $this->Ini->sc_lig_target['C_@scinf_detailRO'] ?>", "<?php echo $sDetailSrc; ?>");
});
</script>
<?php
}
...
{
?>
<iframe border="0" id="nmsc_iframe_liga_form_tbrodetail_mob"  marginWidth="0" marginHeight="0" frameborder="0" valign="top" height="500" width="100%" name="nmsc_iframe_liga_form_tbrodetail_mob"  scrolling="auto" src="<?php echo $sDetailSrc; ?>"></iframe>
<?php
}
?>
</td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_detailro_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_detailro_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
<?php $sStyleHidden_detailro_dumb = ('' == $sStyleHidden_detailro) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_detailro_dumb" style="<?php echo $sStyleHidden_detailro_dumb; ?>"></TD>
   </tr>
<?php $sc_hidden_no = 1; ?>
</TABLE></div><!-- bloco_f -->
   </td>
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbro_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_gambar'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbro_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_gambar'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbro_mob']['form_tbpopict_mob_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbro_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_gambar'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbro_mob']['form_tbpopict_mob_script_case_init'] = $this->Ini->sc_page;
 }
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbro_mob']['form_tbpopict_mob_script_case_init'] ]['form_tbpopict_mob']['embutida_proc']  = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbro_mob']['form_tbpopict_mob_script_case_init'] ]['form_tbpopict_mob']['embutida_form']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbro_mob']['form_tbpopict_mob_script_case_init'] ]['form_tbpopict_mob']['embutida_call']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbro_mob']['form_tbpopict_mob_script_case_init'] ]['form_tbpopict_mob']['embutida_multi'] = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbro_mob']['form_tbpopict_mob_script_case_init'] ]['form_tbpopict_mob']['embutida_liga_form_insert'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbro_mob']['form_tbpopict_mob_script_case_init'] ]['form_tbpopict_mob']['embutida_liga_form_update'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbro_mob']['form_tbpopict_mob_script_case_init'] ]['form_tbpopict_mob']['embutida_liga_form_delete'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbro_mob']['form_tbpopict_mob_script_case_init'] ]['form_tbpopict_mob']['embutida_liga_form_btn_nav'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbro_mob']['form_tbpopict_mob_script_case_init'] ]['form_tbpopict_mob']['embutida_liga_grid_edit'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbro_mob']['form_tbpopict_mob_script_case_init'] ]['form_tbpopict_mob']['embutida_liga_grid_edit_link'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbro_mob']['form_tbpopict_mob_script_case_init'] ]['form_tbpopict_mob']['embutida_liga_qtd_reg'] = '10';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbro_mob']['form_tbpopict_mob_script_case_init'] ]['form_tbpopict_mob']['embutida_liga_tp_pag'] = 'parcial';
 ...
 if ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbro_mob']['form_tbpopict_mob_script_case_init'] ]['form_tbro_mob']['total'] < 0)
 {
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_tbro_mob_empty.htm' : $this->Ini->link_form_tbpopict_mob_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_session=' . session_id() . '&script_case_detail=Y&sc_ifr_height=500';
...
if (isset($this->Ini->sc_lig_target['C_@scinf_gambar']) && 'nmsc_iframe_liga_form_tbpopict_mob' != $this->Ini->sc_lig_target['C_@scinf_gambar'])
{
    if ('novo' != $this->nmgp_opcao)
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbro_mob']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_gambar'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbro_mob']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbro_mob']['form_tbpopict_mob_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbro_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbro_mob']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbro_mob']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbro_mob']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbro_mob']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbro_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbro_mob']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbro_mob']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbro_mob']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_tbro_mob");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_tbro_mob");
 parent.scAjaxDetailHeight("form_tbro_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbro_mob']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
