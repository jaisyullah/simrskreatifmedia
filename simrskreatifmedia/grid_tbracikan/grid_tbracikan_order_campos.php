...
<?php
   ...
   $Ord_Cmp = new grid_tbracikan_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_tbracikan_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbracikan']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tbracikan']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbracikan']['labels']["id"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbracikan']['labels']["id"] : "Id";
   $tab_ger_campos['trancode'] = "on";
   $tab_def_campos['trancode'] = "tranCode";
   $tab_labels["trancode"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbracikan']['labels']["trancode"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbracikan']['labels']["trancode"] : "Tran Code";
   $tab_ger_campos['racikancode'] = "on";
   $tab_def_campos['racikancode'] = "racikanCode";
   $tab_labels["racikancode"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbracikan']['labels']["racikancode"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbracikan']['labels']["racikancode"] : "Racikan Code";
   $tab_ger_campos['jasaresep'] = "on";
   $tab_def_campos['jasaresep'] = "jasaResep";
   $tab_labels["jasaresep"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbracikan']['labels']["jasaresep"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbracikan']['labels']["jasaresep"] : "Jasa Resep";
   $tab_ger_campos['signakali'] = "on";
   $tab_def_campos['signakali'] = "signaKali";
   $tab_labels["signakali"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbracikan']['labels']["signakali"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbracikan']['labels']["signakali"] : "Signa Kali";
   $tab_ger_campos['jenisaturanpakai'] = "on";
   $tab_def_campos['jenisaturanpakai'] = "jenisAturanPakai";
   $tab_labels["jenisaturanpakai"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbracikan']['labels']["jenisaturanpakai"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbracikan']['labels']["jenisaturanpakai"] : "Jenis Aturan Pakai";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_tbracikan']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_tbracikan']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_tbracikan']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbracikan']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tbracikan']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_tbracikan']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_tbracikan']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_tbracikan']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_tbracikan']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_tbracikan_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_tbracikan']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_tbracikan']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_tbracikan']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_tbracikan']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_tbracikan']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
