...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "id";$Nm_numeric[] = "jasaresep";$Nm_numeric[] = "signakali";$Nm_numeric[] = "totalracikan";$Nm_numeric[] = "hargatotal";$Nm_numeric[] = "id";$Nm_numeric[] = "jasaresep";$Nm_numeric[] = "signakali";$Nm_numeric[] = "totalracikan";$Nm_numeric[] = "hargatotal";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_jasaresep_cond" name="jasaresep_cond" onChange="nm_campos_between(document.getElementById('id_vis_jasaresep'), this, 'jasaresep')">
      ...
      <br><span id="id_hide_jasaresep"  <?php echo $str_hide_jasaresep?>><?php
      if ($jasaresep != "")
      {
      $jasaresep_look = substr($this->Db->qstr($jasaresep), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_racikancode_cond" name="racikancode_cond" onChange="nm_campos_between(document.getElementById('id_vis_racikancode'), this, 'racikancode')">
      ...
      <br><span id="id_hide_racikancode"  <?php echo $str_hide_racikancode?>><?php
      if ($racikancode != "")
      {
      $racikancode_look = substr($this->Db->qstr($racikancode), 1, -1); 
      $nmgp_def_dados = array(); 
