...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
  <input type="hidden" name="script_case_session" value="<?php echo $this->form_encode_input(session_id()); ?>"> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_pay_ranap"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
?> 
var var_btn_Cetak_payno = "<?php echo $this->form_encode_input($this->nmgp_dados_form['nopayment']); ?>";
function sc_btn_Cetak()
{
    ...
    scJs_confirm("<?php echo html_entity_decode('Anda yakin ingin cetak kwitansi ini ?', ENT_COMPAT, $_SESSION['scriptcase']['charset']); ?>", sc_btn_Cetak_ok, sc_btn_Cetak_cancel);
}
function sc_btn_Cetak_cancel()
{
}
function sc_btn_Cetak_ok()
{
      nm_gp_submit('<?php echo $this->Ini->link_cetak_ri; ?>', '<?php echo $this->nm_location; ?>', '<?php echo "payno*scin' + var_btn_Cetak_payno + '*scout"; ?>', '', '_blank', '0', '0', 'cetak_ri');
}
var var_btn_sc_btn_0_payno = "<?php echo $this->form_encode_input($this->nmgp_dados_form['nopayment']); ?>";
...
{
  nm_gp_submit('<?php echo $this->Ini->link_cetak_deposit; ?>', '<?php echo $this->nm_location; ?>', '<?php echo "payno*scin' + var_btn_sc_btn_0_payno + '*scout"; ?>', '', '_blank', '0', '0', 'cetak_deposit');
}
var var_btn_sc_btn_1_payno = "<?php echo $this->form_encode_input($this->nmgp_dados_form['trancode']); ?>";
...
{
  nm_gp_submit('<?php echo $this->Ini->link_preview_ri; ?>', '<?php echo $this->nm_location; ?>', '<?php echo "payno*scin' + var_btn_sc_btn_1_payno + '*scout"; ?>', '', '_blank', '0', '0', 'preview_ri');
}
var var_btn_sc_btn_2_payno = "<?php echo $this->form_encode_input($this->nmgp_dados_form['nopayment']); ?>";
...
{
  nm_gp_submit('<?php echo $this->Ini->link_billing_paid_ri; ?>', '<?php echo $this->nm_location; ?>', '<?php echo "payno*scin' + var_btn_sc_btn_2_payno + '*scout"; ?>', '', '_blank', '0', '0', 'billing_paid_ri');
}
var var_btn_sc_btn_3_payno = "<?php echo $this->form_encode_input($this->nmgp_dados_form['nopayment']); ?>";
...
{
  nm_gp_submit('<?php echo $this->Ini->link_cetak_bayar; ?>', '<?php echo $this->nm_location; ?>', '<?php echo "payno*scin' + var_btn_sc_btn_3_payno + '*scout"; ?>', '', '_blank', '0', '0', 'cetak_bayar');
}
var var_btn_sc_btn_4_payno = "<?php echo $this->form_encode_input($this->nmgp_dados_form['nopayment']); ?>";
...
{
  nm_gp_submit('<?php echo $this->Ini->link_billing_ri; ?>', '<?php echo $this->nm_location; ?>', '<?php echo "payno*scin' + var_btn_sc_btn_4_payno + '*scout"; ?>', '', '_blank', '0', '0', 'billing_ri');
}
 NM_tp_critica(1);
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap']['where_detal']))
  {
?>  
...
{
   nm_field_disabled("jmldk1=disabled;jmldk2=disabled;jmlasr=disabled;jmlkary=disabled;nopayment=disabled", "");
   nm_field_disabled("jmlbayar=disabled;potongan=disabled", "I");
   nm_field_disabled("trancode=disabled;nostruk=disabled;custcode=disabled;sc_field_1=disabled;dokter=disabled;jmltagihan=disabled;hrsdibayar=disabled", "U");
