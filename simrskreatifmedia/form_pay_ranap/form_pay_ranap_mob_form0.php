...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['embutida_pdf']))
 {
 ?>
...
<?php
include_once("form_pay_ranap_mob_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_pay_ranap_mob_jquery.php');
 ...
 function addAutocomplete(elem) {
  ...
  $(".sc-ui-autocomp-instansipenjamin", elem).on("focus", function() {
   ...
   if ("" == $(this).val()) {
    ...
    if (hasChanged) {
     if ('function' == typeof do_ajax_form_pay_ranap_mob_event_instansipenjamin_onchange) { do_ajax_form_pay_ranap_mob_event_instansipenjamin_onchange(sRow); }
    }
   }
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
?>
<body class="scFormPage" style="<?php echo $remove_margin . $str_iframe_body; ?>">
<?php

if (isset($_SESSION['scriptcase']['form_pay_ranap']['error_buffer']) && '' != $_SESSION['scriptcase']['form_pay_ranap']['error_buffer'])
{
    echo $_SESSION['scriptcase']['form_pay_ranap']['error_buffer'];
}
...
<?php
 include_once("form_pay_ranap_mob_js0.php");
?>
<script type="text/javascript"> 
...
<form  name="F1" method="post" 
               action="form_pay_ranap_mob.php" 
               target="_self">
<input type="hidden" name="nmgp_url_saida" value="">
<?php
if ('novo' == $this->nmgp_opcao || 'incluir' == $this->nmgp_opcao)
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_pay_ranap_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_pay_ranap_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['fast_search'][2] : "";
?> 
...
<?php echo nmButtonOutput($this->arr_buttons, "bnovo", "scBtnFn_sys_format_inc()", "scBtnFn_sys_format_inc()", "sc_b_new_t", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "sc-unique-btn-21", "", "group_2");?>
  </div>
...
<?php echo nmButtonOutput($this->arr_buttons, "bincluir", "scBtnFn_sys_format_inc()", "scBtnFn_sys_format_inc()", "sc_b_ins_t", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "sc-unique-btn-22", "", "group_2");?>
  </div>
...
<?php echo nmButtonOutput($this->arr_buttons, "bcancelar", "scBtnFn_sys_format_cnl()", "scBtnFn_sys_format_cnl()", "sc_b_sai_t", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "sc-unique-btn-23", "", "group_2");?>
  </div>
...
<?php echo nmButtonOutput($this->arr_buttons, "balterar", "scBtnFn_sys_format_alt()", "scBtnFn_sys_format_alt()", "sc_b_upd_t", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "sc-unique-btn-24", "", "group_2");?>
  </div>
...
<?php echo nmButtonOutput($this->arr_buttons, "bexcluir", "scBtnFn_sys_format_exc()", "scBtnFn_sys_format_exc()", "sc_b_del_t", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "sc-unique-btn-25", "", "group_2");?>
  </div>
...
<?php echo nmButtonOutput($this->arr_buttons, "bcopy", "scBtnFn_sys_format_copy()", "scBtnFn_sys_format_copy()", "sc_b_clone_t", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "sc-unique-btn-27", "", "group_2");?>
  </div>
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['run_iframe'] != "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['run_iframe'] == "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
       <?php echo nmButtonOutput($this->arr_buttons, "bvoltar", "scBtnFn_sys_format_sai()", "scBtnFn_sys_format_sai()", "sc_b_sai_t", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "sc-unique-btn-31", "", "");?>
...
?>
       <?php echo nmButtonOutput($this->arr_buttons, "bsair", "scBtnFn_sys_format_sai()", "scBtnFn_sys_format_sai()", "sc_b_sai_t", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "sc-unique-btn-32", "", "");?>
...
<span id="id_read_on_trancode" class="sc-ui-readonly-trancode css_trancode_line" style="<?php echo $sStyleReadLab_trancode; ?>"><?php echo $this->trancode; ?></span><span id="id_read_off_trancode" class="css_read_off_trancode" style="white-space: nowrap;<?php echo $sStyleReadInp_trancode; ?>">
 ...
 size=20 maxlength=20 alt="{datatype: 'text', maxLength: 20, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php
   $Sc_iframe_master = ($this->Embutida_call) ? 'nmgp_iframe_ret*scinnmsc_iframe_liga_form_pay_ranap_mob*scout' : '';
   if (isset($this->Ini->sc_lig_md5["grid_select_ranap"]) && $this->Ini->sc_lig_md5["grid_select_ranap"] == "S") {
       ...
       $Md5_Lig    = "@SC_par@" . $this->form_encode_input($this->Ini->sc_page) . "@SC_par@form_pay_ranap_mob@SC_par@" . md5($Parms_Lig);
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['Lig_Md5'][md5($Parms_Lig)] = $Parms_Lig;
   } else {
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_jmldk1_line" id="hidden_field_data_jmldk1" style="<?php echo $sStyleHidden_jmldk1; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%;float:right"><tr><td  class="scFormDataFontOdd css_jmldk1_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_jmldk1_label"><span id="id_label_jmldk1"><?php echo $this->nm_new_label['jmldk1']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_jmldk2_line" id="hidden_field_data_jmldk2" style="<?php echo $sStyleHidden_jmldk2; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%;float:right"><tr><td  class="scFormDataFontOdd css_jmldk2_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_jmldk2_label"><span id="id_label_jmldk2"><?php echo $this->nm_new_label['jmldk2']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_jmlasr_line" id="hidden_field_data_jmlasr" style="<?php echo $sStyleHidden_jmlasr; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%;float:right"><tr><td  class="scFormDataFontOdd css_jmlasr_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_jmlasr_label"><span id="id_label_jmlasr"><?php echo $this->nm_new_label['jmlasr']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_jmlkary_line" id="hidden_field_data_jmlkary" style="<?php echo $sStyleHidden_jmlkary; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%;float:right"><tr><td  class="scFormDataFontOdd css_jmlkary_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_jmlkary_label"><span id="id_label_jmlkary"><?php echo $this->nm_new_label['jmlkary']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_selisihpaket_line" id="hidden_field_data_selisihpaket" style="<?php echo $sStyleHidden_selisihpaket; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%;float:right"><tr><td  class="scFormDataFontOdd css_selisihpaket_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_selisihpaket_label"><span id="id_label_selisihpaket"><?php echo $this->nm_new_label['selisihpaket']; ?></span></span><br>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['Lookup_jenispayment'][] = 'TUNAI'; ?>
 <option  value="BPJS" <?php  if ($this->jenispayment == "BPJS") { echo " selected" ;} ?>>BPJS</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['Lookup_jenispayment'][] = 'BPJS'; ?>
 <option  value="KARTU KREDIT" <?php  if ($this->jenispayment == "KARTU KREDIT") { echo " selected" ;} ?>>KARTU KREDIT</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['Lookup_jenispayment'][] = 'KARTU KREDIT'; ?>
 <option  value="KARTU DEBIT" <?php  if ($this->jenispayment == "KARTU DEBIT") { echo " selected" ;} ?>>KARTU DEBIT</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['Lookup_jenispayment'][] = 'KARTU DEBIT'; ?>
 <option  value="ASURANSI" <?php  if ($this->jenispayment == "ASURANSI") { echo " selected" ;} ?>>ASURANSI</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['Lookup_jenispayment'][] = 'ASURANSI'; ?>
 <option  value="KARYAWAN" <?php  if ($this->jenispayment == "KARYAWAN") { echo " selected" ;} ?>>KARYAWAN</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['Lookup_jenispayment'][] = 'KARYAWAN'; ?>
 <option  value="KOMBINASI" <?php  if ($this->jenispayment == "KOMBINASI") { echo " selected" ;} ?>>KOMBINASI</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['Lookup_jenispayment'][] = 'KOMBINASI'; ?>
 <option  value="BANSOS" <?php  if ($this->jenispayment == "BANSOS") { echo " selected" ;} ?>>BANSOS</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['Lookup_jenispayment'][] = 'BANSOS'; ?>
 <option  value="JAMPERU" <?php  if ($this->jenispayment == "JAMPERU") { echo " selected" ;} ?>>JAMPERU</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['Lookup_jenispayment'][] = 'JAMPERU'; ?>
 <option  value="TUNAI PROMO" <?php  if ($this->jenispayment == "TUNAI PROMO") { echo " selected" ;} ?>>TUNAI PROMO</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['Lookup_jenispayment'][] = 'TUNAI PROMO'; ?>
 </select></span>
</span><?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_kode_akun_line" id="hidden_field_data_kode_akun" style="<?php echo $sStyleHidden_kode_akun; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_kode_akun_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_kode_akun_label"><span id="id_label_kode_akun"><?php echo $this->nm_new_label['kode_akun']; ?></span></span><br>
...
<?php $sStyleHidden_kode_akun_dumb = ('' == $sStyleHidden_kode_akun) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_kode_akun_dumb" style="<?php echo $sStyleHidden_kode_akun_dumb; ?>"></TD>
   </tr>
<?php $sc_hidden_no = 1; ?>
</TABLE></div><!-- bloco_f -->
   </td>
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_detailKamar'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_detailKamar'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_tbbillruang_mob_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_detailKamar'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_tbbillruang_mob_script_case_init'] = $this->Ini->sc_page;
 }
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_tbbillruang_mob_script_case_init'] ]['form_tbbillruang_mob']['embutida_proc']  = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_tbbillruang_mob_script_case_init'] ]['form_tbbillruang_mob']['embutida_form']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_tbbillruang_mob_script_case_init'] ]['form_tbbillruang_mob']['embutida_call']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_tbbillruang_mob_script_case_init'] ]['form_tbbillruang_mob']['embutida_multi'] = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_tbbillruang_mob_script_case_init'] ]['form_tbbillruang_mob']['embutida_liga_form_insert'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_tbbillruang_mob_script_case_init'] ]['form_tbbillruang_mob']['embutida_liga_form_update'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_tbbillruang_mob_script_case_init'] ]['form_tbbillruang_mob']['embutida_liga_form_delete'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_tbbillruang_mob_script_case_init'] ]['form_tbbillruang_mob']['embutida_liga_form_btn_nav'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_tbbillruang_mob_script_case_init'] ]['form_tbbillruang_mob']['embutida_liga_grid_edit'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_tbbillruang_mob_script_case_init'] ]['form_tbbillruang_mob']['embutida_liga_grid_edit_link'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_tbbillruang_mob_script_case_init'] ]['form_tbbillruang_mob']['embutida_liga_qtd_reg'] = '10';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_tbbillruang_mob_script_case_init'] ]['form_tbbillruang_mob']['embutida_liga_tp_pag'] = 'parcial';
 ...
 if ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_tbbillruang_mob_script_case_init'] ]['form_pay_ranap_mob']['total'] < 0)
 {
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_pay_ranap_mob_empty.htm' : $this->Ini->link_form_tbbillruang_mob_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_session=' . session_id() . '&script_case_detail=Y&sc_ifr_height=500';
...
if (isset($this->Ini->sc_lig_target['C_@scinf_detailKamar']) && 'nmsc_iframe_liga_form_tbbillruang_mob' != $this->Ini->sc_lig_target['C_@scinf_detailKamar'])
{
    if ('novo' != $this->nmgp_opcao)
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_detailKamar'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_tbbillruang_mob_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
{
?>
<iframe border="0" id="nmsc_iframe_liga_form_tbbillruang_mob"  marginWidth="0" marginHeight="0" frameborder="0" valign="top" height="500" width="100%" name="nmsc_iframe_liga_form_tbbillruang_mob"  scrolling="auto" src="<?php echo $sDetailSrc; ?>"></iframe>
<?php
}
?>
...
<?php $sStyleHidden_detailkamar_dumb = ('' == $sStyleHidden_detailkamar) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_detailkamar_dumb" style="<?php echo $sStyleHidden_detailkamar_dumb; ?>"></TD>
   </tr>
<?php $sc_hidden_no = 1; ?>
</TABLE></div><!-- bloco_f -->
   </td>
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_detailTindakan'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_detailTindakan'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_tbtindakanrawatinap_mob_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_detailTindakan'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_tbtindakanrawatinap_mob_script_case_init'] = $this->Ini->sc_page;
 }
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_tbtindakanrawatinap_mob_script_case_init'] ]['form_tbtindakanrawatinap_mob']['embutida_proc']  = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_tbtindakanrawatinap_mob_script_case_init'] ]['form_tbtindakanrawatinap_mob']['embutida_form']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_tbtindakanrawatinap_mob_script_case_init'] ]['form_tbtindakanrawatinap_mob']['embutida_call']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_tbtindakanrawatinap_mob_script_case_init'] ]['form_tbtindakanrawatinap_mob']['embutida_multi'] = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_tbtindakanrawatinap_mob_script_case_init'] ]['form_tbtindakanrawatinap_mob']['embutida_liga_form_insert'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_tbtindakanrawatinap_mob_script_case_init'] ]['form_tbtindakanrawatinap_mob']['embutida_liga_form_update'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_tbtindakanrawatinap_mob_script_case_init'] ]['form_tbtindakanrawatinap_mob']['embutida_liga_form_delete'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_tbtindakanrawatinap_mob_script_case_init'] ]['form_tbtindakanrawatinap_mob']['embutida_liga_form_btn_nav'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_tbtindakanrawatinap_mob_script_case_init'] ]['form_tbtindakanrawatinap_mob']['embutida_liga_grid_edit'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_tbtindakanrawatinap_mob_script_case_init'] ]['form_tbtindakanrawatinap_mob']['embutida_liga_grid_edit_link'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_tbtindakanrawatinap_mob_script_case_init'] ]['form_tbtindakanrawatinap_mob']['embutida_liga_qtd_reg'] = '';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_tbtindakanrawatinap_mob_script_case_init'] ]['form_tbtindakanrawatinap_mob']['embutida_liga_tp_pag'] = 'total';
 ...
 if ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_tbtindakanrawatinap_mob_script_case_init'] ]['form_pay_ranap_mob']['total'] < 0)
 {
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_pay_ranap_mob_empty.htm' : $this->Ini->link_form_tbtindakanrawatinap_mob_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_session=' . session_id() . '&script_case_detail=Y';
...
if (isset($this->Ini->sc_lig_target['C_@scinf_detailTindakan']) && 'nmsc_iframe_liga_form_tbtindakanrawatinap_mob' != $this->Ini->sc_lig_target['C_@scinf_detailTindakan'])
{
    if ('novo' != $this->nmgp_opcao)
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_detailTindakan'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_tbtindakanrawatinap_mob_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
{
?>
<iframe border="0" id="nmsc_iframe_liga_form_tbtindakanrawatinap_mob"  marginWidth="0" marginHeight="0" frameborder="0" valign="top" height="100" width="100%" name="nmsc_iframe_liga_form_tbtindakanrawatinap_mob"  scrolling="auto" src="<?php echo $sDetailSrc; ?>"></iframe>
<?php
}
?>
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_sc_field_2'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_sc_field_2'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_tbtim_mob_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_sc_field_2'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_tbtim_mob_script_case_init'] = $this->Ini->sc_page;
 }
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_tbtim_mob_script_case_init'] ]['form_tbtim_mob']['embutida_proc']  = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_tbtim_mob_script_case_init'] ]['form_tbtim_mob']['embutida_form']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_tbtim_mob_script_case_init'] ]['form_tbtim_mob']['embutida_call']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_tbtim_mob_script_case_init'] ]['form_tbtim_mob']['embutida_multi'] = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_tbtim_mob_script_case_init'] ]['form_tbtim_mob']['embutida_liga_form_insert'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_tbtim_mob_script_case_init'] ]['form_tbtim_mob']['embutida_liga_form_update'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_tbtim_mob_script_case_init'] ]['form_tbtim_mob']['embutida_liga_form_delete'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_tbtim_mob_script_case_init'] ]['form_tbtim_mob']['embutida_liga_form_btn_nav'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_tbtim_mob_script_case_init'] ]['form_tbtim_mob']['embutida_liga_grid_edit'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_tbtim_mob_script_case_init'] ]['form_tbtim_mob']['embutida_liga_grid_edit_link'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_tbtim_mob_script_case_init'] ]['form_tbtim_mob']['embutida_liga_qtd_reg'] = '';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_tbtim_mob_script_case_init'] ]['form_tbtim_mob']['embutida_liga_tp_pag'] = 'total';
 ...
 if ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_tbtim_mob_script_case_init'] ]['form_pay_ranap_mob']['total'] < 0)
 {
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_pay_ranap_mob_empty.htm' : $this->Ini->link_form_tbtim_mob_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_session=' . session_id() . '&script_case_detail=Y';
...
if (isset($this->Ini->sc_lig_target['C_@scinf_sc_field_2']) && 'nmsc_iframe_liga_form_tbtim_mob' != $this->Ini->sc_lig_target['C_@scinf_sc_field_2'])
{
    if ('novo' != $this->nmgp_opcao)
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_sc_field_2'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_tbtim_mob_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
{
?>
<iframe border="0" id="nmsc_iframe_liga_form_tbtim_mob"  marginWidth="0" marginHeight="0" frameborder="0" valign="top" height="100" width="100%" name="nmsc_iframe_liga_form_tbtim_mob"  scrolling="auto" src="<?php echo $sDetailSrc; ?>"></iframe>
<?php
}
?>
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_detailResep'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_detailResep'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['grid_tbreseprawatinap_alt_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_detailResep'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['grid_tbreseprawatinap_alt_script_case_init'] = $this->Ini->sc_page;
 }
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_pay_ranap_mob_empty.htm' : $this->Ini->link_grid_tbreseprawatinap_alt_cons . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_session=' . session_id() . '&script_case_detail=Y&sc_ifr_height=500' . $parms_lig_cons;
...
if (isset($this->Ini->sc_lig_target['C_@scinf_detailResep']) && 'nmsc_iframe_liga_grid_tbreseprawatinap_alt' != $this->Ini->sc_lig_target['C_@scinf_detailResep'])
{
    if ('novo' != $this->nmgp_opcao)
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_detailResep'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['grid_tbreseprawatinap_alt_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
<?php $sStyleHidden_detailresep_dumb = ('' == $sStyleHidden_detailresep) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_detailresep_dumb" style="<?php echo $sStyleHidden_detailresep_dumb; ?>"></TD>
   </tr>
<?php $sc_hidden_no = 1; ?>
</TABLE></div><!-- bloco_f -->
   </td>
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_bhp'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_bhp'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_tbbhprawatinap_mob_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_bhp'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_tbbhprawatinap_mob_script_case_init'] = $this->Ini->sc_page;
 }
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_tbbhprawatinap_mob_script_case_init'] ]['form_tbbhprawatinap_mob']['embutida_proc']  = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_tbbhprawatinap_mob_script_case_init'] ]['form_tbbhprawatinap_mob']['embutida_form']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_tbbhprawatinap_mob_script_case_init'] ]['form_tbbhprawatinap_mob']['embutida_call']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_tbbhprawatinap_mob_script_case_init'] ]['form_tbbhprawatinap_mob']['embutida_multi'] = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_tbbhprawatinap_mob_script_case_init'] ]['form_tbbhprawatinap_mob']['embutida_liga_form_insert'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_tbbhprawatinap_mob_script_case_init'] ]['form_tbbhprawatinap_mob']['embutida_liga_form_update'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_tbbhprawatinap_mob_script_case_init'] ]['form_tbbhprawatinap_mob']['embutida_liga_form_delete'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_tbbhprawatinap_mob_script_case_init'] ]['form_tbbhprawatinap_mob']['embutida_liga_form_btn_nav'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_tbbhprawatinap_mob_script_case_init'] ]['form_tbbhprawatinap_mob']['embutida_liga_grid_edit'] = '';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_tbbhprawatinap_mob_script_case_init'] ]['form_tbbhprawatinap_mob']['embutida_liga_grid_edit_link'] = '';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_tbbhprawatinap_mob_script_case_init'] ]['form_tbbhprawatinap_mob']['embutida_liga_qtd_reg'] = '10';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_tbbhprawatinap_mob_script_case_init'] ]['form_tbbhprawatinap_mob']['embutida_liga_tp_pag'] = 'parcial';
 ...
 if ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_tbbhprawatinap_mob_script_case_init'] ]['form_pay_ranap_mob']['total'] < 0)
 {
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_pay_ranap_mob_empty.htm' : $this->Ini->link_form_tbbhprawatinap_mob_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_session=' . session_id() . '&script_case_detail=Y';
...
if (isset($this->Ini->sc_lig_target['C_@scinf_bhp']) && 'nmsc_iframe_liga_form_tbbhprawatinap_mob' != $this->Ini->sc_lig_target['C_@scinf_bhp'])
{
    if ('novo' != $this->nmgp_opcao)
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_bhp'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_tbbhprawatinap_mob_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
{
?>
<iframe border="0" id="nmsc_iframe_liga_form_tbbhprawatinap_mob"  marginWidth="0" marginHeight="0" frameborder="0" valign="top" height="100" width="100%" name="nmsc_iframe_liga_form_tbbhprawatinap_mob"  scrolling="auto" src="<?php echo $sDetailSrc; ?>"></iframe>
<?php
}
?>
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_detailresepokvk'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_detailresepokvk'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_tbdetailresepokvk_mob_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_detailresepokvk'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_tbdetailresepokvk_mob_script_case_init'] = $this->Ini->sc_page;
 }
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_tbdetailresepokvk_mob_script_case_init'] ]['form_tbdetailresepokvk_mob']['embutida_proc']  = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_tbdetailresepokvk_mob_script_case_init'] ]['form_tbdetailresepokvk_mob']['embutida_form']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_tbdetailresepokvk_mob_script_case_init'] ]['form_tbdetailresepokvk_mob']['embutida_call']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_tbdetailresepokvk_mob_script_case_init'] ]['form_tbdetailresepokvk_mob']['embutida_multi'] = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_tbdetailresepokvk_mob_script_case_init'] ]['form_tbdetailresepokvk_mob']['embutida_liga_form_insert'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_tbdetailresepokvk_mob_script_case_init'] ]['form_tbdetailresepokvk_mob']['embutida_liga_form_update'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_tbdetailresepokvk_mob_script_case_init'] ]['form_tbdetailresepokvk_mob']['embutida_liga_form_delete'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_tbdetailresepokvk_mob_script_case_init'] ]['form_tbdetailresepokvk_mob']['embutida_liga_form_btn_nav'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_tbdetailresepokvk_mob_script_case_init'] ]['form_tbdetailresepokvk_mob']['embutida_liga_grid_edit'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_tbdetailresepokvk_mob_script_case_init'] ]['form_tbdetailresepokvk_mob']['embutida_liga_grid_edit_link'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_tbdetailresepokvk_mob_script_case_init'] ]['form_tbdetailresepokvk_mob']['embutida_liga_qtd_reg'] = '10';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_tbdetailresepokvk_mob_script_case_init'] ]['form_tbdetailresepokvk_mob']['embutida_liga_tp_pag'] = 'total';
 ...
 if ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_tbdetailresepokvk_mob_script_case_init'] ]['form_pay_ranap_mob']['total'] < 0)
 {
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_pay_ranap_mob_empty.htm' : $this->Ini->link_form_tbdetailresepokvk_mob_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_session=' . session_id() . '&script_case_detail=Y&sc_ifr_height=500';
...
if (isset($this->Ini->sc_lig_target['C_@scinf_detailresepokvk']) && 'nmsc_iframe_liga_form_tbdetailresepokvk_mob' != $this->Ini->sc_lig_target['C_@scinf_detailresepokvk'])
{
    if ('novo' != $this->nmgp_opcao)
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_detailresepokvk'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_tbdetailresepokvk_mob_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
{
?>
<iframe border="0" id="nmsc_iframe_liga_form_tbdetailresepokvk_mob"  marginWidth="0" marginHeight="0" frameborder="0" valign="top" height="500" width="100%" name="nmsc_iframe_liga_form_tbdetailresepokvk_mob"  scrolling="auto" src="<?php echo $sDetailSrc; ?>"></iframe>
<?php
}
?>
...
<?php $sStyleHidden_detailresepokvk_dumb = ('' == $sStyleHidden_detailresepokvk) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_detailresepokvk_dumb" style="<?php echo $sStyleHidden_detailresepokvk_dumb; ?>"></TD>
   </tr>
<?php $sc_hidden_no = 1; ?>
</TABLE></div><!-- bloco_f -->
   </td>
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_Lab'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_Lab'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_tbrujukanlab_mob_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_Lab'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_tbrujukanlab_mob_script_case_init'] = $this->Ini->sc_page;
 }
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_tbrujukanlab_mob_script_case_init'] ]['form_tbrujukanlab_mob']['embutida_proc']  = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_tbrujukanlab_mob_script_case_init'] ]['form_tbrujukanlab_mob']['embutida_form']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_tbrujukanlab_mob_script_case_init'] ]['form_tbrujukanlab_mob']['embutida_call']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_tbrujukanlab_mob_script_case_init'] ]['form_tbrujukanlab_mob']['embutida_multi'] = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_tbrujukanlab_mob_script_case_init'] ]['form_tbrujukanlab_mob']['embutida_liga_form_insert'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_tbrujukanlab_mob_script_case_init'] ]['form_tbrujukanlab_mob']['embutida_liga_form_update'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_tbrujukanlab_mob_script_case_init'] ]['form_tbrujukanlab_mob']['embutida_liga_form_delete'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_tbrujukanlab_mob_script_case_init'] ]['form_tbrujukanlab_mob']['embutida_liga_form_btn_nav'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_tbrujukanlab_mob_script_case_init'] ]['form_tbrujukanlab_mob']['embutida_liga_grid_edit'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_tbrujukanlab_mob_script_case_init'] ]['form_tbrujukanlab_mob']['embutida_liga_grid_edit_link'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_tbrujukanlab_mob_script_case_init'] ]['form_tbrujukanlab_mob']['embutida_liga_qtd_reg'] = '10';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_tbrujukanlab_mob_script_case_init'] ]['form_tbrujukanlab_mob']['embutida_liga_tp_pag'] = 'parcial';
 ...
 if ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_tbrujukanlab_mob_script_case_init'] ]['form_pay_ranap_mob']['total'] < 0)
 {
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_pay_ranap_mob_empty.htm' : $this->Ini->link_form_tbrujukanlab_mob_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_session=' . session_id() . '&script_case_detail=Y';
...
if (isset($this->Ini->sc_lig_target['C_@scinf_Lab']) && 'nmsc_iframe_liga_form_tbrujukanlab_mob' != $this->Ini->sc_lig_target['C_@scinf_Lab'])
{
    if ('novo' != $this->nmgp_opcao)
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_Lab'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_tbrujukanlab_mob_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
{
?>
<iframe border="0" id="nmsc_iframe_liga_form_tbrujukanlab_mob"  marginWidth="0" marginHeight="0" frameborder="0" valign="top" height="100" width="100%" name="nmsc_iframe_liga_form_tbrujukanlab_mob"  scrolling="auto" src="<?php echo $sDetailSrc; ?>"></iframe>
<?php
}
?>
...
<?php $sStyleHidden_lab_dumb = ('' == $sStyleHidden_lab) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_lab_dumb" style="<?php echo $sStyleHidden_lab_dumb; ?>"></TD>
   </tr>
<?php $sc_hidden_no = 1; ?>
</TABLE></div><!-- bloco_f -->
   </td>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rad_line" id="hidden_field_data_rad" style="<?php echo $sStyleHidden_rad; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td width="100%" class="scFormDataFontOdd css_rad_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rad_label"><span id="id_label_rad"><?php echo $this->nm_new_label['rad']; ?></span></span><br>
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_Rad'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_Rad'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_tbrujukanradiologi_mob_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_Rad'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_tbrujukanradiologi_mob_script_case_init'] = $this->Ini->sc_page;
 }
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_tbrujukanradiologi_mob_script_case_init'] ]['form_tbrujukanradiologi_mob']['embutida_proc']  = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_tbrujukanradiologi_mob_script_case_init'] ]['form_tbrujukanradiologi_mob']['embutida_form']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_tbrujukanradiologi_mob_script_case_init'] ]['form_tbrujukanradiologi_mob']['embutida_call']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_tbrujukanradiologi_mob_script_case_init'] ]['form_tbrujukanradiologi_mob']['embutida_multi'] = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_tbrujukanradiologi_mob_script_case_init'] ]['form_tbrujukanradiologi_mob']['embutida_liga_form_insert'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_tbrujukanradiologi_mob_script_case_init'] ]['form_tbrujukanradiologi_mob']['embutida_liga_form_update'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_tbrujukanradiologi_mob_script_case_init'] ]['form_tbrujukanradiologi_mob']['embutida_liga_form_delete'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_tbrujukanradiologi_mob_script_case_init'] ]['form_tbrujukanradiologi_mob']['embutida_liga_form_btn_nav'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_tbrujukanradiologi_mob_script_case_init'] ]['form_tbrujukanradiologi_mob']['embutida_liga_grid_edit'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_tbrujukanradiologi_mob_script_case_init'] ]['form_tbrujukanradiologi_mob']['embutida_liga_grid_edit_link'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_tbrujukanradiologi_mob_script_case_init'] ]['form_tbrujukanradiologi_mob']['embutida_liga_qtd_reg'] = '10';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_tbrujukanradiologi_mob_script_case_init'] ]['form_tbrujukanradiologi_mob']['embutida_liga_tp_pag'] = 'parcial';
 ...
 if ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_tbrujukanradiologi_mob_script_case_init'] ]['form_pay_ranap_mob']['total'] < 0)
 {
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_pay_ranap_mob_empty.htm' : $this->Ini->link_form_tbrujukanradiologi_mob_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_session=' . session_id() . '&script_case_detail=Y';
...
if (isset($this->Ini->sc_lig_target['C_@scinf_Rad']) && 'nmsc_iframe_liga_form_tbrujukanradiologi_mob' != $this->Ini->sc_lig_target['C_@scinf_Rad'])
{
    if ('novo' != $this->nmgp_opcao)
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_Rad'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_tbrujukanradiologi_mob_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
{
?>
<iframe border="0" id="nmsc_iframe_liga_form_tbrujukanradiologi_mob"  marginWidth="0" marginHeight="0" frameborder="0" valign="top" height="100" width="100%" name="nmsc_iframe_liga_form_tbrujukanradiologi_mob"  scrolling="auto" src="<?php echo $sDetailSrc; ?>"></iframe>
<?php
}
?>
...
<?php $sStyleHidden_rad_dumb = ('' == $sStyleHidden_rad) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_rad_dumb" style="<?php echo $sStyleHidden_rad_dumb; ?>"></TD>
   </tr>
<?php $sc_hidden_no = 1; ?>
</TABLE></div><!-- bloco_f -->
   </td>
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_detailAdm'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_detailAdm'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_detailadm_mob_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_detailAdm'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_detailadm_mob_script_case_init'] = $this->Ini->sc_page;
 }
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_detailadm_mob_script_case_init'] ]['form_detailadm_mob']['embutida_proc']  = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_detailadm_mob_script_case_init'] ]['form_detailadm_mob']['embutida_form']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_detailadm_mob_script_case_init'] ]['form_detailadm_mob']['embutida_call']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_detailadm_mob_script_case_init'] ]['form_detailadm_mob']['embutida_multi'] = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_detailadm_mob_script_case_init'] ]['form_detailadm_mob']['embutida_liga_form_insert'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_detailadm_mob_script_case_init'] ]['form_detailadm_mob']['embutida_liga_form_update'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_detailadm_mob_script_case_init'] ]['form_detailadm_mob']['embutida_liga_form_delete'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_detailadm_mob_script_case_init'] ]['form_detailadm_mob']['embutida_liga_form_btn_nav'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_detailadm_mob_script_case_init'] ]['form_detailadm_mob']['embutida_liga_grid_edit'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_detailadm_mob_script_case_init'] ]['form_detailadm_mob']['embutida_liga_grid_edit_link'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_detailadm_mob_script_case_init'] ]['form_detailadm_mob']['embutida_liga_qtd_reg'] = '10';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_detailadm_mob_script_case_init'] ]['form_detailadm_mob']['embutida_liga_tp_pag'] = 'parcial';
 ...
 if ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_detailadm_mob_script_case_init'] ]['form_pay_ranap_mob']['total'] < 0)
 {
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_pay_ranap_mob_empty.htm' : $this->Ini->link_form_detailadm_mob_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_session=' . session_id() . '&script_case_detail=Y&sc_ifr_height=500';
...
if (isset($this->Ini->sc_lig_target['C_@scinf_detailAdm']) && 'nmsc_iframe_liga_form_detailadm_mob' != $this->Ini->sc_lig_target['C_@scinf_detailAdm'])
{
    if ('novo' != $this->nmgp_opcao)
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_detailAdm'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['form_detailadm_mob_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
{
?>
<iframe border="0" id="nmsc_iframe_liga_form_detailadm_mob"  marginWidth="0" marginHeight="0" frameborder="0" valign="top" height="500" width="100%" name="nmsc_iframe_liga_form_detailadm_mob"  scrolling="auto" src="<?php echo $sDetailSrc; ?>"></iframe>
<?php
}
?>
...
?>
       <?php echo nmButtonOutput($this->arr_buttons, "binicio", "scBtnFn_sys_format_ini()", "scBtnFn_sys_format_ini()", "sc_b_ini_b", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "sc-unique-btn-33", "", "");?>
...
?>
       <?php echo nmButtonOutput($this->arr_buttons, "bretorna", "scBtnFn_sys_format_ret()", "scBtnFn_sys_format_ret()", "sc_b_ret_b", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "sc-unique-btn-34", "", "");?>
...
?>
       <?php echo nmButtonOutput($this->arr_buttons, "bfinal", "scBtnFn_sys_format_fim()", "scBtnFn_sys_format_fim()", "sc_b_fim_b", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "sc-unique-btn-36", "", "");?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_pay_ranap_mob");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_pay_ranap_mob");
 parent.scAjaxDetailHeight("form_pay_ranap_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
<script type="text/javascript">
	...
	function scBtnFn_sys_format_copy() {
		if ($("#sc_b_clone_t.sc-unique-btn-27").length && $("#sc_b_clone_t.sc-unique-btn-27").is(":visible")) {
			nm_move ('clone');
			 return;
		}
	}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_ranap_mob']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
