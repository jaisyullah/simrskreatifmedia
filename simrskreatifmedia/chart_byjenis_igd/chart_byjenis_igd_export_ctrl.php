<?php
@session_start() ;
$_SESSION['scriptcase']['chart_byjenis_igd']['sc_process_barr'] = true;
require_once('../chart_byjenis_igd/index.php');
unset($_SESSION['scriptcase']['chart_byjenis_igd']['sc_process_barr']);
$ExportCtrl = new chart_byjenis_igd_export_control;
$ExportCtrl->Export_barr();

class chart_byjenis_igd_export_control
{
