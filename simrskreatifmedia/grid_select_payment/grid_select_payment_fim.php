...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_select_payment"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_select_payment"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_select_payment']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_select_payment']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_select_payment']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_select_payment']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_select_payment']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_select_payment</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_select_payment']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_select_payment']['embutida_filho'] as $ind => $sc_init)
          {
