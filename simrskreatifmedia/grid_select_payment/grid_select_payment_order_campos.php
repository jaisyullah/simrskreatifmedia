...
<?php
   ...
   $Ord_Cmp = new grid_select_payment_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_select_payment_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_select_payment']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_select_payment']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["rm"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_select_payment']['labels']["rm"])) ? $_SESSION['sc_session'][$sc_init]['grid_select_payment']['labels']["rm"] : "Rm";
   ...
   $tab_labels["nama"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_select_payment']['labels']["nama"])) ? $_SESSION['sc_session'][$sc_init]['grid_select_payment']['labels']["nama"] : "Nama";
   ...
   $tab_labels["dokter"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_select_payment']['labels']["dokter"])) ? $_SESSION['sc_session'][$sc_init]['grid_select_payment']['labels']["dokter"] : "Dokter";
   ...
   $tab_labels["selesai"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_select_payment']['labels']["selesai"])) ? $_SESSION['sc_session'][$sc_init]['grid_select_payment']['labels']["selesai"] : "Selesai";
   ...
   $tab_labels["tglkeluar"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_select_payment']['labels']["tglkeluar"])) ? $_SESSION['sc_session'][$sc_init]['grid_select_payment']['labels']["tglkeluar"] : "Tgl Keluar";
   ...
   $tab_labels["carakeluar"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_select_payment']['labels']["carakeluar"])) ? $_SESSION['sc_session'][$sc_init]['grid_select_payment']['labels']["carakeluar"] : "Cara Keluar";
   ...
   $tab_labels["kode"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_select_payment']['labels']["kode"])) ? $_SESSION['sc_session'][$sc_init]['grid_select_payment']['labels']["kode"] : "Kode";
   ...
   $tab_labels["nostruk"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_select_payment']['labels']["nostruk"])) ? $_SESSION['sc_session'][$sc_init]['grid_select_payment']['labels']["nostruk"] : "No Struk";
   ...
   $tab_labels["jenis"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_select_payment']['labels']["jenis"])) ? $_SESSION['sc_session'][$sc_init]['grid_select_payment']['labels']["jenis"] : "Jenis";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_select_payment']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_select_payment']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_select_payment']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_select_payment']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_select_payment']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_select_payment']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_select_payment']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_select_payment']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_select_payment']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_select_payment_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_select_payment']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_select_payment']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_select_payment']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_select_payment']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_select_payment']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
