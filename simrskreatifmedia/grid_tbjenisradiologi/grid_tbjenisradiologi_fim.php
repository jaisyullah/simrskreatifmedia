...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_tbjenisradiologi"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_tbjenisradiologi"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_tbjenisradiologi'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tbjenisradiologi']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_tbjenisradiologi']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tbjenisradiologi']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_tbjenisradiologi']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_tbjenisradiologi']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_tbjenisradiologi</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_tbjenisradiologi']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_tbjenisradiologi']['embutida_filho'] as $ind => $sc_init)
          {
