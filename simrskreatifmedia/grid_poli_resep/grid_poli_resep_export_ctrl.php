<?php
@session_start() ;
$_SESSION['scriptcase']['grid_poli_resep']['sc_process_barr'] = true;
require_once('../grid_poli_resep/index.php');
unset($_SESSION['scriptcase']['grid_poli_resep']['sc_process_barr']);
$ExportCtrl = new grid_poli_resep_export_control;
$ExportCtrl->Export_barr();

class grid_poli_resep_export_control
{
