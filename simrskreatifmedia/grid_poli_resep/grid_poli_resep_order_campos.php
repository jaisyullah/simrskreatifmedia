...
<?php
   ...
   $Ord_Cmp = new grid_poli_resep_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_poli_resep_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_poli_resep']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_poli_resep']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["trancode"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_poli_resep']['labels']["trancode"])) ? $_SESSION['sc_session'][$sc_init]['grid_poli_resep']['labels']["trancode"] : "Tran Code";
   ...
   $tab_labels["trandate"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_poli_resep']['labels']["trandate"])) ? $_SESSION['sc_session'][$sc_init]['grid_poli_resep']['labels']["trandate"] : "Tran Date";
   ...
   {
       $tab_def_campos['rm'] = "c.custCode";
   }
   $tab_labels["rm"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_poli_resep']['labels']["rm"])) ? $_SESSION['sc_session'][$sc_init]['grid_poli_resep']['labels']["rm"] : "RM";
   ...
   $tab_labels["nama"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_poli_resep']['labels']["nama"])) ? $_SESSION['sc_session'][$sc_init]['grid_poli_resep']['labels']["nama"] : "Nama";
   ...
   {
       $tab_def_campos['sc_field_0'] = "c.birthDate";
   }
   $tab_labels["sc_field_0"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_poli_resep']['labels']["sc_field_0"])) ? $_SESSION['sc_session'][$sc_init]['grid_poli_resep']['labels']["sc_field_0"] : "Tgl Lahir";
   ...
   {
       $tab_def_campos['dpjp'] = "concat(d.gelar,' ',d.name,', ',d.spec)";
   }
   $tab_labels["dpjp"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_poli_resep']['labels']["dpjp"])) ? $_SESSION['sc_session'][$sc_init]['grid_poli_resep']['labels']["dpjp"] : "DPJP";
   ...
   $tab_labels["jenis"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_poli_resep']['labels']["jenis"])) ? $_SESSION['sc_session'][$sc_init]['grid_poli_resep']['labels']["jenis"] : "Jenis";
   ...
   $tab_labels["sc_field_1"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_poli_resep']['labels']["sc_field_1"])) ? $_SESSION['sc_session'][$sc_init]['grid_poli_resep']['labels']["sc_field_1"] : "Status Bayar";
   ...
   $tab_labels["sc_field_2"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_poli_resep']['labels']["sc_field_2"])) ? $_SESSION['sc_session'][$sc_init]['grid_poli_resep']['labels']["sc_field_2"] : "Verified Status";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_poli_resep']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_poli_resep']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_poli_resep']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_poli_resep']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_poli_resep']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_poli_resep']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_poli_resep']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_poli_resep']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_poli_resep']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_poli_resep_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_poli_resep']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_poli_resep']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_poli_resep']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_poli_resep']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_poli_resep']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
