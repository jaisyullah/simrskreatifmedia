...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_hrm_daftar_shift"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_hrm_daftar_shift"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_hrm_daftar_shift'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_hrm_daftar_shift']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_hrm_daftar_shift']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_hrm_daftar_shift']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_hrm_daftar_shift']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_hrm_daftar_shift']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_hrm_daftar_shift</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_hrm_daftar_shift']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_hrm_daftar_shift']['embutida_filho'] as $ind => $sc_init)
          {
