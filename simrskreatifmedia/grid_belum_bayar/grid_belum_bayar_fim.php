...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_belum_bayar"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_belum_bayar"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_belum_bayar']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_belum_bayar']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_belum_bayar']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_belum_bayar']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_belum_bayar']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_belum_bayar']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_belum_bayar']['embutida_filho'] as $ind => $sc_init)
          {
