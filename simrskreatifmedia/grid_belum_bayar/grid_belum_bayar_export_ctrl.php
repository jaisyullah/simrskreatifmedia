<?php
@session_start() ;
$_SESSION['scriptcase']['grid_belum_bayar']['sc_process_barr'] = true;
require_once('../grid_belum_bayar/index.php');
unset($_SESSION['scriptcase']['grid_belum_bayar']['sc_process_barr']);
$ExportCtrl = new grid_belum_bayar_export_control;
$ExportCtrl->Export_barr();

class grid_belum_bayar_export_control
{
