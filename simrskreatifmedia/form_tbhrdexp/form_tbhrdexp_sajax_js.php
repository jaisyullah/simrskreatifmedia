  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbhrdexp" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbhrdexp_form();
	}

  // ---------- Validate instnama_
  function do_ajax_form_tbhrdexp_validate_instnama_(iNumLinha)
  {
    var nomeCampo_instnama_ = "instnama_" + iNumLinha;
    var var_instnama_ = scAjaxGetFieldText(nomeCampo_instnama_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbhrdexp_validate_instnama_(var_instnama_, iNumLinha, var_script_case_init, do_ajax_form_tbhrdexp_validate_instnama__cb);
  } // do_ajax_form_tbhrdexp_validate_instnama_

  function do_ajax_form_tbhrdexp_validate_instnama__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbhrdexp_validate_instnama__cb

  // ---------- Validate jab_
  function do_ajax_form_tbhrdexp_validate_jab_(iNumLinha)
  {
    var nomeCampo_jab_ = "jab_" + iNumLinha;
    var var_jab_ = scAjaxGetFieldText(nomeCampo_jab_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbhrdexp_validate_jab_(var_jab_, iNumLinha, var_script_case_init, do_ajax_form_tbhrdexp_validate_jab__cb);
  } // do_ajax_form_tbhrdexp_validate_jab_

  function do_ajax_form_tbhrdexp_validate_jab__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "jab_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "jab_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbhrdexp_validate_jab__cb

  // ---------- Validate masakerja_
  function do_ajax_form_tbhrdexp_validate_masakerja_(iNumLinha)
  {
    var nomeCampo_masakerja_ = "masakerja_" + iNumLinha;
    var var_masakerja_ = scAjaxGetFieldText(nomeCampo_masakerja_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbhrdexp_validate_masakerja_(var_masakerja_, iNumLinha, var_script_case_init, do_ajax_form_tbhrdexp_validate_masakerja__cb);
  } // do_ajax_form_tbhrdexp_validate_masakerja_

  function do_ajax_form_tbhrdexp_validate_masakerja__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "masakerja_" + iLineNumber;
    }
    else
    {
      sFieldValid = "masakerja_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "masakerja_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "masakerja_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbhrdexp_validate_masakerja__cb

  // ---------- Validate param_
  function do_ajax_form_tbhrdexp_validate_param_(iNumLinha)
  {
    var nomeCampo_param_ = "param_" + iNumLinha;
    var var_param_ = scAjaxGetFieldSelect(nomeCampo_param_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbhrdexp_validate_param_(var_param_, iNumLinha, var_script_case_init, do_ajax_form_tbhrdexp_validate_param__cb);
  } // do_ajax_form_tbhrdexp_validate_param_

  function do_ajax_form_tbhrdexp_validate_param__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "param_" + iLineNumber;
    }
    else
    {
      sFieldValid = "param_";
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "param_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "param_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbhrdexp_validate_param__cb

  // ---------- Validate kodekary_
  function do_ajax_form_tbhrdexp_validate_kodekary_(iNumLinha)
  {
    var nomeCampo_kodekary_ = "kodekary_" + iNumLinha;
    var var_kodekary_ = scAjaxGetFieldText(nomeCampo_kodekary_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbhrdexp_validate_kodekary_(var_kodekary_, iNumLinha, var_script_case_init, do_ajax_form_tbhrdexp_validate_kodekary__cb);
  } // do_ajax_form_tbhrdexp_validate_kodekary_

  function do_ajax_form_tbhrdexp_validate_kodekary__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbhrdexp_validate_kodekary__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_tbhrdexp_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_tbhrdexp_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tbhrdexp_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_tbhrdexp_add_new_line_cb);
  } // do_ajax_form_tbhrdexp_add_new_line

  function do_ajax_form_tbhrdexp_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_tbhrdexp_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_tbhrdexp_backup_line(iNumLinha)
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbhrdexp_backup_line(var_kodekary_, var_instnama_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_tbhrdexp_backup_line_cb);
  } // do_ajax_form_tbhrdexp_backup_line

  function do_ajax_form_tbhrdexp_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_tbhrdexp_backup_line_cb

  function do_ajax_form_tbhrdexp_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_tbhrdexp_cancel_insert

  function do_ajax_form_tbhrdexp_cancel_update(iSeqVert)
  {
    do_ajax_form_tbhrdexp_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_tbhrdexp_cancel_update

  function do_ajax_form_tbhrdexp_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_tbhrdexp_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_tbhrdexp_table_refresh()
  {
    var var_kodekary_ = document.F2.kodekary_.value;
    var var_instnama_ = document.F2.instnama_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_tbhrdexp_table_refresh(var_kodekary_, var_instnama_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbhrdexp_table_refresh_cb);
  } //  do_ajax_form_tbhrdexp_table_refresh

  function do_ajax_form_tbhrdexp_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.instnama_.value = scAjaxGetKeyValue("instnama_");
    ...
    scAjaxAlert(do_ajax_form_tbhrdexp_table_refresh_cb_after_alert);
  } // do_ajax_form_tbhrdexp_table_refresh_cb
  function do_ajax_form_tbhrdexp_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxSetNavStatus("t");
    sc_insert_open = false;
  } // do_ajax_form_tbhrdexp_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_tbhrdexp_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_tbhrdexp_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_instnama_ = scAjaxGetFieldText("instnama_" + iNumLinha);
    var var_jab_ = scAjaxGetFieldText("jab_" + iNumLinha);
    var var_masakerja_ = scAjaxGetFieldText("masakerja_" + iNumLinha);
    var var_param_ = scAjaxGetFieldSelect("param_" + iNumLinha);
    var var_kodekary_ = scAjaxGetFieldText("kodekary_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_tbhrdexp_submit_form(var_instnama_, var_jab_, var_masakerja_, var_param_, var_kodekary_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbhrdexp_submit_form_cb);
  } // do_ajax_form_tbhrdexp_submit_form

  function do_ajax_form_tbhrdexp_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("jab_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("masakerja_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("param_" + sc_num_ult_line);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_tbhrdexp_submit_form_cb_after_alert);
  } // do_ajax_form_tbhrdexp_submit_form_cb
  function do_ajax_form_tbhrdexp_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbhrdexp_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tbhrdexp_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_tbhrdexp_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("jab_" + iNavForm);
      scAjaxHideErrorDisplay("masakerja_" + iNavForm);
      scAjaxHideErrorDisplay("param_" + iNavForm);
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tbhrdexp_navigate_form(var_kodekary_, var_instnama_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbhrdexp_navigate_form_cb);
  } // do_ajax_form_tbhrdexp_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrdexp']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbhrdexp_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.instnama_.value = scAjaxGetKeyValue("instnama_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbhrdexp_navigate_form_cb_after_alert);
  } // do_ajax_form_tbhrdexp_navigate_form_cb
  function do_ajax_form_tbhrdexp_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_tbhrdexp_navigate_form_cb_after_alert
  function sc_hide_form_tbhrdexp_form()
  {
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "jab_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "masakerja_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "param_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "kodekary_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["instnama_" + iNumLinha] = {"label": "Instansi / Perusahaan<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["jab_" + iNumLinha] = {"label": "Jabatan Terakhir<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["masakerja_" + iNumLinha] = {"label": "Masa Kerja<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["param_" + iNumLinha] = {"label": "Param<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_field_mult["jab_"][iNumLinha] = "jab_" + iNumLinha;
    ajax_field_mult["masakerja_"][iNumLinha] = "masakerja_" + iNumLinha;
    ajax_field_mult["param_"][iNumLinha] = "param_" + iNumLinha;
    ...
    ajax_field_id["jab_" + iNumLinha] = new Array("hidden_field_label_jab_", "hidden_field_data_jab_" + iNumLinha);
    ajax_field_id["masakerja_" + iNumLinha] = new Array("hidden_field_label_masakerja_", "hidden_field_data_masakerja_" + iNumLinha);
    ajax_field_id["param_" + iNumLinha] = new Array("hidden_field_label_param_", "hidden_field_data_param_" + iNumLinha);
    ajax_error_count["instnama_" + iNumLinha] = "off";
    ajax_error_count["jab_" + iNumLinha] = "off";
    ajax_error_count["masakerja_" + iNumLinha] = "off";
    ajax_error_count["param_" + iNumLinha] = "off";
...
?>
    ...
    ajax_read_only["jab_" + iNumLinha] = "off";
    ajax_read_only["masakerja_" + iNumLinha] = "off";
    ajax_read_only["param_" + iNumLinha] = "off";
...
?>
    ajax_read_only["instnama_" + iNumLinha] = "on";
    ajax_read_only["jab_" + iNumLinha] = "on";
    ajax_read_only["masakerja_" + iNumLinha] = "on";
    ajax_read_only["param_" + iNumLinha] = "on";
    ajax_read_only["kodekary_" + iNumLinha] = "on";
<?php
}
?>
  ...
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["jab_" + iNumLinha] = null;
    ajax_error_list["masakerja_" + iNumLinha] = null;
    ajax_error_list["param_" + iNumLinha] = null;
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["jab_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["jab_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["jab_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["jab_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["jab_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["masakerja_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["masakerja_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["masakerja_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["masakerja_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["masakerja_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["param_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["param_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["param_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["param_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["param_" + iNumLinha]["onfocus"] = new Array();
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['instnama_'])) ? $this->nmgp_cmp_readonly['instnama_'] : 'on';
?>
    scAjaxFieldRead("instnama_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['jab_'])) ? $this->nmgp_cmp_readonly['jab_'] : 'off';
?>
    scAjaxFieldRead("jab_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['masakerja_'])) ? $this->nmgp_cmp_readonly['masakerja_'] : 'off';
?>
    scAjaxFieldRead("masakerja_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['param_'])) ? $this->nmgp_cmp_readonly['param_'] : 'off';
?>
    scAjaxFieldRead("param_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
?>
  ...
  function mdCloseObjects(iSeq)
  {
    ...
    scAjaxFieldRead("jab_" + iSeq, "on");
    scAjaxFieldRead("masakerja_" + iSeq, "on");
    scAjaxFieldRead("param_" + iSeq, "on");
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["instnama_" + iRow] || "on" == ajax_error_count["jab_" + iRow] || "on" == ajax_error_count["masakerja_" + iRow] || "on" == ajax_error_count["param_" + iRow] || "on" == ajax_error_count["kodekary_" + iRow]))
    {
      ...
      $("#hidden_field_data_jab_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_masakerja_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_param_" + iRow).addClass("scFormErrorLine");
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["instnama_" + iRow] && "off" == ajax_error_count["jab_" + iRow] && "off" == ajax_error_count["masakerja_" + iRow] && "off" == ajax_error_count["param_" + iRow] && "off" == ajax_error_count["kodekary_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["instnama_" + iRow] = "off";
        ajax_error_count["jab_" + iRow] = "off";
        ajax_error_count["masakerja_" + iRow] = "off";
        ajax_error_count["param_" + iRow] = "off";
      ...
      $("#hidden_field_data_jab_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_masakerja_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_param_" + iRow).removeClass("scFormErrorLine");
