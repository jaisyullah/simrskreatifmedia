  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbpembatalan_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbpembatalan_mob_form();
	}

  // ---------- Validate id
  function do_ajax_form_tbpembatalan_mob_validate_id()
  {
    var nomeCampo_id = "id";
    var var_id = scAjaxGetFieldHidden(nomeCampo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbpembatalan_mob_validate_id(var_id, var_script_case_init, do_ajax_form_tbpembatalan_mob_validate_id_cb);
  } // do_ajax_form_tbpembatalan_mob_validate_id

  function do_ajax_form_tbpembatalan_mob_validate_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbpembatalan_mob_validate_id_cb

  // ---------- Validate trancode
  function do_ajax_form_tbpembatalan_mob_validate_trancode()
  {
    var nomeCampo_trancode = "trancode";
    var var_trancode = scAjaxGetFieldText(nomeCampo_trancode);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbpembatalan_mob_validate_trancode(var_trancode, var_script_case_init, do_ajax_form_tbpembatalan_mob_validate_trancode_cb);
  } // do_ajax_form_tbpembatalan_mob_validate_trancode

  function do_ajax_form_tbpembatalan_mob_validate_trancode_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbpembatalan_mob_validate_trancode_cb

  // ---------- Validate jenis
  function do_ajax_form_tbpembatalan_mob_validate_jenis()
  {
    var nomeCampo_jenis = "jenis";
    var var_jenis = scAjaxGetFieldSelect(nomeCampo_jenis);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbpembatalan_mob_validate_jenis(var_jenis, var_script_case_init, do_ajax_form_tbpembatalan_mob_validate_jenis_cb);
  } // do_ajax_form_tbpembatalan_mob_validate_jenis

  function do_ajax_form_tbpembatalan_mob_validate_jenis_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "jenis";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbpembatalan_mob_validate_jenis_cb

  // ---------- Validate strukno
  function do_ajax_form_tbpembatalan_mob_validate_strukno()
  {
    var nomeCampo_strukno = "strukno";
    var var_strukno = scAjaxGetFieldText(nomeCampo_strukno);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbpembatalan_mob_validate_strukno(var_strukno, var_script_case_init, do_ajax_form_tbpembatalan_mob_validate_strukno_cb);
  } // do_ajax_form_tbpembatalan_mob_validate_strukno

  function do_ajax_form_tbpembatalan_mob_validate_strukno_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "strukno";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbpembatalan_mob_validate_strukno_cb

  // ---------- Validate pemohon
  function do_ajax_form_tbpembatalan_mob_validate_pemohon()
  {
    var nomeCampo_pemohon = "pemohon";
    var var_pemohon = scAjaxGetFieldText(nomeCampo_pemohon);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbpembatalan_mob_validate_pemohon(var_pemohon, var_script_case_init, do_ajax_form_tbpembatalan_mob_validate_pemohon_cb);
  } // do_ajax_form_tbpembatalan_mob_validate_pemohon

  function do_ajax_form_tbpembatalan_mob_validate_pemohon_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pemohon";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbpembatalan_mob_validate_pemohon_cb

  // ---------- Validate alasan
  function do_ajax_form_tbpembatalan_mob_validate_alasan()
  {
    var nomeCampo_alasan = "alasan";
    var var_alasan = scAjaxGetFieldText(nomeCampo_alasan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbpembatalan_mob_validate_alasan(var_alasan, var_script_case_init, do_ajax_form_tbpembatalan_mob_validate_alasan_cb);
  } // do_ajax_form_tbpembatalan_mob_validate_alasan

  function do_ajax_form_tbpembatalan_mob_validate_alasan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "alasan";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbpembatalan_mob_validate_alasan_cb

  // ---------- Validate status
  function do_ajax_form_tbpembatalan_mob_validate_status()
  {
    var nomeCampo_status = "status";
    var var_status = scAjaxGetFieldSelect(nomeCampo_status);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbpembatalan_mob_validate_status(var_status, var_script_case_init, do_ajax_form_tbpembatalan_mob_validate_status_cb);
  } // do_ajax_form_tbpembatalan_mob_validate_status

  function do_ajax_form_tbpembatalan_mob_validate_status_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "status";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbpembatalan_mob_validate_status_cb

  // ---------- Validate tgltran
  function do_ajax_form_tbpembatalan_mob_validate_tgltran()
  {
    var nomeCampo_tgltran = "tgltran";
    var var_tgltran = scAjaxGetFieldText(nomeCampo_tgltran);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbpembatalan_mob_validate_tgltran(var_tgltran, var_script_case_init, do_ajax_form_tbpembatalan_mob_validate_tgltran_cb);
  } // do_ajax_form_tbpembatalan_mob_validate_tgltran

  function do_ajax_form_tbpembatalan_mob_validate_tgltran_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tgltran";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbpembatalan_mob_validate_tgltran_cb

  // ---------- Validate setuju
  function do_ajax_form_tbpembatalan_mob_validate_setuju()
  {
    var nomeCampo_setuju = "setuju";
    var var_setuju = scAjaxGetFieldRadio(nomeCampo_setuju);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbpembatalan_mob_validate_setuju(var_setuju, var_script_case_init, do_ajax_form_tbpembatalan_mob_validate_setuju_cb);
  } // do_ajax_form_tbpembatalan_mob_validate_setuju

  function do_ajax_form_tbpembatalan_mob_validate_setuju_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "setuju";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbpembatalan_mob_validate_setuju_cb

  // ---------- Validate setujuoleh
  function do_ajax_form_tbpembatalan_mob_validate_setujuoleh()
  {
    var nomeCampo_setujuoleh = "setujuoleh";
    var var_setujuoleh = scAjaxGetFieldText(nomeCampo_setujuoleh);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbpembatalan_mob_validate_setujuoleh(var_setujuoleh, var_script_case_init, do_ajax_form_tbpembatalan_mob_validate_setujuoleh_cb);
  } // do_ajax_form_tbpembatalan_mob_validate_setujuoleh

  function do_ajax_form_tbpembatalan_mob_validate_setujuoleh_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbpembatalan_mob_validate_setujuoleh_cb

  // ---------- Validate tglsetuju
  function do_ajax_form_tbpembatalan_mob_validate_tglsetuju()
  {
    var nomeCampo_tglsetuju = "tglsetuju";
    var var_tglsetuju = scAjaxGetFieldText(nomeCampo_tglsetuju);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbpembatalan_mob_validate_tglsetuju(var_tglsetuju, var_script_case_init, do_ajax_form_tbpembatalan_mob_validate_tglsetuju_cb);
  } // do_ajax_form_tbpembatalan_mob_validate_tglsetuju

  function do_ajax_form_tbpembatalan_mob_validate_tglsetuju_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbpembatalan_mob_validate_tglsetuju_cb

  // ---------- Event onchange jenis
  function do_ajax_form_tbpembatalan_mob_event_jenis_onchange()
  {
    var var_jenis = scAjaxGetFieldSelect("jenis");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tbpembatalan_mob_event_jenis_onchange(var_jenis, var_script_case_init, do_ajax_form_tbpembatalan_mob_event_jenis_onchange_cb);
  } // do_ajax_form_tbpembatalan_mob_event_jenis_onchange

  function do_ajax_form_tbpembatalan_mob_event_jenis_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "jenis";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_tbpembatalan_mob_event_jenis_onchange_cb_after_alert);
  } // do_ajax_form_tbpembatalan_mob_event_jenis_onchange_cb
  function do_ajax_form_tbpembatalan_mob_event_jenis_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_tbpembatalan_mob_event_jenis_onchange_cb_after_alert

  // ---------- Event onclick setuju
  function do_ajax_form_tbpembatalan_mob_event_setuju_onclick()
  {
    var var_tglsetuju = scAjaxGetFieldText("tglsetuju");
    var var_status = scAjaxGetFieldSelect("status");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tbpembatalan_mob_event_setuju_onclick(var_tglsetuju, var_status, var_script_case_init, do_ajax_form_tbpembatalan_mob_event_setuju_onclick_cb);
  } // do_ajax_form_tbpembatalan_mob_event_setuju_onclick

  function do_ajax_form_tbpembatalan_mob_event_setuju_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "setuju";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_tbpembatalan_mob_event_setuju_onclick_cb_after_alert);
  } // do_ajax_form_tbpembatalan_mob_event_setuju_onclick_cb
  function do_ajax_form_tbpembatalan_mob_event_setuju_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_tbpembatalan_mob_event_setuju_onclick_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tbpembatalan_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tbpembatalan_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_tbpembatalan_mob_submit_form(var_id, var_trancode, var_jenis, var_strukno, var_pemohon, var_alasan, var_status, var_tgltran, var_setuju, var_setujuoleh, var_tglsetuju, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbpembatalan_mob_submit_form_cb);
  } // do_ajax_form_tbpembatalan_mob_submit_form

  function do_ajax_form_tbpembatalan_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tbpembatalan_mob_submit_form_cb_after_alert);
  } // do_ajax_form_tbpembatalan_mob_submit_form_cb
  function do_ajax_form_tbpembatalan_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbpembatalan_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tbpembatalan_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tbpembatalan_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbpembatalan_mob_navigate_form_cb);
  } // do_ajax_form_tbpembatalan_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbpembatalan_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbpembatalan_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbpembatalan_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_tbpembatalan_mob_navigate_form_cb
  function do_ajax_form_tbpembatalan_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_tbpembatalan_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_tbpembatalan_mob_navigate_form_cb_after_alert
  function sc_hide_form_tbpembatalan_mob_form()
  {
