...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_tgltran_hora' + iSeqRow).bind('blur', function() { sc_form_tbpembatalan_tgltran_hora_onblur(this, iSeqRow) })
                                          .bind('focus', function() { sc_form_tbpembatalan_tgltran_hora_onfocus(this, iSeqRow) });
  ...
  $('#id_sc_field_tglsetuju_hora' + iSeqRow).bind('blur', function() { sc_form_tbpembatalan_tglsetuju_hora_onblur(this, iSeqRow) })
                                            .bind('focus', function() { sc_form_tbpembatalan_tglsetuju_hora_onfocus(this, iSeqRow) });
} // scJQEventsAdd
...
function sc_form_tbpembatalan_tgltran_hora_onblur(oThis, iSeqRow) {
  do_ajax_form_tbpembatalan_validate_tgltran();
  scCssBlur(oThis);
}
...
function sc_form_tbpembatalan_tgltran_hora_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function sc_form_tbpembatalan_tglsetuju_hora_onblur(oThis, iSeqRow) {
  do_ajax_form_tbpembatalan_validate_tglsetuju();
  scCssBlur(oThis);
}
...
function sc_form_tbpembatalan_tglsetuju_hora_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function scHidePage(pageNo) {
	$("#id_form_tbpembatalan_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_tgltran" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_tbpembatalan_validate_tgltran(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_tglsetuju" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_tbpembatalan_validate_tglsetuju(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
