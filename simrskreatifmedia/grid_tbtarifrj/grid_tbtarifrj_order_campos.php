...
<?php
   ...
   $Ord_Cmp = new grid_tbtarifrj_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_tbtarifrj_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbtarifrj']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tbtarifrj']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbtarifrj']['labels']["id"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbtarifrj']['labels']["id"] : "Id";
   $tab_ger_campos['kodetindakan'] = "on";
   $tab_def_campos['kodetindakan'] = "kodeTindakan";
   $tab_labels["kodetindakan"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbtarifrj']['labels']["kodetindakan"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbtarifrj']['labels']["kodetindakan"] : "Kode Tindakan";
   $tab_ger_campos['isumum'] = "on";
   $tab_def_campos['isumum'] = "isUmum";
   $tab_labels["isumum"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbtarifrj']['labels']["isumum"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbtarifrj']['labels']["isumum"] : "Is Umum";
   $tab_ger_campos['isspesialis'] = "on";
   $tab_def_campos['isspesialis'] = "isSpesialis";
   $tab_labels["isspesialis"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbtarifrj']['labels']["isspesialis"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbtarifrj']['labels']["isspesialis"] : "Is Spesialis";
   $tab_ger_campos['tarifumum'] = "on";
   $tab_def_campos['tarifumum'] = "tarifUmum";
   $tab_labels["tarifumum"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbtarifrj']['labels']["tarifumum"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbtarifrj']['labels']["tarifumum"] : "Tarif Umum";
   $tab_ger_campos['tarifspesialis'] = "on";
   $tab_def_campos['tarifspesialis'] = "tarifSpesialis";
   $tab_labels["tarifspesialis"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbtarifrj']['labels']["tarifspesialis"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbtarifrj']['labels']["tarifspesialis"] : "Tarif Spesialis";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_tbtarifrj']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_tbtarifrj']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_tbtarifrj']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbtarifrj']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tbtarifrj']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_tbtarifrj']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_tbtarifrj']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_tbtarifrj']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_tbtarifrj']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_tbtarifrj_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_tbtarifrj']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_tbtarifrj']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_tbtarifrj']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_tbtarifrj']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_tbtarifrj']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
