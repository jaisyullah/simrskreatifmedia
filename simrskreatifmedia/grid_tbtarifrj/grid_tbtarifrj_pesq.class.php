...
class grid_tbtarifrj_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifrj']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_tbtarifrj_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_tbtarifrj_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_tbtarifrj_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_isspesialis')
      {
          $isspesialis = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_isspesialis($isspesialis);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_isumum')
      {
          $isumum = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_isumum($isumum);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function lookup_ajax_isspesialis($isspesialis)
   {
      $isspesialis = substr($this->Db->qstr($isspesialis), 1, -1);
            $isspesialis_look = substr($this->Db->qstr($isspesialis), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct isSpesialis from " . $this->Ini->nm_tabela . " where  isSpesialis like '%" . $isspesialis . "%' order by isSpesialis"; 
      unset($cmp1,$cmp2);
   ...
   function lookup_ajax_isumum($isumum)
   {
      $isumum = substr($this->Db->qstr($isumum), 1, -1);
            $isumum_look = substr($this->Db->qstr($isumum), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct isUmum from " . $this->Ini->nm_tabela . " where  isUmum like '%" . $isumum . "%' order by isUmum"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifrj']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifrj']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifrj']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifrj']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifrj']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifrj']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifrj']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifrj']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifrj']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifrj']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifrj']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifrj']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifrj']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifrj']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifrj']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - tbtarifrj</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_tbtarifrj/grid_tbtarifrj_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_tbtarifrj_ajax_search.js"></script>
 <script type="text/javascript" src="grid_tbtarifrj_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_tbtarifrj_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_tbtarifrj']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_tbtarifrj']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_isspesialis_cond#NMF#' + search_get_sel_txt('SC_isspesialis_cond') + '@NMF@';
  str_out += 'SC_isspesialis#NMF#' + search_get_text('SC_isspesialis') + '@NMF@';
  str_out += 'id_ac_isspesialis#NMF#' + search_get_text('id_ac_isspesialis') + '@NMF@';
  ...
  str_out += 'SC_isumum_cond#NMF#' + search_get_sel_txt('SC_isumum_cond') + '@NMF@';
  str_out += 'SC_isumum#NMF#' + search_get_text('SC_isumum') + '@NMF@';
  str_out += 'id_ac_isumum#NMF#' + search_get_text('id_ac_isumum') + '@NMF@';
   ...
   $("#id_ac_isumum").autocomplete({
     ...
     $.ajax({
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_isumum",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_isumum").val( $(this).val() );
       }
     }
   });
   $("#id_ac_isspesialis").autocomplete({
     minLength: 1,
     source: function (request, response) {
     $.ajax({
       url: "index.php",
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_isspesialis",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_isspesialis").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     focus: function (event, ui) {
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifrj']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div class="scFilterHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFilterHeaderFont" style="float: left; text-transform: uppercase;"><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - tbtarifrj</div>
...
<?php
   ...
   {
      global 
             $isspesialis_cond, $isspesialis, $isspesialis_autocomp,
             $id_cond, $id, $id_autocomp,
             $kodetindakan_cond, $kodetindakan, $kodetindakan_autocomp,
             $isumum_cond, $isumum, $isumum_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifrj']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifrj']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifrj']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifrj']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $isspesialis = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifrj']['campos_busca']['isspesialis']; 
          $isspesialis_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifrj']['campos_busca']['isspesialis_cond']; 
          $id = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifrj']['campos_busca']['id']; 
          $id_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifrj']['campos_busca']['id_cond']; 
          $kodetindakan = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifrj']['campos_busca']['kodetindakan']; 
          $kodetindakan_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifrj']['campos_busca']['kodetindakan_cond']; 
          $isumum = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifrj']['campos_busca']['isumum']; 
          $isumum_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifrj']['campos_busca']['isumum_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifrj']['campos_busca']['NM_operador']; 
      } 
      if (!isset($isspesialis_cond) || empty($isspesialis_cond))
      {
         $isspesialis_cond = "qp";
      }
      ...
      if (!isset($isumum_cond) || empty($isumum_cond))
      {
         $isumum_cond = "qp";
      }
      ...
      $str_hide_isspesialis = (in_array($isspesialis_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      $str_hide_isumum = (in_array($isumum_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      if (!isset($isspesialis) || $isspesialis == "")
      {
          $isspesialis = "";
      }
      if (isset($isspesialis) && !empty($isspesialis))
      {
         $tmp_pos = strpos($isspesialis, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $isspesialis = substr($isspesialis, 0, $tmp_pos);
         }
      }
      if (!isset($id) || $id == "")
      {
      ...
      if (!isset($isumum) || $isumum == "")
      {
          $isumum = "";
      }
      if (isset($isumum) && !empty($isumum))
      {
         $tmp_pos = strpos($isumum, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $isumum = substr($isumum, 0, $tmp_pos);
         }
      }
?>
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_isspesialis_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['isspesialis'])) ? $this->New_label['isspesialis'] : "Is Spesialis"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_isspesialis_cond" name="isspesialis_cond" onChange="nm_campos_between(document.getElementById('id_vis_isspesialis'), this, 'isspesialis')">
       <OPTION value="qp" <?php if ("qp" == $isspesialis_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $isspesialis_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $isspesialis_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $isspesialis_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_isspesialis" <?php echo $str_hide_isspesialis?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['isspesialis'])) ? $this->New_label['isspesialis'] : "Is Spesialis";
 $nmgp_tab_label .= "isspesialis?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
...
<?php
      ...
      $isspesialis_look = substr($this->Db->qstr($isspesialis), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct isSpesialis from " . $this->Ini->nm_tabela . " where isSpesialis = '$isspesialis_look' order by isSpesialis"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      if (isset($nmgp_def_dados[0][$isspesialis]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$isspesialis];
      }
      else
      {
          $sAutocompValue = $isspesialis;
      }
?>
<INPUT  type="text" id="SC_isspesialis" name="isspesialis" value="<?php echo NM_encode_input($isspesialis) ?>"  size=1 alt="{datatype: 'text', maxLength: 1, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_isspesialis" name="isspesialis_autocomp" size="1"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 1, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_kodetindakan" name="kodetindakan_autocomp" size="15"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 15, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_isumum_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['isumum'])) ? $this->New_label['isumum'] : "Is Umum"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_isumum_cond" name="isumum_cond" onChange="nm_campos_between(document.getElementById('id_vis_isumum'), this, 'isumum')">
       <OPTION value="qp" <?php if ("qp" == $isumum_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $isumum_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $isumum_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $isumum_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_isumum" <?php echo $str_hide_isumum?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['isumum'])) ? $this->New_label['isumum'] : "Is Umum";
 $nmgp_tab_label .= "isumum?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      $isumum_look = substr($this->Db->qstr($isumum), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct isUmum from " . $this->Ini->nm_tabela . " where isUmum = '$isumum_look' order by isUmum"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      if (isset($nmgp_def_dados[0][$isumum]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$isumum];
      }
      else
      {
          $sAutocompValue = $isumum;
      }
?>
<INPUT  type="text" id="SC_isumum" name="isumum" value="<?php echo NM_encode_input($isumum) ?>"  size=1 alt="{datatype: 'text', maxLength: 1, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_isumum" name="isumum_autocomp" size="1"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 1, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
?>
<?php
   if (is_file("grid_tbtarifrj_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_tbtarifrj']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_tbtarifrj']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifrj']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.isspesialis_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_isspesialis'), document.F1.isspesialis_cond, 'isspesialis');
   document.F1.isspesialis.value = "";
   document.F1.isspesialis_autocomp.value = "";
   ...
   document.F1.isumum_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_isumum'), document.F1.isumum_cond, 'isumum');
   document.F1.isumum.value = "";
   document.F1.isumum_autocomp.value = "";
 }
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "simrskreatifmedia/grid_tbtarifrj";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifrj']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifrj']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifrj']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_isspesialis_cond'] = 'cond';
      $tp_fields['SC_isspesialis'] = 'text_aut';
      $tp_fields['id_ac_isspesialis'] = 'text_aut';
      ...
      $tp_fields['SC_isumum_cond'] = 'cond';
      $tp_fields['SC_isumum'] = 'text_aut';
      $tp_fields['id_ac_isumum'] = 'text_aut';
   ...
   {
      global $isspesialis_cond, $isspesialis, $isspesialis_autocomp,
             $id_cond, $id, $id_autocomp,
             $kodetindakan_cond, $kodetindakan, $kodetindakan_autocomp,
             $isumum_cond, $isumum, $isumum_autocomp, $nmgp_tab_label;

      $C_formatado = true;
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_conv_dados.php", "F", "nm_conv_limpa_dado") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
      if (!empty($isspesialis_autocomp) && empty($isspesialis))
      {
          $isspesialis = $isspesialis_autocomp;
      }
      ...
      if (!empty($isumum_autocomp) && empty($isumum))
      {
          $isumum = $isumum_autocomp;
      }
      $isspesialis_cond_salva = $isspesialis_cond; 
      if (!isset($isspesialis_input_2) || $isspesialis_input_2 == "")
      {
          $isspesialis_input_2 = $isspesialis;
      }
      ...
      $isumum_cond_salva = $isumum_cond; 
      if (!isset($isumum_input_2) || $isumum_input_2 == "")
      {
          $isumum_input_2 = $isumum;
      }
      if ($id_cond != "in")
      {
          nm_limpa_numero($id, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifrj']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifrj']['campos_busca']['isspesialis'] = $isspesialis; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifrj']['campos_busca']['isspesialis_cond'] = $isspesialis_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifrj']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifrj']['campos_busca']['id'] = $id; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifrj']['campos_busca']['id_cond'] = $id_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifrj']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifrj']['campos_busca']['kodetindakan'] = $kodetindakan; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifrj']['campos_busca']['kodetindakan_cond'] = $kodetindakan_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifrj']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifrj']['campos_busca']['isumum'] = $isumum; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifrj']['campos_busca']['isumum_cond'] = $isumum_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifrj']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifrj']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifrj']['campos_busca'] = $Temp_Busca;
      }
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['isspesialis'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['isspesialis'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['isspesialis'] = $isspesialis;
      }
      $id_look = substr($this->Db->qstr($id), 1, -1); 
      $nmgp_def_dados = array(); 
   if (is_numeric($id))
   { 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['isumum'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['isumum'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['isumum'] = $isumum;
      }

      //----- $isspesialis
      $this->Date_part = false;
      if (isset($isspesialis) || $isspesialis_cond == "nu" || $isspesialis_cond == "nn" || $isspesialis_cond == "ep" || $isspesialis_cond == "ne")
      {
         $this->monta_condicao("isSpesialis", $isspesialis_cond, $isspesialis, "", "isspesialis");
      }
      ...
      //----- $isumum
      $this->Date_part = false;
      if (isset($isumum) || $isumum_cond == "nu" || $isumum_cond == "nn" || $isumum_cond == "ep" || $isumum_cond == "ne")
      {
         $this->monta_condicao("isUmum", $isumum_cond, $isumum, "", "isumum");
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifrj']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifrj']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifrj']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifrj']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifrj']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifrj']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifrj']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifrj']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifrj']['cond_pesq'] .= $this->NM_operador;
