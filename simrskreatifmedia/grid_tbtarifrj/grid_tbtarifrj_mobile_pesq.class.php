...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "id";$Nm_numeric[] = "tarifumum";$Nm_numeric[] = "tarifspesialis";$Nm_numeric[] = "id";$Nm_numeric[] = "tarifumum";$Nm_numeric[] = "tarifspesialis";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_isspesialis_cond" name="isspesialis_cond" onChange="nm_campos_between(document.getElementById('id_vis_isspesialis'), this, 'isspesialis')">
      ...
      <br><span id="id_hide_isspesialis"  <?php echo $str_hide_isspesialis?>><?php
      if ($isspesialis != "")
      {
      $isspesialis_look = substr($this->Db->qstr($isspesialis), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_isumum_cond" name="isumum_cond" onChange="nm_campos_between(document.getElementById('id_vis_isumum'), this, 'isumum')">
      ...
      <br><span id="id_hide_isumum"  <?php echo $str_hide_isumum?>><?php
      if ($isumum != "")
      {
      $isumum_look = substr($this->Db->qstr($isumum), 1, -1); 
      $nmgp_def_dados = array(); 
