...
function scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['form_vclaim_rujukan_search_no_kartu_exec']['contr_erro']) && $_SESSION['scriptcase']['form_vclaim_rujukan_search_no_kartu_exec']['contr_erro'] == 'on')
    {
