...
.sc-button-image.disabled img {
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_lpk_insert_mob']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_vclaim_lpk_insert/form_vclaim_lpk_insert_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_vclaim_lpk_insert_mob_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_vclaim_lpk_insert_mob_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_lpk_insert_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_lpk_insert_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_lpk_insert_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_lpk_insert_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_lpk_insert_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_lpk_insert_mob']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_lpk_insert_mob']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_lpk_insert_mob']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
?>
<body class="scFormPage" style="<?php echo $remove_margin . $str_iframe_body; ?>">
<?php

if (isset($_SESSION['scriptcase']['form_vclaim_lpk_insert']['error_buffer']) && '' != $_SESSION['scriptcase']['form_vclaim_lpk_insert']['error_buffer'])
{
    echo $_SESSION['scriptcase']['form_vclaim_lpk_insert']['error_buffer'];
}
...
<?php
 include_once("form_vclaim_lpk_insert_mob_js0.php");
?>
<script type="text/javascript"> 
...
<form  name="F1" method="post" 
               action="form_vclaim_lpk_insert_mob.php" 
               target="_self">
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_vclaim_lpk_insert_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_vclaim_lpk_insert_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_lpk_insert_mob']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_lpk_insert_mob']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_lpk_insert_mob']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_lpk_insert_mob']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_lpk_insert_mob']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<?php
  ...
  {
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_lpk_insert_mob']['where_filter']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_lpk_insert_mob']['empty_filter'] = true;
       }
  }
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_tglmasuk_line" id="hidden_field_data_tglmasuk" style="<?php echo $sStyleHidden_tglmasuk; ?>"> <span class="scFormLabelOddFormat css_tglmasuk_label"><span id="id_label_tglmasuk"><?php echo $this->nm_new_label['tglmasuk']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_tglkeluar_line" id="hidden_field_data_tglkeluar" style="<?php echo $sStyleHidden_tglkeluar; ?>"> <span class="scFormLabelOddFormat css_tglkeluar_label"><span id="id_label_tglkeluar"><?php echo $this->nm_new_label['tglkeluar']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_jaminan_line" id="hidden_field_data_jaminan" style="<?php echo $sStyleHidden_jaminan; ?>"> <span class="scFormLabelOddFormat css_jaminan_label"><span id="id_label_jaminan"><?php echo $this->nm_new_label['jaminan']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_poli_line" id="hidden_field_data_poli" style="<?php echo $sStyleHidden_poli; ?>"> <span class="scFormLabelOddFormat css_poli_label"><span id="id_label_poli"><?php echo $this->nm_new_label['poli']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_nmpoli_line" id="hidden_field_data_nmpoli" style="<?php echo $sStyleHidden_nmpoli; ?>"> <span class="scFormLabelOddFormat css_nmpoli_label"><span id="id_label_nmpoli"><?php echo $this->nm_new_label['nmpoli']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_ruangrawat_line" id="hidden_field_data_ruangrawat" style="<?php echo $sStyleHidden_ruangrawat; ?>"> <span class="scFormLabelOddFormat css_ruangrawat_label"><span id="id_label_ruangrawat"><?php echo $this->nm_new_label['ruangrawat']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_kelasrawat_line" id="hidden_field_data_kelasrawat" style="<?php echo $sStyleHidden_kelasrawat; ?>"> <span class="scFormLabelOddFormat css_kelasrawat_label"><span id="id_label_kelasrawat"><?php echo $this->nm_new_label['kelasrawat']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_spesialistik_line" id="hidden_field_data_spesialistik" style="<?php echo $sStyleHidden_spesialistik; ?>"> <span class="scFormLabelOddFormat css_spesialistik_label"><span id="id_label_spesialistik"><?php echo $this->nm_new_label['spesialistik']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_carakeluar_line" id="hidden_field_data_carakeluar" style="<?php echo $sStyleHidden_carakeluar; ?>"> <span class="scFormLabelOddFormat css_carakeluar_label"><span id="id_label_carakeluar"><?php echo $this->nm_new_label['carakeluar']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_kondisipulang_line" id="hidden_field_data_kondisipulang" style="<?php echo $sStyleHidden_kondisipulang; ?>"> <span class="scFormLabelOddFormat css_kondisipulang_label"><span id="id_label_kondisipulang"><?php echo $this->nm_new_label['kondisipulang']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_tindaklanjut_line" id="hidden_field_data_tindaklanjut" style="<?php echo $sStyleHidden_tindaklanjut; ?>"> <span class="scFormLabelOddFormat css_tindaklanjut_label"><span id="id_label_tindaklanjut"><?php echo $this->nm_new_label['tindaklanjut']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_dirujukkodeppk_line" id="hidden_field_data_dirujukkodeppk" style="<?php echo $sStyleHidden_dirujukkodeppk; ?>"> <span class="scFormLabelOddFormat css_dirujukkodeppk_label"><span id="id_label_dirujukkodeppk"><?php echo $this->nm_new_label['dirujukkodeppk']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_tglkontrol_line" id="hidden_field_data_tglkontrol" style="<?php echo $sStyleHidden_tglkontrol; ?>"> <span class="scFormLabelOddFormat css_tglkontrol_label"><span id="id_label_tglkontrol"><?php echo $this->nm_new_label['tglkontrol']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_polikontrolkembali_line" id="hidden_field_data_polikontrolkembali" style="<?php echo $sStyleHidden_polikontrolkembali; ?>"> <span class="scFormLabelOddFormat css_polikontrolkembali_label"><span id="id_label_polikontrolkembali"><?php echo $this->nm_new_label['polikontrolkembali']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_dpjp_line" id="hidden_field_data_dpjp" style="<?php echo $sStyleHidden_dpjp; ?>"> <span class="scFormLabelOddFormat css_dpjp_label"><span id="id_label_dpjp"><?php echo $this->nm_new_label['dpjp']; ?></span></span><br>
...
<?php
           if (($nm_apl_dependente != 1) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_lpk_insert_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_lpk_insert_mob']['dashboard_info']['under_dashboard'])) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_lpk_insert_mob']['nm_run_menu']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_lpk_insert_mob']['nm_run_menu'] != 1))) {
...
<?php
           if (($nm_apl_dependente == 1) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_lpk_insert_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_lpk_insert_mob']['dashboard_info']['under_dashboard']))) {
        $sCondStyle = ($this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_lpk_insert_mob']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_lpk_insert_mob']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_vclaim_lpk_insert_mob");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_vclaim_lpk_insert_mob");
 parent.scAjaxDetailHeight("form_vclaim_lpk_insert_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_lpk_insert_mob']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
