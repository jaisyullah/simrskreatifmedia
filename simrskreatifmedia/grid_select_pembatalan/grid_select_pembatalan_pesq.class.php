...
class grid_select_pembatalan_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['path_libs_php'] = $this->Ini->path_lib_php;
      ...
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search_change_fil")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['campos_busca'] = array(); 
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_select_pembatalan_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_select_pembatalan_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_select_pembatalan_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_dpjp')
      {
          $dpjp = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_dpjp($dpjp);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function lookup_ajax_struk($struk)
   {
      ...
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct Struk from (SELECT 	z.Kode AS Kode, 	z.Struk AS Struk, 	z.Dokter AS DPJP, 	z.RM AS Pasien, 	z.Selesai AS Selesai, 	z.Jenis AS Jenis  FROM 	( 	SELECT 		a.tranCode AS Kode, 		a.noStruk AS Struk, 		a.dokter AS Dokter, 		a.custCode AS RM, 		a.selesai AS Selesai, 		'POLI' AS Jenis  	FROM 		tbdetailrawatjalan a 		LEFT JOIN tbantrian b ON b.struckNo = a.noStruk  	WHERE 		b.STATUS != 'Lengkap' UNION ALL 	SELECT 		a.tranCode AS Kode, 		a.noStruk AS Struk, 		a.dokter AS Dokter, 		a.custCode AS RM, 		a.selesai AS Selesai, 		'RAWAT INAP' AS Jenis  	FROM 		tbdetailrawatinap a 		LEFT JOIN tbadmrawatinap b ON b.tranCode = a.tranCode  	WHERE 		b.STATUS != 'Lengkap' UNION ALL 	SELECT 		a.tranCode AS Kode, 		a.noStruk AS Struk, 		a.dokter AS Dokter, 		a.custCode AS RM, 		a.selesai AS Selesai, 		'IGD' AS Jenis  	FROM 		tbdetailigd a 		LEFT JOIN tbantrian b ON b.struckNo = a.noStruk  	WHERE 		b.STATUS != 'Lengkap' UNION ALL 	SELECT 		trancode AS Kode, 		struk AS Struk, 		doccode AS Dokter, 		custcode AS RM, 		STATUS AS Selesai, 		'LABORATORIUM' AS Jenis  	FROM 		tbtranlab  	WHERE 		STATUS != '2' UNION ALL 	SELECT 		trancode AS Kode, 		struk AS Struk, 		doccode AS Dokter, 		custcode AS RM, 		STATUS AS Selesai, 		'RADIOLOGI' AS Jenis  	FROM 		tbtranrad  	WHERE 		STATUS != '2' UNION ALL 	SELECT 		noPayment AS Kode, 		noStruk AS Struk, 		'' AS DPJP, 		custCode AS Pasien, 		lunas AS Selesai, 		'PEMBAYARAN' AS Jenis  	FROM 		tbpayment UNION ALL 	SELECT 		trancode AS Kode, 		struk AS Struk, 		'' AS DPJP, 		extname AS Pasien, 		deleted AS Selesai, 		'PENJUALAN OBAT BEBAS' AS Jenis  	FROM 		tbdrugsell  	WHERE 		deleted = '0' UNION ALL 	SELECT 		struckNo AS Kode, 		struckNo AS Kode, 		doctor AS DPJP, 		custCode AS Pasien, 		'' AS Selesai, 		'PENDAFTARAN RAJAL' AS Jenis  	FROM 		tbantrian  	WHERE 		STATUS != 'Antre' UNION ALL 	SELECT 		tranCode AS Kode, 		struckNo AS Struk, 		doctor AS DPJP, 		custCode AS Pasien, 		STATUS AS Selesai, 		'PENDAFTARAN RANAP' AS Jenis  	FROM 		tbadmrawatinap  	WHERE 	STATUS = 'Daftar'  	) z where z.Jenis = '" . $_SESSION['jenisnya'] . "') nm_sel_esp where  Struk like '%" . $struk . "%'"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->SelectLimit($nm_comando, 10, 0)) 
   ...
   function lookup_ajax_dpjp($dpjp)
   {
      ...
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct DPJP from (SELECT 	z.Kode AS Kode, 	z.Struk AS Struk, 	z.Dokter AS DPJP, 	z.RM AS Pasien, 	z.Selesai AS Selesai, 	z.Jenis AS Jenis  FROM 	( 	SELECT 		a.tranCode AS Kode, 		a.noStruk AS Struk, 		a.dokter AS Dokter, 		a.custCode AS RM, 		a.selesai AS Selesai, 		'POLI' AS Jenis  	FROM 		tbdetailrawatjalan a 		LEFT JOIN tbantrian b ON b.struckNo = a.noStruk  	WHERE 		b.STATUS != 'Lengkap' UNION ALL 	SELECT 		a.tranCode AS Kode, 		a.noStruk AS Struk, 		a.dokter AS Dokter, 		a.custCode AS RM, 		a.selesai AS Selesai, 		'RAWAT INAP' AS Jenis  	FROM 		tbdetailrawatinap a 		LEFT JOIN tbadmrawatinap b ON b.tranCode = a.tranCode  	WHERE 		b.STATUS != 'Lengkap' UNION ALL 	SELECT 		a.tranCode AS Kode, 		a.noStruk AS Struk, 		a.dokter AS Dokter, 		a.custCode AS RM, 		a.selesai AS Selesai, 		'IGD' AS Jenis  	FROM 		tbdetailigd a 		LEFT JOIN tbantrian b ON b.struckNo = a.noStruk  	WHERE 		b.STATUS != 'Lengkap' UNION ALL 	SELECT 		trancode AS Kode, 		struk AS Struk, 		doccode AS Dokter, 		custcode AS RM, 		STATUS AS Selesai, 		'LABORATORIUM' AS Jenis  	FROM 		tbtranlab  	WHERE 		STATUS != '2' UNION ALL 	SELECT 		trancode AS Kode, 		struk AS Struk, 		doccode AS Dokter, 		custcode AS RM, 		STATUS AS Selesai, 		'RADIOLOGI' AS Jenis  	FROM 		tbtranrad  	WHERE 		STATUS != '2' UNION ALL 	SELECT 		noPayment AS Kode, 		noStruk AS Struk, 		'' AS DPJP, 		custCode AS Pasien, 		lunas AS Selesai, 		'PEMBAYARAN' AS Jenis  	FROM 		tbpayment UNION ALL 	SELECT 		trancode AS Kode, 		struk AS Struk, 		'' AS DPJP, 		extname AS Pasien, 		deleted AS Selesai, 		'PENJUALAN OBAT BEBAS' AS Jenis  	FROM 		tbdrugsell  	WHERE 		deleted = '0' UNION ALL 	SELECT 		struckNo AS Kode, 		struckNo AS Kode, 		doctor AS DPJP, 		custCode AS Pasien, 		'' AS Selesai, 		'PENDAFTARAN RAJAL' AS Jenis  	FROM 		tbantrian  	WHERE 		STATUS != 'Antre' UNION ALL 	SELECT 		tranCode AS Kode, 		struckNo AS Struk, 		doctor AS DPJP, 		custCode AS Pasien, 		STATUS AS Selesai, 		'PENDAFTARAN RANAP' AS Jenis  	FROM 		tbadmrawatinap  	WHERE 	STATUS = 'Daftar'  	) z where z.Jenis = '" . $_SESSION['jenisnya'] . "') nm_sel_esp where  DPJP like '%" . $dpjp . "%'"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->SelectLimit($nm_comando, 10, 0)) 
   ...
   function lookup_ajax_pasien($pasien)
   {
      ...
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct Pasien from (SELECT 	z.Kode AS Kode, 	z.Struk AS Struk, 	z.Dokter AS DPJP, 	z.RM AS Pasien, 	z.Selesai AS Selesai, 	z.Jenis AS Jenis  FROM 	( 	SELECT 		a.tranCode AS Kode, 		a.noStruk AS Struk, 		a.dokter AS Dokter, 		a.custCode AS RM, 		a.selesai AS Selesai, 		'POLI' AS Jenis  	FROM 		tbdetailrawatjalan a 		LEFT JOIN tbantrian b ON b.struckNo = a.noStruk  	WHERE 		b.STATUS != 'Lengkap' UNION ALL 	SELECT 		a.tranCode AS Kode, 		a.noStruk AS Struk, 		a.dokter AS Dokter, 		a.custCode AS RM, 		a.selesai AS Selesai, 		'RAWAT INAP' AS Jenis  	FROM 		tbdetailrawatinap a 		LEFT JOIN tbadmrawatinap b ON b.tranCode = a.tranCode  	WHERE 		b.STATUS != 'Lengkap' UNION ALL 	SELECT 		a.tranCode AS Kode, 		a.noStruk AS Struk, 		a.dokter AS Dokter, 		a.custCode AS RM, 		a.selesai AS Selesai, 		'IGD' AS Jenis  	FROM 		tbdetailigd a 		LEFT JOIN tbantrian b ON b.struckNo = a.noStruk  	WHERE 		b.STATUS != 'Lengkap' UNION ALL 	SELECT 		trancode AS Kode, 		struk AS Struk, 		doccode AS Dokter, 		custcode AS RM, 		STATUS AS Selesai, 		'LABORATORIUM' AS Jenis  	FROM 		tbtranlab  	WHERE 		STATUS != '2' UNION ALL 	SELECT 		trancode AS Kode, 		struk AS Struk, 		doccode AS Dokter, 		custcode AS RM, 		STATUS AS Selesai, 		'RADIOLOGI' AS Jenis  	FROM 		tbtranrad  	WHERE 		STATUS != '2' UNION ALL 	SELECT 		noPayment AS Kode, 		noStruk AS Struk, 		'' AS DPJP, 		custCode AS Pasien, 		lunas AS Selesai, 		'PEMBAYARAN' AS Jenis  	FROM 		tbpayment UNION ALL 	SELECT 		trancode AS Kode, 		struk AS Struk, 		'' AS DPJP, 		extname AS Pasien, 		deleted AS Selesai, 		'PENJUALAN OBAT BEBAS' AS Jenis  	FROM 		tbdrugsell  	WHERE 		deleted = '0' UNION ALL 	SELECT 		struckNo AS Kode, 		struckNo AS Kode, 		doctor AS DPJP, 		custCode AS Pasien, 		'' AS Selesai, 		'PENDAFTARAN RAJAL' AS Jenis  	FROM 		tbantrian  	WHERE 		STATUS != 'Antre' UNION ALL 	SELECT 		tranCode AS Kode, 		struckNo AS Struk, 		doctor AS DPJP, 		custCode AS Pasien, 		STATUS AS Selesai, 		'PENDAFTARAN RANAP' AS Jenis  	FROM 		tbadmrawatinap  	WHERE 	STATUS = 'Daftar'  	) z where z.Jenis = '" . $_SESSION['jenisnya'] . "') nm_sel_esp where  Pasien like '%" . $pasien . "%'"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->SelectLimit($nm_comando, 10, 0)) 
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_select_pembatalan/grid_select_pembatalan_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_select_pembatalan_ajax_search.js"></script>
 <script type="text/javascript" src="grid_select_pembatalan_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_select_pembatalan_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_select_pembatalan']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_select_pembatalan']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
<script type="text/javascript">
 $(function() {
  $(".sc-ui-autocomp-kode").on("focus", function() {
  }).on("blur", function() {
   ...
   $("#SC_kode").val(e.params.data.id);
  });
  $(".sc-ui-autocomp-struk").on("focus", function() {
  }).on("blur", function() {
  }).on("keydown", function(e) {
   if(e.keyCode == $.ui.keyCode.TAB && $(".ui-autocomplete").filter(":visible").length) {
    e.keyCode = $.ui.keyCode.DOWN;
   ...
   $("#SC_struk").val(e.params.data.id);
  });
  $(".sc-ui-autocomp-pasien").on("focus", function() {
  }).on("blur", function() {
  }).on("keydown", function(e) {
   if(e.keyCode == $.ui.keyCode.TAB && $(".ui-autocomplete").filter(":visible").length) {
    e.keyCode = $.ui.keyCode.DOWN;
   ...
   $("#SC_pasien").val(e.params.data.id);
  });
  $(".sc-ui-autocomp-dpjp").on("focus", function() {
  }).on("blur", function() {
  }).on("keydown", function(e) {
   if(e.keyCode == $.ui.keyCode.TAB && $(".ui-autocomplete").filter(":visible").length) {
    e.keyCode = $.ui.keyCode.DOWN;
   ...
   ajax: {
    ...
    data: function (params) {
     var query = {
      q: params.term,
      nmgp_opcao: "ajax_autocomp",
      nmgp_parms: "NM_ajax_opcao?#?autocomp_dpjp",
      max_itens: "10",
      script_case_init: <?php echo $this->Ini->sc_page ?>
     }
     return query;
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<?php
   ...
   function monta_form()
   {
      global 
             ...
             $dpjp_cond, $dpjp, $dpjp_autocomp,
             $pasien_cond, $pasien, $pasien_autocomp,
             $nm_url_saida, $nm_apl_dependente, $nmgp_parms, $bprocessa, $nmgp_save_name, $NM_operador, $NM_filters, $nmgp_save_option, $NM_filters_del, $Script_BI;
      $Script_BI = "";
      $this->nmgp_botoes['clear'] = "on";
      $this->nmgp_botoes['save'] = "on";
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_select_pembatalan']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_select_pembatalan']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['grid_select_pembatalan']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("grid_select_pembatalan", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          $kode = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['campos_busca']['kode']; 
          $kode_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['campos_busca']['kode_cond']; 
          $struk = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['campos_busca']['struk']; 
          $struk_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['campos_busca']['struk_cond']; 
          $dpjp = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['campos_busca']['dpjp']; 
          $dpjp_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['campos_busca']['dpjp_cond']; 
          $pasien = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['campos_busca']['pasien']; 
          $pasien_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['campos_busca']['pasien_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['campos_busca']['NM_operador']; 
      } 
      if (!isset($kode_cond) || empty($kode_cond))
      {
         $kode_cond = "qp";
      }
      if (!isset($struk_cond) || empty($struk_cond))
      {
         $struk_cond = "qp";
      }
      if (!isset($dpjp_cond) || empty($dpjp_cond))
      {
         $dpjp_cond = "qp";
      }
      if (!isset($pasien_cond) || empty($pasien_cond))
      {
         $pasien_cond = "qp";
      }
...
<?php
      ...
      $kode_look = substr($this->Db->qstr($kode), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct Kode from (SELECT 	z.Kode AS Kode, 	z.Struk AS Struk, 	z.Dokter AS DPJP, 	z.RM AS Pasien, 	z.Selesai AS Selesai, 	z.Jenis AS Jenis  FROM 	( 	SELECT 		a.tranCode AS Kode, 		a.noStruk AS Struk, 		a.dokter AS Dokter, 		a.custCode AS RM, 		a.selesai AS Selesai, 		'POLI' AS Jenis  	FROM 		tbdetailrawatjalan a 		LEFT JOIN tbantrian b ON b.struckNo = a.noStruk  	WHERE 		b.STATUS != 'Lengkap' UNION ALL 	SELECT 		a.tranCode AS Kode, 		a.noStruk AS Struk, 		a.dokter AS Dokter, 		a.custCode AS RM, 		a.selesai AS Selesai, 		'RAWAT INAP' AS Jenis  	FROM 		tbdetailrawatinap a 		LEFT JOIN tbadmrawatinap b ON b.tranCode = a.tranCode  	WHERE 		b.STATUS != 'Lengkap' UNION ALL 	SELECT 		a.tranCode AS Kode, 		a.noStruk AS Struk, 		a.dokter AS Dokter, 		a.custCode AS RM, 		a.selesai AS Selesai, 		'IGD' AS Jenis  	FROM 		tbdetailigd a 		LEFT JOIN tbantrian b ON b.struckNo = a.noStruk  	WHERE 		b.STATUS != 'Lengkap' UNION ALL 	SELECT 		trancode AS Kode, 		struk AS Struk, 		doccode AS Dokter, 		custcode AS RM, 		STATUS AS Selesai, 		'LABORATORIUM' AS Jenis  	FROM 		tbtranlab  	WHERE 		STATUS != '2' UNION ALL 	SELECT 		trancode AS Kode, 		struk AS Struk, 		doccode AS Dokter, 		custcode AS RM, 		STATUS AS Selesai, 		'RADIOLOGI' AS Jenis  	FROM 		tbtranrad  	WHERE 		STATUS != '2' UNION ALL 	SELECT 		noPayment AS Kode, 		noStruk AS Struk, 		'' AS DPJP, 		custCode AS Pasien, 		lunas AS Selesai, 		'PEMBAYARAN' AS Jenis  	FROM 		tbpayment UNION ALL 	SELECT 		trancode AS Kode, 		struk AS Struk, 		'' AS DPJP, 		extname AS Pasien, 		deleted AS Selesai, 		'PENJUALAN OBAT BEBAS' AS Jenis  	FROM 		tbdrugsell  	WHERE 		deleted = '0' UNION ALL 	SELECT 		struckNo AS Kode, 		struckNo AS Kode, 		doctor AS DPJP, 		custCode AS Pasien, 		'' AS Selesai, 		'PENDAFTARAN RAJAL' AS Jenis  	FROM 		tbantrian  	WHERE 		STATUS != 'Antre' UNION ALL 	SELECT 		tranCode AS Kode, 		struckNo AS Struk, 		doctor AS DPJP, 		custCode AS Pasien, 		STATUS AS Selesai, 		'PENDAFTARAN RANAP' AS Jenis  	FROM 		tbadmrawatinap  	WHERE 	STATUS = 'Daftar'  	) z where z.Jenis = '" . $_SESSION['jenisnya'] . "') nm_sel_esp where Kode = '$kode_look'"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->SelectLimit($nm_comando, 10, 0)) 
...
?>
<INPUT  type="text" id="SC_kode" name="kode" value="<?php echo NM_encode_input($kode) ?>"  size=25 alt="{datatype: 'text', maxLength: 25, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-kode" id="id_ac_kode" name="kode_autocomp"><?php if ('' !=  $kode) { ?><option value="<?php echo $kode ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
      ...
      <TD id='SC_struk_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['struk'])) ? $this->New_label['struk'] : "Struk"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_struk_cond" name="struk_cond" onChange="nm_campos_between(document.getElementById('id_vis_struk'), this, 'struk')">
       <OPTION value="qp" <?php if ("qp" == $struk_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $struk_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $struk_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $struk_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
...
<?php
      ...
      $struk_look = substr($this->Db->qstr($struk), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct Struk from (SELECT 	z.Kode AS Kode, 	z.Struk AS Struk, 	z.Dokter AS DPJP, 	z.RM AS Pasien, 	z.Selesai AS Selesai, 	z.Jenis AS Jenis  FROM 	( 	SELECT 		a.tranCode AS Kode, 		a.noStruk AS Struk, 		a.dokter AS Dokter, 		a.custCode AS RM, 		a.selesai AS Selesai, 		'POLI' AS Jenis  	FROM 		tbdetailrawatjalan a 		LEFT JOIN tbantrian b ON b.struckNo = a.noStruk  	WHERE 		b.STATUS != 'Lengkap' UNION ALL 	SELECT 		a.tranCode AS Kode, 		a.noStruk AS Struk, 		a.dokter AS Dokter, 		a.custCode AS RM, 		a.selesai AS Selesai, 		'RAWAT INAP' AS Jenis  	FROM 		tbdetailrawatinap a 		LEFT JOIN tbadmrawatinap b ON b.tranCode = a.tranCode  	WHERE 		b.STATUS != 'Lengkap' UNION ALL 	SELECT 		a.tranCode AS Kode, 		a.noStruk AS Struk, 		a.dokter AS Dokter, 		a.custCode AS RM, 		a.selesai AS Selesai, 		'IGD' AS Jenis  	FROM 		tbdetailigd a 		LEFT JOIN tbantrian b ON b.struckNo = a.noStruk  	WHERE 		b.STATUS != 'Lengkap' UNION ALL 	SELECT 		trancode AS Kode, 		struk AS Struk, 		doccode AS Dokter, 		custcode AS RM, 		STATUS AS Selesai, 		'LABORATORIUM' AS Jenis  	FROM 		tbtranlab  	WHERE 		STATUS != '2' UNION ALL 	SELECT 		trancode AS Kode, 		struk AS Struk, 		doccode AS Dokter, 		custcode AS RM, 		STATUS AS Selesai, 		'RADIOLOGI' AS Jenis  	FROM 		tbtranrad  	WHERE 		STATUS != '2' UNION ALL 	SELECT 		noPayment AS Kode, 		noStruk AS Struk, 		'' AS DPJP, 		custCode AS Pasien, 		lunas AS Selesai, 		'PEMBAYARAN' AS Jenis  	FROM 		tbpayment UNION ALL 	SELECT 		trancode AS Kode, 		struk AS Struk, 		'' AS DPJP, 		extname AS Pasien, 		deleted AS Selesai, 		'PENJUALAN OBAT BEBAS' AS Jenis  	FROM 		tbdrugsell  	WHERE 		deleted = '0' UNION ALL 	SELECT 		struckNo AS Kode, 		struckNo AS Kode, 		doctor AS DPJP, 		custCode AS Pasien, 		'' AS Selesai, 		'PENDAFTARAN RAJAL' AS Jenis  	FROM 		tbantrian  	WHERE 		STATUS != 'Antre' UNION ALL 	SELECT 		tranCode AS Kode, 		struckNo AS Struk, 		doctor AS DPJP, 		custCode AS Pasien, 		STATUS AS Selesai, 		'PENDAFTARAN RANAP' AS Jenis  	FROM 		tbadmrawatinap  	WHERE 	STATUS = 'Daftar'  	) z where z.Jenis = '" . $_SESSION['jenisnya'] . "') nm_sel_esp where Struk = '$struk_look'"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->SelectLimit($nm_comando, 10, 0)) 
...
?>
<INPUT  type="text" id="SC_struk" name="struk" value="<?php echo NM_encode_input($struk) ?>"  size=15 alt="{datatype: 'text', maxLength: 15, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectEven sc-ui-autocomp-struk" id="id_ac_struk" name="struk_autocomp"><?php if ('' !=  $struk) { ?><option value="<?php echo $struk ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
     ...
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_dpjp_cond" name="dpjp_cond" onChange="nm_campos_between(document.getElementById('id_vis_dpjp'), this, 'dpjp')">
       <OPTION value="qp" <?php if ("qp" == $dpjp_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $dpjp_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $dpjp_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $dpjp_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
...
<?php
      ...
      $dpjp_look = substr($this->Db->qstr($dpjp), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct DPJP from (SELECT 	z.Kode AS Kode, 	z.Struk AS Struk, 	z.Dokter AS DPJP, 	z.RM AS Pasien, 	z.Selesai AS Selesai, 	z.Jenis AS Jenis  FROM 	( 	SELECT 		a.tranCode AS Kode, 		a.noStruk AS Struk, 		a.dokter AS Dokter, 		a.custCode AS RM, 		a.selesai AS Selesai, 		'POLI' AS Jenis  	FROM 		tbdetailrawatjalan a 		LEFT JOIN tbantrian b ON b.struckNo = a.noStruk  	WHERE 		b.STATUS != 'Lengkap' UNION ALL 	SELECT 		a.tranCode AS Kode, 		a.noStruk AS Struk, 		a.dokter AS Dokter, 		a.custCode AS RM, 		a.selesai AS Selesai, 		'RAWAT INAP' AS Jenis  	FROM 		tbdetailrawatinap a 		LEFT JOIN tbadmrawatinap b ON b.tranCode = a.tranCode  	WHERE 		b.STATUS != 'Lengkap' UNION ALL 	SELECT 		a.tranCode AS Kode, 		a.noStruk AS Struk, 		a.dokter AS Dokter, 		a.custCode AS RM, 		a.selesai AS Selesai, 		'IGD' AS Jenis  	FROM 		tbdetailigd a 		LEFT JOIN tbantrian b ON b.struckNo = a.noStruk  	WHERE 		b.STATUS != 'Lengkap' UNION ALL 	SELECT 		trancode AS Kode, 		struk AS Struk, 		doccode AS Dokter, 		custcode AS RM, 		STATUS AS Selesai, 		'LABORATORIUM' AS Jenis  	FROM 		tbtranlab  	WHERE 		STATUS != '2' UNION ALL 	SELECT 		trancode AS Kode, 		struk AS Struk, 		doccode AS Dokter, 		custcode AS RM, 		STATUS AS Selesai, 		'RADIOLOGI' AS Jenis  	FROM 		tbtranrad  	WHERE 		STATUS != '2' UNION ALL 	SELECT 		noPayment AS Kode, 		noStruk AS Struk, 		'' AS DPJP, 		custCode AS Pasien, 		lunas AS Selesai, 		'PEMBAYARAN' AS Jenis  	FROM 		tbpayment UNION ALL 	SELECT 		trancode AS Kode, 		struk AS Struk, 		'' AS DPJP, 		extname AS Pasien, 		deleted AS Selesai, 		'PENJUALAN OBAT BEBAS' AS Jenis  	FROM 		tbdrugsell  	WHERE 		deleted = '0' UNION ALL 	SELECT 		struckNo AS Kode, 		struckNo AS Kode, 		doctor AS DPJP, 		custCode AS Pasien, 		'' AS Selesai, 		'PENDAFTARAN RAJAL' AS Jenis  	FROM 		tbantrian  	WHERE 		STATUS != 'Antre' UNION ALL 	SELECT 		tranCode AS Kode, 		struckNo AS Struk, 		doctor AS DPJP, 		custCode AS Pasien, 		STATUS AS Selesai, 		'PENDAFTARAN RANAP' AS Jenis  	FROM 		tbadmrawatinap  	WHERE 	STATUS = 'Daftar'  	) z where z.Jenis = '" . $_SESSION['jenisnya'] . "') nm_sel_esp where DPJP = '$dpjp_look'"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->SelectLimit($nm_comando, 10, 0)) 
...
?>
<INPUT  type="text" id="SC_dpjp" name="dpjp" value="<?php echo NM_encode_input($dpjp) ?>"  size=50 alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-dpjp" id="id_ac_dpjp" name="dpjp_autocomp"><?php if ('' !=  $dpjp) { ?><option value="<?php echo $dpjp ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
      ...
      <TD id='SC_pasien_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['pasien'])) ? $this->New_label['pasien'] : "Pasien"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_pasien_cond" name="pasien_cond" onChange="nm_campos_between(document.getElementById('id_vis_pasien'), this, 'pasien')">
       <OPTION value="qp" <?php if ("qp" == $pasien_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $pasien_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $pasien_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $pasien_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
...
<?php
      ...
      $pasien_look = substr($this->Db->qstr($pasien), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct Pasien from (SELECT 	z.Kode AS Kode, 	z.Struk AS Struk, 	z.Dokter AS DPJP, 	z.RM AS Pasien, 	z.Selesai AS Selesai, 	z.Jenis AS Jenis  FROM 	( 	SELECT 		a.tranCode AS Kode, 		a.noStruk AS Struk, 		a.dokter AS Dokter, 		a.custCode AS RM, 		a.selesai AS Selesai, 		'POLI' AS Jenis  	FROM 		tbdetailrawatjalan a 		LEFT JOIN tbantrian b ON b.struckNo = a.noStruk  	WHERE 		b.STATUS != 'Lengkap' UNION ALL 	SELECT 		a.tranCode AS Kode, 		a.noStruk AS Struk, 		a.dokter AS Dokter, 		a.custCode AS RM, 		a.selesai AS Selesai, 		'RAWAT INAP' AS Jenis  	FROM 		tbdetailrawatinap a 		LEFT JOIN tbadmrawatinap b ON b.tranCode = a.tranCode  	WHERE 		b.STATUS != 'Lengkap' UNION ALL 	SELECT 		a.tranCode AS Kode, 		a.noStruk AS Struk, 		a.dokter AS Dokter, 		a.custCode AS RM, 		a.selesai AS Selesai, 		'IGD' AS Jenis  	FROM 		tbdetailigd a 		LEFT JOIN tbantrian b ON b.struckNo = a.noStruk  	WHERE 		b.STATUS != 'Lengkap' UNION ALL 	SELECT 		trancode AS Kode, 		struk AS Struk, 		doccode AS Dokter, 		custcode AS RM, 		STATUS AS Selesai, 		'LABORATORIUM' AS Jenis  	FROM 		tbtranlab  	WHERE 		STATUS != '2' UNION ALL 	SELECT 		trancode AS Kode, 		struk AS Struk, 		doccode AS Dokter, 		custcode AS RM, 		STATUS AS Selesai, 		'RADIOLOGI' AS Jenis  	FROM 		tbtranrad  	WHERE 		STATUS != '2' UNION ALL 	SELECT 		noPayment AS Kode, 		noStruk AS Struk, 		'' AS DPJP, 		custCode AS Pasien, 		lunas AS Selesai, 		'PEMBAYARAN' AS Jenis  	FROM 		tbpayment UNION ALL 	SELECT 		trancode AS Kode, 		struk AS Struk, 		'' AS DPJP, 		extname AS Pasien, 		deleted AS Selesai, 		'PENJUALAN OBAT BEBAS' AS Jenis  	FROM 		tbdrugsell  	WHERE 		deleted = '0' UNION ALL 	SELECT 		struckNo AS Kode, 		struckNo AS Kode, 		doctor AS DPJP, 		custCode AS Pasien, 		'' AS Selesai, 		'PENDAFTARAN RAJAL' AS Jenis  	FROM 		tbantrian  	WHERE 		STATUS != 'Antre' UNION ALL 	SELECT 		tranCode AS Kode, 		struckNo AS Struk, 		doctor AS DPJP, 		custCode AS Pasien, 		STATUS AS Selesai, 		'PENDAFTARAN RANAP' AS Jenis  	FROM 		tbadmrawatinap  	WHERE 	STATUS = 'Daftar'  	) z where z.Jenis = '" . $_SESSION['jenisnya'] . "') nm_sel_esp where Pasien = '$pasien_look'"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->SelectLimit($nm_comando, 10, 0)) 
...
?>
<INPUT  type="text" id="SC_pasien" name="pasien" value="<?php echo NM_encode_input($pasien) ?>"  size=50 alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectEven sc-ui-autocomp-pasien" id="id_ac_pasien" name="pasien_autocomp"><?php if ('' !=  $pasien) { ?><option value="<?php echo $pasien ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if ($_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
<?php
   if (is_file("grid_select_pembatalan_help.txt"))
   {
      $Arq_WebHelp = file("grid_select_pembatalan_help.txt"); 
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_select_pembatalan']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_select_pembatalan']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.struk_cond.value = 'qp';
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "simrskreatifmedia/grid_select_pembatalan";
   ...
   function inicializa_vars()
   {
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          $nmgp_tab_label = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['pesq_tab_label'];
      }
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['where_orig']))
      {
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['where_orig'];
      }
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro($nmgp_save_origem)
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "grid_select_pembatalan/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['id_ac_kode'] = 'select2_aut';
      $tp_fields['SC_struk_cond'] = 'cond';
      $tp_fields['SC_struk'] = 'text_aut';
      $tp_fields['id_ac_struk'] = 'select2_aut';
      $tp_fields['SC_dpjp_cond'] = 'cond';
      $tp_fields['SC_dpjp'] = 'text_aut';
      $tp_fields['id_ac_dpjp'] = 'select2_aut';
      $tp_fields['SC_pasien_cond'] = 'cond';
      $tp_fields['SC_pasien'] = 'text_aut';
      $tp_fields['id_ac_pasien'] = 'select2_aut';
   ...
   function trata_campos()
   {
      global $kode_cond, $kode, $kode_autocomp,
             $struk_cond, $struk, $struk_autocomp,
             $dpjp_cond, $dpjp, $dpjp_autocomp,
             $pasien_cond, $pasien, $pasien_autocomp, $nmgp_tab_label;
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['campos_busca'] as $Cmps => $Vals)
          {
              $$Cmps = $Vals;
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['grid_pesq'] = array();
      ...
      if (!empty($dpjp_autocomp) && empty($dpjp))
      {
          $dpjp = $dpjp_autocomp;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['Grid_search']  = array(); 
      $I_Grid = 0;
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['campos_busca']['kode'] = $kode; 
      if (is_array($kode) && !empty($kode))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['Grid_search'][$I_Grid]['val'][0] = $kode;
      }
      elseif ($kode_cond_salva == "nu" || $kode_cond_salva == "nn" || $kode_cond_salva == "ep" || $kode_cond_salva == "ne" || !empty($kode))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['Grid_search'][$I_Grid]['val'][0][0] = $kode;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['campos_busca']['kode_cond'] = $kode_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['Grid_search'][$I_Grid]['cmp'] = "kode"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['Grid_search'][$I_Grid]['opc'] = $kode_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['grid_pesq']['kode'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['campos_busca']['struk'] = $struk; 
      if (is_array($struk) && !empty($struk))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['Grid_search'][$I_Grid]['val'][0] = $struk;
      }
      elseif ($struk_cond_salva == "nu" || $struk_cond_salva == "nn" || $struk_cond_salva == "ep" || $struk_cond_salva == "ne" || !empty($struk))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['Grid_search'][$I_Grid]['val'][0][0] = $struk;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['campos_busca']['struk_cond'] = $struk_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['Grid_search'][$I_Grid]['cmp'] = "struk"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['Grid_search'][$I_Grid]['opc'] = $struk_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['grid_pesq']['struk'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['campos_busca']['dpjp'] = $dpjp; 
      if (is_array($dpjp) && !empty($dpjp))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['Grid_search'][$I_Grid]['val'][0] = $dpjp;
      }
      elseif ($dpjp_cond_salva == "nu" || $dpjp_cond_salva == "nn" || $dpjp_cond_salva == "ep" || $dpjp_cond_salva == "ne" || !empty($dpjp))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['Grid_search'][$I_Grid]['val'][0][0] = $dpjp;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['campos_busca']['dpjp_cond'] = $dpjp_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['Grid_search'][$I_Grid]['cmp'] = "dpjp"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['Grid_search'][$I_Grid]['opc'] = $dpjp_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['grid_pesq']['dpjp'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['campos_busca']['pasien'] = $pasien; 
      if (is_array($pasien) && !empty($pasien))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['Grid_search'][$I_Grid]['val'][0] = $pasien;
      }
      elseif ($pasien_cond_salva == "nu" || $pasien_cond_salva == "nn" || $pasien_cond_salva == "ep" || $pasien_cond_salva == "ne" || !empty($pasien))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['Grid_search'][$I_Grid]['val'][0][0] = $pasien;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['campos_busca']['pasien_cond'] = $pasien_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['Grid_search'][$I_Grid]['cmp'] = "pasien"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['Grid_search'][$I_Grid]['opc'] = $pasien_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['grid_pesq']['pasien'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      ...
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['dpjp'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['dpjp'] = $dpjp;
      }
      $pasien_look = substr($this->Db->qstr($pasien), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct Pasien from (SELECT 	z.Kode AS Kode, 	z.Struk AS Struk, 	z.Dokter AS DPJP, 	z.RM AS Pasien, 	z.Selesai AS Selesai, 	z.Jenis AS Jenis  FROM 	( 	SELECT 		a.tranCode AS Kode, 		a.noStruk AS Struk, 		a.dokter AS Dokter, 		a.custCode AS RM, 		a.selesai AS Selesai, 		'POLI' AS Jenis  	FROM 		tbdetailrawatjalan a 		LEFT JOIN tbantrian b ON b.struckNo = a.noStruk  	WHERE 		b.STATUS != 'Lengkap' UNION ALL 	SELECT 		a.tranCode AS Kode, 		a.noStruk AS Struk, 		a.dokter AS Dokter, 		a.custCode AS RM, 		a.selesai AS Selesai, 		'RAWAT INAP' AS Jenis  	FROM 		tbdetailrawatinap a 		LEFT JOIN tbadmrawatinap b ON b.tranCode = a.tranCode  	WHERE 		b.STATUS != 'Lengkap' UNION ALL 	SELECT 		a.tranCode AS Kode, 		a.noStruk AS Struk, 		a.dokter AS Dokter, 		a.custCode AS RM, 		a.selesai AS Selesai, 		'IGD' AS Jenis  	FROM 		tbdetailigd a 		LEFT JOIN tbantrian b ON b.struckNo = a.noStruk  	WHERE 		b.STATUS != 'Lengkap' UNION ALL 	SELECT 		trancode AS Kode, 		struk AS Struk, 		doccode AS Dokter, 		custcode AS RM, 		STATUS AS Selesai, 		'LABORATORIUM' AS Jenis  	FROM 		tbtranlab  	WHERE 		STATUS != '2' UNION ALL 	SELECT 		trancode AS Kode, 		struk AS Struk, 		doccode AS Dokter, 		custcode AS RM, 		STATUS AS Selesai, 		'RADIOLOGI' AS Jenis  	FROM 		tbtranrad  	WHERE 		STATUS != '2' UNION ALL 	SELECT 		noPayment AS Kode, 		noStruk AS Struk, 		'' AS DPJP, 		custCode AS Pasien, 		lunas AS Selesai, 		'PEMBAYARAN' AS Jenis  	FROM 		tbpayment UNION ALL 	SELECT 		trancode AS Kode, 		struk AS Struk, 		'' AS DPJP, 		extname AS Pasien, 		deleted AS Selesai, 		'PENJUALAN OBAT BEBAS' AS Jenis  	FROM 		tbdrugsell  	WHERE 		deleted = '0' UNION ALL 	SELECT 		struckNo AS Kode, 		struckNo AS Kode, 		doctor AS DPJP, 		custCode AS Pasien, 		'' AS Selesai, 		'PENDAFTARAN RAJAL' AS Jenis  	FROM 		tbantrian  	WHERE 		STATUS != 'Antre' UNION ALL 	SELECT 		tranCode AS Kode, 		struckNo AS Struk, 		doctor AS DPJP, 		custCode AS Pasien, 		STATUS AS Selesai, 		'PENDAFTARAN RANAP' AS Jenis  	FROM 		tbadmrawatinap  	WHERE 	STATUS = 'Daftar'  	) z where z.Jenis = '" . $_SESSION['jenisnya'] . "') nm_sel_esp where Pasien = '$pasien_look'"; 
      ...
      {
         $this->monta_condicao("DPJP", $dpjp_cond, $dpjp, "", "dpjp");
      }
   ...
   function finaliza_resultado_ajax()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['where_pesq'] = $this->comando;
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['where_pesq_fast'])) 
       {
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['where_pesq'])) 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['where_pesq_fast'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['where_pesq'] = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['where_pesq_fast'] . ")";
           }
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['cond_dyn_search'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_pembatalan']['cond_pesq'] .= $this->NM_operador;
