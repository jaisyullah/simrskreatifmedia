...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_struk_cond" name="struk_cond" onChange="nm_campos_between(document.getElementById('id_vis_struk'), this, 'struk')">
      ...
      <br><span id="id_hide_struk"  <?php echo $str_hide_struk?>><?php
      if ($struk != "")
      {
      $struk_look = substr($this->Db->qstr($struk), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_dpjp_cond" name="dpjp_cond" onChange="nm_campos_between(document.getElementById('id_vis_dpjp'), this, 'dpjp')">
      ...
      <br><span id="id_hide_dpjp"  <?php echo $str_hide_dpjp?>><?php
      if ($dpjp != "")
      {
      $dpjp_look = substr($this->Db->qstr($dpjp), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_pasien_cond" name="pasien_cond" onChange="nm_campos_between(document.getElementById('id_vis_pasien'), this, 'pasien')">
      ...
      <br><span id="id_hide_pasien"  <?php echo $str_hide_pasien?>><?php
      if ($pasien != "")
      {
      $pasien_look = substr($this->Db->qstr($pasien), 1, -1); 
      $nmgp_def_dados = array(); 
