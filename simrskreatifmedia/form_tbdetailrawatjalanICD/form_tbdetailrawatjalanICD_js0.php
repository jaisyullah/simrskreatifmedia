...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_tbdetailrawatjalanICD"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
function scForm_inline_submit(y, z) {
	Nm_Proc_Atualiz = true;
	do_ajax_form_tbdetailrawatjalanICD_submit_form(y, z);
...
{
   nm_field_disabled("custcode_=disabled;diagnosa1_=disabled;diagnosa2_=disabled", "");
