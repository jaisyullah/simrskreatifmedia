  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbdetailrawatjalanICD" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbdetailrawatjalanICD_form();
	}

  // ---------- Validate trancode_
  function do_ajax_form_tbdetailrawatjalanICD_validate_trancode_(iNumLinha)
  {
    var nomeCampo_trancode_ = "trancode_" + iNumLinha;
    var var_trancode_ = scAjaxGetFieldText(nomeCampo_trancode_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdetailrawatjalanICD_validate_trancode_(var_trancode_, iNumLinha, var_script_case_init, do_ajax_form_tbdetailrawatjalanICD_validate_trancode__cb);
  } // do_ajax_form_tbdetailrawatjalanICD_validate_trancode_

  function do_ajax_form_tbdetailrawatjalanICD_validate_trancode__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdetailrawatjalanICD_validate_trancode__cb

  // ---------- Validate custcode_
  function do_ajax_form_tbdetailrawatjalanICD_validate_custcode_(iNumLinha)
  {
    var nomeCampo_custcode_ = "custcode_" + iNumLinha;
    var var_custcode_ = scAjaxGetFieldText(nomeCampo_custcode_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdetailrawatjalanICD_validate_custcode_(var_custcode_, iNumLinha, var_script_case_init, do_ajax_form_tbdetailrawatjalanICD_validate_custcode__cb);
  } // do_ajax_form_tbdetailrawatjalanICD_validate_custcode_

  function do_ajax_form_tbdetailrawatjalanICD_validate_custcode__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "custcode_" + iLineNumber;
    }
    else
    {
      sFieldValid = "custcode_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "custcode_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "custcode_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdetailrawatjalanICD_validate_custcode__cb

  // ---------- Validate diagnosa1_
  function do_ajax_form_tbdetailrawatjalanICD_validate_diagnosa1_(iNumLinha)
  {
    var nomeCampo_diagnosa1_ = "diagnosa1_" + iNumLinha;
    var var_diagnosa1_ = scAjaxGetFieldText(nomeCampo_diagnosa1_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdetailrawatjalanICD_validate_diagnosa1_(var_diagnosa1_, iNumLinha, var_script_case_init, do_ajax_form_tbdetailrawatjalanICD_validate_diagnosa1__cb);
  } // do_ajax_form_tbdetailrawatjalanICD_validate_diagnosa1_

  function do_ajax_form_tbdetailrawatjalanICD_validate_diagnosa1__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "diagnosa1_" + iLineNumber;
    }
    else
    {
      sFieldValid = "diagnosa1_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "diagnosa1_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "diagnosa1_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdetailrawatjalanICD_validate_diagnosa1__cb

  // ---------- Validate icd1_
  function do_ajax_form_tbdetailrawatjalanICD_validate_icd1_(iNumLinha)
  {
  } // do_ajax_form_tbdetailrawatjalanICD_validate_icd1_

  function do_ajax_form_tbdetailrawatjalanICD_validate_icd1__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "icd1_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "icd1_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdetailrawatjalanICD_validate_icd1__cb

  // ---------- Validate diagnosa2_
  function do_ajax_form_tbdetailrawatjalanICD_validate_diagnosa2_(iNumLinha)
  {
    var nomeCampo_diagnosa2_ = "diagnosa2_" + iNumLinha;
    var var_diagnosa2_ = scAjaxGetFieldText(nomeCampo_diagnosa2_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdetailrawatjalanICD_validate_diagnosa2_(var_diagnosa2_, iNumLinha, var_script_case_init, do_ajax_form_tbdetailrawatjalanICD_validate_diagnosa2__cb);
  } // do_ajax_form_tbdetailrawatjalanICD_validate_diagnosa2_

  function do_ajax_form_tbdetailrawatjalanICD_validate_diagnosa2__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "diagnosa2_" + iLineNumber;
    }
    else
    {
      sFieldValid = "diagnosa2_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "diagnosa2_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "diagnosa2_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdetailrawatjalanICD_validate_diagnosa2__cb

  // ---------- Validate icd2_
  function do_ajax_form_tbdetailrawatjalanICD_validate_icd2_(iNumLinha)
  {
  } // do_ajax_form_tbdetailrawatjalanICD_validate_icd2_

  function do_ajax_form_tbdetailrawatjalanICD_validate_icd2__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "icd2_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "icd2_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdetailrawatjalanICD_validate_icd2__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_tbdetailrawatjalanICD_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_tbdetailrawatjalanICD_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tbdetailrawatjalanICD_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_tbdetailrawatjalanICD_add_new_line_cb);
  } // do_ajax_form_tbdetailrawatjalanICD_add_new_line

  function do_ajax_form_tbdetailrawatjalanICD_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
    ...
    nm_field_disabled("custcode_=disabled;diagnosa1_=disabled;diagnosa2_=disabled", "", iAjaxNewLine);
  } // do_ajax_form_tbdetailrawatjalanICD_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_tbdetailrawatjalanICD_backup_line(iNumLinha)
  {
    var var_trancode_ = scAjaxGetFieldText("trancode_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdetailrawatjalanICD_backup_line(var_trancode_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_tbdetailrawatjalanICD_backup_line_cb);
  } // do_ajax_form_tbdetailrawatjalanICD_backup_line

  function do_ajax_form_tbdetailrawatjalanICD_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_tbdetailrawatjalanICD_backup_line_cb

  function do_ajax_form_tbdetailrawatjalanICD_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_tbdetailrawatjalanICD_cancel_insert

  function do_ajax_form_tbdetailrawatjalanICD_cancel_update(iSeqVert)
  {
    do_ajax_form_tbdetailrawatjalanICD_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_tbdetailrawatjalanICD_cancel_update

  function do_ajax_form_tbdetailrawatjalanICD_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_tbdetailrawatjalanICD_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_tbdetailrawatjalanICD_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_tbdetailrawatjalanICD_table_refresh(var_trancode_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbdetailrawatjalanICD_table_refresh_cb);
  } //  do_ajax_form_tbdetailrawatjalanICD_table_refresh

  function do_ajax_form_tbdetailrawatjalanICD_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_tbdetailrawatjalanICD_table_refresh_cb_after_alert);
  } // do_ajax_form_tbdetailrawatjalanICD_table_refresh_cb
  function do_ajax_form_tbdetailrawatjalanICD_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_tbdetailrawatjalanICD_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_tbdetailrawatjalanICD_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_tbdetailrawatjalanICD_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_trancode_ = scAjaxGetFieldText("trancode_" + iNumLinha);
    var var_custcode_ = scAjaxGetFieldText("custcode_" + iNumLinha);
    var var_diagnosa1_ = scAjaxGetFieldText("diagnosa1_" + iNumLinha);
    var var_icd1_ = scAjaxGetFieldText("icd1_" + iNumLinha);
    var var_diagnosa2_ = scAjaxGetFieldText("diagnosa2_" + iNumLinha);
    var var_icd2_ = scAjaxGetFieldText("icd2_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_tbdetailrawatjalanICD_submit_form(var_trancode_, var_custcode_, var_diagnosa1_, var_icd1_, var_diagnosa2_, var_icd2_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbdetailrawatjalanICD_submit_form_cb);
  } // do_ajax_form_tbdetailrawatjalanICD_submit_form

  function do_ajax_form_tbdetailrawatjalanICD_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("custcode_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("diagnosa1_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("icd1_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("diagnosa2_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("icd2_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_tbdetailrawatjalanICD_submit_form_cb_after_alert);
  } // do_ajax_form_tbdetailrawatjalanICD_submit_form_cb
  function do_ajax_form_tbdetailrawatjalanICD_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbdetailrawatjalanICD_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tbdetailrawatjalanICD_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_tbdetailrawatjalanICD_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("custcode_" + iNavForm);
      scAjaxHideErrorDisplay("diagnosa1_" + iNavForm);
      scAjaxHideErrorDisplay("icd1_" + iNavForm);
      scAjaxHideErrorDisplay("diagnosa2_" + iNavForm);
      scAjaxHideErrorDisplay("icd2_" + iNavForm);
    }
    var var_trancode_ = document.F2.trancode_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tbdetailrawatjalanICD_navigate_form(var_trancode_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbdetailrawatjalanICD_navigate_form_cb);
  } // do_ajax_form_tbdetailrawatjalanICD_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailrawatjalanICD']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbdetailrawatjalanICD_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbdetailrawatjalanICD_navigate_form_cb_after_alert);
  } // do_ajax_form_tbdetailrawatjalanICD_navigate_form_cb
  function do_ajax_form_tbdetailrawatjalanICD_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_tbdetailrawatjalanICD_navigate_form_cb_after_alert
  function sc_hide_form_tbdetailrawatjalanICD_form()
  {
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "custcode_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "diagnosa1_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "icd1_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "diagnosa2_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "icd2_" + iNumLinha;
    iTotCampos++;
    ...
    ajax_error_list["custcode_" + iNumLinha] = {"label": "No. RM<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["diagnosa1_" + iNumLinha] = {"label": "Diagnosa 1<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["icd1_" + iNumLinha] = {"label": "ICD 1<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["diagnosa2_" + iNumLinha] = {"label": "Diagnosa 2<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["icd2_" + iNumLinha] = {"label": "ICD 2<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["trancode_"][iNumLinha] = "trancode_" + iNumLinha;
    ajax_field_mult["custcode_"][iNumLinha] = "custcode_" + iNumLinha;
    ajax_field_mult["diagnosa1_"][iNumLinha] = "diagnosa1_" + iNumLinha;
    ajax_field_mult["icd1_"][iNumLinha] = "icd1_" + iNumLinha;
    ajax_field_mult["diagnosa2_"][iNumLinha] = "diagnosa2_" + iNumLinha;
    ajax_field_mult["icd2_"][iNumLinha] = "icd2_" + iNumLinha;
    ajax_field_id["trancode_" + iNumLinha] = new Array("hidden_field_label_trancode_", "hidden_field_data_trancode_" + iNumLinha);
    ajax_field_id["custcode_" + iNumLinha] = new Array("hidden_field_label_custcode_", "hidden_field_data_custcode_" + iNumLinha);
    ajax_field_id["diagnosa1_" + iNumLinha] = new Array("hidden_field_label_diagnosa1_", "hidden_field_data_diagnosa1_" + iNumLinha);
    ajax_field_id["icd1_" + iNumLinha] = new Array("hidden_field_label_icd1_", "hidden_field_data_icd1_" + iNumLinha);
    ajax_field_id["diagnosa2_" + iNumLinha] = new Array("hidden_field_label_diagnosa2_", "hidden_field_data_diagnosa2_" + iNumLinha);
    ajax_field_id["icd2_" + iNumLinha] = new Array("hidden_field_label_icd2_", "hidden_field_data_icd2_" + iNumLinha);
    ajax_error_count["trancode_" + iNumLinha] = "off";
    ajax_error_count["custcode_" + iNumLinha] = "off";
    ajax_error_count["diagnosa1_" + iNumLinha] = "off";
    ajax_error_count["icd1_" + iNumLinha] = "off";
    ajax_error_count["diagnosa2_" + iNumLinha] = "off";
    ajax_error_count["icd2_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["trancode_" + iNumLinha] = "on";
    ajax_read_only["custcode_" + iNumLinha] = "off";
    ajax_read_only["diagnosa1_" + iNumLinha] = "off";
    ajax_read_only["icd1_" + iNumLinha] = "off";
    ajax_read_only["diagnosa2_" + iNumLinha] = "off";
    ajax_read_only["icd2_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["trancode_" + iNumLinha] = "on";
    ajax_read_only["custcode_" + iNumLinha] = "on";
    ajax_read_only["diagnosa1_" + iNumLinha] = "on";
    ajax_read_only["icd1_" + iNumLinha] = "on";
    ajax_read_only["diagnosa2_" + iNumLinha] = "on";
    ajax_read_only["icd2_" + iNumLinha] = "on";
<?php
}
?>
  }
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["custcode_" + iNumLinha] = null;
    ajax_error_list["diagnosa1_" + iNumLinha] = null;
    ajax_error_list["icd1_" + iNumLinha] = null;
    ajax_error_list["diagnosa2_" + iNumLinha] = null;
    ajax_error_list["icd2_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "trancode_": new Array(),
    "custcode_": new Array(),
    "diagnosa1_": new Array(),
    "icd1_": new Array(),
    "diagnosa2_": new Array(),
    "icd2_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["custcode_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["custcode_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["custcode_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["custcode_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["custcode_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["diagnosa1_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["diagnosa1_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["diagnosa1_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["diagnosa1_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["diagnosa1_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["icd1_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["icd1_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["icd1_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["icd1_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["icd1_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["diagnosa2_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["diagnosa2_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["diagnosa2_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["diagnosa2_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["diagnosa2_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["icd2_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["icd2_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["icd2_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["icd2_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["icd2_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['custcode_'])) ? $this->nmgp_cmp_readonly['custcode_'] : 'off';
?>
    scAjaxFieldRead("custcode_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['diagnosa1_'])) ? $this->nmgp_cmp_readonly['diagnosa1_'] : 'off';
?>
    scAjaxFieldRead("diagnosa1_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['icd1_'])) ? $this->nmgp_cmp_readonly['icd1_'] : 'off';
?>
    scAjaxFieldRead("icd1_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['diagnosa2_'])) ? $this->nmgp_cmp_readonly['diagnosa2_'] : 'off';
?>
    scAjaxFieldRead("diagnosa2_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['icd2_'])) ? $this->nmgp_cmp_readonly['icd2_'] : 'off';
?>
    scAjaxFieldRead("icd2_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("trancode_" + iSeq, "on");
    scAjaxFieldRead("custcode_" + iSeq, "on");
    scAjaxFieldRead("diagnosa1_" + iSeq, "on");
    scAjaxFieldRead("icd1_" + iSeq, "on");
    scAjaxFieldRead("diagnosa2_" + iSeq, "on");
    scAjaxFieldRead("icd2_" + iSeq, "on");
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["trancode_" + iRow] || "on" == ajax_error_count["custcode_" + iRow] || "on" == ajax_error_count["diagnosa1_" + iRow] || "on" == ajax_error_count["icd1_" + iRow] || "on" == ajax_error_count["diagnosa2_" + iRow] || "on" == ajax_error_count["icd2_" + iRow]))
    {
      ...
      $("#hidden_field_data_custcode_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_diagnosa1_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_icd1_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_diagnosa2_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_icd2_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["trancode_" + iRow] && "off" == ajax_error_count["custcode_" + iRow] && "off" == ajax_error_count["diagnosa1_" + iRow] && "off" == ajax_error_count["icd1_" + iRow] && "off" == ajax_error_count["diagnosa2_" + iRow] && "off" == ajax_error_count["icd2_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["trancode_" + iRow] = "off";
        ajax_error_count["custcode_" + iRow] = "off";
        ajax_error_count["diagnosa1_" + iRow] = "off";
        ajax_error_count["icd1_" + iRow] = "off";
        ajax_error_count["diagnosa2_" + iRow] = "off";
        ajax_error_count["icd2_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_custcode_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_diagnosa1_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_icd1_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_diagnosa2_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_icd2_" + iRow).removeClass("scFormErrorLine");
    }
  }
