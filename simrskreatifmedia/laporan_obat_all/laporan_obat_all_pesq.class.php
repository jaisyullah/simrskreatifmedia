...
class laporan_obat_all_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_obat_all']['path_libs_php'] = $this->Ini->path_lib_php;
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['laporan_obat_all']['prim_vez']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_obat_all']['prim_vez'] = "S";
      }
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . laporan_obat_all_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . laporan_obat_all_pack_protect_string($Tipo_filter[0]) . "\">.." . laporan_obat_all_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['laporan_obat_all']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['laporan_obat_all']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_obat_all']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_obat_all']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_obat_all']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_obat_all']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_obat_all']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_obat_all']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_obat_all']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_obat_all']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_obat_all']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_obat_all']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_obat_all']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_obat_all']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_obat_all']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_obat_all']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_obat_all']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
   ...
   $NM_retorno = "./";
    if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['laporan_obat_all']['proc_res'])) 
    {
...
<?php
    if ($_SESSION['sc_session'][$this->Ini->sc_page]['laporan_obat_all']['prim_vez'] == "N" && !$_SESSION['sc_session'][$this->Ini->sc_page]['laporan_obat_all']['proc_res']) 
    {
?>
if (parent.document.getElementById('nmsc_iframe_laporan_obat_all').contentWindow.nm_gp_submit_ajax)
{
   parent.document.getElementById('nmsc_iframe_laporan_obat_all').contentWindow.nm_gp_submit_ajax('inicio', 'save_grid');
}
else
{
   parent.document.getElementById('nmsc_iframe_laporan_obat_all').src = 'index.php?nmgp_opcao=pesq&script_case_init=<?php echo NM_encode_input($this->Ini->sc_page) ?>&script_case_session=<?php echo session_id() ?>';
}
<?php
    }
    else
...
<?php
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_obat_all']['prim_vez'] = "N";
?>
</SCRIPT>
</BODY>
</HTML>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>laporan_obat_all/laporan_obat_all_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="laporan_obat_all_ajax_search.js"></script>
 <script type="text/javascript" src="laporan_obat_all_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="laporan_obat_all_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['laporan_obat_all']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['laporan_obat_all']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
function scJQCalendarAdd() {
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_jenis#NMF#' + search_get_select('SC_jenis') + '@NMF@';
  str_out += 'SC_namaitem_cond#NMF#' + search_get_sel_txt('SC_namaitem_cond') + '@NMF@';
  str_out += 'SC_namaitem#NMF#' + search_get_selmult('SC_namaitem') + '@NMF@';
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['laporan_obat_all']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<?php
   ...
   function monta_form()
   {
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['laporan_obat_all']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['laporan_obat_all']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_obat_all']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['laporan_obat_all']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $trandate_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_obat_all']['campos_busca']['trandate_dia']; 
          $trandate_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_obat_all']['campos_busca']['trandate_mes']; 
          $trandate_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_obat_all']['campos_busca']['trandate_ano']; 
          $trandate_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_obat_all']['campos_busca']['trandate_input_2_dia']; 
          $trandate_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_obat_all']['campos_busca']['trandate_input_2_mes']; 
          $trandate_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_obat_all']['campos_busca']['trandate_input_2_ano']; 
          $trandate_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_obat_all']['campos_busca']['trandate_cond']; 
          $jenis = $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_obat_all']['campos_busca']['jenis']; 
          $jenis_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_obat_all']['campos_busca']['jenis_cond']; 
          $namaitem = $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_obat_all']['campos_busca']['namaitem']; 
          $namaitem_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_obat_all']['campos_busca']['namaitem_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_obat_all']['campos_busca']['NM_operador']; 
      } 
      ...
      $str_display_namaitem = ('bw' == $namaitem_cond) ? $display_aberto : $display_fechado;
      ...
      if (is_array($namaitem) && !empty($namaitem))
      {
         $tmp_array = array();
         $namaitem_val_str = "";
         foreach ($namaitem as $tmp_val_cmp)
         {
            if ("" != $namaitem_val_str)
            {
               $namaitem_val_str .= ",";
...
?>
      ...
      <INPUT type="hidden" id="SC_jenis_cond" name="jenis_cond" value="eq">
...
<?php
  $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_obat_all']['psq_check_ret']['jenis'] = array();
  $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_obat_all']['psq_check_ret']['jenis'][] = "Rajal";
  $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_obat_all']['psq_check_ret']['jenis'][] = "Ranap";
 ?>

 <SELECT class="scFilterObjectOdd" id="SC_jenis"  name="jenis"  size="1">
 <OPTION value=""></option>
 <OPTION value="Rajal##@@Rajal"<?php if ($jenis == "Rajal") { echo " selected" ;} ?>>Rajal</option>
 <OPTION value="Ranap##@@Ranap"<?php if ($jenis == "Ranap") { echo " selected" ;} ?>>Ranap</option>
 </SELECT>
...
<?php
      ...
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_obat_all']['psq_check_ret']['namaitem'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_obat_all']['psq_check_ret']['namaitem'][] = trim($rs->fields[0]);
...
?>
   <span id="idAjaxSelect_namaitem">
      <SELECT class="scFilterObjectOdd" id="SC_namaitem" name="namaitem[]"  size="1" multiple>
<?php
      ...
      foreach ($nm_opcoes as $nm_opcao)
      {
         if (!empty($nm_opcao))
         {
            ...
            {
               $namaitem_sel = "";
               foreach ($namaitem as $Dados)
               {
                   if ($Dados === $nm_opc_cod)
                   {
                       $namaitem_sel = "selected";
                       break;
                   }
               }
            }
            ...
            {
               $namaitem_sel = ("S" == $nm_opc_sel) ? "selected" : "";
            }
            $nm_sc_valor = $nm_opc_val;
            $nm_opc_val = $nm_sc_valor;
?>
       <OPTION value="<?php echo NM_encode_input($nm_opc_cod . $delimitador . $nm_opc_val); ?>" <?php echo $namaitem_sel; ?>><?php echo $nm_opc_val; ?></OPTION>
<?php
         }
      }
?>
...
?>
<?php
   if (is_file("laporan_obat_all_help.txt"))
   {
...
?>
<?php
   if ($nm_apl_dependente == 1 || (!$_SESSION['sc_session'][$this->Ini->sc_page]['laporan_obat_all']['opc_psq'] && !$this->aba_iframe))
   {
...
<?php
       ...
       elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['laporan_obat_all']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_obat_all']['dashboard_info']['under_dashboard'])
       { }
       else 
       { 
?>
...
<?php
   ...
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['laporan_obat_all']['opc_psq'])
   {
...
<?php
    if ($_SESSION['sc_session'][$this->Ini->sc_page]['laporan_obat_all']['prim_vez'] == "N") 
    {
?>
       <iframe id="nmsc_iframe_laporan_obat_all" frameborder="0" marginwidth="0px" marginheight="0px" topmargin="0px" leftmargin="0px" align="center" height="1500px" name="nm_iframe_laporan_obat_all" scrolling="auto" src="index.php?nmgp_opcao=pesq&script_case_init=<?php echo NM_encode_input($this->Ini->sc_page) ?>&script_case_session=<?php echo session_id() ?>" width="100%"></iframe>
<?php
    }
    else
    {
?>
       <iframe id="nmsc_iframe_laporan_obat_all" frameborder="0" marginwidth="0px" marginheight="0px" topmargin="0px" leftmargin="0px" align="center" height="1500px" name="nm_iframe_laporan_obat_all" scrolling="auto" src="" width="100%"></iframe>
<?php
    }
?>
<iframe id="nmsc_iframe_laporan_obat_all_pesq"  name="nm_iframe_laporan_obat_all_pesq" style= "display: none;" frameborder="0" marginwidth="0px" marginheight="0px" topmargin="0px" leftmargin="0px" src=""></iframe>
</td></tr></table></td></tr>
</TABLE>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['laporan_obat_all']['orig_pesq'] == "grid")
   {
...
?>
 ...
 {
    document.F1.target = "nm_iframe_laporan_obat_all_pesq";
    document.F1.submit();
 }
 function nm_move()
 {
     document.getElementById('nmsc_iframe_laporan_obat_all').contentWindow.nm_move('igual');
 }
 function limpa_form()
 {
   document.F1.reset();
   ...
   {
      if (document.F1.elements[i].name == 'namaitem[]')
      {
 ...
 {
    if (Field == 'all' || Field == 'namaitem') {
       Sc_carga_select2_namaitem();
    }
    if (Field == 'all' || Field == 'jenis') {
       Sc_carga_select2_jenis();
    }
 }
 function Sc_carga_select2_namaitem()
 {
  $("#SC_namaitem").select2(
    {
      language: {
 ...
 function Sc_carga_select2_jenis()
 {
  $("#SC_jenis").select2(
    {
      language: {
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "simrskreatifmedia/laporan_obat_all";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['laporan_obat_all']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_obat_all']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_obat_all']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_jenis'] = 'select';
      $tp_fields['SC_namaitem_cond'] = 'cond';
      $tp_fields['SC_namaitem'] = 'selmult';
   ...
   function trata_campos()
   {
      global $trandate_cond, $trandate, $trandate_dia, $trandate_mes, $trandate_ano, $trandate_input_2_dia, $trandate_input_2_mes, $trandate_input_2_ano,
             $jenis_cond, $jenis,
             $namaitem_cond, $namaitem, $nmgp_tab_label;
      ...
      if ($tmp_pos === false) {
          ...
          $L_lookup = substr($jenis, 0, $tmp_pos);
      }
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_obat_all']['psq_check_ret']['jenis'])) {
          if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "Jenis : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
      }
      if (is_array($namaitem)) {
          foreach ($namaitem as $I => $Val) {
              $tmp_pos = strpos($Val, "##@@");
              if ($tmp_pos === false) {
                  $L_lookup = $Val;
              }
              ...
              if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && trim($L_lookup) != '' && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_obat_all']['psq_check_ret']['namaitem'])) {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_obat_all']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_obat_all']['campos_busca']['trandate_dia'] = $trandate_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_obat_all']['campos_busca']['trandate_mes'] = $trandate_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_obat_all']['campos_busca']['trandate_ano'] = $trandate_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_obat_all']['campos_busca']['trandate_input_2_dia'] = $trandate_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_obat_all']['campos_busca']['trandate_input_2_mes'] = $trandate_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_obat_all']['campos_busca']['trandate_input_2_ano'] = $trandate_input_2_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_obat_all']['campos_busca']['trandate_cond'] = $trandate_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_obat_all']['campos_busca']['jenis'] = $jenis; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_obat_all']['campos_busca']['jenis_cond'] = $jenis_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_obat_all']['campos_busca']['namaitem'] = $namaitem; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_obat_all']['campos_busca']['namaitem_cond'] = $namaitem_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_obat_all']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_obat_all']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      ...
      $this->cmp_formatado['jenis'] = $Conteudo;
      $this->cmp_formatado['namaitem'] = $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_obat_all']['campos_busca']['namaitem'];
      $this->cmp_formatado['namaitem_input_2'] = $namaitem_input_2;
      ...
      if ($trandate_cond != "bi_TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_obat_all']['campos_busca']['trandate'] = $val[0];
          ...
          if ($trandate_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_obat_all']['campos_busca']['trandate_input_2'] = $val[1];
      ...
      $this->Date_part = false;
      $nm_aspas = "'";
      if ($namaitem_cond == "nu" || $namaitem_cond == "nn" || $namaitem_cond == "ep" || $namaitem_cond == "ne")
      {
          $namaitem = array();
      }
      if (is_array($namaitem) && count($namaitem) != 0)
      {
         foreach ($namaitem as $i => $dados)
         {
      ...
      {
         $this->and_or();
         if ($namaitem_cond == "df" || $namaitem_cond == "np")
         {
             $this->comando        .= " namaItem not in (";
             $this->comando_sum    .= " .namaItem not in (";
             $this->comando_filtro .= " namaItem not in (";
         }
         else
         {
             $this->comando        .= " namaItem in (";
             $this->comando_sum    .= " .namaItem in (";
             $this->comando_filtro .= " namaItem in (";
         }
         $x                     = count($namaitem);
         $xx                    = 0;
         $nm_cond               = "";
         ...
         $Lang_descr_final = isset($Lang_descr[$namaitem_cond]) ? $Lang_descr[$namaitem_cond] : $this->Ini->Nm_lang['lang_srch_like'];
         $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_obat_all']['cond_pesq'] .= $nmgp_tab_label['namaitem'] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
      }
      elseif (isset($namaitem) || $namaitem_cond == "nu" || $namaitem_cond == "nn" || $namaitem_cond == "ep" || $namaitem_cond == "ne")
      {
   ...
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_obat_all']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_obat_all']['cond_dyn_search'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['laporan_obat_all']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_obat_all']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['laporan_obat_all']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_obat_all']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_obat_all']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_obat_all']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['laporan_obat_all']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_obat_all']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['laporan_obat_all']['cond_pesq'] .= $this->NM_operador;
   ...
   function css_obj_select_ajax($Obj)
   {
      switch ($Obj)
      {
         case "namaitem" : return ('class="scFilterObjectOdd"'); break;
         default       : return ("");
      }
   }
