<?php
@session_start() ;
$_SESSION['scriptcase']['laporan_obat_all']['sc_process_barr'] = true;
require_once('../laporan_obat_all/index.php');
unset($_SESSION['scriptcase']['laporan_obat_all']['sc_process_barr']);
$ExportCtrl = new laporan_obat_all_export_control;
$ExportCtrl->Export_barr();

class laporan_obat_all_export_control
{
