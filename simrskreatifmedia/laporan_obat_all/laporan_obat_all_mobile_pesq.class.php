...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "tranDate";$Nm_datas[] = "tranDate";$Nm_numeric[] = "jumlah";$Nm_numeric[] = "biaya";$Nm_numeric[] = "";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_jenis"  <?php echo $str_hide_jenis?>> 
<?php
 ...
 <SELECT class="scFilterObjectEven" id="SC_jenis"  name="jenis"  size="1">
 <OPTION value=""></option>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_namaitem"  <?php echo $str_hide_namaitem?>>
<?php
