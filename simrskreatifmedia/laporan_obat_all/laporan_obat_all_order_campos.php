<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['laporan_obat_all']['glo_nm_path_imag_temp'] . "/sc_apl_default_simrskreatifmedia.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new laporan_obat_all_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class laporan_obat_all_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['laporan_obat_all']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['laporan_obat_all']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["trandate"]   = (isset($_SESSION['sc_session'][$sc_init]['laporan_obat_all']['labels']["trandate"])) ? $_SESSION['sc_session'][$sc_init]['laporan_obat_all']['labels']["trandate"] : "Tgl. Transaksi";
   $tab_ger_campos['trancode'] = "on";
   $tab_def_campos['trancode'] = "tranCode";
   $tab_labels["trancode"]   = (isset($_SESSION['sc_session'][$sc_init]['laporan_obat_all']['labels']["trancode"])) ? $_SESSION['sc_session'][$sc_init]['laporan_obat_all']['labels']["trancode"] : "Kode Transaksi";
   ...
   {
       $tab_def_campos['namapasien'] = "";
   }
   $tab_labels["namapasien"]   = (isset($_SESSION['sc_session'][$sc_init]['laporan_obat_all']['labels']["namapasien"])) ? $_SESSION['sc_session'][$sc_init]['laporan_obat_all']['labels']["namapasien"] : "RM";
   $tab_ger_campos['namaitem'] = "on";
   $tab_def_campos['namaitem'] = "namaItem";
   $tab_labels["namaitem"]   = (isset($_SESSION['sc_session'][$sc_init]['laporan_obat_all']['labels']["namaitem"])) ? $_SESSION['sc_session'][$sc_init]['laporan_obat_all']['labels']["namaitem"] : "Nama Item";
   $tab_ger_campos['satuan'] = "on";
   $tab_def_campos['satuan'] = "satuan";
   $tab_labels["satuan"]   = (isset($_SESSION['sc_session'][$sc_init]['laporan_obat_all']['labels']["satuan"])) ? $_SESSION['sc_session'][$sc_init]['laporan_obat_all']['labels']["satuan"] : "Satuan";
   $tab_ger_campos['jumlah'] = "on";
   $tab_def_campos['jumlah'] = "jumlah";
   $tab_labels["jumlah"]   = (isset($_SESSION['sc_session'][$sc_init]['laporan_obat_all']['labels']["jumlah"])) ? $_SESSION['sc_session'][$sc_init]['laporan_obat_all']['labels']["jumlah"] : "Jumlah";
   $tab_ger_campos['biaya'] = "on";
   $tab_def_campos['biaya'] = "biaya";
   $tab_labels["biaya"]   = (isset($_SESSION['sc_session'][$sc_init]['laporan_obat_all']['labels']["biaya"])) ? $_SESSION['sc_session'][$sc_init]['laporan_obat_all']['labels']["biaya"] : "Biaya";
   $tab_ger_campos['jenis'] = "on";
   $tab_def_campos['jenis'] = "jenis";
   $tab_labels["jenis"]   = (isset($_SESSION['sc_session'][$sc_init]['laporan_obat_all']['labels']["jenis"])) ? $_SESSION['sc_session'][$sc_init]['laporan_obat_all']['labels']["jenis"] : "Jenis";
   ...
   $tab_labels["total"]   = (isset($_SESSION['sc_session'][$sc_init]['laporan_obat_all']['labels']["total"])) ? $_SESSION['sc_session'][$sc_init]['laporan_obat_all']['labels']["total"] : "Total";
   ...
   $tab_labels["sc_field_0"]   = (isset($_SESSION['sc_session'][$sc_init]['laporan_obat_all']['labels']["sc_field_0"])) ? $_SESSION['sc_session'][$sc_init]['laporan_obat_all']['labels']["sc_field_0"] : "Ppn Total";
   ...
   $tab_labels["sc_field_1"]   = (isset($_SESSION['sc_session'][$sc_init]['laporan_obat_all']['labels']["sc_field_1"])) ? $_SESSION['sc_session'][$sc_init]['laporan_obat_all']['labels']["sc_field_1"] : "Grand Total";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['laporan_obat_all']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['laporan_obat_all']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['laporan_obat_all']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['laporan_obat_all']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['laporan_obat_all']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['laporan_obat_all']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['laporan_obat_all']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['laporan_obat_all']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['laporan_obat_all']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "laporan_obat_all_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['laporan_obat_all']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['laporan_obat_all']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['laporan_obat_all']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['laporan_obat_all']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['laporan_obat_all']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
