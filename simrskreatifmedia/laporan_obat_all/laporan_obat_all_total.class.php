...
class laporan_obat_all_total
{
   ...
   function __construct($sc_page)
   {
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['laporan_obat_all']['campos_busca']) && !empty($_SESSION['sc_session'][$this->sc_page]['laporan_obat_all']['campos_busca']))
      { 
