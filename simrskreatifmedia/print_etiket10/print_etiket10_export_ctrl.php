<?php
@session_start() ;
$_SESSION['scriptcase']['print_etiket10']['sc_process_barr'] = true;
require_once('../print_etiket10/index.php');
unset($_SESSION['scriptcase']['print_etiket10']['sc_process_barr']);
$ExportCtrl = new print_etiket10_export_control;
$ExportCtrl->Export_barr();

class print_etiket10_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_chart_titl'] ?> - tbreseprawatjalan :: Excel</TITLE>
