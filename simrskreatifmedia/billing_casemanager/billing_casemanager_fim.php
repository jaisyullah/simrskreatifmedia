...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____billing_casemanager"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____billing_casemanager"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['billing_casemanager']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['billing_casemanager']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['billing_casemanager']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['billing_casemanager']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['billing_casemanager']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>billing_casemanager</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['billing_casemanager']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['billing_casemanager']['embutida_filho'] as $ind => $sc_init)
          {
