<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['billing_casemanager']['glo_nm_path_imag_temp'] . "/sc_apl_default_simrskreatifmedia.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new billing_casemanager_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class billing_casemanager_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['billing_casemanager']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['billing_casemanager']['ordem_select_orig'] = array();
   }
   ...
   {
       $tab_def_campos['sc_field_0'] = "a.custCode";
   }
   $tab_labels["sc_field_0"]   = (isset($_SESSION['sc_session'][$sc_init]['billing_casemanager']['labels']["sc_field_0"])) ? $_SESSION['sc_session'][$sc_init]['billing_casemanager']['labels']["sc_field_0"] : "No RM";
   ...
   {
       $tab_def_campos['sc_field_1'] = "a.idProvider";
   }
   $tab_labels["sc_field_1"]   = (isset($_SESSION['sc_session'][$sc_init]['billing_casemanager']['labels']["sc_field_1"])) ? $_SESSION['sc_session'][$sc_init]['billing_casemanager']['labels']["sc_field_1"] : "No BPJS";
   ...
   {
       $tab_def_campos['sc_field_2'] = "concat( b.NAME,', ',b.salut )";
   }
   $tab_labels["sc_field_2"]   = (isset($_SESSION['sc_session'][$sc_init]['billing_casemanager']['labels']["sc_field_2"])) ? $_SESSION['sc_session'][$sc_init]['billing_casemanager']['labels']["sc_field_2"] : "Nama Pasien";
   ...
   {
       $tab_def_campos['sc_field_3'] = "a.kelas";
   }
   $tab_labels["sc_field_3"]   = (isset($_SESSION['sc_session'][$sc_init]['billing_casemanager']['labels']["sc_field_3"])) ? $_SESSION['sc_session'][$sc_init]['billing_casemanager']['labels']["sc_field_3"] : "Kelas Rawat";
   ...
   {
       $tab_def_campos['sc_field_4'] = "a.caraMasuk";
   }
   $tab_labels["sc_field_4"]   = (isset($_SESSION['sc_session'][$sc_init]['billing_casemanager']['labels']["sc_field_4"])) ? $_SESSION['sc_session'][$sc_init]['billing_casemanager']['labels']["sc_field_4"] : "Cara Masuk";
   ...
   {
       $tab_def_campos['sc_field_5'] = "a.tglMasuk";
   }
   $tab_labels["sc_field_5"]   = (isset($_SESSION['sc_session'][$sc_init]['billing_casemanager']['labels']["sc_field_5"])) ? $_SESSION['sc_session'][$sc_init]['billing_casemanager']['labels']["sc_field_5"] : "Tgl Masuk";
   $tab_ger_campos['los'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['los'] = "los";
   }
   else
   {
       $tab_def_campos['los'] = "IF
	(
   ...
   $tab_labels["los"]   = (isset($_SESSION['sc_session'][$sc_init]['billing_casemanager']['labels']["los"])) ? $_SESSION['sc_session'][$sc_init]['billing_casemanager']['labels']["los"] : "LOS";
   $tab_ger_campos['inacbg'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['inacbg'] = "Inacbg";
   }
   else
   {
       $tab_def_campos['inacbg'] = "";
   }
   $tab_labels["inacbg"]   = (isset($_SESSION['sc_session'][$sc_init]['billing_casemanager']['labels']["inacbg"])) ? $_SESSION['sc_session'][$sc_init]['billing_casemanager']['labels']["inacbg"] : "InaCBG";
   ...
   $tab_labels["sc_field_7"]   = (isset($_SESSION['sc_session'][$sc_init]['billing_casemanager']['labels']["sc_field_7"])) ? $_SESSION['sc_session'][$sc_init]['billing_casemanager']['labels']["sc_field_7"] : "Tarif InaCBG";
   ...
   $tab_labels["sc_field_6"]   = (isset($_SESSION['sc_session'][$sc_init]['billing_casemanager']['labels']["sc_field_6"])) ? $_SESSION['sc_session'][$sc_init]['billing_casemanager']['labels']["sc_field_6"] : "Total Billing";
   ...
   $tab_labels["selisih"]   = (isset($_SESSION['sc_session'][$sc_init]['billing_casemanager']['labels']["selisih"])) ? $_SESSION['sc_session'][$sc_init]['billing_casemanager']['labels']["selisih"] : "Selisih";
   $tab_ger_campos['inacbg'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['billing_casemanager']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['billing_casemanager']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['billing_casemanager']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['billing_casemanager']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['billing_casemanager']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['billing_casemanager']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['billing_casemanager']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['billing_casemanager']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['billing_casemanager']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "billing_casemanager_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['billing_casemanager']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['billing_casemanager']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['billing_casemanager']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['billing_casemanager']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['billing_casemanager']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
