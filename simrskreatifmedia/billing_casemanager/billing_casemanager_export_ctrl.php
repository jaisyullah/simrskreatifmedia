<?php
@session_start() ;
$_SESSION['scriptcase']['billing_casemanager']['sc_process_barr'] = true;
require_once('../billing_casemanager/index.php');
unset($_SESSION['scriptcase']['billing_casemanager']['sc_process_barr']);
$ExportCtrl = new billing_casemanager_export_control;
$ExportCtrl->Export_barr();

class billing_casemanager_export_control
{
