...
class billing_casemanager_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['path_libs_php'] = $this->Ini->path_lib_php;
      ...
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search_change_fil")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['campos_busca'] = array(); 
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . billing_casemanager_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . billing_casemanager_pack_protect_string($Tipo_filter[0]) . "\">.." . billing_casemanager_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_sc_field_3')
      {
          $sc_field_3 = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_sc_field_3($sc_field_3);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
	...
	(
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
          ...
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['grid_pesq'][$campo_join]);
              return;
          }
      ...
      $Nm_datas[] = "a.tglMasuk";$Nm_datas[] = "a_tglMasuk";
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE>Billing Case Management</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>billing_casemanager/billing_casemanager_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="billing_casemanager_ajax_search.js"></script>
 <script type="text/javascript" src="billing_casemanager_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="billing_casemanager_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['billing_casemanager']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['billing_casemanager']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_no. rm_cond#NMF#' + search_get_sel_txt('SC_sc_field_0_cond') + '@NMF@';
  str_out += 'SC_no. rm#NMF#' + search_get_text('SC_sc_field_0') + '@NMF@';
  str_out += 'id_ac_no. rm#NMF#' + search_get_text('id_ac_sc_field_0') + '@NMF@';
  str_out += 'SC_no. bpjs_cond#NMF#' + search_get_sel_txt('SC_sc_field_1_cond') + '@NMF@';
  str_out += 'SC_no. bpjs#NMF#' + search_get_text('SC_sc_field_1') + '@NMF@';
  str_out += 'id_ac_no. bpjs#NMF#' + search_get_text('id_ac_sc_field_1') + '@NMF@';
  str_out += 'SC_nama pasien_cond#NMF#' + search_get_sel_txt('SC_sc_field_2_cond') + '@NMF@';
  str_out += 'SC_nama pasien#NMF#' + search_get_text('SC_sc_field_2') + '@NMF@';
  str_out += 'SC_kelas rawat_cond#NMF#' + search_get_sel_txt('SC_sc_field_3_cond') + '@NMF@';
  str_out += 'SC_kelas rawat#NMF#' + search_get_text('SC_sc_field_3') + '@NMF@';
  str_out += 'id_ac_kelas rawat#NMF#' + search_get_text('id_ac_sc_field_3') + '@NMF@';
   ...
   $("#id_ac_sc_field_3").autocomplete({
     ...
     $.ajax({
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_sc_field_3",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_sc_field_3").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     focus: function (event, ui) {
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div class="scFilterHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFilterHeaderFont" style="float: left; text-transform: uppercase;">Billing Case Management</div>
...
<?php
   ...
   function monta_form()
   {
      global 
             ...
             $sc_field_2_cond, $sc_field_2,
             $sc_field_3_cond, $sc_field_3, $sc_field_3_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          $sc_field_0 = $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['campos_busca']['sc_field_0']; 
          $sc_field_0_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['campos_busca']['sc_field_0_cond']; 
          $sc_field_1 = $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['campos_busca']['sc_field_1']; 
          $sc_field_1_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['campos_busca']['sc_field_1_cond']; 
          $sc_field_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['campos_busca']['sc_field_2']; 
          $sc_field_2_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['campos_busca']['sc_field_2_cond']; 
          $sc_field_3 = $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['campos_busca']['sc_field_3']; 
          $sc_field_3_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['campos_busca']['sc_field_3_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['campos_busca']['NM_operador']; 
      } 
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_sc_field_0_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['sc_field_0'])) ? $this->New_label['sc_field_0'] : "No RM"; ?></TD>
...
?>
<INPUT  type="text" id="SC_sc_field_0" name="sc_field_0" value="<?php echo NM_encode_input($sc_field_0) ?>"  size=6 alt="{datatype: 'text', maxLength: 6, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_sc_field_0" name="sc_field_0_autocomp" size="6"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 6, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_sc_field_1_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['sc_field_1'])) ? $this->New_label['sc_field_1'] : "No BPJS"; ?></TD>
...
?>
<INPUT  type="text" id="SC_sc_field_1" name="sc_field_1" value="<?php echo NM_encode_input($sc_field_1) ?>"  size=30 alt="{datatype: 'text', maxLength: 30, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_sc_field_1" name="sc_field_1_autocomp" size="30"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 30, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_sc_field_2_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['sc_field_2'])) ? $this->New_label['sc_field_2'] : "Nama Pasien"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_sc_field_2_cond" name="sc_field_2_cond" onChange="nm_campos_between(document.getElementById('id_vis_sc_field_2'), this, 'sc_field_2')">
       <OPTION value="qp" <?php if ("qp" == $sc_field_2_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $sc_field_2_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $sc_field_2_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $sc_field_2_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
...
?>
<INPUT  type="text" id="SC_sc_field_2" name="sc_field_2" value="<?php echo NM_encode_input($sc_field_2) ?>"  size=50 alt="{datatype: 'text', maxLength: 52, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
      ...
      <TD id='SC_sc_field_3_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['sc_field_3'])) ? $this->New_label['sc_field_3'] : "Kelas Rawat"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_sc_field_3_cond" name="sc_field_3_cond" onChange="nm_campos_between(document.getElementById('id_vis_sc_field_3'), this, 'sc_field_3')">
       <OPTION value="qp" <?php if ("qp" == $sc_field_3_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $sc_field_3_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $sc_field_3_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $sc_field_3_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
...
<?php
      ...
      {
          $sAutocompValue = $sc_field_3;
      }
?>
<INPUT  type="text" id="SC_sc_field_3" name="sc_field_3" value="<?php echo NM_encode_input($sc_field_3) ?>"  size=15 alt="{datatype: 'text', maxLength: 15, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_sc_field_3" name="sc_field_3_autocomp" size="15"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 15, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if ($_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
<?php
   if (is_file("billing_casemanager_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['billing_casemanager']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['billing_casemanager']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['orig_pesq'] == "grid")
   {
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['where_orig'] = "";
      }
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          $this->comando = "";
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['where_orig'];
      }
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_sc_field_2'] = 'text';
      $tp_fields['SC_sc_field_3_cond'] = 'cond';
      $tp_fields['SC_sc_field_3'] = 'text_aut';
      $tp_fields['id_ac_sc_field_3'] = 'text_aut';
      $tp_fields['SC_NM_operador'] = 'text';
      $tb_fields_esp['SC_no. rm_cond'] = 'SC_sc_field_0_cond';
      $tb_fields_esp['SC_no. rm'] = 'SC_sc_field_0';
      $tb_fields_esp['text_aut'] = 'id_ac_no. rm';
      $tb_fields_esp['id_ac_no. rm'] = 'id_ac_sc_field_0';
      $tb_fields_esp['SC_no. bpjs_cond'] = 'SC_sc_field_1_cond';
      $tb_fields_esp['SC_no. bpjs'] = 'SC_sc_field_1';
      $tb_fields_esp['text_aut'] = 'id_ac_no. bpjs';
      $tb_fields_esp['id_ac_no. bpjs'] = 'id_ac_sc_field_1';
      $tb_fields_esp['SC_nama pasien_cond'] = 'SC_sc_field_2_cond';
      $tb_fields_esp['SC_nama pasien'] = 'SC_sc_field_2';
      $tb_fields_esp['SC_kelas rawat_cond'] = 'SC_sc_field_3_cond';
      $tb_fields_esp['SC_kelas rawat'] = 'SC_sc_field_3';
      $tb_fields_esp['text_aut'] = 'id_ac_kelas rawat';
      $tb_fields_esp['id_ac_kelas rawat'] = 'id_ac_sc_field_3';
      if (is_file($NM_patch))
      {
          $SC_V8    = false;
   ...
   function trata_campos()
   {
      global $sc_field_0_cond, $sc_field_0, $sc_field_0_autocomp,
             $sc_field_1_cond, $sc_field_1, $sc_field_1_autocomp,
             $sc_field_2_cond, $sc_field_2,
             $sc_field_3_cond, $sc_field_3, $sc_field_3_autocomp, $nmgp_tab_label;
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['campos_busca'] as $Cmps => $Vals)
          {
              $$Cmps = $Vals;
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['grid_pesq'] = array();
      ...
      if (!empty($sc_field_3_autocomp) && empty($sc_field_3))
      {
          $sc_field_3 = $sc_field_3_autocomp;
      }
      ...
      if (!isset($sc_field_2_input_2) || $sc_field_2_input_2 == "")
      {
          $sc_field_2_input_2 = $sc_field_2;
      }
      $sc_field_3_cond_salva = $sc_field_3_cond; 
      if (!isset($sc_field_3_input_2) || $sc_field_3_input_2 == "")
      {
          $sc_field_3_input_2 = $sc_field_3;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['Grid_search']  = array(); 
      $I_Grid = 0;
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['campos_busca']['sc_field_0'] = $sc_field_0; 
      if (is_array($sc_field_0) && !empty($sc_field_0))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['Grid_search'][$I_Grid]['val'][0] = $sc_field_0;
      }
      ...
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['Grid_search'][$I_Grid]['val'][0][0] = $sc_field_0;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['campos_busca']['sc_field_0_cond'] = $sc_field_0_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['Grid_search'][$I_Grid]['cmp'] = "sc_field_0"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['Grid_search'][$I_Grid]['opc'] = $sc_field_0_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['grid_pesq']['sc_field_0'] = $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['campos_busca']['sc_field_1'] = $sc_field_1; 
      if (is_array($sc_field_1) && !empty($sc_field_1))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['Grid_search'][$I_Grid]['val'][0] = $sc_field_1;
      }
      ...
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['Grid_search'][$I_Grid]['val'][0][0] = $sc_field_1;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['campos_busca']['sc_field_1_cond'] = $sc_field_1_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['Grid_search'][$I_Grid]['cmp'] = "sc_field_1"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['Grid_search'][$I_Grid]['opc'] = $sc_field_1_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['grid_pesq']['sc_field_1'] = $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['campos_busca']['sc_field_2'] = $sc_field_2; 
      if (is_array($sc_field_2) && !empty($sc_field_2))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['Grid_search'][$I_Grid]['val'][0] = $sc_field_2;
      }
      elseif ($sc_field_2_cond_salva == "nu" || $sc_field_2_cond_salva == "nn" || $sc_field_2_cond_salva == "ep" || $sc_field_2_cond_salva == "ne" || !empty($sc_field_2))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['Grid_search'][$I_Grid]['val'][0][0] = $sc_field_2;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['campos_busca']['sc_field_2_cond'] = $sc_field_2_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['Grid_search'][$I_Grid]['cmp'] = "sc_field_2"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['Grid_search'][$I_Grid]['opc'] = $sc_field_2_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['grid_pesq']['sc_field_2'] = $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['campos_busca']['sc_field_3'] = $sc_field_3; 
      if (is_array($sc_field_3) && !empty($sc_field_3))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['Grid_search'][$I_Grid]['val'][0] = $sc_field_3;
      }
      elseif ($sc_field_3_cond_salva == "nu" || $sc_field_3_cond_salva == "nn" || $sc_field_3_cond_salva == "ep" || $sc_field_3_cond_salva == "ne" || !empty($sc_field_3))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['Grid_search'][$I_Grid]['val'][0][0] = $sc_field_3;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['campos_busca']['sc_field_3_cond'] = $sc_field_3_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['Grid_search'][$I_Grid]['cmp'] = "sc_field_3"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['Grid_search'][$I_Grid]['opc'] = $sc_field_3_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['grid_pesq']['sc_field_3'] = $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      ...
      $Conteudo = $sc_field_2;
      $this->cmp_formatado['sc_field_2'] = $Conteudo;
      $sc_field_3_look = substr($this->Db->qstr($sc_field_3), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct a.kelas from " . $this->Ini->nm_tabela . " where a.pembayaran = 'BPJS' and a.kelas = '$sc_field_3_look' order by a.kelas"; 
      unset($cmp1,$cmp2);
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['sc_field_3'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['sc_field_3'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['sc_field_3'] = $sc_field_3;
      }
      ...
      {
         $this->monta_condicao("a.custCode", $sc_field_0_cond, $sc_field_0, "", "sc_field_0");
      }
      ...
      {
         $this->monta_condicao("a.idProvider", $sc_field_1_cond, $sc_field_1, "", "sc_field_1");
      }

      //----- $sc_field_2
      $this->Date_part = false;
      if (isset($sc_field_2) || $sc_field_2_cond == "nu" || $sc_field_2_cond == "nn" || $sc_field_2_cond == "ep" || $sc_field_2_cond == "ne")
      {
         $this->monta_condicao("concat( b.NAME,', ',b.salut )", $sc_field_2_cond, $sc_field_2, "", "sc_field_2");
      }

      //----- $sc_field_3
      $this->Date_part = false;
      if (isset($sc_field_3) || $sc_field_3_cond == "nu" || $sc_field_3_cond == "nn" || $sc_field_3_cond == "ep" || $sc_field_3_cond == "ne")
      {
         $this->monta_condicao("a.kelas", $sc_field_3_cond, $sc_field_3, "", "sc_field_3");
      }
   }
   ...
   function finaliza_resultado_ajax()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['where_pesq'] = $this->comando;
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['where_pesq_fast'])) 
       {
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['where_pesq'])) 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['where_pesq_fast'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['where_pesq'] = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['where_pesq_fast'] . ")";
           }
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['cond_dyn_search'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['billing_casemanager']['cond_pesq'] .= $this->NM_operador;
