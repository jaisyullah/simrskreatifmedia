...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "a.tglMasuk";$Nm_datas[] = "a_tglMasuk";$Nm_numeric[] = "if
	(
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_sc_field_2_cond" name="sc_field_2_cond" onChange="nm_campos_between(document.getElementById('id_vis_sc_field_2'), this, 'sc_field_2')">
      ...
      <br><span id="id_hide_sc_field_2"  <?php echo $str_hide_sc_field_2?>><INPUT  type="text" id="SC_sc_field_2" name="sc_field_2" value="<?php echo NM_encode_input($sc_field_2) ?>"  size=50 alt="{datatype: 'text', maxLength: 52, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_sc_field_3_cond" name="sc_field_3_cond" onChange="nm_campos_between(document.getElementById('id_vis_sc_field_3'), this, 'sc_field_3')">
      ...
      <br><span id="id_hide_sc_field_3"  <?php echo $str_hide_sc_field_3?>><?php
      if ($sc_field_3 != "")
      {
      $sc_field_3_look = substr($this->Db->qstr($sc_field_3), 1, -1); 
      $nmgp_def_dados = array(); 
