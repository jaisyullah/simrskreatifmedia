...
$old_error_handler = set_error_handler("form_tbradiologirate_scriptcase_error_handler");

function form_tbradiologirate_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['form_tbradiologirate']['contr_erro']) && $_SESSION['scriptcase']['form_tbradiologirate']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_form_tbradiologirate->contr_form_tbradiologirate->Apl_com_erro = true;
            if ($inicial_form_tbradiologirate->contr_form_tbradiologirate->NM_ajax_flag)
            {
                $inicial_form_tbradiologirate->contr_form_tbradiologirate->NM_ajax_info['errList']['geral_form_tbradiologirate'][] = $msg;
                return;
            }
            form_tbradiologirate_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function form_tbradiologirate_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['form_tbradiologirate'])  && '' != $_SESSION['scriptcase']['error_icon']['form_tbradiologirate'])  ? $_SESSION['scriptcase']['error_icon']['form_tbradiologirate']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['form_tbradiologirate']) && '' != $_SESSION['scriptcase']['error_span_title']['form_tbradiologirate']) ? $_SESSION['scriptcase']['error_span_title']['form_tbradiologirate'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['form_tbradiologirate']) && '' != $_SESSION['scriptcase']['error_icon_title']['form_tbradiologirate']) ? $_SESSION['scriptcase']['error_icon_title']['form_tbradiologirate'] : '';
?>
...
<?php
    ...
    $_SESSION['scriptcase']['form_tbradiologirate']['error_buffer'] .= ob_get_flush();
}
