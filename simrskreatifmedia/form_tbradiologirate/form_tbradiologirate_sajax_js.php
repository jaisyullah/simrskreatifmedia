  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbradiologirate" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbradiologirate_form();
	}

  // ---------- Validate kelas_
  function do_ajax_form_tbradiologirate_validate_kelas_(iNumLinha)
  {
    var nomeCampo_kelas_ = "kelas_" + iNumLinha;
    var var_kelas_ = scAjaxGetFieldText(nomeCampo_kelas_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbradiologirate_validate_kelas_(var_kelas_, iNumLinha, var_script_case_init, do_ajax_form_tbradiologirate_validate_kelas__cb);
  } // do_ajax_form_tbradiologirate_validate_kelas_

  function do_ajax_form_tbradiologirate_validate_kelas__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbradiologirate_validate_kelas__cb

  // ---------- Validate ratecon_
  function do_ajax_form_tbradiologirate_validate_ratecon_(iNumLinha)
  {
    var nomeCampo_ratecon_ = "ratecon_" + iNumLinha;
    var var_ratecon_ = scAjaxGetFieldText(nomeCampo_ratecon_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbradiologirate_validate_ratecon_(var_ratecon_, iNumLinha, var_script_case_init, do_ajax_form_tbradiologirate_validate_ratecon__cb);
  } // do_ajax_form_tbradiologirate_validate_ratecon_

  function do_ajax_form_tbradiologirate_validate_ratecon__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "ratecon_" + iLineNumber;
    }
    else
    {
      sFieldValid = "ratecon_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "ratecon_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "ratecon_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbradiologirate_validate_ratecon__cb

  // ---------- Validate ratenoncon_
  function do_ajax_form_tbradiologirate_validate_ratenoncon_(iNumLinha)
  {
    var nomeCampo_ratenoncon_ = "ratenoncon_" + iNumLinha;
    var var_ratenoncon_ = scAjaxGetFieldText(nomeCampo_ratenoncon_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbradiologirate_validate_ratenoncon_(var_ratenoncon_, iNumLinha, var_script_case_init, do_ajax_form_tbradiologirate_validate_ratenoncon__cb);
  } // do_ajax_form_tbradiologirate_validate_ratenoncon_

  function do_ajax_form_tbradiologirate_validate_ratenoncon__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "ratenoncon_" + iLineNumber;
    }
    else
    {
      sFieldValid = "ratenoncon_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "ratenoncon_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "ratenoncon_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbradiologirate_validate_ratenoncon__cb

  // ---------- Validate share_
  function do_ajax_form_tbradiologirate_validate_share_(iNumLinha)
  {
    var nomeCampo_share_ = "share_" + iNumLinha;
    var var_share_ = scAjaxGetFieldText(nomeCampo_share_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbradiologirate_validate_share_(var_share_, iNumLinha, var_script_case_init, do_ajax_form_tbradiologirate_validate_share__cb);
  } // do_ajax_form_tbradiologirate_validate_share_

  function do_ajax_form_tbradiologirate_validate_share__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "share_" + iLineNumber;
    }
    else
    {
      sFieldValid = "share_";
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "share_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "share_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbradiologirate_validate_share__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_tbradiologirate_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_tbradiologirate_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tbradiologirate_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_tbradiologirate_add_new_line_cb);
  } // do_ajax_form_tbradiologirate_add_new_line

  function do_ajax_form_tbradiologirate_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_tbradiologirate_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_tbradiologirate_backup_line(iNumLinha)
  {
    var var_radcode_ = scAjaxGetFieldText("radcode_" + iNumLinha);
    var var_kelas_ = scAjaxGetFieldText("kelas_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbradiologirate_backup_line(var_radcode_, var_kelas_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_tbradiologirate_backup_line_cb);
  } // do_ajax_form_tbradiologirate_backup_line

  function do_ajax_form_tbradiologirate_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_tbradiologirate_backup_line_cb

  function do_ajax_form_tbradiologirate_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_tbradiologirate_cancel_insert

  function do_ajax_form_tbradiologirate_cancel_update(iSeqVert)
  {
    do_ajax_form_tbradiologirate_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_tbradiologirate_cancel_update

  function do_ajax_form_tbradiologirate_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_tbradiologirate_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_tbradiologirate_table_refresh()
  {
    var var_radcode_ = document.F2.radcode_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_tbradiologirate_table_refresh(var_radcode_, var_kelas_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbradiologirate_table_refresh_cb);
  } //  do_ajax_form_tbradiologirate_table_refresh

  function do_ajax_form_tbradiologirate_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.radcode_.value = scAjaxGetKeyValue("radcode_");
    ...
    scAjaxAlert(do_ajax_form_tbradiologirate_table_refresh_cb_after_alert);
  } // do_ajax_form_tbradiologirate_table_refresh_cb
  function do_ajax_form_tbradiologirate_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_tbradiologirate_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_tbradiologirate_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_tbradiologirate_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_kelas_ = scAjaxGetFieldText("kelas_" + iNumLinha);
    var var_ratecon_ = scAjaxGetFieldText("ratecon_" + iNumLinha);
    var var_ratenoncon_ = scAjaxGetFieldText("ratenoncon_" + iNumLinha);
    var var_share_ = scAjaxGetFieldText("share_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_tbradiologirate_submit_form(var_kelas_, var_ratecon_, var_ratenoncon_, var_share_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbradiologirate_submit_form_cb);
  } // do_ajax_form_tbradiologirate_submit_form

  function do_ajax_form_tbradiologirate_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("ratecon_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("ratenoncon_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("share_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_tbradiologirate_submit_form_cb_after_alert);
  } // do_ajax_form_tbradiologirate_submit_form_cb
  function do_ajax_form_tbradiologirate_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbradiologirate_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tbradiologirate_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_tbradiologirate_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("ratecon_" + iNavForm);
      scAjaxHideErrorDisplay("ratenoncon_" + iNavForm);
      scAjaxHideErrorDisplay("share_" + iNavForm);
    }
    var var_radcode_ = document.F2.radcode_.value;
    var var_kelas_ = document.F2.kelas_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tbradiologirate_navigate_form(var_radcode_, var_kelas_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbradiologirate_navigate_form_cb);
  } // do_ajax_form_tbradiologirate_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbradiologirate']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbradiologirate_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.radcode_.value = scAjaxGetKeyValue("radcode_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbradiologirate_navigate_form_cb_after_alert);
  } // do_ajax_form_tbradiologirate_navigate_form_cb
  function do_ajax_form_tbradiologirate_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_tbradiologirate_navigate_form_cb_after_alert
  function sc_hide_form_tbradiologirate_form()
  {
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "ratecon_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "ratenoncon_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "share_" + iNumLinha;
    iTotCampos++;
    ...
    ajax_error_list["ratecon_" + iNumLinha] = {"label": "Harga Contrast<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["ratenoncon_" + iNumLinha] = {"label": "Harga Non-Contrast<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["share_" + iNumLinha] = {"label": "Share<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["kelas_"][iNumLinha] = "kelas_" + iNumLinha;
    ajax_field_mult["ratecon_"][iNumLinha] = "ratecon_" + iNumLinha;
    ajax_field_mult["ratenoncon_"][iNumLinha] = "ratenoncon_" + iNumLinha;
    ajax_field_mult["share_"][iNumLinha] = "share_" + iNumLinha;
    ajax_field_id["kelas_" + iNumLinha] = new Array("hidden_field_label_kelas_", "hidden_field_data_kelas_" + iNumLinha);
    ajax_field_id["ratecon_" + iNumLinha] = new Array("hidden_field_label_ratecon_", "hidden_field_data_ratecon_" + iNumLinha);
    ajax_field_id["ratenoncon_" + iNumLinha] = new Array("hidden_field_label_ratenoncon_", "hidden_field_data_ratenoncon_" + iNumLinha);
    ajax_field_id["share_" + iNumLinha] = new Array("hidden_field_label_share_", "hidden_field_data_share_" + iNumLinha);
    ajax_error_count["kelas_" + iNumLinha] = "off";
    ajax_error_count["ratecon_" + iNumLinha] = "off";
    ajax_error_count["ratenoncon_" + iNumLinha] = "off";
    ajax_error_count["share_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["kelas_" + iNumLinha] = "on";
    ajax_read_only["ratecon_" + iNumLinha] = "off";
    ajax_read_only["ratenoncon_" + iNumLinha] = "off";
    ajax_read_only["share_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["kelas_" + iNumLinha] = "on";
    ajax_read_only["ratecon_" + iNumLinha] = "on";
    ajax_read_only["ratenoncon_" + iNumLinha] = "on";
    ajax_read_only["share_" + iNumLinha] = "on";
<?php
}
?>
  }
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["ratecon_" + iNumLinha] = null;
    ajax_error_list["ratenoncon_" + iNumLinha] = null;
    ajax_error_list["share_" + iNumLinha] = null;
  }
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["ratecon_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["ratecon_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["ratecon_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["ratecon_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["ratecon_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["ratenoncon_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["ratenoncon_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["ratenoncon_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["ratenoncon_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["ratenoncon_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["share_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["share_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["share_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["share_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["share_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['ratecon_'])) ? $this->nmgp_cmp_readonly['ratecon_'] : 'off';
?>
    scAjaxFieldRead("ratecon_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['ratenoncon_'])) ? $this->nmgp_cmp_readonly['ratenoncon_'] : 'off';
?>
    scAjaxFieldRead("ratenoncon_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['share_'])) ? $this->nmgp_cmp_readonly['share_'] : 'off';
?>
    scAjaxFieldRead("share_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("kelas_" + iSeq, "on");
    scAjaxFieldRead("ratecon_" + iSeq, "on");
    scAjaxFieldRead("ratenoncon_" + iSeq, "on");
    scAjaxFieldRead("share_" + iSeq, "on");
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["kelas_" + iRow] || "on" == ajax_error_count["ratecon_" + iRow] || "on" == ajax_error_count["ratenoncon_" + iRow] || "on" == ajax_error_count["share_" + iRow]))
    {
      ...
      $("#hidden_field_data_ratecon_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_ratenoncon_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_share_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["kelas_" + iRow] && "off" == ajax_error_count["ratecon_" + iRow] && "off" == ajax_error_count["ratenoncon_" + iRow] && "off" == ajax_error_count["share_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["kelas_" + iRow] = "off";
        ajax_error_count["ratecon_" + iRow] = "off";
        ajax_error_count["ratenoncon_" + iRow] = "off";
        ajax_error_count["share_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_ratecon_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_ratenoncon_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_share_" + iRow).removeClass("scFormErrorLine");
    }
  }
