...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_jurnal_master"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_jurnal_master"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_jurnal_master'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_jurnal_master']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_jurnal_master']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_jurnal_master']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_jurnal_master']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_jurnal_master']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_jurnal_master</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_jurnal_master']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_jurnal_master']['embutida_filho'] as $ind => $sc_init)
          {
