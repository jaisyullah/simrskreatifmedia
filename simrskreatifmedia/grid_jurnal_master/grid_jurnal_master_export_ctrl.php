<?php
@session_start() ;
$_SESSION['scriptcase']['grid_jurnal_master']['sc_process_barr'] = true;
require_once('../grid_jurnal_master/index.php');
unset($_SESSION['scriptcase']['grid_jurnal_master']['sc_process_barr']);
$ExportCtrl = new grid_jurnal_master_export_control;
$ExportCtrl->Export_barr();

class grid_jurnal_master_export_control
{
