...
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_pocode" name="pocode_autocomp" size="11"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 11, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_pbf_cond" name="pbf_cond" onChange="nm_campos_between(document.getElementById('id_vis_pbf'), this, 'pbf')">
      ...
      <br><span id="id_hide_pbf"  <?php echo $str_hide_pbf?>><?php
      if ($pbf != "")
      {
      $pbf_look = substr($this->Db->qstr($pbf), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_non_pbf_cond" name="non_pbf_cond" onChange="nm_campos_between(document.getElementById('id_vis_non_pbf'), this, 'non_pbf')">
      ...
      <br><span id="id_hide_non_pbf"  <?php echo $str_hide_non_pbf?>><?php
      if ($non_pbf != "")
      {
      $non_pbf_look = substr($this->Db->qstr($non_pbf), 1, -1); 
      $nmgp_def_dados = array(); 
...
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_non_pbf" name="non_pbf_autocomp" size="15"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 15, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
