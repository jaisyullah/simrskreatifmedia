<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tbro']['sc_process_barr'] = true;
require_once('../grid_tbro/index.php');
unset($_SESSION['scriptcase']['grid_tbro']['sc_process_barr']);
$ExportCtrl = new grid_tbro_export_control;
$ExportCtrl->Export_barr();

class grid_tbro_export_control
{
