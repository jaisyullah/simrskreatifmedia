  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_map_transaksi_jurnal" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_map_transaksi_jurnal_form();
	}

  // ---------- Validate id_
  function do_ajax_form_map_transaksi_jurnal_validate_id_(iNumLinha)
  {
    var nomeCampo_id_ = "id_" + iNumLinha;
    var var_id_ = scAjaxGetFieldHidden(nomeCampo_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_map_transaksi_jurnal_validate_id_(var_id_, iNumLinha, var_script_case_init, do_ajax_form_map_transaksi_jurnal_validate_id__cb);
  } // do_ajax_form_map_transaksi_jurnal_validate_id_

  function do_ajax_form_map_transaksi_jurnal_validate_id__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_map_transaksi_jurnal_validate_id__cb

  // ---------- Validate id_jns_transaksi_
  function do_ajax_form_map_transaksi_jurnal_validate_id_jns_transaksi_(iNumLinha)
  {
    var nomeCampo_id_jns_transaksi_ = "id_jns_transaksi_" + iNumLinha;
    var var_id_jns_transaksi_ = scAjaxGetFieldSelect(nomeCampo_id_jns_transaksi_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_map_transaksi_jurnal_validate_id_jns_transaksi_(var_id_jns_transaksi_, iNumLinha, var_script_case_init, do_ajax_form_map_transaksi_jurnal_validate_id_jns_transaksi__cb);
  } // do_ajax_form_map_transaksi_jurnal_validate_id_jns_transaksi_

  function do_ajax_form_map_transaksi_jurnal_validate_id_jns_transaksi__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "id_jns_transaksi_" + iLineNumber;
    }
    else
    {
      sFieldValid = "id_jns_transaksi_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "id_jns_transaksi_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "id_jns_transaksi_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_map_transaksi_jurnal_validate_id_jns_transaksi__cb

  // ---------- Validate id_akun_
  function do_ajax_form_map_transaksi_jurnal_validate_id_akun_(iNumLinha)
  {
    var nomeCampo_id_akun_ = "id_akun_" + iNumLinha;
    var var_id_akun_ = scAjaxGetFieldSelect(nomeCampo_id_akun_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_map_transaksi_jurnal_validate_id_akun_(var_id_akun_, iNumLinha, var_script_case_init, do_ajax_form_map_transaksi_jurnal_validate_id_akun__cb);
  } // do_ajax_form_map_transaksi_jurnal_validate_id_akun_

  function do_ajax_form_map_transaksi_jurnal_validate_id_akun__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "id_akun_" + iLineNumber;
    }
    else
    {
      sFieldValid = "id_akun_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "id_akun_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "id_akun_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_map_transaksi_jurnal_validate_id_akun__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_map_transaksi_jurnal_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_map_transaksi_jurnal_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_map_transaksi_jurnal_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_map_transaksi_jurnal_add_new_line_cb);
  } // do_ajax_form_map_transaksi_jurnal_add_new_line

  function do_ajax_form_map_transaksi_jurnal_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_map_transaksi_jurnal_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_map_transaksi_jurnal_backup_line(iNumLinha)
  {
    var var_id_ = scAjaxGetFieldHidden("id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_map_transaksi_jurnal_backup_line(var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_map_transaksi_jurnal_backup_line_cb);
  } // do_ajax_form_map_transaksi_jurnal_backup_line

  function do_ajax_form_map_transaksi_jurnal_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_map_transaksi_jurnal_backup_line_cb

  function do_ajax_form_map_transaksi_jurnal_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_map_transaksi_jurnal_cancel_insert

  function do_ajax_form_map_transaksi_jurnal_cancel_update(iSeqVert)
  {
    do_ajax_form_map_transaksi_jurnal_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_map_transaksi_jurnal_cancel_update

  function do_ajax_form_map_transaksi_jurnal_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_map_transaksi_jurnal_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_map_transaksi_jurnal_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_map_transaksi_jurnal_table_refresh(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_map_transaksi_jurnal_table_refresh_cb);
  } //  do_ajax_form_map_transaksi_jurnal_table_refresh

  function do_ajax_form_map_transaksi_jurnal_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_map_transaksi_jurnal_table_refresh_cb_after_alert);
  } // do_ajax_form_map_transaksi_jurnal_table_refresh_cb
  function do_ajax_form_map_transaksi_jurnal_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_map_transaksi_jurnal_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_map_transaksi_jurnal_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_map_transaksi_jurnal_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_id_ = scAjaxGetFieldHidden("id_" + iNumLinha);
    var var_id_jns_transaksi_ = scAjaxGetFieldSelect("id_jns_transaksi_" + iNumLinha);
    var var_id_akun_ = scAjaxGetFieldSelect("id_akun_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_map_transaksi_jurnal_submit_form(var_id_, var_id_jns_transaksi_, var_id_akun_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_map_transaksi_jurnal_submit_form_cb);
  } // do_ajax_form_map_transaksi_jurnal_submit_form

  function do_ajax_form_map_transaksi_jurnal_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("id_jns_transaksi_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("id_akun_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_map_transaksi_jurnal_submit_form_cb_after_alert);
  } // do_ajax_form_map_transaksi_jurnal_submit_form_cb
  function do_ajax_form_map_transaksi_jurnal_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_map_transaksi_jurnal_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_map_transaksi_jurnal_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_map_transaksi_jurnal_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("id_jns_transaksi_" + iNavForm);
      scAjaxHideErrorDisplay("id_akun_" + iNavForm);
    }
    var var_id_ = document.F2.id_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_map_transaksi_jurnal_navigate_form(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_map_transaksi_jurnal_navigate_form_cb);
  } // do_ajax_form_map_transaksi_jurnal_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_map_transaksi_jurnal']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_map_transaksi_jurnal_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_map_transaksi_jurnal_navigate_form_cb_after_alert);
  } // do_ajax_form_map_transaksi_jurnal_navigate_form_cb
  function do_ajax_form_map_transaksi_jurnal_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_map_transaksi_jurnal_navigate_form_cb_after_alert
  function sc_hide_form_map_transaksi_jurnal_form()
  {
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "id_jns_transaksi_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "id_akun_" + iNumLinha;
    iTotCampos++;
    ...
    ajax_error_list["id_jns_transaksi_" + iNumLinha] = {"label": "Jenis Transaksi<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["id_akun_" + iNumLinha] = {"label": "Akun<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["id_"][iNumLinha] = "id_" + iNumLinha;
    ajax_field_mult["id_jns_transaksi_"][iNumLinha] = "id_jns_transaksi_" + iNumLinha;
    ajax_field_mult["id_akun_"][iNumLinha] = "id_akun_" + iNumLinha;
    ajax_field_id["id_" + iNumLinha] = new Array("hidden_field_label_id_", "hidden_field_data_id_" + iNumLinha);
    ajax_field_id["id_jns_transaksi_" + iNumLinha] = new Array("hidden_field_label_id_jns_transaksi_", "hidden_field_data_id_jns_transaksi_" + iNumLinha);
    ajax_field_id["id_akun_" + iNumLinha] = new Array("hidden_field_label_id_akun_", "hidden_field_data_id_akun_" + iNumLinha);
    ajax_error_count["id_" + iNumLinha] = "off";
    ajax_error_count["id_jns_transaksi_" + iNumLinha] = "off";
    ajax_error_count["id_akun_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["id_" + iNumLinha] = "on";
    ajax_read_only["id_jns_transaksi_" + iNumLinha] = "off";
    ajax_read_only["id_akun_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["id_" + iNumLinha] = "on";
    ajax_read_only["id_jns_transaksi_" + iNumLinha] = "on";
    ajax_read_only["id_akun_" + iNumLinha] = "on";
<?php
}
?>
  }
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["id_jns_transaksi_" + iNumLinha] = null;
    ajax_error_list["id_akun_" + iNumLinha] = null;
  }
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["id_jns_transaksi_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["id_jns_transaksi_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["id_jns_transaksi_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["id_jns_transaksi_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["id_jns_transaksi_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["id_akun_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["id_akun_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["id_akun_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["id_akun_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["id_akun_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['id_jns_transaksi_'])) ? $this->nmgp_cmp_readonly['id_jns_transaksi_'] : 'off';
?>
    scAjaxFieldRead("id_jns_transaksi_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['id_akun_'])) ? $this->nmgp_cmp_readonly['id_akun_'] : 'off';
?>
    scAjaxFieldRead("id_akun_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("id_" + iSeq, "on");
    scAjaxFieldRead("id_jns_transaksi_" + iSeq, "on");
    scAjaxFieldRead("id_akun_" + iSeq, "on");
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["id_" + iRow] || "on" == ajax_error_count["id_jns_transaksi_" + iRow] || "on" == ajax_error_count["id_akun_" + iRow]))
    {
      ...
      $("#hidden_field_data_id_jns_transaksi_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_id_akun_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["id_" + iRow] && "off" == ajax_error_count["id_jns_transaksi_" + iRow] && "off" == ajax_error_count["id_akun_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["id_" + iRow] = "off";
        ajax_error_count["id_jns_transaksi_" + iRow] = "off";
        ajax_error_count["id_akun_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_id_jns_transaksi_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_id_akun_" + iRow).removeClass("scFormErrorLine");
    }
  }
