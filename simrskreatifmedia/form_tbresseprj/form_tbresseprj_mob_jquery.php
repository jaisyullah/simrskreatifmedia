...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_tglkeluar_hora' + iSeqRow).bind('blur', function() { sc_form_tbresseprj_tglkeluar_onblur(this, iSeqRow) })
                                            .bind('focus', function() { sc_form_tbresseprj_tglkeluar_onfocus(this, iSeqRow) });
...
function displayChange_field_pemeriksaan(row, status) {
	if ("on" == status && typeof $("#nmsc_iframe_liga_form_tbpemeriksaanrawatjalan_mob")[0].contentWindow.scRecreateSelect2 === "function") {
		$("#nmsc_iframe_liga_form_tbpemeriksaanrawatjalan_mob")[0].contentWindow.scRecreateSelect2();
	}
}

function displayChange_field_diagnosa(row, status) {
	if ("on" == status && typeof $("#nmsc_iframe_liga_form_tbdiagnosarawatjalan_mob")[0].contentWindow.scRecreateSelect2 === "function") {
		$("#nmsc_iframe_liga_form_tbdiagnosarawatjalan_mob")[0].contentWindow.scRecreateSelect2();
	}
}
...
function displayChange_field_resep(row, status) {
	if ("on" == status && typeof $("#nmsc_iframe_liga_form_tbreseprjdetail_mob")[0].contentWindow.scRecreateSelect2 === "function") {
		$("#nmsc_iframe_liga_form_tbreseprjdetail_mob")[0].contentWindow.scRecreateSelect2();
	}
}

function displayChange_field_penunjang(row, status) {
	if ("on" == status && typeof $("#nmsc_iframe_liga_form_tbpenunjangrawatjalan_mob")[0].contentWindow.scRecreateSelect2 === "function") {
		$("#nmsc_iframe_liga_form_tbpenunjangrawatjalan_mob")[0].contentWindow.scRecreateSelect2();
	}
}
...
function scHidePage(pageNo) {
	$("#id_form_tbresseprj_mob_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_tglkeluar" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_tbresseprj_mob_validate_tglkeluar(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
