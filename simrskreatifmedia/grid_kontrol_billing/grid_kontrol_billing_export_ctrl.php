<?php
@session_start() ;
$_SESSION['scriptcase']['grid_kontrol_billing']['sc_process_barr'] = true;
require_once('../grid_kontrol_billing/index.php');
unset($_SESSION['scriptcase']['grid_kontrol_billing']['sc_process_barr']);
$ExportCtrl = new grid_kontrol_billing_export_control;
$ExportCtrl->Export_barr();

class grid_kontrol_billing_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_title'] ?> Billing Kontrol Poli :: Excel</TITLE>
