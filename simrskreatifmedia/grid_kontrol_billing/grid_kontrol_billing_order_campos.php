...
<?php
   ...
   $Ord_Cmp = new grid_kontrol_billing_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_kontrol_billing_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_kontrol_billing']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_kontrol_billing']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["struckno"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_kontrol_billing']['labels']["struckno"])) ? $_SESSION['sc_session'][$sc_init]['grid_kontrol_billing']['labels']["struckno"] : "No Daftar";
   $tab_ger_campos['regdate'] = "on";
   $tab_def_campos['regdate'] = "regDate";
   $tab_labels["regdate"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_kontrol_billing']['labels']["regdate"])) ? $_SESSION['sc_session'][$sc_init]['grid_kontrol_billing']['labels']["regdate"] : "Tgl Daftar";
   $tab_ger_campos['regtime'] = "on";
   $tab_def_campos['regtime'] = "regTime";
   $tab_labels["regtime"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_kontrol_billing']['labels']["regtime"])) ? $_SESSION['sc_session'][$sc_init]['grid_kontrol_billing']['labels']["regtime"] : "Waktu Daftar";
   $tab_ger_campos['custcode'] = "on";
   $tab_def_campos['custcode'] = "custCode";
   $tab_labels["custcode"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_kontrol_billing']['labels']["custcode"])) ? $_SESSION['sc_session'][$sc_init]['grid_kontrol_billing']['labels']["custcode"] : "No RM";
   $tab_ger_campos['poly'] = "on";
   $tab_def_campos['poly'] = "poly";
   $tab_labels["poly"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_kontrol_billing']['labels']["poly"])) ? $_SESSION['sc_session'][$sc_init]['grid_kontrol_billing']['labels']["poly"] : "Poli";
   $tab_ger_campos['doctor'] = "on";
   $tab_def_campos['doctor'] = "doctor";
   $tab_labels["doctor"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_kontrol_billing']['labels']["doctor"])) ? $_SESSION['sc_session'][$sc_init]['grid_kontrol_billing']['labels']["doctor"] : "Dokter";
   $tab_ger_campos['bayar'] = "on";
   $tab_def_campos['bayar'] = "bayar";
   $tab_labels["bayar"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_kontrol_billing']['labels']["bayar"])) ? $_SESSION['sc_session'][$sc_init]['grid_kontrol_billing']['labels']["bayar"] : "Jenis Bayar";
   $tab_ger_campos['status'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['status'] = "sc_def_col_1";
   }
   else
   {
       $tab_def_campos['status'] = "`status`";
   }
   $tab_labels["status"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_kontrol_billing']['labels']["status"])) ? $_SESSION['sc_session'][$sc_init]['grid_kontrol_billing']['labels']["status"] : "Status";
   $tab_ger_campos['billing'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['billing'] = "billing";
   }
   else
   {
       $tab_def_campos['billing'] = "";
   }
   $tab_labels["billing"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_kontrol_billing']['labels']["billing"])) ? $_SESSION['sc_session'][$sc_init]['grid_kontrol_billing']['labels']["billing"] : "Billing";
   ...
   $tab_labels["sc_field_0"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_kontrol_billing']['labels']["sc_field_0"])) ? $_SESSION['sc_session'][$sc_init]['grid_kontrol_billing']['labels']["sc_field_0"] : "Sudah/Belum Lunas";
   $tab_ger_campos['billing'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_kontrol_billing']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_kontrol_billing']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_kontrol_billing']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_kontrol_billing']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_kontrol_billing']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_kontrol_billing']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_kontrol_billing']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_kontrol_billing']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_kontrol_billing']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_kontrol_billing_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_kontrol_billing']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_kontrol_billing']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_kontrol_billing']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_kontrol_billing']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_kontrol_billing']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
