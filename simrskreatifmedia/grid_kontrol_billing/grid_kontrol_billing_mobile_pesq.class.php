...
<HTML>
<HEAD>
 <TITLE> Billing Kontrol Poli</TITLE>
    ...
    <TR>
     <TD colspan="1" height="20" class="scFilterBlockBack">
      <TABLE border="0" cellpadding="0" cellspacing="0" width="100%" height="100%">
       <TR>
        <TD class="scFilterBlockFont css_blk_0"><?php echo $Img_tit_blk_i ?>grid_kontrol_billing<?php echo $Img_tit_blk_f ?></TD>
...
?>
    ...
    <TR>
     <TD colspan="1" height="20" class="scFilterBlockBack">
      <TABLE border="0" cellpadding="0" cellspacing="0" width="100%" height="100%">
       <TR>
        <TD class="scFilterBlockFont css_blk_1"><?php echo $Img_tit_blk_i ?>actor<?php echo $Img_tit_blk_f ?></TD>
...
?>
    ...
    <TR>
     <TD colspan="1" height="20" class="scFilterBlockBack">
      <TABLE border="0" cellpadding="0" cellspacing="0" width="100%" height="100%">
       <TR>
        <TD class="scFilterBlockFont css_blk_2"><?php echo $Img_tit_blk_i ?>provider<?php echo $Img_tit_blk_f ?></TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_bayar"  <?php echo $str_hide_bayar?>><?php
      if ($bayar != "")
      {
      $bayar_look = substr($this->Db->qstr($bayar), 1, -1); 
      $nmgp_def_dados = array(); 
