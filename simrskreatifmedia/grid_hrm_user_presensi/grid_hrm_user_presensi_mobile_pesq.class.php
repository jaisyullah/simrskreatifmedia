...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "id";$Nm_numeric[] = "id_presensi";$Nm_numeric[] = "privilege";$Nm_numeric[] = "id_mesin";$Nm_numeric[] = "id";$Nm_numeric[] = "id_presensi";$Nm_numeric[] = "privilege";$Nm_numeric[] = "id_mesin";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_privilege_cond" name="privilege_cond" onChange="nm_campos_between(document.getElementById('id_vis_privilege'), this, 'privilege')">
      ...
      <br><span id="id_hide_privilege"  <?php echo $str_hide_privilege?>><?php
      if ($privilege != "")
      {
      $privilege_look = substr($this->Db->qstr($privilege), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_id_presensi_cond" name="id_presensi_cond" onChange="nm_campos_between(document.getElementById('id_vis_id_presensi'), this, 'id_presensi')">
      ...
      <br><span id="id_hide_id_presensi"  <?php echo $str_hide_id_presensi?>><?php
      if ($id_presensi != "")
      {
      $id_presensi_look = substr($this->Db->qstr($id_presensi), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_user_name_cond" name="user_name_cond" onChange="nm_campos_between(document.getElementById('id_vis_user_name'), this, 'user_name')">
