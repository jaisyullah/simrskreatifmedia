...
<?php
   ...
   $Ord_Cmp = new grid_hrm_user_presensi_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_hrm_user_presensi_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_hrm_user_presensi']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_hrm_user_presensi']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_hrm_user_presensi']['labels']["id"])) ? $_SESSION['sc_session'][$sc_init]['grid_hrm_user_presensi']['labels']["id"] : "Id";
   $tab_ger_campos['id_presensi'] = "on";
   $tab_def_campos['id_presensi'] = "id_presensi";
   $tab_labels["id_presensi"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_hrm_user_presensi']['labels']["id_presensi"])) ? $_SESSION['sc_session'][$sc_init]['grid_hrm_user_presensi']['labels']["id_presensi"] : "Id Presensi";
   $tab_ger_campos['user_name'] = "on";
   $tab_def_campos['user_name'] = "user_name";
   $tab_labels["user_name"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_hrm_user_presensi']['labels']["user_name"])) ? $_SESSION['sc_session'][$sc_init]['grid_hrm_user_presensi']['labels']["user_name"] : "User Name";
   $tab_ger_campos['privilege'] = "on";
   $tab_def_campos['privilege'] = "privilege";
   $tab_labels["privilege"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_hrm_user_presensi']['labels']["privilege"])) ? $_SESSION['sc_session'][$sc_init]['grid_hrm_user_presensi']['labels']["privilege"] : "Privilege";
   $tab_ger_campos['id_mesin'] = "on";
   $tab_def_campos['id_mesin'] = "id_mesin";
   $tab_labels["id_mesin"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_hrm_user_presensi']['labels']["id_mesin"])) ? $_SESSION['sc_session'][$sc_init]['grid_hrm_user_presensi']['labels']["id_mesin"] : "Id Mesin";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_hrm_user_presensi']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_hrm_user_presensi']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_hrm_user_presensi']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_hrm_user_presensi']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_hrm_user_presensi']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_hrm_user_presensi']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_hrm_user_presensi']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_hrm_user_presensi']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_hrm_user_presensi']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_hrm_user_presensi_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_hrm_user_presensi']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_hrm_user_presensi']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_hrm_user_presensi']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_hrm_user_presensi']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_hrm_user_presensi']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
