  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_obat_ranap_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_obat_ranap_mob_form();
	}

  // ---------- Validate id
  function do_ajax_form_obat_ranap_mob_validate_id()
  {
    var nomeCampo_id = "id";
    var var_id = scAjaxGetFieldHidden(nomeCampo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_obat_ranap_mob_validate_id(var_id, var_script_case_init, do_ajax_form_obat_ranap_mob_validate_id_cb);
  } // do_ajax_form_obat_ranap_mob_validate_id

  function do_ajax_form_obat_ranap_mob_validate_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_obat_ranap_mob_validate_id_cb

  // ---------- Validate trancode
  function do_ajax_form_obat_ranap_mob_validate_trancode()
  {
    var nomeCampo_trancode = "trancode";
    var var_trancode = scAjaxGetFieldText(nomeCampo_trancode);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_obat_ranap_mob_validate_trancode(var_trancode, var_script_case_init, do_ajax_form_obat_ranap_mob_validate_trancode_cb);
  } // do_ajax_form_obat_ranap_mob_validate_trancode

  function do_ajax_form_obat_ranap_mob_validate_trancode_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_obat_ranap_mob_validate_trancode_cb

  // ---------- Validate item
  function do_ajax_form_obat_ranap_mob_validate_item()
  {
    var nomeCampo_item = "item";
    var var_item = scAjaxGetFieldText(nomeCampo_item);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_obat_ranap_mob_validate_item(var_item, var_script_case_init, do_ajax_form_obat_ranap_mob_validate_item_cb);
  } // do_ajax_form_obat_ranap_mob_validate_item

  function do_ajax_form_obat_ranap_mob_validate_item_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "item";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_obat_ranap_mob_validate_item_cb

  // ---------- Validate satuan
  function do_ajax_form_obat_ranap_mob_validate_satuan()
  {
    var nomeCampo_satuan = "satuan";
    var var_satuan = scAjaxGetFieldText(nomeCampo_satuan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_obat_ranap_mob_validate_satuan(var_satuan, var_script_case_init, do_ajax_form_obat_ranap_mob_validate_satuan_cb);
  } // do_ajax_form_obat_ranap_mob_validate_satuan

  function do_ajax_form_obat_ranap_mob_validate_satuan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "satuan";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_obat_ranap_mob_validate_satuan_cb

  // ---------- Validate jumlah
  function do_ajax_form_obat_ranap_mob_validate_jumlah()
  {
    var nomeCampo_jumlah = "jumlah";
    var var_jumlah = scAjaxGetFieldText(nomeCampo_jumlah);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_obat_ranap_mob_validate_jumlah(var_jumlah, var_script_case_init, do_ajax_form_obat_ranap_mob_validate_jumlah_cb);
  } // do_ajax_form_obat_ranap_mob_validate_jumlah

  function do_ajax_form_obat_ranap_mob_validate_jumlah_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "jumlah";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_obat_ranap_mob_validate_jumlah_cb

  // ---------- Validate signa
  function do_ajax_form_obat_ranap_mob_validate_signa()
  {
    var nomeCampo_signa = "signa";
    var var_signa = scAjaxGetFieldText(nomeCampo_signa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_obat_ranap_mob_validate_signa(var_signa, var_script_case_init, do_ajax_form_obat_ranap_mob_validate_signa_cb);
  } // do_ajax_form_obat_ranap_mob_validate_signa

  function do_ajax_form_obat_ranap_mob_validate_signa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "signa";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_obat_ranap_mob_validate_signa_cb

  // ---------- Validate jenisaturanpakai
  function do_ajax_form_obat_ranap_mob_validate_jenisaturanpakai()
  {
    var nomeCampo_jenisaturanpakai = "jenisaturanpakai";
    var var_jenisaturanpakai = scAjaxGetFieldText(nomeCampo_jenisaturanpakai);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_obat_ranap_mob_validate_jenisaturanpakai(var_jenisaturanpakai, var_script_case_init, do_ajax_form_obat_ranap_mob_validate_jenisaturanpakai_cb);
  } // do_ajax_form_obat_ranap_mob_validate_jenisaturanpakai

  function do_ajax_form_obat_ranap_mob_validate_jenisaturanpakai_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_obat_ranap_mob_validate_jenisaturanpakai_cb

  // ---------- Validate biaya
  function do_ajax_form_obat_ranap_mob_validate_biaya()
  {
    var nomeCampo_biaya = "biaya";
    var var_biaya = scAjaxGetFieldText(nomeCampo_biaya);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_obat_ranap_mob_validate_biaya(var_biaya, var_script_case_init, do_ajax_form_obat_ranap_mob_validate_biaya_cb);
  } // do_ajax_form_obat_ranap_mob_validate_biaya

  function do_ajax_form_obat_ranap_mob_validate_biaya_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "biaya";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_obat_ranap_mob_validate_biaya_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_obat_ranap_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_obat_ranap_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_obat_ranap_mob_submit_form(var_id, var_trancode, var_item, var_satuan, var_jumlah, var_signa, var_jenisaturanpakai, var_biaya, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_obat_ranap_mob_submit_form_cb);
  } // do_ajax_form_obat_ranap_mob_submit_form

  function do_ajax_form_obat_ranap_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_obat_ranap_mob_submit_form_cb_after_alert);
  } // do_ajax_form_obat_ranap_mob_submit_form_cb
  function do_ajax_form_obat_ranap_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_obat_ranap_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_obat_ranap_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_obat_ranap_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_obat_ranap_mob_navigate_form_cb);
  } // do_ajax_form_obat_ranap_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_obat_ranap_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_obat_ranap_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_obat_ranap_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_obat_ranap_mob_navigate_form_cb
  function do_ajax_form_obat_ranap_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_obat_ranap_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_obat_ranap_mob_navigate_form_cb_after_alert
  function sc_hide_form_obat_ranap_mob_form()
  {
