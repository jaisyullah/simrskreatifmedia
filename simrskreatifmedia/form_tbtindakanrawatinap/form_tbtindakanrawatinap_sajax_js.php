  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbtindakanrawatinap" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbtindakanrawatinap_form();
	}

  // ---------- Validate tgltindakan_
  function do_ajax_form_tbtindakanrawatinap_validate_tgltindakan_(iNumLinha)
  {
    var nomeCampo_tgltindakan_ = "tgltindakan_" + iNumLinha;
    var var_tgltindakan_ = scAjaxGetFieldText(nomeCampo_tgltindakan_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtindakanrawatinap_validate_tgltindakan_(var_tgltindakan_, iNumLinha, var_script_case_init, do_ajax_form_tbtindakanrawatinap_validate_tgltindakan__cb);
  } // do_ajax_form_tbtindakanrawatinap_validate_tgltindakan_

  function do_ajax_form_tbtindakanrawatinap_validate_tgltindakan__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "tgltindakan_" + iLineNumber;
    }
    else
    {
      sFieldValid = "tgltindakan_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "tgltindakan_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "tgltindakan_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtindakanrawatinap_validate_tgltindakan__cb

  // ---------- Validate pelaksana_
  function do_ajax_form_tbtindakanrawatinap_validate_pelaksana_(iNumLinha)
  {
    var nomeCampo_pelaksana_ = "pelaksana_" + iNumLinha;
    var var_pelaksana_ = scAjaxGetFieldSelect(nomeCampo_pelaksana_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtindakanrawatinap_validate_pelaksana_(var_pelaksana_, iNumLinha, var_script_case_init, do_ajax_form_tbtindakanrawatinap_validate_pelaksana__cb);
  } // do_ajax_form_tbtindakanrawatinap_validate_pelaksana_

  function do_ajax_form_tbtindakanrawatinap_validate_pelaksana__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "pelaksana_" + iLineNumber;
    }
    else
    {
      sFieldValid = "pelaksana_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "pelaksana_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "pelaksana_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtindakanrawatinap_validate_pelaksana__cb

  // ---------- Validate tindakan_
  function do_ajax_form_tbtindakanrawatinap_validate_tindakan_(iNumLinha)
  {
    var nomeCampo_tindakan_ = "tindakan_" + iNumLinha;
    var var_tindakan_ = scAjaxGetFieldSelect(nomeCampo_tindakan_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtindakanrawatinap_validate_tindakan_(var_tindakan_, iNumLinha, var_script_case_init, do_ajax_form_tbtindakanrawatinap_validate_tindakan__cb);
  } // do_ajax_form_tbtindakanrawatinap_validate_tindakan_

  function do_ajax_form_tbtindakanrawatinap_validate_tindakan__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "tindakan_" + iLineNumber;
    }
    else
    {
      sFieldValid = "tindakan_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "tindakan_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "tindakan_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtindakanrawatinap_validate_tindakan__cb

  // ---------- Validate biaya_
  function do_ajax_form_tbtindakanrawatinap_validate_biaya_(iNumLinha)
  {
    var nomeCampo_biaya_ = "biaya_" + iNumLinha;
    var var_biaya_ = scAjaxGetFieldText(nomeCampo_biaya_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtindakanrawatinap_validate_biaya_(var_biaya_, iNumLinha, var_script_case_init, do_ajax_form_tbtindakanrawatinap_validate_biaya__cb);
  } // do_ajax_form_tbtindakanrawatinap_validate_biaya_

  function do_ajax_form_tbtindakanrawatinap_validate_biaya__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtindakanrawatinap_validate_biaya__cb

  // ---------- Validate diskon_
  function do_ajax_form_tbtindakanrawatinap_validate_diskon_(iNumLinha)
  {
    var nomeCampo_diskon_ = "diskon_" + iNumLinha;
    var var_diskon_ = scAjaxGetFieldText(nomeCampo_diskon_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtindakanrawatinap_validate_diskon_(var_diskon_, iNumLinha, var_script_case_init, do_ajax_form_tbtindakanrawatinap_validate_diskon__cb);
  } // do_ajax_form_tbtindakanrawatinap_validate_diskon_

  function do_ajax_form_tbtindakanrawatinap_validate_diskon__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtindakanrawatinap_validate_diskon__cb

  // ---------- Validate kelas_
  function do_ajax_form_tbtindakanrawatinap_validate_kelas_(iNumLinha)
  {
    var nomeCampo_kelas_ = "kelas_" + iNumLinha;
    var var_kelas_ = scAjaxGetFieldSelect(nomeCampo_kelas_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtindakanrawatinap_validate_kelas_(var_kelas_, iNumLinha, var_script_case_init, do_ajax_form_tbtindakanrawatinap_validate_kelas__cb);
  } // do_ajax_form_tbtindakanrawatinap_validate_kelas_

  function do_ajax_form_tbtindakanrawatinap_validate_kelas__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "kelas_" + iLineNumber;
    }
    else
    {
      sFieldValid = "kelas_";
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "kelas_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "kelas_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtindakanrawatinap_validate_kelas__cb

  // ---------- Validate pembayaran_
  function do_ajax_form_tbtindakanrawatinap_validate_pembayaran_(iNumLinha)
  {
    var nomeCampo_pembayaran_ = "pembayaran_" + iNumLinha;
    var var_pembayaran_ = scAjaxGetFieldSelect(nomeCampo_pembayaran_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtindakanrawatinap_validate_pembayaran_(var_pembayaran_, iNumLinha, var_script_case_init, do_ajax_form_tbtindakanrawatinap_validate_pembayaran__cb);
  } // do_ajax_form_tbtindakanrawatinap_validate_pembayaran_

  function do_ajax_form_tbtindakanrawatinap_validate_pembayaran__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "pembayaran_" + iLineNumber;
    }
    else
    {
      sFieldValid = "pembayaran_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "pembayaran_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "pembayaran_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtindakanrawatinap_validate_pembayaran__cb

  // ---------- Validate jumlah_
  function do_ajax_form_tbtindakanrawatinap_validate_jumlah_(iNumLinha)
  {
    var nomeCampo_jumlah_ = "jumlah_" + iNumLinha;
    var var_jumlah_ = scAjaxGetFieldText(nomeCampo_jumlah_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtindakanrawatinap_validate_jumlah_(var_jumlah_, iNumLinha, var_script_case_init, do_ajax_form_tbtindakanrawatinap_validate_jumlah__cb);
  } // do_ajax_form_tbtindakanrawatinap_validate_jumlah_

  function do_ajax_form_tbtindakanrawatinap_validate_jumlah__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtindakanrawatinap_validate_jumlah__cb

  // ---------- Validate id_
  function do_ajax_form_tbtindakanrawatinap_validate_id_(iNumLinha)
  {
    var nomeCampo_id_ = "id_" + iNumLinha;
    var var_id_ = scAjaxGetFieldHidden(nomeCampo_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtindakanrawatinap_validate_id_(var_id_, iNumLinha, var_script_case_init, do_ajax_form_tbtindakanrawatinap_validate_id__cb);
  } // do_ajax_form_tbtindakanrawatinap_validate_id_

  function do_ajax_form_tbtindakanrawatinap_validate_id__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtindakanrawatinap_validate_id__cb

  // ---------- Refresh pelaksana_
  function do_ajax_form_tbtindakanrawatinap_refresh_pelaksana_(iSeqForm)
  {
    var var_pelaksana_ = scAjaxGetFieldSelect("pelaksana_" + iSeqForm);
    var var_nmgp_refresh_row = iSeqForm;
    var var_nmgp_refresh_fields = "tindakan_";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tbtindakanrawatinap_refresh_pelaksana_(var_pelaksana_, var_nmgp_refresh_row, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_tbtindakanrawatinap_refresh_pelaksana__cb);
  } // do_ajax_form_tbtindakanrawatinap_refresh_pelaksana_

  function do_ajax_form_tbtindakanrawatinap_refresh_pelaksana__cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtindakanrawatinap_refresh_pelaksana__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_tbtindakanrawatinap_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_tbtindakanrawatinap_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tbtindakanrawatinap_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_tbtindakanrawatinap_add_new_line_cb);
  } // do_ajax_form_tbtindakanrawatinap_add_new_line

  function do_ajax_form_tbtindakanrawatinap_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_tbtindakanrawatinap_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_tbtindakanrawatinap_backup_line(iNumLinha)
  {
    var var_id_ = scAjaxGetFieldHidden("id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtindakanrawatinap_backup_line(var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_tbtindakanrawatinap_backup_line_cb);
  } // do_ajax_form_tbtindakanrawatinap_backup_line

  function do_ajax_form_tbtindakanrawatinap_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_tbtindakanrawatinap_backup_line_cb

  function do_ajax_form_tbtindakanrawatinap_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_tbtindakanrawatinap_cancel_insert

  function do_ajax_form_tbtindakanrawatinap_cancel_update(iSeqVert)
  {
    do_ajax_form_tbtindakanrawatinap_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_tbtindakanrawatinap_cancel_update

  function do_ajax_form_tbtindakanrawatinap_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_tbtindakanrawatinap_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_tbtindakanrawatinap_table_refresh()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tbtindakanrawatinap_table_refresh(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbtindakanrawatinap_table_refresh_cb);
  } //  do_ajax_form_tbtindakanrawatinap_table_refresh

  function do_ajax_form_tbtindakanrawatinap_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_tbtindakanrawatinap_table_refresh_cb_after_alert);
  } // do_ajax_form_tbtindakanrawatinap_table_refresh_cb
  function do_ajax_form_tbtindakanrawatinap_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxSetNavStatus("t");
    sc_insert_open = false;
  } // do_ajax_form_tbtindakanrawatinap_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_tbtindakanrawatinap_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_tbtindakanrawatinap_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    sc_num_ult_line = iNumLinha;
    sc_num_ult_tr   = indexTR;
    scAjaxHideMessage();
    var var_tgltindakan_ = scAjaxGetFieldText("tgltindakan_" + iNumLinha);
    var var_pelaksana_ = scAjaxGetFieldSelect("pelaksana_" + iNumLinha);
    var var_tindakan_ = scAjaxGetFieldSelect("tindakan_" + iNumLinha);
    var var_biaya_ = scAjaxGetFieldText("biaya_" + iNumLinha);
    var var_diskon_ = scAjaxGetFieldText("diskon_" + iNumLinha);
    var var_kelas_ = scAjaxGetFieldSelect("kelas_" + iNumLinha);
    var var_pembayaran_ = scAjaxGetFieldSelect("pembayaran_" + iNumLinha);
...
?>
    x_ajax_form_tbtindakanrawatinap_submit_form(var_tgltindakan_, var_pelaksana_, var_tindakan_, var_biaya_, var_diskon_, var_kelas_, var_pembayaran_, var_jumlah_, var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbtindakanrawatinap_submit_form_cb);
  } // do_ajax_form_tbtindakanrawatinap_submit_form

  function do_ajax_form_tbtindakanrawatinap_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("tgltindakan_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("pelaksana_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("tindakan_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("biaya_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("diskon_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("kelas_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("pembayaran_" + sc_num_ult_line);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_tbtindakanrawatinap_submit_form_cb_after_alert);
  } // do_ajax_form_tbtindakanrawatinap_submit_form_cb
  function do_ajax_form_tbtindakanrawatinap_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbtindakanrawatinap_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tbtindakanrawatinap_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_tbtindakanrawatinap_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("tgltindakan_" + iNavForm);
      scAjaxHideErrorDisplay("pelaksana_" + iNavForm);
      scAjaxHideErrorDisplay("tindakan_" + iNavForm);
      scAjaxHideErrorDisplay("biaya_" + iNavForm);
      scAjaxHideErrorDisplay("diskon_" + iNavForm);
      scAjaxHideErrorDisplay("kelas_" + iNavForm);
      scAjaxHideErrorDisplay("pembayaran_" + iNavForm);
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tbtindakanrawatinap_navigate_form(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbtindakanrawatinap_navigate_form_cb);
  } // do_ajax_form_tbtindakanrawatinap_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtindakanrawatinap']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbtindakanrawatinap_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbtindakanrawatinap_navigate_form_cb_after_alert);
  } // do_ajax_form_tbtindakanrawatinap_navigate_form_cb
  function do_ajax_form_tbtindakanrawatinap_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scFocusField('pelaksana_1');
...
?>
  ...
  } // do_ajax_form_tbtindakanrawatinap_navigate_form_cb_after_alert
  function sc_hide_form_tbtindakanrawatinap_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "tgltindakan_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "pelaksana_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "tindakan_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "biaya_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "diskon_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "kelas_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "pembayaran_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "jumlah_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "id_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["tgltindakan_" + iNumLinha] = {"label": "Tgl Tindakan<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["pelaksana_" + iNumLinha] = {"label": "Pelaksana<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["tindakan_" + iNumLinha] = {"label": "Tindakan<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_error_list["kelas_" + iNumLinha] = {"label": "kelas<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["pembayaran_" + iNumLinha] = {"label": "pembayaran<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_field_mult["tgltindakan_"][iNumLinha] = "tgltindakan_" + iNumLinha;
    ajax_field_mult["pelaksana_"][iNumLinha] = "pelaksana_" + iNumLinha;
    ajax_field_mult["tindakan_"][iNumLinha] = "tindakan_" + iNumLinha;
    ajax_field_mult["biaya_"][iNumLinha] = "biaya_" + iNumLinha;
    ajax_field_mult["diskon_"][iNumLinha] = "diskon_" + iNumLinha;
    ajax_field_mult["kelas_"][iNumLinha] = "kelas_" + iNumLinha;
    ajax_field_mult["pembayaran_"][iNumLinha] = "pembayaran_" + iNumLinha;
    ajax_field_mult["jumlah_"][iNumLinha] = "jumlah_" + iNumLinha;
    ajax_field_mult["id_"][iNumLinha] = "id_" + iNumLinha;
    ajax_field_id["tgltindakan_" + iNumLinha] = new Array("hidden_field_label_tgltindakan_", "hidden_field_data_tgltindakan_" + iNumLinha);
    ajax_field_id["pelaksana_" + iNumLinha] = new Array("hidden_field_label_pelaksana_", "hidden_field_data_pelaksana_" + iNumLinha);
    ajax_field_id["tindakan_" + iNumLinha] = new Array("hidden_field_label_tindakan_", "hidden_field_data_tindakan_" + iNumLinha);
    ...
    ajax_error_count["tgltindakan_" + iNumLinha] = "off";
    ajax_error_count["pelaksana_" + iNumLinha] = "off";
    ajax_error_count["tindakan_" + iNumLinha] = "off";
    ajax_error_count["biaya_" + iNumLinha] = "off";
    ajax_error_count["diskon_" + iNumLinha] = "off";
    ajax_error_count["kelas_" + iNumLinha] = "off";
    ajax_error_count["pembayaran_" + iNumLinha] = "off";
...
{
?>
    ajax_read_only["tgltindakan_" + iNumLinha] = "off";
    ajax_read_only["pelaksana_" + iNumLinha] = "on";
    ajax_read_only["tindakan_" + iNumLinha] = "on";
    ajax_read_only["biaya_" + iNumLinha] = "off";
    ajax_read_only["diskon_" + iNumLinha] = "off";
    ajax_read_only["kelas_" + iNumLinha] = "off";
    ajax_read_only["pembayaran_" + iNumLinha] = "off";
...
{
?>
    ajax_read_only["tgltindakan_" + iNumLinha] = "on";
    ajax_read_only["pelaksana_" + iNumLinha] = "on";
    ajax_read_only["tindakan_" + iNumLinha] = "on";
    ajax_read_only["biaya_" + iNumLinha] = "on";
    ajax_read_only["diskon_" + iNumLinha] = "on";
    ajax_read_only["kelas_" + iNumLinha] = "on";
    ajax_read_only["pembayaran_" + iNumLinha] = "on";
...
?>
  ...
  {
    ajax_error_list["tgltindakan_" + iNumLinha] = null;
    ajax_error_list["pelaksana_" + iNumLinha] = null;
    ajax_error_list["tindakan_" + iNumLinha] = null;
    ajax_error_list["biaya_" + iNumLinha] = null;
    ajax_error_list["diskon_" + iNumLinha] = null;
    ajax_error_list["kelas_" + iNumLinha] = null;
    ajax_error_list["pembayaran_" + iNumLinha] = null;
  ...
  var ajax_field_mult = {
    "tgltindakan_": new Array(),
    "pelaksana_": new Array(),
    "tindakan_": new Array(),
    "biaya_": new Array(),
    "diskon_": new Array(),
    "kelas_": new Array(),
    "pembayaran_": new Array(),
    "jumlah_": new Array(),
    "id_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["tgltindakan_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["tgltindakan_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["tgltindakan_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["tgltindakan_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["tgltindakan_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["pelaksana_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["pelaksana_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["pelaksana_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["pelaksana_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["pelaksana_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["tindakan_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["tindakan_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["tindakan_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["tindakan_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["tindakan_" + iNumLinha]["onfocus"] = new Array();
      ...
      ajax_error_list["kelas_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["kelas_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["kelas_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["kelas_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["kelas_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["pembayaran_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["pembayaran_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["pembayaran_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["pembayaran_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["pembayaran_" + iNumLinha]["onfocus"] = new Array();
...
?>
    ...
    mdOpenObjects(iSeq);
    Obj_Focus = eval("document.getElementById('id_sc_field_pelaksana_" + iSeq + "')");
    if (Obj_Focus)
    {
        Obj_Focus.focus();
    }
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['tgltindakan_'])) ? $this->nmgp_cmp_readonly['tgltindakan_'] : 'off';
?>
    scAjaxFieldRead("tgltindakan_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['pelaksana_'])) ? $this->nmgp_cmp_readonly['pelaksana_'] : 'on';
?>
    scAjaxFieldRead("pelaksana_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['tindakan_'])) ? $this->nmgp_cmp_readonly['tindakan_'] : 'on';
?>
    scAjaxFieldRead("tindakan_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['kelas_'])) ? $this->nmgp_cmp_readonly['kelas_'] : 'off';
?>
    scAjaxFieldRead("kelas_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['pembayaran_'])) ? $this->nmgp_cmp_readonly['pembayaran_'] : 'off';
?>
    scAjaxFieldRead("pembayaran_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
?>
  ...
  {
    scAjaxFieldRead("tgltindakan_" + iSeq, "on");
    scAjaxFieldRead("pelaksana_" + iSeq, "on");
    scAjaxFieldRead("tindakan_" + iSeq, "on");
    scAjaxFieldRead("biaya_" + iSeq, "on");
    scAjaxFieldRead("diskon_" + iSeq, "on");
    scAjaxFieldRead("kelas_" + iSeq, "on");
    scAjaxFieldRead("pembayaran_" + iSeq, "on");
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["tgltindakan_" + iRow] || "on" == ajax_error_count["pelaksana_" + iRow] || "on" == ajax_error_count["tindakan_" + iRow] || "on" == ajax_error_count["biaya_" + iRow] || "on" == ajax_error_count["diskon_" + iRow] || "on" == ajax_error_count["kelas_" + iRow] || "on" == ajax_error_count["pembayaran_" + iRow] || "on" == ajax_error_count["jumlah_" + iRow] || "on" == ajax_error_count["id_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_tgltindakan_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_pelaksana_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_tindakan_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_biaya_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_diskon_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_kelas_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_pembayaran_" + iRow).addClass("scFormErrorLine");
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["tgltindakan_" + iRow] && "off" == ajax_error_count["pelaksana_" + iRow] && "off" == ajax_error_count["tindakan_" + iRow] && "off" == ajax_error_count["biaya_" + iRow] && "off" == ajax_error_count["diskon_" + iRow] && "off" == ajax_error_count["kelas_" + iRow] && "off" == ajax_error_count["pembayaran_" + iRow] && "off" == ajax_error_count["jumlah_" + iRow] && "off" == ajax_error_count["id_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["tgltindakan_" + iRow] = "off";
        ajax_error_count["pelaksana_" + iRow] = "off";
        ajax_error_count["tindakan_" + iRow] = "off";
        ajax_error_count["biaya_" + iRow] = "off";
        ajax_error_count["diskon_" + iRow] = "off";
        ajax_error_count["kelas_" + iRow] = "off";
        ajax_error_count["pembayaran_" + iRow] = "off";
      ...
      $("#hidden_field_data_tgltindakan_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_pelaksana_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_tindakan_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_biaya_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_diskon_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_kelas_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_pembayaran_" + iRow).removeClass("scFormErrorLine");
