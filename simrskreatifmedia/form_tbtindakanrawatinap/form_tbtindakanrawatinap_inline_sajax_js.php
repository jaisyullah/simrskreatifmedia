  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbtindakanrawatinap_inline" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbtindakanrawatinap_inline_form();
	}

  // ---------- Validate tgltindakan_
  function do_ajax_form_tbtindakanrawatinap_inline_validate_tgltindakan_()
  {
    var nomeCampo_tgltindakan_ = "tgltindakan_";
    var var_tgltindakan_ = scAjaxGetFieldText(nomeCampo_tgltindakan_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtindakanrawatinap_inline_validate_tgltindakan_(var_tgltindakan_, var_script_case_init, do_ajax_form_tbtindakanrawatinap_inline_validate_tgltindakan__cb);
  } // do_ajax_form_tbtindakanrawatinap_inline_validate_tgltindakan_

  function do_ajax_form_tbtindakanrawatinap_inline_validate_tgltindakan__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtindakanrawatinap_inline_validate_tgltindakan__cb

  // ---------- Validate pelaksana_
  function do_ajax_form_tbtindakanrawatinap_inline_validate_pelaksana_()
  {
    var nomeCampo_pelaksana_ = "pelaksana_";
    var var_pelaksana_ = scAjaxGetFieldSelect(nomeCampo_pelaksana_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtindakanrawatinap_inline_validate_pelaksana_(var_pelaksana_, var_script_case_init, do_ajax_form_tbtindakanrawatinap_inline_validate_pelaksana__cb);
  } // do_ajax_form_tbtindakanrawatinap_inline_validate_pelaksana_

  function do_ajax_form_tbtindakanrawatinap_inline_validate_pelaksana__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtindakanrawatinap_inline_validate_pelaksana__cb

  // ---------- Validate tindakan_
  function do_ajax_form_tbtindakanrawatinap_inline_validate_tindakan_()
  {
    var nomeCampo_tindakan_ = "tindakan_";
    var var_tindakan_ = scAjaxGetFieldSelect(nomeCampo_tindakan_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtindakanrawatinap_inline_validate_tindakan_(var_tindakan_, var_script_case_init, do_ajax_form_tbtindakanrawatinap_inline_validate_tindakan__cb);
  } // do_ajax_form_tbtindakanrawatinap_inline_validate_tindakan_

  function do_ajax_form_tbtindakanrawatinap_inline_validate_tindakan__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtindakanrawatinap_inline_validate_tindakan__cb

  // ---------- Validate biaya_
  function do_ajax_form_tbtindakanrawatinap_inline_validate_biaya_()
  {
    var nomeCampo_biaya_ = "biaya_";
    var var_biaya_ = scAjaxGetFieldText(nomeCampo_biaya_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtindakanrawatinap_inline_validate_biaya_(var_biaya_, var_script_case_init, do_ajax_form_tbtindakanrawatinap_inline_validate_biaya__cb);
  } // do_ajax_form_tbtindakanrawatinap_inline_validate_biaya_

  function do_ajax_form_tbtindakanrawatinap_inline_validate_biaya__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "biaya_";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtindakanrawatinap_inline_validate_biaya__cb

  // ---------- Validate diskon_
  function do_ajax_form_tbtindakanrawatinap_inline_validate_diskon_()
  {
    var nomeCampo_diskon_ = "diskon_";
    var var_diskon_ = scAjaxGetFieldText(nomeCampo_diskon_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtindakanrawatinap_inline_validate_diskon_(var_diskon_, var_script_case_init, do_ajax_form_tbtindakanrawatinap_inline_validate_diskon__cb);
  } // do_ajax_form_tbtindakanrawatinap_inline_validate_diskon_

  function do_ajax_form_tbtindakanrawatinap_inline_validate_diskon__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "diskon_";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtindakanrawatinap_inline_validate_diskon__cb

  // ---------- Validate kelas_
  function do_ajax_form_tbtindakanrawatinap_inline_validate_kelas_()
  {
    var nomeCampo_kelas_ = "kelas_";
    var var_kelas_ = scAjaxGetFieldSelect(nomeCampo_kelas_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtindakanrawatinap_inline_validate_kelas_(var_kelas_, var_script_case_init, do_ajax_form_tbtindakanrawatinap_inline_validate_kelas__cb);
  } // do_ajax_form_tbtindakanrawatinap_inline_validate_kelas_

  function do_ajax_form_tbtindakanrawatinap_inline_validate_kelas__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "kelas_";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtindakanrawatinap_inline_validate_kelas__cb

  // ---------- Validate pembayaran_
  function do_ajax_form_tbtindakanrawatinap_inline_validate_pembayaran_()
  {
    var nomeCampo_pembayaran_ = "pembayaran_";
    var var_pembayaran_ = scAjaxGetFieldSelect(nomeCampo_pembayaran_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtindakanrawatinap_inline_validate_pembayaran_(var_pembayaran_, var_script_case_init, do_ajax_form_tbtindakanrawatinap_inline_validate_pembayaran__cb);
  } // do_ajax_form_tbtindakanrawatinap_inline_validate_pembayaran_

  function do_ajax_form_tbtindakanrawatinap_inline_validate_pembayaran__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtindakanrawatinap_inline_validate_pembayaran__cb

  // ---------- Validate jumlah_
  function do_ajax_form_tbtindakanrawatinap_inline_validate_jumlah_()
  {
    var nomeCampo_jumlah_ = "jumlah_";
    var var_jumlah_ = scAjaxGetFieldText(nomeCampo_jumlah_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtindakanrawatinap_inline_validate_jumlah_(var_jumlah_, var_script_case_init, do_ajax_form_tbtindakanrawatinap_inline_validate_jumlah__cb);
  } // do_ajax_form_tbtindakanrawatinap_inline_validate_jumlah_

  function do_ajax_form_tbtindakanrawatinap_inline_validate_jumlah__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "jumlah_";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtindakanrawatinap_inline_validate_jumlah__cb

  // ---------- Validate id_
  function do_ajax_form_tbtindakanrawatinap_inline_validate_id_()
  {
    var nomeCampo_id_ = "id_";
    var var_id_ = scAjaxGetFieldHidden(nomeCampo_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtindakanrawatinap_inline_validate_id_(var_id_, var_script_case_init, do_ajax_form_tbtindakanrawatinap_inline_validate_id__cb);
  } // do_ajax_form_tbtindakanrawatinap_inline_validate_id_

  function do_ajax_form_tbtindakanrawatinap_inline_validate_id__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id_";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtindakanrawatinap_inline_validate_id__cb

  // ---------- Refresh pelaksana_
  function do_ajax_form_tbtindakanrawatinap_inline_refresh_pelaksana_()
  {
    var var_pelaksana_ = scAjaxGetFieldSelect("pelaksana_");
    var var_nmgp_refresh_fields = "tindakan_";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tbtindakanrawatinap_inline_refresh_pelaksana_(var_pelaksana_, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_tbtindakanrawatinap_inline_refresh_pelaksana__cb);
  } // do_ajax_form_tbtindakanrawatinap_inline_refresh_pelaksana_

  function do_ajax_form_tbtindakanrawatinap_inline_refresh_pelaksana__cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtindakanrawatinap_inline_refresh_pelaksana__cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tbtindakanrawatinap_inline_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tbtindakanrawatinap_inline_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_tbtindakanrawatinap_inline_submit_form(var_tgltindakan_, var_pelaksana_, var_tindakan_, var_biaya_, var_diskon_, var_kelas_, var_pembayaran_, var_jumlah_, var_id_, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbtindakanrawatinap_inline_submit_form_cb);
  } // do_ajax_form_tbtindakanrawatinap_inline_submit_form

  function do_ajax_form_tbtindakanrawatinap_inline_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tbtindakanrawatinap_inline_submit_form_cb_after_alert);
  } // do_ajax_form_tbtindakanrawatinap_inline_submit_form_cb
  function do_ajax_form_tbtindakanrawatinap_inline_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbtindakanrawatinap_inline_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tbtindakanrawatinap_inline_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tbtindakanrawatinap_inline_navigate_form(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbtindakanrawatinap_inline_navigate_form_cb);
  } // do_ajax_form_tbtindakanrawatinap_inline_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtindakanrawatinap_inline']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbtindakanrawatinap_inline_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbtindakanrawatinap_inline_navigate_form_cb_after_alert);
  } // do_ajax_form_tbtindakanrawatinap_inline_navigate_form_cb
  function do_ajax_form_tbtindakanrawatinap_inline_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_tbtindakanrawatinap_inline_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_tbtindakanrawatinap_inline_navigate_form_cb_after_alert
  function sc_hide_form_tbtindakanrawatinap_inline_form()
  {
