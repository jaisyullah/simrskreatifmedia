...
$old_error_handler = set_error_handler("form_tbtindakanrawatinap_scriptcase_error_handler");

function form_tbtindakanrawatinap_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['form_tbtindakanrawatinap']['contr_erro']) && $_SESSION['scriptcase']['form_tbtindakanrawatinap']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_form_tbtindakanrawatinap->contr_form_tbtindakanrawatinap->Apl_com_erro = true;
            if ($inicial_form_tbtindakanrawatinap->contr_form_tbtindakanrawatinap->NM_ajax_flag)
            {
                $inicial_form_tbtindakanrawatinap->contr_form_tbtindakanrawatinap->NM_ajax_info['errList']['geral_form_tbtindakanrawatinap'][] = $msg;
                return;
            }
            form_tbtindakanrawatinap_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function form_tbtindakanrawatinap_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['form_tbtindakanrawatinap'])  && '' != $_SESSION['scriptcase']['error_icon']['form_tbtindakanrawatinap'])  ? $_SESSION['scriptcase']['error_icon']['form_tbtindakanrawatinap']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['form_tbtindakanrawatinap']) && '' != $_SESSION['scriptcase']['error_span_title']['form_tbtindakanrawatinap']) ? $_SESSION['scriptcase']['error_span_title']['form_tbtindakanrawatinap'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['form_tbtindakanrawatinap']) && '' != $_SESSION['scriptcase']['error_icon_title']['form_tbtindakanrawatinap']) ? $_SESSION['scriptcase']['error_icon_title']['form_tbtindakanrawatinap'] : '';
?>
