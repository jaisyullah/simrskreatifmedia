...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_id_' + iSeqRow).bind('blur', function() { sc_form_tbtindakanrawatinap_id__onblur(this, iSeqRow) })
                                 .bind('change', function() { sc_form_tbtindakanrawatinap_id__onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_tindakan_' + iSeqRow).bind('blur', function() { sc_form_tbtindakanrawatinap_tindakan__onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_form_tbtindakanrawatinap_tindakan__onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_jumlah_' + iSeqRow).bind('blur', function() { sc_form_tbtindakanrawatinap_jumlah__onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_form_tbtindakanrawatinap_jumlah__onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_biaya_' + iSeqRow).bind('blur', function() { sc_form_tbtindakanrawatinap_biaya__onblur(this, iSeqRow) })
                                    .bind('change', function() { sc_form_tbtindakanrawatinap_biaya__onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_tgltindakan_' + iSeqRow).bind('blur', function() { sc_form_tbtindakanrawatinap_tgltindakan__onblur(this, iSeqRow) })
                                          .bind('change', function() { sc_form_tbtindakanrawatinap_tgltindakan__onchange(this, iSeqRow) })
                                          .bind('focus', function() { sc_form_tbtindakanrawatinap_tgltindakan__onfocus(this, iSeqRow) });
  $('#id_sc_field_tgltindakan__hora' + iSeqRow).bind('blur', function() { sc_form_tbtindakanrawatinap_tgltindakan__hora_onblur(this, iSeqRow) })
                                               .bind('change', function() { sc_form_tbtindakanrawatinap_tgltindakan__hora_onchange(this, iSeqRow) })
                                               .bind('focus', function() { sc_form_tbtindakanrawatinap_tgltindakan__hora_onfocus(this, iSeqRow) });
  $('#id_sc_field_diskon_' + iSeqRow).bind('blur', function() { sc_form_tbtindakanrawatinap_diskon__onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_form_tbtindakanrawatinap_diskon__onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_kelas_' + iSeqRow).bind('blur', function() { sc_form_tbtindakanrawatinap_kelas__onblur(this, iSeqRow) })
                                    .bind('change', function() { sc_form_tbtindakanrawatinap_kelas__onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_pembayaran_' + iSeqRow).bind('blur', function() { sc_form_tbtindakanrawatinap_pembayaran__onblur(this, iSeqRow) })
                                         .bind('change', function() { sc_form_tbtindakanrawatinap_pembayaran__onchange(this, iSeqRow) })
...
function sc_form_tbtindakanrawatinap_id__onblur(oThis, iSeqRow) {
  do_ajax_form_tbtindakanrawatinap_validate_id_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_tbtindakanrawatinap_id__onchange(oThis, iSeqRow) {
...
function sc_form_tbtindakanrawatinap_tindakan__onblur(oThis, iSeqRow) {
  do_ajax_form_tbtindakanrawatinap_validate_tindakan_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_tbtindakanrawatinap_tindakan__onchange(oThis, iSeqRow) {
  nm_check_insert(iSeqRow);
}
...
function sc_form_tbtindakanrawatinap_pelaksana__onblur(oThis, iSeqRow) {
  do_ajax_form_tbtindakanrawatinap_validate_pelaksana_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_tbtindakanrawatinap_pelaksana__onchange(oThis, iSeqRow) {
  do_ajax_form_tbtindakanrawatinap_refresh_pelaksana_(iSeqRow);
  nm_check_insert(iSeqRow);
}
...
function sc_form_tbtindakanrawatinap_jumlah__onblur(oThis, iSeqRow) {
  do_ajax_form_tbtindakanrawatinap_validate_jumlah_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_tbtindakanrawatinap_jumlah__onchange(oThis, iSeqRow) {
  nm_check_insert(iSeqRow);
}
...
function sc_form_tbtindakanrawatinap_biaya__onblur(oThis, iSeqRow) {
  do_ajax_form_tbtindakanrawatinap_validate_biaya_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_tbtindakanrawatinap_biaya__onchange(oThis, iSeqRow) {
  nm_check_insert(iSeqRow);
}
...
function sc_form_tbtindakanrawatinap_tgltindakan__onblur(oThis, iSeqRow) {
  do_ajax_form_tbtindakanrawatinap_validate_tgltindakan_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_tbtindakanrawatinap_tgltindakan__hora_onblur(oThis, iSeqRow) {
  do_ajax_form_tbtindakanrawatinap_validate_tgltindakan_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_tbtindakanrawatinap_tgltindakan__onchange(oThis, iSeqRow) {
  nm_check_insert(iSeqRow);
}

function sc_form_tbtindakanrawatinap_tgltindakan__hora_onchange(oThis, iSeqRow) {
  nm_check_insert(iSeqRow);
}
...
function sc_form_tbtindakanrawatinap_tgltindakan__hora_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_form_tbtindakanrawatinap_diskon__onblur(oThis, iSeqRow) {
  do_ajax_form_tbtindakanrawatinap_validate_diskon_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_tbtindakanrawatinap_diskon__onchange(oThis, iSeqRow) {
  nm_check_insert(iSeqRow);
}
...
function sc_form_tbtindakanrawatinap_kelas__onblur(oThis, iSeqRow) {
  do_ajax_form_tbtindakanrawatinap_validate_kelas_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_tbtindakanrawatinap_kelas__onchange(oThis, iSeqRow) {
  nm_check_insert(iSeqRow);
}
...
function sc_form_tbtindakanrawatinap_pembayaran__onblur(oThis, iSeqRow) {
  do_ajax_form_tbtindakanrawatinap_validate_pembayaran_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_tbtindakanrawatinap_pembayaran__onchange(oThis, iSeqRow) {
  nm_check_insert(iSeqRow);
}
...
function scHidePage(pageNo) {
	$("#id_form_tbtindakanrawatinap_form" + pageNo).hide();
}
