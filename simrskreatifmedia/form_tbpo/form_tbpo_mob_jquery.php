...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_datangdate_hora' + iSeqRow).bind('blur', function() { sc_form_tbpo_datangdate_onblur(this, iSeqRow) })
                                             .bind('focus', function() { sc_form_tbpo_datangdate_onfocus(this, iSeqRow) });
  ...
  $('#id_sc_field_jatuhtempo_hora' + iSeqRow).bind('blur', function() { sc_form_tbpo_jatuhtempo_onblur(this, iSeqRow) })
                                             .bind('focus', function() { sc_form_tbpo_jatuhtempo_onfocus(this, iSeqRow) });
  ...
  $('#id_sc_field_trandate_hora' + iSeqRow).bind('blur', function() { sc_form_tbpo_trandate_onblur(this, iSeqRow) })
                                           .bind('focus', function() { sc_form_tbpo_trandate_onfocus(this, iSeqRow) });
  ...
  $('#id_sc_field_tglbast_hora' + iSeqRow).bind('blur', function() { sc_form_tbpo_tglbast_onblur(this, iSeqRow) })
                                          .bind('focus', function() { sc_form_tbpo_tglbast_onfocus(this, iSeqRow) });
...
function scHidePage(pageNo) {
	$("#id_form_tbpo_mob_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_pesandate" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_tbpo_mob_validate_pesandate(iSeqRow);
    },
    numberOfMonths: 1,
    changeMonth: true,
    changeYear: true,
...
?>
  ...
  $("#id_sc_field_jatuhtempo" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_tbpo_mob_validate_jatuhtempo(iSeqRow);
    },
    numberOfMonths: 1,
    changeMonth: true,
    changeYear: true,
...
?>
  ...
  $("#id_sc_field_orderdate" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_tbpo_mob_validate_orderdate(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_datangdate" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_tbpo_mob_validate_datangdate(iSeqRow);
    },
    numberOfMonths: 1,
    changeMonth: true,
    changeYear: true,
...
?>
  ...
  $("#id_sc_field_tglbast" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_tbpo_mob_validate_tglbast(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
