<?php
@session_start() ;
$_SESSION['scriptcase']['pdfreport_kartu']['sc_process_barr'] = true;
require_once('../pdfreport_kartu/index.php');
unset($_SESSION['scriptcase']['pdfreport_kartu']['sc_process_barr']);
$ExportCtrl = new pdfreport_kartu_export_control;
$ExportCtrl->Export_barr();

class pdfreport_kartu_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_chart_title'] ?> tbcustomer :: Excel</TITLE>
