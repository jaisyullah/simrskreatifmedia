<?php
@session_start() ;
$_SESSION['scriptcase']['pdfreport_surat_kesanggupan']['sc_process_barr'] = true;
require_once('../pdfreport_surat_kesanggupan/index.php');
unset($_SESSION['scriptcase']['pdfreport_surat_kesanggupan']['sc_process_barr']);
$ExportCtrl = new pdfreport_surat_kesanggupan_export_control;
$ExportCtrl->Export_barr();

class pdfreport_surat_kesanggupan_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_chart_title'] ?> tbadmrawatinap :: Excel</TITLE>
