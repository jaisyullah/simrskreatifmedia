  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tblabrujukananak" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tblabrujukananak_form();
	}

  // ---------- Validate subname_
  function do_ajax_form_tblabrujukananak_validate_subname_(iNumLinha)
  {
    var nomeCampo_subname_ = "subname_" + iNumLinha;
    var var_subname_ = scAjaxGetFieldSelect(nomeCampo_subname_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblabrujukananak_validate_subname_(var_subname_, iNumLinha, var_script_case_init, do_ajax_form_tblabrujukananak_validate_subname__cb);
  } // do_ajax_form_tblabrujukananak_validate_subname_

  function do_ajax_form_tblabrujukananak_validate_subname__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblabrujukananak_validate_subname__cb

  // ---------- Validate kondisi_
  function do_ajax_form_tblabrujukananak_validate_kondisi_(iNumLinha)
  {
    var nomeCampo_kondisi_ = "kondisi_" + iNumLinha;
    var var_kondisi_ = scAjaxGetFieldSelect(nomeCampo_kondisi_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblabrujukananak_validate_kondisi_(var_kondisi_, iNumLinha, var_script_case_init, do_ajax_form_tblabrujukananak_validate_kondisi__cb);
  } // do_ajax_form_tblabrujukananak_validate_kondisi_

  function do_ajax_form_tblabrujukananak_validate_kondisi__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblabrujukananak_validate_kondisi__cb

  // ---------- Validate jml_hari_
  function do_ajax_form_tblabrujukananak_validate_jml_hari_(iNumLinha)
  {
    var nomeCampo_jml_hari_ = "jml_hari_" + iNumLinha;
    var var_jml_hari_ = scAjaxGetFieldText(nomeCampo_jml_hari_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblabrujukananak_validate_jml_hari_(var_jml_hari_, iNumLinha, var_script_case_init, do_ajax_form_tblabrujukananak_validate_jml_hari__cb);
  } // do_ajax_form_tblabrujukananak_validate_jml_hari_

  function do_ajax_form_tblabrujukananak_validate_jml_hari__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "jml_hari_" + iLineNumber;
    }
    else
    {
      sFieldValid = "jml_hari_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "jml_hari_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "jml_hari_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblabrujukananak_validate_jml_hari__cb

  // ---------- Validate oper_
  function do_ajax_form_tblabrujukananak_validate_oper_(iNumLinha)
  {
    var nomeCampo_oper_ = "oper_" + iNumLinha;
    var var_oper_ = scAjaxGetFieldSelect(nomeCampo_oper_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblabrujukananak_validate_oper_(var_oper_, iNumLinha, var_script_case_init, do_ajax_form_tblabrujukananak_validate_oper__cb);
  } // do_ajax_form_tblabrujukananak_validate_oper_

  function do_ajax_form_tblabrujukananak_validate_oper__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblabrujukananak_validate_oper__cb

  // ---------- Validate n1_
  function do_ajax_form_tblabrujukananak_validate_n1_(iNumLinha)
  {
    var nomeCampo_n1_ = "n1_" + iNumLinha;
    var var_n1_ = scAjaxGetFieldText(nomeCampo_n1_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblabrujukananak_validate_n1_(var_n1_, iNumLinha, var_script_case_init, do_ajax_form_tblabrujukananak_validate_n1__cb);
  } // do_ajax_form_tblabrujukananak_validate_n1_

  function do_ajax_form_tblabrujukananak_validate_n1__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "n1_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "n1_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblabrujukananak_validate_n1__cb

  // ---------- Validate n2_
  function do_ajax_form_tblabrujukananak_validate_n2_(iNumLinha)
  {
    var nomeCampo_n2_ = "n2_" + iNumLinha;
    var var_n2_ = scAjaxGetFieldText(nomeCampo_n2_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblabrujukananak_validate_n2_(var_n2_, iNumLinha, var_script_case_init, do_ajax_form_tblabrujukananak_validate_n2__cb);
  } // do_ajax_form_tblabrujukananak_validate_n2_

  function do_ajax_form_tblabrujukananak_validate_n2__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "n2_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "n2_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblabrujukananak_validate_n2__cb

  // ---------- Validate id_
  function do_ajax_form_tblabrujukananak_validate_id_(iNumLinha)
  {
    var nomeCampo_id_ = "id_" + iNumLinha;
    var var_id_ = scAjaxGetFieldHidden(nomeCampo_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblabrujukananak_validate_id_(var_id_, iNumLinha, var_script_case_init, do_ajax_form_tblabrujukananak_validate_id__cb);
  } // do_ajax_form_tblabrujukananak_validate_id_

  function do_ajax_form_tblabrujukananak_validate_id__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblabrujukananak_validate_id__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_tblabrujukananak_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_tblabrujukananak_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tblabrujukananak_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_tblabrujukananak_add_new_line_cb);
  } // do_ajax_form_tblabrujukananak_add_new_line

  function do_ajax_form_tblabrujukananak_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_tblabrujukananak_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_tblabrujukananak_backup_line(iNumLinha)
  {
    var var_id_ = scAjaxGetFieldHidden("id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblabrujukananak_backup_line(var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_tblabrujukananak_backup_line_cb);
  } // do_ajax_form_tblabrujukananak_backup_line

  function do_ajax_form_tblabrujukananak_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_tblabrujukananak_backup_line_cb

  function do_ajax_form_tblabrujukananak_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_tblabrujukananak_cancel_insert

  function do_ajax_form_tblabrujukananak_cancel_update(iSeqVert)
  {
    do_ajax_form_tblabrujukananak_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_tblabrujukananak_cancel_update

  function do_ajax_form_tblabrujukananak_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_tblabrujukananak_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_tblabrujukananak_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_tblabrujukananak_table_refresh(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tblabrujukananak_table_refresh_cb);
  } //  do_ajax_form_tblabrujukananak_table_refresh

  function do_ajax_form_tblabrujukananak_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_tblabrujukananak_table_refresh_cb_after_alert);
  } // do_ajax_form_tblabrujukananak_table_refresh_cb
  function do_ajax_form_tblabrujukananak_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_tblabrujukananak_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_tblabrujukananak_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_tblabrujukananak_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    sc_num_ult_line = iNumLinha;
    sc_num_ult_tr   = indexTR;
    scAjaxHideMessage();
    var var_subname_ = scAjaxGetFieldSelect("subname_" + iNumLinha);
    var var_kondisi_ = scAjaxGetFieldSelect("kondisi_" + iNumLinha);
    var var_jml_hari_ = scAjaxGetFieldText("jml_hari_" + iNumLinha);
    var var_oper_ = scAjaxGetFieldSelect("oper_" + iNumLinha);
    var var_n1_ = scAjaxGetFieldText("n1_" + iNumLinha);
    var var_n2_ = scAjaxGetFieldText("n2_" + iNumLinha);
    var var_id_ = scAjaxGetFieldHidden("id_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_tblabrujukananak_submit_form(var_subname_, var_kondisi_, var_jml_hari_, var_oper_, var_n1_, var_n2_, var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tblabrujukananak_submit_form_cb);
  } // do_ajax_form_tblabrujukananak_submit_form

  function do_ajax_form_tblabrujukananak_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("jml_hari_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("oper_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("n1_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("n2_" + sc_num_ult_line);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_tblabrujukananak_submit_form_cb_after_alert);
  } // do_ajax_form_tblabrujukananak_submit_form_cb
  function do_ajax_form_tblabrujukananak_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tblabrujukananak_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tblabrujukananak_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_tblabrujukananak_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("jml_hari_" + iNavForm);
      scAjaxHideErrorDisplay("oper_" + iNavForm);
      scAjaxHideErrorDisplay("n1_" + iNavForm);
      scAjaxHideErrorDisplay("n2_" + iNavForm);
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tblabrujukananak_navigate_form(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tblabrujukananak_navigate_form_cb);
  } // do_ajax_form_tblabrujukananak_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblabrujukananak']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tblabrujukananak_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tblabrujukananak_navigate_form_cb_after_alert);
  } // do_ajax_form_tblabrujukananak_navigate_form_cb
  function do_ajax_form_tblabrujukananak_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_tblabrujukananak_navigate_form_cb_after_alert
  function sc_hide_form_tblabrujukananak_form()
  {
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "jml_hari_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "oper_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "n1_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "n2_" + iNumLinha;
    iTotCampos++;
    ...
    ajax_error_list["kondisi_" + iNumLinha] = {"label": "Kondisi Anak<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["jml_hari_" + iNumLinha] = {"label": "Usia Anak<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["oper_" + iNumLinha] = {"label": "Oper<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["n1_" + iNumLinha] = {"label": "N. Rujukan 1<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["n2_" + iNumLinha] = {"label": "N. Rujukan 2<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_field_mult["jml_hari_"][iNumLinha] = "jml_hari_" + iNumLinha;
    ajax_field_mult["oper_"][iNumLinha] = "oper_" + iNumLinha;
    ajax_field_mult["n1_"][iNumLinha] = "n1_" + iNumLinha;
    ajax_field_mult["n2_"][iNumLinha] = "n2_" + iNumLinha;
    ...
    ajax_field_id["jml_hari_" + iNumLinha] = new Array("hidden_field_label_jml_hari_", "hidden_field_data_jml_hari_" + iNumLinha);
    ajax_field_id["oper_" + iNumLinha] = new Array("hidden_field_label_oper_", "hidden_field_data_oper_" + iNumLinha);
    ajax_field_id["n1_" + iNumLinha] = new Array("hidden_field_label_n1_", "hidden_field_data_n1_" + iNumLinha);
    ajax_field_id["n2_" + iNumLinha] = new Array("hidden_field_label_n2_", "hidden_field_data_n2_" + iNumLinha);
    ajax_error_count["subname_" + iNumLinha] = "off";
    ajax_error_count["kondisi_" + iNumLinha] = "off";
    ajax_error_count["jml_hari_" + iNumLinha] = "off";
    ajax_error_count["oper_" + iNumLinha] = "off";
    ajax_error_count["n1_" + iNumLinha] = "off";
    ajax_error_count["n2_" + iNumLinha] = "off";
    ajax_error_count["id_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["subname_" + iNumLinha] = "off";
    ajax_read_only["kondisi_" + iNumLinha] = "off";
    ajax_read_only["jml_hari_" + iNumLinha] = "off";
    ajax_read_only["oper_" + iNumLinha] = "off";
    ajax_read_only["n1_" + iNumLinha] = "off";
    ajax_read_only["n2_" + iNumLinha] = "off";
...
?>
    ...
    ajax_read_only["jml_hari_" + iNumLinha] = "on";
    ajax_read_only["oper_" + iNumLinha] = "on";
    ajax_read_only["n1_" + iNumLinha] = "on";
    ajax_read_only["n2_" + iNumLinha] = "on";
    ajax_read_only["id_" + iNumLinha] = "on";
<?php
}
?>
  ...
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["jml_hari_" + iNumLinha] = null;
    ajax_error_list["oper_" + iNumLinha] = null;
    ajax_error_list["n1_" + iNumLinha] = null;
    ajax_error_list["n2_" + iNumLinha] = null;
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["jml_hari_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["jml_hari_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["jml_hari_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["jml_hari_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["jml_hari_" + iNumLinha]["onfocus"] = new Array();
      ...
      ajax_error_list["n1_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["n1_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["n1_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["n1_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["n1_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["n2_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["n2_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["n2_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["n2_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["n2_" + iNumLinha]["onfocus"] = new Array();
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['subname_'])) ? $this->nmgp_cmp_readonly['subname_'] : 'off';
?>
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['jml_hari_'])) ? $this->nmgp_cmp_readonly['jml_hari_'] : 'off';
?>
    scAjaxFieldRead("jml_hari_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['n1_'])) ? $this->nmgp_cmp_readonly['n1_'] : 'off';
?>
    scAjaxFieldRead("n1_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['n2_'])) ? $this->nmgp_cmp_readonly['n2_'] : 'off';
?>
    scAjaxFieldRead("n2_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
?>
  ...
  function mdCloseObjects(iSeq)
  {
    ...
    scAjaxFieldRead("jml_hari_" + iSeq, "on");
    scAjaxFieldRead("oper_" + iSeq, "on");
    scAjaxFieldRead("n1_" + iSeq, "on");
    scAjaxFieldRead("n2_" + iSeq, "on");
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["subname_" + iRow] || "on" == ajax_error_count["kondisi_" + iRow] || "on" == ajax_error_count["jml_hari_" + iRow] || "on" == ajax_error_count["oper_" + iRow] || "on" == ajax_error_count["n1_" + iRow] || "on" == ajax_error_count["n2_" + iRow] || "on" == ajax_error_count["id_" + iRow]))
    {
      ...
      $("#hidden_field_data_jml_hari_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_oper_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_n1_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_n2_" + iRow).addClass("scFormErrorLine");
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["subname_" + iRow] && "off" == ajax_error_count["kondisi_" + iRow] && "off" == ajax_error_count["jml_hari_" + iRow] && "off" == ajax_error_count["oper_" + iRow] && "off" == ajax_error_count["n1_" + iRow] && "off" == ajax_error_count["n2_" + iRow] && "off" == ajax_error_count["id_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["subname_" + iRow] = "off";
        ajax_error_count["kondisi_" + iRow] = "off";
        ajax_error_count["jml_hari_" + iRow] = "off";
        ajax_error_count["oper_" + iRow] = "off";
        ajax_error_count["n1_" + iRow] = "off";
        ajax_error_count["n2_" + iRow] = "off";
      ...
      $("#hidden_field_data_jml_hari_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_oper_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_n1_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_n2_" + iRow).removeClass("scFormErrorLine");
