  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbdetailmargin" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbdetailmargin_form();
	}

  // ---------- Validate marginrj_
  function do_ajax_form_tbdetailmargin_validate_marginrj_(iNumLinha)
  {
    var nomeCampo_marginrj_ = "marginrj_" + iNumLinha;
    var var_marginrj_ = scAjaxGetFieldText(nomeCampo_marginrj_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdetailmargin_validate_marginrj_(var_marginrj_, iNumLinha, var_script_case_init, do_ajax_form_tbdetailmargin_validate_marginrj__cb);
  } // do_ajax_form_tbdetailmargin_validate_marginrj_

  function do_ajax_form_tbdetailmargin_validate_marginrj__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "marginrj_" + iLineNumber;
    }
    else
    {
      sFieldValid = "marginrj_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "marginrj_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "marginrj_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdetailmargin_validate_marginrj__cb

  // ---------- Validate margininap_
  function do_ajax_form_tbdetailmargin_validate_margininap_(iNumLinha)
  {
    var nomeCampo_margininap_ = "margininap_" + iNumLinha;
    var var_margininap_ = scAjaxGetFieldText(nomeCampo_margininap_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdetailmargin_validate_margininap_(var_margininap_, iNumLinha, var_script_case_init, do_ajax_form_tbdetailmargin_validate_margininap__cb);
  } // do_ajax_form_tbdetailmargin_validate_margininap_

  function do_ajax_form_tbdetailmargin_validate_margininap__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "margininap_" + iLineNumber;
    }
    else
    {
      sFieldValid = "margininap_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "margininap_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "margininap_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdetailmargin_validate_margininap__cb

  // ---------- Validate marginfarm_
  function do_ajax_form_tbdetailmargin_validate_marginfarm_(iNumLinha)
  {
    var nomeCampo_marginfarm_ = "marginfarm_" + iNumLinha;
    var var_marginfarm_ = scAjaxGetFieldText(nomeCampo_marginfarm_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdetailmargin_validate_marginfarm_(var_marginfarm_, iNumLinha, var_script_case_init, do_ajax_form_tbdetailmargin_validate_marginfarm__cb);
  } // do_ajax_form_tbdetailmargin_validate_marginfarm_

  function do_ajax_form_tbdetailmargin_validate_marginfarm__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "marginfarm_" + iLineNumber;
    }
    else
    {
      sFieldValid = "marginfarm_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "marginfarm_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "marginfarm_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdetailmargin_validate_marginfarm__cb

  // ---------- Validate marginkary_
  function do_ajax_form_tbdetailmargin_validate_marginkary_(iNumLinha)
  {
    var nomeCampo_marginkary_ = "marginkary_" + iNumLinha;
    var var_marginkary_ = scAjaxGetFieldText(nomeCampo_marginkary_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdetailmargin_validate_marginkary_(var_marginkary_, iNumLinha, var_script_case_init, do_ajax_form_tbdetailmargin_validate_marginkary__cb);
  } // do_ajax_form_tbdetailmargin_validate_marginkary_

  function do_ajax_form_tbdetailmargin_validate_marginkary__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "marginkary_" + iLineNumber;
    }
    else
    {
      sFieldValid = "marginkary_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "marginkary_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "marginkary_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdetailmargin_validate_marginkary__cb

  // ---------- Validate marginjamsos_
  function do_ajax_form_tbdetailmargin_validate_marginjamsos_(iNumLinha)
  {
    var nomeCampo_marginjamsos_ = "marginjamsos_" + iNumLinha;
    var var_marginjamsos_ = scAjaxGetFieldText(nomeCampo_marginjamsos_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdetailmargin_validate_marginjamsos_(var_marginjamsos_, iNumLinha, var_script_case_init, do_ajax_form_tbdetailmargin_validate_marginjamsos__cb);
  } // do_ajax_form_tbdetailmargin_validate_marginjamsos_

  function do_ajax_form_tbdetailmargin_validate_marginjamsos__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "marginjamsos_" + iLineNumber;
    }
    else
    {
      sFieldValid = "marginjamsos_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "marginjamsos_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "marginjamsos_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdetailmargin_validate_marginjamsos__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_tbdetailmargin_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_tbdetailmargin_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tbdetailmargin_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_tbdetailmargin_add_new_line_cb);
  } // do_ajax_form_tbdetailmargin_add_new_line

  function do_ajax_form_tbdetailmargin_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_tbdetailmargin_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_tbdetailmargin_backup_line(iNumLinha)
  {
    var var_id_ = scAjaxGetFieldText("id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdetailmargin_backup_line(var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_tbdetailmargin_backup_line_cb);
  } // do_ajax_form_tbdetailmargin_backup_line

  function do_ajax_form_tbdetailmargin_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_tbdetailmargin_backup_line_cb

  function do_ajax_form_tbdetailmargin_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_tbdetailmargin_cancel_insert

  function do_ajax_form_tbdetailmargin_cancel_update(iSeqVert)
  {
    do_ajax_form_tbdetailmargin_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_tbdetailmargin_cancel_update

  function do_ajax_form_tbdetailmargin_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_tbdetailmargin_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_tbdetailmargin_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_tbdetailmargin_table_refresh(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbdetailmargin_table_refresh_cb);
  } //  do_ajax_form_tbdetailmargin_table_refresh

  function do_ajax_form_tbdetailmargin_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_tbdetailmargin_table_refresh_cb_after_alert);
  } // do_ajax_form_tbdetailmargin_table_refresh_cb
  function do_ajax_form_tbdetailmargin_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_tbdetailmargin_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_tbdetailmargin_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_tbdetailmargin_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    sc_num_ult_line = iNumLinha;
    sc_num_ult_tr   = indexTR;
    scAjaxHideMessage();
    var var_marginrj_ = scAjaxGetFieldText("marginrj_" + iNumLinha);
    var var_margininap_ = scAjaxGetFieldText("margininap_" + iNumLinha);
    var var_marginfarm_ = scAjaxGetFieldText("marginfarm_" + iNumLinha);
    var var_marginkary_ = scAjaxGetFieldText("marginkary_" + iNumLinha);
    var var_marginjamsos_ = scAjaxGetFieldText("marginjamsos_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_tbdetailmargin_submit_form(var_marginrj_, var_margininap_, var_marginfarm_, var_marginkary_, var_marginjamsos_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbdetailmargin_submit_form_cb);
  } // do_ajax_form_tbdetailmargin_submit_form

  function do_ajax_form_tbdetailmargin_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("marginrj_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("margininap_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("marginfarm_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("marginkary_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("marginjamsos_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_tbdetailmargin_submit_form_cb_after_alert);
  } // do_ajax_form_tbdetailmargin_submit_form_cb
  function do_ajax_form_tbdetailmargin_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbdetailmargin_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tbdetailmargin_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_tbdetailmargin_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("marginrj_" + iNavForm);
      scAjaxHideErrorDisplay("margininap_" + iNavForm);
      scAjaxHideErrorDisplay("marginfarm_" + iNavForm);
      scAjaxHideErrorDisplay("marginkary_" + iNavForm);
      scAjaxHideErrorDisplay("marginjamsos_" + iNavForm);
    }
    var var_id_ = document.F2.id_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tbdetailmargin_navigate_form(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbdetailmargin_navigate_form_cb);
  } // do_ajax_form_tbdetailmargin_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailmargin']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbdetailmargin_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbdetailmargin_navigate_form_cb_after_alert);
  } // do_ajax_form_tbdetailmargin_navigate_form_cb
  function do_ajax_form_tbdetailmargin_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_tbdetailmargin_navigate_form_cb_after_alert
  function sc_hide_form_tbdetailmargin_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "marginrj_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "margininap_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "marginfarm_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "marginkary_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "marginjamsos_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["marginrj_" + iNumLinha] = {"label": "Margin RJ<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["margininap_" + iNumLinha] = {"label": "Margin RI<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["marginfarm_" + iNumLinha] = {"label": "Margin Farmasi<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["marginkary_" + iNumLinha] = {"label": "Margin Karyawan<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["marginjamsos_" + iNumLinha] = {"label": "Margin Jamsos<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["marginrj_"][iNumLinha] = "marginrj_" + iNumLinha;
    ajax_field_mult["margininap_"][iNumLinha] = "margininap_" + iNumLinha;
    ajax_field_mult["marginfarm_"][iNumLinha] = "marginfarm_" + iNumLinha;
    ajax_field_mult["marginkary_"][iNumLinha] = "marginkary_" + iNumLinha;
    ajax_field_mult["marginjamsos_"][iNumLinha] = "marginjamsos_" + iNumLinha;
    ajax_field_id["marginrj_" + iNumLinha] = new Array("hidden_field_label_marginrj_", "hidden_field_data_marginrj_" + iNumLinha);
    ajax_field_id["margininap_" + iNumLinha] = new Array("hidden_field_label_margininap_", "hidden_field_data_margininap_" + iNumLinha);
    ajax_field_id["marginfarm_" + iNumLinha] = new Array("hidden_field_label_marginfarm_", "hidden_field_data_marginfarm_" + iNumLinha);
    ajax_field_id["marginkary_" + iNumLinha] = new Array("hidden_field_label_marginkary_", "hidden_field_data_marginkary_" + iNumLinha);
    ajax_field_id["marginjamsos_" + iNumLinha] = new Array("hidden_field_label_marginjamsos_", "hidden_field_data_marginjamsos_" + iNumLinha);
    ajax_error_count["marginrj_" + iNumLinha] = "off";
    ajax_error_count["margininap_" + iNumLinha] = "off";
    ajax_error_count["marginfarm_" + iNumLinha] = "off";
    ajax_error_count["marginkary_" + iNumLinha] = "off";
    ajax_error_count["marginjamsos_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["marginrj_" + iNumLinha] = "off";
    ajax_read_only["margininap_" + iNumLinha] = "off";
    ajax_read_only["marginfarm_" + iNumLinha] = "off";
    ajax_read_only["marginkary_" + iNumLinha] = "off";
    ajax_read_only["marginjamsos_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["marginrj_" + iNumLinha] = "on";
    ajax_read_only["margininap_" + iNumLinha] = "on";
    ajax_read_only["marginfarm_" + iNumLinha] = "on";
    ajax_read_only["marginkary_" + iNumLinha] = "on";
    ajax_read_only["marginjamsos_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["marginrj_" + iNumLinha] = null;
    ajax_error_list["margininap_" + iNumLinha] = null;
    ajax_error_list["marginfarm_" + iNumLinha] = null;
    ajax_error_list["marginkary_" + iNumLinha] = null;
    ajax_error_list["marginjamsos_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "marginrj_": new Array(),
    "margininap_": new Array(),
    "marginfarm_": new Array(),
    "marginkary_": new Array(),
    "marginjamsos_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["marginrj_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["marginrj_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["marginrj_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["marginrj_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["marginrj_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["margininap_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["margininap_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["margininap_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["margininap_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["margininap_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["marginfarm_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["marginfarm_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["marginfarm_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["marginfarm_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["marginfarm_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["marginkary_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["marginkary_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["marginkary_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["marginkary_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["marginkary_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["marginjamsos_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["marginjamsos_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["marginjamsos_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["marginjamsos_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["marginjamsos_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['marginrj_'])) ? $this->nmgp_cmp_readonly['marginrj_'] : 'off';
?>
    scAjaxFieldRead("marginrj_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['margininap_'])) ? $this->nmgp_cmp_readonly['margininap_'] : 'off';
?>
    scAjaxFieldRead("margininap_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['marginfarm_'])) ? $this->nmgp_cmp_readonly['marginfarm_'] : 'off';
?>
    scAjaxFieldRead("marginfarm_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['marginkary_'])) ? $this->nmgp_cmp_readonly['marginkary_'] : 'off';
?>
    scAjaxFieldRead("marginkary_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['marginjamsos_'])) ? $this->nmgp_cmp_readonly['marginjamsos_'] : 'off';
?>
    scAjaxFieldRead("marginjamsos_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("marginrj_" + iSeq, "on");
    scAjaxFieldRead("margininap_" + iSeq, "on");
    scAjaxFieldRead("marginfarm_" + iSeq, "on");
    scAjaxFieldRead("marginkary_" + iSeq, "on");
    scAjaxFieldRead("marginjamsos_" + iSeq, "on");
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["marginrj_" + iRow] || "on" == ajax_error_count["margininap_" + iRow] || "on" == ajax_error_count["marginfarm_" + iRow] || "on" == ajax_error_count["marginkary_" + iRow] || "on" == ajax_error_count["marginjamsos_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_marginrj_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_margininap_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_marginfarm_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_marginkary_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_marginjamsos_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["marginrj_" + iRow] && "off" == ajax_error_count["margininap_" + iRow] && "off" == ajax_error_count["marginfarm_" + iRow] && "off" == ajax_error_count["marginkary_" + iRow] && "off" == ajax_error_count["marginjamsos_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["marginrj_" + iRow] = "off";
        ajax_error_count["margininap_" + iRow] = "off";
        ajax_error_count["marginfarm_" + iRow] = "off";
        ajax_error_count["marginkary_" + iRow] = "off";
        ajax_error_count["marginjamsos_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_marginrj_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_margininap_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_marginfarm_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_marginkary_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_marginjamsos_" + iRow).removeClass("scFormErrorLine");
    }
  }
