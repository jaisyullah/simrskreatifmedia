...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_tblabcategory"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_tblabcategory"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_tblabcategory'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tblabcategory']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_tblabcategory']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tblabcategory']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_tblabcategory']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_tblabcategory']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_tblabcategory</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_tblabcategory']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_tblabcategory']['embutida_filho'] as $ind => $sc_init)
          {
