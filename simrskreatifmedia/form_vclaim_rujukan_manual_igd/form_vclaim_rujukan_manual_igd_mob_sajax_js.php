  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_vclaim_rujukan_manual_igd_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_vclaim_rujukan_manual_igd_mob_form();
	}

  // ---------- Validate pilih
  function do_ajax_form_vclaim_rujukan_manual_igd_mob_validate_pilih()
  {
    var nomeCampo_pilih = "pilih";
    var var_pilih = scAjaxGetFieldSelect(nomeCampo_pilih);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_rujukan_manual_igd_mob_validate_pilih(var_pilih, var_script_case_init, do_ajax_form_vclaim_rujukan_manual_igd_mob_validate_pilih_cb);
  } // do_ajax_form_vclaim_rujukan_manual_igd_mob_validate_pilih

  function do_ajax_form_vclaim_rujukan_manual_igd_mob_validate_pilih_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_rujukan_manual_igd_mob_validate_pilih_cb

  // ---------- Validate pelayanan
  function do_ajax_form_vclaim_rujukan_manual_igd_mob_validate_pelayanan()
  {
    var nomeCampo_pelayanan = "pelayanan";
    var var_pelayanan = scAjaxGetFieldSelect(nomeCampo_pelayanan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_rujukan_manual_igd_mob_validate_pelayanan(var_pelayanan, var_script_case_init, do_ajax_form_vclaim_rujukan_manual_igd_mob_validate_pelayanan_cb);
  } // do_ajax_form_vclaim_rujukan_manual_igd_mob_validate_pelayanan

  function do_ajax_form_vclaim_rujukan_manual_igd_mob_validate_pelayanan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pelayanan";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_rujukan_manual_igd_mob_validate_pelayanan_cb

  // ---------- Validate tglsep
  function do_ajax_form_vclaim_rujukan_manual_igd_mob_validate_tglsep()
  {
    var nomeCampo_tglsep = "tglsep";
    var var_tglsep = scAjaxGetFieldText(nomeCampo_tglsep);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_rujukan_manual_igd_mob_validate_tglsep(var_tglsep, var_script_case_init, do_ajax_form_vclaim_rujukan_manual_igd_mob_validate_tglsep_cb);
  } // do_ajax_form_vclaim_rujukan_manual_igd_mob_validate_tglsep

  function do_ajax_form_vclaim_rujukan_manual_igd_mob_validate_tglsep_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tglsep";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_rujukan_manual_igd_mob_validate_tglsep_cb

  // ---------- Validate ppkasalpeserta
  function do_ajax_form_vclaim_rujukan_manual_igd_mob_validate_ppkasalpeserta()
  {
    var nomeCampo_ppkasalpeserta = "ppkasalpeserta";
    var var_ppkasalpeserta = scAjaxGetFieldText(nomeCampo_ppkasalpeserta);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_rujukan_manual_igd_mob_validate_ppkasalpeserta(var_ppkasalpeserta, var_script_case_init, do_ajax_form_vclaim_rujukan_manual_igd_mob_validate_ppkasalpeserta_cb);
  } // do_ajax_form_vclaim_rujukan_manual_igd_mob_validate_ppkasalpeserta

  function do_ajax_form_vclaim_rujukan_manual_igd_mob_validate_ppkasalpeserta_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ppkasalpeserta";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_rujukan_manual_igd_mob_validate_ppkasalpeserta_cb

  // ---------- Validate jnsnomor
  function do_ajax_form_vclaim_rujukan_manual_igd_mob_validate_jnsnomor()
  {
    var nomeCampo_jnsnomor = "jnsnomor";
    var var_jnsnomor = scAjaxGetFieldSelect(nomeCampo_jnsnomor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_rujukan_manual_igd_mob_validate_jnsnomor(var_jnsnomor, var_script_case_init, do_ajax_form_vclaim_rujukan_manual_igd_mob_validate_jnsnomor_cb);
  } // do_ajax_form_vclaim_rujukan_manual_igd_mob_validate_jnsnomor

  function do_ajax_form_vclaim_rujukan_manual_igd_mob_validate_jnsnomor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "jnsnomor";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_rujukan_manual_igd_mob_validate_jnsnomor_cb

  // ---------- Validate nomor
  function do_ajax_form_vclaim_rujukan_manual_igd_mob_validate_nomor()
  {
    var nomeCampo_nomor = "nomor";
    var var_nomor = scAjaxGetFieldText(nomeCampo_nomor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_rujukan_manual_igd_mob_validate_nomor(var_nomor, var_script_case_init, do_ajax_form_vclaim_rujukan_manual_igd_mob_validate_nomor_cb);
  } // do_ajax_form_vclaim_rujukan_manual_igd_mob_validate_nomor

  function do_ajax_form_vclaim_rujukan_manual_igd_mob_validate_nomor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nomor";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_rujukan_manual_igd_mob_validate_nomor_cb

  // ---------- Event onchange pilih
  function do_ajax_form_vclaim_rujukan_manual_igd_mob_event_pilih_onchange()
  {
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_vclaim_rujukan_manual_igd_mob_event_pilih_onchange(var_script_case_init, do_ajax_form_vclaim_rujukan_manual_igd_mob_event_pilih_onchange_cb);
  } // do_ajax_form_vclaim_rujukan_manual_igd_mob_event_pilih_onchange

  function do_ajax_form_vclaim_rujukan_manual_igd_mob_event_pilih_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "pilih";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_vclaim_rujukan_manual_igd_mob_event_pilih_onchange_cb_after_alert);
  } // do_ajax_form_vclaim_rujukan_manual_igd_mob_event_pilih_onchange_cb
  function do_ajax_form_vclaim_rujukan_manual_igd_mob_event_pilih_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_vclaim_rujukan_manual_igd_mob_event_pilih_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_vclaim_rujukan_manual_igd_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_vclaim_rujukan_manual_igd_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_pilih = scAjaxGetFieldSelect("pilih");
    var var_pelayanan = scAjaxGetFieldSelect("pelayanan");
    var var_tglsep = scAjaxGetFieldText("tglsep");
    var var_ppkasalpeserta = scAjaxGetFieldText("ppkasalpeserta");
    var var_jnsnomor = scAjaxGetFieldSelect("jnsnomor");
    var var_nomor = scAjaxGetFieldText("nomor");
    ...
    scAjaxProcOn();
    x_ajax_form_vclaim_rujukan_manual_igd_mob_submit_form(var_pilih, var_pelayanan, var_tglsep, var_ppkasalpeserta, var_jnsnomor, var_nomor, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_vclaim_rujukan_manual_igd_mob_submit_form_cb);
  } // do_ajax_form_vclaim_rujukan_manual_igd_mob_submit_form

  function do_ajax_form_vclaim_rujukan_manual_igd_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_vclaim_rujukan_manual_igd_mob_submit_form_cb_after_alert);
  } // do_ajax_form_vclaim_rujukan_manual_igd_mob_submit_form_cb
  function do_ajax_form_vclaim_rujukan_manual_igd_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_vclaim_rujukan_manual_igd_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_vclaim_rujukan_manual_igd_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_form_vclaim_rujukan_manual_igd_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_rujukan_manual_igd_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_vclaim_rujukan_manual_igd_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_vclaim_rujukan_manual_igd_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_vclaim_rujukan_manual_igd_mob_navigate_form_cb
  function do_ajax_form_vclaim_rujukan_manual_igd_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_vclaim_rujukan_manual_igd_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_vclaim_rujukan_manual_igd_mob_navigate_form_cb_after_alert
  function sc_hide_form_vclaim_rujukan_manual_igd_mob_form()
  {
  ...
  ajax_field_list[0] = "pilih";
  ajax_field_list[1] = "pelayanan";
  ajax_field_list[2] = "tglsep";
  ajax_field_list[3] = "ppkasalpeserta";
  ajax_field_list[4] = "jnsnomor";
  ajax_field_list[5] = "nomor";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "pilih": {"label": "Pilih", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "pelayanan": {"label": "Pelayanan", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "ppkasalpeserta": {"label": "PPK Asal Peserta", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "jnsnomor": {"label": "Jenis Nomor", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "nomor": {"label": "Nomor", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    ...
    "pelayanan": new Array(),
    "tglsep": new Array(),
    "ppkasalpeserta": new Array(),
    "jnsnomor": new Array(),
    "nomor": new Array()
  };
  ajax_field_mult["pilih"][1] = "pilih";
  ajax_field_mult["pelayanan"][1] = "pelayanan";
  ajax_field_mult["tglsep"][1] = "tglsep";
  ajax_field_mult["ppkasalpeserta"][1] = "ppkasalpeserta";
  ajax_field_mult["jnsnomor"][1] = "jnsnomor";
  ajax_field_mult["nomor"][1] = "nomor";

  var ajax_field_id = {
    "pilih": new Array("hidden_field_label_pilih", "hidden_field_data_pilih"),
    "pelayanan": new Array("hidden_field_label_pelayanan", "hidden_field_data_pelayanan"),
    "tglsep": new Array("hidden_field_label_tglsep", "hidden_field_data_tglsep"),
    "ppkasalpeserta": new Array("hidden_field_label_ppkasalpeserta", "hidden_field_data_ppkasalpeserta"),
    "jnsnomor": new Array("hidden_field_label_jnsnomor", "hidden_field_data_jnsnomor"),
    "nomor": new Array("hidden_field_label_nomor", "hidden_field_data_nomor")
  };
