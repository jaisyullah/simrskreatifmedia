<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_tbtracer']['glo_nm_path_imag_temp'] . "/sc_apl_default_simrskreatifmedia.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_tbtracer_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_tbtracer_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbtracer']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tbtracer']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels     = array();
   $tab_ger_campos['qrcode'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['qrcode'] = "qrcode";
   }
   else
   {
       $tab_def_campos['qrcode'] = "noStruk";
   }
   $tab_labels["qrcode"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbtracer']['labels']["qrcode"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbtracer']['labels']["qrcode"] : "Qrcode";
   $tab_ger_campos['nostruk'] = "on";
   $tab_def_campos['nostruk'] = "noStruk";
   $tab_labels["nostruk"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbtracer']['labels']["nostruk"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbtracer']['labels']["nostruk"] : "No Struk";
   ...
   {
       $tab_def_campos['sc_field_1'] = "select custCode from (select custCode, struckNo from tbantrian union select custCode, struckNo from tbadmrawatinap) a where a.struckNo = '{noStruk}'";
   }
   $tab_labels["sc_field_1"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbtracer']['labels']["sc_field_1"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbtracer']['labels']["sc_field_1"] : "No RM";
...
FROM tbcustomer 
WHERE custCode = '{No RM}' 
ORDER BY name, salut";
   }
   $tab_labels["sc_field_0"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbtracer']['labels']["sc_field_0"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbtracer']['labels']["sc_field_0"] : "Nama";
   ...
   $tab_labels["usia"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbtracer']['labels']["usia"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbtracer']['labels']["usia"] : "Usia";
   $tab_ger_campos['alamat'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['alamat'] = "Alamat";
   }
   else
   {
       $tab_def_campos['alamat'] = "SELECT address 
FROM tbcustomer 
WHERE custCode = '{No RM}' 
ORDER BY address";
   }
   $tab_labels["alamat"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbtracer']['labels']["alamat"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbtracer']['labels']["alamat"] : "Alamat";
   $tab_ger_campos['lokasi'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['lokasi'] = "Lokasi";
   }
   else
   {
       $tab_def_campos['lokasi'] = "SELECT
	c. NAME AS poly
FROM
	tbantrian a
LEFT JOIN (
...
GROUP BY
   ...
   $tab_labels["lokasi"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbtracer']['labels']["lokasi"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbtracer']['labels']["lokasi"] : "Lokasi";
   ...
   {
       $tab_def_campos['diagnosa'] = "SELECT diagnosa1 
FROM tbdetailrawatjalan 
WHERE noStruk = '{noStruk}' 
ORDER BY diagnosa1";
   }
   $tab_labels["diagnosa"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbtracer']['labels']["diagnosa"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbtracer']['labels']["diagnosa"] : "Diagnosa";
   ...
   {
       $tab_def_campos['icd'] = "SELECT icd1 
FROM tbdetailrawatjalan 
WHERE noStruk = '{noStruk}' 
ORDER BY diagnosa1";
   }
   $tab_labels["icd"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbtracer']['labels']["icd"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbtracer']['labels']["icd"] : "ICD";
   $tab_ger_campos['penerima'] = "on";
   $tab_def_campos['penerima'] = "penerima";
   $tab_labels["penerima"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbtracer']['labels']["penerima"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbtracer']['labels']["penerima"] : "Penerima";
   $tab_ger_campos['status'] = "on";
   $tab_def_campos['status'] = "status";
   $tab_labels["status"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbtracer']['labels']["status"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbtracer']['labels']["status"] : "Status";
   $tab_ger_campos['sc_field_1'] = "none";
   $tab_ger_campos['sc_field_0'] = "none";
   $tab_ger_campos['usia'] = "none";
   $tab_ger_campos['alamat'] = "none";
   $tab_ger_campos['lokasi'] = "none";
   $tab_ger_campos['diagnosa'] = "none";
   $tab_ger_campos['icd'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_tbtracer']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_tbtracer']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_tbtracer']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbtracer']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tbtracer']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_tbtracer']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_tbtracer']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_tbtracer']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_tbtracer']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_title'] ?> Tracer RM</TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_tbtracer_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_tbtracer']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_tbtracer']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_tbtracer']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_tbtracer']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_tbtracer']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
