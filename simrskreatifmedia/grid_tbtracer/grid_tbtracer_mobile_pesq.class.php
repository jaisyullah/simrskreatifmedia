...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_nostruk"  <?php echo $str_hide_nostruk?>><?php
      if ($nostruk != "")
      {
      $nostruk_look = substr($this->Db->qstr($nostruk), 1, -1); 
      $nmgp_def_dados = array(); 
...
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_nostruk" name="nostruk_autocomp" size="15"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 15, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
