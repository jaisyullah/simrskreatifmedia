<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tbtracer']['sc_process_barr'] = true;
require_once('../grid_tbtracer/index.php');
unset($_SESSION['scriptcase']['grid_tbtracer']['sc_process_barr']);
$ExportCtrl = new grid_tbtracer_export_control;
$ExportCtrl->Export_barr();

class grid_tbtracer_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_title'] ?> Tracer RM :: Excel</TITLE>
