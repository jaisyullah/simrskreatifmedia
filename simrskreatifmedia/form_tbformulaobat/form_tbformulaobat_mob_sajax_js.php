  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbformulaobat_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbformulaobat_mob_form();
	}

  // ---------- Validate id
  function do_ajax_form_tbformulaobat_mob_validate_id()
  {
    var nomeCampo_id = "id";
    var var_id = scAjaxGetFieldHidden(nomeCampo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbformulaobat_mob_validate_id(var_id, var_script_case_init, do_ajax_form_tbformulaobat_mob_validate_id_cb);
  } // do_ajax_form_tbformulaobat_mob_validate_id

  function do_ajax_form_tbformulaobat_mob_validate_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbformulaobat_mob_validate_id_cb

  // ---------- Validate namaformula
  function do_ajax_form_tbformulaobat_mob_validate_namaformula()
  {
    var nomeCampo_namaformula = "namaformula";
    var var_namaformula = scAjaxGetFieldText(nomeCampo_namaformula);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbformulaobat_mob_validate_namaformula(var_namaformula, var_script_case_init, do_ajax_form_tbformulaobat_mob_validate_namaformula_cb);
  } // do_ajax_form_tbformulaobat_mob_validate_namaformula

  function do_ajax_form_tbformulaobat_mob_validate_namaformula_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "namaformula";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbformulaobat_mob_validate_namaformula_cb

  // ---------- Validate detailformula
  function do_ajax_form_tbformulaobat_mob_validate_detailformula()
  {
    var nomeCampo_detailformula = "detailformula";
    var var_detailformula = scAjaxGetFieldText(nomeCampo_detailformula);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbformulaobat_mob_validate_detailformula(var_detailformula, var_script_case_init, do_ajax_form_tbformulaobat_mob_validate_detailformula_cb);
  } // do_ajax_form_tbformulaobat_mob_validate_detailformula

  function do_ajax_form_tbformulaobat_mob_validate_detailformula_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "detailformula";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbformulaobat_mob_validate_detailformula_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tbformulaobat_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tbformulaobat_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id = scAjaxGetFieldHidden("id");
    var var_namaformula = scAjaxGetFieldText("namaformula");
    ...
    scAjaxProcOn();
    x_ajax_form_tbformulaobat_mob_submit_form(var_id, var_namaformula, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbformulaobat_mob_submit_form_cb);
  } // do_ajax_form_tbformulaobat_mob_submit_form

  function do_ajax_form_tbformulaobat_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("namaformula");
      scAjaxHideErrorDisplay("detailformula");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tbformulaobat_mob_submit_form_cb_after_alert);
  } // do_ajax_form_tbformulaobat_mob_submit_form_cb
  function do_ajax_form_tbformulaobat_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbformulaobat_mob_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_tbdetailformulaobat_mob"] = "off";

  function do_ajax_form_tbformulaobat_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    scStatusDetail["form_tbdetailformulaobat_mob"] = "on";
    x_ajax_form_tbformulaobat_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbformulaobat_mob_navigate_form_cb);
  } // do_ajax_form_tbformulaobat_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbformulaobat_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbformulaobat_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_tbdetailformulaobat_mob"] && "nmsc_iframe_liga_form_tbdetailformulaobat_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_tbdetailformulaobat_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_tbdetailformulaobat_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_tbdetailformulaobat_mob').contentWindow.nm_move('apl_detalhe', true, '500');
        document.getElementById('nmsc_iframe_liga_form_tbdetailformulaobat_mob').style.height = "500";
        document.getElementById('nmsc_iframe_liga_form_tbdetailformulaobat_mob').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbformulaobat_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_tbformulaobat_mob_navigate_form_cb
  function do_ajax_form_tbformulaobat_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_tbformulaobat_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_tbformulaobat_mob_navigate_form_cb_after_alert
  function sc_hide_form_tbformulaobat_mob_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_tbdetailformulaobat_mob"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[1] = "namaformula";
  ajax_field_list[2] = "detailformula";
  ...
  var ajax_error_list = {
    ...
    "namaformula": {"label": "Nama Formula", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "detailformula": {"label": "", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "id": new Array(),
    "namaformula": new Array(),
    "detailformula": new Array()
  };
  ajax_field_mult["id"][1] = "id";
  ajax_field_mult["namaformula"][1] = "namaformula";
  ajax_field_mult["detailformula"][1] = "detailformula";

  var ajax_field_id = {
    "id": new Array("hidden_field_label_id", "hidden_field_data_id"),
    "namaformula": new Array("hidden_field_label_namaformula", "hidden_field_data_namaformula"),
    "detailformula": new Array("hidden_field_label_detailformula", "hidden_field_data_detailformula")
  };
