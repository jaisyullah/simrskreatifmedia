...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "trandate";$Nm_datas[] = "trandate";$Nm_numeric[] = "id";$Nm_numeric[] = "deleted";$Nm_numeric[] = "iskaryawan";$Nm_numeric[] = "total";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_struk_cond" name="struk_cond" onChange="nm_campos_between(document.getElementById('id_vis_struk'), this, 'struk')">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_resep_cond" name="resep_cond" onChange="nm_campos_between(document.getElementById('id_vis_resep'), this, 'resep')">
      ...
      <br><span id="id_hide_resep"  <?php echo $str_hide_resep?>><?php
      if ($resep != "")
      {
      $resep_look = substr($this->Db->qstr($resep), 1, -1); 
      $nmgp_def_dados = array(); 
