...
<?php
   ...
   $Ord_Cmp = new grid_select_pob_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_select_pob_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_select_pob']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_select_pob']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["trancode"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_select_pob']['labels']["trancode"])) ? $_SESSION['sc_session'][$sc_init]['grid_select_pob']['labels']["trancode"] : "Kode Transaksi";
   $tab_ger_campos['pasien'] = "on";
   $tab_def_campos['pasien'] = "pasien";
   $tab_labels["pasien"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_select_pob']['labels']["pasien"])) ? $_SESSION['sc_session'][$sc_init]['grid_select_pob']['labels']["pasien"] : "Pasien ?";
   $tab_ger_campos['custcode'] = "on";
   $tab_def_campos['custcode'] = "custcode";
   $tab_labels["custcode"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_select_pob']['labels']["custcode"])) ? $_SESSION['sc_session'][$sc_init]['grid_select_pob']['labels']["custcode"] : "No. RM (Jika Pasien)";
   $tab_ger_campos['extname'] = "on";
   $tab_def_campos['extname'] = "extname";
   $tab_labels["extname"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_select_pob']['labels']["extname"])) ? $_SESSION['sc_session'][$sc_init]['grid_select_pob']['labels']["extname"] : "Nama Bebas (Non Pasien)";
   $tab_ger_campos['total'] = "on";
   $tab_def_campos['total'] = "total";
   $tab_labels["total"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_select_pob']['labels']["total"])) ? $_SESSION['sc_session'][$sc_init]['grid_select_pob']['labels']["total"] : "Total";
   $tab_ger_campos['trandate'] = "on";
   $tab_def_campos['trandate'] = "trandate";
   $tab_labels["trandate"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_select_pob']['labels']["trandate"])) ? $_SESSION['sc_session'][$sc_init]['grid_select_pob']['labels']["trandate"] : "Tgl. Transaksi";
   $tab_ger_campos['struk'] = "on";
   $tab_def_campos['struk'] = "struk";
   $tab_labels["struk"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_select_pob']['labels']["struk"])) ? $_SESSION['sc_session'][$sc_init]['grid_select_pob']['labels']["struk"] : "Struk Daftar POB";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_select_pob']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_select_pob']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_select_pob']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_select_pob']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_select_pob']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_select_pob']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_select_pob']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_select_pob']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_select_pob']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_select_pob_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_select_pob']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_select_pob']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_select_pob']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_select_pob']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_select_pob']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
