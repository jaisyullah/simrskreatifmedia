...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_select_pob"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_select_pob"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_select_pob']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_select_pob']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_select_pob']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_select_pob']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_select_pob']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_select_pob']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_select_pob']['embutida_filho'] as $ind => $sc_init)
          {
