<?php
@session_start() ;
$_SESSION['scriptcase']['grid_select_pob']['sc_process_barr'] = true;
require_once('../grid_select_pob/index.php');
unset($_SESSION['scriptcase']['grid_select_pob']['sc_process_barr']);
$ExportCtrl = new grid_select_pob_export_control;
$ExportCtrl->Export_barr();

class grid_select_pob_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_title'] ?> tbdrugsell :: Excel</TITLE>
