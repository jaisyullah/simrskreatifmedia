...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_tglperiksa_hora' + iSeqRow).bind('blur', function() { sc_form_tbfisikigd_old_tglperiksa_hora_onblur(this, iSeqRow) })
                                             .bind('focus', function() { sc_form_tbfisikigd_old_tglperiksa_hora_onfocus(this, iSeqRow) });
} // scJQEventsAdd
...
function sc_form_tbfisikigd_old_tglperiksa_hora_onblur(oThis, iSeqRow) {
  do_ajax_form_tbfisikigd_old_validate_tglperiksa();
  scCssBlur(oThis);
}
...
function sc_form_tbfisikigd_old_tglperiksa_hora_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function scHidePage(pageNo) {
	$("#id_form_tbfisikigd_old_form" + pageNo).hide();
}
