<?php
@session_start() ;
$_SESSION['scriptcase']['grid_lap_demo_agama']['sc_process_barr'] = true;
require_once('../grid_lap_demo_agama/index.php');
unset($_SESSION['scriptcase']['grid_lap_demo_agama']['sc_process_barr']);
$ExportCtrl = new grid_lap_demo_agama_export_control;
$ExportCtrl->Export_barr();

class grid_lap_demo_agama_export_control
{
