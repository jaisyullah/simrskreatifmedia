...
<?php
   ...
   $Ord_Cmp = new grid_lap_demo_agama_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_lap_demo_agama_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_lap_demo_agama']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_lap_demo_agama']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["custcode"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_lap_demo_agama']['labels']["custcode"])) ? $_SESSION['sc_session'][$sc_init]['grid_lap_demo_agama']['labels']["custcode"] : "No RM";
   $tab_ger_campos['name'] = "on";
   $tab_def_campos['name'] = "name";
   $tab_labels["name"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_lap_demo_agama']['labels']["name"])) ? $_SESSION['sc_session'][$sc_init]['grid_lap_demo_agama']['labels']["name"] : "Nama";
   $tab_ger_campos['salut'] = "on";
   $tab_def_campos['salut'] = "salut";
   $tab_labels["salut"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_lap_demo_agama']['labels']["salut"])) ? $_SESSION['sc_session'][$sc_init]['grid_lap_demo_agama']['labels']["salut"] : "Panggilan";
   $tab_ger_campos['religion'] = "on";
   $tab_def_campos['religion'] = "religion";
   $tab_labels["religion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_lap_demo_agama']['labels']["religion"])) ? $_SESSION['sc_session'][$sc_init]['grid_lap_demo_agama']['labels']["religion"] : "Agama";
   $tab_ger_campos['registerdate'] = "on";
   $tab_def_campos['registerdate'] = "registerDate";
   $tab_labels["registerdate"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_lap_demo_agama']['labels']["registerdate"])) ? $_SESSION['sc_session'][$sc_init]['grid_lap_demo_agama']['labels']["registerdate"] : "Tgl. Daftar";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_lap_demo_agama']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_lap_demo_agama']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_lap_demo_agama']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_lap_demo_agama']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_lap_demo_agama']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_lap_demo_agama']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_lap_demo_agama']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_lap_demo_agama']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_lap_demo_agama']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_lap_demo_agama_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_lap_demo_agama']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_lap_demo_agama']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_lap_demo_agama']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_lap_demo_agama']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_lap_demo_agama']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
