...
class grid_lap_demo_agama_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function __construct($tipo = "")
   {
      ...
      $this->array_total_religion = array();
   ...
   function initializeButtons()
   {
      ...
      $this->nmgp_botoes['chart_exit'] = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['dashboard_info']['under_dashboard'] ? "off" : "on";
   ...
   { 
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['grid_lap_demo_agama']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['grid_lap_demo_agama']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['res_hrz'];
      $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
      $dir_raiz          = substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['where_resumo'] = "";
      }
      $this->inicializa_vars();
      $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['SC_Ind_Groupby'];
      $this->Total->$Gb_geral();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['contr_total_geral'] == "OK")
      {
          $this->array_total_religion = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['arr_total']['religion'];
      }
      else
      {
          $this->array_total_religion = array();
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['tot_geral'][1];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['tot_geral'][1] == 0)
      {
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['arr_total']['religion'] = $this->array_total_religion;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['json_use_label'])
       {
          $Lab_religion = "religion";
       }
       else
       {
          $Lab_religion = "Religion";
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['labels']['custcode']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['labels']['custcode'] = "No RM"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['labels']['name']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['labels']['name'] = "Nama"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['labels']['salut']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['labels']['salut'] = "Panggilan"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['labels']['religion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['labels']['religion'] = "Agama"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['labels']['registerdate']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['labels']['registerdate'] = "Tgl. Daftar"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['labels']['id']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['labels']['id'] = "Id"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['labels']['address']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['labels']['address'] = "Address"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['labels']['city']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['labels']['city'] = "City"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['labels']['postcode']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['labels']['postcode'] = "Post Code"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['labels']['birthdate']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['labels']['birthdate'] = "Birth Date"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['labels']['phone']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['labels']['phone'] = "Phone"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['labels']['hp']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['labels']['hp'] = "Hp"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['labels']['spouse']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['labels']['spouse'] = "Spouse"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['labels']['sex']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['labels']['sex'] = "Jenis Kelamin"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['labels']['type']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['labels']['type'] = "Type"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['labels']['typename']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['labels']['typename'] = "Type Name"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['labels']['hta']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['labels']['hta'] = "Hta"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['labels']['lasthta']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['labels']['lasthta'] = "Last Hta"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['labels']['bbtb']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['labels']['bbtb'] = "Bbtb"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['labels']['partus']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['labels']['partus'] = "Partus"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['labels']['deleted']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['labels']['deleted'] = "Deleted"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['labels']['hamil']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['labels']['hamil'] = "Hamil"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['labels']['email']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['labels']['email'] = "Email"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['labels']['blood']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['labels']['blood'] = "Blood"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['labels']['location']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['labels']['location'] = "Location"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['labels']['mother']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['labels']['mother'] = "Mother"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['labels']['father']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['labels']['father'] = "Father"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['labels']['job']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['labels']['job'] = "Job"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['labels']['education']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['labels']['education'] = "Education"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['labels']['birthplace']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['labels']['birthplace'] = "Birthplace"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['labels']['kelurahan']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['labels']['kelurahan'] = "Kelurahan"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['labels']['kecamatan']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['labels']['kecamatan'] = "Kecamatan"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['labels']['rt']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['labels']['rt'] = "Rt"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['labels']['rw']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['labels']['rw'] = "Rw"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['labels']['member']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['labels']['member'] = "Member"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['labels']['idno']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['labels']['idno'] = "Id No"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['labels']['jenis']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['labels']['jenis'] = "Jenis"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['labels']['expdate']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['labels']['expdate'] = "Exp Date"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['labels']['photoname']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['labels']['photoname'] = "Photo Name"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['labels']['isdead']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['labels']['isdead'] = "Is Dead"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['labels']['tlc']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['labels']['tlc'] = "Tlc"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['labels']['bu']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['labels']['bu'] = "Bu"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['labels']['lastupdated']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['labels']['lastupdated'] = "Last Updated"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['labels']['nip']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['labels']['nip'] = "Nip"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['labels']['instno']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['labels']['instno'] = "Inst No"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['labels']['kelompokcode']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['labels']['kelompokcode'] = "Kelompok Code"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['labels']['kelompok']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['labels']['kelompok'] = "Kelompok"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['labels']['penanggung']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['labels']['penanggung'] = "Penanggung"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['labels']['cardno']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['labels']['cardno'] = "Card No"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['labels']['statusbl']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['labels']['statusbl'] = "Status BL"; 
       }
       //-----
       $this->comp_field_nm = array(
           'religion' => 0,
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['summarizing_fields_order']['religion']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['summarizing_fields_order']['religion'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['summarizing_fields_order']['religion'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['summarizing_fields_display']['religion'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['summarizing_fields_display']['religion'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['summarizing_fields_display']['religion'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['summarizing_fields_display']['religion'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['summarizing_fields_display']['religion'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['summarizing_fields_display']['religion'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['summarizing_fields_display']['religion'] as $i_sum => $d_sum)
           {
       ...
       //-----
       foreach ($this->array_total_religion as $i_religion => $d_religion) {
           if (!in_array($i_religion, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_religion[3] ] = $d_religion[2];
               $this->comp_label[0][ $d_religion[3] ] = $d_religion[2];
           }
       }
       ...
       //-----
       $this->comp_links_fl = array(
           array('name' => 'religion', 'prot' => '@aspass@'),
       );
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['pivot_order_level'] = -1;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['pivot_tabular_label'];
       ...
       //-----
       foreach ($this->comp_label[0] as $i_religion => $l_religion) {
           if (isset($this->array_total_religion[$i_religion])) {
               $this->comp_group[$i_religion] = array();
           }
       }
   ...
   function getCompData($level, $params = array()) {
       if (0 == $level) {
           $return = $this->array_total_religion;
       }
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_lap_demo_agama@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function buildChart()
   {
       ...
       $this->comp_chart_config = array(
           '0|1' => array(
               ...
               'label_x'  => $this->getChartText(strip_tags($Lab_religion)),
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['pivot_charts']    = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['pivot_orig']      = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['comb_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['comb_table_def']  = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['anlt_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['anlt_table_def']  = array();
	...
	function filterChartsByGroupbyLevel() {
		...
		if (isset($nmgp_opcao) && ('pdf' == $nmgp_opcao || 'pdf_res' == $nmgp_opcao) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['chart_level']) && '' !== $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['chart_level']) {
			$applyFilter = true;
		}
		elseif (isset($nmgp_opcao) && 'image_res' == $nmgp_opcao && isset($_POST['chart_level']) && '' !== $_POST['chart_level']) {
			$applyFilter = true;
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['chart_level'] = $_POST['chart_level'];
		}
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['pivot_charts'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['pivot_orig'];

		if ($applyFilter) {
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['pivot_charts'] as $chartIndex => $chartData) {
				...
				if ($groupbyLevel > $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['chart_level']) {
					unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['pivot_charts'][$chartIndex]);
				}
			}
		}

		$this->comp_chart_data = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['pivot_charts'];
	}
           ...
           foreach ($a_totals as $i_total => $values)
           {
               ...
               if (isset($this->comp_chart_config[$key_config]))
               {
                   ...
                   foreach ($a_keys as $tmp_key)
                   {
                       ...
                       $xml_links[]  = $this->getFusionLink('sc_grid_lap_demo_agama_' . session_id() . '_!!!' . implode('_', array_merge(array($group + 1, $i_total), $link_index)) . '!!!.json');
                   }
                   ...
                   $this->comp_chart_data[$key_data]['xml']        = $this->getFusionLink('sc_grid_lap_demo_agama_' . session_id() . '_!!!' . implode('_', array_merge(array($group, $i_total), $param)) . '!!!.json');
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['embutida'])
                   {
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['proc_pdf_vert']){ 
   ...
   {
       if (!$res_chart && $this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['json_use_format']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['json_use_format'])
       {
           return $valor_campo;
       }
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function resumo_final()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['ajax_nav'])
      {
   ...
   function inicializa_vars()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         require_once($this->Ini->path_aplicacao . "grid_lap_demo_agama_total.class.php"); 
      }
      ...
      $this->Total   = new grid_lap_demo_agama_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      $this->Total->Calc_resumo_religion("res");
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['arr_total'][$cmp_gb];
      }
      ksort($this->array_total_religion);
      if ("out" == $this->NM_tipo)
      {
         $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['SC_Ind_Groupby'];
         $this->Total->$Gb_geral();
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['dashboard_refresh_after_chart'] = 'resumo';
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['doc_word'])
{
   ...
   { 
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_lap_demo_agama_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grid_lap_demo_agama_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_lap_demo_agama_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['num_css'] . '.css');
...
$nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_lap_demo_agama/grid_lap_demo_agama_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\">\r\n");
           ...
           $nm_saida->saida("     }\r\n");
           $nm_saida->saida("   </script>\r\n");
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['ajax_nav'] && !$this->Ini->sc_export_ajax && !$this->Ini->Export_html_zip && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['doc_word'])
      {
           $nm_saida->saida("   <script type=\"text/javascript\"> \r\n");
          ...
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['grid_pesq']))
          { 
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['doc_word']) 
      {
      ...
      {
          $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['dashboard_info']['remove_margin'] ? ' style="margin: 0"' : '';
          $nm_saida->saida(" <BODY class=\"" . $this->css_scGridPage . "\"" . $remove_margin . ">\r\n");
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['embutida'])
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top_normal()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['xls'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bexcel", "", "", "Rxls_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_lap_demo_agama/grid_lap_demo_agama_config_xls.php?script_case_init=" . $this->Ini->sc_page . "&app_name=grid_lap_demo_agama&nm_tp_xls=xlsx&nm_tot_xls=N&nm_tot_xls=N&nm_res_cons=s&nm_ini_xls_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&summary_export_columns=S&origem=res&language=&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['xml'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bxml", "", "", "Rxml_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_lap_demo_agama/grid_lap_demo_agama_config_xml.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=s&nm_ini_xml_res=grid,resume,chart&nm_all_modules=grid,resume,chart&nm_xml_tag=tag&nm_xml_label=S&language=&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['csv'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcsv", "", "", "Rcsv_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_lap_demo_agama/grid_lap_demo_agama_config_csv.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_res_cons=s&nm_ini_csv_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&nm_delim_line=1&nm_delim_col=1&nm_delim_dados=1&nm_label_csv=N&language=&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_lap_demo_agama/grid_lap_demo_agama_config_print.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_opc=resumo&nm_cor=CO&nm_res_cons=s&nm_ini_prt_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&origem=res&language=id&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      {
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bconf_graf", "", "", "Rgraf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_lap_demo_agama/grid_lap_demo_agama_config_graf_flash.php?nome_apl=grid_lap_demo_agama&campo_apl=nm_resumo_graf&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=id&tp_apl=ger_gra&KeepThis=true&TB_iframe=true&height=450&width=400&modal=true", "", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
      }
      if ($this->nmgp_botoes['chart_detail'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("grid_lap_demo_agama_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
   ...
   function monta_html_fim()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['print_all'])
      {
          $this->grafico_pdf();
      }
      $nm_saida->saida("</TABLE>\r\n");
      $nm_saida->saida("<link rel=\"stylesheet\" type=\"text/css\" href=\"../_lib/css/" . $this->Ini->str_schema_all . "_sweetalert.css\" />\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_lap_demo_agama']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_lap_demo_agama']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
$nm_saida->saida("       scJs_alert('" . $mensagem . "', $jsonParams);\r\n");
      ...
      elseif ($this->Ini->Export_html_zip || ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['opcao'] == "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['graf_pdf'] == "S"))
      {
          $this->grafico_pdf();
      }
      else
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'grid_lap_demo_agama_config_pivot.php?nome_apl=grid_lap_demo_agama&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=id&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_lap_demo_agama_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "grid_lap_demo_agama/grid_lap_demo_agama_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
...
//--- 
 function grafico_bot()
 {
   ...
   $bPDF = false;
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['pivot_charts']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['graf_bot'] = true;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['graf_first'] = true;
       require_once($this->Ini->path_aplicacao . $this->Ini->Apl_grafico); 
       $this->Graf  = new grid_lap_demo_agama_grafico();
       $this->Graf->Db     = $this->Db;
       $this->Graf->Erro   = $this->Erro;
      ...
      if (isset($_POST['nmgp_opcao']) && 'ajax_navigate' == $_POST['nmgp_opcao'] && isset($_POST['opc']) && ('grid_search_res' == $_POST['opc'] || 'resumo_search' == $_POST['opc'])) {
       ...
       $nm_saida->saida("<TR>\r\n");
       $iChartCount = 1;
       $iChartTotal = sizeof($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['pivot_charts']);
       $sChartLang  = isset($this->Ini->Nm_lang['lang_pdff_pcht']) ? $this->Ini->Nm_lang['lang_pdff_pcht'] : 'Generating chart';
       if (!NM_is_utf8($sChartLang))
       {
           $sChartLang = sc_convert_encoding($sChartLang, "UTF-8", $_SESSION['scriptcase']['charset']);
      ...
      if ($bPDF && (!isset($this->progress_fp) || !$this->progress_fp))
      {
       ...
       $nm_saida->saida("</TR>\r\n");
      if (isset($_POST['nmgp_opcao']) && 'ajax_navigate' == $_POST['nmgp_opcao'] && isset($_POST['opc']) && 'resumo' == $_POST['opc']) {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['new_charts'] = $_SESSION['scriptcase']['saida_html'];
      ...
      if (isset($_POST['nmgp_opcao']) && 'ajax_navigate' == $_POST['nmgp_opcao'] && isset($_POST['opc']) && ('grid_search_res' == $_POST['opc'] || 'resumo_search' == $_POST['opc'])) {
       ...
       $nm_saida->saida("</TABLE>\r\n");
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['graf_bot'] = false;
       if ($bPDF && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['charts_html']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['charts_html'])
       {
           $nm_saida->saida("<script type=\"text/javascript\">\r\n");
           $nm_saida->saida("{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['charts_html']}\r\n");
           $nm_saida->saida("</script>\r\n");
...
//--- 
   ...
   {
      global $nm_saida;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_agama']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
      ...
      { 
        ...
        if ($_SESSION['scriptcase']['charset'] != "UTF-8")
        {
          ...
          $religion = $Busca_temp['religion']; 
          $tmp_pos = strpos($religion, "##@@");
          if ($tmp_pos !== false && !is_array($religion))
          {
              $religion = substr($religion, 0, $tmp_pos);
          }
          $registerdate = $Busca_temp['registerdate']; 
          $tmp_pos = strpos($registerdate, "##@@");
          if ($tmp_pos !== false && !is_array($registerdate))
          {
              $registerdate = substr($registerdate, 0, $tmp_pos);
          }
          $registerdate_2 = $Busca_temp['registerdate_input_2']; 
      } 
   ...
   //---- 
   function adiciona_registro($quebra_religion, $quebra_religion_orig)
   {
      //----- Agama
      if (!isset($this->array_total_religion[$quebra_religion_orig]))
      {
         $this->array_total_religion[$quebra_religion_orig][0] = 1;
         $this->array_total_religion[$quebra_religion_orig][1] = 1;
         $this->array_total_religion[$quebra_religion_orig][2] = $quebra_religion;
         $this->array_total_religion[$quebra_religion_orig][3] = $quebra_religion_orig;
      }
      else
      {
         $this->array_total_religion[$quebra_religion_orig][0]++;
         $this->array_total_religion[$quebra_religion_orig][2]++;
      }
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('', 'religion');
     $campos_order = $this->Ini->Get_date_order_groupby("religion", 'asc', $format, $campos_order);
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->custcode = $rs_res->fields[0] ;  
            $this->name = $rs_res->fields[1] ;  
            $this->salut = $rs_res->fields[2] ;  
            $this->religion = $rs_res->fields[3] ;  
            $this->registerdate = $rs_res->fields[4] ;  
            $this->sex = $rs_res->fields[5] ;  
            $this->id = $rs_res->fields[6] ;  
            $this->look_sex = $this->sex; 
            $this->Lookup->lookup_sex($this->look_sex); 
            $this->religion_orig = $this->religion;
            $this->sex = $this->look_sex ;
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->religion, $this->religion_orig);
            }
   }
//
