...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "id";$Nm_numeric[] = "rkkcode";$Nm_numeric[] = "id_rkk";$Nm_numeric[] = "status";$Nm_numeric[] = "id";$Nm_numeric[] = "rkkcode";$Nm_numeric[] = "id_rkk";$Nm_numeric[] = "status";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_rkkcode_cond" name="rkkcode_cond" onChange="nm_campos_between(document.getElementById('id_vis_rkkcode'), this, 'rkkcode')">
      ...
      <br><span id="id_hide_rkkcode"  <?php echo $str_hide_rkkcode?>><?php
      if ($rkkcode != "")
      {
      $rkkcode_look = substr($this->Db->qstr($rkkcode), 1, -1); 
      $nmgp_def_dados = array(); 
