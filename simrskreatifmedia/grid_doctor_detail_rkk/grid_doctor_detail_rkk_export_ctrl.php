<?php
@session_start() ;
$_SESSION['scriptcase']['grid_doctor_detail_rkk']['sc_process_barr'] = true;
require_once('../grid_doctor_detail_rkk/index.php');
unset($_SESSION['scriptcase']['grid_doctor_detail_rkk']['sc_process_barr']);
$ExportCtrl = new grid_doctor_detail_rkk_export_control;
$ExportCtrl->Export_barr();

class grid_doctor_detail_rkk_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_title'] ?> doctor_detail_rkk :: Excel</TITLE>
