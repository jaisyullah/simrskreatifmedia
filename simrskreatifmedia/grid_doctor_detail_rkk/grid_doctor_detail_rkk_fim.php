...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_doctor_detail_rkk"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_doctor_detail_rkk"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_doctor_detail_rkk']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_doctor_detail_rkk']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_doctor_detail_rkk']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_doctor_detail_rkk']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_doctor_detail_rkk']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_doctor_detail_rkk</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_doctor_detail_rkk']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_doctor_detail_rkk']['embutida_filho'] as $ind => $sc_init)
          {
