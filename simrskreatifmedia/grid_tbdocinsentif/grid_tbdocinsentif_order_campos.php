...
<?php
   ...
   $Ord_Cmp = new grid_tbdocinsentif_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_tbdocinsentif_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbdocinsentif']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tbdocinsentif']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["doccode"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbdocinsentif']['labels']["doccode"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbdocinsentif']['labels']["doccode"] : "Doc Code";
   $tab_ger_campos['tindakan'] = "on";
   $tab_def_campos['tindakan'] = "tindakan";
   $tab_labels["tindakan"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbdocinsentif']['labels']["tindakan"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbdocinsentif']['labels']["tindakan"] : "Tindakan";
   $tab_ger_campos['tindname'] = "on";
   $tab_def_campos['tindname'] = "tindName";
   $tab_labels["tindname"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbdocinsentif']['labels']["tindname"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbdocinsentif']['labels']["tindname"] : "Tind Name";
   $tab_ger_campos['class'] = "on";
   $tab_def_campos['class'] = "class";
   $tab_labels["class"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbdocinsentif']['labels']["class"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbdocinsentif']['labels']["class"] : "Class";
   $tab_ger_campos['rate'] = "on";
   $tab_def_campos['rate'] = "rate";
   $tab_labels["rate"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbdocinsentif']['labels']["rate"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbdocinsentif']['labels']["rate"] : "Rate";
   $tab_ger_campos['taxedrate'] = "on";
   $tab_def_campos['taxedrate'] = "taxedRate";
   $tab_labels["taxedrate"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbdocinsentif']['labels']["taxedrate"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbdocinsentif']['labels']["taxedrate"] : "Taxed Rate";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_tbdocinsentif']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_tbdocinsentif']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_tbdocinsentif']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbdocinsentif']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tbdocinsentif']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_tbdocinsentif']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_tbdocinsentif']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_tbdocinsentif']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_tbdocinsentif']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_tbdocinsentif_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_tbdocinsentif']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_tbdocinsentif']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_tbdocinsentif']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_tbdocinsentif']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_tbdocinsentif']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
