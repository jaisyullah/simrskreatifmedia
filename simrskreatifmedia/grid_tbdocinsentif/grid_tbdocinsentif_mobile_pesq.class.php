...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "tranDate";$Nm_datas[] = "tranDate";$Nm_numeric[] = "rate";$Nm_numeric[] = "taxedrate";$Nm_numeric[] = "disc";$Nm_numeric[] = "nilai";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_class_cond" name="class_cond" onChange="nm_campos_between(document.getElementById('id_vis_class'), this, 'class')">
      ...
      <br><span id="id_hide_class"  <?php echo $str_hide_class?>><?php
      if ($class != "")
      {
      $class_look = substr($this->Db->qstr($class), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_tindname_cond" name="tindname_cond" onChange="nm_campos_between(document.getElementById('id_vis_tindname'), this, 'tindname')">
      ...
      <br><span id="id_hide_tindname"  <?php echo $str_hide_tindname?>><?php
      if ($tindname != "")
      {
      $tindname_look = substr($this->Db->qstr($tindname), 1, -1); 
      $nmgp_def_dados = array(); 
