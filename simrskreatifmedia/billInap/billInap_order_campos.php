...
<?php
   ...
   $Ord_Cmp = new billInap_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class billInap_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['billInap']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['billInap']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["deskripsi"]   = (isset($_SESSION['sc_session'][$sc_init]['billInap']['labels']["deskripsi"])) ? $_SESSION['sc_session'][$sc_init]['billInap']['labels']["deskripsi"] : "Deskripsi";
   $tab_ger_campos['jumlah'] = "on";
   $tab_def_campos['jumlah'] = "jumlah";
   $tab_labels["jumlah"]   = (isset($_SESSION['sc_session'][$sc_init]['billInap']['labels']["jumlah"])) ? $_SESSION['sc_session'][$sc_init]['billInap']['labels']["jumlah"] : "Jumlah";
   $tab_ger_campos['biaya'] = "on";
   $tab_def_campos['biaya'] = "Biaya";
   $tab_labels["biaya"]   = (isset($_SESSION['sc_session'][$sc_init]['billInap']['labels']["biaya"])) ? $_SESSION['sc_session'][$sc_init]['billInap']['labels']["biaya"] : "Biaya";
   $tab_ger_campos['total'] = "on";
   $tab_def_campos['total'] = "Total";
   $tab_labels["total"]   = (isset($_SESSION['sc_session'][$sc_init]['billInap']['labels']["total"])) ? $_SESSION['sc_session'][$sc_init]['billInap']['labels']["total"] : "Total";
   $tab_ger_campos['diskon'] = "on";
   $tab_def_campos['diskon'] = "Diskon";
   $tab_labels["diskon"]   = (isset($_SESSION['sc_session'][$sc_init]['billInap']['labels']["diskon"])) ? $_SESSION['sc_session'][$sc_init]['billInap']['labels']["diskon"] : "Diskon";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['billInap']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['billInap']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['billInap']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['billInap']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['billInap']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['billInap']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['billInap']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['billInap']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['billInap']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['billInap']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['billInap']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['billInap']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['billInap']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['billInap']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
