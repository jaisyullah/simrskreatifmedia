<?php
@session_start() ;
$_SESSION['scriptcase']['billInap']['sc_process_barr'] = true;
require_once('../billInap/index.php');
unset($_SESSION['scriptcase']['billInap']['sc_process_barr']);
$ExportCtrl = new billInap_export_control;
$ExportCtrl->Export_barr();

class billInap_export_control
{
