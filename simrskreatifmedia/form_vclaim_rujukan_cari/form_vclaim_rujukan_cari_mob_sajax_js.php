  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_vclaim_rujukan_cari_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_vclaim_rujukan_cari_mob_form();
	}

  // ---------- Validate pilih
  function do_ajax_form_vclaim_rujukan_cari_mob_validate_pilih()
  {
    var nomeCampo_pilih = "pilih";
    var var_pilih = scAjaxGetFieldSelect(nomeCampo_pilih);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_rujukan_cari_mob_validate_pilih(var_pilih, var_script_case_init, do_ajax_form_vclaim_rujukan_cari_mob_validate_pilih_cb);
  } // do_ajax_form_vclaim_rujukan_cari_mob_validate_pilih

  function do_ajax_form_vclaim_rujukan_cari_mob_validate_pilih_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_rujukan_cari_mob_validate_pilih_cb

  // ---------- Validate tglsep
  function do_ajax_form_vclaim_rujukan_cari_mob_validate_tglsep()
  {
    var nomeCampo_tglsep = "tglsep";
    var var_tglsep = scAjaxGetFieldText(nomeCampo_tglsep);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_rujukan_cari_mob_validate_tglsep(var_tglsep, var_script_case_init, do_ajax_form_vclaim_rujukan_cari_mob_validate_tglsep_cb);
  } // do_ajax_form_vclaim_rujukan_cari_mob_validate_tglsep

  function do_ajax_form_vclaim_rujukan_cari_mob_validate_tglsep_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tglsep";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_rujukan_cari_mob_validate_tglsep_cb

  // ---------- Validate basiscari
  function do_ajax_form_vclaim_rujukan_cari_mob_validate_basiscari()
  {
    var nomeCampo_basiscari = "basiscari";
    var var_basiscari = scAjaxGetFieldSelect(nomeCampo_basiscari);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_rujukan_cari_mob_validate_basiscari(var_basiscari, var_script_case_init, do_ajax_form_vclaim_rujukan_cari_mob_validate_basiscari_cb);
  } // do_ajax_form_vclaim_rujukan_cari_mob_validate_basiscari

  function do_ajax_form_vclaim_rujukan_cari_mob_validate_basiscari_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_rujukan_cari_mob_validate_basiscari_cb

  // ---------- Validate faskes
  function do_ajax_form_vclaim_rujukan_cari_mob_validate_faskes()
  {
    var nomeCampo_faskes = "faskes";
    var var_faskes = scAjaxGetFieldSelect(nomeCampo_faskes);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_rujukan_cari_mob_validate_faskes(var_faskes, var_script_case_init, do_ajax_form_vclaim_rujukan_cari_mob_validate_faskes_cb);
  } // do_ajax_form_vclaim_rujukan_cari_mob_validate_faskes

  function do_ajax_form_vclaim_rujukan_cari_mob_validate_faskes_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "faskes";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_rujukan_cari_mob_validate_faskes_cb

  // ---------- Validate nomorcari
  function do_ajax_form_vclaim_rujukan_cari_mob_validate_nomorcari()
  {
    var nomeCampo_nomorcari = "nomorcari";
    var var_nomorcari = scAjaxGetFieldText(nomeCampo_nomorcari);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_rujukan_cari_mob_validate_nomorcari(var_nomorcari, var_script_case_init, do_ajax_form_vclaim_rujukan_cari_mob_validate_nomorcari_cb);
  } // do_ajax_form_vclaim_rujukan_cari_mob_validate_nomorcari

  function do_ajax_form_vclaim_rujukan_cari_mob_validate_nomorcari_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_rujukan_cari_mob_validate_nomorcari_cb

  // ---------- Event onchange pilih
  function do_ajax_form_vclaim_rujukan_cari_mob_event_pilih_onchange()
  {
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_vclaim_rujukan_cari_mob_event_pilih_onchange(var_script_case_init, do_ajax_form_vclaim_rujukan_cari_mob_event_pilih_onchange_cb);
  } // do_ajax_form_vclaim_rujukan_cari_mob_event_pilih_onchange

  function do_ajax_form_vclaim_rujukan_cari_mob_event_pilih_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "pilih";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_vclaim_rujukan_cari_mob_event_pilih_onchange_cb_after_alert);
  } // do_ajax_form_vclaim_rujukan_cari_mob_event_pilih_onchange_cb
  function do_ajax_form_vclaim_rujukan_cari_mob_event_pilih_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_vclaim_rujukan_cari_mob_event_pilih_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_vclaim_rujukan_cari_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_vclaim_rujukan_cari_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_vclaim_rujukan_cari_mob_submit_form(var_pilih, var_tglsep, var_basiscari, var_faskes, var_nomorcari, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_vclaim_rujukan_cari_mob_submit_form_cb);
  } // do_ajax_form_vclaim_rujukan_cari_mob_submit_form

  function do_ajax_form_vclaim_rujukan_cari_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_vclaim_rujukan_cari_mob_submit_form_cb_after_alert);
  } // do_ajax_form_vclaim_rujukan_cari_mob_submit_form_cb
  function do_ajax_form_vclaim_rujukan_cari_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_vclaim_rujukan_cari_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_vclaim_rujukan_cari_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_form_vclaim_rujukan_cari_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_rujukan_cari_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_vclaim_rujukan_cari_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_vclaim_rujukan_cari_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_vclaim_rujukan_cari_mob_navigate_form_cb
  function do_ajax_form_vclaim_rujukan_cari_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_vclaim_rujukan_cari_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_vclaim_rujukan_cari_mob_navigate_form_cb_after_alert
  function sc_hide_form_vclaim_rujukan_cari_mob_form()
  {
