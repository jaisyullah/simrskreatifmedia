...
<?php
   ...
   $Ord_Cmp = new grid_tbformulaobat_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_tbformulaobat_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbformulaobat']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tbformulaobat']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbformulaobat']['labels']["id"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbformulaobat']['labels']["id"] : "ID";
   $tab_ger_campos['namaformula'] = "on";
   $tab_def_campos['namaformula'] = "namaFormula";
   $tab_labels["namaformula"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbformulaobat']['labels']["namaformula"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbformulaobat']['labels']["namaformula"] : "Nama Formula";
   ...
   {
       $tab_def_campos['sc_field_0'] = "SELECT sum(a.jumlah*b.hargaJual)
FROM tbdetailformulaobat a left join tbobat b on b.kodeItem = a.kodeItem
WHERE a.idFormula = '{id}'";
   }
   $tab_labels["sc_field_0"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbformulaobat']['labels']["sc_field_0"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbformulaobat']['labels']["sc_field_0"] : "Total Paket";
   ...
   $tab_labels["detail"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbformulaobat']['labels']["detail"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbformulaobat']['labels']["detail"] : "Detail";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_tbformulaobat']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_tbformulaobat']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_tbformulaobat']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbformulaobat']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tbformulaobat']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_tbformulaobat']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_tbformulaobat']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_tbformulaobat']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_tbformulaobat']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_tbformulaobat_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_tbformulaobat']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_tbformulaobat']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_tbformulaobat']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_tbformulaobat']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_tbformulaobat']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
