<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tbformulaobat']['sc_process_barr'] = true;
require_once('../grid_tbformulaobat/index.php');
unset($_SESSION['scriptcase']['grid_tbformulaobat']['sc_process_barr']);
$ExportCtrl = new grid_tbformulaobat_export_control;
$ExportCtrl->Export_barr();

class grid_tbformulaobat_export_control
{
