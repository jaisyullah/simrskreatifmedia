...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "expDate";$Nm_datas[] = "expDate";$Nm_datas[] = "";$Nm_datas[] = "";$Nm_numeric[] = "jmlterima";$Nm_numeric[] = "hargaterima";$Nm_numeric[] = "isi";$Nm_numeric[] = "disc";$Nm_numeric[] = "";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_jmlterima_cond" name="jmlterima_cond" onChange="nm_campos_between(document.getElementById('id_vis_jmlterima'), this, 'jmlterima')">
      ...
      <br><span id="id_hide_jmlterima"  <?php echo $str_hide_jmlterima?>><INPUT  type="text" id="SC_jmlterima" name="jmlterima" value="<?php echo NM_encode_input($jmlterima) ?>" size=5 alt="{datatype: 'integer', maxLength: 5, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_hargaterima_cond" name="hargaterima_cond" onChange="nm_campos_between(document.getElementById('id_vis_hargaterima'), this, 'hargaterima')">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_isi_cond" name="isi_cond" onChange="nm_campos_between(document.getElementById('id_vis_isi'), this, 'isi')">
