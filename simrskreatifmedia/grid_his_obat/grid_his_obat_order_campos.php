<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_his_obat']['glo_nm_path_imag_temp'] . "/sc_apl_default_simrskreatifmedia.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_his_obat_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_his_obat_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_his_obat']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_his_obat']['ordem_select_orig'] = array();
   }
   ...
   if ($use_alias == "S")
   {
       $tab_def_campos['tgl'] = "Tgl";
   }
   else
   {
       $tab_def_campos['tgl'] = "";
   }
   $tab_labels["tgl"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_his_obat']['labels']["tgl"])) ? $_SESSION['sc_session'][$sc_init]['grid_his_obat']['labels']["tgl"] : "Tgl";
   $tab_ger_campos['supplier'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['supplier'] = "Supplier";
   }
   else
   {
       $tab_def_campos['supplier'] = "";
   }
   $tab_labels["supplier"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_his_obat']['labels']["supplier"])) ? $_SESSION['sc_session'][$sc_init]['grid_his_obat']['labels']["supplier"] : "Supplier";
   $tab_ger_campos['jmlterima'] = "on";
   $tab_def_campos['jmlterima'] = "jmlTerima";
   $tab_labels["jmlterima"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_his_obat']['labels']["jmlterima"])) ? $_SESSION['sc_session'][$sc_init]['grid_his_obat']['labels']["jmlterima"] : "Jml Terima";
   $tab_ger_campos['isi'] = "on";
   $tab_def_campos['isi'] = "isi";
   $tab_labels["isi"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_his_obat']['labels']["isi"])) ? $_SESSION['sc_session'][$sc_init]['grid_his_obat']['labels']["isi"] : "Isi";
   ...
   $tab_labels["total"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_his_obat']['labels']["total"])) ? $_SESSION['sc_session'][$sc_init]['grid_his_obat']['labels']["total"] : "Jml * Isi";
   $tab_ger_campos['hargaterima'] = "on";
   $tab_def_campos['hargaterima'] = "hargaTerima";
   $tab_labels["hargaterima"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_his_obat']['labels']["hargaterima"])) ? $_SESSION['sc_session'][$sc_init]['grid_his_obat']['labels']["hargaterima"] : "Harga Terima";
   $tab_ger_campos['disc'] = "on";
   $tab_def_campos['disc'] = "disc";
   $tab_labels["disc"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_his_obat']['labels']["disc"])) ? $_SESSION['sc_session'][$sc_init]['grid_his_obat']['labels']["disc"] : "Disc (%)";
   ...
   $tab_labels["sc_field_2"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_his_obat']['labels']["sc_field_2"])) ? $_SESSION['sc_session'][$sc_init]['grid_his_obat']['labels']["sc_field_2"] : "Harga Disc";
   $tab_ger_campos['batchno'] = "on";
   $tab_def_campos['batchno'] = "batchNo";
   $tab_labels["batchno"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_his_obat']['labels']["batchno"])) ? $_SESSION['sc_session'][$sc_init]['grid_his_obat']['labels']["batchno"] : "Batch No";
   $tab_ger_campos['expdate'] = "on";
   $tab_def_campos['expdate'] = "expDate";
   $tab_labels["expdate"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_his_obat']['labels']["expdate"])) ? $_SESSION['sc_session'][$sc_init]['grid_his_obat']['labels']["expdate"] : "Exp Date";
   $tab_ger_campos['principal'] = "on";
   $tab_def_campos['principal'] = "principal";
   $tab_labels["principal"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_his_obat']['labels']["principal"])) ? $_SESSION['sc_session'][$sc_init]['grid_his_obat']['labels']["principal"] : "Principal";
   ...
   $tab_labels["sc_field_0"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_his_obat']['labels']["sc_field_0"])) ? $_SESSION['sc_session'][$sc_init]['grid_his_obat']['labels']["sc_field_0"] : "HJA 28%";
   ...
   $tab_labels["sc_field_1"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_his_obat']['labels']["sc_field_1"])) ? $_SESSION['sc_session'][$sc_init]['grid_his_obat']['labels']["sc_field_1"] : "HJA RI 38%";
   $tab_ger_campos['tgl'] = "none";
   $tab_ger_campos['supplier'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_his_obat']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_his_obat']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_his_obat']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_his_obat']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_his_obat']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_his_obat']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_his_obat']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_his_obat']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_his_obat']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_title'] ?> tbpodetail</TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_his_obat_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_his_obat']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_his_obat']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_his_obat']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_his_obat']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_his_obat']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
