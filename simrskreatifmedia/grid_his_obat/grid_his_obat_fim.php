...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_his_obat"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_his_obat"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_his_obat']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_his_obat']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_his_obat']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_his_obat']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_his_obat']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_his_obat']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_his_obat']['embutida_filho'] as $ind => $sc_init)
          {
