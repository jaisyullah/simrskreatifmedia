<?php
@session_start() ;
$_SESSION['scriptcase']['grid_his_obat']['sc_process_barr'] = true;
require_once('../grid_his_obat/index.php');
unset($_SESSION['scriptcase']['grid_his_obat']['sc_process_barr']);
$ExportCtrl = new grid_his_obat_export_control;
$ExportCtrl->Export_barr();

class grid_his_obat_export_control
{
