...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "masa_berlaku";$Nm_datas[] = "masa_berlaku";$Nm_numeric[] = "id";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_sifat_cond" name="sifat_cond" onChange="nm_campos_between(document.getElementById('id_vis_sifat'), this, 'sifat')">
      ...
      <br><span id="id_hide_sifat"  <?php echo $str_hide_sifat?>><?php
      if ($sifat != "")
      {
      $sifat_look = substr($this->Db->qstr($sifat), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_nama_dok_cond" name="nama_dok_cond" onChange="nm_campos_between(document.getElementById('id_vis_nama_dok'), this, 'nama_dok')">
      ...
      <br><span id="id_hide_nama_dok"  <?php echo $str_hide_nama_dok?>><?php
      if ($nama_dok != "")
      {
      $nama_dok_look = substr($this->Db->qstr($nama_dok), 1, -1); 
      $nmgp_def_dados = array(); 
