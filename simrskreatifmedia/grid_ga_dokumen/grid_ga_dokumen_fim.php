...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_ga_dokumen"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_ga_dokumen"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_ga_dokumen'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_ga_dokumen']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_ga_dokumen']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_ga_dokumen']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_ga_dokumen']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_ga_dokumen']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_ga_dokumen']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_ga_dokumen']['embutida_filho'] as $ind => $sc_init)
          {
