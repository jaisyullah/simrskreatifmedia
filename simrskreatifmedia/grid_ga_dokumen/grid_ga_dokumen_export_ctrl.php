<?php
@session_start() ;
$_SESSION['scriptcase']['grid_ga_dokumen']['sc_process_barr'] = true;
require_once('../grid_ga_dokumen/index.php');
unset($_SESSION['scriptcase']['grid_ga_dokumen']['sc_process_barr']);
$ExportCtrl = new grid_ga_dokumen_export_control;
$ExportCtrl->Export_barr();

class grid_ga_dokumen_export_control
{
