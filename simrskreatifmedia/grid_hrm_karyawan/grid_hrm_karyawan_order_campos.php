...
<?php
   ...
   $Ord_Cmp = new grid_hrm_karyawan_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_hrm_karyawan_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_hrm_karyawan']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_hrm_karyawan']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_hrm_karyawan']['labels']["id"])) ? $_SESSION['sc_session'][$sc_init]['grid_hrm_karyawan']['labels']["id"] : "ID";
   $tab_ger_campos['nama'] = "on";
   $tab_def_campos['nama'] = "nama";
   $tab_labels["nama"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_hrm_karyawan']['labels']["nama"])) ? $_SESSION['sc_session'][$sc_init]['grid_hrm_karyawan']['labels']["nama"] : "Nama";
   $tab_ger_campos['nik'] = "on";
   $tab_def_campos['nik'] = "nik";
   $tab_labels["nik"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_hrm_karyawan']['labels']["nik"])) ? $_SESSION['sc_session'][$sc_init]['grid_hrm_karyawan']['labels']["nik"] : "NIK";
   $tab_ger_campos['ponsel'] = "on";
   $tab_def_campos['ponsel'] = "ponsel";
   $tab_labels["ponsel"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_hrm_karyawan']['labels']["ponsel"])) ? $_SESSION['sc_session'][$sc_init]['grid_hrm_karyawan']['labels']["ponsel"] : "Ponsel";
   $tab_ger_campos['email'] = "on";
   $tab_def_campos['email'] = "email";
   $tab_labels["email"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_hrm_karyawan']['labels']["email"])) ? $_SESSION['sc_session'][$sc_init]['grid_hrm_karyawan']['labels']["email"] : "Email";
   $tab_ger_campos['npwp'] = "on";
   $tab_def_campos['npwp'] = "npwp";
   $tab_labels["npwp"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_hrm_karyawan']['labels']["npwp"])) ? $_SESSION['sc_session'][$sc_init]['grid_hrm_karyawan']['labels']["npwp"] : "NPWP";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_hrm_karyawan']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_hrm_karyawan']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_hrm_karyawan']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_hrm_karyawan']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_hrm_karyawan']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_hrm_karyawan']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_hrm_karyawan']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_hrm_karyawan']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_hrm_karyawan']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_hrm_karyawan_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_hrm_karyawan']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_hrm_karyawan']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_hrm_karyawan']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_hrm_karyawan']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_hrm_karyawan']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
