...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "id";$Nm_numeric[] = "tenaga_medis";$Nm_numeric[] = "id_presensi";$Nm_numeric[] = "id";$Nm_numeric[] = "tenaga_medis";$Nm_numeric[] = "id_presensi";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_ponsel_cond" name="ponsel_cond" onChange="nm_campos_between(document.getElementById('id_vis_ponsel'), this, 'ponsel')">
      ...
      <br><span id="id_hide_ponsel"  <?php echo $str_hide_ponsel?>><?php
      if ($ponsel != "")
      {
      $ponsel_look = substr($this->Db->qstr($ponsel), 1, -1); 
      $nmgp_def_dados = array(); 
