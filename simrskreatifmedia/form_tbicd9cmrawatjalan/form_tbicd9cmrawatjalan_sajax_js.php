  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbicd9cmrawatjalan" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbicd9cmrawatjalan_form();
	}

  // ---------- Validate icd9cm_
  function do_ajax_form_tbicd9cmrawatjalan_validate_icd9cm_(iNumLinha)
  {
    var nomeCampo_icd9cm_ = "icd9cm_" + iNumLinha;
    var var_icd9cm_ = scAjaxGetFieldSelect(nomeCampo_icd9cm_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbicd9cmrawatjalan_validate_icd9cm_(var_icd9cm_, iNumLinha, var_script_case_init, do_ajax_form_tbicd9cmrawatjalan_validate_icd9cm__cb);
  } // do_ajax_form_tbicd9cmrawatjalan_validate_icd9cm_

  function do_ajax_form_tbicd9cmrawatjalan_validate_icd9cm__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "icd9cm_" + iLineNumber;
    }
    else
    {
      sFieldValid = "icd9cm_";
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "icd9cm_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "icd9cm_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbicd9cmrawatjalan_validate_icd9cm__cb

  // ---------- Validate namadiagnosa_
  function do_ajax_form_tbicd9cmrawatjalan_validate_namadiagnosa_(iNumLinha)
  {
  } // do_ajax_form_tbicd9cmrawatjalan_validate_namadiagnosa_

  function do_ajax_form_tbicd9cmrawatjalan_validate_namadiagnosa__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbicd9cmrawatjalan_validate_namadiagnosa__cb

  // ---------- Validate keterangan_
  function do_ajax_form_tbicd9cmrawatjalan_validate_keterangan_(iNumLinha)
  {
    var nomeCampo_keterangan_ = "keterangan_" + iNumLinha;
    var var_keterangan_ = scAjaxGetFieldText(nomeCampo_keterangan_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbicd9cmrawatjalan_validate_keterangan_(var_keterangan_, iNumLinha, var_script_case_init, do_ajax_form_tbicd9cmrawatjalan_validate_keterangan__cb);
  } // do_ajax_form_tbicd9cmrawatjalan_validate_keterangan_

  function do_ajax_form_tbicd9cmrawatjalan_validate_keterangan__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbicd9cmrawatjalan_validate_keterangan__cb

  // ---------- Validate tglicd9cm_
  function do_ajax_form_tbicd9cmrawatjalan_validate_tglicd9cm_(iNumLinha)
  {
    var nomeCampo_tglicd9cm_ = "tglicd9cm_" + iNumLinha;
    var var_tglicd9cm_ = scAjaxGetFieldText(nomeCampo_tglicd9cm_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbicd9cmrawatjalan_validate_tglicd9cm_(var_tglicd9cm_, iNumLinha, var_script_case_init, do_ajax_form_tbicd9cmrawatjalan_validate_tglicd9cm__cb);
  } // do_ajax_form_tbicd9cmrawatjalan_validate_tglicd9cm_

  function do_ajax_form_tbicd9cmrawatjalan_validate_tglicd9cm__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "tglicd9cm_" + iLineNumber;
    }
    else
    {
      sFieldValid = "tglicd9cm_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "tglicd9cm_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "tglicd9cm_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbicd9cmrawatjalan_validate_tglicd9cm__cb

  // ---------- Validate id_
  function do_ajax_form_tbicd9cmrawatjalan_validate_id_(iNumLinha)
  {
    var nomeCampo_id_ = "id_" + iNumLinha;
    var var_id_ = scAjaxGetFieldHidden(nomeCampo_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbicd9cmrawatjalan_validate_id_(var_id_, iNumLinha, var_script_case_init, do_ajax_form_tbicd9cmrawatjalan_validate_id__cb);
  } // do_ajax_form_tbicd9cmrawatjalan_validate_id_

  function do_ajax_form_tbicd9cmrawatjalan_validate_id__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbicd9cmrawatjalan_validate_id__cb

  // ---------- Refresh namadiagnosa_
  function do_ajax_form_tbicd9cmrawatjalan_refresh_namadiagnosa_(iSeqForm)
  {
    var var_namadiagnosa_ = scAjaxGetFieldText("namadiagnosa_" + iSeqForm);
    var var_nmgp_refresh_row = iSeqForm;
    var var_nmgp_refresh_fields = "icd9cm_";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tbicd9cmrawatjalan_refresh_namadiagnosa_(var_namadiagnosa_, var_nmgp_refresh_row, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_tbicd9cmrawatjalan_refresh_namadiagnosa__cb);
  } // do_ajax_form_tbicd9cmrawatjalan_refresh_namadiagnosa_

  function do_ajax_form_tbicd9cmrawatjalan_refresh_namadiagnosa__cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbicd9cmrawatjalan_refresh_namadiagnosa__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_tbicd9cmrawatjalan_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_tbicd9cmrawatjalan_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tbicd9cmrawatjalan_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_tbicd9cmrawatjalan_add_new_line_cb);
  } // do_ajax_form_tbicd9cmrawatjalan_add_new_line

  function do_ajax_form_tbicd9cmrawatjalan_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_tbicd9cmrawatjalan_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_tbicd9cmrawatjalan_backup_line(iNumLinha)
  {
    var var_id_ = scAjaxGetFieldHidden("id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbicd9cmrawatjalan_backup_line(var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_tbicd9cmrawatjalan_backup_line_cb);
  } // do_ajax_form_tbicd9cmrawatjalan_backup_line

  function do_ajax_form_tbicd9cmrawatjalan_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_tbicd9cmrawatjalan_backup_line_cb

  function do_ajax_form_tbicd9cmrawatjalan_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_tbicd9cmrawatjalan_cancel_insert

  function do_ajax_form_tbicd9cmrawatjalan_cancel_update(iSeqVert)
  {
    do_ajax_form_tbicd9cmrawatjalan_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_tbicd9cmrawatjalan_cancel_update

  function do_ajax_form_tbicd9cmrawatjalan_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_tbicd9cmrawatjalan_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_tbicd9cmrawatjalan_table_refresh()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tbicd9cmrawatjalan_table_refresh(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbicd9cmrawatjalan_table_refresh_cb);
  } //  do_ajax_form_tbicd9cmrawatjalan_table_refresh

  function do_ajax_form_tbicd9cmrawatjalan_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_tbicd9cmrawatjalan_table_refresh_cb_after_alert);
  } // do_ajax_form_tbicd9cmrawatjalan_table_refresh_cb
  function do_ajax_form_tbicd9cmrawatjalan_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxSetNavStatus("t");
    sc_insert_open = false;
  } // do_ajax_form_tbicd9cmrawatjalan_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_tbicd9cmrawatjalan_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_tbicd9cmrawatjalan_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    sc_num_ult_line = iNumLinha;
    sc_num_ult_tr   = indexTR;
    scAjaxHideMessage();
    var var_icd9cm_ = scAjaxGetFieldSelect("icd9cm_" + iNumLinha);
    ...
    var var_tglicd9cm_ = scAjaxGetFieldText("tglicd9cm_" + iNumLinha);
    var var_id_ = scAjaxGetFieldHidden("id_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_tbicd9cmrawatjalan_submit_form(var_icd9cm_, var_namadiagnosa_, var_keterangan_, var_tglicd9cm_, var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbicd9cmrawatjalan_submit_form_cb);
  } // do_ajax_form_tbicd9cmrawatjalan_submit_form

  function do_ajax_form_tbicd9cmrawatjalan_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_tbicd9cmrawatjalan_submit_form_cb_after_alert);
  } // do_ajax_form_tbicd9cmrawatjalan_submit_form_cb
  function do_ajax_form_tbicd9cmrawatjalan_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbicd9cmrawatjalan_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tbicd9cmrawatjalan_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_tbicd9cmrawatjalan_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tbicd9cmrawatjalan_navigate_form(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbicd9cmrawatjalan_navigate_form_cb);
  } // do_ajax_form_tbicd9cmrawatjalan_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbicd9cmrawatjalan']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbicd9cmrawatjalan_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbicd9cmrawatjalan_navigate_form_cb_after_alert);
  } // do_ajax_form_tbicd9cmrawatjalan_navigate_form_cb
  function do_ajax_form_tbicd9cmrawatjalan_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_tbicd9cmrawatjalan_navigate_form_cb_after_alert
  function sc_hide_form_tbicd9cmrawatjalan_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "icd9cm_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "namadiagnosa_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "keterangan_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "tglicd9cm_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "id_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["icd9cm_" + iNumLinha] = {"label": "ICD9CM<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_error_list["tglicd9cm_" + iNumLinha] = {"label": "Tgl ICD9CM<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_field_mult["icd9cm_"][iNumLinha] = "icd9cm_" + iNumLinha;
    ...
    ajax_field_mult["tglicd9cm_"][iNumLinha] = "tglicd9cm_" + iNumLinha;
    ajax_field_mult["id_"][iNumLinha] = "id_" + iNumLinha;
    ajax_field_id["icd9cm_" + iNumLinha] = new Array("hidden_field_label_icd9cm_", "hidden_field_data_icd9cm_" + iNumLinha);
    ...
    ajax_field_id["tglicd9cm_" + iNumLinha] = new Array("hidden_field_label_tglicd9cm_", "hidden_field_data_tglicd9cm_" + iNumLinha);
    ajax_error_count["icd9cm_" + iNumLinha] = "off";
    ajax_error_count["namadiagnosa_" + iNumLinha] = "off";
    ajax_error_count["keterangan_" + iNumLinha] = "off";
    ajax_error_count["tglicd9cm_" + iNumLinha] = "off";
    ajax_error_count["id_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["icd9cm_" + iNumLinha] = "off";
    ajax_read_only["namadiagnosa_" + iNumLinha] = "off";
    ajax_read_only["keterangan_" + iNumLinha] = "off";
    ajax_read_only["tglicd9cm_" + iNumLinha] = "off";
...
?>
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["icd9cm_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["icd9cm_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["icd9cm_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["icd9cm_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["icd9cm_" + iNumLinha]["onfocus"] = new Array();
      ...
      ajax_error_list["tglicd9cm_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["tglicd9cm_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["tglicd9cm_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["tglicd9cm_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["tglicd9cm_" + iNumLinha]["onfocus"] = new Array();
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['icd9cm_'])) ? $this->nmgp_cmp_readonly['icd9cm_'] : 'off';
?>
    scAjaxFieldRead("icd9cm_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['tglicd9cm_'])) ? $this->nmgp_cmp_readonly['tglicd9cm_'] : 'off';
?>
    scAjaxFieldRead("tglicd9cm_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["icd9cm_" + iRow] || "on" == ajax_error_count["namadiagnosa_" + iRow] || "on" == ajax_error_count["keterangan_" + iRow] || "on" == ajax_error_count["tglicd9cm_" + iRow] || "on" == ajax_error_count["id_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_icd9cm_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_namadiagnosa_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_keterangan_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_tglicd9cm_" + iRow).addClass("scFormErrorLine");
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["icd9cm_" + iRow] && "off" == ajax_error_count["namadiagnosa_" + iRow] && "off" == ajax_error_count["keterangan_" + iRow] && "off" == ajax_error_count["tglicd9cm_" + iRow] && "off" == ajax_error_count["id_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["icd9cm_" + iRow] = "off";
        ajax_error_count["namadiagnosa_" + iRow] = "off";
        ajax_error_count["keterangan_" + iRow] = "off";
        ajax_error_count["tglicd9cm_" + iRow] = "off";
      ...
      $("#hidden_field_data_icd9cm_" + iRow).removeClass("scFormErrorLine");
      ...
      $("#hidden_field_data_tglicd9cm_" + iRow).removeClass("scFormErrorLine");
