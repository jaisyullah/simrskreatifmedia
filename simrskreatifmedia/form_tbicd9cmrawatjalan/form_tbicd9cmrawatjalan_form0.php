<?php
class form_tbicd9cmrawatjalan_form extends form_tbicd9cmrawatjalan_apl
{
function Form_Init()
{
...
<HEAD>
 <TITLE><?php if ('novo' == $this->nmgp_opcao) { echo strip_tags("" . $this->Ini->Nm_lang['lang_othr_frmi_titl'] . " - tbicd9cmrawatjalan"); } else { echo strip_tags("" . $this->Ini->Nm_lang['lang_othr_frmu_titl'] . " - tbicd9cmrawatjalan"); } ?></TITLE>
...
<?php
if ($this->Embutida_form && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbicd9cmrawatjalan']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbicd9cmrawatjalan']['sc_modal'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbicd9cmrawatjalan']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbicd9cmrawatjalan']['sc_redir_atualiz'] == 'ok')
{
?>
...
?>
<style type="text/css">
.css_read_off_tglicd9cm_ button {
...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbicd9cmrawatjalan']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_tbicd9cmrawatjalan/form_tbicd9cmrawatjalan_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_tbicd9cmrawatjalan_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_tbicd9cmrawatjalan_jquery.php');
 ...
 function addAutocomplete(elem) {
  ...
  $(".sc-ui-autocomp-namadiagnosa_", elem).on("focus", function() {
   ...
   if ("" == $(this).val()) {
    ...
    if (hasChanged) {
     do_ajax_form_tbicd9cmrawatjalan_refresh_namadiagnosa_(sRow);
     if ('function' == typeof do_ajax_form_tbicd9cmrawatjalan_event_namadiagnosa__onchange) { do_ajax_form_tbicd9cmrawatjalan_event_namadiagnosa__onchange(sRow); }
    }
   }
   ...
   source: function (request, response) {
    $.ajax({
     url: "form_tbicd9cmrawatjalan.php",
     dataType: "json",
     data: {
      term: request.term,
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbicd9cmrawatjalan']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbicd9cmrawatjalan']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbicd9cmrawatjalan']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbicd9cmrawatjalan']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbicd9cmrawatjalan']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbicd9cmrawatjalan']['recarga'];
}
if ('novo' == $opcao_botoes && $this->Embutida_form)
{
    $opcao_botoes = 'inicio';
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbicd9cmrawatjalan']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbicd9cmrawatjalan']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
?>
...
<?php
 include_once("form_tbicd9cmrawatjalan_js0.php");
?>
<script type="text/javascript"> 
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_tbicd9cmrawatjalan'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_tbicd9cmrawatjalan'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbicd9cmrawatjalan']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbicd9cmrawatjalan']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbicd9cmrawatjalan']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbicd9cmrawatjalan']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbicd9cmrawatjalan']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<div class="scFormHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFormHeaderFont" style="float: left; text-transform: uppercase;"><?php if ($this->nmgp_opcao == "novo") { echo "" . $this->Ini->Nm_lang['lang_othr_frmi_titl'] . " - tbicd9cmrawatjalan"; } else { echo "" . $this->Ini->Nm_lang['lang_othr_frmu_titl'] . " - tbicd9cmrawatjalan"; } ?></div>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbicd9cmrawatjalan']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbicd9cmrawatjalan']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbicd9cmrawatjalan']['run_iframe'] != "R")
{
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbicd9cmrawatjalan']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbicd9cmrawatjalan']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbicd9cmrawatjalan']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbicd9cmrawatjalan']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbicd9cmrawatjalan']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbicd9cmrawatjalan']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbicd9cmrawatjalan']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbicd9cmrawatjalan']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbicd9cmrawatjalan']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbicd9cmrawatjalan']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
 ...
 ?>
   ...
   <?php if (isset($this->nmgp_cmp_hidden['tglicd9cm_']) && $this->nmgp_cmp_hidden['tglicd9cm_'] == 'off') { $sStyleHidden_tglicd9cm_ = 'display: none'; }
      ...
      if (!isset($this->nm_new_label['tglicd9cm_'])) {
          $this->nm_new_label['tglicd9cm_'] = "Tgl ICD9CM"; } ?>
...
{ 
   ...
   { 
       ob_start();
       $iStart = sizeof($this->form_vert_form_tbicd9cmrawatjalan);
       $guarda_nmgp_opcao = $this->nmgp_opcao;
       $guarda_form_vert_form_tbicd9cmrawatjalan = $this->form_vert_form_tbicd9cmrawatjalan;
       $this->nmgp_opcao = 'novo';
   } 
   if ($this->Embutida_form && empty($this->form_vert_form_tbicd9cmrawatjalan))
   {
       $sc_seq_vert = 0;
   }
   ...
   foreach ($this->form_vert_form_tbicd9cmrawatjalan as $sc_seq_vert => $sc_lixo)
   {
       $this->loadRecordState($sc_seq_vert);
       $this->trancode_ = $this->form_vert_form_tbicd9cmrawatjalan[$sc_seq_vert]['trancode_'];
       ...
       elseif ($Line_Add)
       {
        ...
        $this->icd9cm_ = $this->form_vert_form_tbicd9cmrawatjalan[$sc_seq_vert]['icd9cm_']; 
       ...
       $this->keterangan_ = $this->form_vert_form_tbicd9cmrawatjalan[$sc_seq_vert]['keterangan_']; 
       ...
       $this->tglicd9cm_ = $this->form_vert_form_tbicd9cmrawatjalan[$sc_seq_vert]['tglicd9cm_'] . ' ' . $this->form_vert_form_tbicd9cmrawatjalan[$sc_seq_vert]['tglicd9cm__hora']; 
       ...
       $this->id_ = $this->form_vert_form_tbicd9cmrawatjalan[$sc_seq_vert]['id_']; 
       $id_ = $this->id_; 
       if (!isset($this->nmgp_cmp_hidden['id_']))
       {
           $this->nmgp_cmp_hidden['id_'] = 'off';
...
<?php echo nmButtonOutput($this->arr_buttons, "bmd_novo", "do_ajax_form_tbicd9cmrawatjalan_add_new_line(" . $sc_seq_vert . ")", "do_ajax_form_tbicd9cmrawatjalan_add_new_line(" . $sc_seq_vert . ")", "sc_new_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
<?php }?>
<?php
  $Style_add_line = (!$Line_Add) ? "display: none" : "";
?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_form_tbicd9cmrawatjalan_cancel_insert(" . $sc_seq_vert . ")", "do_ajax_form_tbicd9cmrawatjalan_cancel_insert(" . $sc_seq_vert . ")", "sc_canceli_line_" . $sc_seq_vert . "", "", "", "" . $Style_add_line . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_form_tbicd9cmrawatjalan_cancel_update(" . $sc_seq_vert . ")", "do_ajax_form_tbicd9cmrawatjalan_cancel_update(" . $sc_seq_vert . ")", "sc_cancelu_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
 </TD>
   <?php }?>
...
<?php } else { ?>
<span id="id_read_on_tglicd9cm_<?php echo $sc_seq_vert ?>" class="sc-ui-readonly-tglicd9cm_<?php echo $sc_seq_vert ?> css_tglicd9cm__line" style="<?php echo $sStyleReadLab_tglicd9cm_; ?>"><?php echo $tglicd9cm_; ?></span><span id="id_read_off_tglicd9cm_<?php echo $sc_seq_vert ?>" class="css_read_off_tglicd9cm_" style="white-space: nowrap;<?php echo $sStyleReadInp_tglicd9cm_; ?>"><?php
...
<?php   
   ...
   { 
       ...
       $this->form_vert_form_tbicd9cmrawatjalan = $guarda_form_vert_form_tbicd9cmrawatjalan;
   } 
   if ($Table_refresh) 
   { 
...
<?php
if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbicd9cmrawatjalan']['run_modal']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbicd9cmrawatjalan']['run_modal'])
{
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbicd9cmrawatjalan']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbicd9cmrawatjalan']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_tbicd9cmrawatjalan");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_tbicd9cmrawatjalan");
 parent.scAjaxDetailHeight("form_tbicd9cmrawatjalan", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
<script type="text/javascript">
	function scBtnFn_sys_format_inc() {
		if ($("#sc_b_new_t.sc-unique-btn-1").length && $("#sc_b_new_t.sc-unique-btn-1").is(":visible")) {
			do_ajax_form_tbicd9cmrawatjalan_add_new_line(); return false;
			 return;
		}
...
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbicd9cmrawatjalan']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
