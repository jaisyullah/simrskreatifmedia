...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_trandate_hora' + iSeqRow).bind('blur', function() { sc_form_tbadjustment_trandate_hora_onblur(this, iSeqRow) })
                                           .bind('focus', function() { sc_form_tbadjustment_trandate_hora_onfocus(this, iSeqRow) });
...
function sc_form_tbadjustment_trandate_hora_onblur(oThis, iSeqRow) {
  do_ajax_form_tbadjustment_validate_trandate();
  scCssBlur(oThis);
}
...
function sc_form_tbadjustment_trandate_hora_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function displayChange_field_detail(row, status) {
	if ("on" == status && typeof $("#nmsc_iframe_liga_form_tbdetailadjustment")[0].contentWindow.scRecreateSelect2 === "function") {
		$("#nmsc_iframe_liga_form_tbdetailadjustment")[0].contentWindow.scRecreateSelect2();
	}
}
...
function scHidePage(pageNo) {
	$("#id_form_tbadjustment_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_trandate" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_tbadjustment_validate_trandate(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
