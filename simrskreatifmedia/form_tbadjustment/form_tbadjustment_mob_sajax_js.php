  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbadjustment_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbadjustment_mob_form();
	}

  // ---------- Validate adjcode
  function do_ajax_form_tbadjustment_mob_validate_adjcode()
  {
    var nomeCampo_adjcode = "adjcode";
    var var_adjcode = scAjaxGetFieldText(nomeCampo_adjcode);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbadjustment_mob_validate_adjcode(var_adjcode, var_script_case_init, do_ajax_form_tbadjustment_mob_validate_adjcode_cb);
  } // do_ajax_form_tbadjustment_mob_validate_adjcode

  function do_ajax_form_tbadjustment_mob_validate_adjcode_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbadjustment_mob_validate_adjcode_cb

  // ---------- Validate depo
  function do_ajax_form_tbadjustment_mob_validate_depo()
  {
    var nomeCampo_depo = "depo";
    var var_depo = scAjaxGetFieldSelect(nomeCampo_depo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbadjustment_mob_validate_depo(var_depo, var_script_case_init, do_ajax_form_tbadjustment_mob_validate_depo_cb);
  } // do_ajax_form_tbadjustment_mob_validate_depo

  function do_ajax_form_tbadjustment_mob_validate_depo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "depo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbadjustment_mob_validate_depo_cb

  // ---------- Validate trandate
  function do_ajax_form_tbadjustment_mob_validate_trandate()
  {
    var nomeCampo_trandate = "trandate";
    var var_trandate = scAjaxGetFieldText(nomeCampo_trandate);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbadjustment_mob_validate_trandate(var_trandate, var_script_case_init, do_ajax_form_tbadjustment_mob_validate_trandate_cb);
  } // do_ajax_form_tbadjustment_mob_validate_trandate

  function do_ajax_form_tbadjustment_mob_validate_trandate_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbadjustment_mob_validate_trandate_cb

  // ---------- Validate adjby
  function do_ajax_form_tbadjustment_mob_validate_adjby()
  {
    var nomeCampo_adjby = "adjby";
    var var_adjby = scAjaxGetFieldText(nomeCampo_adjby);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbadjustment_mob_validate_adjby(var_adjby, var_script_case_init, do_ajax_form_tbadjustment_mob_validate_adjby_cb);
  } // do_ajax_form_tbadjustment_mob_validate_adjby

  function do_ajax_form_tbadjustment_mob_validate_adjby_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "adjby";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbadjustment_mob_validate_adjby_cb

  // ---------- Validate jenisadj
  function do_ajax_form_tbadjustment_mob_validate_jenisadj()
  {
    var nomeCampo_jenisadj = "jenisadj";
    var var_jenisadj = scAjaxGetFieldSelect(nomeCampo_jenisadj);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbadjustment_mob_validate_jenisadj(var_jenisadj, var_script_case_init, do_ajax_form_tbadjustment_mob_validate_jenisadj_cb);
  } // do_ajax_form_tbadjustment_mob_validate_jenisadj

  function do_ajax_form_tbadjustment_mob_validate_jenisadj_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbadjustment_mob_validate_jenisadj_cb

  // ---------- Validate note
  function do_ajax_form_tbadjustment_mob_validate_note()
  {
    var nomeCampo_note = "note";
    var var_note = scAjaxGetFieldText(nomeCampo_note);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbadjustment_mob_validate_note(var_note, var_script_case_init, do_ajax_form_tbadjustment_mob_validate_note_cb);
  } // do_ajax_form_tbadjustment_mob_validate_note

  function do_ajax_form_tbadjustment_mob_validate_note_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "note";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbadjustment_mob_validate_note_cb

  // ---------- Validate status
  function do_ajax_form_tbadjustment_mob_validate_status()
  {
    var nomeCampo_status = "status";
    var var_status = scAjaxGetFieldSelect(nomeCampo_status);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbadjustment_mob_validate_status(var_status, var_script_case_init, do_ajax_form_tbadjustment_mob_validate_status_cb);
  } // do_ajax_form_tbadjustment_mob_validate_status

  function do_ajax_form_tbadjustment_mob_validate_status_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "status";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbadjustment_mob_validate_status_cb

  // ---------- Validate detail
  function do_ajax_form_tbadjustment_mob_validate_detail()
  {
    var nomeCampo_detail = "detail";
    var var_detail = scAjaxGetFieldText(nomeCampo_detail);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbadjustment_mob_validate_detail(var_detail, var_script_case_init, do_ajax_form_tbadjustment_mob_validate_detail_cb);
  } // do_ajax_form_tbadjustment_mob_validate_detail

  function do_ajax_form_tbadjustment_mob_validate_detail_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "detail";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbadjustment_mob_validate_detail_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tbadjustment_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tbadjustment_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_tbadjustment_mob_submit_form(var_adjcode, var_depo, var_trandate, var_adjby, var_jenisadj, var_note, var_status, var_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbadjustment_mob_submit_form_cb);
  } // do_ajax_form_tbadjustment_mob_submit_form

  function do_ajax_form_tbadjustment_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tbadjustment_mob_submit_form_cb_after_alert);
  } // do_ajax_form_tbadjustment_mob_submit_form_cb
  function do_ajax_form_tbadjustment_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbadjustment_mob_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_tbdetailadjustment_mob"] = "off";

  function do_ajax_form_tbadjustment_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    scStatusDetail["form_tbdetailadjustment_mob"] = "on";
    x_ajax_form_tbadjustment_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbadjustment_mob_navigate_form_cb);
  } // do_ajax_form_tbadjustment_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbadjustment_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbadjustment_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_tbdetailadjustment_mob"] && "nmsc_iframe_liga_form_tbdetailadjustment_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_tbdetailadjustment_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_tbdetailadjustment_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_tbdetailadjustment_mob').contentWindow.nm_move('apl_detalhe', true, '1000');
        document.getElementById('nmsc_iframe_liga_form_tbdetailadjustment_mob').style.height = "1000";
        document.getElementById('nmsc_iframe_liga_form_tbdetailadjustment_mob').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbadjustment_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_tbadjustment_mob_navigate_form_cb
  function do_ajax_form_tbadjustment_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_tbadjustment_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_tbadjustment_mob_navigate_form_cb_after_alert
  function sc_hide_form_tbadjustment_mob_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_tbdetailadjustment_mob"])
    {
      return true;
    }
    return false;
