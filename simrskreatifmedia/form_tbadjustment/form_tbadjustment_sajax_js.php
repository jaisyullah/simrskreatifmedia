  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbadjustment" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbadjustment_form();
	}

  // ---------- Validate adjcode
  function do_ajax_form_tbadjustment_validate_adjcode()
  {
    var nomeCampo_adjcode = "adjcode";
    var var_adjcode = scAjaxGetFieldText(nomeCampo_adjcode);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbadjustment_validate_adjcode(var_adjcode, var_script_case_init, do_ajax_form_tbadjustment_validate_adjcode_cb);
  } // do_ajax_form_tbadjustment_validate_adjcode

  function do_ajax_form_tbadjustment_validate_adjcode_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbadjustment_validate_adjcode_cb

  // ---------- Validate depo
  function do_ajax_form_tbadjustment_validate_depo()
  {
    var nomeCampo_depo = "depo";
    var var_depo = scAjaxGetFieldSelect(nomeCampo_depo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbadjustment_validate_depo(var_depo, var_script_case_init, do_ajax_form_tbadjustment_validate_depo_cb);
  } // do_ajax_form_tbadjustment_validate_depo

  function do_ajax_form_tbadjustment_validate_depo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "depo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbadjustment_validate_depo_cb

  // ---------- Validate trandate
  function do_ajax_form_tbadjustment_validate_trandate()
  {
    var nomeCampo_trandate = "trandate";
    var var_trandate = scAjaxGetFieldText(nomeCampo_trandate);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbadjustment_validate_trandate(var_trandate, var_script_case_init, do_ajax_form_tbadjustment_validate_trandate_cb);
  } // do_ajax_form_tbadjustment_validate_trandate

  function do_ajax_form_tbadjustment_validate_trandate_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbadjustment_validate_trandate_cb

  // ---------- Validate adjby
  function do_ajax_form_tbadjustment_validate_adjby()
  {
    var nomeCampo_adjby = "adjby";
    var var_adjby = scAjaxGetFieldText(nomeCampo_adjby);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbadjustment_validate_adjby(var_adjby, var_script_case_init, do_ajax_form_tbadjustment_validate_adjby_cb);
  } // do_ajax_form_tbadjustment_validate_adjby

  function do_ajax_form_tbadjustment_validate_adjby_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "adjby";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbadjustment_validate_adjby_cb

  // ---------- Validate jenisadj
  function do_ajax_form_tbadjustment_validate_jenisadj()
  {
    var nomeCampo_jenisadj = "jenisadj";
    var var_jenisadj = scAjaxGetFieldSelect(nomeCampo_jenisadj);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbadjustment_validate_jenisadj(var_jenisadj, var_script_case_init, do_ajax_form_tbadjustment_validate_jenisadj_cb);
  } // do_ajax_form_tbadjustment_validate_jenisadj

  function do_ajax_form_tbadjustment_validate_jenisadj_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "jenisadj";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbadjustment_validate_jenisadj_cb

  // ---------- Validate note
  function do_ajax_form_tbadjustment_validate_note()
  {
    var nomeCampo_note = "note";
    var var_note = scAjaxGetFieldText(nomeCampo_note);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbadjustment_validate_note(var_note, var_script_case_init, do_ajax_form_tbadjustment_validate_note_cb);
  } // do_ajax_form_tbadjustment_validate_note

  function do_ajax_form_tbadjustment_validate_note_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "note";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbadjustment_validate_note_cb

  // ---------- Validate status
  function do_ajax_form_tbadjustment_validate_status()
  {
    var nomeCampo_status = "status";
    var var_status = scAjaxGetFieldSelect(nomeCampo_status);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbadjustment_validate_status(var_status, var_script_case_init, do_ajax_form_tbadjustment_validate_status_cb);
  } // do_ajax_form_tbadjustment_validate_status

  function do_ajax_form_tbadjustment_validate_status_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "status";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbadjustment_validate_status_cb

  // ---------- Validate detail
  function do_ajax_form_tbadjustment_validate_detail()
  {
    var nomeCampo_detail = "detail";
    var var_detail = scAjaxGetFieldText(nomeCampo_detail);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbadjustment_validate_detail(var_detail, var_script_case_init, do_ajax_form_tbadjustment_validate_detail_cb);
  } // do_ajax_form_tbadjustment_validate_detail

  function do_ajax_form_tbadjustment_validate_detail_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "detail";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbadjustment_validate_detail_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tbadjustment_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tbadjustment_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_adjcode = scAjaxGetFieldText("adjcode");
    var var_depo = scAjaxGetFieldSelect("depo");
    var var_trandate = scAjaxGetFieldText("trandate");
    var var_adjby = scAjaxGetFieldText("adjby");
    var var_jenisadj = scAjaxGetFieldSelect("jenisadj");
    ...
    scAjaxProcOn();
    x_ajax_form_tbadjustment_submit_form(var_adjcode, var_depo, var_trandate, var_adjby, var_jenisadj, var_note, var_status, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbadjustment_submit_form_cb);
  } // do_ajax_form_tbadjustment_submit_form

  function do_ajax_form_tbadjustment_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("adjcode");
      scAjaxHideErrorDisplay("depo");
      scAjaxHideErrorDisplay("trandate");
      scAjaxHideErrorDisplay("adjby");
      scAjaxHideErrorDisplay("jenisadj");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tbadjustment_submit_form_cb_after_alert);
  } // do_ajax_form_tbadjustment_submit_form_cb
  function do_ajax_form_tbadjustment_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbadjustment_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_tbdetailadjustment"] = "off";

  function do_ajax_form_tbadjustment_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    scStatusDetail["form_tbdetailadjustment"] = "on";
    x_ajax_form_tbadjustment_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbadjustment_navigate_form_cb);
  } // do_ajax_form_tbadjustment_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbadjustment']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbadjustment_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_tbdetailadjustment"] && "nmsc_iframe_liga_form_tbdetailadjustment" != scMasterDetailIframe["nmsc_iframe_liga_form_tbdetailadjustment"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_tbdetailadjustment"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_tbdetailadjustment').contentWindow.nm_move('apl_detalhe', true, '1000');
        document.getElementById('nmsc_iframe_liga_form_tbdetailadjustment').style.height = "1000";
        document.getElementById('nmsc_iframe_liga_form_tbdetailadjustment').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbadjustment_navigate_form_cb_after_alert);
  } // do_ajax_form_tbadjustment_navigate_form_cb
  function do_ajax_form_tbadjustment_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_tbadjustment_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_tbadjustment_navigate_form_cb_after_alert
  function sc_hide_form_tbadjustment_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_tbdetailadjustment"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[0] = "adjcode";
  ajax_field_list[1] = "depo";
  ajax_field_list[2] = "trandate";
  ajax_field_list[3] = "adjby";
  ajax_field_list[4] = "jenisadj";
  ajax_field_list[5] = "note";
  ajax_field_list[6] = "status";
  ajax_field_list[7] = "detail";
  ...
  var ajax_error_list = {
    "adjcode": {"label": "Kode Transaksi", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "depo": {"label": "Depo", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "adjby": {"label": "Verif Oleh", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "jenisadj": {"label": "Jenis", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  ajax_field_mult["adjcode"][1] = "adjcode";
  ajax_field_mult["depo"][1] = "depo";
  ajax_field_mult["trandate"][1] = "trandate";
  ajax_field_mult["adjby"][1] = "adjby";
  ajax_field_mult["jenisadj"][1] = "jenisadj";
  ajax_field_mult["note"][1] = "note";
  ajax_field_mult["status"][1] = "status";
  ajax_field_mult["detail"][1] = "detail";

  var ajax_field_id = {
    "adjcode": new Array("hidden_field_label_adjcode", "hidden_field_data_adjcode"),
    "depo": new Array("hidden_field_label_depo", "hidden_field_data_depo"),
    "trandate": new Array("hidden_field_label_trandate", "hidden_field_data_trandate"),
    "adjby": new Array("hidden_field_label_adjby", "hidden_field_data_adjby"),
    "jenisadj": new Array("hidden_field_label_jenisadj", "hidden_field_data_jenisadj"),
