...
class grid_tbdetailrawatinapF_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_tbdetailrawatinapF_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_tbdetailrawatinapF_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_tbdetailrawatinapF_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_jeniskeluar')
      {
          $jeniskeluar = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_jeniskeluar($jeniskeluar);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function lookup_ajax_trancode($trancode)
   {
      ...
      $nm_comando = "select distinct tranCode from " . $this->Ini->nm_tabela . " where selesai = 'N' and  tranCode like '%" . $trancode . "%' order by tranCode"; 
      unset($cmp1,$cmp2);
   ...
   function lookup_ajax_dokter($dokter)
   {
      ...
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct dokter from " . $this->Ini->nm_tabela . " where selesai = 'N' and  dokter like '%" . $dokter . "%' order by dokter"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
   ...
   function lookup_ajax_selesai($selesai)
   {
      ...
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct selesai from " . $this->Ini->nm_tabela . " where selesai = 'N' and  selesai like '%" . $selesai . "%' order by selesai"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
   ...
   function lookup_ajax_jeniskeluar($jeniskeluar)
   {
      $jeniskeluar = substr($this->Db->qstr($jeniskeluar), 1, -1);
            $jeniskeluar_look = substr($this->Db->qstr($jeniskeluar), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct jenisKeluar from " . $this->Ini->nm_tabela . " where selesai = 'N' and  jenisKeluar like '%" . $jeniskeluar . "%' order by jenisKeluar"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
   ...
   function lookup_ajax_carakeluar($carakeluar)
   {
      ...
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct caraKeluar from " . $this->Ini->nm_tabela . " where selesai = 'N' and  caraKeluar like '%" . $carakeluar . "%' order by caraKeluar"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
   ...
   function lookup_ajax_alasankeluar($alasankeluar)
   {
      ...
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct alasanKeluar from " . $this->Ini->nm_tabela . " where selesai = 'N' and  alasanKeluar like '%" . $alasankeluar . "%' order by alasanKeluar"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
   ...
   function lookup_ajax_custcode($custcode)
   {
      ...
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct custCode from " . $this->Ini->nm_tabela . " where selesai = 'N' and  custCode like '%" . $custcode . "%' order by custCode"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
   ...
   function lookup_ajax_resikojatuh($resikojatuh)
   {
      ...
      {
          $nm_comando = "select distinct resikoJatuh from " . $this->Ini->nm_tabela . " where selesai = 'N' and   CAST (resikoJatuh AS TEXT)  like '%" . $resikojatuh . "%' order by resikoJatuh"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct resikoJatuh from " . $this->Ini->nm_tabela . " where selesai = 'N' and   CAST (resikoJatuh AS VARCHAR)  like '%" . $resikojatuh . "%' order by resikoJatuh"; 
      }
      else
      {
          $nm_comando = "select distinct resikoJatuh from " . $this->Ini->nm_tabela . " where selesai = 'N' and  resikoJatuh like '%" . $resikojatuh . "%' order by resikoJatuh"; 
      }
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - Pelayanan Resep Rawat Inap</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_tbdetailrawatinapF/grid_tbdetailrawatinapF_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_tbdetailrawatinapF_ajax_search.js"></script>
 <script type="text/javascript" src="grid_tbdetailrawatinapF_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_tbdetailrawatinapF_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_tbdetailrawatinapF']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_tbdetailrawatinapF']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_jeniskeluar_cond#NMF#' + search_get_sel_txt('SC_jeniskeluar_cond') + '@NMF@';
  str_out += 'SC_jeniskeluar#NMF#' + search_get_text('SC_jeniskeluar') + '@NMF@';
  str_out += 'id_ac_jeniskeluar#NMF#' + search_get_text('id_ac_jeniskeluar') + '@NMF@';
  ...
  str_out += 'SC_nama pasien_cond#NMF#' + search_get_sel_txt('SC_sc_field_0_cond') + '@NMF@';
  str_out += 'SC_nama pasien#NMF#' + search_get_text('SC_sc_field_0') + '@NMF@';
  str_out += 'SC_ruanginap_cond#NMF#' + search_get_sel_txt('SC_ruanginap_cond') + '@NMF@';
  str_out += 'SC_ruanginap#NMF#' + search_get_text('SC_ruanginap') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
   ...
   $("#id_ac_jeniskeluar").autocomplete({
     minLength: 1,
     source: function (request, response) {
     $.ajax({
       url: "index.php",
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_jeniskeluar",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_jeniskeluar").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     focus: function (event, ui) {
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div class="scFilterHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFilterHeaderFont" style="float: left; text-transform: uppercase;"><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - Pelayanan Resep Rawat Inap</div>
...
<?php
   ...
   function monta_form()
   {
      global 
             ...
             $tglkeluar_cond, $tglkeluar, $tglkeluar_dia, $tglkeluar_mes, $tglkeluar_ano, $tglkeluar_hor, $tglkeluar_min, $tglkeluar_seg,
             $jeniskeluar_cond, $jeniskeluar, $jeniskeluar_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $trancode = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['campos_busca']['trancode']; 
          $trancode_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['campos_busca']['trancode_cond']; 
          $dokter = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['campos_busca']['dokter']; 
          $dokter_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['campos_busca']['dokter_cond']; 
          $selesai = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['campos_busca']['selesai']; 
          $selesai_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['campos_busca']['selesai_cond']; 
          $tglkeluar_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['campos_busca']['tglkeluar_dia']; 
          $tglkeluar_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['campos_busca']['tglkeluar_mes']; 
          $tglkeluar_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['campos_busca']['tglkeluar_ano']; 
          $tglkeluar_hor = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['campos_busca']['tglkeluar_hor']; 
          $tglkeluar_min = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['campos_busca']['tglkeluar_min']; 
          $tglkeluar_seg = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['campos_busca']['tglkeluar_seg']; 
          $tglkeluar_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['campos_busca']['tglkeluar_cond']; 
          $jeniskeluar = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['campos_busca']['jeniskeluar']; 
          $jeniskeluar_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['campos_busca']['jeniskeluar_cond']; 
          $carakeluar = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['campos_busca']['carakeluar']; 
          $carakeluar_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['campos_busca']['carakeluar_cond']; 
          $alasankeluar = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['campos_busca']['alasankeluar']; 
          $alasankeluar_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['campos_busca']['alasankeluar_cond']; 
          $custcode = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['campos_busca']['custcode']; 
          $custcode_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['campos_busca']['custcode_cond']; 
          $resikojatuh = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['campos_busca']['resikojatuh']; 
          $resikojatuh_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['campos_busca']['resikojatuh_cond']; 
          $sc_field_0 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['campos_busca']['sc_field_0']; 
          $sc_field_0_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['campos_busca']['sc_field_0_cond']; 
          $ruanginap = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['campos_busca']['ruanginap']; 
          $ruanginap_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['campos_busca']['ruanginap_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['campos_busca']['NM_operador']; 
      } 
      ...
      $str_hide_jeniskeluar = (in_array($jeniskeluar_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      $str_hide_ruanginap = (in_array($ruanginap_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      if (!isset($jeniskeluar) || $jeniskeluar == "")
      {
          $jeniskeluar = "";
      }
      ...
      if (!isset($ruanginap) || $ruanginap == "")
      {
          $ruanginap = "";
      }
      if (isset($ruanginap) && !empty($ruanginap))
      {
...
<?php
      ...
      $trancode_look = substr($this->Db->qstr($trancode), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct tranCode from " . $this->Ini->nm_tabela . " where selesai = 'N' and tranCode = '$trancode_look' order by tranCode"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
...
<?php
      ...
      $dokter_look = substr($this->Db->qstr($dokter), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct dokter from " . $this->Ini->nm_tabela . " where selesai = 'N' and dokter = '$dokter_look' order by dokter"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
...
?>
<INPUT  type="text" id="SC_dokter" name="dokter" value="<?php echo NM_encode_input($dokter) ?>"  size=25 alt="{datatype: 'text', maxLength: 25, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_dokter" name="dokter_autocomp" size="25"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 25, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
<?php
      ...
      $selesai_look = substr($this->Db->qstr($selesai), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct selesai from " . $this->Ini->nm_tabela . " where selesai = 'N' and selesai = '$selesai_look' order by selesai"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
...
?>
<INPUT  type="text" id="SC_selesai" name="selesai" value="<?php echo NM_encode_input($selesai) ?>"  size=1 alt="{datatype: 'text', maxLength: 1, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_selesai" name="selesai_autocomp" size="1"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 1, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <INPUT type="hidden" id="SC_tglkeluar_cond" name="tglkeluar_cond" value="eq">
...
?>
 ...
 <?php echo $date_format_show ?>         </SPAN>
      ...
      <TD id='SC_jeniskeluar_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['jeniskeluar'])) ? $this->New_label['jeniskeluar'] : "Jenis Keluar"; ?></TD>
      
      <INPUT type="hidden" id="SC_jeniskeluar_cond" name="jeniskeluar_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_jeniskeluar" <?php echo $str_hide_jeniskeluar?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['jeniskeluar'])) ? $this->New_label['jeniskeluar'] : "Jenis Keluar";
 $nmgp_tab_label .= "jeniskeluar?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      $jeniskeluar_look = substr($this->Db->qstr($jeniskeluar), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct jenisKeluar from " . $this->Ini->nm_tabela . " where selesai = 'N' and jenisKeluar = '$jeniskeluar_look' order by jenisKeluar"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      if (isset($nmgp_def_dados[0][$jeniskeluar]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$jeniskeluar];
      }
      else
      {
          $sAutocompValue = $jeniskeluar;
      }
?>
<INPUT  type="text" id="SC_jeniskeluar" name="jeniskeluar" value="<?php echo NM_encode_input($jeniskeluar) ?>"  size=25 alt="{datatype: 'text', maxLength: 25, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_jeniskeluar" name="jeniskeluar_autocomp" size="25"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 25, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
<?php
      ...
      $carakeluar_look = substr($this->Db->qstr($carakeluar), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct caraKeluar from " . $this->Ini->nm_tabela . " where selesai = 'N' and caraKeluar = '$carakeluar_look' order by caraKeluar"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
...
?>
<INPUT  type="text" id="SC_carakeluar" name="carakeluar" value="<?php echo NM_encode_input($carakeluar) ?>"  size=25 alt="{datatype: 'text', maxLength: 25, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_carakeluar" name="carakeluar_autocomp" size="25"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 25, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <INPUT type="hidden" id="SC_alasankeluar_cond" name="alasankeluar_cond" value="eq">
...
<?php
      ...
      $alasankeluar_look = substr($this->Db->qstr($alasankeluar), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct alasanKeluar from " . $this->Ini->nm_tabela . " where selesai = 'N' and alasanKeluar = '$alasankeluar_look' order by alasanKeluar"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
...
?>
<INPUT  type="text" id="SC_alasankeluar" name="alasankeluar" value="<?php echo NM_encode_input($alasankeluar) ?>"  size=50 alt="{datatype: 'text', maxLength: 100, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_alasankeluar" name="alasankeluar_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 100, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
<?php
      ...
      $custcode_look = substr($this->Db->qstr($custcode), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct custCode from " . $this->Ini->nm_tabela . " where selesai = 'N' and custCode = '$custcode_look' order by custCode"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
...
?>
<INPUT  type="text" id="SC_custcode" name="custcode" value="<?php echo NM_encode_input($custcode) ?>"  size=6 alt="{datatype: 'text', maxLength: 6, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_custcode" name="custcode_autocomp" size="6"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 6, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_resikojatuh_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['resikojatuh'])) ? $this->New_label['resikojatuh'] : "Resiko Jatuh"; ?></TD>
      
      <INPUT type="hidden" id="SC_resikojatuh_cond" name="resikojatuh_cond" value="eq">
...
<?php
   ...
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct resikoJatuh from " . $this->Ini->nm_tabela . " where selesai = 'N' and resikoJatuh = $resikojatuh_look order by resikoJatuh"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct resikoJatuh from " . $this->Ini->nm_tabela . " where selesai = 'N' and resikoJatuh = $resikojatuh_look order by resikoJatuh"; 
...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_resikojatuh" name="resikojatuh_autocomp" size="3"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 3, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
      ...
      <TD id='SC_sc_field_0_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['sc_field_0'])) ? $this->New_label['sc_field_0'] : "Nama Pasien"; ?></TD>
...
?>
<INPUT  type="text" id="SC_sc_field_0" name="sc_field_0" value="<?php echo NM_encode_input($sc_field_0) ?>"  size=10 alt="{datatype: 'text', maxLength: 20, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
      ...
      <TD id='SC_ruanginap_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['ruanginap'])) ? $this->New_label['ruanginap'] : "ruangInap"; ?></TD>
      
      <INPUT type="hidden" id="SC_ruanginap_cond" name="ruanginap_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_ruanginap" <?php echo $str_hide_ruanginap?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['ruanginap'])) ? $this->New_label['ruanginap'] : "ruangInap";
 $nmgp_tab_label .= "ruanginap?#?" . $SC_Label . "?@?";
...
?>
<INPUT  type="text" id="SC_ruanginap" name="ruanginap" value="<?php echo NM_encode_input($ruanginap) ?>"  size=10 alt="{datatype: 'text', maxLength: 20, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
...
?>
<?php
   if (is_file("grid_tbdetailrawatinapF_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_tbdetailrawatinapF']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_tbdetailrawatinapF']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   nm_campos_between(document.getElementById('id_vis_jeniskeluar'), document.F1.jeniskeluar_cond, 'jeniskeluar');
   document.F1.jeniskeluar.value = "";
   document.F1.jeniskeluar_autocomp.value = "";
   ...
   nm_campos_between(document.getElementById('id_vis_ruanginap'), document.F1.ruanginap_cond, 'ruanginap');
   document.F1.ruanginap.value = "";
 }
 function SC_carga_evt_jquery()
 {
    $('#SC_tglkeluar_dia').bind('change', function() {sc_grid_tbdetailrawatinapF_valida_dia(this)});
    $('#SC_tglkeluar_hor').bind('change', function() {sc_grid_tbdetailrawatinapF_valida_hora(this)});
    $('#SC_tglkeluar_mes').bind('change', function() {sc_grid_tbdetailrawatinapF_valida_mes(this)});
    $('#SC_tglkeluar_min').bind('change', function() {sc_grid_tbdetailrawatinapF_valida_min(this)});
    $('#SC_tglkeluar_seg').bind('change', function() {sc_grid_tbdetailrawatinapF_valida_seg(this)});
 }
 function sc_grid_tbdetailrawatinapF_valida_dia(obj)
 {
 ...
 function sc_grid_tbdetailrawatinapF_valida_mes(obj)
 {
 ...
 function sc_grid_tbdetailrawatinapF_valida_hora(obj)
 {
 ...
 function sc_grid_tbdetailrawatinapF_valida_min(obj)
 {
 ...
 function sc_grid_tbdetailrawatinapF_valida_seg(obj)
 {
     if (obj.value != "" && (obj.value < 0 || obj.value > 59))
     {
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "simrskreatifmedia/grid_tbdetailrawatinapF";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro($nmgp_save_origem)
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "grid_tbdetailrawatinapF/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_jeniskeluar_cond'] = 'cond';
      $tp_fields['SC_jeniskeluar'] = 'text_aut';
      $tp_fields['id_ac_jeniskeluar'] = 'text_aut';
      ...
      $tp_fields['SC_ruanginap_cond'] = 'cond';
      $tp_fields['SC_ruanginap'] = 'text';
      $tp_fields['SC_NM_operador'] = 'text';
      $tb_fields_esp['SC_nama pasien_cond'] = 'SC_sc_field_0_cond';
      $tb_fields_esp['SC_nama pasien'] = 'SC_sc_field_0';
      if (is_file($NM_patch))
      {
          $SC_V8    = false;
   ...
   function trata_campos()
   {
      global $trancode_cond, $trancode, $trancode_autocomp,
             ...
             $resikojatuh_cond, $resikojatuh, $resikojatuh_autocomp,
             $sc_field_0_cond, $sc_field_0,
             $ruanginap_cond, $ruanginap, $nmgp_tab_label;
      ...
      if (!empty($jeniskeluar_autocomp) && empty($jeniskeluar))
      {
          $jeniskeluar = $jeniskeluar_autocomp;
      }
      ...
      $jeniskeluar_cond_salva = $jeniskeluar_cond; 
      if (!isset($jeniskeluar_input_2) || $jeniskeluar_input_2 == "")
      {
          $jeniskeluar_input_2 = $jeniskeluar;
      }
      ...
      $ruanginap_cond_salva = $ruanginap_cond; 
      if (!isset($ruanginap_input_2) || $ruanginap_input_2 == "")
      {
          $ruanginap_input_2 = $ruanginap;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['campos_busca']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['campos_busca_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['campos_busca'];
      }
      if ($resikojatuh_cond != "in")
      {
          nm_limpa_numero($resikojatuh, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['campos_busca']['trancode'] = $trancode; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['campos_busca']['trancode_cond'] = $trancode_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['campos_busca']['dokter'] = $dokter; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['campos_busca']['dokter_cond'] = $dokter_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['campos_busca']['selesai'] = $selesai; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['campos_busca']['selesai_cond'] = $selesai_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['campos_busca']['tglkeluar_dia'] = $tglkeluar_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['campos_busca']['tglkeluar_mes'] = $tglkeluar_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['campos_busca']['tglkeluar_ano'] = $tglkeluar_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['campos_busca']['tglkeluar_hor'] = $tglkeluar_hor; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['campos_busca']['tglkeluar_min'] = $tglkeluar_min; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['campos_busca']['tglkeluar_seg'] = $tglkeluar_seg; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['campos_busca']['tglkeluar_cond'] = $tglkeluar_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['campos_busca']['jeniskeluar'] = $jeniskeluar; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['campos_busca']['jeniskeluar_cond'] = $jeniskeluar_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['campos_busca']['carakeluar'] = $carakeluar; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['campos_busca']['carakeluar_cond'] = $carakeluar_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['campos_busca']['alasankeluar'] = $alasankeluar; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['campos_busca']['alasankeluar_cond'] = $alasankeluar_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['campos_busca']['custcode'] = $custcode; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['campos_busca']['custcode_cond'] = $custcode_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['campos_busca']['resikojatuh'] = $resikojatuh; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['campos_busca']['resikojatuh_cond'] = $resikojatuh_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['campos_busca']['sc_field_0'] = $sc_field_0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['campos_busca']['sc_field_0_cond'] = $sc_field_0_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['campos_busca']['ruanginap'] = $ruanginap; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['campos_busca']['ruanginap_cond'] = $ruanginap_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['campos_busca'] = $Temp_Busca;
      }
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['jeniskeluar'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['jeniskeluar'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['jeniskeluar'] = $jeniskeluar;
      }
      $carakeluar_look = substr($this->Db->qstr($carakeluar), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct caraKeluar from " . $this->Ini->nm_tabela . " where selesai = 'N' and caraKeluar = '$carakeluar_look' order by caraKeluar"; 
   ...
   { 
      ...
      $Conteudo = $ruanginap;
      $this->cmp_formatado['ruanginap'] = $Conteudo;
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['campos_busca_ant']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['campos_busca_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['campos_busca'];
      }
      ...
      {
         $this->monta_condicao("selesai", $selesai_cond, $selesai, "", "selesai");
      }
      ...
      if ($tglkeluar_cond != "bi_TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['campos_busca']['tglkeluar'] = $val[0];
          ...
          if ($tglkeluar_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['campos_busca']['tglkeluar_input_2'] = $val[1];
          ...
          {
              $this->monta_condicao("tglKeluar", $tglkeluar_cond, $tglkeluar, $tglkeluar_input_2, 'tglkeluar', 'DATETIME');
          }
      }

      //----- $jeniskeluar
      $this->Date_part = false;
      if (isset($jeniskeluar) || $jeniskeluar_cond == "nu" || $jeniskeluar_cond == "nn" || $jeniskeluar_cond == "ep" || $jeniskeluar_cond == "ne")
      {
         $this->monta_condicao("jenisKeluar", $jeniskeluar_cond, $jeniskeluar, "", "jeniskeluar");
      }
      ...
      {
         $this->monta_condicao("caraKeluar", $carakeluar_cond, $carakeluar, "", "carakeluar");
      }
      ...
      {
         $this->monta_condicao("alasanKeluar", $alasankeluar_cond, $alasankeluar, "", "alasankeluar");
      }
      ...
      {
         $this->monta_condicao("resikoJatuh", $resikojatuh_cond, $resikojatuh, "", "resikojatuh");
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['where_pesq_ant'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['campos_busca_ant'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['campos_busca'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailrawatinapF']['cond_pesq'] .= $this->NM_operador;
