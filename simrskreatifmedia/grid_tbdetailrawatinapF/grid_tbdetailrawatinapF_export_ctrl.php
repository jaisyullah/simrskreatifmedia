<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tbdetailrawatinapF']['sc_process_barr'] = true;
require_once('../grid_tbdetailrawatinapF/index.php');
unset($_SESSION['scriptcase']['grid_tbdetailrawatinapF']['sc_process_barr']);
$ExportCtrl = new grid_tbdetailrawatinapF_export_control;
$ExportCtrl->Export_barr();

class grid_tbdetailrawatinapF_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - Pelayanan Resep Rawat Inap :: Excel</TITLE>
