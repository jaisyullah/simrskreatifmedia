...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "tglKeluar";$Nm_datas[] = "tglKeluar";$Nm_numeric[] = "resikojatuh";
...
<HTML>
<HEAD>
 <TITLE> - Pelayanan Resep Rawat Inap</TITLE>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_dokter"  <?php echo $str_hide_dokter?>><?php
      if ($dokter != "")
      {
      $dokter_look = substr($this->Db->qstr($dokter), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_selesai"  <?php echo $str_hide_selesai?>><?php
      if ($selesai != "")
      {
      $selesai_look = substr($this->Db->qstr($selesai), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_jeniskeluar"  <?php echo $str_hide_jeniskeluar?>><?php
      if ($jeniskeluar != "")
      {
      $jeniskeluar_look = substr($this->Db->qstr($jeniskeluar), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_carakeluar"  <?php echo $str_hide_carakeluar?>><?php
      if ($carakeluar != "")
      {
      $carakeluar_look = substr($this->Db->qstr($carakeluar), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_alasankeluar"  <?php echo $str_hide_alasankeluar?>><?php
      if ($alasankeluar != "")
      {
      $alasankeluar_look = substr($this->Db->qstr($alasankeluar), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_resikojatuh"  <?php echo $str_hide_resikojatuh?>><?php
      if ($resikojatuh != "")
      {
      $resikojatuh_look = substr($this->Db->qstr($resikojatuh), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_sc_field_0"  <?php echo $str_hide_sc_field_0?>><INPUT  type="text" id="SC_sc_field_0" name="sc_field_0" value="<?php echo NM_encode_input($sc_field_0) ?>"  size=10 alt="{datatype: 'text', maxLength: 20, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_ruanginap"  <?php echo $str_hide_ruanginap?>><INPUT  type="text" id="SC_ruanginap" name="ruanginap" value="<?php echo NM_encode_input($ruanginap) ?>"  size=10 alt="{datatype: 'text', maxLength: 20, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
