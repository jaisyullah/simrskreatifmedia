<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tbhistoriro']['sc_process_barr'] = true;
require_once('../grid_tbhistoriro/index.php');
unset($_SESSION['scriptcase']['grid_tbhistoriro']['sc_process_barr']);
$ExportCtrl = new grid_tbhistoriro_export_control;
$ExportCtrl->Export_barr();

class grid_tbhistoriro_export_control
{
