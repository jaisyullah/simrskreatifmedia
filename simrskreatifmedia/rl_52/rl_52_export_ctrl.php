<?php
@session_start() ;
$_SESSION['scriptcase']['rl_52']['sc_process_barr'] = true;
require_once('../rl_52/index.php');
unset($_SESSION['scriptcase']['rl_52']['sc_process_barr']);
$ExportCtrl = new rl_52_export_control;
$ExportCtrl->Export_barr();

class rl_52_export_control
{
