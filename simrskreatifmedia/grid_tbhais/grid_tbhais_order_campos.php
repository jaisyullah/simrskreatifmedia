<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_tbhais']['glo_nm_path_imag_temp'] . "/sc_apl_default_simrskreatifmedia.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_tbhais_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_tbhais_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbhais']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tbhais']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["trandate"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbhais']['labels']["trandate"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbhais']['labels']["trandate"] : "Tgl. Transaksi";
   $tab_ger_campos['trancode'] = "on";
   $tab_def_campos['trancode'] = "tranCode";
   $tab_labels["trancode"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbhais']['labels']["trancode"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbhais']['labels']["trancode"] : "Kode Ranap";
   $tab_ger_campos['custcode'] = "on";
   $tab_def_campos['custcode'] = "custCode";
   $tab_labels["custcode"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbhais']['labels']["custcode"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbhais']['labels']["custcode"] : "Pasien";
   $tab_ger_campos['ett'] = "on";
   $tab_def_campos['ett'] = "ETT";
   $tab_labels["ett"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbhais']['labels']["ett"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbhais']['labels']["ett"] : "ETT";
   $tab_ger_campos['cvl'] = "on";
   $tab_def_campos['cvl'] = "CVL";
   $tab_labels["cvl"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbhais']['labels']["cvl"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbhais']['labels']["cvl"] : "CVL";
   $tab_ger_campos['ivl'] = "on";
   $tab_def_campos['ivl'] = "IVL";
   $tab_labels["ivl"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbhais']['labels']["ivl"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbhais']['labels']["ivl"] : "IVL";
   $tab_ger_campos['uc'] = "on";
   $tab_def_campos['uc'] = "UC";
   $tab_labels["uc"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbhais']['labels']["uc"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbhais']['labels']["uc"] : "UC";
   $tab_ger_campos['vap'] = "on";
   $tab_def_campos['vap'] = "VAP";
   $tab_labels["vap"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbhais']['labels']["vap"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbhais']['labels']["vap"] : "VAP";
   $tab_ger_campos['iad'] = "on";
   $tab_def_campos['iad'] = "IAD";
   $tab_labels["iad"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbhais']['labels']["iad"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbhais']['labels']["iad"] : "IAD";
   $tab_ger_campos['pleb'] = "on";
   $tab_def_campos['pleb'] = "PLEB";
   $tab_labels["pleb"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbhais']['labels']["pleb"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbhais']['labels']["pleb"] : "PLEB";
   $tab_ger_campos['isk'] = "on";
   $tab_def_campos['isk'] = "ISK";
   $tab_labels["isk"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbhais']['labels']["isk"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbhais']['labels']["isk"] : "ISK";
   $tab_ger_campos['deku'] = "on";
   $tab_def_campos['deku'] = "Deku";
   $tab_labels["deku"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbhais']['labels']["deku"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbhais']['labels']["deku"] : "Deku";
   $tab_ger_campos['sputum'] = "on";
   $tab_def_campos['sputum'] = "Sputum";
   $tab_labels["sputum"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbhais']['labels']["sputum"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbhais']['labels']["sputum"] : "Sputum";
   $tab_ger_campos['darah'] = "on";
   $tab_def_campos['darah'] = "Darah";
   $tab_labels["darah"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbhais']['labels']["darah"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbhais']['labels']["darah"] : "Darah";
   $tab_ger_campos['urine'] = "on";
   $tab_def_campos['urine'] = "Urine";
   $tab_labels["urine"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbhais']['labels']["urine"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbhais']['labels']["urine"] : "Urine";
   $tab_ger_campos['antibiotik'] = "on";
   $tab_def_campos['antibiotik'] = "Antibiotik";
   $tab_labels["antibiotik"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbhais']['labels']["antibiotik"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbhais']['labels']["antibiotik"] : "Antibiotik";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_tbhais']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_tbhais']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_tbhais']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbhais']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tbhais']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_tbhais']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_tbhais']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_tbhais']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_tbhais']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_tbhais_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_tbhais']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_tbhais']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_tbhais']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_tbhais']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_tbhais']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
