<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tbhais']['sc_process_barr'] = true;
require_once('../grid_tbhais/index.php');
unset($_SESSION['scriptcase']['grid_tbhais']['sc_process_barr']);
$ExportCtrl = new grid_tbhais_export_control;
$ExportCtrl->Export_barr();

class grid_tbhais_export_control
{
