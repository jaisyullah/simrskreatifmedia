...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "tranDate";$Nm_datas[] = "tranDate";$Nm_numeric[] = "id";$Nm_numeric[] = "ett";$Nm_numeric[] = "cvl";$Nm_numeric[] = "ivl";$Nm_numeric[] = "uc";$Nm_numeric[] = "vap";$Nm_numeric[] = "iad";$Nm_numeric[] = "pleb";$Nm_numeric[] = "isk";$Nm_numeric[] = "deku";$Nm_numeric[] = "sputum";$Nm_numeric[] = "darah";$Nm_numeric[] = "urine";$Nm_numeric[] = "antibiotik";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_custcode_cond" name="custcode_cond" onChange="nm_campos_between(document.getElementById('id_vis_custcode'), this, 'custcode')">
