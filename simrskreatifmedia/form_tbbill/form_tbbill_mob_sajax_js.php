  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbbill_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbbill_mob_form();
	}

  // ---------- Validate id
  function do_ajax_form_tbbill_mob_validate_id()
  {
    var nomeCampo_id = "id";
    var var_id = scAjaxGetFieldText(nomeCampo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbbill_mob_validate_id(var_id, var_script_case_init, do_ajax_form_tbbill_mob_validate_id_cb);
  } // do_ajax_form_tbbill_mob_validate_id

  function do_ajax_form_tbbill_mob_validate_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbbill_mob_validate_id_cb

  // ---------- Validate trancode
  function do_ajax_form_tbbill_mob_validate_trancode()
  {
    var nomeCampo_trancode = "trancode";
    var var_trancode = scAjaxGetFieldText(nomeCampo_trancode);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbbill_mob_validate_trancode(var_trancode, var_script_case_init, do_ajax_form_tbbill_mob_validate_trancode_cb);
  } // do_ajax_form_tbbill_mob_validate_trancode

  function do_ajax_form_tbbill_mob_validate_trancode_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbbill_mob_validate_trancode_cb

  // ---------- Validate keterangan
  function do_ajax_form_tbbill_mob_validate_keterangan()
  {
    var nomeCampo_keterangan = "keterangan";
    var var_keterangan = scAjaxGetFieldText(nomeCampo_keterangan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbbill_mob_validate_keterangan(var_keterangan, var_script_case_init, do_ajax_form_tbbill_mob_validate_keterangan_cb);
  } // do_ajax_form_tbbill_mob_validate_keterangan

  function do_ajax_form_tbbill_mob_validate_keterangan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbbill_mob_validate_keterangan_cb

  // ---------- Validate deposit
  function do_ajax_form_tbbill_mob_validate_deposit()
  {
    var nomeCampo_deposit = "deposit";
    var var_deposit = scAjaxGetFieldText(nomeCampo_deposit);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbbill_mob_validate_deposit(var_deposit, var_script_case_init, do_ajax_form_tbbill_mob_validate_deposit_cb);
  } // do_ajax_form_tbbill_mob_validate_deposit

  function do_ajax_form_tbbill_mob_validate_deposit_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "deposit";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbbill_mob_validate_deposit_cb

  // ---------- Validate trandate
  function do_ajax_form_tbbill_mob_validate_trandate()
  {
    var nomeCampo_trandate = "trandate";
    var var_trandate = scAjaxGetFieldText(nomeCampo_trandate);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbbill_mob_validate_trandate(var_trandate, var_script_case_init, do_ajax_form_tbbill_mob_validate_trandate_cb);
  } // do_ajax_form_tbbill_mob_validate_trandate

  function do_ajax_form_tbbill_mob_validate_trandate_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbbill_mob_validate_trandate_cb

  // ---------- Validate nostruk
  function do_ajax_form_tbbill_mob_validate_nostruk()
  {
    var nomeCampo_nostruk = "nostruk";
    var var_nostruk = scAjaxGetFieldText(nomeCampo_nostruk);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbbill_mob_validate_nostruk(var_nostruk, var_script_case_init, do_ajax_form_tbbill_mob_validate_nostruk_cb);
  } // do_ajax_form_tbbill_mob_validate_nostruk

  function do_ajax_form_tbbill_mob_validate_nostruk_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nostruk";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbbill_mob_validate_nostruk_cb

  // ---------- Validate billdetail
  function do_ajax_form_tbbill_mob_validate_billdetail()
  {
    var nomeCampo_billdetail = "billdetail";
    var var_billdetail = scAjaxGetFieldText(nomeCampo_billdetail);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbbill_mob_validate_billdetail(var_billdetail, var_script_case_init, do_ajax_form_tbbill_mob_validate_billdetail_cb);
  } // do_ajax_form_tbbill_mob_validate_billdetail

  function do_ajax_form_tbbill_mob_validate_billdetail_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "billdetail";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbbill_mob_validate_billdetail_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tbbill_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tbbill_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_tbbill_mob_submit_form(var_id, var_trancode, var_keterangan, var_deposit, var_trandate, var_nostruk, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbbill_mob_submit_form_cb);
  } // do_ajax_form_tbbill_mob_submit_form

  function do_ajax_form_tbbill_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("billdetail");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tbbill_mob_submit_form_cb_after_alert);
  } // do_ajax_form_tbbill_mob_submit_form_cb
  function do_ajax_form_tbbill_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbbill_mob_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_tbbilldetail_mob"] = "off";

  function do_ajax_form_tbbill_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    scStatusDetail["form_tbbilldetail_mob"] = "on";
    x_ajax_form_tbbill_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbbill_mob_navigate_form_cb);
  } // do_ajax_form_tbbill_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbill_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbbill_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_tbbilldetail_mob"] && "nmsc_iframe_liga_form_tbbilldetail_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_tbbilldetail_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_tbbilldetail_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_tbbilldetail_mob').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_tbbilldetail_mob').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_tbbilldetail_mob').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbbill_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_tbbill_mob_navigate_form_cb
  function do_ajax_form_tbbill_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_tbbill_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_tbbill_mob_navigate_form_cb_after_alert
  function sc_hide_form_tbbill_mob_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_tbbilldetail_mob"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[3] = "deposit";
  ajax_field_list[4] = "trandate";
  ajax_field_list[5] = "nostruk";
  ajax_field_list[6] = "billdetail";
  ...
  var ajax_error_list = {
    ...
    "billdetail": {"label": "billDetail", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  ajax_field_mult["billdetail"][1] = "billdetail";
  ...
  var ajax_field_id = {
    ...
    "billdetail": new Array("hidden_field_label_billdetail", "hidden_field_data_billdetail")
  };
