<?php
class form_detailopname_gizi_form extends form_detailopname_gizi_apl
{
function Form_Init()
{
...
<HEAD>
 <TITLE><?php if ('novo' == $this->nmgp_opcao) { echo strip_tags("" . $this->Ini->Nm_lang['lang_othr_frmi_titl'] . " - detailopname_gizi"); } else { echo strip_tags("" . $this->Ini->Nm_lang['lang_othr_frmu_titl'] . " - detailopname_gizi"); } ?></TITLE>
...
<?php
if ($this->Embutida_form && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detailopname_gizi']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detailopname_gizi']['sc_modal'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detailopname_gizi']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detailopname_gizi']['sc_redir_atualiz'] == 'ok')
{
?>
...
.sc-button-image.disabled img {
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detailopname_gizi']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_detailopname_gizi/form_detailopname_gizi_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_detailopname_gizi_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_detailopname_gizi_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_detailopname_gizi']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_detailopname_gizi']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_detailopname_gizi']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_detailopname_gizi']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_detailopname_gizi']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detailopname_gizi']['recarga'];
}
if ('novo' == $opcao_botoes && $this->Embutida_form)
{
    $opcao_botoes = 'inicio';
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detailopname_gizi']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detailopname_gizi']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
?>
...
<?php
 include_once("form_detailopname_gizi_js0.php");
?>
<script type="text/javascript"> 
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_detailopname_gizi'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_detailopname_gizi'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detailopname_gizi']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_detailopname_gizi']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_detailopname_gizi']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_detailopname_gizi']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['form_detailopname_gizi']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<div class="scFormHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFormHeaderFont" style="float: left; text-transform: uppercase;"><?php if ($this->nmgp_opcao == "novo") { echo "" . $this->Ini->Nm_lang['lang_othr_frmi_titl'] . " - detailopname_gizi"; } else { echo "" . $this->Ini->Nm_lang['lang_othr_frmu_titl'] . " - detailopname_gizi"; } ?></div>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_detailopname_gizi']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detailopname_gizi']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detailopname_gizi']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_detailopname_gizi']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detailopname_gizi']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detailopname_gizi']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detailopname_gizi']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_detailopname_gizi']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detailopname_gizi']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_detailopname_gizi']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detailopname_gizi']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_detailopname_gizi']['fast_search'][2] : "";
?> 
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detailopname_gizi']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detailopname_gizi']['run_iframe'] != "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detailopname_gizi']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_detailopname_gizi']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_detailopname_gizi']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_detailopname_gizi']['run_iframe'] == "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detailopname_gizi']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_detailopname_gizi']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detailopname_gizi']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_detailopname_gizi']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detailopname_gizi']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detailopname_gizi']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detailopname_gizi']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_detailopname_gizi']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_detailopname_gizi']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_detailopname_gizi']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_detailopname_gizi']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detailopname_gizi']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
 ...
 ?>
   ...
   <?php if (isset($this->nmgp_cmp_hidden['stokawal_']) && $this->nmgp_cmp_hidden['stokawal_'] == 'off') { $sStyleHidden_stokawal_ = 'display: none'; }
      ...
      if (!isset($this->nm_new_label['stokawal_'])) {
          $this->nm_new_label['stokawal_'] = "Stokawal"; } ?>
   ...
   <?php if (isset($this->nmgp_cmp_hidden['koreksi_']) && $this->nmgp_cmp_hidden['koreksi_'] == 'off') { $sStyleHidden_koreksi_ = 'display: none'; }
      if (1 || !isset($this->nmgp_cmp_hidden['koreksi_']) || $this->nmgp_cmp_hidden['koreksi_'] == 'on') {
      if (!isset($this->nm_new_label['koreksi_'])) {
          $this->nm_new_label['koreksi_'] = "Koreksi"; } ?>

    <TD class="scFormLabelOddMult css_koreksi__label" id="hidden_field_label_koreksi_" style="<?php echo $sStyleHidden_koreksi_; ?>" > <?php echo $this->nm_new_label['koreksi_'] ?> </TD>
   <?php } ?>
   ...
   <?php if (isset($this->nmgp_cmp_hidden['stokakhir_']) && $this->nmgp_cmp_hidden['stokakhir_'] == 'off') { $sStyleHidden_stokakhir_ = 'display: none'; }
      ...
      if (!isset($this->nm_new_label['stokakhir_'])) {
          $this->nm_new_label['stokakhir_'] = "Stokakhir"; } ?>
...
{ 
   ...
   { 
       ob_start();
       $iStart = sizeof($this->form_vert_form_detailopname_gizi);
       $guarda_nmgp_opcao = $this->nmgp_opcao;
       $guarda_form_vert_form_detailopname_gizi = $this->form_vert_form_detailopname_gizi;
       $this->nmgp_opcao = 'novo';
   } 
   if ($this->Embutida_form && empty($this->form_vert_form_detailopname_gizi))
   {
       $sc_seq_vert = 0;
   }
   ...
   foreach ($this->form_vert_form_detailopname_gizi as $sc_seq_vert => $sc_lixo)
   {
       $this->loadRecordState($sc_seq_vert);
       $this->opnamecode_ = $this->form_vert_form_detailopname_gizi[$sc_seq_vert]['opnamecode_'];
       if (isset($this->Embutida_ronly) && $this->Embutida_ronly && !$Line_Add)
       {
           $this->nmgp_cmp_readonly['bahan_'] = true;
           $this->nmgp_cmp_readonly['satuan_'] = true;
           $this->nmgp_cmp_readonly['stokawal_'] = true;
           $this->nmgp_cmp_readonly['koreksi_'] = true;
       ...
       elseif ($Line_Add)
       {
           ...
           if (!isset($this->nmgp_cmp_readonly['koreksi_']) || $this->nmgp_cmp_readonly['koreksi_'] != "on") {$this->nmgp_cmp_readonly['koreksi_'] = false;}
        ...
        $this->bahan_ = $this->form_vert_form_detailopname_gizi[$sc_seq_vert]['bahan_']; 
       $bahan_ = $this->bahan_; 
       $sStyleHidden_bahan_ = '';
       ...
       $this->satuan_ = $this->form_vert_form_detailopname_gizi[$sc_seq_vert]['satuan_']; 
       ...
       $this->stokawal_ = $this->form_vert_form_detailopname_gizi[$sc_seq_vert]['stokawal_']; 
       ...
       $this->koreksi_ = $this->form_vert_form_detailopname_gizi[$sc_seq_vert]['koreksi_']; 
       $koreksi_ = $this->koreksi_; 
       $sStyleHidden_koreksi_ = '';
       if (isset($sCheckRead_koreksi_))
       {
           unset($sCheckRead_koreksi_);
       }
       if (isset($this->nmgp_cmp_readonly['koreksi_']))
       {
           $sCheckRead_koreksi_ = $this->nmgp_cmp_readonly['koreksi_'];
       }
       if (isset($this->nmgp_cmp_hidden['koreksi_']) && $this->nmgp_cmp_hidden['koreksi_'] == 'off')
       {
           unset($this->nmgp_cmp_hidden['koreksi_']);
           $sStyleHidden_koreksi_ = 'display: none;';
       }
       $bTestReadOnly_koreksi_ = true;
       $sStyleReadLab_koreksi_ = 'display: none;';
       $sStyleReadInp_koreksi_ = '';
       if (isset($this->nmgp_cmp_readonly['koreksi_']) && $this->nmgp_cmp_readonly['koreksi_'] == 'on')
       {
           $bTestReadOnly_koreksi_ = false;
           unset($this->nmgp_cmp_readonly['koreksi_']);
           $sStyleReadLab_koreksi_ = '';
           $sStyleReadInp_koreksi_ = 'display: none;';
       }
       $this->stokakhir_ = $this->form_vert_form_detailopname_gizi[$sc_seq_vert]['stokakhir_']; 
       ...
       $this->keterangan_ = $this->form_vert_form_detailopname_gizi[$sc_seq_vert]['keterangan_']; 
       ...
       $this->id_ = $this->form_vert_form_detailopname_gizi[$sc_seq_vert]['id_']; 
       $id_ = $this->id_; 
       if (!isset($this->nmgp_cmp_hidden['id_']))
       {
           $this->nmgp_cmp_hidden['id_'] = 'off';
...
<?php echo nmButtonOutput($this->arr_buttons, "bmd_novo", "do_ajax_form_detailopname_gizi_add_new_line(" . $sc_seq_vert . ")", "do_ajax_form_detailopname_gizi_add_new_line(" . $sc_seq_vert . ")", "sc_new_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
<?php }?>
<?php
  $Style_add_line = (!$Line_Add) ? "display: none" : "";
?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_form_detailopname_gizi_cancel_insert(" . $sc_seq_vert . ")", "do_ajax_form_detailopname_gizi_cancel_insert(" . $sc_seq_vert . ")", "sc_canceli_line_" . $sc_seq_vert . "", "", "", "" . $Style_add_line . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_form_detailopname_gizi_cancel_update(" . $sc_seq_vert . ")", "do_ajax_form_detailopname_gizi_cancel_update(" . $sc_seq_vert . ")", "sc_cancelu_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
 </TD>
   <?php }?>
...
<?php } else { ?>
<span id="id_read_on_bahan_<?php echo $sc_seq_vert ?>" class="sc-ui-readonly-bahan_<?php echo $sc_seq_vert ?> css_bahan__line" style="<?php echo $sStyleReadLab_bahan_; ?>"><?php echo $this->bahan_; ?></span><span id="id_read_off_bahan_<?php echo $sc_seq_vert ?>" class="css_read_off_bahan_" style="white-space: nowrap;<?php echo $sStyleReadInp_bahan_; ?>">
 <input class="sc-js-input scFormObjectOddMult css_bahan__obj" style="" id="id_sc_field_bahan_<?php echo $sc_seq_vert ?>" type=text name="bahan_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($bahan_) ?>"
...
<?php if ($bTestReadOnly_satuan_ && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["satuan_"]) &&  $this->nmgp_cmp_readonly["satuan_"] == "on") { 
 ...
 ?>
<input type="hidden" name="satuan_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($satuan_) . "\">" . $satuan_ . ""; ?>
<?php } else { ?>
...
<input type="hidden" name="stokawal_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($stokawal_) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>
...
<?php if ($bTestReadOnly_stokawal_ && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["stokawal_"]) &&  $this->nmgp_cmp_readonly["stokawal_"] == "on") { 
 ...
 ?>
<input type="hidden" name="stokawal_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($stokawal_) . "\">" . $stokawal_ . ""; ?>
<?php } else { ?>
<span id="id_read_on_stokawal_<?php echo $sc_seq_vert ?>" class="sc-ui-readonly-stokawal_<?php echo $sc_seq_vert ?> css_stokawal__line" style="<?php echo $sStyleReadLab_stokawal_; ?>"><?php echo $this->stokawal_; ?></span><span id="id_read_off_stokawal_<?php echo $sc_seq_vert ?>" class="css_read_off_stokawal_" style="white-space: nowrap;<?php echo $sStyleReadInp_stokawal_; ?>">
 <input class="sc-js-input scFormObjectOddMult css_stokawal__obj" style="" id="id_sc_field_stokawal_<?php echo $sc_seq_vert ?>" type=text name="stokawal_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($stokawal_) ?>"
 size=5 alt="{datatype: 'integer', maxLength: 5, thousandsSep: '<?php echo str_replace("'", "\'", $this->field_config['stokawal_']['symbol_grp']); ?>', thousandsFormat: <?php echo $this->field_config['stokawal_']['symbol_fmt']; ?>, allowNegative: false, onlyNegative: false, negativePos: <?php echo (4 == $this->field_config['stokawal_']['format_neg'] ? "'suffix'" : "'prefix'") ?>, alignment: 'left', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddMultWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
   ...
   <?php if (isset($this->nmgp_cmp_hidden['koreksi_']) && $this->nmgp_cmp_hidden['koreksi_'] == 'off') { $sc_hidden_yes++;  ?>
<input type="hidden" name="koreksi_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($koreksi_) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormDataOddMult css_koreksi__line" id="hidden_field_data_koreksi_<?php echo $sc_seq_vert; ?>" style="<?php echo $sStyleHidden_koreksi_; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOddMult css_koreksi__line" style="vertical-align: top;padding: 0px">
<?php if ($bTestReadOnly_koreksi_ && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["koreksi_"]) &&  $this->nmgp_cmp_readonly["koreksi_"] == "on") { 

 ?>
<input type="hidden" name="koreksi_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($koreksi_) . "\">" . $koreksi_ . ""; ?>
<?php } else { ?>
<span id="id_read_on_koreksi_<?php echo $sc_seq_vert ?>" class="sc-ui-readonly-koreksi_<?php echo $sc_seq_vert ?> css_koreksi__line" style="<?php echo $sStyleReadLab_koreksi_; ?>"><?php echo $this->koreksi_; ?></span><span id="id_read_off_koreksi_<?php echo $sc_seq_vert ?>" class="css_read_off_koreksi_" style="white-space: nowrap;<?php echo $sStyleReadInp_koreksi_; ?>">
 <input class="sc-js-input scFormObjectOddMult css_koreksi__obj" style="" id="id_sc_field_koreksi_<?php echo $sc_seq_vert ?>" type=text name="koreksi_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($koreksi_) ?>"
 size=5 alt="{datatype: 'integer', maxLength: 5, thousandsSep: '<?php echo str_replace("'", "\'", $this->field_config['koreksi_']['symbol_grp']); ?>', thousandsFormat: <?php echo $this->field_config['koreksi_']['symbol_fmt']; ?>, allowNegative: false, onlyNegative: false, negativePos: <?php echo (4 == $this->field_config['koreksi_']['format_neg'] ? "'suffix'" : "'prefix'") ?>, alignment: 'left', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddMultWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
</td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_koreksi_<?php echo $sc_seq_vert; ?>_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_koreksi_<?php echo $sc_seq_vert; ?>_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
<span id="id_read_on_stokakhir_<?php echo $sc_seq_vert ?>" class="sc-ui-readonly-stokakhir_<?php echo $sc_seq_vert ?> css_stokakhir__line" style="<?php echo $sStyleReadLab_stokakhir_; ?>"><?php echo $this->stokakhir_; ?></span><span id="id_read_off_stokakhir_<?php echo $sc_seq_vert ?>" class="css_read_off_stokakhir_" style="white-space: nowrap;<?php echo $sStyleReadInp_stokakhir_; ?>">
 ...
 size=5 alt="{datatype: 'integer', maxLength: 5, thousandsSep: '<?php echo str_replace("'", "\'", $this->field_config['stokakhir_']['symbol_grp']); ?>', thousandsFormat: <?php echo $this->field_config['stokakhir_']['symbol_fmt']; ?>, allowNegative: false, onlyNegative: false, negativePos: <?php echo (4 == $this->field_config['stokakhir_']['format_neg'] ? "'suffix'" : "'prefix'") ?>, alignment: 'left', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddMultWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
...
<?php   
       ...
       if (isset($sCheckRead_koreksi_))
       {
           $this->nmgp_cmp_readonly['koreksi_'] = $sCheckRead_koreksi_;
       }
       if ('display: none;' == $sStyleHidden_koreksi_)
       {
           $this->nmgp_cmp_hidden['koreksi_'] = 'off';
       }
       if (isset($sCheckRead_stokakhir_))
       {
   ...
   { 
       ...
       $this->form_vert_form_detailopname_gizi = $guarda_form_vert_form_detailopname_gizi;
   } 
   if ($Table_refresh) 
   { 
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detailopname_gizi']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detailopname_gizi']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_detailopname_gizi']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_detailopname_gizi']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_detailopname_gizi']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detailopname_gizi']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detailopname_gizi']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detailopname_gizi']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detailopname_gizi']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<?php
if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detailopname_gizi']['run_modal']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_detailopname_gizi']['run_modal'])
{
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detailopname_gizi']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_detailopname_gizi']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_detailopname_gizi");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_detailopname_gizi");
 parent.scAjaxDetailHeight("form_detailopname_gizi", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
<script type="text/javascript">
	function scBtnFn_sys_format_inc() {
		if ($("#sc_b_new_t.sc-unique-btn-1").length && $("#sc_b_new_t.sc-unique-btn-1").is(":visible")) {
			do_ajax_form_detailopname_gizi_add_new_line(); return false;
			 return;
		}
...
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_detailopname_gizi']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
