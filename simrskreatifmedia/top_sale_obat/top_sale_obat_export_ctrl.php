<?php
@session_start() ;
$_SESSION['scriptcase']['top_sale_obat']['sc_process_barr'] = true;
require_once('../top_sale_obat/index.php');
unset($_SESSION['scriptcase']['top_sale_obat']['sc_process_barr']);
$ExportCtrl = new top_sale_obat_export_control;
$ExportCtrl->Export_barr();

class top_sale_obat_export_control
{
