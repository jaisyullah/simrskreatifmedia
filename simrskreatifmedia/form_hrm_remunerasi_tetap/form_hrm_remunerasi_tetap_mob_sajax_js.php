  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_hrm_remunerasi_tetap_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_hrm_remunerasi_tetap_mob_form();
	}

  // ---------- Validate id
  function do_ajax_form_hrm_remunerasi_tetap_mob_validate_id()
  {
    var nomeCampo_id = "id";
    var var_id = scAjaxGetFieldHidden(nomeCampo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_remunerasi_tetap_mob_validate_id(var_id, var_script_case_init, do_ajax_form_hrm_remunerasi_tetap_mob_validate_id_cb);
  } // do_ajax_form_hrm_remunerasi_tetap_mob_validate_id

  function do_ajax_form_hrm_remunerasi_tetap_mob_validate_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_remunerasi_tetap_mob_validate_id_cb

  // ---------- Validate id_karyawan
  function do_ajax_form_hrm_remunerasi_tetap_mob_validate_id_karyawan()
  {
    var nomeCampo_id_karyawan = "id_karyawan";
    var var_id_karyawan = scAjaxGetFieldSelect(nomeCampo_id_karyawan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_remunerasi_tetap_mob_validate_id_karyawan(var_id_karyawan, var_script_case_init, do_ajax_form_hrm_remunerasi_tetap_mob_validate_id_karyawan_cb);
  } // do_ajax_form_hrm_remunerasi_tetap_mob_validate_id_karyawan

  function do_ajax_form_hrm_remunerasi_tetap_mob_validate_id_karyawan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_remunerasi_tetap_mob_validate_id_karyawan_cb

  // ---------- Validate gaji_pokok
  function do_ajax_form_hrm_remunerasi_tetap_mob_validate_gaji_pokok()
  {
    var nomeCampo_gaji_pokok = "gaji_pokok";
    var var_gaji_pokok = scAjaxGetFieldText(nomeCampo_gaji_pokok);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_remunerasi_tetap_mob_validate_gaji_pokok(var_gaji_pokok, var_script_case_init, do_ajax_form_hrm_remunerasi_tetap_mob_validate_gaji_pokok_cb);
  } // do_ajax_form_hrm_remunerasi_tetap_mob_validate_gaji_pokok

  function do_ajax_form_hrm_remunerasi_tetap_mob_validate_gaji_pokok_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_remunerasi_tetap_mob_validate_gaji_pokok_cb

  // ---------- Validate tunj_struktural
  function do_ajax_form_hrm_remunerasi_tetap_mob_validate_tunj_struktural()
  {
    var nomeCampo_tunj_struktural = "tunj_struktural";
    var var_tunj_struktural = scAjaxGetFieldText(nomeCampo_tunj_struktural);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_remunerasi_tetap_mob_validate_tunj_struktural(var_tunj_struktural, var_script_case_init, do_ajax_form_hrm_remunerasi_tetap_mob_validate_tunj_struktural_cb);
  } // do_ajax_form_hrm_remunerasi_tetap_mob_validate_tunj_struktural

  function do_ajax_form_hrm_remunerasi_tetap_mob_validate_tunj_struktural_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_remunerasi_tetap_mob_validate_tunj_struktural_cb

  // ---------- Validate tunj_fungsional
  function do_ajax_form_hrm_remunerasi_tetap_mob_validate_tunj_fungsional()
  {
    var nomeCampo_tunj_fungsional = "tunj_fungsional";
    var var_tunj_fungsional = scAjaxGetFieldText(nomeCampo_tunj_fungsional);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_remunerasi_tetap_mob_validate_tunj_fungsional(var_tunj_fungsional, var_script_case_init, do_ajax_form_hrm_remunerasi_tetap_mob_validate_tunj_fungsional_cb);
  } // do_ajax_form_hrm_remunerasi_tetap_mob_validate_tunj_fungsional

  function do_ajax_form_hrm_remunerasi_tetap_mob_validate_tunj_fungsional_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_remunerasi_tetap_mob_validate_tunj_fungsional_cb

  // ---------- Validate tunj_keluarga
  function do_ajax_form_hrm_remunerasi_tetap_mob_validate_tunj_keluarga()
  {
    var nomeCampo_tunj_keluarga = "tunj_keluarga";
    var var_tunj_keluarga = scAjaxGetFieldText(nomeCampo_tunj_keluarga);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_remunerasi_tetap_mob_validate_tunj_keluarga(var_tunj_keluarga, var_script_case_init, do_ajax_form_hrm_remunerasi_tetap_mob_validate_tunj_keluarga_cb);
  } // do_ajax_form_hrm_remunerasi_tetap_mob_validate_tunj_keluarga

  function do_ajax_form_hrm_remunerasi_tetap_mob_validate_tunj_keluarga_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_remunerasi_tetap_mob_validate_tunj_keluarga_cb

  // ---------- Validate tunj_transport_makan
  function do_ajax_form_hrm_remunerasi_tetap_mob_validate_tunj_transport_makan()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_remunerasi_tetap_mob_validate_tunj_transport_makan(var_tunj_transport_makan, var_script_case_init, do_ajax_form_hrm_remunerasi_tetap_mob_validate_tunj_transport_makan_cb);
  } // do_ajax_form_hrm_remunerasi_tetap_mob_validate_tunj_transport_makan

  function do_ajax_form_hrm_remunerasi_tetap_mob_validate_tunj_transport_makan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_remunerasi_tetap_mob_validate_tunj_transport_makan_cb

  // ---------- Validate tunj_bpjs_kesehatan
  function do_ajax_form_hrm_remunerasi_tetap_mob_validate_tunj_bpjs_kesehatan()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_remunerasi_tetap_mob_validate_tunj_bpjs_kesehatan(var_tunj_bpjs_kesehatan, var_script_case_init, do_ajax_form_hrm_remunerasi_tetap_mob_validate_tunj_bpjs_kesehatan_cb);
  } // do_ajax_form_hrm_remunerasi_tetap_mob_validate_tunj_bpjs_kesehatan

  function do_ajax_form_hrm_remunerasi_tetap_mob_validate_tunj_bpjs_kesehatan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_remunerasi_tetap_mob_validate_tunj_bpjs_kesehatan_cb

  // ---------- Validate no_dok_penetapan
  function do_ajax_form_hrm_remunerasi_tetap_mob_validate_no_dok_penetapan()
  {
    var nomeCampo_no_dok_penetapan = "no_dok_penetapan";
    var var_no_dok_penetapan = scAjaxGetFieldText(nomeCampo_no_dok_penetapan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_remunerasi_tetap_mob_validate_no_dok_penetapan(var_no_dok_penetapan, var_script_case_init, do_ajax_form_hrm_remunerasi_tetap_mob_validate_no_dok_penetapan_cb);
  } // do_ajax_form_hrm_remunerasi_tetap_mob_validate_no_dok_penetapan

  function do_ajax_form_hrm_remunerasi_tetap_mob_validate_no_dok_penetapan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_remunerasi_tetap_mob_validate_no_dok_penetapan_cb

  // ---------- Validate tanggal_penetapan
  function do_ajax_form_hrm_remunerasi_tetap_mob_validate_tanggal_penetapan()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_remunerasi_tetap_mob_validate_tanggal_penetapan(var_tanggal_penetapan, var_script_case_init, do_ajax_form_hrm_remunerasi_tetap_mob_validate_tanggal_penetapan_cb);
  } // do_ajax_form_hrm_remunerasi_tetap_mob_validate_tanggal_penetapan

  function do_ajax_form_hrm_remunerasi_tetap_mob_validate_tanggal_penetapan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_remunerasi_tetap_mob_validate_tanggal_penetapan_cb

  // ---------- Validate status
  function do_ajax_form_hrm_remunerasi_tetap_mob_validate_status()
  {
    var nomeCampo_status = "status";
    var var_status = scAjaxGetFieldSelect(nomeCampo_status);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_remunerasi_tetap_mob_validate_status(var_status, var_script_case_init, do_ajax_form_hrm_remunerasi_tetap_mob_validate_status_cb);
  } // do_ajax_form_hrm_remunerasi_tetap_mob_validate_status

  function do_ajax_form_hrm_remunerasi_tetap_mob_validate_status_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "status";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_remunerasi_tetap_mob_validate_status_cb

  // ---------- Validate keterangan
  function do_ajax_form_hrm_remunerasi_tetap_mob_validate_keterangan()
  {
    var nomeCampo_keterangan = "keterangan";
    var var_keterangan = scAjaxGetFieldText(nomeCampo_keterangan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_remunerasi_tetap_mob_validate_keterangan(var_keterangan, var_script_case_init, do_ajax_form_hrm_remunerasi_tetap_mob_validate_keterangan_cb);
  } // do_ajax_form_hrm_remunerasi_tetap_mob_validate_keterangan

  function do_ajax_form_hrm_remunerasi_tetap_mob_validate_keterangan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_remunerasi_tetap_mob_validate_keterangan_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_hrm_remunerasi_tetap_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_hrm_remunerasi_tetap_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_hrm_remunerasi_tetap_mob_submit_form(var_id, var_id_karyawan, var_gaji_pokok, var_tunj_struktural, var_tunj_fungsional, var_tunj_keluarga, var_tunj_transport_makan, var_tunj_bpjs_kesehatan, var_no_dok_penetapan, var_tanggal_penetapan, var_status, var_keterangan, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_hrm_remunerasi_tetap_mob_submit_form_cb);
  } // do_ajax_form_hrm_remunerasi_tetap_mob_submit_form

  function do_ajax_form_hrm_remunerasi_tetap_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_hrm_remunerasi_tetap_mob_submit_form_cb_after_alert);
  } // do_ajax_form_hrm_remunerasi_tetap_mob_submit_form_cb
  function do_ajax_form_hrm_remunerasi_tetap_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_hrm_remunerasi_tetap_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_hrm_remunerasi_tetap_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_hrm_remunerasi_tetap_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_hrm_remunerasi_tetap_mob_navigate_form_cb);
  } // do_ajax_form_hrm_remunerasi_tetap_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_hrm_remunerasi_tetap_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_hrm_remunerasi_tetap_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_hrm_remunerasi_tetap_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_hrm_remunerasi_tetap_mob_navigate_form_cb
  function do_ajax_form_hrm_remunerasi_tetap_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_hrm_remunerasi_tetap_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_hrm_remunerasi_tetap_mob_navigate_form_cb_after_alert
  function sc_hide_form_hrm_remunerasi_tetap_mob_form()
  {
