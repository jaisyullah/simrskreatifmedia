  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_hrm_remunerasi_tetap" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_hrm_remunerasi_tetap_form();
	}

  // ---------- Validate id
  function do_ajax_form_hrm_remunerasi_tetap_validate_id()
  {
    var nomeCampo_id = "id";
    var var_id = scAjaxGetFieldHidden(nomeCampo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_remunerasi_tetap_validate_id(var_id, var_script_case_init, do_ajax_form_hrm_remunerasi_tetap_validate_id_cb);
  } // do_ajax_form_hrm_remunerasi_tetap_validate_id

  function do_ajax_form_hrm_remunerasi_tetap_validate_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_remunerasi_tetap_validate_id_cb

  // ---------- Validate id_karyawan
  function do_ajax_form_hrm_remunerasi_tetap_validate_id_karyawan()
  {
    var nomeCampo_id_karyawan = "id_karyawan";
    var var_id_karyawan = scAjaxGetFieldSelect(nomeCampo_id_karyawan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_remunerasi_tetap_validate_id_karyawan(var_id_karyawan, var_script_case_init, do_ajax_form_hrm_remunerasi_tetap_validate_id_karyawan_cb);
  } // do_ajax_form_hrm_remunerasi_tetap_validate_id_karyawan

  function do_ajax_form_hrm_remunerasi_tetap_validate_id_karyawan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id_karyawan";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_remunerasi_tetap_validate_id_karyawan_cb

  // ---------- Validate gaji_pokok
  function do_ajax_form_hrm_remunerasi_tetap_validate_gaji_pokok()
  {
    var nomeCampo_gaji_pokok = "gaji_pokok";
    var var_gaji_pokok = scAjaxGetFieldText(nomeCampo_gaji_pokok);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_remunerasi_tetap_validate_gaji_pokok(var_gaji_pokok, var_script_case_init, do_ajax_form_hrm_remunerasi_tetap_validate_gaji_pokok_cb);
  } // do_ajax_form_hrm_remunerasi_tetap_validate_gaji_pokok

  function do_ajax_form_hrm_remunerasi_tetap_validate_gaji_pokok_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "gaji_pokok";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_remunerasi_tetap_validate_gaji_pokok_cb

  // ---------- Validate tunj_struktural
  function do_ajax_form_hrm_remunerasi_tetap_validate_tunj_struktural()
  {
    var nomeCampo_tunj_struktural = "tunj_struktural";
    var var_tunj_struktural = scAjaxGetFieldText(nomeCampo_tunj_struktural);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_remunerasi_tetap_validate_tunj_struktural(var_tunj_struktural, var_script_case_init, do_ajax_form_hrm_remunerasi_tetap_validate_tunj_struktural_cb);
  } // do_ajax_form_hrm_remunerasi_tetap_validate_tunj_struktural

  function do_ajax_form_hrm_remunerasi_tetap_validate_tunj_struktural_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tunj_struktural";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_remunerasi_tetap_validate_tunj_struktural_cb

  // ---------- Validate tunj_fungsional
  function do_ajax_form_hrm_remunerasi_tetap_validate_tunj_fungsional()
  {
    var nomeCampo_tunj_fungsional = "tunj_fungsional";
    var var_tunj_fungsional = scAjaxGetFieldText(nomeCampo_tunj_fungsional);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_remunerasi_tetap_validate_tunj_fungsional(var_tunj_fungsional, var_script_case_init, do_ajax_form_hrm_remunerasi_tetap_validate_tunj_fungsional_cb);
  } // do_ajax_form_hrm_remunerasi_tetap_validate_tunj_fungsional

  function do_ajax_form_hrm_remunerasi_tetap_validate_tunj_fungsional_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tunj_fungsional";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_remunerasi_tetap_validate_tunj_fungsional_cb

  // ---------- Validate tunj_keluarga
  function do_ajax_form_hrm_remunerasi_tetap_validate_tunj_keluarga()
  {
    var nomeCampo_tunj_keluarga = "tunj_keluarga";
    var var_tunj_keluarga = scAjaxGetFieldText(nomeCampo_tunj_keluarga);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_remunerasi_tetap_validate_tunj_keluarga(var_tunj_keluarga, var_script_case_init, do_ajax_form_hrm_remunerasi_tetap_validate_tunj_keluarga_cb);
  } // do_ajax_form_hrm_remunerasi_tetap_validate_tunj_keluarga

  function do_ajax_form_hrm_remunerasi_tetap_validate_tunj_keluarga_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tunj_keluarga";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_remunerasi_tetap_validate_tunj_keluarga_cb

  // ---------- Validate tunj_transport_makan
  function do_ajax_form_hrm_remunerasi_tetap_validate_tunj_transport_makan()
  {
    var nomeCampo_tunj_transport_makan = "tunj_transport_makan";
    var var_tunj_transport_makan = scAjaxGetFieldText(nomeCampo_tunj_transport_makan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_remunerasi_tetap_validate_tunj_transport_makan(var_tunj_transport_makan, var_script_case_init, do_ajax_form_hrm_remunerasi_tetap_validate_tunj_transport_makan_cb);
  } // do_ajax_form_hrm_remunerasi_tetap_validate_tunj_transport_makan

  function do_ajax_form_hrm_remunerasi_tetap_validate_tunj_transport_makan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tunj_transport_makan";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_remunerasi_tetap_validate_tunj_transport_makan_cb

  // ---------- Validate tunj_bpjs_kesehatan
  function do_ajax_form_hrm_remunerasi_tetap_validate_tunj_bpjs_kesehatan()
  {
    var nomeCampo_tunj_bpjs_kesehatan = "tunj_bpjs_kesehatan";
    var var_tunj_bpjs_kesehatan = scAjaxGetFieldText(nomeCampo_tunj_bpjs_kesehatan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_remunerasi_tetap_validate_tunj_bpjs_kesehatan(var_tunj_bpjs_kesehatan, var_script_case_init, do_ajax_form_hrm_remunerasi_tetap_validate_tunj_bpjs_kesehatan_cb);
  } // do_ajax_form_hrm_remunerasi_tetap_validate_tunj_bpjs_kesehatan

  function do_ajax_form_hrm_remunerasi_tetap_validate_tunj_bpjs_kesehatan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tunj_bpjs_kesehatan";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_remunerasi_tetap_validate_tunj_bpjs_kesehatan_cb

  // ---------- Validate no_dok_penetapan
  function do_ajax_form_hrm_remunerasi_tetap_validate_no_dok_penetapan()
  {
    var nomeCampo_no_dok_penetapan = "no_dok_penetapan";
    var var_no_dok_penetapan = scAjaxGetFieldText(nomeCampo_no_dok_penetapan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_remunerasi_tetap_validate_no_dok_penetapan(var_no_dok_penetapan, var_script_case_init, do_ajax_form_hrm_remunerasi_tetap_validate_no_dok_penetapan_cb);
  } // do_ajax_form_hrm_remunerasi_tetap_validate_no_dok_penetapan

  function do_ajax_form_hrm_remunerasi_tetap_validate_no_dok_penetapan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "no_dok_penetapan";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_remunerasi_tetap_validate_no_dok_penetapan_cb

  // ---------- Validate tanggal_penetapan
  function do_ajax_form_hrm_remunerasi_tetap_validate_tanggal_penetapan()
  {
    var nomeCampo_tanggal_penetapan = "tanggal_penetapan";
    var var_tanggal_penetapan = scAjaxGetFieldText(nomeCampo_tanggal_penetapan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_remunerasi_tetap_validate_tanggal_penetapan(var_tanggal_penetapan, var_script_case_init, do_ajax_form_hrm_remunerasi_tetap_validate_tanggal_penetapan_cb);
  } // do_ajax_form_hrm_remunerasi_tetap_validate_tanggal_penetapan

  function do_ajax_form_hrm_remunerasi_tetap_validate_tanggal_penetapan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tanggal_penetapan";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_remunerasi_tetap_validate_tanggal_penetapan_cb

  // ---------- Validate status
  function do_ajax_form_hrm_remunerasi_tetap_validate_status()
  {
    var nomeCampo_status = "status";
    var var_status = scAjaxGetFieldSelect(nomeCampo_status);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_remunerasi_tetap_validate_status(var_status, var_script_case_init, do_ajax_form_hrm_remunerasi_tetap_validate_status_cb);
  } // do_ajax_form_hrm_remunerasi_tetap_validate_status

  function do_ajax_form_hrm_remunerasi_tetap_validate_status_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "status";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_remunerasi_tetap_validate_status_cb

  // ---------- Validate keterangan
  function do_ajax_form_hrm_remunerasi_tetap_validate_keterangan()
  {
    var nomeCampo_keterangan = "keterangan";
    var var_keterangan = scAjaxGetFieldText(nomeCampo_keterangan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_remunerasi_tetap_validate_keterangan(var_keterangan, var_script_case_init, do_ajax_form_hrm_remunerasi_tetap_validate_keterangan_cb);
  } // do_ajax_form_hrm_remunerasi_tetap_validate_keterangan

  function do_ajax_form_hrm_remunerasi_tetap_validate_keterangan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_remunerasi_tetap_validate_keterangan_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_hrm_remunerasi_tetap_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_hrm_remunerasi_tetap_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id = scAjaxGetFieldHidden("id");
    var var_id_karyawan = scAjaxGetFieldSelect("id_karyawan");
    var var_gaji_pokok = scAjaxGetFieldText("gaji_pokok");
    var var_tunj_struktural = scAjaxGetFieldText("tunj_struktural");
    var var_tunj_fungsional = scAjaxGetFieldText("tunj_fungsional");
    var var_tunj_keluarga = scAjaxGetFieldText("tunj_keluarga");
    var var_tunj_transport_makan = scAjaxGetFieldText("tunj_transport_makan");
    var var_tunj_bpjs_kesehatan = scAjaxGetFieldText("tunj_bpjs_kesehatan");
    var var_no_dok_penetapan = scAjaxGetFieldText("no_dok_penetapan");
    var var_tanggal_penetapan = scAjaxGetFieldText("tanggal_penetapan");
    ...
    scAjaxProcOn();
    x_ajax_form_hrm_remunerasi_tetap_submit_form(var_id, var_id_karyawan, var_gaji_pokok, var_tunj_struktural, var_tunj_fungsional, var_tunj_keluarga, var_tunj_transport_makan, var_tunj_bpjs_kesehatan, var_no_dok_penetapan, var_tanggal_penetapan, var_status, var_keterangan, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_hrm_remunerasi_tetap_submit_form_cb);
  } // do_ajax_form_hrm_remunerasi_tetap_submit_form

  function do_ajax_form_hrm_remunerasi_tetap_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("id_karyawan");
      scAjaxHideErrorDisplay("gaji_pokok");
      scAjaxHideErrorDisplay("tunj_struktural");
      scAjaxHideErrorDisplay("tunj_fungsional");
      scAjaxHideErrorDisplay("tunj_keluarga");
      scAjaxHideErrorDisplay("tunj_transport_makan");
      scAjaxHideErrorDisplay("tunj_bpjs_kesehatan");
      scAjaxHideErrorDisplay("no_dok_penetapan");
      scAjaxHideErrorDisplay("tanggal_penetapan");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_hrm_remunerasi_tetap_submit_form_cb_after_alert);
  } // do_ajax_form_hrm_remunerasi_tetap_submit_form_cb
  function do_ajax_form_hrm_remunerasi_tetap_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_hrm_remunerasi_tetap_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_hrm_remunerasi_tetap_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_hrm_remunerasi_tetap_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_hrm_remunerasi_tetap_navigate_form_cb);
  } // do_ajax_form_hrm_remunerasi_tetap_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_hrm_remunerasi_tetap']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_hrm_remunerasi_tetap_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_hrm_remunerasi_tetap_navigate_form_cb_after_alert);
  } // do_ajax_form_hrm_remunerasi_tetap_navigate_form_cb
  function do_ajax_form_hrm_remunerasi_tetap_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_hrm_remunerasi_tetap_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_hrm_remunerasi_tetap_navigate_form_cb_after_alert
  function sc_hide_form_hrm_remunerasi_tetap_form()
  {
  ...
  ajax_field_list[1] = "id_karyawan";
  ajax_field_list[2] = "gaji_pokok";
  ajax_field_list[3] = "tunj_struktural";
  ajax_field_list[4] = "tunj_fungsional";
  ajax_field_list[5] = "tunj_keluarga";
  ajax_field_list[6] = "tunj_transport_makan";
  ajax_field_list[7] = "tunj_bpjs_kesehatan";
  ajax_field_list[8] = "no_dok_penetapan";
  ajax_field_list[9] = "tanggal_penetapan";
  ajax_field_list[10] = "status";
  ajax_field_list[11] = "keterangan";
  ...
  var ajax_error_list = {
    ...
    "id_karyawan": {"label": "Karyawan", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "gaji_pokok": {"label": "Gaji Pokok", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "tunj_struktural": {"label": "Tunj Struktural", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "tunj_fungsional": {"label": "Tunj Fungsional", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "tunj_keluarga": {"label": "Tunj Keluarga", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "tunj_transport_makan": {"label": "Tunj Transport Makan", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "tunj_bpjs_kesehatan": {"label": "Tunj Bpjs Kesehatan", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "no_dok_penetapan": {"label": "No Dok Penetapan", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "tanggal_penetapan": {"label": "Tanggal Penetapan", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  var ajax_field_mult = {
    "id": new Array(),
    "id_karyawan": new Array(),
    "gaji_pokok": new Array(),
    "tunj_struktural": new Array(),
    "tunj_fungsional": new Array(),
    "tunj_keluarga": new Array(),
    "tunj_transport_makan": new Array(),
    "tunj_bpjs_kesehatan": new Array(),
    "no_dok_penetapan": new Array(),
    "tanggal_penetapan": new Array(),
    "status": new Array(),
    "keterangan": new Array()
  };
  ajax_field_mult["id"][1] = "id";
  ajax_field_mult["id_karyawan"][1] = "id_karyawan";
  ajax_field_mult["gaji_pokok"][1] = "gaji_pokok";
  ajax_field_mult["tunj_struktural"][1] = "tunj_struktural";
  ajax_field_mult["tunj_fungsional"][1] = "tunj_fungsional";
  ajax_field_mult["tunj_keluarga"][1] = "tunj_keluarga";
  ajax_field_mult["tunj_transport_makan"][1] = "tunj_transport_makan";
  ajax_field_mult["tunj_bpjs_kesehatan"][1] = "tunj_bpjs_kesehatan";
  ajax_field_mult["no_dok_penetapan"][1] = "no_dok_penetapan";
  ajax_field_mult["tanggal_penetapan"][1] = "tanggal_penetapan";
  ...
  var ajax_field_id = {
    ...
    "id_karyawan": new Array("hidden_field_label_id_karyawan", "hidden_field_data_id_karyawan"),
    "gaji_pokok": new Array("hidden_field_label_gaji_pokok", "hidden_field_data_gaji_pokok"),
    "tunj_struktural": new Array("hidden_field_label_tunj_struktural", "hidden_field_data_tunj_struktural"),
    "tunj_fungsional": new Array("hidden_field_label_tunj_fungsional", "hidden_field_data_tunj_fungsional"),
    "tunj_keluarga": new Array("hidden_field_label_tunj_keluarga", "hidden_field_data_tunj_keluarga"),
    "tunj_transport_makan": new Array("hidden_field_label_tunj_transport_makan", "hidden_field_data_tunj_transport_makan"),
    "tunj_bpjs_kesehatan": new Array("hidden_field_label_tunj_bpjs_kesehatan", "hidden_field_data_tunj_bpjs_kesehatan"),
    "no_dok_penetapan": new Array("hidden_field_label_no_dok_penetapan", "hidden_field_data_no_dok_penetapan"),
    "tanggal_penetapan": new Array("hidden_field_label_tanggal_penetapan", "hidden_field_data_tanggal_penetapan"),
  ...
  var ajax_read_only = {
    ...
    "tunj_fungsional": "off",
    "tunj_keluarga": "off",
    "tunj_transport_makan": "off",
    "tunj_bpjs_kesehatan": "off",
    "no_dok_penetapan": "off",
    "tanggal_penetapan": "off",
    "status": "off",
    "keterangan": "off"
  };
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("tunj_transport_makan" == sIndex)
    {
      scAjaxSetFieldText(sIndex, aValue, "", "", true);
      updateHeaderFooter(sIndex, aValue);
