...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_trandate_hora' + iSeqRow).bind('blur', function() { sc_form_tbtranlab_trandate_hora_onblur(this, iSeqRow) })
                                           .bind('focus', function() { sc_form_tbtranlab_trandate_hora_onfocus(this, iSeqRow) });
  ...
  $('#id_sc_field_finishdate_hora' + iSeqRow).bind('blur', function() { sc_form_tbtranlab_finishdate_hora_onblur(this, iSeqRow) })
                                             .bind('focus', function() { sc_form_tbtranlab_finishdate_hora_onfocus(this, iSeqRow) });
  ...
  $('#id_sc_field_proyeksidate_hora' + iSeqRow).bind('blur', function() { sc_form_tbtranlab_proyeksidate_hora_onblur(this, iSeqRow) })
                                               .bind('focus', function() { sc_form_tbtranlab_proyeksidate_hora_onfocus(this, iSeqRow) });
...
function sc_form_tbtranlab_trandate_hora_onblur(oThis, iSeqRow) {
  do_ajax_form_tbtranlab_validate_trandate();
  scCssBlur(oThis);
}
...
function sc_form_tbtranlab_trandate_hora_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function sc_form_tbtranlab_finishdate_hora_onblur(oThis, iSeqRow) {
  do_ajax_form_tbtranlab_validate_finishdate();
  scCssBlur(oThis);
}
...
function sc_form_tbtranlab_finishdate_hora_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function sc_form_tbtranlab_proyeksidate_hora_onblur(oThis, iSeqRow) {
  do_ajax_form_tbtranlab_validate_proyeksidate();
  scCssBlur(oThis);
}
...
function sc_form_tbtranlab_proyeksidate_hora_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function scHidePage(pageNo) {
	$("#id_form_tbtranlab_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_trandate" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_tbtranlab_validate_trandate(iSeqRow);
    },
    numberOfMonths: 1,
    changeMonth: true,
    changeYear: true,
...
?>
  ...
  $("#id_sc_field_proyeksidate" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_tbtranlab_validate_proyeksidate(iSeqRow);
    },
    numberOfMonths: 1,
    changeMonth: true,
    changeYear: true,
...
?>
  ...
  $("#id_sc_field_finishdate" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_tbtranlab_validate_finishdate(iSeqRow);
    },
    numberOfMonths: 1,
    dayNames: ["<?php        echo html_entity_decode($this->Ini->Nm_lang['lang_days_sund'], ENT_COMPAT, $_SESSION['scriptcase']['charset']);        ?>","<?php echo html_entity_decode($this->Ini->Nm_lang['lang_days_mond'], ENT_COMPAT, $_SESSION['scriptcase']['charset']);        ?>","<?php echo html_entity_decode($this->Ini->Nm_lang['lang_days_tued'], ENT_COMPAT, $_SESSION['scriptcase']['charset']);        ?>","<?php echo html_entity_decode($this->Ini->Nm_lang['lang_days_wend'], ENT_COMPAT, $_SESSION['scriptcase']['charset']);        ?>","<?php echo html_entity_decode($this->Ini->Nm_lang['lang_days_thud'], ENT_COMPAT, $_SESSION['scriptcase']['charset']);        ?>","<?php echo html_entity_decode($this->Ini->Nm_lang['lang_days_frid'], ENT_COMPAT, $_SESSION['scriptcase']['charset']);        ?>","<?php echo html_entity_decode($this->Ini->Nm_lang['lang_days_satd'], ENT_COMPAT, $_SESSION['scriptcase']['charset']);        ?>"],
    dayNamesMin: ["<?php     echo html_entity_decode($this->Ini->Nm_lang['lang_substr_days_sund'], ENT_COMPAT, $_SESSION['scriptcase']['charset']); ?>","<?php echo html_entity_decode($this->Ini->Nm_lang['lang_substr_days_mond'], ENT_COMPAT, $_SESSION['scriptcase']['charset']); ?>","<?php echo html_entity_decode($this->Ini->Nm_lang['lang_substr_days_tued'], ENT_COMPAT, $_SESSION['scriptcase']['charset']); ?>","<?php echo html_entity_decode($this->Ini->Nm_lang['lang_substr_days_wend'], ENT_COMPAT, $_SESSION['scriptcase']['charset']); ?>","<?php echo html_entity_decode($this->Ini->Nm_lang['lang_substr_days_thud'], ENT_COMPAT, $_SESSION['scriptcase']['charset']); ?>","<?php echo html_entity_decode($this->Ini->Nm_lang['lang_substr_days_frid'], ENT_COMPAT, $_SESSION['scriptcase']['charset']); ?>","<?php echo html_entity_decode($this->Ini->Nm_lang['lang_substr_days_satd'], ENT_COMPAT, $_SESSION['scriptcase']['charset']); ?>"],
...
?>
  ...
  $("#id_sc_field_enterdate" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_tbtranlab_validate_enterdate(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_takendate" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_tbtranlab_validate_takendate(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
