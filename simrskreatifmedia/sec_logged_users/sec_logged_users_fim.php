...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____sec_logged_users"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____sec_logged_users"]);
   }
