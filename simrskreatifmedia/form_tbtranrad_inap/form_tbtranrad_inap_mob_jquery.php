...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_id' + iSeqRow).bind('blur', function() { sc_form_tbtranrad_inap_id_onblur(this, iSeqRow) })
                                .bind('focus', function() { sc_form_tbtranrad_inap_id_onfocus(this, iSeqRow) });
  $('#id_sc_field_trancode' + iSeqRow).bind('blur', function() { sc_form_tbtranrad_inap_trancode_onblur(this, iSeqRow) })
                                      .bind('focus', function() { sc_form_tbtranrad_inap_trancode_onfocus(this, iSeqRow) });
  $('#id_sc_field_struk' + iSeqRow).bind('blur', function() { sc_form_tbtranrad_inap_struk_onblur(this, iSeqRow) })
                                   .bind('change', function() { sc_form_tbtranrad_inap_struk_onchange(this, iSeqRow) })
                                   .bind('focus', function() { sc_form_tbtranrad_inap_struk_onfocus(this, iSeqRow) });
  $('#id_sc_field_custcode' + iSeqRow).bind('blur', function() { sc_form_tbtranrad_inap_custcode_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_form_tbtranrad_inap_custcode_onchange(this, iSeqRow) })
                                      .bind('focus', function() { sc_form_tbtranrad_inap_custcode_onfocus(this, iSeqRow) });
  $('#id_sc_field_inapcode' + iSeqRow).bind('blur', function() { sc_form_tbtranrad_inap_inapcode_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_form_tbtranrad_inap_inapcode_onchange(this, iSeqRow) })
                                      .bind('focus', function() { sc_form_tbtranrad_inap_inapcode_onfocus(this, iSeqRow) });
  $('#id_sc_field_doccode' + iSeqRow).bind('blur', function() { sc_form_tbtranrad_inap_doccode_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_form_tbtranrad_inap_doccode_onchange(this, iSeqRow) })
                                     .bind('focus', function() { sc_form_tbtranrad_inap_doccode_onfocus(this, iSeqRow) });
  $('#id_sc_field_docname' + iSeqRow).bind('blur', function() { sc_form_tbtranrad_inap_docname_onblur(this, iSeqRow) })
                                     .bind('focus', function() { sc_form_tbtranrad_inap_docname_onfocus(this, iSeqRow) });
  $('#id_sc_field_note' + iSeqRow).bind('blur', function() { sc_form_tbtranrad_inap_note_onblur(this, iSeqRow) })
                                  .bind('focus', function() { sc_form_tbtranrad_inap_note_onfocus(this, iSeqRow) });
  $('#id_sc_field_trandate' + iSeqRow).bind('blur', function() { sc_form_tbtranrad_inap_trandate_onblur(this, iSeqRow) })
                                      .bind('focus', function() { sc_form_tbtranrad_inap_trandate_onfocus(this, iSeqRow) });
  $('#id_sc_field_trandate_hora' + iSeqRow).bind('blur', function() { sc_form_tbtranrad_inap_trandate_onblur(this, iSeqRow) })
                                           .bind('focus', function() { sc_form_tbtranrad_inap_trandate_onfocus(this, iSeqRow) });
  $('#id_sc_field_status' + iSeqRow).bind('blur', function() { sc_form_tbtranrad_inap_status_onblur(this, iSeqRow) })
                                    .bind('focus', function() { sc_form_tbtranrad_inap_status_onfocus(this, iSeqRow) });
  $('#id_sc_field_contrast' + iSeqRow).bind('blur', function() { sc_form_tbtranrad_inap_contrast_onblur(this, iSeqRow) })
                                      .bind('focus', function() { sc_form_tbtranrad_inap_contrast_onfocus(this, iSeqRow) });
  $('#id_sc_field_poli' + iSeqRow).bind('blur', function() { sc_form_tbtranrad_inap_poli_onblur(this, iSeqRow) })
                                  .bind('focus', function() { sc_form_tbtranrad_inap_poli_onfocus(this, iSeqRow) });
  $('#id_sc_field_diag' + iSeqRow).bind('blur', function() { sc_form_tbtranrad_inap_diag_onblur(this, iSeqRow) })
                                  .bind('focus', function() { sc_form_tbtranrad_inap_diag_onfocus(this, iSeqRow) });
  $('#id_sc_field_instcode' + iSeqRow).bind('blur', function() { sc_form_tbtranrad_inap_instcode_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_form_tbtranrad_inap_instcode_onchange(this, iSeqRow) })
                                      .bind('focus', function() { sc_form_tbtranrad_inap_instcode_onfocus(this, iSeqRow) });
  $('#id_sc_field_alamat' + iSeqRow).bind('blur', function() { sc_form_tbtranrad_inap_alamat_onblur(this, iSeqRow) })
                                    .bind('focus', function() { sc_form_tbtranrad_inap_alamat_onfocus(this, iSeqRow) });
  $('#id_sc_field_sc_field_0' + iSeqRow).bind('blur', function() { sc_form_tbtranrad_inap_sc_field_0_onblur(this, iSeqRow) })
                                        .bind('focus', function() { sc_form_tbtranrad_inap_sc_field_0_onfocus(this, iSeqRow) });
  $('#id_sc_field_usia' + iSeqRow).bind('blur', function() { sc_form_tbtranrad_inap_usia_onblur(this, iSeqRow) })
                                  .bind('focus', function() { sc_form_tbtranrad_inap_usia_onfocus(this, iSeqRow) });
  $('#id_sc_field_detailrad' + iSeqRow).bind('blur', function() { sc_form_tbtranrad_inap_detailrad_onblur(this, iSeqRow) })
                                       .bind('focus', function() { sc_form_tbtranrad_inap_detailrad_onfocus(this, iSeqRow) });
  $('#id_sc_field_provider' + iSeqRow).bind('blur', function() { sc_form_tbtranrad_inap_provider_onblur(this, iSeqRow) })
                                      .bind('focus', function() { sc_form_tbtranrad_inap_provider_onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_form_tbtranrad_inap_id_onblur(oThis, iSeqRow) {
  do_ajax_form_tbtranrad_inap_mob_validate_id();
  scCssBlur(oThis);
}

function sc_form_tbtranrad_inap_id_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_tbtranrad_inap_trancode_onblur(oThis, iSeqRow) {
  do_ajax_form_tbtranrad_inap_mob_validate_trancode();
  scCssBlur(oThis);
}

function sc_form_tbtranrad_inap_trancode_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_tbtranrad_inap_struk_onblur(oThis, iSeqRow) {
  do_ajax_form_tbtranrad_inap_mob_validate_struk();
  scCssBlur(oThis);
}

function sc_form_tbtranrad_inap_struk_onchange(oThis, iSeqRow) {
  do_ajax_form_tbtranrad_inap_mob_refresh_struk();
}

function sc_form_tbtranrad_inap_struk_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_tbtranrad_inap_custcode_onblur(oThis, iSeqRow) {
  do_ajax_form_tbtranrad_inap_mob_validate_custcode();
  scCssBlur(oThis);
}

function sc_form_tbtranrad_inap_custcode_onchange(oThis, iSeqRow) {
  do_ajax_form_tbtranrad_inap_mob_refresh_custcode();
}

function sc_form_tbtranrad_inap_custcode_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_tbtranrad_inap_inapcode_onblur(oThis, iSeqRow) {
  do_ajax_form_tbtranrad_inap_mob_validate_inapcode();
  scCssBlur(oThis);
}

function sc_form_tbtranrad_inap_inapcode_onchange(oThis, iSeqRow) {
  do_ajax_form_tbtranrad_inap_mob_event_inapcode_onchange();
}

function sc_form_tbtranrad_inap_inapcode_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_tbtranrad_inap_doccode_onblur(oThis, iSeqRow) {
  do_ajax_form_tbtranrad_inap_mob_validate_doccode();
  scCssBlur(oThis);
}

function sc_form_tbtranrad_inap_doccode_onchange(oThis, iSeqRow) {
  do_ajax_form_tbtranrad_inap_mob_refresh_doccode();
}

function sc_form_tbtranrad_inap_doccode_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_tbtranrad_inap_docname_onblur(oThis, iSeqRow) {
  do_ajax_form_tbtranrad_inap_mob_validate_docname();
  scCssBlur(oThis);
}

function sc_form_tbtranrad_inap_docname_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_tbtranrad_inap_note_onblur(oThis, iSeqRow) {
  do_ajax_form_tbtranrad_inap_mob_validate_note();
  scCssBlur(oThis);
}

function sc_form_tbtranrad_inap_note_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_tbtranrad_inap_trandate_onblur(oThis, iSeqRow) {
...
function sc_form_tbtranrad_inap_trandate_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function sc_form_tbtranrad_inap_status_onblur(oThis, iSeqRow) {
  do_ajax_form_tbtranrad_inap_mob_validate_status();
  scCssBlur(oThis);
}

function sc_form_tbtranrad_inap_status_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_tbtranrad_inap_contrast_onblur(oThis, iSeqRow) {
  do_ajax_form_tbtranrad_inap_mob_validate_contrast();
  scCssBlur(oThis);
}

function sc_form_tbtranrad_inap_contrast_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_tbtranrad_inap_poli_onblur(oThis, iSeqRow) {
  do_ajax_form_tbtranrad_inap_mob_validate_poli();
  scCssBlur(oThis);
}

function sc_form_tbtranrad_inap_poli_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_tbtranrad_inap_diag_onblur(oThis, iSeqRow) {
  do_ajax_form_tbtranrad_inap_mob_validate_diag();
  scCssBlur(oThis);
}

function sc_form_tbtranrad_inap_diag_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_tbtranrad_inap_instcode_onblur(oThis, iSeqRow) {
  do_ajax_form_tbtranrad_inap_mob_validate_instcode();
  scCssBlur(oThis);
}

function sc_form_tbtranrad_inap_instcode_onchange(oThis, iSeqRow) {
  do_ajax_form_tbtranrad_inap_mob_refresh_instcode();
}

function sc_form_tbtranrad_inap_instcode_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_tbtranrad_inap_alamat_onblur(oThis, iSeqRow) {
  do_ajax_form_tbtranrad_inap_mob_validate_alamat();
  scCssBlur(oThis);
}

function sc_form_tbtranrad_inap_alamat_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_tbtranrad_inap_sc_field_0_onblur(oThis, iSeqRow) {
  do_ajax_form_tbtranrad_inap_mob_validate_sc_field_0();
  scCssBlur(oThis);
}

function sc_form_tbtranrad_inap_sc_field_0_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_tbtranrad_inap_usia_onblur(oThis, iSeqRow) {
  do_ajax_form_tbtranrad_inap_mob_validate_usia();
  scCssBlur(oThis);
}

function sc_form_tbtranrad_inap_usia_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_tbtranrad_inap_detailrad_onblur(oThis, iSeqRow) {
  do_ajax_form_tbtranrad_inap_mob_validate_detailrad();
  scCssBlur(oThis);
}

function sc_form_tbtranrad_inap_detailrad_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_tbtranrad_inap_provider_onblur(oThis, iSeqRow) {
  do_ajax_form_tbtranrad_inap_mob_validate_provider();
  scCssBlur(oThis);
}

function sc_form_tbtranrad_inap_provider_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function scHidePage(pageNo) {
	$("#id_form_tbtranrad_inap_mob_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_trandate" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_tbtranrad_inap_mob_validate_trandate(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_enterdate" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_tbtranrad_inap_mob_validate_enterdate(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_finishdate" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_tbtranrad_inap_mob_validate_finishdate(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_statusberkasdate" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_tbtranrad_inap_mob_validate_statusberkasdate(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
