...
//----- 
   function ini_controle()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['form_tbtranrad_inap']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['form_tbtranrad_inap']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_tbtranrad_inap']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_tbtranrad_inap']['total']);
          }
          if (!isset($_SESSION['sc_session'][$script_case_init]['form_tbtranrad_inap']['total']))
          {
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_tbtranrad_inap']['form_tbdetailrad_script_case_init'] ]['form_tbdetailrad']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_tbtranrad_inap']['form_tbdetailrad_script_case_init'] ]['form_tbdetailrad']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_tbtranrad_inap']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_tbtranrad_inap']['sc_redir_insert'] = $this->sc_redir_insert;
          }
      } 
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_tbtranrad_inap']['parms']))
      {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_tbtranrad_inap']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_tbtranrad_inap']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_tbtranrad_inap']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_tbtranrad_inap']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_tbtranrad_inap']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_tbtranrad_inap']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_tbtranrad_inap']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_tbtranrad_inap']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_tbtranrad_inap_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("id");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['initialize'];
      } 
      else 
      { 
         $this->nm_data = new nm_data("id");
      } 
      $_SESSION['sc_session'][$script_case_init]['form_tbtranrad_inap']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_tbtranrad_inap']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_tbtranrad_inap'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_tbtranrad_inap']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_tbtranrad_inap']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_tbtranrad_inap') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_tbtranrad_inap']['label'] = "Edit Transaksi Radiologi";
      ...
      $_SESSION['scriptcase']['error_icon']['form_tbtranrad_inap']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Rhino__NM__nm_scriptcase9_Rhino_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_tbtranrad_inap'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['embutida_call'] : $this->Embutida_call;

       $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbtranrad_inap']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbtranrad_inap']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbtranrad_inap']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbtranrad_inap']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbtranrad_inap']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbtranrad_inap']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbtranrad_inap']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbtranrad_inap']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbtranrad_inap']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbtranrad_inap']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbtranrad_inap']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbtranrad_inap']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbtranrad_inap']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_tbtranrad_inap']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_tbtranrad_inap']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbtranrad_inap']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbtranrad_inap']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbtranrad_inap']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_tbtranrad_inap']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_tbtranrad_inap']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbtranrad_inap']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbtranrad_inap']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_tbtranrad_inap']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_tbtranrad_inap']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbtranrad_inap']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbtranrad_inap']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbtranrad_inap']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbtranrad_inap']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbtranrad_inap']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbtranrad_inap']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbtranrad_inap']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbtranrad_inap']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbtranrad_inap']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbtranrad_inap']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbtranrad_inap']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbtranrad_inap']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbtranrad_inap']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbtranrad_inap']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbtranrad_inap']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbtranrad_inap']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbtranrad_inap']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbtranrad_inap']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbtranrad_inap']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbtranrad_inap']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_tbtranrad_inap']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_tbtranrad_inap']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_tbtranrad_inap']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbtranrad_inap']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbtranrad_inap']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbtranrad_inap']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbtranrad_inap']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbtranrad_inap']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbtranrad_inap']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbtranrad_inap']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbtranrad_inap']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbtranrad_inap']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbtranrad_inap']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbtranrad_inap']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbtranrad_inap']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbtranrad_inap']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbtranrad_inap']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbtranrad_inap']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbtranrad_inap']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbtranrad_inap']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbtranrad_inap']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbtranrad_inap']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbtranrad_inap']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbtranrad_inap']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbtranrad_inap']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbtranrad_inap']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbtranrad_inap']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbtranrad_inap']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbtranrad_inap']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbtranrad_inap']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbtranrad_inap']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbtranrad_inap']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbtranrad_inap']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbtranrad_inap']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbtranrad_inap']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbtranrad_inap']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbtranrad_inap']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbtranrad_inap']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbtranrad_inap']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbtranrad_inap']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbtranrad_inap']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbtranrad_inap']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbtranrad_inap']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_tbtranrad_inap'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_tbtranrad_inap'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_tbtranrad_inap']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_tbtranrad_inap']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_tbtranrad_inap']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_tbtranrad_inap']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_tbtranrad_inap']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_tbtranrad_inap']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_tbtranrad_inap']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_tbtranrad_inap']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['form_tbtranrad_inap']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['dados_form'];
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("form_tbtranrad_inap", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (isset($_GET['nm_cal_display']))
      {
          ...
          { 
              include_once($this->Ini->path_embutida . 'form_tbtranrad_inap/form_tbtranrad_inap_calendar.php');
          }
          else
          { 
              include_once($this->Ini->path_aplicacao . 'form_tbtranrad_inap_calendar.php');
          }
          exit;
      }

      if (is_file($this->Ini->path_aplicacao . 'form_tbtranrad_inap_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_tbtranrad_inap_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      if ($this->Embutida_proc)
      { 
          require_once($this->Ini->path_embutida . 'form_tbtranrad_inap/form_tbtranrad_inap_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_tbtranrad_inap_erro.class.php"); 
      }
      $this->Erro      = new form_tbtranrad_inap_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if ($this->nmgp_opcao == "fast_search")  
      {
          $this->SC_fast_search($this->nmgp_fast_search, $this->nmgp_cond_fast_search, $this->nmgp_arg_fast_search);
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['opcao'] = "inicio";
          $this->nmgp_opcao = "inicio";
          $this->proc_fast_search = true;
      } 
      if ($nm_opc_lookup != "lookup" && $nm_opc_php != "formphp")
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['opcao']))
         { 
             if ($this->id != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_tbtranrad_inap']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_tbtranrad_inap']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_tbtranrad_inap']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['opc_ant'];
      } 
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['final'];
      }
      else
      {
      }
...
//
      if ($this->nmgp_opcao == "excluir")
      {
          ...
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['form_tbdetailrad_script_case_init'] ]['form_tbdetailrad']['embutida_form'] = false;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['form_tbdetailrad_script_case_init'] ]['form_tbdetailrad']['embutida_proc'] = true;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['form_tbdetailrad_script_case_init'] ]['form_tbdetailrad']['reg_start'] = "";
          unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['form_tbdetailrad_script_case_init'] ]['form_tbdetailrad']['total']);
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['dados_select'];
     }
   }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "recarga_mobile" || $this->nmgp_opcao == "muda_form") 
      {
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['dados_select']['trancode']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->trancode = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['dados_select']['trancode'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['dados_select']['inapcode']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->inapcode = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['dados_select']['inapcode'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['dados_select']['struk']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->struk = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['dados_select']['struk'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['dados_select']['usia']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->usia = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['dados_select']['usia'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['dados_select']['alamat']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->alamat = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['dados_select']['alamat'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['dados_select']['doccode']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->doccode = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['dados_select']['doccode'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['dados_select']['docname']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->docname = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['dados_select']['docname'];
          } 
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['recarga'] = $this->nmgp_opcao;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['sc_redir_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['sc_redir_insert'] == "ok")
          {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['sc_redir_atualiz'] == "ok")
          {
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "form_tbtranrad_inap.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap'][$path_doc_md5][1] = $Zip_name;
?>
...
<form name="Fdown" method="get" action="form_tbtranrad_inap_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="form_tbtranrad_inap"> 
...
//---------------------------------------------------------
     ...
     if ('' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_form_tbtranrad_inap']) || !is_array($this->NM_ajax_info['errList']['geral_form_tbtranrad_inap']))
              {
                  $this->NM_ajax_info['errList']['geral_form_tbtranrad_inap'] = array();
              }
              $this->NM_ajax_info['errList']['geral_form_tbtranrad_inap'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
      if ('' == $filtro || 'id' == $filtro)
...
//---
    ...
    function ValidateField_custcode(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->custcode) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['Lookup_custcode']) && !in_array($this->custcode, $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['Lookup_custcode']))
               {
                   $hasError = true;
    ...
    function ValidateField_instcode(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->instcode) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['Lookup_instcode']) && !in_array($this->instcode, $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['Lookup_instcode']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_provider(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->provider) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['Lookup_provider']) && !in_array($this->provider, $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['Lookup_provider']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_struk(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->struk) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['Lookup_struk']) && !in_array($this->struk, $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['Lookup_struk']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_sc_field_0(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->sc_field_0) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['Lookup_sc_field_0']) && !in_array($this->sc_field_0, $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['Lookup_sc_field_0']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_alamat(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->alamat) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['Lookup_alamat']) && !in_array($this->alamat, $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['Lookup_alamat']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_doccode(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->doccode) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['Lookup_doccode']) && !in_array($this->doccode, $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['Lookup_doccode']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_docname(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->docname) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['Lookup_docname']) && !in_array($this->docname, $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['Lookup_docname']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_poli(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->poli) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['Lookup_poli']) && !in_array($this->poli, $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['Lookup_poli']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['dados_form'] = $this->nmgp_dados_form;
   }
...
//-- 
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['id']['keyVal'] = form_tbtranrad_inap_pack_protect_string($this->nmgp_dados_form['id']);
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['form_tbdetailrad_script_case_init'] ]['form_tbdetailrad']['foreign_key']['trancode'] = $this->nmgp_dados_form['trancode'];
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['form_tbdetailrad_script_case_init'] ]['form_tbdetailrad']['where_filter'] = "trancode = '" . $this->nmgp_dados_form['trancode'] . "'";
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['form_tbdetailrad_script_case_init'] ]['form_tbdetailrad']['where_detal']  = "trancode = '" . $this->nmgp_dados_form['trancode'] . "'";
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['total'] < 0)
              {
                  $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['form_tbdetailrad_script_case_init'] ]['form_tbdetailrad']['where_filter'] = "1 <> 1";
              }
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['form_tbdetailrad_script_case_init'] ]['form_tbdetailrad']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['form_tbdetailrad_script_case_init'] ]['form_tbdetailrad']['total']);
          }
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['Lookup_custcode']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['Lookup_custcode'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['Lookup_custcode']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['Lookup_custcode'] = array(); 
}
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       while (!$rs->EOF) 
       { 
              $aLookup[] = array(form_tbtranrad_inap_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', form_tbtranrad_inap_pack_protect_string(NM_charset_to_utf8($rs->fields[0]))));
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['Lookup_custcode'][] = $rs->fields[0];
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['custcode']['valList'][$i] = form_tbtranrad_inap_pack_protect_string($v);
          }
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['Lookup_instcode']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['Lookup_instcode'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['Lookup_instcode']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['Lookup_instcode'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       while (!$rs->EOF) 
       { 
              $aLookup[] = array(form_tbtranrad_inap_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', form_tbtranrad_inap_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['Lookup_instcode'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['instcode']['valList'][$i] = form_tbtranrad_inap_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['Lookup_provider']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['Lookup_provider'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['Lookup_provider']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['Lookup_provider'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              $aLookup[] = array(form_tbtranrad_inap_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', form_tbtranrad_inap_pack_protect_string(NM_charset_to_utf8($rs->fields[0]))));
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['Lookup_provider'][] = $rs->fields[0];
              $nmgp_def_dados .= $rs->fields[0] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $rs->MoveNext() ; 
       } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['provider']['valList'][$i] = form_tbtranrad_inap_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['Lookup_struk']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['Lookup_struk'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['Lookup_struk']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['Lookup_struk'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['Lookup_struk'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['struk']['valList'][$i] = form_tbtranrad_inap_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['Lookup_sc_field_0']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['Lookup_sc_field_0'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['Lookup_sc_field_0']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['Lookup_sc_field_0'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['Lookup_sc_field_0'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['sc_field_0']['valList'][$i] = form_tbtranrad_inap_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['Lookup_alamat']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['Lookup_alamat'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['Lookup_alamat']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['Lookup_alamat'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['Lookup_alamat'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['alamat']['valList'][$i] = form_tbtranrad_inap_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['Lookup_doccode']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['Lookup_doccode'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['Lookup_doccode']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['Lookup_doccode'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['Lookup_doccode'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['doccode']['valList'][$i] = form_tbtranrad_inap_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['Lookup_docname']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['Lookup_docname'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['Lookup_docname']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['Lookup_docname'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['Lookup_docname'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['docname']['valList'][$i] = form_tbtranrad_inap_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['Lookup_poli']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['Lookup_poli'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['Lookup_poli']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['Lookup_poli'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['Lookup_poli'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['poli']['valList'][$i] = form_tbtranrad_inap_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_tbtranrad_inap_pack_protect_string('Y') => form_tbtranrad_inap_pack_protect_string("Ya"));
$aLookup[] = array(form_tbtranrad_inap_pack_protect_string('N') => form_tbtranrad_inap_pack_protect_string("Tidak"));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['Lookup_contrast'][] = 'Y';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['Lookup_contrast'][] = 'N';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['contrast']['valList'][$i] = form_tbtranrad_inap_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_tbtranrad_inap_pack_protect_string('0') => form_tbtranrad_inap_pack_protect_string("Daftar"));
$aLookup[] = array(form_tbtranrad_inap_pack_protect_string('1') => form_tbtranrad_inap_pack_protect_string("Selesai"));
$aLookup[] = array(form_tbtranrad_inap_pack_protect_string('2') => form_tbtranrad_inap_pack_protect_string("Lengkap"));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['Lookup_status'][] = '0';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['Lookup_status'][] = '1';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['Lookup_status'][] = '2';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['status']['valList'][$i] = form_tbtranrad_inap_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   function ajax_return_values_detailrad($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
  ...
  function nm_proc_onload($bFormat = true)
  {
      ...
      $_SESSION['scriptcase']['form_tbtranrad_inap']['contr_erro'] = 'on';
...
//----------- 
   ...
   function return_after_insert()
   {
      ...
      if ('' != $this->id)
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['reg_start'] = $rsc->fields[0];
          $rsc->Close();
      }
   }
...
$_SESSION['scriptcase']['form_tbtranrad_inap']['contr_erro'] = 'off'; 
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['db_changed'] = true;
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['total']);
              }
              ...
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao   = "igual"; 
      ...
      { 
          ...
          { 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['reg_start'] = 0; 
              }
...
$_SESSION['scriptcase']['form_tbtranrad_inap']['contr_erro'] = 'off'; 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['parms'] = "id?#?$this->id?@?"; 
      }
      $this->NM_commit_db(); 
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['where_filter'] . ")";
          }
      }
//------------ 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['run_iframe'] == "R")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['iframe_evento'] = $this->sc_evento; 
      } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['run_iframe'] == "F" && $this->sc_evento == "insert")
      {
          $this->nmgp_opcao = "final";
      }
      $sc_where = trim("");
      ...
      { 
          ...
          $qt_geral_reg_form_tbtranrad_inap = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['total'] = $qt_geral_reg_form_tbtranrad_inap;
          $rt->Close(); 
          if ($this->nmgp_opcao == "igual" && isset($this->NM_btn_navega) && 'S' == $this->NM_btn_navega && !empty($this->id))
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['reg_start'] = $rt->fields[0];
              $rt->Close(); 
          }
      } 
      else 
      { 
          $qt_geral_reg_form_tbtranrad_inap = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['total'];
      } 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['reg_start']++; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['reg_start'] > $qt_geral_reg_form_tbtranrad_inap)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['reg_start'] = $qt_geral_reg_form_tbtranrad_inap; 
          }
      } 
      ...
      if ($this->nmgp_opcao == "navpage" && ($this->nmgp_ordem - 1) <= $qt_geral_reg_form_tbtranrad_inap) 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['reg_start'] = $this->nmgp_ordem - 1; 
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['reg_start']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['reg_start']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['reg_start'] = 0;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['reg_start'] + 1;
      $this->NM_ajax_info['navSummary']['reg_ini'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['reg_start'] + 1; 
      $this->NM_ajax_info['navSummary']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['reg_qtd']; 
      $this->NM_ajax_info['navSummary']['reg_tot'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['total'] + 1; 
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
              $GLOBALS["NM_ERRO_IBASE"] = 1;  
          } 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['run_iframe'] == "R")
          {
              ...
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['select'] = ""; 
              } 
          } 
          if ($this->nmgp_opcao == "igual") 
          { 
          ...
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['reg_start'] . ")" ; 
              $rs = $this->Db->SelectLimit($nmgp_select, 1, $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['reg_start']) ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['reg_start'] . ")" ; 
          ...
          { 
              ...
              if (!$rs === false && !$rs->EOF) 
              { 
                  $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['reg_start']) ;  
              } 
          } 
          ...
          if ($rs->EOF) 
          { 
              if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['where_filter']))
              {
                  ...
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['empty_filter'] = true;
                  return; 
              }
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['dados_select'] = $this->nmgp_dados_select;
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['reg_start'] < $qt_geral_reg_form_tbtranrad_inap;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['opcao']   = '';
          }
      } 
...
//-- 
      ...
      $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['form_tbdetailrad_script_case_init'] ]['form_tbdetailrad']['embutida_parms'] = "NM_btn_insert*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinS*scoutNM_btn_navega*scinN*scout";
  }
// 
//-- 
...
//-- 
   ...
   function NM_gera_nav_page() 
   {
       ...
       $rec_tot    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['total'] + 1;
       $rec_fim    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['reg_start'] + 1;
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
        ...
        $this->initFormPages();
    include_once("form_tbtranrad_inap_form0.php");
        $this->hideFormPages();
 }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['table_refresh'])
        {
   ...
   function jqueryButtonText($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['csrf_token'];
    }
...
else
{
   ...
   function SC_fast_search($field, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['where_filter_form'] . " and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_form_tbtranrad_inap = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['total'] = $qt_geral_reg_form_tbtranrad_inap;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_tbtranrad_inap_pack_ajax_response();
   ...
   function SC_monta_condicao(&$comando, $nome, $condicao, $campo, $tp_campo="")
   {
      ...
      {
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['decimal_db'] == ".")
         {
             $nm_aspas  = "";
             $nm_aspas1 = "";
         }
         ...
         if (isset($Nm_datas[$campo_join]))
         {
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          {
             ...
             $nm_aspas1 = "#";
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['SC_sep_date1'];
              }
          }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "form_tbtranrad_inap_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_tbtranrad_inap_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['masterValue']))
{
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['dashboard_info']['under_dashboard']) {
?>
var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['dashboard_info']['parent_widget']; ?>']");
if (dbParentFrame && dbParentFrame[0] && dbParentFrame[0].contentWindow.scAjaxDetailValue)
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtranrad_inap']['masterValue'] as $cmp_master => $val_master)
        {
?>
