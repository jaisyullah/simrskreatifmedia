<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tbreqitemLog']['sc_process_barr'] = true;
require_once('../grid_tbreqitemLog/index.php');
unset($_SESSION['scriptcase']['grid_tbreqitemLog']['sc_process_barr']);
$ExportCtrl = new grid_tbreqitemLog_export_control;
$ExportCtrl->Export_barr();

class grid_tbreqitemLog_export_control
{
