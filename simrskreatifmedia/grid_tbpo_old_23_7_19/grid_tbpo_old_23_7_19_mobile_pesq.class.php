...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_non_pbf"  <?php echo $str_hide_non_pbf?>><INPUT  type="text" id="SC_non_pbf" name="non_pbf" value="<?php echo NM_encode_input($non_pbf) ?>"  size=50 alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
