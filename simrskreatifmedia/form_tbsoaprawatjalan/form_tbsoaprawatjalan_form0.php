<?php
class form_tbsoaprawatjalan_form extends form_tbsoaprawatjalan_apl
{
function Form_Init()
{
...
<?php
if ($this->Embutida_form && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbsoaprawatjalan']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbsoaprawatjalan']['sc_modal'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbsoaprawatjalan']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbsoaprawatjalan']['sc_redir_atualiz'] == 'ok')
{
?>
...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbsoaprawatjalan']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_tbsoaprawatjalan/form_tbsoaprawatjalan_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_tbsoaprawatjalan_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_tbsoaprawatjalan_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbsoaprawatjalan']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbsoaprawatjalan']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbsoaprawatjalan']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbsoaprawatjalan']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbsoaprawatjalan']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbsoaprawatjalan']['recarga'];
}
if ('novo' == $opcao_botoes && $this->Embutida_form)
{
    $opcao_botoes = 'inicio';
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbsoaprawatjalan']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbsoaprawatjalan']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
?>
...
<?php
 include_once("form_tbsoaprawatjalan_js0.php");
?>
<script type="text/javascript"> 
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_tbsoaprawatjalan'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_tbsoaprawatjalan'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbsoaprawatjalan']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbsoaprawatjalan']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbsoaprawatjalan']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbsoaprawatjalan']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbsoaprawatjalan']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbsoaprawatjalan']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbsoaprawatjalan']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbsoaprawatjalan']['run_iframe'] != "R")
{
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbsoaprawatjalan']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbsoaprawatjalan']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbsoaprawatjalan']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbsoaprawatjalan']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbsoaprawatjalan']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbsoaprawatjalan']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbsoaprawatjalan']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbsoaprawatjalan']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbsoaprawatjalan']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbsoaprawatjalan']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
{ 
   ...
   { 
       ob_start();
       $iStart = sizeof($this->form_vert_form_tbsoaprawatjalan);
       $guarda_nmgp_opcao = $this->nmgp_opcao;
       $guarda_form_vert_form_tbsoaprawatjalan = $this->form_vert_form_tbsoaprawatjalan;
       $this->nmgp_opcao = 'novo';
   } 
   if ($this->Embutida_form && empty($this->form_vert_form_tbsoaprawatjalan))
   {
       $sc_seq_vert = 0;
   }
   ...
   foreach ($this->form_vert_form_tbsoaprawatjalan as $sc_seq_vert => $sc_lixo)
   {
       $this->loadRecordState($sc_seq_vert);
       $this->trancode_ = $this->form_vert_form_tbsoaprawatjalan[$sc_seq_vert]['trancode_'];
       $this->id_tr_ = $this->form_vert_form_tbsoaprawatjalan[$sc_seq_vert]['id_tr_'];
       ...
       elseif ($Line_Add)
       {
        ...
        $this->tglsoap_ = $this->form_vert_form_tbsoaprawatjalan[$sc_seq_vert]['tglsoap_'] . ' ' . $this->form_vert_form_tbsoaprawatjalan[$sc_seq_vert]['tglsoap__hora']; 
       ...
       $this->subject_ = $this->form_vert_form_tbsoaprawatjalan[$sc_seq_vert]['subject_']; 
       ...
       $this->object_ = $this->form_vert_form_tbsoaprawatjalan[$sc_seq_vert]['object_']; 
       ...
       $this->assesment_ = $this->form_vert_form_tbsoaprawatjalan[$sc_seq_vert]['assesment_']; 
       ...
       $this->plan_ = $this->form_vert_form_tbsoaprawatjalan[$sc_seq_vert]['plan_']; 
       $plan_ = $this->plan_; 
       ...
       $this->pelaksana_ = $this->form_vert_form_tbsoaprawatjalan[$sc_seq_vert]['pelaksana_']; 
       ...
       $this->id_ = $this->form_vert_form_tbsoaprawatjalan[$sc_seq_vert]['id_']; 
       $id_ = $this->id_; 
       if (!isset($this->nmgp_cmp_hidden['id_']))
       {
           $this->nmgp_cmp_hidden['id_'] = 'off';
...
<?php echo nmButtonOutput($this->arr_buttons, "bmd_novo", "do_ajax_form_tbsoaprawatjalan_add_new_line(" . $sc_seq_vert . ")", "do_ajax_form_tbsoaprawatjalan_add_new_line(" . $sc_seq_vert . ")", "sc_new_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
<?php }?>
<?php
  $Style_add_line = (!$Line_Add) ? "display: none" : "";
?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_form_tbsoaprawatjalan_cancel_insert(" . $sc_seq_vert . ")", "do_ajax_form_tbsoaprawatjalan_cancel_insert(" . $sc_seq_vert . ")", "sc_canceli_line_" . $sc_seq_vert . "", "", "", "" . $Style_add_line . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_form_tbsoaprawatjalan_cancel_update(" . $sc_seq_vert . ")", "do_ajax_form_tbsoaprawatjalan_cancel_update(" . $sc_seq_vert . ")", "sc_cancelu_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
 </TD>
   <?php }?>
...
<?php
   $Sc_iframe_master = ($this->Embutida_call) ? 'nmgp_iframe_ret*scinnmsc_iframe_liga_form_tbsoaprawatjalan*scout' : '';
   if (isset($this->Ini->sc_lig_md5["grid_tbtemplatesoap"]) && $this->Ini->sc_lig_md5["grid_tbtemplatesoap"] == "S") {
       $Parms_Lig  = "nmgp_url_saida*scin*scoutnmgp_parms_ret*scinF1,subject_" . $sc_seq_vert . ",subject*scoutnm_evt_ret_busca*scinsc_form_tbsoaprawatjalan_subject__onchange(this," . $sc_seq_vert . ")*scout" . $Sc_iframe_master;
       $Md5_Lig    = "@SC_par@" . $this->form_encode_input($this->Ini->sc_page) . "@SC_par@form_tbsoaprawatjalan@SC_par@" . md5($Parms_Lig);
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbsoaprawatjalan']['Lig_Md5'][md5($Parms_Lig)] = $Parms_Lig;
   } else {
       $Md5_Lig  = "nmgp_url_saida*scin*scoutnmgp_parms_ret*scinF1,subject_" . $sc_seq_vert . ",subject*scoutnm_evt_ret_busca*scinsc_form_tbsoaprawatjalan_subject__onchange(this," . $sc_seq_vert . ")*scout" . $Sc_iframe_master;
   }
?>
...
<?php
   $Sc_iframe_master = ($this->Embutida_call) ? 'nmgp_iframe_ret*scinnmsc_iframe_liga_form_tbsoaprawatjalan*scout' : '';
   if (isset($this->Ini->sc_lig_md5["grid_tbtemplatesoap"]) && $this->Ini->sc_lig_md5["grid_tbtemplatesoap"] == "S") {
       $Parms_Lig  = "nmgp_url_saida*scin*scoutnmgp_parms_ret*scinF1,object_" . $sc_seq_vert . ",object*scoutnm_evt_ret_busca*scinsc_form_tbsoaprawatjalan_object__onchange(this," . $sc_seq_vert . ")*scout" . $Sc_iframe_master;
       $Md5_Lig    = "@SC_par@" . $this->form_encode_input($this->Ini->sc_page) . "@SC_par@form_tbsoaprawatjalan@SC_par@" . md5($Parms_Lig);
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbsoaprawatjalan']['Lig_Md5'][md5($Parms_Lig)] = $Parms_Lig;
   } else {
       $Md5_Lig  = "nmgp_url_saida*scin*scoutnmgp_parms_ret*scinF1,object_" . $sc_seq_vert . ",object*scoutnm_evt_ret_busca*scinsc_form_tbsoaprawatjalan_object__onchange(this," . $sc_seq_vert . ")*scout" . $Sc_iframe_master;
   }
?>
...
<?php
   $Sc_iframe_master = ($this->Embutida_call) ? 'nmgp_iframe_ret*scinnmsc_iframe_liga_form_tbsoaprawatjalan*scout' : '';
   if (isset($this->Ini->sc_lig_md5["grid_tbtemplatesoap"]) && $this->Ini->sc_lig_md5["grid_tbtemplatesoap"] == "S") {
       $Parms_Lig  = "nmgp_url_saida*scin*scoutnmgp_parms_ret*scinF1,assesment_" . $sc_seq_vert . ",assessment*scoutnm_evt_ret_busca*scinsc_form_tbsoaprawatjalan_assesment__onchange(this," . $sc_seq_vert . ")*scout" . $Sc_iframe_master;
       $Md5_Lig    = "@SC_par@" . $this->form_encode_input($this->Ini->sc_page) . "@SC_par@form_tbsoaprawatjalan@SC_par@" . md5($Parms_Lig);
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbsoaprawatjalan']['Lig_Md5'][md5($Parms_Lig)] = $Parms_Lig;
   } else {
       $Md5_Lig  = "nmgp_url_saida*scin*scoutnmgp_parms_ret*scinF1,assesment_" . $sc_seq_vert . ",assessment*scoutnm_evt_ret_busca*scinsc_form_tbsoaprawatjalan_assesment__onchange(this," . $sc_seq_vert . ")*scout" . $Sc_iframe_master;
   }
?>
...
<?php
   $Sc_iframe_master = ($this->Embutida_call) ? 'nmgp_iframe_ret*scinnmsc_iframe_liga_form_tbsoaprawatjalan*scout' : '';
   if (isset($this->Ini->sc_lig_md5["grid_tbtemplatesoap"]) && $this->Ini->sc_lig_md5["grid_tbtemplatesoap"] == "S") {
       $Parms_Lig  = "nmgp_url_saida*scin*scoutnmgp_parms_ret*scinF1,plan_" . $sc_seq_vert . ",plan*scoutnm_evt_ret_busca*scinsc_form_tbsoaprawatjalan_plan__onchange(this," . $sc_seq_vert . ")*scout" . $Sc_iframe_master;
       $Md5_Lig    = "@SC_par@" . $this->form_encode_input($this->Ini->sc_page) . "@SC_par@form_tbsoaprawatjalan@SC_par@" . md5($Parms_Lig);
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbsoaprawatjalan']['Lig_Md5'][md5($Parms_Lig)] = $Parms_Lig;
   } else {
       $Md5_Lig  = "nmgp_url_saida*scin*scoutnmgp_parms_ret*scinF1,plan_" . $sc_seq_vert . ",plan*scoutnm_evt_ret_busca*scinsc_form_tbsoaprawatjalan_plan__onchange(this," . $sc_seq_vert . ")*scout" . $Sc_iframe_master;
   }
?>
...
<?php   
   ...
   { 
       ...
       $this->form_vert_form_tbsoaprawatjalan = $guarda_form_vert_form_tbsoaprawatjalan;
   } 
   if ($Table_refresh) 
   { 
...
<?php
if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbsoaprawatjalan']['run_modal']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbsoaprawatjalan']['run_modal'])
{
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbsoaprawatjalan']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbsoaprawatjalan']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_tbsoaprawatjalan");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_tbsoaprawatjalan");
 parent.scAjaxDetailHeight("form_tbsoaprawatjalan", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
<script type="text/javascript">
	function scBtnFn_sys_format_inc() {
		if ($("#sc_b_new_t.sc-unique-btn-1").length && $("#sc_b_new_t.sc-unique-btn-1").is(":visible")) {
			do_ajax_form_tbsoaprawatjalan_add_new_line(); return false;
			 return;
		}
...
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbsoaprawatjalan']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
