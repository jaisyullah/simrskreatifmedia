<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_detailrawatinap']['glo_nm_path_imag_temp'] . "/sc_apl_default_simrskreatifmedia.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_detailrawatinap_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_detailrawatinap_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_detailrawatinap']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_detailrawatinap']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["kode"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detailrawatinap']['labels']["kode"])) ? $_SESSION['sc_session'][$sc_init]['grid_detailrawatinap']['labels']["kode"] : "Kode";
   $tab_ger_campos['norm'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['norm'] = "norm";
   }
   else
   {
       $tab_def_campos['norm'] = "a.custCode";
   }
   $tab_labels["norm"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detailrawatinap']['labels']["norm"])) ? $_SESSION['sc_session'][$sc_init]['grid_detailrawatinap']['labels']["norm"] : "No RM";
   ...
   {
       $tab_def_campos['rm'] = "concat(c.name,', ',salut)";
   }
   $tab_labels["rm"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detailrawatinap']['labels']["rm"])) ? $_SESSION['sc_session'][$sc_init]['grid_detailrawatinap']['labels']["rm"] : "RM";
   ...
   $tab_labels["sc_field_1"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detailrawatinap']['labels']["sc_field_1"])) ? $_SESSION['sc_session'][$sc_init]['grid_detailrawatinap']['labels']["sc_field_1"] : "Tgl Lahir";
   $tab_ger_campos['usia'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['usia'] = "Usia";
   }
   else
   {
       $tab_def_campos['usia'] = "";
   }
   $tab_labels["usia"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detailrawatinap']['labels']["usia"])) ? $_SESSION['sc_session'][$sc_init]['grid_detailrawatinap']['labels']["usia"] : "Usia";
   ...
   $tab_labels["dokter"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detailrawatinap']['labels']["dokter"])) ? $_SESSION['sc_session'][$sc_init]['grid_detailrawatinap']['labels']["dokter"] : "DPJP";
   ...
   $tab_labels["tglmasuk"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detailrawatinap']['labels']["tglmasuk"])) ? $_SESSION['sc_session'][$sc_init]['grid_detailrawatinap']['labels']["tglmasuk"] : "Tgl Masuk";
   ...
   $tab_labels["kelas"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detailrawatinap']['labels']["kelas"])) ? $_SESSION['sc_session'][$sc_init]['grid_detailrawatinap']['labels']["kelas"] : "Kelas";
   ...
   $tab_labels["ruanginap"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detailrawatinap']['labels']["ruanginap"])) ? $_SESSION['sc_session'][$sc_init]['grid_detailrawatinap']['labels']["ruanginap"] : "Kamar / Bed";
   ...
   {
       $tab_def_campos['bayar'] = "";
   }
   $tab_labels["bayar"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detailrawatinap']['labels']["bayar"])) ? $_SESSION['sc_session'][$sc_init]['grid_detailrawatinap']['labels']["bayar"] : "Cara Bayar";
   ...
   {
       $tab_def_campos['diagnosa'] = "a.diagnosa1";
   }
   $tab_labels["diagnosa"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detailrawatinap']['labels']["diagnosa"])) ? $_SESSION['sc_session'][$sc_init]['grid_detailrawatinap']['labels']["diagnosa"] : "Diagnosa";
   $tab_ger_campos['sc_field_1'] = "none";
   $tab_ger_campos['usia'] = "none";
   $tab_ger_campos['ruanginap'] = "none";
   $tab_ger_campos['bayar'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_detailrawatinap']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_detailrawatinap']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_detailrawatinap']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_detailrawatinap']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_detailrawatinap']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_detailrawatinap']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_detailrawatinap']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_detailrawatinap']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_detailrawatinap']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_detailrawatinap_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_detailrawatinap']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_detailrawatinap']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_detailrawatinap']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_detailrawatinap']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_detailrawatinap']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
