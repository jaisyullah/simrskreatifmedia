...
class grid_detailrawatinap_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   { 
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['grid_detailrawatinap']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['grid_detailrawatinap']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['res_hrz'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['where_resumo'] = "";
      }
      $this->inicializa_vars();
      $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['SC_Ind_Groupby'];
      $this->Total->$Gb_geral();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['contr_total_geral'] == "OK")
      {
          $this->array_total_dokter = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['arr_total']['dokter'];
      }
      else
      {
          $this->array_total_dokter = array();
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['tot_geral'][1] == 0)
      {
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          $this->drawMatrix();
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['arr_total']['dokter'] = $this->array_total_dokter;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['json_use_label'])
       {
          $Lab_dokter = "dokter";
       }
       else
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['labels']['kode']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['labels']['kode'] = "Kode"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['labels']['norm']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['labels']['norm'] = "No RM"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['labels']['rm']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['labels']['rm'] = "RM"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['labels']['sc_field_1']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['labels']['sc_field_1'] = "Tgl Lahir"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['labels']['usia']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['labels']['usia'] = "Usia"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['labels']['dokter']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['labels']['dokter'] = "DPJP"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['labels']['tglmasuk']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['labels']['tglmasuk'] = "Tgl Masuk"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['labels']['kelas']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['labels']['kelas'] = "Kelas"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['labels']['ruanginap']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['labels']['ruanginap'] = "Kamar / Bed"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['labels']['bayar']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['labels']['bayar'] = "Cara Bayar"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['labels']['diagnosa']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['labels']['diagnosa'] = "Diagnosa"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['labels']['selesai']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['labels']['selesai'] = "Selesai"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['labels']['tglkeluar']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['labels']['tglkeluar'] = "Tgl Keluar"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['labels']['jeniskeluar']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['labels']['jeniskeluar'] = "Jenis Keluar"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['labels']['carakeluar']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['labels']['carakeluar'] = "Cara Keluar"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['labels']['alasankeluar']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['labels']['alasankeluar'] = "Alasan Keluar"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['labels']['resikojatuh']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['labels']['resikojatuh'] = "Resiko Jatuh"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['labels']['sc_field_0']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['labels']['sc_field_0'] = "Billing Pasien"; 
       }
       //-----
       $this->comp_field_nm = array(
           'dokter' => 0,
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['summarizing_fields_order']['dokter']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['summarizing_fields_order']['dokter'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['summarizing_fields_order']['dokter'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['summarizing_fields_display']['dokter'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['summarizing_fields_display']['dokter'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['summarizing_fields_display']['dokter'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['summarizing_fields_display']['dokter'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['summarizing_fields_display']['dokter'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['summarizing_fields_display']['dokter'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['summarizing_fields_display']['dokter'] as $i_sum => $d_sum)
           {
       ...
       //-----
       foreach ($this->array_total_dokter as $i_dokter => $d_dokter) {
           if (!in_array($i_dokter, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_dokter[2] ] = $d_dokter[1];
               $this->comp_label[0][ $d_dokter[2] ] = $d_dokter[1];
           }
       }
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['pivot_order_level'] = -1;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['pivot_tabular_label'];
       ...
       //-----
       foreach ($this->comp_label[0] as $i_dokter => $l_dokter) {
           if (isset($this->array_total_dokter[$i_dokter])) {
               $this->comp_group[$i_dokter] = array();
           }
       }
   ...
   function getCompData($level, $params = array()) {
       if (0 == $level) {
           $return = $this->array_total_dokter;
       }
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_detailrawatinap@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function buildChart()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['pivot_charts']    = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['pivot_orig']      = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['comb_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['comb_table_def']  = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['anlt_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['anlt_table_def']  = array();
	...
	function filterChartsByGroupbyLevel() {
		...
		if (isset($nmgp_opcao) && ('pdf' == $nmgp_opcao || 'pdf_res' == $nmgp_opcao) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['chart_level']) && '' !== $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['chart_level']) {
			$applyFilter = true;
		}
		elseif (isset($nmgp_opcao) && 'image_res' == $nmgp_opcao && isset($_POST['chart_level']) && '' !== $_POST['chart_level']) {
			$applyFilter = true;
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['chart_level'] = $_POST['chart_level'];
		}
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['pivot_charts'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['pivot_orig'];

		if ($applyFilter) {
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['pivot_charts'] as $chartIndex => $chartData) {
				...
				if ($groupbyLevel > $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['chart_level']) {
					unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['pivot_charts'][$chartIndex]);
				}
			}
		}

		$this->comp_chart_data = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['pivot_charts'];
	}
           ...
           foreach ($a_totals as $i_total => $values)
           {
               ...
               if (isset($this->comp_chart_config[$key_config]))
               {
                   ...
                   foreach ($a_keys as $tmp_key)
                   {
                       ...
                       $xml_links[]  = $this->getFusionLink('sc_grid_detailrawatinap_' . session_id() . '_!!!' . implode('_', array_merge(array($group + 1, $i_total), $link_index)) . '!!!.json');
                   }
                   ...
                   $this->comp_chart_data[$key_data]['xml']        = $this->getFusionLink('sc_grid_detailrawatinap_' . session_id() . '_!!!' . implode('_', array_merge(array($group, $i_total), $param)) . '!!!.json');
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['proc_pdf_vert']){ 
   ...
   {
       if (!$res_chart && $this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['json_use_format']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['json_use_format'])
       {
           return $valor_campo;
       }
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         $this->monta_html_ini();
         $this->monta_cabecalho();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function inicializa_vars()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         require_once($this->Ini->path_aplicacao . "grid_detailrawatinap_total.class.php"); 
      }
      ...
      $this->Total   = new grid_detailrawatinap_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      $this->Total->Calc_resumo_dokter("res");
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['arr_total'][$cmp_gb];
      }
      ksort($this->array_total_dokter);
      if ("out" == $this->NM_tipo)
      {
         $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['SC_Ind_Groupby'];
         $this->Total->$Gb_geral();
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['dashboard_refresh_after_chart'] = 'resumo';
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['doc_word'])
{
   ...
   { 
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_detailrawatinap_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grid_detailrawatinap_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_detailrawatinap_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['num_css'] . '.css');
...
$nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_detailrawatinap/grid_detailrawatinap_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\">\r\n");
           ...
           $nm_saida->saida("     }\r\n");
           $nm_saida->saida("   </script>\r\n");
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['ajax_nav'] && !$this->Ini->sc_export_ajax && !$this->Ini->Export_html_zip && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['doc_word'])
      {
           $nm_saida->saida("   <script type=\"text/javascript\"> \r\n");
          ...
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['grid_pesq']))
          { 
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['doc_word']) 
      {
      ...
      {
          $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['dashboard_info']['remove_margin'] ? ' style="margin: 0"' : '';
          $nm_saida->saida(" <BODY class=\"" . $this->css_scGridPage . "\"" . $remove_margin . ">\r\n");
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['embutida'])
      {
   ...
   function monta_barra_top_normal()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['pdf'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "Rpdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_detailrawatinap/grid_detailrawatinap_config_pdf.php?nm_opc=pdf_res&nm_target=0&nm_cor=cor&papel=8&orientacao=1&bookmarks=1&largura=1200&conf_larg=S&conf_fonte=10&grafico=S&sc_ver_93=" . s . "&nm_tem_gb=s&nm_res_cons=s&nm_ini_pdf_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&summary_export_columns=S&nm_label_group=N&nm_all_cab=S&nm_all_label=S&pdf_zip=N&nm_orient_grid=2&origem=res&language=id&conf_socor=N&script_case_init=" . $this->Ini->sc_page . "&app_name=grid_detailrawatinap&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['word'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "Rword_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_detailrawatinap/grid_detailrawatinap_config_word.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_cor=CO&nm_res_cons=s&nm_ini_word_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&origem=res&language=id&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['xls'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bexcel", "", "", "Rxls_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_detailrawatinap/grid_detailrawatinap_config_xls.php?script_case_init=" . $this->Ini->sc_page . "&app_name=grid_detailrawatinap&nm_tp_xls=xlsx&nm_tot_xls=N&nm_tot_xls=N&nm_res_cons=s&nm_ini_xls_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&summary_export_columns=S&origem=res&language=&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['csv'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcsv", "", "", "Rcsv_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_detailrawatinap/grid_detailrawatinap_config_csv.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_res_cons=s&nm_ini_csv_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&nm_delim_line=1&nm_delim_col=1&nm_delim_dados=1&nm_label_csv=N&language=&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_detailrawatinap/grid_detailrawatinap_config_print.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_opc=resumo&nm_cor=CO&nm_res_cons=s&nm_ini_prt_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&origem=res&language=id&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if ($this->nmgp_botoes['chart_detail'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("grid_detailrawatinap_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
   ...
   function monta_html_fim()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['print_all'])
      {
          $this->grafico_pdf();
      }
      $nm_saida->saida("</TABLE>\r\n");
      $nm_saida->saida("<link rel=\"stylesheet\" type=\"text/css\" href=\"../_lib/css/" . $this->Ini->str_schema_all . "_sweetalert.css\" />\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_detailrawatinap']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_detailrawatinap']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'grid_detailrawatinap_config_pivot.php?nome_apl=grid_detailrawatinap&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=id&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_detailrawatinap_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "grid_detailrawatinap/grid_detailrawatinap_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
...
//--- 
   ...
   {
      global $nm_saida;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
      ...
      { 
        ...
        if ($_SESSION['scriptcase']['charset'] != "UTF-8")
        {
          ...
          $kode = $Busca_temp['kode']; 
          $tmp_pos = strpos($kode, "##@@");
          if ($tmp_pos !== false && !is_array($kode))
          {
              $kode = substr($kode, 0, $tmp_pos);
          }
          $dokter = $Busca_temp['dokter']; 
          $tmp_pos = strpos($dokter, "##@@");
          if ($tmp_pos !== false && !is_array($dokter))
          {
              $dokter = substr($dokter, 0, $tmp_pos);
          }
          $selesai = $Busca_temp['selesai']; 
          $tmp_pos = strpos($selesai, "##@@");
          if ($tmp_pos !== false && !is_array($selesai))
          {
              $selesai = substr($selesai, 0, $tmp_pos);
          }
          $tglkeluar = $Busca_temp['tglkeluar']; 
          $tmp_pos = strpos($tglkeluar, "##@@");
          if ($tmp_pos !== false && !is_array($tglkeluar))
          {
              $tglkeluar = substr($tglkeluar, 0, $tmp_pos);
          }
          $tglkeluar_2 = $Busca_temp['tglkeluar_input_2']; 
      } 
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['cond_pesq']))
      {  
          $pos       = 0;
          $trab_pos  = false;
          $pos_tmp   = true; 
          ...
          $nm_cond_filtro_or  = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['cond_pesq'], $trab_pos + 5) == "or")  ? " " . trim($this->Ini->Nm_lang['lang_srch_orr_cond']) . " " : "";
          $nm_cond_filtro_and = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['cond_pesq'], $trab_pos + 5) == "and") ? " " . trim($this->Ini->Nm_lang['lang_srch_and_cond']) . " " : "";
          $nm_cab_filtro   = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['cond_pesq'], 0, $trab_pos);
   ...
   //---- 
   function adiciona_registro($quebra_dokter, $quebra_dokter_orig)
   {
      //----- DPJP
      if (!isset($this->array_total_dokter[$quebra_dokter_orig]))
      {
         $this->array_total_dokter[$quebra_dokter_orig][0] = 1;
         $this->array_total_dokter[$quebra_dokter_orig][1] = $quebra_dokter;
         $this->array_total_dokter[$quebra_dokter_orig][2] = $quebra_dokter_orig;
      }
      else
      {
         $this->array_total_dokter[$quebra_dokter_orig][0]++;
      }
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('', 'dokter');
     $campos_order = $this->Ini->Get_date_order_groupby("a.dokter", 'asc', $format, $campos_order);
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->kode = $rs_res->fields[0] ;  
            $this->norm = $rs_res->fields[1] ;  
            $this->rm = $rs_res->fields[2] ;  
            $this->dokter = $rs_res->fields[3] ;  
            $this->tglmasuk = $rs_res->fields[4] ;  
            $this->kelas = $rs_res->fields[5] ;  
            $this->diagnosa = $rs_res->fields[6] ;  
            $this->selesai = $rs_res->fields[7] ;  
            $this->tglkeluar = $rs_res->fields[8] ;  
            $this->jeniskeluar = $rs_res->fields[9] ;  
            $this->carakeluar = $rs_res->fields[10] ;  
...
$_SESSION['scriptcase']['grid_detailrawatinap']['contr_erro'] = 'off'; 
            $this->dokter_orig = $this->dokter;
            $this->dokter = $this->look_dokter ;
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->dokter, $this->dokter_orig);
            }
   }
//
