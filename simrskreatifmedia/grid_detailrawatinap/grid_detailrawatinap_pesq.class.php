...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_selesai" name="selesai_autocomp" size="3"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 3, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_tglkeluar_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['tglkeluar'])) ? $this->New_label['tglkeluar'] : "Tgl Keluar"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_tglkeluar_cond" name="tglkeluar_cond" onChange="nm_campos_between(document.getElementById('id_vis_tglkeluar'), this, 'tglkeluar')">
...
?>
 ...
 <?php echo $date_format_show ?>         </SPAN>
       ...
       <TR valign="top">
        <TD id="id_vis_tglkeluar"  <?php echo $str_display_tglkeluar; ?> class="scFilterFieldFontEven">
