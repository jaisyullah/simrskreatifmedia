...
class grid_detailrawatinap_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['path_libs_php'] = $this->Ini->path_lib_php;
      ...
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search_change_fil")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['campos_busca'] = array(); 
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_detailrawatinap_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_detailrawatinap_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_detailrawatinap_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
          ...
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['grid_pesq'][$campo_join]);
              return;
          }
      ...
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_detailrawatinap/grid_detailrawatinap_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_detailrawatinap_ajax_search.js"></script>
 <script type="text/javascript" src="grid_detailrawatinap_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_detailrawatinap_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_detailrawatinap']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_detailrawatinap']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<?php
   ...
   function monta_form()
   {
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          $kode = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['campos_busca']['kode']; 
          $kode_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['campos_busca']['kode_cond']; 
          $dokter = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['campos_busca']['dokter']; 
          $dokter_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['campos_busca']['dokter_cond']; 
          $selesai = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['campos_busca']['selesai']; 
          $selesai_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['campos_busca']['selesai_cond']; 
          $tglkeluar_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['campos_busca']['tglkeluar_dia']; 
          $tglkeluar_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['campos_busca']['tglkeluar_mes']; 
          $tglkeluar_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['campos_busca']['tglkeluar_ano']; 
          $tglkeluar_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['campos_busca']['tglkeluar_input_2_dia']; 
          $tglkeluar_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['campos_busca']['tglkeluar_input_2_mes']; 
          $tglkeluar_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['campos_busca']['tglkeluar_input_2_ano']; 
          $tglkeluar_hor = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['campos_busca']['tglkeluar_hor']; 
          $tglkeluar_min = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['campos_busca']['tglkeluar_min']; 
          $tglkeluar_seg = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['campos_busca']['tglkeluar_seg']; 
          $tglkeluar_input_2_hor = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['campos_busca']['tglkeluar_input_2_hor']; 
          $tglkeluar_input_2_min = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['campos_busca']['tglkeluar_input_2_min']; 
          $tglkeluar_input_2_seg = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['campos_busca']['tglkeluar_input_2_seg']; 
          $tglkeluar_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['campos_busca']['tglkeluar_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['campos_busca']['NM_operador']; 
      } 
      ...
      $str_display_kode = ('bw' == $kode_cond) ? $display_aberto : $display_fechado;
...
?>
<INPUT  type="text" id="SC_kode" name="kode" value="<?php echo NM_encode_input($kode) ?>"  size=50 alt="{datatype: 'text', maxLength: 75, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_kode" name="kode_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 75, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_dokter_cond" name="dokter_cond" onChange="nm_campos_between(document.getElementById('id_vis_dokter'), this, 'dokter')">
      ...
      <br><span id="id_hide_dokter"  <?php echo $str_hide_dokter?>><?php
      if ($dokter != "")
      {
      $dokter_look = substr($this->Db->qstr($dokter), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_selesai_cond" name="selesai_cond" onChange="nm_campos_between(document.getElementById('id_vis_selesai'), this, 'selesai')">
      ...
      <br><span id="id_hide_selesai"  <?php echo $str_hide_selesai?>><?php
      if ($selesai != "")
      {
      $selesai_look = substr($this->Db->qstr($selesai), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_tglkeluar_cond" name="tglkeluar_cond" onChange="nm_campos_between(document.getElementById('id_vis_tglkeluar'), this, 'tglkeluar')">
      ...
      <br><span id="id_hide_tglkeluar"  <?php echo $str_hide_tglkeluar?>>
<?php
...
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_tglkeluar_dia" name="tglkeluar_dia" value="<?php echo NM_encode_input($tglkeluar_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_tglkeluar_mes" name="tglkeluar_mes" value="<?php echo NM_encode_input($tglkeluar_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_tglkeluar_hor" name="tglkeluar_hor" value="<?php echo NM_encode_input($tglkeluar_hor); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_tglkeluar_min" name="tglkeluar_min" value="<?php echo NM_encode_input($tglkeluar_min); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_tglkeluar_seg" name="tglkeluar_seg" value="<?php echo NM_encode_input($tglkeluar_seg); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
?>
        <SPAN id="id_css_tglkeluar"  class="scFilterFieldFontEven">
...
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_tglkeluar_input_2_dia" name="tglkeluar_input_2_dia" value="<?php echo NM_encode_input($tglkeluar_input_2_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_tglkeluar_input_2_mes" name="tglkeluar_input_2_mes" value="<?php echo NM_encode_input($tglkeluar_input_2_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_tglkeluar_input_2_hor" name="tglkeluar_input_2_hor" value="<?php echo NM_encode_input($tglkeluar_input_2_hor); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_tglkeluar_input_2_min" name="tglkeluar_input_2_min" value="<?php echo NM_encode_input($tglkeluar_input_2_min); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_tglkeluar_input_2_seg" name="tglkeluar_input_2_seg" value="<?php echo NM_encode_input($tglkeluar_input_2_seg); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if ($_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
<?php
   if (is_file("grid_detailrawatinap_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_detailrawatinap']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_detailrawatinap']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['orig_pesq'] == "grid")
   {
...
?>
 ...
 {
    $('#SC_tglkeluar_dia').bind('change', function() {sc_grid_detailrawatinap_valida_dia(this)});
    $('#SC_tglkeluar_hor').bind('change', function() {sc_grid_detailrawatinap_valida_hora(this)});
    $('#SC_tglkeluar_input_2_dia').bind('change', function() {sc_grid_detailrawatinap_valida_dia(this)});
    $('#SC_tglkeluar_input_2_hor').bind('change', function() {sc_grid_detailrawatinap_valida_hora(this)});
    $('#SC_tglkeluar_input_2_mes').bind('change', function() {sc_grid_detailrawatinap_valida_mes(this)});
    $('#SC_tglkeluar_input_2_min').bind('change', function() {sc_grid_detailrawatinap_valida_min(this)});
    $('#SC_tglkeluar_input_2_seg').bind('change', function() {sc_grid_detailrawatinap_valida_seg(this)});
    $('#SC_tglkeluar_mes').bind('change', function() {sc_grid_detailrawatinap_valida_mes(this)});
    $('#SC_tglkeluar_min').bind('change', function() {sc_grid_detailrawatinap_valida_min(this)});
    $('#SC_tglkeluar_seg').bind('change', function() {sc_grid_detailrawatinap_valida_seg(this)});
 }
 function sc_grid_detailrawatinap_valida_dia(obj)
 {
 ...
 function sc_grid_detailrawatinap_valida_mes(obj)
 {
 ...
 function sc_grid_detailrawatinap_valida_hora(obj)
 {
 ...
 function sc_grid_detailrawatinap_valida_min(obj)
 {
 ...
 function sc_grid_detailrawatinap_valida_seg(obj)
 {
     if (obj.value != "" && (obj.value < 0 || obj.value > 59))
     {
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['where_orig'] = "";
      }
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          $this->comando = "";
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['where_orig'];
      }
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function trata_campos()
   {
      global $kode_cond, $kode, $kode_autocomp,
             $dokter_cond, $dokter, $dokter_autocomp,
             $selesai_cond, $selesai, $selesai_autocomp,
             $tglkeluar_cond, $tglkeluar, $tglkeluar_dia, $tglkeluar_mes, $tglkeluar_ano, $tglkeluar_hor, $tglkeluar_min, $tglkeluar_seg, $tglkeluar_input_2_dia, $tglkeluar_input_2_mes, $tglkeluar_input_2_ano, $tglkeluar_input_2_min, $tglkeluar_input_2_hor, $tglkeluar_input_2_seg, $nmgp_tab_label;
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['campos_busca'] as $Cmps => $Vals)
          {
              $$Cmps = $Vals;
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['grid_pesq'] = array();
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['Grid_search']  = array(); 
      $I_Grid = 0;
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['campos_busca']['kode'] = $kode; 
      if (is_array($kode) && !empty($kode))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['Grid_search'][$I_Grid]['val'][0] = $kode;
      }
      elseif ($kode_cond_salva == "nu" || $kode_cond_salva == "nn" || $kode_cond_salva == "ep" || $kode_cond_salva == "ne" || !empty($kode))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['Grid_search'][$I_Grid]['val'][0][0] = $kode;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['campos_busca']['kode_cond'] = $kode_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['Grid_search'][$I_Grid]['cmp'] = "kode"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['Grid_search'][$I_Grid]['opc'] = $kode_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['grid_pesq']['kode'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['campos_busca']['dokter'] = $dokter; 
      if (is_array($dokter) && !empty($dokter))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['Grid_search'][$I_Grid]['val'][0] = $dokter;
      }
      elseif ($dokter_cond_salva == "nu" || $dokter_cond_salva == "nn" || $dokter_cond_salva == "ep" || $dokter_cond_salva == "ne" || !empty($dokter))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['Grid_search'][$I_Grid]['val'][0][0] = $dokter;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['campos_busca']['dokter_cond'] = $dokter_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['Grid_search'][$I_Grid]['cmp'] = "dokter"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['Grid_search'][$I_Grid]['opc'] = $dokter_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['grid_pesq']['dokter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['campos_busca']['selesai'] = $selesai; 
      if (is_array($selesai) && !empty($selesai))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['Grid_search'][$I_Grid]['val'][0] = $selesai;
      }
      elseif ($selesai_cond_salva == "nu" || $selesai_cond_salva == "nn" || $selesai_cond_salva == "ep" || $selesai_cond_salva == "ne" || !empty($selesai))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['Grid_search'][$I_Grid]['val'][0][0] = $selesai;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['campos_busca']['selesai_cond'] = $selesai_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['Grid_search'][$I_Grid]['cmp'] = "selesai"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['Grid_search'][$I_Grid]['opc'] = $selesai_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['grid_pesq']['selesai'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['campos_busca']['tglkeluar_dia'] = $tglkeluar_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['campos_busca']['tglkeluar_mes'] = $tglkeluar_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['campos_busca']['tglkeluar_ano'] = $tglkeluar_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['campos_busca']['tglkeluar_input_2_dia'] = $tglkeluar_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['campos_busca']['tglkeluar_input_2_mes'] = $tglkeluar_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['campos_busca']['tglkeluar_input_2_ano'] = $tglkeluar_input_2_ano; 
      ...
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['Grid_search'][$I_Grid]['val'][0][] = "D:" . $tglkeluar_dia;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['Grid_search'][$I_Grid]['val'][0][] = "M:" . $tglkeluar_mes;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['Grid_search'][$I_Grid]['val'][0][] = "Y:" . $tglkeluar_ano;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['Grid_search'][$I_Grid]['val'][1][] = "D:" . $tglkeluar_input_2_dia;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['Grid_search'][$I_Grid]['val'][1][] = "M:" . $tglkeluar_input_2_mes;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['Grid_search'][$I_Grid]['val'][1][] = "Y:" . $tglkeluar_input_2_ano;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['campos_busca']['tglkeluar_hor'] = $tglkeluar_hor; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['campos_busca']['tglkeluar_min'] = $tglkeluar_min; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['campos_busca']['tglkeluar_seg'] = $tglkeluar_seg; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['campos_busca']['tglkeluar_input_2_hor'] = $tglkeluar_input_2_hor; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['campos_busca']['tglkeluar_input_2_min'] = $tglkeluar_input_2_min; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['campos_busca']['tglkeluar_input_2_seg'] = $tglkeluar_input_2_seg; 
      ...
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['Grid_search'][$I_Grid]['val'][0][] = "H:" . $tglkeluar_hor;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['Grid_search'][$I_Grid]['val'][0][] = "I:" . $tglkeluar_min;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['Grid_search'][$I_Grid]['val'][0][] = "S:" . $tglkeluar_seg;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['Grid_search'][$I_Grid]['val'][1][] = "H:" . $tglkeluar_input_2_hor;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['Grid_search'][$I_Grid]['val'][1][] = "I:" . $tglkeluar_input_2_min;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['Grid_search'][$I_Grid]['val'][1][] = "S:" . $tglkeluar_input_2_seg;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['campos_busca']['tglkeluar_cond'] = $tglkeluar_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['Grid_search'][$I_Grid]['cmp'] = "tglkeluar"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['Grid_search'][$I_Grid]['opc'] = $tglkeluar_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['grid_pesq']['tglkeluar'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      ...
      {
         $this->monta_condicao("a.tranCode", $kode_cond, $kode, "", "kode");
      }
      ...
      if ($tglkeluar_cond != "bi_TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['campos_busca']['tglkeluar'] = $val[0];
          ...
          if ($tglkeluar_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['campos_busca']['tglkeluar_input_2'] = $val[1];
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['grid_pesq']['tglkeluar']['label'] = $nmgp_tab_label['tglkeluar'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['grid_pesq']['tglkeluar']['descr'] = $nmgp_tab_label['tglkeluar'] . " " . $this->Ini->Nm_lang['lang_srch_ever'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['grid_pesq']['tglkeluar']['hint']  = $nmgp_tab_label['tglkeluar'] . " " . $this->Ini->Nm_lang['lang_srch_ever'];
      }
   }
   ...
   function finaliza_resultado_ajax()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['where_pesq'] = $this->comando;
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['where_pesq_fast'])) 
       {
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['where_pesq'])) 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['where_pesq_fast'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['where_pesq'] = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['where_pesq_fast'] . ")";
           }
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['cond_dyn_search'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detailrawatinap']['cond_pesq'] .= $this->NM_operador;
