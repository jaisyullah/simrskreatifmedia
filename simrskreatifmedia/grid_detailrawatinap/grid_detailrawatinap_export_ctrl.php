<?php
@session_start() ;
$_SESSION['scriptcase']['grid_detailrawatinap']['sc_process_barr'] = true;
require_once('../grid_detailrawatinap/index.php');
unset($_SESSION['scriptcase']['grid_detailrawatinap']['sc_process_barr']);
$ExportCtrl = new grid_detailrawatinap_export_control;
$ExportCtrl->Export_barr();

class grid_detailrawatinap_export_control
{
