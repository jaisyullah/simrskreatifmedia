<?php
@session_start() ;
$_SESSION['scriptcase']['grid_payment_lab']['sc_process_barr'] = true;
require_once('../grid_payment_lab/index.php');
unset($_SESSION['scriptcase']['grid_payment_lab']['sc_process_barr']);
$ExportCtrl = new grid_payment_lab_export_control;
$ExportCtrl->Export_barr();

class grid_payment_lab_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - Pembayaran Lab :: Excel</TITLE>
