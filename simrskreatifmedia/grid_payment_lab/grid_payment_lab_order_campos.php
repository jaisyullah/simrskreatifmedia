...
<?php
   ...
   $Ord_Cmp = new grid_payment_lab_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_payment_lab_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_payment_lab']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_payment_lab']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["tglbayar"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_payment_lab']['labels']["tglbayar"])) ? $_SESSION['sc_session'][$sc_init]['grid_payment_lab']['labels']["tglbayar"] : "Tgl Bayar";
   $tab_ger_campos['nopayment'] = "on";
   $tab_def_campos['nopayment'] = "noPayment";
   $tab_labels["nopayment"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_payment_lab']['labels']["nopayment"])) ? $_SESSION['sc_session'][$sc_init]['grid_payment_lab']['labels']["nopayment"] : "No Payment";
   $tab_ger_campos['nostruk'] = "on";
   $tab_def_campos['nostruk'] = "noStruk";
   $tab_labels["nostruk"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_payment_lab']['labels']["nostruk"])) ? $_SESSION['sc_session'][$sc_init]['grid_payment_lab']['labels']["nostruk"] : "No Struk";
   $tab_ger_campos['trancode'] = "on";
   $tab_def_campos['trancode'] = "tranCode";
   $tab_labels["trancode"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_payment_lab']['labels']["trancode"])) ? $_SESSION['sc_session'][$sc_init]['grid_payment_lab']['labels']["trancode"] : "Kode Transaksi";
   $tab_ger_campos['custcode'] = "on";
   $tab_def_campos['custcode'] = "custCode";
   $tab_labels["custcode"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_payment_lab']['labels']["custcode"])) ? $_SESSION['sc_session'][$sc_init]['grid_payment_lab']['labels']["custcode"] : "No. RM";
...
ORDER BY name, salut";
   ...
   $tab_labels["sc_field_1"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_payment_lab']['labels']["sc_field_1"])) ? $_SESSION['sc_session'][$sc_init]['grid_payment_lab']['labels']["sc_field_1"] : "Nama Pasien";
   $tab_ger_campos['jmlbayar'] = "on";
   $tab_def_campos['jmlbayar'] = "jmlBayar";
   $tab_labels["jmlbayar"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_payment_lab']['labels']["jmlbayar"])) ? $_SESSION['sc_session'][$sc_init]['grid_payment_lab']['labels']["jmlbayar"] : "Jml Bayar";
   $tab_ger_campos['jenispayment'] = "on";
   $tab_def_campos['jenispayment'] = "jenisPayment";
   $tab_labels["jenispayment"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_payment_lab']['labels']["jenispayment"])) ? $_SESSION['sc_session'][$sc_init]['grid_payment_lab']['labels']["jenispayment"] : "Jenis Payment";
   $tab_ger_campos['kasir'] = "on";
   $tab_def_campos['kasir'] = "kasir";
   $tab_labels["kasir"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_payment_lab']['labels']["kasir"])) ? $_SESSION['sc_session'][$sc_init]['grid_payment_lab']['labels']["kasir"] : "Kasir";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_payment_lab']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_payment_lab']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_payment_lab']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_payment_lab']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_payment_lab']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_payment_lab']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_payment_lab']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_payment_lab']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_payment_lab']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_payment_lab_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_payment_lab']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_payment_lab']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_payment_lab']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_payment_lab']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_payment_lab']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
