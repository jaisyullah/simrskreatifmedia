...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "(sum(b_refharga * b_disetujui))-(sum((b_refharga * b_diskon)/100))+(sum((b_refharga * b_ppn)/100))";$Nm_numeric[] = "sum((b_refharga * b_ppn)/100)";$Nm_numeric[] = "sum((b_refharga * b_diskon)/100)";$Nm_numeric[] = "`harga satuan`";$Nm_numeric[] = "n";$Nm_numeric[] = "qty";$Nm_numeric[] = "subtotal";
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_a_nopo_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['a_nopo'])) ? $this->New_label['a_nopo'] : "No PO"; ?></TD>
      
      <INPUT type="hidden" id="SC_a_nopo_cond" name="a_nopo_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_a_nopo" <?php echo $str_hide_a_nopo?> valign="top">
