<?php
@session_start() ;
$_SESSION['scriptcase']['PO_gizi']['sc_process_barr'] = true;
require_once('../PO_gizi/index.php');
unset($_SESSION['scriptcase']['PO_gizi']['sc_process_barr']);
$ExportCtrl = new PO_gizi_export_control;
$ExportCtrl->Export_barr();

class PO_gizi_export_control
{
