...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____PO_gizi"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____PO_gizi"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['PO_gizi']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['PO_gizi']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['PO_gizi']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['PO_gizi']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['PO_gizi']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['PO_gizi']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['PO_gizi']['embutida_filho'] as $ind => $sc_init)
          {
