...
class form_tbbhpigd_old_apl
{
   ...
   var $form_vert_form_tbbhpigd_old = array();
...
//----- 
   function ini_controle()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['form_tbbhpigd_old']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['form_tbbhpigd_old']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_tbbhpigd_old']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_tbbhpigd_old']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_tbbhpigd_old']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_tbbhpigd_old']['sc_redir_insert'] = $this->sc_redir_insert;
          }
          if (isset($this->trancode)) 
          {
              $_SESSION['trancode'] = $this->trancode;
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_tbbhpigd_old']['parms']))
      {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_tbbhpigd_old']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_tbbhpigd_old']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_tbbhpigd_old']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_tbbhpigd_old']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_tbbhpigd_old']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_tbbhpigd_old']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_tbbhpigd_old']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_tbbhpigd_old']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_tbbhpigd_old_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("id");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['initialize'];
      } 
      else 
      { 
         $this->nm_data = new nm_data("id");
      } 
      $_SESSION['sc_session'][$script_case_init]['form_tbbhpigd_old']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_tbbhpigd_old']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_tbbhpigd_old'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_tbbhpigd_old']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_tbbhpigd_old']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_tbbhpigd_old') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_tbbhpigd_old']['label'] = "" . $this->Ini->Nm_lang['lang_othr_frmu_titl'] . " - tbreseprawatigd";
      ...
      $_SESSION['scriptcase']['error_icon']['form_tbbhpigd_old']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Rhino__NM__nm_scriptcase9_Rhino_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_tbbhpigd_old'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['embutida_call'] : $this->Embutida_call;

       $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbbhpigd_old']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbbhpigd_old']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbbhpigd_old']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbbhpigd_old']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbbhpigd_old']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbbhpigd_old']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbbhpigd_old']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbbhpigd_old']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbbhpigd_old']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbbhpigd_old']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbbhpigd_old']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbbhpigd_old']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbbhpigd_old']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_tbbhpigd_old']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_tbbhpigd_old']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbbhpigd_old']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbbhpigd_old']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbbhpigd_old']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_tbbhpigd_old']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_tbbhpigd_old']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbbhpigd_old']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbbhpigd_old']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_tbbhpigd_old']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_tbbhpigd_old']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbbhpigd_old']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbbhpigd_old']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbbhpigd_old']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbbhpigd_old']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbbhpigd_old']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbbhpigd_old']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbbhpigd_old']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbbhpigd_old']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbbhpigd_old']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbbhpigd_old']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbbhpigd_old']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbbhpigd_old']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbbhpigd_old']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbbhpigd_old']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbbhpigd_old']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbbhpigd_old']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbbhpigd_old']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbbhpigd_old']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbbhpigd_old']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbbhpigd_old']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_tbbhpigd_old']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_tbbhpigd_old']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_tbbhpigd_old']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbbhpigd_old']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbbhpigd_old']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbbhpigd_old']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbbhpigd_old']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbbhpigd_old']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbbhpigd_old']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbbhpigd_old']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbbhpigd_old']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbbhpigd_old']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbbhpigd_old']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbbhpigd_old']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbbhpigd_old']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbbhpigd_old']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbbhpigd_old']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbbhpigd_old']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbbhpigd_old']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbbhpigd_old']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbbhpigd_old']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbbhpigd_old']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbbhpigd_old']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbbhpigd_old']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbbhpigd_old']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbbhpigd_old']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbbhpigd_old']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbbhpigd_old']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbbhpigd_old']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbbhpigd_old']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbbhpigd_old']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbbhpigd_old']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbbhpigd_old']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbbhpigd_old']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbbhpigd_old']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbbhpigd_old']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbbhpigd_old']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbbhpigd_old']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbbhpigd_old']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbbhpigd_old']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbbhpigd_old']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbbhpigd_old']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tbbhpigd_old']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_tbbhpigd_old'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_tbbhpigd_old'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_tbbhpigd_old']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['form_tbbhpigd_old']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['form_tbbhpigd_old']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['form_tbbhpigd_old']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_tbbhpigd_old']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['form_tbbhpigd_old']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['form_tbbhpigd_old']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_tbbhpigd_old']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['form_tbbhpigd_old']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['form_tbbhpigd_old']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_tbbhpigd_old']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_tbbhpigd_old']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_tbbhpigd_old']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field . "_"] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field . "_"] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_tbbhpigd_old']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_tbbhpigd_old']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_tbbhpigd_old']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field . "_"] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field . "_"] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_tbbhpigd_old']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_tbbhpigd_old']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['form_tbbhpigd_old']['exit'];
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("form_tbbhpigd_old", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (is_file($this->Ini->path_aplicacao . 'form_tbbhpigd_old_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_tbbhpigd_old_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      { 
          require_once($this->Ini->path_embutida . 'form_tbbhpigd_old/form_tbbhpigd_old_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_tbbhpigd_old_erro.class.php"); 
      }
      $this->Erro      = new form_tbbhpigd_old_erro();
      $this->Erro->Ini = $this->Ini;
      if ($nm_opc_lookup != "lookup" && $nm_opc_php != "formphp")
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['opcao']))
         { 
             if ($this->id_ != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_tbbhpigd_old']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_tbbhpigd_old']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_tbbhpigd_old']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['opc_ant'];
      } 
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['final'];
      }
      else
      {
      }
...
//
   ...
   function controle()
   {
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['opc_edit'] = true;  
      ...
      if ($this->NM_ajax_flag && 'submit_form' == $this->NM_ajax_opcao)
      {
         ...
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['dados_form'][$sc_seq_vert]))
         {
             $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['dados_form'][$sc_seq_vert];
         ...
         if ($Campos_Crit != "" || !empty($Campos_Falta) || $this->Campos_Mens_erro != "")
         {
             $this->NM_rollback_db();
              if ($this->NM_ajax_flag)
              {
                  if (!isset($this->NM_ajax_info['errList']['geral_form_tbbhpigd_old']) || !is_array($this->NM_ajax_info['errList']['geral_form_tbbhpigd_old']))
                  {
                      $this->NM_ajax_info['errList']['geral_form_tbbhpigd_old'] = array();
                  }
                  if ($Campos_Crit != "")
                  {
                      $this->NM_ajax_info['errList']['geral_form_tbbhpigd_old'][] = $Campos_Crit;
                  }
                  if (!empty($Campos_Falta))
                  {
                      $this->NM_ajax_info['errList']['geral_form_tbbhpigd_old'][] = $this->Formata_Campos_Falta($Campos_Falta);
                  }
                  if ($this->Campos_Mens_erro != "")
                  {
                      $this->NM_ajax_info['errList']['geral_form_tbbhpigd_old'][] = $this->Campos_Mens_erro;
                  }
              }
         }
         else
         ...
         {
             $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['recarga'] = $this->nmgp_opcao;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['sc_redir_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['sc_redir_insert'] == "ok")
          {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['sc_redir_atualiz'] == "ok")
          {
   ...
   $nm_nao_carga = false;
   $nmgp_def_dados = "" ; 
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['Lookup_item_']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['Lookup_item_'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['Lookup_item_']); 
   }
   else
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['Lookup_item_'] = array(); 
    }
   ...
   if ($nm_comando != "" && $rs = $this->Db->SelectLimit($nm_comando, 10, 0))
   {
       while (!$rs->EOF) 
       { 
              $aLookup[] = array(form_tbbhpigd_old_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', form_tbbhpigd_old_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['Lookup_item_'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
      ...
      { 
         ...
         { 
             $GLOBALS["biaya_" . $sc_seq_vert] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['dados_select'][$sc_seq_vert]['biaya_'];
         } 
         if ($this->nmgp_opcao == "recarga" && !isset($GLOBALS["trandate_" . $sc_seq_vert]))
         { 
             $GLOBALS["trandate_" . $sc_seq_vert] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['dados_select'][$sc_seq_vert]['trandate_'];
         } 
         ...
         if (isset($this->biaya_)) { $this->nm_limpa_alfa($this->biaya_); }
         if (isset($this->diskon_)) { $this->nm_limpa_alfa($this->diskon_); }
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['dados_form'])) 
         {
            $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['dados_form'][$sc_seq_vert];
         }
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['dados_select'])) 
         {
            $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['dados_select'][$sc_seq_vert];
         }
         if ($this->nmgp_opcao != "recarga" && (!in_array($sc_seq_vert, $sc_check_excl) && !in_array($sc_seq_vert, $sc_check_incl) ))
         { }
         else
         {
             if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['dados_select'][$sc_seq_vert]['biaya_']) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['sc_disabled'][$sc_seq_vert]['biaya_']))
             { 
                 $this->biaya_ = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['dados_select'][$sc_seq_vert]['biaya_'];
             } 
             if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['dados_select'][$sc_seq_vert]['trandate_']) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['sc_disabled'][$sc_seq_vert]['trandate_']))
             { 
                 $this->trandate_ = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['dados_select'][$sc_seq_vert]['trandate_'];
             } 
             $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['sc_disabled'] = array();
             $this->controle_form_vert(); 
             ...
             $this->form_vert_form_tbbhpigd_old[$sc_seq_vert]['item_'] =  $this->item_; 
             $this->form_vert_form_tbbhpigd_old[$sc_seq_vert]['satuan_'] =  $this->satuan_; 
             $this->form_vert_form_tbbhpigd_old[$sc_seq_vert]['stok_'] =  $this->stok_; 
             $this->form_vert_form_tbbhpigd_old[$sc_seq_vert]['jumlah_'] =  $this->jumlah_; 
             $this->form_vert_form_tbbhpigd_old[$sc_seq_vert]['signa_'] =  $this->signa_; 
             $this->form_vert_form_tbbhpigd_old[$sc_seq_vert]['biaya_'] =  $this->biaya_; 
             $this->form_vert_form_tbbhpigd_old[$sc_seq_vert]['diskon_'] =  $this->diskon_; 
             $this->form_vert_form_tbbhpigd_old[$sc_seq_vert]['trandate_'] =  $this->trandate_; 
             $this->form_vert_form_tbbhpigd_old[$sc_seq_vert]['trandate__hora'] =  $this->trandate__hora; 
             $this->form_vert_form_tbbhpigd_old[$sc_seq_vert]['id_'] =  $this->id_; 
             $this->form_vert_form_tbbhpigd_old[$sc_seq_vert]['trancode_'] =  $this->trancode_; 
             $this->form_vert_form_tbbhpigd_old[$sc_seq_vert]['jenisaturanpakai_'] =  $this->jenisaturanpakai_; 
             $this->form_vert_form_tbbhpigd_old[$sc_seq_vert]['retur_'] =  $this->retur_; 
         }
         $sc_seq_vert++; 
      } 
      ...
      if ($this->NM_ajax_flag && 'table_refresh' == $this->NM_ajax_opcao)
      {
          ...
          $this->NM_ajax_info['rsSize'] = sizeof($this->form_vert_form_tbbhpigd_old);
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
      }
...
//
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "form_tbbhpigd_old.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old'][$path_doc_md5][1] = $Zip_name;
?>
...
<form name="Fdown" method="get" action="form_tbbhpigd_old_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="form_tbbhpigd_old"> 
...
//---------------------------------------------------------
     ...
     if ('' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              ...
              $this->NM_ajax_info['errList']['geral_form_tbbhpigd_old'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
...
//---
    ...
    function ValidateField_satuan_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->satuan_) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['Lookup_satuan_']) && !in_array($this->satuan_, $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['Lookup_satuan_']))
               {
                   $hasError = true;
    ...
    function ValidateField_stok_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->stok_) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['Lookup_stok_']) && !in_array($this->stok_, $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['Lookup_stok_']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['dados_form'][$sc_seq_vert] = $this->nmgp_dados_form;
   }
...
//-- 
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['navStatus']['ret'] = $this->Nav_permite_ret ? 'S' : 'N';
              $this->NM_ajax_info['navStatus']['ava'] = $this->Nav_permite_ava ? 'S' : 'N';
              $this->NM_ajax_info['fldList']['id_']['keyVal'] = form_tbbhpigd_old_pack_protect_string($this->nmgp_dados_form['id_']);
          }
   } // ajax_return_values
   function ajax_return_values_all_vert()
   {
          ...
          {
              $this->form_vert_form_tbbhpigd_old[$this->nmgp_refresh_row] = $this->NM_ajax_info['param'];
              if ((isset($this->Embutida_ronly) && $this->Embutida_ronly) || $this->NM_ajax_force_values)
              {
                  ...
                  {
                      $this->form_vert_form_tbbhpigd_old[$this->nmgp_refresh_row]['item_'] = $this->item_;
                  }
                  if (isset($this->NM_ajax_changed['satuan_']) && $this->NM_ajax_changed['satuan_'])
                  {
                      $this->form_vert_form_tbbhpigd_old[$this->nmgp_refresh_row]['satuan_'] = $this->satuan_;
                  }
                  if (isset($this->NM_ajax_changed['stok_']) && $this->NM_ajax_changed['stok_'])
                  {
                      $this->form_vert_form_tbbhpigd_old[$this->nmgp_refresh_row]['stok_'] = $this->stok_;
                  }
                  if (isset($this->NM_ajax_changed['jumlah_']) && $this->NM_ajax_changed['jumlah_'])
                  {
                      $this->form_vert_form_tbbhpigd_old[$this->nmgp_refresh_row]['jumlah_'] = $this->jumlah_;
                  }
                  if (isset($this->NM_ajax_changed['signa_']) && $this->NM_ajax_changed['signa_'])
                  {
                      $this->form_vert_form_tbbhpigd_old[$this->nmgp_refresh_row]['signa_'] = $this->signa_;
                  }
                  if (isset($this->NM_ajax_changed['biaya_']) && $this->NM_ajax_changed['biaya_'])
                  {
                      $this->form_vert_form_tbbhpigd_old[$this->nmgp_refresh_row]['biaya_'] = $this->biaya_;
                  }
                  if (isset($this->NM_ajax_changed['diskon_']) && $this->NM_ajax_changed['diskon_'])
                  {
                      $this->form_vert_form_tbbhpigd_old[$this->nmgp_refresh_row]['diskon_'] = $this->diskon_;
                  }
                  if (isset($this->NM_ajax_changed['trandate_']) && $this->NM_ajax_changed['trandate_'])
                  {
                      $this->form_vert_form_tbbhpigd_old[$this->nmgp_refresh_row]['trandate_'] = $this->trandate_;
                      $this->form_vert_form_tbbhpigd_old[$this->nmgp_refresh_row]['trandate__hora'] = $this->trandate__hora;
                  }
                  if (isset($this->NM_ajax_changed['id_']) && $this->NM_ajax_changed['id_'])
                  {
                      $this->form_vert_form_tbbhpigd_old[$this->nmgp_refresh_row]['id_'] = $this->id_;
                  }
              }
          }
          ...
          foreach($this->form_vert_form_tbbhpigd_old as $sc_seq_vert => $aRecData)
          {
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          $this->NM_ajax_info['fldList']['item_' . $sc_seq_vert . '_autocomp'] = array(
               'type'    => 'text',
               'valList' => array($aLookup[0][form_tbbhpigd_old_pack_protect_string($aRecData['item_'])]),
              );
              }
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['Lookup_satuan_']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['Lookup_satuan_'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['Lookup_satuan_']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['Lookup_satuan_'] = array(); 
}
if ('autocomp_' != substr($this->NM_ajax_opcao, 0, 9))
{
   $this->item_ = $this->form_vert_form_tbbhpigd_old[$sc_seq_vert]['item_'];
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       while (!$rs->EOF) 
       { 
              $aLookup[] = array(form_tbbhpigd_old_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', form_tbbhpigd_old_pack_protect_string(NM_charset_to_utf8($rs->fields[0]))));
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['Lookup_satuan_'][] = $rs->fields[0];
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['satuan_' . $sc_seq_vert]['valList'][$i] = form_tbbhpigd_old_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['Lookup_stok_']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['Lookup_stok_'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['Lookup_stok_']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['Lookup_stok_'] = array(); 
}
if ('autocomp_' != substr($this->NM_ajax_opcao, 0, 9))
{
   $this->item_ = $this->form_vert_form_tbbhpigd_old[$sc_seq_vert]['item_'];
   ...
   $nm_comando = "SELECT sum(a.currentStock) FROM tbstockobat a left join tbdepo b on b.kodeDepo = a.depo WHERE a.kodeItem = '$this->item_' AND (b.namaDepo = 'IGD' OR b.namaDepo = 'TROLLY EMERGENCY')";
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $aLookup[] = array(form_tbbhpigd_old_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', form_tbbhpigd_old_pack_protect_string(NM_charset_to_utf8($rs->fields[0]))));
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['Lookup_stok_'][] = $rs->fields[0];
              $nmgp_def_dados .= $rs->fields[0] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $rs->MoveNext() ; 
       } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['stok_' . $sc_seq_vert]['valList'][$i] = form_tbbhpigd_old_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
  ...
  function nm_proc_onload($bFormat = true)
  {
      ...
      $_SESSION['scriptcase']['form_tbbhpigd_old']['contr_erro'] = 'on';
...
//----------- 
   ...
   function return_after_insert()
   {
      ...
      if ('' != $this->id_)
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['reg_start'] = $rsc->fields[0];
          $rsc->Close();
      }
   }
   ...
   { 
      ...
      if ($this->nmgp_opcao == "alterar")
      {
          ...
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['dados_select'][$sc_seq_vert]['item_'] = $this->item_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['dados_select'][$sc_seq_vert]['satuan_'] = $this->satuan_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['dados_select'][$sc_seq_vert]['jumlah_'] = $this->jumlah_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['dados_select'][$sc_seq_vert]['signa_'] = $this->signa_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['dados_select'][$sc_seq_vert]['biaya_'] = $this->biaya_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['dados_select'][$sc_seq_vert]['diskon_'] = $this->diskon_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['dados_select'][$sc_seq_vert]['trandate_'] = $this->trandate_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['dados_select'][$sc_seq_vert]['id_'] = $this->id_;
          }
      }
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['decimal_db'] == ",") 
      {
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              { 
                  ...
                  $SC_fields_update[] = "item = '$this->item_', satuan = '$this->satuan_', jumlah = $this->jumlah_, signa = '$this->signa_', biaya = $this->biaya_, tranDate = #$this->trandate_#, diskon = $this->diskon_"; 
              } 
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
              { 
                  $comando = "UPDATE " . $this->Ini->nm_tabela . " SET ";  
                  $SC_fields_update[] = "item = '$this->item_', satuan = '$this->satuan_', jumlah = $this->jumlah_, signa = '$this->signa_', biaya = $this->biaya_, tranDate = " . $this->Ini->date_delim . $this->trandate_ . $this->Ini->date_delim1 . ", diskon = $this->diskon_"; 
              } 
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_oracle))
              { 
                  $comando = "UPDATE " . $this->Ini->nm_tabela . " SET ";  
              ...
              { 
                  $comando = "UPDATE " . $this->Ini->nm_tabela . " SET ";  
                  $SC_fields_update[] = "item = '$this->item_', satuan = '$this->satuan_', jumlah = $this->jumlah_, signa = '$this->signa_', biaya = $this->biaya_, tranDate = EXTEND('$this->trandate_', YEAR TO FRACTION), diskon = $this->diskon_"; 
              } 
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
              { 
                  $comando = "UPDATE " . $this->Ini->nm_tabela . " SET ";  
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['db_changed'] = true;
              ...
              $this->nmgp_refresh_fields = array_diff(array('item_', 'satuan_', 'stok_', 'jumlah_', 'signa_', 'biaya_', 'diskon_', 'trandate_', 'id_'), $aDoNotUpdate);
...
else
{
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              if (key($aValData) == form_tbbhpigd_old_pack_protect_string(NM_charset_to_utf8($this->satuan_)))
              {
...
else
{
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          foreach ($aLookup as $aValData)
          {
              if (key($aValData) == form_tbbhpigd_old_pack_protect_string(NM_charset_to_utf8($this->stok_)))
              {
                  $sLabelTemp = current($aValData);
              }
          }
          $tmpLabel_stok_ = $sLabelTemp;
              ...
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao   = "igual"; 
...
if (isset($this->rs[0][0]))     
{
 ...
 {
  $sErrorIndex = ('submit_form' == $this->NM_ajax_opcao) ? 'geral_form_tbbhpigd_old' : substr(substr($this->NM_ajax_opcao, 0, strrpos($this->NM_ajax_opcao, '_')), 6);
  $this->NM_ajax_info['errList'][$sErrorIndex][] = $error_message;
 }
;
}

$update_table  = 'tbbhpigd';      
...
$_SESSION['scriptcase']['form_tbbhpigd_old']['contr_erro'] = 'off'; 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['decimal_db'] == ",")
   {
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['parms'] = "id_?#?$this->id_?@?"; 
      }
...
//---------- 
   ...
   { 
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_tbbhpigd_old']['rows']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_tbbhpigd_old']['rows']))
      {
          $this->sc_max_reg = $_SESSION['scriptcase']['sc_apl_conf']['form_tbbhpigd_old']['rows'];
      } 
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_tbbhpigd_old']['rows_ins']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_tbbhpigd_old']['rows_ins']))
      {
          $this->sc_max_reg_incl = $_SESSION['scriptcase']['sc_apl_conf']['form_tbbhpigd_old']['rows_ins'];
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['embutida_liga_qtd_reg']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['embutida_liga_qtd_reg'])
      {
          $this->sc_max_reg = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['embutida_liga_qtd_reg'];
      }
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $GLOBALS["NM_ERRO_IBASE"] = 0;  
      $this->form_vert_form_tbbhpigd_old = array();
      if ($this->nmgp_opcao != "novo") 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['parms'] = ""; 
      } 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
      { 
          $GLOBALS["NM_ERRO_IBASE"] = 1;  
      ...
      {
          $this->nmgp_opcao = "avanca";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['reg_start'] -= $this->sc_max_reg;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['reg_start']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['reg_start']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['reg_start'] = 0;
      }
      if (isset($this->NM_where_filter))
      {
          $this->NM_where_filter = str_replace("@percent@", "%", $this->NM_where_filter);
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['total']);
          }
      }
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['where_filter'] . ")";
          }
      }
      $sc_where = "";
      if ('' != $sc_where_filter)
      ...
      if ('total' != $this->form_paginacao)
      {
          if ($this->app_is_initializing || $this->sc_teve_excl || $this->sc_teve_incl || (isset($_POST['master_nav']) && 'on' == $_POST['master_nav']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['total']))
          {
              ...
              $qt_geral_reg_form_tbbhpigd_old = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['total'] = $qt_geral_reg_form_tbbhpigd_old;
              $rt->Close();
          }
      if ((isset($_POST['master_nav']) && 'on' == $_POST['master_nav']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['total']) || $this->sc_teve_excl || $this->sc_teve_incl)
      { 
          ...
          if ($this->nmgp_opcao == "igual" && isset($this->NM_btn_navega) && 'S' == $this->NM_btn_navega && !empty($this->id_))
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['reg_start'] = $rt->fields[0];
              $rt->Close(); 
          }
      } 
      else 
      { 
          $qt_geral_reg_form_tbbhpigd_old = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['total'];
      } 
      if ($this->nmgp_opcao == "inicio" || $this->nmgp_opcao == "ordem") 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['reg_start'] = 0; 
      } 
      if ($this->nmgp_opcao == "navpage" && ($this->nmgp_ordem - 1) <= $qt_geral_reg_form_tbbhpigd_old) 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['reg_start'] = $this->nmgp_ordem - 1; 
      } 
      if ($this->nmgp_opcao == "avanca")  
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['reg_start'] += $this->sc_max_reg; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['reg_start'] > $qt_geral_reg_form_tbbhpigd_old)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['reg_start'] = $qt_geral_reg_form_tbbhpigd_old - $this->sc_max_reg; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['reg_start'] = 0; 
              }
          }
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['reg_start'] = ($qt_geral_reg_form_tbbhpigd_old + 1) - $this->sc_max_reg; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['reg_start'] < 0)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['reg_start'] = 0; 
          }
      ...
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['ordem_cmp'] != $this->nmgp_ordem)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['ordem_cmp'] = $this->nmgp_ordem; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['ordem_ord'] = ' asc'; 
          }
          elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['ordem_ord'] == ' asc')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['ordem_ord'] = ' desc'; 
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['ordem_ord'] = ' asc'; 
      ...
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['ordem_cmp'])) 
      { 
          $sc_order_by = " order by " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['ordem_cmp'] . $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['ordem_ord']; 
      } 
      ...
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['run_iframe'] == "R")
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nmgp_select; 
              $rs = $this->Db->Execute($nmgp_select) ; 
          } 
          ...
          { 
              ...
              { 
                  $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, $this->sc_max_reg, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['reg_start'] . ")" ; 
                  $rs = $this->Db->SelectLimit($nmgp_select, $this->sc_max_reg, $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['reg_start']) ; 
              } 
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
              { 
                  $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, $this->sc_max_reg, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['reg_start'] . ")" ; 
              ...
              { 
                  ...
                  if (!$rs === false && !$rs->EOF) 
                  { 
                      $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['reg_start']) ;  
                  } 
              } 
          } 
      }
          ...
          {
              $sc_seq_vert = 0; 
              if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['where_filter']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['empty_filter'] = true;
              }
          }
          else
          {
          ...
          { 
              ...
              if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['parms'])) 
              { 
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['parms'] = "id_?#?$this->id_?@?";
              } 
...
//
//-- 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['dados_select'][$sc_seq_vert] = $this->nmgp_dados_select;
              $this->nm_guardar_campos();
              $this->nm_formatar_campos();
             $this->form_vert_form_tbbhpigd_old[$sc_seq_vert]['item_'] =  $this->item_; 
             $this->form_vert_form_tbbhpigd_old[$sc_seq_vert]['satuan_'] =  $this->satuan_; 
          ...
          ksort ($this->form_vert_form_tbbhpigd_old); 
          $rs->Close(); 
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['reg_start'] < (($qt_geral_reg_form_tbbhpigd_old + 1) - $this->sc_max_reg);
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['opcao'] = '';
          }
      } 
      if ($this->nmgp_opcao == "novo") 
      { 
          ...
          elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['embutida_multi']) 
          { 
          } 
        ...
        function initializeRecordState() {
                $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['record_state'] = array();
        }

        function storeRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['record_state'])) {
                        $this->initializeRecordState();
                }
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['record_state'][$sc_seq_vert])) {
                        $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['record_state'][$sc_seq_vert] = array();
                }

                $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['record_state'][$sc_seq_vert]['buttons'] = array(
                        'delete' => $this->nmgp_botoes['delete'],
                        'update' => $this->nmgp_botoes['update']
                );
        }
        ...
        function loadRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['record_state']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['record_state'][$sc_seq_vert])) {
                        return;
                }

                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['record_state'][$sc_seq_vert]['buttons']['delete'])) {
                        $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['record_state'][$sc_seq_vert]['buttons']['delete'];
                }
                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['record_state'][$sc_seq_vert]['buttons']['update'])) {
                        $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['record_state'][$sc_seq_vert]['buttons']['update'];
                }
        }
...
$check_sql = "SELECT sum(a.currentStock)"
   . " FROM tbstockobat a left join tbdepo b on b.kodeDepo = a.depo"
   . " WHERE a.kodeItem = '".$this->item_ ."' AND (b.namaDepo = 'IGD' OR b.namaDepo = 'TROLLY EMERGENCY')";
...
$error_message = 'Stok tidak tersedia pada Stok Unit.'; 
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
   ...
   {
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['table_refresh'] = true;
   ...
   else
   {
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['table_refresh'])
        {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['csrf_token'];
    }
...
else
{
   ...
   function SC_fast_search($field, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['where_filter_form'] . " and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_form_tbbhpigd_old = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['total'] = $qt_geral_reg_form_tbbhpigd_old;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_tbbhpigd_old_pack_ajax_response();
         ...
         if (isset($Nm_datas[$campo_join]))
         {
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          {
             ...
             $nm_aspas1 = "#";
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['SC_sep_date1'];
              }
          }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "form_tbbhpigd_old_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_tbbhpigd_old_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['masterValue']))
{
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['dashboard_info']['under_dashboard']) {
?>
var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['dashboard_info']['parent_widget']; ?>']");
if (dbParentFrame && dbParentFrame[0] && dbParentFrame[0].contentWindow.scAjaxDetailValue)
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbhpigd_old']['masterValue'] as $cmp_master => $val_master)
        {
?>
