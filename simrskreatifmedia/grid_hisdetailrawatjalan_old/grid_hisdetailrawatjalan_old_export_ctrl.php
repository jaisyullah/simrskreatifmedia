<?php
@session_start() ;
$_SESSION['scriptcase']['grid_hisdetailrawatjalan_old']['sc_process_barr'] = true;
require_once('../grid_hisdetailrawatjalan_old/index.php');
unset($_SESSION['scriptcase']['grid_hisdetailrawatjalan_old']['sc_process_barr']);
$ExportCtrl = new grid_hisdetailrawatjalan_old_export_control;
$ExportCtrl->Export_barr();

class grid_hisdetailrawatjalan_old_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - Pelayanan Rawat Jalan :: Excel</TITLE>
