<?php
@session_start() ;
$_SESSION['scriptcase']['cetak_adm_ri']['sc_process_barr'] = true;
require_once('../cetak_adm_ri/index.php');
unset($_SESSION['scriptcase']['cetak_adm_ri']['sc_process_barr']);
$ExportCtrl = new cetak_adm_ri_export_control;
$ExportCtrl->Export_barr();

class cetak_adm_ri_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_chart_titl'] ?> - tbadmrawatinap :: Excel</TITLE>
