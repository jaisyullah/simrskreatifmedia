...
class cetak_adm_ri_rtf
{
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      $nm_raiz_img  = ""; 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cetak_adm_ri']['rtf_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['cetak_adm_ri']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['cetak_adm_ri']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['cetak_adm_ri']['rtf_name']);
      }
...
$_SESSION['scriptcase']['cetak_adm_ri']['contr_erro'] = 'off'; 
   ...
   {
         $this->look_sc_field_4 = html_entity_decode($this->look_sc_field_4, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         if (!NM_is_utf8($this->look_sc_field_4))
         {
             $this->look_sc_field_4 = sc_convert_encoding($this->look_sc_field_4, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->look_sc_field_4 = str_replace('<', '&lt;', $this->look_sc_field_4);
         $this->look_sc_field_4 = str_replace('>', '&gt;', $this->look_sc_field_4);
         $this->Texto_tag .= "<td>" . $this->look_sc_field_4 . "</td>\r\n";
   }
   //----- doctor
   function NM_export_doctor()
   {
         $this->doctor = html_entity_decode($this->doctor, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->doctor = strip_tags($this->doctor);
         if (!NM_is_utf8($this->doctor))
         {
             $this->doctor = sc_convert_encoding($this->doctor, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->doctor = str_replace('<', '&lt;', $this->doctor);
         $this->doctor = str_replace('>', '&gt;', $this->doctor);
         $this->Texto_tag .= "<td>" . $this->doctor . "</td>\r\n";
   }
   //----- sc_field_5
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['cetak_adm_ri']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['cetak_adm_ri']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_chart_titl'] ?> - tbadmrawatinap :: RTF</TITLE>
