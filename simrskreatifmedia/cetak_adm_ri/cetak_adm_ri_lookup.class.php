<?php
class cetak_adm_ri_lookup
{
//  
   function lookup_sc_field_4(&$conteudo) 
   {   
      return ; 
      if ($conteudo === "") 
      { 
...
//  
   function lookup_sc_field_5(&$conteudo , $sc_field_1, &$nm_array_retorno_lookup) 
   {
...
//  
   function lookup_sc_field_6(&$conteudo, &$nm_array_retorno_lookup) 
   {
      $nm_array_retorno_lookup = array();
      $conteudo = "";
      $nm_comando = "select CONCAT(date(NOW()),' ',time(NOW()));" ; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rx = $this->Db->Execute($nm_comando)) 
      { 
