<?php
@session_start() ;
$_SESSION['scriptcase']['detailLIS']['sc_process_barr'] = true;
require_once('../detailLIS/index.php');
unset($_SESSION['scriptcase']['detailLIS']['sc_process_barr']);
$ExportCtrl = new detailLIS_export_control;
$ExportCtrl->Export_barr();

class detailLIS_export_control
{
