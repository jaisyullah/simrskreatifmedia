...
class detailLIS_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['path_libs_php'] = $this->Ini->path_lib_php;
      ...
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search_change_fil")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['campos_busca'] = array(); 
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . detailLIS_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . detailLIS_pack_protect_string($Tipo_filter[0]) . "\">.." . detailLIS_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_detail')
      {
          $detail = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_detail($detail);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_alamat')
      {
          $alamat = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_alamat($alamat);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>detailLIS/detailLIS_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="detailLIS_ajax_search.js"></script>
 <script type="text/javascript" src="detailLIS_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="detailLIS_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['detailLIS']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['detailLIS']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_detail_cond#NMF#' + search_get_sel_txt('SC_detail_cond') + '@NMF@';
  str_out += 'SC_detail#NMF#' + search_get_text('SC_detail') + '@NMF@';
  str_out += 'id_ac_detail#NMF#' + search_get_text('id_ac_detail') + '@NMF@';
  ...
  str_out += 'id_ac_nama pasien#NMF#' + search_get_text('id_ac_sc_field_0') + '@NMF@';
  str_out += 'SC_lab number_cond#NMF#' + search_get_sel_txt('SC_sc_field_1_cond') + '@NMF@';
  str_out += 'SC_lab number#NMF#' + search_get_text('SC_sc_field_1') + '@NMF@';
  str_out += 'id_ac_lab number#NMF#' + search_get_text('id_ac_sc_field_1') + '@NMF@';
  str_out += 'SC_alamat_cond#NMF#' + search_get_sel_txt('SC_alamat_cond') + '@NMF@';
  str_out += 'SC_alamat#NMF#' + search_get_text('SC_alamat') + '@NMF@';
  str_out += 'id_ac_alamat#NMF#' + search_get_text('id_ac_alamat') + '@NMF@';
   ...
   $("#id_ac_detail").autocomplete({
     ...
     $.ajax({
       ...
       data: {
          ...
          nmgp_parms: "NM_ajax_opcao?#?autocomp_detail",
          max_itens: "10",
          cod_desc: "N",
   ...
   $("#id_ac_alamat").autocomplete({
     ...
     $.ajax({
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_alamat",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<?php
   ...
   function monta_form()
   {
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          $detail = $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['campos_busca']['detail']; 
          $detail_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['campos_busca']['detail_cond']; 
          $sc_field_0 = $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['campos_busca']['sc_field_0']; 
          $sc_field_0_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['campos_busca']['sc_field_0_cond']; 
          $sc_field_1 = $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['campos_busca']['sc_field_1']; 
          $sc_field_1_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['campos_busca']['sc_field_1_cond']; 
          $alamat = $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['campos_busca']['alamat']; 
          $alamat_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['campos_busca']['alamat_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['campos_busca']['NM_operador']; 
      } 
      if (!isset($detail_cond) || empty($detail_cond))
      {
         $detail_cond = "qp";
      }
      ...
      if (!isset($alamat_cond) || empty($alamat_cond))
      {
         $alamat_cond = "qp";
      }
      ...
      $str_hide_detail = (in_array($detail_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      $str_hide_alamat = (in_array($alamat_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      {
         $tmp_pos = strpos($detail, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $detail = substr($detail, 0, $tmp_pos);
         }
      }
      ...
      {
         $tmp_pos = strpos($alamat, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $alamat = substr($alamat, 0, $tmp_pos);
         }
      }
?>
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_detail_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['detail'])) ? $this->New_label['detail'] : "Detail"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_detail_cond" name="detail_cond" onChange="nm_campos_between(document.getElementById('id_vis_detail'), this, 'detail')">
       <OPTION value="qp" <?php if ("qp" == $detail_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $detail_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $detail_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $detail_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_detail" <?php echo $str_hide_detail?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['detail'])) ? $this->New_label['detail'] : "Detail";
 $nmgp_tab_label .= "detail?#?" . $SC_Label . "?@?";
...
<?php
      ...
      {
          $sAutocompValue = $detail;
      }
?>
<INPUT  type="text" id="SC_detail" name="detail" value="<?php echo NM_encode_input($detail) ?>"  size=10 alt="{datatype: 'text', maxLength: 10, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_detail" name="detail_autocomp" size="10"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 10, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
?>
<INPUT  type="text" id="SC_sc_field_0" name="sc_field_0" value="<?php echo NM_encode_input($sc_field_0) ?>"  size=10 alt="{datatype: 'text', maxLength: 10, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_sc_field_0" name="sc_field_0_autocomp" size="10"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 10, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_sc_field_1_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['sc_field_1'])) ? $this->New_label['sc_field_1'] : "Lab Number"; ?></TD>
     <TD class="scFilterFieldOdd"> 
...
?>
<INPUT  type="text" id="SC_sc_field_1" name="sc_field_1" value="<?php echo NM_encode_input($sc_field_1) ?>"  size=10 alt="{datatype: 'text', maxLength: 10, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_sc_field_1" name="sc_field_1_autocomp" size="10"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 10, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_alamat_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['alamat'])) ? $this->New_label['alamat'] : "Alamat"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_alamat_cond" name="alamat_cond" onChange="nm_campos_between(document.getElementById('id_vis_alamat'), this, 'alamat')">
       <OPTION value="qp" <?php if ("qp" == $alamat_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $alamat_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $alamat_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $alamat_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_alamat" <?php echo $str_hide_alamat?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['alamat'])) ? $this->New_label['alamat'] : "Alamat";
 $nmgp_tab_label .= "alamat?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      {
          $sAutocompValue = $alamat;
      }
?>
<INPUT  type="text" id="SC_alamat" name="alamat" value="<?php echo NM_encode_input($alamat) ?>"  size=10 alt="{datatype: 'text', maxLength: 10, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_alamat" name="alamat_autocomp" size="10"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 10, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if ($_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['detailLIS']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['detailLIS']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.detail_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_detail'), document.F1.detail_cond, 'detail');
   document.F1.detail.value = "";
   document.F1.detail_autocomp.value = "";
   ...
   document.F1.alamat_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_alamat'), document.F1.alamat_cond, 'alamat');
   document.F1.alamat.value = "";
   document.F1.alamat_autocomp.value = "";
 }
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['where_orig']))
      {
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['where_orig'];
      }
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_detail_cond'] = 'cond';
      $tp_fields['SC_detail'] = 'text_aut';
      $tp_fields['id_ac_detail'] = 'text_aut';
      ...
      $tp_fields['SC_alamat_cond'] = 'cond';
      $tp_fields['SC_alamat'] = 'text_aut';
      $tp_fields['id_ac_alamat'] = 'text_aut';
      ...
      $tb_fields_esp['text_aut'] = 'id_ac_nama pasien';
      $tb_fields_esp['id_ac_nama pasien'] = 'id_ac_sc_field_0';
      $tb_fields_esp['SC_lab number_cond'] = 'SC_sc_field_1_cond';
      $tb_fields_esp['SC_lab number'] = 'SC_sc_field_1';
      $tb_fields_esp['text_aut'] = 'id_ac_lab number';
      $tb_fields_esp['id_ac_lab number'] = 'id_ac_sc_field_1';
      if (is_file($NM_patch))
      {
          $SC_V8    = false;
   ...
   {
      global $detail_cond, $detail, $detail_autocomp,
             $sc_field_0_cond, $sc_field_0, $sc_field_0_autocomp,
             $sc_field_1_cond, $sc_field_1, $sc_field_1_autocomp,
             $alamat_cond, $alamat, $alamat_autocomp, $nmgp_tab_label;
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['campos_busca'] as $Cmps => $Vals)
          {
              $$Cmps = $Vals;
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['grid_pesq'] = array();
      if (!empty($detail_autocomp) && empty($detail))
      {
          $detail = $detail_autocomp;
      }
      ...
      if (!empty($alamat_autocomp) && empty($alamat))
      {
          $alamat = $alamat_autocomp;
      }
      $detail_cond_salva = $detail_cond; 
      if (!isset($detail_input_2) || $detail_input_2 == "")
      {
          $detail_input_2 = $detail;
      }
      ...
      $alamat_cond_salva = $alamat_cond; 
      if (!isset($alamat_input_2) || $alamat_input_2 == "")
      {
          $alamat_input_2 = $alamat;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['Grid_search']  = array(); 
      $I_Grid = 0;
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['campos_busca']['detail'] = $detail; 
      if (is_array($detail) && !empty($detail))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['Grid_search'][$I_Grid]['val'][0] = $detail;
      }
      elseif ($detail_cond_salva == "nu" || $detail_cond_salva == "nn" || $detail_cond_salva == "ep" || $detail_cond_salva == "ne" || !empty($detail))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['Grid_search'][$I_Grid]['val'][0][0] = $detail;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['campos_busca']['detail_cond'] = $detail_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['Grid_search'][$I_Grid]['cmp'] = "detail"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['Grid_search'][$I_Grid]['opc'] = $detail_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['grid_pesq']['detail'] = $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['campos_busca']['sc_field_0'] = $sc_field_0; 
      if (is_array($sc_field_0) && !empty($sc_field_0))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['Grid_search'][$I_Grid]['val'][0] = $sc_field_0;
      }
      ...
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['Grid_search'][$I_Grid]['val'][0][0] = $sc_field_0;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['campos_busca']['sc_field_0_cond'] = $sc_field_0_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['Grid_search'][$I_Grid]['cmp'] = "sc_field_0"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['Grid_search'][$I_Grid]['opc'] = $sc_field_0_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['grid_pesq']['sc_field_0'] = $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['campos_busca']['sc_field_1'] = $sc_field_1; 
      if (is_array($sc_field_1) && !empty($sc_field_1))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['Grid_search'][$I_Grid]['val'][0] = $sc_field_1;
      }
      ...
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['Grid_search'][$I_Grid]['val'][0][0] = $sc_field_1;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['campos_busca']['sc_field_1_cond'] = $sc_field_1_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['Grid_search'][$I_Grid]['cmp'] = "sc_field_1"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['Grid_search'][$I_Grid]['opc'] = $sc_field_1_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['grid_pesq']['sc_field_1'] = $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['campos_busca']['alamat'] = $alamat; 
      if (is_array($alamat) && !empty($alamat))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['Grid_search'][$I_Grid]['val'][0] = $alamat;
      }
      elseif ($alamat_cond_salva == "nu" || $alamat_cond_salva == "nn" || $alamat_cond_salva == "ep" || $alamat_cond_salva == "ne" || !empty($alamat))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['Grid_search'][$I_Grid]['val'][0][0] = $alamat;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['campos_busca']['alamat_cond'] = $alamat_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['Grid_search'][$I_Grid]['cmp'] = "alamat"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['Grid_search'][$I_Grid]['opc'] = $alamat_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['grid_pesq']['alamat'] = $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['detail'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['detail'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['detail'] = $detail;
      }
      $sc_field_0_look = substr($this->Db->qstr($sc_field_0), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct `Nama Pasien` from (select '' as Detail, '' as 'Nama Pasien', '' as 'Lab Number', '' as Alamat) nm_sel_esp where `Nama Pasien` = '$sc_field_0_look'"; 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['alamat'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['alamat'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['alamat'] = $alamat;
      }

      //----- $detail
      $this->Date_part = false;
      if (isset($detail) || $detail_cond == "nu" || $detail_cond == "nn" || $detail_cond == "ep" || $detail_cond == "ne")
      {
         $this->monta_condicao("Detail", $detail_cond, $detail, "", "detail");
      }
      ...
      {
         $this->monta_condicao("`Nama Pasien`", $sc_field_0_cond, $sc_field_0, "", "sc_field_0");
      }
      ...
      {
         $this->monta_condicao("`Lab Number`", $sc_field_1_cond, $sc_field_1, "", "sc_field_1");
      }

      //----- $alamat
      $this->Date_part = false;
      if (isset($alamat) || $alamat_cond == "nu" || $alamat_cond == "nn" || $alamat_cond == "ep" || $alamat_cond == "ne")
      {
         $this->monta_condicao("Alamat", $alamat_cond, $alamat, "", "alamat");
      }
   }
   ...
   function finaliza_resultado_ajax()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['where_pesq'] = $this->comando;
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['where_pesq_fast'])) 
       {
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['where_pesq'])) 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['where_pesq_fast'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['where_pesq'] = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['where_pesq_fast'] . ")";
           }
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['cond_dyn_search'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['detailLIS']['cond_pesq'] .= $this->NM_operador;
