...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_detail_cond" name="detail_cond" onChange="nm_campos_between(document.getElementById('id_vis_detail'), this, 'detail')">
      ...
      <br><span id="id_hide_detail"  <?php echo $str_hide_detail?>><?php
      if ($detail != "")
      {
      $detail_look = substr($this->Db->qstr($detail), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_alamat_cond" name="alamat_cond" onChange="nm_campos_between(document.getElementById('id_vis_alamat'), this, 'alamat')">
      ...
      <br><span id="id_hide_alamat"  <?php echo $str_hide_alamat?>><?php
      if ($alamat != "")
      {
      $alamat_look = substr($this->Db->qstr($alamat), 1, -1); 
      $nmgp_def_dados = array(); 
