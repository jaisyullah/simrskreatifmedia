...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_lap_demo_top_diag_ri"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_lap_demo_top_diag_ri"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_lap_demo_top_diag_ri']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_lap_demo_top_diag_ri']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_lap_demo_top_diag_ri']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_lap_demo_top_diag_ri']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_lap_demo_top_diag_ri']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_lap_demo_top_diag_ri</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_lap_demo_top_diag_ri']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_lap_demo_top_diag_ri']['embutida_filho'] as $ind => $sc_init)
          {
