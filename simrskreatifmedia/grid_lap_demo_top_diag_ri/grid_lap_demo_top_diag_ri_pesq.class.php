...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_diagnosa1" name="diagnosa1_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_icd1_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['icd1'])) ? $this->New_label['icd1'] : "ICD 10"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_icd1_cond" name="icd1_cond" onChange="nm_campos_between(document.getElementById('id_vis_icd1'), this, 'icd1')">
...
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_icd1" name="icd1_autocomp" size="25"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 25, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_count_2_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['count_2'])) ? $this->New_label['count_2'] : "Jumlah"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_count_2_cond" name="count_2_cond" onChange="nm_campos_between(document.getElementById('id_vis_count_2'), this, 'count_2')">
     ...
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_count_2" <?php echo $str_hide_count_2?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
...
?>
<INPUT  type="text" id="SC_count_2" name="count_2" value="<?php echo NM_encode_input($count_2) ?>" size=19 alt="{datatype: 'integer', maxLength: 19, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
