  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbadministrasi" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbadministrasi_form();
	}

  // ---------- Validate biayaadm
  function do_ajax_form_tbadministrasi_validate_biayaadm()
  {
    var nomeCampo_biayaadm = "biayaadm";
    var var_biayaadm = scAjaxGetFieldText(nomeCampo_biayaadm);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbadministrasi_validate_biayaadm(var_biayaadm, var_script_case_init, do_ajax_form_tbadministrasi_validate_biayaadm_cb);
  } // do_ajax_form_tbadministrasi_validate_biayaadm

  function do_ajax_form_tbadministrasi_validate_biayaadm_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbadministrasi_validate_biayaadm_cb

  // ---------- Validate tarifadm
  function do_ajax_form_tbadministrasi_validate_tarifadm()
  {
    var nomeCampo_tarifadm = "tarifadm";
    var var_tarifadm = scAjaxGetFieldText(nomeCampo_tarifadm);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbadministrasi_validate_tarifadm(var_tarifadm, var_script_case_init, do_ajax_form_tbadministrasi_validate_tarifadm_cb);
  } // do_ajax_form_tbadministrasi_validate_tarifadm

  function do_ajax_form_tbadministrasi_validate_tarifadm_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbadministrasi_validate_tarifadm_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tbadministrasi_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tbadministrasi_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_tbadministrasi_submit_form(var_biayaadm, var_tarifadm, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbadministrasi_submit_form_cb);
  } // do_ajax_form_tbadministrasi_submit_form

  function do_ajax_form_tbadministrasi_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tbadministrasi_submit_form_cb_after_alert);
  } // do_ajax_form_tbadministrasi_submit_form_cb
  function do_ajax_form_tbadministrasi_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbadministrasi_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tbadministrasi_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_tbadministrasi_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbadministrasi_navigate_form_cb);
  } // do_ajax_form_tbadministrasi_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbadministrasi']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbadministrasi_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbadministrasi_navigate_form_cb_after_alert);
  } // do_ajax_form_tbadministrasi_navigate_form_cb
  function do_ajax_form_tbadministrasi_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_tbadministrasi_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_tbadministrasi_navigate_form_cb_after_alert
  function sc_hide_form_tbadministrasi_form()
  {
