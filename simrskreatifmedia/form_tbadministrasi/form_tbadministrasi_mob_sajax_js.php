  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbadministrasi_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbadministrasi_mob_form();
	}

  // ---------- Validate biayaadm
  function do_ajax_form_tbadministrasi_mob_validate_biayaadm()
  {
    var nomeCampo_biayaadm = "biayaadm";
    var var_biayaadm = scAjaxGetFieldText(nomeCampo_biayaadm);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbadministrasi_mob_validate_biayaadm(var_biayaadm, var_script_case_init, do_ajax_form_tbadministrasi_mob_validate_biayaadm_cb);
  } // do_ajax_form_tbadministrasi_mob_validate_biayaadm

  function do_ajax_form_tbadministrasi_mob_validate_biayaadm_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "biayaadm";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbadministrasi_mob_validate_biayaadm_cb

  // ---------- Validate tarifadm
  function do_ajax_form_tbadministrasi_mob_validate_tarifadm()
  {
    var nomeCampo_tarifadm = "tarifadm";
    var var_tarifadm = scAjaxGetFieldText(nomeCampo_tarifadm);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbadministrasi_mob_validate_tarifadm(var_tarifadm, var_script_case_init, do_ajax_form_tbadministrasi_mob_validate_tarifadm_cb);
  } // do_ajax_form_tbadministrasi_mob_validate_tarifadm

  function do_ajax_form_tbadministrasi_mob_validate_tarifadm_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tarifadm";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbadministrasi_mob_validate_tarifadm_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tbadministrasi_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tbadministrasi_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_biayaadm = scAjaxGetFieldText("biayaadm");
    var var_tarifadm = scAjaxGetFieldText("tarifadm");
    ...
    scAjaxProcOn();
    x_ajax_form_tbadministrasi_mob_submit_form(var_biayaadm, var_tarifadm, var_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbadministrasi_mob_submit_form_cb);
  } // do_ajax_form_tbadministrasi_mob_submit_form

  function do_ajax_form_tbadministrasi_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("biayaadm");
      scAjaxHideErrorDisplay("tarifadm");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tbadministrasi_mob_submit_form_cb_after_alert);
  } // do_ajax_form_tbadministrasi_mob_submit_form_cb
  function do_ajax_form_tbadministrasi_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbadministrasi_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tbadministrasi_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_tbadministrasi_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbadministrasi_mob_navigate_form_cb);
  } // do_ajax_form_tbadministrasi_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbadministrasi_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbadministrasi_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbadministrasi_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_tbadministrasi_mob_navigate_form_cb
  function do_ajax_form_tbadministrasi_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_tbadministrasi_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_tbadministrasi_mob_navigate_form_cb_after_alert
  function sc_hide_form_tbadministrasi_mob_form()
  {
  ...
  ajax_field_list[0] = "biayaadm";
  ajax_field_list[1] = "tarifadm";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "biayaadm": {"label": "Biaya Adm", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "tarifadm": {"label": "Tarif Adm", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  ajax_field_mult["biayaadm"][1] = "biayaadm";
  ajax_field_mult["tarifadm"][1] = "tarifadm";

  var ajax_field_id = {
    "biayaadm": new Array("hidden_field_label_biayaadm", "hidden_field_data_biayaadm"),
    "tarifadm": new Array("hidden_field_label_tarifadm", "hidden_field_data_tarifadm")
  };
