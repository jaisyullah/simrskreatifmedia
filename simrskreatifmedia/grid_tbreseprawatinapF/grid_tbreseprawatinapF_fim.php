...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_tbreseprawatinapF"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_tbreseprawatinapF"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_tbreseprawatinapF'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tbreseprawatinapF']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_tbreseprawatinapF']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tbreseprawatinapF']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_tbreseprawatinapF']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_tbreseprawatinapF']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_tbreseprawatinapF</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_tbreseprawatinapF']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_tbreseprawatinapF']['embutida_filho'] as $ind => $sc_init)
          {
