...
<?php
   ...
   $Ord_Cmp = new grid_tbreseprawatinapF_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_tbreseprawatinapF_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbreseprawatinapF']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tbreseprawatinapF']['ordem_select_orig'] = array();
   }
   ...
   if ($use_alias == "S")
   {
       $tab_def_campos['no'] = "sc_def_col_1";
   }
   else
   {
       $tab_def_campos['no'] = "`No`";
   }
   $tab_labels["no"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbreseprawatinapF']['labels']["no"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbreseprawatinapF']['labels']["no"] : "No";
   ...
   {
       $tab_def_campos['sc_field_0'] = "`Kode Transaksi`";
   }
   $tab_labels["sc_field_0"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbreseprawatinapF']['labels']["sc_field_0"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbreseprawatinapF']['labels']["sc_field_0"] : "Kode Transaksi";
   ...
   {
       $tab_def_campos['sc_field_1'] = "`No Struk`";
   }
   $tab_labels["sc_field_1"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbreseprawatinapF']['labels']["sc_field_1"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbreseprawatinapF']['labels']["sc_field_1"] : "No Struk";
   ...
   {
       $tab_def_campos['sc_field_2'] = "`Tgl Transaksi`";
   }
   $tab_labels["sc_field_2"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbreseprawatinapF']['labels']["sc_field_2"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbreseprawatinapF']['labels']["sc_field_2"] : "Tgl Transaksi";
   $tab_ger_campos['validasi'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['validasi'] = "Validasi";
   }
   else
   {
       $tab_def_campos['validasi'] = "";
   }
   $tab_labels["validasi"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbreseprawatinapF']['labels']["validasi"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbreseprawatinapF']['labels']["validasi"] : "Validasi";
   $tab_ger_campos['tambah'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['tambah'] = "Tambah";
   }
   else
   {
       $tab_def_campos['tambah'] = "";
   }
   $tab_labels["tambah"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbreseprawatinapF']['labels']["tambah"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbreseprawatinapF']['labels']["tambah"] : "Tambah";
   $tab_ger_campos['validasi'] = "none";
   $tab_ger_campos['tambah'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_tbreseprawatinapF']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_tbreseprawatinapF']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_tbreseprawatinapF']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbreseprawatinapF']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tbreseprawatinapF']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_tbreseprawatinapF']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_tbreseprawatinapF']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_tbreseprawatinapF']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_tbreseprawatinapF']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_tbreseprawatinapF_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_tbreseprawatinapF']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_tbreseprawatinapF']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_tbreseprawatinapF']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_tbreseprawatinapF']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_tbreseprawatinapF']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
