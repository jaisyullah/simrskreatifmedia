<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tbreseprawatinapF']['sc_process_barr'] = true;
require_once('../grid_tbreseprawatinapF/index.php');
unset($_SESSION['scriptcase']['grid_tbreseprawatinapF']['sc_process_barr']);
$ExportCtrl = new grid_tbreseprawatinapF_export_control;
$ExportCtrl->Export_barr();

class grid_tbreseprawatinapF_export_control
{
