<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tbpaymentri']['sc_process_barr'] = true;
require_once('../grid_tbpaymentri/index.php');
unset($_SESSION['scriptcase']['grid_tbpaymentri']['sc_process_barr']);
$ExportCtrl = new grid_tbpaymentri_export_control;
$ExportCtrl->Export_barr();

class grid_tbpaymentri_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - Pembayaran RI :: Excel</TITLE>
