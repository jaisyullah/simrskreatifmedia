  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbdetailresepokvk_inline" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbdetailresepokvk_inline_form();
	}

  // ---------- Validate item_
  function do_ajax_form_tbdetailresepokvk_inline_validate_item_()
  {
  } // do_ajax_form_tbdetailresepokvk_inline_validate_item_

  function do_ajax_form_tbdetailresepokvk_inline_validate_item__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdetailresepokvk_inline_validate_item__cb

  // ---------- Validate jumlah_
  function do_ajax_form_tbdetailresepokvk_inline_validate_jumlah_()
  {
    var nomeCampo_jumlah_ = "jumlah_";
    var var_jumlah_ = scAjaxGetFieldText(nomeCampo_jumlah_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdetailresepokvk_inline_validate_jumlah_(var_jumlah_, var_script_case_init, do_ajax_form_tbdetailresepokvk_inline_validate_jumlah__cb);
  } // do_ajax_form_tbdetailresepokvk_inline_validate_jumlah_

  function do_ajax_form_tbdetailresepokvk_inline_validate_jumlah__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "jumlah_";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdetailresepokvk_inline_validate_jumlah__cb

  // ---------- Validate terpakai_
  function do_ajax_form_tbdetailresepokvk_inline_validate_terpakai_()
  {
    var nomeCampo_terpakai_ = "terpakai_";
    var var_terpakai_ = scAjaxGetFieldText(nomeCampo_terpakai_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdetailresepokvk_inline_validate_terpakai_(var_terpakai_, var_script_case_init, do_ajax_form_tbdetailresepokvk_inline_validate_terpakai__cb);
  } // do_ajax_form_tbdetailresepokvk_inline_validate_terpakai_

  function do_ajax_form_tbdetailresepokvk_inline_validate_terpakai__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdetailresepokvk_inline_validate_terpakai__cb

  // ---------- Validate satuan_
  function do_ajax_form_tbdetailresepokvk_inline_validate_satuan_()
  {
    var nomeCampo_satuan_ = "satuan_";
    var var_satuan_ = scAjaxGetFieldSelect(nomeCampo_satuan_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdetailresepokvk_inline_validate_satuan_(var_satuan_, var_script_case_init, do_ajax_form_tbdetailresepokvk_inline_validate_satuan__cb);
  } // do_ajax_form_tbdetailresepokvk_inline_validate_satuan_

  function do_ajax_form_tbdetailresepokvk_inline_validate_satuan__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "satuan_";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdetailresepokvk_inline_validate_satuan__cb

  // ---------- Validate diskon_
  function do_ajax_form_tbdetailresepokvk_inline_validate_diskon_()
  {
    var nomeCampo_diskon_ = "diskon_";
    var var_diskon_ = scAjaxGetFieldText(nomeCampo_diskon_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdetailresepokvk_inline_validate_diskon_(var_diskon_, var_script_case_init, do_ajax_form_tbdetailresepokvk_inline_validate_diskon__cb);
  } // do_ajax_form_tbdetailresepokvk_inline_validate_diskon_

  function do_ajax_form_tbdetailresepokvk_inline_validate_diskon__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "diskon_";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdetailresepokvk_inline_validate_diskon__cb

  // ---------- Validate signa_
  function do_ajax_form_tbdetailresepokvk_inline_validate_signa_()
  {
  } // do_ajax_form_tbdetailresepokvk_inline_validate_signa_

  function do_ajax_form_tbdetailresepokvk_inline_validate_signa__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "signa_";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdetailresepokvk_inline_validate_signa__cb

  // ---------- Validate trandate_
  function do_ajax_form_tbdetailresepokvk_inline_validate_trandate_()
  {
    var nomeCampo_trandate_ = "trandate_";
    var var_trandate_ = scAjaxGetFieldText(nomeCampo_trandate_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdetailresepokvk_inline_validate_trandate_(var_trandate_, var_script_case_init, do_ajax_form_tbdetailresepokvk_inline_validate_trandate__cb);
  } // do_ajax_form_tbdetailresepokvk_inline_validate_trandate_

  function do_ajax_form_tbdetailresepokvk_inline_validate_trandate__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdetailresepokvk_inline_validate_trandate__cb

  // ---------- Validate id_
  function do_ajax_form_tbdetailresepokvk_inline_validate_id_()
  {
    var nomeCampo_id_ = "id_";
    var var_id_ = scAjaxGetFieldHidden(nomeCampo_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdetailresepokvk_inline_validate_id_(var_id_, var_script_case_init, do_ajax_form_tbdetailresepokvk_inline_validate_id__cb);
  } // do_ajax_form_tbdetailresepokvk_inline_validate_id_

  function do_ajax_form_tbdetailresepokvk_inline_validate_id__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id_";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdetailresepokvk_inline_validate_id__cb

  // ---------- Validate stok_
  function do_ajax_form_tbdetailresepokvk_inline_validate_stok_()
  {
    var nomeCampo_stok_ = "stok_";
    var var_stok_ = scAjaxGetFieldText(nomeCampo_stok_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdetailresepokvk_inline_validate_stok_(var_stok_, var_script_case_init, do_ajax_form_tbdetailresepokvk_inline_validate_stok__cb);
  } // do_ajax_form_tbdetailresepokvk_inline_validate_stok_

  function do_ajax_form_tbdetailresepokvk_inline_validate_stok__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "stok_";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdetailresepokvk_inline_validate_stok__cb

  // ---------- Refresh item_
  function do_ajax_form_tbdetailresepokvk_inline_refresh_item_()
  {
    var var_item_ = scAjaxGetFieldText("item_");
    var var_trancode_ = scAjaxGetFieldText("trancode_");
    var var_nmgp_refresh_fields = "satuan__#fld#_stok_";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tbdetailresepokvk_inline_refresh_item_(var_item_, var_trancode_, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_tbdetailresepokvk_inline_refresh_item__cb);
  } // do_ajax_form_tbdetailresepokvk_inline_refresh_item_

  function do_ajax_form_tbdetailresepokvk_inline_refresh_item__cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdetailresepokvk_inline_refresh_item__cb

  // ---------- Event onchange item_
  function do_ajax_form_tbdetailresepokvk_inline_event_item__onchange()
  {
    var var_stok_ = "";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tbdetailresepokvk_inline_event_item__onchange(var_stok_, var_script_case_init, do_ajax_form_tbdetailresepokvk_inline_event_item__onchange_cb);
  } // do_ajax_form_tbdetailresepokvk_inline_event_item__onchange

  function do_ajax_form_tbdetailresepokvk_inline_event_item__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "item_";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_tbdetailresepokvk_inline_event_item__onchange_cb_after_alert);
  } // do_ajax_form_tbdetailresepokvk_inline_event_item__onchange_cb
  function do_ajax_form_tbdetailresepokvk_inline_event_item__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    do_ajax_form_tbdetailresepokvk_inline_refresh_item_();
    scAjaxRedir();
  } // do_ajax_form_tbdetailresepokvk_inline_event_item__onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tbdetailresepokvk_inline_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tbdetailresepokvk_inline_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_item_ = scAjaxGetFieldText("item_");
    ...
    var var_signa_ = scAjaxGetFieldText("signa_");
    ...
    scAjaxProcOn();
    x_ajax_form_tbdetailresepokvk_inline_submit_form(var_item_, var_jumlah_, var_terpakai_, var_satuan_, var_diskon_, var_signa_, var_trandate_, var_id_, var_stok_, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbdetailresepokvk_inline_submit_form_cb);
  } // do_ajax_form_tbdetailresepokvk_inline_submit_form

  function do_ajax_form_tbdetailresepokvk_inline_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tbdetailresepokvk_inline_submit_form_cb_after_alert);
  } // do_ajax_form_tbdetailresepokvk_inline_submit_form_cb
  function do_ajax_form_tbdetailresepokvk_inline_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbdetailresepokvk_inline_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tbdetailresepokvk_inline_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tbdetailresepokvk_inline_navigate_form(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbdetailresepokvk_inline_navigate_form_cb);
  } // do_ajax_form_tbdetailresepokvk_inline_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailresepokvk_inline']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbdetailresepokvk_inline_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbdetailresepokvk_inline_navigate_form_cb_after_alert);
  } // do_ajax_form_tbdetailresepokvk_inline_navigate_form_cb
  function do_ajax_form_tbdetailresepokvk_inline_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_tbdetailresepokvk_inline_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_tbdetailresepokvk_inline_navigate_form_cb_after_alert
  function sc_hide_form_tbdetailresepokvk_inline_form()
  {
  ...
  var ajax_error_list = {
    ...
    "stok_": {"label": "STOK", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_id = {
    ...
    "stok_": new Array("hidden_field_label_stok_", "hidden_field_data_stok_")
  };
