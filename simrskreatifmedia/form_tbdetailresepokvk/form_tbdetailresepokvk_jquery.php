...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_id_' + iSeqRow).bind('blur', function() { sc_form_tbdetailresepokvk_id__onblur(this, iSeqRow) })
                                 .bind('change', function() { sc_form_tbdetailresepokvk_id__onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_satuan_' + iSeqRow).bind('blur', function() { sc_form_tbdetailresepokvk_satuan__onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_form_tbdetailresepokvk_satuan__onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_jumlah_' + iSeqRow).bind('blur', function() { sc_form_tbdetailresepokvk_jumlah__onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_form_tbdetailresepokvk_jumlah__onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_terpakai_' + iSeqRow).bind('blur', function() { sc_form_tbdetailresepokvk_terpakai__onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_form_tbdetailresepokvk_terpakai__onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_signa_' + iSeqRow).bind('blur', function() { sc_form_tbdetailresepokvk_signa__onblur(this, iSeqRow) })
                                    .bind('change', function() { sc_form_tbdetailresepokvk_signa__onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_trandate_' + iSeqRow).bind('blur', function() { sc_form_tbdetailresepokvk_trandate__onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_form_tbdetailresepokvk_trandate__onchange(this, iSeqRow) })
                                       .bind('focus', function() { sc_form_tbdetailresepokvk_trandate__onfocus(this, iSeqRow) });
  $('#id_sc_field_trandate__hora' + iSeqRow).bind('blur', function() { sc_form_tbdetailresepokvk_trandate__hora_onblur(this, iSeqRow) })
                                            .bind('change', function() { sc_form_tbdetailresepokvk_trandate__hora_onchange(this, iSeqRow) })
                                            .bind('focus', function() { sc_form_tbdetailresepokvk_trandate__hora_onfocus(this, iSeqRow) });
  $('#id_sc_field_diskon_' + iSeqRow).bind('blur', function() { sc_form_tbdetailresepokvk_diskon__onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_form_tbdetailresepokvk_diskon__onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_stok_' + iSeqRow).bind('blur', function() { sc_form_tbdetailresepokvk_stok__onblur(this, iSeqRow) })
                                   .bind('change', function() { sc_form_tbdetailresepokvk_stok__onchange(this, iSeqRow) })
...
function sc_form_tbdetailresepokvk_id__onblur(oThis, iSeqRow) {
  do_ajax_form_tbdetailresepokvk_validate_id_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_tbdetailresepokvk_id__onchange(oThis, iSeqRow) {
...
function sc_form_tbdetailresepokvk_item__onblur(oThis, iSeqRow) {
  do_ajax_form_tbdetailresepokvk_validate_item_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_tbdetailresepokvk_item__onchange(oThis, iSeqRow) {
  do_ajax_form_tbdetailresepokvk_event_item__onchange(iSeqRow);
  nm_check_insert(iSeqRow);
}
...
function sc_form_tbdetailresepokvk_satuan__onblur(oThis, iSeqRow) {
  do_ajax_form_tbdetailresepokvk_validate_satuan_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_tbdetailresepokvk_satuan__onchange(oThis, iSeqRow) {
  nm_check_insert(iSeqRow);
}
...
function sc_form_tbdetailresepokvk_jumlah__onblur(oThis, iSeqRow) {
  do_ajax_form_tbdetailresepokvk_validate_jumlah_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_tbdetailresepokvk_jumlah__onchange(oThis, iSeqRow) {
  nm_check_insert(iSeqRow);
}
...
function sc_form_tbdetailresepokvk_terpakai__onblur(oThis, iSeqRow) {
  do_ajax_form_tbdetailresepokvk_validate_terpakai_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_tbdetailresepokvk_terpakai__onchange(oThis, iSeqRow) {
  nm_check_insert(iSeqRow);
}
...
function sc_form_tbdetailresepokvk_signa__onblur(oThis, iSeqRow) {
  do_ajax_form_tbdetailresepokvk_validate_signa_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_tbdetailresepokvk_signa__onchange(oThis, iSeqRow) {
  nm_check_insert(iSeqRow);
}
...
function sc_form_tbdetailresepokvk_trandate__onblur(oThis, iSeqRow) {
  do_ajax_form_tbdetailresepokvk_validate_trandate_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_tbdetailresepokvk_trandate__hora_onblur(oThis, iSeqRow) {
  do_ajax_form_tbdetailresepokvk_validate_trandate_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_tbdetailresepokvk_trandate__onchange(oThis, iSeqRow) {
  nm_check_insert(iSeqRow);
}

function sc_form_tbdetailresepokvk_trandate__hora_onchange(oThis, iSeqRow) {
  nm_check_insert(iSeqRow);
}
...
function sc_form_tbdetailresepokvk_trandate__hora_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_form_tbdetailresepokvk_diskon__onblur(oThis, iSeqRow) {
  do_ajax_form_tbdetailresepokvk_validate_diskon_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_tbdetailresepokvk_diskon__onchange(oThis, iSeqRow) {
  nm_check_insert(iSeqRow);
}
...
function sc_form_tbdetailresepokvk_stok__onblur(oThis, iSeqRow) {
  do_ajax_form_tbdetailresepokvk_validate_stok_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_tbdetailresepokvk_stok__onchange(oThis, iSeqRow) {
  nm_check_insert(iSeqRow);
}
...
function scHidePage(pageNo) {
	$("#id_form_tbdetailresepokvk_form" + pageNo).hide();
}
