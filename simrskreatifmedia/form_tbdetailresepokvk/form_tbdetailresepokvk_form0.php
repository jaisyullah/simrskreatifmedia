<?php
class form_tbdetailresepokvk_form extends form_tbdetailresepokvk_apl
{
function Form_Init()
{
...
<?php
if ($this->Embutida_form && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailresepokvk']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailresepokvk']['sc_modal'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailresepokvk']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailresepokvk']['sc_redir_atualiz'] == 'ok')
{
?>
...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailresepokvk']['embutida_pdf']))
 {
 ?>
...
<?php
include_once("form_tbdetailresepokvk_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_tbdetailresepokvk_jquery.php');
...
?>
 ...
 function addAutocomplete(elem) {
  ...
  $(".sc-ui-autocomp-item_", elem).on("focus", function() {
   ...
   width: "250px",
   ajax: {
    url: "form_tbdetailresepokvk.php",
    dataType: "json",
   ...
   var sId = $(this).attr("id").substr(6), sRow = "item_" != sId ? sId.substr(5) : "";
   sc_form_tbdetailresepokvk_item__onfocus("id_sc_field_" + sId, sRow);
  ...
  var iSeq_signa_ = $(".sc-ui-autocomp-signa_", elem).attr("id").substr(12);
  ...
  $(".sc-ui-autocomp-signa_", elem).on("focus", function() {
   ...
   var sId = $(this).attr("id").substr(6), sRow = "signa_" != sId ? sId.substr(6) : "";
   sc_form_tbdetailresepokvk_signa__onfocus("id_sc_field_" + sId, sRow);
  }).on("select2:close", function(e) {
   var sId = $(this).attr("id").substr(6);
   $("#id_sc_field_" + sId).trigger("blur");
  }).on("select2:select", function(e) {
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailresepokvk']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailresepokvk']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailresepokvk']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailresepokvk']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailresepokvk']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailresepokvk']['recarga'];
}
if ('novo' == $opcao_botoes && $this->Embutida_form)
{
    $opcao_botoes = 'inicio';
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailresepokvk']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailresepokvk']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
?>
...
<?php
 include_once("form_tbdetailresepokvk_js0.php");
?>
<script type="text/javascript"> 
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_tbdetailresepokvk'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_tbdetailresepokvk'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailresepokvk']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailresepokvk']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailresepokvk']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailresepokvk']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailresepokvk']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<div class="scFormHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFormHeaderFont" style="float: left; text-transform: uppercase;"><?php if ($this->nmgp_opcao == "novo") { echo "" . $this->Ini->Nm_lang['lang_othr_frmi_title'] . " tbdetailresepokvk"; } else { echo "" . $this->Ini->Nm_lang['lang_othr_frmu_title'] . " tbdetailresepokvk"; } ?></div>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailresepokvk']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailresepokvk']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailresepokvk']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailresepokvk']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailresepokvk']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailresepokvk']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailresepokvk']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailresepokvk']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailresepokvk']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailresepokvk']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailresepokvk']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailresepokvk']['fast_search'][2] : "";
?> 
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailresepokvk']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailresepokvk']['run_iframe'] != "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailresepokvk']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailresepokvk']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailresepokvk']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailresepokvk']['run_iframe'] == "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailresepokvk']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailresepokvk']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailresepokvk']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailresepokvk']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailresepokvk']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailresepokvk']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailresepokvk']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailresepokvk']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailresepokvk']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailresepokvk']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailresepokvk']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailresepokvk']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
 ...
 ?>
   ...
   <?php if (isset($this->nmgp_cmp_hidden['terpakai_']) && $this->nmgp_cmp_hidden['terpakai_'] == 'off') { $sStyleHidden_terpakai_ = 'display: none'; }
      if (1 || !isset($this->nmgp_cmp_hidden['terpakai_']) || $this->nmgp_cmp_hidden['terpakai_'] == 'on') {
      if (!isset($this->nm_new_label['terpakai_'])) {
          $this->nm_new_label['terpakai_'] = "Terpakai"; } ?>

    <TD class="scFormLabelOddMult css_terpakai__label" id="hidden_field_label_terpakai_" style="<?php echo $sStyleHidden_terpakai_; ?>" > <?php echo $this->nm_new_label['terpakai_'] ?> </TD>
   <?php } ?>
...
{ 
   ...
   { 
       ob_start();
       $iStart = sizeof($this->form_vert_form_tbdetailresepokvk);
       $guarda_nmgp_opcao = $this->nmgp_opcao;
       $guarda_form_vert_form_tbdetailresepokvk = $this->form_vert_form_tbdetailresepokvk;
       $this->nmgp_opcao = 'novo';
   } 
   if ($this->Embutida_form && empty($this->form_vert_form_tbdetailresepokvk))
   {
       $sc_seq_vert = 0;
   }
   ...
   foreach ($this->form_vert_form_tbdetailresepokvk as $sc_seq_vert => $sc_lixo)
   {
       $this->loadRecordState($sc_seq_vert);
       $this->trancode_ = $this->form_vert_form_tbdetailresepokvk[$sc_seq_vert]['trancode_'];
       $this->biaya_ = $this->form_vert_form_tbdetailresepokvk[$sc_seq_vert]['biaya_'];
       $this->kelas_ = $this->form_vert_form_tbdetailresepokvk[$sc_seq_vert]['kelas_'];
       if (isset($this->Embutida_ronly) && $this->Embutida_ronly && !$Line_Add)
       {
           $this->nmgp_cmp_readonly['item_'] = true;
           $this->nmgp_cmp_readonly['jumlah_'] = true;
           $this->nmgp_cmp_readonly['terpakai_'] = true;
       ...
       elseif ($Line_Add)
       {
           ...
           if (!isset($this->nmgp_cmp_readonly['terpakai_']) || $this->nmgp_cmp_readonly['terpakai_'] != "on") {$this->nmgp_cmp_readonly['terpakai_'] = false;}
       ...
       $this->jumlah_ = $this->form_vert_form_tbdetailresepokvk[$sc_seq_vert]['jumlah_']; 
       ...
       $this->terpakai_ = $this->form_vert_form_tbdetailresepokvk[$sc_seq_vert]['terpakai_']; 
       $terpakai_ = $this->terpakai_; 
       $sStyleHidden_terpakai_ = '';
       if (isset($sCheckRead_terpakai_))
       {
           unset($sCheckRead_terpakai_);
       }
       if (isset($this->nmgp_cmp_readonly['terpakai_']))
       {
           $sCheckRead_terpakai_ = $this->nmgp_cmp_readonly['terpakai_'];
       }
       ...
       $bTestReadOnly_terpakai_ = true;
       $sStyleReadLab_terpakai_ = 'display: none;';
       $sStyleReadInp_terpakai_ = '';
       if (isset($this->nmgp_cmp_readonly['terpakai_']) && $this->nmgp_cmp_readonly['terpakai_'] == 'on')
       {
           $bTestReadOnly_terpakai_ = false;
           unset($this->nmgp_cmp_readonly['terpakai_']);
           $sStyleReadLab_terpakai_ = '';
           $sStyleReadInp_terpakai_ = 'display: none;';
       }
       $this->satuan_ = $this->form_vert_form_tbdetailresepokvk[$sc_seq_vert]['satuan_']; 
       ...
       $this->diskon_ = $this->form_vert_form_tbdetailresepokvk[$sc_seq_vert]['diskon_']; 
       ...
       $this->signa_ = $this->form_vert_form_tbdetailresepokvk[$sc_seq_vert]['signa_']; 
       $signa_ = $this->signa_; 
       $sStyleHidden_signa_ = '';
       ...
       $this->trandate_ = $this->form_vert_form_tbdetailresepokvk[$sc_seq_vert]['trandate_'] . ' ' . $this->form_vert_form_tbdetailresepokvk[$sc_seq_vert]['trandate__hora']; 
       ...
       $this->id_ = $this->form_vert_form_tbdetailresepokvk[$sc_seq_vert]['id_']; 
       $id_ = $this->id_; 
       if (!isset($this->nmgp_cmp_hidden['id_']))
       {
           $this->nmgp_cmp_hidden['id_'] = 'off';
       ...
       $this->stok_ = $this->form_vert_form_tbdetailresepokvk[$sc_seq_vert]['stok_']; 
       $stok_ = $this->stok_; 
       $sStyleHidden_stok_ = '';
...
<?php echo nmButtonOutput($this->arr_buttons, "bmd_novo", "do_ajax_form_tbdetailresepokvk_add_new_line(" . $sc_seq_vert . ")", "do_ajax_form_tbdetailresepokvk_add_new_line(" . $sc_seq_vert . ")", "sc_new_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
<?php }?>
<?php
  $Style_add_line = (!$Line_Add) ? "display: none" : "";
?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_form_tbdetailresepokvk_cancel_insert(" . $sc_seq_vert . ")", "do_ajax_form_tbdetailresepokvk_cancel_insert(" . $sc_seq_vert . ")", "sc_canceli_line_" . $sc_seq_vert . "", "", "", "" . $Style_add_line . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_form_tbdetailresepokvk_cancel_update(" . $sc_seq_vert . ")", "do_ajax_form_tbdetailresepokvk_cancel_update(" . $sc_seq_vert . ")", "sc_cancelu_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
 </TD>
   <?php }?>
...
<input type="hidden" name="terpakai_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($terpakai_) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormDataOddMult css_terpakai__line" id="hidden_field_data_terpakai_<?php echo $sc_seq_vert; ?>" style="<?php echo $sStyleHidden_terpakai_; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOddMult css_terpakai__line" style="vertical-align: top;padding: 0px">
<?php if ($bTestReadOnly_terpakai_ && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["terpakai_"]) &&  $this->nmgp_cmp_readonly["terpakai_"] == "on") { 

 ?>
<input type="hidden" name="terpakai_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($terpakai_) . "\">" . $terpakai_ . ""; ?>
<?php } else { ?>
<span id="id_read_on_terpakai_<?php echo $sc_seq_vert ?>" class="sc-ui-readonly-terpakai_<?php echo $sc_seq_vert ?> css_terpakai__line" style="<?php echo $sStyleReadLab_terpakai_; ?>"><?php echo $this->terpakai_; ?></span><span id="id_read_off_terpakai_<?php echo $sc_seq_vert ?>" class="css_read_off_terpakai_" style="white-space: nowrap;<?php echo $sStyleReadInp_terpakai_; ?>">
 <input class="sc-js-input scFormObjectOddMult scFormObjectOddMultSpin scSpin_terpakai__obj css_terpakai__obj" style="" id="id_sc_field_terpakai_<?php echo $sc_seq_vert ?>" type=text name="terpakai_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($terpakai_) ?>"
...
</td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_terpakai_<?php echo $sc_seq_vert; ?>_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_terpakai_<?php echo $sc_seq_vert; ?>_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
?>
<span id="id_read_on_signa_<?php echo $sc_seq_vert ?>" class="sc-ui-readonly-signa_<?php echo $sc_seq_vert ?> css_signa__line" style="<?php echo $sStyleReadLab_signa_; ?>"><?php echo str_replace("<", "&lt;", $signa__look); ?></span><span id="id_read_off_signa_<?php echo $sc_seq_vert ?>" class="css_read_off_signa_" style="white-space: nowrap;<?php echo $sStyleReadInp_signa_; ?>">
 <input class="sc-js-input scFormObjectOddMult css_signa__obj" style="display: none;" id="id_sc_field_signa_<?php echo $sc_seq_vert ?>" type=text name="signa_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($signa_) ?>"
...
?>
<select id="id_ac_signa_<?php echo $sc_seq_vert; ?>" class="scFormObjectOddMult sc-ui-autocomp-signa_ css_signa__obj"><?php if ('' != $this->signa_) { ?><option value="<?php echo $this->signa_ ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select></span><?php } ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOddMult css_stok__line" id="hidden_field_data_stok_<?php echo $sc_seq_vert; ?>" style="<?php echo $sStyleHidden_stok_; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOddMult css_stok__line" style="vertical-align: top;padding: 0px"><?php
...
?>
<span id="id_imghtml_stok_<?php echo $sc_seq_vert; ?>"><a href="javascript:nm_gp_submit('<?php echo $this->Ini->link_grid_stock_all_cons . "', '$this->nm_location', 'item_stok*scin" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailresepokvk']['dados_form'][$sc_seq_vert]['item_'] . "*scoutNMSC_inicial*scininicio*scoutNMSC_paginacao*scinFULL*scoutNMSC_modal*scinok*scout', 'inicio', 'modal', '650', '900', 'grid_stock_all')\"><font color=\"" . $this->Ini->cor_link_dados . "\">" . $stok_ ; ?></font></a></span>
...
<?php } else { ?>
<span id="id_read_on_stok_<?php echo $sc_seq_vert ?>" class="sc-ui-readonly-stok_<?php echo $sc_seq_vert ?> css_stok__line" style="<?php echo $sStyleReadLab_stok_; ?>"><?php echo $this->stok_; ?></span><span id="id_read_off_stok_<?php echo $sc_seq_vert ?>" class="css_read_off_stok_" style="white-space: nowrap;<?php echo $sStyleReadInp_stok_; ?>"></span><?php } ?>
...
<?php   
       ...
       if (isset($sCheckRead_terpakai_))
       {
           $this->nmgp_cmp_readonly['terpakai_'] = $sCheckRead_terpakai_;
       }
       if ('display: none;' == $sStyleHidden_terpakai_)
       {
           $this->nmgp_cmp_hidden['terpakai_'] = 'off';
       }
       if (isset($sCheckRead_satuan_))
       {
   ...
   { 
       ...
       $this->form_vert_form_tbdetailresepokvk = $guarda_form_vert_form_tbdetailresepokvk;
   } 
   if ($Table_refresh) 
   { 
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailresepokvk']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailresepokvk']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailresepokvk']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailresepokvk']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailresepokvk']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailresepokvk']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailresepokvk']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailresepokvk']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailresepokvk']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<?php
if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailresepokvk']['run_modal']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailresepokvk']['run_modal'])
{
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailresepokvk']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailresepokvk']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_tbdetailresepokvk");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_tbdetailresepokvk");
 parent.scAjaxDetailHeight("form_tbdetailresepokvk", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailresepokvk']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
