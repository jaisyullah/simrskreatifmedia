...
<?php
   ...
   $Ord_Cmp = new grid_tbpbf_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_tbpbf_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbpbf']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tbpbf']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['pbfcode'] = "pbfCode";
   $tab_labels["pbfcode"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbpbf']['labels']["pbfcode"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbpbf']['labels']["pbfcode"] : "Kode PBF";
   $tab_ger_campos['pbfname'] = "on";
   $tab_def_campos['pbfname'] = "pbfName";
   $tab_labels["pbfname"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbpbf']['labels']["pbfname"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbpbf']['labels']["pbfname"] : "Nama";
   $tab_ger_campos['city'] = "on";
   $tab_def_campos['city'] = "city";
   $tab_labels["city"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbpbf']['labels']["city"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbpbf']['labels']["city"] : "Kota";
   $tab_ger_campos['phone'] = "on";
   $tab_def_campos['phone'] = "phone";
   $tab_labels["phone"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbpbf']['labels']["phone"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbpbf']['labels']["phone"] : "Telepon";
   $tab_ger_campos['cp'] = "on";
   $tab_def_campos['cp'] = "cp";
   $tab_labels["cp"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbpbf']['labels']["cp"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbpbf']['labels']["cp"] : "Kontak Person";
   $tab_ger_campos['status'] = "on";
   $tab_def_campos['status'] = "status";
   $tab_labels["status"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbpbf']['labels']["status"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbpbf']['labels']["status"] : "Status";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_tbpbf']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_tbpbf']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_tbpbf']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbpbf']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tbpbf']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_tbpbf']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_tbpbf']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_tbpbf']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_tbpbf']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_tbpbf_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_tbpbf']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_tbpbf']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_tbpbf']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_tbpbf']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_tbpbf']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
