...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "disc";$Nm_numeric[] = "disc";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_city_cond" name="city_cond" onChange="nm_campos_between(document.getElementById('id_vis_city'), this, 'city')">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_pbfcode_cond" name="pbfcode_cond" onChange="nm_campos_between(document.getElementById('id_vis_pbfcode'), this, 'pbfcode')">
      ...
      <br><span id="id_hide_pbfcode"  <?php echo $str_hide_pbfcode?>><?php
      if ($pbfcode != "")
      {
      $pbfcode_look = substr($this->Db->qstr($pbfcode), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_pbfname_cond" name="pbfname_cond" onChange="nm_campos_between(document.getElementById('id_vis_pbfname'), this, 'pbfname')">
      ...
      <br><span id="id_hide_pbfname"  <?php echo $str_hide_pbfname?>><?php
      if ($pbfname != "")
      {
      $pbfname_look = substr($this->Db->qstr($pbfname), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_address_cond" name="address_cond" onChange="nm_campos_between(document.getElementById('id_vis_address'), this, 'address')">
      ...
      <br><span id="id_hide_address"  <?php echo $str_hide_address?>><?php
      if ($address != "")
      {
      $address_look = substr($this->Db->qstr($address), 1, -1); 
      $nmgp_def_dados = array(); 
