...
class grid_tbpbf_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpbf']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_tbpbf_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_tbpbf_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_tbpbf_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_pbfcode')
      {
          $pbfcode = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_pbfcode($pbfcode);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_pbfname')
      {
          $pbfname = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_pbfname($pbfname);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function lookup_ajax_pbfcode($pbfcode)
   {
      $pbfcode = substr($this->Db->qstr($pbfcode), 1, -1);
            $pbfcode_look = substr($this->Db->qstr($pbfcode), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct pbfCode from " . $this->Ini->nm_tabela . " where  pbfCode like '%" . $pbfcode . "%' order by pbfCode"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
   ...
   function lookup_ajax_pbfname($pbfname)
   {
      $pbfname = substr($this->Db->qstr($pbfname), 1, -1);
            $pbfname_look = substr($this->Db->qstr($pbfname), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct pbfName from " . $this->Ini->nm_tabela . " where  pbfName like '%" . $pbfname . "%' order by pbfName"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpbf']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpbf']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpbf']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpbf']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpbf']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpbf']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpbf']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpbf']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpbf']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpbf']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpbf']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpbf']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpbf']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpbf']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpbf']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - Supplier / PBF</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_tbpbf/grid_tbpbf_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_tbpbf_ajax_search.js"></script>
 <script type="text/javascript" src="grid_tbpbf_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_tbpbf_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_tbpbf']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_tbpbf']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_pbfcode_cond#NMF#' + search_get_sel_txt('SC_pbfcode_cond') + '@NMF@';
  str_out += 'SC_pbfcode#NMF#' + search_get_text('SC_pbfcode') + '@NMF@';
  str_out += 'id_ac_pbfcode#NMF#' + search_get_text('id_ac_pbfcode') + '@NMF@';
  str_out += 'SC_pbfname_cond#NMF#' + search_get_sel_txt('SC_pbfname_cond') + '@NMF@';
  str_out += 'SC_pbfname#NMF#' + search_get_text('SC_pbfname') + '@NMF@';
  str_out += 'id_ac_pbfname#NMF#' + search_get_text('id_ac_pbfname') + '@NMF@';
   ...
   $("#id_ac_pbfcode").autocomplete({
     ...
     $.ajax({
       ...
       data: {
          ...
          nmgp_parms: "NM_ajax_opcao?#?autocomp_pbfcode",
          max_itens: "10",
          cod_desc: "N",
     ...
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_pbfcode").val( $(this).val() );
       }
     }
   });
   $("#id_ac_pbfname").autocomplete({
     minLength: 1,
     source: function (request, response) {
     $.ajax({
       url: "index.php",
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_pbfname",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpbf']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div class="scFilterHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFilterHeaderFont" style="float: left; text-transform: uppercase;"><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - Supplier / PBF</div>
...
<?php
   ...
   function monta_form()
   {
      global 
             ...
             $pbfcode_cond, $pbfcode, $pbfcode_autocomp,
             $pbfname_cond, $pbfname, $pbfname_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpbf']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpbf']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpbf']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpbf']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $city = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpbf']['campos_busca']['city']; 
          $city_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpbf']['campos_busca']['city_cond']; 
          $pbfcode = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpbf']['campos_busca']['pbfcode']; 
          $pbfcode_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpbf']['campos_busca']['pbfcode_cond']; 
          $pbfname = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpbf']['campos_busca']['pbfname']; 
          $pbfname_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpbf']['campos_busca']['pbfname_cond']; 
          $address = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpbf']['campos_busca']['address']; 
          $address_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpbf']['campos_busca']['address_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpbf']['campos_busca']['NM_operador']; 
      } 
      if (!isset($city_cond) || empty($city_cond))
      {
         $city_cond = "qp";
      }
      if (!isset($pbfcode_cond) || empty($pbfcode_cond))
      {
         $pbfcode_cond = "qp";
      }
      if (!isset($pbfname_cond) || empty($pbfname_cond))
      {
         $pbfname_cond = "qp";
      }
      ...
      $str_hide_pbfcode = (in_array($pbfcode_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_pbfname = (in_array($pbfname_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      if (!isset($pbfcode) || $pbfcode == "")
      {
          $pbfcode = "";
      }
      if (isset($pbfcode) && !empty($pbfcode))
      {
         $tmp_pos = strpos($pbfcode, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $pbfcode = substr($pbfcode, 0, $tmp_pos);
         }
      }
      if (!isset($pbfname) || $pbfname == "")
      {
          $pbfname = "";
      }
      if (isset($pbfname) && !empty($pbfname))
      {
         $tmp_pos = strpos($pbfname, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $pbfname = substr($pbfname, 0, $tmp_pos);
         }
      }
  ...
  <TD width="100%" height="">
   ...
   <tr>
     ...
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_city_cond" name="city_cond" onChange="nm_campos_between(document.getElementById('id_vis_city'), this, 'city')">
...
?>
<INPUT  type="text" id="SC_city" name="city" value="<?php echo NM_encode_input($city) ?>"  size=25 alt="{datatype: 'text', maxLength: 25, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_city" name="city_autocomp" size="25"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 25, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_pbfcode_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['pbfcode'])) ? $this->New_label['pbfcode'] : "Kode PBF"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_pbfcode_cond" name="pbfcode_cond" onChange="nm_campos_between(document.getElementById('id_vis_pbfcode'), this, 'pbfcode')">
       <OPTION value="qp" <?php if ("qp" == $pbfcode_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $pbfcode_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $pbfcode_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $pbfcode_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_pbfcode" <?php echo $str_hide_pbfcode?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['pbfcode'])) ? $this->New_label['pbfcode'] : "Kode PBF";
 $nmgp_tab_label .= "pbfcode?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      $pbfcode_look = substr($this->Db->qstr($pbfcode), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct pbfCode from " . $this->Ini->nm_tabela . " where pbfCode = '$pbfcode_look' order by pbfCode"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      if (isset($nmgp_def_dados[0][$pbfcode]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$pbfcode];
      }
      else
      {
          $sAutocompValue = $pbfcode;
      }
?>
<INPUT  type="text" id="SC_pbfcode" name="pbfcode" value="<?php echo NM_encode_input($pbfcode) ?>"  size=13 alt="{datatype: 'text', maxLength: 13, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_pbfcode" name="pbfcode_autocomp" size="13"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 13, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_pbfname_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['pbfname'])) ? $this->New_label['pbfname'] : "Nama"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_pbfname_cond" name="pbfname_cond" onChange="nm_campos_between(document.getElementById('id_vis_pbfname'), this, 'pbfname')">
       <OPTION value="qp" <?php if ("qp" == $pbfname_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $pbfname_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $pbfname_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $pbfname_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_pbfname" <?php echo $str_hide_pbfname?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['pbfname'])) ? $this->New_label['pbfname'] : "Nama";
 $nmgp_tab_label .= "pbfname?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      $pbfname_look = substr($this->Db->qstr($pbfname), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct pbfName from " . $this->Ini->nm_tabela . " where pbfName = '$pbfname_look' order by pbfName"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      if (isset($nmgp_def_dados[0][$pbfname]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$pbfname];
      }
      else
      {
          $sAutocompValue = $pbfname;
      }
?>
<INPUT  type="text" id="SC_pbfname" name="pbfname" value="<?php echo NM_encode_input($pbfname) ?>"  size=50 alt="{datatype: 'text', maxLength: 100, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_pbfname" name="pbfname_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 100, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_address_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['address'])) ? $this->New_label['address'] : "Alamat"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_address_cond" name="address_cond" onChange="nm_campos_between(document.getElementById('id_vis_address'), this, 'address')">
...
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_address" name="address_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 32767, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
?>
<?php
   if (is_file("grid_tbpbf_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_tbpbf']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_tbpbf']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpbf']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.pbfcode_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_pbfcode'), document.F1.pbfcode_cond, 'pbfcode');
   document.F1.pbfcode.value = "";
   document.F1.pbfcode_autocomp.value = "";
   document.F1.pbfname_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_pbfname'), document.F1.pbfname_cond, 'pbfname');
   document.F1.pbfname.value = "";
   document.F1.pbfname_autocomp.value = "";
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "simrskreatifmedia/grid_tbpbf";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpbf']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpbf']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpbf']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_pbfcode_cond'] = 'cond';
      $tp_fields['SC_pbfcode'] = 'text_aut';
      $tp_fields['id_ac_pbfcode'] = 'text_aut';
      $tp_fields['SC_pbfname_cond'] = 'cond';
      $tp_fields['SC_pbfname'] = 'text_aut';
      $tp_fields['id_ac_pbfname'] = 'text_aut';
   ...
   {
      global $city_cond, $city, $city_autocomp,
             $pbfcode_cond, $pbfcode, $pbfcode_autocomp,
             $pbfname_cond, $pbfname, $pbfname_autocomp,
             $address_cond, $address, $address_autocomp, $nmgp_tab_label;
      ...
      if (!empty($pbfcode_autocomp) && empty($pbfcode))
      {
          $pbfcode = $pbfcode_autocomp;
      }
      if (!empty($pbfname_autocomp) && empty($pbfname))
      {
          $pbfname = $pbfname_autocomp;
      }
      ...
      $pbfcode_cond_salva = $pbfcode_cond; 
      if (!isset($pbfcode_input_2) || $pbfcode_input_2 == "")
      {
          $pbfcode_input_2 = $pbfcode;
      }
      $pbfname_cond_salva = $pbfname_cond; 
      if (!isset($pbfname_input_2) || $pbfname_input_2 == "")
      {
          $pbfname_input_2 = $pbfname;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpbf']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpbf']['campos_busca']['city'] = $city; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpbf']['campos_busca']['city_cond'] = $city_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpbf']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpbf']['campos_busca']['pbfcode'] = $pbfcode; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpbf']['campos_busca']['pbfcode_cond'] = $pbfcode_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpbf']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpbf']['campos_busca']['pbfname'] = $pbfname; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpbf']['campos_busca']['pbfname_cond'] = $pbfname_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpbf']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpbf']['campos_busca']['address'] = $address; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpbf']['campos_busca']['address_cond'] = $address_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpbf']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpbf']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpbf']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['pbfcode'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['pbfcode'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['pbfcode'] = $pbfcode;
      }
      $pbfname_look = substr($this->Db->qstr($pbfname), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct pbfName from " . $this->Ini->nm_tabela . " where pbfName = '$pbfname_look' order by pbfName"; 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['pbfname'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['pbfname'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['pbfname'] = $pbfname;
      }
      $address_look = substr($this->Db->qstr($address), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct address from " . $this->Ini->nm_tabela . " where address = '$address_look' order by address"; 
      ...
      //----- $pbfcode
      $this->Date_part = false;
      if (isset($pbfcode) || $pbfcode_cond == "nu" || $pbfcode_cond == "nn" || $pbfcode_cond == "ep" || $pbfcode_cond == "ne")
      {
         $this->monta_condicao("pbfCode", $pbfcode_cond, $pbfcode, "", "pbfcode");
      }

      //----- $pbfname
      $this->Date_part = false;
      if (isset($pbfname) || $pbfname_cond == "nu" || $pbfname_cond == "nn" || $pbfname_cond == "ep" || $pbfname_cond == "ne")
      {
         $this->monta_condicao("pbfName", $pbfname_cond, $pbfname, "", "pbfname");
      }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpbf']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpbf']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpbf']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpbf']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpbf']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpbf']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpbf']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpbf']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbpbf']['cond_pesq'] .= $this->NM_operador;
