...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_tbpbf"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_tbpbf"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_tbpbf'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tbpbf']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_tbpbf']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tbpbf']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_tbpbf']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_tbpbf']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_tbpbf']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_tbpbf']['embutida_filho'] as $ind => $sc_init)
          {
