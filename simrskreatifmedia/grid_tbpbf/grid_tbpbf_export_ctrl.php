<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tbpbf']['sc_process_barr'] = true;
require_once('../grid_tbpbf/index.php');
unset($_SESSION['scriptcase']['grid_tbpbf']['sc_process_barr']);
$ExportCtrl = new grid_tbpbf_export_control;
$ExportCtrl->Export_barr();

class grid_tbpbf_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - Supplier / PBF :: Excel</TITLE>
