...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_jnspelayanan' + iSeqRow).bind('blur', function() { sc_form_vclaim_sep_pembuatan_jnspelayanan_onblur(this, iSeqRow) })
                                          .bind('focus', function() { sc_form_vclaim_sep_pembuatan_jnspelayanan_onfocus(this, iSeqRow) });
  $('#id_sc_field_tglsep' + iSeqRow).bind('blur', function() { sc_form_vclaim_sep_pembuatan_tglsep_onblur(this, iSeqRow) })
                                    .bind('focus', function() { sc_form_vclaim_sep_pembuatan_tglsep_onfocus(this, iSeqRow) });
  $('#id_sc_field_norujukan' + iSeqRow).bind('blur', function() { sc_form_vclaim_sep_pembuatan_norujukan_onblur(this, iSeqRow) })
                                       .bind('focus', function() { sc_form_vclaim_sep_pembuatan_norujukan_onfocus(this, iSeqRow) });
  $('#id_sc_field_asalrujukan' + iSeqRow).bind('blur', function() { sc_form_vclaim_sep_pembuatan_asalrujukan_onblur(this, iSeqRow) })
                                         .bind('focus', function() { sc_form_vclaim_sep_pembuatan_asalrujukan_onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_form_vclaim_sep_pembuatan_jnspelayanan_onblur(oThis, iSeqRow) {
  do_ajax_form_vclaim_sep_pembuatan_mob_validate_jnspelayanan();
  scCssBlur(oThis);
}

function sc_form_vclaim_sep_pembuatan_jnspelayanan_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_vclaim_sep_pembuatan_tglsep_onblur(oThis, iSeqRow) {
  do_ajax_form_vclaim_sep_pembuatan_mob_validate_tglsep();
  scCssBlur(oThis);
}

function sc_form_vclaim_sep_pembuatan_tglsep_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_vclaim_sep_pembuatan_norujukan_onblur(oThis, iSeqRow) {
  do_ajax_form_vclaim_sep_pembuatan_mob_validate_norujukan();
  scCssBlur(oThis);
}

function sc_form_vclaim_sep_pembuatan_norujukan_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_vclaim_sep_pembuatan_asalrujukan_onblur(oThis, iSeqRow) {
  do_ajax_form_vclaim_sep_pembuatan_mob_validate_asalrujukan();
  scCssBlur(oThis);
}

function sc_form_vclaim_sep_pembuatan_asalrujukan_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function scHidePage(pageNo) {
	$("#id_form_vclaim_sep_pembuatan_mob_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_tglsep" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_vclaim_sep_pembuatan_mob_validate_tglsep(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
