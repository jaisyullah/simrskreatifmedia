  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_vclaim_sep_pembuatan_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_vclaim_sep_pembuatan_mob_form();
	}

  // ---------- Validate jnspelayanan
  function do_ajax_form_vclaim_sep_pembuatan_mob_validate_jnspelayanan()
  {
    var nomeCampo_jnspelayanan = "jnspelayanan";
    var var_jnspelayanan = scAjaxGetFieldSelect(nomeCampo_jnspelayanan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_sep_pembuatan_mob_validate_jnspelayanan(var_jnspelayanan, var_script_case_init, do_ajax_form_vclaim_sep_pembuatan_mob_validate_jnspelayanan_cb);
  } // do_ajax_form_vclaim_sep_pembuatan_mob_validate_jnspelayanan

  function do_ajax_form_vclaim_sep_pembuatan_mob_validate_jnspelayanan_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_sep_pembuatan_mob_validate_jnspelayanan_cb

  // ---------- Validate tglsep
  function do_ajax_form_vclaim_sep_pembuatan_mob_validate_tglsep()
  {
    var nomeCampo_tglsep = "tglsep";
    var var_tglsep = scAjaxGetFieldText(nomeCampo_tglsep);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_sep_pembuatan_mob_validate_tglsep(var_tglsep, var_script_case_init, do_ajax_form_vclaim_sep_pembuatan_mob_validate_tglsep_cb);
  } // do_ajax_form_vclaim_sep_pembuatan_mob_validate_tglsep

  function do_ajax_form_vclaim_sep_pembuatan_mob_validate_tglsep_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tglsep";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_sep_pembuatan_mob_validate_tglsep_cb

  // ---------- Validate asalrujukan
  function do_ajax_form_vclaim_sep_pembuatan_mob_validate_asalrujukan()
  {
    var nomeCampo_asalrujukan = "asalrujukan";
    var var_asalrujukan = scAjaxGetFieldSelect(nomeCampo_asalrujukan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_sep_pembuatan_mob_validate_asalrujukan(var_asalrujukan, var_script_case_init, do_ajax_form_vclaim_sep_pembuatan_mob_validate_asalrujukan_cb);
  } // do_ajax_form_vclaim_sep_pembuatan_mob_validate_asalrujukan

  function do_ajax_form_vclaim_sep_pembuatan_mob_validate_asalrujukan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_sep_pembuatan_mob_validate_asalrujukan_cb

  // ---------- Validate norujukan
  function do_ajax_form_vclaim_sep_pembuatan_mob_validate_norujukan()
  {
    var nomeCampo_norujukan = "norujukan";
    var var_norujukan = scAjaxGetFieldText(nomeCampo_norujukan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_sep_pembuatan_mob_validate_norujukan(var_norujukan, var_script_case_init, do_ajax_form_vclaim_sep_pembuatan_mob_validate_norujukan_cb);
  } // do_ajax_form_vclaim_sep_pembuatan_mob_validate_norujukan

  function do_ajax_form_vclaim_sep_pembuatan_mob_validate_norujukan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_sep_pembuatan_mob_validate_norujukan_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_vclaim_sep_pembuatan_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_vclaim_sep_pembuatan_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_vclaim_sep_pembuatan_mob_submit_form(var_jnspelayanan, var_tglsep, var_asalrujukan, var_norujukan, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_vclaim_sep_pembuatan_mob_submit_form_cb);
  } // do_ajax_form_vclaim_sep_pembuatan_mob_submit_form

  function do_ajax_form_vclaim_sep_pembuatan_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_vclaim_sep_pembuatan_mob_submit_form_cb_after_alert);
  } // do_ajax_form_vclaim_sep_pembuatan_mob_submit_form_cb
  function do_ajax_form_vclaim_sep_pembuatan_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_vclaim_sep_pembuatan_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_vclaim_sep_pembuatan_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_form_vclaim_sep_pembuatan_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_pembuatan_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_vclaim_sep_pembuatan_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_vclaim_sep_pembuatan_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_vclaim_sep_pembuatan_mob_navigate_form_cb
  function do_ajax_form_vclaim_sep_pembuatan_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_vclaim_sep_pembuatan_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_vclaim_sep_pembuatan_mob_navigate_form_cb_after_alert
  function sc_hide_form_vclaim_sep_pembuatan_mob_form()
  {
  ...
  ajax_field_list[0] = "jnspelayanan";
  ajax_field_list[1] = "tglsep";
  ajax_field_list[2] = "asalrujukan";
  ajax_field_list[3] = "norujukan";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "jnspelayanan": {"label": "Pelayanan", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
