...
<HEAD>
 <TITLE><?php if ('novo' == $this->nmgp_opcao) { echo strip_tags("" . $this->Ini->Nm_lang['lang_othr_frmi_titl'] . ""); } else { echo strip_tags("Cari Rujukan"); } ?></TITLE>
...
?>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_pembuatan_mob']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_vclaim_sep_pembuatan/form_vclaim_sep_pembuatan_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_vclaim_sep_pembuatan_mob_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_vclaim_sep_pembuatan_mob_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_pembuatan_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_pembuatan_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_pembuatan_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_pembuatan_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_pembuatan_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_pembuatan_mob']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_pembuatan_mob']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_pembuatan_mob']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
?>
<body class="scFormPage" style="<?php echo $remove_margin . $str_iframe_body; ?>">
<?php

if (isset($_SESSION['scriptcase']['form_vclaim_sep_pembuatan']['error_buffer']) && '' != $_SESSION['scriptcase']['form_vclaim_sep_pembuatan']['error_buffer'])
{
    echo $_SESSION['scriptcase']['form_vclaim_sep_pembuatan']['error_buffer'];
}
...
<?php
 include_once("form_vclaim_sep_pembuatan_mob_js0.php");
?>
<script type="text/javascript"> 
...
<form  name="F1" method="post" 
               action="form_vclaim_sep_pembuatan_mob.php" 
               target="_self">
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_vclaim_sep_pembuatan_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_vclaim_sep_pembuatan_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_pembuatan_mob']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_pembuatan_mob']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_pembuatan_mob']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_pembuatan_mob']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_pembuatan_mob']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<div class="scFormHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFormHeaderFont" style="float: left; text-transform: uppercase;"><?php if ($this->nmgp_opcao == "novo") { echo "" . $this->Ini->Nm_lang['lang_othr_frmi_titl'] . ""; } else { echo "Cari Rujukan"; } ?></div>
...
<?php
  ...
  {
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_pembuatan_mob']['where_filter']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_pembuatan_mob']['empty_filter'] = true;
       }
  }
?>
...
<TABLE align="center" id="hidden_bloco_0" class="scFormTable" width="100%" style="height: 100%;"><?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   {
       $this->nm_new_label['jnspelayanan'] = "Pelayanan";
   }
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_pembuatan_mob']['Lookup_jnspelayanan'][] = '1'; ?>
 <option  value="2" <?php  if ($this->jnspelayanan == "2") { echo " selected" ;} ?><?php  if (empty($this->jnspelayanan)) { echo " selected" ;} ?>>Rawat Jalan</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_pembuatan_mob']['Lookup_jnspelayanan'][] = '2'; ?>
 </select></span>
</span><?php  }?>
 </TD>
   <?php }?>
...
$asalrujukan_look = "";
 if ($this->asalrujukan == "1") { $asalrujukan_look .= "Faskes Tingkat 1" ;} 
 if ($this->asalrujukan == "2") { $asalrujukan_look .= "Faskes Tingkat 2" ;} 
...
<span id="id_read_on_asalrujukan" class="css_asalrujukan_line"  style="<?php echo $sStyleReadLab_asalrujukan; ?>"><?php echo $this->form_encode_input($asalrujukan_look); ?></span><span id="id_read_off_asalrujukan" class="css_read_off_asalrujukan" style="white-space: nowrap; <?php echo $sStyleReadInp_asalrujukan; ?>">
 ...
 <option  value="1" <?php  if ($this->asalrujukan == "1") { echo " selected" ;} ?><?php  if (empty($this->asalrujukan)) { echo " selected" ;} ?>>Faskes Tingkat 1</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_pembuatan_mob']['Lookup_asalrujukan'][] = '1'; ?>
 <option  value="2" <?php  if ($this->asalrujukan == "2") { echo " selected" ;} ?>>Faskes Tingkat 2</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_pembuatan_mob']['Lookup_asalrujukan'][] = '2'; ?>
 </select></span>
</span><?php  }?>
 </TD>
   <?php }?>
...
<span id="id_read_on_norujukan" class="sc-ui-readonly-norujukan css_norujukan_line" style="<?php echo $sStyleReadLab_norujukan; ?>"><?php echo $this->norujukan; ?></span><span id="id_read_off_norujukan" class="css_read_off_norujukan" style="white-space: nowrap;<?php echo $sStyleReadInp_norujukan; ?>">
 ...
 size=27 maxlength=20 alt="{datatype: 'text', maxLength: 20, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
 </TD>
   <?php }?>
...
<?php
           if (($nm_apl_dependente != 1) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_pembuatan_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_pembuatan_mob']['dashboard_info']['under_dashboard'])) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_pembuatan_mob']['nm_run_menu']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_pembuatan_mob']['nm_run_menu'] != 1))) {
...
<?php
           if (($nm_apl_dependente == 1) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_pembuatan_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_pembuatan_mob']['dashboard_info']['under_dashboard']))) {
        $sCondStyle = ($this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_pembuatan_mob']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_pembuatan_mob']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_vclaim_sep_pembuatan_mob");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_vclaim_sep_pembuatan_mob");
 parent.scAjaxDetailHeight("form_vclaim_sep_pembuatan_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_pembuatan_mob']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
