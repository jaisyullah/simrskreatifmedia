...
?>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_pembuatan']['embutida_pdf']))
 {
 ?>
...
<?php
include_once("form_vclaim_sep_pembuatan_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_vclaim_sep_pembuatan_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_pembuatan']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_pembuatan']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_pembuatan']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_pembuatan']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_pembuatan']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_pembuatan']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_pembuatan']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_pembuatan']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
?>
...
<?php
 include_once("form_vclaim_sep_pembuatan_js0.php");
?>
<script type="text/javascript"> 
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_vclaim_sep_pembuatan'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_vclaim_sep_pembuatan'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_pembuatan']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_pembuatan']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_pembuatan']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_pembuatan']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_pembuatan']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<?php
  ...
  {
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_pembuatan']['where_filter']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_pembuatan']['empty_filter'] = true;
       }
  }
?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_pembuatan']['Lookup_jnspelayanan'][] = '1'; ?>
 <option  value="2" <?php  if ($this->jnspelayanan == "2") { echo " selected" ;} ?><?php  if (empty($this->jnspelayanan)) { echo " selected" ;} ?>>Rawat Jalan</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_pembuatan']['Lookup_jnspelayanan'][] = '2'; ?>
 </select></span>
</span><?php  }?>
</TD>
   <?php }?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_pembuatan']['Lookup_asalrujukan'][] = '1'; ?>
 <option  value="2" <?php  if ($this->asalrujukan == "2") { echo " selected" ;} ?>>Faskes Tingkat 2</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_pembuatan']['Lookup_asalrujukan'][] = '2'; ?>
 </select></span>
</span><?php  }?>
</TD>
   <?php }?>
...
<?php
           if (($nm_apl_dependente != 1) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_pembuatan']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_pembuatan']['dashboard_info']['under_dashboard'])) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_pembuatan']['nm_run_menu']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_pembuatan']['nm_run_menu'] != 1))) {
...
<?php
           if (($nm_apl_dependente == 1) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_pembuatan']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_pembuatan']['dashboard_info']['under_dashboard']))) {
        $sCondStyle = ($this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_pembuatan']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_pembuatan']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_vclaim_sep_pembuatan");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_vclaim_sep_pembuatan");
 parent.scAjaxDetailHeight("form_vclaim_sep_pembuatan", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_pembuatan']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
