<?php
@session_start() ;
$_SESSION['scriptcase']['chart_diagnosa_top']['sc_process_barr'] = true;
require_once('../chart_diagnosa_top/index.php');
unset($_SESSION['scriptcase']['chart_diagnosa_top']['sc_process_barr']);
$ExportCtrl = new chart_diagnosa_top_export_control;
$ExportCtrl->Export_barr();

class chart_diagnosa_top_export_control
{
