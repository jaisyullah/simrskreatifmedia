...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____chart_diagnosa_top"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____chart_diagnosa_top"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['chart_diagnosa_top']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['chart_diagnosa_top']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['chart_diagnosa_top']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['chart_diagnosa_top']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['chart_diagnosa_top']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>chart_diagnosa_top</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['chart_diagnosa_top']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['chart_diagnosa_top']['embutida_filho'] as $ind => $sc_init)
          {
