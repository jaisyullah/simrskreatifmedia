  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_buku_pengeluaran_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_buku_pengeluaran_mob_form();
	}

  // ---------- Validate id_pbf
  function do_ajax_form_buku_pengeluaran_mob_validate_id_pbf()
  {
    var nomeCampo_id_pbf = "id_pbf";
    var var_id_pbf = scAjaxGetFieldText(nomeCampo_id_pbf);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_buku_pengeluaran_mob_validate_id_pbf(var_id_pbf, var_script_case_init, do_ajax_form_buku_pengeluaran_mob_validate_id_pbf_cb);
  } // do_ajax_form_buku_pengeluaran_mob_validate_id_pbf

  function do_ajax_form_buku_pengeluaran_mob_validate_id_pbf_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_buku_pengeluaran_mob_validate_id_pbf_cb

  // ---------- Validate id_hutang
  function do_ajax_form_buku_pengeluaran_mob_validate_id_hutang()
  {
    var nomeCampo_id_hutang = "id_hutang";
    var var_id_hutang = scAjaxGetFieldText(nomeCampo_id_hutang);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_buku_pengeluaran_mob_validate_id_hutang(var_id_hutang, var_script_case_init, do_ajax_form_buku_pengeluaran_mob_validate_id_hutang_cb);
  } // do_ajax_form_buku_pengeluaran_mob_validate_id_hutang

  function do_ajax_form_buku_pengeluaran_mob_validate_id_hutang_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id_hutang";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_buku_pengeluaran_mob_validate_id_hutang_cb

  // ---------- Validate no_referensi
  function do_ajax_form_buku_pengeluaran_mob_validate_no_referensi()
  {
    var nomeCampo_no_referensi = "no_referensi";
    var var_no_referensi = scAjaxGetFieldText(nomeCampo_no_referensi);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_buku_pengeluaran_mob_validate_no_referensi(var_no_referensi, var_script_case_init, do_ajax_form_buku_pengeluaran_mob_validate_no_referensi_cb);
  } // do_ajax_form_buku_pengeluaran_mob_validate_no_referensi

  function do_ajax_form_buku_pengeluaran_mob_validate_no_referensi_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "no_referensi";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_buku_pengeluaran_mob_validate_no_referensi_cb

  // ---------- Validate keterangan
  function do_ajax_form_buku_pengeluaran_mob_validate_keterangan()
  {
    var nomeCampo_keterangan = "keterangan";
    var var_keterangan = scAjaxGetFieldText(nomeCampo_keterangan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_buku_pengeluaran_mob_validate_keterangan(var_keterangan, var_script_case_init, do_ajax_form_buku_pengeluaran_mob_validate_keterangan_cb);
  } // do_ajax_form_buku_pengeluaran_mob_validate_keterangan

  function do_ajax_form_buku_pengeluaran_mob_validate_keterangan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_buku_pengeluaran_mob_validate_keterangan_cb

  // ---------- Validate tanggal
  function do_ajax_form_buku_pengeluaran_mob_validate_tanggal()
  {
    var nomeCampo_tanggal = "tanggal";
    var var_tanggal = scAjaxGetFieldText(nomeCampo_tanggal);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_buku_pengeluaran_mob_validate_tanggal(var_tanggal, var_script_case_init, do_ajax_form_buku_pengeluaran_mob_validate_tanggal_cb);
  } // do_ajax_form_buku_pengeluaran_mob_validate_tanggal

  function do_ajax_form_buku_pengeluaran_mob_validate_tanggal_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tanggal";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_buku_pengeluaran_mob_validate_tanggal_cb

  // ---------- Validate jumlah_bayar
  function do_ajax_form_buku_pengeluaran_mob_validate_jumlah_bayar()
  {
    var nomeCampo_jumlah_bayar = "jumlah_bayar";
    var var_jumlah_bayar = scAjaxGetFieldText(nomeCampo_jumlah_bayar);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_buku_pengeluaran_mob_validate_jumlah_bayar(var_jumlah_bayar, var_script_case_init, do_ajax_form_buku_pengeluaran_mob_validate_jumlah_bayar_cb);
  } // do_ajax_form_buku_pengeluaran_mob_validate_jumlah_bayar

  function do_ajax_form_buku_pengeluaran_mob_validate_jumlah_bayar_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "jumlah_bayar";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_buku_pengeluaran_mob_validate_jumlah_bayar_cb

  // ---------- Validate jenis_pembayaran
  function do_ajax_form_buku_pengeluaran_mob_validate_jenis_pembayaran()
  {
    var nomeCampo_jenis_pembayaran = "jenis_pembayaran";
    var var_jenis_pembayaran = scAjaxGetFieldSelect(nomeCampo_jenis_pembayaran);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_buku_pengeluaran_mob_validate_jenis_pembayaran(var_jenis_pembayaran, var_script_case_init, do_ajax_form_buku_pengeluaran_mob_validate_jenis_pembayaran_cb);
  } // do_ajax_form_buku_pengeluaran_mob_validate_jenis_pembayaran

  function do_ajax_form_buku_pengeluaran_mob_validate_jenis_pembayaran_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "jenis_pembayaran";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_buku_pengeluaran_mob_validate_jenis_pembayaran_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_buku_pengeluaran_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_buku_pengeluaran_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id_pbf = scAjaxGetFieldText("id_pbf");
    var var_id_hutang = scAjaxGetFieldText("id_hutang");
    var var_no_referensi = scAjaxGetFieldText("no_referensi");
    var var_keterangan = scAjaxGetFieldText("keterangan");
    var var_tanggal = scAjaxGetFieldText("tanggal");
    var var_jumlah_bayar = scAjaxGetFieldText("jumlah_bayar");
    var var_jenis_pembayaran = scAjaxGetFieldSelect("jenis_pembayaran");
    ...
    scAjaxProcOn();
    x_ajax_form_buku_pengeluaran_mob_submit_form(var_id_pbf, var_id_hutang, var_no_referensi, var_keterangan, var_tanggal, var_jumlah_bayar, var_jenis_pembayaran, var_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_buku_pengeluaran_mob_submit_form_cb);
  } // do_ajax_form_buku_pengeluaran_mob_submit_form

  function do_ajax_form_buku_pengeluaran_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("id_pbf");
      scAjaxHideErrorDisplay("id_hutang");
      scAjaxHideErrorDisplay("no_referensi");
      scAjaxHideErrorDisplay("keterangan");
      scAjaxHideErrorDisplay("tanggal");
      scAjaxHideErrorDisplay("jumlah_bayar");
      scAjaxHideErrorDisplay("jenis_pembayaran");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_buku_pengeluaran_mob_submit_form_cb_after_alert);
  } // do_ajax_form_buku_pengeluaran_mob_submit_form_cb
  function do_ajax_form_buku_pengeluaran_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_buku_pengeluaran_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_buku_pengeluaran_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_buku_pengeluaran_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_buku_pengeluaran_mob_navigate_form_cb);
  } // do_ajax_form_buku_pengeluaran_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_buku_pengeluaran_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_buku_pengeluaran_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_buku_pengeluaran_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_buku_pengeluaran_mob_navigate_form_cb
  function do_ajax_form_buku_pengeluaran_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_buku_pengeluaran_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_buku_pengeluaran_mob_navigate_form_cb_after_alert
  function sc_hide_form_buku_pengeluaran_mob_form()
  {
  ...
  ajax_field_list[0] = "id_pbf";
  ajax_field_list[1] = "id_hutang";
  ajax_field_list[2] = "no_referensi";
  ajax_field_list[3] = "keterangan";
  ajax_field_list[4] = "tanggal";
  ajax_field_list[5] = "jumlah_bayar";
  ajax_field_list[6] = "jenis_pembayaran";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "id_pbf": {"label": "Vendor", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "id_hutang": {"label": "Id Hutang", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "no_referensi": {"label": "No Referensi", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "tanggal": {"label": "Tanggal", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "jumlah_bayar": {"label": "Jumlah Bayar", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "jenis_pembayaran": {"label": "Jenis Pembayaran", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "id_pbf": new Array(),
    "id_hutang": new Array(),
    "no_referensi": new Array(),
    "keterangan": new Array(),
    "tanggal": new Array(),
    "jumlah_bayar": new Array(),
    "jenis_pembayaran": new Array()
  };
  ajax_field_mult["id_pbf"][1] = "id_pbf";
  ajax_field_mult["id_hutang"][1] = "id_hutang";
  ajax_field_mult["no_referensi"][1] = "no_referensi";
  ajax_field_mult["keterangan"][1] = "keterangan";
  ajax_field_mult["tanggal"][1] = "tanggal";
  ajax_field_mult["jumlah_bayar"][1] = "jumlah_bayar";
  ajax_field_mult["jenis_pembayaran"][1] = "jenis_pembayaran";

  var ajax_field_id = {
    "id_pbf": new Array("hidden_field_label_id_pbf", "hidden_field_data_id_pbf"),
    "id_hutang": new Array("hidden_field_label_id_hutang", "hidden_field_data_id_hutang"),
    "no_referensi": new Array("hidden_field_label_no_referensi", "hidden_field_data_no_referensi"),
    "keterangan": new Array("hidden_field_label_keterangan", "hidden_field_data_keterangan"),
    "tanggal": new Array("hidden_field_label_tanggal", "hidden_field_data_tanggal"),
    "jumlah_bayar": new Array("hidden_field_label_jumlah_bayar", "hidden_field_data_jumlah_bayar"),
    "jenis_pembayaran": new Array("hidden_field_label_jenis_pembayaran", "hidden_field_data_jenis_pembayaran")
  };
