  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbtarifri" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbtarifri_form();
	}

  // ---------- Validate kelas_
  function do_ajax_form_tbtarifri_validate_kelas_(iNumLinha)
  {
    var nomeCampo_kelas_ = "kelas_" + iNumLinha;
    var var_kelas_ = scAjaxGetFieldSelect(nomeCampo_kelas_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtarifri_validate_kelas_(var_kelas_, iNumLinha, var_script_case_init, do_ajax_form_tbtarifri_validate_kelas__cb);
  } // do_ajax_form_tbtarifri_validate_kelas_

  function do_ajax_form_tbtarifri_validate_kelas__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtarifri_validate_kelas__cb

  // ---------- Validate jenisbayar_
  function do_ajax_form_tbtarifri_validate_jenisbayar_(iNumLinha)
  {
    var nomeCampo_jenisbayar_ = "jenisbayar_" + iNumLinha;
    var var_jenisbayar_ = scAjaxGetFieldSelect(nomeCampo_jenisbayar_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtarifri_validate_jenisbayar_(var_jenisbayar_, iNumLinha, var_script_case_init, do_ajax_form_tbtarifri_validate_jenisbayar__cb);
  } // do_ajax_form_tbtarifri_validate_jenisbayar_

  function do_ajax_form_tbtarifri_validate_jenisbayar__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "jenisbayar_" + iLineNumber;
    }
    else
    {
      sFieldValid = "jenisbayar_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "jenisbayar_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "jenisbayar_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtarifri_validate_jenisbayar__cb

  // ---------- Validate tarif_
  function do_ajax_form_tbtarifri_validate_tarif_(iNumLinha)
  {
    var nomeCampo_tarif_ = "tarif_" + iNumLinha;
    var var_tarif_ = scAjaxGetFieldText(nomeCampo_tarif_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtarifri_validate_tarif_(var_tarif_, iNumLinha, var_script_case_init, do_ajax_form_tbtarifri_validate_tarif__cb);
  } // do_ajax_form_tbtarifri_validate_tarif_

  function do_ajax_form_tbtarifri_validate_tarif__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "tarif_" + iLineNumber;
    }
    else
    {
      sFieldValid = "tarif_";
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "tarif_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "tarif_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtarifri_validate_tarif__cb

  // ---------- Validate sharedoc_
  function do_ajax_form_tbtarifri_validate_sharedoc_(iNumLinha)
  {
    var nomeCampo_sharedoc_ = "sharedoc_" + iNumLinha;
    var var_sharedoc_ = scAjaxGetFieldText(nomeCampo_sharedoc_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtarifri_validate_sharedoc_(var_sharedoc_, iNumLinha, var_script_case_init, do_ajax_form_tbtarifri_validate_sharedoc__cb);
  } // do_ajax_form_tbtarifri_validate_sharedoc_

  function do_ajax_form_tbtarifri_validate_sharedoc__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "sharedoc_" + iLineNumber;
    }
    else
    {
      sFieldValid = "sharedoc_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "sharedoc_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "sharedoc_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtarifri_validate_sharedoc__cb

  // ---------- Validate kodetindakan_
  function do_ajax_form_tbtarifri_validate_kodetindakan_(iNumLinha)
  {
    var nomeCampo_kodetindakan_ = "kodetindakan_" + iNumLinha;
    var var_kodetindakan_ = scAjaxGetFieldText(nomeCampo_kodetindakan_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtarifri_validate_kodetindakan_(var_kodetindakan_, iNumLinha, var_script_case_init, do_ajax_form_tbtarifri_validate_kodetindakan__cb);
  } // do_ajax_form_tbtarifri_validate_kodetindakan_

  function do_ajax_form_tbtarifri_validate_kodetindakan__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "kodetindakan_" + iLineNumber;
    }
    else
    {
      sFieldValid = "kodetindakan_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "kodetindakan_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "kodetindakan_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtarifri_validate_kodetindakan__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_tbtarifri_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_tbtarifri_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tbtarifri_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_tbtarifri_add_new_line_cb);
  } // do_ajax_form_tbtarifri_add_new_line

  function do_ajax_form_tbtarifri_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_tbtarifri_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_tbtarifri_backup_line(iNumLinha)
  {
    var var_kodetindakan_ = scAjaxGetFieldText("kodetindakan_" + iNumLinha);
    var var_kelas_ = scAjaxGetFieldSelect("kelas_" + iNumLinha);
    var var_jenisbayar_ = scAjaxGetFieldSelect("jenisbayar_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtarifri_backup_line(var_kodetindakan_, var_kelas_, var_jenisbayar_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_tbtarifri_backup_line_cb);
  } // do_ajax_form_tbtarifri_backup_line

  function do_ajax_form_tbtarifri_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_tbtarifri_backup_line_cb

  function do_ajax_form_tbtarifri_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_tbtarifri_cancel_insert

  function do_ajax_form_tbtarifri_cancel_update(iSeqVert)
  {
    do_ajax_form_tbtarifri_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_tbtarifri_cancel_update

  function do_ajax_form_tbtarifri_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_tbtarifri_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_tbtarifri_table_refresh()
  {
    var var_kodetindakan_ = document.F2.kodetindakan_.value;
    var var_kelas_ = document.F2.kelas_.value;
    var var_jenisbayar_ = document.F2.jenisbayar_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_tbtarifri_table_refresh(var_kodetindakan_, var_kelas_, var_jenisbayar_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbtarifri_table_refresh_cb);
  } //  do_ajax_form_tbtarifri_table_refresh

  function do_ajax_form_tbtarifri_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.kodetindakan_.value = scAjaxGetKeyValue("kodetindakan_");
    document.F2.kelas_.value = scAjaxGetKeyValue("kelas_");
    document.F2.jenisbayar_.value = scAjaxGetKeyValue("jenisbayar_");
    ...
    scAjaxAlert(do_ajax_form_tbtarifri_table_refresh_cb_after_alert);
  } // do_ajax_form_tbtarifri_table_refresh_cb
  function do_ajax_form_tbtarifri_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_tbtarifri_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_tbtarifri_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_tbtarifri_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    var var_kelas_ = scAjaxGetFieldSelect("kelas_" + iNumLinha);
    var var_jenisbayar_ = scAjaxGetFieldSelect("jenisbayar_" + iNumLinha);
    var var_tarif_ = scAjaxGetFieldText("tarif_" + iNumLinha);
    var var_sharedoc_ = scAjaxGetFieldText("sharedoc_" + iNumLinha);
    var var_kodetindakan_ = scAjaxGetFieldText("kodetindakan_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_tbtarifri_submit_form(var_kelas_, var_jenisbayar_, var_tarif_, var_sharedoc_, var_kodetindakan_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbtarifri_submit_form_cb);
  } // do_ajax_form_tbtarifri_submit_form

  function do_ajax_form_tbtarifri_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("jenisbayar_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("tarif_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("sharedoc_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("kodetindakan_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_tbtarifri_submit_form_cb_after_alert);
  } // do_ajax_form_tbtarifri_submit_form_cb
  function do_ajax_form_tbtarifri_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbtarifri_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tbtarifri_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_tbtarifri_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("jenisbayar_" + iNavForm);
      scAjaxHideErrorDisplay("tarif_" + iNavForm);
      scAjaxHideErrorDisplay("sharedoc_" + iNavForm);
      scAjaxHideErrorDisplay("kodetindakan_" + iNavForm);
    }
    var var_kodetindakan_ = document.F2.kodetindakan_.value;
    var var_kelas_ = document.F2.kelas_.value;
    var var_jenisbayar_ = document.F2.jenisbayar_.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tbtarifri_navigate_form(var_kodetindakan_, var_kelas_, var_jenisbayar_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbtarifri_navigate_form_cb);
  } // do_ajax_form_tbtarifri_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtarifri']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbtarifri_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.kodetindakan_.value = scAjaxGetKeyValue("kodetindakan_" + var_last_index);
    document.F2.kelas_.value = scAjaxGetKeyValue("kelas_" + var_last_index);
    document.F2.jenisbayar_.value = scAjaxGetKeyValue("jenisbayar_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbtarifri_navigate_form_cb_after_alert);
  } // do_ajax_form_tbtarifri_navigate_form_cb
  function do_ajax_form_tbtarifri_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_tbtarifri_navigate_form_cb_after_alert
  function sc_hide_form_tbtarifri_form()
  {
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "jenisbayar_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "tarif_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "sharedoc_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "kodetindakan_" + iNumLinha;
    iTotCampos++;
    ...
    ajax_error_list["jenisbayar_" + iNumLinha] = {"label": "Jenis Bayar<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["tarif_" + iNumLinha] = {"label": "Tarif<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["sharedoc_" + iNumLinha] = {"label": "Share Doc<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["kodetindakan_" + iNumLinha] = {"label": "Kode Tindakan<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["kelas_"][iNumLinha] = "kelas_" + iNumLinha;
    ajax_field_mult["jenisbayar_"][iNumLinha] = "jenisbayar_" + iNumLinha;
    ajax_field_mult["tarif_"][iNumLinha] = "tarif_" + iNumLinha;
    ajax_field_mult["sharedoc_"][iNumLinha] = "sharedoc_" + iNumLinha;
    ajax_field_mult["kodetindakan_"][iNumLinha] = "kodetindakan_" + iNumLinha;
    ajax_field_id["kelas_" + iNumLinha] = new Array("hidden_field_label_kelas_", "hidden_field_data_kelas_" + iNumLinha);
    ajax_field_id["jenisbayar_" + iNumLinha] = new Array("hidden_field_label_jenisbayar_", "hidden_field_data_jenisbayar_" + iNumLinha);
    ajax_field_id["tarif_" + iNumLinha] = new Array("hidden_field_label_tarif_", "hidden_field_data_tarif_" + iNumLinha);
    ajax_field_id["sharedoc_" + iNumLinha] = new Array("hidden_field_label_sharedoc_", "hidden_field_data_sharedoc_" + iNumLinha);
    ajax_error_count["kelas_" + iNumLinha] = "off";
    ajax_error_count["jenisbayar_" + iNumLinha] = "off";
    ajax_error_count["tarif_" + iNumLinha] = "off";
    ajax_error_count["sharedoc_" + iNumLinha] = "off";
    ajax_error_count["kodetindakan_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["kelas_" + iNumLinha] = "on";
    ajax_read_only["jenisbayar_" + iNumLinha] = "on";
    ajax_read_only["tarif_" + iNumLinha] = "off";
    ajax_read_only["sharedoc_" + iNumLinha] = "off";
    ajax_read_only["kodetindakan_" + iNumLinha] = "on";
<?php
}
else
{
?>
    ajax_read_only["kelas_" + iNumLinha] = "on";
    ajax_read_only["jenisbayar_" + iNumLinha] = "on";
    ajax_read_only["tarif_" + iNumLinha] = "on";
    ajax_read_only["sharedoc_" + iNumLinha] = "on";
    ajax_read_only["kodetindakan_" + iNumLinha] = "on";
<?php
}
?>
  ...
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["jenisbayar_" + iNumLinha] = null;
    ajax_error_list["tarif_" + iNumLinha] = null;
    ajax_error_list["sharedoc_" + iNumLinha] = null;
    ajax_error_list["kodetindakan_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "kelas_": new Array(),
    "jenisbayar_": new Array(),
    "tarif_": new Array(),
    "sharedoc_": new Array(),
    "kodetindakan_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["jenisbayar_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["jenisbayar_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["jenisbayar_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["jenisbayar_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["jenisbayar_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["tarif_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["tarif_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["tarif_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["tarif_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["tarif_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["sharedoc_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["sharedoc_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["sharedoc_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["sharedoc_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["sharedoc_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["kodetindakan_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["kodetindakan_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["kodetindakan_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["kodetindakan_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["kodetindakan_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['kelas_'])) ? $this->nmgp_cmp_readonly['kelas_'] : 'on';
?>
    scAjaxFieldRead("kelas_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['jenisbayar_'])) ? $this->nmgp_cmp_readonly['jenisbayar_'] : 'on';
?>
    scAjaxFieldRead("jenisbayar_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['tarif_'])) ? $this->nmgp_cmp_readonly['tarif_'] : 'off';
?>
    scAjaxFieldRead("tarif_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['sharedoc_'])) ? $this->nmgp_cmp_readonly['sharedoc_'] : 'off';
?>
    scAjaxFieldRead("sharedoc_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['kodetindakan_'])) ? $this->nmgp_cmp_readonly['kodetindakan_'] : 'on';
?>
    scAjaxFieldRead("kodetindakan_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("kelas_" + iSeq, "on");
    scAjaxFieldRead("jenisbayar_" + iSeq, "on");
    scAjaxFieldRead("tarif_" + iSeq, "on");
    scAjaxFieldRead("sharedoc_" + iSeq, "on");
    scAjaxFieldRead("kodetindakan_" + iSeq, "on");
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["kelas_" + iRow] || "on" == ajax_error_count["jenisbayar_" + iRow] || "on" == ajax_error_count["tarif_" + iRow] || "on" == ajax_error_count["sharedoc_" + iRow] || "on" == ajax_error_count["kodetindakan_" + iRow]))
    {
      ...
      $("#hidden_field_data_jenisbayar_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_tarif_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sharedoc_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_kodetindakan_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["kelas_" + iRow] && "off" == ajax_error_count["jenisbayar_" + iRow] && "off" == ajax_error_count["tarif_" + iRow] && "off" == ajax_error_count["sharedoc_" + iRow] && "off" == ajax_error_count["kodetindakan_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["kelas_" + iRow] = "off";
        ajax_error_count["jenisbayar_" + iRow] = "off";
        ajax_error_count["tarif_" + iRow] = "off";
        ajax_error_count["sharedoc_" + iRow] = "off";
        ajax_error_count["kodetindakan_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_jenisbayar_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_tarif_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_sharedoc_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_kodetindakan_" + iRow).removeClass("scFormErrorLine");
    }
  }
