  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_vclaim_lpk_update_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_vclaim_lpk_update_mob_form();
	}

  // ---------- Validate nosep
  function do_ajax_form_vclaim_lpk_update_mob_validate_nosep()
  {
    var nomeCampo_nosep = "nosep";
    var var_nosep = scAjaxGetFieldText(nomeCampo_nosep);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_lpk_update_mob_validate_nosep(var_nosep, var_script_case_init, do_ajax_form_vclaim_lpk_update_mob_validate_nosep_cb);
  } // do_ajax_form_vclaim_lpk_update_mob_validate_nosep

  function do_ajax_form_vclaim_lpk_update_mob_validate_nosep_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_lpk_update_mob_validate_nosep_cb

  // ---------- Validate tglmasuk
  function do_ajax_form_vclaim_lpk_update_mob_validate_tglmasuk()
  {
    var nomeCampo_tglmasuk = "tglmasuk";
    var var_tglmasuk = scAjaxGetFieldText(nomeCampo_tglmasuk);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_lpk_update_mob_validate_tglmasuk(var_tglmasuk, var_script_case_init, do_ajax_form_vclaim_lpk_update_mob_validate_tglmasuk_cb);
  } // do_ajax_form_vclaim_lpk_update_mob_validate_tglmasuk

  function do_ajax_form_vclaim_lpk_update_mob_validate_tglmasuk_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_lpk_update_mob_validate_tglmasuk_cb

  // ---------- Validate tglkeluar
  function do_ajax_form_vclaim_lpk_update_mob_validate_tglkeluar()
  {
    var nomeCampo_tglkeluar = "tglkeluar";
    var var_tglkeluar = scAjaxGetFieldText(nomeCampo_tglkeluar);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_lpk_update_mob_validate_tglkeluar(var_tglkeluar, var_script_case_init, do_ajax_form_vclaim_lpk_update_mob_validate_tglkeluar_cb);
  } // do_ajax_form_vclaim_lpk_update_mob_validate_tglkeluar

  function do_ajax_form_vclaim_lpk_update_mob_validate_tglkeluar_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_lpk_update_mob_validate_tglkeluar_cb

  // ---------- Validate jaminan
  function do_ajax_form_vclaim_lpk_update_mob_validate_jaminan()
  {
    var nomeCampo_jaminan = "jaminan";
    var var_jaminan = scAjaxGetFieldText(nomeCampo_jaminan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_lpk_update_mob_validate_jaminan(var_jaminan, var_script_case_init, do_ajax_form_vclaim_lpk_update_mob_validate_jaminan_cb);
  } // do_ajax_form_vclaim_lpk_update_mob_validate_jaminan

  function do_ajax_form_vclaim_lpk_update_mob_validate_jaminan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "jaminan";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_lpk_update_mob_validate_jaminan_cb

  // ---------- Validate poli
  function do_ajax_form_vclaim_lpk_update_mob_validate_poli()
  {
    var nomeCampo_poli = "poli";
    var var_poli = scAjaxGetFieldText(nomeCampo_poli);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_lpk_update_mob_validate_poli(var_poli, var_script_case_init, do_ajax_form_vclaim_lpk_update_mob_validate_poli_cb);
  } // do_ajax_form_vclaim_lpk_update_mob_validate_poli

  function do_ajax_form_vclaim_lpk_update_mob_validate_poli_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "poli";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_lpk_update_mob_validate_poli_cb

  // ---------- Validate nmpoli
  function do_ajax_form_vclaim_lpk_update_mob_validate_nmpoli()
  {
    var nomeCampo_nmpoli = "nmpoli";
    var var_nmpoli = scAjaxGetFieldText(nomeCampo_nmpoli);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_lpk_update_mob_validate_nmpoli(var_nmpoli, var_script_case_init, do_ajax_form_vclaim_lpk_update_mob_validate_nmpoli_cb);
  } // do_ajax_form_vclaim_lpk_update_mob_validate_nmpoli

  function do_ajax_form_vclaim_lpk_update_mob_validate_nmpoli_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nmpoli";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_lpk_update_mob_validate_nmpoli_cb

  // ---------- Validate ruangrawat
  function do_ajax_form_vclaim_lpk_update_mob_validate_ruangrawat()
  {
    var nomeCampo_ruangrawat = "ruangrawat";
    var var_ruangrawat = scAjaxGetFieldText(nomeCampo_ruangrawat);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_lpk_update_mob_validate_ruangrawat(var_ruangrawat, var_script_case_init, do_ajax_form_vclaim_lpk_update_mob_validate_ruangrawat_cb);
  } // do_ajax_form_vclaim_lpk_update_mob_validate_ruangrawat

  function do_ajax_form_vclaim_lpk_update_mob_validate_ruangrawat_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ruangrawat";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_lpk_update_mob_validate_ruangrawat_cb

  // ---------- Validate kelasrawat
  function do_ajax_form_vclaim_lpk_update_mob_validate_kelasrawat()
  {
    var nomeCampo_kelasrawat = "kelasrawat";
    var var_kelasrawat = scAjaxGetFieldText(nomeCampo_kelasrawat);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_lpk_update_mob_validate_kelasrawat(var_kelasrawat, var_script_case_init, do_ajax_form_vclaim_lpk_update_mob_validate_kelasrawat_cb);
  } // do_ajax_form_vclaim_lpk_update_mob_validate_kelasrawat

  function do_ajax_form_vclaim_lpk_update_mob_validate_kelasrawat_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "kelasrawat";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_lpk_update_mob_validate_kelasrawat_cb

  // ---------- Validate spesialistik
  function do_ajax_form_vclaim_lpk_update_mob_validate_spesialistik()
  {
    var nomeCampo_spesialistik = "spesialistik";
    var var_spesialistik = scAjaxGetFieldText(nomeCampo_spesialistik);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_lpk_update_mob_validate_spesialistik(var_spesialistik, var_script_case_init, do_ajax_form_vclaim_lpk_update_mob_validate_spesialistik_cb);
  } // do_ajax_form_vclaim_lpk_update_mob_validate_spesialistik

  function do_ajax_form_vclaim_lpk_update_mob_validate_spesialistik_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "spesialistik";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_lpk_update_mob_validate_spesialistik_cb

  // ---------- Validate carakeluar
  function do_ajax_form_vclaim_lpk_update_mob_validate_carakeluar()
  {
    var nomeCampo_carakeluar = "carakeluar";
    var var_carakeluar = scAjaxGetFieldText(nomeCampo_carakeluar);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_lpk_update_mob_validate_carakeluar(var_carakeluar, var_script_case_init, do_ajax_form_vclaim_lpk_update_mob_validate_carakeluar_cb);
  } // do_ajax_form_vclaim_lpk_update_mob_validate_carakeluar

  function do_ajax_form_vclaim_lpk_update_mob_validate_carakeluar_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_lpk_update_mob_validate_carakeluar_cb

  // ---------- Validate kondisipulang
  function do_ajax_form_vclaim_lpk_update_mob_validate_kondisipulang()
  {
    var nomeCampo_kondisipulang = "kondisipulang";
    var var_kondisipulang = scAjaxGetFieldText(nomeCampo_kondisipulang);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_lpk_update_mob_validate_kondisipulang(var_kondisipulang, var_script_case_init, do_ajax_form_vclaim_lpk_update_mob_validate_kondisipulang_cb);
  } // do_ajax_form_vclaim_lpk_update_mob_validate_kondisipulang

  function do_ajax_form_vclaim_lpk_update_mob_validate_kondisipulang_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "kondisipulang";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_lpk_update_mob_validate_kondisipulang_cb

  // ---------- Validate diagnosa
  function do_ajax_form_vclaim_lpk_update_mob_validate_diagnosa()
  {
    var nomeCampo_diagnosa = "diagnosa";
    var var_diagnosa = scAjaxGetFieldText(nomeCampo_diagnosa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_lpk_update_mob_validate_diagnosa(var_diagnosa, var_script_case_init, do_ajax_form_vclaim_lpk_update_mob_validate_diagnosa_cb);
  } // do_ajax_form_vclaim_lpk_update_mob_validate_diagnosa

  function do_ajax_form_vclaim_lpk_update_mob_validate_diagnosa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_lpk_update_mob_validate_diagnosa_cb

  // ---------- Validate procedure
  function do_ajax_form_vclaim_lpk_update_mob_validate_procedure()
  {
    var nomeCampo_procedure = "procedure";
    var var_procedure = scAjaxGetFieldText(nomeCampo_procedure);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_lpk_update_mob_validate_procedure(var_procedure, var_script_case_init, do_ajax_form_vclaim_lpk_update_mob_validate_procedure_cb);
  } // do_ajax_form_vclaim_lpk_update_mob_validate_procedure

  function do_ajax_form_vclaim_lpk_update_mob_validate_procedure_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_lpk_update_mob_validate_procedure_cb

  // ---------- Validate tindaklanjut
  function do_ajax_form_vclaim_lpk_update_mob_validate_tindaklanjut()
  {
    var nomeCampo_tindaklanjut = "tindaklanjut";
    var var_tindaklanjut = scAjaxGetFieldText(nomeCampo_tindaklanjut);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_lpk_update_mob_validate_tindaklanjut(var_tindaklanjut, var_script_case_init, do_ajax_form_vclaim_lpk_update_mob_validate_tindaklanjut_cb);
  } // do_ajax_form_vclaim_lpk_update_mob_validate_tindaklanjut

  function do_ajax_form_vclaim_lpk_update_mob_validate_tindaklanjut_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tindaklanjut";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_lpk_update_mob_validate_tindaklanjut_cb

  // ---------- Validate dirujukkodeppk
  function do_ajax_form_vclaim_lpk_update_mob_validate_dirujukkodeppk()
  {
    var nomeCampo_dirujukkodeppk = "dirujukkodeppk";
    var var_dirujukkodeppk = scAjaxGetFieldText(nomeCampo_dirujukkodeppk);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_lpk_update_mob_validate_dirujukkodeppk(var_dirujukkodeppk, var_script_case_init, do_ajax_form_vclaim_lpk_update_mob_validate_dirujukkodeppk_cb);
  } // do_ajax_form_vclaim_lpk_update_mob_validate_dirujukkodeppk

  function do_ajax_form_vclaim_lpk_update_mob_validate_dirujukkodeppk_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "dirujukkodeppk";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_lpk_update_mob_validate_dirujukkodeppk_cb

  // ---------- Validate tglkontrol
  function do_ajax_form_vclaim_lpk_update_mob_validate_tglkontrol()
  {
    var nomeCampo_tglkontrol = "tglkontrol";
    var var_tglkontrol = scAjaxGetFieldText(nomeCampo_tglkontrol);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_lpk_update_mob_validate_tglkontrol(var_tglkontrol, var_script_case_init, do_ajax_form_vclaim_lpk_update_mob_validate_tglkontrol_cb);
  } // do_ajax_form_vclaim_lpk_update_mob_validate_tglkontrol

  function do_ajax_form_vclaim_lpk_update_mob_validate_tglkontrol_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tglkontrol";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_lpk_update_mob_validate_tglkontrol_cb

  // ---------- Validate polikontrolkembali
  function do_ajax_form_vclaim_lpk_update_mob_validate_polikontrolkembali()
  {
    var nomeCampo_polikontrolkembali = "polikontrolkembali";
    var var_polikontrolkembali = scAjaxGetFieldText(nomeCampo_polikontrolkembali);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_lpk_update_mob_validate_polikontrolkembali(var_polikontrolkembali, var_script_case_init, do_ajax_form_vclaim_lpk_update_mob_validate_polikontrolkembali_cb);
  } // do_ajax_form_vclaim_lpk_update_mob_validate_polikontrolkembali

  function do_ajax_form_vclaim_lpk_update_mob_validate_polikontrolkembali_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "polikontrolkembali";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_lpk_update_mob_validate_polikontrolkembali_cb

  // ---------- Validate dpjp
  function do_ajax_form_vclaim_lpk_update_mob_validate_dpjp()
  {
    var nomeCampo_dpjp = "dpjp";
    var var_dpjp = scAjaxGetFieldText(nomeCampo_dpjp);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_lpk_update_mob_validate_dpjp(var_dpjp, var_script_case_init, do_ajax_form_vclaim_lpk_update_mob_validate_dpjp_cb);
  } // do_ajax_form_vclaim_lpk_update_mob_validate_dpjp

  function do_ajax_form_vclaim_lpk_update_mob_validate_dpjp_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "dpjp";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_lpk_update_mob_validate_dpjp_cb

  // ---------- Validate user
  function do_ajax_form_vclaim_lpk_update_mob_validate_user()
  {
    var nomeCampo_user = "user";
    var var_user = scAjaxGetFieldText(nomeCampo_user);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_lpk_update_mob_validate_user(var_user, var_script_case_init, do_ajax_form_vclaim_lpk_update_mob_validate_user_cb);
  } // do_ajax_form_vclaim_lpk_update_mob_validate_user

  function do_ajax_form_vclaim_lpk_update_mob_validate_user_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "user";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_lpk_update_mob_validate_user_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_vclaim_lpk_update_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_vclaim_lpk_update_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    var var_jaminan = scAjaxGetFieldText("jaminan");
    var var_poli = scAjaxGetFieldText("poli");
    var var_nmpoli = scAjaxGetFieldText("nmpoli");
    var var_ruangrawat = scAjaxGetFieldText("ruangrawat");
    var var_kelasrawat = scAjaxGetFieldText("kelasrawat");
    var var_spesialistik = scAjaxGetFieldText("spesialistik");
    var var_carakeluar = scAjaxGetFieldText("carakeluar");
    var var_kondisipulang = scAjaxGetFieldText("kondisipulang");
    var var_diagnosa = scAjaxGetFieldText("diagnosa");
    var var_procedure = scAjaxGetFieldText("procedure");
    var var_tindaklanjut = scAjaxGetFieldText("tindaklanjut");
    var var_dirujukkodeppk = scAjaxGetFieldText("dirujukkodeppk");
    var var_tglkontrol = scAjaxGetFieldText("tglkontrol");
    var var_polikontrolkembali = scAjaxGetFieldText("polikontrolkembali");
    var var_dpjp = scAjaxGetFieldText("dpjp");
    ...
    scAjaxProcOn();
    x_ajax_form_vclaim_lpk_update_mob_submit_form(var_nosep, var_tglmasuk, var_tglkeluar, var_jaminan, var_poli, var_nmpoli, var_ruangrawat, var_kelasrawat, var_spesialistik, var_carakeluar, var_kondisipulang, var_diagnosa, var_procedure, var_tindaklanjut, var_dirujukkodeppk, var_tglkontrol, var_polikontrolkembali, var_dpjp, var_user, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_vclaim_lpk_update_mob_submit_form_cb);
  } // do_ajax_form_vclaim_lpk_update_mob_submit_form

  function do_ajax_form_vclaim_lpk_update_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_vclaim_lpk_update_mob_submit_form_cb_after_alert);
  } // do_ajax_form_vclaim_lpk_update_mob_submit_form_cb
  function do_ajax_form_vclaim_lpk_update_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_vclaim_lpk_update_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_vclaim_lpk_update_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_form_vclaim_lpk_update_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_lpk_update_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_vclaim_lpk_update_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_vclaim_lpk_update_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_vclaim_lpk_update_mob_navigate_form_cb
  function do_ajax_form_vclaim_lpk_update_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_vclaim_lpk_update_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_vclaim_lpk_update_mob_navigate_form_cb_after_alert
  function sc_hide_form_vclaim_lpk_update_mob_form()
  {
  ...
  ajax_field_list[0] = "nosep";
  ajax_field_list[1] = "tglmasuk";
  ajax_field_list[2] = "tglkeluar";
  ajax_field_list[3] = "jaminan";
  ajax_field_list[4] = "poli";
  ajax_field_list[5] = "nmpoli";
  ajax_field_list[6] = "ruangrawat";
  ajax_field_list[7] = "kelasrawat";
  ajax_field_list[8] = "spesialistik";
  ajax_field_list[9] = "carakeluar";
  ajax_field_list[10] = "kondisipulang";
  ajax_field_list[11] = "diagnosa";
  ajax_field_list[12] = "procedure";
  ajax_field_list[13] = "tindaklanjut";
  ajax_field_list[14] = "dirujukkodeppk";
  ajax_field_list[15] = "tglkontrol";
  ajax_field_list[16] = "polikontrolkembali";
  ajax_field_list[17] = "dpjp";
  ajax_field_list[18] = "user";
  ...
  var ajax_error_list = {
    ...
    "tglmasuk": {"label": "Tanggal Masuk", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "tglkeluar": {"label": "Tanggal Keluar", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "jaminan": {"label": "Jaminan", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "poli": {"label": "Poli", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "nmpoli": {"label": "Nama Poli", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "ruangrawat": {"label": "Ruang Rawat", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "kelasrawat": {"label": "Kelas Rawat", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "spesialistik": {"label": "Spesialistik", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "kondisipulang": {"label": "Kondisi Pulang", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "tindaklanjut": {"label": "Tindak Lanjut", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "dirujukkodeppk": {"label": "Dirujuk ke PPK", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "tglkontrol": {"label": "Tanggal Kontrol", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "polikontrolkembali": {"label": "Poli Kontrol Kembali", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "dpjp": {"label": "DPJP", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  var ajax_field_mult = {
    ...
    "poli": new Array(),
    "nmpoli": new Array(),
    "ruangrawat": new Array(),
    "kelasrawat": new Array(),
    "spesialistik": new Array(),
    "carakeluar": new Array(),
    "kondisipulang": new Array(),
    "diagnosa": new Array(),
    "procedure": new Array(),
    "tindaklanjut": new Array(),
    "dirujukkodeppk": new Array(),
    "tglkontrol": new Array(),
    "polikontrolkembali": new Array(),
    "dpjp": new Array(),
    "user": new Array()
  };
  ...
  ajax_field_mult["jaminan"][1] = "jaminan";
  ajax_field_mult["poli"][1] = "poli";
  ajax_field_mult["nmpoli"][1] = "nmpoli";
  ajax_field_mult["ruangrawat"][1] = "ruangrawat";
  ajax_field_mult["kelasrawat"][1] = "kelasrawat";
  ajax_field_mult["spesialistik"][1] = "spesialistik";
  ajax_field_mult["carakeluar"][1] = "carakeluar";
  ajax_field_mult["kondisipulang"][1] = "kondisipulang";
  ajax_field_mult["diagnosa"][1] = "diagnosa";
  ajax_field_mult["procedure"][1] = "procedure";
  ajax_field_mult["tindaklanjut"][1] = "tindaklanjut";
  ajax_field_mult["dirujukkodeppk"][1] = "dirujukkodeppk";
  ajax_field_mult["tglkontrol"][1] = "tglkontrol";
  ajax_field_mult["polikontrolkembali"][1] = "polikontrolkembali";
  ajax_field_mult["dpjp"][1] = "dpjp";
  ajax_field_mult["user"][1] = "user";

  var ajax_field_id = {
    "nosep": new Array("hidden_field_label_nosep", "hidden_field_data_nosep"),
    "tglmasuk": new Array("hidden_field_label_tglmasuk", "hidden_field_data_tglmasuk"),
    "tglkeluar": new Array("hidden_field_label_tglkeluar", "hidden_field_data_tglkeluar"),
    "jaminan": new Array("hidden_field_label_jaminan", "hidden_field_data_jaminan"),
    "poli": new Array("hidden_field_label_poli", "hidden_field_data_poli"),
    "nmpoli": new Array("hidden_field_label_nmpoli", "hidden_field_data_nmpoli"),
    "ruangrawat": new Array("hidden_field_label_ruangrawat", "hidden_field_data_ruangrawat"),
    "kelasrawat": new Array("hidden_field_label_kelasrawat", "hidden_field_data_kelasrawat"),
    "spesialistik": new Array("hidden_field_label_spesialistik", "hidden_field_data_spesialistik"),
    "carakeluar": new Array("hidden_field_label_carakeluar", "hidden_field_data_carakeluar"),
    "kondisipulang": new Array("hidden_field_label_kondisipulang", "hidden_field_data_kondisipulang"),
    ...
    "tindaklanjut": new Array("hidden_field_label_tindaklanjut", "hidden_field_data_tindaklanjut"),
    "dirujukkodeppk": new Array("hidden_field_label_dirujukkodeppk", "hidden_field_data_dirujukkodeppk"),
    "tglkontrol": new Array("hidden_field_label_tglkontrol", "hidden_field_data_tglkontrol"),
    "polikontrolkembali": new Array("hidden_field_label_polikontrolkembali", "hidden_field_data_polikontrolkembali"),
    "dpjp": new Array("hidden_field_label_dpjp", "hidden_field_data_dpjp"),
