  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_vclaim_lpk_update" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_vclaim_lpk_update_form();
	}

  // ---------- Validate nosep
  function do_ajax_form_vclaim_lpk_update_validate_nosep()
  {
    var nomeCampo_nosep = "nosep";
    var var_nosep = scAjaxGetFieldText(nomeCampo_nosep);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_lpk_update_validate_nosep(var_nosep, var_script_case_init, do_ajax_form_vclaim_lpk_update_validate_nosep_cb);
  } // do_ajax_form_vclaim_lpk_update_validate_nosep

  function do_ajax_form_vclaim_lpk_update_validate_nosep_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_lpk_update_validate_nosep_cb

  // ---------- Validate tglmasuk
  function do_ajax_form_vclaim_lpk_update_validate_tglmasuk()
  {
    var nomeCampo_tglmasuk = "tglmasuk";
    var var_tglmasuk = scAjaxGetFieldText(nomeCampo_tglmasuk);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_lpk_update_validate_tglmasuk(var_tglmasuk, var_script_case_init, do_ajax_form_vclaim_lpk_update_validate_tglmasuk_cb);
  } // do_ajax_form_vclaim_lpk_update_validate_tglmasuk

  function do_ajax_form_vclaim_lpk_update_validate_tglmasuk_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_lpk_update_validate_tglmasuk_cb

  // ---------- Validate tglkeluar
  function do_ajax_form_vclaim_lpk_update_validate_tglkeluar()
  {
    var nomeCampo_tglkeluar = "tglkeluar";
    var var_tglkeluar = scAjaxGetFieldText(nomeCampo_tglkeluar);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_lpk_update_validate_tglkeluar(var_tglkeluar, var_script_case_init, do_ajax_form_vclaim_lpk_update_validate_tglkeluar_cb);
  } // do_ajax_form_vclaim_lpk_update_validate_tglkeluar

  function do_ajax_form_vclaim_lpk_update_validate_tglkeluar_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_lpk_update_validate_tglkeluar_cb

  // ---------- Validate jaminan
  function do_ajax_form_vclaim_lpk_update_validate_jaminan()
  {
    var nomeCampo_jaminan = "jaminan";
    var var_jaminan = scAjaxGetFieldText(nomeCampo_jaminan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_lpk_update_validate_jaminan(var_jaminan, var_script_case_init, do_ajax_form_vclaim_lpk_update_validate_jaminan_cb);
  } // do_ajax_form_vclaim_lpk_update_validate_jaminan

  function do_ajax_form_vclaim_lpk_update_validate_jaminan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "jaminan";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_lpk_update_validate_jaminan_cb

  // ---------- Validate poli
  function do_ajax_form_vclaim_lpk_update_validate_poli()
  {
    var nomeCampo_poli = "poli";
    var var_poli = scAjaxGetFieldText(nomeCampo_poli);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_lpk_update_validate_poli(var_poli, var_script_case_init, do_ajax_form_vclaim_lpk_update_validate_poli_cb);
  } // do_ajax_form_vclaim_lpk_update_validate_poli

  function do_ajax_form_vclaim_lpk_update_validate_poli_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "poli";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_lpk_update_validate_poli_cb

  // ---------- Validate nmpoli
  function do_ajax_form_vclaim_lpk_update_validate_nmpoli()
  {
    var nomeCampo_nmpoli = "nmpoli";
    var var_nmpoli = scAjaxGetFieldText(nomeCampo_nmpoli);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_lpk_update_validate_nmpoli(var_nmpoli, var_script_case_init, do_ajax_form_vclaim_lpk_update_validate_nmpoli_cb);
  } // do_ajax_form_vclaim_lpk_update_validate_nmpoli

  function do_ajax_form_vclaim_lpk_update_validate_nmpoli_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nmpoli";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_lpk_update_validate_nmpoli_cb

  // ---------- Validate ruangrawat
  function do_ajax_form_vclaim_lpk_update_validate_ruangrawat()
  {
    var nomeCampo_ruangrawat = "ruangrawat";
    var var_ruangrawat = scAjaxGetFieldText(nomeCampo_ruangrawat);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_lpk_update_validate_ruangrawat(var_ruangrawat, var_script_case_init, do_ajax_form_vclaim_lpk_update_validate_ruangrawat_cb);
  } // do_ajax_form_vclaim_lpk_update_validate_ruangrawat

  function do_ajax_form_vclaim_lpk_update_validate_ruangrawat_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_lpk_update_validate_ruangrawat_cb

  // ---------- Validate kelasrawat
  function do_ajax_form_vclaim_lpk_update_validate_kelasrawat()
  {
    var nomeCampo_kelasrawat = "kelasrawat";
    var var_kelasrawat = scAjaxGetFieldText(nomeCampo_kelasrawat);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_lpk_update_validate_kelasrawat(var_kelasrawat, var_script_case_init, do_ajax_form_vclaim_lpk_update_validate_kelasrawat_cb);
  } // do_ajax_form_vclaim_lpk_update_validate_kelasrawat

  function do_ajax_form_vclaim_lpk_update_validate_kelasrawat_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_lpk_update_validate_kelasrawat_cb

  // ---------- Validate spesialistik
  function do_ajax_form_vclaim_lpk_update_validate_spesialistik()
  {
    var nomeCampo_spesialistik = "spesialistik";
    var var_spesialistik = scAjaxGetFieldText(nomeCampo_spesialistik);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_lpk_update_validate_spesialistik(var_spesialistik, var_script_case_init, do_ajax_form_vclaim_lpk_update_validate_spesialistik_cb);
  } // do_ajax_form_vclaim_lpk_update_validate_spesialistik

  function do_ajax_form_vclaim_lpk_update_validate_spesialistik_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_lpk_update_validate_spesialistik_cb

  // ---------- Validate carakeluar
  function do_ajax_form_vclaim_lpk_update_validate_carakeluar()
  {
    var nomeCampo_carakeluar = "carakeluar";
    var var_carakeluar = scAjaxGetFieldText(nomeCampo_carakeluar);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_lpk_update_validate_carakeluar(var_carakeluar, var_script_case_init, do_ajax_form_vclaim_lpk_update_validate_carakeluar_cb);
  } // do_ajax_form_vclaim_lpk_update_validate_carakeluar

  function do_ajax_form_vclaim_lpk_update_validate_carakeluar_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_lpk_update_validate_carakeluar_cb

  // ---------- Validate kondisipulang
  function do_ajax_form_vclaim_lpk_update_validate_kondisipulang()
  {
    var nomeCampo_kondisipulang = "kondisipulang";
    var var_kondisipulang = scAjaxGetFieldText(nomeCampo_kondisipulang);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_lpk_update_validate_kondisipulang(var_kondisipulang, var_script_case_init, do_ajax_form_vclaim_lpk_update_validate_kondisipulang_cb);
  } // do_ajax_form_vclaim_lpk_update_validate_kondisipulang

  function do_ajax_form_vclaim_lpk_update_validate_kondisipulang_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_lpk_update_validate_kondisipulang_cb

  // ---------- Validate diagnosa
  function do_ajax_form_vclaim_lpk_update_validate_diagnosa()
  {
    var nomeCampo_diagnosa = "diagnosa";
    var var_diagnosa = scAjaxGetFieldText(nomeCampo_diagnosa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_lpk_update_validate_diagnosa(var_diagnosa, var_script_case_init, do_ajax_form_vclaim_lpk_update_validate_diagnosa_cb);
  } // do_ajax_form_vclaim_lpk_update_validate_diagnosa

  function do_ajax_form_vclaim_lpk_update_validate_diagnosa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_lpk_update_validate_diagnosa_cb

  // ---------- Validate procedure
  function do_ajax_form_vclaim_lpk_update_validate_procedure()
  {
    var nomeCampo_procedure = "procedure";
    var var_procedure = scAjaxGetFieldText(nomeCampo_procedure);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_lpk_update_validate_procedure(var_procedure, var_script_case_init, do_ajax_form_vclaim_lpk_update_validate_procedure_cb);
  } // do_ajax_form_vclaim_lpk_update_validate_procedure

  function do_ajax_form_vclaim_lpk_update_validate_procedure_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_lpk_update_validate_procedure_cb

  // ---------- Validate tindaklanjut
  function do_ajax_form_vclaim_lpk_update_validate_tindaklanjut()
  {
    var nomeCampo_tindaklanjut = "tindaklanjut";
    var var_tindaklanjut = scAjaxGetFieldText(nomeCampo_tindaklanjut);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_lpk_update_validate_tindaklanjut(var_tindaklanjut, var_script_case_init, do_ajax_form_vclaim_lpk_update_validate_tindaklanjut_cb);
  } // do_ajax_form_vclaim_lpk_update_validate_tindaklanjut

  function do_ajax_form_vclaim_lpk_update_validate_tindaklanjut_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_lpk_update_validate_tindaklanjut_cb

  // ---------- Validate dirujukkodeppk
  function do_ajax_form_vclaim_lpk_update_validate_dirujukkodeppk()
  {
    var nomeCampo_dirujukkodeppk = "dirujukkodeppk";
    var var_dirujukkodeppk = scAjaxGetFieldText(nomeCampo_dirujukkodeppk);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_lpk_update_validate_dirujukkodeppk(var_dirujukkodeppk, var_script_case_init, do_ajax_form_vclaim_lpk_update_validate_dirujukkodeppk_cb);
  } // do_ajax_form_vclaim_lpk_update_validate_dirujukkodeppk

  function do_ajax_form_vclaim_lpk_update_validate_dirujukkodeppk_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_lpk_update_validate_dirujukkodeppk_cb

  // ---------- Validate tglkontrol
  function do_ajax_form_vclaim_lpk_update_validate_tglkontrol()
  {
    var nomeCampo_tglkontrol = "tglkontrol";
    var var_tglkontrol = scAjaxGetFieldText(nomeCampo_tglkontrol);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_lpk_update_validate_tglkontrol(var_tglkontrol, var_script_case_init, do_ajax_form_vclaim_lpk_update_validate_tglkontrol_cb);
  } // do_ajax_form_vclaim_lpk_update_validate_tglkontrol

  function do_ajax_form_vclaim_lpk_update_validate_tglkontrol_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_lpk_update_validate_tglkontrol_cb

  // ---------- Validate polikontrolkembali
  function do_ajax_form_vclaim_lpk_update_validate_polikontrolkembali()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_lpk_update_validate_polikontrolkembali(var_polikontrolkembali, var_script_case_init, do_ajax_form_vclaim_lpk_update_validate_polikontrolkembali_cb);
  } // do_ajax_form_vclaim_lpk_update_validate_polikontrolkembali

  function do_ajax_form_vclaim_lpk_update_validate_polikontrolkembali_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_lpk_update_validate_polikontrolkembali_cb

  // ---------- Validate dpjp
  function do_ajax_form_vclaim_lpk_update_validate_dpjp()
  {
    var nomeCampo_dpjp = "dpjp";
    var var_dpjp = scAjaxGetFieldText(nomeCampo_dpjp);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_lpk_update_validate_dpjp(var_dpjp, var_script_case_init, do_ajax_form_vclaim_lpk_update_validate_dpjp_cb);
  } // do_ajax_form_vclaim_lpk_update_validate_dpjp

  function do_ajax_form_vclaim_lpk_update_validate_dpjp_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "dpjp";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_lpk_update_validate_dpjp_cb

  // ---------- Validate user
  function do_ajax_form_vclaim_lpk_update_validate_user()
  {
    var nomeCampo_user = "user";
    var var_user = scAjaxGetFieldText(nomeCampo_user);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vclaim_lpk_update_validate_user(var_user, var_script_case_init, do_ajax_form_vclaim_lpk_update_validate_user_cb);
  } // do_ajax_form_vclaim_lpk_update_validate_user

  function do_ajax_form_vclaim_lpk_update_validate_user_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "user";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vclaim_lpk_update_validate_user_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_vclaim_lpk_update_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_vclaim_lpk_update_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_vclaim_lpk_update_submit_form(var_nosep, var_tglmasuk, var_tglkeluar, var_jaminan, var_poli, var_nmpoli, var_ruangrawat, var_kelasrawat, var_spesialistik, var_carakeluar, var_kondisipulang, var_diagnosa, var_procedure, var_tindaklanjut, var_dirujukkodeppk, var_tglkontrol, var_polikontrolkembali, var_dpjp, var_user, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_vclaim_lpk_update_submit_form_cb);
  } // do_ajax_form_vclaim_lpk_update_submit_form

  function do_ajax_form_vclaim_lpk_update_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_vclaim_lpk_update_submit_form_cb_after_alert);
  } // do_ajax_form_vclaim_lpk_update_submit_form_cb
  function do_ajax_form_vclaim_lpk_update_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_vclaim_lpk_update_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_vclaim_lpk_update_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_form_vclaim_lpk_update_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_lpk_update']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_vclaim_lpk_update_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_vclaim_lpk_update_navigate_form_cb_after_alert);
  } // do_ajax_form_vclaim_lpk_update_navigate_form_cb
  function do_ajax_form_vclaim_lpk_update_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_vclaim_lpk_update_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_vclaim_lpk_update_navigate_form_cb_after_alert
  function sc_hide_form_vclaim_lpk_update_form()
  {
