<?php
@session_start() ;
$_SESSION['scriptcase']['grid_lap_kasir_per_shift']['sc_process_barr'] = true;
require_once('../grid_lap_kasir_per_shift/index.php');
unset($_SESSION['scriptcase']['grid_lap_kasir_per_shift']['sc_process_barr']);
$ExportCtrl = new grid_lap_kasir_per_shift_export_control;
$ExportCtrl->Export_barr();

class grid_lap_kasir_per_shift_export_control
{
