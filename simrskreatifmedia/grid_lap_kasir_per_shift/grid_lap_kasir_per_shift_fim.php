...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_lap_kasir_per_shift"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_lap_kasir_per_shift"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_lap_kasir_per_shift']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_lap_kasir_per_shift']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_lap_kasir_per_shift']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_lap_kasir_per_shift']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_lap_kasir_per_shift']['sc_modal']);
           if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_lap_kasir_per_shift']['opc_psq']))
           {
...
<HTML>
<HEAD>
 <TITLE>grid_lap_kasir_per_shift</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_lap_kasir_per_shift']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_lap_kasir_per_shift']['embutida_filho'] as $ind => $sc_init)
          {
