...
class grid_lap_kasir_per_shift_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   var $link_graph_tot; 
   var $Tot_ger; 
   var $array_total_jenis;
   var $array_total_kasir;
   var $array_total_paiddate;
   var $array_total_custcode;
   ...
   function __construct($tipo = "")
   {
      ...
      $this->array_total_jenis    = array();
      $this->array_total_kasir    = array();
      $this->array_total_paiddate = array();
      $this->array_total_custcode = array();
   ...
   function initializeButtons()
   {
      ...
      $this->nmgp_botoes['chart_exit'] = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['dashboard_info']['under_dashboard'] ? "off" : "on";
   ...
   { 
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['grid_lap_kasir_per_shift']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['grid_lap_kasir_per_shift']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['res_hrz'];
      $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
      $dir_raiz          = substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['where_resumo'] = "";
      }
      $this->inicializa_vars();
      $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['SC_Ind_Groupby'];
      $this->Total->$Gb_geral();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['contr_total_geral'] == "OK")
      {
          $this->array_total_jenis = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['arr_total']['jenis'];
          $this->array_total_kasir = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['arr_total']['kasir'];
          $this->array_total_paiddate = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['arr_total']['paiddate'];
          $this->array_total_custcode = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['arr_total']['custcode'];
      }
      else
      {
          $this->array_total_jenis = array();
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['tot_geral'][2];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['tot_geral'][1] == 0)
      {
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          $this->drawMatrix();
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['arr_total']['jenis'] = $this->array_total_jenis;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['arr_total']['kasir'] = $this->array_total_kasir;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['arr_total']['paiddate'] = $this->array_total_paiddate;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['arr_total']['custcode'] = $this->array_total_custcode;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['json_use_label'])
       {
          $Lab_jenis = "Jenis";
          $Lab_kasir = "kasir";
          $Lab_paiddate = "paidDate";
          $Lab_custcode = "custCode";
       }
       else
       {
          $Lab_jenis = "Jenis";
          $Lab_kasir = "Kasir";
          $Lab_paiddate = "Tgl. Bayar";
          $Lab_paiddate =  sprintf("" . $this->Ini->Nm_lang['lang_othr_cons_title_YYYYMMDD2'] . "", $Lab_paiddate);
          $Lab_custcode = "Pasien";
       }
       $this->comp_field = array(
           $Lab_jenis,
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['labels']['trancode']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['labels']['trancode'] = "Kode Pelayanan"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['labels']['nopayment']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['labels']['nopayment'] = "No Pembayaran"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['labels']['paiddate']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['labels']['paiddate'] = "Tgl. Bayar"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['labels']['custcode']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['labels']['custcode'] = "Pasien"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['labels']['nominal']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['labels']['nominal'] = "Nominal"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['labels']['jenis']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['labels']['jenis'] = "Jenis"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['labels']['kasir']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['labels']['kasir'] = "Kasir"; 
       }
       //-----
       $this->comp_field_nm = array(
           'jenis' => 0,
       ...
       //-----
       $this->comp_sum = array(
           2 => "Nominal (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")",
       );
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['summarizing_fields_order']['Jenis']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['summarizing_fields_order']['Jenis'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['summarizing_fields_order']['Jenis'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['summarizing_fields_display']['Jenis'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['summarizing_fields_display']['Jenis'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['summarizing_fields_display']['Jenis'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['summarizing_fields_display']['Jenis'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['summarizing_fields_display']['Jenis'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['summarizing_fields_display']['Jenis'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['summarizing_fields_display']['Jenis'] as $i_sum => $d_sum)
           {
       ...
       //-----
       $this->comp_sum_lnk = array(
           2 => array('field' => "nominal", 'show' => true),
       );
       ...
       //-----
       foreach ($this->array_total_jenis as $i_jenis => $d_jenis) {
           if (!in_array($i_jenis, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_jenis[3] ] = $d_jenis[2];
               $this->comp_label[0][ $d_jenis[3] ] = $d_jenis[2];
           }
           foreach ($this->array_total_kasir[$i_jenis] as $i_kasir => $d_kasir) {
               if (!in_array($i_kasir, $this->comp_label[1][ $d_jenis[3] ], true)) {
                   $this->comp_index[1][ $d_kasir[3] ] = $d_kasir[2];
                   $this->comp_label[1][ $d_jenis[3] ][ $d_kasir[3] ] = $d_kasir[2];
               }
               foreach ($this->array_total_paiddate[$i_jenis][$i_kasir] as $i_paiddate => $d_paiddate) {
                   if (!in_array($i_paiddate, $this->comp_label[2][ $d_jenis[3] ][ $d_kasir[3] ], true)) {
                       $this->comp_index[2][ $d_paiddate[3] ] = $d_paiddate[2];
                       $this->comp_label[2][ $d_jenis[3] ][ $d_kasir[3] ][ $d_paiddate[3] ] = $d_paiddate[2];
                   }
                   foreach ($this->array_total_custcode[$i_jenis][$i_kasir][$i_paiddate] as $i_custcode => $d_custcode) {
                       if (!in_array($i_custcode, $this->comp_label[3][ $d_jenis[3] ][ $d_kasir[3] ][ $d_paiddate[3] ], true)) {
                           $this->comp_index[3][ $d_custcode[3] ] = $d_custcode[2];
                           $this->comp_label[3][ $d_jenis[3] ][ $d_kasir[3] ][ $d_paiddate[3] ][ $d_custcode[3] ] = $d_custcode[2];
                       }
                   }
               }
           }
       ...
       //-----
       $this->comp_links_fl = array(
           array('name' => 'jenis', 'prot' => '@aspass@'),
           array('name' => 'kasir', 'prot' => '@aspass@'),
           array('name' => 'paiddate', 'prot' => '@aspass@'),
           array('name' => 'custcode', 'prot' => '@aspass@'),
       );
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['pivot_order_level'] = -1;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['pivot_tabular_label'];
       ...
       //-----
       foreach ($this->comp_label[0] as $i_jenis => $l_jenis) {
           if (isset($this->array_total_jenis[$i_jenis])) {
               $this->comp_group[$i_jenis] = array();
           }
           foreach ($this->comp_label[1][$i_jenis] as $i_kasir => $l_kasir) {
               if (isset($this->array_total_kasir[$i_jenis][$i_kasir])) {
                   $this->comp_group[$i_jenis][$i_kasir] = array();
               }
               foreach ($this->comp_label[2][$i_jenis][$i_kasir] as $i_paiddate => $l_paiddate) {
                   if (isset($this->array_total_paiddate[$i_jenis][$i_kasir][$i_paiddate])) {
                       $this->comp_group[$i_jenis][$i_kasir][$i_paiddate] = array();
                   }
                   foreach ($this->comp_label[3][$i_jenis][$i_kasir][$i_paiddate] as $i_custcode => $l_custcode) {
                       if (isset($this->array_total_custcode[$i_jenis][$i_kasir][$i_paiddate][$i_custcode])) {
                           $this->comp_group[$i_jenis][$i_kasir][$i_paiddate][$i_custcode] = array();
                       }
                   }
               }
           }
   ...
   function getCompData($level, $params = array()) {
       if (0 == $level) {
           $return = $this->array_total_jenis;
       }
       elseif (1 == $level) {
           $return = $this->array_total_kasir;
       }
       elseif (2 == $level) {
           $return = $this->array_total_paiddate;
       }
       elseif (3 == $level) {
           $return = $this->array_total_custcode;
       }
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_lap_kasir_per_shift@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function buildChart()
   {
       ...
       $this->comp_chart_config = array(
           '0|1' => array(
               'title'    => $this->getChartText(strip_tags("Nominal (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")")),
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'Jenis',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_jenis)),
               'label_y'  => $this->getChartText(strip_tags("Nominal (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")")),
           ...
           '1|1' => array(
               ...
               'field_x'  => 'kasir',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_kasir)),
               'label_y'  => $this->getChartText(strip_tags("Nominal (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")")),
               'format'   => $this->formatChartValue(1),
           ),
           '2|1' => array(
               ...
               'field_x'  => 'paidDate',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_paiddate)),
               'label_y'  => $this->getChartText(strip_tags("Nominal (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")")),
               'format'   => $this->formatChartValue(1),
           ),
           '3|1' => array(
               ...
               'field_x'  => 'custCode',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_custcode)),
               'label_y'  => $this->getChartText(strip_tags("Nominal (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")")),
               'format'   => $this->formatChartValue(1),
           ),
           'T|1' => array(
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['pivot_charts']    = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['pivot_orig']      = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['comb_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['comb_table_def']  = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['anlt_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['anlt_table_def']  = array();
	...
	function filterChartsByGroupbyLevel() {
		...
		if (isset($nmgp_opcao) && ('pdf' == $nmgp_opcao || 'pdf_res' == $nmgp_opcao) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['chart_level']) && '' !== $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['chart_level']) {
			$applyFilter = true;
		}
		elseif (isset($nmgp_opcao) && 'image_res' == $nmgp_opcao && isset($_POST['chart_level']) && '' !== $_POST['chart_level']) {
			$applyFilter = true;
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['chart_level'] = $_POST['chart_level'];
		}
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['pivot_charts'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['pivot_orig'];

		if ($applyFilter) {
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['pivot_charts'] as $chartIndex => $chartData) {
				...
				if ($groupbyLevel > $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['chart_level']) {
					unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['pivot_charts'][$chartIndex]);
				}
			}
		}

		$this->comp_chart_data = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['pivot_charts'];
	}
   ...
   function formatChartValue($total)
   {
       ...
       if ($total == 1)
       {
           $arr_param = array(
               ...
               'thousandSeparator' => ".",
               'trailingZeros'     => "0",
               'monetarySymbol'    => "" . $this->getChartText("Rp") . "",
           ...
           foreach ($a_totals as $i_total => $values)
           {
               ...
               if (isset($this->comp_chart_config[$key_config]))
               {
                   ...
                   foreach ($a_keys as $tmp_key)
                   {
                       ...
                       $xml_links[]  = $this->getFusionLink('sc_grid_lap_kasir_per_shift_' . session_id() . '_!!!' . implode('_', array_merge(array($group + 1, $i_total), $link_index)) . '!!!.json');
                   }
                   ...
                   $this->comp_chart_data[$key_data]['xml']        = $this->getFusionLink('sc_grid_lap_kasir_per_shift_' . session_id() . '_!!!' . implode('_', array_merge(array($group, $i_total), $param)) . '!!!.json');
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['proc_pdf_vert']){ 
   ...
   {
       if (!$res_chart && $this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['json_use_format']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['json_use_format'])
       {
           return $valor_campo;
       }
       ...
       if ($total == 1)
       {
           nmgp_Form_Num_Val($valor_campo, ".", ",", "0", "S", "", "Rp", "V:3:", "-");
       }
       return $valor_campo;
   }
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         $this->monta_html_ini();
         $this->monta_cabecalho();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function inicializa_vars()
   {
      ...
      $this->Total   = new grid_lap_kasir_per_shift_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      $this->Total->Calc_resumo_Jenis("res");
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['arr_total'][$cmp_gb];
      }
      ksort($this->array_total_jenis);
      ksort($this->array_total_kasir);
      ksort($this->array_total_paiddate);
      ksort($this->array_total_custcode);
      if ("out" == $this->NM_tipo)
      {
         $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['SC_Ind_Groupby'];
         $this->Total->$Gb_geral();
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['dashboard_refresh_after_chart'] = 'resumo';
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['doc_word'])
{
   ...
   { 
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_lap_kasir_per_shift_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grid_lap_kasir_per_shift_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_lap_kasir_per_shift_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['num_css'] . '.css');
...
$nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_lap_kasir_per_shift/grid_lap_kasir_per_shift_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\">\r\n");
           ...
           $nm_saida->saida("     }\r\n");
           $nm_saida->saida("   </script>\r\n");
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['ajax_nav'] && !$this->Ini->sc_export_ajax && !$this->Ini->Export_html_zip && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['doc_word'])
      {
           $nm_saida->saida("   <script type=\"text/javascript\"> \r\n");
          ...
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['grid_pesq']))
          { 
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      $nm_saida->saida("	scSetSummaryFixedHeaders();\r\n");
      $nm_saida->saida("});\r\n");
      $nm_saida->saida("function scSetSummaryFixedHeaders() {\r\n");
      $nm_saida->saida("	var divScroll, gridHeaders, headerPlaceholder;\r\n");
      $nm_saida->saida("	gridHeaders = scGetSummaryHeaderRow();\r\n");
      $nm_saida->saida("	headerPlaceholder = $(\"#sc-id-summary-fixedheaders-placeholder\");\r\n");
      $nm_saida->saida("	if (!gridHeaders) {\r\n");
      $nm_saida->saida("		headerPlaceholder.hide();\r\n");
      $nm_saida->saida("	}\r\n");
      $nm_saida->saida("	else {\r\n");
      $nm_saida->saida("		if (scIsSummaryHeaderVisible(gridHeaders)) {\r\n");
      $nm_saida->saida("			headerPlaceholder.hide();\r\n");
      $nm_saida->saida("		}\r\n");
      $nm_saida->saida("		else {\r\n");
      $nm_saida->saida("			if (!headerPlaceholder.filter(\":visible\").length) {\r\n");
      $nm_saida->saida("				scSetSummaryFixedHeadersContents(gridHeaders, headerPlaceholder);\r\n");
      $nm_saida->saida("				scSetSummaryFixedHeadersSize(gridHeaders);\r\n");
      $nm_saida->saida("				headerPlaceholder.show();\r\n");
      $nm_saida->saida("			}\r\n");
      $nm_saida->saida("			scSetSummaryFixedHeadersPosition(gridHeaders, headerPlaceholder);\r\n");
      $nm_saida->saida("		}\r\n");
      $nm_saida->saida("	}\r\n");
      $nm_saida->saida("}\r\n");
      $nm_saida->saida("function scSetSummaryFixedHeadersPosition(gridHeaders, headerPlaceholder) {\r\n");
      $nm_saida->saida("	if (gridHeaders) {\r\n");
      ...
      $nm_saida->saida("	}\r\n");
      $nm_saida->saida("}\r\n");
      $nm_saida->saida("function scIsSummaryHeaderVisible(gridHeaders) {\r\n");
      $nm_saida->saida("    if (typeof(scIsHeaderVisibleMobile) === typeof(function(){})) { return scIsHeaderVisibleMobile(gridHeaders); }\r\n");
      $nm_saida->saida("	return gridHeaders.offset().top > $(document).scrollTop();\r\n");
      $nm_saida->saida("}\r\n");
      $nm_saida->saida("function scGetSummaryHeaderRow() {\r\n");
      $nm_saida->saida("	var gridHeaders = $(\".sc-ui-summary-header-row\").filter(\":visible\");\r\n");
      $nm_saida->saida("	if (!gridHeaders.length) {\r\n");
      $nm_saida->saida("		gridHeaders = false;\r\n");
      $nm_saida->saida("	}\r\n");
      $nm_saida->saida("	return gridHeaders;\r\n");
      $nm_saida->saida("}\r\n");
      $nm_saida->saida("function scSetSummaryFixedHeadersContents(gridHeaders, headerPlaceholder) {\r\n");
      ...
      $nm_saida->saida("}\r\n");
      $nm_saida->saida("function scSetSummaryFixedHeadersSize(gridHeaders) {\r\n");
      $nm_saida->saida("	var i, j, headerColumns, gridColumns, cellHeight, cellWidth, tableOriginal, tableHeaders;\r\n");
      $nm_saida->saida("	tableOriginal = document.getElementById(\"sc-ui-summary-body\");\r\n");
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['doc_word']) 
      {
      ...
      {
          $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['dashboard_info']['remove_margin'] ? ' style="margin: 0"' : '';
          $nm_saida->saida(" <BODY class=\"" . $this->css_scGridPage . "\"" . $remove_margin . ">\r\n");
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['embutida'])
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top_normal()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['pdf'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "Rpdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_lap_kasir_per_shift/grid_lap_kasir_per_shift_config_pdf.php?nm_opc=pdf_res&nm_target=0&nm_cor=cor&papel=8&orientacao=1&bookmarks=1&largura=1200&conf_larg=S&conf_fonte=10&grafico=S&sc_ver_93=" . s . "&nm_tem_gb=s&nm_res_cons=s&nm_ini_pdf_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&summary_export_columns=S&nm_label_group=N&nm_all_cab=S&nm_all_label=S&pdf_zip=N&nm_orient_grid=2&origem=res&language=id&conf_socor=N&script_case_init=" . $this->Ini->sc_page . "&app_name=grid_lap_kasir_per_shift&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['word'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "Rword_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_lap_kasir_per_shift/grid_lap_kasir_per_shift_config_word.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_cor=CO&nm_res_cons=s&nm_ini_word_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&origem=res&language=id&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['xls'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bexcel", "", "", "Rxls_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_lap_kasir_per_shift/grid_lap_kasir_per_shift_config_xls.php?script_case_init=" . $this->Ini->sc_page . "&app_name=grid_lap_kasir_per_shift&nm_tp_xls=xlsx&nm_tot_xls=N&nm_tot_xls=N&nm_res_cons=s&nm_ini_xls_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&summary_export_columns=S&origem=res&language=&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['xml'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bxml", "", "", "Rxml_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_lap_kasir_per_shift/grid_lap_kasir_per_shift_config_xml.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=s&nm_ini_xml_res=grid,resume,chart&nm_all_modules=grid,resume,chart&nm_xml_tag=tag&nm_xml_label=S&language=&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['csv'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcsv", "", "", "Rcsv_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_lap_kasir_per_shift/grid_lap_kasir_per_shift_config_csv.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_res_cons=s&nm_ini_csv_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&nm_delim_line=1&nm_delim_col=1&nm_delim_dados=1&nm_label_csv=N&language=&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_lap_kasir_per_shift/grid_lap_kasir_per_shift_config_print.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_opc=resumo&nm_cor=CO&nm_res_cons=s&nm_ini_prt_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&origem=res&language=id&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      {
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bconf_graf", "", "", "Rgraf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_lap_kasir_per_shift/grid_lap_kasir_per_shift_config_graf_flash.php?nome_apl=grid_lap_kasir_per_shift&campo_apl=nm_resumo_graf&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=id&tp_apl=cns_htm&KeepThis=true&TB_iframe=true&height=450&width=400&modal=true", "", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
      }
      ...
      if ($this->nmgp_botoes['chart_detail'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("grid_lap_kasir_per_shift_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
   ...
   function monta_html_fim()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['print_all'])
      {
          $this->grafico_pdf();
      }
      $nm_saida->saida("</TABLE>\r\n");
      $nm_saida->saida("<link rel=\"stylesheet\" type=\"text/css\" href=\"../_lib/css/" . $this->Ini->str_schema_all . "_sweetalert.css\" />\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_lap_kasir_per_shift']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_lap_kasir_per_shift']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'grid_lap_kasir_per_shift_config_pivot.php?nome_apl=grid_lap_kasir_per_shift&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=id&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   $nm_saida->saida("               nm_submit_modal(\"" . $this->Ini->path_link . "grid_lap_kasir_per_shift/grid_lap_kasir_per_shift_export_email.php?script_case_init={$this->Ini->sc_page}&path_img={$this->Ini->path_img_global}&path_btn={$this->Ini->path_botoes}&sType=pdf_res&sAdd=__E__nmgp_tipo_pdf=\" + z + \"__E__sc_parms_pdf=\" + p + \"__E__sc_create_charts=\" + crt + \"__E__sc_graf_pdf=\" + g + \"__E__chart_level=\" + chart_level + \"__E__SC_module_export=\" + SC_module_export + \"__E__use_pass_pdf=\" + use_pass_pdf + \"__E__pdf_all_cab=\" + pdf_all_cab + \"__E__pdf_all_label=\" +  pdf_all_label + \"__E__pdf_label_group=\" +  pdf_label_group + \"__E__pdf_zip=\" +  pdf_zip + \"&nm_opc=pdf&KeepThis=true&TB_iframe=true&modal=true\", '');\r\n");
      ...
      $nm_saida->saida("   }\r\n");
      $nm_saida->saida("</SCRIPT>\r\n");
   $nm_saida->saida("<div id=\"sc-id-summary-fixedheaders-placeholder\" style=\"display: none; position: fixed; top: 0\"></div>\r\n");
      $nm_saida->saida("</BODY>\r\n");
      $nm_saida->saida("</HTML>\r\n");
   }
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_lap_kasir_per_shift_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "grid_lap_kasir_per_shift/grid_lap_kasir_per_shift_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
...
//--- 
   ...
   {
      global $nm_saida;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_kasir_per_shift']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
      ...
      { 
        ...
        if ($_SESSION['scriptcase']['charset'] != "UTF-8")
        {
          ...
          $paiddate = $Busca_temp['paiddate']; 
          $tmp_pos = strpos($paiddate, "##@@");
          if ($tmp_pos !== false && !is_array($paiddate))
          {
              $paiddate = substr($paiddate, 0, $tmp_pos);
          }
          $paiddate_2 = $Busca_temp['paiddate_input_2']; 
          $kasir = $Busca_temp['kasir']; 
          $tmp_pos = strpos($kasir, "##@@");
          if ($tmp_pos !== false && !is_array($kasir))
          {
              $kasir = substr($kasir, 0, $tmp_pos);
          }
      } 
   ...
   //---- 
   function adiciona_registro($sum_nominal, $quebra_jenis, $quebra_kasir, $quebra_paiddate, $quebra_custcode, $quebra_jenis_orig, $quebra_kasir_orig, $quebra_paiddate_orig, $quebra_custcode_orig)
   {
      //----- Jenis
      if (!isset($this->array_total_jenis[$quebra_jenis_orig]))
      {
         $this->array_total_jenis[$quebra_jenis_orig][0] = 1;
         $this->array_total_jenis[$quebra_jenis_orig][1] = $sum_nominal;
         $this->array_total_jenis[$quebra_jenis_orig][2] = $quebra_jenis;
         $this->array_total_jenis[$quebra_jenis_orig][3] = $quebra_jenis_orig;
      }
      else
      {
         $this->array_total_jenis[$quebra_jenis_orig][0]++;
         $this->array_total_jenis[$quebra_jenis_orig][1] += $sum_nominal;
      }
      //----- Kasir
      if (!isset($this->array_total_kasir[$quebra_jenis_orig][$quebra_kasir_orig]))
      {
         $this->array_total_kasir[$quebra_jenis_orig][$quebra_kasir_orig][0] = 1;
         $this->array_total_kasir[$quebra_jenis_orig][$quebra_kasir_orig][1] = $sum_nominal;
         $this->array_total_kasir[$quebra_jenis_orig][$quebra_kasir_orig][2] = $quebra_kasir;
         $this->array_total_kasir[$quebra_jenis_orig][$quebra_kasir_orig][3] = $quebra_kasir_orig;
      }
      else
      {
         $this->array_total_kasir[$quebra_jenis_orig][$quebra_kasir_orig][0]++;
         $this->array_total_kasir[$quebra_jenis_orig][$quebra_kasir_orig][1] += $sum_nominal;
      }
      //----- " . $this->Ini->Nm_lang['lang_othr_cons_title_YYYYMMDD2'] . "
      if (!isset($this->array_total_paiddate[$quebra_jenis_orig][$quebra_kasir_orig][$quebra_paiddate_orig]))
      {
         $this->array_total_paiddate[$quebra_jenis_orig][$quebra_kasir_orig][$quebra_paiddate_orig][0] = 1;
         $this->array_total_paiddate[$quebra_jenis_orig][$quebra_kasir_orig][$quebra_paiddate_orig][1] = $sum_nominal;
         $this->array_total_paiddate[$quebra_jenis_orig][$quebra_kasir_orig][$quebra_paiddate_orig][2] = $quebra_paiddate;
         $this->array_total_paiddate[$quebra_jenis_orig][$quebra_kasir_orig][$quebra_paiddate_orig][3] = $quebra_paiddate_orig;
      }
      else
      {
         $this->array_total_paiddate[$quebra_jenis_orig][$quebra_kasir_orig][$quebra_paiddate_orig][0]++;
         $this->array_total_paiddate[$quebra_jenis_orig][$quebra_kasir_orig][$quebra_paiddate_orig][1] += $sum_nominal;
      }
      //----- Pasien
      if (!isset($this->array_total_custcode[$quebra_jenis_orig][$quebra_kasir_orig][$quebra_paiddate_orig][$quebra_custcode_orig]))
      {
         $this->array_total_custcode[$quebra_jenis_orig][$quebra_kasir_orig][$quebra_paiddate_orig][$quebra_custcode_orig][0] = 1;
         $this->array_total_custcode[$quebra_jenis_orig][$quebra_kasir_orig][$quebra_paiddate_orig][$quebra_custcode_orig][1] = $sum_nominal;
         $this->array_total_custcode[$quebra_jenis_orig][$quebra_kasir_orig][$quebra_paiddate_orig][$quebra_custcode_orig][2] = $quebra_custcode;
         $this->array_total_custcode[$quebra_jenis_orig][$quebra_kasir_orig][$quebra_paiddate_orig][$quebra_custcode_orig][3] = $quebra_custcode_orig;
      }
      else
      {
         $this->array_total_custcode[$quebra_jenis_orig][$quebra_kasir_orig][$quebra_paiddate_orig][$quebra_custcode_orig][0]++;
         $this->array_total_custcode[$quebra_jenis_orig][$quebra_kasir_orig][$quebra_paiddate_orig][$quebra_custcode_orig][1] += $sum_nominal;
      }
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('', 'jenis');
     $campos_order = $this->Ini->Get_date_order_groupby("Jenis", 'asc', $format, $campos_order);
     $format       = $this->Ini->Get_Gb_date_format('', 'kasir');
     $campos_order = $this->Ini->Get_date_order_groupby("kasir", 'asc', $format, $campos_order);
     $format       = $this->Ini->Get_Gb_date_format('', 'paiddate');
     $campos_order = $this->Ini->Get_date_order_groupby("paidDate", 'asc', $format, $campos_order);
     $format       = $this->Ini->Get_Gb_date_format('', 'custcode');
     $campos_order = $this->Ini->Get_date_order_groupby("custCode", 'asc', $format, $campos_order);
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->nopayment = $rs_res->fields[1] ;  
            $this->paiddate = $rs_res->fields[2] ;  
            $this->custcode = $rs_res->fields[3] ;  
            $this->nominal = $rs_res->fields[4] ;  
            $this->nominal =  str_replace(",", ".", $this->nominal);
            $this->jenis = $rs_res->fields[5] ;  
            $this->kasir = $rs_res->fields[6] ;  
            $this->look_custcode = $this->custcode; 
            $this->Lookup->lookup_custcode($this->look_custcode, $this->custcode) ; 
            $this->jenis_orig = $this->jenis;
            $this->kasir_orig = $this->kasir;
            ...
            $this->paiddate_orig = $this->Ini->Get_arg_groupby($TP_Time . $this->paiddate, $Format_tst);
            $this->paiddate = $this->Ini->GB_date_format($TP_Time . $this->paiddate, $Format_tst, $Prefix_dat);
            $this->custcode_orig = $this->custcode;
            $this->custcode = $this->look_custcode ;
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->nominal, $this->jenis, $this->kasir, $this->paiddate, $this->custcode, $this->jenis_orig,  $this->kasir_orig,  $this->paiddate_orig,  $this->custcode_orig);
            }
   }
//
