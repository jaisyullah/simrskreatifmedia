...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____sec_grid_sec_groups"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____sec_grid_sec_groups"]);
   }
