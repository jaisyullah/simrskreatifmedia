...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "tglLahir";$Nm_datas[] = "tglLahir";$Nm_numeric[] = "id";$Nm_numeric[] = "fisikbb";$Nm_numeric[] = "fisiktb";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_tmplahir_cond" name="tmplahir_cond" onChange="nm_campos_between(document.getElementById('id_vis_tmplahir'), this, 'tmplahir')">
      ...
      <br><span id="id_hide_tmplahir"  <?php echo $str_hide_tmplahir?>><?php
      if ($tmplahir != "")
      {
      $tmplahir_look = substr($this->Db->qstr($tmplahir), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_kodekary_cond" name="kodekary_cond" onChange="nm_campos_between(document.getElementById('id_vis_kodekary'), this, 'kodekary')">
      ...
      <br><span id="id_hide_kodekary"  <?php echo $str_hide_kodekary?>><?php
      if ($kodekary != "")
      {
      $kodekary_look = substr($this->Db->qstr($kodekary), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_namalengkap_cond" name="namalengkap_cond" onChange="nm_campos_between(document.getElementById('id_vis_namalengkap'), this, 'namalengkap')">
      ...
      <br><span id="id_hide_namalengkap"  <?php echo $str_hide_namalengkap?>><?php
      if ($namalengkap != "")
      {
      $namalengkap_look = substr($this->Db->qstr($namalengkap), 1, -1); 
      $nmgp_def_dados = array(); 
