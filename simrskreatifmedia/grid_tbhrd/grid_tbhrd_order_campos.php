...
<?php
   ...
   $Ord_Cmp = new grid_tbhrd_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_tbhrd_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbhrd']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tbhrd']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['kodekary'] = "kodeKary";
   $tab_labels["kodekary"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbhrd']['labels']["kodekary"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbhrd']['labels']["kodekary"] : "Kode Kary";
   $tab_ger_campos['namalengkap'] = "on";
   $tab_def_campos['namalengkap'] = "namaLengkap";
   $tab_labels["namalengkap"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbhrd']['labels']["namalengkap"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbhrd']['labels']["namalengkap"] : "Nama Lengkap";
   $tab_ger_campos['tgllahir'] = "on";
   $tab_def_campos['tgllahir'] = "tglLahir";
   $tab_labels["tgllahir"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbhrd']['labels']["tgllahir"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbhrd']['labels']["tgllahir"] : "Tgl Lahir";
   $tab_ger_campos['telp'] = "on";
   $tab_def_campos['telp'] = "telp";
   $tab_labels["telp"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbhrd']['labels']["telp"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbhrd']['labels']["telp"] : "Telp";
   $tab_ger_campos['alamat'] = "on";
   $tab_def_campos['alamat'] = "alamat";
   $tab_labels["alamat"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbhrd']['labels']["alamat"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbhrd']['labels']["alamat"] : "Alamat";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_tbhrd']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_tbhrd']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_tbhrd']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbhrd']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tbhrd']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_tbhrd']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_tbhrd']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_tbhrd']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_tbhrd']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_tbhrd_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_tbhrd']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_tbhrd']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_tbhrd']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_tbhrd']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_tbhrd']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
