<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tbhrd']['sc_process_barr'] = true;
require_once('../grid_tbhrd/index.php');
unset($_SESSION['scriptcase']['grid_tbhrd']['sc_process_barr']);
$ExportCtrl = new grid_tbhrd_export_control;
$ExportCtrl->Export_barr();

class grid_tbhrd_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - HRD :: Excel</TITLE>
