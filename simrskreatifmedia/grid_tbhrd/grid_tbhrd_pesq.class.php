...
class grid_tbhrd_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbhrd']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_tbhrd_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_tbhrd_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_tbhrd_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_tmplahir')
      {
          $tmplahir = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_tmplahir($tmplahir);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_kodekary')
      {
          $kodekary = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_kodekary($kodekary);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_namalengkap')
      {
          $namalengkap = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_namalengkap($namalengkap);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function lookup_ajax_tmplahir($tmplahir)
   {
      $tmplahir = substr($this->Db->qstr($tmplahir), 1, -1);
            $tmplahir_look = substr($this->Db->qstr($tmplahir), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct tmpLahir from " . $this->Ini->nm_tabela . " where  tmpLahir like '%" . $tmplahir . "%' order by tmpLahir"; 
      unset($cmp1,$cmp2);
   ...
   function lookup_ajax_kodekary($kodekary)
   {
      $kodekary = substr($this->Db->qstr($kodekary), 1, -1);
            $kodekary_look = substr($this->Db->qstr($kodekary), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct kodeKary from " . $this->Ini->nm_tabela . " where  kodeKary like '%" . $kodekary . "%' order by kodeKary"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
   ...
   function lookup_ajax_namalengkap($namalengkap)
   {
      $namalengkap = substr($this->Db->qstr($namalengkap), 1, -1);
            $namalengkap_look = substr($this->Db->qstr($namalengkap), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct namaLengkap from " . $this->Ini->nm_tabela . " where  namaLengkap like '%" . $namalengkap . "%' order by namaLengkap"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $Nm_datas[] = "tglLahir";$Nm_datas[] = "tglLahir";
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbhrd']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbhrd']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbhrd']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbhrd']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbhrd']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbhrd']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbhrd']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbhrd']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbhrd']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbhrd']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbhrd']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbhrd']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbhrd']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbhrd']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbhrd']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbhrd']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbhrd']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - HRD</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_tbhrd/grid_tbhrd_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_tbhrd_ajax_search.js"></script>
 <script type="text/javascript" src="grid_tbhrd_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_tbhrd_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_tbhrd']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_tbhrd']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_tmplahir_cond#NMF#' + search_get_sel_txt('SC_tmplahir_cond') + '@NMF@';
  str_out += 'SC_tmplahir#NMF#' + search_get_text('SC_tmplahir') + '@NMF@';
  str_out += 'id_ac_tmplahir#NMF#' + search_get_text('id_ac_tmplahir') + '@NMF@';
  ...
  str_out += 'SC_kodekary_cond#NMF#' + search_get_sel_txt('SC_kodekary_cond') + '@NMF@';
  str_out += 'SC_kodekary#NMF#' + search_get_text('SC_kodekary') + '@NMF@';
  str_out += 'id_ac_kodekary#NMF#' + search_get_text('id_ac_kodekary') + '@NMF@';
  str_out += 'SC_namalengkap_cond#NMF#' + search_get_sel_txt('SC_namalengkap_cond') + '@NMF@';
  str_out += 'SC_namalengkap#NMF#' + search_get_text('SC_namalengkap') + '@NMF@';
  str_out += 'id_ac_namalengkap#NMF#' + search_get_text('id_ac_namalengkap') + '@NMF@';
   ...
   $("#id_ac_kodekary").autocomplete({
     ...
     $.ajax({
       ...
       data: {
          ...
          nmgp_parms: "NM_ajax_opcao?#?autocomp_kodekary",
          max_itens: "10",
          cod_desc: "N",
     ...
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_kodekary").val( $(this).val() );
       }
     }
   });
   $("#id_ac_namalengkap").autocomplete({
     minLength: 1,
     source: function (request, response) {
     $.ajax({
       url: "index.php",
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_namalengkap",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_namalengkap").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     focus: function (event, ui) {
   ...
   $("#id_ac_tmplahir").autocomplete({
     ...
     $.ajax({
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_tmplahir",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbhrd']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div class="scFilterHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFilterHeaderFont" style="float: left; text-transform: uppercase;"><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - HRD</div>
...
<?php
   ...
   {
      global 
             $tmplahir_cond, $tmplahir, $tmplahir_autocomp,
             $id_cond, $id, $id_autocomp,
             $kodekary_cond, $kodekary, $kodekary_autocomp,
             $namalengkap_cond, $namalengkap, $namalengkap_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbhrd']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbhrd']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbhrd']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbhrd']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $tmplahir = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbhrd']['campos_busca']['tmplahir']; 
          $tmplahir_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbhrd']['campos_busca']['tmplahir_cond']; 
          $id = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbhrd']['campos_busca']['id']; 
          $id_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbhrd']['campos_busca']['id_cond']; 
          $kodekary = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbhrd']['campos_busca']['kodekary']; 
          $kodekary_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbhrd']['campos_busca']['kodekary_cond']; 
          $namalengkap = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbhrd']['campos_busca']['namalengkap']; 
          $namalengkap_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbhrd']['campos_busca']['namalengkap_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbhrd']['campos_busca']['NM_operador']; 
      } 
      if (!isset($tmplahir_cond) || empty($tmplahir_cond))
      {
         $tmplahir_cond = "qp";
      }
      ...
      if (!isset($kodekary_cond) || empty($kodekary_cond))
      {
         $kodekary_cond = "qp";
      }
      if (!isset($namalengkap_cond) || empty($namalengkap_cond))
      {
         $namalengkap_cond = "qp";
      }
      ...
      $str_hide_tmplahir = (in_array($tmplahir_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_id = (in_array($id_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_kodekary = (in_array($kodekary_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_namalengkap = (in_array($namalengkap_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      if (!isset($tmplahir) || $tmplahir == "")
      {
          $tmplahir = "";
      }
      if (isset($tmplahir) && !empty($tmplahir))
      {
         $tmp_pos = strpos($tmplahir, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $tmplahir = substr($tmplahir, 0, $tmp_pos);
         }
      }
      if (!isset($id) || $id == "")
      {
      ...
      if (!isset($kodekary) || $kodekary == "")
      {
          $kodekary = "";
      }
      if (isset($kodekary) && !empty($kodekary))
      {
         $tmp_pos = strpos($kodekary, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $kodekary = substr($kodekary, 0, $tmp_pos);
         }
      }
      ...
      if (isset($namalengkap) && !empty($namalengkap))
      {
         $tmp_pos = strpos($namalengkap, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $namalengkap = substr($namalengkap, 0, $tmp_pos);
         }
      }
?>
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_tmplahir_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['tmplahir'])) ? $this->New_label['tmplahir'] : "Tmp Lahir"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_tmplahir_cond" name="tmplahir_cond" onChange="nm_campos_between(document.getElementById('id_vis_tmplahir'), this, 'tmplahir')">
       <OPTION value="qp" <?php if ("qp" == $tmplahir_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $tmplahir_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $tmplahir_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $tmplahir_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_tmplahir" <?php echo $str_hide_tmplahir?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['tmplahir'])) ? $this->New_label['tmplahir'] : "Tmp Lahir";
 $nmgp_tab_label .= "tmplahir?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
...
<?php
      ...
      $tmplahir_look = substr($this->Db->qstr($tmplahir), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct tmpLahir from " . $this->Ini->nm_tabela . " where tmpLahir = '$tmplahir_look' order by tmpLahir"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      if (isset($nmgp_def_dados[0][$tmplahir]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$tmplahir];
      }
      else
      {
          $sAutocompValue = $tmplahir;
      }
?>
<INPUT  type="text" id="SC_tmplahir" name="tmplahir" value="<?php echo NM_encode_input($tmplahir) ?>"  size=35 alt="{datatype: 'text', maxLength: 35, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_tmplahir" name="tmplahir_autocomp" size="35"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 35, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_id" name="id_autocomp" size="5"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 5, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
      ...
      <TD id='SC_kodekary_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['kodekary'])) ? $this->New_label['kodekary'] : "Kode Kary"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_kodekary_cond" name="kodekary_cond" onChange="nm_campos_between(document.getElementById('id_vis_kodekary'), this, 'kodekary')">
       <OPTION value="qp" <?php if ("qp" == $kodekary_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $kodekary_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $kodekary_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $kodekary_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_kodekary" <?php echo $str_hide_kodekary?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['kodekary'])) ? $this->New_label['kodekary'] : "Kode Kary";
 $nmgp_tab_label .= "kodekary?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      $kodekary_look = substr($this->Db->qstr($kodekary), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct kodeKary from " . $this->Ini->nm_tabela . " where kodeKary = '$kodekary_look' order by kodeKary"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      if (isset($nmgp_def_dados[0][$kodekary]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$kodekary];
      }
      else
      {
          $sAutocompValue = $kodekary;
      }
?>
<INPUT  type="text" id="SC_kodekary" name="kodekary" value="<?php echo NM_encode_input($kodekary) ?>"  size=15 alt="{datatype: 'text', maxLength: 15, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_kodekary" name="kodekary_autocomp" size="15"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 15, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_namalengkap_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['namalengkap'])) ? $this->New_label['namalengkap'] : "Nama Lengkap"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_namalengkap_cond" name="namalengkap_cond" onChange="nm_campos_between(document.getElementById('id_vis_namalengkap'), this, 'namalengkap')">
       <OPTION value="qp" <?php if ("qp" == $namalengkap_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $namalengkap_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $namalengkap_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $namalengkap_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_namalengkap" <?php echo $str_hide_namalengkap?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['namalengkap'])) ? $this->New_label['namalengkap'] : "Nama Lengkap";
 $nmgp_tab_label .= "namalengkap?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      $namalengkap_look = substr($this->Db->qstr($namalengkap), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct namaLengkap from " . $this->Ini->nm_tabela . " where namaLengkap = '$namalengkap_look' order by namaLengkap"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      if (isset($nmgp_def_dados[0][$namalengkap]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$namalengkap];
      }
      else
      {
          $sAutocompValue = $namalengkap;
      }
?>
<INPUT  type="text" id="SC_namalengkap" name="namalengkap" value="<?php echo NM_encode_input($namalengkap) ?>"  size=50 alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_namalengkap" name="namalengkap_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
?>
<?php
   if (is_file("grid_tbhrd_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_tbhrd']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_tbhrd']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbhrd']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.tmplahir_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_tmplahir'), document.F1.tmplahir_cond, 'tmplahir');
   document.F1.tmplahir.value = "";
   document.F1.tmplahir_autocomp.value = "";
   ...
   document.F1.kodekary_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_kodekary'), document.F1.kodekary_cond, 'kodekary');
   document.F1.kodekary.value = "";
   document.F1.kodekary_autocomp.value = "";
   document.F1.namalengkap_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_namalengkap'), document.F1.namalengkap_cond, 'namalengkap');
   document.F1.namalengkap.value = "";
   document.F1.namalengkap_autocomp.value = "";
 }
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "simrskreatifmedia/grid_tbhrd";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbhrd']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbhrd']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbhrd']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_tmplahir_cond'] = 'cond';
      $tp_fields['SC_tmplahir'] = 'text_aut';
      $tp_fields['id_ac_tmplahir'] = 'text_aut';
      $tp_fields['SC_id_cond'] = 'cond';
      $tp_fields['SC_id'] = 'text_aut';
      $tp_fields['id_ac_id'] = 'text_aut';
      $tp_fields['SC_kodekary_cond'] = 'cond';
      $tp_fields['SC_kodekary'] = 'text_aut';
      $tp_fields['id_ac_kodekary'] = 'text_aut';
      $tp_fields['SC_namalengkap_cond'] = 'cond';
      $tp_fields['SC_namalengkap'] = 'text_aut';
      $tp_fields['id_ac_namalengkap'] = 'text_aut';
   ...
   {
      global $tmplahir_cond, $tmplahir, $tmplahir_autocomp,
             $id_cond, $id, $id_autocomp,
             $kodekary_cond, $kodekary, $kodekary_autocomp,
             $namalengkap_cond, $namalengkap, $namalengkap_autocomp, $nmgp_tab_label;

      $C_formatado = true;
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_conv_dados.php", "F", "nm_conv_limpa_dado") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
      if (!empty($tmplahir_autocomp) && empty($tmplahir))
      {
          $tmplahir = $tmplahir_autocomp;
      }
      if (!empty($id_autocomp) && empty($id))
      {
          $id = $id_autocomp;
      }
      if (!empty($kodekary_autocomp) && empty($kodekary))
      {
          $kodekary = $kodekary_autocomp;
      }
      if (!empty($namalengkap_autocomp) && empty($namalengkap))
      {
          $namalengkap = $namalengkap_autocomp;
      }
      $tmplahir_cond_salva = $tmplahir_cond; 
      if (!isset($tmplahir_input_2) || $tmplahir_input_2 == "")
      {
          $tmplahir_input_2 = $tmplahir;
      }
      ...
      $kodekary_cond_salva = $kodekary_cond; 
      if (!isset($kodekary_input_2) || $kodekary_input_2 == "")
      {
          $kodekary_input_2 = $kodekary;
      }
      $namalengkap_cond_salva = $namalengkap_cond; 
      if (!isset($namalengkap_input_2) || $namalengkap_input_2 == "")
      {
          $namalengkap_input_2 = $namalengkap;
      }
      if ($id_cond != "in")
      {
          nm_limpa_numero($id, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbhrd']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbhrd']['campos_busca']['tmplahir'] = $tmplahir; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbhrd']['campos_busca']['tmplahir_cond'] = $tmplahir_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbhrd']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbhrd']['campos_busca']['id'] = $id; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbhrd']['campos_busca']['id_cond'] = $id_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbhrd']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbhrd']['campos_busca']['kodekary'] = $kodekary; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbhrd']['campos_busca']['kodekary_cond'] = $kodekary_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbhrd']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbhrd']['campos_busca']['namalengkap'] = $namalengkap; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbhrd']['campos_busca']['namalengkap_cond'] = $namalengkap_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbhrd']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbhrd']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbhrd']['campos_busca'] = $Temp_Busca;
      }
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['tmplahir'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['tmplahir'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['tmplahir'] = $tmplahir;
      }
      $id_look = substr($this->Db->qstr($id), 1, -1); 
      $nmgp_def_dados = array(); 
   if (is_numeric($id))
   { 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['kodekary'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['kodekary'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['kodekary'] = $kodekary;
      }
      $namalengkap_look = substr($this->Db->qstr($namalengkap), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct namaLengkap from " . $this->Ini->nm_tabela . " where namaLengkap = '$namalengkap_look' order by namaLengkap"; 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['namalengkap'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['namalengkap'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['namalengkap'] = $namalengkap;
      }

      //----- $tmplahir
      $this->Date_part = false;
      if (isset($tmplahir) || $tmplahir_cond == "nu" || $tmplahir_cond == "nn" || $tmplahir_cond == "ep" || $tmplahir_cond == "ne")
      {
         $this->monta_condicao("tmpLahir", $tmplahir_cond, $tmplahir, "", "tmplahir");
      }
      ...
      //----- $kodekary
      $this->Date_part = false;
      if (isset($kodekary) || $kodekary_cond == "nu" || $kodekary_cond == "nn" || $kodekary_cond == "ep" || $kodekary_cond == "ne")
      {
         $this->monta_condicao("kodeKary", $kodekary_cond, $kodekary, "", "kodekary");
      }

      //----- $namalengkap
      $this->Date_part = false;
      if (isset($namalengkap) || $namalengkap_cond == "nu" || $namalengkap_cond == "nn" || $namalengkap_cond == "ep" || $namalengkap_cond == "ne")
      {
         $this->monta_condicao("namaLengkap", $namalengkap_cond, $namalengkap, "", "namalengkap");
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbhrd']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbhrd']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbhrd']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbhrd']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbhrd']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbhrd']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbhrd']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbhrd']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbhrd']['cond_pesq'] .= $this->NM_operador;
