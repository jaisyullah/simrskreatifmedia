...
<html>
    <head>
        ...
        <link rel="stylesheet"  href="<?php echo $_SESSION["scriptcase"]["menu_dani"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.mobile-1.2.0.min.css" />
        ...
        <script src="<?php echo $_SESSION["scriptcase"]["menu_dani"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.js"></script>
        ...
        <script src="<?php echo $_SESSION["scriptcase"]["menu_dani"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.mobile-1.2.0.min.js"></script>
    <style>
    <?php
    if(isset($menu_dani_menuData["data"]) && is_array($menu_dani_menuData["data"]) && !empty($menu_dani_menuData["data"]))
    {
        foreach($menu_dani_menuData["data"] as $arr_item)
        {
    ...
    <body>
    <?php
        escreveMenuMobile($menu_dani_menuData["data"], $this->path_imag_apl);
    ?>
	<?php
