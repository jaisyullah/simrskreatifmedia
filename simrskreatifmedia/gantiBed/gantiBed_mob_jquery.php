...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_sc_field_0' + iSeqRow).bind('blur', function() { sc_gantiBed_sc_field_0_onblur(this, iSeqRow) })
                                        .bind('focus', function() { sc_gantiBed_sc_field_0_onfocus(this, iSeqRow) });
  $('#id_sc_field_kelas' + iSeqRow).bind('blur', function() { sc_gantiBed_kelas_onblur(this, iSeqRow) })
                                   .bind('focus', function() { sc_gantiBed_kelas_onfocus(this, iSeqRow) });
  $('#id_sc_field_sc_field_1' + iSeqRow).bind('blur', function() { sc_gantiBed_sc_field_1_onblur(this, iSeqRow) })
                                        .bind('focus', function() { sc_gantiBed_sc_field_1_onfocus(this, iSeqRow) });
  $('#id_sc_field_sc_field_2' + iSeqRow).bind('blur', function() { sc_gantiBed_sc_field_2_onblur(this, iSeqRow) })
                                        .bind('focus', function() { sc_gantiBed_sc_field_2_onfocus(this, iSeqRow) });
  $('#id_sc_field_custcode' + iSeqRow).bind('blur', function() { sc_gantiBed_custcode_onblur(this, iSeqRow) })
                                      .bind('focus', function() { sc_gantiBed_custcode_onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_gantiBed_sc_field_0_onblur(oThis, iSeqRow) {
  do_ajax_gantiBed_mob_validate_sc_field_0();
  scCssBlur(oThis);
}

function sc_gantiBed_sc_field_0_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_gantiBed_kelas_onblur(oThis, iSeqRow) {
  do_ajax_gantiBed_mob_validate_kelas();
  scCssBlur(oThis);
}

function sc_gantiBed_kelas_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_gantiBed_sc_field_1_onblur(oThis, iSeqRow) {
  do_ajax_gantiBed_mob_validate_sc_field_1();
  scCssBlur(oThis);
}

function sc_gantiBed_sc_field_1_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_gantiBed_sc_field_2_onblur(oThis, iSeqRow) {
  do_ajax_gantiBed_mob_validate_sc_field_2();
  scCssBlur(oThis);
}

function sc_gantiBed_sc_field_2_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_gantiBed_custcode_onblur(oThis, iSeqRow) {
  do_ajax_gantiBed_mob_validate_custcode();
  scCssBlur(oThis);
}

function sc_gantiBed_custcode_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function scHidePage(pageNo) {
	$("#id_gantiBed_mob_form" + pageNo).hide();
}
