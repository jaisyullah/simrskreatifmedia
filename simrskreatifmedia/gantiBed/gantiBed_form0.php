...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['gantiBed']['embutida_pdf']))
 {
 ?>
...
<?php
include_once("gantiBed_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('gantiBed_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['gantiBed']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['gantiBed']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['gantiBed']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['gantiBed']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['gantiBed']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['gantiBed']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['gantiBed']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['gantiBed']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['gantiBed'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['gantiBed'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['gantiBed']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['gantiBed']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['gantiBed']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['gantiBed']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['gantiBed']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<?php
  ...
  {
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['gantiBed']['where_filter']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['gantiBed']['empty_filter'] = true;
       }
  }
?>
...
<?php
           if (($nm_apl_dependente != 1) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['gantiBed']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['gantiBed']['dashboard_info']['under_dashboard'])) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['gantiBed']['nm_run_menu']) || $_SESSION['sc_session'][$this->Ini->sc_page]['gantiBed']['nm_run_menu'] != 1))) {
...
<?php
           if (($nm_apl_dependente == 1) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['gantiBed']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['gantiBed']['dashboard_info']['under_dashboard']))) {
        $sCondStyle = ($this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['gantiBed']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['gantiBed']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("gantiBed");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("gantiBed");
 parent.scAjaxDetailHeight("gantiBed", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['gantiBed']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
