<?php
@session_start() ;
$_SESSION['scriptcase']['grid_satuanbahan']['sc_process_barr'] = true;
require_once('../grid_satuanbahan/index.php');
unset($_SESSION['scriptcase']['grid_satuanbahan']['sc_process_barr']);
$ExportCtrl = new grid_satuanbahan_export_control;
$ExportCtrl->Export_barr();

class grid_satuanbahan_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - satuanbahan :: Excel</TITLE>
