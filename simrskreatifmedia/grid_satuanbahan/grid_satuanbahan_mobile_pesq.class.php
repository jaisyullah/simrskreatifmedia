...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_satuancode_cond" name="satuancode_cond" onChange="nm_campos_between(document.getElementById('id_vis_satuancode'), this, 'satuancode')">
      ...
      <br><span id="id_hide_satuancode"  <?php echo $str_hide_satuancode?>><?php
      if ($satuancode != "")
      {
      $satuancode_look = substr($this->Db->qstr($satuancode), 1, -1); 
      $nmgp_def_dados = array(); 
