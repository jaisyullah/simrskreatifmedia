<?php
   include_once('report_general_ledger_session.php');
   @session_start() ;
   $_SESSION['scriptcase']['report_general_ledger']['glo_nm_perfil']          = "conn_mysql";
   $_SESSION['scriptcase']['report_general_ledger']['glo_nm_path_prod']       = "";
   $_SESSION['scriptcase']['report_general_ledger']['glo_nm_path_conf']       = "";
   $_SESSION['scriptcase']['report_general_ledger']['glo_nm_path_imagens']    = "";
   $_SESSION['scriptcase']['report_general_ledger']['glo_nm_path_imag_temp']  = "";
   $_SESSION['scriptcase']['report_general_ledger']['glo_nm_path_doc']        = "";
    ...
    //check prod
    if(empty($_SESSION['scriptcase']['report_general_ledger']['glo_nm_path_prod']))
    {
            /*check prod*/$_SESSION['scriptcase']['report_general_ledger']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
    }
    //check img
    if(empty($_SESSION['scriptcase']['report_general_ledger']['glo_nm_path_imagens']))
    {
            /*check img*/$_SESSION['scriptcase']['report_general_ledger']['glo_nm_path_imagens'] = $str_path_apl_url . "_lib/file/img";
    }
    //check tmp
    if(empty($_SESSION['scriptcase']['report_general_ledger']['glo_nm_path_imag_temp']))
    {
            /*check tmp*/$_SESSION['scriptcase']['report_general_ledger']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
    }
    //check doc
    if(empty($_SESSION['scriptcase']['report_general_ledger']['glo_nm_path_doc']))
    {
            /*check doc*/$_SESSION['scriptcase']['report_general_ledger']['glo_nm_path_doc'] = $str_path_apl_dir . "_lib/file/doc";
    }
    //end check publication with the prod
//
class report_general_ledger_ini
{
   var $nm_cod_apl;
   var $nm_nome_apl;
   var $nm_seguranca;
...
//
   function init($Tp_init = "")
   {
      ...
      $_SESSION['sc_session'][$this->sc_page]['report_general_ledger']['decimal_db'] = "."; 
      $this->nm_cod_apl      = "report_general_ledger"; 
      $this->nm_nome_apl     = ""; 
      $this->nm_seguranca    = ""; 
...
// 
      ...
      $this->sc_protocolo    = "";
      $this->path_prod       = $_SESSION['scriptcase']['report_general_ledger']['glo_nm_path_prod'];
      $this->path_conf       = $_SESSION['scriptcase']['report_general_ledger']['glo_nm_path_conf'];
      $this->path_imagens    = $_SESSION['scriptcase']['report_general_ledger']['glo_nm_path_imagens'];
      $this->path_imag_temp  = $_SESSION['scriptcase']['report_general_ledger']['glo_nm_path_imag_temp'];
      $this->path_doc        = $_SESSION['scriptcase']['report_general_ledger']['glo_nm_path_doc'];
      ...
      $this->path_aplicacao  = substr($this->path_aplicacao, 0, strrpos($this->path_aplicacao, '/')) . '/report_general_ledger';
      ...
      if (isset($_SESSION['scriptcase']['report_general_ledger']['session_timeout']['lang'])) {
          $this->str_lang = $_SESSION['scriptcase']['report_general_ledger']['session_timeout']['lang'];
      }
      elseif (!isset($_SESSION['scriptcase']['report_general_ledger']['actual_lang']) || $_SESSION['scriptcase']['report_general_ledger']['actual_lang'] != $this->str_lang) {
          $_SESSION['scriptcase']['report_general_ledger']['actual_lang'] = $this->str_lang;
      ...
      {
          include_once("report_general_ledger_json.php");
      }
      $this->SC_Link_View = (isset($_SESSION['sc_session'][$this->sc_page]['report_general_ledger']['SC_Link_View'])) ? $_SESSION['sc_session'][$this->sc_page]['report_general_ledger']['SC_Link_View'] : false;
      if (isset($_GET['SC_Link_View']) && !empty($_GET['SC_Link_View']) && is_numeric($_GET['SC_Link_View']))
      {
          if ($_SESSION['sc_session'][$this->sc_page]['report_general_ledger']['embutida'])
          {
              $this->SC_Link_View = true;
              $_SESSION['sc_session'][$this->sc_page]['report_general_ledger']['SC_Link_View'] = true;
          }
      }
      if (isset($_POST['nmgp_opcao']) && $_POST['nmgp_opcao'] == "ajax_save_ancor")
      {
          $_SESSION['sc_session'][$this->sc_page]['report_general_ledger']['ancor_save'] = $_POST['ancor_save'];
...
<?php
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['report_general_ledger']['dashboard_info']['under_dashboard']))
      {
          $_SESSION['sc_session'][$this->sc_page]['report_general_ledger']['dashboard_info']['under_dashboard'] = false;
          $_SESSION['sc_session'][$this->sc_page]['report_general_ledger']['dashboard_info']['dashboard_app']   = '';
          $_SESSION['sc_session'][$this->sc_page]['report_general_ledger']['dashboard_info']['own_widget']      = '';
          $_SESSION['sc_session'][$this->sc_page]['report_general_ledger']['dashboard_info']['parent_widget']   = '';
          $_SESSION['sc_session'][$this->sc_page]['report_general_ledger']['dashboard_info']['compact_mode']    = false;
          $_SESSION['sc_session'][$this->sc_page]['report_general_ledger']['dashboard_info']['remove_margin']   = false;
      }
      if (isset($_GET['under_dashboard']) && 1 == $_GET['under_dashboard'])
      {
          if (isset($_GET['own_widget']) && 'dbifrm_widget' == substr($_GET['own_widget'], 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['report_general_ledger']['dashboard_info']['own_widget'] = $_GET['own_widget'];
              $_SESSION['sc_session'][$this->sc_page]['report_general_ledger']['dashboard_info']['under_dashboard'] = true;
              if (isset($_GET['dashboard_app'])) {
                  $_SESSION['sc_session'][$this->sc_page]['report_general_ledger']['dashboard_info']['dashboard_app'] = $_GET['dashboard_app'];
              }
              if (isset($_GET['parent_widget'])) {
                  $_SESSION['sc_session'][$this->sc_page]['report_general_ledger']['dashboard_info']['parent_widget'] = $_GET['parent_widget'];
              }
              if (isset($_GET['compact_mode'])) {
                  $_SESSION['sc_session'][$this->sc_page]['report_general_ledger']['dashboard_info']['compact_mode'] = 1 == $_GET['compact_mode'];
              }
              if (isset($_GET['remove_margin'])) {
                  $_SESSION['sc_session'][$this->sc_page]['report_general_ledger']['dashboard_info']['remove_margin'] = 1 == $_GET['remove_margin'];
              }
          }
      }
      elseif (isset($under_dashboard) && 1 == $under_dashboard)
      {
          if (isset($own_widget) && 'dbifrm_widget' == substr($own_widget, 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['report_general_ledger']['dashboard_info']['own_widget'] = $own_widget;
              $_SESSION['sc_session'][$this->sc_page]['report_general_ledger']['dashboard_info']['under_dashboard'] = true;
              if (isset($dashboard_app)) {
                  $_SESSION['sc_session'][$this->sc_page]['report_general_ledger']['dashboard_info']['dashboard_app'] = $dashboard_app;
              }
              if (isset($parent_widget)) {
                  $_SESSION['sc_session'][$this->sc_page]['report_general_ledger']['dashboard_info']['parent_widget'] = $parent_widget;
              }
              if (isset($compact_mode)) {
                  $_SESSION['sc_session'][$this->sc_page]['report_general_ledger']['dashboard_info']['compact_mode'] = 1 == $compact_mode;
              }
              if (isset($remove_margin)) {
                  $_SESSION['sc_session'][$this->sc_page]['report_general_ledger']['dashboard_info']['remove_margin'] = 1 == $remove_margin;
              }
          }
      }
      if (!isset($_SESSION['sc_session'][$this->sc_page]['report_general_ledger']['dashboard_info']['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['report_general_ledger']['dashboard_info']['maximized'] = false;
      }
      if (isset($_GET['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['report_general_ledger']['dashboard_info']['maximized'] = 1 == $_GET['maximized'];
      }
      if ($_SESSION['sc_session'][$this->sc_page]['report_general_ledger']['dashboard_info']['under_dashboard'])
      {
          $sTmpDashboardApp = $_SESSION['sc_session'][$this->sc_page]['report_general_ledger']['dashboard_info']['dashboard_app'];
          if ('' != $sTmpDashboardApp && isset($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["report_general_ledger"]))
          {
              foreach ($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["report_general_ledger"] as $sTmpTargetLink => $sTmpTargetWidget)
              {
      ...
      if (!is_file($this->root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
      {
          ...
          unset($_SESSION['scriptcase']['report_general_ledger']['glo_nm_conexao']);
      }
      ...
      if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['report_general_ledger']['session_timeout']['redir']))
      {
      ...
      $_SESSION['sc_session'][$this->sc_page]['report_general_ledger']['path_doc'] = $this->path_doc; 
      ...
      if (!is_dir($this->root . $this->path_prod))
      {
          ...
          echo " </tr>";
          echo "</table>";
          if (!$_SESSION['sc_session'][$script_case_init]['report_general_ledger']['iframe_menu'] && (!isset($_SESSION['sc_session'][$script_case_init]['report_general_ledger']['sc_outra_jan']) || !$_SESSION['sc_session'][$script_case_init]['report_general_ledger']['sc_outra_jan'])) 
          { 
...
// 
      include_once($this->path_aplicacao . "report_general_ledger_erro.class.php"); 
      $this->Erro = new report_general_ledger_erro();
      include_once($this->path_adodb . "/adodb.inc.php"); 
      $this->sc_Include($this->path_libs . "/nm_sec_prod.php", "F", "nm_reg_prod") ; 
      $this->sc_Include($this->path_libs . "/nm_ini_perfil.php", "F", "perfil_lib") ; 
// 
 if(function_exists('set_php_timezone')) set_php_timezone('report_general_ledger'); 
// 
      ...
      if (isset($_SESSION['scriptcase']['report_general_ledger']['session_timeout']['redir'])) {
          ...
          if ($_SESSION['scriptcase']['report_general_ledger']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "  </HEAD>\r\n";
              $SS_cod_html .= "   <body>\r\n";
          }
          else {
              ...
              $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['report_general_ledger']['session_timeout']['redir'] . "');\">\r\n";
              $SS_cod_html .= "     </form>\r\n";
          ...
          if ($_SESSION['scriptcase']['report_general_ledger']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['report_general_ledger']['session_timeout']['redir'] . "');\r\n";
          }
          ...
          $SS_cod_html .= " </body>\r\n";
          $SS_cod_html .= "</HTML>\r\n";
          unset($_SESSION['scriptcase']['report_general_ledger']['session_timeout']);
          unset($_SESSION['sc_session']);
      }
   ...
   function prep_conect()
   {
      if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
      {
          ...
          {
              if (isset($_SESSION['scriptcase']['report_general_ledger']['glo_nm_conexao']) && $_SESSION['scriptcase']['report_general_ledger']['glo_nm_conexao'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['report_general_ledger']['glo_nm_conexao'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['report_general_ledger']['glo_nm_perfil']) && $_SESSION['scriptcase']['report_general_ledger']['glo_nm_perfil'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['report_general_ledger']['glo_nm_perfil'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['report_general_ledger']['glo_con_' . $NM_con_orig]))
              {
                  $_SESSION['scriptcase']['report_general_ledger']['glo_con_' . $NM_con_orig] = $NM_con_dest;
              }
          }
      }
      $con_devel             = (isset($_SESSION['scriptcase']['report_general_ledger']['glo_nm_conexao'])) ? $_SESSION['scriptcase']['report_general_ledger']['glo_nm_conexao'] : ""; 
      $perfil_trab           = ""; 
      $this->nm_falta_var    = ""; 
      $this->nm_falta_var_db = ""; 
      $nm_crit_perfil        = false;
      if (isset($_SESSION['scriptcase']['report_general_ledger']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['report_general_ledger']['glo_nm_conexao']))
      {
          ob_start();
      ...
      if (isset($_SESSION['scriptcase']['report_general_ledger']['glo_nm_perfil']) && !empty($_SESSION['scriptcase']['report_general_ledger']['glo_nm_perfil']))
      {
          $perfil_trab = $_SESSION['scriptcase']['report_general_ledger']['glo_nm_perfil'];
      }
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['report_general_ledger']['embutida_init']) || !$_SESSION['sc_session'][$this->sc_page]['report_general_ledger']['embutida_init']) 
      {
          if (!isset($_SESSION['start_date'])) 
          {
              $this->nm_falta_var .= "start_date; ";
          }
          if (!isset($_SESSION['end_date'])) 
          {
              $this->nm_falta_var .= "end_date; ";
          }
          if (!isset($_SESSION['akun'])) 
          {
              $this->nm_falta_var .= "akun; ";
          }
      }
// 
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['report_general_ledger']['decimal_db'] = $_SESSION['scriptcase']['glo_decimal_db']; 
      }
      if (isset($_SESSION['scriptcase']['glo_date_separator']) && !empty($_SESSION['scriptcase']['glo_date_separator']))
      {
          ...
          if (strlen($SC_temp) == 2)
          {
              $_SESSION['sc_session'][$this->sc_page]['report_general_ledger']['SC_sep_date']  = substr($SC_temp, 0, 1); 
              $_SESSION['sc_session'][$this->sc_page]['report_general_ledger']['SC_sep_date1'] = substr($SC_temp, 1, 1); 
          }
          else
           {
              $_SESSION['sc_session'][$this->sc_page]['report_general_ledger']['SC_sep_date']  = $SC_temp; 
              $_SESSION['sc_session'][$this->sc_page]['report_general_ledger']['SC_sep_date1'] = $SC_temp; 
          }
          $this->date_delim  = $_SESSION['sc_session'][$this->sc_page]['report_general_ledger']['SC_sep_date'];
          $this->date_delim1 = $_SESSION['sc_session'][$this->sc_page]['report_general_ledger']['SC_sep_date1'];
      }
// 
...
<?php
   ...
   function conectDB()
   {
      ...
      if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['report_general_ledger']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['report_general_ledger']['glo_nm_conexao']))
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['report_general_ledger']['glo_nm_conexao'], $this->root . $this->path_prod, 'simrskreatifmedia', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
...
// 
   ...
   function sc_Sql_Protect($var, $tp, $conex="")
   {
       ...
       if ($tp == "date")
       {
           ...
           if (isset($_SESSION['sc_session'][$this->sc_page]['report_general_ledger']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->sc_page]['report_general_ledger']['SC_sep_date']))
           {
               $delim  = $_SESSION['sc_session'][$this->sc_page]['report_general_ledger']['SC_sep_date'];
               $delim1 = $_SESSION['sc_session'][$this->sc_page]['report_general_ledger']['SC_sep_date1'];
           }
   ...
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['report_general_ledger']['SC_Gb_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['report_general_ledger']['SC_Gb_date_format'][$GB][$cmp] : "";
   }

   function Get_Gb_prefix_date_format($GB, $cmp)
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['report_general_ledger']['SC_Gb_prefix_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['report_general_ledger']['SC_Gb_prefix_date_format'][$GB][$cmp] : "";
   }
...
//===============================================================================
//
class report_general_ledger_apl
{
   var $Ini;
   var $Erro;
   var $Db;
...
//----- 
   function controle()
   {
      ...
      $this->Ini = new report_general_ledger_ini(); 
      $this->Ini->init();
      $this->Change_Menu = false;
      if (isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_general_ledger']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['report_general_ledger']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['report_general_ledger']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['report_general_ledger'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['report_general_ledger']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['report_general_ledger']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('report_general_ledger') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['report_general_ledger']['label'] = "" . $this->Ini->Nm_lang['lang_othr_blank_title'] . "";
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['report_general_ledger']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['report_general_ledger']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['report_general_ledger']['exit'];
      ...
      $this->Db = $this->Ini->Db; 
      include_once($this->Ini->path_aplicacao . "report_general_ledger_erro.class.php"); 
      $this->Erro      = new report_general_ledger_erro();
      $this->Erro->Ini = $this->Ini;
//
      $_SESSION['scriptcase']['report_general_ledger']['contr_erro'] = 'on';
...
if (!isset($_SESSION['akun'])) {$_SESSION['akun'] = "";}
...
$sSQL = "SELECT id, nama, tipe FROM akun WHERE id = '".$this->sc_temp_akun."'";
...
foreach($this->ds  as $ab){
	$kd_akun = $ab[0];
	$nm_akun = $ab[1];
	$tipe_akun = $ab[2];
}

$sSQL = "SELECT SUM(x.debet) jml_debet, SUM(x.kredit) jml_kredit FROM (
			SELECT jm.tanggal, j.akun,
			CASE WHEN j.flag = 'D' THEN j.nominal ELSE 0 END debet,
			CASE WHEN j.flag = 'K' THEN j.nominal ELSE 0 END kredit
			FROM jurnal_detail j LEFT JOIN jurnal_master jm ON j.id_jurnal_master = jm.id
			LEFT JOIN akun a ON j.akun = a.id WHERE j.akun = '".$this->sc_temp_akun."' 
			AND jm.tanggal BETWEEN '".$this->sc_temp_start_date."' AND '".$this->sc_temp_end_date."'
		)x";
...
foreach($this->ds  as $ax){
	$jml_debet = $ax[0];
	$jml_kredit = $ax[1];
}

$date = date_create($this->sc_temp_start_date);
$year = date_format($date,"Y");


$sSQL = "SELECT CASE WHEN SUM(x.debet) IS NULL THEN 0 END jml_debet, 
		CASE WHEN SUM(x.kredit) IS NULL THEN 0 END jml_kredit FROM (
			SELECT jm.tanggal, j.akun,
			CASE WHEN j.flag = 'D' THEN j.nominal ELSE 0 END debet,
			CASE WHEN j.flag = 'K' THEN j.nominal ELSE 0 END kredit
			FROM jurnal_detail j LEFT JOIN jurnal_master jm ON j.id_jurnal_master = jm.id
			LEFT JOIN akun a ON j.akun = a.id WHERE j.akun = '".$this->sc_temp_akun."' 
			AND jm.tanggal >= '".$year."-01-01' AND jm.tanggal < '".$this->sc_temp_start_date."'
		)x";
...
foreach($this->ds  as $ay){
	$bal_debet = $ay[0];
	$bal_kredit = $ay[1];
}

if($tipe_akun == 'Debet'){
	$balance = $bal_debet - $bal_kredit;
	$bal_akhir = $balance + $jml_debet - $jml_kredit;
}else{
	$balance = $bal_kredit - $bal_debet;
	$bal_akhir = $balance + $jml_kredit - $jml_debet;
}

echo '<html>
	<head>
		<title>Printed Format</title>
		<style>
			@font-face {
				font-family:"Arial";
			}
	...
	<body><center>
		...
		<div style="width:825px; margin-top:8px;color: #888; border-top:1px solid #AAA; border-bottom:1px solid #AAA; font-family:Arial; font-size:14px; font-weight: bold;">
				<div style="padding-top:24px;"><center>'.$institusi.'</center></div>
				<div style="padding-top:7px;"><center>IKHTISAR BUKU BESAR</center></div>
				<div style="padding-top:7px;"><center>'.$kd_akun.'&nbsp;&nbsp;&nbsp;'.$nm_akun.'</center></div>
				<div style="padding-top:7px;padding-bottom:24px;"><center>PERIODE: '.$this->sc_temp_start_date.' s/d '.$this->sc_temp_end_date.' </center></div>
			</div>
			
				<div style="margin-top:15px;">
					<table style="font-family:Arial; font-size:12px;border: 1px solid #BBB; width:825px;">
						<thead>
							<tr style="font-family:Arial; font-size:12px;border: 1px solid #BBB; height:32px;">
								<th style="border-right: 1px solid #BBB;border-top: 2px solid #BBB;border-bottom: 2px solid #BBB;">Saldo Awal</th>
								<th style="border-right: 1px solid #BBB;border-top: 2px solid #BBB;border-bottom: 2px solid #BBB;border-right: 1px solid #BBB;;">Mutasi Debet</th>
								<th style="border-top: 2px solid #BBB;border-bottom: 2px solid #BBB;border-right: 1px solid #BBB;">Mutasi Kredit</th>
								<th style="border-top: 2px solid #BBB;border-bottom: 2px solid #BBB;border-right: 1px solid #BBB;">Saldo Akhir</th>
							</tr>						
						</thead>
						<tbody>
							<tr style="font-family:Arial; font-size:12px;border: 1px solid #BBB;">
								<td style="height:24px; border-right: 1px solid #BBB;border-top: 1px solid #BBB;text-align:center;padding-left:3px;padding-right:3px;">'.$balance.'</td>
								<td style="height:24px; border-right: 1px solid #BBB;text-align:right;border-top: 1px solid #BBB;border-right: 1px solid #BBB;padding-left:3px;padding-right:3px;">'.number_format($jml_debet,2, ',' , '.' ).'</td>
								<td style="height:24px; border-top: 1px solid #BBB;text-align:right;border-right: 1px solid #BBB;padding-left:3px;padding-right:3px;">'.number_format($jml_kredit,2, ',' , '.' ).'</td>
								<td style="height:24px; border-top: 1px solid #BBB;text-align:right;padding-left:3px;padding-right:3px;">'.number_format($bal_akhir,2, ',' , '.' ).'</td>
							</tr>						
						</tbody>
					</table>
				</div>
			...
			<div style="margin-top:15px;">
				...
				<table style="font-family:Arial; font-size:12px;border: 1px solid #BBB; width:825px;">
					<thead>
						<tr style="font-family:Arial; font-size:12px;border: 1px solid #BBB; height:32px;">
							<th style="border-right: 1px solid #BBB;border-top: 2px solid #BBB;border-bottom: 2px solid #BBB;">Tanggal</th>
							<th style="border-right: 1px solid #BBB;border-top: 2px solid #BBB;border-bottom: 2px solid #BBB;border-right: 1px solid #BBB;">Referensi</th>
							<th style="border-right: 1px solid #BBB;border-top: 2px solid #BBB;border-bottom: 2px solid #BBB;border-right: 1px solid #BBB;">Keterangan</th>
							<th style="width:125px;border-top: 2px solid #BBB;border-bottom: 2px solid #BBB;border-right: 1px solid #BBB;">Debet</th>
							<th style="width:125px;border-top: 2px solid #BBB;border-bottom: 2px solid #BBB;">Kredit</th>
						</tr>
					</thead>
					<tbody>';

$sSQL = "SELECT jm.tanggal, jm.no_referensi, jm.keterangan, 
		CASE WHEN j.flag = 'D' THEN j.nominal ELSE 0 END debet,
		CASE WHEN j.flag = 'K' THEN j.nominal ELSE 0 END kredit
		FROM jurnal_detail j LEFT JOIN jurnal_master jm ON j.id_jurnal_master = jm.id
		LEFT JOIN akun a ON j.akun = a.id WHERE j.akun = '".$this->sc_temp_akun."' 
...
$no=1;
if(!empty($this->dataset )){
	foreach($this->dataset  as $ah){
		echo '<tr style="font-family:Arial; font-size:12px;border: 1px solid #BBB;">

								<td style="height:24px; border-right: 1px solid #BBB;border-top: 1px solid #BBB;text-align:center;padding-left:3px;padding-right:3px;">'.$ah[0].'</td>
								<td style="height:24px; border-right: 1px solid #BBB;border-top: 1px solid #BBB;text-align:center;border-right: 1px solid #BBB;padding-left:3px;padding-right:3px;">'.$ah[1].'</td>
								<td style="height:24px; border-top: 1px solid #BBB;text-align:left;border-right: 1px solid #BBB;padding-left:3px;padding-right:3px;">'.$ah[2].'</td>
								<td style="height:24px; border-top: 1px solid #BBB;text-align:right;border-right: 1px solid #BBB;padding-left:3px;padding-right:3px;">'.number_format($ah[3],2, ',' , '.' ).'</td>
								<td style="height:24px; border-top: 1px solid #BBB;text-align:right;padding-left:3px;padding-right:3px;">'.number_format($ah[4],2, ',' , '.' ).'</td>
							</tr>';	
		$no++;
	}	
}else{
	echo '<tr style="font-family:Arial; font-size:12px;border: 1px solid #BBB;">
								...
								<td style="height:24px; border-right: 1px solid #BBB;border-top: 1px solid #BBB;text-align:center;padding-left:3px;padding-right:3px;">&nbsp;</td>
								<td style="height:24px; border-right: 1px solid #BBB;border-top: 1px solid #BBB;border-right: 1px solid #BBB;padding-left:3px;padding-right:3px;">&nbsp;</td>
								<td style="height:24px; border-top: 1px solid #BBB;text-align:left;border-right: 1px solid #BBB;padding-left:3px;padding-right:3px;">&nbsp;</td>
								<td style="height:24px; border-top: 1px solid #BBB;text-align:right;border-right: 1px solid #BBB;padding-left:3px;padding-right:3px;">&nbsp;</td>
								<td style="height:24px; border-top: 1px solid #BBB;text-align:center;padding-left:3px;padding-right:3px;">&nbsp;</td>
							</tr>';	
}
...
$_SESSION['scriptcase']['report_general_ledger']['contr_erro'] = 'off'; 
//--- 
       $this->Db->Close(); 
       if ($this->Change_Menu)
       {
...
//======= =========================
   ...
   if (!empty($_POST))
   {
       foreach ($_POST as $nmgp_var => $nmgp_val)
       {
            ...
            nm_limpa_str_report_general_ledger($nmgp_val);
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['report_general_ledger']['glo_nm_path_imag_temp'] . "/sc_apl_default_simrskreatifmedia.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['report_general_ledger']['glo_nm_path_imag_temp'] . "/sc_apl_default_simrskreatifmedia.txt"));
       }
       if (isset($apl_def)) {
           if ($apl_def[0] != "report_general_ledger") {
               $_SESSION['scriptcase']['sem_session'] = true;
               if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                   $_SESSION['scriptcase']['report_general_ledger']['session_timeout']['redir'] = $apl_def[0];
               }
               else {
                   $_SESSION['scriptcase']['report_general_ledger']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
               }
               $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
               $_SESSION['scriptcase']['report_general_ledger']['session_timeout']['redir_tp'] = $Redir_tp;
           }
           if (isset($_COOKIE['sc_actual_lang_simrskreatifmedia'])) {
               $_SESSION['scriptcase']['report_general_ledger']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_simrskreatifmedia'];
           }
       }
   }
   ...
   if (isset($_POST["start_date"])) 
   {
       ...
       nm_limpa_str_report_general_ledger($_SESSION["start_date"]);
   }
   ...
   if (isset($_POST["end_date"])) 
   {
       ...
       nm_limpa_str_report_general_ledger($_SESSION["end_date"]);
   }
   ...
   if (isset($_POST["akun"])) 
   {
       ...
       nm_limpa_str_report_general_ledger($_SESSION["akun"]);
   }
   if (isset($_GET["akun"])) 
   {
   ...
   $salva_iframe = false;
   if (isset($_SESSION['sc_session'][$script_case_init]['report_general_ledger']['iframe_menu']))
   {
       $salva_iframe = $_SESSION['sc_session'][$script_case_init]['report_general_ledger']['iframe_menu'];
       unset($_SESSION['sc_session'][$script_case_init]['report_general_ledger']['iframe_menu']);
   }
   if (isset($nm_run_menu) && $nm_run_menu == 1)
   {
        ...
        $_SESSION['scriptcase']['sc_apl_menu_atual'] = "report_general_ledger";
        $achou = false;
        if (isset($_SESSION['sc_session'][$script_case_init]))
        {
            foreach ($_SESSION['sc_session'][$script_case_init] as $nome_apl => $resto)
            {
                if ($nome_apl == 'report_general_ledger' || $achou)
                {
        ...
        $_SESSION['sc_session'][$script_case_init]['report_general_ledger']['iframe_menu'] = true;
   }
   else
   {
       $_SESSION['sc_session'][$script_case_init]['report_general_ledger']['iframe_menu'] = $salva_iframe;
   }

   if (!isset($_SESSION['sc_session'][$script_case_init]['report_general_ledger']['initialize']))
   {
       $_SESSION['sc_session'][$script_case_init]['report_general_ledger']['initialize'] = true;
   }
   elseif (!isset($_SERVER['HTTP_REFERER']))
   {
       $_SESSION['sc_session'][$script_case_init]['report_general_ledger']['initialize'] = false;
   }
   ...
   else
   {
       ...
       if ('report_general_ledger' == $sReferer || 'report_general_ledger_' == substr($sReferer, 0, 22))
       {
           $_SESSION['sc_session'][$script_case_init]['report_general_ledger']['initialize'] = false;
       }
       else
   ...
   if (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'report_general_ledger')
   {
       $_SESSION['sc_session'][$script_case_init]['report_general_ledger']['sc_outra_jan'] = true;
        unset($_SESSION['scriptcase']['sc_outra_jan']);
   }
   $_SESSION['sc_session'][$script_case_init]['report_general_ledger']['menu_desenv'] = false;   
   if (!defined("SC_ERROR_HANDLER"))
   {
       define("SC_ERROR_HANDLER", 1);
       include_once(dirname(__FILE__) . "/report_general_ledger_erro.php");
   }
   if (!empty($nmgp_parms)) 
   { 
       ...
       while (!empty($todo[$ix]))
       {
            ...
            if (1 < sizeof($cadapar))
            {
                ...
                nm_limpa_str_report_general_ledger($cadapar[1]);
   ...
   $contr_report_general_ledger = new report_general_ledger_apl();
   $contr_report_general_ledger->controle();
//
   function nm_limpa_str_report_general_ledger(&$str)
   {
