  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_supplier_gizi_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_supplier_gizi_mob_form();
	}

  // ---------- Validate suppcode
  function do_ajax_form_supplier_gizi_mob_validate_suppcode()
  {
    var nomeCampo_suppcode = "suppcode";
    var var_suppcode = scAjaxGetFieldText(nomeCampo_suppcode);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_supplier_gizi_mob_validate_suppcode(var_suppcode, var_script_case_init, do_ajax_form_supplier_gizi_mob_validate_suppcode_cb);
  } // do_ajax_form_supplier_gizi_mob_validate_suppcode

  function do_ajax_form_supplier_gizi_mob_validate_suppcode_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "suppcode";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_supplier_gizi_mob_validate_suppcode_cb

  // ---------- Validate jenis
  function do_ajax_form_supplier_gizi_mob_validate_jenis()
  {
    var nomeCampo_jenis = "jenis";
    var var_jenis = scAjaxGetFieldSelect(nomeCampo_jenis);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_supplier_gizi_mob_validate_jenis(var_jenis, var_script_case_init, do_ajax_form_supplier_gizi_mob_validate_jenis_cb);
  } // do_ajax_form_supplier_gizi_mob_validate_jenis

  function do_ajax_form_supplier_gizi_mob_validate_jenis_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "jenis";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_supplier_gizi_mob_validate_jenis_cb

  // ---------- Validate nama
  function do_ajax_form_supplier_gizi_mob_validate_nama()
  {
    var nomeCampo_nama = "nama";
    var var_nama = scAjaxGetFieldText(nomeCampo_nama);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_supplier_gizi_mob_validate_nama(var_nama, var_script_case_init, do_ajax_form_supplier_gizi_mob_validate_nama_cb);
  } // do_ajax_form_supplier_gizi_mob_validate_nama

  function do_ajax_form_supplier_gizi_mob_validate_nama_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nama";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_supplier_gizi_mob_validate_nama_cb

  // ---------- Validate alamat
  function do_ajax_form_supplier_gizi_mob_validate_alamat()
  {
    var nomeCampo_alamat = "alamat";
    var var_alamat = scAjaxGetFieldText(nomeCampo_alamat);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_supplier_gizi_mob_validate_alamat(var_alamat, var_script_case_init, do_ajax_form_supplier_gizi_mob_validate_alamat_cb);
  } // do_ajax_form_supplier_gizi_mob_validate_alamat

  function do_ajax_form_supplier_gizi_mob_validate_alamat_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "alamat";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_supplier_gizi_mob_validate_alamat_cb

  // ---------- Validate telp
  function do_ajax_form_supplier_gizi_mob_validate_telp()
  {
    var nomeCampo_telp = "telp";
    var var_telp = scAjaxGetFieldText(nomeCampo_telp);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_supplier_gizi_mob_validate_telp(var_telp, var_script_case_init, do_ajax_form_supplier_gizi_mob_validate_telp_cb);
  } // do_ajax_form_supplier_gizi_mob_validate_telp

  function do_ajax_form_supplier_gizi_mob_validate_telp_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "telp";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_supplier_gizi_mob_validate_telp_cb

  // ---------- Validate cp
  function do_ajax_form_supplier_gizi_mob_validate_cp()
  {
    var nomeCampo_cp = "cp";
    var var_cp = scAjaxGetFieldText(nomeCampo_cp);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_supplier_gizi_mob_validate_cp(var_cp, var_script_case_init, do_ajax_form_supplier_gizi_mob_validate_cp_cb);
  } // do_ajax_form_supplier_gizi_mob_validate_cp

  function do_ajax_form_supplier_gizi_mob_validate_cp_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cp";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_supplier_gizi_mob_validate_cp_cb

  // ---------- Validate telp_cp
  function do_ajax_form_supplier_gizi_mob_validate_telp_cp()
  {
    var nomeCampo_telp_cp = "telp_cp";
    var var_telp_cp = scAjaxGetFieldText(nomeCampo_telp_cp);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_supplier_gizi_mob_validate_telp_cp(var_telp_cp, var_script_case_init, do_ajax_form_supplier_gizi_mob_validate_telp_cp_cb);
  } // do_ajax_form_supplier_gizi_mob_validate_telp_cp

  function do_ajax_form_supplier_gizi_mob_validate_telp_cp_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "telp_cp";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_supplier_gizi_mob_validate_telp_cp_cb

  // ---------- Validate no_rek
  function do_ajax_form_supplier_gizi_mob_validate_no_rek()
  {
    var nomeCampo_no_rek = "no_rek";
    var var_no_rek = scAjaxGetFieldText(nomeCampo_no_rek);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_supplier_gizi_mob_validate_no_rek(var_no_rek, var_script_case_init, do_ajax_form_supplier_gizi_mob_validate_no_rek_cb);
  } // do_ajax_form_supplier_gizi_mob_validate_no_rek

  function do_ajax_form_supplier_gizi_mob_validate_no_rek_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "no_rek";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_supplier_gizi_mob_validate_no_rek_cb

  // ---------- Validate aktif
  function do_ajax_form_supplier_gizi_mob_validate_aktif()
  {
    var nomeCampo_aktif = "aktif";
    var var_aktif = scAjaxGetFieldRadio(nomeCampo_aktif);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_supplier_gizi_mob_validate_aktif(var_aktif, var_script_case_init, do_ajax_form_supplier_gizi_mob_validate_aktif_cb);
  } // do_ajax_form_supplier_gizi_mob_validate_aktif

  function do_ajax_form_supplier_gizi_mob_validate_aktif_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "aktif";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_supplier_gizi_mob_validate_aktif_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_supplier_gizi_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_supplier_gizi_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_suppcode = scAjaxGetFieldText("suppcode");
    ...
    var var_telp_cp = scAjaxGetFieldText("telp_cp");
    var var_no_rek = scAjaxGetFieldText("no_rek");
    ...
    scAjaxProcOn();
    x_ajax_form_supplier_gizi_mob_submit_form(var_suppcode, var_jenis, var_nama, var_alamat, var_telp, var_cp, var_telp_cp, var_no_rek, var_aktif, var_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_supplier_gizi_mob_submit_form_cb);
  } // do_ajax_form_supplier_gizi_mob_submit_form

  function do_ajax_form_supplier_gizi_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("suppcode");
      ...
      scAjaxHideErrorDisplay("telp_cp");
      scAjaxHideErrorDisplay("no_rek");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_supplier_gizi_mob_submit_form_cb_after_alert);
  } // do_ajax_form_supplier_gizi_mob_submit_form_cb
  function do_ajax_form_supplier_gizi_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_supplier_gizi_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_supplier_gizi_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_supplier_gizi_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_supplier_gizi_mob_navigate_form_cb);
  } // do_ajax_form_supplier_gizi_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_supplier_gizi_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_supplier_gizi_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_supplier_gizi_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_supplier_gizi_mob_navigate_form_cb
  function do_ajax_form_supplier_gizi_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_supplier_gizi_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_supplier_gizi_mob_navigate_form_cb_after_alert
  function sc_hide_form_supplier_gizi_mob_form()
  {
  ...
  ajax_field_list[0] = "suppcode";
  ajax_field_list[1] = "jenis";
  ajax_field_list[2] = "nama";
  ajax_field_list[3] = "alamat";
  ajax_field_list[4] = "telp";
  ajax_field_list[5] = "cp";
  ajax_field_list[6] = "telp_cp";
  ajax_field_list[7] = "no_rek";
  ajax_field_list[8] = "aktif";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "suppcode": {"label": "Kode Supplier", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "jenis": {"label": "Jenis", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "nama": {"label": "Nama Supplier", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "alamat": {"label": "Alamat", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "telp": {"label": "Telp", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "cp": {"label": "CP", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "telp_cp": {"label": "Telp CP", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "no_rek": {"label": "No Rek", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  ajax_field_mult["suppcode"][1] = "suppcode";
  ...
  ajax_field_mult["telp_cp"][1] = "telp_cp";
  ajax_field_mult["no_rek"][1] = "no_rek";
  ajax_field_mult["aktif"][1] = "aktif";

  var ajax_field_id = {
    "suppcode": new Array("hidden_field_label_suppcode", "hidden_field_data_suppcode"),
    ...
    "telp_cp": new Array("hidden_field_label_telp_cp", "hidden_field_data_telp_cp"),
    "no_rek": new Array("hidden_field_label_no_rek", "hidden_field_data_no_rek"),
