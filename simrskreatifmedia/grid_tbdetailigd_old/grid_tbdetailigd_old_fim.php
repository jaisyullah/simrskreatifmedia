...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_tbdetailigd_old"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_tbdetailigd_old"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tbdetailigd_old']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_tbdetailigd_old']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tbdetailigd_old']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_tbdetailigd_old']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_tbdetailigd_old']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_tbdetailigd_old</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_tbdetailigd_old']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_tbdetailigd_old']['embutida_filho'] as $ind => $sc_init)
          {
