<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tbdetailigd_old']['sc_process_barr'] = true;
require_once('../grid_tbdetailigd_old/index.php');
unset($_SESSION['scriptcase']['grid_tbdetailigd_old']['sc_process_barr']);
$ExportCtrl = new grid_tbdetailigd_old_export_control;
$ExportCtrl->Export_barr();

class grid_tbdetailigd_old_export_control
{
