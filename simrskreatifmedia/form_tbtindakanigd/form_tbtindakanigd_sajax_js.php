  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbtindakanigd" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbtindakanigd_form();
	}

  // ---------- Validate pelaksana_
  function do_ajax_form_tbtindakanigd_validate_pelaksana_(iNumLinha)
  {
    var nomeCampo_pelaksana_ = "pelaksana_" + iNumLinha;
    var var_pelaksana_ = scAjaxGetFieldSelect(nomeCampo_pelaksana_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtindakanigd_validate_pelaksana_(var_pelaksana_, iNumLinha, var_script_case_init, do_ajax_form_tbtindakanigd_validate_pelaksana__cb);
  } // do_ajax_form_tbtindakanigd_validate_pelaksana_

  function do_ajax_form_tbtindakanigd_validate_pelaksana__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtindakanigd_validate_pelaksana__cb

  // ---------- Validate tindakan_
  function do_ajax_form_tbtindakanigd_validate_tindakan_(iNumLinha)
  {
    var nomeCampo_tindakan_ = "tindakan_" + iNumLinha;
    var var_tindakan_ = scAjaxGetFieldSelect(nomeCampo_tindakan_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtindakanigd_validate_tindakan_(var_tindakan_, iNumLinha, var_script_case_init, do_ajax_form_tbtindakanigd_validate_tindakan__cb);
  } // do_ajax_form_tbtindakanigd_validate_tindakan_

  function do_ajax_form_tbtindakanigd_validate_tindakan__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtindakanigd_validate_tindakan__cb

  // ---------- Validate biaya_
  function do_ajax_form_tbtindakanigd_validate_biaya_(iNumLinha)
  {
    var nomeCampo_biaya_ = "biaya_" + iNumLinha;
    var var_biaya_ = scAjaxGetFieldText(nomeCampo_biaya_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtindakanigd_validate_biaya_(var_biaya_, iNumLinha, var_script_case_init, do_ajax_form_tbtindakanigd_validate_biaya__cb);
  } // do_ajax_form_tbtindakanigd_validate_biaya_

  function do_ajax_form_tbtindakanigd_validate_biaya__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtindakanigd_validate_biaya__cb

  // ---------- Validate diskon_
  function do_ajax_form_tbtindakanigd_validate_diskon_(iNumLinha)
  {
    var nomeCampo_diskon_ = "diskon_" + iNumLinha;
    var var_diskon_ = scAjaxGetFieldText(nomeCampo_diskon_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtindakanigd_validate_diskon_(var_diskon_, iNumLinha, var_script_case_init, do_ajax_form_tbtindakanigd_validate_diskon__cb);
  } // do_ajax_form_tbtindakanigd_validate_diskon_

  function do_ajax_form_tbtindakanigd_validate_diskon__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtindakanigd_validate_diskon__cb

  // ---------- Validate tgltindakan_
  function do_ajax_form_tbtindakanigd_validate_tgltindakan_(iNumLinha)
  {
    var nomeCampo_tgltindakan_ = "tgltindakan_" + iNumLinha;
    var var_tgltindakan_ = scAjaxGetFieldText(nomeCampo_tgltindakan_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtindakanigd_validate_tgltindakan_(var_tgltindakan_, iNumLinha, var_script_case_init, do_ajax_form_tbtindakanigd_validate_tgltindakan__cb);
  } // do_ajax_form_tbtindakanigd_validate_tgltindakan_

  function do_ajax_form_tbtindakanigd_validate_tgltindakan__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtindakanigd_validate_tgltindakan__cb

  // ---------- Validate jumlah_
  function do_ajax_form_tbtindakanigd_validate_jumlah_(iNumLinha)
  {
    var nomeCampo_jumlah_ = "jumlah_" + iNumLinha;
    var var_jumlah_ = scAjaxGetFieldText(nomeCampo_jumlah_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtindakanigd_validate_jumlah_(var_jumlah_, iNumLinha, var_script_case_init, do_ajax_form_tbtindakanigd_validate_jumlah__cb);
  } // do_ajax_form_tbtindakanigd_validate_jumlah_

  function do_ajax_form_tbtindakanigd_validate_jumlah__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtindakanigd_validate_jumlah__cb

  // ---------- Validate id_
  function do_ajax_form_tbtindakanigd_validate_id_(iNumLinha)
  {
    var nomeCampo_id_ = "id_" + iNumLinha;
    var var_id_ = scAjaxGetFieldHidden(nomeCampo_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtindakanigd_validate_id_(var_id_, iNumLinha, var_script_case_init, do_ajax_form_tbtindakanigd_validate_id__cb);
  } // do_ajax_form_tbtindakanigd_validate_id_

  function do_ajax_form_tbtindakanigd_validate_id__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtindakanigd_validate_id__cb

  // ---------- Validate kode_akun_
  function do_ajax_form_tbtindakanigd_validate_kode_akun_(iNumLinha)
  {
    var nomeCampo_kode_akun_ = "kode_akun_" + iNumLinha;
    var var_kode_akun_ = scAjaxGetFieldText(nomeCampo_kode_akun_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtindakanigd_validate_kode_akun_(var_kode_akun_, iNumLinha, var_script_case_init, do_ajax_form_tbtindakanigd_validate_kode_akun__cb);
  } // do_ajax_form_tbtindakanigd_validate_kode_akun_

  function do_ajax_form_tbtindakanigd_validate_kode_akun__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "kode_akun_" + iLineNumber;
    }
    else
    {
      sFieldValid = "kode_akun_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "kode_akun_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "kode_akun_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtindakanigd_validate_kode_akun__cb

  // ---------- Validate id_tr_
  function do_ajax_form_tbtindakanigd_validate_id_tr_(iNumLinha)
  {
    var nomeCampo_id_tr_ = "id_tr_" + iNumLinha;
    var var_id_tr_ = scAjaxGetFieldText(nomeCampo_id_tr_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtindakanigd_validate_id_tr_(var_id_tr_, iNumLinha, var_script_case_init, do_ajax_form_tbtindakanigd_validate_id_tr__cb);
  } // do_ajax_form_tbtindakanigd_validate_id_tr_

  function do_ajax_form_tbtindakanigd_validate_id_tr__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtindakanigd_validate_id_tr__cb

  // ---------- Refresh pelaksana_
  function do_ajax_form_tbtindakanigd_refresh_pelaksana_(iSeqForm)
  {
    var var_pelaksana_ = scAjaxGetFieldSelect("pelaksana_" + iSeqForm);
    var var_nmgp_refresh_row = iSeqForm;
    var var_nmgp_refresh_fields = "kode_akun__#fld#_tindakan_";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tbtindakanigd_refresh_pelaksana_(var_pelaksana_, var_nmgp_refresh_row, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_tbtindakanigd_refresh_pelaksana__cb);
  } // do_ajax_form_tbtindakanigd_refresh_pelaksana_

  function do_ajax_form_tbtindakanigd_refresh_pelaksana__cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtindakanigd_refresh_pelaksana__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_tbtindakanigd_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_tbtindakanigd_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tbtindakanigd_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_tbtindakanigd_add_new_line_cb);
  } // do_ajax_form_tbtindakanigd_add_new_line

  function do_ajax_form_tbtindakanigd_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_tbtindakanigd_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_tbtindakanigd_backup_line(iNumLinha)
  {
    var var_id_ = scAjaxGetFieldHidden("id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtindakanigd_backup_line(var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_tbtindakanigd_backup_line_cb);
  } // do_ajax_form_tbtindakanigd_backup_line

  function do_ajax_form_tbtindakanigd_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_tbtindakanigd_backup_line_cb

  function do_ajax_form_tbtindakanigd_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_tbtindakanigd_cancel_insert

  function do_ajax_form_tbtindakanigd_cancel_update(iSeqVert)
  {
    do_ajax_form_tbtindakanigd_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_tbtindakanigd_cancel_update

  function do_ajax_form_tbtindakanigd_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_tbtindakanigd_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_tbtindakanigd_table_refresh()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tbtindakanigd_table_refresh(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbtindakanigd_table_refresh_cb);
  } //  do_ajax_form_tbtindakanigd_table_refresh

  function do_ajax_form_tbtindakanigd_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_tbtindakanigd_table_refresh_cb_after_alert);
  } // do_ajax_form_tbtindakanigd_table_refresh_cb
  function do_ajax_form_tbtindakanigd_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxSetNavStatus("t");
    sc_insert_open = false;
  } // do_ajax_form_tbtindakanigd_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_tbtindakanigd_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_tbtindakanigd_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    var var_id_ = scAjaxGetFieldHidden("id_" + iNumLinha);
    var var_kode_akun_ = scAjaxGetFieldText("kode_akun_" + iNumLinha);
...
?>
    x_ajax_form_tbtindakanigd_submit_form(var_pelaksana_, var_tindakan_, var_biaya_, var_diskon_, var_tgltindakan_, var_jumlah_, var_id_, var_kode_akun_, var_id_tr_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbtindakanigd_submit_form_cb);
  } // do_ajax_form_tbtindakanigd_submit_form

  function do_ajax_form_tbtindakanigd_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("kode_akun_" + sc_num_ult_line);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_tbtindakanigd_submit_form_cb_after_alert);
  } // do_ajax_form_tbtindakanigd_submit_form_cb
  function do_ajax_form_tbtindakanigd_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbtindakanigd_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tbtindakanigd_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_tbtindakanigd_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("kode_akun_" + iNavForm);
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tbtindakanigd_navigate_form(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbtindakanigd_navigate_form_cb);
  } // do_ajax_form_tbtindakanigd_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtindakanigd']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbtindakanigd_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbtindakanigd_navigate_form_cb_after_alert);
  } // do_ajax_form_tbtindakanigd_navigate_form_cb
  function do_ajax_form_tbtindakanigd_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_tbtindakanigd_navigate_form_cb_after_alert
  function sc_hide_form_tbtindakanigd_form()
  {
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "kode_akun_" + iNumLinha;
    iTotCampos++;
    ...
    ajax_error_list["kode_akun_" + iNumLinha] = {"label": "Kode Akun<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_field_mult["kode_akun_"][iNumLinha] = "kode_akun_" + iNumLinha;
    ...
    ajax_field_id["kode_akun_" + iNumLinha] = new Array("hidden_field_label_kode_akun_", "hidden_field_data_kode_akun_" + iNumLinha);
    ...
    ajax_error_count["kode_akun_" + iNumLinha] = "off";
    ajax_error_count["id_tr_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["pelaksana_" + iNumLinha] = "off";
    ajax_read_only["tindakan_" + iNumLinha] = "off";
    ...
    ajax_read_only["kode_akun_" + iNumLinha] = "off";
...
?>
    ...
    ajax_read_only["id_" + iNumLinha] = "on";
    ajax_read_only["kode_akun_" + iNumLinha] = "on";
...
?>
  ...
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["kode_akun_" + iNumLinha] = null;
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["kode_akun_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["kode_akun_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["kode_akun_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["kode_akun_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["kode_akun_" + iNumLinha]["onfocus"] = new Array();
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['pelaksana_'])) ? $this->nmgp_cmp_readonly['pelaksana_'] : 'off';
?>
    scAjaxFieldRead("pelaksana_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['tindakan_'])) ? $this->nmgp_cmp_readonly['tindakan_'] : 'off';
?>
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['kode_akun_'])) ? $this->nmgp_cmp_readonly['kode_akun_'] : 'off';
?>
    scAjaxFieldRead("kode_akun_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
?>
  ...
  function mdCloseObjects(iSeq)
  {
    ...
    scAjaxFieldRead("kode_akun_" + iSeq, "on");
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["pelaksana_" + iRow] || "on" == ajax_error_count["tindakan_" + iRow] || "on" == ajax_error_count["biaya_" + iRow] || "on" == ajax_error_count["diskon_" + iRow] || "on" == ajax_error_count["tgltindakan_" + iRow] || "on" == ajax_error_count["jumlah_" + iRow] || "on" == ajax_error_count["id_" + iRow] || "on" == ajax_error_count["kode_akun_" + iRow] || "on" == ajax_error_count["id_tr_" + iRow]))
    {
      ...
      $("#hidden_field_data_kode_akun_" + iRow).addClass("scFormErrorLine");
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["pelaksana_" + iRow] && "off" == ajax_error_count["tindakan_" + iRow] && "off" == ajax_error_count["biaya_" + iRow] && "off" == ajax_error_count["diskon_" + iRow] && "off" == ajax_error_count["tgltindakan_" + iRow] && "off" == ajax_error_count["jumlah_" + iRow] && "off" == ajax_error_count["id_" + iRow] && "off" == ajax_error_count["kode_akun_" + iRow] && "off" == ajax_error_count["id_tr_" + iRow]))
    {
      if (bErrorRow)
      {
        ...
        ajax_error_count["kode_akun_" + iRow] = "off";
      ...
      $("#hidden_field_data_kode_akun_" + iRow).removeClass("scFormErrorLine");
