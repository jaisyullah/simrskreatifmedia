  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbhisrateobat" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbhisrateobat_form();
	}

  // ---------- Validate id_
  function do_ajax_form_tbhisrateobat_validate_id_(iNumLinha)
  {
    var nomeCampo_id_ = "id_" + iNumLinha;
    var var_id_ = scAjaxGetFieldHidden(nomeCampo_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbhisrateobat_validate_id_(var_id_, iNumLinha, var_script_case_init, do_ajax_form_tbhisrateobat_validate_id__cb);
  } // do_ajax_form_tbhisrateobat_validate_id_

  function do_ajax_form_tbhisrateobat_validate_id__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbhisrateobat_validate_id__cb

  // ---------- Validate principal_
  function do_ajax_form_tbhisrateobat_validate_principal_(iNumLinha)
  {
    var nomeCampo_principal_ = "principal_" + iNumLinha;
    var var_principal_ = scAjaxGetFieldText(nomeCampo_principal_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbhisrateobat_validate_principal_(var_principal_, iNumLinha, var_script_case_init, do_ajax_form_tbhisrateobat_validate_principal__cb);
  } // do_ajax_form_tbhisrateobat_validate_principal_

  function do_ajax_form_tbhisrateobat_validate_principal__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbhisrateobat_validate_principal__cb

  // ---------- Validate isi_
  function do_ajax_form_tbhisrateobat_validate_isi_(iNumLinha)
  {
    var nomeCampo_isi_ = "isi_" + iNumLinha;
    var var_isi_ = scAjaxGetFieldText(nomeCampo_isi_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbhisrateobat_validate_isi_(var_isi_, iNumLinha, var_script_case_init, do_ajax_form_tbhisrateobat_validate_isi__cb);
  } // do_ajax_form_tbhisrateobat_validate_isi_

  function do_ajax_form_tbhisrateobat_validate_isi__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbhisrateobat_validate_isi__cb

  // ---------- Validate harga_
  function do_ajax_form_tbhisrateobat_validate_harga_(iNumLinha)
  {
    var nomeCampo_harga_ = "harga_" + iNumLinha;
    var var_harga_ = scAjaxGetFieldText(nomeCampo_harga_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbhisrateobat_validate_harga_(var_harga_, iNumLinha, var_script_case_init, do_ajax_form_tbhisrateobat_validate_harga__cb);
  } // do_ajax_form_tbhisrateobat_validate_harga_

  function do_ajax_form_tbhisrateobat_validate_harga__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbhisrateobat_validate_harga__cb

  // ---------- Validate buydate_
  function do_ajax_form_tbhisrateobat_validate_buydate_(iNumLinha)
  {
    var nomeCampo_buydate_ = "buydate_" + iNumLinha;
    var var_buydate_ = scAjaxGetFieldText(nomeCampo_buydate_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbhisrateobat_validate_buydate_(var_buydate_, iNumLinha, var_script_case_init, do_ajax_form_tbhisrateobat_validate_buydate__cb);
  } // do_ajax_form_tbhisrateobat_validate_buydate_

  function do_ajax_form_tbhisrateobat_validate_buydate__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "buydate_" + iLineNumber;
    }
    else
    {
      sFieldValid = "buydate_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "buydate_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "buydate_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbhisrateobat_validate_buydate__cb

  // ---------- Validate aktif_
  function do_ajax_form_tbhisrateobat_validate_aktif_(iNumLinha)
  {
    var nomeCampo_aktif_ = "aktif_" + iNumLinha;
    var var_aktif_ = scAjaxGetFieldSelect(nomeCampo_aktif_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbhisrateobat_validate_aktif_(var_aktif_, iNumLinha, var_script_case_init, do_ajax_form_tbhisrateobat_validate_aktif__cb);
  } // do_ajax_form_tbhisrateobat_validate_aktif_

  function do_ajax_form_tbhisrateobat_validate_aktif__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbhisrateobat_validate_aktif__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_tbhisrateobat_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_tbhisrateobat_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tbhisrateobat_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_tbhisrateobat_add_new_line_cb);
  } // do_ajax_form_tbhisrateobat_add_new_line

  function do_ajax_form_tbhisrateobat_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_tbhisrateobat_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_tbhisrateobat_backup_line(iNumLinha)
  {
    var var_id_ = scAjaxGetFieldHidden("id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbhisrateobat_backup_line(var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_tbhisrateobat_backup_line_cb);
  } // do_ajax_form_tbhisrateobat_backup_line

  function do_ajax_form_tbhisrateobat_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_tbhisrateobat_backup_line_cb

  function do_ajax_form_tbhisrateobat_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_tbhisrateobat_cancel_insert

  function do_ajax_form_tbhisrateobat_cancel_update(iSeqVert)
  {
    do_ajax_form_tbhisrateobat_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_tbhisrateobat_cancel_update

  function do_ajax_form_tbhisrateobat_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_tbhisrateobat_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_tbhisrateobat_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_tbhisrateobat_table_refresh(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbhisrateobat_table_refresh_cb);
  } //  do_ajax_form_tbhisrateobat_table_refresh

  function do_ajax_form_tbhisrateobat_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_tbhisrateobat_table_refresh_cb_after_alert);
  } // do_ajax_form_tbhisrateobat_table_refresh_cb
  function do_ajax_form_tbhisrateobat_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_tbhisrateobat_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_tbhisrateobat_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_tbhisrateobat_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    var var_buydate_ = scAjaxGetFieldText("buydate_" + iNumLinha);
...
?>
    x_ajax_form_tbhisrateobat_submit_form(var_id_, var_principal_, var_isi_, var_harga_, var_buydate_, var_aktif_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbhisrateobat_submit_form_cb);
  } // do_ajax_form_tbhisrateobat_submit_form

  function do_ajax_form_tbhisrateobat_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("buydate_" + sc_num_ult_line);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_tbhisrateobat_submit_form_cb_after_alert);
  } // do_ajax_form_tbhisrateobat_submit_form_cb
  function do_ajax_form_tbhisrateobat_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbhisrateobat_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tbhisrateobat_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("buydate_" + iNavForm);
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tbhisrateobat_navigate_form(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbhisrateobat_navigate_form_cb);
  } // do_ajax_form_tbhisrateobat_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhisrateobat']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbhisrateobat_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbhisrateobat_navigate_form_cb_after_alert);
  } // do_ajax_form_tbhisrateobat_navigate_form_cb
  function do_ajax_form_tbhisrateobat_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_tbhisrateobat_navigate_form_cb_after_alert
  function sc_hide_form_tbhisrateobat_form()
  {
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "buydate_" + iNumLinha;
    iTotCampos++;
    ...
    ajax_error_list["buydate_" + iNumLinha] = {"label": "Buy Date<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_field_mult["buydate_"][iNumLinha] = "buydate_" + iNumLinha;
    ...
    ajax_field_id["buydate_" + iNumLinha] = new Array("hidden_field_label_buydate_", "hidden_field_data_buydate_" + iNumLinha);
    ...
    ajax_error_count["buydate_" + iNumLinha] = "off";
...
?>
    ...
    ajax_read_only["buydate_" + iNumLinha] = "off";
...
?>
    ...
    ajax_read_only["buydate_" + iNumLinha] = "on";
...
?>
  ...
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["buydate_" + iNumLinha] = null;
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["buydate_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["buydate_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["buydate_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["buydate_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["buydate_" + iNumLinha]["onfocus"] = new Array();
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['buydate_'])) ? $this->nmgp_cmp_readonly['buydate_'] : 'off';
?>
    scAjaxFieldRead("buydate_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
?>
  ...
  function mdCloseObjects(iSeq)
  {
    ...
    scAjaxFieldRead("buydate_" + iSeq, "on");
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["id_" + iRow] || "on" == ajax_error_count["principal_" + iRow] || "on" == ajax_error_count["isi_" + iRow] || "on" == ajax_error_count["harga_" + iRow] || "on" == ajax_error_count["buydate_" + iRow] || "on" == ajax_error_count["aktif_" + iRow]))
    {
      ...
      $("#hidden_field_data_buydate_" + iRow).addClass("scFormErrorLine");
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["id_" + iRow] && "off" == ajax_error_count["principal_" + iRow] && "off" == ajax_error_count["isi_" + iRow] && "off" == ajax_error_count["harga_" + iRow] && "off" == ajax_error_count["buydate_" + iRow] && "off" == ajax_error_count["aktif_" + iRow]))
    {
      if (bErrorRow)
      {
        ...
        ajax_error_count["buydate_" + iRow] = "off";
      ...
      $("#hidden_field_data_buydate_" + iRow).removeClass("scFormErrorLine");
