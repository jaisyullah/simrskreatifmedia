<?php
@session_start() ;
$_SESSION['scriptcase']['lap_grid_tbpo']['sc_process_barr'] = true;
require_once('../lap_grid_tbpo/index.php');
unset($_SESSION['scriptcase']['lap_grid_tbpo']['sc_process_barr']);
$ExportCtrl = new lap_grid_tbpo_export_control;
$ExportCtrl->Export_barr();

class lap_grid_tbpo_export_control
{
