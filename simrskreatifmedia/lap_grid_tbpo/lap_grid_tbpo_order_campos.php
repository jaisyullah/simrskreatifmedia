...
<?php
   ...
   $Ord_Cmp = new lap_grid_tbpo_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class lap_grid_tbpo_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['lap_grid_tbpo']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['lap_grid_tbpo']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["pocode"]   = (isset($_SESSION['sc_session'][$sc_init]['lap_grid_tbpo']['labels']["pocode"])) ? $_SESSION['sc_session'][$sc_init]['lap_grid_tbpo']['labels']["pocode"] : "Kode PO";
   $tab_ger_campos['pbf'] = "on";
   $tab_def_campos['pbf'] = "pbf";
   $tab_labels["pbf"]   = (isset($_SESSION['sc_session'][$sc_init]['lap_grid_tbpo']['labels']["pbf"])) ? $_SESSION['sc_session'][$sc_init]['lap_grid_tbpo']['labels']["pbf"] : "PBF/Supplier";
   $tab_ger_campos['non_pbf'] = "on";
   $tab_def_campos['non_pbf'] = "non_pbf";
   $tab_labels["non_pbf"]   = (isset($_SESSION['sc_session'][$sc_init]['lap_grid_tbpo']['labels']["non_pbf"])) ? $_SESSION['sc_session'][$sc_init]['lap_grid_tbpo']['labels']["non_pbf"] : "Non PBF";
   $tab_ger_campos['pesandate'] = "on";
   $tab_def_campos['pesandate'] = "pesanDate";
   $tab_labels["pesandate"]   = (isset($_SESSION['sc_session'][$sc_init]['lap_grid_tbpo']['labels']["pesandate"])) ? $_SESSION['sc_session'][$sc_init]['lap_grid_tbpo']['labels']["pesandate"] : "Tgl. Pesan";
   $tab_ger_campos['total'] = "on";
   $tab_def_campos['total'] = "total";
   $tab_labels["total"]   = (isset($_SESSION['sc_session'][$sc_init]['lap_grid_tbpo']['labels']["total"])) ? $_SESSION['sc_session'][$sc_init]['lap_grid_tbpo']['labels']["total"] : "Total";
   $tab_ger_campos['status'] = "on";
   $tab_def_campos['status'] = "status";
   $tab_labels["status"]   = (isset($_SESSION['sc_session'][$sc_init]['lap_grid_tbpo']['labels']["status"])) ? $_SESSION['sc_session'][$sc_init]['lap_grid_tbpo']['labels']["status"] : "Status";
   $tab_ger_campos['detailpo'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['detailpo'] = "detailPO";
   }
   else
   {
       $tab_def_campos['detailpo'] = "";
   }
   $tab_labels["detailpo"]   = (isset($_SESSION['sc_session'][$sc_init]['lap_grid_tbpo']['labels']["detailpo"])) ? $_SESSION['sc_session'][$sc_init]['lap_grid_tbpo']['labels']["detailpo"] : "Detail Item";
   $tab_ger_campos['fakturno'] = "on";
   $tab_def_campos['fakturno'] = "fakturNo";
   $tab_labels["fakturno"]   = (isset($_SESSION['sc_session'][$sc_init]['lap_grid_tbpo']['labels']["fakturno"])) ? $_SESSION['sc_session'][$sc_init]['lap_grid_tbpo']['labels']["fakturno"] : "Faktur No";
   $tab_ger_campos['detailpo'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['lap_grid_tbpo']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['lap_grid_tbpo']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['lap_grid_tbpo']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['lap_grid_tbpo']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['lap_grid_tbpo']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['lap_grid_tbpo']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['lap_grid_tbpo']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['lap_grid_tbpo']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['lap_grid_tbpo']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "lap_grid_tbpo_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['lap_grid_tbpo']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['lap_grid_tbpo']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['lap_grid_tbpo']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['lap_grid_tbpo']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['lap_grid_tbpo']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
