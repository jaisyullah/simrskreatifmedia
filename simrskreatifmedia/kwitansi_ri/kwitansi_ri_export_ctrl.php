<?php
@session_start() ;
$_SESSION['scriptcase']['kwitansi_ri']['sc_process_barr'] = true;
require_once('../kwitansi_ri/index.php');
unset($_SESSION['scriptcase']['kwitansi_ri']['sc_process_barr']);
$ExportCtrl = new kwitansi_ri_export_control;
$ExportCtrl->Export_barr();

class kwitansi_ri_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - Kuitansi :: Excel</TITLE>
