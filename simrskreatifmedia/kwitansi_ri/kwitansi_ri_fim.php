...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____kwitansi_ri"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____kwitansi_ri"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['kwitansi_ri']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['kwitansi_ri']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['kwitansi_ri']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['kwitansi_ri']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['kwitansi_ri']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['kwitansi_ri']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['kwitansi_ri']['embutida_filho'] as $ind => $sc_init)
          {
