<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['kwitansi_ri']['glo_nm_path_imag_temp'] . "/sc_apl_default_simrskreatifmedia.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new kwitansi_ri_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class kwitansi_ri_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['kwitansi_ri']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['kwitansi_ri']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["trancode"]   = (isset($_SESSION['sc_session'][$sc_init]['kwitansi_ri']['labels']["trancode"])) ? $_SESSION['sc_session'][$sc_init]['kwitansi_ri']['labels']["trancode"] : "Kode Transaksi";
   $tab_ger_campos['custcode'] = "on";
   $tab_def_campos['custcode'] = "custCode";
   $tab_labels["custcode"]   = (isset($_SESSION['sc_session'][$sc_init]['kwitansi_ri']['labels']["custcode"])) ? $_SESSION['sc_session'][$sc_init]['kwitansi_ri']['labels']["custcode"] : "No. RM";
   $tab_ger_campos['dokter'] = "on";
   $tab_def_campos['dokter'] = "dokter";
   $tab_labels["dokter"]   = (isset($_SESSION['sc_session'][$sc_init]['kwitansi_ri']['labels']["dokter"])) ? $_SESSION['sc_session'][$sc_init]['kwitansi_ri']['labels']["dokter"] : "Dokter";
   $tab_ger_campos['jmltagihan'] = "on";
   $tab_def_campos['jmltagihan'] = "jmlTagihan";
   $tab_labels["jmltagihan"]   = (isset($_SESSION['sc_session'][$sc_init]['kwitansi_ri']['labels']["jmltagihan"])) ? $_SESSION['sc_session'][$sc_init]['kwitansi_ri']['labels']["jmltagihan"] : "Jml Tagihan";
   $tab_ger_campos['jmlbayar'] = "on";
   $tab_def_campos['jmlbayar'] = "jmlBayar";
   $tab_labels["jmlbayar"]   = (isset($_SESSION['sc_session'][$sc_init]['kwitansi_ri']['labels']["jmlbayar"])) ? $_SESSION['sc_session'][$sc_init]['kwitansi_ri']['labels']["jmlbayar"] : "Jml Bayar";
   $tab_ger_campos['deposit'] = "on";
   $tab_def_campos['deposit'] = "deposit";
   $tab_labels["deposit"]   = (isset($_SESSION['sc_session'][$sc_init]['kwitansi_ri']['labels']["deposit"])) ? $_SESSION['sc_session'][$sc_init]['kwitansi_ri']['labels']["deposit"] : "Deposit";
   $tab_ger_campos['potongan'] = "on";
   $tab_def_campos['potongan'] = "potongan";
   $tab_labels["potongan"]   = (isset($_SESSION['sc_session'][$sc_init]['kwitansi_ri']['labels']["potongan"])) ? $_SESSION['sc_session'][$sc_init]['kwitansi_ri']['labels']["potongan"] : "Potongan";
   $tab_ger_campos['hrsdibayar'] = "on";
   $tab_def_campos['hrsdibayar'] = "hrsDibayar";
   $tab_labels["hrsdibayar"]   = (isset($_SESSION['sc_session'][$sc_init]['kwitansi_ri']['labels']["hrsdibayar"])) ? $_SESSION['sc_session'][$sc_init]['kwitansi_ri']['labels']["hrsdibayar"] : "Hrs Dibayar";
   $tab_ger_campos['trandate'] = "on";
   $tab_def_campos['trandate'] = "tranDate";
   $tab_labels["trandate"]   = (isset($_SESSION['sc_session'][$sc_init]['kwitansi_ri']['labels']["trandate"])) ? $_SESSION['sc_session'][$sc_init]['kwitansi_ri']['labels']["trandate"] : "Tran Date";
   $tab_ger_campos['terimadari'] = "on";
   $tab_def_campos['terimadari'] = "terimaDari";
   $tab_labels["terimadari"]   = (isset($_SESSION['sc_session'][$sc_init]['kwitansi_ri']['labels']["terimadari"])) ? $_SESSION['sc_session'][$sc_init]['kwitansi_ri']['labels']["terimadari"] : "Terima Dari";
   $tab_ger_campos['jenispayment'] = "on";
   $tab_def_campos['jenispayment'] = "jenisPayment";
   $tab_labels["jenispayment"]   = (isset($_SESSION['sc_session'][$sc_init]['kwitansi_ri']['labels']["jenispayment"])) ? $_SESSION['sc_session'][$sc_init]['kwitansi_ri']['labels']["jenispayment"] : "Jenis Payment";
   ...
   {
       $tab_def_campos['sc_field_0'] = "SELECT sc_concat(name,',', salut) 
FROM tbcustomer 
WHERE custCode = '{custCode}' 
ORDER BY name, salut";
   }
   $tab_labels["sc_field_0"]   = (isset($_SESSION['sc_session'][$sc_init]['kwitansi_ri']['labels']["sc_field_0"])) ? $_SESSION['sc_session'][$sc_init]['kwitansi_ri']['labels']["sc_field_0"] : "Nama Pasien";
   $tab_ger_campos['rp1'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['rp1'] = "Rp1";
   }
   else
   {
       $tab_def_campos['rp1'] = "";
   }
   $tab_labels["rp1"]   = (isset($_SESSION['sc_session'][$sc_init]['kwitansi_ri']['labels']["rp1"])) ? $_SESSION['sc_session'][$sc_init]['kwitansi_ri']['labels']["rp1"] : "Rp1";
   $tab_ger_campos['rp2'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['rp2'] = "Rp2";
   }
   else
   {
       $tab_def_campos['rp2'] = "";
   }
   $tab_labels["rp2"]   = (isset($_SESSION['sc_session'][$sc_init]['kwitansi_ri']['labels']["rp2"])) ? $_SESSION['sc_session'][$sc_init]['kwitansi_ri']['labels']["rp2"] : "Rp2";
   $tab_ger_campos['rp3'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['rp3'] = "Rp3";
   }
   else
   {
       $tab_def_campos['rp3'] = "";
   }
   $tab_labels["rp3"]   = (isset($_SESSION['sc_session'][$sc_init]['kwitansi_ri']['labels']["rp3"])) ? $_SESSION['sc_session'][$sc_init]['kwitansi_ri']['labels']["rp3"] : "Rp3";
   $tab_ger_campos['adm'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['adm'] = "adm";
   }
   else
   {
       $tab_def_campos['adm'] = "";
   }
   $tab_labels["adm"]   = (isset($_SESSION['sc_session'][$sc_init]['kwitansi_ri']['labels']["adm"])) ? $_SESSION['sc_session'][$sc_init]['kwitansi_ri']['labels']["adm"] : "adm";
   $tab_ger_campos['biaya'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['biaya'] = "biaya";
   }
   else
   {
       $tab_def_campos['biaya'] = "";
   }
   $tab_labels["biaya"]   = (isset($_SESSION['sc_session'][$sc_init]['kwitansi_ri']['labels']["biaya"])) ? $_SESSION['sc_session'][$sc_init]['kwitansi_ri']['labels']["biaya"] : "biaya";
   $tab_ger_campos['biayaadm'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['biayaadm'] = "biayaadm";
   }
   else
   {
       $tab_def_campos['biayaadm'] = "";
   }
   $tab_labels["biayaadm"]   = (isset($_SESSION['sc_session'][$sc_init]['kwitansi_ri']['labels']["biayaadm"])) ? $_SESSION['sc_session'][$sc_init]['kwitansi_ri']['labels']["biayaadm"] : "biayaadm";
   $tab_ger_campos['biayaresep'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['biayaresep'] = "biayaresep";
   }
   else
   {
       $tab_def_campos['biayaresep'] = "";
   }
   $tab_labels["biayaresep"]   = (isset($_SESSION['sc_session'][$sc_init]['kwitansi_ri']['labels']["biayaresep"])) ? $_SESSION['sc_session'][$sc_init]['kwitansi_ri']['labels']["biayaresep"] : "biayaresep";
   $tab_ger_campos['jmlresep'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['jmlresep'] = "jmlResep";
   }
   else
   {
       $tab_def_campos['jmlresep'] = "";
   }
   $tab_labels["jmlresep"]   = (isset($_SESSION['sc_session'][$sc_init]['kwitansi_ri']['labels']["jmlresep"])) ? $_SESSION['sc_session'][$sc_init]['kwitansi_ri']['labels']["jmlresep"] : "jmlResep";
   $tab_ger_campos['jmltdk'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['jmltdk'] = "jmlTdk";
   }
   else
   {
       $tab_def_campos['jmltdk'] = "";
   }
   $tab_labels["jmltdk"]   = (isset($_SESSION['sc_session'][$sc_init]['kwitansi_ri']['labels']["jmltdk"])) ? $_SESSION['sc_session'][$sc_init]['kwitansi_ri']['labels']["jmltdk"] : "jmlTdk";
   $tab_ger_campos['resep'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['resep'] = "resep";
   }
   else
   {
       $tab_def_campos['resep'] = "";
   }
   $tab_labels["resep"]   = (isset($_SESSION['sc_session'][$sc_init]['kwitansi_ri']['labels']["resep"])) ? $_SESSION['sc_session'][$sc_init]['kwitansi_ri']['labels']["resep"] : "resep";
   $tab_ger_campos['satuanresep'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['satuanresep'] = "satuanResep";
   }
   else
   {
       $tab_def_campos['satuanresep'] = "";
   }
   $tab_labels["satuanresep"]   = (isset($_SESSION['sc_session'][$sc_init]['kwitansi_ri']['labels']["satuanresep"])) ? $_SESSION['sc_session'][$sc_init]['kwitansi_ri']['labels']["satuanresep"] : "satuanResep";
   $tab_ger_campos['satuantdk'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['satuantdk'] = "satuanTdk";
   }
   else
   {
       $tab_def_campos['satuantdk'] = "";
   }
   $tab_labels["satuantdk"]   = (isset($_SESSION['sc_session'][$sc_init]['kwitansi_ri']['labels']["satuantdk"])) ? $_SESSION['sc_session'][$sc_init]['kwitansi_ri']['labels']["satuantdk"] : "satuanTdk";
   $tab_ger_campos['terbilang'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['terbilang'] = "terbilang";
   }
   else
   {
       $tab_def_campos['terbilang'] = "";
   }
   $tab_labels["terbilang"]   = (isset($_SESSION['sc_session'][$sc_init]['kwitansi_ri']['labels']["terbilang"])) ? $_SESSION['sc_session'][$sc_init]['kwitansi_ri']['labels']["terbilang"] : "terbilang";
   $tab_ger_campos['tindakan'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['tindakan'] = "tindakan";
   }
   else
   {
       $tab_def_campos['tindakan'] = "";
   }
   $tab_labels["tindakan"]   = (isset($_SESSION['sc_session'][$sc_init]['kwitansi_ri']['labels']["tindakan"])) ? $_SESSION['sc_session'][$sc_init]['kwitansi_ri']['labels']["tindakan"] : "tindakan";
   $tab_ger_campos['sc_field_0'] = "none";
   $tab_ger_campos['rp1'] = "none";
   $tab_ger_campos['rp2'] = "none";
   $tab_ger_campos['rp3'] = "none";
   $tab_ger_campos['adm'] = "none";
   $tab_ger_campos['biaya'] = "none";
   $tab_ger_campos['biayaadm'] = "none";
   $tab_ger_campos['biayaresep'] = "none";
   $tab_ger_campos['jmlresep'] = "none";
   $tab_ger_campos['jmltdk'] = "none";
   $tab_ger_campos['resep'] = "none";
   $tab_ger_campos['satuanresep'] = "none";
   $tab_ger_campos['satuantdk'] = "none";
   $tab_ger_campos['terbilang'] = "none";
   $tab_ger_campos['tindakan'] = "none";
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['kwitansi_ri']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['kwitansi_ri']['field_display']))
   {
       foreach ($_SESSION['scriptcase']['sc_apl_conf']['kwitansi_ri']['field_display'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['kwitansi_ri']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['kwitansi_ri']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['kwitansi_ri']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['kwitansi_ri']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['kwitansi_ri']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['kwitansi_ri']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['kwitansi_ri']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['kwitansi_ri']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['kwitansi_ri']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - Kuitansi</TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "kwitansi_ri_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['kwitansi_ri']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['kwitansi_ri']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['kwitansi_ri']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['kwitansi_ri']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['kwitansi_ri']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
