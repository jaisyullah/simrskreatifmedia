...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_pesandate_hora' + iSeqRow).bind('blur', function() { sc_form_tbreq_pesandate_onblur(this, iSeqRow) })
                                            .bind('focus', function() { sc_form_tbreq_pesandate_onfocus(this, iSeqRow) });
  ...
  $('#id_sc_field_jatuhtempo_hora' + iSeqRow).bind('blur', function() { sc_form_tbreq_jatuhtempo_onblur(this, iSeqRow) })
                                             .bind('focus', function() { sc_form_tbreq_jatuhtempo_onfocus(this, iSeqRow) });
...
function displayChange_field_detailpo(row, status) {
	if ("on" == status && typeof $("#nmsc_iframe_liga_form_tbreqdetail_mob")[0].contentWindow.scRecreateSelect2 === "function") {
		$("#nmsc_iframe_liga_form_tbreqdetail_mob")[0].contentWindow.scRecreateSelect2();
	}
}
...
function scHidePage(pageNo) {
	$("#id_form_tbreq_mob_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_pesandate" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_tbreq_mob_validate_pesandate(iSeqRow);
    },
    numberOfMonths: 1,
    changeMonth: true,
    changeYear: true,
...
?>
  ...
  $("#id_sc_field_jatuhtempo" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_tbreq_mob_validate_jatuhtempo(iSeqRow);
    },
    numberOfMonths: 1,
    changeMonth: true,
    changeYear: true,
...
?>
  ...
  $("#id_sc_field_datangdate" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_tbreq_mob_validate_datangdate(iSeqRow);
    },
    numberOfMonths: 1,
    changeMonth: true,
    changeYear: true,
