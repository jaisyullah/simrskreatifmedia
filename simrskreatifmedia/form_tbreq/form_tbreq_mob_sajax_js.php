  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbreq_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbreq_mob_form();
	}

  // ---------- Validate pesandate
  function do_ajax_form_tbreq_mob_validate_pesandate()
  {
    var nomeCampo_pesandate = "pesandate";
    var var_pesandate = scAjaxGetFieldText(nomeCampo_pesandate);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbreq_mob_validate_pesandate(var_pesandate, var_script_case_init, do_ajax_form_tbreq_mob_validate_pesandate_cb);
  } // do_ajax_form_tbreq_mob_validate_pesandate

  function do_ajax_form_tbreq_mob_validate_pesandate_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbreq_mob_validate_pesandate_cb

  // ---------- Validate status
  function do_ajax_form_tbreq_mob_validate_status()
  {
    var nomeCampo_status = "status";
    var var_status = scAjaxGetFieldText(nomeCampo_status);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbreq_mob_validate_status(var_status, var_script_case_init, do_ajax_form_tbreq_mob_validate_status_cb);
  } // do_ajax_form_tbreq_mob_validate_status

  function do_ajax_form_tbreq_mob_validate_status_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "status";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbreq_mob_validate_status_cb

  // ---------- Validate total
  function do_ajax_form_tbreq_mob_validate_total()
  {
    var nomeCampo_total = "total";
    var var_total = scAjaxGetFieldText(nomeCampo_total);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbreq_mob_validate_total(var_total, var_script_case_init, do_ajax_form_tbreq_mob_validate_total_cb);
  } // do_ajax_form_tbreq_mob_validate_total

  function do_ajax_form_tbreq_mob_validate_total_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "total";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbreq_mob_validate_total_cb

  // ---------- Validate jatuhtempo
  function do_ajax_form_tbreq_mob_validate_jatuhtempo()
  {
    var nomeCampo_jatuhtempo = "jatuhtempo";
    var var_jatuhtempo = scAjaxGetFieldText(nomeCampo_jatuhtempo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbreq_mob_validate_jatuhtempo(var_jatuhtempo, var_script_case_init, do_ajax_form_tbreq_mob_validate_jatuhtempo_cb);
  } // do_ajax_form_tbreq_mob_validate_jatuhtempo

  function do_ajax_form_tbreq_mob_validate_jatuhtempo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbreq_mob_validate_jatuhtempo_cb

  // ---------- Validate note
  function do_ajax_form_tbreq_mob_validate_note()
  {
    var nomeCampo_note = "note";
    var var_note = scAjaxGetFieldText(nomeCampo_note);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbreq_mob_validate_note(var_note, var_script_case_init, do_ajax_form_tbreq_mob_validate_note_cb);
  } // do_ajax_form_tbreq_mob_validate_note

  function do_ajax_form_tbreq_mob_validate_note_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "note";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbreq_mob_validate_note_cb

  // ---------- Validate detailpo
  function do_ajax_form_tbreq_mob_validate_detailpo()
  {
    var nomeCampo_detailpo = "detailpo";
    var var_detailpo = scAjaxGetFieldText(nomeCampo_detailpo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbreq_mob_validate_detailpo(var_detailpo, var_script_case_init, do_ajax_form_tbreq_mob_validate_detailpo_cb);
  } // do_ajax_form_tbreq_mob_validate_detailpo

  function do_ajax_form_tbreq_mob_validate_detailpo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbreq_mob_validate_detailpo_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tbreq_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tbreq_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_tbreq_mob_submit_form(var_pesandate, var_status, var_total, var_jatuhtempo, var_note, var_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbreq_mob_submit_form_cb);
  } // do_ajax_form_tbreq_mob_submit_form

  function do_ajax_form_tbreq_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tbreq_mob_submit_form_cb_after_alert);
  } // do_ajax_form_tbreq_mob_submit_form_cb
  function do_ajax_form_tbreq_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbreq_mob_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_tbreqdetail_mob"] = "off";

  function do_ajax_form_tbreq_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    scStatusDetail["form_tbreqdetail_mob"] = "on";
    x_ajax_form_tbreq_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbreq_mob_navigate_form_cb);
  } // do_ajax_form_tbreq_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreq_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbreq_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_tbreqdetail_mob"] && "nmsc_iframe_liga_form_tbreqdetail_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_tbreqdetail_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_tbreqdetail_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_tbreqdetail_mob').contentWindow.nm_move('apl_detalhe', true, '1000');
        document.getElementById('nmsc_iframe_liga_form_tbreqdetail_mob').style.height = "1000";
        document.getElementById('nmsc_iframe_liga_form_tbreqdetail_mob').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbreq_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_tbreq_mob_navigate_form_cb
  function do_ajax_form_tbreq_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_tbreq_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_tbreq_mob_navigate_form_cb_after_alert
  function sc_hide_form_tbreq_mob_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_tbreqdetail_mob"])
    {
      return true;
    }
    return false;
