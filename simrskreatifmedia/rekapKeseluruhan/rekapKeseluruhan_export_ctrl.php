<?php
@session_start() ;
$_SESSION['scriptcase']['rekapKeseluruhan']['sc_process_barr'] = true;
require_once('../rekapKeseluruhan/index.php');
unset($_SESSION['scriptcase']['rekapKeseluruhan']['sc_process_barr']);
$ExportCtrl = new rekapKeseluruhan_export_control;
$ExportCtrl->Export_barr();

class rekapKeseluruhan_export_control
{
