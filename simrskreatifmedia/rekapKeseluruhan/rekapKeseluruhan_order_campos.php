<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['rekapKeseluruhan']['glo_nm_path_imag_temp'] . "/sc_apl_default_simrskreatifmedia.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new rekapKeseluruhan_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class rekapKeseluruhan_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['rekapKeseluruhan']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['rekapKeseluruhan']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["trandate"]   = (isset($_SESSION['sc_session'][$sc_init]['rekapKeseluruhan']['labels']["trandate"])) ? $_SESSION['sc_session'][$sc_init]['rekapKeseluruhan']['labels']["trandate"] : "Tgl. Transaksi";
   $tab_ger_campos['trancode'] = "on";
   $tab_def_campos['trancode'] = "tranCode";
   $tab_labels["trancode"]   = (isset($_SESSION['sc_session'][$sc_init]['rekapKeseluruhan']['labels']["trancode"])) ? $_SESSION['sc_session'][$sc_init]['rekapKeseluruhan']['labels']["trancode"] : "Kode Pelayanan";
   $tab_ger_campos['nopayment'] = "on";
   $tab_def_campos['nopayment'] = "noPayment";
   $tab_labels["nopayment"]   = (isset($_SESSION['sc_session'][$sc_init]['rekapKeseluruhan']['labels']["nopayment"])) ? $_SESSION['sc_session'][$sc_init]['rekapKeseluruhan']['labels']["nopayment"] : "Kode Pembayaran";
   $tab_ger_campos['tag'] = "on";
   $tab_def_campos['tag'] = "Tag";
   $tab_labels["tag"]   = (isset($_SESSION['sc_session'][$sc_init]['rekapKeseluruhan']['labels']["tag"])) ? $_SESSION['sc_session'][$sc_init]['rekapKeseluruhan']['labels']["tag"] : "Total";
   $tab_ger_campos['custcode'] = "on";
   $tab_def_campos['custcode'] = "custCode";
   $tab_labels["custcode"]   = (isset($_SESSION['sc_session'][$sc_init]['rekapKeseluruhan']['labels']["custcode"])) ? $_SESSION['sc_session'][$sc_init]['rekapKeseluruhan']['labels']["custcode"] : "RM";
   ...
   {
       $tab_def_campos['sc_field_1'] = "SELECT sc_concat(name,', ', salut)
FROM tbcustomer 
WHERE custCode = '{custCode}' 
ORDER BY name, salut, custCode";
   }
   $tab_labels["sc_field_1"]   = (isset($_SESSION['sc_session'][$sc_init]['rekapKeseluruhan']['labels']["sc_field_1"])) ? $_SESSION['sc_session'][$sc_init]['rekapKeseluruhan']['labels']["sc_field_1"] : "Pasien";
   $tab_ger_campos['dokter'] = "on";
   $tab_def_campos['dokter'] = "dokter";
   $tab_labels["dokter"]   = (isset($_SESSION['sc_session'][$sc_init]['rekapKeseluruhan']['labels']["dokter"])) ? $_SESSION['sc_session'][$sc_init]['rekapKeseluruhan']['labels']["dokter"] : "DPJP";
   $tab_ger_campos['jenispayment'] = "on";
   $tab_def_campos['jenispayment'] = "jenisPayment";
   $tab_labels["jenispayment"]   = (isset($_SESSION['sc_session'][$sc_init]['rekapKeseluruhan']['labels']["jenispayment"])) ? $_SESSION['sc_session'][$sc_init]['rekapKeseluruhan']['labels']["jenispayment"] : "Jenis Payment";
   $tab_ger_campos['edc1'] = "on";
   $tab_def_campos['edc1'] = "edc1";
   $tab_labels["edc1"]   = (isset($_SESSION['sc_session'][$sc_init]['rekapKeseluruhan']['labels']["edc1"])) ? $_SESSION['sc_session'][$sc_init]['rekapKeseluruhan']['labels']["edc1"] : "EDC";
   $tab_ger_campos['instansipenjamin'] = "on";
   $tab_def_campos['instansipenjamin'] = "instansiPenjamin";
   $tab_labels["instansipenjamin"]   = (isset($_SESSION['sc_session'][$sc_init]['rekapKeseluruhan']['labels']["instansipenjamin"])) ? $_SESSION['sc_session'][$sc_init]['rekapKeseluruhan']['labels']["instansipenjamin"] : "Instansi Penjamin";
   $tab_ger_campos['paiddate'] = "on";
   $tab_def_campos['paiddate'] = "paidDate";
   $tab_labels["paiddate"]   = (isset($_SESSION['sc_session'][$sc_init]['rekapKeseluruhan']['labels']["paiddate"])) ? $_SESSION['sc_session'][$sc_init]['rekapKeseluruhan']['labels']["paiddate"] : "Tgl. Bayar";
   $tab_ger_campos['kasir'] = "on";
   $tab_def_campos['kasir'] = "kasir";
   $tab_labels["kasir"]   = (isset($_SESSION['sc_session'][$sc_init]['rekapKeseluruhan']['labels']["kasir"])) ? $_SESSION['sc_session'][$sc_init]['rekapKeseluruhan']['labels']["kasir"] : "Kasir";
   $tab_ger_campos['nostruk'] = "on";
   $tab_def_campos['nostruk'] = "noStruk";
   $tab_labels["nostruk"]   = (isset($_SESSION['sc_session'][$sc_init]['rekapKeseluruhan']['labels']["nostruk"])) ? $_SESSION['sc_session'][$sc_init]['rekapKeseluruhan']['labels']["nostruk"] : "No Struk";
   $tab_ger_campos['kategori'] = "on";
   $tab_def_campos['kategori'] = "Kategori";
   $tab_labels["kategori"]   = (isset($_SESSION['sc_session'][$sc_init]['rekapKeseluruhan']['labels']["kategori"])) ? $_SESSION['sc_session'][$sc_init]['rekapKeseluruhan']['labels']["kategori"] : "Kategori";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['rekapKeseluruhan']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['rekapKeseluruhan']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['rekapKeseluruhan']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['rekapKeseluruhan']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['rekapKeseluruhan']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['rekapKeseluruhan']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['rekapKeseluruhan']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['rekapKeseluruhan']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['rekapKeseluruhan']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "rekapKeseluruhan_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['rekapKeseluruhan']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['rekapKeseluruhan']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['rekapKeseluruhan']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['rekapKeseluruhan']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['rekapKeseluruhan']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
