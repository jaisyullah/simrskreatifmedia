<?php
class form_tbreseprawatjalanF_form extends form_tbreseprawatjalanF_apl
{
function Form_Init()
{
...
<?php
if ($this->Embutida_form && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatjalanF']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatjalanF']['sc_modal'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatjalanF']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatjalanF']['sc_redir_atualiz'] == 'ok')
{
?>
...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatjalanF']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_tbreseprawatjalanF/form_tbreseprawatjalanF_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_tbreseprawatjalanF_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_tbreseprawatjalanF_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatjalanF']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatjalanF']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatjalanF']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatjalanF']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatjalanF']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatjalanF']['recarga'];
}
if ('novo' == $opcao_botoes && $this->Embutida_form)
{
    $opcao_botoes = 'inicio';
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatjalanF']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatjalanF']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
?>
...
<?php
 include_once("form_tbreseprawatjalanF_js0.php");
?>
<script type="text/javascript"> 
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_tbreseprawatjalanF'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_tbreseprawatjalanF'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatjalanF']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatjalanF']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatjalanF']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatjalanF']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatjalanF']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatjalanF']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatjalanF']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatjalanF']['run_iframe'] != "R")
{
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatjalanF']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatjalanF']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatjalanF']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatjalanF']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatjalanF']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatjalanF']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatjalanF']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatjalanF']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatjalanF']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatjalanF']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
 ...
 ?>
   ...
   <?php if (isset($this->nmgp_cmp_hidden['btn_print_']) && $this->nmgp_cmp_hidden['btn_print_'] == 'off') { $sStyleHidden_btn_print_ = 'display: none'; }
      if (1 || !isset($this->nmgp_cmp_hidden['btn_print_']) || $this->nmgp_cmp_hidden['btn_print_'] == 'on') {
      if (!isset($this->nm_new_label['btn_print_'])) {
          $this->nm_new_label['btn_print_'] = "Etiket"; } ?>

    <TD class="scFormLabelOddMult css_btn_print__label" id="hidden_field_label_btn_print_" style="<?php echo $sStyleHidden_btn_print_; ?>" > <?php echo $this->nm_new_label['btn_print_'] ?> </TD>
   <?php } ?>
...
{ 
   ...
   { 
       ob_start();
       $iStart = sizeof($this->form_vert_form_tbreseprawatjalanF);
       $guarda_nmgp_opcao = $this->nmgp_opcao;
       $guarda_form_vert_form_tbreseprawatjalanF = $this->form_vert_form_tbreseprawatjalanF;
       $this->nmgp_opcao = 'novo';
   } 
   if ($this->Embutida_form && empty($this->form_vert_form_tbreseprawatjalanF))
   {
       $sc_seq_vert = 0;
   }
   ...
   foreach ($this->form_vert_form_tbreseprawatjalanF as $sc_seq_vert => $sc_lixo)
   {
       $this->loadRecordState($sc_seq_vert);
       $this->trancode_ = $this->form_vert_form_tbreseprawatjalanF[$sc_seq_vert]['trancode_'];
       if (isset($this->Embutida_ronly) && $this->Embutida_ronly && !$Line_Add)
       {
           ...
           $this->nmgp_cmp_readonly['btn_print_'] = true;
       ...
       elseif ($Line_Add)
       {
           ...
           if (!isset($this->nmgp_cmp_readonly['btn_print_']) || $this->nmgp_cmp_readonly['btn_print_'] != "on") {$this->nmgp_cmp_readonly['btn_print_'] = false;}
       ...
       $this->satuan_ = $this->form_vert_form_tbreseprawatjalanF[$sc_seq_vert]['satuan_']; 
       ...
       $this->stok_ = $this->form_vert_form_tbreseprawatjalanF[$sc_seq_vert]['stok_']; 
       $stok_ = $this->stok_; 
       $sStyleHidden_stok_ = '';
       ...
       $this->jumlah_ = $this->form_vert_form_tbreseprawatjalanF[$sc_seq_vert]['jumlah_']; 
       ...
       $this->signa_ = $this->form_vert_form_tbreseprawatjalanF[$sc_seq_vert]['signa_']; 
       $signa_ = $this->signa_; 
       $sStyleHidden_signa_ = '';
       ...
       $this->jenisaturanpakai_ = $this->form_vert_form_tbreseprawatjalanF[$sc_seq_vert]['jenisaturanpakai_']; 
       ...
       $this->biaya_ = $this->form_vert_form_tbreseprawatjalanF[$sc_seq_vert]['biaya_']; 
       $biaya_ = $this->biaya_; 
       $sStyleHidden_biaya_ = '';
       ...
       $this->trandate_ = $this->form_vert_form_tbreseprawatjalanF[$sc_seq_vert]['trandate_'] . ' ' . $this->form_vert_form_tbreseprawatjalanF[$sc_seq_vert]['trandate__hora']; 
       ...
       $this->diskon_ = $this->form_vert_form_tbreseprawatjalanF[$sc_seq_vert]['diskon_']; 
       ...
       $this->btn_print_ = $this->form_vert_form_tbreseprawatjalanF[$sc_seq_vert]['btn_print_']; 
       $btn_print_ = $this->btn_print_; 
       $sStyleHidden_btn_print_ = '';
       if (isset($sCheckRead_btn_print_))
       {
           unset($sCheckRead_btn_print_);
       }
       if (isset($this->nmgp_cmp_readonly['btn_print_']))
       {
           $sCheckRead_btn_print_ = $this->nmgp_cmp_readonly['btn_print_'];
       }
       if (isset($this->nmgp_cmp_hidden['btn_print_']) && $this->nmgp_cmp_hidden['btn_print_'] == 'off')
       {
           unset($this->nmgp_cmp_hidden['btn_print_']);
           $sStyleHidden_btn_print_ = 'display: none;';
       }
       $bTestReadOnly_btn_print_ = true;
       $sStyleReadLab_btn_print_ = 'display: none;';
       $sStyleReadInp_btn_print_ = '';
       if (isset($this->nmgp_cmp_readonly['btn_print_']) && $this->nmgp_cmp_readonly['btn_print_'] == 'on')
       {
           $bTestReadOnly_btn_print_ = false;
           unset($this->nmgp_cmp_readonly['btn_print_']);
           $sStyleReadLab_btn_print_ = '';
           $sStyleReadInp_btn_print_ = 'display: none;';
       }
       $this->id_ = $this->form_vert_form_tbreseprawatjalanF[$sc_seq_vert]['id_']; 
       $id_ = $this->id_; 
       if (!isset($this->nmgp_cmp_hidden['id_']))
       {
           $this->nmgp_cmp_hidden['id_'] = 'off';
...
<?php echo nmButtonOutput($this->arr_buttons, "bmd_novo", "do_ajax_form_tbreseprawatjalanF_add_new_line(" . $sc_seq_vert . ")", "do_ajax_form_tbreseprawatjalanF_add_new_line(" . $sc_seq_vert . ")", "sc_new_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
<?php }?>
<?php
  $Style_add_line = (!$Line_Add) ? "display: none" : "";
?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_form_tbreseprawatjalanF_cancel_insert(" . $sc_seq_vert . ")", "do_ajax_form_tbreseprawatjalanF_cancel_insert(" . $sc_seq_vert . ")", "sc_canceli_line_" . $sc_seq_vert . "", "", "", "" . $Style_add_line . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_form_tbreseprawatjalanF_cancel_update(" . $sc_seq_vert . ")", "do_ajax_form_tbreseprawatjalanF_cancel_update(" . $sc_seq_vert . ")", "sc_cancelu_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
 </TD>
   <?php }?>
...
<span id="id_read_on_signa_<?php echo $sc_seq_vert ?>" class="sc-ui-readonly-signa_<?php echo $sc_seq_vert ?> css_signa__line" style="<?php echo $sStyleReadLab_signa_; ?>"><?php echo $this->signa_; ?></span><span id="id_read_off_signa_<?php echo $sc_seq_vert ?>" class="css_read_off_signa_" style="white-space: nowrap;<?php echo $sStyleReadInp_signa_; ?>">
 ...
 size=10 maxlength=15 alt="{datatype: 'text', maxLength: 15, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddMultWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
...
else
{
   ...
   while (!empty($todo[$x])) 
   {
          $cadaselect = explode("?#?", $todo[$x]) ; 
          if ($cadaselect[1] == "@ ") {$cadaselect[1]= trim($cadaselect[1]); } ; 
          if (isset($this->Embutida_ronly) && $this->Embutida_ronly && isset($this->jenisaturanpakai__1))
          {
              foreach ($this->jenisaturanpakai__1 as $tmp_jenisaturanpakai_)
              {
                  if (trim($tmp_jenisaturanpakai_) === trim($cadaselect[1])) { $jenisaturanpakai__look .= $cadaselect[0] . '__SC_BREAK_LINE__'; }
              }
          }
          elseif (trim($this->jenisaturanpakai_) === trim($cadaselect[1])) { $jenisaturanpakai__look .= $cadaselect[0]; } 
          $x++; 
   }
...
<?php
   ...
   echo " <span id=\"idAjaxSelect_jenisaturanpakai_" .  $sc_seq_vert . "\"><select class=\"sc-js-input scFormObjectOddMult css_jenisaturanpakai__obj\" style=\"\" id=\"id_sc_field_jenisaturanpakai_" . $sc_seq_vert . "\" name=\"jenisaturanpakai_" . $sc_seq_vert . "\" size=\"1\" alt=\"{type: 'select', enterTab: false}\">" ; 
   echo "\r" ; 
   ...
   while (!empty($todo[$x]) && !$nm_nao_carga) 
   {
          ...
          if ($cadaselect[1] == "@ ") {$cadaselect[1]= trim($cadaselect[1]); } ; 
          echo "  <option value=\"$cadaselect[1]\"" ; 
          if (trim($this->jenisaturanpakai_) === trim($cadaselect[1])) 
          {
              echo " selected" ; 
          }
          if (strtoupper($cadaselect[2]) == "S") 
...
<span id="id_read_on_diskon_<?php echo $sc_seq_vert ?>" class="sc-ui-readonly-diskon_<?php echo $sc_seq_vert ?> css_diskon__line" style="<?php echo $sStyleReadLab_diskon_; ?>"><?php echo $this->diskon_; ?></span><span id="id_read_off_diskon_<?php echo $sc_seq_vert ?>" class="css_read_off_diskon_" style="white-space: nowrap;<?php echo $sStyleReadInp_diskon_; ?>">
 ...
 size=3 alt="{datatype: 'integer', maxLength: 3, thousandsSep: '<?php echo str_replace("'", "\'", $this->field_config['diskon_']['symbol_grp']); ?>', thousandsFormat: <?php echo $this->field_config['diskon_']['symbol_fmt']; ?>, allowNegative: false, onlyNegative: false, negativePos: <?php echo (4 == $this->field_config['diskon_']['format_neg'] ? "'suffix'" : "'prefix'") ?>, enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddMultWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
   ...
   <?php if (isset($this->nmgp_cmp_hidden['btn_print_']) && $this->nmgp_cmp_hidden['btn_print_'] == 'off') { $sc_hidden_yes++;  ?>
<input type="hidden" name="btn_print_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($btn_print_) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormDataOddMult css_btn_print__line" id="hidden_field_data_btn_print_<?php echo $sc_seq_vert; ?>" style="<?php echo $sStyleHidden_btn_print_; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOddMult css_btn_print__line" style="vertical-align: top;padding: 0px"><?php
          ...
          { 
              if ($this->Ini->Export_img_zip) {
                  ...
                  $btn_print_ = "<img border=\"0\" src=\"scriptcase__NM__ico__NM__printer3_32.png\"/>" ; 
              }
              else {
...
?>
<span id="id_imghtml_btn_print_<?php echo $sc_seq_vert; ?>"><a href="javascript:nm_gp_submit('<?php echo $this->Ini->link_etiket_edit . "', '$this->nm_location', 'id_etiket*scin" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatjalanF']['dados_form'][$sc_seq_vert]['id_'] . "*scoutNM_btn_insert*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinS*scoutNM_btn_navega*scinN*scoutNMSC_modal*scinok*scout', '', 'modal', '600', '800', 'etiket')\"><font color=\"" . $this->Ini->cor_link_dados . "\">" . $btn_print_ ; ?></font></a></span>
<?php if ($bTestReadOnly_btn_print_ && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["btn_print_"]) &&  $this->nmgp_cmp_readonly["btn_print_"] == "on") { 

 ?>
<input type="hidden" name="btn_print_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($btn_print_) . "\">" . $btn_print_ . ""; ?>
<?php } else { ?>
<span id="id_read_on_btn_print_<?php echo $sc_seq_vert ?>" class="sc-ui-readonly-btn_print_<?php echo $sc_seq_vert ?> css_btn_print__line" style="<?php echo $sStyleReadLab_btn_print_; ?>"><?php echo $this->btn_print_; ?></span><span id="id_read_off_btn_print_<?php echo $sc_seq_vert ?>" class="css_read_off_btn_print_" style="white-space: nowrap;<?php echo $sStyleReadInp_btn_print_; ?>"></span><?php } ?>
</td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_btn_print_<?php echo $sc_seq_vert; ?>_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_btn_print_<?php echo $sc_seq_vert; ?>_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
<?php   
       ...
       if (isset($sCheckRead_btn_print_))
       {
           $this->nmgp_cmp_readonly['btn_print_'] = $sCheckRead_btn_print_;
       }
       if ('display: none;' == $sStyleHidden_btn_print_)
       {
           $this->nmgp_cmp_hidden['btn_print_'] = 'off';
       }
       if (isset($sCheckRead_id_))
       {
   ...
   { 
       ...
       $this->form_vert_form_tbreseprawatjalanF = $guarda_form_vert_form_tbreseprawatjalanF;
   } 
   if ($Table_refresh) 
   { 
...
<?php
if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatjalanF']['run_modal']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatjalanF']['run_modal'])
{
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatjalanF']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatjalanF']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_tbreseprawatjalanF");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_tbreseprawatjalanF");
 parent.scAjaxDetailHeight("form_tbreseprawatjalanF", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
<script type="text/javascript">
	function scBtnFn_sys_format_inc() {
		if ($("#sc_b_new_t.sc-unique-btn-1").length && $("#sc_b_new_t.sc-unique-btn-1").is(":visible")) {
			do_ajax_form_tbreseprawatjalanF_add_new_line(); return false;
			 return;
		}
...
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatjalanF']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
