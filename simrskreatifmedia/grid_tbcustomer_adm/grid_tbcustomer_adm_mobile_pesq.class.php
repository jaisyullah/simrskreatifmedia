...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "birthDate";$Nm_datas[] = "birthDate";$Nm_datas[] = "hta";$Nm_datas[] = "hta";$Nm_datas[] = "lastHta";$Nm_datas[] = "lastHta";$Nm_datas[] = "partus";$Nm_datas[] = "partus";$Nm_datas[] = "expdate";$Nm_datas[] = "expdate";$Nm_datas[] = "lastUpdated";$Nm_datas[] = "lastUpdated";$Nm_datas[] = "registerdate";$Nm_datas[] = "registerdate";$Nm_numeric[] = "deleted";$Nm_numeric[] = "hamil";$Nm_numeric[] = "isdead";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_name"  <?php echo $str_hide_name?>><?php
      if ($name != "")
      {
      $name_look = substr($this->Db->qstr($name), 1, -1); 
      $nmgp_def_dados = array(); 
...
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_birthdate_dia" name="birthdate_dia" value="<?php echo NM_encode_input($birthdate_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_birthdate_mes" name="birthdate_mes" value="<?php echo NM_encode_input($birthdate_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_birthdate_ano" name="birthdate_ano" value="<?php echo NM_encode_input($birthdate_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
