<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tbcustomer_adm']['sc_process_barr'] = true;
require_once('../grid_tbcustomer_adm/index.php');
unset($_SESSION['scriptcase']['grid_tbcustomer_adm']['sc_process_barr']);
$ExportCtrl = new grid_tbcustomer_adm_export_control;
$ExportCtrl->Export_barr();

class grid_tbcustomer_adm_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_title'] ?> Pasien :: Excel</TITLE>
