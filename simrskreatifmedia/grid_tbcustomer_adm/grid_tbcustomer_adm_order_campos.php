...
<?php
   ...
   $Ord_Cmp = new grid_tbcustomer_adm_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_tbcustomer_adm_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbcustomer_adm']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tbcustomer_adm']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["custcode"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbcustomer_adm']['labels']["custcode"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbcustomer_adm']['labels']["custcode"] : "No. RM";
...
ORDER BY name, salut";
   ...
   $tab_labels["nama"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbcustomer_adm']['labels']["nama"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbcustomer_adm']['labels']["nama"] : "Nama Pasien";
   $tab_ger_campos['birthdate'] = "on";
   $tab_def_campos['birthdate'] = "birthDate";
   $tab_labels["birthdate"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbcustomer_adm']['labels']["birthdate"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbcustomer_adm']['labels']["birthdate"] : "Tgl Lahir";
   $tab_ger_campos['address'] = "on";
   $tab_def_campos['address'] = "address";
   $tab_labels["address"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbcustomer_adm']['labels']["address"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbcustomer_adm']['labels']["address"] : "Alamat Pasien";
   $tab_ger_campos['sex'] = "on";
   $tab_def_campos['sex'] = "sex";
   $tab_labels["sex"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbcustomer_adm']['labels']["sex"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbcustomer_adm']['labels']["sex"] : "J/K";
   $tab_ger_campos['spouse'] = "on";
   $tab_def_campos['spouse'] = "spouse";
   $tab_labels["spouse"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbcustomer_adm']['labels']["spouse"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbcustomer_adm']['labels']["spouse"] : "Pasangan";
   $tab_ger_campos['mother'] = "on";
   $tab_def_campos['mother'] = "mother";
   $tab_labels["mother"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbcustomer_adm']['labels']["mother"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbcustomer_adm']['labels']["mother"] : "Nama Ibu";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_tbcustomer_adm']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_tbcustomer_adm']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_tbcustomer_adm']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbcustomer_adm']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tbcustomer_adm']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_tbcustomer_adm']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_tbcustomer_adm']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_tbcustomer_adm']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_tbcustomer_adm']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_tbcustomer_adm_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_tbcustomer_adm']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_tbcustomer_adm']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_tbcustomer_adm']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_tbcustomer_adm']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_tbcustomer_adm']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
