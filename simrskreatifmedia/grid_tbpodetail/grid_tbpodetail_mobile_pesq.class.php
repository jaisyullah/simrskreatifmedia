...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "jumlah";$Nm_numeric[] = "isi";$Nm_numeric[] = "harga";$Nm_numeric[] = "disc";$Nm_numeric[] = "";$Nm_numeric[] = "jumlah";$Nm_numeric[] = "isi";$Nm_numeric[] = "harga";$Nm_numeric[] = "disc";$Nm_numeric[] = "";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_po_cond" name="po_cond" onChange="nm_campos_between(document.getElementById('id_vis_po'), this, 'po')">
      ...
      <br><span id="id_hide_po"  <?php echo $str_hide_po?>><?php
      if ($po != "")
      {
      $po_look = substr($this->Db->qstr($po), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_item_cond" name="item_cond" onChange="nm_campos_between(document.getElementById('id_vis_item'), this, 'item')">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_jumlah_cond" name="jumlah_cond" onChange="nm_campos_between(document.getElementById('id_vis_jumlah'), this, 'jumlah')">
      ...
      <br><span id="id_hide_jumlah"  <?php echo $str_hide_jumlah?>><INPUT  type="text" id="SC_jumlah" name="jumlah" value="<?php echo NM_encode_input($jumlah) ?>" size=12 alt="{datatype: 'integer', maxLength: 12, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_kemasan_cond" name="kemasan_cond" onChange="nm_campos_between(document.getElementById('id_vis_kemasan'), this, 'kemasan')">
      ...
      <br><span id="id_hide_kemasan"  <?php echo $str_hide_kemasan?>><?php
      if ($kemasan != "")
      {
      $kemasan_look = substr($this->Db->qstr($kemasan), 1, -1); 
      $nmgp_def_dados = array(); 
