...
class grid_tbpodetail_total
{
   ...
   function __construct($sc_page)
   {
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['grid_tbpodetail']['campos_busca']) && !empty($_SESSION['sc_session'][$this->sc_page]['grid_tbpodetail']['campos_busca']))
      { 
