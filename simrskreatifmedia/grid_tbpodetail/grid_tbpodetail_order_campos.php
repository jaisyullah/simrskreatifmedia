...
<?php
   ...
   $Ord_Cmp = new grid_tbpodetail_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_tbpodetail_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbpodetail']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tbpodetail']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["item"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbpodetail']['labels']["item"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbpodetail']['labels']["item"] : "Item";
   $tab_ger_campos['jumlah'] = "on";
   $tab_def_campos['jumlah'] = "jumlah";
   $tab_labels["jumlah"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbpodetail']['labels']["jumlah"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbpodetail']['labels']["jumlah"] : "Jumlah";
   $tab_ger_campos['kemasan'] = "on";
   $tab_def_campos['kemasan'] = "kemasan";
   $tab_labels["kemasan"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbpodetail']['labels']["kemasan"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbpodetail']['labels']["kemasan"] : "Kemasan";
   $tab_ger_campos['isi'] = "on";
   $tab_def_campos['isi'] = "isi";
   $tab_labels["isi"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbpodetail']['labels']["isi"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbpodetail']['labels']["isi"] : "Isi";
   $tab_ger_campos['harga'] = "on";
   $tab_def_campos['harga'] = "harga";
   $tab_labels["harga"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbpodetail']['labels']["harga"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbpodetail']['labels']["harga"] : "Harga";
   $tab_ger_campos['disc'] = "on";
   $tab_def_campos['disc'] = "disc";
   $tab_labels["disc"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbpodetail']['labels']["disc"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbpodetail']['labels']["disc"] : "Disc";
   $tab_ger_campos['principal'] = "on";
   $tab_def_campos['principal'] = "principal";
   $tab_labels["principal"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbpodetail']['labels']["principal"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbpodetail']['labels']["principal"] : "Principal";
   ...
   $tab_labels["total"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbpodetail']['labels']["total"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbpodetail']['labels']["total"] : "Total";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_tbpodetail']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_tbpodetail']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_tbpodetail']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbpodetail']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tbpodetail']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_tbpodetail']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_tbpodetail']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_tbpodetail']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_tbpodetail']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_tbpodetail_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_tbpodetail']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_tbpodetail']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_tbpodetail']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_tbpodetail']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_tbpodetail']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
