...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_kodeitem_cond" name="kodeitem_cond" onChange="nm_campos_between(document.getElementById('id_vis_kodeitem'), this, 'kodeitem')">
      ...
      <br><span id="id_hide_kodeitem"  <?php echo $str_hide_kodeitem?>><?php
      if ($kodeitem != "")
      {
      $kodeitem_look = substr($this->Db->qstr($kodeitem), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_signa_cond" name="signa_cond" onChange="nm_campos_between(document.getElementById('id_vis_signa'), this, 'signa')">
      ...
      <br><span id="id_hide_signa"  <?php echo $str_hide_signa?>><?php
      if ($signa != "")
      {
      $signa_look = substr($this->Db->qstr($signa), 1, -1); 
      $nmgp_def_dados = array(); 
