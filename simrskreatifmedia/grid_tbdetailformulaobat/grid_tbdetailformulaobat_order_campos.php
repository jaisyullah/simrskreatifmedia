...
<?php
   ...
   $Ord_Cmp = new grid_tbdetailformulaobat_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_tbdetailformulaobat_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbdetailformulaobat']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tbdetailformulaobat']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["kodeitem"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbdetailformulaobat']['labels']["kodeitem"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbdetailformulaobat']['labels']["kodeitem"] : "Item";
   $tab_ger_campos['jumlah'] = "on";
   $tab_def_campos['jumlah'] = "jumlah";
   $tab_labels["jumlah"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbdetailformulaobat']['labels']["jumlah"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbdetailformulaobat']['labels']["jumlah"] : "Jumlah";
   $tab_ger_campos['signa'] = "on";
   $tab_def_campos['signa'] = "signa";
   $tab_labels["signa"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbdetailformulaobat']['labels']["signa"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbdetailformulaobat']['labels']["signa"] : "Signa";
   ...
   {
       $tab_def_campos['harga'] = "SELECT hargaJual 
FROM tbobat 
WHERE kodeItem = '{kodeItem}' 
ORDER BY hargaJual";
   }
   $tab_labels["harga"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbdetailformulaobat']['labels']["harga"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbdetailformulaobat']['labels']["harga"] : "HJA @";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_tbdetailformulaobat']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_tbdetailformulaobat']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_tbdetailformulaobat']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbdetailformulaobat']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tbdetailformulaobat']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_tbdetailformulaobat']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_tbdetailformulaobat']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_tbdetailformulaobat']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_tbdetailformulaobat']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_tbdetailformulaobat_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_tbdetailformulaobat']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_tbdetailformulaobat']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_tbdetailformulaobat']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_tbdetailformulaobat']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_tbdetailformulaobat']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
