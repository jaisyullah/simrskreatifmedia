<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tbdetailformulaobat']['sc_process_barr'] = true;
require_once('../grid_tbdetailformulaobat/index.php');
unset($_SESSION['scriptcase']['grid_tbdetailformulaobat']['sc_process_barr']);
$ExportCtrl = new grid_tbdetailformulaobat_export_control;
$ExportCtrl->Export_barr();

class grid_tbdetailformulaobat_export_control
{
