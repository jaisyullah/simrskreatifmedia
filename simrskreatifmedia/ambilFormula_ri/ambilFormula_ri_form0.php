...
.sc-button-image.disabled img {
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['ambilFormula_ri']['embutida_pdf']))
 {
 ?>
...
<?php
include_once("ambilFormula_ri_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('ambilFormula_ri_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['ambilFormula_ri']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['ambilFormula_ri']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['ambilFormula_ri']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['ambilFormula_ri']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['ambilFormula_ri']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['ambilFormula_ri']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['ambilFormula_ri']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['ambilFormula_ri']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
?>
...
<?php
 include_once("ambilFormula_ri_js0.php");
?>
<script type="text/javascript"> 
...
<?php
$_SESSION['scriptcase']['error_span_title']['ambilFormula_ri'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['ambilFormula_ri'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['ambilFormula_ri']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['ambilFormula_ri']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['ambilFormula_ri']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['ambilFormula_ri']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['ambilFormula_ri']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<?php
  ...
  {
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['ambilFormula_ri']['where_filter']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['ambilFormula_ri']['empty_filter'] = true;
       }
  }
?>
...
<?php
           if (($nm_apl_dependente != 1) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['ambilFormula_ri']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['ambilFormula_ri']['dashboard_info']['under_dashboard'])) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['ambilFormula_ri']['nm_run_menu']) || $_SESSION['sc_session'][$this->Ini->sc_page]['ambilFormula_ri']['nm_run_menu'] != 1))) {
...
<?php
           if (($nm_apl_dependente == 1) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['ambilFormula_ri']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['ambilFormula_ri']['dashboard_info']['under_dashboard']))) {
        $sCondStyle = ($this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['ambilFormula_ri']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['ambilFormula_ri']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("ambilFormula_ri");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("ambilFormula_ri");
 parent.scAjaxDetailHeight("ambilFormula_ri", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['ambilFormula_ri']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
