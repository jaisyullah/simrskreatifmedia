<?php
@session_start() ;
$_SESSION['scriptcase']['print_etiket6']['sc_process_barr'] = true;
require_once('../print_etiket6/index.php');
unset($_SESSION['scriptcase']['print_etiket6']['sc_process_barr']);
$ExportCtrl = new print_etiket6_export_control;
$ExportCtrl->Export_barr();

class print_etiket6_export_control
{
