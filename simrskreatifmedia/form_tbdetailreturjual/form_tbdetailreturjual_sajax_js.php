  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbdetailreturjual" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbdetailreturjual_form();
	}

  // ---------- Validate id_
  function do_ajax_form_tbdetailreturjual_validate_id_(iNumLinha)
  {
    var nomeCampo_id_ = "id_" + iNumLinha;
    var var_id_ = scAjaxGetFieldHidden(nomeCampo_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdetailreturjual_validate_id_(var_id_, iNumLinha, var_script_case_init, do_ajax_form_tbdetailreturjual_validate_id__cb);
  } // do_ajax_form_tbdetailreturjual_validate_id_

  function do_ajax_form_tbdetailreturjual_validate_id__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdetailreturjual_validate_id__cb

  // ---------- Validate item_
  function do_ajax_form_tbdetailreturjual_validate_item_(iNumLinha)
  {
    var nomeCampo_item_ = "item_" + iNumLinha;
    var var_item_ = scAjaxGetFieldSelect(nomeCampo_item_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdetailreturjual_validate_item_(var_item_, iNumLinha, var_script_case_init, do_ajax_form_tbdetailreturjual_validate_item__cb);
  } // do_ajax_form_tbdetailreturjual_validate_item_

  function do_ajax_form_tbdetailreturjual_validate_item__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdetailreturjual_validate_item__cb

  // ---------- Validate jml_
  function do_ajax_form_tbdetailreturjual_validate_jml_(iNumLinha)
  {
    var nomeCampo_jml_ = "jml_" + iNumLinha;
    var var_jml_ = scAjaxGetFieldText(nomeCampo_jml_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdetailreturjual_validate_jml_(var_jml_, iNumLinha, var_script_case_init, do_ajax_form_tbdetailreturjual_validate_jml__cb);
  } // do_ajax_form_tbdetailreturjual_validate_jml_

  function do_ajax_form_tbdetailreturjual_validate_jml__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "jml_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "jml_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdetailreturjual_validate_jml__cb

  // ---------- Validate retur_
  function do_ajax_form_tbdetailreturjual_validate_retur_(iNumLinha)
  {
    var nomeCampo_retur_ = "retur_" + iNumLinha;
    var var_retur_ = scAjaxGetFieldText(nomeCampo_retur_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdetailreturjual_validate_retur_(var_retur_, iNumLinha, var_script_case_init, do_ajax_form_tbdetailreturjual_validate_retur__cb);
  } // do_ajax_form_tbdetailreturjual_validate_retur_

  function do_ajax_form_tbdetailreturjual_validate_retur__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdetailreturjual_validate_retur__cb

  // ---------- Validate inputdate_
  function do_ajax_form_tbdetailreturjual_validate_inputdate_(iNumLinha)
  {
    var nomeCampo_inputdate_ = "inputdate_" + iNumLinha;
    var var_inputdate_ = scAjaxGetFieldText(nomeCampo_inputdate_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdetailreturjual_validate_inputdate_(var_inputdate_, iNumLinha, var_script_case_init, do_ajax_form_tbdetailreturjual_validate_inputdate__cb);
  } // do_ajax_form_tbdetailreturjual_validate_inputdate_

  function do_ajax_form_tbdetailreturjual_validate_inputdate__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "inputdate_" + iLineNumber;
    }
    else
    {
      sFieldValid = "inputdate_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "inputdate_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "inputdate_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdetailreturjual_validate_inputdate__cb

  // ---------- Validate status_
  function do_ajax_form_tbdetailreturjual_validate_status_(iNumLinha)
  {
    var nomeCampo_status_ = "status_" + iNumLinha;
    var var_status_ = scAjaxGetFieldText(nomeCampo_status_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdetailreturjual_validate_status_(var_status_, iNumLinha, var_script_case_init, do_ajax_form_tbdetailreturjual_validate_status__cb);
  } // do_ajax_form_tbdetailreturjual_validate_status_

  function do_ajax_form_tbdetailreturjual_validate_status__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdetailreturjual_validate_status__cb

  // ---------- Validate userinput_
  function do_ajax_form_tbdetailreturjual_validate_userinput_(iNumLinha)
  {
    var nomeCampo_userinput_ = "userinput_" + iNumLinha;
    var var_userinput_ = scAjaxGetFieldText(nomeCampo_userinput_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdetailreturjual_validate_userinput_(var_userinput_, iNumLinha, var_script_case_init, do_ajax_form_tbdetailreturjual_validate_userinput__cb);
  } // do_ajax_form_tbdetailreturjual_validate_userinput_

  function do_ajax_form_tbdetailreturjual_validate_userinput__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "userinput_" + iLineNumber;
    }
    else
    {
      sFieldValid = "userinput_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "userinput_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "userinput_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdetailreturjual_validate_userinput__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_tbdetailreturjual_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_tbdetailreturjual_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tbdetailreturjual_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_tbdetailreturjual_add_new_line_cb);
  } // do_ajax_form_tbdetailreturjual_add_new_line

  function do_ajax_form_tbdetailreturjual_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_tbdetailreturjual_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_tbdetailreturjual_backup_line(iNumLinha)
  {
    var var_id_ = scAjaxGetFieldHidden("id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdetailreturjual_backup_line(var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_tbdetailreturjual_backup_line_cb);
  } // do_ajax_form_tbdetailreturjual_backup_line

  function do_ajax_form_tbdetailreturjual_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_tbdetailreturjual_backup_line_cb

  function do_ajax_form_tbdetailreturjual_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_tbdetailreturjual_cancel_insert

  function do_ajax_form_tbdetailreturjual_cancel_update(iSeqVert)
  {
    do_ajax_form_tbdetailreturjual_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_tbdetailreturjual_cancel_update

  function do_ajax_form_tbdetailreturjual_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_tbdetailreturjual_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_tbdetailreturjual_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_tbdetailreturjual_table_refresh(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbdetailreturjual_table_refresh_cb);
  } //  do_ajax_form_tbdetailreturjual_table_refresh

  function do_ajax_form_tbdetailreturjual_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_tbdetailreturjual_table_refresh_cb_after_alert);
  } // do_ajax_form_tbdetailreturjual_table_refresh_cb
  function do_ajax_form_tbdetailreturjual_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_tbdetailreturjual_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_tbdetailreturjual_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_tbdetailreturjual_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    var var_jml_ = scAjaxGetFieldText("jml_" + iNumLinha);
    var var_retur_ = scAjaxGetFieldText("retur_" + iNumLinha);
    var var_inputdate_ = scAjaxGetFieldText("inputdate_" + iNumLinha);
    var var_status_ = scAjaxGetFieldText("status_" + iNumLinha);
    var var_userinput_ = scAjaxGetFieldText("userinput_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_tbdetailreturjual_submit_form(var_id_, var_item_, var_jml_, var_retur_, var_inputdate_, var_status_, var_userinput_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbdetailreturjual_submit_form_cb);
  } // do_ajax_form_tbdetailreturjual_submit_form

  function do_ajax_form_tbdetailreturjual_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("jml_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("retur_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("inputdate_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("status_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("userinput_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_tbdetailreturjual_submit_form_cb_after_alert);
  } // do_ajax_form_tbdetailreturjual_submit_form_cb
  function do_ajax_form_tbdetailreturjual_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbdetailreturjual_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tbdetailreturjual_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_tbdetailreturjual_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("jml_" + iNavForm);
      scAjaxHideErrorDisplay("retur_" + iNavForm);
      scAjaxHideErrorDisplay("inputdate_" + iNavForm);
      scAjaxHideErrorDisplay("status_" + iNavForm);
      scAjaxHideErrorDisplay("userinput_" + iNavForm);
    }
    var var_id_ = document.F2.id_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tbdetailreturjual_navigate_form(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbdetailreturjual_navigate_form_cb);
  } // do_ajax_form_tbdetailreturjual_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailreturjual']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbdetailreturjual_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbdetailreturjual_navigate_form_cb_after_alert);
  } // do_ajax_form_tbdetailreturjual_navigate_form_cb
  function do_ajax_form_tbdetailreturjual_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_tbdetailreturjual_navigate_form_cb_after_alert
  function sc_hide_form_tbdetailreturjual_form()
  {
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "jml_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "retur_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "inputdate_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "status_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "userinput_" + iNumLinha;
    iTotCampos++;
    ...
    ajax_error_list["jml_" + iNumLinha] = {"label": "Jml<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_error_list["inputdate_" + iNumLinha] = {"label": "Input Date<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_error_list["userinput_" + iNumLinha] = {"label": "User Input<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["id_"][iNumLinha] = "id_" + iNumLinha;
    ajax_field_mult["item_"][iNumLinha] = "item_" + iNumLinha;
    ajax_field_mult["jml_"][iNumLinha] = "jml_" + iNumLinha;
    ajax_field_mult["retur_"][iNumLinha] = "retur_" + iNumLinha;
    ajax_field_mult["inputdate_"][iNumLinha] = "inputdate_" + iNumLinha;
    ajax_field_mult["status_"][iNumLinha] = "status_" + iNumLinha;
    ajax_field_mult["userinput_"][iNumLinha] = "userinput_" + iNumLinha;
    ajax_field_id["item_" + iNumLinha] = new Array("hidden_field_label_item_", "hidden_field_data_item_" + iNumLinha);
    ajax_field_id["jml_" + iNumLinha] = new Array("hidden_field_label_jml_", "hidden_field_data_jml_" + iNumLinha);
    ajax_field_id["retur_" + iNumLinha] = new Array("hidden_field_label_retur_", "hidden_field_data_retur_" + iNumLinha);
    ajax_field_id["inputdate_" + iNumLinha] = new Array("hidden_field_label_inputdate_", "hidden_field_data_inputdate_" + iNumLinha);
    ajax_field_id["status_" + iNumLinha] = new Array("hidden_field_label_status_", "hidden_field_data_status_" + iNumLinha);
    ajax_field_id["userinput_" + iNumLinha] = new Array("hidden_field_label_userinput_", "hidden_field_data_userinput_" + iNumLinha);
    ajax_error_count["id_" + iNumLinha] = "off";
    ajax_error_count["item_" + iNumLinha] = "off";
    ajax_error_count["jml_" + iNumLinha] = "off";
    ajax_error_count["retur_" + iNumLinha] = "off";
    ajax_error_count["inputdate_" + iNumLinha] = "off";
    ajax_error_count["status_" + iNumLinha] = "off";
    ajax_error_count["userinput_" + iNumLinha] = "off";
<?php
...
?>
    ...
    ajax_read_only["jml_" + iNumLinha] = "off";
    ajax_read_only["retur_" + iNumLinha] = "off";
    ajax_read_only["inputdate_" + iNumLinha] = "off";
    ajax_read_only["status_" + iNumLinha] = "off";
    ajax_read_only["userinput_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ...
    ajax_read_only["jml_" + iNumLinha] = "on";
    ajax_read_only["retur_" + iNumLinha] = "on";
    ajax_read_only["inputdate_" + iNumLinha] = "on";
    ajax_read_only["status_" + iNumLinha] = "on";
    ajax_read_only["userinput_" + iNumLinha] = "on";
<?php
}
?>
  }
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["jml_" + iNumLinha] = null;
    ajax_error_list["retur_" + iNumLinha] = null;
    ajax_error_list["inputdate_" + iNumLinha] = null;
    ajax_error_list["status_" + iNumLinha] = null;
    ajax_error_list["userinput_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    ...
    "jml_": new Array(),
    "retur_": new Array(),
    "inputdate_": new Array(),
    "status_": new Array(),
    "userinput_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["jml_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["jml_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["jml_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["jml_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["jml_" + iNumLinha]["onfocus"] = new Array();
      ...
      ajax_error_list["inputdate_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["inputdate_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["inputdate_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["inputdate_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["inputdate_" + iNumLinha]["onfocus"] = new Array();
      ...
      ajax_error_list["userinput_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["userinput_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["userinput_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["userinput_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["userinput_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['jml_'])) ? $this->nmgp_cmp_readonly['jml_'] : 'off';
?>
    scAjaxFieldRead("jml_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['inputdate_'])) ? $this->nmgp_cmp_readonly['inputdate_'] : 'off';
?>
    scAjaxFieldRead("inputdate_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['userinput_'])) ? $this->nmgp_cmp_readonly['userinput_'] : 'off';
?>
    scAjaxFieldRead("userinput_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }
  ...
  function mdCloseObjects(iSeq)
  {
    ...
    scAjaxFieldRead("jml_" + iSeq, "on");
    scAjaxFieldRead("retur_" + iSeq, "on");
    scAjaxFieldRead("inputdate_" + iSeq, "on");
    scAjaxFieldRead("status_" + iSeq, "on");
    scAjaxFieldRead("userinput_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["id_" + iRow] || "on" == ajax_error_count["item_" + iRow] || "on" == ajax_error_count["jml_" + iRow] || "on" == ajax_error_count["retur_" + iRow] || "on" == ajax_error_count["inputdate_" + iRow] || "on" == ajax_error_count["status_" + iRow] || "on" == ajax_error_count["userinput_" + iRow]))
    {
      ...
      $("#hidden_field_data_jml_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_retur_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_inputdate_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_status_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_userinput_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["id_" + iRow] && "off" == ajax_error_count["item_" + iRow] && "off" == ajax_error_count["jml_" + iRow] && "off" == ajax_error_count["retur_" + iRow] && "off" == ajax_error_count["inputdate_" + iRow] && "off" == ajax_error_count["status_" + iRow] && "off" == ajax_error_count["userinput_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["id_" + iRow] = "off";
        ajax_error_count["item_" + iRow] = "off";
        ajax_error_count["jml_" + iRow] = "off";
        ajax_error_count["retur_" + iRow] = "off";
        ajax_error_count["inputdate_" + iRow] = "off";
        ajax_error_count["status_" + iRow] = "off";
        ajax_error_count["userinput_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_jml_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_retur_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_inputdate_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_status_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_userinput_" + iRow).removeClass("scFormErrorLine");
    }
  }
