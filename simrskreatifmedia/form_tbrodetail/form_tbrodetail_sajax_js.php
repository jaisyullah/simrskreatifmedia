  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbrodetail" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbrodetail_form();
	}

  // ---------- Validate idpo_
  function do_ajax_form_tbrodetail_validate_idpo_(iNumLinha)
  {
    var nomeCampo_idpo_ = "idpo_" + iNumLinha;
    var var_idpo_ = scAjaxGetFieldText(nomeCampo_idpo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbrodetail_validate_idpo_(var_idpo_, iNumLinha, var_script_case_init, do_ajax_form_tbrodetail_validate_idpo__cb);
  } // do_ajax_form_tbrodetail_validate_idpo_

  function do_ajax_form_tbrodetail_validate_idpo__cb(sResp)
  {
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "idpo_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "idpo_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbrodetail_validate_idpo__cb

  // ---------- Validate item_
  function do_ajax_form_tbrodetail_validate_item_(iNumLinha)
  {
    var nomeCampo_item_ = "item_" + iNumLinha;
    var var_item_ = scAjaxGetFieldSelect(nomeCampo_item_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbrodetail_validate_item_(var_item_, iNumLinha, var_script_case_init, do_ajax_form_tbrodetail_validate_item__cb);
  } // do_ajax_form_tbrodetail_validate_item_

  function do_ajax_form_tbrodetail_validate_item__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbrodetail_validate_item__cb

  // ---------- Validate disc_
  function do_ajax_form_tbrodetail_validate_disc_(iNumLinha)
  {
    var nomeCampo_disc_ = "disc_" + iNumLinha;
    var var_disc_ = scAjaxGetFieldText(nomeCampo_disc_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbrodetail_validate_disc_(var_disc_, iNumLinha, var_script_case_init, do_ajax_form_tbrodetail_validate_disc__cb);
  } // do_ajax_form_tbrodetail_validate_disc_

  function do_ajax_form_tbrodetail_validate_disc__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbrodetail_validate_disc__cb

  // ---------- Validate principal_
  function do_ajax_form_tbrodetail_validate_principal_(iNumLinha)
  {
    var nomeCampo_principal_ = "principal_" + iNumLinha;
    var var_principal_ = scAjaxGetFieldText(nomeCampo_principal_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbrodetail_validate_principal_(var_principal_, iNumLinha, var_script_case_init, do_ajax_form_tbrodetail_validate_principal__cb);
  } // do_ajax_form_tbrodetail_validate_principal_

  function do_ajax_form_tbrodetail_validate_principal__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbrodetail_validate_principal__cb

  // ---------- Validate jmlterima_
  function do_ajax_form_tbrodetail_validate_jmlterima_(iNumLinha)
  {
    var nomeCampo_jmlterima_ = "jmlterima_" + iNumLinha;
    var var_jmlterima_ = scAjaxGetFieldText(nomeCampo_jmlterima_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbrodetail_validate_jmlterima_(var_jmlterima_, iNumLinha, var_script_case_init, do_ajax_form_tbrodetail_validate_jmlterima__cb);
  } // do_ajax_form_tbrodetail_validate_jmlterima_

  function do_ajax_form_tbrodetail_validate_jmlterima__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbrodetail_validate_jmlterima__cb

  // ---------- Validate hargaterima_
  function do_ajax_form_tbrodetail_validate_hargaterima_(iNumLinha)
  {
    var nomeCampo_hargaterima_ = "hargaterima_" + iNumLinha;
    var var_hargaterima_ = scAjaxGetFieldText(nomeCampo_hargaterima_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbrodetail_validate_hargaterima_(var_hargaterima_, iNumLinha, var_script_case_init, do_ajax_form_tbrodetail_validate_hargaterima__cb);
  } // do_ajax_form_tbrodetail_validate_hargaterima_

  function do_ajax_form_tbrodetail_validate_hargaterima__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbrodetail_validate_hargaterima__cb

  // ---------- Validate batchno_
  function do_ajax_form_tbrodetail_validate_batchno_(iNumLinha)
  {
    var nomeCampo_batchno_ = "batchno_" + iNumLinha;
    var var_batchno_ = scAjaxGetFieldText(nomeCampo_batchno_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbrodetail_validate_batchno_(var_batchno_, iNumLinha, var_script_case_init, do_ajax_form_tbrodetail_validate_batchno__cb);
  } // do_ajax_form_tbrodetail_validate_batchno_

  function do_ajax_form_tbrodetail_validate_batchno__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbrodetail_validate_batchno__cb

  // ---------- Validate expdate_
  function do_ajax_form_tbrodetail_validate_expdate_(iNumLinha)
  {
    var nomeCampo_expdate_ = "expdate_" + iNumLinha;
    var var_expdate_ = scAjaxGetFieldText(nomeCampo_expdate_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbrodetail_validate_expdate_(var_expdate_, iNumLinha, var_script_case_init, do_ajax_form_tbrodetail_validate_expdate__cb);
  } // do_ajax_form_tbrodetail_validate_expdate_

  function do_ajax_form_tbrodetail_validate_expdate__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbrodetail_validate_expdate__cb

  // ---------- Validate po_
  function do_ajax_form_tbrodetail_validate_po_(iNumLinha)
  {
    var nomeCampo_po_ = "po_" + iNumLinha;
    var var_po_ = scAjaxGetFieldText(nomeCampo_po_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbrodetail_validate_po_(var_po_, iNumLinha, var_script_case_init, do_ajax_form_tbrodetail_validate_po__cb);
  } // do_ajax_form_tbrodetail_validate_po_

  function do_ajax_form_tbrodetail_validate_po__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbrodetail_validate_po__cb

  // ---------- Event onchange item_
  function do_ajax_form_tbrodetail_event_item__onchange(iSeqForm)
  {
    var var_item_ = scAjaxGetFieldSelect("item_" + iSeqForm);
    var var_hargaterima_ = scAjaxGetFieldText("hargaterima_" + iSeqForm);
    ...
    var var_expdate_ = scAjaxGetFieldText("expdate_" + iSeqForm);
    var var_batchno_ = scAjaxGetFieldText("batchno_" + iSeqForm);
    var var_jmlterima_ = scAjaxGetFieldText("jmlterima_" + iSeqForm);
    var var_script_case_init = document.F2.script_case_init.value;
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_tbrodetail_event_item__onchange(var_item_, var_hargaterima_, var_po_, var_disc_, var_principal_, var_expdate_, var_batchno_, var_jmlterima_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_tbrodetail_event_item__onchange_cb);
  } // do_ajax_form_tbrodetail_event_item__onchange

  function do_ajax_form_tbrodetail_event_item__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_tbrodetail_event_item__onchange_cb_after_alert);
  } // do_ajax_form_tbrodetail_event_item__onchange_cb
  function do_ajax_form_tbrodetail_event_item__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_tbrodetail_event_item__onchange_cb_after_alert

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_tbrodetail_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_tbrodetail_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tbrodetail_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_tbrodetail_add_new_line_cb);
  } // do_ajax_form_tbrodetail_add_new_line

  function do_ajax_form_tbrodetail_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_tbrodetail_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_tbrodetail_backup_line(iNumLinha)
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbrodetail_backup_line(var_item_, var_po_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_tbrodetail_backup_line_cb);
  } // do_ajax_form_tbrodetail_backup_line

  function do_ajax_form_tbrodetail_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_tbrodetail_backup_line_cb

  function do_ajax_form_tbrodetail_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_tbrodetail_cancel_insert

  function do_ajax_form_tbrodetail_cancel_update(iSeqVert)
  {
    do_ajax_form_tbrodetail_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_tbrodetail_cancel_update

  function do_ajax_form_tbrodetail_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_tbrodetail_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_tbrodetail_table_refresh()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tbrodetail_table_refresh(var_item_, var_po_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbrodetail_table_refresh_cb);
  } //  do_ajax_form_tbrodetail_table_refresh

  function do_ajax_form_tbrodetail_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_tbrodetail_table_refresh_cb_after_alert);
  } // do_ajax_form_tbrodetail_table_refresh_cb
  function do_ajax_form_tbrodetail_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_tbrodetail_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_tbrodetail_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_tbrodetail_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    sc_num_ult_line = iNumLinha;
    sc_num_ult_tr   = indexTR;
    scAjaxHideMessage();
    var var_idpo_ = scAjaxGetFieldText("idpo_" + iNumLinha);
    var var_item_ = scAjaxGetFieldSelect("item_" + iNumLinha);
...
?>
    x_ajax_form_tbrodetail_submit_form(var_idpo_, var_item_, var_disc_, var_principal_, var_jmlterima_, var_hargaterima_, var_batchno_, var_expdate_, var_po_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbrodetail_submit_form_cb);
  } // do_ajax_form_tbrodetail_submit_form

  function do_ajax_form_tbrodetail_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("idpo_" + sc_num_ult_line);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_tbrodetail_submit_form_cb_after_alert);
  } // do_ajax_form_tbrodetail_submit_form_cb
  function do_ajax_form_tbrodetail_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbrodetail_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tbrodetail_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_tbrodetail_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("idpo_" + iNavForm);
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tbrodetail_navigate_form(var_item_, var_po_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbrodetail_navigate_form_cb);
  } // do_ajax_form_tbrodetail_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbrodetail']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbrodetail_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbrodetail_navigate_form_cb_after_alert);
  } // do_ajax_form_tbrodetail_navigate_form_cb
  function do_ajax_form_tbrodetail_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_tbrodetail_navigate_form_cb_after_alert
  function sc_hide_form_tbrodetail_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "idpo_" + iNumLinha;
    iTotCampos++;
    ...
    iTotCampos++;
    ajax_error_list["idpo_" + iNumLinha] = {"label": "ID Pesan<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_field_mult["idpo_"][iNumLinha] = "idpo_" + iNumLinha;
    ...
    ajax_field_id["idpo_" + iNumLinha] = new Array("hidden_field_label_idpo_", "hidden_field_data_idpo_" + iNumLinha);
    ...
    ajax_error_count["idpo_" + iNumLinha] = "off";
...
{
?>
    ajax_read_only["idpo_" + iNumLinha] = "off";
...
{
?>
    ajax_read_only["idpo_" + iNumLinha] = "on";
    ajax_read_only["item_" + iNumLinha] = "on";
...
?>
  ...
  {
    ajax_error_list["idpo_" + iNumLinha] = null;
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["idpo_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["idpo_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["idpo_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["idpo_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["idpo_" + iNumLinha]["onfocus"] = new Array();
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['idpo_'])) ? $this->nmgp_cmp_readonly['idpo_'] : 'off';
?>
    scAjaxFieldRead("idpo_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["idpo_" + iRow] || "on" == ajax_error_count["item_" + iRow] || "on" == ajax_error_count["disc_" + iRow] || "on" == ajax_error_count["principal_" + iRow] || "on" == ajax_error_count["jmlterima_" + iRow] || "on" == ajax_error_count["hargaterima_" + iRow] || "on" == ajax_error_count["batchno_" + iRow] || "on" == ajax_error_count["expdate_" + iRow] || "on" == ajax_error_count["po_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_idpo_" + iRow).addClass("scFormErrorLine");
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["idpo_" + iRow] && "off" == ajax_error_count["item_" + iRow] && "off" == ajax_error_count["disc_" + iRow] && "off" == ajax_error_count["principal_" + iRow] && "off" == ajax_error_count["jmlterima_" + iRow] && "off" == ajax_error_count["hargaterima_" + iRow] && "off" == ajax_error_count["batchno_" + iRow] && "off" == ajax_error_count["expdate_" + iRow] && "off" == ajax_error_count["po_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["idpo_" + iRow] = "off";
      ...
      $("#hidden_field_data_idpo_" + iRow).removeClass("scFormErrorLine");
