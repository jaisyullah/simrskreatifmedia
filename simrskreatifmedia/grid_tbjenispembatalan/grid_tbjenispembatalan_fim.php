...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_tbjenispembatalan"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_tbjenispembatalan"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_tbjenispembatalan'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tbjenispembatalan']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_tbjenispembatalan']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tbjenispembatalan']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_tbjenispembatalan']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_tbjenispembatalan']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_tbjenispembatalan</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_tbjenispembatalan']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_tbjenispembatalan']['embutida_filho'] as $ind => $sc_init)
          {
