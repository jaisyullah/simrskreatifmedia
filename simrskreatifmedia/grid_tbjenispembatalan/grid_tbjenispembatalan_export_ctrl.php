<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tbjenispembatalan']['sc_process_barr'] = true;
require_once('../grid_tbjenispembatalan/index.php');
unset($_SESSION['scriptcase']['grid_tbjenispembatalan']['sc_process_barr']);
$ExportCtrl = new grid_tbjenispembatalan_export_control;
$ExportCtrl->Export_barr();

class grid_tbjenispembatalan_export_control
{
