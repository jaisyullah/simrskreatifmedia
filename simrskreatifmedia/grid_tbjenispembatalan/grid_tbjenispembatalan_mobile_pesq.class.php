...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_jenisbatal_cond" name="jenisbatal_cond" onChange="nm_campos_between(document.getElementById('id_vis_jenisbatal'), this, 'jenisbatal')">
      ...
      <br><span id="id_hide_jenisbatal"  <?php echo $str_hide_jenisbatal?>><?php
      if ($jenisbatal != "")
      {
      $jenisbatal_look = substr($this->Db->qstr($jenisbatal), 1, -1); 
      $nmgp_def_dados = array(); 
