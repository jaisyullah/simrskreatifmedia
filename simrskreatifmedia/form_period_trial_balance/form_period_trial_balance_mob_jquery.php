...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_start_date' + iSeqRow).bind('blur', function() { sc_form_period_trial_balance_start_date_onblur(this, iSeqRow) })
                                        .bind('focus', function() { sc_form_period_trial_balance_start_date_onfocus(this, iSeqRow) });
  $('#id_sc_field_end_date' + iSeqRow).bind('blur', function() { sc_form_period_trial_balance_end_date_onblur(this, iSeqRow) })
                                      .bind('focus', function() { sc_form_period_trial_balance_end_date_onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_form_period_trial_balance_start_date_onblur(oThis, iSeqRow) {
  do_ajax_form_period_trial_balance_mob_validate_start_date();
  scCssBlur(oThis);
}

function sc_form_period_trial_balance_start_date_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_period_trial_balance_end_date_onblur(oThis, iSeqRow) {
  do_ajax_form_period_trial_balance_mob_validate_end_date();
  scCssBlur(oThis);
}

function sc_form_period_trial_balance_end_date_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function scHidePage(pageNo) {
	$("#id_form_period_trial_balance_mob_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_start_date" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_period_trial_balance_mob_validate_start_date(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_end_date" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_period_trial_balance_mob_validate_end_date(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
