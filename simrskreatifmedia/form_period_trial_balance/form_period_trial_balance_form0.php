...
?>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_period_trial_balance']['embutida_pdf']))
 {
 ?>
...
<?php
include_once("form_period_trial_balance_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_period_trial_balance_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_period_trial_balance']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_period_trial_balance']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_period_trial_balance']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_period_trial_balance']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_period_trial_balance']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_period_trial_balance']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_period_trial_balance']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_period_trial_balance']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
?>
...
<?php
 include_once("form_period_trial_balance_js0.php");
?>
<script type="text/javascript"> 
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_period_trial_balance'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_period_trial_balance'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_period_trial_balance']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_period_trial_balance']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_period_trial_balance']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_period_trial_balance']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['form_period_trial_balance']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<?php
  ...
  {
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_period_trial_balance']['where_filter']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['form_period_trial_balance']['empty_filter'] = true;
       }
  }
?>
...
<?php
           if (($nm_apl_dependente != 1) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_period_trial_balance']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_period_trial_balance']['dashboard_info']['under_dashboard'])) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_period_trial_balance']['nm_run_menu']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_period_trial_balance']['nm_run_menu'] != 1))) {
...
<?php
           if (($nm_apl_dependente == 1) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_period_trial_balance']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_period_trial_balance']['dashboard_info']['under_dashboard']))) {
        $sCondStyle = ($this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_period_trial_balance']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_period_trial_balance']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_period_trial_balance");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_period_trial_balance");
 parent.scAjaxDetailHeight("form_period_trial_balance", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_period_trial_balance']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
