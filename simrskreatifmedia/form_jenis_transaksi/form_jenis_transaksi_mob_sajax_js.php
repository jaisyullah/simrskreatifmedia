  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_jenis_transaksi_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_jenis_transaksi_mob_form();
	}

  // ---------- Validate id
  function do_ajax_form_jenis_transaksi_mob_validate_id()
  {
    var nomeCampo_id = "id";
    var var_id = scAjaxGetFieldText(nomeCampo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jenis_transaksi_mob_validate_id(var_id, var_script_case_init, do_ajax_form_jenis_transaksi_mob_validate_id_cb);
  } // do_ajax_form_jenis_transaksi_mob_validate_id

  function do_ajax_form_jenis_transaksi_mob_validate_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jenis_transaksi_mob_validate_id_cb

  // ---------- Validate nama_transaksi
  function do_ajax_form_jenis_transaksi_mob_validate_nama_transaksi()
  {
    var nomeCampo_nama_transaksi = "nama_transaksi";
    var var_nama_transaksi = scAjaxGetFieldText(nomeCampo_nama_transaksi);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jenis_transaksi_mob_validate_nama_transaksi(var_nama_transaksi, var_script_case_init, do_ajax_form_jenis_transaksi_mob_validate_nama_transaksi_cb);
  } // do_ajax_form_jenis_transaksi_mob_validate_nama_transaksi

  function do_ajax_form_jenis_transaksi_mob_validate_nama_transaksi_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nama_transaksi";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jenis_transaksi_mob_validate_nama_transaksi_cb

  // ---------- Validate flag
  function do_ajax_form_jenis_transaksi_mob_validate_flag()
  {
    var nomeCampo_flag = "flag";
    var var_flag = scAjaxGetFieldSelect(nomeCampo_flag);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jenis_transaksi_mob_validate_flag(var_flag, var_script_case_init, do_ajax_form_jenis_transaksi_mob_validate_flag_cb);
  } // do_ajax_form_jenis_transaksi_mob_validate_flag

  function do_ajax_form_jenis_transaksi_mob_validate_flag_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "flag";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jenis_transaksi_mob_validate_flag_cb

  // ---------- Validate keterangan
  function do_ajax_form_jenis_transaksi_mob_validate_keterangan()
  {
    var nomeCampo_keterangan = "keterangan";
    var var_keterangan = scAjaxGetFieldText(nomeCampo_keterangan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jenis_transaksi_mob_validate_keterangan(var_keterangan, var_script_case_init, do_ajax_form_jenis_transaksi_mob_validate_keterangan_cb);
  } // do_ajax_form_jenis_transaksi_mob_validate_keterangan

  function do_ajax_form_jenis_transaksi_mob_validate_keterangan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jenis_transaksi_mob_validate_keterangan_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_jenis_transaksi_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_jenis_transaksi_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id = scAjaxGetFieldText("id");
    var var_nama_transaksi = scAjaxGetFieldText("nama_transaksi");
    var var_flag = scAjaxGetFieldSelect("flag");
    ...
    scAjaxProcOn();
    x_ajax_form_jenis_transaksi_mob_submit_form(var_id, var_nama_transaksi, var_flag, var_keterangan, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_jenis_transaksi_mob_submit_form_cb);
  } // do_ajax_form_jenis_transaksi_mob_submit_form

  function do_ajax_form_jenis_transaksi_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("nama_transaksi");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_jenis_transaksi_mob_submit_form_cb_after_alert);
  } // do_ajax_form_jenis_transaksi_mob_submit_form_cb
  function do_ajax_form_jenis_transaksi_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_jenis_transaksi_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_jenis_transaksi_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_jenis_transaksi_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_jenis_transaksi_mob_navigate_form_cb);
  } // do_ajax_form_jenis_transaksi_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_jenis_transaksi_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_jenis_transaksi_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_jenis_transaksi_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_jenis_transaksi_mob_navigate_form_cb
  function do_ajax_form_jenis_transaksi_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_jenis_transaksi_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_jenis_transaksi_mob_navigate_form_cb_after_alert
  function sc_hide_form_jenis_transaksi_mob_form()
  {
  ...
  ajax_field_list[1] = "nama_transaksi";
  ajax_field_list[2] = "flag";
  ...
  var ajax_error_list = {
    ...
    "nama_transaksi": {"label": "Nama Transaksi", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  var ajax_field_mult = {
    "id": new Array(),
    "nama_transaksi": new Array(),
    "flag": new Array(),
    "keterangan": new Array()
  };
  ajax_field_mult["id"][1] = "id";
  ajax_field_mult["nama_transaksi"][1] = "nama_transaksi";
  ...
  var ajax_field_id = {
    ...
    "nama_transaksi": new Array("hidden_field_label_nama_transaksi", "hidden_field_data_nama_transaksi"),
    "flag": new Array("hidden_field_label_flag", "hidden_field_data_flag"),
