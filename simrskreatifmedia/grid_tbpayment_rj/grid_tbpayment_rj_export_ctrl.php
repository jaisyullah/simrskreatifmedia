<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tbpayment_rj']['sc_process_barr'] = true;
require_once('../grid_tbpayment_rj/index.php');
unset($_SESSION['scriptcase']['grid_tbpayment_rj']['sc_process_barr']);
$ExportCtrl = new grid_tbpayment_rj_export_control;
$ExportCtrl->Export_barr();

class grid_tbpayment_rj_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_title'] ?> tbpayment :: Excel</TITLE>
