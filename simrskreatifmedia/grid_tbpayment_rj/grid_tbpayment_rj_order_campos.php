<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_tbpayment_rj']['glo_nm_path_imag_temp'] . "/sc_apl_default_simrskreatifmedia.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_tbpayment_rj_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_tbpayment_rj_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbpayment_rj']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tbpayment_rj']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbpayment_rj']['labels']["id"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbpayment_rj']['labels']["id"] : "ID";
   $tab_ger_campos['trancode'] = "on";
   $tab_def_campos['trancode'] = "tranCode";
   $tab_labels["trancode"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbpayment_rj']['labels']["trancode"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbpayment_rj']['labels']["trancode"] : "Tran Code";
   $tab_ger_campos['nostruk'] = "on";
   $tab_def_campos['nostruk'] = "noStruk";
   $tab_labels["nostruk"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbpayment_rj']['labels']["nostruk"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbpayment_rj']['labels']["nostruk"] : "No Struk";
   $tab_ger_campos['custcode'] = "on";
   $tab_def_campos['custcode'] = "custCode";
   $tab_labels["custcode"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbpayment_rj']['labels']["custcode"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbpayment_rj']['labels']["custcode"] : "Cust Code";
   $tab_ger_campos['dokter'] = "on";
   $tab_def_campos['dokter'] = "dokter";
   $tab_labels["dokter"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbpayment_rj']['labels']["dokter"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbpayment_rj']['labels']["dokter"] : "Dokter";
   $tab_ger_campos['jmltagihan'] = "on";
   $tab_def_campos['jmltagihan'] = "jmlTagihan";
   $tab_labels["jmltagihan"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbpayment_rj']['labels']["jmltagihan"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbpayment_rj']['labels']["jmltagihan"] : "Jml Tagihan";
   $tab_ger_campos['jmlbayar'] = "on";
   $tab_def_campos['jmlbayar'] = "jmlBayar";
   $tab_labels["jmlbayar"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbpayment_rj']['labels']["jmlbayar"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbpayment_rj']['labels']["jmlbayar"] : "Jml Bayar";
   $tab_ger_campos['deposit'] = "on";
   $tab_def_campos['deposit'] = "deposit";
   $tab_labels["deposit"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbpayment_rj']['labels']["deposit"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbpayment_rj']['labels']["deposit"] : "Deposit";
   $tab_ger_campos['potongan'] = "on";
   $tab_def_campos['potongan'] = "potongan";
   $tab_labels["potongan"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbpayment_rj']['labels']["potongan"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbpayment_rj']['labels']["potongan"] : "Potongan";
   $tab_ger_campos['hrsdibayar'] = "on";
   $tab_def_campos['hrsdibayar'] = "hrsDibayar";
   $tab_labels["hrsdibayar"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbpayment_rj']['labels']["hrsdibayar"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbpayment_rj']['labels']["hrsdibayar"] : "Hrs Dibayar";
   $tab_ger_campos['trandate'] = "on";
   $tab_def_campos['trandate'] = "tranDate";
   $tab_labels["trandate"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbpayment_rj']['labels']["trandate"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbpayment_rj']['labels']["trandate"] : "Tran Date";
   $tab_ger_campos['terimadari'] = "on";
   $tab_def_campos['terimadari'] = "terimaDari";
   $tab_labels["terimadari"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbpayment_rj']['labels']["terimadari"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbpayment_rj']['labels']["terimadari"] : "Terima Dari";
   $tab_ger_campos['jenispayment'] = "on";
   $tab_def_campos['jenispayment'] = "jenisPayment";
   $tab_labels["jenispayment"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbpayment_rj']['labels']["jenispayment"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbpayment_rj']['labels']["jenispayment"] : "Jenis Payment";
   $tab_ger_campos['instansipenjamin'] = "on";
   $tab_def_campos['instansipenjamin'] = "instansiPenjamin";
   $tab_labels["instansipenjamin"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbpayment_rj']['labels']["instansipenjamin"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbpayment_rj']['labels']["instansipenjamin"] : "Instansi Penjamin";
   $tab_ger_campos['bankdebit'] = "on";
   $tab_def_campos['bankdebit'] = "bankDebit";
   $tab_labels["bankdebit"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbpayment_rj']['labels']["bankdebit"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbpayment_rj']['labels']["bankdebit"] : "Bank Debit";
   $tab_ger_campos['nokartu'] = "on";
   $tab_def_campos['nokartu'] = "noKartu";
   $tab_labels["nokartu"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbpayment_rj']['labels']["nokartu"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbpayment_rj']['labels']["nokartu"] : "No Kartu";
   ...
   {
       $tab_def_campos['sc_field_0'] = "`Jaminan/Polis`";
   }
   $tab_labels["sc_field_0"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbpayment_rj']['labels']["sc_field_0"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbpayment_rj']['labels']["sc_field_0"] : "Jaminan / Polis";
   $tab_ger_campos['lunas'] = "on";
   $tab_def_campos['lunas'] = "lunas";
   $tab_labels["lunas"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbpayment_rj']['labels']["lunas"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbpayment_rj']['labels']["lunas"] : "Lunas";
   $tab_ger_campos['paiddate'] = "on";
   $tab_def_campos['paiddate'] = "paidDate";
   $tab_labels["paiddate"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbpayment_rj']['labels']["paiddate"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbpayment_rj']['labels']["paiddate"] : "Paid Date";
   $tab_ger_campos['nopayment'] = "on";
   $tab_def_campos['nopayment'] = "noPayment";
   $tab_labels["nopayment"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbpayment_rj']['labels']["nopayment"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbpayment_rj']['labels']["nopayment"] : "No Payment";
   $tab_ger_campos['deskripsi'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['deskripsi'] = "deskripsi";
   }
   else
   {
       $tab_def_campos['deskripsi'] = "";
   }
   $tab_labels["deskripsi"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbpayment_rj']['labels']["deskripsi"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbpayment_rj']['labels']["deskripsi"] : "deskripsi";
   ...
   {
       $tab_def_campos['subtotal'] = "";
   }
   $tab_labels["subtotal"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbpayment_rj']['labels']["subtotal"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbpayment_rj']['labels']["subtotal"] : "subtotal";
   ...
   $tab_labels["terbilang"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbpayment_rj']['labels']["terbilang"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbpayment_rj']['labels']["terbilang"] : "terbilang";
   $tab_ger_campos['deskripsi'] = "none";
   $tab_ger_campos['subtotal'] = "none";
   $tab_ger_campos['terbilang'] = "none";
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_tbpayment_rj']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_tbpayment_rj']['field_display']))
   {
       foreach ($_SESSION['scriptcase']['sc_apl_conf']['grid_tbpayment_rj']['field_display'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_tbpayment_rj']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_tbpayment_rj']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_tbpayment_rj']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbpayment_rj']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tbpayment_rj']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_tbpayment_rj']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_tbpayment_rj']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_tbpayment_rj']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_tbpayment_rj']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_title'] ?> tbpayment</TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_tbpayment_rj_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_tbpayment_rj']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_tbpayment_rj']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_tbpayment_rj']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_tbpayment_rj']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_tbpayment_rj']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
