...
<HEAD>
 <TITLE><?php if ('novo' == $this->nmgp_opcao) { echo strip_tags("" . $this->Ini->Nm_lang['lang_othr_frmi_titl'] . " - Kamar Operasi"); } else { echo strip_tags("" . $this->Ini->Nm_lang['lang_othr_frmu_titl'] . " - Kamar Operasi"); } ?></TITLE>
...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_tbdetailok/form_tbdetailok_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_tbdetailok_mob_sajax_js.php");
?>
<script type="text/javascript">
...
function summary_atualiza(reg_ini, reg_qtd, reg_tot)
{
 ...
 function nm_field_disabled(Fields, Opt) {
  ...
  for (i=0; i < Field.length; i++)
  {
     ...
     if (F_name == "strukrj")
     {
        $('input[name="strukrj"]').prop("disabled", F_opc);
        if (F_opc == "disabled" || F_opc == true) {
            $('input[name="strukrj"]').addClass("scFormInputDisabled");
        }
        else {
            $('input[name="strukrj"]').removeClass("scFormInputDisabled");
        }
     }
  }
 } // nm_field_disabled
...
include_once('form_tbdetailok_mob_jquery.php');
 ...
 function toggleBlock(e) {
  ...
  if (show_block[block_id]) {
    ...
    if ("hidden_bloco_8" == block_id) {
      scAjaxDetailHeight("pemeriksaanLab_rj", $($("#nmsc_iframe_liga_pemeriksaanLab_rj")[0].contentWindow.document).innerHeight());
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
?>
<body class="scFormPage" style="<?php echo $remove_margin . $str_iframe_body; ?>">
<?php

if (isset($_SESSION['scriptcase']['form_tbdetailok']['error_buffer']) && '' != $_SESSION['scriptcase']['form_tbdetailok']['error_buffer'])
{
    echo $_SESSION['scriptcase']['form_tbdetailok']['error_buffer'];
}
...
<?php
 include_once("form_tbdetailok_mob_js0.php");
?>
<script type="text/javascript"> 
...
<form  name="F1" method="post" 
               action="form_tbdetailok_mob.php" 
               target="_self">
<input type="hidden" name="nmgp_url_saida" value="">
<?php
if ('novo' == $this->nmgp_opcao || 'incluir' == $this->nmgp_opcao)
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_tbdetailok_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_tbdetailok_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<div class="scFormHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFormHeaderFont" style="float: left; text-transform: uppercase;"><?php if ($this->nmgp_opcao == "novo") { echo "" . $this->Ini->Nm_lang['lang_othr_frmi_titl'] . " - Kamar Operasi"; } else { echo "" . $this->Ini->Nm_lang['lang_othr_frmu_titl'] . " - Kamar Operasi"; } ?></div>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['fast_search'][2] : "";
?> 
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['run_iframe'] != "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['run_iframe'] == "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
   ...
   if (!isset($this->nmgp_cmp_hidden['strukrj']))
   {
       $this->nmgp_cmp_hidden['strukrj'] = 'off';
   }
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_inapcode_line" id="hidden_field_data_inapcode" style="<?php echo $sStyleHidden_inapcode; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_inapcode_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_inapcode_label"><span id="id_label_inapcode"><?php echo $this->nm_new_label['inapcode']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['php_cmp_required']['inapcode']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['php_cmp_required']['inapcode'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<span id="id_read_on_inapcode" class="sc-ui-readonly-inapcode css_inapcode_line" style="<?php echo $sStyleReadLab_inapcode; ?>"><?php echo $this->inapcode; ?></span><span id="id_read_off_inapcode" class="css_read_off_inapcode" style="white-space: nowrap;<?php echo $sStyleReadInp_inapcode; ?>">
 ...
 size=15 maxlength=15 alt="{datatype: 'text', maxLength: 15, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php
   $Sc_iframe_master = ($this->Embutida_call) ? 'nmgp_iframe_ret*scinnmsc_iframe_liga_form_tbdetailok_mob*scout' : '';
   if (isset($this->Ini->sc_lig_md5["grid_tbadmrawatinap"]) && $this->Ini->sc_lig_md5["grid_tbadmrawatinap"] == "S") {
       $Parms_Lig  = "nmgp_url_saida*scin*scoutnmgp_parms_ret*scinF1,inapcode,trancode*scoutnm_evt_ret_busca*scinsc_form_tbdetailok_inapcode_onchange(this)*scout" . $Sc_iframe_master;
       $Md5_Lig    = "@SC_par@" . $this->form_encode_input($this->Ini->sc_page) . "@SC_par@form_tbdetailok_mob@SC_par@" . md5($Parms_Lig);
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['Lig_Md5'][md5($Parms_Lig)] = $Parms_Lig;
   } else {
       $Md5_Lig  = "nmgp_url_saida*scin*scoutnmgp_parms_ret*scinF1,inapcode,trancode*scoutnm_evt_ret_busca*scinsc_form_tbdetailok_inapcode_onchange(this)*scout" . $Sc_iframe_master;
   }
?>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    ...
    {
        $this->nm_new_label['funcroom'] = "Tindakan OK";
    }
?>
<?php
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_funcroom_line" id="hidden_field_data_funcroom" style="<?php echo $sStyleHidden_funcroom; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_funcroom_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_funcroom_label"><span id="id_label_funcroom"><?php echo $this->nm_new_label['funcroom']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['php_cmp_required']['funcroom']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['php_cmp_required']['funcroom'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<span id="id_read_on_funcroom" class="sc-ui-readonly-funcroom css_funcroom_line" style="<?php echo $sStyleReadLab_funcroom; ?>"><?php echo $this->funcroom; ?></span><span id="id_read_off_funcroom" class="css_read_off_funcroom" style="white-space: nowrap;<?php echo $sStyleReadInp_funcroom; ?>">
 ...
 size=50 maxlength=50 alt="{datatype: 'text', maxLength: 50, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: 'upper', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: 'Mis. : SECTIO CITO', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    if (!isset($this->nm_new_label['strukrj']))
    {
        $this->nm_new_label['strukrj'] = "strukRJ";
    }
?>
<?php
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
   $nm_img_fun_cel  = ($nm_img_fun_cel  == $this->Ini->img_fun_imp    ? $this->Ini->img_fun_par  : $this->Ini->img_fun_imp);
   $strukrj = $this->strukrj;
   if (!isset($this->nmgp_cmp_hidden['strukrj']))
   {
       $this->nmgp_cmp_hidden['strukrj'] = 'off';
   }
   $sStyleHidden_strukrj = '';
   if (isset($this->nmgp_cmp_hidden['strukrj']) && $this->nmgp_cmp_hidden['strukrj'] == 'off')
   {
       unset($this->nmgp_cmp_hidden['strukrj']);
       $sStyleHidden_strukrj = 'display: none;';
   }
   $bTestReadOnly = true;
   $sStyleReadLab_strukrj = 'display: none;';
   $sStyleReadInp_strukrj = '';
   if (/*$this->nmgp_opcao != "novo" && */isset($this->nmgp_cmp_readonly['strukrj']) && $this->nmgp_cmp_readonly['strukrj'] == 'on')
   {
       $bTestReadOnly = false;
       unset($this->nmgp_cmp_readonly['strukrj']);
       $sStyleReadLab_strukrj = '';
       $sStyleReadInp_strukrj = 'display: none;';
   }
?>
<?php if (isset($this->nmgp_cmp_hidden['strukrj']) && $this->nmgp_cmp_hidden['strukrj'] == 'off') { $sc_hidden_yes++;  ?>
<input type="hidden" name="strukrj" value="<?php echo $this->form_encode_input($strukrj) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormDataOdd css_strukrj_line" id="hidden_field_data_strukrj" style="<?php echo $sStyleHidden_strukrj; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_strukrj_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_strukrj_label"><span id="id_label_strukrj"><?php echo $this->nm_new_label['strukrj']; ?></span></span><br>
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["strukrj"]) &&  $this->nmgp_cmp_readonly["strukrj"] == "on") { 

 ?>
<input type="hidden" name="strukrj" value="<?php echo $this->form_encode_input($strukrj) . "\">" . $strukrj . ""; ?>
<?php } else { ?>
<span id="id_read_on_strukrj" class="sc-ui-readonly-strukrj css_strukrj_line" style="<?php echo $sStyleReadLab_strukrj; ?>"><?php echo $this->strukrj; ?></span><span id="id_read_off_strukrj" class="css_read_off_strukrj" style="white-space: nowrap;<?php echo $sStyleReadInp_strukrj; ?>">
 <input class="sc-js-input scFormObjectOdd css_strukrj_obj" style="" id="id_sc_field_strukrj" type=text name="strukrj" value="<?php echo $this->form_encode_input($strukrj) ?>"
...
</td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_strukrj_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_strukrj_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
<?php $sStyleHidden_strukrj_dumb = ('' == $sStyleHidden_strukrj) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_strukrj_dumb" style="<?php echo $sStyleHidden_strukrj_dumb; ?>"></TD>
   </tr>
<?php $sc_hidden_no = 1; ?>
</TABLE></div><!-- bloco_f -->
   </td>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_diagpre_line" id="hidden_field_data_diagpre" style="<?php echo $sStyleHidden_diagpre; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_diagpre_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_diagpre_label"><span id="id_label_diagpre"><?php echo $this->nm_new_label['diagpre']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['php_cmp_required']['diagpre']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['php_cmp_required']['diagpre'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<span id="id_read_on_diagpre" class="sc-ui-readonly-diagpre css_diagpre_line" style="<?php echo $sStyleReadLab_diagpre; ?>"><?php echo $this->diagpre; ?></span><span id="id_read_off_diagpre" class="css_read_off_diagpre" style="white-space: nowrap;<?php echo $sStyleReadInp_diagpre; ?>">
 ...
 size=50 maxlength=200 alt="{datatype: 'text', maxLength: 200, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: 'Deskripsi Diagnosa Pre Op', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
...
<span id="id_read_on_diagpost" class="sc-ui-readonly-diagpost css_diagpost_line" style="<?php echo $sStyleReadLab_diagpost; ?>"><?php echo $this->diagpost; ?></span><span id="id_read_off_diagpost" class="css_read_off_diagpost" style="white-space: nowrap;<?php echo $sStyleReadInp_diagpost; ?>">
 ...
 size=50 maxlength=200 alt="{datatype: 'text', maxLength: 200, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: 'Deskripsi Diagnosa Post Op', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_pa_line" id="hidden_field_data_pa" style="<?php echo $sStyleHidden_pa; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_pa_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_pa_label"><span id="id_label_pa"><?php echo $this->nm_new_label['pa']; ?></span></span><br>
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["pa"]) &&  $this->nmgp_cmp_readonly["pa"] == "on") { 

$pa_look = "";
 if ($this->pa == "Tidak") { $pa_look .= "Tidak" ;} 
...
$pa_look = "";
 ...
 if (empty($pa_look)) { $pa_look = $this->pa; }
?>
<span id="id_read_on_pa" class="css_pa_line"  style="<?php echo $sStyleReadLab_pa; ?>"><?php echo $this->form_encode_input($pa_look); ?></span><span id="id_read_off_pa" class="css_read_off_pa" style="white-space: nowrap; <?php echo $sStyleReadInp_pa; ?>">
 <span id="idAjaxSelect_pa"><select class="sc-js-input scFormObjectOdd css_pa_obj" style="" id="id_sc_field_pa" name="pa" size="1" alt="{type: 'select', enterTab: false}">
 <option  value="Tidak" <?php  if ($this->pa == "Tidak") { echo " selected" ;} ?><?php  if (empty($this->pa)) { echo " selected" ;} ?>>Tidak</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['Lookup_pa'][] = 'Tidak'; ?>
 <option  value="Ya" <?php  if ($this->pa == "Ya") { echo " selected" ;} ?>>Ya</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['Lookup_pa'][] = 'Ya'; ?>
 </select></span>
</span><?php  }?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['Lookup_cito'][] = 'Non Cito'; ?>
 <option  value="Cito Siang" <?php  if ($this->cito == "Cito Siang") { echo " selected" ;} ?>>Cito Siang</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['Lookup_cito'][] = 'Cito Siang'; ?>
 <option  value="Cito Malam" <?php  if ($this->cito == "Cito Malam") { echo " selected" ;} ?>>Cito Malam</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['Lookup_cito'][] = 'Cito Malam'; ?>
 <option  value="Cito Minggu" <?php  if ($this->cito == "Cito Minggu") { echo " selected" ;} ?>>Cito Minggu</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['Lookup_cito'][] = 'Cito Minggu'; ?>
 </select></span>
</span><?php  }?>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
   if (!isset($this->nm_new_label['vc']))
   {
       $this->nm_new_label['vc'] = "VC";
   }
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
   $nm_img_fun_cel  = ($nm_img_fun_cel  == $this->Ini->img_fun_imp    ? $this->Ini->img_fun_par  : $this->Ini->img_fun_imp);
   $vc = $this->vc;
   $sStyleHidden_vc = '';
   if (isset($this->nmgp_cmp_hidden['vc']) && $this->nmgp_cmp_hidden['vc'] == 'off')
   {
       unset($this->nmgp_cmp_hidden['vc']);
       $sStyleHidden_vc = 'display: none;';
   }
   $bTestReadOnly = true;
   $sStyleReadLab_vc = 'display: none;';
   $sStyleReadInp_vc = '';
   if (/*$this->nmgp_opcao != "novo" && */isset($this->nmgp_cmp_readonly['vc']) && $this->nmgp_cmp_readonly['vc'] == 'on')
   {
       $bTestReadOnly = false;
       unset($this->nmgp_cmp_readonly['vc']);
       $sStyleReadLab_vc = '';
       $sStyleReadInp_vc = 'display: none;';
   }
?>
<?php if (isset($this->nmgp_cmp_hidden['vc']) && $this->nmgp_cmp_hidden['vc'] == 'off') { $sc_hidden_yes++; ?>
<input type=hidden name="vc" value="<?php echo $this->form_encode_input($this->vc) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormDataOdd css_vc_line" id="hidden_field_data_vc" style="<?php echo $sStyleHidden_vc; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_vc_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_vc_label"><span id="id_label_vc"><?php echo $this->nm_new_label['vc']; ?></span></span><br>
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["vc"]) &&  $this->nmgp_cmp_readonly["vc"] == "on") { 

$vc_look = "";
 if ($this->vc == "Tidak") { $vc_look .= "Tidak" ;} 
 if ($this->vc == "Ya") { $vc_look .= "Ya" ;} 
 if (empty($vc_look)) { $vc_look = $this->vc; }
?>
<input type="hidden" name="vc" value="<?php echo $this->form_encode_input($vc) . "\">" . $vc_look . ""; ?>
<?php } else { ?>
<?php
...
$vc_look = "";
 ...
 if (empty($vc_look)) { $vc_look = $this->vc; }
?>
<span id="id_read_on_vc" class="css_vc_line"  style="<?php echo $sStyleReadLab_vc; ?>"><?php echo $this->form_encode_input($vc_look); ?></span><span id="id_read_off_vc" class="css_read_off_vc" style="white-space: nowrap; <?php echo $sStyleReadInp_vc; ?>">
 <span id="idAjaxSelect_vc"><select class="sc-js-input scFormObjectOdd css_vc_obj" style="" id="id_sc_field_vc" name="vc" size="1" alt="{type: 'select', enterTab: false}">
 <option  value="Tidak" <?php  if ($this->vc == "Tidak") { echo " selected" ;} ?><?php  if (empty($this->vc)) { echo " selected" ;} ?>>Tidak</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['Lookup_vc'][] = 'Tidak'; ?>
 <option  value="Ya" <?php  if ($this->vc == "Ya") { echo " selected" ;} ?>>Ya</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['Lookup_vc'][] = 'Ya'; ?>
 </select></span>
</span><?php  }?>
</td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_vc_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_vc_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
   if (!isset($this->nm_new_label['cultur']))
   {
       $this->nm_new_label['cultur'] = "Cultur";
   }
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
   $nm_img_fun_cel  = ($nm_img_fun_cel  == $this->Ini->img_fun_imp    ? $this->Ini->img_fun_par  : $this->Ini->img_fun_imp);
   $cultur = $this->cultur;
   $sStyleHidden_cultur = '';
   if (isset($this->nmgp_cmp_hidden['cultur']) && $this->nmgp_cmp_hidden['cultur'] == 'off')
   {
       unset($this->nmgp_cmp_hidden['cultur']);
       $sStyleHidden_cultur = 'display: none;';
   }
   $bTestReadOnly = true;
   $sStyleReadLab_cultur = 'display: none;';
   $sStyleReadInp_cultur = '';
   if (/*$this->nmgp_opcao != "novo" && */isset($this->nmgp_cmp_readonly['cultur']) && $this->nmgp_cmp_readonly['cultur'] == 'on')
   {
       $bTestReadOnly = false;
       unset($this->nmgp_cmp_readonly['cultur']);
       $sStyleReadLab_cultur = '';
       $sStyleReadInp_cultur = 'display: none;';
   }
?>
<?php if (isset($this->nmgp_cmp_hidden['cultur']) && $this->nmgp_cmp_hidden['cultur'] == 'off') { $sc_hidden_yes++; ?>
<input type=hidden name="cultur" value="<?php echo $this->form_encode_input($this->cultur) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormDataOdd css_cultur_line" id="hidden_field_data_cultur" style="<?php echo $sStyleHidden_cultur; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_cultur_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_cultur_label"><span id="id_label_cultur"><?php echo $this->nm_new_label['cultur']; ?></span></span><br>
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["cultur"]) &&  $this->nmgp_cmp_readonly["cultur"] == "on") { 

$cultur_look = "";
 if ($this->cultur == "Tidak") { $cultur_look .= "Tidak" ;} 
 if ($this->cultur == "Ya") { $cultur_look .= "Ya" ;} 
 if (empty($cultur_look)) { $cultur_look = $this->cultur; }
?>
<input type="hidden" name="cultur" value="<?php echo $this->form_encode_input($cultur) . "\">" . $cultur_look . ""; ?>
<?php } else { ?>
<?php
...
$cultur_look = "";
 ...
 if (empty($cultur_look)) { $cultur_look = $this->cultur; }
?>
<span id="id_read_on_cultur" class="css_cultur_line"  style="<?php echo $sStyleReadLab_cultur; ?>"><?php echo $this->form_encode_input($cultur_look); ?></span><span id="id_read_off_cultur" class="css_read_off_cultur" style="white-space: nowrap; <?php echo $sStyleReadInp_cultur; ?>">
 <span id="idAjaxSelect_cultur"><select class="sc-js-input scFormObjectOdd css_cultur_obj" style="" id="id_sc_field_cultur" name="cultur" size="1" alt="{type: 'select', enterTab: false}">
 <option  value="Tidak" <?php  if ($this->cultur == "Tidak") { echo " selected" ;} ?><?php  if (empty($this->cultur)) { echo " selected" ;} ?>>Tidak</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['Lookup_cultur'][] = 'Tidak'; ?>
 <option  value="Ya" <?php  if ($this->cultur == "Ya") { echo " selected" ;} ?>>Ya</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['Lookup_cultur'][] = 'Ya'; ?>
 </select></span>
</span><?php  }?>
</td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_cultur_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_cultur_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
   if (!isset($this->nm_new_label['asa']))
   {
       $this->nm_new_label['asa'] = "ASA";
   }
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
   $nm_img_fun_cel  = ($nm_img_fun_cel  == $this->Ini->img_fun_imp    ? $this->Ini->img_fun_par  : $this->Ini->img_fun_imp);
   $asa = $this->asa;
   $sStyleHidden_asa = '';
   if (isset($this->nmgp_cmp_hidden['asa']) && $this->nmgp_cmp_hidden['asa'] == 'off')
   {
       unset($this->nmgp_cmp_hidden['asa']);
       $sStyleHidden_asa = 'display: none;';
   }
   $bTestReadOnly = true;
   $sStyleReadLab_asa = 'display: none;';
   $sStyleReadInp_asa = '';
   if (/*$this->nmgp_opcao != "novo" && */isset($this->nmgp_cmp_readonly['asa']) && $this->nmgp_cmp_readonly['asa'] == 'on')
   {
       $bTestReadOnly = false;
       unset($this->nmgp_cmp_readonly['asa']);
       $sStyleReadLab_asa = '';
       $sStyleReadInp_asa = 'display: none;';
   }
?>
<?php if (isset($this->nmgp_cmp_hidden['asa']) && $this->nmgp_cmp_hidden['asa'] == 'off') { $sc_hidden_yes++; ?>
<input type=hidden name="asa" value="<?php echo $this->form_encode_input($this->asa) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormDataOdd css_asa_line" id="hidden_field_data_asa" style="<?php echo $sStyleHidden_asa; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_asa_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_asa_label"><span id="id_label_asa"><?php echo $this->nm_new_label['asa']; ?></span></span><br>
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["asa"]) &&  $this->nmgp_cmp_readonly["asa"] == "on") { 

$asa_look = "";
 if ($this->asa == "ASA I") { $asa_look .= "ASA I" ;} 
 if ($this->asa == "ASA II") { $asa_look .= "ASA II" ;} 
 if ($this->asa == "ASA III") { $asa_look .= "ASA III" ;} 
 if ($this->asa == "ASA IV") { $asa_look .= "ASA IV" ;} 
 if ($this->asa == "ASA V") { $asa_look .= "ASA V" ;} 
 if (empty($asa_look)) { $asa_look = $this->asa; }
?>
<input type="hidden" name="asa" value="<?php echo $this->form_encode_input($asa) . "\">" . $asa_look . ""; ?>
<?php } else { ?>
<?php
...
$asa_look = "";
 ...
 if (empty($asa_look)) { $asa_look = $this->asa; }
?>
<span id="id_read_on_asa" class="css_asa_line"  style="<?php echo $sStyleReadLab_asa; ?>"><?php echo $this->form_encode_input($asa_look); ?></span><span id="id_read_off_asa" class="css_read_off_asa" style="white-space: nowrap; <?php echo $sStyleReadInp_asa; ?>">
 <span id="idAjaxSelect_asa"><select class="sc-js-input scFormObjectOdd css_asa_obj" style="" id="id_sc_field_asa" name="asa" size="1" alt="{type: 'select', enterTab: false}">
 <option  value="ASA I" <?php  if ($this->asa == "ASA I") { echo " selected" ;} ?><?php  if (empty($this->asa)) { echo " selected" ;} ?>>ASA I</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['Lookup_asa'][] = 'ASA I'; ?>
 <option  value="ASA II" <?php  if ($this->asa == "ASA II") { echo " selected" ;} ?>>ASA II</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['Lookup_asa'][] = 'ASA II'; ?>
 <option  value="ASA III" <?php  if ($this->asa == "ASA III") { echo " selected" ;} ?>>ASA III</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['Lookup_asa'][] = 'ASA III'; ?>
 <option  value="ASA IV" <?php  if ($this->asa == "ASA IV") { echo " selected" ;} ?>>ASA IV</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['Lookup_asa'][] = 'ASA IV'; ?>
 <option  value="ASA V" <?php  if ($this->asa == "ASA V") { echo " selected" ;} ?>>ASA V</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['Lookup_asa'][] = 'ASA V'; ?>
 </select></span>
</span><?php  }?>
</td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_asa_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_asa_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    ...
    {
        $this->nm_new_label['opertime'] = "W. Operasi";
    }
?>
<?php
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['Lookup_observasi'][] = '1'; ?>
<?php  if (in_array("1", $this->observasi_1))  { echo " checked" ;} ?> onClick="do_ajax_form_tbdetailok_mob_event_observasi_onclick();" ><span></span>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['Lookup_tindobservasi'][] = ''; ?>
 <option value=""></option>
 <option  value="OBSERVASI" <?php  if ($this->tindobservasi == "OBSERVASI") { echo " selected" ;} ?>>OBSERVASI</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['Lookup_tindobservasi'][] = 'OBSERVASI'; ?>
 </select></span>
</span><?php  }?>
...
<TABLE align="center" id="hidden_bloco_6" class="scFormTable" width="100%" style="height: 100%;">   <tr>
    ...
    <TD colspan="1" height="20" class="scFormBlock">
     <TABLE style="padding: 0px; spacing: 0px; border-width: 0px;" width="100%" height="100%">
      <TR>
       <TD align="" valign="" class="scFormBlockFont">JASA PENATA</TD>
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_detailInsentif'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_detailInsentif'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['form_tbtim_mob_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_detailInsentif'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['form_tbtim_mob_script_case_init'] = $this->Ini->sc_page;
 }
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['form_tbtim_mob_script_case_init'] ]['form_tbtim_mob']['embutida_proc']  = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['form_tbtim_mob_script_case_init'] ]['form_tbtim_mob']['embutida_form']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['form_tbtim_mob_script_case_init'] ]['form_tbtim_mob']['embutida_call']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['form_tbtim_mob_script_case_init'] ]['form_tbtim_mob']['embutida_multi'] = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['form_tbtim_mob_script_case_init'] ]['form_tbtim_mob']['embutida_liga_form_insert'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['form_tbtim_mob_script_case_init'] ]['form_tbtim_mob']['embutida_liga_form_update'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['form_tbtim_mob_script_case_init'] ]['form_tbtim_mob']['embutida_liga_form_delete'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['form_tbtim_mob_script_case_init'] ]['form_tbtim_mob']['embutida_liga_form_btn_nav'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['form_tbtim_mob_script_case_init'] ]['form_tbtim_mob']['embutida_liga_grid_edit'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['form_tbtim_mob_script_case_init'] ]['form_tbtim_mob']['embutida_liga_grid_edit_link'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['form_tbtim_mob_script_case_init'] ]['form_tbtim_mob']['embutida_liga_qtd_reg'] = '10';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['form_tbtim_mob_script_case_init'] ]['form_tbtim_mob']['embutida_liga_tp_pag'] = 'total';
 ...
 if ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['form_tbtim_mob_script_case_init'] ]['form_tbdetailok_mob']['total'] < 0)
 {
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_tbdetailok_mob_empty.htm' : $this->Ini->link_form_tbtim_mob_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_session=' . session_id() . '&script_case_detail=Y&sc_ifr_height=600';
...
if (isset($this->Ini->sc_lig_target['C_@scinf_detailInsentif']) && 'nmsc_iframe_liga_form_tbtim_mob' != $this->Ini->sc_lig_target['C_@scinf_detailInsentif'])
{
    if ('novo' != $this->nmgp_opcao)
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_detailInsentif'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['form_tbtim_mob_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
{
?>
<iframe border="0" id="nmsc_iframe_liga_form_tbtim_mob"  marginWidth="0" marginHeight="0" frameborder="0" valign="top" height="600" width="100%" name="nmsc_iframe_liga_form_tbtim_mob"  scrolling="auto" src="<?php echo $sDetailSrc; ?>"></iframe>
<?php
}
?>
...
<?php $sStyleHidden_detailinsentif_dumb = ('' == $sStyleHidden_detailinsentif) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_detailinsentif_dumb" style="<?php echo $sStyleHidden_detailinsentif_dumb; ?>"></TD>
   </tr>
<?php $sc_hidden_no = 1; ?>
</TABLE></div><!-- bloco_f -->
   </td>
...
<TABLE align="center" id="hidden_bloco_7" class="scFormTable" width="100%" style="height: 100%;">   <tr>
    ...
    <TD colspan="1" height="20" class="scFormBlock">
     <TABLE style="padding: 0px; spacing: 0px; border-width: 0px;" width="100%" height="100%">
      <TR>
       <TD align="" valign="" class="scFormBlockFont">OBAT / BHP</TD>
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_detailResep'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_detailResep'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['form_tbdetailresepokvk_mob_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_detailResep'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['form_tbdetailresepokvk_mob_script_case_init'] = $this->Ini->sc_page;
 }
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['form_tbdetailresepokvk_mob_script_case_init'] ]['form_tbdetailresepokvk_mob']['embutida_proc']  = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['form_tbdetailresepokvk_mob_script_case_init'] ]['form_tbdetailresepokvk_mob']['embutida_form']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['form_tbdetailresepokvk_mob_script_case_init'] ]['form_tbdetailresepokvk_mob']['embutida_call']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['form_tbdetailresepokvk_mob_script_case_init'] ]['form_tbdetailresepokvk_mob']['embutida_multi'] = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['form_tbdetailresepokvk_mob_script_case_init'] ]['form_tbdetailresepokvk_mob']['embutida_liga_form_insert'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['form_tbdetailresepokvk_mob_script_case_init'] ]['form_tbdetailresepokvk_mob']['embutida_liga_form_update'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['form_tbdetailresepokvk_mob_script_case_init'] ]['form_tbdetailresepokvk_mob']['embutida_liga_form_delete'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['form_tbdetailresepokvk_mob_script_case_init'] ]['form_tbdetailresepokvk_mob']['embutida_liga_form_btn_nav'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['form_tbdetailresepokvk_mob_script_case_init'] ]['form_tbdetailresepokvk_mob']['embutida_liga_grid_edit'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['form_tbdetailresepokvk_mob_script_case_init'] ]['form_tbdetailresepokvk_mob']['embutida_liga_grid_edit_link'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['form_tbdetailresepokvk_mob_script_case_init'] ]['form_tbdetailresepokvk_mob']['embutida_liga_qtd_reg'] = '10';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['form_tbdetailresepokvk_mob_script_case_init'] ]['form_tbdetailresepokvk_mob']['embutida_liga_tp_pag'] = 'total';
 ...
 if ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['form_tbdetailresepokvk_mob_script_case_init'] ]['form_tbdetailok_mob']['total'] < 0)
 {
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_tbdetailok_mob_empty.htm' : $this->Ini->link_form_tbdetailresepokvk_mob_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_session=' . session_id() . '&script_case_detail=Y&sc_ifr_height=500';
...
if (isset($this->Ini->sc_lig_target['C_@scinf_detailResep']) && 'nmsc_iframe_liga_form_tbdetailresepokvk_mob' != $this->Ini->sc_lig_target['C_@scinf_detailResep'])
{
    if ('novo' != $this->nmgp_opcao)
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_detailResep'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['form_tbdetailresepokvk_mob_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
<TABLE align="center" id="hidden_bloco_8" class="scFormTable" width="100%" style="height: 100%;">   <tr>
    ...
    <TD colspan="1" height="20" class="scFormBlock">
     <TABLE style="padding: 0px; spacing: 0px; border-width: 0px;" width="100%" height="100%">
      <TR>
       <TD align="" valign="" class="scFormBlockFont">HASIL LAB</TD>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    ...
    {
        $this->nm_new_label['hasillab'] = "hasilLab";
    }
?>
<?php
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_hasilLab'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_hasilLab'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['pemeriksaanLab_rj_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_hasilLab'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['pemeriksaanLab_rj_script_case_init'] = $this->Ini->sc_page;
 }
 ...
 if (isset($this->Ini->sc_lig_md5["pemeriksaanLab_rj"]) && $this->Ini->sc_lig_md5["pemeriksaanLab_rj"] == "S") {
     $Parms_Lig  = "nostruk*scin" . $this->nmgp_dados_form['strukrj'] . "*scoutNMSC_inicial*scininicio*scoutNMSC_paginacao*scinFULL*scoutNMSC_cab*scinN*scout";
     $Md5_Lig    = "@SC_par@" . $this->form_encode_input($this->Ini->sc_page) . "@SC_par@form_tbdetailok_mob@SC_par@" . md5($Parms_Lig);
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['Lig_Md5'][md5($Parms_Lig)] = $Parms_Lig;
 } else {
     $Md5_Lig  = "nostruk*scin" . $this->nmgp_dados_form['strukrj'] . "*scoutNMSC_inicial*scininicio*scoutNMSC_paginacao*scinFULL*scoutNMSC_cab*scinN*scout";
 }
 $parms_lig_cons = "&nmgp_parms=" . $Md5_Lig;
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_tbdetailok_mob_empty.htm' : $this->Ini->link_pemeriksaanLab_rj_cons . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_session=' . session_id() . '&script_case_detail=Y' . $parms_lig_cons;
...
if (isset($this->Ini->sc_lig_target['C_@scinf_hasilLab']) && 'nmsc_iframe_liga_pemeriksaanLab_rj' != $this->Ini->sc_lig_target['C_@scinf_hasilLab'])
{
    if ('novo' != $this->nmgp_opcao)
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_hasilLab'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['pemeriksaanLab_rj_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
{
?>
<iframe border="0" id="nmsc_iframe_liga_pemeriksaanLab_rj"  marginWidth="0" marginHeight="0" frameborder="0" valign="top" height="100" width="100%" name="nmsc_iframe_liga_pemeriksaanLab_rj"  scrolling="auto" src="<?php echo $sDetailSrc; ?>"></iframe>
<?php
}
?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_tbdetailok_mob");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_tbdetailok_mob");
 parent.scAjaxDetailHeight("form_tbdetailok_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok_mob']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
