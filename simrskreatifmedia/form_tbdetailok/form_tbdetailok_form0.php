...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['embutida_pdf']))
 {
 ?>
...
<?php
include_once("form_tbdetailok_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_tbdetailok_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
?>
...
<?php
 include_once("form_tbdetailok_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_tbdetailok'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_tbdetailok'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['fast_search'][2] : "";
?> 
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['run_iframe'] != "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['run_iframe'] == "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_inapcode_label" id="hidden_field_label_inapcode" style="<?php echo $sStyleHidden_inapcode; ?>"><span id="id_label_inapcode"><?php echo $this->nm_new_label['inapcode']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['php_cmp_required']['inapcode']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['php_cmp_required']['inapcode'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<span id="id_read_on_inapcode" class="sc-ui-readonly-inapcode css_inapcode_line" style="<?php echo $sStyleReadLab_inapcode; ?>"><?php echo $this->inapcode; ?></span><span id="id_read_off_inapcode" class="css_read_off_inapcode" style="white-space: nowrap;<?php echo $sStyleReadInp_inapcode; ?>">
 ...
 size=15 maxlength=15 alt="{datatype: 'text', maxLength: 15, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php
   $Sc_iframe_master = ($this->Embutida_call) ? 'nmgp_iframe_ret*scinnmsc_iframe_liga_form_tbdetailok*scout' : '';
   if (isset($this->Ini->sc_lig_md5["grid_tbadmrawatinap"]) && $this->Ini->sc_lig_md5["grid_tbadmrawatinap"] == "S") {
       ...
       $Md5_Lig    = "@SC_par@" . $this->form_encode_input($this->Ini->sc_page) . "@SC_par@form_tbdetailok@SC_par@" . md5($Parms_Lig);
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['Lig_Md5'][md5($Parms_Lig)] = $Parms_Lig;
   } else {
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_funcroom_label" id="hidden_field_label_funcroom" style="<?php echo $sStyleHidden_funcroom; ?>"><span id="id_label_funcroom"><?php echo $this->nm_new_label['funcroom']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['php_cmp_required']['funcroom']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['php_cmp_required']['funcroom'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_trandate_label" id="hidden_field_label_trandate" style="<?php echo $sStyleHidden_trandate; ?>"><span id="id_label_trandate"><?php echo $this->nm_new_label['trandate']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['php_cmp_required']['trandate']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['php_cmp_required']['trandate'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_strukrj_label" id="hidden_field_label_strukrj" style="<?php echo $sStyleHidden_strukrj; ?>"><span id="id_label_strukrj"><?php echo $this->nm_new_label['strukrj']; ?></span></TD>
    <TD class="scFormDataOdd css_strukrj_line" id="hidden_field_data_strukrj" style="<?php echo $sStyleHidden_strukrj; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_strukrj_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_diagpre_label" id="hidden_field_label_diagpre" style="<?php echo $sStyleHidden_diagpre; ?>"><span id="id_label_diagpre"><?php echo $this->nm_new_label['diagpre']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['php_cmp_required']['diagpre']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['php_cmp_required']['diagpre'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['Lookup_pa'][] = 'Tidak'; ?>
 <option  value="Ya" <?php  if ($this->pa == "Ya") { echo " selected" ;} ?>>Ya</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['Lookup_pa'][] = 'Ya'; ?>
 </select></span>
</span><?php  }?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['Lookup_cito'][] = 'Non Cito'; ?>
 <option  value="Cito Siang" <?php  if ($this->cito == "Cito Siang") { echo " selected" ;} ?>>Cito Siang</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['Lookup_cito'][] = 'Cito Siang'; ?>
 <option  value="Cito Malam" <?php  if ($this->cito == "Cito Malam") { echo " selected" ;} ?>>Cito Malam</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['Lookup_cito'][] = 'Cito Malam'; ?>
 <option  value="Cito Minggu" <?php  if ($this->cito == "Cito Minggu") { echo " selected" ;} ?>>Cito Minggu</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['Lookup_cito'][] = 'Cito Minggu'; ?>
 </select></span>
</span><?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_vc_label" id="hidden_field_label_vc" style="<?php echo $sStyleHidden_vc; ?>"><span id="id_label_vc"><?php echo $this->nm_new_label['vc']; ?></span></TD>
    <TD class="scFormDataOdd css_vc_line" id="hidden_field_data_vc" style="<?php echo $sStyleHidden_vc; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_vc_line" style="vertical-align: top;padding: 0px">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['Lookup_vc'][] = 'Tidak'; ?>
 <option  value="Ya" <?php  if ($this->vc == "Ya") { echo " selected" ;} ?>>Ya</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['Lookup_vc'][] = 'Ya'; ?>
 </select></span>
</span><?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_cultur_label" id="hidden_field_label_cultur" style="<?php echo $sStyleHidden_cultur; ?>"><span id="id_label_cultur"><?php echo $this->nm_new_label['cultur']; ?></span></TD>
    <TD class="scFormDataOdd css_cultur_line" id="hidden_field_data_cultur" style="<?php echo $sStyleHidden_cultur; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_cultur_line" style="vertical-align: top;padding: 0px">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['Lookup_cultur'][] = 'Tidak'; ?>
 <option  value="Ya" <?php  if ($this->cultur == "Ya") { echo " selected" ;} ?>>Ya</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['Lookup_cultur'][] = 'Ya'; ?>
 </select></span>
</span><?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_asa_label" id="hidden_field_label_asa" style="<?php echo $sStyleHidden_asa; ?>"><span id="id_label_asa"><?php echo $this->nm_new_label['asa']; ?></span></TD>
    <TD class="scFormDataOdd css_asa_line" id="hidden_field_data_asa" style="<?php echo $sStyleHidden_asa; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_asa_line" style="vertical-align: top;padding: 0px">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['Lookup_asa'][] = 'ASA I'; ?>
 <option  value="ASA II" <?php  if ($this->asa == "ASA II") { echo " selected" ;} ?>>ASA II</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['Lookup_asa'][] = 'ASA II'; ?>
 <option  value="ASA III" <?php  if ($this->asa == "ASA III") { echo " selected" ;} ?>>ASA III</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['Lookup_asa'][] = 'ASA III'; ?>
 <option  value="ASA IV" <?php  if ($this->asa == "ASA IV") { echo " selected" ;} ?>>ASA IV</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['Lookup_asa'][] = 'ASA IV'; ?>
 <option  value="ASA V" <?php  if ($this->asa == "ASA V") { echo " selected" ;} ?>>ASA V</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['Lookup_asa'][] = 'ASA V'; ?>
 </select></span>
</span><?php  }?>
...
?>
    ...
    <TD class="scFormDataOdd" colspan="8" >&nbsp;</TD>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['Lookup_observasi'][] = '1'; ?>
<?php  if (in_array("1", $this->observasi_1))  { echo " checked" ;} ?> onClick="do_ajax_form_tbdetailok_event_observasi_onclick();" ><span></span>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['Lookup_tindobservasi'][] = ''; ?>
 <option value=""></option>
 <option  value="OBSERVASI" <?php  if ($this->tindobservasi == "OBSERVASI") { echo " selected" ;} ?>>OBSERVASI</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['Lookup_tindobservasi'][] = 'OBSERVASI'; ?>
 </select></span>
</span><?php  }?>
...
<ul class="scTabLine">
<li id="id_tabs_6_6" class="scTabActive"><a href="javascript: sc_control_tabs_6(6)">JASA PENATA</a></li>
<li id="id_tabs_6_7" class="scTabInactive"><a href="javascript: sc_control_tabs_6(7)">OBAT / BHP</a></li>
<li id="id_tabs_6_8" class="scTabInactive"><a href="javascript: sc_control_tabs_6(8)">HASIL LAB</a></li>
</ul>
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_detailInsentif'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_detailInsentif'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['form_tbtim_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_detailInsentif'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['form_tbtim_script_case_init'] = $this->Ini->sc_page;
 }
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['form_tbtim_script_case_init'] ]['form_tbtim']['embutida_proc']  = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['form_tbtim_script_case_init'] ]['form_tbtim']['embutida_form']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['form_tbtim_script_case_init'] ]['form_tbtim']['embutida_call']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['form_tbtim_script_case_init'] ]['form_tbtim']['embutida_multi'] = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['form_tbtim_script_case_init'] ]['form_tbtim']['embutida_liga_form_insert'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['form_tbtim_script_case_init'] ]['form_tbtim']['embutida_liga_form_update'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['form_tbtim_script_case_init'] ]['form_tbtim']['embutida_liga_form_delete'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['form_tbtim_script_case_init'] ]['form_tbtim']['embutida_liga_form_btn_nav'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['form_tbtim_script_case_init'] ]['form_tbtim']['embutida_liga_grid_edit'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['form_tbtim_script_case_init'] ]['form_tbtim']['embutida_liga_grid_edit_link'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['form_tbtim_script_case_init'] ]['form_tbtim']['embutida_liga_qtd_reg'] = '10';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['form_tbtim_script_case_init'] ]['form_tbtim']['embutida_liga_tp_pag'] = 'total';
 ...
 if ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['form_tbtim_script_case_init'] ]['form_tbdetailok']['total'] < 0)
 {
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_tbdetailok_empty.htm' : $this->Ini->link_form_tbtim_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_session=' . session_id() . '&script_case_detail=Y&sc_ifr_height=600';
if (isset($this->Ini->sc_lig_target['C_@scinf_detailInsentif']) && 'nmsc_iframe_liga_form_tbtim' != $this->Ini->sc_lig_target['C_@scinf_detailInsentif'])
{
    ...
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_detailInsentif'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['form_tbtim_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_detailResep'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_detailResep'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['form_tbdetailresepokvk_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_detailResep'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['form_tbdetailresepokvk_script_case_init'] = $this->Ini->sc_page;
 }
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['form_tbdetailresepokvk_script_case_init'] ]['form_tbdetailresepokvk']['embutida_proc']  = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['form_tbdetailresepokvk_script_case_init'] ]['form_tbdetailresepokvk']['embutida_form']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['form_tbdetailresepokvk_script_case_init'] ]['form_tbdetailresepokvk']['embutida_call']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['form_tbdetailresepokvk_script_case_init'] ]['form_tbdetailresepokvk']['embutida_multi'] = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['form_tbdetailresepokvk_script_case_init'] ]['form_tbdetailresepokvk']['embutida_liga_form_insert'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['form_tbdetailresepokvk_script_case_init'] ]['form_tbdetailresepokvk']['embutida_liga_form_update'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['form_tbdetailresepokvk_script_case_init'] ]['form_tbdetailresepokvk']['embutida_liga_form_delete'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['form_tbdetailresepokvk_script_case_init'] ]['form_tbdetailresepokvk']['embutida_liga_form_btn_nav'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['form_tbdetailresepokvk_script_case_init'] ]['form_tbdetailresepokvk']['embutida_liga_grid_edit'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['form_tbdetailresepokvk_script_case_init'] ]['form_tbdetailresepokvk']['embutida_liga_grid_edit_link'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['form_tbdetailresepokvk_script_case_init'] ]['form_tbdetailresepokvk']['embutida_liga_qtd_reg'] = '10';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['form_tbdetailresepokvk_script_case_init'] ]['form_tbdetailresepokvk']['embutida_liga_tp_pag'] = 'total';
 ...
 if ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['form_tbdetailresepokvk_script_case_init'] ]['form_tbdetailok']['total'] < 0)
 {
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_tbdetailok_empty.htm' : $this->Ini->link_form_tbdetailresepokvk_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_session=' . session_id() . '&script_case_detail=Y&sc_ifr_height=500';
if (isset($this->Ini->sc_lig_target['C_@scinf_detailResep']) && 'nmsc_iframe_liga_form_tbdetailresepokvk' != $this->Ini->sc_lig_target['C_@scinf_detailResep'])
{
    if ('novo' != $this->nmgp_opcao)
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_detailResep'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['form_tbdetailresepokvk_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_hasilLab'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_hasilLab'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['pemeriksaanLab_rj_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_hasilLab'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['pemeriksaanLab_rj_script_case_init'] = $this->Ini->sc_page;
 }
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_tbdetailok_empty.htm' : $this->Ini->link_pemeriksaanLab_rj_cons . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_session=' . session_id() . '&script_case_detail=Y' . $parms_lig_cons;
if (isset($this->Ini->sc_lig_target['C_@scinf_hasilLab']) && 'nmsc_iframe_liga_pemeriksaanLab_rj' != $this->Ini->sc_lig_target['C_@scinf_hasilLab'])
{
    if ('novo' != $this->nmgp_opcao)
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_hasilLab'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['pemeriksaanLab_rj_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<?php
  ...
  $nm_sc_blocos_aba    = array(6 => 6,7 => 6,8 => 6);
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_tbdetailok");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_tbdetailok");
 parent.scAjaxDetailHeight("form_tbdetailok", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailok']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
