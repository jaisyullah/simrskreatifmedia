  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbhrdstatus" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbhrdstatus_form();
	}

  // ---------- Validate status_
  function do_ajax_form_tbhrdstatus_validate_status_(iNumLinha)
  {
    var nomeCampo_status_ = "status_" + iNumLinha;
    var var_status_ = scAjaxGetFieldSelect(nomeCampo_status_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbhrdstatus_validate_status_(var_status_, iNumLinha, var_script_case_init, do_ajax_form_tbhrdstatus_validate_status__cb);
  } // do_ajax_form_tbhrdstatus_validate_status_

  function do_ajax_form_tbhrdstatus_validate_status__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbhrdstatus_validate_status__cb

  // ---------- Validate tglstatus_
  function do_ajax_form_tbhrdstatus_validate_tglstatus_(iNumLinha)
  {
    var nomeCampo_tglstatus_ = "tglstatus_" + iNumLinha;
    var var_tglstatus_ = scAjaxGetFieldText(nomeCampo_tglstatus_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbhrdstatus_validate_tglstatus_(var_tglstatus_, iNumLinha, var_script_case_init, do_ajax_form_tbhrdstatus_validate_tglstatus__cb);
  } // do_ajax_form_tbhrdstatus_validate_tglstatus_

  function do_ajax_form_tbhrdstatus_validate_tglstatus__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "tglstatus_" + iLineNumber;
    }
    else
    {
      sFieldValid = "tglstatus_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "tglstatus_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "tglstatus_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbhrdstatus_validate_tglstatus__cb

  // ---------- Validate kodekary_
  function do_ajax_form_tbhrdstatus_validate_kodekary_(iNumLinha)
  {
    var nomeCampo_kodekary_ = "kodekary_" + iNumLinha;
    var var_kodekary_ = scAjaxGetFieldText(nomeCampo_kodekary_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbhrdstatus_validate_kodekary_(var_kodekary_, iNumLinha, var_script_case_init, do_ajax_form_tbhrdstatus_validate_kodekary__cb);
  } // do_ajax_form_tbhrdstatus_validate_kodekary_

  function do_ajax_form_tbhrdstatus_validate_kodekary__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbhrdstatus_validate_kodekary__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_tbhrdstatus_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_tbhrdstatus_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tbhrdstatus_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_tbhrdstatus_add_new_line_cb);
  } // do_ajax_form_tbhrdstatus_add_new_line

  function do_ajax_form_tbhrdstatus_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_tbhrdstatus_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_tbhrdstatus_backup_line(iNumLinha)
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbhrdstatus_backup_line(var_kodekary_, var_status_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_tbhrdstatus_backup_line_cb);
  } // do_ajax_form_tbhrdstatus_backup_line

  function do_ajax_form_tbhrdstatus_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_tbhrdstatus_backup_line_cb

  function do_ajax_form_tbhrdstatus_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_tbhrdstatus_cancel_insert

  function do_ajax_form_tbhrdstatus_cancel_update(iSeqVert)
  {
    do_ajax_form_tbhrdstatus_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_tbhrdstatus_cancel_update

  function do_ajax_form_tbhrdstatus_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_tbhrdstatus_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_tbhrdstatus_table_refresh()
  {
    var var_kodekary_ = document.F2.kodekary_.value;
    var var_status_ = document.F2.status_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_tbhrdstatus_table_refresh(var_kodekary_, var_status_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbhrdstatus_table_refresh_cb);
  } //  do_ajax_form_tbhrdstatus_table_refresh

  function do_ajax_form_tbhrdstatus_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.status_.value = scAjaxGetKeyValue("status_");
    ...
    scAjaxAlert(do_ajax_form_tbhrdstatus_table_refresh_cb_after_alert);
  } // do_ajax_form_tbhrdstatus_table_refresh_cb
  function do_ajax_form_tbhrdstatus_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxSetNavStatus("t");
    sc_insert_open = false;
  } // do_ajax_form_tbhrdstatus_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_tbhrdstatus_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_tbhrdstatus_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_status_ = scAjaxGetFieldSelect("status_" + iNumLinha);
    var var_tglstatus_ = scAjaxGetFieldText("tglstatus_" + iNumLinha);
    var var_kodekary_ = scAjaxGetFieldText("kodekary_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_tbhrdstatus_submit_form(var_status_, var_tglstatus_, var_kodekary_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbhrdstatus_submit_form_cb);
  } // do_ajax_form_tbhrdstatus_submit_form

  function do_ajax_form_tbhrdstatus_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("tglstatus_" + sc_num_ult_line);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_tbhrdstatus_submit_form_cb_after_alert);
  } // do_ajax_form_tbhrdstatus_submit_form_cb
  function do_ajax_form_tbhrdstatus_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbhrdstatus_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tbhrdstatus_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_tbhrdstatus_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("tglstatus_" + iNavForm);
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tbhrdstatus_navigate_form(var_kodekary_, var_status_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbhrdstatus_navigate_form_cb);
  } // do_ajax_form_tbhrdstatus_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrdstatus']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbhrdstatus_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.status_.value = scAjaxGetKeyValue("status_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbhrdstatus_navigate_form_cb_after_alert);
  } // do_ajax_form_tbhrdstatus_navigate_form_cb
  function do_ajax_form_tbhrdstatus_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_tbhrdstatus_navigate_form_cb_after_alert
  function sc_hide_form_tbhrdstatus_form()
  {
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "tglstatus_" + iNumLinha;
    iTotCampos++;
    ...
    ajax_error_list["tglstatus_" + iNumLinha] = {"label": "Periode / Tanggal<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_field_mult["tglstatus_"][iNumLinha] = "tglstatus_" + iNumLinha;
    ...
    ajax_field_id["tglstatus_" + iNumLinha] = new Array("hidden_field_label_tglstatus_", "hidden_field_data_tglstatus_" + iNumLinha);
    ajax_error_count["status_" + iNumLinha] = "off";
    ajax_error_count["tglstatus_" + iNumLinha] = "off";
...
?>
    ...
    ajax_read_only["tglstatus_" + iNumLinha] = "off";
...
?>
    ajax_read_only["status_" + iNumLinha] = "on";
    ajax_read_only["tglstatus_" + iNumLinha] = "on";
    ajax_read_only["kodekary_" + iNumLinha] = "on";
<?php
}
?>
  ...
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["tglstatus_" + iNumLinha] = null;
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["tglstatus_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["tglstatus_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["tglstatus_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["tglstatus_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["tglstatus_" + iNumLinha]["onfocus"] = new Array();
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['status_'])) ? $this->nmgp_cmp_readonly['status_'] : 'on';
?>
    scAjaxFieldRead("status_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['tglstatus_'])) ? $this->nmgp_cmp_readonly['tglstatus_'] : 'off';
?>
    scAjaxFieldRead("tglstatus_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
?>
  ...
  function mdCloseObjects(iSeq)
  {
    ...
    scAjaxFieldRead("tglstatus_" + iSeq, "on");
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["status_" + iRow] || "on" == ajax_error_count["tglstatus_" + iRow] || "on" == ajax_error_count["kodekary_" + iRow]))
    {
      ...
      $("#hidden_field_data_tglstatus_" + iRow).addClass("scFormErrorLine");
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["status_" + iRow] && "off" == ajax_error_count["tglstatus_" + iRow] && "off" == ajax_error_count["kodekary_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["status_" + iRow] = "off";
        ajax_error_count["tglstatus_" + iRow] = "off";
      ...
      $("#hidden_field_data_tglstatus_" + iRow).removeClass("scFormErrorLine");
