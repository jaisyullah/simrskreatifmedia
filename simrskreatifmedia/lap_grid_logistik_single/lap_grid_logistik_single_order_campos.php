<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['lap_grid_logistik_single']['glo_nm_path_imag_temp'] . "/sc_apl_default_simrskreatifmedia.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new lap_grid_logistik_single_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class lap_grid_logistik_single_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['lap_grid_logistik_single']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['lap_grid_logistik_single']['ordem_select_orig'] = array();
   }
   ...
   {
       $tab_def_campos['sc_field_5'] = "b.orderDate";
   }
   $tab_labels["sc_field_5"]   = (isset($_SESSION['sc_session'][$sc_init]['lap_grid_logistik_single']['labels']["sc_field_5"])) ? $_SESSION['sc_session'][$sc_init]['lap_grid_logistik_single']['labels']["sc_field_5"] : "Tgl Pesan";
   ...
   {
       $tab_def_campos['item'] = "a.item";
   }
   $tab_labels["item"]   = (isset($_SESSION['sc_session'][$sc_init]['lap_grid_logistik_single']['labels']["item"])) ? $_SESSION['sc_session'][$sc_init]['lap_grid_logistik_single']['labels']["item"] : "Item";
   $tab_ger_campos['po'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['po'] = "po";
   }
   else
   {
       $tab_def_campos['po'] = "a.po";
   }
   $tab_labels["po"]   = (isset($_SESSION['sc_session'][$sc_init]['lap_grid_logistik_single']['labels']["po"])) ? $_SESSION['sc_session'][$sc_init]['lap_grid_logistik_single']['labels']["po"] : "PO";
   $tab_ger_campos['pbf'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['pbf'] = "pbf";
   }
   else
   {
       $tab_def_campos['pbf'] = "b.pbf";
   }
   $tab_labels["pbf"]   = (isset($_SESSION['sc_session'][$sc_init]['lap_grid_logistik_single']['labels']["pbf"])) ? $_SESSION['sc_session'][$sc_init]['lap_grid_logistik_single']['labels']["pbf"] : "PBF";
   ...
   {
       $tab_def_campos['sc_field_0'] = "b.non_pbf";
   }
   $tab_labels["sc_field_0"]   = (isset($_SESSION['sc_session'][$sc_init]['lap_grid_logistik_single']['labels']["sc_field_0"])) ? $_SESSION['sc_session'][$sc_init]['lap_grid_logistik_single']['labels']["sc_field_0"] : "Non PBF";
   $tab_ger_campos['jml'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['jml'] = "jml";
   }
   else
   {
       $tab_def_campos['jml'] = "a.jumlah";
   }
   $tab_labels["jml"]   = (isset($_SESSION['sc_session'][$sc_init]['lap_grid_logistik_single']['labels']["jml"])) ? $_SESSION['sc_session'][$sc_init]['lap_grid_logistik_single']['labels']["jml"] : "Jumlah";
   $tab_ger_campos['kemasan'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['kemasan'] = "kemasan";
   }
   else
   {
       $tab_def_campos['kemasan'] = "a.kemasan";
   }
   $tab_labels["kemasan"]   = (isset($_SESSION['sc_session'][$sc_init]['lap_grid_logistik_single']['labels']["kemasan"])) ? $_SESSION['sc_session'][$sc_init]['lap_grid_logistik_single']['labels']["kemasan"] : "Kemasan";
   $tab_ger_campos['isi'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['isi'] = "isi";
   }
   else
   {
       $tab_def_campos['isi'] = "a.isi";
   }
   $tab_labels["isi"]   = (isset($_SESSION['sc_session'][$sc_init]['lap_grid_logistik_single']['labels']["isi"])) ? $_SESSION['sc_session'][$sc_init]['lap_grid_logistik_single']['labels']["isi"] : "Isi";
   $tab_ger_campos['hrg'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['hrg'] = "hrg";
   }
   else
   {
       $tab_def_campos['hrg'] = "a.harga";
   }
   $tab_labels["hrg"]   = (isset($_SESSION['sc_session'][$sc_init]['lap_grid_logistik_single']['labels']["hrg"])) ? $_SESSION['sc_session'][$sc_init]['lap_grid_logistik_single']['labels']["hrg"] : "Harga";
   ...
   {
       $tab_def_campos['sc_field_2'] = "a.hargaTerima";
   }
   $tab_labels["sc_field_2"]   = (isset($_SESSION['sc_session'][$sc_init]['lap_grid_logistik_single']['labels']["sc_field_2"])) ? $_SESSION['sc_session'][$sc_init]['lap_grid_logistik_single']['labels']["sc_field_2"] : "Hrg Terima";
   $tab_ger_campos['disc'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['disc'] = "disc";
   }
   else
   {
       $tab_def_campos['disc'] = "a.disc";
   }
   $tab_labels["disc"]   = (isset($_SESSION['sc_session'][$sc_init]['lap_grid_logistik_single']['labels']["disc"])) ? $_SESSION['sc_session'][$sc_init]['lap_grid_logistik_single']['labels']["disc"] : "Disc";
   ...
   $tab_labels["sc_field_7"]   = (isset($_SESSION['sc_session'][$sc_init]['lap_grid_logistik_single']['labels']["sc_field_7"])) ? $_SESSION['sc_session'][$sc_init]['lap_grid_logistik_single']['labels']["sc_field_7"] : "Harga Disc";
   ...
   $tab_labels["sc_field_8"]   = (isset($_SESSION['sc_session'][$sc_init]['lap_grid_logistik_single']['labels']["sc_field_8"])) ? $_SESSION['sc_session'][$sc_init]['lap_grid_logistik_single']['labels']["sc_field_8"] : "Subtotal Harga";
   $tab_ger_campos['b_status'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['b_status'] = "b_status";
   }
   else
   {
       $tab_def_campos['b_status'] = "b.`status`";
   }
   $tab_labels["b_status"]   = (isset($_SESSION['sc_session'][$sc_init]['lap_grid_logistik_single']['labels']["b_status"])) ? $_SESSION['sc_session'][$sc_init]['lap_grid_logistik_single']['labels']["b_status"] : "Status";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['lap_grid_logistik_single']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['lap_grid_logistik_single']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['lap_grid_logistik_single']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['lap_grid_logistik_single']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['lap_grid_logistik_single']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['lap_grid_logistik_single']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['lap_grid_logistik_single']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['lap_grid_logistik_single']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['lap_grid_logistik_single']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "lap_grid_logistik_single_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['lap_grid_logistik_single']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['lap_grid_logistik_single']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['lap_grid_logistik_single']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['lap_grid_logistik_single']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['lap_grid_logistik_single']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
