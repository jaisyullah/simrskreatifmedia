...
class lap_grid_logistik_single_total
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function __construct($sc_page)
   {
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['lap_grid_logistik_single']['campos_busca']) && !empty($_SESSION['sc_session'][$this->sc_page]['lap_grid_logistik_single']['campos_busca']))
      { 
   ...
   {
      global $nada, $nm_lang , $item, $pbf;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['lap_grid_logistik_single']['contr_total_geral'] == "OK") 
      { 
          return; 
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['lap_grid_logistik_single']['tot_geral'] = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
          $nm_comando = "select count(*) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['lap_grid_logistik_single']['where_pesq']; 
      } 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['lap_grid_logistik_single']['tot_geral'][0] = "" . $this->Ini->Nm_lang['lang_msgs_totl'] . ""; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['lap_grid_logistik_single']['tot_geral'][1] = $rt->fields[0] ; 
      $rt->Close(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['lap_grid_logistik_single']['contr_total_geral'] = "OK";
   } 

   //-----  item
   function quebra_item_Item($item, $arg_sum_item) 
   {
      global $tot_item, $item, $pbf;
      $tot_item = array() ;  
      $tot_item[0] = $item ; 
   }
   ...
   {
      global $nm_lang, $sc_field_7, $sc_field_8, $item, $pbf;
      $this->nm_data = new nm_data("id");
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['lap_grid_logistik_single']['sql_tot_res']);
      ...
      $ind_qb                = $_SESSION['sc_session'][$this->Ini->sc_page]['lap_grid_logistik_single']['SC_Ind_Groupby'];
      $cmp_sql_def   = array('item' => "a.item");
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['lap_grid_logistik_single']['arr_total'] = array();
      foreach ($cmps_quebra_atual as $cmp_gb)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $_SESSION['sc_session'][$this->Ini->sc_page]['lap_grid_logistik_single']['arr_total'][$cmp_gb] = $this->$Arr_tot_name;
      }
   }
   ...
   function Res_Totaliza_Item($ind_qb, $cmp_tot, $arr_tots, $group, $join, $cmps_quebras, $cmps_quebras1, $cmps_quebras2, $cmps_quebrasS, $Cmp_dim, $cmps_quebra_atual, $cmp_sql_def)
   {
      ...
      $cmp_sql_tp_num = array('a_id' => 'N','jml' => 'N','hrg' => 'N','disc' => 'N','sc_field_1' => 'N','sc_field_2' => 'N','isi' => 'N','sc_field_7' => 'N','sc_field_8' => 'N');
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['lap_grid_logistik_single']['sql_tot_res']))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['lap_grid_logistik_single']['sql_tot_res'] = str_replace("#@#cmps_quebras#@#", "", $comando);
      }
      $comando  = str_replace("#@#cmps_quebras#@#", "," . $cmps_quebras, $comando);
      $comando .= " group by " . $cmps_quebras . " order by " .  $cmps_quebras;
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['lap_grid_logistik_single']['Res_search_metric_use']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['lap_grid_logistik_single']['Res_search_metric_use']))
      {
          $comando = $cmd_simp;
          $cmps_S  = "";
