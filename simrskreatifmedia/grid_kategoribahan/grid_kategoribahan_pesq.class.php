...
class grid_kategoribahan_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kategoribahan']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_kategoribahan_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_kategoribahan_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_kategoribahan_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_kategoricode')
      {
          $kategoricode = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_kategoricode($kategoricode);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_namakategori')
      {
          $namakategori = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_namakategori($namakategori);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function lookup_ajax_kategoricode($kategoricode)
   {
      $kategoricode = substr($this->Db->qstr($kategoricode), 1, -1);
            $kategoricode_look = substr($this->Db->qstr($kategoricode), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct kategoricode from " . $this->Ini->nm_tabela . " where  kategoricode like '%" . $kategoricode . "%' order by kategoricode"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
   ...
   function lookup_ajax_namakategori($namakategori)
   {
      $namakategori = substr($this->Db->qstr($namakategori), 1, -1);
            $namakategori_look = substr($this->Db->qstr($namakategori), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct namakategori from " . $this->Ini->nm_tabela . " where  namakategori like '%" . $namakategori . "%' order by namakategori"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kategoribahan']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kategoribahan']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kategoribahan']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kategoribahan']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kategoribahan']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kategoribahan']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kategoribahan']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kategoribahan']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kategoribahan']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kategoribahan']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kategoribahan']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kategoribahan']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kategoribahan']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kategoribahan']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kategoribahan']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - kategoribahan</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_kategoribahan/grid_kategoribahan_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_kategoribahan_ajax_search.js"></script>
 <script type="text/javascript" src="grid_kategoribahan_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_kategoribahan_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_kategoribahan']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_kategoribahan']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_kategoricode_cond#NMF#' + search_get_sel_txt('SC_kategoricode_cond') + '@NMF@';
  str_out += 'SC_kategoricode#NMF#' + search_get_text('SC_kategoricode') + '@NMF@';
  str_out += 'id_ac_kategoricode#NMF#' + search_get_text('id_ac_kategoricode') + '@NMF@';
  str_out += 'SC_namakategori_cond#NMF#' + search_get_sel_txt('SC_namakategori_cond') + '@NMF@';
  str_out += 'SC_namakategori#NMF#' + search_get_text('SC_namakategori') + '@NMF@';
  str_out += 'id_ac_namakategori#NMF#' + search_get_text('id_ac_namakategori') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
   $("#id_ac_kategoricode").autocomplete({
     minLength: 1,
     ...
     $.ajax({
       ...
       data: {
          ...
          nmgp_parms: "NM_ajax_opcao?#?autocomp_kategoricode",
          max_itens: "10",
          cod_desc: "N",
     ...
     select: function (event, ui) {
       $("#SC_kategoricode").val(ui.item.value);
     ...
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_kategoricode").val( $(this).val() );
       }
     }
   });
   $("#id_ac_namakategori").autocomplete({
     minLength: 1,
     source: function (request, response) {
     $.ajax({
       url: "index.php",
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_namakategori",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_namakategori").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     focus: function (event, ui) {
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kategoribahan']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div class="scFilterHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFilterHeaderFont" style="float: left; text-transform: uppercase;"><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - kategoribahan</div>
...
<?php
   ...
   function monta_form()
   {
      global 
             ...
             $kategoricode_cond, $kategoricode, $kategoricode_autocomp,
             $namakategori_cond, $namakategori, $namakategori_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kategoribahan']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kategoribahan']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kategoribahan']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kategoribahan']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $keterangan = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kategoribahan']['campos_busca']['keterangan']; 
          $keterangan_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kategoribahan']['campos_busca']['keterangan_cond']; 
          $id = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kategoribahan']['campos_busca']['id']; 
          $id_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kategoribahan']['campos_busca']['id_cond']; 
          $kategoricode = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kategoribahan']['campos_busca']['kategoricode']; 
          $kategoricode_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kategoribahan']['campos_busca']['kategoricode_cond']; 
          $namakategori = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kategoribahan']['campos_busca']['namakategori']; 
          $namakategori_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kategoribahan']['campos_busca']['namakategori_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kategoribahan']['campos_busca']['NM_operador']; 
      } 
      ...
      if (!isset($kategoricode_cond) || empty($kategoricode_cond))
      {
         $kategoricode_cond = "qp";
      }
      if (!isset($namakategori_cond) || empty($namakategori_cond))
      {
         $namakategori_cond = "qp";
      }
      ...
      $str_hide_kategoricode = (in_array($kategoricode_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_namakategori = (in_array($namakategori_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      if (!isset($kategoricode) || $kategoricode == "")
      {
          $kategoricode = "";
      }
      if (isset($kategoricode) && !empty($kategoricode))
      {
         $tmp_pos = strpos($kategoricode, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $kategoricode = substr($kategoricode, 0, $tmp_pos);
         }
      }
      if (!isset($namakategori) || $namakategori == "")
      {
          $namakategori = "";
      }
      if (isset($namakategori) && !empty($namakategori))
      {
         $tmp_pos = strpos($namakategori, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $namakategori = substr($namakategori, 0, $tmp_pos);
         }
      }
?>
 <TR align="center">
...
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_id" name="id_autocomp" size="5"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 5, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
      ...
      <TD id='SC_kategoricode_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['kategoricode'])) ? $this->New_label['kategoricode'] : "Kategoricode"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_kategoricode_cond" name="kategoricode_cond" onChange="nm_campos_between(document.getElementById('id_vis_kategoricode'), this, 'kategoricode')">
       <OPTION value="qp" <?php if ("qp" == $kategoricode_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $kategoricode_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $kategoricode_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $kategoricode_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_kategoricode" <?php echo $str_hide_kategoricode?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['kategoricode'])) ? $this->New_label['kategoricode'] : "Kategoricode";
 $nmgp_tab_label .= "kategoricode?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      $kategoricode_look = substr($this->Db->qstr($kategoricode), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct kategoricode from " . $this->Ini->nm_tabela . " where kategoricode = '$kategoricode_look' order by kategoricode"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      if (isset($nmgp_def_dados[0][$kategoricode]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$kategoricode];
      }
      else
      {
          $sAutocompValue = $kategoricode;
      }
?>
<INPUT  type="text" id="SC_kategoricode" name="kategoricode" value="<?php echo NM_encode_input($kategoricode) ?>"  size=15 alt="{datatype: 'text', maxLength: 15, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_kategoricode" name="kategoricode_autocomp" size="15"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 15, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_namakategori_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['namakategori'])) ? $this->New_label['namakategori'] : "Namakategori"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_namakategori_cond" name="namakategori_cond" onChange="nm_campos_between(document.getElementById('id_vis_namakategori'), this, 'namakategori')">
       <OPTION value="qp" <?php if ("qp" == $namakategori_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $namakategori_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $namakategori_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $namakategori_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_namakategori" <?php echo $str_hide_namakategori?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['namakategori'])) ? $this->New_label['namakategori'] : "Namakategori";
 $nmgp_tab_label .= "namakategori?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      $namakategori_look = substr($this->Db->qstr($namakategori), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct namakategori from " . $this->Ini->nm_tabela . " where namakategori = '$namakategori_look' order by namakategori"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      if (isset($nmgp_def_dados[0][$namakategori]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$namakategori];
      }
      else
      {
          $sAutocompValue = $namakategori;
      }
?>
<INPUT  type="text" id="SC_namakategori" name="namakategori" value="<?php echo NM_encode_input($namakategori) ?>"  size=50 alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_namakategori" name="namakategori_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
?>
<?php
   if (is_file("grid_kategoribahan_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_kategoribahan']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_kategoribahan']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kategoribahan']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.kategoricode_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_kategoricode'), document.F1.kategoricode_cond, 'kategoricode');
   document.F1.kategoricode.value = "";
   document.F1.kategoricode_autocomp.value = "";
   document.F1.namakategori_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_namakategori'), document.F1.namakategori_cond, 'namakategori');
   document.F1.namakategori.value = "";
   document.F1.namakategori_autocomp.value = "";
 }
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "simrskreatifmedia/grid_kategoribahan";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kategoribahan']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kategoribahan']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kategoribahan']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_kategoricode_cond'] = 'cond';
      $tp_fields['SC_kategoricode'] = 'text_aut';
      $tp_fields['id_ac_kategoricode'] = 'text_aut';
      $tp_fields['SC_namakategori_cond'] = 'cond';
      $tp_fields['SC_namakategori'] = 'text_aut';
      $tp_fields['id_ac_namakategori'] = 'text_aut';
   ...
   function trata_campos()
   {
      global $keterangan_cond, $keterangan, $keterangan_autocomp,
             $id_cond, $id, $id_autocomp,
             $kategoricode_cond, $kategoricode, $kategoricode_autocomp,
             $namakategori_cond, $namakategori, $namakategori_autocomp, $nmgp_tab_label;
      ...
      if (!empty($kategoricode_autocomp) && empty($kategoricode))
      {
          $kategoricode = $kategoricode_autocomp;
      }
      if (!empty($namakategori_autocomp) && empty($namakategori))
      {
          $namakategori = $namakategori_autocomp;
      }
      ...
      $kategoricode_cond_salva = $kategoricode_cond; 
      if (!isset($kategoricode_input_2) || $kategoricode_input_2 == "")
      {
          $kategoricode_input_2 = $kategoricode;
      }
      $namakategori_cond_salva = $namakategori_cond; 
      if (!isset($namakategori_input_2) || $namakategori_input_2 == "")
      {
          $namakategori_input_2 = $namakategori;
      }
      if ($id_cond != "in")
      {
          nm_limpa_numero($id, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kategoribahan']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kategoribahan']['campos_busca']['keterangan'] = $keterangan; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kategoribahan']['campos_busca']['keterangan_cond'] = $keterangan_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kategoribahan']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kategoribahan']['campos_busca']['id'] = $id; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kategoribahan']['campos_busca']['id_cond'] = $id_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kategoribahan']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kategoribahan']['campos_busca']['kategoricode'] = $kategoricode; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kategoribahan']['campos_busca']['kategoricode_cond'] = $kategoricode_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kategoribahan']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kategoribahan']['campos_busca']['namakategori'] = $namakategori; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kategoribahan']['campos_busca']['namakategori_cond'] = $namakategori_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kategoribahan']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kategoribahan']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kategoribahan']['campos_busca'] = $Temp_Busca;
      }
   ...
   { 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['kategoricode'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['kategoricode'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['kategoricode'] = $kategoricode;
      }
      $namakategori_look = substr($this->Db->qstr($namakategori), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct namakategori from " . $this->Ini->nm_tabela . " where namakategori = '$namakategori_look' order by namakategori"; 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['namakategori'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['namakategori'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['namakategori'] = $namakategori;
      }
      ...
      //----- $kategoricode
      $this->Date_part = false;
      if (isset($kategoricode) || $kategoricode_cond == "nu" || $kategoricode_cond == "nn" || $kategoricode_cond == "ep" || $kategoricode_cond == "ne")
      {
         $this->monta_condicao("kategoricode", $kategoricode_cond, $kategoricode, "", "kategoricode");
      }

      //----- $namakategori
      $this->Date_part = false;
      if (isset($namakategori) || $namakategori_cond == "nu" || $namakategori_cond == "nn" || $namakategori_cond == "ep" || $namakategori_cond == "ne")
      {
         $this->monta_condicao("namakategori", $namakategori_cond, $namakategori, "", "namakategori");
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kategoribahan']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kategoribahan']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kategoribahan']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kategoribahan']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kategoribahan']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kategoribahan']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kategoribahan']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kategoribahan']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kategoribahan']['cond_pesq'] .= $this->NM_operador;
