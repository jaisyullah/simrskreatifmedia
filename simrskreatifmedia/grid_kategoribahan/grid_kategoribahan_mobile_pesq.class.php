...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_kategoricode_cond" name="kategoricode_cond" onChange="nm_campos_between(document.getElementById('id_vis_kategoricode'), this, 'kategoricode')">
      ...
      <br><span id="id_hide_kategoricode"  <?php echo $str_hide_kategoricode?>><?php
      if ($kategoricode != "")
      {
      $kategoricode_look = substr($this->Db->qstr($kategoricode), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_namakategori_cond" name="namakategori_cond" onChange="nm_campos_between(document.getElementById('id_vis_namakategori'), this, 'namakategori')">
      ...
      <br><span id="id_hide_namakategori"  <?php echo $str_hide_namakategori?>><?php
      if ($namakategori != "")
      {
      $namakategori_look = substr($this->Db->qstr($namakategori), 1, -1); 
      $nmgp_def_dados = array(); 
