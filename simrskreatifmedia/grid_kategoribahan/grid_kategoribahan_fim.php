...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_kategoribahan"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_kategoribahan"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_kategoribahan'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_kategoribahan']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_kategoribahan']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_kategoribahan']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_kategoribahan']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_kategoribahan']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_kategoribahan</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_kategoribahan']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_kategoribahan']['embutida_filho'] as $ind => $sc_init)
          {
