<?php
   include_once('chart_lab_hitung_session.php');
   @session_start() ;
   $_SESSION['scriptcase']['chart_lab_hitung']['glo_nm_perfil']          = "conn_mysql";
   $_SESSION['scriptcase']['chart_lab_hitung']['glo_nm_path_prod']       = "";
   $_SESSION['scriptcase']['chart_lab_hitung']['glo_nm_path_conf']       = "";
   $_SESSION['scriptcase']['chart_lab_hitung']['glo_nm_path_imagens']    = "";
   $_SESSION['scriptcase']['chart_lab_hitung']['glo_nm_path_imag_temp']  = "";
   $_SESSION['scriptcase']['chart_lab_hitung']['glo_nm_path_doc']        = "";
    ...
    //check prod
    if(empty($_SESSION['scriptcase']['chart_lab_hitung']['glo_nm_path_prod']))
    {
            /*check prod*/$_SESSION['scriptcase']['chart_lab_hitung']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
    }
    //check img
    if(empty($_SESSION['scriptcase']['chart_lab_hitung']['glo_nm_path_imagens']))
    {
            /*check img*/$_SESSION['scriptcase']['chart_lab_hitung']['glo_nm_path_imagens'] = $str_path_apl_url . "_lib/file/img";
    }
    //check tmp
    if(empty($_SESSION['scriptcase']['chart_lab_hitung']['glo_nm_path_imag_temp']))
    {
            /*check tmp*/$_SESSION['scriptcase']['chart_lab_hitung']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
    }
    //check doc
    if(empty($_SESSION['scriptcase']['chart_lab_hitung']['glo_nm_path_doc']))
    {
            /*check doc*/$_SESSION['scriptcase']['chart_lab_hitung']['glo_nm_path_doc'] = $str_path_apl_dir . "_lib/file/doc";
    }
    //end check publication with the prod
//
class chart_lab_hitung_ini
{
   var $nm_cod_apl;
   var $nm_nome_apl;
   var $nm_seguranca;
...
//
   function init($Tp_init = "")
   {
      ...
      $_SESSION['sc_session'][$this->sc_page]['chart_lab_hitung']['decimal_db'] = "."; 
      $this->nm_cod_apl      = "chart_lab_hitung"; 
      $this->nm_nome_apl     = ""; 
      $this->nm_seguranca    = ""; 
...
// 
      ...
      $this->sc_protocolo    = "";
      $this->path_prod       = $_SESSION['scriptcase']['chart_lab_hitung']['glo_nm_path_prod'];
      $this->path_conf       = $_SESSION['scriptcase']['chart_lab_hitung']['glo_nm_path_conf'];
      $this->path_imagens    = $_SESSION['scriptcase']['chart_lab_hitung']['glo_nm_path_imagens'];
      $this->path_imag_temp  = $_SESSION['scriptcase']['chart_lab_hitung']['glo_nm_path_imag_temp'];
      $this->path_doc        = $_SESSION['scriptcase']['chart_lab_hitung']['glo_nm_path_doc'];
      ...
      $this->path_aplicacao  = substr($this->path_aplicacao, 0, strrpos($this->path_aplicacao, '/')) . '/chart_lab_hitung';
      ...
      if (isset($_SESSION['scriptcase']['chart_lab_hitung']['session_timeout']['lang'])) {
          $this->str_lang = $_SESSION['scriptcase']['chart_lab_hitung']['session_timeout']['lang'];
      }
      elseif (!isset($_SESSION['scriptcase']['chart_lab_hitung']['actual_lang']) || $_SESSION['scriptcase']['chart_lab_hitung']['actual_lang'] != $this->str_lang) {
          $_SESSION['scriptcase']['chart_lab_hitung']['actual_lang'] = $this->str_lang;
      ...
      {
          include_once("chart_lab_hitung_json.php");
      }
      $this->SC_Link_View = (isset($_SESSION['sc_session'][$this->sc_page]['chart_lab_hitung']['SC_Link_View'])) ? $_SESSION['sc_session'][$this->sc_page]['chart_lab_hitung']['SC_Link_View'] : false;
      if (isset($_GET['SC_Link_View']) && !empty($_GET['SC_Link_View']) && is_numeric($_GET['SC_Link_View']))
      {
          if ($_SESSION['sc_session'][$this->sc_page]['chart_lab_hitung']['embutida'])
          {
              $this->SC_Link_View = true;
              $_SESSION['sc_session'][$this->sc_page]['chart_lab_hitung']['SC_Link_View'] = true;
          }
      }
    if (!$_SESSION['sc_session'][$this->sc_page]['chart_lab_hitung']['embutida'])
    {
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['chart_lab_hitung']['grid_search_add']['cmp'] = $_POST['parm'];
          $_SESSION['sc_session'][$this->sc_page]['chart_lab_hitung']['grid_search_add']['seq'] = $_POST['seq'];
          $_SESSION['sc_session'][$this->sc_page]['chart_lab_hitung']['opcao'] = $_POST['origem'];
          $nmgp_opcao = $_POST['origem'];
      }
    }
      if (isset($_POST['nmgp_opcao']) && $_POST['nmgp_opcao'] == "ajax_save_ancor")
      {
          $_SESSION['sc_session'][$this->sc_page]['chart_lab_hitung']['ancor_save'] = $_POST['ancor_save'];
...
<?php
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['chart_lab_hitung']['dashboard_info']['under_dashboard']))
      {
          $_SESSION['sc_session'][$this->sc_page]['chart_lab_hitung']['dashboard_info']['under_dashboard'] = false;
          $_SESSION['sc_session'][$this->sc_page]['chart_lab_hitung']['dashboard_info']['dashboard_app']   = '';
          $_SESSION['sc_session'][$this->sc_page]['chart_lab_hitung']['dashboard_info']['own_widget']      = '';
          $_SESSION['sc_session'][$this->sc_page]['chart_lab_hitung']['dashboard_info']['parent_widget']   = '';
          $_SESSION['sc_session'][$this->sc_page]['chart_lab_hitung']['dashboard_info']['compact_mode']    = false;
          $_SESSION['sc_session'][$this->sc_page]['chart_lab_hitung']['dashboard_info']['remove_margin']   = false;
      }
      if (isset($_GET['under_dashboard']) && 1 == $_GET['under_dashboard'])
      {
          if (isset($_GET['own_widget']) && 'dbifrm_widget' == substr($_GET['own_widget'], 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['chart_lab_hitung']['dashboard_info']['own_widget'] = $_GET['own_widget'];
              $_SESSION['sc_session'][$this->sc_page]['chart_lab_hitung']['dashboard_info']['under_dashboard'] = true;
              if (isset($_GET['dashboard_app'])) {
                  $_SESSION['sc_session'][$this->sc_page]['chart_lab_hitung']['dashboard_info']['dashboard_app'] = $_GET['dashboard_app'];
              }
              if (isset($_GET['parent_widget'])) {
                  $_SESSION['sc_session'][$this->sc_page]['chart_lab_hitung']['dashboard_info']['parent_widget'] = $_GET['parent_widget'];
              }
              if (isset($_GET['compact_mode'])) {
                  $_SESSION['sc_session'][$this->sc_page]['chart_lab_hitung']['dashboard_info']['compact_mode'] = 1 == $_GET['compact_mode'];
              }
              if (isset($_GET['remove_margin'])) {
                  $_SESSION['sc_session'][$this->sc_page]['chart_lab_hitung']['dashboard_info']['remove_margin'] = 1 == $_GET['remove_margin'];
              }
          }
      }
      elseif (isset($under_dashboard) && 1 == $under_dashboard)
      {
          if (isset($own_widget) && 'dbifrm_widget' == substr($own_widget, 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['chart_lab_hitung']['dashboard_info']['own_widget'] = $own_widget;
              $_SESSION['sc_session'][$this->sc_page]['chart_lab_hitung']['dashboard_info']['under_dashboard'] = true;
              if (isset($dashboard_app)) {
                  $_SESSION['sc_session'][$this->sc_page]['chart_lab_hitung']['dashboard_info']['dashboard_app'] = $dashboard_app;
              }
              if (isset($parent_widget)) {
                  $_SESSION['sc_session'][$this->sc_page]['chart_lab_hitung']['dashboard_info']['parent_widget'] = $parent_widget;
              }
              if (isset($compact_mode)) {
                  $_SESSION['sc_session'][$this->sc_page]['chart_lab_hitung']['dashboard_info']['compact_mode'] = 1 == $compact_mode;
              }
              if (isset($remove_margin)) {
                  $_SESSION['sc_session'][$this->sc_page]['chart_lab_hitung']['dashboard_info']['remove_margin'] = 1 == $remove_margin;
              }
          }
      }
      if (!isset($_SESSION['sc_session'][$this->sc_page]['chart_lab_hitung']['dashboard_info']['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['chart_lab_hitung']['dashboard_info']['maximized'] = false;
      }
      if (isset($_GET['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['chart_lab_hitung']['dashboard_info']['maximized'] = 1 == $_GET['maximized'];
      }
      if ($_SESSION['sc_session'][$this->sc_page]['chart_lab_hitung']['dashboard_info']['under_dashboard'])
      {
          $sTmpDashboardApp = $_SESSION['sc_session'][$this->sc_page]['chart_lab_hitung']['dashboard_info']['dashboard_app'];
          if ('' != $sTmpDashboardApp && isset($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["chart_lab_hitung"]))
          {
              foreach ($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["chart_lab_hitung"] as $sTmpTargetLink => $sTmpTargetWidget)
              {
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['chart_lab_hitung']['responsive_chart']))
      {
          $_SESSION['sc_session'][$this->sc_page]['chart_lab_hitung']['responsive_chart'] = array(
              'enabled' => true,
              'active'  => true,
          );
      }
      if ($_SESSION['sc_session'][$this->sc_page]['chart_lab_hitung']['responsive_chart']['enabled'])
      {
          $_SESSION['sc_session'][$this->sc_page]['chart_lab_hitung']['responsive_chart']['active'] = true;
      }
      elseif ($_SESSION['sc_session'][$this->sc_page]['chart_lab_hitung']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->sc_page]['chart_lab_hitung']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->sc_page]['chart_lab_hitung']['dashboard_info']['maximized'])
      {
          $_SESSION['sc_session'][$this->sc_page]['chart_lab_hitung']['responsive_chart']['active'] = true;
      }
      else
      {
          $_SESSION['sc_session'][$this->sc_page]['chart_lab_hitung']['responsive_chart']['active'] = false;
      }
      if ($Tp_init == "Path_sub")
      {
          return;
      ...
      if (!is_file($this->root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
      {
          ...
          unset($_SESSION['scriptcase']['chart_lab_hitung']['glo_nm_conexao']);
      }
      ...
      if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['chart_lab_hitung']['session_timeout']['redir']))
      {
      ...
      $_SESSION['sc_session'][$this->sc_page]['chart_lab_hitung']['path_doc'] = $this->path_doc; 
      ...
      if (!is_dir($this->root . $this->path_prod))
      {
          ...
          echo " </tr>";
          echo "</table>";
          if (!$_SESSION['sc_session'][$script_case_init]['chart_lab_hitung']['iframe_menu'] && (!isset($_SESSION['sc_session'][$script_case_init]['chart_lab_hitung']['sc_outra_jan']) || !$_SESSION['sc_session'][$script_case_init]['chart_lab_hitung']['sc_outra_jan'])) 
          { 
...
// 
      include_once($this->path_aplicacao . "chart_lab_hitung_erro.class.php"); 
      $this->Erro = new chart_lab_hitung_erro();
      include_once($this->path_adodb . "/adodb.inc.php"); 
      $this->sc_Include($this->path_libs . "/nm_sec_prod.php", "F", "nm_reg_prod") ; 
      $this->sc_Include($this->path_libs . "/nm_ini_perfil.php", "F", "perfil_lib") ; 
// 
 if(function_exists('set_php_timezone')) set_php_timezone('chart_lab_hitung'); 
// 
      ...
      if (isset($_SESSION['scriptcase']['chart_lab_hitung']['session_timeout']['redir'])) {
          ...
          if ($_SESSION['scriptcase']['chart_lab_hitung']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "  </HEAD>\r\n";
              $SS_cod_html .= "   <body>\r\n";
          }
          else {
              ...
              $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['chart_lab_hitung']['session_timeout']['redir'] . "');\">\r\n";
              $SS_cod_html .= "     </form>\r\n";
          ...
          if ($_SESSION['scriptcase']['chart_lab_hitung']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['chart_lab_hitung']['session_timeout']['redir'] . "');\r\n";
          }
          ...
          $SS_cod_html .= " </body>\r\n";
          $SS_cod_html .= "</HTML>\r\n";
          unset($_SESSION['scriptcase']['chart_lab_hitung']['session_timeout']);
          unset($_SESSION['sc_session']);
      }
      ...
      $_SESSION['sc_session'][$this->sc_page]['chart_lab_hitung']['seq_dir'] = 0; 
      $_SESSION['sc_session'][$this->sc_page]['chart_lab_hitung']['sub_dir'] = array(); 
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
      $this->conectDB();
   ...
   function prep_conect()
   {
      if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
      {
          ...
          {
              if (isset($_SESSION['scriptcase']['chart_lab_hitung']['glo_nm_conexao']) && $_SESSION['scriptcase']['chart_lab_hitung']['glo_nm_conexao'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['chart_lab_hitung']['glo_nm_conexao'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['chart_lab_hitung']['glo_nm_perfil']) && $_SESSION['scriptcase']['chart_lab_hitung']['glo_nm_perfil'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['chart_lab_hitung']['glo_nm_perfil'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['chart_lab_hitung']['glo_con_' . $NM_con_orig]))
              {
                  $_SESSION['scriptcase']['chart_lab_hitung']['glo_con_' . $NM_con_orig] = $NM_con_dest;
              }
          }
      }
      $con_devel             = (isset($_SESSION['scriptcase']['chart_lab_hitung']['glo_nm_conexao'])) ? $_SESSION['scriptcase']['chart_lab_hitung']['glo_nm_conexao'] : ""; 
      $perfil_trab           = ""; 
      $this->nm_falta_var    = ""; 
      $this->nm_falta_var_db = ""; 
      $nm_crit_perfil        = false;
      if (isset($_SESSION['scriptcase']['chart_lab_hitung']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['chart_lab_hitung']['glo_nm_conexao']))
      {
          ob_start();
      ...
      if (isset($_SESSION['scriptcase']['chart_lab_hitung']['glo_nm_perfil']) && !empty($_SESSION['scriptcase']['chart_lab_hitung']['glo_nm_perfil']))
      {
          $perfil_trab = $_SESSION['scriptcase']['chart_lab_hitung']['glo_nm_perfil'];
      }
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['chart_lab_hitung']['embutida_init']) || !$_SESSION['sc_session'][$this->sc_page]['chart_lab_hitung']['embutida_init']) 
      {
      }
// 
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['chart_lab_hitung']['decimal_db'] = $_SESSION['scriptcase']['glo_decimal_db']; 
      }
      if (isset($_SESSION['scriptcase']['glo_date_separator']) && !empty($_SESSION['scriptcase']['glo_date_separator']))
      {
          ...
          if (strlen($SC_temp) == 2)
          {
              $_SESSION['sc_session'][$this->sc_page]['chart_lab_hitung']['SC_sep_date']  = substr($SC_temp, 0, 1); 
              $_SESSION['sc_session'][$this->sc_page]['chart_lab_hitung']['SC_sep_date1'] = substr($SC_temp, 1, 1); 
          }
          else
           {
              $_SESSION['sc_session'][$this->sc_page]['chart_lab_hitung']['SC_sep_date']  = $SC_temp; 
              $_SESSION['sc_session'][$this->sc_page]['chart_lab_hitung']['SC_sep_date1'] = $SC_temp; 
          }
          $this->date_delim  = $_SESSION['sc_session'][$this->sc_page]['chart_lab_hitung']['SC_sep_date'];
          $this->date_delim1 = $_SESSION['sc_session'][$this->sc_page]['chart_lab_hitung']['SC_sep_date1'];
      }
// 
...
<?php
   ...
   function conectDB()
   {
      ...
      if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['chart_lab_hitung']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['chart_lab_hitung']['glo_nm_conexao']))
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['chart_lab_hitung']['glo_nm_conexao'], $this->root . $this->path_prod, 'simrskreatifmedia', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
...
// 
   ...
   function sc_Sql_Protect($var, $tp, $conex="")
   {
       ...
       if ($tp == "date")
       {
           ...
           if (isset($_SESSION['sc_session'][$this->sc_page]['chart_lab_hitung']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->sc_page]['chart_lab_hitung']['SC_sep_date']))
           {
               $delim  = $_SESSION['sc_session'][$this->sc_page]['chart_lab_hitung']['SC_sep_date'];
               $delim1 = $_SESSION['sc_session'][$this->sc_page]['chart_lab_hitung']['SC_sep_date1'];
           }
   ...
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['chart_lab_hitung']['SC_Gb_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['chart_lab_hitung']['SC_Gb_date_format'][$GB][$cmp] : "";
   }

   function Get_Gb_prefix_date_format($GB, $cmp)
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['chart_lab_hitung']['SC_Gb_prefix_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['chart_lab_hitung']['SC_Gb_prefix_date_format'][$GB][$cmp] : "";
   }
...
//===============================================================================
//
class chart_lab_hitung_sub_css
{
   function __construct()
   {
      ...
      if ($_SESSION['sc_session'][$script_case_init]['chart_lab_hitung']['SC_herda_css'] == "N")
      {
          $_SESSION['sc_session'][$script_case_init]['SC_sub_css']['chart_lab_hitung']    = $str_schema_all . "_grid.css";
          $_SESSION['sc_session'][$script_case_init]['SC_sub_css_bw']['chart_lab_hitung'] = $str_schema_all . "_grid_bw.css";
      }
   }
}
//
class chart_lab_hitung_apl
{
   var $Ini;
   var $Erro;
   var $Db;
...
//----- 
   function controle($linhas = 0)
   {
      ...
      if (isset($_SESSION['sc_session']['scriptcase']['embutida_form_pdf']['chart_lab_hitung']))
      { 
          $GLOBALS['nmgp_parms'] = $_SESSION['sc_session']['scriptcase']['embutida_form_pdf']['chart_lab_hitung'];
          $Parms_form_pdf = true;
      } 
      if ($_SESSION['sc_session'][$script_case_init]['chart_lab_hitung']['embutida'] || $Parms_form_pdf)
      { 
          ...
          { 
              ...
              foreach ($todo as $param)
              {
                   ...
                   if (1 < sizeof($cadapar))
                   {
                       ...
                       nm_limpa_str_chart_lab_hitung($cadapar[1]);
                       nm_protect_num_chart_lab_hitung($cadapar[0], $cadapar[1]);
                       if ($cadapar[1] == "@ ") {$cadapar[1] = trim($cadapar[1]); }
                       $Tmp_par   = $cadapar[0];
                       $$Tmp_par = $cadapar[1];
                       if ($Tmp_par == "nmgp_opcao")
                       {
                           $_SESSION['sc_session'][$script_case_init]['chart_lab_hitung']['opcao'] = $cadapar[1];
                       }
                   }
              }
          } 
      ...
      if ($Parms_form_pdf)
      { 
          $_SESSION['sc_session'][$script_case_init]['chart_lab_hitung']['embutida_pdf'] = true;
          $_SESSION['sc_session'][$script_case_init]['chart_lab_hitung']['embutida_form'] = true;
          $_SESSION['sc_session'][$script_case_init]['chart_lab_hitung']['embutida_form_full'] = false;
          $_SESSION['sc_session'][$script_case_init]['chart_lab_hitung']['embutida_pai'] = "";
      } 
      $_SESSION['scriptcase']['sc_ctl_ajax'] = 'part';
      if (!$this->Ini || isset($_SESSION['sc_session'][$script_case_init]['chart_lab_hitung']['embutida_ibase'])) 
      { 
          $this->Ini = new chart_lab_hitung_ini(); 
          $this->Ini->init();
      } 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase) && $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['embutida'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['embutida_ibase'] = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['emb_lig_aba'] = array();
      $this->Change_Menu = false;
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['Res_search_metric']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['Res_search_metric_use'] = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['Res_search_metric']     = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['where_res_lookup']      = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['where_pesq'];
      }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['Proc_Link_Res']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['Proc_Link_Res'] = false;
       }
       if ($nmgp_opcao == "link_res")  
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['Proc_Link_Res'] = true;
           $nmgp_opcao = "inicio";  
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['opcao'] = "inicio";  
           $Temp_parms = "";  
           ...
           foreach ($todo as $param)
           {
                ...
                if ($cadapar[0] == "tgl")  
                { 
                    $cadapar[0] = str_replace("tgl", "trandate", $cadapar[0]);
                } 
                if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['SC_Ind_Groupby'] == "sc_free_group_by")
                { 
                    ...
                    elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['SC_Gb_Free_orig'][$cadapar[0]]))
                    {
                        list ($Sql_orig, $Sql_order) = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['SC_Gb_Free_sql'][$cadapar[0]];
                        $cadapar[1]  = str_replace("@aspass@", "", $cadapar[1]);
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['where_resumo'] = $Temp_parms;
       } 
      if ($nmgp_opcao != "ajax_navigate" && $nmgp_opcao != "ajax_detalhe" && isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['sc_outra_jan'] || $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['sc_modal']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['chart_lab_hitung']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['chart_lab_hitung'];
          }
          ...
          if (!$_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['embutida'] && $this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['chart_lab_hitung']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['chart_lab_hitung']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('chart_lab_hitung') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['chart_lab_hitung']['label'] = "" . $this->Ini->Nm_lang['lang_othr_chart_title'] . " Statistik IGD";
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['embutida'])
      {
          $this->Change_Menu = false;
      }
      $this->Db = $this->Ini->Db; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['nm_tpbanco'] = $this->Ini->nm_tpbanco;
      $this->nm_data = new nm_data("id");
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['embutida'])
      { 
          include_once($this->Ini->path_embutida . "chart_lab_hitung/chart_lab_hitung_erro.class.php"); 
      } 
      else 
      { 
          include_once($this->Ini->path_aplicacao . "chart_lab_hitung_erro.class.php"); 
      } 
      $this->Erro      = new chart_lab_hitung_erro();
      $this->Erro->Ini = $this->Ini;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['embutida'])
      { 
          require_once($this->Ini->path_embutida . "chart_lab_hitung/chart_lab_hitung_lookup.class.php"); 
      } 
      else 
      { 
          require_once($this->Ini->path_aplicacao . "chart_lab_hitung_lookup.class.php"); 
      } 
      $this->Lookup       = new chart_lab_hitung_lookup();
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['embutida'])
      {
          ...
          if (isset($_POST['nmgp_opcao']) && $_POST['nmgp_opcao'] == "ajax_export")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['opcao'] = $nmgp_opcao;
              if ($nmgp_opcao == "print" || $nmgp_opcao == "res_print" || $nmgp_opcao == "det_print")
              {
                  $ajax_opc_print   = true;
                  $nm_arquivo_print = "/sc_chart_lab_hitung_" . session_id();
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['embutida'])
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['ajax_nav'] = false;
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['scroll_navigate'] = false;
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['scroll_navigate_reload'] = false;
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['scroll_navigate_app'] = false;
          if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['scroll_navigate_header_row']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['scroll_navigate_header_row'] = 1;
          }
          if (isset($_POST['nmgp_opcao']) && ($_POST['nmgp_opcao'] == "ajax_navigate" || $_POST['nmgp_opcao'] == "ajax_detalhe"))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['ajax_nav'] = true;
              ...
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['save_grid'] = true;
              }
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['SC_Gb_date_format'])) 
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['SC_Gb_date_format'] = array();
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['SC_Gb_prefix_date_format']['sc_free_group_by']['tgl'] = "" . $this->Ini->Nm_lang['lang_othr_valueDD'] . "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['SC_Gb_date_format']['sc_free_group_by']['tgl'])) 
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['SC_Gb_date_format']['sc_free_group_by']['tgl'] = 'DD';
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['SC_All_Groupby'] = array('sc_free_group_by' => 'all');
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['SC_Groupby_hide'])) 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['SC_Groupby_hide'] = array();
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['SC_Ind_Groupby'])) 
      { 
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['SC_All_Groupby'] as $Ind => $Tp)
          {
              if ($Tp == "grid")
              {
                  continue;
              }
              if (!in_array($Ind, $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['SC_Groupby_hide'])) 
              { 
                  break;
              }
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['SC_Ind_Groupby'] = $Ind;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['SC_Gb_Free_cmp'])) 
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['SC_Gb_Free_cmp']  = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['SC_Gb_Free_sql']  = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['SC_Gb_Free_orig'] = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['SC_Gb_Free_cmp']['tgl'] = "trandate";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['SC_Gb_Free_sql']['tgl']["trandate"] = 'asc';
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['Labels_GB'] = array();
      if  ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['SC_Ind_Groupby'] == "sc_free_group_by")
      {
          $Arr_free_labels = array();
          $Arr_free_labels['tgl'] = "" . sprintf("" . $this->Ini->Nm_lang['lang_othr_chart_title_DD'] . " Tgl", "Tgl") . "";
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['SC_Gb_Free_cmp'] as $Field => $Label)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['Labels_GB'][] = $Arr_free_labels[$Field];
          }
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['summarizing_fields_display']['sc_free_group_by'][2]['display'] = true;
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['summarizing_fields_control']['sc_free_group_by']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['summarizing_fields_control']['sc_free_group_by'] = array(
               array(
                   'cmp_res' => "NM_Count",
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['dados_orig_gb']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['dados_orig_gb'] = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['dados_orig_gb']['all']['SC_Ind_Groupby'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['dados_orig_gb']['all']['SC_Gb_Free_cmp'] = array();
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['SC_Ind_Groupby']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['dados_orig_gb']['all']['SC_Ind_Groupby'] = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['SC_Ind_Groupby'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['SC_Gb_Free_cmp']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['dados_orig_gb']['all']['SC_Gb_Free_cmp'] = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['SC_Gb_Free_cmp'];
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['dados_orig_gb']['res']['summarizing_fields_display'] = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['dados_orig_gb']['res']['summarizing_fields_order']   = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['dados_orig_gb']['res']['summarizing_fields_control'] = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['dados_orig_gb']['res']['pivot_x_axys']               = array();
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['summarizing_fields_display']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['dados_orig_gb']['res']['summarizing_fields_display'] = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['summarizing_fields_display'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['summarizing_fields_order']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['dados_orig_gb']['res']['summarizing_fields_order'] = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['summarizing_fields_order'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['summarizing_fields_control']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['dados_orig_gb']['res']['summarizing_fields_control'] = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['summarizing_fields_control'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['pivot_x_axys']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['dados_orig_gb']['res']['pivot_x_axys'] = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['pivot_x_axys'];
          }
      }
      $this->Ini->Apl_resumo  = "chart_lab_hitung_resumo_" . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['SC_Ind_Groupby'] . ".class.php"; 
      $this->Ini->Apl_grafico = "chart_lab_hitung_grafico_" . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['SC_Ind_Groupby'] . ".class.php"; 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['xls_return']  = ($nmgp_opcao == "xls")  ? "volta_grid" : "resumo"; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['csv_return']  = ($nmgp_opcao == "csv")  ? "volta_grid" : "resumo"; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['xml_return']  = ($nmgp_opcao == "xml")  ? "volta_grid" : "resumo"; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['json_return'] = ($nmgp_opcao == "json") ? "volta_grid" : "resumo"; 
      ...
      if ($nmgp_opcao == 'print' || $nmgp_opcao == 'res_print') {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['print_return'] = $this->ret_print;
      }
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['embutida'])
      {
          if ($this->Ini->Export_html_zip)
          {
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['html_name']))
              {
                  $nm_arquivo_html = "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['html_name'];
              }
              elseif ($nmgp_opcao == 'print' && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)
              {
                  $nm_arquivo_html = "/sc_chart_lab_hitung_" . session_id() . ".html";
              }
              else
              {
                  $nm_arquivo_html = "/sc_chart_lab_hitung_res_" . session_id() . ".html";
              }
      ...
      if ($nmgp_opcao == "doc_word") {  
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['word_return'] = $this->ret_word;
          $_SESSION['scriptcase']['proc_mobile'] = false;
      }
      ...
      { 
          $nmgp_opcao = "doc_word"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['opcao'] = "doc_word"; 
      }
      elseif ($nmgp_opcao == "doc_word" && strpos(" " . $this->Ini->SC_module_export, "grid") === false)  
      { 
          $nmgp_opcao = "doc_word_res"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['opcao'] = "doc_word_res"; 
      }
      if ($nmgp_opcao == "xls_res" && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)  
      { 
          $nmgp_opcao = "xls"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['opcao'] = "xls"; 
      }
      elseif ($nmgp_opcao == "xls" && strpos(" " . $this->Ini->SC_module_export, "grid") === false)  
      { 
          $nmgp_opcao = "xls_res"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['opcao'] = "xls_res"; 
      }
      if ($nmgp_opcao == "csv_res" && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)  
      { 
          $nmgp_opcao = "csv"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['opcao'] = "csv"; 
      }
      elseif ($nmgp_opcao == "csv" && strpos(" " . $this->Ini->SC_module_export, "grid") === false)  
      { 
          $nmgp_opcao = "csv_res"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['opcao'] = "csv_res"; 
      }
      if ($nmgp_opcao == "xml_res" && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)  
      { 
          $nmgp_opcao = "xml"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['opcao'] = "xml"; 
      }
      elseif ($nmgp_opcao == "xml" && strpos(" " . $this->Ini->SC_module_export, "grid") === false)  
      { 
          $nmgp_opcao = "xml_res"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['opcao'] = "xml_res"; 
      }
      if ($nmgp_opcao == "json_res" && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)  
      { 
          $nmgp_opcao = "json"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['opcao'] = "json"; 
      }
      elseif ($nmgp_opcao == "json" && strpos(" " . $this->Ini->SC_module_export, "grid") === false)  
      { 
          $nmgp_opcao = "json_res"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['opcao'] = "json_res"; 
      }
      $_SESSION['sc_session'][$script_case_init]['chart_lab_hitung']['skip_charts'] = (strpos(" " . $this->Ini->SC_module_export, "chart") !== false) ? false : true;
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['pdf_det'] = false;
      if ($nmgp_opcao == 'pdf')
      { 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['pdf_res'] = false;
      if ($nmgp_opcao == 'pdf_res')
      {
          if (strpos(" " . $this->Ini->SC_module_export, "grid") !== false)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['opcao'] = 'pdf';
              $nmgp_opcao = 'pdf';
          }
          else
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['pdf_res'] = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['opcao'] = 'pdf';
              $nmgp_opcao = 'pdf';
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['conf_chart_level'] = "S";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['cfg_graf']['graf_tipo']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['graf_disp']        = array('Bar');
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['cfg_graf']['graf_tipo']        = 'Bar';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['cfg_graf']['graf_larg']        = '800';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['cfg_graf']['graf_alt']         = '600';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['graf_opc_atual']   = '1';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['graf_mod_allowed'] = array(1, 2);
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['graf_order']       = '';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['cfg_graf']['graf_font'] = '';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['graf_subtitle_val'] = '';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['chartpallet']       = '1';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['graf_exibe_val']    = '1';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['paletteColors']     = '';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['cfg_graf']['graf_barra_orien'] = 'Vertical';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['cfg_graf']['graf_barra_forma'] = 'Bar';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['cfg_graf']['graf_barra_dimen'] = '3d';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['cfg_graf']['graf_barra_sobre'] = 'No';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['cfg_graf']['graf_barra_empil'] = 'Off';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['cfg_graf']['graf_barra_inver'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['cfg_graf']['graf_barra_agrup'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['cfg_graf']['graf_barra_funil'] = 'N';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['cfg_graf']['graf_pizza_forma'] = 'Pie';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['cfg_graf']['graf_pizza_dimen'] = '3d';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['cfg_graf']['graf_pizza_orden'] = 'Off';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['cfg_graf']['graf_pizza_explo'] = 'Off';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['cfg_graf']['graf_pizza_valor'] = 'Valor';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['cfg_graf']['graf_linha_forma'] = 'Line';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['cfg_graf']['graf_linha_inver'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['cfg_graf']['graf_linha_agrup'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['cfg_graf']['graf_area_forma']  = 'Area';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['cfg_graf']['graf_area_empil']  = 'Off';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['cfg_graf']['graf_area_inver']  = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['cfg_graf']['graf_area_agrup']  = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['cfg_graf']['graf_marca_inver'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['cfg_graf']['graf_marca_agrup'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['cfg_graf']['graf_gauge_forma'] = 'Circular';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['cfg_graf']['graf_radar_forma'] = 'Line';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['cfg_graf']['graf_radar_empil'] = 'Off';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['cfg_graf']['graf_polar_forma'] = 'Line';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['cfg_graf']['graf_funil_dimen'] = '3d';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['cfg_graf']['graf_funil_inver'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['cfg_graf']['graf_pyram_dimen'] = '3d';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['cfg_graf']['graf_pyram_valor'] = 'Valor';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['cfg_graf']['graf_pyram_forma'] = 'S';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['embutida']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['embutida']      = false;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['embutida_grid']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['embutida_grid'] = false;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['embutida_init']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['embutida_init'] = false;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['embutida_label']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['embutida_label'] = false;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['cab_embutida']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['cab_embutida'] = "";
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['embutida_pdf']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['embutida_pdf'] = "";
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['embutida_treeview']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['embutida_treeview'] = false;
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['proc_pdf']      = (!$_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['embutida'] && ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['opcao'] == "pdf_res")) ? true : false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['proc_pdf_vert'] = false;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['proc_pdf']) {
          $_SESSION['scriptcase']['proc_mobile'] = false;
      } 
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['embutida']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['embutida'])
      { 
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['field_order']))
      { 
          if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['usr_cmp_sel']))
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['usr_cmp_sel'] = array();
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['usr_cmp_sel_orig'] = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['usr_cmp_sel'];
      } 
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['chart_lab_hitung']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['chart_lab_hitung']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['chart_lab_hitung']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }

      $this->Ini->sc_Include($this->Ini->path_libs . "/nm_gc.php", "F", "nm_gc") ; 
      nm_gc($this->Ini->path_libs);
      if (!$_SESSION['sc_session'][$script_case_init]['chart_lab_hitung']['embutida'])
      { 
      ...
      if (!$_SESSION['sc_session'][$script_case_init]['chart_lab_hitung']['embutida'])
      { 
          $this->pdf_zip = (isset($_SESSION['sc_session'][$script_case_init]['chart_lab_hitung']['opc_pdf']['pdf_zip'])) ? $_SESSION['sc_session'][$script_case_init]['chart_lab_hitung']['opc_pdf']['pdf_zip'] : "N";
          $_SESSION['sc_session'][$script_case_init]['chart_lab_hitung']['use_pass_pdf'] = "";
      ...
      if ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['opcao']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['opcao']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['where_orig'])))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['opcao'] = "inicio";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['chart_lab_hitung']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['chart_lab_hitung']['start'] == 'filter')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['opcao'] == "inicio" || $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['opcao'] == "grid")  
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['opcao'] = "busca";
          }   
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['opcao'] != "detalhe" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['where_orig']) || !empty($nmgp_parms) || !empty($GLOBALS["nmgp_parms"])))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['opc_liga'] = array();  
          if (isset($NMSC_conf_apl) && !empty($NMSC_conf_apl))
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['opc_liga'] = $NMSC_conf_apl;  
          }   
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['opc_liga']['inicial']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['opcao'] = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['opc_liga']['inicial'];
          }
      }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['opc_liga']['paginacao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['opc_liga']['paginacao']))
          { 
              $this->Ini->Apl_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['opc_liga']['paginacao'];
          } 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['opcao'] == "busca")
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['opcao'] = "grid" ;  
      }   
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['opcao_print']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['opcao_print']))  
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['opcao_print'] = "inicio" ;  
      }   
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['print_all'] = false;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['opcao'] == "print")  
      { 
          if (strpos(" " . $this->Ini->SC_module_export, "grid") === false)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['opcao'] = "res_print";
          }
      } 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['opcao'] == "res_print")  
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['opcao']     = "resumo";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['print_all'] = true;
          if (strpos(" " . $this->Ini->SC_module_export, "grid") !== false)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['opcao'] = "print";
              $nmgp_tipo_print = "RC";
          }
      } 
      if (substr($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['opcao'], 0, 7) == "grafico")  
      { 
          $_SESSION['scriptcase']['sc_ctl_ajax'] = 'part';
      } 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['opcao'] == "pdf")
      { 
          $this->Ini->path_img_modelo = $this->Ini->path_img_modelo;
      } 
      $this->Ini->grid_search_change_fil = false;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['opcao'] == "grid_search" || $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['opcao'] == "grid_search_res")
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['opcao'] == "grid_search")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['orig_pesq'] = 'grid';
          } 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['opcao'] == "grid_search_res")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['orig_pesq'] = 'res';
          } 
          $this->SC_proc_grid_search($_POST['parm']);
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['where_pesq_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['where_pesq'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['contr_array_resumo'] = "NAO";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['contr_total_geral']  = "NAO";
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['tot_geral']);
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['opcao'] = 'pesq';
          ob_end_clean();
          $this->Ini->Arr_result = array();
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['opcao'] == "grid_search_change_fil" || $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['opcao'] == "grid_search_change_fil_res")
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['opcao'] == "grid_search_change_fil")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['orig_pesq'] = 'grid';
          } 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['opcao'] == "grid_search_change_fil_res")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['orig_pesq'] = 'res';
          } 
          if (!$_SESSION['scriptcase']['proc_mobile']) 
          { 
              require_once($this->Ini->path_aplicacao . "chart_lab_hitung_pesq.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "chart_lab_hitung_mobile_pesq.class.php"); 
          } 
          $this->pesq  = new chart_lab_hitung_pesq();
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['opcao'] == "resumo_search")
      { 
          if ($_POST['parm'] == 'clear_res_search')
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['resumo_search']);
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['resumo_search_look']);
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['Res_search_metric']);
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['Res_search_metric_use']);
              $this->Recupera_where();
              $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['where_res_lookup'] = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['where_pesq'];
          }
          else
          {
              $Func_res = "SC_proc_resumo_search_" . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['SC_Ind_Groupby'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['opcao'] == "ajax_res_fill_combo")
      { 
      ...
      $return_grid = false; 
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['Proc_Link_Res'] && $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['opcao'] == "resumo" && isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['resumo_search']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['resumo_search']))
      { 
          $return_grid = true; 
      } 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['opcao'] == 'pesq' && isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['orig_pesq']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['orig_pesq']))  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['orig_pesq'] == "res")  
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['opcao'] = 'resumo';
          } 
          elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['orig_pesq'] == "grid") 
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['opcao'] = 'inicio';
          } 
      } 
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['Proc_Link_Res'] && $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['opcao'] != 'resumo' && isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['Proc_Res_Search']))
      { 
          $this->Recupera_where();
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['where_pesq_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['where_pesq'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['where_res_lookup'] = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['where_pesq'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['Proc_Res_Search']); 
      } 
//
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['prim_cons'] = false;  
      if (substr($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['opcao'], 0, 7) != "grafico" && $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['opcao'] != "detalhe" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['where_orig']) || !empty($nmgp_parms) || !empty($GLOBALS["nmgp_parms"])))  
      { 
        if (!$return_grid) {
         unset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['use_pass_pdf']);
         $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['prim_cons'] = true;  
         $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['where_orig'] = "";
         $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['where_pesq']       = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['where_orig'];  
         $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['where_pesq_ant']   = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['where_orig'];  
         $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['cond_pesq'] = ""; 
         $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['where_pesq_filtro'] = "";
         $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['contr_total_geral'] = "NAO";
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['sc_total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['tot_geral']);
         $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['contr_array_resumo'] = "NAO";
        }
      } 
      if (!in_array($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['opcao'], array('config_print', 'word_res', 'xls_res', 'xml_res', 'json_res', 'csv_res', 'rtf_res', 'image_res', 'ajax_comb_table', 'ajax_comb_save', 'ajax_comb_file_view', 'ajax_comb_file_download'))) {
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['where_pesq'] = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['where_pesq_ant'];  
      }
      $nm_flag_pdf   = true;
      $nm_vendo_pdf  = ("pdf" == $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['opcao']);
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['graf_pdf'] = "S";
      if (isset($nmgp_graf_pdf) && !empty($nmgp_graf_pdf))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['graf_pdf'] = $nmgp_graf_pdf;
      }
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['embutida'])
      {
         if ($nm_flag_pdf && $nm_vendo_pdf)
         {
            $nm_arquivo_htm_temp = $this->Ini->root . $this->Ini->path_imag_temp . "/sc_chart_lab_hitung_html_" . session_id() . "_2.html";
            ...
            {
                $nm_arquivo_pdf_base = "/sc_pdf_" . date("YmdHis") . "_" . rand(0, 1000) . "_chart_lab_hitung.pdf";
                $nm_arquivo_pdf_url  = $this->Ini->path_imag_temp . $nm_arquivo_pdf_base;
            }
            $nm_arquivo_pdf_serv = $this->Ini->root . $nm_arquivo_pdf_url;
            $nm_arquivo_de_saida = $this->Ini->root . $this->Ini->path_imag_temp . "/sc_chart_lab_hitung_html_" . session_id() . ".html";
            $nm_url_de_saida = $this->Ini->server_pdf . $this->Ini->path_imag_temp . "/sc_chart_lab_hitung_html_" . session_id() . ".html";
...
//----------------------------------->
      if ($this->NM_ajax_opcao == "ajax_comb_table")
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['embutida'])
          {
              require_once($this->Ini->path_embutida . "chart_lab_hitung/" . $this->Ini->Apl_resumo);
          }
          else 
          {
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['comb_field_display_type'][ $_POST['sumcfg_field'] ] = $_POST['sumcfg_value'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['chart_display_values'][ $_POST['sumcfg_field'] ]    = 1 == $_POST['sumcfg_display'];
          echo 'ok';
          exit;
      }
      else
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['chart_combination_order_rule']   = 'asc' == $_POST['sort_option'] || 'desc' == $_POST['sort_option'] ? $_POST['sort_option'] : '';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['chart_combination_order_field']  = $_POST['sort_field'];
          if ('orig' == $_POST['sort_option'])
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['chart_combination_order_forced'] = false;
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['chart_combination_order_forced'] = true;
          }
          echo 'ok';
          exit;
      }
      ...
      {
          if (!isset($_SESSION['scriptcase']['chart_export_file']['chart_lab_hitung']) || !isset($_SESSION['scriptcase']['chart_export_file']['chart_lab_hitung'][ $_REQUEST['chart_file_md5'] ]))
          {
              echo 'error_file_not_found';
          }
          else
          {
              echo $this->Ini->path_imag_temp . '/' . $_SESSION['scriptcase']['chart_export_file']['chart_lab_hitung'][ $_REQUEST['chart_file_md5'] ]['name'];
          }
          exit;
      }
      else
      if ($nmgp_opcao == "ajax_comb_file_download")
      {
          ...
          {
              $filename = $_SESSION['scriptcase']['chart_export_file']['chart_lab_hitung'][ $_REQUEST['chart_file_md5'] ]['name'];
              $path     = $_SESSION['scriptcase']['chart_export_file']['chart_lab_hitung'][ $_REQUEST['chart_file_md5'] ]['dir'] . $filename;
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['opcao'] == "print_res" || $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['opcao'] == "res_print")
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['embutida'])
          {
              require_once($this->Ini->path_embutida . "chart_lab_hitung/" . $this->Ini->Apl_resumo);
          ...
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['opcao']);
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['export_progress_file']  = $_POST['export_progress_file'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['export_progress_step']  = 'init';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['export_progress_count'] = 0;
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['export_progress_total'] = 0;
          $this->outputCombinationPrint();
      }
      else
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['opcao'] == "config_print")
      { 
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['opcao']);
      ...
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['embutida'])
          { 
              require_once($this->Ini->path_embutida . " . chart_lab_hitung . /" . $this->Ini->Apl_grafico); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . $this->Ini->Apl_grafico); 
          } 
          $this->Graf  = new chart_lab_hitung_grafico();
          $this->prep_modulos("Graf");
          if (substr($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['opcao'], 7, 1) == "_")  
          { 
              $this->Graf->grafico_col(substr($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['opcao'], 8));
              $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['opcao'] = "grid";
          }
          else
          { 
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['dashboard_refresh_after_chart'])) {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['opcao'] = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['dashboard_refresh_after_chart'];
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['dashboard_refresh_after_chart']);
              }
              else {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['opcao'] = "grid";
              }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['opcao'] == "busca")  
      { 
          if (!$_SESSION['scriptcase']['proc_mobile']) 
          { 
              require_once($this->Ini->path_aplicacao . "chart_lab_hitung_pesq.class.php"); 
      ...
      { 
          ...
          $this->Res = new chart_lab_hitung_resumo();
...
<?php
      ...
      {
         $nm_saida->finaliza();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['ajax_nav'])
         {
             $Temp = ob_get_clean();
             if ($Temp !== false && trim($Temp) != "")
             {
             ...
             if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['opcao'] != "ajax_detalhe")  
             {
                 $this->Ini->Arr_result['setVar'][] = array('var' => 'scQtReg', 'value' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['qt_reg_grid']);
             }
             $_SESSION['scriptcase']['saida_var'] = false;
             $oJson = new Services_JSON();
             echo $oJson->encode($this->Ini->Arr_result);
            ...
            if(isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['export_sel_columns']['field_order']))
            {
                $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['field_order'] = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['export_sel_columns']['field_order'];
                unset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['export_sel_columns']['field_order']);
            }
            if(isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['export_sel_columns']['usr_cmp_sel']))
            {
                $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['usr_cmp_sel'] = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['export_sel_columns']['usr_cmp_sel'];
                unset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['export_sel_columns']['usr_cmp_sel']);
            }
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['doc_word'])
         {
             $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['word_file'] = $this->Ini->root . $this->Ini->path_imag_temp . $nm_arquivo_doc_word;
         ...
         if ($nm_flag_pdf && $nm_vendo_pdf)
         {
            ...
            if (!$this->Ini->sc_export_ajax && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['pdf_det'])
            {
            ...
            if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['pdf_name']))
            {
                $nm_arquivo_pdf_serv = $this->Ini->root .  $this->Ini->path_imag_temp . "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['pdf_name'];
                $nm_arquivo_pdf_url  = $this->Ini->path_imag_temp . "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['pdf_name'];
                $nm_arquivo_pdf_base = "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['pdf_name'];
                unset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['pdf_name']);
            }
            ...
            elseif (is_dir($this->Ini->path_third . $dir_qpdf) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['use_pass_pdf']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['use_pass_pdf']))
            {
            ...
            if ($this->pdf_zip == "S")
            {
                $pdf_pass = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['use_pass_pdf'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['use_pass_pdf'] : "";
            ...
            elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['use_pass_pdf']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['use_pass_pdf']))
            {
                if (FALSE !== strpos(strtolower(php_uname()), 'windows')) 
                {
                    $dir_qpdf = "/qpdf/win/bin";
                ...
                if (is_dir($this->Ini->path_third . $dir_qpdf)) 
                {
                    ...
                    $pdf_pass  = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['use_pass_pdf'];
            ...
            $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['contr_array_resumo'] = '';
            $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['contr_total_geral']  = '';
            // ----- PDF log
            ...
            if (!$_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['pdf_det'])
            {
                if (-1 < $this->grid->progress_grid && $this->grid->progress_fp)
                {
...
unset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['pdf_file']);
if (is_file($nm_arquivo_pdf_serv))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['pdf_file'] = $nm_arquivo_pdf_serv;
}
if ($_SESSION['sc_session'][$script_case_init]['chart_lab_hitung']['opcao'] == "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['pdf_det'])
{
  $NM_volta  = "resumo";
  $NM_target = "_self";
?>
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_chart_title'] ?> Statistik IGD :: PDF</TITLE>
...
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung'][$tableDef]['label'] as $series_name)
        {
...
<?php
        $this->outputCombinationTableRow($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung'][$tableData], 0, $tableDef);
?>
</table>
<?php
        exit;
...
<?php
            ...
            {
?>
  <td class="scGridFieldOdd scGridFieldOddFont" style="text-align: right"><?php echo chart_lab_hitung_resumo::formatValue($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung'][$tableDef]['summ'][$index], $value, true); ?></td>
<?php
            }
?>
 </tr>
<?php
	...
	function outputCombinationZipPassword($type, $fileName, $password) {
		$zipCommand  = "";
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['chart_lab_hitung']['glo_nm_path_imag_temp'] . '/';
	...
	function outputCombinationData() {
		if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['anlt_table_def']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['anlt_table_def'])) {
	...
	function outputCombinationExport($type, $content, $password) {
		...
		$fileName = "sc_{$type}_{$dateTime}_{$fileSeq}_chart_lab_hitung.{$type}";
		...
		if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung'][$testFilename . '_name'])) {
			$fileName = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung'][$testFilename . '_name'];
		}
		...
		if (!isset($_SESSION['scriptcase']['chart_export_file']['chart_lab_hitung'])) {
			$_SESSION['scriptcase']['chart_export_file']['chart_lab_hitung'] = array();
		}
		$_SESSION['scriptcase']['chart_export_file']['chart_lab_hitung'][$fileMd5] = array(
			'dir'  => $fileDir,
			'name' => $fileName
		);
		...
		switch ($type) {
			...
			case 'html':
				if ($this->Ini->sc_export_ajax) {
					$_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['export_print_files'][] = $fileName;

					$this->outputCombinationEmail($this->Res->zipFileList($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['export_print_files']));
				}
				else {
...
SCEOT;
	...
	function outputCombinationPrintConfig() {
		...
		$hasOneGroupByLevel = 1 >= count($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['Labels_GB']);
		$isMultiSeriesChart = !isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['summarizing_drill_down']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['summarizing_drill_down'];
...
SCEOT;
		...
		$lastGroupby = count($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['Labels_GB']) - 1;
		foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['Labels_GB'] as $groupbyIndex => $groupbyLabel) {
...
SCEOT;
	...
	function outputCombinationPrintCss() {
		$_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['chart_export_print_css'] = 'color';

		if ('bw' == $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['chart_export_print_css']) {
	...
	function outputCombinationPrintCharts() {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['export_print_bw'] = isset($_POST['export_chart_bw']) && 'Y' == $_POST['export_chart_bw'];

		$chartImages = $this->Res->generateChartImages();

		$_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['export_print_bw'] = false;
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['export_print_files'] = $chartImages;
	...
	function outputCombinationXmlContent($tableDef, $tableData) {
		return "<?xml version=\"1.0\" encoding=\"{$_SESSION['scriptcase']['charset']}\" ?>\r\n" .
		       "<chart_lab_hitung>\r\n" .
		       $this->outputCombinationXmlRow($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung'][$tableData], 0, $tableDef) .
		       "</chart_lab_hitung>";
	...
	function outputCombinationXmlRow($rows, $level, $tableDef) {
		...
		foreach ($rows as $data) {
			...
			foreach ($data['values'] as $index => $value) {
				$outputData .= "<aggregate_{$_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung'][$tableDef]['field'][$index]} label=\"" . $this->outputCombinationXmlProtectText($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung'][$tableDef]['label'][$index]) . "\" value=\"" . $this->outputCombinationXmlProtectNumber(chart_lab_hitung_resumo::formatValue($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung'][$tableDef]['summ'][$index], $value, true)) . "\" />\r\n";
			}
	...
	function outputCombinationCsvContent($tableDef, $tableData) {
		$hasChildren = $this->outputCombinationHasChildren($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung'][$tableData]);
		return $this->outputCombinationCsvRow($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung'][$tableData], 0, array(), $tableDef, count($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['pivot_y_axys']), $hasChildren);
	...
	function outputCombinationCsvHeader($tableDef, $hasChildren) {
		...
		if ($hasChildren) {
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['pivot_group_by'] as $groupByName) {
				$headers[] = $groupByName;
			}
		}
		else {
			$headers[] = current($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['pivot_group_by']);
		}

		foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung'][$tableDef]['label'] as $summName) {
			$headers[] = $summName;
		}
	...
	function outputCombinationCsvRow($rows, $level, $parameters, $tableDef, $totalDepth, $hasChildren) {
		...
		foreach ($rows as $data) {
			...
			foreach ($data['values'] as $index => $value) {
				$thisRow[] = $this->outputCombinationCsvProtectNumber(chart_lab_hitung_resumo::formatValue($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung'][$tableDef]['summ'][$index], $value, true));
			}
	...
	function outputCombinationRtfContent($tableDef, $tableData) {
		...
		return "<?xml version=\"1.0\" encoding=\"UTF-8\" ?>\r\n" .
		       ...
		       $this->outputCombinationRtfRow($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung'][$tableData], 0, array(), $tableDef, count($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['pivot_y_axys']), $hasChildren) .
			   "</table>\r\n" .
		       "</DOC>\r\n";
	...
	function outputCombinationRtfHeader($tableDef, $hasChildren) {
		...
		if ($hasChildren) {
			...
			$headers .= "<td>" . current($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['pivot_group_by']) . "</td>\r\n";
		}
	...
	function outputCombinationRtfRow($rows, $level, $parameters, $tableDef, $totalDepth, $hasChildren) {
		...
		foreach ($rows as $data) {
			...
			foreach ($data['values'] as $index => $value) {
				$outputData .= "<td>" . $this->outputCombinationRtfProtectNumber(chart_lab_hitung_resumo::formatValue($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung'][$tableDef]['summ'][$index], $value, true)) . "</td>\r\n";
			}
	...
	function outputCombinationXlsContent($tableDef, $tableData) {
		...
		$this->outputCombinationXlsRow($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung'][$tableData], 0, array(), $tableDef, count($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['pivot_y_axys']), $hasChildren);
	...
	function outputCombinationXlsHeader($tableDef, $hasChildren) {
		...
		if ($hasChildren) {
			...
			$this->addXlsCell(array(
				'col'     => $column++,
				'row'     => $this->thisRow,
				'content' => current($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['pivot_group_by']),
				'size'    => 'auto',
				'bold'    => true,
				'align'   => 'left'
			));
		...
		foreach ($rows as $data) {
			...
			foreach ($data['values'] as $index => $value) {
				$this->addXlsCell(array(
					'col'     => $column++,
					'row'     => $this->thisRow,
					'content' => $this->outputCombinationXlsProtectNumber(chart_lab_hitung_resumo::formatValue($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung'][$tableDef]['summ'][$index], $value, true)),
					'align'   => 'right'
				));
			}
	...
	function outputCombinationWordContent($tableDef, $tableData) {
		...
		return "<html xmlns:o=\"urn:schemas-microsoft-com:office:office\" xmlns:x=\"urn:schemas-microsoft-com:office:word\" xmlns=\"http://www.w3.org/TR/REC-html40\"{$_SESSION['scriptcase']['reg_conf']['html_dir']}>\r\n" .
		       ...
		       $this->outputCombinationWordRow($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung'][$tableData], 0, array(), $tableDef, count($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['pivot_y_axys']), $hasChildren) .
		       "</table>\r\n" .
		       "</body>\r\n" .
		       "</html>\r\n";
	...
	function outputCombinationWordCss() {
		$_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['chart_export_word_css'] = 'color';

		if ('bw' == $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['chart_export_word_css']) {
			$cssFile    = "{$this->Ini->str_schema_all}_grid_bw.css";
			$cssDirFile = "{$this->Ini->str_schema_all}_grid_bw{$_SESSION['scriptcase']['reg_conf']['css_dir']}.css";
		}
		else {
	...
	function outputCombinationWordHeader($tableDef, $hasChildren) {
		...
		if ($hasChildren) {
			...
			$headers .= "<td class=\"scGridLabelFont\">" . current($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['pivot_group_by']) . "</td>\r\n";
		}
	...
	function outputCombinationWordRow($rows, $level, $parameters, $tableDef, $totalDepth, $hasChildren) {
		...
		foreach ($rows as $data) {
			...
			foreach ($data['values'] as $index => $value) {
				$outputData .= "<td class=\"scGridFieldOdd scGridFieldOddFont\">" . $this->outputCombinationWordProtectNumber(chart_lab_hitung_resumo::formatValue($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung'][$tableDef]['summ'][$index], $value, true)) . "</td>\r\n";
			}
...
SCEOT;
  ...
  function close_emb()
  {
   ...
   function SC_proc_grid_search($Parms)
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['tmp_busca'] = array();
       foreach ($tmp as $cada_f)
       {
           $dats = explode("_DYN_", $cada_f);
           if ($dats[1] == "del_grid_search_all")
           {
               foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['grid_pesq'] as $ind => $dados)
               {
                   $this->proc_del_grid_search($ind, true);
               }
               unset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['grid_pesq']);
               continue;
           }
           ...
           if (!isset($busca[$dats[0]]))
           {
               ...
               if ($dats[0] == "tgl")
               {
                   ...
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['tmp_busca'][$dats[0] . '_' . $tp] = $vl;
                   }
                   if (!empty($val1))
                   {
                       foreach ($val1 as $tp => $vl)
                       {
                          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['tmp_busca'][$dats[0] . '_input_2_' . $tp] = $vl;
                       }
                   }
               }
               else
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['tmp_busca'][$dats[0]] = (isset($fields[$ix]['vls'][0])) ? $fields[$ix]['vls'][0][0] : "";
                   if (isset($fields[$ix]['vls'][1]))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['tmp_busca'][$dats[0] . '_input_2'] = $fields[$ix]['vls'][1][0];
                   }
               }
               $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['tmp_busca'][$dats[0] . '_cond'] = $dats[1];
           }
           $ix++;
      }
      if ($_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['tmp_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['tmp_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['tmp_busca'] as $ind => $dados)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['campos_busca'][$ind] = $dados;
      }
      if (!$_SESSION['scriptcase']['proc_mobile']) 
      { 
          require_once($this->Ini->path_aplicacao . "chart_lab_hitung_pesq.class.php"); 
   ...
   function proc_del_grid_search($cmp_del, $del_all)
   {
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['campos_busca'][$cmp_del . "_dia"] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['campos_busca'][$cmp_del . "_mes"] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['campos_busca'][$cmp_del . "_ano"] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['campos_busca'][$cmp_del . "_input_2_dia"] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['campos_busca'][$cmp_del . "_input_2_mes"] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['campos_busca'][$cmp_del . "_input_2_ano"] = "";
      }
      elseif (is_array($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['campos_busca'][$cmp_del]))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['campos_busca'][$cmp_del] = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['campos_busca'][$cmp_del . "_input_2"] = array();
      }
      else
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['campos_busca'][$cmp_del] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['campos_busca'][$cmp_del . "_input_2"] = "";
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['campos_busca'][$cmp_del . "_cond"] = "";
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['grid_pesq'][$cmp_del]);
   }
/*---------*/
...
/*---------*/
   function SC_proc_opc_resumo_search($tmp)
   {
       ...
       {
           unset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['resumo_search'][$obj_id]);
           unset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['resumo_search_look'][$obj_id]);
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['Proc_Res_Search'] = true;
       $Temp_sem  = array('SU' => 0, 'MO' => 1, 'TU' => 2, 'WE' => 3, 'TH' => 4, 'FR' => 5, 'SA' => 6);
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['resumo_search'][$obj_id]))
       {
           unset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['resumo_search'][$obj_id]);
       }
       if ($tp_pesq == "clear_search_obj")
       {
           ...
           if ($tp_data == "metric")
           {
               unset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['Res_search_metric_use'][$obj_id]);
               $res_metr_name = $this->tab_res_metricas[$obj_id];
               if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['Res_search_metric'][$res_metr_name]['tot_min']))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['Res_search_metric'][$res_metr_name]['val_min'] = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['Res_search_metric'][$res_metr_name]['tot_min'];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['Res_search_metric'][$res_metr_name]['val_max'] = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['Res_search_metric'][$res_metr_name]['tot_max'];
               }
           }
           $this->SC_where_resumo_search();
           return;
       ...
       if ($tp_pesq != "bw")
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['resumo_search_look'][$obj_id] = array();
       }
       if ($tp_dado == "num" || $tp_dado == "txt")
       {
           if ($tp_pesq == "bw")
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['resumo_search_look'][$obj_id]['val_min'] = $vls[0];
               $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['resumo_search_look'][$obj_id]['val_max'] = $vls[1];
               if ($tp_data == "metric")
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['Res_search_metric_use'][$obj_id] = true;
                   $res_metr_name = $this->tab_res_metricas[$obj_id];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['Res_search_metric'][$res_metr_name]['val_min'] = NM_charset_decode($vls[0]);
                   $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['Res_search_metric'][$res_metr_name]['val_max'] = NM_charset_decode($vls[1]);
                   $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['resumo_search'][$res_metr_name] = "Metric";
               }
               else
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['resumo_search'][$obj_id] = $nam_db . " between " . NM_charset_decode($vls[0]) . " and " . NM_charset_decode($vls[1]);
               }
           }
           elseif ($tp_pesq == "eql")
           {
               if($tp_dado == "num")
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['resumo_search'][$obj_id] = $nam_db . " = " . NM_charset_decode($vls[0]);
               }
               else
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['resumo_search'][$obj_id] = $nam_db . " = " . $this->Ini->Db->qstr(NM_charset_decode($vls[0]));
               }
               $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['resumo_search_look'][$obj_id][] = $vls[0];
           }
           else
           {
               $t_val = "";
               foreach ($vls as $cada_val)
               {
                   ...
                   $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['resumo_search_look'][$obj_id][] = $cada_val;
               }
               if (!empty($t_val) && $t_val != "''")
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['resumo_search'][$obj_id] = $nam_db . " IN (" . $t_val . ")";
               }
           }
       }
       else
       {
           ...
           if ($tp_data == "actual")
           {
               ...
               foreach ($vls as $cada_opc)
               {
                   ...
                   if ($cada_opc != "")
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['resumo_search_look'][$obj_id][] = $cada_opc;
                   }
               }
               if (!empty($result))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['resumo_search'][$obj_id] = $result;
               }
           }
           elseif ($tp_data == "realtive")
           {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['resumo_search_look'][$obj_id] = $vls;
               $result = "";
               foreach ($vls as $cada_opc)
               {
                   if (empty($cada_opc)) { continue; }
           ...
           elseif ($tp_data == "range")
           {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['resumo_search'][$obj_id] = $nam_db . " between " . $delim . $vls[0] . $delim1 . " and " . $delim . $vls[1] . $delim1;
           }
       }
       $this->SC_where_resumo_search();
   }
   ...
   {
      $tmp_cmd = "";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['where_orig'])) 
      {
          $tmp_cmd = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['where_orig']; 
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['where_pesq_filtro'])) 
      {
          if (!empty($tmp_cmd)) 
          {
              $tmp_cmd .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['where_pesq_filtro'] . ")"; 
          }
          else
          {
              $tmp_cmd = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['where_pesq_filtro'] . ")"; 
          }
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['where_res_lookup'] = $tmp_cmd;
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['where_resumo_search'] = "";
      $prim = true;
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['resumo_search'])) 
      {
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['resumo_search'] as $cmp => $val) 
          {
              if ($val != "Metric")
              {
                  if (!$prim)
                  {
                     $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['where_resumo_search'] .= " and ";
                  }
                  $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['where_resumo_search'] .= "(" . $val . ")";
                  $prim = false;
              }
          }
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['where_resumo_search'])) 
      {
          if (!empty($tmp_cmd)) 
          {
              $tmp_cmd .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['where_resumo_search'] . ")"; 
          }
          else
          {
              $tmp_cmd = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['where_resumo_search'] . ")"; 
          }
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['where_pesq'] = $tmp_cmd;
   }
   function Recupera_where()
   {
      if (in_array($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['opcao'], array('word_res', 'xls_res', 'xml_res', 'csv_res', 'rtf_res', 'ajax_comb_table', 'ajax_comb_save', 'ajax_comb_file_view', 'ajax_comb_file_download'))) {
          return;
      }
      $tmp_cmd = "";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['where_orig'])) 
  ...
  function html_doc_word($nm_arquivo_doc_word, $nmgp_password)
  {
      ...
      { 
          ...
          $Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['word_file'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['word_file'], ".");
          if ($Pos !== false) {
              $Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['word_file'], 0, $Pos);
          }
          $Arq_zip .= ".zip";
          ...
          $Arq_input = (FALSE !== strpos($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['word_file'], ' ')) ? " \"" . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['word_file'] . "\"" :  $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['word_file'];
           if (is_file($Arq_zip)) {
               unlink($Arq_zip);
           }
           $str_zip = "";
           ...
           if (is_file($Arq_zip)) {
               unlink($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['word_file']);
               $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['word_file'] = $Arq_zip;
               $nm_arquivo_doc_word = $Arq_doc;
          } 
      } 
      if ($this->Ini->sc_export_ajax)
      {
          $this->Arr_result['file_export']  = NM_charset_to_utf8($_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung']['word_file']);
      ...
      if (strpos(" " . $this->Ini->SC_module_export, "grid") !== false)
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung'][$path_doc_md5][0] = $this->Ini->path_imag_temp . $nm_arquivo_doc_word;
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung'][$path_doc_md5][1] = substr($nm_arquivo_doc_word, 1);
          require_once($this->Ini->path_lib_php . "/sc_progress_bar.php");
          $this->pb = new scProgressBar();
          $this->pb->setRoot($this->Ini->root);
          $this->pb->setDir($_SESSION['scriptcase']['chart_lab_hitung']['glo_nm_path_imag_temp'] . "/");
...
<HTML<?php echo $_SESSION['scriptcase']['reg_conf']['html_dir'] ?>>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_chart_title'] ?> Statistik IGD :: Doc</TITLE>
...
<form name="Fdown" method="get" action="chart_lab_hitung_download.php" target="_blank" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="chart_lab_hitung"> 
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      ...
      $Html_password = "";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung'][$path_doc_md5][0] = $this->Ini->path_imag_temp . $nm_arquivo_html;
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_lab_hitung'][$path_doc_md5][1] = substr($nm_arquivo_html, 1);
          require_once($this->Ini->path_lib_php . "/sc_progress_bar.php");
          $this->pb = new scProgressBar();
          $this->pb->setRoot($this->Ini->root);
          $this->pb->setDir($_SESSION['scriptcase']['chart_lab_hitung']['glo_nm_path_imag_temp'] . "/");
...
// 
//======= =========================
   if (isset($_SESSION['scriptcase']['chart_lab_hitung']['sc_process_barr'])) {
       return;
   }
   ...
   $_SESSION['scriptcase']['chart_lab_hitung']['contr_erro'] = 'off';
   $sc_conv_var = array();
   $Sc_lig_md5 = false;
   ...
   if (!empty($_POST))
   {
       ...
       foreach ($_POST as $nmgp_var => $nmgp_val)
       {
            ...
            nm_limpa_str_chart_lab_hitung($nmgp_val);
            $nmgp_val = NM_decode_input($nmgp_val);
            nm_protect_num_chart_lab_hitung($nmgp_var, $nmgp_val);
            $$nmgp_var = $nmgp_val;
       }
   }
   if (!empty($_GET))
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['chart_lab_hitung']['glo_nm_path_imag_temp'] . "/sc_apl_default_simrskreatifmedia.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['chart_lab_hitung']['glo_nm_path_imag_temp'] . "/sc_apl_default_simrskreatifmedia.txt"));
       }
       if (isset($apl_def)) {
           if ($apl_def[0] != "chart_lab_hitung") {
               $_SESSION['scriptcase']['sem_session'] = true;
               if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                   $_SESSION['scriptcase']['chart_lab_hitung']['session_timeout']['redir'] = $apl_def[0];
               }
               else {
                   $_SESSION['scriptcase']['chart_lab_hitung']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
               }
               $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
               $_SESSION['scriptcase']['chart_lab_hitung']['session_timeout']['redir_tp'] = $Redir_tp;
           }
           if (isset($_COOKIE['sc_actual_lang_simrskreatifmedia'])) {
               $_SESSION['scriptcase']['chart_lab_hitung']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_simrskreatifmedia'];
           }
       }
   }
   ...
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['chart_lab_hitung']['embutida_pai']))
   {
       $apl_pai = $_SESSION['sc_session'][$script_case_init]['chart_lab_hitung']['embutida_pai'];
       if (isset($_SESSION['sc_session'][$script_case_init][$apl_pai]['embutida_filho']))
       {
           ...
           {
               if (isset($_SESSION['sc_session'][$init_filho]['chart_lab_hitung']['master_pai']) && $_SESSION['sc_session'][$init_filho]['chart_lab_hitung']['master_pai'] == $script_case_init)
               {
   ...
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['chart_lab_hitung']['embutida_form']) && $_SESSION['sc_session'][$script_case_init]['chart_lab_hitung']['embutida_form'] && !isset($_SESSION['sc_session'][$script_case_init]['chart_lab_hitung']['master_pai']))
   {
       $SC_init_ant = $script_case_init;
       $script_case_init = rand(2, 10000);
       if (isset($_SESSION['sc_session'][$SC_init_ant]['chart_lab_hitung']['embutida_pai']))
       {
           $_SESSION['sc_session'][$SC_init_ant][$_SESSION['sc_session'][$SC_init_ant]['chart_lab_hitung']['embutida_pai']]['embutida_filho'][] = $script_case_init;
       }
       $_SESSION['sc_session'][$script_case_init]['chart_lab_hitung']['master_pai'] = $SC_init_ant;
   }
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['chart_lab_hitung']['master_pai']))
   {
       $SC_init_ant = $_SESSION['sc_session'][$script_case_init]['chart_lab_hitung']['master_pai'];
       if (!isset($_SESSION['sc_session'][$SC_init_ant]['chart_lab_hitung']['embutida_form_parms']))
       {
           $_SESSION['sc_session'][$SC_init_ant]['chart_lab_hitung']['embutida_form_parms'] = "";
       }
       $_SESSION['sc_session'][$script_case_init]['chart_lab_hitung']['embutida_form_parms'] = $_SESSION['sc_session'][$SC_init_ant]['chart_lab_hitung']['embutida_form_parms'];
       $_SESSION['sc_session'][$script_case_init]['chart_lab_hitung']['embutida_form'] = true;
       $_SESSION['sc_session'][$script_case_init]['chart_lab_hitung']['embutida_form_full'] = (isset($_SESSION['sc_session'][$SC_init_ant]['chart_lab_hitung']['embutida_form_full'])) ? $_SESSION['sc_session'][$SC_init_ant]['chart_lab_hitung']['embutida_form_full'] : false;
       $_SESSION['sc_session'][$script_case_init]['chart_lab_hitung']['reg_start'] = "";
       $_SESSION['sc_session'][$script_case_init]['chart_lab_hitung']['opcao'] = "inicio";
       unset($_SESSION['sc_session'][$SC_init_ant]['chart_lab_hitung']['embutida_form']);
       unset($_SESSION['sc_session'][$SC_init_ant]['chart_lab_hitung']['embutida_form_parms']);
   }
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['chart_lab_hitung']['embutida_form_parms'])) 
   {
       if (!empty($_SESSION['sc_session'][$script_case_init]['chart_lab_hitung']['embutida_form_parms'])) 
       {
           $nmgp_parms = $_SESSION['sc_session'][$script_case_init]['chart_lab_hitung']['embutida_form_parms'];
           $_SESSION['sc_session'][$script_case_init]['chart_lab_hitung']['embutida_form_parms'] = "";
       }
   }
   elseif (isset($script_case_init))
   {
       unset($_SESSION['sc_session'][$script_case_init]['chart_lab_hitung']['embutida_form']);
       unset($_SESSION['sc_session'][$script_case_init]['chart_lab_hitung']['embutida_form_full']);
       unset($_SESSION['sc_session'][$script_case_init]['chart_lab_hitung']['embutida_form_parms']);
   }
   if (!isset($nmgp_opcao) || !isset($script_case_init) || ((!isset($_SESSION['sc_session'][$script_case_init]['chart_lab_hitung']['embutida']) || !$_SESSION['sc_session'][$script_case_init]['chart_lab_hitung']['embutida']) && $nmgp_opcao != "formphp"))
   { 
       if (!empty($nmgp_parms)) 
       { 
           ...
           { 
               unset($_SESSION['sc_session'][$script_case_init]['chart_lab_hitung']);
               $_SESSION['sc_session'][$script_case_init]['chart_lab_hitung']['b_sair'] = false;
           }   
       } 
   } 
   $ini_embutida = "";
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['chart_lab_hitung']['embutida']) && $_SESSION['sc_session'][$script_case_init]['chart_lab_hitung']['embutida'])
   {
       $nmgp_outra_jan = "";
   }
   ...
   if (isset($GLOBALS["script_case_init"]) && !empty($GLOBALS["script_case_init"]))
   {
       $ini_embutida = $GLOBALS["script_case_init"];
        if (!isset($_SESSION['sc_session'][$ini_embutida]['chart_lab_hitung']['embutida']))
        { 
           $_SESSION['sc_session'][$ini_embutida]['chart_lab_hitung']['embutida'] = false;
        }
        if (!$_SESSION['sc_session'][$ini_embutida]['chart_lab_hitung']['embutida'])
        { 
           $script_case_init = $ini_embutida;
        }
   }
   if (isset($_SESSION['scriptcase']['chart_lab_hitung']['protect_modal']) && !empty($_SESSION['scriptcase']['chart_lab_hitung']['protect_modal']))
   {
       $script_case_init = $_SESSION['scriptcase']['chart_lab_hitung']['protect_modal'];
   }
   ...
   $salva_emb    = false;
   $salva_iframe = false;
   $_SESSION['sc_session'][$script_case_init]['chart_lab_hitung']['doc_word'] = false;
   $_SESSION['scriptcase']['saida_word'] = false;
   if (!isset($_SESSION['sc_session'][$script_case_init]['chart_lab_hitung']['skip_charts']))
   {
       $_SESSION['sc_session'][$script_case_init]['chart_lab_hitung']['skip_charts'] = false;
   }
   if (isset($_REQUEST['sc_create_charts']))
   {
       $_SESSION['sc_session'][$script_case_init]['chart_lab_hitung']['skip_charts'] = 'N' == $_REQUEST['sc_create_charts'];
   }
   if (isset($_SESSION['sc_session'][$script_case_init]['chart_lab_hitung']['iframe_menu']))
   {
       $salva_iframe = $_SESSION['sc_session'][$script_case_init]['chart_lab_hitung']['iframe_menu'];
       unset($_SESSION['sc_session'][$script_case_init]['chart_lab_hitung']['iframe_menu']);
   }
   if (isset($_SESSION['sc_session'][$script_case_init]['chart_lab_hitung']['embutida']))
   {
       $salva_emb = $_SESSION['sc_session'][$script_case_init]['chart_lab_hitung']['embutida'];
       unset($_SESSION['sc_session'][$script_case_init]['chart_lab_hitung']['embutida']);
   }
   if (isset($nm_run_menu) && $nm_run_menu == 1 && !$salva_emb)
   {
        ...
        $_SESSION['scriptcase']['sc_apl_menu_atual'] = "chart_lab_hitung";
        $achou = false;
        if (isset($_SESSION['sc_session'][$script_case_init]))
        {
            foreach ($_SESSION['sc_session'][$script_case_init] as $nome_apl => $resto)
            {
                if ($nome_apl == 'chart_lab_hitung' || $achou)
                {
        ...
        $_SESSION['sc_session'][$script_case_init]['chart_lab_hitung']['iframe_menu'] = true;
   }
   else
   {
       $_SESSION['sc_session'][$script_case_init]['chart_lab_hitung']['iframe_menu'] = $salva_iframe;
   }
   $_SESSION['sc_session'][$script_case_init]['chart_lab_hitung']['embutida'] = $salva_emb;

   if (!isset($_SESSION['sc_session'][$script_case_init]['chart_lab_hitung']['initialize']))
   {
       $_SESSION['sc_session'][$script_case_init]['chart_lab_hitung']['initialize'] = true;
   }
   elseif (!isset($_SERVER['HTTP_REFERER']))
   {
       $_SESSION['sc_session'][$script_case_init]['chart_lab_hitung']['initialize'] = false;
   }
   elseif (false === strpos($_SERVER['HTTP_REFERER'], '/chart_lab_hitung/'))
   {
       $_SESSION['sc_session'][$script_case_init]['chart_lab_hitung']['initialize'] = true;
   }
   else
   ...
   if ($_SESSION['sc_session'][$script_case_init]['chart_lab_hitung']['initialize'])
   {
       unset($_SESSION['sc_session'][$script_case_init]['chart_lab_hitung']['tot_geral']);
       $_SESSION['sc_session'][$script_case_init]['chart_lab_hitung']['contr_total_geral'] = "NAO";
   }

   $_POST['script_case_init'] = $script_case_init;
   if (isset($nmgp_opcao) && $nmgp_opcao == "busca" && isset($nmgp_orig_pesq))
   {
       $_SESSION['sc_session'][$script_case_init]['chart_lab_hitung']['orig_pesq'] = $nmgp_orig_pesq;
   }
   if (!isset($nmgp_opcao) || empty($nmgp_opcao) || $nmgp_opcao == "grid" && (!isset($_SESSION['sc_session'][$script_case_init]['chart_lab_hitung']['b_sair'])))
   {
       $_SESSION['sc_session'][$script_case_init]['chart_lab_hitung']['b_sair'] = true;
   }
   if (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'chart_lab_hitung')
   {
       $_SESSION['sc_session'][$script_case_init]['chart_lab_hitung']['sc_outra_jan'] = true;
        unset($_SESSION['scriptcase']['sc_outra_jan']);
   }
   $_SESSION['sc_session'][$script_case_init]['chart_lab_hitung']['menu_desenv'] = false;   
   if (!defined("SC_ERROR_HANDLER"))
   {
       define("SC_ERROR_HANDLER", 1);
       include_once(dirname(__FILE__) . "/chart_lab_hitung_erro.php");
   }
   ...
   if (!$_SESSION['sc_session'][$script_case_init]['chart_lab_hitung']['embutida'] && $nmgp_opcao != "formphp")
   { 
       ...
       { 
           ...
           $_SESSION['sc_session'][$script_case_init]['chart_lab_hitung']['sc_change_lang'] = true;
           unset($_SESSION['sc_session'][$script_case_init]['chart_lab_hitung']['tot_geral']);
           $_SESSION['sc_session'][$script_case_init]['chart_lab_hitung']['contr_total_geral'] = "NAO";
       ...
       { 
           ...
           $_SESSION['sc_session'][$script_case_init]['chart_lab_hitung']['num_css'] = rand(0, 1000);
       } 
       ...
       if (!empty($nmgp_opcao))  
       { 
           $_SESSION['sc_session'][$script_case_init]['chart_lab_hitung']['opcao'] = $nmgp_opcao ;  
       }   
       if (isset($nmgp_lig_edit_lapis)) 
       {
          $_SESSION['sc_session'][$script_case_init]['chart_lab_hitung']['mostra_edit'] = $nmgp_lig_edit_lapis;
       ...
       $nm_saida = "";
       if (isset($_SESSION['sc_session'][$script_case_init]['chart_lab_hitung']['volta_redirect_apl']) && !empty($_SESSION['sc_session'][$script_case_init]['chart_lab_hitung']['volta_redirect_apl']))
       {
           $_SESSION['scriptcase']['sc_url_saida'][$script_case_init] = $_SESSION['sc_session'][$script_case_init]['chart_lab_hitung']['volta_redirect_apl']; 
           $nm_apl_dependente = $_SESSION['sc_session'][$script_case_init]['chart_lab_hitung']['volta_redirect_tp']; 
           $_SESSION['sc_session'][$script_case_init]['chart_lab_hitung']['volta_redirect_apl'] = "";
           $_SESSION['sc_session'][$script_case_init]['chart_lab_hitung']['volta_redirect_tp'] = "";
           $nm_url_saida = "chart_lab_hitung_fim.php"; 
       
       }
       elseif (substr($_SESSION['sc_session'][$script_case_init]['chart_lab_hitung']['opcao'], 0, 7) != "grafico" && $_SESSION['sc_session'][$script_case_init]['chart_lab_hitung']['opcao'] != "pdf" ) 
       {
           if (isset($_SESSION['sc_session'][$script_case_init]['chart_lab_hitung']['sc_outra_jan']) && $_SESSION['sc_session'][$script_case_init]['chart_lab_hitung']['sc_outra_jan'])
           {
               if ($nmgp_url_saida == "modal")
               {
                   $_SESSION['sc_session'][$script_case_init]['chart_lab_hitung']['sc_modal'] = true;
               }
               $nm_url_saida = "chart_lab_hitung_fim.php"; 
           }
           else
           {
               ...
               { 
                   $_SESSION['sc_session'][$script_case_init]['chart_lab_hitung']['retorno_cons'] = $nmgp_url_saida ; 
               } 
               if (!empty($_SESSION['sc_session'][$script_case_init]['chart_lab_hitung']['retorno_cons'])) 
               { 
                   $nm_url_saida = $_SESSION['sc_session'][$script_case_init]['chart_lab_hitung']['retorno_cons']  . "?script_case_init=" . NM_encode_input($script_case_init);  
                   $nm_apl_dependente = 1 ; 
               } 
...
// 
       if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && substr($_SESSION['sc_session'][$script_case_init]['chart_lab_hitung']['opcao'], 0, 7) != "grafico" && $_SESSION['sc_session'][$script_case_init]['chart_lab_hitung']['opcao'] != "pdf" ) 
       { 
            $_SESSION['scriptcase']['sc_url_saida'][$script_case_init] = $_SESSION['scriptcase']['nm_sc_retorno']; 
            $_SESSION['sc_session'][$script_case_init]['chart_lab_hitung']['menu_desenv'] = true;   
       } 
       if (isset($nmgp_parms_ret)) 
       {
           ...
           $_SESSION['sc_session'][$script_case_init]['chart_lab_hitung']['form_psq_ret']  = $todo[0];
           $_SESSION['sc_session'][$script_case_init]['chart_lab_hitung']['campo_psq_ret'] = $todo[1];
           $_SESSION['sc_session'][$script_case_init]['chart_lab_hitung']['dado_psq_ret']  = $todo[2];
           $_SESSION['sc_session'][$script_case_init]['chart_lab_hitung']['js_apos_busca'] = $nm_evt_ret_busca;
           $_SESSION['sc_session'][$script_case_init]['chart_lab_hitung']['opc_psq'] = true;   
           if (isset($nmgp_iframe_ret)) 
           {
               $_SESSION['sc_session'][$script_case_init]['chart_lab_hitung']['iframe_ret_cap'] = $nmgp_iframe_ret;
           }
       } 
       elseif (!isset($_SESSION['sc_session'][$script_case_init]['chart_lab_hitung']['opc_psq']))
       {
           $_SESSION['sc_session'][$script_case_init]['chart_lab_hitung']['opc_psq'] = false ;   
       } 
       if (isset($_SESSION['sc_session'][$script_case_init]['chart_lab_hitung']['embutida_form']) && $_SESSION['sc_session'][$script_case_init]['chart_lab_hitung']['embutida_form'])
       {
           if (!isset($_SESSION['sc_session'][$script_case_init]['chart_lab_hitung']['embutida_form_full']) || !$_SESSION['sc_session'][$script_case_init]['chart_lab_hitung']['embutida_form_full'])
           {
               $_SESSION['sc_session'][$script_case_init]['chart_lab_hitung']['mostra_edit'] = "N";   
           } 
       ...
       $contr_chart_lab_hitung = new chart_lab_hitung_apl();

      if ('ajax_autocomp' == $nmgp_opcao)
      {
          $nmgp_opcao = 'busca';
          $_SESSION['sc_session'][$script_case_init]['chart_lab_hitung']['opcao'] = "busca";
          $contr_chart_lab_hitung->NM_ajax_flag = true;
          $contr_chart_lab_hitung->NM_ajax_opcao = $NM_ajax_opcao;
      }
      if ('ajax_filter_save' == $nmgp_opcao)
      {
          ...
          $_SESSION['sc_session'][$script_case_init]['chart_lab_hitung']['opcao'] = "busca";
          $contr_chart_lab_hitung->NM_ajax_flag = true;
          $contr_chart_lab_hitung->NM_ajax_opcao = "ajax_filter_save";
      }
      if ('ajax_filter_delete' == $nmgp_opcao)
      {
          ...
          $_SESSION['sc_session'][$script_case_init]['chart_lab_hitung']['opcao'] = "busca";
          $contr_chart_lab_hitung->NM_ajax_flag = true;
          $contr_chart_lab_hitung->NM_ajax_opcao = "ajax_filter_delete";
      }
      if ('ajax_filter_select' == $nmgp_opcao)
      {
          ...
          $_SESSION['sc_session'][$script_case_init]['chart_lab_hitung']['opcao'] = "busca";
          $contr_chart_lab_hitung->NM_ajax_flag = true;
          $contr_chart_lab_hitung->NM_ajax_opcao = "ajax_filter_select";
      }
      if ('ajax_comb_table' == $nmgp_opcao)
      {
          $contr_chart_lab_hitung->NM_ajax_flag = true;
          $contr_chart_lab_hitung->NM_ajax_opcao = "ajax_comb_table";
      }
      if ('ajax_comb_save' == $nmgp_opcao)
      {
          $contr_chart_lab_hitung->NM_ajax_flag = true;
          $contr_chart_lab_hitung->NM_ajax_opcao = "ajax_comb_save";
      }
      if ('ajax_comb_sort' == $nmgp_opcao)
      {
          $contr_chart_lab_hitung->NM_ajax_flag = true;
          $contr_chart_lab_hitung->NM_ajax_opcao = "ajax_comb_sort";
      }
       $contr_chart_lab_hitung->controle();
   } 
   if (!$_SESSION['sc_session'][$script_case_init]['chart_lab_hitung']['embutida'] && $nmgp_opcao == "formphp")
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 0;  
...
//
   function nm_limpa_str_chart_lab_hitung(&$str)
   {
   ...
   function nm_protect_num_chart_lab_hitung($name, &$val)
   {
       if (empty($val))
       {
          return;
   ...
   function chart_lab_hitung_pack_protect_string($sString)
   {
