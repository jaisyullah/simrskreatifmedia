...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "id";$Nm_numeric[] = "id_karyawan";$Nm_numeric[] = "id";$Nm_numeric[] = "id_karyawan";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_tahun_lulus_cond" name="tahun_lulus_cond" onChange="nm_campos_between(document.getElementById('id_vis_tahun_lulus'), this, 'tahun_lulus')">
      ...
      <br><span id="id_hide_tahun_lulus"  <?php echo $str_hide_tahun_lulus?>><?php
      if ($tahun_lulus != "")
      {
      $tahun_lulus_look = substr($this->Db->qstr($tahun_lulus), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_level_cond" name="level_cond" onChange="nm_campos_between(document.getElementById('id_vis_level'), this, 'level')">
      ...
      <br><span id="id_hide_level"  <?php echo $str_hide_level?>><?php
      if ($level != "")
      {
      $level_look = substr($this->Db->qstr($level), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_lembaga_cond" name="lembaga_cond" onChange="nm_campos_between(document.getElementById('id_vis_lembaga'), this, 'lembaga')">
      ...
      <br><span id="id_hide_lembaga"  <?php echo $str_hide_lembaga?>><?php
      if ($lembaga != "")
      {
      $lembaga_look = substr($this->Db->qstr($lembaga), 1, -1); 
      $nmgp_def_dados = array(); 
