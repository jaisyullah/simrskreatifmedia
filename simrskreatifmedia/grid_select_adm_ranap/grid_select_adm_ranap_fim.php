...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_select_adm_ranap"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_select_adm_ranap"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_select_adm_ranap']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_select_adm_ranap']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_select_adm_ranap']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_select_adm_ranap']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_select_adm_ranap']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_select_adm_ranap</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_select_adm_ranap']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_select_adm_ranap']['embutida_filho'] as $ind => $sc_init)
          {
