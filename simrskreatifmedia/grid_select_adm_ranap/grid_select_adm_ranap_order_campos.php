<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_select_adm_ranap']['glo_nm_path_imag_temp'] . "/sc_apl_default_simrskreatifmedia.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_select_adm_ranap_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_select_adm_ranap_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_select_adm_ranap']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_select_adm_ranap']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["trancode"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_select_adm_ranap']['labels']["trancode"])) ? $_SESSION['sc_session'][$sc_init]['grid_select_adm_ranap']['labels']["trancode"] : "Tran Code";
   $tab_ger_campos['custcode'] = "on";
   $tab_def_campos['custcode'] = "custCode";
   $tab_labels["custcode"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_select_adm_ranap']['labels']["custcode"])) ? $_SESSION['sc_session'][$sc_init]['grid_select_adm_ranap']['labels']["custcode"] : "Cust Code";
...
ORDER BY name, salut";
   ...
   $tab_labels["sc_field_0"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_select_adm_ranap']['labels']["sc_field_0"])) ? $_SESSION['sc_session'][$sc_init]['grid_select_adm_ranap']['labels']["sc_field_0"] : "Nama Pasien";
   $tab_ger_campos['tglmasuk'] = "on";
   $tab_def_campos['tglmasuk'] = "tglMasuk";
   $tab_labels["tglmasuk"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_select_adm_ranap']['labels']["tglmasuk"])) ? $_SESSION['sc_session'][$sc_init]['grid_select_adm_ranap']['labels']["tglmasuk"] : "Tgl Masuk";
   $tab_ger_campos['pembayaran'] = "on";
   $tab_def_campos['pembayaran'] = "pembayaran";
   $tab_labels["pembayaran"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_select_adm_ranap']['labels']["pembayaran"])) ? $_SESSION['sc_session'][$sc_init]['grid_select_adm_ranap']['labels']["pembayaran"] : "Pembayaran";
   $tab_ger_campos['kelas'] = "on";
   $tab_def_campos['kelas'] = "kelas";
   $tab_labels["kelas"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_select_adm_ranap']['labels']["kelas"])) ? $_SESSION['sc_session'][$sc_init]['grid_select_adm_ranap']['labels']["kelas"] : "Kelas";
   $tab_ger_campos['bed'] = "on";
   $tab_def_campos['bed'] = "bed";
   $tab_labels["bed"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_select_adm_ranap']['labels']["bed"])) ? $_SESSION['sc_session'][$sc_init]['grid_select_adm_ranap']['labels']["bed"] : "Bed";
   $tab_ger_campos['paket'] = "on";
   $tab_def_campos['paket'] = "paket";
   $tab_labels["paket"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_select_adm_ranap']['labels']["paket"])) ? $_SESSION['sc_session'][$sc_init]['grid_select_adm_ranap']['labels']["paket"] : "Paket";
   $tab_ger_campos['caramasuk'] = "on";
   $tab_def_campos['caramasuk'] = "caraMasuk";
   $tab_labels["caramasuk"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_select_adm_ranap']['labels']["caramasuk"])) ? $_SESSION['sc_session'][$sc_init]['grid_select_adm_ranap']['labels']["caramasuk"] : "Cara Masuk";
   $tab_ger_campos['status'] = "on";
   $tab_def_campos['status'] = "status";
   $tab_labels["status"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_select_adm_ranap']['labels']["status"])) ? $_SESSION['sc_session'][$sc_init]['grid_select_adm_ranap']['labels']["status"] : "Status";
   $tab_ger_campos['unitasal'] = "on";
   $tab_def_campos['unitasal'] = "unitAsal";
   $tab_labels["unitasal"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_select_adm_ranap']['labels']["unitasal"])) ? $_SESSION['sc_session'][$sc_init]['grid_select_adm_ranap']['labels']["unitasal"] : "Unit Asal";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_select_adm_ranap']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_select_adm_ranap']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_select_adm_ranap']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_select_adm_ranap']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_select_adm_ranap']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_select_adm_ranap']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_select_adm_ranap']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_select_adm_ranap']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_select_adm_ranap']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - Adm Pasien Ranap</TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_select_adm_ranap_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_select_adm_ranap']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_select_adm_ranap']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_select_adm_ranap']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_select_adm_ranap']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_select_adm_ranap']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
