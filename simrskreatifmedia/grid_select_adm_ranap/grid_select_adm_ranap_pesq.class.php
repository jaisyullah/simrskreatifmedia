...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - Adm Pasien Ranap</TITLE>
...
?>
      ...
      <TD id='SC_pembayaran_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['pembayaran'])) ? $this->New_label['pembayaran'] : "Pembayaran"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_pembayaran_cond" name="pembayaran_cond" onChange="nm_campos_between(document.getElementById('id_vis_pembayaran'), this, 'pembayaran')">
