...
class grid_select_adm_ranap_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_adm_ranap']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_select_adm_ranap_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_select_adm_ranap_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_select_adm_ranap_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function lookup_ajax_trancode($trancode)
   {
      ...
      $nm_comando = "select distinct tranCode from " . $this->Ini->nm_tabela . " where status = 'Daftar' or status = 'Pelayanan' and  tranCode like '%" . $trancode . "%' order by tranCode"; 
      unset($cmp1,$cmp2);
   ...
   function lookup_ajax_custcode($custcode)
   {
      ...
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct custCode from " . $this->Ini->nm_tabela . " where status = 'Daftar' or status = 'Pelayanan' and  custCode like '%" . $custcode . "%' order by custCode"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
   ...
   function lookup_ajax_pembayaran($pembayaran)
   {
      ...
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct pembayaran from " . $this->Ini->nm_tabela . " where status = 'Daftar' or status = 'Pelayanan' and  pembayaran like '%" . $pembayaran . "%' order by pembayaran"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_adm_ranap']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_adm_ranap']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_adm_ranap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_adm_ranap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_adm_ranap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_adm_ranap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_adm_ranap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_adm_ranap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_adm_ranap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_adm_ranap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_adm_ranap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_adm_ranap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_adm_ranap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_adm_ranap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_adm_ranap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_adm_ranap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_adm_ranap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_select_adm_ranap/grid_select_adm_ranap_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_select_adm_ranap_ajax_search.js"></script>
 <script type="text/javascript" src="grid_select_adm_ranap_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_select_adm_ranap_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_select_adm_ranap']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_select_adm_ranap']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_adm_ranap']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div class="scFilterHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFilterHeaderFont" style="float: left; text-transform: uppercase;"><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - Adm Pasien Ranap</div>
...
<?php
   ...
   function monta_form()
   {
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_adm_ranap']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_adm_ranap']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_adm_ranap']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_adm_ranap']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $trancode = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_adm_ranap']['campos_busca']['trancode']; 
          $trancode_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_adm_ranap']['campos_busca']['trancode_cond']; 
          $custcode = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_adm_ranap']['campos_busca']['custcode']; 
          $custcode_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_adm_ranap']['campos_busca']['custcode_cond']; 
          $tglmasuk_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_adm_ranap']['campos_busca']['tglmasuk_dia']; 
          $tglmasuk_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_adm_ranap']['campos_busca']['tglmasuk_mes']; 
          $tglmasuk_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_adm_ranap']['campos_busca']['tglmasuk_ano']; 
          $tglmasuk_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_adm_ranap']['campos_busca']['tglmasuk_input_2_dia']; 
          $tglmasuk_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_adm_ranap']['campos_busca']['tglmasuk_input_2_mes']; 
          $tglmasuk_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_adm_ranap']['campos_busca']['tglmasuk_input_2_ano']; 
          $tglmasuk_hor = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_adm_ranap']['campos_busca']['tglmasuk_hor']; 
          $tglmasuk_min = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_adm_ranap']['campos_busca']['tglmasuk_min']; 
          $tglmasuk_seg = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_adm_ranap']['campos_busca']['tglmasuk_seg']; 
          $tglmasuk_input_2_hor = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_adm_ranap']['campos_busca']['tglmasuk_input_2_hor']; 
          $tglmasuk_input_2_min = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_adm_ranap']['campos_busca']['tglmasuk_input_2_min']; 
          $tglmasuk_input_2_seg = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_adm_ranap']['campos_busca']['tglmasuk_input_2_seg']; 
          $tglmasuk_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_adm_ranap']['campos_busca']['tglmasuk_cond']; 
          $pembayaran = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_adm_ranap']['campos_busca']['pembayaran']; 
          $pembayaran_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_adm_ranap']['campos_busca']['pembayaran_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_adm_ranap']['campos_busca']['NM_operador']; 
      } 
      ...
      if (!isset($pembayaran_cond) || empty($pembayaran_cond))
      {
         $pembayaran_cond = "qp";
      }
      ...
      $str_display_pembayaran = ('bw' == $pembayaran_cond) ? $display_aberto : $display_fechado;
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      ...
      $trancode_look = substr($this->Db->qstr($trancode), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct tranCode from " . $this->Ini->nm_tabela . " where status = 'Daftar' or status = 'Pelayanan' and tranCode = '$trancode_look' order by tranCode"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      ...
      $custcode_look = substr($this->Db->qstr($custcode), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct custCode from " . $this->Ini->nm_tabela . " where status = 'Daftar' or status = 'Pelayanan' and custCode = '$custcode_look' order by custCode"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_tglmasuk_cond" name="tglmasuk_cond" onChange="nm_campos_between(document.getElementById('id_vis_tglmasuk'), this, 'tglmasuk')">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_pembayaran_cond" name="pembayaran_cond" onChange="nm_campos_between(document.getElementById('id_vis_pembayaran'), this, 'pembayaran')">
       <OPTION value="qp" <?php if ("qp" == $pembayaran_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $pembayaran_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $pembayaran_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $pembayaran_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
      <br><span id="id_hide_pembayaran"  <?php echo $str_hide_pembayaran?>><?php
      if ($pembayaran != "")
      {
      $pembayaran_look = substr($this->Db->qstr($pembayaran), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct pembayaran from " . $this->Ini->nm_tabela . " where status = 'Daftar' or status = 'Pelayanan' and pembayaran = '$pembayaran_look' order by pembayaran"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
...
?>
<INPUT  type="text" id="SC_pembayaran" name="pembayaran" value="<?php echo NM_encode_input($pembayaran) ?>"  size=15 alt="{datatype: 'text', maxLength: 15, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_pembayaran" name="pembayaran_autocomp" size="15"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 15, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
?>
<?php
   if (is_file("grid_select_adm_ranap_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_select_adm_ranap']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_select_adm_ranap']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_adm_ranap']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.pembayaran_cond.value = 'qp';
 ...
 {
    $('#SC_tglmasuk_dia').bind('change', function() {sc_grid_select_adm_ranap_valida_dia(this)});
    $('#SC_tglmasuk_hor').bind('change', function() {sc_grid_select_adm_ranap_valida_hora(this)});
    $('#SC_tglmasuk_input_2_dia').bind('change', function() {sc_grid_select_adm_ranap_valida_dia(this)});
    $('#SC_tglmasuk_input_2_hor').bind('change', function() {sc_grid_select_adm_ranap_valida_hora(this)});
    $('#SC_tglmasuk_input_2_mes').bind('change', function() {sc_grid_select_adm_ranap_valida_mes(this)});
    $('#SC_tglmasuk_input_2_min').bind('change', function() {sc_grid_select_adm_ranap_valida_min(this)});
    $('#SC_tglmasuk_input_2_seg').bind('change', function() {sc_grid_select_adm_ranap_valida_seg(this)});
    $('#SC_tglmasuk_mes').bind('change', function() {sc_grid_select_adm_ranap_valida_mes(this)});
    $('#SC_tglmasuk_min').bind('change', function() {sc_grid_select_adm_ranap_valida_min(this)});
    $('#SC_tglmasuk_seg').bind('change', function() {sc_grid_select_adm_ranap_valida_seg(this)});
 }
 function sc_grid_select_adm_ranap_valida_dia(obj)
 {
 ...
 function sc_grid_select_adm_ranap_valida_mes(obj)
 {
 ...
 function sc_grid_select_adm_ranap_valida_hora(obj)
 {
 ...
 function sc_grid_select_adm_ranap_valida_min(obj)
 {
 ...
 function sc_grid_select_adm_ranap_valida_seg(obj)
 {
     if (obj.value != "" && (obj.value < 0 || obj.value > 59))
     {
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "simrskreatifmedia/grid_select_adm_ranap";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_adm_ranap']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_adm_ranap']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_adm_ranap']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro($nmgp_save_origem)
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "grid_select_adm_ranap/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function trata_campos()
   {
      global $trancode_cond, $trancode, $trancode_autocomp,
             $custcode_cond, $custcode, $custcode_autocomp,
             $tglmasuk_cond, $tglmasuk, $tglmasuk_dia, $tglmasuk_mes, $tglmasuk_ano, $tglmasuk_hor, $tglmasuk_min, $tglmasuk_seg, $tglmasuk_input_2_dia, $tglmasuk_input_2_mes, $tglmasuk_input_2_ano, $tglmasuk_input_2_min, $tglmasuk_input_2_hor, $tglmasuk_input_2_seg,
             $pembayaran_cond, $pembayaran, $pembayaran_autocomp, $nmgp_tab_label;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_adm_ranap']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_adm_ranap']['campos_busca']['trancode'] = $trancode; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_adm_ranap']['campos_busca']['trancode_cond'] = $trancode_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_adm_ranap']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_adm_ranap']['campos_busca']['custcode'] = $custcode; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_adm_ranap']['campos_busca']['custcode_cond'] = $custcode_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_adm_ranap']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_adm_ranap']['campos_busca']['tglmasuk_dia'] = $tglmasuk_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_adm_ranap']['campos_busca']['tglmasuk_mes'] = $tglmasuk_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_adm_ranap']['campos_busca']['tglmasuk_ano'] = $tglmasuk_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_adm_ranap']['campos_busca']['tglmasuk_input_2_dia'] = $tglmasuk_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_adm_ranap']['campos_busca']['tglmasuk_input_2_mes'] = $tglmasuk_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_adm_ranap']['campos_busca']['tglmasuk_input_2_ano'] = $tglmasuk_input_2_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_adm_ranap']['campos_busca']['tglmasuk_hor'] = $tglmasuk_hor; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_adm_ranap']['campos_busca']['tglmasuk_min'] = $tglmasuk_min; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_adm_ranap']['campos_busca']['tglmasuk_seg'] = $tglmasuk_seg; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_adm_ranap']['campos_busca']['tglmasuk_input_2_hor'] = $tglmasuk_input_2_hor; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_adm_ranap']['campos_busca']['tglmasuk_input_2_min'] = $tglmasuk_input_2_min; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_adm_ranap']['campos_busca']['tglmasuk_input_2_seg'] = $tglmasuk_input_2_seg; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_adm_ranap']['campos_busca']['tglmasuk_cond'] = $tglmasuk_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_adm_ranap']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_adm_ranap']['campos_busca']['pembayaran'] = $pembayaran; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_adm_ranap']['campos_busca']['pembayaran_cond'] = $pembayaran_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_adm_ranap']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_adm_ranap']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_adm_ranap']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      ...
      if ($tglmasuk_cond != "bi_TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_adm_ranap']['campos_busca']['tglmasuk'] = $val[0];
          ...
          if ($tglmasuk_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_adm_ranap']['campos_busca']['tglmasuk_input_2'] = $val[1];
      ...
      {
         $this->monta_condicao("pembayaran", $pembayaran_cond, $pembayaran, "", "pembayaran");
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_adm_ranap']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_adm_ranap']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_adm_ranap']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_adm_ranap']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_adm_ranap']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_adm_ranap']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_adm_ranap']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_adm_ranap']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_adm_ranap']['cond_pesq'] .= $this->NM_operador;
