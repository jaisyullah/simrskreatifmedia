<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tbobat']['sc_process_barr'] = true;
require_once('../grid_tbobat/index.php');
unset($_SESSION['scriptcase']['grid_tbobat']['sc_process_barr']);
$ExportCtrl = new grid_tbobat_export_control;
$ExportCtrl->Export_barr();

class grid_tbobat_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - Obat & Alat :: Excel</TITLE>
