...
<?php
   ...
   $Ord_Cmp = new grid_tbobat_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_tbobat_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbobat']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tbobat']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['kodeitem'] = "kodeItem";
   $tab_labels["kodeitem"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbobat']['labels']["kodeitem"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbobat']['labels']["kodeitem"] : "Kode Item";
   $tab_ger_campos['namaitem'] = "on";
   $tab_def_campos['namaitem'] = "namaItem";
   $tab_labels["namaitem"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbobat']['labels']["namaitem"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbobat']['labels']["namaitem"] : "Nama Item";
   $tab_ger_campos['aktif'] = "on";
   $tab_def_campos['aktif'] = "aktif";
   $tab_labels["aktif"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbobat']['labels']["aktif"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbobat']['labels']["aktif"] : "Aktif";
   $tab_ger_campos['jenisbarang'] = "on";
   $tab_def_campos['jenisbarang'] = "jenisBarang";
   $tab_labels["jenisbarang"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbobat']['labels']["jenisbarang"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbobat']['labels']["jenisbarang"] : "Jenis Barang";
   $tab_ger_campos['satuanterkecil'] = "on";
   $tab_def_campos['satuanterkecil'] = "satuanTerkecil";
   $tab_labels["satuanterkecil"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbobat']['labels']["satuanterkecil"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbobat']['labels']["satuanterkecil"] : "Satuan Terkecil";
   $tab_ger_campos['stokminimal'] = "on";
   $tab_def_campos['stokminimal'] = "stokMinimal";
   $tab_labels["stokminimal"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbobat']['labels']["stokminimal"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbobat']['labels']["stokminimal"] : "Stok Minimal";
   $tab_ger_campos['hargajual'] = "on";
   $tab_def_campos['hargajual'] = "hargaJual";
   $tab_labels["hargajual"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbobat']['labels']["hargajual"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbobat']['labels']["hargajual"] : "Harga Jual";
   $tab_ger_campos['stok'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['stok'] = "Stok";
   }
   else
   {
       $tab_def_campos['stok'] = "";
   }
   $tab_labels["stok"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbobat']['labels']["stok"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbobat']['labels']["stok"] : "Stok";
   $tab_ger_campos['ed'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['ed'] = "ED";
   }
   else
   {
       $tab_def_campos['ed'] = "";
   }
   $tab_labels["ed"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbobat']['labels']["ed"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbobat']['labels']["ed"] : "ED";
   $tab_ger_campos['stok'] = "none";
   $tab_ger_campos['ed'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_tbobat']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_tbobat']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_tbobat']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbobat']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tbobat']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_tbobat']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_tbobat']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_tbobat']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_tbobat']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_tbobat_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_tbobat']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_tbobat']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_tbobat']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_tbobat']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_tbobat']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
