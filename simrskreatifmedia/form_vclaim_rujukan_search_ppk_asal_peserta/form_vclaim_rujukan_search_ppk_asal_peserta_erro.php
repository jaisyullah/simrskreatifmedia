...
function scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['form_vclaim_rujukan_search_ppk_asal_peserta']['contr_erro']) && $_SESSION['scriptcase']['form_vclaim_rujukan_search_ppk_asal_peserta']['contr_erro'] == 'on')
    {
