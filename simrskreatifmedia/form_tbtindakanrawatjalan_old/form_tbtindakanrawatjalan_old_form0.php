<?php
class form_tbtindakanrawatjalan_old_form extends form_tbtindakanrawatjalan_old_apl
{
function Form_Init()
{
...
<?php
if ($this->Embutida_form && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtindakanrawatjalan_old']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtindakanrawatjalan_old']['sc_modal'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtindakanrawatjalan_old']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtindakanrawatjalan_old']['sc_redir_atualiz'] == 'ok')
{
?>
...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtindakanrawatjalan_old']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_tbtindakanrawatjalan_old/form_tbtindakanrawatjalan_old_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_tbtindakanrawatjalan_old_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_tbtindakanrawatjalan_old_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtindakanrawatjalan_old']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtindakanrawatjalan_old']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtindakanrawatjalan_old']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtindakanrawatjalan_old']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtindakanrawatjalan_old']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtindakanrawatjalan_old']['recarga'];
}
if ('novo' == $opcao_botoes && $this->Embutida_form)
{
    $opcao_botoes = 'inicio';
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtindakanrawatjalan_old']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtindakanrawatjalan_old']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
?>
...
<?php
 include_once("form_tbtindakanrawatjalan_old_js0.php");
?>
<script type="text/javascript"> 
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_tbtindakanrawatjalan_old'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_tbtindakanrawatjalan_old'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtindakanrawatjalan_old']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtindakanrawatjalan_old']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtindakanrawatjalan_old']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtindakanrawatjalan_old']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtindakanrawatjalan_old']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtindakanrawatjalan_old']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtindakanrawatjalan_old']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtindakanrawatjalan_old']['run_iframe'] != "R")
{
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtindakanrawatjalan_old']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtindakanrawatjalan_old']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtindakanrawatjalan_old']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtindakanrawatjalan_old']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtindakanrawatjalan_old']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtindakanrawatjalan_old']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtindakanrawatjalan_old']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtindakanrawatjalan_old']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtindakanrawatjalan_old']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtindakanrawatjalan_old']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
{ 
   ...
   { 
       ob_start();
       $iStart = sizeof($this->form_vert_form_tbtindakanrawatjalan_old);
       $guarda_nmgp_opcao = $this->nmgp_opcao;
       $guarda_form_vert_form_tbtindakanrawatjalan_old = $this->form_vert_form_tbtindakanrawatjalan_old;
       $this->nmgp_opcao = 'novo';
   } 
   if ($this->Embutida_form && empty($this->form_vert_form_tbtindakanrawatjalan_old))
   {
       $sc_seq_vert = 0;
   }
   ...
   foreach ($this->form_vert_form_tbtindakanrawatjalan_old as $sc_seq_vert => $sc_lixo)
   {
       ...
       elseif ($Line_Add)
       {
        ...
        $this->tindakan_ = $this->form_vert_form_tbtindakanrawatjalan_old[$sc_seq_vert]['tindakan_']; 
       ...
       $this->diskon_ = $this->form_vert_form_tbtindakanrawatjalan_old[$sc_seq_vert]['diskon_']; 
       ...
       $this->biaya_ = $this->form_vert_form_tbtindakanrawatjalan_old[$sc_seq_vert]['biaya_']; 
       $biaya_ = $this->biaya_; 
       $sStyleHidden_biaya_ = '';
       ...
       $this->tgltindakan_ = $this->form_vert_form_tbtindakanrawatjalan_old[$sc_seq_vert]['tgltindakan_'] . ' ' . $this->form_vert_form_tbtindakanrawatjalan_old[$sc_seq_vert]['tgltindakan__hora']; 
       ...
       $this->jumlah_ = $this->form_vert_form_tbtindakanrawatjalan_old[$sc_seq_vert]['jumlah_']; 
       ...
       $this->id_ = $this->form_vert_form_tbtindakanrawatjalan_old[$sc_seq_vert]['id_']; 
       $id_ = $this->id_; 
       if (!isset($this->nmgp_cmp_hidden['id_']))
       {
           $this->nmgp_cmp_hidden['id_'] = 'off';
...
<?php echo nmButtonOutput($this->arr_buttons, "bmd_novo", "do_ajax_form_tbtindakanrawatjalan_old_add_new_line(" . $sc_seq_vert . ")", "do_ajax_form_tbtindakanrawatjalan_old_add_new_line(" . $sc_seq_vert . ")", "sc_new_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
<?php }?>
<?php
  $Style_add_line = (!$Line_Add) ? "display: none" : "";
?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_form_tbtindakanrawatjalan_old_cancel_insert(" . $sc_seq_vert . ")", "do_ajax_form_tbtindakanrawatjalan_old_cancel_insert(" . $sc_seq_vert . ")", "sc_canceli_line_" . $sc_seq_vert . "", "", "", "" . $Style_add_line . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_form_tbtindakanrawatjalan_old_cancel_update(" . $sc_seq_vert . ")", "do_ajax_form_tbtindakanrawatjalan_old_cancel_update(" . $sc_seq_vert . ")", "sc_cancelu_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
 </TD>
   <?php }?>
...
<?php   
   ...
   { 
       ...
       $this->form_vert_form_tbtindakanrawatjalan_old = $guarda_form_vert_form_tbtindakanrawatjalan_old;
   } 
   if ($Table_refresh) 
   { 
...
<?php
if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtindakanrawatjalan_old']['run_modal']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtindakanrawatjalan_old']['run_modal'])
{
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtindakanrawatjalan_old']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtindakanrawatjalan_old']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_tbtindakanrawatjalan_old");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_tbtindakanrawatjalan_old");
 parent.scAjaxDetailHeight("form_tbtindakanrawatjalan_old", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
<script type="text/javascript">
	function scBtnFn_sys_format_inc() {
		if ($("#sc_b_new_t.sc-unique-btn-1").length && $("#sc_b_new_t.sc-unique-btn-1").is(":visible")) {
			do_ajax_form_tbtindakanrawatjalan_old_add_new_line(); return false;
			 return;
		}
...
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtindakanrawatjalan_old']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
