...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "tgl_kirim";$Nm_datas[] = "tgl_kirim";$Nm_numeric[] = "id";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_tgl_kirim_cond" name="tgl_kirim_cond" onChange="nm_campos_between(document.getElementById('id_vis_tgl_kirim'), this, 'tgl_kirim')">
      ...
      <br><span id="id_hide_tgl_kirim"  <?php echo $str_hide_tgl_kirim?>>
<?php
  $Form_base = "ddmmyyyy";
  $date_format_show = "";
...
?>
 ...
 <?php echo $date_format_show ?>         </SPAN>
                  <br />
        <SPAN id="id_vis_tgl_kirim"  <?php echo $str_display_tgl_kirim; ?> class="scFilterFieldFontEven">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_jadwal_cond" name="jadwal_cond" onChange="nm_campos_between(document.getElementById('id_vis_jadwal'), this, 'jadwal')">
      ...
      <br><span id="id_hide_jadwal"  <?php echo $str_hide_jadwal?>><?php
      if ($jadwal != "")
      {
      $jadwal_look = substr($this->Db->qstr($jadwal), 1, -1); 
      $nmgp_def_dados = array(); 
