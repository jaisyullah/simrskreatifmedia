<?php
@session_start() ;
$_SESSION['scriptcase']['grid_pengiriman_gizi']['sc_process_barr'] = true;
require_once('../grid_pengiriman_gizi/index.php');
unset($_SESSION['scriptcase']['grid_pengiriman_gizi']['sc_process_barr']);
$ExportCtrl = new grid_pengiriman_gizi_export_control;
$ExportCtrl->Export_barr();

class grid_pengiriman_gizi_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - pengiriman gizi :: Excel</TITLE>
