...
class grid_pengiriman_gizi_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengiriman_gizi']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_pengiriman_gizi_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_pengiriman_gizi_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_pengiriman_gizi_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_jadwal')
      {
          $jadwal = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_jadwal($jadwal);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function lookup_ajax_jadwal($jadwal)
   {
      $jadwal = substr($this->Db->qstr($jadwal), 1, -1);
            $jadwal_look = substr($this->Db->qstr($jadwal), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct jadwal from " . $this->Ini->nm_tabela . " where  jadwal like '%" . $jadwal . "%' order by jadwal"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $Nm_datas[] = "tgl_kirim";$Nm_datas[] = "tgl_kirim";
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengiriman_gizi']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengiriman_gizi']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengiriman_gizi']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengiriman_gizi']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengiriman_gizi']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengiriman_gizi']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengiriman_gizi']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengiriman_gizi']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengiriman_gizi']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengiriman_gizi']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengiriman_gizi']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengiriman_gizi']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengiriman_gizi']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengiriman_gizi']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengiriman_gizi']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengiriman_gizi']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengiriman_gizi']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - pengiriman gizi</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_pengiriman_gizi/grid_pengiriman_gizi_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_pengiriman_gizi_ajax_search.js"></script>
 <script type="text/javascript" src="grid_pengiriman_gizi_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_pengiriman_gizi_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_pengiriman_gizi']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_pengiriman_gizi']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_tgl_kirim_cond#NMF#' + search_get_sel_txt('SC_tgl_kirim_cond') + '@NMF@';
  str_out += 'SC_tgl_kirim_dia#NMF#' + search_get_sel_txt('SC_tgl_kirim_dia') + '@NMF@';
  str_out += 'SC_tgl_kirim_mes#NMF#' + search_get_sel_txt('SC_tgl_kirim_mes') + '@NMF@';
  str_out += 'SC_tgl_kirim_ano#NMF#' + search_get_sel_txt('SC_tgl_kirim_ano') + '@NMF@';
  str_out += 'SC_tgl_kirim_input_2_dia#NMF#' + search_get_sel_txt('SC_tgl_kirim_input_2_dia') + '@NMF@';
  str_out += 'SC_tgl_kirim_input_2_mes#NMF#' + search_get_sel_txt('SC_tgl_kirim_input_2_mes') + '@NMF@';
  str_out += 'SC_tgl_kirim_input_2_ano#NMF#' + search_get_sel_txt('SC_tgl_kirim_input_2_ano') + '@NMF@';
  str_out += 'SC_jadwal_cond#NMF#' + search_get_sel_txt('SC_jadwal_cond') + '@NMF@';
  str_out += 'SC_jadwal#NMF#' + search_get_text('SC_jadwal') + '@NMF@';
  str_out += 'id_ac_jadwal#NMF#' + search_get_text('id_ac_jadwal') + '@NMF@';
   ...
   $("#id_ac_jadwal").autocomplete({
     ...
     $.ajax({
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_jadwal",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengiriman_gizi']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div class="scFilterHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFilterHeaderFont" style="float: left; text-transform: uppercase;"><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - pengiriman gizi</div>
...
<?php
   ...
   function monta_form()
   {
      global 
             ...
             $tgl_kirim_cond, $tgl_kirim, $tgl_kirim_dia, $tgl_kirim_mes, $tgl_kirim_ano, $tgl_kirim_input_2_dia, $tgl_kirim_input_2_mes, $tgl_kirim_input_2_ano,
             $jadwal_cond, $jadwal, $jadwal_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengiriman_gizi']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengiriman_gizi']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengiriman_gizi']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengiriman_gizi']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $id = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengiriman_gizi']['campos_busca']['id']; 
          $id_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengiriman_gizi']['campos_busca']['id_cond']; 
          $tgl_kirim_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengiriman_gizi']['campos_busca']['tgl_kirim_dia']; 
          $tgl_kirim_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengiriman_gizi']['campos_busca']['tgl_kirim_mes']; 
          $tgl_kirim_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengiriman_gizi']['campos_busca']['tgl_kirim_ano']; 
          $tgl_kirim_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengiriman_gizi']['campos_busca']['tgl_kirim_input_2_dia']; 
          $tgl_kirim_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengiriman_gizi']['campos_busca']['tgl_kirim_input_2_mes']; 
          $tgl_kirim_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengiriman_gizi']['campos_busca']['tgl_kirim_input_2_ano']; 
          $tgl_kirim_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengiriman_gizi']['campos_busca']['tgl_kirim_cond']; 
          $jadwal = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengiriman_gizi']['campos_busca']['jadwal']; 
          $jadwal_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengiriman_gizi']['campos_busca']['jadwal_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengiriman_gizi']['campos_busca']['NM_operador']; 
      } 
      if (!isset($id_cond) || empty($id_cond))
      {
         $id_cond = "gt";
      }
      if (!isset($tgl_kirim_cond) || empty($tgl_kirim_cond))
      {
         $tgl_kirim_cond = "eq";
      }
      if (!isset($jadwal_cond) || empty($jadwal_cond))
      {
         $jadwal_cond = "qp";
      }
      ...
      $str_hide_tgl_kirim = (in_array($tgl_kirim_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_jadwal = (in_array($jadwal_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      $str_display_id = ('bw' == $id_cond) ? $display_aberto : $display_fechado;
      $str_display_tgl_kirim = ('bw' == $tgl_kirim_cond) ? $display_aberto : $display_fechado;
      $str_display_jadwal = ('bw' == $jadwal_cond) ? $display_aberto : $display_fechado;
      ...
      if (!isset($tgl_kirim) || $tgl_kirim == "")
      {
          $tgl_kirim = "";
      }
      if (isset($tgl_kirim) && !empty($tgl_kirim))
      {
         $tmp_pos = strpos($tgl_kirim, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $tgl_kirim = substr($tgl_kirim, 0, $tmp_pos);
         }
      }
      ...
      {
         $tmp_pos = strpos($jadwal, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $jadwal = substr($jadwal, 0, $tmp_pos);
         }
      }
?>
 <TR align="center">
...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_id" name="id_autocomp" size="15"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 15, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
      ...
      <TD id='SC_tgl_kirim_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['tgl_kirim'])) ? $this->New_label['tgl_kirim'] : "Tgl Kirim"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_tgl_kirim_cond" name="tgl_kirim_cond" onChange="nm_campos_between(document.getElementById('id_vis_tgl_kirim'), this, 'tgl_kirim')">
       <OPTION value="eq" <?php if ("eq" == $tgl_kirim_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="gt" <?php if ("gt" == $tgl_kirim_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $tgl_kirim_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $tgl_kirim_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_tgl_kirim" <?php echo $str_hide_tgl_kirim?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['tgl_kirim'])) ? $this->New_label['tgl_kirim'] : "Tgl Kirim";
 $nmgp_tab_label .= "tgl_kirim?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
  ...
  {
?>
<span id='id_date_part_tgl_kirim_DD' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_tgl_kirim_dia" name="tgl_kirim_dia" value="<?php echo NM_encode_input($tgl_kirim_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_tgl_kirim_MM' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_tgl_kirim_mes" name="tgl_kirim_mes" value="<?php echo NM_encode_input($tgl_kirim_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_tgl_kirim_AAAA' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_tgl_kirim_ano" name="tgl_kirim_ano" value="<?php echo NM_encode_input($tgl_kirim_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 </span>
...
?>
        <SPAN id="id_css_tgl_kirim"  class="scFilterFieldFontEven">
 <?php echo $date_format_show ?>         </SPAN>
                 </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_tgl_kirim"  <?php echo $str_display_tgl_kirim; ?> class="scFilterFieldFontEven">
...
<?php
  ...
  {
?>
<span id='id_date_part_tgl_kirim_input_2_DD' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_tgl_kirim_input_2_dia" name="tgl_kirim_input_2_dia" value="<?php echo NM_encode_input($tgl_kirim_input_2_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_tgl_kirim_input_2_MM' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_tgl_kirim_input_2_mes" name="tgl_kirim_input_2_mes" value="<?php echo NM_encode_input($tgl_kirim_input_2_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_tgl_kirim_input_2_AAAA' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_tgl_kirim_input_2_ano" name="tgl_kirim_input_2_ano" value="<?php echo NM_encode_input($tgl_kirim_input_2_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 </span>
...
?>
      ...
      <TD id='SC_jadwal_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['jadwal'])) ? $this->New_label['jadwal'] : "Jadwal"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_jadwal_cond" name="jadwal_cond" onChange="nm_campos_between(document.getElementById('id_vis_jadwal'), this, 'jadwal')">
       <OPTION value="qp" <?php if ("qp" == $jadwal_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $jadwal_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $jadwal_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $jadwal_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_jadwal" <?php echo $str_hide_jadwal?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['jadwal'])) ? $this->New_label['jadwal'] : "Jadwal";
 $nmgp_tab_label .= "jadwal?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      $jadwal_look = substr($this->Db->qstr($jadwal), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct jadwal from " . $this->Ini->nm_tabela . " where jadwal = '$jadwal_look' order by jadwal"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      if (isset($nmgp_def_dados[0][$jadwal]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$jadwal];
      }
      else
      {
          $sAutocompValue = $jadwal;
      }
?>
<INPUT  type="text" id="SC_jadwal" name="jadwal" value="<?php echo NM_encode_input($jadwal) ?>"  size=10 alt="{datatype: 'text', maxLength: 10, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_jadwal" name="jadwal_autocomp" size="10"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 10, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
?>
<?php
   if (is_file("grid_pengiriman_gizi_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_pengiriman_gizi']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_pengiriman_gizi']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengiriman_gizi']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.tgl_kirim_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_tgl_kirim'), document.F1.tgl_kirim_cond, 'tgl_kirim');
   document.F1.tgl_kirim_dia.value = "";
   document.F1.tgl_kirim_mes.value = "";
   document.F1.tgl_kirim_ano.value = "";
   document.F1.tgl_kirim_input_2_dia.value = "";
   document.F1.tgl_kirim_input_2_mes.value = "";
   document.F1.tgl_kirim_input_2_ano.value = "";
   document.F1.jadwal_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_jadwal'), document.F1.jadwal_cond, 'jadwal');
   document.F1.jadwal.value = "";
   document.F1.jadwal_autocomp.value = "";
 }
 function SC_carga_evt_jquery()
 {
    $('#SC_tgl_kirim_dia').bind('change', function() {sc_grid_pengiriman_gizi_valida_dia(this)});
    $('#SC_tgl_kirim_input_2_dia').bind('change', function() {sc_grid_pengiriman_gizi_valida_dia(this)});
    $('#SC_tgl_kirim_input_2_mes').bind('change', function() {sc_grid_pengiriman_gizi_valida_mes(this)});
    $('#SC_tgl_kirim_mes').bind('change', function() {sc_grid_pengiriman_gizi_valida_mes(this)});
 }
 function sc_grid_pengiriman_gizi_valida_dia(obj)
 {
 ...
 function sc_grid_pengiriman_gizi_valida_mes(obj)
 {
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "simrskreatifmedia/grid_pengiriman_gizi";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengiriman_gizi']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengiriman_gizi']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengiriman_gizi']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_tgl_kirim_cond'] = 'cond';
      $tp_fields['SC_tgl_kirim_dia'] = 'text';
      $tp_fields['SC_tgl_kirim_mes'] = 'text';
      $tp_fields['SC_tgl_kirim_ano'] = 'text';
      $tp_fields['SC_tgl_kirim_input_2_dia'] = 'text';
      $tp_fields['SC_tgl_kirim_input_2_mes'] = 'text';
      $tp_fields['SC_tgl_kirim_input_2_ano'] = 'text';
      $tp_fields['SC_jadwal_cond'] = 'cond';
      $tp_fields['SC_jadwal'] = 'text_aut';
      $tp_fields['id_ac_jadwal'] = 'text_aut';
   ...
   function trata_campos()
   {
      global $id_cond, $id, $id_autocomp,
             $tgl_kirim_cond, $tgl_kirim, $tgl_kirim_dia, $tgl_kirim_mes, $tgl_kirim_ano, $tgl_kirim_input_2_dia, $tgl_kirim_input_2_mes, $tgl_kirim_input_2_ano,
             $jadwal_cond, $jadwal, $jadwal_autocomp, $nmgp_tab_label;
      ...
      if (!empty($jadwal_autocomp) && empty($jadwal))
      {
          $jadwal = $jadwal_autocomp;
      }
      ...
      $tgl_kirim_cond_salva = $tgl_kirim_cond; 
      if (!isset($tgl_kirim_input_2_dia) || $tgl_kirim_input_2_dia == "")
      {
          $tgl_kirim_input_2_dia = $tgl_kirim_dia;
      }
      if (!isset($tgl_kirim_input_2_mes) || $tgl_kirim_input_2_mes == "")
      {
          $tgl_kirim_input_2_mes = $tgl_kirim_mes;
      }
      if (!isset($tgl_kirim_input_2_ano) || $tgl_kirim_input_2_ano == "")
      {
          $tgl_kirim_input_2_ano = $tgl_kirim_ano;
      }
      $jadwal_cond_salva = $jadwal_cond; 
      if (!isset($jadwal_input_2) || $jadwal_input_2 == "")
      {
          $jadwal_input_2 = $jadwal;
      }
      if ($id_cond != "in")
      {
          nm_limpa_numero($id, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengiriman_gizi']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengiriman_gizi']['campos_busca']['id'] = $id; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengiriman_gizi']['campos_busca']['id_cond'] = $id_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengiriman_gizi']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengiriman_gizi']['campos_busca']['tgl_kirim_dia'] = $tgl_kirim_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengiriman_gizi']['campos_busca']['tgl_kirim_mes'] = $tgl_kirim_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengiriman_gizi']['campos_busca']['tgl_kirim_ano'] = $tgl_kirim_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengiriman_gizi']['campos_busca']['tgl_kirim_input_2_dia'] = $tgl_kirim_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengiriman_gizi']['campos_busca']['tgl_kirim_input_2_mes'] = $tgl_kirim_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengiriman_gizi']['campos_busca']['tgl_kirim_input_2_ano'] = $tgl_kirim_input_2_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengiriman_gizi']['campos_busca']['tgl_kirim_cond'] = $tgl_kirim_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengiriman_gizi']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengiriman_gizi']['campos_busca']['jadwal'] = $jadwal; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengiriman_gizi']['campos_busca']['jadwal_cond'] = $jadwal_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengiriman_gizi']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengiriman_gizi']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengiriman_gizi']['campos_busca'] = $Temp_Busca;
      }
   ...
   { 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['jadwal'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['jadwal'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['jadwal'] = $jadwal;
      }
      ...
      //----- $tgl_kirim
      $this->Date_part = false;
      if ($tgl_kirim_cond != "bi_TP")
      {
          $tgl_kirim_cond = strtoupper($tgl_kirim_cond);
          $Dtxt = "";
          $val  = array();
          $Dtxt .= $tgl_kirim_ano;
          $Dtxt .= $tgl_kirim_mes;
          $Dtxt .= $tgl_kirim_dia;
          $val[0]['ano'] = $tgl_kirim_ano;
          $val[0]['mes'] = $tgl_kirim_mes;
          $val[0]['dia'] = $tgl_kirim_dia;
          if ($tgl_kirim_cond == "BW")
          {
              $val[1]['ano'] = $tgl_kirim_input_2_ano;
              $val[1]['mes'] = $tgl_kirim_input_2_mes;
              $val[1]['dia'] = $tgl_kirim_input_2_dia;
          }
          $this->Operador_date_part = "";
          $this->Lang_date_part     = "";
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_oracle))
          {
              $this->nm_prep_date($val, "DT", "DATETIME", $tgl_kirim_cond, "", "data");
          }
          else
          {
              $this->nm_prep_date($val, "DT", "DATE", $tgl_kirim_cond, "", "data");
          }
          if (!$this->Date_part) {
              $val[0] = $this->Ini->sc_Date_Protect($val[0]);
          }
          $tgl_kirim = $val[0];
          $this->cmp_formatado['tgl_kirim'] = $val[0];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengiriman_gizi']['campos_busca']['tgl_kirim'] = $val[0];
          $this->nm_data->SetaData($this->cmp_formatado['tgl_kirim'], "YYYY-MM-DD");
          $this->cmp_formatado['tgl_kirim'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DT", "dmY"));
          if ($tgl_kirim_cond == "BW")
          {
              if (!$this->Date_part) {
                  $val[1] = $this->Ini->sc_Date_Protect($val[1]);
              }
              $tgl_kirim_input_2     = $val[1];
              $this->cmp_formatado['tgl_kirim_input_2'] = $val[1];
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengiriman_gizi']['campos_busca']['tgl_kirim_input_2'] = $val[1];
              $this->nm_data->SetaData($this->cmp_formatado['tgl_kirim_input_2'], "YYYY-MM-DD");
              $this->cmp_formatado['tgl_kirim_input_2'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DT", "dmY"));
          }
          if (!empty($Dtxt) || $tgl_kirim_cond == "NU" || $tgl_kirim_cond == "NN"|| $tgl_kirim_cond == "EP"|| $tgl_kirim_cond == "NE")
          {
              $this->monta_condicao("tgl_kirim", $tgl_kirim_cond, $tgl_kirim, $tgl_kirim_input_2, 'tgl_kirim', 'DATE');
          }
      }

      //----- $jadwal
      $this->Date_part = false;
      if (isset($jadwal) || $jadwal_cond == "nu" || $jadwal_cond == "nn" || $jadwal_cond == "ep" || $jadwal_cond == "ne")
      {
         $this->monta_condicao("jadwal", $jadwal_cond, $jadwal, "", "jadwal");
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengiriman_gizi']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengiriman_gizi']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengiriman_gizi']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengiriman_gizi']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengiriman_gizi']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengiriman_gizi']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengiriman_gizi']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengiriman_gizi']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengiriman_gizi']['cond_pesq'] .= $this->NM_operador;
