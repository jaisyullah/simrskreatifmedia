...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_pengiriman_gizi"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_pengiriman_gizi"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_pengiriman_gizi'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_pengiriman_gizi']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_pengiriman_gizi']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_pengiriman_gizi']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_pengiriman_gizi']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_pengiriman_gizi']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_pengiriman_gizi</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_pengiriman_gizi']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_pengiriman_gizi']['embutida_filho'] as $ind => $sc_init)
          {
