...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_hrm_shift_karyawan"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_hrm_shift_karyawan"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_hrm_shift_karyawan'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_hrm_shift_karyawan']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_hrm_shift_karyawan']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_hrm_shift_karyawan']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_hrm_shift_karyawan']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_hrm_shift_karyawan']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_hrm_shift_karyawan</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_hrm_shift_karyawan']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_hrm_shift_karyawan']['embutida_filho'] as $ind => $sc_init)
          {
