...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "birthDate";$Nm_datas[] = "birthDate";$Nm_datas[] = "dateSip";$Nm_datas[] = "dateSip";$Nm_datas[] = "joinDate";$Nm_datas[] = "joinDate";$Nm_numeric[] = "id";$Nm_numeric[] = "deleted";$Nm_numeric[] = "poliform";$Nm_numeric[] = "israd";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_birthdate_cond" name="birthdate_cond" onChange="nm_campos_between(document.getElementById('id_vis_birthdate'), this, 'birthdate')">
      ...
      <br><span id="id_hide_birthdate"  <?php echo $str_hide_birthdate?>>
<?php
...
?>
 ...
 <?php echo $date_format_show ?>         </SPAN>
                  <br />
        <SPAN id="id_vis_birthdate"  <?php echo $str_display_birthdate; ?> class="scFilterFieldFontOdd">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_doccode_cond" name="doccode_cond" onChange="nm_campos_between(document.getElementById('id_vis_doccode'), this, 'doccode')">
      ...
      <br><span id="id_hide_doccode"  <?php echo $str_hide_doccode?>><?php
      if ($doccode != "")
      {
      $doccode_look = substr($this->Db->qstr($doccode), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_type_cond" name="type_cond" onChange="nm_campos_between(document.getElementById('id_vis_type'), this, 'type')">
      ...
      <br><span id="id_hide_type"  <?php echo $str_hide_type?>><?php
      if ($type != "")
      {
      $type_look = substr($this->Db->qstr($type), 1, -1); 
      $nmgp_def_dados = array(); 
