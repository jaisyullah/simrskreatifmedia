...
class grid_tbdoctor_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdoctor']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_tbdoctor_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_tbdoctor_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_tbdoctor_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_type')
      {
          $type = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_type($type);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function lookup_ajax_type($type)
   {
      $type = substr($this->Db->qstr($type), 1, -1);
            $type_look = substr($this->Db->qstr($type), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct type from " . $this->Ini->nm_tabela . " where  type like '%" . $type . "%' order by type"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $Nm_datas[] = "birthDate";$Nm_datas[] = "birthDate";$Nm_datas[] = "dateSip";$Nm_datas[] = "dateSip";$Nm_datas[] = "joinDate";$Nm_datas[] = "joinDate";
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdoctor']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdoctor']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdoctor']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdoctor']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdoctor']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdoctor']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdoctor']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdoctor']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdoctor']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdoctor']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdoctor']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdoctor']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdoctor']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdoctor']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdoctor']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdoctor']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdoctor']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - Paramedis</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_tbdoctor/grid_tbdoctor_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_tbdoctor_ajax_search.js"></script>
 <script type="text/javascript" src="grid_tbdoctor_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_tbdoctor_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_tbdoctor']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_tbdoctor']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_type#NMF#' + search_get_text('SC_type') + '@NMF@';
  str_out += 'id_ac_type#NMF#' + search_get_text('id_ac_type') + '@NMF@';
   ...
   $("#id_ac_type").autocomplete({
     ...
     $.ajax({
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_type",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdoctor']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div class="scFilterHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFilterHeaderFont" style="float: left; text-transform: uppercase;"><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - Paramedis</div>
...
<?php
   ...
   {
      global 
             $birthdate_cond, $birthdate, $birthdate_dia, $birthdate_mes, $birthdate_ano, $birthdate_hor, $birthdate_min, $birthdate_seg, $birthdate_input_2_dia, $birthdate_input_2_mes, $birthdate_input_2_ano, $birthdate_input_2_min, $birthdate_input_2_hor, $birthdate_input_2_seg,
             $doccode_cond, $doccode, $doccode_autocomp,
             $type_cond, $type, $type_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdoctor']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdoctor']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdoctor']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdoctor']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $birthdate_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdoctor']['campos_busca']['birthdate_dia']; 
          $birthdate_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdoctor']['campos_busca']['birthdate_mes']; 
          $birthdate_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdoctor']['campos_busca']['birthdate_ano']; 
          $birthdate_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdoctor']['campos_busca']['birthdate_input_2_dia']; 
          $birthdate_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdoctor']['campos_busca']['birthdate_input_2_mes']; 
          $birthdate_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdoctor']['campos_busca']['birthdate_input_2_ano']; 
          $birthdate_hor = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdoctor']['campos_busca']['birthdate_hor']; 
          $birthdate_min = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdoctor']['campos_busca']['birthdate_min']; 
          $birthdate_seg = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdoctor']['campos_busca']['birthdate_seg']; 
          $birthdate_input_2_hor = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdoctor']['campos_busca']['birthdate_input_2_hor']; 
          $birthdate_input_2_min = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdoctor']['campos_busca']['birthdate_input_2_min']; 
          $birthdate_input_2_seg = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdoctor']['campos_busca']['birthdate_input_2_seg']; 
          $birthdate_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdoctor']['campos_busca']['birthdate_cond']; 
          $doccode = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdoctor']['campos_busca']['doccode']; 
          $doccode_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdoctor']['campos_busca']['doccode_cond']; 
          $type = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdoctor']['campos_busca']['type']; 
          $type_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdoctor']['campos_busca']['type_cond']; 
          $name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdoctor']['campos_busca']['name']; 
          $name_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdoctor']['campos_busca']['name_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdoctor']['campos_busca']['NM_operador']; 
      } 
      if (!isset($birthdate_cond) || empty($birthdate_cond))
      {
         $birthdate_cond = "eq";
      }
      if (!isset($doccode_cond) || empty($doccode_cond))
      {
         $doccode_cond = "qp";
      }
      if (!isset($type_cond) || empty($type_cond))
      {
         $type_cond = "qp";
      }
      ...
      $str_display_birthdate = ('bw' == $birthdate_cond) ? $display_aberto : $display_fechado;
      $str_display_doccode = ('bw' == $doccode_cond) ? $display_aberto : $display_fechado;
      $str_display_type = ('bw' == $type_cond) ? $display_aberto : $display_fechado;
      $str_display_name = ('bw' == $name_cond) ? $display_aberto : $display_fechado;
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_birthdate_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['birthdate'])) ? $this->New_label['birthdate'] : "Tgl. Lahir"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_birthdate_cond" name="birthdate_cond" onChange="nm_campos_between(document.getElementById('id_vis_birthdate'), this, 'birthdate')">
       <OPTION value="eq" <?php if ("eq" == $birthdate_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="gt" <?php if ("gt" == $birthdate_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $birthdate_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $birthdate_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
...
?>
 ...
 <?php echo $date_format_show ?>         </SPAN>
       ...
       <TR valign="top">
        <TD id="id_vis_birthdate"  <?php echo $str_display_birthdate; ?> class="scFilterFieldFontOdd">
...
<?php
  ...
  {
?>
<span id='id_date_part_birthdate_input_2_DD' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_birthdate_input_2_dia" name="birthdate_input_2_dia" value="<?php echo NM_encode_input($birthdate_input_2_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_birthdate_input_2_MM' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_birthdate_input_2_mes" name="birthdate_input_2_mes" value="<?php echo NM_encode_input($birthdate_input_2_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_birthdate_input_2_AAAA' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_birthdate_input_2_ano" name="birthdate_input_2_ano" value="<?php echo NM_encode_input($birthdate_input_2_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 </span>
...
<?php
  ...
  {
?>
<span id='id_date_part_birthdate_input_2_HH' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_birthdate_input_2_hor" name="birthdate_input_2_hor" value="<?php echo NM_encode_input($birthdate_input_2_hor); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_birthdate_input_2_II' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_birthdate_input_2_min" name="birthdate_input_2_min" value="<?php echo NM_encode_input($birthdate_input_2_min); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_birthdate_input_2_SS' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_birthdate_input_2_seg" name="birthdate_input_2_seg" value="<?php echo NM_encode_input($birthdate_input_2_seg); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
?>
      ...
      <TD id='SC_doccode_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['doccode'])) ? $this->New_label['doccode'] : "Kode Medis"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_doccode_cond" name="doccode_cond" onChange="nm_campos_between(document.getElementById('id_vis_doccode'), this, 'doccode')">
       <OPTION value="qp" <?php if ("qp" == $doccode_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $doccode_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $doccode_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $doccode_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
...
?>
<INPUT  type="text" id="SC_doccode" name="doccode" value="<?php echo NM_encode_input($doccode) ?>"  size=8 alt="{datatype: 'text', maxLength: 8, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_doccode" name="doccode_autocomp" size="8"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 8, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_type_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['type'])) ? $this->New_label['type'] : "Jenis"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_type_cond" name="type_cond" onChange="nm_campos_between(document.getElementById('id_vis_type'), this, 'type')">
       <OPTION value="qp" <?php if ("qp" == $type_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $type_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $type_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $type_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
...
<?php
      ...
      $type_look = substr($this->Db->qstr($type), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct type from " . $this->Ini->nm_tabela . " where type = '$type_look' order by type"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      if (isset($nmgp_def_dados[0][$type]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$type];
      }
      else
      {
          $sAutocompValue = $type;
...
?>
<INPUT  type="text" id="SC_type" name="type" value="<?php echo NM_encode_input($type) ?>"  size=50 alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_type" name="type_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
?>
<?php
   if (is_file("grid_tbdoctor_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_tbdoctor']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_tbdoctor']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdoctor']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.birthdate_cond.value = 'eq';
   ...
   document.F1.birthdate_input_2_dia.value = "";
   document.F1.birthdate_input_2_mes.value = "";
   document.F1.birthdate_input_2_ano.value = "";
   document.F1.birthdate_hor.value = "";
   document.F1.birthdate_min.value = "";
   document.F1.birthdate_seg.value = "";
   document.F1.birthdate_input_2_hor.value = "";
   document.F1.birthdate_input_2_min.value = "";
   document.F1.birthdate_input_2_seg.value = "";
   document.F1.doccode_cond.value = 'qp';
   ...
   document.F1.type_cond.value = 'qp';
 ...
 {
    $('#SC_birthdate_dia').bind('change', function() {sc_grid_tbdoctor_valida_dia(this)});
    $('#SC_birthdate_hor').bind('change', function() {sc_grid_tbdoctor_valida_hora(this)});
    $('#SC_birthdate_input_2_dia').bind('change', function() {sc_grid_tbdoctor_valida_dia(this)});
    $('#SC_birthdate_input_2_hor').bind('change', function() {sc_grid_tbdoctor_valida_hora(this)});
    $('#SC_birthdate_input_2_mes').bind('change', function() {sc_grid_tbdoctor_valida_mes(this)});
    $('#SC_birthdate_input_2_min').bind('change', function() {sc_grid_tbdoctor_valida_min(this)});
    $('#SC_birthdate_input_2_seg').bind('change', function() {sc_grid_tbdoctor_valida_seg(this)});
    $('#SC_birthdate_mes').bind('change', function() {sc_grid_tbdoctor_valida_mes(this)});
    $('#SC_birthdate_min').bind('change', function() {sc_grid_tbdoctor_valida_min(this)});
    $('#SC_birthdate_seg').bind('change', function() {sc_grid_tbdoctor_valida_seg(this)});
 }
 function sc_grid_tbdoctor_valida_dia(obj)
 {
 ...
 function sc_grid_tbdoctor_valida_mes(obj)
 {
 ...
 function sc_grid_tbdoctor_valida_hora(obj)
 {
 ...
 function sc_grid_tbdoctor_valida_min(obj)
 {
 ...
 function sc_grid_tbdoctor_valida_seg(obj)
 {
     if (obj.value != "" && (obj.value < 0 || obj.value > 59))
     {
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "simrskreatifmedia/grid_tbdoctor";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdoctor']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdoctor']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdoctor']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_type'] = 'text_aut';
      $tp_fields['id_ac_type'] = 'text_aut';
   ...
   {
      global $birthdate_cond, $birthdate, $birthdate_dia, $birthdate_mes, $birthdate_ano, $birthdate_hor, $birthdate_min, $birthdate_seg, $birthdate_input_2_dia, $birthdate_input_2_mes, $birthdate_input_2_ano, $birthdate_input_2_min, $birthdate_input_2_hor, $birthdate_input_2_seg,
             $doccode_cond, $doccode, $doccode_autocomp,
             $type_cond, $type, $type_autocomp,
      ...
      if (!empty($type_autocomp) && empty($type))
      {
          $type = $type_autocomp;
      }
      ...
      if (!isset($birthdate_input_2_dia) || $birthdate_input_2_dia == "")
      {
          $birthdate_input_2_dia = $birthdate_dia;
      }
      if (!isset($birthdate_input_2_mes) || $birthdate_input_2_mes == "")
      {
          $birthdate_input_2_mes = $birthdate_mes;
      }
      if (!isset($birthdate_input_2_ano) || $birthdate_input_2_ano == "")
      {
          $birthdate_input_2_ano = $birthdate_ano;
      }
      if (!isset($birthdate_input_2_hor) || $birthdate_input_2_hor == "")
      {
          $birthdate_input_2_hor = $birthdate_hor;
      }
      if (!isset($birthdate_input_2_min) || $birthdate_input_2_min == "")
      {
          $birthdate_input_2_min = $birthdate_min;
      }
      if (!isset($birthdate_input_2_seg) || $birthdate_input_2_seg == "")
      {
          $birthdate_input_2_seg = $birthdate_seg;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdoctor']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdoctor']['campos_busca']['birthdate_dia'] = $birthdate_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdoctor']['campos_busca']['birthdate_mes'] = $birthdate_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdoctor']['campos_busca']['birthdate_ano'] = $birthdate_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdoctor']['campos_busca']['birthdate_input_2_dia'] = $birthdate_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdoctor']['campos_busca']['birthdate_input_2_mes'] = $birthdate_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdoctor']['campos_busca']['birthdate_input_2_ano'] = $birthdate_input_2_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdoctor']['campos_busca']['birthdate_hor'] = $birthdate_hor; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdoctor']['campos_busca']['birthdate_min'] = $birthdate_min; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdoctor']['campos_busca']['birthdate_seg'] = $birthdate_seg; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdoctor']['campos_busca']['birthdate_input_2_hor'] = $birthdate_input_2_hor; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdoctor']['campos_busca']['birthdate_input_2_min'] = $birthdate_input_2_min; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdoctor']['campos_busca']['birthdate_input_2_seg'] = $birthdate_input_2_seg; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdoctor']['campos_busca']['birthdate_cond'] = $birthdate_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdoctor']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdoctor']['campos_busca']['doccode'] = $doccode; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdoctor']['campos_busca']['doccode_cond'] = $doccode_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdoctor']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdoctor']['campos_busca']['type'] = $type; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdoctor']['campos_busca']['type_cond'] = $type_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdoctor']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdoctor']['campos_busca']['name'] = $name; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdoctor']['campos_busca']['name_cond'] = $name_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdoctor']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdoctor']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdoctor']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      ...
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['type'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['type'] = $type;
      }
      $name_look = substr($this->Db->qstr($name), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct name from " . $this->Ini->nm_tabela . " where name = '$name_look' order by name"; 
      ...
      if ($birthdate_cond != "bi_TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdoctor']['campos_busca']['birthdate'] = $val[0];
          ...
          if ($birthdate_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdoctor']['campos_busca']['birthdate_input_2'] = $val[1];
      ...
      //----- $type
      $this->Date_part = false;
      if (isset($type) || $type_cond == "nu" || $type_cond == "nn" || $type_cond == "ep" || $type_cond == "ne")
      {
         $this->monta_condicao("type", $type_cond, $type, "", "type");
      }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdoctor']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdoctor']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdoctor']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdoctor']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdoctor']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdoctor']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdoctor']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdoctor']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdoctor']['cond_pesq'] .= $this->NM_operador;
