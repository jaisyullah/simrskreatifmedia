...
<?php
   ...
   $Ord_Cmp = new grid_tbdoctor_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_tbdoctor_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbdoctor']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tbdoctor']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["doccode"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbdoctor']['labels']["doccode"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbdoctor']['labels']["doccode"] : "Kode Medis";
   ...
   {
       $tab_def_campos['nama'] = "select sc_concat(gelar,name,', ', spec) from tbdoctor where docCode = '{docCode}'";
   }
   $tab_labels["nama"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbdoctor']['labels']["nama"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbdoctor']['labels']["nama"] : "Nama";
   $tab_ger_campos['city'] = "on";
   $tab_def_campos['city'] = "city";
   $tab_labels["city"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbdoctor']['labels']["city"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbdoctor']['labels']["city"] : "Kota";
   $tab_ger_campos['hp'] = "on";
   $tab_def_campos['hp'] = "hp";
   $tab_labels["hp"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbdoctor']['labels']["hp"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbdoctor']['labels']["hp"] : "No. HP";
   $tab_ger_campos['birthdate'] = "on";
   $tab_def_campos['birthdate'] = "birthDate";
   $tab_labels["birthdate"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbdoctor']['labels']["birthdate"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbdoctor']['labels']["birthdate"] : "Tgl. Lahir";
   $tab_ger_campos['joindate'] = "on";
   $tab_def_campos['joindate'] = "joinDate";
   $tab_labels["joindate"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbdoctor']['labels']["joindate"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbdoctor']['labels']["joindate"] : "Join Date";
   $tab_ger_campos['address'] = "on";
   $tab_def_campos['address'] = "address";
   $tab_labels["address"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbdoctor']['labels']["address"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbdoctor']['labels']["address"] : "Alamat";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_tbdoctor']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_tbdoctor']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_tbdoctor']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbdoctor']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tbdoctor']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_tbdoctor']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_tbdoctor']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_tbdoctor']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_tbdoctor']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_tbdoctor_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_tbdoctor']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_tbdoctor']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_tbdoctor']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_tbdoctor']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_tbdoctor']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
