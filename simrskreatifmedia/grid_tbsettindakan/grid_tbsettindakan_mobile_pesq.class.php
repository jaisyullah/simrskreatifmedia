...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_poli_cond" name="poli_cond" onChange="nm_campos_between(document.getElementById('id_vis_poli'), this, 'poli')">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_set_tindakan_cond" name="set_tindakan_cond" onChange="nm_campos_between(document.getElementById('id_vis_set_tindakan'), this, 'set_tindakan')">
      ...
      <br><span id="id_hide_set_tindakan"  <?php echo $str_hide_set_tindakan?>><?php
      if ($set_tindakan != "")
      {
      $set_tindakan_look = substr($this->Db->qstr($set_tindakan), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_kode_tind_cond" name="kode_tind_cond" onChange="nm_campos_between(document.getElementById('id_vis_kode_tind'), this, 'kode_tind')">
      ...
      <br><span id="id_hide_kode_tind"  <?php echo $str_hide_kode_tind?>><?php
      if ($kode_tind != "")
      {
      $kode_tind_look = substr($this->Db->qstr($kode_tind), 1, -1); 
      $nmgp_def_dados = array(); 
