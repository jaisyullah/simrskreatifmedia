<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tbsettindakan']['sc_process_barr'] = true;
require_once('../grid_tbsettindakan/index.php');
unset($_SESSION['scriptcase']['grid_tbsettindakan']['sc_process_barr']);
$ExportCtrl = new grid_tbsettindakan_export_control;
$ExportCtrl->Export_barr();

class grid_tbsettindakan_export_control
{
