...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_tbsettindakan"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_tbsettindakan"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_tbsettindakan'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tbsettindakan']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_tbsettindakan']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tbsettindakan']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_tbsettindakan']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_tbsettindakan']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_tbsettindakan</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_tbsettindakan']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_tbsettindakan']['embutida_filho'] as $ind => $sc_init)
          {
