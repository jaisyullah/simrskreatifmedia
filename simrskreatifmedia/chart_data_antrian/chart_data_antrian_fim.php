...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____chart_data_antrian"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____chart_data_antrian"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['chart_data_antrian']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['chart_data_antrian']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['chart_data_antrian']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['chart_data_antrian']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['chart_data_antrian']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>chart_data_antrian</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['chart_data_antrian']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['chart_data_antrian']['embutida_filho'] as $ind => $sc_init)
          {
