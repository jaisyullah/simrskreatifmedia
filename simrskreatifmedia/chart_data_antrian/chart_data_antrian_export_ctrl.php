<?php
@session_start() ;
$_SESSION['scriptcase']['chart_data_antrian']['sc_process_barr'] = true;
require_once('../chart_data_antrian/index.php');
unset($_SESSION['scriptcase']['chart_data_antrian']['sc_process_barr']);
$ExportCtrl = new chart_data_antrian_export_control;
$ExportCtrl->Export_barr();

class chart_data_antrian_export_control
{
