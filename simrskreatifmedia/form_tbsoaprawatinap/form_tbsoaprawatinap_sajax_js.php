  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbsoaprawatinap" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbsoaprawatinap_form();
	}

  // ---------- Validate tglsoap_
  function do_ajax_form_tbsoaprawatinap_validate_tglsoap_(iNumLinha)
  {
    var nomeCampo_tglsoap_ = "tglsoap_" + iNumLinha;
    var var_tglsoap_ = scAjaxGetFieldText(nomeCampo_tglsoap_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbsoaprawatinap_validate_tglsoap_(var_tglsoap_, iNumLinha, var_script_case_init, do_ajax_form_tbsoaprawatinap_validate_tglsoap__cb);
  } // do_ajax_form_tbsoaprawatinap_validate_tglsoap_

  function do_ajax_form_tbsoaprawatinap_validate_tglsoap__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbsoaprawatinap_validate_tglsoap__cb

  // ---------- Validate subject_
  function do_ajax_form_tbsoaprawatinap_validate_subject_(iNumLinha)
  {
    var nomeCampo_subject_ = "subject_" + iNumLinha;
    var var_subject_ = scAjaxGetFieldText(nomeCampo_subject_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbsoaprawatinap_validate_subject_(var_subject_, iNumLinha, var_script_case_init, do_ajax_form_tbsoaprawatinap_validate_subject__cb);
  } // do_ajax_form_tbsoaprawatinap_validate_subject_

  function do_ajax_form_tbsoaprawatinap_validate_subject__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbsoaprawatinap_validate_subject__cb

  // ---------- Validate object_
  function do_ajax_form_tbsoaprawatinap_validate_object_(iNumLinha)
  {
    var nomeCampo_object_ = "object_" + iNumLinha;
    var var_object_ = scAjaxGetFieldText(nomeCampo_object_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbsoaprawatinap_validate_object_(var_object_, iNumLinha, var_script_case_init, do_ajax_form_tbsoaprawatinap_validate_object__cb);
  } // do_ajax_form_tbsoaprawatinap_validate_object_

  function do_ajax_form_tbsoaprawatinap_validate_object__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbsoaprawatinap_validate_object__cb

  // ---------- Validate assesment_
  function do_ajax_form_tbsoaprawatinap_validate_assesment_(iNumLinha)
  {
    var nomeCampo_assesment_ = "assesment_" + iNumLinha;
    var var_assesment_ = scAjaxGetFieldText(nomeCampo_assesment_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbsoaprawatinap_validate_assesment_(var_assesment_, iNumLinha, var_script_case_init, do_ajax_form_tbsoaprawatinap_validate_assesment__cb);
  } // do_ajax_form_tbsoaprawatinap_validate_assesment_

  function do_ajax_form_tbsoaprawatinap_validate_assesment__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbsoaprawatinap_validate_assesment__cb

  // ---------- Validate plan_
  function do_ajax_form_tbsoaprawatinap_validate_plan_(iNumLinha)
  {
    var nomeCampo_plan_ = "plan_" + iNumLinha;
    var var_plan_ = scAjaxGetFieldText(nomeCampo_plan_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbsoaprawatinap_validate_plan_(var_plan_, iNumLinha, var_script_case_init, do_ajax_form_tbsoaprawatinap_validate_plan__cb);
  } // do_ajax_form_tbsoaprawatinap_validate_plan_

  function do_ajax_form_tbsoaprawatinap_validate_plan__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbsoaprawatinap_validate_plan__cb

  // ---------- Validate pelaksana_
  function do_ajax_form_tbsoaprawatinap_validate_pelaksana_(iNumLinha)
  {
    var nomeCampo_pelaksana_ = "pelaksana_" + iNumLinha;
    var var_pelaksana_ = scAjaxGetFieldText(nomeCampo_pelaksana_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbsoaprawatinap_validate_pelaksana_(var_pelaksana_, iNumLinha, var_script_case_init, do_ajax_form_tbsoaprawatinap_validate_pelaksana__cb);
  } // do_ajax_form_tbsoaprawatinap_validate_pelaksana_

  function do_ajax_form_tbsoaprawatinap_validate_pelaksana__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbsoaprawatinap_validate_pelaksana__cb

  // ---------- Validate id_
  function do_ajax_form_tbsoaprawatinap_validate_id_(iNumLinha)
  {
    var nomeCampo_id_ = "id_" + iNumLinha;
    var var_id_ = scAjaxGetFieldHidden(nomeCampo_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbsoaprawatinap_validate_id_(var_id_, iNumLinha, var_script_case_init, do_ajax_form_tbsoaprawatinap_validate_id__cb);
  } // do_ajax_form_tbsoaprawatinap_validate_id_

  function do_ajax_form_tbsoaprawatinap_validate_id__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbsoaprawatinap_validate_id__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_tbsoaprawatinap_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_tbsoaprawatinap_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tbsoaprawatinap_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_tbsoaprawatinap_add_new_line_cb);
  } // do_ajax_form_tbsoaprawatinap_add_new_line

  function do_ajax_form_tbsoaprawatinap_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_tbsoaprawatinap_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_tbsoaprawatinap_backup_line(iNumLinha)
  {
    var var_id_ = scAjaxGetFieldHidden("id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbsoaprawatinap_backup_line(var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_tbsoaprawatinap_backup_line_cb);
  } // do_ajax_form_tbsoaprawatinap_backup_line

  function do_ajax_form_tbsoaprawatinap_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_tbsoaprawatinap_backup_line_cb

  function do_ajax_form_tbsoaprawatinap_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_tbsoaprawatinap_cancel_insert

  function do_ajax_form_tbsoaprawatinap_cancel_update(iSeqVert)
  {
    do_ajax_form_tbsoaprawatinap_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_tbsoaprawatinap_cancel_update

  function do_ajax_form_tbsoaprawatinap_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_tbsoaprawatinap_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_tbsoaprawatinap_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_tbsoaprawatinap_table_refresh(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbsoaprawatinap_table_refresh_cb);
  } //  do_ajax_form_tbsoaprawatinap_table_refresh

  function do_ajax_form_tbsoaprawatinap_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_tbsoaprawatinap_table_refresh_cb_after_alert);
  } // do_ajax_form_tbsoaprawatinap_table_refresh_cb
  function do_ajax_form_tbsoaprawatinap_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxSetNavStatus("t");
    sc_insert_open = false;
  } // do_ajax_form_tbsoaprawatinap_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_tbsoaprawatinap_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_tbsoaprawatinap_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
...
?>
    x_ajax_form_tbsoaprawatinap_submit_form(var_tglsoap_, var_subject_, var_object_, var_assesment_, var_plan_, var_pelaksana_, var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbsoaprawatinap_submit_form_cb);
  } // do_ajax_form_tbsoaprawatinap_submit_form

  function do_ajax_form_tbsoaprawatinap_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_tbsoaprawatinap_submit_form_cb_after_alert);
  } // do_ajax_form_tbsoaprawatinap_submit_form_cb
  function do_ajax_form_tbsoaprawatinap_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbsoaprawatinap_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tbsoaprawatinap_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_tbsoaprawatinap_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tbsoaprawatinap_navigate_form(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbsoaprawatinap_navigate_form_cb);
  } // do_ajax_form_tbsoaprawatinap_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbsoaprawatinap']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbsoaprawatinap_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbsoaprawatinap_navigate_form_cb_after_alert);
  } // do_ajax_form_tbsoaprawatinap_navigate_form_cb
  function do_ajax_form_tbsoaprawatinap_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_tbsoaprawatinap_navigate_form_cb_after_alert
  function sc_hide_form_tbsoaprawatinap_form()
  {
