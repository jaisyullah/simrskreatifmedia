  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbdocinsentif_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbdocinsentif_mob_form();
	}

  // ---------- Validate doccode
  function do_ajax_form_tbdocinsentif_mob_validate_doccode()
  {
    var nomeCampo_doccode = "doccode";
    var var_doccode = scAjaxGetFieldText(nomeCampo_doccode);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdocinsentif_mob_validate_doccode(var_doccode, var_script_case_init, do_ajax_form_tbdocinsentif_mob_validate_doccode_cb);
  } // do_ajax_form_tbdocinsentif_mob_validate_doccode

  function do_ajax_form_tbdocinsentif_mob_validate_doccode_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdocinsentif_mob_validate_doccode_cb

  // ---------- Validate tindakan
  function do_ajax_form_tbdocinsentif_mob_validate_tindakan()
  {
    var nomeCampo_tindakan = "tindakan";
    var var_tindakan = scAjaxGetFieldText(nomeCampo_tindakan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdocinsentif_mob_validate_tindakan(var_tindakan, var_script_case_init, do_ajax_form_tbdocinsentif_mob_validate_tindakan_cb);
  } // do_ajax_form_tbdocinsentif_mob_validate_tindakan

  function do_ajax_form_tbdocinsentif_mob_validate_tindakan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdocinsentif_mob_validate_tindakan_cb

  // ---------- Validate tindname
  function do_ajax_form_tbdocinsentif_mob_validate_tindname()
  {
    var nomeCampo_tindname = "tindname";
    var var_tindname = scAjaxGetFieldText(nomeCampo_tindname);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdocinsentif_mob_validate_tindname(var_tindname, var_script_case_init, do_ajax_form_tbdocinsentif_mob_validate_tindname_cb);
  } // do_ajax_form_tbdocinsentif_mob_validate_tindname

  function do_ajax_form_tbdocinsentif_mob_validate_tindname_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tindname";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdocinsentif_mob_validate_tindname_cb

  // ---------- Validate class
  function do_ajax_form_tbdocinsentif_mob_validate_class()
  {
    var nomeCampo_class = "class";
    var var_class = scAjaxGetFieldText(nomeCampo_class);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdocinsentif_mob_validate_class(var_class, var_script_case_init, do_ajax_form_tbdocinsentif_mob_validate_class_cb);
  } // do_ajax_form_tbdocinsentif_mob_validate_class

  function do_ajax_form_tbdocinsentif_mob_validate_class_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "class";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdocinsentif_mob_validate_class_cb

  // ---------- Validate rate
  function do_ajax_form_tbdocinsentif_mob_validate_rate()
  {
    var nomeCampo_rate = "rate";
    var var_rate = scAjaxGetFieldText(nomeCampo_rate);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdocinsentif_mob_validate_rate(var_rate, var_script_case_init, do_ajax_form_tbdocinsentif_mob_validate_rate_cb);
  } // do_ajax_form_tbdocinsentif_mob_validate_rate

  function do_ajax_form_tbdocinsentif_mob_validate_rate_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "rate";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdocinsentif_mob_validate_rate_cb

  // ---------- Validate taxedrate
  function do_ajax_form_tbdocinsentif_mob_validate_taxedrate()
  {
    var nomeCampo_taxedrate = "taxedrate";
    var var_taxedrate = scAjaxGetFieldText(nomeCampo_taxedrate);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdocinsentif_mob_validate_taxedrate(var_taxedrate, var_script_case_init, do_ajax_form_tbdocinsentif_mob_validate_taxedrate_cb);
  } // do_ajax_form_tbdocinsentif_mob_validate_taxedrate

  function do_ajax_form_tbdocinsentif_mob_validate_taxedrate_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "taxedrate";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdocinsentif_mob_validate_taxedrate_cb

  // ---------- Validate disc
  function do_ajax_form_tbdocinsentif_mob_validate_disc()
  {
    var nomeCampo_disc = "disc";
    var var_disc = scAjaxGetFieldText(nomeCampo_disc);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdocinsentif_mob_validate_disc(var_disc, var_script_case_init, do_ajax_form_tbdocinsentif_mob_validate_disc_cb);
  } // do_ajax_form_tbdocinsentif_mob_validate_disc

  function do_ajax_form_tbdocinsentif_mob_validate_disc_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "disc";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdocinsentif_mob_validate_disc_cb

  // ---------- Validate nilai
  function do_ajax_form_tbdocinsentif_mob_validate_nilai()
  {
    var nomeCampo_nilai = "nilai";
    var var_nilai = scAjaxGetFieldText(nomeCampo_nilai);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdocinsentif_mob_validate_nilai(var_nilai, var_script_case_init, do_ajax_form_tbdocinsentif_mob_validate_nilai_cb);
  } // do_ajax_form_tbdocinsentif_mob_validate_nilai

  function do_ajax_form_tbdocinsentif_mob_validate_nilai_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nilai";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdocinsentif_mob_validate_nilai_cb

  // ---------- Validate trandate
  function do_ajax_form_tbdocinsentif_mob_validate_trandate()
  {
    var nomeCampo_trandate = "trandate";
    var var_trandate = scAjaxGetFieldText(nomeCampo_trandate);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdocinsentif_mob_validate_trandate(var_trandate, var_script_case_init, do_ajax_form_tbdocinsentif_mob_validate_trandate_cb);
  } // do_ajax_form_tbdocinsentif_mob_validate_trandate

  function do_ajax_form_tbdocinsentif_mob_validate_trandate_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdocinsentif_mob_validate_trandate_cb

  // ---------- Validate trancode
  function do_ajax_form_tbdocinsentif_mob_validate_trancode()
  {
    var nomeCampo_trancode = "trancode";
    var var_trancode = scAjaxGetFieldText(nomeCampo_trancode);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdocinsentif_mob_validate_trancode(var_trancode, var_script_case_init, do_ajax_form_tbdocinsentif_mob_validate_trancode_cb);
  } // do_ajax_form_tbdocinsentif_mob_validate_trancode

  function do_ajax_form_tbdocinsentif_mob_validate_trancode_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdocinsentif_mob_validate_trancode_cb

  // ---------- Validate struk
  function do_ajax_form_tbdocinsentif_mob_validate_struk()
  {
    var nomeCampo_struk = "struk";
    var var_struk = scAjaxGetFieldText(nomeCampo_struk);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdocinsentif_mob_validate_struk(var_struk, var_script_case_init, do_ajax_form_tbdocinsentif_mob_validate_struk_cb);
  } // do_ajax_form_tbdocinsentif_mob_validate_struk

  function do_ajax_form_tbdocinsentif_mob_validate_struk_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "struk";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdocinsentif_mob_validate_struk_cb

  // ---------- Validate id
  function do_ajax_form_tbdocinsentif_mob_validate_id()
  {
    var nomeCampo_id = "id";
    var var_id = scAjaxGetFieldText(nomeCampo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdocinsentif_mob_validate_id(var_id, var_script_case_init, do_ajax_form_tbdocinsentif_mob_validate_id_cb);
  } // do_ajax_form_tbdocinsentif_mob_validate_id

  function do_ajax_form_tbdocinsentif_mob_validate_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdocinsentif_mob_validate_id_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tbdocinsentif_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tbdocinsentif_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_doccode = scAjaxGetFieldText("doccode");
    var var_tindakan = scAjaxGetFieldText("tindakan");
    var var_tindname = scAjaxGetFieldText("tindname");
    var var_class = scAjaxGetFieldText("class");
    var var_rate = scAjaxGetFieldText("rate");
    var var_taxedrate = scAjaxGetFieldText("taxedrate");
    var var_disc = scAjaxGetFieldText("disc");
    var var_nilai = scAjaxGetFieldText("nilai");
    ...
    scAjaxProcOn();
    x_ajax_form_tbdocinsentif_mob_submit_form(var_doccode, var_tindakan, var_tindname, var_class, var_rate, var_taxedrate, var_disc, var_nilai, var_trandate, var_trancode, var_struk, var_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbdocinsentif_mob_submit_form_cb);
  } // do_ajax_form_tbdocinsentif_mob_submit_form

  function do_ajax_form_tbdocinsentif_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("tindname");
      scAjaxHideErrorDisplay("class");
      scAjaxHideErrorDisplay("rate");
      scAjaxHideErrorDisplay("taxedrate");
      scAjaxHideErrorDisplay("disc");
      scAjaxHideErrorDisplay("nilai");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tbdocinsentif_mob_submit_form_cb_after_alert);
  } // do_ajax_form_tbdocinsentif_mob_submit_form_cb
  function do_ajax_form_tbdocinsentif_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbdocinsentif_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tbdocinsentif_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_tbdocinsentif_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbdocinsentif_mob_navigate_form_cb);
  } // do_ajax_form_tbdocinsentif_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdocinsentif_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbdocinsentif_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbdocinsentif_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_tbdocinsentif_mob_navigate_form_cb
  function do_ajax_form_tbdocinsentif_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_tbdocinsentif_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_tbdocinsentif_mob_navigate_form_cb_after_alert
  function sc_hide_form_tbdocinsentif_mob_form()
  {
  ...
  ajax_field_list[1] = "tindakan";
  ajax_field_list[2] = "tindname";
  ajax_field_list[3] = "class";
  ajax_field_list[4] = "rate";
  ajax_field_list[5] = "taxedrate";
  ajax_field_list[6] = "disc";
  ajax_field_list[7] = "nilai";
  ajax_field_list[8] = "trandate";
  ajax_field_list[9] = "trancode";
  ajax_field_list[10] = "struk";
  ajax_field_list[11] = "id";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "doccode": {"label": "Doc Code", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "tindname": {"label": "Tind Name", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "class": {"label": "Class", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "rate": {"label": "Rate", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "taxedrate": {"label": "Taxed Rate", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "disc": {"label": "Disc", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "nilai": {"label": "Nilai", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "trandate": {"label": "Tran Date", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "trancode": {"label": "Tran Code", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  ajax_field_mult["tindname"][1] = "tindname";
  ajax_field_mult["class"][1] = "class";
  ajax_field_mult["rate"][1] = "rate";
  ajax_field_mult["taxedrate"][1] = "taxedrate";
  ajax_field_mult["disc"][1] = "disc";
  ajax_field_mult["nilai"][1] = "nilai";
  ...
  var ajax_field_id = {
    ...
    "tindname": new Array("hidden_field_label_tindname", "hidden_field_data_tindname"),
    ...
    "taxedrate": new Array("hidden_field_label_taxedrate", "hidden_field_data_taxedrate"),
    "disc": new Array("hidden_field_label_disc", "hidden_field_data_disc"),
    "nilai": new Array("hidden_field_label_nilai", "hidden_field_data_nilai"),
