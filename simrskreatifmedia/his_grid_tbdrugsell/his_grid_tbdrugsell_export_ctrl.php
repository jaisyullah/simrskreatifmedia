<?php
@session_start() ;
$_SESSION['scriptcase']['his_grid_tbdrugsell']['sc_process_barr'] = true;
require_once('../his_grid_tbdrugsell/index.php');
unset($_SESSION['scriptcase']['his_grid_tbdrugsell']['sc_process_barr']);
$ExportCtrl = new his_grid_tbdrugsell_export_control;
$ExportCtrl->Export_barr();

class his_grid_tbdrugsell_export_control
{
