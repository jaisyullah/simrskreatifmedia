...
<?php
   ...
   $Ord_Cmp = new his_grid_tbdrugsell_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class his_grid_tbdrugsell_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['his_grid_tbdrugsell']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['his_grid_tbdrugsell']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["trandate"]   = (isset($_SESSION['sc_session'][$sc_init]['his_grid_tbdrugsell']['labels']["trandate"])) ? $_SESSION['sc_session'][$sc_init]['his_grid_tbdrugsell']['labels']["trandate"] : "Tgl Transaksi";
   $tab_ger_campos['trancode'] = "on";
   $tab_def_campos['trancode'] = "trancode";
   $tab_labels["trancode"]   = (isset($_SESSION['sc_session'][$sc_init]['his_grid_tbdrugsell']['labels']["trancode"])) ? $_SESSION['sc_session'][$sc_init]['his_grid_tbdrugsell']['labels']["trancode"] : "Kode Transaksi";
   $tab_ger_campos['struk'] = "on";
   $tab_def_campos['struk'] = "struk";
   $tab_labels["struk"]   = (isset($_SESSION['sc_session'][$sc_init]['his_grid_tbdrugsell']['labels']["struk"])) ? $_SESSION['sc_session'][$sc_init]['his_grid_tbdrugsell']['labels']["struk"] : "No Struk";
   $tab_ger_campos['resep'] = "on";
   $tab_def_campos['resep'] = "resep";
   $tab_labels["resep"]   = (isset($_SESSION['sc_session'][$sc_init]['his_grid_tbdrugsell']['labels']["resep"])) ? $_SESSION['sc_session'][$sc_init]['his_grid_tbdrugsell']['labels']["resep"] : "Resep ?";
   $tab_ger_campos['doccode'] = "on";
   $tab_def_campos['doccode'] = "doccode";
   $tab_labels["doccode"]   = (isset($_SESSION['sc_session'][$sc_init]['his_grid_tbdrugsell']['labels']["doccode"])) ? $_SESSION['sc_session'][$sc_init]['his_grid_tbdrugsell']['labels']["doccode"] : "Dokter";
   $tab_ger_campos['pasien'] = "on";
   $tab_def_campos['pasien'] = "pasien";
   $tab_labels["pasien"]   = (isset($_SESSION['sc_session'][$sc_init]['his_grid_tbdrugsell']['labels']["pasien"])) ? $_SESSION['sc_session'][$sc_init]['his_grid_tbdrugsell']['labels']["pasien"] : "Pasien ?";
   $tab_ger_campos['custname'] = "on";
   $tab_def_campos['custname'] = "custname";
   $tab_labels["custname"]   = (isset($_SESSION['sc_session'][$sc_init]['his_grid_tbdrugsell']['labels']["custname"])) ? $_SESSION['sc_session'][$sc_init]['his_grid_tbdrugsell']['labels']["custname"] : "Nama Pasien";
   $tab_ger_campos['total'] = "on";
   $tab_def_campos['total'] = "total";
   $tab_labels["total"]   = (isset($_SESSION['sc_session'][$sc_init]['his_grid_tbdrugsell']['labels']["total"])) ? $_SESSION['sc_session'][$sc_init]['his_grid_tbdrugsell']['labels']["total"] : "Total";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['his_grid_tbdrugsell']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['his_grid_tbdrugsell']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['his_grid_tbdrugsell']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['his_grid_tbdrugsell']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['his_grid_tbdrugsell']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['his_grid_tbdrugsell']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['his_grid_tbdrugsell']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['his_grid_tbdrugsell']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['his_grid_tbdrugsell']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "his_grid_tbdrugsell_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['his_grid_tbdrugsell']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['his_grid_tbdrugsell']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['his_grid_tbdrugsell']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['his_grid_tbdrugsell']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['his_grid_tbdrugsell']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
