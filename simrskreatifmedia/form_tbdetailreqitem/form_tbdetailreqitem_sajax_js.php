  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbdetailreqitem" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbdetailreqitem_form();
	}

  // ---------- Validate item_
  function do_ajax_form_tbdetailreqitem_validate_item_(iNumLinha)
  {
  } // do_ajax_form_tbdetailreqitem_validate_item_

  function do_ajax_form_tbdetailreqitem_validate_item__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdetailreqitem_validate_item__cb

  // ---------- Validate permintaan_
  function do_ajax_form_tbdetailreqitem_validate_permintaan_(iNumLinha)
  {
    var nomeCampo_permintaan_ = "permintaan_" + iNumLinha;
    var var_permintaan_ = scAjaxGetFieldText(nomeCampo_permintaan_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdetailreqitem_validate_permintaan_(var_permintaan_, iNumLinha, var_script_case_init, do_ajax_form_tbdetailreqitem_validate_permintaan__cb);
  } // do_ajax_form_tbdetailreqitem_validate_permintaan_

  function do_ajax_form_tbdetailreqitem_validate_permintaan__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "permintaan_" + iLineNumber;
    }
    else
    {
      sFieldValid = "permintaan_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "permintaan_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "permintaan_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdetailreqitem_validate_permintaan__cb

  // ---------- Validate realisasi_
  function do_ajax_form_tbdetailreqitem_validate_realisasi_(iNumLinha)
  {
    var nomeCampo_realisasi_ = "realisasi_" + iNumLinha;
    var var_realisasi_ = scAjaxGetFieldText(nomeCampo_realisasi_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdetailreqitem_validate_realisasi_(var_realisasi_, iNumLinha, var_script_case_init, do_ajax_form_tbdetailreqitem_validate_realisasi__cb);
  } // do_ajax_form_tbdetailreqitem_validate_realisasi_

  function do_ajax_form_tbdetailreqitem_validate_realisasi__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "realisasi_" + iLineNumber;
    }
    else
    {
      sFieldValid = "realisasi_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "realisasi_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "realisasi_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdetailreqitem_validate_realisasi__cb

  // ---------- Validate tglupdate_
  function do_ajax_form_tbdetailreqitem_validate_tglupdate_(iNumLinha)
  {
    var nomeCampo_tglupdate_ = "tglupdate_" + iNumLinha;
    var var_tglupdate_ = scAjaxGetFieldText(nomeCampo_tglupdate_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdetailreqitem_validate_tglupdate_(var_tglupdate_, iNumLinha, var_script_case_init, do_ajax_form_tbdetailreqitem_validate_tglupdate__cb);
  } // do_ajax_form_tbdetailreqitem_validate_tglupdate_

  function do_ajax_form_tbdetailreqitem_validate_tglupdate__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "tglupdate_" + iLineNumber;
    }
    else
    {
      sFieldValid = "tglupdate_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "tglupdate_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "tglupdate_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdetailreqitem_validate_tglupdate__cb

  // ---------- Validate sc_field_0_
  function do_ajax_form_tbdetailreqitem_validate_sc_field_0_(iNumLinha)
  {
    var nomeCampo_sc_field_0_ = "sc_field_0_" + iNumLinha;
    var var_sc_field_0_ = scAjaxGetFieldText(nomeCampo_sc_field_0_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdetailreqitem_validate_sc_field_0_(var_sc_field_0_, iNumLinha, var_script_case_init, do_ajax_form_tbdetailreqitem_validate_sc_field_0__cb);
  } // do_ajax_form_tbdetailreqitem_validate_sc_field_0_

  function do_ajax_form_tbdetailreqitem_validate_sc_field_0__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdetailreqitem_validate_sc_field_0__cb

  // ---------- Event onchange trancode
  function do_ajax_form_tbdetailreqitem_event_trancode_onchange(iSeqForm)
  {
    var var_tglupdate_ = scAjaxGetFieldText("tglupdate_" + iSeqForm);
    var var_script_case_init = document.F2.script_case_init.value;
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_tbdetailreqitem_event_trancode_onchange(var_tglupdate_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_tbdetailreqitem_event_trancode_onchange_cb);
  } // do_ajax_form_tbdetailreqitem_event_trancode_onchange

  function do_ajax_form_tbdetailreqitem_event_trancode_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "trancode" + iLineNumber;
    }
    else
    {
    ...
    {
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "trancode");
    }
    else
    {
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "trancode");
    }
    if (!scAjaxHasError())
    {
      scAjaxSetFields();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_tbdetailreqitem_event_trancode_onchange_cb_after_alert);
  } // do_ajax_form_tbdetailreqitem_event_trancode_onchange_cb
  function do_ajax_form_tbdetailreqitem_event_trancode_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_tbdetailreqitem_event_trancode_onchange_cb_after_alert

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_tbdetailreqitem_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_tbdetailreqitem_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tbdetailreqitem_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_tbdetailreqitem_add_new_line_cb);
  } // do_ajax_form_tbdetailreqitem_add_new_line

  function do_ajax_form_tbdetailreqitem_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
    ...
    nm_field_disabled("tglupdate_=disabled", "", iAjaxNewLine);
    nm_field_disabled("realisasi_=disabled", "I", iAjaxNewLine, 'novo');
  } // do_ajax_form_tbdetailreqitem_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_tbdetailreqitem_backup_line(iNumLinha)
  {
    var var_id_ = scAjaxGetFieldText("id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdetailreqitem_backup_line(var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_tbdetailreqitem_backup_line_cb);
  } // do_ajax_form_tbdetailreqitem_backup_line

  function do_ajax_form_tbdetailreqitem_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_tbdetailreqitem_backup_line_cb

  function do_ajax_form_tbdetailreqitem_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_tbdetailreqitem_cancel_insert

  function do_ajax_form_tbdetailreqitem_cancel_update(iSeqVert)
  {
    do_ajax_form_tbdetailreqitem_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_tbdetailreqitem_cancel_update

  function do_ajax_form_tbdetailreqitem_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_tbdetailreqitem_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_tbdetailreqitem_table_refresh()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tbdetailreqitem_table_refresh(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbdetailreqitem_table_refresh_cb);
  } //  do_ajax_form_tbdetailreqitem_table_refresh

  function do_ajax_form_tbdetailreqitem_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_tbdetailreqitem_table_refresh_cb_after_alert);
  } // do_ajax_form_tbdetailreqitem_table_refresh_cb
  function do_ajax_form_tbdetailreqitem_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_tbdetailreqitem_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_tbdetailreqitem_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_tbdetailreqitem_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    var var_permintaan_ = scAjaxGetFieldText("permintaan_" + iNumLinha);
    var var_realisasi_ = scAjaxGetFieldText("realisasi_" + iNumLinha);
    var var_tglupdate_ = scAjaxGetFieldText("tglupdate_" + iNumLinha);
...
?>
    x_ajax_form_tbdetailreqitem_submit_form(var_item_, var_permintaan_, var_realisasi_, var_tglupdate_, var_sc_field_0_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbdetailreqitem_submit_form_cb);
  } // do_ajax_form_tbdetailreqitem_submit_form

  function do_ajax_form_tbdetailreqitem_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("permintaan_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("realisasi_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("tglupdate_" + sc_num_ult_line);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_tbdetailreqitem_submit_form_cb_after_alert);
  } // do_ajax_form_tbdetailreqitem_submit_form_cb
  function do_ajax_form_tbdetailreqitem_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbdetailreqitem_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tbdetailreqitem_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_tbdetailreqitem_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("permintaan_" + iNavForm);
      scAjaxHideErrorDisplay("realisasi_" + iNavForm);
      scAjaxHideErrorDisplay("tglupdate_" + iNavForm);
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tbdetailreqitem_navigate_form(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbdetailreqitem_navigate_form_cb);
  } // do_ajax_form_tbdetailreqitem_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailreqitem']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbdetailreqitem_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbdetailreqitem_navigate_form_cb_after_alert);
  } // do_ajax_form_tbdetailreqitem_navigate_form_cb
  function do_ajax_form_tbdetailreqitem_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_tbdetailreqitem_navigate_form_cb_after_alert
  function sc_hide_form_tbdetailreqitem_form()
  {
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "permintaan_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "realisasi_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "tglupdate_" + iNumLinha;
    iTotCampos++;
    ...
    ajax_error_list["permintaan_" + iNumLinha] = {"label": "Jml. Permintaan<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["realisasi_" + iNumLinha] = {"label": "Jml. Realisasi<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["tglupdate_" + iNumLinha] = {"label": "Tgl Update<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["sc_field_0_" + iNumLinha] = {"label": "Stok Unit<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["item_"][iNumLinha] = "item_" + iNumLinha;
    ajax_field_mult["permintaan_"][iNumLinha] = "permintaan_" + iNumLinha;
    ajax_field_mult["realisasi_"][iNumLinha] = "realisasi_" + iNumLinha;
    ajax_field_mult["tglupdate_"][iNumLinha] = "tglupdate_" + iNumLinha;
    ...
    ajax_field_id["permintaan_" + iNumLinha] = new Array("hidden_field_label_permintaan_", "hidden_field_data_permintaan_" + iNumLinha);
    ajax_field_id["realisasi_" + iNumLinha] = new Array("hidden_field_label_realisasi_", "hidden_field_data_realisasi_" + iNumLinha);
    ajax_field_id["tglupdate_" + iNumLinha] = new Array("hidden_field_label_tglupdate_", "hidden_field_data_tglupdate_" + iNumLinha);
    ...
    ajax_error_count["permintaan_" + iNumLinha] = "off";
    ajax_error_count["realisasi_" + iNumLinha] = "off";
    ajax_error_count["tglupdate_" + iNumLinha] = "off";
...
?>
    ...
    ajax_read_only["permintaan_" + iNumLinha] = "off";
    ajax_read_only["realisasi_" + iNumLinha] = "off";
    ajax_read_only["tglupdate_" + iNumLinha] = "off";
...
?>
    ...
    ajax_read_only["permintaan_" + iNumLinha] = "on";
    ajax_read_only["realisasi_" + iNumLinha] = "on";
    ajax_read_only["tglupdate_" + iNumLinha] = "on";
...
?>
  ...
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["permintaan_" + iNumLinha] = null;
    ajax_error_list["realisasi_" + iNumLinha] = null;
    ajax_error_list["tglupdate_" + iNumLinha] = null;
  ...
  var ajax_field_mult = {
    "item_": new Array(),
    "permintaan_": new Array(),
    "realisasi_": new Array(),
    "tglupdate_": new Array(),
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["permintaan_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["permintaan_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["permintaan_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["permintaan_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["permintaan_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["realisasi_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["realisasi_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["realisasi_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["realisasi_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["realisasi_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["tglupdate_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["tglupdate_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["tglupdate_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["tglupdate_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["tglupdate_" + iNumLinha]["onfocus"] = new Array();
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['permintaan_'])) ? $this->nmgp_cmp_readonly['permintaan_'] : 'off';
?>
    scAjaxFieldRead("permintaan_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['realisasi_'])) ? $this->nmgp_cmp_readonly['realisasi_'] : 'off';
?>
    scAjaxFieldRead("realisasi_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['tglupdate_'])) ? $this->nmgp_cmp_readonly['tglupdate_'] : 'off';
?>
    scAjaxFieldRead("tglupdate_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
?>
  ...
  function mdCloseObjects(iSeq)
  {
    ...
    scAjaxFieldRead("permintaan_" + iSeq, "on");
    scAjaxFieldRead("realisasi_" + iSeq, "on");
    scAjaxFieldRead("tglupdate_" + iSeq, "on");
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["item_" + iRow] || "on" == ajax_error_count["permintaan_" + iRow] || "on" == ajax_error_count["realisasi_" + iRow] || "on" == ajax_error_count["tglupdate_" + iRow] || "on" == ajax_error_count["sc_field_0_" + iRow]))
    {
      ...
      $("#hidden_field_data_permintaan_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_realisasi_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_tglupdate_" + iRow).addClass("scFormErrorLine");
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["item_" + iRow] && "off" == ajax_error_count["permintaan_" + iRow] && "off" == ajax_error_count["realisasi_" + iRow] && "off" == ajax_error_count["tglupdate_" + iRow] && "off" == ajax_error_count["sc_field_0_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["item_" + iRow] = "off";
        ajax_error_count["permintaan_" + iRow] = "off";
        ajax_error_count["realisasi_" + iRow] = "off";
        ajax_error_count["tglupdate_" + iRow] = "off";
      ...
      $("#hidden_field_data_permintaan_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_realisasi_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_tglupdate_" + iRow).removeClass("scFormErrorLine");
