...
$old_error_handler = set_error_handler("form_tbdetailreqitem_scriptcase_error_handler");

function form_tbdetailreqitem_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['form_tbdetailreqitem']['contr_erro']) && $_SESSION['scriptcase']['form_tbdetailreqitem']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_form_tbdetailreqitem->contr_form_tbdetailreqitem->Apl_com_erro = true;
            if ($inicial_form_tbdetailreqitem->contr_form_tbdetailreqitem->NM_ajax_flag)
            {
                $inicial_form_tbdetailreqitem->contr_form_tbdetailreqitem->NM_ajax_info['errList']['geral_form_tbdetailreqitem'][] = $msg;
                return;
            }
            form_tbdetailreqitem_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function form_tbdetailreqitem_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['form_tbdetailreqitem'])  && '' != $_SESSION['scriptcase']['error_icon']['form_tbdetailreqitem'])  ? $_SESSION['scriptcase']['error_icon']['form_tbdetailreqitem']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['form_tbdetailreqitem']) && '' != $_SESSION['scriptcase']['error_span_title']['form_tbdetailreqitem']) ? $_SESSION['scriptcase']['error_span_title']['form_tbdetailreqitem'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['form_tbdetailreqitem']) && '' != $_SESSION['scriptcase']['error_icon_title']['form_tbdetailreqitem']) ? $_SESSION['scriptcase']['error_icon_title']['form_tbdetailreqitem'] : '';
?>
...
<?php
    ...
    $_SESSION['scriptcase']['form_tbdetailreqitem']['error_buffer'] .= ob_get_flush();
}
