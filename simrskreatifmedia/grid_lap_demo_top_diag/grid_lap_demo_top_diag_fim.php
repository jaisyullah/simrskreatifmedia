...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_lap_demo_top_diag"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_lap_demo_top_diag"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_lap_demo_top_diag']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_lap_demo_top_diag']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_lap_demo_top_diag']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_lap_demo_top_diag']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_lap_demo_top_diag']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_lap_demo_top_diag</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_lap_demo_top_diag']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_lap_demo_top_diag']['embutida_filho'] as $ind => $sc_init)
          {
