<?php
@session_start() ;
$_SESSION['scriptcase']['grid_lap_demo_top_diag']['sc_process_barr'] = true;
require_once('../grid_lap_demo_top_diag/index.php');
unset($_SESSION['scriptcase']['grid_lap_demo_top_diag']['sc_process_barr']);
$ExportCtrl = new grid_lap_demo_top_diag_export_control;
$ExportCtrl->Export_barr();

class grid_lap_demo_top_diag_export_control
{
