...
//----- 
   function ini_controle()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['form_tblab']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['form_tblab']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_tblab']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_tblab']['total']);
          }
          if (!isset($_SESSION['sc_session'][$script_case_init]['form_tblab']['total']))
          {
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_tblab']['form_tblabrate_script_case_init'] ]['form_tblabrate']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_tblab']['form_tblabrate_script_case_init'] ]['form_tblabrate']['total']);
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_tblab']['form_tblabdetail_script_case_init'] ]['form_tblabdetail']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_tblab']['form_tblabdetail_script_case_init'] ]['form_tblabdetail']['total']);
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_tblab']['form_tblabrujukananak_script_case_init'] ]['form_tblabrujukananak']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_tblab']['form_tblabrujukananak_script_case_init'] ]['form_tblabrujukananak']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_tblab']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_tblab']['sc_redir_insert'] = $this->sc_redir_insert;
          }
      } 
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_tblab']['parms']))
      {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_tblab']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_tblab']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_tblab']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_tblab']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_tblab']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_tblab']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_tblab']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_tblab']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_tblab_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("id");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['initialize'];
      } 
      else 
      { 
         $this->nm_data = new nm_data("id");
      } 
      $_SESSION['sc_session'][$script_case_init]['form_tblab']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_tblab']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_tblab'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_tblab']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_tblab']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_tblab') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_tblab']['label'] = "" . $this->Ini->Nm_lang['lang_othr_frmu_title'] . " Cek Lab";
      ...
      $_SESSION['scriptcase']['error_icon']['form_tblab']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Rhino__NM__nm_scriptcase9_Rhino_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_tblab'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['embutida_call'] : $this->Embutida_call;

       $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblab']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblab']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblab']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblab']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblab']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblab']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblab']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblab']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblab']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblab']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblab']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblab']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblab']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_tblab']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_tblab']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblab']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblab']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblab']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_tblab']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_tblab']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblab']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblab']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_tblab']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_tblab']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblab']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblab']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblab']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblab']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblab']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblab']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblab']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblab']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblab']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblab']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblab']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblab']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblab']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblab']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblab']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblab']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblab']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblab']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblab']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblab']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_tblab']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_tblab']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_tblab']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblab']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblab']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblab']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblab']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblab']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblab']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblab']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblab']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblab']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblab']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblab']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblab']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblab']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblab']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblab']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblab']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblab']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblab']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblab']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblab']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblab']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblab']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblab']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblab']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblab']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblab']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblab']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblab']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblab']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblab']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblab']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblab']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblab']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblab']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblab']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblab']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblab']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblab']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblab']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tblab']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_tblab'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_tblab'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_tblab']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_tblab']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_tblab']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_tblab']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_tblab']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_tblab']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_tblab']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_tblab']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['form_tblab']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['dados_form'];
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("form_tblab", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (is_file($this->Ini->path_aplicacao . 'form_tblab_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_tblab_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      { 
          require_once($this->Ini->path_embutida . 'form_tblab/form_tblab_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_tblab_erro.class.php"); 
      }
      $this->Erro      = new form_tblab_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if ($this->nmgp_opcao == "fast_search")  
      {
          $this->SC_fast_search($this->nmgp_fast_search, $this->nmgp_cond_fast_search, $this->nmgp_arg_fast_search);
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['opcao'] = "inicio";
          $this->nmgp_opcao = "inicio";
          $this->proc_fast_search = true;
      } 
      if ($nm_opc_lookup != "lookup" && $nm_opc_php != "formphp")
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['opcao']))
         { 
             if ($this->id != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_tblab']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_tblab']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_tblab']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['opc_ant'];
      } 
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['final'];
      }
      else
      {
      }
...
//
      if ($this->nmgp_opcao == "excluir")
      {
          ...
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['form_tblabrate_script_case_init'] ]['form_tblabrate']['embutida_form'] = false;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['form_tblabrate_script_case_init'] ]['form_tblabrate']['embutida_proc'] = true;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['form_tblabrate_script_case_init'] ]['form_tblabrate']['reg_start'] = "";
          unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['form_tblabrate_script_case_init'] ]['form_tblabrate']['total']);
          require_once($this->Ini->root . $this->Ini->path_link  . SC_dir_app_name('form_tblabrate') . "/index.php");
          require_once($this->Ini->root . $this->Ini->path_link  . SC_dir_app_name('form_tblabrate') . "/form_tblabrate_apl.php");
          $this->form_tblabrate = new form_tblabrate_apl;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['form_tblabdetail_script_case_init'] ]['form_tblabdetail']['embutida_form'] = false;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['form_tblabdetail_script_case_init'] ]['form_tblabdetail']['embutida_proc'] = true;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['form_tblabdetail_script_case_init'] ]['form_tblabdetail']['reg_start'] = "";
          unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['form_tblabdetail_script_case_init'] ]['form_tblabdetail']['total']);
          require_once($this->Ini->root . $this->Ini->path_link  . SC_dir_app_name('form_tblabdetail') . "/index.php");
          require_once($this->Ini->root . $this->Ini->path_link  . SC_dir_app_name('form_tblabdetail') . "/form_tblabdetail_apl.php");
          $this->form_tblabdetail = new form_tblabdetail_apl;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['form_tblabrujukananak_script_case_init'] ]['form_tblabrujukananak']['embutida_form'] = false;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['form_tblabrujukananak_script_case_init'] ]['form_tblabrujukananak']['embutida_proc'] = true;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['form_tblabrujukananak_script_case_init'] ]['form_tblabrujukananak']['reg_start'] = "";
          unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['form_tblabrujukananak_script_case_init'] ]['form_tblabrujukananak']['total']);
          require_once($this->Ini->root . $this->Ini->path_link  . SC_dir_app_name('form_tblabrujukananak') . "/index.php");
          require_once($this->Ini->root . $this->Ini->path_link  . SC_dir_app_name('form_tblabrujukananak') . "/form_tblabrujukananak_apl.php");
          $this->form_tblabrujukananak = new form_tblabrujukananak_apl;
      }
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['dados_select'];
     }
   }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
      ...
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "recarga_mobile" || $this->nmgp_opcao == "muda_form") 
      {
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['dados_select']['labcode']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->labcode = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['dados_select']['labcode'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['dados_select']['lastupdated']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->lastupdated = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['dados_select']['lastupdated'];
          } 
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['recarga'] = $this->nmgp_opcao;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['sc_redir_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['sc_redir_insert'] == "ok")
          {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['sc_redir_atualiz'] == "ok")
          {
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "form_tblab.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab'][$path_doc_md5][1] = $Zip_name;
?>
...
<form name="Fdown" method="get" action="form_tblab_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="form_tblab"> 
...
//---------------------------------------------------------
     ...
     if ('' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_form_tblab']) || !is_array($this->NM_ajax_info['errList']['geral_form_tblab']))
              {
                  $this->NM_ajax_info['errList']['geral_form_tblab'] = array();
              }
              $this->NM_ajax_info['errList']['geral_form_tblab'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
...
//---
    ...
    function ValidateField_kategori(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->kategori) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['Lookup_kategori']) && !in_array($this->kategori, $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['Lookup_kategori']))
               {
                   $hasError = true;
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['dados_form'] = $this->nmgp_dados_form;
   }
...
//-- 
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['id']['keyVal'] = form_tblab_pack_protect_string($this->nmgp_dados_form['id']);
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['form_tblabrujukananak_script_case_init'] ]['form_tblabrujukananak']['foreign_key']['labcode'] = $this->nmgp_dados_form['labcode'];
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['form_tblabrujukananak_script_case_init'] ]['form_tblabrujukananak']['foreign_key']['kategori'] = $this->nmgp_dados_form['kategori'];
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['form_tblabrujukananak_script_case_init'] ]['form_tblabrujukananak']['foreign_key']['nama'] = $this->nmgp_dados_form['nama'];
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['form_tblabrujukananak_script_case_init'] ]['form_tblabrujukananak']['where_filter'] = "labcode = '" . $this->nmgp_dados_form['labcode'] . "' AND kategori = '" . $this->nmgp_dados_form['kategori'] . "' AND nama = '" . $this->nmgp_dados_form['nama'] . "'";
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['form_tblabrujukananak_script_case_init'] ]['form_tblabrujukananak']['where_detal']  = "labcode = '" . $this->nmgp_dados_form['labcode'] . "' AND kategori = '" . $this->nmgp_dados_form['kategori'] . "' AND nama = '" . $this->nmgp_dados_form['nama'] . "'";
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['total'] < 0)
              {
                  $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['form_tblabrujukananak_script_case_init'] ]['form_tblabrujukananak']['where_filter'] = "1 <> 1";
              }
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['form_tblabrujukananak_script_case_init'] ]['form_tblabrujukananak']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['form_tblabrujukananak_script_case_init'] ]['form_tblabrujukananak']['total']);
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['form_tblabdetail_script_case_init'] ]['form_tblabdetail']['foreign_key']['labcode'] = $this->nmgp_dados_form['labcode'];
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['form_tblabdetail_script_case_init'] ]['form_tblabdetail']['where_filter'] = "labcode = '" . $this->nmgp_dados_form['labcode'] . "'";
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['form_tblabdetail_script_case_init'] ]['form_tblabdetail']['where_detal']  = "labcode = '" . $this->nmgp_dados_form['labcode'] . "'";
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['total'] < 0)
              {
                  $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['form_tblabdetail_script_case_init'] ]['form_tblabdetail']['where_filter'] = "1 <> 1";
              }
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['form_tblabdetail_script_case_init'] ]['form_tblabdetail']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['form_tblabdetail_script_case_init'] ]['form_tblabdetail']['total']);
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['form_tblabrate_script_case_init'] ]['form_tblabrate']['foreign_key']['labcode'] = $this->nmgp_dados_form['labcode'];
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['form_tblabrate_script_case_init'] ]['form_tblabrate']['where_filter'] = "labcode = '" . $this->nmgp_dados_form['labcode'] . "'";
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['form_tblabrate_script_case_init'] ]['form_tblabrate']['where_detal']  = "labcode = '" . $this->nmgp_dados_form['labcode'] . "'";
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['total'] < 0)
              {
                  $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['form_tblabrate_script_case_init'] ]['form_tblabrate']['where_filter'] = "1 <> 1";
              }
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['form_tblabrate_script_case_init'] ]['form_tblabrate']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['form_tblabrate_script_case_init'] ]['form_tblabrate']['total']);
          }
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['Lookup_kategori']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['Lookup_kategori'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['Lookup_kategori']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['Lookup_kategori'] = array(); 
}
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       while (!$rs->EOF) 
       { 
              $aLookup[] = array(form_tblab_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', form_tblab_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['Lookup_kategori'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['kategori']['valList'][$i] = form_tblab_pack_protect_string($v);
          }
...
$aLookup[] = array(form_tblab_pack_protect_string('0') => form_tblab_pack_protect_string("Range"));
$aLookup[] = array(form_tblab_pack_protect_string('1') => form_tblab_pack_protect_string("Pilihan"));
$aLookup[] = array(form_tblab_pack_protect_string('2') => form_tblab_pack_protect_string("Uraian"));
$aLookup[] = array(form_tblab_pack_protect_string('3') => form_tblab_pack_protect_string("Sub-Pemeriksaan"));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['Lookup_tipehasil'][] = '0';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['Lookup_tipehasil'][] = '1';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['Lookup_tipehasil'][] = '2';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['Lookup_tipehasil'][] = '3';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['tipehasil']['valList'][$i] = form_tblab_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_tblab_pack_protect_string('') => form_tblab_pack_protect_string(""));
$aLookup[] = array(form_tblab_pack_protect_string('-:-') => form_tblab_pack_protect_string("-:-"));
$aLookup[] = array(form_tblab_pack_protect_string(':') => form_tblab_pack_protect_string(":"));
$aLookup[] = array(form_tblab_pack_protect_string('<:<') => form_tblab_pack_protect_string("<:<"));
$aLookup[] = array(form_tblab_pack_protect_string('>:>') => form_tblab_pack_protect_string(">:>"));
$aLookup[] = array(form_tblab_pack_protect_string('?:?') => form_tblab_pack_protect_string("?:?"));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['Lookup_oper'][] = '';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['Lookup_oper'][] = '-:-';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['Lookup_oper'][] = ':';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['Lookup_oper'][] = '<:<';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['Lookup_oper'][] = '>:>';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['Lookup_oper'][] = '?:?';
          ...
          {
              $this->NM_ajax_info['fldList']['oper']['valList'][$i] = form_tblab_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_tblab_pack_protect_string('%') => form_tblab_pack_protect_string("%"));
$aLookup[] = array(form_tblab_pack_protect_string('-') => form_tblab_pack_protect_string("-"));
$aLookup[] = array(form_tblab_pack_protect_string('/LPB') => form_tblab_pack_protect_string("/LPB"));
$aLookup[] = array(form_tblab_pack_protect_string('/mm3') => form_tblab_pack_protect_string("/mm3"));
$aLookup[] = array(form_tblab_pack_protect_string('/uL') => form_tblab_pack_protect_string("/uL"));
$aLookup[] = array(form_tblab_pack_protect_string('1 ml') => form_tblab_pack_protect_string("1 ml"));
$aLookup[] = array(form_tblab_pack_protect_string('CC') => form_tblab_pack_protect_string("CC"));
$aLookup[] = array(form_tblab_pack_protect_string('detik') => form_tblab_pack_protect_string("detik"));
$aLookup[] = array(form_tblab_pack_protect_string('Fl') => form_tblab_pack_protect_string("Fl"));
$aLookup[] = array(form_tblab_pack_protect_string('g/dL') => form_tblab_pack_protect_string("g/dL"));
$aLookup[] = array(form_tblab_pack_protect_string('g/24 jam') => form_tblab_pack_protect_string("g/24 jam"));
$aLookup[] = array(form_tblab_pack_protect_string('gr/dL') => form_tblab_pack_protect_string("gr/dL"));
$aLookup[] = array(form_tblab_pack_protect_string('juta/dL') => form_tblab_pack_protect_string("juta/dL"));
$aLookup[] = array(form_tblab_pack_protect_string('juta/mm3') => form_tblab_pack_protect_string("juta/mm3"));
$aLookup[] = array(form_tblab_pack_protect_string('MENIT') => form_tblab_pack_protect_string("MENIT"));
$aLookup[] = array(form_tblab_pack_protect_string('mEq / L') => form_tblab_pack_protect_string("mEq / L"));
$aLookup[] = array(form_tblab_pack_protect_string('mg/dL') => form_tblab_pack_protect_string("mg/dL"));
$aLookup[] = array(form_tblab_pack_protect_string('mg/L') => form_tblab_pack_protect_string("mg/L"));
$aLookup[] = array(form_tblab_pack_protect_string('ml') => form_tblab_pack_protect_string("ml"));
$aLookup[] = array(form_tblab_pack_protect_string('mm/jam') => form_tblab_pack_protect_string("mm/jam"));
$aLookup[] = array(form_tblab_pack_protect_string('mmol/24 jam') => form_tblab_pack_protect_string("mmol/24 jam"));
$aLookup[] = array(form_tblab_pack_protect_string('mmol/L') => form_tblab_pack_protect_string("mmol/L"));
$aLookup[] = array(form_tblab_pack_protect_string('NEGATIF') => form_tblab_pack_protect_string("NEGATIF"));
$aLookup[] = array(form_tblab_pack_protect_string('ng/dl') => form_tblab_pack_protect_string("ng/dl"));
$aLookup[] = array(form_tblab_pack_protect_string('ng/ml') => form_tblab_pack_protect_string("ng/ml"));
$aLookup[] = array(form_tblab_pack_protect_string('Pg') => form_tblab_pack_protect_string("Pg"));
$aLookup[] = array(form_tblab_pack_protect_string('RESUS') => form_tblab_pack_protect_string("RESUS"));
$aLookup[] = array(form_tblab_pack_protect_string('ribu / mm3') => form_tblab_pack_protect_string("ribu / mm3"));
$aLookup[] = array(form_tblab_pack_protect_string('ribu/dL') => form_tblab_pack_protect_string("ribu/dL"));
$aLookup[] = array(form_tblab_pack_protect_string('U/I') => form_tblab_pack_protect_string("U/I"));
$aLookup[] = array(form_tblab_pack_protect_string('ug/dL') => form_tblab_pack_protect_string("ug/dL"));
$aLookup[] = array(form_tblab_pack_protect_string('UI/ML') => form_tblab_pack_protect_string("UI/ML"));
$aLookup[] = array(form_tblab_pack_protect_string('ulU/mL') => form_tblab_pack_protect_string("ulU/mL"));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['Lookup_satuan'][] = '';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['Lookup_satuan'][] = '%';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['Lookup_satuan'][] = '-';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['Lookup_satuan'][] = '/LPB';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['Lookup_satuan'][] = '/mm3';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['Lookup_satuan'][] = '/uL';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['Lookup_satuan'][] = '1 ml';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['Lookup_satuan'][] = 'CC';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['Lookup_satuan'][] = 'detik';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['Lookup_satuan'][] = 'Fl';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['Lookup_satuan'][] = 'g/dL';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['Lookup_satuan'][] = 'g/24 jam';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['Lookup_satuan'][] = 'gr/dL';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['Lookup_satuan'][] = 'juta/dL';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['Lookup_satuan'][] = 'juta/mm3';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['Lookup_satuan'][] = 'MENIT';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['Lookup_satuan'][] = 'mEq / L';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['Lookup_satuan'][] = 'mg/dL';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['Lookup_satuan'][] = 'mg/L';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['Lookup_satuan'][] = 'ml';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['Lookup_satuan'][] = 'mm/jam';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['Lookup_satuan'][] = 'mmol/24 jam';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['Lookup_satuan'][] = 'mmol/L';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['Lookup_satuan'][] = 'NEGATIF';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['Lookup_satuan'][] = 'ng/dl';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['Lookup_satuan'][] = 'ng/ml';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['Lookup_satuan'][] = 'Pg';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['Lookup_satuan'][] = 'RESUS';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['Lookup_satuan'][] = 'ribu / mm3';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['Lookup_satuan'][] = 'ribu/dL';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['Lookup_satuan'][] = 'U/I';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['Lookup_satuan'][] = 'ug/dL';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['Lookup_satuan'][] = 'UI/ML';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['Lookup_satuan'][] = 'ulU/mL';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['satuan']['valList'][$i] = form_tblab_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   function ajax_return_values_id($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
...
//----------- 
   ...
   { 
    ...
    if ("incluir" == $this->nmgp_opcao) {
      $this->sc_evento = $this->nmgp_opcao;
      $_SESSION['scriptcase']['form_tblab']['contr_erro'] = 'on';
...
$_SESSION['scriptcase']['form_tblab']['contr_erro'] = 'off'; 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['decimal_db'] == ",") 
      {
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['db_changed'] = true;
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['total']);
              }
              ...
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao   = "igual"; 
      ...
      { 
          ...
          if ($bDelecaoOk)
          {
              ...
              $this->form_tblabrujukananak->ini_controle();
              if ($this->form_tblabrujukananak->temRegistros($sDetailWhere))
              {
                  $bDelecaoOk = false;
          ...
          if ($bDelecaoOk)
          {
              ...
              $this->form_tblabdetail->ini_controle();
              if ($this->form_tblabdetail->temRegistros($sDetailWhere))
              {
                  $bDelecaoOk = false;
                  $sMsgErro   = $this->Ini->Nm_lang['lang_errm_fkvi'];
              }
          ...
          {
              $sDetailWhere = "labcode = '" . $this->labcode . "'";
              $this->form_tblabrate->ini_controle();
              if ($this->form_tblabrate->temRegistros($sDetailWhere))
              {
                  $bDelecaoOk = false;
                  $sMsgErro   = $this->Ini->Nm_lang['lang_errm_fkvi'];
              }
          ...
          { 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['reg_start'] = 0; 
              }
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['parms'] = "id?#?$this->id?@?"; 
      }
      $this->NM_commit_db(); 
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['where_filter'] . ")";
          }
      }
//------------ 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['run_iframe'] == "R")
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['iframe_evento'] == "insert") 
          { 
               $this->nmgp_opcao = "novo"; 
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['select'] = "";
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['iframe_evento'] = $this->sc_evento; 
      } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['run_iframe'] == "F" && $this->sc_evento == "insert")
      {
          $this->nmgp_opcao = "final";
      }
      $sc_where = trim("");
      ...
      { 
          ...
          $qt_geral_reg_form_tblab = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['total'] = $qt_geral_reg_form_tblab;
          $rt->Close(); 
          if ($this->nmgp_opcao == "igual" && isset($this->NM_btn_navega) && 'S' == $this->NM_btn_navega && !empty($this->id))
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['reg_start'] = $rt->fields[0];
              $rt->Close(); 
          }
      } 
      else 
      { 
          $qt_geral_reg_form_tblab = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['total'];
      } 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['reg_start']++; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['reg_start'] > $qt_geral_reg_form_tblab)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['reg_start'] = $qt_geral_reg_form_tblab; 
          }
      } 
      ...
      if ($this->nmgp_opcao == "navpage" && ($this->nmgp_ordem - 1) <= $qt_geral_reg_form_tblab) 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['reg_start'] = $this->nmgp_ordem - 1; 
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['reg_start']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['reg_start']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['reg_start'] = 0;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['reg_start'] + 1;
      $this->NM_ajax_info['navSummary']['reg_ini'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['reg_start'] + 1; 
      $this->NM_ajax_info['navSummary']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['reg_qtd']; 
      $this->NM_ajax_info['navSummary']['reg_tot'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['total'] + 1; 
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
              $GLOBALS["NM_ERRO_IBASE"] = 1;  
          } 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['run_iframe'] == "R")
          {
              if ($this->sc_evento == "update")
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['select'] = ""; 
              } 
          } 
          if ($this->nmgp_opcao == "igual") 
          ...
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['reg_start'] . ")" ; 
              $rs = $this->Db->SelectLimit($nmgp_select, 1, $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['reg_start']) ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['reg_start'] . ")" ; 
          ...
          { 
              ...
              if (!$rs === false && !$rs->EOF) 
              { 
                  $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['reg_start']) ;  
              } 
          } 
          ...
          if ($rs->EOF) 
          { 
              if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['where_filter']))
              {
                  ...
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['empty_filter'] = true;
                  return; 
              }
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['dados_select'] = $this->nmgp_dados_select;
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['reg_start'] < $qt_geral_reg_form_tblab;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['opcao']   = '';
          }
      } 
...
//-- 
      ...
      $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['form_tblabrate_script_case_init'] ]['form_tblabrate']['embutida_parms'] = "NM_btn_insert*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinS*scoutNM_btn_navega*scinN*scout";
      $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['form_tblabdetail_script_case_init'] ]['form_tblabdetail']['embutida_parms'] = "NM_btn_insert*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinS*scoutNM_btn_navega*scinN*scout";
      $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['form_tblabrujukananak_script_case_init'] ]['form_tblabrujukananak']['embutida_parms'] = "NM_btn_insert*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinS*scoutNM_btn_navega*scinN*scout";
  }
// 
//-- 
...
//-- 
   ...
   function NM_gera_nav_page() 
   {
       ...
       $rec_tot    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['total'] + 1;
       $rec_fim    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['reg_start'] + 1;
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
        ...
        $this->initFormPages();
    include_once("form_tblab_form0.php");
        $this->hideFormPages();
 }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['table_refresh'])
        {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['csrf_token'];
    }
...
else
{
   ...
   function SC_fast_search($field, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['where_filter_form'] . " and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_form_tblab = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['total'] = $qt_geral_reg_form_tblab;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_tblab_pack_ajax_response();
         ...
         if (isset($Nm_datas[$campo_join]))
         {
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          {
             ...
             $nm_aspas1 = "#";
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['SC_sep_date1'];
              }
          }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "form_tblab_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_tblab_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['masterValue']))
{
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['dashboard_info']['under_dashboard']) {
?>
var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['dashboard_info']['parent_widget']; ?>']");
if (dbParentFrame && dbParentFrame[0] && dbParentFrame[0].contentWindow.scAjaxDetailValue)
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['masterValue'] as $cmp_master => $val_master)
        {
?>
