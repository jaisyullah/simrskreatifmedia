  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tblab_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tblab_mob_form();
	}

  // ---------- Validate labcode
  function do_ajax_form_tblab_mob_validate_labcode()
  {
    var nomeCampo_labcode = "labcode";
    var var_labcode = scAjaxGetFieldText(nomeCampo_labcode);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblab_mob_validate_labcode(var_labcode, var_script_case_init, do_ajax_form_tblab_mob_validate_labcode_cb);
  } // do_ajax_form_tblab_mob_validate_labcode

  function do_ajax_form_tblab_mob_validate_labcode_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblab_mob_validate_labcode_cb

  // ---------- Validate kategori
  function do_ajax_form_tblab_mob_validate_kategori()
  {
    var nomeCampo_kategori = "kategori";
    var var_kategori = scAjaxGetFieldSelect(nomeCampo_kategori);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblab_mob_validate_kategori(var_kategori, var_script_case_init, do_ajax_form_tblab_mob_validate_kategori_cb);
  } // do_ajax_form_tblab_mob_validate_kategori

  function do_ajax_form_tblab_mob_validate_kategori_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblab_mob_validate_kategori_cb

  // ---------- Validate nama
  function do_ajax_form_tblab_mob_validate_nama()
  {
    var nomeCampo_nama = "nama";
    var var_nama = scAjaxGetFieldText(nomeCampo_nama);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblab_mob_validate_nama(var_nama, var_script_case_init, do_ajax_form_tblab_mob_validate_nama_cb);
  } // do_ajax_form_tblab_mob_validate_nama

  function do_ajax_form_tblab_mob_validate_nama_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nama";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblab_mob_validate_nama_cb

  // ---------- Validate tipehasil
  function do_ajax_form_tblab_mob_validate_tipehasil()
  {
    var nomeCampo_tipehasil = "tipehasil";
    var var_tipehasil = scAjaxGetFieldSelect(nomeCampo_tipehasil);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblab_mob_validate_tipehasil(var_tipehasil, var_script_case_init, do_ajax_form_tblab_mob_validate_tipehasil_cb);
  } // do_ajax_form_tblab_mob_validate_tipehasil

  function do_ajax_form_tblab_mob_validate_tipehasil_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblab_mob_validate_tipehasil_cb

  // ---------- Validate oper
  function do_ajax_form_tblab_mob_validate_oper()
  {
    var nomeCampo_oper = "oper";
    var var_oper = scAjaxGetFieldSelect(nomeCampo_oper);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblab_mob_validate_oper(var_oper, var_script_case_init, do_ajax_form_tblab_mob_validate_oper_cb);
  } // do_ajax_form_tblab_mob_validate_oper

  function do_ajax_form_tblab_mob_validate_oper_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "oper";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblab_mob_validate_oper_cb

  // ---------- Validate satuan
  function do_ajax_form_tblab_mob_validate_satuan()
  {
    var nomeCampo_satuan = "satuan";
    var var_satuan = scAjaxGetFieldSelect(nomeCampo_satuan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblab_mob_validate_satuan(var_satuan, var_script_case_init, do_ajax_form_tblab_mob_validate_satuan_cb);
  } // do_ajax_form_tblab_mob_validate_satuan

  function do_ajax_form_tblab_mob_validate_satuan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "satuan";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblab_mob_validate_satuan_cb

  // ---------- Validate p1
  function do_ajax_form_tblab_mob_validate_p1()
  {
    var nomeCampo_p1 = "p1";
    var var_p1 = scAjaxGetFieldText(nomeCampo_p1);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblab_mob_validate_p1(var_p1, var_script_case_init, do_ajax_form_tblab_mob_validate_p1_cb);
  } // do_ajax_form_tblab_mob_validate_p1

  function do_ajax_form_tblab_mob_validate_p1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "p1";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblab_mob_validate_p1_cb

  // ---------- Validate p2
  function do_ajax_form_tblab_mob_validate_p2()
  {
    var nomeCampo_p2 = "p2";
    var var_p2 = scAjaxGetFieldText(nomeCampo_p2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblab_mob_validate_p2(var_p2, var_script_case_init, do_ajax_form_tblab_mob_validate_p2_cb);
  } // do_ajax_form_tblab_mob_validate_p2

  function do_ajax_form_tblab_mob_validate_p2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "p2";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblab_mob_validate_p2_cb

  // ---------- Validate w1
  function do_ajax_form_tblab_mob_validate_w1()
  {
    var nomeCampo_w1 = "w1";
    var var_w1 = scAjaxGetFieldText(nomeCampo_w1);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblab_mob_validate_w1(var_w1, var_script_case_init, do_ajax_form_tblab_mob_validate_w1_cb);
  } // do_ajax_form_tblab_mob_validate_w1

  function do_ajax_form_tblab_mob_validate_w1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "w1";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblab_mob_validate_w1_cb

  // ---------- Validate w2
  function do_ajax_form_tblab_mob_validate_w2()
  {
    var nomeCampo_w2 = "w2";
    var var_w2 = scAjaxGetFieldText(nomeCampo_w2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblab_mob_validate_w2(var_w2, var_script_case_init, do_ajax_form_tblab_mob_validate_w2_cb);
  } // do_ajax_form_tblab_mob_validate_w2

  function do_ajax_form_tblab_mob_validate_w2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "w2";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblab_mob_validate_w2_cb

  // ---------- Validate lastupdated
  function do_ajax_form_tblab_mob_validate_lastupdated()
  {
    var nomeCampo_lastupdated = "lastupdated";
    var var_lastupdated = scAjaxGetFieldText(nomeCampo_lastupdated);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblab_mob_validate_lastupdated(var_lastupdated, var_script_case_init, do_ajax_form_tblab_mob_validate_lastupdated_cb);
  } // do_ajax_form_tblab_mob_validate_lastupdated

  function do_ajax_form_tblab_mob_validate_lastupdated_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblab_mob_validate_lastupdated_cb

  // ---------- Validate tarif
  function do_ajax_form_tblab_mob_validate_tarif()
  {
    var nomeCampo_tarif = "tarif";
    var var_tarif = scAjaxGetFieldText(nomeCampo_tarif);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblab_mob_validate_tarif(var_tarif, var_script_case_init, do_ajax_form_tblab_mob_validate_tarif_cb);
  } // do_ajax_form_tblab_mob_validate_tarif

  function do_ajax_form_tblab_mob_validate_tarif_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tarif";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblab_mob_validate_tarif_cb

  // ---------- Validate detail
  function do_ajax_form_tblab_mob_validate_detail()
  {
    var nomeCampo_detail = "detail";
    var var_detail = scAjaxGetFieldText(nomeCampo_detail);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblab_mob_validate_detail(var_detail, var_script_case_init, do_ajax_form_tblab_mob_validate_detail_cb);
  } // do_ajax_form_tblab_mob_validate_detail

  function do_ajax_form_tblab_mob_validate_detail_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "detail";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblab_mob_validate_detail_cb

  // ---------- Validate sc_field_0
  function do_ajax_form_tblab_mob_validate_sc_field_0()
  {
    var nomeCampo_sc_field_0 = "sc_field_0";
    var var_sc_field_0 = scAjaxGetFieldText(nomeCampo_sc_field_0);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblab_mob_validate_sc_field_0(var_sc_field_0, var_script_case_init, do_ajax_form_tblab_mob_validate_sc_field_0_cb);
  } // do_ajax_form_tblab_mob_validate_sc_field_0

  function do_ajax_form_tblab_mob_validate_sc_field_0_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblab_mob_validate_sc_field_0_cb

  // ---------- Validate id
  function do_ajax_form_tblab_mob_validate_id()
  {
    var nomeCampo_id = "id";
    var var_id = scAjaxGetFieldHidden(nomeCampo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblab_mob_validate_id(var_id, var_script_case_init, do_ajax_form_tblab_mob_validate_id_cb);
  } // do_ajax_form_tblab_mob_validate_id

  function do_ajax_form_tblab_mob_validate_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblab_mob_validate_id_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tblab_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tblab_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_tblab_mob_submit_form(var_labcode, var_kategori, var_nama, var_tipehasil, var_oper, var_satuan, var_p1, var_p2, var_w1, var_w2, var_lastupdated, var_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tblab_mob_submit_form_cb);
  } // do_ajax_form_tblab_mob_submit_form

  function do_ajax_form_tblab_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tblab_mob_submit_form_cb_after_alert);
  } // do_ajax_form_tblab_mob_submit_form_cb
  function do_ajax_form_tblab_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tblab_mob_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_tblabrate_mob"] = "off";
  scStatusDetail["form_tblabdetail_mob"] = "off";
  scStatusDetail["form_tblabrujukananak_mob"] = "off";

  function do_ajax_form_tblab_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    scStatusDetail["form_tblabrate_mob"] = "on";
    scStatusDetail["form_tblabdetail_mob"] = "on";
    scStatusDetail["form_tblabrujukananak_mob"] = "on";
    x_ajax_form_tblab_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tblab_mob_navigate_form_cb);
  } // do_ajax_form_tblab_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tblab_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_tblabrate_mob"] && "nmsc_iframe_liga_form_tblabrate_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_tblabrate_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_tblabrate_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_tblabrate_mob').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_tblabrate_mob').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_tblabrate_mob').style.display = "none";
    }
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_tblabdetail_mob"] && "nmsc_iframe_liga_form_tblabdetail_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_tblabdetail_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_tblabdetail_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_tblabdetail_mob').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_tblabdetail_mob').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_tblabdetail_mob').style.display = "none";
    }
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_tblabrujukananak_mob"] && "nmsc_iframe_liga_form_tblabrujukananak_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_tblabrujukananak_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_tblabrujukananak_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_tblabrujukananak_mob').contentWindow.nm_move('apl_detalhe', true, '500');
        document.getElementById('nmsc_iframe_liga_form_tblabrujukananak_mob').style.height = "500";
        document.getElementById('nmsc_iframe_liga_form_tblabrujukananak_mob').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tblab_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_tblab_mob_navigate_form_cb
  function do_ajax_form_tblab_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_tblab_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_tblab_mob_navigate_form_cb_after_alert
  function sc_hide_form_tblab_mob_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_tblabrate_mob"] && "off" == scStatusDetail["form_tblabdetail_mob"] && "off" == scStatusDetail["form_tblabrujukananak_mob"])
    {
      return true;
    }
    return false;
