  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tblab" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tblab_form();
	}

  // ---------- Validate labcode
  function do_ajax_form_tblab_validate_labcode()
  {
    var nomeCampo_labcode = "labcode";
    var var_labcode = scAjaxGetFieldText(nomeCampo_labcode);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblab_validate_labcode(var_labcode, var_script_case_init, do_ajax_form_tblab_validate_labcode_cb);
  } // do_ajax_form_tblab_validate_labcode

  function do_ajax_form_tblab_validate_labcode_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblab_validate_labcode_cb

  // ---------- Validate kategori
  function do_ajax_form_tblab_validate_kategori()
  {
    var nomeCampo_kategori = "kategori";
    var var_kategori = scAjaxGetFieldSelect(nomeCampo_kategori);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblab_validate_kategori(var_kategori, var_script_case_init, do_ajax_form_tblab_validate_kategori_cb);
  } // do_ajax_form_tblab_validate_kategori

  function do_ajax_form_tblab_validate_kategori_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblab_validate_kategori_cb

  // ---------- Validate nama
  function do_ajax_form_tblab_validate_nama()
  {
    var nomeCampo_nama = "nama";
    var var_nama = scAjaxGetFieldText(nomeCampo_nama);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblab_validate_nama(var_nama, var_script_case_init, do_ajax_form_tblab_validate_nama_cb);
  } // do_ajax_form_tblab_validate_nama

  function do_ajax_form_tblab_validate_nama_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nama";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblab_validate_nama_cb

  // ---------- Validate tipehasil
  function do_ajax_form_tblab_validate_tipehasil()
  {
    var nomeCampo_tipehasil = "tipehasil";
    var var_tipehasil = scAjaxGetFieldSelect(nomeCampo_tipehasil);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblab_validate_tipehasil(var_tipehasil, var_script_case_init, do_ajax_form_tblab_validate_tipehasil_cb);
  } // do_ajax_form_tblab_validate_tipehasil

  function do_ajax_form_tblab_validate_tipehasil_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tipehasil";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblab_validate_tipehasil_cb

  // ---------- Validate oper
  function do_ajax_form_tblab_validate_oper()
  {
    var nomeCampo_oper = "oper";
    var var_oper = scAjaxGetFieldSelect(nomeCampo_oper);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblab_validate_oper(var_oper, var_script_case_init, do_ajax_form_tblab_validate_oper_cb);
  } // do_ajax_form_tblab_validate_oper

  function do_ajax_form_tblab_validate_oper_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "oper";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblab_validate_oper_cb

  // ---------- Validate satuan
  function do_ajax_form_tblab_validate_satuan()
  {
    var nomeCampo_satuan = "satuan";
    var var_satuan = scAjaxGetFieldSelect(nomeCampo_satuan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblab_validate_satuan(var_satuan, var_script_case_init, do_ajax_form_tblab_validate_satuan_cb);
  } // do_ajax_form_tblab_validate_satuan

  function do_ajax_form_tblab_validate_satuan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "satuan";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblab_validate_satuan_cb

  // ---------- Validate p1
  function do_ajax_form_tblab_validate_p1()
  {
    var nomeCampo_p1 = "p1";
    var var_p1 = scAjaxGetFieldText(nomeCampo_p1);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblab_validate_p1(var_p1, var_script_case_init, do_ajax_form_tblab_validate_p1_cb);
  } // do_ajax_form_tblab_validate_p1

  function do_ajax_form_tblab_validate_p1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "p1";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblab_validate_p1_cb

  // ---------- Validate p2
  function do_ajax_form_tblab_validate_p2()
  {
    var nomeCampo_p2 = "p2";
    var var_p2 = scAjaxGetFieldText(nomeCampo_p2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblab_validate_p2(var_p2, var_script_case_init, do_ajax_form_tblab_validate_p2_cb);
  } // do_ajax_form_tblab_validate_p2

  function do_ajax_form_tblab_validate_p2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "p2";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblab_validate_p2_cb

  // ---------- Validate w1
  function do_ajax_form_tblab_validate_w1()
  {
    var nomeCampo_w1 = "w1";
    var var_w1 = scAjaxGetFieldText(nomeCampo_w1);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblab_validate_w1(var_w1, var_script_case_init, do_ajax_form_tblab_validate_w1_cb);
  } // do_ajax_form_tblab_validate_w1

  function do_ajax_form_tblab_validate_w1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "w1";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblab_validate_w1_cb

  // ---------- Validate w2
  function do_ajax_form_tblab_validate_w2()
  {
    var nomeCampo_w2 = "w2";
    var var_w2 = scAjaxGetFieldText(nomeCampo_w2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblab_validate_w2(var_w2, var_script_case_init, do_ajax_form_tblab_validate_w2_cb);
  } // do_ajax_form_tblab_validate_w2

  function do_ajax_form_tblab_validate_w2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "w2";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblab_validate_w2_cb

  // ---------- Validate lastupdated
  function do_ajax_form_tblab_validate_lastupdated()
  {
    var nomeCampo_lastupdated = "lastupdated";
    var var_lastupdated = scAjaxGetFieldText(nomeCampo_lastupdated);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblab_validate_lastupdated(var_lastupdated, var_script_case_init, do_ajax_form_tblab_validate_lastupdated_cb);
  } // do_ajax_form_tblab_validate_lastupdated

  function do_ajax_form_tblab_validate_lastupdated_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblab_validate_lastupdated_cb

  // ---------- Validate tarif
  function do_ajax_form_tblab_validate_tarif()
  {
    var nomeCampo_tarif = "tarif";
    var var_tarif = scAjaxGetFieldText(nomeCampo_tarif);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblab_validate_tarif(var_tarif, var_script_case_init, do_ajax_form_tblab_validate_tarif_cb);
  } // do_ajax_form_tblab_validate_tarif

  function do_ajax_form_tblab_validate_tarif_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tarif";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblab_validate_tarif_cb

  // ---------- Validate detail
  function do_ajax_form_tblab_validate_detail()
  {
    var nomeCampo_detail = "detail";
    var var_detail = scAjaxGetFieldText(nomeCampo_detail);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblab_validate_detail(var_detail, var_script_case_init, do_ajax_form_tblab_validate_detail_cb);
  } // do_ajax_form_tblab_validate_detail

  function do_ajax_form_tblab_validate_detail_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "detail";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblab_validate_detail_cb

  // ---------- Validate sc_field_0
  function do_ajax_form_tblab_validate_sc_field_0()
  {
    var nomeCampo_sc_field_0 = "sc_field_0";
    var var_sc_field_0 = scAjaxGetFieldText(nomeCampo_sc_field_0);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblab_validate_sc_field_0(var_sc_field_0, var_script_case_init, do_ajax_form_tblab_validate_sc_field_0_cb);
  } // do_ajax_form_tblab_validate_sc_field_0

  function do_ajax_form_tblab_validate_sc_field_0_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblab_validate_sc_field_0_cb

  // ---------- Validate id
  function do_ajax_form_tblab_validate_id()
  {
    var nomeCampo_id = "id";
    var var_id = scAjaxGetFieldHidden(nomeCampo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblab_validate_id(var_id, var_script_case_init, do_ajax_form_tblab_validate_id_cb);
  } // do_ajax_form_tblab_validate_id

  function do_ajax_form_tblab_validate_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblab_validate_id_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tblab_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tblab_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_labcode = scAjaxGetFieldText("labcode");
    var var_kategori = scAjaxGetFieldSelect("kategori");
    var var_nama = scAjaxGetFieldText("nama");
    var var_tipehasil = scAjaxGetFieldSelect("tipehasil");
    var var_oper = scAjaxGetFieldSelect("oper");
    var var_satuan = scAjaxGetFieldSelect("satuan");
    var var_p1 = scAjaxGetFieldText("p1");
    var var_p2 = scAjaxGetFieldText("p2");
    var var_w1 = scAjaxGetFieldText("w1");
    var var_w2 = scAjaxGetFieldText("w2");
    ...
    scAjaxProcOn();
    x_ajax_form_tblab_submit_form(var_labcode, var_kategori, var_nama, var_tipehasil, var_oper, var_satuan, var_p1, var_p2, var_w1, var_w2, var_lastupdated, var_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tblab_submit_form_cb);
  } // do_ajax_form_tblab_submit_form

  function do_ajax_form_tblab_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("tipehasil");
      scAjaxHideErrorDisplay("oper");
      scAjaxHideErrorDisplay("satuan");
      scAjaxHideErrorDisplay("p1");
      scAjaxHideErrorDisplay("p2");
      scAjaxHideErrorDisplay("w1");
      scAjaxHideErrorDisplay("w2");
      scAjaxHideErrorDisplay("lastupdated");
      scAjaxHideErrorDisplay("tarif");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tblab_submit_form_cb_after_alert);
  } // do_ajax_form_tblab_submit_form_cb
  function do_ajax_form_tblab_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tblab_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_tblabrate"] = "off";
  scStatusDetail["form_tblabdetail"] = "off";
  scStatusDetail["form_tblabrujukananak"] = "off";

  function do_ajax_form_tblab_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    scStatusDetail["form_tblabrate"] = "on";
    scStatusDetail["form_tblabdetail"] = "on";
    scStatusDetail["form_tblabrujukananak"] = "on";
    x_ajax_form_tblab_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tblab_navigate_form_cb);
  } // do_ajax_form_tblab_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tblab_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_tblabrate"] && "nmsc_iframe_liga_form_tblabrate" != scMasterDetailIframe["nmsc_iframe_liga_form_tblabrate"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_tblabrate"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_tblabrate').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_tblabrate').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_tblabrate').style.display = "none";
    }
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_tblabdetail"] && "nmsc_iframe_liga_form_tblabdetail" != scMasterDetailIframe["nmsc_iframe_liga_form_tblabdetail"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_tblabdetail"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_tblabdetail').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_tblabdetail').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_tblabdetail').style.display = "none";
    }
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_tblabrujukananak"] && "nmsc_iframe_liga_form_tblabrujukananak" != scMasterDetailIframe["nmsc_iframe_liga_form_tblabrujukananak"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_tblabrujukananak"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_tblabrujukananak').contentWindow.nm_move('apl_detalhe', true, '500');
        document.getElementById('nmsc_iframe_liga_form_tblabrujukananak').style.height = "500";
        document.getElementById('nmsc_iframe_liga_form_tblabrujukananak').style.display = "none";
    }
    scAjaxSetBtnVars();
    sc_change_tabs(true, 'hidden_bloco_1', 'id_tabs_1_1');
    sc_change_tabs(false, 'hidden_bloco_2', 'id_tabs_1_2');
    sc_change_tabs(false, 'hidden_bloco_3', 'id_tabs_1_3');
    sc_change_tabs(false, 'hidden_bloco_4', 'id_tabs_1_4');
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tblab_navigate_form_cb_after_alert);
  } // do_ajax_form_tblab_navigate_form_cb
  function do_ajax_form_tblab_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_tblab_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_tblab_navigate_form_cb_after_alert
  function sc_hide_form_tblab_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_tblabrate"] && "off" == scStatusDetail["form_tblabdetail"] && "off" == scStatusDetail["form_tblabrujukananak"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[1] = "kategori";
  ajax_field_list[2] = "nama";
  ajax_field_list[3] = "tipehasil";
  ajax_field_list[4] = "oper";
  ajax_field_list[5] = "satuan";
  ajax_field_list[6] = "p1";
  ajax_field_list[7] = "p2";
  ajax_field_list[8] = "w1";
  ajax_field_list[9] = "w2";
  ajax_field_list[10] = "lastupdated";
  ajax_field_list[11] = "tarif";
  ajax_field_list[12] = "detail";
  ...
  var ajax_error_list = {
    "labcode": {"label": "Kode Lab", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "tipehasil": {"label": "Tipehasil", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "oper": {"label": "Oper (Pria : Wanita)", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "satuan": {"label": "Satuan", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "p1": {"label": "Rujukan Pria 1", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "p2": {"label": "Rujukan Pria 2", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "w1": {"label": "Rujukan Wanita 1", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "w2": {"label": "Rujukan Wanita 2", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "lastupdated": {"label": "Terakhir Update", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "tarif": {"label": "", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "detail": {"label": "", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  var ajax_block_tab = {
    ...
    "hidden_bloco_3": "id_tabs_1_3",
    "hidden_bloco_4": "id_tabs_1_4"
  };
  ...
  ajax_field_mult["tipehasil"][1] = "tipehasil";
  ajax_field_mult["oper"][1] = "oper";
  ajax_field_mult["satuan"][1] = "satuan";
  ajax_field_mult["p1"][1] = "p1";
  ajax_field_mult["p2"][1] = "p2";
  ajax_field_mult["w1"][1] = "w1";
  ajax_field_mult["w2"][1] = "w2";
  ajax_field_mult["lastupdated"][1] = "lastupdated";
  ajax_field_mult["tarif"][1] = "tarif";
  ...
  var ajax_field_id = {
    ...
    "tipehasil": new Array("hidden_field_label_tipehasil", "hidden_field_data_tipehasil"),
    ...
    "p1": new Array("hidden_field_label_p1", "hidden_field_data_p1"),
    "p2": new Array("hidden_field_label_p2", "hidden_field_data_p2"),
    "w1": new Array("hidden_field_label_w1", "hidden_field_data_w1"),
    "w2": new Array("hidden_field_label_w2", "hidden_field_data_w2"),
    "lastupdated": new Array("hidden_field_label_lastupdated", "hidden_field_data_lastupdated"),
    "tarif": new Array("hidden_field_label_tarif", "hidden_field_data_tarif"),
