...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_lastupdated_hora' + iSeqRow).bind('blur', function() { sc_form_tblab_lastupdated_hora_onblur(this, iSeqRow) })
                                              .bind('focus', function() { sc_form_tblab_lastupdated_hora_onfocus(this, iSeqRow) });
...
function sc_form_tblab_lastupdated_hora_onblur(oThis, iSeqRow) {
  do_ajax_form_tblab_validate_lastupdated();
  scCssBlur(oThis);
}
...
function sc_form_tblab_lastupdated_hora_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function displayChange_field_tarif(row, status) {
	if ("on" == status && typeof $("#nmsc_iframe_liga_form_tblabrate")[0].contentWindow.scRecreateSelect2 === "function") {
		$("#nmsc_iframe_liga_form_tblabrate")[0].contentWindow.scRecreateSelect2();
	}
}

function displayChange_field_detail(row, status) {
	if ("on" == status && typeof $("#nmsc_iframe_liga_form_tblabdetail")[0].contentWindow.scRecreateSelect2 === "function") {
		$("#nmsc_iframe_liga_form_tblabdetail")[0].contentWindow.scRecreateSelect2();
	}
}

function displayChange_field_sc_field_0(row, status) {
	if ("on" == status && typeof $("#nmsc_iframe_liga_form_tblabrujukananak")[0].contentWindow.scRecreateSelect2 === "function") {
		$("#nmsc_iframe_liga_form_tblabrujukananak")[0].contentWindow.scRecreateSelect2();
	}
}
...
function scHidePage(pageNo) {
	$("#id_form_tblab_form" + pageNo).hide();
}
