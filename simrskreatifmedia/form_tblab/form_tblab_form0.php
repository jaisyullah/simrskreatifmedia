...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['embutida_pdf']))
 {
 ?>
...
<?php
include_once("form_tblab_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_tblab_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
?>
...
<?php
 include_once("form_tblab_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_tblab'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_tblab'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['fast_search'][2] : "";
?> 
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['run_iframe'] != "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['run_iframe'] == "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_kategori_line" id="hidden_field_data_kategori" style="<?php echo $sStyleHidden_kategori; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_kategori_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tipehasil_label" id="hidden_field_label_tipehasil" style="<?php echo $sStyleHidden_tipehasil; ?>"><span id="id_label_tipehasil"><?php echo $this->nm_new_label['tipehasil']; ?></span></TD>
    <TD class="scFormDataOdd css_tipehasil_line" id="hidden_field_data_tipehasil" style="<?php echo $sStyleHidden_tipehasil; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tipehasil_line" style="vertical-align: top;padding: 0px">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['Lookup_tipehasil'][] = '0'; ?>
 <option  value="1" <?php  if ($this->tipehasil == "1") { echo " selected" ;} ?>>Pilihan</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['Lookup_tipehasil'][] = '1'; ?>
 <option  value="2" <?php  if ($this->tipehasil == "2") { echo " selected" ;} ?>>Uraian</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['Lookup_tipehasil'][] = '2'; ?>
 <option  value="3" <?php  if ($this->tipehasil == "3") { echo " selected" ;} ?>>Sub-Pemeriksaan</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['Lookup_tipehasil'][] = '3'; ?>
 </select></span>
</span><?php  }?>
...
<ul class="scTabLine">
<li id="id_tabs_1_1" class="scTabActive"><a href="javascript: sc_control_tabs_1(1)">Nilai</a></li>
<li id="id_tabs_1_2" class="scTabInactive"><a href="javascript: sc_control_tabs_1(2)">Harga</a></li>
<li id="id_tabs_1_3" class="scTabInactive"><a href="javascript: sc_control_tabs_1(3)">Sub-Pemeriksaan</a></li>
<li id="id_tabs_1_4" class="scTabInactive"><a href="javascript: sc_control_tabs_1(4)">N. Rujukan Anak</a></li>
</ul>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['Lookup_oper'][] = ''; ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_satuan_label" id="hidden_field_label_satuan" style="<?php echo $sStyleHidden_satuan; ?>"><span id="id_label_satuan"><?php echo $this->nm_new_label['satuan']; ?></span></TD>
    <TD class="scFormDataOdd css_satuan_line" id="hidden_field_data_satuan" style="<?php echo $sStyleHidden_satuan; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_satuan_line" style="vertical-align: top;padding: 0px">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['Lookup_satuan'][] = ''; ?>
 <option  value="%" <?php  if ($this->satuan == "%") { echo " selected" ;} ?>>%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['Lookup_satuan'][] = '%'; ?>
 <option  value="-" <?php  if ($this->satuan == "-") { echo " selected" ;} ?>>-</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['Lookup_satuan'][] = '-'; ?>
 <option  value="/LPB" <?php  if ($this->satuan == "/LPB") { echo " selected" ;} ?>>/LPB</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['Lookup_satuan'][] = '/LPB'; ?>
 <option  value="/mm3" <?php  if ($this->satuan == "/mm3") { echo " selected" ;} ?>>/mm3</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['Lookup_satuan'][] = '/mm3'; ?>
 <option  value="/uL" <?php  if ($this->satuan == "/uL") { echo " selected" ;} ?>>/uL</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['Lookup_satuan'][] = '/uL'; ?>
 <option  value="1 ml" <?php  if ($this->satuan == "1 ml") { echo " selected" ;} ?>>1 ml</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['Lookup_satuan'][] = '1 ml'; ?>
 <option  value="CC" <?php  if ($this->satuan == "CC") { echo " selected" ;} ?>>CC</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['Lookup_satuan'][] = 'CC'; ?>
 <option  value="detik" <?php  if ($this->satuan == "detik") { echo " selected" ;} ?>>detik</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['Lookup_satuan'][] = 'detik'; ?>
 <option  value="Fl" <?php  if ($this->satuan == "Fl") { echo " selected" ;} ?>>Fl</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['Lookup_satuan'][] = 'Fl'; ?>
 <option  value="g/dL" <?php  if ($this->satuan == "g/dL") { echo " selected" ;} ?>>g/dL</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['Lookup_satuan'][] = 'g/dL'; ?>
 <option  value="g/24 jam" <?php  if ($this->satuan == "g/24 jam") { echo " selected" ;} ?>>g/24 jam</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['Lookup_satuan'][] = 'g/24 jam'; ?>
 <option  value="gr/dL" <?php  if ($this->satuan == "gr/dL") { echo " selected" ;} ?>>gr/dL</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['Lookup_satuan'][] = 'gr/dL'; ?>
 <option  value="juta/dL" <?php  if ($this->satuan == "juta/dL") { echo " selected" ;} ?>>juta/dL</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['Lookup_satuan'][] = 'juta/dL'; ?>
 <option  value="juta/mm3" <?php  if ($this->satuan == "juta/mm3") { echo " selected" ;} ?>>juta/mm3</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['Lookup_satuan'][] = 'juta/mm3'; ?>
 <option  value="MENIT" <?php  if ($this->satuan == "MENIT") { echo " selected" ;} ?>>MENIT</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['Lookup_satuan'][] = 'MENIT'; ?>
 <option  value="mEq / L" <?php  if ($this->satuan == "mEq / L") { echo " selected" ;} ?>>mEq / L</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['Lookup_satuan'][] = 'mEq / L'; ?>
 <option  value="mg/dL" <?php  if ($this->satuan == "mg/dL") { echo " selected" ;} ?>>mg/dL</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['Lookup_satuan'][] = 'mg/dL'; ?>
 <option  value="mg/L" <?php  if ($this->satuan == "mg/L") { echo " selected" ;} ?>>mg/L</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['Lookup_satuan'][] = 'mg/L'; ?>
 <option  value="ml" <?php  if ($this->satuan == "ml") { echo " selected" ;} ?>>ml</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['Lookup_satuan'][] = 'ml'; ?>
 <option  value="mm/jam" <?php  if ($this->satuan == "mm/jam") { echo " selected" ;} ?>>mm/jam</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['Lookup_satuan'][] = 'mm/jam'; ?>
 <option  value="mmol/24 jam" <?php  if ($this->satuan == "mmol/24 jam") { echo " selected" ;} ?>>mmol/24 jam</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['Lookup_satuan'][] = 'mmol/24 jam'; ?>
 <option  value="mmol/L" <?php  if ($this->satuan == "mmol/L") { echo " selected" ;} ?>>mmol/L</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['Lookup_satuan'][] = 'mmol/L'; ?>
 <option  value="NEGATIF" <?php  if ($this->satuan == "NEGATIF") { echo " selected" ;} ?>>NEGATIF</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['Lookup_satuan'][] = 'NEGATIF'; ?>
 <option  value="ng/dl" <?php  if ($this->satuan == "ng/dl") { echo " selected" ;} ?>>ng/dl</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['Lookup_satuan'][] = 'ng/dl'; ?>
 <option  value="ng/ml" <?php  if ($this->satuan == "ng/ml") { echo " selected" ;} ?>>ng/ml</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['Lookup_satuan'][] = 'ng/ml'; ?>
 <option  value="Pg" <?php  if ($this->satuan == "Pg") { echo " selected" ;} ?>>Pg</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['Lookup_satuan'][] = 'Pg'; ?>
 <option  value="RESUS" <?php  if ($this->satuan == "RESUS") { echo " selected" ;} ?>>RESUS</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['Lookup_satuan'][] = 'RESUS'; ?>
 <option  value="ribu / mm3" <?php  if ($this->satuan == "ribu / mm3") { echo " selected" ;} ?>>ribu / mm3</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['Lookup_satuan'][] = 'ribu / mm3'; ?>
 <option  value="ribu/dL" <?php  if ($this->satuan == "ribu/dL") { echo " selected" ;} ?>>ribu/dL</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['Lookup_satuan'][] = 'ribu/dL'; ?>
 <option  value="U/I" <?php  if ($this->satuan == "U/I") { echo " selected" ;} ?>>U/I</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['Lookup_satuan'][] = 'U/I'; ?>
 <option  value="ug/dL" <?php  if ($this->satuan == "ug/dL") { echo " selected" ;} ?>>ug/dL</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['Lookup_satuan'][] = 'ug/dL'; ?>
 <option  value="UI/ML" <?php  if ($this->satuan == "UI/ML") { echo " selected" ;} ?>>UI/ML</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['Lookup_satuan'][] = 'UI/ML'; ?>
 <option  value="ulU/mL" <?php  if ($this->satuan == "ulU/mL") { echo " selected" ;} ?>>ulU/mL</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['Lookup_satuan'][] = 'ulU/mL'; ?>
 </select></span>
</span><?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_p1_label" id="hidden_field_label_p1" style="<?php echo $sStyleHidden_p1; ?>"><span id="id_label_p1"><?php echo $this->nm_new_label['p1']; ?></span></TD>
    <TD class="scFormDataOdd css_p1_line" id="hidden_field_data_p1" style="<?php echo $sStyleHidden_p1; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_p1_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_p2_label" id="hidden_field_label_p2" style="<?php echo $sStyleHidden_p2; ?>"><span id="id_label_p2"><?php echo $this->nm_new_label['p2']; ?></span></TD>
    <TD class="scFormDataOdd css_p2_line" id="hidden_field_data_p2" style="<?php echo $sStyleHidden_p2; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_p2_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_w1_label" id="hidden_field_label_w1" style="<?php echo $sStyleHidden_w1; ?>"><span id="id_label_w1"><?php echo $this->nm_new_label['w1']; ?></span></TD>
    <TD class="scFormDataOdd css_w1_line" id="hidden_field_data_w1" style="<?php echo $sStyleHidden_w1; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_w1_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_w2_label" id="hidden_field_label_w2" style="<?php echo $sStyleHidden_w2; ?>"><span id="id_label_w2"><?php echo $this->nm_new_label['w2']; ?></span></TD>
    <TD class="scFormDataOdd css_w2_line" id="hidden_field_data_w2" style="<?php echo $sStyleHidden_w2; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_w2_line" style="vertical-align: top;padding: 0px">
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_tarif'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_tarif'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['form_tblabrate_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_tarif'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['form_tblabrate_script_case_init'] = $this->Ini->sc_page;
 }
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['form_tblabrate_script_case_init'] ]['form_tblabrate']['embutida_proc']  = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['form_tblabrate_script_case_init'] ]['form_tblabrate']['embutida_form']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['form_tblabrate_script_case_init'] ]['form_tblabrate']['embutida_call']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['form_tblabrate_script_case_init'] ]['form_tblabrate']['embutida_multi'] = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['form_tblabrate_script_case_init'] ]['form_tblabrate']['embutida_liga_form_insert'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['form_tblabrate_script_case_init'] ]['form_tblabrate']['embutida_liga_form_update'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['form_tblabrate_script_case_init'] ]['form_tblabrate']['embutida_liga_form_delete'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['form_tblabrate_script_case_init'] ]['form_tblabrate']['embutida_liga_form_btn_nav'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['form_tblabrate_script_case_init'] ]['form_tblabrate']['embutida_liga_grid_edit'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['form_tblabrate_script_case_init'] ]['form_tblabrate']['embutida_liga_grid_edit_link'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['form_tblabrate_script_case_init'] ]['form_tblabrate']['embutida_liga_qtd_reg'] = '10';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['form_tblabrate_script_case_init'] ]['form_tblabrate']['embutida_liga_tp_pag'] = 'parcial';
 ...
 if ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['form_tblabrate_script_case_init'] ]['form_tblab']['total'] < 0)
 {
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_tblab_empty.htm' : $this->Ini->link_form_tblabrate_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_session=' . session_id() . '&script_case_detail=Y';
if (isset($this->Ini->sc_lig_target['C_@scinf_tarif']) && 'nmsc_iframe_liga_form_tblabrate' != $this->Ini->sc_lig_target['C_@scinf_tarif'])
{
    if ('novo' != $this->nmgp_opcao)
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_tarif'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['form_tblabrate_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
{
?>
<iframe border="0" id="nmsc_iframe_liga_form_tblabrate"  marginWidth="0" marginHeight="0" frameborder="0" valign="top" height="100" width="100%" name="nmsc_iframe_liga_form_tblabrate"  scrolling="auto" src="<?php echo $sDetailSrc; ?>"></iframe>
<?php
}
?>
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_detail'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_detail'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['form_tblabdetail_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_detail'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['form_tblabdetail_script_case_init'] = $this->Ini->sc_page;
 }
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['form_tblabdetail_script_case_init'] ]['form_tblabdetail']['embutida_proc']  = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['form_tblabdetail_script_case_init'] ]['form_tblabdetail']['embutida_form']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['form_tblabdetail_script_case_init'] ]['form_tblabdetail']['embutida_call']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['form_tblabdetail_script_case_init'] ]['form_tblabdetail']['embutida_multi'] = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['form_tblabdetail_script_case_init'] ]['form_tblabdetail']['embutida_liga_form_insert'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['form_tblabdetail_script_case_init'] ]['form_tblabdetail']['embutida_liga_form_update'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['form_tblabdetail_script_case_init'] ]['form_tblabdetail']['embutida_liga_form_delete'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['form_tblabdetail_script_case_init'] ]['form_tblabdetail']['embutida_liga_form_btn_nav'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['form_tblabdetail_script_case_init'] ]['form_tblabdetail']['embutida_liga_grid_edit'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['form_tblabdetail_script_case_init'] ]['form_tblabdetail']['embutida_liga_grid_edit_link'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['form_tblabdetail_script_case_init'] ]['form_tblabdetail']['embutida_liga_qtd_reg'] = '10';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['form_tblabdetail_script_case_init'] ]['form_tblabdetail']['embutida_liga_tp_pag'] = 'parcial';
 ...
 if ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['form_tblabdetail_script_case_init'] ]['form_tblab']['total'] < 0)
 {
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_tblab_empty.htm' : $this->Ini->link_form_tblabdetail_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_session=' . session_id() . '&script_case_detail=Y';
if (isset($this->Ini->sc_lig_target['C_@scinf_detail']) && 'nmsc_iframe_liga_form_tblabdetail' != $this->Ini->sc_lig_target['C_@scinf_detail'])
{
    if ('novo' != $this->nmgp_opcao)
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_detail'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['form_tblabdetail_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
{
?>
<iframe border="0" id="nmsc_iframe_liga_form_tblabdetail"  marginWidth="0" marginHeight="0" frameborder="0" valign="top" height="100" width="100%" name="nmsc_iframe_liga_form_tblabdetail"  scrolling="auto" src="<?php echo $sDetailSrc; ?>"></iframe>
<?php
}
?>
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_sc_field_0'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_sc_field_0'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['form_tblabrujukananak_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_sc_field_0'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['form_tblabrujukananak_script_case_init'] = $this->Ini->sc_page;
 }
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['form_tblabrujukananak_script_case_init'] ]['form_tblabrujukananak']['embutida_proc']  = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['form_tblabrujukananak_script_case_init'] ]['form_tblabrujukananak']['embutida_form']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['form_tblabrujukananak_script_case_init'] ]['form_tblabrujukananak']['embutida_call']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['form_tblabrujukananak_script_case_init'] ]['form_tblabrujukananak']['embutida_multi'] = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['form_tblabrujukananak_script_case_init'] ]['form_tblabrujukananak']['embutida_liga_form_insert'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['form_tblabrujukananak_script_case_init'] ]['form_tblabrujukananak']['embutida_liga_form_update'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['form_tblabrujukananak_script_case_init'] ]['form_tblabrujukananak']['embutida_liga_form_delete'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['form_tblabrujukananak_script_case_init'] ]['form_tblabrujukananak']['embutida_liga_form_btn_nav'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['form_tblabrujukananak_script_case_init'] ]['form_tblabrujukananak']['embutida_liga_grid_edit'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['form_tblabrujukananak_script_case_init'] ]['form_tblabrujukananak']['embutida_liga_grid_edit_link'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['form_tblabrujukananak_script_case_init'] ]['form_tblabrujukananak']['embutida_liga_qtd_reg'] = '10';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['form_tblabrujukananak_script_case_init'] ]['form_tblabrujukananak']['embutida_liga_tp_pag'] = 'parcial';
 ...
 if ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['form_tblabrujukananak_script_case_init'] ]['form_tblab']['total'] < 0)
 {
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_tblab_empty.htm' : $this->Ini->link_form_tblabrujukananak_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_session=' . session_id() . '&script_case_detail=Y&sc_ifr_height=500';
if (isset($this->Ini->sc_lig_target['C_@scinf_sc_field_0']) && 'nmsc_iframe_liga_form_tblabrujukananak' != $this->Ini->sc_lig_target['C_@scinf_sc_field_0'])
{
    if ('novo' != $this->nmgp_opcao)
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_sc_field_0'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['form_tblabrujukananak_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
{
?>
<iframe border="0" id="nmsc_iframe_liga_form_tblabrujukananak"  marginWidth="0" marginHeight="0" frameborder="0" valign="top" height="500" width="100%" name="nmsc_iframe_liga_form_tblabrujukananak"  scrolling="auto" src="<?php echo $sDetailSrc; ?>"></iframe>
<?php
}
?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<?php
  ...
  $nm_sc_blocos_aba    = array(1 => 1,2 => 1,3 => 1,4 => 1);
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_tblab");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_tblab");
 parent.scAjaxDetailHeight("form_tblab", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_tblab']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
