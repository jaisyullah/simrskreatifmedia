...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_tgltindakan__hora' + iSeqRow).bind('blur', function() { sc_form_tbtindakanendoscopy_tgltindakan__onblur(this, iSeqRow) })
                                               .bind('focus', function() { sc_form_tbtindakanendoscopy_tgltindakan__onfocus(this, iSeqRow) });
...
function scHidePage(pageNo) {
	$("#id_form_tbtindakanendoscopy_inline_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_tgltindakan_" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_tbtindakanendoscopy_inline_validate_tgltindakan_(iSeqRow);
    },
    numberOfMonths: 1,
    changeMonth: true,
    changeYear: true,
