  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbtindakanendoscopy_inline" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbtindakanendoscopy_inline_form();
	}

  // ---------- Validate tgltindakan_
  function do_ajax_form_tbtindakanendoscopy_inline_validate_tgltindakan_()
  {
    var nomeCampo_tgltindakan_ = "tgltindakan_";
    var var_tgltindakan_ = scAjaxGetFieldText(nomeCampo_tgltindakan_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtindakanendoscopy_inline_validate_tgltindakan_(var_tgltindakan_, var_script_case_init, do_ajax_form_tbtindakanendoscopy_inline_validate_tgltindakan__cb);
  } // do_ajax_form_tbtindakanendoscopy_inline_validate_tgltindakan_

  function do_ajax_form_tbtindakanendoscopy_inline_validate_tgltindakan__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtindakanendoscopy_inline_validate_tgltindakan__cb

  // ---------- Validate pelaksana_
  function do_ajax_form_tbtindakanendoscopy_inline_validate_pelaksana_()
  {
    var nomeCampo_pelaksana_ = "pelaksana_";
    var var_pelaksana_ = scAjaxGetFieldSelect(nomeCampo_pelaksana_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtindakanendoscopy_inline_validate_pelaksana_(var_pelaksana_, var_script_case_init, do_ajax_form_tbtindakanendoscopy_inline_validate_pelaksana__cb);
  } // do_ajax_form_tbtindakanendoscopy_inline_validate_pelaksana_

  function do_ajax_form_tbtindakanendoscopy_inline_validate_pelaksana__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtindakanendoscopy_inline_validate_pelaksana__cb

  // ---------- Validate tindakan_
  function do_ajax_form_tbtindakanendoscopy_inline_validate_tindakan_()
  {
    var nomeCampo_tindakan_ = "tindakan_";
    var var_tindakan_ = scAjaxGetFieldSelect(nomeCampo_tindakan_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtindakanendoscopy_inline_validate_tindakan_(var_tindakan_, var_script_case_init, do_ajax_form_tbtindakanendoscopy_inline_validate_tindakan__cb);
  } // do_ajax_form_tbtindakanendoscopy_inline_validate_tindakan_

  function do_ajax_form_tbtindakanendoscopy_inline_validate_tindakan__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtindakanendoscopy_inline_validate_tindakan__cb

  // ---------- Validate biaya_
  function do_ajax_form_tbtindakanendoscopy_inline_validate_biaya_()
  {
    var nomeCampo_biaya_ = "biaya_";
    var var_biaya_ = scAjaxGetFieldText(nomeCampo_biaya_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtindakanendoscopy_inline_validate_biaya_(var_biaya_, var_script_case_init, do_ajax_form_tbtindakanendoscopy_inline_validate_biaya__cb);
  } // do_ajax_form_tbtindakanendoscopy_inline_validate_biaya_

  function do_ajax_form_tbtindakanendoscopy_inline_validate_biaya__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "biaya_";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtindakanendoscopy_inline_validate_biaya__cb

  // ---------- Validate diskon_
  function do_ajax_form_tbtindakanendoscopy_inline_validate_diskon_()
  {
    var nomeCampo_diskon_ = "diskon_";
    var var_diskon_ = scAjaxGetFieldText(nomeCampo_diskon_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtindakanendoscopy_inline_validate_diskon_(var_diskon_, var_script_case_init, do_ajax_form_tbtindakanendoscopy_inline_validate_diskon__cb);
  } // do_ajax_form_tbtindakanendoscopy_inline_validate_diskon_

  function do_ajax_form_tbtindakanendoscopy_inline_validate_diskon__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "diskon_";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtindakanendoscopy_inline_validate_diskon__cb

  // ---------- Validate kelas_
  function do_ajax_form_tbtindakanendoscopy_inline_validate_kelas_()
  {
    var nomeCampo_kelas_ = "kelas_";
    var var_kelas_ = scAjaxGetFieldSelect(nomeCampo_kelas_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtindakanendoscopy_inline_validate_kelas_(var_kelas_, var_script_case_init, do_ajax_form_tbtindakanendoscopy_inline_validate_kelas__cb);
  } // do_ajax_form_tbtindakanendoscopy_inline_validate_kelas_

  function do_ajax_form_tbtindakanendoscopy_inline_validate_kelas__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "kelas_";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtindakanendoscopy_inline_validate_kelas__cb

  // ---------- Validate pembayaran_
  function do_ajax_form_tbtindakanendoscopy_inline_validate_pembayaran_()
  {
    var nomeCampo_pembayaran_ = "pembayaran_";
    var var_pembayaran_ = scAjaxGetFieldSelect(nomeCampo_pembayaran_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtindakanendoscopy_inline_validate_pembayaran_(var_pembayaran_, var_script_case_init, do_ajax_form_tbtindakanendoscopy_inline_validate_pembayaran__cb);
  } // do_ajax_form_tbtindakanendoscopy_inline_validate_pembayaran_

  function do_ajax_form_tbtindakanendoscopy_inline_validate_pembayaran__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtindakanendoscopy_inline_validate_pembayaran__cb

  // ---------- Validate jumlah_
  function do_ajax_form_tbtindakanendoscopy_inline_validate_jumlah_()
  {
    var nomeCampo_jumlah_ = "jumlah_";
    var var_jumlah_ = scAjaxGetFieldText(nomeCampo_jumlah_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtindakanendoscopy_inline_validate_jumlah_(var_jumlah_, var_script_case_init, do_ajax_form_tbtindakanendoscopy_inline_validate_jumlah__cb);
  } // do_ajax_form_tbtindakanendoscopy_inline_validate_jumlah_

  function do_ajax_form_tbtindakanendoscopy_inline_validate_jumlah__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "jumlah_";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtindakanendoscopy_inline_validate_jumlah__cb

  // ---------- Validate id_
  function do_ajax_form_tbtindakanendoscopy_inline_validate_id_()
  {
    var nomeCampo_id_ = "id_";
    var var_id_ = scAjaxGetFieldHidden(nomeCampo_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtindakanendoscopy_inline_validate_id_(var_id_, var_script_case_init, do_ajax_form_tbtindakanendoscopy_inline_validate_id__cb);
  } // do_ajax_form_tbtindakanendoscopy_inline_validate_id_

  function do_ajax_form_tbtindakanendoscopy_inline_validate_id__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id_";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtindakanendoscopy_inline_validate_id__cb

  // ---------- Refresh pelaksana_
  function do_ajax_form_tbtindakanendoscopy_inline_refresh_pelaksana_()
  {
    var var_pelaksana_ = scAjaxGetFieldSelect("pelaksana_");
    var var_nmgp_refresh_fields = "tindakan_";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tbtindakanendoscopy_inline_refresh_pelaksana_(var_pelaksana_, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_tbtindakanendoscopy_inline_refresh_pelaksana__cb);
  } // do_ajax_form_tbtindakanendoscopy_inline_refresh_pelaksana_

  function do_ajax_form_tbtindakanendoscopy_inline_refresh_pelaksana__cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtindakanendoscopy_inline_refresh_pelaksana__cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tbtindakanendoscopy_inline_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tbtindakanendoscopy_inline_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_tgltindakan_ = scAjaxGetFieldText("tgltindakan_");
    var var_pelaksana_ = scAjaxGetFieldSelect("pelaksana_");
    var var_tindakan_ = scAjaxGetFieldSelect("tindakan_");
    var var_biaya_ = scAjaxGetFieldText("biaya_");
    var var_diskon_ = scAjaxGetFieldText("diskon_");
    var var_kelas_ = scAjaxGetFieldSelect("kelas_");
    var var_pembayaran_ = scAjaxGetFieldSelect("pembayaran_");
    ...
    scAjaxProcOn();
    x_ajax_form_tbtindakanendoscopy_inline_submit_form(var_tgltindakan_, var_pelaksana_, var_tindakan_, var_biaya_, var_diskon_, var_kelas_, var_pembayaran_, var_jumlah_, var_id_, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbtindakanendoscopy_inline_submit_form_cb);
  } // do_ajax_form_tbtindakanendoscopy_inline_submit_form

  function do_ajax_form_tbtindakanendoscopy_inline_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("tgltindakan_");
      scAjaxHideErrorDisplay("pelaksana_");
      scAjaxHideErrorDisplay("tindakan_");
      scAjaxHideErrorDisplay("biaya_");
      scAjaxHideErrorDisplay("diskon_");
      scAjaxHideErrorDisplay("kelas_");
      scAjaxHideErrorDisplay("pembayaran_");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tbtindakanendoscopy_inline_submit_form_cb_after_alert);
  } // do_ajax_form_tbtindakanendoscopy_inline_submit_form_cb
  function do_ajax_form_tbtindakanendoscopy_inline_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbtindakanendoscopy_inline_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tbtindakanendoscopy_inline_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tbtindakanendoscopy_inline_navigate_form(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbtindakanendoscopy_inline_navigate_form_cb);
  } // do_ajax_form_tbtindakanendoscopy_inline_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtindakanendoscopy_inline']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbtindakanendoscopy_inline_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbtindakanendoscopy_inline_navigate_form_cb_after_alert);
  } // do_ajax_form_tbtindakanendoscopy_inline_navigate_form_cb
  function do_ajax_form_tbtindakanendoscopy_inline_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_tbtindakanendoscopy_inline_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_tbtindakanendoscopy_inline_navigate_form_cb_after_alert
  function sc_hide_form_tbtindakanendoscopy_inline_form()
  {
  ...
  ajax_field_list[0] = "tgltindakan_";
  ajax_field_list[1] = "pelaksana_";
  ajax_field_list[2] = "tindakan_";
  ajax_field_list[3] = "biaya_";
  ajax_field_list[4] = "diskon_";
  ajax_field_list[5] = "kelas_";
  ajax_field_list[6] = "pembayaran_";
  ajax_field_list[7] = "jumlah_";
  ajax_field_list[8] = "id_";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "tgltindakan_": {"label": "Tgl Tindakan", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "pelaksana_": {"label": "Pelaksana", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "tindakan_": {"label": "Tindakan", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "kelas_": {"label": "kelas", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "pembayaran_": {"label": "pembayaran", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  ajax_field_mult["tgltindakan_"][1] = "tgltindakan_";
  ajax_field_mult["pelaksana_"][1] = "pelaksana_";
  ajax_field_mult["tindakan_"][1] = "tindakan_";
  ajax_field_mult["biaya_"][1] = "biaya_";
  ajax_field_mult["diskon_"][1] = "diskon_";
  ajax_field_mult["kelas_"][1] = "kelas_";
  ajax_field_mult["pembayaran_"][1] = "pembayaran_";
  ajax_field_mult["jumlah_"][1] = "jumlah_";
  ajax_field_mult["id_"][1] = "id_";

  var ajax_field_id = {
    "tgltindakan_": new Array("hidden_field_label_tgltindakan_", "hidden_field_data_tgltindakan_"),
    "pelaksana_": new Array("hidden_field_label_pelaksana_", "hidden_field_data_pelaksana_"),
    "tindakan_": new Array("hidden_field_label_tindakan_", "hidden_field_data_tindakan_"),
