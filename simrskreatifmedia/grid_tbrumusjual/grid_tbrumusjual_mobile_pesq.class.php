...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_jenisbarang_cond" name="jenisbarang_cond" onChange="nm_campos_between(document.getElementById('id_vis_jenisbarang'), this, 'jenisbarang')">
      ...
      <br><span id="id_hide_jenisbarang"  <?php echo $str_hide_jenisbarang?>><?php
      if ($jenisbarang != "")
      {
      $jenisbarang_look = substr($this->Db->qstr($jenisbarang), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_rumusjual_cond" name="rumusjual_cond" onChange="nm_campos_between(document.getElementById('id_vis_rumusjual'), this, 'rumusjual')">
      ...
      <br><span id="id_hide_rumusjual"  <?php echo $str_hide_rumusjual?>><?php
      if ($rumusjual != "")
      {
      $rumusjual_look = substr($this->Db->qstr($rumusjual), 1, -1); 
      $nmgp_def_dados = array(); 
