...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_nama_transaksi_cond" name="nama_transaksi_cond" onChange="nm_campos_between(document.getElementById('id_vis_nama_transaksi'), this, 'nama_transaksi')">
      ...
      <br><span id="id_hide_nama_transaksi"  <?php echo $str_hide_nama_transaksi?>><?php
      if ($nama_transaksi != "")
      {
      $nama_transaksi_look = substr($this->Db->qstr($nama_transaksi), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_flag_cond" name="flag_cond" onChange="nm_campos_between(document.getElementById('id_vis_flag'), this, 'flag')">
