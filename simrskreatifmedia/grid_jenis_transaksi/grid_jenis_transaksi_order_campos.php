...
<?php
   ...
   $Ord_Cmp = new grid_jenis_transaksi_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_jenis_transaksi_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_jenis_transaksi']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_jenis_transaksi']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_jenis_transaksi']['labels']["id"])) ? $_SESSION['sc_session'][$sc_init]['grid_jenis_transaksi']['labels']["id"] : "ID";
   $tab_ger_campos['nama_transaksi'] = "on";
   $tab_def_campos['nama_transaksi'] = "nama_transaksi";
   $tab_labels["nama_transaksi"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_jenis_transaksi']['labels']["nama_transaksi"])) ? $_SESSION['sc_session'][$sc_init]['grid_jenis_transaksi']['labels']["nama_transaksi"] : "Nama Transaksi";
   $tab_ger_campos['flag'] = "on";
   $tab_def_campos['flag'] = "flag";
   $tab_labels["flag"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_jenis_transaksi']['labels']["flag"])) ? $_SESSION['sc_session'][$sc_init]['grid_jenis_transaksi']['labels']["flag"] : "Flag";
   $tab_ger_campos['keterangan'] = "on";
   $tab_def_campos['keterangan'] = "keterangan";
   $tab_labels["keterangan"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_jenis_transaksi']['labels']["keterangan"])) ? $_SESSION['sc_session'][$sc_init]['grid_jenis_transaksi']['labels']["keterangan"] : "Keterangan";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_jenis_transaksi']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_jenis_transaksi']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_jenis_transaksi']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_jenis_transaksi']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_jenis_transaksi']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_jenis_transaksi']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_jenis_transaksi']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_jenis_transaksi']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_jenis_transaksi']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_jenis_transaksi_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_jenis_transaksi']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_jenis_transaksi']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_jenis_transaksi']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_jenis_transaksi']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_jenis_transaksi']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
