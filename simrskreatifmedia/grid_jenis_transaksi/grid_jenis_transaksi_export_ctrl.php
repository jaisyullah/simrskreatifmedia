<?php
@session_start() ;
$_SESSION['scriptcase']['grid_jenis_transaksi']['sc_process_barr'] = true;
require_once('../grid_jenis_transaksi/index.php');
unset($_SESSION['scriptcase']['grid_jenis_transaksi']['sc_process_barr']);
$ExportCtrl = new grid_jenis_transaksi_export_control;
$ExportCtrl->Export_barr();

class grid_jenis_transaksi_export_control
{
