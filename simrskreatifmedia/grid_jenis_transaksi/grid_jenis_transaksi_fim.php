...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_jenis_transaksi"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_jenis_transaksi"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_jenis_transaksi'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_jenis_transaksi']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_jenis_transaksi']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_jenis_transaksi']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_jenis_transaksi']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_jenis_transaksi']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_jenis_transaksi</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_jenis_transaksi']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_jenis_transaksi']['embutida_filho'] as $ind => $sc_init)
          {
