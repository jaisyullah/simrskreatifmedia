...
<?php
   ...
   $Ord_Cmp = new grid_hrm_remunerasi_pembayaran_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_hrm_remunerasi_pembayaran_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_hrm_remunerasi_pembayaran']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_hrm_remunerasi_pembayaran']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels     = array();
   $tab_ger_campos['id_karyawan'] = "on";
   $tab_def_campos['id_karyawan'] = "id_karyawan";
   $tab_labels["id_karyawan"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_hrm_remunerasi_pembayaran']['labels']["id_karyawan"])) ? $_SESSION['sc_session'][$sc_init]['grid_hrm_remunerasi_pembayaran']['labels']["id_karyawan"] : "Karyawan";
   $tab_ger_campos['gaji_pokok'] = "on";
   $tab_def_campos['gaji_pokok'] = "gaji_pokok";
   $tab_labels["gaji_pokok"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_hrm_remunerasi_pembayaran']['labels']["gaji_pokok"])) ? $_SESSION['sc_session'][$sc_init]['grid_hrm_remunerasi_pembayaran']['labels']["gaji_pokok"] : "Gaji Pokok";
   $tab_ger_campos['tunj_struktural'] = "on";
   $tab_def_campos['tunj_struktural'] = "tunj_struktural";
   $tab_labels["tunj_struktural"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_hrm_remunerasi_pembayaran']['labels']["tunj_struktural"])) ? $_SESSION['sc_session'][$sc_init]['grid_hrm_remunerasi_pembayaran']['labels']["tunj_struktural"] : "Tunj Struktural";
   $tab_ger_campos['tunj_fungsional'] = "on";
   $tab_def_campos['tunj_fungsional'] = "tunj_fungsional";
   $tab_labels["tunj_fungsional"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_hrm_remunerasi_pembayaran']['labels']["tunj_fungsional"])) ? $_SESSION['sc_session'][$sc_init]['grid_hrm_remunerasi_pembayaran']['labels']["tunj_fungsional"] : "Tunj Fungsional";
   $tab_ger_campos['tunj_keluarga'] = "on";
   $tab_def_campos['tunj_keluarga'] = "tunj_keluarga";
   $tab_labels["tunj_keluarga"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_hrm_remunerasi_pembayaran']['labels']["tunj_keluarga"])) ? $_SESSION['sc_session'][$sc_init]['grid_hrm_remunerasi_pembayaran']['labels']["tunj_keluarga"] : "Tunj Keluarga";
   $tab_ger_campos['tunj_transport_makan'] = "on";
   $tab_def_campos['tunj_transport_makan'] = "tunj_transport_makan";
   $tab_labels["tunj_transport_makan"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_hrm_remunerasi_pembayaran']['labels']["tunj_transport_makan"])) ? $_SESSION['sc_session'][$sc_init]['grid_hrm_remunerasi_pembayaran']['labels']["tunj_transport_makan"] : "Tunj Transport Makan";
   $tab_ger_campos['tunj_bpjs_kesehatan'] = "on";
   $tab_def_campos['tunj_bpjs_kesehatan'] = "tunj_bpjs_kesehatan";
   $tab_labels["tunj_bpjs_kesehatan"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_hrm_remunerasi_pembayaran']['labels']["tunj_bpjs_kesehatan"])) ? $_SESSION['sc_session'][$sc_init]['grid_hrm_remunerasi_pembayaran']['labels']["tunj_bpjs_kesehatan"] : "Tunj Bpjs Kesehatan";
   $tab_ger_campos['tunj_masa_kerja'] = "on";
   $tab_def_campos['tunj_masa_kerja'] = "tunj_masa_kerja";
   $tab_labels["tunj_masa_kerja"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_hrm_remunerasi_pembayaran']['labels']["tunj_masa_kerja"])) ? $_SESSION['sc_session'][$sc_init]['grid_hrm_remunerasi_pembayaran']['labels']["tunj_masa_kerja"] : "Tunj Masa Kerja";
   $tab_ger_campos['lembur'] = "on";
   $tab_def_campos['lembur'] = "lembur";
   $tab_labels["lembur"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_hrm_remunerasi_pembayaran']['labels']["lembur"])) ? $_SESSION['sc_session'][$sc_init]['grid_hrm_remunerasi_pembayaran']['labels']["lembur"] : "Lembur";
   $tab_ger_campos['insentif'] = "on";
   $tab_def_campos['insentif'] = "insentif";
   $tab_labels["insentif"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_hrm_remunerasi_pembayaran']['labels']["insentif"])) ? $_SESSION['sc_session'][$sc_init]['grid_hrm_remunerasi_pembayaran']['labels']["insentif"] : "Insentif";
   $tab_ger_campos['pph_21'] = "on";
   $tab_def_campos['pph_21'] = "pph_21";
   $tab_labels["pph_21"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_hrm_remunerasi_pembayaran']['labels']["pph_21"])) ? $_SESSION['sc_session'][$sc_init]['grid_hrm_remunerasi_pembayaran']['labels']["pph_21"] : "Pph 21";
   $tab_ger_campos['bpjs_tenaga_kerja'] = "on";
   $tab_def_campos['bpjs_tenaga_kerja'] = "bpjs_tenaga_kerja";
   $tab_labels["bpjs_tenaga_kerja"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_hrm_remunerasi_pembayaran']['labels']["bpjs_tenaga_kerja"])) ? $_SESSION['sc_session'][$sc_init]['grid_hrm_remunerasi_pembayaran']['labels']["bpjs_tenaga_kerja"] : "Bpjs Tenaga Kerja";
   $tab_ger_campos['kasbon'] = "on";
   $tab_def_campos['kasbon'] = "kasbon";
   $tab_labels["kasbon"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_hrm_remunerasi_pembayaran']['labels']["kasbon"])) ? $_SESSION['sc_session'][$sc_init]['grid_hrm_remunerasi_pembayaran']['labels']["kasbon"] : "Kasbon";
   $tab_ger_campos['terlambat'] = "on";
   $tab_def_campos['terlambat'] = "terlambat";
   $tab_labels["terlambat"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_hrm_remunerasi_pembayaran']['labels']["terlambat"])) ? $_SESSION['sc_session'][$sc_init]['grid_hrm_remunerasi_pembayaran']['labels']["terlambat"] : "Terlambat";
   $tab_ger_campos['alfa_izin'] = "on";
   $tab_def_campos['alfa_izin'] = "alfa_izin";
   $tab_labels["alfa_izin"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_hrm_remunerasi_pembayaran']['labels']["alfa_izin"])) ? $_SESSION['sc_session'][$sc_init]['grid_hrm_remunerasi_pembayaran']['labels']["alfa_izin"] : "Alfa Izin";
   $tab_ger_campos['parkir'] = "on";
   $tab_def_campos['parkir'] = "parkir";
   $tab_labels["parkir"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_hrm_remunerasi_pembayaran']['labels']["parkir"])) ? $_SESSION['sc_session'][$sc_init]['grid_hrm_remunerasi_pembayaran']['labels']["parkir"] : "Parkir";
   $tab_ger_campos['periode_remunerasi'] = "on";
   $tab_def_campos['periode_remunerasi'] = "periode_remunerasi";
   $tab_labels["periode_remunerasi"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_hrm_remunerasi_pembayaran']['labels']["periode_remunerasi"])) ? $_SESSION['sc_session'][$sc_init]['grid_hrm_remunerasi_pembayaran']['labels']["periode_remunerasi"] : "Periode Remunerasi";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_hrm_remunerasi_pembayaran']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_hrm_remunerasi_pembayaran']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_hrm_remunerasi_pembayaran']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_hrm_remunerasi_pembayaran']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_hrm_remunerasi_pembayaran']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_hrm_remunerasi_pembayaran']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_hrm_remunerasi_pembayaran']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_hrm_remunerasi_pembayaran']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_hrm_remunerasi_pembayaran']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_hrm_remunerasi_pembayaran_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_hrm_remunerasi_pembayaran']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_hrm_remunerasi_pembayaran']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_hrm_remunerasi_pembayaran']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_hrm_remunerasi_pembayaran']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_hrm_remunerasi_pembayaran']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
