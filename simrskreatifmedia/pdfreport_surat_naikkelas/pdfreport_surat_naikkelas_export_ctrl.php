<?php
@session_start() ;
$_SESSION['scriptcase']['pdfreport_surat_naikkelas']['sc_process_barr'] = true;
require_once('../pdfreport_surat_naikkelas/index.php');
unset($_SESSION['scriptcase']['pdfreport_surat_naikkelas']['sc_process_barr']);
$ExportCtrl = new pdfreport_surat_naikkelas_export_control;
$ExportCtrl->Export_barr();

class pdfreport_surat_naikkelas_export_control
{
