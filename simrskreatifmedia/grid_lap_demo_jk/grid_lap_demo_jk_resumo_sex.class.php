...
class grid_lap_demo_jk_resumo
{
   ...
   function initializeButtons()
   {
      ...
      $this->nmgp_botoes['chart_exit'] = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['dashboard_info']['under_dashboard'] ? "off" : "on";
   ...
   { 
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['grid_lap_demo_jk']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['grid_lap_demo_jk']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['res_hrz'];
      $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
      $dir_raiz          = substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['where_resumo'] = "";
      }
      $this->inicializa_vars();
      $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['SC_Ind_Groupby'];
      $this->Total->$Gb_geral();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['contr_total_geral'] == "OK")
      {
          $this->array_total_sex = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['arr_total']['sex'];
      }
      else
      {
          $this->array_total_sex = array();
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['tot_geral'][1];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['tot_geral'][1] == 0)
      {
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['arr_total']['sex'] = $this->array_total_sex;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['json_use_label'])
       {
          $Lab_sex = "sex";
       }
       else
       {
          $Lab_sex = "Jenis Kelamin";
       }
       $this->comp_field = array(
           $Lab_sex,
       );

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['labels']['custcode']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['labels']['custcode'] = "No RM"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['labels']['name']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['labels']['name'] = "Nama"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['labels']['salut']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['labels']['salut'] = "Panggilan"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['labels']['sex']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['labels']['sex'] = "Jenis Kelamin"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['labels']['registerdate']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['labels']['registerdate'] = "Tgl. Daftar"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['labels']['id']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['labels']['id'] = "Id"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['labels']['address']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['labels']['address'] = "Address"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['labels']['city']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['labels']['city'] = "City"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['labels']['postcode']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['labels']['postcode'] = "Post Code"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['labels']['birthdate']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['labels']['birthdate'] = "Birth Date"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['labels']['phone']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['labels']['phone'] = "Phone"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['labels']['hp']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['labels']['hp'] = "Hp"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['labels']['spouse']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['labels']['spouse'] = "Spouse"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['labels']['type']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['labels']['type'] = "Type"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['labels']['typename']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['labels']['typename'] = "Type Name"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['labels']['hta']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['labels']['hta'] = "Hta"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['labels']['lasthta']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['labels']['lasthta'] = "Last Hta"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['labels']['bbtb']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['labels']['bbtb'] = "Bbtb"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['labels']['partus']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['labels']['partus'] = "Partus"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['labels']['deleted']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['labels']['deleted'] = "Deleted"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['labels']['hamil']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['labels']['hamil'] = "Hamil"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['labels']['email']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['labels']['email'] = "Email"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['labels']['blood']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['labels']['blood'] = "Blood"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['labels']['location']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['labels']['location'] = "Location"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['labels']['mother']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['labels']['mother'] = "Mother"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['labels']['father']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['labels']['father'] = "Father"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['labels']['job']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['labels']['job'] = "Job"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['labels']['education']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['labels']['education'] = "Education"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['labels']['religion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['labels']['religion'] = "Religion"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['labels']['birthplace']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['labels']['birthplace'] = "Birthplace"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['labels']['kelurahan']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['labels']['kelurahan'] = "Kelurahan"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['labels']['kecamatan']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['labels']['kecamatan'] = "Kecamatan"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['labels']['rt']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['labels']['rt'] = "Rt"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['labels']['rw']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['labels']['rw'] = "Rw"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['labels']['member']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['labels']['member'] = "Member"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['labels']['idno']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['labels']['idno'] = "Id No"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['labels']['jenis']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['labels']['jenis'] = "Jenis"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['labels']['expdate']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['labels']['expdate'] = "Exp Date"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['labels']['photoname']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['labels']['photoname'] = "Photo Name"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['labels']['isdead']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['labels']['isdead'] = "Is Dead"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['labels']['tlc']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['labels']['tlc'] = "Tlc"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['labels']['bu']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['labels']['bu'] = "Bu"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['labels']['lastupdated']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['labels']['lastupdated'] = "Last Updated"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['labels']['nip']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['labels']['nip'] = "Nip"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['labels']['instno']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['labels']['instno'] = "Inst No"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['labels']['kelompokcode']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['labels']['kelompokcode'] = "Kelompok Code"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['labels']['kelompok']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['labels']['kelompok'] = "Kelompok"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['labels']['penanggung']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['labels']['penanggung'] = "Penanggung"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['labels']['cardno']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['labels']['cardno'] = "Card No"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['labels']['statusbl']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['labels']['statusbl'] = "Status BL"; 
       }
       //-----
       $this->comp_field_nm = array(
           'sex' => 0,
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['summarizing_fields_order']['sex']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['summarizing_fields_order']['sex'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['summarizing_fields_order']['sex'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['summarizing_fields_display']['sex'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['summarizing_fields_display']['sex'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['summarizing_fields_display']['sex'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['summarizing_fields_display']['sex'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['summarizing_fields_display']['sex'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['summarizing_fields_display']['sex'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['summarizing_fields_display']['sex'] as $i_sum => $d_sum)
           {
       ...
       //-----
       foreach ($this->array_total_sex as $i_sex => $d_sex) {
           if (!in_array($i_sex, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_sex[3] ] = $d_sex[2];
               $this->comp_label[0][ $d_sex[3] ] = $d_sex[2];
           }
       }
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['pivot_order_level'] = -1;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['pivot_tabular_label'];
       ...
       //-----
       foreach ($this->comp_label[0] as $i_sex => $l_sex) {
           if (isset($this->array_total_sex[$i_sex])) {
               $this->comp_group[$i_sex] = array();
           }
       }
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_lap_demo_jk@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function buildChart()
   {
       ...
       $this->comp_chart_config = array(
           '0|1' => array(
               ...
               'label_x'  => $this->getChartText(strip_tags($Lab_sex)),
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['pivot_charts']    = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['pivot_orig']      = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['comb_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['comb_table_def']  = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['anlt_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['anlt_table_def']  = array();
	...
	function filterChartsByGroupbyLevel() {
		...
		if (isset($nmgp_opcao) && ('pdf' == $nmgp_opcao || 'pdf_res' == $nmgp_opcao) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['chart_level']) && '' !== $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['chart_level']) {
			$applyFilter = true;
		}
		elseif (isset($nmgp_opcao) && 'image_res' == $nmgp_opcao && isset($_POST['chart_level']) && '' !== $_POST['chart_level']) {
			$applyFilter = true;
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['chart_level'] = $_POST['chart_level'];
		}
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['pivot_charts'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['pivot_orig'];

		if ($applyFilter) {
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['pivot_charts'] as $chartIndex => $chartData) {
				...
				if ($groupbyLevel > $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['chart_level']) {
					unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['pivot_charts'][$chartIndex]);
				}
			}
		}

		$this->comp_chart_data = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['pivot_charts'];
	}
           ...
           foreach ($a_totals as $i_total => $values)
           {
               ...
               if (isset($this->comp_chart_config[$key_config]))
               {
                   ...
                   foreach ($a_keys as $tmp_key)
                   {
                       ...
                       $xml_links[]  = $this->getFusionLink('sc_grid_lap_demo_jk_' . session_id() . '_!!!' . implode('_', array_merge(array($group + 1, $i_total), $link_index)) . '!!!.json');
                   }
                   ...
                   $this->comp_chart_data[$key_data]['xml']        = $this->getFusionLink('sc_grid_lap_demo_jk_' . session_id() . '_!!!' . implode('_', array_merge(array($group, $i_total), $param)) . '!!!.json');
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['embutida'])
                   {
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['proc_pdf_vert']){ 
   ...
   {
       if (!$res_chart && $this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['json_use_format']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['json_use_format'])
       {
           return $valor_campo;
       }
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function resumo_final()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['ajax_nav'])
      {
   ...
   function inicializa_vars()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         require_once($this->Ini->path_aplicacao . "grid_lap_demo_jk_total.class.php"); 
      }
      ...
      $this->Total   = new grid_lap_demo_jk_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      $this->Total->Calc_resumo_sex("res");
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['arr_total'][$cmp_gb];
      }
      ksort($this->array_total_sex);
      if ("out" == $this->NM_tipo)
      {
         $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['SC_Ind_Groupby'];
         $this->Total->$Gb_geral();
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['dashboard_refresh_after_chart'] = 'resumo';
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['doc_word'])
{
   ...
   { 
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_lap_demo_jk_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grid_lap_demo_jk_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_lap_demo_jk_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['num_css'] . '.css');
...
$nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_lap_demo_jk/grid_lap_demo_jk_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\">\r\n");
           ...
           $nm_saida->saida("     }\r\n");
           $nm_saida->saida("   </script>\r\n");
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['ajax_nav'] && !$this->Ini->sc_export_ajax && !$this->Ini->Export_html_zip && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['doc_word'])
      {
           $nm_saida->saida("   <script type=\"text/javascript\"> \r\n");
          ...
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['grid_pesq']))
          { 
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['doc_word']) 
      {
      ...
      {
          $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['dashboard_info']['remove_margin'] ? ' style="margin: 0"' : '';
          $nm_saida->saida(" <BODY class=\"" . $this->css_scGridPage . "\"" . $remove_margin . ">\r\n");
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['embutida'])
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top_normal()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['pdf'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "Rpdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_lap_demo_jk/grid_lap_demo_jk_config_pdf.php?nm_opc=pdf_res&nm_target=0&nm_cor=cor&papel=8&orientacao=1&bookmarks=1&largura=1200&conf_larg=S&conf_fonte=10&grafico=S&sc_ver_93=" . s . "&nm_tem_gb=s&nm_res_cons=s&nm_ini_pdf_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&summary_export_columns=S&nm_label_group=N&nm_all_cab=S&nm_all_label=S&pdf_zip=N&nm_orient_grid=2&origem=res&language=id&conf_socor=N&script_case_init=" . $this->Ini->sc_page . "&app_name=grid_lap_demo_jk&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['word'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "Rword_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_lap_demo_jk/grid_lap_demo_jk_config_word.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_cor=CO&nm_res_cons=s&nm_ini_word_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&origem=res&language=id&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['xls'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bexcel", "", "", "Rxls_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_lap_demo_jk/grid_lap_demo_jk_config_xls.php?script_case_init=" . $this->Ini->sc_page . "&app_name=grid_lap_demo_jk&nm_tp_xls=xlsx&nm_tot_xls=N&nm_tot_xls=N&nm_res_cons=s&nm_ini_xls_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&summary_export_columns=S&origem=res&language=&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['xml'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bxml", "", "", "Rxml_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_lap_demo_jk/grid_lap_demo_jk_config_xml.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=s&nm_ini_xml_res=grid,resume,chart&nm_all_modules=grid,resume,chart&nm_xml_tag=tag&nm_xml_label=S&language=&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['csv'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcsv", "", "", "Rcsv_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_lap_demo_jk/grid_lap_demo_jk_config_csv.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_res_cons=s&nm_ini_csv_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&nm_delim_line=1&nm_delim_col=1&nm_delim_dados=1&nm_label_csv=N&language=&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_lap_demo_jk/grid_lap_demo_jk_config_print.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_opc=resumo&nm_cor=CO&nm_res_cons=s&nm_ini_prt_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&origem=res&language=id&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      {
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bconf_graf", "", "", "Rgraf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_lap_demo_jk/grid_lap_demo_jk_config_graf_flash.php?nome_apl=grid_lap_demo_jk&campo_apl=nm_resumo_graf&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=id&tp_apl=ger_gra&KeepThis=true&TB_iframe=true&height=450&width=400&modal=true", "", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
      }
      if ($this->nmgp_botoes['chart_detail'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("grid_lap_demo_jk_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
   ...
   function monta_html_fim()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['print_all'])
      {
          $this->grafico_pdf();
      }
      $nm_saida->saida("</TABLE>\r\n");
      $nm_saida->saida("<link rel=\"stylesheet\" type=\"text/css\" href=\"../_lib/css/" . $this->Ini->str_schema_all . "_sweetalert.css\" />\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_lap_demo_jk']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_lap_demo_jk']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
$nm_saida->saida("       scJs_alert('" . $mensagem . "', $jsonParams);\r\n");
      ...
      elseif ($this->Ini->Export_html_zip || ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['opcao'] == "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['graf_pdf'] == "S"))
      {
          $this->grafico_pdf();
      }
      else
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'grid_lap_demo_jk_config_pivot.php?nome_apl=grid_lap_demo_jk&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=id&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_lap_demo_jk_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "grid_lap_demo_jk/grid_lap_demo_jk_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
...
//--- 
 function grafico_bot()
 {
   ...
   $bPDF = false;
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['pivot_charts']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['graf_bot'] = true;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['graf_first'] = true;
       require_once($this->Ini->path_aplicacao . $this->Ini->Apl_grafico); 
       $this->Graf  = new grid_lap_demo_jk_grafico();
       $this->Graf->Db     = $this->Db;
       $this->Graf->Erro   = $this->Erro;
      ...
      if (isset($_POST['nmgp_opcao']) && 'ajax_navigate' == $_POST['nmgp_opcao'] && isset($_POST['opc']) && ('grid_search_res' == $_POST['opc'] || 'resumo_search' == $_POST['opc'])) {
       ...
       $nm_saida->saida("<TR>\r\n");
       $iChartCount = 1;
       $iChartTotal = sizeof($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['pivot_charts']);
       $sChartLang  = isset($this->Ini->Nm_lang['lang_pdff_pcht']) ? $this->Ini->Nm_lang['lang_pdff_pcht'] : 'Generating chart';
       if (!NM_is_utf8($sChartLang))
       {
           $sChartLang = sc_convert_encoding($sChartLang, "UTF-8", $_SESSION['scriptcase']['charset']);
      ...
      if ($bPDF && (!isset($this->progress_fp) || !$this->progress_fp))
      {
       ...
       $nm_saida->saida("</TR>\r\n");
      if (isset($_POST['nmgp_opcao']) && 'ajax_navigate' == $_POST['nmgp_opcao'] && isset($_POST['opc']) && 'resumo' == $_POST['opc']) {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['new_charts'] = $_SESSION['scriptcase']['saida_html'];
      ...
      if (isset($_POST['nmgp_opcao']) && 'ajax_navigate' == $_POST['nmgp_opcao'] && isset($_POST['opc']) && ('grid_search_res' == $_POST['opc'] || 'resumo_search' == $_POST['opc'])) {
       ...
       $nm_saida->saida("</TABLE>\r\n");
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['graf_bot'] = false;
       if ($bPDF && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['charts_html']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['charts_html'])
       {
           $nm_saida->saida("<script type=\"text/javascript\">\r\n");
           $nm_saida->saida("{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['charts_html']}\r\n");
           $nm_saida->saida("</script>\r\n");
...
//--- 
   ...
   {
      global $nm_saida;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_demo_jk']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
      ...
      { 
        ...
        if ($_SESSION['scriptcase']['charset'] != "UTF-8")
        {
          ...
          $sex = $Busca_temp['sex']; 
          $tmp_pos = strpos($sex, "##@@");
          if ($tmp_pos !== false && !is_array($sex))
          {
              $sex = substr($sex, 0, $tmp_pos);
          }
   ...
   //---- 
   function adiciona_registro($quebra_sex, $quebra_sex_orig)
   {
      //----- Jenis Kelamin
      if (!isset($this->array_total_sex[$quebra_sex_orig]))
      {
         $this->array_total_sex[$quebra_sex_orig][0] = 1;
         $this->array_total_sex[$quebra_sex_orig][1] = 1;
         $this->array_total_sex[$quebra_sex_orig][2] = $quebra_sex;
         $this->array_total_sex[$quebra_sex_orig][3] = $quebra_sex_orig;
      }
      else
      {
         $this->array_total_sex[$quebra_sex_orig][0]++;
         $this->array_total_sex[$quebra_sex_orig][2]++;
      }
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('', 'sex');
     $campos_order = $this->Ini->Get_date_order_groupby("sex", 'asc', $format, $campos_order);
