<?php
@session_start() ;
$_SESSION['scriptcase']['grid_lap_demo_jk']['sc_process_barr'] = true;
require_once('../grid_lap_demo_jk/index.php');
unset($_SESSION['scriptcase']['grid_lap_demo_jk']['sc_process_barr']);
$ExportCtrl = new grid_lap_demo_jk_export_control;
$ExportCtrl->Export_barr();

class grid_lap_demo_jk_export_control
{
