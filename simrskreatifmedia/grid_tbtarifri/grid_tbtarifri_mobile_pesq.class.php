...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "id";$Nm_numeric[] = "jasasarana";$Nm_numeric[] = "jasapelayanan";$Nm_numeric[] = "jasamedik";$Nm_numeric[] = "tarif";$Nm_numeric[] = "id";$Nm_numeric[] = "jasasarana";$Nm_numeric[] = "jasapelayanan";$Nm_numeric[] = "jasamedik";$Nm_numeric[] = "tarif";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_jenisbayar_cond" name="jenisbayar_cond" onChange="nm_campos_between(document.getElementById('id_vis_jenisbayar'), this, 'jenisbayar')">
      ...
      <br><span id="id_hide_jenisbayar"  <?php echo $str_hide_jenisbayar?>><?php
      if ($jenisbayar != "")
      {
      $jenisbayar_look = substr($this->Db->qstr($jenisbayar), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_kodetindakan_cond" name="kodetindakan_cond" onChange="nm_campos_between(document.getElementById('id_vis_kodetindakan'), this, 'kodetindakan')">
      ...
      <br><span id="id_hide_kodetindakan"  <?php echo $str_hide_kodetindakan?>><?php
      if ($kodetindakan != "")
      {
      $kodetindakan_look = substr($this->Db->qstr($kodetindakan), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_kelas_cond" name="kelas_cond" onChange="nm_campos_between(document.getElementById('id_vis_kelas'), this, 'kelas')">
