...
class grid_tbtarifri_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifri']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_tbtarifri_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_tbtarifri_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_tbtarifri_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_jenisbayar')
      {
          $jenisbayar = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_jenisbayar($jenisbayar);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_kodetindakan')
      {
          $kodetindakan = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_kodetindakan($kodetindakan);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function lookup_ajax_jenisbayar($jenisbayar)
   {
      $jenisbayar = substr($this->Db->qstr($jenisbayar), 1, -1);
            $jenisbayar_look = substr($this->Db->qstr($jenisbayar), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct jenisBayar from " . $this->Ini->nm_tabela . " where  jenisBayar like '%" . $jenisbayar . "%' order by jenisBayar"; 
      unset($cmp1,$cmp2);
   ...
   function lookup_ajax_kodetindakan($kodetindakan)
   {
      $kodetindakan = substr($this->Db->qstr($kodetindakan), 1, -1);
            $kodetindakan_look = substr($this->Db->qstr($kodetindakan), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct kodeTindakan from " . $this->Ini->nm_tabela . " where  kodeTindakan like '%" . $kodetindakan . "%' order by kodeTindakan"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifri']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifri']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifri']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifri']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifri']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifri']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifri']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifri']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifri']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifri']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifri']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifri']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifri']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifri']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifri']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - tbtarifri</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_tbtarifri/grid_tbtarifri_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_tbtarifri_ajax_search.js"></script>
 <script type="text/javascript" src="grid_tbtarifri_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_tbtarifri_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_tbtarifri']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_tbtarifri']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_jenisbayar_cond#NMF#' + search_get_sel_txt('SC_jenisbayar_cond') + '@NMF@';
  str_out += 'SC_jenisbayar#NMF#' + search_get_text('SC_jenisbayar') + '@NMF@';
  str_out += 'id_ac_jenisbayar#NMF#' + search_get_text('id_ac_jenisbayar') + '@NMF@';
  ...
  str_out += 'SC_kodetindakan_cond#NMF#' + search_get_sel_txt('SC_kodetindakan_cond') + '@NMF@';
  str_out += 'SC_kodetindakan#NMF#' + search_get_text('SC_kodetindakan') + '@NMF@';
  str_out += 'id_ac_kodetindakan#NMF#' + search_get_text('id_ac_kodetindakan') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
   ...
   $("#id_ac_kodetindakan").autocomplete({
     minLength: 1,
     source: function (request, response) {
     $.ajax({
       url: "index.php",
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_kodetindakan",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_kodetindakan").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     focus: function (event, ui) {
   ...
   $("#id_ac_jenisbayar").autocomplete({
     ...
     $.ajax({
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_jenisbayar",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_jenisbayar").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     focus: function (event, ui) {
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifri']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div class="scFilterHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFilterHeaderFont" style="float: left; text-transform: uppercase;"><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - tbtarifri</div>
...
<?php
   ...
   {
      global 
             $jenisbayar_cond, $jenisbayar, $jenisbayar_autocomp,
             $id_cond, $id, $id_autocomp,
             $kodetindakan_cond, $kodetindakan, $kodetindakan_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifri']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifri']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifri']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifri']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $jenisbayar = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifri']['campos_busca']['jenisbayar']; 
          $jenisbayar_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifri']['campos_busca']['jenisbayar_cond']; 
          $id = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifri']['campos_busca']['id']; 
          $id_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifri']['campos_busca']['id_cond']; 
          $kodetindakan = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifri']['campos_busca']['kodetindakan']; 
          $kodetindakan_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifri']['campos_busca']['kodetindakan_cond']; 
          $kelas = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifri']['campos_busca']['kelas']; 
          $kelas_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifri']['campos_busca']['kelas_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifri']['campos_busca']['NM_operador']; 
      } 
      if (!isset($jenisbayar_cond) || empty($jenisbayar_cond))
      {
         $jenisbayar_cond = "qp";
      }
      ...
      if (!isset($kodetindakan_cond) || empty($kodetindakan_cond))
      {
         $kodetindakan_cond = "qp";
      }
      ...
      $str_hide_jenisbayar = (in_array($jenisbayar_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_id = (in_array($id_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_kodetindakan = (in_array($kodetindakan_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_kelas = (in_array($kelas_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      if (!isset($jenisbayar) || $jenisbayar == "")
      {
          $jenisbayar = "";
      }
      if (isset($jenisbayar) && !empty($jenisbayar))
      {
         $tmp_pos = strpos($jenisbayar, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $jenisbayar = substr($jenisbayar, 0, $tmp_pos);
         }
      }
      if (!isset($id) || $id == "")
      {
      ...
      if (!isset($kodetindakan) || $kodetindakan == "")
      {
          $kodetindakan = "";
      }
      if (isset($kodetindakan) && !empty($kodetindakan))
      {
         $tmp_pos = strpos($kodetindakan, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $kodetindakan = substr($kodetindakan, 0, $tmp_pos);
         }
      }
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_jenisbayar_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['jenisbayar'])) ? $this->New_label['jenisbayar'] : "Jenis Bayar"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_jenisbayar_cond" name="jenisbayar_cond" onChange="nm_campos_between(document.getElementById('id_vis_jenisbayar'), this, 'jenisbayar')">
       <OPTION value="qp" <?php if ("qp" == $jenisbayar_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $jenisbayar_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $jenisbayar_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $jenisbayar_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_jenisbayar" <?php echo $str_hide_jenisbayar?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['jenisbayar'])) ? $this->New_label['jenisbayar'] : "Jenis Bayar";
 $nmgp_tab_label .= "jenisbayar?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
...
<?php
      ...
      $jenisbayar_look = substr($this->Db->qstr($jenisbayar), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct jenisBayar from " . $this->Ini->nm_tabela . " where jenisBayar = '$jenisbayar_look' order by jenisBayar"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      if (isset($nmgp_def_dados[0][$jenisbayar]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$jenisbayar];
      }
      else
      {
          $sAutocompValue = $jenisbayar;
      }
?>
<INPUT  type="text" id="SC_jenisbayar" name="jenisbayar" value="<?php echo NM_encode_input($jenisbayar) ?>"  size=10 alt="{datatype: 'text', maxLength: 10, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_jenisbayar" name="jenisbayar_autocomp" size="10"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 10, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_id" name="id_autocomp" size="5"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 5, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
      ...
      <TD id='SC_kodetindakan_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['kodetindakan'])) ? $this->New_label['kodetindakan'] : "Kode Tindakan"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_kodetindakan_cond" name="kodetindakan_cond" onChange="nm_campos_between(document.getElementById('id_vis_kodetindakan'), this, 'kodetindakan')">
       <OPTION value="qp" <?php if ("qp" == $kodetindakan_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $kodetindakan_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $kodetindakan_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $kodetindakan_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_kodetindakan" <?php echo $str_hide_kodetindakan?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['kodetindakan'])) ? $this->New_label['kodetindakan'] : "Kode Tindakan";
 $nmgp_tab_label .= "kodetindakan?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      $kodetindakan_look = substr($this->Db->qstr($kodetindakan), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct kodeTindakan from " . $this->Ini->nm_tabela . " where kodeTindakan = '$kodetindakan_look' order by kodeTindakan"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      if (isset($nmgp_def_dados[0][$kodetindakan]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$kodetindakan];
      }
      else
      {
          $sAutocompValue = $kodetindakan;
      }
?>
<INPUT  type="text" id="SC_kodetindakan" name="kodetindakan" value="<?php echo NM_encode_input($kodetindakan) ?>"  size=15 alt="{datatype: 'text', maxLength: 15, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_kodetindakan" name="kodetindakan_autocomp" size="15"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 15, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
     ...
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_kelas_cond" name="kelas_cond" onChange="nm_campos_between(document.getElementById('id_vis_kelas'), this, 'kelas')">
...
?>
<INPUT  type="text" id="SC_kelas" name="kelas" value="<?php echo NM_encode_input($kelas) ?>"  size=50 alt="{datatype: 'text', maxLength: 255, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_kelas" name="kelas_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 255, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
?>
<?php
   if (is_file("grid_tbtarifri_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_tbtarifri']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_tbtarifri']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifri']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.jenisbayar_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_jenisbayar'), document.F1.jenisbayar_cond, 'jenisbayar');
   document.F1.jenisbayar.value = "";
   document.F1.jenisbayar_autocomp.value = "";
   ...
   document.F1.kodetindakan_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_kodetindakan'), document.F1.kodetindakan_cond, 'kodetindakan');
   document.F1.kodetindakan.value = "";
   document.F1.kodetindakan_autocomp.value = "";
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "simrskreatifmedia/grid_tbtarifri";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifri']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifri']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifri']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_jenisbayar_cond'] = 'cond';
      $tp_fields['SC_jenisbayar'] = 'text_aut';
      $tp_fields['id_ac_jenisbayar'] = 'text_aut';
      $tp_fields['SC_id_cond'] = 'cond';
      $tp_fields['SC_id'] = 'text_aut';
      $tp_fields['id_ac_id'] = 'text_aut';
      $tp_fields['SC_kodetindakan_cond'] = 'cond';
      $tp_fields['SC_kodetindakan'] = 'text_aut';
      $tp_fields['id_ac_kodetindakan'] = 'text_aut';
   ...
   {
      global $jenisbayar_cond, $jenisbayar, $jenisbayar_autocomp,
             $id_cond, $id, $id_autocomp,
             $kodetindakan_cond, $kodetindakan, $kodetindakan_autocomp,
      ...
      if (!empty($jenisbayar_autocomp) && empty($jenisbayar))
      {
          $jenisbayar = $jenisbayar_autocomp;
      }
      if (!empty($id_autocomp) && empty($id))
      {
          $id = $id_autocomp;
      }
      if (!empty($kodetindakan_autocomp) && empty($kodetindakan))
      {
          $kodetindakan = $kodetindakan_autocomp;
      }
      if (!empty($kelas_autocomp) && empty($kelas))
      {
          $kelas = $kelas_autocomp;
      }
      $jenisbayar_cond_salva = $jenisbayar_cond; 
      if (!isset($jenisbayar_input_2) || $jenisbayar_input_2 == "")
      {
          $jenisbayar_input_2 = $jenisbayar;
      }
      ...
      $kodetindakan_cond_salva = $kodetindakan_cond; 
      if (!isset($kodetindakan_input_2) || $kodetindakan_input_2 == "")
      {
          $kodetindakan_input_2 = $kodetindakan;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifri']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifri']['campos_busca']['jenisbayar'] = $jenisbayar; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifri']['campos_busca']['jenisbayar_cond'] = $jenisbayar_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifri']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifri']['campos_busca']['id'] = $id; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifri']['campos_busca']['id_cond'] = $id_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifri']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifri']['campos_busca']['kodetindakan'] = $kodetindakan; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifri']['campos_busca']['kodetindakan_cond'] = $kodetindakan_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifri']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifri']['campos_busca']['kelas'] = $kelas; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifri']['campos_busca']['kelas_cond'] = $kelas_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifri']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifri']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifri']['campos_busca'] = $Temp_Busca;
      }
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['jenisbayar'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['jenisbayar'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['jenisbayar'] = $jenisbayar;
      }
      $id_look = substr($this->Db->qstr($id), 1, -1); 
      $nmgp_def_dados = array(); 
   if (is_numeric($id))
   { 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['kodetindakan'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['kodetindakan'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['kodetindakan'] = $kodetindakan;
      }
      $kelas_look = substr($this->Db->qstr($kelas), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct kelas from " . $this->Ini->nm_tabela . " where kelas = '$kelas_look' order by kelas"; 
      ...
      if (isset($jenisbayar) || $jenisbayar_cond == "nu" || $jenisbayar_cond == "nn" || $jenisbayar_cond == "ep" || $jenisbayar_cond == "ne")
      {
         $this->monta_condicao("jenisBayar", $jenisbayar_cond, $jenisbayar, "", "jenisbayar");
      }
      ...
      //----- $kodetindakan
      $this->Date_part = false;
      if (isset($kodetindakan) || $kodetindakan_cond == "nu" || $kodetindakan_cond == "nn" || $kodetindakan_cond == "ep" || $kodetindakan_cond == "ne")
      {
         $this->monta_condicao("kodeTindakan", $kodetindakan_cond, $kodetindakan, "", "kodetindakan");
      }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifri']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifri']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifri']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifri']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifri']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifri']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifri']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifri']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtarifri']['cond_pesq'] .= $this->NM_operador;
