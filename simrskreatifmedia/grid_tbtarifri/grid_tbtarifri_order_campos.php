...
<?php
   ...
   $Ord_Cmp = new grid_tbtarifri_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_tbtarifri_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbtarifri']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tbtarifri']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbtarifri']['labels']["id"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbtarifri']['labels']["id"] : "Id";
   $tab_ger_campos['kodetindakan'] = "on";
   $tab_def_campos['kodetindakan'] = "kodeTindakan";
   $tab_labels["kodetindakan"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbtarifri']['labels']["kodetindakan"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbtarifri']['labels']["kodetindakan"] : "Kode Tindakan";
   $tab_ger_campos['kelas'] = "on";
   $tab_def_campos['kelas'] = "kelas";
   $tab_labels["kelas"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbtarifri']['labels']["kelas"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbtarifri']['labels']["kelas"] : "Kelas";
   $tab_ger_campos['jenisbayar'] = "on";
   $tab_def_campos['jenisbayar'] = "jenisBayar";
   $tab_labels["jenisbayar"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbtarifri']['labels']["jenisbayar"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbtarifri']['labels']["jenisbayar"] : "Jenis Bayar";
   $tab_ger_campos['jasasarana'] = "on";
   $tab_def_campos['jasasarana'] = "jasaSarana";
   $tab_labels["jasasarana"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbtarifri']['labels']["jasasarana"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbtarifri']['labels']["jasasarana"] : "Jasa Sarana";
   $tab_ger_campos['jasapelayanan'] = "on";
   $tab_def_campos['jasapelayanan'] = "jasaPelayanan";
   $tab_labels["jasapelayanan"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbtarifri']['labels']["jasapelayanan"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbtarifri']['labels']["jasapelayanan"] : "Jasa Pelayanan";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_tbtarifri']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_tbtarifri']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_tbtarifri']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbtarifri']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tbtarifri']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_tbtarifri']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_tbtarifri']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_tbtarifri']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_tbtarifri']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_tbtarifri_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_tbtarifri']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_tbtarifri']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_tbtarifri']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_tbtarifri']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_tbtarifri']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
