<?php
@session_start() ;
$_SESSION['scriptcase']['pendapatanKasir_detail']['sc_process_barr'] = true;
require_once('../pendapatanKasir_detail/index.php');
unset($_SESSION['scriptcase']['pendapatanKasir_detail']['sc_process_barr']);
$ExportCtrl = new pendapatanKasir_detail_export_control;
$ExportCtrl->Export_barr();

class pendapatanKasir_detail_export_control
{
