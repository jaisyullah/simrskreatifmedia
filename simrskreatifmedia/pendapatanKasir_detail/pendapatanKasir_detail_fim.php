...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____pendapatanKasir_detail"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____pendapatanKasir_detail"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['pendapatanKasir_detail']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['pendapatanKasir_detail']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['pendapatanKasir_detail']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['pendapatanKasir_detail']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['pendapatanKasir_detail']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>pendapatanKasir_detail</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['pendapatanKasir_detail']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['pendapatanKasir_detail']['embutida_filho'] as $ind => $sc_init)
          {
