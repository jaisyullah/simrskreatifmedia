...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      ...
      <br><span id="id_hide_total"  <?php echo $str_hide_total?>><INPUT  type="text" id="SC_total" name="total" value="<?php echo NM_encode_input($total) ?>" size=22 alt="{datatype: 'integer', maxLength: 22, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
