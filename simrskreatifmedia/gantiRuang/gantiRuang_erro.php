...
$old_error_handler = set_error_handler("gantiRuang_scriptcase_error_handler");

function gantiRuang_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['gantiRuang']['contr_erro']) && $_SESSION['scriptcase']['gantiRuang']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_gantiRuang->contr_gantiRuang->Apl_com_erro = true;
            if ($inicial_gantiRuang->contr_gantiRuang->NM_ajax_flag)
            {
                $inicial_gantiRuang->contr_gantiRuang->NM_ajax_info['errList']['geral_gantiRuang'][] = $msg;
                return;
            }
            gantiRuang_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function gantiRuang_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['gantiRuang'])  && '' != $_SESSION['scriptcase']['error_icon']['gantiRuang'])  ? $_SESSION['scriptcase']['error_icon']['gantiRuang']  : "";
        $sCloseIcon      = (isset($_SESSION['scriptcase']['error_close']['gantiRuang']) && '' != $_SESSION['scriptcase']['error_close']['gantiRuang']) ? $_SESSION['scriptcase']['error_close']['gantiRuang'] : "<td><input class=\"scButton_default\" type=\"button\" onClick=\"document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false\" value=\"X\" /></td>";

        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['gantiRuang']) && '' != $_SESSION['scriptcase']['error_span_title']['gantiRuang']) ? $_SESSION['scriptcase']['error_span_title']['gantiRuang'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['gantiRuang']) && '' != $_SESSION['scriptcase']['error_icon_title']['gantiRuang']) ? $_SESSION['scriptcase']['error_icon_title']['gantiRuang'] : '';
?>
