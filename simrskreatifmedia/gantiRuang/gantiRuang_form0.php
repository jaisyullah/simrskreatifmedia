...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['gantiRuang']['embutida_pdf']))
 {
 ?>
...
<?php
include_once("gantiRuang_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('gantiRuang_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['gantiRuang']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['gantiRuang']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['gantiRuang']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['gantiRuang']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['gantiRuang']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['gantiRuang']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['gantiRuang']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['gantiRuang']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
?>
...
<?php
 include_once("gantiRuang_js0.php");
?>
<script type="text/javascript"> 
...
<?php
$_SESSION['scriptcase']['error_span_title']['gantiRuang'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['gantiRuang'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['gantiRuang']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['gantiRuang']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['gantiRuang']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['gantiRuang']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['gantiRuang']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<?php
  ...
  {
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['gantiRuang']['where_filter']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['gantiRuang']['empty_filter'] = true;
       }
  }
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_sc_field_1_line" id="hidden_field_data_sc_field_1" style="<?php echo $sStyleHidden_sc_field_1; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_custcode_line" id="hidden_field_data_custcode" style="<?php echo $sStyleHidden_custcode; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_kelas_label" id="hidden_field_label_kelas" style="<?php echo $sStyleHidden_kelas; ?>"><span id="id_label_kelas"><?php echo $this->nm_new_label['kelas']; ?></span></TD>
    <TD class="scFormDataOdd css_kelas_line" id="hidden_field_data_kelas" style="<?php echo $sStyleHidden_kelas; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_sc_field_3_line" id="hidden_field_data_sc_field_3" style="<?php echo $sStyleHidden_sc_field_3; ?>">
...
<?php
           if (($nm_apl_dependente != 1) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['gantiRuang']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['gantiRuang']['dashboard_info']['under_dashboard'])) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['gantiRuang']['nm_run_menu']) || $_SESSION['sc_session'][$this->Ini->sc_page]['gantiRuang']['nm_run_menu'] != 1))) {
...
<?php
           if (($nm_apl_dependente == 1) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['gantiRuang']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['gantiRuang']['dashboard_info']['under_dashboard']))) {
        $sCondStyle = ($this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['gantiRuang']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['gantiRuang']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("gantiRuang");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("gantiRuang");
 parent.scAjaxDetailHeight("gantiRuang", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['gantiRuang']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
