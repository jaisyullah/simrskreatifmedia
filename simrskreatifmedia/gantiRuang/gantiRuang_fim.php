...
//----- 
   ...
   if (isset($script_case_init) && !is_array($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['gantiRuang']))
   {
      unset($_SESSION['sc_session'][$script_case_init]['gantiRuang']['sc_redir_atualiz']);
      unset($_SESSION['sc_session'][$script_case_init]['gantiRuang']['sc_redir_insert']);
   }
   $fecha_janela = false;
   if (isset($_SESSION['sc_session'][$script_case_init]['gantiRuang']['nm_run_menu']) && $_SESSION['sc_session'][$script_case_init]['gantiRuang']['nm_run_menu'] == 2)
   {
       $fecha_janela   = true;
       $fecha_aba_menu = true;
   }
   ...
   {
       if (isset($script_case_init) && !is_array($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['gantiRuang']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['gantiRuang']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['gantiRuang']['sc_modal']);
           if (!isset($_SESSION['sc_session'][$script_case_init]['gantiRuang']['db_changed']) || $_SESSION['sc_session'][$script_case_init]['gantiRuang']['db_changed'])
           {
               if (isset($_SESSION['sc_session'][$script_case_init]['gantiRuang']['lig_iframe_modal']))
               {
                   $iframe_master = $_SESSION['sc_session'][$script_case_init]['gantiRuang']['lig_iframe_modal'];
                   ...
                   unset($_SESSION['sc_session'][$script_case_init]['gantiRuang']['lig_iframe_modal']);
               }
               else
               {
       ...
       {
           if (!isset($script_case_init) || is_array($script_case_init) || !isset($_SESSION['sc_session'][$script_case_init]['gantiRuang']['db_changed']) || $_SESSION['sc_session'][$script_case_init]['gantiRuang']['db_changed'])
           {
       ...
       if (isset($_SESSION['sc_session'][$script_case_init]['gantiRuang']['lig_iframe_modal']))
       {
           $Save_modal = $_SESSION['sc_session'][$script_case_init]['gantiRuang']['lig_iframe_modal'];
           nm_limpa_arr_session();
           $_SESSION['sc_session'][$script_case_init]['gantiRuang']['lig_iframe_modal'] = $Save_modal;
       }
       else
       {
           nm_limpa_arr_session();
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['gantiRuang']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['gantiRuang']['embutida_filho'] as $ind => $sc_init)
          {
