  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_gantiRuang" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_gantiRuang_form();
	}

  // ---------- Validate sc_field_1
  function do_ajax_gantiRuang_validate_sc_field_1()
  {
    var nomeCampo_sc_field_1 = "sc_field_1";
    var var_sc_field_1 = scAjaxGetFieldText(nomeCampo_sc_field_1);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_gantiRuang_validate_sc_field_1(var_sc_field_1, var_script_case_init, do_ajax_gantiRuang_validate_sc_field_1_cb);
  } // do_ajax_gantiRuang_validate_sc_field_1

  function do_ajax_gantiRuang_validate_sc_field_1_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_gantiRuang_validate_sc_field_1_cb

  // ---------- Validate custcode
  function do_ajax_gantiRuang_validate_custcode()
  {
    var nomeCampo_custcode = "custcode";
    var var_custcode = scAjaxGetFieldSelect(nomeCampo_custcode);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_gantiRuang_validate_custcode(var_custcode, var_script_case_init, do_ajax_gantiRuang_validate_custcode_cb);
  } // do_ajax_gantiRuang_validate_custcode

  function do_ajax_gantiRuang_validate_custcode_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_gantiRuang_validate_custcode_cb

  // ---------- Validate kelas
  function do_ajax_gantiRuang_validate_kelas()
  {
    var nomeCampo_kelas = "kelas";
    var var_kelas = scAjaxGetFieldText(nomeCampo_kelas);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_gantiRuang_validate_kelas(var_kelas, var_script_case_init, do_ajax_gantiRuang_validate_kelas_cb);
  } // do_ajax_gantiRuang_validate_kelas

  function do_ajax_gantiRuang_validate_kelas_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "kelas";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_gantiRuang_validate_kelas_cb

  // ---------- Validate sc_field_2
  function do_ajax_gantiRuang_validate_sc_field_2()
  {
    var nomeCampo_sc_field_2 = "sc_field_2";
    var var_sc_field_2 = scAjaxGetFieldSelect(nomeCampo_sc_field_2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_gantiRuang_validate_sc_field_2(var_sc_field_2, var_script_case_init, do_ajax_gantiRuang_validate_sc_field_2_cb);
  } // do_ajax_gantiRuang_validate_sc_field_2

  function do_ajax_gantiRuang_validate_sc_field_2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_gantiRuang_validate_sc_field_2_cb

  // ---------- Validate sc_field_3
  function do_ajax_gantiRuang_validate_sc_field_3()
  {
    var nomeCampo_sc_field_3 = "sc_field_3";
    var var_sc_field_3 = scAjaxGetFieldSelect(nomeCampo_sc_field_3);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_gantiRuang_validate_sc_field_3(var_sc_field_3, var_script_case_init, do_ajax_gantiRuang_validate_sc_field_3_cb);
  } // do_ajax_gantiRuang_validate_sc_field_3

  function do_ajax_gantiRuang_validate_sc_field_3_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_gantiRuang_validate_sc_field_3_cb

  // ---------- Validate sc_field_0
  function do_ajax_gantiRuang_validate_sc_field_0()
  {
    var nomeCampo_sc_field_0 = "sc_field_0";
    var var_sc_field_0 = scAjaxGetFieldSelect(nomeCampo_sc_field_0);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_gantiRuang_validate_sc_field_0(var_sc_field_0, var_script_case_init, do_ajax_gantiRuang_validate_sc_field_0_cb);
  } // do_ajax_gantiRuang_validate_sc_field_0

  function do_ajax_gantiRuang_validate_sc_field_0_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_gantiRuang_validate_sc_field_0_cb

  // ---------- Refresh sc_field_3
  function do_ajax_gantiRuang_refresh_sc_field_3()
  {
    var var_sc_field_3 = scAjaxGetFieldSelect("sc_field_3");
    var var_nmgp_refresh_fields = "sc_field_0";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_gantiRuang_refresh_sc_field_3(var_sc_field_3, var_nmgp_refresh_fields, var_script_case_init, do_ajax_gantiRuang_refresh_sc_field_3_cb);
  } // do_ajax_gantiRuang_refresh_sc_field_3

  function do_ajax_gantiRuang_refresh_sc_field_3_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_gantiRuang_refresh_sc_field_3_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_gantiRuang_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_gantiRuang_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_gantiRuang_submit_form(var_sc_field_1, var_custcode, var_kelas, var_sc_field_2, var_sc_field_3, var_sc_field_0, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_gantiRuang_submit_form_cb);
  } // do_ajax_gantiRuang_submit_form

  function do_ajax_gantiRuang_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_gantiRuang_submit_form_cb_after_alert);
  } // do_ajax_gantiRuang_submit_form_cb
  function do_ajax_gantiRuang_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_gantiRuang_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_gantiRuang_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_gantiRuang_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['gantiRuang']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_gantiRuang_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_gantiRuang_navigate_form_cb_after_alert);
  } // do_ajax_gantiRuang_navigate_form_cb
  function do_ajax_gantiRuang_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_gantiRuang_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_gantiRuang_navigate_form_cb_after_alert
  function sc_hide_gantiRuang_form()
  {
