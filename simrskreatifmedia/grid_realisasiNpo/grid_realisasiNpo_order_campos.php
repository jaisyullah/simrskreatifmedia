...
<?php
   ...
   $Ord_Cmp = new grid_realisasiNpo_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_realisasiNpo_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_realisasiNpo']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_realisasiNpo']['ordem_select_orig'] = array();
   }
   ...
   if ($use_alias == "S")
   {
       $tab_def_campos['a_npocode'] = "a_npocode";
   }
   else
   {
       $tab_def_campos['a_npocode'] = "a.npoCode";
   }
   $tab_labels["a_npocode"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_realisasiNpo']['labels']["a_npocode"])) ? $_SESSION['sc_session'][$sc_init]['grid_realisasiNpo']['labels']["a_npocode"] : "Npo Code";
   $tab_ger_campos['a_alasan'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['a_alasan'] = "a_alasan";
   }
   else
   {
       $tab_def_campos['a_alasan'] = "a.alasan";
   }
   $tab_labels["a_alasan"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_realisasiNpo']['labels']["a_alasan"])) ? $_SESSION['sc_session'][$sc_init]['grid_realisasiNpo']['labels']["a_alasan"] : "Alasan";
   $tab_ger_campos['a_jenis'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['a_jenis'] = "a_jenis";
   }
   else
   {
       $tab_def_campos['a_jenis'] = "a.jenis";
   }
   $tab_labels["a_jenis"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_realisasiNpo']['labels']["a_jenis"])) ? $_SESSION['sc_session'][$sc_init]['grid_realisasiNpo']['labels']["a_jenis"] : "Jenis";
   $tab_ger_campos['b_item'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['b_item'] = "b_item";
   }
   else
   {
       $tab_def_campos['b_item'] = "b.item";
   }
   $tab_labels["b_item"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_realisasiNpo']['labels']["b_item"])) ? $_SESSION['sc_session'][$sc_init]['grid_realisasiNpo']['labels']["b_item"] : "Item";
   $tab_ger_campos['b_jml'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['b_jml'] = "b_jml";
   }
   else
   {
       $tab_def_campos['b_jml'] = "b.jml";
   }
   $tab_labels["b_jml"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_realisasiNpo']['labels']["b_jml"])) ? $_SESSION['sc_session'][$sc_init]['grid_realisasiNpo']['labels']["b_jml"] : "Jml";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_realisasiNpo']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_realisasiNpo']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_realisasiNpo']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_realisasiNpo']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_realisasiNpo']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_realisasiNpo']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_realisasiNpo']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_realisasiNpo']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_realisasiNpo']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_realisasiNpo_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_realisasiNpo']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_realisasiNpo']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_realisasiNpo']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_realisasiNpo']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_realisasiNpo']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
