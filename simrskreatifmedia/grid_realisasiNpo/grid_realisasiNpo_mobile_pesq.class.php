...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "b_jml";$Nm_numeric[] = "b_jml";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_a_npocode_cond" name="a_npocode_cond" onChange="nm_campos_between(document.getElementById('id_vis_a_npocode'), this, 'a_npocode')">
      ...
      <br><span id="id_hide_a_npocode"  <?php echo $str_hide_a_npocode?>><?php
      if ($a_npocode != "")
      {
      $a_npocode_look = substr($this->Db->qstr($a_npocode), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_a_alasan_cond" name="a_alasan_cond" onChange="nm_campos_between(document.getElementById('id_vis_a_alasan'), this, 'a_alasan')">
      ...
      <br><span id="id_hide_a_alasan"  <?php echo $str_hide_a_alasan?>><?php
      if ($a_alasan != "")
      {
      $a_alasan_look = substr($this->Db->qstr($a_alasan), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_a_jenis_cond" name="a_jenis_cond" onChange="nm_campos_between(document.getElementById('id_vis_a_jenis'), this, 'a_jenis')">
      ...
      <br><span id="id_hide_a_jenis"  <?php echo $str_hide_a_jenis?>><?php
      if ($a_jenis != "")
      {
      $a_jenis_look = substr($this->Db->qstr($a_jenis), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_b_item_cond" name="b_item_cond" onChange="nm_campos_between(document.getElementById('id_vis_b_item'), this, 'b_item')">
      ...
      <br><span id="id_hide_b_item"  <?php echo $str_hide_b_item?>><?php
      if ($b_item != "")
      {
      $b_item_look = substr($this->Db->qstr($b_item), 1, -1); 
      $nmgp_def_dados = array(); 
