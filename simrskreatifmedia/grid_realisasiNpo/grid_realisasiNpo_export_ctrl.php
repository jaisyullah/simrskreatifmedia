<?php
@session_start() ;
$_SESSION['scriptcase']['grid_realisasiNpo']['sc_process_barr'] = true;
require_once('../grid_realisasiNpo/index.php');
unset($_SESSION['scriptcase']['grid_realisasiNpo']['sc_process_barr']);
$ExportCtrl = new grid_realisasiNpo_export_control;
$ExportCtrl->Export_barr();

class grid_realisasiNpo_export_control
{
