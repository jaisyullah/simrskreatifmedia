...
class grid_realisasiNpo_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['path_libs_php'] = $this->Ini->path_lib_php;
      ...
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search_change_fil")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['campos_busca'] = array(); 
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_realisasiNpo_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_realisasiNpo_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_realisasiNpo_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_a_npocode')
      {
          $a_npocode = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_a_npocode($a_npocode);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_a_alasan')
      {
          $a_alasan = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_a_alasan($a_alasan);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_a_jenis')
      {
          $a_jenis = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_a_jenis($a_jenis);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_b_item')
      {
          $b_item = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_b_item($b_item);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
          ...
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['grid_pesq'][$campo_join]);
              return;
          }
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_realisasiNpo/grid_realisasiNpo_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_realisasiNpo_ajax_search.js"></script>
 <script type="text/javascript" src="grid_realisasiNpo_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_realisasiNpo_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_realisasiNpo']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_realisasiNpo']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_a_npocode_cond#NMF#' + search_get_sel_txt('SC_a_npocode_cond') + '@NMF@';
  str_out += 'SC_a_npocode#NMF#' + search_get_text('SC_a_npocode') + '@NMF@';
  str_out += 'id_ac_a_npocode#NMF#' + search_get_text('id_ac_a_npocode') + '@NMF@';
  str_out += 'SC_a_alasan_cond#NMF#' + search_get_sel_txt('SC_a_alasan_cond') + '@NMF@';
  str_out += 'SC_a_alasan#NMF#' + search_get_text('SC_a_alasan') + '@NMF@';
  str_out += 'id_ac_a_alasan#NMF#' + search_get_text('id_ac_a_alasan') + '@NMF@';
  str_out += 'SC_a_jenis_cond#NMF#' + search_get_sel_txt('SC_a_jenis_cond') + '@NMF@';
  str_out += 'SC_a_jenis#NMF#' + search_get_text('SC_a_jenis') + '@NMF@';
  str_out += 'id_ac_a_jenis#NMF#' + search_get_text('id_ac_a_jenis') + '@NMF@';
  str_out += 'SC_b_item_cond#NMF#' + search_get_sel_txt('SC_b_item_cond') + '@NMF@';
  str_out += 'SC_b_item#NMF#' + search_get_text('SC_b_item') + '@NMF@';
  str_out += 'id_ac_b_item#NMF#' + search_get_text('id_ac_b_item') + '@NMF@';
   ...
   $("#id_ac_a_npocode").autocomplete({
     ...
     $.ajax({
       ...
       data: {
          ...
          nmgp_parms: "NM_ajax_opcao?#?autocomp_a_npocode",
          max_itens: "10",
          cod_desc: "N",
     ...
     select: function (event, ui) {
       $("#SC_a_npocode").val(ui.item.value);
     ...
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_a_npocode").val( $(this).val() );
       }
     }
   });
   $("#id_ac_a_alasan").autocomplete({
     minLength: 1,
     source: function (request, response) {
     $.ajax({
       url: "index.php",
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_a_alasan",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_a_alasan").val( $(this).val() );
       }
     }
   });
   $("#id_ac_a_jenis").autocomplete({
     minLength: 1,
     source: function (request, response) {
     $.ajax({
       url: "index.php",
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_a_jenis",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_a_jenis").val( $(this).val() );
       }
     }
   });
   $("#id_ac_b_item").autocomplete({
     minLength: 1,
     source: function (request, response) {
     $.ajax({
       url: "index.php",
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_b_item",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<?php
   ...
   {
      global 
             $a_npocode_cond, $a_npocode, $a_npocode_autocomp,
             $a_alasan_cond, $a_alasan, $a_alasan_autocomp,
             $a_jenis_cond, $a_jenis, $a_jenis_autocomp,
             $b_item_cond, $b_item, $b_item_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          $a_npocode = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['campos_busca']['a_npocode']; 
          $a_npocode_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['campos_busca']['a_npocode_cond']; 
          $a_alasan = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['campos_busca']['a_alasan']; 
          $a_alasan_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['campos_busca']['a_alasan_cond']; 
          $a_jenis = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['campos_busca']['a_jenis']; 
          $a_jenis_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['campos_busca']['a_jenis_cond']; 
          $b_item = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['campos_busca']['b_item']; 
          $b_item_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['campos_busca']['b_item_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['campos_busca']['NM_operador']; 
      } 
      if (!isset($a_npocode_cond) || empty($a_npocode_cond))
      {
         $a_npocode_cond = "qp";
      }
      if (!isset($a_alasan_cond) || empty($a_alasan_cond))
      {
         $a_alasan_cond = "qp";
      }
      if (!isset($a_jenis_cond) || empty($a_jenis_cond))
      {
         $a_jenis_cond = "qp";
      }
      if (!isset($b_item_cond) || empty($b_item_cond))
      {
         $b_item_cond = "qp";
      }
      ...
      $str_hide_a_npocode = (in_array($a_npocode_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_a_alasan = (in_array($a_alasan_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_a_jenis = (in_array($a_jenis_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_b_item = (in_array($b_item_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      if (!isset($a_npocode) || $a_npocode == "")
      {
          $a_npocode = "";
      }
      if (isset($a_npocode) && !empty($a_npocode))
      {
         $tmp_pos = strpos($a_npocode, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $a_npocode = substr($a_npocode, 0, $tmp_pos);
         }
      }
      if (!isset($a_alasan) || $a_alasan == "")
      {
          $a_alasan = "";
      }
      if (isset($a_alasan) && !empty($a_alasan))
      {
         $tmp_pos = strpos($a_alasan, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $a_alasan = substr($a_alasan, 0, $tmp_pos);
         }
      }
      if (!isset($a_jenis) || $a_jenis == "")
      {
          $a_jenis = "";
      }
      if (isset($a_jenis) && !empty($a_jenis))
      {
         $tmp_pos = strpos($a_jenis, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $a_jenis = substr($a_jenis, 0, $tmp_pos);
         }
      }
      if (!isset($b_item) || $b_item == "")
      {
          $b_item = "";
      }
      if (isset($b_item) && !empty($b_item))
      {
         $tmp_pos = strpos($b_item, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $b_item = substr($b_item, 0, $tmp_pos);
         }
      }
?>
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_a_npocode_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['a_npocode'])) ? $this->New_label['a_npocode'] : "Npo Code"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_a_npocode_cond" name="a_npocode_cond" onChange="nm_campos_between(document.getElementById('id_vis_a_npocode'), this, 'a_npocode')">
       <OPTION value="qp" <?php if ("qp" == $a_npocode_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $a_npocode_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $a_npocode_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $a_npocode_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_a_npocode" <?php echo $str_hide_a_npocode?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['a_npocode'])) ? $this->New_label['a_npocode'] : "Npo Code";
 $nmgp_tab_label .= "a_npocode?#?" . $SC_Label . "?@?";
...
<?php
      ...
      {
          $sAutocompValue = $a_npocode;
      }
?>
<INPUT  type="text" id="SC_a_npocode" name="a_npocode" value="<?php echo NM_encode_input($a_npocode) ?>"  size=45 alt="{datatype: 'text', maxLength: 45, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_a_npocode" name="a_npocode_autocomp" size="45"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 45, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_a_alasan_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['a_alasan'])) ? $this->New_label['a_alasan'] : "Alasan"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_a_alasan_cond" name="a_alasan_cond" onChange="nm_campos_between(document.getElementById('id_vis_a_alasan'), this, 'a_alasan')">
       <OPTION value="qp" <?php if ("qp" == $a_alasan_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $a_alasan_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $a_alasan_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $a_alasan_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_a_alasan" <?php echo $str_hide_a_alasan?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['a_alasan'])) ? $this->New_label['a_alasan'] : "Alasan";
 $nmgp_tab_label .= "a_alasan?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      {
          $sAutocompValue = $a_alasan;
      }
?>
<INPUT  type="text" id="SC_a_alasan" name="a_alasan" value="<?php echo NM_encode_input($a_alasan) ?>"  size=50 alt="{datatype: 'text', maxLength: 765, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_a_alasan" name="a_alasan_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 765, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_a_jenis_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['a_jenis'])) ? $this->New_label['a_jenis'] : "Jenis"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_a_jenis_cond" name="a_jenis_cond" onChange="nm_campos_between(document.getElementById('id_vis_a_jenis'), this, 'a_jenis')">
       <OPTION value="qp" <?php if ("qp" == $a_jenis_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $a_jenis_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $a_jenis_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $a_jenis_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_a_jenis" <?php echo $str_hide_a_jenis?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['a_jenis'])) ? $this->New_label['a_jenis'] : "Jenis";
 $nmgp_tab_label .= "a_jenis?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      {
          $sAutocompValue = $a_jenis;
      }
?>
<INPUT  type="text" id="SC_a_jenis" name="a_jenis" value="<?php echo NM_encode_input($a_jenis) ?>"  size=24 alt="{datatype: 'text', maxLength: 24, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_a_jenis" name="a_jenis_autocomp" size="24"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 24, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_b_item_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['b_item'])) ? $this->New_label['b_item'] : "Item"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_b_item_cond" name="b_item_cond" onChange="nm_campos_between(document.getElementById('id_vis_b_item'), this, 'b_item')">
       <OPTION value="qp" <?php if ("qp" == $b_item_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $b_item_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $b_item_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $b_item_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_b_item" <?php echo $str_hide_b_item?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['b_item'])) ? $this->New_label['b_item'] : "Item";
 $nmgp_tab_label .= "b_item?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      {
          $sAutocompValue = $b_item;
      }
?>
<INPUT  type="text" id="SC_b_item" name="b_item" value="<?php echo NM_encode_input($b_item) ?>"  size=45 alt="{datatype: 'text', maxLength: 45, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_b_item" name="b_item_autocomp" size="45"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 45, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if ($_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
<?php
   if (is_file("grid_realisasiNpo_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_realisasiNpo']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_realisasiNpo']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.a_npocode_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_a_npocode'), document.F1.a_npocode_cond, 'a_npocode');
   document.F1.a_npocode.value = "";
   document.F1.a_npocode_autocomp.value = "";
   document.F1.a_alasan_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_a_alasan'), document.F1.a_alasan_cond, 'a_alasan');
   document.F1.a_alasan.value = "";
   document.F1.a_alasan_autocomp.value = "";
   document.F1.a_jenis_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_a_jenis'), document.F1.a_jenis_cond, 'a_jenis');
   document.F1.a_jenis.value = "";
   document.F1.a_jenis_autocomp.value = "";
   document.F1.b_item_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_b_item'), document.F1.b_item_cond, 'b_item');
   document.F1.b_item.value = "";
   document.F1.b_item_autocomp.value = "";
 }
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['where_orig']))
      {
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['where_orig'];
      }
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_a_npocode_cond'] = 'cond';
      $tp_fields['SC_a_npocode'] = 'text_aut';
      $tp_fields['id_ac_a_npocode'] = 'text_aut';
      $tp_fields['SC_a_alasan_cond'] = 'cond';
      $tp_fields['SC_a_alasan'] = 'text_aut';
      $tp_fields['id_ac_a_alasan'] = 'text_aut';
      $tp_fields['SC_a_jenis_cond'] = 'cond';
      $tp_fields['SC_a_jenis'] = 'text_aut';
      $tp_fields['id_ac_a_jenis'] = 'text_aut';
      $tp_fields['SC_b_item_cond'] = 'cond';
      $tp_fields['SC_b_item'] = 'text_aut';
      $tp_fields['id_ac_b_item'] = 'text_aut';
   ...
   {
      global $a_npocode_cond, $a_npocode, $a_npocode_autocomp,
             $a_alasan_cond, $a_alasan, $a_alasan_autocomp,
             $a_jenis_cond, $a_jenis, $a_jenis_autocomp,
             $b_item_cond, $b_item, $b_item_autocomp, $nmgp_tab_label;
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['campos_busca'] as $Cmps => $Vals)
          {
              $$Cmps = $Vals;
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['grid_pesq'] = array();
      if (!empty($a_npocode_autocomp) && empty($a_npocode))
      {
          $a_npocode = $a_npocode_autocomp;
      }
      if (!empty($a_alasan_autocomp) && empty($a_alasan))
      {
          $a_alasan = $a_alasan_autocomp;
      }
      if (!empty($a_jenis_autocomp) && empty($a_jenis))
      {
          $a_jenis = $a_jenis_autocomp;
      }
      if (!empty($b_item_autocomp) && empty($b_item))
      {
          $b_item = $b_item_autocomp;
      }
      $a_npocode_cond_salva = $a_npocode_cond; 
      if (!isset($a_npocode_input_2) || $a_npocode_input_2 == "")
      {
          $a_npocode_input_2 = $a_npocode;
      }
      $a_alasan_cond_salva = $a_alasan_cond; 
      if (!isset($a_alasan_input_2) || $a_alasan_input_2 == "")
      {
          $a_alasan_input_2 = $a_alasan;
      }
      $a_jenis_cond_salva = $a_jenis_cond; 
      if (!isset($a_jenis_input_2) || $a_jenis_input_2 == "")
      {
          $a_jenis_input_2 = $a_jenis;
      }
      $b_item_cond_salva = $b_item_cond; 
      if (!isset($b_item_input_2) || $b_item_input_2 == "")
      {
          $b_item_input_2 = $b_item;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['Grid_search']  = array(); 
      $I_Grid = 0;
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['campos_busca']['a_npocode'] = $a_npocode; 
      if (is_array($a_npocode) && !empty($a_npocode))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['Grid_search'][$I_Grid]['val'][0] = $a_npocode;
      }
      elseif ($a_npocode_cond_salva == "nu" || $a_npocode_cond_salva == "nn" || $a_npocode_cond_salva == "ep" || $a_npocode_cond_salva == "ne" || !empty($a_npocode))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['Grid_search'][$I_Grid]['val'][0][0] = $a_npocode;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['campos_busca']['a_npocode_cond'] = $a_npocode_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['Grid_search'][$I_Grid]['cmp'] = "a_npocode"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['Grid_search'][$I_Grid]['opc'] = $a_npocode_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['grid_pesq']['a_npocode'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['campos_busca']['a_alasan'] = $a_alasan; 
      if (is_array($a_alasan) && !empty($a_alasan))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['Grid_search'][$I_Grid]['val'][0] = $a_alasan;
      }
      elseif ($a_alasan_cond_salva == "nu" || $a_alasan_cond_salva == "nn" || $a_alasan_cond_salva == "ep" || $a_alasan_cond_salva == "ne" || !empty($a_alasan))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['Grid_search'][$I_Grid]['val'][0][0] = $a_alasan;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['campos_busca']['a_alasan_cond'] = $a_alasan_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['Grid_search'][$I_Grid]['cmp'] = "a_alasan"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['Grid_search'][$I_Grid]['opc'] = $a_alasan_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['grid_pesq']['a_alasan'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['campos_busca']['a_jenis'] = $a_jenis; 
      if (is_array($a_jenis) && !empty($a_jenis))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['Grid_search'][$I_Grid]['val'][0] = $a_jenis;
      }
      elseif ($a_jenis_cond_salva == "nu" || $a_jenis_cond_salva == "nn" || $a_jenis_cond_salva == "ep" || $a_jenis_cond_salva == "ne" || !empty($a_jenis))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['Grid_search'][$I_Grid]['val'][0][0] = $a_jenis;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['campos_busca']['a_jenis_cond'] = $a_jenis_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['Grid_search'][$I_Grid]['cmp'] = "a_jenis"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['Grid_search'][$I_Grid]['opc'] = $a_jenis_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['grid_pesq']['a_jenis'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['campos_busca']['b_item'] = $b_item; 
      if (is_array($b_item) && !empty($b_item))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['Grid_search'][$I_Grid]['val'][0] = $b_item;
      }
      elseif ($b_item_cond_salva == "nu" || $b_item_cond_salva == "nn" || $b_item_cond_salva == "ep" || $b_item_cond_salva == "ne" || !empty($b_item))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['Grid_search'][$I_Grid]['val'][0][0] = $b_item;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['campos_busca']['b_item_cond'] = $b_item_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['Grid_search'][$I_Grid]['cmp'] = "b_item"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['Grid_search'][$I_Grid]['opc'] = $b_item_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['grid_pesq']['b_item'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['a_npocode'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['a_npocode'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['a_npocode'] = $a_npocode;
      }
      $a_alasan_look = substr($this->Db->qstr($a_alasan), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct a.alasan from " . $this->Ini->nm_tabela . " where a.alasan = '$a_alasan_look' order by a.alasan"; 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['a_alasan'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['a_alasan'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['a_alasan'] = $a_alasan;
      }
      $a_jenis_look = substr($this->Db->qstr($a_jenis), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct a.jenis from " . $this->Ini->nm_tabela . " where a.jenis = '$a_jenis_look' order by a.jenis"; 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['a_jenis'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['a_jenis'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['a_jenis'] = $a_jenis;
      }
      $b_item_look = substr($this->Db->qstr($b_item), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct b.item from " . $this->Ini->nm_tabela . " where b.item = '$b_item_look' order by b.item"; 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['b_item'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['b_item'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['b_item'] = $b_item;
      }

      //----- $a_npocode
      $this->Date_part = false;
      if (isset($a_npocode) || $a_npocode_cond == "nu" || $a_npocode_cond == "nn" || $a_npocode_cond == "ep" || $a_npocode_cond == "ne")
      {
         $this->monta_condicao("a.npoCode", $a_npocode_cond, $a_npocode, "", "a_npocode");
      }

      //----- $a_alasan
      $this->Date_part = false;
      if (isset($a_alasan) || $a_alasan_cond == "nu" || $a_alasan_cond == "nn" || $a_alasan_cond == "ep" || $a_alasan_cond == "ne")
      {
         $this->monta_condicao("a.alasan", $a_alasan_cond, $a_alasan, "", "a_alasan");
      }

      //----- $a_jenis
      $this->Date_part = false;
      if (isset($a_jenis) || $a_jenis_cond == "nu" || $a_jenis_cond == "nn" || $a_jenis_cond == "ep" || $a_jenis_cond == "ne")
      {
         $this->monta_condicao("a.jenis", $a_jenis_cond, $a_jenis, "", "a_jenis");
      }

      //----- $b_item
      $this->Date_part = false;
      if (isset($b_item) || $b_item_cond == "nu" || $b_item_cond == "nn" || $b_item_cond == "ep" || $b_item_cond == "ne")
      {
         $this->monta_condicao("b.item", $b_item_cond, $b_item, "", "b_item");
      }
   }
   ...
   function finaliza_resultado_ajax()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['where_pesq'] = $this->comando;
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['where_pesq_fast'])) 
       {
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['where_pesq'])) 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['where_pesq_fast'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['where_pesq'] = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['where_pesq_fast'] . ")";
           }
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['cond_dyn_search'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_realisasiNpo']['cond_pesq'] .= $this->NM_operador;
