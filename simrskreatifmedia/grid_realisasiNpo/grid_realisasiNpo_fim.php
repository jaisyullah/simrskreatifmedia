...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_realisasiNpo"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_realisasiNpo"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_realisasiNpo']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_realisasiNpo']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_realisasiNpo']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_realisasiNpo']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_realisasiNpo']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_realisasiNpo']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_realisasiNpo']['embutida_filho'] as $ind => $sc_init)
          {
