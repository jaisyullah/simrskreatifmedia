  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbhasillab" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbhasillab_form();
	}

  // ---------- Validate nama_
  function do_ajax_form_tbhasillab_validate_nama_(iNumLinha)
  {
    var nomeCampo_nama_ = "nama_" + iNumLinha;
    var var_nama_ = scAjaxGetFieldText(nomeCampo_nama_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbhasillab_validate_nama_(var_nama_, iNumLinha, var_script_case_init, do_ajax_form_tbhasillab_validate_nama__cb);
  } // do_ajax_form_tbhasillab_validate_nama_

  function do_ajax_form_tbhasillab_validate_nama__cb(sResp)
  {
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "nama_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "nama_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbhasillab_validate_nama__cb

  // ---------- Validate kategori_
  function do_ajax_form_tbhasillab_validate_kategori_(iNumLinha)
  {
    var nomeCampo_kategori_ = "kategori_" + iNumLinha;
    var var_kategori_ = scAjaxGetFieldText(nomeCampo_kategori_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbhasillab_validate_kategori_(var_kategori_, iNumLinha, var_script_case_init, do_ajax_form_tbhasillab_validate_kategori__cb);
  } // do_ajax_form_tbhasillab_validate_kategori_

  function do_ajax_form_tbhasillab_validate_kategori__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "kategori_" + iLineNumber;
    }
    else
    {
      sFieldValid = "kategori_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "kategori_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "kategori_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbhasillab_validate_kategori__cb

  // ---------- Validate subname_
  function do_ajax_form_tbhasillab_validate_subname_(iNumLinha)
  {
    var nomeCampo_subname_ = "subname_" + iNumLinha;
    var var_subname_ = scAjaxGetFieldText(nomeCampo_subname_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbhasillab_validate_subname_(var_subname_, iNumLinha, var_script_case_init, do_ajax_form_tbhasillab_validate_subname__cb);
  } // do_ajax_form_tbhasillab_validate_subname_

  function do_ajax_form_tbhasillab_validate_subname__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "subname_" + iLineNumber;
    }
    else
    {
      sFieldValid = "subname_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "subname_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "subname_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbhasillab_validate_subname__cb

  // ---------- Validate hasil_
  function do_ajax_form_tbhasillab_validate_hasil_(iNumLinha)
  {
    var nomeCampo_hasil_ = "hasil_" + iNumLinha;
    var var_hasil_ = scAjaxGetFieldText(nomeCampo_hasil_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbhasillab_validate_hasil_(var_hasil_, iNumLinha, var_script_case_init, do_ajax_form_tbhasillab_validate_hasil__cb);
  } // do_ajax_form_tbhasillab_validate_hasil_

  function do_ajax_form_tbhasillab_validate_hasil__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "hasil_" + iLineNumber;
    }
    else
    {
      sFieldValid = "hasil_";
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "hasil_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "hasil_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbhasillab_validate_hasil__cb

  // ---------- Validate satuan_
  function do_ajax_form_tbhasillab_validate_satuan_(iNumLinha)
  {
    var nomeCampo_satuan_ = "satuan_" + iNumLinha;
    var var_satuan_ = scAjaxGetFieldText(nomeCampo_satuan_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbhasillab_validate_satuan_(var_satuan_, iNumLinha, var_script_case_init, do_ajax_form_tbhasillab_validate_satuan__cb);
  } // do_ajax_form_tbhasillab_validate_satuan_

  function do_ajax_form_tbhasillab_validate_satuan__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbhasillab_validate_satuan__cb

  // ---------- Validate marked_
  function do_ajax_form_tbhasillab_validate_marked_(iNumLinha)
  {
    var nomeCampo_marked_ = "marked_" + iNumLinha;
    var var_marked_ = scAjaxGetFieldText(nomeCampo_marked_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbhasillab_validate_marked_(var_marked_, iNumLinha, var_script_case_init, do_ajax_form_tbhasillab_validate_marked__cb);
  } // do_ajax_form_tbhasillab_validate_marked_

  function do_ajax_form_tbhasillab_validate_marked__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbhasillab_validate_marked__cb

  // ---------- Validate rujukan_
  function do_ajax_form_tbhasillab_validate_rujukan_(iNumLinha)
  {
    var nomeCampo_rujukan_ = "rujukan_" + iNumLinha;
    var var_rujukan_ = scAjaxGetFieldText(nomeCampo_rujukan_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbhasillab_validate_rujukan_(var_rujukan_, iNumLinha, var_script_case_init, do_ajax_form_tbhasillab_validate_rujukan__cb);
  } // do_ajax_form_tbhasillab_validate_rujukan_

  function do_ajax_form_tbhasillab_validate_rujukan__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "rujukan_" + iLineNumber;
    }
    else
    {
      sFieldValid = "rujukan_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "rujukan_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "rujukan_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbhasillab_validate_rujukan__cb

  // ---------- Validate id_
  function do_ajax_form_tbhasillab_validate_id_(iNumLinha)
  {
    var nomeCampo_id_ = "id_" + iNumLinha;
    var var_id_ = scAjaxGetFieldHidden(nomeCampo_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbhasillab_validate_id_(var_id_, iNumLinha, var_script_case_init, do_ajax_form_tbhasillab_validate_id__cb);
  } // do_ajax_form_tbhasillab_validate_id_

  function do_ajax_form_tbhasillab_validate_id__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbhasillab_validate_id__cb

  // ---------- Event onchange hasil_
  function do_ajax_form_tbhasillab_event_hasil__onchange(iSeqForm)
  {
    var var_kategori_ = scAjaxGetFieldText("kategori_" + iSeqForm);
    var var_script_case_init = document.F2.script_case_init.value;
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_tbhasillab_event_hasil__onchange(var_kategori_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_tbhasillab_event_hasil__onchange_cb);
  } // do_ajax_form_tbhasillab_event_hasil__onchange

  function do_ajax_form_tbhasillab_event_hasil__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_tbhasillab_event_hasil__onchange_cb_after_alert);
  } // do_ajax_form_tbhasillab_event_hasil__onchange_cb
  function do_ajax_form_tbhasillab_event_hasil__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_tbhasillab_event_hasil__onchange_cb_after_alert

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_tbhasillab_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_tbhasillab_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tbhasillab_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_tbhasillab_add_new_line_cb);
  } // do_ajax_form_tbhasillab_add_new_line

  function do_ajax_form_tbhasillab_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
    ...
    nm_field_disabled("rujukan_=disabled", "", iAjaxNewLine);
  } // do_ajax_form_tbhasillab_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_tbhasillab_backup_line(iNumLinha)
  {
    var var_id_ = scAjaxGetFieldHidden("id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbhasillab_backup_line(var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_tbhasillab_backup_line_cb);
  } // do_ajax_form_tbhasillab_backup_line

  function do_ajax_form_tbhasillab_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_tbhasillab_backup_line_cb

  function do_ajax_form_tbhasillab_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_tbhasillab_cancel_insert

  function do_ajax_form_tbhasillab_cancel_update(iSeqVert)
  {
    do_ajax_form_tbhasillab_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_tbhasillab_cancel_update

  function do_ajax_form_tbhasillab_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_tbhasillab_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_tbhasillab_table_refresh()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tbhasillab_table_refresh(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbhasillab_table_refresh_cb);
  } //  do_ajax_form_tbhasillab_table_refresh

  function do_ajax_form_tbhasillab_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_tbhasillab_table_refresh_cb_after_alert);
  } // do_ajax_form_tbhasillab_table_refresh_cb
  function do_ajax_form_tbhasillab_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_tbhasillab_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_tbhasillab_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_tbhasillab_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    sc_num_ult_line = iNumLinha;
    sc_num_ult_tr   = indexTR;
    scAjaxHideMessage();
    var var_nama_ = scAjaxGetFieldText("nama_" + iNumLinha);
    var var_kategori_ = scAjaxGetFieldText("kategori_" + iNumLinha);
    var var_subname_ = scAjaxGetFieldText("subname_" + iNumLinha);
    var var_hasil_ = scAjaxGetFieldText("hasil_" + iNumLinha);
    var var_satuan_ = scAjaxGetFieldText("satuan_" + iNumLinha);
    var var_marked_ = scAjaxGetFieldText("marked_" + iNumLinha);
    var var_rujukan_ = scAjaxGetFieldText("rujukan_" + iNumLinha);
    var var_id_ = scAjaxGetFieldHidden("id_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_tbhasillab_submit_form(var_nama_, var_kategori_, var_subname_, var_hasil_, var_satuan_, var_marked_, var_rujukan_, var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbhasillab_submit_form_cb);
  } // do_ajax_form_tbhasillab_submit_form

  function do_ajax_form_tbhasillab_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("nama_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("kategori_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("subname_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("hasil_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("satuan_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("marked_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("rujukan_" + sc_num_ult_line);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_tbhasillab_submit_form_cb_after_alert);
  } // do_ajax_form_tbhasillab_submit_form_cb
  function do_ajax_form_tbhasillab_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbhasillab_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tbhasillab_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    {
      scAjaxHideErrorDisplay("nama_" + iNavForm);
      scAjaxHideErrorDisplay("kategori_" + iNavForm);
      scAjaxHideErrorDisplay("subname_" + iNavForm);
      scAjaxHideErrorDisplay("hasil_" + iNavForm);
      scAjaxHideErrorDisplay("satuan_" + iNavForm);
      scAjaxHideErrorDisplay("marked_" + iNavForm);
      scAjaxHideErrorDisplay("rujukan_" + iNavForm);
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tbhasillab_navigate_form(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbhasillab_navigate_form_cb);
  } // do_ajax_form_tbhasillab_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhasillab']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbhasillab_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbhasillab_navigate_form_cb_after_alert);
  } // do_ajax_form_tbhasillab_navigate_form_cb
  function do_ajax_form_tbhasillab_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_tbhasillab_navigate_form_cb_after_alert
  function sc_hide_form_tbhasillab_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "nama_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "kategori_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "subname_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "hasil_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "satuan_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "marked_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "rujukan_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "id_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["nama_" + iNumLinha] = {"label": "Nama Pemeriksaan<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["kategori_" + iNumLinha] = {"label": "Kategori<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["subname_" + iNumLinha] = {"label": "Sub Pemeriksaan<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["hasil_" + iNumLinha] = {"label": "Hasil<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_error_list["marked_" + iNumLinha] = {"label": "Tandai<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["rujukan_" + iNumLinha] = {"label": "Rujukan<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_field_mult["nama_"][iNumLinha] = "nama_" + iNumLinha;
    ajax_field_mult["kategori_"][iNumLinha] = "kategori_" + iNumLinha;
    ajax_field_mult["subname_"][iNumLinha] = "subname_" + iNumLinha;
    ajax_field_mult["hasil_"][iNumLinha] = "hasil_" + iNumLinha;
    ajax_field_mult["satuan_"][iNumLinha] = "satuan_" + iNumLinha;
    ajax_field_mult["marked_"][iNumLinha] = "marked_" + iNumLinha;
    ajax_field_mult["rujukan_"][iNumLinha] = "rujukan_" + iNumLinha;
    ajax_field_mult["id_"][iNumLinha] = "id_" + iNumLinha;
    ajax_field_id["nama_" + iNumLinha] = new Array("hidden_field_label_nama_", "hidden_field_data_nama_" + iNumLinha);
    ajax_field_id["kategori_" + iNumLinha] = new Array("hidden_field_label_kategori_", "hidden_field_data_kategori_" + iNumLinha);
    ajax_field_id["subname_" + iNumLinha] = new Array("hidden_field_label_subname_", "hidden_field_data_subname_" + iNumLinha);
    ajax_field_id["hasil_" + iNumLinha] = new Array("hidden_field_label_hasil_", "hidden_field_data_hasil_" + iNumLinha);
    ...
    ajax_field_id["rujukan_" + iNumLinha] = new Array("hidden_field_label_rujukan_", "hidden_field_data_rujukan_" + iNumLinha);
    ajax_error_count["nama_" + iNumLinha] = "off";
    ajax_error_count["kategori_" + iNumLinha] = "off";
    ajax_error_count["subname_" + iNumLinha] = "off";
    ajax_error_count["hasil_" + iNumLinha] = "off";
    ajax_error_count["satuan_" + iNumLinha] = "off";
    ajax_error_count["marked_" + iNumLinha] = "off";
    ajax_error_count["rujukan_" + iNumLinha] = "off";
    ajax_error_count["id_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["nama_" + iNumLinha] = "on";
    ajax_read_only["kategori_" + iNumLinha] = "on";
    ajax_read_only["subname_" + iNumLinha] = "on";
    ajax_read_only["hasil_" + iNumLinha] = "off";
    ajax_read_only["satuan_" + iNumLinha] = "on";
    ajax_read_only["marked_" + iNumLinha] = "on";
    ajax_read_only["rujukan_" + iNumLinha] = "on";
...
?>
    ...
    ajax_read_only["kategori_" + iNumLinha] = "on";
    ajax_read_only["subname_" + iNumLinha] = "on";
    ajax_read_only["hasil_" + iNumLinha] = "on";
    ajax_read_only["satuan_" + iNumLinha] = "on";
    ajax_read_only["marked_" + iNumLinha] = "on";
    ajax_read_only["rujukan_" + iNumLinha] = "on";
    ajax_read_only["id_" + iNumLinha] = "on";
...
?>
  ...
  {
    ajax_error_list["nama_" + iNumLinha] = null;
    ajax_error_list["kategori_" + iNumLinha] = null;
    ajax_error_list["subname_" + iNumLinha] = null;
    ajax_error_list["hasil_" + iNumLinha] = null;
    ajax_error_list["satuan_" + iNumLinha] = null;
    ajax_error_list["marked_" + iNumLinha] = null;
    ajax_error_list["rujukan_" + iNumLinha] = null;
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["nama_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["nama_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["nama_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["nama_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["nama_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["kategori_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["kategori_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["kategori_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["kategori_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["kategori_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["subname_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["subname_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["subname_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["subname_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["subname_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["hasil_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["hasil_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["hasil_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["hasil_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["hasil_" + iNumLinha]["onfocus"] = new Array();
      ...
      ajax_error_list["rujukan_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["rujukan_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["rujukan_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["rujukan_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["rujukan_" + iNumLinha]["onfocus"] = new Array();
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['nama_'])) ? $this->nmgp_cmp_readonly['nama_'] : 'on';
?>
    scAjaxFieldRead("nama_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['kategori_'])) ? $this->nmgp_cmp_readonly['kategori_'] : 'on';
?>
    scAjaxFieldRead("kategori_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['subname_'])) ? $this->nmgp_cmp_readonly['subname_'] : 'on';
?>
    scAjaxFieldRead("subname_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['hasil_'])) ? $this->nmgp_cmp_readonly['hasil_'] : 'off';
?>
    scAjaxFieldRead("hasil_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['satuan_'])) ? $this->nmgp_cmp_readonly['satuan_'] : 'on';
?>
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['rujukan_'])) ? $this->nmgp_cmp_readonly['rujukan_'] : 'on';
?>
    scAjaxFieldRead("rujukan_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
?>
  ...
  {
    scAjaxFieldRead("nama_" + iSeq, "on");
    scAjaxFieldRead("kategori_" + iSeq, "on");
    scAjaxFieldRead("subname_" + iSeq, "on");
    scAjaxFieldRead("hasil_" + iSeq, "on");
    scAjaxFieldRead("satuan_" + iSeq, "on");
    scAjaxFieldRead("marked_" + iSeq, "on");
    scAjaxFieldRead("rujukan_" + iSeq, "on");
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["nama_" + iRow] || "on" == ajax_error_count["kategori_" + iRow] || "on" == ajax_error_count["subname_" + iRow] || "on" == ajax_error_count["hasil_" + iRow] || "on" == ajax_error_count["satuan_" + iRow] || "on" == ajax_error_count["marked_" + iRow] || "on" == ajax_error_count["rujukan_" + iRow] || "on" == ajax_error_count["id_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_nama_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_kategori_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_subname_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_hasil_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_satuan_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_marked_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_rujukan_" + iRow).addClass("scFormErrorLine");
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["nama_" + iRow] && "off" == ajax_error_count["kategori_" + iRow] && "off" == ajax_error_count["subname_" + iRow] && "off" == ajax_error_count["hasil_" + iRow] && "off" == ajax_error_count["satuan_" + iRow] && "off" == ajax_error_count["marked_" + iRow] && "off" == ajax_error_count["rujukan_" + iRow] && "off" == ajax_error_count["id_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["nama_" + iRow] = "off";
        ajax_error_count["kategori_" + iRow] = "off";
        ajax_error_count["subname_" + iRow] = "off";
        ajax_error_count["hasil_" + iRow] = "off";
        ajax_error_count["satuan_" + iRow] = "off";
        ajax_error_count["marked_" + iRow] = "off";
        ajax_error_count["rujukan_" + iRow] = "off";
      ...
      $("#hidden_field_data_nama_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_kategori_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_subname_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_hasil_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_satuan_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_marked_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_rujukan_" + iRow).removeClass("scFormErrorLine");
