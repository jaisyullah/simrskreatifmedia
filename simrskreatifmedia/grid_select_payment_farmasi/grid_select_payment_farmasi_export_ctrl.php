<?php
@session_start() ;
$_SESSION['scriptcase']['grid_select_payment_farmasi']['sc_process_barr'] = true;
require_once('../grid_select_payment_farmasi/index.php');
unset($_SESSION['scriptcase']['grid_select_payment_farmasi']['sc_process_barr']);
$ExportCtrl = new grid_select_payment_farmasi_export_control;
$ExportCtrl->Export_barr();

class grid_select_payment_farmasi_export_control
{
