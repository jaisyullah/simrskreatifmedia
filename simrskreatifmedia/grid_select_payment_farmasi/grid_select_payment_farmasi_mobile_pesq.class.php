...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      ...
      <br><span id="id_hide_sc_field_0"  <?php echo $str_hide_sc_field_0?>><INPUT  type="text" id="SC_sc_field_0" name="sc_field_0" value="<?php echo NM_encode_input($sc_field_0) ?>"  size=10 alt="{datatype: 'text', maxLength: 20, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
