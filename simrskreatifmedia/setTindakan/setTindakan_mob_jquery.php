...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_id' + iSeqRow).bind('blur', function() { sc_setTindakan_id_onblur(this, iSeqRow) })
                                .bind('focus', function() { sc_setTindakan_id_onfocus(this, iSeqRow) });
  $('#id_sc_field_sc_field_0' + iSeqRow).bind('blur', function() { sc_setTindakan_sc_field_0_onblur(this, iSeqRow) })
                                        .bind('focus', function() { sc_setTindakan_sc_field_0_onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_setTindakan_id_onblur(oThis, iSeqRow) {
  do_ajax_setTindakan_mob_validate_id();
  scCssBlur(oThis);
}

function sc_setTindakan_id_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_setTindakan_sc_field_0_onblur(oThis, iSeqRow) {
  do_ajax_setTindakan_mob_validate_sc_field_0();
  scCssBlur(oThis);
}

function sc_setTindakan_sc_field_0_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function scHidePage(pageNo) {
	$("#id_setTindakan_mob_form" + pageNo).hide();
}
