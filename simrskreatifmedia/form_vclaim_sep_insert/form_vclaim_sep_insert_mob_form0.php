...
<HEAD>
 <TITLE><?php if ('novo' == $this->nmgp_opcao) { echo strip_tags("" . $this->Ini->Nm_lang['lang_othr_frmi_titl'] . ""); } else { echo strip_tags("Pembuatan SEP"); } ?></TITLE>
...
?>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert_mob']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_vclaim_sep_insert/form_vclaim_sep_insert_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_vclaim_sep_insert_mob_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_vclaim_sep_insert_mob_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert_mob']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert_mob']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert_mob']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
?>
<body class="scFormPage" style="<?php echo $remove_margin . $str_iframe_body; ?>">
<?php

if (isset($_SESSION['scriptcase']['form_vclaim_sep_insert']['error_buffer']) && '' != $_SESSION['scriptcase']['form_vclaim_sep_insert']['error_buffer'])
{
    echo $_SESSION['scriptcase']['form_vclaim_sep_insert']['error_buffer'];
}
...
<?php
 include_once("form_vclaim_sep_insert_mob_js0.php");
?>
<script type="text/javascript"> 
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_vclaim_sep_insert_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_vclaim_sep_insert_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert_mob']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert_mob']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert_mob']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert_mob']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert_mob']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<div class="scFormHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFormHeaderFont" style="float: left; text-transform: uppercase;"><?php if ($this->nmgp_opcao == "novo") { echo "" . $this->Ini->Nm_lang['lang_othr_frmi_titl'] . ""; } else { echo "Pembuatan SEP"; } ?></div>
...
<?php
  ...
  {
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert_mob']['where_filter']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert_mob']['empty_filter'] = true;
       }
  }
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_nokartu_line" id="hidden_field_data_nokartu" style="<?php echo $sStyleHidden_nokartu; ?>"> <span class="scFormLabelOddFormat css_nokartu_label"><span id="id_label_nokartu"><?php echo $this->nm_new_label['nokartu']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_nama_line" id="hidden_field_data_nama" style="<?php echo $sStyleHidden_nama; ?>"> <span class="scFormLabelOddFormat css_nama_label"><span id="id_label_nama"><?php echo $this->nm_new_label['nama']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_nik_line" id="hidden_field_data_nik" style="<?php echo $sStyleHidden_nik; ?>"> <span class="scFormLabelOddFormat css_nik_label"><span id="id_label_nik"><?php echo $this->nm_new_label['nik']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_keterangan_line" id="hidden_field_data_keterangan" style="<?php echo $sStyleHidden_keterangan; ?>"> <span class="scFormLabelOddFormat css_keterangan_label"><span id="id_label_keterangan"><?php echo $this->nm_new_label['keterangan']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_sex_line" id="hidden_field_data_sex" style="<?php echo $sStyleHidden_sex; ?>"> <span class="scFormLabelOddFormat css_sex_label"><span id="id_label_sex"><?php echo $this->nm_new_label['sex']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_umursaatpelayanan_line" id="hidden_field_data_umursaatpelayanan" style="<?php echo $sStyleHidden_umursaatpelayanan; ?>"> <span class="scFormLabelOddFormat css_umursaatpelayanan_label"><span id="id_label_umursaatpelayanan"><?php echo $this->nm_new_label['umursaatpelayanan']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_kodehakkelas_line" id="hidden_field_data_kodehakkelas" style="<?php echo $sStyleHidden_kodehakkelas; ?>"> <span class="scFormLabelOddFormat css_kodehakkelas_label"><span id="id_label_kodehakkelas"><?php echo $this->nm_new_label['kodehakkelas']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_keteranganhakkelas_line" id="hidden_field_data_keteranganhakkelas" style="<?php echo $sStyleHidden_keteranganhakkelas; ?>"> <span class="scFormLabelOddFormat css_keteranganhakkelas_label"><span id="id_label_keteranganhakkelas"><?php echo $this->nm_new_label['keteranganhakkelas']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_kodejenispeserta_line" id="hidden_field_data_kodejenispeserta" style="<?php echo $sStyleHidden_kodejenispeserta; ?>"> <span class="scFormLabelOddFormat css_kodejenispeserta_label"><span id="id_label_kodejenispeserta"><?php echo $this->nm_new_label['kodejenispeserta']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_keteranganjenispeserta_line" id="hidden_field_data_keteranganjenispeserta" style="<?php echo $sStyleHidden_keteranganjenispeserta; ?>"> <span class="scFormLabelOddFormat css_keteranganjenispeserta_label"><span id="id_label_keteranganjenispeserta"><?php echo $this->nm_new_label['keteranganjenispeserta']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_kdprovider_line" id="hidden_field_data_kdprovider" style="<?php echo $sStyleHidden_kdprovider; ?>"> <span class="scFormLabelOddFormat css_kdprovider_label"><span id="id_label_kdprovider"><?php echo $this->nm_new_label['kdprovider']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_nmprovider_line" id="hidden_field_data_nmprovider" style="<?php echo $sStyleHidden_nmprovider; ?>"> <span class="scFormLabelOddFormat css_nmprovider_label"><span id="id_label_nmprovider"><?php echo $this->nm_new_label['nmprovider']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_tglcetakkartu_line" id="hidden_field_data_tglcetakkartu" style="<?php echo $sStyleHidden_tglcetakkartu; ?>"> <span class="scFormLabelOddFormat css_tglcetakkartu_label"><span id="id_label_tglcetakkartu"><?php echo $this->nm_new_label['tglcetakkartu']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_tgltat_line" id="hidden_field_data_tgltat" style="<?php echo $sStyleHidden_tgltat; ?>"> <span class="scFormLabelOddFormat css_tgltat_label"><span id="id_label_tgltat"><?php echo $this->nm_new_label['tgltat']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_tgltmt_line" id="hidden_field_data_tgltmt" style="<?php echo $sStyleHidden_tgltmt; ?>"> <span class="scFormLabelOddFormat css_tgltmt_label"><span id="id_label_tgltmt"><?php echo $this->nm_new_label['tgltmt']; ?></span></span><br>
...
<?php $sStyleHidden_tgltmt_dumb = ('' == $sStyleHidden_tgltmt) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_tgltmt_dumb" style="<?php echo $sStyleHidden_tgltmt_dumb; ?>"></TD>
   </tr>
<?php $sc_hidden_no = 1; ?>
</TABLE></div><!-- bloco_f -->
   </td>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_ppkpelayanan_line" id="hidden_field_data_ppkpelayanan" style="<?php echo $sStyleHidden_ppkpelayanan; ?>"> <span class="scFormLabelOddFormat css_ppkpelayanan_label"><span id="id_label_ppkpelayanan"><?php echo $this->nm_new_label['ppkpelayanan']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_nmppkpelayanan_line" id="hidden_field_data_nmppkpelayanan" style="<?php echo $sStyleHidden_nmppkpelayanan; ?>"> <span class="scFormLabelOddFormat css_nmppkpelayanan_label"><span id="id_label_nmppkpelayanan"><?php echo $this->nm_new_label['nmppkpelayanan']; ?></span></span><br>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert_mob']['Lookup_jnspelayanan'][] = '1'; ?>
 <option  value="2" <?php  if ($this->jnspelayanan == "2") { echo " selected" ;} ?>>Rawat Jalan</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert_mob']['Lookup_jnspelayanan'][] = '2'; ?>
 </select></span>
</span><?php  }?>
 </TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_klsrawat_line" id="hidden_field_data_klsrawat" style="<?php echo $sStyleHidden_klsrawat; ?>"> <span class="scFormLabelOddFormat css_klsrawat_label"><span id="id_label_klsrawat"><?php echo $this->nm_new_label['klsrawat']; ?></span></span><br>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert_mob']['Lookup_klsrawat'][] = '1'; ?>
 <option  value="2" <?php  if ($this->klsrawat == "2") { echo " selected" ;} ?>>Kelas 2</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert_mob']['Lookup_klsrawat'][] = '2'; ?>
 <option  value="3" <?php  if ($this->klsrawat == "3") { echo " selected" ;} ?>>Kelas 3</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert_mob']['Lookup_klsrawat'][] = '3'; ?>
 </select></span>
</span><?php  }?>
 </TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_nomr_line" id="hidden_field_data_nomr" style="<?php echo $sStyleHidden_nomr; ?>"> <span class="scFormLabelOddFormat css_nomr_label"><span id="id_label_nomr"><?php echo $this->nm_new_label['nomr']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_asalrujukan_line" id="hidden_field_data_asalrujukan" style="<?php echo $sStyleHidden_asalrujukan; ?>"> <span class="scFormLabelOddFormat css_asalrujukan_label"><span id="id_label_asalrujukan"><?php echo $this->nm_new_label['asalrujukan']; ?></span></span><br>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert_mob']['Lookup_asalrujukan'][] = '1'; ?>
 <option  value="2" <?php  if ($this->asalrujukan == "2") { echo " selected" ;} ?>>Faskes 2</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert_mob']['Lookup_asalrujukan'][] = '2'; ?>
 </select></span>
</span><?php  }?>
 </TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_norujukan_line" id="hidden_field_data_norujukan" style="<?php echo $sStyleHidden_norujukan; ?>"> <span class="scFormLabelOddFormat css_norujukan_label"><span id="id_label_norujukan"><?php echo $this->nm_new_label['norujukan']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_ppkrujukan_line" id="hidden_field_data_ppkrujukan" style="<?php echo $sStyleHidden_ppkrujukan; ?>"> <span class="scFormLabelOddFormat css_ppkrujukan_label"><span id="id_label_ppkrujukan"><?php echo $this->nm_new_label['ppkrujukan']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_nmppkrujukan_line" id="hidden_field_data_nmppkrujukan" style="<?php echo $sStyleHidden_nmppkrujukan; ?>"> <span class="scFormLabelOddFormat css_nmppkrujukan_label"><span id="id_label_nmppkrujukan"><?php echo $this->nm_new_label['nmppkrujukan']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_diagawal_line" id="hidden_field_data_diagawal" style="<?php echo $sStyleHidden_diagawal; ?>"> <span class="scFormLabelOddFormat css_diagawal_label"><span id="id_label_diagawal"><?php echo $this->nm_new_label['diagawal']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_nmdiagawal_line" id="hidden_field_data_nmdiagawal" style="<?php echo $sStyleHidden_nmdiagawal; ?>"> <span class="scFormLabelOddFormat css_nmdiagawal_label"><span id="id_label_nmdiagawal"><?php echo $this->nm_new_label['nmdiagawal']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_politujuan_line" id="hidden_field_data_politujuan" style="<?php echo $sStyleHidden_politujuan; ?>"> <span class="scFormLabelOddFormat css_politujuan_label"><span id="id_label_politujuan"><?php echo $this->nm_new_label['politujuan']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_nmpolitujuan_line" id="hidden_field_data_nmpolitujuan" style="<?php echo $sStyleHidden_nmpolitujuan; ?>"> <span class="scFormLabelOddFormat css_nmpolitujuan_label"><span id="id_label_nmpolitujuan"><?php echo $this->nm_new_label['nmpolitujuan']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_polieksekutif_line" id="hidden_field_data_polieksekutif" style="<?php echo $sStyleHidden_polieksekutif; ?>"> <span class="scFormLabelOddFormat css_polieksekutif_label"><span id="id_label_polieksekutif"><?php echo $this->nm_new_label['polieksekutif']; ?></span></span><br>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert_mob']['Lookup_polieksekutif'][] = '0'; ?>
 <option  value="1" <?php  if ($this->polieksekutif == "1") { echo " selected" ;} ?>>Ya</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert_mob']['Lookup_polieksekutif'][] = '1'; ?>
 </select></span>
</span><?php  }?>
 </TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_cob_line" id="hidden_field_data_cob" style="<?php echo $sStyleHidden_cob; ?>"> <span class="scFormLabelOddFormat css_cob_label"><span id="id_label_cob"><?php echo $this->nm_new_label['cob']; ?></span></span><br>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert_mob']['Lookup_cob'][] = '0'; ?>
 <option  value="1" <?php  if ($this->cob == "1") { echo " selected" ;} ?>>Ya</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert_mob']['Lookup_cob'][] = '1'; ?>
 </select></span>
</span><?php  }?>
 </TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_kejadianlakalantas_line" id="hidden_field_data_kejadianlakalantas" style="<?php echo $sStyleHidden_kejadianlakalantas; ?>"> <span class="scFormLabelOddFormat css_kejadianlakalantas_label"><span id="id_label_kejadianlakalantas"><?php echo $this->nm_new_label['kejadianlakalantas']; ?></span></span><br>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert_mob']['Lookup_kejadianlakalantas'][] = '0'; ?>
 <option  value="1" <?php  if ($this->kejadianlakalantas == "1") { echo " selected" ;} ?>>Ya</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert_mob']['Lookup_kejadianlakalantas'][] = '1'; ?>
 </select></span>
</span><?php  }?>
 </TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_penjaminlakalantas_line" id="hidden_field_data_penjaminlakalantas" style="<?php echo $sStyleHidden_penjaminlakalantas; ?>"> <span class="scFormLabelOddFormat css_penjaminlakalantas_label"><span id="id_label_penjaminlakalantas"><?php echo $this->nm_new_label['penjaminlakalantas']; ?></span></span><br>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert_mob']['Lookup_penjaminlakalantas'][] = '1'; ?>
 <option  value="2" <?php  if ($this->penjaminlakalantas == "2") { echo " selected" ;} ?>>BPJS KETENAGAKERJAAN</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert_mob']['Lookup_penjaminlakalantas'][] = '2'; ?>
 <option  value="3" <?php  if ($this->penjaminlakalantas == "3") { echo " selected" ;} ?>>TASPEN, PT</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert_mob']['Lookup_penjaminlakalantas'][] = '3'; ?>
 <option  value="4" <?php  if ($this->penjaminlakalantas == "4") { echo " selected" ;} ?>>ASABRI,PT</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert_mob']['Lookup_penjaminlakalantas'][] = '4'; ?>
 </select></span>
</span><?php  }?>
 </TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_lokasilakalantas_line" id="hidden_field_data_lokasilakalantas" style="<?php echo $sStyleHidden_lokasilakalantas; ?>"> <span class="scFormLabelOddFormat css_lokasilakalantas_label"><span id="id_label_lokasilakalantas"><?php echo $this->nm_new_label['lokasilakalantas']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_notelp_line" id="hidden_field_data_notelp" style="<?php echo $sStyleHidden_notelp; ?>"> <span class="scFormLabelOddFormat css_notelp_label"><span id="id_label_notelp"><?php echo $this->nm_new_label['notelp']; ?></span></span><br>
...
<?php
           if (($nm_apl_dependente != 1) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert_mob']['dashboard_info']['under_dashboard'])) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert_mob']['nm_run_menu']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert_mob']['nm_run_menu'] != 1))) {
...
<?php
           if (($nm_apl_dependente == 1) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert_mob']['dashboard_info']['under_dashboard']))) {
        $sCondStyle = ($this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert_mob']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert_mob']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_vclaim_sep_insert_mob");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_vclaim_sep_insert_mob");
 parent.scAjaxDetailHeight("form_vclaim_sep_insert_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert_mob']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
