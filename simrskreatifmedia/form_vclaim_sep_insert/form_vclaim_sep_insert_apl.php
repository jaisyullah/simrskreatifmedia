<?php
//
class form_vclaim_sep_insert_apl
{
...
//----- 
   function ini_controle()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['form_vclaim_sep_insert']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['form_vclaim_sep_insert']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_vclaim_sep_insert']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_vclaim_sep_insert']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_vclaim_sep_insert']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_vclaim_sep_insert']['sc_redir_insert'] = $this->sc_redir_insert;
          }
      } 
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_vclaim_sep_insert']['parms']))
      {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_vclaim_sep_insert']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_vclaim_sep_insert']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_vclaim_sep_insert']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_vclaim_sep_insert']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_vclaim_sep_insert']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_vclaim_sep_insert']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_vclaim_sep_insert']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_vclaim_sep_insert']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_vclaim_sep_insert_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("id");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['initialize'];
      } 
      else 
      { 
         $this->nm_data = new nm_data("id");
      } 
      $_SESSION['sc_session'][$script_case_init]['form_vclaim_sep_insert']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_vclaim_sep_insert']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_vclaim_sep_insert'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_vclaim_sep_insert']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_vclaim_sep_insert']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_vclaim_sep_insert') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_vclaim_sep_insert']['label'] = "Pembuatan SEP";
      ...
      $_SESSION['scriptcase']['error_icon']['form_vclaim_sep_insert']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Rhino__NM__nm_scriptcase9_Rhino_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_vclaim_sep_insert'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['embutida_call'] : $this->Embutida_call;

       $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_insert']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_insert']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_insert']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_insert']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_insert']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_insert']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_insert']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_insert']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_insert']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_insert']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_insert']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_insert']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_insert']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_vclaim_sep_insert']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_vclaim_sep_insert']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_insert']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_insert']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_insert']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_vclaim_sep_insert']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_vclaim_sep_insert']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_insert']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_insert']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_vclaim_sep_insert']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_vclaim_sep_insert']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_insert']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_insert']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_insert']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_insert']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_insert']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_insert']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_insert']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_insert']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_insert']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_insert']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_insert']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_insert']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_insert']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_insert']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_insert']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_insert']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_insert']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_insert']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_insert']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_insert']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_vclaim_sep_insert']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_vclaim_sep_insert']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_vclaim_sep_insert']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_insert']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_insert']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_insert']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_insert']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_insert']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_insert']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_insert']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_insert']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_insert']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_insert']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_insert']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_insert']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_insert']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_insert']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_insert']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_insert']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_insert']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_insert']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_insert']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_insert']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_insert']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_insert']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_insert']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_insert']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_insert']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_insert']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_insert']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_insert']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_insert']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_insert']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_insert']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_insert']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_insert']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_insert']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_insert']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_insert']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_insert']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_insert']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_insert']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_vclaim_sep_insert']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_vclaim_sep_insert'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_vclaim_sep_insert'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_vclaim_sep_insert']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['form_vclaim_sep_insert']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['form_vclaim_sep_insert']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['form_vclaim_sep_insert']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_vclaim_sep_insert']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['form_vclaim_sep_insert']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['form_vclaim_sep_insert']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_vclaim_sep_insert']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['form_vclaim_sep_insert']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['form_vclaim_sep_insert']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_vclaim_sep_insert']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_vclaim_sep_insert']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_vclaim_sep_insert']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_vclaim_sep_insert']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_vclaim_sep_insert']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_vclaim_sep_insert']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_vclaim_sep_insert']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_vclaim_sep_insert']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['form_vclaim_sep_insert']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['dados_form'];
      }
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("form_vclaim_sep_insert", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (isset($_GET['nm_cal_display']))
      {
          ...
          { 
              include_once($this->Ini->path_embutida . 'form_vclaim_sep_insert/form_vclaim_sep_insert_calendar.php');
          }
          else
          { 
              include_once($this->Ini->path_aplicacao . 'form_vclaim_sep_insert_calendar.php');
          }
          exit;
      }

      if (is_file($this->Ini->path_aplicacao . 'form_vclaim_sep_insert_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_vclaim_sep_insert_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      if ($this->Embutida_proc)
      { 
          require_once($this->Ini->path_embutida . 'form_vclaim_sep_insert/form_vclaim_sep_insert_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_vclaim_sep_insert_erro.class.php"); 
      }
      $this->Erro      = new form_vclaim_sep_insert_erro();
      $this->Erro->Ini = $this->Ini;
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_vclaim_sep_insert']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_vclaim_sep_insert']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_vclaim_sep_insert']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['opc_ant'];
      } 
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['final'];
      }
      else
      {
      }
...
//
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['dados_select'];
     }
   }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
      ...
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "recarga_mobile" || $this->nmgp_opcao == "muda_form") 
      {
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['dados_select']['user']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->user = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['dados_select']['user'];
          } 
...
//
      if (!isset($nm_form_submit) && $this->nmgp_opcao != "nada")
      {
          ...
          $this->nmdiagawal = "" ;  
          $this->nmpolitujuan = "" ;  
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['dados_form']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['dados_form']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['dados_form'] as $NM_campo => $NM_valor)
              {
                  $$NM_campo = $NM_valor;
              }
          }
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['recarga'] = $this->nmgp_opcao;
      }
      if ($Campos_Crit != "" || !empty($Campos_Falta) || $this->Campos_Mens_erro != "" || $campos_erro != "" || !isset($this->bok) || $this->bok != "OK" || $this->nmgp_opcao == "recarga")
      {
          ...
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['campos']))
              { 
                  $nokartu = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['campos'][0]; 
                  $nama = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['campos'][1]; 
                  $nik = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['campos'][2]; 
                  $keterangan = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['campos'][3]; 
                  $sex = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['campos'][4]; 
                  $umursaatpelayanan = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['campos'][5]; 
                  $kodehakkelas = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['campos'][6]; 
                  $keteranganhakkelas = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['campos'][7]; 
                  $kodejenispeserta = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['campos'][8]; 
                  $keteranganjenispeserta = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['campos'][9]; 
                  $kdprovider = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['campos'][10]; 
                  $nmprovider = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['campos'][11]; 
                  $tglcetakkartu = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['campos'][12]; 
                  $tgltat = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['campos'][13]; 
                  $tgltmt = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['campos'][14]; 
                  $tglsep = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['campos'][15]; 
                  $ppkpelayanan = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['campos'][16]; 
                  $nmppkpelayanan = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['campos'][17]; 
                  $jnspelayanan = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['campos'][18]; 
                  $klsrawat = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['campos'][19]; 
                  $nomr = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['campos'][20]; 
                  $asalrujukan = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['campos'][21]; 
                  $norujukan = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['campos'][22]; 
                  $tglrujukan = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['campos'][23]; 
                  $ppkrujukan = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['campos'][24]; 
                  $nmppkrujukan = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['campos'][25]; 
                  $catatan = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['campos'][26]; 
                  $diagawal = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['campos'][27]; 
                  $nmdiagawal = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['campos'][28]; 
                  $politujuan = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['campos'][29]; 
                  $nmpolitujuan = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['campos'][30]; 
                  $polieksekutif = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['campos'][31]; 
                  $cob = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['campos'][32]; 
                  $kejadianlakalantas = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['campos'][33]; 
                  $penjaminlakalantas = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['campos'][34]; 
                  $lokasilakalantas = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['campos'][35]; 
                  $notelp = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['campos'][36]; 
                  $user = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['campos'][37]; 
              } 
          }
          $this->nm_gera_html();
          $this->NM_close_db(); 
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['campos'] = array(); 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['campos'][0] = $this->nokartu; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['campos'][1] = $this->nama; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['campos'][2] = $this->nik; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['campos'][3] = $this->keterangan; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['campos'][4] = $this->sex; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['campos'][5] = $this->umursaatpelayanan; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['campos'][6] = $this->kodehakkelas; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['campos'][7] = $this->keteranganhakkelas; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['campos'][8] = $this->kodejenispeserta; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['campos'][9] = $this->keteranganjenispeserta; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['campos'][10] = $this->kdprovider; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['campos'][11] = $this->nmprovider; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['campos'][12] = $this->tglcetakkartu; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['campos'][13] = $this->tgltat; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['campos'][14] = $this->tgltmt; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['campos'][15] = $this->tglsep; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['campos'][16] = $this->ppkpelayanan; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['campos'][17] = $this->nmppkpelayanan; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['campos'][18] = $this->jnspelayanan; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['campos'][19] = $this->klsrawat; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['campos'][20] = $this->nomr; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['campos'][21] = $this->asalrujukan; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['campos'][22] = $this->norujukan; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['campos'][23] = $this->tglrujukan; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['campos'][24] = $this->ppkrujukan; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['campos'][25] = $this->nmppkrujukan; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['campos'][26] = $this->catatan; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['campos'][27] = $this->diagawal; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['campos'][28] = $this->nmdiagawal; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['campos'][29] = $this->politujuan; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['campos'][30] = $this->nmpolitujuan; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['campos'][31] = $this->polieksekutif; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['campos'][32] = $this->cob; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['campos'][33] = $this->kejadianlakalantas; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['campos'][34] = $this->penjaminlakalantas; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['campos'][35] = $this->lokasilakalantas; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['campos'][36] = $this->notelp; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['campos'][37] = $this->user; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['redir'] == "redir")
          {
          ...
          {
              $contr_menu = "";
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['iframe_menu'])
              {
                  $contr_menu = "glo_menu";
              }
              if (isset($_SESSION['scriptcase']['sc_ult_apl_menu']) && in_array("form_vclaim_sep_insert", $_SESSION['scriptcase']['sc_ult_apl_menu']))
              {
                  $this->NM_close_db(); 
                  $this->nmgp_redireciona_form("form_vclaim_sep_insert_fim.php", $this->nm_location, $contr_menu); 
              }
              else
              {
                  $this->nm_gera_html();
                  if (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['embutida_proc'])
                  { 
                      $this->NM_close_db(); 
                  } 
              }
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "form_vclaim_sep_insert.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert'][$path_doc_md5][1] = $Zip_name;
?>
...
<form name="Fdown" method="get" action="form_vclaim_sep_insert_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="form_vclaim_sep_insert"> 
...
//---------------------------------------------------------
     ...
     if ('' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_form_vclaim_sep_insert']) || !is_array($this->NM_ajax_info['errList']['geral_form_vclaim_sep_insert']))
              {
                  $this->NM_ajax_info['errList']['geral_form_vclaim_sep_insert'] = array();
              }
              $this->NM_ajax_info['errList']['geral_form_vclaim_sep_insert'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
...
//---
      ...
      if (empty($Campos_Crit) && empty($Campos_Falta) && empty($this->Campos_Mens_erro))
      {
          ...
          {
              $_SESSION['scriptcase']['form_vclaim_sep_insert']['contr_erro'] = 'on';
...
$_SESSION['scriptcase']['form_vclaim_sep_insert']['contr_erro'] = 'off'; 
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['dados_form'] = $this->nmgp_dados_form;
   }
...
$aLookup[] = array(form_vclaim_sep_insert_pack_protect_string('1') => form_vclaim_sep_insert_pack_protect_string("Rawat Inap"));
$aLookup[] = array(form_vclaim_sep_insert_pack_protect_string('2') => form_vclaim_sep_insert_pack_protect_string("Rawat Jalan"));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['Lookup_jnspelayanan'][] = '1';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['Lookup_jnspelayanan'][] = '2';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['jnspelayanan']['valList'][$i] = form_vclaim_sep_insert_pack_protect_string($v);
          }
...
$aLookup[] = array(form_vclaim_sep_insert_pack_protect_string('1') => form_vclaim_sep_insert_pack_protect_string("Kelas 1"));
$aLookup[] = array(form_vclaim_sep_insert_pack_protect_string('2') => form_vclaim_sep_insert_pack_protect_string("Kelas 2"));
$aLookup[] = array(form_vclaim_sep_insert_pack_protect_string('3') => form_vclaim_sep_insert_pack_protect_string("Kelas 3"));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['Lookup_klsrawat'][] = '1';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['Lookup_klsrawat'][] = '2';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['Lookup_klsrawat'][] = '3';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['klsrawat']['valList'][$i] = form_vclaim_sep_insert_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_vclaim_sep_insert_pack_protect_string('1') => form_vclaim_sep_insert_pack_protect_string("Faskes 1"));
$aLookup[] = array(form_vclaim_sep_insert_pack_protect_string('2') => form_vclaim_sep_insert_pack_protect_string("Faskes 2"));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['Lookup_asalrujukan'][] = '1';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['Lookup_asalrujukan'][] = '2';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['asalrujukan']['valList'][$i] = form_vclaim_sep_insert_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_vclaim_sep_insert_pack_protect_string('0') => form_vclaim_sep_insert_pack_protect_string("Tidak"));
$aLookup[] = array(form_vclaim_sep_insert_pack_protect_string('1') => form_vclaim_sep_insert_pack_protect_string("Ya"));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['Lookup_polieksekutif'][] = '0';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['Lookup_polieksekutif'][] = '1';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['polieksekutif']['valList'][$i] = form_vclaim_sep_insert_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_vclaim_sep_insert_pack_protect_string('0') => form_vclaim_sep_insert_pack_protect_string("Tidak"));
$aLookup[] = array(form_vclaim_sep_insert_pack_protect_string('1') => form_vclaim_sep_insert_pack_protect_string("Ya"));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['Lookup_cob'][] = '0';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['Lookup_cob'][] = '1';
          $aLookupOrig = $aLookup;
          $sSelComp = "name=\"cob\"";
          ...
          {
              $this->NM_ajax_info['fldList']['cob']['valList'][$i] = form_vclaim_sep_insert_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_vclaim_sep_insert_pack_protect_string('0') => form_vclaim_sep_insert_pack_protect_string("Tidak"));
$aLookup[] = array(form_vclaim_sep_insert_pack_protect_string('1') => form_vclaim_sep_insert_pack_protect_string("Ya"));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['Lookup_kejadianlakalantas'][] = '0';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['Lookup_kejadianlakalantas'][] = '1';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['kejadianlakalantas']['valList'][$i] = form_vclaim_sep_insert_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_vclaim_sep_insert_pack_protect_string('1') => form_vclaim_sep_insert_pack_protect_string("JASA RAHARJA"));
$aLookup[] = array(form_vclaim_sep_insert_pack_protect_string('2') => form_vclaim_sep_insert_pack_protect_string("BPJS KETENAGAKERJAAN"));
$aLookup[] = array(form_vclaim_sep_insert_pack_protect_string('3') => form_vclaim_sep_insert_pack_protect_string("TASPEN, PT"));
$aLookup[] = array(form_vclaim_sep_insert_pack_protect_string('4') => form_vclaim_sep_insert_pack_protect_string("ASABRI,PT"));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['Lookup_penjaminlakalantas'][] = '1';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['Lookup_penjaminlakalantas'][] = '2';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['Lookup_penjaminlakalantas'][] = '3';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['Lookup_penjaminlakalantas'][] = '4';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['penjaminlakalantas']['valList'][$i] = form_vclaim_sep_insert_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   function ajax_return_values_user($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
...
$_SESSION['scriptcase']['form_vclaim_sep_insert']['contr_erro'] = 'off'; 
    ...
    $this->nm_formatar_campos();
        $this->initFormPages();
    include_once("form_vclaim_sep_insert_form0.php");
        $this->hideFormPages();
 }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['table_refresh'])
        {
   ...
   function jqueryButtonText($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['csrf_token'];
    }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "form_vclaim_sep_insert_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_vclaim_sep_insert_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['masterValue']))
{
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['dashboard_info']['under_dashboard']) {
?>
var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['dashboard_info']['parent_widget']; ?>']");
if (dbParentFrame && dbParentFrame[0] && dbParentFrame[0].contentWindow.scAjaxDetailValue)
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['masterValue'] as $cmp_master => $val_master)
        {
?>
...
function nmgp_redireciona_form($nm_apl_dest, $nm_apl_retorno, $nm_apl_parms, $nm_target="", $opc="", $alt_modal=430, $larg_modal=630)
{
   ...
   if (is_array($nm_apl_parms))
   {
       ...
       foreach ($nm_apl_parms as $par => $val)
       {
           ...
           elseif (substr($val, 0, 1) == "[")
           {
               $tmp_parms .= $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert'][substr($val, 1, -1)];
           }
           else
           {
               $tmp_parms .= $val;
   ...
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['opcao'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_sep_insert']['retorno_edit'] = "";
   }
