...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_tglreq_hora' + iSeqRow).bind('blur', function() { sc_form_tbreqitem_tglreq_hora_onblur(this, iSeqRow) })
                                         .bind('focus', function() { sc_form_tbreqitem_tglreq_hora_onfocus(this, iSeqRow) });
...
function sc_form_tbreqitem_tglreq_hora_onblur(oThis, iSeqRow) {
  do_ajax_form_tbreqitem_validate_tglreq();
  scCssBlur(oThis);
}
...
function sc_form_tbreqitem_tglreq_hora_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function displayChange_field_detailreq(row, status) {
	if ("on" == status && typeof $("#nmsc_iframe_liga_form_tbdetailreqitem")[0].contentWindow.scRecreateSelect2 === "function") {
		$("#nmsc_iframe_liga_form_tbdetailreqitem")[0].contentWindow.scRecreateSelect2();
	}
}
...
function scHidePage(pageNo) {
	$("#id_form_tbreqitem_form" + pageNo).hide();
}
