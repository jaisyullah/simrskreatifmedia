  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbreqitem" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbreqitem_form();
	}

  // ---------- Validate kodereq
  function do_ajax_form_tbreqitem_validate_kodereq()
  {
    var nomeCampo_kodereq = "kodereq";
    var var_kodereq = scAjaxGetFieldText(nomeCampo_kodereq);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbreqitem_validate_kodereq(var_kodereq, var_script_case_init, do_ajax_form_tbreqitem_validate_kodereq_cb);
  } // do_ajax_form_tbreqitem_validate_kodereq

  function do_ajax_form_tbreqitem_validate_kodereq_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbreqitem_validate_kodereq_cb

  // ---------- Validate unit
  function do_ajax_form_tbreqitem_validate_unit()
  {
    var nomeCampo_unit = "unit";
    var var_unit = scAjaxGetFieldSelect(nomeCampo_unit);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbreqitem_validate_unit(var_unit, var_script_case_init, do_ajax_form_tbreqitem_validate_unit_cb);
  } // do_ajax_form_tbreqitem_validate_unit

  function do_ajax_form_tbreqitem_validate_unit_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "unit";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbreqitem_validate_unit_cb

  // ---------- Validate tglreq
  function do_ajax_form_tbreqitem_validate_tglreq()
  {
    var nomeCampo_tglreq = "tglreq";
    var var_tglreq = scAjaxGetFieldText(nomeCampo_tglreq);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbreqitem_validate_tglreq(var_tglreq, var_script_case_init, do_ajax_form_tbreqitem_validate_tglreq_cb);
  } // do_ajax_form_tbreqitem_validate_tglreq

  function do_ajax_form_tbreqitem_validate_tglreq_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tglreq";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbreqitem_validate_tglreq_cb

  // ---------- Validate selesai
  function do_ajax_form_tbreqitem_validate_selesai()
  {
    var nomeCampo_selesai = "selesai";
    var var_selesai = scAjaxGetFieldSelect(nomeCampo_selesai);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbreqitem_validate_selesai(var_selesai, var_script_case_init, do_ajax_form_tbreqitem_validate_selesai_cb);
  } // do_ajax_form_tbreqitem_validate_selesai

  function do_ajax_form_tbreqitem_validate_selesai_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "selesai";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbreqitem_validate_selesai_cb

  // ---------- Validate detailreq
  function do_ajax_form_tbreqitem_validate_detailreq()
  {
    var nomeCampo_detailreq = "detailreq";
    var var_detailreq = scAjaxGetFieldText(nomeCampo_detailreq);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbreqitem_validate_detailreq(var_detailreq, var_script_case_init, do_ajax_form_tbreqitem_validate_detailreq_cb);
  } // do_ajax_form_tbreqitem_validate_detailreq

  function do_ajax_form_tbreqitem_validate_detailreq_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbreqitem_validate_detailreq_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tbreqitem_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tbreqitem_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_tbreqitem_submit_form(var_kodereq, var_unit, var_tglreq, var_selesai, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbreqitem_submit_form_cb);
  } // do_ajax_form_tbreqitem_submit_form

  function do_ajax_form_tbreqitem_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tbreqitem_submit_form_cb_after_alert);
  } // do_ajax_form_tbreqitem_submit_form_cb
  function do_ajax_form_tbreqitem_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbreqitem_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_tbdetailreqitem"] = "off";

  function do_ajax_form_tbreqitem_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    scStatusDetail["form_tbdetailreqitem"] = "on";
    x_ajax_form_tbreqitem_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbreqitem_navigate_form_cb);
  } // do_ajax_form_tbreqitem_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreqitem']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbreqitem_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_tbdetailreqitem"] && "nmsc_iframe_liga_form_tbdetailreqitem" != scMasterDetailIframe["nmsc_iframe_liga_form_tbdetailreqitem"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_tbdetailreqitem"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_tbdetailreqitem').contentWindow.nm_move('apl_detalhe', true, '500');
        document.getElementById('nmsc_iframe_liga_form_tbdetailreqitem').style.height = "500";
        document.getElementById('nmsc_iframe_liga_form_tbdetailreqitem').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbreqitem_navigate_form_cb_after_alert);
  } // do_ajax_form_tbreqitem_navigate_form_cb
  function do_ajax_form_tbreqitem_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_tbreqitem_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_tbreqitem_navigate_form_cb_after_alert
  function sc_hide_form_tbreqitem_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_tbdetailreqitem"])
    {
      return true;
    }
    return false;
