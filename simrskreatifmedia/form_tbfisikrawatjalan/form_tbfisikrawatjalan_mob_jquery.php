...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_tglperiksa_hora' + iSeqRow).bind('blur', function() { sc_form_tbfisikrawatjalan_tglperiksa_onblur(this, iSeqRow) })
                                             .bind('focus', function() { sc_form_tbfisikrawatjalan_tglperiksa_onfocus(this, iSeqRow) });
} // scJQEventsAdd
...
function scHidePage(pageNo) {
	$("#id_form_tbfisikrawatjalan_mob_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_tglperiksa" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_tbfisikrawatjalan_mob_validate_tglperiksa(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
