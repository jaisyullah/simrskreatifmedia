  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbfisikrawatjalan" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbfisikrawatjalan_form();
	}

  // ---------- Validate tinggi
  function do_ajax_form_tbfisikrawatjalan_validate_tinggi()
  {
    var nomeCampo_tinggi = "tinggi";
    var var_tinggi = scAjaxGetFieldText(nomeCampo_tinggi);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbfisikrawatjalan_validate_tinggi(var_tinggi, var_script_case_init, do_ajax_form_tbfisikrawatjalan_validate_tinggi_cb);
  } // do_ajax_form_tbfisikrawatjalan_validate_tinggi

  function do_ajax_form_tbfisikrawatjalan_validate_tinggi_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbfisikrawatjalan_validate_tinggi_cb

  // ---------- Validate berat
  function do_ajax_form_tbfisikrawatjalan_validate_berat()
  {
    var nomeCampo_berat = "berat";
    var var_berat = scAjaxGetFieldText(nomeCampo_berat);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbfisikrawatjalan_validate_berat(var_berat, var_script_case_init, do_ajax_form_tbfisikrawatjalan_validate_berat_cb);
  } // do_ajax_form_tbfisikrawatjalan_validate_berat

  function do_ajax_form_tbfisikrawatjalan_validate_berat_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "berat";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbfisikrawatjalan_validate_berat_cb

  // ---------- Validate detakjantung
  function do_ajax_form_tbfisikrawatjalan_validate_detakjantung()
  {
    var nomeCampo_detakjantung = "detakjantung";
    var var_detakjantung = scAjaxGetFieldText(nomeCampo_detakjantung);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbfisikrawatjalan_validate_detakjantung(var_detakjantung, var_script_case_init, do_ajax_form_tbfisikrawatjalan_validate_detakjantung_cb);
  } // do_ajax_form_tbfisikrawatjalan_validate_detakjantung

  function do_ajax_form_tbfisikrawatjalan_validate_detakjantung_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbfisikrawatjalan_validate_detakjantung_cb

  // ---------- Validate tekanandarah
  function do_ajax_form_tbfisikrawatjalan_validate_tekanandarah()
  {
    var nomeCampo_tekanandarah = "tekanandarah";
    var var_tekanandarah = scAjaxGetFieldText(nomeCampo_tekanandarah);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbfisikrawatjalan_validate_tekanandarah(var_tekanandarah, var_script_case_init, do_ajax_form_tbfisikrawatjalan_validate_tekanandarah_cb);
  } // do_ajax_form_tbfisikrawatjalan_validate_tekanandarah

  function do_ajax_form_tbfisikrawatjalan_validate_tekanandarah_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbfisikrawatjalan_validate_tekanandarah_cb

  // ---------- Validate suhu
  function do_ajax_form_tbfisikrawatjalan_validate_suhu()
  {
    var nomeCampo_suhu = "suhu";
    var var_suhu = scAjaxGetFieldText(nomeCampo_suhu);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbfisikrawatjalan_validate_suhu(var_suhu, var_script_case_init, do_ajax_form_tbfisikrawatjalan_validate_suhu_cb);
  } // do_ajax_form_tbfisikrawatjalan_validate_suhu

  function do_ajax_form_tbfisikrawatjalan_validate_suhu_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "suhu";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbfisikrawatjalan_validate_suhu_cb

  // ---------- Validate nafas
  function do_ajax_form_tbfisikrawatjalan_validate_nafas()
  {
    var nomeCampo_nafas = "nafas";
    var var_nafas = scAjaxGetFieldText(nomeCampo_nafas);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbfisikrawatjalan_validate_nafas(var_nafas, var_script_case_init, do_ajax_form_tbfisikrawatjalan_validate_nafas_cb);
  } // do_ajax_form_tbfisikrawatjalan_validate_nafas

  function do_ajax_form_tbfisikrawatjalan_validate_nafas_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nafas";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbfisikrawatjalan_validate_nafas_cb

  // ---------- Validate keluhan
  function do_ajax_form_tbfisikrawatjalan_validate_keluhan()
  {
    var nomeCampo_keluhan = "keluhan";
    var var_keluhan = scAjaxGetFieldText(nomeCampo_keluhan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbfisikrawatjalan_validate_keluhan(var_keluhan, var_script_case_init, do_ajax_form_tbfisikrawatjalan_validate_keluhan_cb);
  } // do_ajax_form_tbfisikrawatjalan_validate_keluhan

  function do_ajax_form_tbfisikrawatjalan_validate_keluhan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "keluhan";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbfisikrawatjalan_validate_keluhan_cb

  // ---------- Validate pemeriksa
  function do_ajax_form_tbfisikrawatjalan_validate_pemeriksa()
  {
    var nomeCampo_pemeriksa = "pemeriksa";
    var var_pemeriksa = scAjaxGetFieldText(nomeCampo_pemeriksa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbfisikrawatjalan_validate_pemeriksa(var_pemeriksa, var_script_case_init, do_ajax_form_tbfisikrawatjalan_validate_pemeriksa_cb);
  } // do_ajax_form_tbfisikrawatjalan_validate_pemeriksa

  function do_ajax_form_tbfisikrawatjalan_validate_pemeriksa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbfisikrawatjalan_validate_pemeriksa_cb

  // ---------- Validate tglperiksa
  function do_ajax_form_tbfisikrawatjalan_validate_tglperiksa()
  {
    var nomeCampo_tglperiksa = "tglperiksa";
    var var_tglperiksa = scAjaxGetFieldText(nomeCampo_tglperiksa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbfisikrawatjalan_validate_tglperiksa(var_tglperiksa, var_script_case_init, do_ajax_form_tbfisikrawatjalan_validate_tglperiksa_cb);
  } // do_ajax_form_tbfisikrawatjalan_validate_tglperiksa

  function do_ajax_form_tbfisikrawatjalan_validate_tglperiksa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbfisikrawatjalan_validate_tglperiksa_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tbfisikrawatjalan_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tbfisikrawatjalan_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_tbfisikrawatjalan_submit_form(var_tinggi, var_berat, var_detakjantung, var_tekanandarah, var_suhu, var_nafas, var_keluhan, var_pemeriksa, var_tglperiksa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbfisikrawatjalan_submit_form_cb);
  } // do_ajax_form_tbfisikrawatjalan_submit_form

  function do_ajax_form_tbfisikrawatjalan_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tbfisikrawatjalan_submit_form_cb_after_alert);
  } // do_ajax_form_tbfisikrawatjalan_submit_form_cb
  function do_ajax_form_tbfisikrawatjalan_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbfisikrawatjalan_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tbfisikrawatjalan_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_tbfisikrawatjalan_navigate_form(var_trancode, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbfisikrawatjalan_navigate_form_cb);
  } // do_ajax_form_tbfisikrawatjalan_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbfisikrawatjalan']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbfisikrawatjalan_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbfisikrawatjalan_navigate_form_cb_after_alert);
  } // do_ajax_form_tbfisikrawatjalan_navigate_form_cb
  function do_ajax_form_tbfisikrawatjalan_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_tbfisikrawatjalan_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_tbfisikrawatjalan_navigate_form_cb_after_alert
  function sc_hide_form_tbfisikrawatjalan_form()
  {
