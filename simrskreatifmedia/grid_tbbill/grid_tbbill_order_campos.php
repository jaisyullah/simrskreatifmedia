...
<?php
   ...
   $Ord_Cmp = new grid_tbbill_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_tbbill_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbbill']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tbbill']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbbill']['labels']["id"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbbill']['labels']["id"] : "Id";
   $tab_ger_campos['trancode'] = "on";
   $tab_def_campos['trancode'] = "tranCode";
   $tab_labels["trancode"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbbill']['labels']["trancode"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbbill']['labels']["trancode"] : "Tran Code";
   $tab_ger_campos['keterangan'] = "on";
   $tab_def_campos['keterangan'] = "keterangan";
   $tab_labels["keterangan"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbbill']['labels']["keterangan"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbbill']['labels']["keterangan"] : "Keterangan";
   $tab_ger_campos['deposit'] = "on";
   $tab_def_campos['deposit'] = "deposit";
   $tab_labels["deposit"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbbill']['labels']["deposit"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbbill']['labels']["deposit"] : "Deposit";
   $tab_ger_campos['trandate'] = "on";
   $tab_def_campos['trandate'] = "tranDate";
   $tab_labels["trandate"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbbill']['labels']["trandate"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbbill']['labels']["trandate"] : "Tran Date";
   $tab_ger_campos['nostruk'] = "on";
   $tab_def_campos['nostruk'] = "noStruk";
   $tab_labels["nostruk"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbbill']['labels']["nostruk"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbbill']['labels']["nostruk"] : "No Struk";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_tbbill']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_tbbill']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_tbbill']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbbill']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tbbill']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_tbbill']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_tbbill']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_tbbill']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_tbbill']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_tbbill_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_tbbill']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_tbbill']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_tbbill']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_tbbill']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_tbbill']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
