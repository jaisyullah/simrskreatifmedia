...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "tranDate";$Nm_datas[] = "tranDate";$Nm_numeric[] = "id";$Nm_numeric[] = "deposit";$Nm_numeric[] = "nostruk";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_deposit_cond" name="deposit_cond" onChange="nm_campos_between(document.getElementById('id_vis_deposit'), this, 'deposit')">
      ...
      <br><span id="id_hide_deposit"  <?php echo $str_hide_deposit?>><?php
      if ($deposit != "")
      {
      $deposit_look = substr($this->Db->qstr($deposit), 1, -1); 
      $nmgp_def_dados = array(); 
