<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tbbill']['sc_process_barr'] = true;
require_once('../grid_tbbill/index.php');
unset($_SESSION['scriptcase']['grid_tbbill']['sc_process_barr']);
$ExportCtrl = new grid_tbbill_export_control;
$ExportCtrl->Export_barr();

class grid_tbbill_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - tbbill :: Excel</TITLE>
