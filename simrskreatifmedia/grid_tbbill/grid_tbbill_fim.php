...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_tbbill"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_tbbill"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_tbbill'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tbbill']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_tbbill']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tbbill']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_tbbill']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_tbbill']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_tbbill']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_tbbill']['embutida_filho'] as $ind => $sc_init)
          {
