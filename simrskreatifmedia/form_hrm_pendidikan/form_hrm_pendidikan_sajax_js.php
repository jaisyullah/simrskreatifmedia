  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_hrm_pendidikan" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_hrm_pendidikan_form();
	}

  // ---------- Validate level_
  function do_ajax_form_hrm_pendidikan_validate_level_(iNumLinha)
  {
    var nomeCampo_level_ = "level_" + iNumLinha;
    var var_level_ = scAjaxGetFieldSelect(nomeCampo_level_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_pendidikan_validate_level_(var_level_, iNumLinha, var_script_case_init, do_ajax_form_hrm_pendidikan_validate_level__cb);
  } // do_ajax_form_hrm_pendidikan_validate_level_

  function do_ajax_form_hrm_pendidikan_validate_level__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "level_" + iLineNumber;
    }
    else
    {
      sFieldValid = "level_";
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "level_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "level_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_pendidikan_validate_level__cb

  // ---------- Validate lembaga_
  function do_ajax_form_hrm_pendidikan_validate_lembaga_(iNumLinha)
  {
    var nomeCampo_lembaga_ = "lembaga_" + iNumLinha;
    var var_lembaga_ = scAjaxGetFieldText(nomeCampo_lembaga_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_pendidikan_validate_lembaga_(var_lembaga_, iNumLinha, var_script_case_init, do_ajax_form_hrm_pendidikan_validate_lembaga__cb);
  } // do_ajax_form_hrm_pendidikan_validate_lembaga_

  function do_ajax_form_hrm_pendidikan_validate_lembaga__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "lembaga_" + iLineNumber;
    }
    else
    {
      sFieldValid = "lembaga_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "lembaga_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "lembaga_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_pendidikan_validate_lembaga__cb

  // ---------- Validate tahun_lulus_
  function do_ajax_form_hrm_pendidikan_validate_tahun_lulus_(iNumLinha)
  {
    var nomeCampo_tahun_lulus_ = "tahun_lulus_" + iNumLinha;
    var var_tahun_lulus_ = scAjaxGetFieldText(nomeCampo_tahun_lulus_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_pendidikan_validate_tahun_lulus_(var_tahun_lulus_, iNumLinha, var_script_case_init, do_ajax_form_hrm_pendidikan_validate_tahun_lulus__cb);
  } // do_ajax_form_hrm_pendidikan_validate_tahun_lulus_

  function do_ajax_form_hrm_pendidikan_validate_tahun_lulus__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "tahun_lulus_" + iLineNumber;
    }
    else
    {
      sFieldValid = "tahun_lulus_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "tahun_lulus_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "tahun_lulus_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_pendidikan_validate_tahun_lulus__cb

  // ---------- Validate id_
  function do_ajax_form_hrm_pendidikan_validate_id_(iNumLinha)
  {
    var nomeCampo_id_ = "id_" + iNumLinha;
    var var_id_ = scAjaxGetFieldHidden(nomeCampo_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_pendidikan_validate_id_(var_id_, iNumLinha, var_script_case_init, do_ajax_form_hrm_pendidikan_validate_id__cb);
  } // do_ajax_form_hrm_pendidikan_validate_id_

  function do_ajax_form_hrm_pendidikan_validate_id__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_pendidikan_validate_id__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_hrm_pendidikan_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_hrm_pendidikan_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_hrm_pendidikan_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_hrm_pendidikan_add_new_line_cb);
  } // do_ajax_form_hrm_pendidikan_add_new_line

  function do_ajax_form_hrm_pendidikan_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_hrm_pendidikan_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_hrm_pendidikan_backup_line(iNumLinha)
  {
    var var_id_ = scAjaxGetFieldHidden("id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_pendidikan_backup_line(var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_hrm_pendidikan_backup_line_cb);
  } // do_ajax_form_hrm_pendidikan_backup_line

  function do_ajax_form_hrm_pendidikan_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_hrm_pendidikan_backup_line_cb

  function do_ajax_form_hrm_pendidikan_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_hrm_pendidikan_cancel_insert

  function do_ajax_form_hrm_pendidikan_cancel_update(iSeqVert)
  {
    do_ajax_form_hrm_pendidikan_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_hrm_pendidikan_cancel_update

  function do_ajax_form_hrm_pendidikan_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_hrm_pendidikan_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_hrm_pendidikan_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_hrm_pendidikan_table_refresh(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_hrm_pendidikan_table_refresh_cb);
  } //  do_ajax_form_hrm_pendidikan_table_refresh

  function do_ajax_form_hrm_pendidikan_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_hrm_pendidikan_table_refresh_cb_after_alert);
  } // do_ajax_form_hrm_pendidikan_table_refresh_cb
  function do_ajax_form_hrm_pendidikan_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_hrm_pendidikan_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_hrm_pendidikan_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_hrm_pendidikan_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    sc_num_ult_line = iNumLinha;
    sc_num_ult_tr   = indexTR;
    scAjaxHideMessage();
    var var_level_ = scAjaxGetFieldSelect("level_" + iNumLinha);
    var var_lembaga_ = scAjaxGetFieldText("lembaga_" + iNumLinha);
    var var_tahun_lulus_ = scAjaxGetFieldText("tahun_lulus_" + iNumLinha);
    var var_id_ = scAjaxGetFieldHidden("id_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_hrm_pendidikan_submit_form(var_level_, var_lembaga_, var_tahun_lulus_, var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_hrm_pendidikan_submit_form_cb);
  } // do_ajax_form_hrm_pendidikan_submit_form

  function do_ajax_form_hrm_pendidikan_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("level_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("lembaga_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("tahun_lulus_" + sc_num_ult_line);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_hrm_pendidikan_submit_form_cb_after_alert);
  } // do_ajax_form_hrm_pendidikan_submit_form_cb
  function do_ajax_form_hrm_pendidikan_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_hrm_pendidikan_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_hrm_pendidikan_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_hrm_pendidikan_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("level_" + iNavForm);
      scAjaxHideErrorDisplay("lembaga_" + iNavForm);
      scAjaxHideErrorDisplay("tahun_lulus_" + iNavForm);
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_hrm_pendidikan_navigate_form(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_hrm_pendidikan_navigate_form_cb);
  } // do_ajax_form_hrm_pendidikan_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_hrm_pendidikan']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_hrm_pendidikan_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_hrm_pendidikan_navigate_form_cb_after_alert);
  } // do_ajax_form_hrm_pendidikan_navigate_form_cb
  function do_ajax_form_hrm_pendidikan_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_hrm_pendidikan_navigate_form_cb_after_alert
  function sc_hide_form_hrm_pendidikan_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "level_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "lembaga_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "tahun_lulus_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "id_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["level_" + iNumLinha] = {"label": "Level<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["lembaga_" + iNumLinha] = {"label": "Lembaga<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["tahun_lulus_" + iNumLinha] = {"label": "Tahun Lulus<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_field_mult["level_"][iNumLinha] = "level_" + iNumLinha;
    ajax_field_mult["lembaga_"][iNumLinha] = "lembaga_" + iNumLinha;
    ajax_field_mult["tahun_lulus_"][iNumLinha] = "tahun_lulus_" + iNumLinha;
    ajax_field_mult["id_"][iNumLinha] = "id_" + iNumLinha;
    ajax_field_id["level_" + iNumLinha] = new Array("hidden_field_label_level_", "hidden_field_data_level_" + iNumLinha);
    ajax_field_id["lembaga_" + iNumLinha] = new Array("hidden_field_label_lembaga_", "hidden_field_data_lembaga_" + iNumLinha);
    ajax_field_id["tahun_lulus_" + iNumLinha] = new Array("hidden_field_label_tahun_lulus_", "hidden_field_data_tahun_lulus_" + iNumLinha);
    ajax_error_count["level_" + iNumLinha] = "off";
    ajax_error_count["lembaga_" + iNumLinha] = "off";
    ajax_error_count["tahun_lulus_" + iNumLinha] = "off";
    ajax_error_count["id_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["level_" + iNumLinha] = "off";
    ajax_read_only["lembaga_" + iNumLinha] = "off";
    ajax_read_only["tahun_lulus_" + iNumLinha] = "off";
...
{
?>
    ajax_read_only["level_" + iNumLinha] = "on";
    ajax_read_only["lembaga_" + iNumLinha] = "on";
    ajax_read_only["tahun_lulus_" + iNumLinha] = "on";
    ajax_read_only["id_" + iNumLinha] = "on";
<?php
}
?>
  ...
  {
    ajax_error_list["level_" + iNumLinha] = null;
    ajax_error_list["lembaga_" + iNumLinha] = null;
    ajax_error_list["tahun_lulus_" + iNumLinha] = null;
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["level_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["level_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["level_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["level_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["level_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["lembaga_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["lembaga_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["lembaga_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["lembaga_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["lembaga_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["tahun_lulus_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["tahun_lulus_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["tahun_lulus_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["tahun_lulus_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["tahun_lulus_" + iNumLinha]["onfocus"] = new Array();
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['level_'])) ? $this->nmgp_cmp_readonly['level_'] : 'off';
?>
    scAjaxFieldRead("level_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['lembaga_'])) ? $this->nmgp_cmp_readonly['lembaga_'] : 'off';
?>
    scAjaxFieldRead("lembaga_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['tahun_lulus_'])) ? $this->nmgp_cmp_readonly['tahun_lulus_'] : 'off';
?>
    scAjaxFieldRead("tahun_lulus_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
?>
  ...
  {
    scAjaxFieldRead("level_" + iSeq, "on");
    scAjaxFieldRead("lembaga_" + iSeq, "on");
    scAjaxFieldRead("tahun_lulus_" + iSeq, "on");
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["level_" + iRow] || "on" == ajax_error_count["lembaga_" + iRow] || "on" == ajax_error_count["tahun_lulus_" + iRow] || "on" == ajax_error_count["id_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_level_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_lembaga_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_tahun_lulus_" + iRow).addClass("scFormErrorLine");
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["level_" + iRow] && "off" == ajax_error_count["lembaga_" + iRow] && "off" == ajax_error_count["tahun_lulus_" + iRow] && "off" == ajax_error_count["id_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["level_" + iRow] = "off";
        ajax_error_count["lembaga_" + iRow] = "off";
        ajax_error_count["tahun_lulus_" + iRow] = "off";
      ...
      $("#hidden_field_data_level_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_lembaga_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_tahun_lulus_" + iRow).removeClass("scFormErrorLine");
