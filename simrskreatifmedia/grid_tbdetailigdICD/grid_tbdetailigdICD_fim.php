...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_tbdetailigdICD"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_tbdetailigdICD"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tbdetailigdICD']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_tbdetailigdICD']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tbdetailigdICD']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_tbdetailigdICD']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_tbdetailigdICD']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_tbdetailigdICD</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_tbdetailigdICD']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_tbdetailigdICD']['embutida_filho'] as $ind => $sc_init)
          {
