...
<?php
   ...
   $Ord_Cmp = new grid_tbdetailigdICD_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_tbdetailigdICD_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbdetailigdICD']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tbdetailigdICD']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["trancode"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbdetailigdICD']['labels']["trancode"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbdetailigdICD']['labels']["trancode"] : "Kode Transaksi";
   $tab_ger_campos['custcode'] = "on";
   $tab_def_campos['custcode'] = "custCode";
   $tab_labels["custcode"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbdetailigdICD']['labels']["custcode"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbdetailigdICD']['labels']["custcode"] : "Nama Pasien";
...
ORDER BY name, salut";
   ...
   $tab_labels["pasien"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbdetailigdICD']['labels']["pasien"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbdetailigdICD']['labels']["pasien"] : "Pasien";
   $tab_ger_campos['diagnosa1'] = "on";
   $tab_def_campos['diagnosa1'] = "diagnosa1";
   $tab_labels["diagnosa1"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbdetailigdICD']['labels']["diagnosa1"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbdetailigdICD']['labels']["diagnosa1"] : "Diagnosa 1";
   $tab_ger_campos['icd1'] = "on";
   $tab_def_campos['icd1'] = "icd1";
   $tab_labels["icd1"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbdetailigdICD']['labels']["icd1"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbdetailigdICD']['labels']["icd1"] : "ICD 1";
   $tab_ger_campos['diagnosa2'] = "on";
   $tab_def_campos['diagnosa2'] = "diagnosa2";
   $tab_labels["diagnosa2"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbdetailigdICD']['labels']["diagnosa2"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbdetailigdICD']['labels']["diagnosa2"] : "Diagnosa 2";
   $tab_ger_campos['icd2'] = "on";
   $tab_def_campos['icd2'] = "icd2";
   $tab_labels["icd2"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbdetailigdICD']['labels']["icd2"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbdetailigdICD']['labels']["icd2"] : "ICD 2";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_tbdetailigdICD']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_tbdetailigdICD']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_tbdetailigdICD']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbdetailigdICD']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tbdetailigdICD']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_tbdetailigdICD']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_tbdetailigdICD']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_tbdetailigdICD']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_tbdetailigdICD']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_tbdetailigdICD_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_tbdetailigdICD']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_tbdetailigdICD']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_tbdetailigdICD']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_tbdetailigdICD']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_tbdetailigdICD']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
