<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tbdetailigdICD']['sc_process_barr'] = true;
require_once('../grid_tbdetailigdICD/index.php');
unset($_SESSION['scriptcase']['grid_tbdetailigdICD']['sc_process_barr']);
$ExportCtrl = new grid_tbdetailigdICD_export_control;
$ExportCtrl->Export_barr();

class grid_tbdetailigdICD_export_control
{
