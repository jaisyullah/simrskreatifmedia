<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_tbdetailrawatjalan_old']['glo_nm_path_imag_temp'] . "/sc_apl_default_simrskreatifmedia.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_tbdetailrawatjalan_old_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_tbdetailrawatjalan_old_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatjalan_old']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatjalan_old']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["trancode"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatjalan_old']['labels']["trancode"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatjalan_old']['labels']["trancode"] : "Kode Transaksi";
   ...
   $tab_labels["custcode"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatjalan_old']['labels']["custcode"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatjalan_old']['labels']["custcode"] : "No RM";
...
ORDER BY name, salut";
   ...
   $tab_labels["sc_field_0"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatjalan_old']['labels']["sc_field_0"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatjalan_old']['labels']["sc_field_0"] : "Nama Pasien";
   ...
   $tab_labels["dokter"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatjalan_old']['labels']["dokter"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatjalan_old']['labels']["dokter"] : "Dokter";
   ...
   $tab_labels["selesai"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatjalan_old']['labels']["selesai"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatjalan_old']['labels']["selesai"] : "Selesai";
   ...
   $tab_labels["tglkeluar"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatjalan_old']['labels']["tglkeluar"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatjalan_old']['labels']["tglkeluar"] : "Tgl Keluar";
   ...
   $tab_labels["diagnosa1"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatjalan_old']['labels']["diagnosa1"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatjalan_old']['labels']["diagnosa1"] : "Diagnosa";
   ...
   $tab_labels["icd1"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatjalan_old']['labels']["icd1"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatjalan_old']['labels']["icd1"] : "Kode ICD";
   ...
   $tab_labels["nostruk"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatjalan_old']['labels']["nostruk"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatjalan_old']['labels']["nostruk"] : "No Struk";
   ...
   $tab_labels["statuspasien"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatjalan_old']['labels']["statuspasien"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatjalan_old']['labels']["statuspasien"] : "Status Pasien";
   ...
   $tab_labels["jenis"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatjalan_old']['labels']["jenis"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatjalan_old']['labels']["jenis"] : "Jenis";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatjalan_old']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatjalan_old']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatjalan_old']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatjalan_old']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatjalan_old']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatjalan_old']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatjalan_old']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatjalan_old']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatjalan_old']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_tbdetailrawatjalan_old_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatjalan_old']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatjalan_old']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatjalan_old']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatjalan_old']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_tbdetailrawatjalan_old']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
