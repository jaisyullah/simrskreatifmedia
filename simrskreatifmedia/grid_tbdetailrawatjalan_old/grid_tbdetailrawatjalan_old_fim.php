...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_tbdetailrawatjalan_old"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_tbdetailrawatjalan_old"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tbdetailrawatjalan_old']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_tbdetailrawatjalan_old']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tbdetailrawatjalan_old']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_tbdetailrawatjalan_old']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_tbdetailrawatjalan_old']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_tbdetailrawatjalan_old</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_tbdetailrawatjalan_old']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_tbdetailrawatjalan_old']['embutida_filho'] as $ind => $sc_init)
          {
