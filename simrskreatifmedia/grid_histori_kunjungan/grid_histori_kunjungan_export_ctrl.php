<?php
@session_start() ;
$_SESSION['scriptcase']['grid_histori_kunjungan']['sc_process_barr'] = true;
require_once('../grid_histori_kunjungan/index.php');
unset($_SESSION['scriptcase']['grid_histori_kunjungan']['sc_process_barr']);
$ExportCtrl = new grid_histori_kunjungan_export_control;
$ExportCtrl->Export_barr();

class grid_histori_kunjungan_export_control
{
