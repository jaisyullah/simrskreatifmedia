<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_histori_kunjungan']['glo_nm_path_imag_temp'] . "/sc_apl_default_simrskreatifmedia.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_histori_kunjungan_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_histori_kunjungan_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_histori_kunjungan']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_histori_kunjungan']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["custcode"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_histori_kunjungan']['labels']["custcode"])) ? $_SESSION['sc_session'][$sc_init]['grid_histori_kunjungan']['labels']["custcode"] : "No. RM";
   $tab_ger_campos['poly'] = "on";
   $tab_def_campos['poly'] = "poly";
   $tab_labels["poly"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_histori_kunjungan']['labels']["poly"])) ? $_SESSION['sc_session'][$sc_init]['grid_histori_kunjungan']['labels']["poly"] : "Poli";
...
ORDER BY name, salut";
   ...
   $tab_labels["sc_field_0"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_histori_kunjungan']['labels']["sc_field_0"])) ? $_SESSION['sc_session'][$sc_init]['grid_histori_kunjungan']['labels']["sc_field_0"] : "Nama Pasien";
...
ORDER BY phone, hp";
   ...
   $tab_labels["phone"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_histori_kunjungan']['labels']["phone"])) ? $_SESSION['sc_session'][$sc_init]['grid_histori_kunjungan']['labels']["phone"] : "No Telp/HP";
   $tab_ger_campos['doctor'] = "on";
   $tab_def_campos['doctor'] = "doctor";
   $tab_labels["doctor"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_histori_kunjungan']['labels']["doctor"])) ? $_SESSION['sc_session'][$sc_init]['grid_histori_kunjungan']['labels']["doctor"] : "Dokter";
   $tab_ger_campos['queue'] = "on";
   $tab_def_campos['queue'] = "queue";
   $tab_labels["queue"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_histori_kunjungan']['labels']["queue"])) ? $_SESSION['sc_session'][$sc_init]['grid_histori_kunjungan']['labels']["queue"] : "Antrian";
   $tab_ger_campos['regdate'] = "on";
   $tab_def_campos['regdate'] = "regDate";
   $tab_labels["regdate"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_histori_kunjungan']['labels']["regdate"])) ? $_SESSION['sc_session'][$sc_init]['grid_histori_kunjungan']['labels']["regdate"] : "Tgl Daftar";
   $tab_ger_campos['regtime'] = "on";
   $tab_def_campos['regtime'] = "regTime";
   $tab_labels["regtime"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_histori_kunjungan']['labels']["regtime"])) ? $_SESSION['sc_session'][$sc_init]['grid_histori_kunjungan']['labels']["regtime"] : "Waktu Daftar";
   $tab_ger_campos['handled'] = "on";
   $tab_def_campos['handled'] = "handled";
   $tab_labels["handled"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_histori_kunjungan']['labels']["handled"])) ? $_SESSION['sc_session'][$sc_init]['grid_histori_kunjungan']['labels']["handled"] : "Selesai";
   $tab_ger_campos['struckno'] = "on";
   $tab_def_campos['struckno'] = "struckNo";
   $tab_labels["struckno"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_histori_kunjungan']['labels']["struckno"])) ? $_SESSION['sc_session'][$sc_init]['grid_histori_kunjungan']['labels']["struckno"] : "No Struk";
   $tab_ger_campos['status'] = "on";
   $tab_def_campos['status'] = "status";
   $tab_labels["status"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_histori_kunjungan']['labels']["status"])) ? $_SESSION['sc_session'][$sc_init]['grid_histori_kunjungan']['labels']["status"] : "Status";
   $tab_ger_campos['inst'] = "on";
   $tab_def_campos['inst'] = "inst";
   $tab_labels["inst"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_histori_kunjungan']['labels']["inst"])) ? $_SESSION['sc_session'][$sc_init]['grid_histori_kunjungan']['labels']["inst"] : "Penanggung";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_histori_kunjungan']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_histori_kunjungan']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_histori_kunjungan']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_histori_kunjungan']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_histori_kunjungan']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_histori_kunjungan']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_histori_kunjungan']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_histori_kunjungan']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_histori_kunjungan']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_histori_kunjungan_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_histori_kunjungan']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_histori_kunjungan']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_histori_kunjungan']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_histori_kunjungan']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_histori_kunjungan']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
