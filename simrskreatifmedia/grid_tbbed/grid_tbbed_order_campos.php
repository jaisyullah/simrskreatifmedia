...
<?php
   ...
   $Ord_Cmp = new grid_tbbed_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_tbbed_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbbed']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tbbed']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["idbed"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbbed']['labels']["idbed"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbbed']['labels']["idbed"] : "Id Bed";
   $tab_ger_campos['kelas'] = "on";
   $tab_def_campos['kelas'] = "kelas";
   $tab_labels["kelas"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbbed']['labels']["kelas"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbbed']['labels']["kelas"] : "Kelas";
   $tab_ger_campos['ruang'] = "on";
   $tab_def_campos['ruang'] = "ruang";
   $tab_labels["ruang"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbbed']['labels']["ruang"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbbed']['labels']["ruang"] : "Ruang";
   $tab_ger_campos['nobed'] = "on";
   $tab_def_campos['nobed'] = "noBed";
   $tab_labels["nobed"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbbed']['labels']["nobed"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbbed']['labels']["nobed"] : "No Bed";
   $tab_ger_campos['custcode'] = "on";
   $tab_def_campos['custcode'] = "custCode";
   $tab_labels["custcode"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbbed']['labels']["custcode"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbbed']['labels']["custcode"] : "Cust Code";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_tbbed']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_tbbed']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_tbbed']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbbed']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tbbed']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_tbbed']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_tbbed']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_tbbed']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_tbbed']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_tbbed_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_tbbed']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_tbbed']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_tbbed']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_tbbed']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_tbbed']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
