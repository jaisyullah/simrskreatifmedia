...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "idbed";$Nm_numeric[] = "nobed";$Nm_numeric[] = "idbed";$Nm_numeric[] = "nobed";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_idbed_cond" name="idbed_cond" onChange="nm_campos_between(document.getElementById('id_vis_idbed'), this, 'idbed')">
      ...
      <br><span id="id_hide_idbed"  <?php echo $str_hide_idbed?>><?php
      if ($idbed != "")
      {
      $idbed_look = substr($this->Db->qstr($idbed), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_nobed_cond" name="nobed_cond" onChange="nm_campos_between(document.getElementById('id_vis_nobed'), this, 'nobed')">
      ...
      <br><span id="id_hide_nobed"  <?php echo $str_hide_nobed?>><?php
      if ($nobed != "")
      {
      $nobed_look = substr($this->Db->qstr($nobed), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_ruang_cond" name="ruang_cond" onChange="nm_campos_between(document.getElementById('id_vis_ruang'), this, 'ruang')">
      ...
      <br><span id="id_hide_ruang"  <?php echo $str_hide_ruang?>><?php
      if ($ruang != "")
      {
      $ruang_look = substr($this->Db->qstr($ruang), 1, -1); 
      $nmgp_def_dados = array(); 
