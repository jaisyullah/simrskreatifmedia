  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbrujukanradiologi" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbrujukanradiologi_form();
	}

  // ---------- Validate radcode_
  function do_ajax_form_tbrujukanradiologi_validate_radcode_(iNumLinha)
  {
  } // do_ajax_form_tbrujukanradiologi_validate_radcode_

  function do_ajax_form_tbrujukanradiologi_validate_radcode__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "radcode_" + iLineNumber;
    }
    else
    {
      sFieldValid = "radcode_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "radcode_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "radcode_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbrujukanradiologi_validate_radcode__cb

  // ---------- Validate desc_
  function do_ajax_form_tbrujukanradiologi_validate_desc_(iNumLinha)
  {
    var nomeCampo_desc_ = "desc_" + iNumLinha;
    var var_desc_ = scAjaxGetFieldText(nomeCampo_desc_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbrujukanradiologi_validate_desc_(var_desc_, iNumLinha, var_script_case_init, do_ajax_form_tbrujukanradiologi_validate_desc__cb);
  } // do_ajax_form_tbrujukanradiologi_validate_desc_

  function do_ajax_form_tbrujukanradiologi_validate_desc__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbrujukanradiologi_validate_desc__cb

  // ---------- Validate doccode_
  function do_ajax_form_tbrujukanradiologi_validate_doccode_(iNumLinha)
  {
    var nomeCampo_doccode_ = "doccode_" + iNumLinha;
    var var_doccode_ = scAjaxGetFieldSelect(nomeCampo_doccode_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbrujukanradiologi_validate_doccode_(var_doccode_, iNumLinha, var_script_case_init, do_ajax_form_tbrujukanradiologi_validate_doccode__cb);
  } // do_ajax_form_tbrujukanradiologi_validate_doccode_

  function do_ajax_form_tbrujukanradiologi_validate_doccode__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "doccode_" + iLineNumber;
    }
    else
    {
      sFieldValid = "doccode_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "doccode_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "doccode_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbrujukanradiologi_validate_doccode__cb

  // ---------- Validate trandate_
  function do_ajax_form_tbrujukanradiologi_validate_trandate_(iNumLinha)
  {
    var nomeCampo_trandate_ = "trandate_" + iNumLinha;
    var var_trandate_ = scAjaxGetFieldText(nomeCampo_trandate_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbrujukanradiologi_validate_trandate_(var_trandate_, iNumLinha, var_script_case_init, do_ajax_form_tbrujukanradiologi_validate_trandate__cb);
  } // do_ajax_form_tbrujukanradiologi_validate_trandate_

  function do_ajax_form_tbrujukanradiologi_validate_trandate__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbrujukanradiologi_validate_trandate__cb

  // ---------- Validate id_
  function do_ajax_form_tbrujukanradiologi_validate_id_(iNumLinha)
  {
    var nomeCampo_id_ = "id_" + iNumLinha;
    var var_id_ = scAjaxGetFieldHidden(nomeCampo_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbrujukanradiologi_validate_id_(var_id_, iNumLinha, var_script_case_init, do_ajax_form_tbrujukanradiologi_validate_id__cb);
  } // do_ajax_form_tbrujukanradiologi_validate_id_

  function do_ajax_form_tbrujukanradiologi_validate_id__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbrujukanradiologi_validate_id__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_tbrujukanradiologi_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_tbrujukanradiologi_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tbrujukanradiologi_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_tbrujukanradiologi_add_new_line_cb);
  } // do_ajax_form_tbrujukanradiologi_add_new_line

  function do_ajax_form_tbrujukanradiologi_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_tbrujukanradiologi_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_tbrujukanradiologi_backup_line(iNumLinha)
  {
    var var_id_ = scAjaxGetFieldHidden("id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbrujukanradiologi_backup_line(var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_tbrujukanradiologi_backup_line_cb);
  } // do_ajax_form_tbrujukanradiologi_backup_line

  function do_ajax_form_tbrujukanradiologi_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_tbrujukanradiologi_backup_line_cb

  function do_ajax_form_tbrujukanradiologi_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_tbrujukanradiologi_cancel_insert

  function do_ajax_form_tbrujukanradiologi_cancel_update(iSeqVert)
  {
    do_ajax_form_tbrujukanradiologi_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_tbrujukanradiologi_cancel_update

  function do_ajax_form_tbrujukanradiologi_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_tbrujukanradiologi_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_tbrujukanradiologi_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_tbrujukanradiologi_table_refresh(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbrujukanradiologi_table_refresh_cb);
  } //  do_ajax_form_tbrujukanradiologi_table_refresh

  function do_ajax_form_tbrujukanradiologi_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_tbrujukanradiologi_table_refresh_cb_after_alert);
  } // do_ajax_form_tbrujukanradiologi_table_refresh_cb
  function do_ajax_form_tbrujukanradiologi_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_tbrujukanradiologi_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_tbrujukanradiologi_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_tbrujukanradiologi_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    var var_doccode_ = scAjaxGetFieldSelect("doccode_" + iNumLinha);
...
?>
    x_ajax_form_tbrujukanradiologi_submit_form(var_radcode_, var_desc_, var_doccode_, var_trandate_, var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbrujukanradiologi_submit_form_cb);
  } // do_ajax_form_tbrujukanradiologi_submit_form

  function do_ajax_form_tbrujukanradiologi_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("radcode_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("desc_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("doccode_" + sc_num_ult_line);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_tbrujukanradiologi_submit_form_cb_after_alert);
  } // do_ajax_form_tbrujukanradiologi_submit_form_cb
  function do_ajax_form_tbrujukanradiologi_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbrujukanradiologi_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tbrujukanradiologi_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_tbrujukanradiologi_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("radcode_" + iNavForm);
      scAjaxHideErrorDisplay("desc_" + iNavForm);
      scAjaxHideErrorDisplay("doccode_" + iNavForm);
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tbrujukanradiologi_navigate_form(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbrujukanradiologi_navigate_form_cb);
  } // do_ajax_form_tbrujukanradiologi_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbrujukanradiologi']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbrujukanradiologi_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbrujukanradiologi_navigate_form_cb_after_alert);
  } // do_ajax_form_tbrujukanradiologi_navigate_form_cb
  function do_ajax_form_tbrujukanradiologi_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_tbrujukanradiologi_navigate_form_cb_after_alert
  function sc_hide_form_tbrujukanradiologi_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "radcode_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "desc_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "doccode_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "trandate_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "id_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["radcode_" + iNumLinha] = {"label": "Nama Pemeriksaan<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["desc_" + iNumLinha] = {"label": "Keterangan<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["doccode_" + iNumLinha] = {"label": "Dokter Perujuk<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_field_mult["radcode_"][iNumLinha] = "radcode_" + iNumLinha;
    ajax_field_mult["desc_"][iNumLinha] = "desc_" + iNumLinha;
    ajax_field_mult["doccode_"][iNumLinha] = "doccode_" + iNumLinha;
    ajax_field_mult["trandate_"][iNumLinha] = "trandate_" + iNumLinha;
    ajax_field_mult["id_"][iNumLinha] = "id_" + iNumLinha;
    ajax_field_id["radcode_" + iNumLinha] = new Array("hidden_field_label_radcode_", "hidden_field_data_radcode_" + iNumLinha);
    ajax_field_id["desc_" + iNumLinha] = new Array("hidden_field_label_desc_", "hidden_field_data_desc_" + iNumLinha);
    ajax_field_id["doccode_" + iNumLinha] = new Array("hidden_field_label_doccode_", "hidden_field_data_doccode_" + iNumLinha);
    ajax_field_id["trandate_" + iNumLinha] = new Array("hidden_field_label_trandate_", "hidden_field_data_trandate_" + iNumLinha);
    ajax_error_count["radcode_" + iNumLinha] = "off";
    ajax_error_count["desc_" + iNumLinha] = "off";
    ajax_error_count["doccode_" + iNumLinha] = "off";
...
{
?>
    ajax_read_only["radcode_" + iNumLinha] = "off";
    ajax_read_only["desc_" + iNumLinha] = "off";
    ajax_read_only["doccode_" + iNumLinha] = "off";
...
{
?>
    ajax_read_only["radcode_" + iNumLinha] = "on";
    ajax_read_only["desc_" + iNumLinha] = "on";
    ajax_read_only["doccode_" + iNumLinha] = "on";
...
?>
  ...
  {
    ajax_error_list["radcode_" + iNumLinha] = null;
    ajax_error_list["desc_" + iNumLinha] = null;
    ajax_error_list["doccode_" + iNumLinha] = null;
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["radcode_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["radcode_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["radcode_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["radcode_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["radcode_" + iNumLinha]["onfocus"] = new Array();
      ...
      ajax_error_list["doccode_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["doccode_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["doccode_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["doccode_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["doccode_" + iNumLinha]["onfocus"] = new Array();
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['radcode_'])) ? $this->nmgp_cmp_readonly['radcode_'] : 'off';
?>
    scAjaxFieldRead("radcode_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['doccode_'])) ? $this->nmgp_cmp_readonly['doccode_'] : 'off';
?>
    scAjaxFieldRead("doccode_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
?>
  ...
  {
    scAjaxFieldRead("radcode_" + iSeq, "on");
    scAjaxFieldRead("desc_" + iSeq, "on");
    scAjaxFieldRead("doccode_" + iSeq, "on");
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["radcode_" + iRow] || "on" == ajax_error_count["desc_" + iRow] || "on" == ajax_error_count["doccode_" + iRow] || "on" == ajax_error_count["trandate_" + iRow] || "on" == ajax_error_count["id_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_radcode_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_desc_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_doccode_" + iRow).addClass("scFormErrorLine");
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["radcode_" + iRow] && "off" == ajax_error_count["desc_" + iRow] && "off" == ajax_error_count["doccode_" + iRow] && "off" == ajax_error_count["trandate_" + iRow] && "off" == ajax_error_count["id_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["radcode_" + iRow] = "off";
        ajax_error_count["desc_" + iRow] = "off";
        ajax_error_count["doccode_" + iRow] = "off";
      ...
      $("#hidden_field_data_radcode_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_desc_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_doccode_" + iRow).removeClass("scFormErrorLine");
