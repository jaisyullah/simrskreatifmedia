...
function scEventControl_init(iSeqRow) {
  ...
  scEventControl_data["doccode_" + iSeqRow] = {"blur": false, "change": false, "autocomp": false, "original": "", "calculated": ""};
...
function scEventControl_active(iSeqRow) {
  ...
  if (scEventControl_data["doccode_" + iSeqRow]["blur"]) {
    return true;
  }
  if (scEventControl_data["doccode_" + iSeqRow]["change"]) {
    return true;
  }
  ...
  if (scEventControl_data["radcode_" + iSeqRow]["autocomp"]) {
    return true;
  }
  return false;
...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_id_' + iSeqRow).bind('blur', function() { sc_form_tbrujukanradiologi_id__onblur(this, iSeqRow) })
                                 .bind('change', function() { sc_form_tbrujukanradiologi_id__onchange(this, iSeqRow) })
                                 .bind('focus', function() { sc_form_tbrujukanradiologi_id__onfocus(this, iSeqRow) });
  $('#id_sc_field_doccode_' + iSeqRow).bind('blur', function() { sc_form_tbrujukanradiologi_doccode__onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_form_tbrujukanradiologi_doccode__onchange(this, iSeqRow) })
                                      .bind('focus', function() { sc_form_tbrujukanradiologi_doccode__onfocus(this, iSeqRow) });
  $('#id_sc_field_radcode_' + iSeqRow).bind('blur', function() { sc_form_tbrujukanradiologi_radcode__onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_form_tbrujukanradiologi_radcode__onchange(this, iSeqRow) })
                                      .bind('focus', function() { sc_form_tbrujukanradiologi_radcode__onfocus(this, iSeqRow) });
  $('#id_sc_field_trandate_' + iSeqRow).bind('blur', function() { sc_form_tbrujukanradiologi_trandate__onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_form_tbrujukanradiologi_trandate__onchange(this, iSeqRow) })
                                       .bind('focus', function() { sc_form_tbrujukanradiologi_trandate__onfocus(this, iSeqRow) });
  $('#id_sc_field_trandate__hora' + iSeqRow).bind('blur', function() { sc_form_tbrujukanradiologi_trandate__hora_onblur(this, iSeqRow) })
                                            .bind('change', function() { sc_form_tbrujukanradiologi_trandate__hora_onchange(this, iSeqRow) })
                                            .bind('focus', function() { sc_form_tbrujukanradiologi_trandate__hora_onfocus(this, iSeqRow) });
  $('#id_sc_field_desc_' + iSeqRow).bind('blur', function() { sc_form_tbrujukanradiologi_desc__onblur(this, iSeqRow) })
                                   .bind('change', function() { sc_form_tbrujukanradiologi_desc__onchange(this, iSeqRow) })
                                   .bind('focus', function() { sc_form_tbrujukanradiologi_desc__onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_form_tbrujukanradiologi_id__onblur(oThis, iSeqRow) {
  do_ajax_form_tbrujukanradiologi_validate_id_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_tbrujukanradiologi_id__onchange(oThis, iSeqRow) {
  nm_check_insert(iSeqRow);
}

function sc_form_tbrujukanradiologi_id__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_form_tbrujukanradiologi_doccode__onblur(oThis, iSeqRow) {
  do_ajax_form_tbrujukanradiologi_validate_doccode_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_tbrujukanradiologi_doccode__onchange(oThis, iSeqRow) {
  nm_check_insert(iSeqRow);
}

function sc_form_tbrujukanradiologi_doccode__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_form_tbrujukanradiologi_radcode__onblur(oThis, iSeqRow) {
  do_ajax_form_tbrujukanradiologi_validate_radcode_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_tbrujukanradiologi_radcode__onchange(oThis, iSeqRow) {
  nm_check_insert(iSeqRow);
}

function sc_form_tbrujukanradiologi_radcode__onfocus(oThis, iSeqRow) {
  scCssFocus(oThis, iSeqRow);
}

function sc_form_tbrujukanradiologi_trandate__onblur(oThis, iSeqRow) {
  do_ajax_form_tbrujukanradiologi_validate_trandate_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_tbrujukanradiologi_trandate__hora_onblur(oThis, iSeqRow) {
  do_ajax_form_tbrujukanradiologi_validate_trandate_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_tbrujukanradiologi_trandate__onchange(oThis, iSeqRow) {
  nm_check_insert(iSeqRow);
}

function sc_form_tbrujukanradiologi_trandate__hora_onchange(oThis, iSeqRow) {
  nm_check_insert(iSeqRow);
}

function sc_form_tbrujukanradiologi_trandate__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_form_tbrujukanradiologi_trandate__hora_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_form_tbrujukanradiologi_desc__onblur(oThis, iSeqRow) {
  do_ajax_form_tbrujukanradiologi_validate_desc_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_tbrujukanradiologi_desc__onchange(oThis, iSeqRow) {
  nm_check_insert(iSeqRow);
}

function sc_form_tbrujukanradiologi_desc__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}
...
function displayChange_block_0(status) {
	...
	displayChange_field("doccode_", "", status);
...
function displayChange_row(row, status) {
	...
	displayChange_field_doccode_(row, status);
...
function displayChange_field_doccode_(row, status) {
}
...
function scHidePage(pageNo) {
	$("#id_form_tbrujukanradiologi_form" + pageNo).hide();
}
