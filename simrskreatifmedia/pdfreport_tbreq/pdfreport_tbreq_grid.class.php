...
//
   ...
   $_SESSION['scriptcase']['pdfreport_tbreq']['default_font'] = $this->default_font;
   ...
   if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
   {
       ...
       {
           if (in_array("pdfreport_tbreq", $apls_aba))
           {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_tbreq']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
   {
       $this->aba_iframe = true;
   }
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_tbreq']['qt_col_grid'] = 1 ;  
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['pdfreport_tbreq']['cols']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['pdfreport_tbreq']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_tbreq']['qt_col_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['pdfreport_tbreq']['cols'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['pdfreport_tbreq']['cols']);
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_tbreq']['ordem_select']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_tbreq']['ordem_select'] = array(); 
   } 
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_tbreq']['ordem_quebra']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_tbreq']['ordem_grid'] = "" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_tbreq']['ordem_ant']  = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_tbreq']['ordem_desc'] = "" ; 
   }   
   if (!empty($nmgp_parms) && $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_tbreq']['opcao'] != "pdf")   
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_tbreq']['opcao'] = "igual";
       $rec = "ini";
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_tbreq']['where_orig']) || $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_tbreq']['prim_cons'] || !empty($nmgp_parms))  
   { 
   ...
   {   
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_tbreq']['where_pesq'] .= $this->nm_where_dinamico;
   }   
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_tbreq']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_tbreq']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_tbreq']['where_pesq_filtro'];
//
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_tbreq']['tot_geral'][1])) 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_tbreq']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_tbreq']['tot_geral'][1] ;  
   }
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_tbreq']['where_pesq_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_tbreq']['where_pesq'];  
//----- 
   ...
   $nmgp_order_by = ""; 
   $campos_order_select = "";
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_tbreq']['ordem_select'] as $campo => $ordem) 
   {
        if ($campo != $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_tbreq']['ordem_grid']) 
        {
   ...
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_tbreq']['ordem_grid'])) 
   { 
       $nmgp_order_by = " order by " . $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_tbreq']['ordem_grid'] . $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_tbreq']['ordem_desc']; 
   } 
   if (!empty($campos_order_select)) 
   { 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_tbreq']['order_grid'] = $nmgp_order_by;
...
// 
 function Pdf_image()
 {
   ...
   $this->Pdf->Image($this->NM_raiz_img . $this->Ini->path_img_global . "/grp__NM__bg__NM__Req Order Logistik.jpg", "0.000000", "0.000000", "297", "210", '', '', '', false, 300, '', false, false, 0);
...
//----- 
 function grid($linhas = 0)
 {
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_tbreq']['labels']['id'] = "Id";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_tbreq']['labels']['pocode'] = "pocode";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_tbreq']['labels']['pbf'] = "Pbf";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_tbreq']['labels']['pesandate'] = "Pesan Date";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_tbreq']['labels']['datangdate'] = "Datang Date";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_tbreq']['labels']['jatuhtempo'] = "Jatuh Tempo";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_tbreq']['labels']['total'] = "Total";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_tbreq']['labels']['fakturno'] = "Faktur No";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_tbreq']['labels']['note'] = "Note";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_tbreq']['labels']['status'] = "Status";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_tbreq']['labels']['subsel'] = "subsel";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_tbreq']['labels']['subsel_no'] = "NO";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_tbreq']['labels']['subsel_item'] = "Item";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_tbreq']['labels']['subsel_stok'] = "Stok";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_tbreq']['labels']['subsel_jumlah'] = "Jumlah";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_tbreq']['labels']['subsel_kemasan'] = "Kemasan";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_tbreq']['labels']['subsel_harga'] = "Harga";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_tbreq']['labels']['subsel_principal'] = "Principal";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_tbreq']['labels']['subsel_total'] = "Total";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_tbreq']['labels']['terbilang'] = "terbilang";
   $HTTP_REFERER = (isset($_SERVER['HTTP_REFERER'])) ? $_SERVER['HTTP_REFERER'] : ""; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_tbreq']['seq_dir'] = 0; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_tbreq']['sub_dir'] = array(); 
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_tbreq']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_tbreq']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_tbreq']['where_pesq_filtro'];
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['pdfreport_tbreq']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['pdfreport_tbreq']['lig_edit'] != '')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_tbreq']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['pdfreport_tbreq']['lig_edit'];
   }
...
// 
   ...
   {  
      ...
      $this->Pdf_init();
      $this->Pdf_image();
      while (!$this->rs_grid->EOF && $nm_quant_linhas < $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_tbreq']['qt_col_grid']) 
      {  
  ...
  $barcode  = $this->pocode[$this->nm_grid_colunas] ;

$this->pocode[$this->nm_grid_colunas]  = 'REQ-'.$this->pocode[$this->nm_grid_colunas] ;
...
$_SESSION['scriptcase']['pdfreport_tbreq']['contr_erro'] = 'off';
          ...
          { 
            ...
            $cell_poCode = array('posx' => '54', 'posy' => '53.5', 'data' => $this->pocode[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => '12', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_total = array('posx' => '210', 'posy' => '196', 'data' => $this->total[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'R', 'font_type'  => $this->default_font, 'font_size'  => '12', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => B);
            ...
            $cell_tglpermintaan = array('posx' => '230', 'posy' => '53.5', 'data' => $this->pesandate[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => '12', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            ...
            $this->Pdf->SetFont($cell_tglpermintaan['font_type'], $cell_tglpermintaan['font_style'], $cell_tglpermintaan['font_size']);
            $this->pdf_text_color($cell_tglpermintaan['data'], $cell_tglpermintaan['color_r'], $cell_tglpermintaan['color_g'], $cell_tglpermintaan['color_b']);
            if (!empty($cell_tglpermintaan['posx']) && !empty($cell_tglpermintaan['posy']))
            {
                $this->Pdf->SetXY($cell_tglpermintaan['posx'], $cell_tglpermintaan['posy']);
            }
            elseif (!empty($cell_tglpermintaan['posx']))
            {
                $this->Pdf->SetX($cell_tglpermintaan['posx']);
            }
            elseif (!empty($cell_tglpermintaan['posy']))
            {
                $this->Pdf->SetY($cell_tglpermintaan['posy']);
            }
            $this->Pdf->Cell($cell_tglpermintaan['width'], 0, $cell_tglpermintaan['data'], 0, 0, $cell_tglpermintaan['align']);
