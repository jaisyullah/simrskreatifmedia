<?php
@session_start() ;
$_SESSION['scriptcase']['grid_resep_keluar']['sc_process_barr'] = true;
require_once('../grid_resep_keluar/index.php');
unset($_SESSION['scriptcase']['grid_resep_keluar']['sc_process_barr']);
$ExportCtrl = new grid_resep_keluar_export_control;
$ExportCtrl->Export_barr();

class grid_resep_keluar_export_control
{
