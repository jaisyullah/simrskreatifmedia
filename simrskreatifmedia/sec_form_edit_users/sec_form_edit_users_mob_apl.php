...
if (isset($this->NM_ajax_flag) && $this->NM_ajax_flag)
{
    $original_login = $this->login;
      ...
      {
          $sc_cmd_dependency = "DELETE FROM rsiapp_users_groups WHERE login = '" . $this->login  . "'";
      }
...
$_SESSION['scriptcase']['sec_form_edit_users_mob']['contr_erro'] = 'off'; 
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "select login, group_id from rsiapp_users_groups where login = '$this->login'"; 
          }  
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "select login, group_id from rsiapp_users_groups where login = '$this->login'"; 
         ...
         { 
              ...
              { 
                  $_SESSION['scriptcase']['sc_sql_ult_comando'] = "delete from rsiapp_users_groups where login = '" . $sc_campos_sel['login'] . "' and group_id = '" . $sc_campos_sel['group_id'] . "'"; 
              } 
              else 
              { 
                  $_SESSION['scriptcase']['sc_sql_ult_comando'] = "delete from rsiapp_users_groups where login = '" . $sc_campos_sel['login'] . "' and group_id = '" . $sc_campos_sel['group_id'] . "'"; 
         ...
         { 
             if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
             { 
                 $_SESSION['scriptcase']['sc_sql_ult_comando'] = "insert into rsiapp_users_groups (login, group_id) values ('" . $sc_campos_form['login'] . "', '" . $sc_campos_form['groups'] . "')"; 
             } 
             else 
             { 
                 $_SESSION['scriptcase']['sc_sql_ult_comando'] = "insert into rsiapp_users_groups (login, group_id) values ('" . $sc_campos_form['login'] . "', '" . $sc_campos_form['groups'] . "')"; 
          ...
          { 
              foreach ($todo_groups as $cada_groups) 
              {
                  ...
                  { 
                      ...
                      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
                      { 
                          $_SESSION['scriptcase']['sc_sql_ult_comando'] = "insert into rsiapp_users_groups (login, group_id) values ('$this->login', '$groupsx')"; 
                      } 
                      else 
                      { 
                          $_SESSION['scriptcase']['sc_sql_ult_comando'] = "insert into rsiapp_users_groups (login, group_id) values ('$this->login', '$groupsx')"; 
      ...
      { 
          ...
          { 
              ...
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
              { 
                  $_SESSION['scriptcase']['sc_sql_ult_comando'] = "delete from rsiapp_users_groups where login = '$this->login'"; 
              } 
              else 
              { 
                  $_SESSION['scriptcase']['sc_sql_ult_comando'] = "delete from rsiapp_users_groups where login = '$this->login'"; 
