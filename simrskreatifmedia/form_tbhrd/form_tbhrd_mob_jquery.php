...
function displayChange_field_status(row, status) {
	if ("on" == status && typeof $("#nmsc_iframe_liga_form_tbhrdstatus_mob")[0].contentWindow.scRecreateSelect2 === "function") {
		$("#nmsc_iframe_liga_form_tbhrdstatus_mob")[0].contentWindow.scRecreateSelect2();
	}
}

function displayChange_field_sc_field_0(row, status) {
	if ("on" == status && typeof $("#nmsc_iframe_liga_form_tbhrdformal_mob")[0].contentWindow.scRecreateSelect2 === "function") {
		$("#nmsc_iframe_liga_form_tbhrdformal_mob")[0].contentWindow.scRecreateSelect2();
	}
}
...
function displayChange_field_sc_field_2(row, status) {
	if ("on" == status && typeof $("#nmsc_iframe_liga_form_tbhrdexp_mob")[0].contentWindow.scRecreateSelect2 === "function") {
		$("#nmsc_iframe_liga_form_tbhrdexp_mob")[0].contentWindow.scRecreateSelect2();
	}
}

function displayChange_field_keluarga(row, status) {
	if ("on" == status && typeof $("#nmsc_iframe_liga_form_tbhrdklg_mob")[0].contentWindow.scRecreateSelect2 === "function") {
		$("#nmsc_iframe_liga_form_tbhrdklg_mob")[0].contentWindow.scRecreateSelect2();
	}
}

function displayChange_field_sc_field_3(row, status) {
	if ("on" == status && typeof $("#nmsc_iframe_liga_form_tbhrdminat_mob")[0].contentWindow.scRecreateSelect2 === "function") {
		$("#nmsc_iframe_liga_form_tbhrdminat_mob")[0].contentWindow.scRecreateSelect2();
	}
}

function displayChange_field_referensi(row, status) {
	if ("on" == status && typeof $("#nmsc_iframe_liga_form_tbhrdref_mob")[0].contentWindow.scRecreateSelect2 === "function") {
		$("#nmsc_iframe_liga_form_tbhrdref_mob")[0].contentWindow.scRecreateSelect2();
	}
}

function displayChange_field_sc_field_4(row, status) {
	if ("on" == status && typeof $("#nmsc_iframe_liga_form_tbhrdhope_mob")[0].contentWindow.scRecreateSelect2 === "function") {
		$("#nmsc_iframe_liga_form_tbhrdhope_mob")[0].contentWindow.scRecreateSelect2();
	}
}
...
function scHidePage(pageNo) {
	$("#id_form_tbhrd_mob_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_tgllahir" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_tbhrd_mob_validate_tgllahir(iSeqRow);
    },
    numberOfMonths: 1,
    changeMonth: true,
    changeYear: true,
...
function scJQUploadAdd(iSeqRow) {
  $("#id_sc_field_photo" + iSeqRow).fileupload({
    datatype: "json",
    url: "form_tbhrd_mob_ul_save.php",
    dropZone: "",
    formData: function() {
      return [
