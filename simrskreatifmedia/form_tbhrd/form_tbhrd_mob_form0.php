...
?>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['embutida_pdf']))
 {
 ?>
...
<?php
include_once("form_tbhrd_mob_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_tbhrd_mob_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
?>
<body class="scFormPage" style="<?php echo $remove_margin . $str_iframe_body; ?>">
<?php

if (isset($_SESSION['scriptcase']['form_tbhrd']['error_buffer']) && '' != $_SESSION['scriptcase']['form_tbhrd']['error_buffer'])
{
    echo $_SESSION['scriptcase']['form_tbhrd']['error_buffer'];
}
...
<?php
 include_once("form_tbhrd_mob_js0.php");
?>
<script type="text/javascript"> 
...
<form  name="F1" method="post" enctype="multipart/form-data" 
               action="form_tbhrd_mob.php" 
               target="_self">
<input type="hidden" name="nmgp_url_saida" value="">
<?php
if ('novo' == $this->nmgp_opcao || 'incluir' == $this->nmgp_opcao)
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_tbhrd_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_tbhrd_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['fast_search'][2] : "";
?> 
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['run_iframe'] != "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['run_iframe'] == "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_kodekary_line" id="hidden_field_data_kodekary" style="<?php echo $sStyleHidden_kodekary; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_kodekary_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_kodekary_label"><span id="id_label_kodekary"><?php echo $this->nm_new_label['kodekary']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_namalengkap_line" id="hidden_field_data_namalengkap" style="<?php echo $sStyleHidden_namalengkap; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_namalengkap_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_namalengkap_label"><span id="id_label_namalengkap"><?php echo $this->nm_new_label['namalengkap']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_tmplahir_line" id="hidden_field_data_tmplahir" style="<?php echo $sStyleHidden_tmplahir; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tmplahir_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_tmplahir_label"><span id="id_label_tmplahir"><?php echo $this->nm_new_label['tmplahir']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_tgllahir_line" id="hidden_field_data_tgllahir" style="<?php echo $sStyleHidden_tgllahir; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tgllahir_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_tgllahir_label"><span id="id_label_tgllahir"><?php echo $this->nm_new_label['tgllahir']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_pendidikan_line" id="hidden_field_data_pendidikan" style="<?php echo $sStyleHidden_pendidikan; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_pendidikan_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_pendidikan_label"><span id="id_label_pendidikan"><?php echo $this->nm_new_label['pendidikan']; ?></span></span><br>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['Lookup_pendidikan'][] = ''; ?>
 <option value=""></option>
 <option  value="SD" <?php  if ($this->pendidikan == "SD") { echo " selected" ;} ?>>SD</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['Lookup_pendidikan'][] = 'SD'; ?>
 <option  value="SMP" <?php  if ($this->pendidikan == "SMP") { echo " selected" ;} ?>>SMP</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['Lookup_pendidikan'][] = 'SMP'; ?>
 <option  value="SMA" <?php  if ($this->pendidikan == "SMA") { echo " selected" ;} ?>>SMA</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['Lookup_pendidikan'][] = 'SMA'; ?>
 <option  value="DIPLOMA" <?php  if ($this->pendidikan == "DIPLOMA") { echo " selected" ;} ?>>DIPLOMA</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['Lookup_pendidikan'][] = 'DIPLOMA'; ?>
 <option  value="SARJANA" <?php  if ($this->pendidikan == "SARJANA") { echo " selected" ;} ?>>SARJANA</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['Lookup_pendidikan'][] = 'SARJANA'; ?>
 <option  value="PASCA SARJANA" <?php  if ($this->pendidikan == "PASCA SARJANA") { echo " selected" ;} ?>>PASCA SARJANA</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['Lookup_pendidikan'][] = 'PASCA SARJANA'; ?>
 </select></span>
</span><?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_agama_line" id="hidden_field_data_agama" style="<?php echo $sStyleHidden_agama; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_agama_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_agama_label"><span id="id_label_agama"><?php echo $this->nm_new_label['agama']; ?></span></span><br>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['Lookup_agama'][] = ''; ?>
 <option value=""></option>
 <option  value="ISLAM" <?php  if ($this->agama == "ISLAM") { echo " selected" ;} ?>>ISLAM</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['Lookup_agama'][] = 'ISLAM'; ?>
 <option  value="HINDU" <?php  if ($this->agama == "HINDU") { echo " selected" ;} ?>>HINDU</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['Lookup_agama'][] = 'HINDU'; ?>
 <option  value="BUDHA" <?php  if ($this->agama == "BUDHA") { echo " selected" ;} ?>>BUDHA</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['Lookup_agama'][] = 'BUDHA'; ?>
 <option  value="KRISTEN" <?php  if ($this->agama == "KRISTEN") { echo " selected" ;} ?>>KRISTEN</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['Lookup_agama'][] = 'KRISTEN'; ?>
 <option  value="KATOLIK" <?php  if ($this->agama == "KATOLIK") { echo " selected" ;} ?>>KATOLIK</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['Lookup_agama'][] = 'KATOLIK'; ?>
 </select></span>
</span><?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_jk_line" id="hidden_field_data_jk" style="<?php echo $sStyleHidden_jk; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_jk_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_jk_label"><span id="id_label_jk"><?php echo $this->nm_new_label['jk']; ?></span></span><br>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['Lookup_jk'][] = 'L'; ?>
 <option  value="P" <?php  if ($this->jk == "P") { echo " selected" ;} ?>>PEREMPUAN</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['Lookup_jk'][] = 'P'; ?>
 </select></span>
</span><?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_idno_line" id="hidden_field_data_idno" style="<?php echo $sStyleHidden_idno; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_idno_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_idno_label"><span id="id_label_idno"><?php echo $this->nm_new_label['idno']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_goldar_line" id="hidden_field_data_goldar" style="<?php echo $sStyleHidden_goldar; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_goldar_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_goldar_label"><span id="id_label_goldar"><?php echo $this->nm_new_label['goldar']; ?></span></span><br>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['Lookup_goldar'][] = ''; ?>
 <option value=""></option>
 <option  value="A" <?php  if ($this->goldar == "A") { echo " selected" ;} ?>>A</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['Lookup_goldar'][] = 'A'; ?>
 <option  value="B" <?php  if ($this->goldar == "B") { echo " selected" ;} ?>>B</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['Lookup_goldar'][] = 'B'; ?>
 <option  value="A/B" <?php  if ($this->goldar == "A/B") { echo " selected" ;} ?>>A/B</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['Lookup_goldar'][] = 'A/B'; ?>
 <option  value="O" <?php  if ($this->goldar == "O") { echo " selected" ;} ?>>O</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['Lookup_goldar'][] = 'O'; ?>
 </select></span>
</span><?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_telp_line" id="hidden_field_data_telp" style="<?php echo $sStyleHidden_telp; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_telp_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_telp_label"><span id="id_label_telp"><?php echo $this->nm_new_label['telp']; ?></span></span><br>
...
<?php $sStyleHidden_alamat_dumb = ('' == $sStyleHidden_alamat) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_alamat_dumb" style="<?php echo $sStyleHidden_alamat_dumb; ?>"></TD>
   </tr>
<?php $sc_hidden_no = 1; ?>
</TABLE></div><!-- bloco_f -->
   </td>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_emgalamat_line" id="hidden_field_data_emgalamat" style="<?php echo $sStyleHidden_emgalamat; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_emgalamat_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_emgalamat_label"><span id="id_label_emgalamat"><?php echo $this->nm_new_label['emgalamat']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_emgnama_line" id="hidden_field_data_emgnama" style="<?php echo $sStyleHidden_emgnama; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_emgnama_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_emgnama_label"><span id="id_label_emgnama"><?php echo $this->nm_new_label['emgnama']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_statustt_line" id="hidden_field_data_statustt" style="<?php echo $sStyleHidden_statustt; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_statustt_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_statustt_label"><span id="id_label_statustt"><?php echo $this->nm_new_label['statustt']; ?></span></span><br>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['Lookup_statustt'][] = ''; ?>
 <option value=""></option>
 <option  value="PRIBADI" <?php  if ($this->statustt == "PRIBADI") { echo " selected" ;} ?>>PRIBADI</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['Lookup_statustt'][] = 'PRIBADI'; ?>
 <option  value="ORANG TUA" <?php  if ($this->statustt == "ORANG TUA") { echo " selected" ;} ?>>ORANG TUA</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['Lookup_statustt'][] = 'ORANG TUA'; ?>
 <option  value="KONTRAK" <?php  if ($this->statustt == "KONTRAK") { echo " selected" ;} ?>>KONTRAK</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['Lookup_statustt'][] = 'KONTRAK'; ?>
 </select></span>
</span><?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_kbm_line" id="hidden_field_data_kbm" style="<?php echo $sStyleHidden_kbm; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_kbm_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_kbm_label"><span id="id_label_kbm"><?php echo $this->nm_new_label['kbm']; ?></span></span><br>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['Lookup_kbm'][] = ''; ?>
 <option value=""></option>
 <option  value="Tidak Punya" <?php  if ($this->kbm == "Tidak Punya") { echo " selected" ;} ?>>Tidak Punya</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['Lookup_kbm'][] = 'Tidak Punya'; ?>
 <option  value="Motor" <?php  if ($this->kbm == "Motor") { echo " selected" ;} ?>>Motor</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['Lookup_kbm'][] = 'Motor'; ?>
 <option  value="Mobil" <?php  if ($this->kbm == "Mobil") { echo " selected" ;} ?>>Mobil</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['Lookup_kbm'][] = 'Mobil'; ?>
 </select></span>
</span><?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_fisikbb_line" id="hidden_field_data_fisikbb" style="<?php echo $sStyleHidden_fisikbb; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fisikbb_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_fisikbb_label"><span id="id_label_fisikbb"><?php echo $this->nm_new_label['fisikbb']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_fisiktb_line" id="hidden_field_data_fisiktb" style="<?php echo $sStyleHidden_fisiktb; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fisiktb_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_fisiktb_label"><span id="id_label_fisiktb"><?php echo $this->nm_new_label['fisiktb']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_kacamata_line" id="hidden_field_data_kacamata" style="<?php echo $sStyleHidden_kacamata; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_kacamata_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_kacamata_label"><span id="id_label_kacamata"><?php echo $this->nm_new_label['kacamata']; ?></span></span><br>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['Lookup_kacamata'][] = ''; ?>
 <option value=""></option>
 <option  value="Y" <?php  if ($this->kacamata == "Y") { echo " selected" ;} ?>>Ya</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['Lookup_kacamata'][] = 'Y'; ?>
 <option  value="N" <?php  if ($this->kacamata == "N") { echo " selected" ;} ?>>Tidak</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['Lookup_kacamata'][] = 'N'; ?>
 </select></span>
</span><?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_pidana_line" id="hidden_field_data_pidana" style="<?php echo $sStyleHidden_pidana; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_pidana_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_pidana_label"><span id="id_label_pidana"><?php echo $this->nm_new_label['pidana']; ?></span></span><br>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['Lookup_pidana'][] = ''; ?>
 <option value=""></option>
 <option  value="Y" <?php  if ($this->pidana == "Y") { echo " selected" ;} ?>>Ya</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['Lookup_pidana'][] = 'Y'; ?>
 <option  value="N" <?php  if ($this->pidana == "N") { echo " selected" ;} ?>>Tidak</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['Lookup_pidana'][] = 'N'; ?>
 </select></span>
</span><?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_pidanakasus_line" id="hidden_field_data_pidanakasus" style="<?php echo $sStyleHidden_pidanakasus; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_pidanakasus_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_pidanakasus_label"><span id="id_label_pidanakasus"><?php echo $this->nm_new_label['pidanakasus']; ?></span></span><br>
<?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_kantorspouse_line" id="hidden_field_data_kantorspouse" style="<?php echo $sStyleHidden_kantorspouse; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_kantorspouse_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_kantorspouse_label"><span id="id_label_kantorspouse"><?php echo $this->nm_new_label['kantorspouse']; ?></span></span><br>
<?php
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_Status'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_Status'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdstatus_mob_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_Status'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdstatus_mob_script_case_init'] = $this->Ini->sc_page;
 }
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdstatus_mob_script_case_init'] ]['form_tbhrdstatus_mob']['embutida_proc']  = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdstatus_mob_script_case_init'] ]['form_tbhrdstatus_mob']['embutida_form']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdstatus_mob_script_case_init'] ]['form_tbhrdstatus_mob']['embutida_call']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdstatus_mob_script_case_init'] ]['form_tbhrdstatus_mob']['embutida_multi'] = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdstatus_mob_script_case_init'] ]['form_tbhrdstatus_mob']['embutida_liga_form_insert'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdstatus_mob_script_case_init'] ]['form_tbhrdstatus_mob']['embutida_liga_form_update'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdstatus_mob_script_case_init'] ]['form_tbhrdstatus_mob']['embutida_liga_form_delete'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdstatus_mob_script_case_init'] ]['form_tbhrdstatus_mob']['embutida_liga_form_btn_nav'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdstatus_mob_script_case_init'] ]['form_tbhrdstatus_mob']['embutida_liga_grid_edit'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdstatus_mob_script_case_init'] ]['form_tbhrdstatus_mob']['embutida_liga_grid_edit_link'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdstatus_mob_script_case_init'] ]['form_tbhrdstatus_mob']['embutida_liga_qtd_reg'] = '10';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdstatus_mob_script_case_init'] ]['form_tbhrdstatus_mob']['embutida_liga_tp_pag'] = 'parcial';
 ...
 if ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdstatus_mob_script_case_init'] ]['form_tbhrd_mob']['total'] < 0)
 {
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_tbhrd_mob_empty.htm' : $this->Ini->link_form_tbhrdstatus_mob_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_session=' . session_id() . '&script_case_detail=Y';
...
if (isset($this->Ini->sc_lig_target['C_@scinf_Status']) && 'nmsc_iframe_liga_form_tbhrdstatus_mob' != $this->Ini->sc_lig_target['C_@scinf_Status'])
{
    if ('novo' != $this->nmgp_opcao)
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_Status'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdstatus_mob_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
{
?>
<iframe border="0" id="nmsc_iframe_liga_form_tbhrdstatus_mob"  marginWidth="0" marginHeight="0" frameborder="0" valign="top" height="100" width="100%" name="nmsc_iframe_liga_form_tbhrdstatus_mob"  scrolling="auto" src="<?php echo $sDetailSrc; ?>"></iframe>
<?php
}
?>
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_sc_field_0'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_sc_field_0'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdformal_mob_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_sc_field_0'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdformal_mob_script_case_init'] = $this->Ini->sc_page;
 }
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdformal_mob_script_case_init'] ]['form_tbhrdformal_mob']['embutida_proc']  = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdformal_mob_script_case_init'] ]['form_tbhrdformal_mob']['embutida_form']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdformal_mob_script_case_init'] ]['form_tbhrdformal_mob']['embutida_call']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdformal_mob_script_case_init'] ]['form_tbhrdformal_mob']['embutida_multi'] = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdformal_mob_script_case_init'] ]['form_tbhrdformal_mob']['embutida_liga_form_insert'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdformal_mob_script_case_init'] ]['form_tbhrdformal_mob']['embutida_liga_form_update'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdformal_mob_script_case_init'] ]['form_tbhrdformal_mob']['embutida_liga_form_delete'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdformal_mob_script_case_init'] ]['form_tbhrdformal_mob']['embutida_liga_form_btn_nav'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdformal_mob_script_case_init'] ]['form_tbhrdformal_mob']['embutida_liga_grid_edit'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdformal_mob_script_case_init'] ]['form_tbhrdformal_mob']['embutida_liga_grid_edit_link'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdformal_mob_script_case_init'] ]['form_tbhrdformal_mob']['embutida_liga_qtd_reg'] = '10';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdformal_mob_script_case_init'] ]['form_tbhrdformal_mob']['embutida_liga_tp_pag'] = 'parcial';
 ...
 if ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdformal_mob_script_case_init'] ]['form_tbhrd_mob']['total'] < 0)
 {
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_tbhrd_mob_empty.htm' : $this->Ini->link_form_tbhrdformal_mob_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_session=' . session_id() . '&script_case_detail=Y';
...
if (isset($this->Ini->sc_lig_target['C_@scinf_sc_field_0']) && 'nmsc_iframe_liga_form_tbhrdformal_mob' != $this->Ini->sc_lig_target['C_@scinf_sc_field_0'])
{
    if ('novo' != $this->nmgp_opcao)
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_sc_field_0'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdformal_mob_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
{
?>
<iframe border="0" id="nmsc_iframe_liga_form_tbhrdformal_mob"  marginWidth="0" marginHeight="0" frameborder="0" valign="top" height="100" width="100%" name="nmsc_iframe_liga_form_tbhrdformal_mob"  scrolling="auto" src="<?php echo $sDetailSrc; ?>"></iframe>
<?php
}
?>
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_sc_field_1'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_sc_field_1'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdinformal_mob_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_sc_field_1'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdinformal_mob_script_case_init'] = $this->Ini->sc_page;
 }
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdinformal_mob_script_case_init'] ]['form_tbhrdinformal_mob']['embutida_proc']  = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdinformal_mob_script_case_init'] ]['form_tbhrdinformal_mob']['embutida_form']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdinformal_mob_script_case_init'] ]['form_tbhrdinformal_mob']['embutida_call']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdinformal_mob_script_case_init'] ]['form_tbhrdinformal_mob']['embutida_multi'] = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdinformal_mob_script_case_init'] ]['form_tbhrdinformal_mob']['embutida_liga_form_insert'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdinformal_mob_script_case_init'] ]['form_tbhrdinformal_mob']['embutida_liga_form_update'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdinformal_mob_script_case_init'] ]['form_tbhrdinformal_mob']['embutida_liga_form_delete'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdinformal_mob_script_case_init'] ]['form_tbhrdinformal_mob']['embutida_liga_form_btn_nav'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdinformal_mob_script_case_init'] ]['form_tbhrdinformal_mob']['embutida_liga_grid_edit'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdinformal_mob_script_case_init'] ]['form_tbhrdinformal_mob']['embutida_liga_grid_edit_link'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdinformal_mob_script_case_init'] ]['form_tbhrdinformal_mob']['embutida_liga_qtd_reg'] = '10';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdinformal_mob_script_case_init'] ]['form_tbhrdinformal_mob']['embutida_liga_tp_pag'] = 'parcial';
 ...
 if ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdinformal_mob_script_case_init'] ]['form_tbhrd_mob']['total'] < 0)
 {
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_tbhrd_mob_empty.htm' : $this->Ini->link_form_tbhrdinformal_mob_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_session=' . session_id() . '&script_case_detail=Y';
...
if (isset($this->Ini->sc_lig_target['C_@scinf_sc_field_1']) && 'nmsc_iframe_liga_form_tbhrdinformal_mob' != $this->Ini->sc_lig_target['C_@scinf_sc_field_1'])
{
    if ('novo' != $this->nmgp_opcao)
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_sc_field_1'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdinformal_mob_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_sc_field_2'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_sc_field_2'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdexp_mob_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_sc_field_2'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdexp_mob_script_case_init'] = $this->Ini->sc_page;
 }
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdexp_mob_script_case_init'] ]['form_tbhrdexp_mob']['embutida_proc']  = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdexp_mob_script_case_init'] ]['form_tbhrdexp_mob']['embutida_form']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdexp_mob_script_case_init'] ]['form_tbhrdexp_mob']['embutida_call']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdexp_mob_script_case_init'] ]['form_tbhrdexp_mob']['embutida_multi'] = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdexp_mob_script_case_init'] ]['form_tbhrdexp_mob']['embutida_liga_form_insert'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdexp_mob_script_case_init'] ]['form_tbhrdexp_mob']['embutida_liga_form_update'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdexp_mob_script_case_init'] ]['form_tbhrdexp_mob']['embutida_liga_form_delete'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdexp_mob_script_case_init'] ]['form_tbhrdexp_mob']['embutida_liga_form_btn_nav'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdexp_mob_script_case_init'] ]['form_tbhrdexp_mob']['embutida_liga_grid_edit'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdexp_mob_script_case_init'] ]['form_tbhrdexp_mob']['embutida_liga_grid_edit_link'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdexp_mob_script_case_init'] ]['form_tbhrdexp_mob']['embutida_liga_qtd_reg'] = '10';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdexp_mob_script_case_init'] ]['form_tbhrdexp_mob']['embutida_liga_tp_pag'] = 'parcial';
 ...
 if ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdexp_mob_script_case_init'] ]['form_tbhrd_mob']['total'] < 0)
 {
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_tbhrd_mob_empty.htm' : $this->Ini->link_form_tbhrdexp_mob_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_session=' . session_id() . '&script_case_detail=Y';
...
if (isset($this->Ini->sc_lig_target['C_@scinf_sc_field_2']) && 'nmsc_iframe_liga_form_tbhrdexp_mob' != $this->Ini->sc_lig_target['C_@scinf_sc_field_2'])
{
    if ('novo' != $this->nmgp_opcao)
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_sc_field_2'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdexp_mob_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
{
?>
<iframe border="0" id="nmsc_iframe_liga_form_tbhrdexp_mob"  marginWidth="0" marginHeight="0" frameborder="0" valign="top" height="100" width="100%" name="nmsc_iframe_liga_form_tbhrdexp_mob"  scrolling="auto" src="<?php echo $sDetailSrc; ?>"></iframe>
<?php
}
?>
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_Keluarga'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_Keluarga'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdklg_mob_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_Keluarga'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdklg_mob_script_case_init'] = $this->Ini->sc_page;
 }
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdklg_mob_script_case_init'] ]['form_tbhrdklg_mob']['embutida_proc']  = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdklg_mob_script_case_init'] ]['form_tbhrdklg_mob']['embutida_form']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdklg_mob_script_case_init'] ]['form_tbhrdklg_mob']['embutida_call']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdklg_mob_script_case_init'] ]['form_tbhrdklg_mob']['embutida_multi'] = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdklg_mob_script_case_init'] ]['form_tbhrdklg_mob']['embutida_liga_form_insert'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdklg_mob_script_case_init'] ]['form_tbhrdklg_mob']['embutida_liga_form_update'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdklg_mob_script_case_init'] ]['form_tbhrdklg_mob']['embutida_liga_form_delete'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdklg_mob_script_case_init'] ]['form_tbhrdklg_mob']['embutida_liga_form_btn_nav'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdklg_mob_script_case_init'] ]['form_tbhrdklg_mob']['embutida_liga_grid_edit'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdklg_mob_script_case_init'] ]['form_tbhrdklg_mob']['embutida_liga_grid_edit_link'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdklg_mob_script_case_init'] ]['form_tbhrdklg_mob']['embutida_liga_qtd_reg'] = '10';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdklg_mob_script_case_init'] ]['form_tbhrdklg_mob']['embutida_liga_tp_pag'] = 'parcial';
 ...
 if ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdklg_mob_script_case_init'] ]['form_tbhrd_mob']['total'] < 0)
 {
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_tbhrd_mob_empty.htm' : $this->Ini->link_form_tbhrdklg_mob_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_session=' . session_id() . '&script_case_detail=Y';
...
if (isset($this->Ini->sc_lig_target['C_@scinf_Keluarga']) && 'nmsc_iframe_liga_form_tbhrdklg_mob' != $this->Ini->sc_lig_target['C_@scinf_Keluarga'])
{
    if ('novo' != $this->nmgp_opcao)
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_Keluarga'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdklg_mob_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
{
?>
<iframe border="0" id="nmsc_iframe_liga_form_tbhrdklg_mob"  marginWidth="0" marginHeight="0" frameborder="0" valign="top" height="100" width="100%" name="nmsc_iframe_liga_form_tbhrdklg_mob"  scrolling="auto" src="<?php echo $sDetailSrc; ?>"></iframe>
<?php
}
?>
...
<?php $sStyleHidden_keluarga_dumb = ('' == $sStyleHidden_keluarga) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_keluarga_dumb" style="<?php echo $sStyleHidden_keluarga_dumb; ?>"></TD>
   </tr>
<?php $sc_hidden_no = 1; ?>
</TABLE></div><!-- bloco_f -->
   </td>
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_sc_field_3'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_sc_field_3'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdminat_mob_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_sc_field_3'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdminat_mob_script_case_init'] = $this->Ini->sc_page;
 }
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdminat_mob_script_case_init'] ]['form_tbhrdminat_mob']['embutida_proc']  = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdminat_mob_script_case_init'] ]['form_tbhrdminat_mob']['embutida_form']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdminat_mob_script_case_init'] ]['form_tbhrdminat_mob']['embutida_call']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdminat_mob_script_case_init'] ]['form_tbhrdminat_mob']['embutida_multi'] = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdminat_mob_script_case_init'] ]['form_tbhrdminat_mob']['embutida_liga_form_insert'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdminat_mob_script_case_init'] ]['form_tbhrdminat_mob']['embutida_liga_form_update'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdminat_mob_script_case_init'] ]['form_tbhrdminat_mob']['embutida_liga_form_delete'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdminat_mob_script_case_init'] ]['form_tbhrdminat_mob']['embutida_liga_form_btn_nav'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdminat_mob_script_case_init'] ]['form_tbhrdminat_mob']['embutida_liga_grid_edit'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdminat_mob_script_case_init'] ]['form_tbhrdminat_mob']['embutida_liga_grid_edit_link'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdminat_mob_script_case_init'] ]['form_tbhrdminat_mob']['embutida_liga_qtd_reg'] = '10';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdminat_mob_script_case_init'] ]['form_tbhrdminat_mob']['embutida_liga_tp_pag'] = 'parcial';
 ...
 if ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdminat_mob_script_case_init'] ]['form_tbhrd_mob']['total'] < 0)
 {
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_tbhrd_mob_empty.htm' : $this->Ini->link_form_tbhrdminat_mob_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_session=' . session_id() . '&script_case_detail=Y';
...
if (isset($this->Ini->sc_lig_target['C_@scinf_sc_field_3']) && 'nmsc_iframe_liga_form_tbhrdminat_mob' != $this->Ini->sc_lig_target['C_@scinf_sc_field_3'])
{
    if ('novo' != $this->nmgp_opcao)
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_sc_field_3'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdminat_mob_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
{
?>
<iframe border="0" id="nmsc_iframe_liga_form_tbhrdminat_mob"  marginWidth="0" marginHeight="0" frameborder="0" valign="top" height="100" width="100%" name="nmsc_iframe_liga_form_tbhrdminat_mob"  scrolling="auto" src="<?php echo $sDetailSrc; ?>"></iframe>
<?php
}
?>
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_Referensi'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_Referensi'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdref_mob_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_Referensi'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdref_mob_script_case_init'] = $this->Ini->sc_page;
 }
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdref_mob_script_case_init'] ]['form_tbhrdref_mob']['embutida_proc']  = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdref_mob_script_case_init'] ]['form_tbhrdref_mob']['embutida_form']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdref_mob_script_case_init'] ]['form_tbhrdref_mob']['embutida_call']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdref_mob_script_case_init'] ]['form_tbhrdref_mob']['embutida_multi'] = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdref_mob_script_case_init'] ]['form_tbhrdref_mob']['embutida_liga_form_insert'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdref_mob_script_case_init'] ]['form_tbhrdref_mob']['embutida_liga_form_update'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdref_mob_script_case_init'] ]['form_tbhrdref_mob']['embutida_liga_form_delete'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdref_mob_script_case_init'] ]['form_tbhrdref_mob']['embutida_liga_form_btn_nav'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdref_mob_script_case_init'] ]['form_tbhrdref_mob']['embutida_liga_grid_edit'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdref_mob_script_case_init'] ]['form_tbhrdref_mob']['embutida_liga_grid_edit_link'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdref_mob_script_case_init'] ]['form_tbhrdref_mob']['embutida_liga_qtd_reg'] = '10';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdref_mob_script_case_init'] ]['form_tbhrdref_mob']['embutida_liga_tp_pag'] = 'parcial';
 ...
 if ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdref_mob_script_case_init'] ]['form_tbhrd_mob']['total'] < 0)
 {
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_tbhrd_mob_empty.htm' : $this->Ini->link_form_tbhrdref_mob_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_session=' . session_id() . '&script_case_detail=Y';
...
if (isset($this->Ini->sc_lig_target['C_@scinf_Referensi']) && 'nmsc_iframe_liga_form_tbhrdref_mob' != $this->Ini->sc_lig_target['C_@scinf_Referensi'])
{
    if ('novo' != $this->nmgp_opcao)
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_Referensi'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdref_mob_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
{
?>
<iframe border="0" id="nmsc_iframe_liga_form_tbhrdref_mob"  marginWidth="0" marginHeight="0" frameborder="0" valign="top" height="100" width="100%" name="nmsc_iframe_liga_form_tbhrdref_mob"  scrolling="auto" src="<?php echo $sDetailSrc; ?>"></iframe>
<?php
}
?>
...
<?php $sStyleHidden_referensi_dumb = ('' == $sStyleHidden_referensi) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_referensi_dumb" style="<?php echo $sStyleHidden_referensi_dumb; ?>"></TD>
   </tr>
<?php $sc_hidden_no = 1; ?>
</TABLE></div><!-- bloco_f -->
   </td>
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_sc_field_4'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_sc_field_4'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdhope_mob_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_sc_field_4'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdhope_mob_script_case_init'] = $this->Ini->sc_page;
 }
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdhope_mob_script_case_init'] ]['form_tbhrdhope_mob']['embutida_proc']  = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdhope_mob_script_case_init'] ]['form_tbhrdhope_mob']['embutida_form']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdhope_mob_script_case_init'] ]['form_tbhrdhope_mob']['embutida_call']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdhope_mob_script_case_init'] ]['form_tbhrdhope_mob']['embutida_multi'] = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdhope_mob_script_case_init'] ]['form_tbhrdhope_mob']['embutida_liga_form_insert'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdhope_mob_script_case_init'] ]['form_tbhrdhope_mob']['embutida_liga_form_update'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdhope_mob_script_case_init'] ]['form_tbhrdhope_mob']['embutida_liga_form_delete'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdhope_mob_script_case_init'] ]['form_tbhrdhope_mob']['embutida_liga_form_btn_nav'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdhope_mob_script_case_init'] ]['form_tbhrdhope_mob']['embutida_liga_grid_edit'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdhope_mob_script_case_init'] ]['form_tbhrdhope_mob']['embutida_liga_grid_edit_link'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdhope_mob_script_case_init'] ]['form_tbhrdhope_mob']['embutida_liga_qtd_reg'] = '10';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdhope_mob_script_case_init'] ]['form_tbhrdhope_mob']['embutida_liga_tp_pag'] = 'parcial';
 ...
 if ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdhope_mob_script_case_init'] ]['form_tbhrd_mob']['total'] < 0)
 {
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_tbhrd_mob_empty.htm' : $this->Ini->link_form_tbhrdhope_mob_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_session=' . session_id() . '&script_case_detail=Y';
...
if (isset($this->Ini->sc_lig_target['C_@scinf_sc_field_4']) && 'nmsc_iframe_liga_form_tbhrdhope_mob' != $this->Ini->sc_lig_target['C_@scinf_sc_field_4'])
{
    if ('novo' != $this->nmgp_opcao)
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_sc_field_4'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['form_tbhrdhope_mob_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
{
?>
<iframe border="0" id="nmsc_iframe_liga_form_tbhrdhope_mob"  marginWidth="0" marginHeight="0" frameborder="0" valign="top" height="100" width="100%" name="nmsc_iframe_liga_form_tbhrdhope_mob"  scrolling="auto" src="<?php echo $sDetailSrc; ?>"></iframe>
<?php
}
?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['total'] + 1)?>);</script><?php }} ?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_tbhrd_mob");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_tbhrd_mob");
 parent.scAjaxDetailHeight("form_tbhrd_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrd_mob']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
