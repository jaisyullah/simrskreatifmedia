...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_level_cond" name="level_cond" onChange="nm_campos_between(document.getElementById('id_vis_level'), this, 'level')">
