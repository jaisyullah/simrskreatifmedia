...
<?php
   ...
   $Ord_Cmp = new grid_tbclinicalpathway_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_tbclinicalpathway_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbclinicalpathway']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tbclinicalpathway']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbclinicalpathway']['labels']["id"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbclinicalpathway']['labels']["id"] : "ID";
   $tab_ger_campos['namacp'] = "on";
   $tab_def_campos['namacp'] = "namaCP";
   $tab_labels["namacp"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbclinicalpathway']['labels']["namacp"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbclinicalpathway']['labels']["namacp"] : "Nama CP";
   $tab_ger_campos['icd'] = "on";
   $tab_def_campos['icd'] = "icd";
   $tab_labels["icd"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbclinicalpathway']['labels']["icd"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbclinicalpathway']['labels']["icd"] : "ICD";
   $tab_ger_campos['rate1'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['rate1'] = "rate1";
   }
   else
   {
       $tab_def_campos['rate1'] = "";
   }
   $tab_labels["rate1"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbclinicalpathway']['labels']["rate1"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbclinicalpathway']['labels']["rate1"] : "Est Kelas 1";
   $tab_ger_campos['rate2'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['rate2'] = "rate2";
   }
   else
   {
       $tab_def_campos['rate2'] = "";
   }
   $tab_labels["rate2"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbclinicalpathway']['labels']["rate2"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbclinicalpathway']['labels']["rate2"] : "Est Kelas 2";
   $tab_ger_campos['rate3'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['rate3'] = "rate3";
   }
   else
   {
       $tab_def_campos['rate3'] = "";
   }
   $tab_labels["rate3"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbclinicalpathway']['labels']["rate3"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbclinicalpathway']['labels']["rate3"] : "Est Kelas 3";
   $tab_ger_campos['aktif'] = "on";
   $tab_def_campos['aktif'] = "aktif";
   $tab_labels["aktif"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbclinicalpathway']['labels']["aktif"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbclinicalpathway']['labels']["aktif"] : "Aktif";
   $tab_ger_campos['rate1'] = "none";
   $tab_ger_campos['rate2'] = "none";
   $tab_ger_campos['rate3'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_tbclinicalpathway']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_tbclinicalpathway']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_tbclinicalpathway']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbclinicalpathway']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tbclinicalpathway']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_tbclinicalpathway']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_tbclinicalpathway']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_tbclinicalpathway']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_tbclinicalpathway']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_tbclinicalpathway_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_tbclinicalpathway']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_tbclinicalpathway']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_tbclinicalpathway']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_tbclinicalpathway']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_tbclinicalpathway']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
