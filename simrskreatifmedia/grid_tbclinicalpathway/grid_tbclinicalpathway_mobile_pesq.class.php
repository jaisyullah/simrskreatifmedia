...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "id";$Nm_numeric[] = "";$Nm_numeric[] = "id";$Nm_numeric[] = "";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      ...
      <br><span id="id_hide_id"  <?php echo $str_hide_id?>><INPUT  type="text" id="SC_id" name="id" value="<?php echo NM_encode_input($id) ?>" size=6 alt="{datatype: 'integer', maxLength: 6, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_namacp_cond" name="namacp_cond" onChange="nm_campos_between(document.getElementById('id_vis_namacp'), this, 'namacp')">
      ...
      <br><span id="id_hide_namacp"  <?php echo $str_hide_namacp?>><?php
      if ($namacp != "")
      {
      $namacp_look = substr($this->Db->qstr($namacp), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_aktif_cond" name="aktif_cond" onChange="nm_campos_between(document.getElementById('id_vis_aktif'), this, 'aktif')">
      ...
      <br><span id="id_hide_aktif"  <?php echo $str_hide_aktif?>><?php
      if ($aktif != "")
      {
      $aktif_look = substr($this->Db->qstr($aktif), 1, -1); 
      $nmgp_def_dados = array(); 
