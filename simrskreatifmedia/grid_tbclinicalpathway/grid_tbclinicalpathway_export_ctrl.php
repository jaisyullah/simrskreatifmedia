<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tbclinicalpathway']['sc_process_barr'] = true;
require_once('../grid_tbclinicalpathway/index.php');
unset($_SESSION['scriptcase']['grid_tbclinicalpathway']['sc_process_barr']);
$ExportCtrl = new grid_tbclinicalpathway_export_control;
$ExportCtrl->Export_barr();

class grid_tbclinicalpathway_export_control
{
