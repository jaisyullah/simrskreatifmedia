  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbhrdformal" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbhrdformal_form();
	}

  // ---------- Validate tingkat_
  function do_ajax_form_tbhrdformal_validate_tingkat_(iNumLinha)
  {
    var nomeCampo_tingkat_ = "tingkat_" + iNumLinha;
    var var_tingkat_ = scAjaxGetFieldSelect(nomeCampo_tingkat_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbhrdformal_validate_tingkat_(var_tingkat_, iNumLinha, var_script_case_init, do_ajax_form_tbhrdformal_validate_tingkat__cb);
  } // do_ajax_form_tbhrdformal_validate_tingkat_

  function do_ajax_form_tbhrdformal_validate_tingkat__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "tingkat_" + iLineNumber;
    }
    else
    {
      sFieldValid = "tingkat_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "tingkat_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "tingkat_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbhrdformal_validate_tingkat__cb

  // ---------- Validate instnama_
  function do_ajax_form_tbhrdformal_validate_instnama_(iNumLinha)
  {
    var nomeCampo_instnama_ = "instnama_" + iNumLinha;
    var var_instnama_ = scAjaxGetFieldText(nomeCampo_instnama_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbhrdformal_validate_instnama_(var_instnama_, iNumLinha, var_script_case_init, do_ajax_form_tbhrdformal_validate_instnama__cb);
  } // do_ajax_form_tbhrdformal_validate_instnama_

  function do_ajax_form_tbhrdformal_validate_instnama__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "instnama_" + iLineNumber;
    }
    else
    {
      sFieldValid = "instnama_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "instnama_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "instnama_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbhrdformal_validate_instnama__cb

  // ---------- Validate fakultas_
  function do_ajax_form_tbhrdformal_validate_fakultas_(iNumLinha)
  {
    var nomeCampo_fakultas_ = "fakultas_" + iNumLinha;
    var var_fakultas_ = scAjaxGetFieldText(nomeCampo_fakultas_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbhrdformal_validate_fakultas_(var_fakultas_, iNumLinha, var_script_case_init, do_ajax_form_tbhrdformal_validate_fakultas__cb);
  } // do_ajax_form_tbhrdformal_validate_fakultas_

  function do_ajax_form_tbhrdformal_validate_fakultas__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "fakultas_" + iLineNumber;
    }
    else
    {
      sFieldValid = "fakultas_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "fakultas_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "fakultas_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbhrdformal_validate_fakultas__cb

  // ---------- Validate thlulus_
  function do_ajax_form_tbhrdformal_validate_thlulus_(iNumLinha)
  {
    var nomeCampo_thlulus_ = "thlulus_" + iNumLinha;
    var var_thlulus_ = scAjaxGetFieldText(nomeCampo_thlulus_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbhrdformal_validate_thlulus_(var_thlulus_, iNumLinha, var_script_case_init, do_ajax_form_tbhrdformal_validate_thlulus__cb);
  } // do_ajax_form_tbhrdformal_validate_thlulus_

  function do_ajax_form_tbhrdformal_validate_thlulus__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "thlulus_" + iLineNumber;
    }
    else
    {
      sFieldValid = "thlulus_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "thlulus_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "thlulus_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbhrdformal_validate_thlulus__cb

  // ---------- Validate kodekary_
  function do_ajax_form_tbhrdformal_validate_kodekary_(iNumLinha)
  {
    var nomeCampo_kodekary_ = "kodekary_" + iNumLinha;
    var var_kodekary_ = scAjaxGetFieldText(nomeCampo_kodekary_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbhrdformal_validate_kodekary_(var_kodekary_, iNumLinha, var_script_case_init, do_ajax_form_tbhrdformal_validate_kodekary__cb);
  } // do_ajax_form_tbhrdformal_validate_kodekary_

  function do_ajax_form_tbhrdformal_validate_kodekary__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "kodekary_" + iLineNumber;
    }
    else
    {
      sFieldValid = "kodekary_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "kodekary_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "kodekary_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbhrdformal_validate_kodekary__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_tbhrdformal_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_tbhrdformal_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tbhrdformal_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_tbhrdformal_add_new_line_cb);
  } // do_ajax_form_tbhrdformal_add_new_line

  function do_ajax_form_tbhrdformal_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_tbhrdformal_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_tbhrdformal_backup_line(iNumLinha)
  {
    var var_kodekary_ = scAjaxGetFieldText("kodekary_" + iNumLinha);
    var var_tingkat_ = scAjaxGetFieldSelect("tingkat_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbhrdformal_backup_line(var_kodekary_, var_tingkat_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_tbhrdformal_backup_line_cb);
  } // do_ajax_form_tbhrdformal_backup_line

  function do_ajax_form_tbhrdformal_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_tbhrdformal_backup_line_cb

  function do_ajax_form_tbhrdformal_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_tbhrdformal_cancel_insert

  function do_ajax_form_tbhrdformal_cancel_update(iSeqVert)
  {
    do_ajax_form_tbhrdformal_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_tbhrdformal_cancel_update

  function do_ajax_form_tbhrdformal_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_tbhrdformal_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_tbhrdformal_table_refresh()
  {
    var var_kodekary_ = document.F2.kodekary_.value;
    var var_tingkat_ = document.F2.tingkat_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_tbhrdformal_table_refresh(var_kodekary_, var_tingkat_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbhrdformal_table_refresh_cb);
  } //  do_ajax_form_tbhrdformal_table_refresh

  function do_ajax_form_tbhrdformal_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.kodekary_.value = scAjaxGetKeyValue("kodekary_");
    document.F2.tingkat_.value = scAjaxGetKeyValue("tingkat_");
    ...
    scAjaxAlert(do_ajax_form_tbhrdformal_table_refresh_cb_after_alert);
  } // do_ajax_form_tbhrdformal_table_refresh_cb
  function do_ajax_form_tbhrdformal_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxSetNavStatus("t");
    sc_insert_open = false;
  } // do_ajax_form_tbhrdformal_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_tbhrdformal_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_tbhrdformal_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_tingkat_ = scAjaxGetFieldSelect("tingkat_" + iNumLinha);
    var var_instnama_ = scAjaxGetFieldText("instnama_" + iNumLinha);
    var var_fakultas_ = scAjaxGetFieldText("fakultas_" + iNumLinha);
    var var_thlulus_ = scAjaxGetFieldText("thlulus_" + iNumLinha);
    var var_kodekary_ = scAjaxGetFieldText("kodekary_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_tbhrdformal_submit_form(var_tingkat_, var_instnama_, var_fakultas_, var_thlulus_, var_kodekary_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbhrdformal_submit_form_cb);
  } // do_ajax_form_tbhrdformal_submit_form

  function do_ajax_form_tbhrdformal_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("tingkat_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("instnama_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("fakultas_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("thlulus_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("kodekary_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_tbhrdformal_submit_form_cb_after_alert);
  } // do_ajax_form_tbhrdformal_submit_form_cb
  function do_ajax_form_tbhrdformal_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbhrdformal_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tbhrdformal_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_tbhrdformal_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("tingkat_" + iNavForm);
      scAjaxHideErrorDisplay("instnama_" + iNavForm);
      scAjaxHideErrorDisplay("fakultas_" + iNavForm);
      scAjaxHideErrorDisplay("thlulus_" + iNavForm);
      scAjaxHideErrorDisplay("kodekary_" + iNavForm);
    }
    var var_kodekary_ = document.F2.kodekary_.value;
    var var_tingkat_ = document.F2.tingkat_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tbhrdformal_navigate_form(var_kodekary_, var_tingkat_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbhrdformal_navigate_form_cb);
  } // do_ajax_form_tbhrdformal_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhrdformal']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbhrdformal_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.kodekary_.value = scAjaxGetKeyValue("kodekary_" + var_last_index);
    document.F2.tingkat_.value = scAjaxGetKeyValue("tingkat_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbhrdformal_navigate_form_cb_after_alert);
  } // do_ajax_form_tbhrdformal_navigate_form_cb
  function do_ajax_form_tbhrdformal_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_tbhrdformal_navigate_form_cb_after_alert
  function sc_hide_form_tbhrdformal_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "tingkat_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "instnama_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "fakultas_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "thlulus_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "kodekary_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["tingkat_" + iNumLinha] = {"label": "Tingkat<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["instnama_" + iNumLinha] = {"label": "Nama Lembaga<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["fakultas_" + iNumLinha] = {"label": "Fakultas / Jurusan<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["thlulus_" + iNumLinha] = {"label": "Tahun Lulus<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["kodekary_" + iNumLinha] = {"label": "Kode Kary<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["tingkat_"][iNumLinha] = "tingkat_" + iNumLinha;
    ajax_field_mult["instnama_"][iNumLinha] = "instnama_" + iNumLinha;
    ajax_field_mult["fakultas_"][iNumLinha] = "fakultas_" + iNumLinha;
    ajax_field_mult["thlulus_"][iNumLinha] = "thlulus_" + iNumLinha;
    ajax_field_mult["kodekary_"][iNumLinha] = "kodekary_" + iNumLinha;
    ajax_field_id["tingkat_" + iNumLinha] = new Array("hidden_field_label_tingkat_", "hidden_field_data_tingkat_" + iNumLinha);
    ajax_field_id["instnama_" + iNumLinha] = new Array("hidden_field_label_instnama_", "hidden_field_data_instnama_" + iNumLinha);
    ajax_field_id["fakultas_" + iNumLinha] = new Array("hidden_field_label_fakultas_", "hidden_field_data_fakultas_" + iNumLinha);
    ajax_field_id["thlulus_" + iNumLinha] = new Array("hidden_field_label_thlulus_", "hidden_field_data_thlulus_" + iNumLinha);
    ajax_error_count["tingkat_" + iNumLinha] = "off";
    ajax_error_count["instnama_" + iNumLinha] = "off";
    ajax_error_count["fakultas_" + iNumLinha] = "off";
    ajax_error_count["thlulus_" + iNumLinha] = "off";
    ajax_error_count["kodekary_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["tingkat_" + iNumLinha] = "on";
    ajax_read_only["instnama_" + iNumLinha] = "off";
    ajax_read_only["fakultas_" + iNumLinha] = "off";
    ajax_read_only["thlulus_" + iNumLinha] = "off";
    ajax_read_only["kodekary_" + iNumLinha] = "on";
<?php
}
else
{
?>
    ajax_read_only["tingkat_" + iNumLinha] = "on";
    ajax_read_only["instnama_" + iNumLinha] = "on";
    ajax_read_only["fakultas_" + iNumLinha] = "on";
    ajax_read_only["thlulus_" + iNumLinha] = "on";
    ajax_read_only["kodekary_" + iNumLinha] = "on";
<?php
}
?>
  ...
  {
    ajax_error_list["tingkat_" + iNumLinha] = null;
    ajax_error_list["instnama_" + iNumLinha] = null;
    ajax_error_list["fakultas_" + iNumLinha] = null;
    ajax_error_list["thlulus_" + iNumLinha] = null;
    ajax_error_list["kodekary_" + iNumLinha] = null;
  }
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["tingkat_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["tingkat_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["tingkat_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["tingkat_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["tingkat_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["instnama_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["instnama_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["instnama_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["instnama_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["instnama_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["fakultas_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["fakultas_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["fakultas_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["fakultas_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["fakultas_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["thlulus_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["thlulus_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["thlulus_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["thlulus_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["thlulus_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["kodekary_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["kodekary_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["kodekary_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["kodekary_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["kodekary_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['tingkat_'])) ? $this->nmgp_cmp_readonly['tingkat_'] : 'on';
?>
    scAjaxFieldRead("tingkat_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['instnama_'])) ? $this->nmgp_cmp_readonly['instnama_'] : 'off';
?>
    scAjaxFieldRead("instnama_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['fakultas_'])) ? $this->nmgp_cmp_readonly['fakultas_'] : 'off';
?>
    scAjaxFieldRead("fakultas_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['thlulus_'])) ? $this->nmgp_cmp_readonly['thlulus_'] : 'off';
?>
    scAjaxFieldRead("thlulus_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['kodekary_'])) ? $this->nmgp_cmp_readonly['kodekary_'] : 'on';
?>
    scAjaxFieldRead("kodekary_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("tingkat_" + iSeq, "on");
    scAjaxFieldRead("instnama_" + iSeq, "on");
    scAjaxFieldRead("fakultas_" + iSeq, "on");
    scAjaxFieldRead("thlulus_" + iSeq, "on");
    scAjaxFieldRead("kodekary_" + iSeq, "on");
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["tingkat_" + iRow] || "on" == ajax_error_count["instnama_" + iRow] || "on" == ajax_error_count["fakultas_" + iRow] || "on" == ajax_error_count["thlulus_" + iRow] || "on" == ajax_error_count["kodekary_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_tingkat_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_instnama_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_fakultas_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_thlulus_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_kodekary_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["tingkat_" + iRow] && "off" == ajax_error_count["instnama_" + iRow] && "off" == ajax_error_count["fakultas_" + iRow] && "off" == ajax_error_count["thlulus_" + iRow] && "off" == ajax_error_count["kodekary_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["tingkat_" + iRow] = "off";
        ajax_error_count["instnama_" + iRow] = "off";
        ajax_error_count["fakultas_" + iRow] = "off";
        ajax_error_count["thlulus_" + iRow] = "off";
        ajax_error_count["kodekary_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_tingkat_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_instnama_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_fakultas_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_thlulus_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_kodekary_" + iRow).removeClass("scFormErrorLine");
    }
  }
