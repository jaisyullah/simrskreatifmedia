<form name="F2" method=post 
               action="./" 
               target="_self"> 
<input type="hidden" name="kodekary_" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['kodekary_']); ?>">
<input type="hidden" name="tingkat_" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['tingkat_']); ?>">
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_tbhrdformal"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
function scForm_inline_submit(y, z) {
	Nm_Proc_Atualiz = true;
	do_ajax_form_tbhrdformal_submit_form(y, z);
