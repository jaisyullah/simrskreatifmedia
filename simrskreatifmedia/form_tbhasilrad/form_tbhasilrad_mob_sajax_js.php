  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbhasilrad_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbhasilrad_mob_form();
	}

  // ---------- Validate dicom
  function do_ajax_form_tbhasilrad_mob_validate_dicom()
  {
    var nomeCampo_dicom = "dicom";
    var var_dicom = scAjaxGetFieldText(nomeCampo_dicom);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbhasilrad_mob_validate_dicom(var_dicom, var_script_case_init, do_ajax_form_tbhasilrad_mob_validate_dicom_cb);
  } // do_ajax_form_tbhasilrad_mob_validate_dicom

  function do_ajax_form_tbhasilrad_mob_validate_dicom_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbhasilrad_mob_validate_dicom_cb

  // ---------- Validate hasil
  function do_ajax_form_tbhasilrad_mob_validate_hasil()
  {
    var nomeCampo_hasil = "hasil";
    var var_hasil = scAjaxGetFieldEditorHtml(nomeCampo_hasil);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbhasilrad_mob_validate_hasil(var_hasil, var_script_case_init, do_ajax_form_tbhasilrad_mob_validate_hasil_cb);
  } // do_ajax_form_tbhasilrad_mob_validate_hasil

  function do_ajax_form_tbhasilrad_mob_validate_hasil_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "hasil";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbhasilrad_mob_validate_hasil_cb

  // ---------- Validate struk
  function do_ajax_form_tbhasilrad_mob_validate_struk()
  {
    var nomeCampo_struk = "struk";
    var var_struk = scAjaxGetFieldText(nomeCampo_struk);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbhasilrad_mob_validate_struk(var_struk, var_script_case_init, do_ajax_form_tbhasilrad_mob_validate_struk_cb);
  } // do_ajax_form_tbhasilrad_mob_validate_struk

  function do_ajax_form_tbhasilrad_mob_validate_struk_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "struk";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbhasilrad_mob_validate_struk_cb

  // ---------- Validate template
  function do_ajax_form_tbhasilrad_mob_validate_template()
  {
    var nomeCampo_template = "template";
    var var_template = scAjaxGetFieldText(nomeCampo_template);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbhasilrad_mob_validate_template(var_template, var_script_case_init, do_ajax_form_tbhasilrad_mob_validate_template_cb);
  } // do_ajax_form_tbhasilrad_mob_validate_template

  function do_ajax_form_tbhasilrad_mob_validate_template_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "template";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbhasilrad_mob_validate_template_cb

  // ---------- Validate attachment
  function do_ajax_form_tbhasilrad_mob_validate_attachment()
  {
    var nomeCampo_attachment = "attachment";
    var var_attachment = scAjaxGetFieldText(nomeCampo_attachment);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbhasilrad_mob_validate_attachment(var_attachment, var_script_case_init, do_ajax_form_tbhasilrad_mob_validate_attachment_cb);
  } // do_ajax_form_tbhasilrad_mob_validate_attachment

  function do_ajax_form_tbhasilrad_mob_validate_attachment_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "attachment";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbhasilrad_mob_validate_attachment_cb

  // ---------- Validate attachment2
  function do_ajax_form_tbhasilrad_mob_validate_attachment2()
  {
    var nomeCampo_attachment2 = "attachment2";
    var var_attachment2 = scAjaxGetFieldText(nomeCampo_attachment2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbhasilrad_mob_validate_attachment2(var_attachment2, var_script_case_init, do_ajax_form_tbhasilrad_mob_validate_attachment2_cb);
  } // do_ajax_form_tbhasilrad_mob_validate_attachment2

  function do_ajax_form_tbhasilrad_mob_validate_attachment2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "attachment2";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbhasilrad_mob_validate_attachment2_cb

  // ---------- Validate attachment3
  function do_ajax_form_tbhasilrad_mob_validate_attachment3()
  {
    var nomeCampo_attachment3 = "attachment3";
    var var_attachment3 = scAjaxGetFieldText(nomeCampo_attachment3);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbhasilrad_mob_validate_attachment3(var_attachment3, var_script_case_init, do_ajax_form_tbhasilrad_mob_validate_attachment3_cb);
  } // do_ajax_form_tbhasilrad_mob_validate_attachment3

  function do_ajax_form_tbhasilrad_mob_validate_attachment3_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "attachment3";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbhasilrad_mob_validate_attachment3_cb

  // ---------- Validate trancode
  function do_ajax_form_tbhasilrad_mob_validate_trancode()
  {
    var nomeCampo_trancode = "trancode";
    var var_trancode = scAjaxGetFieldText(nomeCampo_trancode);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbhasilrad_mob_validate_trancode(var_trancode, var_script_case_init, do_ajax_form_tbhasilrad_mob_validate_trancode_cb);
  } // do_ajax_form_tbhasilrad_mob_validate_trancode

  function do_ajax_form_tbhasilrad_mob_validate_trancode_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbhasilrad_mob_validate_trancode_cb

  // ---------- Validate sc_field_1
  function do_ajax_form_tbhasilrad_mob_validate_sc_field_1()
  {
    var nomeCampo_sc_field_1 = "sc_field_1";
    var var_sc_field_1 = scAjaxGetFieldText(nomeCampo_sc_field_1);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbhasilrad_mob_validate_sc_field_1(var_sc_field_1, var_script_case_init, do_ajax_form_tbhasilrad_mob_validate_sc_field_1_cb);
  } // do_ajax_form_tbhasilrad_mob_validate_sc_field_1

  function do_ajax_form_tbhasilrad_mob_validate_sc_field_1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbhasilrad_mob_validate_sc_field_1_cb

  // ---------- Validate diagnosa
  function do_ajax_form_tbhasilrad_mob_validate_diagnosa()
  {
    var nomeCampo_diagnosa = "diagnosa";
    var var_diagnosa = scAjaxGetFieldSelect(nomeCampo_diagnosa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbhasilrad_mob_validate_diagnosa(var_diagnosa, var_script_case_init, do_ajax_form_tbhasilrad_mob_validate_diagnosa_cb);
  } // do_ajax_form_tbhasilrad_mob_validate_diagnosa

  function do_ajax_form_tbhasilrad_mob_validate_diagnosa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbhasilrad_mob_validate_diagnosa_cb

  // ---------- Validate sc_field_0
  function do_ajax_form_tbhasilrad_mob_validate_sc_field_0()
  {
    var nomeCampo_sc_field_0 = "sc_field_0";
    var var_sc_field_0 = scAjaxGetFieldText(nomeCampo_sc_field_0);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbhasilrad_mob_validate_sc_field_0(var_sc_field_0, var_script_case_init, do_ajax_form_tbhasilrad_mob_validate_sc_field_0_cb);
  } // do_ajax_form_tbhasilrad_mob_validate_sc_field_0

  function do_ajax_form_tbhasilrad_mob_validate_sc_field_0_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbhasilrad_mob_validate_sc_field_0_cb

  // ---------- Validate radcode
  function do_ajax_form_tbhasilrad_mob_validate_radcode()
  {
    var nomeCampo_radcode = "radcode";
    var var_radcode = scAjaxGetFieldText(nomeCampo_radcode);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbhasilrad_mob_validate_radcode(var_radcode, var_script_case_init, do_ajax_form_tbhasilrad_mob_validate_radcode_cb);
  } // do_ajax_form_tbhasilrad_mob_validate_radcode

  function do_ajax_form_tbhasilrad_mob_validate_radcode_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "radcode";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbhasilrad_mob_validate_radcode_cb

  // ---------- Refresh trancode
  function do_ajax_form_tbhasilrad_mob_refresh_trancode()
  {
    var var_trancode = scAjaxGetFieldText("trancode");
    var var_nmgp_refresh_fields = "attachment_#fld#_struk_#fld#_attachment2";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tbhasilrad_mob_refresh_trancode(var_trancode, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_tbhasilrad_mob_refresh_trancode_cb);
  } // do_ajax_form_tbhasilrad_mob_refresh_trancode

  function do_ajax_form_tbhasilrad_mob_refresh_trancode_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbhasilrad_mob_refresh_trancode_cb

  // ---------- Event onchange template
  function do_ajax_form_tbhasilrad_mob_event_template_onchange()
  {
    var var_template = scAjaxGetFieldText("template");
    var var_hasil = scAjaxGetFieldEditorHtml("hasil");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tbhasilrad_mob_event_template_onchange(var_template, var_hasil, var_script_case_init, do_ajax_form_tbhasilrad_mob_event_template_onchange_cb);
  } // do_ajax_form_tbhasilrad_mob_event_template_onchange

  function do_ajax_form_tbhasilrad_mob_event_template_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "template";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_tbhasilrad_mob_event_template_onchange_cb_after_alert);
  } // do_ajax_form_tbhasilrad_mob_event_template_onchange_cb
  function do_ajax_form_tbhasilrad_mob_event_template_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbhasilrad_mob_event_template_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tbhasilrad_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tbhasilrad_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_dicom = scAjaxGetFieldText("dicom");
    var var_hasil = scAjaxGetFieldEditorHtml("hasil");
    var var_struk = scAjaxGetFieldText("struk");
    var var_template = scAjaxGetFieldText("template");
    var var_attachment = scAjaxGetFieldText("attachment");
    var var_attachment2 = scAjaxGetFieldText("attachment2");
    var var_attachment3 = scAjaxGetFieldText("attachment3");
    var var_trancode = scAjaxGetFieldText("trancode");
    var var_sc_field_1 = scAjaxGetFieldText("sc_field_1");
    var var_diagnosa = scAjaxGetFieldSelect("diagnosa");
    var var_sc_field_0 = scAjaxGetFieldText("sc_field_0");
    var var_radcode = scAjaxGetFieldText("radcode");
    var var_attachment_ul_name = scAjaxSpecCharProtect(document.F1.attachment_ul_name.value);//.replace(/[+]/g, "__NM_PLUS__");
    var var_attachment_ul_type = document.F1.attachment_ul_type.value;
    var var_attachment2_ul_name = scAjaxSpecCharProtect(document.F1.attachment2_ul_name.value);//.replace(/[+]/g, "__NM_PLUS__");
    var var_attachment2_ul_type = document.F1.attachment2_ul_type.value;
    var var_attachment3_ul_name = scAjaxSpecCharProtect(document.F1.attachment3_ul_name.value);//.replace(/[+]/g, "__NM_PLUS__");
    var var_attachment3_ul_type = document.F1.attachment3_ul_type.value;
    var var_dicom_ul_name = scAjaxSpecCharProtect(document.F1.dicom_ul_name.value);//.replace(/[+]/g, "__NM_PLUS__");
    var var_dicom_ul_type = document.F1.dicom_ul_type.value;
    var var_dicom_salva = scAjaxSpecCharProtect(document.F1.dicom_salva.value);//.replace(/[+]/g, "__NM_PLUS__");
    var var_dicom_limpa = document.F1.dicom_limpa.checked ? "S" : "N";
    var var_attachment_salva = scAjaxSpecCharProtect(document.F1.attachment_salva.value);//.replace(/[+]/g, "__NM_PLUS__");
    var var_attachment_limpa = document.F1.attachment_limpa.checked ? "S" : "N";
    var var_attachment2_salva = scAjaxSpecCharProtect(document.F1.attachment2_salva.value);//.replace(/[+]/g, "__NM_PLUS__");
    var var_attachment2_limpa = document.F1.attachment2_limpa.checked ? "S" : "N";
    var var_attachment3_salva = scAjaxSpecCharProtect(document.F1.attachment3_salva.value);//.replace(/[+]/g, "__NM_PLUS__");
    var var_attachment3_limpa = document.F1.attachment3_limpa.checked ? "S" : "N";
    ...
    scAjaxProcOn();
    x_ajax_form_tbhasilrad_mob_submit_form(var_dicom, var_hasil, var_struk, var_template, var_attachment, var_attachment2, var_attachment3, var_trancode, var_sc_field_1, var_diagnosa, var_sc_field_0, var_radcode, var_attachment_ul_name, var_attachment_ul_type, var_attachment2_ul_name, var_attachment2_ul_type, var_attachment3_ul_name, var_attachment3_ul_type, var_dicom_ul_name, var_dicom_ul_type, var_dicom_salva, var_dicom_limpa, var_attachment_salva, var_attachment_limpa, var_attachment2_salva, var_attachment2_limpa, var_attachment3_salva, var_attachment3_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbhasilrad_mob_submit_form_cb);
  } // do_ajax_form_tbhasilrad_mob_submit_form

  function do_ajax_form_tbhasilrad_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("dicom");
      scAjaxHideErrorDisplay("hasil");
      scAjaxHideErrorDisplay("struk");
      scAjaxHideErrorDisplay("template");
      scAjaxHideErrorDisplay("attachment");
      scAjaxHideErrorDisplay("attachment2");
      scAjaxHideErrorDisplay("attachment3");
      ...
      scAjaxHideErrorDisplay("radcode");
      scLigEditLookupCall();
<?php
...
?>
    ...
    if (!scAjaxHasError())
    {
      ...
      if (document.F1.dicom_limpa && document.F1.dicom_limpa.checked)
      {
        var oImgTemp = {0: {"value" : ""}};
        scAjaxSetFieldDocument("dicom", oImgTemp, "", "");
      }
      else if (document.getElementById("id_ajax_doc_dicom") && "" != document.getElementById("id_ajax_doc_dicom").innerHTML)
      {
        document.getElementById("id_ajax_doc_dicom").style.display = "";
      }
      if (document.F1.attachment_limpa && document.F1.attachment_limpa.checked)
      {
        var oImgTemp = {0: {"value" : ""}};
        scAjaxSetFieldImage("attachment", oImgTemp, "", "", "", "N");
      }
      if (document.F1.attachment2_limpa && document.F1.attachment2_limpa.checked)
      {
        var oImgTemp = {0: {"value" : ""}};
        scAjaxSetFieldImage("attachment2", oImgTemp, "", "", "", "N");
      }
      if (document.F1.attachment3_limpa && document.F1.attachment3_limpa.checked)
      {
        var oImgTemp = {0: {"value" : ""}};
        scAjaxSetFieldImage("attachment3", oImgTemp, "", "", "", "N");
      }
    document.F1.attachment_ul_name.value = '';
    document.F1.attachment_ul_type.value = '';
    document.F1.attachment2_ul_name.value = '';
    document.F1.attachment2_ul_type.value = '';
    document.F1.attachment3_ul_name.value = '';
    document.F1.attachment3_ul_type.value = '';
    }
    scAjaxShowDebug();
    scAjaxSetDisplay();
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tbhasilrad_mob_submit_form_cb_after_alert);
  } // do_ajax_form_tbhasilrad_mob_submit_form_cb
  function do_ajax_form_tbhasilrad_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbhasilrad_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tbhasilrad_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_struk = document.F2.struk.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tbhasilrad_mob_navigate_form(var_trancode, var_struk, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbhasilrad_mob_navigate_form_cb);
  } // do_ajax_form_tbhasilrad_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhasilrad_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbhasilrad_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.struk.value = scAjaxGetKeyValue("struk");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbhasilrad_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_tbhasilrad_mob_navigate_form_cb
  function do_ajax_form_tbhasilrad_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_tbhasilrad_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_tbhasilrad_mob_navigate_form_cb_after_alert
  function sc_hide_form_tbhasilrad_mob_form()
  {
  ...
  ajax_field_list[0] = "dicom";
  ajax_field_list[1] = "hasil";
  ajax_field_list[2] = "struk";
  ajax_field_list[3] = "template";
  ajax_field_list[4] = "attachment";
  ajax_field_list[5] = "attachment2";
  ajax_field_list[6] = "attachment3";
  ajax_field_list[7] = "trancode";
  ajax_field_list[8] = "sc_field_1";
  ajax_field_list[9] = "diagnosa";
  ajax_field_list[10] = "sc_field_0";
  ajax_field_list[11] = "radcode";
  ...
  var ajax_error_list = {
    "dicom": {"label": "Dicom", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "hasil": {"label": "Expertise", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "struk": {"label": "Struk", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "template": {"label": "Gunakan Template", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "attachment": {"label": "Foto Radiologi", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "attachment2": {"label": "Attachment", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "attachment3": {"label": "Attachment 3", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "sc_field_1": {"label": "No RM", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "radcode": {"label": "Petugas", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    ...
    "attachment2": new Array(),
    "attachment3": new Array(),
    "trancode": new Array(),
  ...
  ajax_field_mult["dicom"][1] = "dicom";
  ajax_field_mult["hasil"][1] = "hasil";
  ajax_field_mult["struk"][1] = "struk";
  ajax_field_mult["template"][1] = "template";
  ajax_field_mult["attachment"][1] = "attachment";
  ajax_field_mult["attachment2"][1] = "attachment2";
  ajax_field_mult["attachment3"][1] = "attachment3";
  ...
  ajax_field_mult["radcode"][1] = "radcode";

  var ajax_field_id = {
    "dicom": new Array("hidden_field_label_dicom", "hidden_field_data_dicom"),
    "hasil": new Array("hidden_field_label_hasil", "hidden_field_data_hasil"),
    "template": new Array("hidden_field_label_template", "hidden_field_data_template"),
    "attachment": new Array("hidden_field_label_attachment", "hidden_field_data_attachment"),
    "attachment2": new Array("hidden_field_label_attachment2", "hidden_field_data_attachment2"),
    "attachment3": new Array("hidden_field_label_attachment3", "hidden_field_data_attachment3"),
