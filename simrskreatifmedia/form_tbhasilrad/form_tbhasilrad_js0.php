<form name="F2" method=post 
               action="./" 
               target="_self"> 
<input type="hidden" name="trancode" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['trancode']); ?>">
<input type="hidden" name="struk" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['struk']); ?>">
...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhasilrad']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
  <input type="hidden" name="script_case_session" value="<?php echo $this->form_encode_input(session_id()); ?>"> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_tbhasilrad"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
?> 
var var_btn_Cetak_var_rad = "<?php echo $this->form_encode_input($this->nmgp_dados_form['trancode']); ?>";
...
{
  nm_gp_submit('<?php echo $this->Ini->link_pdfreport_tbhasilrad_cons; ?>', '<?php echo $this->nm_location; ?>', '<?php echo "var_rad*scin' + var_btn_Cetak_var_rad + '*scout"; ?>', 'inicio', '_blank', '0', '0', 'pdfreport_tbhasilrad');
}
 NM_tp_critica(1);
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhasilrad']['where_detal']))
  {
?>  
...
function nm_mostra_doc(campo1, campo2, campo3)
{
    ...
    NovaJanela = window.open ("form_tbhasilrad_doc.php?script_case_init=<?php echo $this->form_encode_input($this->Ini->sc_page); ?>&script_case_session=<?php echo session_id() ?>&nm_cod_doc=" + campo1 + "&nm_nome_doc=" + encodeURIComponent(campo2) + "&nm_cod_apl=" + campo3, "sc_name_download_iframe", "resizable, scrollbars");
}
...
{
   nm_field_disabled("diagnosa=disabled", "");
