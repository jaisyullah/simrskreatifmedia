  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbhasilrad" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbhasilrad_form();
	}

  // ---------- Validate dicom
  function do_ajax_form_tbhasilrad_validate_dicom()
  {
    var nomeCampo_dicom = "dicom";
    var var_dicom = scAjaxGetFieldText(nomeCampo_dicom);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbhasilrad_validate_dicom(var_dicom, var_script_case_init, do_ajax_form_tbhasilrad_validate_dicom_cb);
  } // do_ajax_form_tbhasilrad_validate_dicom

  function do_ajax_form_tbhasilrad_validate_dicom_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbhasilrad_validate_dicom_cb

  // ---------- Validate hasil
  function do_ajax_form_tbhasilrad_validate_hasil()
  {
    var nomeCampo_hasil = "hasil";
    var var_hasil = scAjaxGetFieldEditorHtml(nomeCampo_hasil);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbhasilrad_validate_hasil(var_hasil, var_script_case_init, do_ajax_form_tbhasilrad_validate_hasil_cb);
  } // do_ajax_form_tbhasilrad_validate_hasil

  function do_ajax_form_tbhasilrad_validate_hasil_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "hasil";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbhasilrad_validate_hasil_cb

  // ---------- Validate struk
  function do_ajax_form_tbhasilrad_validate_struk()
  {
    var nomeCampo_struk = "struk";
    var var_struk = scAjaxGetFieldText(nomeCampo_struk);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbhasilrad_validate_struk(var_struk, var_script_case_init, do_ajax_form_tbhasilrad_validate_struk_cb);
  } // do_ajax_form_tbhasilrad_validate_struk

  function do_ajax_form_tbhasilrad_validate_struk_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "struk";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbhasilrad_validate_struk_cb

  // ---------- Validate template
  function do_ajax_form_tbhasilrad_validate_template()
  {
    var nomeCampo_template = "template";
    var var_template = scAjaxGetFieldText(nomeCampo_template);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbhasilrad_validate_template(var_template, var_script_case_init, do_ajax_form_tbhasilrad_validate_template_cb);
  } // do_ajax_form_tbhasilrad_validate_template

  function do_ajax_form_tbhasilrad_validate_template_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbhasilrad_validate_template_cb

  // ---------- Validate attachment
  function do_ajax_form_tbhasilrad_validate_attachment()
  {
    var nomeCampo_attachment = "attachment";
    var var_attachment = scAjaxGetFieldText(nomeCampo_attachment);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbhasilrad_validate_attachment(var_attachment, var_script_case_init, do_ajax_form_tbhasilrad_validate_attachment_cb);
  } // do_ajax_form_tbhasilrad_validate_attachment

  function do_ajax_form_tbhasilrad_validate_attachment_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbhasilrad_validate_attachment_cb

  // ---------- Validate attachment2
  function do_ajax_form_tbhasilrad_validate_attachment2()
  {
    var nomeCampo_attachment2 = "attachment2";
    var var_attachment2 = scAjaxGetFieldText(nomeCampo_attachment2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbhasilrad_validate_attachment2(var_attachment2, var_script_case_init, do_ajax_form_tbhasilrad_validate_attachment2_cb);
  } // do_ajax_form_tbhasilrad_validate_attachment2

  function do_ajax_form_tbhasilrad_validate_attachment2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbhasilrad_validate_attachment2_cb

  // ---------- Validate attachment3
  function do_ajax_form_tbhasilrad_validate_attachment3()
  {
    var nomeCampo_attachment3 = "attachment3";
    var var_attachment3 = scAjaxGetFieldText(nomeCampo_attachment3);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbhasilrad_validate_attachment3(var_attachment3, var_script_case_init, do_ajax_form_tbhasilrad_validate_attachment3_cb);
  } // do_ajax_form_tbhasilrad_validate_attachment3

  function do_ajax_form_tbhasilrad_validate_attachment3_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbhasilrad_validate_attachment3_cb

  // ---------- Validate trancode
  function do_ajax_form_tbhasilrad_validate_trancode()
  {
    var nomeCampo_trancode = "trancode";
    var var_trancode = scAjaxGetFieldText(nomeCampo_trancode);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbhasilrad_validate_trancode(var_trancode, var_script_case_init, do_ajax_form_tbhasilrad_validate_trancode_cb);
  } // do_ajax_form_tbhasilrad_validate_trancode

  function do_ajax_form_tbhasilrad_validate_trancode_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbhasilrad_validate_trancode_cb

  // ---------- Validate sc_field_1
  function do_ajax_form_tbhasilrad_validate_sc_field_1()
  {
    var nomeCampo_sc_field_1 = "sc_field_1";
    var var_sc_field_1 = scAjaxGetFieldText(nomeCampo_sc_field_1);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbhasilrad_validate_sc_field_1(var_sc_field_1, var_script_case_init, do_ajax_form_tbhasilrad_validate_sc_field_1_cb);
  } // do_ajax_form_tbhasilrad_validate_sc_field_1

  function do_ajax_form_tbhasilrad_validate_sc_field_1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbhasilrad_validate_sc_field_1_cb

  // ---------- Validate diagnosa
  function do_ajax_form_tbhasilrad_validate_diagnosa()
  {
    var nomeCampo_diagnosa = "diagnosa";
    var var_diagnosa = scAjaxGetFieldSelect(nomeCampo_diagnosa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbhasilrad_validate_diagnosa(var_diagnosa, var_script_case_init, do_ajax_form_tbhasilrad_validate_diagnosa_cb);
  } // do_ajax_form_tbhasilrad_validate_diagnosa

  function do_ajax_form_tbhasilrad_validate_diagnosa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbhasilrad_validate_diagnosa_cb

  // ---------- Validate sc_field_0
  function do_ajax_form_tbhasilrad_validate_sc_field_0()
  {
    var nomeCampo_sc_field_0 = "sc_field_0";
    var var_sc_field_0 = scAjaxGetFieldText(nomeCampo_sc_field_0);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbhasilrad_validate_sc_field_0(var_sc_field_0, var_script_case_init, do_ajax_form_tbhasilrad_validate_sc_field_0_cb);
  } // do_ajax_form_tbhasilrad_validate_sc_field_0

  function do_ajax_form_tbhasilrad_validate_sc_field_0_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbhasilrad_validate_sc_field_0_cb

  // ---------- Validate radcode
  function do_ajax_form_tbhasilrad_validate_radcode()
  {
    var nomeCampo_radcode = "radcode";
    var var_radcode = scAjaxGetFieldText(nomeCampo_radcode);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbhasilrad_validate_radcode(var_radcode, var_script_case_init, do_ajax_form_tbhasilrad_validate_radcode_cb);
  } // do_ajax_form_tbhasilrad_validate_radcode

  function do_ajax_form_tbhasilrad_validate_radcode_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "radcode";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbhasilrad_validate_radcode_cb

  // ---------- Refresh trancode
  function do_ajax_form_tbhasilrad_refresh_trancode()
  {
    ...
    scAjaxProcOn(true);
    x_ajax_form_tbhasilrad_refresh_trancode(var_trancode, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_tbhasilrad_refresh_trancode_cb);
  } // do_ajax_form_tbhasilrad_refresh_trancode

  function do_ajax_form_tbhasilrad_refresh_trancode_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbhasilrad_refresh_trancode_cb

  // ---------- Event onchange template
  function do_ajax_form_tbhasilrad_event_template_onchange()
  {
    var var_template = scAjaxGetFieldText("template");
    var var_hasil = scAjaxGetFieldEditorHtml("hasil");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tbhasilrad_event_template_onchange(var_template, var_hasil, var_script_case_init, do_ajax_form_tbhasilrad_event_template_onchange_cb);
  } // do_ajax_form_tbhasilrad_event_template_onchange

  function do_ajax_form_tbhasilrad_event_template_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "template";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_tbhasilrad_event_template_onchange_cb_after_alert);
  } // do_ajax_form_tbhasilrad_event_template_onchange_cb
  function do_ajax_form_tbhasilrad_event_template_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbhasilrad_event_template_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tbhasilrad_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tbhasilrad_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_tbhasilrad_submit_form(var_dicom, var_hasil, var_struk, var_template, var_attachment, var_attachment2, var_attachment3, var_trancode, var_sc_field_1, var_diagnosa, var_sc_field_0, var_radcode, var_attachment_ul_name, var_attachment_ul_type, var_attachment2_ul_name, var_attachment2_ul_type, var_attachment3_ul_name, var_attachment3_ul_type, var_dicom_ul_name, var_dicom_ul_type, var_dicom_salva, var_dicom_limpa, var_attachment_salva, var_attachment_limpa, var_attachment2_salva, var_attachment2_limpa, var_attachment3_salva, var_attachment3_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbhasilrad_submit_form_cb);
  } // do_ajax_form_tbhasilrad_submit_form

  function do_ajax_form_tbhasilrad_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tbhasilrad_submit_form_cb_after_alert);
  } // do_ajax_form_tbhasilrad_submit_form_cb
  function do_ajax_form_tbhasilrad_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbhasilrad_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tbhasilrad_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tbhasilrad_navigate_form(var_trancode, var_struk, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbhasilrad_navigate_form_cb);
  } // do_ajax_form_tbhasilrad_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbhasilrad']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbhasilrad_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbhasilrad_navigate_form_cb_after_alert);
  } // do_ajax_form_tbhasilrad_navigate_form_cb
  function do_ajax_form_tbhasilrad_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_tbhasilrad_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_tbhasilrad_navigate_form_cb_after_alert
  function sc_hide_form_tbhasilrad_form()
  {
