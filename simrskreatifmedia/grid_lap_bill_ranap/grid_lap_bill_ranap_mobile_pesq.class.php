...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "a.tglKeluar";$Nm_datas[] = "a_tglKeluar";$Nm_datas[] = "e.tglMasuk";$Nm_datas[] = "e_tglMasuk";$Nm_numeric[] = "";
...
<span id='id_date_part_tglkeluar_DD' style='display: inline-block'>
         ...
         <SELECT class="scFilterObjectEven" id="SC_tglkeluar_dia" name="tglkeluar_dia">
          <OPTION value=""></OPTION>
...
<span id='id_date_part_tglkeluar_MM' style='display: inline-block'>
         ...
         <SELECT class="scFilterObjectEven" id="SC_tglkeluar_mes" name="tglkeluar_mes">
          <OPTION value=""></OPTION>
...
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_tglkeluar_ano" name="tglkeluar_ano" value="<?php echo NM_encode_input($tglkeluar_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
...
?>
          ...
          <BR>
        <SPAN id="id_vis_tglkeluar"  <?php echo $str_display_tglkeluar; ?> class="scFilterFieldFontEven">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <?php
...
<span id='id_date_part_tglkeluar_input_2_DD' style='display: inline-block'>
         ...
         <SELECT class="scFilterObjectEven" id="SC_tglkeluar_input_2_dia" name="tglkeluar_input_2_dia">
          <OPTION value=""></OPTION>
...
<span id='id_date_part_tglkeluar_input_2_MM' style='display: inline-block'>
         ...
         <SELECT class="scFilterObjectEven" id="SC_tglkeluar_input_2_mes" name="tglkeluar_input_2_mes">
          <OPTION value=""></OPTION>
...
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_tglkeluar_input_2_ano" name="tglkeluar_input_2_ano" value="<?php echo NM_encode_input($tglkeluar_input_2_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_poli"  <?php echo $str_hide_poli?>><?php
      if ($poli != "")
      {
      $poli_look = substr($this->Db->qstr($poli), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_dpjp"  <?php echo $str_hide_dpjp?>><INPUT  type="text" id="SC_dpjp" name="dpjp" value="<?php echo NM_encode_input($dpjp) ?>"  size=50 alt="{datatype: 'text', maxLength: 222, allowedChars: '', lettersCase: 'upper', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
