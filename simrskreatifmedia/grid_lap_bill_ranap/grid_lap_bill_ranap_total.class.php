...
class grid_lap_bill_ranap_total
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function __construct($sc_page)
   {
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['grid_lap_bill_ranap']['campos_busca']) && !empty($_SESSION['sc_session'][$this->sc_page]['grid_lap_bill_ranap']['campos_busca']))
      { 
