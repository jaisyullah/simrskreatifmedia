<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_lap_bill_ranap']['glo_nm_path_imag_temp'] . "/sc_apl_default_simrskreatifmedia.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_lap_bill_ranap_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_lap_bill_ranap_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_lap_bill_ranap']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_lap_bill_ranap']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["rm"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_lap_bill_ranap']['labels']["rm"])) ? $_SESSION['sc_session'][$sc_init]['grid_lap_bill_ranap']['labels']["rm"] : "RM";
   $tab_ger_campos['pasien'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['pasien'] = "pasien";
   }
   else
   {
       $tab_def_campos['pasien'] = "concat( c.NAME,', ',c.salut )";
   }
   $tab_labels["pasien"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_lap_bill_ranap']['labels']["pasien"])) ? $_SESSION['sc_session'][$sc_init]['grid_lap_bill_ranap']['labels']["pasien"] : "Pasien";
   $tab_ger_campos['carabayar'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['carabayar'] = "carabayar";
   }
   else
   {
       $tab_def_campos['carabayar'] = "e.pembayaran";
   }
   $tab_labels["carabayar"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_lap_bill_ranap']['labels']["carabayar"])) ? $_SESSION['sc_session'][$sc_init]['grid_lap_bill_ranap']['labels']["carabayar"] : "Cara Bayar";
   ...
   {
       $tab_def_campos['tglmasuk'] = "e.tglMasuk";
   }
   $tab_labels["tglmasuk"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_lap_bill_ranap']['labels']["tglmasuk"])) ? $_SESSION['sc_session'][$sc_init]['grid_lap_bill_ranap']['labels']["tglmasuk"] : "Tgl Masuk";
   ...
   $tab_labels["tglkeluar"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_lap_bill_ranap']['labels']["tglkeluar"])) ? $_SESSION['sc_session'][$sc_init]['grid_lap_bill_ranap']['labels']["tglkeluar"] : "Tgl Keluar";
   $tab_ger_campos['dpjp'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['dpjp'] = "dpjp";
   }
   else
   {
       $tab_def_campos['dpjp'] = "concat( b.gelar,'. ',b.NAME,', ',b.spec )";
   }
   $tab_labels["dpjp"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_lap_bill_ranap']['labels']["dpjp"])) ? $_SESSION['sc_session'][$sc_init]['grid_lap_bill_ranap']['labels']["dpjp"] : "DPJP";
   $tab_ger_campos['poli'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['poli'] = "poli";
   }
   else
   {
       $tab_def_campos['poli'] = "d.NAME";
   }
   $tab_labels["poli"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_lap_bill_ranap']['labels']["poli"])) ? $_SESSION['sc_session'][$sc_init]['grid_lap_bill_ranap']['labels']["poli"] : "Poli";
   ...
   {
       $tab_def_campos['sc_field_0'] = "a.caraKeluar";
   }
   $tab_labels["sc_field_0"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_lap_bill_ranap']['labels']["sc_field_0"])) ? $_SESSION['sc_session'][$sc_init]['grid_lap_bill_ranap']['labels']["sc_field_0"] : "Status Keluar";
   ...
   $tab_labels["total"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_lap_bill_ranap']['labels']["total"])) ? $_SESSION['sc_session'][$sc_init]['grid_lap_bill_ranap']['labels']["total"] : "Total";
   $tab_ger_campos['verifstatus'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['verifstatus'] = "verifStatus";
   }
   else
   {
       $tab_def_campos['verifstatus'] = "";
   }
   $tab_labels["verifstatus"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_lap_bill_ranap']['labels']["verifstatus"])) ? $_SESSION['sc_session'][$sc_init]['grid_lap_bill_ranap']['labels']["verifstatus"] : "Verif Status";
   $tab_ger_campos['verifiedby'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['verifiedby'] = "VerifiedBy";
   }
   else
   {
       $tab_def_campos['verifiedby'] = "";
   }
   $tab_labels["verifiedby"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_lap_bill_ranap']['labels']["verifiedby"])) ? $_SESSION['sc_session'][$sc_init]['grid_lap_bill_ranap']['labels']["verifiedby"] : "Verified Oleh";
   ...
   {
       $tab_def_campos['deposit'] = "";
   }
   $tab_labels["deposit"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_lap_bill_ranap']['labels']["deposit"])) ? $_SESSION['sc_session'][$sc_init]['grid_lap_bill_ranap']['labels']["deposit"] : "Deposit";
   ...
   {
       $tab_def_campos['selisih'] = "";
   }
   $tab_labels["selisih"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_lap_bill_ranap']['labels']["selisih"])) ? $_SESSION['sc_session'][$sc_init]['grid_lap_bill_ranap']['labels']["selisih"] : "Selisih";
   $tab_ger_campos['e_kelas'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['e_kelas'] = "e_kelas";
   }
   else
   {
       $tab_def_campos['e_kelas'] = "e.kelas";
   }
   $tab_labels["e_kelas"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_lap_bill_ranap']['labels']["e_kelas"])) ? $_SESSION['sc_session'][$sc_init]['grid_lap_bill_ranap']['labels']["e_kelas"] : "Hak Kelas";
   $tab_ger_campos['total'] = "none";
   $tab_ger_campos['verifstatus'] = "none";
   $tab_ger_campos['verifiedby'] = "none";
   $tab_ger_campos['deposit'] = "none";
   $tab_ger_campos['selisih'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_lap_bill_ranap']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_lap_bill_ranap']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_lap_bill_ranap']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_lap_bill_ranap']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_lap_bill_ranap']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_lap_bill_ranap']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_lap_bill_ranap']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_lap_bill_ranap']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_lap_bill_ranap']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_lap_bill_ranap_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_lap_bill_ranap']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_lap_bill_ranap']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_lap_bill_ranap']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_lap_bill_ranap']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_lap_bill_ranap']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
