...
class grid_lap_bill_ranap_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function __construct($tipo = "")
   {
      ...
      $this->array_total_carabayar = array();
   ...
   { 
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['grid_lap_bill_ranap']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['grid_lap_bill_ranap']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['where_resumo']);
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['proc_res'] = true;
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['res_hrz'];
      $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
      $dir_raiz          = substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['where_resumo'] = "";
      }
      $this->inicializa_vars();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['contr_total_geral'] == "OK")
      {
          $this->array_total_carabayar = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['arr_total']['carabayar'];
      }
      else
      {
          $this->array_total_carabayar = array();
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['tot_geral'][2];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['tot_geral'][1] == 0)
      {
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          $this->drawMatrix();
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['json_use_label'])
       {
          $Lab_carabayar = "CaraBayar";
       }
       else
       {
          $Lab_carabayar = "Cara Bayar";
       }
       $this->comp_field = array(
           $Lab_carabayar,
       );

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['labels']['rm']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['labels']['rm'] = "RM"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['labels']['pasien']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['labels']['pasien'] = "Pasien"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['labels']['carabayar']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['labels']['carabayar'] = "Cara Bayar"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['labels']['tglmasuk']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['labels']['tglmasuk'] = "Tgl Masuk"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['labels']['tglkeluar']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['labels']['tglkeluar'] = "Tgl Keluar"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['labels']['dpjp']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['labels']['dpjp'] = "DPJP"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['labels']['poli']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['labels']['poli'] = "Poli"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['labels']['sc_field_0']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['labels']['sc_field_0'] = "Status Keluar"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['labels']['total']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['labels']['total'] = "Total"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['labels']['verifstatus']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['labels']['verifstatus'] = "Verif Status"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['labels']['verifiedby']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['labels']['verifiedby'] = "Verified Oleh"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['labels']['deposit']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['labels']['deposit'] = "Deposit"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['labels']['selisih']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['labels']['selisih'] = "Selisih"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['labels']['e_kelas']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['labels']['e_kelas'] = "Hak Kelas"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['labels']['trancode']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['labels']['trancode'] = "Kode Transaksi"; 
       }
       //-----
       $this->comp_field_nm = array(
           'carabayar' => 0,
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['summarizing_fields_order']['CaraBayar']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['summarizing_fields_order']['CaraBayar'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['summarizing_fields_order']['CaraBayar'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['summarizing_fields_display']['CaraBayar'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['summarizing_fields_display']['CaraBayar'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['summarizing_fields_display']['CaraBayar'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['summarizing_fields_display']['CaraBayar'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['summarizing_fields_display']['CaraBayar'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['summarizing_fields_display']['CaraBayar'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['summarizing_fields_display']['CaraBayar'] as $i_sum => $d_sum)
           {
       ...
       //-----
       foreach ($this->array_total_carabayar as $i_carabayar => $d_carabayar) {
           if (!in_array($i_carabayar, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_carabayar[3] ] = $d_carabayar[2];
               $this->comp_label[0][ $d_carabayar[3] ] = $d_carabayar[2];
           }
       }
       ...
       //-----
       $this->comp_links_fl = array(
           array('name' => 'carabayar', 'prot' => '@aspass@'),
       );
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['pivot_order_level'] = -1;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['pivot_tabular_label'];
       ...
       //-----
       foreach ($this->comp_label[0] as $i_carabayar => $l_carabayar) {
           if (isset($this->array_total_carabayar[$i_carabayar])) {
               $this->comp_group[$i_carabayar] = array();
           }
       }
   ...
   function getCompData($level, $params = array()) {
       if (0 == $level) {
           $return = $this->array_total_carabayar;
       }
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_lap_bill_ranap@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function buildChart()
   {
       ...
       $this->comp_chart_config = array(
           '0|1' => array(
               ...
               'label_x'  => $this->getChartText(strip_tags($Lab_carabayar)),
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['pivot_charts']    = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['pivot_orig']      = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['comb_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['comb_table_def']  = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['anlt_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['anlt_table_def']  = array();
	...
	function filterChartsByGroupbyLevel() {
		...
		if (isset($nmgp_opcao) && ('pdf' == $nmgp_opcao || 'pdf_res' == $nmgp_opcao) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['chart_level']) && '' !== $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['chart_level']) {
			$applyFilter = true;
		}
		elseif (isset($nmgp_opcao) && 'image_res' == $nmgp_opcao && isset($_POST['chart_level']) && '' !== $_POST['chart_level']) {
			$applyFilter = true;
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['chart_level'] = $_POST['chart_level'];
		}
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['pivot_charts'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['pivot_orig'];

		if ($applyFilter) {
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['pivot_charts'] as $chartIndex => $chartData) {
				...
				if ($groupbyLevel > $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['chart_level']) {
					unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['pivot_charts'][$chartIndex]);
				}
			}
		}

		$this->comp_chart_data = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['pivot_charts'];
	}
           ...
           foreach ($a_totals as $i_total => $values)
           {
               ...
               if (isset($this->comp_chart_config[$key_config]))
               {
                   ...
                   foreach ($a_keys as $tmp_key)
                   {
                       ...
                       $xml_links[]  = $this->getFusionLink('sc_grid_lap_bill_ranap_' . session_id() . '_!!!' . implode('_', array_merge(array($group + 1, $i_total), $link_index)) . '!!!.json');
                   }
                   ...
                   $this->comp_chart_data[$key_data]['xml']        = $this->getFusionLink('sc_grid_lap_bill_ranap_' . session_id() . '_!!!' . implode('_', array_merge(array($group, $i_total), $param)) . '!!!.json');
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['proc_pdf_vert']){ 
   ...
   {
       if (!$res_chart && $this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['json_use_format']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['json_use_format'])
       {
           return $valor_campo;
       }
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function inicializa_vars()
   {
      ...
      $this->Total   = new grid_lap_bill_ranap_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['tot_geral'] as $ind => $val)
      {
          if ($ind > 0)
          {
      ...
      $this->array_total_carabayar = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['arr_total']['carabayar'];
      ksort($this->array_total_carabayar);
   }
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_lap_bill_ranap_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "grid_lap_bill_ranap/grid_lap_bill_ranap_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
       $nm_saida->saida("" . $tp_quebra . "\r\n");
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['responsive_chart']['active']) {
...
//--- 
   ...
   {
      global $nm_saida;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
      ...
      { 
        ...
        if ($_SESSION['scriptcase']['charset'] != "UTF-8")
        {
          ...
          $tglmasuk = $Busca_temp['tglmasuk']; 
          $tmp_pos = strpos($tglmasuk, "##@@");
          if ($tmp_pos !== false && !is_array($tglmasuk))
          {
          ...
          $dpjp = $Busca_temp['dpjp']; 
          $tmp_pos = strpos($dpjp, "##@@");
          if ($tmp_pos !== false && !is_array($dpjp))
          {
   ...
   //---- 
   function adiciona_registro($sum_total, $quebra_carabayar, $quebra_carabayar_orig)
   {
      //----- Cara Bayar
      if (!isset($this->array_total_carabayar[$quebra_carabayar_orig]))
      {
         $this->array_total_carabayar[$quebra_carabayar_orig][0] = 1;
         $this->array_total_carabayar[$quebra_carabayar_orig][1] = $sum_total;
         $this->array_total_carabayar[$quebra_carabayar_orig][2] = $quebra_carabayar;
         $this->array_total_carabayar[$quebra_carabayar_orig][3] = $quebra_carabayar_orig;
      }
      else
      {
         $this->array_total_carabayar[$quebra_carabayar_orig][0]++;
         $this->array_total_carabayar[$quebra_carabayar_orig][1] += $sum_total;
      }
      //----- Total
   ...
   {
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['arr_total']['carabayar'] as $campo_carabayar => $dados_carabayar)
      {
         $this->array_total_carabayar[$campo_carabayar][1] = $dados_carabayar[1];
      }
   }
   //---- 
...
$_SESSION['scriptcase']['grid_lap_bill_ranap']['contr_erro'] = 'off'; 
     ...
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('', 'carabayar');
     $campos_order = $this->Ini->Get_date_order_groupby("e.pembayaran", 'asc', $format, $campos_order);
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->rm = $rs_res->fields[0] ;  
            $this->pasien = $rs_res->fields[1] ;  
            $this->carabayar = $rs_res->fields[2] ;  
            $this->tglmasuk = $rs_res->fields[3] ;  
            $this->tglkeluar = $rs_res->fields[4] ;  
            $this->dpjp = $rs_res->fields[5] ;  
            $this->poli = $rs_res->fields[6] ;  
            $this->sc_field_0 = $rs_res->fields[7] ;  
            $this->e_kelas = $rs_res->fields[8] ;  
            $this->trancode = $rs_res->fields[9] ;  
            $_SESSION['scriptcase']['grid_lap_bill_ranap']['contr_erro'] = 'on';
...
$_SESSION['scriptcase']['grid_lap_bill_ranap']['contr_erro'] = 'off'; 
            $this->carabayar_orig = $this->carabayar;
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->total, $this->carabayar, $this->carabayar_orig);
            }
   }
//
