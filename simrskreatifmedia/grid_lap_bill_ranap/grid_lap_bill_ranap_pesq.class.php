...
class grid_lap_bill_ranap_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['path_libs_php'] = $this->Ini->path_lib_php;
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['prim_vez']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['prim_vez'] = "S";
      }
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_lap_bill_ranap_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_lap_bill_ranap_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_lap_bill_ranap_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function lookup_ajax_poli($poli)
   {
      ...
      $nm_comando = "select distinct d.NAME from " . $this->Ini->nm_tabela . " where  d.NAME like '%" . $poli . "%' order by d.NAME"; 
      unset($cmp1,$cmp2);
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $Nm_datas[] = "a.tglKeluar";$Nm_datas[] = "a_tglKeluar";$Nm_datas[] = "e.tglMasuk";$Nm_datas[] = "e_tglMasuk";
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
   ...
   $NM_retorno = "./";
    if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['proc_res'])) 
    {
...
<?php
    if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['prim_vez'] == "N" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['proc_res']) 
    {
?>
if (parent.document.getElementById('nmsc_iframe_grid_lap_bill_ranap').contentWindow.nm_gp_submit_ajax)
{
   parent.document.getElementById('nmsc_iframe_grid_lap_bill_ranap').contentWindow.nm_gp_submit_ajax('inicio', 'save_grid');
}
else
{
   parent.document.getElementById('nmsc_iframe_grid_lap_bill_ranap').src = 'index.php?nmgp_opcao=pesq&script_case_init=<?php echo NM_encode_input($this->Ini->sc_page) ?>&script_case_session=<?php echo session_id() ?>';
}
<?php
    }
    else
...
<?php
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['prim_vez'] = "N";
?>
</SCRIPT>
</BODY>
</HTML>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_lap_bill_ranap/grid_lap_bill_ranap_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_lap_bill_ranap_ajax_search.js"></script>
 <script type="text/javascript" src="grid_lap_bill_ranap_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_lap_bill_ranap_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_lap_bill_ranap']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_lap_bill_ranap']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
function scJQCalendarAdd() {
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'id_ac_poli#NMF#' + search_get_title('select2-id_ac_poli-container') + '@NMF@';
  str_out += 'SC_dpjp_cond#NMF#' + search_get_sel_txt('SC_dpjp_cond') + '@NMF@';
  str_out += 'SC_dpjp#NMF#' + search_get_text('SC_dpjp') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
  $(".sc-ui-autocomp-poli").on("focus", function() {
  }).on("blur", function() {
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<?php
   ...
   function monta_form()
   {
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $tglmasuk_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['campos_busca']['tglmasuk_dia']; 
          $tglmasuk_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['campos_busca']['tglmasuk_mes']; 
          $tglmasuk_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['campos_busca']['tglmasuk_ano']; 
          $tglmasuk_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['campos_busca']['tglmasuk_input_2_dia']; 
          $tglmasuk_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['campos_busca']['tglmasuk_input_2_mes']; 
          $tglmasuk_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['campos_busca']['tglmasuk_input_2_ano']; 
          $tglmasuk_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['campos_busca']['tglmasuk_cond']; 
          $tglkeluar_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['campos_busca']['tglkeluar_dia']; 
          $tglkeluar_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['campos_busca']['tglkeluar_mes']; 
          $tglkeluar_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['campos_busca']['tglkeluar_ano']; 
          $tglkeluar_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['campos_busca']['tglkeluar_input_2_dia']; 
          $tglkeluar_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['campos_busca']['tglkeluar_input_2_mes']; 
          $tglkeluar_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['campos_busca']['tglkeluar_input_2_ano']; 
          $tglkeluar_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['campos_busca']['tglkeluar_cond']; 
          $poli = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['campos_busca']['poli']; 
          $poli_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['campos_busca']['poli_cond']; 
          $dpjp = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['campos_busca']['dpjp']; 
          $dpjp_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['campos_busca']['dpjp_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['campos_busca']['NM_operador']; 
      } 
      ...
      $str_hide_dpjp = (in_array($dpjp_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      $str_display_dpjp = ('bw' == $dpjp_cond) ? $display_aberto : $display_fechado;
...
<?php
      ...
      $poli_look = substr($this->Db->qstr($poli), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct d.NAME from " . $this->Ini->nm_tabela . " where d.NAME = '$poli_look' order by d.NAME"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
...
?>
<INPUT  type="text" id="SC_poli" name="poli" value="<?php echo NM_encode_input($poli) ?>"  size=50 alt="{datatype: 'text', maxLength: 300, allowedChars: '', lettersCase: 'upper', autoTab: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-poli" id="id_ac_poli" name="poli_autocomp"><?php if ('' !=  $poli) { ?><option value="<?php echo $poli ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>

        </TD>
       </TR>
      </TABLE>
     </TD>
      <TD id='SC_dpjp_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['dpjp'])) ? $this->New_label['dpjp'] : "DPJP"; ?></TD>
      
      <INPUT type="hidden" id="SC_dpjp_cond" name="dpjp_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_dpjp" <?php echo $str_hide_dpjp?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['dpjp'])) ? $this->New_label['dpjp'] : "DPJP";
 $nmgp_tab_label .= "dpjp?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<INPUT  type="text" id="SC_dpjp" name="dpjp" value="<?php echo NM_encode_input($dpjp) ?>"  size=50 alt="{datatype: 'text', maxLength: 222, allowedChars: '', lettersCase: 'upper', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
...
?>
<?php
   if (is_file("grid_lap_bill_ranap_help.txt"))
   {
...
?>
<?php
   if ($nm_apl_dependente == 1 || (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['opc_psq'] && !$this->aba_iframe))
   {
...
<?php
       ...
       elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['dashboard_info']['under_dashboard'])
       { }
       else 
       { 
?>
...
<?php
   ...
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['opc_psq'])
   {
...
<?php
    if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['prim_vez'] == "N") 
    {
?>
       <iframe id="nmsc_iframe_grid_lap_bill_ranap" frameborder="0" marginwidth="0px" marginheight="0px" topmargin="0px" leftmargin="0px" align="center" height="1500px" name="nm_iframe_grid_lap_bill_ranap" scrolling="auto" src="index.php?nmgp_opcao=pesq&script_case_init=<?php echo NM_encode_input($this->Ini->sc_page) ?>&script_case_session=<?php echo session_id() ?>" width="100%"></iframe>
<?php
    }
    else
    {
?>
       <iframe id="nmsc_iframe_grid_lap_bill_ranap" frameborder="0" marginwidth="0px" marginheight="0px" topmargin="0px" leftmargin="0px" align="center" height="1500px" name="nm_iframe_grid_lap_bill_ranap" scrolling="auto" src="" width="100%"></iframe>
<?php
    }
?>
<iframe id="nmsc_iframe_grid_lap_bill_ranap_pesq"  name="nm_iframe_grid_lap_bill_ranap_pesq" style= "display: none;" frameborder="0" marginwidth="0px" marginheight="0px" topmargin="0px" leftmargin="0px" src=""></iframe>
</td></tr></table></td></tr>
</TABLE>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['orig_pesq'] == "grid")
   {
...
?>
 ...
 {
    document.F1.target = "nm_iframe_grid_lap_bill_ranap_pesq";
    document.F1.submit();
 }
 function nm_move()
 {
     document.getElementById('nmsc_iframe_grid_lap_bill_ranap').contentWindow.nm_move('igual');
 }
 function limpa_form()
 {
   document.F1.reset();
   ...
   nm_campos_between(document.getElementById('id_vis_dpjp'), document.F1.dpjp_cond, 'dpjp');
   document.F1.dpjp.value = "";
   Sc_carga_select2('all');
 }
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "simrskreatifmedia/grid_lap_bill_ranap";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['id_ac_poli'] = 'select2_aut';
      $tp_fields['SC_dpjp_cond'] = 'cond';
      $tp_fields['SC_dpjp'] = 'text';
   ...
   function trata_campos()
   {
      ...
      $dpjp_cond_salva = $dpjp_cond; 
      if (!isset($dpjp_input_2) || $dpjp_input_2 == "")
      {
          $dpjp_input_2 = $dpjp;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['campos_busca']['tglmasuk_dia'] = $tglmasuk_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['campos_busca']['tglmasuk_mes'] = $tglmasuk_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['campos_busca']['tglmasuk_ano'] = $tglmasuk_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['campos_busca']['tglmasuk_input_2_dia'] = $tglmasuk_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['campos_busca']['tglmasuk_input_2_mes'] = $tglmasuk_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['campos_busca']['tglmasuk_input_2_ano'] = $tglmasuk_input_2_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['campos_busca']['tglmasuk_cond'] = $tglmasuk_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['campos_busca']['tglkeluar_dia'] = $tglkeluar_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['campos_busca']['tglkeluar_mes'] = $tglkeluar_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['campos_busca']['tglkeluar_ano'] = $tglkeluar_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['campos_busca']['tglkeluar_input_2_dia'] = $tglkeluar_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['campos_busca']['tglkeluar_input_2_mes'] = $tglkeluar_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['campos_busca']['tglkeluar_input_2_ano'] = $tglkeluar_input_2_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['campos_busca']['tglkeluar_cond'] = $tglkeluar_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['campos_busca']['poli'] = $poli; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['campos_busca']['poli_cond'] = $poli_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['campos_busca']['dpjp'] = $dpjp; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['campos_busca']['dpjp_cond'] = $dpjp_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      ...
      $Conteudo = $dpjp;
      $this->cmp_formatado['dpjp'] = $Conteudo;
      ...
      if ($tglmasuk_cond != "bi_TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['campos_busca']['tglmasuk'] = $val[0];
          ...
          if ($tglmasuk_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['campos_busca']['tglmasuk_input_2'] = $val[1];
          ...
          {
              $this->monta_condicao("e.tglMasuk", $tglmasuk_cond, $tglmasuk, $tglmasuk_input_2, 'tglmasuk', 'DATETIME');
          }
      }
      ...
      if ($tglkeluar_cond != "bi_TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['campos_busca']['tglkeluar'] = $val[0];
          ...
          if ($tglkeluar_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['campos_busca']['tglkeluar_input_2'] = $val[1];
      ...
      {
         $this->monta_condicao("d.NAME", $poli_cond, $poli, "", "poli");
      }
      ...
      if (isset($dpjp) && !empty($dpjp))
      { 
           $dpjp = strtoupper($dpjp);
      } 
      if (isset($dpjp) || $dpjp_cond == "nu" || $dpjp_cond == "nn" || $dpjp_cond == "ep" || $dpjp_cond == "ne")
      {
         $this->monta_condicao("concat( b.gelar,'. ',b.NAME,', ',b.spec )", $dpjp_cond, $dpjp, "", "dpjp");
      }
   }
   ...
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['cond_dyn_search'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lap_bill_ranap']['cond_pesq'] .= $this->NM_operador;
