...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____BOR"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____BOR"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['BOR']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['BOR']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['BOR']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['BOR']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['BOR']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['BOR']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['BOR']['embutida_filho'] as $ind => $sc_init)
          {
