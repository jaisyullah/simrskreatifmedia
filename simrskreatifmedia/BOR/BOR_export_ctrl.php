<?php
@session_start() ;
$_SESSION['scriptcase']['BOR']['sc_process_barr'] = true;
require_once('../BOR/index.php');
unset($_SESSION['scriptcase']['BOR']['sc_process_barr']);
$ExportCtrl = new BOR_export_control;
$ExportCtrl->Export_barr();

class BOR_export_control
{
