...
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['BOR']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['BOR']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["tgl"]   = (isset($_SESSION['sc_session'][$sc_init]['BOR']['labels']["tgl"])) ? $_SESSION['sc_session'][$sc_init]['BOR']['labels']["tgl"] : "Tgl";
   $tab_ger_campos['hp'] = "on";
   $tab_def_campos['hp'] = "HP";
   $tab_labels["hp"]   = (isset($_SESSION['sc_session'][$sc_init]['BOR']['labels']["hp"])) ? $_SESSION['sc_session'][$sc_init]['BOR']['labels']["hp"] : "Hari Perawatan";
   $tab_ger_campos['jmlbed'] = "on";
   $tab_def_campos['jmlbed'] = "jmlBed";
   $tab_labels["jmlbed"]   = (isset($_SESSION['sc_session'][$sc_init]['BOR']['labels']["jmlbed"])) ? $_SESSION['sc_session'][$sc_init]['BOR']['labels']["jmlbed"] : "Jml Bed";
   $tab_ger_campos['bor'] = "on";
   $tab_def_campos['bor'] = "BOR";
   $tab_labels["bor"]   = (isset($_SESSION['sc_session'][$sc_init]['BOR']['labels']["bor"])) ? $_SESSION['sc_session'][$sc_init]['BOR']['labels']["bor"] : "BOR";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['BOR']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['BOR']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['BOR']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['BOR']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['BOR']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['BOR']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['BOR']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['BOR']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['BOR']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['BOR']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['BOR']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['BOR']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['BOR']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['BOR']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
