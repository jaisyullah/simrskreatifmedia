<?php
@session_start() ;
$_SESSION['scriptcase']['grid_histbdetailendoscopy']['sc_process_barr'] = true;
require_once('../grid_histbdetailendoscopy/index.php');
unset($_SESSION['scriptcase']['grid_histbdetailendoscopy']['sc_process_barr']);
$ExportCtrl = new grid_histbdetailendoscopy_export_control;
$ExportCtrl->Export_barr();

class grid_histbdetailendoscopy_export_control
{
