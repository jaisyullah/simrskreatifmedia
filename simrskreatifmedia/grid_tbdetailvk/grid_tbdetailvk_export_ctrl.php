<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tbdetailvk']['sc_process_barr'] = true;
require_once('../grid_tbdetailvk/index.php');
unset($_SESSION['scriptcase']['grid_tbdetailvk']['sc_process_barr']);
$ExportCtrl = new grid_tbdetailvk_export_control;
$ExportCtrl->Export_barr();

class grid_tbdetailvk_export_control
{
