...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_farmasi']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
  <input type="hidden" name="script_case_session" value="<?php echo $this->form_encode_input(session_id()); ?>"> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_pay_farmasi"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
?> 
var var_btn_Cetak_payno_pob = "<?php echo $this->form_encode_input($this->nmgp_dados_form['nopayment']); ?>";
...
{
      nm_gp_submit('<?php echo $this->Ini->link_cetak_farmasi; ?>', '<?php echo $this->nm_location; ?>', '<?php echo "payno_pob*scin' + var_btn_Cetak_payno_pob + '*scout"; ?>', '', '_blank', '0', '0', 'cetak_farmasi');
}
function sc_btn_sc_btn_0()
{
    ...
    scJs_confirm("<?php echo html_entity_decode('Apakah Anda yakin ?', ENT_COMPAT, $_SESSION['scriptcase']['charset']); ?>", sc_btn_sc_btn_0_ok, sc_btn_sc_btn_0_cancel)
}
...
{ 
   var sob_iframe = '';
<?php 
if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_farmasi']['embutida_form']) {
...
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_farmasi']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_farmasi']['sc_modal']) {
    echo "   sob_iframe += 'parent.';\r\n";
}
?>
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_farmasi']['where_detal']))
  {
?>  
...
function sc_form_onload()
{
   ...
   nm_field_disabled("trancode=disabled;nostruk=disabled;custcode=disabled;jmltagihan=disabled;hrsdibayar=disabled", "U");
