...
class grid_hrm_supp_presensi_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['path_libs_php'] = $this->Ini->path_lib_php;
      ...
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search_change_fil")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['campos_busca'] = array(); 
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_hrm_supp_presensi_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_hrm_supp_presensi_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_hrm_supp_presensi_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_jenis')
      {
          $jenis = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_jenis($jenis);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
          ...
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['grid_pesq'][$campo_join]);
              return;
          }
      ...
      $Nm_datas[] = "fromDate";$Nm_datas[] = "fromDate";$Nm_datas[] = "toDate";$Nm_datas[] = "toDate";$Nm_datas[] = "tranDate";$Nm_datas[] = "tranDate";
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         $nome_sum = "hrm_supp_presensi.$nome";
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE>Daftar Pengajuan Sakit / Izin / Cuti</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_hrm_supp_presensi/grid_hrm_supp_presensi_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_hrm_supp_presensi_ajax_search.js"></script>
 <script type="text/javascript" src="grid_hrm_supp_presensi_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_hrm_supp_presensi_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_hrm_supp_presensi']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_hrm_supp_presensi']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_fromdate_cond#NMF#' + search_get_sel_txt('SC_fromdate_cond') + '@NMF@';
  str_out += 'SC_fromdate_dia#NMF#' + search_get_sel_txt('SC_fromdate_dia') + '@NMF@';
  str_out += 'SC_fromdate_mes#NMF#' + search_get_sel_txt('SC_fromdate_mes') + '@NMF@';
  str_out += 'SC_fromdate_ano#NMF#' + search_get_sel_txt('SC_fromdate_ano') + '@NMF@';
  str_out += 'SC_fromdate_input_2_dia#NMF#' + search_get_sel_txt('SC_fromdate_input_2_dia') + '@NMF@';
  str_out += 'SC_fromdate_input_2_mes#NMF#' + search_get_sel_txt('SC_fromdate_input_2_mes') + '@NMF@';
  str_out += 'SC_fromdate_input_2_ano#NMF#' + search_get_sel_txt('SC_fromdate_input_2_ano') + '@NMF@';
  str_out += 'SC_id_cond#NMF#' + search_get_sel_txt('SC_id_cond') + '@NMF@';
  str_out += 'SC_id#NMF#' + search_get_text('SC_id') + '@NMF@';
  str_out += 'SC_id_kary_cond#NMF#' + search_get_sel_txt('SC_id_kary_cond') + '@NMF@';
  str_out += 'SC_id_kary#NMF#' + search_get_text('SC_id_kary') + '@NMF@';
  str_out += 'SC_jenis_cond#NMF#' + search_get_sel_txt('SC_jenis_cond') + '@NMF@';
  str_out += 'SC_jenis#NMF#' + search_get_text('SC_jenis') + '@NMF@';
  str_out += 'id_ac_jenis#NMF#' + search_get_text('id_ac_jenis') + '@NMF@';
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div class="scFilterHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFilterHeaderFont" style="float: left; text-transform: uppercase;">Daftar Pengajuan Sakit / Izin / Cuti</div>
...
<?php
   ...
   {
      global 
             $fromdate_cond, $fromdate, $fromdate_dia, $fromdate_mes, $fromdate_ano, $fromdate_input_2_dia, $fromdate_input_2_mes, $fromdate_input_2_ano,
             $id_cond, $id,
             $id_kary_cond, $id_kary,
             $jenis_cond, $jenis, $jenis_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          $fromdate_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['campos_busca']['fromdate_dia']; 
          $fromdate_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['campos_busca']['fromdate_mes']; 
          $fromdate_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['campos_busca']['fromdate_ano']; 
          $fromdate_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['campos_busca']['fromdate_input_2_dia']; 
          $fromdate_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['campos_busca']['fromdate_input_2_mes']; 
          $fromdate_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['campos_busca']['fromdate_input_2_ano']; 
          $fromdate_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['campos_busca']['fromdate_cond']; 
          $id = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['campos_busca']['id']; 
          $id_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['campos_busca']['id_cond']; 
          $id_kary = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['campos_busca']['id_kary']; 
          $id_kary_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['campos_busca']['id_kary_cond']; 
          $jenis = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['campos_busca']['jenis']; 
          $jenis_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['campos_busca']['jenis_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['campos_busca']['NM_operador']; 
          ...
          if (strtoupper($id_kary_cond) != "II" && strtoupper($id_kary_cond) != "QP" && strtoupper($id_kary_cond) != "NP" && strtoupper($id_kary_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($id_kary, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
      } 
      if (!isset($fromdate_cond) || empty($fromdate_cond))
      {
         $fromdate_cond = "eq";
      }
      ...
      if (!isset($id_kary_cond) || empty($id_kary_cond))
      {
         $id_kary_cond = "gt";
      }
      if (!isset($jenis_cond) || empty($jenis_cond))
      {
         $jenis_cond = "qp";
      }
      ...
      $str_hide_fromdate = (in_array($fromdate_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_id = (in_array($id_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_id_kary = (in_array($id_kary_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_jenis = (in_array($jenis_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      $str_display_fromdate = ('bw' == $fromdate_cond) ? $display_aberto : $display_fechado;
      $str_display_id = ('bw' == $id_cond) ? $display_aberto : $display_fechado;
      $str_display_id_kary = ('bw' == $id_kary_cond) ? $display_aberto : $display_fechado;
      $str_display_jenis = ('bw' == $jenis_cond) ? $display_aberto : $display_fechado;
      ...
      {
         $tmp_pos = strpos($fromdate, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $fromdate = substr($fromdate, 0, $tmp_pos);
         }
      }
      if (!isset($id) || $id == "")
      {
      ...
      if (!isset($id_kary) || $id_kary == "")
      {
          $id_kary = "";
      }
      if (isset($id_kary) && !empty($id_kary))
      {
         $tmp_pos = strpos($id_kary, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $id_kary = substr($id_kary, 0, $tmp_pos);
         }
      }
      ...
      {
         $tmp_pos = strpos($jenis, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $jenis = substr($jenis, 0, $tmp_pos);
         }
      }
?>
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_fromdate_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['fromdate'])) ? $this->New_label['fromdate'] : "Dari Tgl"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_fromdate_cond" name="fromdate_cond" onChange="nm_campos_between(document.getElementById('id_vis_fromdate'), this, 'fromdate')">
       <OPTION value="eq" <?php if ("eq" == $fromdate_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="gt" <?php if ("gt" == $fromdate_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $fromdate_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $fromdate_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_fromdate" <?php echo $str_hide_fromdate?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['fromdate'])) ? $this->New_label['fromdate'] : "Dari Tgl";
 $nmgp_tab_label .= "fromdate?#?" . $SC_Label . "?@?";
...
<?php
  ...
  {
?>
<span id='id_date_part_fromdate_DD' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_fromdate_dia" name="fromdate_dia" value="<?php echo NM_encode_input($fromdate_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_fromdate_MM' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_fromdate_mes" name="fromdate_mes" value="<?php echo NM_encode_input($fromdate_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_fromdate_AAAA' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_fromdate_ano" name="fromdate_ano" value="<?php echo NM_encode_input($fromdate_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 </span>
...
?>
        <SPAN id="id_css_fromdate"  class="scFilterFieldFontOdd">
 <?php echo $date_format_show ?>         </SPAN>
                 </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_fromdate"  <?php echo $str_display_fromdate; ?> class="scFilterFieldFontOdd">
...
<?php
  ...
  {
?>
<span id='id_date_part_fromdate_input_2_DD' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_fromdate_input_2_dia" name="fromdate_input_2_dia" value="<?php echo NM_encode_input($fromdate_input_2_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_fromdate_input_2_MM' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_fromdate_input_2_mes" name="fromdate_input_2_mes" value="<?php echo NM_encode_input($fromdate_input_2_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_fromdate_input_2_AAAA' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_fromdate_input_2_ano" name="fromdate_input_2_ano" value="<?php echo NM_encode_input($fromdate_input_2_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 </span>
...
<INPUT  type="text" id="SC_id" name="id" value="<?php echo NM_encode_input($id) ?>" size=15 alt="{datatype: 'integer', maxLength: 15, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
      ...
      <TD id='SC_id_kary_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['id_kary'])) ? $this->New_label['id_kary'] : "Karyawan"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_id_kary_cond" name="id_kary_cond" onChange="nm_campos_between(document.getElementById('id_vis_id_kary'), this, 'id_kary')">
       <OPTION value="gt" <?php if ("gt" == $id_kary_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $id_kary_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $id_kary_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_id_kary" <?php echo $str_hide_id_kary?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['id_kary'])) ? $this->New_label['id_kary'] : "Karyawan";
 $nmgp_tab_label .= "id_kary?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<INPUT  type="text" id="SC_id_kary" name="id_kary" value="<?php echo NM_encode_input($id_kary) ?>" size=15 alt="{datatype: 'integer', maxLength: 15, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
      ...
      <TD id='SC_jenis_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['jenis'])) ? $this->New_label['jenis'] : "Jenis Pengajuan"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_jenis_cond" name="jenis_cond" onChange="nm_campos_between(document.getElementById('id_vis_jenis'), this, 'jenis')">
       <OPTION value="qp" <?php if ("qp" == $jenis_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $jenis_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $jenis_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $jenis_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_jenis" <?php echo $str_hide_jenis?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['jenis'])) ? $this->New_label['jenis'] : "Jenis Pengajuan";
 $nmgp_tab_label .= "jenis?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      {
          $sAutocompValue = $jenis;
      }
?>
<INPUT  type="text" id="SC_jenis" name="jenis" value="<?php echo NM_encode_input($jenis) ?>"  size=25 alt="{datatype: 'text', maxLength: 25, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_jenis" name="jenis_autocomp" size="25"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 25, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if ($_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
<?php
   if (is_file("grid_hrm_supp_presensi_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_hrm_supp_presensi']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_hrm_supp_presensi']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.fromdate_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_fromdate'), document.F1.fromdate_cond, 'fromdate');
   document.F1.fromdate_dia.value = "";
   document.F1.fromdate_mes.value = "";
   document.F1.fromdate_ano.value = "";
   document.F1.fromdate_input_2_dia.value = "";
   document.F1.fromdate_input_2_mes.value = "";
   document.F1.fromdate_input_2_ano.value = "";
   ...
   document.F1.id_kary_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_id_kary'), document.F1.id_kary_cond, 'id_kary');
   document.F1.id_kary.value = "";
   document.F1.jenis_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_jenis'), document.F1.jenis_cond, 'jenis');
   document.F1.jenis.value = "";
   document.F1.jenis_autocomp.value = "";
 }
 function SC_carga_evt_jquery()
 {
    $('#SC_fromdate_dia').bind('change', function() {sc_grid_hrm_supp_presensi_valida_dia(this)});
    $('#SC_fromdate_input_2_dia').bind('change', function() {sc_grid_hrm_supp_presensi_valida_dia(this)});
    $('#SC_fromdate_input_2_mes').bind('change', function() {sc_grid_hrm_supp_presensi_valida_mes(this)});
    $('#SC_fromdate_mes').bind('change', function() {sc_grid_hrm_supp_presensi_valida_mes(this)});
 }
 function sc_grid_hrm_supp_presensi_valida_dia(obj)
 {
 ...
 function sc_grid_hrm_supp_presensi_valida_mes(obj)
 {
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['where_orig']))
      {
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['where_orig'];
      }
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro($nmgp_save_origem)
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "grid_hrm_supp_presensi/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_fromdate_cond'] = 'cond';
      $tp_fields['SC_fromdate_dia'] = 'text';
      $tp_fields['SC_fromdate_mes'] = 'text';
      $tp_fields['SC_fromdate_ano'] = 'text';
      $tp_fields['SC_fromdate_input_2_dia'] = 'text';
      $tp_fields['SC_fromdate_input_2_mes'] = 'text';
      $tp_fields['SC_fromdate_input_2_ano'] = 'text';
      $tp_fields['SC_id_cond'] = 'cond';
      $tp_fields['SC_id'] = 'text';
      $tp_fields['SC_id_kary_cond'] = 'cond';
      $tp_fields['SC_id_kary'] = 'text';
      $tp_fields['SC_jenis_cond'] = 'cond';
      $tp_fields['SC_jenis'] = 'text_aut';
      $tp_fields['id_ac_jenis'] = 'text_aut';
   ...
   {
      global $fromdate_cond, $fromdate, $fromdate_dia, $fromdate_mes, $fromdate_ano, $fromdate_input_2_dia, $fromdate_input_2_mes, $fromdate_input_2_ano,
             $id_cond, $id,
             $id_kary_cond, $id_kary,
             $jenis_cond, $jenis, $jenis_autocomp, $nmgp_tab_label;
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['campos_busca'] as $Cmps => $Vals)
          {
              $$Cmps = $Vals;
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['grid_pesq'] = array();
      if (!empty($jenis_autocomp) && empty($jenis))
      {
          $jenis = $jenis_autocomp;
      }
      $fromdate_cond_salva = $fromdate_cond; 
      if (!isset($fromdate_input_2_dia) || $fromdate_input_2_dia == "")
      {
          $fromdate_input_2_dia = $fromdate_dia;
      }
      if (!isset($fromdate_input_2_mes) || $fromdate_input_2_mes == "")
      {
          $fromdate_input_2_mes = $fromdate_mes;
      }
      if (!isset($fromdate_input_2_ano) || $fromdate_input_2_ano == "")
      {
          $fromdate_input_2_ano = $fromdate_ano;
      }
      ...
      $id_kary_cond_salva = $id_kary_cond; 
      if (!isset($id_kary_input_2) || $id_kary_input_2 == "")
      {
          $id_kary_input_2 = $id_kary;
      }
      $jenis_cond_salva = $jenis_cond; 
      if (!isset($jenis_input_2) || $jenis_input_2 == "")
      {
          $jenis_input_2 = $jenis;
      }
      if ($id_cond != "in")
      ...
      if ($id_kary_cond != "in")
      {
          nm_limpa_numero($id_kary, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['Grid_search']  = array(); 
      $I_Grid = 0;
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['campos_busca']['fromdate_dia'] = $fromdate_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['campos_busca']['fromdate_mes'] = $fromdate_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['campos_busca']['fromdate_ano'] = $fromdate_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['campos_busca']['fromdate_input_2_dia'] = $fromdate_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['campos_busca']['fromdate_input_2_mes'] = $fromdate_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['campos_busca']['fromdate_input_2_ano'] = $fromdate_input_2_ano; 
      if (!empty($fromdate_dia) || !empty($fromdate_mes) || !empty($fromdate_ano) || $fromdate_cond_salva == "nu" || $fromdate_cond_salva == "nn" || $fromdate_cond_salva == "ep" || $fromdate_cond_salva == "ne")
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['Grid_search'][$I_Grid]['val'][0][] = "D:" . $fromdate_dia;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['Grid_search'][$I_Grid]['val'][0][] = "M:" . $fromdate_mes;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['Grid_search'][$I_Grid]['val'][0][] = "Y:" . $fromdate_ano;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['Grid_search'][$I_Grid]['val'][1][] = "D:" . $fromdate_input_2_dia;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['Grid_search'][$I_Grid]['val'][1][] = "M:" . $fromdate_input_2_mes;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['Grid_search'][$I_Grid]['val'][1][] = "Y:" . $fromdate_input_2_ano;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['campos_busca']['fromdate_cond'] = $fromdate_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['Grid_search'][$I_Grid]['cmp'] = "fromdate"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['Grid_search'][$I_Grid]['opc'] = $fromdate_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['grid_pesq']['fromdate'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['campos_busca']['id'] = $id; 
      if (is_array($id) && !empty($id))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['Grid_search'][$I_Grid]['val'][0] = $id;
      }
      elseif ($id_cond_salva == "nu" || $id_cond_salva == "nn" || $id_cond_salva == "ep" || $id_cond_salva == "ne" || !empty($id))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['Grid_search'][$I_Grid]['val'][0][0] = $id;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['campos_busca']['id_cond'] = $id_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['Grid_search'][$I_Grid]['cmp'] = "id"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['Grid_search'][$I_Grid]['opc'] = $id_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['grid_pesq']['id'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['campos_busca']['id_kary'] = $id_kary; 
      if (is_array($id_kary) && !empty($id_kary))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['Grid_search'][$I_Grid]['val'][0] = $id_kary;
      }
      elseif ($id_kary_cond_salva == "nu" || $id_kary_cond_salva == "nn" || $id_kary_cond_salva == "ep" || $id_kary_cond_salva == "ne" || !empty($id_kary))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['Grid_search'][$I_Grid]['val'][0][0] = $id_kary;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['campos_busca']['id_kary_cond'] = $id_kary_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['Grid_search'][$I_Grid]['cmp'] = "id_kary"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['Grid_search'][$I_Grid]['opc'] = $id_kary_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['grid_pesq']['id_kary'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['campos_busca']['jenis'] = $jenis; 
      if (is_array($jenis) && !empty($jenis))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['Grid_search'][$I_Grid]['val'][0] = $jenis;
      }
      elseif ($jenis_cond_salva == "nu" || $jenis_cond_salva == "nn" || $jenis_cond_salva == "ep" || $jenis_cond_salva == "ne" || !empty($jenis))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['Grid_search'][$I_Grid]['val'][0][0] = $jenis;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['campos_busca']['jenis_cond'] = $jenis_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['Grid_search'][$I_Grid]['cmp'] = "jenis"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['Grid_search'][$I_Grid]['opc'] = $jenis_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['grid_pesq']['jenis'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      ...
      $this->cmp_formatado['id_kary'] = $Conteudo;
      $jenis_look = substr($this->Db->qstr($jenis), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct jenis from " . $this->Ini->nm_tabela . " where jenis = '$jenis_look' order by jenis"; 
      unset($cmp1,$cmp2);
      ...
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['jenis'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['jenis'] = $jenis;
      }

      //----- $fromdate
      $this->Date_part = false;
      if ($fromdate_cond != "bi_TP")
      {
          $fromdate_cond = strtoupper($fromdate_cond);
          $Dtxt = "";
          $val  = array();
          $Dtxt .= $fromdate_ano;
          $Dtxt .= $fromdate_mes;
          $Dtxt .= $fromdate_dia;
          $val[0]['ano'] = $fromdate_ano;
          $val[0]['mes'] = $fromdate_mes;
          $val[0]['dia'] = $fromdate_dia;
          if ($fromdate_cond == "BW")
          {
              $val[1]['ano'] = $fromdate_input_2_ano;
              $val[1]['mes'] = $fromdate_input_2_mes;
              $val[1]['dia'] = $fromdate_input_2_dia;
          }
          $this->Operador_date_part = "";
          $this->Lang_date_part     = "";
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_oracle))
          {
              $this->nm_prep_date($val, "DT", "DATETIME", $fromdate_cond, "", "data");
          }
          else
          {
              $this->nm_prep_date($val, "DT", "DATE", $fromdate_cond, "", "data");
          }
          if (!$this->Date_part) {
              $val[0] = $this->Ini->sc_Date_Protect($val[0]);
          }
          $fromdate = $val[0];
          $this->cmp_formatado['fromdate'] = $val[0];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['campos_busca']['fromdate'] = $val[0];
          $this->nm_data->SetaData($this->cmp_formatado['fromdate'], "YYYY-MM-DD");
          $this->cmp_formatado['fromdate'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DT", "dmY"));
          if ($fromdate_cond == "BW")
          {
              if (!$this->Date_part) {
                  $val[1] = $this->Ini->sc_Date_Protect($val[1]);
              }
              $fromdate_input_2     = $val[1];
              $this->cmp_formatado['fromdate_input_2'] = $val[1];
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['campos_busca']['fromdate_input_2'] = $val[1];
              $this->nm_data->SetaData($this->cmp_formatado['fromdate_input_2'], "YYYY-MM-DD");
              $this->cmp_formatado['fromdate_input_2'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DT", "dmY"));
          }
          if (!empty($Dtxt) || $fromdate_cond == "NU" || $fromdate_cond == "NN"|| $fromdate_cond == "EP"|| $fromdate_cond == "NE")
          {
              $this->monta_condicao("fromDate", $fromdate_cond, $fromdate, $fromdate_input_2, 'fromdate', 'DATE');
          }
      }
      else
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['grid_pesq']['fromdate']['label'] = $nmgp_tab_label['fromdate'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['grid_pesq']['fromdate']['descr'] = $nmgp_tab_label['fromdate'] . " " . $this->Ini->Nm_lang['lang_srch_ever'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['grid_pesq']['fromdate']['hint']  = $nmgp_tab_label['fromdate'] . " " . $this->Ini->Nm_lang['lang_srch_ever'];
      }
      ...
      //----- $id_kary
      $this->Date_part = false;
      if (isset($id_kary) || $id_kary_cond == "nu" || $id_kary_cond == "nn" || $id_kary_cond == "ep" || $id_kary_cond == "ne")
      {
         $this->monta_condicao("id_kary", $id_kary_cond, $id_kary, "", "id_kary");
      }

      //----- $jenis
      $this->Date_part = false;
      if (isset($jenis) || $jenis_cond == "nu" || $jenis_cond == "nn" || $jenis_cond == "ep" || $jenis_cond == "ne")
      {
         $this->monta_condicao("jenis", $jenis_cond, $jenis, "", "jenis");
      }
   }
   ...
   function finaliza_resultado_ajax()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['where_pesq'] = $this->comando;
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['where_pesq_fast'])) 
       {
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['where_pesq'])) 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['where_pesq_fast'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['where_pesq'] = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['where_pesq_fast'] . ")";
           }
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['cond_dyn_search'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hrm_supp_presensi']['cond_pesq'] .= $this->NM_operador;
