...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "fromDate";$Nm_datas[] = "fromDate";$Nm_datas[] = "toDate";$Nm_datas[] = "toDate";$Nm_datas[] = "tranDate";$Nm_datas[] = "tranDate";$Nm_numeric[] = "id";$Nm_numeric[] = "id_kary";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_fromdate_cond" name="fromdate_cond" onChange="nm_campos_between(document.getElementById('id_vis_fromdate'), this, 'fromdate')">
      ...
      <br><span id="id_hide_fromdate"  <?php echo $str_hide_fromdate?>>
<?php
  $Form_base = "ddmmyyyy";
  $date_format_show = "";
...
?>
 ...
 <?php echo $date_format_show ?>         </SPAN>
                  <br />
        <SPAN id="id_vis_fromdate"  <?php echo $str_display_fromdate; ?> class="scFilterFieldFontOdd">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_id_kary_cond" name="id_kary_cond" onChange="nm_campos_between(document.getElementById('id_vis_id_kary'), this, 'id_kary')">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_jenis_cond" name="jenis_cond" onChange="nm_campos_between(document.getElementById('id_vis_jenis'), this, 'jenis')">
      ...
      <br><span id="id_hide_jenis"  <?php echo $str_hide_jenis?>><?php
      if ($jenis != "")
      {
      $jenis_look = substr($this->Db->qstr($jenis), 1, -1); 
      $nmgp_def_dados = array(); 
