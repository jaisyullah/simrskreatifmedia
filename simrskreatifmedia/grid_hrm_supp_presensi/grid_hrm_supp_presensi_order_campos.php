...
<?php
   ...
   $Ord_Cmp = new grid_hrm_supp_presensi_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_hrm_supp_presensi_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_hrm_supp_presensi']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_hrm_supp_presensi']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_hrm_supp_presensi']['labels']["id"])) ? $_SESSION['sc_session'][$sc_init]['grid_hrm_supp_presensi']['labels']["id"] : "ID";
   $tab_ger_campos['id_kary'] = "on";
   $tab_def_campos['id_kary'] = "id_kary";
   $tab_labels["id_kary"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_hrm_supp_presensi']['labels']["id_kary"])) ? $_SESSION['sc_session'][$sc_init]['grid_hrm_supp_presensi']['labels']["id_kary"] : "Karyawan";
   $tab_ger_campos['jenis'] = "on";
   $tab_def_campos['jenis'] = "jenis";
   $tab_labels["jenis"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_hrm_supp_presensi']['labels']["jenis"])) ? $_SESSION['sc_session'][$sc_init]['grid_hrm_supp_presensi']['labels']["jenis"] : "Jenis Pengajuan";
   $tab_ger_campos['fromdate'] = "on";
   $tab_def_campos['fromdate'] = "fromDate";
   $tab_labels["fromdate"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_hrm_supp_presensi']['labels']["fromdate"])) ? $_SESSION['sc_session'][$sc_init]['grid_hrm_supp_presensi']['labels']["fromdate"] : "Dari Tgl";
   $tab_ger_campos['todate'] = "on";
   $tab_def_campos['todate'] = "toDate";
   $tab_labels["todate"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_hrm_supp_presensi']['labels']["todate"])) ? $_SESSION['sc_session'][$sc_init]['grid_hrm_supp_presensi']['labels']["todate"] : "Sampai Tgl";
   $tab_ger_campos['desc'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['desc'] = "sc_def_col_1";
   }
   else
   {
       $tab_def_campos['desc'] = "`desc`";
   }
   $tab_labels["desc"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_hrm_supp_presensi']['labels']["desc"])) ? $_SESSION['sc_session'][$sc_init]['grid_hrm_supp_presensi']['labels']["desc"] : "Keterangan";
   $tab_ger_campos['trandate'] = "on";
   $tab_def_campos['trandate'] = "tranDate";
   $tab_labels["trandate"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_hrm_supp_presensi']['labels']["trandate"])) ? $_SESSION['sc_session'][$sc_init]['grid_hrm_supp_presensi']['labels']["trandate"] : "Tgl Transaksi";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_hrm_supp_presensi']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_hrm_supp_presensi']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_hrm_supp_presensi']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_hrm_supp_presensi']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_hrm_supp_presensi']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_hrm_supp_presensi']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_hrm_supp_presensi']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_hrm_supp_presensi']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_hrm_supp_presensi']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_hrm_supp_presensi_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_hrm_supp_presensi']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_hrm_supp_presensi']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_hrm_supp_presensi']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_hrm_supp_presensi']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_hrm_supp_presensi']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
