<?php
@session_start() ;
$_SESSION['scriptcase']['grid_retur_pelayanan']['sc_process_barr'] = true;
require_once('../grid_retur_pelayanan/index.php');
unset($_SESSION['scriptcase']['grid_retur_pelayanan']['sc_process_barr']);
$ExportCtrl = new grid_retur_pelayanan_export_control;
$ExportCtrl->Export_barr();

class grid_retur_pelayanan_export_control
{
