...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_retur_pelayanan"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_retur_pelayanan"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_retur_pelayanan']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_retur_pelayanan']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_retur_pelayanan']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_retur_pelayanan']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_retur_pelayanan']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_retur_pelayanan</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_retur_pelayanan']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_retur_pelayanan']['embutida_filho'] as $ind => $sc_init)
          {
