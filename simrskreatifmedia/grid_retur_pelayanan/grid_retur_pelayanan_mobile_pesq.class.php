...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_rm_cond" name="rm_cond" onChange="nm_campos_between(document.getElementById('id_vis_rm'), this, 'rm')">
      ...
      <br><span id="id_hide_rm"  <?php echo $str_hide_rm?>><?php
      if ($rm != "")
      {
      $rm_look = substr($this->Db->qstr($rm), 1, -1); 
      $nmgp_def_dados = array(); 
