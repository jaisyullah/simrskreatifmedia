...
class grid_retur_pelayanan_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['path_libs_php'] = $this->Ini->path_lib_php;
      ...
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search_change_fil")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['campos_busca'] = array(); 
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_retur_pelayanan_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_retur_pelayanan_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_retur_pelayanan_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_rm')
      {
          $rm = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_rm($rm);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE>Pilih Kode Pelayanan</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_retur_pelayanan/grid_retur_pelayanan_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_retur_pelayanan_ajax_search.js"></script>
 <script type="text/javascript" src="grid_retur_pelayanan_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_retur_pelayanan_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_retur_pelayanan']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_retur_pelayanan']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_rm_cond#NMF#' + search_get_sel_txt('SC_rm_cond') + '@NMF@';
  str_out += 'SC_rm#NMF#' + search_get_text('SC_rm') + '@NMF@';
  str_out += 'id_ac_rm#NMF#' + search_get_text('id_ac_rm') + '@NMF@';
   ...
   $("#id_ac_rm").autocomplete({
     ...
     $.ajax({
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_rm",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div class="scFilterHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFilterHeaderFont" style="float: left; text-transform: uppercase;">Pilih Kode Pelayanan</div>
...
<?php
   ...
   function monta_form()
   {
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          $trancode = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['campos_busca']['trancode']; 
          $trancode_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['campos_busca']['trancode_cond']; 
          $trandate_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['campos_busca']['trandate_dia']; 
          $trandate_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['campos_busca']['trandate_mes']; 
          $trandate_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['campos_busca']['trandate_ano']; 
          $trandate_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['campos_busca']['trandate_input_2_dia']; 
          $trandate_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['campos_busca']['trandate_input_2_mes']; 
          $trandate_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['campos_busca']['trandate_input_2_ano']; 
          $trandate_hor = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['campos_busca']['trandate_hor']; 
          $trandate_min = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['campos_busca']['trandate_min']; 
          $trandate_seg = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['campos_busca']['trandate_seg']; 
          $trandate_input_2_hor = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['campos_busca']['trandate_input_2_hor']; 
          $trandate_input_2_min = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['campos_busca']['trandate_input_2_min']; 
          $trandate_input_2_seg = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['campos_busca']['trandate_input_2_seg']; 
          $trandate_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['campos_busca']['trandate_cond']; 
          $rm = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['campos_busca']['rm']; 
          $rm_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['campos_busca']['rm_cond']; 
          $nama = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['campos_busca']['nama']; 
          $nama_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['campos_busca']['nama_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['campos_busca']['NM_operador']; 
      } 
      ...
      if (!isset($rm_cond) || empty($rm_cond))
      {
         $rm_cond = "qp";
      }
      ...
      $str_hide_rm = (in_array($rm_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      $str_display_rm = ('bw' == $rm_cond) ? $display_aberto : $display_fechado;
...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_trancode" name="trancode_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 75, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_trandate_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['trandate'])) ? $this->New_label['trandate'] : "Tgl. Transaksi"; ?></TD>
...
?>
      ...
      <TD id='SC_rm_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['rm'])) ? $this->New_label['rm'] : "RM"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_rm_cond" name="rm_cond" onChange="nm_campos_between(document.getElementById('id_vis_rm'), this, 'rm')">
       <OPTION value="qp" <?php if ("qp" == $rm_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $rm_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $rm_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $rm_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_rm" <?php echo $str_hide_rm?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['rm'])) ? $this->New_label['rm'] : "RM";
 $nmgp_tab_label .= "rm?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<INPUT  type="text" id="SC_rm" name="rm" value="<?php echo NM_encode_input($rm) ?>"  size=50 alt="{datatype: 'text', maxLength: 150, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_rm" name="rm_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 150, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
?>
<INPUT  type="text" id="SC_nama" name="nama" value="<?php echo NM_encode_input($nama) ?>"  size=50 alt="{datatype: 'text', maxLength: 156, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_nama" name="nama_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 156, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if ($_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
<?php
   if (is_file("grid_retur_pelayanan_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_retur_pelayanan']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_retur_pelayanan']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.rm_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_rm'), document.F1.rm_cond, 'rm');
   document.F1.rm.value = "";
   document.F1.rm_autocomp.value = "";
 ...
 {
    $('#SC_trandate_dia').bind('change', function() {sc_grid_retur_pelayanan_valida_dia(this)});
    $('#SC_trandate_hor').bind('change', function() {sc_grid_retur_pelayanan_valida_hora(this)});
    $('#SC_trandate_input_2_dia').bind('change', function() {sc_grid_retur_pelayanan_valida_dia(this)});
    $('#SC_trandate_input_2_hor').bind('change', function() {sc_grid_retur_pelayanan_valida_hora(this)});
    $('#SC_trandate_input_2_mes').bind('change', function() {sc_grid_retur_pelayanan_valida_mes(this)});
    $('#SC_trandate_input_2_min').bind('change', function() {sc_grid_retur_pelayanan_valida_min(this)});
    $('#SC_trandate_input_2_seg').bind('change', function() {sc_grid_retur_pelayanan_valida_seg(this)});
    $('#SC_trandate_mes').bind('change', function() {sc_grid_retur_pelayanan_valida_mes(this)});
    $('#SC_trandate_min').bind('change', function() {sc_grid_retur_pelayanan_valida_min(this)});
    $('#SC_trandate_seg').bind('change', function() {sc_grid_retur_pelayanan_valida_seg(this)});
 }
 function sc_grid_retur_pelayanan_valida_dia(obj)
 {
 ...
 function sc_grid_retur_pelayanan_valida_mes(obj)
 {
 ...
 function sc_grid_retur_pelayanan_valida_hora(obj)
 {
 ...
 function sc_grid_retur_pelayanan_valida_min(obj)
 {
 ...
 function sc_grid_retur_pelayanan_valida_seg(obj)
 {
     if (obj.value != "" && (obj.value < 0 || obj.value > 59))
     {
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['where_orig']))
      {
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['where_orig'];
      }
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_rm_cond'] = 'cond';
      $tp_fields['SC_rm'] = 'text_aut';
      $tp_fields['id_ac_rm'] = 'text_aut';
   ...
   function trata_campos()
   {
      global $trancode_cond, $trancode, $trancode_autocomp,
             $trandate_cond, $trandate, $trandate_dia, $trandate_mes, $trandate_ano, $trandate_hor, $trandate_min, $trandate_seg, $trandate_input_2_dia, $trandate_input_2_mes, $trandate_input_2_ano, $trandate_input_2_min, $trandate_input_2_hor, $trandate_input_2_seg,
             $rm_cond, $rm, $rm_autocomp,
             $nama_cond, $nama, $nama_autocomp, $nmgp_tab_label;
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['campos_busca'] as $Cmps => $Vals)
          {
              $$Cmps = $Vals;
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['grid_pesq'] = array();
      if (!empty($trancode_autocomp) && empty($trancode))
      {
          $trancode = $trancode_autocomp;
      }
      if (!empty($rm_autocomp) && empty($rm))
      {
          $rm = $rm_autocomp;
      }
      ...
      $rm_cond_salva = $rm_cond; 
      if (!isset($rm_input_2) || $rm_input_2 == "")
      {
          $rm_input_2 = $rm;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['Grid_search']  = array(); 
      $I_Grid = 0;
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['campos_busca']['trancode'] = $trancode; 
      if (is_array($trancode) && !empty($trancode))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['Grid_search'][$I_Grid]['val'][0] = $trancode;
      }
      elseif ($trancode_cond_salva == "nu" || $trancode_cond_salva == "nn" || $trancode_cond_salva == "ep" || $trancode_cond_salva == "ne" || !empty($trancode))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['Grid_search'][$I_Grid]['val'][0][0] = $trancode;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['campos_busca']['trancode_cond'] = $trancode_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['Grid_search'][$I_Grid]['cmp'] = "trancode"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['Grid_search'][$I_Grid]['opc'] = $trancode_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['grid_pesq']['trancode'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['campos_busca']['trandate_dia'] = $trandate_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['campos_busca']['trandate_mes'] = $trandate_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['campos_busca']['trandate_ano'] = $trandate_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['campos_busca']['trandate_input_2_dia'] = $trandate_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['campos_busca']['trandate_input_2_mes'] = $trandate_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['campos_busca']['trandate_input_2_ano'] = $trandate_input_2_ano; 
      ...
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['Grid_search'][$I_Grid]['val'][0][] = "D:" . $trandate_dia;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['Grid_search'][$I_Grid]['val'][0][] = "M:" . $trandate_mes;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['Grid_search'][$I_Grid]['val'][0][] = "Y:" . $trandate_ano;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['Grid_search'][$I_Grid]['val'][1][] = "D:" . $trandate_input_2_dia;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['Grid_search'][$I_Grid]['val'][1][] = "M:" . $trandate_input_2_mes;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['Grid_search'][$I_Grid]['val'][1][] = "Y:" . $trandate_input_2_ano;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['campos_busca']['trandate_hor'] = $trandate_hor; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['campos_busca']['trandate_min'] = $trandate_min; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['campos_busca']['trandate_seg'] = $trandate_seg; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['campos_busca']['trandate_input_2_hor'] = $trandate_input_2_hor; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['campos_busca']['trandate_input_2_min'] = $trandate_input_2_min; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['campos_busca']['trandate_input_2_seg'] = $trandate_input_2_seg; 
      ...
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['Grid_search'][$I_Grid]['val'][0][] = "H:" . $trandate_hor;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['Grid_search'][$I_Grid]['val'][0][] = "I:" . $trandate_min;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['Grid_search'][$I_Grid]['val'][0][] = "S:" . $trandate_seg;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['Grid_search'][$I_Grid]['val'][1][] = "H:" . $trandate_input_2_hor;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['Grid_search'][$I_Grid]['val'][1][] = "I:" . $trandate_input_2_min;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['Grid_search'][$I_Grid]['val'][1][] = "S:" . $trandate_input_2_seg;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['campos_busca']['trandate_cond'] = $trandate_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['Grid_search'][$I_Grid]['cmp'] = "trandate"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['Grid_search'][$I_Grid]['opc'] = $trandate_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['grid_pesq']['trandate'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['campos_busca']['rm'] = $rm; 
      if (is_array($rm) && !empty($rm))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['Grid_search'][$I_Grid]['val'][0] = $rm;
      }
      elseif ($rm_cond_salva == "nu" || $rm_cond_salva == "nn" || $rm_cond_salva == "ep" || $rm_cond_salva == "ne" || !empty($rm))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['Grid_search'][$I_Grid]['val'][0][0] = $rm;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['campos_busca']['rm_cond'] = $rm_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['Grid_search'][$I_Grid]['cmp'] = "rm"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['Grid_search'][$I_Grid]['opc'] = $rm_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['grid_pesq']['rm'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['campos_busca']['nama'] = $nama; 
      if (is_array($nama) && !empty($nama))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['Grid_search'][$I_Grid]['val'][0] = $nama;
      }
      elseif ($nama_cond_salva == "nu" || $nama_cond_salva == "nn" || $nama_cond_salva == "ep" || $nama_cond_salva == "ne" || !empty($nama))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['Grid_search'][$I_Grid]['val'][0][0] = $nama;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['campos_busca']['nama_cond'] = $nama_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['Grid_search'][$I_Grid]['cmp'] = "nama"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['Grid_search'][$I_Grid]['opc'] = $nama_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['grid_pesq']['nama'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      ...
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['rm'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['rm'] = $rm;
      }
      $nama_look = substr($this->Db->qstr($nama), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct Nama from (SELECT 	z.tranCode,z.tranDate,z.RM, IF 	( z.Jenis = '2', z.RM, concat( x.NAME, ', ', x.salut ) ) AS Nama  FROM 	( 	SELECT 		'1' AS Jenis, 		a.tranCode AS tranCode, 		a.tranDate AS tranDate, 		b.custCode AS RM  	FROM 		tbreseprawatjalan a 		LEFT JOIN tbdetailrawatjalan b ON b.tranCode = a.tranCode  	GROUP BY 		a.tranCode UNION ALL 	SELECT 		'3' AS Jenis, 		a.tranCode AS tranCode, 		a.tranDate AS tranDate, 		b.custCode AS RM  	FROM 		tbreseprawatigd a 		LEFT JOIN tbdetailigd b ON b.tranCode = a.tranCode  	GROUP BY 		a.tranCode UNION ALL 	SELECT 		'4' AS Jenis, 		a.strukResep AS tranCode, 		a.tranDate AS tranDate, 		b.custCode AS RM  	FROM 		tbreseprawatinap a 		LEFT JOIN tbdetailrawatinap b ON b.tranCode = a.tranCode  	GROUP BY 		a.strukResep UNION ALL 	SELECT 		'2' AS Jenis, 		trancode AS tranCode, 		trandate AS tranDate, 		extname AS RM  	FROM 		tbdrugsell  	ORDER BY 		trancode DESC  	) z 	LEFT JOIN tbcustomer x ON x.custCode = z.RM  WHERE 	(DATE_FORMAT( z.tranDate, \"%Y-%m-%d\" ) = CURDATE( )  	OR DATE_FORMAT( z.tranDate, \"%Y-%m-%d\" ) = CURDATE( ) - INTERVAL 1 DAY)  	AND z.Jenis = '" . $_SESSION['jenis'] . "'  ) nm_sel_esp where Nama = '$nama_look'"; 
      ...
      if ($trandate_cond != "bi_TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['campos_busca']['trandate'] = $val[0];
          ...
          if ($trandate_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['campos_busca']['trandate_input_2'] = $val[1];
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['grid_pesq']['trandate']['label'] = $nmgp_tab_label['trandate'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['grid_pesq']['trandate']['descr'] = $nmgp_tab_label['trandate'] . " " . $this->Ini->Nm_lang['lang_srch_ever'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['grid_pesq']['trandate']['hint']  = $nmgp_tab_label['trandate'] . " " . $this->Ini->Nm_lang['lang_srch_ever'];
      }

      //----- $rm
      $this->Date_part = false;
      if (isset($rm) || $rm_cond == "nu" || $rm_cond == "nn" || $rm_cond == "ep" || $rm_cond == "ne")
      {
         $this->monta_condicao("RM", $rm_cond, $rm, "", "rm");
      }
   ...
   function finaliza_resultado_ajax()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['where_pesq'] = $this->comando;
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['where_pesq_fast'])) 
       {
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['where_pesq'])) 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['where_pesq_fast'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['where_pesq'] = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['where_pesq_fast'] . ")";
           }
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['cond_dyn_search'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_retur_pelayanan']['cond_pesq'] .= $this->NM_operador;
