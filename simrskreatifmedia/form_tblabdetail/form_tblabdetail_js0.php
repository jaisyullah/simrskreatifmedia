...
<input type="hidden" name="detailname_" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['detailname_']); ?>">
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_tblabdetail"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
function scForm_inline_submit(y, z) {
	Nm_Proc_Atualiz = true;
	do_ajax_form_tblabdetail_submit_form(y, z);
...
{
   nm_field_disabled("lastupdated_=disabled", "");
