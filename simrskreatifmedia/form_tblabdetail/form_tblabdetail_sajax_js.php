  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tblabdetail" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tblabdetail_form();
	}

  // ---------- Validate detailname_
  function do_ajax_form_tblabdetail_validate_detailname_(iNumLinha)
  {
    var nomeCampo_detailname_ = "detailname_" + iNumLinha;
    var var_detailname_ = scAjaxGetFieldText(nomeCampo_detailname_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblabdetail_validate_detailname_(var_detailname_, iNumLinha, var_script_case_init, do_ajax_form_tblabdetail_validate_detailname__cb);
  } // do_ajax_form_tblabdetail_validate_detailname_

  function do_ajax_form_tblabdetail_validate_detailname__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblabdetail_validate_detailname__cb

  // ---------- Validate oper_
  function do_ajax_form_tblabdetail_validate_oper_(iNumLinha)
  {
    var nomeCampo_oper_ = "oper_" + iNumLinha;
    var var_oper_ = scAjaxGetFieldSelect(nomeCampo_oper_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblabdetail_validate_oper_(var_oper_, iNumLinha, var_script_case_init, do_ajax_form_tblabdetail_validate_oper__cb);
  } // do_ajax_form_tblabdetail_validate_oper_

  function do_ajax_form_tblabdetail_validate_oper__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblabdetail_validate_oper__cb

  // ---------- Validate p1_
  function do_ajax_form_tblabdetail_validate_p1_(iNumLinha)
  {
    var nomeCampo_p1_ = "p1_" + iNumLinha;
    var var_p1_ = scAjaxGetFieldText(nomeCampo_p1_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblabdetail_validate_p1_(var_p1_, iNumLinha, var_script_case_init, do_ajax_form_tblabdetail_validate_p1__cb);
  } // do_ajax_form_tblabdetail_validate_p1_

  function do_ajax_form_tblabdetail_validate_p1__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "p1_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "p1_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblabdetail_validate_p1__cb

  // ---------- Validate p2_
  function do_ajax_form_tblabdetail_validate_p2_(iNumLinha)
  {
    var nomeCampo_p2_ = "p2_" + iNumLinha;
    var var_p2_ = scAjaxGetFieldText(nomeCampo_p2_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblabdetail_validate_p2_(var_p2_, iNumLinha, var_script_case_init, do_ajax_form_tblabdetail_validate_p2__cb);
  } // do_ajax_form_tblabdetail_validate_p2_

  function do_ajax_form_tblabdetail_validate_p2__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "p2_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "p2_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblabdetail_validate_p2__cb

  // ---------- Validate w1_
  function do_ajax_form_tblabdetail_validate_w1_(iNumLinha)
  {
    var nomeCampo_w1_ = "w1_" + iNumLinha;
    var var_w1_ = scAjaxGetFieldText(nomeCampo_w1_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblabdetail_validate_w1_(var_w1_, iNumLinha, var_script_case_init, do_ajax_form_tblabdetail_validate_w1__cb);
  } // do_ajax_form_tblabdetail_validate_w1_

  function do_ajax_form_tblabdetail_validate_w1__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "w1_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "w1_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblabdetail_validate_w1__cb

  // ---------- Validate w2_
  function do_ajax_form_tblabdetail_validate_w2_(iNumLinha)
  {
    var nomeCampo_w2_ = "w2_" + iNumLinha;
    var var_w2_ = scAjaxGetFieldText(nomeCampo_w2_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblabdetail_validate_w2_(var_w2_, iNumLinha, var_script_case_init, do_ajax_form_tblabdetail_validate_w2__cb);
  } // do_ajax_form_tblabdetail_validate_w2_

  function do_ajax_form_tblabdetail_validate_w2__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "w2_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "w2_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblabdetail_validate_w2__cb

  // ---------- Validate satuan_
  function do_ajax_form_tblabdetail_validate_satuan_(iNumLinha)
  {
    var nomeCampo_satuan_ = "satuan_" + iNumLinha;
    var var_satuan_ = scAjaxGetFieldSelect(nomeCampo_satuan_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblabdetail_validate_satuan_(var_satuan_, iNumLinha, var_script_case_init, do_ajax_form_tblabdetail_validate_satuan__cb);
  } // do_ajax_form_tblabdetail_validate_satuan_

  function do_ajax_form_tblabdetail_validate_satuan__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblabdetail_validate_satuan__cb

  // ---------- Validate lastupdated_
  function do_ajax_form_tblabdetail_validate_lastupdated_(iNumLinha)
  {
    var nomeCampo_lastupdated_ = "lastupdated_" + iNumLinha;
    var var_lastupdated_ = scAjaxGetFieldText(nomeCampo_lastupdated_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblabdetail_validate_lastupdated_(var_lastupdated_, iNumLinha, var_script_case_init, do_ajax_form_tblabdetail_validate_lastupdated__cb);
  } // do_ajax_form_tblabdetail_validate_lastupdated_

  function do_ajax_form_tblabdetail_validate_lastupdated__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblabdetail_validate_lastupdated__cb

  // ---------- Validate id_
  function do_ajax_form_tblabdetail_validate_id_(iNumLinha)
  {
    var nomeCampo_id_ = "id_" + iNumLinha;
    var var_id_ = scAjaxGetFieldHidden(nomeCampo_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblabdetail_validate_id_(var_id_, iNumLinha, var_script_case_init, do_ajax_form_tblabdetail_validate_id__cb);
  } // do_ajax_form_tblabdetail_validate_id_

  function do_ajax_form_tblabdetail_validate_id__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblabdetail_validate_id__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_tblabdetail_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_tblabdetail_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tblabdetail_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_tblabdetail_add_new_line_cb);
  } // do_ajax_form_tblabdetail_add_new_line

  function do_ajax_form_tblabdetail_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
    ...
    nm_field_disabled("lastupdated_=disabled", "", iAjaxNewLine);
  } // do_ajax_form_tblabdetail_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_tblabdetail_backup_line(iNumLinha)
  {
    var var_labcode_ = scAjaxGetFieldText("labcode_" + iNumLinha);
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblabdetail_backup_line(var_labcode_, var_detailname_, var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_tblabdetail_backup_line_cb);
  } // do_ajax_form_tblabdetail_backup_line

  function do_ajax_form_tblabdetail_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_tblabdetail_backup_line_cb

  function do_ajax_form_tblabdetail_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_tblabdetail_cancel_insert

  function do_ajax_form_tblabdetail_cancel_update(iSeqVert)
  {
    do_ajax_form_tblabdetail_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_tblabdetail_cancel_update

  function do_ajax_form_tblabdetail_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_tblabdetail_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_tblabdetail_table_refresh()
  {
    var var_labcode_ = document.F2.labcode_.value;
    var var_detailname_ = document.F2.detailname_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_tblabdetail_table_refresh(var_labcode_, var_detailname_, var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tblabdetail_table_refresh_cb);
  } //  do_ajax_form_tblabdetail_table_refresh

  function do_ajax_form_tblabdetail_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.labcode_.value = scAjaxGetKeyValue("labcode_");
    document.F2.detailname_.value = scAjaxGetKeyValue("detailname_");
    ...
    scAjaxAlert(do_ajax_form_tblabdetail_table_refresh_cb_after_alert);
  } // do_ajax_form_tblabdetail_table_refresh_cb
  function do_ajax_form_tblabdetail_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_tblabdetail_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_tblabdetail_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_tblabdetail_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    var var_p1_ = scAjaxGetFieldText("p1_" + iNumLinha);
    var var_p2_ = scAjaxGetFieldText("p2_" + iNumLinha);
    var var_w1_ = scAjaxGetFieldText("w1_" + iNumLinha);
    var var_w2_ = scAjaxGetFieldText("w2_" + iNumLinha);
...
?>
    x_ajax_form_tblabdetail_submit_form(var_detailname_, var_oper_, var_p1_, var_p2_, var_w1_, var_w2_, var_satuan_, var_lastupdated_, var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tblabdetail_submit_form_cb);
  } // do_ajax_form_tblabdetail_submit_form

  function do_ajax_form_tblabdetail_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("p1_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("p2_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("w1_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("w2_" + sc_num_ult_line);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_tblabdetail_submit_form_cb_after_alert);
  } // do_ajax_form_tblabdetail_submit_form_cb
  function do_ajax_form_tblabdetail_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tblabdetail_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tblabdetail_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_tblabdetail_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("p1_" + iNavForm);
      scAjaxHideErrorDisplay("p2_" + iNavForm);
      scAjaxHideErrorDisplay("w1_" + iNavForm);
      scAjaxHideErrorDisplay("w2_" + iNavForm);
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tblabdetail_navigate_form(var_labcode_, var_detailname_, var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tblabdetail_navigate_form_cb);
  } // do_ajax_form_tblabdetail_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblabdetail']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tblabdetail_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.labcode_.value = scAjaxGetKeyValue("labcode_" + var_last_index);
    document.F2.detailname_.value = scAjaxGetKeyValue("detailname_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tblabdetail_navigate_form_cb_after_alert);
  } // do_ajax_form_tblabdetail_navigate_form_cb
  function do_ajax_form_tblabdetail_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_tblabdetail_navigate_form_cb_after_alert
  function sc_hide_form_tblabdetail_form()
  {
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "p1_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "p2_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "w1_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "w2_" + iNumLinha;
    iTotCampos++;
    ...
    iTotCampos++;
    ajax_error_list["detailname_" + iNumLinha] = {"label": "Nama Detail<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["oper_" + iNumLinha] = {"label": "Oper (LK:PR)<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["p1_" + iNumLinha] = {"label": "Rujukan Pria 1<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["p2_" + iNumLinha] = {"label": "Rujukan Pria 2<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["w1_" + iNumLinha] = {"label": "Rujukan Wanita 1<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["w2_" + iNumLinha] = {"label": "Rujukan Wanita 2<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_error_list["lastupdated_" + iNumLinha] = {"label": "Terakhir Update<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_field_mult["p1_"][iNumLinha] = "p1_" + iNumLinha;
    ajax_field_mult["p2_"][iNumLinha] = "p2_" + iNumLinha;
    ajax_field_mult["w1_"][iNumLinha] = "w1_" + iNumLinha;
    ajax_field_mult["w2_"][iNumLinha] = "w2_" + iNumLinha;
    ...
    ajax_field_id["p1_" + iNumLinha] = new Array("hidden_field_label_p1_", "hidden_field_data_p1_" + iNumLinha);
    ajax_field_id["p2_" + iNumLinha] = new Array("hidden_field_label_p2_", "hidden_field_data_p2_" + iNumLinha);
    ajax_field_id["w1_" + iNumLinha] = new Array("hidden_field_label_w1_", "hidden_field_data_w1_" + iNumLinha);
    ajax_field_id["w2_" + iNumLinha] = new Array("hidden_field_label_w2_", "hidden_field_data_w2_" + iNumLinha);
    ...
    ajax_error_count["p1_" + iNumLinha] = "off";
    ajax_error_count["p2_" + iNumLinha] = "off";
    ajax_error_count["w1_" + iNumLinha] = "off";
    ajax_error_count["w2_" + iNumLinha] = "off";
...
?>
    ...
    ajax_read_only["p1_" + iNumLinha] = "off";
    ajax_read_only["p2_" + iNumLinha] = "off";
    ajax_read_only["w1_" + iNumLinha] = "off";
    ajax_read_only["w2_" + iNumLinha] = "off";
...
?>
    ...
    ajax_read_only["p1_" + iNumLinha] = "on";
    ajax_read_only["p2_" + iNumLinha] = "on";
    ajax_read_only["w1_" + iNumLinha] = "on";
    ajax_read_only["w2_" + iNumLinha] = "on";
...
?>
  ...
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["p1_" + iNumLinha] = null;
    ajax_error_list["p2_" + iNumLinha] = null;
    ajax_error_list["w1_" + iNumLinha] = null;
    ajax_error_list["w2_" + iNumLinha] = null;
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["p1_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["p1_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["p1_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["p1_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["p1_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["p2_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["p2_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["p2_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["p2_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["p2_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["w1_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["w1_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["w1_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["w1_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["w1_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["w2_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["w2_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["w2_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["w2_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["w2_" + iNumLinha]["onfocus"] = new Array();
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['detailname_'])) ? $this->nmgp_cmp_readonly['detailname_'] : 'on';
?>
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['p1_'])) ? $this->nmgp_cmp_readonly['p1_'] : 'off';
?>
    scAjaxFieldRead("p1_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['p2_'])) ? $this->nmgp_cmp_readonly['p2_'] : 'off';
?>
    scAjaxFieldRead("p2_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['w1_'])) ? $this->nmgp_cmp_readonly['w1_'] : 'off';
?>
    scAjaxFieldRead("w1_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['w2_'])) ? $this->nmgp_cmp_readonly['w2_'] : 'off';
?>
    scAjaxFieldRead("w2_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
?>
  ...
  function mdCloseObjects(iSeq)
  {
    ...
    scAjaxFieldRead("p1_" + iSeq, "on");
    scAjaxFieldRead("p2_" + iSeq, "on");
    scAjaxFieldRead("w1_" + iSeq, "on");
    scAjaxFieldRead("w2_" + iSeq, "on");
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["detailname_" + iRow] || "on" == ajax_error_count["oper_" + iRow] || "on" == ajax_error_count["p1_" + iRow] || "on" == ajax_error_count["p2_" + iRow] || "on" == ajax_error_count["w1_" + iRow] || "on" == ajax_error_count["w2_" + iRow] || "on" == ajax_error_count["satuan_" + iRow] || "on" == ajax_error_count["lastupdated_" + iRow] || "on" == ajax_error_count["id_" + iRow]))
    {
      ...
      $("#hidden_field_data_p1_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_p2_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_w1_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_w2_" + iRow).addClass("scFormErrorLine");
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["detailname_" + iRow] && "off" == ajax_error_count["oper_" + iRow] && "off" == ajax_error_count["p1_" + iRow] && "off" == ajax_error_count["p2_" + iRow] && "off" == ajax_error_count["w1_" + iRow] && "off" == ajax_error_count["w2_" + iRow] && "off" == ajax_error_count["satuan_" + iRow] && "off" == ajax_error_count["lastupdated_" + iRow] && "off" == ajax_error_count["id_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["detailname_" + iRow] = "off";
        ajax_error_count["oper_" + iRow] = "off";
        ajax_error_count["p1_" + iRow] = "off";
        ajax_error_count["p2_" + iRow] = "off";
        ajax_error_count["w1_" + iRow] = "off";
        ajax_error_count["w2_" + iRow] = "off";
      ...
      $("#hidden_field_data_p1_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_p2_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_w1_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_w2_" + iRow).removeClass("scFormErrorLine");
