...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['embutida_pdf']))
 {
 ?>
...
<?php
include_once("form_pay_poli_old_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_pay_poli_old_jquery.php');
...
?>
 ...
 function addAutocomplete(elem) {
  ...
  $(".sc-ui-autocomp-instansipenjamin", elem).on("focus", function() {
   ...
   var sId = $(this).attr("id").substr(6), sRow = "instansipenjamin" != sId ? sId.substr(16) : "";
   sc_form_pay_poli_old_instansipenjamin_onfocus("id_sc_field_" + sId, sRow);
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
?>
...
<?php
 include_once("form_pay_poli_old_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_pay_poli_old'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_pay_poli_old'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['fast_search'][2] : "";
?> 
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['run_iframe'] != "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['run_iframe'] == "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<span id="id_read_on_trancode" class="sc-ui-readonly-trancode css_trancode_line" style="<?php echo $sStyleReadLab_trancode; ?>"><?php echo $this->trancode; ?></span><span id="id_read_off_trancode" class="css_read_off_trancode" style="white-space: nowrap;<?php echo $sStyleReadInp_trancode; ?>">
 ...
 size=20 maxlength=20 alt="{datatype: 'text', maxLength: 20, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php
   $Sc_iframe_master = ($this->Embutida_call) ? 'nmgp_iframe_ret*scinnmsc_iframe_liga_form_pay_poli_old*scout' : '';
   if (isset($this->Ini->sc_lig_md5["grid_select_payment"]) && $this->Ini->sc_lig_md5["grid_select_payment"] == "S") {
       ...
       $Md5_Lig    = "@SC_par@" . $this->form_encode_input($this->Ini->sc_page) . "@SC_par@form_pay_poli_old@SC_par@" . md5($Parms_Lig);
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['Lig_Md5'][md5($Parms_Lig)] = $Parms_Lig;
   } else {
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_jenispayment_label" id="hidden_field_label_jenispayment" style="<?php echo $sStyleHidden_jenispayment; ?>"><span id="id_label_jenispayment"><?php echo $this->nm_new_label['jenispayment']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['php_cmp_required']['jenispayment']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['php_cmp_required']['jenispayment'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['Lookup_jenispayment'][] = ''; ?>
 <option value=""></option>
 <option  value="TUNAI" <?php  if ($this->jenispayment == "TUNAI") { echo " selected" ;} ?>>TUNAI</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['Lookup_jenispayment'][] = 'TUNAI'; ?>
 <option  value="BPJS" <?php  if ($this->jenispayment == "BPJS") { echo " selected" ;} ?>>BPJS</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['Lookup_jenispayment'][] = 'BPJS'; ?>
 <option  value="KARTU KREDIT" <?php  if ($this->jenispayment == "KARTU KREDIT") { echo " selected" ;} ?>>KARTU KREDIT</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['Lookup_jenispayment'][] = 'KARTU KREDIT'; ?>
 <option  value="KARTU DEBIT" <?php  if ($this->jenispayment == "KARTU DEBIT") { echo " selected" ;} ?>>KARTU DEBIT</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['Lookup_jenispayment'][] = 'KARTU DEBIT'; ?>
 <option  value="ASURANSI" <?php  if ($this->jenispayment == "ASURANSI") { echo " selected" ;} ?>>ASURANSI</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['Lookup_jenispayment'][] = 'ASURANSI'; ?>
 <option  value="KARYAWAN" <?php  if ($this->jenispayment == "KARYAWAN") { echo " selected" ;} ?>>KARYAWAN</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['Lookup_jenispayment'][] = 'KARYAWAN'; ?>
 <option  value="KOMBINASI" <?php  if ($this->jenispayment == "KOMBINASI") { echo " selected" ;} ?>>KOMBINASI</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['Lookup_jenispayment'][] = 'KOMBINASI'; ?>
 <option  value="BANSOS" <?php  if ($this->jenispayment == "BANSOS") { echo " selected" ;} ?>>BANSOS</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['Lookup_jenispayment'][] = 'BANSOS'; ?>
 <option  value="JAMPERU" <?php  if ($this->jenispayment == "JAMPERU") { echo " selected" ;} ?>>JAMPERU</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['Lookup_jenispayment'][] = 'JAMPERU'; ?>
 </select></span>
</span><?php  }?>
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_detailTindakan'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_detailTindakan'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbtindakanrawatjalan_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_detailTindakan'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbtindakanrawatjalan_script_case_init'] = $this->Ini->sc_page;
 }
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbtindakanrawatjalan_script_case_init'] ]['form_tbtindakanrawatjalan']['embutida_proc']  = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbtindakanrawatjalan_script_case_init'] ]['form_tbtindakanrawatjalan']['embutida_form']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbtindakanrawatjalan_script_case_init'] ]['form_tbtindakanrawatjalan']['embutida_call']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbtindakanrawatjalan_script_case_init'] ]['form_tbtindakanrawatjalan']['embutida_multi'] = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbtindakanrawatjalan_script_case_init'] ]['form_tbtindakanrawatjalan']['embutida_liga_form_insert'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbtindakanrawatjalan_script_case_init'] ]['form_tbtindakanrawatjalan']['embutida_liga_form_update'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbtindakanrawatjalan_script_case_init'] ]['form_tbtindakanrawatjalan']['embutida_liga_form_delete'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbtindakanrawatjalan_script_case_init'] ]['form_tbtindakanrawatjalan']['embutida_liga_form_btn_nav'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbtindakanrawatjalan_script_case_init'] ]['form_tbtindakanrawatjalan']['embutida_liga_grid_edit'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbtindakanrawatjalan_script_case_init'] ]['form_tbtindakanrawatjalan']['embutida_liga_grid_edit_link'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbtindakanrawatjalan_script_case_init'] ]['form_tbtindakanrawatjalan']['embutida_liga_qtd_reg'] = '10';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbtindakanrawatjalan_script_case_init'] ]['form_tbtindakanrawatjalan']['embutida_liga_tp_pag'] = 'total';
 ...
 if ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbtindakanrawatjalan_script_case_init'] ]['form_pay_poli_old']['total'] < 0)
 {
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_pay_poli_old_empty.htm' : $this->Ini->link_form_tbtindakanrawatjalan_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_session=' . session_id() . '&script_case_detail=Y';
if (isset($this->Ini->sc_lig_target['C_@scinf_detailTindakan']) && 'nmsc_iframe_liga_form_tbtindakanrawatjalan' != $this->Ini->sc_lig_target['C_@scinf_detailTindakan'])
{
    ...
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_detailTindakan'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbtindakanrawatjalan_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_detailResep'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_detailResep'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbreseprawatjalan_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_detailResep'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbreseprawatjalan_script_case_init'] = $this->Ini->sc_page;
 }
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbreseprawatjalan_script_case_init'] ]['form_tbreseprawatjalan']['embutida_proc']  = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbreseprawatjalan_script_case_init'] ]['form_tbreseprawatjalan']['embutida_form']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbreseprawatjalan_script_case_init'] ]['form_tbreseprawatjalan']['embutida_call']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbreseprawatjalan_script_case_init'] ]['form_tbreseprawatjalan']['embutida_multi'] = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbreseprawatjalan_script_case_init'] ]['form_tbreseprawatjalan']['embutida_liga_form_insert'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbreseprawatjalan_script_case_init'] ]['form_tbreseprawatjalan']['embutida_liga_form_update'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbreseprawatjalan_script_case_init'] ]['form_tbreseprawatjalan']['embutida_liga_form_delete'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbreseprawatjalan_script_case_init'] ]['form_tbreseprawatjalan']['embutida_liga_form_btn_nav'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbreseprawatjalan_script_case_init'] ]['form_tbreseprawatjalan']['embutida_liga_grid_edit'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbreseprawatjalan_script_case_init'] ]['form_tbreseprawatjalan']['embutida_liga_grid_edit_link'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbreseprawatjalan_script_case_init'] ]['form_tbreseprawatjalan']['embutida_liga_qtd_reg'] = '10';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbreseprawatjalan_script_case_init'] ]['form_tbreseprawatjalan']['embutida_liga_tp_pag'] = 'total';
 ...
 if ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbreseprawatjalan_script_case_init'] ]['form_pay_poli_old']['total'] < 0)
 {
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_pay_poli_old_empty.htm' : $this->Ini->link_form_tbreseprawatjalan_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_session=' . session_id() . '&script_case_detail=Y';
if (isset($this->Ini->sc_lig_target['C_@scinf_detailResep']) && 'nmsc_iframe_liga_form_tbreseprawatjalan' != $this->Ini->sc_lig_target['C_@scinf_detailResep'])
{
    if ('novo' != $this->nmgp_opcao)
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_detailResep'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbreseprawatjalan_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_detailAdm'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_detailAdm'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_detailadm_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_detailAdm'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_detailadm_script_case_init'] = $this->Ini->sc_page;
 }
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_detailadm_script_case_init'] ]['form_detailadm']['embutida_proc']  = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_detailadm_script_case_init'] ]['form_detailadm']['embutida_form']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_detailadm_script_case_init'] ]['form_detailadm']['embutida_call']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_detailadm_script_case_init'] ]['form_detailadm']['embutida_multi'] = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_detailadm_script_case_init'] ]['form_detailadm']['embutida_liga_form_insert'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_detailadm_script_case_init'] ]['form_detailadm']['embutida_liga_form_update'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_detailadm_script_case_init'] ]['form_detailadm']['embutida_liga_form_delete'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_detailadm_script_case_init'] ]['form_detailadm']['embutida_liga_form_btn_nav'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_detailadm_script_case_init'] ]['form_detailadm']['embutida_liga_grid_edit'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_detailadm_script_case_init'] ]['form_detailadm']['embutida_liga_grid_edit_link'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_detailadm_script_case_init'] ]['form_detailadm']['embutida_liga_qtd_reg'] = '10';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_detailadm_script_case_init'] ]['form_detailadm']['embutida_liga_tp_pag'] = 'parcial';
 ...
 if ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_detailadm_script_case_init'] ]['form_pay_poli_old']['total'] < 0)
 {
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_pay_poli_old_empty.htm' : $this->Ini->link_form_detailadm_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_session=' . session_id() . '&script_case_detail=Y';
if (isset($this->Ini->sc_lig_target['C_@scinf_detailAdm']) && 'nmsc_iframe_liga_form_detailadm' != $this->Ini->sc_lig_target['C_@scinf_detailAdm'])
{
    if ('novo' != $this->nmgp_opcao)
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_detailAdm'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_detailadm_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_lab'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_lab'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbrujukanlab_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_lab'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbrujukanlab_script_case_init'] = $this->Ini->sc_page;
 }
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbrujukanlab_script_case_init'] ]['form_tbrujukanlab']['embutida_proc']  = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbrujukanlab_script_case_init'] ]['form_tbrujukanlab']['embutida_form']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbrujukanlab_script_case_init'] ]['form_tbrujukanlab']['embutida_call']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbrujukanlab_script_case_init'] ]['form_tbrujukanlab']['embutida_multi'] = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbrujukanlab_script_case_init'] ]['form_tbrujukanlab']['embutida_liga_form_insert'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbrujukanlab_script_case_init'] ]['form_tbrujukanlab']['embutida_liga_form_update'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbrujukanlab_script_case_init'] ]['form_tbrujukanlab']['embutida_liga_form_delete'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbrujukanlab_script_case_init'] ]['form_tbrujukanlab']['embutida_liga_form_btn_nav'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbrujukanlab_script_case_init'] ]['form_tbrujukanlab']['embutida_liga_grid_edit'] = '';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbrujukanlab_script_case_init'] ]['form_tbrujukanlab']['embutida_liga_grid_edit_link'] = '';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbrujukanlab_script_case_init'] ]['form_tbrujukanlab']['embutida_liga_qtd_reg'] = '10';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbrujukanlab_script_case_init'] ]['form_tbrujukanlab']['embutida_liga_tp_pag'] = 'total';
 ...
 if ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbrujukanlab_script_case_init'] ]['form_pay_poli_old']['total'] < 0)
 {
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_pay_poli_old_empty.htm' : $this->Ini->link_form_tbrujukanlab_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_session=' . session_id() . '&script_case_detail=Y&sc_ifr_height=500';
if (isset($this->Ini->sc_lig_target['C_@scinf_lab']) && 'nmsc_iframe_liga_form_tbrujukanlab' != $this->Ini->sc_lig_target['C_@scinf_lab'])
{
    if ('novo' != $this->nmgp_opcao)
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_lab'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbrujukanlab_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_radiologi'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_radiologi'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbrujukanradiologi_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_radiologi'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbrujukanradiologi_script_case_init'] = $this->Ini->sc_page;
 }
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbrujukanradiologi_script_case_init'] ]['form_tbrujukanradiologi']['embutida_proc']  = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbrujukanradiologi_script_case_init'] ]['form_tbrujukanradiologi']['embutida_form']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbrujukanradiologi_script_case_init'] ]['form_tbrujukanradiologi']['embutida_call']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbrujukanradiologi_script_case_init'] ]['form_tbrujukanradiologi']['embutida_multi'] = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbrujukanradiologi_script_case_init'] ]['form_tbrujukanradiologi']['embutida_liga_form_insert'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbrujukanradiologi_script_case_init'] ]['form_tbrujukanradiologi']['embutida_liga_form_update'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbrujukanradiologi_script_case_init'] ]['form_tbrujukanradiologi']['embutida_liga_form_delete'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbrujukanradiologi_script_case_init'] ]['form_tbrujukanradiologi']['embutida_liga_form_btn_nav'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbrujukanradiologi_script_case_init'] ]['form_tbrujukanradiologi']['embutida_liga_grid_edit'] = '';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbrujukanradiologi_script_case_init'] ]['form_tbrujukanradiologi']['embutida_liga_grid_edit_link'] = '';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbrujukanradiologi_script_case_init'] ]['form_tbrujukanradiologi']['embutida_liga_qtd_reg'] = '10';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbrujukanradiologi_script_case_init'] ]['form_tbrujukanradiologi']['embutida_liga_tp_pag'] = 'total';
 ...
 if ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbrujukanradiologi_script_case_init'] ]['form_pay_poli_old']['total'] < 0)
 {
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_pay_poli_old_empty.htm' : $this->Ini->link_form_tbrujukanradiologi_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_session=' . session_id() . '&script_case_detail=Y&sc_ifr_height=500';
if (isset($this->Ini->sc_lig_target['C_@scinf_radiologi']) && 'nmsc_iframe_liga_form_tbrujukanradiologi' != $this->Ini->sc_lig_target['C_@scinf_radiologi'])
{
    if ('novo' != $this->nmgp_opcao)
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_radiologi'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbrujukanradiologi_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_bhp'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_bhp'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbbhprawatjalan_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_bhp'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbbhprawatjalan_script_case_init'] = $this->Ini->sc_page;
 }
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbbhprawatjalan_script_case_init'] ]['form_tbbhprawatjalan']['embutida_proc']  = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbbhprawatjalan_script_case_init'] ]['form_tbbhprawatjalan']['embutida_form']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbbhprawatjalan_script_case_init'] ]['form_tbbhprawatjalan']['embutida_call']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbbhprawatjalan_script_case_init'] ]['form_tbbhprawatjalan']['embutida_multi'] = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbbhprawatjalan_script_case_init'] ]['form_tbbhprawatjalan']['embutida_liga_form_insert'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbbhprawatjalan_script_case_init'] ]['form_tbbhprawatjalan']['embutida_liga_form_update'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbbhprawatjalan_script_case_init'] ]['form_tbbhprawatjalan']['embutida_liga_form_delete'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbbhprawatjalan_script_case_init'] ]['form_tbbhprawatjalan']['embutida_liga_form_btn_nav'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbbhprawatjalan_script_case_init'] ]['form_tbbhprawatjalan']['embutida_liga_grid_edit'] = '';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbbhprawatjalan_script_case_init'] ]['form_tbbhprawatjalan']['embutida_liga_grid_edit_link'] = '';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbbhprawatjalan_script_case_init'] ]['form_tbbhprawatjalan']['embutida_liga_qtd_reg'] = '10';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbbhprawatjalan_script_case_init'] ]['form_tbbhprawatjalan']['embutida_liga_tp_pag'] = 'total';
 ...
 if ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbbhprawatjalan_script_case_init'] ]['form_pay_poli_old']['total'] < 0)
 {
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_pay_poli_old_empty.htm' : $this->Ini->link_form_tbbhprawatjalan_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_session=' . session_id() . '&script_case_detail=Y';
if (isset($this->Ini->sc_lig_target['C_@scinf_bhp']) && 'nmsc_iframe_liga_form_tbbhprawatjalan' != $this->Ini->sc_lig_target['C_@scinf_bhp'])
{
    if ('novo' != $this->nmgp_opcao)
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_bhp'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbbhprawatjalan_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_pay_poli_old");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_pay_poli_old");
 parent.scAjaxDetailHeight("form_pay_poli_old", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
