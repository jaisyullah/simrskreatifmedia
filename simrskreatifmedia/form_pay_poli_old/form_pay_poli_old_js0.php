...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
  <input type="hidden" name="script_case_session" value="<?php echo $this->form_encode_input(session_id()); ?>"> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_pay_poli_old"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
{
      nm_gp_submit('<?php echo $this->Ini->link_cetak_rj; ?>', '<?php echo $this->nm_location; ?>', '<?php echo "payno*scin' + var_btn_Cetak_payno + '*scout"; ?>', '', '_blank', '0', '0', 'cetak_rj');
}
...
{
  nm_gp_submit('<?php echo $this->Ini->link_cetak_card; ?>', '<?php echo $this->nm_location; ?>', '<?php echo "payno*scin' + var_btn_sc_btn_0_payno + '*scout"; ?>', '', '_blank', '0', '0', 'cetak_card');
}
 NM_tp_critica(1);
...
{ 
   var sob_iframe = '';
<?php 
if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['embutida_form']) {
...
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['sc_modal']) {
    echo "   sob_iframe += 'parent.';\r\n";
}
?>
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['where_detal']))
  {
?>  
...
{
   nm_field_disabled("nopayment=disabled", "");
   nm_field_disabled("jmlbayar=disabled;potongan=disabled", "I");
   nm_field_disabled("trancode=disabled;nostruk=disabled;custcode=disabled;sc_field_1=disabled;dokter=disabled;jmltagihan=disabled;hrsdibayar=disabled;kasir=disabled", "U");
