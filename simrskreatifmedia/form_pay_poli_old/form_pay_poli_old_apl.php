...
//----- 
   function ini_controle()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['form_pay_poli_old']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['form_pay_poli_old']['embutida_parms'];
          unset($_SESSION['sc_session'][$script_case_init]['form_pay_poli_old']['embutida_parms']);
      } 
      ...
      { 
          ...
          while (!empty($todo[$ix]))
          {
             ...
             if (1 < sizeof($cadapar))
             {
                if (substr($cadapar[0], 0, 11) == "SC_glo_par_")
                {
                 ...
                 nm_limpa_str_form_pay_poli_old($cadapar[1]);
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_pay_poli_old']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_pay_poli_old']['total']);
          }
          if (!isset($_SESSION['sc_session'][$script_case_init]['form_pay_poli_old']['total']))
          {
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_pay_poli_old']['form_tbtindakanrawatjalan_script_case_init'] ]['form_tbtindakanrawatjalan']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_pay_poli_old']['form_tbtindakanrawatjalan_script_case_init'] ]['form_tbtindakanrawatjalan']['total']);
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_pay_poli_old']['form_tbreseprawatjalan_script_case_init'] ]['form_tbreseprawatjalan']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_pay_poli_old']['form_tbreseprawatjalan_script_case_init'] ]['form_tbreseprawatjalan']['total']);
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_pay_poli_old']['form_detailadm_script_case_init'] ]['form_detailadm']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_pay_poli_old']['form_detailadm_script_case_init'] ]['form_detailadm']['total']);
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_pay_poli_old']['form_tbrujukanlab_script_case_init'] ]['form_tbrujukanlab']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_pay_poli_old']['form_tbrujukanlab_script_case_init'] ]['form_tbrujukanlab']['total']);
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_pay_poli_old']['form_tbrujukanradiologi_script_case_init'] ]['form_tbrujukanradiologi']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_pay_poli_old']['form_tbrujukanradiologi_script_case_init'] ]['form_tbrujukanradiologi']['total']);
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_pay_poli_old']['form_tbbhprawatjalan_script_case_init'] ]['form_tbbhprawatjalan']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_pay_poli_old']['form_tbbhprawatjalan_script_case_init'] ]['form_tbbhprawatjalan']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_pay_poli_old']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_pay_poli_old']['sc_redir_insert'] = $this->sc_redir_insert;
          }
          if (isset($this->usr_login)) 
          {
              $_SESSION['usr_login'] = $this->usr_login;
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_pay_poli_old']['parms']))
      {
          if ((!isset($this->nmgp_opcao) || ($this->nmgp_opcao != "incluir" && $this->nmgp_opcao != "alterar" && $this->nmgp_opcao != "excluir" && $this->nmgp_opcao != "novo" && $this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")) && (!isset($this->NM_ajax_opcao) || $this->NM_ajax_opcao == ""))
          {
              $todox = str_replace("?#?@?@?", "?#?@ ?@?", $_SESSION['sc_session'][$script_case_init]['form_pay_poli_old']['parms']);
              $todo  = explode("?@?", $todox);
              $ix = 0;
              while (!empty($todo[$ix]))
              {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_pay_poli_old']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_pay_poli_old']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_pay_poli_old']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_pay_poli_old']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_pay_poli_old']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_pay_poli_old']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_pay_poli_old']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_pay_poli_old']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_pay_poli_old_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("id");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['initialize'];
      } 
      else 
      { 
         $this->nm_data = new nm_data("id");
      } 
      $_SESSION['sc_session'][$script_case_init]['form_pay_poli_old']['upload_field_info'] = array();

      $this->Ini->Init_apl_lig = array();
      $this->List_apl_lig = array('cetak_rj'=>array('type'=>'blank', 'lab'=>'Struk Poliklinik', 'hint'=>'', 'img_on'=>'', 'img_off'=>''));
      if (isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['sc_outra_jan'] || $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['sc_modal']))
      {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_pay_poli_old']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_pay_poli_old'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_pay_poli_old']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_pay_poli_old']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_pay_poli_old') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_pay_poli_old']['label'] = "" . $this->Ini->Nm_lang['lang_othr_frmu_titl'] . " - Pembayaran RJ";
      ...
      $_SESSION['scriptcase']['error_icon']['form_pay_poli_old']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Rhino__NM__nm_scriptcase9_Rhino_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_pay_poli_old'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['embutida_call'] : $this->Embutida_call;

       $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_pay_poli_old']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_pay_poli_old']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_pay_poli_old']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_pay_poli_old']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_pay_poli_old']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_pay_poli_old']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_pay_poli_old']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_pay_poli_old']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_pay_poli_old']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_pay_poli_old']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_pay_poli_old']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_pay_poli_old']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_pay_poli_old']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_pay_poli_old']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_pay_poli_old']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_pay_poli_old']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_pay_poli_old']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_pay_poli_old']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_pay_poli_old']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_pay_poli_old']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_pay_poli_old']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_pay_poli_old']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_pay_poli_old']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_pay_poli_old']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_pay_poli_old']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_pay_poli_old']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_pay_poli_old']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_pay_poli_old']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_pay_poli_old']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_pay_poli_old']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_pay_poli_old']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_pay_poli_old']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_pay_poli_old']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_pay_poli_old']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_pay_poli_old']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_pay_poli_old']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_pay_poli_old']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_pay_poli_old']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_pay_poli_old']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_pay_poli_old']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_pay_poli_old']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_pay_poli_old']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_pay_poli_old']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_pay_poli_old']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_pay_poli_old']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_pay_poli_old']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_pay_poli_old']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_pay_poli_old']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_pay_poli_old']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_pay_poli_old']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_pay_poli_old']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_pay_poli_old']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_pay_poli_old']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_pay_poli_old']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_pay_poli_old']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_pay_poli_old']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_pay_poli_old']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_pay_poli_old']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_pay_poli_old']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_pay_poli_old']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_pay_poli_old']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_pay_poli_old']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_pay_poli_old']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_pay_poli_old']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_pay_poli_old']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_pay_poli_old']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_pay_poli_old']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_pay_poli_old']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_pay_poli_old']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_pay_poli_old']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_pay_poli_old']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_pay_poli_old']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_pay_poli_old']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_pay_poli_old']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_pay_poli_old']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_pay_poli_old']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_pay_poli_old']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_pay_poli_old']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_pay_poli_old']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_pay_poli_old']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_pay_poli_old']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_pay_poli_old']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_pay_poli_old']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_pay_poli_old']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_pay_poli_old']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_pay_poli_old']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_pay_poli_old']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_pay_poli_old'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_pay_poli_old'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_pay_poli_old']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['form_pay_poli_old']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['form_pay_poli_old']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['form_pay_poli_old']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_pay_poli_old']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['form_pay_poli_old']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['form_pay_poli_old']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_pay_poli_old']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['form_pay_poli_old']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['form_pay_poli_old']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_pay_poli_old']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_pay_poli_old']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_pay_poli_old']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_pay_poli_old']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_pay_poli_old']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_pay_poli_old']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_pay_poli_old']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_pay_poli_old']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['form_pay_poli_old']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['dados_form'];
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("form_pay_poli_old", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (isset($_GET['nm_cal_display']))
      {
          ...
          { 
              include_once($this->Ini->path_embutida . 'form_pay_poli_old/form_pay_poli_old_calendar.php');
          }
          else
          { 
              include_once($this->Ini->path_aplicacao . 'form_pay_poli_old_calendar.php');
          }
          exit;
      }

      if (is_file($this->Ini->path_aplicacao . 'form_pay_poli_old_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_pay_poli_old_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      if ($this->Embutida_proc)
      { 
          require_once($this->Ini->path_embutida . 'form_pay_poli_old/form_pay_poli_old_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_pay_poli_old_erro.class.php"); 
      }
      $this->Erro      = new form_pay_poli_old_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if ($this->nmgp_opcao == "fast_search")  
      {
          $this->SC_fast_search($this->nmgp_fast_search, $this->nmgp_cond_fast_search, $this->nmgp_arg_fast_search);
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['opcao'] = "inicio";
          $this->nmgp_opcao = "inicio";
          $this->proc_fast_search = true;
      } 
      if ($nm_opc_lookup != "lookup" && $nm_opc_php != "formphp")
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['opcao']))
         { 
             if ($this->id != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_pay_poli_old']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_pay_poli_old']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_pay_poli_old']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['opc_ant'];
      } 
      ...
      {
          $this->nmgp_botoes['Cetak'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['botoes']['Cetak'];
          $this->nmgp_botoes['sc_btn_0'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['botoes']['sc_btn_0'];
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['final'];
      }
      else
      {
      }
...
//
      if ($this->nmgp_opcao == "excluir")
      {
          ...
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbtindakanrawatjalan_script_case_init'] ]['form_tbtindakanrawatjalan']['embutida_form'] = false;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbtindakanrawatjalan_script_case_init'] ]['form_tbtindakanrawatjalan']['embutida_proc'] = true;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbtindakanrawatjalan_script_case_init'] ]['form_tbtindakanrawatjalan']['reg_start'] = "";
          unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbtindakanrawatjalan_script_case_init'] ]['form_tbtindakanrawatjalan']['total']);
          ...
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbreseprawatjalan_script_case_init'] ]['form_tbreseprawatjalan']['embutida_form'] = false;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbreseprawatjalan_script_case_init'] ]['form_tbreseprawatjalan']['embutida_proc'] = true;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbreseprawatjalan_script_case_init'] ]['form_tbreseprawatjalan']['reg_start'] = "";
          unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbreseprawatjalan_script_case_init'] ]['form_tbreseprawatjalan']['total']);
          ...
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_detailadm_script_case_init'] ]['form_detailadm']['embutida_form'] = false;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_detailadm_script_case_init'] ]['form_detailadm']['embutida_proc'] = true;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_detailadm_script_case_init'] ]['form_detailadm']['reg_start'] = "";
          unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_detailadm_script_case_init'] ]['form_detailadm']['total']);
          ...
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbrujukanlab_script_case_init'] ]['form_tbrujukanlab']['embutida_form'] = false;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbrujukanlab_script_case_init'] ]['form_tbrujukanlab']['embutida_proc'] = true;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbrujukanlab_script_case_init'] ]['form_tbrujukanlab']['reg_start'] = "";
          unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbrujukanlab_script_case_init'] ]['form_tbrujukanlab']['total']);
          ...
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbrujukanradiologi_script_case_init'] ]['form_tbrujukanradiologi']['embutida_form'] = false;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbrujukanradiologi_script_case_init'] ]['form_tbrujukanradiologi']['embutida_proc'] = true;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbrujukanradiologi_script_case_init'] ]['form_tbrujukanradiologi']['reg_start'] = "";
          unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbrujukanradiologi_script_case_init'] ]['form_tbrujukanradiologi']['total']);
          ...
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbbhprawatjalan_script_case_init'] ]['form_tbbhprawatjalan']['embutida_form'] = false;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbbhprawatjalan_script_case_init'] ]['form_tbbhprawatjalan']['embutida_proc'] = true;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbbhprawatjalan_script_case_init'] ]['form_tbbhprawatjalan']['reg_start'] = "";
          unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbbhprawatjalan_script_case_init'] ]['form_tbbhprawatjalan']['total']);
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['dados_select'];
     }
   }
...
//
      if ($this->NM_ajax_flag && 'validate_' == substr($this->NM_ajax_opcao, 0, 9))
      {
          ...
          form_pay_poli_old_pack_ajax_response();
          exit;
      }
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6))
      {
   ...
   $nm_nao_carga = false;
   $nmgp_def_dados = "" ; 
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['Lookup_instansipenjamin']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['Lookup_instansipenjamin'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['Lookup_instansipenjamin']); 
   }
   else
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['Lookup_instansipenjamin'] = array(); 
    }
   ...
   if ($nm_comando != "" && $rs = $this->Db->SelectLimit($nm_comando, 10, 0))
   {
       while (!$rs->EOF) 
       { 
              $aLookup[] = array(form_pay_poli_old_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', form_pay_poli_old_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['Lookup_instansipenjamin'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "recarga_mobile" || $this->nmgp_opcao == "muda_form") 
      {
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['dados_select']['trancode']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->trancode = $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['dados_select']['trancode'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['dados_select']['nostruk']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->nostruk = $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['dados_select']['nostruk'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['dados_select']['custcode']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->custcode = $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['dados_select']['custcode'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['dados_select']['sc_field_1']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->sc_field_1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['dados_select']['sc_field_1'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['dados_select']['dokter']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->dokter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['dados_select']['dokter'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['dados_select']['jmltagihan']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->jmltagihan = $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['dados_select']['jmltagihan'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['dados_select']['jmlbayar']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->jmlbayar = $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['dados_select']['jmlbayar'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['dados_select']['potongan']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->potongan = $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['dados_select']['potongan'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['dados_select']['hrsdibayar']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->hrsdibayar = $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['dados_select']['hrsdibayar'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['dados_select']['nopayment']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->nopayment = $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['dados_select']['nopayment'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['dados_select']['kasir']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->kasir = $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['dados_select']['kasir'];
          } 
      ...
      if ($this->nmgp_opcao == "incluir" || $this->nmgp_opcao == "alterar" || $this->nmgp_opcao == "excluir") 
      {
          ...
          $_SESSION['scriptcase']['form_pay_poli_old']['contr_erro'] = 'off';
          if ($Campos_Crit != "") 
          {
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['recarga'] = $this->nmgp_opcao;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['sc_redir_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['sc_redir_insert'] == "ok")
          {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['sc_redir_atualiz'] == "ok")
          {
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "form_pay_poli_old.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old'][$path_doc_md5][1] = $Zip_name;
?>
...
<form name="Fdown" method="get" action="form_pay_poli_old_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="form_pay_poli_old"> 
...
//---------------------------------------------------------
     ...
     if ('' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_form_pay_poli_old']) || !is_array($this->NM_ajax_info['errList']['geral_form_pay_poli_old']))
              {
                  $this->NM_ajax_info['errList']['geral_form_pay_poli_old'] = array();
              }
              $this->NM_ajax_info['errList']['geral_form_pay_poli_old'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
      if ('' == $filtro || 'id' == $filtro)
...
//---
      ...
      if (empty($Campos_Crit) && empty($Campos_Falta) && empty($this->Campos_Mens_erro))
      {
          ...
          {
              $_SESSION['scriptcase']['form_pay_poli_old']['contr_erro'] = 'on';
...
$_SESSION['scriptcase']['form_pay_poli_old']['contr_erro'] = 'off'; 
    ...
    function ValidateField_nostruk(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->nostruk) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['Lookup_nostruk']) && !in_array($this->nostruk, $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['Lookup_nostruk']))
               {
                   $hasError = true;
    ...
    function ValidateField_custcode(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->custcode) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['Lookup_custcode']) && !in_array($this->custcode, $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['Lookup_custcode']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_sc_field_1(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->sc_field_1) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['Lookup_sc_field_1']) && !in_array($this->sc_field_1, $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['Lookup_sc_field_1']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_dokter(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->dokter) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['Lookup_dokter']) && !in_array($this->dokter, $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['Lookup_dokter']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_jmldk1(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->jmldk1, 15, 0, 0, 0, "N") == false)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "Jml DK1; " ; 
                  if (!isset($Campos_Erros['jmldk1']))
    ...
    function ValidateField_jmldk2(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->jmldk2, 15, 0, 0, 0, "N") == false)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "Jml DK2; " ; 
                  if (!isset($Campos_Erros['jmldk2']))
    ...
    function ValidateField_jmlasr(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->jmlasr, 15, 0, 0, 0, "N") == false)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "Jml Asr; " ; 
                  if (!isset($Campos_Erros['jmlasr']))
    ...
    function ValidateField_jmlkary(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->jmlkary, 15, 0, 0, 0, "N") == false)  
              { 
                  $hasError = true;
    ...
    function ValidateField_jenispayment(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['php_cmp_required']['jenispayment']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['php_cmp_required']['jenispayment'] == "on")
        { 
          $hasError = true;
    ...
    function ValidateField_bankdebit(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->bankdebit) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['Lookup_bankdebit']) && !in_array($this->bankdebit, $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['Lookup_bankdebit']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
...
;
    ...
    function ValidateField_edc1(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->edc1) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['Lookup_edc1']) && !in_array($this->edc1, $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['Lookup_edc1']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_edc2(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->edc2) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['Lookup_edc2']) && !in_array($this->edc2, $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['Lookup_edc2']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_poli(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->poli) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['Lookup_poli']) && !in_array($this->poli, $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['Lookup_poli']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['dados_form'] = $this->nmgp_dados_form;
   }
...
//-- 
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['id']['keyVal'] = form_pay_poli_old_pack_protect_string($this->nmgp_dados_form['id']);
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbbhprawatjalan_script_case_init'] ]['form_tbbhprawatjalan']['foreign_key']['trancode'] = $this->nmgp_dados_form['trancode'];
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbbhprawatjalan_script_case_init'] ]['form_tbbhprawatjalan']['where_filter'] = "tranCode = '" . $this->nmgp_dados_form['trancode'] . "'";
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbbhprawatjalan_script_case_init'] ]['form_tbbhprawatjalan']['where_detal']  = "tranCode = '" . $this->nmgp_dados_form['trancode'] . "'";
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['total'] < 0)
              {
                  $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbbhprawatjalan_script_case_init'] ]['form_tbbhprawatjalan']['where_filter'] = "1 <> 1";
              }
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbbhprawatjalan_script_case_init'] ]['form_tbbhprawatjalan']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbbhprawatjalan_script_case_init'] ]['form_tbbhprawatjalan']['total']);
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_detailadm_script_case_init'] ]['form_detailadm']['foreign_key']['trancode'] = $this->nmgp_dados_form['trancode'];
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_detailadm_script_case_init'] ]['form_detailadm']['where_filter'] = "tranCode = '" . $this->nmgp_dados_form['trancode'] . "'";
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_detailadm_script_case_init'] ]['form_detailadm']['where_detal']  = "tranCode = '" . $this->nmgp_dados_form['trancode'] . "'";
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['total'] < 0)
              {
                  $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_detailadm_script_case_init'] ]['form_detailadm']['where_filter'] = "1 <> 1";
              }
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_detailadm_script_case_init'] ]['form_detailadm']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_detailadm_script_case_init'] ]['form_detailadm']['total']);
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbreseprawatjalan_script_case_init'] ]['form_tbreseprawatjalan']['foreign_key']['trancode'] = $this->nmgp_dados_form['trancode'];
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbreseprawatjalan_script_case_init'] ]['form_tbreseprawatjalan']['where_filter'] = "tranCode = '" . $this->nmgp_dados_form['trancode'] . "'";
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbreseprawatjalan_script_case_init'] ]['form_tbreseprawatjalan']['where_detal']  = "tranCode = '" . $this->nmgp_dados_form['trancode'] . "'";
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['total'] < 0)
              {
                  $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbreseprawatjalan_script_case_init'] ]['form_tbreseprawatjalan']['where_filter'] = "1 <> 1";
              }
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbreseprawatjalan_script_case_init'] ]['form_tbreseprawatjalan']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbreseprawatjalan_script_case_init'] ]['form_tbreseprawatjalan']['total']);
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbtindakanrawatjalan_script_case_init'] ]['form_tbtindakanrawatjalan']['foreign_key']['trancode'] = $this->nmgp_dados_form['trancode'];
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbtindakanrawatjalan_script_case_init'] ]['form_tbtindakanrawatjalan']['where_filter'] = "tranCode = '" . $this->nmgp_dados_form['trancode'] . "'";
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbtindakanrawatjalan_script_case_init'] ]['form_tbtindakanrawatjalan']['where_detal']  = "tranCode = '" . $this->nmgp_dados_form['trancode'] . "'";
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['total'] < 0)
              {
                  $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbtindakanrawatjalan_script_case_init'] ]['form_tbtindakanrawatjalan']['where_filter'] = "1 <> 1";
              }
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbtindakanrawatjalan_script_case_init'] ]['form_tbtindakanrawatjalan']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbtindakanrawatjalan_script_case_init'] ]['form_tbtindakanrawatjalan']['total']);
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbrujukanlab_script_case_init'] ]['form_tbrujukanlab']['foreign_key']['trancode'] = $this->nmgp_dados_form['trancode'];
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbrujukanlab_script_case_init'] ]['form_tbrujukanlab']['foreign_key']['struk'] = $this->nmgp_dados_form['nostruk'];
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbrujukanlab_script_case_init'] ]['form_tbrujukanlab']['where_filter'] = "tranCode = '" . $this->nmgp_dados_form['trancode'] . "' AND struk = " . $this->nmgp_dados_form['nostruk'] . "";
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbrujukanlab_script_case_init'] ]['form_tbrujukanlab']['where_detal']  = "tranCode = '" . $this->nmgp_dados_form['trancode'] . "' AND struk = " . $this->nmgp_dados_form['nostruk'] . "";
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['total'] < 0)
              {
                  $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbrujukanlab_script_case_init'] ]['form_tbrujukanlab']['where_filter'] = "1 <> 1";
              }
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbrujukanlab_script_case_init'] ]['form_tbrujukanlab']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbrujukanlab_script_case_init'] ]['form_tbrujukanlab']['total']);
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbrujukanradiologi_script_case_init'] ]['form_tbrujukanradiologi']['foreign_key']['trancode'] = $this->nmgp_dados_form['trancode'];
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbrujukanradiologi_script_case_init'] ]['form_tbrujukanradiologi']['foreign_key']['struk'] = $this->nmgp_dados_form['nostruk'];
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbrujukanradiologi_script_case_init'] ]['form_tbrujukanradiologi']['where_filter'] = "tranCode = '" . $this->nmgp_dados_form['trancode'] . "' AND struk = " . $this->nmgp_dados_form['nostruk'] . "";
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbrujukanradiologi_script_case_init'] ]['form_tbrujukanradiologi']['where_detal']  = "tranCode = '" . $this->nmgp_dados_form['trancode'] . "' AND struk = " . $this->nmgp_dados_form['nostruk'] . "";
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['total'] < 0)
              {
                  $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbrujukanradiologi_script_case_init'] ]['form_tbrujukanradiologi']['where_filter'] = "1 <> 1";
              }
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbrujukanradiologi_script_case_init'] ]['form_tbrujukanradiologi']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbrujukanradiologi_script_case_init'] ]['form_tbrujukanradiologi']['total']);
          }
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['Lookup_nostruk']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['Lookup_nostruk'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['Lookup_nostruk']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['Lookup_nostruk'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['Lookup_nostruk'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['nostruk']['valList'][$i] = form_pay_poli_old_pack_protect_string($v);
          }
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['Lookup_custcode']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['Lookup_custcode'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['Lookup_custcode']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['Lookup_custcode'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       while (!$rs->EOF) 
       { 
              $aLookup[] = array(form_pay_poli_old_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', form_pay_poli_old_pack_protect_string(NM_charset_to_utf8($rs->fields[0]))));
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['Lookup_custcode'][] = $rs->fields[0];
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['custcode']['valList'][$i] = form_pay_poli_old_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['Lookup_sc_field_1']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['Lookup_sc_field_1'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['Lookup_sc_field_1']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['Lookup_sc_field_1'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['Lookup_sc_field_1'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['sc_field_1']['valList'][$i] = form_pay_poli_old_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['Lookup_dokter']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['Lookup_dokter'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['Lookup_dokter']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['Lookup_dokter'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['Lookup_dokter'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['dokter']['valList'][$i] = form_pay_poli_old_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_pay_poli_old_pack_protect_string('TUNAI') => form_pay_poli_old_pack_protect_string("TUNAI"));
$aLookup[] = array(form_pay_poli_old_pack_protect_string('BPJS') => form_pay_poli_old_pack_protect_string("BPJS"));
$aLookup[] = array(form_pay_poli_old_pack_protect_string('KARTU KREDIT') => form_pay_poli_old_pack_protect_string("KARTU KREDIT"));
$aLookup[] = array(form_pay_poli_old_pack_protect_string('KARTU DEBIT') => form_pay_poli_old_pack_protect_string("KARTU DEBIT"));
$aLookup[] = array(form_pay_poli_old_pack_protect_string('ASURANSI') => form_pay_poli_old_pack_protect_string("ASURANSI"));
$aLookup[] = array(form_pay_poli_old_pack_protect_string('KARYAWAN') => form_pay_poli_old_pack_protect_string("KARYAWAN"));
$aLookup[] = array(form_pay_poli_old_pack_protect_string('KOMBINASI') => form_pay_poli_old_pack_protect_string("KOMBINASI"));
$aLookup[] = array(form_pay_poli_old_pack_protect_string('BANSOS') => form_pay_poli_old_pack_protect_string("BANSOS"));
$aLookup[] = array(form_pay_poli_old_pack_protect_string('JAMPERU') => form_pay_poli_old_pack_protect_string("JAMPERU"));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['Lookup_jenispayment'][] = 'TUNAI';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['Lookup_jenispayment'][] = 'BPJS';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['Lookup_jenispayment'][] = 'KARTU KREDIT';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['Lookup_jenispayment'][] = 'KARTU DEBIT';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['Lookup_jenispayment'][] = 'ASURANSI';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['Lookup_jenispayment'][] = 'KARYAWAN';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['Lookup_jenispayment'][] = 'KOMBINASI';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['Lookup_jenispayment'][] = 'BANSOS';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['Lookup_jenispayment'][] = 'JAMPERU';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['jenispayment']['valList'][$i] = form_pay_poli_old_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          $val_output = isset($aLookup[0][form_pay_poli_old_pack_protect_string(NM_charset_to_utf8($this->instansipenjamin))]) ? $aLookup[0][form_pay_poli_old_pack_protect_string(NM_charset_to_utf8($this->instansipenjamin))] : "";
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['Lookup_bankdebit']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['Lookup_bankdebit'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['Lookup_bankdebit']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['Lookup_bankdebit'] = array(); 
}
$aLookup[] = array(form_pay_poli_old_pack_protect_string('') => form_pay_poli_old_pack_protect_string(' '));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['Lookup_bankdebit'][] = '';
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   } 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['Lookup_bankdebit'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['bankdebit']['valList'][$i] = form_pay_poli_old_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['Lookup_edc1']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['Lookup_edc1'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['Lookup_edc1']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['Lookup_edc1'] = array(); 
}
$aLookup[] = array(form_pay_poli_old_pack_protect_string('') => form_pay_poli_old_pack_protect_string(' '));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['Lookup_edc1'][] = '';
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   } 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['Lookup_edc1'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['edc1']['valList'][$i] = form_pay_poli_old_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['Lookup_edc2']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['Lookup_edc2'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['Lookup_edc2']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['Lookup_edc2'] = array(); 
}
$aLookup[] = array(form_pay_poli_old_pack_protect_string('') => form_pay_poli_old_pack_protect_string(' '));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['Lookup_edc2'][] = '';
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   } 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['Lookup_edc2'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['edc2']['valList'][$i] = form_pay_poli_old_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['Lookup_poli']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['Lookup_poli'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['Lookup_poli']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['Lookup_poli'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['Lookup_poli'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['poli']['valList'][$i] = form_pay_poli_old_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   function ajax_return_values_bhp($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
...
$_SESSION['scriptcase']['form_pay_poli_old']['contr_erro'] = 'off'; 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['decimal_db'] == ",") 
      {
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['db_changed'] = true;
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['total']);
              }
              ...
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao   = "igual"; 
      ...
      { 
          ...
          { 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['reg_start'] = 0; 
              }
...
$_SESSION['scriptcase']['form_pay_poli_old']['contr_erro'] = 'off'; 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['decimal_db'] == ",")
   {
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['parms'] = "id?#?$this->id?@?"; 
      }
      $this->NM_commit_db(); 
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['where_filter'] . ")";
          }
      }
//------------ 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['run_iframe'] == "R")
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['iframe_evento'] == "insert") 
          { 
               $this->nmgp_opcao = "novo"; 
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['select'] = "";
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['iframe_evento'] = $this->sc_evento; 
      } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['run_iframe'] == "F" && $this->sc_evento == "insert")
      {
          $this->nmgp_opcao = "final";
      }
      $sc_where = trim("");
      ...
      { 
          ...
          $qt_geral_reg_form_pay_poli_old = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['total'] = $qt_geral_reg_form_pay_poli_old;
          $rt->Close(); 
          if ($this->nmgp_opcao == "igual" && isset($this->NM_btn_navega) && 'S' == $this->NM_btn_navega && !empty($this->id))
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['reg_start'] = $rt->fields[0];
              $rt->Close(); 
          }
      } 
      else 
      { 
          $qt_geral_reg_form_pay_poli_old = $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['total'];
      } 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['reg_start']++; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['reg_start'] > $qt_geral_reg_form_pay_poli_old)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['reg_start'] = $qt_geral_reg_form_pay_poli_old; 
          }
      } 
      ...
      if ($this->nmgp_opcao == "navpage" && ($this->nmgp_ordem - 1) <= $qt_geral_reg_form_pay_poli_old) 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['reg_start'] = $this->nmgp_ordem - 1; 
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['reg_start']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['reg_start']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['reg_start'] = 0;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['reg_start'] + 1;
      $this->NM_ajax_info['navSummary']['reg_ini'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['reg_start'] + 1; 
      $this->NM_ajax_info['navSummary']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['reg_qtd']; 
      $this->NM_ajax_info['navSummary']['reg_tot'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['total'] + 1; 
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
              $GLOBALS["NM_ERRO_IBASE"] = 1;  
          } 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['run_iframe'] == "R")
          {
              if ($this->sc_evento == "update")
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['select'] = ""; 
              } 
          } 
          if ($this->nmgp_opcao == "igual") 
          ...
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['reg_start'] . ")" ; 
              $rs = $this->Db->SelectLimit($nmgp_select, 1, $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['reg_start']) ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['reg_start'] . ")" ; 
          ...
          { 
              ...
              if (!$rs === false && !$rs->EOF) 
              { 
                  $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['reg_start']) ;  
              } 
          } 
          ...
          if ($rs->EOF) 
          { 
              if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['where_filter']))
              {
                  ...
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['empty_filter'] = true;
                  return; 
              }
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['dados_select'] = $this->nmgp_dados_select;
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['reg_start'] < $qt_geral_reg_form_pay_poli_old;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['opcao']   = '';
          }
      } 
...
//-- 
      ...
      $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbtindakanrawatjalan_script_case_init'] ]['form_tbtindakanrawatjalan']['embutida_parms'] = "NM_btn_insert*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinS*scoutNM_btn_navega*scinN*scout";
      $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbreseprawatjalan_script_case_init'] ]['form_tbreseprawatjalan']['embutida_parms'] = "trancode*scin" . $this->nmgp_dados_form['trancode'] . "*scoutNM_btn_insert*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinS*scoutNM_btn_navega*scinN*scout";
      $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_detailadm_script_case_init'] ]['form_detailadm']['embutida_parms'] = "NM_btn_insert*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinS*scoutNM_btn_navega*scinN*scout";
      $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbrujukanlab_script_case_init'] ]['form_tbrujukanlab']['embutida_parms'] = "NM_btn_insert*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinS*scoutNM_btn_navega*scinN*scout";
      $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbrujukanradiologi_script_case_init'] ]['form_tbrujukanradiologi']['embutida_parms'] = "NM_btn_insert*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinS*scoutNM_btn_navega*scinN*scout";
      $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['form_tbbhprawatjalan_script_case_init'] ]['form_tbbhprawatjalan']['embutida_parms'] = "trancode*scin" . $this->nmgp_dados_form['trancode'] . "*scoutNM_btn_insert*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinS*scoutNM_btn_navega*scinN*scout";
  }
// 
//-- 
...
//-- 
   ...
   function NM_gera_nav_page() 
   {
       ...
       $rec_tot    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['total'] + 1;
       $rec_fim    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['reg_start'] + 1;
       ...
       foreach ($Arr_result as $Ind_result => $Lin_result)
       {
        ...
        function initializeRecordState() {
                $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['record_state'] = array();
        }

        function storeRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['record_state'])) {
                        $this->initializeRecordState();
                }
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['record_state'][$sc_seq_vert])) {
                        $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['record_state'][$sc_seq_vert] = array();
                }

                $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['record_state'][$sc_seq_vert]['buttons'] = array(
        ...
        function loadRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['record_state']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['record_state'][$sc_seq_vert])) {
                        return;
                }

                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['record_state'][$sc_seq_vert]['buttons']['delete'])) {
                        $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['record_state'][$sc_seq_vert]['buttons']['delete'];
                }
                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['record_state'][$sc_seq_vert]['buttons']['update'])) {
                        $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['record_state'][$sc_seq_vert]['buttons']['update'];
                }
        }
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
        ...
        $this->initFormPages();
    include_once("form_pay_poli_old_form0.php");
        $this->hideFormPages();
 }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['table_refresh'])
        {
   ...
   function jqueryButtonText($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['csrf_token'];
    }
...
else
{
   ...
   function SC_fast_search($field, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['where_filter_form'] . " and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_form_pay_poli_old = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['total'] = $qt_geral_reg_form_pay_poli_old;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_pay_poli_old_pack_ajax_response();
         ...
         if (isset($Nm_datas[$campo_join]))
         {
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          {
             ...
             $nm_aspas1 = "#";
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['SC_sep_date1'];
              }
          }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "form_pay_poli_old_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_pay_poli_old_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['masterValue']))
{
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['dashboard_info']['under_dashboard']) {
?>
var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['dashboard_info']['parent_widget']; ?>']");
if (dbParentFrame && dbParentFrame[0] && dbParentFrame[0].contentWindow.scAjaxDetailValue)
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_poli_old']['masterValue'] as $cmp_master => $val_master)
        {
?>
