...
class grid_tbdrugsell_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['path_libs_php'] = $this->Ini->path_lib_php;
      ...
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search_change_fil")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['campos_busca'] = array(); 
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_tbdrugsell_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_tbdrugsell_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_tbdrugsell_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
          ...
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['grid_pesq'][$campo_join]);
              return;
          }
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['decimal_db'] == ".")
         {
            $nm_aspas  = "";
            $nm_aspas1 = "";
         }
      ...
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['SC_sep_date']))
          {
              $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['SC_sep_date'];
              $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['SC_sep_date1'];
          }
      }
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_tbdrugsell/grid_tbdrugsell_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_tbdrugsell_ajax_search.js"></script>
 <script type="text/javascript" src="grid_tbdrugsell_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_tbdrugsell_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_tbdrugsell']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_tbdrugsell']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<?php
   ...
   function monta_form()
   {
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          $docname = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['campos_busca']['docname']; 
          $docname_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['campos_busca']['docname_cond']; 
          $trancode = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['campos_busca']['trancode']; 
          $trancode_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['campos_busca']['trancode_cond']; 
          $struk = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['campos_busca']['struk']; 
          $struk_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['campos_busca']['struk_cond']; 
          $resep = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['campos_busca']['resep']; 
          $resep_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['campos_busca']['resep_cond']; 
          $doccode = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['campos_busca']['doccode']; 
          $doccode_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['campos_busca']['doccode_cond']; 
          $resepno = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['campos_busca']['resepno']; 
          $resepno_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['campos_busca']['resepno_cond']; 
          $pasien = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['campos_busca']['pasien']; 
          $pasien_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['campos_busca']['pasien_cond']; 
          $custcode = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['campos_busca']['custcode']; 
          $custcode_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['campos_busca']['custcode_cond']; 
          $custname = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['campos_busca']['custname']; 
          $custname_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['campos_busca']['custname_cond']; 
          $total = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['campos_busca']['total']; 
          $total_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['campos_busca']['total_cond']; 
          $trandate_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['campos_busca']['trandate_dia']; 
          $trandate_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['campos_busca']['trandate_mes']; 
          $trandate_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['campos_busca']['trandate_ano']; 
          $trandate_hor = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['campos_busca']['trandate_hor']; 
          $trandate_min = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['campos_busca']['trandate_min']; 
          $trandate_seg = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['campos_busca']['trandate_seg']; 
          $trandate_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['campos_busca']['trandate_cond']; 
          $deleted = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['campos_busca']['deleted']; 
          $deleted_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['campos_busca']['deleted_cond']; 
          $iskaryawan = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['campos_busca']['iskaryawan']; 
          $iskaryawan_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['campos_busca']['iskaryawan_cond']; 
          $tlc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['campos_busca']['tlc']; 
          $tlc_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['campos_busca']['tlc_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['campos_busca']['NM_operador']; 
      } 
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if ($_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
<?php
   if (is_file("grid_tbdrugsell_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_tbdrugsell']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_tbdrugsell']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_tbdrugsell']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_tbdrugsell']['start'] == 'filter')
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['orig_pesq'] == "grid")
   {
...
?>
 ...
 {
    $('#SC_trandate_dia').bind('change', function() {sc_grid_tbdrugsell_valida_dia(this)});
    $('#SC_trandate_hor').bind('change', function() {sc_grid_tbdrugsell_valida_hora(this)});
    $('#SC_trandate_mes').bind('change', function() {sc_grid_tbdrugsell_valida_mes(this)});
    $('#SC_trandate_min').bind('change', function() {sc_grid_tbdrugsell_valida_min(this)});
    $('#SC_trandate_seg').bind('change', function() {sc_grid_tbdrugsell_valida_seg(this)});
 }
 function sc_grid_tbdrugsell_valida_dia(obj)
 {
 ...
 function sc_grid_tbdrugsell_valida_mes(obj)
 {
 ...
 function sc_grid_tbdrugsell_valida_hora(obj)
 {
 ...
 function sc_grid_tbdrugsell_valida_min(obj)
 {
 ...
 function sc_grid_tbdrugsell_valida_seg(obj)
 {
     if (obj.value != "" && (obj.value < 0 || obj.value > 59))
     {
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['where_orig']))
      {
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['where_orig'];
      }
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function trata_campos()
   {
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['campos_busca'] as $Cmps => $Vals)
          {
              $$Cmps = $Vals;
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['grid_pesq'] = array();
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['Grid_search']  = array(); 
      $I_Grid = 0;
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['campos_busca']['docname'] = $docname; 
      if (is_array($docname) && !empty($docname))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['Grid_search'][$I_Grid]['val'][0] = $docname;
      }
      elseif ($docname_cond_salva == "nu" || $docname_cond_salva == "nn" || $docname_cond_salva == "ep" || $docname_cond_salva == "ne" || !empty($docname))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['Grid_search'][$I_Grid]['val'][0][0] = $docname;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['campos_busca']['docname_cond'] = $docname_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['Grid_search'][$I_Grid]['cmp'] = "docname"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['Grid_search'][$I_Grid]['opc'] = $docname_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['grid_pesq']['docname'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['campos_busca']['trancode'] = $trancode; 
      if (is_array($trancode) && !empty($trancode))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['Grid_search'][$I_Grid]['val'][0] = $trancode;
      }
      elseif ($trancode_cond_salva == "nu" || $trancode_cond_salva == "nn" || $trancode_cond_salva == "ep" || $trancode_cond_salva == "ne" || !empty($trancode))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['Grid_search'][$I_Grid]['val'][0][0] = $trancode;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['campos_busca']['trancode_cond'] = $trancode_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['Grid_search'][$I_Grid]['cmp'] = "trancode"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['Grid_search'][$I_Grid]['opc'] = $trancode_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['grid_pesq']['trancode'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['campos_busca']['struk'] = $struk; 
      if (is_array($struk) && !empty($struk))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['Grid_search'][$I_Grid]['val'][0] = $struk;
      }
      elseif ($struk_cond_salva == "nu" || $struk_cond_salva == "nn" || $struk_cond_salva == "ep" || $struk_cond_salva == "ne" || !empty($struk))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['Grid_search'][$I_Grid]['val'][0][0] = $struk;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['campos_busca']['struk_cond'] = $struk_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['Grid_search'][$I_Grid]['cmp'] = "struk"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['Grid_search'][$I_Grid]['opc'] = $struk_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['grid_pesq']['struk'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['campos_busca']['resep'] = $resep; 
      if (is_array($resep) && !empty($resep))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['Grid_search'][$I_Grid]['val'][0] = $resep;
      }
      elseif ($resep_cond_salva == "nu" || $resep_cond_salva == "nn" || $resep_cond_salva == "ep" || $resep_cond_salva == "ne" || !empty($resep))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['Grid_search'][$I_Grid]['val'][0][0] = $resep;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['campos_busca']['resep_cond'] = $resep_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['Grid_search'][$I_Grid]['cmp'] = "resep"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['Grid_search'][$I_Grid]['opc'] = $resep_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['grid_pesq']['resep'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['campos_busca']['doccode'] = $doccode; 
      if (is_array($doccode) && !empty($doccode))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['Grid_search'][$I_Grid]['val'][0] = $doccode;
      }
      elseif ($doccode_cond_salva == "nu" || $doccode_cond_salva == "nn" || $doccode_cond_salva == "ep" || $doccode_cond_salva == "ne" || !empty($doccode))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['Grid_search'][$I_Grid]['val'][0][0] = $doccode;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['campos_busca']['doccode_cond'] = $doccode_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['Grid_search'][$I_Grid]['cmp'] = "doccode"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['Grid_search'][$I_Grid]['opc'] = $doccode_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['grid_pesq']['doccode'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['campos_busca']['resepno'] = $resepno; 
      if (is_array($resepno) && !empty($resepno))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['Grid_search'][$I_Grid]['val'][0] = $resepno;
      }
      elseif ($resepno_cond_salva == "nu" || $resepno_cond_salva == "nn" || $resepno_cond_salva == "ep" || $resepno_cond_salva == "ne" || !empty($resepno))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['Grid_search'][$I_Grid]['val'][0][0] = $resepno;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['campos_busca']['resepno_cond'] = $resepno_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['Grid_search'][$I_Grid]['cmp'] = "resepno"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['Grid_search'][$I_Grid]['opc'] = $resepno_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['grid_pesq']['resepno'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['campos_busca']['pasien'] = $pasien; 
      if (is_array($pasien) && !empty($pasien))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['Grid_search'][$I_Grid]['val'][0] = $pasien;
      }
      elseif ($pasien_cond_salva == "nu" || $pasien_cond_salva == "nn" || $pasien_cond_salva == "ep" || $pasien_cond_salva == "ne" || !empty($pasien))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['Grid_search'][$I_Grid]['val'][0][0] = $pasien;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['campos_busca']['pasien_cond'] = $pasien_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['Grid_search'][$I_Grid]['cmp'] = "pasien"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['Grid_search'][$I_Grid]['opc'] = $pasien_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['grid_pesq']['pasien'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['campos_busca']['custcode'] = $custcode; 
      if (is_array($custcode) && !empty($custcode))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['Grid_search'][$I_Grid]['val'][0] = $custcode;
      }
      elseif ($custcode_cond_salva == "nu" || $custcode_cond_salva == "nn" || $custcode_cond_salva == "ep" || $custcode_cond_salva == "ne" || !empty($custcode))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['Grid_search'][$I_Grid]['val'][0][0] = $custcode;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['campos_busca']['custcode_cond'] = $custcode_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['Grid_search'][$I_Grid]['cmp'] = "custcode"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['Grid_search'][$I_Grid]['opc'] = $custcode_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['grid_pesq']['custcode'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['campos_busca']['custname'] = $custname; 
      if (is_array($custname) && !empty($custname))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['Grid_search'][$I_Grid]['val'][0] = $custname;
      }
      elseif ($custname_cond_salva == "nu" || $custname_cond_salva == "nn" || $custname_cond_salva == "ep" || $custname_cond_salva == "ne" || !empty($custname))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['Grid_search'][$I_Grid]['val'][0][0] = $custname;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['campos_busca']['custname_cond'] = $custname_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['Grid_search'][$I_Grid]['cmp'] = "custname"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['Grid_search'][$I_Grid]['opc'] = $custname_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['grid_pesq']['custname'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['campos_busca']['total'] = $total; 
      if (is_array($total) && !empty($total))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['Grid_search'][$I_Grid]['val'][0] = $total;
      }
      elseif ($total_cond_salva == "nu" || $total_cond_salva == "nn" || $total_cond_salva == "ep" || $total_cond_salva == "ne" || !empty($total))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['Grid_search'][$I_Grid]['val'][0][0] = $total;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['campos_busca']['total_cond'] = $total_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['Grid_search'][$I_Grid]['cmp'] = "total"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['Grid_search'][$I_Grid]['opc'] = $total_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['grid_pesq']['total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['campos_busca']['trandate_dia'] = $trandate_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['campos_busca']['trandate_mes'] = $trandate_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['campos_busca']['trandate_ano'] = $trandate_ano; 
      ...
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['Grid_search'][$I_Grid]['val'][0][] = "D:" . $trandate_dia;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['Grid_search'][$I_Grid]['val'][0][] = "M:" . $trandate_mes;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['Grid_search'][$I_Grid]['val'][0][] = "Y:" . $trandate_ano;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['campos_busca']['trandate_hor'] = $trandate_hor; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['campos_busca']['trandate_min'] = $trandate_min; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['campos_busca']['trandate_seg'] = $trandate_seg; 
      ...
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['Grid_search'][$I_Grid]['val'][0][] = "H:" . $trandate_hor;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['Grid_search'][$I_Grid]['val'][0][] = "I:" . $trandate_min;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['Grid_search'][$I_Grid]['val'][0][] = "S:" . $trandate_seg;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['campos_busca']['trandate_cond'] = $trandate_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['Grid_search'][$I_Grid]['cmp'] = "trandate"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['Grid_search'][$I_Grid]['opc'] = $trandate_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['grid_pesq']['trandate'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['campos_busca']['deleted'] = $deleted; 
      if (is_array($deleted) && !empty($deleted))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['Grid_search'][$I_Grid]['val'][0] = $deleted;
      }
      elseif ($deleted_cond_salva == "nu" || $deleted_cond_salva == "nn" || $deleted_cond_salva == "ep" || $deleted_cond_salva == "ne" || !empty($deleted))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['Grid_search'][$I_Grid]['val'][0][0] = $deleted;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['campos_busca']['deleted_cond'] = $deleted_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['Grid_search'][$I_Grid]['cmp'] = "deleted"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['Grid_search'][$I_Grid]['opc'] = $deleted_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['grid_pesq']['deleted'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['campos_busca']['iskaryawan'] = $iskaryawan; 
      if (is_array($iskaryawan) && !empty($iskaryawan))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['Grid_search'][$I_Grid]['val'][0] = $iskaryawan;
      }
      ...
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['Grid_search'][$I_Grid]['val'][0][0] = $iskaryawan;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['campos_busca']['iskaryawan_cond'] = $iskaryawan_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['Grid_search'][$I_Grid]['cmp'] = "iskaryawan"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['Grid_search'][$I_Grid]['opc'] = $iskaryawan_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['grid_pesq']['iskaryawan'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['campos_busca']['tlc'] = $tlc; 
      if (is_array($tlc) && !empty($tlc))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['Grid_search'][$I_Grid]['val'][0] = $tlc;
      }
      elseif ($tlc_cond_salva == "nu" || $tlc_cond_salva == "nn" || $tlc_cond_salva == "ep" || $tlc_cond_salva == "ne" || !empty($tlc))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['Grid_search'][$I_Grid]['val'][0][0] = $tlc;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['campos_busca']['tlc_cond'] = $tlc_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['Grid_search'][$I_Grid]['cmp'] = "tlc"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['Grid_search'][$I_Grid]['opc'] = $tlc_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['grid_pesq']['tlc'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['campos_busca'] = $Temp_Busca;
      }
   ...
   { 
      ...
      if ($trandate_cond != "bi_TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['campos_busca']['trandate'] = $val[0];
          ...
          if ($trandate_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['campos_busca']['trandate_input_2'] = $val[1];
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['grid_pesq']['trandate']['label'] = $nmgp_tab_label['trandate'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['grid_pesq']['trandate']['descr'] = $nmgp_tab_label['trandate'] . " " . $this->Ini->Nm_lang['lang_srch_ever'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['grid_pesq']['trandate']['hint']  = $nmgp_tab_label['trandate'] . " " . $this->Ini->Nm_lang['lang_srch_ever'];
      }
   ...
   function finaliza_resultado_ajax()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['where_pesq'] = $this->comando;
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['where_pesq_fast'])) 
       {
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['where_pesq'])) 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['where_pesq_fast'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['where_pesq'] = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['where_pesq_fast'] . ")";
           }
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['cond_dyn_search'] = "";
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['where_pesq_fast'] = "";
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['fast_search']);
      if ("" == $this->comando_filtro)
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['where_orig'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['where_pesq']         = $this->comando . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['opcao']              = "pesq";
      if ("" == $this->comando_filtro)
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['where_pesq_filtro'] = "";
      }
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['cond_pesq'] .= $this->NM_operador;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['where_pesq_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdrugsell']['where_pesq'];
