<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tbdrugsell']['sc_process_barr'] = true;
require_once('../grid_tbdrugsell/index.php');
unset($_SESSION['scriptcase']['grid_tbdrugsell']['sc_process_barr']);
$ExportCtrl = new grid_tbdrugsell_export_control;
$ExportCtrl->Export_barr();

class grid_tbdrugsell_export_control
{
