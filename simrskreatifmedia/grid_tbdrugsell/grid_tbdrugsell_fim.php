...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_tbdrugsell"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_tbdrugsell"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tbdrugsell']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_tbdrugsell']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tbdrugsell']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_tbdrugsell']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_tbdrugsell']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_tbdrugsell']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_tbdrugsell']['embutida_filho'] as $ind => $sc_init)
          {
