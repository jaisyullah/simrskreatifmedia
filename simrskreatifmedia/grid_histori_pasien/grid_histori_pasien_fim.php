...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_histori_pasien"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_histori_pasien"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_histori_pasien']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_histori_pasien']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_histori_pasien']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_histori_pasien']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_histori_pasien']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_histori_pasien</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_histori_pasien']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_histori_pasien']['embutida_filho'] as $ind => $sc_init)
          {
