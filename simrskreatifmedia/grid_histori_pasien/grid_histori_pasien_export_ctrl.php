<?php
@session_start() ;
$_SESSION['scriptcase']['grid_histori_pasien']['sc_process_barr'] = true;
require_once('../grid_histori_pasien/index.php');
unset($_SESSION['scriptcase']['grid_histori_pasien']['sc_process_barr']);
$ExportCtrl = new grid_histori_pasien_export_control;
$ExportCtrl->Export_barr();

class grid_histori_pasien_export_control
{
