...
<?php
   ...
   $Ord_Cmp = new grid_histori_pasien_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_histori_pasien_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_histori_pasien']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_histori_pasien']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["tglmasuk"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_histori_pasien']['labels']["tglmasuk"])) ? $_SESSION['sc_session'][$sc_init]['grid_histori_pasien']['labels']["tglmasuk"] : "Tgl Masuk";
   $tab_ger_campos['tglkeluar'] = "on";
   $tab_def_campos['tglkeluar'] = "tglKeluar";
   $tab_labels["tglkeluar"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_histori_pasien']['labels']["tglkeluar"])) ? $_SESSION['sc_session'][$sc_init]['grid_histori_pasien']['labels']["tglkeluar"] : "Tgl Keluar";
   $tab_ger_campos['carakeluar'] = "on";
   $tab_def_campos['carakeluar'] = "caraKeluar";
   $tab_labels["carakeluar"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_histori_pasien']['labels']["carakeluar"])) ? $_SESSION['sc_session'][$sc_init]['grid_histori_pasien']['labels']["carakeluar"] : "Cara Keluar";
   $tab_ger_campos['dpjp'] = "on";
   $tab_def_campos['dpjp'] = "DPJP";
   $tab_labels["dpjp"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_histori_pasien']['labels']["dpjp"])) ? $_SESSION['sc_session'][$sc_init]['grid_histori_pasien']['labels']["dpjp"] : "DPJP";
   $tab_ger_campos['diagnosa'] = "on";
   $tab_def_campos['diagnosa'] = "Diagnosa";
   $tab_labels["diagnosa"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_histori_pasien']['labels']["diagnosa"])) ? $_SESSION['sc_session'][$sc_init]['grid_histori_pasien']['labels']["diagnosa"] : "Diagnosa";
   $tab_ger_campos['icd10'] = "on";
   $tab_def_campos['icd10'] = "icd10";
   $tab_labels["icd10"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_histori_pasien']['labels']["icd10"])) ? $_SESSION['sc_session'][$sc_init]['grid_histori_pasien']['labels']["icd10"] : "ICD 10";
   $tab_ger_campos['ruang'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['ruang'] = "Ruang";
   }
   else
   {
       $tab_def_campos['ruang'] = "";
   }
   $tab_labels["ruang"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_histori_pasien']['labels']["ruang"])) ? $_SESSION['sc_session'][$sc_init]['grid_histori_pasien']['labels']["ruang"] : "Ruang / Lantai";
   $tab_ger_campos['detailmedis'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['detailmedis'] = "detailMedis";
   }
   else
   {
       $tab_def_campos['detailmedis'] = "";
   }
   $tab_labels["detailmedis"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_histori_pasien']['labels']["detailmedis"])) ? $_SESSION['sc_session'][$sc_init]['grid_histori_pasien']['labels']["detailmedis"] : "Detail Medis";
   $tab_ger_campos['kategori'] = "on";
   $tab_def_campos['kategori'] = "Kategori";
   $tab_labels["kategori"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_histori_pasien']['labels']["kategori"])) ? $_SESSION['sc_session'][$sc_init]['grid_histori_pasien']['labels']["kategori"] : "Kategori";
   $tab_ger_campos['ruang'] = "none";
   $tab_ger_campos['detailmedis'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_histori_pasien']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_histori_pasien']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_histori_pasien']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_histori_pasien']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_histori_pasien']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_histori_pasien']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_histori_pasien']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_histori_pasien']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_histori_pasien']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_histori_pasien_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_histori_pasien']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_histori_pasien']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_histori_pasien']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_histori_pasien']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_histori_pasien']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
