...
class grid_histori_pasien_xls
{
   ...
   function monta_xls()
   {
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_histori_pasien']['embutida']) {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_histori_pasien']['opcao'] = "";
      }
   }
   ...
   function inicializa_vars()
   {
      ...
      { 
          ...
          { 
              ...
              $this->Res_xls = new grid_histori_pasien_res_xls();
              $this->prep_modulos("Res_xls");
          } 
          $this->Arquivo    = "sc_xls";
          $this->Arquivo   .= "_" . date("YmdHis") . "_" . rand(0, 1000);
          $this->Arq_zip    = $this->Arquivo . "_grid_histori_pasien.zip";
          $this->Arquivo   .= "_grid_histori_pasien" . $this->Xls_tp;
          $this->Tit_doc    = "grid_histori_pasien" . $this->Xls_tp;
          $this->Tit_zip    = "grid_histori_pasien.zip";
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_histori_pasien']['embutida'] && !$this->Ini->sc_export_ajax) {
          ...
          $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['grid_histori_pasien']['xls_return']);
          if ($this->Tem_xls_res) {
   ...
   function grava_arquivo()
   {
      ...
      $pos      = strrpos($this->Ini->link_grid_hist_medis_cons_emb, '/');
      $link_xls = substr($this->Ini->link_grid_hist_medis_cons_emb, 0, $pos) . "/grid_hist_medis_xls.class.php";
      if (!is_file($this->Ini->link_grid_hist_medis_cons_emb) || !is_file($link_xls))
      {
      ...
      $pos      = strrpos($this->Ini->link_grid_hist_medis_cons_emb, '/');
      $link_xml = substr($this->Ini->link_grid_hist_medis_cons_emb, 0, $pos) . "/grid_hist_medis_xml.class.php";
      if (!is_file($this->Ini->link_grid_hist_medis_cons_emb) || !is_file($link_xml))
      {
          $this->NM_cmp_hidden['detailmedis'] = "off";
      }
      else
      ...
      $nm_raiz_img  = ""; 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_histori_pasien']['xls_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_histori_pasien']['xls_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_histori_pasien']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_histori_pasien']['xls_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_histori_pasien']['xls_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_histori_pasien']['xls_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_histori_pasien']['xls_name']);
          $this->Xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
          $this->Zip_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arq_zip;
      }
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_histori_pasien']['field_order'] as $Cada_cmp)
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_histori_pasien']['embutida_label']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_histori_pasien']['embutida_label'])
      { 
          $this->count_span = 0;
          $this->Xls_row++;
          $this->proc_label();
...
$_SESSION['scriptcase']['grid_histori_pasien']['contr_erro'] = 'off'; 
         ...
         foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_histori_pasien']['field_order'] as $Cada_col)
         { 
            if ($Cada_col == "detailmedis" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
            { 
                $xls_row_base = $this->Xls_row;
                if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_histori_pasien']['embutida'])
                { 
                    foreach ($this->Rows_sub_detailmedis as $line => $cols)
                    {
                        $this->Xls_row++;
                        $this->arr_export['lines'][$this->Xls_row] = $cols;
                    }
                    if (!empty($this->Rows_sub_detailmedis['lines']))
                    {
                ...
                { 
                    foreach ($this->Rows_sub_detailmedis as $lines)
                    {
                        $this->Xls_col = 0;
         ...
         if (isset($this->NM_Row_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_histori_pasien']['embutida'])
         { 
      ...
      $this->xls_set_style();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_histori_pasien']['embutida'] && $prim_reg)
      { 
          $this->proc_label();
          $this->xls_sub_cons_copy_label($this->Xls_row);
      ...
      if (isset($this->NM_Col_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_histori_pasien']['embutida'])
      { 
      ...
      { 
          if ($this->Tem_xls_res)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_histori_pasien']['xls_res_grid'] = true;
              if (!$this->Ini->sc_export_ajax) {
              ...
              if ($this->Use_phpspreadsheet) {
                  $Xls_res = \PhpOffice\PhpSpreadsheet\IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['grid_histori_pasien']['xls_res_sheet']);
              }
              else {
                  $Xls_res = PHPExcel_IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['grid_histori_pasien']['xls_res_sheet']);
              }
              foreach($Xls_res->getAllSheets() as $sheet)
              {
                  $this->Xls_dados->addExternalSheet($sheet);
              }
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_histori_pasien']['xls_res_grid']);
              unlink($_SESSION['sc_session'][$this->Ini->sc_page]['grid_histori_pasien']['xls_res_sheet']);
          } 
          if (!$this->Ini->sc_export_ajax) {
   ...
   { 
      ...
      { 
          ...
          if ($Cada_col == "detailmedis" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              $this->arr_span['detailmedis'] = $this->count_span;
              $this->Emb_label_cols_detailmedis = 0;
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hist_medis']['embutida'] = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hist_medis']['embutida_label'] = true;
              $GLOBALS["script_case_init"] = $this->Ini->sc_page;
                  ...
                  if (isset($_SESSION['scriptcase']['export_return']))
                  {
                     foreach ($_SESSION['scriptcase']['export_return']['label'] as $col => $dados)
                     {
                         if (isset($dados['col_span_i'])) {
                             $this->Emb_label_cols_detailmedis += $dados['col_span_i'];
                         }
                         elseif (isset($dados['col_span_f'])) {
                             $this->Emb_label_cols_detailmedis += $dados['col_span_f'];
                         }
                         else {
                             $this->Emb_label_cols_detailmedis++;
                         }
                     }
                  }
                  $this->count_span += $this->Emb_label_cols_detailmedis;
              }
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hist_medis']['embutida'] = false;
              ...
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_histori_pasien']['embutida'])
              { 
                  $this->arr_export['label'][$this->Xls_col]['col_span_f'] = $this->Emb_label_cols_detailmedis;
                  $this->Xls_col++;
              }
              else
              { 
                  $this->Xls_col += $this->Emb_label_cols_detailmedis;
              } 
          }
   ...
   function NM_export_icd10()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->icd10, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->icd10, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- ruang
   ...
   //----- detailmedis
   function NM_export_detailmedis()
   {
         $GLOBALS["script_case_init"] = $this->Ini->sc_page;
         $GLOBALS["nmgp_parms"] = "nmgp_opcao?#?xls?@?trancode?#?" . str_replace("'", "@aspass@", $this->Orig_trancode) . "?@?";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hist_medis']['embutida'] = true;
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hist_medis']['nolabel'] = true;
         if (method_exists($this->grid_hist_medis, "controle"))
         {
             $this->grid_hist_medis->controle();
             if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
             ...
             if (isset($_SESSION['scriptcase']['export_return']))
             {
                 $this->Rows_sub_detailmedis = array();
                 if (isset($_SESSION['scriptcase']['export_return']['label']))
                 {
                     $_SESSION['scriptcase']['export_return']['label'][0]['col_span_i'] = $this->arr_span['detailmedis'];
                     $this->Xls_col += $this->Emb_label_cols_detailmedis;
                 }
                 if (isset($_SESSION['scriptcase']['export_return']['lines']))
                 {
                     foreach ($_SESSION['scriptcase']['export_return']['lines'] as $line => $cols)
                     {
                         ...
                         {
                             $this->Rows_sub_detailmedis[$line][$icol] = $dados;
                             if ($prim_col)
                             {
                                 if (isset($this->Rows_sub_detailmedis[$line][$icol]['col_span_i']))
                                 {
                                    $this->Rows_sub_detailmedis[$line][$icol]['col_span_i'] += $this->arr_span['detailmedis'];
                                 }
                                 else
                                 {
                                    $this->Rows_sub_detailmedis[$line][$icol]['col_span_i'] = $this->arr_span['detailmedis'];
   ...
   function NM_sub_cons_icd10()
   {
         ...
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->icd10;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- detailmedis
   function NM_sub_cons_detailmedis()
   {
         $this->Rows_sub_detailmedis = array();
         $GLOBALS["script_case_init"] = $this->Ini->sc_page;
         $GLOBALS["nmgp_parms"] = "nmgp_opcao?#?xls?@?trancode?#?" . str_replace("'", "@aspass@", $this->Orig_trancode) . "?@?";
             ...
             if (isset($_SESSION['scriptcase']['export_return']))
             {
                 ...
                 if (isset($_SESSION['scriptcase']['export_return']['lines']))
                 {
                     ...
                     foreach ($_SESSION['scriptcase']['export_return']['lines'] as $line => $cols)
                     {
                         ...
                         foreach ($cols as $icol => $dados)
                         {
                             $this->Rows_sub_detailmedis[$this->row_sub][$icol] = $dados;
                             if ($prim_col && $this->row_sub > 1)
                             {
                                 if (isset($this->Rows_sub_detailmedis[$this->row_sub][$icol]['col_span_i']))
                                 {
                                    $this->Rows_sub_detailmedis[$this->row_sub][$icol]['col_span_i'] += $this->arr_span['detailmedis'];
                                 }
                                 else
                                 {
                                    $this->Rows_sub_detailmedis[$this->row_sub][$icol]['col_span_i'] = $this->arr_span['detailmedis'];
   ...
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_histori_pasien']['nolabel']) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_histori_pasien']['nolabel'])
       {
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_histori_pasien']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_histori_pasien']['xls_file'] = $this->Xls_f;
      }
...
<HEAD>
 <TITLE>Histori Medis Pasien :: Excel</TITLE>
...
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['grid_histori_pasien']['xls_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php
