...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "id";$Nm_numeric[] = "stokawal";$Nm_numeric[] = "stokkoreksi";$Nm_numeric[] = "stokakhir";$Nm_numeric[] = "id";$Nm_numeric[] = "stokawal";$Nm_numeric[] = "stokkoreksi";$Nm_numeric[] = "stokakhir";
...
<HTML>
<HEAD>
 <TITLE> - tbdetailstockopname</TITLE>
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_stokawal_cond" name="stokawal_cond" onChange="nm_campos_between(document.getElementById('id_vis_stokawal'), this, 'stokawal')">
      ...
      <br><span id="id_hide_stokawal"  <?php echo $str_hide_stokawal?>><?php
      if ($stokawal != "")
      {
      $stokawal_look = substr($this->Db->qstr($stokawal), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_socode_cond" name="socode_cond" onChange="nm_campos_between(document.getElementById('id_vis_socode'), this, 'socode')">
      ...
      <br><span id="id_hide_socode"  <?php echo $str_hide_socode?>><?php
      if ($socode != "")
      {
      $socode_look = substr($this->Db->qstr($socode), 1, -1); 
      $nmgp_def_dados = array(); 
