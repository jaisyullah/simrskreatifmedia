...
<?php
   ...
   $Ord_Cmp = new grid_tbdetailstockopname_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_tbdetailstockopname_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbdetailstockopname']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tbdetailstockopname']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbdetailstockopname']['labels']["id"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbdetailstockopname']['labels']["id"] : "Id";
   $tab_ger_campos['socode'] = "on";
   $tab_def_campos['socode'] = "soCode";
   $tab_labels["socode"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbdetailstockopname']['labels']["socode"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbdetailstockopname']['labels']["socode"] : "So Code";
   $tab_ger_campos['namaitem'] = "on";
   $tab_def_campos['namaitem'] = "namaItem";
   $tab_labels["namaitem"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbdetailstockopname']['labels']["namaitem"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbdetailstockopname']['labels']["namaitem"] : "Nama Item";
   $tab_ger_campos['stokawal'] = "on";
   $tab_def_campos['stokawal'] = "stokAwal";
   $tab_labels["stokawal"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbdetailstockopname']['labels']["stokawal"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbdetailstockopname']['labels']["stokawal"] : "Stok Awal";
   $tab_ger_campos['stokkoreksi'] = "on";
   $tab_def_campos['stokkoreksi'] = "stokKoreksi";
   $tab_labels["stokkoreksi"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbdetailstockopname']['labels']["stokkoreksi"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbdetailstockopname']['labels']["stokkoreksi"] : "Stok Koreksi";
   $tab_ger_campos['stokakhir'] = "on";
   $tab_def_campos['stokakhir'] = "stokAkhir";
   $tab_labels["stokakhir"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbdetailstockopname']['labels']["stokakhir"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbdetailstockopname']['labels']["stokakhir"] : "Stok Akhir";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_tbdetailstockopname']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_tbdetailstockopname']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_tbdetailstockopname']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbdetailstockopname']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tbdetailstockopname']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_tbdetailstockopname']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_tbdetailstockopname']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_tbdetailstockopname']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_tbdetailstockopname']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_tbdetailstockopname_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_tbdetailstockopname']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_tbdetailstockopname']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_tbdetailstockopname']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_tbdetailstockopname']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_tbdetailstockopname']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
