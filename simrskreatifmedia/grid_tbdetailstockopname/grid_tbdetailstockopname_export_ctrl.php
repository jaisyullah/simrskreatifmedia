<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tbdetailstockopname']['sc_process_barr'] = true;
require_once('../grid_tbdetailstockopname/index.php');
unset($_SESSION['scriptcase']['grid_tbdetailstockopname']['sc_process_barr']);
$ExportCtrl = new grid_tbdetailstockopname_export_control;
$ExportCtrl->Export_barr();

class grid_tbdetailstockopname_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - tbdetailstockopname :: Excel</TITLE>
