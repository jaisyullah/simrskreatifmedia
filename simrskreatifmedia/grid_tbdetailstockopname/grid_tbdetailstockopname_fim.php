...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_tbdetailstockopname"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_tbdetailstockopname"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_tbdetailstockopname'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tbdetailstockopname']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_tbdetailstockopname']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tbdetailstockopname']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_tbdetailstockopname']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_tbdetailstockopname']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_tbdetailstockopname</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_tbdetailstockopname']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_tbdetailstockopname']['embutida_filho'] as $ind => $sc_init)
          {
