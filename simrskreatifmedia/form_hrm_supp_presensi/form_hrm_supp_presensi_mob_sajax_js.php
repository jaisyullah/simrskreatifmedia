  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_hrm_supp_presensi_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_hrm_supp_presensi_mob_form();
	}

  // ---------- Validate id
  function do_ajax_form_hrm_supp_presensi_mob_validate_id()
  {
    var nomeCampo_id = "id";
    var var_id = scAjaxGetFieldHidden(nomeCampo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_supp_presensi_mob_validate_id(var_id, var_script_case_init, do_ajax_form_hrm_supp_presensi_mob_validate_id_cb);
  } // do_ajax_form_hrm_supp_presensi_mob_validate_id

  function do_ajax_form_hrm_supp_presensi_mob_validate_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_supp_presensi_mob_validate_id_cb

  // ---------- Validate id_kary
  function do_ajax_form_hrm_supp_presensi_mob_validate_id_kary()
  {
    var nomeCampo_id_kary = "id_kary";
    var var_id_kary = scAjaxGetFieldSelect(nomeCampo_id_kary);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_supp_presensi_mob_validate_id_kary(var_id_kary, var_script_case_init, do_ajax_form_hrm_supp_presensi_mob_validate_id_kary_cb);
  } // do_ajax_form_hrm_supp_presensi_mob_validate_id_kary

  function do_ajax_form_hrm_supp_presensi_mob_validate_id_kary_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id_kary";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_supp_presensi_mob_validate_id_kary_cb

  // ---------- Validate jenis
  function do_ajax_form_hrm_supp_presensi_mob_validate_jenis()
  {
    var nomeCampo_jenis = "jenis";
    var var_jenis = scAjaxGetFieldSelect(nomeCampo_jenis);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_supp_presensi_mob_validate_jenis(var_jenis, var_script_case_init, do_ajax_form_hrm_supp_presensi_mob_validate_jenis_cb);
  } // do_ajax_form_hrm_supp_presensi_mob_validate_jenis

  function do_ajax_form_hrm_supp_presensi_mob_validate_jenis_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "jenis";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_supp_presensi_mob_validate_jenis_cb

  // ---------- Validate fromdate
  function do_ajax_form_hrm_supp_presensi_mob_validate_fromdate()
  {
    var nomeCampo_fromdate = "fromdate";
    var var_fromdate = scAjaxGetFieldText(nomeCampo_fromdate);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_supp_presensi_mob_validate_fromdate(var_fromdate, var_script_case_init, do_ajax_form_hrm_supp_presensi_mob_validate_fromdate_cb);
  } // do_ajax_form_hrm_supp_presensi_mob_validate_fromdate

  function do_ajax_form_hrm_supp_presensi_mob_validate_fromdate_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fromdate";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_supp_presensi_mob_validate_fromdate_cb

  // ---------- Validate todate
  function do_ajax_form_hrm_supp_presensi_mob_validate_todate()
  {
    var nomeCampo_todate = "todate";
    var var_todate = scAjaxGetFieldText(nomeCampo_todate);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_supp_presensi_mob_validate_todate(var_todate, var_script_case_init, do_ajax_form_hrm_supp_presensi_mob_validate_todate_cb);
  } // do_ajax_form_hrm_supp_presensi_mob_validate_todate

  function do_ajax_form_hrm_supp_presensi_mob_validate_todate_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "todate";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_supp_presensi_mob_validate_todate_cb

  // ---------- Validate desc
  function do_ajax_form_hrm_supp_presensi_mob_validate_desc()
  {
    var nomeCampo_desc = "desc";
    var var_desc = scAjaxGetFieldText(nomeCampo_desc);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_supp_presensi_mob_validate_desc(var_desc, var_script_case_init, do_ajax_form_hrm_supp_presensi_mob_validate_desc_cb);
  } // do_ajax_form_hrm_supp_presensi_mob_validate_desc

  function do_ajax_form_hrm_supp_presensi_mob_validate_desc_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "desc";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_supp_presensi_mob_validate_desc_cb

  // ---------- Validate attachment
  function do_ajax_form_hrm_supp_presensi_mob_validate_attachment()
  {
    var nomeCampo_attachment = "attachment";
    var var_attachment = scAjaxGetFieldText(nomeCampo_attachment);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_supp_presensi_mob_validate_attachment(var_attachment, var_script_case_init, do_ajax_form_hrm_supp_presensi_mob_validate_attachment_cb);
  } // do_ajax_form_hrm_supp_presensi_mob_validate_attachment

  function do_ajax_form_hrm_supp_presensi_mob_validate_attachment_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_supp_presensi_mob_validate_attachment_cb

  // ---------- Validate status
  function do_ajax_form_hrm_supp_presensi_mob_validate_status()
  {
    var nomeCampo_status = "status";
    var var_status = scAjaxGetFieldSelect(nomeCampo_status);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_supp_presensi_mob_validate_status(var_status, var_script_case_init, do_ajax_form_hrm_supp_presensi_mob_validate_status_cb);
  } // do_ajax_form_hrm_supp_presensi_mob_validate_status

  function do_ajax_form_hrm_supp_presensi_mob_validate_status_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "status";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_supp_presensi_mob_validate_status_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_hrm_supp_presensi_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_hrm_supp_presensi_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id = scAjaxGetFieldHidden("id");
    var var_id_kary = scAjaxGetFieldSelect("id_kary");
    var var_jenis = scAjaxGetFieldSelect("jenis");
    var var_fromdate = scAjaxGetFieldText("fromdate");
    var var_todate = scAjaxGetFieldText("todate");
    var var_desc = scAjaxGetFieldText("desc");
    ...
    scAjaxProcOn();
    x_ajax_form_hrm_supp_presensi_mob_submit_form(var_id, var_id_kary, var_jenis, var_fromdate, var_todate, var_desc, var_attachment, var_status, var_attachment_ul_name, var_attachment_ul_type, var_attachment_salva, var_attachment_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_hrm_supp_presensi_mob_submit_form_cb);
  } // do_ajax_form_hrm_supp_presensi_mob_submit_form

  function do_ajax_form_hrm_supp_presensi_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("id_kary");
      scAjaxHideErrorDisplay("jenis");
      scAjaxHideErrorDisplay("fromdate");
      scAjaxHideErrorDisplay("todate");
      scAjaxHideErrorDisplay("desc");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_hrm_supp_presensi_mob_submit_form_cb_after_alert);
  } // do_ajax_form_hrm_supp_presensi_mob_submit_form_cb
  function do_ajax_form_hrm_supp_presensi_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_hrm_supp_presensi_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_hrm_supp_presensi_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_hrm_supp_presensi_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_hrm_supp_presensi_mob_navigate_form_cb);
  } // do_ajax_form_hrm_supp_presensi_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_hrm_supp_presensi_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_hrm_supp_presensi_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_hrm_supp_presensi_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_hrm_supp_presensi_mob_navigate_form_cb
  function do_ajax_form_hrm_supp_presensi_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_hrm_supp_presensi_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_hrm_supp_presensi_mob_navigate_form_cb_after_alert
  function sc_hide_form_hrm_supp_presensi_mob_form()
  {
  ...
  ajax_field_list[1] = "id_kary";
  ajax_field_list[2] = "jenis";
  ajax_field_list[3] = "fromdate";
  ajax_field_list[4] = "todate";
  ajax_field_list[5] = "desc";
  ajax_field_list[6] = "attachment";
  ...
  var ajax_error_list = {
    ...
    "id_kary": {"label": "Karyawan", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "jenis": {"label": "Jenis Pengajuan", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "fromdate": {"label": "Dari Tgl", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "todate": {"label": "Sampai Tgl", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "desc": {"label": "Keterangan", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "attachment": {"label": "Lampiran", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  ajax_field_mult["id_kary"][1] = "id_kary";
  ajax_field_mult["jenis"][1] = "jenis";
  ajax_field_mult["fromdate"][1] = "fromdate";
  ajax_field_mult["todate"][1] = "todate";
  ajax_field_mult["desc"][1] = "desc";
  ajax_field_mult["attachment"][1] = "attachment";
  ajax_field_mult["status"][1] = "status";

  var ajax_field_id = {
    "id_kary": new Array("hidden_field_label_id_kary", "hidden_field_data_id_kary"),
    "jenis": new Array("hidden_field_label_jenis", "hidden_field_data_jenis"),
    "fromdate": new Array("hidden_field_label_fromdate", "hidden_field_data_fromdate"),
    "todate": new Array("hidden_field_label_todate", "hidden_field_data_todate"),
    "desc": new Array("hidden_field_label_desc", "hidden_field_data_desc"),
