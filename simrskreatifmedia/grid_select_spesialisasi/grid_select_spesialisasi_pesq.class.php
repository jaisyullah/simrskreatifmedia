...
class grid_select_spesialisasi_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_spesialisasi']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_select_spesialisasi_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_select_spesialisasi_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_select_spesialisasi_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_gelar')
      {
          $gelar = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_gelar($gelar);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_letak')
      {
          $letak = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_letak($letak);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function lookup_ajax_gelar($gelar)
   {
      $gelar = substr($this->Db->qstr($gelar), 1, -1);
            $gelar_look = substr($this->Db->qstr($gelar), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct gelar from " . $this->Ini->nm_tabela . " where letak = '2' and  gelar like '%" . $gelar . "%' order by gelar"; 
      unset($cmp1,$cmp2);
   ...
   function lookup_ajax_letak($letak)
   {
      $letak = str_replace($_SESSION['scriptcase']['reg_conf']['grup_num'], "", $letak);
      $letak = substr($this->Db->qstr($letak), 1, -1);
            $letak_look = substr($this->Db->qstr($letak), 1, -1); 
      $nmgp_def_dados = array(); 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct letak from " . $this->Ini->nm_tabela . " where letak = '2' and   CAST (letak AS TEXT)  like '%" . $letak . "%' order by letak"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct letak from " . $this->Ini->nm_tabela . " where letak = '2' and   CAST (letak AS VARCHAR)  like '%" . $letak . "%' order by letak"; 
      }
      else
      {
          $nm_comando = "select distinct letak from " . $this->Ini->nm_tabela . " where letak = '2' and  letak like '%" . $letak . "%' order by letak"; 
      }
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_spesialisasi']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_spesialisasi']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_spesialisasi']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_spesialisasi']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_spesialisasi']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_spesialisasi']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_spesialisasi']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_spesialisasi']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_spesialisasi']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_spesialisasi']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_spesialisasi']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_spesialisasi']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_spesialisasi']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_spesialisasi']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_spesialisasi']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - tbgelardokter</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_select_spesialisasi/grid_select_spesialisasi_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_select_spesialisasi_ajax_search.js"></script>
 <script type="text/javascript" src="grid_select_spesialisasi_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_select_spesialisasi_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_select_spesialisasi']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_select_spesialisasi']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_gelar_cond#NMF#' + search_get_sel_txt('SC_gelar_cond') + '@NMF@';
  str_out += 'SC_gelar#NMF#' + search_get_text('SC_gelar') + '@NMF@';
  str_out += 'id_ac_gelar#NMF#' + search_get_text('id_ac_gelar') + '@NMF@';
  str_out += 'SC_letak_cond#NMF#' + search_get_sel_txt('SC_letak_cond') + '@NMF@';
  str_out += 'SC_letak#NMF#' + search_get_text('SC_letak') + '@NMF@';
  str_out += 'id_ac_letak#NMF#' + search_get_text('id_ac_letak') + '@NMF@';
   ...
   $("#id_ac_gelar").autocomplete({
     ...
     $.ajax({
       ...
       data: {
          ...
          nmgp_parms: "NM_ajax_opcao?#?autocomp_gelar",
          max_itens: "10",
          cod_desc: "N",
     ...
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_gelar").val( $(this).val() );
       }
     }
   });
   $("#id_ac_letak").autocomplete({
     minLength: 1,
     source: function (request, response) {
     $.ajax({
       url: "index.php",
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_letak",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_spesialisasi']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div class="scFilterHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFilterHeaderFont" style="float: left; text-transform: uppercase;"><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - tbgelardokter</div>
...
<?php
   ...
   {
      global 
             $gelar_cond, $gelar, $gelar_autocomp,
             $letak_cond, $letak, $letak_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_spesialisasi']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_spesialisasi']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_spesialisasi']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_spesialisasi']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $gelar = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_spesialisasi']['campos_busca']['gelar']; 
          $gelar_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_spesialisasi']['campos_busca']['gelar_cond']; 
          $letak = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_spesialisasi']['campos_busca']['letak']; 
          $letak_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_spesialisasi']['campos_busca']['letak_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_spesialisasi']['campos_busca']['NM_operador']; 
      } 
      if (!isset($gelar_cond) || empty($gelar_cond))
      {
         $gelar_cond = "qp";
      }
      if (!isset($letak_cond) || empty($letak_cond))
      {
         $letak_cond = "gt";
      }
      ...
      $str_hide_gelar = (in_array($gelar_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_letak = (in_array($letak_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      if (!isset($gelar) || $gelar == "")
      {
          $gelar = "";
      }
      if (isset($gelar) && !empty($gelar))
      {
         $tmp_pos = strpos($gelar, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $gelar = substr($gelar, 0, $tmp_pos);
         }
      }
      if (!isset($letak) || $letak == "")
      {
          $letak = "";
      }
      if (isset($letak) && !empty($letak))
      {
         $tmp_pos = strpos($letak, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $letak = substr($letak, 0, $tmp_pos);
         }
      }
?>
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_gelar_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['gelar'])) ? $this->New_label['gelar'] : "Gelar"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_gelar_cond" name="gelar_cond" onChange="nm_campos_between(document.getElementById('id_vis_gelar'), this, 'gelar')">
       <OPTION value="qp" <?php if ("qp" == $gelar_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $gelar_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $gelar_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $gelar_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_gelar" <?php echo $str_hide_gelar?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['gelar'])) ? $this->New_label['gelar'] : "Gelar";
 $nmgp_tab_label .= "gelar?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
...
<?php
      ...
      $gelar_look = substr($this->Db->qstr($gelar), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct gelar from " . $this->Ini->nm_tabela . " where letak = '2' and gelar = '$gelar_look' order by gelar"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      if (isset($nmgp_def_dados[0][$gelar]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$gelar];
      }
      else
      {
          $sAutocompValue = $gelar;
      }
?>
<INPUT  type="text" id="SC_gelar" name="gelar" value="<?php echo NM_encode_input($gelar) ?>"  size=20 alt="{datatype: 'text', maxLength: 20, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_gelar" name="gelar_autocomp" size="20"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 20, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_letak_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['letak'])) ? $this->New_label['letak'] : "Letak"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_letak_cond" name="letak_cond" onChange="nm_campos_between(document.getElementById('id_vis_letak'), this, 'letak')">
       <OPTION value="gt" <?php if ("gt" == $letak_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $letak_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $letak_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_letak" <?php echo $str_hide_letak?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['letak'])) ? $this->New_label['letak'] : "Letak";
 $nmgp_tab_label .= "letak?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
   ...
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct letak from " . $this->Ini->nm_tabela . " where letak = '2' and letak = $letak_look order by letak"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct letak from " . $this->Ini->nm_tabela . " where letak = '2' and letak = $letak_look order by letak"; 
      ...
      if (isset($nmgp_def_dados[0][$letak]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$letak];
      }
      else
      {
            nmgp_Form_Num_Val($letak, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          $sAutocompValue = $letak;
      }
?>
<INPUT  type="text" id="SC_letak" name="letak" value="<?php echo NM_encode_input($letak) ?>" size=3 alt="{datatype: 'integer', maxLength: 3, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_letak" name="letak_autocomp" size="3"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 3, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
...
?>
<?php
   if (is_file("grid_select_spesialisasi_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_select_spesialisasi']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_select_spesialisasi']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_spesialisasi']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.gelar_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_gelar'), document.F1.gelar_cond, 'gelar');
   document.F1.gelar.value = "";
   document.F1.gelar_autocomp.value = "";
   document.F1.letak_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_letak'), document.F1.letak_cond, 'letak');
   document.F1.letak.value = "";
   document.F1.letak_autocomp.value = "";
 }
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "simrskreatifmedia/grid_select_spesialisasi";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_spesialisasi']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_spesialisasi']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_spesialisasi']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro($nmgp_save_origem)
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "grid_select_spesialisasi/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_gelar_cond'] = 'cond';
      $tp_fields['SC_gelar'] = 'text_aut';
      $tp_fields['id_ac_gelar'] = 'text_aut';
      $tp_fields['SC_letak_cond'] = 'cond';
      $tp_fields['SC_letak'] = 'text_aut';
      $tp_fields['id_ac_letak'] = 'text_aut';
   ...
   {
      global $gelar_cond, $gelar, $gelar_autocomp,
             $letak_cond, $letak, $letak_autocomp, $nmgp_tab_label;

      $C_formatado = true;
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_conv_dados.php", "F", "nm_conv_limpa_dado") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
      if (!empty($gelar_autocomp) && empty($gelar))
      {
          $gelar = $gelar_autocomp;
      }
      if (!empty($letak_autocomp) && empty($letak))
      {
          $letak = $letak_autocomp;
      }
      $gelar_cond_salva = $gelar_cond; 
      if (!isset($gelar_input_2) || $gelar_input_2 == "")
      {
          $gelar_input_2 = $gelar;
      }
      $letak_cond_salva = $letak_cond; 
      if (!isset($letak_input_2) || $letak_input_2 == "")
      {
          $letak_input_2 = $letak;
      }
      if ($letak_cond != "in")
      {
          nm_limpa_numero($letak, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_spesialisasi']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_spesialisasi']['campos_busca']['gelar'] = $gelar; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_spesialisasi']['campos_busca']['gelar_cond'] = $gelar_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_spesialisasi']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_spesialisasi']['campos_busca']['letak'] = $letak; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_spesialisasi']['campos_busca']['letak_cond'] = $letak_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_spesialisasi']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_spesialisasi']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_spesialisasi']['campos_busca'] = $Temp_Busca;
      }
      if ($letak_cond != "in" && $letak_cond != "bw" && !empty($letak) && !is_numeric($letak))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Letak";
      }
      if ($letak_cond == "bw" && ((!empty($letak) && !is_numeric($letak)) || (!empty($letak_input_2) && !is_numeric($letak_input_2)) ))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Letak";
      }
      if (!empty($this->Campos_Mens_erro)) 
      ...
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['gelar'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['gelar'] = $gelar;
      }
      $letak_look = substr($this->Db->qstr($letak), 1, -1); 
      $nmgp_def_dados = array(); 
   if (is_numeric($letak))
   { 
      ...
      if (isset($gelar) || $gelar_cond == "nu" || $gelar_cond == "nn" || $gelar_cond == "ep" || $gelar_cond == "ne")
      {
         $this->monta_condicao("gelar", $gelar_cond, $gelar, "", "gelar");
      }

      //----- $letak
      $this->Date_part = false;
      if (isset($letak) || $letak_cond == "nu" || $letak_cond == "nn" || $letak_cond == "ep" || $letak_cond == "ne")
      {
         $this->monta_condicao("letak", $letak_cond, $letak, "", "letak");
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_spesialisasi']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_spesialisasi']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_spesialisasi']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_spesialisasi']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_spesialisasi']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_spesialisasi']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_spesialisasi']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_spesialisasi']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_select_spesialisasi']['cond_pesq'] .= $this->NM_operador;
