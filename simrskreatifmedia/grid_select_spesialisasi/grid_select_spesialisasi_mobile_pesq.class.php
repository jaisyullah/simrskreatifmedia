...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "letak";$Nm_numeric[] = "letak";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_gelar_cond" name="gelar_cond" onChange="nm_campos_between(document.getElementById('id_vis_gelar'), this, 'gelar')">
      ...
      <br><span id="id_hide_gelar"  <?php echo $str_hide_gelar?>><?php
      if ($gelar != "")
      {
      $gelar_look = substr($this->Db->qstr($gelar), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_letak_cond" name="letak_cond" onChange="nm_campos_between(document.getElementById('id_vis_letak'), this, 'letak')">
      ...
      <br><span id="id_hide_letak"  <?php echo $str_hide_letak?>><?php
      if ($letak != "")
      {
      $letak_look = substr($this->Db->qstr($letak), 1, -1); 
      $nmgp_def_dados = array(); 
