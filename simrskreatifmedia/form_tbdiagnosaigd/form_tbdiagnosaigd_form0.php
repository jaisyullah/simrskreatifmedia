<?php
class form_tbdiagnosaigd_form extends form_tbdiagnosaigd_apl
{
function Form_Init()
{
...
<HEAD>
 <TITLE><?php if ('novo' == $this->nmgp_opcao) { echo strip_tags("" . $this->Ini->Nm_lang['lang_othr_frmi_titl'] . " - tbdiagnosaigd"); } else { echo strip_tags("" . $this->Ini->Nm_lang['lang_othr_frmu_titl'] . " - tbdiagnosaigd"); } ?></TITLE>
...
<?php
if ($this->Embutida_form && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdiagnosaigd']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdiagnosaigd']['sc_modal'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdiagnosaigd']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdiagnosaigd']['sc_redir_atualiz'] == 'ok')
{
?>
...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdiagnosaigd']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_tbdiagnosaigd/form_tbdiagnosaigd_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_tbdiagnosaigd_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_tbdiagnosaigd_jquery.php');
...
?>
 ...
 function addAutocomplete(elem) {
  ...
  $(".sc-ui-autocomp-namadiagnosa_", elem).on("focus", function() {
   ...
   var sId = $(this).attr("id").substr(6), sRow = "namadiagnosa_" != sId ? sId.substr(13) : "";
   sc_form_tbdiagnosaigd_namadiagnosa__onfocus("id_sc_field_" + sId, sRow);
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdiagnosaigd']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdiagnosaigd']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdiagnosaigd']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdiagnosaigd']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdiagnosaigd']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdiagnosaigd']['recarga'];
}
if ('novo' == $opcao_botoes && $this->Embutida_form)
{
    $opcao_botoes = 'inicio';
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdiagnosaigd']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdiagnosaigd']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
?>
...
<?php
 include_once("form_tbdiagnosaigd_js0.php");
?>
<script type="text/javascript"> 
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_tbdiagnosaigd'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_tbdiagnosaigd'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdiagnosaigd']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdiagnosaigd']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdiagnosaigd']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdiagnosaigd']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdiagnosaigd']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<div class="scFormHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFormHeaderFont" style="float: left; text-transform: uppercase;"><?php if ($this->nmgp_opcao == "novo") { echo "" . $this->Ini->Nm_lang['lang_othr_frmi_titl'] . " - tbdiagnosaigd"; } else { echo "" . $this->Ini->Nm_lang['lang_othr_frmu_titl'] . " - tbdiagnosaigd"; } ?></div>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdiagnosaigd']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdiagnosaigd']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdiagnosaigd']['run_iframe'] != "R")
{
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdiagnosaigd']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdiagnosaigd']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdiagnosaigd']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdiagnosaigd']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdiagnosaigd']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdiagnosaigd']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdiagnosaigd']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdiagnosaigd']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdiagnosaigd']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdiagnosaigd']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
 ...
 ?>
   ...
   <?php if (isset($this->nmgp_cmp_hidden['kodeicdx_']) && $this->nmgp_cmp_hidden['kodeicdx_'] == 'off') { $sStyleHidden_kodeicdx_ = 'display: none'; }
      ...
      if (!isset($this->nm_new_label['kodeicdx_'])) {
          $this->nm_new_label['kodeicdx_'] = "Kode ICD X"; } ?>
...
{ 
   ...
   { 
       ob_start();
       $iStart = sizeof($this->form_vert_form_tbdiagnosaigd);
       $guarda_nmgp_opcao = $this->nmgp_opcao;
       $guarda_form_vert_form_tbdiagnosaigd = $this->form_vert_form_tbdiagnosaigd;
       $this->nmgp_opcao = 'novo';
   } 
   if ($this->Embutida_form && empty($this->form_vert_form_tbdiagnosaigd))
   {
       $sc_seq_vert = 0;
   }
   ...
   foreach ($this->form_vert_form_tbdiagnosaigd as $sc_seq_vert => $sc_lixo)
   {
       $this->loadRecordState($sc_seq_vert);
       $this->id_ = $this->form_vert_form_tbdiagnosaigd[$sc_seq_vert]['id_'];
       ...
       elseif ($Line_Add)
       {
        ...
        $this->kodeicdx_ = $this->form_vert_form_tbdiagnosaigd[$sc_seq_vert]['kodeicdx_']; 
       ...
       $this->jenisdiagnosa_ = $this->form_vert_form_tbdiagnosaigd[$sc_seq_vert]['jenisdiagnosa_']; 
       ...
       $this->keterangan_ = $this->form_vert_form_tbdiagnosaigd[$sc_seq_vert]['keterangan_']; 
       ...
       $this->tgldiagnosa_ = $this->form_vert_form_tbdiagnosaigd[$sc_seq_vert]['tgldiagnosa_'] . ' ' . $this->form_vert_form_tbdiagnosaigd[$sc_seq_vert]['tgldiagnosa__hora']; 
       ...
       $this->trancode_ = $this->form_vert_form_tbdiagnosaigd[$sc_seq_vert]['trancode_']; 
...
<?php echo nmButtonOutput($this->arr_buttons, "bmd_novo", "do_ajax_form_tbdiagnosaigd_add_new_line(" . $sc_seq_vert . ")", "do_ajax_form_tbdiagnosaigd_add_new_line(" . $sc_seq_vert . ")", "sc_new_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
<?php }?>
<?php
  $Style_add_line = (!$Line_Add) ? "display: none" : "";
?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_form_tbdiagnosaigd_cancel_insert(" . $sc_seq_vert . ")", "do_ajax_form_tbdiagnosaigd_cancel_insert(" . $sc_seq_vert . ")", "sc_canceli_line_" . $sc_seq_vert . "", "", "", "" . $Style_add_line . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_form_tbdiagnosaigd_cancel_update(" . $sc_seq_vert . ")", "do_ajax_form_tbdiagnosaigd_cancel_update(" . $sc_seq_vert . ")", "sc_cancelu_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
 </TD>
   <?php }?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdiagnosaigd']['Lookup_jenisdiagnosa_'][] = ''; ?>
 <option value=""></option>
 <option  value="PRIMER" <?php  if ($this->jenisdiagnosa_ == "PRIMER") { echo " selected" ;} ?>>PRIMER</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdiagnosaigd']['Lookup_jenisdiagnosa_'][] = 'PRIMER'; ?>
 <option  value="SEKUNDER" <?php  if ($this->jenisdiagnosa_ == "SEKUNDER") { echo " selected" ;} ?>>SEKUNDER</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdiagnosaigd']['Lookup_jenisdiagnosa_'][] = 'SEKUNDER'; ?>
 </select></span>
</span><?php  }?>
...
<?php   
   ...
   { 
       ...
       $this->form_vert_form_tbdiagnosaigd = $guarda_form_vert_form_tbdiagnosaigd;
   } 
   if ($Table_refresh) 
   { 
...
<?php
if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdiagnosaigd']['run_modal']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdiagnosaigd']['run_modal'])
{
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdiagnosaigd']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdiagnosaigd']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_tbdiagnosaigd");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_tbdiagnosaigd");
 parent.scAjaxDetailHeight("form_tbdiagnosaigd", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
<script type="text/javascript">
	function scBtnFn_sys_format_inc() {
		if ($("#sc_b_new_t.sc-unique-btn-1").length && $("#sc_b_new_t.sc-unique-btn-1").is(":visible")) {
			do_ajax_form_tbdiagnosaigd_add_new_line(); return false;
			 return;
		}
...
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdiagnosaigd']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
