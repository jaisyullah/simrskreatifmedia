<?php
class form_tbbilldetail_form extends form_tbbilldetail_apl
{
function Form_Init()
{
...
<HEAD>
 <TITLE><?php if ('novo' == $this->nmgp_opcao) { echo strip_tags("" . $this->Ini->Nm_lang['lang_othr_frmi_titl'] . " - tbbilldetail"); } else { echo strip_tags("" . $this->Ini->Nm_lang['lang_othr_frmu_titl'] . " - tbbilldetail"); } ?></TITLE>
...
<?php
if ($this->Embutida_form && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbilldetail']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbilldetail']['sc_modal'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbilldetail']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbilldetail']['sc_redir_atualiz'] == 'ok')
{
?>
...
?>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbilldetail']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_tbbilldetail/form_tbbilldetail_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_tbbilldetail_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_tbbilldetail_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbilldetail']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbilldetail']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbilldetail']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbilldetail']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbilldetail']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbilldetail']['recarga'];
}
if ('novo' == $opcao_botoes && $this->Embutida_form)
{
    $opcao_botoes = 'inicio';
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbilldetail']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbilldetail']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
?>
...
<?php
 include_once("form_tbbilldetail_js0.php");
?>
<script type="text/javascript"> 
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_tbbilldetail'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_tbbilldetail'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbilldetail']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbilldetail']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbilldetail']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbilldetail']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbilldetail']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<div class="scFormHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFormHeaderFont" style="float: left; text-transform: uppercase;"><?php if ($this->nmgp_opcao == "novo") { echo "" . $this->Ini->Nm_lang['lang_othr_frmi_titl'] . " - tbbilldetail"; } else { echo "" . $this->Ini->Nm_lang['lang_othr_frmu_titl'] . " - tbbilldetail"; } ?></div>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbilldetail']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbilldetail']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbilldetail']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbilldetail']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbilldetail']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbilldetail']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbilldetail']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbilldetail']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbilldetail']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbilldetail']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbilldetail']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbilldetail']['fast_search'][2] : "";
?> 
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbilldetail']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbilldetail']['run_iframe'] != "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbilldetail']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbilldetail']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbilldetail']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbilldetail']['run_iframe'] == "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbilldetail']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbilldetail']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbilldetail']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbilldetail']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbilldetail']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbilldetail']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbilldetail']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbilldetail']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbilldetail']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbilldetail']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbilldetail']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbilldetail']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
 ...
 ?>
   ...
   <?php if (isset($this->nmgp_cmp_hidden['cover_']) && $this->nmgp_cmp_hidden['cover_'] == 'off') { $sStyleHidden_cover_ = 'display: none'; }
      if (1 || !isset($this->nmgp_cmp_hidden['cover_']) || $this->nmgp_cmp_hidden['cover_'] == 'on') {
      if (!isset($this->nm_new_label['cover_'])) {
          $this->nm_new_label['cover_'] = "Cover"; } ?>

    <TD class="scFormLabelOddMult css_cover__label" id="hidden_field_label_cover_" style="<?php echo $sStyleHidden_cover_; ?>" > <?php echo $this->nm_new_label['cover_'] ?> </TD>
   <?php } ?>
   ...
   <?php if (isset($this->nmgp_cmp_hidden['trandate_']) && $this->nmgp_cmp_hidden['trandate_'] == 'off') { $sStyleHidden_trandate_ = 'display: none'; }
      ...
      if (!isset($this->nm_new_label['trandate_'])) {
          $this->nm_new_label['trandate_'] = "Tran Date"; } ?>
<?php
...
{ 
   ...
   { 
       ob_start();
       $iStart = sizeof($this->form_vert_form_tbbilldetail);
       $guarda_nmgp_opcao = $this->nmgp_opcao;
       $guarda_form_vert_form_tbbilldetail = $this->form_vert_form_tbbilldetail;
       $this->nmgp_opcao = 'novo';
   } 
   if ($this->Embutida_form && empty($this->form_vert_form_tbbilldetail))
   {
       $sc_seq_vert = 0;
   }
   ...
   foreach ($this->form_vert_form_tbbilldetail as $sc_seq_vert => $sc_lixo)
   {
       ...
       if (isset($this->Embutida_ronly) && $this->Embutida_ronly && !$Line_Add)
       {
           ...
           $this->nmgp_cmp_readonly['cover_'] = true;
       ...
       elseif ($Line_Add)
       {
           ...
           if (!isset($this->nmgp_cmp_readonly['cover_']) || $this->nmgp_cmp_readonly['cover_'] != "on") {$this->nmgp_cmp_readonly['cover_'] = false;}
        ...
        $this->id_ = $this->form_vert_form_tbbilldetail[$sc_seq_vert]['id_']; 
       $id_ = $this->id_; 
       $sStyleHidden_id_ = '';
       ...
       $this->trancode_ = $this->form_vert_form_tbbilldetail[$sc_seq_vert]['trancode_']; 
       ...
       $this->keterangan_ = $this->form_vert_form_tbbilldetail[$sc_seq_vert]['keterangan_']; 
       ...
       $this->jumlah_ = $this->form_vert_form_tbbilldetail[$sc_seq_vert]['jumlah_']; 
       ...
       $this->biaya_ = $this->form_vert_form_tbbilldetail[$sc_seq_vert]['biaya_']; 
       $biaya_ = $this->biaya_; 
       $sStyleHidden_biaya_ = '';
       ...
       $this->cover_ = $this->form_vert_form_tbbilldetail[$sc_seq_vert]['cover_']; 
       $cover_ = $this->cover_; 
       $sStyleHidden_cover_ = '';
       if (isset($sCheckRead_cover_))
       {
           unset($sCheckRead_cover_);
       }
       if (isset($this->nmgp_cmp_readonly['cover_']))
       {
           $sCheckRead_cover_ = $this->nmgp_cmp_readonly['cover_'];
       }
       if (isset($this->nmgp_cmp_hidden['cover_']) && $this->nmgp_cmp_hidden['cover_'] == 'off')
       {
           unset($this->nmgp_cmp_hidden['cover_']);
           $sStyleHidden_cover_ = 'display: none;';
       }
       $bTestReadOnly_cover_ = true;
       $sStyleReadLab_cover_ = 'display: none;';
       $sStyleReadInp_cover_ = '';
       if (isset($this->nmgp_cmp_readonly['cover_']) && $this->nmgp_cmp_readonly['cover_'] == 'on')
       {
           $bTestReadOnly_cover_ = false;
           unset($this->nmgp_cmp_readonly['cover_']);
           $sStyleReadLab_cover_ = '';
           $sStyleReadInp_cover_ = 'display: none;';
       }
       $this->subtotal_ = $this->form_vert_form_tbbilldetail[$sc_seq_vert]['subtotal_']; 
       ...
       $this->trandate_ = $this->form_vert_form_tbbilldetail[$sc_seq_vert]['trandate_'] . ' ' . $this->form_vert_form_tbbilldetail[$sc_seq_vert]['trandate__hora']; 
...
<?php echo nmButtonOutput($this->arr_buttons, "bmd_novo", "do_ajax_form_tbbilldetail_add_new_line(" . $sc_seq_vert . ")", "do_ajax_form_tbbilldetail_add_new_line(" . $sc_seq_vert . ")", "sc_new_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
<?php }?>
<?php
  $Style_add_line = (!$Line_Add) ? "display: none" : "";
?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_form_tbbilldetail_cancel_insert(" . $sc_seq_vert . ")", "do_ajax_form_tbbilldetail_cancel_insert(" . $sc_seq_vert . ")", "sc_canceli_line_" . $sc_seq_vert . "", "", "", "" . $Style_add_line . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_form_tbbilldetail_cancel_update(" . $sc_seq_vert . ")", "do_ajax_form_tbbilldetail_cancel_update(" . $sc_seq_vert . ")", "sc_cancelu_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
 </TD>
   <?php }?>
...
<span id="id_read_on_biaya_<?php echo $sc_seq_vert ?>" class="sc-ui-readonly-biaya_<?php echo $sc_seq_vert ?> css_biaya__line" style="<?php echo $sStyleReadLab_biaya_; ?>"><?php echo $this->biaya_; ?></span><span id="id_read_off_biaya_<?php echo $sc_seq_vert ?>" class="css_read_off_biaya_" style="white-space: nowrap;<?php echo $sStyleReadInp_biaya_; ?>">
 ...
 size=8 alt="{datatype: 'integer', maxLength: 8, thousandsSep: '<?php echo str_replace("'", "\'", $this->field_config['biaya_']['symbol_grp']); ?>', thousandsFormat: <?php echo $this->field_config['biaya_']['symbol_fmt']; ?>, allowNegative: false, onlyNegative: false, negativePos: <?php echo (4 == $this->field_config['biaya_']['format_neg'] ? "'suffix'" : "'prefix'") ?>, alignment: 'left', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddMultWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
   ...
   <?php if (isset($this->nmgp_cmp_hidden['cover_']) && $this->nmgp_cmp_hidden['cover_'] == 'off') { $sc_hidden_yes++;  ?>
<input type="hidden" name="cover_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($cover_) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormDataOddMult css_cover__line" id="hidden_field_data_cover_<?php echo $sc_seq_vert; ?>" style="<?php echo $sStyleHidden_cover_; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOddMult css_cover__line" style="vertical-align: top;padding: 0px">
<?php if ($bTestReadOnly_cover_ && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["cover_"]) &&  $this->nmgp_cmp_readonly["cover_"] == "on") { 

 ?>
<input type="hidden" name="cover_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($cover_) . "\">" . $cover_ . ""; ?>
<?php } else { ?>
<span id="id_read_on_cover_<?php echo $sc_seq_vert ?>" class="sc-ui-readonly-cover_<?php echo $sc_seq_vert ?> css_cover__line" style="<?php echo $sStyleReadLab_cover_; ?>"><?php echo $this->cover_; ?></span><span id="id_read_off_cover_<?php echo $sc_seq_vert ?>" class="css_read_off_cover_" style="white-space: nowrap;<?php echo $sStyleReadInp_cover_; ?>">
 <input class="sc-js-input scFormObjectOddMult css_cover__obj" style="" id="id_sc_field_cover_<?php echo $sc_seq_vert ?>" type=text name="cover_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($cover_) ?>"
 size=8 alt="{datatype: 'integer', maxLength: 8, thousandsSep: '<?php echo str_replace("'", "\'", $this->field_config['cover_']['symbol_grp']); ?>', thousandsFormat: <?php echo $this->field_config['cover_']['symbol_fmt']; ?>, allowNegative: false, onlyNegative: false, negativePos: <?php echo (4 == $this->field_config['cover_']['format_neg'] ? "'suffix'" : "'prefix'") ?>, alignment: 'left', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddMultWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
</td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_cover_<?php echo $sc_seq_vert; ?>_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_cover_<?php echo $sc_seq_vert; ?>_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
<span id="id_read_on_subtotal_<?php echo $sc_seq_vert ?>" class="sc-ui-readonly-subtotal_<?php echo $sc_seq_vert ?> css_subtotal__line" style="<?php echo $sStyleReadLab_subtotal_; ?>"><?php echo $this->subtotal_; ?></span><span id="id_read_off_subtotal_<?php echo $sc_seq_vert ?>" class="css_read_off_subtotal_" style="white-space: nowrap;<?php echo $sStyleReadInp_subtotal_; ?>">
 ...
 size=8 alt="{datatype: 'integer', maxLength: 8, thousandsSep: '<?php echo str_replace("'", "\'", $this->field_config['subtotal_']['symbol_grp']); ?>', thousandsFormat: <?php echo $this->field_config['subtotal_']['symbol_fmt']; ?>, allowNegative: false, onlyNegative: false, negativePos: <?php echo (4 == $this->field_config['subtotal_']['format_neg'] ? "'suffix'" : "'prefix'") ?>, alignment: 'left', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddMultWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
...
<?php   
       ...
       if (isset($sCheckRead_cover_))
       {
           $this->nmgp_cmp_readonly['cover_'] = $sCheckRead_cover_;
       }
       if ('display: none;' == $sStyleHidden_cover_)
       {
           $this->nmgp_cmp_hidden['cover_'] = 'off';
       }
       if (isset($sCheckRead_subtotal_))
       {
   ...
   { 
       ...
       $this->form_vert_form_tbbilldetail = $guarda_form_vert_form_tbbilldetail;
   } 
   if ($Table_refresh) 
   { 
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbilldetail']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbilldetail']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbilldetail']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbilldetail']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbilldetail']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbilldetail']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbilldetail']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbilldetail']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbilldetail']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<?php
if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbilldetail']['run_modal']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbilldetail']['run_modal'])
{
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbilldetail']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbilldetail']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_tbbilldetail");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_tbbilldetail");
 parent.scAjaxDetailHeight("form_tbbilldetail", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
<script type="text/javascript">
	function scBtnFn_sys_format_inc() {
		if ($("#sc_b_new_t.sc-unique-btn-1").length && $("#sc_b_new_t.sc-unique-btn-1").is(":visible")) {
			do_ajax_form_tbbilldetail_add_new_line(); return false;
			 return;
		}
...
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbilldetail']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
