<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['pendapatanKasir']['glo_nm_path_imag_temp'] . "/sc_apl_default_simrskreatifmedia.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new pendapatanKasir_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class pendapatanKasir_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['pendapatanKasir']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['pendapatanKasir']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["trandate"]   = (isset($_SESSION['sc_session'][$sc_init]['pendapatanKasir']['labels']["trandate"])) ? $_SESSION['sc_session'][$sc_init]['pendapatanKasir']['labels']["trandate"] : "Tgl. Transaksi";
   $tab_ger_campos['nopayment'] = "on";
   $tab_def_campos['nopayment'] = "noPayment";
   $tab_labels["nopayment"]   = (isset($_SESSION['sc_session'][$sc_init]['pendapatanKasir']['labels']["nopayment"])) ? $_SESSION['sc_session'][$sc_init]['pendapatanKasir']['labels']["nopayment"] : "Kode Pembayaran";
   $tab_ger_campos['trancode'] = "on";
   $tab_def_campos['trancode'] = "tranCode";
   $tab_labels["trancode"]   = (isset($_SESSION['sc_session'][$sc_init]['pendapatanKasir']['labels']["trancode"])) ? $_SESSION['sc_session'][$sc_init]['pendapatanKasir']['labels']["trancode"] : "Kode Pelayanan";
   $tab_ger_campos['custcode'] = "on";
   $tab_def_campos['custcode'] = "custCode";
   $tab_labels["custcode"]   = (isset($_SESSION['sc_session'][$sc_init]['pendapatanKasir']['labels']["custcode"])) ? $_SESSION['sc_session'][$sc_init]['pendapatanKasir']['labels']["custcode"] : "Pasien";
   $tab_ger_campos['dokter'] = "on";
   $tab_def_campos['dokter'] = "dokter";
   $tab_labels["dokter"]   = (isset($_SESSION['sc_session'][$sc_init]['pendapatanKasir']['labels']["dokter"])) ? $_SESSION['sc_session'][$sc_init]['pendapatanKasir']['labels']["dokter"] : "DPJP";
   $tab_ger_campos['jmlbayar'] = "on";
   $tab_def_campos['jmlbayar'] = "jmlBayar";
   $tab_labels["jmlbayar"]   = (isset($_SESSION['sc_session'][$sc_init]['pendapatanKasir']['labels']["jmlbayar"])) ? $_SESSION['sc_session'][$sc_init]['pendapatanKasir']['labels']["jmlbayar"] : "Jml Bayar";
   $tab_ger_campos['jenispayment'] = "on";
   $tab_def_campos['jenispayment'] = "jenisPayment";
   $tab_labels["jenispayment"]   = (isset($_SESSION['sc_session'][$sc_init]['pendapatanKasir']['labels']["jenispayment"])) ? $_SESSION['sc_session'][$sc_init]['pendapatanKasir']['labels']["jenispayment"] : "Jenis Payment";
   $tab_ger_campos['paiddate'] = "on";
   $tab_def_campos['paiddate'] = "paidDate";
   $tab_labels["paiddate"]   = (isset($_SESSION['sc_session'][$sc_init]['pendapatanKasir']['labels']["paiddate"])) ? $_SESSION['sc_session'][$sc_init]['pendapatanKasir']['labels']["paiddate"] : "Tgl. Bayar";
   $tab_ger_campos['kasir'] = "on";
   $tab_def_campos['kasir'] = "kasir";
   $tab_labels["kasir"]   = (isset($_SESSION['sc_session'][$sc_init]['pendapatanKasir']['labels']["kasir"])) ? $_SESSION['sc_session'][$sc_init]['pendapatanKasir']['labels']["kasir"] : "Kasir";
   ...
   $tab_labels["detail"]   = (isset($_SESSION['sc_session'][$sc_init]['pendapatanKasir']['labels']["detail"])) ? $_SESSION['sc_session'][$sc_init]['pendapatanKasir']['labels']["detail"] : "detail";
   $tab_ger_campos['nokartu'] = "on";
   $tab_def_campos['nokartu'] = "noKartu";
   $tab_labels["nokartu"]   = (isset($_SESSION['sc_session'][$sc_init]['pendapatanKasir']['labels']["nokartu"])) ? $_SESSION['sc_session'][$sc_init]['pendapatanKasir']['labels']["nokartu"] : "No Kartu";
   $tab_ger_campos['instansipenjamin'] = "on";
   $tab_def_campos['instansipenjamin'] = "instansiPenjamin";
   $tab_labels["instansipenjamin"]   = (isset($_SESSION['sc_session'][$sc_init]['pendapatanKasir']['labels']["instansipenjamin"])) ? $_SESSION['sc_session'][$sc_init]['pendapatanKasir']['labels']["instansipenjamin"] : "Provider";
   $tab_ger_campos['nostruk'] = "on";
   $tab_def_campos['nostruk'] = "noStruk";
   $tab_labels["nostruk"]   = (isset($_SESSION['sc_session'][$sc_init]['pendapatanKasir']['labels']["nostruk"])) ? $_SESSION['sc_session'][$sc_init]['pendapatanKasir']['labels']["nostruk"] : "No Struk";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['pendapatanKasir']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['pendapatanKasir']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['pendapatanKasir']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['pendapatanKasir']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['pendapatanKasir']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['pendapatanKasir']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['pendapatanKasir']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['pendapatanKasir']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['pendapatanKasir']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "pendapatanKasir_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['pendapatanKasir']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['pendapatanKasir']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['pendapatanKasir']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['pendapatanKasir']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['pendapatanKasir']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
