<?php
@session_start() ;
$_SESSION['scriptcase']['pendapatanKasir']['sc_process_barr'] = true;
require_once('../pendapatanKasir/index.php');
unset($_SESSION['scriptcase']['pendapatanKasir']['sc_process_barr']);
$ExportCtrl = new pendapatanKasir_export_control;
$ExportCtrl->Export_barr();

class pendapatanKasir_export_control
{
