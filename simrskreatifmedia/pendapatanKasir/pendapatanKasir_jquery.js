...
function ajax_navigate(opc, parm)
{
    ...
    return new Promise(function(resolve, reject) {$.ajax({
     ...
     .done(function(jsonNavigate) {
        ...
        document.getElementById('nmsc_iframe_liga_A_pendapatanKasir').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_E_pendapatanKasir').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_D_pendapatanKasir').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_B_pendapatanKasir').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_A_pendapatanKasir').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_E_pendapatanKasir').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_D_pendapatanKasir').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_B_pendapatanKasir').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_A_pendapatanKasir').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_E_pendapatanKasir').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_D_pendapatanKasir').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_B_pendapatanKasir').style.width  = '0px';
        if (oResp["redirInfo"]) {
           nmAjaxRedir(oResp);
        }
        if (oResp["setValue"]) {
