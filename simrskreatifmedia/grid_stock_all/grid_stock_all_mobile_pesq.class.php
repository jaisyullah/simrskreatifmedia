...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "stok";$Nm_numeric[] = "stok";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_stok_cond" name="stok_cond" onChange="nm_campos_between(document.getElementById('id_vis_stok'), this, 'stok')">
      ...
      <br><span id="id_hide_stok"  <?php echo $str_hide_stok?>><INPUT  type="text" id="SC_stok" name="stok" value="<?php echo NM_encode_input($stok) ?>" size=23 alt="{datatype: 'integer', maxLength: 23, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
