<?php
@session_start() ;
$_SESSION['scriptcase']['grid_stock_all']['sc_process_barr'] = true;
require_once('../grid_stock_all/index.php');
unset($_SESSION['scriptcase']['grid_stock_all']['sc_process_barr']);
$ExportCtrl = new grid_stock_all_export_control;
$ExportCtrl->Export_barr();

class grid_stock_all_export_control
{
