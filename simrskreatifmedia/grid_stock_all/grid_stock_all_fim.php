...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_stock_all"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_stock_all"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_stock_all']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_stock_all']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_stock_all']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_stock_all']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_stock_all']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_stock_all']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_stock_all']['embutida_filho'] as $ind => $sc_init)
          {
