...
class grid_tbdetailok_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_tbdetailok_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_tbdetailok_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_tbdetailok_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $Nm_datas[] = "tranDate";$Nm_datas[] = "tranDate";$Nm_datas[] = "entryDate";$Nm_datas[] = "entryDate";$Nm_datas[] = "awalObs";$Nm_datas[] = "awalObs";$Nm_datas[] = "akhirObs";$Nm_datas[] = "akhirObs";
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_tbdetailok/grid_tbdetailok_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_tbdetailok_ajax_search.js"></script>
 <script type="text/javascript" src="grid_tbdetailok_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_tbdetailok_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_tbdetailok']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_tbdetailok']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<?php
   ...
   function monta_form()
   {
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $id = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['id']; 
          $id_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['id_cond']; 
          $trancode = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['trancode']; 
          $trancode_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['trancode_cond']; 
          $custcode = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['custcode']; 
          $custcode_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['custcode_cond']; 
          $pa = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['pa']; 
          $pa_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['pa_cond']; 
          $cito = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['cito']; 
          $cito_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['cito_cond']; 
          $vc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['vc']; 
          $vc_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['vc_cond']; 
          $cultur = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['cultur']; 
          $cultur_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['cultur_cond']; 
          $asa = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['asa']; 
          $asa_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['asa_cond']; 
          $diagpre = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['diagpre']; 
          $diagpre_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['diagpre_cond']; 
          $diagpost = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['diagpost']; 
          $diagpost_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['diagpost_cond']; 
          $trandate_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['trandate_dia']; 
          $trandate_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['trandate_mes']; 
          $trandate_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['trandate_ano']; 
          $trandate_hor = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['trandate_hor']; 
          $trandate_min = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['trandate_min']; 
          $trandate_seg = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['trandate_seg']; 
          $trandate_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['trandate_cond']; 
          $entrydate_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['entrydate_dia']; 
          $entrydate_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['entrydate_mes']; 
          $entrydate_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['entrydate_ano']; 
          $entrydate_hor = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['entrydate_hor']; 
          $entrydate_min = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['entrydate_min']; 
          $entrydate_seg = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['entrydate_seg']; 
          $entrydate_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['entrydate_cond']; 
          $class = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['class']; 
          $class_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['class_cond']; 
          $inapcode = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['inapcode']; 
          $inapcode_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['inapcode_cond']; 
          $awalobs_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['awalobs_dia']; 
          $awalobs_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['awalobs_mes']; 
          $awalobs_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['awalobs_ano']; 
          $awalobs_hor = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['awalobs_hor']; 
          $awalobs_min = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['awalobs_min']; 
          $awalobs_seg = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['awalobs_seg']; 
          $awalobs_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['awalobs_cond']; 
          $akhirobs_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['akhirobs_dia']; 
          $akhirobs_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['akhirobs_mes']; 
          $akhirobs_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['akhirobs_ano']; 
          $akhirobs_hor = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['akhirobs_hor']; 
          $akhirobs_min = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['akhirobs_min']; 
          $akhirobs_seg = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['akhirobs_seg']; 
          $akhirobs_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['akhirobs_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['NM_operador']; 
      } 
...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_id" name="id_autocomp" size="5"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 5, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_custcode" name="custcode_autocomp" size="8"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 8, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_pa_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['pa'])) ? $this->New_label['pa'] : "PA"; ?></TD>
...
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_pa" name="pa_autocomp" size="10"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 10, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_cito_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['cito'])) ? $this->New_label['cito'] : "Cito"; ?></TD>
...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_cito" name="cito_autocomp" size="15"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 15, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_vc_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['vc'])) ? $this->New_label['vc'] : "VC"; ?></TD>
...
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_vc" name="vc_autocomp" size="10"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 10, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_cultur_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['cultur'])) ? $this->New_label['cultur'] : "Cultur"; ?></TD>
...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_cultur" name="cultur_autocomp" size="10"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 10, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
?>
<?php
   if (is_file("grid_tbdetailok_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_tbdetailok']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_tbdetailok']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['orig_pesq'] == "grid")
   {
...
?>
 ...
 {
    $('#SC_akhirobs_dia').bind('change', function() {sc_grid_tbdetailok_valida_dia(this)});
    $('#SC_akhirobs_hor').bind('change', function() {sc_grid_tbdetailok_valida_hora(this)});
    $('#SC_akhirobs_mes').bind('change', function() {sc_grid_tbdetailok_valida_mes(this)});
    $('#SC_akhirobs_min').bind('change', function() {sc_grid_tbdetailok_valida_min(this)});
    $('#SC_akhirobs_seg').bind('change', function() {sc_grid_tbdetailok_valida_seg(this)});
    $('#SC_awalobs_dia').bind('change', function() {sc_grid_tbdetailok_valida_dia(this)});
    $('#SC_awalobs_hor').bind('change', function() {sc_grid_tbdetailok_valida_hora(this)});
    $('#SC_awalobs_mes').bind('change', function() {sc_grid_tbdetailok_valida_mes(this)});
    $('#SC_awalobs_min').bind('change', function() {sc_grid_tbdetailok_valida_min(this)});
    $('#SC_awalobs_seg').bind('change', function() {sc_grid_tbdetailok_valida_seg(this)});
    $('#SC_entrydate_dia').bind('change', function() {sc_grid_tbdetailok_valida_dia(this)});
    $('#SC_entrydate_hor').bind('change', function() {sc_grid_tbdetailok_valida_hora(this)});
    $('#SC_entrydate_mes').bind('change', function() {sc_grid_tbdetailok_valida_mes(this)});
    $('#SC_entrydate_min').bind('change', function() {sc_grid_tbdetailok_valida_min(this)});
    $('#SC_entrydate_seg').bind('change', function() {sc_grid_tbdetailok_valida_seg(this)});
    $('#SC_trandate_dia').bind('change', function() {sc_grid_tbdetailok_valida_dia(this)});
    $('#SC_trandate_hor').bind('change', function() {sc_grid_tbdetailok_valida_hora(this)});
    $('#SC_trandate_mes').bind('change', function() {sc_grid_tbdetailok_valida_mes(this)});
    $('#SC_trandate_min').bind('change', function() {sc_grid_tbdetailok_valida_min(this)});
    $('#SC_trandate_seg').bind('change', function() {sc_grid_tbdetailok_valida_seg(this)});
 }
 function sc_grid_tbdetailok_valida_dia(obj)
 {
 ...
 function sc_grid_tbdetailok_valida_mes(obj)
 {
 ...
 function sc_grid_tbdetailok_valida_hora(obj)
 {
 ...
 function sc_grid_tbdetailok_valida_min(obj)
 {
 ...
 function sc_grid_tbdetailok_valida_seg(obj)
 {
     if (obj.value != "" && (obj.value < 0 || obj.value > 59))
     {
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "simrskreatifmedia/grid_tbdetailok";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function trata_campos()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['id'] = $id; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['id_cond'] = $id_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['trancode'] = $trancode; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['trancode_cond'] = $trancode_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['custcode'] = $custcode; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['custcode_cond'] = $custcode_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['pa'] = $pa; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['pa_cond'] = $pa_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['cito'] = $cito; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['cito_cond'] = $cito_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['vc'] = $vc; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['vc_cond'] = $vc_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['cultur'] = $cultur; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['cultur_cond'] = $cultur_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['asa'] = $asa; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['asa_cond'] = $asa_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['diagpre'] = $diagpre; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['diagpre_cond'] = $diagpre_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['diagpost'] = $diagpost; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['diagpost_cond'] = $diagpost_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['trandate_dia'] = $trandate_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['trandate_mes'] = $trandate_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['trandate_ano'] = $trandate_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['trandate_hor'] = $trandate_hor; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['trandate_min'] = $trandate_min; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['trandate_seg'] = $trandate_seg; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['trandate_cond'] = $trandate_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['entrydate_dia'] = $entrydate_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['entrydate_mes'] = $entrydate_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['entrydate_ano'] = $entrydate_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['entrydate_hor'] = $entrydate_hor; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['entrydate_min'] = $entrydate_min; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['entrydate_seg'] = $entrydate_seg; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['entrydate_cond'] = $entrydate_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['class'] = $class; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['class_cond'] = $class_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['inapcode'] = $inapcode; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['inapcode_cond'] = $inapcode_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['awalobs_dia'] = $awalobs_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['awalobs_mes'] = $awalobs_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['awalobs_ano'] = $awalobs_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['awalobs_hor'] = $awalobs_hor; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['awalobs_min'] = $awalobs_min; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['awalobs_seg'] = $awalobs_seg; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['awalobs_cond'] = $awalobs_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['akhirobs_dia'] = $akhirobs_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['akhirobs_mes'] = $akhirobs_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['akhirobs_ano'] = $akhirobs_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['akhirobs_hor'] = $akhirobs_hor; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['akhirobs_min'] = $akhirobs_min; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['akhirobs_seg'] = $akhirobs_seg; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['akhirobs_cond'] = $akhirobs_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca'] = $Temp_Busca;
      }
   ...
   { 
      ...
      if ($trandate_cond != "bi_TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['trandate'] = $val[0];
          ...
          if ($trandate_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['trandate_input_2'] = $val[1];
      ...
      if ($entrydate_cond != "bi_TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['entrydate'] = $val[0];
          ...
          if ($entrydate_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['entrydate_input_2'] = $val[1];
      ...
      if ($awalobs_cond != "bi_TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['awalobs'] = $val[0];
          ...
          if ($awalobs_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['awalobs_input_2'] = $val[1];
      ...
      if ($akhirobs_cond != "bi_TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['akhirobs'] = $val[0];
          ...
          if ($akhirobs_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']['akhirobs_input_2'] = $val[1];
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailok']['cond_pesq'] .= $this->NM_operador;
