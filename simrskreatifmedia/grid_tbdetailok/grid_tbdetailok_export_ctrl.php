<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tbdetailok']['sc_process_barr'] = true;
require_once('../grid_tbdetailok/index.php');
unset($_SESSION['scriptcase']['grid_tbdetailok']['sc_process_barr']);
$ExportCtrl = new grid_tbdetailok_export_control;
$ExportCtrl->Export_barr();

class grid_tbdetailok_export_control
{
