...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "tglTran";$Nm_datas[] = "tglTran";$Nm_datas[] = "tglSetuju";$Nm_datas[] = "tglSetuju";$Nm_numeric[] = "id";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_pemohon_cond" name="pemohon_cond" onChange="nm_campos_between(document.getElementById('id_vis_pemohon'), this, 'pemohon')">
      ...
      <br><span id="id_hide_pemohon"  <?php echo $str_hide_pemohon?>><?php
      if ($pemohon != "")
      {
      $pemohon_look = substr($this->Db->qstr($pemohon), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_strukno_cond" name="strukno_cond" onChange="nm_campos_between(document.getElementById('id_vis_strukno'), this, 'strukno')">
      ...
      <br><span id="id_hide_strukno"  <?php echo $str_hide_strukno?>><?php
      if ($strukno != "")
      {
      $strukno_look = substr($this->Db->qstr($strukno), 1, -1); 
      $nmgp_def_dados = array(); 
