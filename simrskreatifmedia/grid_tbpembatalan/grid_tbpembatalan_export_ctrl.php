<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tbpembatalan']['sc_process_barr'] = true;
require_once('../grid_tbpembatalan/index.php');
unset($_SESSION['scriptcase']['grid_tbpembatalan']['sc_process_barr']);
$ExportCtrl = new grid_tbpembatalan_export_control;
$ExportCtrl->Export_barr();

class grid_tbpembatalan_export_control
{
