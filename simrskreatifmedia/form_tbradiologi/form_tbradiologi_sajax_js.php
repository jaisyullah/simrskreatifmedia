  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbradiologi" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbradiologi_form();
	}

  // ---------- Validate radcode
  function do_ajax_form_tbradiologi_validate_radcode()
  {
    var nomeCampo_radcode = "radcode";
    var var_radcode = scAjaxGetFieldText(nomeCampo_radcode);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbradiologi_validate_radcode(var_radcode, var_script_case_init, do_ajax_form_tbradiologi_validate_radcode_cb);
  } // do_ajax_form_tbradiologi_validate_radcode

  function do_ajax_form_tbradiologi_validate_radcode_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbradiologi_validate_radcode_cb

  // ---------- Validate nama
  function do_ajax_form_tbradiologi_validate_nama()
  {
    var nomeCampo_nama = "nama";
    var var_nama = scAjaxGetFieldText(nomeCampo_nama);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbradiologi_validate_nama(var_nama, var_script_case_init, do_ajax_form_tbradiologi_validate_nama_cb);
  } // do_ajax_form_tbradiologi_validate_nama

  function do_ajax_form_tbradiologi_validate_nama_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nama";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbradiologi_validate_nama_cb

  // ---------- Validate jenis
  function do_ajax_form_tbradiologi_validate_jenis()
  {
    var nomeCampo_jenis = "jenis";
    var var_jenis = scAjaxGetFieldSelect(nomeCampo_jenis);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbradiologi_validate_jenis(var_jenis, var_script_case_init, do_ajax_form_tbradiologi_validate_jenis_cb);
  } // do_ajax_form_tbradiologi_validate_jenis

  function do_ajax_form_tbradiologi_validate_jenis_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "jenis";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbradiologi_validate_jenis_cb

  // ---------- Validate kategori
  function do_ajax_form_tbradiologi_validate_kategori()
  {
  } // do_ajax_form_tbradiologi_validate_kategori

  function do_ajax_form_tbradiologi_validate_kategori_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbradiologi_validate_kategori_cb

  // ---------- Validate description
  function do_ajax_form_tbradiologi_validate_description()
  {
    var nomeCampo_description = "description";
    var var_description = scAjaxGetFieldText(nomeCampo_description);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbradiologi_validate_description(var_description, var_script_case_init, do_ajax_form_tbradiologi_validate_description_cb);
  } // do_ajax_form_tbradiologi_validate_description

  function do_ajax_form_tbradiologi_validate_description_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbradiologi_validate_description_cb

  // ---------- Validate harga
  function do_ajax_form_tbradiologi_validate_harga()
  {
    var nomeCampo_harga = "harga";
    var var_harga = scAjaxGetFieldText(nomeCampo_harga);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbradiologi_validate_harga(var_harga, var_script_case_init, do_ajax_form_tbradiologi_validate_harga_cb);
  } // do_ajax_form_tbradiologi_validate_harga

  function do_ajax_form_tbradiologi_validate_harga_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "harga";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbradiologi_validate_harga_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tbradiologi_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tbradiologi_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_tbradiologi_submit_form(var_radcode, var_nama, var_jenis, var_kategori, var_description, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbradiologi_submit_form_cb);
  } // do_ajax_form_tbradiologi_submit_form

  function do_ajax_form_tbradiologi_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tbradiologi_submit_form_cb_after_alert);
  } // do_ajax_form_tbradiologi_submit_form_cb
  function do_ajax_form_tbradiologi_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbradiologi_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_tbradiologirate"] = "off";

  function do_ajax_form_tbradiologi_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    scStatusDetail["form_tbradiologirate"] = "on";
    x_ajax_form_tbradiologi_navigate_form(var_radcode, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbradiologi_navigate_form_cb);
  } // do_ajax_form_tbradiologi_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbradiologi']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbradiologi_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_tbradiologirate"] && "nmsc_iframe_liga_form_tbradiologirate" != scMasterDetailIframe["nmsc_iframe_liga_form_tbradiologirate"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_tbradiologirate"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_tbradiologirate').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_tbradiologirate').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_tbradiologirate').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbradiologi_navigate_form_cb_after_alert);
  } // do_ajax_form_tbradiologi_navigate_form_cb
  function do_ajax_form_tbradiologi_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_tbradiologi_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_tbradiologi_navigate_form_cb_after_alert
  function sc_hide_form_tbradiologi_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_tbradiologirate"])
    {
      return true;
    }
    return false;
