  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbradiologi_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbradiologi_mob_form();
	}

  // ---------- Validate radcode
  function do_ajax_form_tbradiologi_mob_validate_radcode()
  {
    var nomeCampo_radcode = "radcode";
    var var_radcode = scAjaxGetFieldText(nomeCampo_radcode);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbradiologi_mob_validate_radcode(var_radcode, var_script_case_init, do_ajax_form_tbradiologi_mob_validate_radcode_cb);
  } // do_ajax_form_tbradiologi_mob_validate_radcode

  function do_ajax_form_tbradiologi_mob_validate_radcode_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbradiologi_mob_validate_radcode_cb

  // ---------- Validate nama
  function do_ajax_form_tbradiologi_mob_validate_nama()
  {
    var nomeCampo_nama = "nama";
    var var_nama = scAjaxGetFieldText(nomeCampo_nama);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbradiologi_mob_validate_nama(var_nama, var_script_case_init, do_ajax_form_tbradiologi_mob_validate_nama_cb);
  } // do_ajax_form_tbradiologi_mob_validate_nama

  function do_ajax_form_tbradiologi_mob_validate_nama_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nama";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbradiologi_mob_validate_nama_cb

  // ---------- Validate jenis
  function do_ajax_form_tbradiologi_mob_validate_jenis()
  {
    var nomeCampo_jenis = "jenis";
    var var_jenis = scAjaxGetFieldSelect(nomeCampo_jenis);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbradiologi_mob_validate_jenis(var_jenis, var_script_case_init, do_ajax_form_tbradiologi_mob_validate_jenis_cb);
  } // do_ajax_form_tbradiologi_mob_validate_jenis

  function do_ajax_form_tbradiologi_mob_validate_jenis_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "jenis";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbradiologi_mob_validate_jenis_cb

  // ---------- Validate kategori
  function do_ajax_form_tbradiologi_mob_validate_kategori()
  {
  } // do_ajax_form_tbradiologi_mob_validate_kategori

  function do_ajax_form_tbradiologi_mob_validate_kategori_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbradiologi_mob_validate_kategori_cb

  // ---------- Validate description
  function do_ajax_form_tbradiologi_mob_validate_description()
  {
    var nomeCampo_description = "description";
    var var_description = scAjaxGetFieldText(nomeCampo_description);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbradiologi_mob_validate_description(var_description, var_script_case_init, do_ajax_form_tbradiologi_mob_validate_description_cb);
  } // do_ajax_form_tbradiologi_mob_validate_description

  function do_ajax_form_tbradiologi_mob_validate_description_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbradiologi_mob_validate_description_cb

  // ---------- Validate harga
  function do_ajax_form_tbradiologi_mob_validate_harga()
  {
    var nomeCampo_harga = "harga";
    var var_harga = scAjaxGetFieldText(nomeCampo_harga);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbradiologi_mob_validate_harga(var_harga, var_script_case_init, do_ajax_form_tbradiologi_mob_validate_harga_cb);
  } // do_ajax_form_tbradiologi_mob_validate_harga

  function do_ajax_form_tbradiologi_mob_validate_harga_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "harga";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbradiologi_mob_validate_harga_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tbradiologi_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tbradiologi_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_tbradiologi_mob_submit_form(var_radcode, var_nama, var_jenis, var_kategori, var_description, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbradiologi_mob_submit_form_cb);
  } // do_ajax_form_tbradiologi_mob_submit_form

  function do_ajax_form_tbradiologi_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tbradiologi_mob_submit_form_cb_after_alert);
  } // do_ajax_form_tbradiologi_mob_submit_form_cb
  function do_ajax_form_tbradiologi_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbradiologi_mob_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_tbradiologirate_mob"] = "off";

  function do_ajax_form_tbradiologi_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("description");
    scAjaxHideErrorDisplay("harga");
    var var_radcode = document.F2.radcode.value;
    ...
    scAjaxProcOn();
    scStatusDetail["form_tbradiologirate_mob"] = "on";
    x_ajax_form_tbradiologi_mob_navigate_form(var_radcode, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbradiologi_mob_navigate_form_cb);
  } // do_ajax_form_tbradiologi_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbradiologi_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbradiologi_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.radcode.value = scAjaxGetKeyValue("radcode");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_tbradiologirate_mob"] && "nmsc_iframe_liga_form_tbradiologirate_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_tbradiologirate_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_tbradiologirate_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_tbradiologirate_mob').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_tbradiologirate_mob').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_tbradiologirate_mob').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbradiologi_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_tbradiologi_mob_navigate_form_cb
  function do_ajax_form_tbradiologi_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_tbradiologi_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_tbradiologi_mob_navigate_form_cb_after_alert
  function sc_hide_form_tbradiologi_mob_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_tbradiologirate_mob"])
    {
      return true;
    }
    return false;
  ...
  var ajax_error_list = {
    "radcode": {"label": "Kode Radiologi", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "nama": {"label": "Nama Pemeriksaan", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "description": {"label": "Deskripsi", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "harga": {"label": "", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  ajax_field_mult["harga"][1] = "harga";

  var ajax_field_id = {
    "radcode": new Array("hidden_field_label_radcode", "hidden_field_data_radcode"),
    ...
    "harga": new Array("hidden_field_label_harga", "hidden_field_data_harga")
  };
