<?php
@session_start() ;
$_SESSION['scriptcase']['grid_hisdetailrawatjalan']['sc_process_barr'] = true;
require_once('../grid_hisdetailrawatjalan/index.php');
unset($_SESSION['scriptcase']['grid_hisdetailrawatjalan']['sc_process_barr']);
$ExportCtrl = new grid_hisdetailrawatjalan_export_control;
$ExportCtrl->Export_barr();

class grid_hisdetailrawatjalan_export_control
{
