...
class grid_hisdetailrawatjalan_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   { 
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['grid_hisdetailrawatjalan']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['grid_hisdetailrawatjalan']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['where_resumo']);
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['proc_res'] = true;
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['res_hrz'];
      $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
      $dir_raiz          = substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['where_resumo'] = "";
      }
      $this->inicializa_vars();
      $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['SC_Ind_Groupby'];
      $this->Total->$Gb_geral();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['contr_total_geral'] == "OK")
      {
          $this->array_total_dokter = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['arr_total']['dokter'];
      }
      else
      {
          $this->array_total_dokter = array();
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['tot_geral'][1] == 0)
      {
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          $this->drawMatrix();
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['arr_total']['dokter'] = $this->array_total_dokter;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['json_use_label'])
       {
          $Lab_dokter = "dokter";
       }
       else
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['labels']['trancode']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['labels']['trancode'] = "Kode Transaksi"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['labels']['custcode']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['labels']['custcode'] = "No RM"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['labels']['sc_field_0']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['labels']['sc_field_0'] = "Nama Pasien"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['labels']['dokter']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['labels']['dokter'] = "Dokter"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['labels']['selesai']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['labels']['selesai'] = "Selesai"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['labels']['tgldaftar']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['labels']['tgldaftar'] = "Tgl Daftar"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['labels']['tglkeluar']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['labels']['tglkeluar'] = "Tgl Keluar"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['labels']['diagnosa1']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['labels']['diagnosa1'] = "Diagnosa"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['labels']['icd1']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['labels']['icd1'] = "Kode ICD"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['labels']['nostruk']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['labels']['nostruk'] = "No Struk"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['labels']['statuspasien']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['labels']['statuspasien'] = "Status Pasien"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['labels']['umur']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['labels']['umur'] = "Umur"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['labels']['id']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['labels']['id'] = "Id"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['labels']['carakeluar']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['labels']['carakeluar'] = "Cara Keluar"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['labels']['alasankeluar']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['labels']['alasankeluar'] = "Alasan Keluar"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['labels']['resikojatuh']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['labels']['resikojatuh'] = "Resiko Jatuh"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['labels']['diagnosa2']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['labels']['diagnosa2'] = "Diagnosa 2"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['labels']['icd2']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['labels']['icd2'] = "Icd 2"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['labels']['poli']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['labels']['poli'] = "Poli"; 
       }
       //-----
       $this->comp_field_nm = array(
           'dokter' => 0,
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['summarizing_fields_order']['byDokter']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['summarizing_fields_order']['byDokter'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['summarizing_fields_order']['byDokter'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['summarizing_fields_display']['byDokter'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['summarizing_fields_display']['byDokter'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['summarizing_fields_display']['byDokter'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['summarizing_fields_display']['byDokter'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['summarizing_fields_display']['byDokter'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['summarizing_fields_display']['byDokter'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['summarizing_fields_display']['byDokter'] as $i_sum => $d_sum)
           {
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['pivot_order_level'] = -1;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['pivot_tabular_label'];
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_hisdetailrawatjalan@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function buildChart()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['pivot_charts']    = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['pivot_orig']      = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['comb_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['comb_table_def']  = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['anlt_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['anlt_table_def']  = array();
	...
	function filterChartsByGroupbyLevel() {
		...
		if (isset($nmgp_opcao) && ('pdf' == $nmgp_opcao || 'pdf_res' == $nmgp_opcao) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['chart_level']) && '' !== $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['chart_level']) {
			$applyFilter = true;
		}
		elseif (isset($nmgp_opcao) && 'image_res' == $nmgp_opcao && isset($_POST['chart_level']) && '' !== $_POST['chart_level']) {
			$applyFilter = true;
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['chart_level'] = $_POST['chart_level'];
		}
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['pivot_charts'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['pivot_orig'];

		if ($applyFilter) {
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['pivot_charts'] as $chartIndex => $chartData) {
				...
				if ($groupbyLevel > $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['chart_level']) {
					unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['pivot_charts'][$chartIndex]);
				}
			}
		}

		$this->comp_chart_data = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['pivot_charts'];
	}
           ...
           foreach ($a_totals as $i_total => $values)
           {
               ...
               if (isset($this->comp_chart_config[$key_config]))
               {
                   ...
                   foreach ($a_keys as $tmp_key)
                   {
                       ...
                       $xml_links[]  = $this->getFusionLink('sc_grid_hisdetailrawatjalan_' . session_id() . '_!!!' . implode('_', array_merge(array($group + 1, $i_total), $link_index)) . '!!!.json');
                   }
                   ...
                   $this->comp_chart_data[$key_data]['xml']        = $this->getFusionLink('sc_grid_hisdetailrawatjalan_' . session_id() . '_!!!' . implode('_', array_merge(array($group, $i_total), $param)) . '!!!.json');
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['proc_pdf_vert']){ 
   ...
   {
       if (!$res_chart && $this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['json_use_format']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['json_use_format'])
       {
           return $valor_campo;
       }
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         $this->monta_html_ini();
         $this->monta_cabecalho();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function inicializa_vars()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         require_once($this->Ini->path_aplicacao . "grid_hisdetailrawatjalan_total.class.php"); 
      }
      ...
      $this->Total   = new grid_hisdetailrawatjalan_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['arr_total'][$cmp_gb];
      }
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['dashboard_refresh_after_chart'] = 'resumo';
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['doc_word'])
{
   ...
   { 
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_hisdetailrawatjalan_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grid_hisdetailrawatjalan_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_hisdetailrawatjalan_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['num_css'] . '.css');
...
$nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_hisdetailrawatjalan/grid_hisdetailrawatjalan_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\">\r\n");
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['doc_word']) 
      {
      ...
      {
          $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['dashboard_info']['remove_margin'] ? ' style="margin: 0"' : '';
          $nm_saida->saida(" <BODY class=\"" . $this->css_scGridPage . "\"" . $remove_margin . ">\r\n");
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['embutida'])
      {
   ...
   function monta_barra_top_normal()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_hisdetailrawatjalan/grid_hisdetailrawatjalan_config_print.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=N&nm_opc=resumo&nm_cor=PB&nm_res_cons=s&nm_ini_prt_res=resume&nm_all_modules=grid,resume,chart&password=n&origem=res&language=id&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if ($this->nmgp_botoes['chart_detail'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("grid_hisdetailrawatjalan_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
   ...
   function monta_html_fim()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['print_all'])
      {
          $this->grafico_pdf();
      }
      $nm_saida->saida("</TABLE>\r\n");
      $nm_saida->saida("<link rel=\"stylesheet\" type=\"text/css\" href=\"../_lib/css/" . $this->Ini->str_schema_all . "_sweetalert.css\" />\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_hisdetailrawatjalan']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_hisdetailrawatjalan']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'grid_hisdetailrawatjalan_config_pivot.php?nome_apl=grid_hisdetailrawatjalan&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=id&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_hisdetailrawatjalan_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "grid_hisdetailrawatjalan/grid_hisdetailrawatjalan_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
...
//--- 
   ...
   {
      global $nm_saida;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_hisdetailrawatjalan']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
