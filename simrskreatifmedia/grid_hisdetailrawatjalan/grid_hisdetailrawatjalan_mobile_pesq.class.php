...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "a.tglKeluar";$Nm_datas[] = "a_tglKeluar";$Nm_datas[] = "b.regDate";$Nm_datas[] = "b_regDate";$Nm_numeric[] = "a_id";$Nm_numeric[] = "a_nostruk";$Nm_numeric[] = "a_resikojatuh";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_tgldaftar"  <?php echo $str_hide_tgldaftar?>>
<?php
  $Form_base = "ddmmyyyy";
  $date_format_show = "";
...
?>
          ...
          <BR>
        <SPAN id="id_vis_tgldaftar"  <?php echo $str_display_tgldaftar; ?> class="scFilterFieldFontOdd">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_poli"  <?php echo $str_hide_poli?>>
<?php
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_statuspasien"  <?php echo $str_hide_statuspasien?>> 
<?php
