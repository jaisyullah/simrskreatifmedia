...
<?php
   ...
   $Ord_Cmp = new grid_his_tbpembatalan_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_his_tbpembatalan_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_his_tbpembatalan']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_his_tbpembatalan']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_his_tbpembatalan']['labels']["id"])) ? $_SESSION['sc_session'][$sc_init]['grid_his_tbpembatalan']['labels']["id"] : "ID";
   $tab_ger_campos['trancode'] = "on";
   $tab_def_campos['trancode'] = "tranCode";
   $tab_labels["trancode"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_his_tbpembatalan']['labels']["trancode"])) ? $_SESSION['sc_session'][$sc_init]['grid_his_tbpembatalan']['labels']["trancode"] : "Tran Code";
   $tab_ger_campos['strukno'] = "on";
   $tab_def_campos['strukno'] = "strukNo";
   $tab_labels["strukno"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_his_tbpembatalan']['labels']["strukno"])) ? $_SESSION['sc_session'][$sc_init]['grid_his_tbpembatalan']['labels']["strukno"] : "Struk No";
   $tab_ger_campos['pemohon'] = "on";
   $tab_def_campos['pemohon'] = "pemohon";
   $tab_labels["pemohon"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_his_tbpembatalan']['labels']["pemohon"])) ? $_SESSION['sc_session'][$sc_init]['grid_his_tbpembatalan']['labels']["pemohon"] : "Pemohon";
   $tab_ger_campos['jenis'] = "on";
   $tab_def_campos['jenis'] = "jenis";
   $tab_labels["jenis"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_his_tbpembatalan']['labels']["jenis"])) ? $_SESSION['sc_session'][$sc_init]['grid_his_tbpembatalan']['labels']["jenis"] : "Jenis";
   $tab_ger_campos['alasan'] = "on";
   $tab_def_campos['alasan'] = "alasan";
   $tab_labels["alasan"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_his_tbpembatalan']['labels']["alasan"])) ? $_SESSION['sc_session'][$sc_init]['grid_his_tbpembatalan']['labels']["alasan"] : "Alasan";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_his_tbpembatalan']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_his_tbpembatalan']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_his_tbpembatalan']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_his_tbpembatalan']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_his_tbpembatalan']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_his_tbpembatalan']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_his_tbpembatalan']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_his_tbpembatalan']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_his_tbpembatalan']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_his_tbpembatalan_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_his_tbpembatalan']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_his_tbpembatalan']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_his_tbpembatalan']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_his_tbpembatalan']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_his_tbpembatalan']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
