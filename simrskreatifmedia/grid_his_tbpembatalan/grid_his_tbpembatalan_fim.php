...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_his_tbpembatalan"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_his_tbpembatalan"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_tbpembatalan'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_his_tbpembatalan']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_his_tbpembatalan']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_his_tbpembatalan']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_his_tbpembatalan']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_his_tbpembatalan']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_his_tbpembatalan</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_his_tbpembatalan']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_his_tbpembatalan']['embutida_filho'] as $ind => $sc_init)
          {
