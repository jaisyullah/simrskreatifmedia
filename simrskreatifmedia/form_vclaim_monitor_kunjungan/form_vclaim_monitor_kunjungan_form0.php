...
.sc-button-image.disabled img {
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_monitor_kunjungan']['embutida_pdf']))
 {
 ?>
...
<?php
include_once("form_vclaim_monitor_kunjungan_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_vclaim_monitor_kunjungan_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_monitor_kunjungan']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_monitor_kunjungan']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_monitor_kunjungan']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_monitor_kunjungan']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_monitor_kunjungan']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_monitor_kunjungan']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_monitor_kunjungan']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_monitor_kunjungan']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
?>
...
<?php
 include_once("form_vclaim_monitor_kunjungan_js0.php");
?>
<script type="text/javascript"> 
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_vclaim_monitor_kunjungan'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_vclaim_monitor_kunjungan'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_monitor_kunjungan']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_monitor_kunjungan']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_monitor_kunjungan']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_monitor_kunjungan']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_monitor_kunjungan']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<?php
  ...
  {
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_monitor_kunjungan']['where_filter']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_monitor_kunjungan']['empty_filter'] = true;
       }
  }
?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_monitor_kunjungan']['Lookup_jnspelayanan'][] = '1'; ?>
 <option  value="2" <?php  if ($this->jnspelayanan == "2") { echo " selected" ;} ?>>Rawat Jalan</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_monitor_kunjungan']['Lookup_jnspelayanan'][] = '2'; ?>
 </select></span>
</span><?php  }?>
</TD>
   <?php }?>
...
<?php
           if (($nm_apl_dependente != 1) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_monitor_kunjungan']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_monitor_kunjungan']['dashboard_info']['under_dashboard'])) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_monitor_kunjungan']['nm_run_menu']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_monitor_kunjungan']['nm_run_menu'] != 1))) {
...
<?php
           if (($nm_apl_dependente == 1) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_monitor_kunjungan']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_monitor_kunjungan']['dashboard_info']['under_dashboard']))) {
        $sCondStyle = ($this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_monitor_kunjungan']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_monitor_kunjungan']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_vclaim_monitor_kunjungan");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_vclaim_monitor_kunjungan");
 parent.scAjaxDetailHeight("form_vclaim_monitor_kunjungan", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_monitor_kunjungan']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
