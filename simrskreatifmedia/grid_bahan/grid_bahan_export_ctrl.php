<?php
@session_start() ;
$_SESSION['scriptcase']['grid_bahan']['sc_process_barr'] = true;
require_once('../grid_bahan/index.php');
unset($_SESSION['scriptcase']['grid_bahan']['sc_process_barr']);
$ExportCtrl = new grid_bahan_export_control;
$ExportCtrl->Export_barr();

class grid_bahan_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - bahan :: Excel</TITLE>
