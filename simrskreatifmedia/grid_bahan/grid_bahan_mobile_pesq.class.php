...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_bahancode_cond" name="bahancode_cond" onChange="nm_campos_between(document.getElementById('id_vis_bahancode'), this, 'bahancode')">
      ...
      <br><span id="id_hide_bahancode"  <?php echo $str_hide_bahancode?>><?php
      if ($bahancode != "")
      {
      $bahancode_look = substr($this->Db->qstr($bahancode), 1, -1); 
      $nmgp_def_dados = array(); 
