...
?>
          ...
          <BR>
        <SPAN id="id_vis_intime"  <?php echo $str_display_intime; ?> class="scFilterFieldFontOdd">
...
<span id='id_date_part_outtime_DD' style='display: inline-block'>
         ...
         <SELECT class="scFilterObjectEven" id="SC_outtime_dia" name="outtime_dia">
          <OPTION value=""></OPTION>
...
<span id='id_date_part_outtime_MM' style='display: inline-block'>
         ...
         <SELECT class="scFilterObjectEven" id="SC_outtime_mes" name="outtime_mes">
          <OPTION value=""></OPTION>
...
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_outtime_ano" name="outtime_ano" value="<?php echo NM_encode_input($outtime_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
...
?>
          ...
          <BR>
        <SPAN id="id_vis_outtime"  <?php echo $str_display_outtime; ?> class="scFilterFieldFontEven">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <?php
...
<span id='id_date_part_outtime_input_2_DD' style='display: inline-block'>
         ...
         <SELECT class="scFilterObjectEven" id="SC_outtime_input_2_dia" name="outtime_input_2_dia">
          <OPTION value=""></OPTION>
...
<span id='id_date_part_outtime_input_2_MM' style='display: inline-block'>
         ...
         <SELECT class="scFilterObjectEven" id="SC_outtime_input_2_mes" name="outtime_input_2_mes">
          <OPTION value=""></OPTION>
...
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_outtime_input_2_ano" name="outtime_input_2_ano" value="<?php echo NM_encode_input($outtime_input_2_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
