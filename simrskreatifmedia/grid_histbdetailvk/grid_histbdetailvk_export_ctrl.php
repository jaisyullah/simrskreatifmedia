<?php
@session_start() ;
$_SESSION['scriptcase']['grid_histbdetailvk']['sc_process_barr'] = true;
require_once('../grid_histbdetailvk/index.php');
unset($_SESSION['scriptcase']['grid_histbdetailvk']['sc_process_barr']);
$ExportCtrl = new grid_histbdetailvk_export_control;
$ExportCtrl->Export_barr();

class grid_histbdetailvk_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - Kamar Bersalin :: Excel</TITLE>
