...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_tglretur_hora' + iSeqRow).bind('blur', function() { sc_form_tbreturlog_tglretur_onblur(this, iSeqRow) })
                                           .bind('focus', function() { sc_form_tbreturlog_tglretur_onfocus(this, iSeqRow) });
...
function displayChange_field_detailr(row, status) {
	if ("on" == status && typeof $("#nmsc_iframe_liga_form_tbdetailreturlog_mob")[0].contentWindow.scRecreateSelect2 === "function") {
		$("#nmsc_iframe_liga_form_tbdetailreturlog_mob")[0].contentWindow.scRecreateSelect2();
	}
}
...
function scHidePage(pageNo) {
	$("#id_form_tbreturlog_mob_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_tglretur" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_tbreturlog_mob_validate_tglretur(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
