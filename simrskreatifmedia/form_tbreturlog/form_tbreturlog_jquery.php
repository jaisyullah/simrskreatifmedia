...
function scEventControl_init(iSeqRow) {
  ...
  scEventControl_data["detailr" + iSeqRow] = {"blur": false, "change": false, "autocomp": false, "original": "", "calculated": ""};
}
...
function scEventControl_active(iSeqRow) {
  ...
  if (scEventControl_data["detailr" + iSeqRow]["blur"]) {
    return true;
  }
  if (scEventControl_data["detailr" + iSeqRow]["change"]) {
    return true;
  }
  return false;
...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_koderetur' + iSeqRow).bind('blur', function() { sc_form_tbreturlog_koderetur_onblur(this, iSeqRow) })
                                       .bind('focus', function() { sc_form_tbreturlog_koderetur_onfocus(this, iSeqRow) });
  $('#id_sc_field_tglretur' + iSeqRow).bind('blur', function() { sc_form_tbreturlog_tglretur_onblur(this, iSeqRow) })
                                      .bind('focus', function() { sc_form_tbreturlog_tglretur_onfocus(this, iSeqRow) });
  $('#id_sc_field_tglretur_hora' + iSeqRow).bind('blur', function() { sc_form_tbreturlog_tglretur_hora_onblur(this, iSeqRow) })
                                           .bind('focus', function() { sc_form_tbreturlog_tglretur_hora_onfocus(this, iSeqRow) });
  $('#id_sc_field_supplier' + iSeqRow).bind('blur', function() { sc_form_tbreturlog_supplier_onblur(this, iSeqRow) })
                                      .bind('focus', function() { sc_form_tbreturlog_supplier_onfocus(this, iSeqRow) });
  $('#id_sc_field_selesai' + iSeqRow).bind('blur', function() { sc_form_tbreturlog_selesai_onblur(this, iSeqRow) })
                                     .bind('focus', function() { sc_form_tbreturlog_selesai_onfocus(this, iSeqRow) });
  $('#id_sc_field_detailr' + iSeqRow).bind('blur', function() { sc_form_tbreturlog_detailr_onblur(this, iSeqRow) })
                                     .bind('focus', function() { sc_form_tbreturlog_detailr_onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_form_tbreturlog_koderetur_onblur(oThis, iSeqRow) {
  do_ajax_form_tbreturlog_validate_koderetur();
  scCssBlur(oThis);
}

function sc_form_tbreturlog_koderetur_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_tbreturlog_tglretur_onblur(oThis, iSeqRow) {
  do_ajax_form_tbreturlog_validate_tglretur();
  scCssBlur(oThis);
}

function sc_form_tbreturlog_tglretur_hora_onblur(oThis, iSeqRow) {
  do_ajax_form_tbreturlog_validate_tglretur();
  scCssBlur(oThis);
}

function sc_form_tbreturlog_tglretur_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_tbreturlog_tglretur_hora_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_tbreturlog_supplier_onblur(oThis, iSeqRow) {
  do_ajax_form_tbreturlog_validate_supplier();
  scCssBlur(oThis);
}

function sc_form_tbreturlog_supplier_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_tbreturlog_selesai_onblur(oThis, iSeqRow) {
  do_ajax_form_tbreturlog_validate_selesai();
  scCssBlur(oThis);
}

function sc_form_tbreturlog_selesai_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_tbreturlog_detailr_onblur(oThis, iSeqRow) {
  do_ajax_form_tbreturlog_validate_detailr();
  scCssBlur(oThis);
}

function sc_form_tbreturlog_detailr_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function displayChange_block_1(status) {
	displayChange_field("detailr", "", status);
}
...
function displayChange_row(row, status) {
	...
	displayChange_field_detailr(row, status);
}
...
function displayChange_field_detailr(row, status) {
	if ("on" == status && typeof $("#nmsc_iframe_liga_form_tbdetailreturlog")[0].contentWindow.scRecreateSelect2 === "function") {
		$("#nmsc_iframe_liga_form_tbdetailreturlog")[0].contentWindow.scRecreateSelect2();
	}
}
...
function scHidePage(pageNo) {
	$("#id_form_tbreturlog_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_tglretur" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_tbreturlog_validate_tglretur(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
