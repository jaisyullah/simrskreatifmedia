  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbreturlog_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbreturlog_mob_form();
	}

  // ---------- Validate koderetur
  function do_ajax_form_tbreturlog_mob_validate_koderetur()
  {
    var nomeCampo_koderetur = "koderetur";
    var var_koderetur = scAjaxGetFieldText(nomeCampo_koderetur);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbreturlog_mob_validate_koderetur(var_koderetur, var_script_case_init, do_ajax_form_tbreturlog_mob_validate_koderetur_cb);
  } // do_ajax_form_tbreturlog_mob_validate_koderetur

  function do_ajax_form_tbreturlog_mob_validate_koderetur_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbreturlog_mob_validate_koderetur_cb

  // ---------- Validate tglretur
  function do_ajax_form_tbreturlog_mob_validate_tglretur()
  {
    var nomeCampo_tglretur = "tglretur";
    var var_tglretur = scAjaxGetFieldText(nomeCampo_tglretur);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbreturlog_mob_validate_tglretur(var_tglretur, var_script_case_init, do_ajax_form_tbreturlog_mob_validate_tglretur_cb);
  } // do_ajax_form_tbreturlog_mob_validate_tglretur

  function do_ajax_form_tbreturlog_mob_validate_tglretur_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbreturlog_mob_validate_tglretur_cb

  // ---------- Validate supplier
  function do_ajax_form_tbreturlog_mob_validate_supplier()
  {
    var nomeCampo_supplier = "supplier";
    var var_supplier = scAjaxGetFieldSelect(nomeCampo_supplier);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbreturlog_mob_validate_supplier(var_supplier, var_script_case_init, do_ajax_form_tbreturlog_mob_validate_supplier_cb);
  } // do_ajax_form_tbreturlog_mob_validate_supplier

  function do_ajax_form_tbreturlog_mob_validate_supplier_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "supplier";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbreturlog_mob_validate_supplier_cb

  // ---------- Validate selesai
  function do_ajax_form_tbreturlog_mob_validate_selesai()
  {
    var nomeCampo_selesai = "selesai";
    var var_selesai = scAjaxGetFieldSelect(nomeCampo_selesai);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbreturlog_mob_validate_selesai(var_selesai, var_script_case_init, do_ajax_form_tbreturlog_mob_validate_selesai_cb);
  } // do_ajax_form_tbreturlog_mob_validate_selesai

  function do_ajax_form_tbreturlog_mob_validate_selesai_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "selesai";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbreturlog_mob_validate_selesai_cb

  // ---------- Validate detailr
  function do_ajax_form_tbreturlog_mob_validate_detailr()
  {
    var nomeCampo_detailr = "detailr";
    var var_detailr = scAjaxGetFieldText(nomeCampo_detailr);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbreturlog_mob_validate_detailr(var_detailr, var_script_case_init, do_ajax_form_tbreturlog_mob_validate_detailr_cb);
  } // do_ajax_form_tbreturlog_mob_validate_detailr

  function do_ajax_form_tbreturlog_mob_validate_detailr_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "detailr";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbreturlog_mob_validate_detailr_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tbreturlog_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tbreturlog_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_koderetur = scAjaxGetFieldText("koderetur");
    var var_tglretur = scAjaxGetFieldText("tglretur");
    var var_supplier = scAjaxGetFieldSelect("supplier");
    ...
    scAjaxProcOn();
    x_ajax_form_tbreturlog_mob_submit_form(var_koderetur, var_tglretur, var_supplier, var_selesai, var_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbreturlog_mob_submit_form_cb);
  } // do_ajax_form_tbreturlog_mob_submit_form

  function do_ajax_form_tbreturlog_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("supplier");
      scAjaxHideErrorDisplay("selesai");
      scAjaxHideErrorDisplay("detailr");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tbreturlog_mob_submit_form_cb_after_alert);
  } // do_ajax_form_tbreturlog_mob_submit_form_cb
  function do_ajax_form_tbreturlog_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbreturlog_mob_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_tbdetailreturlog_mob"] = "off";

  function do_ajax_form_tbreturlog_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    scStatusDetail["form_tbdetailreturlog_mob"] = "on";
    x_ajax_form_tbreturlog_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbreturlog_mob_navigate_form_cb);
  } // do_ajax_form_tbreturlog_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreturlog_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbreturlog_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_tbdetailreturlog_mob"] && "nmsc_iframe_liga_form_tbdetailreturlog_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_tbdetailreturlog_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_tbdetailreturlog_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_tbdetailreturlog_mob').contentWindow.nm_move('apl_detalhe', true, '600');
        document.getElementById('nmsc_iframe_liga_form_tbdetailreturlog_mob').style.height = "600";
        document.getElementById('nmsc_iframe_liga_form_tbdetailreturlog_mob').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbreturlog_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_tbreturlog_mob_navigate_form_cb
  function do_ajax_form_tbreturlog_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_tbreturlog_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_tbreturlog_mob_navigate_form_cb_after_alert
  function sc_hide_form_tbreturlog_mob_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_tbdetailreturlog_mob"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[0] = "koderetur";
  ajax_field_list[1] = "tglretur";
  ajax_field_list[2] = "supplier";
  ajax_field_list[3] = "selesai";
  ajax_field_list[4] = "detailr";
  ...
  var ajax_error_list = {
    ...
    "supplier": {"label": "Supplier", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "selesai": {"label": "Selesai", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "detailr": {"label": "", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  ajax_field_mult["supplier"][1] = "supplier";
  ajax_field_mult["selesai"][1] = "selesai";
  ajax_field_mult["detailr"][1] = "detailr";
  ...
  var ajax_field_id = {
    ...
    "supplier": new Array("hidden_field_label_supplier", "hidden_field_data_supplier"),
    "selesai": new Array("hidden_field_label_selesai", "hidden_field_data_selesai"),
    "detailr": new Array("hidden_field_label_detailr", "hidden_field_data_detailr")
  };
