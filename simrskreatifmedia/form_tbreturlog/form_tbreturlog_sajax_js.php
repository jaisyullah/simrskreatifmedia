  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbreturlog" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbreturlog_form();
	}

  // ---------- Validate koderetur
  function do_ajax_form_tbreturlog_validate_koderetur()
  {
    var nomeCampo_koderetur = "koderetur";
    var var_koderetur = scAjaxGetFieldText(nomeCampo_koderetur);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbreturlog_validate_koderetur(var_koderetur, var_script_case_init, do_ajax_form_tbreturlog_validate_koderetur_cb);
  } // do_ajax_form_tbreturlog_validate_koderetur

  function do_ajax_form_tbreturlog_validate_koderetur_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbreturlog_validate_koderetur_cb

  // ---------- Validate tglretur
  function do_ajax_form_tbreturlog_validate_tglretur()
  {
    var nomeCampo_tglretur = "tglretur";
    var var_tglretur = scAjaxGetFieldText(nomeCampo_tglretur);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbreturlog_validate_tglretur(var_tglretur, var_script_case_init, do_ajax_form_tbreturlog_validate_tglretur_cb);
  } // do_ajax_form_tbreturlog_validate_tglretur

  function do_ajax_form_tbreturlog_validate_tglretur_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbreturlog_validate_tglretur_cb

  // ---------- Validate supplier
  function do_ajax_form_tbreturlog_validate_supplier()
  {
    var nomeCampo_supplier = "supplier";
    var var_supplier = scAjaxGetFieldSelect(nomeCampo_supplier);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbreturlog_validate_supplier(var_supplier, var_script_case_init, do_ajax_form_tbreturlog_validate_supplier_cb);
  } // do_ajax_form_tbreturlog_validate_supplier

  function do_ajax_form_tbreturlog_validate_supplier_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbreturlog_validate_supplier_cb

  // ---------- Validate selesai
  function do_ajax_form_tbreturlog_validate_selesai()
  {
    var nomeCampo_selesai = "selesai";
    var var_selesai = scAjaxGetFieldSelect(nomeCampo_selesai);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbreturlog_validate_selesai(var_selesai, var_script_case_init, do_ajax_form_tbreturlog_validate_selesai_cb);
  } // do_ajax_form_tbreturlog_validate_selesai

  function do_ajax_form_tbreturlog_validate_selesai_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "selesai";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbreturlog_validate_selesai_cb

  // ---------- Validate detailr
  function do_ajax_form_tbreturlog_validate_detailr()
  {
    var nomeCampo_detailr = "detailr";
    var var_detailr = scAjaxGetFieldText(nomeCampo_detailr);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbreturlog_validate_detailr(var_detailr, var_script_case_init, do_ajax_form_tbreturlog_validate_detailr_cb);
  } // do_ajax_form_tbreturlog_validate_detailr

  function do_ajax_form_tbreturlog_validate_detailr_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "detailr";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbreturlog_validate_detailr_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tbreturlog_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tbreturlog_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_tbreturlog_submit_form(var_koderetur, var_tglretur, var_supplier, var_selesai, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbreturlog_submit_form_cb);
  } // do_ajax_form_tbreturlog_submit_form

  function do_ajax_form_tbreturlog_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tbreturlog_submit_form_cb_after_alert);
  } // do_ajax_form_tbreturlog_submit_form_cb
  function do_ajax_form_tbreturlog_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbreturlog_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_tbdetailreturlog"] = "off";

  function do_ajax_form_tbreturlog_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    scStatusDetail["form_tbdetailreturlog"] = "on";
    x_ajax_form_tbreturlog_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbreturlog_navigate_form_cb);
  } // do_ajax_form_tbreturlog_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreturlog']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbreturlog_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_tbdetailreturlog"] && "nmsc_iframe_liga_form_tbdetailreturlog" != scMasterDetailIframe["nmsc_iframe_liga_form_tbdetailreturlog"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_tbdetailreturlog"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_tbdetailreturlog').contentWindow.nm_move('apl_detalhe', true, '600');
        document.getElementById('nmsc_iframe_liga_form_tbdetailreturlog').style.height = "600";
        document.getElementById('nmsc_iframe_liga_form_tbdetailreturlog').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbreturlog_navigate_form_cb_after_alert);
  } // do_ajax_form_tbreturlog_navigate_form_cb
  function do_ajax_form_tbreturlog_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_tbreturlog_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_tbreturlog_navigate_form_cb_after_alert
  function sc_hide_form_tbreturlog_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_tbdetailreturlog"])
    {
      return true;
    }
    return false;
