<?php
@session_start() ;
$_SESSION['scriptcase']['grid_jurnal']['sc_process_barr'] = true;
require_once('../grid_jurnal/index.php');
unset($_SESSION['scriptcase']['grid_jurnal']['sc_process_barr']);
$ExportCtrl = new grid_jurnal_export_control;
$ExportCtrl->Export_barr();

class grid_jurnal_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_title'] ?> jurnal :: Excel</TITLE>
