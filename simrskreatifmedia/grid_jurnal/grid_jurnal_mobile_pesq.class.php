...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "tanggal";$Nm_datas[] = "tanggal";$Nm_numeric[] = "id";$Nm_numeric[] = "nominal";$Nm_numeric[] = "id_transaksi";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_flag_cond" name="flag_cond" onChange="nm_campos_between(document.getElementById('id_vis_flag'), this, 'flag')">
      ...
      <br><span id="id_hide_flag"  <?php echo $str_hide_flag?>><?php
      if ($flag != "")
      {
      $flag_look = substr($this->Db->qstr($flag), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_akun_cond" name="akun_cond" onChange="nm_campos_between(document.getElementById('id_vis_akun'), this, 'akun')">
      ...
      <br><span id="id_hide_akun"  <?php echo $str_hide_akun?>><?php
      if ($akun != "")
      {
      $akun_look = substr($this->Db->qstr($akun), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_nominal_cond" name="nominal_cond" onChange="nm_campos_between(document.getElementById('id_vis_nominal'), this, 'nominal')">
      ...
      <br><span id="id_hide_nominal"  <?php echo $str_hide_nominal?>><?php
      if ($nominal != "")
      {
      $nominal_look = substr($this->Db->qstr($nominal), 1, -1); 
      $nmgp_def_dados = array(); 
