  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tariflab" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tariflab_form();
	}

  // ---------- Validate kelas_
  function do_ajax_form_tariflab_validate_kelas_(iNumLinha)
  {
    var nomeCampo_kelas_ = "kelas_" + iNumLinha;
    var var_kelas_ = scAjaxGetFieldSelect(nomeCampo_kelas_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tariflab_validate_kelas_(var_kelas_, iNumLinha, var_script_case_init, do_ajax_form_tariflab_validate_kelas__cb);
  } // do_ajax_form_tariflab_validate_kelas_

  function do_ajax_form_tariflab_validate_kelas__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tariflab_validate_kelas__cb

  // ---------- Validate jenisbayar_
  function do_ajax_form_tariflab_validate_jenisbayar_(iNumLinha)
  {
    var nomeCampo_jenisbayar_ = "jenisbayar_" + iNumLinha;
    var var_jenisbayar_ = scAjaxGetFieldSelect(nomeCampo_jenisbayar_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tariflab_validate_jenisbayar_(var_jenisbayar_, iNumLinha, var_script_case_init, do_ajax_form_tariflab_validate_jenisbayar__cb);
  } // do_ajax_form_tariflab_validate_jenisbayar_

  function do_ajax_form_tariflab_validate_jenisbayar__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tariflab_validate_jenisbayar__cb

  // ---------- Validate tarif_
  function do_ajax_form_tariflab_validate_tarif_(iNumLinha)
  {
    var nomeCampo_tarif_ = "tarif_" + iNumLinha;
    var var_tarif_ = scAjaxGetFieldText(nomeCampo_tarif_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tariflab_validate_tarif_(var_tarif_, iNumLinha, var_script_case_init, do_ajax_form_tariflab_validate_tarif__cb);
  } // do_ajax_form_tariflab_validate_tarif_

  function do_ajax_form_tariflab_validate_tarif__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tariflab_validate_tarif__cb

  // ---------- Validate kodelab_
  function do_ajax_form_tariflab_validate_kodelab_(iNumLinha)
  {
    var nomeCampo_kodelab_ = "kodelab_" + iNumLinha;
    var var_kodelab_ = scAjaxGetFieldText(nomeCampo_kodelab_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tariflab_validate_kodelab_(var_kodelab_, iNumLinha, var_script_case_init, do_ajax_form_tariflab_validate_kodelab__cb);
  } // do_ajax_form_tariflab_validate_kodelab_

  function do_ajax_form_tariflab_validate_kodelab__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "kodelab_" + iLineNumber;
    }
    else
    {
      sFieldValid = "kodelab_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "kodelab_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "kodelab_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tariflab_validate_kodelab__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_tariflab_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_tariflab_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tariflab_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_tariflab_add_new_line_cb);
  } // do_ajax_form_tariflab_add_new_line

  function do_ajax_form_tariflab_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_tariflab_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_tariflab_backup_line(iNumLinha)
  {
    var var_kodelab_ = scAjaxGetFieldText("kodelab_" + iNumLinha);
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tariflab_backup_line(var_kodelab_, var_kelas_, var_jenisbayar_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_tariflab_backup_line_cb);
  } // do_ajax_form_tariflab_backup_line

  function do_ajax_form_tariflab_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_tariflab_backup_line_cb

  function do_ajax_form_tariflab_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_tariflab_cancel_insert

  function do_ajax_form_tariflab_cancel_update(iSeqVert)
  {
    do_ajax_form_tariflab_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_tariflab_cancel_update

  function do_ajax_form_tariflab_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_tariflab_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_tariflab_table_refresh()
  {
    var var_kodelab_ = document.F2.kodelab_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_tariflab_table_refresh(var_kodelab_, var_kelas_, var_jenisbayar_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tariflab_table_refresh_cb);
  } //  do_ajax_form_tariflab_table_refresh

  function do_ajax_form_tariflab_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.kodelab_.value = scAjaxGetKeyValue("kodelab_");
    ...
    scAjaxAlert(do_ajax_form_tariflab_table_refresh_cb_after_alert);
  } // do_ajax_form_tariflab_table_refresh_cb
  function do_ajax_form_tariflab_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxSetNavStatus("t");
    sc_insert_open = false;
  } // do_ajax_form_tariflab_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_tariflab_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_tariflab_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
...
?>
    x_ajax_form_tariflab_submit_form(var_kelas_, var_jenisbayar_, var_tarif_, var_kodelab_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tariflab_submit_form_cb);
  } // do_ajax_form_tariflab_submit_form

  function do_ajax_form_tariflab_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("kodelab_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_tariflab_submit_form_cb_after_alert);
  } // do_ajax_form_tariflab_submit_form_cb
  function do_ajax_form_tariflab_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tariflab_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tariflab_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_tariflab_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("kodelab_" + iNavForm);
    }
    var var_kodelab_ = document.F2.kodelab_.value;
    var var_kelas_ = document.F2.kelas_.value;
    var var_jenisbayar_ = document.F2.jenisbayar_.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tariflab_navigate_form(var_kodelab_, var_kelas_, var_jenisbayar_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tariflab_navigate_form_cb);
  } // do_ajax_form_tariflab_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tariflab']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tariflab_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.kodelab_.value = scAjaxGetKeyValue("kodelab_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tariflab_navigate_form_cb_after_alert);
  } // do_ajax_form_tariflab_navigate_form_cb
  function do_ajax_form_tariflab_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_tariflab_navigate_form_cb_after_alert
  function sc_hide_form_tariflab_form()
  {
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "kodelab_" + iNumLinha;
    iTotCampos++;
    ...
    ajax_error_list["kodelab_" + iNumLinha] = {"label": "Kode Lab<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_field_mult["kodelab_"][iNumLinha] = "kodelab_" + iNumLinha;
    ...
    ajax_error_count["kodelab_" + iNumLinha] = "off";
<?php
...
?>
    ...
    ajax_read_only["kodelab_" + iNumLinha] = "on";
<?php
}
else
{
...
?>
  ...
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["kodelab_" + iNumLinha] = null;
  }
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["kodelab_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["kodelab_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["kodelab_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["kodelab_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["kodelab_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['kodelab_'])) ? $this->nmgp_cmp_readonly['kodelab_'] : 'on';
?>
    scAjaxFieldRead("kodelab_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }
  ...
  function mdCloseObjects(iSeq)
  {
    ...
    scAjaxFieldRead("kodelab_" + iSeq, "on");
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["kelas_" + iRow] || "on" == ajax_error_count["jenisbayar_" + iRow] || "on" == ajax_error_count["tarif_" + iRow] || "on" == ajax_error_count["kodelab_" + iRow]))
    {
      ...
      $("#hidden_field_data_kodelab_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["kelas_" + iRow] && "off" == ajax_error_count["jenisbayar_" + iRow] && "off" == ajax_error_count["tarif_" + iRow] && "off" == ajax_error_count["kodelab_" + iRow]))
    {
      if (bErrorRow)
      {
        ...
        ajax_error_count["kodelab_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_kodelab_" + iRow).removeClass("scFormErrorLine");
    }
  }
