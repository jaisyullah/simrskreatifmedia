  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbclinicalpathway" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbclinicalpathway_form();
	}

  // ---------- Validate namacp
  function do_ajax_form_tbclinicalpathway_validate_namacp()
  {
    var nomeCampo_namacp = "namacp";
    var var_namacp = scAjaxGetFieldText(nomeCampo_namacp);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbclinicalpathway_validate_namacp(var_namacp, var_script_case_init, do_ajax_form_tbclinicalpathway_validate_namacp_cb);
  } // do_ajax_form_tbclinicalpathway_validate_namacp

  function do_ajax_form_tbclinicalpathway_validate_namacp_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbclinicalpathway_validate_namacp_cb

  // ---------- Validate aktif
  function do_ajax_form_tbclinicalpathway_validate_aktif()
  {
    var nomeCampo_aktif = "aktif";
    var var_aktif = scAjaxGetFieldRadio(nomeCampo_aktif);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbclinicalpathway_validate_aktif(var_aktif, var_script_case_init, do_ajax_form_tbclinicalpathway_validate_aktif_cb);
  } // do_ajax_form_tbclinicalpathway_validate_aktif

  function do_ajax_form_tbclinicalpathway_validate_aktif_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "aktif";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbclinicalpathway_validate_aktif_cb

  // ---------- Validate icd
  function do_ajax_form_tbclinicalpathway_validate_icd()
  {
  } // do_ajax_form_tbclinicalpathway_validate_icd

  function do_ajax_form_tbclinicalpathway_validate_icd_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "icd";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbclinicalpathway_validate_icd_cb

  // ---------- Validate detail
  function do_ajax_form_tbclinicalpathway_validate_detail()
  {
    var nomeCampo_detail = "detail";
    var var_detail = scAjaxGetFieldText(nomeCampo_detail);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbclinicalpathway_validate_detail(var_detail, var_script_case_init, do_ajax_form_tbclinicalpathway_validate_detail_cb);
  } // do_ajax_form_tbclinicalpathway_validate_detail

  function do_ajax_form_tbclinicalpathway_validate_detail_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "detail";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbclinicalpathway_validate_detail_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tbclinicalpathway_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tbclinicalpathway_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_tbclinicalpathway_submit_form(var_namacp, var_aktif, var_icd, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbclinicalpathway_submit_form_cb);
  } // do_ajax_form_tbclinicalpathway_submit_form

  function do_ajax_form_tbclinicalpathway_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tbclinicalpathway_submit_form_cb_after_alert);
  } // do_ajax_form_tbclinicalpathway_submit_form_cb
  function do_ajax_form_tbclinicalpathway_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbclinicalpathway_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_tbdetailcp"] = "off";

  function do_ajax_form_tbclinicalpathway_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    scStatusDetail["form_tbdetailcp"] = "on";
    x_ajax_form_tbclinicalpathway_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbclinicalpathway_navigate_form_cb);
  } // do_ajax_form_tbclinicalpathway_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbclinicalpathway']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbclinicalpathway_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_tbdetailcp"] && "nmsc_iframe_liga_form_tbdetailcp" != scMasterDetailIframe["nmsc_iframe_liga_form_tbdetailcp"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_tbdetailcp"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_tbdetailcp').contentWindow.nm_move('apl_detalhe', true, '800');
        document.getElementById('nmsc_iframe_liga_form_tbdetailcp').style.height = "800";
        document.getElementById('nmsc_iframe_liga_form_tbdetailcp').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbclinicalpathway_navigate_form_cb_after_alert);
  } // do_ajax_form_tbclinicalpathway_navigate_form_cb
  function do_ajax_form_tbclinicalpathway_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_tbclinicalpathway_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_tbclinicalpathway_navigate_form_cb_after_alert
  function sc_hide_form_tbclinicalpathway_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_tbdetailcp"])
    {
      return true;
    }
    return false;
