<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tbtranrad_inap']['sc_process_barr'] = true;
require_once('../grid_tbtranrad_inap/index.php');
unset($_SESSION['scriptcase']['grid_tbtranrad_inap']['sc_process_barr']);
$ExportCtrl = new grid_tbtranrad_inap_export_control;
$ExportCtrl->Export_barr();

class grid_tbtranrad_inap_export_control
{
