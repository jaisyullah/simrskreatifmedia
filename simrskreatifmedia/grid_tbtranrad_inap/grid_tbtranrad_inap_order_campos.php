<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_tbtranrad_inap']['glo_nm_path_imag_temp'] . "/sc_apl_default_simrskreatifmedia.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_tbtranrad_inap_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_tbtranrad_inap_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbtranrad_inap']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tbtranrad_inap']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["trancode"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbtranrad_inap']['labels']["trancode"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbtranrad_inap']['labels']["trancode"] : "Kode Transaksi";
   $tab_ger_campos['struk'] = "on";
   $tab_def_campos['struk'] = "struk";
   $tab_labels["struk"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbtranrad_inap']['labels']["struk"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbtranrad_inap']['labels']["struk"] : "No Struk";
   $tab_ger_campos['custcode'] = "on";
   $tab_def_campos['custcode'] = "custcode";
   $tab_labels["custcode"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbtranrad_inap']['labels']["custcode"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbtranrad_inap']['labels']["custcode"] : "No. RM";
...
ORDER BY name, salut";
   ...
   $tab_labels["nama"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbtranrad_inap']['labels']["nama"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbtranrad_inap']['labels']["nama"] : "Nama";
...
ORDER BY sex";
   ...
   $tab_labels["sc_field_0"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbtranrad_inap']['labels']["sc_field_0"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbtranrad_inap']['labels']["sc_field_0"] : "J/K";
   ...
   $tab_labels["umur"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbtranrad_inap']['labels']["umur"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbtranrad_inap']['labels']["umur"] : "Umur";
   ...
   $tab_labels["sc_field_1"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbtranrad_inap']['labels']["sc_field_1"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbtranrad_inap']['labels']["sc_field_1"] : "Tgl. Lahir";
   $tab_ger_campos['inapcode'] = "on";
   $tab_def_campos['inapcode'] = "inapcode";
   $tab_labels["inapcode"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbtranrad_inap']['labels']["inapcode"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbtranrad_inap']['labels']["inapcode"] : "Kode Inap";
   $tab_ger_campos['docname'] = "on";
   $tab_def_campos['docname'] = "docname";
   $tab_labels["docname"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbtranrad_inap']['labels']["docname"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbtranrad_inap']['labels']["docname"] : "Nama Dokter";
   $tab_ger_campos['trandate'] = "on";
   $tab_def_campos['trandate'] = "trandate";
   $tab_labels["trandate"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbtranrad_inap']['labels']["trandate"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbtranrad_inap']['labels']["trandate"] : "Tgl. Transaksi";
   $tab_ger_campos['penjamin'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['penjamin'] = "Penjamin";
   }
   else
   {
       $tab_def_campos['penjamin'] = "";
   }
   $tab_labels["penjamin"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbtranrad_inap']['labels']["penjamin"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbtranrad_inap']['labels']["penjamin"] : "Penjamin";
   $tab_ger_campos['status'] = "on";
   $tab_def_campos['status'] = "status";
   $tab_labels["status"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbtranrad_inap']['labels']["status"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbtranrad_inap']['labels']["status"] : "Status";
   $tab_ger_campos['nama'] = "none";
   $tab_ger_campos['sc_field_0'] = "none";
   $tab_ger_campos['umur'] = "none";
   $tab_ger_campos['sc_field_1'] = "none";
   $tab_ger_campos['penjamin'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_tbtranrad_inap']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_tbtranrad_inap']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_tbtranrad_inap']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbtranrad_inap']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tbtranrad_inap']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_tbtranrad_inap']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_tbtranrad_inap']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_tbtranrad_inap']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_tbtranrad_inap']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_tbtranrad_inap_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_tbtranrad_inap']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_tbtranrad_inap']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_tbtranrad_inap']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_tbtranrad_inap']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_tbtranrad_inap']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
