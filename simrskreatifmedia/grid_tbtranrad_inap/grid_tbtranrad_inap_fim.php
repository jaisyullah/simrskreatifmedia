...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_tbtranrad_inap"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_tbtranrad_inap"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_tbtranrad_inap'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tbtranrad_inap']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_tbtranrad_inap']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tbtranrad_inap']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_tbtranrad_inap']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_tbtranrad_inap']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_tbtranrad_inap</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_tbtranrad_inap']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_tbtranrad_inap']['embutida_filho'] as $ind => $sc_init)
          {
