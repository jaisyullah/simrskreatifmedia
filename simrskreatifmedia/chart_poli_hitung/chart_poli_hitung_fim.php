...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____chart_poli_hitung"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____chart_poli_hitung"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['chart_poli_hitung']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['chart_poli_hitung']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['chart_poli_hitung']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['chart_poli_hitung']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['chart_poli_hitung']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['chart_poli_hitung']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['chart_poli_hitung']['embutida_filho'] as $ind => $sc_init)
          {
