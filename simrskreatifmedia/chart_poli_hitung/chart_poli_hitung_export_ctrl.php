<?php
@session_start() ;
$_SESSION['scriptcase']['chart_poli_hitung']['sc_process_barr'] = true;
require_once('../chart_poli_hitung/index.php');
unset($_SESSION['scriptcase']['chart_poli_hitung']['sc_process_barr']);
$ExportCtrl = new chart_poli_hitung_export_control;
$ExportCtrl->Export_barr();

class chart_poli_hitung_export_control
{
