<?php
@session_start() ;
$_SESSION['scriptcase']['detailHisRJ']['sc_process_barr'] = true;
require_once('../detailHisRJ/index.php');
unset($_SESSION['scriptcase']['detailHisRJ']['sc_process_barr']);
$ExportCtrl = new detailHisRJ_export_control;
$ExportCtrl->Export_barr();

class detailHisRJ_export_control
{
