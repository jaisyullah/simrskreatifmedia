...
<?php
   ...
   $Ord_Cmp = new detailHisRJ_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class detailHisRJ_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['detailHisRJ']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['detailHisRJ']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['treatment'] = "Treatment";
   $tab_labels["treatment"]   = (isset($_SESSION['sc_session'][$sc_init]['detailHisRJ']['labels']["treatment"])) ? $_SESSION['sc_session'][$sc_init]['detailHisRJ']['labels']["treatment"] : "Treatment";
   $tab_ger_campos['jumlah'] = "on";
   $tab_def_campos['jumlah'] = "jumlah";
   $tab_labels["jumlah"]   = (isset($_SESSION['sc_session'][$sc_init]['detailHisRJ']['labels']["jumlah"])) ? $_SESSION['sc_session'][$sc_init]['detailHisRJ']['labels']["jumlah"] : "Jumlah";
   $tab_ger_campos['tgl'] = "on";
   $tab_def_campos['tgl'] = "Tgl";
   $tab_labels["tgl"]   = (isset($_SESSION['sc_session'][$sc_init]['detailHisRJ']['labels']["tgl"])) ? $_SESSION['sc_session'][$sc_init]['detailHisRJ']['labels']["tgl"] : "Tgl";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['detailHisRJ']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['detailHisRJ']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['detailHisRJ']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['detailHisRJ']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['detailHisRJ']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['detailHisRJ']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['detailHisRJ']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['detailHisRJ']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['detailHisRJ']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "detailHisRJ_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['detailHisRJ']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['detailHisRJ']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['detailHisRJ']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['detailHisRJ']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['detailHisRJ']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
