...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_treatment_cond" name="treatment_cond" onChange="nm_campos_between(document.getElementById('id_vis_treatment'), this, 'treatment')">
      ...
      <br><span id="id_hide_treatment"  <?php echo $str_hide_treatment?>><INPUT  type="text" id="SC_treatment" name="treatment" value="<?php echo NM_encode_input($treatment) ?>"  size=50 alt="{datatype: 'text', maxLength: 255, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_jumlah_cond" name="jumlah_cond" onChange="nm_campos_between(document.getElementById('id_vis_jumlah'), this, 'jumlah')">
      ...
      <br><span id="id_hide_jumlah"  <?php echo $str_hide_jumlah?>><?php
      if ($jumlah != "")
      {
      $jumlah_look = substr($this->Db->qstr($jumlah), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_tgl_cond" name="tgl_cond" onChange="nm_campos_between(document.getElementById('id_vis_tgl'), this, 'tgl')">
      ...
      <br><span id="id_hide_tgl"  <?php echo $str_hide_tgl?>>
<?php
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_deskripsi_cond" name="deskripsi_cond" onChange="nm_campos_between(document.getElementById('id_vis_deskripsi'), this, 'deskripsi')">
