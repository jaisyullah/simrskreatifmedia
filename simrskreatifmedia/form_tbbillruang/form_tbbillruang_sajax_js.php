  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbbillruang" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbbillruang_form();
	}

  // ---------- Validate check_in_
  function do_ajax_form_tbbillruang_validate_check_in_(iNumLinha)
  {
    ...
    x_ajax_form_tbbillruang_validate_check_in_(var_check_in_, var_check_in__hora, iNumLinha, var_script_case_init, do_ajax_form_tbbillruang_validate_check_in__cb);
  } // do_ajax_form_tbbillruang_validate_check_in_

  function do_ajax_form_tbbillruang_validate_check_in__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbbillruang_validate_check_in__cb

  // ---------- Validate check_out_
  function do_ajax_form_tbbillruang_validate_check_out_(iNumLinha)
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbbillruang_validate_check_out_(var_check_out_, var_check_out__hora, iNumLinha, var_script_case_init, do_ajax_form_tbbillruang_validate_check_out__cb);
  } // do_ajax_form_tbbillruang_validate_check_out_

  function do_ajax_form_tbbillruang_validate_check_out__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbbillruang_validate_check_out__cb

  // ---------- Validate lama_
  function do_ajax_form_tbbillruang_validate_lama_(iNumLinha)
  {
    var nomeCampo_lama_ = "lama_" + iNumLinha;
    var var_lama_ = scAjaxGetFieldText(nomeCampo_lama_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbbillruang_validate_lama_(var_lama_, iNumLinha, var_script_case_init, do_ajax_form_tbbillruang_validate_lama__cb);
  } // do_ajax_form_tbbillruang_validate_lama_

  function do_ajax_form_tbbillruang_validate_lama__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbbillruang_validate_lama__cb

  // ---------- Validate bed_
  function do_ajax_form_tbbillruang_validate_bed_(iNumLinha)
  {
    var nomeCampo_bed_ = "bed_" + iNumLinha;
    var var_bed_ = scAjaxGetFieldSelect(nomeCampo_bed_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbbillruang_validate_bed_(var_bed_, iNumLinha, var_script_case_init, do_ajax_form_tbbillruang_validate_bed__cb);
  } // do_ajax_form_tbbillruang_validate_bed_

  function do_ajax_form_tbbillruang_validate_bed__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbbillruang_validate_bed__cb

  // ---------- Validate rate_
  function do_ajax_form_tbbillruang_validate_rate_(iNumLinha)
  {
    var nomeCampo_rate_ = "rate_" + iNumLinha;
    var var_rate_ = scAjaxGetFieldText(nomeCampo_rate_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbbillruang_validate_rate_(var_rate_, iNumLinha, var_script_case_init, do_ajax_form_tbbillruang_validate_rate__cb);
  } // do_ajax_form_tbbillruang_validate_rate_

  function do_ajax_form_tbbillruang_validate_rate__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbbillruang_validate_rate__cb

  // ---------- Validate disc_
  function do_ajax_form_tbbillruang_validate_disc_(iNumLinha)
  {
    var nomeCampo_disc_ = "disc_" + iNumLinha;
    var var_disc_ = scAjaxGetFieldText(nomeCampo_disc_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbbillruang_validate_disc_(var_disc_, iNumLinha, var_script_case_init, do_ajax_form_tbbillruang_validate_disc__cb);
  } // do_ajax_form_tbbillruang_validate_disc_

  function do_ajax_form_tbbillruang_validate_disc__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbbillruang_validate_disc__cb

  // ---------- Validate keperawatan_
  function do_ajax_form_tbbillruang_validate_keperawatan_(iNumLinha)
  {
    var nomeCampo_keperawatan_ = "keperawatan_" + iNumLinha;
    var var_keperawatan_ = scAjaxGetFieldText(nomeCampo_keperawatan_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbbillruang_validate_keperawatan_(var_keperawatan_, iNumLinha, var_script_case_init, do_ajax_form_tbbillruang_validate_keperawatan__cb);
  } // do_ajax_form_tbbillruang_validate_keperawatan_

  function do_ajax_form_tbbillruang_validate_keperawatan__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbbillruang_validate_keperawatan__cb

  // ---------- Validate id_
  function do_ajax_form_tbbillruang_validate_id_(iNumLinha)
  {
    var nomeCampo_id_ = "id_" + iNumLinha;
    var var_id_ = scAjaxGetFieldHidden(nomeCampo_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbbillruang_validate_id_(var_id_, iNumLinha, var_script_case_init, do_ajax_form_tbbillruang_validate_id__cb);
  } // do_ajax_form_tbbillruang_validate_id_

  function do_ajax_form_tbbillruang_validate_id__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbbillruang_validate_id__cb

  // ---------- Validate trandate_
  function do_ajax_form_tbbillruang_validate_trandate_(iNumLinha)
  {
    var nomeCampo_trandate_ = "trandate_" + iNumLinha;
    var var_trandate_ = scAjaxGetFieldText(nomeCampo_trandate_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbbillruang_validate_trandate_(var_trandate_, iNumLinha, var_script_case_init, do_ajax_form_tbbillruang_validate_trandate__cb);
  } // do_ajax_form_tbbillruang_validate_trandate_

  function do_ajax_form_tbbillruang_validate_trandate__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbbillruang_validate_trandate__cb

  // ---------- Validate trancode_
  function do_ajax_form_tbbillruang_validate_trancode_(iNumLinha)
  {
    var nomeCampo_trancode_ = "trancode_" + iNumLinha;
    var var_trancode_ = scAjaxGetFieldText(nomeCampo_trancode_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbbillruang_validate_trancode_(var_trancode_, iNumLinha, var_script_case_init, do_ajax_form_tbbillruang_validate_trancode__cb);
  } // do_ajax_form_tbbillruang_validate_trancode_

  function do_ajax_form_tbbillruang_validate_trancode__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbbillruang_validate_trancode__cb

  // ---------- Validate sc_field_0_
  function do_ajax_form_tbbillruang_validate_sc_field_0_(iNumLinha)
  {
    var nomeCampo_sc_field_0_ = "sc_field_0_" + iNumLinha;
    var var_sc_field_0_ = scAjaxGetFieldText(nomeCampo_sc_field_0_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbbillruang_validate_sc_field_0_(var_sc_field_0_, iNumLinha, var_script_case_init, do_ajax_form_tbbillruang_validate_sc_field_0__cb);
  } // do_ajax_form_tbbillruang_validate_sc_field_0_

  function do_ajax_form_tbbillruang_validate_sc_field_0__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbbillruang_validate_sc_field_0__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_tbbillruang_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_tbbillruang_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tbbillruang_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_tbbillruang_add_new_line_cb);
  } // do_ajax_form_tbbillruang_add_new_line

  function do_ajax_form_tbbillruang_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_tbbillruang_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_tbbillruang_backup_line(iNumLinha)
  {
    var var_id_ = scAjaxGetFieldHidden("id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbbillruang_backup_line(var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_tbbillruang_backup_line_cb);
  } // do_ajax_form_tbbillruang_backup_line

  function do_ajax_form_tbbillruang_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_tbbillruang_backup_line_cb

  function do_ajax_form_tbbillruang_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_tbbillruang_cancel_insert

  function do_ajax_form_tbbillruang_cancel_update(iSeqVert)
  {
    do_ajax_form_tbbillruang_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_tbbillruang_cancel_update

  function do_ajax_form_tbbillruang_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_tbbillruang_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_tbbillruang_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_tbbillruang_table_refresh(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbbillruang_table_refresh_cb);
  } //  do_ajax_form_tbbillruang_table_refresh

  function do_ajax_form_tbbillruang_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_tbbillruang_table_refresh_cb_after_alert);
  } // do_ajax_form_tbbillruang_table_refresh_cb
  function do_ajax_form_tbbillruang_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxSetNavStatus("t");
    sc_insert_open = false;
  } // do_ajax_form_tbbillruang_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_tbbillruang_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_tbbillruang_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
...
?>
    x_ajax_form_tbbillruang_submit_form(var_check_in_, var_check_in__hora, var_check_out_, var_check_out__hora, var_lama_, var_bed_, var_rate_, var_disc_, var_keperawatan_, var_id_, var_trandate_, var_trancode_, var_sc_field_0_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbbillruang_submit_form_cb);
  } // do_ajax_form_tbbillruang_submit_form

  function do_ajax_form_tbbillruang_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_tbbillruang_submit_form_cb_after_alert);
  } // do_ajax_form_tbbillruang_submit_form_cb
  function do_ajax_form_tbbillruang_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbbillruang_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tbbillruang_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_tbbillruang_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tbbillruang_navigate_form(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbbillruang_navigate_form_cb);
  } // do_ajax_form_tbbillruang_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbbillruang']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbbillruang_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbbillruang_navigate_form_cb_after_alert);
  } // do_ajax_form_tbbillruang_navigate_form_cb
  function do_ajax_form_tbbillruang_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_tbbillruang_navigate_form_cb_after_alert
  function sc_hide_form_tbbillruang_form()
  {
