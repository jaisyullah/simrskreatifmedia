  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_calendar_tbcustomer" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_calendar_tbcustomer_form();
	}

  // ---------- Validate hta
  function do_ajax_calendar_tbcustomer_validate_hta()
  {
    var nomeCampo_hta = "hta";
    var var_hta = scAjaxGetFieldText(nomeCampo_hta);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_tbcustomer_validate_hta(var_hta, var_script_case_init, do_ajax_calendar_tbcustomer_validate_hta_cb);
  } // do_ajax_calendar_tbcustomer_validate_hta

  function do_ajax_calendar_tbcustomer_validate_hta_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_tbcustomer_validate_hta_cb

  // ---------- Validate tp
  function do_ajax_calendar_tbcustomer_validate_tp()
  {
    var nomeCampo_tp = "tp";
    var var_tp = scAjaxGetFieldText(nomeCampo_tp);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_tbcustomer_validate_tp(var_tp, var_script_case_init, do_ajax_calendar_tbcustomer_validate_tp_cb);
  } // do_ajax_calendar_tbcustomer_validate_tp

  function do_ajax_calendar_tbcustomer_validate_tp_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tp";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_tbcustomer_validate_tp_cb

  // ---------- Validate id
  function do_ajax_calendar_tbcustomer_validate_id()
  {
    var nomeCampo_id = "id";
    var var_id = scAjaxGetFieldText(nomeCampo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_tbcustomer_validate_id(var_id, var_script_case_init, do_ajax_calendar_tbcustomer_validate_id_cb);
  } // do_ajax_calendar_tbcustomer_validate_id

  function do_ajax_calendar_tbcustomer_validate_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_tbcustomer_validate_id_cb

  // ---------- Validate sc_field_0
  function do_ajax_calendar_tbcustomer_validate_sc_field_0()
  {
    var nomeCampo_sc_field_0 = "sc_field_0";
    var var_sc_field_0 = scAjaxGetFieldSelect(nomeCampo_sc_field_0);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_tbcustomer_validate_sc_field_0(var_sc_field_0, var_script_case_init, do_ajax_calendar_tbcustomer_validate_sc_field_0_cb);
  } // do_ajax_calendar_tbcustomer_validate_sc_field_0

  function do_ajax_calendar_tbcustomer_validate_sc_field_0_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_tbcustomer_validate_sc_field_0_cb

  // ---------- Validate birthdate
  function do_ajax_calendar_tbcustomer_validate_birthdate()
  {
    var nomeCampo_birthdate = "birthdate";
    var var_birthdate = scAjaxGetFieldText(nomeCampo_birthdate);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_tbcustomer_validate_birthdate(var_birthdate, var_script_case_init, do_ajax_calendar_tbcustomer_validate_birthdate_cb);
  } // do_ajax_calendar_tbcustomer_validate_birthdate

  function do_ajax_calendar_tbcustomer_validate_birthdate_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_tbcustomer_validate_birthdate_cb

  // ---------- Validate spouse
  function do_ajax_calendar_tbcustomer_validate_spouse()
  {
    var nomeCampo_spouse = "spouse";
    var var_spouse = scAjaxGetFieldText(nomeCampo_spouse);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_tbcustomer_validate_spouse(var_spouse, var_script_case_init, do_ajax_calendar_tbcustomer_validate_spouse_cb);
  } // do_ajax_calendar_tbcustomer_validate_spouse

  function do_ajax_calendar_tbcustomer_validate_spouse_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "spouse";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_tbcustomer_validate_spouse_cb

  // ---------- Validate job
  function do_ajax_calendar_tbcustomer_validate_job()
  {
    var nomeCampo_job = "job";
    var var_job = scAjaxGetFieldText(nomeCampo_job);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_tbcustomer_validate_job(var_job, var_script_case_init, do_ajax_calendar_tbcustomer_validate_job_cb);
  } // do_ajax_calendar_tbcustomer_validate_job

  function do_ajax_calendar_tbcustomer_validate_job_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "job";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_tbcustomer_validate_job_cb

  // ---------- Validate city
  function do_ajax_calendar_tbcustomer_validate_city()
  {
    var nomeCampo_city = "city";
    var var_city = scAjaxGetFieldText(nomeCampo_city);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_tbcustomer_validate_city(var_city, var_script_case_init, do_ajax_calendar_tbcustomer_validate_city_cb);
  } // do_ajax_calendar_tbcustomer_validate_city

  function do_ajax_calendar_tbcustomer_validate_city_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "city";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_tbcustomer_validate_city_cb

  // ---------- Validate postcode
  function do_ajax_calendar_tbcustomer_validate_postcode()
  {
    var nomeCampo_postcode = "postcode";
    var var_postcode = scAjaxGetFieldText(nomeCampo_postcode);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_tbcustomer_validate_postcode(var_postcode, var_script_case_init, do_ajax_calendar_tbcustomer_validate_postcode_cb);
  } // do_ajax_calendar_tbcustomer_validate_postcode

  function do_ajax_calendar_tbcustomer_validate_postcode_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_tbcustomer_validate_postcode_cb

  // ---------- Validate phone
  function do_ajax_calendar_tbcustomer_validate_phone()
  {
    var nomeCampo_phone = "phone";
    var var_phone = scAjaxGetFieldText(nomeCampo_phone);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_tbcustomer_validate_phone(var_phone, var_script_case_init, do_ajax_calendar_tbcustomer_validate_phone_cb);
  } // do_ajax_calendar_tbcustomer_validate_phone

  function do_ajax_calendar_tbcustomer_validate_phone_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "phone";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_tbcustomer_validate_phone_cb

  // ---------- Validate hp
  function do_ajax_calendar_tbcustomer_validate_hp()
  {
    var nomeCampo_hp = "hp";
    var var_hp = scAjaxGetFieldText(nomeCampo_hp);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_tbcustomer_validate_hp(var_hp, var_script_case_init, do_ajax_calendar_tbcustomer_validate_hp_cb);
  } // do_ajax_calendar_tbcustomer_validate_hp

  function do_ajax_calendar_tbcustomer_validate_hp_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "hp";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_tbcustomer_validate_hp_cb

  // ---------- Validate address
  function do_ajax_calendar_tbcustomer_validate_address()
  {
    var nomeCampo_address = "address";
    var var_address = scAjaxGetFieldText(nomeCampo_address);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_tbcustomer_validate_address(var_address, var_script_case_init, do_ajax_calendar_tbcustomer_validate_address_cb);
  } // do_ajax_calendar_tbcustomer_validate_address

  function do_ajax_calendar_tbcustomer_validate_address_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "address";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_tbcustomer_validate_address_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_calendar_tbcustomer_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_calendar_tbcustomer_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_calendar_tbcustomer_submit_form(var_hta, var_tp, var_id, var_sc_field_0, var_birthdate, var_spouse, var_job, var_city, var_postcode, var_phone, var_hp, var_address, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_calendar_tbcustomer_submit_form_cb);
  } // do_ajax_calendar_tbcustomer_submit_form

  function do_ajax_calendar_tbcustomer_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_calendar_tbcustomer_submit_form_cb_after_alert);
  } // do_ajax_calendar_tbcustomer_submit_form_cb
  function do_ajax_calendar_tbcustomer_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_calendar_tbcustomer_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_calendar_tbcustomer_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_calendar_tbcustomer_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_calendar_tbcustomer_navigate_form_cb);
  } // do_ajax_calendar_tbcustomer_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_calendar_tbcustomer_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_calendar_tbcustomer_navigate_form_cb_after_alert);
  } // do_ajax_calendar_tbcustomer_navigate_form_cb
  function do_ajax_calendar_tbcustomer_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_calendar_tbcustomer_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_calendar_tbcustomer_navigate_form_cb_after_alert
  function sc_hide_calendar_tbcustomer_form()
  {
