...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
  <input type="hidden" name="script_case_session" value="<?php echo $this->form_encode_input(session_id()); ?>"> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="calendar_tbcustomer"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['where_detal']))
  {
?>  
...
{
   nm_field_disabled("hta=disabled;tp=disabled;sc_field_0=disabled;birthdate=disabled;spouse=disabled;job=disabled;city=disabled;postcode=disabled;phone=disabled;hp=disabled;address=disabled", "");
