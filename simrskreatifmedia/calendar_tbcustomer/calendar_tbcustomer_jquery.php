...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_birthdate_hora' + iSeqRow).bind('blur', function() { sc_calendar_tbcustomer_birthdate_hora_onblur(this, iSeqRow) })
                                            .bind('focus', function() { sc_calendar_tbcustomer_birthdate_hora_onfocus(this, iSeqRow) });
...
function sc_calendar_tbcustomer_birthdate_hora_onblur(oThis, iSeqRow) {
  do_ajax_calendar_tbcustomer_validate_birthdate();
  scCssBlur(oThis);
}
...
function sc_calendar_tbcustomer_birthdate_hora_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function scHidePage(pageNo) {
	$("#id_calendar_tbcustomer_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_birthdate" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_calendar_tbcustomer_validate_birthdate(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_lasthta" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_calendar_tbcustomer_validate_lasthta(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_partus" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_calendar_tbcustomer_validate_partus(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_expdate" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_calendar_tbcustomer_validate_expdate(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_lastupdated" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_calendar_tbcustomer_validate_lastupdated(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_registerdate" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_calendar_tbcustomer_validate_registerdate(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
