...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_id' + iSeqRow).bind('blur', function() { sc_calendar_tbcustomer_id_onblur(this, iSeqRow) })
                                .bind('focus', function() { sc_calendar_tbcustomer_id_onfocus(this, iSeqRow) });
  $('#id_sc_field_address' + iSeqRow).bind('blur', function() { sc_calendar_tbcustomer_address_onblur(this, iSeqRow) })
                                     .bind('focus', function() { sc_calendar_tbcustomer_address_onfocus(this, iSeqRow) });
  $('#id_sc_field_city' + iSeqRow).bind('blur', function() { sc_calendar_tbcustomer_city_onblur(this, iSeqRow) })
                                  .bind('focus', function() { sc_calendar_tbcustomer_city_onfocus(this, iSeqRow) });
  $('#id_sc_field_postcode' + iSeqRow).bind('blur', function() { sc_calendar_tbcustomer_postcode_onblur(this, iSeqRow) })
                                      .bind('focus', function() { sc_calendar_tbcustomer_postcode_onfocus(this, iSeqRow) });
  $('#id_sc_field_birthdate' + iSeqRow).bind('blur', function() { sc_calendar_tbcustomer_birthdate_onblur(this, iSeqRow) })
                                       .bind('focus', function() { sc_calendar_tbcustomer_birthdate_onfocus(this, iSeqRow) });
  $('#id_sc_field_birthdate_hora' + iSeqRow).bind('blur', function() { sc_calendar_tbcustomer_birthdate_onblur(this, iSeqRow) })
                                            .bind('focus', function() { sc_calendar_tbcustomer_birthdate_onfocus(this, iSeqRow) });
  $('#id_sc_field_phone' + iSeqRow).bind('blur', function() { sc_calendar_tbcustomer_phone_onblur(this, iSeqRow) })
                                   .bind('focus', function() { sc_calendar_tbcustomer_phone_onfocus(this, iSeqRow) });
  $('#id_sc_field_hp' + iSeqRow).bind('blur', function() { sc_calendar_tbcustomer_hp_onblur(this, iSeqRow) })
                                .bind('focus', function() { sc_calendar_tbcustomer_hp_onfocus(this, iSeqRow) });
  $('#id_sc_field_spouse' + iSeqRow).bind('blur', function() { sc_calendar_tbcustomer_spouse_onblur(this, iSeqRow) })
                                    .bind('focus', function() { sc_calendar_tbcustomer_spouse_onfocus(this, iSeqRow) });
  $('#id_sc_field_hta' + iSeqRow).bind('blur', function() { sc_calendar_tbcustomer_hta_onblur(this, iSeqRow) })
                                 .bind('focus', function() { sc_calendar_tbcustomer_hta_onfocus(this, iSeqRow) });
  $('#id_sc_field_job' + iSeqRow).bind('blur', function() { sc_calendar_tbcustomer_job_onblur(this, iSeqRow) })
                                 .bind('focus', function() { sc_calendar_tbcustomer_job_onfocus(this, iSeqRow) });
  $('#id_sc_field_tp' + iSeqRow).bind('blur', function() { sc_calendar_tbcustomer_tp_onblur(this, iSeqRow) })
                                .bind('focus', function() { sc_calendar_tbcustomer_tp_onfocus(this, iSeqRow) });
  $('#id_sc_field_sc_field_0' + iSeqRow).bind('blur', function() { sc_calendar_tbcustomer_sc_field_0_onblur(this, iSeqRow) })
                                        .bind('focus', function() { sc_calendar_tbcustomer_sc_field_0_onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_calendar_tbcustomer_id_onblur(oThis, iSeqRow) {
  do_ajax_calendar_tbcustomer_mob_validate_id();
  scCssBlur(oThis);
}

function sc_calendar_tbcustomer_id_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_calendar_tbcustomer_address_onblur(oThis, iSeqRow) {
  do_ajax_calendar_tbcustomer_mob_validate_address();
  scCssBlur(oThis);
}

function sc_calendar_tbcustomer_address_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_calendar_tbcustomer_city_onblur(oThis, iSeqRow) {
  do_ajax_calendar_tbcustomer_mob_validate_city();
  scCssBlur(oThis);
}

function sc_calendar_tbcustomer_city_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_calendar_tbcustomer_postcode_onblur(oThis, iSeqRow) {
  do_ajax_calendar_tbcustomer_mob_validate_postcode();
  scCssBlur(oThis);
}

function sc_calendar_tbcustomer_postcode_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_calendar_tbcustomer_birthdate_onblur(oThis, iSeqRow) {
...
function sc_calendar_tbcustomer_birthdate_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function sc_calendar_tbcustomer_phone_onblur(oThis, iSeqRow) {
  do_ajax_calendar_tbcustomer_mob_validate_phone();
  scCssBlur(oThis);
}

function sc_calendar_tbcustomer_phone_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_calendar_tbcustomer_hp_onblur(oThis, iSeqRow) {
  do_ajax_calendar_tbcustomer_mob_validate_hp();
  scCssBlur(oThis);
}

function sc_calendar_tbcustomer_hp_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_calendar_tbcustomer_spouse_onblur(oThis, iSeqRow) {
  do_ajax_calendar_tbcustomer_mob_validate_spouse();
  scCssBlur(oThis);
}

function sc_calendar_tbcustomer_spouse_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_calendar_tbcustomer_hta_onblur(oThis, iSeqRow) {
  do_ajax_calendar_tbcustomer_mob_validate_hta();
  scCssBlur(oThis);
}

function sc_calendar_tbcustomer_hta_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_calendar_tbcustomer_job_onblur(oThis, iSeqRow) {
  do_ajax_calendar_tbcustomer_mob_validate_job();
  scCssBlur(oThis);
}

function sc_calendar_tbcustomer_job_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_calendar_tbcustomer_tp_onblur(oThis, iSeqRow) {
  do_ajax_calendar_tbcustomer_mob_validate_tp();
  scCssBlur(oThis);
}

function sc_calendar_tbcustomer_tp_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_calendar_tbcustomer_sc_field_0_onblur(oThis, iSeqRow) {
  do_ajax_calendar_tbcustomer_mob_validate_sc_field_0();
  scCssBlur(oThis);
}

function sc_calendar_tbcustomer_sc_field_0_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function scHidePage(pageNo) {
	$("#id_calendar_tbcustomer_mob_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_birthdate" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_calendar_tbcustomer_mob_validate_birthdate(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_lasthta" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_calendar_tbcustomer_mob_validate_lasthta(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_partus" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_calendar_tbcustomer_mob_validate_partus(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_expdate" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_calendar_tbcustomer_mob_validate_expdate(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_lastupdated" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_calendar_tbcustomer_mob_validate_lastupdated(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_registerdate" + iSeqRow).datepicker({
    beforeShow: function(input, inst) {
      ...
      if ('' == sTime || ' ' == sTime) {
        sTime = ' <?php echo $this->jqueryCalendarTimeStart($this->field_config['registerdate']['date_format']); ?>';
      }
      $oField.datepicker("option", "dateFormat", "<?php echo $this->jqueryCalendarDtFormat("" . str_replace(array('/', 'aaaa', 'hh', 'ii', 'ss', ':', ';', $_SESSION['scriptcase']['reg_conf']['date_sep'], $_SESSION['scriptcase']['reg_conf']['time_sep']), array('', 'yyyy', '','','', '', '', '', ''), $this->field_config['registerdate']['date_format']) . "", "" . $_SESSION['scriptcase']['reg_conf']['date_sep'] . ""); ?>" + sTime);
    },
    onClose: function(dateText, inst) {
      do_ajax_calendar_tbcustomer_mob_validate_registerdate(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
    ...
    weekHeader: "<?php echo html_entity_decode($this->Ini->Nm_lang['lang_shrt_days_sem'], ENT_COMPAT, $_SESSION['scriptcase']['charset']); ?>",
    firstDay: <?php echo $this->jqueryCalendarWeekInit("" . $_SESSION['scriptcase']['reg_conf']['date_week_ini'] . ""); ?>,
    dateFormat: "<?php echo $this->jqueryCalendarDtFormat("" . str_replace(array('/', 'aaaa', 'hh', 'ii', 'ss', ':', ';', $_SESSION['scriptcase']['reg_conf']['date_sep'], $_SESSION['scriptcase']['reg_conf']['time_sep']), array('', 'yyyy', '','','', '', '', '', ''), $this->field_config['registerdate']['date_format']) . "", "" . $_SESSION['scriptcase']['reg_conf']['date_sep'] . ""); ?>",
    showOtherMonths: true,
    showOn: "button",
<?php
$miniCalendarIcon   = $this->jqueryIconFile('calendar');
