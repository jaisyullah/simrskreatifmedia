...
//----- 
   function ini_controle()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['calendar_tbcustomer']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['calendar_tbcustomer']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['calendar_tbcustomer']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['calendar_tbcustomer']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['calendar_tbcustomer']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['calendar_tbcustomer']['sc_redir_insert'] = $this->sc_redir_insert;
          }
      } 
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['calendar_tbcustomer']['parms']))
      {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['calendar_tbcustomer']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['calendar_tbcustomer']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['calendar_tbcustomer']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['calendar_tbcustomer']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['calendar_tbcustomer']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['calendar_tbcustomer']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['calendar_tbcustomer']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['calendar_tbcustomer']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new calendar_tbcustomer_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("id");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['initialize'];
      } 
      else 
      { 
         $this->nm_data = new nm_data("id");
      } 
      $_SESSION['sc_session'][$script_case_init]['calendar_tbcustomer']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['calendar_tbcustomer']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['calendar_tbcustomer'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['calendar_tbcustomer']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['calendar_tbcustomer']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('calendar_tbcustomer') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['calendar_tbcustomer']['label'] = "" . $this->Ini->Nm_lang['lang_othr_frmu_title'] . " tbcustomer";
      ...
      $_SESSION['scriptcase']['error_icon']['calendar_tbcustomer']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Rhino__NM__nm_scriptcase9_Rhino_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['calendar_tbcustomer'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['embutida_call'] : $this->Embutida_call;

       $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tbcustomer']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tbcustomer']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tbcustomer']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tbcustomer']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tbcustomer']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tbcustomer']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tbcustomer']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tbcustomer']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tbcustomer']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tbcustomer']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tbcustomer']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tbcustomer']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tbcustomer']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_tbcustomer']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['calendar_tbcustomer']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tbcustomer']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tbcustomer']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tbcustomer']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_tbcustomer']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['calendar_tbcustomer']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tbcustomer']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tbcustomer']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_tbcustomer']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['calendar_tbcustomer']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tbcustomer']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tbcustomer']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tbcustomer']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tbcustomer']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tbcustomer']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tbcustomer']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tbcustomer']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tbcustomer']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tbcustomer']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tbcustomer']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tbcustomer']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tbcustomer']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tbcustomer']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tbcustomer']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tbcustomer']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tbcustomer']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tbcustomer']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tbcustomer']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tbcustomer']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tbcustomer']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_tbcustomer']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['calendar_tbcustomer']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['calendar_tbcustomer']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tbcustomer']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tbcustomer']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tbcustomer']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tbcustomer']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tbcustomer']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tbcustomer']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tbcustomer']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tbcustomer']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tbcustomer']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tbcustomer']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tbcustomer']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tbcustomer']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tbcustomer']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tbcustomer']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tbcustomer']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tbcustomer']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tbcustomer']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tbcustomer']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tbcustomer']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tbcustomer']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tbcustomer']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tbcustomer']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tbcustomer']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tbcustomer']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tbcustomer']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tbcustomer']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tbcustomer']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tbcustomer']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tbcustomer']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tbcustomer']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tbcustomer']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tbcustomer']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tbcustomer']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tbcustomer']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tbcustomer']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tbcustomer']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tbcustomer']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tbcustomer']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tbcustomer']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_tbcustomer']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['calendar_tbcustomer'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['calendar_tbcustomer'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_tbcustomer']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['calendar_tbcustomer']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['calendar_tbcustomer']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['calendar_tbcustomer']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_tbcustomer']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['calendar_tbcustomer']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['calendar_tbcustomer']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_tbcustomer']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['calendar_tbcustomer']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['calendar_tbcustomer']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_tbcustomer']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['calendar_tbcustomer']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['calendar_tbcustomer']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_tbcustomer']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['calendar_tbcustomer']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['calendar_tbcustomer']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_tbcustomer']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['calendar_tbcustomer']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['calendar_tbcustomer']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['dados_form'];
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("calendar_tbcustomer", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (isset($_GET['nm_cal_display']))
      {
          ...
          { 
              include_once($this->Ini->path_embutida . 'calendar_tbcustomer/calendar_tbcustomer_calendar.php');
          }
          else
          { 
              include_once($this->Ini->path_aplicacao . 'calendar_tbcustomer_calendar.php');
          }
          exit;
      }

      if (is_file($this->Ini->path_aplicacao . 'calendar_tbcustomer_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'calendar_tbcustomer_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      if ($this->Embutida_proc)
      { 
          require_once($this->Ini->path_embutida . 'calendar_tbcustomer/calendar_tbcustomer_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "calendar_tbcustomer_erro.class.php"); 
      }
      $this->Erro      = new calendar_tbcustomer_erro();
      $this->Erro->Ini = $this->Ini;
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_tbcustomer']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['calendar_tbcustomer']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['calendar_tbcustomer']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['opc_ant'];
      } 
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['final'];
      }
      else
      {
      }
...
//
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['dados_select'];
     }
   }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
      ...
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "recarga_mobile" || $this->nmgp_opcao == "muda_form") 
      {
          ...
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['dados_select']['hta']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->hta = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['dados_select']['hta'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['dados_select']['tp']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->tp = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['dados_select']['tp'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['dados_select']['sc_field_0']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->sc_field_0 = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['dados_select']['sc_field_0'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['dados_select']['birthdate']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->birthdate = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['dados_select']['birthdate'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['dados_select']['spouse']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->spouse = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['dados_select']['spouse'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['dados_select']['job']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->job = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['dados_select']['job'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['dados_select']['city']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->city = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['dados_select']['city'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['dados_select']['postcode']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->postcode = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['dados_select']['postcode'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['dados_select']['phone']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->phone = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['dados_select']['phone'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['dados_select']['hp']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->hp = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['dados_select']['hp'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['dados_select']['address']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->address = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['dados_select']['address'];
          } 
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['recarga'] = $this->nmgp_opcao;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['sc_redir_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['sc_redir_insert'] == "ok")
          {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['sc_redir_atualiz'] == "ok")
          {
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "calendar_tbcustomer.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer'][$path_doc_md5][1] = $Zip_name;
?>
...
<form name="Fdown" method="get" action="calendar_tbcustomer_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="calendar_tbcustomer"> 
...
//---------------------------------------------------------
     ...
     if ('' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_calendar_tbcustomer']) || !is_array($this->NM_ajax_info['errList']['geral_calendar_tbcustomer']))
              {
                  $this->NM_ajax_info['errList']['geral_calendar_tbcustomer'] = array();
              }
              $this->NM_ajax_info['errList']['geral_calendar_tbcustomer'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
...
;
    ...
    function ValidateField_id(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['php_cmp_required']['id']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['php_cmp_required']['id'] == "on") 
           { 
              $hasError = true;
              $Campos_Falta[] = "ID" ; 
              if (!isset($Campos_Erros['id']))
    ...
    function ValidateField_sc_field_0(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->sc_field_0) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['Lookup_sc_field_0']) && !in_array($this->sc_field_0, $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['Lookup_sc_field_0']))
               {
                   $hasError = true;
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['dados_form'] = $this->nmgp_dados_form;
   }
...
//-- 
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['id']['keyVal'] = calendar_tbcustomer_pack_protect_string($this->nmgp_dados_form['id']);
          }
   } // ajax_return_values
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['Lookup_sc_field_0']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['Lookup_sc_field_0'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['Lookup_sc_field_0']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['Lookup_sc_field_0'] = array(); 
}
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       while (!$rs->EOF) 
       { 
              $aLookup[] = array(calendar_tbcustomer_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', calendar_tbcustomer_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['Lookup_sc_field_0'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['sc_field_0']['valList'][$i] = calendar_tbcustomer_pack_protect_string($v);
          }
   ...
   function ajax_return_values_address($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
  ...
  function nm_proc_onload($bFormat = true)
  {
      if ('calendar' != $this->nmgp_opcao) {
          ...
          $_SESSION['scriptcase']['calendar_tbcustomer']['contr_erro'] = 'on';
...
//----------- 
   ...
   function controle_navegacao()
   {
      global $sc_where;
          ...
          if (false && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['total']))
          {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['total'] = $rsc->fields[0];
               $rsc->Close(); 
               if ('' != $this->id)
               {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['inicio'] = $rsc->fields[0];
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['inicio'] < 0)
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['inicio'] = 0;
               }
               $rsc->Close(); 
               }
               else
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['qt_reg_grid'] = 1;
          if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['inicio']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['inicio'] = 0;
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['final']  = 0;
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['opcao'] = $this->NM_ajax_info['param']['nmgp_opcao'];
          if (in_array($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['opcao'], array('incluir', 'alterar', 'excluir')))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['opcao'] = '';
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['opcao'] == 'inicio')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['inicio'] = 0;
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['opcao'] == 'retorna')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['inicio'] = 0 ;
              }
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['opcao'] == 'avanca' && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['total']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['total'] > $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['final']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['final'];
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['opcao'] == 'final')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['total'] - $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['inicio'] = 0;
              }
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['final'] = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['inicio'] + $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['qt_reg_grid'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['final'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['opcao'] = '';
   ...
   { 
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['db_changed'] = true;
      ...
      { 
          ...
          {
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['total']);
              }
              ...
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao = "novo"; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['run_iframe'] == "R")
              { 
                   $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['return_edit'] = "new";
              } 
              }
              $this->nm_flag_iframe = true;
          } 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['parms'] = "id?#?$this->id?@?"; 
      }
      $this->NM_commit_db(); 
      if (isset($this->google_calendar_insert) && $this->google_calendar_insert)
      {
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['where_filter'] . ")";
          }
      }
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
              $GLOBALS["NM_ERRO_IBASE"] = 1;  
          } 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['run_iframe'] == "R")
          {
              if ($this->sc_evento == "update")
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['select'] = ""; 
              } 
          } 
          ...
          if ($rs->EOF) 
          { 
              if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['where_filter']))
              {
                  ...
                  $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['empty_filter'] = true;
                  return; 
              }
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['dados_select'] = $this->nmgp_dados_select;
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
        ...
        $this->initFormPages();
    include_once("calendar_tbcustomer_form0.php");
        $this->hideFormPages();
 }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['table_refresh'])
        {
   ...
   function calendarOutputDisplay()
   {
       ...
       $appReturn = '';
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['iframe_menu'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['sc_outra_jan']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['sc_outra_jan'] != 'calendar_tbcustomer')) {
           global $nm_url_saida, $nm_apl_dependente;
           if ((!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['run_iframe'] == "R" || $this->aba_iframe) && ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['run_iframe'] != "F") && ($nm_apl_dependente == 1)) {
...
?>
      events: 'calendar_tbcustomer.php?script_case_init=<?php echo $this->Ini->sc_page ?>&nmgp_opcao=calendar_fetch' + getCategory(false),
...
{
?>
        tb_show('', 'calendar_tbcustomer.php?nmgp_opcao=edit_novo&sc_cal_click_date=' + sDate + '&sc_cal_click_time=' + sTime + '&sc_cal_click_allday=' + allDay + '&script_case_init=<?php echo $this->Ini->sc_page ?>&nmgp_outra_jan=true&nmgp_url_saida=modal&TB_iframe=true&modal=true&height=500&width=700', '');
<?php
}
...
{
?>
        tb_show('', 'calendar_tbcustomer.php?nmgp_opcao=igual_calendar&id=' + calEvent.id + '&__orig_id=' + calEvent.id + '&script_case_init=<?php echo $this->Ini->sc_page ?>&nmgp_outra_jan=true&nmgp_url_saida=modal&TB_iframe=true&modal=true&height=500&width=700', '');
<?php
}
  ...
  function scEditEvent(sEventId) {
    ...
    $("#sc-ui-form").submit();
        ...
        function refreshFilterCategories() {
                $('#calendar').fullCalendar('removeEventSource', 'calendar_tbcustomer.php?script_case_init=<?php echo $this->Ini->sc_page ?>&nmgp_opcao=calendar_fetch' + getCategory(false));

                setCategory();

                $('#calendar').fullCalendar('addEventSource', 'calendar_tbcustomer.php?script_case_init=<?php echo $this->Ini->sc_page ?>&nmgp_opcao=calendar_fetch' + getCategory(false));
        }
...
<?php
   ...
   function jqueryButtonText($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['csrf_token'];
    }
...
else
{
   ...
   function SC_fast_search($field, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['empty_filter']);
      ...
      $sv_data = $data_search;
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['where_filter_form'] . " and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_calendar_tbcustomer = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['total'] = $qt_geral_reg_calendar_tbcustomer;
      $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          calendar_tbcustomer_pack_ajax_response();
   ...
   function SC_monta_condicao(&$comando, $nome, $condicao, $campo, $tp_campo="")
   {
      ...
      {
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['decimal_db'] == ".")
         {
             $nm_aspas  = "";
             $nm_aspas1 = "";
         }
         ...
         if (isset($Nm_datas[$campo_join]))
         {
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          {
             ...
             $nm_aspas1 = "#";
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['SC_sep_date1'];
              }
          }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "calendar_tbcustomer_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['nm_run_menu'] = 2;
       $nmgp_saida_form = "calendar_tbcustomer_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['masterValue']))
{
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['dashboard_info']['under_dashboard']) {
?>
var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['dashboard_info']['parent_widget']; ?>']");
if (dbParentFrame && dbParentFrame[0] && dbParentFrame[0].contentWindow.scAjaxDetailValue)
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbcustomer']['masterValue'] as $cmp_master => $val_master)
        {
?>
