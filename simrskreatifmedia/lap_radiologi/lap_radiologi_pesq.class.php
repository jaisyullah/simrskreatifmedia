...
//-- ajax metodos ---
   ...
   $NM_retorno = "./";
    if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['lap_radiologi']['proc_res'])) 
    {
...
<?php
    if ($_SESSION['sc_session'][$this->Ini->sc_page]['lap_radiologi']['prim_vez'] == "N" && !$_SESSION['sc_session'][$this->Ini->sc_page]['lap_radiologi']['proc_res']) 
    {
?>
if (parent.document.getElementById('nmsc_iframe_lap_radiologi').contentWindow.nm_gp_submit_ajax)
{
   parent.document.getElementById('nmsc_iframe_lap_radiologi').contentWindow.nm_gp_submit_ajax('inicio', 'save_grid');
}
else
{
   parent.document.getElementById('nmsc_iframe_lap_radiologi').src = 'index.php?nmgp_opcao=pesq&script_case_init=<?php echo NM_encode_input($this->Ini->sc_page) ?>&script_case_session=<?php echo session_id() ?>';
}
<?php
    }
    else
...
<?php
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['lap_radiologi']['prim_vez'] = "N";
?>
</SCRIPT>
</BODY>
</HTML>
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_tgl_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['tgl'])) ? $this->New_label['tgl'] : "Tgl Pemeriksaan"; ?></TD>
...
?>
      ...
      <TD id='SC_jk_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['jk'])) ? $this->New_label['jk'] : "JK"; ?></TD>
      
      <INPUT type="hidden" id="SC_jk_cond" name="jk_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_jk" <?php echo $str_hide_jk?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
...
<?php
 ...
 <OPTION value="P##@@Wanita"<?php if ($jk == "P") { echo " selected" ;} ?>>Wanita</option>
      ...
      <TD id='SC_tl_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['tl'])) ? $this->New_label['tl'] : "Tgl. Lahir"; ?></TD>
      
      <INPUT type="hidden" id="SC_tl_cond" name="tl_cond" value="bw">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_tl" <?php echo $str_hide_tl?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
...
<span id='id_date_part_tl_DD' style='display: inline-block'>
         ...
         <SELECT class="scFilterObjectOdd" id="SC_tl_dia" name="tl_dia">
          <OPTION value=""></OPTION>
...
<span id='id_date_part_tl_MM' style='display: inline-block'>
         ...
         <SELECT class="scFilterObjectOdd" id="SC_tl_mes" name="tl_mes">
          <OPTION value=""></OPTION>
...
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_tl_ano" name="tl_ano" value="<?php echo NM_encode_input($tl_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
...
?>
       ...
       <TR valign="top">
        <TD id="id_vis_tl"  <?php echo $str_display_tl; ?> class="scFilterFieldFontOdd">
         <?php echo $date_sep_bw ?>
         <BR>
         <?php
...
<span id='id_date_part_tl_input_2_DD' style='display: inline-block'>
         ...
         <SELECT class="scFilterObjectOdd" id="SC_tl_input_2_dia" name="tl_input_2_dia">
          <OPTION value=""></OPTION>
...
<span id='id_date_part_tl_input_2_MM' style='display: inline-block'>
         ...
         <SELECT class="scFilterObjectOdd" id="SC_tl_input_2_mes" name="tl_input_2_mes">
          <OPTION value=""></OPTION>
...
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_tl_input_2_ano" name="tl_input_2_ano" value="<?php echo NM_encode_input($tl_input_2_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
...
<?php
    if ($_SESSION['sc_session'][$this->Ini->sc_page]['lap_radiologi']['prim_vez'] == "N") 
    {
?>
       <iframe id="nmsc_iframe_lap_radiologi" frameborder="0" marginwidth="0px" marginheight="0px" topmargin="0px" leftmargin="0px" align="center" height="1500px" name="nm_iframe_lap_radiologi" scrolling="auto" src="index.php?nmgp_opcao=pesq&script_case_init=<?php echo NM_encode_input($this->Ini->sc_page) ?>&script_case_session=<?php echo session_id() ?>" width="100%"></iframe>
<?php
    }
    else
    {
?>
       <iframe id="nmsc_iframe_lap_radiologi" frameborder="0" marginwidth="0px" marginheight="0px" topmargin="0px" leftmargin="0px" align="center" height="1500px" name="nm_iframe_lap_radiologi" scrolling="auto" src="" width="100%"></iframe>
<?php
    }
?>
<iframe id="nmsc_iframe_lap_radiologi_pesq"  name="nm_iframe_lap_radiologi_pesq" style= "display: none;" frameborder="0" marginwidth="0px" marginheight="0px" topmargin="0px" leftmargin="0px" src=""></iframe>
</td></tr></table></td></tr>
</TABLE>
...
?>
 ...
 {
    document.F1.target = "nm_iframe_lap_radiologi_pesq";
    document.F1.submit();
 }
 function nm_move()
 {
     document.getElementById('nmsc_iframe_lap_radiologi').contentWindow.nm_move('igual');
 }
 function limpa_form()
 {
   document.F1.reset();
