...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____lap_radiologi"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____lap_radiologi"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['lap_radiologi']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['lap_radiologi']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['lap_radiologi']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['lap_radiologi']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['lap_radiologi']['sc_modal']);
           if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['lap_radiologi']['opc_psq']))
           {
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['lap_radiologi']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['lap_radiologi']['embutida_filho'] as $ind => $sc_init)
          {
