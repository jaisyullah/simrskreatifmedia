<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['lap_radiologi']['glo_nm_path_imag_temp'] . "/sc_apl_default_simrskreatifmedia.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new lap_radiologi_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class lap_radiologi_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['lap_radiologi']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['lap_radiologi']['ordem_select_orig'] = array();
   }
   ...
   {
       $tab_def_campos['tgl'] = "d.trandate";
   }
   $tab_labels["tgl"]   = (isset($_SESSION['sc_session'][$sc_init]['lap_radiologi']['labels']["tgl"])) ? $_SESSION['sc_session'][$sc_init]['lap_radiologi']['labels']["tgl"] : "Tgl Pemeriksaan";
   ...
   $tab_labels["rm"]   = (isset($_SESSION['sc_session'][$sc_init]['lap_radiologi']['labels']["rm"])) ? $_SESSION['sc_session'][$sc_init]['lap_radiologi']['labels']["rm"] : "RM";
   ...
   $tab_labels["sc_field_1"]   = (isset($_SESSION['sc_session'][$sc_init]['lap_radiologi']['labels']["sc_field_1"])) ? $_SESSION['sc_session'][$sc_init]['lap_radiologi']['labels']["sc_field_1"] : "Nama Pasien";
   ...
   {
       $tab_def_campos['jk'] = "b.sex";
   }
   $tab_labels["jk"]   = (isset($_SESSION['sc_session'][$sc_init]['lap_radiologi']['labels']["jk"])) ? $_SESSION['sc_session'][$sc_init]['lap_radiologi']['labels']["jk"] : "JK";
   ...
   $tab_labels["umur"]   = (isset($_SESSION['sc_session'][$sc_init]['lap_radiologi']['labels']["umur"])) ? $_SESSION['sc_session'][$sc_init]['lap_radiologi']['labels']["umur"] : "UMUR";
   $tab_ger_campos['tl'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['tl'] = "tl";
   }
   else
   {
       $tab_def_campos['tl'] = "b.birthDate";
   }
   $tab_labels["tl"]   = (isset($_SESSION['sc_session'][$sc_init]['lap_radiologi']['labels']["tl"])) ? $_SESSION['sc_session'][$sc_init]['lap_radiologi']['labels']["tl"] : "TL";
   ...
   {
       $tab_def_campos['pemeriksaan'] = "e.nama";
   }
   $tab_labels["pemeriksaan"]   = (isset($_SESSION['sc_session'][$sc_init]['lap_radiologi']['labels']["pemeriksaan"])) ? $_SESSION['sc_session'][$sc_init]['lap_radiologi']['labels']["pemeriksaan"] : "Pemeriksaan";
   ...
   {
       $tab_def_campos['harga'] = "d.rate";
   }
   $tab_labels["harga"]   = (isset($_SESSION['sc_session'][$sc_init]['lap_radiologi']['labels']["harga"])) ? $_SESSION['sc_session'][$sc_init]['lap_radiologi']['labels']["harga"] : "Harga";
   ...
   $tab_labels["sc_field_0"]   = (isset($_SESSION['sc_session'][$sc_init]['lap_radiologi']['labels']["sc_field_0"])) ? $_SESSION['sc_session'][$sc_init]['lap_radiologi']['labels']["sc_field_0"] : "Asal Pasien";
   ...
   {
       $tab_def_campos['poli'] = "a.poli";
   }
   $tab_labels["poli"]   = (isset($_SESSION['sc_session'][$sc_init]['lap_radiologi']['labels']["poli"])) ? $_SESSION['sc_session'][$sc_init]['lap_radiologi']['labels']["poli"] : "Poli";
   $tab_ger_campos['tranri'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['tranri'] = "tranri";
   }
   else
   {
       $tab_def_campos['tranri'] = "a.inapcode";
   }
   $tab_labels["tranri"]   = (isset($_SESSION['sc_session'][$sc_init]['lap_radiologi']['labels']["tranri"])) ? $_SESSION['sc_session'][$sc_init]['lap_radiologi']['labels']["tranri"] : "Tran RI";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['lap_radiologi']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['lap_radiologi']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['lap_radiologi']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['lap_radiologi']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['lap_radiologi']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['lap_radiologi']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['lap_radiologi']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['lap_radiologi']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['lap_radiologi']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "lap_radiologi_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['lap_radiologi']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['lap_radiologi']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['lap_radiologi']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['lap_radiologi']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['lap_radiologi']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
