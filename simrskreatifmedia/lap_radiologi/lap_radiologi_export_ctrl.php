<?php
@session_start() ;
$_SESSION['scriptcase']['lap_radiologi']['sc_process_barr'] = true;
require_once('../lap_radiologi/index.php');
unset($_SESSION['scriptcase']['lap_radiologi']['sc_process_barr']);
$ExportCtrl = new lap_radiologi_export_control;
$ExportCtrl->Export_barr();

class lap_radiologi_export_control
{
