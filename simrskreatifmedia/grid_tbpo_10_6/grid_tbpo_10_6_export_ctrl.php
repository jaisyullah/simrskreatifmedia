<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tbpo_10_6']['sc_process_barr'] = true;
require_once('../grid_tbpo_10_6/index.php');
unset($_SESSION['scriptcase']['grid_tbpo_10_6']['sc_process_barr']);
$ExportCtrl = new grid_tbpo_10_6_export_control;
$ExportCtrl->Export_barr();

class grid_tbpo_10_6_export_control
{
