...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailigd_old']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
  <input type="hidden" name="script_case_session" value="<?php echo $this->form_encode_input(session_id()); ?>"> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_tbdetailigd_old"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
?> 
var var_btn_sc_btn_0_var_rm_his = "<?php echo $this->form_encode_input($this->nmgp_dados_form['custcode']); ?>";
...
{
  nm_gp_submit('<?php echo $this->Ini->link_grid_histori_pasien_cons; ?>', '<?php echo $this->nm_location; ?>', '<?php echo "var_rm_his*scin' + var_btn_sc_btn_0_var_rm_his + '*scout"; ?>', 'inicio', '_blank', '0', '0', 'grid_histori_pasien');
}
 NM_tp_critica(1);
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailigd_old']['where_detal']))
  {
?>  
...
{
   nm_field_disabled("trancode=disabled;usia=disabled;sc_field_4=disabled;sc_field_5=disabled", "");
