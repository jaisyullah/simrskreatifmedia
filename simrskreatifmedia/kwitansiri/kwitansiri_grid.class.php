...
//--- 
 function monta_grid($linhas = 0)
 {
   ...
   { 
       ...
       unset ($_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['save_grid']);
       $this->grid();
       $flag_apaga_pdf_log = TRUE;
       if (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['opcao'] == "pdf")
       { 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['opcao_print'] == "print")
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['opcao'] = $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['opcao_ant'];
       $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['opcao_print'] = "";
   }
   $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['opcao_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['opcao'];
 }
...
//
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['force_toolbar']))
   { 
       $this->force_toolbar = true;
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['force_toolbar']);
   } 
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['Ind_lig_mult'])) {
       $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['Ind_lig_mult'] = 0;
   }
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['embutida'])
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['Lig_Md5']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['Lig_Md5'] = array();
       }
   }
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['opcao'] != 'print')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['Lig_Md5'] = array();
   }
   $this->grid_emb_form = false;
   $this->grid_emb_form_full = false;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['embutida_form']) && $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['embutida_form'])
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['embutida_form_full']) && $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['embutida_form_full'])
       {
       ...
       else
       {
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['mostra_edit'] = "N";
       }
   }
   $this->aba_iframe = false;
   $this->Print_All = $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['print_all'];
   if ($this->Print_All)
   {
   ...
   if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
   {
       ...
       {
           if (in_array("kwitansiri", $apls_aba))
           {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
   {
       $this->aba_iframe = true;
   }
   ...
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['kwitansiri']['export']) && $_SESSION['scriptcase']['sc_apl_conf']['kwitansiri']['export'] == 'off')
   {
       $this->nmgp_botoes['export'] = "off";
   }
   $this->nmgp_botoes['print'] = "on";
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['kwitansiri']['print']) && $_SESSION['scriptcase']['sc_apl_conf']['kwitansiri']['print'] == 'off')
   {
   ...
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['kwitansiri']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['kwitansiri']['btn_display']))
   {
       foreach ($_SESSION['scriptcase']['sc_apl_conf']['kwitansiri']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
       {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['doc_word'] || $this->Ini->sc_export_ajax_img)
   { 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['opcao'] == "muda_qt_linhas")
   { 
       unset($rec);
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['opcao'] == "muda_rec_linhas")
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['opcao'] = "muda_qt_linhas";
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['embutida'])
   {
       $nmgp_ordem = ""; 
...
//
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['embutida'])
   { 
       include_once($this->Ini->path_embutida . "kwitansiri/kwitansiri_total.class.php"); 
   } 
   else 
   { 
       include_once($this->Ini->path_aplicacao . "kwitansiri_total.class.php"); 
   } 
   ...
   if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['qt_lin_grid']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['qt_lin_grid'] = 10 ;  
       $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['qt_col_grid'] = 1 ;  
   }   
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['kwitansiri']['rows']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['kwitansiri']['rows']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['qt_lin_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['kwitansiri']['rows'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['kwitansiri']['rows']);
   }
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['kwitansiri']['cols']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['kwitansiri']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['qt_col_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['kwitansiri']['cols'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['kwitansiri']['cols']);
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['opc_liga']['rows']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['qt_lin_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['opc_liga']['rows'];  
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['opc_liga']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['qt_col_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['opc_liga']['cols'];  
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['opcao'] == "muda_qt_linhas") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['opcao']  = "igual" ;  
       ...
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['qt_lin_grid'] = $nmgp_quant_linhas ;  
       } 
       if (!empty($nmgp_quant_colunas)) 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['qt_col_grid'] = $nmgp_quant_colunas ;  
       } 
   }   
   $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['qt_reg_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['qt_lin_grid'] * $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['qt_col_grid']; 
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['ordem_select']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['ordem_select'] = array(); 
   } 
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['ordem_quebra']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['ordem_grid'] = "" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['ordem_ant']  = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['ordem_desc'] = "" ; 
   }   
   if (!empty($nmgp_ordem))  
   { 
       $nmgp_ordem = str_replace('\"', '"', $nmgp_ordem); 
       $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['ordem_grid'] = $nmgp_ordem  ; 
       $this->ordem_grid = $nmgp_ordem; 
   }   
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['opcao'] == "ordem")  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['opcao'] = "inicio" ;  
       if (($_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['ordem_ant'] == $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['ordem_grid']) && $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['ordem_desc'] == "")  
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['ordem_desc'] = " desc" ; 
       } 
       else   
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['ordem_desc'] = "" ;  
       } 
       $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['ordem_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['ordem_grid'];  
   }  
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['inicio']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['inicio'] = 0 ;  
       $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['final']  = 0 ;  
   }   
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['opc_edit'])  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['opc_edit'] = false;  
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['opcao'] != "inicio") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['opcao'] = "edit" ; 
       } 
   }   
   if (!empty($nmgp_parms) && $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['opcao'] != "pdf")   
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['opcao'] = "igual";
       $rec = "ini";
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['where_orig']) || $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['prim_cons'] || !empty($nmgp_parms))  
   { 
   ...
   {   
       $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['where_pesq'] .= $this->nm_where_dinamico;
   }   
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['where_pesq_filtro'];
...
//--------- 
//
   $nmgp_opc_orig = $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['opcao']; 
   if (isset($rec)) 
   { 
       if ($rec == "ini") 
       { 
       ...
       elseif ($rec == "fim") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['opcao'] = "final" ; 
       } 
           else 
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['opcao'] = "avanca" ; 
               $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['final'] = $rec; 
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['final'] > 0) 
               { 
                   $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['final']-- ; 
               } 
          } 
   } 
   $NM_opcao       = $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['opcao']; 
   if ($NM_opcao == "print") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['opcao_print'] = "print" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['opcao']       = "igual" ; 
...
// 
   $this->count_ger = 0;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['opcao'] == "final" || $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['qt_reg_grid'] == "all") 
   { 
       $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['SC_Ind_Groupby'];
       $this->Tot->$Gb_geral();
       $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['tot_geral'][1] ;  
       $this->count_ger = $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['tot_geral'][1];
   } 
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['where_dinamic']) && $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['where_dinamic'] != $this->nm_where_dinamico)  
   { 
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['tot_geral']);
   } 
   $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['where_dinamic'] = $this->nm_where_dinamico;  
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['tot_geral']) || $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['where_pesq_ant'] || $nmgp_opc_orig == "edit") 
   { 
       ...
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['contr_array_resumo']))  
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['contr_array_resumo'] = "NAO";
       } 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['qt_reg_grid'] == "all") 
   { 
        $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['qt_reg_grid'] = $this->count_ger;
        $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['opcao']       = "inicio";
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['opcao'] == "inicio" || $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['opcao'] == "pesq") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['inicio'] = 0 ; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['opcao'] == "final") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['sc_total'] - $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['qt_reg_grid']; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['inicio'] < 0) 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['inicio'] = 0 ; 
       } 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['opcao'] == "retorna") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['qt_reg_grid']; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['inicio'] < 0) 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['inicio'] = 0 ; 
       } 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['opcao'] == "avanca" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['sc_total']) || $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['sc_total'] > $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['final'])) 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['final']; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['opcao_print'] != "print" && substr($_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['opcao'], 0, 7) != "detalhe" && $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['opcao'] != "pdf") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['opcao'] = "igual"; 
   } 
   $this->Rec_ini = $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['qt_reg_grid']; 
   if ($this->Rec_ini < 0) 
   { 
       $this->Rec_ini = 0; 
   } 
   $this->Rec_fim = $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['inicio'] + $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['qt_reg_grid'] + 1; 
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['sc_total']) && $this->Rec_fim > $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['sc_total']) 
   { 
       $this->Rec_fim = $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['sc_total']; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['inicio'] > 0) 
   { 
       $this->Rec_ini++ ; 
   } 
   $this->nmgp_reg_start = $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['inicio']; 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['inicio'] > 0) 
   { 
       $this->nmgp_reg_start-- ; 
   } 
...
//----- 
   ...
   $nmgp_order_by = ""; 
   $campos_order_select = "";
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['ordem_select'] as $campo => $ordem) 
   {
        if ($campo != $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['ordem_grid']) 
        {
   ...
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['ordem_grid'])) 
   { 
       $nmgp_order_by = " order by " . $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['ordem_grid'] . $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['ordem_desc']; 
   } 
   if (!empty($campos_order_select)) 
   { 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['order_grid'] = $nmgp_order_by;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['opcao'] == "pdf" || $this->Ini->Apl_paginacao == "FULL")
   {
   ...
   {
       $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, " . ($_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['qt_reg_grid'] + 2) . ", $this->nmgp_reg_start)" ; 
       $this->rs_grid = $this->Db->SelectLimit($nmgp_select, $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['qt_reg_grid'] + 2, $this->nmgp_reg_start) ; 
   }  
   ...
   { 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['final'] = $this->nmgp_reg_start ; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['inicio'] != 0 && $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['opcao'] != "pdf") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['final']++ ; 
           $this->SC_seq_register = $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['final']; 
   ...
   $this->nmgp_reg_inicial = $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['final'] + 1;
   $this->nmgp_reg_final   = $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['final'] + $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['qt_reg_grid'];
   $this->nmgp_reg_final   = ($this->nmgp_reg_final > $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['tot_geral'][1]) ? $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['tot_geral'][1] : $this->nmgp_reg_final;
// 
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['embutida'])
   { 
       if (!$this->Ini->sc_export_ajax && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['opcao'] == "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['embutida_pdf'] != "pdf")
       {
           //---------- Gauge ----------
?>
...
<?php
           ...
           $this->progress_pdf     = 0;
           $this->progress_res     = isset($_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['pivot_charts']) ? sizeof($_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['pivot_charts']) : 0;
...
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['embutida'])
       { 
           $css_body = "";
       } 
       else 
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['ajax_nav'])
       { 
           ...
           $nm_saida->saida("    <input type=\"hidden\" name=\"script_case_session\" value=\"" . session_id() . "\">\r\n");
           $nm_saida->saida("   </form>\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\" src=\"kwitansiri_jquery.js\"></script>\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\" src=\"kwitansiri_ajax.js\"></script>\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\" src=\"kwitansiri_message.js\"></script>\r\n");
          ...
          $nm_saida->saida("   <script type=\"text/javascript\" src=\"" . $this->Ini->path_prod . "/third/jquery_plugin/malsup-blockui/jquery.blockUI.js\"></script>\r\n");
           ...
           $nm_saida->saida("   var scQtReg  = " . $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['qt_reg_grid'] . ";\r\n");
           ...
           $nm_saida->saida("       dataType: \"html\",\r\n");
           $nm_saida->saida("       url: \"kwitansiri_save_grid.php\",\r\n");
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['num_css']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['num_css'] = rand(0, 1000);
       }
       $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_kwitansiri_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['num_css'] . '.css', 'w');
       ...
       {
           $nm_saida->saida("  <style type=\"text/css\">\r\n");
           $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_kwitansiri_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['num_css'] . '.css');
       ...
       {
           $nm_saida->saida("   <link rel=\"stylesheet\" href=\"" . $this->Ini->path_imag_temp . "/sc_css_kwitansiri_grid_" . $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['num_css'] . ".css\" type=\"text/css\" media=\"screen\" />\r\n");
           $nm_saida->saida("   <link rel=\"stylesheet\" href=\"../_lib/css/" . $_SESSION['scriptcase']['erro']['str_schema'] . "\" type=\"text/css\" media=\"screen\" />\r\n");
           $nm_saida->saida("   <link rel=\"stylesheet\" href=\"../_lib/css/" . $_SESSION['scriptcase']['erro']['str_schema_dir'] . "\" type=\"text/css\" media=\"screen\" />\r\n");
       }
   } 
       ...
       if (!$this->Ini->Export_html_zip && !$_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['doc_word'] && ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['opcao_print'] == "print")) 
       {
           if ($this->Print_All) 
           {
               $nm_saida->saida(" <link rel=\"stylesheet\" type=\"text/css\" href=\"../_lib/buttons/" . $this->Ini->Str_btn_css . "\" /> \r\n");
       ...
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['opcao'] != "pdf" && !$this->Print_All)
       { 
...
//----- 
 function grid($linhas = 0)
 {
    global 
           $nm_saida;
   $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['labels']['trancode'] = "Kode Transaksi";
   $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['labels']['custcode'] = "No. RM";
   $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['labels']['dokter'] = "Dokter";
   $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['labels']['jmltagihan'] = "Jml Tagihan";
   $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['labels']['jmlbayar'] = "Jml Bayar";
   $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['labels']['deposit'] = "Deposit";
   $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['labels']['potongan'] = "Potongan";
   $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['labels']['hrsdibayar'] = "Hrs Dibayar";
   $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['labels']['trandate'] = "Tran Date";
   $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['labels']['terimadari'] = "Terima Dari";
   $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['labels']['jenispayment'] = "Jenis Payment";
   $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['labels']['sc_field_0'] = "Nama Pasien";
   $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['labels']['rp1'] = "Rp1";
   $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['labels']['rp2'] = "Rp2";
   $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['labels']['rp3'] = "Rp3";
   $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['labels']['adm'] = "adm";
   $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['labels']['biaya'] = "biaya";
   $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['labels']['biayaadm'] = "biayaadm";
   $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['labels']['biayaresep'] = "biayaresep";
   $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['labels']['jmlresep'] = "jmlResep";
   $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['labels']['jmltdk'] = "jmlTdk";
   $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['labels']['resep'] = "resep";
   $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['labels']['satuanresep'] = "satuanResep";
   $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['labels']['satuantdk'] = "satuanTdk";
   $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['labels']['terbilang'] = "terbilang";
   $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['labels']['tindakan'] = "tindakan";
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['embutida'])
   { 
   ...
   $this->sc_where_atual   = $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['where_pesq'];
   $this->sc_where_filtro  = $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['where_pesq_filtro'];
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['kwitansiri']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['kwitansiri']['lig_edit'] != '')
   {
       if ($_SESSION['scriptcase']['sc_apl_conf']['kwitansiri']['lig_edit'] == "on")  {$_SESSION['scriptcase']['sc_apl_conf']['kwitansiri']['lig_edit'] = "S";}
       if ($_SESSION['scriptcase']['sc_apl_conf']['kwitansiri']['lig_edit'] == "off") {$_SESSION['scriptcase']['sc_apl_conf']['kwitansiri']['lig_edit'] = "N";}
       $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['kwitansiri']['lig_edit'];
   }
   if (!empty($this->nm_grid_sem_reg))
   {
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['embutida'])
       {
           $nm_saida->saida("<table id=\"apl_kwitansiri#?#$nm_seq_execucoes\" width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\">\r\n");
       ...
       else
       {
           ...
           { 
               $this->force_toolbar = true;
               $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['force_toolbar'] = true;
           } 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['ajax_nav'])
           { 
               $_SESSION['scriptcase']['saida_html'] = "";
   ...
   { 
       $nm_id_aplicacao = " id=\"apl_kwitansiri#?#1\"";
   } 
// 
   $nm_quant_linhas = 0 ;
   ...
   while (!$this->rs_grid->EOF && $quant_tot_linhas < $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['qt_reg_grid']) 
   {  
     $nm_quant_linhas = 0;
     $this->nm_grid_colunas = 0;
     while (!$this->rs_grid->EOF && $nm_quant_linhas < $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['qt_col_grid'] && $quant_tot_linhas < $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['qt_reg_grid']) 
     {  
          $this->sc_proc_grid = true;
          //---------- Gauge ----------
          if (!$this->Ini->sc_export_ajax && $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['opcao'] == "pdf" && -1 < $this->progress_grid)
          {
              $this->progress_now++;
          ...
          $this->SC_seq_register = $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['final'] + 1; 
...
$_SESSION['scriptcase']['kwitansiri']['contr_erro'] = 'off';
   ...
   $sc_data_cab2 = $this->nm_data->FormataSaida("h:i");
     ...
     $nm_saida->saida("      <td class=\"tg-ox40\">:</td>\r\n");
     $nm_saida->saida("      <td class=\"tg-yw4l\">" . $this->trancode[$reg] . "</td>\r\n");
     $nm_saida->saida("      <td class=\"tg-yw4l\"></td>\r\n");
     $nm_saida->saida("    </tr>\r\n");
     $nm_saida->saida("    <tr>\r\n");
   ...
   if ($this->rs_grid->EOF)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['final'];
   }
   $this->rs_grid->Close();
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['ajax_nav'])
   { 
   ...
   function nmgp_barra_top_normal()
   {
      ...
      if ($this->nmgp_botoes['group_1'] == "on" && !$this->grid_emb_form)
      {
          ...
          $nm_saida->saida("           $Cod_Btn\r\n");
      if ($this->nmgp_botoes['pdf'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
      ...
      if ($this->nmgp_botoes['word'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $Tem_word_res = "n";
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['SC_Ind_Groupby'] != "sc_free_total")
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['SC_Ind_Groupby'] == "sc_free_group_by" && empty($_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['SC_Gb_Free_cmp']))
          {
              $Tem_word_res = "n";
          }
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "word_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "kwitansiri/kwitansiri_config_word.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=N&nm_cor=AM&nm_res_cons=" . $Tem_word_res . "&nm_ini_word_res=grid&nm_all_modules=grid&password=n&origem=cons&language=id&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      if ($this->nmgp_botoes['xls'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $Tem_xls_res = "n";
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['SC_Ind_Groupby'] != "sc_free_total")
      ...
      if ($this->nmgp_botoes['xml'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $Tem_xml_res = "n";
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['SC_Ind_Groupby'] != "sc_free_total")
      ...
      if ($this->nmgp_botoes['csv'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $Tem_csv_res = "n";
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['SC_Ind_Groupby'] != "sc_free_total")
      ...
      if ($this->nmgp_botoes['rtf'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
      ...
      if ($this->nmgp_botoes['print'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $Tem_pdf_res = "n";
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "print_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "kwitansiri/kwitansiri_config_print.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=N&nm_opc=PC&nm_cor=PB&password=n&language=id&nm_page=" . NM_encode_input($this->Ini->sc_page) . "&nm_res_cons=" . $Tem_pdf_res . "&nm_ini_prt_res=grid&nm_all_modules=grid&origem=cons&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      ...
      $nm_saida->saida("          <td class=\"" . $this->css_scGridToolbarPadd . "\" nowrap valign=\"middle\" align=\"right\" width=\"33%\"> \r\n");
          if (is_file("kwitansiri_help.txt") && !$this->grid_emb_form)
          {
             $Arq_WebHelp = file("kwitansiri_help.txt"); 
      ...
      $nm_saida->saida("        </tr> \r\n");
      $nm_saida->saida("       </table> \r\n");
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['ajax_nav'] && $this->force_toolbar)
      { 
   ...
   function nmgp_barra_top_mobile()
   {
      ...
      if (!$this->Ini->SC_Link_View && $this->nmgp_botoes['qsearch'] == "on")
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['fast_search'][2] : "";
      ...
      if ($this->nmgp_botoes['sort_col'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          ...
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bsort", "scBtnOrderCamposShow('" . $this->Ini->path_link . "kwitansiri/kwitansiri_order_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&use_alias=" . $UseAlias . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "scBtnOrderCamposShow('" . $this->Ini->path_link . "kwitansiri/kwitansiri_order_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&use_alias=" . $UseAlias . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "ordcmp_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "group_2", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['b_sair'] || $this->grid_emb_form || $this->grid_emb_form_full || (isset($_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['dashboard_info']['under_dashboard']))
      {
         $this->nmgp_botoes['exit'] = "off"; 
      }
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['opc_psq'])
      {
      ...
      {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['sc_modal'])
        {
   ...
   function nmgp_barra_bot_mobile()
   {
      ...
      {
          if ($this->nmgp_botoes['first'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['opc_liga']['nav']))
          {
              if ($this->Rec_ini == 0)
              {
          ...
          if ($this->nmgp_botoes['back'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['opc_liga']['nav']))
          {
              if ($this->Rec_ini == 0)
              {
          ...
          if ($this->nmgp_botoes['forward'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['opc_liga']['nav']))
          {
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcons_avanca", "nm_gp_submit_rec('" . $this->Rec_fim . "');", "nm_gp_submit_rec('" . $this->Rec_fim . "');", "forward_bot", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
              $NM_btn = true;
          }
          if ($this->nmgp_botoes['last'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['opc_liga']['nav']))
          {
 ...
 function nm_fim_grid($flag_apaga_pdf_log = TRUE)
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['embutida'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']))
   {
   ...
   $nm_saida->saida("   </body>\r\n");
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['opcao'] == "pdf" || $this->Print_All)
   { 
   $nm_saida->saida("   </HTML>\r\n");
        return;
   } 
   ...
   if ($this->Rec_ini == 0 && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
   { 
   } 
   elseif ($this->Rec_ini == 0 && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['opcao'] != "pdf" && $_SESSION['scriptcase']['proc_mobile'])
   { 
   ...
   $nm_saida->saida("   if (typeof(scSetFixedHeaders) === typeof(function(){})) scSetFixedHeaders();\r\n");
   $nm_saida->saida("  });\r\n");
   if ($this->rs_grid->EOF && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['opcao'] != "pdf")
   {
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['opcao'] != "pdf" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['opc_liga']['nav']) && !$_SESSION['scriptcase']['proc_mobile'])
       { 
       } 
       elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['opcao'] != "pdf" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['opc_liga']['nav']) && $_SESSION['scriptcase']['proc_mobile'])
       { 
           { 
   ...
   if ($this->grid_emb_form || $this->grid_emb_form_full)
   {
       ...
       $nm_saida->saida("         setTimeout(\"parent.scAjaxDetailHeight('kwitansiri', $(document).innerHeight())\",50);\r\n");
       $nm_saida->saida("      }\r\n");
       $nm_saida->saida("   </script>\r\n");
   }
   $nm_saida->saida("   </HTML>\r\n");
...
//--- 
 function form_navegacao()
 {
   ...
   $nm_saida->saida("    <input type=\"hidden\" name=\"SC_lig_apl_orig\" value=\"kwitansiri\"/>\r\n");
   ...
   $nm_saida->saida("                     action=\"kwitansiri_pesq.class.php\" \r\n");
   $nm_saida->saida("                     target=\"_self\" style=\"display: none\"> \r\n");
   $nm_saida->saida("    <input type=\"hidden\" name=\"script_case_init\" value=\"" . NM_encode_input($this->Ini->sc_page) . "\"/> \r\n");
   $nm_saida->saida("    <input type=\"hidden\" name=\"script_case_session\" value=\"" . NM_encode_input(session_id()) . "\"/> \r\n");
   $nm_saida->saida("   </form> \r\n");
   ...
   $nm_saida->saida("                     action=\"kwitansiri_iframe_prt.php\" \r\n");
   ...
   $nm_saida->saida("               nm_submit_modal(\"" . $this->Ini->path_link . "kwitansiri/kwitansiri_export_email.php?script_case_init={$this->Ini->sc_page}&path_img={$this->Ini->path_img_global}&path_btn={$this->Ini->path_botoes}&sType=\"+ str_type +\"&sAdd=__E__nmgp_cor_word=\" + cor + \"__E__SC_module_export=\" + SC_module_export + \"__E__nmgp_password=\" + password + \"&KeepThis=true&TB_iframe=true&modal=true\", bol_param);\r\n");
   $nm_saida->saida("       }\r\n");
   $nm_saida->saida("       else\r\n");
   $nm_saida->saida("       {\r\n");
   ...
   $nm_saida->saida("           document.F3.SC_module_export.value = z;\r\n");
   $nm_saida->saida("       }\r\n");
   $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['kwitansiri_iframe_params'] = array(
   ...
   $Md5_pdf    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@kwitansiri@SC_par@" . md5($prep_parm_pdf);
   $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['Md5_pdf'][md5($prep_parm_pdf)] = $prep_parm_pdf;
   ...
   $nm_saida->saida("               document.Fprint.action = \"kwitansiri_export_ctrl.php\";\r\n");
   $nm_saida->saida("           }\r\n");
   $nm_saida->saida("           else\r\n");
   $nm_saida->saida("           {\r\n");
   ...
   $nm_saida->saida("           document.Fexport.nmgp_password.value = password;\r\n");
   $nm_saida->saida("           document.Fexport.SC_module_export.value = SC_module_export;\r\n");
   $nm_saida->saida("           document.Fexport.action = \"kwitansiri_export_ctrl.php\";\r\n");
   $nm_saida->saida("           document.Fexport.submit() ;\r\n");
   $nm_saida->saida("       }\r\n");
   $nm_saida->saida("   }\r\n");
   ...
   $nm_saida->saida("   {\r\n");
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['form_psq_ret']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['campo_psq_ret']) )
   {
      $nm_saida->saida("      if (document.Fpesq.nm_ret_psq.value != \"\")\r\n");
      $nm_saida->saida("      {\r\n");
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['sc_modal'])
      {
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['iframe_ret_cap']))
         {
             $Iframe_cap = $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['iframe_ret_cap'];
             unset($_SESSION['sc_session'][$script_case_init]['kwitansiri']['iframe_ret_cap']);
             $nm_saida->saida("           var Obj_Form  = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['campo_psq_ret'] . ";\r\n");
             $nm_saida->saida("           var Obj_Form1 = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['form_psq_ret'] . "." . str_replace("_autocomp", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['campo_psq_ret']) . ";\r\n");
             $nm_saida->saida("           var Obj_Doc   = parent.document.getElementById('" . $Iframe_cap . "').contentWindow;\r\n");
             $nm_saida->saida("           if (parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['campo_psq_ret'] . "\"))\r\n");
             $nm_saida->saida("           {\r\n");
             $nm_saida->saida("               var Obj_Readonly = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['campo_psq_ret'] . "\");\r\n");
             $nm_saida->saida("           }\r\n");
         }
         else
         {
             $nm_saida->saida("          var Obj_Form  = parent.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['campo_psq_ret'] . ";\r\n");
             $nm_saida->saida("          var Obj_Form1 = parent.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['form_psq_ret'] . "." . str_replace("_autocomp", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['campo_psq_ret']) . ";\r\n");
             $nm_saida->saida("          var Obj_Doc   = parent;\r\n");
             $nm_saida->saida("          if (parent.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['campo_psq_ret'] . "\"))\r\n");
             $nm_saida->saida("          {\r\n");
             $nm_saida->saida("              var Obj_Readonly = parent.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['campo_psq_ret'] . "\");\r\n");
             $nm_saida->saida("          }\r\n");
         }
      }
      else
      {
          $nm_saida->saida("          var Obj_Form  = opener.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['campo_psq_ret'] . ";\r\n");
          $nm_saida->saida("          var Obj_Form1 = opener.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['form_psq_ret'] . "." . str_replace("_autocomp", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['campo_psq_ret']) . ";\r\n");
          $nm_saida->saida("          var Obj_Doc   = opener;\r\n");
          $nm_saida->saida("          if (opener.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['campo_psq_ret'] . "\"))\r\n");
          $nm_saida->saida("          {\r\n");
          $nm_saida->saida("              var Obj_Readonly = opener.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['campo_psq_ret'] . "\");\r\n");
          $nm_saida->saida("          }\r\n");
      }
          $nm_saida->saida("          else\r\n");
          $nm_saida->saida("          {\r\n");
      ...
      $nm_saida->saida("              }\r\n");
     if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['js_apos_busca']))
     {
      $nm_saida->saida("              if (Obj_Doc." . $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['js_apos_busca'] . ")\r\n");
      $nm_saida->saida("              {\r\n");
      $nm_saida->saida("                  Obj_Doc." . $_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['js_apos_busca'] . "();\r\n");
      $nm_saida->saida("              }\r\n");
   ...
   $nm_saida->saida("      document.F5.action = \"kwitansiri_fim.php\";\r\n");
   ...
   $nm_saida->saida("   }\r\n");
   if (($this->grid_emb_form || $this->grid_emb_form_full) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['kwitansiri']['reg_start']))
   {
       $nm_saida->saida("      $(document).ready(function(){\r\n");
       $nm_saida->saida("         setTimeout(\"parent.scAjaxDetailStatus('kwitansiri')\",50);\r\n");
       $nm_saida->saida("         setTimeout(\"parent.scAjaxDetailHeight('kwitansiri', $(document).innerHeight())\",50);\r\n");
       $nm_saida->saida("      })\r\n");
   }
   $nm_saida->saida("   </script>\r\n");
