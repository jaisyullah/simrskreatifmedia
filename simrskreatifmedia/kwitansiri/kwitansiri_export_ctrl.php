<?php
@session_start() ;
$_SESSION['scriptcase']['kwitansiri']['sc_process_barr'] = true;
require_once('../kwitansiri/index.php');
unset($_SESSION['scriptcase']['kwitansiri']['sc_process_barr']);
$ExportCtrl = new kwitansiri_export_control;
$ExportCtrl->Export_barr();

class kwitansiri_export_control
{
