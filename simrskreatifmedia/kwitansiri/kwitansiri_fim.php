...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____kwitansiri"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____kwitansiri"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['kwitansiri']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['kwitansiri']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['kwitansiri']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['kwitansiri']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['kwitansiri']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['kwitansiri']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['kwitansiri']['embutida_filho'] as $ind => $sc_init)
          {
