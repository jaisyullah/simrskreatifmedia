<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['kwitansiri']['glo_nm_path_imag_temp'] . "/sc_apl_default_simrskreatifmedia.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new kwitansiri_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class kwitansiri_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['kwitansiri']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['kwitansiri']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["trancode"]   = (isset($_SESSION['sc_session'][$sc_init]['kwitansiri']['labels']["trancode"])) ? $_SESSION['sc_session'][$sc_init]['kwitansiri']['labels']["trancode"] : "Kode Transaksi";
   $tab_ger_campos['custcode'] = "on";
   $tab_def_campos['custcode'] = "custCode";
   $tab_labels["custcode"]   = (isset($_SESSION['sc_session'][$sc_init]['kwitansiri']['labels']["custcode"])) ? $_SESSION['sc_session'][$sc_init]['kwitansiri']['labels']["custcode"] : "No. RM";
   $tab_ger_campos['dokter'] = "on";
   $tab_def_campos['dokter'] = "dokter";
   $tab_labels["dokter"]   = (isset($_SESSION['sc_session'][$sc_init]['kwitansiri']['labels']["dokter"])) ? $_SESSION['sc_session'][$sc_init]['kwitansiri']['labels']["dokter"] : "Dokter";
   $tab_ger_campos['jmltagihan'] = "on";
   $tab_def_campos['jmltagihan'] = "jmlTagihan";
   $tab_labels["jmltagihan"]   = (isset($_SESSION['sc_session'][$sc_init]['kwitansiri']['labels']["jmltagihan"])) ? $_SESSION['sc_session'][$sc_init]['kwitansiri']['labels']["jmltagihan"] : "Jml Tagihan";
   $tab_ger_campos['jmlbayar'] = "on";
   $tab_def_campos['jmlbayar'] = "jmlBayar";
   $tab_labels["jmlbayar"]   = (isset($_SESSION['sc_session'][$sc_init]['kwitansiri']['labels']["jmlbayar"])) ? $_SESSION['sc_session'][$sc_init]['kwitansiri']['labels']["jmlbayar"] : "Jml Bayar";
   $tab_ger_campos['deposit'] = "on";
   $tab_def_campos['deposit'] = "deposit";
   $tab_labels["deposit"]   = (isset($_SESSION['sc_session'][$sc_init]['kwitansiri']['labels']["deposit"])) ? $_SESSION['sc_session'][$sc_init]['kwitansiri']['labels']["deposit"] : "Deposit";
   $tab_ger_campos['potongan'] = "on";
   $tab_def_campos['potongan'] = "potongan";
   $tab_labels["potongan"]   = (isset($_SESSION['sc_session'][$sc_init]['kwitansiri']['labels']["potongan"])) ? $_SESSION['sc_session'][$sc_init]['kwitansiri']['labels']["potongan"] : "Potongan";
   $tab_ger_campos['hrsdibayar'] = "on";
   $tab_def_campos['hrsdibayar'] = "hrsDibayar";
   $tab_labels["hrsdibayar"]   = (isset($_SESSION['sc_session'][$sc_init]['kwitansiri']['labels']["hrsdibayar"])) ? $_SESSION['sc_session'][$sc_init]['kwitansiri']['labels']["hrsdibayar"] : "Hrs Dibayar";
   $tab_ger_campos['trandate'] = "on";
   $tab_def_campos['trandate'] = "tranDate";
   $tab_labels["trandate"]   = (isset($_SESSION['sc_session'][$sc_init]['kwitansiri']['labels']["trandate"])) ? $_SESSION['sc_session'][$sc_init]['kwitansiri']['labels']["trandate"] : "Tran Date";
   $tab_ger_campos['terimadari'] = "on";
   $tab_def_campos['terimadari'] = "terimaDari";
   $tab_labels["terimadari"]   = (isset($_SESSION['sc_session'][$sc_init]['kwitansiri']['labels']["terimadari"])) ? $_SESSION['sc_session'][$sc_init]['kwitansiri']['labels']["terimadari"] : "Terima Dari";
   $tab_ger_campos['jenispayment'] = "on";
   $tab_def_campos['jenispayment'] = "jenisPayment";
   $tab_labels["jenispayment"]   = (isset($_SESSION['sc_session'][$sc_init]['kwitansiri']['labels']["jenispayment"])) ? $_SESSION['sc_session'][$sc_init]['kwitansiri']['labels']["jenispayment"] : "Jenis Payment";
...
ORDER BY name, salut";
   ...
   $tab_labels["sc_field_0"]   = (isset($_SESSION['sc_session'][$sc_init]['kwitansiri']['labels']["sc_field_0"])) ? $_SESSION['sc_session'][$sc_init]['kwitansiri']['labels']["sc_field_0"] : "Nama Pasien";
   ...
   $tab_labels["rp1"]   = (isset($_SESSION['sc_session'][$sc_init]['kwitansiri']['labels']["rp1"])) ? $_SESSION['sc_session'][$sc_init]['kwitansiri']['labels']["rp1"] : "Rp1";
   ...
   $tab_labels["rp2"]   = (isset($_SESSION['sc_session'][$sc_init]['kwitansiri']['labels']["rp2"])) ? $_SESSION['sc_session'][$sc_init]['kwitansiri']['labels']["rp2"] : "Rp2";
   ...
   $tab_labels["rp3"]   = (isset($_SESSION['sc_session'][$sc_init]['kwitansiri']['labels']["rp3"])) ? $_SESSION['sc_session'][$sc_init]['kwitansiri']['labels']["rp3"] : "Rp3";
   ...
   $tab_labels["adm"]   = (isset($_SESSION['sc_session'][$sc_init]['kwitansiri']['labels']["adm"])) ? $_SESSION['sc_session'][$sc_init]['kwitansiri']['labels']["adm"] : "adm";
   ...
   $tab_labels["biaya"]   = (isset($_SESSION['sc_session'][$sc_init]['kwitansiri']['labels']["biaya"])) ? $_SESSION['sc_session'][$sc_init]['kwitansiri']['labels']["biaya"] : "biaya";
   ...
   $tab_labels["biayaadm"]   = (isset($_SESSION['sc_session'][$sc_init]['kwitansiri']['labels']["biayaadm"])) ? $_SESSION['sc_session'][$sc_init]['kwitansiri']['labels']["biayaadm"] : "biayaadm";
   ...
   $tab_labels["biayaresep"]   = (isset($_SESSION['sc_session'][$sc_init]['kwitansiri']['labels']["biayaresep"])) ? $_SESSION['sc_session'][$sc_init]['kwitansiri']['labels']["biayaresep"] : "biayaresep";
   ...
   $tab_labels["jmlresep"]   = (isset($_SESSION['sc_session'][$sc_init]['kwitansiri']['labels']["jmlresep"])) ? $_SESSION['sc_session'][$sc_init]['kwitansiri']['labels']["jmlresep"] : "jmlResep";
   ...
   $tab_labels["jmltdk"]   = (isset($_SESSION['sc_session'][$sc_init]['kwitansiri']['labels']["jmltdk"])) ? $_SESSION['sc_session'][$sc_init]['kwitansiri']['labels']["jmltdk"] : "jmlTdk";
   ...
   $tab_labels["resep"]   = (isset($_SESSION['sc_session'][$sc_init]['kwitansiri']['labels']["resep"])) ? $_SESSION['sc_session'][$sc_init]['kwitansiri']['labels']["resep"] : "resep";
   ...
   $tab_labels["satuanresep"]   = (isset($_SESSION['sc_session'][$sc_init]['kwitansiri']['labels']["satuanresep"])) ? $_SESSION['sc_session'][$sc_init]['kwitansiri']['labels']["satuanresep"] : "satuanResep";
   ...
   $tab_labels["satuantdk"]   = (isset($_SESSION['sc_session'][$sc_init]['kwitansiri']['labels']["satuantdk"])) ? $_SESSION['sc_session'][$sc_init]['kwitansiri']['labels']["satuantdk"] : "satuanTdk";
   ...
   $tab_labels["terbilang"]   = (isset($_SESSION['sc_session'][$sc_init]['kwitansiri']['labels']["terbilang"])) ? $_SESSION['sc_session'][$sc_init]['kwitansiri']['labels']["terbilang"] : "terbilang";
   ...
   $tab_labels["tindakan"]   = (isset($_SESSION['sc_session'][$sc_init]['kwitansiri']['labels']["tindakan"])) ? $_SESSION['sc_session'][$sc_init]['kwitansiri']['labels']["tindakan"] : "tindakan";
   ...
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['kwitansiri']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['kwitansiri']['field_display']))
   {
       foreach ($_SESSION['scriptcase']['sc_apl_conf']['kwitansiri']['field_display'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['kwitansiri']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['kwitansiri']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['kwitansiri']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['kwitansiri']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['kwitansiri']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['kwitansiri']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['kwitansiri']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['kwitansiri']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['kwitansiri']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "kwitansiri_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['kwitansiri']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['kwitansiri']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['kwitansiri']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['kwitansiri']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['kwitansiri']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
