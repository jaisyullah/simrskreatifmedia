  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbnpo_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbnpo_mob_form();
	}

  // ---------- Validate npocode
  function do_ajax_form_tbnpo_mob_validate_npocode()
  {
    var nomeCampo_npocode = "npocode";
    var var_npocode = scAjaxGetFieldText(nomeCampo_npocode);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbnpo_mob_validate_npocode(var_npocode, var_script_case_init, do_ajax_form_tbnpo_mob_validate_npocode_cb);
  } // do_ajax_form_tbnpo_mob_validate_npocode

  function do_ajax_form_tbnpo_mob_validate_npocode_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbnpo_mob_validate_npocode_cb

  // ---------- Validate jenis
  function do_ajax_form_tbnpo_mob_validate_jenis()
  {
    var nomeCampo_jenis = "jenis";
    var var_jenis = scAjaxGetFieldRadio(nomeCampo_jenis);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbnpo_mob_validate_jenis(var_jenis, var_script_case_init, do_ajax_form_tbnpo_mob_validate_jenis_cb);
  } // do_ajax_form_tbnpo_mob_validate_jenis

  function do_ajax_form_tbnpo_mob_validate_jenis_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "jenis";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbnpo_mob_validate_jenis_cb

  // ---------- Validate alasan
  function do_ajax_form_tbnpo_mob_validate_alasan()
  {
    var nomeCampo_alasan = "alasan";
    var var_alasan = scAjaxGetFieldText(nomeCampo_alasan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbnpo_mob_validate_alasan(var_alasan, var_script_case_init, do_ajax_form_tbnpo_mob_validate_alasan_cb);
  } // do_ajax_form_tbnpo_mob_validate_alasan

  function do_ajax_form_tbnpo_mob_validate_alasan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "alasan";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbnpo_mob_validate_alasan_cb

  // ---------- Validate pj
  function do_ajax_form_tbnpo_mob_validate_pj()
  {
    var nomeCampo_pj = "pj";
    var var_pj = scAjaxGetFieldText(nomeCampo_pj);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbnpo_mob_validate_pj(var_pj, var_script_case_init, do_ajax_form_tbnpo_mob_validate_pj_cb);
  } // do_ajax_form_tbnpo_mob_validate_pj

  function do_ajax_form_tbnpo_mob_validate_pj_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pj";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbnpo_mob_validate_pj_cb

  // ---------- Validate npodate
  function do_ajax_form_tbnpo_mob_validate_npodate()
  {
    var nomeCampo_npodate = "npodate";
    var var_npodate = scAjaxGetFieldText(nomeCampo_npodate);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbnpo_mob_validate_npodate(var_npodate, var_script_case_init, do_ajax_form_tbnpo_mob_validate_npodate_cb);
  } // do_ajax_form_tbnpo_mob_validate_npodate

  function do_ajax_form_tbnpo_mob_validate_npodate_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "npodate";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbnpo_mob_validate_npodate_cb

  // ---------- Validate selesai
  function do_ajax_form_tbnpo_mob_validate_selesai()
  {
    var nomeCampo_selesai = "selesai";
    var var_selesai = scAjaxGetFieldSelect(nomeCampo_selesai);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbnpo_mob_validate_selesai(var_selesai, var_script_case_init, do_ajax_form_tbnpo_mob_validate_selesai_cb);
  } // do_ajax_form_tbnpo_mob_validate_selesai

  function do_ajax_form_tbnpo_mob_validate_selesai_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "selesai";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbnpo_mob_validate_selesai_cb

  // ---------- Validate detailnpo
  function do_ajax_form_tbnpo_mob_validate_detailnpo()
  {
    var nomeCampo_detailnpo = "detailnpo";
    var var_detailnpo = scAjaxGetFieldText(nomeCampo_detailnpo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbnpo_mob_validate_detailnpo(var_detailnpo, var_script_case_init, do_ajax_form_tbnpo_mob_validate_detailnpo_cb);
  } // do_ajax_form_tbnpo_mob_validate_detailnpo

  function do_ajax_form_tbnpo_mob_validate_detailnpo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "detailnpo";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbnpo_mob_validate_detailnpo_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tbnpo_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tbnpo_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_npocode = scAjaxGetFieldText("npocode");
    var var_jenis = scAjaxGetFieldRadio("jenis");
    var var_alasan = scAjaxGetFieldText("alasan");
    var var_pj = scAjaxGetFieldText("pj");
    var var_npodate = scAjaxGetFieldText("npodate");
    ...
    scAjaxProcOn();
    x_ajax_form_tbnpo_mob_submit_form(var_npocode, var_jenis, var_alasan, var_pj, var_npodate, var_selesai, var_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbnpo_mob_submit_form_cb);
  } // do_ajax_form_tbnpo_mob_submit_form

  function do_ajax_form_tbnpo_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("npocode");
      scAjaxHideErrorDisplay("jenis");
      scAjaxHideErrorDisplay("alasan");
      scAjaxHideErrorDisplay("pj");
      scAjaxHideErrorDisplay("npodate");
      scAjaxHideErrorDisplay("selesai");
      scAjaxHideErrorDisplay("detailnpo");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tbnpo_mob_submit_form_cb_after_alert);
  } // do_ajax_form_tbnpo_mob_submit_form_cb
  function do_ajax_form_tbnpo_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbnpo_mob_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_tbdetailnpo_mob"] = "off";

  function do_ajax_form_tbnpo_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    scStatusDetail["form_tbdetailnpo_mob"] = "on";
    x_ajax_form_tbnpo_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbnpo_mob_navigate_form_cb);
  } // do_ajax_form_tbnpo_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbnpo_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbnpo_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_tbdetailnpo_mob"] && "nmsc_iframe_liga_form_tbdetailnpo_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_tbdetailnpo_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_tbdetailnpo_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_tbdetailnpo_mob').contentWindow.nm_move('apl_detalhe', true, '500');
        document.getElementById('nmsc_iframe_liga_form_tbdetailnpo_mob').style.height = "500";
        document.getElementById('nmsc_iframe_liga_form_tbdetailnpo_mob').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbnpo_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_tbnpo_mob_navigate_form_cb
  function do_ajax_form_tbnpo_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_tbnpo_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_tbnpo_mob_navigate_form_cb_after_alert
  function sc_hide_form_tbnpo_mob_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_tbdetailnpo_mob"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[0] = "npocode";
  ajax_field_list[1] = "jenis";
  ajax_field_list[2] = "alasan";
  ajax_field_list[3] = "pj";
  ajax_field_list[4] = "npodate";
  ajax_field_list[5] = "selesai";
  ajax_field_list[6] = "detailnpo";
  ...
  var ajax_error_list = {
    "npocode": {"label": "Kode PO Ext", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "jenis": {"label": "Jenis", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "alasan": {"label": "Alasan PO External", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "pj": {"label": "Penanggung Jawab", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "npodate": {"label": "Tgl. PO", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "selesai": {"label": "Selesai", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "detailnpo": {"label": "", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  ajax_field_mult["npocode"][1] = "npocode";
  ajax_field_mult["jenis"][1] = "jenis";
  ajax_field_mult["alasan"][1] = "alasan";
  ajax_field_mult["pj"][1] = "pj";
  ajax_field_mult["npodate"][1] = "npodate";
  ajax_field_mult["selesai"][1] = "selesai";
  ajax_field_mult["detailnpo"][1] = "detailnpo";

  var ajax_field_id = {
    "npocode": new Array("hidden_field_label_npocode", "hidden_field_data_npocode"),
    ...
    "npodate": new Array("hidden_field_label_npodate", "hidden_field_data_npodate"),
    "selesai": new Array("hidden_field_label_selesai", "hidden_field_data_selesai"),
    "detailnpo": new Array("hidden_field_label_detailnpo", "hidden_field_data_detailnpo")
  };
