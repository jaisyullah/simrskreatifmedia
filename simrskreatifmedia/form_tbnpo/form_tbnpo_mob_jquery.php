...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_npodate_hora' + iSeqRow).bind('blur', function() { sc_form_tbnpo_npodate_onblur(this, iSeqRow) })
                                          .bind('focus', function() { sc_form_tbnpo_npodate_onfocus(this, iSeqRow) });
...
function displayChange_field_detailnpo(row, status) {
	if ("on" == status && typeof $("#nmsc_iframe_liga_form_tbdetailnpo_mob")[0].contentWindow.scRecreateSelect2 === "function") {
		$("#nmsc_iframe_liga_form_tbdetailnpo_mob")[0].contentWindow.scRecreateSelect2();
	}
}
...
function scHidePage(pageNo) {
	$("#id_form_tbnpo_mob_form" + pageNo).hide();
}
