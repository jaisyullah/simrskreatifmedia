  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbnpo" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbnpo_form();
	}

  // ---------- Validate npocode
  function do_ajax_form_tbnpo_validate_npocode()
  {
    var nomeCampo_npocode = "npocode";
    var var_npocode = scAjaxGetFieldText(nomeCampo_npocode);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbnpo_validate_npocode(var_npocode, var_script_case_init, do_ajax_form_tbnpo_validate_npocode_cb);
  } // do_ajax_form_tbnpo_validate_npocode

  function do_ajax_form_tbnpo_validate_npocode_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbnpo_validate_npocode_cb

  // ---------- Validate jenis
  function do_ajax_form_tbnpo_validate_jenis()
  {
    var nomeCampo_jenis = "jenis";
    var var_jenis = scAjaxGetFieldRadio(nomeCampo_jenis);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbnpo_validate_jenis(var_jenis, var_script_case_init, do_ajax_form_tbnpo_validate_jenis_cb);
  } // do_ajax_form_tbnpo_validate_jenis

  function do_ajax_form_tbnpo_validate_jenis_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "jenis";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbnpo_validate_jenis_cb

  // ---------- Validate alasan
  function do_ajax_form_tbnpo_validate_alasan()
  {
    var nomeCampo_alasan = "alasan";
    var var_alasan = scAjaxGetFieldText(nomeCampo_alasan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbnpo_validate_alasan(var_alasan, var_script_case_init, do_ajax_form_tbnpo_validate_alasan_cb);
  } // do_ajax_form_tbnpo_validate_alasan

  function do_ajax_form_tbnpo_validate_alasan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "alasan";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbnpo_validate_alasan_cb

  // ---------- Validate pj
  function do_ajax_form_tbnpo_validate_pj()
  {
    var nomeCampo_pj = "pj";
    var var_pj = scAjaxGetFieldText(nomeCampo_pj);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbnpo_validate_pj(var_pj, var_script_case_init, do_ajax_form_tbnpo_validate_pj_cb);
  } // do_ajax_form_tbnpo_validate_pj

  function do_ajax_form_tbnpo_validate_pj_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pj";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbnpo_validate_pj_cb

  // ---------- Validate npodate
  function do_ajax_form_tbnpo_validate_npodate()
  {
    var nomeCampo_npodate = "npodate";
    var var_npodate = scAjaxGetFieldText(nomeCampo_npodate);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbnpo_validate_npodate(var_npodate, var_script_case_init, do_ajax_form_tbnpo_validate_npodate_cb);
  } // do_ajax_form_tbnpo_validate_npodate

  function do_ajax_form_tbnpo_validate_npodate_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "npodate";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbnpo_validate_npodate_cb

  // ---------- Validate selesai
  function do_ajax_form_tbnpo_validate_selesai()
  {
    var nomeCampo_selesai = "selesai";
    var var_selesai = scAjaxGetFieldSelect(nomeCampo_selesai);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbnpo_validate_selesai(var_selesai, var_script_case_init, do_ajax_form_tbnpo_validate_selesai_cb);
  } // do_ajax_form_tbnpo_validate_selesai

  function do_ajax_form_tbnpo_validate_selesai_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "selesai";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbnpo_validate_selesai_cb

  // ---------- Validate detailnpo
  function do_ajax_form_tbnpo_validate_detailnpo()
  {
    var nomeCampo_detailnpo = "detailnpo";
    var var_detailnpo = scAjaxGetFieldText(nomeCampo_detailnpo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbnpo_validate_detailnpo(var_detailnpo, var_script_case_init, do_ajax_form_tbnpo_validate_detailnpo_cb);
  } // do_ajax_form_tbnpo_validate_detailnpo

  function do_ajax_form_tbnpo_validate_detailnpo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbnpo_validate_detailnpo_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tbnpo_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tbnpo_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_tbnpo_submit_form(var_npocode, var_jenis, var_alasan, var_pj, var_npodate, var_selesai, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbnpo_submit_form_cb);
  } // do_ajax_form_tbnpo_submit_form

  function do_ajax_form_tbnpo_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tbnpo_submit_form_cb_after_alert);
  } // do_ajax_form_tbnpo_submit_form_cb
  function do_ajax_form_tbnpo_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbnpo_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_tbdetailnpo"] = "off";

  function do_ajax_form_tbnpo_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    scStatusDetail["form_tbdetailnpo"] = "on";
    x_ajax_form_tbnpo_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbnpo_navigate_form_cb);
  } // do_ajax_form_tbnpo_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbnpo']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbnpo_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_tbdetailnpo"] && "nmsc_iframe_liga_form_tbdetailnpo" != scMasterDetailIframe["nmsc_iframe_liga_form_tbdetailnpo"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_tbdetailnpo"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_tbdetailnpo').contentWindow.nm_move('apl_detalhe', true, '500');
        document.getElementById('nmsc_iframe_liga_form_tbdetailnpo').style.height = "500";
        document.getElementById('nmsc_iframe_liga_form_tbdetailnpo').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbnpo_navigate_form_cb_after_alert);
  } // do_ajax_form_tbnpo_navigate_form_cb
  function do_ajax_form_tbnpo_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_tbnpo_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_tbnpo_navigate_form_cb_after_alert
  function sc_hide_form_tbnpo_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_tbdetailnpo"])
    {
      return true;
    }
    return false;
