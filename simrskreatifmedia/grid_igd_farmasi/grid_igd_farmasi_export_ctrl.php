<?php
@session_start() ;
$_SESSION['scriptcase']['grid_igd_farmasi']['sc_process_barr'] = true;
require_once('../grid_igd_farmasi/index.php');
unset($_SESSION['scriptcase']['grid_igd_farmasi']['sc_process_barr']);
$ExportCtrl = new grid_igd_farmasi_export_control;
$ExportCtrl->Export_barr();

class grid_igd_farmasi_export_control
{
