<?php
@session_start() ;
$_SESSION['scriptcase']['cetak_antrian']['sc_process_barr'] = true;
require_once('../cetak_antrian/index.php');
unset($_SESSION['scriptcase']['cetak_antrian']['sc_process_barr']);
$ExportCtrl = new cetak_antrian_export_control;
$ExportCtrl->Export_barr();

class cetak_antrian_export_control
{
