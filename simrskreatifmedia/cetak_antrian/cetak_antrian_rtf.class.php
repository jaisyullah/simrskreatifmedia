...
class cetak_antrian_rtf
{
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "cetak_antrian.rtf";
   }
   //---- 
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      $nm_raiz_img  = ""; 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cetak_antrian']['rtf_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['cetak_antrian']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['cetak_antrian']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['cetak_antrian']['rtf_name']);
      }
...
$_SESSION['scriptcase']['cetak_antrian']['contr_erro'] = 'off'; 
   ...
   function NM_export_a_doctor()
   {
         ...
         $this->a_doctor = str_replace('<', '&lt;', $this->a_doctor);
         $this->a_doctor = str_replace('>', '&gt;', $this->a_doctor);
         $this->Texto_tag .= "<td>" . $this->a_doctor . "</td>\r\n";
   }
   //----- sc_field_9
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['cetak_antrian']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['cetak_antrian']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
