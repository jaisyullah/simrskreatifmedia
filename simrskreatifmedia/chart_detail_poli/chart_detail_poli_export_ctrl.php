<?php
@session_start() ;
$_SESSION['scriptcase']['chart_detail_poli']['sc_process_barr'] = true;
require_once('../chart_detail_poli/index.php');
unset($_SESSION['scriptcase']['chart_detail_poli']['sc_process_barr']);
$ExportCtrl = new chart_detail_poli_export_control;
$ExportCtrl->Export_barr();

class chart_detail_poli_export_control
{
