  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbreqdetail" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbreqdetail_form();
	}

  // ---------- Validate item_
  function do_ajax_form_tbreqdetail_validate_item_(iNumLinha)
  {
    var nomeCampo_item_ = "item_" + iNumLinha;
    var var_item_ = scAjaxGetFieldSelect(nomeCampo_item_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbreqdetail_validate_item_(var_item_, iNumLinha, var_script_case_init, do_ajax_form_tbreqdetail_validate_item__cb);
  } // do_ajax_form_tbreqdetail_validate_item_

  function do_ajax_form_tbreqdetail_validate_item__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbreqdetail_validate_item__cb

  // ---------- Validate jumlah_
  function do_ajax_form_tbreqdetail_validate_jumlah_(iNumLinha)
  {
    var nomeCampo_jumlah_ = "jumlah_" + iNumLinha;
    var var_jumlah_ = scAjaxGetFieldText(nomeCampo_jumlah_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbreqdetail_validate_jumlah_(var_jumlah_, iNumLinha, var_script_case_init, do_ajax_form_tbreqdetail_validate_jumlah__cb);
  } // do_ajax_form_tbreqdetail_validate_jumlah_

  function do_ajax_form_tbreqdetail_validate_jumlah__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbreqdetail_validate_jumlah__cb

  // ---------- Validate kemasan_
  function do_ajax_form_tbreqdetail_validate_kemasan_(iNumLinha)
  {
    var nomeCampo_kemasan_ = "kemasan_" + iNumLinha;
    var var_kemasan_ = scAjaxGetFieldText(nomeCampo_kemasan_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbreqdetail_validate_kemasan_(var_kemasan_, iNumLinha, var_script_case_init, do_ajax_form_tbreqdetail_validate_kemasan__cb);
  } // do_ajax_form_tbreqdetail_validate_kemasan_

  function do_ajax_form_tbreqdetail_validate_kemasan__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbreqdetail_validate_kemasan__cb

  // ---------- Validate isi_
  function do_ajax_form_tbreqdetail_validate_isi_(iNumLinha)
  {
    var nomeCampo_isi_ = "isi_" + iNumLinha;
    var var_isi_ = scAjaxGetFieldText(nomeCampo_isi_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbreqdetail_validate_isi_(var_isi_, iNumLinha, var_script_case_init, do_ajax_form_tbreqdetail_validate_isi__cb);
  } // do_ajax_form_tbreqdetail_validate_isi_

  function do_ajax_form_tbreqdetail_validate_isi__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbreqdetail_validate_isi__cb

  // ---------- Validate totalisi_
  function do_ajax_form_tbreqdetail_validate_totalisi_(iNumLinha)
  {
    var nomeCampo_totalisi_ = "totalisi_" + iNumLinha;
    var var_totalisi_ = scAjaxGetFieldText(nomeCampo_totalisi_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbreqdetail_validate_totalisi_(var_totalisi_, iNumLinha, var_script_case_init, do_ajax_form_tbreqdetail_validate_totalisi__cb);
  } // do_ajax_form_tbreqdetail_validate_totalisi_

  function do_ajax_form_tbreqdetail_validate_totalisi__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbreqdetail_validate_totalisi__cb

  // ---------- Validate principal_
  function do_ajax_form_tbreqdetail_validate_principal_(iNumLinha)
  {
    var nomeCampo_principal_ = "principal_" + iNumLinha;
    var var_principal_ = scAjaxGetFieldText(nomeCampo_principal_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbreqdetail_validate_principal_(var_principal_, iNumLinha, var_script_case_init, do_ajax_form_tbreqdetail_validate_principal__cb);
  } // do_ajax_form_tbreqdetail_validate_principal_

  function do_ajax_form_tbreqdetail_validate_principal__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbreqdetail_validate_principal__cb

  // ---------- Validate po_
  function do_ajax_form_tbreqdetail_validate_po_(iNumLinha)
  {
    var nomeCampo_po_ = "po_" + iNumLinha;
    var var_po_ = scAjaxGetFieldText(nomeCampo_po_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbreqdetail_validate_po_(var_po_, iNumLinha, var_script_case_init, do_ajax_form_tbreqdetail_validate_po__cb);
  } // do_ajax_form_tbreqdetail_validate_po_

  function do_ajax_form_tbreqdetail_validate_po__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbreqdetail_validate_po__cb

  // ---------- Event onchange isi_
  function do_ajax_form_tbreqdetail_event_isi__onchange(iSeqForm)
  {
    ...
    scAjaxProcOn(true);
    x_ajax_form_tbreqdetail_event_isi__onchange(var_jumlah_, var_totalisi_, var_isi_, var_subtotal_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_tbreqdetail_event_isi__onchange_cb);
  } // do_ajax_form_tbreqdetail_event_isi__onchange

  function do_ajax_form_tbreqdetail_event_isi__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_tbreqdetail_event_isi__onchange_cb_after_alert);
  } // do_ajax_form_tbreqdetail_event_isi__onchange_cb
  function do_ajax_form_tbreqdetail_event_isi__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_tbreqdetail_event_isi__onchange_cb_after_alert

  // ---------- Event onchange item_
  function do_ajax_form_tbreqdetail_event_item__onchange(iSeqForm)
  {
    ...
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_tbreqdetail_event_item__onchange(var_item_, var_kemasan_, var_isi_, var_po_, var_principal_, var_disc_, var_harga_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_tbreqdetail_event_item__onchange_cb);
  } // do_ajax_form_tbreqdetail_event_item__onchange

  function do_ajax_form_tbreqdetail_event_item__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_tbreqdetail_event_item__onchange_cb_after_alert);
  } // do_ajax_form_tbreqdetail_event_item__onchange_cb
  function do_ajax_form_tbreqdetail_event_item__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_tbreqdetail_event_item__onchange_cb_after_alert

  // ---------- Event onchange jumlah_
  function do_ajax_form_tbreqdetail_event_jumlah__onchange(iSeqForm)
  {
    var var_jumlah_ = scAjaxGetFieldText("jumlah_" + iSeqForm);
    var var_totalisi_ = scAjaxGetFieldText("totalisi_" + iSeqForm);
    var var_isi_ = scAjaxGetFieldText("isi_" + iSeqForm);
    ...
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_tbreqdetail_event_jumlah__onchange(var_jumlah_, var_totalisi_, var_isi_, var_subtotal_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_tbreqdetail_event_jumlah__onchange_cb);
  } // do_ajax_form_tbreqdetail_event_jumlah__onchange

  function do_ajax_form_tbreqdetail_event_jumlah__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_tbreqdetail_event_jumlah__onchange_cb_after_alert);
  } // do_ajax_form_tbreqdetail_event_jumlah__onchange_cb
  function do_ajax_form_tbreqdetail_event_jumlah__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_tbreqdetail_event_jumlah__onchange_cb_after_alert

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_tbreqdetail_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_tbreqdetail_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tbreqdetail_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_tbreqdetail_add_new_line_cb);
  } // do_ajax_form_tbreqdetail_add_new_line

  function do_ajax_form_tbreqdetail_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
    ...
    nm_field_disabled("totalisi_=disabled", "", iAjaxNewLine);
  } // do_ajax_form_tbreqdetail_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_tbreqdetail_backup_line(iNumLinha)
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbreqdetail_backup_line(var_po_, var_item_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_tbreqdetail_backup_line_cb);
  } // do_ajax_form_tbreqdetail_backup_line

  function do_ajax_form_tbreqdetail_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_tbreqdetail_backup_line_cb

  function do_ajax_form_tbreqdetail_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_tbreqdetail_cancel_insert

  function do_ajax_form_tbreqdetail_cancel_update(iSeqVert)
  {
    do_ajax_form_tbreqdetail_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_tbreqdetail_cancel_update

  function do_ajax_form_tbreqdetail_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_tbreqdetail_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_tbreqdetail_table_refresh()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tbreqdetail_table_refresh(var_po_, var_item_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbreqdetail_table_refresh_cb);
  } //  do_ajax_form_tbreqdetail_table_refresh

  function do_ajax_form_tbreqdetail_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_tbreqdetail_table_refresh_cb_after_alert);
  } // do_ajax_form_tbreqdetail_table_refresh_cb
  function do_ajax_form_tbreqdetail_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_tbreqdetail_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_tbreqdetail_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_tbreqdetail_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
...
?>
    x_ajax_form_tbreqdetail_submit_form(var_item_, var_jumlah_, var_kemasan_, var_isi_, var_totalisi_, var_principal_, var_po_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbreqdetail_submit_form_cb);
  } // do_ajax_form_tbreqdetail_submit_form

  function do_ajax_form_tbreqdetail_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_tbreqdetail_submit_form_cb_after_alert);
  } // do_ajax_form_tbreqdetail_submit_form_cb
  function do_ajax_form_tbreqdetail_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbreqdetail_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tbreqdetail_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_tbreqdetail_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tbreqdetail_navigate_form(var_po_, var_item_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbreqdetail_navigate_form_cb);
  } // do_ajax_form_tbreqdetail_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreqdetail']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbreqdetail_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbreqdetail_navigate_form_cb_after_alert);
  } // do_ajax_form_tbreqdetail_navigate_form_cb
  function do_ajax_form_tbreqdetail_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_tbreqdetail_navigate_form_cb_after_alert
  function sc_hide_form_tbreqdetail_form()
  {
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["item_" + iRow] || "on" == ajax_error_count["jumlah_" + iRow] || "on" == ajax_error_count["kemasan_" + iRow] || "on" == ajax_error_count["isi_" + iRow] || "on" == ajax_error_count["totalisi_" + iRow] || "on" == ajax_error_count["principal_" + iRow] || "on" == ajax_error_count["po_" + iRow]))
    {
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["item_" + iRow] && "off" == ajax_error_count["jumlah_" + iRow] && "off" == ajax_error_count["kemasan_" + iRow] && "off" == ajax_error_count["isi_" + iRow] && "off" == ajax_error_count["totalisi_" + iRow] && "off" == ajax_error_count["principal_" + iRow] && "off" == ajax_error_count["po_" + iRow]))
    {
      if (bErrorRow)
      {
