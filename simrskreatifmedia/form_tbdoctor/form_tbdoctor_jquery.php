...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_birthdate_hora' + iSeqRow).bind('blur', function() { sc_form_tbdoctor_birthdate_hora_onblur(this, iSeqRow) })
                                            .bind('focus', function() { sc_form_tbdoctor_birthdate_hora_onfocus(this, iSeqRow) });
  ...
  $('#id_sc_field_datesip_hora' + iSeqRow).bind('blur', function() { sc_form_tbdoctor_datesip_hora_onblur(this, iSeqRow) })
                                          .bind('focus', function() { sc_form_tbdoctor_datesip_hora_onfocus(this, iSeqRow) });
  ...
  $('#id_sc_field_joindate_hora' + iSeqRow).bind('blur', function() { sc_form_tbdoctor_joindate_hora_onblur(this, iSeqRow) })
                                           .bind('focus', function() { sc_form_tbdoctor_joindate_hora_onfocus(this, iSeqRow) });
...
function sc_form_tbdoctor_birthdate_hora_onblur(oThis, iSeqRow) {
  do_ajax_form_tbdoctor_validate_birthdate();
  scCssBlur(oThis);
}
...
function sc_form_tbdoctor_birthdate_hora_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function sc_form_tbdoctor_datesip_hora_onblur(oThis, iSeqRow) {
  do_ajax_form_tbdoctor_validate_datesip();
  scCssBlur(oThis);
}
...
function sc_form_tbdoctor_datesip_hora_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function sc_form_tbdoctor_joindate_hora_onblur(oThis, iSeqRow) {
  do_ajax_form_tbdoctor_validate_joindate();
  scCssBlur(oThis);
}
...
function sc_form_tbdoctor_joindate_hora_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function displayChange_field_rkk(row, status) {
	if ("on" == status && typeof $("#nmsc_iframe_liga_form_doctor_rkk")[0].contentWindow.scRecreateSelect2 === "function") {
		$("#nmsc_iframe_liga_form_doctor_rkk")[0].contentWindow.scRecreateSelect2();
	}
}
...
function scHidePage(pageNo) {
	$("#id_form_tbdoctor_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_birthdate" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_tbdoctor_validate_birthdate(iSeqRow);
    },
    numberOfMonths: 1,
    changeMonth: true,
    changeYear: true,
...
?>
  ...
  $("#id_sc_field_datesip" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_tbdoctor_validate_datesip(iSeqRow);
    },
    numberOfMonths: 1,
    changeMonth: true,
    changeYear: true,
...
?>
  ...
  $("#id_sc_field_joindate" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_tbdoctor_validate_joindate(iSeqRow);
    },
    numberOfMonths: 1,
    changeMonth: true,
    changeYear: true,
