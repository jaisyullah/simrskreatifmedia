  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbdoctor" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbdoctor_form();
	}

  // ---------- Validate doccode
  function do_ajax_form_tbdoctor_validate_doccode()
  {
    var nomeCampo_doccode = "doccode";
    var var_doccode = scAjaxGetFieldText(nomeCampo_doccode);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdoctor_validate_doccode(var_doccode, var_script_case_init, do_ajax_form_tbdoctor_validate_doccode_cb);
  } // do_ajax_form_tbdoctor_validate_doccode

  function do_ajax_form_tbdoctor_validate_doccode_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdoctor_validate_doccode_cb

  // ---------- Validate type
  function do_ajax_form_tbdoctor_validate_type()
  {
    var nomeCampo_type = "type";
    var var_type = scAjaxGetFieldSelect(nomeCampo_type);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdoctor_validate_type(var_type, var_script_case_init, do_ajax_form_tbdoctor_validate_type_cb);
  } // do_ajax_form_tbdoctor_validate_type

  function do_ajax_form_tbdoctor_validate_type_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "type";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdoctor_validate_type_cb

  // ---------- Validate name
  function do_ajax_form_tbdoctor_validate_name()
  {
    var nomeCampo_name = "name";
    var var_name = scAjaxGetFieldText(nomeCampo_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdoctor_validate_name(var_name, var_script_case_init, do_ajax_form_tbdoctor_validate_name_cb);
  } // do_ajax_form_tbdoctor_validate_name

  function do_ajax_form_tbdoctor_validate_name_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "name";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdoctor_validate_name_cb

  // ---------- Validate gelar
  function do_ajax_form_tbdoctor_validate_gelar()
  {
    var nomeCampo_gelar = "gelar";
    var var_gelar = scAjaxGetFieldText(nomeCampo_gelar);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdoctor_validate_gelar(var_gelar, var_script_case_init, do_ajax_form_tbdoctor_validate_gelar_cb);
  } // do_ajax_form_tbdoctor_validate_gelar

  function do_ajax_form_tbdoctor_validate_gelar_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "gelar";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdoctor_validate_gelar_cb

  // ---------- Validate spec
  function do_ajax_form_tbdoctor_validate_spec()
  {
    var nomeCampo_spec = "spec";
    var var_spec = scAjaxGetFieldText(nomeCampo_spec);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdoctor_validate_spec(var_spec, var_script_case_init, do_ajax_form_tbdoctor_validate_spec_cb);
  } // do_ajax_form_tbdoctor_validate_spec

  function do_ajax_form_tbdoctor_validate_spec_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "spec";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdoctor_validate_spec_cb

  // ---------- Validate birthdate
  function do_ajax_form_tbdoctor_validate_birthdate()
  {
    var nomeCampo_birthdate = "birthdate";
    var var_birthdate = scAjaxGetFieldText(nomeCampo_birthdate);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdoctor_validate_birthdate(var_birthdate, var_script_case_init, do_ajax_form_tbdoctor_validate_birthdate_cb);
  } // do_ajax_form_tbdoctor_validate_birthdate

  function do_ajax_form_tbdoctor_validate_birthdate_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdoctor_validate_birthdate_cb

  // ---------- Validate sex
  function do_ajax_form_tbdoctor_validate_sex()
  {
    var nomeCampo_sex = "sex";
    var var_sex = scAjaxGetFieldRadio(nomeCampo_sex);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdoctor_validate_sex(var_sex, var_script_case_init, do_ajax_form_tbdoctor_validate_sex_cb);
  } // do_ajax_form_tbdoctor_validate_sex

  function do_ajax_form_tbdoctor_validate_sex_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sex";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdoctor_validate_sex_cb

  // ---------- Validate address
  function do_ajax_form_tbdoctor_validate_address()
  {
    var nomeCampo_address = "address";
    var var_address = scAjaxGetFieldText(nomeCampo_address);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdoctor_validate_address(var_address, var_script_case_init, do_ajax_form_tbdoctor_validate_address_cb);
  } // do_ajax_form_tbdoctor_validate_address

  function do_ajax_form_tbdoctor_validate_address_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "address";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdoctor_validate_address_cb

  // ---------- Validate city
  function do_ajax_form_tbdoctor_validate_city()
  {
    var nomeCampo_city = "city";
    var var_city = scAjaxGetFieldText(nomeCampo_city);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdoctor_validate_city(var_city, var_script_case_init, do_ajax_form_tbdoctor_validate_city_cb);
  } // do_ajax_form_tbdoctor_validate_city

  function do_ajax_form_tbdoctor_validate_city_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "city";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdoctor_validate_city_cb

  // ---------- Validate hp
  function do_ajax_form_tbdoctor_validate_hp()
  {
    var nomeCampo_hp = "hp";
    var var_hp = scAjaxGetFieldText(nomeCampo_hp);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdoctor_validate_hp(var_hp, var_script_case_init, do_ajax_form_tbdoctor_validate_hp_cb);
  } // do_ajax_form_tbdoctor_validate_hp

  function do_ajax_form_tbdoctor_validate_hp_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "hp";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdoctor_validate_hp_cb

  // ---------- Validate phone
  function do_ajax_form_tbdoctor_validate_phone()
  {
    var nomeCampo_phone = "phone";
    var var_phone = scAjaxGetFieldText(nomeCampo_phone);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdoctor_validate_phone(var_phone, var_script_case_init, do_ajax_form_tbdoctor_validate_phone_cb);
  } // do_ajax_form_tbdoctor_validate_phone

  function do_ajax_form_tbdoctor_validate_phone_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "phone";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdoctor_validate_phone_cb

  // ---------- Validate poli
  function do_ajax_form_tbdoctor_validate_poli()
  {
    var nomeCampo_poli = "poli";
    nm_pack(nomeCampo_poli + '_dest', nomeCampo_poli);
    var var_poli = scAjaxGetFieldText(nomeCampo_poli);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdoctor_validate_poli(var_poli, var_script_case_init, do_ajax_form_tbdoctor_validate_poli_cb);
  } // do_ajax_form_tbdoctor_validate_poli

  function do_ajax_form_tbdoctor_validate_poli_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "poli";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdoctor_validate_poli_cb

  // ---------- Validate sip
  function do_ajax_form_tbdoctor_validate_sip()
  {
    var nomeCampo_sip = "sip";
    var var_sip = scAjaxGetFieldText(nomeCampo_sip);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdoctor_validate_sip(var_sip, var_script_case_init, do_ajax_form_tbdoctor_validate_sip_cb);
  } // do_ajax_form_tbdoctor_validate_sip

  function do_ajax_form_tbdoctor_validate_sip_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sip";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdoctor_validate_sip_cb

  // ---------- Validate datesip
  function do_ajax_form_tbdoctor_validate_datesip()
  {
    var nomeCampo_datesip = "datesip";
    var var_datesip = scAjaxGetFieldText(nomeCampo_datesip);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdoctor_validate_datesip(var_datesip, var_script_case_init, do_ajax_form_tbdoctor_validate_datesip_cb);
  } // do_ajax_form_tbdoctor_validate_datesip

  function do_ajax_form_tbdoctor_validate_datesip_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "datesip";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdoctor_validate_datesip_cb

  // ---------- Validate spr
  function do_ajax_form_tbdoctor_validate_spr()
  {
    var nomeCampo_spr = "spr";
    var var_spr = scAjaxGetFieldText(nomeCampo_spr);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdoctor_validate_spr(var_spr, var_script_case_init, do_ajax_form_tbdoctor_validate_spr_cb);
  } // do_ajax_form_tbdoctor_validate_spr

  function do_ajax_form_tbdoctor_validate_spr_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "spr";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdoctor_validate_spr_cb

  // ---------- Validate joindate
  function do_ajax_form_tbdoctor_validate_joindate()
  {
    var nomeCampo_joindate = "joindate";
    var var_joindate = scAjaxGetFieldText(nomeCampo_joindate);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdoctor_validate_joindate(var_joindate, var_script_case_init, do_ajax_form_tbdoctor_validate_joindate_cb);
  } // do_ajax_form_tbdoctor_validate_joindate

  function do_ajax_form_tbdoctor_validate_joindate_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdoctor_validate_joindate_cb

  // ---------- Validate npwp
  function do_ajax_form_tbdoctor_validate_npwp()
  {
    var nomeCampo_npwp = "npwp";
    var var_npwp = scAjaxGetFieldText(nomeCampo_npwp);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdoctor_validate_npwp(var_npwp, var_script_case_init, do_ajax_form_tbdoctor_validate_npwp_cb);
  } // do_ajax_form_tbdoctor_validate_npwp

  function do_ajax_form_tbdoctor_validate_npwp_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "npwp";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdoctor_validate_npwp_cb

  // ---------- Validate guaranteefee
  function do_ajax_form_tbdoctor_validate_guaranteefee()
  {
    var nomeCampo_guaranteefee = "guaranteefee";
    var var_guaranteefee = scAjaxGetFieldText(nomeCampo_guaranteefee);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdoctor_validate_guaranteefee(var_guaranteefee, var_script_case_init, do_ajax_form_tbdoctor_validate_guaranteefee_cb);
  } // do_ajax_form_tbdoctor_validate_guaranteefee

  function do_ajax_form_tbdoctor_validate_guaranteefee_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "guaranteefee";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdoctor_validate_guaranteefee_cb

  // ---------- Validate rkk
  function do_ajax_form_tbdoctor_validate_rkk()
  {
    var nomeCampo_rkk = "rkk";
    var var_rkk = scAjaxGetFieldText(nomeCampo_rkk);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdoctor_validate_rkk(var_rkk, var_script_case_init, do_ajax_form_tbdoctor_validate_rkk_cb);
  } // do_ajax_form_tbdoctor_validate_rkk

  function do_ajax_form_tbdoctor_validate_rkk_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "rkk";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdoctor_validate_rkk_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tbdoctor_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tbdoctor_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_doccode = scAjaxGetFieldText("doccode");
    var var_type = scAjaxGetFieldSelect("type");
    var var_name = scAjaxGetFieldText("name");
    var var_gelar = scAjaxGetFieldText("gelar");
    var var_spec = scAjaxGetFieldText("spec");
    var var_birthdate = scAjaxGetFieldText("birthdate");
    var var_sex = scAjaxGetFieldRadio("sex");
    ...
    nm_pack("poli_dest", "poli");
    var var_poli = scAjaxGetFieldText("poli");
    var var_sip = scAjaxGetFieldText("sip");
    var var_datesip = scAjaxGetFieldText("datesip");
    var var_spr = scAjaxGetFieldText("spr");
    var var_joindate = scAjaxGetFieldText("joindate");
    var var_npwp = scAjaxGetFieldText("npwp");
    var var_guaranteefee = scAjaxGetFieldText("guaranteefee");
    ...
    scAjaxProcOn();
    x_ajax_form_tbdoctor_submit_form(var_doccode, var_type, var_name, var_gelar, var_spec, var_birthdate, var_sex, var_address, var_city, var_hp, var_phone, var_poli, var_sip, var_datesip, var_spr, var_joindate, var_npwp, var_guaranteefee, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbdoctor_submit_form_cb);
  } // do_ajax_form_tbdoctor_submit_form

  function do_ajax_form_tbdoctor_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("gelar");
      scAjaxHideErrorDisplay("spec");
      ...
      scAjaxHideErrorDisplay("sip");
      scAjaxHideErrorDisplay("datesip");
      scAjaxHideErrorDisplay("spr");
      scAjaxHideErrorDisplay("joindate");
      scAjaxHideErrorDisplay("npwp");
      scAjaxHideErrorDisplay("guaranteefee");
      scAjaxHideErrorDisplay("rkk");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tbdoctor_submit_form_cb_after_alert);
  } // do_ajax_form_tbdoctor_submit_form_cb
  function do_ajax_form_tbdoctor_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbdoctor_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_doctor_rkk"] = "off";

  function do_ajax_form_tbdoctor_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    scStatusDetail["form_doctor_rkk"] = "on";
    x_ajax_form_tbdoctor_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbdoctor_navigate_form_cb);
  } // do_ajax_form_tbdoctor_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdoctor']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbdoctor_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_doctor_rkk"] && "nmsc_iframe_liga_form_doctor_rkk" != scMasterDetailIframe["nmsc_iframe_liga_form_doctor_rkk"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_doctor_rkk"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_doctor_rkk').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_doctor_rkk').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_doctor_rkk').style.display = "none";
    }
    scAjaxSetBtnVars();
    sc_change_tabs(true, 'hidden_bloco_2', 'id_tabs_2_2');
    sc_change_tabs(false, 'hidden_bloco_3', 'id_tabs_2_3');
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbdoctor_navigate_form_cb_after_alert);
  } // do_ajax_form_tbdoctor_navigate_form_cb
  function do_ajax_form_tbdoctor_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_tbdoctor_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_tbdoctor_navigate_form_cb_after_alert
  function sc_hide_form_tbdoctor_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_doctor_rkk"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[0] = "doccode";
  ajax_field_list[1] = "type";
  ajax_field_list[2] = "name";
  ajax_field_list[3] = "gelar";
  ajax_field_list[4] = "spec";
  ajax_field_list[5] = "birthdate";
  ajax_field_list[6] = "sex";
  ajax_field_list[7] = "address";
  ajax_field_list[8] = "city";
  ajax_field_list[9] = "hp";
  ajax_field_list[10] = "phone";
  ajax_field_list[11] = "poli";
  ajax_field_list[12] = "sip";
  ajax_field_list[13] = "datesip";
  ajax_field_list[14] = "spr";
  ajax_field_list[15] = "joindate";
  ajax_field_list[16] = "npwp";
  ajax_field_list[17] = "guaranteefee";
  ajax_field_list[18] = "rkk";
  ...
  var ajax_error_list = {
    "doccode": {"label": "Kode Paramedis", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "type": {"label": "Jenis", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "name": {"label": "Nama Lengkap", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "gelar": {"label": "Gelar", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "spec": {"label": "Spesialisasi", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "hp": {"label": "No. HP", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "sip": {"label": "No. SIP", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "datesip": {"label": "Tgl Habis SIP", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "spr": {"label": "No. SPR", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "joindate": {"label": "Tgl. Bergabung", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "npwp": {"label": "NPWP", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "guaranteefee": {"label": "Guarantee Fee", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "rkk": {"label": "", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  ajax_field_mult["sip"][1] = "sip";
  ajax_field_mult["datesip"][1] = "datesip";
  ajax_field_mult["spr"][1] = "spr";
  ajax_field_mult["joindate"][1] = "joindate";
  ajax_field_mult["npwp"][1] = "npwp";
  ajax_field_mult["guaranteefee"][1] = "guaranteefee";
  ajax_field_mult["rkk"][1] = "rkk";
  ...
  var ajax_field_id = {
    ...
    "gelar": new Array("hidden_field_label_gelar", "hidden_field_data_gelar"),
    "spec": new Array("hidden_field_label_spec", "hidden_field_data_spec"),
    ...
    "sip": new Array("hidden_field_label_sip", "hidden_field_data_sip"),
    "datesip": new Array("hidden_field_label_datesip", "hidden_field_data_datesip"),
    "spr": new Array("hidden_field_label_spr", "hidden_field_data_spr"),
    ...
    "guaranteefee": new Array("hidden_field_label_guaranteefee", "hidden_field_data_guaranteefee"),
    "rkk": new Array("hidden_field_label_rkk", "hidden_field_data_rkk")
  };
