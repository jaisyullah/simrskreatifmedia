...
function displayChange_field_tarif(row, status) {
	if ("on" == status && typeof $("#nmsc_iframe_liga_form_tariflab")[0].contentWindow.scRecreateSelect2 === "function") {
		$("#nmsc_iframe_liga_form_tariflab")[0].contentWindow.scRecreateSelect2();
	}
}
...
function scHidePage(pageNo) {
	$("#id_form_tbceklab_form" + pageNo).hide();
}
