  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbceklab_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbceklab_mob_form();
	}

  // ---------- Validate ceklab
  function do_ajax_form_tbceklab_mob_validate_ceklab()
  {
    var nomeCampo_ceklab = "ceklab";
    var var_ceklab = scAjaxGetFieldText(nomeCampo_ceklab);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbceklab_mob_validate_ceklab(var_ceklab, var_script_case_init, do_ajax_form_tbceklab_mob_validate_ceklab_cb);
  } // do_ajax_form_tbceklab_mob_validate_ceklab

  function do_ajax_form_tbceklab_mob_validate_ceklab_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbceklab_mob_validate_ceklab_cb

  // ---------- Validate namalab
  function do_ajax_form_tbceklab_mob_validate_namalab()
  {
    var nomeCampo_namalab = "namalab";
    var var_namalab = scAjaxGetFieldText(nomeCampo_namalab);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbceklab_mob_validate_namalab(var_namalab, var_script_case_init, do_ajax_form_tbceklab_mob_validate_namalab_cb);
  } // do_ajax_form_tbceklab_mob_validate_namalab

  function do_ajax_form_tbceklab_mob_validate_namalab_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "namalab";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbceklab_mob_validate_namalab_cb

  // ---------- Validate jenis
  function do_ajax_form_tbceklab_mob_validate_jenis()
  {
  } // do_ajax_form_tbceklab_mob_validate_jenis

  function do_ajax_form_tbceklab_mob_validate_jenis_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "jenis";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbceklab_mob_validate_jenis_cb

  // ---------- Validate pemeriksaan
  function do_ajax_form_tbceklab_mob_validate_pemeriksaan()
  {
    var nomeCampo_pemeriksaan = "pemeriksaan";
    var var_pemeriksaan = scAjaxGetFieldText(nomeCampo_pemeriksaan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbceklab_mob_validate_pemeriksaan(var_pemeriksaan, var_script_case_init, do_ajax_form_tbceklab_mob_validate_pemeriksaan_cb);
  } // do_ajax_form_tbceklab_mob_validate_pemeriksaan

  function do_ajax_form_tbceklab_mob_validate_pemeriksaan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbceklab_mob_validate_pemeriksaan_cb

  // ---------- Validate nilairujukandari
  function do_ajax_form_tbceklab_mob_validate_nilairujukandari()
  {
    var nomeCampo_nilairujukandari = "nilairujukandari";
    var var_nilairujukandari = scAjaxGetFieldText(nomeCampo_nilairujukandari);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbceklab_mob_validate_nilairujukandari(var_nilairujukandari, var_script_case_init, do_ajax_form_tbceklab_mob_validate_nilairujukandari_cb);
  } // do_ajax_form_tbceklab_mob_validate_nilairujukandari

  function do_ajax_form_tbceklab_mob_validate_nilairujukandari_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbceklab_mob_validate_nilairujukandari_cb

  // ---------- Validate nilairujukansampai
  function do_ajax_form_tbceklab_mob_validate_nilairujukansampai()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbceklab_mob_validate_nilairujukansampai(var_nilairujukansampai, var_script_case_init, do_ajax_form_tbceklab_mob_validate_nilairujukansampai_cb);
  } // do_ajax_form_tbceklab_mob_validate_nilairujukansampai

  function do_ajax_form_tbceklab_mob_validate_nilairujukansampai_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbceklab_mob_validate_nilairujukansampai_cb

  // ---------- Validate tarif
  function do_ajax_form_tbceklab_mob_validate_tarif()
  {
    var nomeCampo_tarif = "tarif";
    var var_tarif = scAjaxGetFieldText(nomeCampo_tarif);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbceklab_mob_validate_tarif(var_tarif, var_script_case_init, do_ajax_form_tbceklab_mob_validate_tarif_cb);
  } // do_ajax_form_tbceklab_mob_validate_tarif

  function do_ajax_form_tbceklab_mob_validate_tarif_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tarif";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbceklab_mob_validate_tarif_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tbceklab_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tbceklab_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_tbceklab_mob_submit_form(var_ceklab, var_namalab, var_jenis, var_nilairujukandari, var_nilairujukansampai, var_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbceklab_mob_submit_form_cb);
  } // do_ajax_form_tbceklab_mob_submit_form

  function do_ajax_form_tbceklab_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tbceklab_mob_submit_form_cb_after_alert);
  } // do_ajax_form_tbceklab_mob_submit_form_cb
  function do_ajax_form_tbceklab_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbceklab_mob_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_tbdetaillab_mob"] = "off";
  scStatusDetail["form_tariflab_mob"] = "off";

  function do_ajax_form_tbceklab_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scStatusDetail["form_tariflab_mob"] = "on";
    x_ajax_form_tbceklab_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbceklab_mob_navigate_form_cb);
  } // do_ajax_form_tbceklab_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbceklab_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbceklab_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_tariflab_mob"] && "nmsc_iframe_liga_form_tariflab_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_tariflab_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_tariflab_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_tariflab_mob').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_tariflab_mob').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_tariflab_mob').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbceklab_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_tbceklab_mob_navigate_form_cb
  function do_ajax_form_tbceklab_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_tbceklab_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_tbceklab_mob_navigate_form_cb_after_alert
  function sc_hide_form_tbceklab_mob_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_tbdetaillab_mob"] && "off" == scStatusDetail["form_tariflab_mob"])
    {
      return true;
    }
    return false;
