  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbdetailreturlog" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbdetailreturlog_form();
	}

  // ---------- Validate id_
  function do_ajax_form_tbdetailreturlog_validate_id_(iNumLinha)
  {
    var nomeCampo_id_ = "id_" + iNumLinha;
    var var_id_ = scAjaxGetFieldHidden(nomeCampo_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdetailreturlog_validate_id_(var_id_, iNumLinha, var_script_case_init, do_ajax_form_tbdetailreturlog_validate_id__cb);
  } // do_ajax_form_tbdetailreturlog_validate_id_

  function do_ajax_form_tbdetailreturlog_validate_id__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdetailreturlog_validate_id__cb

  // ---------- Validate item_
  function do_ajax_form_tbdetailreturlog_validate_item_(iNumLinha)
  {
  } // do_ajax_form_tbdetailreturlog_validate_item_

  function do_ajax_form_tbdetailreturlog_validate_item__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdetailreturlog_validate_item__cb

  // ---------- Validate qty_
  function do_ajax_form_tbdetailreturlog_validate_qty_(iNumLinha)
  {
    var nomeCampo_qty_ = "qty_" + iNumLinha;
    var var_qty_ = scAjaxGetFieldText(nomeCampo_qty_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdetailreturlog_validate_qty_(var_qty_, iNumLinha, var_script_case_init, do_ajax_form_tbdetailreturlog_validate_qty__cb);
  } // do_ajax_form_tbdetailreturlog_validate_qty_

  function do_ajax_form_tbdetailreturlog_validate_qty__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "qty_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "qty_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdetailreturlog_validate_qty__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_tbdetailreturlog_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_tbdetailreturlog_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tbdetailreturlog_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_tbdetailreturlog_add_new_line_cb);
  } // do_ajax_form_tbdetailreturlog_add_new_line

  function do_ajax_form_tbdetailreturlog_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_tbdetailreturlog_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_tbdetailreturlog_backup_line(iNumLinha)
  {
    var var_id_ = scAjaxGetFieldHidden("id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdetailreturlog_backup_line(var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_tbdetailreturlog_backup_line_cb);
  } // do_ajax_form_tbdetailreturlog_backup_line

  function do_ajax_form_tbdetailreturlog_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_tbdetailreturlog_backup_line_cb

  function do_ajax_form_tbdetailreturlog_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_tbdetailreturlog_cancel_insert

  function do_ajax_form_tbdetailreturlog_cancel_update(iSeqVert)
  {
    do_ajax_form_tbdetailreturlog_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_tbdetailreturlog_cancel_update

  function do_ajax_form_tbdetailreturlog_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_tbdetailreturlog_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_tbdetailreturlog_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_tbdetailreturlog_table_refresh(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbdetailreturlog_table_refresh_cb);
  } //  do_ajax_form_tbdetailreturlog_table_refresh

  function do_ajax_form_tbdetailreturlog_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_tbdetailreturlog_table_refresh_cb_after_alert);
  } // do_ajax_form_tbdetailreturlog_table_refresh_cb
  function do_ajax_form_tbdetailreturlog_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_tbdetailreturlog_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_tbdetailreturlog_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_tbdetailreturlog_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    var var_qty_ = scAjaxGetFieldText("qty_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_tbdetailreturlog_submit_form(var_id_, var_item_, var_qty_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbdetailreturlog_submit_form_cb);
  } // do_ajax_form_tbdetailreturlog_submit_form

  function do_ajax_form_tbdetailreturlog_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("qty_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_tbdetailreturlog_submit_form_cb_after_alert);
  } // do_ajax_form_tbdetailreturlog_submit_form_cb
  function do_ajax_form_tbdetailreturlog_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbdetailreturlog_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tbdetailreturlog_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_tbdetailreturlog_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("qty_" + iNavForm);
    }
    var var_id_ = document.F2.id_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tbdetailreturlog_navigate_form(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbdetailreturlog_navigate_form_cb);
  } // do_ajax_form_tbdetailreturlog_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailreturlog']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbdetailreturlog_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbdetailreturlog_navigate_form_cb_after_alert);
  } // do_ajax_form_tbdetailreturlog_navigate_form_cb
  function do_ajax_form_tbdetailreturlog_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_tbdetailreturlog_navigate_form_cb_after_alert
  function sc_hide_form_tbdetailreturlog_form()
  {
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "qty_" + iNumLinha;
    iTotCampos++;
    ...
    ajax_error_list["item_" + iNumLinha] = {"label": "Item / Obat<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["qty_" + iNumLinha] = {"label": "Jumlah Retur<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["id_"][iNumLinha] = "id_" + iNumLinha;
    ajax_field_mult["item_"][iNumLinha] = "item_" + iNumLinha;
    ajax_field_mult["qty_"][iNumLinha] = "qty_" + iNumLinha;
    ajax_field_id["item_" + iNumLinha] = new Array("hidden_field_label_item_", "hidden_field_data_item_" + iNumLinha);
    ajax_field_id["qty_" + iNumLinha] = new Array("hidden_field_label_qty_", "hidden_field_data_qty_" + iNumLinha);
    ajax_error_count["id_" + iNumLinha] = "off";
    ajax_error_count["item_" + iNumLinha] = "off";
    ajax_error_count["qty_" + iNumLinha] = "off";
<?php
...
?>
    ...
    ajax_read_only["qty_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ...
    ajax_read_only["qty_" + iNumLinha] = "on";
<?php
}
?>
  }
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["qty_" + iNumLinha] = null;
  }
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["qty_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["qty_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["qty_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["qty_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["qty_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['qty_'])) ? $this->nmgp_cmp_readonly['qty_'] : 'off';
?>
    scAjaxFieldRead("qty_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["id_" + iRow] || "on" == ajax_error_count["item_" + iRow] || "on" == ajax_error_count["qty_" + iRow]))
    {
      ...
      $("#hidden_field_data_qty_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["id_" + iRow] && "off" == ajax_error_count["item_" + iRow] && "off" == ajax_error_count["qty_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["id_" + iRow] = "off";
        ajax_error_count["item_" + iRow] = "off";
        ajax_error_count["qty_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_qty_" + iRow).removeClass("scFormErrorLine");
    }
  }
