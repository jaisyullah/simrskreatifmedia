...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      ...
      <br><span id="id_hide_deskripsi"  <?php echo $str_hide_deskripsi?>><INPUT  type="text" id="SC_deskripsi" name="deskripsi" value="<?php echo NM_encode_input($deskripsi) ?>" size="50" maxlength="32767" class="scFilterObjectEven">
 </TD>
