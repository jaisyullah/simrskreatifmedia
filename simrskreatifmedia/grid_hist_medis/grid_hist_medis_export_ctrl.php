<?php
@session_start() ;
$_SESSION['scriptcase']['grid_hist_medis']['sc_process_barr'] = true;
require_once('../grid_hist_medis/index.php');
unset($_SESSION['scriptcase']['grid_hist_medis']['sc_process_barr']);
$ExportCtrl = new grid_hist_medis_export_control;
$ExportCtrl->Export_barr();

class grid_hist_medis_export_control
{
