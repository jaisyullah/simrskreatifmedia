...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_grafik_kematian"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_grafik_kematian"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_grafik_kematian']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_grafik_kematian']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_grafik_kematian']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_grafik_kematian']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_grafik_kematian']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_grafik_kematian</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_grafik_kematian']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_grafik_kematian']['embutida_filho'] as $ind => $sc_init)
          {
