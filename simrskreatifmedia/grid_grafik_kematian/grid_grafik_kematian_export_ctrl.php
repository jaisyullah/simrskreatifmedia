<?php
@session_start() ;
$_SESSION['scriptcase']['grid_grafik_kematian']['sc_process_barr'] = true;
require_once('../grid_grafik_kematian/index.php');
unset($_SESSION['scriptcase']['grid_grafik_kematian']['sc_process_barr']);
$ExportCtrl = new grid_grafik_kematian_export_control;
$ExportCtrl->Export_barr();

class grid_grafik_kematian_export_control
{
