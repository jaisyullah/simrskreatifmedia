...
class grid_grafik_kematian_total
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function __construct($sc_page)
   {
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['grid_grafik_kematian']['campos_busca']) && !empty($_SESSION['sc_session'][$this->sc_page]['grid_grafik_kematian']['campos_busca']))
      { 
   ...
   {
      global $nada, $nm_lang , $custcode, $dokter;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['contr_total_geral'] == "OK") 
      { 
          return; 
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['tot_geral'] = array() ;  
    if ($res_limit && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['sql_tot_res']))
    {
        $nm_comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['sql_tot_res'];
    }
    else
    {
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
      { 
          $nm_comando = "select count(*) from (SELECT 	z.tglKeluar, 	z.custCode, 	z.diagnosa1, 	z.dokter, 	z.caraKeluar, 	z.Jenis,         z.icd1 FROM 	( 	SELECT 		tglKeluar, 		custCode, 		diagnosa1, 		dokter, 		caraKeluar, 		'Rawat Inap' AS Jenis,                icd1 	FROM 		tbdetailrawatinap  	WHERE 		caraKeluar LIKE 'MENINGGAL%' UNION ALL 	SELECT 		tglKeluar, 		custCode, 		diagnosa1, 		dokter, 		caraKeluar, 		'IGD' AS Jenis,                 icd1 	FROM 		tbdetailigd  	WHERE 	caraKeluar LIKE 'MENINGGAL%'  	) z) nm_sel_esp " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['where_pesq']; 
      } 
      else 
      { 
          $nm_comando = "select count(*) from (SELECT 	z.tglKeluar, 	z.custCode, 	z.diagnosa1, 	z.dokter, 	z.caraKeluar, 	z.Jenis,         z.icd1 FROM 	( 	SELECT 		tglKeluar, 		custCode, 		diagnosa1, 		dokter, 		caraKeluar, 		'Rawat Inap' AS Jenis,                icd1 	FROM 		tbdetailrawatinap  	WHERE 		caraKeluar LIKE 'MENINGGAL%' UNION ALL 	SELECT 		tglKeluar, 		custCode, 		diagnosa1, 		dokter, 		caraKeluar, 		'IGD' AS Jenis,                 icd1 	FROM 		tbdetailigd  	WHERE 	caraKeluar LIKE 'MENINGGAL%'  	) z) nm_sel_esp " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['where_pesq']; 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['tot_geral'][0] = "" . $this->Ini->Nm_lang['lang_msgs_totl'] . ""; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['tot_geral'][1] = $rt->fields[0] ; 
      $rt->Close(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['contr_total_geral'] = "OK";
   } 

   //-----  jenis
   function quebra_jenis_regDate($jenis, $arg_sum_jenis) 
   {
      global $tot_jenis, $custcode, $dokter;
      $tot_jenis = array() ;  
      $tot_jenis[0] = $jenis ; 
   }
   ...
   {
      global $nm_lang, $custcode, $dokter;
      $this->nm_data = new nm_data("id");
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['sql_tot_res']);
      ...
      $ind_qb                = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['SC_Ind_Groupby'];
      $cmp_sql_def   = array('jenis' => "Jenis");
      $cmps_quebra_atual = array("jenis");
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['arr_total'] = array();
      foreach ($cmps_quebra_atual as $cmp_gb)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['arr_total'][$cmp_gb] = $this->$Arr_tot_name;
      }
   }
   ...
   function Res_Totaliza_regDate($ind_qb, $cmp_tot, $arr_tots, $group, $join, $cmps_quebras, $cmps_quebras1, $cmps_quebras2, $cmps_quebrasS, $Cmp_dim, $cmps_quebra_atual, $cmp_sql_def)
   {
      ...
      { 
         $cmd_simp = "select count(*)#@#cmps_quebras#@# from (SELECT 	z.tglKeluar, 	z.custCode, 	z.diagnosa1, 	z.dokter, 	z.caraKeluar, 	z.Jenis,         z.icd1 FROM 	( 	SELECT 		tglKeluar, 		custCode, 		diagnosa1, 		dokter, 		caraKeluar, 		'Rawat Inap' AS Jenis,                icd1 	FROM 		tbdetailrawatinap  	WHERE 		caraKeluar LIKE 'MENINGGAL%' UNION ALL 	SELECT 		tglKeluar, 		custCode, 		diagnosa1, 		dokter, 		caraKeluar, 		'IGD' AS Jenis,                 icd1 	FROM 		tbdetailigd  	WHERE 	caraKeluar LIKE 'MENINGGAL%'  	) z) sc_sel_esp " . $where_ok;
         $comando  = "select count(*)#@#cmps_quebras#@# from (";
         $comando .= "select " . $cmps_quebras1 . " from (SELECT 	z.tglKeluar, 	z.custCode, 	z.diagnosa1, 	z.dokter, 	z.caraKeluar, 	z.Jenis,         z.icd1 FROM 	( 	SELECT 		tglKeluar, 		custCode, 		diagnosa1, 		dokter, 		caraKeluar, 		'Rawat Inap' AS Jenis,                icd1 	FROM 		tbdetailrawatinap  	WHERE 		caraKeluar LIKE 'MENINGGAL%' UNION ALL 	SELECT 		tglKeluar, 		custCode, 		diagnosa1, 		dokter, 		caraKeluar, 		'IGD' AS Jenis,                 icd1 	FROM 		tbdetailigd  	WHERE 	caraKeluar LIKE 'MENINGGAL%'  	) z) sc_sel_esp1 " . $where_ok . ") SC_sel1 INNER JOIN (";
         $comando .= "select " . $cmps_quebras2 . " from (SELECT 	z.tglKeluar, 	z.custCode, 	z.diagnosa1, 	z.dokter, 	z.caraKeluar, 	z.Jenis,         z.icd1 FROM 	( 	SELECT 		tglKeluar, 		custCode, 		diagnosa1, 		dokter, 		caraKeluar, 		'Rawat Inap' AS Jenis,                icd1 	FROM 		tbdetailrawatinap  	WHERE 		caraKeluar LIKE 'MENINGGAL%' UNION ALL 	SELECT 		tglKeluar, 		custCode, 		diagnosa1, 		dokter, 		caraKeluar, 		'IGD' AS Jenis,                 icd1 	FROM 		tbdetailigd  	WHERE 	caraKeluar LIKE 'MENINGGAL%'  	) z) sc_sel_esp2 " . $where_ok . " group by " . $group . $sc_having . ") SC_sel2 ";
         $comando .= " ON " . $join;
      } 
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['sql_tot_res']))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['sql_tot_res'] = str_replace("#@#cmps_quebras#@#", "", $comando);
      }
      $comando  = str_replace("#@#cmps_quebras#@#", "," . $cmps_quebras, $comando);
      $comando .= " group by " . $cmps_quebras . " order by " .  $cmps_quebras;
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['Res_search_metric_use']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['Res_search_metric_use']))
      {
          $comando = $cmd_simp;
          $cmps_S  = "";
