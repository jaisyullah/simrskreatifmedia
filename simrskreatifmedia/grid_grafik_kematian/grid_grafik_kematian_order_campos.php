...
<?php
   ...
   $Ord_Cmp = new grid_grafik_kematian_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_grafik_kematian_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_grafik_kematian']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_grafik_kematian']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["tglkeluar"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_grafik_kematian']['labels']["tglkeluar"])) ? $_SESSION['sc_session'][$sc_init]['grid_grafik_kematian']['labels']["tglkeluar"] : "Tgl Keluar";
   $tab_ger_campos['custcode'] = "on";
   $tab_def_campos['custcode'] = "custCode";
   $tab_labels["custcode"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_grafik_kematian']['labels']["custcode"])) ? $_SESSION['sc_session'][$sc_init]['grid_grafik_kematian']['labels']["custcode"] : "Pasien / No RM";
   $tab_ger_campos['diagnosa1'] = "on";
   $tab_def_campos['diagnosa1'] = "diagnosa1";
   $tab_labels["diagnosa1"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_grafik_kematian']['labels']["diagnosa1"])) ? $_SESSION['sc_session'][$sc_init]['grid_grafik_kematian']['labels']["diagnosa1"] : "Diagnosa Teks";
   $tab_ger_campos['icd1'] = "on";
   $tab_def_campos['icd1'] = "icd1";
   $tab_labels["icd1"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_grafik_kematian']['labels']["icd1"])) ? $_SESSION['sc_session'][$sc_init]['grid_grafik_kematian']['labels']["icd1"] : "ICD 10";
   $tab_ger_campos['dokter'] = "on";
   $tab_def_campos['dokter'] = "dokter";
   $tab_labels["dokter"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_grafik_kematian']['labels']["dokter"])) ? $_SESSION['sc_session'][$sc_init]['grid_grafik_kematian']['labels']["dokter"] : "Dokter";
   $tab_ger_campos['carakeluar'] = "on";
   $tab_def_campos['carakeluar'] = "caraKeluar";
   $tab_labels["carakeluar"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_grafik_kematian']['labels']["carakeluar"])) ? $_SESSION['sc_session'][$sc_init]['grid_grafik_kematian']['labels']["carakeluar"] : "Cara Keluar";
   $tab_ger_campos['jenis'] = "on";
   $tab_def_campos['jenis'] = "Jenis";
   $tab_labels["jenis"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_grafik_kematian']['labels']["jenis"])) ? $_SESSION['sc_session'][$sc_init]['grid_grafik_kematian']['labels']["jenis"] : "Jenis";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_grafik_kematian']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_grafik_kematian']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_grafik_kematian']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_grafik_kematian']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_grafik_kematian']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_grafik_kematian']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_grafik_kematian']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_grafik_kematian']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_grafik_kematian']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_grafik_kematian_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_grafik_kematian']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_grafik_kematian']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_grafik_kematian']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_grafik_kematian']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_grafik_kematian']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
