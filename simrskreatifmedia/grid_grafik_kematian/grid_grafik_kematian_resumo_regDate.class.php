...
class grid_grafik_kematian_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function initializeButtons()
   {
      ...
      $this->nmgp_botoes['chart_exit'] = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['dashboard_info']['under_dashboard'] ? "off" : "on";
   ...
   { 
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['grid_grafik_kematian']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['grid_grafik_kematian']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['resumo_search']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['resumo_search']))
      { 
         $this->res_contr = new grid_grafik_kematian_apl();
     ...
     { 
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['res_hrz'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['where_resumo'] = "";
      }
      $this->inicializa_vars();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['contr_total_geral'] == "OK")
      {
          $this->array_total_jenis = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['arr_total']['jenis'];
      }
      else
      {
          $this->array_total_jenis = array();
      ...
      $Sv_tot_ger = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['tot_geral'];
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['contr_total_geral'] = "N";
      $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['SC_Ind_Groupby'];
      $tp_tot = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['Res_search_metric_use']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['Res_search_metric_use'])) ? true : false;
      $this->Total->$Gb_geral($tp_tot);
      $this->array_total_geral = array();
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['tot_geral'][1];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['tot_geral'][1] == 0)
      {
          $this->NM_res_sem_reg = true;
      }
      if (isset($Sv_tot_ger))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['tot_geral'] = $Sv_tot_ger;
          unset($Sv_tot_ger);
      }
      $this->resumo_init();
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['arr_total']['jenis'] = $this->array_total_jenis;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['json_use_label'])
       {
          $Lab_jenis = "Jenis";
       }
       else
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['labels']['tglkeluar']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['labels']['tglkeluar'] = "Tgl Keluar"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['labels']['custcode']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['labels']['custcode'] = "Pasien / No RM"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['labels']['diagnosa1']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['labels']['diagnosa1'] = "Diagnosa Teks"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['labels']['icd1']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['labels']['icd1'] = "ICD 10"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['labels']['dokter']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['labels']['dokter'] = "Dokter"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['labels']['carakeluar']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['labels']['carakeluar'] = "Cara Keluar"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['labels']['jenis']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['labels']['jenis'] = "Jenis"; 
       }
       //-----
       $this->comp_field_nm = array(
           'jenis' => 0,
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['summarizing_fields_order']['regDate']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['summarizing_fields_order']['regDate'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['summarizing_fields_order']['regDate'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['summarizing_fields_display']['regDate'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['summarizing_fields_display']['regDate'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['summarizing_fields_display']['regDate'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['summarizing_fields_display']['regDate'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['summarizing_fields_display']['regDate'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['summarizing_fields_display']['regDate'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['summarizing_fields_display']['regDate'] as $i_sum => $d_sum)
           {
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['pivot_order_level'] = -1;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['pivot_tabular_label'];
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_grafik_kematian@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function buildChart()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['pivot_charts']    = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['pivot_orig']      = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['comb_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['comb_table_def']  = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['anlt_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['anlt_table_def']  = array();
	...
	function filterChartsByGroupbyLevel() {
		...
		if (isset($nmgp_opcao) && ('pdf' == $nmgp_opcao || 'pdf_res' == $nmgp_opcao) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['chart_level']) && '' !== $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['chart_level']) {
			$applyFilter = true;
		}
		elseif (isset($nmgp_opcao) && 'image_res' == $nmgp_opcao && isset($_POST['chart_level']) && '' !== $_POST['chart_level']) {
			$applyFilter = true;
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['chart_level'] = $_POST['chart_level'];
		}
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['pivot_charts'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['pivot_orig'];

		if ($applyFilter) {
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['pivot_charts'] as $chartIndex => $chartData) {
				...
				if ($groupbyLevel > $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['chart_level']) {
					unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['pivot_charts'][$chartIndex]);
				}
			}
		}

		$this->comp_chart_data = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['pivot_charts'];
	}
           ...
           foreach ($a_totals as $i_total => $values)
           {
               ...
               if (isset($this->comp_chart_config[$key_config]))
               {
                   ...
                   foreach ($a_keys as $tmp_key)
                   {
                       ...
                       $xml_links[]  = $this->getFusionLink('sc_grid_grafik_kematian_' . session_id() . '_!!!' . implode('_', array_merge(array($group + 1, $i_total), $link_index)) . '!!!.json');
                   }
                   ...
                   $this->comp_chart_data[$key_data]['xml']        = $this->getFusionLink('sc_grid_grafik_kematian_' . session_id() . '_!!!' . implode('_', array_merge(array($group, $i_total), $param)) . '!!!.json');
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['embutida'])
                   {
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['proc_pdf_vert']){ 
   ...
   {
       if (!$res_chart && $this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['json_use_format']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['json_use_format'])
       {
           return $valor_campo;
       }
   ...
   function resumo_init()
   {
      ...
      {
         $this->monta_html_ini();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function resumo_final()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['ajax_nav'])
      {
   ...
   function inicializa_vars()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         require_once($this->Ini->path_aplicacao . "grid_grafik_kematian_total.class.php"); 
      }
      ...
      $this->Total   = new grid_grafik_kematian_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      $this->Total->Calc_resumo_regDate("res");
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['arr_total'][$cmp_gb];
      }
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['dashboard_refresh_after_chart'] = 'resumo';
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['doc_word'])
{
   ...
   { 
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_grafik_kematian_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grid_grafik_kematian_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_grafik_kematian_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['num_css'] . '.css');
...
$nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_grafik_kematian/grid_grafik_kematian_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\">\r\n");
           ...
           $nm_saida->saida("     }\r\n");
           $nm_saida->saida("   </script>\r\n");
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['ajax_nav'] && !$this->Ini->sc_export_ajax && !$this->Ini->Export_html_zip && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['doc_word'])
      {
           $nm_saida->saida("   <script type=\"text/javascript\"> \r\n");
          ...
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['grid_pesq']))
          { 
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['doc_word']) 
      {
      ...
      {
          $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['dashboard_info']['remove_margin'] ? ' style="margin: 0"' : '';
          $nm_saida->saida(" <BODY class=\"" . $this->css_scGridPage . "\"" . $remove_margin . ">\r\n");
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['embutida'])
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top_normal()
   {
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['ajax_nav'] && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['where_resumo_search']))
      {
          $this->NM_res_sem_reg = false;
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['embutida'])
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['word'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "Rword_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_grafik_kematian/grid_grafik_kematian_config_word.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_cor=CO&nm_res_cons=s&nm_ini_word_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&origem=res&language=id&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['xls'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bexcel", "", "", "Rxls_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_grafik_kematian/grid_grafik_kematian_config_xls.php?script_case_init=" . $this->Ini->sc_page . "&app_name=grid_grafik_kematian&nm_tp_xls=xlsx&nm_tot_xls=S&nm_tot_xls=S&nm_res_cons=s&nm_ini_xls_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&summary_export_columns=S&origem=res&language=&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['xml'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bxml", "", "", "Rxml_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_grafik_kematian/grid_grafik_kematian_config_xml.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=s&nm_ini_xml_res=grid,resume,chart&nm_all_modules=grid,resume,chart&nm_xml_tag=tag&nm_xml_label=S&language=&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['csv'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcsv", "", "", "Rcsv_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_grafik_kematian/grid_grafik_kematian_config_csv.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_res_cons=s&nm_ini_csv_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&nm_delim_line=1&nm_delim_col=1&nm_delim_dados=1&nm_label_csv=N&language=&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      {
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bconf_graf", "", "", "Rgraf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_grafik_kematian/grid_grafik_kematian_config_graf_flash.php?nome_apl=grid_grafik_kematian&campo_apl=nm_resumo_graf&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=id&tp_apl=ger_gra&KeepThis=true&TB_iframe=true&height=450&width=400&modal=true", "", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
      }
      if ($this->nmgp_botoes['chart_detail'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("grid_grafik_kematian_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
   ...
   function monta_html_fim()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['print_all'])
      {
          $this->grafico_pdf();
      }
      $nm_saida->saida("</TABLE>\r\n");
      $nm_saida->saida("<link rel=\"stylesheet\" type=\"text/css\" href=\"../_lib/css/" . $this->Ini->str_schema_all . "_sweetalert.css\" />\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_grafik_kematian']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_grafik_kematian']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
$nm_saida->saida("       scJs_alert('" . $mensagem . "', $jsonParams);\r\n");
      ...
      elseif ($this->Ini->Export_html_zip || ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['opcao'] == "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['graf_pdf'] == "S"))
      {
          $this->grafico_pdf();
      }
      else
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'grid_grafik_kematian_config_pivot.php?nome_apl=grid_grafik_kematian&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=id&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_grafik_kematian_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "grid_grafik_kematian/grid_grafik_kematian_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
...
//--- 
 function grafico_bot()
 {
   ...
   $bPDF = false;
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['pivot_charts']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['graf_bot'] = true;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['graf_first'] = true;
       require_once($this->Ini->path_aplicacao . $this->Ini->Apl_grafico); 
       $this->Graf  = new grid_grafik_kematian_grafico();
       $this->Graf->Db     = $this->Db;
       $this->Graf->Erro   = $this->Erro;
      ...
      if (isset($_POST['nmgp_opcao']) && 'ajax_navigate' == $_POST['nmgp_opcao'] && isset($_POST['opc']) && ('grid_search_res' == $_POST['opc'] || 'resumo_search' == $_POST['opc'])) {
       ...
       $nm_saida->saida("<TR>\r\n");
       $iChartCount = 1;
       $iChartTotal = sizeof($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['pivot_charts']);
       $sChartLang  = isset($this->Ini->Nm_lang['lang_pdff_pcht']) ? $this->Ini->Nm_lang['lang_pdff_pcht'] : 'Generating chart';
       if (!NM_is_utf8($sChartLang))
       {
           $sChartLang = sc_convert_encoding($sChartLang, "UTF-8", $_SESSION['scriptcase']['charset']);
      ...
      if ($bPDF && (!isset($this->progress_fp) || !$this->progress_fp))
      {
       ...
       $nm_saida->saida("</TR>\r\n");
      if (isset($_POST['nmgp_opcao']) && 'ajax_navigate' == $_POST['nmgp_opcao'] && isset($_POST['opc']) && 'resumo' == $_POST['opc']) {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['new_charts'] = $_SESSION['scriptcase']['saida_html'];
      ...
      if (isset($_POST['nmgp_opcao']) && 'ajax_navigate' == $_POST['nmgp_opcao'] && isset($_POST['opc']) && ('grid_search_res' == $_POST['opc'] || 'resumo_search' == $_POST['opc'])) {
       ...
       $nm_saida->saida("</TABLE>\r\n");
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['graf_bot'] = false;
       if ($bPDF && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['charts_html']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['charts_html'])
       {
           $nm_saida->saida("<script type=\"text/javascript\">\r\n");
           $nm_saida->saida("{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['charts_html']}\r\n");
           $nm_saida->saida("</script>\r\n");
...
//--- 
   function monta_resumo_search()
   {
      ...
      $this->html_resumo_search();
       ...
       { 
           ...
           $_SESSION['scriptcase']['saida_html'] = "";
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['resumo_search_look']))
           { 
               $this->Ini->Arr_result['setArr'][] = array('var' => 'Tab_obj_res_combo', 'value' => '');
               foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['resumo_search_look'] as $cada_combo => $opcs_combo)
               { 
               ...
               if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['resumo_search_look']))
               { 
   ...
   {
       global $nm_saida;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['res_search_label'] = array();
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['resumo_search']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['resumo_search']         = array();
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['resumo_search_look']    = array();
       ...
       $lin_obj  = $this->resumo_search_tglKeluar_SC_1();
   ...
   function resumo_search_tglKeluar_SC_1()
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['resumo_search']['tglKeluar_SC_1']))
       {
       ...
       $lin_obj .= "Bulan";
       $Cod_Btn  = nmButtonOutput($this->arr_buttons, "blimparsummaryfield", "nm_proc_res_search('tglKeluar_SC_1', '', '', '', 'clear_search_obj', '', '');", "nm_proc_res_search('tglKeluar_SC_1', '', '', '', 'clear_search_obj', '', '');", "tglKeluar_SC_1_clear", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
       $lin_obj .= "<span id=\"btn_clear_tglKeluar_SC_1\" style='float:right; display: none;' class='scGridSummarySearchLabelclean'>". $Cod_Btn ."</span>"; 
       $lin_obj .= "     </div>";
       $lin_obj  .= "   <div class='scGridSummarySearchObjeto' id=\"id_tab_tglKeluar_SC_1\" style=\" \">";
       $lin_obj  .= "   <select class=\"css_toolbar_obj\" style=\"vertical-align: middle;\" id=\"tglKeluar_SC_1\" name=\"tglKeluar_SC_1\" onChange=\"nm_proc_res_search('tglKeluar_SC_1', 'tglKeluar', 'select', 'dth', 'eql', 'seasonal', '');\">";
       $disabled  = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['resumo_search_look']['tglKeluar_SC_1'])) ? "" : " disabled";
       $lin_obj  .= "   <option value='__NM__' selected='selected'" . $disabled . ">" . $this->Ini->Nm_lang['lang_search_select_summary'] . "</option>";
       $selected  = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['resumo_search_look']['tglKeluar_SC_1']) && in_array('month_jan', $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['resumo_search_look']['tglKeluar_SC_1'])) ? " selected" : "";
       $lin_obj  .= "   <option value=\"month_jan\"" . $selected . ">" . $this->Ini->Nm_lang['lang_mnth_janu'] . "</option>";
       $selected  = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['resumo_search_look']['tglKeluar_SC_1']) && in_array('month_feb', $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['resumo_search_look']['tglKeluar_SC_1'])) ? " selected" : "";
       $lin_obj  .= "   <option value=\"month_feb\"" . $selected . ">" . $this->Ini->Nm_lang['lang_mnth_febr'] . "</option>";
       $selected  = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['resumo_search_look']['tglKeluar_SC_1']) && in_array('month_mar', $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['resumo_search_look']['tglKeluar_SC_1'])) ? " selected" : "";
       $lin_obj  .= "   <option value=\"month_mar\"" . $selected . ">" . $this->Ini->Nm_lang['lang_mnth_marc'] . "</option>";
       $selected  = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['resumo_search_look']['tglKeluar_SC_1']) && in_array('month_apr', $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['resumo_search_look']['tglKeluar_SC_1'])) ? " selected" : "";
       $lin_obj  .= "   <option value=\"month_apr\"" . $selected . ">" . $this->Ini->Nm_lang['lang_mnth_apri'] . "</option>";
       $selected  = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['resumo_search_look']['tglKeluar_SC_1']) && in_array('month_may', $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['resumo_search_look']['tglKeluar_SC_1'])) ? " selected" : "";
       $lin_obj  .= "   <option value=\"month_may\"" . $selected . ">" . $this->Ini->Nm_lang['lang_mnth_mayy'] . "</option>";
       $selected  = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['resumo_search_look']['tglKeluar_SC_1']) && in_array('month_jun', $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['resumo_search_look']['tglKeluar_SC_1'])) ? " selected" : "";
       $lin_obj  .= "   <option value=\"month_jun\"" . $selected . ">" . $this->Ini->Nm_lang['lang_mnth_june'] . "</option>";
       $selected  = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['resumo_search_look']['tglKeluar_SC_1']) && in_array('month_jul', $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['resumo_search_look']['tglKeluar_SC_1'])) ? " selected" : "";
       $lin_obj  .= "   <option value=\"month_jul\"" . $selected . ">" . $this->Ini->Nm_lang['lang_mnth_july'] . "</option>";
       $selected  = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['resumo_search_look']['tglKeluar_SC_1']) && in_array('month_aug', $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['resumo_search_look']['tglKeluar_SC_1'])) ? " selected" : "";
       $lin_obj  .= "   <option value=\"month_aug\"" . $selected . ">" . $this->Ini->Nm_lang['lang_mnth_augu'] . "</option>";
       $selected  = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['resumo_search_look']['tglKeluar_SC_1']) && in_array('month_sep', $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['resumo_search_look']['tglKeluar_SC_1'])) ? " selected" : "";
       $lin_obj  .= "   <option value=\"month_sep\"" . $selected . ">" . $this->Ini->Nm_lang['lang_mnth_sept'] . "</option>";
       $selected  = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['resumo_search_look']['tglKeluar_SC_1']) && in_array('month_oct', $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['resumo_search_look']['tglKeluar_SC_1'])) ? " selected" : "";
       $lin_obj  .= "   <option value=\"month_oct\"" . $selected . ">" . $this->Ini->Nm_lang['lang_mnth_octo'] . "</option>";
       $selected  = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['resumo_search_look']['tglKeluar_SC_1']) && in_array('month_nov', $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['resumo_search_look']['tglKeluar_SC_1'])) ? " selected" : "";
       $lin_obj  .= "   <option value=\"month_nov\"" . $selected . ">" . $this->Ini->Nm_lang['lang_mnth_nove'] . "</option>";
       $selected  = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['resumo_search_look']['tglKeluar_SC_1']) && in_array('month_dec', $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['resumo_search_look']['tglKeluar_SC_1'])) ? " selected" : "";
   ...
   function JS_resumo_search()
   {
       ...
       $nm_saida->saida("         $('#tglKeluar_SC_1').SumoSelect({ csvDispCount: 3, selectAll:true, placeholder: '" . $this->Ini->Nm_lang['lang_search_select_summary'] . "', captionFormat:'{0} " . $this->Ini->Nm_lang['lang_btns_selected_summary'] . "', captionFormatAllSelected: '" . $this->Ini->Nm_lang['lang_btns_all_of_them_summary'] . "', locale : ['" . $this->Ini->Nm_lang['lang_btns_ok_summary'] . "', '" . $this->Ini->Nm_lang['lang_btns_cancel_summary'] . "', '" . $this->Ini->Nm_lang['lang_btns_all_selected_summary'] . "'] });\r\n");
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['resumo_search_look']))
       { 
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grafik_kematian']['resumo_search_look'] as $cada_combo => $opcs_combo)
           { 
...
$nm_saida->saida("             }\r\n");
   ...
   //---- 
   function adiciona_registro($quebra_jenis, $quebra_jenis_orig)
   {
      //----- Jenis
      if (!isset($this->array_total_jenis[$quebra_jenis_orig]))
      {
         $this->array_total_jenis[$quebra_jenis_orig][0] = 1;
         $this->array_total_jenis[$quebra_jenis_orig][1] = 1;
      ...
      else
      {
         ...
         $this->array_total_jenis[$quebra_jenis_orig][2]++;
      }
   }
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->tglkeluar = $rs_res->fields[0] ;  
            $this->custcode = $rs_res->fields[1] ;  
            $this->diagnosa1 = $rs_res->fields[2] ;  
            $this->icd1 = $rs_res->fields[3] ;  
            $this->dokter = $rs_res->fields[4] ;  
            $this->carakeluar = $rs_res->fields[5] ;  
            $this->jenis = $rs_res->fields[6] ;  
            $this->jenis_orig = $this->jenis;
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->jenis, $this->jenis_orig);
            }
   }
//
