...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_tbhasillab"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_tbhasillab"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_tbhasillab'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tbhasillab']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_tbhasillab']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tbhasillab']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_tbhasillab']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_tbhasillab']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_tbhasillab']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_tbhasillab']['embutida_filho'] as $ind => $sc_init)
          {
