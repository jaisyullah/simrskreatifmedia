...
<?php
   ...
   $Ord_Cmp = new grid_tbhasillab_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_tbhasillab_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbhasillab']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tbhasillab']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["trancode"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbhasillab']['labels']["trancode"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbhasillab']['labels']["trancode"] : "Trancode";
   $tab_ger_campos['labcode'] = "on";
   $tab_def_campos['labcode'] = "labcode";
   $tab_labels["labcode"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbhasillab']['labels']["labcode"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbhasillab']['labels']["labcode"] : "Labcode";
   $tab_ger_campos['kategori'] = "on";
   $tab_def_campos['kategori'] = "kategori";
   $tab_labels["kategori"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbhasillab']['labels']["kategori"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbhasillab']['labels']["kategori"] : "Kategori";
   $tab_ger_campos['nama'] = "on";
   $tab_def_campos['nama'] = "nama";
   $tab_labels["nama"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbhasillab']['labels']["nama"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbhasillab']['labels']["nama"] : "Nama";
   $tab_ger_campos['subname'] = "on";
   $tab_def_campos['subname'] = "subname";
   $tab_labels["subname"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbhasillab']['labels']["subname"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbhasillab']['labels']["subname"] : "Subname";
   $tab_ger_campos['hasil'] = "on";
   $tab_def_campos['hasil'] = "hasil";
   $tab_labels["hasil"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbhasillab']['labels']["hasil"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbhasillab']['labels']["hasil"] : "Hasil";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_tbhasillab']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_tbhasillab']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_tbhasillab']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbhasillab']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tbhasillab']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_tbhasillab']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_tbhasillab']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_tbhasillab']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_tbhasillab']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_tbhasillab_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_tbhasillab']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_tbhasillab']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_tbhasillab']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_tbhasillab']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_tbhasillab']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
