...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_nilaikonversi_cond" name="nilaikonversi_cond" onChange="nm_campos_between(document.getElementById('id_vis_nilaikonversi'), this, 'nilaikonversi')">
      ...
      <br><span id="id_hide_nilaikonversi"  <?php echo $str_hide_nilaikonversi?>><?php
      if ($nilaikonversi != "")
      {
      $nilaikonversi_look = substr($this->Db->qstr($nilaikonversi), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_konversisatuan_cond" name="konversisatuan_cond" onChange="nm_campos_between(document.getElementById('id_vis_konversisatuan'), this, 'konversisatuan')">
      ...
      <br><span id="id_hide_konversisatuan"  <?php echo $str_hide_konversisatuan?>><?php
      if ($konversisatuan != "")
      {
      $konversisatuan_look = substr($this->Db->qstr($konversisatuan), 1, -1); 
      $nmgp_def_dados = array(); 
