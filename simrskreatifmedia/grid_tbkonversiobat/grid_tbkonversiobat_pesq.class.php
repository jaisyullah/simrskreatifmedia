...
class grid_tbkonversiobat_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbkonversiobat']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_tbkonversiobat_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_tbkonversiobat_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_tbkonversiobat_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_nilaikonversi')
      {
          $nilaikonversi = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_nilaikonversi($nilaikonversi);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_konversisatuan')
      {
          $konversisatuan = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_konversisatuan($konversisatuan);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function lookup_ajax_nilaikonversi($nilaikonversi)
   {
      $nilaikonversi = substr($this->Db->qstr($nilaikonversi), 1, -1);
            $nilaikonversi_look = substr($this->Db->qstr($nilaikonversi), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct nilaiKonversi from " . $this->Ini->nm_tabela . " where  nilaiKonversi like '%" . $nilaikonversi . "%' order by nilaiKonversi"; 
      unset($cmp1,$cmp2);
   ...
   function lookup_ajax_konversisatuan($konversisatuan)
   {
      $konversisatuan = substr($this->Db->qstr($konversisatuan), 1, -1);
            $konversisatuan_look = substr($this->Db->qstr($konversisatuan), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct konversiSatuan from " . $this->Ini->nm_tabela . " where  konversiSatuan like '%" . $konversisatuan . "%' order by konversiSatuan"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbkonversiobat']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbkonversiobat']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbkonversiobat']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbkonversiobat']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbkonversiobat']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbkonversiobat']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbkonversiobat']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbkonversiobat']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbkonversiobat']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbkonversiobat']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbkonversiobat']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbkonversiobat']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbkonversiobat']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbkonversiobat']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbkonversiobat']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - tbkonversiobat</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_tbkonversiobat/grid_tbkonversiobat_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_tbkonversiobat_ajax_search.js"></script>
 <script type="text/javascript" src="grid_tbkonversiobat_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_tbkonversiobat_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_tbkonversiobat']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_tbkonversiobat']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_nilaikonversi_cond#NMF#' + search_get_sel_txt('SC_nilaikonversi_cond') + '@NMF@';
  str_out += 'SC_nilaikonversi#NMF#' + search_get_text('SC_nilaikonversi') + '@NMF@';
  str_out += 'id_ac_nilaikonversi#NMF#' + search_get_text('id_ac_nilaikonversi') + '@NMF@';
  ...
  str_out += 'SC_konversisatuan_cond#NMF#' + search_get_sel_txt('SC_konversisatuan_cond') + '@NMF@';
  str_out += 'SC_konversisatuan#NMF#' + search_get_text('SC_konversisatuan') + '@NMF@';
  str_out += 'id_ac_konversisatuan#NMF#' + search_get_text('id_ac_konversisatuan') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
   ...
   $("#id_ac_konversisatuan").autocomplete({
     minLength: 1,
     source: function (request, response) {
     $.ajax({
       url: "index.php",
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_konversisatuan",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_konversisatuan").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     focus: function (event, ui) {
     ...
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_konversisatuan").val( $(this).val() );
       }
     }
   });
   $("#id_ac_nilaikonversi").autocomplete({
     minLength: 1,
     source: function (request, response) {
     $.ajax({
       url: "index.php",
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_nilaikonversi",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_nilaikonversi").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     focus: function (event, ui) {
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbkonversiobat']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div class="scFilterHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFilterHeaderFont" style="float: left; text-transform: uppercase;"><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - tbkonversiobat</div>
...
<?php
   ...
   {
      global 
             $nilaikonversi_cond, $nilaikonversi, $nilaikonversi_autocomp,
             $id_cond, $id, $id_autocomp,
             $kodeitem_cond, $kodeitem, $kodeitem_autocomp,
             $konversisatuan_cond, $konversisatuan, $konversisatuan_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbkonversiobat']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbkonversiobat']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbkonversiobat']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbkonversiobat']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $nilaikonversi = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbkonversiobat']['campos_busca']['nilaikonversi']; 
          $nilaikonversi_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbkonversiobat']['campos_busca']['nilaikonversi_cond']; 
          $id = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbkonversiobat']['campos_busca']['id']; 
          $id_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbkonversiobat']['campos_busca']['id_cond']; 
          $kodeitem = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbkonversiobat']['campos_busca']['kodeitem']; 
          $kodeitem_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbkonversiobat']['campos_busca']['kodeitem_cond']; 
          $konversisatuan = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbkonversiobat']['campos_busca']['konversisatuan']; 
          $konversisatuan_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbkonversiobat']['campos_busca']['konversisatuan_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbkonversiobat']['campos_busca']['NM_operador']; 
      } 
      if (!isset($nilaikonversi_cond) || empty($nilaikonversi_cond))
      {
         $nilaikonversi_cond = "qp";
      }
      ...
      if (!isset($konversisatuan_cond) || empty($konversisatuan_cond))
      {
         $konversisatuan_cond = "qp";
      }
      $display_aberto  = "style=display:";
      $display_fechado = "style=display:none";
      $opc_hide_input = array("nu","nn","ep","ne");
      $str_hide_nilaikonversi = (in_array($nilaikonversi_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      $str_hide_konversisatuan = (in_array($konversisatuan_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      if (!isset($nilaikonversi) || $nilaikonversi == "")
      {
          $nilaikonversi = "";
      }
      if (isset($nilaikonversi) && !empty($nilaikonversi))
      {
         $tmp_pos = strpos($nilaikonversi, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $nilaikonversi = substr($nilaikonversi, 0, $tmp_pos);
         }
      }
      if (!isset($id) || $id == "")
      {
      ...
      if (!isset($konversisatuan) || $konversisatuan == "")
      {
          $konversisatuan = "";
      }
      if (isset($konversisatuan) && !empty($konversisatuan))
      {
         $tmp_pos = strpos($konversisatuan, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $konversisatuan = substr($konversisatuan, 0, $tmp_pos);
         }
      }
?>
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_nilaikonversi_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['nilaikonversi'])) ? $this->New_label['nilaikonversi'] : "Nilai Konversi"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_nilaikonversi_cond" name="nilaikonversi_cond" onChange="nm_campos_between(document.getElementById('id_vis_nilaikonversi'), this, 'nilaikonversi')">
       <OPTION value="qp" <?php if ("qp" == $nilaikonversi_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $nilaikonversi_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $nilaikonversi_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $nilaikonversi_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_nilaikonversi" <?php echo $str_hide_nilaikonversi?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['nilaikonversi'])) ? $this->New_label['nilaikonversi'] : "Nilai Konversi";
 $nmgp_tab_label .= "nilaikonversi?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
...
<?php
      ...
      $nilaikonversi_look = substr($this->Db->qstr($nilaikonversi), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct nilaiKonversi from " . $this->Ini->nm_tabela . " where nilaiKonversi = '$nilaikonversi_look' order by nilaiKonversi"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      if (isset($nmgp_def_dados[0][$nilaikonversi]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$nilaikonversi];
      }
      else
      {
          $sAutocompValue = $nilaikonversi;
      }
?>
<INPUT  type="text" id="SC_nilaikonversi" name="nilaikonversi" value="<?php echo NM_encode_input($nilaikonversi) ?>"  size=50 alt="{datatype: 'text', maxLength: 255, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_nilaikonversi" name="nilaikonversi_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 255, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_kodeitem" name="kodeitem_autocomp" size="10"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 10, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_konversisatuan_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['konversisatuan'])) ? $this->New_label['konversisatuan'] : "Konversi Satuan"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_konversisatuan_cond" name="konversisatuan_cond" onChange="nm_campos_between(document.getElementById('id_vis_konversisatuan'), this, 'konversisatuan')">
       <OPTION value="qp" <?php if ("qp" == $konversisatuan_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $konversisatuan_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $konversisatuan_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $konversisatuan_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_konversisatuan" <?php echo $str_hide_konversisatuan?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['konversisatuan'])) ? $this->New_label['konversisatuan'] : "Konversi Satuan";
 $nmgp_tab_label .= "konversisatuan?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      $konversisatuan_look = substr($this->Db->qstr($konversisatuan), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct konversiSatuan from " . $this->Ini->nm_tabela . " where konversiSatuan = '$konversisatuan_look' order by konversiSatuan"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      if (isset($nmgp_def_dados[0][$konversisatuan]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$konversisatuan];
      }
      else
      {
          $sAutocompValue = $konversisatuan;
      }
?>
<INPUT  type="text" id="SC_konversisatuan" name="konversisatuan" value="<?php echo NM_encode_input($konversisatuan) ?>"  size=15 alt="{datatype: 'text', maxLength: 15, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_konversisatuan" name="konversisatuan_autocomp" size="15"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 15, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
?>
<?php
   if (is_file("grid_tbkonversiobat_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_tbkonversiobat']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_tbkonversiobat']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbkonversiobat']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.nilaikonversi_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_nilaikonversi'), document.F1.nilaikonversi_cond, 'nilaikonversi');
   document.F1.nilaikonversi.value = "";
   document.F1.nilaikonversi_autocomp.value = "";
   ...
   document.F1.konversisatuan_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_konversisatuan'), document.F1.konversisatuan_cond, 'konversisatuan');
   document.F1.konversisatuan.value = "";
   document.F1.konversisatuan_autocomp.value = "";
 }
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "simrskreatifmedia/grid_tbkonversiobat";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbkonversiobat']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbkonversiobat']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbkonversiobat']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_nilaikonversi_cond'] = 'cond';
      $tp_fields['SC_nilaikonversi'] = 'text_aut';
      $tp_fields['id_ac_nilaikonversi'] = 'text_aut';
      ...
      $tp_fields['SC_konversisatuan_cond'] = 'cond';
      $tp_fields['SC_konversisatuan'] = 'text_aut';
      $tp_fields['id_ac_konversisatuan'] = 'text_aut';
   ...
   {
      global $nilaikonversi_cond, $nilaikonversi, $nilaikonversi_autocomp,
             $id_cond, $id, $id_autocomp,
             $kodeitem_cond, $kodeitem, $kodeitem_autocomp,
             $konversisatuan_cond, $konversisatuan, $konversisatuan_autocomp, $nmgp_tab_label;

      $C_formatado = true;
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_conv_dados.php", "F", "nm_conv_limpa_dado") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
      if (!empty($nilaikonversi_autocomp) && empty($nilaikonversi))
      {
          $nilaikonversi = $nilaikonversi_autocomp;
      }
      ...
      if (!empty($konversisatuan_autocomp) && empty($konversisatuan))
      {
          $konversisatuan = $konversisatuan_autocomp;
      }
      $nilaikonversi_cond_salva = $nilaikonversi_cond; 
      if (!isset($nilaikonversi_input_2) || $nilaikonversi_input_2 == "")
      {
          $nilaikonversi_input_2 = $nilaikonversi;
      }
      ...
      $konversisatuan_cond_salva = $konversisatuan_cond; 
      if (!isset($konversisatuan_input_2) || $konversisatuan_input_2 == "")
      {
          $konversisatuan_input_2 = $konversisatuan;
      }
      if ($id_cond != "in")
      {
          nm_limpa_numero($id, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbkonversiobat']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbkonversiobat']['campos_busca']['nilaikonversi'] = $nilaikonversi; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbkonversiobat']['campos_busca']['nilaikonversi_cond'] = $nilaikonversi_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbkonversiobat']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbkonversiobat']['campos_busca']['id'] = $id; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbkonversiobat']['campos_busca']['id_cond'] = $id_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbkonversiobat']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbkonversiobat']['campos_busca']['kodeitem'] = $kodeitem; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbkonversiobat']['campos_busca']['kodeitem_cond'] = $kodeitem_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbkonversiobat']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbkonversiobat']['campos_busca']['konversisatuan'] = $konversisatuan; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbkonversiobat']['campos_busca']['konversisatuan_cond'] = $konversisatuan_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbkonversiobat']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbkonversiobat']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbkonversiobat']['campos_busca'] = $Temp_Busca;
      }
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['nilaikonversi'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['nilaikonversi'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['nilaikonversi'] = $nilaikonversi;
      }
      $id_look = substr($this->Db->qstr($id), 1, -1); 
      $nmgp_def_dados = array(); 
   if (is_numeric($id))
   { 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['konversisatuan'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['konversisatuan'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['konversisatuan'] = $konversisatuan;
      }

      //----- $nilaikonversi
      $this->Date_part = false;
      if (isset($nilaikonversi) || $nilaikonversi_cond == "nu" || $nilaikonversi_cond == "nn" || $nilaikonversi_cond == "ep" || $nilaikonversi_cond == "ne")
      {
         $this->monta_condicao("nilaiKonversi", $nilaikonversi_cond, $nilaikonversi, "", "nilaikonversi");
      }
      ...
      //----- $konversisatuan
      $this->Date_part = false;
      if (isset($konversisatuan) || $konversisatuan_cond == "nu" || $konversisatuan_cond == "nn" || $konversisatuan_cond == "ep" || $konversisatuan_cond == "ne")
      {
         $this->monta_condicao("konversiSatuan", $konversisatuan_cond, $konversisatuan, "", "konversisatuan");
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbkonversiobat']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbkonversiobat']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbkonversiobat']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbkonversiobat']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbkonversiobat']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbkonversiobat']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbkonversiobat']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbkonversiobat']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbkonversiobat']['cond_pesq'] .= $this->NM_operador;
