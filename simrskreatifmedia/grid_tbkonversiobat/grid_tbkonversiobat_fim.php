...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_tbkonversiobat"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_tbkonversiobat"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_tbkonversiobat'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tbkonversiobat']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_tbkonversiobat']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tbkonversiobat']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_tbkonversiobat']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_tbkonversiobat']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_tbkonversiobat</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_tbkonversiobat']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_tbkonversiobat']['embutida_filho'] as $ind => $sc_init)
          {
