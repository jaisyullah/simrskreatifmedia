...
<?php
   ...
   $Ord_Cmp = new grid_tbkonversiobat_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_tbkonversiobat_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbkonversiobat']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tbkonversiobat']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbkonversiobat']['labels']["id"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbkonversiobat']['labels']["id"] : "Id";
   $tab_ger_campos['kodeitem'] = "on";
   $tab_def_campos['kodeitem'] = "kodeItem";
   $tab_labels["kodeitem"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbkonversiobat']['labels']["kodeitem"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbkonversiobat']['labels']["kodeitem"] : "Kode Item";
   $tab_ger_campos['konversisatuan'] = "on";
   $tab_def_campos['konversisatuan'] = "konversiSatuan";
   $tab_labels["konversisatuan"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbkonversiobat']['labels']["konversisatuan"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbkonversiobat']['labels']["konversisatuan"] : "Konversi Satuan";
   $tab_ger_campos['nilaikonversi'] = "on";
   $tab_def_campos['nilaikonversi'] = "nilaiKonversi";
   $tab_labels["nilaikonversi"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbkonversiobat']['labels']["nilaikonversi"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbkonversiobat']['labels']["nilaikonversi"] : "Nilai Konversi";
   $tab_ger_campos['satuandefault'] = "on";
   $tab_def_campos['satuandefault'] = "satuanDefault";
   $tab_labels["satuandefault"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbkonversiobat']['labels']["satuandefault"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbkonversiobat']['labels']["satuandefault"] : "Satuan Default";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_tbkonversiobat']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_tbkonversiobat']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_tbkonversiobat']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbkonversiobat']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tbkonversiobat']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_tbkonversiobat']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_tbkonversiobat']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_tbkonversiobat']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_tbkonversiobat']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_tbkonversiobat_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_tbkonversiobat']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_tbkonversiobat']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_tbkonversiobat']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_tbkonversiobat']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_tbkonversiobat']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
