  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbruang_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbruang_mob_form();
	}

  // ---------- Validate idruang
  function do_ajax_form_tbruang_mob_validate_idruang()
  {
    var nomeCampo_idruang = "idruang";
    var var_idruang = scAjaxGetFieldHidden(nomeCampo_idruang);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbruang_mob_validate_idruang(var_idruang, var_script_case_init, do_ajax_form_tbruang_mob_validate_idruang_cb);
  } // do_ajax_form_tbruang_mob_validate_idruang

  function do_ajax_form_tbruang_mob_validate_idruang_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbruang_mob_validate_idruang_cb

  // ---------- Validate namaruang
  function do_ajax_form_tbruang_mob_validate_namaruang()
  {
    var nomeCampo_namaruang = "namaruang";
    var var_namaruang = scAjaxGetFieldText(nomeCampo_namaruang);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbruang_mob_validate_namaruang(var_namaruang, var_script_case_init, do_ajax_form_tbruang_mob_validate_namaruang_cb);
  } // do_ajax_form_tbruang_mob_validate_namaruang

  function do_ajax_form_tbruang_mob_validate_namaruang_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "namaruang";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbruang_mob_validate_namaruang_cb

  // ---------- Validate kelas
  function do_ajax_form_tbruang_mob_validate_kelas()
  {
    var nomeCampo_kelas = "kelas";
    var var_kelas = scAjaxGetFieldSelect(nomeCampo_kelas);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbruang_mob_validate_kelas(var_kelas, var_script_case_init, do_ajax_form_tbruang_mob_validate_kelas_cb);
  } // do_ajax_form_tbruang_mob_validate_kelas

  function do_ajax_form_tbruang_mob_validate_kelas_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "kelas";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbruang_mob_validate_kelas_cb

  // ---------- Validate noranap
  function do_ajax_form_tbruang_mob_validate_noranap()
  {
    var nomeCampo_noranap = "noranap";
    var var_noranap = scAjaxGetFieldText(nomeCampo_noranap);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbruang_mob_validate_noranap(var_noranap, var_script_case_init, do_ajax_form_tbruang_mob_validate_noranap_cb);
  } // do_ajax_form_tbruang_mob_validate_noranap

  function do_ajax_form_tbruang_mob_validate_noranap_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "noranap";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbruang_mob_validate_noranap_cb

  // ---------- Validate bed
  function do_ajax_form_tbruang_mob_validate_bed()
  {
    var nomeCampo_bed = "bed";
    var var_bed = scAjaxGetFieldText(nomeCampo_bed);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbruang_mob_validate_bed(var_bed, var_script_case_init, do_ajax_form_tbruang_mob_validate_bed_cb);
  } // do_ajax_form_tbruang_mob_validate_bed

  function do_ajax_form_tbruang_mob_validate_bed_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "bed";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbruang_mob_validate_bed_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tbruang_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tbruang_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_idruang = scAjaxGetFieldHidden("idruang");
    var var_namaruang = scAjaxGetFieldText("namaruang");
    var var_kelas = scAjaxGetFieldSelect("kelas");
    var var_noranap = scAjaxGetFieldText("noranap");
    ...
    scAjaxProcOn();
    x_ajax_form_tbruang_mob_submit_form(var_idruang, var_namaruang, var_kelas, var_noranap, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbruang_mob_submit_form_cb);
  } // do_ajax_form_tbruang_mob_submit_form

  function do_ajax_form_tbruang_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("idruang");
      scAjaxHideErrorDisplay("namaruang");
      scAjaxHideErrorDisplay("kelas");
      scAjaxHideErrorDisplay("noranap");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tbruang_mob_submit_form_cb_after_alert);
  } // do_ajax_form_tbruang_mob_submit_form_cb
  function do_ajax_form_tbruang_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbruang_mob_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_tbbed_mob"] = "off";

  function do_ajax_form_tbruang_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("noranap");
    scAjaxHideErrorDisplay("bed");
    var var_idruang = document.F2.idruang.value;
    ...
    scAjaxProcOn();
    scStatusDetail["form_tbbed_mob"] = "on";
    x_ajax_form_tbruang_mob_navigate_form(var_idruang, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbruang_mob_navigate_form_cb);
  } // do_ajax_form_tbruang_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbruang_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbruang_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.idruang.value = scAjaxGetKeyValue("idruang");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_tbbed_mob"] && "nmsc_iframe_liga_form_tbbed_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_tbbed_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_tbbed_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_tbbed_mob').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_tbbed_mob').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_tbbed_mob').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbruang_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_tbruang_mob_navigate_form_cb
  function do_ajax_form_tbruang_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_tbruang_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_tbruang_mob_navigate_form_cb_after_alert
  function sc_hide_form_tbruang_mob_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_tbbed_mob"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[0] = "idruang";
  ajax_field_list[1] = "namaruang";
  ajax_field_list[2] = "kelas";
  ajax_field_list[3] = "noranap";
  ajax_field_list[4] = "bed";
  ...
  var ajax_error_list = {
    "idruang": {"label": "ID Ruang", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "namaruang": {"label": "Nama Ruang", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "kelas": {"label": "Kelas", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "noranap": {"label": "No Ranap", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "bed": {"label": "", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  ajax_field_mult["idruang"][1] = "idruang";
  ajax_field_mult["namaruang"][1] = "namaruang";
  ajax_field_mult["kelas"][1] = "kelas";
  ajax_field_mult["noranap"][1] = "noranap";
  ajax_field_mult["bed"][1] = "bed";

  var ajax_field_id = {
    "idruang": new Array("hidden_field_label_idruang", "hidden_field_data_idruang"),
    "namaruang": new Array("hidden_field_label_namaruang", "hidden_field_data_namaruang"),
    "kelas": new Array("hidden_field_label_kelas", "hidden_field_data_kelas"),
    "noranap": new Array("hidden_field_label_noranap", "hidden_field_data_noranap"),
