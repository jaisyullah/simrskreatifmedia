...
function displayChange_field_bed(row, status) {
	if ("on" == status && typeof $("#nmsc_iframe_liga_form_tbbed_mob")[0].contentWindow.scRecreateSelect2 === "function") {
		$("#nmsc_iframe_liga_form_tbbed_mob")[0].contentWindow.scRecreateSelect2();
	}
}
...
function scHidePage(pageNo) {
	$("#id_form_tbruang_mob_form" + pageNo).hide();
}
