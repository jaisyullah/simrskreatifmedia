  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbruang" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbruang_form();
	}

  // ---------- Validate idruang
  function do_ajax_form_tbruang_validate_idruang()
  {
    var nomeCampo_idruang = "idruang";
    var var_idruang = scAjaxGetFieldHidden(nomeCampo_idruang);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbruang_validate_idruang(var_idruang, var_script_case_init, do_ajax_form_tbruang_validate_idruang_cb);
  } // do_ajax_form_tbruang_validate_idruang

  function do_ajax_form_tbruang_validate_idruang_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbruang_validate_idruang_cb

  // ---------- Validate namaruang
  function do_ajax_form_tbruang_validate_namaruang()
  {
    var nomeCampo_namaruang = "namaruang";
    var var_namaruang = scAjaxGetFieldText(nomeCampo_namaruang);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbruang_validate_namaruang(var_namaruang, var_script_case_init, do_ajax_form_tbruang_validate_namaruang_cb);
  } // do_ajax_form_tbruang_validate_namaruang

  function do_ajax_form_tbruang_validate_namaruang_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbruang_validate_namaruang_cb

  // ---------- Validate kelas
  function do_ajax_form_tbruang_validate_kelas()
  {
    var nomeCampo_kelas = "kelas";
    var var_kelas = scAjaxGetFieldSelect(nomeCampo_kelas);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbruang_validate_kelas(var_kelas, var_script_case_init, do_ajax_form_tbruang_validate_kelas_cb);
  } // do_ajax_form_tbruang_validate_kelas

  function do_ajax_form_tbruang_validate_kelas_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "kelas";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbruang_validate_kelas_cb

  // ---------- Validate noranap
  function do_ajax_form_tbruang_validate_noranap()
  {
    var nomeCampo_noranap = "noranap";
    var var_noranap = scAjaxGetFieldText(nomeCampo_noranap);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbruang_validate_noranap(var_noranap, var_script_case_init, do_ajax_form_tbruang_validate_noranap_cb);
  } // do_ajax_form_tbruang_validate_noranap

  function do_ajax_form_tbruang_validate_noranap_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "noranap";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbruang_validate_noranap_cb

  // ---------- Validate bed
  function do_ajax_form_tbruang_validate_bed()
  {
    var nomeCampo_bed = "bed";
    var var_bed = scAjaxGetFieldText(nomeCampo_bed);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbruang_validate_bed(var_bed, var_script_case_init, do_ajax_form_tbruang_validate_bed_cb);
  } // do_ajax_form_tbruang_validate_bed

  function do_ajax_form_tbruang_validate_bed_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "bed";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbruang_validate_bed_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tbruang_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tbruang_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_tbruang_submit_form(var_idruang, var_namaruang, var_kelas, var_noranap, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbruang_submit_form_cb);
  } // do_ajax_form_tbruang_submit_form

  function do_ajax_form_tbruang_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scLigEditLookupCall();
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbruang']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbruang']['dashboard_info']['under_dashboard']) {
?>
      var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbruang']['dashboard_info']['parent_widget']; ?>']");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tbruang_submit_form_cb_after_alert);
  } // do_ajax_form_tbruang_submit_form_cb
  function do_ajax_form_tbruang_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbruang_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_tbbed"] = "off";

  function do_ajax_form_tbruang_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    scStatusDetail["form_tbbed"] = "on";
    x_ajax_form_tbruang_navigate_form(var_idruang, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbruang_navigate_form_cb);
  } // do_ajax_form_tbruang_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbruang']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbruang_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_tbbed"] && "nmsc_iframe_liga_form_tbbed" != scMasterDetailIframe["nmsc_iframe_liga_form_tbbed"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_tbbed"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_tbbed').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_tbbed').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_tbbed').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbruang_navigate_form_cb_after_alert);
  } // do_ajax_form_tbruang_navigate_form_cb
  function do_ajax_form_tbruang_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_tbruang_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_tbruang_navigate_form_cb_after_alert
  function sc_hide_form_tbruang_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_tbbed"])
    {
      return true;
    }
    return false;
