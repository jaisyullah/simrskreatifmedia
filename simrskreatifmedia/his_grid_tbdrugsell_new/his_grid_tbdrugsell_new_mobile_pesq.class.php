...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "trandate";$Nm_datas[] = "trandate";$Nm_numeric[] = "id";$Nm_numeric[] = "total";$Nm_numeric[] = "iskaryawan";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_extname"  <?php echo $str_hide_extname?>><?php
      if ($extname != "")
      {
      $extname_look = substr($this->Db->qstr($extname), 1, -1); 
      $nmgp_def_dados = array(); 
...
<select class="sc-js-input scFilterObjectEven sc-ui-autocomp-extname" id="id_ac_extname" name="extname_autocomp"><?php if ('' !=  $extname) { ?><option value="<?php echo $extname ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
 </TD>
