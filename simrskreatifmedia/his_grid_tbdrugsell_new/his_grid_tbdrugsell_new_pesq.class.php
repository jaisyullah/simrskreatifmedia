...
class his_grid_tbdrugsell_new_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['his_grid_tbdrugsell_new']['path_libs_php'] = $this->Ini->path_lib_php;
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['his_grid_tbdrugsell_new']['prim_vez']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['his_grid_tbdrugsell_new']['prim_vez'] = "S";
      }
   ...
   function init()
   {
    ...
    if (!$this->NM_ajax_flag && (!isset($bprocessa) || $bprocessa != "pesq"))
    {
      global $trandate_cond, $trandate, $trandate_dia, $trandate_mes, $trandate_ano, $trandate_input_2_dia, $trandate_input_2_mes, $trandate_input_2_ano,
             $extname_cond, $extname, $extname_autocomp;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . his_grid_tbdrugsell_new_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . his_grid_tbdrugsell_new_pack_protect_string($Tipo_filter[0]) . "\">.." . his_grid_tbdrugsell_new_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_extname')
      {
          $extname = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_extname($extname);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function lookup_ajax_extname($extname)
   {
      $extname = substr($this->Db->qstr($extname), 1, -1);
            $extname_look = substr($this->Db->qstr($extname), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct extname from " . $this->Ini->nm_tabela . " where  extname like '%" . $extname . "%' order by extname"; 
      unset($cmp1,$cmp2);
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['his_grid_tbdrugsell_new']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['his_grid_tbdrugsell_new']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['his_grid_tbdrugsell_new']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['his_grid_tbdrugsell_new']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['his_grid_tbdrugsell_new']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['his_grid_tbdrugsell_new']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['his_grid_tbdrugsell_new']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['his_grid_tbdrugsell_new']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['his_grid_tbdrugsell_new']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['his_grid_tbdrugsell_new']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['his_grid_tbdrugsell_new']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['his_grid_tbdrugsell_new']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['his_grid_tbdrugsell_new']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['his_grid_tbdrugsell_new']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['his_grid_tbdrugsell_new']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['his_grid_tbdrugsell_new']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['his_grid_tbdrugsell_new']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
   ...
   $NM_retorno = "./";
    if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['his_grid_tbdrugsell_new']['proc_res'])) 
    {
...
<?php
    if ($_SESSION['sc_session'][$this->Ini->sc_page]['his_grid_tbdrugsell_new']['prim_vez'] == "N" && !$_SESSION['sc_session'][$this->Ini->sc_page]['his_grid_tbdrugsell_new']['proc_res']) 
    {
?>
if (parent.document.getElementById('nmsc_iframe_his_grid_tbdrugsell_new').contentWindow.nm_gp_submit_ajax)
{
   parent.document.getElementById('nmsc_iframe_his_grid_tbdrugsell_new').contentWindow.nm_gp_submit_ajax('inicio', 'save_grid');
}
else
{
   parent.document.getElementById('nmsc_iframe_his_grid_tbdrugsell_new').src = 'index.php?nmgp_opcao=pesq&script_case_init=<?php echo NM_encode_input($this->Ini->sc_page) ?>&script_case_session=<?php echo session_id() ?>';
}
<?php
    }
    else
...
<?php
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['his_grid_tbdrugsell_new']['prim_vez'] = "N";
?>
</SCRIPT>
</BODY>
</HTML>
...
<HEAD>
 <TITLE>HISTORI - PENJUALAN OBAT BEBAS</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>his_grid_tbdrugsell_new/his_grid_tbdrugsell_new_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="his_grid_tbdrugsell_new_ajax_search.js"></script>
 <script type="text/javascript" src="his_grid_tbdrugsell_new_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="his_grid_tbdrugsell_new_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['his_grid_tbdrugsell_new']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['his_grid_tbdrugsell_new']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
function scJQCalendarAdd() {
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_extname#NMF#' + search_get_text('SC_extname') + '@NMF@';
  str_out += 'id_ac_extname#NMF#' + search_get_title('select2-id_ac_extname-container') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
  $(".sc-ui-autocomp-extname").on("focus", function() {
  }).on("blur", function() {
   ...
   ajax: {
    ...
    data: function (params) {
     var query = {
      ...
      nmgp_parms: "NM_ajax_opcao?#?autocomp_extname",
      max_itens: "10",
   ...
   $("#SC_extname").val(e.params.data.id);
          nm_submit_form();
  });
 });
</script>
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['his_grid_tbdrugsell_new']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div class="scFilterHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFilterHeaderFont" style="float: left; text-transform: uppercase;">HISTORI - PENJUALAN OBAT BEBAS</div>
...
<?php
   ...
   function monta_form()
   {
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['his_grid_tbdrugsell_new']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['his_grid_tbdrugsell_new']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['his_grid_tbdrugsell_new']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['his_grid_tbdrugsell_new']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $trandate_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['his_grid_tbdrugsell_new']['campos_busca']['trandate_dia']; 
          $trandate_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['his_grid_tbdrugsell_new']['campos_busca']['trandate_mes']; 
          $trandate_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['his_grid_tbdrugsell_new']['campos_busca']['trandate_ano']; 
          $trandate_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['his_grid_tbdrugsell_new']['campos_busca']['trandate_input_2_dia']; 
          $trandate_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['his_grid_tbdrugsell_new']['campos_busca']['trandate_input_2_mes']; 
          $trandate_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['his_grid_tbdrugsell_new']['campos_busca']['trandate_input_2_ano']; 
          $trandate_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['his_grid_tbdrugsell_new']['campos_busca']['trandate_cond']; 
          $extname = $_SESSION['sc_session'][$this->Ini->sc_page]['his_grid_tbdrugsell_new']['campos_busca']['extname']; 
          $extname_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['his_grid_tbdrugsell_new']['campos_busca']['extname_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['his_grid_tbdrugsell_new']['campos_busca']['NM_operador']; 
      } 
      ...
      {
         $tmp_pos = strpos($extname, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $extname = substr($extname, 0, $tmp_pos);
         }
      }
?>
 <TR align="center">
...
<?php
      ...
      $extname_look = substr($this->Db->qstr($extname), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct extname from " . $this->Ini->nm_tabela . " where extname = '$extname_look' order by extname"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      if (isset($nmgp_def_dados[0][$extname]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$extname];
      }
      else
      {
          $sAutocompValue = $extname;
      }
?>
<INPUT  type="text" id="SC_extname" name="extname" value="<?php echo NM_encode_input($extname) ?>"  size=50 alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" onChange="nm_submit_form()" style="display: none">
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-extname" id="id_ac_extname" name="extname_autocomp"><?php if ('' !=  $extname) { ?><option value="<?php echo $extname ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
...
?>
<?php
   if (is_file("his_grid_tbdrugsell_new_help.txt"))
   {
...
?>
<?php
   if ($nm_apl_dependente == 1 || (!$_SESSION['sc_session'][$this->Ini->sc_page]['his_grid_tbdrugsell_new']['opc_psq'] && !$this->aba_iframe))
   {
...
<?php
       ...
       elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['his_grid_tbdrugsell_new']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['his_grid_tbdrugsell_new']['dashboard_info']['under_dashboard'])
       { }
       else 
       { 
?>
...
<?php
   ...
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['his_grid_tbdrugsell_new']['opc_psq'])
   {
...
<?php
    if ($_SESSION['sc_session'][$this->Ini->sc_page]['his_grid_tbdrugsell_new']['prim_vez'] == "N") 
    {
?>
       <iframe id="nmsc_iframe_his_grid_tbdrugsell_new" frameborder="0" marginwidth="0px" marginheight="0px" topmargin="0px" leftmargin="0px" align="center" height="1500px" name="nm_iframe_his_grid_tbdrugsell_new" scrolling="auto" src="index.php?nmgp_opcao=pesq&script_case_init=<?php echo NM_encode_input($this->Ini->sc_page) ?>&script_case_session=<?php echo session_id() ?>" width="100%"></iframe>
<?php
    }
    else
    {
?>
       <iframe id="nmsc_iframe_his_grid_tbdrugsell_new" frameborder="0" marginwidth="0px" marginheight="0px" topmargin="0px" leftmargin="0px" align="center" height="1500px" name="nm_iframe_his_grid_tbdrugsell_new" scrolling="auto" src="" width="100%"></iframe>
<?php
    }
?>
<iframe id="nmsc_iframe_his_grid_tbdrugsell_new_pesq"  name="nm_iframe_his_grid_tbdrugsell_new_pesq" style= "display: none;" frameborder="0" marginwidth="0px" marginheight="0px" topmargin="0px" leftmargin="0px" src=""></iframe>
</td></tr></table></td></tr>
</TABLE>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['his_grid_tbdrugsell_new']['orig_pesq'] == "grid")
   {
...
?>
 ...
 {
    document.F1.target = "nm_iframe_his_grid_tbdrugsell_new_pesq";
    document.F1.submit();
 }
 function nm_move()
 {
     document.getElementById('nmsc_iframe_his_grid_tbdrugsell_new').contentWindow.nm_move('igual');
 }
 function limpa_form()
 {
   document.F1.reset();
   ...
   document.F1.extname.value = "";
   document.F1.extname_autocomp.value = "";
   Sc_carga_select2('all');
 }
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "simrskreatifmedia/his_grid_tbdrugsell_new";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['his_grid_tbdrugsell_new']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['his_grid_tbdrugsell_new']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['his_grid_tbdrugsell_new']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro($nmgp_save_origem)
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "his_grid_tbdrugsell_new/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_extname'] = 'text_aut';
      $tp_fields['id_ac_extname'] = 'select2_aut';
   ...
   {
      global $trandate_cond, $trandate, $trandate_dia, $trandate_mes, $trandate_ano, $trandate_input_2_dia, $trandate_input_2_mes, $trandate_input_2_ano,
             $extname_cond, $extname, $extname_autocomp, $nmgp_tab_label;

      $C_formatado = true;
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_conv_dados.php", "F", "nm_conv_limpa_dado") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
      if (!empty($extname_autocomp) && empty($extname))
      {
          $extname = $extname_autocomp;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['his_grid_tbdrugsell_new']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['his_grid_tbdrugsell_new']['campos_busca']['trandate_dia'] = $trandate_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['his_grid_tbdrugsell_new']['campos_busca']['trandate_mes'] = $trandate_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['his_grid_tbdrugsell_new']['campos_busca']['trandate_ano'] = $trandate_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['his_grid_tbdrugsell_new']['campos_busca']['trandate_input_2_dia'] = $trandate_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['his_grid_tbdrugsell_new']['campos_busca']['trandate_input_2_mes'] = $trandate_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['his_grid_tbdrugsell_new']['campos_busca']['trandate_input_2_ano'] = $trandate_input_2_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['his_grid_tbdrugsell_new']['campos_busca']['trandate_cond'] = $trandate_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['his_grid_tbdrugsell_new']['campos_busca']['extname'] = $extname; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['his_grid_tbdrugsell_new']['campos_busca']['extname_cond'] = $extname_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['his_grid_tbdrugsell_new']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['his_grid_tbdrugsell_new']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['extname'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['extname'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['extname'] = $extname;
      }
      ...
      if ($trandate_cond != "bi_TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['his_grid_tbdrugsell_new']['campos_busca']['trandate'] = $val[0];
          ...
          if ($trandate_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['his_grid_tbdrugsell_new']['campos_busca']['trandate_input_2'] = $val[1];
      ...
      //----- $extname
      $this->Date_part = false;
      if (isset($extname) || $extname_cond == "nu" || $extname_cond == "nn" || $extname_cond == "ep" || $extname_cond == "ne")
      {
   ...
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['his_grid_tbdrugsell_new']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['his_grid_tbdrugsell_new']['cond_dyn_search'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['his_grid_tbdrugsell_new']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['his_grid_tbdrugsell_new']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['his_grid_tbdrugsell_new']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['his_grid_tbdrugsell_new']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['his_grid_tbdrugsell_new']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['his_grid_tbdrugsell_new']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['his_grid_tbdrugsell_new']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['his_grid_tbdrugsell_new']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['his_grid_tbdrugsell_new']['cond_pesq'] .= $this->NM_operador;
