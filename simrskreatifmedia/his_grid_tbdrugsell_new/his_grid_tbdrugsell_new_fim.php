...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____his_grid_tbdrugsell_new"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____his_grid_tbdrugsell_new"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['his_grid_tbdrugsell_new']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['his_grid_tbdrugsell_new']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['his_grid_tbdrugsell_new']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['his_grid_tbdrugsell_new']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['his_grid_tbdrugsell_new']['sc_modal']);
           if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['his_grid_tbdrugsell_new']['opc_psq']))
           {
...
<HTML>
<HEAD>
 <TITLE>his_grid_tbdrugsell_new</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['his_grid_tbdrugsell_new']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['his_grid_tbdrugsell_new']['embutida_filho'] as $ind => $sc_init)
          {
