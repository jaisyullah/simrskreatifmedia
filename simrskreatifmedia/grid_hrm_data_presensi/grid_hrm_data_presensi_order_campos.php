...
<?php
   ...
   $Ord_Cmp = new grid_hrm_data_presensi_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_hrm_data_presensi_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_hrm_data_presensi']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_hrm_data_presensi']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_hrm_data_presensi']['labels']["id"])) ? $_SESSION['sc_session'][$sc_init]['grid_hrm_data_presensi']['labels']["id"] : "ID";
   $tab_ger_campos['user'] = "on";
   $tab_def_campos['user'] = "user";
   $tab_labels["user"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_hrm_data_presensi']['labels']["user"])) ? $_SESSION['sc_session'][$sc_init]['grid_hrm_data_presensi']['labels']["user"] : "User";
   $tab_ger_campos['date_time'] = "on";
   $tab_def_campos['date_time'] = "date_time";
   $tab_labels["date_time"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_hrm_data_presensi']['labels']["date_time"])) ? $_SESSION['sc_session'][$sc_init]['grid_hrm_data_presensi']['labels']["date_time"] : "Tanggal";
   $tab_ger_campos['ver'] = "on";
   $tab_def_campos['ver'] = "ver";
   $tab_labels["ver"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_hrm_data_presensi']['labels']["ver"])) ? $_SESSION['sc_session'][$sc_init]['grid_hrm_data_presensi']['labels']["ver"] : "Ver";
   $tab_ger_campos['status'] = "on";
   $tab_def_campos['status'] = "status";
   $tab_labels["status"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_hrm_data_presensi']['labels']["status"])) ? $_SESSION['sc_session'][$sc_init]['grid_hrm_data_presensi']['labels']["status"] : "Status";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_hrm_data_presensi']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_hrm_data_presensi']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_hrm_data_presensi']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_hrm_data_presensi']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_hrm_data_presensi']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_hrm_data_presensi']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_hrm_data_presensi']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_hrm_data_presensi']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_hrm_data_presensi']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_hrm_data_presensi_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_hrm_data_presensi']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_hrm_data_presensi']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_hrm_data_presensi']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_hrm_data_presensi']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_hrm_data_presensi']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
