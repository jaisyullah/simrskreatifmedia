...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_hrm_data_presensi"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_hrm_data_presensi"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_hrm_data_presensi']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_hrm_data_presensi']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_hrm_data_presensi']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_hrm_data_presensi']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_hrm_data_presensi']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_hrm_data_presensi</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_hrm_data_presensi']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_hrm_data_presensi']['embutida_filho'] as $ind => $sc_init)
          {
