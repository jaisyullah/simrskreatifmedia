...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_paiddate_hora' + iSeqRow).bind('blur', function() { sc_form_pay_igd_paiddate_hora_onblur(this, iSeqRow) })
                                           .bind('focus', function() { sc_form_pay_igd_paiddate_hora_onfocus(this, iSeqRow) });
...
function sc_form_pay_igd_paiddate_hora_onblur(oThis, iSeqRow) {
  do_ajax_form_pay_igd_validate_paiddate();
  scCssBlur(oThis);
}
...
function sc_form_pay_igd_paiddate_hora_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function scHidePage(pageNo) {
	$("#id_form_pay_igd_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_paiddate" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_pay_igd_validate_paiddate(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_trandate" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_pay_igd_validate_trandate(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
