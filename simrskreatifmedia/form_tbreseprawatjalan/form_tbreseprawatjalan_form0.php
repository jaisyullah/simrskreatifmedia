<?php
class form_tbreseprawatjalan_form extends form_tbreseprawatjalan_apl
{
function Form_Init()
{
...
<?php
if ($this->Embutida_form && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatjalan']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatjalan']['sc_modal'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatjalan']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatjalan']['sc_redir_atualiz'] == 'ok')
{
?>
...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatjalan']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_tbreseprawatjalan/form_tbreseprawatjalan_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_tbreseprawatjalan_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_tbreseprawatjalan_jquery.php');
...
?>
 ...
 function addAutocomplete(elem) {
  ...
  $(".sc-ui-autocomp-item_", elem).on("focus", function() {
   ...
   width: "300px",
   ajax: {
    url: "form_tbreseprawatjalan.php",
    dataType: "json",
   ...
   var sId = $(this).attr("id").substr(6), sRow = "item_" != sId ? sId.substr(5) : "";
   sc_form_tbreseprawatjalan_item__onfocus("id_sc_field_" + sId, sRow);
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatjalan']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatjalan']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatjalan']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatjalan']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatjalan']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatjalan']['recarga'];
}
if ('novo' == $opcao_botoes && $this->Embutida_form)
{
    $opcao_botoes = 'inicio';
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatjalan']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatjalan']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
?>
...
<?php
 include_once("form_tbreseprawatjalan_js0.php");
?>
<script type="text/javascript"> 
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_tbreseprawatjalan'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_tbreseprawatjalan'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatjalan']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatjalan']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatjalan']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatjalan']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatjalan']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatjalan']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatjalan']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatjalan']['run_iframe'] != "R")
{
?>
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatjalan']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatjalan']['run_iframe'] != "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatjalan']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatjalan']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatjalan']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatjalan']['run_iframe'] == "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatjalan']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatjalan']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatjalan']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatjalan']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatjalan']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatjalan']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatjalan']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatjalan']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatjalan']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatjalan']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatjalan']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatjalan']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
{ 
   ...
   { 
       ob_start();
       $iStart = sizeof($this->form_vert_form_tbreseprawatjalan);
       $guarda_nmgp_opcao = $this->nmgp_opcao;
       $guarda_form_vert_form_tbreseprawatjalan = $this->form_vert_form_tbreseprawatjalan;
       $this->nmgp_opcao = 'novo';
   } 
   if ($this->Embutida_form && empty($this->form_vert_form_tbreseprawatjalan))
   {
       $sc_seq_vert = 0;
   }
   ...
   foreach ($this->form_vert_form_tbreseprawatjalan as $sc_seq_vert => $sc_lixo)
   {
       $this->loadRecordState($sc_seq_vert);
       $this->trancode_ = $this->form_vert_form_tbreseprawatjalan[$sc_seq_vert]['trancode_'];
       $this->id_tr_ = $this->form_vert_form_tbreseprawatjalan[$sc_seq_vert]['id_tr_'];
       $this->btn_print_ = $this->form_vert_form_tbreseprawatjalan[$sc_seq_vert]['btn_print_'];
       $this->stok_ = $this->form_vert_form_tbreseprawatjalan[$sc_seq_vert]['stok_'];
       ...
       $this->satuan_ = $this->form_vert_form_tbreseprawatjalan[$sc_seq_vert]['satuan_']; 
       ...
       $this->jumlah_ = $this->form_vert_form_tbreseprawatjalan[$sc_seq_vert]['jumlah_']; 
       ...
       $this->signa_ = $this->form_vert_form_tbreseprawatjalan[$sc_seq_vert]['signa_']; 
       $signa_ = $this->signa_; 
       $sStyleHidden_signa_ = '';
       ...
       $this->jenisaturanpakai_ = $this->form_vert_form_tbreseprawatjalan[$sc_seq_vert]['jenisaturanpakai_']; 
       ...
       $this->biaya_ = $this->form_vert_form_tbreseprawatjalan[$sc_seq_vert]['biaya_']; 
       $biaya_ = $this->biaya_; 
       $sStyleHidden_biaya_ = '';
       ...
       $this->diskon_ = $this->form_vert_form_tbreseprawatjalan[$sc_seq_vert]['diskon_']; 
       ...
       $this->trandate_ = $this->form_vert_form_tbreseprawatjalan[$sc_seq_vert]['trandate_'] . ' ' . $this->form_vert_form_tbreseprawatjalan[$sc_seq_vert]['trandate__hora']; 
       ...
       $this->id_ = $this->form_vert_form_tbreseprawatjalan[$sc_seq_vert]['id_']; 
       $id_ = $this->id_; 
       if (!isset($this->nmgp_cmp_hidden['id_']))
       {
           $this->nmgp_cmp_hidden['id_'] = 'off';
       ...
       $this->stock_ = $this->form_vert_form_tbreseprawatjalan[$sc_seq_vert]['stock_']; 
       $stock_ = $this->stock_; 
       $sStyleHidden_stock_ = '';
       ...
       $this->retur_ = $this->form_vert_form_tbreseprawatjalan[$sc_seq_vert]['retur_']; 
       $retur_ = $this->retur_; 
       $sStyleHidden_retur_ = '';
...
<?php echo nmButtonOutput($this->arr_buttons, "bmd_novo", "do_ajax_form_tbreseprawatjalan_add_new_line(" . $sc_seq_vert . ")", "do_ajax_form_tbreseprawatjalan_add_new_line(" . $sc_seq_vert . ")", "sc_new_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
<?php }?>
<?php
  $Style_add_line = (!$Line_Add) ? "display: none" : "";
?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_form_tbreseprawatjalan_cancel_insert(" . $sc_seq_vert . ")", "do_ajax_form_tbreseprawatjalan_cancel_insert(" . $sc_seq_vert . ")", "sc_canceli_line_" . $sc_seq_vert . "", "", "", "" . $Style_add_line . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_form_tbreseprawatjalan_cancel_update(" . $sc_seq_vert . ")", "do_ajax_form_tbreseprawatjalan_cancel_update(" . $sc_seq_vert . ")", "sc_cancelu_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
 </TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOddMult css_stock__line" id="hidden_field_data_stock_<?php echo $sc_seq_vert; ?>" style="<?php echo $sStyleHidden_stock_; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOddMult css_stock__line" style="vertical-align: top;padding: 0px"><?php
          ...
          { 
              if ($this->Ini->Export_img_zip) {
                  ...
                  $stock_ = "<img border=\"0\" src=\"scriptcase__NM__ico__NM__first_aid_box_32.png\"/>" ; 
              }
              else {
...
?>
<span id="id_imghtml_stock_<?php echo $sc_seq_vert; ?>"><a href="javascript:nm_gp_submit('<?php echo $this->Ini->link_grid_stock_all_cons . "', '$this->nm_location', 'item_stok*scin" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatjalan']['dados_form'][$sc_seq_vert]['item_'] . "*scoutNMSC_inicial*scininicio*scoutNMSC_paginacao*scinFULL*scoutNMSC_modal*scinok*scout', 'inicio', 'modal', '650', '900', 'grid_stock_all')\"><font color=\"" . $this->Ini->cor_link_dados . "\">" . $stock_ ; ?></font></a></span>
...
<?php } else { ?>
<span id="id_read_on_stock_<?php echo $sc_seq_vert ?>" class="sc-ui-readonly-stock_<?php echo $sc_seq_vert ?> css_stock__line" style="<?php echo $sStyleReadLab_stock_; ?>"><?php echo $this->stock_; ?></span><span id="id_read_off_stock_<?php echo $sc_seq_vert ?>" class="css_read_off_stock_" style="white-space: nowrap;<?php echo $sStyleReadInp_stock_; ?>"></span><?php } ?>
...
<?php   
   ...
   { 
       ...
       $this->form_vert_form_tbreseprawatjalan = $guarda_form_vert_form_tbreseprawatjalan;
   } 
   if ($Table_refresh) 
   { 
...
<?php
if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatjalan']['run_modal']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatjalan']['run_modal'])
{
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatjalan']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatjalan']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_tbreseprawatjalan");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_tbreseprawatjalan");
 parent.scAjaxDetailHeight("form_tbreseprawatjalan", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
<script type="text/javascript">
	function scBtnFn_sys_format_inc() {
		if ($("#sc_b_new_t.sc-unique-btn-1").length && $("#sc_b_new_t.sc-unique-btn-1").is(":visible")) {
			do_ajax_form_tbreseprawatjalan_add_new_line(); return false;
			 return;
		}
...
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatjalan']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
