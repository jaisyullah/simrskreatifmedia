<?php
   include_once('form_vclaim_ref_diagnosa_list_session.php');
   @session_start() ;
   $_SESSION['scriptcase']['form_vclaim_ref_diagnosa_list']['glo_nm_perfil']          = "conn_mysql";
   $_SESSION['scriptcase']['form_vclaim_ref_diagnosa_list']['glo_nm_path_prod']       = "";
   $_SESSION['scriptcase']['form_vclaim_ref_diagnosa_list']['glo_nm_path_conf']       = "";
   $_SESSION['scriptcase']['form_vclaim_ref_diagnosa_list']['glo_nm_path_imagens']    = "";
   $_SESSION['scriptcase']['form_vclaim_ref_diagnosa_list']['glo_nm_path_imag_temp']  = "";
   $_SESSION['scriptcase']['form_vclaim_ref_diagnosa_list']['glo_nm_path_doc']        = "";
    ...
    //check prod
    if(empty($_SESSION['scriptcase']['form_vclaim_ref_diagnosa_list']['glo_nm_path_prod']))
    {
            /*check prod*/$_SESSION['scriptcase']['form_vclaim_ref_diagnosa_list']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
    }
    //check img
    if(empty($_SESSION['scriptcase']['form_vclaim_ref_diagnosa_list']['glo_nm_path_imagens']))
    {
            /*check img*/$_SESSION['scriptcase']['form_vclaim_ref_diagnosa_list']['glo_nm_path_imagens'] = $str_path_apl_url . "_lib/file/img";
    }
    //check tmp
    if(empty($_SESSION['scriptcase']['form_vclaim_ref_diagnosa_list']['glo_nm_path_imag_temp']))
    {
            /*check tmp*/$_SESSION['scriptcase']['form_vclaim_ref_diagnosa_list']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
    }
    //check doc
    if(empty($_SESSION['scriptcase']['form_vclaim_ref_diagnosa_list']['glo_nm_path_doc']))
    {
            /*check doc*/$_SESSION['scriptcase']['form_vclaim_ref_diagnosa_list']['glo_nm_path_doc'] = $str_path_apl_dir . "_lib/file/doc";
    }
    //end check publication with the prod
//
class form_vclaim_ref_diagnosa_list_ini
{
   var $nm_cod_apl;
   var $nm_nome_apl;
   var $nm_seguranca;
...
//
   function init($Tp_init = "")
   {
      ...
      $_SESSION['sc_session'][$this->sc_page]['form_vclaim_ref_diagnosa_list']['decimal_db'] = "."; 
      $this->nm_cod_apl      = "form_vclaim_ref_diagnosa_list"; 
      $this->nm_nome_apl     = ""; 
      $this->nm_seguranca    = ""; 
...
// 
      ...
      $this->sc_protocolo    = "";
      $this->path_prod       = $_SESSION['scriptcase']['form_vclaim_ref_diagnosa_list']['glo_nm_path_prod'];
      $this->path_conf       = $_SESSION['scriptcase']['form_vclaim_ref_diagnosa_list']['glo_nm_path_conf'];
      $this->path_imagens    = $_SESSION['scriptcase']['form_vclaim_ref_diagnosa_list']['glo_nm_path_imagens'];
      $this->path_imag_temp  = $_SESSION['scriptcase']['form_vclaim_ref_diagnosa_list']['glo_nm_path_imag_temp'];
      $this->path_doc        = $_SESSION['scriptcase']['form_vclaim_ref_diagnosa_list']['glo_nm_path_doc'];
      ...
      $this->path_aplicacao  = substr($this->path_aplicacao, 0, strrpos($this->path_aplicacao, '/')) . '/form_vclaim_ref_diagnosa_list';
      ...
      if (isset($_SESSION['scriptcase']['form_vclaim_ref_diagnosa_list']['session_timeout']['lang'])) {
          $this->str_lang = $_SESSION['scriptcase']['form_vclaim_ref_diagnosa_list']['session_timeout']['lang'];
      }
      elseif (!isset($_SESSION['scriptcase']['form_vclaim_ref_diagnosa_list']['actual_lang']) || $_SESSION['scriptcase']['form_vclaim_ref_diagnosa_list']['actual_lang'] != $this->str_lang) {
          $_SESSION['scriptcase']['form_vclaim_ref_diagnosa_list']['actual_lang'] = $this->str_lang;
      ...
      {
          include_once("form_vclaim_ref_diagnosa_list_json.php");
      }
      $this->SC_Link_View = (isset($_SESSION['sc_session'][$this->sc_page]['form_vclaim_ref_diagnosa_list']['SC_Link_View'])) ? $_SESSION['sc_session'][$this->sc_page]['form_vclaim_ref_diagnosa_list']['SC_Link_View'] : false;
      if (isset($_GET['SC_Link_View']) && !empty($_GET['SC_Link_View']) && is_numeric($_GET['SC_Link_View']))
      {
          if ($_SESSION['sc_session'][$this->sc_page]['form_vclaim_ref_diagnosa_list']['embutida'])
          {
              $this->SC_Link_View = true;
              $_SESSION['sc_session'][$this->sc_page]['form_vclaim_ref_diagnosa_list']['SC_Link_View'] = true;
          }
      }
      if (isset($_POST['nmgp_opcao']) && $_POST['nmgp_opcao'] == "ajax_save_ancor")
      {
          $_SESSION['sc_session'][$this->sc_page]['form_vclaim_ref_diagnosa_list']['ancor_save'] = $_POST['ancor_save'];
...
<?php
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['form_vclaim_ref_diagnosa_list']['dashboard_info']['under_dashboard']))
      {
          $_SESSION['sc_session'][$this->sc_page]['form_vclaim_ref_diagnosa_list']['dashboard_info']['under_dashboard'] = false;
          $_SESSION['sc_session'][$this->sc_page]['form_vclaim_ref_diagnosa_list']['dashboard_info']['dashboard_app']   = '';
          $_SESSION['sc_session'][$this->sc_page]['form_vclaim_ref_diagnosa_list']['dashboard_info']['own_widget']      = '';
          $_SESSION['sc_session'][$this->sc_page]['form_vclaim_ref_diagnosa_list']['dashboard_info']['parent_widget']   = '';
          $_SESSION['sc_session'][$this->sc_page]['form_vclaim_ref_diagnosa_list']['dashboard_info']['compact_mode']    = false;
          $_SESSION['sc_session'][$this->sc_page]['form_vclaim_ref_diagnosa_list']['dashboard_info']['remove_margin']   = false;
      }
      if (isset($_GET['under_dashboard']) && 1 == $_GET['under_dashboard'])
      {
          if (isset($_GET['own_widget']) && 'dbifrm_widget' == substr($_GET['own_widget'], 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['form_vclaim_ref_diagnosa_list']['dashboard_info']['own_widget'] = $_GET['own_widget'];
              $_SESSION['sc_session'][$this->sc_page]['form_vclaim_ref_diagnosa_list']['dashboard_info']['under_dashboard'] = true;
              if (isset($_GET['dashboard_app'])) {
                  $_SESSION['sc_session'][$this->sc_page]['form_vclaim_ref_diagnosa_list']['dashboard_info']['dashboard_app'] = $_GET['dashboard_app'];
              }
              if (isset($_GET['parent_widget'])) {
                  $_SESSION['sc_session'][$this->sc_page]['form_vclaim_ref_diagnosa_list']['dashboard_info']['parent_widget'] = $_GET['parent_widget'];
              }
              if (isset($_GET['compact_mode'])) {
                  $_SESSION['sc_session'][$this->sc_page]['form_vclaim_ref_diagnosa_list']['dashboard_info']['compact_mode'] = 1 == $_GET['compact_mode'];
              }
              if (isset($_GET['remove_margin'])) {
                  $_SESSION['sc_session'][$this->sc_page]['form_vclaim_ref_diagnosa_list']['dashboard_info']['remove_margin'] = 1 == $_GET['remove_margin'];
              }
          }
      }
      elseif (isset($under_dashboard) && 1 == $under_dashboard)
      {
          if (isset($own_widget) && 'dbifrm_widget' == substr($own_widget, 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['form_vclaim_ref_diagnosa_list']['dashboard_info']['own_widget'] = $own_widget;
              $_SESSION['sc_session'][$this->sc_page]['form_vclaim_ref_diagnosa_list']['dashboard_info']['under_dashboard'] = true;
              if (isset($dashboard_app)) {
                  $_SESSION['sc_session'][$this->sc_page]['form_vclaim_ref_diagnosa_list']['dashboard_info']['dashboard_app'] = $dashboard_app;
              }
              if (isset($parent_widget)) {
                  $_SESSION['sc_session'][$this->sc_page]['form_vclaim_ref_diagnosa_list']['dashboard_info']['parent_widget'] = $parent_widget;
              }
              if (isset($compact_mode)) {
                  $_SESSION['sc_session'][$this->sc_page]['form_vclaim_ref_diagnosa_list']['dashboard_info']['compact_mode'] = 1 == $compact_mode;
              }
              if (isset($remove_margin)) {
                  $_SESSION['sc_session'][$this->sc_page]['form_vclaim_ref_diagnosa_list']['dashboard_info']['remove_margin'] = 1 == $remove_margin;
              }
          }
      }
      if (!isset($_SESSION['sc_session'][$this->sc_page]['form_vclaim_ref_diagnosa_list']['dashboard_info']['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['form_vclaim_ref_diagnosa_list']['dashboard_info']['maximized'] = false;
      }
      if (isset($_GET['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['form_vclaim_ref_diagnosa_list']['dashboard_info']['maximized'] = 1 == $_GET['maximized'];
      }
      if ($_SESSION['sc_session'][$this->sc_page]['form_vclaim_ref_diagnosa_list']['dashboard_info']['under_dashboard'])
      {
          $sTmpDashboardApp = $_SESSION['sc_session'][$this->sc_page]['form_vclaim_ref_diagnosa_list']['dashboard_info']['dashboard_app'];
          if ('' != $sTmpDashboardApp && isset($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["form_vclaim_ref_diagnosa_list"]))
          {
              foreach ($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["form_vclaim_ref_diagnosa_list"] as $sTmpTargetLink => $sTmpTargetWidget)
              {
      ...
      if (!is_file($this->root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
      {
          ...
          unset($_SESSION['scriptcase']['form_vclaim_ref_diagnosa_list']['glo_nm_conexao']);
      }
      ...
      if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['form_vclaim_ref_diagnosa_list']['session_timeout']['redir']))
      {
      ...
      $_SESSION['sc_session'][$this->sc_page]['form_vclaim_ref_diagnosa_list']['path_doc'] = $this->path_doc; 
      ...
      if (!is_dir($this->root . $this->path_prod))
      {
          ...
          echo " </tr>";
          echo "</table>";
          if (!$_SESSION['sc_session'][$script_case_init]['form_vclaim_ref_diagnosa_list']['iframe_menu'] && (!isset($_SESSION['sc_session'][$script_case_init]['form_vclaim_ref_diagnosa_list']['sc_outra_jan']) || !$_SESSION['sc_session'][$script_case_init]['form_vclaim_ref_diagnosa_list']['sc_outra_jan'])) 
          { 
...
// 
      include_once($this->path_aplicacao . "form_vclaim_ref_diagnosa_list_erro.class.php"); 
      $this->Erro = new form_vclaim_ref_diagnosa_list_erro();
      include_once($this->path_adodb . "/adodb.inc.php"); 
      $this->sc_Include($this->path_libs . "/nm_sec_prod.php", "F", "nm_reg_prod") ; 
      $this->sc_Include($this->path_libs . "/nm_ini_perfil.php", "F", "perfil_lib") ; 
// 
 if(function_exists('set_php_timezone')) set_php_timezone('form_vclaim_ref_diagnosa_list'); 
// 
      ...
      if (isset($_SESSION['scriptcase']['form_vclaim_ref_diagnosa_list']['session_timeout']['redir'])) {
          ...
          if ($_SESSION['scriptcase']['form_vclaim_ref_diagnosa_list']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "  </HEAD>\r\n";
              $SS_cod_html .= "   <body>\r\n";
          }
          else {
              ...
              $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['form_vclaim_ref_diagnosa_list']['session_timeout']['redir'] . "');\">\r\n";
              $SS_cod_html .= "     </form>\r\n";
          ...
          if ($_SESSION['scriptcase']['form_vclaim_ref_diagnosa_list']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['form_vclaim_ref_diagnosa_list']['session_timeout']['redir'] . "');\r\n";
          }
          ...
          $SS_cod_html .= " </body>\r\n";
          $SS_cod_html .= "</HTML>\r\n";
          unset($_SESSION['scriptcase']['form_vclaim_ref_diagnosa_list']['session_timeout']);
          unset($_SESSION['sc_session']);
      }
   ...
   function prep_conect()
   {
      if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
      {
          ...
          {
              if (isset($_SESSION['scriptcase']['form_vclaim_ref_diagnosa_list']['glo_nm_conexao']) && $_SESSION['scriptcase']['form_vclaim_ref_diagnosa_list']['glo_nm_conexao'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['form_vclaim_ref_diagnosa_list']['glo_nm_conexao'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['form_vclaim_ref_diagnosa_list']['glo_nm_perfil']) && $_SESSION['scriptcase']['form_vclaim_ref_diagnosa_list']['glo_nm_perfil'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['form_vclaim_ref_diagnosa_list']['glo_nm_perfil'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['form_vclaim_ref_diagnosa_list']['glo_con_' . $NM_con_orig]))
              {
                  $_SESSION['scriptcase']['form_vclaim_ref_diagnosa_list']['glo_con_' . $NM_con_orig] = $NM_con_dest;
              }
          }
      }
      $con_devel             = (isset($_SESSION['scriptcase']['form_vclaim_ref_diagnosa_list']['glo_nm_conexao'])) ? $_SESSION['scriptcase']['form_vclaim_ref_diagnosa_list']['glo_nm_conexao'] : ""; 
      $perfil_trab           = ""; 
      $this->nm_falta_var    = ""; 
      $this->nm_falta_var_db = ""; 
      $nm_crit_perfil        = false;
      if (isset($_SESSION['scriptcase']['form_vclaim_ref_diagnosa_list']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['form_vclaim_ref_diagnosa_list']['glo_nm_conexao']))
      {
          ob_start();
      ...
      if (isset($_SESSION['scriptcase']['form_vclaim_ref_diagnosa_list']['glo_nm_perfil']) && !empty($_SESSION['scriptcase']['form_vclaim_ref_diagnosa_list']['glo_nm_perfil']))
      {
          $perfil_trab = $_SESSION['scriptcase']['form_vclaim_ref_diagnosa_list']['glo_nm_perfil'];
      }
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['form_vclaim_ref_diagnosa_list']['embutida_init']) || !$_SESSION['sc_session'][$this->sc_page]['form_vclaim_ref_diagnosa_list']['embutida_init']) 
      {
...
// 
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['form_vclaim_ref_diagnosa_list']['decimal_db'] = $_SESSION['scriptcase']['glo_decimal_db']; 
      }
      if (isset($_SESSION['scriptcase']['glo_date_separator']) && !empty($_SESSION['scriptcase']['glo_date_separator']))
      {
          ...
          if (strlen($SC_temp) == 2)
          {
              $_SESSION['sc_session'][$this->sc_page]['form_vclaim_ref_diagnosa_list']['SC_sep_date']  = substr($SC_temp, 0, 1); 
              $_SESSION['sc_session'][$this->sc_page]['form_vclaim_ref_diagnosa_list']['SC_sep_date1'] = substr($SC_temp, 1, 1); 
          }
          else
           {
              $_SESSION['sc_session'][$this->sc_page]['form_vclaim_ref_diagnosa_list']['SC_sep_date']  = $SC_temp; 
              $_SESSION['sc_session'][$this->sc_page]['form_vclaim_ref_diagnosa_list']['SC_sep_date1'] = $SC_temp; 
          }
          $this->date_delim  = $_SESSION['sc_session'][$this->sc_page]['form_vclaim_ref_diagnosa_list']['SC_sep_date'];
          $this->date_delim1 = $_SESSION['sc_session'][$this->sc_page]['form_vclaim_ref_diagnosa_list']['SC_sep_date1'];
      }
// 
...
<?php
   ...
   function conectDB()
   {
      ...
      if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['form_vclaim_ref_diagnosa_list']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['form_vclaim_ref_diagnosa_list']['glo_nm_conexao']))
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['form_vclaim_ref_diagnosa_list']['glo_nm_conexao'], $this->root . $this->path_prod, 'simrskreatifmedia', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
...
// 
   ...
   function sc_Sql_Protect($var, $tp, $conex="")
   {
       ...
       if ($tp == "date")
       {
           ...
           if (isset($_SESSION['sc_session'][$this->sc_page]['form_vclaim_ref_diagnosa_list']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->sc_page]['form_vclaim_ref_diagnosa_list']['SC_sep_date']))
           {
               $delim  = $_SESSION['sc_session'][$this->sc_page]['form_vclaim_ref_diagnosa_list']['SC_sep_date'];
               $delim1 = $_SESSION['sc_session'][$this->sc_page]['form_vclaim_ref_diagnosa_list']['SC_sep_date1'];
           }
   ...
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['form_vclaim_ref_diagnosa_list']['SC_Gb_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['form_vclaim_ref_diagnosa_list']['SC_Gb_date_format'][$GB][$cmp] : "";
   }

   function Get_Gb_prefix_date_format($GB, $cmp)
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['form_vclaim_ref_diagnosa_list']['SC_Gb_prefix_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['form_vclaim_ref_diagnosa_list']['SC_Gb_prefix_date_format'][$GB][$cmp] : "";
   }
...
//===============================================================================
//
class form_vclaim_ref_diagnosa_list_apl
{
   var $Ini;
   var $Erro;
   var $Db;
...
//----- 
   function controle()
   {
      ...
      $this->Ini = new form_vclaim_ref_diagnosa_list_ini(); 
      $this->Ini->init();
      $this->Change_Menu = false;
      if (isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_ref_diagnosa_list']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_vclaim_ref_diagnosa_list']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_vclaim_ref_diagnosa_list']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_vclaim_ref_diagnosa_list'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_vclaim_ref_diagnosa_list']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_vclaim_ref_diagnosa_list']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_vclaim_ref_diagnosa_list') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_vclaim_ref_diagnosa_list']['label'] = "" . $this->Ini->Nm_lang['lang_othr_blank_title'] . "";
          ...
          elseif ($this->Ini->sc_page == $this->sc_init_menu)
          {
              ...
              {
                  if ($apl == "form_vclaim_ref_diagnosa_list")
                  {
                      $achou = true;
                  }
                  elseif ($achou)
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_vclaim_ref_diagnosa_list']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_vclaim_ref_diagnosa_list']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['form_vclaim_ref_diagnosa_list']['exit'];
      ...
      $this->Db = $this->Ini->Db; 
      include_once($this->Ini->path_aplicacao . "form_vclaim_ref_diagnosa_list_erro.class.php"); 
      $this->Erro      = new form_vclaim_ref_diagnosa_list_erro();
      $this->Erro->Ini = $this->Ini;
//
      $_SESSION['scriptcase']['form_vclaim_ref_diagnosa_list']['contr_erro'] = 'on';
...
<body>
	...
	<table style="margin:auto;margin-top:50px;">		  
		...
		<tr>
		  <td class="header" colspan="2"><button onclick="location.href='<?php echo $this->Ini->path_link . "" . SC_dir_app_name('form_vclaim_ref_diagnosa') . "/?script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&nmgp_url_saida=" . $this->nm_location; ?>'">Kembali</button></td>
	  	</tr>
	</table>
...
$_SESSION['scriptcase']['form_vclaim_ref_diagnosa_list']['contr_erro'] = 'off'; 
//--- 
       $this->Db->Close(); 
       if ($this->Change_Menu)
       {
...
//======= =========================
   ...
   if (!empty($_POST))
   {
       foreach ($_POST as $nmgp_var => $nmgp_val)
       {
            ...
            nm_limpa_str_form_vclaim_ref_diagnosa_list($nmgp_val);
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['form_vclaim_ref_diagnosa_list']['glo_nm_path_imag_temp'] . "/sc_apl_default_simrskreatifmedia.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['form_vclaim_ref_diagnosa_list']['glo_nm_path_imag_temp'] . "/sc_apl_default_simrskreatifmedia.txt"));
       }
       if (isset($apl_def)) {
           if ($apl_def[0] != "form_vclaim_ref_diagnosa_list") {
               $_SESSION['scriptcase']['sem_session'] = true;
               if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                   $_SESSION['scriptcase']['form_vclaim_ref_diagnosa_list']['session_timeout']['redir'] = $apl_def[0];
               }
               else {
                   $_SESSION['scriptcase']['form_vclaim_ref_diagnosa_list']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
               }
               $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
               $_SESSION['scriptcase']['form_vclaim_ref_diagnosa_list']['session_timeout']['redir_tp'] = $Redir_tp;
           }
           if (isset($_COOKIE['sc_actual_lang_simrskreatifmedia'])) {
               $_SESSION['scriptcase']['form_vclaim_ref_diagnosa_list']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_simrskreatifmedia'];
           }
       }
   }
   ...
   if (isset($_POST["list"])) 
   {
       ...
       nm_limpa_str_form_vclaim_ref_diagnosa_list($_SESSION["list"]);
   }
   if (isset($_GET["list"])) 
   {
   ...
   if (isset($_POST["search"])) 
   {
       ...
       nm_limpa_str_form_vclaim_ref_diagnosa_list($_SESSION["search"]);
   }
   ...
   $salva_iframe = false;
   if (isset($_SESSION['sc_session'][$script_case_init]['form_vclaim_ref_diagnosa_list']['iframe_menu']))
   {
       $salva_iframe = $_SESSION['sc_session'][$script_case_init]['form_vclaim_ref_diagnosa_list']['iframe_menu'];
       unset($_SESSION['sc_session'][$script_case_init]['form_vclaim_ref_diagnosa_list']['iframe_menu']);
   }
   if (isset($nm_run_menu) && $nm_run_menu == 1)
   {
        ...
        $_SESSION['scriptcase']['sc_apl_menu_atual'] = "form_vclaim_ref_diagnosa_list";
        $achou = false;
        if (isset($_SESSION['sc_session'][$script_case_init]))
        {
            foreach ($_SESSION['sc_session'][$script_case_init] as $nome_apl => $resto)
            {
                if ($nome_apl == 'form_vclaim_ref_diagnosa_list' || $achou)
                {
        ...
        $_SESSION['sc_session'][$script_case_init]['form_vclaim_ref_diagnosa_list']['iframe_menu'] = true;
   }
   else
   {
       $_SESSION['sc_session'][$script_case_init]['form_vclaim_ref_diagnosa_list']['iframe_menu'] = $salva_iframe;
   }

   if (!isset($_SESSION['sc_session'][$script_case_init]['form_vclaim_ref_diagnosa_list']['initialize']))
   {
       $_SESSION['sc_session'][$script_case_init]['form_vclaim_ref_diagnosa_list']['initialize'] = true;
   }
   elseif (!isset($_SERVER['HTTP_REFERER']))
   {
       $_SESSION['sc_session'][$script_case_init]['form_vclaim_ref_diagnosa_list']['initialize'] = false;
   }
   ...
   else
   {
       ...
       if ('form_vclaim_ref_diagnosa_list' == $sReferer || 'form_vclaim_ref_diagnosa_list_' == substr($sReferer, 0, 30))
       {
           $_SESSION['sc_session'][$script_case_init]['form_vclaim_ref_diagnosa_list']['initialize'] = false;
       }
       else
   ...
   if (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'form_vclaim_ref_diagnosa_list')
   {
       $_SESSION['sc_session'][$script_case_init]['form_vclaim_ref_diagnosa_list']['sc_outra_jan'] = true;
        unset($_SESSION['scriptcase']['sc_outra_jan']);
   }
   $_SESSION['sc_session'][$script_case_init]['form_vclaim_ref_diagnosa_list']['menu_desenv'] = false;   
   if (!defined("SC_ERROR_HANDLER"))
   {
       define("SC_ERROR_HANDLER", 1);
       include_once(dirname(__FILE__) . "/form_vclaim_ref_diagnosa_list_erro.php");
   }
   if (!empty($nmgp_parms)) 
   { 
       ...
       while (!empty($todo[$ix]))
       {
            ...
            if (1 < sizeof($cadapar))
            {
                ...
                nm_limpa_str_form_vclaim_ref_diagnosa_list($cadapar[1]);
   ...
   $contr_form_vclaim_ref_diagnosa_list = new form_vclaim_ref_diagnosa_list_apl();
   $contr_form_vclaim_ref_diagnosa_list->controle();
//
   function nm_limpa_str_form_vclaim_ref_diagnosa_list(&$str)
   {
