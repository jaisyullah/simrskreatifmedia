  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_hrm_kontrak_kerja" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_hrm_kontrak_kerja_form();
	}

  // ---------- Validate no_kontrak_
  function do_ajax_form_hrm_kontrak_kerja_validate_no_kontrak_(iNumLinha)
  {
    var nomeCampo_no_kontrak_ = "no_kontrak_" + iNumLinha;
    var var_no_kontrak_ = scAjaxGetFieldText(nomeCampo_no_kontrak_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_kontrak_kerja_validate_no_kontrak_(var_no_kontrak_, iNumLinha, var_script_case_init, do_ajax_form_hrm_kontrak_kerja_validate_no_kontrak__cb);
  } // do_ajax_form_hrm_kontrak_kerja_validate_no_kontrak_

  function do_ajax_form_hrm_kontrak_kerja_validate_no_kontrak__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "no_kontrak_" + iLineNumber;
    }
    else
    {
      sFieldValid = "no_kontrak_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "no_kontrak_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "no_kontrak_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_kontrak_kerja_validate_no_kontrak__cb

  // ---------- Validate tanggal_awal_
  function do_ajax_form_hrm_kontrak_kerja_validate_tanggal_awal_(iNumLinha)
  {
    var nomeCampo_tanggal_awal_ = "tanggal_awal_" + iNumLinha;
    var var_tanggal_awal_ = scAjaxGetFieldText(nomeCampo_tanggal_awal_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_kontrak_kerja_validate_tanggal_awal_(var_tanggal_awal_, iNumLinha, var_script_case_init, do_ajax_form_hrm_kontrak_kerja_validate_tanggal_awal__cb);
  } // do_ajax_form_hrm_kontrak_kerja_validate_tanggal_awal_

  function do_ajax_form_hrm_kontrak_kerja_validate_tanggal_awal__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_kontrak_kerja_validate_tanggal_awal__cb

  // ---------- Validate tanggal_akhir_
  function do_ajax_form_hrm_kontrak_kerja_validate_tanggal_akhir_(iNumLinha)
  {
    var nomeCampo_tanggal_akhir_ = "tanggal_akhir_" + iNumLinha;
    var var_tanggal_akhir_ = scAjaxGetFieldText(nomeCampo_tanggal_akhir_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_kontrak_kerja_validate_tanggal_akhir_(var_tanggal_akhir_, iNumLinha, var_script_case_init, do_ajax_form_hrm_kontrak_kerja_validate_tanggal_akhir__cb);
  } // do_ajax_form_hrm_kontrak_kerja_validate_tanggal_akhir_

  function do_ajax_form_hrm_kontrak_kerja_validate_tanggal_akhir__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_kontrak_kerja_validate_tanggal_akhir__cb

  // ---------- Validate tmt_kerja_
  function do_ajax_form_hrm_kontrak_kerja_validate_tmt_kerja_(iNumLinha)
  {
    var nomeCampo_tmt_kerja_ = "tmt_kerja_" + iNumLinha;
    var var_tmt_kerja_ = scAjaxGetFieldText(nomeCampo_tmt_kerja_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_kontrak_kerja_validate_tmt_kerja_(var_tmt_kerja_, iNumLinha, var_script_case_init, do_ajax_form_hrm_kontrak_kerja_validate_tmt_kerja__cb);
  } // do_ajax_form_hrm_kontrak_kerja_validate_tmt_kerja_

  function do_ajax_form_hrm_kontrak_kerja_validate_tmt_kerja__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "tmt_kerja_" + iLineNumber;
    }
    else
    {
      sFieldValid = "tmt_kerja_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors || ($("#ui-datepicker-div").length && $("#ui-datepicker-div").filter(":visible").length))
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "tmt_kerja_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "tmt_kerja_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_kontrak_kerja_validate_tmt_kerja__cb

  // ---------- Validate id_
  function do_ajax_form_hrm_kontrak_kerja_validate_id_(iNumLinha)
  {
    var nomeCampo_id_ = "id_" + iNumLinha;
    var var_id_ = scAjaxGetFieldHidden(nomeCampo_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_kontrak_kerja_validate_id_(var_id_, iNumLinha, var_script_case_init, do_ajax_form_hrm_kontrak_kerja_validate_id__cb);
  } // do_ajax_form_hrm_kontrak_kerja_validate_id_

  function do_ajax_form_hrm_kontrak_kerja_validate_id__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_kontrak_kerja_validate_id__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_hrm_kontrak_kerja_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_hrm_kontrak_kerja_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_hrm_kontrak_kerja_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_hrm_kontrak_kerja_add_new_line_cb);
  } // do_ajax_form_hrm_kontrak_kerja_add_new_line

  function do_ajax_form_hrm_kontrak_kerja_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_hrm_kontrak_kerja_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_hrm_kontrak_kerja_backup_line(iNumLinha)
  {
    var var_id_ = scAjaxGetFieldHidden("id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_kontrak_kerja_backup_line(var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_hrm_kontrak_kerja_backup_line_cb);
  } // do_ajax_form_hrm_kontrak_kerja_backup_line

  function do_ajax_form_hrm_kontrak_kerja_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_hrm_kontrak_kerja_backup_line_cb

  function do_ajax_form_hrm_kontrak_kerja_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_hrm_kontrak_kerja_cancel_insert

  function do_ajax_form_hrm_kontrak_kerja_cancel_update(iSeqVert)
  {
    do_ajax_form_hrm_kontrak_kerja_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_hrm_kontrak_kerja_cancel_update

  function do_ajax_form_hrm_kontrak_kerja_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_hrm_kontrak_kerja_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_hrm_kontrak_kerja_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_hrm_kontrak_kerja_table_refresh(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_hrm_kontrak_kerja_table_refresh_cb);
  } //  do_ajax_form_hrm_kontrak_kerja_table_refresh

  function do_ajax_form_hrm_kontrak_kerja_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_hrm_kontrak_kerja_table_refresh_cb_after_alert);
  } // do_ajax_form_hrm_kontrak_kerja_table_refresh_cb
  function do_ajax_form_hrm_kontrak_kerja_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_hrm_kontrak_kerja_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_hrm_kontrak_kerja_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_hrm_kontrak_kerja_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    sc_num_ult_line = iNumLinha;
    sc_num_ult_tr   = indexTR;
    scAjaxHideMessage();
    var var_no_kontrak_ = scAjaxGetFieldText("no_kontrak_" + iNumLinha);
    ...
    var var_tmt_kerja_ = scAjaxGetFieldText("tmt_kerja_" + iNumLinha);
    var var_id_ = scAjaxGetFieldHidden("id_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_hrm_kontrak_kerja_submit_form(var_no_kontrak_, var_tanggal_awal_, var_tanggal_akhir_, var_tmt_kerja_, var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_hrm_kontrak_kerja_submit_form_cb);
  } // do_ajax_form_hrm_kontrak_kerja_submit_form

  function do_ajax_form_hrm_kontrak_kerja_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_hrm_kontrak_kerja_submit_form_cb_after_alert);
  } // do_ajax_form_hrm_kontrak_kerja_submit_form_cb
  function do_ajax_form_hrm_kontrak_kerja_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_hrm_kontrak_kerja_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_hrm_kontrak_kerja_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_hrm_kontrak_kerja_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_hrm_kontrak_kerja_navigate_form(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_hrm_kontrak_kerja_navigate_form_cb);
  } // do_ajax_form_hrm_kontrak_kerja_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_hrm_kontrak_kerja']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_hrm_kontrak_kerja_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_hrm_kontrak_kerja_navigate_form_cb_after_alert);
  } // do_ajax_form_hrm_kontrak_kerja_navigate_form_cb
  function do_ajax_form_hrm_kontrak_kerja_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_hrm_kontrak_kerja_navigate_form_cb_after_alert
  function sc_hide_form_hrm_kontrak_kerja_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "no_kontrak_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "tanggal_awal_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "tanggal_akhir_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "tmt_kerja_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "id_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["no_kontrak_" + iNumLinha] = {"label": "No Kontrak<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_error_list["tmt_kerja_" + iNumLinha] = {"label": "Tmt Kerja<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_field_mult["no_kontrak_"][iNumLinha] = "no_kontrak_" + iNumLinha;
    ...
    ajax_field_mult["tmt_kerja_"][iNumLinha] = "tmt_kerja_" + iNumLinha;
    ajax_field_mult["id_"][iNumLinha] = "id_" + iNumLinha;
    ajax_field_id["no_kontrak_" + iNumLinha] = new Array("hidden_field_label_no_kontrak_", "hidden_field_data_no_kontrak_" + iNumLinha);
    ...
    ajax_field_id["tmt_kerja_" + iNumLinha] = new Array("hidden_field_label_tmt_kerja_", "hidden_field_data_tmt_kerja_" + iNumLinha);
    ajax_error_count["no_kontrak_" + iNumLinha] = "off";
    ajax_error_count["tanggal_awal_" + iNumLinha] = "off";
    ajax_error_count["tanggal_akhir_" + iNumLinha] = "off";
    ajax_error_count["tmt_kerja_" + iNumLinha] = "off";
    ajax_error_count["id_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["no_kontrak_" + iNumLinha] = "off";
    ajax_read_only["tanggal_awal_" + iNumLinha] = "off";
    ajax_read_only["tanggal_akhir_" + iNumLinha] = "off";
    ajax_read_only["tmt_kerja_" + iNumLinha] = "off";
...
?>
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["no_kontrak_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["no_kontrak_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["no_kontrak_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["no_kontrak_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["no_kontrak_" + iNumLinha]["onfocus"] = new Array();
      ...
      ajax_error_list["tmt_kerja_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["tmt_kerja_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["tmt_kerja_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["tmt_kerja_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["tmt_kerja_" + iNumLinha]["onfocus"] = new Array();
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['no_kontrak_'])) ? $this->nmgp_cmp_readonly['no_kontrak_'] : 'off';
?>
    scAjaxFieldRead("no_kontrak_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['tmt_kerja_'])) ? $this->nmgp_cmp_readonly['tmt_kerja_'] : 'off';
?>
    scAjaxFieldRead("tmt_kerja_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["no_kontrak_" + iRow] || "on" == ajax_error_count["tanggal_awal_" + iRow] || "on" == ajax_error_count["tanggal_akhir_" + iRow] || "on" == ajax_error_count["tmt_kerja_" + iRow] || "on" == ajax_error_count["id_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_no_kontrak_" + iRow).addClass("scFormErrorLine");
      ...
      $("#hidden_field_data_tmt_kerja_" + iRow).addClass("scFormErrorLine");
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["no_kontrak_" + iRow] && "off" == ajax_error_count["tanggal_awal_" + iRow] && "off" == ajax_error_count["tanggal_akhir_" + iRow] && "off" == ajax_error_count["tmt_kerja_" + iRow] && "off" == ajax_error_count["id_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["no_kontrak_" + iRow] = "off";
        ajax_error_count["tanggal_awal_" + iRow] = "off";
        ajax_error_count["tanggal_akhir_" + iRow] = "off";
        ajax_error_count["tmt_kerja_" + iRow] = "off";
      ...
      $("#hidden_field_data_no_kontrak_" + iRow).removeClass("scFormErrorLine");
      ...
      $("#hidden_field_data_tmt_kerja_" + iRow).removeClass("scFormErrorLine");
