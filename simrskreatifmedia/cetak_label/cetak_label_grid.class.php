...
//
   ...
   $_SESSION['scriptcase']['cetak_label']['default_font'] = $this->default_font;
   ...
   if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
   {
       ...
       {
           if (in_array("cetak_label", $apls_aba))
           {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['cetak_label']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
   {
       $this->aba_iframe = true;
   }
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['cetak_label']['qt_col_grid'] = 3 ;  
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['cetak_label']['cols']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['cetak_label']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['cetak_label']['qt_col_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['cetak_label']['cols'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['cetak_label']['cols']);
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['cetak_label']['ordem_select']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['cetak_label']['ordem_select'] = array(); 
       $_SESSION['sc_session'][$this->Ini->sc_page]['cetak_label']['ordem_select']['a.struckNo'] = 'DESC'; 
   } 
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['cetak_label']['ordem_quebra']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['cetak_label']['ordem_grid'] = "" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['cetak_label']['ordem_ant']  = "a.struckNo DESC"; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['cetak_label']['ordem_desc'] = "" ; 
   }   
   if (!empty($nmgp_parms) && $_SESSION['sc_session'][$this->Ini->sc_page]['cetak_label']['opcao'] != "pdf")   
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['cetak_label']['opcao'] = "igual";
       $rec = "ini";
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['cetak_label']['where_orig']) || $_SESSION['sc_session'][$this->Ini->sc_page]['cetak_label']['prim_cons'] || !empty($nmgp_parms))  
   { 
   ...
   {   
       $_SESSION['sc_session'][$this->Ini->sc_page]['cetak_label']['where_pesq'] .= $this->nm_where_dinamico;
   }   
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['cetak_label']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['cetak_label']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['cetak_label']['where_pesq_filtro'];
//
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cetak_label']['tot_geral'][1])) 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['cetak_label']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['cetak_label']['tot_geral'][1] ;  
   }
   $_SESSION['sc_session'][$this->Ini->sc_page]['cetak_label']['where_pesq_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['cetak_label']['where_pesq'];  
//----- 
   ...
   $nmgp_order_by = ""; 
   $campos_order_select = "";
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['cetak_label']['ordem_select'] as $campo => $ordem) 
   {
        if ($campo != $_SESSION['sc_session'][$this->Ini->sc_page]['cetak_label']['ordem_grid']) 
        {
   ...
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['cetak_label']['ordem_grid'])) 
   { 
       $nmgp_order_by = " order by " . $_SESSION['sc_session'][$this->Ini->sc_page]['cetak_label']['ordem_grid'] . $_SESSION['sc_session'][$this->Ini->sc_page]['cetak_label']['ordem_desc']; 
   } 
   if (!empty($campos_order_select)) 
   { 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['cetak_label']['order_grid'] = $nmgp_order_by;
...
//----- 
 function grid($linhas = 0)
 {
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['cetak_label']['labels']['sc_field_0'] = "Nama Pasien";
   $_SESSION['sc_session'][$this->Ini->sc_page]['cetak_label']['labels']['sc_field_1'] = "Kategori Pasien";
   $_SESSION['sc_session'][$this->Ini->sc_page]['cetak_label']['labels']['sc_field_2'] = "No RM";
   $_SESSION['sc_session'][$this->Ini->sc_page]['cetak_label']['labels']['sc_field_3'] = "Tanggal Lahir";
   $_SESSION['sc_session'][$this->Ini->sc_page]['cetak_label']['labels']['jk'] = "JK";
   $_SESSION['sc_session'][$this->Ini->sc_page]['cetak_label']['labels']['alergi'] = "Alergi";
   $_SESSION['sc_session'][$this->Ini->sc_page]['cetak_label']['labels']['usia'] = "Usia";
   $HTTP_REFERER = (isset($_SERVER['HTTP_REFERER'])) ? $_SERVER['HTTP_REFERER'] : ""; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['cetak_label']['seq_dir'] = 0; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['cetak_label']['sub_dir'] = array(); 
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['cetak_label']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['cetak_label']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['cetak_label']['where_pesq_filtro'];
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['cetak_label']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['cetak_label']['lig_edit'] != '')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['cetak_label']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['cetak_label']['lig_edit'];
   }
...
// 
   ...
   {  
      ...
      while (!$this->rs_grid->EOF && $nm_quant_linhas < $_SESSION['sc_session'][$this->Ini->sc_page]['cetak_label']['qt_col_grid']) 
      {  
