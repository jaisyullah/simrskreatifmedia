<?php
@session_start() ;
$_SESSION['scriptcase']['cetak_label']['sc_process_barr'] = true;
require_once('../cetak_label/index.php');
unset($_SESSION['scriptcase']['cetak_label']['sc_process_barr']);
$ExportCtrl = new cetak_label_export_control;
$ExportCtrl->Export_barr();

class cetak_label_export_control
{
