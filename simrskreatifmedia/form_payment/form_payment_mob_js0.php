...
{ 
   var sob_iframe = '';
<?php 
if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_mob']['embutida_form']) {
...
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_mob']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_mob']['sc_modal']) {
    echo "   sob_iframe += 'parent.';\r\n";
}
?>
...
function sc_form_onload()
{
   ...
   nm_field_disabled("nostruk=disabled;custcode=disabled;sc_field_1=disabled;dokter=disabled;jmltagihan=disabled;hrsdibayar=disabled;kasir=disabled", "U");
