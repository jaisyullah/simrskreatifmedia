...
//----- 
   function ini_controle()
   {
      ...
      { 
          ...
          if (!isset($_SESSION['sc_session'][$script_case_init]['form_payment_mob']['total']))
          {
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_payment_mob']['form_tbtindakanrawatjalan_mob_script_case_init'] ]['form_tbtindakanrawatjalan_mob']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_payment_mob']['form_tbtindakanrawatjalan_mob_script_case_init'] ]['form_tbtindakanrawatjalan_mob']['total']);
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_payment_mob']['form_tbreseprawatjalan_mob_script_case_init'] ]['form_tbreseprawatjalan_mob']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_payment_mob']['form_tbreseprawatjalan_mob_script_case_init'] ]['form_tbreseprawatjalan_mob']['total']);
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_payment_mob']['form_detailadm_mob_script_case_init'] ]['form_detailadm_mob']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_payment_mob']['form_detailadm_mob_script_case_init'] ]['form_detailadm_mob']['total']);
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_payment_mob']['form_tbdetaillab_mob_script_case_init'] ]['form_tbdetaillab_mob']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_payment_mob']['form_tbdetaillab_mob_script_case_init'] ]['form_tbdetaillab_mob']['total']);
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_payment_mob']['form_tbdetailrad_mob_script_case_init'] ]['form_tbdetailrad_mob']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_payment_mob']['form_tbdetailrad_mob_script_case_init'] ]['form_tbdetailrad_mob']['total']);
          }
      ...
      if (isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_mob']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_mob']['sc_outra_jan'] || $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_mob']['sc_modal']))
      {
      ...
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_mob']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_mob']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_mob']['sc_outra_jan']))
      {
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_payment_mob']))
          {
               ...
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_payment_mob']['label'] = "" . $this->Ini->Nm_lang['lang_othr_frmu_titl'] . " - Pembayaran RJ";
      ...
      {
          $this->nmgp_botoes['Cetak'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_mob']['botoes']['Cetak'];
...
//
      if ($this->nmgp_opcao == "excluir")
      {
          ...
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_mob']['form_tbtindakanrawatjalan_mob_script_case_init'] ]['form_tbtindakanrawatjalan_mob']['embutida_form'] = false;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_mob']['form_tbtindakanrawatjalan_mob_script_case_init'] ]['form_tbtindakanrawatjalan_mob']['embutida_proc'] = true;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_mob']['form_tbtindakanrawatjalan_mob_script_case_init'] ]['form_tbtindakanrawatjalan_mob']['reg_start'] = "";
          unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_mob']['form_tbtindakanrawatjalan_mob_script_case_init'] ]['form_tbtindakanrawatjalan_mob']['total']);
          ...
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_mob']['form_tbreseprawatjalan_mob_script_case_init'] ]['form_tbreseprawatjalan_mob']['embutida_form'] = false;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_mob']['form_tbreseprawatjalan_mob_script_case_init'] ]['form_tbreseprawatjalan_mob']['embutida_proc'] = true;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_mob']['form_tbreseprawatjalan_mob_script_case_init'] ]['form_tbreseprawatjalan_mob']['reg_start'] = "";
          unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_mob']['form_tbreseprawatjalan_mob_script_case_init'] ]['form_tbreseprawatjalan_mob']['total']);
          ...
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_mob']['form_detailadm_mob_script_case_init'] ]['form_detailadm_mob']['embutida_form'] = false;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_mob']['form_detailadm_mob_script_case_init'] ]['form_detailadm_mob']['embutida_proc'] = true;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_mob']['form_detailadm_mob_script_case_init'] ]['form_detailadm_mob']['reg_start'] = "";
          unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_mob']['form_detailadm_mob_script_case_init'] ]['form_detailadm_mob']['total']);
          ...
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_mob']['form_tbdetaillab_mob_script_case_init'] ]['form_tbdetaillab_mob']['embutida_form'] = false;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_mob']['form_tbdetaillab_mob_script_case_init'] ]['form_tbdetaillab_mob']['embutida_proc'] = true;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_mob']['form_tbdetaillab_mob_script_case_init'] ]['form_tbdetaillab_mob']['reg_start'] = "";
          unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_mob']['form_tbdetaillab_mob_script_case_init'] ]['form_tbdetaillab_mob']['total']);
          ...
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_mob']['form_tbdetailrad_mob_script_case_init'] ]['form_tbdetailrad_mob']['embutida_form'] = false;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_mob']['form_tbdetailrad_mob_script_case_init'] ]['form_tbdetailrad_mob']['embutida_proc'] = true;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_mob']['form_tbdetailrad_mob_script_case_init'] ]['form_tbdetailrad_mob']['reg_start'] = "";
          unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_mob']['form_tbdetailrad_mob_script_case_init'] ]['form_tbdetailrad_mob']['total']);
...
//
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
      ...
      {
          $this->nm_tira_formatacao();
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_mob']['dados_select']['nostruk']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->nostruk = $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_mob']['dados_select']['nostruk'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_mob']['dados_select']['custcode']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->custcode = $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_mob']['dados_select']['custcode'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_mob']['dados_select']['sc_field_1']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->sc_field_1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_mob']['dados_select']['sc_field_1'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_mob']['dados_select']['dokter']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->dokter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_mob']['dados_select']['dokter'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_mob']['dados_select']['jmltagihan']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->jmltagihan = $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_mob']['dados_select']['jmltagihan'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_mob']['dados_select']['jmlbayar']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->jmlbayar = $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_mob']['dados_select']['jmlbayar'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_mob']['dados_select']['potongan']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->potongan = $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_mob']['dados_select']['potongan'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_mob']['dados_select']['hrsdibayar']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->hrsdibayar = $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_mob']['dados_select']['hrsdibayar'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_mob']['dados_select']['nopayment']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->nopayment = $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_mob']['dados_select']['nopayment'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_mob']['dados_select']['kasir']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->kasir = $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_mob']['dados_select']['kasir'];
          } 
...
$javascript_message = 'Data pembayaran berhasil diinput.';  
...
$_SESSION['scriptcase']['form_payment_mob']['contr_erro'] = 'off'; 
    ...
    function ValidateField_custcode(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->custcode) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_mob']['Lookup_custcode']) && !in_array($this->custcode, $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_mob']['Lookup_custcode']))
               {
                   $hasError = true;
    ...
    function ValidateField_sc_field_1(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->sc_field_1) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_mob']['Lookup_sc_field_1']) && !in_array($this->sc_field_1, $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_mob']['Lookup_sc_field_1']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_dokter(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->dokter) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_mob']['Lookup_dokter']) && !in_array($this->dokter, $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_mob']['Lookup_dokter']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_bankdebit(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->bankdebit) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_mob']['Lookup_bankdebit']) && !in_array($this->bankdebit, $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_mob']['Lookup_bankdebit']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
...
;
    ...
    function ValidateField_poli(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->poli) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_mob']['Lookup_poli']) && !in_array($this->poli, $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_mob']['Lookup_poli']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
...
//
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_mob']['total'] < 0)
              {
              ...
              if (isset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_mob']['form_detailadm_mob_script_case_init'] ]['form_detailadm_mob']['total']))
              {
                  unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_mob']['form_detailadm_mob_script_case_init'] ]['form_detailadm_mob']['total']);
              }
              ...
              if (isset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_mob']['form_tbreseprawatjalan_mob_script_case_init'] ]['form_tbreseprawatjalan_mob']['total']))
              {
                  unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_mob']['form_tbreseprawatjalan_mob_script_case_init'] ]['form_tbreseprawatjalan_mob']['total']);
              }
              ...
              if (isset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_mob']['form_tbtindakanrawatjalan_mob_script_case_init'] ]['form_tbtindakanrawatjalan_mob']['total']))
              {
                  unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_mob']['form_tbtindakanrawatjalan_mob_script_case_init'] ]['form_tbtindakanrawatjalan_mob']['total']);
              }
              ...
              if (isset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_mob']['form_tbdetaillab_mob_script_case_init'] ]['form_tbdetaillab_mob']['total']))
              {
                  unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_mob']['form_tbdetaillab_mob_script_case_init'] ]['form_tbdetaillab_mob']['total']);
              }
              ...
              if (isset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_mob']['form_tbdetailrad_mob_script_case_init'] ]['form_tbdetailrad_mob']['total']))
              {
                  unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_mob']['form_tbdetailrad_mob_script_case_init'] ]['form_tbdetailrad_mob']['total']);
              }
          }
...
{ 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       while (!$rs->EOF) 
       { 
              $aLookup[] = array(form_payment_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', form_payment_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[0]))));
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['custcode']['valList'][$i] = form_payment_mob_pack_protect_string($v);
          }
...
else
{
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['sc_field_1']['valList'][$i] = form_payment_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
{ 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['dokter']['valList'][$i] = form_payment_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_payment_mob_pack_protect_string('TUNAI') => form_payment_mob_pack_protect_string("TUNAI"));
$aLookup[] = array(form_payment_mob_pack_protect_string('BPJS') => form_payment_mob_pack_protect_string("BPJS"));
$aLookup[] = array(form_payment_mob_pack_protect_string('KARTU KREDIT') => form_payment_mob_pack_protect_string("KARTU KREDIT"));
$aLookup[] = array(form_payment_mob_pack_protect_string('KARTU DEBIT') => form_payment_mob_pack_protect_string("KARTU DEBIT"));
$aLookup[] = array(form_payment_mob_pack_protect_string('ASURANSI') => form_payment_mob_pack_protect_string("ASURANSI"));
$aLookup[] = array(form_payment_mob_pack_protect_string('KARYAWAN') => form_payment_mob_pack_protect_string("KARYAWAN"));
$aLookup[] = array(form_payment_mob_pack_protect_string('KOMBINASI') => form_payment_mob_pack_protect_string("KOMBINASI"));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_mob']['Lookup_jenispayment'][] = 'TUNAI';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_mob']['Lookup_jenispayment'][] = 'BPJS';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_mob']['Lookup_jenispayment'][] = 'KARTU KREDIT';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_mob']['Lookup_jenispayment'][] = 'KARTU DEBIT';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_mob']['Lookup_jenispayment'][] = 'ASURANSI';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_mob']['Lookup_jenispayment'][] = 'KARYAWAN';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_mob']['Lookup_jenispayment'][] = 'KOMBINASI';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['jenispayment']['valList'][$i] = form_payment_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          $val_output = isset($aLookup[0][form_payment_mob_pack_protect_string(NM_charset_to_utf8($this->instansipenjamin))]) ? $aLookup[0][form_payment_mob_pack_protect_string(NM_charset_to_utf8($this->instansipenjamin))] : "";
...
else
{
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['bankdebit']['valList'][$i] = form_payment_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
else
{
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['poli']['valList'][$i] = form_payment_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$_SESSION['scriptcase']['form_payment_mob']['contr_erro'] = 'off'; 
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          { 
              ...
              $this->nmgp_refresh_fields = array_diff(array('id', 'nostruk', 'custcode', 'sc_field_1', 'dokter', 'jmltagihan', 'jmlbayar', 'deposit', 'potongan', 'hrsdibayar', 'nopayment', 'terimadari', 'jenispayment', 'instansipenjamin', 'bankdebit', 'nokartu', 'sc_field_0', 'poli', 'kasir', 'detailtindakan', 'detailresep', 'detailadm', 'lab', 'radiologi'), $aDoNotUpdate);
              $this->ajax_return_values();
      ...
      { 
          ...
          if ($bDelecaoOk)
          {
              $sDetailWhere = "pasien = '" . $this->custcode . "'";
...
$jmlTagihan = $jmlTindakan+$jmlResep+$jmladm;
...
$modificado_jenispayment = $this->jenispayment;
$modificado_jmltagihan = $this->jmltagihan;
$modificado_dokter = $this->dokter;
$modificado_custcode = $this->custcode;
$modificado_poli = $this->poli;
$modificado_instansipenjamin = $this->instansipenjamin;
$modificado_jenispayment = $this->jenispayment;
$modificado_hrsdibayar = $this->hrsdibayar;
$this->nm_formatar_campos('nostruk', 'jenispayment');
...
if ($original_dokter !== $modificado_dokter || isset($this->nmgp_cmp_readonly['dokter']) || (isset($bFlagRead_dokter) && $bFlagRead_dokter))
{
...
$this->jmltagihan  = ($jmlTindakan+$jmlResep+$jmladm)-$pembayaran;
...
if($jenisby == 'TUNAI'){
	$this->jenispayment  = 'TUNAI';
}else if ($jenisby == 'BPJS'){
	$this->jenispayment  = 'BPJS';
}else if ($jenisby == 'ASURANSI'){
	$this->jenispayment  = 'ASURANSI';
}
...
$modificado_jmltagihan = $this->jmltagihan;
$modificado_hrsdibayar = $this->hrsdibayar;
$this->nm_formatar_campos('jmltagihan', 'nostruk', 'jenispayment');
if ($original_jmltagihan !== $modificado_jmltagihan || isset($this->nmgp_cmp_readonly['jmltagihan']) || (isset($bFlagRead_jmltagihan) && $bFlagRead_jmltagihan))
{
    $this->ajax_return_values_jmltagihan(true);
}
