 ...
 function nm_field_disabled(Fields, Opt) {
  ...
  for (i=0; i < Field.length; i++)
  {
     ...
     if (F_name == "nostruk")
     {
        ...
        $('input[id="cap_nostruk"]').prop("disabled", F_opc);
        if (F_opc == "disabled" || F_opc == true) {
            $('#cap_nostruk').hide();
        }
        else {
...
?>
 ...
 function addAutocomplete(elem) {
  ...
  $(".sc-ui-autocomp-instansipenjamin", elem).on("focus", function() {
   ...
   var sId = $(this).attr("id").substr(6), sRow = "instansipenjamin" != sId ? sId.substr(16) : "";
   sc_form_payment_instansipenjamin_onfocus("id_sc_field_" + sId, sRow);
...
<span id="id_read_on_nostruk" class="sc-ui-readonly-nostruk css_nostruk_line" style="<?php echo $sStyleReadLab_nostruk; ?>"><?php echo $this->nostruk; ?></span><span id="id_read_off_nostruk" class="css_read_off_nostruk" style="white-space: nowrap;<?php echo $sStyleReadInp_nostruk; ?>">
 ...
 size=10 maxlength=10 alt="{datatype: 'text', maxLength: 10, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php
   ...
   if (isset($this->Ini->sc_lig_md5["grid_belum_bayar"]) && $this->Ini->sc_lig_md5["grid_belum_bayar"] == "S") {
       $Parms_Lig  = "nmgp_url_saida*scin*scoutnmgp_parms_ret*scinF1,nostruk,struk*scoutnm_evt_ret_busca*scinsc_form_payment_nostruk_onchange(this)*scout" . $Sc_iframe_master;
       ...
       $Md5_Lig  = "nmgp_url_saida*scin*scoutnmgp_parms_ret*scinF1,nostruk,struk*scoutnm_evt_ret_busca*scinsc_form_payment_nostruk_onchange(this)*scout" . $Sc_iframe_master;
   }
?>

<?php if (!$this->Ini->Export_img_zip) { ?><?php echo nmButtonOutput($this->arr_buttons, "bform_captura", "nm_submit_cap('" . $this->Ini->link_grid_belum_bayar_cons_psq. "', '" . $Md5_Lig . "')", "nm_submit_cap('" . $this->Ini->link_grid_belum_bayar_cons_psq. "', '" . $Md5_Lig . "')", "cap_nostruk", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
<?php } ?>
<?php } ?>
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['Lookup_custcode']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['Lookup_custcode'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['Lookup_custcode']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['Lookup_custcode'] = array(); 
}
if ($this->nostruk != "")
{ 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       while (!$rs->EOF) 
       { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['Lookup_custcode'][] = $rs->fields[0];
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['Lookup_sc_field_1']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['Lookup_sc_field_1'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['Lookup_sc_field_1']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['Lookup_sc_field_1'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['Lookup_sc_field_1'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['Lookup_dokter']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['Lookup_dokter'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['Lookup_dokter']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['Lookup_dokter'] = array(); 
}
if ($this->nostruk != "")
{ 
   $this->nm_clear_val("nostruk");
   ...
   $nm_comando = "SELECT doctor  FROM tbantrian where struckNo = '$this->nostruk'  ORDER BY doctor";
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       while (!$rs->EOF) 
       { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['Lookup_dokter'][] = $rs->fields[0];
              $nmgp_def_dados .= $rs->fields[0] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $rs->MoveNext() ; 
       } 
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   {
       $this->nm_new_label['jenispayment'] = "Cara Bayar";
   }
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
   $nm_img_fun_cel  = ($nm_img_fun_cel  == $this->Ini->img_fun_imp    ? $this->Ini->img_fun_par  : $this->Ini->img_fun_imp);
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['Lookup_jenispayment'][] = ''; ?>
 <option value=""></option>
 <option  value="TUNAI" <?php  if ($this->jenispayment == "TUNAI") { echo " selected" ;} ?>>TUNAI</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['Lookup_jenispayment'][] = 'TUNAI'; ?>
 <option  value="BPJS" <?php  if ($this->jenispayment == "BPJS") { echo " selected" ;} ?>>BPJS</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['Lookup_jenispayment'][] = 'BPJS'; ?>
 <option  value="KARTU KREDIT" <?php  if ($this->jenispayment == "KARTU KREDIT") { echo " selected" ;} ?>>KARTU KREDIT</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['Lookup_jenispayment'][] = 'KARTU KREDIT'; ?>
 <option  value="KARTU DEBIT" <?php  if ($this->jenispayment == "KARTU DEBIT") { echo " selected" ;} ?>>KARTU DEBIT</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['Lookup_jenispayment'][] = 'KARTU DEBIT'; ?>
 <option  value="ASURANSI" <?php  if ($this->jenispayment == "ASURANSI") { echo " selected" ;} ?>>ASURANSI</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['Lookup_jenispayment'][] = 'ASURANSI'; ?>
 <option  value="KARYAWAN" <?php  if ($this->jenispayment == "KARYAWAN") { echo " selected" ;} ?>>KARYAWAN</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['Lookup_jenispayment'][] = 'KARYAWAN'; ?>
 <option  value="KOMBINASI" <?php  if ($this->jenispayment == "KOMBINASI") { echo " selected" ;} ?>>KOMBINASI</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['Lookup_jenispayment'][] = 'KOMBINASI'; ?>
 </select></span>
</span><?php  }?>
...
$aLookup = array();
   ...
   $nm_nao_carga = false;
   $nmgp_def_dados = "" ; 
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['Lookup_instansipenjamin']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['Lookup_instansipenjamin'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['Lookup_instansipenjamin']); 
   }
   else
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['Lookup_instansipenjamin'] = array(); 
    }
   ...
   if ($nm_comando != "" && $rs = $this->Db->SelectLimit($nm_comando, 10, 0))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['Lookup_instansipenjamin'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['Lookup_bankdebit']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['Lookup_bankdebit'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['Lookup_bankdebit']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['Lookup_bankdebit'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['Lookup_bankdebit'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['Lookup_poli']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['Lookup_poli'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['Lookup_poli']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['Lookup_poli'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['Lookup_poli'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_detailTindakan'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_detailTindakan'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['form_tbtindakanrawatjalan_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_detailTindakan'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['form_tbtindakanrawatjalan_script_case_init'] = $this->Ini->sc_page;
 }
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['form_tbtindakanrawatjalan_script_case_init'] ]['form_tbtindakanrawatjalan']['embutida_proc']  = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['form_tbtindakanrawatjalan_script_case_init'] ]['form_tbtindakanrawatjalan']['embutida_form']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['form_tbtindakanrawatjalan_script_case_init'] ]['form_tbtindakanrawatjalan']['embutida_call']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['form_tbtindakanrawatjalan_script_case_init'] ]['form_tbtindakanrawatjalan']['embutida_multi'] = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['form_tbtindakanrawatjalan_script_case_init'] ]['form_tbtindakanrawatjalan']['embutida_liga_form_insert'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['form_tbtindakanrawatjalan_script_case_init'] ]['form_tbtindakanrawatjalan']['embutida_liga_form_update'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['form_tbtindakanrawatjalan_script_case_init'] ]['form_tbtindakanrawatjalan']['embutida_liga_form_delete'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['form_tbtindakanrawatjalan_script_case_init'] ]['form_tbtindakanrawatjalan']['embutida_liga_form_btn_nav'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['form_tbtindakanrawatjalan_script_case_init'] ]['form_tbtindakanrawatjalan']['embutida_liga_grid_edit'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['form_tbtindakanrawatjalan_script_case_init'] ]['form_tbtindakanrawatjalan']['embutida_liga_grid_edit_link'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['form_tbtindakanrawatjalan_script_case_init'] ]['form_tbtindakanrawatjalan']['embutida_liga_qtd_reg'] = '10';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['form_tbtindakanrawatjalan_script_case_init'] ]['form_tbtindakanrawatjalan']['embutida_liga_tp_pag'] = 'parcial';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['form_tbtindakanrawatjalan_script_case_init'] ]['form_tbtindakanrawatjalan']['embutida_parms'] = "NM_btn_insert*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinS*scoutNM_btn_navega*scinN*scout";
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['form_tbtindakanrawatjalan_script_case_init'] ]['form_tbtindakanrawatjalan']['foreign_key']['trancode'] = $this->nmgp_dados_form['trancode'];
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['form_tbtindakanrawatjalan_script_case_init'] ]['form_tbtindakanrawatjalan']['where_filter'] = "tranCode = '" . $this->nmgp_dados_form['trancode'] . "'";
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['form_tbtindakanrawatjalan_script_case_init'] ]['form_tbtindakanrawatjalan']['where_detal']  = "tranCode = '" . $this->nmgp_dados_form['trancode'] . "'";
 if ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['form_tbtindakanrawatjalan_script_case_init'] ]['form_payment']['total'] < 0)
 {
     $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['form_tbtindakanrawatjalan_script_case_init'] ]['form_tbtindakanrawatjalan']['where_filter'] = "1 <> 1";
 }
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_payment_empty.htm' : $this->Ini->link_form_tbtindakanrawatjalan_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_session=' . session_id() . '&script_case_detail=Y';
if (isset($this->Ini->sc_lig_target['C_@scinf_detailTindakan']) && 'nmsc_iframe_liga_form_tbtindakanrawatjalan' != $this->Ini->sc_lig_target['C_@scinf_detailTindakan'])
{
    ...
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_detailTindakan'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['form_tbtindakanrawatjalan_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_detailResep'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_detailResep'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['form_tbreseprawatjalan_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_detailResep'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['form_tbreseprawatjalan_script_case_init'] = $this->Ini->sc_page;
 }
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['form_tbreseprawatjalan_script_case_init'] ]['form_tbreseprawatjalan']['embutida_proc']  = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['form_tbreseprawatjalan_script_case_init'] ]['form_tbreseprawatjalan']['embutida_form']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['form_tbreseprawatjalan_script_case_init'] ]['form_tbreseprawatjalan']['embutida_call']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['form_tbreseprawatjalan_script_case_init'] ]['form_tbreseprawatjalan']['embutida_multi'] = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['form_tbreseprawatjalan_script_case_init'] ]['form_tbreseprawatjalan']['embutida_liga_form_insert'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['form_tbreseprawatjalan_script_case_init'] ]['form_tbreseprawatjalan']['embutida_liga_form_update'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['form_tbreseprawatjalan_script_case_init'] ]['form_tbreseprawatjalan']['embutida_liga_form_delete'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['form_tbreseprawatjalan_script_case_init'] ]['form_tbreseprawatjalan']['embutida_liga_form_btn_nav'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['form_tbreseprawatjalan_script_case_init'] ]['form_tbreseprawatjalan']['embutida_liga_grid_edit'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['form_tbreseprawatjalan_script_case_init'] ]['form_tbreseprawatjalan']['embutida_liga_grid_edit_link'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['form_tbreseprawatjalan_script_case_init'] ]['form_tbreseprawatjalan']['embutida_liga_qtd_reg'] = '10';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['form_tbreseprawatjalan_script_case_init'] ]['form_tbreseprawatjalan']['embutida_liga_tp_pag'] = 'parcial';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['form_tbreseprawatjalan_script_case_init'] ]['form_tbreseprawatjalan']['embutida_parms'] = "trancode*scin" . $this->nmgp_dados_form['trancode'] . "*scoutNM_btn_insert*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinS*scoutNM_btn_navega*scinN*scout";
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['form_tbreseprawatjalan_script_case_init'] ]['form_tbreseprawatjalan']['foreign_key']['trancode'] = $this->nmgp_dados_form['trancode'];
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['form_tbreseprawatjalan_script_case_init'] ]['form_tbreseprawatjalan']['where_filter'] = "tranCode = '" . $this->nmgp_dados_form['trancode'] . "'";
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['form_tbreseprawatjalan_script_case_init'] ]['form_tbreseprawatjalan']['where_detal']  = "tranCode = '" . $this->nmgp_dados_form['trancode'] . "'";
 if ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['form_tbreseprawatjalan_script_case_init'] ]['form_payment']['total'] < 0)
 {
     $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['form_tbreseprawatjalan_script_case_init'] ]['form_tbreseprawatjalan']['where_filter'] = "1 <> 1";
 }
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_payment_empty.htm' : $this->Ini->link_form_tbreseprawatjalan_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_session=' . session_id() . '&script_case_detail=Y';
if (isset($this->Ini->sc_lig_target['C_@scinf_detailResep']) && 'nmsc_iframe_liga_form_tbreseprawatjalan' != $this->Ini->sc_lig_target['C_@scinf_detailResep'])
{
    if ('novo' != $this->nmgp_opcao)
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_detailResep'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['form_tbreseprawatjalan_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_detailAdm'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_detailAdm'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['form_detailadm_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_detailAdm'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['form_detailadm_script_case_init'] = $this->Ini->sc_page;
 }
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['form_detailadm_script_case_init'] ]['form_detailadm']['embutida_proc']  = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['form_detailadm_script_case_init'] ]['form_detailadm']['embutida_form']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['form_detailadm_script_case_init'] ]['form_detailadm']['embutida_call']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['form_detailadm_script_case_init'] ]['form_detailadm']['embutida_multi'] = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['form_detailadm_script_case_init'] ]['form_detailadm']['embutida_liga_form_insert'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['form_detailadm_script_case_init'] ]['form_detailadm']['embutida_liga_form_update'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['form_detailadm_script_case_init'] ]['form_detailadm']['embutida_liga_form_delete'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['form_detailadm_script_case_init'] ]['form_detailadm']['embutida_liga_form_btn_nav'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['form_detailadm_script_case_init'] ]['form_detailadm']['embutida_liga_grid_edit'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['form_detailadm_script_case_init'] ]['form_detailadm']['embutida_liga_grid_edit_link'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['form_detailadm_script_case_init'] ]['form_detailadm']['embutida_liga_qtd_reg'] = '10';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['form_detailadm_script_case_init'] ]['form_detailadm']['embutida_liga_tp_pag'] = 'parcial';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['form_detailadm_script_case_init'] ]['form_detailadm']['embutida_parms'] = "NM_btn_insert*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinS*scoutNM_btn_navega*scinN*scout";
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['form_detailadm_script_case_init'] ]['form_detailadm']['foreign_key']['trancode'] = $this->nmgp_dados_form['trancode'];
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['form_detailadm_script_case_init'] ]['form_detailadm']['where_filter'] = "tranCode = '" . $this->nmgp_dados_form['trancode'] . "'";
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['form_detailadm_script_case_init'] ]['form_detailadm']['where_detal']  = "tranCode = '" . $this->nmgp_dados_form['trancode'] . "'";
 if ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['form_detailadm_script_case_init'] ]['form_payment']['total'] < 0)
 {
     $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['form_detailadm_script_case_init'] ]['form_detailadm']['where_filter'] = "1 <> 1";
 }
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_payment_empty.htm' : $this->Ini->link_form_detailadm_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_session=' . session_id() . '&script_case_detail=Y';
if (isset($this->Ini->sc_lig_target['C_@scinf_detailAdm']) && 'nmsc_iframe_liga_form_detailadm' != $this->Ini->sc_lig_target['C_@scinf_detailAdm'])
{
    if ('novo' != $this->nmgp_opcao)
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_detailAdm'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['form_detailadm_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
<TABLE align="center" id="hidden_bloco_4" class="scFormTable" width="100%" style="height: 100%;"><?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    ...
    {
        $this->nm_new_label['lab'] = "LABORATORIUM";
    }
?>
<?php
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_lab'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_lab'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['form_tbdetaillab_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_lab'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['form_tbdetaillab_script_case_init'] = $this->Ini->sc_page;
 }
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['form_tbdetaillab_script_case_init'] ]['form_tbdetaillab']['embutida_proc']  = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['form_tbdetaillab_script_case_init'] ]['form_tbdetaillab']['embutida_form']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['form_tbdetaillab_script_case_init'] ]['form_tbdetaillab']['embutida_call']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['form_tbdetaillab_script_case_init'] ]['form_tbdetaillab']['embutida_multi'] = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['form_tbdetaillab_script_case_init'] ]['form_tbdetaillab']['embutida_liga_form_insert'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['form_tbdetaillab_script_case_init'] ]['form_tbdetaillab']['embutida_liga_form_update'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['form_tbdetaillab_script_case_init'] ]['form_tbdetaillab']['embutida_liga_form_delete'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['form_tbdetaillab_script_case_init'] ]['form_tbdetaillab']['embutida_liga_form_btn_nav'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['form_tbdetaillab_script_case_init'] ]['form_tbdetaillab']['embutida_liga_grid_edit'] = '';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['form_tbdetaillab_script_case_init'] ]['form_tbdetaillab']['embutida_liga_grid_edit_link'] = '';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['form_tbdetaillab_script_case_init'] ]['form_tbdetaillab']['embutida_liga_qtd_reg'] = '10';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['form_tbdetaillab_script_case_init'] ]['form_tbdetaillab']['embutida_liga_tp_pag'] = 'parcial';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['form_tbdetaillab_script_case_init'] ]['form_tbdetaillab']['embutida_parms'] = "NM_btn_insert*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinS*scoutNM_btn_navega*scinN*scout";
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['form_tbdetaillab_script_case_init'] ]['form_tbdetaillab']['foreign_key']['pasien'] = $this->nmgp_dados_form['custcode'];
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['form_tbdetaillab_script_case_init'] ]['form_tbdetaillab']['where_filter'] = "pasien = '" . $this->nmgp_dados_form['custcode'] . "'";
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['form_tbdetaillab_script_case_init'] ]['form_tbdetaillab']['where_detal']  = "pasien = '" . $this->nmgp_dados_form['custcode'] . "'";
 if ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['form_tbdetaillab_script_case_init'] ]['form_payment']['total'] < 0)
 {
     $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['form_tbdetaillab_script_case_init'] ]['form_tbdetaillab']['where_filter'] = "1 <> 1";
 }
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_payment_empty.htm' : $this->Ini->link_form_tbdetaillab_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_session=' . session_id() . '&script_case_detail=Y';
if (isset($this->Ini->sc_lig_target['C_@scinf_lab']) && 'nmsc_iframe_liga_form_tbdetaillab' != $this->Ini->sc_lig_target['C_@scinf_lab'])
{
    if ('novo' != $this->nmgp_opcao)
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_lab'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['form_tbdetaillab_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
{
?>
<iframe border="0" id="nmsc_iframe_liga_form_tbdetaillab"  marginWidth="0" marginHeight="0" frameborder="0" valign="top" height="100" width="100%" name="nmsc_iframe_liga_form_tbdetaillab"  scrolling="auto" src="<?php echo $sDetailSrc; ?>"></iframe>
<?php
}
?>
...
<TABLE align="center" id="hidden_bloco_5" class="scFormTable" width="100%" style="height: 100%;"><?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    ...
    {
        $this->nm_new_label['radiologi'] = "RADIOLOGI";
    }
?>
<?php
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_radiologi'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_radiologi'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['form_tbdetailrad_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_radiologi'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['form_tbdetailrad_script_case_init'] = $this->Ini->sc_page;
 }
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['form_tbdetailrad_script_case_init'] ]['form_tbdetailrad']['embutida_proc']  = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['form_tbdetailrad_script_case_init'] ]['form_tbdetailrad']['embutida_form']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['form_tbdetailrad_script_case_init'] ]['form_tbdetailrad']['embutida_call']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['form_tbdetailrad_script_case_init'] ]['form_tbdetailrad']['embutida_multi'] = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['form_tbdetailrad_script_case_init'] ]['form_tbdetailrad']['embutida_liga_form_insert'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['form_tbdetailrad_script_case_init'] ]['form_tbdetailrad']['embutida_liga_form_update'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['form_tbdetailrad_script_case_init'] ]['form_tbdetailrad']['embutida_liga_form_delete'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['form_tbdetailrad_script_case_init'] ]['form_tbdetailrad']['embutida_liga_form_btn_nav'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['form_tbdetailrad_script_case_init'] ]['form_tbdetailrad']['embutida_liga_grid_edit'] = '';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['form_tbdetailrad_script_case_init'] ]['form_tbdetailrad']['embutida_liga_grid_edit_link'] = '';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['form_tbdetailrad_script_case_init'] ]['form_tbdetailrad']['embutida_liga_qtd_reg'] = '10';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['form_tbdetailrad_script_case_init'] ]['form_tbdetailrad']['embutida_liga_tp_pag'] = 'parcial';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['form_tbdetailrad_script_case_init'] ]['form_tbdetailrad']['embutida_parms'] = "NM_btn_insert*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinS*scoutNM_btn_navega*scinN*scout";
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['form_tbdetailrad_script_case_init'] ]['form_tbdetailrad']['foreign_key']['pasien'] = $this->nmgp_dados_form['custcode'];
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['form_tbdetailrad_script_case_init'] ]['form_tbdetailrad']['where_filter'] = "pasien = '" . $this->nmgp_dados_form['custcode'] . "'";
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['form_tbdetailrad_script_case_init'] ]['form_tbdetailrad']['where_detal']  = "pasien = '" . $this->nmgp_dados_form['custcode'] . "'";
 if ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['form_tbdetailrad_script_case_init'] ]['form_payment']['total'] < 0)
 {
     $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['form_tbdetailrad_script_case_init'] ]['form_tbdetailrad']['where_filter'] = "1 <> 1";
 }
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_payment_empty.htm' : $this->Ini->link_form_tbdetailrad_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_session=' . session_id() . '&script_case_detail=Y';
if (isset($this->Ini->sc_lig_target['C_@scinf_radiologi']) && 'nmsc_iframe_liga_form_tbdetailrad' != $this->Ini->sc_lig_target['C_@scinf_radiologi'])
{
    if ('novo' != $this->nmgp_opcao)
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_radiologi'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['form_tbdetailrad_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
{
?>
<iframe border="0" id="nmsc_iframe_liga_form_tbdetailrad"  marginWidth="0" marginHeight="0" frameborder="0" valign="top" height="100" width="100%" name="nmsc_iframe_liga_form_tbdetailrad"  scrolling="auto" src="<?php echo $sDetailSrc; ?>"></iframe>
<?php
}
?>
