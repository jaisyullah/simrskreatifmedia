...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_id' + iSeqRow).bind('blur', function() { sc_form_payment_id_onblur(this, iSeqRow) })
                                .bind('focus', function() { sc_form_payment_id_onfocus(this, iSeqRow) });
  $('#id_sc_field_nostruk' + iSeqRow).bind('blur', function() { sc_form_payment_nostruk_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_form_payment_nostruk_onchange(this, iSeqRow) })
                                     .bind('focus', function() { sc_form_payment_nostruk_onfocus(this, iSeqRow) });
  $('#id_sc_field_custcode' + iSeqRow).bind('blur', function() { sc_form_payment_custcode_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_form_payment_custcode_onchange(this, iSeqRow) })
                                      .bind('focus', function() { sc_form_payment_custcode_onfocus(this, iSeqRow) });
  $('#id_sc_field_dokter' + iSeqRow).bind('blur', function() { sc_form_payment_dokter_onblur(this, iSeqRow) })
                                    .bind('change', function() { sc_form_payment_dokter_onchange(this, iSeqRow) })
                                    .bind('focus', function() { sc_form_payment_dokter_onfocus(this, iSeqRow) });
  $('#id_sc_field_jmltagihan' + iSeqRow).bind('blur', function() { sc_form_payment_jmltagihan_onblur(this, iSeqRow) })
                                        .bind('focus', function() { sc_form_payment_jmltagihan_onfocus(this, iSeqRow) });
  $('#id_sc_field_jmlbayar' + iSeqRow).bind('blur', function() { sc_form_payment_jmlbayar_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_form_payment_jmlbayar_onchange(this, iSeqRow) })
                                      .bind('focus', function() { sc_form_payment_jmlbayar_onfocus(this, iSeqRow) });
  $('#id_sc_field_deposit' + iSeqRow).bind('blur', function() { sc_form_payment_deposit_onblur(this, iSeqRow) })
                                     .bind('focus', function() { sc_form_payment_deposit_onfocus(this, iSeqRow) });
  $('#id_sc_field_potongan' + iSeqRow).bind('blur', function() { sc_form_payment_potongan_onblur(this, iSeqRow) })
                                      .bind('focus', function() { sc_form_payment_potongan_onfocus(this, iSeqRow) });
  $('#id_sc_field_hrsdibayar' + iSeqRow).bind('blur', function() { sc_form_payment_hrsdibayar_onblur(this, iSeqRow) })
                                        .bind('focus', function() { sc_form_payment_hrsdibayar_onfocus(this, iSeqRow) });
  $('#id_sc_field_terimadari' + iSeqRow).bind('blur', function() { sc_form_payment_terimadari_onblur(this, iSeqRow) })
                                        .bind('focus', function() { sc_form_payment_terimadari_onfocus(this, iSeqRow) });
  $('#id_sc_field_jenispayment' + iSeqRow).bind('blur', function() { sc_form_payment_jenispayment_onblur(this, iSeqRow) })
                                          .bind('change', function() { sc_form_payment_jenispayment_onchange(this, iSeqRow) })
                                          .bind('focus', function() { sc_form_payment_jenispayment_onfocus(this, iSeqRow) });
  $('#id_sc_field_instansipenjamin' + iSeqRow).bind('blur', function() { sc_form_payment_instansipenjamin_onblur(this, iSeqRow) })
                                              .bind('focus', function() { sc_form_payment_instansipenjamin_onfocus(this, iSeqRow) });
  $('#id_sc_field_bankdebit' + iSeqRow).bind('blur', function() { sc_form_payment_bankdebit_onblur(this, iSeqRow) })
                                       .bind('focus', function() { sc_form_payment_bankdebit_onfocus(this, iSeqRow) });
  $('#id_sc_field_nokartu' + iSeqRow).bind('blur', function() { sc_form_payment_nokartu_onblur(this, iSeqRow) })
                                     .bind('focus', function() { sc_form_payment_nokartu_onfocus(this, iSeqRow) });
  ...
  $('#id_sc_field_nopayment' + iSeqRow).bind('blur', function() { sc_form_payment_nopayment_onblur(this, iSeqRow) })
                                       .bind('focus', function() { sc_form_payment_nopayment_onfocus(this, iSeqRow) });
  $('#id_sc_field_kasir' + iSeqRow).bind('blur', function() { sc_form_payment_kasir_onblur(this, iSeqRow) })
                                   .bind('focus', function() { sc_form_payment_kasir_onfocus(this, iSeqRow) });
  $('#id_sc_field_sc_field_1' + iSeqRow).bind('blur', function() { sc_form_payment_sc_field_1_onblur(this, iSeqRow) })
                                        .bind('focus', function() { sc_form_payment_sc_field_1_onfocus(this, iSeqRow) });
  $('#id_sc_field_poli' + iSeqRow).bind('blur', function() { sc_form_payment_poli_onblur(this, iSeqRow) })
                                  .bind('focus', function() { sc_form_payment_poli_onfocus(this, iSeqRow) });
  $('#id_sc_field_detailadm' + iSeqRow).bind('blur', function() { sc_form_payment_detailadm_onblur(this, iSeqRow) })
                                       .bind('focus', function() { sc_form_payment_detailadm_onfocus(this, iSeqRow) });
  $('#id_sc_field_detailresep' + iSeqRow).bind('blur', function() { sc_form_payment_detailresep_onblur(this, iSeqRow) })
                                         .bind('focus', function() { sc_form_payment_detailresep_onfocus(this, iSeqRow) });
  $('#id_sc_field_detailtindakan' + iSeqRow).bind('blur', function() { sc_form_payment_detailtindakan_onblur(this, iSeqRow) })
                                            .bind('focus', function() { sc_form_payment_detailtindakan_onfocus(this, iSeqRow) });
  $('#id_sc_field_lab' + iSeqRow).bind('blur', function() { sc_form_payment_lab_onblur(this, iSeqRow) })
                                 .bind('focus', function() { sc_form_payment_lab_onfocus(this, iSeqRow) });
  $('#id_sc_field_radiologi' + iSeqRow).bind('blur', function() { sc_form_payment_radiologi_onblur(this, iSeqRow) })
                                       .bind('focus', function() { sc_form_payment_radiologi_onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_form_payment_id_onblur(oThis, iSeqRow) {
  do_ajax_form_payment_validate_id();
  scCssBlur(oThis);
}

function sc_form_payment_id_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_payment_nostruk_onblur(oThis, iSeqRow) {
  do_ajax_form_payment_validate_nostruk();
  scCssBlur(oThis);
}

function sc_form_payment_nostruk_onchange(oThis, iSeqRow) {
  do_ajax_form_payment_event_nostruk_onchange();
}

function sc_form_payment_nostruk_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_payment_custcode_onblur(oThis, iSeqRow) {
  do_ajax_form_payment_validate_custcode();
  scCssBlur(oThis);
}

function sc_form_payment_custcode_onchange(oThis, iSeqRow) {
  do_ajax_form_payment_refresh_custcode();
}

function sc_form_payment_custcode_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_payment_dokter_onblur(oThis, iSeqRow) {
  do_ajax_form_payment_validate_dokter();
  scCssBlur(oThis);
}

function sc_form_payment_dokter_onchange(oThis, iSeqRow) {
  do_ajax_form_payment_refresh_dokter();
}

function sc_form_payment_dokter_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_payment_jmltagihan_onblur(oThis, iSeqRow) {
  do_ajax_form_payment_validate_jmltagihan();
  scCssBlur(oThis);
}

function sc_form_payment_jmltagihan_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_payment_jmlbayar_onblur(oThis, iSeqRow) {
  do_ajax_form_payment_validate_jmlbayar();
  scCssBlur(oThis);
}

function sc_form_payment_jmlbayar_onchange(oThis, iSeqRow) {
  do_ajax_form_payment_event_jmlbayar_onchange();
}

function sc_form_payment_jmlbayar_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_payment_deposit_onblur(oThis, iSeqRow) {
  do_ajax_form_payment_validate_deposit();
  scCssBlur(oThis);
}

function sc_form_payment_deposit_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_payment_potongan_onblur(oThis, iSeqRow) {
  do_ajax_form_payment_validate_potongan();
  scCssBlur(oThis);
}

function sc_form_payment_potongan_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_payment_hrsdibayar_onblur(oThis, iSeqRow) {
  do_ajax_form_payment_validate_hrsdibayar();
  scCssBlur(oThis);
}

function sc_form_payment_hrsdibayar_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_payment_terimadari_onblur(oThis, iSeqRow) {
  do_ajax_form_payment_validate_terimadari();
  scCssBlur(oThis);
}

function sc_form_payment_terimadari_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_payment_jenispayment_onblur(oThis, iSeqRow) {
  do_ajax_form_payment_validate_jenispayment();
  scCssBlur(oThis);
}

function sc_form_payment_jenispayment_onchange(oThis, iSeqRow) {
  do_ajax_form_payment_event_jenispayment_onchange();
}

function sc_form_payment_jenispayment_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_payment_instansipenjamin_onblur(oThis, iSeqRow) {
  do_ajax_form_payment_validate_instansipenjamin();
  scCssBlur(oThis);
}

function sc_form_payment_instansipenjamin_onfocus(oThis, iSeqRow) {
  scCssFocus(oThis);
}

function sc_form_payment_bankdebit_onblur(oThis, iSeqRow) {
  do_ajax_form_payment_validate_bankdebit();
  scCssBlur(oThis);
}

function sc_form_payment_bankdebit_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_payment_nokartu_onblur(oThis, iSeqRow) {
  do_ajax_form_payment_validate_nokartu();
  scCssBlur(oThis);
}

function sc_form_payment_nokartu_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function sc_form_payment_nopayment_onblur(oThis, iSeqRow) {
  do_ajax_form_payment_validate_nopayment();
  scCssBlur(oThis);
}

function sc_form_payment_nopayment_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_payment_kasir_onblur(oThis, iSeqRow) {
  do_ajax_form_payment_validate_kasir();
  scCssBlur(oThis);
}

function sc_form_payment_kasir_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_payment_sc_field_1_onblur(oThis, iSeqRow) {
  do_ajax_form_payment_validate_sc_field_1();
  scCssBlur(oThis);
}

function sc_form_payment_sc_field_1_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_payment_poli_onblur(oThis, iSeqRow) {
  do_ajax_form_payment_validate_poli();
  scCssBlur(oThis);
}

function sc_form_payment_poli_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_payment_detailadm_onblur(oThis, iSeqRow) {
  do_ajax_form_payment_validate_detailadm();
  scCssBlur(oThis);
}

function sc_form_payment_detailadm_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_payment_detailresep_onblur(oThis, iSeqRow) {
  do_ajax_form_payment_validate_detailresep();
  scCssBlur(oThis);
}

function sc_form_payment_detailresep_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_payment_detailtindakan_onblur(oThis, iSeqRow) {
  do_ajax_form_payment_validate_detailtindakan();
  scCssBlur(oThis);
}

function sc_form_payment_detailtindakan_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_payment_lab_onblur(oThis, iSeqRow) {
  do_ajax_form_payment_validate_lab();
  scCssBlur(oThis);
}

function sc_form_payment_lab_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_payment_radiologi_onblur(oThis, iSeqRow) {
  do_ajax_form_payment_validate_radiologi();
  scCssBlur(oThis);
}

function sc_form_payment_radiologi_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function displayChange_field_dokter(row, status) {
	if ("on" == status) {
		if ("all" == row) {
			var fieldList = $(".css_dokter__obj");
			for (var i = 0; i < fieldList.length; i++) {
				$($(fieldList[i]).attr("id")).select2("destroy");
			}
		}
		else {
			$("#id_sc_field_dokter" + row).select2("destroy");
		}
		scJQSelect2Add(row, "dokter");
	}
}
...
function scRecreateSelect2() {
	displayChange_field_dokter("all", "on");
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_trandate" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_payment_validate_trandate(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_paiddate" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_payment_validate_paiddate(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
function scJQSelect2Add(seqRow, specificField) {
  if (null == specificField || "dokter" == specificField) {
    scJQSelect2Add_dokter(seqRow);
  }
...
function scJQSelect2Add_dokter(seqRow) {
  var elemSelector = "all" == seqRow ? ".css_dokter_obj" : "#id_sc_field_dokter" + seqRow;
  $(elemSelector).select2(
    {
      containerCssClass: 'css_dokter_obj',
      dropdownCssClass: 'css_dokter_obj',
      language: {
        noResults: function() {
...
function scJQElementsAdd(iLine) {
  ...
  setTimeout(function () { if ('function' == typeof displayChange_field_dokter) { displayChange_field_dokter(iLine, "on"); } }, 150);
