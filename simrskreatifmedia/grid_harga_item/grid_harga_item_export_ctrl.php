<?php
@session_start() ;
$_SESSION['scriptcase']['grid_harga_item']['sc_process_barr'] = true;
require_once('../grid_harga_item/index.php');
unset($_SESSION['scriptcase']['grid_harga_item']['sc_process_barr']);
$ExportCtrl = new grid_harga_item_export_control;
$ExportCtrl->Export_barr();

class grid_harga_item_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_title'] ?> tbobat :: Excel</TITLE>
