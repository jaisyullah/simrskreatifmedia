...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_harga_item"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_harga_item"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_harga_item']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_harga_item']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_harga_item']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_harga_item']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_harga_item']['sc_modal']);
           if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_harga_item']['opc_psq']))
           {
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_harga_item']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_harga_item']['embutida_filho'] as $ind => $sc_init)
          {
