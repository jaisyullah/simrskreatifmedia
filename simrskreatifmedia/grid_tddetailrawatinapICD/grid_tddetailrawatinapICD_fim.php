...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_tddetailrawatinapICD"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_tddetailrawatinapICD"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tddetailrawatinapICD']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_tddetailrawatinapICD']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tddetailrawatinapICD']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_tddetailrawatinapICD']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_tddetailrawatinapICD']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_tddetailrawatinapICD</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_tddetailrawatinapICD']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_tddetailrawatinapICD']['embutida_filho'] as $ind => $sc_init)
          {
