...
class grid_tddetailrawatinapICD_res_csv
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_csv()
   {
      ...
      $this->grava_arquivo();
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tddetailrawatinapICD']['csv_res_grid']))
      {
          return;
      }
   ...
   function inicializa_vars()
   {
      ...
      { 
          $this->Csv_password = $_POST['nmgp_password'];
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tddetailrawatinapICD']['csv_res_grid']) && !$this->Ini->sc_export_ajax) {
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tddetailrawatinapICD']['csv_res_grid']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tddetailrawatinapICD']['csv_res_file'] = $this->Csv_f;
      }
