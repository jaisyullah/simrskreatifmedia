<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tddetailrawatinapICD']['sc_process_barr'] = true;
require_once('../grid_tddetailrawatinapICD/index.php');
unset($_SESSION['scriptcase']['grid_tddetailrawatinapICD']['sc_process_barr']);
$ExportCtrl = new grid_tddetailrawatinapICD_export_control;
$ExportCtrl->Export_barr();

class grid_tddetailrawatinapICD_export_control
{
