...
class pendapatan_Lab_xls
{
   ...
   function monta_xls()
   {
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['embutida']) {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['opcao'] = "";
      }
   }
   ...
   function inicializa_vars()
   {
      ...
      { 
          ...
          { 
              ...
              $this->Res_xls = new pendapatan_Lab_res_xls();
              $this->prep_modulos("Res_xls");
          } 
          $this->Arquivo    = "sc_xls";
          $this->Arquivo   .= "_" . date("YmdHis") . "_" . rand(0, 1000);
          $this->Arq_zip    = $this->Arquivo . "_pendapatan_Lab.zip";
          $this->Arquivo   .= "_pendapatan_Lab" . $this->Xls_tp;
          $this->Tit_doc    = "pendapatan_Lab" . $this->Xls_tp;
          $this->Tit_zip    = "pendapatan_Lab.zip";
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['SC_Ind_Groupby'] == "_NM_SC_")
      {
          ...
          $this->Res = new pendapatan_Lab_resumo("out");
      ...
      $this->GB_tot_php = array('_NM_SC_','sc_free_group_by');
      if (in_array($_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['SC_Ind_Groupby'], $this->GB_tot_php))
      {
          $Tot_Gb = "totaliza_php_" . $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['SC_Ind_Groupby'];
          $this->$Tot_Gb();
      }
      else
      {
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['embutida'] && !$this->Ini->sc_export_ajax) {
          ...
          $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['xls_return']);
          if ($this->Tem_xls_res) {
   ...
   function grava_arquivo()
   {
      ...
      $nm_raiz_img  = ""; 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['xls_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['xls_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['xls_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['xls_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['xls_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['xls_name']);
          $this->Xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
          $this->Zip_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arq_zip;
      }
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['field_order'] as $Cada_cmp)
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['embutida_label']) && $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['embutida_label'])
      { 
          $this->count_span = 0;
          $this->Xls_row++;
          $this->proc_label();
      ...
      $nmgp_select_count .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['where_pesq'];
      ...
      { 
          ...
          { 
              ...
              $nmgp_select_count .= " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['where_resumo']; 
          } 
          else
          { 
              $nmgp_select .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['where_resumo'] . ")"; 
              $nmgp_select_count .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['where_resumo'] . ")"; 
          } 
      } 
      $nmgp_select .= " group by a.trancode, 	a.labcode"; 
      $nmgp_select_count .= " group by a.trancode, 	a.labcode"; 
      $nmgp_order_by = $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['order_grid'];
      ...
      while (!$rs->EOF)
      {
         ...
         $this->Xls_col = 0;
         $this->Xls_row++;
         $this->tgltransaksi = $rs->fields[0] ;  
         $this->pemeriksaan = $rs->fields[1] ;  
         $this->kategori = $rs->fields[2] ;  
         $this->harga = $rs->fields[3] ;  
         $this->harga =  str_replace(",", ".", $this->harga);
         $this->harga = (string)$this->harga;
         $this->pasien = $rs->fields[4] ;  
         $this->poli = $rs->fields[5] ;  
         $this->nostruk = $rs->fields[6] ;  
         $this->kode = $rs->fields[7] ;  
         $this->klsranap = $rs->fields[8] ;  
         $this->diskon = $rs->fields[9] ;  
...
$_SESSION['scriptcase']['pendapatan_Lab']['contr_erro'] = 'off'; 
         ...
         if (isset($this->NM_Row_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['embutida'])
         { 
      ...
      $this->xls_set_style();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['embutida'] && $prim_reg)
      { 
          $this->proc_label();
          $this->xls_sub_cons_copy_label($this->Xls_row);
      ...
      if (isset($this->NM_Col_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['embutida'])
      { 
      ...
      { 
          if ($this->Tem_xls_res)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['xls_res_grid'] = true;
              if (!$this->Ini->sc_export_ajax) {
              ...
              if ($this->Use_phpspreadsheet) {
                  $Xls_res = \PhpOffice\PhpSpreadsheet\IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['xls_res_sheet']);
              }
              else {
                  $Xls_res = PHPExcel_IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['xls_res_sheet']);
              }
              foreach($Xls_res->getAllSheets() as $sheet)
              {
                  $this->Xls_dados->addExternalSheet($sheet);
              }
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['xls_res_grid']);
              unlink($_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['xls_res_sheet']);
          } 
          if (!$this->Ini->sc_export_ajax) {
   ...
   { 
      ...
      { 
          ...
          if ($Cada_col == "tgltransaksi" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              $this->count_span++;
          ...
          if ($Cada_col == "klsranap" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              $this->count_span++;
              $current_cell_ref = $this->calc_cell($this->Xls_col);
              if (!NM_is_utf8($SC_Label))
   ...
   //----- tgltransaksi
   function NM_export_tgltransaksi()
   {
         $current_cell_ref = $this->calc_cell($this->Xls_col);
      ...
      {
             if (substr($this->tgltransaksi, 10, 1) == "-") 
             { 
                 $this->tgltransaksi = substr($this->tgltransaksi, 0, 10) . " " . substr($this->tgltransaksi, 11);
             } 
             if (substr($this->tgltransaksi, 13, 1) == ".") 
             { 
                $this->tgltransaksi = substr($this->tgltransaksi, 0, 13) . ":" . substr($this->tgltransaksi, 14, 2) . ":" . substr($this->tgltransaksi, 17);
             } 
             $conteudo_x =  $this->tgltransaksi;
             nm_conv_limpa_dado($conteudo_x, "YYYY-MM-DD HH:II:SS");
             if (is_numeric($conteudo_x) && strlen($conteudo_x) > 0) 
             { 
                 $this->nm_data->SetaData($this->tgltransaksi, "YYYY-MM-DD HH:II:SS  ");
                 $this->tgltransaksi = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DH", "ddmmaaaa;hhiiss"));
             } 
      }
         if (!NM_is_utf8($this->tgltransaksi))
         {
             $this->tgltransaksi = sc_convert_encoding($this->tgltransaksi, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->tgltransaksi, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->tgltransaksi, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- pemeriksaan
   function NM_export_pemeriksaan()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->pemeriksaan, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->pemeriksaan, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- kategori
   ...
   function NM_export_harga()
   {
         ...
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->harga);
         $this->Xls_col++;
   }
   //----- pasien
   ...
   function NM_export_klsranap()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
         $this->klsranap = html_entity_decode($this->klsranap, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->klsranap = strip_tags($this->klsranap);
         if (!NM_is_utf8($this->klsranap))
         {
             $this->klsranap = sc_convert_encoding($this->klsranap, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->klsranap, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->klsranap, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- diskon
   ...
   //----- tgltransaksi
   function NM_sub_cons_tgltransaksi()
   {
      if (!empty($this->tgltransaksi))
      {
         if (substr($this->tgltransaksi, 10, 1) == "-") 
         ...
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->tgltransaksi;
   ...
   //----- pemeriksaan
   function NM_sub_cons_pemeriksaan()
   {
         $this->pemeriksaan = html_entity_decode($this->pemeriksaan, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->pemeriksaan = strip_tags($this->pemeriksaan);
         if (!NM_is_utf8($this->pemeriksaan))
         ...
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->pemeriksaan;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- harga
   function NM_sub_cons_harga()
   {
         if (!NM_is_utf8($this->harga))
         {
             $this->harga = sc_convert_encoding($this->harga, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->harga;
   ...
   function NM_sub_cons_klsranap()
   {
         ...
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->klsranap;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['nolabel']) || $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['nolabel'])
       {
 ...
 function quebra_pemeriksaan_sc_free_group_by($Cmp_qb, $Where_qb, $Cmp_Name) 
 {
   ...
   function quebra_pemeriksaan_sc_free_group_by_top()
   {
       if ($this->groupby_show != "S") {
           return;
       }
       ...
       $temp_cmp = "";
       $cont_col = 0;
       foreach ($this->campos_quebra_pemeriksaan as $cada_campo) {
           if ($cont_col == $lim_col) {
   ...
   function quebra_pemeriksaan_sc_free_group_by_bot()
   {
       if ($this->groupby_show != "S") {
           return;
       }
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['field_order'] as $Cada_cmp)
       {
           if (!isset($this->NM_cmp_hidden[$Cada_cmp]) || $this->NM_cmp_hidden[$Cada_cmp] != "off")
           {
               ...
               elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['embutida']) {
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = "";
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
...
$_SESSION['scriptcase']['pendapatan_Lab']['contr_erro'] = 'off';
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['xls_file'] = $this->Xls_f;
      }
      $path_doc_md5 = md5($this->Ini->path_imag_temp . "/" . $this->Arquivo);
      $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab'][$path_doc_md5][0] = $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab'][$path_doc_md5][1] = $this->Tit_doc;
...
<HEAD>
 <TITLE>Rekapitulasi Pendapatan Lab :: Excel</TITLE>
...
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['xls_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php
