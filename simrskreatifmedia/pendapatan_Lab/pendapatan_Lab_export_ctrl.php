<?php
@session_start() ;
$_SESSION['scriptcase']['pendapatan_Lab']['sc_process_barr'] = true;
require_once('../pendapatan_Lab/index.php');
unset($_SESSION['scriptcase']['pendapatan_Lab']['sc_process_barr']);
$ExportCtrl = new pendapatan_Lab_export_control;
$ExportCtrl->Export_barr();

class pendapatan_Lab_export_control
{
