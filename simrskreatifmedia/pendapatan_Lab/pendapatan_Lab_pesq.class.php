...
class pendapatan_Lab_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['path_libs_php'] = $this->Ini->path_lib_php;
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['prim_vez']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['prim_vez'] = "S";
      }
   ...
   function init()
   {
    ...
    {
      global $tgltransaksi_cond, $tgltransaksi, $tgltransaksi_dia, $tgltransaksi_mes, $tgltransaksi_ano, $tgltransaksi_input_2_dia, $tgltransaksi_input_2_mes, $tgltransaksi_input_2_ano,
             $pemeriksaan_cond, $pemeriksaan,
             $kategori_cond, $kategori,
             $poli_cond, $poli,
             $klsranap_cond, $klsranap;
      $_SESSION['scriptcase']['pendapatan_Lab']['contr_erro'] = 'on';
 $tgltransaksi  = date('Y-m-d');
$tgltransaksi_2  = date('Y-m-d');
$_SESSION['scriptcase']['pendapatan_Lab']['contr_erro'] = 'off'; 
      if (isset($tgltransaksi_day))
      {
          $tgltransaksi_dia = $tgltransaksi_day; 
      }
      if (isset($tgltransaksi_month))
      {
          $tgltransaksi_mes = $tgltransaksi_month; 
      }
      if (isset($tgltransaksi_year))
      {
          $tgltransaksi_ano = $tgltransaksi_year; 
      }
      if (isset($tgltransaksi))
      {
          $tgltransaksi = str_replace("0000", "", $tgltransaksi);
          $tgltransaksi = str_replace("-00", "-", $tgltransaksi);
          $tgltransaksiXX = explode("-", $tgltransaksi);
          if (isset($tgltransaksiXX[2]))
          {
              $tgltransaksi_dia = $tgltransaksiXX[2]; 
          }
          if (isset($tgltransaksiXX[1]))
          {
              $tgltransaksi_mes = $tgltransaksiXX[1]; 
          }
          if (isset($tgltransaksiXX[0]))
          {
              $tgltransaksi_ano = $tgltransaksiXX[0]; 
          }
      }
      if (isset($tgltransaksi_input_2_day))
      {
          $tgltransaksi_input_2_dia = $tgltransaksi_input_2_day; 
      }
      if (isset($tgltransaksi_input_2_month))
      {
          $tgltransaksi_input_2_mes = $tgltransaksi_input_2_month; 
      }
      if (isset($tgltransaksi_input_2_year))
      {
          $tgltransaksi_input_2_ano = $tgltransaksi_input_2_year; 
      }
      if (isset($tgltransaksi_2))
      {
          $tgltransaksi_2 = str_replace("0000", "", $tgltransaksi_2);
          $tgltransaksi_2 = str_replace("-00", "-", $tgltransaksi_2);
          $tgltransaksiXX = explode("-", $tgltransaksi_2);
          if (isset($tgltransaksiXX[2]))
          {
              $tgltransaksi_input_2_dia = $tgltransaksiXX[2]; 
          }
          if (isset($tgltransaksiXX[1]))
          {
              $tgltransaksi_input_2_mes = $tgltransaksiXX[1]; 
          }
          if (isset($tgltransaksiXX[0]))
          {
              $tgltransaksi_input_2_ano = $tgltransaksiXX[0]; 
          }
      }
    }
   }
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . pendapatan_Lab_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . pendapatan_Lab_pack_protect_string($Tipo_filter[0]) . "\">.." . pendapatan_Lab_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
   ...
   $NM_retorno = "./";
    if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['proc_res'])) 
    {
...
<?php
    if ($_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['prim_vez'] == "N" && !$_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['proc_res']) 
    {
?>
if (parent.document.getElementById('nmsc_iframe_pendapatan_Lab').contentWindow.nm_gp_submit_ajax)
{
   parent.document.getElementById('nmsc_iframe_pendapatan_Lab').contentWindow.nm_gp_submit_ajax('inicio', 'save_grid');
}
else
{
   parent.document.getElementById('nmsc_iframe_pendapatan_Lab').src = 'index.php?nmgp_opcao=pesq&script_case_init=<?php echo NM_encode_input($this->Ini->sc_page) ?>&script_case_session=<?php echo session_id() ?>';
}
<?php
    }
    else
...
<?php
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['prim_vez'] = "N";
?>
</SCRIPT>
</BODY>
</HTML>
...
<HEAD>
 <TITLE>Rekapitulasi Pendapatan Lab</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>pendapatan_Lab/pendapatan_Lab_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="pendapatan_Lab_ajax_search.js"></script>
 <script type="text/javascript" src="pendapatan_Lab_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="pendapatan_Lab_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['pendapatan_Lab']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['pendapatan_Lab']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
function scJQCalendarAdd() {
  $("#sc_tgltransaksi_jq").datepicker({
    beforeShow: function(input, inst) {
          var_dt_ini  = document.getElementById('SC_tgltransaksi_dia').value + '/';
          var_dt_ini += document.getElementById('SC_tgltransaksi_mes').value + '/';
          var_dt_ini += document.getElementById('SC_tgltransaksi_ano').value;
          document.getElementById('sc_tgltransaksi_jq').value = var_dt_ini;
    },
    onClose: function(dateText, inst) {
          aParts  = dateText.split("/");
          document.getElementById('SC_tgltransaksi_dia').value = aParts[0];
          document.getElementById('SC_tgltransaksi_mes').value = aParts[1];
          document.getElementById('SC_tgltransaksi_ano').value = aParts[2];
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
  ...
  $("#sc_tgltransaksi_jq2").datepicker({
    beforeShow: function(input, inst) {
          var_dt_ini  = document.getElementById('SC_tgltransaksi_input_2_dia').value + '/';
          var_dt_ini += document.getElementById('SC_tgltransaksi_input_2_mes').value + '/';
          var_dt_ini += document.getElementById('SC_tgltransaksi_input_2_ano').value;
          document.getElementById('sc_tgltransaksi_jq2').value = var_dt_ini;
    },
    onClose: function(dateText, inst) {
          aParts  = dateText.split("/");
          document.getElementById('SC_tgltransaksi_input_2_dia').value = aParts[0];
          document.getElementById('SC_tgltransaksi_input_2_mes').value = aParts[1];
          document.getElementById('SC_tgltransaksi_input_2_ano').value = aParts[2];
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_tgltransaksi_cond#NMF#' + search_get_sel_txt('SC_tgltransaksi_cond') + '@NMF@';
  str_out += 'SC_tgltransaksi_dia#NMF#' + search_get_sel_txt('SC_tgltransaksi_dia') + '@NMF@';
  str_out += 'SC_tgltransaksi_mes#NMF#' + search_get_sel_txt('SC_tgltransaksi_mes') + '@NMF@';
  str_out += 'SC_tgltransaksi_ano#NMF#' + search_get_sel_txt('SC_tgltransaksi_ano') + '@NMF@';
  str_out += 'SC_tgltransaksi_input_2_dia#NMF#' + search_get_sel_txt('SC_tgltransaksi_input_2_dia') + '@NMF@';
  str_out += 'SC_tgltransaksi_input_2_mes#NMF#' + search_get_sel_txt('SC_tgltransaksi_input_2_mes') + '@NMF@';
  str_out += 'SC_tgltransaksi_input_2_ano#NMF#' + search_get_sel_txt('SC_tgltransaksi_input_2_ano') + '@NMF@';
  ...
  str_out += 'SC_poli#NMF#' + search_get_selmult('SC_poli') + '@NMF@';
  str_out += 'SC_klsranap_cond#NMF#' + search_get_sel_txt('SC_klsranap_cond') + '@NMF@';
  str_out += 'SC_klsranap#NMF#' + search_get_selmult('SC_klsranap') + '@NMF@';
...
<?php
   ...
   {
      global 
             $tgltransaksi_cond, $tgltransaksi, $tgltransaksi_dia, $tgltransaksi_mes, $tgltransaksi_ano, $tgltransaksi_input_2_dia, $tgltransaksi_input_2_mes, $tgltransaksi_input_2_ano,
             $pemeriksaan_cond, $pemeriksaan,
             $kategori_cond, $kategori,
             $poli_cond, $poli,
             $klsranap_cond, $klsranap,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $tgltransaksi_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['campos_busca']['tgltransaksi_dia']; 
          $tgltransaksi_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['campos_busca']['tgltransaksi_mes']; 
          $tgltransaksi_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['campos_busca']['tgltransaksi_ano']; 
          $tgltransaksi_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['campos_busca']['tgltransaksi_input_2_dia']; 
          $tgltransaksi_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['campos_busca']['tgltransaksi_input_2_mes']; 
          $tgltransaksi_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['campos_busca']['tgltransaksi_input_2_ano']; 
          $tgltransaksi_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['campos_busca']['tgltransaksi_cond']; 
          $pemeriksaan = $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['campos_busca']['pemeriksaan']; 
          $pemeriksaan_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['campos_busca']['pemeriksaan_cond']; 
          $kategori = $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['campos_busca']['kategori']; 
          $kategori_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['campos_busca']['kategori_cond']; 
          $poli = $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['campos_busca']['poli']; 
          $poli_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['campos_busca']['poli_cond']; 
          $klsranap = $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['campos_busca']['klsranap']; 
          $klsranap_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['campos_busca']['klsranap_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['campos_busca']['NM_operador']; 
      } 
      if (!isset($tgltransaksi_cond) || empty($tgltransaksi_cond))
      {
         $tgltransaksi_cond = "bw";
      }
      $display_aberto  = "style=display:";
      $display_fechado = "style=display:none";
      $opc_hide_input = array("nu","nn","ep","ne");
      $str_hide_tgltransaksi = (in_array($tgltransaksi_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      $str_hide_klsranap = (in_array($klsranap_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      $str_display_tgltransaksi = ('bw' == $tgltransaksi_cond) ? $display_aberto : $display_fechado;
      ...
      $str_display_klsranap = ('bw' == $klsranap_cond) ? $display_aberto : $display_fechado;
      ...
      // klsranap
      if (is_array($klsranap) && !empty($klsranap))
      {
         $tmp_array = array();
         $klsranap_val_str = "";
         foreach ($klsranap as $tmp_val_cmp)
         {
            if ("" != $klsranap_val_str)
            {
               $klsranap_val_str .= ",";
      ...
      if (!isset($tgltransaksi) || $tgltransaksi == "")
      {
          $tgltransaksi = "";
      }
      if (isset($tgltransaksi) && !empty($tgltransaksi))
      {
    ...
    <TR>
     <TD colspan="3" height="20" class="scFilterBlockBack">
      <TABLE border="0" cellpadding="0" cellspacing="0" width="100%" height="100%">
       <TR>
        <TD class="scFilterBlockFont css_blk_0"><?php echo $Img_tit_blk_i ?>Tanggal Transaksi<?php echo $Img_tit_blk_f ?></TD>
      ...
      <TD id='SC_tgltransaksi_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['tgltransaksi'])) ? $this->New_label['tgltransaksi'] : "Tgl Transaksi"; ?></TD>
      
      <INPUT type="hidden" id="SC_tgltransaksi_cond" name="tgltransaksi_cond" value="bw">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_tgltransaksi" <?php echo $str_hide_tgltransaksi?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['tgltransaksi'])) ? $this->New_label['tgltransaksi'] : "Tgl Transaksi";
 $nmgp_tab_label .= "tgltransaksi?#?" . $SC_Label . "?@?";
...
<?php
  ...
  {
?>
<span id='id_date_part_tgltransaksi_DD' style='display: inline-block'>

         <SELECT class="scFilterObjectOdd" id="SC_tgltransaksi_dia" name="tgltransaksi_dia">
          <OPTION value=""></OPTION>
          <OPTION value="01" <?php if ("01" == $tgltransaksi_dia) { echo "selected"; } ?>>01</OPTION>
          <OPTION value="02" <?php if ("02" == $tgltransaksi_dia) { echo "selected"; } ?>>02</OPTION>
          <OPTION value="03" <?php if ("03" == $tgltransaksi_dia) { echo "selected"; } ?>>03</OPTION>
          <OPTION value="04" <?php if ("04" == $tgltransaksi_dia) { echo "selected"; } ?>>04</OPTION>
          <OPTION value="05" <?php if ("05" == $tgltransaksi_dia) { echo "selected"; } ?>>05</OPTION>
          <OPTION value="06" <?php if ("06" == $tgltransaksi_dia) { echo "selected"; } ?>>06</OPTION>
          <OPTION value="07" <?php if ("07" == $tgltransaksi_dia) { echo "selected"; } ?>>07</OPTION>
          <OPTION value="08" <?php if ("08" == $tgltransaksi_dia) { echo "selected"; } ?>>08</OPTION>
          <OPTION value="09" <?php if ("09" == $tgltransaksi_dia) { echo "selected"; } ?>>09</OPTION>
          <OPTION value="10" <?php if ("10" == $tgltransaksi_dia) { echo "selected"; } ?>>10</OPTION>
          <OPTION value="11" <?php if ("11" == $tgltransaksi_dia) { echo "selected"; } ?>>11</OPTION>
          <OPTION value="12" <?php if ("12" == $tgltransaksi_dia) { echo "selected"; } ?>>12</OPTION>
          <OPTION value="13" <?php if ("13" == $tgltransaksi_dia) { echo "selected"; } ?>>13</OPTION>
          <OPTION value="14" <?php if ("14" == $tgltransaksi_dia) { echo "selected"; } ?>>14</OPTION>
          <OPTION value="15" <?php if ("15" == $tgltransaksi_dia) { echo "selected"; } ?>>15</OPTION>
          <OPTION value="16" <?php if ("16" == $tgltransaksi_dia) { echo "selected"; } ?>>16</OPTION>
          <OPTION value="17" <?php if ("17" == $tgltransaksi_dia) { echo "selected"; } ?>>17</OPTION>
          <OPTION value="18" <?php if ("18" == $tgltransaksi_dia) { echo "selected"; } ?>>18</OPTION>
          <OPTION value="19" <?php if ("19" == $tgltransaksi_dia) { echo "selected"; } ?>>19</OPTION>
          <OPTION value="20" <?php if ("20" == $tgltransaksi_dia) { echo "selected"; } ?>>20</OPTION>
          <OPTION value="21" <?php if ("21" == $tgltransaksi_dia) { echo "selected"; } ?>>21</OPTION>
          <OPTION value="22" <?php if ("22" == $tgltransaksi_dia) { echo "selected"; } ?>>22</OPTION>
          <OPTION value="23" <?php if ("23" == $tgltransaksi_dia) { echo "selected"; } ?>>23</OPTION>
          <OPTION value="24" <?php if ("24" == $tgltransaksi_dia) { echo "selected"; } ?>>24</OPTION>
          <OPTION value="25" <?php if ("25" == $tgltransaksi_dia) { echo "selected"; } ?>>25</OPTION>
          <OPTION value="26" <?php if ("26" == $tgltransaksi_dia) { echo "selected"; } ?>>26</OPTION>
          <OPTION value="27" <?php if ("27" == $tgltransaksi_dia) { echo "selected"; } ?>>27</OPTION>
          <OPTION value="28" <?php if ("28" == $tgltransaksi_dia) { echo "selected"; } ?>>28</OPTION>
          <OPTION value="29" <?php if ("29" == $tgltransaksi_dia) { echo "selected"; } ?>>29</OPTION>
          <OPTION value="30" <?php if ("30" == $tgltransaksi_dia) { echo "selected"; } ?>>30</OPTION>
          <OPTION value="31" <?php if ("31" == $tgltransaksi_dia) { echo "selected"; } ?>>31</OPTION>
         </SELECT>
         </span>
...
<?php
  ...
  {
?>
<span id='id_date_part_tgltransaksi_MM' style='display: inline-block'>

         <SELECT class="scFilterObjectOdd" id="SC_tgltransaksi_mes" name="tgltransaksi_mes">
          <OPTION value=""></OPTION>
          <OPTION value="01" <?php if ("01" == $tgltransaksi_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][0] ?></OPTION>
          <OPTION value="02" <?php if ("02" == $tgltransaksi_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][1] ?></OPTION>
          <OPTION value="03" <?php if ("03" == $tgltransaksi_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][2] ?></OPTION>
          <OPTION value="04" <?php if ("04" == $tgltransaksi_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][3] ?></OPTION>
          <OPTION value="05" <?php if ("05" == $tgltransaksi_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][4] ?></OPTION>
          <OPTION value="06" <?php if ("06" == $tgltransaksi_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][5] ?></OPTION>
          <OPTION value="07" <?php if ("07" == $tgltransaksi_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][6] ?></OPTION>
          <OPTION value="08" <?php if ("08" == $tgltransaksi_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][7] ?></OPTION>
          <OPTION value="09" <?php if ("09" == $tgltransaksi_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][8] ?></OPTION>
          <OPTION value="10" <?php if ("10" == $tgltransaksi_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][9] ?></OPTION>
          <OPTION value="11" <?php if ("11" == $tgltransaksi_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][10] ?></OPTION>
          <OPTION value="12" <?php if ("12" == $tgltransaksi_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][11] ?></OPTION>
         </SELECT>
         </span>
...
<?php
  ...
  {
?>
<span id='id_date_part_tgltransaksi_AAAA' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_tgltransaksi_ano" name="tgltransaksi_ano" value="<?php echo NM_encode_input($tgltransaksi_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 <INPUT type="hidden" id="sc_tgltransaksi_jq">
</span>
...
?>
       ...
       <TR valign="top">
        <TD id="id_vis_tgltransaksi"  <?php echo $str_display_tgltransaksi; ?> class="scFilterFieldFontOdd">
...
<?php
  ...
  {
?>
<span id='id_date_part_tgltransaksi_input_2_DD' style='display: inline-block'>

         <SELECT class="scFilterObjectOdd" id="SC_tgltransaksi_input_2_dia" name="tgltransaksi_input_2_dia">
          <OPTION value=""></OPTION>
          <OPTION value="01" <?php if ("01" == $tgltransaksi_input_2_dia) { echo "selected"; } ?>>01</OPTION>
          <OPTION value="02" <?php if ("02" == $tgltransaksi_input_2_dia) { echo "selected"; } ?>>02</OPTION>
          <OPTION value="03" <?php if ("03" == $tgltransaksi_input_2_dia) { echo "selected"; } ?>>03</OPTION>
          <OPTION value="04" <?php if ("04" == $tgltransaksi_input_2_dia) { echo "selected"; } ?>>04</OPTION>
          <OPTION value="05" <?php if ("05" == $tgltransaksi_input_2_dia) { echo "selected"; } ?>>05</OPTION>
          <OPTION value="06" <?php if ("06" == $tgltransaksi_input_2_dia) { echo "selected"; } ?>>06</OPTION>
          <OPTION value="07" <?php if ("07" == $tgltransaksi_input_2_dia) { echo "selected"; } ?>>07</OPTION>
          <OPTION value="08" <?php if ("08" == $tgltransaksi_input_2_dia) { echo "selected"; } ?>>08</OPTION>
          <OPTION value="09" <?php if ("09" == $tgltransaksi_input_2_dia) { echo "selected"; } ?>>09</OPTION>
          <OPTION value="10" <?php if ("10" == $tgltransaksi_input_2_dia) { echo "selected"; } ?>>10</OPTION>
          <OPTION value="11" <?php if ("11" == $tgltransaksi_input_2_dia) { echo "selected"; } ?>>11</OPTION>
          <OPTION value="12" <?php if ("12" == $tgltransaksi_input_2_dia) { echo "selected"; } ?>>12</OPTION>
          <OPTION value="13" <?php if ("13" == $tgltransaksi_input_2_dia) { echo "selected"; } ?>>13</OPTION>
          <OPTION value="14" <?php if ("14" == $tgltransaksi_input_2_dia) { echo "selected"; } ?>>14</OPTION>
          <OPTION value="15" <?php if ("15" == $tgltransaksi_input_2_dia) { echo "selected"; } ?>>15</OPTION>
          <OPTION value="16" <?php if ("16" == $tgltransaksi_input_2_dia) { echo "selected"; } ?>>16</OPTION>
          <OPTION value="17" <?php if ("17" == $tgltransaksi_input_2_dia) { echo "selected"; } ?>>17</OPTION>
          <OPTION value="18" <?php if ("18" == $tgltransaksi_input_2_dia) { echo "selected"; } ?>>18</OPTION>
          <OPTION value="19" <?php if ("19" == $tgltransaksi_input_2_dia) { echo "selected"; } ?>>19</OPTION>
          <OPTION value="20" <?php if ("20" == $tgltransaksi_input_2_dia) { echo "selected"; } ?>>20</OPTION>
          <OPTION value="21" <?php if ("21" == $tgltransaksi_input_2_dia) { echo "selected"; } ?>>21</OPTION>
          <OPTION value="22" <?php if ("22" == $tgltransaksi_input_2_dia) { echo "selected"; } ?>>22</OPTION>
          <OPTION value="23" <?php if ("23" == $tgltransaksi_input_2_dia) { echo "selected"; } ?>>23</OPTION>
          <OPTION value="24" <?php if ("24" == $tgltransaksi_input_2_dia) { echo "selected"; } ?>>24</OPTION>
          <OPTION value="25" <?php if ("25" == $tgltransaksi_input_2_dia) { echo "selected"; } ?>>25</OPTION>
          <OPTION value="26" <?php if ("26" == $tgltransaksi_input_2_dia) { echo "selected"; } ?>>26</OPTION>
          <OPTION value="27" <?php if ("27" == $tgltransaksi_input_2_dia) { echo "selected"; } ?>>27</OPTION>
          <OPTION value="28" <?php if ("28" == $tgltransaksi_input_2_dia) { echo "selected"; } ?>>28</OPTION>
          <OPTION value="29" <?php if ("29" == $tgltransaksi_input_2_dia) { echo "selected"; } ?>>29</OPTION>
          <OPTION value="30" <?php if ("30" == $tgltransaksi_input_2_dia) { echo "selected"; } ?>>30</OPTION>
          <OPTION value="31" <?php if ("31" == $tgltransaksi_input_2_dia) { echo "selected"; } ?>>31</OPTION>
         </SELECT>
         </span>
...
<?php
  ...
  {
?>
<span id='id_date_part_tgltransaksi_input_2_MM' style='display: inline-block'>

         <SELECT class="scFilterObjectOdd" id="SC_tgltransaksi_input_2_mes" name="tgltransaksi_input_2_mes">
          <OPTION value=""></OPTION>
          <OPTION value="01" <?php if ("01" == $tgltransaksi_input_2_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][0] ?></OPTION>
          <OPTION value="02" <?php if ("02" == $tgltransaksi_input_2_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][1] ?></OPTION>
          <OPTION value="03" <?php if ("03" == $tgltransaksi_input_2_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][2] ?></OPTION>
          <OPTION value="04" <?php if ("04" == $tgltransaksi_input_2_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][3] ?></OPTION>
          <OPTION value="05" <?php if ("05" == $tgltransaksi_input_2_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][4] ?></OPTION>
          <OPTION value="06" <?php if ("06" == $tgltransaksi_input_2_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][5] ?></OPTION>
          <OPTION value="07" <?php if ("07" == $tgltransaksi_input_2_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][6] ?></OPTION>
          <OPTION value="08" <?php if ("08" == $tgltransaksi_input_2_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][7] ?></OPTION>
          <OPTION value="09" <?php if ("09" == $tgltransaksi_input_2_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][8] ?></OPTION>
          <OPTION value="10" <?php if ("10" == $tgltransaksi_input_2_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][9] ?></OPTION>
          <OPTION value="11" <?php if ("11" == $tgltransaksi_input_2_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][10] ?></OPTION>
          <OPTION value="12" <?php if ("12" == $tgltransaksi_input_2_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][11] ?></OPTION>
         </SELECT>
         </span>
...
<?php
  ...
  {
?>
<span id='id_date_part_tgltransaksi_input_2_AAAA' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_tgltransaksi_input_2_ano" name="tgltransaksi_input_2_ano" value="<?php echo NM_encode_input($tgltransaksi_input_2_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 <INPUT type="hidden" id="sc_tgltransaksi_jq2">
</span>
...
?>
    ...
    <TR>
     <TD colspan="3" height="20" class="scFilterBlockBack">
      <TABLE border="0" cellpadding="0" cellspacing="0" width="100%" height="100%">
       <TR>
        <TD class="scFilterBlockFont css_blk_1"><?php echo $Img_tit_blk_i ?>Pemeriksaan<?php echo $Img_tit_blk_f ?></TD>
      ...
      <TD id='SC_pemeriksaan_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['pemeriksaan'])) ? $this->New_label['pemeriksaan'] : "Pemeriksaan"; ?></TD>
      
      <INPUT type="hidden" id="SC_pemeriksaan_cond" name="pemeriksaan_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_pemeriksaan" <?php echo $str_hide_pemeriksaan?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
...
<?php
      ...
      $nmgp_def_dados = "" ; 
      $nm_comando = "SELECT nama, nama  FROM tblab GROUP BY labcode ORDER BY nama"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['psq_check_ret']['pemeriksaan'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['psq_check_ret']['pemeriksaan'][] = trim($rs->fields[0]);
...
?>
   <span id="idAjaxSelect_pemeriksaan">
      <SELECT class="scFilterObjectOdd" id="SC_pemeriksaan" name="pemeriksaan[]"  size="1" multiple>
       <OPTION value=""></OPTION>
<?php
...
<?php
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['psq_check_ret']['kategori'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['psq_check_ret']['kategori'][] = trim($rs->fields[0]);
            $nmgp_def_dados .= trim($rs->fields[1]) . "?#?" ; 
            $nmgp_def_dados .= trim($rs->fields[0]) . "?#?N?@?" ; 
            $rs->MoveNext() ; 
         } 
...
<?php
      ...
      foreach ($nm_opcoes as $nm_opcao)
      {
         if (!empty($nm_opcao))
         {
            ...
            $nm_opc_val = $nm_sc_valor;
?>
       <OPTION value="<?php echo NM_encode_input($nm_opc_cod . $delimitador . $nm_opc_val); ?>" <?php echo $kategori_sel; ?>><?php echo $nm_opc_val; ?></OPTION>
<?php
         }
      }
?>
...
?>
    ...
    <TR>
     <TD colspan="3" height="20" class="scFilterBlockBack">
      <TABLE border="0" cellpadding="0" cellspacing="0" width="100%" height="100%">
       <TR>
        <TD class="scFilterBlockFont css_blk_2"><?php echo $Img_tit_blk_i ?>Poli dan Kelas<?php echo $Img_tit_blk_f ?></TD>
...
<?php
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['psq_check_ret']['poli'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['psq_check_ret']['poli'][] = trim($rs->fields[0]);
            $nmgp_def_dados .= trim($rs->fields[1]) . "?#?" ; 
            $nmgp_def_dados .= trim($rs->fields[0]) . "?#?N?@?" ; 
            $rs->MoveNext() ; 
         } 
...
?>
   <span id="idAjaxSelect_poli">
      <SELECT class="scFilterObjectOdd" id="SC_poli" name="poli[]"  size="1" multiple>
       <OPTION value=""></OPTION>
<?php
      $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
      $nm_opcoes  = explode("?@?", $nm_opcoesx);
...
?>
      ...
      <TD id='SC_klsranap_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['klsranap'])) ? $this->New_label['klsranap'] : "Kelas Rawat"; ?></TD>
      
      <INPUT type="hidden" id="SC_klsranap_cond" name="klsranap_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_klsranap" <?php echo $str_hide_klsranap?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['klsranap'])) ? $this->New_label['klsranap'] : "Kelas Rawat";
 $nmgp_tab_label .= "klsranap?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      $klsranap_look = substr($this->Db->qstr($klsranap), 1, -1); 
      $nmgp_def_dados = "" ; 
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['psq_check_ret']['klsranap'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['psq_check_ret']['klsranap'][] = trim($rs->fields[0]);
            $nmgp_def_dados .= trim($rs->fields[1]) . "?#?" ; 
            $nmgp_def_dados .= trim($rs->fields[0]) . "?#?N?@?" ; 
            $rs->MoveNext() ; 
         } 
...
?>
   <span id="idAjaxSelect_klsranap">
      <SELECT class="scFilterObjectEven" id="SC_klsranap" name="klsranap[]"  size="1" multiple>
       <OPTION value=""></OPTION>
<?php
      $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
      $nm_opcoes  = explode("?@?", $nm_opcoesx);
      foreach ($nm_opcoes as $nm_opcao)
      {
         if (!empty($nm_opcao))
         {
            ...
            {
               $klsranap_sel = "";
               foreach ($klsranap as $Dados)
               {
                   if ($Dados === $nm_opc_cod)
                   {
                       $klsranap_sel = "selected";
                       break;
                   }
               }
            }
            ...
            {
               $klsranap_sel = ("S" == $nm_opc_sel) ? "selected" : "";
            }
            $nm_sc_valor = $nm_opc_val;
            $nm_opc_val = $nm_sc_valor;
?>
       <OPTION value="<?php echo NM_encode_input($nm_opc_cod . $delimitador . $nm_opc_val); ?>" <?php echo $klsranap_sel; ?>><?php echo $nm_opc_val; ?></OPTION>
<?php
         }
      }
?>
...
?>
<?php
   if (is_file("pendapatan_Lab_help.txt"))
   {
...
?>
<?php
   if ($nm_apl_dependente == 1 || (!$_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['opc_psq'] && !$this->aba_iframe))
   {
...
<?php
       ...
       elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['dashboard_info']['under_dashboard'])
       { }
       else 
       { 
?>
...
<?php
   ...
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['opc_psq'])
   {
...
<?php
    if ($_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['prim_vez'] == "N") 
    {
?>
       <iframe id="nmsc_iframe_pendapatan_Lab" frameborder="0" marginwidth="0px" marginheight="0px" topmargin="0px" leftmargin="0px" align="center" height="1500px" name="nm_iframe_pendapatan_Lab" scrolling="auto" src="index.php?nmgp_opcao=pesq&script_case_init=<?php echo NM_encode_input($this->Ini->sc_page) ?>&script_case_session=<?php echo session_id() ?>" width="100%"></iframe>
<?php
    }
    else
    {
?>
       <iframe id="nmsc_iframe_pendapatan_Lab" frameborder="0" marginwidth="0px" marginheight="0px" topmargin="0px" leftmargin="0px" align="center" height="1500px" name="nm_iframe_pendapatan_Lab" scrolling="auto" src="" width="100%"></iframe>
<?php
    }
?>
<iframe id="nmsc_iframe_pendapatan_Lab_pesq"  name="nm_iframe_pendapatan_Lab_pesq" style= "display: none;" frameborder="0" marginwidth="0px" marginheight="0px" topmargin="0px" leftmargin="0px" src=""></iframe>
</td></tr></table></td></tr>
</TABLE>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['orig_pesq'] == "grid")
   {
...
?>
 ...
 {
    document.F1.target = "nm_iframe_pendapatan_Lab_pesq";
    document.F1.submit();
 }
 function nm_move()
 {
     document.getElementById('nmsc_iframe_pendapatan_Lab').contentWindow.nm_move('igual');
 }
 function limpa_form()
 {
   document.F1.reset();
   ...
   document.F1.tgltransaksi_cond.value = 'bw';
   nm_campos_between(document.getElementById('id_vis_tgltransaksi'), document.F1.tgltransaksi_cond, 'tgltransaksi');
   document.F1.tgltransaksi_dia.value = "";
   document.F1.tgltransaksi_mes.value = "";
   document.F1.tgltransaksi_ano.value = "";
   document.F1.tgltransaksi_input_2_dia.value = "";
   document.F1.tgltransaksi_input_2_mes.value = "";
   document.F1.tgltransaksi_input_2_ano.value = "";
   ...
   for (i = 0; i < document.F1.elements.length; i++)
   {
      if (document.F1.elements[i].name == 'poli[]')
      {
          while (document.F1.elements[i].selectedIndex != -1)
          {
              aa = document.F1.elements[i].selectedIndex;
   ...
   nm_campos_between(document.getElementById('id_vis_klsranap'), document.F1.klsranap_cond, 'klsranap');
   for (i = 0; i < document.F1.elements.length; i++)
   {
      if (document.F1.elements[i].name == 'klsranap[]')
      {
          while (document.F1.elements[i].selectedIndex != -1)
          {
              aa = document.F1.elements[i].selectedIndex;
 ...
 function Sc_carga_select2(Field)
 {
    ...
    if (Field == 'all' || Field == 'poli') {
       Sc_carga_select2_poli();
    }
    if (Field == 'all' || Field == 'klsranap') {
       Sc_carga_select2_klsranap();
    }
 }
 ...
 function Sc_carga_select2_poli()
 {
  $("#SC_poli").select2(
    {
      language: {
 ...
 function Sc_carga_select2_klsranap()
 {
  $("#SC_klsranap").select2(
    {
      language: {
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "simrskreatifmedia/pendapatan_Lab";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_tgltransaksi_cond'] = 'cond';
      $tp_fields['SC_tgltransaksi_dia'] = 'text';
      $tp_fields['SC_tgltransaksi_mes'] = 'text';
      $tp_fields['SC_tgltransaksi_ano'] = 'text';
      $tp_fields['SC_tgltransaksi_input_2_dia'] = 'text';
      $tp_fields['SC_tgltransaksi_input_2_mes'] = 'text';
      $tp_fields['SC_tgltransaksi_input_2_ano'] = 'text';
      ...
      $tp_fields['SC_poli'] = 'selmult';
      $tp_fields['SC_klsranap_cond'] = 'cond';
      $tp_fields['SC_klsranap'] = 'selmult';
   ...
   function trata_campos()
   {
      global $tgltransaksi_cond, $tgltransaksi, $tgltransaksi_dia, $tgltransaksi_mes, $tgltransaksi_ano, $tgltransaksi_input_2_dia, $tgltransaksi_input_2_mes, $tgltransaksi_input_2_ano,
             ...
             $kategori_cond, $kategori,
             $poli_cond, $poli,
             $klsranap_cond, $klsranap, $nmgp_tab_label;

      $C_formatado = true;
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_conv_dados.php", "F", "nm_conv_limpa_dado") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
      $tgltransaksi_cond_salva = $tgltransaksi_cond; 
      if (!isset($tgltransaksi_input_2_dia) || $tgltransaksi_input_2_dia == "")
      {
          $tgltransaksi_input_2_dia = $tgltransaksi_dia;
      }
      if (!isset($tgltransaksi_input_2_mes) || $tgltransaksi_input_2_mes == "")
      {
          $tgltransaksi_input_2_mes = $tgltransaksi_mes;
      }
      if (!isset($tgltransaksi_input_2_ano) || $tgltransaksi_input_2_ano == "")
      {
          $tgltransaksi_input_2_ano = $tgltransaksi_ano;
      }
      ...
      $klsranap_cond_salva = $klsranap_cond; 
      if (!isset($klsranap_input_2) || $klsranap_input_2 == "")
      {
          $klsranap_input_2 = $klsranap;
      }
      if (is_array($pemeriksaan)) {
          foreach ($pemeriksaan as $I => $Val) {
              ...
              if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && trim($L_lookup) != '' && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['psq_check_ret']['pemeriksaan'])) {
      ...
      if (is_array($kategori)) {
          foreach ($kategori as $I => $Val) {
              ...
              if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && trim($L_lookup) != '' && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['psq_check_ret']['kategori'])) {
      ...
      if (is_array($poli)) {
          foreach ($poli as $I => $Val) {
              ...
              if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && trim($L_lookup) != '' && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['psq_check_ret']['poli'])) {
                  if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "Poli : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
                  break;
              }
          }
      }
      if (is_array($klsranap)) {
          foreach ($klsranap as $I => $Val) {
              $tmp_pos = strpos($Val, "##@@");
              if ($tmp_pos === false) {
                  $L_lookup = $Val;
              }
              ...
              if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && trim($L_lookup) != '' && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['psq_check_ret']['klsranap'])) {
                  if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "Kelas Rawat : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
                  break;
              }
          }
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['campos_busca']['tgltransaksi_dia'] = $tgltransaksi_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['campos_busca']['tgltransaksi_mes'] = $tgltransaksi_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['campos_busca']['tgltransaksi_ano'] = $tgltransaksi_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['campos_busca']['tgltransaksi_input_2_dia'] = $tgltransaksi_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['campos_busca']['tgltransaksi_input_2_mes'] = $tgltransaksi_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['campos_busca']['tgltransaksi_input_2_ano'] = $tgltransaksi_input_2_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['campos_busca']['tgltransaksi_cond'] = $tgltransaksi_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['campos_busca']['pemeriksaan'] = $pemeriksaan; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['campos_busca']['pemeriksaan_cond'] = $pemeriksaan_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['campos_busca']['kategori'] = $kategori; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['campos_busca']['kategori_cond'] = $kategori_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['campos_busca']['poli'] = $poli; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['campos_busca']['poli_cond'] = $poli_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['campos_busca']['klsranap'] = $klsranap; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['campos_busca']['klsranap_cond'] = $klsranap_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      }
      $this->cmp_formatado['pemeriksaan'] = $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['campos_busca']['pemeriksaan'];
      $this->cmp_formatado['pemeriksaan_input_2'] = $pemeriksaan_input_2;
      $this->cmp_formatado['kategori'] = $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['campos_busca']['kategori'];
      $this->cmp_formatado['kategori_input_2'] = $kategori_input_2;
      $this->cmp_formatado['poli'] = $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['campos_busca']['poli'];
      $this->cmp_formatado['poli_input_2'] = $poli_input_2;
      $this->cmp_formatado['klsranap'] = $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['campos_busca']['klsranap'];
      $this->cmp_formatado['klsranap_input_2'] = $klsranap_input_2;

      //----- $tgltransaksi
      $this->Date_part = false;
      if ($tgltransaksi_cond != "bi_TP")
      {
          $tgltransaksi_cond = strtoupper($tgltransaksi_cond);
          $Dtxt = "";
          $val  = array();
          $Dtxt .= $tgltransaksi_ano;
          $Dtxt .= $tgltransaksi_mes;
          $Dtxt .= $tgltransaksi_dia;
          $val[0]['ano'] = $tgltransaksi_ano;
          $val[0]['mes'] = $tgltransaksi_mes;
          $val[0]['dia'] = $tgltransaksi_dia;
          if ($tgltransaksi_cond == "BW")
          {
              $val[1]['ano'] = $tgltransaksi_input_2_ano;
              $val[1]['mes'] = $tgltransaksi_input_2_mes;
              $val[1]['dia'] = $tgltransaksi_input_2_dia;
          }
          $this->Operador_date_part = "";
          $this->Lang_date_part     = "";
          $this->nm_prep_date($val, "DT", "DATETIME", $tgltransaksi_cond, "", "data");
          if (!$this->Date_part) {
              $val[0] = $this->Ini->sc_Date_Protect($val[0]);
          }
          $tgltransaksi = $val[0];
          $this->cmp_formatado['tgltransaksi'] = $val[0];
          $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['campos_busca']['tgltransaksi'] = $val[0];
          $this->nm_data->SetaData($this->cmp_formatado['tgltransaksi'], "YYYY-MM-DD HH:II:SS");
          $this->cmp_formatado['tgltransaksi'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DH", "dmY"));
          if ($tgltransaksi_cond == "BW")
          {
              if (!$this->Date_part) {
                  $val[1] = $this->Ini->sc_Date_Protect($val[1]);
              }
              $tgltransaksi_input_2     = $val[1];
              $this->cmp_formatado['tgltransaksi_input_2'] = $val[1];
              $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['campos_busca']['tgltransaksi_input_2'] = $val[1];
              $this->nm_data->SetaData($this->cmp_formatado['tgltransaksi_input_2'], "YYYY-MM-DD HH:II:SS");
              $this->cmp_formatado['tgltransaksi_input_2'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DH", "dmY"));
          }
          if (!empty($Dtxt) || $tgltransaksi_cond == "NU" || $tgltransaksi_cond == "NN"|| $tgltransaksi_cond == "EP"|| $tgltransaksi_cond == "NE")
          {
              $this->monta_condicao("a.tranDate", $tgltransaksi_cond, $tgltransaksi, $tgltransaksi_input_2, 'tgltransaksi', 'DATETIME');
          }
      }
      ...
      if (is_array($pemeriksaan) && count($pemeriksaan) != 0)
      {
         ...
         {
             $this->comando        .= " b.nama not in (";
             $this->comando_sum    .= " .b.nama not in (";
             $this->comando_filtro .= " b.nama not in (";
         }
         else
         {
             $this->comando        .= " b.nama in (";
             $this->comando_sum    .= " .b.nama in (";
             $this->comando_filtro .= " b.nama in (";
         }
         $x                     = count($pemeriksaan);
         $xx                    = 0;
         $nm_cond               = "";
         ...
         $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['cond_pesq'] .= $nmgp_tab_label['pemeriksaan'] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
      }
      elseif (isset($pemeriksaan) || $pemeriksaan_cond == "nu" || $pemeriksaan_cond == "nn" || $pemeriksaan_cond == "ep" || $pemeriksaan_cond == "ne")
      {
         $this->monta_condicao("b.nama", $pemeriksaan_cond, $pemeriksaan, "", "pemeriksaan");
      }
      ...
      if (is_array($kategori) && count($kategori) != 0)
      {
         ...
         {
             $this->comando        .= " b.kategori not in (";
             $this->comando_sum    .= " .b.kategori not in (";
             $this->comando_filtro .= " b.kategori not in (";
         }
         else
         {
             $this->comando        .= " b.kategori in (";
             $this->comando_sum    .= " .b.kategori in (";
             $this->comando_filtro .= " b.kategori in (";
         }
         $x                     = count($kategori);
         $xx                    = 0;
         $nm_cond               = "";
         ...
         $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['cond_pesq'] .= $nmgp_tab_label['kategori'] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
      }
      elseif (isset($kategori) || $kategori_cond == "nu" || $kategori_cond == "nn" || $kategori_cond == "ep" || $kategori_cond == "ne")
      {
         $this->monta_condicao("b.kategori", $kategori_cond, $kategori, "", "kategori");
      }

      //----- $poli
      $this->Date_part = false;
      $nm_aspas = "'";
      if ($poli_cond == "nu" || $poli_cond == "nn" || $poli_cond == "ep" || $poli_cond == "ne")
      {
          $poli = array();
      }
      if (is_array($poli) && count($poli) != 0)
      {
         foreach ($poli as $i => $dados)
         {
            $tmp_pos = strpos($dados, "##@@");
            if (($tmp_pos === false && $dados == "") || $tmp_pos == 0)
            {
      ...
      {
         $this->and_or();
         if ($poli_cond == "df" || $poli_cond == "np")
         {
             $this->comando        .= " f.`name` not in (";
             $this->comando_sum    .= " .f.`name` not in (";
             $this->comando_filtro .= " f.`name` not in (";
         }
         else
         {
             $this->comando        .= " f.`name` in (";
             $this->comando_sum    .= " .f.`name` in (";
             $this->comando_filtro .= " f.`name` in (";
         }
         $x                     = count($poli);
         $xx                    = 0;
         $nm_cond               = "";
         ...
         $Lang_descr['df'] = $this->Ini->Nm_lang['lang_srch_diff'];
         $Lang_descr['np'] = $this->Ini->Nm_lang['lang_srch_not_like'];
         $Lang_descr_final = isset($Lang_descr[$poli_cond]) ? $Lang_descr[$poli_cond] : $this->Ini->Nm_lang['lang_srch_like'];
         $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['cond_pesq'] .= $nmgp_tab_label['poli'] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
      }
      elseif (isset($poli) || $poli_cond == "nu" || $poli_cond == "nn" || $poli_cond == "ep" || $poli_cond == "ne")
      {
         $this->monta_condicao("f.`name`", $poli_cond, $poli, "", "poli");
      }

      //----- $klsranap
      $this->Date_part = false;
      $nm_aspas = "'";
      if ($klsranap_cond == "nu" || $klsranap_cond == "nn" || $klsranap_cond == "ep" || $klsranap_cond == "ne")
      {
          $klsranap = array();
      }
      if (is_array($klsranap) && count($klsranap) != 0)
      {
         foreach ($klsranap as $i => $dados)
         {
            $tmp_pos = strpos($dados, "##@@");
            if (($tmp_pos === false && $dados == "") || $tmp_pos == 0)
            {
      ...
      {
         $this->and_or();
         if ($klsranap_cond == "df" || $klsranap_cond == "np")
         {
             $this->comando        .= " g.kelas not in (";
             $this->comando_sum    .= " .g.kelas not in (";
             $this->comando_filtro .= " g.kelas not in (";
         }
         else
         {
             $this->comando        .= " g.kelas in (";
             $this->comando_sum    .= " .g.kelas in (";
             $this->comando_filtro .= " g.kelas in (";
         }
         $x                     = count($klsranap);
         $xx                    = 0;
         $nm_cond               = "";
         ...
         $Lang_descr['df'] = $this->Ini->Nm_lang['lang_srch_diff'];
         $Lang_descr['np'] = $this->Ini->Nm_lang['lang_srch_not_like'];
         $Lang_descr_final = isset($Lang_descr[$klsranap_cond]) ? $Lang_descr[$klsranap_cond] : $this->Ini->Nm_lang['lang_srch_like'];
         $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['cond_pesq'] .= $nmgp_tab_label['klsranap'] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
      }
      elseif (isset($klsranap) || $klsranap_cond == "nu" || $klsranap_cond == "nn" || $klsranap_cond == "ep" || $klsranap_cond == "ne")
      {
         $this->monta_condicao("g.kelas", $klsranap_cond, $klsranap, "", "klsranap");
      }
   }
   ...
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['cond_dyn_search'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['cond_pesq'] .= $this->NM_operador;
   ...
   function css_obj_select_ajax($Obj)
   {
      switch ($Obj)
      {
         case "pemeriksaan" : return ('class="scFilterObjectOdd"'); break;
         case "kategori" : return ('class="scFilterObjectEven"'); break;
         case "poli" : return ('class="scFilterObjectOdd"'); break;
         case "klsranap" : return ('class="scFilterObjectEven"'); break;
         default       : return ("");
      }
   }
