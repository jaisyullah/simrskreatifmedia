...
class pendapatan_Lab_resumo
{
     ...
     { 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['contr_total_geral'] == "OK")
      {
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
          {
              ...
              $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['arr_total'][$cmp_gb];
          }
      }
      else
      {
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['tot_geral'][1];
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['json_use_label'])
       {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['labels']['pemeriksaan'] = $Lab_pemeriksaan; 
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
          $Str_gb .= ($Str_gb == "") ? "" : ",";
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['labels']['tgltransaksi']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['labels']['tgltransaksi'] = "Tgl Transaksi"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['labels']['pemeriksaan']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['labels']['pemeriksaan'] = "Pemeriksaan"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['labels']['kategori']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['labels']['kategori'] = "Kategori"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['labels']['harga']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['labels']['harga'] = "Harga"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['labels']['pasien']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['labels']['pasien'] = "Pasien"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['labels']['poli']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['labels']['poli'] = "Poli"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['labels']['nostruk']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['labels']['nostruk'] = "No Struk"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['labels']['kode']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['labels']['kode'] = "Kode Transaksi"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['labels']['sc_field_0']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['labels']['sc_field_0'] = "Jenis Bayar"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['labels']['klsranap']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['labels']['klsranap'] = "Kelas Rawat"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['labels']['diskon']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['labels']['diskon'] = "Diskon"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['labels']['penjamin']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['labels']['penjamin'] = "Penjamin"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['labels']['koderanap']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['labels']['koderanap'] = "Kode Ranap"; 
       }
       //-----
       $ix = 0;
       $this->comp_field_nm = array();
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['summarizing_fields_order']['sc_free_group_by']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['summarizing_fields_order']['sc_free_group_by'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['summarizing_fields_order']['sc_free_group_by'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['summarizing_fields_display']['sc_free_group_by'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['summarizing_fields_display']['sc_free_group_by'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['summarizing_fields_display']['sc_free_group_by'] as $i_sum => $d_sum)
           {
      ...
      eval ($Str_gb);
       ...
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['SC_Gb_Free_cmp'] as $cmp_gb => $col_sql)
       {
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['pivot_tabular_label'];
   ...
   function buildChart()
   {
	...
	function filterChartsBySummarization() {
		...
		if (isset($nmgp_opcao) && ('pdf' == $nmgp_opcao || 'pdf_res' == $nmgp_opcao)) {
			...
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['summarizing_fields_display']['sc_free_group_by'] as $fieldIndex => $fieldData) {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['proc_pdf_vert']){ 
   ...
   function totaliza()
   {
      ...
      $this->array_total_pemeriksaan = $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['arr_total']['pemeriksaan'];
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
...
//--- 
   ...
   //---- 
   function adiciona_registro($quebra_pemeriksaan, $quebra_pemeriksaan_orig)
   {
      $contr_arr = "";
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
          $Name_orig  = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['SC_Gb_Free_orig'][$cmp_gb])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatan_Lab']['SC_Gb_Free_orig'][$cmp_gb] : $cmp_gb;
      ...
      if (empty($this->array_total_geral))
      {
         ...
         $this->array_total_geral[1] = 1;
      }
      else
      {
         $this->array_total_geral[0]++;
         $this->array_total_geral[1]++;
      }
   }
   ...
   function compat_arrays()
   {
      ...
      {
          $Arr_gb[]   = $cmp_gb;
          $Arr_name[] = "_SESSION['sc_session'][" . $this->Ini->sc_page . "]['pendapatan_Lab']['arr_total']['" .$cmp_gb . "']" . $Control;
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->pemeriksaan, $this->pemeriksaan_orig);
            }
   }
//
...
$_SESSION['scriptcase']['pendapatan_Lab']['contr_erro'] = 'off';
         ...
         $this->adiciona_registro(sc_strip_script($this->pemeriksaan), sc_strip_script($pemeriksaan_orig));
