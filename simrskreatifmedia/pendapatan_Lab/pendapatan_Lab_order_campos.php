...
<?php
   ...
   $Ord_Cmp = new pendapatan_Lab_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class pendapatan_Lab_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['pendapatan_Lab']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['pendapatan_Lab']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels     = array();
   $tab_ger_campos['tgltransaksi'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['tgltransaksi'] = "tgltransaksi";
   }
   else
   {
       $tab_def_campos['tgltransaksi'] = "a.tranDate";
   }
   $tab_labels["tgltransaksi"]   = (isset($_SESSION['sc_session'][$sc_init]['pendapatan_Lab']['labels']["tgltransaksi"])) ? $_SESSION['sc_session'][$sc_init]['pendapatan_Lab']['labels']["tgltransaksi"] : "Tgl Transaksi";
   $tab_ger_campos['pemeriksaan'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['pemeriksaan'] = "pemeriksaan";
   }
   else
   {
       $tab_def_campos['pemeriksaan'] = "b.nama";
   }
   $tab_labels["pemeriksaan"]   = (isset($_SESSION['sc_session'][$sc_init]['pendapatan_Lab']['labels']["pemeriksaan"])) ? $_SESSION['sc_session'][$sc_init]['pendapatan_Lab']['labels']["pemeriksaan"] : "Pemeriksaan";
   ...
   {
       $tab_def_campos['kategori'] = "b.kategori";
   }
   $tab_labels["kategori"]   = (isset($_SESSION['sc_session'][$sc_init]['pendapatan_Lab']['labels']["kategori"])) ? $_SESSION['sc_session'][$sc_init]['pendapatan_Lab']['labels']["kategori"] : "Kategori";
   $tab_ger_campos['harga'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['harga'] = "harga";
   }
   else
   {
       $tab_def_campos['harga'] = "a.rate";
   }
   $tab_labels["harga"]   = (isset($_SESSION['sc_session'][$sc_init]['pendapatan_Lab']['labels']["harga"])) ? $_SESSION['sc_session'][$sc_init]['pendapatan_Lab']['labels']["harga"] : "Harga";
   ...
   {
       $tab_def_campos['pasien'] = "concat(d. NAME,', ',d.salut,' (',d.custCode,')')";
   }
   $tab_labels["pasien"]   = (isset($_SESSION['sc_session'][$sc_init]['pendapatan_Lab']['labels']["pasien"])) ? $_SESSION['sc_session'][$sc_init]['pendapatan_Lab']['labels']["pasien"] : "Pasien";
   ...
   {
       $tab_def_campos['poli'] = "f.`name`";
   }
   $tab_labels["poli"]   = (isset($_SESSION['sc_session'][$sc_init]['pendapatan_Lab']['labels']["poli"])) ? $_SESSION['sc_session'][$sc_init]['pendapatan_Lab']['labels']["poli"] : "Poli";
   ...
   {
       $tab_def_campos['nostruk'] = "c.struk";
   }
   $tab_labels["nostruk"]   = (isset($_SESSION['sc_session'][$sc_init]['pendapatan_Lab']['labels']["nostruk"])) ? $_SESSION['sc_session'][$sc_init]['pendapatan_Lab']['labels']["nostruk"] : "No Struk";
   ...
   $tab_labels["kode"]   = (isset($_SESSION['sc_session'][$sc_init]['pendapatan_Lab']['labels']["kode"])) ? $_SESSION['sc_session'][$sc_init]['pendapatan_Lab']['labels']["kode"] : "Kode Transaksi";
   ...
   $tab_labels["sc_field_0"]   = (isset($_SESSION['sc_session'][$sc_init]['pendapatan_Lab']['labels']["sc_field_0"])) ? $_SESSION['sc_session'][$sc_init]['pendapatan_Lab']['labels']["sc_field_0"] : "Jenis Bayar";
   $tab_ger_campos['klsranap'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['klsranap'] = "klsranap";
   }
   else
   {
       $tab_def_campos['klsranap'] = "g.kelas";
   }
   $tab_labels["klsranap"]   = (isset($_SESSION['sc_session'][$sc_init]['pendapatan_Lab']['labels']["klsranap"])) ? $_SESSION['sc_session'][$sc_init]['pendapatan_Lab']['labels']["klsranap"] : "Kelas Rawat";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['pendapatan_Lab']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['pendapatan_Lab']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['pendapatan_Lab']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['pendapatan_Lab']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['pendapatan_Lab']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['pendapatan_Lab']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['pendapatan_Lab']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['pendapatan_Lab']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['pendapatan_Lab']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "pendapatan_Lab_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['pendapatan_Lab']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['pendapatan_Lab']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['pendapatan_Lab']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['pendapatan_Lab']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['pendapatan_Lab']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
