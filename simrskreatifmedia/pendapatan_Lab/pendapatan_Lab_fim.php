...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____pendapatan_Lab"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____pendapatan_Lab"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['pendapatan_Lab']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['pendapatan_Lab']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['pendapatan_Lab']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['pendapatan_Lab']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['pendapatan_Lab']['sc_modal']);
           if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['pendapatan_Lab']['opc_psq']))
           {
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['pendapatan_Lab']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['pendapatan_Lab']['embutida_filho'] as $ind => $sc_init)
          {
