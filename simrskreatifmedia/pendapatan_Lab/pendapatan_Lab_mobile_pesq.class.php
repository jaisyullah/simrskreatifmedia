...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "a.tranDate";$Nm_datas[] = "a_tranDate";$Nm_numeric[] = "a_rate";$Nm_numeric[] = "a_disc";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_tgltransaksi"  <?php echo $str_hide_tgltransaksi?>>
<?php
  $Form_base = "ddmmyyyy";
  $date_format_show = "";
...
?>
          ...
          <BR>
        <SPAN id="id_vis_tgltransaksi"  <?php echo $str_display_tgltransaksi; ?> class="scFilterFieldFontOdd">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_klsranap"  <?php echo $str_hide_klsranap?>>
<?php
