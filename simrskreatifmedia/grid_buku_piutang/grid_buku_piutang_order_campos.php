...
<?php
   ...
   $Ord_Cmp = new grid_buku_piutang_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_buku_piutang_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_buku_piutang']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_buku_piutang']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_buku_piutang']['labels']["id"])) ? $_SESSION['sc_session'][$sc_init]['grid_buku_piutang']['labels']["id"] : "Id";
   $tab_ger_campos['id_transaksi'] = "on";
   $tab_def_campos['id_transaksi'] = "id_transaksi";
   $tab_labels["id_transaksi"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_buku_piutang']['labels']["id_transaksi"])) ? $_SESSION['sc_session'][$sc_init]['grid_buku_piutang']['labels']["id_transaksi"] : "Id Transaksi";
   $tab_ger_campos['no_referensi'] = "on";
   $tab_def_campos['no_referensi'] = "no_referensi";
   $tab_labels["no_referensi"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_buku_piutang']['labels']["no_referensi"])) ? $_SESSION['sc_session'][$sc_init]['grid_buku_piutang']['labels']["no_referensi"] : "No Referensi";
   $tab_ger_campos['tanggal'] = "on";
   $tab_def_campos['tanggal'] = "tanggal";
   $tab_labels["tanggal"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_buku_piutang']['labels']["tanggal"])) ? $_SESSION['sc_session'][$sc_init]['grid_buku_piutang']['labels']["tanggal"] : "Tanggal";
   $tab_ger_campos['keterangan'] = "on";
   $tab_def_campos['keterangan'] = "keterangan";
   $tab_labels["keterangan"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_buku_piutang']['labels']["keterangan"])) ? $_SESSION['sc_session'][$sc_init]['grid_buku_piutang']['labels']["keterangan"] : "Keterangan";
   $tab_ger_campos['nilai_transaksi'] = "on";
   $tab_def_campos['nilai_transaksi'] = "nilai_transaksi";
   $tab_labels["nilai_transaksi"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_buku_piutang']['labels']["nilai_transaksi"])) ? $_SESSION['sc_session'][$sc_init]['grid_buku_piutang']['labels']["nilai_transaksi"] : "Nilai Transaksi";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_buku_piutang']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_buku_piutang']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_buku_piutang']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_buku_piutang']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_buku_piutang']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_buku_piutang']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_buku_piutang']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_buku_piutang']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_buku_piutang']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_buku_piutang_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_buku_piutang']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_buku_piutang']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_buku_piutang']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_buku_piutang']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_buku_piutang']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
