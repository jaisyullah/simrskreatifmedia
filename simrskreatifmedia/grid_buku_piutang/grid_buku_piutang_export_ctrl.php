<?php
@session_start() ;
$_SESSION['scriptcase']['grid_buku_piutang']['sc_process_barr'] = true;
require_once('../grid_buku_piutang/index.php');
unset($_SESSION['scriptcase']['grid_buku_piutang']['sc_process_barr']);
$ExportCtrl = new grid_buku_piutang_export_control;
$ExportCtrl->Export_barr();

class grid_buku_piutang_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_title'] ?> buku_piutang :: Excel</TITLE>
