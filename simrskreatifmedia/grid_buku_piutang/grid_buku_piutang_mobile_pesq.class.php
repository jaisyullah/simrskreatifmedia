...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "tanggal";$Nm_datas[] = "tanggal";$Nm_numeric[] = "id";$Nm_numeric[] = "id_transaksi";$Nm_numeric[] = "nilai_transaksi";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_tanggal_cond" name="tanggal_cond" onChange="nm_campos_between(document.getElementById('id_vis_tanggal'), this, 'tanggal')">
      ...
      <br><span id="id_hide_tanggal"  <?php echo $str_hide_tanggal?>>
<?php
  $Form_base = "ddmmyyyy";
  $date_format_show = "";
...
?>
 ...
 <?php echo $date_format_show ?>         </SPAN>
                  <br />
        <SPAN id="id_vis_tanggal"  <?php echo $str_display_tanggal; ?> class="scFilterFieldFontOdd">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_id_transaksi_cond" name="id_transaksi_cond" onChange="nm_campos_between(document.getElementById('id_vis_id_transaksi'), this, 'id_transaksi')">
      ...
      <br><span id="id_hide_id_transaksi"  <?php echo $str_hide_id_transaksi?>><?php
      if ($id_transaksi != "")
      {
      $id_transaksi_look = substr($this->Db->qstr($id_transaksi), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_no_referensi_cond" name="no_referensi_cond" onChange="nm_campos_between(document.getElementById('id_vis_no_referensi'), this, 'no_referensi')">
      ...
      <br><span id="id_hide_no_referensi"  <?php echo $str_hide_no_referensi?>><?php
      if ($no_referensi != "")
      {
      $no_referensi_look = substr($this->Db->qstr($no_referensi), 1, -1); 
      $nmgp_def_dados = array(); 
