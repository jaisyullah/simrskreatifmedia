...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_igd_old']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
  <input type="hidden" name="script_case_session" value="<?php echo $this->form_encode_input(session_id()); ?>"> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_pay_igd_old"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
?> 
var var_btn_Cetak_payno_igd = "<?php echo $this->form_encode_input($this->nmgp_dados_form['nopayment']); ?>";
...
{
      nm_gp_submit('<?php echo $this->Ini->link_cetak_gd; ?>', '<?php echo $this->nm_location; ?>', '<?php echo "payno_igd*scin' + var_btn_Cetak_payno_igd + '*scout"; ?>', '', '_blank', '0', '0', 'cetak_gd');
}
 NM_tp_critica(1);
...
{ 
   var sob_iframe = '';
<?php 
if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_igd_old']['embutida_form']) {
...
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_igd_old']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_igd_old']['sc_modal']) {
    echo "   sob_iframe += 'parent.';\r\n";
}
?>
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pay_igd_old']['where_detal']))
  {
?>  
