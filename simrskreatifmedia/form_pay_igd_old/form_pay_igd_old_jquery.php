...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_id' + iSeqRow).bind('blur', function() { sc_form_pay_igd_old_id_onblur(this, iSeqRow) })
                                .bind('focus', function() { sc_form_pay_igd_old_id_onfocus(this, iSeqRow) });
  $('#id_sc_field_trancode' + iSeqRow).bind('blur', function() { sc_form_pay_igd_old_trancode_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_form_pay_igd_old_trancode_onchange(this, iSeqRow) })
                                      .bind('focus', function() { sc_form_pay_igd_old_trancode_onfocus(this, iSeqRow) });
  $('#id_sc_field_nostruk' + iSeqRow).bind('blur', function() { sc_form_pay_igd_old_nostruk_onblur(this, iSeqRow) })
                                     .bind('focus', function() { sc_form_pay_igd_old_nostruk_onfocus(this, iSeqRow) });
  $('#id_sc_field_custcode' + iSeqRow).bind('blur', function() { sc_form_pay_igd_old_custcode_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_form_pay_igd_old_custcode_onchange(this, iSeqRow) })
                                      .bind('focus', function() { sc_form_pay_igd_old_custcode_onfocus(this, iSeqRow) });
  $('#id_sc_field_dokter' + iSeqRow).bind('blur', function() { sc_form_pay_igd_old_dokter_onblur(this, iSeqRow) })
                                    .bind('focus', function() { sc_form_pay_igd_old_dokter_onfocus(this, iSeqRow) });
  $('#id_sc_field_jmltagihan' + iSeqRow).bind('blur', function() { sc_form_pay_igd_old_jmltagihan_onblur(this, iSeqRow) })
                                        .bind('focus', function() { sc_form_pay_igd_old_jmltagihan_onfocus(this, iSeqRow) });
  $('#id_sc_field_jmlbayar' + iSeqRow).bind('blur', function() { sc_form_pay_igd_old_jmlbayar_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_form_pay_igd_old_jmlbayar_onchange(this, iSeqRow) })
                                      .bind('focus', function() { sc_form_pay_igd_old_jmlbayar_onfocus(this, iSeqRow) });
  $('#id_sc_field_deposit' + iSeqRow).bind('blur', function() { sc_form_pay_igd_old_deposit_onblur(this, iSeqRow) })
                                     .bind('focus', function() { sc_form_pay_igd_old_deposit_onfocus(this, iSeqRow) });
  $('#id_sc_field_potongan' + iSeqRow).bind('blur', function() { sc_form_pay_igd_old_potongan_onblur(this, iSeqRow) })
                                      .bind('focus', function() { sc_form_pay_igd_old_potongan_onfocus(this, iSeqRow) });
  $('#id_sc_field_hrsdibayar' + iSeqRow).bind('blur', function() { sc_form_pay_igd_old_hrsdibayar_onblur(this, iSeqRow) })
                                        .bind('focus', function() { sc_form_pay_igd_old_hrsdibayar_onfocus(this, iSeqRow) });
  $('#id_sc_field_terimadari' + iSeqRow).bind('blur', function() { sc_form_pay_igd_old_terimadari_onblur(this, iSeqRow) })
                                        .bind('focus', function() { sc_form_pay_igd_old_terimadari_onfocus(this, iSeqRow) });
  $('#id_sc_field_jenispayment' + iSeqRow).bind('blur', function() { sc_form_pay_igd_old_jenispayment_onblur(this, iSeqRow) })
                                          .bind('change', function() { sc_form_pay_igd_old_jenispayment_onchange(this, iSeqRow) })
                                          .bind('focus', function() { sc_form_pay_igd_old_jenispayment_onfocus(this, iSeqRow) });
  $('#id_sc_field_instansipenjamin' + iSeqRow).bind('blur', function() { sc_form_pay_igd_old_instansipenjamin_onblur(this, iSeqRow) })
                                              .bind('focus', function() { sc_form_pay_igd_old_instansipenjamin_onfocus(this, iSeqRow) });
  $('#id_sc_field_bankdebit' + iSeqRow).bind('blur', function() { sc_form_pay_igd_old_bankdebit_onblur(this, iSeqRow) })
                                       .bind('focus', function() { sc_form_pay_igd_old_bankdebit_onfocus(this, iSeqRow) });
  $('#id_sc_field_nokartu' + iSeqRow).bind('blur', function() { sc_form_pay_igd_old_nokartu_onblur(this, iSeqRow) })
                                     .bind('focus', function() { sc_form_pay_igd_old_nokartu_onfocus(this, iSeqRow) });
  $('#id_sc_field_sc_field_0' + iSeqRow).bind('blur', function() { sc_form_pay_igd_old_sc_field_0_onblur(this, iSeqRow) })
                                        .bind('focus', function() { sc_form_pay_igd_old_sc_field_0_onfocus(this, iSeqRow) });
  $('#id_sc_field_paiddate' + iSeqRow).bind('blur', function() { sc_form_pay_igd_old_paiddate_onblur(this, iSeqRow) })
                                      .bind('focus', function() { sc_form_pay_igd_old_paiddate_onfocus(this, iSeqRow) });
  $('#id_sc_field_paiddate_hora' + iSeqRow).bind('blur', function() { sc_form_pay_igd_old_paiddate_hora_onblur(this, iSeqRow) })
                                           .bind('focus', function() { sc_form_pay_igd_old_paiddate_hora_onfocus(this, iSeqRow) });
  $('#id_sc_field_nopayment' + iSeqRow).bind('blur', function() { sc_form_pay_igd_old_nopayment_onblur(this, iSeqRow) })
                                       .bind('focus', function() { sc_form_pay_igd_old_nopayment_onfocus(this, iSeqRow) });
  $('#id_sc_field_kasir' + iSeqRow).bind('blur', function() { sc_form_pay_igd_old_kasir_onblur(this, iSeqRow) })
                                   .bind('focus', function() { sc_form_pay_igd_old_kasir_onfocus(this, iSeqRow) });
  $('#id_sc_field_jmldk1' + iSeqRow).bind('blur', function() { sc_form_pay_igd_old_jmldk1_onblur(this, iSeqRow) })
                                    .bind('focus', function() { sc_form_pay_igd_old_jmldk1_onfocus(this, iSeqRow) });
  $('#id_sc_field_jmldk2' + iSeqRow).bind('blur', function() { sc_form_pay_igd_old_jmldk2_onblur(this, iSeqRow) })
                                    .bind('focus', function() { sc_form_pay_igd_old_jmldk2_onfocus(this, iSeqRow) });
  $('#id_sc_field_jmlasr' + iSeqRow).bind('blur', function() { sc_form_pay_igd_old_jmlasr_onblur(this, iSeqRow) })
                                    .bind('focus', function() { sc_form_pay_igd_old_jmlasr_onfocus(this, iSeqRow) });
  $('#id_sc_field_jmlkary' + iSeqRow).bind('blur', function() { sc_form_pay_igd_old_jmlkary_onblur(this, iSeqRow) })
                                     .bind('focus', function() { sc_form_pay_igd_old_jmlkary_onfocus(this, iSeqRow) });
  $('#id_sc_field_edc1' + iSeqRow).bind('blur', function() { sc_form_pay_igd_old_edc1_onblur(this, iSeqRow) })
                                  .bind('focus', function() { sc_form_pay_igd_old_edc1_onfocus(this, iSeqRow) });
  $('#id_sc_field_edc2' + iSeqRow).bind('blur', function() { sc_form_pay_igd_old_edc2_onblur(this, iSeqRow) })
                                  .bind('focus', function() { sc_form_pay_igd_old_edc2_onfocus(this, iSeqRow) });
  $('#id_sc_field_lab' + iSeqRow).bind('blur', function() { sc_form_pay_igd_old_lab_onblur(this, iSeqRow) })
                                 .bind('focus', function() { sc_form_pay_igd_old_lab_onfocus(this, iSeqRow) });
  $('#id_sc_field_sc_field_1' + iSeqRow).bind('blur', function() { sc_form_pay_igd_old_sc_field_1_onblur(this, iSeqRow) })
                                        .bind('focus', function() { sc_form_pay_igd_old_sc_field_1_onfocus(this, iSeqRow) });
  $('#id_sc_field_poli' + iSeqRow).bind('blur', function() { sc_form_pay_igd_old_poli_onblur(this, iSeqRow) })
                                  .bind('focus', function() { sc_form_pay_igd_old_poli_onfocus(this, iSeqRow) });
  $('#id_sc_field_rad' + iSeqRow).bind('blur', function() { sc_form_pay_igd_old_rad_onblur(this, iSeqRow) })
                                 .bind('focus', function() { sc_form_pay_igd_old_rad_onfocus(this, iSeqRow) });
  $('#id_sc_field_bhp' + iSeqRow).bind('blur', function() { sc_form_pay_igd_old_bhp_onblur(this, iSeqRow) })
                                 .bind('focus', function() { sc_form_pay_igd_old_bhp_onfocus(this, iSeqRow) });
  $('#id_sc_field_detailadm' + iSeqRow).bind('blur', function() { sc_form_pay_igd_old_detailadm_onblur(this, iSeqRow) })
                                       .bind('focus', function() { sc_form_pay_igd_old_detailadm_onfocus(this, iSeqRow) });
  $('#id_sc_field_detailresep' + iSeqRow).bind('blur', function() { sc_form_pay_igd_old_detailresep_onblur(this, iSeqRow) })
                                         .bind('focus', function() { sc_form_pay_igd_old_detailresep_onfocus(this, iSeqRow) });
  $('#id_sc_field_detailtindakan' + iSeqRow).bind('blur', function() { sc_form_pay_igd_old_detailtindakan_onblur(this, iSeqRow) })
                                            .bind('focus', function() { sc_form_pay_igd_old_detailtindakan_onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_form_pay_igd_old_id_onblur(oThis, iSeqRow) {
  do_ajax_form_pay_igd_old_validate_id();
  scCssBlur(oThis);
}

function sc_form_pay_igd_old_id_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_pay_igd_old_trancode_onblur(oThis, iSeqRow) {
  do_ajax_form_pay_igd_old_validate_trancode();
  scCssBlur(oThis);
}

function sc_form_pay_igd_old_trancode_onchange(oThis, iSeqRow) {
  do_ajax_form_pay_igd_old_event_trancode_onchange();
}

function sc_form_pay_igd_old_trancode_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_pay_igd_old_nostruk_onblur(oThis, iSeqRow) {
  do_ajax_form_pay_igd_old_validate_nostruk();
  scCssBlur(oThis);
}

function sc_form_pay_igd_old_nostruk_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_pay_igd_old_custcode_onblur(oThis, iSeqRow) {
  do_ajax_form_pay_igd_old_validate_custcode();
  scCssBlur(oThis);
}

function sc_form_pay_igd_old_custcode_onchange(oThis, iSeqRow) {
  do_ajax_form_pay_igd_old_refresh_custcode();
}

function sc_form_pay_igd_old_custcode_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_pay_igd_old_dokter_onblur(oThis, iSeqRow) {
  do_ajax_form_pay_igd_old_validate_dokter();
  scCssBlur(oThis);
}

function sc_form_pay_igd_old_dokter_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_pay_igd_old_jmltagihan_onblur(oThis, iSeqRow) {
  do_ajax_form_pay_igd_old_validate_jmltagihan();
  scCssBlur(oThis);
}

function sc_form_pay_igd_old_jmltagihan_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_pay_igd_old_jmlbayar_onblur(oThis, iSeqRow) {
  do_ajax_form_pay_igd_old_validate_jmlbayar();
  scCssBlur(oThis);
}

function sc_form_pay_igd_old_jmlbayar_onchange(oThis, iSeqRow) {
  do_ajax_form_pay_igd_old_event_jmlbayar_onchange();
}

function sc_form_pay_igd_old_jmlbayar_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_pay_igd_old_deposit_onblur(oThis, iSeqRow) {
  do_ajax_form_pay_igd_old_validate_deposit();
  scCssBlur(oThis);
}

function sc_form_pay_igd_old_deposit_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_pay_igd_old_potongan_onblur(oThis, iSeqRow) {
  do_ajax_form_pay_igd_old_validate_potongan();
  scCssBlur(oThis);
}

function sc_form_pay_igd_old_potongan_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_pay_igd_old_hrsdibayar_onblur(oThis, iSeqRow) {
  do_ajax_form_pay_igd_old_validate_hrsdibayar();
  scCssBlur(oThis);
}

function sc_form_pay_igd_old_hrsdibayar_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_pay_igd_old_terimadari_onblur(oThis, iSeqRow) {
  do_ajax_form_pay_igd_old_validate_terimadari();
  scCssBlur(oThis);
}

function sc_form_pay_igd_old_terimadari_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_pay_igd_old_jenispayment_onblur(oThis, iSeqRow) {
  do_ajax_form_pay_igd_old_validate_jenispayment();
  scCssBlur(oThis);
}

function sc_form_pay_igd_old_jenispayment_onchange(oThis, iSeqRow) {
  do_ajax_form_pay_igd_old_event_jenispayment_onchange();
}

function sc_form_pay_igd_old_jenispayment_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_pay_igd_old_instansipenjamin_onblur(oThis, iSeqRow) {
  do_ajax_form_pay_igd_old_validate_instansipenjamin();
  scCssBlur(oThis);
}

function sc_form_pay_igd_old_instansipenjamin_onfocus(oThis, iSeqRow) {
  scCssFocus(oThis);
}

function sc_form_pay_igd_old_bankdebit_onblur(oThis, iSeqRow) {
  do_ajax_form_pay_igd_old_validate_bankdebit();
  scCssBlur(oThis);
}

function sc_form_pay_igd_old_bankdebit_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_pay_igd_old_nokartu_onblur(oThis, iSeqRow) {
  do_ajax_form_pay_igd_old_validate_nokartu();
  scCssBlur(oThis);
}

function sc_form_pay_igd_old_nokartu_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_pay_igd_old_sc_field_0_onblur(oThis, iSeqRow) {
  do_ajax_form_pay_igd_old_validate_sc_field_0();
  scCssBlur(oThis);
}

function sc_form_pay_igd_old_sc_field_0_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_pay_igd_old_paiddate_onblur(oThis, iSeqRow) {
  do_ajax_form_pay_igd_old_validate_paiddate();
  scCssBlur(oThis);
}

function sc_form_pay_igd_old_paiddate_hora_onblur(oThis, iSeqRow) {
  do_ajax_form_pay_igd_old_validate_paiddate();
  scCssBlur(oThis);
}

function sc_form_pay_igd_old_paiddate_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_pay_igd_old_paiddate_hora_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_pay_igd_old_nopayment_onblur(oThis, iSeqRow) {
  do_ajax_form_pay_igd_old_validate_nopayment();
  scCssBlur(oThis);
}

function sc_form_pay_igd_old_nopayment_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_pay_igd_old_kasir_onblur(oThis, iSeqRow) {
  do_ajax_form_pay_igd_old_validate_kasir();
  scCssBlur(oThis);
}

function sc_form_pay_igd_old_kasir_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_pay_igd_old_jmldk1_onblur(oThis, iSeqRow) {
  do_ajax_form_pay_igd_old_validate_jmldk1();
  scCssBlur(oThis);
}

function sc_form_pay_igd_old_jmldk1_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_pay_igd_old_jmldk2_onblur(oThis, iSeqRow) {
  do_ajax_form_pay_igd_old_validate_jmldk2();
  scCssBlur(oThis);
}

function sc_form_pay_igd_old_jmldk2_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_pay_igd_old_jmlasr_onblur(oThis, iSeqRow) {
  do_ajax_form_pay_igd_old_validate_jmlasr();
  scCssBlur(oThis);
}

function sc_form_pay_igd_old_jmlasr_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_pay_igd_old_jmlkary_onblur(oThis, iSeqRow) {
  do_ajax_form_pay_igd_old_validate_jmlkary();
  scCssBlur(oThis);
}

function sc_form_pay_igd_old_jmlkary_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_pay_igd_old_edc1_onblur(oThis, iSeqRow) {
  do_ajax_form_pay_igd_old_validate_edc1();
  scCssBlur(oThis);
}

function sc_form_pay_igd_old_edc1_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_pay_igd_old_edc2_onblur(oThis, iSeqRow) {
  do_ajax_form_pay_igd_old_validate_edc2();
  scCssBlur(oThis);
}

function sc_form_pay_igd_old_edc2_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_pay_igd_old_lab_onblur(oThis, iSeqRow) {
  do_ajax_form_pay_igd_old_validate_lab();
  scCssBlur(oThis);
}

function sc_form_pay_igd_old_lab_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_pay_igd_old_sc_field_1_onblur(oThis, iSeqRow) {
  do_ajax_form_pay_igd_old_validate_sc_field_1();
  scCssBlur(oThis);
}

function sc_form_pay_igd_old_sc_field_1_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_pay_igd_old_poli_onblur(oThis, iSeqRow) {
  do_ajax_form_pay_igd_old_validate_poli();
  scCssBlur(oThis);
}

function sc_form_pay_igd_old_poli_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_pay_igd_old_rad_onblur(oThis, iSeqRow) {
  do_ajax_form_pay_igd_old_validate_rad();
  scCssBlur(oThis);
}

function sc_form_pay_igd_old_rad_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_pay_igd_old_bhp_onblur(oThis, iSeqRow) {
  do_ajax_form_pay_igd_old_validate_bhp();
  scCssBlur(oThis);
}

function sc_form_pay_igd_old_bhp_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_pay_igd_old_detailadm_onblur(oThis, iSeqRow) {
  do_ajax_form_pay_igd_old_validate_detailadm();
  scCssBlur(oThis);
}

function sc_form_pay_igd_old_detailadm_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_pay_igd_old_detailresep_onblur(oThis, iSeqRow) {
  do_ajax_form_pay_igd_old_validate_detailresep();
  scCssBlur(oThis);
}

function sc_form_pay_igd_old_detailresep_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_pay_igd_old_detailtindakan_onblur(oThis, iSeqRow) {
  do_ajax_form_pay_igd_old_validate_detailtindakan();
  scCssBlur(oThis);
}

function sc_form_pay_igd_old_detailtindakan_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function scHidePage(pageNo) {
	$("#id_form_pay_igd_old_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_paiddate" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_pay_igd_old_validate_paiddate(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_trandate" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_pay_igd_old_validate_trandate(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
