  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_hrm_periode_remunerasi_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_hrm_periode_remunerasi_mob_form();
	}

  // ---------- Validate id
  function do_ajax_form_hrm_periode_remunerasi_mob_validate_id()
  {
    var nomeCampo_id = "id";
    var var_id = scAjaxGetFieldHidden(nomeCampo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_periode_remunerasi_mob_validate_id(var_id, var_script_case_init, do_ajax_form_hrm_periode_remunerasi_mob_validate_id_cb);
  } // do_ajax_form_hrm_periode_remunerasi_mob_validate_id

  function do_ajax_form_hrm_periode_remunerasi_mob_validate_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_periode_remunerasi_mob_validate_id_cb

  // ---------- Validate deskripsi
  function do_ajax_form_hrm_periode_remunerasi_mob_validate_deskripsi()
  {
    var nomeCampo_deskripsi = "deskripsi";
    var var_deskripsi = scAjaxGetFieldText(nomeCampo_deskripsi);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_periode_remunerasi_mob_validate_deskripsi(var_deskripsi, var_script_case_init, do_ajax_form_hrm_periode_remunerasi_mob_validate_deskripsi_cb);
  } // do_ajax_form_hrm_periode_remunerasi_mob_validate_deskripsi

  function do_ajax_form_hrm_periode_remunerasi_mob_validate_deskripsi_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_periode_remunerasi_mob_validate_deskripsi_cb

  // ---------- Validate tanggal_awal
  function do_ajax_form_hrm_periode_remunerasi_mob_validate_tanggal_awal()
  {
    var nomeCampo_tanggal_awal = "tanggal_awal";
    var var_tanggal_awal = scAjaxGetFieldText(nomeCampo_tanggal_awal);
    var var_script_case_init = document.F1.script_case_init.value;
    setTimeout(function() {
      var var_tanggal_awal = scAjaxGetFieldText(nomeCampo_tanggal_awal);
      x_ajax_form_hrm_periode_remunerasi_mob_validate_tanggal_awal(var_tanggal_awal, var_script_case_init, do_ajax_form_hrm_periode_remunerasi_mob_validate_tanggal_awal_cb);
    }, 200);
  } // do_ajax_form_hrm_periode_remunerasi_mob_validate_tanggal_awal

  function do_ajax_form_hrm_periode_remunerasi_mob_validate_tanggal_awal_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tanggal_awal";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_periode_remunerasi_mob_validate_tanggal_awal_cb

  // ---------- Validate tanggal_akhir
  function do_ajax_form_hrm_periode_remunerasi_mob_validate_tanggal_akhir()
  {
    var nomeCampo_tanggal_akhir = "tanggal_akhir";
    var var_tanggal_akhir = scAjaxGetFieldText(nomeCampo_tanggal_akhir);
    var var_script_case_init = document.F1.script_case_init.value;
    setTimeout(function() {
      var var_tanggal_akhir = scAjaxGetFieldText(nomeCampo_tanggal_akhir);
      x_ajax_form_hrm_periode_remunerasi_mob_validate_tanggal_akhir(var_tanggal_akhir, var_script_case_init, do_ajax_form_hrm_periode_remunerasi_mob_validate_tanggal_akhir_cb);
    }, 200);
  } // do_ajax_form_hrm_periode_remunerasi_mob_validate_tanggal_akhir

  function do_ajax_form_hrm_periode_remunerasi_mob_validate_tanggal_akhir_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tanggal_akhir";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors || ($("#ui-datepicker-div").length && $("#ui-datepicker-div").filter(":visible").length))
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_periode_remunerasi_mob_validate_tanggal_akhir_cb

  // ---------- Validate keterangan
  function do_ajax_form_hrm_periode_remunerasi_mob_validate_keterangan()
  {
    var nomeCampo_keterangan = "keterangan";
    var var_keterangan = scAjaxGetFieldText(nomeCampo_keterangan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_periode_remunerasi_mob_validate_keterangan(var_keterangan, var_script_case_init, do_ajax_form_hrm_periode_remunerasi_mob_validate_keterangan_cb);
  } // do_ajax_form_hrm_periode_remunerasi_mob_validate_keterangan

  function do_ajax_form_hrm_periode_remunerasi_mob_validate_keterangan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_periode_remunerasi_mob_validate_keterangan_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_hrm_periode_remunerasi_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_hrm_periode_remunerasi_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id = scAjaxGetFieldHidden("id");
    var var_deskripsi = scAjaxGetFieldText("deskripsi");
    var var_tanggal_awal = scAjaxGetFieldText("tanggal_awal");
    var var_tanggal_akhir = scAjaxGetFieldText("tanggal_akhir");
    ...
    scAjaxProcOn();
    x_ajax_form_hrm_periode_remunerasi_mob_submit_form(var_id, var_deskripsi, var_tanggal_awal, var_tanggal_akhir, var_keterangan, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_hrm_periode_remunerasi_mob_submit_form_cb);
  } // do_ajax_form_hrm_periode_remunerasi_mob_submit_form

  function do_ajax_form_hrm_periode_remunerasi_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("tanggal_awal");
      scAjaxHideErrorDisplay("tanggal_akhir");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_hrm_periode_remunerasi_mob_submit_form_cb_after_alert);
  } // do_ajax_form_hrm_periode_remunerasi_mob_submit_form_cb
  function do_ajax_form_hrm_periode_remunerasi_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_hrm_periode_remunerasi_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_hrm_periode_remunerasi_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_hrm_periode_remunerasi_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_hrm_periode_remunerasi_mob_navigate_form_cb);
  } // do_ajax_form_hrm_periode_remunerasi_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_hrm_periode_remunerasi_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_hrm_periode_remunerasi_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_hrm_periode_remunerasi_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_hrm_periode_remunerasi_mob_navigate_form_cb
  function do_ajax_form_hrm_periode_remunerasi_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_hrm_periode_remunerasi_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_hrm_periode_remunerasi_mob_navigate_form_cb_after_alert
  function sc_hide_form_hrm_periode_remunerasi_mob_form()
  {
  ...
  ajax_field_list[1] = "deskripsi";
  ajax_field_list[2] = "tanggal_awal";
  ajax_field_list[3] = "tanggal_akhir";
  ...
  var ajax_error_list = {
    ...
    "tanggal_awal": {"label": "Tanggal Awal", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "tanggal_akhir": {"label": "Tanggal Akhir", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  var ajax_field_mult = {
    "id": new Array(),
    "deskripsi": new Array(),
    "tanggal_awal": new Array(),
    "tanggal_akhir": new Array(),
    "keterangan": new Array()
  };
  ajax_field_mult["id"][1] = "id";
  ajax_field_mult["deskripsi"][1] = "deskripsi";
  ajax_field_mult["tanggal_awal"][1] = "tanggal_awal";
  ajax_field_mult["tanggal_akhir"][1] = "tanggal_akhir";
  ...
  var ajax_field_id = {
    ...
    "tanggal_awal": new Array("hidden_field_label_tanggal_awal", "hidden_field_data_tanggal_awal"),
    "tanggal_akhir": new Array("hidden_field_label_tanggal_akhir", "hidden_field_data_tanggal_akhir"),
