  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_hrm_periode_remunerasi" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_hrm_periode_remunerasi_form();
	}

  // ---------- Validate id
  function do_ajax_form_hrm_periode_remunerasi_validate_id()
  {
    var nomeCampo_id = "id";
    var var_id = scAjaxGetFieldHidden(nomeCampo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_periode_remunerasi_validate_id(var_id, var_script_case_init, do_ajax_form_hrm_periode_remunerasi_validate_id_cb);
  } // do_ajax_form_hrm_periode_remunerasi_validate_id

  function do_ajax_form_hrm_periode_remunerasi_validate_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_periode_remunerasi_validate_id_cb

  // ---------- Validate deskripsi
  function do_ajax_form_hrm_periode_remunerasi_validate_deskripsi()
  {
    var nomeCampo_deskripsi = "deskripsi";
    var var_deskripsi = scAjaxGetFieldText(nomeCampo_deskripsi);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_periode_remunerasi_validate_deskripsi(var_deskripsi, var_script_case_init, do_ajax_form_hrm_periode_remunerasi_validate_deskripsi_cb);
  } // do_ajax_form_hrm_periode_remunerasi_validate_deskripsi

  function do_ajax_form_hrm_periode_remunerasi_validate_deskripsi_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_periode_remunerasi_validate_deskripsi_cb

  // ---------- Validate tanggal_awal
  function do_ajax_form_hrm_periode_remunerasi_validate_tanggal_awal()
  {
    ...
    setTimeout(function() {
      var var_tanggal_awal = scAjaxGetFieldText(nomeCampo_tanggal_awal);
      x_ajax_form_hrm_periode_remunerasi_validate_tanggal_awal(var_tanggal_awal, var_script_case_init, do_ajax_form_hrm_periode_remunerasi_validate_tanggal_awal_cb);
    }, 200);
  } // do_ajax_form_hrm_periode_remunerasi_validate_tanggal_awal

  function do_ajax_form_hrm_periode_remunerasi_validate_tanggal_awal_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_periode_remunerasi_validate_tanggal_awal_cb

  // ---------- Validate tanggal_akhir
  function do_ajax_form_hrm_periode_remunerasi_validate_tanggal_akhir()
  {
    ...
    setTimeout(function() {
      var var_tanggal_akhir = scAjaxGetFieldText(nomeCampo_tanggal_akhir);
      x_ajax_form_hrm_periode_remunerasi_validate_tanggal_akhir(var_tanggal_akhir, var_script_case_init, do_ajax_form_hrm_periode_remunerasi_validate_tanggal_akhir_cb);
    }, 200);
  } // do_ajax_form_hrm_periode_remunerasi_validate_tanggal_akhir

  function do_ajax_form_hrm_periode_remunerasi_validate_tanggal_akhir_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_periode_remunerasi_validate_tanggal_akhir_cb

  // ---------- Validate keterangan
  function do_ajax_form_hrm_periode_remunerasi_validate_keterangan()
  {
    var nomeCampo_keterangan = "keterangan";
    var var_keterangan = scAjaxGetFieldText(nomeCampo_keterangan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_periode_remunerasi_validate_keterangan(var_keterangan, var_script_case_init, do_ajax_form_hrm_periode_remunerasi_validate_keterangan_cb);
  } // do_ajax_form_hrm_periode_remunerasi_validate_keterangan

  function do_ajax_form_hrm_periode_remunerasi_validate_keterangan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_periode_remunerasi_validate_keterangan_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_hrm_periode_remunerasi_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_hrm_periode_remunerasi_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_hrm_periode_remunerasi_submit_form(var_id, var_deskripsi, var_tanggal_awal, var_tanggal_akhir, var_keterangan, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_hrm_periode_remunerasi_submit_form_cb);
  } // do_ajax_form_hrm_periode_remunerasi_submit_form

  function do_ajax_form_hrm_periode_remunerasi_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_hrm_periode_remunerasi_submit_form_cb_after_alert);
  } // do_ajax_form_hrm_periode_remunerasi_submit_form_cb
  function do_ajax_form_hrm_periode_remunerasi_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_hrm_periode_remunerasi_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_hrm_periode_remunerasi_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_hrm_periode_remunerasi_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_hrm_periode_remunerasi_navigate_form_cb);
  } // do_ajax_form_hrm_periode_remunerasi_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_hrm_periode_remunerasi']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_hrm_periode_remunerasi_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_hrm_periode_remunerasi_navigate_form_cb_after_alert);
  } // do_ajax_form_hrm_periode_remunerasi_navigate_form_cb
  function do_ajax_form_hrm_periode_remunerasi_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_hrm_periode_remunerasi_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_hrm_periode_remunerasi_navigate_form_cb_after_alert
  function sc_hide_form_hrm_periode_remunerasi_form()
  {
