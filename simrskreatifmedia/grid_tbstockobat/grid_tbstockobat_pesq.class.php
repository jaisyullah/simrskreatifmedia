...
class grid_tbstockobat_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockobat']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_tbstockobat_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_tbstockobat_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_tbstockobat_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_currentstock')
      {
          $currentstock = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_currentstock($currentstock);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function lookup_ajax_currentstock($currentstock)
   {
      $currentstock = str_replace($_SESSION['scriptcase']['reg_conf']['grup_num'], "", $currentstock);
      $currentstock = substr($this->Db->qstr($currentstock), 1, -1);
            $currentstock_look = substr($this->Db->qstr($currentstock), 1, -1); 
      $nmgp_def_dados = array(); 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct currentStock from " . $this->Ini->nm_tabela . " where kodeItem = '" . $_SESSION['itemcode'] . "' and   CAST (currentStock AS TEXT)  like '%" . $currentstock . "%' order by currentStock"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct currentStock from " . $this->Ini->nm_tabela . " where kodeItem = '" . $_SESSION['itemcode'] . "' and   CAST (currentStock AS VARCHAR)  like '%" . $currentstock . "%' order by currentStock"; 
      }
      else
      {
          $nm_comando = "select distinct currentStock from " . $this->Ini->nm_tabela . " where kodeItem = '" . $_SESSION['itemcode'] . "' and  currentStock like '%" . $currentstock . "%' order by currentStock"; 
      }
      unset($cmp1,$cmp2);
   ...
   function lookup_ajax_id($id)
   {
      ...
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct id from " . $this->Ini->nm_tabela . " where kodeItem = '" . $_SESSION['itemcode'] . "' and   CAST (id AS TEXT)  like '%" . $id . "%' order by id"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct id from " . $this->Ini->nm_tabela . " where kodeItem = '" . $_SESSION['itemcode'] . "' and   CAST (id AS VARCHAR)  like '%" . $id . "%' order by id"; 
      }
      else
      {
          $nm_comando = "select distinct id from " . $this->Ini->nm_tabela . " where kodeItem = '" . $_SESSION['itemcode'] . "' and  id like '%" . $id . "%' order by id"; 
      }
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
   ...
   function lookup_ajax_kodeitem($kodeitem)
   {
      ...
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct kodeItem from " . $this->Ini->nm_tabela . " where kodeItem = '" . $_SESSION['itemcode'] . "' and  kodeItem like '%" . $kodeitem . "%' order by kodeItem"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $Nm_datas[] = "expDate";$Nm_datas[] = "expDate";
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockobat']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockobat']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockobat']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockobat']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockobat']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockobat']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockobat']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockobat']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockobat']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockobat']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockobat']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockobat']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockobat']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockobat']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockobat']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockobat']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockobat']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - tbstockobat</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_tbstockobat/grid_tbstockobat_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_tbstockobat_ajax_search.js"></script>
 <script type="text/javascript" src="grid_tbstockobat_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_tbstockobat_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_tbstockobat']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_tbstockobat']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_currentstock_cond#NMF#' + search_get_sel_txt('SC_currentstock_cond') + '@NMF@';
  str_out += 'SC_currentstock#NMF#' + search_get_text('SC_currentstock') + '@NMF@';
  str_out += 'id_ac_currentstock#NMF#' + search_get_text('id_ac_currentstock') + '@NMF@';
  ...
  str_out += 'SC_expdate_cond#NMF#' + search_get_sel_txt('SC_expdate_cond') + '@NMF@';
  str_out += 'SC_expdate_dia#NMF#' + search_get_sel_txt('SC_expdate_dia') + '@NMF@';
  str_out += 'SC_expdate_mes#NMF#' + search_get_sel_txt('SC_expdate_mes') + '@NMF@';
  str_out += 'SC_expdate_ano#NMF#' + search_get_sel_txt('SC_expdate_ano') + '@NMF@';
  str_out += 'SC_expdate_input_2_dia#NMF#' + search_get_sel_txt('SC_expdate_input_2_dia') + '@NMF@';
  str_out += 'SC_expdate_input_2_mes#NMF#' + search_get_sel_txt('SC_expdate_input_2_mes') + '@NMF@';
  str_out += 'SC_expdate_input_2_ano#NMF#' + search_get_sel_txt('SC_expdate_input_2_ano') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
   $("#id_ac_currentstock").autocomplete({
     minLength: 1,
     ...
     $.ajax({
       ...
       data: {
          ...
          nmgp_parms: "NM_ajax_opcao?#?autocomp_currentstock",
          max_itens: "10",
          cod_desc: "N",
     ...
     select: function (event, ui) {
       $("#SC_currentstock").val(ui.item.value);
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockobat']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div class="scFilterHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFilterHeaderFont" style="float: left; text-transform: uppercase;"><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - tbstockobat</div>
...
<?php
   ...
   {
      global 
             $currentstock_cond, $currentstock, $currentstock_autocomp,
             $id_cond, $id, $id_autocomp,
             $kodeitem_cond, $kodeitem, $kodeitem_autocomp,
             $expdate_cond, $expdate, $expdate_dia, $expdate_mes, $expdate_ano, $expdate_input_2_dia, $expdate_input_2_mes, $expdate_input_2_ano,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockobat']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockobat']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockobat']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockobat']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $currentstock = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockobat']['campos_busca']['currentstock']; 
          $currentstock_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockobat']['campos_busca']['currentstock_cond']; 
          $id = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockobat']['campos_busca']['id']; 
          $id_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockobat']['campos_busca']['id_cond']; 
          $kodeitem = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockobat']['campos_busca']['kodeitem']; 
          $kodeitem_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockobat']['campos_busca']['kodeitem_cond']; 
          $expdate_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockobat']['campos_busca']['expdate_dia']; 
          $expdate_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockobat']['campos_busca']['expdate_mes']; 
          $expdate_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockobat']['campos_busca']['expdate_ano']; 
          $expdate_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockobat']['campos_busca']['expdate_input_2_dia']; 
          $expdate_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockobat']['campos_busca']['expdate_input_2_mes']; 
          $expdate_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockobat']['campos_busca']['expdate_input_2_ano']; 
          $expdate_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockobat']['campos_busca']['expdate_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockobat']['campos_busca']['NM_operador']; 
      } 
      if (!isset($currentstock_cond) || empty($currentstock_cond))
      {
         $currentstock_cond = "gt";
      }
      ...
      if (!isset($expdate_cond) || empty($expdate_cond))
      {
         $expdate_cond = "eq";
      }
      ...
      $str_hide_currentstock = (in_array($currentstock_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      $str_hide_expdate = (in_array($expdate_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      $str_display_currentstock = ('bw' == $currentstock_cond) ? $display_aberto : $display_fechado;
      $str_display_id = ('bw' == $id_cond) ? $display_aberto : $display_fechado;
      $str_display_kodeitem = ('bw' == $kodeitem_cond) ? $display_aberto : $display_fechado;
      $str_display_expdate = ('bw' == $expdate_cond) ? $display_aberto : $display_fechado;

      if (!isset($currentstock) || $currentstock == "")
      {
          $currentstock = "";
      }
      if (isset($currentstock) && !empty($currentstock))
      {
         $tmp_pos = strpos($currentstock, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $currentstock = substr($currentstock, 0, $tmp_pos);
         }
      }
      if (!isset($id) || $id == "")
      {
      ...
      {
         $tmp_pos = strpos($expdate, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $expdate = substr($expdate, 0, $tmp_pos);
         }
      }
?>
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_currentstock_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['currentstock'])) ? $this->New_label['currentstock'] : "Current Stock"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_currentstock_cond" name="currentstock_cond" onChange="nm_campos_between(document.getElementById('id_vis_currentstock'), this, 'currentstock')">
       <OPTION value="gt" <?php if ("gt" == $currentstock_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $currentstock_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $currentstock_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_currentstock" <?php echo $str_hide_currentstock?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['currentstock'])) ? $this->New_label['currentstock'] : "Current Stock";
 $nmgp_tab_label .= "currentstock?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
...
<?php
   ...
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct currentStock from " . $this->Ini->nm_tabela . " where kodeItem = '" . $_SESSION['itemcode'] . "' and currentStock = $currentstock_look order by currentStock"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct currentStock from " . $this->Ini->nm_tabela . " where kodeItem = '" . $_SESSION['itemcode'] . "' and currentStock = $currentstock_look order by currentStock"; 
      ...
      if (isset($nmgp_def_dados[0][$currentstock]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$currentstock];
      }
      else
      {
            nmgp_Form_Num_Val($currentstock, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          $sAutocompValue = $currentstock;
      }
?>
<INPUT  type="text" id="SC_currentstock" name="currentstock" value="<?php echo NM_encode_input($currentstock) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_currentstock" name="currentstock_autocomp" size="11"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
...
<?php
   ...
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct id from " . $this->Ini->nm_tabela . " where kodeItem = '" . $_SESSION['itemcode'] . "' and id = $id_look order by id"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct id from " . $this->Ini->nm_tabela . " where kodeItem = '" . $_SESSION['itemcode'] . "' and id = $id_look order by id"; 
...
<?php
      ...
      $kodeitem_look = substr($this->Db->qstr($kodeitem), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct kodeItem from " . $this->Ini->nm_tabela . " where kodeItem = '" . $_SESSION['itemcode'] . "' and kodeItem = '$kodeitem_look' order by kodeItem"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_kodeitem" name="kodeitem_autocomp" size="10"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 10, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_expdate_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['expdate'])) ? $this->New_label['expdate'] : "Exp Date"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_expdate_cond" name="expdate_cond" onChange="nm_campos_between(document.getElementById('id_vis_expdate'), this, 'expdate')">
       <OPTION value="eq" <?php if ("eq" == $expdate_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="gt" <?php if ("gt" == $expdate_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $expdate_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $expdate_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_expdate" <?php echo $str_hide_expdate?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['expdate'])) ? $this->New_label['expdate'] : "Exp Date";
 $nmgp_tab_label .= "expdate?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
  ...
  {
?>
<span id='id_date_part_expdate_DD' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_expdate_dia" name="expdate_dia" value="<?php echo NM_encode_input($expdate_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_expdate_MM' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_expdate_mes" name="expdate_mes" value="<?php echo NM_encode_input($expdate_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_expdate_AAAA' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_expdate_ano" name="expdate_ano" value="<?php echo NM_encode_input($expdate_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 </span>
...
?>
        <SPAN id="id_css_expdate"  class="scFilterFieldFontEven">
 <?php echo $date_format_show ?>         </SPAN>
                 </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_expdate"  <?php echo $str_display_expdate; ?> class="scFilterFieldFontEven">
...
<?php
  ...
  {
?>
<span id='id_date_part_expdate_input_2_DD' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_expdate_input_2_dia" name="expdate_input_2_dia" value="<?php echo NM_encode_input($expdate_input_2_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_expdate_input_2_MM' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_expdate_input_2_mes" name="expdate_input_2_mes" value="<?php echo NM_encode_input($expdate_input_2_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_expdate_input_2_AAAA' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_expdate_input_2_ano" name="expdate_input_2_ano" value="<?php echo NM_encode_input($expdate_input_2_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 </span>
...
?>
<?php
   if (is_file("grid_tbstockobat_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_tbstockobat']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_tbstockobat']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockobat']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.currentstock_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_currentstock'), document.F1.currentstock_cond, 'currentstock');
   document.F1.currentstock.value = "";
   document.F1.currentstock_autocomp.value = "";
   ...
   document.F1.expdate_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_expdate'), document.F1.expdate_cond, 'expdate');
   document.F1.expdate_dia.value = "";
   document.F1.expdate_mes.value = "";
   document.F1.expdate_ano.value = "";
   document.F1.expdate_input_2_dia.value = "";
   document.F1.expdate_input_2_mes.value = "";
   document.F1.expdate_input_2_ano.value = "";
 }
 function SC_carga_evt_jquery()
 {
    $('#SC_expdate_dia').bind('change', function() {sc_grid_tbstockobat_valida_dia(this)});
    $('#SC_expdate_input_2_dia').bind('change', function() {sc_grid_tbstockobat_valida_dia(this)});
    $('#SC_expdate_input_2_mes').bind('change', function() {sc_grid_tbstockobat_valida_mes(this)});
    $('#SC_expdate_mes').bind('change', function() {sc_grid_tbstockobat_valida_mes(this)});
 }
 function sc_grid_tbstockobat_valida_dia(obj)
 {
 ...
 function sc_grid_tbstockobat_valida_mes(obj)
 {
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "simrskreatifmedia/grid_tbstockobat";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockobat']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockobat']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockobat']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_currentstock_cond'] = 'cond';
      $tp_fields['SC_currentstock'] = 'text_aut';
      $tp_fields['id_ac_currentstock'] = 'text_aut';
      ...
      $tp_fields['SC_expdate_cond'] = 'cond';
      $tp_fields['SC_expdate_dia'] = 'text';
      $tp_fields['SC_expdate_mes'] = 'text';
      $tp_fields['SC_expdate_ano'] = 'text';
      $tp_fields['SC_expdate_input_2_dia'] = 'text';
      $tp_fields['SC_expdate_input_2_mes'] = 'text';
      $tp_fields['SC_expdate_input_2_ano'] = 'text';
   ...
   {
      global $currentstock_cond, $currentstock, $currentstock_autocomp,
             $id_cond, $id, $id_autocomp,
             $kodeitem_cond, $kodeitem, $kodeitem_autocomp,
             $expdate_cond, $expdate, $expdate_dia, $expdate_mes, $expdate_ano, $expdate_input_2_dia, $expdate_input_2_mes, $expdate_input_2_ano, $nmgp_tab_label;

      $C_formatado = true;
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_conv_dados.php", "F", "nm_conv_limpa_dado") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
      if (!empty($currentstock_autocomp) && empty($currentstock))
      {
          $currentstock = $currentstock_autocomp;
      }
      ...
      $currentstock_cond_salva = $currentstock_cond; 
      if (!isset($currentstock_input_2) || $currentstock_input_2 == "")
      {
          $currentstock_input_2 = $currentstock;
      }
      ...
      $expdate_cond_salva = $expdate_cond; 
      if (!isset($expdate_input_2_dia) || $expdate_input_2_dia == "")
      {
          $expdate_input_2_dia = $expdate_dia;
      }
      if (!isset($expdate_input_2_mes) || $expdate_input_2_mes == "")
      {
          $expdate_input_2_mes = $expdate_mes;
      }
      if (!isset($expdate_input_2_ano) || $expdate_input_2_ano == "")
      {
          $expdate_input_2_ano = $expdate_ano;
      }
      if ($currentstock_cond != "in")
      {
          nm_limpa_numero($currentstock, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($id_cond != "in")
      {
          nm_limpa_numero($id, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockobat']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockobat']['campos_busca']['currentstock'] = $currentstock; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockobat']['campos_busca']['currentstock_cond'] = $currentstock_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockobat']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockobat']['campos_busca']['id'] = $id; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockobat']['campos_busca']['id_cond'] = $id_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockobat']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockobat']['campos_busca']['kodeitem'] = $kodeitem; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockobat']['campos_busca']['kodeitem_cond'] = $kodeitem_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockobat']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockobat']['campos_busca']['expdate_dia'] = $expdate_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockobat']['campos_busca']['expdate_mes'] = $expdate_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockobat']['campos_busca']['expdate_ano'] = $expdate_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockobat']['campos_busca']['expdate_input_2_dia'] = $expdate_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockobat']['campos_busca']['expdate_input_2_mes'] = $expdate_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockobat']['campos_busca']['expdate_input_2_ano'] = $expdate_input_2_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockobat']['campos_busca']['expdate_cond'] = $expdate_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockobat']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockobat']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockobat']['campos_busca'] = $Temp_Busca;
      }
      if ($currentstock_cond != "in" && $currentstock_cond != "bw" && !empty($currentstock) && !is_numeric($currentstock))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Current Stock";
      }
      if ($currentstock_cond == "bw" && ((!empty($currentstock) && !is_numeric($currentstock)) || (!empty($currentstock_input_2) && !is_numeric($currentstock_input_2)) ))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Current Stock";
      }
   ...
   { 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['currentstock'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['currentstock'] = $cmp1;
      }
      else
      {
          $cmp1 = $currentstock;
   ...
   { 
      ...
      if (isset($currentstock) || $currentstock_cond == "nu" || $currentstock_cond == "nn" || $currentstock_cond == "ep" || $currentstock_cond == "ne")
      {
         $this->monta_condicao("currentStock", $currentstock_cond, $currentstock, "", "currentstock");
      }
      ...
      //----- $expdate
      $this->Date_part = false;
      if ($expdate_cond != "bi_TP")
      {
          $expdate_cond = strtoupper($expdate_cond);
          $Dtxt = "";
          $val  = array();
          $Dtxt .= $expdate_ano;
          $Dtxt .= $expdate_mes;
          $Dtxt .= $expdate_dia;
          $val[0]['ano'] = $expdate_ano;
          $val[0]['mes'] = $expdate_mes;
          $val[0]['dia'] = $expdate_dia;
          if ($expdate_cond == "BW")
          {
              $val[1]['ano'] = $expdate_input_2_ano;
              $val[1]['mes'] = $expdate_input_2_mes;
              $val[1]['dia'] = $expdate_input_2_dia;
          }
          $this->Operador_date_part = "";
          $this->Lang_date_part     = "";
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_oracle))
          {
              $this->nm_prep_date($val, "DT", "DATETIME", $expdate_cond, "", "data");
          }
          else
          {
              $this->nm_prep_date($val, "DT", "DATE", $expdate_cond, "", "data");
          }
          if (!$this->Date_part) {
              $val[0] = $this->Ini->sc_Date_Protect($val[0]);
          }
          $expdate = $val[0];
          $this->cmp_formatado['expdate'] = $val[0];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockobat']['campos_busca']['expdate'] = $val[0];
          $this->nm_data->SetaData($this->cmp_formatado['expdate'], "YYYY-MM-DD");
          $this->cmp_formatado['expdate'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DT", "dmY"));
          if ($expdate_cond == "BW")
          {
              if (!$this->Date_part) {
                  $val[1] = $this->Ini->sc_Date_Protect($val[1]);
              }
              $expdate_input_2     = $val[1];
              $this->cmp_formatado['expdate_input_2'] = $val[1];
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockobat']['campos_busca']['expdate_input_2'] = $val[1];
              $this->nm_data->SetaData($this->cmp_formatado['expdate_input_2'], "YYYY-MM-DD");
              $this->cmp_formatado['expdate_input_2'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DT", "dmY"));
          }
          if (!empty($Dtxt) || $expdate_cond == "NU" || $expdate_cond == "NN"|| $expdate_cond == "EP"|| $expdate_cond == "NE")
          {
              $this->monta_condicao("expDate", $expdate_cond, $expdate, $expdate_input_2, 'expdate', 'DATE');
          }
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockobat']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockobat']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockobat']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockobat']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockobat']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockobat']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockobat']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockobat']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbstockobat']['cond_pesq'] .= $this->NM_operador;
