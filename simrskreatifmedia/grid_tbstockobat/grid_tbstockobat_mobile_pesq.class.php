...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "expDate";$Nm_datas[] = "expDate";$Nm_numeric[] = "id";$Nm_numeric[] = "currentstock";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_currentstock_cond" name="currentstock_cond" onChange="nm_campos_between(document.getElementById('id_vis_currentstock'), this, 'currentstock')">
      ...
      <br><span id="id_hide_currentstock"  <?php echo $str_hide_currentstock?>><?php
      if ($currentstock != "")
      {
      $currentstock_look = substr($this->Db->qstr($currentstock), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_expdate_cond" name="expdate_cond" onChange="nm_campos_between(document.getElementById('id_vis_expdate'), this, 'expdate')">
      ...
      <br><span id="id_hide_expdate"  <?php echo $str_hide_expdate?>>
<?php
  $Form_base = "ddmmyyyy";
  $date_format_show = "";
...
?>
 ...
 <?php echo $date_format_show ?>         </SPAN>
                  <br />
        <SPAN id="id_vis_expdate"  <?php echo $str_display_expdate; ?> class="scFilterFieldFontEven">
