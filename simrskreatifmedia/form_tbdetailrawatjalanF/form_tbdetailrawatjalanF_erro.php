...
$old_error_handler = set_error_handler("form_tbdetailrawatjalanF_scriptcase_error_handler");

function form_tbdetailrawatjalanF_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['form_tbdetailrawatjalanF']['contr_erro']) && $_SESSION['scriptcase']['form_tbdetailrawatjalanF']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_form_tbdetailrawatjalanF->contr_form_tbdetailrawatjalanF->Apl_com_erro = true;
            if ($inicial_form_tbdetailrawatjalanF->contr_form_tbdetailrawatjalanF->NM_ajax_flag)
            {
                $inicial_form_tbdetailrawatjalanF->contr_form_tbdetailrawatjalanF->NM_ajax_info['errList']['geral_form_tbdetailrawatjalanF'][] = $msg;
                return;
            }
            form_tbdetailrawatjalanF_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function form_tbdetailrawatjalanF_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['form_tbdetailrawatjalanF'])  && '' != $_SESSION['scriptcase']['error_icon']['form_tbdetailrawatjalanF'])  ? $_SESSION['scriptcase']['error_icon']['form_tbdetailrawatjalanF']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['form_tbdetailrawatjalanF']) && '' != $_SESSION['scriptcase']['error_span_title']['form_tbdetailrawatjalanF']) ? $_SESSION['scriptcase']['error_span_title']['form_tbdetailrawatjalanF'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['form_tbdetailrawatjalanF']) && '' != $_SESSION['scriptcase']['error_icon_title']['form_tbdetailrawatjalanF']) ? $_SESSION['scriptcase']['error_icon_title']['form_tbdetailrawatjalanF'] : '';
?>
