<form name="F2" method=post 
               action="./" 
               target="_self"> 
<input type="hidden" name="nostruk" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['nostruk']); ?>">
...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailrawatjalanF']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
  <input type="hidden" name="script_case_session" value="<?php echo $this->form_encode_input(session_id()); ?>"> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_tbdetailrawatjalanF"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
?> 
var var_btn_sc_btn_0_var_rmrj = "<?php echo $this->form_encode_input($this->nmgp_dados_form['custcode']); ?>";
...
{
  nm_gp_submit('<?php echo $this->Ini->link_historiRJ_cons; ?>', '<?php echo $this->nm_location; ?>', '<?php echo "var_rmrj*scin' + var_btn_sc_btn_0_var_rmrj + '*scout"; ?>', 'inicio', '_blank', '0', '0', 'historiRJ');
}
var var_btn_sc_btn_1_struknya = "<?php echo $this->form_encode_input($this->nmgp_dados_form['nostruk']); ?>";
...
{
  nm_gp_submit('<?php echo $this->Ini->link_copy_resep; ?>', '<?php echo $this->nm_location; ?>', '<?php echo "struknya*scin' + var_btn_sc_btn_1_struknya + '*scout"; ?>', '', '_blank', '0', '0', 'copy_resep');
}
var var_btn_sc_btn_2_struknya = "<?php echo $this->form_encode_input($this->nmgp_dados_form['trancode']); ?>";
...
{
  nm_gp_submit('<?php echo $this->Ini->link_obat_rajal; ?>', '<?php echo $this->nm_location; ?>', '<?php echo "struknya*scin' + var_btn_sc_btn_2_struknya + '*scout"; ?>', '', '_blank', '0', '0', 'obat_rajal');
}
 NM_tp_critica(1);
...
{ 
   var sob_iframe = '';
<?php 
if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailrawatjalanF']['embutida_form']) {
...
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailrawatjalanF']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailrawatjalanF']['sc_modal']) {
    echo "   sob_iframe += 'parent.';\r\n";
}
?>
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdetailrawatjalanF']['where_detal']))
  {
?>  
...
{
   nm_field_disabled("hta=disabled;tp=disabled;uk=disabled", "");
   nm_field_disabled("tglkeluar=disabled;carakeluar=disabled;alasankeluar=disabled", "I");
   nm_field_disabled("trancode=disabled", "U");
