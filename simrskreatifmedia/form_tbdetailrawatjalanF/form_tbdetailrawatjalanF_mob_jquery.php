...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_tglkeluar_hora' + iSeqRow).bind('blur', function() { sc_form_tbdetailrawatjalanF_tglkeluar_onblur(this, iSeqRow) })
                                            .bind('focus', function() { sc_form_tbdetailrawatjalanF_tglkeluar_onfocus(this, iSeqRow) });
...
function displayChange_field_resep(row, status) {
	if ("on" == status && typeof $("#nmsc_iframe_liga_form_tbreseprawatjalanF_mob")[0].contentWindow.scRecreateSelect2 === "function") {
		$("#nmsc_iframe_liga_form_tbreseprawatjalanF_mob")[0].contentWindow.scRecreateSelect2();
	}
}

function displayChange_field_racikan(row, status) {
	if ("on" == status && typeof $("#nmsc_iframe_liga_form_tbracikan_mob")[0].contentWindow.scRecreateSelect2 === "function") {
		$("#nmsc_iframe_liga_form_tbracikan_mob")[0].contentWindow.scRecreateSelect2();
	}
}
...
function scHidePage(pageNo) {
	$("#id_form_tbdetailrawatjalanF_mob_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_tglkeluar" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_tbdetailrawatjalanF_mob_validate_tglkeluar(iSeqRow);
    },
    numberOfMonths: 1,
    changeMonth: true,
    changeYear: true,
