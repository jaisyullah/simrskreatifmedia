<?php
@session_start() ;
$_SESSION['scriptcase']['grid_detailresepinapF']['sc_process_barr'] = true;
require_once('../grid_detailresepinapF/index.php');
unset($_SESSION['scriptcase']['grid_detailresepinapF']['sc_process_barr']);
$ExportCtrl = new grid_detailresepinapF_export_control;
$ExportCtrl->Export_barr();

class grid_detailresepinapF_export_control
{
