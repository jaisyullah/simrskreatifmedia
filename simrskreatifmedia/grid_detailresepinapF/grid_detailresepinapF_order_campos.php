...
<?php
   ...
   $Ord_Cmp = new grid_detailresepinapF_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_detailresepinapF_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_detailresepinapF']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_detailresepinapF']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["item"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detailresepinapF']['labels']["item"])) ? $_SESSION['sc_session'][$sc_init]['grid_detailresepinapF']['labels']["item"] : "Item";
   $tab_ger_campos['jumlah'] = "on";
   $tab_def_campos['jumlah'] = "jumlah";
   $tab_labels["jumlah"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detailresepinapF']['labels']["jumlah"])) ? $_SESSION['sc_session'][$sc_init]['grid_detailresepinapF']['labels']["jumlah"] : "Jumlah";
   $tab_ger_campos['satuan'] = "on";
   $tab_def_campos['satuan'] = "satuan";
   $tab_labels["satuan"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detailresepinapF']['labels']["satuan"])) ? $_SESSION['sc_session'][$sc_init]['grid_detailresepinapF']['labels']["satuan"] : "Satuan";
   $tab_ger_campos['biaya'] = "on";
   $tab_def_campos['biaya'] = "biaya";
   $tab_labels["biaya"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detailresepinapF']['labels']["biaya"])) ? $_SESSION['sc_session'][$sc_init]['grid_detailresepinapF']['labels']["biaya"] : "Biaya";
   $tab_ger_campos['diskon'] = "on";
   $tab_def_campos['diskon'] = "diskon";
   $tab_labels["diskon"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detailresepinapF']['labels']["diskon"])) ? $_SESSION['sc_session'][$sc_init]['grid_detailresepinapF']['labels']["diskon"] : "Diskon";
   $tab_ger_campos['signa'] = "on";
   $tab_def_campos['signa'] = "signa";
   $tab_labels["signa"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detailresepinapF']['labels']["signa"])) ? $_SESSION['sc_session'][$sc_init]['grid_detailresepinapF']['labels']["signa"] : "Signa";
   $tab_ger_campos['edit'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['edit'] = "edit";
   }
   else
   {
       $tab_def_campos['edit'] = "";
   }
   $tab_labels["edit"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detailresepinapF']['labels']["edit"])) ? $_SESSION['sc_session'][$sc_init]['grid_detailresepinapF']['labels']["edit"] : "Edit";
   $tab_ger_campos['edit'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_detailresepinapF']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_detailresepinapF']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_detailresepinapF']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_detailresepinapF']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_detailresepinapF']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_detailresepinapF']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_detailresepinapF']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_detailresepinapF']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_detailresepinapF']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_detailresepinapF_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_detailresepinapF']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_detailresepinapF']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_detailresepinapF']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_detailresepinapF']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_detailresepinapF']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
