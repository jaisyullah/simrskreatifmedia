...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "id";$Nm_numeric[] = "jumlah";$Nm_numeric[] = "biaya";$Nm_numeric[] = "diskon";$Nm_numeric[] = "id";$Nm_numeric[] = "jumlah";$Nm_numeric[] = "biaya";$Nm_numeric[] = "diskon";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_satuan_cond" name="satuan_cond" onChange="nm_campos_between(document.getElementById('id_vis_satuan'), this, 'satuan')">
