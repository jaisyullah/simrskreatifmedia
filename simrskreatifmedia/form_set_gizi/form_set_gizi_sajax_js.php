  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_set_gizi" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_set_gizi_form();
	}

  // ---------- Validate gizi
  function do_ajax_form_set_gizi_validate_gizi()
  {
    var nomeCampo_gizi = "gizi";
    var var_gizi = scAjaxGetFieldText(nomeCampo_gizi);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_set_gizi_validate_gizi(var_gizi, var_script_case_init, do_ajax_form_set_gizi_validate_gizi_cb);
  } // do_ajax_form_set_gizi_validate_gizi

  function do_ajax_form_set_gizi_validate_gizi_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_set_gizi_validate_gizi_cb

  // ---------- Validate jadwal
  function do_ajax_form_set_gizi_validate_jadwal()
  {
    var nomeCampo_jadwal = "jadwal";
    var var_jadwal = scAjaxGetFieldSelect(nomeCampo_jadwal);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_set_gizi_validate_jadwal(var_jadwal, var_script_case_init, do_ajax_form_set_gizi_validate_jadwal_cb);
  } // do_ajax_form_set_gizi_validate_jadwal

  function do_ajax_form_set_gizi_validate_jadwal_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "jadwal";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_set_gizi_validate_jadwal_cb

  // ---------- Validate mp
  function do_ajax_form_set_gizi_validate_mp()
  {
    var nomeCampo_mp = "mp";
    var var_mp = scAjaxGetFieldText(nomeCampo_mp);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_set_gizi_validate_mp(var_mp, var_script_case_init, do_ajax_form_set_gizi_validate_mp_cb);
  } // do_ajax_form_set_gizi_validate_mp

  function do_ajax_form_set_gizi_validate_mp_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "mp";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_set_gizi_validate_mp_cb

  // ---------- Validate ln
  function do_ajax_form_set_gizi_validate_ln()
  {
    var nomeCampo_ln = "ln";
    var var_ln = scAjaxGetFieldText(nomeCampo_ln);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_set_gizi_validate_ln(var_ln, var_script_case_init, do_ajax_form_set_gizi_validate_ln_cb);
  } // do_ajax_form_set_gizi_validate_ln

  function do_ajax_form_set_gizi_validate_ln_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ln";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_set_gizi_validate_ln_cb

  // ---------- Validate lh
  function do_ajax_form_set_gizi_validate_lh()
  {
    var nomeCampo_lh = "lh";
    var var_lh = scAjaxGetFieldText(nomeCampo_lh);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_set_gizi_validate_lh(var_lh, var_script_case_init, do_ajax_form_set_gizi_validate_lh_cb);
  } // do_ajax_form_set_gizi_validate_lh

  function do_ajax_form_set_gizi_validate_lh_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "lh";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_set_gizi_validate_lh_cb

  // ---------- Validate syr
  function do_ajax_form_set_gizi_validate_syr()
  {
    var nomeCampo_syr = "syr";
    var var_syr = scAjaxGetFieldText(nomeCampo_syr);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_set_gizi_validate_syr(var_syr, var_script_case_init, do_ajax_form_set_gizi_validate_syr_cb);
  } // do_ajax_form_set_gizi_validate_syr

  function do_ajax_form_set_gizi_validate_syr_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "syr";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_set_gizi_validate_syr_cb

  // ---------- Validate ekstra
  function do_ajax_form_set_gizi_validate_ekstra()
  {
    var nomeCampo_ekstra = "ekstra";
    var var_ekstra = scAjaxGetFieldText(nomeCampo_ekstra);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_set_gizi_validate_ekstra(var_ekstra, var_script_case_init, do_ajax_form_set_gizi_validate_ekstra_cb);
  } // do_ajax_form_set_gizi_validate_ekstra

  function do_ajax_form_set_gizi_validate_ekstra_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ekstra";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_set_gizi_validate_ekstra_cb

  // ---------- Validate buah
  function do_ajax_form_set_gizi_validate_buah()
  {
    var nomeCampo_buah = "buah";
    var var_buah = scAjaxGetFieldText(nomeCampo_buah);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_set_gizi_validate_buah(var_buah, var_script_case_init, do_ajax_form_set_gizi_validate_buah_cb);
  } // do_ajax_form_set_gizi_validate_buah

  function do_ajax_form_set_gizi_validate_buah_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "buah";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_set_gizi_validate_buah_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_set_gizi_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_set_gizi_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_set_gizi_submit_form(var_gizi, var_jadwal, var_mp, var_ln, var_lh, var_syr, var_ekstra, var_buah, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_set_gizi_submit_form_cb);
  } // do_ajax_form_set_gizi_submit_form

  function do_ajax_form_set_gizi_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_set_gizi_submit_form_cb_after_alert);
  } // do_ajax_form_set_gizi_submit_form_cb
  function do_ajax_form_set_gizi_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_set_gizi_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_set_gizi_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_set_gizi_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_set_gizi_navigate_form_cb);
  } // do_ajax_form_set_gizi_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_set_gizi']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_set_gizi_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_set_gizi_navigate_form_cb_after_alert);
  } // do_ajax_form_set_gizi_navigate_form_cb
  function do_ajax_form_set_gizi_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_set_gizi_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_set_gizi_navigate_form_cb_after_alert
  function sc_hide_form_set_gizi_form()
  {
