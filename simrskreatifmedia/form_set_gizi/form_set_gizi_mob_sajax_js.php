  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_set_gizi_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_set_gizi_mob_form();
	}

  // ---------- Validate gizi
  function do_ajax_form_set_gizi_mob_validate_gizi()
  {
    var nomeCampo_gizi = "gizi";
    var var_gizi = scAjaxGetFieldText(nomeCampo_gizi);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_set_gizi_mob_validate_gizi(var_gizi, var_script_case_init, do_ajax_form_set_gizi_mob_validate_gizi_cb);
  } // do_ajax_form_set_gizi_mob_validate_gizi

  function do_ajax_form_set_gizi_mob_validate_gizi_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_set_gizi_mob_validate_gizi_cb

  // ---------- Validate jadwal
  function do_ajax_form_set_gizi_mob_validate_jadwal()
  {
    var nomeCampo_jadwal = "jadwal";
    var var_jadwal = scAjaxGetFieldSelect(nomeCampo_jadwal);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_set_gizi_mob_validate_jadwal(var_jadwal, var_script_case_init, do_ajax_form_set_gizi_mob_validate_jadwal_cb);
  } // do_ajax_form_set_gizi_mob_validate_jadwal

  function do_ajax_form_set_gizi_mob_validate_jadwal_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "jadwal";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_set_gizi_mob_validate_jadwal_cb

  // ---------- Validate mp
  function do_ajax_form_set_gizi_mob_validate_mp()
  {
    var nomeCampo_mp = "mp";
    var var_mp = scAjaxGetFieldText(nomeCampo_mp);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_set_gizi_mob_validate_mp(var_mp, var_script_case_init, do_ajax_form_set_gizi_mob_validate_mp_cb);
  } // do_ajax_form_set_gizi_mob_validate_mp

  function do_ajax_form_set_gizi_mob_validate_mp_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "mp";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_set_gizi_mob_validate_mp_cb

  // ---------- Validate ln
  function do_ajax_form_set_gizi_mob_validate_ln()
  {
    var nomeCampo_ln = "ln";
    var var_ln = scAjaxGetFieldText(nomeCampo_ln);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_set_gizi_mob_validate_ln(var_ln, var_script_case_init, do_ajax_form_set_gizi_mob_validate_ln_cb);
  } // do_ajax_form_set_gizi_mob_validate_ln

  function do_ajax_form_set_gizi_mob_validate_ln_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ln";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_set_gizi_mob_validate_ln_cb

  // ---------- Validate lh
  function do_ajax_form_set_gizi_mob_validate_lh()
  {
    var nomeCampo_lh = "lh";
    var var_lh = scAjaxGetFieldText(nomeCampo_lh);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_set_gizi_mob_validate_lh(var_lh, var_script_case_init, do_ajax_form_set_gizi_mob_validate_lh_cb);
  } // do_ajax_form_set_gizi_mob_validate_lh

  function do_ajax_form_set_gizi_mob_validate_lh_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "lh";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_set_gizi_mob_validate_lh_cb

  // ---------- Validate syr
  function do_ajax_form_set_gizi_mob_validate_syr()
  {
    var nomeCampo_syr = "syr";
    var var_syr = scAjaxGetFieldText(nomeCampo_syr);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_set_gizi_mob_validate_syr(var_syr, var_script_case_init, do_ajax_form_set_gizi_mob_validate_syr_cb);
  } // do_ajax_form_set_gizi_mob_validate_syr

  function do_ajax_form_set_gizi_mob_validate_syr_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "syr";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_set_gizi_mob_validate_syr_cb

  // ---------- Validate ekstra
  function do_ajax_form_set_gizi_mob_validate_ekstra()
  {
    var nomeCampo_ekstra = "ekstra";
    var var_ekstra = scAjaxGetFieldText(nomeCampo_ekstra);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_set_gizi_mob_validate_ekstra(var_ekstra, var_script_case_init, do_ajax_form_set_gizi_mob_validate_ekstra_cb);
  } // do_ajax_form_set_gizi_mob_validate_ekstra

  function do_ajax_form_set_gizi_mob_validate_ekstra_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ekstra";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_set_gizi_mob_validate_ekstra_cb

  // ---------- Validate buah
  function do_ajax_form_set_gizi_mob_validate_buah()
  {
    var nomeCampo_buah = "buah";
    var var_buah = scAjaxGetFieldText(nomeCampo_buah);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_set_gizi_mob_validate_buah(var_buah, var_script_case_init, do_ajax_form_set_gizi_mob_validate_buah_cb);
  } // do_ajax_form_set_gizi_mob_validate_buah

  function do_ajax_form_set_gizi_mob_validate_buah_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "buah";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_set_gizi_mob_validate_buah_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_set_gizi_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_set_gizi_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_gizi = scAjaxGetFieldText("gizi");
    var var_jadwal = scAjaxGetFieldSelect("jadwal");
    var var_mp = scAjaxGetFieldText("mp");
    var var_ln = scAjaxGetFieldText("ln");
    var var_lh = scAjaxGetFieldText("lh");
    var var_syr = scAjaxGetFieldText("syr");
    var var_ekstra = scAjaxGetFieldText("ekstra");
    var var_buah = scAjaxGetFieldText("buah");
    ...
    scAjaxProcOn();
    x_ajax_form_set_gizi_mob_submit_form(var_gizi, var_jadwal, var_mp, var_ln, var_lh, var_syr, var_ekstra, var_buah, var_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_set_gizi_mob_submit_form_cb);
  } // do_ajax_form_set_gizi_mob_submit_form

  function do_ajax_form_set_gizi_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("gizi");
      scAjaxHideErrorDisplay("jadwal");
      scAjaxHideErrorDisplay("mp");
      scAjaxHideErrorDisplay("ln");
      scAjaxHideErrorDisplay("lh");
      scAjaxHideErrorDisplay("syr");
      scAjaxHideErrorDisplay("ekstra");
      scAjaxHideErrorDisplay("buah");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_set_gizi_mob_submit_form_cb_after_alert);
  } // do_ajax_form_set_gizi_mob_submit_form_cb
  function do_ajax_form_set_gizi_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_set_gizi_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_set_gizi_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_set_gizi_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_set_gizi_mob_navigate_form_cb);
  } // do_ajax_form_set_gizi_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_set_gizi_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_set_gizi_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_set_gizi_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_set_gizi_mob_navigate_form_cb
  function do_ajax_form_set_gizi_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_set_gizi_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_set_gizi_mob_navigate_form_cb_after_alert
  function sc_hide_form_set_gizi_mob_form()
  {
  ...
  ajax_field_list[0] = "gizi";
  ajax_field_list[1] = "jadwal";
  ajax_field_list[2] = "mp";
  ajax_field_list[3] = "ln";
  ajax_field_list[4] = "lh";
  ajax_field_list[5] = "syr";
  ajax_field_list[6] = "ekstra";
  ajax_field_list[7] = "buah";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "gizi": {"label": "Gizi", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "jadwal": {"label": "Jadwal", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "mp": {"label": "MP", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "ln": {"label": "LN", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "lh": {"label": "LH", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "syr": {"label": "Syr", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "ekstra": {"label": "Ekstra", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "buah": {"label": "Buah", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  ajax_field_mult["gizi"][1] = "gizi";
  ajax_field_mult["jadwal"][1] = "jadwal";
  ajax_field_mult["mp"][1] = "mp";
  ajax_field_mult["ln"][1] = "ln";
  ajax_field_mult["lh"][1] = "lh";
  ajax_field_mult["syr"][1] = "syr";
  ajax_field_mult["ekstra"][1] = "ekstra";
  ajax_field_mult["buah"][1] = "buah";

  var ajax_field_id = {
    "gizi": new Array("hidden_field_label_gizi", "hidden_field_data_gizi"),
    "jadwal": new Array("hidden_field_label_jadwal", "hidden_field_data_jadwal"),
    "mp": new Array("hidden_field_label_mp", "hidden_field_data_mp"),
    "ln": new Array("hidden_field_label_ln", "hidden_field_data_ln"),
    "lh": new Array("hidden_field_label_lh", "hidden_field_data_lh"),
    "syr": new Array("hidden_field_label_syr", "hidden_field_data_syr"),
    "ekstra": new Array("hidden_field_label_ekstra", "hidden_field_data_ekstra"),
    "buah": new Array("hidden_field_label_buah", "hidden_field_data_buah")
  };
