...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "id";$Nm_numeric[] = "tunj_masa_kerja";$Nm_numeric[] = "lembur";$Nm_numeric[] = "insentif";$Nm_numeric[] = "periode_remunerasi";$Nm_numeric[] = "id_karyawan";$Nm_numeric[] = "id";$Nm_numeric[] = "tunj_masa_kerja";$Nm_numeric[] = "lembur";$Nm_numeric[] = "insentif";$Nm_numeric[] = "periode_remunerasi";$Nm_numeric[] = "id_karyawan";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_insentif_cond" name="insentif_cond" onChange="nm_campos_between(document.getElementById('id_vis_insentif'), this, 'insentif')">
      ...
      <br><span id="id_hide_insentif"  <?php echo $str_hide_insentif?>><?php
      if ($insentif != "")
      {
      $insentif_look = substr($this->Db->qstr($insentif), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_tunj_masa_kerja_cond" name="tunj_masa_kerja_cond" onChange="nm_campos_between(document.getElementById('id_vis_tunj_masa_kerja'), this, 'tunj_masa_kerja')">
      ...
      <br><span id="id_hide_tunj_masa_kerja"  <?php echo $str_hide_tunj_masa_kerja?>><?php
      if ($tunj_masa_kerja != "")
      {
      $tunj_masa_kerja_look = substr($this->Db->qstr($tunj_masa_kerja), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_lembur_cond" name="lembur_cond" onChange="nm_campos_between(document.getElementById('id_vis_lembur'), this, 'lembur')">
      ...
      <br><span id="id_hide_lembur"  <?php echo $str_hide_lembur?>><?php
      if ($lembur != "")
      {
      $lembur_look = substr($this->Db->qstr($lembur), 1, -1); 
      $nmgp_def_dados = array(); 
