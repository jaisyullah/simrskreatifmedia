...
<?php
   ...
   $Ord_Cmp = new grid_hrm_remunerasi_tidak_tetap_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_hrm_remunerasi_tidak_tetap_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_hrm_remunerasi_tidak_tetap']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_hrm_remunerasi_tidak_tetap']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_hrm_remunerasi_tidak_tetap']['labels']["id"])) ? $_SESSION['sc_session'][$sc_init]['grid_hrm_remunerasi_tidak_tetap']['labels']["id"] : "Id";
   $tab_ger_campos['id_karyawan'] = "on";
   $tab_def_campos['id_karyawan'] = "id_karyawan";
   $tab_labels["id_karyawan"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_hrm_remunerasi_tidak_tetap']['labels']["id_karyawan"])) ? $_SESSION['sc_session'][$sc_init]['grid_hrm_remunerasi_tidak_tetap']['labels']["id_karyawan"] : "Karyawan";
   $tab_ger_campos['tunj_masa_kerja'] = "on";
   $tab_def_campos['tunj_masa_kerja'] = "tunj_masa_kerja";
   $tab_labels["tunj_masa_kerja"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_hrm_remunerasi_tidak_tetap']['labels']["tunj_masa_kerja"])) ? $_SESSION['sc_session'][$sc_init]['grid_hrm_remunerasi_tidak_tetap']['labels']["tunj_masa_kerja"] : "Tunj Masa Kerja";
   $tab_ger_campos['lembur'] = "on";
   $tab_def_campos['lembur'] = "lembur";
   $tab_labels["lembur"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_hrm_remunerasi_tidak_tetap']['labels']["lembur"])) ? $_SESSION['sc_session'][$sc_init]['grid_hrm_remunerasi_tidak_tetap']['labels']["lembur"] : "Lembur";
   $tab_ger_campos['insentif'] = "on";
   $tab_def_campos['insentif'] = "insentif";
   $tab_labels["insentif"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_hrm_remunerasi_tidak_tetap']['labels']["insentif"])) ? $_SESSION['sc_session'][$sc_init]['grid_hrm_remunerasi_tidak_tetap']['labels']["insentif"] : "Insentif";
   $tab_ger_campos['periode_remunerasi'] = "on";
   $tab_def_campos['periode_remunerasi'] = "periode_remunerasi";
   $tab_labels["periode_remunerasi"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_hrm_remunerasi_tidak_tetap']['labels']["periode_remunerasi"])) ? $_SESSION['sc_session'][$sc_init]['grid_hrm_remunerasi_tidak_tetap']['labels']["periode_remunerasi"] : "Periode Remunerasi";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_hrm_remunerasi_tidak_tetap']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_hrm_remunerasi_tidak_tetap']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_hrm_remunerasi_tidak_tetap']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_hrm_remunerasi_tidak_tetap']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_hrm_remunerasi_tidak_tetap']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_hrm_remunerasi_tidak_tetap']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_hrm_remunerasi_tidak_tetap']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_hrm_remunerasi_tidak_tetap']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_hrm_remunerasi_tidak_tetap']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_hrm_remunerasi_tidak_tetap_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_hrm_remunerasi_tidak_tetap']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_hrm_remunerasi_tidak_tetap']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_hrm_remunerasi_tidak_tetap']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_hrm_remunerasi_tidak_tetap']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_hrm_remunerasi_tidak_tetap']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
