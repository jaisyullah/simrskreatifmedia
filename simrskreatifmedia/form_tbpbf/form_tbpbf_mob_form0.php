...
<HEAD>
 <TITLE><?php if ('novo' == $this->nmgp_opcao) { echo strip_tags("" . $this->Ini->Nm_lang['lang_othr_frmi_titl'] . " - Supplier / PBF"); } else { echo strip_tags("" . $this->Ini->Nm_lang['lang_othr_frmu_titl'] . " - Supplier / PBF"); } ?></TITLE>
...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbpbf_mob']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_tbpbf/form_tbpbf_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_tbpbf_mob_sajax_js.php");
?>
<script type="text/javascript">
...
function summary_atualiza(reg_ini, reg_qtd, reg_tot)
{
 ...
 function nm_field_disabled(Fields, Opt) {
  ...
  for (i=0; i < Field.length; i++)
  {
     ...
     if (F_name == "jenis")
     {
        $('select[name="jenis"]').prop("disabled", F_opc);
        if (F_opc == "disabled" || F_opc == true) {
            $('select[name="jenis"]').addClass("scFormInputDisabled");
        }
        else {
            $('select[name="jenis"]').removeClass("scFormInputDisabled");
        }
     }
  }
 } // nm_field_disabled
...
include_once('form_tbpbf_mob_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbpbf_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbpbf_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbpbf_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbpbf_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbpbf_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbpbf_mob']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbpbf_mob']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbpbf_mob']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
?>
<body class="scFormPage" style="<?php echo $remove_margin . $str_iframe_body; ?>">
<?php

if (isset($_SESSION['scriptcase']['form_tbpbf']['error_buffer']) && '' != $_SESSION['scriptcase']['form_tbpbf']['error_buffer'])
{
    echo $_SESSION['scriptcase']['form_tbpbf']['error_buffer'];
}
...
<?php
 include_once("form_tbpbf_mob_js0.php");
?>
<script type="text/javascript"> 
...
<form  name="F1" method="post" 
               action="form_tbpbf_mob.php" 
               target="_self">
<input type="hidden" name="nmgp_url_saida" value="">
<?php
if ('novo' == $this->nmgp_opcao || 'incluir' == $this->nmgp_opcao)
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbpbf_mob']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbpbf_mob']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_tbpbf_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_tbpbf_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbpbf_mob']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbpbf_mob']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbpbf_mob']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbpbf_mob']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbpbf_mob']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<div class="scFormHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFormHeaderFont" style="float: left; text-transform: uppercase;"><?php if ($this->nmgp_opcao == "novo") { echo "" . $this->Ini->Nm_lang['lang_othr_frmi_titl'] . " - Supplier / PBF"; } else { echo "" . $this->Ini->Nm_lang['lang_othr_frmu_titl'] . " - Supplier / PBF"; } ?></div>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbpbf_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbpbf_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbpbf_mob']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbpbf_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbpbf_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbpbf_mob']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbpbf_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbpbf_mob']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbpbf_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbpbf_mob']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbpbf_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbpbf_mob']['fast_search'][2] : "";
?> 
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbpbf_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbpbf_mob']['run_iframe'] != "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbpbf_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbpbf_mob']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbpbf_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbpbf_mob']['run_iframe'] == "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbpbf_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbpbf_mob']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbpbf_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbpbf_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbpbf_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbpbf_mob']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbpbf_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbpbf_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbpbf_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbpbf_mob']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbpbf_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbpbf_mob']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<TABLE align="center" id="hidden_bloco_0" class="scFormTable" width="100%" style="height: 100%;"><?php
           if ('novo' != $this->nmgp_opcao && !isset($this->nmgp_cmp_readonly['pbfcode']))
           {
               $this->nmgp_cmp_readonly['pbfcode'] = 'on';
           }
?>
   <tr>
    ...
    <TD colspan="1" height="20" class="scFormBlock">
     <TABLE style="padding: 0px; spacing: 0px; border-width: 0px;" width="100%" height="100%">
      <TR>
       <TD align="" valign="" class="scFormBlockFont"><?php if ('' != $this->Ini->Block_img_exp && '' != $this->Ini->Block_img_col && !$this->Ini->Export_img_zip) { echo "<table style=\"border-collapse: collapse; height: 100%; width: 100%\"><tr><td style=\"vertical-align: middle; border-width: 0px; padding: 0px 2px 0px 0px\"><img id=\"SC_blk_pdf0\" src=\"" . $this->Ini->path_icones . "/" . $this->Ini->Block_img_col . "\" style=\"border: 0px; float: left\" class=\"sc-ui-block-control\"></td><td style=\"border-width: 0px; padding: 0px; width: 100%;\" class=\"scFormBlockAlign\">"; } ?>Perusahaan<?php if ('' != $this->Ini->Block_img_exp && '' != $this->Ini->Block_img_col && !$this->Ini->Export_img_zip) { echo "</td></tr></table>"; } ?></TD>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    if (!isset($this->nm_new_label['pbfcode']))
    {
        $this->nm_new_label['pbfcode'] = "Kode PBF";
    }
?>
<?php
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
   $nm_img_fun_cel  = ($nm_img_fun_cel  == $this->Ini->img_fun_imp    ? $this->Ini->img_fun_par  : $this->Ini->img_fun_imp);
   $pbfcode = $this->pbfcode;
   $sStyleHidden_pbfcode = '';
   if (isset($this->nmgp_cmp_hidden['pbfcode']) && $this->nmgp_cmp_hidden['pbfcode'] == 'off')
   {
       unset($this->nmgp_cmp_hidden['pbfcode']);
       $sStyleHidden_pbfcode = 'display: none;';
   }
   $bTestReadOnly = true;
   $sStyleReadLab_pbfcode = 'display: none;';
   $sStyleReadInp_pbfcode = '';
   if (/*($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir") || */(isset($this->nmgp_cmp_readonly["pbfcode"]) &&  $this->nmgp_cmp_readonly["pbfcode"] == "on"))
   {
       $bTestReadOnly = false;
       unset($this->nmgp_cmp_readonly['pbfcode']);
       $sStyleReadLab_pbfcode = '';
       $sStyleReadInp_pbfcode = 'display: none;';
   }
?>
<?php if (isset($this->nmgp_cmp_hidden['pbfcode']) && $this->nmgp_cmp_hidden['pbfcode'] == 'off') { $sc_hidden_yes++;  ?>
<input type="hidden" name="pbfcode" value="<?php echo $this->form_encode_input($pbfcode) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormDataOdd css_pbfcode_line" id="hidden_field_data_pbfcode" style="<?php echo $sStyleHidden_pbfcode; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_pbfcode_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_pbfcode_label"><span id="id_label_pbfcode"><?php echo $this->nm_new_label['pbfcode']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbpbf_mob']['php_cmp_required']['pbfcode']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbpbf_mob']['php_cmp_required']['pbfcode'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
<?php if ($bTestReadOnly && ($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir") || (isset($this->nmgp_cmp_readonly["pbfcode"]) &&  $this->nmgp_cmp_readonly["pbfcode"] == "on")) { 

 ?>
<input type="hidden" name="pbfcode" value="<?php echo $this->form_encode_input($pbfcode) . "\"><span id=\"id_ajax_label_pbfcode\">" . $pbfcode . "</span>"; ?>
<?php } else { ?>
<span id="id_read_on_pbfcode" class="sc-ui-readonly-pbfcode css_pbfcode_line" style="<?php echo $sStyleReadLab_pbfcode; ?>"><?php echo $this->pbfcode; ?></span><span id="id_read_off_pbfcode" class="css_read_off_pbfcode" style="white-space: nowrap;<?php echo $sStyleReadInp_pbfcode; ?>">
 <input class="sc-js-input scFormObjectOdd css_pbfcode_obj" style="" id="id_sc_field_pbfcode" type=text name="pbfcode" value="<?php echo $this->form_encode_input($pbfcode) ?>"
...
</td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_pbfcode_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_pbfcode_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    if (!isset($this->nm_new_label['pbfname']))
    {
        $this->nm_new_label['pbfname'] = "Nama PBF";
    }
?>
<?php
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
   $nm_img_fun_cel  = ($nm_img_fun_cel  == $this->Ini->img_fun_imp    ? $this->Ini->img_fun_par  : $this->Ini->img_fun_imp);
   $pbfname = $this->pbfname;
   $sStyleHidden_pbfname = '';
   if (isset($this->nmgp_cmp_hidden['pbfname']) && $this->nmgp_cmp_hidden['pbfname'] == 'off')
   {
       unset($this->nmgp_cmp_hidden['pbfname']);
       $sStyleHidden_pbfname = 'display: none;';
   }
   $bTestReadOnly = true;
   $sStyleReadLab_pbfname = 'display: none;';
   $sStyleReadInp_pbfname = '';
   if (/*$this->nmgp_opcao != "novo" && */isset($this->nmgp_cmp_readonly['pbfname']) && $this->nmgp_cmp_readonly['pbfname'] == 'on')
   {
       $bTestReadOnly = false;
       unset($this->nmgp_cmp_readonly['pbfname']);
       $sStyleReadLab_pbfname = '';
       $sStyleReadInp_pbfname = 'display: none;';
   }
?>
<?php if (isset($this->nmgp_cmp_hidden['pbfname']) && $this->nmgp_cmp_hidden['pbfname'] == 'off') { $sc_hidden_yes++;  ?>
<input type="hidden" name="pbfname" value="<?php echo $this->form_encode_input($pbfname) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormDataOdd css_pbfname_line" id="hidden_field_data_pbfname" style="<?php echo $sStyleHidden_pbfname; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_pbfname_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_pbfname_label"><span id="id_label_pbfname"><?php echo $this->nm_new_label['pbfname']; ?></span></span><br>
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["pbfname"]) &&  $this->nmgp_cmp_readonly["pbfname"] == "on") { 

 ?>
<input type="hidden" name="pbfname" value="<?php echo $this->form_encode_input($pbfname) . "\">" . $pbfname . ""; ?>
<?php } else { ?>
<span id="id_read_on_pbfname" class="sc-ui-readonly-pbfname css_pbfname_line" style="<?php echo $sStyleReadLab_pbfname; ?>"><?php echo $this->pbfname; ?></span><span id="id_read_off_pbfname" class="css_read_off_pbfname" style="white-space: nowrap;<?php echo $sStyleReadInp_pbfname; ?>">
 <input class="sc-js-input scFormObjectOdd css_pbfname_obj" style="" id="id_sc_field_pbfname" type=text name="pbfname" value="<?php echo $this->form_encode_input($pbfname) ?>"
...
</td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_pbfname_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_pbfname_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
$jenis_look = "";
 if ($this->jenis == "PBF") { $jenis_look .= "PBF" ;} 
 if ($this->jenis == "Principal") { $jenis_look .= "Principal" ;} 
...
<span id="id_read_on_jenis" class="css_jenis_line"  style="<?php echo $sStyleReadLab_jenis; ?>"><?php echo $this->form_encode_input($jenis_look); ?></span><span id="id_read_off_jenis" class="css_read_off_jenis" style="white-space: nowrap; <?php echo $sStyleReadInp_jenis; ?>">
 ...
 <option  value="PBF" <?php  if ($this->jenis == "PBF") { echo " selected" ;} ?>>PBF</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbpbf_mob']['Lookup_jenis'][] = 'PBF'; ?>
 <option  value="Principal" <?php  if ($this->jenis == "Principal") { echo " selected" ;} ?>>Principal</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbpbf_mob']['Lookup_jenis'][] = 'Principal'; ?>
 </select></span>
</span><?php  }?>
...
<span id="id_read_on_disc" class="sc-ui-readonly-disc css_disc_line" style="<?php echo $sStyleReadLab_disc; ?>"><?php echo $this->disc; ?></span><span id="id_read_off_disc" class="css_read_off_disc" style="white-space: nowrap;<?php echo $sStyleReadInp_disc; ?>">
 ...
 size=3 alt="{datatype: 'integer', maxLength: 3, thousandsSep: '<?php echo str_replace("'", "\'", $this->field_config['disc']['symbol_grp']); ?>', thousandsFormat: <?php echo $this->field_config['disc']['symbol_fmt']; ?>, allowNegative: false, onlyNegative: false, negativePos: <?php echo (4 == $this->field_config['disc']['format_neg'] ? "'suffix'" : "'prefix'") ?>, alignment: 'left', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
<span class="css_disc_label scFormDataHelpOdd">&nbsp;%
</span></td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_disc_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_disc_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
<TABLE align="center" id="hidden_bloco_1" class="scFormTable" width="100%" style="height: 100%;">   <tr>
    ...
    <TD colspan="1" height="20" class="scFormBlock">
     <TABLE style="padding: 0px; spacing: 0px; border-width: 0px;" width="100%" height="100%">
      <TR>
       <TD align="" valign="" class="scFormBlockFont"><?php if ('' != $this->Ini->Block_img_exp && '' != $this->Ini->Block_img_col && !$this->Ini->Export_img_zip) { echo "<table style=\"border-collapse: collapse; height: 100%; width: 100%\"><tr><td style=\"vertical-align: middle; border-width: 0px; padding: 0px 2px 0px 0px\"><img id=\"SC_blk_pdf1\" src=\"" . $this->Ini->path_icones . "/" . $this->Ini->Block_img_col . "\" style=\"border: 0px; float: left\" class=\"sc-ui-block-control\"></td><td style=\"border-width: 0px; padding: 0px; width: 100%;\" class=\"scFormBlockAlign\">"; } ?>Kontak<?php if ('' != $this->Ini->Block_img_exp && '' != $this->Ini->Block_img_col && !$this->Ini->Export_img_zip) { echo "</td></tr></table>"; } ?></TD>
...
<span id="id_read_on_cp" class="sc-ui-readonly-cp css_cp_line" style="<?php echo $sStyleReadLab_cp; ?>"><?php echo $this->cp; ?></span><span id="id_read_off_cp" class="css_read_off_cp" style="white-space: nowrap;<?php echo $sStyleReadInp_cp; ?>">
 ...
 size=50 maxlength=50 alt="{datatype: 'text', maxLength: 50, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: 'upper', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: 'Contact Person', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
...
$status_look = "";
 if ($this->status == "Approved") { $status_look .= "Approved" ;} 
 if ($this->status == "Prefered") { $status_look .= "Prefered" ;} 
...
<span id="id_read_on_status" class="css_status_line"  style="<?php echo $sStyleReadLab_status; ?>"><?php echo $this->form_encode_input($status_look); ?></span><span id="id_read_off_status" class="css_read_off_status" style="white-space: nowrap; <?php echo $sStyleReadInp_status; ?>">
 ...
 <option  value="Approved" <?php  if ($this->status == "Approved") { echo " selected" ;} ?>>Approved</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbpbf_mob']['Lookup_status'][] = 'Approved'; ?>
 <option  value="Prefered" <?php  if ($this->status == "Prefered") { echo " selected" ;} ?>>Prefered</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbpbf_mob']['Lookup_status'][] = 'Prefered'; ?>
 </select></span>
</span><?php  }?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbpbf_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbpbf_mob']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbpbf_mob']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbpbf_mob']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbpbf_mob']['total'] + 1)?>);</script><?php }} ?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbpbf_mob']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbpbf_mob']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_tbpbf_mob");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_tbpbf_mob");
 parent.scAjaxDetailHeight("form_tbpbf_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbpbf_mob']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
