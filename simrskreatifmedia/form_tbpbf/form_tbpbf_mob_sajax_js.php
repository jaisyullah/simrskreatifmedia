  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbpbf_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbpbf_mob_form();
	}

  // ---------- Validate pbfcode
  function do_ajax_form_tbpbf_mob_validate_pbfcode()
  {
    var nomeCampo_pbfcode = "pbfcode";
    var var_pbfcode = scAjaxGetFieldText(nomeCampo_pbfcode);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbpbf_mob_validate_pbfcode(var_pbfcode, var_script_case_init, do_ajax_form_tbpbf_mob_validate_pbfcode_cb);
  } // do_ajax_form_tbpbf_mob_validate_pbfcode

  function do_ajax_form_tbpbf_mob_validate_pbfcode_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbpbf_mob_validate_pbfcode_cb

  // ---------- Validate pbfname
  function do_ajax_form_tbpbf_mob_validate_pbfname()
  {
    var nomeCampo_pbfname = "pbfname";
    var var_pbfname = scAjaxGetFieldText(nomeCampo_pbfname);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbpbf_mob_validate_pbfname(var_pbfname, var_script_case_init, do_ajax_form_tbpbf_mob_validate_pbfname_cb);
  } // do_ajax_form_tbpbf_mob_validate_pbfname

  function do_ajax_form_tbpbf_mob_validate_pbfname_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pbfname";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbpbf_mob_validate_pbfname_cb

  // ---------- Validate jenis
  function do_ajax_form_tbpbf_mob_validate_jenis()
  {
    var nomeCampo_jenis = "jenis";
    var var_jenis = scAjaxGetFieldSelect(nomeCampo_jenis);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbpbf_mob_validate_jenis(var_jenis, var_script_case_init, do_ajax_form_tbpbf_mob_validate_jenis_cb);
  } // do_ajax_form_tbpbf_mob_validate_jenis

  function do_ajax_form_tbpbf_mob_validate_jenis_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "jenis";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbpbf_mob_validate_jenis_cb

  // ---------- Validate address
  function do_ajax_form_tbpbf_mob_validate_address()
  {
    var nomeCampo_address = "address";
    var var_address = scAjaxGetFieldText(nomeCampo_address);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbpbf_mob_validate_address(var_address, var_script_case_init, do_ajax_form_tbpbf_mob_validate_address_cb);
  } // do_ajax_form_tbpbf_mob_validate_address

  function do_ajax_form_tbpbf_mob_validate_address_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "address";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbpbf_mob_validate_address_cb

  // ---------- Validate disc
  function do_ajax_form_tbpbf_mob_validate_disc()
  {
    var nomeCampo_disc = "disc";
    var var_disc = scAjaxGetFieldText(nomeCampo_disc);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbpbf_mob_validate_disc(var_disc, var_script_case_init, do_ajax_form_tbpbf_mob_validate_disc_cb);
  } // do_ajax_form_tbpbf_mob_validate_disc

  function do_ajax_form_tbpbf_mob_validate_disc_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "disc";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbpbf_mob_validate_disc_cb

  // ---------- Validate city
  function do_ajax_form_tbpbf_mob_validate_city()
  {
    var nomeCampo_city = "city";
    var var_city = scAjaxGetFieldText(nomeCampo_city);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbpbf_mob_validate_city(var_city, var_script_case_init, do_ajax_form_tbpbf_mob_validate_city_cb);
  } // do_ajax_form_tbpbf_mob_validate_city

  function do_ajax_form_tbpbf_mob_validate_city_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "city";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbpbf_mob_validate_city_cb

  // ---------- Validate phone
  function do_ajax_form_tbpbf_mob_validate_phone()
  {
    var nomeCampo_phone = "phone";
    var var_phone = scAjaxGetFieldText(nomeCampo_phone);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbpbf_mob_validate_phone(var_phone, var_script_case_init, do_ajax_form_tbpbf_mob_validate_phone_cb);
  } // do_ajax_form_tbpbf_mob_validate_phone

  function do_ajax_form_tbpbf_mob_validate_phone_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "phone";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbpbf_mob_validate_phone_cb

  // ---------- Validate fax
  function do_ajax_form_tbpbf_mob_validate_fax()
  {
    var nomeCampo_fax = "fax";
    var var_fax = scAjaxGetFieldText(nomeCampo_fax);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbpbf_mob_validate_fax(var_fax, var_script_case_init, do_ajax_form_tbpbf_mob_validate_fax_cb);
  } // do_ajax_form_tbpbf_mob_validate_fax

  function do_ajax_form_tbpbf_mob_validate_fax_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fax";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbpbf_mob_validate_fax_cb

  // ---------- Validate cp
  function do_ajax_form_tbpbf_mob_validate_cp()
  {
    var nomeCampo_cp = "cp";
    var var_cp = scAjaxGetFieldText(nomeCampo_cp);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbpbf_mob_validate_cp(var_cp, var_script_case_init, do_ajax_form_tbpbf_mob_validate_cp_cb);
  } // do_ajax_form_tbpbf_mob_validate_cp

  function do_ajax_form_tbpbf_mob_validate_cp_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cp";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbpbf_mob_validate_cp_cb

  // ---------- Validate status
  function do_ajax_form_tbpbf_mob_validate_status()
  {
    var nomeCampo_status = "status";
    var var_status = scAjaxGetFieldSelect(nomeCampo_status);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbpbf_mob_validate_status(var_status, var_script_case_init, do_ajax_form_tbpbf_mob_validate_status_cb);
  } // do_ajax_form_tbpbf_mob_validate_status

  function do_ajax_form_tbpbf_mob_validate_status_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "status";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbpbf_mob_validate_status_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tbpbf_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tbpbf_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_tbpbf_mob_submit_form(var_pbfcode, var_pbfname, var_jenis, var_address, var_disc, var_city, var_phone, var_fax, var_cp, var_status, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbpbf_mob_submit_form_cb);
  } // do_ajax_form_tbpbf_mob_submit_form

  function do_ajax_form_tbpbf_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tbpbf_mob_submit_form_cb_after_alert);
  } // do_ajax_form_tbpbf_mob_submit_form_cb
  function do_ajax_form_tbpbf_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbpbf_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tbpbf_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_tbpbf_mob_navigate_form(var_pbfcode, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbpbf_mob_navigate_form_cb);
  } // do_ajax_form_tbpbf_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbpbf_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbpbf_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbpbf_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_tbpbf_mob_navigate_form_cb
  function do_ajax_form_tbpbf_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_tbpbf_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_tbpbf_mob_navigate_form_cb_after_alert
  function sc_hide_form_tbpbf_mob_form()
  {
