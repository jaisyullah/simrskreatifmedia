  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_jurnal" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_jurnal_form();
	}

  // ---------- Validate id_
  function do_ajax_form_jurnal_validate_id_(iNumLinha)
  {
    var nomeCampo_id_ = "id_" + iNumLinha;
    var var_id_ = scAjaxGetFieldHidden(nomeCampo_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jurnal_validate_id_(var_id_, iNumLinha, var_script_case_init, do_ajax_form_jurnal_validate_id__cb);
  } // do_ajax_form_jurnal_validate_id_

  function do_ajax_form_jurnal_validate_id__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jurnal_validate_id__cb

  // ---------- Validate akun_
  function do_ajax_form_jurnal_validate_akun_(iNumLinha)
  {
    var nomeCampo_akun_ = "akun_" + iNumLinha;
    var var_akun_ = scAjaxGetFieldSelect(nomeCampo_akun_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jurnal_validate_akun_(var_akun_, iNumLinha, var_script_case_init, do_ajax_form_jurnal_validate_akun__cb);
  } // do_ajax_form_jurnal_validate_akun_

  function do_ajax_form_jurnal_validate_akun__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "akun_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "akun_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jurnal_validate_akun__cb

  // ---------- Validate nominal_
  function do_ajax_form_jurnal_validate_nominal_(iNumLinha)
  {
    var nomeCampo_nominal_ = "nominal_" + iNumLinha;
    var var_nominal_ = scAjaxGetFieldText(nomeCampo_nominal_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jurnal_validate_nominal_(var_nominal_, iNumLinha, var_script_case_init, do_ajax_form_jurnal_validate_nominal__cb);
  } // do_ajax_form_jurnal_validate_nominal_

  function do_ajax_form_jurnal_validate_nominal__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "nominal_" + iLineNumber;
    }
    else
    {
      sFieldValid = "nominal_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "nominal_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "nominal_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jurnal_validate_nominal__cb

  // ---------- Validate flag_
  function do_ajax_form_jurnal_validate_flag_(iNumLinha)
  {
    var nomeCampo_flag_ = "flag_" + iNumLinha;
    var var_flag_ = scAjaxGetFieldSelect(nomeCampo_flag_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jurnal_validate_flag_(var_flag_, iNumLinha, var_script_case_init, do_ajax_form_jurnal_validate_flag__cb);
  } // do_ajax_form_jurnal_validate_flag_

  function do_ajax_form_jurnal_validate_flag__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "flag_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "flag_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jurnal_validate_flag__cb

  // ---------- Validate tanggal_
  function do_ajax_form_jurnal_validate_tanggal_(iNumLinha)
  {
    var nomeCampo_tanggal_ = "tanggal_" + iNumLinha;
    var var_tanggal_ = scAjaxGetFieldText(nomeCampo_tanggal_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jurnal_validate_tanggal_(var_tanggal_, iNumLinha, var_script_case_init, do_ajax_form_jurnal_validate_tanggal__cb);
  } // do_ajax_form_jurnal_validate_tanggal_

  function do_ajax_form_jurnal_validate_tanggal__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "tanggal_" + iLineNumber;
    }
    else
    {
      sFieldValid = "tanggal_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors || ($("#ui-datepicker-div").length && $("#ui-datepicker-div").filter(":visible").length))
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "tanggal_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "tanggal_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jurnal_validate_tanggal__cb

  // ---------- Validate id_transaksi_
  function do_ajax_form_jurnal_validate_id_transaksi_(iNumLinha)
  {
    var nomeCampo_id_transaksi_ = "id_transaksi_" + iNumLinha;
    var var_id_transaksi_ = scAjaxGetFieldText(nomeCampo_id_transaksi_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jurnal_validate_id_transaksi_(var_id_transaksi_, iNumLinha, var_script_case_init, do_ajax_form_jurnal_validate_id_transaksi__cb);
  } // do_ajax_form_jurnal_validate_id_transaksi_

  function do_ajax_form_jurnal_validate_id_transaksi__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "id_transaksi_" + iLineNumber;
    }
    else
    {
      sFieldValid = "id_transaksi_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "id_transaksi_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "id_transaksi_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jurnal_validate_id_transaksi__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_jurnal_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_jurnal_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_jurnal_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_jurnal_add_new_line_cb);
  } // do_ajax_form_jurnal_add_new_line

  function do_ajax_form_jurnal_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_jurnal_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_jurnal_backup_line(iNumLinha)
  {
    var var_id_ = scAjaxGetFieldHidden("id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jurnal_backup_line(var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_jurnal_backup_line_cb);
  } // do_ajax_form_jurnal_backup_line

  function do_ajax_form_jurnal_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_jurnal_backup_line_cb

  function do_ajax_form_jurnal_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_jurnal_cancel_insert

  function do_ajax_form_jurnal_cancel_update(iSeqVert)
  {
    do_ajax_form_jurnal_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_jurnal_cancel_update

  function do_ajax_form_jurnal_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_jurnal_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_jurnal_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_jurnal_table_refresh(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_jurnal_table_refresh_cb);
  } //  do_ajax_form_jurnal_table_refresh

  function do_ajax_form_jurnal_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_jurnal_table_refresh_cb_after_alert);
  } // do_ajax_form_jurnal_table_refresh_cb
  function do_ajax_form_jurnal_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_jurnal_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_jurnal_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_jurnal_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_id_ = scAjaxGetFieldHidden("id_" + iNumLinha);
    var var_akun_ = scAjaxGetFieldSelect("akun_" + iNumLinha);
    var var_nominal_ = scAjaxGetFieldText("nominal_" + iNumLinha);
    var var_flag_ = scAjaxGetFieldSelect("flag_" + iNumLinha);
    var var_tanggal_ = scAjaxGetFieldText("tanggal_" + iNumLinha);
    var var_id_transaksi_ = scAjaxGetFieldText("id_transaksi_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_jurnal_submit_form(var_id_, var_akun_, var_nominal_, var_flag_, var_tanggal_, var_id_transaksi_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_jurnal_submit_form_cb);
  } // do_ajax_form_jurnal_submit_form

  function do_ajax_form_jurnal_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("akun_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("nominal_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("flag_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("tanggal_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("id_transaksi_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_jurnal_submit_form_cb_after_alert);
  } // do_ajax_form_jurnal_submit_form_cb
  function do_ajax_form_jurnal_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_jurnal_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_jurnal_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_jurnal_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("akun_" + iNavForm);
      scAjaxHideErrorDisplay("nominal_" + iNavForm);
      scAjaxHideErrorDisplay("flag_" + iNavForm);
      scAjaxHideErrorDisplay("tanggal_" + iNavForm);
      scAjaxHideErrorDisplay("id_transaksi_" + iNavForm);
    }
    var var_id_ = document.F2.id_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_jurnal_navigate_form(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_jurnal_navigate_form_cb);
  } // do_ajax_form_jurnal_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_jurnal']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_jurnal_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_jurnal_navigate_form_cb_after_alert);
  } // do_ajax_form_jurnal_navigate_form_cb
  function do_ajax_form_jurnal_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_jurnal_navigate_form_cb_after_alert
  function sc_hide_form_jurnal_form()
  {
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "akun_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "nominal_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "flag_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "tanggal_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "id_transaksi_" + iNumLinha;
    iTotCampos++;
    ...
    ajax_error_list["akun_" + iNumLinha] = {"label": "Akun<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["nominal_" + iNumLinha] = {"label": "Nominal<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["flag_" + iNumLinha] = {"label": "Flag<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["tanggal_" + iNumLinha] = {"label": "Tanggal<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["id_transaksi_" + iNumLinha] = {"label": "Transaksi<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["id_"][iNumLinha] = "id_" + iNumLinha;
    ajax_field_mult["akun_"][iNumLinha] = "akun_" + iNumLinha;
    ajax_field_mult["nominal_"][iNumLinha] = "nominal_" + iNumLinha;
    ajax_field_mult["flag_"][iNumLinha] = "flag_" + iNumLinha;
    ajax_field_mult["tanggal_"][iNumLinha] = "tanggal_" + iNumLinha;
    ajax_field_mult["id_transaksi_"][iNumLinha] = "id_transaksi_" + iNumLinha;
    ajax_field_id["id_" + iNumLinha] = new Array("hidden_field_label_id_", "hidden_field_data_id_" + iNumLinha);
    ajax_field_id["akun_" + iNumLinha] = new Array("hidden_field_label_akun_", "hidden_field_data_akun_" + iNumLinha);
    ajax_field_id["nominal_" + iNumLinha] = new Array("hidden_field_label_nominal_", "hidden_field_data_nominal_" + iNumLinha);
    ajax_field_id["flag_" + iNumLinha] = new Array("hidden_field_label_flag_", "hidden_field_data_flag_" + iNumLinha);
    ajax_field_id["tanggal_" + iNumLinha] = new Array("hidden_field_label_tanggal_", "hidden_field_data_tanggal_" + iNumLinha);
    ajax_field_id["id_transaksi_" + iNumLinha] = new Array("hidden_field_label_id_transaksi_", "hidden_field_data_id_transaksi_" + iNumLinha);
    ajax_error_count["id_" + iNumLinha] = "off";
    ajax_error_count["akun_" + iNumLinha] = "off";
    ajax_error_count["nominal_" + iNumLinha] = "off";
    ajax_error_count["flag_" + iNumLinha] = "off";
    ajax_error_count["tanggal_" + iNumLinha] = "off";
    ajax_error_count["id_transaksi_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["id_" + iNumLinha] = "on";
    ajax_read_only["akun_" + iNumLinha] = "off";
    ajax_read_only["nominal_" + iNumLinha] = "off";
    ajax_read_only["flag_" + iNumLinha] = "off";
    ajax_read_only["tanggal_" + iNumLinha] = "off";
    ajax_read_only["id_transaksi_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["id_" + iNumLinha] = "on";
    ajax_read_only["akun_" + iNumLinha] = "on";
    ajax_read_only["nominal_" + iNumLinha] = "on";
    ajax_read_only["flag_" + iNumLinha] = "on";
    ajax_read_only["tanggal_" + iNumLinha] = "on";
    ajax_read_only["id_transaksi_" + iNumLinha] = "on";
<?php
}
?>
  }
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["akun_" + iNumLinha] = null;
    ajax_error_list["nominal_" + iNumLinha] = null;
    ajax_error_list["flag_" + iNumLinha] = null;
    ajax_error_list["tanggal_" + iNumLinha] = null;
    ajax_error_list["id_transaksi_" + iNumLinha] = null;
  }
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["akun_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["akun_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["akun_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["akun_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["akun_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["nominal_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["nominal_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["nominal_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["nominal_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["nominal_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["flag_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["flag_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["flag_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["flag_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["flag_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["tanggal_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["tanggal_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["tanggal_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["tanggal_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["tanggal_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["id_transaksi_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["id_transaksi_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["id_transaksi_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["id_transaksi_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["id_transaksi_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['akun_'])) ? $this->nmgp_cmp_readonly['akun_'] : 'off';
?>
    scAjaxFieldRead("akun_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['nominal_'])) ? $this->nmgp_cmp_readonly['nominal_'] : 'off';
?>
    scAjaxFieldRead("nominal_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['flag_'])) ? $this->nmgp_cmp_readonly['flag_'] : 'off';
?>
    scAjaxFieldRead("flag_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['tanggal_'])) ? $this->nmgp_cmp_readonly['tanggal_'] : 'off';
?>
    scAjaxFieldRead("tanggal_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['id_transaksi_'])) ? $this->nmgp_cmp_readonly['id_transaksi_'] : 'off';
?>
    scAjaxFieldRead("id_transaksi_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("id_" + iSeq, "on");
    scAjaxFieldRead("akun_" + iSeq, "on");
    scAjaxFieldRead("nominal_" + iSeq, "on");
    scAjaxFieldRead("flag_" + iSeq, "on");
    scAjaxFieldRead("tanggal_" + iSeq, "on");
    scAjaxFieldRead("id_transaksi_" + iSeq, "on");
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["id_" + iRow] || "on" == ajax_error_count["akun_" + iRow] || "on" == ajax_error_count["nominal_" + iRow] || "on" == ajax_error_count["flag_" + iRow] || "on" == ajax_error_count["tanggal_" + iRow] || "on" == ajax_error_count["id_transaksi_" + iRow]))
    {
      ...
      $("#hidden_field_data_akun_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_nominal_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_flag_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_tanggal_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_id_transaksi_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["id_" + iRow] && "off" == ajax_error_count["akun_" + iRow] && "off" == ajax_error_count["nominal_" + iRow] && "off" == ajax_error_count["flag_" + iRow] && "off" == ajax_error_count["tanggal_" + iRow] && "off" == ajax_error_count["id_transaksi_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["id_" + iRow] = "off";
        ajax_error_count["akun_" + iRow] = "off";
        ajax_error_count["nominal_" + iRow] = "off";
        ajax_error_count["flag_" + iRow] = "off";
        ajax_error_count["tanggal_" + iRow] = "off";
        ajax_error_count["id_transaksi_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_akun_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_nominal_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_flag_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_tanggal_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_id_transaksi_" + iRow).removeClass("scFormErrorLine");
    }
  }
