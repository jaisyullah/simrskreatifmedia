  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbdrugsell_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbdrugsell_mob_form();
	}

  // ---------- Validate trancode
  function do_ajax_form_tbdrugsell_mob_validate_trancode()
  {
    var nomeCampo_trancode = "trancode";
    var var_trancode = scAjaxGetFieldText(nomeCampo_trancode);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdrugsell_mob_validate_trancode(var_trancode, var_script_case_init, do_ajax_form_tbdrugsell_mob_validate_trancode_cb);
  } // do_ajax_form_tbdrugsell_mob_validate_trancode

  function do_ajax_form_tbdrugsell_mob_validate_trancode_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdrugsell_mob_validate_trancode_cb

  // ---------- Validate struk
  function do_ajax_form_tbdrugsell_mob_validate_struk()
  {
    var nomeCampo_struk = "struk";
    var var_struk = scAjaxGetFieldText(nomeCampo_struk);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdrugsell_mob_validate_struk(var_struk, var_script_case_init, do_ajax_form_tbdrugsell_mob_validate_struk_cb);
  } // do_ajax_form_tbdrugsell_mob_validate_struk

  function do_ajax_form_tbdrugsell_mob_validate_struk_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "struk";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdrugsell_mob_validate_struk_cb

  // ---------- Validate pasien
  function do_ajax_form_tbdrugsell_mob_validate_pasien()
  {
    var nomeCampo_pasien = "pasien";
    var var_pasien = scAjaxGetFieldCheckbox(nomeCampo_pasien, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdrugsell_mob_validate_pasien(var_pasien, var_script_case_init, do_ajax_form_tbdrugsell_mob_validate_pasien_cb);
  } // do_ajax_form_tbdrugsell_mob_validate_pasien

  function do_ajax_form_tbdrugsell_mob_validate_pasien_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pasien";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdrugsell_mob_validate_pasien_cb

  // ---------- Validate custcode
  function do_ajax_form_tbdrugsell_mob_validate_custcode()
  {
    var nomeCampo_custcode = "custcode";
    var var_custcode = scAjaxGetFieldText(nomeCampo_custcode);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdrugsell_mob_validate_custcode(var_custcode, var_script_case_init, do_ajax_form_tbdrugsell_mob_validate_custcode_cb);
  } // do_ajax_form_tbdrugsell_mob_validate_custcode

  function do_ajax_form_tbdrugsell_mob_validate_custcode_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdrugsell_mob_validate_custcode_cb

  // ---------- Validate custname
  function do_ajax_form_tbdrugsell_mob_validate_custname()
  {
    var nomeCampo_custname = "custname";
    var var_custname = scAjaxGetFieldSelect(nomeCampo_custname);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdrugsell_mob_validate_custname(var_custname, var_script_case_init, do_ajax_form_tbdrugsell_mob_validate_custname_cb);
  } // do_ajax_form_tbdrugsell_mob_validate_custname

  function do_ajax_form_tbdrugsell_mob_validate_custname_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "custname";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdrugsell_mob_validate_custname_cb

  // ---------- Validate extname
  function do_ajax_form_tbdrugsell_mob_validate_extname()
  {
    var nomeCampo_extname = "extname";
    var var_extname = scAjaxGetFieldText(nomeCampo_extname);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdrugsell_mob_validate_extname(var_extname, var_script_case_init, do_ajax_form_tbdrugsell_mob_validate_extname_cb);
  } // do_ajax_form_tbdrugsell_mob_validate_extname

  function do_ajax_form_tbdrugsell_mob_validate_extname_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "extname";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdrugsell_mob_validate_extname_cb

  // ---------- Validate iskaryawan
  function do_ajax_form_tbdrugsell_mob_validate_iskaryawan()
  {
    var nomeCampo_iskaryawan = "iskaryawan";
    var var_iskaryawan = scAjaxGetFieldCheckbox(nomeCampo_iskaryawan, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdrugsell_mob_validate_iskaryawan(var_iskaryawan, var_script_case_init, do_ajax_form_tbdrugsell_mob_validate_iskaryawan_cb);
  } // do_ajax_form_tbdrugsell_mob_validate_iskaryawan

  function do_ajax_form_tbdrugsell_mob_validate_iskaryawan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "iskaryawan";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdrugsell_mob_validate_iskaryawan_cb

  // ---------- Validate total
  function do_ajax_form_tbdrugsell_mob_validate_total()
  {
    var nomeCampo_total = "total";
    var var_total = scAjaxGetFieldText(nomeCampo_total);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdrugsell_mob_validate_total(var_total, var_script_case_init, do_ajax_form_tbdrugsell_mob_validate_total_cb);
  } // do_ajax_form_tbdrugsell_mob_validate_total

  function do_ajax_form_tbdrugsell_mob_validate_total_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "total";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdrugsell_mob_validate_total_cb

  // ---------- Validate trandate
  function do_ajax_form_tbdrugsell_mob_validate_trandate()
  {
    var nomeCampo_trandate = "trandate";
    var var_trandate = scAjaxGetFieldText(nomeCampo_trandate);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdrugsell_mob_validate_trandate(var_trandate, var_script_case_init, do_ajax_form_tbdrugsell_mob_validate_trandate_cb);
  } // do_ajax_form_tbdrugsell_mob_validate_trandate

  function do_ajax_form_tbdrugsell_mob_validate_trandate_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdrugsell_mob_validate_trandate_cb

  // ---------- Validate id
  function do_ajax_form_tbdrugsell_mob_validate_id()
  {
    var nomeCampo_id = "id";
    var var_id = scAjaxGetFieldHidden(nomeCampo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdrugsell_mob_validate_id(var_id, var_script_case_init, do_ajax_form_tbdrugsell_mob_validate_id_cb);
  } // do_ajax_form_tbdrugsell_mob_validate_id

  function do_ajax_form_tbdrugsell_mob_validate_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdrugsell_mob_validate_id_cb

  // ---------- Validate detailsell
  function do_ajax_form_tbdrugsell_mob_validate_detailsell()
  {
    var nomeCampo_detailsell = "detailsell";
    var var_detailsell = scAjaxGetFieldText(nomeCampo_detailsell);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdrugsell_mob_validate_detailsell(var_detailsell, var_script_case_init, do_ajax_form_tbdrugsell_mob_validate_detailsell_cb);
  } // do_ajax_form_tbdrugsell_mob_validate_detailsell

  function do_ajax_form_tbdrugsell_mob_validate_detailsell_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "detailsell";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdrugsell_mob_validate_detailsell_cb

  // ---------- Refresh custcode
  function do_ajax_form_tbdrugsell_mob_refresh_custcode()
  {
    var var_custcode = scAjaxGetFieldText("custcode");
    var var_nmgp_refresh_fields = "custcode";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tbdrugsell_mob_refresh_custcode(var_custcode, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_tbdrugsell_mob_refresh_custcode_cb);
  } // do_ajax_form_tbdrugsell_mob_refresh_custcode

  function do_ajax_form_tbdrugsell_mob_refresh_custcode_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdrugsell_mob_refresh_custcode_cb

  // ---------- Event onclick pasien
  function do_ajax_form_tbdrugsell_mob_event_pasien_onclick()
  {
    var var_pasien = scAjaxGetFieldCheckbox("pasien", ";");
    var var_custcode = scAjaxGetFieldText("custcode");
    var var_custname = scAjaxGetFieldSelect("custname");
    var var_extname = scAjaxGetFieldText("extname");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tbdrugsell_mob_event_pasien_onclick(var_pasien, var_custcode, var_custname, var_extname, var_script_case_init, do_ajax_form_tbdrugsell_mob_event_pasien_onclick_cb);
  } // do_ajax_form_tbdrugsell_mob_event_pasien_onclick

  function do_ajax_form_tbdrugsell_mob_event_pasien_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "pasien";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_tbdrugsell_mob_event_pasien_onclick_cb_after_alert);
  } // do_ajax_form_tbdrugsell_mob_event_pasien_onclick_cb
  function do_ajax_form_tbdrugsell_mob_event_pasien_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_tbdrugsell_mob_event_pasien_onclick_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tbdrugsell_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tbdrugsell_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    var var_custname = scAjaxGetFieldSelect("custname");
    var var_extname = scAjaxGetFieldText("extname");
    var var_iskaryawan = scAjaxGetFieldCheckbox("iskaryawan", ";");
    ...
    scAjaxProcOn();
    x_ajax_form_tbdrugsell_mob_submit_form(var_trancode, var_struk, var_pasien, var_custcode, var_custname, var_extname, var_iskaryawan, var_total, var_trandate, var_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbdrugsell_mob_submit_form_cb);
  } // do_ajax_form_tbdrugsell_mob_submit_form

  function do_ajax_form_tbdrugsell_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("pasien");
      scAjaxHideErrorDisplay("custcode");
      scAjaxHideErrorDisplay("custname");
      scAjaxHideErrorDisplay("extname");
      scAjaxHideErrorDisplay("iskaryawan");
      scAjaxHideErrorDisplay("total");
      scAjaxHideErrorDisplay("trandate");
      scAjaxHideErrorDisplay("id");
      scAjaxHideErrorDisplay("detailsell");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tbdrugsell_mob_submit_form_cb_after_alert);
  } // do_ajax_form_tbdrugsell_mob_submit_form_cb
  function do_ajax_form_tbdrugsell_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbdrugsell_mob_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_tbitemdrugsell_mob"] = "off";

  function do_ajax_form_tbdrugsell_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    scStatusDetail["form_tbitemdrugsell_mob"] = "on";
    x_ajax_form_tbdrugsell_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbdrugsell_mob_navigate_form_cb);
  } // do_ajax_form_tbdrugsell_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdrugsell_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbdrugsell_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_tbitemdrugsell_mob"] && "nmsc_iframe_liga_form_tbitemdrugsell_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_tbitemdrugsell_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_tbitemdrugsell_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_tbitemdrugsell_mob').contentWindow.nm_move('apl_detalhe', true, '500');
        document.getElementById('nmsc_iframe_liga_form_tbitemdrugsell_mob').style.height = "500";
        document.getElementById('nmsc_iframe_liga_form_tbitemdrugsell_mob').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbdrugsell_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_tbdrugsell_mob_navigate_form_cb
  function do_ajax_form_tbdrugsell_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_tbdrugsell_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_tbdrugsell_mob_navigate_form_cb_after_alert
  function sc_hide_form_tbdrugsell_mob_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_tbitemdrugsell_mob"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[1] = "struk";
  ajax_field_list[2] = "pasien";
  ajax_field_list[3] = "custcode";
  ajax_field_list[4] = "custname";
  ajax_field_list[5] = "extname";
  ajax_field_list[6] = "iskaryawan";
  ajax_field_list[7] = "total";
  ajax_field_list[8] = "trandate";
  ajax_field_list[9] = "id";
  ajax_field_list[10] = "detailsell";
  ...
  var ajax_error_list = {
    ...
    "pasien": {"label": "Pasien ?", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "custcode": {"label": "No RM", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "custname": {"label": "Nama Pasien", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "extname": {"label": "Nama Pembeli", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "iskaryawan": {"label": "Karyawan ?", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "detailsell": {"label": "", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    ...
    "custname": new Array(),
    "extname": new Array(),
    "iskaryawan": new Array(),
    "total": new Array(),
    "trandate": new Array(),
    "id": new Array(),
    "detailsell": new Array()
  };
  ajax_field_mult["trancode"][1] = "trancode";
  ajax_field_mult["struk"][1] = "struk";
  ajax_field_mult["pasien"][1] = "pasien";
  ajax_field_mult["custcode"][1] = "custcode";
  ajax_field_mult["custname"][1] = "custname";
  ajax_field_mult["extname"][1] = "extname";
  ajax_field_mult["iskaryawan"][1] = "iskaryawan";
  ajax_field_mult["total"][1] = "total";
  ajax_field_mult["trandate"][1] = "trandate";
  ajax_field_mult["id"][1] = "id";
  ajax_field_mult["detailsell"][1] = "detailsell";
  ...
  var ajax_field_id = {
    ...
    "pasien": new Array("hidden_field_label_pasien", "hidden_field_data_pasien"),
    "custcode": new Array("hidden_field_label_custcode", "hidden_field_data_custcode"),
    "custname": new Array("hidden_field_label_custname", "hidden_field_data_custname"),
    "extname": new Array("hidden_field_label_extname", "hidden_field_data_extname"),
    "iskaryawan": new Array("hidden_field_label_iskaryawan", "hidden_field_data_iskaryawan"),
    ...
    "detailsell": new Array("hidden_field_label_detailsell", "hidden_field_data_detailsell")
  };
