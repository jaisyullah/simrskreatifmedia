  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbdrugsell" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbdrugsell_form();
	}

  // ---------- Validate trancode
  function do_ajax_form_tbdrugsell_validate_trancode()
  {
    var nomeCampo_trancode = "trancode";
    var var_trancode = scAjaxGetFieldText(nomeCampo_trancode);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdrugsell_validate_trancode(var_trancode, var_script_case_init, do_ajax_form_tbdrugsell_validate_trancode_cb);
  } // do_ajax_form_tbdrugsell_validate_trancode

  function do_ajax_form_tbdrugsell_validate_trancode_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdrugsell_validate_trancode_cb

  // ---------- Validate struk
  function do_ajax_form_tbdrugsell_validate_struk()
  {
    var nomeCampo_struk = "struk";
    var var_struk = scAjaxGetFieldText(nomeCampo_struk);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdrugsell_validate_struk(var_struk, var_script_case_init, do_ajax_form_tbdrugsell_validate_struk_cb);
  } // do_ajax_form_tbdrugsell_validate_struk

  function do_ajax_form_tbdrugsell_validate_struk_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "struk";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdrugsell_validate_struk_cb

  // ---------- Validate pasien
  function do_ajax_form_tbdrugsell_validate_pasien()
  {
    var nomeCampo_pasien = "pasien";
    var var_pasien = scAjaxGetFieldCheckbox(nomeCampo_pasien, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdrugsell_validate_pasien(var_pasien, var_script_case_init, do_ajax_form_tbdrugsell_validate_pasien_cb);
  } // do_ajax_form_tbdrugsell_validate_pasien

  function do_ajax_form_tbdrugsell_validate_pasien_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pasien";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdrugsell_validate_pasien_cb

  // ---------- Validate custcode
  function do_ajax_form_tbdrugsell_validate_custcode()
  {
    var nomeCampo_custcode = "custcode";
    var var_custcode = scAjaxGetFieldText(nomeCampo_custcode);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdrugsell_validate_custcode(var_custcode, var_script_case_init, do_ajax_form_tbdrugsell_validate_custcode_cb);
  } // do_ajax_form_tbdrugsell_validate_custcode

  function do_ajax_form_tbdrugsell_validate_custcode_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdrugsell_validate_custcode_cb

  // ---------- Validate custname
  function do_ajax_form_tbdrugsell_validate_custname()
  {
    var nomeCampo_custname = "custname";
    var var_custname = scAjaxGetFieldSelect(nomeCampo_custname);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdrugsell_validate_custname(var_custname, var_script_case_init, do_ajax_form_tbdrugsell_validate_custname_cb);
  } // do_ajax_form_tbdrugsell_validate_custname

  function do_ajax_form_tbdrugsell_validate_custname_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdrugsell_validate_custname_cb

  // ---------- Validate extname
  function do_ajax_form_tbdrugsell_validate_extname()
  {
    var nomeCampo_extname = "extname";
    var var_extname = scAjaxGetFieldText(nomeCampo_extname);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdrugsell_validate_extname(var_extname, var_script_case_init, do_ajax_form_tbdrugsell_validate_extname_cb);
  } // do_ajax_form_tbdrugsell_validate_extname

  function do_ajax_form_tbdrugsell_validate_extname_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "extname";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdrugsell_validate_extname_cb

  // ---------- Validate iskaryawan
  function do_ajax_form_tbdrugsell_validate_iskaryawan()
  {
    var nomeCampo_iskaryawan = "iskaryawan";
    var var_iskaryawan = scAjaxGetFieldCheckbox(nomeCampo_iskaryawan, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdrugsell_validate_iskaryawan(var_iskaryawan, var_script_case_init, do_ajax_form_tbdrugsell_validate_iskaryawan_cb);
  } // do_ajax_form_tbdrugsell_validate_iskaryawan

  function do_ajax_form_tbdrugsell_validate_iskaryawan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdrugsell_validate_iskaryawan_cb

  // ---------- Validate total
  function do_ajax_form_tbdrugsell_validate_total()
  {
    var nomeCampo_total = "total";
    var var_total = scAjaxGetFieldText(nomeCampo_total);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdrugsell_validate_total(var_total, var_script_case_init, do_ajax_form_tbdrugsell_validate_total_cb);
  } // do_ajax_form_tbdrugsell_validate_total

  function do_ajax_form_tbdrugsell_validate_total_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "total";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdrugsell_validate_total_cb

  // ---------- Validate trandate
  function do_ajax_form_tbdrugsell_validate_trandate()
  {
    var nomeCampo_trandate = "trandate";
    var var_trandate = scAjaxGetFieldText(nomeCampo_trandate);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdrugsell_validate_trandate(var_trandate, var_script_case_init, do_ajax_form_tbdrugsell_validate_trandate_cb);
  } // do_ajax_form_tbdrugsell_validate_trandate

  function do_ajax_form_tbdrugsell_validate_trandate_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdrugsell_validate_trandate_cb

  // ---------- Validate id
  function do_ajax_form_tbdrugsell_validate_id()
  {
    var nomeCampo_id = "id";
    var var_id = scAjaxGetFieldHidden(nomeCampo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdrugsell_validate_id(var_id, var_script_case_init, do_ajax_form_tbdrugsell_validate_id_cb);
  } // do_ajax_form_tbdrugsell_validate_id

  function do_ajax_form_tbdrugsell_validate_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdrugsell_validate_id_cb

  // ---------- Validate detailsell
  function do_ajax_form_tbdrugsell_validate_detailsell()
  {
    var nomeCampo_detailsell = "detailsell";
    var var_detailsell = scAjaxGetFieldText(nomeCampo_detailsell);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdrugsell_validate_detailsell(var_detailsell, var_script_case_init, do_ajax_form_tbdrugsell_validate_detailsell_cb);
  } // do_ajax_form_tbdrugsell_validate_detailsell

  function do_ajax_form_tbdrugsell_validate_detailsell_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdrugsell_validate_detailsell_cb

  // ---------- Refresh custcode
  function do_ajax_form_tbdrugsell_refresh_custcode()
  {
    var var_custcode = scAjaxGetFieldText("custcode");
    var var_nmgp_refresh_fields = "custcode";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tbdrugsell_refresh_custcode(var_custcode, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_tbdrugsell_refresh_custcode_cb);
  } // do_ajax_form_tbdrugsell_refresh_custcode

  function do_ajax_form_tbdrugsell_refresh_custcode_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdrugsell_refresh_custcode_cb

  // ---------- Event onclick pasien
  function do_ajax_form_tbdrugsell_event_pasien_onclick()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tbdrugsell_event_pasien_onclick(var_pasien, var_custcode, var_custname, var_extname, var_script_case_init, do_ajax_form_tbdrugsell_event_pasien_onclick_cb);
  } // do_ajax_form_tbdrugsell_event_pasien_onclick

  function do_ajax_form_tbdrugsell_event_pasien_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "pasien";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_tbdrugsell_event_pasien_onclick_cb_after_alert);
  } // do_ajax_form_tbdrugsell_event_pasien_onclick_cb
  function do_ajax_form_tbdrugsell_event_pasien_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_tbdrugsell_event_pasien_onclick_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tbdrugsell_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tbdrugsell_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_tbdrugsell_submit_form(var_trancode, var_struk, var_pasien, var_custcode, var_custname, var_extname, var_iskaryawan, var_total, var_trandate, var_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbdrugsell_submit_form_cb);
  } // do_ajax_form_tbdrugsell_submit_form

  function do_ajax_form_tbdrugsell_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tbdrugsell_submit_form_cb_after_alert);
  } // do_ajax_form_tbdrugsell_submit_form_cb
  function do_ajax_form_tbdrugsell_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbdrugsell_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_tbitemdrugsell"] = "off";

  function do_ajax_form_tbdrugsell_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    x_ajax_form_tbdrugsell_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbdrugsell_navigate_form_cb);
  } // do_ajax_form_tbdrugsell_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdrugsell']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbdrugsell_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbdrugsell_navigate_form_cb_after_alert);
  } // do_ajax_form_tbdrugsell_navigate_form_cb
  function do_ajax_form_tbdrugsell_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_tbdrugsell_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_tbdrugsell_navigate_form_cb_after_alert
  function sc_hide_form_tbdrugsell_form()
  {
