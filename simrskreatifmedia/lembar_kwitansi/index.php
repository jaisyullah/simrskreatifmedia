<?php
   include_once('lembar_kwitansi_session.php');
   @session_start() ;
   $_SESSION['scriptcase']['lembar_kwitansi']['glo_nm_perfil']          = "conn_mysql";
   $_SESSION['scriptcase']['lembar_kwitansi']['glo_nm_path_prod']       = "";
   $_SESSION['scriptcase']['lembar_kwitansi']['glo_nm_path_conf']       = "";
   $_SESSION['scriptcase']['lembar_kwitansi']['glo_nm_path_imagens']    = "";
   $_SESSION['scriptcase']['lembar_kwitansi']['glo_nm_path_imag_temp']  = "";
   $_SESSION['scriptcase']['lembar_kwitansi']['glo_nm_path_doc']        = "";
    ...
    //check prod
    if(empty($_SESSION['scriptcase']['lembar_kwitansi']['glo_nm_path_prod']))
    {
            /*check prod*/$_SESSION['scriptcase']['lembar_kwitansi']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
    }
    //check img
    if(empty($_SESSION['scriptcase']['lembar_kwitansi']['glo_nm_path_imagens']))
    {
            /*check img*/$_SESSION['scriptcase']['lembar_kwitansi']['glo_nm_path_imagens'] = $str_path_apl_url . "_lib/file/img";
    }
    //check tmp
    if(empty($_SESSION['scriptcase']['lembar_kwitansi']['glo_nm_path_imag_temp']))
    {
            /*check tmp*/$_SESSION['scriptcase']['lembar_kwitansi']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
    }
    //check doc
    if(empty($_SESSION['scriptcase']['lembar_kwitansi']['glo_nm_path_doc']))
    {
            /*check doc*/$_SESSION['scriptcase']['lembar_kwitansi']['glo_nm_path_doc'] = $str_path_apl_dir . "_lib/file/doc";
    }
    //end check publication with the prod
//
class lembar_kwitansi_ini
{
   var $nm_cod_apl;
   var $nm_nome_apl;
   var $nm_seguranca;
...
//
   function init($Tp_init = "")
   {
      ...
      $_SESSION['sc_session'][$this->sc_page]['lembar_kwitansi']['decimal_db'] = "."; 
      $this->nm_cod_apl      = "lembar_kwitansi"; 
      $this->nm_nome_apl     = ""; 
      $this->nm_seguranca    = ""; 
...
// 
      ...
      $this->sc_protocolo    = "";
      $this->path_prod       = $_SESSION['scriptcase']['lembar_kwitansi']['glo_nm_path_prod'];
      $this->path_conf       = $_SESSION['scriptcase']['lembar_kwitansi']['glo_nm_path_conf'];
      $this->path_imagens    = $_SESSION['scriptcase']['lembar_kwitansi']['glo_nm_path_imagens'];
      $this->path_imag_temp  = $_SESSION['scriptcase']['lembar_kwitansi']['glo_nm_path_imag_temp'];
      $this->path_doc        = $_SESSION['scriptcase']['lembar_kwitansi']['glo_nm_path_doc'];
      ...
      $this->path_aplicacao  = substr($this->path_aplicacao, 0, strrpos($this->path_aplicacao, '/')) . '/lembar_kwitansi';
      ...
      if (isset($_SESSION['scriptcase']['lembar_kwitansi']['session_timeout']['lang'])) {
          $this->str_lang = $_SESSION['scriptcase']['lembar_kwitansi']['session_timeout']['lang'];
      }
      elseif (!isset($_SESSION['scriptcase']['lembar_kwitansi']['actual_lang']) || $_SESSION['scriptcase']['lembar_kwitansi']['actual_lang'] != $this->str_lang) {
          $_SESSION['scriptcase']['lembar_kwitansi']['actual_lang'] = $this->str_lang;
      ...
      {
          include_once("lembar_kwitansi_json.php");
      }
      $this->SC_Link_View = (isset($_SESSION['sc_session'][$this->sc_page]['lembar_kwitansi']['SC_Link_View'])) ? $_SESSION['sc_session'][$this->sc_page]['lembar_kwitansi']['SC_Link_View'] : false;
      if (isset($_GET['SC_Link_View']) && !empty($_GET['SC_Link_View']) && is_numeric($_GET['SC_Link_View']))
      {
          if ($_SESSION['sc_session'][$this->sc_page]['lembar_kwitansi']['embutida'])
          {
              $this->SC_Link_View = true;
              $_SESSION['sc_session'][$this->sc_page]['lembar_kwitansi']['SC_Link_View'] = true;
          }
      }
      if (isset($_POST['nmgp_opcao']) && $_POST['nmgp_opcao'] == "ajax_save_ancor")
      {
          $_SESSION['sc_session'][$this->sc_page]['lembar_kwitansi']['ancor_save'] = $_POST['ancor_save'];
...
<?php
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['lembar_kwitansi']['dashboard_info']['under_dashboard']))
      {
          $_SESSION['sc_session'][$this->sc_page]['lembar_kwitansi']['dashboard_info']['under_dashboard'] = false;
          $_SESSION['sc_session'][$this->sc_page]['lembar_kwitansi']['dashboard_info']['dashboard_app']   = '';
          $_SESSION['sc_session'][$this->sc_page]['lembar_kwitansi']['dashboard_info']['own_widget']      = '';
          $_SESSION['sc_session'][$this->sc_page]['lembar_kwitansi']['dashboard_info']['parent_widget']   = '';
          $_SESSION['sc_session'][$this->sc_page]['lembar_kwitansi']['dashboard_info']['compact_mode']    = false;
          $_SESSION['sc_session'][$this->sc_page]['lembar_kwitansi']['dashboard_info']['remove_margin']   = false;
      }
      if (isset($_GET['under_dashboard']) && 1 == $_GET['under_dashboard'])
      {
          if (isset($_GET['own_widget']) && 'dbifrm_widget' == substr($_GET['own_widget'], 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['lembar_kwitansi']['dashboard_info']['own_widget'] = $_GET['own_widget'];
              $_SESSION['sc_session'][$this->sc_page]['lembar_kwitansi']['dashboard_info']['under_dashboard'] = true;
              if (isset($_GET['dashboard_app'])) {
                  $_SESSION['sc_session'][$this->sc_page]['lembar_kwitansi']['dashboard_info']['dashboard_app'] = $_GET['dashboard_app'];
              }
              if (isset($_GET['parent_widget'])) {
                  $_SESSION['sc_session'][$this->sc_page]['lembar_kwitansi']['dashboard_info']['parent_widget'] = $_GET['parent_widget'];
              }
              if (isset($_GET['compact_mode'])) {
                  $_SESSION['sc_session'][$this->sc_page]['lembar_kwitansi']['dashboard_info']['compact_mode'] = 1 == $_GET['compact_mode'];
              }
              if (isset($_GET['remove_margin'])) {
                  $_SESSION['sc_session'][$this->sc_page]['lembar_kwitansi']['dashboard_info']['remove_margin'] = 1 == $_GET['remove_margin'];
              }
          }
      }
      elseif (isset($under_dashboard) && 1 == $under_dashboard)
      {
          if (isset($own_widget) && 'dbifrm_widget' == substr($own_widget, 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['lembar_kwitansi']['dashboard_info']['own_widget'] = $own_widget;
              $_SESSION['sc_session'][$this->sc_page]['lembar_kwitansi']['dashboard_info']['under_dashboard'] = true;
              if (isset($dashboard_app)) {
                  $_SESSION['sc_session'][$this->sc_page]['lembar_kwitansi']['dashboard_info']['dashboard_app'] = $dashboard_app;
              }
              if (isset($parent_widget)) {
                  $_SESSION['sc_session'][$this->sc_page]['lembar_kwitansi']['dashboard_info']['parent_widget'] = $parent_widget;
              }
              if (isset($compact_mode)) {
                  $_SESSION['sc_session'][$this->sc_page]['lembar_kwitansi']['dashboard_info']['compact_mode'] = 1 == $compact_mode;
              }
              if (isset($remove_margin)) {
                  $_SESSION['sc_session'][$this->sc_page]['lembar_kwitansi']['dashboard_info']['remove_margin'] = 1 == $remove_margin;
              }
          }
      }
      if (!isset($_SESSION['sc_session'][$this->sc_page]['lembar_kwitansi']['dashboard_info']['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['lembar_kwitansi']['dashboard_info']['maximized'] = false;
      }
      if (isset($_GET['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['lembar_kwitansi']['dashboard_info']['maximized'] = 1 == $_GET['maximized'];
      }
      if ($_SESSION['sc_session'][$this->sc_page]['lembar_kwitansi']['dashboard_info']['under_dashboard'])
      {
          $sTmpDashboardApp = $_SESSION['sc_session'][$this->sc_page]['lembar_kwitansi']['dashboard_info']['dashboard_app'];
          if ('' != $sTmpDashboardApp && isset($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["lembar_kwitansi"]))
          {
              foreach ($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["lembar_kwitansi"] as $sTmpTargetLink => $sTmpTargetWidget)
              {
      ...
      if (!is_file($this->root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
      {
          ...
          unset($_SESSION['scriptcase']['lembar_kwitansi']['glo_nm_conexao']);
      }
      ...
      if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['lembar_kwitansi']['session_timeout']['redir']))
      {
      ...
      $_SESSION['sc_session'][$this->sc_page]['lembar_kwitansi']['path_doc'] = $this->path_doc; 
      ...
      if (!is_dir($this->root . $this->path_prod))
      {
          ...
          echo " </tr>";
          echo "</table>";
          if (!$_SESSION['sc_session'][$script_case_init]['lembar_kwitansi']['iframe_menu'] && (!isset($_SESSION['sc_session'][$script_case_init]['lembar_kwitansi']['sc_outra_jan']) || !$_SESSION['sc_session'][$script_case_init]['lembar_kwitansi']['sc_outra_jan'])) 
          { 
...
// 
      include_once($this->path_aplicacao . "lembar_kwitansi_erro.class.php"); 
      $this->Erro = new lembar_kwitansi_erro();
      include_once($this->path_adodb . "/adodb.inc.php"); 
      $this->sc_Include($this->path_libs . "/nm_sec_prod.php", "F", "nm_reg_prod") ; 
      $this->sc_Include($this->path_libs . "/nm_ini_perfil.php", "F", "perfil_lib") ; 
// 
 if(function_exists('set_php_timezone')) set_php_timezone('lembar_kwitansi'); 
// 
      ...
      if (isset($_SESSION['scriptcase']['lembar_kwitansi']['session_timeout']['redir'])) {
          ...
          if ($_SESSION['scriptcase']['lembar_kwitansi']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "  </HEAD>\r\n";
              $SS_cod_html .= "   <body>\r\n";
          }
          else {
              ...
              $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['lembar_kwitansi']['session_timeout']['redir'] . "');\">\r\n";
              $SS_cod_html .= "     </form>\r\n";
          ...
          if ($_SESSION['scriptcase']['lembar_kwitansi']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['lembar_kwitansi']['session_timeout']['redir'] . "');\r\n";
          }
          ...
          $SS_cod_html .= " </body>\r\n";
          $SS_cod_html .= "</HTML>\r\n";
          unset($_SESSION['scriptcase']['lembar_kwitansi']['session_timeout']);
          unset($_SESSION['sc_session']);
      }
      ...
      $_SESSION['sc_session'][$this->sc_page]['lembar_kwitansi']['seq_dir'] = 0; 
      $_SESSION['sc_session'][$this->sc_page]['lembar_kwitansi']['sub_dir'] = array(); 
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
      $this->conectDB();
   ...
   function prep_conect()
   {
      if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
      {
          ...
          {
              if (isset($_SESSION['scriptcase']['lembar_kwitansi']['glo_nm_conexao']) && $_SESSION['scriptcase']['lembar_kwitansi']['glo_nm_conexao'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['lembar_kwitansi']['glo_nm_conexao'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['lembar_kwitansi']['glo_nm_perfil']) && $_SESSION['scriptcase']['lembar_kwitansi']['glo_nm_perfil'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['lembar_kwitansi']['glo_nm_perfil'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['lembar_kwitansi']['glo_con_' . $NM_con_orig]))
              {
                  $_SESSION['scriptcase']['lembar_kwitansi']['glo_con_' . $NM_con_orig] = $NM_con_dest;
              }
          }
      }
      $con_devel             = (isset($_SESSION['scriptcase']['lembar_kwitansi']['glo_nm_conexao'])) ? $_SESSION['scriptcase']['lembar_kwitansi']['glo_nm_conexao'] : ""; 
      $perfil_trab           = ""; 
      $this->nm_falta_var    = ""; 
      $this->nm_falta_var_db = ""; 
      $nm_crit_perfil        = false;
      if (isset($_SESSION['scriptcase']['lembar_kwitansi']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['lembar_kwitansi']['glo_nm_conexao']))
      {
          ob_start();
      ...
      if (isset($_SESSION['scriptcase']['lembar_kwitansi']['glo_nm_perfil']) && !empty($_SESSION['scriptcase']['lembar_kwitansi']['glo_nm_perfil']))
      {
          $perfil_trab = $_SESSION['scriptcase']['lembar_kwitansi']['glo_nm_perfil'];
      }
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['lembar_kwitansi']['embutida_init']) || !$_SESSION['sc_session'][$this->sc_page]['lembar_kwitansi']['embutida_init']) 
      {
      }
// 
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['lembar_kwitansi']['decimal_db'] = $_SESSION['scriptcase']['glo_decimal_db']; 
      }
      if (isset($_SESSION['scriptcase']['glo_date_separator']) && !empty($_SESSION['scriptcase']['glo_date_separator']))
      {
          ...
          if (strlen($SC_temp) == 2)
          {
              $_SESSION['sc_session'][$this->sc_page]['lembar_kwitansi']['SC_sep_date']  = substr($SC_temp, 0, 1); 
              $_SESSION['sc_session'][$this->sc_page]['lembar_kwitansi']['SC_sep_date1'] = substr($SC_temp, 1, 1); 
          }
          else
           {
              $_SESSION['sc_session'][$this->sc_page]['lembar_kwitansi']['SC_sep_date']  = $SC_temp; 
              $_SESSION['sc_session'][$this->sc_page]['lembar_kwitansi']['SC_sep_date1'] = $SC_temp; 
          }
          $this->date_delim  = $_SESSION['sc_session'][$this->sc_page]['lembar_kwitansi']['SC_sep_date'];
          $this->date_delim1 = $_SESSION['sc_session'][$this->sc_page]['lembar_kwitansi']['SC_sep_date1'];
      }
// 
...
<?php
   ...
   function conectDB()
   {
      ...
      if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['lembar_kwitansi']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['lembar_kwitansi']['glo_nm_conexao']))
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['lembar_kwitansi']['glo_nm_conexao'], $this->root . $this->path_prod, 'simrskreatifmedia', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
...
// 
   ...
   function sc_Sql_Protect($var, $tp, $conex="")
   {
       ...
       if ($tp == "date")
       {
           ...
           if (isset($_SESSION['sc_session'][$this->sc_page]['lembar_kwitansi']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->sc_page]['lembar_kwitansi']['SC_sep_date']))
           {
               $delim  = $_SESSION['sc_session'][$this->sc_page]['lembar_kwitansi']['SC_sep_date'];
               $delim1 = $_SESSION['sc_session'][$this->sc_page]['lembar_kwitansi']['SC_sep_date1'];
           }
   ...
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['lembar_kwitansi']['SC_Gb_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['lembar_kwitansi']['SC_Gb_date_format'][$GB][$cmp] : "";
   }

   function Get_Gb_prefix_date_format($GB, $cmp)
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['lembar_kwitansi']['SC_Gb_prefix_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['lembar_kwitansi']['SC_Gb_prefix_date_format'][$GB][$cmp] : "";
   }
...
//----- 
   function controle()
   {
      ...
      $this->Ini = new lembar_kwitansi_ini(); 
      $this->Ini->init();
      $this->Change_Menu = false;
      if (isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['lembar_kwitansi']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['lembar_kwitansi']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['lembar_kwitansi']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['lembar_kwitansi'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['lembar_kwitansi']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['lembar_kwitansi']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('lembar_kwitansi') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['lembar_kwitansi']['label'] = "" . $this->Ini->Nm_lang['lang_othr_blank_title'] . "";
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['lembar_kwitansi']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['lembar_kwitansi']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['lembar_kwitansi']['exit'];
      ...
      $this->Db = $this->Ini->Db; 
      include_once($this->Ini->path_aplicacao . "lembar_kwitansi_erro.class.php"); 
      $this->Erro      = new lembar_kwitansi_erro();
      $this->Erro->Ini = $this->Ini;
//
      $_SESSION['scriptcase']['lembar_kwitansi']['contr_erro'] = 'on';
 ?>
<html>
...
span.cls_004{font-family:Courier New,serif;font-size:10.9px;color:rgb(0,0,0);font-weight:bold;font-style:normal;text-decoration: none}
div.cls_004{font-family:Courier New,serif;font-size:10.9px;color:rgb(0,0,0);font-weight:bold;font-style:normal;text-decoration: none}
span.cls_005{font-family:Arial,serif;font-size:6.3px;color:rgb(0,0,0);font-weight:normal;font-style:normal;text-decoration: none}
div.cls_005{font-family:Arial,serif;font-size:6.3px;color:rgb(0,0,0);font-weight:normal;font-style:normal;text-decoration: none}
span.cls_002{font-family:"Bodoni MT",serif;font-size:10.9px;color:rgb(0,0,0);font-weight:normal;font-style:normal;text-decoration: none}
div.cls_002{font-family:"Bodoni MT",serif;font-size:10.9px;color:rgb(0,0,0);font-weight:normal;font-style:normal;text-decoration: none}
span.cls_006{font-family:Arial,serif;font-size:7.2px;color:rgb(0,0,0);font-weight:normal;font-style:normal;text-decoration: none}
div.cls_006{font-family:Arial,serif;font-size:7.2px;color:rgb(0,0,0);font-weight:normal;font-style:normal;text-decoration: none}
span.cls_007{font-family:Arial,serif;font-size:8.2px;color:rgb(0,0,0);font-weight:normal;font-style:normal;text-decoration: none}
div.cls_007{font-family:Arial,serif;font-size:8.2px;color:rgb(0,0,0);font-weight:normal;font-style:normal;text-decoration: none}
-->
</style>
...
<body>
<div class="class-input" style="width:180px;height:30px;margin-right:0px;text-align:center;background:#428BCA;font-family:Roboto; font-size:14px; font-weight: bold; border: solid 1px #999">
			<div style="height:4px;"></div>
			<a href="javascript:printDiv('printedArea')" style="text-decoration:none; color:#fff; font-weight:bold;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Cetak&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
		</div>	
	
	
<div style="position:absolute;left:50%;margin-left:-306px;top:0px;width:300px;height:792px;overflow:hidden" id="printedArea">
<div style="position:absolute;left:0px;top:0px"></div>
<div style="position:absolute;left:107.90px;top:0.25px" class="cls_003"><span class="cls_003">RUMAH SAKIT  IBU DAN ANAK</span></div>
<div style="position:absolute;left:153.30px;top:11.60px" class="cls_004"><span class="cls_004">AULIA</span></div>
<div style="position:absolute;left:92.40px;top:25.35px" class="cls_005"><span class="cls_005">JL. Jeruk Raya No. 15 Jagakarsa, Jakarta Selatan 12620</span></div>
<div style="position:absolute;left:97.40px;top:33.55px" class="cls_005"><span class="cls_005">Telp. (021) 727 0208, 786 6057 : Fax. (021) 727 0208</span></div>
<div style="position:absolute;left:77.80px;top:49.05px" class="cls_002"><span class="cls_002">KWITANSI No. P/PLB/18/07/0002</span></div>
<div style="position:absolute;left:36.00px;top:72.05px" class="cls_006"><span class="cls_006">Terima Dari</span></div>
<div style="position:absolute;left:108.00px;top:71.90px" class="cls_007"><span class="cls_007">:</span></div>
<div style="position:absolute;left:120.00px;top:72.05px" class="cls_006"><span class="cls_006">NADHIFA NUR UMAIZA, AN.</span></div>
<div style="position:absolute;left:36.00px;top:84.05px" class="cls_006"><span class="cls_006">Uang Sebanyak</span></div>
<div style="position:absolute;left:108.00px;top:83.90px" class="cls_007"><span class="cls_007">:</span></div>
<div style="position:absolute;left:120.00px;top:84.05px" class="cls_006"><span class="cls_006">SERATUS TIGA RIBU DUA RATUS TUJUH</span></div>
<div style="position:absolute;left:120.00px;top:90.45px" class="cls_006"><span class="cls_006">PULUH LIMA RUPIAH</span></div>
<div style="position:absolute;left:36.00px;top:102.05px" class="cls_006"><span class="cls_006">Nama Pasien</span></div>
<div style="position:absolute;left:108.00px;top:101.90px" class="cls_007"><span class="cls_007">:</span></div>
<div style="position:absolute;left:120.00px;top:102.05px" class="cls_006"><span class="cls_006">NADHIFA NUR UMAIZA,AN. (085130)</span></div>
<div style="position:absolute;left:36.00px;top:120.05px" class="cls_006"><span class="cls_006">Dokter</span></div>
<div style="position:absolute;left:108.00px;top:119.90px" class="cls_007"><span class="cls_007">:</span></div>
<div style="position:absolute;left:120.00px;top:120.05px" class="cls_006"><span class="cls_006">DR.IRENE SATHYANINGRUM RATNA K,</span></div>
<div style="position:absolute;left:120.00px;top:129.25px" class="cls_006"><span class="cls_006">DR,</span></div>
<div style="position:absolute;left:36.00px;top:144.05px" class="cls_006"><span class="cls_006">Untuk Pemeriksaan Laboratorium</span></div>
<div style="position:absolute;left:232.50px;top:144.05px" class="cls_006"><span class="cls_006">PLB180100289</span></div>
<div style="position:absolute;left:39.40px;top:162.05px" class="cls_006"><span class="cls_006">No.</span></div>
<div style="position:absolute;left:82.50px;top:162.05px" class="cls_006"><span class="cls_006">Nama Pemeriksaan</span></div>
<div style="position:absolute;left:185.20px;top:162.05px" class="cls_006"><span class="cls_006">Harga</span></div>
<div style="position:absolute;left:221.00px;top:162.05px" class="cls_006"><span class="cls_006">Disc</span></div>
<div style="position:absolute;left:254.20px;top:162.05px" class="cls_006"><span class="cls_006">Harga</span></div>
<div style="position:absolute;left:43.99px;top:176.05px" class="cls_006"><span class="cls_006">1</span></div>
<div style="position:absolute;left:54.00px;top:176.05px" class="cls_006"><span class="cls_006">DARAH LENGKAP</span></div>
<div style="position:absolute;left:162.00px;top:176.05px" class="cls_006"><span class="cls_006">Rp.</span></div>
<div style="position:absolute;left:191.84px;top:176.05px" class="cls_006"><span class="cls_006">71,875</span></div>
<div style="position:absolute;left:226.99px;top:176.05px" class="cls_006"><span class="cls_006">0</span></div>
<div style="position:absolute;left:240.00px;top:176.05px" class="cls_006"><span class="cls_006">Rp.</span></div>
<div style="position:absolute;left:264.74px;top:176.05px" class="cls_006"><span class="cls_006">71,875</span></div>
<div style="position:absolute;left:43.99px;top:194.05px" class="cls_006"><span class="cls_006">2</span></div>
<div style="position:absolute;left:54.00px;top:194.05px" class="cls_006"><span class="cls_006">SARANA LABORATORIUM</span></div>
<div style="position:absolute;left:162.00px;top:194.05px" class="cls_006"><span class="cls_006">Rp.</span></div>
<div style="position:absolute;left:191.84px;top:194.05px" class="cls_006"><span class="cls_006">27,000</span></div>
<div style="position:absolute;left:226.99px;top:194.05px" class="cls_006"><span class="cls_006">0</span></div>
<div style="position:absolute;left:240.00px;top:194.05px" class="cls_006"><span class="cls_006">Rp.</span></div>
<div style="position:absolute;left:264.74px;top:194.05px" class="cls_006"><span class="cls_006">27,000</span></div>
<div style="position:absolute;left:43.99px;top:212.05px" class="cls_006"><span class="cls_006">3</span></div>
<div style="position:absolute;left:54.00px;top:212.05px" class="cls_006"><span class="cls_006">BHP 3 (LANCET, 0,5 ML,</span></div>
<div style="position:absolute;left:162.00px;top:212.05px" class="cls_006"><span class="cls_006">Rp.</span></div>
<div style="position:absolute;left:195.84px;top:212.05px" class="cls_006"><span class="cls_006">4,400</span></div>
<div style="position:absolute;left:226.99px;top:212.05px" class="cls_006"><span class="cls_006">0</span></div>
<div style="position:absolute;left:240.00px;top:212.05px" class="cls_006"><span class="cls_006">Rp.</span></div>
<div style="position:absolute;left:268.74px;top:212.05px" class="cls_006"><span class="cls_006">4,400</span></div>
<div style="position:absolute;left:54.00px;top:221.25px" class="cls_006"><span class="cls_006">KAPAS, OKPLAST)</span></div>
<div style="position:absolute;left:54.00px;top:738.05px" class="cls_006"><span class="cls_006">Biaya administrasi</span></div>
<div style="position:absolute;left:204.00px;top:738.05px" class="cls_006"><span class="cls_006">Rp.</span></div>
<div style="position:absolute;left:287.99px;top:738.05px" class="cls_006"><span class="cls_006">0</span></div>
<div style="position:absolute;left:42.00px;top:750.05px" class="cls_006"><span class="cls_006">Tgl.</span></div>
<div style="position:absolute;left:72.00px;top:750.05px" class="cls_006"><span class="cls_006">21 July 2018</span></div>
<div style="position:absolute;left:162.00px;top:750.05px" class="cls_006"><span class="cls_006">Total</span></div>
<div style="position:absolute;left:204.00px;top:750.05px" class="cls_006"><span class="cls_006">Rp.</span></div>
<div style="position:absolute;left:265.99px;top:750.05px" class="cls_006"><span class="cls_006">103,275</span></div>
<div style="position:absolute;left:42.00px;top:762.05px" class="cls_006"><span class="cls_006">Jam</span></div>
<div style="position:absolute;left:73.99px;top:762.05px" class="cls_006"><span class="cls_006">9:33:33AM</span></div>
<div style="position:absolute;left:162.00px;top:762.05px" class="cls_006"><span class="cls_006">Bayar</span></div>
<div style="position:absolute;left:204.00px;top:762.05px" class="cls_006"><span class="cls_006">Rp.</span></div>
<div style="position:absolute;left:265.99px;top:762.05px" class="cls_006"><span class="cls_006">105,000</span></div>
<div style="position:absolute;left:42.00px;top:774.05px" class="cls_006"><span class="cls_006">Kasir</span></div>
<div style="position:absolute;left:72.00px;top:774.05px" class="cls_006"><span class="cls_006">JAISY_IT</span></div>
<div style="position:absolute;left:162.00px;top:774.05px" class="cls_006"><span class="cls_006">Kembali</span></div>
<div style="position:absolute;left:204.00px;top:774.05px" class="cls_006"><span class="cls_006">Rp.</span></div>
<div style="position:absolute;left:271.20px;top:774.05px" class="cls_006"><span class="cls_006">(1,725)</span></div>
</div>
...
$_SESSION['scriptcase']['lembar_kwitansi']['contr_erro'] = 'off'; 
//--- 
       $this->Db->Close(); 
       if ($this->Change_Menu)
       {
...
//======= =========================
   ...
   if (!empty($_POST))
   {
       foreach ($_POST as $nmgp_var => $nmgp_val)
       {
            ...
            nm_limpa_str_lembar_kwitansi($nmgp_val);
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['lembar_kwitansi']['glo_nm_path_imag_temp'] . "/sc_apl_default_simrskreatifmedia.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['lembar_kwitansi']['glo_nm_path_imag_temp'] . "/sc_apl_default_simrskreatifmedia.txt"));
       }
       if (isset($apl_def)) {
           if ($apl_def[0] != "lembar_kwitansi") {
               $_SESSION['scriptcase']['sem_session'] = true;
               if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                   $_SESSION['scriptcase']['lembar_kwitansi']['session_timeout']['redir'] = $apl_def[0];
               }
               else {
                   $_SESSION['scriptcase']['lembar_kwitansi']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
               }
               $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
               $_SESSION['scriptcase']['lembar_kwitansi']['session_timeout']['redir_tp'] = $Redir_tp;
           }
           if (isset($_COOKIE['sc_actual_lang_simrskreatifmedia'])) {
               $_SESSION['scriptcase']['lembar_kwitansi']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_simrskreatifmedia'];
           }
       }
   }
   ...
   $salva_iframe = false;
   if (isset($_SESSION['sc_session'][$script_case_init]['lembar_kwitansi']['iframe_menu']))
   {
       $salva_iframe = $_SESSION['sc_session'][$script_case_init]['lembar_kwitansi']['iframe_menu'];
       unset($_SESSION['sc_session'][$script_case_init]['lembar_kwitansi']['iframe_menu']);
   }
   if (isset($nm_run_menu) && $nm_run_menu == 1)
   {
        ...
        $_SESSION['scriptcase']['sc_apl_menu_atual'] = "lembar_kwitansi";
        $achou = false;
        if (isset($_SESSION['sc_session'][$script_case_init]))
        {
            foreach ($_SESSION['sc_session'][$script_case_init] as $nome_apl => $resto)
            {
                if ($nome_apl == 'lembar_kwitansi' || $achou)
                {
        ...
        $_SESSION['sc_session'][$script_case_init]['lembar_kwitansi']['iframe_menu'] = true;
   }
   else
   {
       $_SESSION['sc_session'][$script_case_init]['lembar_kwitansi']['iframe_menu'] = $salva_iframe;
   }

   if (!isset($_SESSION['sc_session'][$script_case_init]['lembar_kwitansi']['initialize']))
   {
       $_SESSION['sc_session'][$script_case_init]['lembar_kwitansi']['initialize'] = true;
   }
   elseif (!isset($_SERVER['HTTP_REFERER']))
   {
       $_SESSION['sc_session'][$script_case_init]['lembar_kwitansi']['initialize'] = false;
   }
   ...
   else
   {
       ...
       if ('lembar_kwitansi' == $sReferer || 'lembar_kwitansi_' == substr($sReferer, 0, 16))
       {
           $_SESSION['sc_session'][$script_case_init]['lembar_kwitansi']['initialize'] = false;
       }
       else
   ...
   if (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'lembar_kwitansi')
   {
       $_SESSION['sc_session'][$script_case_init]['lembar_kwitansi']['sc_outra_jan'] = true;
        unset($_SESSION['scriptcase']['sc_outra_jan']);
   }
   $_SESSION['sc_session'][$script_case_init]['lembar_kwitansi']['menu_desenv'] = false;   
   if (!defined("SC_ERROR_HANDLER"))
   {
       define("SC_ERROR_HANDLER", 1);
       include_once(dirname(__FILE__) . "/lembar_kwitansi_erro.php");
   }
   if (!empty($nmgp_parms)) 
   { 
       ...
       while (!empty($todo[$ix]))
       {
            ...
            if (1 < sizeof($cadapar))
            {
                ...
                nm_limpa_str_lembar_kwitansi($cadapar[1]);
   ...
   $contr_lembar_kwitansi = new lembar_kwitansi_apl();
   $contr_lembar_kwitansi->controle();
//
   function nm_limpa_str_lembar_kwitansi(&$str)
   {
