  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbresependoscopy" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbresependoscopy_form();
	}

  // ---------- Validate item_
  function do_ajax_form_tbresependoscopy_validate_item_(iNumLinha)
  {
  } // do_ajax_form_tbresependoscopy_validate_item_

  function do_ajax_form_tbresependoscopy_validate_item__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbresependoscopy_validate_item__cb

  // ---------- Validate satuan_
  function do_ajax_form_tbresependoscopy_validate_satuan_(iNumLinha)
  {
    var nomeCampo_satuan_ = "satuan_" + iNumLinha;
    var var_satuan_ = scAjaxGetFieldSelect(nomeCampo_satuan_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbresependoscopy_validate_satuan_(var_satuan_, iNumLinha, var_script_case_init, do_ajax_form_tbresependoscopy_validate_satuan__cb);
  } // do_ajax_form_tbresependoscopy_validate_satuan_

  function do_ajax_form_tbresependoscopy_validate_satuan__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbresependoscopy_validate_satuan__cb

  // ---------- Validate stok_
  function do_ajax_form_tbresependoscopy_validate_stok_(iNumLinha)
  {
    var nomeCampo_stok_ = "stok_" + iNumLinha;
    var var_stok_ = scAjaxGetFieldSelect(nomeCampo_stok_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbresependoscopy_validate_stok_(var_stok_, iNumLinha, var_script_case_init, do_ajax_form_tbresependoscopy_validate_stok__cb);
  } // do_ajax_form_tbresependoscopy_validate_stok_

  function do_ajax_form_tbresependoscopy_validate_stok__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbresependoscopy_validate_stok__cb

  // ---------- Validate jumlah_
  function do_ajax_form_tbresependoscopy_validate_jumlah_(iNumLinha)
  {
    var nomeCampo_jumlah_ = "jumlah_" + iNumLinha;
    var var_jumlah_ = scAjaxGetFieldText(nomeCampo_jumlah_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbresependoscopy_validate_jumlah_(var_jumlah_, iNumLinha, var_script_case_init, do_ajax_form_tbresependoscopy_validate_jumlah__cb);
  } // do_ajax_form_tbresependoscopy_validate_jumlah_

  function do_ajax_form_tbresependoscopy_validate_jumlah__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbresependoscopy_validate_jumlah__cb

  // ---------- Validate signa_
  function do_ajax_form_tbresependoscopy_validate_signa_(iNumLinha)
  {
    var nomeCampo_signa_ = "signa_" + iNumLinha;
    var var_signa_ = scAjaxGetFieldText(nomeCampo_signa_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbresependoscopy_validate_signa_(var_signa_, iNumLinha, var_script_case_init, do_ajax_form_tbresependoscopy_validate_signa__cb);
  } // do_ajax_form_tbresependoscopy_validate_signa_

  function do_ajax_form_tbresependoscopy_validate_signa__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbresependoscopy_validate_signa__cb

  // ---------- Validate jenisaturanpakai_
  function do_ajax_form_tbresependoscopy_validate_jenisaturanpakai_(iNumLinha)
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbresependoscopy_validate_jenisaturanpakai_(var_jenisaturanpakai_, iNumLinha, var_script_case_init, do_ajax_form_tbresependoscopy_validate_jenisaturanpakai__cb);
  } // do_ajax_form_tbresependoscopy_validate_jenisaturanpakai_

  function do_ajax_form_tbresependoscopy_validate_jenisaturanpakai__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbresependoscopy_validate_jenisaturanpakai__cb

  // ---------- Validate biaya_
  function do_ajax_form_tbresependoscopy_validate_biaya_(iNumLinha)
  {
    var nomeCampo_biaya_ = "biaya_" + iNumLinha;
    var var_biaya_ = scAjaxGetFieldText(nomeCampo_biaya_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbresependoscopy_validate_biaya_(var_biaya_, iNumLinha, var_script_case_init, do_ajax_form_tbresependoscopy_validate_biaya__cb);
  } // do_ajax_form_tbresependoscopy_validate_biaya_

  function do_ajax_form_tbresependoscopy_validate_biaya__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbresependoscopy_validate_biaya__cb

  // ---------- Validate diskon_
  function do_ajax_form_tbresependoscopy_validate_diskon_(iNumLinha)
  {
    var nomeCampo_diskon_ = "diskon_" + iNumLinha;
    var var_diskon_ = scAjaxGetFieldText(nomeCampo_diskon_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbresependoscopy_validate_diskon_(var_diskon_, iNumLinha, var_script_case_init, do_ajax_form_tbresependoscopy_validate_diskon__cb);
  } // do_ajax_form_tbresependoscopy_validate_diskon_

  function do_ajax_form_tbresependoscopy_validate_diskon__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbresependoscopy_validate_diskon__cb

  // ---------- Validate trandate_
  function do_ajax_form_tbresependoscopy_validate_trandate_(iNumLinha)
  {
    var nomeCampo_trandate_ = "trandate_" + iNumLinha;
    var var_trandate_ = scAjaxGetFieldText(nomeCampo_trandate_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbresependoscopy_validate_trandate_(var_trandate_, iNumLinha, var_script_case_init, do_ajax_form_tbresependoscopy_validate_trandate__cb);
  } // do_ajax_form_tbresependoscopy_validate_trandate_

  function do_ajax_form_tbresependoscopy_validate_trandate__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbresependoscopy_validate_trandate__cb

  // ---------- Validate id_
  function do_ajax_form_tbresependoscopy_validate_id_(iNumLinha)
  {
    var nomeCampo_id_ = "id_" + iNumLinha;
    var var_id_ = scAjaxGetFieldHidden(nomeCampo_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbresependoscopy_validate_id_(var_id_, iNumLinha, var_script_case_init, do_ajax_form_tbresependoscopy_validate_id__cb);
  } // do_ajax_form_tbresependoscopy_validate_id_

  function do_ajax_form_tbresependoscopy_validate_id__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbresependoscopy_validate_id__cb

  // ---------- Refresh item_
  function do_ajax_form_tbresependoscopy_refresh_item_(iSeqForm)
  {
    ...
    scAjaxProcOn(true);
    x_ajax_form_tbresependoscopy_refresh_item_(var_item_, var_nmgp_refresh_row, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_tbresependoscopy_refresh_item__cb);
  } // do_ajax_form_tbresependoscopy_refresh_item_

  function do_ajax_form_tbresependoscopy_refresh_item__cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbresependoscopy_refresh_item__cb

  // ---------- Event onchange item_
  function do_ajax_form_tbresependoscopy_event_item__onchange(iSeqForm)
  {
    var var_jumlah_ = scAjaxGetFieldText("jumlah_" + iSeqForm);
    var var_script_case_init = document.F2.script_case_init.value;
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_tbresependoscopy_event_item__onchange(var_jumlah_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_tbresependoscopy_event_item__onchange_cb);
  } // do_ajax_form_tbresependoscopy_event_item__onchange

  function do_ajax_form_tbresependoscopy_event_item__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_tbresependoscopy_event_item__onchange_cb_after_alert);
  } // do_ajax_form_tbresependoscopy_event_item__onchange_cb
  function do_ajax_form_tbresependoscopy_event_item__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    do_ajax_form_tbresependoscopy_refresh_item_(iLineNumber);
    scAjaxRedir();
  } // do_ajax_form_tbresependoscopy_event_item__onchange_cb_after_alert

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_tbresependoscopy_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_tbresependoscopy_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tbresependoscopy_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_tbresependoscopy_add_new_line_cb);
  } // do_ajax_form_tbresependoscopy_add_new_line

  function do_ajax_form_tbresependoscopy_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_tbresependoscopy_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_tbresependoscopy_backup_line(iNumLinha)
  {
    var var_id_ = scAjaxGetFieldHidden("id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbresependoscopy_backup_line(var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_tbresependoscopy_backup_line_cb);
  } // do_ajax_form_tbresependoscopy_backup_line

  function do_ajax_form_tbresependoscopy_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_tbresependoscopy_backup_line_cb

  function do_ajax_form_tbresependoscopy_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_tbresependoscopy_cancel_insert

  function do_ajax_form_tbresependoscopy_cancel_update(iSeqVert)
  {
    do_ajax_form_tbresependoscopy_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_tbresependoscopy_cancel_update

  function do_ajax_form_tbresependoscopy_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_tbresependoscopy_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_tbresependoscopy_table_refresh()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tbresependoscopy_table_refresh(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbresependoscopy_table_refresh_cb);
  } //  do_ajax_form_tbresependoscopy_table_refresh

  function do_ajax_form_tbresependoscopy_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_tbresependoscopy_table_refresh_cb_after_alert);
  } // do_ajax_form_tbresependoscopy_table_refresh_cb
  function do_ajax_form_tbresependoscopy_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxSetNavStatus("t");
    sc_insert_open = false;
  } // do_ajax_form_tbresependoscopy_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_tbresependoscopy_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_tbresependoscopy_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
...
?>
    x_ajax_form_tbresependoscopy_submit_form(var_item_, var_satuan_, var_stok_, var_jumlah_, var_signa_, var_jenisaturanpakai_, var_biaya_, var_diskon_, var_trandate_, var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbresependoscopy_submit_form_cb);
  } // do_ajax_form_tbresependoscopy_submit_form

  function do_ajax_form_tbresependoscopy_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_tbresependoscopy_submit_form_cb_after_alert);
  } // do_ajax_form_tbresependoscopy_submit_form_cb
  function do_ajax_form_tbresependoscopy_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbresependoscopy_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tbresependoscopy_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tbresependoscopy_navigate_form(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbresependoscopy_navigate_form_cb);
  } // do_ajax_form_tbresependoscopy_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbresependoscopy']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbresependoscopy_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbresependoscopy_navigate_form_cb_after_alert);
  } // do_ajax_form_tbresependoscopy_navigate_form_cb
  function do_ajax_form_tbresependoscopy_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_tbresependoscopy_navigate_form_cb_after_alert
  function sc_hide_form_tbresependoscopy_form()
  {
