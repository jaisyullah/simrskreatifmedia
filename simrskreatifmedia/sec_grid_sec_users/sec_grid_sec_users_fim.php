...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____sec_grid_sec_users"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____sec_grid_sec_users"]);
   }
