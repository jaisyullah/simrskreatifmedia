...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_select_formula"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_select_formula"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_select_formula']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_select_formula']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_select_formula']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_select_formula']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_select_formula']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_select_formula</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_select_formula']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_select_formula']['embutida_filho'] as $ind => $sc_init)
          {
