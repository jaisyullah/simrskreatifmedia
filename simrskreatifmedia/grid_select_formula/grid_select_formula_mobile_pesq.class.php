...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_namaformula_cond" name="namaformula_cond" onChange="nm_campos_between(document.getElementById('id_vis_namaformula'), this, 'namaformula')">
      ...
      <br><span id="id_hide_namaformula"  <?php echo $str_hide_namaformula?>><?php
      if ($namaformula != "")
      {
      $namaformula_look = substr($this->Db->qstr($namaformula), 1, -1); 
      $nmgp_def_dados = array(); 
