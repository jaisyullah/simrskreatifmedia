...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_harga_rad"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_harga_rad"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_harga_rad']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_harga_rad']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_harga_rad']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_harga_rad']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_harga_rad']['sc_modal']);
           if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_harga_rad']['opc_psq']))
           {
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_harga_rad']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_harga_rad']['embutida_filho'] as $ind => $sc_init)
          {
