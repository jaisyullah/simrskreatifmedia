...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "a_ratecon";$Nm_numeric[] = "a_ratenoncon";$Nm_numeric[] = "a_`share`";$Nm_numeric[] = "a_ratecon";$Nm_numeric[] = "a_ratenoncon";$Nm_numeric[] = "a_`share`";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_nama"  <?php echo $str_hide_nama?>>
<?php
