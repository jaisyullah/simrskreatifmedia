  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_hrm_rkk_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_hrm_rkk_mob_form();
	}

  // ---------- Validate id
  function do_ajax_form_hrm_rkk_mob_validate_id()
  {
    var nomeCampo_id = "id";
    var var_id = scAjaxGetFieldHidden(nomeCampo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_rkk_mob_validate_id(var_id, var_script_case_init, do_ajax_form_hrm_rkk_mob_validate_id_cb);
  } // do_ajax_form_hrm_rkk_mob_validate_id

  function do_ajax_form_hrm_rkk_mob_validate_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_rkk_mob_validate_id_cb

  // ---------- Validate deskripsi_rkk
  function do_ajax_form_hrm_rkk_mob_validate_deskripsi_rkk()
  {
    var nomeCampo_deskripsi_rkk = "deskripsi_rkk";
    var var_deskripsi_rkk = scAjaxGetFieldText(nomeCampo_deskripsi_rkk);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_rkk_mob_validate_deskripsi_rkk(var_deskripsi_rkk, var_script_case_init, do_ajax_form_hrm_rkk_mob_validate_deskripsi_rkk_cb);
  } // do_ajax_form_hrm_rkk_mob_validate_deskripsi_rkk

  function do_ajax_form_hrm_rkk_mob_validate_deskripsi_rkk_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "deskripsi_rkk";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_rkk_mob_validate_deskripsi_rkk_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_hrm_rkk_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_hrm_rkk_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id = scAjaxGetFieldHidden("id");
    var var_deskripsi_rkk = scAjaxGetFieldText("deskripsi_rkk");
    ...
    scAjaxProcOn();
    x_ajax_form_hrm_rkk_mob_submit_form(var_id, var_deskripsi_rkk, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_hrm_rkk_mob_submit_form_cb);
  } // do_ajax_form_hrm_rkk_mob_submit_form

  function do_ajax_form_hrm_rkk_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("deskripsi_rkk");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_hrm_rkk_mob_submit_form_cb_after_alert);
  } // do_ajax_form_hrm_rkk_mob_submit_form_cb
  function do_ajax_form_hrm_rkk_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_hrm_rkk_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_hrm_rkk_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_hrm_rkk_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_hrm_rkk_mob_navigate_form_cb);
  } // do_ajax_form_hrm_rkk_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_hrm_rkk_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_hrm_rkk_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_hrm_rkk_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_hrm_rkk_mob_navigate_form_cb
  function do_ajax_form_hrm_rkk_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_hrm_rkk_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_hrm_rkk_mob_navigate_form_cb_after_alert
  function sc_hide_form_hrm_rkk_mob_form()
  {
  ...
  ajax_field_list[1] = "deskripsi_rkk";
  ...
  var ajax_error_list = {
    ...
    "deskripsi_rkk": {"label": "Deskripsi Rkk", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "id": new Array(),
    "deskripsi_rkk": new Array()
  };
  ajax_field_mult["id"][1] = "id";
  ajax_field_mult["deskripsi_rkk"][1] = "deskripsi_rkk";

  var ajax_field_id = {
    "id": new Array("hidden_field_label_id", "hidden_field_data_id"),
    "deskripsi_rkk": new Array("hidden_field_label_deskripsi_rkk", "hidden_field_data_deskripsi_rkk")
  };
