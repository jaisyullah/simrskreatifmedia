...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "id";$Nm_numeric[] = "parent_id";$Nm_numeric[] = "id";$Nm_numeric[] = "parent_id";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_parent_id_cond" name="parent_id_cond" onChange="nm_campos_between(document.getElementById('id_vis_parent_id'), this, 'parent_id')">
      ...
      <br><span id="id_hide_parent_id"  <?php echo $str_hide_parent_id?>><?php
      if ($parent_id != "")
      {
      $parent_id_look = substr($this->Db->qstr($parent_id), 1, -1); 
      $nmgp_def_dados = array(); 
