<?php
@session_start() ;
$_SESSION['scriptcase']['grid_approvalusulanpengadaan_gizi']['sc_process_barr'] = true;
require_once('../grid_approvalusulanpengadaan_gizi/index.php');
unset($_SESSION['scriptcase']['grid_approvalusulanpengadaan_gizi']['sc_process_barr']);
$ExportCtrl = new grid_approvalusulanpengadaan_gizi_export_control;
$ExportCtrl->Export_barr();

class grid_approvalusulanpengadaan_gizi_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - usulan pengadaan :: Excel</TITLE>
