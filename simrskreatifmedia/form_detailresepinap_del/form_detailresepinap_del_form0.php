...
<HEAD>
 <TITLE><?php if ('novo' == $this->nmgp_opcao) { echo strip_tags("" . $this->Ini->Nm_lang['lang_othr_frmi_title'] . " tbreseprawatinap"); } else { echo strip_tags("" . $this->Ini->Nm_lang['lang_othr_frmu_title'] . " tbreseprawatinap"); } ?></TITLE>
...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detailresepinap_del']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_detailresepinap_del/form_detailresepinap_del_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_detailresepinap_del_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_detailresepinap_del_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_detailresepinap_del']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_detailresepinap_del']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_detailresepinap_del']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_detailresepinap_del']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_detailresepinap_del']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detailresepinap_del']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detailresepinap_del']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detailresepinap_del']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
?>
...
<?php
 include_once("form_detailresepinap_del_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_detailresepinap_del']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_detailresepinap_del']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_detailresepinap_del'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_detailresepinap_del'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detailresepinap_del']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_detailresepinap_del']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_detailresepinap_del']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_detailresepinap_del']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['form_detailresepinap_del']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<div class="scFormHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFormHeaderFont" style="float: left; text-transform: uppercase;"><?php if ($this->nmgp_opcao == "novo") { echo "" . $this->Ini->Nm_lang['lang_othr_frmi_title'] . " tbreseprawatinap"; } else { echo "" . $this->Ini->Nm_lang['lang_othr_frmu_title'] . " tbreseprawatinap"; } ?></div>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_detailresepinap_del']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detailresepinap_del']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detailresepinap_del']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_detailresepinap_del']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detailresepinap_del']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detailresepinap_del']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detailresepinap_del']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_detailresepinap_del']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detailresepinap_del']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_detailresepinap_del']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detailresepinap_del']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_detailresepinap_del']['fast_search'][2] : "";
?> 
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detailresepinap_del']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detailresepinap_del']['run_iframe'] != "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detailresepinap_del']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_detailresepinap_del']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_detailresepinap_del']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_detailresepinap_del']['run_iframe'] == "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detailresepinap_del']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_detailresepinap_del']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detailresepinap_del']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_detailresepinap_del']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detailresepinap_del']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detailresepinap_del']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detailresepinap_del']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_detailresepinap_del']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_detailresepinap_del']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_detailresepinap_del']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_detailresepinap_del']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detailresepinap_del']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php } else { ?>
<span id="id_read_on_item" class="sc-ui-readonly-item css_item_line" style="<?php echo $sStyleReadLab_item; ?>"><?php echo $this->item; ?></span><span id="id_read_off_item" class="css_read_off_item" style="white-space: nowrap;<?php echo $sStyleReadInp_item; ?>">
 <input class="sc-js-input scFormObjectOdd css_item_obj" style="" id="id_sc_field_item" type=text name="item" value="<?php echo $this->form_encode_input($item) ?>"
...
<input type="hidden" name="satuan" value="<?php echo $this->form_encode_input($satuan) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>
...
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["satuan"]) &&  $this->nmgp_cmp_readonly["satuan"] == "on") { 
 ...
 ?>
<input type="hidden" name="satuan" value="<?php echo $this->form_encode_input($satuan) . "\">" . $satuan . ""; ?>
<?php } else { ?>
<span id="id_read_on_satuan" class="sc-ui-readonly-satuan css_satuan_line" style="<?php echo $sStyleReadLab_satuan; ?>"><?php echo $this->satuan; ?></span><span id="id_read_off_satuan" class="css_read_off_satuan" style="white-space: nowrap;<?php echo $sStyleReadInp_satuan; ?>">
 <input class="sc-js-input scFormObjectOdd css_satuan_obj" style="" id="id_sc_field_satuan" type=text name="satuan" value="<?php echo $this->form_encode_input($satuan) ?>"
 size=25 maxlength=25 alt="{datatype: 'text', maxLength: 25, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
...
<span id="id_read_on_jumlah" class="sc-ui-readonly-jumlah css_jumlah_line" style="<?php echo $sStyleReadLab_jumlah; ?>"><?php echo $this->jumlah; ?></span><span id="id_read_off_jumlah" class="css_read_off_jumlah" style="white-space: nowrap;<?php echo $sStyleReadInp_jumlah; ?>">
 ...
 size=2 alt="{datatype: 'integer', maxLength: 2, thousandsSep: '<?php echo str_replace("'", "\'", $this->field_config['jumlah']['symbol_grp']); ?>', thousandsFormat: <?php echo $this->field_config['jumlah']['symbol_fmt']; ?>, allowNegative: false, onlyNegative: false, negativePos: <?php echo (4 == $this->field_config['jumlah']['format_neg'] ? "'suffix'" : "'prefix'") ?>, alignment: 'left', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    ...
    {
        $this->nm_new_label['jenisaturanpakai'] = "Jenis Aturan Pakai";
    }
?>
<?php
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
...
<?php } else { ?>
<span id="id_read_on_jenisaturanpakai" class="sc-ui-readonly-jenisaturanpakai css_jenisaturanpakai_line" style="<?php echo $sStyleReadLab_jenisaturanpakai; ?>"><?php echo $this->jenisaturanpakai; ?></span><span id="id_read_off_jenisaturanpakai" class="css_read_off_jenisaturanpakai" style="white-space: nowrap;<?php echo $sStyleReadInp_jenisaturanpakai; ?>">
 <input class="sc-js-input scFormObjectOdd css_jenisaturanpakai_obj" style="" id="id_sc_field_jenisaturanpakai" type=text name="jenisaturanpakai" value="<?php echo $this->form_encode_input($jenisaturanpakai) ?>"
 size=25 maxlength=25 alt="{datatype: 'text', maxLength: 25, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
...
<span id="id_read_on_biaya" class="sc-ui-readonly-biaya css_biaya_line" style="<?php echo $sStyleReadLab_biaya; ?>"><?php echo $this->biaya; ?></span><span id="id_read_off_biaya" class="css_read_off_biaya" style="white-space: nowrap;<?php echo $sStyleReadInp_biaya; ?>">
 ...
 size=8 alt="{datatype: 'integer', maxLength: 8, thousandsSep: '<?php echo str_replace("'", "\'", $this->field_config['biaya']['symbol_grp']); ?>', thousandsFormat: <?php echo $this->field_config['biaya']['symbol_fmt']; ?>, allowNegative: false, onlyNegative: false, negativePos: <?php echo (4 == $this->field_config['biaya']['format_neg'] ? "'suffix'" : "'prefix'") ?>, alignment: 'left', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detailresepinap_del']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detailresepinap_del']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_detailresepinap_del']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_detailresepinap_del']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_detailresepinap_del']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detailresepinap_del']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detailresepinap_del']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detailresepinap_del']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detailresepinap_del']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detailresepinap_del']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_detailresepinap_del']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_detailresepinap_del");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_detailresepinap_del");
 parent.scAjaxDetailHeight("form_detailresepinap_del", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_detailresepinap_del']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
