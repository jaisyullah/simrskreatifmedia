...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_tbadmrawatinap"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_tbadmrawatinap"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_tbadmrawatinap'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tbadmrawatinap']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_tbadmrawatinap']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tbadmrawatinap']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_tbadmrawatinap']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_tbadmrawatinap']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_tbadmrawatinap</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_tbadmrawatinap']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_tbadmrawatinap']['embutida_filho'] as $ind => $sc_init)
          {
