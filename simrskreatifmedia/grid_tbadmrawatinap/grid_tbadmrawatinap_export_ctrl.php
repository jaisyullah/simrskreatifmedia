<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tbadmrawatinap']['sc_process_barr'] = true;
require_once('../grid_tbadmrawatinap/index.php');
unset($_SESSION['scriptcase']['grid_tbadmrawatinap']['sc_process_barr']);
$ExportCtrl = new grid_tbadmrawatinap_export_control;
$ExportCtrl->Export_barr();

class grid_tbadmrawatinap_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - Admisi Rawat Inap :: Excel</TITLE>
