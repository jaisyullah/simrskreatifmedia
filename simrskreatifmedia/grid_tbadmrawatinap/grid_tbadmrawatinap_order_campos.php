<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_tbadmrawatinap']['glo_nm_path_imag_temp'] . "/sc_apl_default_simrskreatifmedia.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_tbadmrawatinap_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_tbadmrawatinap_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbadmrawatinap']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tbadmrawatinap']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["trancode"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbadmrawatinap']['labels']["trancode"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbadmrawatinap']['labels']["trancode"] : "Kode Transaksi";
   ...
   $tab_labels["custcode"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbadmrawatinap']['labels']["custcode"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbadmrawatinap']['labels']["custcode"] : "No RM";
   ...
   {
       $tab_def_campos['nama'] = "concat(b.name,', ',b.salut)";
   }
   $tab_labels["nama"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbadmrawatinap']['labels']["nama"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbadmrawatinap']['labels']["nama"] : "Nama";
   ...
   $tab_labels["sc_field_0"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbadmrawatinap']['labels']["sc_field_0"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbadmrawatinap']['labels']["sc_field_0"] : "Tgl. Lahir";
   $tab_ger_campos['doctor'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['doctor'] = "doctor";
   }
   else
   {
       $tab_def_campos['doctor'] = "a.doctor";
   }
   $tab_labels["doctor"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbadmrawatinap']['labels']["doctor"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbadmrawatinap']['labels']["doctor"] : "Doctor";
   ...
   {
       $tab_def_campos['tglmasuk'] = "a.tglMasuk";
   }
   $tab_labels["tglmasuk"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbadmrawatinap']['labels']["tglmasuk"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbadmrawatinap']['labels']["tglmasuk"] : "Tgl Masuk";
   ...
   {
       $tab_def_campos['bed'] = "a.bed";
   }
   $tab_labels["bed"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbadmrawatinap']['labels']["bed"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbadmrawatinap']['labels']["bed"] : "Bed";
   $tab_ger_campos['pembayaran'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['pembayaran'] = "pembayaran";
   }
   else
   {
       $tab_def_campos['pembayaran'] = "a.pembayaran";
   }
   $tab_labels["pembayaran"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbadmrawatinap']['labels']["pembayaran"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbadmrawatinap']['labels']["pembayaran"] : "Pembayaran";
   ...
   {
       $tab_def_campos['kelas'] = "a.kelas";
   }
   $tab_labels["kelas"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbadmrawatinap']['labels']["kelas"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbadmrawatinap']['labels']["kelas"] : "Kelas";
   ...
   $tab_labels["diagnosa1"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbadmrawatinap']['labels']["diagnosa1"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbadmrawatinap']['labels']["diagnosa1"] : "Diagnosa 1";
   $tab_ger_campos['caramasuk'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['caramasuk'] = "caramasuk";
   }
   else
   {
       $tab_def_campos['caramasuk'] = "a.caraMasuk";
   }
   $tab_labels["caramasuk"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbadmrawatinap']['labels']["caramasuk"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbadmrawatinap']['labels']["caramasuk"] : "Cara Masuk";
   ...
   $tab_labels["status"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbadmrawatinap']['labels']["status"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbadmrawatinap']['labels']["status"] : "Status";
   ...
   {
       $tab_def_campos['sc_field_1'] = "SELECT tglKeluar 
FROM tbdetailrawatinap 
WHERE tranCode = '{tranCode}' 
ORDER BY tglKeluar";
   }
   $tab_labels["sc_field_1"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbadmrawatinap']['labels']["sc_field_1"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbadmrawatinap']['labels']["sc_field_1"] : "Tgl. Keluar";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_tbadmrawatinap']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_tbadmrawatinap']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_tbadmrawatinap']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbadmrawatinap']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tbadmrawatinap']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_tbadmrawatinap']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_tbadmrawatinap']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_tbadmrawatinap']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_tbadmrawatinap']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - Admisi Rawat Inap</TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_tbadmrawatinap_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_tbadmrawatinap']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_tbadmrawatinap']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_tbadmrawatinap']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_tbadmrawatinap']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_tbadmrawatinap']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
