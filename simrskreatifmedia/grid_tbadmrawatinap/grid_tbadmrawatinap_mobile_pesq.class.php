...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "a.tglMasuk";$Nm_datas[] = "a_tglMasuk";$Nm_numeric[] = "a_id";$Nm_numeric[] = "a_struckno";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_doctor"  <?php echo $str_hide_doctor?>><?php
      if ($doctor != "")
      {
      $doctor_look = substr($this->Db->qstr($doctor), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_pembayaran"  <?php echo $str_hide_pembayaran?>><?php
      if ($pembayaran != "")
      {
      $pembayaran_look = substr($this->Db->qstr($pembayaran), 1, -1); 
      $nmgp_def_dados = array(); 
