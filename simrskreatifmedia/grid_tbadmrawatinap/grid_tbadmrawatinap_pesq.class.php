...
class grid_tbadmrawatinap_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbadmrawatinap']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_tbadmrawatinap_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_tbadmrawatinap_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_tbadmrawatinap_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_pembayaran')
      {
          $pembayaran = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_pembayaran($pembayaran);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function lookup_ajax_custcode($custcode)
   {
      ...
      $nm_comando = "select distinct a.custCode from " . $this->Ini->nm_tabela . " where a.status != 'Batal' and  a.custCode like '%" . $custcode . "%' order by a.custCode"; 
      unset($cmp1,$cmp2);
   ...
   function lookup_ajax_diagnosa1($diagnosa1)
   {
      ...
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct a.diagnosa1 from " . $this->Ini->nm_tabela . " where a.status != 'Batal' and  a.diagnosa1 like '%" . $diagnosa1 . "%' order by a.diagnosa1"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
   ...
   function lookup_ajax_doctor($doctor)
   {
      ...
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct a.doctor from " . $this->Ini->nm_tabela . " where a.status != 'Batal' and  a.doctor like '%" . $doctor . "%' order by a.doctor"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
   ...
   function lookup_ajax_pembayaran($pembayaran)
   {
      $pembayaran = substr($this->Db->qstr($pembayaran), 1, -1);
            $pembayaran_look = substr($this->Db->qstr($pembayaran), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct a.pembayaran from " . $this->Ini->nm_tabela . " where a.status != 'Batal' and  a.pembayaran like '%" . $pembayaran . "%' order by a.pembayaran"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
   ...
   function lookup_ajax_kelas($kelas)
   {
      ...
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct a.kelas from " . $this->Ini->nm_tabela . " where a.status != 'Batal' and  a.kelas like '%" . $kelas . "%' order by a.kelas"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbadmrawatinap']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbadmrawatinap']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbadmrawatinap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbadmrawatinap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbadmrawatinap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbadmrawatinap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbadmrawatinap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbadmrawatinap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbadmrawatinap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbadmrawatinap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbadmrawatinap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbadmrawatinap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbadmrawatinap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbadmrawatinap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbadmrawatinap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbadmrawatinap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbadmrawatinap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - Admisi Rawat Inap</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_tbadmrawatinap/grid_tbadmrawatinap_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_tbadmrawatinap_ajax_search.js"></script>
 <script type="text/javascript" src="grid_tbadmrawatinap_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_tbadmrawatinap_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_tbadmrawatinap']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_tbadmrawatinap']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_pembayaran_cond#NMF#' + search_get_sel_txt('SC_pembayaran_cond') + '@NMF@';
  str_out += 'SC_pembayaran#NMF#' + search_get_text('SC_pembayaran') + '@NMF@';
  str_out += 'id_ac_pembayaran#NMF#' + search_get_text('id_ac_pembayaran') + '@NMF@';
   ...
   $("#id_ac_pembayaran").autocomplete({
     ...
     $.ajax({
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_pembayaran",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_pembayaran").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     focus: function (event, ui) {
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbadmrawatinap']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div class="scFilterHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFilterHeaderFont" style="float: left; text-transform: uppercase;"><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - Admisi Rawat Inap</div>
...
<?php
   ...
   function monta_form()
   {
      global 
             ...
             $pembayaran_cond, $pembayaran, $pembayaran_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbadmrawatinap']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbadmrawatinap']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbadmrawatinap']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbadmrawatinap']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $custcode = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbadmrawatinap']['campos_busca']['custcode']; 
          $custcode_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbadmrawatinap']['campos_busca']['custcode_cond']; 
          $nama = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbadmrawatinap']['campos_busca']['nama']; 
          $nama_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbadmrawatinap']['campos_busca']['nama_cond']; 
          $diagnosa1 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbadmrawatinap']['campos_busca']['diagnosa1']; 
          $diagnosa1_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbadmrawatinap']['campos_busca']['diagnosa1_cond']; 
          $doctor = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbadmrawatinap']['campos_busca']['doctor']; 
          $doctor_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbadmrawatinap']['campos_busca']['doctor_cond']; 
          $pembayaran = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbadmrawatinap']['campos_busca']['pembayaran']; 
          $pembayaran_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbadmrawatinap']['campos_busca']['pembayaran_cond']; 
          $kelas = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbadmrawatinap']['campos_busca']['kelas']; 
          $kelas_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbadmrawatinap']['campos_busca']['kelas_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbadmrawatinap']['campos_busca']['NM_operador']; 
      } 
      ...
      $str_hide_pembayaran = (in_array($pembayaran_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      {
         $tmp_pos = strpos($pembayaran, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $pembayaran = substr($pembayaran, 0, $tmp_pos);
         }
      }
...
<?php
      ...
      $custcode_look = substr($this->Db->qstr($custcode), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct a.custCode from " . $this->Ini->nm_tabela . " where a.status != 'Batal' and a.custCode = '$custcode_look' order by a.custCode"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_custcode" name="custcode_autocomp" size="18"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 18, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
<?php
      ...
      $diagnosa1_look = substr($this->Db->qstr($diagnosa1), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct a.diagnosa1 from " . $this->Ini->nm_tabela . " where a.status != 'Batal' and a.diagnosa1 = '$diagnosa1_look' order by a.diagnosa1"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
...
?>
<INPUT  type="text" id="SC_diagnosa1" name="diagnosa1" value="<?php echo NM_encode_input($diagnosa1) ?>"  size=50 alt="{datatype: 'text', maxLength: 150, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_diagnosa1" name="diagnosa1_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 150, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_doctor_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['doctor'])) ? $this->New_label['doctor'] : "Doctor"; ?></TD>
...
<?php
      ...
      $doctor_look = substr($this->Db->qstr($doctor), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct a.doctor from " . $this->Ini->nm_tabela . " where a.status != 'Batal' and a.doctor = '$doctor_look' order by a.doctor"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
...
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_doctor" name="doctor_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 150, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_pembayaran_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['pembayaran'])) ? $this->New_label['pembayaran'] : "Pembayaran"; ?></TD>
      
      <INPUT type="hidden" id="SC_pembayaran_cond" name="pembayaran_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_pembayaran" <?php echo $str_hide_pembayaran?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['pembayaran'])) ? $this->New_label['pembayaran'] : "Pembayaran";
 $nmgp_tab_label .= "pembayaran?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      $pembayaran_look = substr($this->Db->qstr($pembayaran), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct a.pembayaran from " . $this->Ini->nm_tabela . " where a.status != 'Batal' and a.pembayaran = '$pembayaran_look' order by a.pembayaran"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      if (isset($nmgp_def_dados[0][$pembayaran]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$pembayaran];
      }
      else
      {
          $sAutocompValue = $pembayaran;
      }
?>
<INPUT  type="text" id="SC_pembayaran" name="pembayaran" value="<?php echo NM_encode_input($pembayaran) ?>"  size=45 alt="{datatype: 'text', maxLength: 45, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_pembayaran" name="pembayaran_autocomp" size="45"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 45, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
<?php
      ...
      $kelas_look = substr($this->Db->qstr($kelas), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct a.kelas from " . $this->Ini->nm_tabela . " where a.status != 'Batal' and a.kelas = '$kelas_look' order by a.kelas"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
...
?>
<INPUT  type="text" id="SC_kelas" name="kelas" value="<?php echo NM_encode_input($kelas) ?>"  size=45 alt="{datatype: 'text', maxLength: 45, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_kelas" name="kelas_autocomp" size="45"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 45, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
?>
<?php
   if (is_file("grid_tbadmrawatinap_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_tbadmrawatinap']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_tbadmrawatinap']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbadmrawatinap']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   nm_campos_between(document.getElementById('id_vis_pembayaran'), document.F1.pembayaran_cond, 'pembayaran');
   document.F1.pembayaran.value = "";
   document.F1.pembayaran_autocomp.value = "";
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "simrskreatifmedia/grid_tbadmrawatinap";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbadmrawatinap']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbadmrawatinap']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbadmrawatinap']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_pembayaran_cond'] = 'cond';
      $tp_fields['SC_pembayaran'] = 'text_aut';
      $tp_fields['id_ac_pembayaran'] = 'text_aut';
   ...
   function trata_campos()
   {
      global $custcode_cond, $custcode, $custcode_autocomp,
             ...
             $doctor_cond, $doctor, $doctor_autocomp,
             $pembayaran_cond, $pembayaran, $pembayaran_autocomp,
             $kelas_cond, $kelas, $kelas_autocomp, $nmgp_tab_label;
      ...
      if (!empty($pembayaran_autocomp) && empty($pembayaran))
      {
          $pembayaran = $pembayaran_autocomp;
      }
      ...
      $pembayaran_cond_salva = $pembayaran_cond; 
      if (!isset($pembayaran_input_2) || $pembayaran_input_2 == "")
      {
          $pembayaran_input_2 = $pembayaran;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbadmrawatinap']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbadmrawatinap']['campos_busca']['custcode'] = $custcode; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbadmrawatinap']['campos_busca']['custcode_cond'] = $custcode_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbadmrawatinap']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbadmrawatinap']['campos_busca']['nama'] = $nama; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbadmrawatinap']['campos_busca']['nama_cond'] = $nama_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbadmrawatinap']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbadmrawatinap']['campos_busca']['diagnosa1'] = $diagnosa1; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbadmrawatinap']['campos_busca']['diagnosa1_cond'] = $diagnosa1_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbadmrawatinap']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbadmrawatinap']['campos_busca']['doctor'] = $doctor; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbadmrawatinap']['campos_busca']['doctor_cond'] = $doctor_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbadmrawatinap']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbadmrawatinap']['campos_busca']['pembayaran'] = $pembayaran; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbadmrawatinap']['campos_busca']['pembayaran_cond'] = $pembayaran_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbadmrawatinap']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbadmrawatinap']['campos_busca']['kelas'] = $kelas; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbadmrawatinap']['campos_busca']['kelas_cond'] = $kelas_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbadmrawatinap']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbadmrawatinap']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbadmrawatinap']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['pembayaran'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['pembayaran'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['pembayaran'] = $pembayaran;
      }
      $kelas_look = substr($this->Db->qstr($kelas), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct a.kelas from " . $this->Ini->nm_tabela . " where a.status != 'Batal' and a.kelas = '$kelas_look' order by a.kelas"; 
      ...
      {
         $this->monta_condicao("concat(b.name,', ',b.salut)", $nama_cond, $nama, "", "nama");
      }
      ...
      {
         $this->monta_condicao("a.doctor", $doctor_cond, $doctor, "", "doctor");
      }

      //----- $pembayaran
      $this->Date_part = false;
      if (isset($pembayaran) || $pembayaran_cond == "nu" || $pembayaran_cond == "nn" || $pembayaran_cond == "ep" || $pembayaran_cond == "ne")
      {
         $this->monta_condicao("a.pembayaran", $pembayaran_cond, $pembayaran, "", "pembayaran");
      }
      ...
      {
         $this->monta_condicao("a.kelas", $kelas_cond, $kelas, "", "kelas");
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbadmrawatinap']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbadmrawatinap']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbadmrawatinap']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbadmrawatinap']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbadmrawatinap']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbadmrawatinap']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbadmrawatinap']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbadmrawatinap']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbadmrawatinap']['cond_pesq'] .= $this->NM_operador;
