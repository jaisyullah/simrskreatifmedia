...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_kodedepo_cond" name="kodedepo_cond" onChange="nm_campos_between(document.getElementById('id_vis_kodedepo'), this, 'kodedepo')">
      ...
      <br><span id="id_hide_kodedepo"  <?php echo $str_hide_kodedepo?>><?php
      if ($kodedepo != "")
      {
      $kodedepo_look = substr($this->Db->qstr($kodedepo), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_namadepo_cond" name="namadepo_cond" onChange="nm_campos_between(document.getElementById('id_vis_namadepo'), this, 'namadepo')">
      ...
      <br><span id="id_hide_namadepo"  <?php echo $str_hide_namadepo?>><?php
      if ($namadepo != "")
      {
      $namadepo_look = substr($this->Db->qstr($namadepo), 1, -1); 
      $nmgp_def_dados = array(); 
