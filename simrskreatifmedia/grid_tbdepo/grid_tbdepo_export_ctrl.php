<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tbdepo']['sc_process_barr'] = true;
require_once('../grid_tbdepo/index.php');
unset($_SESSION['scriptcase']['grid_tbdepo']['sc_process_barr']);
$ExportCtrl = new grid_tbdepo_export_control;
$ExportCtrl->Export_barr();

class grid_tbdepo_export_control
{
