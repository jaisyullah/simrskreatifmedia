...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "deleted";$Nm_numeric[] = "deleted";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_code_cond" name="code_cond" onChange="nm_campos_between(document.getElementById('id_vis_code'), this, 'code')">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_deleted_cond" name="deleted_cond" onChange="nm_campos_between(document.getElementById('id_vis_deleted'), this, 'deleted')">
      ...
      <br><span id="id_hide_deleted"  <?php echo $str_hide_deleted?>><?php
      if ($deleted != "")
      {
      $deleted_look = substr($this->Db->qstr($deleted), 1, -1); 
      $nmgp_def_dados = array(); 
