<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tbjenislain']['sc_process_barr'] = true;
require_once('../grid_tbjenislain/index.php');
unset($_SESSION['scriptcase']['grid_tbjenislain']['sc_process_barr']);
$ExportCtrl = new grid_tbjenislain_export_control;
$ExportCtrl->Export_barr();

class grid_tbjenislain_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_title'] ?> tbjenislain :: Excel</TITLE>
