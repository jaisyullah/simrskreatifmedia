<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tbdetailigdF']['sc_process_barr'] = true;
require_once('../grid_tbdetailigdF/index.php');
unset($_SESSION['scriptcase']['grid_tbdetailigdF']['sc_process_barr']);
$ExportCtrl = new grid_tbdetailigdF_export_control;
$ExportCtrl->Export_barr();

class grid_tbdetailigdF_export_control
{
