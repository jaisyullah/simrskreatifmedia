...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbantrian']['embutida_pdf']))
 {
 ?>
...
<?php
include_once("form_tbantrian_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_tbantrian_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbantrian']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbantrian']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbantrian']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbantrian']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbantrian']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbantrian']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbantrian']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbantrian']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
?>
...
<?php
 include_once("form_tbantrian_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbantrian']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbantrian']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_tbantrian'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_tbantrian'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbantrian']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbantrian']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbantrian']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbantrian']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbantrian']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbantrian']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbantrian']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbantrian']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbantrian']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbantrian']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbantrian']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbantrian']['fast_search'][2] : "";
?> 
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbantrian']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbantrian']['run_iframe'] != "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbantrian']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbantrian']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbantrian']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbantrian']['run_iframe'] == "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbantrian']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbantrian']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbantrian']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbantrian']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbantrian']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbantrian']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbantrian']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbantrian']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbantrian']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbantrian']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbantrian']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbantrian']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
?>
<script type="text/javascript">
var pag_ativa = "form_tbantrian_form0";
</script>
<ul class="scTabLine sc-ui-page-tab-line">
<?php
    $this->tabCssClass = array(
        'form_tbantrian_form0' => array(
            'title' => "Pendaftaran Pasien",
            'class' => empty($nmgp_num_form) || $nmgp_num_form == "form_tbantrian_form0" ? "scTabActive" : "scTabInactive",
        ),
        'form_tbantrian_form1' => array(
            'title' => "Biaya",
            'class' => $nmgp_num_form == "form_tbantrian_form1" ? "scTabActive" : "scTabInactive",
        ),
    );
        if (!empty($this->Ini->nm_hidden_pages)) {
                foreach ($this->Ini->nm_hidden_pages as $pageName => $pageStatus) {
                        if ('Pendaftaran Pasien' == $pageName && 'off' == $pageStatus) {
                                $this->tabCssClass['form_tbantrian_form0']['class'] = 'scTabInactive';
                        }
                        if ('Biaya' == $pageName && 'off' == $pageStatus) {
                                $this->tabCssClass['form_tbantrian_form1']['class'] = 'scTabInactive';
                        }
                }
...
?>
<?php
    $css_celula = $this->tabCssClass["form_tbantrian_form0"]['class'];
?>
   <li id="id_form_tbantrian_form0" class="<?php echo $css_celula; ?> sc-form-page">
    <a href="javascript: sc_exib_ocult_pag ('form_tbantrian_form0')">
     Pendaftaran Pasien
    </a>
   </li>
<?php
    $css_celula = $this->tabCssClass["form_tbantrian_form1"]['class'];
?>
   <li id="id_form_tbantrian_form1" class="<?php echo $css_celula; ?> sc-form-page">
    <a href="javascript: sc_exib_ocult_pag ('form_tbantrian_form1')">
     Biaya
    </a>
   </li>
</ul>
...
<div id="form_tbantrian_form0" style='display: none; width: 1px; height: 0px; overflow: scroll'>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_poly_label" id="hidden_field_label_poly" style="<?php echo $sStyleHidden_poly; ?>"><span id="id_label_poly"><?php echo $this->nm_new_label['poly']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbantrian']['php_cmp_required']['poly']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbantrian']['php_cmp_required']['poly'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_poly_line" id="hidden_field_data_poly" style="<?php echo $sStyleHidden_poly; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_poly_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_doctor_label" id="hidden_field_label_doctor" style="<?php echo $sStyleHidden_doctor; ?>"><span id="id_label_doctor"><?php echo $this->nm_new_label['doctor']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbantrian']['php_cmp_required']['doctor']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbantrian']['php_cmp_required']['doctor'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_regdate_line" id="hidden_field_data_regdate" style="<?php echo $sStyleHidden_regdate; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_regdate_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_viaphone_label" id="hidden_field_label_viaphone" style="<?php echo $sStyleHidden_viaphone; ?>"><span id="id_label_viaphone"><?php echo $this->nm_new_label['viaphone']; ?></span></TD>
    <TD class="scFormDataOdd css_viaphone_line" id="hidden_field_data_viaphone" style="<?php echo $sStyleHidden_viaphone; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_viaphone_line" style="vertical-align: top;padding: 0px">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbantrian']['Lookup_viaphone'][] = '0'; ?>
 <option  value="1" <?php  if ($this->viaphone == "1") { echo " selected" ;} ?>>Ya</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbantrian']['Lookup_viaphone'][] = '1'; ?>
 </select></span>
</span><?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_regtime_line" id="hidden_field_data_regtime" style="<?php echo $sStyleHidden_regtime; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_regtime_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_queue_label" id="hidden_field_label_queue" style="<?php echo $sStyleHidden_queue; ?>"><span id="id_label_queue"><?php echo $this->nm_new_label['queue']; ?></span></TD>
    <TD class="scFormDataOdd css_queue_line" id="hidden_field_data_queue" style="<?php echo $sStyleHidden_queue; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_queue_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_custcode_label" id="hidden_field_label_custcode" style="<?php echo $sStyleHidden_custcode; ?>"><span id="id_label_custcode"><?php echo $this->nm_new_label['custcode']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbantrian']['php_cmp_required']['custcode']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbantrian']['php_cmp_required']['custcode'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<span id="id_read_on_custcode" class="sc-ui-readonly-custcode css_custcode_line" style="<?php echo $sStyleReadLab_custcode; ?>"><?php echo $this->custcode; ?></span><span id="id_read_off_custcode" class="css_read_off_custcode" style="white-space: nowrap;<?php echo $sStyleReadInp_custcode; ?>">
 ...
 size=8 maxlength=8 alt="{datatype: 'text', maxLength: 8, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php
   $Sc_iframe_master = ($this->Embutida_call) ? 'nmgp_iframe_ret*scinnmsc_iframe_liga_form_tbantrian*scout' : '';
   if (isset($this->Ini->sc_lig_md5["grid_tbcustomer"]) && $this->Ini->sc_lig_md5["grid_tbcustomer"] == "S") {
       ...
       $Md5_Lig    = "@SC_par@" . $this->form_encode_input($this->Ini->sc_page) . "@SC_par@form_tbantrian@SC_par@" . md5($Parms_Lig);
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbantrian']['Lig_Md5'][md5($Parms_Lig)] = $Parms_Lig;
   } else {
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbantrian']['Lookup_status'][] = 'Antre'; ?>
 <option  value="Batal" <?php  if ($this->status == "Batal") { echo " selected" ;} ?>>Batal</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbantrian']['Lookup_status'][] = 'Batal'; ?>
 <option  value="Pelayanan" <?php  if ($this->status == "Pelayanan") { echo " selected" ;} ?>>Pelayanan</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbantrian']['Lookup_status'][] = 'Pelayanan'; ?>
 <option  value="Lengkap" <?php  if ($this->status == "Lengkap") { echo " selected" ;} ?>>Lengkap</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbantrian']['Lookup_status'][] = 'Lengkap'; ?>
 <option  value="Selesai" <?php  if ($this->status == "Selesai") { echo " selected" ;} ?>>Selesai</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbantrian']['Lookup_status'][] = 'Selesai'; ?>
 </select></span>
</span><?php  }?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbantrian']['Lookup_jenis'][] = 'Pasien Lama'; ?>
 <option  value="Pasien Baru" <?php  if ($this->jenis == "Pasien Baru") { echo " selected" ;} ?>>Pasien Baru</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbantrian']['Lookup_jenis'][] = 'Pasien Baru'; ?>
 </select></span>
</span><?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_bayar_label" id="hidden_field_label_bayar" style="<?php echo $sStyleHidden_bayar; ?>"><span id="id_label_bayar"><?php echo $this->nm_new_label['bayar']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbantrian']['php_cmp_required']['bayar']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbantrian']['php_cmp_required']['bayar'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_bayar_line" id="hidden_field_data_bayar" style="<?php echo $sStyleHidden_bayar; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_bayar_line" style="vertical-align: top;padding: 0px">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbantrian']['Lookup_bayar'][] = ''; ?>
 <option value=""></option>
 <option  value="ASURANSI" <?php  if ($this->bayar == "ASURANSI") { echo " selected" ;} ?>>ASURANSI</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbantrian']['Lookup_bayar'][] = 'ASURANSI'; ?>
 <option  value="TUNAI" <?php  if ($this->bayar == "TUNAI") { echo " selected" ;} ?>>TUNAI</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbantrian']['Lookup_bayar'][] = 'TUNAI'; ?>
 <option  value="BPJS" <?php  if ($this->bayar == "BPJS") { echo " selected" ;} ?>>BPJS</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbantrian']['Lookup_bayar'][] = 'BPJS'; ?>
 <option  value="COB" <?php  if ($this->bayar == "COB") { echo " selected" ;} ?>>COB</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbantrian']['Lookup_bayar'][] = 'COB'; ?>
 <option  value="PAKET" <?php  if ($this->bayar == "PAKET") { echo " selected" ;} ?>>PAKET</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbantrian']['Lookup_bayar'][] = 'PAKET'; ?>
 <option  value="BANSOS" <?php  if ($this->bayar == "BANSOS") { echo " selected" ;} ?>>BANSOS</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbantrian']['Lookup_bayar'][] = 'BANSOS'; ?>
 <option  value="JAMPERU" <?php  if ($this->bayar == "JAMPERU") { echo " selected" ;} ?>>JAMPERU</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbantrian']['Lookup_bayar'][] = 'JAMPERU'; ?>
 <option  value="TUNAI PAKET" <?php  if ($this->bayar == "TUNAI PAKET") { echo " selected" ;} ?>>TUNAI PAKET</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbantrian']['Lookup_bayar'][] = 'TUNAI PAKET'; ?>
 <option  value="TUNAI PROMO" <?php  if ($this->bayar == "TUNAI PROMO") { echo " selected" ;} ?>>TUNAI PROMO</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbantrian']['Lookup_bayar'][] = 'TUNAI PROMO'; ?>
 </select></span>
</span><?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_instno_label" id="hidden_field_label_instno" style="<?php echo $sStyleHidden_instno; ?>"><span id="id_label_instno"><?php echo $this->nm_new_label['instno']; ?></span></TD>
    <TD class="scFormDataOdd css_instno_line" id="hidden_field_data_instno" style="<?php echo $sStyleHidden_instno; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_instno_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_instexpiry_label" id="hidden_field_label_instexpiry" style="<?php echo $sStyleHidden_instexpiry; ?>"><span id="id_label_instexpiry"><?php echo $this->nm_new_label['instexpiry']; ?></span></TD>
    <TD class="scFormDataOdd css_instexpiry_line" id="hidden_field_data_instexpiry" style="<?php echo $sStyleHidden_instexpiry; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_instexpiry_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_inst_label" id="hidden_field_label_inst" style="<?php echo $sStyleHidden_inst; ?>"><span id="id_label_inst"><?php echo $this->nm_new_label['inst']; ?></span></TD>
    <TD class="scFormDataOdd css_inst_line" id="hidden_field_data_inst" style="<?php echo $sStyleHidden_inst; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_inst_line" style="vertical-align: top;padding: 0px">
