...
function scFocusField(sField) {
  ...
  if ($oField.length > 0) {
    switch ($oField[0].name) {
      ...
      case 'uk':
      case 'struckno':
        sc_exib_ocult_pag('form_tbantrian_form0');
        break;
      case 'detailadm':
      case 'admission':
      case 'id':
        sc_exib_ocult_pag('form_tbantrian_form1');
        break;
    }
  }
...
function scHidePage(pageNo) {
	$("#id_form_tbantrian_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_regdate" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_tbantrian_validate_regdate(iSeqRow);
    },
    numberOfMonths: 1,
    changeMonth: true,
    changeYear: true,
...
?>
  ...
  $("#id_sc_field_instexpiry" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_tbantrian_validate_instexpiry(iSeqRow);
    },
    numberOfMonths: 1,
    changeMonth: true,
    changeYear: true,
...
?>
  ...
  $("#id_sc_field_hta" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_tbantrian_validate_hta(iSeqRow);
    },
    numberOfMonths: 1,
    changeMonth: true,
    changeYear: true,
...
?>
  ...
  $("#id_sc_field_handled" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_tbantrian_validate_handled(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_paid" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_tbantrian_validate_paid(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
