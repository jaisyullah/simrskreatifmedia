...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbantrian']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
  <input type="hidden" name="script_case_session" value="<?php echo $this->form_encode_input(session_id()); ?>"> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_tbantrian"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
?> 
var var_btn_sc_btn_0_norm = "<?php echo $this->form_encode_input($this->nmgp_dados_form['custcode']); ?>";
...
{
  nm_gp_submit('<?php echo $this->Ini->link_label; ?>', '<?php echo $this->nm_location; ?>', '<?php echo "norm*scin' + var_btn_sc_btn_0_norm + '*scout"; ?>', '', '_blank', '0', '0', 'label');
}
var var_btn_sc_btn_1_var_no_struk = "<?php echo $this->form_encode_input($this->nmgp_dados_form['struckno']); ?>";
...
{
  nm_gp_submit('<?php echo $this->Ini->link_cetak_antrian_cons; ?>', '<?php echo $this->nm_location; ?>', '<?php echo "var_no_struk*scin' + var_btn_sc_btn_1_var_no_struk + '*scout"; ?>', 'inicio', '_blank', '0', '0', 'cetak_antrian');
}
var var_btn_sc_btn_2_var_custcode = "<?php echo $this->form_encode_input($this->nmgp_dados_form['custcode']); ?>";
...
{
  nm_gp_submit('<?php echo $this->Ini->link_pdfreport_kartu_cons; ?>', '<?php echo $this->nm_location; ?>', '<?php echo "var_custcode*scin' + var_btn_sc_btn_2_var_custcode + '*scout"; ?>', 'inicio', '_blank', '0', '0', 'pdfreport_kartu');
}
var var_btn_sc_btn_3_strukrj = "<?php echo $this->form_encode_input($this->nmgp_dados_form['struckno']); ?>";
var var_btn_sc_btn_3_dokterasal = "<?php echo $this->form_encode_input($this->nmgp_dados_form['doctor']); ?>";
var var_btn_sc_btn_3_custcode = "<?php echo $this->form_encode_input($this->nmgp_dados_form['custcode']); ?>";
...
{
  nm_gp_submit('<?php echo $this->Ini->link_gantiDokter_edit; ?>', '<?php echo $this->nm_location; ?>', '<?php echo "strukrj*scin' + var_btn_sc_btn_3_strukrj + '*scoutdokterasal*scin' + var_btn_sc_btn_3_dokterasal + '*scoutcustcode*scin' + var_btn_sc_btn_3_custcode + '*scoutNM_btn_insert*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinS*scoutNM_btn_navega*scinN*scout"; ?>', '', '_self', '0', '0', 'gantiDokter');
}
 NM_tp_critica(1);
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbantrian']['where_detal']))
  {
?>  
...
{
   nm_field_disabled("viaphone=disabled;nama=disabled;alamat=disabled;sc_field_2=disabled;sc_field_1=disabled;sc_field_0=disabled;tp=disabled;uk=disabled", "");
   
}
function sc_exib_ocult_pag(N_pagina)
{
    document.getElementById('form_tbantrian_form0').style.width='1px';
    document.getElementById('form_tbantrian_form0').style.height='0px';
    document.getElementById('form_tbantrian_form0').style.display='none';
    document.getElementById('form_tbantrian_form0').style.overflow='scroll';
    document.getElementById('form_tbantrian_form1').style.width='1px';
    document.getElementById('form_tbantrian_form1').style.height='0px';
    document.getElementById('form_tbantrian_form1').style.display='none';
    document.getElementById('form_tbantrian_form1').style.overflow='scroll';
   ...
   if ("form_tbantrian_form1" == N_pagina) {
