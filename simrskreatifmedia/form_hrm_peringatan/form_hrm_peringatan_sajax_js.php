  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_hrm_peringatan" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_hrm_peringatan_form();
	}

  // ---------- Validate tgl_peringatan_
  function do_ajax_form_hrm_peringatan_validate_tgl_peringatan_(iNumLinha)
  {
    var nomeCampo_tgl_peringatan_ = "tgl_peringatan_" + iNumLinha;
    var var_tgl_peringatan_ = scAjaxGetFieldText(nomeCampo_tgl_peringatan_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_peringatan_validate_tgl_peringatan_(var_tgl_peringatan_, iNumLinha, var_script_case_init, do_ajax_form_hrm_peringatan_validate_tgl_peringatan__cb);
  } // do_ajax_form_hrm_peringatan_validate_tgl_peringatan_

  function do_ajax_form_hrm_peringatan_validate_tgl_peringatan__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "tgl_peringatan_" + iLineNumber;
    }
    else
    {
      sFieldValid = "tgl_peringatan_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "tgl_peringatan_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "tgl_peringatan_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_peringatan_validate_tgl_peringatan__cb

  // ---------- Validate perihal_
  function do_ajax_form_hrm_peringatan_validate_perihal_(iNumLinha)
  {
    var nomeCampo_perihal_ = "perihal_" + iNumLinha;
    var var_perihal_ = scAjaxGetFieldText(nomeCampo_perihal_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_peringatan_validate_perihal_(var_perihal_, iNumLinha, var_script_case_init, do_ajax_form_hrm_peringatan_validate_perihal__cb);
  } // do_ajax_form_hrm_peringatan_validate_perihal_

  function do_ajax_form_hrm_peringatan_validate_perihal__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "perihal_" + iLineNumber;
    }
    else
    {
      sFieldValid = "perihal_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "perihal_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "perihal_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_peringatan_validate_perihal__cb

  // ---------- Validate alasan_
  function do_ajax_form_hrm_peringatan_validate_alasan_(iNumLinha)
  {
    var nomeCampo_alasan_ = "alasan_" + iNumLinha;
    var var_alasan_ = scAjaxGetFieldText(nomeCampo_alasan_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_peringatan_validate_alasan_(var_alasan_, iNumLinha, var_script_case_init, do_ajax_form_hrm_peringatan_validate_alasan__cb);
  } // do_ajax_form_hrm_peringatan_validate_alasan_

  function do_ajax_form_hrm_peringatan_validate_alasan__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "alasan_" + iLineNumber;
    }
    else
    {
      sFieldValid = "alasan_";
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "alasan_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "alasan_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_peringatan_validate_alasan__cb

  // ---------- Validate peringatan_ke_
  function do_ajax_form_hrm_peringatan_validate_peringatan_ke_(iNumLinha)
  {
    var nomeCampo_peringatan_ke_ = "peringatan_ke_" + iNumLinha;
    var var_peringatan_ke_ = scAjaxGetFieldText(nomeCampo_peringatan_ke_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_peringatan_validate_peringatan_ke_(var_peringatan_ke_, iNumLinha, var_script_case_init, do_ajax_form_hrm_peringatan_validate_peringatan_ke__cb);
  } // do_ajax_form_hrm_peringatan_validate_peringatan_ke_

  function do_ajax_form_hrm_peringatan_validate_peringatan_ke__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "peringatan_ke_" + iLineNumber;
    }
    else
    {
      sFieldValid = "peringatan_ke_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "peringatan_ke_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "peringatan_ke_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_peringatan_validate_peringatan_ke__cb

  // ---------- Validate lampiran_
  function do_ajax_form_hrm_peringatan_validate_lampiran_(iNumLinha)
  {
    var nomeCampo_lampiran_ = "lampiran_" + iNumLinha;
    var var_lampiran_ = scAjaxGetFieldText(nomeCampo_lampiran_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_peringatan_validate_lampiran_(var_lampiran_, iNumLinha, var_script_case_init, do_ajax_form_hrm_peringatan_validate_lampiran__cb);
  } // do_ajax_form_hrm_peringatan_validate_lampiran_

  function do_ajax_form_hrm_peringatan_validate_lampiran__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "lampiran_" + iLineNumber;
    }
    else
    {
      sFieldValid = "lampiran_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "lampiran_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "lampiran_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_peringatan_validate_lampiran__cb

  // ---------- Validate id_
  function do_ajax_form_hrm_peringatan_validate_id_(iNumLinha)
  {
    var nomeCampo_id_ = "id_" + iNumLinha;
    var var_id_ = scAjaxGetFieldHidden(nomeCampo_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_peringatan_validate_id_(var_id_, iNumLinha, var_script_case_init, do_ajax_form_hrm_peringatan_validate_id__cb);
  } // do_ajax_form_hrm_peringatan_validate_id_

  function do_ajax_form_hrm_peringatan_validate_id__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_peringatan_validate_id__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_hrm_peringatan_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_hrm_peringatan_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_hrm_peringatan_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_hrm_peringatan_add_new_line_cb);
  } // do_ajax_form_hrm_peringatan_add_new_line

  function do_ajax_form_hrm_peringatan_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_hrm_peringatan_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_hrm_peringatan_backup_line(iNumLinha)
  {
    var var_id_ = scAjaxGetFieldHidden("id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_peringatan_backup_line(var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_hrm_peringatan_backup_line_cb);
  } // do_ajax_form_hrm_peringatan_backup_line

  function do_ajax_form_hrm_peringatan_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_hrm_peringatan_backup_line_cb

  function do_ajax_form_hrm_peringatan_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_hrm_peringatan_cancel_insert

  function do_ajax_form_hrm_peringatan_cancel_update(iSeqVert)
  {
    do_ajax_form_hrm_peringatan_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_hrm_peringatan_cancel_update

  function do_ajax_form_hrm_peringatan_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_hrm_peringatan_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_hrm_peringatan_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_hrm_peringatan_table_refresh(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_hrm_peringatan_table_refresh_cb);
  } //  do_ajax_form_hrm_peringatan_table_refresh

  function do_ajax_form_hrm_peringatan_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_hrm_peringatan_table_refresh_cb_after_alert);
  } // do_ajax_form_hrm_peringatan_table_refresh_cb
  function do_ajax_form_hrm_peringatan_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_hrm_peringatan_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_hrm_peringatan_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_hrm_peringatan_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    sc_num_ult_line = iNumLinha;
    sc_num_ult_tr   = indexTR;
    scAjaxHideMessage();
    var var_tgl_peringatan_ = scAjaxGetFieldText("tgl_peringatan_" + iNumLinha);
    var var_perihal_ = scAjaxGetFieldText("perihal_" + iNumLinha);
    var var_alasan_ = scAjaxGetFieldText("alasan_" + iNumLinha);
    var var_peringatan_ke_ = scAjaxGetFieldText("peringatan_ke_" + iNumLinha);
    var var_lampiran_ = scAjaxGetFieldText("lampiran_" + iNumLinha);
    var var_id_ = scAjaxGetFieldHidden("id_" + iNumLinha);
    var var_lampiran__ul_name = scAjaxSpecCharProtect(eval('document.F1.lampiran__ul_name' + iNumLinha + '.value'));
    var var_lampiran__ul_type = eval('document.F1.lampiran__ul_type' + iNumLinha + '.value');
    var var_lampiran__salva = document.F1.elements["lampiran_" + iNumLinha + "_salva"] ? eval('document.F1.lampiran_' + iNumLinha + '_salva.value') : "";
    var var_lampiran__limpa = eval('document.F1.lampiran__limpa' + iNumLinha + '.checked') ? "S" : "N";
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_hrm_peringatan_submit_form(var_tgl_peringatan_, var_perihal_, var_alasan_, var_peringatan_ke_, var_lampiran_, var_id_, var_lampiran__ul_name, var_lampiran__ul_type, var_lampiran__salva, var_lampiran__limpa, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_hrm_peringatan_submit_form_cb);
  } // do_ajax_form_hrm_peringatan_submit_form

  function do_ajax_form_hrm_peringatan_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("tgl_peringatan_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("perihal_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("alasan_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("peringatan_ke_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("lampiran_" + sc_num_ult_line);
...
<?php
        ...
        {
?>
          if (document.F1.elements["lampiran__limpa" + sc_num_ult_line] && document.F1.elements["lampiran__limpa" + sc_num_ult_line].checked)
          {
            var oImgTemp = {0: {"value" : ""}};
            scAjaxSetFieldDocument("lampiran_" + sc_num_ult_line, oImgTemp, "", "");
            document.F1.elements["lampiran__limpa" + sc_num_ult_line].checked = false;
          }
          else if (document.getElementById("id_ajax_doc_lampiran_" + sc_num_ult_line) && "" != document.getElementById("id_ajax_doc_lampiran_" + sc_num_ult_line).innerHTML)
          {
            document.getElementById("id_ajax_doc_lampiran_" + sc_num_ult_line).style.display = "";
          }
<?php
        }
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_hrm_peringatan_submit_form_cb_after_alert);
  } // do_ajax_form_hrm_peringatan_submit_form_cb
  function do_ajax_form_hrm_peringatan_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_hrm_peringatan_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_hrm_peringatan_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_hrm_peringatan_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("tgl_peringatan_" + iNavForm);
      scAjaxHideErrorDisplay("perihal_" + iNavForm);
      scAjaxHideErrorDisplay("alasan_" + iNavForm);
      scAjaxHideErrorDisplay("peringatan_ke_" + iNavForm);
      scAjaxHideErrorDisplay("lampiran_" + iNavForm);
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_hrm_peringatan_navigate_form(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_hrm_peringatan_navigate_form_cb);
  } // do_ajax_form_hrm_peringatan_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_hrm_peringatan']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_hrm_peringatan_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_hrm_peringatan_navigate_form_cb_after_alert);
  } // do_ajax_form_hrm_peringatan_navigate_form_cb
  function do_ajax_form_hrm_peringatan_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_hrm_peringatan_navigate_form_cb_after_alert
  function sc_hide_form_hrm_peringatan_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "tgl_peringatan_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "perihal_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "alasan_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "peringatan_ke_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "lampiran_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "id_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["tgl_peringatan_" + iNumLinha] = {"label": "Tgl Peringatan<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["perihal_" + iNumLinha] = {"label": "Perihal<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["alasan_" + iNumLinha] = {"label": "Alasan<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["peringatan_ke_" + iNumLinha] = {"label": "Peringatan Ke<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["lampiran_" + iNumLinha] = {"label": "Lampiran<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_field_mult["tgl_peringatan_"][iNumLinha] = "tgl_peringatan_" + iNumLinha;
    ajax_field_mult["perihal_"][iNumLinha] = "perihal_" + iNumLinha;
    ajax_field_mult["alasan_"][iNumLinha] = "alasan_" + iNumLinha;
    ajax_field_mult["peringatan_ke_"][iNumLinha] = "peringatan_ke_" + iNumLinha;
    ajax_field_mult["lampiran_"][iNumLinha] = "lampiran_" + iNumLinha;
    ajax_field_mult["id_"][iNumLinha] = "id_" + iNumLinha;
    ajax_field_id["tgl_peringatan_" + iNumLinha] = new Array("hidden_field_label_tgl_peringatan_", "hidden_field_data_tgl_peringatan_" + iNumLinha);
    ajax_field_id["perihal_" + iNumLinha] = new Array("hidden_field_label_perihal_", "hidden_field_data_perihal_" + iNumLinha);
    ajax_field_id["alasan_" + iNumLinha] = new Array("hidden_field_label_alasan_", "hidden_field_data_alasan_" + iNumLinha);
    ajax_field_id["peringatan_ke_" + iNumLinha] = new Array("hidden_field_label_peringatan_ke_", "hidden_field_data_peringatan_ke_" + iNumLinha);
    ajax_field_id["lampiran_" + iNumLinha] = new Array("hidden_field_label_lampiran_", "hidden_field_data_lampiran_" + iNumLinha);
    ajax_error_count["tgl_peringatan_" + iNumLinha] = "off";
    ajax_error_count["perihal_" + iNumLinha] = "off";
    ajax_error_count["alasan_" + iNumLinha] = "off";
    ajax_error_count["peringatan_ke_" + iNumLinha] = "off";
    ajax_error_count["lampiran_" + iNumLinha] = "off";
    ajax_error_count["id_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["tgl_peringatan_" + iNumLinha] = "off";
    ajax_read_only["perihal_" + iNumLinha] = "off";
    ajax_read_only["alasan_" + iNumLinha] = "off";
    ajax_read_only["peringatan_ke_" + iNumLinha] = "off";
    ajax_read_only["lampiran_" + iNumLinha] = "off";
...
{
?>
    ajax_read_only["tgl_peringatan_" + iNumLinha] = "on";
    ajax_read_only["perihal_" + iNumLinha] = "on";
    ajax_read_only["alasan_" + iNumLinha] = "on";
    ajax_read_only["peringatan_ke_" + iNumLinha] = "on";
    ajax_read_only["lampiran_" + iNumLinha] = "on";
    ajax_read_only["id_" + iNumLinha] = "on";
<?php
}
?>
  ...
  {
    ajax_error_list["tgl_peringatan_" + iNumLinha] = null;
    ajax_error_list["perihal_" + iNumLinha] = null;
    ajax_error_list["alasan_" + iNumLinha] = null;
    ajax_error_list["peringatan_ke_" + iNumLinha] = null;
    ajax_error_list["lampiran_" + iNumLinha] = null;
  ...
  var ajax_field_mult = {
    "tgl_peringatan_": new Array(),
    "perihal_": new Array(),
    "alasan_": new Array(),
    "peringatan_ke_": new Array(),
    "lampiran_": new Array(),
    "id_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["tgl_peringatan_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["tgl_peringatan_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["tgl_peringatan_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["tgl_peringatan_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["tgl_peringatan_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["perihal_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["perihal_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["perihal_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["perihal_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["perihal_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["alasan_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["alasan_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["alasan_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["alasan_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["alasan_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["peringatan_ke_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["peringatan_ke_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["peringatan_ke_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["peringatan_ke_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["peringatan_ke_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["lampiran_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["lampiran_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["lampiran_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["lampiran_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["lampiran_" + iNumLinha]["onfocus"] = new Array();
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['tgl_peringatan_'])) ? $this->nmgp_cmp_readonly['tgl_peringatan_'] : 'off';
?>
    scAjaxFieldRead("tgl_peringatan_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['perihal_'])) ? $this->nmgp_cmp_readonly['perihal_'] : 'off';
?>
    scAjaxFieldRead("perihal_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['alasan_'])) ? $this->nmgp_cmp_readonly['alasan_'] : 'off';
?>
    scAjaxFieldRead("alasan_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['peringatan_ke_'])) ? $this->nmgp_cmp_readonly['peringatan_ke_'] : 'off';
?>
    scAjaxFieldRead("peringatan_ke_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['lampiran_'])) ? $this->nmgp_cmp_readonly['lampiran_'] : 'off';
?>
    scAjaxFieldRead("lampiran_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
?>
  ...
  {
    scAjaxFieldRead("tgl_peringatan_" + iSeq, "on");
    scAjaxFieldRead("perihal_" + iSeq, "on");
    scAjaxFieldRead("alasan_" + iSeq, "on");
    scAjaxFieldRead("peringatan_ke_" + iSeq, "on");
    scAjaxFieldRead("lampiran_" + iSeq, "on");
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["tgl_peringatan_" + iRow] || "on" == ajax_error_count["perihal_" + iRow] || "on" == ajax_error_count["alasan_" + iRow] || "on" == ajax_error_count["peringatan_ke_" + iRow] || "on" == ajax_error_count["lampiran_" + iRow] || "on" == ajax_error_count["id_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_tgl_peringatan_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_perihal_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_alasan_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_peringatan_ke_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_lampiran_" + iRow).addClass("scFormErrorLine");
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["tgl_peringatan_" + iRow] && "off" == ajax_error_count["perihal_" + iRow] && "off" == ajax_error_count["alasan_" + iRow] && "off" == ajax_error_count["peringatan_ke_" + iRow] && "off" == ajax_error_count["lampiran_" + iRow] && "off" == ajax_error_count["id_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["tgl_peringatan_" + iRow] = "off";
        ajax_error_count["perihal_" + iRow] = "off";
        ajax_error_count["alasan_" + iRow] = "off";
        ajax_error_count["peringatan_ke_" + iRow] = "off";
        ajax_error_count["lampiran_" + iRow] = "off";
      ...
      $("#hidden_field_data_tgl_peringatan_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_perihal_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_alasan_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_peringatan_ke_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_lampiran_" + iRow).removeClass("scFormErrorLine");
