  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbdepo_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbdepo_mob_form();
	}

  // ---------- Validate kodedepo
  function do_ajax_form_tbdepo_mob_validate_kodedepo()
  {
    var nomeCampo_kodedepo = "kodedepo";
    var var_kodedepo = scAjaxGetFieldText(nomeCampo_kodedepo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdepo_mob_validate_kodedepo(var_kodedepo, var_script_case_init, do_ajax_form_tbdepo_mob_validate_kodedepo_cb);
  } // do_ajax_form_tbdepo_mob_validate_kodedepo

  function do_ajax_form_tbdepo_mob_validate_kodedepo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "kodedepo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdepo_mob_validate_kodedepo_cb

  // ---------- Validate namadepo
  function do_ajax_form_tbdepo_mob_validate_namadepo()
  {
    var nomeCampo_namadepo = "namadepo";
    var var_namadepo = scAjaxGetFieldText(nomeCampo_namadepo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdepo_mob_validate_namadepo(var_namadepo, var_script_case_init, do_ajax_form_tbdepo_mob_validate_namadepo_cb);
  } // do_ajax_form_tbdepo_mob_validate_namadepo

  function do_ajax_form_tbdepo_mob_validate_namadepo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "namadepo";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdepo_mob_validate_namadepo_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tbdepo_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tbdepo_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_kodedepo = scAjaxGetFieldText("kodedepo");
    var var_namadepo = scAjaxGetFieldText("namadepo");
    ...
    scAjaxProcOn();
    x_ajax_form_tbdepo_mob_submit_form(var_kodedepo, var_namadepo, var_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbdepo_mob_submit_form_cb);
  } // do_ajax_form_tbdepo_mob_submit_form

  function do_ajax_form_tbdepo_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("kodedepo");
      scAjaxHideErrorDisplay("namadepo");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tbdepo_mob_submit_form_cb_after_alert);
  } // do_ajax_form_tbdepo_mob_submit_form_cb
  function do_ajax_form_tbdepo_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbdepo_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tbdepo_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_tbdepo_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbdepo_mob_navigate_form_cb);
  } // do_ajax_form_tbdepo_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdepo_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbdepo_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbdepo_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_tbdepo_mob_navigate_form_cb
  function do_ajax_form_tbdepo_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_tbdepo_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_tbdepo_mob_navigate_form_cb_after_alert
  function sc_hide_form_tbdepo_mob_form()
  {
  ...
  ajax_field_list[0] = "kodedepo";
  ajax_field_list[1] = "namadepo";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "kodedepo": {"label": "Kode Depo", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "namadepo": {"label": "Nama Depo", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  ajax_field_mult["kodedepo"][1] = "kodedepo";
  ajax_field_mult["namadepo"][1] = "namadepo";

  var ajax_field_id = {
    "kodedepo": new Array("hidden_field_label_kodedepo", "hidden_field_data_kodedepo"),
    "namadepo": new Array("hidden_field_label_namadepo", "hidden_field_data_namadepo")
  };
