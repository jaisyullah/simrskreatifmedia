  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbdepo" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbdepo_form();
	}

  // ---------- Validate kodedepo
  function do_ajax_form_tbdepo_validate_kodedepo()
  {
    var nomeCampo_kodedepo = "kodedepo";
    var var_kodedepo = scAjaxGetFieldText(nomeCampo_kodedepo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdepo_validate_kodedepo(var_kodedepo, var_script_case_init, do_ajax_form_tbdepo_validate_kodedepo_cb);
  } // do_ajax_form_tbdepo_validate_kodedepo

  function do_ajax_form_tbdepo_validate_kodedepo_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdepo_validate_kodedepo_cb

  // ---------- Validate namadepo
  function do_ajax_form_tbdepo_validate_namadepo()
  {
    var nomeCampo_namadepo = "namadepo";
    var var_namadepo = scAjaxGetFieldText(nomeCampo_namadepo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdepo_validate_namadepo(var_namadepo, var_script_case_init, do_ajax_form_tbdepo_validate_namadepo_cb);
  } // do_ajax_form_tbdepo_validate_namadepo

  function do_ajax_form_tbdepo_validate_namadepo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdepo_validate_namadepo_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tbdepo_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tbdepo_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_tbdepo_submit_form(var_kodedepo, var_namadepo, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbdepo_submit_form_cb);
  } // do_ajax_form_tbdepo_submit_form

  function do_ajax_form_tbdepo_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tbdepo_submit_form_cb_after_alert);
  } // do_ajax_form_tbdepo_submit_form_cb
  function do_ajax_form_tbdepo_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbdepo_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tbdepo_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_tbdepo_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbdepo_navigate_form_cb);
  } // do_ajax_form_tbdepo_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdepo']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbdepo_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbdepo_navigate_form_cb_after_alert);
  } // do_ajax_form_tbdepo_navigate_form_cb
  function do_ajax_form_tbdepo_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_tbdepo_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_tbdepo_navigate_form_cb_after_alert
  function sc_hide_form_tbdepo_form()
  {
