...
class rekapKeseluruhan_master_rtf
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "rekapKeseluruhan_master.rtf";
   }
   //---- 
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      $nm_raiz_img  = ""; 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['rekapKeseluruhan_master']['rtf_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['rekapKeseluruhan_master']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['rekapKeseluruhan_master']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['rekapKeseluruhan_master']['rtf_name']);
      }
   ...
   function NM_export_instansipenjamin()
   {
         ...
         $this->instansipenjamin = str_replace('<', '&lt;', $this->instansipenjamin);
         $this->instansipenjamin = str_replace('>', '&gt;', $this->instansipenjamin);
         $this->Texto_tag .= "<td>" . $this->instansipenjamin . "</td>\r\n";
   }
   //----- paiddate
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['rekapKeseluruhan_master']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['rekapKeseluruhan_master']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<HEAD>
 <TITLE>Detail Keseluruhan Kasir :: RTF</TITLE>
