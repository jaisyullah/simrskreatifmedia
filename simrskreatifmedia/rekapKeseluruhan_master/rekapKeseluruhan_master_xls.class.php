...
class rekapKeseluruhan_master_xls
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_xls()
   {
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['rekapKeseluruhan_master']['embutida']) {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['rekapKeseluruhan_master']['opcao'] = "";
      }
   }
   ...
   function inicializa_vars()
   {
      ...
      { 
          ...
          { 
              ...
              $this->Res_xls = new rekapKeseluruhan_master_res_xls();
              $this->prep_modulos("Res_xls");
          } 
          $this->Arquivo    = "sc_xls";
          $this->Arquivo   .= "_" . date("YmdHis") . "_" . rand(0, 1000);
          $this->Arq_zip    = $this->Arquivo . "_rekapKeseluruhan_master.zip";
          $this->Arquivo   .= "_rekapKeseluruhan_master" . $this->Xls_tp;
          $this->Tit_doc    = "rekapKeseluruhan_master" . $this->Xls_tp;
          $this->Tit_zip    = "rekapKeseluruhan_master.zip";
      ...
      require_once($this->Ini->path_aplicacao . "rekapKeseluruhan_master_total.class.php"); 
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['rekapKeseluruhan_master']['embutida'] && !$this->Ini->sc_export_ajax) {
          ...
          $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['rekapKeseluruhan_master']['xls_return']);
          if ($this->Tem_xls_res) {
   ...
   function grava_arquivo()
   {
      ...
      $pos      = strrpos($this->Ini->link_detailItemBebas_cons_emb, '/');
      $link_xls = substr($this->Ini->link_detailItemBebas_cons_emb, 0, $pos) . "/detailItemBebas_xls.class.php";
      if (!is_file($this->Ini->link_detailItemBebas_cons_emb) || !is_file($link_xls))
      {
      ...
      $pos      = strrpos($this->Ini->link_detailItemBebas_cons_emb, '/');
      $link_xml = substr($this->Ini->link_detailItemBebas_cons_emb, 0, $pos) . "/detailItemBebas_xml.class.php";
      if (!is_file($this->Ini->link_detailItemBebas_cons_emb) || !is_file($link_xml))
      {
          $this->NM_cmp_hidden['detailobat'] = "off";
      }
      else
      ...
      $nm_raiz_img  = ""; 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['rekapKeseluruhan_master']['xls_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['rekapKeseluruhan_master']['xls_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['rekapKeseluruhan_master']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['rekapKeseluruhan_master']['xls_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['rekapKeseluruhan_master']['xls_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['rekapKeseluruhan_master']['xls_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['rekapKeseluruhan_master']['xls_name']);
          $this->Xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
          $this->Zip_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arq_zip;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['rekapKeseluruhan_master']['embutida_label']) && $_SESSION['sc_session'][$this->Ini->sc_page]['rekapKeseluruhan_master']['embutida_label'])
      { 
          $this->count_span = 0;
          $this->Xls_row++;
          $this->proc_label();
      ...
      $nmgp_select_count .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['rekapKeseluruhan_master']['where_pesq'];
      $nmgp_order_by = $_SESSION['sc_session'][$this->Ini->sc_page]['rekapKeseluruhan_master']['order_grid'];
     ...
     $nm_houve_quebra = "N";
         ...
         { 
             $this->xls_set_style();
             $this->NM_export_detail();
             if ($_SESSION['sc_session'][$this->Ini->sc_page]['rekapKeseluruhan_master']['embutida'])
             { 
                 $this->Xls_row++;
                 $this->arr_export['lines'][$this->Xls_row] = $this->Rows_sub_detail['label'];
                 foreach ($this->Rows_sub_detail['lines'] as $line => $cols)
                 {
                     $this->Xls_row++;
             ...
             { 
                 ...
                 $_SESSION['scriptcase']['export_return']['label'] = $this->Rows_sub_detail['label'];
                 foreach ($this->Rows_sub_detail['lines'] as $line)
                 {
                     $this->Xls_col = 0;
                     $this->Xls_row++;
         ...
         { 
             $this->xls_set_style();
             $this->NM_export_detailobat();
             if ($_SESSION['sc_session'][$this->Ini->sc_page]['rekapKeseluruhan_master']['embutida'])
             { 
                 $this->Xls_row++;
                 $this->arr_export['lines'][$this->Xls_row] = $this->Rows_sub_detailobat['label'];
                 foreach ($this->Rows_sub_detailobat['lines'] as $line => $cols)
                 {
                     $this->Xls_row++;
                     $this->arr_export['lines'][$this->Xls_row] = $cols;
                 }
             ...
             { 
                 ...
                 $_SESSION['scriptcase']['export_return']['label'] = $this->Rows_sub_detailobat['label'];
                 foreach ($this->Rows_sub_detailobat['lines'] as $line)
                 {
                     $this->Xls_col = 0;
                     $this->Xls_row++;
                     $this->xls_sub_cons_lines($line);
         ...
         if (isset($this->NM_Row_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['rekapKeseluruhan_master']['embutida'])
         { 
      ...
      $this->xls_set_style();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['rekapKeseluruhan_master']['embutida'] && $prim_reg)
      { 
          $this->proc_label();
          $this->xls_sub_cons_copy_label($this->Xls_row);
      ...
      if (isset($this->NM_Col_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['rekapKeseluruhan_master']['embutida'])
      { 
      ...
      { 
          if ($this->Tem_xls_res)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['rekapKeseluruhan_master']['xls_res_grid'] = true;
              if (!$this->Ini->sc_export_ajax) {
              ...
              if ($this->Use_phpspreadsheet) {
                  $Xls_res = \PhpOffice\PhpSpreadsheet\IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['rekapKeseluruhan_master']['xls_res_sheet']);
              }
              else {
                  $Xls_res = PHPExcel_IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['rekapKeseluruhan_master']['xls_res_sheet']);
              }
              foreach($Xls_res->getAllSheets() as $sheet)
              {
                  $this->Xls_dados->addExternalSheet($sheet);
              }
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['rekapKeseluruhan_master']['xls_res_grid']);
              unlink($_SESSION['sc_session'][$this->Ini->sc_page]['rekapKeseluruhan_master']['xls_res_sheet']);
          } 
          if (!$this->Ini->sc_export_ajax) {
   ...
   { 
      ...
      { 
          ...
          $SC_Label = (isset($this->New_label['detailobat'])) ? $this->New_label['detailobat'] : "detailObat"; 
          if (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off")
          {
              $this->arr_span['detailobat'] = $this->count_span;
              $this->Emb_label_cols_detailobat = 0;
              $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['embutida'] = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['embutida_label'] = true;
              $GLOBALS["script_case_init"] = $this->Ini->sc_page;
              $GLOBALS["nmgp_parms"] = "nmgp_opcao?#?xls?@?";
              if (method_exists($this->detailItemBebas, "controle"))
              {
                  ...
                  if (isset($_SESSION['scriptcase']['export_return']))
                  {
                     ...
                     {
                         if (isset($dados['col_span_i'])) {
                             $this->Emb_label_cols_detailobat += $dados['col_span_i'];
                         }
                         elseif (isset($dados['col_span_f'])) {
                             $this->Emb_label_cols_detailobat += $dados['col_span_f'];
                         }
                         else {
                             $this->Emb_label_cols_detailobat++;
                         }
                     }
                  }
              }
      ...
      { 
          ...
          if (!isset($this->NM_cmp_hidden[$detailobat]) || $this->NM_cmp_hidden[$detailobat] != "off")
          {
              while ($this->count_span < $this->Emb_label_cols_detailobat)
              {
                  $this->arr_export['label'][$this->Xls_col]['data']     = " ";
                  $this->arr_export['label'][$this->Xls_col]['align']    = "left";
                  $this->arr_export['label'][$this->Xls_col]['autosize'] = "s";
   ...
   function NM_export_tag()
   {
         ...
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->tag);
         $this->Xls_col++;
   }
   //----- custcode
   ...
   function NM_export_instansipenjamin()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
         $this->instansipenjamin = html_entity_decode($this->instansipenjamin, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->instansipenjamin = strip_tags($this->instansipenjamin);
         if (!NM_is_utf8($this->instansipenjamin))
         {
             $this->instansipenjamin = sc_convert_encoding($this->instansipenjamin, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->instansipenjamin, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->instansipenjamin, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- paiddate
   ...
   function NM_export_detail()
   {
         ...
         if (method_exists($this->pendapatanKasir_detail, "controle"))
         {
             ...
             if (isset($_SESSION['scriptcase']['export_return']))
             {
                 $this->Rows_sub_detail = $_SESSION['scriptcase']['export_return'];
                 return;
             }
         }
         $_SESSION['sc_session'][$this->Ini->sc_page]['pendapatanKasir_detail']['embutida'] = false;
   ...
   //----- detailobat
   function NM_export_detailobat()
   {
         $GLOBALS["script_case_init"] = $this->Ini->sc_page;
         $GLOBALS["nmgp_parms"] = "nmgp_opcao?#?xls?@?kodebebas?#?" . str_replace("'", "@aspass@", $this->Orig_trancode) . "?@?";
         $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['embutida'] = true;
         $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['nolabel'] = true;
         if (method_exists($this->detailItemBebas, "controle"))
         {
             $this->detailItemBebas->controle();
             if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
             ...
             if (isset($_SESSION['scriptcase']['export_return']))
             {
                 $this->Rows_sub_detailobat = $_SESSION['scriptcase']['export_return'];
                 return;
             }
         }
         $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['embutida'] = false;
   ...
   function NM_sub_cons_instansipenjamin()
   {
         ...
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->instansipenjamin;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- detailobat
   function NM_sub_cons_detailobat()
   {
         $this->Rows_sub_detailobat = array();
         $GLOBALS["script_case_init"] = $this->Ini->sc_page;
         $GLOBALS["nmgp_parms"] = "nmgp_opcao?#?xls?@?kodebebas?#?" . str_replace("'", "@aspass@", $this->Orig_trancode) . "?@?";
         $_SESSION['sc_session'][$this->Ini->sc_page]['detailItemBebas']['embutida'] = true;
         if (method_exists($this->detailItemBebas, "controle"))
   ...
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['rekapKeseluruhan_master']['nolabel']) || $_SESSION['sc_session'][$this->Ini->sc_page]['rekapKeseluruhan_master']['nolabel'])
       {
   ...
   function quebra_geral_sc_free_total_bot()
   {
       ...
       $prim_cmp = true;
       $mens_tot = $_SESSION['sc_session'][$this->Ini->sc_page]['rekapKeseluruhan_master']['tot_geral'][0] . "(" . $_SESSION['sc_session'][$this->Ini->sc_page]['rekapKeseluruhan_master']['tot_geral'][1] . ")";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['rekapKeseluruhan_master']['field_order'] as $Cada_cmp)
       {
           if ($Cada_cmp == "tag" && (!isset($this->NM_cmp_hidden['tag']) || $this->NM_cmp_hidden['tag'] != "off"))
           {
               $Format_Num = "#,##0";
               $Vl_Tot     = $_SESSION['sc_session'][$this->Ini->sc_page]['rekapKeseluruhan_master']['tot_geral'][2];
               $prim_cmp = false;
           ...
           elseif (!isset($this->NM_cmp_hidden[$Cada_cmp]) || $this->NM_cmp_hidden[$Cada_cmp] != "off")
           {
               ...
               elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['rekapKeseluruhan_master']['embutida']) {
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['rekapKeseluruhan_master']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['rekapKeseluruhan_master']['xls_file'] = $this->Xls_f;
      }
      $path_doc_md5 = md5($this->Ini->path_imag_temp . "/" . $this->Arquivo);
      $_SESSION['sc_session'][$this->Ini->sc_page]['rekapKeseluruhan_master'][$path_doc_md5][0] = $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      $_SESSION['sc_session'][$this->Ini->sc_page]['rekapKeseluruhan_master'][$path_doc_md5][1] = $this->Tit_doc;
...
<HEAD>
 <TITLE>Detail Keseluruhan Kasir :: Excel</TITLE>
...
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['rekapKeseluruhan_master']['xls_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php
