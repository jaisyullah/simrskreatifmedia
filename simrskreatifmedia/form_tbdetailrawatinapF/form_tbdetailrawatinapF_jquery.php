...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_tglkeluar_hora' + iSeqRow).bind('blur', function() { sc_form_tbdetailrawatinapF_tglkeluar_hora_onblur(this, iSeqRow) })
                                            .bind('focus', function() { sc_form_tbdetailrawatinapF_tglkeluar_hora_onfocus(this, iSeqRow) });
...
function sc_form_tbdetailrawatinapF_tglkeluar_hora_onblur(oThis, iSeqRow) {
  do_ajax_form_tbdetailrawatinapF_validate_tglkeluar();
  scCssBlur(oThis);
}
...
function sc_form_tbdetailrawatinapF_tglkeluar_hora_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function scHidePage(pageNo) {
	$("#id_form_tbdetailrawatinapF_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_tglkeluar" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_tbdetailrawatinapF_validate_tglkeluar(iSeqRow);
    },
    numberOfMonths: 1,
    changeMonth: true,
    changeYear: true,
