...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_detailresepinap"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_detailresepinap"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_detailresepinap']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_detailresepinap']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_detailresepinap']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_detailresepinap']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_detailresepinap']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_detailresepinap</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_detailresepinap']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_detailresepinap']['embutida_filho'] as $ind => $sc_init)
          {
