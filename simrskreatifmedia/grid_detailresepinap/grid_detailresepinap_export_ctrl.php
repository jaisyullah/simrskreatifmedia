<?php
@session_start() ;
$_SESSION['scriptcase']['grid_detailresepinap']['sc_process_barr'] = true;
require_once('../grid_detailresepinap/index.php');
unset($_SESSION['scriptcase']['grid_detailresepinap']['sc_process_barr']);
$ExportCtrl = new grid_detailresepinap_export_control;
$ExportCtrl->Export_barr();

class grid_detailresepinap_export_control
{
