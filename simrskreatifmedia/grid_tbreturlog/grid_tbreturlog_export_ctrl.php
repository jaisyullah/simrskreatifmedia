<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tbreturlog']['sc_process_barr'] = true;
require_once('../grid_tbreturlog/index.php');
unset($_SESSION['scriptcase']['grid_tbreturlog']['sc_process_barr']);
$ExportCtrl = new grid_tbreturlog_export_control;
$ExportCtrl->Export_barr();

class grid_tbreturlog_export_control
{
