...
class grid_eis_rajal_total
{
   ...
   function __construct($sc_page)
   {
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['grid_eis_rajal']['campos_busca']) && !empty($_SESSION['sc_session'][$this->sc_page]['grid_eis_rajal']['campos_busca']))
      { 
