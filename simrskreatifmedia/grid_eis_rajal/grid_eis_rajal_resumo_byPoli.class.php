...
class grid_eis_rajal_resumo
{
   ...
   var $link_graph_tot; 
   var $Tot_ger; 
   var $array_total_regdate;
   var $array_total_poly;
   var $array_total_doctor;
   var $array_total_inst;
   ...
   function initializeButtons()
   {
      ...
      $this->nmgp_botoes['chart_exit'] = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['dashboard_info']['under_dashboard'] ? "off" : "on";
   ...
   { 
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['grid_eis_rajal']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['grid_eis_rajal']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['res_hrz'];
      $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
      $dir_raiz          = substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['where_resumo'] = "";
      }
      $this->inicializa_vars();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['contr_total_geral'] == "OK")
      {
          $this->array_total_regdate = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['arr_total']['regdate'];
          $this->array_total_poly = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['arr_total']['poly'];
          $this->array_total_doctor = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['arr_total']['doctor'];
          $this->array_total_inst = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['arr_total']['inst'];
      }
      else
      {
          $this->array_total_regdate = array();
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['tot_geral'][1];
      $this->array_total_geral[1] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['tot_geral'][2];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['tot_geral'][1] == 0)
      {
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          $this->drawMatrix();
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['json_use_label'])
       {
          $Lab_regdate = "regDate";
          $Lab_poly = "poly";
          $Lab_doctor = "doctor";
       ...
       {
          $Lab_regdate = "Tgl. Daftar";
          $Lab_regdate =  sprintf("" . $this->Ini->Nm_lang['lang_othr_cons_title_YYYYMM'] . "", $Lab_regdate);
          $Lab_poly = "Poliklinik";
          $Lab_doctor = "Dokter";
          $Lab_inst = "Provider";
       }
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['labels']['poly']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['labels']['poly'] = "Poliklinik"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['labels']['doctor']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['labels']['doctor'] = "Dokter"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['labels']['regdate']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['labels']['regdate'] = "Tgl. Daftar"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['labels']['inst']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['labels']['inst'] = "Provider"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['labels']['bayar']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['labels']['bayar'] = "Bayar"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['labels']['tariff']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['labels']['tariff'] = "Tariff"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['labels']['struckno']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['labels']['struckno'] = "Struck No"; 
       }
       //-----
       $this->comp_field_nm = array(
           'regdate' => 0,
       ...
       $this->comp_sum = array(
           ...
           3 => "Tariff (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")",
       );
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['summarizing_fields_order']['byPoli']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['summarizing_fields_order']['byPoli'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['summarizing_fields_order']['byPoli'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['summarizing_fields_display']['byPoli'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['summarizing_fields_display']['byPoli'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['summarizing_fields_display']['byPoli'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['summarizing_fields_display']['byPoli'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['summarizing_fields_display']['byPoli'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['summarizing_fields_display']['byPoli'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['summarizing_fields_display']['byPoli'] as $i_sum => $d_sum)
           {
       ...
       $this->comp_sum_lnk = array(
           ...
           3 => array('field' => "tariff", 'show' => true),
       );
       ...
       //-----
       foreach ($this->array_total_regdate as $i_regdate => $d_regdate) {
           if (!in_array($i_regdate, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_regdate[4] ] = $d_regdate[3];
               $this->comp_label[0][ $d_regdate[4] ] = $d_regdate[3];
           }
           foreach ($this->array_total_poly[$i_regdate] as $i_poly => $d_poly) {
               if (!in_array($i_poly, $this->comp_label[1][ $d_regdate[4] ], true)) {
                   $this->comp_index[1][ $d_poly[4] ] = $d_poly[3];
                   $this->comp_label[1][ $d_regdate[4] ][ $d_poly[4] ] = $d_poly[3];
               }
               foreach ($this->array_total_doctor[$i_regdate][$i_poly] as $i_doctor => $d_doctor) {
                   if (!in_array($i_doctor, $this->comp_label[2][ $d_regdate[4] ][ $d_poly[4] ], true)) {
                       $this->comp_index[2][ $d_doctor[4] ] = $d_doctor[3];
                       $this->comp_label[2][ $d_regdate[4] ][ $d_poly[4] ][ $d_doctor[4] ] = $d_doctor[3];
                   }
                   foreach ($this->array_total_inst[$i_regdate][$i_poly][$i_doctor] as $i_inst => $d_inst) {
                       if (!in_array($i_inst, $this->comp_label[3][ $d_regdate[4] ][ $d_poly[4] ][ $d_doctor[4] ], true)) {
                           $this->comp_index[3][ $d_inst[4] ] = $d_inst[3];
                           $this->comp_label[3][ $d_regdate[4] ][ $d_poly[4] ][ $d_doctor[4] ][ $d_inst[4] ] = $d_inst[3];
                       }
                   }
               }
           }
       ...
       //-----
       $this->comp_links_fl = array(
           array('name' => 'regdate', 'prot' => '@aspass@'),
           array('name' => 'poly', 'prot' => '@aspass@'),
           array('name' => 'doctor', 'prot' => '@aspass@'),
           array('name' => 'inst', 'prot' => '@aspass@'),
       );
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['pivot_order_level'] = -1;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['pivot_tabular_label'];
       ...
       //-----
       foreach ($this->comp_label[0] as $i_regdate => $l_regdate) {
           if (isset($this->array_total_regdate[$i_regdate])) {
               $this->comp_group[$i_regdate] = array();
           }
           foreach ($this->comp_label[1][$i_regdate] as $i_poly => $l_poly) {
               if (isset($this->array_total_poly[$i_regdate][$i_poly])) {
                   $this->comp_group[$i_regdate][$i_poly] = array();
               }
               foreach ($this->comp_label[2][$i_regdate][$i_poly] as $i_doctor => $l_doctor) {
                   if (isset($this->array_total_doctor[$i_regdate][$i_poly][$i_doctor])) {
                       $this->comp_group[$i_regdate][$i_poly][$i_doctor] = array();
                   }
                   foreach ($this->comp_label[3][$i_regdate][$i_poly][$i_doctor] as $i_inst => $l_inst) {
                       if (isset($this->array_total_inst[$i_regdate][$i_poly][$i_doctor][$i_inst])) {
                           $this->comp_group[$i_regdate][$i_poly][$i_doctor][$i_inst] = array();
                       }
                   }
               }
           }
   ...
   function getCompData($level, $params = array()) {
       if (0 == $level) {
           $return = $this->array_total_regdate;
       }
       elseif (1 == $level) {
           $return = $this->array_total_poly;
       }
       elseif (2 == $level) {
           $return = $this->array_total_doctor;
       }
       elseif (3 == $level) {
           $return = $this->array_total_inst;
       }
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_eis_rajal@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['embutida'])
                   {
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['proc_pdf_vert']){ 
   ...
   {
       if (!$res_chart && $this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['json_use_format']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['json_use_format'])
       {
           return $valor_campo;
       }
       ...
       if ($total == 2)
       {
           nmgp_Form_Num_Val($valor_campo, ".", ",", "2", "S", "", "Rp", "V:3:", "-");
       }
       return $valor_campo;
   }
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         $this->monta_html_ini();
         $this->monta_cabecalho();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function resumo_final()
   {
      ...
      if (!$this->NM_res_sem_reg && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['opcao'] != "pdf")
      {
          $this->grafico_bot();
      }
      if ("out" == $this->NM_tipo)
   ...
   function inicializa_vars()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         require_once($this->Ini->path_aplicacao . "grid_eis_rajal_total.class.php"); 
      }
      ...
      $this->Total   = new grid_eis_rajal_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['tot_geral'] as $ind => $val)
      {
          if ($ind > 0)
          {
      ...
      $this->array_total_doctor = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['arr_total']['doctor'];
      $this->array_total_inst = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['arr_total']['inst'];
      ksort($this->array_total_regdate);
      ksort($this->array_total_poly);
      ksort($this->array_total_doctor);
      ksort($this->array_total_inst);
   }
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['dashboard_refresh_after_chart'] = 'resumo';
      $nm_saida->saida("<HTML" . $_SESSION['scriptcase']['reg_conf']['html_dir'] . ">\r\n");
      $nm_saida->saida("<HEAD>\r\n");
      $nm_saida->saida(" <TITLE>" . $this->Ini->Nm_lang['lang_othr_smry_title'] . " tbantrian</TITLE>\r\n");
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['doc_word'])
{
   ...
   { 
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_eis_rajal_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grid_eis_rajal_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_eis_rajal_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['num_css'] . '.css');
...
$nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_eis_rajal/grid_eis_rajal_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\">\r\n");
           ...
           $nm_saida->saida("     }\r\n");
           $nm_saida->saida("   </script>\r\n");
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['ajax_nav'] && !$this->Ini->sc_export_ajax && !$this->Ini->Export_html_zip && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['doc_word'])
      {
           $nm_saida->saida("   <script type=\"text/javascript\"> \r\n");
          ...
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['grid_pesq']))
          { 
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['doc_word']) 
      {
      ...
      {
          $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['dashboard_info']['remove_margin'] ? ' style="margin: 0"' : '';
          $nm_saida->saida(" <BODY class=\"" . $this->css_scGridPage . "\"" . $remove_margin . ">\r\n");
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['embutida'])
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top_normal()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['pdf'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "Rpdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_eis_rajal/grid_eis_rajal_config_pdf.php?nm_opc=pdf_res&nm_target=0&nm_cor=cor&papel=1&orientacao=1&bookmarks=1&largura=1200&conf_larg=S&conf_fonte=10&grafico=XX&sc_ver_93=" . s . "&nm_tem_gb=s&nm_res_cons=s&nm_ini_pdf_res=resume&nm_all_modules=grid,resume&password=n&summary_export_columns=N&nm_label_group=S&nm_all_cab=N&nm_all_label=N&pdf_zip=N&nm_orient_grid=2&origem=res&language=id&conf_socor=N&script_case_init=" . $this->Ini->sc_page . "&app_name=grid_eis_rajal&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['word'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "Rword_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_eis_rajal/grid_eis_rajal_config_word.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=N&nm_cor=AM&nm_res_cons=s&nm_ini_word_res=resume&nm_all_modules=grid,resume&password=n&origem=res&language=id&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_eis_rajal/grid_eis_rajal_config_print.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=N&nm_opc=resumo&nm_cor=PB&nm_res_cons=s&nm_ini_prt_res=resume&nm_all_modules=grid,resume&password=n&origem=res&language=id&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if ($this->nmgp_botoes['chart_detail'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("grid_eis_rajal_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
   ...
   function monta_html_fim()
   {
      ...
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_eis_rajal']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_eis_rajal']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'grid_eis_rajal_config_pivot.php?nome_apl=grid_eis_rajal&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=id&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_eis_rajal_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "grid_eis_rajal/grid_eis_rajal_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
...
//--- 
 function grafico_bot()
 {
   ...
   $bPDF = false;
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['pivot_charts']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['graf_bot'] = true;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['graf_first'] = true;
       require_once($this->Ini->path_aplicacao . $this->Ini->Apl_grafico); 
       $this->Graf  = new grid_eis_rajal_grafico();
       $this->Graf->Db     = $this->Db;
       $this->Graf->Erro   = $this->Erro;
       ...
       $nm_saida->saida("<TR>\r\n");
       $iChartCount = 1;
       $iChartTotal = sizeof($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['pivot_charts']);
      ...
      if ($bPDF && (!isset($this->progress_fp) || !$this->progress_fp))
      {
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['pivot_charts'] as $chart_index => $chart_data)
       {
           $qtd_col++;
           if ($qtd_col > $lim_col)
           {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['ajax_nav'])
      {
       ...
       $nm_saida->saida("</TABLE>\r\n");
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['graf_bot'] = false;
       if ($bPDF && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['charts_html']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['charts_html'])
       {
           $nm_saida->saida("<script type=\"text/javascript\">\r\n");
           $nm_saida->saida("{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['charts_html']}\r\n");
           $nm_saida->saida("</script>\r\n");
       }
   }
 }
//--- 
   ...
   {
      global $nm_saida;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
      ...
      { 
        ...
        if ($_SESSION['scriptcase']['charset'] != "UTF-8")
        {
          ...
          $regdate = $Busca_temp['regdate']; 
          $tmp_pos = strpos($regdate, "##@@");
          if ($tmp_pos !== false && !is_array($regdate))
          {
              $regdate = substr($regdate, 0, $tmp_pos);
          }
          $regdate_2 = $Busca_temp['regdate_input_2']; 
          $doctor = $Busca_temp['doctor']; 
          $tmp_pos = strpos($doctor, "##@@");
          if ($tmp_pos !== false && !is_array($doctor))
          {
              $doctor = substr($doctor, 0, $tmp_pos);
          }
          $poly = $Busca_temp['poly']; 
          $tmp_pos = strpos($poly, "##@@");
          if ($tmp_pos !== false && !is_array($poly))
          {
              $poly = substr($poly, 0, $tmp_pos);
          }
      } 
   ...
   //---- 
   function adiciona_registro($sum_tariff, $quebra_regdate, $quebra_poly, $quebra_doctor, $quebra_inst, $quebra_regdate_orig, $quebra_poly_orig, $quebra_doctor_orig, $quebra_inst_orig)
   {
      //----- " . $this->Ini->Nm_lang['lang_othr_cons_title_YYYYMM'] . "
      if (!isset($this->array_total_regdate[$quebra_regdate_orig]))
      {
         $this->array_total_regdate[$quebra_regdate_orig][0] = 1;
         $this->array_total_regdate[$quebra_regdate_orig][1] = $sum_tariff;
         $this->array_total_regdate[$quebra_regdate_orig][2] = 1;
         $this->array_total_regdate[$quebra_regdate_orig][3] = $quebra_regdate;
         $this->array_total_regdate[$quebra_regdate_orig][4] = $quebra_regdate_orig;
      }
      else
      {
         $this->array_total_regdate[$quebra_regdate_orig][0]++;
         $this->array_total_regdate[$quebra_regdate_orig][1] += $sum_tariff;
         $this->array_total_regdate[$quebra_regdate_orig][2]++;
      }
      //----- Poliklinik
      if (!isset($this->array_total_poly[$quebra_regdate_orig][$quebra_poly_orig]))
      {
         $this->array_total_poly[$quebra_regdate_orig][$quebra_poly_orig][0] = 1;
         $this->array_total_poly[$quebra_regdate_orig][$quebra_poly_orig][1] = $sum_tariff;
         $this->array_total_poly[$quebra_regdate_orig][$quebra_poly_orig][2] = 1;
         $this->array_total_poly[$quebra_regdate_orig][$quebra_poly_orig][3] = $quebra_poly;
         $this->array_total_poly[$quebra_regdate_orig][$quebra_poly_orig][4] = $quebra_poly_orig;
      }
      else
      {
         $this->array_total_poly[$quebra_regdate_orig][$quebra_poly_orig][0]++;
         $this->array_total_poly[$quebra_regdate_orig][$quebra_poly_orig][1] += $sum_tariff;
         $this->array_total_poly[$quebra_regdate_orig][$quebra_poly_orig][2]++;
      }
      //----- Dokter
      if (!isset($this->array_total_doctor[$quebra_regdate_orig][$quebra_poly_orig][$quebra_doctor_orig]))
      {
         $this->array_total_doctor[$quebra_regdate_orig][$quebra_poly_orig][$quebra_doctor_orig][0] = 1;
         $this->array_total_doctor[$quebra_regdate_orig][$quebra_poly_orig][$quebra_doctor_orig][1] = $sum_tariff;
         $this->array_total_doctor[$quebra_regdate_orig][$quebra_poly_orig][$quebra_doctor_orig][2] = 1;
         $this->array_total_doctor[$quebra_regdate_orig][$quebra_poly_orig][$quebra_doctor_orig][3] = $quebra_doctor;
         $this->array_total_doctor[$quebra_regdate_orig][$quebra_poly_orig][$quebra_doctor_orig][4] = $quebra_doctor_orig;
      }
      else
      {
         $this->array_total_doctor[$quebra_regdate_orig][$quebra_poly_orig][$quebra_doctor_orig][0]++;
         $this->array_total_doctor[$quebra_regdate_orig][$quebra_poly_orig][$quebra_doctor_orig][1] += $sum_tariff;
         $this->array_total_doctor[$quebra_regdate_orig][$quebra_poly_orig][$quebra_doctor_orig][2]++;
      }
      //----- Provider
      if (!isset($this->array_total_inst[$quebra_regdate_orig][$quebra_poly_orig][$quebra_doctor_orig][$quebra_inst_orig]))
      {
         $this->array_total_inst[$quebra_regdate_orig][$quebra_poly_orig][$quebra_doctor_orig][$quebra_inst_orig][0] = 1;
         $this->array_total_inst[$quebra_regdate_orig][$quebra_poly_orig][$quebra_doctor_orig][$quebra_inst_orig][1] = $sum_tariff;
         $this->array_total_inst[$quebra_regdate_orig][$quebra_poly_orig][$quebra_doctor_orig][$quebra_inst_orig][2] = 1;
         $this->array_total_inst[$quebra_regdate_orig][$quebra_poly_orig][$quebra_doctor_orig][$quebra_inst_orig][3] = $quebra_inst;
         $this->array_total_inst[$quebra_regdate_orig][$quebra_poly_orig][$quebra_doctor_orig][$quebra_inst_orig][4] = $quebra_inst_orig;
      }
      else
      {
         $this->array_total_inst[$quebra_regdate_orig][$quebra_poly_orig][$quebra_doctor_orig][$quebra_inst_orig][0]++;
         $this->array_total_inst[$quebra_regdate_orig][$quebra_poly_orig][$quebra_doctor_orig][$quebra_inst_orig][1] += $sum_tariff;
         $this->array_total_inst[$quebra_regdate_orig][$quebra_poly_orig][$quebra_doctor_orig][$quebra_inst_orig][2]++;
      }
      //----- Total
      if (empty($this->array_total_geral))
      {
         $this->array_total_geral[0] = 1;
         $this->array_total_geral[1] = $sum_tariff;
   ...
   {
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['arr_total']['regdate'] as $campo_regdate => $dados_regdate)
      {
         $this->array_total_regdate[$campo_regdate][2] = $dados_regdate[1];
         $this->array_total_regdate[$campo_regdate][1] = $dados_regdate[2];
         foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['arr_total']['poly'][$campo_regdate] as $campo_poly => $dados_poly)
         {
            $this->array_total_poly[$campo_regdate][$campo_poly][2] = $dados_poly[1];
            $this->array_total_poly[$campo_regdate][$campo_poly][1] = $dados_poly[2];
            foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['arr_total']['doctor'][$campo_regdate][$campo_poly] as $campo_doctor => $dados_doctor)
            {
               $this->array_total_doctor[$campo_regdate][$campo_poly][$campo_doctor][2] = $dados_doctor[1];
               $this->array_total_doctor[$campo_regdate][$campo_poly][$campo_doctor][1] = $dados_doctor[2];
               foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['arr_total']['inst'][$campo_regdate][$campo_poly][$campo_doctor] as $campo_inst => $dados_inst)
               {
                  $this->array_total_inst[$campo_regdate][$campo_poly][$campo_doctor][$campo_inst][2] = $dados_inst[1];
                  $this->array_total_inst[$campo_regdate][$campo_poly][$campo_doctor][$campo_inst][1] = $dados_inst[2];
               }
            }
         }
      }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('', 'regdate');
     $campos_order = $this->Ini->Get_date_order_groupby("regDate", 'asc', $format, $campos_order);
     $format       = $this->Ini->Get_Gb_date_format('', 'poly');
     $campos_order = $this->Ini->Get_date_order_groupby("poly", 'asc', $format, $campos_order);
     $format       = $this->Ini->Get_Gb_date_format('', 'doctor');
     $campos_order = $this->Ini->Get_date_order_groupby("doctor", 'asc', $format, $campos_order);
     $format       = $this->Ini->Get_Gb_date_format('', 'inst');
     $campos_order = $this->Ini->Get_date_order_groupby("inst", 'asc', $format, $campos_order);
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->poly = $rs_res->fields[0] ;  
            $this->doctor = $rs_res->fields[1] ;  
            $this->regdate = $rs_res->fields[2] ;  
            $this->inst = $rs_res->fields[3] ;  
            $this->bayar = $rs_res->fields[4] ;  
            $this->struckno = $rs_res->fields[5] ;  
...
$_SESSION['scriptcase']['grid_eis_rajal']['contr_erro'] = 'off'; 
            ...
            $this->regdate_orig = $this->Ini->Get_arg_groupby($TP_Time . $this->regdate, $Format_tst);
            $this->regdate = $this->Ini->GB_date_format($TP_Time . $this->regdate, $Format_tst, $Prefix_dat);
            $this->poly_orig = $this->poly;
            $this->doctor_orig = $this->doctor;
            $this->inst_orig = $this->inst;
            $this->poly = $this->look_poly ;
            $this->doctor = $this->look_doctor ;
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->tariff, $this->regdate, $this->poly, $this->doctor, $this->inst, $this->regdate_orig,  $this->poly_orig,  $this->doctor_orig,  $this->inst_orig);
            }
   }
//
...
$_SESSION['scriptcase']['grid_eis_rajal']['contr_erro'] = 'off';
     ...
     $this->regdate = $this->Ini->GB_date_format($TP_Time . $regdate_SV, $Format_tst, $Prefix_dat); 
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['arr_total']['regdate'] = $this->array_total_regdate;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['arr_total']['poly'] = $this->array_total_poly;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['arr_total']['doctor'] = $this->array_total_doctor;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eis_rajal']['arr_total']['inst'] = $this->array_total_inst;
      }
   }
