...
<?php
   ...
   $Ord_Cmp = new grid_eis_rajal_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_eis_rajal_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_eis_rajal']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_eis_rajal']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["poly"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_eis_rajal']['labels']["poly"])) ? $_SESSION['sc_session'][$sc_init]['grid_eis_rajal']['labels']["poly"] : "Poliklinik";
   $tab_ger_campos['doctor'] = "on";
   $tab_def_campos['doctor'] = "doctor";
   $tab_labels["doctor"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_eis_rajal']['labels']["doctor"])) ? $_SESSION['sc_session'][$sc_init]['grid_eis_rajal']['labels']["doctor"] : "Dokter";
   $tab_ger_campos['regdate'] = "on";
   $tab_def_campos['regdate'] = "regDate";
   $tab_labels["regdate"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_eis_rajal']['labels']["regdate"])) ? $_SESSION['sc_session'][$sc_init]['grid_eis_rajal']['labels']["regdate"] : "Tgl. Daftar";
   $tab_ger_campos['inst'] = "on";
   $tab_def_campos['inst'] = "inst";
   $tab_labels["inst"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_eis_rajal']['labels']["inst"])) ? $_SESSION['sc_session'][$sc_init]['grid_eis_rajal']['labels']["inst"] : "Provider";
   $tab_ger_campos['bayar'] = "on";
   $tab_def_campos['bayar'] = "bayar";
   $tab_labels["bayar"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_eis_rajal']['labels']["bayar"])) ? $_SESSION['sc_session'][$sc_init]['grid_eis_rajal']['labels']["bayar"] : "Bayar";
   $tab_ger_campos['tariff'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['tariff'] = "Tariff";
   }
   else
   {
       $tab_def_campos['tariff'] = "";
   }
   $tab_labels["tariff"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_eis_rajal']['labels']["tariff"])) ? $_SESSION['sc_session'][$sc_init]['grid_eis_rajal']['labels']["tariff"] : "Tariff";
   $tab_ger_campos['tariff'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_eis_rajal']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_eis_rajal']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_eis_rajal']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_eis_rajal']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_eis_rajal']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_eis_rajal']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_eis_rajal']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_eis_rajal']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_eis_rajal']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_eis_rajal_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_eis_rajal']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_eis_rajal']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_eis_rajal']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_eis_rajal']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_eis_rajal']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
