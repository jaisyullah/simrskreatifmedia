...
//--- 
   ...
   //---- 
   function adiciona_registro($sum_masuk, $sum_keluar, $sum_kumulatif)
   {
      //----- Total
      if (empty($this->array_total_geral))
      {
         $this->array_total_geral[0] = 1;
         $this->array_total_geral[1] = $sum_masuk;
         $this->array_total_geral[2] = $sum_keluar;
         $this->array_total_geral[3] = $sum_kumulatif;
      }
      else
      {
...
//
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok']['order_grid'] = $nmgp_order_by;
      ...
      while (!$this->rs_grid->EOF) 
      {
         ...
         $this->adiciona_registro(NM_encode_input(sc_strip_script($this->masuk)), NM_encode_input(sc_strip_script($this->keluar)), NM_encode_input(sc_strip_script($this->kumulatif)));
         $this->rs_grid->MoveNext();
      }
      $this->finaliza_arrays();
      $this->rs_grid->Close();
      $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok']['tot_geral'][2] = $this->array_total_geral[1];
      $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok']['tot_geral'][3] = $this->array_total_geral[2];
      $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok']['tot_geral'][4] = $this->array_total_geral[3];
      $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok']['contr_array_resumo'] = "OK";
