...
<?php
   ...
   $Ord_Cmp = new kartu_stok_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class kartu_stok_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['kartu_stok']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['kartu_stok']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['kadaluarsa'] = "Kadaluarsa";
   $tab_labels["kadaluarsa"]   = (isset($_SESSION['sc_session'][$sc_init]['kartu_stok']['labels']["kadaluarsa"])) ? $_SESSION['sc_session'][$sc_init]['kartu_stok']['labels']["kadaluarsa"] : "Tgl Kadaluarsa";
   $tab_ger_campos['transaksi'] = "on";
   $tab_def_campos['transaksi'] = "Transaksi";
   $tab_labels["transaksi"]   = (isset($_SESSION['sc_session'][$sc_init]['kartu_stok']['labels']["transaksi"])) ? $_SESSION['sc_session'][$sc_init]['kartu_stok']['labels']["transaksi"] : "Tgl Transaksi";
   $tab_ger_campos['trancode'] = "on";
   $tab_def_campos['trancode'] = "tranCode";
   $tab_labels["trancode"]   = (isset($_SESSION['sc_session'][$sc_init]['kartu_stok']['labels']["trancode"])) ? $_SESSION['sc_session'][$sc_init]['kartu_stok']['labels']["trancode"] : "Kode Transaksi";
   $tab_ger_campos['kategori'] = "on";
   $tab_def_campos['kategori'] = "Kategori";
   $tab_labels["kategori"]   = (isset($_SESSION['sc_session'][$sc_init]['kartu_stok']['labels']["kategori"])) ? $_SESSION['sc_session'][$sc_init]['kartu_stok']['labels']["kategori"] : "Kategori";
   $tab_ger_campos['deskripsi'] = "on";
   $tab_def_campos['deskripsi'] = "Deskripsi";
   $tab_labels["deskripsi"]   = (isset($_SESSION['sc_session'][$sc_init]['kartu_stok']['labels']["deskripsi"])) ? $_SESSION['sc_session'][$sc_init]['kartu_stok']['labels']["deskripsi"] : "Nama Item";
   $tab_ger_campos['masuk'] = "on";
   $tab_def_campos['masuk'] = "Masuk";
   $tab_labels["masuk"]   = (isset($_SESSION['sc_session'][$sc_init]['kartu_stok']['labels']["masuk"])) ? $_SESSION['sc_session'][$sc_init]['kartu_stok']['labels']["masuk"] : "Masuk";
   $tab_ger_campos['keluar'] = "on";
   $tab_def_campos['keluar'] = "Keluar";
   $tab_labels["keluar"]   = (isset($_SESSION['sc_session'][$sc_init]['kartu_stok']['labels']["keluar"])) ? $_SESSION['sc_session'][$sc_init]['kartu_stok']['labels']["keluar"] : "Keluar";
   $tab_ger_campos['kumulatif'] = "on";
   $tab_def_campos['kumulatif'] = "Kumulatif";
   $tab_labels["kumulatif"]   = (isset($_SESSION['sc_session'][$sc_init]['kartu_stok']['labels']["kumulatif"])) ? $_SESSION['sc_session'][$sc_init]['kartu_stok']['labels']["kumulatif"] : "Masuk-Keluar";
   $tab_ger_campos['cumulatif'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['cumulatif'] = "Cumulatif";
   }
   else
   {
       $tab_def_campos['cumulatif'] = "";
   }
   $tab_labels["cumulatif"]   = (isset($_SESSION['sc_session'][$sc_init]['kartu_stok']['labels']["cumulatif"])) ? $_SESSION['sc_session'][$sc_init]['kartu_stok']['labels']["cumulatif"] : "Kumulatif";
   $tab_ger_campos['cumulatif'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['kartu_stok']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['kartu_stok']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['kartu_stok']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['kartu_stok']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['kartu_stok']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['kartu_stok']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['kartu_stok']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['kartu_stok']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['kartu_stok']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "kartu_stok_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['kartu_stok']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['kartu_stok']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['kartu_stok']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['kartu_stok']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['kartu_stok']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
