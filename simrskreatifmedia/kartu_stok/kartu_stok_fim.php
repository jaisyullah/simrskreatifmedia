...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____kartu_stok"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____kartu_stok"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['kartu_stok']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['kartu_stok']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['kartu_stok']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['kartu_stok']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['kartu_stok']['sc_modal']);
           if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['kartu_stok']['opc_psq']))
           {
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['kartu_stok']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['kartu_stok']['embutida_filho'] as $ind => $sc_init)
          {
