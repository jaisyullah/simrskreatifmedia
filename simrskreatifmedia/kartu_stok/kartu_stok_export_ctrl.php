<?php
@session_start() ;
$_SESSION['scriptcase']['kartu_stok']['sc_process_barr'] = true;
require_once('../kartu_stok/index.php');
unset($_SESSION['scriptcase']['kartu_stok']['sc_process_barr']);
$ExportCtrl = new kartu_stok_export_control;
$ExportCtrl->Export_barr();

class kartu_stok_export_control
{
