...
class kartu_stok_total
{
   ...
   function __construct($sc_page)
   {
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['kartu_stok']['campos_busca']) && !empty($_SESSION['sc_session'][$this->sc_page]['kartu_stok']['campos_busca']))
      { 
