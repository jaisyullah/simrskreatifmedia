...
class kartu_stok_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok']['path_libs_php'] = $this->Ini->path_lib_php;
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok']['prim_vez']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok']['prim_vez'] = "S";
      }
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . kartu_stok_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . kartu_stok_pack_protect_string($Tipo_filter[0]) . "\">.." . kartu_stok_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $Nm_datas[] = "Kadaluarsa";$Nm_datas[] = "Kadaluarsa";$Nm_datas[] = "Transaksi";$Nm_datas[] = "Transaksi";
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
   ...
   $NM_retorno = "./";
    if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok']['proc_res'])) 
    {
...
<?php
    if ($_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok']['prim_vez'] == "N" && !$_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok']['proc_res']) 
    {
?>
if (parent.document.getElementById('nmsc_iframe_kartu_stok').contentWindow.nm_gp_submit_ajax)
{
   parent.document.getElementById('nmsc_iframe_kartu_stok').contentWindow.nm_gp_submit_ajax('inicio', 'save_grid');
}
else
{
   parent.document.getElementById('nmsc_iframe_kartu_stok').src = 'index.php?nmgp_opcao=pesq&script_case_init=<?php echo NM_encode_input($this->Ini->sc_page) ?>&script_case_session=<?php echo session_id() ?>';
}
<?php
    }
    else
...
<?php
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok']['prim_vez'] = "N";
?>
</SCRIPT>
</BODY>
</HTML>
...
<HEAD>
 <TITLE>Kartu Stok Farmasi</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>kartu_stok/kartu_stok_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="kartu_stok_ajax_search.js"></script>
 <script type="text/javascript" src="kartu_stok_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="kartu_stok_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['kartu_stok']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['kartu_stok']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
function scJQCalendarAdd() {
  $("#sc_transaksi_jq").datepicker({
    beforeShow: function(input, inst) {
          var_dt_ini  = document.getElementById('SC_transaksi_dia').value + '/';
          var_dt_ini += document.getElementById('SC_transaksi_mes').value + '/';
          var_dt_ini += document.getElementById('SC_transaksi_ano').value;
          document.getElementById('sc_transaksi_jq').value = var_dt_ini;
    },
    onClose: function(dateText, inst) {
          aParts  = dateText.split("/");
          document.getElementById('SC_transaksi_dia').value = aParts[0];
          document.getElementById('SC_transaksi_mes').value = aParts[1];
          document.getElementById('SC_transaksi_ano').value = aParts[2];
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
  ...
  $("#sc_transaksi_jq2").datepicker({
    beforeShow: function(input, inst) {
          var_dt_ini  = document.getElementById('SC_transaksi_input_2_dia').value + '/';
          var_dt_ini += document.getElementById('SC_transaksi_input_2_mes').value + '/';
          var_dt_ini += document.getElementById('SC_transaksi_input_2_ano').value;
          document.getElementById('sc_transaksi_jq2').value = var_dt_ini;
    },
    onClose: function(dateText, inst) {
          aParts  = dateText.split("/");
          document.getElementById('SC_transaksi_input_2_dia').value = aParts[0];
          document.getElementById('SC_transaksi_input_2_mes').value = aParts[1];
          document.getElementById('SC_transaksi_input_2_ano').value = aParts[2];
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_transaksi_cond#NMF#' + search_get_sel_txt('SC_transaksi_cond') + '@NMF@';
  str_out += 'SC_transaksi_dia#NMF#' + search_get_sel_txt('SC_transaksi_dia') + '@NMF@';
  str_out += 'SC_transaksi_mes#NMF#' + search_get_sel_txt('SC_transaksi_mes') + '@NMF@';
  str_out += 'SC_transaksi_ano#NMF#' + search_get_sel_txt('SC_transaksi_ano') + '@NMF@';
  str_out += 'SC_transaksi_input_2_dia#NMF#' + search_get_sel_txt('SC_transaksi_input_2_dia') + '@NMF@';
  str_out += 'SC_transaksi_input_2_mes#NMF#' + search_get_sel_txt('SC_transaksi_input_2_mes') + '@NMF@';
  str_out += 'SC_transaksi_input_2_ano#NMF#' + search_get_sel_txt('SC_transaksi_input_2_ano') + '@NMF@';
...
<?php
   ...
   {
      global 
             $transaksi_cond, $transaksi, $transaksi_dia, $transaksi_mes, $transaksi_ano, $transaksi_input_2_dia, $transaksi_input_2_mes, $transaksi_input_2_ano,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $transaksi_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok']['campos_busca']['transaksi_dia']; 
          $transaksi_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok']['campos_busca']['transaksi_mes']; 
          $transaksi_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok']['campos_busca']['transaksi_ano']; 
          $transaksi_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok']['campos_busca']['transaksi_input_2_dia']; 
          $transaksi_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok']['campos_busca']['transaksi_input_2_mes']; 
          $transaksi_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok']['campos_busca']['transaksi_input_2_ano']; 
          $transaksi_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok']['campos_busca']['transaksi_cond']; 
          $deskripsi = $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok']['campos_busca']['deskripsi']; 
          $deskripsi_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok']['campos_busca']['deskripsi_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok']['campos_busca']['NM_operador']; 
      } 
      if (!isset($transaksi_cond) || empty($transaksi_cond))
      {
         $transaksi_cond = "bw";
      }
      ...
      $str_hide_transaksi = (in_array($transaksi_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_deskripsi = (in_array($deskripsi_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      $str_display_transaksi = ('bw' == $transaksi_cond) ? $display_aberto : $display_fechado;
      ...
      {
         $tmp_pos = strpos($transaksi, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $transaksi = substr($transaksi, 0, $tmp_pos);
         }
      }
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_transaksi_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['transaksi'])) ? $this->New_label['transaksi'] : "Tgl Transaksi"; ?></TD>
      
      <INPUT type="hidden" id="SC_transaksi_cond" name="transaksi_cond" value="bw">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_transaksi" <?php echo $str_hide_transaksi?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['transaksi'])) ? $this->New_label['transaksi'] : "Tgl Transaksi";
 $nmgp_tab_label .= "transaksi?#?" . $SC_Label . "?@?";
...
<?php
  ...
  {
?>
<span id='id_date_part_transaksi_DD' style='display: inline-block'>

         <SELECT class="scFilterObjectOdd" id="SC_transaksi_dia" name="transaksi_dia">
          <OPTION value=""></OPTION>
          <OPTION value="01" <?php if ("01" == $transaksi_dia) { echo "selected"; } ?>>01</OPTION>
          <OPTION value="02" <?php if ("02" == $transaksi_dia) { echo "selected"; } ?>>02</OPTION>
          <OPTION value="03" <?php if ("03" == $transaksi_dia) { echo "selected"; } ?>>03</OPTION>
          <OPTION value="04" <?php if ("04" == $transaksi_dia) { echo "selected"; } ?>>04</OPTION>
          <OPTION value="05" <?php if ("05" == $transaksi_dia) { echo "selected"; } ?>>05</OPTION>
          <OPTION value="06" <?php if ("06" == $transaksi_dia) { echo "selected"; } ?>>06</OPTION>
          <OPTION value="07" <?php if ("07" == $transaksi_dia) { echo "selected"; } ?>>07</OPTION>
          <OPTION value="08" <?php if ("08" == $transaksi_dia) { echo "selected"; } ?>>08</OPTION>
          <OPTION value="09" <?php if ("09" == $transaksi_dia) { echo "selected"; } ?>>09</OPTION>
          <OPTION value="10" <?php if ("10" == $transaksi_dia) { echo "selected"; } ?>>10</OPTION>
          <OPTION value="11" <?php if ("11" == $transaksi_dia) { echo "selected"; } ?>>11</OPTION>
          <OPTION value="12" <?php if ("12" == $transaksi_dia) { echo "selected"; } ?>>12</OPTION>
          <OPTION value="13" <?php if ("13" == $transaksi_dia) { echo "selected"; } ?>>13</OPTION>
          <OPTION value="14" <?php if ("14" == $transaksi_dia) { echo "selected"; } ?>>14</OPTION>
          <OPTION value="15" <?php if ("15" == $transaksi_dia) { echo "selected"; } ?>>15</OPTION>
          <OPTION value="16" <?php if ("16" == $transaksi_dia) { echo "selected"; } ?>>16</OPTION>
          <OPTION value="17" <?php if ("17" == $transaksi_dia) { echo "selected"; } ?>>17</OPTION>
          <OPTION value="18" <?php if ("18" == $transaksi_dia) { echo "selected"; } ?>>18</OPTION>
          <OPTION value="19" <?php if ("19" == $transaksi_dia) { echo "selected"; } ?>>19</OPTION>
          <OPTION value="20" <?php if ("20" == $transaksi_dia) { echo "selected"; } ?>>20</OPTION>
          <OPTION value="21" <?php if ("21" == $transaksi_dia) { echo "selected"; } ?>>21</OPTION>
          <OPTION value="22" <?php if ("22" == $transaksi_dia) { echo "selected"; } ?>>22</OPTION>
          <OPTION value="23" <?php if ("23" == $transaksi_dia) { echo "selected"; } ?>>23</OPTION>
          <OPTION value="24" <?php if ("24" == $transaksi_dia) { echo "selected"; } ?>>24</OPTION>
          <OPTION value="25" <?php if ("25" == $transaksi_dia) { echo "selected"; } ?>>25</OPTION>
          <OPTION value="26" <?php if ("26" == $transaksi_dia) { echo "selected"; } ?>>26</OPTION>
          <OPTION value="27" <?php if ("27" == $transaksi_dia) { echo "selected"; } ?>>27</OPTION>
          <OPTION value="28" <?php if ("28" == $transaksi_dia) { echo "selected"; } ?>>28</OPTION>
          <OPTION value="29" <?php if ("29" == $transaksi_dia) { echo "selected"; } ?>>29</OPTION>
          <OPTION value="30" <?php if ("30" == $transaksi_dia) { echo "selected"; } ?>>30</OPTION>
          <OPTION value="31" <?php if ("31" == $transaksi_dia) { echo "selected"; } ?>>31</OPTION>
         </SELECT>
         </span>
...
<?php
  ...
  {
?>
<span id='id_date_part_transaksi_MM' style='display: inline-block'>

         <SELECT class="scFilterObjectOdd" id="SC_transaksi_mes" name="transaksi_mes">
          <OPTION value=""></OPTION>
          <OPTION value="01" <?php if ("01" == $transaksi_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][0] ?></OPTION>
          <OPTION value="02" <?php if ("02" == $transaksi_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][1] ?></OPTION>
          <OPTION value="03" <?php if ("03" == $transaksi_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][2] ?></OPTION>
          <OPTION value="04" <?php if ("04" == $transaksi_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][3] ?></OPTION>
          <OPTION value="05" <?php if ("05" == $transaksi_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][4] ?></OPTION>
          <OPTION value="06" <?php if ("06" == $transaksi_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][5] ?></OPTION>
          <OPTION value="07" <?php if ("07" == $transaksi_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][6] ?></OPTION>
          <OPTION value="08" <?php if ("08" == $transaksi_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][7] ?></OPTION>
          <OPTION value="09" <?php if ("09" == $transaksi_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][8] ?></OPTION>
          <OPTION value="10" <?php if ("10" == $transaksi_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][9] ?></OPTION>
          <OPTION value="11" <?php if ("11" == $transaksi_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][10] ?></OPTION>
          <OPTION value="12" <?php if ("12" == $transaksi_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][11] ?></OPTION>
         </SELECT>
         </span>
...
<?php
  ...
  {
?>
<span id='id_date_part_transaksi_AAAA' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_transaksi_ano" name="transaksi_ano" value="<?php echo NM_encode_input($transaksi_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 <INPUT type="hidden" id="sc_transaksi_jq">
</span>
...
?>
       ...
       <TR valign="top">
        <TD id="id_vis_transaksi"  <?php echo $str_display_transaksi; ?> class="scFilterFieldFontOdd">
...
<?php
  ...
  {
?>
<span id='id_date_part_transaksi_input_2_DD' style='display: inline-block'>

         <SELECT class="scFilterObjectOdd" id="SC_transaksi_input_2_dia" name="transaksi_input_2_dia">
          <OPTION value=""></OPTION>
          <OPTION value="01" <?php if ("01" == $transaksi_input_2_dia) { echo "selected"; } ?>>01</OPTION>
          <OPTION value="02" <?php if ("02" == $transaksi_input_2_dia) { echo "selected"; } ?>>02</OPTION>
          <OPTION value="03" <?php if ("03" == $transaksi_input_2_dia) { echo "selected"; } ?>>03</OPTION>
          <OPTION value="04" <?php if ("04" == $transaksi_input_2_dia) { echo "selected"; } ?>>04</OPTION>
          <OPTION value="05" <?php if ("05" == $transaksi_input_2_dia) { echo "selected"; } ?>>05</OPTION>
          <OPTION value="06" <?php if ("06" == $transaksi_input_2_dia) { echo "selected"; } ?>>06</OPTION>
          <OPTION value="07" <?php if ("07" == $transaksi_input_2_dia) { echo "selected"; } ?>>07</OPTION>
          <OPTION value="08" <?php if ("08" == $transaksi_input_2_dia) { echo "selected"; } ?>>08</OPTION>
          <OPTION value="09" <?php if ("09" == $transaksi_input_2_dia) { echo "selected"; } ?>>09</OPTION>
          <OPTION value="10" <?php if ("10" == $transaksi_input_2_dia) { echo "selected"; } ?>>10</OPTION>
          <OPTION value="11" <?php if ("11" == $transaksi_input_2_dia) { echo "selected"; } ?>>11</OPTION>
          <OPTION value="12" <?php if ("12" == $transaksi_input_2_dia) { echo "selected"; } ?>>12</OPTION>
          <OPTION value="13" <?php if ("13" == $transaksi_input_2_dia) { echo "selected"; } ?>>13</OPTION>
          <OPTION value="14" <?php if ("14" == $transaksi_input_2_dia) { echo "selected"; } ?>>14</OPTION>
          <OPTION value="15" <?php if ("15" == $transaksi_input_2_dia) { echo "selected"; } ?>>15</OPTION>
          <OPTION value="16" <?php if ("16" == $transaksi_input_2_dia) { echo "selected"; } ?>>16</OPTION>
          <OPTION value="17" <?php if ("17" == $transaksi_input_2_dia) { echo "selected"; } ?>>17</OPTION>
          <OPTION value="18" <?php if ("18" == $transaksi_input_2_dia) { echo "selected"; } ?>>18</OPTION>
          <OPTION value="19" <?php if ("19" == $transaksi_input_2_dia) { echo "selected"; } ?>>19</OPTION>
          <OPTION value="20" <?php if ("20" == $transaksi_input_2_dia) { echo "selected"; } ?>>20</OPTION>
          <OPTION value="21" <?php if ("21" == $transaksi_input_2_dia) { echo "selected"; } ?>>21</OPTION>
          <OPTION value="22" <?php if ("22" == $transaksi_input_2_dia) { echo "selected"; } ?>>22</OPTION>
          <OPTION value="23" <?php if ("23" == $transaksi_input_2_dia) { echo "selected"; } ?>>23</OPTION>
          <OPTION value="24" <?php if ("24" == $transaksi_input_2_dia) { echo "selected"; } ?>>24</OPTION>
          <OPTION value="25" <?php if ("25" == $transaksi_input_2_dia) { echo "selected"; } ?>>25</OPTION>
          <OPTION value="26" <?php if ("26" == $transaksi_input_2_dia) { echo "selected"; } ?>>26</OPTION>
          <OPTION value="27" <?php if ("27" == $transaksi_input_2_dia) { echo "selected"; } ?>>27</OPTION>
          <OPTION value="28" <?php if ("28" == $transaksi_input_2_dia) { echo "selected"; } ?>>28</OPTION>
          <OPTION value="29" <?php if ("29" == $transaksi_input_2_dia) { echo "selected"; } ?>>29</OPTION>
          <OPTION value="30" <?php if ("30" == $transaksi_input_2_dia) { echo "selected"; } ?>>30</OPTION>
          <OPTION value="31" <?php if ("31" == $transaksi_input_2_dia) { echo "selected"; } ?>>31</OPTION>
         </SELECT>
         </span>
...
<?php
  ...
  {
?>
<span id='id_date_part_transaksi_input_2_MM' style='display: inline-block'>

         <SELECT class="scFilterObjectOdd" id="SC_transaksi_input_2_mes" name="transaksi_input_2_mes">
          <OPTION value=""></OPTION>
          <OPTION value="01" <?php if ("01" == $transaksi_input_2_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][0] ?></OPTION>
          <OPTION value="02" <?php if ("02" == $transaksi_input_2_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][1] ?></OPTION>
          <OPTION value="03" <?php if ("03" == $transaksi_input_2_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][2] ?></OPTION>
          <OPTION value="04" <?php if ("04" == $transaksi_input_2_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][3] ?></OPTION>
          <OPTION value="05" <?php if ("05" == $transaksi_input_2_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][4] ?></OPTION>
          <OPTION value="06" <?php if ("06" == $transaksi_input_2_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][5] ?></OPTION>
          <OPTION value="07" <?php if ("07" == $transaksi_input_2_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][6] ?></OPTION>
          <OPTION value="08" <?php if ("08" == $transaksi_input_2_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][7] ?></OPTION>
          <OPTION value="09" <?php if ("09" == $transaksi_input_2_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][8] ?></OPTION>
          <OPTION value="10" <?php if ("10" == $transaksi_input_2_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][9] ?></OPTION>
          <OPTION value="11" <?php if ("11" == $transaksi_input_2_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][10] ?></OPTION>
          <OPTION value="12" <?php if ("12" == $transaksi_input_2_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][11] ?></OPTION>
         </SELECT>
         </span>
...
<?php
  ...
  {
?>
<span id='id_date_part_transaksi_input_2_AAAA' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_transaksi_input_2_ano" name="transaksi_input_2_ano" value="<?php echo NM_encode_input($transaksi_input_2_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 <INPUT type="hidden" id="sc_transaksi_jq2">
</span>
...
?>
      ...
      <TD id='SC_deskripsi_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['deskripsi'])) ? $this->New_label['deskripsi'] : "Nama Item"; ?></TD>
...
<?php
      ...
      $nmgp_def_dados = "" ; 
      $nm_comando = "SELECT namaItem, namaItem  FROM tbobat WHERE aktif = 'Y' ORDER BY namaItem"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok']['psq_check_ret']['deskripsi'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok']['psq_check_ret']['deskripsi'][] = trim($rs->fields[0]);
...
?>
   <span id="idAjaxSelect_deskripsi">
...
<?php
      ...
      foreach ($nm_opcoes as $nm_opcao)
      {
         if (!empty($nm_opcao))
         {
            ...
            {
               $deskripsi_sel = "";
               foreach ($deskripsi as $Dados)
               {
                   if ($Dados === $nm_opc_cod)
                   {
                       $deskripsi_sel = "selected";
                       break;
                   }
               }
            }
            ...
            {
               $deskripsi_sel = ("S" == $nm_opc_sel) ? "selected" : "";
            }
            $nm_sc_valor = $nm_opc_val;
            $nm_opc_val = $nm_sc_valor;
?>
       <OPTION value="<?php echo NM_encode_input($nm_opc_cod . $delimitador . $nm_opc_val); ?>" <?php echo $deskripsi_sel; ?>><?php echo $nm_opc_val; ?></OPTION>
<?php
         }
      }
?>
...
?>
<?php
   if (is_file("kartu_stok_help.txt"))
   {
...
?>
<?php
   if ($nm_apl_dependente == 1 || (!$_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok']['opc_psq'] && !$this->aba_iframe))
   {
...
<?php
       ...
       elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok']['dashboard_info']['under_dashboard'])
       { }
       else 
       { 
?>
...
<?php
   ...
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok']['opc_psq'])
   {
...
<?php
    if ($_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok']['prim_vez'] == "N") 
    {
?>
       <iframe id="nmsc_iframe_kartu_stok" frameborder="0" marginwidth="0px" marginheight="0px" topmargin="0px" leftmargin="0px" align="center" height="1500px" name="nm_iframe_kartu_stok" scrolling="auto" src="index.php?nmgp_opcao=pesq&script_case_init=<?php echo NM_encode_input($this->Ini->sc_page) ?>&script_case_session=<?php echo session_id() ?>" width="100%"></iframe>
<?php
    }
    else
    {
?>
       <iframe id="nmsc_iframe_kartu_stok" frameborder="0" marginwidth="0px" marginheight="0px" topmargin="0px" leftmargin="0px" align="center" height="1500px" name="nm_iframe_kartu_stok" scrolling="auto" src="" width="100%"></iframe>
<?php
    }
?>
<iframe id="nmsc_iframe_kartu_stok_pesq"  name="nm_iframe_kartu_stok_pesq" style= "display: none;" frameborder="0" marginwidth="0px" marginheight="0px" topmargin="0px" leftmargin="0px" src=""></iframe>
</td></tr></table></td></tr>
</TABLE>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok']['orig_pesq'] == "grid")
   {
...
?>
 ...
 {
    document.F1.target = "nm_iframe_kartu_stok_pesq";
    document.F1.submit();
 }
 function nm_move()
 {
     document.getElementById('nmsc_iframe_kartu_stok').contentWindow.nm_move('igual');
 }
 function limpa_form()
 {
   document.F1.reset();
   ...
   document.F1.transaksi_cond.value = 'bw';
   nm_campos_between(document.getElementById('id_vis_transaksi'), document.F1.transaksi_cond, 'transaksi');
   document.F1.transaksi_dia.value = "";
   document.F1.transaksi_mes.value = "";
   document.F1.transaksi_ano.value = "";
   document.F1.transaksi_input_2_dia.value = "";
   document.F1.transaksi_input_2_mes.value = "";
   document.F1.transaksi_input_2_ano.value = "";
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "simrskreatifmedia/kartu_stok";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_transaksi_cond'] = 'cond';
      $tp_fields['SC_transaksi_dia'] = 'text';
      $tp_fields['SC_transaksi_mes'] = 'text';
      $tp_fields['SC_transaksi_ano'] = 'text';
      $tp_fields['SC_transaksi_input_2_dia'] = 'text';
      $tp_fields['SC_transaksi_input_2_mes'] = 'text';
      $tp_fields['SC_transaksi_input_2_ano'] = 'text';
   ...
   {
      global $transaksi_cond, $transaksi, $transaksi_dia, $transaksi_mes, $transaksi_ano, $transaksi_input_2_dia, $transaksi_input_2_mes, $transaksi_input_2_ano,
      ...
      $transaksi_cond_salva = $transaksi_cond; 
      if (!isset($transaksi_input_2_dia) || $transaksi_input_2_dia == "")
      {
          $transaksi_input_2_dia = $transaksi_dia;
      }
      if (!isset($transaksi_input_2_mes) || $transaksi_input_2_mes == "")
      {
          $transaksi_input_2_mes = $transaksi_mes;
      }
      if (!isset($transaksi_input_2_ano) || $transaksi_input_2_ano == "")
      {
          $transaksi_input_2_ano = $transaksi_ano;
      }
      ...
      if (is_array($deskripsi)) {
          foreach ($deskripsi as $I => $Val) {
              ...
              if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && trim($L_lookup) != '' && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok']['psq_check_ret']['deskripsi'])) {
                  if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "Nama Item : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
                  break;
              }
          }
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok']['campos_busca']['transaksi_dia'] = $transaksi_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok']['campos_busca']['transaksi_mes'] = $transaksi_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok']['campos_busca']['transaksi_ano'] = $transaksi_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok']['campos_busca']['transaksi_input_2_dia'] = $transaksi_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok']['campos_busca']['transaksi_input_2_mes'] = $transaksi_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok']['campos_busca']['transaksi_input_2_ano'] = $transaksi_input_2_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok']['campos_busca']['transaksi_cond'] = $transaksi_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok']['campos_busca']['deskripsi'] = $deskripsi; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok']['campos_busca']['deskripsi_cond'] = $deskripsi_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      }
      $this->cmp_formatado['deskripsi'] = $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok']['campos_busca']['deskripsi'];
      $this->cmp_formatado['deskripsi_input_2'] = $deskripsi_input_2;

      //----- $transaksi
      $this->Date_part = false;
      if ($transaksi_cond != "bi_TP")
      {
          $transaksi_cond = strtoupper($transaksi_cond);
          $Dtxt = "";
          $val  = array();
          $Dtxt .= $transaksi_ano;
          $Dtxt .= $transaksi_mes;
          $Dtxt .= $transaksi_dia;
          $val[0]['ano'] = $transaksi_ano;
          $val[0]['mes'] = $transaksi_mes;
          $val[0]['dia'] = $transaksi_dia;
          if ($transaksi_cond == "BW")
          {
              $val[1]['ano'] = $transaksi_input_2_ano;
              $val[1]['mes'] = $transaksi_input_2_mes;
              $val[1]['dia'] = $transaksi_input_2_dia;
          }
          $this->Operador_date_part = "";
          $this->Lang_date_part     = "";
          $this->nm_prep_date($val, "DT", "DATETIME", $transaksi_cond, "", "data");
          if (!$this->Date_part) {
              $val[0] = $this->Ini->sc_Date_Protect($val[0]);
          }
          $transaksi = $val[0];
          $this->cmp_formatado['transaksi'] = $val[0];
          $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok']['campos_busca']['transaksi'] = $val[0];
          $this->nm_data->SetaData($this->cmp_formatado['transaksi'], "YYYY-MM-DD HH:II:SS");
          $this->cmp_formatado['transaksi'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DH", "dmY"));
          if ($transaksi_cond == "BW")
          {
              if (!$this->Date_part) {
                  $val[1] = $this->Ini->sc_Date_Protect($val[1]);
              }
              $transaksi_input_2     = $val[1];
              $this->cmp_formatado['transaksi_input_2'] = $val[1];
              $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok']['campos_busca']['transaksi_input_2'] = $val[1];
              $this->nm_data->SetaData($this->cmp_formatado['transaksi_input_2'], "YYYY-MM-DD HH:II:SS");
              $this->cmp_formatado['transaksi_input_2'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DH", "dmY"));
          }
          if (!empty($Dtxt) || $transaksi_cond == "NU" || $transaksi_cond == "NN"|| $transaksi_cond == "EP"|| $transaksi_cond == "NE")
          {
              $this->monta_condicao("Transaksi", $transaksi_cond, $transaksi, $transaksi_input_2, 'transaksi', 'DATETIME');
          }
      }
      ...
      if (is_array($deskripsi) && count($deskripsi) != 0)
      {
         ...
         $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok']['cond_pesq'] .= $nmgp_tab_label['deskripsi'] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
      }
   ...
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok']['cond_dyn_search'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['kartu_stok']['cond_pesq'] .= $this->NM_operador;
   ...
   function css_obj_select_ajax($Obj)
   {
      switch ($Obj)
      {
         case "deskripsi" : return ('class="scFilterObjectOdd"'); break;
         default       : return ("");
      }
   }
