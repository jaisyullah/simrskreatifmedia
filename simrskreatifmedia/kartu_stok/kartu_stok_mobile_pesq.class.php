...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "Kadaluarsa";$Nm_datas[] = "Kadaluarsa";$Nm_datas[] = "Transaksi";$Nm_datas[] = "Transaksi";$Nm_numeric[] = "masuk";$Nm_numeric[] = "keluar";$Nm_numeric[] = "kumulatif";$Nm_numeric[] = "";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_transaksi"  <?php echo $str_hide_transaksi?>>
<?php
  $Form_base = "ddmmyyyy";
  $date_format_show = "";
...
?>
          ...
          <BR>
        <SPAN id="id_vis_transaksi"  <?php echo $str_display_transaksi; ?> class="scFilterFieldFontOdd">
...
?>
   <span id="idAjaxSelect_deskripsi">
      <SELECT class="scFilterObjectEven" id="SC_deskripsi" name="deskripsi[]"  size="1" multiple>
       <OPTION value=""></OPTION>
<?php
...
<?php
   ...
   function css_obj_select_ajax($Obj)
   {
      switch ($Obj)
      {
         case "deskripsi" : return ('class="scFilterObjectEven"'); break;
         default       : return ("");
      }
   }
