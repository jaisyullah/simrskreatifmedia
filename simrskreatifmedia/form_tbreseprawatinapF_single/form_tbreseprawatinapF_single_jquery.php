...
function scEventControl_active(iSeqRow) {
  ...
  if (scEventControl_data["item" + iSeqRow]["autocomp"]) {
    return true;
  }
  if (scEventControl_data["signa" + iSeqRow]["autocomp"]) {
    return true;
  }
...
function scEventControl_onCalculator_diskon() {
  if (!_scCalculatorControl["id_sc_field_diskon"]) {
    ...
    do_ajax_form_tbreseprawatinapF_single_event_diskon_onblur();
  }
...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_id' + iSeqRow).bind('blur', function() { sc_form_tbreseprawatinapF_single_id_onblur(this, iSeqRow) })
                                .bind('focus', function() { sc_form_tbreseprawatinapF_single_id_onfocus(this, iSeqRow) });
  $('#id_sc_field_trancode' + iSeqRow).bind('blur', function() { sc_form_tbreseprawatinapF_single_trancode_onblur(this, iSeqRow) })
                                      .bind('focus', function() { sc_form_tbreseprawatinapF_single_trancode_onfocus(this, iSeqRow) });
  $('#id_sc_field_item' + iSeqRow).bind('blur', function() { sc_form_tbreseprawatinapF_single_item_onblur(this, iSeqRow) })
                                  .bind('change', function() { sc_form_tbreseprawatinapF_single_item_onchange(this, iSeqRow) })
                                  .bind('focus', function() { sc_form_tbreseprawatinapF_single_item_onfocus(this, iSeqRow) });
  $('#id_sc_field_satuan' + iSeqRow).bind('blur', function() { sc_form_tbreseprawatinapF_single_satuan_onblur(this, iSeqRow) })
                                    .bind('focus', function() { sc_form_tbreseprawatinapF_single_satuan_onfocus(this, iSeqRow) });
  $('#id_sc_field_jumlah' + iSeqRow).bind('blur', function() { sc_form_tbreseprawatinapF_single_jumlah_onblur(this, iSeqRow) })
                                    .bind('focus', function() { sc_form_tbreseprawatinapF_single_jumlah_onfocus(this, iSeqRow) });
  $('#id_sc_field_signa' + iSeqRow).bind('blur', function() { sc_form_tbreseprawatinapF_single_signa_onblur(this, iSeqRow) })
                                   .bind('focus', function() { sc_form_tbreseprawatinapF_single_signa_onfocus(this, iSeqRow) });
  $('#id_sc_field_jenisaturanpakai' + iSeqRow).bind('blur', function() { sc_form_tbreseprawatinapF_single_jenisaturanpakai_onblur(this, iSeqRow) })
                                              .bind('focus', function() { sc_form_tbreseprawatinapF_single_jenisaturanpakai_onfocus(this, iSeqRow) });
  $('#id_sc_field_biaya' + iSeqRow).bind('blur', function() { sc_form_tbreseprawatinapF_single_biaya_onblur(this, iSeqRow) })
                                   .bind('focus', function() { sc_form_tbreseprawatinapF_single_biaya_onfocus(this, iSeqRow) });
  $('#id_sc_field_strukresep' + iSeqRow).bind('blur', function() { sc_form_tbreseprawatinapF_single_strukresep_onblur(this, iSeqRow) })
                                        .bind('focus', function() { sc_form_tbreseprawatinapF_single_strukresep_onfocus(this, iSeqRow) });
  $('#id_sc_field_trandate' + iSeqRow).bind('blur', function() { sc_form_tbreseprawatinapF_single_trandate_onblur(this, iSeqRow) })
                                      .bind('focus', function() { sc_form_tbreseprawatinapF_single_trandate_onfocus(this, iSeqRow) });
  $('#id_sc_field_trandate_hora' + iSeqRow).bind('blur', function() { sc_form_tbreseprawatinapF_single_trandate_hora_onblur(this, iSeqRow) })
                                           .bind('focus', function() { sc_form_tbreseprawatinapF_single_trandate_hora_onfocus(this, iSeqRow) });
  $('#id_sc_field_diskon' + iSeqRow).bind('blur', function() { sc_form_tbreseprawatinapF_single_diskon_onblur(this, iSeqRow) })
                                    .bind('focus', function() { sc_form_tbreseprawatinapF_single_diskon_onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_form_tbreseprawatinapF_single_id_onblur(oThis, iSeqRow) {
  do_ajax_form_tbreseprawatinapF_single_validate_id();
  scCssBlur(oThis);
}

function sc_form_tbreseprawatinapF_single_id_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_tbreseprawatinapF_single_trancode_onblur(oThis, iSeqRow) {
  do_ajax_form_tbreseprawatinapF_single_validate_trancode();
  scCssBlur(oThis);
}

function sc_form_tbreseprawatinapF_single_trancode_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_tbreseprawatinapF_single_item_onblur(oThis, iSeqRow) {
  do_ajax_form_tbreseprawatinapF_single_validate_item();
  scCssBlur(oThis);
}

function sc_form_tbreseprawatinapF_single_item_onchange(oThis, iSeqRow) {
  do_ajax_form_tbreseprawatinapF_single_event_item_onchange();
}

function sc_form_tbreseprawatinapF_single_item_onfocus(oThis, iSeqRow) {
  scCssFocus(oThis);
}

function sc_form_tbreseprawatinapF_single_satuan_onblur(oThis, iSeqRow) {
  do_ajax_form_tbreseprawatinapF_single_validate_satuan();
  scCssBlur(oThis);
}

function sc_form_tbreseprawatinapF_single_satuan_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_tbreseprawatinapF_single_jumlah_onblur(oThis, iSeqRow) {
  do_ajax_form_tbreseprawatinapF_single_validate_jumlah();
  scCssBlur(oThis);
}

function sc_form_tbreseprawatinapF_single_jumlah_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_tbreseprawatinapF_single_signa_onblur(oThis, iSeqRow) {
  do_ajax_form_tbreseprawatinapF_single_validate_signa();
  scCssBlur(oThis);
}

function sc_form_tbreseprawatinapF_single_signa_onfocus(oThis, iSeqRow) {
  scCssFocus(oThis);
}

function sc_form_tbreseprawatinapF_single_jenisaturanpakai_onblur(oThis, iSeqRow) {
  do_ajax_form_tbreseprawatinapF_single_validate_jenisaturanpakai();
  scCssBlur(oThis);
}

function sc_form_tbreseprawatinapF_single_jenisaturanpakai_onfocus(oThis, iSeqRow) {
  scCssFocus(oThis);
}

function sc_form_tbreseprawatinapF_single_biaya_onblur(oThis, iSeqRow) {
  do_ajax_form_tbreseprawatinapF_single_validate_biaya();
  scCssBlur(oThis);
}

function sc_form_tbreseprawatinapF_single_biaya_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_tbreseprawatinapF_single_strukresep_onblur(oThis, iSeqRow) {
  do_ajax_form_tbreseprawatinapF_single_validate_strukresep();
  scCssBlur(oThis);
}

function sc_form_tbreseprawatinapF_single_strukresep_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_tbreseprawatinapF_single_trandate_onblur(oThis, iSeqRow) {
  do_ajax_form_tbreseprawatinapF_single_validate_trandate();
  scCssBlur(oThis);
}

function sc_form_tbreseprawatinapF_single_trandate_hora_onblur(oThis, iSeqRow) {
  do_ajax_form_tbreseprawatinapF_single_validate_trandate();
  scCssBlur(oThis);
}

function sc_form_tbreseprawatinapF_single_trandate_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_tbreseprawatinapF_single_trandate_hora_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_tbreseprawatinapF_single_diskon_onblur(oThis, iSeqRow) {
  do_ajax_form_tbreseprawatinapF_single_validate_diskon();
  scCssBlur(oThis);
}

function sc_form_tbreseprawatinapF_single_diskon_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function scHidePage(pageNo) {
	$("#id_form_tbreseprawatinapF_single_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_trandate" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_tbreseprawatinapF_single_validate_trandate(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
