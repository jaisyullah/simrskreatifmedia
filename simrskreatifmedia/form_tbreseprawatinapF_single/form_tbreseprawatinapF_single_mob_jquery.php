...
function scEventControl_onCalculator_diskon() {
  if (!_scCalculatorControl["id_sc_field_diskon"]) {
    ...
    do_ajax_form_tbreseprawatinapF_single_mob_event_diskon_onblur();
  }
...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_trandate_hora' + iSeqRow).bind('blur', function() { sc_form_tbreseprawatinapF_single_trandate_onblur(this, iSeqRow) })
                                           .bind('focus', function() { sc_form_tbreseprawatinapF_single_trandate_onfocus(this, iSeqRow) });
...
function scHidePage(pageNo) {
	$("#id_form_tbreseprawatinapF_single_mob_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_trandate" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_tbreseprawatinapF_single_mob_validate_trandate(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
