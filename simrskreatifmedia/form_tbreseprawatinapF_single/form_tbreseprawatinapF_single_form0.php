...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatinapF_single']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_tbreseprawatinapF_single/form_tbreseprawatinapF_single_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_tbreseprawatinapF_single_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_tbreseprawatinapF_single_jquery.php');
...
?>
 ...
 function addAutocomplete(elem) {
  ...
  $(".sc-ui-autocomp-item", elem).on("focus", function() {
   var sId = $(this).attr("id").substr(6);
   scEventControl_data[sId]["autocomp"] = true;
  }).on("blur", function() {
   var sId = $(this).attr("id").substr(6), sRow = "item" != sId ? sId.substr(4) : "";
   if ("" == $(this).val()) {
   ...
   width: "300px",
   ajax: {
    url: "form_tbreseprawatinapF_single.php",
    dataType: "json",
   ...
   var sId = $(this).attr("id").substr(6), sRow = "item" != sId ? sId.substr(4) : "";
   sc_form_tbreseprawatinapF_single_item_onfocus("id_sc_field_" + sId, sRow);
  ...
  $(".sc-ui-autocomp-signa", elem).on("focus", function() {
   var sId = $(this).attr("id").substr(6);
   scEventControl_data[sId]["autocomp"] = true;
  }).on("blur", function() {
   var sId = $(this).attr("id").substr(6), sRow = "signa" != sId ? sId.substr(5) : "";
   if ("" == $(this).val()) {
    $("#id_sc_field_" + sId).val("");
   }
   scEventControl_data[sId]["autocomp"] = false;
   ...
   var sId = $(this).attr("id").substr(6), sRow = "signa" != sId ? sId.substr(5) : "";
   sc_form_tbreseprawatinapF_single_signa_onfocus("id_sc_field_" + sId, sRow);
  }).on("select2:close", function(e) {
   var sId = $(this).attr("id").substr(6);
   $("#id_sc_field_" + sId).trigger("blur");
  }).on("select2:select", function(e) {
  ...
  $(".sc-ui-autocomp-jenisaturanpakai", elem).on("focus", function() {
   ...
   var sId = $(this).attr("id").substr(6), sRow = "jenisaturanpakai" != sId ? sId.substr(16) : "";
   sc_form_tbreseprawatinapF_single_jenisaturanpakai_onfocus("id_sc_field_" + sId, sRow);
  }).on("select2:close", function(e) {
   var sId = $(this).attr("id").substr(6);
   $("#id_sc_field_" + sId).trigger("blur");
  }).on("select2:select", function(e) {
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatinapF_single']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatinapF_single']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatinapF_single']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatinapF_single']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatinapF_single']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatinapF_single']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatinapF_single']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatinapF_single']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
?>
...
<?php
 include_once("form_tbreseprawatinapF_single_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatinapF_single']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatinapF_single']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_tbreseprawatinapF_single'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_tbreseprawatinapF_single'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatinapF_single']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatinapF_single']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatinapF_single']['run_iframe'] != "R")
{
?>
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatinapF_single']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatinapF_single']['run_iframe'] != "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatinapF_single']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatinapF_single']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatinapF_single']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatinapF_single']['run_iframe'] == "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatinapF_single']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatinapF_single']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatinapF_single']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatinapF_single']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatinapF_single']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatinapF_single']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatinapF_single']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatinapF_single']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatinapF_single']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatinapF_single']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<input type="hidden" name="item" value="<?php echo $this->form_encode_input($item) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormLabelOdd scUiLabelWidthFix css_item_label" id="hidden_field_label_item" style="<?php echo $sStyleHidden_item; ?>"><span id="id_label_item"><?php echo $this->nm_new_label['item']; ?></span></TD>
    <TD class="scFormDataOdd css_item_line" id="hidden_field_data_item" style="<?php echo $sStyleHidden_item; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_item_line" style="vertical-align: top;padding: 0px">
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["item"]) &&  $this->nmgp_cmp_readonly["item"] == "on") { 

 ?>
<input type="hidden" name="item" value="<?php echo $this->form_encode_input($item) . "\">" . $item . ""; ?>
<?php } else { ?>

<?php
$aRecData['item'] = $this->item;
$aLookup = array();
...
$sAutocompValue = (isset($aLookup[0][$this->item])) ? $aLookup[0][$this->item] : $this->item;
$item_look = (isset($aLookup[0][$this->item])) ? $aLookup[0][$this->item] : $this->item;
?>
<span id="id_read_on_item" class="sc-ui-readonly-item css_item_line" style="<?php echo $sStyleReadLab_item; ?>"><?php echo str_replace("<", "&lt;", $item_look); ?></span><span id="id_read_off_item" class="css_read_off_item" style="white-space: nowrap;<?php echo $sStyleReadInp_item; ?>">
 <input class="sc-js-input scFormObjectOdd css_item_obj" style="display: none;" id="id_sc_field_item" type=text name="item" value="<?php echo $this->form_encode_input($item) ?>"
 size=50 maxlength=150 style="display: none" alt="{datatype: 'text', maxLength: 150, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" >
<?php
$aRecData['item'] = $this->item;
$aLookup = array();
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
$sAutocompValue = (isset($aLookup[0][$this->item])) ? $aLookup[0][$this->item] : '';
$item_look = (isset($aLookup[0][$this->item])) ? $aLookup[0][$this->item] : '';
?>
<select id="id_ac_item" class="scFormObjectOdd sc-ui-autocomp-item css_item_obj"><?php if ('' != $this->item) { ?><option value="<?php echo $this->item ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select></span><?php } ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_satuan_line" id="hidden_field_data_satuan" style="<?php echo $sStyleHidden_satuan; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_satuan_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_jumlah_label" id="hidden_field_label_jumlah" style="<?php echo $sStyleHidden_jumlah; ?>"><span id="id_label_jumlah"><?php echo $this->nm_new_label['jumlah']; ?></span></TD>
    <TD class="scFormDataOdd css_jumlah_line" id="hidden_field_data_jumlah" style="<?php echo $sStyleHidden_jumlah; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_jumlah_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_signa_label" id="hidden_field_label_signa" style="<?php echo $sStyleHidden_signa; ?>"><span id="id_label_signa"><?php echo $this->nm_new_label['signa']; ?></span></TD>
    <TD class="scFormDataOdd css_signa_line" id="hidden_field_data_signa" style="<?php echo $sStyleHidden_signa; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_signa_line" style="vertical-align: top;padding: 0px">
...
$aLookup = array();
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
$sAutocompValue = (isset($aLookup[0][$this->signa])) ? $aLookup[0][$this->signa] : $this->signa;
$signa_look = (isset($aLookup[0][$this->signa])) ? $aLookup[0][$this->signa] : $this->signa;
?>
<span id="id_read_on_signa" class="sc-ui-readonly-signa css_signa_line" style="<?php echo $sStyleReadLab_signa; ?>"><?php echo str_replace("<", "&lt;", $signa_look); ?></span><span id="id_read_off_signa" class="css_read_off_signa" style="white-space: nowrap;<?php echo $sStyleReadInp_signa; ?>">
 <input class="sc-js-input scFormObjectOdd css_signa_obj" style="display: none;" id="id_sc_field_signa" type=text name="signa" value="<?php echo $this->form_encode_input($signa) ?>"
...
$aLookup = array();
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
$sAutocompValue = (isset($aLookup[0][$this->signa])) ? $aLookup[0][$this->signa] : '';
$signa_look = (isset($aLookup[0][$this->signa])) ? $aLookup[0][$this->signa] : '';
?>
<select id="id_ac_signa" class="scFormObjectOdd sc-ui-autocomp-signa css_signa_obj"><?php if ('' != $this->signa) { ?><option value="<?php echo $this->signa ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select></span><?php } ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_jenisaturanpakai_line" id="hidden_field_data_jenisaturanpakai" style="<?php echo $sStyleHidden_jenisaturanpakai; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_jenisaturanpakai_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_biaya_label" id="hidden_field_label_biaya" style="<?php echo $sStyleHidden_biaya; ?>"><span id="id_label_biaya"><?php echo $this->nm_new_label['biaya']; ?></span></TD>
    <TD class="scFormDataOdd css_biaya_line" id="hidden_field_data_biaya" style="<?php echo $sStyleHidden_biaya; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_biaya_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_diskon_label" id="hidden_field_label_diskon" style="<?php echo $sStyleHidden_diskon; ?>"><span id="id_label_diskon"><?php echo $this->nm_new_label['diskon']; ?></span></TD>
    <TD class="scFormDataOdd css_diskon_line" id="hidden_field_data_diskon" style="<?php echo $sStyleHidden_diskon; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_diskon_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_strukresep_label" id="hidden_field_label_strukresep" style="<?php echo $sStyleHidden_strukresep; ?>"><span id="id_label_strukresep"><?php echo $this->nm_new_label['strukresep']; ?></span></TD>
    <TD class="scFormDataOdd css_strukresep_line" id="hidden_field_data_strukresep" style="<?php echo $sStyleHidden_strukresep; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_strukresep_line" style="vertical-align: top;padding: 0px">
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatinapF_single']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatinapF_single']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatinapF_single']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatinapF_single']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatinapF_single']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatinapF_single']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatinapF_single']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatinapF_single']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatinapF_single']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatinapF_single']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatinapF_single']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_tbreseprawatinapF_single");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_tbreseprawatinapF_single");
 parent.scAjaxDetailHeight("form_tbreseprawatinapF_single", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatinapF_single']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
