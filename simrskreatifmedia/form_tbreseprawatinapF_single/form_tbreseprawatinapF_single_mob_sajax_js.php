  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbreseprawatinapF_single_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbreseprawatinapF_single_mob_form();
	}

  // ---------- Validate item
  function do_ajax_form_tbreseprawatinapF_single_mob_validate_item()
  {
    var nomeCampo_item = "item";
    var var_item = scAjaxGetFieldText(nomeCampo_item);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbreseprawatinapF_single_mob_validate_item(var_item, var_script_case_init, do_ajax_form_tbreseprawatinapF_single_mob_validate_item_cb);
  } // do_ajax_form_tbreseprawatinapF_single_mob_validate_item

  function do_ajax_form_tbreseprawatinapF_single_mob_validate_item_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbreseprawatinapF_single_mob_validate_item_cb

  // ---------- Validate satuan
  function do_ajax_form_tbreseprawatinapF_single_mob_validate_satuan()
  {
    var nomeCampo_satuan = "satuan";
    var var_satuan = scAjaxGetFieldSelect(nomeCampo_satuan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbreseprawatinapF_single_mob_validate_satuan(var_satuan, var_script_case_init, do_ajax_form_tbreseprawatinapF_single_mob_validate_satuan_cb);
  } // do_ajax_form_tbreseprawatinapF_single_mob_validate_satuan

  function do_ajax_form_tbreseprawatinapF_single_mob_validate_satuan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "satuan";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbreseprawatinapF_single_mob_validate_satuan_cb

  // ---------- Validate jumlah
  function do_ajax_form_tbreseprawatinapF_single_mob_validate_jumlah()
  {
    var nomeCampo_jumlah = "jumlah";
    var var_jumlah = scAjaxGetFieldText(nomeCampo_jumlah);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbreseprawatinapF_single_mob_validate_jumlah(var_jumlah, var_script_case_init, do_ajax_form_tbreseprawatinapF_single_mob_validate_jumlah_cb);
  } // do_ajax_form_tbreseprawatinapF_single_mob_validate_jumlah

  function do_ajax_form_tbreseprawatinapF_single_mob_validate_jumlah_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "jumlah";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbreseprawatinapF_single_mob_validate_jumlah_cb

  // ---------- Validate signa
  function do_ajax_form_tbreseprawatinapF_single_mob_validate_signa()
  {
  } // do_ajax_form_tbreseprawatinapF_single_mob_validate_signa

  function do_ajax_form_tbreseprawatinapF_single_mob_validate_signa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "signa";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbreseprawatinapF_single_mob_validate_signa_cb

  // ---------- Validate jenisaturanpakai
  function do_ajax_form_tbreseprawatinapF_single_mob_validate_jenisaturanpakai()
  {
  } // do_ajax_form_tbreseprawatinapF_single_mob_validate_jenisaturanpakai

  function do_ajax_form_tbreseprawatinapF_single_mob_validate_jenisaturanpakai_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "jenisaturanpakai";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbreseprawatinapF_single_mob_validate_jenisaturanpakai_cb

  // ---------- Validate biaya
  function do_ajax_form_tbreseprawatinapF_single_mob_validate_biaya()
  {
    var nomeCampo_biaya = "biaya";
    var var_biaya = scAjaxGetFieldText(nomeCampo_biaya);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbreseprawatinapF_single_mob_validate_biaya(var_biaya, var_script_case_init, do_ajax_form_tbreseprawatinapF_single_mob_validate_biaya_cb);
  } // do_ajax_form_tbreseprawatinapF_single_mob_validate_biaya

  function do_ajax_form_tbreseprawatinapF_single_mob_validate_biaya_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "biaya";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbreseprawatinapF_single_mob_validate_biaya_cb

  // ---------- Validate diskon
  function do_ajax_form_tbreseprawatinapF_single_mob_validate_diskon()
  {
    var nomeCampo_diskon = "diskon";
    var var_diskon = scAjaxGetFieldText(nomeCampo_diskon);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbreseprawatinapF_single_mob_validate_diskon(var_diskon, var_script_case_init, do_ajax_form_tbreseprawatinapF_single_mob_validate_diskon_cb);
  } // do_ajax_form_tbreseprawatinapF_single_mob_validate_diskon

  function do_ajax_form_tbreseprawatinapF_single_mob_validate_diskon_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "diskon";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbreseprawatinapF_single_mob_validate_diskon_cb

  // ---------- Validate trandate
  function do_ajax_form_tbreseprawatinapF_single_mob_validate_trandate()
  {
    var nomeCampo_trandate = "trandate";
    var var_trandate = scAjaxGetFieldText(nomeCampo_trandate);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbreseprawatinapF_single_mob_validate_trandate(var_trandate, var_script_case_init, do_ajax_form_tbreseprawatinapF_single_mob_validate_trandate_cb);
  } // do_ajax_form_tbreseprawatinapF_single_mob_validate_trandate

  function do_ajax_form_tbreseprawatinapF_single_mob_validate_trandate_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbreseprawatinapF_single_mob_validate_trandate_cb

  // ---------- Validate strukresep
  function do_ajax_form_tbreseprawatinapF_single_mob_validate_strukresep()
  {
    var nomeCampo_strukresep = "strukresep";
    var var_strukresep = scAjaxGetFieldText(nomeCampo_strukresep);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbreseprawatinapF_single_mob_validate_strukresep(var_strukresep, var_script_case_init, do_ajax_form_tbreseprawatinapF_single_mob_validate_strukresep_cb);
  } // do_ajax_form_tbreseprawatinapF_single_mob_validate_strukresep

  function do_ajax_form_tbreseprawatinapF_single_mob_validate_strukresep_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "strukresep";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbreseprawatinapF_single_mob_validate_strukresep_cb

  // ---------- Validate trancode
  function do_ajax_form_tbreseprawatinapF_single_mob_validate_trancode()
  {
    var nomeCampo_trancode = "trancode";
    var var_trancode = scAjaxGetFieldText(nomeCampo_trancode);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbreseprawatinapF_single_mob_validate_trancode(var_trancode, var_script_case_init, do_ajax_form_tbreseprawatinapF_single_mob_validate_trancode_cb);
  } // do_ajax_form_tbreseprawatinapF_single_mob_validate_trancode

  function do_ajax_form_tbreseprawatinapF_single_mob_validate_trancode_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbreseprawatinapF_single_mob_validate_trancode_cb

  // ---------- Validate id
  function do_ajax_form_tbreseprawatinapF_single_mob_validate_id()
  {
    var nomeCampo_id = "id";
    var var_id = scAjaxGetFieldHidden(nomeCampo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbreseprawatinapF_single_mob_validate_id(var_id, var_script_case_init, do_ajax_form_tbreseprawatinapF_single_mob_validate_id_cb);
  } // do_ajax_form_tbreseprawatinapF_single_mob_validate_id

  function do_ajax_form_tbreseprawatinapF_single_mob_validate_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbreseprawatinapF_single_mob_validate_id_cb

  // ---------- Refresh item
  function do_ajax_form_tbreseprawatinapF_single_mob_refresh_item()
  {
    var var_item = scAjaxGetFieldText("item");
    var var_nmgp_refresh_fields = "satuan";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tbreseprawatinapF_single_mob_refresh_item(var_item, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_tbreseprawatinapF_single_mob_refresh_item_cb);
  } // do_ajax_form_tbreseprawatinapF_single_mob_refresh_item

  function do_ajax_form_tbreseprawatinapF_single_mob_refresh_item_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbreseprawatinapF_single_mob_refresh_item_cb

  // ---------- Event onchange item
  function do_ajax_form_tbreseprawatinapF_single_mob_event_item_onchange()
  {
    var var_item = scAjaxGetFieldText("id_ac_item");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tbreseprawatinapF_single_mob_event_item_onchange(var_item, var_script_case_init, do_ajax_form_tbreseprawatinapF_single_mob_event_item_onchange_cb);
  } // do_ajax_form_tbreseprawatinapF_single_mob_event_item_onchange

  function do_ajax_form_tbreseprawatinapF_single_mob_event_item_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "item";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_tbreseprawatinapF_single_mob_event_item_onchange_cb_after_alert);
  } // do_ajax_form_tbreseprawatinapF_single_mob_event_item_onchange_cb
  function do_ajax_form_tbreseprawatinapF_single_mob_event_item_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    do_ajax_form_tbreseprawatinapF_single_mob_refresh_item();
    scAjaxRedir();
  } // do_ajax_form_tbreseprawatinapF_single_mob_event_item_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tbreseprawatinapF_single_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tbreseprawatinapF_single_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_item = scAjaxGetFieldText("item");
    var var_satuan = scAjaxGetFieldSelect("satuan");
    var var_jumlah = scAjaxGetFieldText("jumlah");
    var var_signa = scAjaxGetFieldText("signa");
    var var_jenisaturanpakai = scAjaxGetFieldText("jenisaturanpakai");
    var var_biaya = scAjaxGetFieldText("biaya");
    var var_diskon = scAjaxGetFieldText("diskon");
    var var_trandate = scAjaxGetFieldText("trandate");
    var var_strukresep = scAjaxGetFieldText("strukresep");
    ...
    scAjaxProcOn();
    x_ajax_form_tbreseprawatinapF_single_mob_submit_form(var_item, var_satuan, var_jumlah, var_signa, var_jenisaturanpakai, var_biaya, var_diskon, var_trandate, var_strukresep, var_trancode, var_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbreseprawatinapF_single_mob_submit_form_cb);
  } // do_ajax_form_tbreseprawatinapF_single_mob_submit_form

  function do_ajax_form_tbreseprawatinapF_single_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("item");
      scAjaxHideErrorDisplay("satuan");
      scAjaxHideErrorDisplay("jumlah");
      scAjaxHideErrorDisplay("signa");
      scAjaxHideErrorDisplay("jenisaturanpakai");
      scAjaxHideErrorDisplay("biaya");
      scAjaxHideErrorDisplay("diskon");
      scAjaxHideErrorDisplay("trandate");
      scAjaxHideErrorDisplay("strukresep");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tbreseprawatinapF_single_mob_submit_form_cb_after_alert);
  } // do_ajax_form_tbreseprawatinapF_single_mob_submit_form_cb
  function do_ajax_form_tbreseprawatinapF_single_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbreseprawatinapF_single_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tbreseprawatinapF_single_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tbreseprawatinapF_single_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbreseprawatinapF_single_mob_navigate_form_cb);
  } // do_ajax_form_tbreseprawatinapF_single_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatinapF_single_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbreseprawatinapF_single_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbreseprawatinapF_single_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_tbreseprawatinapF_single_mob_navigate_form_cb
  function do_ajax_form_tbreseprawatinapF_single_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_tbreseprawatinapF_single_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_tbreseprawatinapF_single_mob_navigate_form_cb_after_alert
  function sc_hide_form_tbreseprawatinapF_single_mob_form()
  {
  ...
  ajax_field_list[0] = "item";
  ajax_field_list[1] = "satuan";
  ajax_field_list[2] = "jumlah";
  ajax_field_list[3] = "signa";
  ajax_field_list[4] = "jenisaturanpakai";
  ajax_field_list[5] = "biaya";
  ajax_field_list[6] = "diskon";
  ajax_field_list[7] = "trandate";
  ajax_field_list[8] = "strukresep";
  ajax_field_list[9] = "trancode";
  ...
  var ajax_error_list = {
    "item": {"label": "Item", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "satuan": {"label": "Satuan", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "jumlah": {"label": "Jumlah", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "signa": {"label": "Signa", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "jenisaturanpakai": {"label": "Signa (Aturan Pakai)", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "biaya": {"label": "Biaya", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "diskon": {"label": "Diskon", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "strukresep": {"label": "Struk Resep", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  var ajax_field_mult = {
    ...
    "jumlah": new Array(),
    "signa": new Array(),
    "jenisaturanpakai": new Array(),
    "biaya": new Array(),
    "diskon": new Array(),
    "trandate": new Array(),
    "strukresep": new Array(),
    "trancode": new Array(),
    "id": new Array()
  };
  ajax_field_mult["item"][1] = "item";
  ajax_field_mult["satuan"][1] = "satuan";
  ajax_field_mult["jumlah"][1] = "jumlah";
  ajax_field_mult["signa"][1] = "signa";
  ajax_field_mult["jenisaturanpakai"][1] = "jenisaturanpakai";
  ajax_field_mult["biaya"][1] = "biaya";
  ajax_field_mult["diskon"][1] = "diskon";
  ajax_field_mult["trandate"][1] = "trandate";
  ajax_field_mult["strukresep"][1] = "strukresep";
  ajax_field_mult["trancode"][1] = "trancode";
  ajax_field_mult["id"][1] = "id";

  var ajax_field_id = {
    "item": new Array("hidden_field_label_item", "hidden_field_data_item"),
    "satuan": new Array("hidden_field_label_satuan", "hidden_field_data_satuan"),
    "jumlah": new Array("hidden_field_label_jumlah", "hidden_field_data_jumlah"),
    "signa": new Array("hidden_field_label_signa", "hidden_field_data_signa"),
    "jenisaturanpakai": new Array("hidden_field_label_jenisaturanpakai", "hidden_field_data_jenisaturanpakai"),
    "biaya": new Array("hidden_field_label_biaya", "hidden_field_data_biaya"),
    "diskon": new Array("hidden_field_label_diskon", "hidden_field_data_diskon"),
