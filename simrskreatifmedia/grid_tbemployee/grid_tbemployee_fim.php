...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_tbemployee"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_tbemployee"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_tbemployee'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tbemployee']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_tbemployee']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tbemployee']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_tbemployee']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_tbemployee']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_tbemployee']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_tbemployee']['embutida_filho'] as $ind => $sc_init)
          {
