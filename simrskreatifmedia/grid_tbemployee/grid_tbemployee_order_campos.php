...
<?php
   ...
   $Ord_Cmp = new grid_tbemployee_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_tbemployee_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbemployee']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tbemployee']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['staffcode'] = "staffCode";
   $tab_labels["staffcode"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbemployee']['labels']["staffcode"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbemployee']['labels']["staffcode"] : "Staff Code";
   $tab_ger_campos['appcode'] = "on";
   $tab_def_campos['appcode'] = "appCode";
   $tab_labels["appcode"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbemployee']['labels']["appcode"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbemployee']['labels']["appcode"] : "App Code";
   $tab_ger_campos['staffname'] = "on";
   $tab_def_campos['staffname'] = "staffName";
   $tab_labels["staffname"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbemployee']['labels']["staffname"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbemployee']['labels']["staffname"] : "Staff Name";
   $tab_ger_campos['surname'] = "on";
   $tab_def_campos['surname'] = "surName";
   $tab_labels["surname"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbemployee']['labels']["surname"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbemployee']['labels']["surname"] : "Sur Name";
   $tab_ger_campos['pob'] = "on";
   $tab_def_campos['pob'] = "poB";
   $tab_labels["pob"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbemployee']['labels']["pob"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbemployee']['labels']["pob"] : "Po B";
   $tab_ger_campos['dob'] = "on";
   $tab_def_campos['dob'] = "doB";
   $tab_labels["dob"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbemployee']['labels']["dob"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbemployee']['labels']["dob"] : "Do B";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_tbemployee']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_tbemployee']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_tbemployee']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbemployee']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tbemployee']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_tbemployee']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_tbemployee']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_tbemployee']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_tbemployee']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_tbemployee_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_tbemployee']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_tbemployee']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_tbemployee']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_tbemployee']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_tbemployee']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
