...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "doB";$Nm_datas[] = "doB";$Nm_datas[] = "lastUpdate";$Nm_datas[] = "lastUpdate";$Nm_datas[] = "enterDate";$Nm_datas[] = "enterDate";$Nm_datas[] = "resignDate";$Nm_datas[] = "resignDate";$Nm_numeric[] = "iscompleted";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_surname_cond" name="surname_cond" onChange="nm_campos_between(document.getElementById('id_vis_surname'), this, 'surname')">
      ...
      <br><span id="id_hide_surname"  <?php echo $str_hide_surname?>><?php
      if ($surname != "")
      {
      $surname_look = substr($this->Db->qstr($surname), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_staffcode_cond" name="staffcode_cond" onChange="nm_campos_between(document.getElementById('id_vis_staffcode'), this, 'staffcode')">
      ...
      <br><span id="id_hide_staffcode"  <?php echo $str_hide_staffcode?>><?php
      if ($staffcode != "")
      {
      $staffcode_look = substr($this->Db->qstr($staffcode), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_appcode_cond" name="appcode_cond" onChange="nm_campos_between(document.getElementById('id_vis_appcode'), this, 'appcode')">
      ...
      <br><span id="id_hide_appcode"  <?php echo $str_hide_appcode?>><?php
      if ($appcode != "")
      {
      $appcode_look = substr($this->Db->qstr($appcode), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_staffname_cond" name="staffname_cond" onChange="nm_campos_between(document.getElementById('id_vis_staffname'), this, 'staffname')">
      ...
      <br><span id="id_hide_staffname"  <?php echo $str_hide_staffname?>><?php
      if ($staffname != "")
      {
      $staffname_look = substr($this->Db->qstr($staffname), 1, -1); 
      $nmgp_def_dados = array(); 
