<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tbemployee']['sc_process_barr'] = true;
require_once('../grid_tbemployee/index.php');
unset($_SESSION['scriptcase']['grid_tbemployee']['sc_process_barr']);
$ExportCtrl = new grid_tbemployee_export_control;
$ExportCtrl->Export_barr();

class grid_tbemployee_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - tbemployee :: Excel</TITLE>
