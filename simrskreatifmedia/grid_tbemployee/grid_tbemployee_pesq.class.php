...
class grid_tbemployee_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbemployee']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_tbemployee_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_tbemployee_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_tbemployee_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_surname')
      {
          $surname = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_surname($surname);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_staffcode')
      {
          $staffcode = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_staffcode($staffcode);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_appcode')
      {
          $appcode = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_appcode($appcode);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_staffname')
      {
          $staffname = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_staffname($staffname);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function lookup_ajax_surname($surname)
   {
      $surname = substr($this->Db->qstr($surname), 1, -1);
            $surname_look = substr($this->Db->qstr($surname), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct surName from " . $this->Ini->nm_tabela . " where  surName like '%" . $surname . "%' order by surName"; 
      unset($cmp1,$cmp2);
   ...
   function lookup_ajax_staffcode($staffcode)
   {
      $staffcode = substr($this->Db->qstr($staffcode), 1, -1);
            $staffcode_look = substr($this->Db->qstr($staffcode), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct staffCode from " . $this->Ini->nm_tabela . " where  staffCode like '%" . $staffcode . "%' order by staffCode"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
   ...
   function lookup_ajax_appcode($appcode)
   {
      $appcode = substr($this->Db->qstr($appcode), 1, -1);
            $appcode_look = substr($this->Db->qstr($appcode), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct appCode from " . $this->Ini->nm_tabela . " where  appCode like '%" . $appcode . "%' order by appCode"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
   ...
   function lookup_ajax_staffname($staffname)
   {
      $staffname = substr($this->Db->qstr($staffname), 1, -1);
            $staffname_look = substr($this->Db->qstr($staffname), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct staffName from " . $this->Ini->nm_tabela . " where  staffName like '%" . $staffname . "%' order by staffName"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $Nm_datas[] = "doB";$Nm_datas[] = "doB";$Nm_datas[] = "lastUpdate";$Nm_datas[] = "lastUpdate";$Nm_datas[] = "enterDate";$Nm_datas[] = "enterDate";$Nm_datas[] = "resignDate";$Nm_datas[] = "resignDate";
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbemployee']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbemployee']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbemployee']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbemployee']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbemployee']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbemployee']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbemployee']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbemployee']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbemployee']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbemployee']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbemployee']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbemployee']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbemployee']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbemployee']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbemployee']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbemployee']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbemployee']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - tbemployee</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_tbemployee/grid_tbemployee_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_tbemployee_ajax_search.js"></script>
 <script type="text/javascript" src="grid_tbemployee_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_tbemployee_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_tbemployee']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_tbemployee']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_surname_cond#NMF#' + search_get_sel_txt('SC_surname_cond') + '@NMF@';
  str_out += 'SC_surname#NMF#' + search_get_text('SC_surname') + '@NMF@';
  str_out += 'id_ac_surname#NMF#' + search_get_text('id_ac_surname') + '@NMF@';
  str_out += 'SC_staffcode_cond#NMF#' + search_get_sel_txt('SC_staffcode_cond') + '@NMF@';
  str_out += 'SC_staffcode#NMF#' + search_get_text('SC_staffcode') + '@NMF@';
  str_out += 'id_ac_staffcode#NMF#' + search_get_text('id_ac_staffcode') + '@NMF@';
  str_out += 'SC_appcode_cond#NMF#' + search_get_sel_txt('SC_appcode_cond') + '@NMF@';
  str_out += 'SC_appcode#NMF#' + search_get_text('SC_appcode') + '@NMF@';
  str_out += 'id_ac_appcode#NMF#' + search_get_text('id_ac_appcode') + '@NMF@';
  str_out += 'SC_staffname_cond#NMF#' + search_get_sel_txt('SC_staffname_cond') + '@NMF@';
  str_out += 'SC_staffname#NMF#' + search_get_text('SC_staffname') + '@NMF@';
  str_out += 'id_ac_staffname#NMF#' + search_get_text('id_ac_staffname') + '@NMF@';
   ...
   $("#id_ac_staffcode").autocomplete({
     ...
     $.ajax({
       ...
       data: {
          ...
          nmgp_parms: "NM_ajax_opcao?#?autocomp_staffcode",
          max_itens: "10",
          cod_desc: "N",
     ...
     select: function (event, ui) {
       $("#SC_staffcode").val(ui.item.value);
     ...
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_staffcode").val( $(this).val() );
       }
     }
   });
   $("#id_ac_appcode").autocomplete({
     minLength: 1,
     source: function (request, response) {
     $.ajax({
       url: "index.php",
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_appcode",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_appcode").val( $(this).val() );
       }
     }
   });
   $("#id_ac_staffname").autocomplete({
     minLength: 1,
     source: function (request, response) {
     $.ajax({
       url: "index.php",
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_staffname",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_staffname").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     focus: function (event, ui) {
     ...
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_staffname").val( $(this).val() );
       }
     }
   });
   $("#id_ac_surname").autocomplete({
     minLength: 1,
     source: function (request, response) {
     $.ajax({
       url: "index.php",
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_surname",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbemployee']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div class="scFilterHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFilterHeaderFont" style="float: left; text-transform: uppercase;"><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - tbemployee</div>
...
<?php
   ...
   {
      global 
             $surname_cond, $surname, $surname_autocomp,
             $staffcode_cond, $staffcode, $staffcode_autocomp,
             $appcode_cond, $appcode, $appcode_autocomp,
             $staffname_cond, $staffname, $staffname_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbemployee']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbemployee']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbemployee']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbemployee']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $surname = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbemployee']['campos_busca']['surname']; 
          $surname_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbemployee']['campos_busca']['surname_cond']; 
          $staffcode = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbemployee']['campos_busca']['staffcode']; 
          $staffcode_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbemployee']['campos_busca']['staffcode_cond']; 
          $appcode = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbemployee']['campos_busca']['appcode']; 
          $appcode_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbemployee']['campos_busca']['appcode_cond']; 
          $staffname = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbemployee']['campos_busca']['staffname']; 
          $staffname_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbemployee']['campos_busca']['staffname_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbemployee']['campos_busca']['NM_operador']; 
      } 
      if (!isset($surname_cond) || empty($surname_cond))
      {
         $surname_cond = "qp";
      }
      if (!isset($staffcode_cond) || empty($staffcode_cond))
      {
         $staffcode_cond = "qp";
      }
      if (!isset($appcode_cond) || empty($appcode_cond))
      {
         $appcode_cond = "qp";
      }
      if (!isset($staffname_cond) || empty($staffname_cond))
      {
         $staffname_cond = "qp";
      }
      ...
      $str_hide_surname = (in_array($surname_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_staffcode = (in_array($staffcode_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_appcode = (in_array($appcode_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_staffname = (in_array($staffname_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      {
         $tmp_pos = strpos($surname, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $surname = substr($surname, 0, $tmp_pos);
         }
      }
      if (!isset($staffcode) || $staffcode == "")
      {
          $staffcode = "";
      }
      if (isset($staffcode) && !empty($staffcode))
      {
         $tmp_pos = strpos($staffcode, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $staffcode = substr($staffcode, 0, $tmp_pos);
         }
      }
      ...
      {
         $tmp_pos = strpos($appcode, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $appcode = substr($appcode, 0, $tmp_pos);
         }
      }
      ...
      if (isset($staffname) && !empty($staffname))
      {
         $tmp_pos = strpos($staffname, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $staffname = substr($staffname, 0, $tmp_pos);
         }
      }
?>
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_surname_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['surname'])) ? $this->New_label['surname'] : "Sur Name"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_surname_cond" name="surname_cond" onChange="nm_campos_between(document.getElementById('id_vis_surname'), this, 'surname')">
       <OPTION value="qp" <?php if ("qp" == $surname_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $surname_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $surname_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $surname_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_surname" <?php echo $str_hide_surname?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['surname'])) ? $this->New_label['surname'] : "Sur Name";
 $nmgp_tab_label .= "surname?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
...
<?php
      ...
      $surname_look = substr($this->Db->qstr($surname), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct surName from " . $this->Ini->nm_tabela . " where surName = '$surname_look' order by surName"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      if (isset($nmgp_def_dados[0][$surname]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$surname];
      }
      else
      {
          $sAutocompValue = $surname;
      }
?>
<INPUT  type="text" id="SC_surname" name="surname" value="<?php echo NM_encode_input($surname) ?>"  size=50 alt="{datatype: 'text', maxLength: 100, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_surname" name="surname_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 100, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_staffcode_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['staffcode'])) ? $this->New_label['staffcode'] : "Staff Code"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_staffcode_cond" name="staffcode_cond" onChange="nm_campos_between(document.getElementById('id_vis_staffcode'), this, 'staffcode')">
       <OPTION value="qp" <?php if ("qp" == $staffcode_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $staffcode_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $staffcode_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $staffcode_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_staffcode" <?php echo $str_hide_staffcode?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['staffcode'])) ? $this->New_label['staffcode'] : "Staff Code";
 $nmgp_tab_label .= "staffcode?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      $staffcode_look = substr($this->Db->qstr($staffcode), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct staffCode from " . $this->Ini->nm_tabela . " where staffCode = '$staffcode_look' order by staffCode"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      if (isset($nmgp_def_dados[0][$staffcode]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$staffcode];
      }
      else
      {
          $sAutocompValue = $staffcode;
      }
?>
<INPUT  type="text" id="SC_staffcode" name="staffcode" value="<?php echo NM_encode_input($staffcode) ?>"  size=9 alt="{datatype: 'text', maxLength: 9, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_staffcode" name="staffcode_autocomp" size="9"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 9, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_appcode_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['appcode'])) ? $this->New_label['appcode'] : "App Code"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_appcode_cond" name="appcode_cond" onChange="nm_campos_between(document.getElementById('id_vis_appcode'), this, 'appcode')">
       <OPTION value="qp" <?php if ("qp" == $appcode_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $appcode_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $appcode_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $appcode_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_appcode" <?php echo $str_hide_appcode?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['appcode'])) ? $this->New_label['appcode'] : "App Code";
 $nmgp_tab_label .= "appcode?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      $appcode_look = substr($this->Db->qstr($appcode), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct appCode from " . $this->Ini->nm_tabela . " where appCode = '$appcode_look' order by appCode"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      if (isset($nmgp_def_dados[0][$appcode]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$appcode];
      }
      else
      {
          $sAutocompValue = $appcode;
      }
?>
<INPUT  type="text" id="SC_appcode" name="appcode" value="<?php echo NM_encode_input($appcode) ?>"  size=9 alt="{datatype: 'text', maxLength: 9, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_appcode" name="appcode_autocomp" size="9"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 9, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_staffname_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['staffname'])) ? $this->New_label['staffname'] : "Staff Name"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_staffname_cond" name="staffname_cond" onChange="nm_campos_between(document.getElementById('id_vis_staffname'), this, 'staffname')">
       <OPTION value="qp" <?php if ("qp" == $staffname_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $staffname_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $staffname_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $staffname_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_staffname" <?php echo $str_hide_staffname?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['staffname'])) ? $this->New_label['staffname'] : "Staff Name";
 $nmgp_tab_label .= "staffname?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      $staffname_look = substr($this->Db->qstr($staffname), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct staffName from " . $this->Ini->nm_tabela . " where staffName = '$staffname_look' order by staffName"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      if (isset($nmgp_def_dados[0][$staffname]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$staffname];
      }
      else
      {
          $sAutocompValue = $staffname;
      }
?>
<INPUT  type="text" id="SC_staffname" name="staffname" value="<?php echo NM_encode_input($staffname) ?>"  size=50 alt="{datatype: 'text', maxLength: 100, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_staffname" name="staffname_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 100, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
?>
<?php
   if (is_file("grid_tbemployee_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_tbemployee']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_tbemployee']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbemployee']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.surname_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_surname'), document.F1.surname_cond, 'surname');
   document.F1.surname.value = "";
   document.F1.surname_autocomp.value = "";
   document.F1.staffcode_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_staffcode'), document.F1.staffcode_cond, 'staffcode');
   document.F1.staffcode.value = "";
   document.F1.staffcode_autocomp.value = "";
   document.F1.appcode_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_appcode'), document.F1.appcode_cond, 'appcode');
   document.F1.appcode.value = "";
   document.F1.appcode_autocomp.value = "";
   document.F1.staffname_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_staffname'), document.F1.staffname_cond, 'staffname');
   document.F1.staffname.value = "";
   document.F1.staffname_autocomp.value = "";
 }
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "simrskreatifmedia/grid_tbemployee";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbemployee']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbemployee']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbemployee']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_surname_cond'] = 'cond';
      $tp_fields['SC_surname'] = 'text_aut';
      $tp_fields['id_ac_surname'] = 'text_aut';
      $tp_fields['SC_staffcode_cond'] = 'cond';
      $tp_fields['SC_staffcode'] = 'text_aut';
      $tp_fields['id_ac_staffcode'] = 'text_aut';
      $tp_fields['SC_appcode_cond'] = 'cond';
      $tp_fields['SC_appcode'] = 'text_aut';
      $tp_fields['id_ac_appcode'] = 'text_aut';
      $tp_fields['SC_staffname_cond'] = 'cond';
      $tp_fields['SC_staffname'] = 'text_aut';
      $tp_fields['id_ac_staffname'] = 'text_aut';
   ...
   {
      global $surname_cond, $surname, $surname_autocomp,
             $staffcode_cond, $staffcode, $staffcode_autocomp,
             $appcode_cond, $appcode, $appcode_autocomp,
             $staffname_cond, $staffname, $staffname_autocomp, $nmgp_tab_label;

      $C_formatado = true;
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_conv_dados.php", "F", "nm_conv_limpa_dado") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
      if (!empty($surname_autocomp) && empty($surname))
      {
          $surname = $surname_autocomp;
      }
      if (!empty($staffcode_autocomp) && empty($staffcode))
      {
          $staffcode = $staffcode_autocomp;
      }
      if (!empty($appcode_autocomp) && empty($appcode))
      {
          $appcode = $appcode_autocomp;
      }
      if (!empty($staffname_autocomp) && empty($staffname))
      {
          $staffname = $staffname_autocomp;
      }
      $surname_cond_salva = $surname_cond; 
      if (!isset($surname_input_2) || $surname_input_2 == "")
      {
          $surname_input_2 = $surname;
      }
      $staffcode_cond_salva = $staffcode_cond; 
      if (!isset($staffcode_input_2) || $staffcode_input_2 == "")
      {
          $staffcode_input_2 = $staffcode;
      }
      $appcode_cond_salva = $appcode_cond; 
      if (!isset($appcode_input_2) || $appcode_input_2 == "")
      {
          $appcode_input_2 = $appcode;
      }
      $staffname_cond_salva = $staffname_cond; 
      if (!isset($staffname_input_2) || $staffname_input_2 == "")
      {
          $staffname_input_2 = $staffname;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbemployee']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbemployee']['campos_busca']['surname'] = $surname; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbemployee']['campos_busca']['surname_cond'] = $surname_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbemployee']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbemployee']['campos_busca']['staffcode'] = $staffcode; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbemployee']['campos_busca']['staffcode_cond'] = $staffcode_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbemployee']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbemployee']['campos_busca']['appcode'] = $appcode; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbemployee']['campos_busca']['appcode_cond'] = $appcode_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbemployee']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbemployee']['campos_busca']['staffname'] = $staffname; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbemployee']['campos_busca']['staffname_cond'] = $staffname_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbemployee']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbemployee']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbemployee']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['surname'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['surname'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['surname'] = $surname;
      }
      $staffcode_look = substr($this->Db->qstr($staffcode), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct staffCode from " . $this->Ini->nm_tabela . " where staffCode = '$staffcode_look' order by staffCode"; 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['staffcode'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['staffcode'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['staffcode'] = $staffcode;
      }
      $appcode_look = substr($this->Db->qstr($appcode), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct appCode from " . $this->Ini->nm_tabela . " where appCode = '$appcode_look' order by appCode"; 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['appcode'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['appcode'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['appcode'] = $appcode;
      }
      $staffname_look = substr($this->Db->qstr($staffname), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct staffName from " . $this->Ini->nm_tabela . " where staffName = '$staffname_look' order by staffName"; 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['staffname'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['staffname'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['staffname'] = $staffname;
      }

      //----- $surname
      $this->Date_part = false;
      if (isset($surname) || $surname_cond == "nu" || $surname_cond == "nn" || $surname_cond == "ep" || $surname_cond == "ne")
      {
         $this->monta_condicao("surName", $surname_cond, $surname, "", "surname");
      }

      //----- $staffcode
      $this->Date_part = false;
      if (isset($staffcode) || $staffcode_cond == "nu" || $staffcode_cond == "nn" || $staffcode_cond == "ep" || $staffcode_cond == "ne")
      {
         $this->monta_condicao("staffCode", $staffcode_cond, $staffcode, "", "staffcode");
      }

      //----- $appcode
      $this->Date_part = false;
      if (isset($appcode) || $appcode_cond == "nu" || $appcode_cond == "nn" || $appcode_cond == "ep" || $appcode_cond == "ne")
      {
         $this->monta_condicao("appCode", $appcode_cond, $appcode, "", "appcode");
      }

      //----- $staffname
      $this->Date_part = false;
      if (isset($staffname) || $staffname_cond == "nu" || $staffname_cond == "nn" || $staffname_cond == "ep" || $staffname_cond == "ne")
      {
         $this->monta_condicao("staffName", $staffname_cond, $staffname, "", "staffname");
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbemployee']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbemployee']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbemployee']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbemployee']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbemployee']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbemployee']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbemployee']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbemployee']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbemployee']['cond_pesq'] .= $this->NM_operador;
