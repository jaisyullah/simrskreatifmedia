<?php
@session_start() ;
$_SESSION['scriptcase']['grid_select_igd']['sc_process_barr'] = true;
require_once('../grid_select_igd/index.php');
unset($_SESSION['scriptcase']['grid_select_igd']['sc_process_barr']);
$ExportCtrl = new grid_select_igd_export_control;
$ExportCtrl->Export_barr();

class grid_select_igd_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - tbantrian :: Excel</TITLE>
