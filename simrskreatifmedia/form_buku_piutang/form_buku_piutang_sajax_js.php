  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_buku_piutang" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_buku_piutang_form();
	}

  // ---------- Validate id
  function do_ajax_form_buku_piutang_validate_id()
  {
    var nomeCampo_id = "id";
    var var_id = scAjaxGetFieldHidden(nomeCampo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_buku_piutang_validate_id(var_id, var_script_case_init, do_ajax_form_buku_piutang_validate_id_cb);
  } // do_ajax_form_buku_piutang_validate_id

  function do_ajax_form_buku_piutang_validate_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_buku_piutang_validate_id_cb

  // ---------- Validate id_transaksi
  function do_ajax_form_buku_piutang_validate_id_transaksi()
  {
    var nomeCampo_id_transaksi = "id_transaksi";
    var var_id_transaksi = scAjaxGetFieldText(nomeCampo_id_transaksi);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_buku_piutang_validate_id_transaksi(var_id_transaksi, var_script_case_init, do_ajax_form_buku_piutang_validate_id_transaksi_cb);
  } // do_ajax_form_buku_piutang_validate_id_transaksi

  function do_ajax_form_buku_piutang_validate_id_transaksi_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_buku_piutang_validate_id_transaksi_cb

  // ---------- Validate no_referensi
  function do_ajax_form_buku_piutang_validate_no_referensi()
  {
    var nomeCampo_no_referensi = "no_referensi";
    var var_no_referensi = scAjaxGetFieldText(nomeCampo_no_referensi);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_buku_piutang_validate_no_referensi(var_no_referensi, var_script_case_init, do_ajax_form_buku_piutang_validate_no_referensi_cb);
  } // do_ajax_form_buku_piutang_validate_no_referensi

  function do_ajax_form_buku_piutang_validate_no_referensi_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_buku_piutang_validate_no_referensi_cb

  // ---------- Validate tanggal
  function do_ajax_form_buku_piutang_validate_tanggal()
  {
    var nomeCampo_tanggal = "tanggal";
    var var_tanggal = scAjaxGetFieldText(nomeCampo_tanggal);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_buku_piutang_validate_tanggal(var_tanggal, var_script_case_init, do_ajax_form_buku_piutang_validate_tanggal_cb);
  } // do_ajax_form_buku_piutang_validate_tanggal

  function do_ajax_form_buku_piutang_validate_tanggal_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tanggal";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_buku_piutang_validate_tanggal_cb

  // ---------- Validate keterangan
  function do_ajax_form_buku_piutang_validate_keterangan()
  {
    var nomeCampo_keterangan = "keterangan";
    var var_keterangan = scAjaxGetFieldText(nomeCampo_keterangan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_buku_piutang_validate_keterangan(var_keterangan, var_script_case_init, do_ajax_form_buku_piutang_validate_keterangan_cb);
  } // do_ajax_form_buku_piutang_validate_keterangan

  function do_ajax_form_buku_piutang_validate_keterangan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_buku_piutang_validate_keterangan_cb

  // ---------- Validate nilai_transaksi
  function do_ajax_form_buku_piutang_validate_nilai_transaksi()
  {
    var nomeCampo_nilai_transaksi = "nilai_transaksi";
    var var_nilai_transaksi = scAjaxGetFieldText(nomeCampo_nilai_transaksi);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_buku_piutang_validate_nilai_transaksi(var_nilai_transaksi, var_script_case_init, do_ajax_form_buku_piutang_validate_nilai_transaksi_cb);
  } // do_ajax_form_buku_piutang_validate_nilai_transaksi

  function do_ajax_form_buku_piutang_validate_nilai_transaksi_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_buku_piutang_validate_nilai_transaksi_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_buku_piutang_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_buku_piutang_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_buku_piutang_submit_form(var_id, var_id_transaksi, var_no_referensi, var_tanggal, var_keterangan, var_nilai_transaksi, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_buku_piutang_submit_form_cb);
  } // do_ajax_form_buku_piutang_submit_form

  function do_ajax_form_buku_piutang_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_buku_piutang_submit_form_cb_after_alert);
  } // do_ajax_form_buku_piutang_submit_form_cb
  function do_ajax_form_buku_piutang_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_buku_piutang_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_buku_piutang_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_buku_piutang_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_buku_piutang_navigate_form_cb);
  } // do_ajax_form_buku_piutang_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_buku_piutang']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_buku_piutang_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_buku_piutang_navigate_form_cb_after_alert);
  } // do_ajax_form_buku_piutang_navigate_form_cb
  function do_ajax_form_buku_piutang_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_buku_piutang_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_buku_piutang_navigate_form_cb_after_alert
  function sc_hide_form_buku_piutang_form()
  {
