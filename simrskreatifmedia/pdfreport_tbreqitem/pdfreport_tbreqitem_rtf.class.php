...
class pdfreport_tbreqitem_rtf
{
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "pdfreport_tbreqitem.rtf";
   }
   //---- 
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      $nm_raiz_img  = ""; 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_tbreqitem']['rtf_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_tbreqitem']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_tbreqitem']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_tbreqitem']['rtf_name']);
      }
   ...
   function NM_export_subsel_permintaan()
   {
         ...
         $this->subsel_permintaan = str_replace('<', '&lt;', $this->subsel_permintaan);
         $this->subsel_permintaan = str_replace('>', '&gt;', $this->subsel_permintaan);
         $this->Texto_tag .= "<td>" . $this->subsel_permintaan . "</td>\r\n";
   }
   //----- subsel_realisasi
   function NM_export_subsel_realisasi()
   {
         ...
         $this->subsel_realisasi = str_replace('<', '&lt;', $this->subsel_realisasi);
         $this->subsel_realisasi = str_replace('>', '&gt;', $this->subsel_realisasi);
         $this->Texto_tag .= "<td>" . $this->subsel_realisasi . "</td>\r\n";
   }
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_tbreqitem']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_tbreqitem']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_chart_title'] ?> tbreqitem :: RTF</TITLE>
