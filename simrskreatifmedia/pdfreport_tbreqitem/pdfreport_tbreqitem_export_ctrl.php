<?php
@session_start() ;
$_SESSION['scriptcase']['pdfreport_tbreqitem']['sc_process_barr'] = true;
require_once('../pdfreport_tbreqitem/index.php');
unset($_SESSION['scriptcase']['pdfreport_tbreqitem']['sc_process_barr']);
$ExportCtrl = new pdfreport_tbreqitem_export_control;
$ExportCtrl->Export_barr();

class pdfreport_tbreqitem_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_chart_title'] ?> tbreqitem :: Excel</TITLE>
