...
<?php
   ...
   $Ord_Cmp = new grid_hrm_karyawan_tetap_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_hrm_karyawan_tetap_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_hrm_karyawan_tetap']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_hrm_karyawan_tetap']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_hrm_karyawan_tetap']['labels']["id"])) ? $_SESSION['sc_session'][$sc_init]['grid_hrm_karyawan_tetap']['labels']["id"] : "Id";
   $tab_ger_campos['id_karyawan'] = "on";
   $tab_def_campos['id_karyawan'] = "id_karyawan";
   $tab_labels["id_karyawan"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_hrm_karyawan_tetap']['labels']["id_karyawan"])) ? $_SESSION['sc_session'][$sc_init]['grid_hrm_karyawan_tetap']['labels']["id_karyawan"] : "Karyawan";
   $tab_ger_campos['no_skep'] = "on";
   $tab_def_campos['no_skep'] = "no_skep";
   $tab_labels["no_skep"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_hrm_karyawan_tetap']['labels']["no_skep"])) ? $_SESSION['sc_session'][$sc_init]['grid_hrm_karyawan_tetap']['labels']["no_skep"] : "No Skep";
   $tab_ger_campos['tanggal_skep'] = "on";
   $tab_def_campos['tanggal_skep'] = "tanggal_skep";
   $tab_labels["tanggal_skep"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_hrm_karyawan_tetap']['labels']["tanggal_skep"])) ? $_SESSION['sc_session'][$sc_init]['grid_hrm_karyawan_tetap']['labels']["tanggal_skep"] : "Tanggal Skep";
   $tab_ger_campos['keterangan'] = "on";
   $tab_def_campos['keterangan'] = "keterangan";
   $tab_labels["keterangan"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_hrm_karyawan_tetap']['labels']["keterangan"])) ? $_SESSION['sc_session'][$sc_init]['grid_hrm_karyawan_tetap']['labels']["keterangan"] : "Keterangan";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_hrm_karyawan_tetap']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_hrm_karyawan_tetap']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_hrm_karyawan_tetap']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_hrm_karyawan_tetap']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_hrm_karyawan_tetap']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_hrm_karyawan_tetap']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_hrm_karyawan_tetap']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_hrm_karyawan_tetap']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_hrm_karyawan_tetap']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_hrm_karyawan_tetap_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_hrm_karyawan_tetap']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_hrm_karyawan_tetap']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_hrm_karyawan_tetap']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_hrm_karyawan_tetap']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_hrm_karyawan_tetap']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
