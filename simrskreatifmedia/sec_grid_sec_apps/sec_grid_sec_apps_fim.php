...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____sec_grid_sec_apps"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____sec_grid_sec_apps"]);
   }
