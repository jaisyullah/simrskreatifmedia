...
<?php
   ...
   $Ord_Cmp = new grid_hrm_potongan_tetap_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_hrm_potongan_tetap_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_hrm_potongan_tetap']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_hrm_potongan_tetap']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_hrm_potongan_tetap']['labels']["id"])) ? $_SESSION['sc_session'][$sc_init]['grid_hrm_potongan_tetap']['labels']["id"] : "Id";
   $tab_ger_campos['id_karyawan'] = "on";
   $tab_def_campos['id_karyawan'] = "id_karyawan";
   $tab_labels["id_karyawan"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_hrm_potongan_tetap']['labels']["id_karyawan"])) ? $_SESSION['sc_session'][$sc_init]['grid_hrm_potongan_tetap']['labels']["id_karyawan"] : "Karyawan";
   $tab_ger_campos['pph_21'] = "on";
   $tab_def_campos['pph_21'] = "pph_21";
   $tab_labels["pph_21"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_hrm_potongan_tetap']['labels']["pph_21"])) ? $_SESSION['sc_session'][$sc_init]['grid_hrm_potongan_tetap']['labels']["pph_21"] : "Pph 21";
   $tab_ger_campos['bpjs_tenaga_kerja'] = "on";
   $tab_def_campos['bpjs_tenaga_kerja'] = "bpjs_tenaga_kerja";
   $tab_labels["bpjs_tenaga_kerja"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_hrm_potongan_tetap']['labels']["bpjs_tenaga_kerja"])) ? $_SESSION['sc_session'][$sc_init]['grid_hrm_potongan_tetap']['labels']["bpjs_tenaga_kerja"] : "Bpjs Tenaga Kerja";
   $tab_ger_campos['periode_remunerasi'] = "on";
   $tab_def_campos['periode_remunerasi'] = "periode_remunerasi";
   $tab_labels["periode_remunerasi"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_hrm_potongan_tetap']['labels']["periode_remunerasi"])) ? $_SESSION['sc_session'][$sc_init]['grid_hrm_potongan_tetap']['labels']["periode_remunerasi"] : "Periode Remunerasi";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_hrm_potongan_tetap']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_hrm_potongan_tetap']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_hrm_potongan_tetap']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_hrm_potongan_tetap']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_hrm_potongan_tetap']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_hrm_potongan_tetap']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_hrm_potongan_tetap']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_hrm_potongan_tetap']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_hrm_potongan_tetap']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_hrm_potongan_tetap_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_hrm_potongan_tetap']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_hrm_potongan_tetap']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_hrm_potongan_tetap']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_hrm_potongan_tetap']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_hrm_potongan_tetap']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
