...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_hrm_potongan_tetap"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_hrm_potongan_tetap"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_hrm_potongan_tetap'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_hrm_potongan_tetap']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_hrm_potongan_tetap']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_hrm_potongan_tetap']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_hrm_potongan_tetap']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_hrm_potongan_tetap']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_hrm_potongan_tetap</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_hrm_potongan_tetap']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_hrm_potongan_tetap']['embutida_filho'] as $ind => $sc_init)
          {
