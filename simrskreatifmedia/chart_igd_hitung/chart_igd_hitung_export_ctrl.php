<?php
@session_start() ;
$_SESSION['scriptcase']['chart_igd_hitung']['sc_process_barr'] = true;
require_once('../chart_igd_hitung/index.php');
unset($_SESSION['scriptcase']['chart_igd_hitung']['sc_process_barr']);
$ExportCtrl = new chart_igd_hitung_export_control;
$ExportCtrl->Export_barr();

class chart_igd_hitung_export_control
{
