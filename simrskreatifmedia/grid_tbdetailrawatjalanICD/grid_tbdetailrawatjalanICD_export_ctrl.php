<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tbdetailrawatjalanICD']['sc_process_barr'] = true;
require_once('../grid_tbdetailrawatjalanICD/index.php');
unset($_SESSION['scriptcase']['grid_tbdetailrawatjalanICD']['sc_process_barr']);
$ExportCtrl = new grid_tbdetailrawatjalanICD_export_control;
$ExportCtrl->Export_barr();

class grid_tbdetailrawatjalanICD_export_control
{
