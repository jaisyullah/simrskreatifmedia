...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_tbdetailrawatjalanICD"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_tbdetailrawatjalanICD"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tbdetailrawatjalanICD']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_tbdetailrawatjalanICD']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tbdetailrawatjalanICD']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_tbdetailrawatjalanICD']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_tbdetailrawatjalanICD']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_tbdetailrawatjalanICD</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_tbdetailrawatjalanICD']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_tbdetailrawatjalanICD']['embutida_filho'] as $ind => $sc_init)
          {
