<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tbhasilrad']['sc_process_barr'] = true;
require_once('../grid_tbhasilrad/index.php');
unset($_SESSION['scriptcase']['grid_tbhasilrad']['sc_process_barr']);
$ExportCtrl = new grid_tbhasilrad_export_control;
$ExportCtrl->Export_barr();

class grid_tbhasilrad_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_title'] ?> Hasil Radiologi :: Excel</TITLE>
