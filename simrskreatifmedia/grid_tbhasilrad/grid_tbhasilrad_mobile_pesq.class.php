...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_hasil"  <?php echo $str_hide_hasil?>><?php
      if ($hasil != "")
      {
      $hasil_look = substr($this->Db->qstr($hasil), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_radcode"  <?php echo $str_hide_radcode?>><?php
      if ($radcode != "")
      {
      $radcode_look = substr($this->Db->qstr($radcode), 1, -1); 
      $nmgp_def_dados = array(); 
