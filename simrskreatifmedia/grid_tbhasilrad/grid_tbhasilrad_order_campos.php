...
<?php
   ...
   $Ord_Cmp = new grid_tbhasilrad_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_tbhasilrad_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbhasilrad']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tbhasilrad']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["trancode"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbhasilrad']['labels']["trancode"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbhasilrad']['labels']["trancode"] : "Kode Transaksi";
   ...
   {
       $tab_def_campos['sc_field_1'] = "SELECT custcode 
FROM tbtranrad 
WHERE trancode = '{trancode}' 
ORDER BY custcode";
   }
   $tab_labels["sc_field_1"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbhasilrad']['labels']["sc_field_1"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbhasilrad']['labels']["sc_field_1"] : "No RM";
...
ORDER BY name, salut";
   ...
   $tab_labels["sc_field_0"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbhasilrad']['labels']["sc_field_0"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbhasilrad']['labels']["sc_field_0"] : "Nama Pasien";
   $tab_ger_campos['radcode'] = "on";
   $tab_def_campos['radcode'] = "radcode";
   $tab_labels["radcode"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbhasilrad']['labels']["radcode"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbhasilrad']['labels']["radcode"] : "Petugas";
   ...
   {
       $tab_def_campos['pemeriksaan'] = "SELECT a.nama 
FROM tbradiologi a left join tbdetailrad b on b.radcode = a.radcode
WHERE b.trancode = '{trancode}' 
ORDER BY nama";
   }
   $tab_labels["pemeriksaan"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbhasilrad']['labels']["pemeriksaan"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbhasilrad']['labels']["pemeriksaan"] : "Pemeriksaan";
   $tab_ger_campos['whatsapp'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['whatsapp'] = "Whatsapp";
   }
   else
   {
       $tab_def_campos['whatsapp'] = "";
   }
   $tab_labels["whatsapp"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbhasilrad']['labels']["whatsapp"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbhasilrad']['labels']["whatsapp"] : "Whatsapp";
   $tab_ger_campos['sc_field_1'] = "none";
   $tab_ger_campos['sc_field_0'] = "none";
   $tab_ger_campos['pemeriksaan'] = "none";
   $tab_ger_campos['whatsapp'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_tbhasilrad']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_tbhasilrad']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_tbhasilrad']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbhasilrad']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tbhasilrad']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_tbhasilrad']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_tbhasilrad']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_tbhasilrad']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_tbhasilrad']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_tbhasilrad_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_tbhasilrad']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_tbhasilrad']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_tbhasilrad']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_tbhasilrad']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_tbhasilrad']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
