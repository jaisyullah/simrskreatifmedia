<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tagihan_resep_rj']['sc_process_barr'] = true;
require_once('../grid_tagihan_resep_rj/index.php');
unset($_SESSION['scriptcase']['grid_tagihan_resep_rj']['sc_process_barr']);
$ExportCtrl = new grid_tagihan_resep_rj_export_control;
$ExportCtrl->Export_barr();

class grid_tagihan_resep_rj_export_control
{
