...
<?php
   ...
   $Ord_Cmp = new grid_tagihan_resep_rj_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_tagihan_resep_rj_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tagihan_resep_rj']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tagihan_resep_rj']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["trancode"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tagihan_resep_rj']['labels']["trancode"])) ? $_SESSION['sc_session'][$sc_init]['grid_tagihan_resep_rj']['labels']["trancode"] : "Kode Transaksi";
   $tab_ger_campos['custcode'] = "on";
   $tab_def_campos['custcode'] = "custCode";
   $tab_labels["custcode"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tagihan_resep_rj']['labels']["custcode"])) ? $_SESSION['sc_session'][$sc_init]['grid_tagihan_resep_rj']['labels']["custcode"] : "Nama Pasien";
   $tab_ger_campos['dokter'] = "on";
   $tab_def_campos['dokter'] = "dokter";
   $tab_labels["dokter"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tagihan_resep_rj']['labels']["dokter"])) ? $_SESSION['sc_session'][$sc_init]['grid_tagihan_resep_rj']['labels']["dokter"] : "Dokter";
   $tab_ger_campos['selesai'] = "on";
   $tab_def_campos['selesai'] = "selesai";
   $tab_labels["selesai"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tagihan_resep_rj']['labels']["selesai"])) ? $_SESSION['sc_session'][$sc_init]['grid_tagihan_resep_rj']['labels']["selesai"] : "Selesai";
   $tab_ger_campos['tglkeluar'] = "on";
   $tab_def_campos['tglkeluar'] = "tglKeluar";
   $tab_labels["tglkeluar"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tagihan_resep_rj']['labels']["tglkeluar"])) ? $_SESSION['sc_session'][$sc_init]['grid_tagihan_resep_rj']['labels']["tglkeluar"] : "Tgl Keluar";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_tagihan_resep_rj']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_tagihan_resep_rj']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_tagihan_resep_rj']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tagihan_resep_rj']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tagihan_resep_rj']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_tagihan_resep_rj']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_tagihan_resep_rj']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_tagihan_resep_rj']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_tagihan_resep_rj']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_tagihan_resep_rj_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_tagihan_resep_rj']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_tagihan_resep_rj']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_tagihan_resep_rj']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_tagihan_resep_rj']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_tagihan_resep_rj']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
