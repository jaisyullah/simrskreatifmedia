...
class grid_tbtemplatesoap_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtemplatesoap']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_tbtemplatesoap_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_tbtemplatesoap_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_tbtemplatesoap_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_object')
      {
          $object = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_object($object);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_namasoap')
      {
          $namasoap = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_namasoap($namasoap);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_subject')
      {
          $subject = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_subject($subject);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function lookup_ajax_object($object)
   {
      $object = substr($this->Db->qstr($object), 1, -1);
            $object_look = substr($this->Db->qstr($object), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct object from " . $this->Ini->nm_tabela . " where  object like '%" . $object . "%' order by object"; 
      unset($cmp1,$cmp2);
   ...
   function lookup_ajax_namasoap($namasoap)
   {
      $namasoap = substr($this->Db->qstr($namasoap), 1, -1);
            $namasoap_look = substr($this->Db->qstr($namasoap), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct namaSOAP from " . $this->Ini->nm_tabela . " where  namaSOAP like '%" . $namasoap . "%' order by namaSOAP"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
   ...
   function lookup_ajax_subject($subject)
   {
      $subject = substr($this->Db->qstr($subject), 1, -1);
            $subject_look = substr($this->Db->qstr($subject), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct subject from " . $this->Ini->nm_tabela . " where  subject like '%" . $subject . "%' order by subject"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtemplatesoap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtemplatesoap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtemplatesoap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtemplatesoap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtemplatesoap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtemplatesoap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtemplatesoap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtemplatesoap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtemplatesoap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtemplatesoap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtemplatesoap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtemplatesoap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtemplatesoap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtemplatesoap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtemplatesoap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - tbtemplatesoap</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_tbtemplatesoap/grid_tbtemplatesoap_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_tbtemplatesoap_ajax_search.js"></script>
 <script type="text/javascript" src="grid_tbtemplatesoap_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_tbtemplatesoap_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_tbtemplatesoap']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_tbtemplatesoap']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_object_cond#NMF#' + search_get_sel_txt('SC_object_cond') + '@NMF@';
  str_out += 'SC_object#NMF#' + search_get_text('SC_object') + '@NMF@';
  str_out += 'id_ac_object#NMF#' + search_get_text('id_ac_object') + '@NMF@';
  ...
  str_out += 'SC_namasoap_cond#NMF#' + search_get_sel_txt('SC_namasoap_cond') + '@NMF@';
  str_out += 'SC_namasoap#NMF#' + search_get_text('SC_namasoap') + '@NMF@';
  str_out += 'id_ac_namasoap#NMF#' + search_get_text('id_ac_namasoap') + '@NMF@';
  str_out += 'SC_subject_cond#NMF#' + search_get_sel_txt('SC_subject_cond') + '@NMF@';
  str_out += 'SC_subject#NMF#' + search_get_text('SC_subject') + '@NMF@';
  str_out += 'id_ac_subject#NMF#' + search_get_text('id_ac_subject') + '@NMF@';
   ...
   $("#id_ac_namasoap").autocomplete({
     ...
     $.ajax({
       ...
       data: {
          ...
          nmgp_parms: "NM_ajax_opcao?#?autocomp_namasoap",
          max_itens: "10",
          cod_desc: "N",
     ...
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_namasoap").val( $(this).val() );
       }
     }
   });
   $("#id_ac_subject").autocomplete({
     minLength: 1,
     source: function (request, response) {
     $.ajax({
       url: "index.php",
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_subject",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_subject").val( $(this).val() );
       }
     }
   });
   $("#id_ac_object").autocomplete({
     minLength: 1,
     source: function (request, response) {
     $.ajax({
       url: "index.php",
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_object",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtemplatesoap']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div class="scFilterHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFilterHeaderFont" style="float: left; text-transform: uppercase;"><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - tbtemplatesoap</div>
...
<?php
   ...
   {
      global 
             $object_cond, $object, $object_autocomp,
             $id_cond, $id, $id_autocomp,
             $namasoap_cond, $namasoap, $namasoap_autocomp,
             $subject_cond, $subject, $subject_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtemplatesoap']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtemplatesoap']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtemplatesoap']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtemplatesoap']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $object = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtemplatesoap']['campos_busca']['object']; 
          $object_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtemplatesoap']['campos_busca']['object_cond']; 
          $id = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtemplatesoap']['campos_busca']['id']; 
          $id_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtemplatesoap']['campos_busca']['id_cond']; 
          $namasoap = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtemplatesoap']['campos_busca']['namasoap']; 
          $namasoap_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtemplatesoap']['campos_busca']['namasoap_cond']; 
          $subject = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtemplatesoap']['campos_busca']['subject']; 
          $subject_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtemplatesoap']['campos_busca']['subject_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtemplatesoap']['campos_busca']['NM_operador']; 
      } 
      if (!isset($object_cond) || empty($object_cond))
      {
         $object_cond = "qp";
      }
      ...
      if (!isset($namasoap_cond) || empty($namasoap_cond))
      {
         $namasoap_cond = "qp";
      }
      if (!isset($subject_cond) || empty($subject_cond))
      {
         $subject_cond = "qp";
      }
      ...
      $str_hide_object = (in_array($object_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_id = (in_array($id_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_namasoap = (in_array($namasoap_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_subject = (in_array($subject_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      {
         $tmp_pos = strpos($object, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $object = substr($object, 0, $tmp_pos);
         }
      }
      if (!isset($id) || $id == "")
      {
      ...
      if (!isset($namasoap) || $namasoap == "")
      {
          $namasoap = "";
      }
      if (isset($namasoap) && !empty($namasoap))
      {
         $tmp_pos = strpos($namasoap, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $namasoap = substr($namasoap, 0, $tmp_pos);
         }
      }
      ...
      {
         $tmp_pos = strpos($subject, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $subject = substr($subject, 0, $tmp_pos);
         }
      }
?>
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_object_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['object'])) ? $this->New_label['object'] : "Object"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_object_cond" name="object_cond" onChange="nm_campos_between(document.getElementById('id_vis_object'), this, 'object')">
       <OPTION value="qp" <?php if ("qp" == $object_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $object_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $object_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $object_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_object" <?php echo $str_hide_object?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['object'])) ? $this->New_label['object'] : "Object";
 $nmgp_tab_label .= "object?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
...
<?php
      ...
      $object_look = substr($this->Db->qstr($object), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct object from " . $this->Ini->nm_tabela . " where object = '$object_look' order by object"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      if (isset($nmgp_def_dados[0][$object]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$object];
      }
      else
      {
          $sAutocompValue = $object;
      }
?>
<INPUT  type="text" id="SC_object" name="object" value="<?php echo NM_encode_input($object) ?>"  size=50 alt="{datatype: 'text', maxLength: 255, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_object" name="object_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 255, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_id" name="id_autocomp" size="5"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 5, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
      ...
      <TD id='SC_namasoap_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['namasoap'])) ? $this->New_label['namasoap'] : "Nama SOAP"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_namasoap_cond" name="namasoap_cond" onChange="nm_campos_between(document.getElementById('id_vis_namasoap'), this, 'namasoap')">
       <OPTION value="qp" <?php if ("qp" == $namasoap_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $namasoap_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $namasoap_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $namasoap_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_namasoap" <?php echo $str_hide_namasoap?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['namasoap'])) ? $this->New_label['namasoap'] : "Nama SOAP";
 $nmgp_tab_label .= "namasoap?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      $namasoap_look = substr($this->Db->qstr($namasoap), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct namaSOAP from " . $this->Ini->nm_tabela . " where namaSOAP = '$namasoap_look' order by namaSOAP"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      if (isset($nmgp_def_dados[0][$namasoap]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$namasoap];
      }
      else
      {
          $sAutocompValue = $namasoap;
      }
?>
<INPUT  type="text" id="SC_namasoap" name="namasoap" value="<?php echo NM_encode_input($namasoap) ?>"  size=30 alt="{datatype: 'text', maxLength: 30, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_namasoap" name="namasoap_autocomp" size="30"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 30, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_subject_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['subject'])) ? $this->New_label['subject'] : "Subject"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_subject_cond" name="subject_cond" onChange="nm_campos_between(document.getElementById('id_vis_subject'), this, 'subject')">
       <OPTION value="qp" <?php if ("qp" == $subject_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $subject_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $subject_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $subject_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_subject" <?php echo $str_hide_subject?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['subject'])) ? $this->New_label['subject'] : "Subject";
 $nmgp_tab_label .= "subject?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      $subject_look = substr($this->Db->qstr($subject), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct subject from " . $this->Ini->nm_tabela . " where subject = '$subject_look' order by subject"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      if (isset($nmgp_def_dados[0][$subject]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$subject];
      }
      else
      {
          $sAutocompValue = $subject;
      }
?>
<INPUT  type="text" id="SC_subject" name="subject" value="<?php echo NM_encode_input($subject) ?>"  size=50 alt="{datatype: 'text', maxLength: 255, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_subject" name="subject_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 255, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
?>
<?php
   if (is_file("grid_tbtemplatesoap_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_tbtemplatesoap']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_tbtemplatesoap']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtemplatesoap']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.object_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_object'), document.F1.object_cond, 'object');
   document.F1.object.value = "";
   document.F1.object_autocomp.value = "";
   ...
   document.F1.namasoap_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_namasoap'), document.F1.namasoap_cond, 'namasoap');
   document.F1.namasoap.value = "";
   document.F1.namasoap_autocomp.value = "";
   document.F1.subject_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_subject'), document.F1.subject_cond, 'subject');
   document.F1.subject.value = "";
   document.F1.subject_autocomp.value = "";
 }
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "simrskreatifmedia/grid_tbtemplatesoap";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtemplatesoap']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtemplatesoap']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtemplatesoap']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_object_cond'] = 'cond';
      $tp_fields['SC_object'] = 'text_aut';
      $tp_fields['id_ac_object'] = 'text_aut';
      $tp_fields['SC_id_cond'] = 'cond';
      $tp_fields['SC_id'] = 'text_aut';
      $tp_fields['id_ac_id'] = 'text_aut';
      $tp_fields['SC_namasoap_cond'] = 'cond';
      $tp_fields['SC_namasoap'] = 'text_aut';
      $tp_fields['id_ac_namasoap'] = 'text_aut';
      $tp_fields['SC_subject_cond'] = 'cond';
      $tp_fields['SC_subject'] = 'text_aut';
      $tp_fields['id_ac_subject'] = 'text_aut';
   ...
   {
      global $object_cond, $object, $object_autocomp,
             $id_cond, $id, $id_autocomp,
             $namasoap_cond, $namasoap, $namasoap_autocomp,
             $subject_cond, $subject, $subject_autocomp, $nmgp_tab_label;

      $C_formatado = true;
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_conv_dados.php", "F", "nm_conv_limpa_dado") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
      if (!empty($object_autocomp) && empty($object))
      {
          $object = $object_autocomp;
      }
      if (!empty($id_autocomp) && empty($id))
      {
          $id = $id_autocomp;
      }
      if (!empty($namasoap_autocomp) && empty($namasoap))
      {
          $namasoap = $namasoap_autocomp;
      }
      if (!empty($subject_autocomp) && empty($subject))
      {
          $subject = $subject_autocomp;
      }
      $object_cond_salva = $object_cond; 
      if (!isset($object_input_2) || $object_input_2 == "")
      {
          $object_input_2 = $object;
      }
      ...
      $namasoap_cond_salva = $namasoap_cond; 
      if (!isset($namasoap_input_2) || $namasoap_input_2 == "")
      {
          $namasoap_input_2 = $namasoap;
      }
      $subject_cond_salva = $subject_cond; 
      if (!isset($subject_input_2) || $subject_input_2 == "")
      {
          $subject_input_2 = $subject;
      }
      if ($id_cond != "in")
      {
          nm_limpa_numero($id, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtemplatesoap']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtemplatesoap']['campos_busca']['object'] = $object; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtemplatesoap']['campos_busca']['object_cond'] = $object_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtemplatesoap']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtemplatesoap']['campos_busca']['id'] = $id; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtemplatesoap']['campos_busca']['id_cond'] = $id_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtemplatesoap']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtemplatesoap']['campos_busca']['namasoap'] = $namasoap; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtemplatesoap']['campos_busca']['namasoap_cond'] = $namasoap_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtemplatesoap']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtemplatesoap']['campos_busca']['subject'] = $subject; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtemplatesoap']['campos_busca']['subject_cond'] = $subject_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtemplatesoap']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtemplatesoap']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtemplatesoap']['campos_busca'] = $Temp_Busca;
      }
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['object'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['object'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['object'] = $object;
      }
      $id_look = substr($this->Db->qstr($id), 1, -1); 
      $nmgp_def_dados = array(); 
   if (is_numeric($id))
   { 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['namasoap'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['namasoap'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['namasoap'] = $namasoap;
      }
      $subject_look = substr($this->Db->qstr($subject), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct subject from " . $this->Ini->nm_tabela . " where subject = '$subject_look' order by subject"; 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['subject'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['subject'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['subject'] = $subject;
      }

      //----- $object
      $this->Date_part = false;
      if (isset($object) || $object_cond == "nu" || $object_cond == "nn" || $object_cond == "ep" || $object_cond == "ne")
      {
         $this->monta_condicao("object", $object_cond, $object, "", "object");
      }
      ...
      //----- $namasoap
      $this->Date_part = false;
      if (isset($namasoap) || $namasoap_cond == "nu" || $namasoap_cond == "nn" || $namasoap_cond == "ep" || $namasoap_cond == "ne")
      {
         $this->monta_condicao("namaSOAP", $namasoap_cond, $namasoap, "", "namasoap");
      }

      //----- $subject
      $this->Date_part = false;
      if (isset($subject) || $subject_cond == "nu" || $subject_cond == "nn" || $subject_cond == "ep" || $subject_cond == "ne")
      {
         $this->monta_condicao("subject", $subject_cond, $subject, "", "subject");
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtemplatesoap']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtemplatesoap']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtemplatesoap']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtemplatesoap']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtemplatesoap']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtemplatesoap']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtemplatesoap']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtemplatesoap']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbtemplatesoap']['cond_pesq'] .= $this->NM_operador;
