...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_tbtemplatesoap"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_tbtemplatesoap"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_tbtemplatesoap'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tbtemplatesoap']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_tbtemplatesoap']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tbtemplatesoap']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_tbtemplatesoap']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_tbtemplatesoap']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_tbtemplatesoap</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_tbtemplatesoap']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_tbtemplatesoap']['embutida_filho'] as $ind => $sc_init)
          {
