...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_object_cond" name="object_cond" onChange="nm_campos_between(document.getElementById('id_vis_object'), this, 'object')">
      ...
      <br><span id="id_hide_object"  <?php echo $str_hide_object?>><?php
      if ($object != "")
      {
      $object_look = substr($this->Db->qstr($object), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_namasoap_cond" name="namasoap_cond" onChange="nm_campos_between(document.getElementById('id_vis_namasoap'), this, 'namasoap')">
      ...
      <br><span id="id_hide_namasoap"  <?php echo $str_hide_namasoap?>><?php
      if ($namasoap != "")
      {
      $namasoap_look = substr($this->Db->qstr($namasoap), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_subject_cond" name="subject_cond" onChange="nm_campos_between(document.getElementById('id_vis_subject'), this, 'subject')">
      ...
      <br><span id="id_hide_subject"  <?php echo $str_hide_subject?>><?php
      if ($subject != "")
      {
      $subject_look = substr($this->Db->qstr($subject), 1, -1); 
      $nmgp_def_dados = array(); 
