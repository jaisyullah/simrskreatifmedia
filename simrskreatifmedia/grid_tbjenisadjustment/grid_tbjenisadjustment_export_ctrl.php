<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tbjenisadjustment']['sc_process_barr'] = true;
require_once('../grid_tbjenisadjustment/index.php');
unset($_SESSION['scriptcase']['grid_tbjenisadjustment']['sc_process_barr']);
$ExportCtrl = new grid_tbjenisadjustment_export_control;
$ExportCtrl->Export_barr();

class grid_tbjenisadjustment_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_title'] ?> Jenis Adjustment :: Excel</TITLE>
