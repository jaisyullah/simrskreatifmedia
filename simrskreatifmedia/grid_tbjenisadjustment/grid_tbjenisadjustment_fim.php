...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_tbjenisadjustment"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_tbjenisadjustment"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_tbjenisadjustment'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tbjenisadjustment']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_tbjenisadjustment']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tbjenisadjustment']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_tbjenisadjustment']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_tbjenisadjustment']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_tbjenisadjustment</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_tbjenisadjustment']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_tbjenisadjustment']['embutida_filho'] as $ind => $sc_init)
          {
