<?php
@session_start() ;
$_SESSION['scriptcase']['print_etiket3']['sc_process_barr'] = true;
require_once('../print_etiket3/index.php');
unset($_SESSION['scriptcase']['print_etiket3']['sc_process_barr']);
$ExportCtrl = new print_etiket3_export_control;
$ExportCtrl->Export_barr();

class print_etiket3_export_control
{
