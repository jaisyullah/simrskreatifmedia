...
//
   ...
   $_SESSION['scriptcase']['print_etiket3']['default_font'] = $this->default_font;
   ...
   if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
   {
       ...
       {
           if (in_array("print_etiket3", $apls_aba))
           {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['print_etiket3']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
   {
       $this->aba_iframe = true;
   }
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['print_etiket3']['qt_col_grid'] = 1 ;  
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['print_etiket3']['cols']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['print_etiket3']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['print_etiket3']['qt_col_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['print_etiket3']['cols'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['print_etiket3']['cols']);
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['print_etiket3']['ordem_select']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['print_etiket3']['ordem_select'] = array(); 
   } 
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['print_etiket3']['ordem_quebra']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['print_etiket3']['ordem_grid'] = "" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['print_etiket3']['ordem_ant']  = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['print_etiket3']['ordem_desc'] = "" ; 
   }   
   if (!empty($nmgp_parms) && $_SESSION['sc_session'][$this->Ini->sc_page]['print_etiket3']['opcao'] != "pdf")   
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['print_etiket3']['opcao'] = "igual";
       $rec = "ini";
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['print_etiket3']['where_orig']) || $_SESSION['sc_session'][$this->Ini->sc_page]['print_etiket3']['prim_cons'] || !empty($nmgp_parms))  
   { 
   ...
   {   
       $_SESSION['sc_session'][$this->Ini->sc_page]['print_etiket3']['where_pesq'] .= $this->nm_where_dinamico;
   }   
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['print_etiket3']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['print_etiket3']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['print_etiket3']['where_pesq_filtro'];
//
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['print_etiket3']['tot_geral'][1])) 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['print_etiket3']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['print_etiket3']['tot_geral'][1] ;  
   }
   $_SESSION['sc_session'][$this->Ini->sc_page]['print_etiket3']['where_pesq_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['print_etiket3']['where_pesq'];  
//----- 
   ...
   $nmgp_order_by = ""; 
   $campos_order_select = "";
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['print_etiket3']['ordem_select'] as $campo => $ordem) 
   {
        if ($campo != $_SESSION['sc_session'][$this->Ini->sc_page]['print_etiket3']['ordem_grid']) 
        {
   ...
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['print_etiket3']['ordem_grid'])) 
   { 
       $nmgp_order_by = " order by " . $_SESSION['sc_session'][$this->Ini->sc_page]['print_etiket3']['ordem_grid'] . $_SESSION['sc_session'][$this->Ini->sc_page]['print_etiket3']['ordem_desc']; 
   } 
   if (!empty($campos_order_select)) 
   { 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['print_etiket3']['order_grid'] = $nmgp_order_by;
...
// 
 function Pdf_image()
 {
   ...
   $this->Pdf->Image($this->NM_raiz_img . $this->Ini->path_img_global . "/grp__NM__bg__NM__etiket3.jpg", "0.000000", "0.000000", "210", "297", '', '', '', false, 300, '', false, false, 0);
...
//----- 
 function grid($linhas = 0)
 {
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['print_etiket3']['labels']['id'] = "Id";
   $_SESSION['sc_session'][$this->Ini->sc_page]['print_etiket3']['labels']['trancode'] = "Tran Code";
   $_SESSION['sc_session'][$this->Ini->sc_page]['print_etiket3']['labels']['item'] = "Item";
   $_SESSION['sc_session'][$this->Ini->sc_page]['print_etiket3']['labels']['satuan'] = "Satuan";
   $_SESSION['sc_session'][$this->Ini->sc_page]['print_etiket3']['labels']['jumlah'] = "Jumlah";
   $_SESSION['sc_session'][$this->Ini->sc_page]['print_etiket3']['labels']['aturanpakai1'] = "Aturan Pakai 1";
   $_SESSION['sc_session'][$this->Ini->sc_page]['print_etiket3']['labels']['aturanpakai2'] = "Aturan Pakai 2";
   $_SESSION['sc_session'][$this->Ini->sc_page]['print_etiket3']['labels']['jenisaturanpakai'] = "Jenis Aturan Pakai";
   $_SESSION['sc_session'][$this->Ini->sc_page]['print_etiket3']['labels']['sc_field_0'] = "Nama Obat";
   $_SESSION['sc_session'][$this->Ini->sc_page]['print_etiket3']['labels']['ed'] = "ed";
   $_SESSION['sc_session'][$this->Ini->sc_page]['print_etiket3']['labels']['exp'] = "exp";
   $_SESSION['sc_session'][$this->Ini->sc_page]['print_etiket3']['labels']['nama'] = "nama";
   $_SESSION['sc_session'][$this->Ini->sc_page]['print_etiket3']['labels']['qty'] = "qty";
   $_SESSION['sc_session'][$this->Ini->sc_page]['print_etiket3']['labels']['rsia'] = "rsia";
   $_SESSION['sc_session'][$this->Ini->sc_page]['print_etiket3']['labels']['sehari'] = "sehari";
   $_SESSION['sc_session'][$this->Ini->sc_page]['print_etiket3']['labels']['tgl_lahir'] = "tgl_lahir";
   $HTTP_REFERER = (isset($_SERVER['HTTP_REFERER'])) ? $_SERVER['HTTP_REFERER'] : ""; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['print_etiket3']['seq_dir'] = 0; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['print_etiket3']['sub_dir'] = array(); 
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['print_etiket3']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['print_etiket3']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['print_etiket3']['where_pesq_filtro'];
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['print_etiket3']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['print_etiket3']['lig_edit'] != '')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['print_etiket3']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['print_etiket3']['lig_edit'];
   }
...
// 
   ...
   {  
      ...
      $this->Pdf_init();
      $this->Pdf_image();
      while (!$this->rs_grid->EOF && $nm_quant_linhas < $_SESSION['sc_session'][$this->Ini->sc_page]['print_etiket3']['qt_col_grid']) 
      {  
...
$_SESSION['scriptcase']['print_etiket3']['contr_erro'] = 'off';
          ...
          $this->tgl_lahir[$this->nm_grid_colunas] = $this->SC_conv_utf8($this->tgl_lahir[$this->nm_grid_colunas]);
            $cell_tranCode = array('posx' => '6', 'posy' => '51', 'data' => $this->trancode[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => '12', 'color_r'    => '255', 'color_g'    => '255', 'color_b'    => '255', 'font_style' => $this->default_style);
            $cell_satuan = array('posx' => '11', 'posy' => '67', 'data' => $this->satuan[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => '12', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_jumlah = array('posx' => '43', 'posy' => '64', 'data' => $this->jumlah[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => '12', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_aturanPakai1 = array('posx' => '6', 'posy' => '62.5', 'data' => $this->aturanpakai1[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => '12', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_aturanPakai2 = array('posx' => '6', 'posy' => '67', 'data' => $this->aturanpakai2[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => '12', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_jenisAturanPakai = array('posx' => '6', 'posy' => '72', 'data' => $this->jenisaturanpakai[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => '10', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_sehari = array('posx' => '11', 'posy' => '62.5', 'data' => $this->sehari[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => '12', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_nama = array('posx' => '6', 'posy' => '46', 'data' => $this->nama[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => '12', 'color_r'    => '255', 'color_g'    => '255', 'color_b'    => '255', 'font_style' => $this->default_style);
            $cell_tgl_lahir = array('posx' => '55', 'posy' => '51', 'data' => $this->tgl_lahir[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => '12', 'color_r'    => '255', 'color_g'    => '255', 'color_b'    => '255', 'font_style' => $this->default_style);
            $cell_rsia = array('posx' => '13', 'posy' => '77.5', 'data' => $this->rsia[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => '11', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_qty = array('posx' => '33', 'posy' => '64', 'data' => $this->qty[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => '12', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_ed = array('posx' => '55', 'posy' => '69', 'data' => $this->ed[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => '11', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_exp = array('posx' => '55', 'posy' => '64', 'data' => $this->exp[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => '10', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_sc_field_0 = array('posx' => '6', 'posy' => '57', 'data' => $this->sc_field_0[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => '12', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
