  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbalergi" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbalergi_form();
	}

  // ---------- Validate description_
  function do_ajax_form_tbalergi_validate_description_(iNumLinha)
  {
    ...
    x_ajax_form_tbalergi_validate_description_(var_description_, iNumLinha, var_script_case_init, do_ajax_form_tbalergi_validate_description__cb);
  } // do_ajax_form_tbalergi_validate_description_

  function do_ajax_form_tbalergi_validate_description__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbalergi_validate_description__cb

  // ---------- Validate alergi_
  function do_ajax_form_tbalergi_validate_alergi_(iNumLinha)
  {
    var nomeCampo_alergi_ = "alergi_" + iNumLinha;
    var var_alergi_ = scAjaxGetFieldSelect(nomeCampo_alergi_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbalergi_validate_alergi_(var_alergi_, iNumLinha, var_script_case_init, do_ajax_form_tbalergi_validate_alergi__cb);
  } // do_ajax_form_tbalergi_validate_alergi_

  function do_ajax_form_tbalergi_validate_alergi__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "alergi_" + iLineNumber;
    }
    else
    {
      sFieldValid = "alergi_";
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "alergi_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "alergi_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbalergi_validate_alergi__cb

  // ---------- Validate custcode_
  function do_ajax_form_tbalergi_validate_custcode_(iNumLinha)
  {
    var nomeCampo_custcode_ = "custcode_" + iNumLinha;
    var var_custcode_ = scAjaxGetFieldText(nomeCampo_custcode_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbalergi_validate_custcode_(var_custcode_, iNumLinha, var_script_case_init, do_ajax_form_tbalergi_validate_custcode__cb);
  } // do_ajax_form_tbalergi_validate_custcode_

  function do_ajax_form_tbalergi_validate_custcode__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbalergi_validate_custcode__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_tbalergi_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_tbalergi_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tbalergi_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_tbalergi_add_new_line_cb);
  } // do_ajax_form_tbalergi_add_new_line

  function do_ajax_form_tbalergi_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_tbalergi_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_tbalergi_backup_line(iNumLinha)
  {
    var var_custcode_ = scAjaxGetFieldText("custcode_" + iNumLinha);
    var var_alergi_ = scAjaxGetFieldSelect("alergi_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbalergi_backup_line(var_custcode_, var_alergi_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_tbalergi_backup_line_cb);
  } // do_ajax_form_tbalergi_backup_line

  function do_ajax_form_tbalergi_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_tbalergi_backup_line_cb

  function do_ajax_form_tbalergi_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_tbalergi_cancel_insert

  function do_ajax_form_tbalergi_cancel_update(iSeqVert)
  {
    do_ajax_form_tbalergi_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_tbalergi_cancel_update

  function do_ajax_form_tbalergi_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_tbalergi_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_tbalergi_table_refresh()
  {
    var var_custcode_ = document.F2.custcode_.value;
    var var_alergi_ = document.F2.alergi_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_tbalergi_table_refresh(var_custcode_, var_alergi_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbalergi_table_refresh_cb);
  } //  do_ajax_form_tbalergi_table_refresh

  function do_ajax_form_tbalergi_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.custcode_.value = scAjaxGetKeyValue("custcode_");
    document.F2.alergi_.value = scAjaxGetKeyValue("alergi_");
    ...
    scAjaxAlert(do_ajax_form_tbalergi_table_refresh_cb_after_alert);
  } // do_ajax_form_tbalergi_table_refresh_cb
  function do_ajax_form_tbalergi_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxSetNavStatus("t");
    sc_insert_open = false;
  } // do_ajax_form_tbalergi_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_tbalergi_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_tbalergi_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
...
?>
    x_ajax_form_tbalergi_submit_form(var_description_, var_alergi_, var_custcode_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbalergi_submit_form_cb);
  } // do_ajax_form_tbalergi_submit_form

  function do_ajax_form_tbalergi_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("alergi_" + sc_num_ult_line);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_tbalergi_submit_form_cb_after_alert);
  } // do_ajax_form_tbalergi_submit_form_cb
  function do_ajax_form_tbalergi_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbalergi_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tbalergi_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_tbalergi_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("alergi_" + iNavForm);
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tbalergi_navigate_form(var_custcode_, var_alergi_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbalergi_navigate_form_cb);
  } // do_ajax_form_tbalergi_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbalergi']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbalergi_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.custcode_.value = scAjaxGetKeyValue("custcode_" + var_last_index);
    document.F2.alergi_.value = scAjaxGetKeyValue("alergi_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbalergi_navigate_form_cb_after_alert);
  } // do_ajax_form_tbalergi_navigate_form_cb
  function do_ajax_form_tbalergi_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_tbalergi_navigate_form_cb_after_alert
  function sc_hide_form_tbalergi_form()
  {
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "alergi_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "custcode_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["description_" + iNumLinha] = {"label": "Deskripsi Alergi<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["alergi_" + iNumLinha] = {"label": "Jenis Alergi<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_field_mult["alergi_"][iNumLinha] = "alergi_" + iNumLinha;
    ...
    ajax_field_id["alergi_" + iNumLinha] = new Array("hidden_field_label_alergi_", "hidden_field_data_alergi_" + iNumLinha);
    ajax_error_count["description_" + iNumLinha] = "off";
    ajax_error_count["alergi_" + iNumLinha] = "off";
...
?>
    ...
    ajax_read_only["alergi_" + iNumLinha] = "on";
...
?>
  ...
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["alergi_" + iNumLinha] = null;
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["alergi_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["alergi_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["alergi_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["alergi_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["alergi_" + iNumLinha]["onfocus"] = new Array();
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['description_'])) ? $this->nmgp_cmp_readonly['description_'] : 'on';
?>
    scAjaxFieldRead("description_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['alergi_'])) ? $this->nmgp_cmp_readonly['alergi_'] : 'on';
?>
    scAjaxFieldRead("alergi_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['custcode_'])) ? $this->nmgp_cmp_readonly['custcode_'] : 'on';
?>
  ...
  function mdCloseObjects(iSeq)
  {
    ...
    scAjaxFieldRead("alergi_" + iSeq, "on");
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["description_" + iRow] || "on" == ajax_error_count["alergi_" + iRow] || "on" == ajax_error_count["custcode_" + iRow]))
    {
      ...
      $("#hidden_field_data_alergi_" + iRow).addClass("scFormErrorLine");
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["description_" + iRow] && "off" == ajax_error_count["alergi_" + iRow] && "off" == ajax_error_count["custcode_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["description_" + iRow] = "off";
        ajax_error_count["alergi_" + iRow] = "off";
      ...
      $("#hidden_field_data_alergi_" + iRow).removeClass("scFormErrorLine");
