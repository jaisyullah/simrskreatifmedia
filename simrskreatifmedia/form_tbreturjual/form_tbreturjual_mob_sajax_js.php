  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbreturjual_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbreturjual_mob_form();
	}

  // ---------- Validate id
  function do_ajax_form_tbreturjual_mob_validate_id()
  {
    var nomeCampo_id = "id";
    var var_id = scAjaxGetFieldHidden(nomeCampo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbreturjual_mob_validate_id(var_id, var_script_case_init, do_ajax_form_tbreturjual_mob_validate_id_cb);
  } // do_ajax_form_tbreturjual_mob_validate_id

  function do_ajax_form_tbreturjual_mob_validate_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbreturjual_mob_validate_id_cb

  // ---------- Validate koderetur
  function do_ajax_form_tbreturjual_mob_validate_koderetur()
  {
    var nomeCampo_koderetur = "koderetur";
    var var_koderetur = scAjaxGetFieldText(nomeCampo_koderetur);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbreturjual_mob_validate_koderetur(var_koderetur, var_script_case_init, do_ajax_form_tbreturjual_mob_validate_koderetur_cb);
  } // do_ajax_form_tbreturjual_mob_validate_koderetur

  function do_ajax_form_tbreturjual_mob_validate_koderetur_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "koderetur";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbreturjual_mob_validate_koderetur_cb

  // ---------- Validate user_verif
  function do_ajax_form_tbreturjual_mob_validate_user_verif()
  {
    var nomeCampo_user_verif = "user_verif";
    var var_user_verif = scAjaxGetFieldText(nomeCampo_user_verif);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbreturjual_mob_validate_user_verif(var_user_verif, var_script_case_init, do_ajax_form_tbreturjual_mob_validate_user_verif_cb);
  } // do_ajax_form_tbreturjual_mob_validate_user_verif

  function do_ajax_form_tbreturjual_mob_validate_user_verif_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "user_verif";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbreturjual_mob_validate_user_verif_cb

  // ---------- Validate tglretur
  function do_ajax_form_tbreturjual_mob_validate_tglretur()
  {
    var nomeCampo_tglretur = "tglretur";
    var var_tglretur = scAjaxGetFieldText(nomeCampo_tglretur);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbreturjual_mob_validate_tglretur(var_tglretur, var_script_case_init, do_ajax_form_tbreturjual_mob_validate_tglretur_cb);
  } // do_ajax_form_tbreturjual_mob_validate_tglretur

  function do_ajax_form_tbreturjual_mob_validate_tglretur_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tglretur";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbreturjual_mob_validate_tglretur_cb

  // ---------- Validate kodetran
  function do_ajax_form_tbreturjual_mob_validate_kodetran()
  {
    var nomeCampo_kodetran = "kodetran";
    var var_kodetran = scAjaxGetFieldText(nomeCampo_kodetran);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbreturjual_mob_validate_kodetran(var_kodetran, var_script_case_init, do_ajax_form_tbreturjual_mob_validate_kodetran_cb);
  } // do_ajax_form_tbreturjual_mob_validate_kodetran

  function do_ajax_form_tbreturjual_mob_validate_kodetran_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "kodetran";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbreturjual_mob_validate_kodetran_cb

  // ---------- Validate tglverif
  function do_ajax_form_tbreturjual_mob_validate_tglverif()
  {
    var nomeCampo_tglverif = "tglverif";
    var var_tglverif = scAjaxGetFieldText(nomeCampo_tglverif);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbreturjual_mob_validate_tglverif(var_tglverif, var_script_case_init, do_ajax_form_tbreturjual_mob_validate_tglverif_cb);
  } // do_ajax_form_tbreturjual_mob_validate_tglverif

  function do_ajax_form_tbreturjual_mob_validate_tglverif_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tglverif";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbreturjual_mob_validate_tglverif_cb

  // ---------- Validate jenis
  function do_ajax_form_tbreturjual_mob_validate_jenis()
  {
    var nomeCampo_jenis = "jenis";
    var var_jenis = scAjaxGetFieldSelect(nomeCampo_jenis);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbreturjual_mob_validate_jenis(var_jenis, var_script_case_init, do_ajax_form_tbreturjual_mob_validate_jenis_cb);
  } // do_ajax_form_tbreturjual_mob_validate_jenis

  function do_ajax_form_tbreturjual_mob_validate_jenis_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "jenis";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbreturjual_mob_validate_jenis_cb

  // ---------- Validate statusretur
  function do_ajax_form_tbreturjual_mob_validate_statusretur()
  {
    var nomeCampo_statusretur = "statusretur";
    var var_statusretur = scAjaxGetFieldSelect(nomeCampo_statusretur);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbreturjual_mob_validate_statusretur(var_statusretur, var_script_case_init, do_ajax_form_tbreturjual_mob_validate_statusretur_cb);
  } // do_ajax_form_tbreturjual_mob_validate_statusretur

  function do_ajax_form_tbreturjual_mob_validate_statusretur_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "statusretur";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbreturjual_mob_validate_statusretur_cb

  // ---------- Validate keterangan
  function do_ajax_form_tbreturjual_mob_validate_keterangan()
  {
    var nomeCampo_keterangan = "keterangan";
    var var_keterangan = scAjaxGetFieldText(nomeCampo_keterangan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbreturjual_mob_validate_keterangan(var_keterangan, var_script_case_init, do_ajax_form_tbreturjual_mob_validate_keterangan_cb);
  } // do_ajax_form_tbreturjual_mob_validate_keterangan

  function do_ajax_form_tbreturjual_mob_validate_keterangan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbreturjual_mob_validate_keterangan_cb

  // ---------- Validate detailretur
  function do_ajax_form_tbreturjual_mob_validate_detailretur()
  {
    var nomeCampo_detailretur = "detailretur";
    var var_detailretur = scAjaxGetFieldText(nomeCampo_detailretur);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbreturjual_mob_validate_detailretur(var_detailretur, var_script_case_init, do_ajax_form_tbreturjual_mob_validate_detailretur_cb);
  } // do_ajax_form_tbreturjual_mob_validate_detailretur

  function do_ajax_form_tbreturjual_mob_validate_detailretur_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "detailretur";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbreturjual_mob_validate_detailretur_cb

  // ---------- Event onchange jenis
  function do_ajax_form_tbreturjual_mob_event_jenis_onchange()
  {
    var var_jenis = scAjaxGetFieldSelect("jenis");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tbreturjual_mob_event_jenis_onchange(var_jenis, var_script_case_init, do_ajax_form_tbreturjual_mob_event_jenis_onchange_cb);
  } // do_ajax_form_tbreturjual_mob_event_jenis_onchange

  function do_ajax_form_tbreturjual_mob_event_jenis_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "jenis";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_tbreturjual_mob_event_jenis_onchange_cb_after_alert);
  } // do_ajax_form_tbreturjual_mob_event_jenis_onchange_cb
  function do_ajax_form_tbreturjual_mob_event_jenis_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_tbreturjual_mob_event_jenis_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tbreturjual_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tbreturjual_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id = scAjaxGetFieldHidden("id");
    var var_koderetur = scAjaxGetFieldText("koderetur");
    var var_user_verif = scAjaxGetFieldText("user_verif");
    var var_tglretur = scAjaxGetFieldText("tglretur");
    var var_kodetran = scAjaxGetFieldText("kodetran");
    var var_tglverif = scAjaxGetFieldText("tglverif");
    var var_jenis = scAjaxGetFieldSelect("jenis");
    var var_statusretur = scAjaxGetFieldSelect("statusretur");
    ...
    scAjaxProcOn();
    x_ajax_form_tbreturjual_mob_submit_form(var_id, var_koderetur, var_user_verif, var_tglretur, var_kodetran, var_tglverif, var_jenis, var_statusretur, var_keterangan, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbreturjual_mob_submit_form_cb);
  } // do_ajax_form_tbreturjual_mob_submit_form

  function do_ajax_form_tbreturjual_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("koderetur");
      scAjaxHideErrorDisplay("user_verif");
      scAjaxHideErrorDisplay("tglretur");
      scAjaxHideErrorDisplay("kodetran");
      scAjaxHideErrorDisplay("tglverif");
      scAjaxHideErrorDisplay("jenis");
      scAjaxHideErrorDisplay("statusretur");
      scAjaxHideErrorDisplay("keterangan");
      scAjaxHideErrorDisplay("detailretur");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tbreturjual_mob_submit_form_cb_after_alert);
  } // do_ajax_form_tbreturjual_mob_submit_form_cb
  function do_ajax_form_tbreturjual_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbreturjual_mob_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_tbdetailreturjual_mob"] = "off";

  function do_ajax_form_tbreturjual_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    scStatusDetail["form_tbdetailreturjual_mob"] = "on";
    x_ajax_form_tbreturjual_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbreturjual_mob_navigate_form_cb);
  } // do_ajax_form_tbreturjual_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreturjual_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbreturjual_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_tbdetailreturjual_mob"] && "nmsc_iframe_liga_form_tbdetailreturjual_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_tbdetailreturjual_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_tbdetailreturjual_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_tbdetailreturjual_mob').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_tbdetailreturjual_mob').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_tbdetailreturjual_mob').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbreturjual_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_tbreturjual_mob_navigate_form_cb
  function do_ajax_form_tbreturjual_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_tbreturjual_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_tbreturjual_mob_navigate_form_cb_after_alert
  function sc_hide_form_tbreturjual_mob_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_tbdetailreturjual_mob"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[1] = "koderetur";
  ajax_field_list[2] = "user_verif";
  ajax_field_list[3] = "tglretur";
  ajax_field_list[4] = "kodetran";
  ajax_field_list[5] = "tglverif";
  ajax_field_list[6] = "jenis";
  ajax_field_list[7] = "statusretur";
  ajax_field_list[8] = "keterangan";
  ajax_field_list[9] = "detailretur";
  ...
  var ajax_error_list = {
    ...
    "koderetur": {"label": "Kode Retur", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "user_verif": {"label": "User Verif", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "tglretur": {"label": "Tgl Retur", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "kodetran": {"label": "Kode Pelayanan", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "tglverif": {"label": "Tgl Verif", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "jenis": {"label": "Jenis", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "statusretur": {"label": "Status Retur", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "detailretur": {"label": "", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "id": new Array(),
    "koderetur": new Array(),
    "user_verif": new Array(),
    "tglretur": new Array(),
    "kodetran": new Array(),
    "tglverif": new Array(),
    "jenis": new Array(),
    "statusretur": new Array(),
    "keterangan": new Array(),
    "detailretur": new Array()
  };
  ajax_field_mult["id"][1] = "id";
  ajax_field_mult["koderetur"][1] = "koderetur";
  ajax_field_mult["user_verif"][1] = "user_verif";
  ajax_field_mult["tglretur"][1] = "tglretur";
  ajax_field_mult["kodetran"][1] = "kodetran";
  ajax_field_mult["tglverif"][1] = "tglverif";
  ajax_field_mult["jenis"][1] = "jenis";
  ajax_field_mult["statusretur"][1] = "statusretur";
  ajax_field_mult["keterangan"][1] = "keterangan";
  ajax_field_mult["detailretur"][1] = "detailretur";

  var ajax_field_id = {
    "koderetur": new Array("hidden_field_label_koderetur", "hidden_field_data_koderetur"),
    "user_verif": new Array("hidden_field_label_user_verif", "hidden_field_data_user_verif"),
    "tglretur": new Array("hidden_field_label_tglretur", "hidden_field_data_tglretur"),
    "kodetran": new Array("hidden_field_label_kodetran", "hidden_field_data_kodetran"),
    "tglverif": new Array("hidden_field_label_tglverif", "hidden_field_data_tglverif"),
    "jenis": new Array("hidden_field_label_jenis", "hidden_field_data_jenis"),
    "statusretur": new Array("hidden_field_label_statusretur", "hidden_field_data_statusretur"),
    "keterangan": new Array("hidden_field_label_keterangan", "hidden_field_data_keterangan"),
    "detailretur": new Array("hidden_field_label_detailretur", "hidden_field_data_detailretur")
  };
