...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_tglretur_hora' + iSeqRow).bind('blur', function() { sc_form_tbreturjual_tglretur_hora_onblur(this, iSeqRow) })
                                           .bind('focus', function() { sc_form_tbreturjual_tglretur_hora_onfocus(this, iSeqRow) });
  ...
  $('#id_sc_field_tglverif_hora' + iSeqRow).bind('blur', function() { sc_form_tbreturjual_tglverif_hora_onblur(this, iSeqRow) })
                                           .bind('focus', function() { sc_form_tbreturjual_tglverif_hora_onfocus(this, iSeqRow) });
...
function sc_form_tbreturjual_tglretur_hora_onblur(oThis, iSeqRow) {
  do_ajax_form_tbreturjual_validate_tglretur();
  scCssBlur(oThis);
}
...
function sc_form_tbreturjual_tglretur_hora_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function sc_form_tbreturjual_tglverif_hora_onblur(oThis, iSeqRow) {
  do_ajax_form_tbreturjual_validate_tglverif();
  scCssBlur(oThis);
}
...
function sc_form_tbreturjual_tglverif_hora_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function displayChange_field_detailretur(row, status) {
	if ("on" == status && typeof $("#nmsc_iframe_liga_form_tbdetailreturjual")[0].contentWindow.scRecreateSelect2 === "function") {
		$("#nmsc_iframe_liga_form_tbdetailreturjual")[0].contentWindow.scRecreateSelect2();
	}
}
...
function scHidePage(pageNo) {
	$("#id_form_tbreturjual_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_tglretur" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_tbreturjual_validate_tglretur(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_tglverif" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_tbreturjual_validate_tglverif(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
