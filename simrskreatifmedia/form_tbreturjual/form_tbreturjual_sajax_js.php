  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbreturjual" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbreturjual_form();
	}

  // ---------- Validate id
  function do_ajax_form_tbreturjual_validate_id()
  {
    var nomeCampo_id = "id";
    var var_id = scAjaxGetFieldHidden(nomeCampo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbreturjual_validate_id(var_id, var_script_case_init, do_ajax_form_tbreturjual_validate_id_cb);
  } // do_ajax_form_tbreturjual_validate_id

  function do_ajax_form_tbreturjual_validate_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbreturjual_validate_id_cb

  // ---------- Validate koderetur
  function do_ajax_form_tbreturjual_validate_koderetur()
  {
    var nomeCampo_koderetur = "koderetur";
    var var_koderetur = scAjaxGetFieldText(nomeCampo_koderetur);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbreturjual_validate_koderetur(var_koderetur, var_script_case_init, do_ajax_form_tbreturjual_validate_koderetur_cb);
  } // do_ajax_form_tbreturjual_validate_koderetur

  function do_ajax_form_tbreturjual_validate_koderetur_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbreturjual_validate_koderetur_cb

  // ---------- Validate user_verif
  function do_ajax_form_tbreturjual_validate_user_verif()
  {
    var nomeCampo_user_verif = "user_verif";
    var var_user_verif = scAjaxGetFieldText(nomeCampo_user_verif);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbreturjual_validate_user_verif(var_user_verif, var_script_case_init, do_ajax_form_tbreturjual_validate_user_verif_cb);
  } // do_ajax_form_tbreturjual_validate_user_verif

  function do_ajax_form_tbreturjual_validate_user_verif_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbreturjual_validate_user_verif_cb

  // ---------- Validate tglretur
  function do_ajax_form_tbreturjual_validate_tglretur()
  {
    var nomeCampo_tglretur = "tglretur";
    var var_tglretur = scAjaxGetFieldText(nomeCampo_tglretur);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbreturjual_validate_tglretur(var_tglretur, var_script_case_init, do_ajax_form_tbreturjual_validate_tglretur_cb);
  } // do_ajax_form_tbreturjual_validate_tglretur

  function do_ajax_form_tbreturjual_validate_tglretur_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbreturjual_validate_tglretur_cb

  // ---------- Validate kodetran
  function do_ajax_form_tbreturjual_validate_kodetran()
  {
    var nomeCampo_kodetran = "kodetran";
    var var_kodetran = scAjaxGetFieldText(nomeCampo_kodetran);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbreturjual_validate_kodetran(var_kodetran, var_script_case_init, do_ajax_form_tbreturjual_validate_kodetran_cb);
  } // do_ajax_form_tbreturjual_validate_kodetran

  function do_ajax_form_tbreturjual_validate_kodetran_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbreturjual_validate_kodetran_cb

  // ---------- Validate tglverif
  function do_ajax_form_tbreturjual_validate_tglverif()
  {
    var nomeCampo_tglverif = "tglverif";
    var var_tglverif = scAjaxGetFieldText(nomeCampo_tglverif);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbreturjual_validate_tglverif(var_tglverif, var_script_case_init, do_ajax_form_tbreturjual_validate_tglverif_cb);
  } // do_ajax_form_tbreturjual_validate_tglverif

  function do_ajax_form_tbreturjual_validate_tglverif_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbreturjual_validate_tglverif_cb

  // ---------- Validate jenis
  function do_ajax_form_tbreturjual_validate_jenis()
  {
    var nomeCampo_jenis = "jenis";
    var var_jenis = scAjaxGetFieldSelect(nomeCampo_jenis);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbreturjual_validate_jenis(var_jenis, var_script_case_init, do_ajax_form_tbreturjual_validate_jenis_cb);
  } // do_ajax_form_tbreturjual_validate_jenis

  function do_ajax_form_tbreturjual_validate_jenis_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "jenis";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbreturjual_validate_jenis_cb

  // ---------- Validate statusretur
  function do_ajax_form_tbreturjual_validate_statusretur()
  {
    var nomeCampo_statusretur = "statusretur";
    var var_statusretur = scAjaxGetFieldSelect(nomeCampo_statusretur);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbreturjual_validate_statusretur(var_statusretur, var_script_case_init, do_ajax_form_tbreturjual_validate_statusretur_cb);
  } // do_ajax_form_tbreturjual_validate_statusretur

  function do_ajax_form_tbreturjual_validate_statusretur_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbreturjual_validate_statusretur_cb

  // ---------- Validate keterangan
  function do_ajax_form_tbreturjual_validate_keterangan()
  {
    var nomeCampo_keterangan = "keterangan";
    var var_keterangan = scAjaxGetFieldText(nomeCampo_keterangan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbreturjual_validate_keterangan(var_keterangan, var_script_case_init, do_ajax_form_tbreturjual_validate_keterangan_cb);
  } // do_ajax_form_tbreturjual_validate_keterangan

  function do_ajax_form_tbreturjual_validate_keterangan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbreturjual_validate_keterangan_cb

  // ---------- Validate detailretur
  function do_ajax_form_tbreturjual_validate_detailretur()
  {
    var nomeCampo_detailretur = "detailretur";
    var var_detailretur = scAjaxGetFieldText(nomeCampo_detailretur);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbreturjual_validate_detailretur(var_detailretur, var_script_case_init, do_ajax_form_tbreturjual_validate_detailretur_cb);
  } // do_ajax_form_tbreturjual_validate_detailretur

  function do_ajax_form_tbreturjual_validate_detailretur_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbreturjual_validate_detailretur_cb

  // ---------- Event onchange jenis
  function do_ajax_form_tbreturjual_event_jenis_onchange()
  {
    var var_jenis = scAjaxGetFieldSelect("jenis");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tbreturjual_event_jenis_onchange(var_jenis, var_script_case_init, do_ajax_form_tbreturjual_event_jenis_onchange_cb);
  } // do_ajax_form_tbreturjual_event_jenis_onchange

  function do_ajax_form_tbreturjual_event_jenis_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "jenis";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_tbreturjual_event_jenis_onchange_cb_after_alert);
  } // do_ajax_form_tbreturjual_event_jenis_onchange_cb
  function do_ajax_form_tbreturjual_event_jenis_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_tbreturjual_event_jenis_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tbreturjual_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tbreturjual_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_tbreturjual_submit_form(var_id, var_koderetur, var_user_verif, var_tglretur, var_kodetran, var_tglverif, var_jenis, var_statusretur, var_keterangan, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbreturjual_submit_form_cb);
  } // do_ajax_form_tbreturjual_submit_form

  function do_ajax_form_tbreturjual_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tbreturjual_submit_form_cb_after_alert);
  } // do_ajax_form_tbreturjual_submit_form_cb
  function do_ajax_form_tbreturjual_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbreturjual_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_tbdetailreturjual"] = "off";

  function do_ajax_form_tbreturjual_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    scStatusDetail["form_tbdetailreturjual"] = "on";
    x_ajax_form_tbreturjual_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbreturjual_navigate_form_cb);
  } // do_ajax_form_tbreturjual_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreturjual']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbreturjual_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_tbdetailreturjual"] && "nmsc_iframe_liga_form_tbdetailreturjual" != scMasterDetailIframe["nmsc_iframe_liga_form_tbdetailreturjual"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_tbdetailreturjual"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_tbdetailreturjual').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_tbdetailreturjual').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_tbdetailreturjual').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbreturjual_navigate_form_cb_after_alert);
  } // do_ajax_form_tbreturjual_navigate_form_cb
  function do_ajax_form_tbreturjual_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_tbreturjual_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_tbreturjual_navigate_form_cb_after_alert
  function sc_hide_form_tbreturjual_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_tbdetailreturjual"])
    {
      return true;
    }
    return false;
