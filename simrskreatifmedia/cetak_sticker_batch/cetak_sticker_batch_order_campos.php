<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['cetak_sticker_batch']['glo_nm_path_imag_temp'] . "/sc_apl_default_simrskreatifmedia.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new cetak_sticker_batch_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class cetak_sticker_batch_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['cetak_sticker_batch']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['cetak_sticker_batch']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels     = array();
   $tab_ger_campos['b_gelar'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['b_gelar'] = "b_gelar";
   }
   else
   {
       $tab_def_campos['b_gelar'] = "b.gelar";
   }
   $tab_labels["b_gelar"]   = (isset($_SESSION['sc_session'][$sc_init]['cetak_sticker_batch']['labels']["b_gelar"])) ? $_SESSION['sc_session'][$sc_init]['cetak_sticker_batch']['labels']["b_gelar"] : "Gelar";
   ...
   {
       $tab_def_campos['sc_field_1'] = "b.nama_pasien";
   }
   $tab_labels["sc_field_1"]   = (isset($_SESSION['sc_session'][$sc_init]['cetak_sticker_batch']['labels']["sc_field_1"])) ? $_SESSION['sc_session'][$sc_init]['cetak_sticker_batch']['labels']["sc_field_1"] : "Nama Pasien";
   ...
   {
       $tab_def_campos['sc_field_2'] = "b.bed";
   }
   $tab_labels["sc_field_2"]   = (isset($_SESSION['sc_session'][$sc_init]['cetak_sticker_batch']['labels']["sc_field_2"])) ? $_SESSION['sc_session'][$sc_init]['cetak_sticker_batch']['labels']["sc_field_2"] : "No Bed";
   $tab_ger_campos['makan'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['makan'] = "makan";
   }
   else
   {
       $tab_def_campos['makan'] = "a.jadwal";
   }
   $tab_labels["makan"]   = (isset($_SESSION['sc_session'][$sc_init]['cetak_sticker_batch']['labels']["makan"])) ? $_SESSION['sc_session'][$sc_init]['cetak_sticker_batch']['labels']["makan"] : "Makan";
   $tab_ger_campos['b_diet'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['b_diet'] = "b_diet";
   }
   else
   {
       $tab_def_campos['b_diet'] = "b.diet";
   }
   $tab_labels["b_diet"]   = (isset($_SESSION['sc_session'][$sc_init]['cetak_sticker_batch']['labels']["b_diet"])) ? $_SESSION['sc_session'][$sc_init]['cetak_sticker_batch']['labels']["b_diet"] : "Diet";
   $tab_ger_campos['b_mp'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['b_mp'] = "b_mp";
   }
   else
   {
       $tab_def_campos['b_mp'] = "b.mp";
   }
   $tab_labels["b_mp"]   = (isset($_SESSION['sc_session'][$sc_init]['cetak_sticker_batch']['labels']["b_mp"])) ? $_SESSION['sc_session'][$sc_init]['cetak_sticker_batch']['labels']["b_mp"] : "Mp";
   $tab_ger_campos['b_lh'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['b_lh'] = "b_lh";
   }
   else
   {
       $tab_def_campos['b_lh'] = "b.lh";
   }
   $tab_labels["b_lh"]   = (isset($_SESSION['sc_session'][$sc_init]['cetak_sticker_batch']['labels']["b_lh"])) ? $_SESSION['sc_session'][$sc_init]['cetak_sticker_batch']['labels']["b_lh"] : "Lh";
   $tab_ger_campos['b_ln'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['b_ln'] = "b_ln";
   }
   else
   {
       $tab_def_campos['b_ln'] = "b.ln";
   }
   $tab_labels["b_ln"]   = (isset($_SESSION['sc_session'][$sc_init]['cetak_sticker_batch']['labels']["b_ln"])) ? $_SESSION['sc_session'][$sc_init]['cetak_sticker_batch']['labels']["b_ln"] : "Ln";
   $tab_ger_campos['b_syr'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['b_syr'] = "b_syr";
   }
   else
   {
       $tab_def_campos['b_syr'] = "b.syr";
   }
   $tab_labels["b_syr"]   = (isset($_SESSION['sc_session'][$sc_init]['cetak_sticker_batch']['labels']["b_syr"])) ? $_SESSION['sc_session'][$sc_init]['cetak_sticker_batch']['labels']["b_syr"] : "Syr";
   $tab_ger_campos['b_ekstra'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['b_ekstra'] = "b_ekstra";
   }
   else
   {
       $tab_def_campos['b_ekstra'] = "b.ekstra";
   }
   $tab_labels["b_ekstra"]   = (isset($_SESSION['sc_session'][$sc_init]['cetak_sticker_batch']['labels']["b_ekstra"])) ? $_SESSION['sc_session'][$sc_init]['cetak_sticker_batch']['labels']["b_ekstra"] : "Ekstra";
   $tab_ger_campos['b_buah'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['b_buah'] = "b_buah";
   }
   else
   {
       $tab_def_campos['b_buah'] = "b.buah";
   }
   $tab_labels["b_buah"]   = (isset($_SESSION['sc_session'][$sc_init]['cetak_sticker_batch']['labels']["b_buah"])) ? $_SESSION['sc_session'][$sc_init]['cetak_sticker_batch']['labels']["b_buah"] : "Buah";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['cetak_sticker_batch']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['cetak_sticker_batch']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['cetak_sticker_batch']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['cetak_sticker_batch']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['cetak_sticker_batch']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['cetak_sticker_batch']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['cetak_sticker_batch']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['cetak_sticker_batch']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['cetak_sticker_batch']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - inventaris</TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "cetak_sticker_batch_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['cetak_sticker_batch']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['cetak_sticker_batch']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['cetak_sticker_batch']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['cetak_sticker_batch']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['cetak_sticker_batch']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
