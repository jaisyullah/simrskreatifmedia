...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____cetak_sticker_batch"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____cetak_sticker_batch"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['cetak_sticker_batch']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['cetak_sticker_batch']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['cetak_sticker_batch']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['cetak_sticker_batch']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['cetak_sticker_batch']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>cetak_sticker_batch</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['cetak_sticker_batch']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['cetak_sticker_batch']['embutida_filho'] as $ind => $sc_init)
          {
