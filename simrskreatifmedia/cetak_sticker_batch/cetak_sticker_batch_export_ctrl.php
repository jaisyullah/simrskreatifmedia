<?php
@session_start() ;
$_SESSION['scriptcase']['cetak_sticker_batch']['sc_process_barr'] = true;
require_once('../cetak_sticker_batch/index.php');
unset($_SESSION['scriptcase']['cetak_sticker_batch']['sc_process_barr']);
$ExportCtrl = new cetak_sticker_batch_export_control;
$ExportCtrl->Export_barr();

class cetak_sticker_batch_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - inventaris :: Excel</TITLE>
