...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____kwitansi"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____kwitansi"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['kwitansi']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['kwitansi']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['kwitansi']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['kwitansi']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['kwitansi']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['kwitansi']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['kwitansi']['embutida_filho'] as $ind => $sc_init)
          {
