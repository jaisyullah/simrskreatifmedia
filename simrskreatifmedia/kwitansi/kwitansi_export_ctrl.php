<?php
@session_start() ;
$_SESSION['scriptcase']['kwitansi']['sc_process_barr'] = true;
require_once('../kwitansi/index.php');
unset($_SESSION['scriptcase']['kwitansi']['sc_process_barr']);
$ExportCtrl = new kwitansi_export_control;
$ExportCtrl->Export_barr();

class kwitansi_export_control
{
