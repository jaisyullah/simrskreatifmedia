<?php
@session_start() ;
$_SESSION['scriptcase']['grid_hisdetailrawatinap']['sc_process_barr'] = true;
require_once('../grid_hisdetailrawatinap/index.php');
unset($_SESSION['scriptcase']['grid_hisdetailrawatinap']['sc_process_barr']);
$ExportCtrl = new grid_hisdetailrawatinap_export_control;
$ExportCtrl->Export_barr();

class grid_hisdetailrawatinap_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - Pelayanan Rawat Inap :: Excel</TITLE>
