<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_hisdetailrawatinap']['glo_nm_path_imag_temp'] . "/sc_apl_default_simrskreatifmedia.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_hisdetailrawatinap_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_hisdetailrawatinap_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_hisdetailrawatinap']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_hisdetailrawatinap']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels     = array();
   $tab_ger_campos['bill'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['bill'] = "Bill";
   }
   else
   {
       $tab_def_campos['bill'] = "";
   }
   $tab_labels["bill"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_hisdetailrawatinap']['labels']["bill"])) ? $_SESSION['sc_session'][$sc_init]['grid_hisdetailrawatinap']['labels']["bill"] : "Bill";
   ...
   {
       $tab_def_campos['kode'] = "a.tranCode";
   }
   $tab_labels["kode"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_hisdetailrawatinap']['labels']["kode"])) ? $_SESSION['sc_session'][$sc_init]['grid_hisdetailrawatinap']['labels']["kode"] : "Kode";
   $tab_ger_campos['rm'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['rm'] = "rm";
   }
   else
   {
       $tab_def_campos['rm'] = "a.custCode";
   }
   $tab_labels["rm"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_hisdetailrawatinap']['labels']["rm"])) ? $_SESSION['sc_session'][$sc_init]['grid_hisdetailrawatinap']['labels']["rm"] : "RM";
...
ORDER BY name, salut";
   ...
   $tab_labels["sc_field_0"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_hisdetailrawatinap']['labels']["sc_field_0"])) ? $_SESSION['sc_session'][$sc_init]['grid_hisdetailrawatinap']['labels']["sc_field_0"] : "Nama Pasien";
   ...
   $tab_labels["sc_field_1"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_hisdetailrawatinap']['labels']["sc_field_1"])) ? $_SESSION['sc_session'][$sc_init]['grid_hisdetailrawatinap']['labels']["sc_field_1"] : "Tgl. Lahir";
   $tab_ger_campos['jk'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['jk'] = "JK";
   }
   else
   {
       $tab_def_campos['jk'] = "";
   }
   $tab_labels["jk"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_hisdetailrawatinap']['labels']["jk"])) ? $_SESSION['sc_session'][$sc_init]['grid_hisdetailrawatinap']['labels']["jk"] : "JK";
   $tab_ger_campos['diagnosa'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['diagnosa'] = "diagnosa";
   }
   else
   {
       $tab_def_campos['diagnosa'] = "b.diagnosa1";
   }
   $tab_labels["diagnosa"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_hisdetailrawatinap']['labels']["diagnosa"])) ? $_SESSION['sc_session'][$sc_init]['grid_hisdetailrawatinap']['labels']["diagnosa"] : "Diagnosa";
   $tab_ger_campos['bayar'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['bayar'] = "bayar";
   }
   else
   {
       $tab_def_campos['bayar'] = "b.pembayaran";
   }
   $tab_labels["bayar"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_hisdetailrawatinap']['labels']["bayar"])) ? $_SESSION['sc_session'][$sc_init]['grid_hisdetailrawatinap']['labels']["bayar"] : "Bayar";
   $tab_ger_campos['kelas'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['kelas'] = "kelas";
   }
   else
   {
       $tab_def_campos['kelas'] = "b.kelas";
   }
   $tab_labels["kelas"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_hisdetailrawatinap']['labels']["kelas"])) ? $_SESSION['sc_session'][$sc_init]['grid_hisdetailrawatinap']['labels']["kelas"] : "Kelas";
   $tab_ger_campos['ruanginap'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['ruanginap'] = "ruangInap";
   }
   else
   {
       $tab_def_campos['ruanginap'] = "select sc_concat(c.ruang,' (Bed ',c.noBed,')') as 'Ruang/Bed' from tbadmrawatinap a left join tbdetailrawatinap b on b.tranCode = a.tranCode left join tbbed c on c.idBed = a.bed where a.tranCode = '{Kode}'";
   }
   $tab_labels["ruanginap"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_hisdetailrawatinap']['labels']["ruanginap"])) ? $_SESSION['sc_session'][$sc_init]['grid_hisdetailrawatinap']['labels']["ruanginap"] : "Ruang / Bed";
   ...
   {
       $tab_def_campos['dokter'] = "a.dokter";
   }
   $tab_labels["dokter"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_hisdetailrawatinap']['labels']["dokter"])) ? $_SESSION['sc_session'][$sc_init]['grid_hisdetailrawatinap']['labels']["dokter"] : "Dokter";
   $tab_ger_campos['tglmasuk'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['tglmasuk'] = "tglmasuk";
   }
   else
   {
       $tab_def_campos['tglmasuk'] = "b.tglMasuk";
   }
   $tab_labels["tglmasuk"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_hisdetailrawatinap']['labels']["tglmasuk"])) ? $_SESSION['sc_session'][$sc_init]['grid_hisdetailrawatinap']['labels']["tglmasuk"] : "Tgl Masuk";
   $tab_ger_campos['tglkeluar'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['tglkeluar'] = "tglkeluar";
   }
   else
   {
       $tab_def_campos['tglkeluar'] = "a.tglKeluar";
   }
   $tab_labels["tglkeluar"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_hisdetailrawatinap']['labels']["tglkeluar"])) ? $_SESSION['sc_session'][$sc_init]['grid_hisdetailrawatinap']['labels']["tglkeluar"] : "Tgl Keluar";
   $tab_ger_campos['carakeluar'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['carakeluar'] = "carakeluar";
   }
   else
   {
       $tab_def_campos['carakeluar'] = "a.caraKeluar";
   }
   $tab_labels["carakeluar"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_hisdetailrawatinap']['labels']["carakeluar"])) ? $_SESSION['sc_session'][$sc_init]['grid_hisdetailrawatinap']['labels']["carakeluar"] : "Cara Keluar";
   $tab_ger_campos['bill'] = "none";
   $tab_ger_campos['sc_field_0'] = "none";
   $tab_ger_campos['sc_field_1'] = "none";
   $tab_ger_campos['jk'] = "none";
   $tab_ger_campos['ruanginap'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_hisdetailrawatinap']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_hisdetailrawatinap']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_hisdetailrawatinap']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_hisdetailrawatinap']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_hisdetailrawatinap']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_hisdetailrawatinap']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_hisdetailrawatinap']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_hisdetailrawatinap']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_hisdetailrawatinap']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - Pelayanan Rawat Inap</TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_hisdetailrawatinap_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_hisdetailrawatinap']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_hisdetailrawatinap']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_hisdetailrawatinap']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_hisdetailrawatinap']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_hisdetailrawatinap']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
