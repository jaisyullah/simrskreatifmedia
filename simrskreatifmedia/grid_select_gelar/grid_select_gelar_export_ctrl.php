<?php
@session_start() ;
$_SESSION['scriptcase']['grid_select_gelar']['sc_process_barr'] = true;
require_once('../grid_select_gelar/index.php');
unset($_SESSION['scriptcase']['grid_select_gelar']['sc_process_barr']);
$ExportCtrl = new grid_select_gelar_export_control;
$ExportCtrl->Export_barr();

class grid_select_gelar_export_control
{
