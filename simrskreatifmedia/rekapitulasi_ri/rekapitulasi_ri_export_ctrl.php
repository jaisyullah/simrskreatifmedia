<?php
@session_start() ;
$_SESSION['scriptcase']['rekapitulasi_ri']['sc_process_barr'] = true;
require_once('../rekapitulasi_ri/index.php');
unset($_SESSION['scriptcase']['rekapitulasi_ri']['sc_process_barr']);
$ExportCtrl = new rekapitulasi_ri_export_control;
$ExportCtrl->Export_barr();

class rekapitulasi_ri_export_control
{
