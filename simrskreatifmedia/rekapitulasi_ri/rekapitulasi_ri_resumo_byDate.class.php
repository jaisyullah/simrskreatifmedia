...
class rekapitulasi_ri_resumo
{
   ...
   var $link_graph_tot; 
   var $Tot_ger; 
   var $array_total_b_tglkeluar;
   var $array_total_a_tglmasuk;
   ...
   function __construct($tipo = "")
   {
      ...
      $this->array_total_b_tglkeluar = array();
      $this->array_total_a_tglmasuk  = array();
   ...
   function initializeButtons()
   {
      ...
      $this->nmgp_botoes['chart_exit'] = isset($_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['dashboard_info']['under_dashboard'] ? "off" : "on";
   ...
   { 
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['rekapitulasi_ri']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['rekapitulasi_ri']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['res_hrz'];
      $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
      $dir_raiz          = substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['where_resumo'] = "";
      }
      $this->inicializa_vars();
      $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['SC_Ind_Groupby'];
      $this->Total->$Gb_geral();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['contr_total_geral'] == "OK")
      {
          $this->array_total_b_tglkeluar = $_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['arr_total']['b_tglkeluar'];
          $this->array_total_a_tglmasuk = $_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['arr_total']['a_tglmasuk'];
      }
      else
      {
          $this->array_total_b_tglkeluar = array();
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['tot_geral'][1];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['tot_geral'][1] == 0)
      {
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          $this->drawMatrix();
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['arr_total']['b_tglkeluar'] = $this->array_total_b_tglkeluar;
      $_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['arr_total']['a_tglmasuk'] = $this->array_total_a_tglmasuk;
      $_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['json_use_label'])
       {
          $Lab_b_tglkeluar = "b.tglKeluar";
          $Lab_a_tglmasuk = "a.tglMasuk";
       }
       else
       {
          $Lab_b_tglkeluar = "Tgl Masuk x Tgl Keluar";
          $Lab_a_tglmasuk = "Tgl Masuk x Tgl Keluar";
       }
       $this->comp_field = array(
           $Lab_b_tglkeluar,
           $Lab_a_tglmasuk,
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['labels']['a_trancode']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['labels']['a_trancode'] = "Kode Transaksi"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['labels']['a_custcode']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['labels']['a_custcode'] = "No RM"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['labels']['nama']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['labels']['nama'] = "Nama Pasien"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['labels']['tl']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['labels']['tl'] = "Tgl. Lahir"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['labels']['usia']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['labels']['usia'] = "Usia"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['labels']['a_kelas']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['labels']['a_kelas'] = "Kelas Bayar"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['labels']['bed']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['labels']['bed'] = "Bed"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['labels']['a_tglmasuk']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['labels']['a_tglmasuk'] = "Tgl Masuk"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['labels']['b_tglkeluar']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['labels']['b_tglkeluar'] = "Tgl Keluar"; 
       }
       //-----
       $this->comp_field_nm = array(
           'b_tglkeluar' => 0,
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['summarizing_fields_order']['byDate']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['summarizing_fields_order']['byDate'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['summarizing_fields_order']['byDate'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['summarizing_fields_display']['byDate'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['summarizing_fields_display']['byDate'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['summarizing_fields_display']['byDate'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['summarizing_fields_display']['byDate'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['summarizing_fields_display']['byDate'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['summarizing_fields_display']['byDate'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['summarizing_fields_display']['byDate'] as $i_sum => $d_sum)
           {
       ...
       //-----
       foreach ($this->array_total_b_tglkeluar as $i_b_tglkeluar => $d_b_tglkeluar) {
           if (!in_array($i_b_tglkeluar, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_b_tglkeluar[3] ] = $d_b_tglkeluar[2];
               $this->comp_label[0][ $d_b_tglkeluar[3] ] = $d_b_tglkeluar[2];
           }
           foreach ($this->array_total_a_tglmasuk[$i_b_tglkeluar] as $i_a_tglmasuk => $d_a_tglmasuk) {
               if (!in_array($i_a_tglmasuk, $this->comp_label[1][ $d_b_tglkeluar[3] ], true)) {
                   $this->comp_index[1][ $d_a_tglmasuk[3] ] = $d_a_tglmasuk[2];
                   $this->comp_label[1][ $d_b_tglkeluar[3] ][ $d_a_tglmasuk[3] ] = $d_a_tglmasuk[2];
               }
           }
       }
       ...
       //-----
       $this->comp_links_fl = array(
           array('name' => 'b_tglkeluar', 'prot' => '@aspass@'),
           array('name' => 'a_tglmasuk', 'prot' => '@aspass@'),
       );
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['pivot_order_level'] = -1;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['pivot_tabular_label'];
       ...
       //-----
       foreach ($this->comp_label[0] as $i_b_tglkeluar => $l_b_tglkeluar) {
           if (isset($this->array_total_b_tglkeluar[$i_b_tglkeluar])) {
               $this->comp_group[$i_b_tglkeluar] = array();
           }
           foreach ($this->comp_label[1][$i_b_tglkeluar] as $i_a_tglmasuk => $l_a_tglmasuk) {
               if (isset($this->array_total_a_tglmasuk[$i_b_tglkeluar][$i_a_tglmasuk])) {
                   $this->comp_group[$i_b_tglkeluar][$i_a_tglmasuk] = array();
               }
           }
       }
   ...
   function getCompData($level, $params = array()) {
       if (0 == $level) {
           $return = $this->array_total_b_tglkeluar;
       }
       elseif (1 == $level) {
           $return = $this->array_total_a_tglmasuk;
       }
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@rekapitulasi_ri@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function buildChart()
   {
       ...
       $this->comp_chart_config = array(
           '0|1' => array(
               ...
               'label_x'  => $this->getChartText(strip_tags($Lab_b_tglkeluar)),
           ...
           '1|1' => array(
               ...
               'field_x'  => 'a.tglMasuk',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_a_tglmasuk)),
               'label_y'  => $this->getChartText(strip_tags("" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . "")),
               'format'   => $this->formatChartValue(1),
           ),
           'T|1' => array(
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['pivot_charts']    = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['pivot_orig']      = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['comb_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['comb_table_def']  = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['anlt_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['anlt_table_def']  = array();
	...
	function filterChartsByGroupbyLevel() {
		...
		if (isset($nmgp_opcao) && ('pdf' == $nmgp_opcao || 'pdf_res' == $nmgp_opcao) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['chart_level']) && '' !== $_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['chart_level']) {
			$applyFilter = true;
		}
		elseif (isset($nmgp_opcao) && 'image_res' == $nmgp_opcao && isset($_POST['chart_level']) && '' !== $_POST['chart_level']) {
			$applyFilter = true;
			$_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['chart_level'] = $_POST['chart_level'];
		}
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['pivot_charts'] = $_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['pivot_orig'];

		if ($applyFilter) {
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['pivot_charts'] as $chartIndex => $chartData) {
				...
				if ($groupbyLevel > $_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['chart_level']) {
					unset($_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['pivot_charts'][$chartIndex]);
				}
			}
		}

		$this->comp_chart_data = $_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['pivot_charts'];
	}
           ...
           foreach ($a_totals as $i_total => $values)
           {
               ...
               if (isset($this->comp_chart_config[$key_config]))
               {
                   ...
                   foreach ($a_keys as $tmp_key)
                   {
                       ...
                       $xml_links[]  = $this->getFusionLink('sc_rekapitulasi_ri_' . session_id() . '_!!!' . implode('_', array_merge(array($group + 1, $i_total), $link_index)) . '!!!.json');
                   }
                   ...
                   $this->comp_chart_data[$key_data]['xml']        = $this->getFusionLink('sc_rekapitulasi_ri_' . session_id() . '_!!!' . implode('_', array_merge(array($group, $i_total), $param)) . '!!!.json');
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
   ...
   function drawMatrixLabels()
   {
       ...
       $apl_cab_resumo = "Tgl Masuk x Tgl Keluar";
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['proc_pdf_vert']){ 
   ...
   {
       if (!$res_chart && $this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['json_use_format']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['json_use_format'])
       {
           return $valor_campo;
       }
   ...
   function resumo_init()
   {
      ...
      {
         $this->monta_html_ini();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function inicializa_vars()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         require_once($this->Ini->path_aplicacao . "rekapitulasi_ri_total.class.php"); 
      }
      ...
      $this->Total   = new rekapitulasi_ri_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      $this->Total->Calc_resumo_byDate("res");
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['arr_total'][$cmp_gb];
      }
      ksort($this->array_total_b_tglkeluar);
      ksort($this->array_total_a_tglmasuk);
      if ("out" == $this->NM_tipo)
      {
         $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['SC_Ind_Groupby'];
         $this->Total->$Gb_geral();
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['dashboard_refresh_after_chart'] = 'resumo';
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['doc_word'])
{
   ...
   { 
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_rekapitulasi_ri_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_rekapitulasi_ri_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_rekapitulasi_ri_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['num_css'] . '.css');
...
$nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "rekapitulasi_ri/rekapitulasi_ri_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\">\r\n");
           ...
           $nm_saida->saida("     }\r\n");
           $nm_saida->saida("   </script>\r\n");
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['ajax_nav'] && !$this->Ini->sc_export_ajax && !$this->Ini->Export_html_zip && !$_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['doc_word'])
      {
           $nm_saida->saida("   <script type=\"text/javascript\"> \r\n");
          ...
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['grid_pesq']))
          { 
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['doc_word']) 
      {
      ...
      {
          $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['dashboard_info']['remove_margin'] ? ' style="margin: 0"' : '';
          $nm_saida->saida(" <BODY class=\"" . $this->css_scGridPage . "\"" . $remove_margin . ">\r\n");
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['embutida'])
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top_normal()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['pdf'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "Rpdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "rekapitulasi_ri/rekapitulasi_ri_config_pdf.php?nm_opc=pdf_res&nm_target=0&nm_cor=cor&papel=8&orientacao=1&bookmarks=1&largura=1200&conf_larg=S&conf_fonte=10&grafico=S&sc_ver_93=" . s . "&nm_tem_gb=s&nm_res_cons=s&nm_ini_pdf_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&summary_export_columns=S&nm_label_group=N&nm_all_cab=S&nm_all_label=S&pdf_zip=N&nm_orient_grid=2&origem=res&language=id&conf_socor=N&script_case_init=" . $this->Ini->sc_page . "&app_name=rekapitulasi_ri&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['word'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "Rword_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "rekapitulasi_ri/rekapitulasi_ri_config_word.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_cor=CO&nm_res_cons=s&nm_ini_word_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&origem=res&language=id&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['xls'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bexcel", "", "", "Rxls_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "rekapitulasi_ri/rekapitulasi_ri_config_xls.php?script_case_init=" . $this->Ini->sc_page . "&app_name=rekapitulasi_ri&nm_tp_xls=xlsx&nm_tot_xls=N&nm_tot_xls=N&nm_res_cons=s&nm_ini_xls_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&summary_export_columns=S&origem=res&language=&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['xml'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bxml", "", "", "Rxml_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "rekapitulasi_ri/rekapitulasi_ri_config_xml.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=s&nm_ini_xml_res=grid,resume,chart&nm_all_modules=grid,resume,chart&nm_xml_tag=tag&nm_xml_label=S&language=&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "rekapitulasi_ri/rekapitulasi_ri_config_print.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_opc=resumo&nm_cor=CO&nm_res_cons=s&nm_ini_prt_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&origem=res&language=id&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      {
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bconf_graf", "", "", "Rgraf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "rekapitulasi_ri/rekapitulasi_ri_config_graf_flash.php?nome_apl=rekapitulasi_ri&campo_apl=nm_resumo_graf&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=id&tp_apl=cns_htm&KeepThis=true&TB_iframe=true&height=450&width=400&modal=true", "", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
      }
      ...
      if ($this->nmgp_botoes['chart_detail'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("rekapitulasi_ri_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
   ...
   function monta_html_fim()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['print_all'])
      {
          $this->grafico_pdf();
      }
      $nm_saida->saida("</TABLE>\r\n");
      $nm_saida->saida("<link rel=\"stylesheet\" type=\"text/css\" href=\"../_lib/css/" . $this->Ini->str_schema_all . "_sweetalert.css\" />\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['rekapitulasi_ri']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['rekapitulasi_ri']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'rekapitulasi_ri_config_pivot.php?nome_apl=rekapitulasi_ri&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=id&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_rekapitulasi_ri_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "rekapitulasi_ri/rekapitulasi_ri_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
           $tp_quebra .= "<div style=\"height:1px;overflow:hidden\"><H1 style=\"font-size:0;padding:1px\">Tgl Masuk x Tgl Keluar</H1></div>";
       }
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['rekapitulasi_ri']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
...
//--- 
   ...
   //---- 
   function adiciona_registro($quebra_b_tglkeluar, $quebra_a_tglmasuk, $quebra_b_tglkeluar_orig, $quebra_a_tglmasuk_orig)
   {
      //----- " . $this->Ini->Nm_lang['lang_othr_cons_title_YYYYMMDD2'] . "
      if (!isset($this->array_total_b_tglkeluar[$quebra_b_tglkeluar_orig]))
      {
         $this->array_total_b_tglkeluar[$quebra_b_tglkeluar_orig][0] = 1;
         $this->array_total_b_tglkeluar[$quebra_b_tglkeluar_orig][1] = 1;
         $this->array_total_b_tglkeluar[$quebra_b_tglkeluar_orig][2] = $quebra_b_tglkeluar;
         $this->array_total_b_tglkeluar[$quebra_b_tglkeluar_orig][3] = $quebra_b_tglkeluar_orig;
      }
      else
      {
         $this->array_total_b_tglkeluar[$quebra_b_tglkeluar_orig][0]++;
         $this->array_total_b_tglkeluar[$quebra_b_tglkeluar_orig][2]++;
      }
      //----- " . $this->Ini->Nm_lang['lang_othr_cons_title_YYYYMMDD2'] . "
      if (!isset($this->array_total_a_tglmasuk[$quebra_b_tglkeluar_orig][$quebra_a_tglmasuk_orig]))
      {
         $this->array_total_a_tglmasuk[$quebra_b_tglkeluar_orig][$quebra_a_tglmasuk_orig][0] = 1;
         $this->array_total_a_tglmasuk[$quebra_b_tglkeluar_orig][$quebra_a_tglmasuk_orig][1] = 1;
         $this->array_total_a_tglmasuk[$quebra_b_tglkeluar_orig][$quebra_a_tglmasuk_orig][2] = $quebra_a_tglmasuk;
         $this->array_total_a_tglmasuk[$quebra_b_tglkeluar_orig][$quebra_a_tglmasuk_orig][3] = $quebra_a_tglmasuk_orig;
      }
      else
      {
         $this->array_total_a_tglmasuk[$quebra_b_tglkeluar_orig][$quebra_a_tglmasuk_orig][0]++;
         $this->array_total_a_tglmasuk[$quebra_b_tglkeluar_orig][$quebra_a_tglmasuk_orig][2]++;
      }
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('', 'b_tglkeluar');
     $campos_order = $this->Ini->Get_date_order_groupby("b.tglKeluar", 'asc', $format, $campos_order);
     $format       = $this->Ini->Get_Gb_date_format('', 'a_tglmasuk');
     $campos_order = $this->Ini->Get_date_order_groupby("a.tglMasuk", 'asc', $format, $campos_order);
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->a_trancode = $rs_res->fields[0] ;  
            $this->a_custcode = $rs_res->fields[1] ;  
            $this->nama = $rs_res->fields[2] ;  
            $this->tl = $rs_res->fields[3] ;  
            $this->a_kelas = $rs_res->fields[4] ;  
            $this->bed = $rs_res->fields[5] ;  
            $this->a_tglmasuk = $rs_res->fields[6] ;  
            $this->b_tglkeluar = $rs_res->fields[7] ;  
...
$_SESSION['scriptcase']['rekapitulasi_ri']['contr_erro'] = 'off'; 
            ...
            $this->b_tglkeluar_orig = $this->Ini->Get_arg_groupby($TP_Time . $this->b_tglkeluar, $Format_tst);
            $this->b_tglkeluar = $this->Ini->GB_date_format($TP_Time . $this->b_tglkeluar, $Format_tst, $Prefix_dat);
            ...
            $this->a_tglmasuk_orig = $this->Ini->Get_arg_groupby($TP_Time . $this->a_tglmasuk, $Format_tst);
            $this->a_tglmasuk = $this->Ini->GB_date_format($TP_Time . $this->a_tglmasuk, $Format_tst, $Prefix_dat);
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->b_tglkeluar, $this->a_tglmasuk, $this->b_tglkeluar_orig,  $this->a_tglmasuk_orig);
            }
   }
//
