...
<?php
   ...
   $Ord_Cmp = new rekapitulasi_ri_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class rekapitulasi_ri_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['rekapitulasi_ri']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['rekapitulasi_ri']['ordem_select_orig'] = array();
   }
   ...
   if ($use_alias == "S")
   {
       $tab_def_campos['a_trancode'] = "a_trancode";
   }
   else
   {
       $tab_def_campos['a_trancode'] = "a.tranCode";
   }
   $tab_labels["a_trancode"]   = (isset($_SESSION['sc_session'][$sc_init]['rekapitulasi_ri']['labels']["a_trancode"])) ? $_SESSION['sc_session'][$sc_init]['rekapitulasi_ri']['labels']["a_trancode"] : "Kode Transaksi";
   $tab_ger_campos['a_custcode'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['a_custcode'] = "a_custcode";
   }
   else
   {
       $tab_def_campos['a_custcode'] = "a.custCode";
   }
   $tab_labels["a_custcode"]   = (isset($_SESSION['sc_session'][$sc_init]['rekapitulasi_ri']['labels']["a_custcode"])) ? $_SESSION['sc_session'][$sc_init]['rekapitulasi_ri']['labels']["a_custcode"] : "No RM";
   ...
   $tab_labels["nama"]   = (isset($_SESSION['sc_session'][$sc_init]['rekapitulasi_ri']['labels']["nama"])) ? $_SESSION['sc_session'][$sc_init]['rekapitulasi_ri']['labels']["nama"] : "Nama Pasien";
   ...
   {
       $tab_def_campos['tl'] = "date(c.birthDate)";
   }
   $tab_labels["tl"]   = (isset($_SESSION['sc_session'][$sc_init]['rekapitulasi_ri']['labels']["tl"])) ? $_SESSION['sc_session'][$sc_init]['rekapitulasi_ri']['labels']["tl"] : "Tgl. Lahir";
   ...
   $tab_labels["usia"]   = (isset($_SESSION['sc_session'][$sc_init]['rekapitulasi_ri']['labels']["usia"])) ? $_SESSION['sc_session'][$sc_init]['rekapitulasi_ri']['labels']["usia"] : "Usia";
   $tab_ger_campos['a_kelas'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['a_kelas'] = "a_kelas";
   }
   else
   {
       $tab_def_campos['a_kelas'] = "a.kelas";
   }
   $tab_labels["a_kelas"]   = (isset($_SESSION['sc_session'][$sc_init]['rekapitulasi_ri']['labels']["a_kelas"])) ? $_SESSION['sc_session'][$sc_init]['rekapitulasi_ri']['labels']["a_kelas"] : "Kelas Bayar";
   ...
   {
       $tab_def_campos['bed'] = "concat(d.kelas,' - ',d.ruang,' (Bed ',d.noBed,')')";
   }
   $tab_labels["bed"]   = (isset($_SESSION['sc_session'][$sc_init]['rekapitulasi_ri']['labels']["bed"])) ? $_SESSION['sc_session'][$sc_init]['rekapitulasi_ri']['labels']["bed"] : "Bed";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['rekapitulasi_ri']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['rekapitulasi_ri']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['rekapitulasi_ri']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['rekapitulasi_ri']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['rekapitulasi_ri']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['rekapitulasi_ri']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['rekapitulasi_ri']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['rekapitulasi_ri']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['rekapitulasi_ri']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "rekapitulasi_ri_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['rekapitulasi_ri']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['rekapitulasi_ri']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['rekapitulasi_ri']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['rekapitulasi_ri']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['rekapitulasi_ri']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
