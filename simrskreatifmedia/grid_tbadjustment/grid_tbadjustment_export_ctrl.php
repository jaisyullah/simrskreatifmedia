<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tbadjustment']['sc_process_barr'] = true;
require_once('../grid_tbadjustment/index.php');
unset($_SESSION['scriptcase']['grid_tbadjustment']['sc_process_barr']);
$ExportCtrl = new grid_tbadjustment_export_control;
$ExportCtrl->Export_barr();

class grid_tbadjustment_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_title'] ?> Stock Adjustment :: Excel</TITLE>
