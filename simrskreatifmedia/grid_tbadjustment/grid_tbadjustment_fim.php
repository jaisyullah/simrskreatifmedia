...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_tbadjustment"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____grid_tbadjustment"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_tbadjustment'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tbadjustment']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_tbadjustment']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tbadjustment']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_tbadjustment']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_tbadjustment']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_tbadjustment']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_tbadjustment']['embutida_filho'] as $ind => $sc_init)
          {
