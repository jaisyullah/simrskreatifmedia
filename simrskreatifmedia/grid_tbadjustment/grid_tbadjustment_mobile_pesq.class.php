...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "tranDate";$Nm_datas[] = "tranDate";$Nm_numeric[] = "id";$Nm_numeric[] = "jenisadj";$Nm_numeric[] = "status";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_adjcode_cond" name="adjcode_cond" onChange="nm_campos_between(document.getElementById('id_vis_adjcode'), this, 'adjcode')">
      ...
      <br><span id="id_hide_adjcode"  <?php echo $str_hide_adjcode?>><?php
      if ($adjcode != "")
      {
      $adjcode_look = substr($this->Db->qstr($adjcode), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_depo_cond" name="depo_cond" onChange="nm_campos_between(document.getElementById('id_vis_depo'), this, 'depo')">
      ...
      <br><span id="id_hide_depo"  <?php echo $str_hide_depo?>><?php
      if ($depo != "")
      {
      $depo_look = substr($this->Db->qstr($depo), 1, -1); 
      $nmgp_def_dados = array(); 
