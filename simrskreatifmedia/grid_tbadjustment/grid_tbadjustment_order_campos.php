...
<?php
   ...
   $Ord_Cmp = new grid_tbadjustment_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_tbadjustment_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbadjustment']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tbadjustment']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['adjcode'] = "adjCode";
   $tab_labels["adjcode"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbadjustment']['labels']["adjcode"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbadjustment']['labels']["adjcode"] : "Kode Transaksi";
   $tab_ger_campos['trandate'] = "on";
   $tab_def_campos['trandate'] = "tranDate";
   $tab_labels["trandate"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbadjustment']['labels']["trandate"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbadjustment']['labels']["trandate"] : "Tgl. Transaksi";
   $tab_ger_campos['depo'] = "on";
   $tab_def_campos['depo'] = "depo";
   $tab_labels["depo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbadjustment']['labels']["depo"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbadjustment']['labels']["depo"] : "Depo";
   $tab_ger_campos['jenisadj'] = "on";
   $tab_def_campos['jenisadj'] = "jenisAdj";
   $tab_labels["jenisadj"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbadjustment']['labels']["jenisadj"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbadjustment']['labels']["jenisadj"] : "Jenis";
   $tab_ger_campos['adjby'] = "on";
   $tab_def_campos['adjby'] = "adjBy";
   $tab_labels["adjby"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbadjustment']['labels']["adjby"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbadjustment']['labels']["adjby"] : "Verif";
   $tab_ger_campos['status'] = "on";
   $tab_def_campos['status'] = "status";
   $tab_labels["status"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbadjustment']['labels']["status"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbadjustment']['labels']["status"] : "Status";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_tbadjustment']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_tbadjustment']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_tbadjustment']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbadjustment']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tbadjustment']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_tbadjustment']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_tbadjustment']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_tbadjustment']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_tbadjustment']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_tbadjustment_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_tbadjustment']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_tbadjustment']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_tbadjustment']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_tbadjustment']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_tbadjustment']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
