...
<?php
   ...
   $Ord_Cmp = new grid_tbtindakan_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_tbtindakan_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbtindakan']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tbtindakan']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbtindakan']['labels']["id"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbtindakan']['labels']["id"] : "ID";
   $tab_ger_campos['jenistindakan'] = "on";
   $tab_def_campos['jenistindakan'] = "jenisTindakan";
   $tab_labels["jenistindakan"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbtindakan']['labels']["jenistindakan"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbtindakan']['labels']["jenistindakan"] : "Jenis Tindakan";
   $tab_ger_campos['kodetindakan'] = "on";
   $tab_def_campos['kodetindakan'] = "kodeTindakan";
   $tab_labels["kodetindakan"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbtindakan']['labels']["kodetindakan"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbtindakan']['labels']["kodetindakan"] : "Kode Tindakan";
   $tab_ger_campos['kategori'] = "on";
   $tab_def_campos['kategori'] = "kategori";
   $tab_labels["kategori"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbtindakan']['labels']["kategori"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbtindakan']['labels']["kategori"] : "Kategori";
   $tab_ger_campos['namatindakan'] = "on";
   $tab_def_campos['namatindakan'] = "namaTindakan";
   $tab_labels["namatindakan"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbtindakan']['labels']["namatindakan"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbtindakan']['labels']["namatindakan"] : "Nama Tindakan";
   ...
   {
       $tab_def_campos['harga'] = "SELECT
	t.tarif 
FROM
	( SELECT kodeTindakan, tarif FROM tbtarifrj UNION ALL SELECT kodeTindakan, concat( kelas, ' = ', tarif) AS tarif FROM tbtarifri ) t 
WHERE
	t.kodeTindakan = '{kodeTindakan}'";
   }
   $tab_labels["harga"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbtindakan']['labels']["harga"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbtindakan']['labels']["harga"] : "Harga";
   $tab_ger_campos['harga'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_tbtindakan']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_tbtindakan']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_tbtindakan']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbtindakan']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tbtindakan']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_tbtindakan']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_tbtindakan']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_tbtindakan']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_tbtindakan']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_tbtindakan_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_tbtindakan']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_tbtindakan']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_tbtindakan']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_tbtindakan']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_tbtindakan']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
