...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_jenistindakan_cond" name="jenistindakan_cond" onChange="nm_campos_between(document.getElementById('id_vis_jenistindakan'), this, 'jenistindakan')">
      ...
      <br><span id="id_hide_jenistindakan"  <?php echo $str_hide_jenistindakan?>><?php
      if ($jenistindakan != "")
      {
      $jenistindakan_look = substr($this->Db->qstr($jenistindakan), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_kodetindakan_cond" name="kodetindakan_cond" onChange="nm_campos_between(document.getElementById('id_vis_kodetindakan'), this, 'kodetindakan')">
