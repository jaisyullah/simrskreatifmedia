<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tbtindakan']['sc_process_barr'] = true;
require_once('../grid_tbtindakan/index.php');
unset($_SESSION['scriptcase']['grid_tbtindakan']['sc_process_barr']);
$ExportCtrl = new grid_tbtindakan_export_control;
$ExportCtrl->Export_barr();

class grid_tbtindakan_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - Tindakan Medis :: Excel</TITLE>
