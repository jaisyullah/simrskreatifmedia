...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "tgl";$Nm_datas[] = "tgl";$Nm_numeric[] = "id";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_pengeluarancode_cond" name="pengeluarancode_cond" onChange="nm_campos_between(document.getElementById('id_vis_pengeluarancode'), this, 'pengeluarancode')">
      ...
      <br><span id="id_hide_pengeluarancode"  <?php echo $str_hide_pengeluarancode?>><?php
      if ($pengeluarancode != "")
      {
      $pengeluarancode_look = substr($this->Db->qstr($pengeluarancode), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_tgl_cond" name="tgl_cond" onChange="nm_campos_between(document.getElementById('id_vis_tgl'), this, 'tgl')">
...
?>
 ...
 <?php echo $date_format_show ?>         </SPAN>
                  <br />
        <SPAN id="id_vis_tgl"  <?php echo $str_display_tgl; ?> class="scFilterFieldFontEven">
