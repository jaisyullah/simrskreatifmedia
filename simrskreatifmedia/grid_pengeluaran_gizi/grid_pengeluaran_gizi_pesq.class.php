...
class grid_pengeluaran_gizi_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengeluaran_gizi']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_pengeluaran_gizi_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_pengeluaran_gizi_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_pengeluaran_gizi_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_pengeluarancode')
      {
          $pengeluarancode = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_pengeluarancode($pengeluarancode);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function lookup_ajax_pengeluarancode($pengeluarancode)
   {
      $pengeluarancode = substr($this->Db->qstr($pengeluarancode), 1, -1);
            $pengeluarancode_look = substr($this->Db->qstr($pengeluarancode), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct pengeluarancode from " . $this->Ini->nm_tabela . " where  pengeluarancode like '%" . $pengeluarancode . "%' order by pengeluarancode"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengeluaran_gizi']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengeluaran_gizi']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         $nome_sum = "pengeluaran_gizi.$nome";
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengeluaran_gizi']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengeluaran_gizi']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengeluaran_gizi']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengeluaran_gizi']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengeluaran_gizi']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengeluaran_gizi']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengeluaran_gizi']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengeluaran_gizi']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengeluaran_gizi']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengeluaran_gizi']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengeluaran_gizi']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengeluaran_gizi']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengeluaran_gizi']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengeluaran_gizi']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengeluaran_gizi']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - pengeluaran_gizi</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_pengeluaran_gizi/grid_pengeluaran_gizi_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_pengeluaran_gizi_ajax_search.js"></script>
 <script type="text/javascript" src="grid_pengeluaran_gizi_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_pengeluaran_gizi_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_pengeluaran_gizi']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_pengeluaran_gizi']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_pengeluarancode_cond#NMF#' + search_get_sel_txt('SC_pengeluarancode_cond') + '@NMF@';
  str_out += 'SC_pengeluarancode#NMF#' + search_get_text('SC_pengeluarancode') + '@NMF@';
  str_out += 'id_ac_pengeluarancode#NMF#' + search_get_text('id_ac_pengeluarancode') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
   $("#id_ac_pengeluarancode").autocomplete({
     minLength: 1,
     ...
     $.ajax({
       ...
       data: {
          ...
          nmgp_parms: "NM_ajax_opcao?#?autocomp_pengeluarancode",
          max_itens: "10",
          cod_desc: "N",
     ...
     select: function (event, ui) {
       $("#SC_pengeluarancode").val(ui.item.value);
     ...
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_pengeluarancode").val( $(this).val() );
       }
     }
   });
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengeluaran_gizi']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div class="scFilterHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFilterHeaderFont" style="float: left; text-transform: uppercase;"><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - pengeluaran_gizi</div>
...
<?php
   ...
   function monta_form()
   {
      global 
             ...
             $pengeluarancode_cond, $pengeluarancode, $pengeluarancode_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengeluaran_gizi']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengeluaran_gizi']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengeluaran_gizi']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengeluaran_gizi']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $status = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengeluaran_gizi']['campos_busca']['status']; 
          $status_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengeluaran_gizi']['campos_busca']['status_cond']; 
          $id = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengeluaran_gizi']['campos_busca']['id']; 
          $id_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengeluaran_gizi']['campos_busca']['id_cond']; 
          $pengeluarancode = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengeluaran_gizi']['campos_busca']['pengeluarancode']; 
          $pengeluarancode_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengeluaran_gizi']['campos_busca']['pengeluarancode_cond']; 
          $tgl_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengeluaran_gizi']['campos_busca']['tgl_dia']; 
          $tgl_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengeluaran_gizi']['campos_busca']['tgl_mes']; 
          $tgl_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengeluaran_gizi']['campos_busca']['tgl_ano']; 
          $tgl_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengeluaran_gizi']['campos_busca']['tgl_input_2_dia']; 
          $tgl_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengeluaran_gizi']['campos_busca']['tgl_input_2_mes']; 
          $tgl_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengeluaran_gizi']['campos_busca']['tgl_input_2_ano']; 
          $tgl_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengeluaran_gizi']['campos_busca']['tgl_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengeluaran_gizi']['campos_busca']['NM_operador']; 
      } 
      ...
      if (!isset($pengeluarancode_cond) || empty($pengeluarancode_cond))
      {
         $pengeluarancode_cond = "qp";
      }
      ...
      $str_hide_pengeluarancode = (in_array($pengeluarancode_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      $str_display_pengeluarancode = ('bw' == $pengeluarancode_cond) ? $display_aberto : $display_fechado;
      ...
      if (!isset($pengeluarancode) || $pengeluarancode == "")
      {
          $pengeluarancode = "";
      }
      if (isset($pengeluarancode) && !empty($pengeluarancode))
      {
         $tmp_pos = strpos($pengeluarancode, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $pengeluarancode = substr($pengeluarancode, 0, $tmp_pos);
         }
      }
      if (!isset($tgl) || $tgl == "")
      {
   ...
   <tr>
     ...
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_status_cond" name="status_cond" onChange="nm_campos_between(document.getElementById('id_vis_status'), this, 'status')">
       ...
       <OPTION value="np" <?php if ("np" == $status_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $status_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $status_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
...
?>
<INPUT  type="text" id="SC_status" name="status" value="<?php echo NM_encode_input($status) ?>"  size=15 alt="{datatype: 'text', maxLength: 15, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_status" name="status_autocomp" size="15"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 15, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_id" name="id_autocomp" size="5"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 5, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
      ...
      <TD id='SC_pengeluarancode_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['pengeluarancode'])) ? $this->New_label['pengeluarancode'] : "Pengeluarancode"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_pengeluarancode_cond" name="pengeluarancode_cond" onChange="nm_campos_between(document.getElementById('id_vis_pengeluarancode'), this, 'pengeluarancode')">
       <OPTION value="qp" <?php if ("qp" == $pengeluarancode_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $pengeluarancode_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $pengeluarancode_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $pengeluarancode_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_pengeluarancode" <?php echo $str_hide_pengeluarancode?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['pengeluarancode'])) ? $this->New_label['pengeluarancode'] : "Pengeluarancode";
 $nmgp_tab_label .= "pengeluarancode?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      $pengeluarancode_look = substr($this->Db->qstr($pengeluarancode), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct pengeluarancode from " . $this->Ini->nm_tabela . " where pengeluarancode = '$pengeluarancode_look' order by pengeluarancode"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      if (isset($nmgp_def_dados[0][$pengeluarancode]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$pengeluarancode];
      }
      else
      {
          $sAutocompValue = $pengeluarancode;
      }
?>
<INPUT  type="text" id="SC_pengeluarancode" name="pengeluarancode" value="<?php echo NM_encode_input($pengeluarancode) ?>"  size=15 alt="{datatype: 'text', maxLength: 15, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_pengeluarancode" name="pengeluarancode_autocomp" size="15"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 15, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_tgl_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['tgl'])) ? $this->New_label['tgl'] : "Tgl"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_tgl_cond" name="tgl_cond" onChange="nm_campos_between(document.getElementById('id_vis_tgl'), this, 'tgl')">
...
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_tgl_dia" name="tgl_dia" value="<?php echo NM_encode_input($tgl_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_tgl_mes" name="tgl_mes" value="<?php echo NM_encode_input($tgl_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_tgl_ano" name="tgl_ano" value="<?php echo NM_encode_input($tgl_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 </span>
...
?>
        <SPAN id="id_css_tgl"  class="scFilterFieldFontEven">
 <?php echo $date_format_show ?>         </SPAN>
                 </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_tgl"  <?php echo $str_display_tgl; ?> class="scFilterFieldFontEven">
...
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_tgl_input_2_dia" name="tgl_input_2_dia" value="<?php echo NM_encode_input($tgl_input_2_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_tgl_input_2_mes" name="tgl_input_2_mes" value="<?php echo NM_encode_input($tgl_input_2_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_tgl_input_2_ano" name="tgl_input_2_ano" value="<?php echo NM_encode_input($tgl_input_2_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 </span>
...
?>
<?php
   if (is_file("grid_pengeluaran_gizi_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_pengeluaran_gizi']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_pengeluaran_gizi']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengeluaran_gizi']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.status_cond.value = 'qp';
   ...
   document.F1.pengeluarancode_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_pengeluarancode'), document.F1.pengeluarancode_cond, 'pengeluarancode');
   document.F1.pengeluarancode.value = "";
   document.F1.pengeluarancode_autocomp.value = "";
 ...
 {
    $('#SC_tgl_dia').bind('change', function() {sc_grid_pengeluaran_gizi_valida_dia(this)});
    $('#SC_tgl_input_2_dia').bind('change', function() {sc_grid_pengeluaran_gizi_valida_dia(this)});
    $('#SC_tgl_input_2_mes').bind('change', function() {sc_grid_pengeluaran_gizi_valida_mes(this)});
    $('#SC_tgl_mes').bind('change', function() {sc_grid_pengeluaran_gizi_valida_mes(this)});
 }
 function sc_grid_pengeluaran_gizi_valida_dia(obj)
 {
 ...
 function sc_grid_pengeluaran_gizi_valida_mes(obj)
 {
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "simrskreatifmedia/grid_pengeluaran_gizi";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengeluaran_gizi']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengeluaran_gizi']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengeluaran_gizi']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro($nmgp_save_origem)
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "grid_pengeluaran_gizi/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_pengeluarancode_cond'] = 'cond';
      $tp_fields['SC_pengeluarancode'] = 'text_aut';
      $tp_fields['id_ac_pengeluarancode'] = 'text_aut';
   ...
   {
      global $status_cond, $status, $status_autocomp,
             $id_cond, $id, $id_autocomp,
             $pengeluarancode_cond, $pengeluarancode, $pengeluarancode_autocomp,
             $tgl_cond, $tgl, $tgl_dia, $tgl_mes, $tgl_ano, $tgl_input_2_dia, $tgl_input_2_mes, $tgl_input_2_ano, $nmgp_tab_label;
      ...
      if (!empty($pengeluarancode_autocomp) && empty($pengeluarancode))
      {
          $pengeluarancode = $pengeluarancode_autocomp;
      }
      ...
      $pengeluarancode_cond_salva = $pengeluarancode_cond; 
      if (!isset($pengeluarancode_input_2) || $pengeluarancode_input_2 == "")
      {
          $pengeluarancode_input_2 = $pengeluarancode;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengeluaran_gizi']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengeluaran_gizi']['campos_busca']['status'] = $status; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengeluaran_gizi']['campos_busca']['status_cond'] = $status_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengeluaran_gizi']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengeluaran_gizi']['campos_busca']['id'] = $id; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengeluaran_gizi']['campos_busca']['id_cond'] = $id_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengeluaran_gizi']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengeluaran_gizi']['campos_busca']['pengeluarancode'] = $pengeluarancode; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengeluaran_gizi']['campos_busca']['pengeluarancode_cond'] = $pengeluarancode_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengeluaran_gizi']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengeluaran_gizi']['campos_busca']['tgl_dia'] = $tgl_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengeluaran_gizi']['campos_busca']['tgl_mes'] = $tgl_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengeluaran_gizi']['campos_busca']['tgl_ano'] = $tgl_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengeluaran_gizi']['campos_busca']['tgl_input_2_dia'] = $tgl_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengeluaran_gizi']['campos_busca']['tgl_input_2_mes'] = $tgl_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengeluaran_gizi']['campos_busca']['tgl_input_2_ano'] = $tgl_input_2_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengeluaran_gizi']['campos_busca']['tgl_cond'] = $tgl_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengeluaran_gizi']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengeluaran_gizi']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengeluaran_gizi']['campos_busca'] = $Temp_Busca;
      }
   ...
   { 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['pengeluarancode'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['pengeluarancode'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['pengeluarancode'] = $pengeluarancode;
      }
      ...
      //----- $pengeluarancode
      $this->Date_part = false;
      if (isset($pengeluarancode) || $pengeluarancode_cond == "nu" || $pengeluarancode_cond == "nn" || $pengeluarancode_cond == "ep" || $pengeluarancode_cond == "ne")
      {
         $this->monta_condicao("pengeluarancode", $pengeluarancode_cond, $pengeluarancode, "", "pengeluarancode");
      }
      ...
      if ($tgl_cond != "bi_TP")
      {
          ...
          {
              $this->nm_prep_date($val, "DT", "DATE", $tgl_cond, "", "data");
          }
          if (!$this->Date_part) {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengeluaran_gizi']['campos_busca']['tgl'] = $val[0];
          $this->nm_data->SetaData($this->cmp_formatado['tgl'], "YYYY-MM-DD");
          $this->cmp_formatado['tgl'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DT", "dmY"));
          if ($tgl_cond == "BW")
          {
              if (!$this->Date_part) {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengeluaran_gizi']['campos_busca']['tgl_input_2'] = $val[1];
              $this->nm_data->SetaData($this->cmp_formatado['tgl_input_2'], "YYYY-MM-DD");
              $this->cmp_formatado['tgl_input_2'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DT", "dmY"));
          }
          if (!empty($Dtxt) || $tgl_cond == "NU" || $tgl_cond == "NN"|| $tgl_cond == "EP"|| $tgl_cond == "NE")
          {
              $this->monta_condicao("tgl", $tgl_cond, $tgl, $tgl_input_2, 'tgl', 'DATE');
          }
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengeluaran_gizi']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengeluaran_gizi']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengeluaran_gizi']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengeluaran_gizi']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengeluaran_gizi']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengeluaran_gizi']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengeluaran_gizi']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengeluaran_gizi']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pengeluaran_gizi']['cond_pesq'] .= $this->NM_operador;
