...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____fast_slow_moving"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____fast_slow_moving"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['fast_slow_moving']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['fast_slow_moving']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['fast_slow_moving']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['fast_slow_moving']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['fast_slow_moving']['sc_modal']);
           if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['fast_slow_moving']['opc_psq']))
           {
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['fast_slow_moving']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['fast_slow_moving']['embutida_filho'] as $ind => $sc_init)
          {
