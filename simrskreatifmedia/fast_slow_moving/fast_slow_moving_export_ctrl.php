<?php
@session_start() ;
$_SESSION['scriptcase']['fast_slow_moving']['sc_process_barr'] = true;
require_once('../fast_slow_moving/index.php');
unset($_SESSION['scriptcase']['fast_slow_moving']['sc_process_barr']);
$ExportCtrl = new fast_slow_moving_export_control;
$ExportCtrl->Export_barr();

class fast_slow_moving_export_control
{
