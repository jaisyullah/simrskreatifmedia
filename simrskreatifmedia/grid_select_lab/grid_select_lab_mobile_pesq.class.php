...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "trandate";$Nm_datas[] = "trandate";$Nm_datas[] = "enterdate";$Nm_datas[] = "enterdate";$Nm_datas[] = "finishdate";$Nm_datas[] = "finishdate";$Nm_datas[] = "takendate";$Nm_datas[] = "takendate";$Nm_datas[] = "proyeksidate";$Nm_datas[] = "proyeksidate";$Nm_numeric[] = "source";$Nm_numeric[] = "status";$Nm_numeric[] = "deleted";$Nm_numeric[] = "penjamin";$Nm_numeric[] = "pasien";$Nm_numeric[] = "ageyear";$Nm_numeric[] = "agemonth";$Nm_numeric[] = "ageday";$Nm_numeric[] = "ispl";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_inapcode_cond" name="inapcode_cond" onChange="nm_campos_between(document.getElementById('id_vis_inapcode'), this, 'inapcode')">
      ...
      <br><span id="id_hide_inapcode"  <?php echo $str_hide_inapcode?>><?php
      if ($inapcode != "")
      {
      $inapcode_look = substr($this->Db->qstr($inapcode), 1, -1); 
      $nmgp_def_dados = array(); 
