<?php
@session_start() ;
$_SESSION['scriptcase']['grid_select_lab']['sc_process_barr'] = true;
require_once('../grid_select_lab/index.php');
unset($_SESSION['scriptcase']['grid_select_lab']['sc_process_barr']);
$ExportCtrl = new grid_select_lab_export_control;
$ExportCtrl->Export_barr();

class grid_select_lab_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_title'] ?> Transaksi Lab :: Excel</TITLE>
