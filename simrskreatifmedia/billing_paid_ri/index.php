<?php
   include_once('billing_paid_ri_session.php');
   @session_start() ;
   $_SESSION['scriptcase']['billing_paid_ri']['glo_nm_perfil']          = "conn_mysql";
   $_SESSION['scriptcase']['billing_paid_ri']['glo_nm_path_prod']       = "";
   $_SESSION['scriptcase']['billing_paid_ri']['glo_nm_path_conf']       = "";
   $_SESSION['scriptcase']['billing_paid_ri']['glo_nm_path_imagens']    = "";
   $_SESSION['scriptcase']['billing_paid_ri']['glo_nm_path_imag_temp']  = "";
   $_SESSION['scriptcase']['billing_paid_ri']['glo_nm_path_doc']        = "";
    ...
    //check prod
    if(empty($_SESSION['scriptcase']['billing_paid_ri']['glo_nm_path_prod']))
    {
            /*check prod*/$_SESSION['scriptcase']['billing_paid_ri']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
    }
    //check img
    if(empty($_SESSION['scriptcase']['billing_paid_ri']['glo_nm_path_imagens']))
    {
            /*check img*/$_SESSION['scriptcase']['billing_paid_ri']['glo_nm_path_imagens'] = $str_path_apl_url . "_lib/file/img";
    }
    //check tmp
    if(empty($_SESSION['scriptcase']['billing_paid_ri']['glo_nm_path_imag_temp']))
    {
            /*check tmp*/$_SESSION['scriptcase']['billing_paid_ri']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
    }
    //check doc
    if(empty($_SESSION['scriptcase']['billing_paid_ri']['glo_nm_path_doc']))
    {
            /*check doc*/$_SESSION['scriptcase']['billing_paid_ri']['glo_nm_path_doc'] = $str_path_apl_dir . "_lib/file/doc";
    }
    //end check publication with the prod
//
class billing_paid_ri_ini
{
   var $nm_cod_apl;
   var $nm_nome_apl;
   var $nm_seguranca;
...
//
   function init($Tp_init = "")
   {
      ...
      $_SESSION['sc_session'][$this->sc_page]['billing_paid_ri']['decimal_db'] = "."; 
      $this->nm_cod_apl      = "billing_paid_ri"; 
      $this->nm_nome_apl     = ""; 
      $this->nm_seguranca    = ""; 
...
// 
      ...
      $this->sc_protocolo    = "";
      $this->path_prod       = $_SESSION['scriptcase']['billing_paid_ri']['glo_nm_path_prod'];
      $this->path_conf       = $_SESSION['scriptcase']['billing_paid_ri']['glo_nm_path_conf'];
      $this->path_imagens    = $_SESSION['scriptcase']['billing_paid_ri']['glo_nm_path_imagens'];
      $this->path_imag_temp  = $_SESSION['scriptcase']['billing_paid_ri']['glo_nm_path_imag_temp'];
      $this->path_doc        = $_SESSION['scriptcase']['billing_paid_ri']['glo_nm_path_doc'];
      ...
      $this->path_aplicacao  = substr($this->path_aplicacao, 0, strrpos($this->path_aplicacao, '/')) . '/billing_paid_ri';
      ...
      if (isset($_SESSION['scriptcase']['billing_paid_ri']['session_timeout']['lang'])) {
          $this->str_lang = $_SESSION['scriptcase']['billing_paid_ri']['session_timeout']['lang'];
      }
      elseif (!isset($_SESSION['scriptcase']['billing_paid_ri']['actual_lang']) || $_SESSION['scriptcase']['billing_paid_ri']['actual_lang'] != $this->str_lang) {
          $_SESSION['scriptcase']['billing_paid_ri']['actual_lang'] = $this->str_lang;
      ...
      {
          include_once("billing_paid_ri_json.php");
      }
      $this->SC_Link_View = (isset($_SESSION['sc_session'][$this->sc_page]['billing_paid_ri']['SC_Link_View'])) ? $_SESSION['sc_session'][$this->sc_page]['billing_paid_ri']['SC_Link_View'] : false;
      if (isset($_GET['SC_Link_View']) && !empty($_GET['SC_Link_View']) && is_numeric($_GET['SC_Link_View']))
      {
          if ($_SESSION['sc_session'][$this->sc_page]['billing_paid_ri']['embutida'])
          {
              $this->SC_Link_View = true;
              $_SESSION['sc_session'][$this->sc_page]['billing_paid_ri']['SC_Link_View'] = true;
          }
      }
      if (isset($_POST['nmgp_opcao']) && $_POST['nmgp_opcao'] == "ajax_save_ancor")
      {
          $_SESSION['sc_session'][$this->sc_page]['billing_paid_ri']['ancor_save'] = $_POST['ancor_save'];
...
<?php
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['billing_paid_ri']['dashboard_info']['under_dashboard']))
      {
          $_SESSION['sc_session'][$this->sc_page]['billing_paid_ri']['dashboard_info']['under_dashboard'] = false;
          $_SESSION['sc_session'][$this->sc_page]['billing_paid_ri']['dashboard_info']['dashboard_app']   = '';
          $_SESSION['sc_session'][$this->sc_page]['billing_paid_ri']['dashboard_info']['own_widget']      = '';
          $_SESSION['sc_session'][$this->sc_page]['billing_paid_ri']['dashboard_info']['parent_widget']   = '';
          $_SESSION['sc_session'][$this->sc_page]['billing_paid_ri']['dashboard_info']['compact_mode']    = false;
          $_SESSION['sc_session'][$this->sc_page]['billing_paid_ri']['dashboard_info']['remove_margin']   = false;
      }
      if (isset($_GET['under_dashboard']) && 1 == $_GET['under_dashboard'])
      {
          if (isset($_GET['own_widget']) && 'dbifrm_widget' == substr($_GET['own_widget'], 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['billing_paid_ri']['dashboard_info']['own_widget'] = $_GET['own_widget'];
              $_SESSION['sc_session'][$this->sc_page]['billing_paid_ri']['dashboard_info']['under_dashboard'] = true;
              if (isset($_GET['dashboard_app'])) {
                  $_SESSION['sc_session'][$this->sc_page]['billing_paid_ri']['dashboard_info']['dashboard_app'] = $_GET['dashboard_app'];
              }
              if (isset($_GET['parent_widget'])) {
                  $_SESSION['sc_session'][$this->sc_page]['billing_paid_ri']['dashboard_info']['parent_widget'] = $_GET['parent_widget'];
              }
              if (isset($_GET['compact_mode'])) {
                  $_SESSION['sc_session'][$this->sc_page]['billing_paid_ri']['dashboard_info']['compact_mode'] = 1 == $_GET['compact_mode'];
              }
              if (isset($_GET['remove_margin'])) {
                  $_SESSION['sc_session'][$this->sc_page]['billing_paid_ri']['dashboard_info']['remove_margin'] = 1 == $_GET['remove_margin'];
              }
          }
      }
      elseif (isset($under_dashboard) && 1 == $under_dashboard)
      {
          if (isset($own_widget) && 'dbifrm_widget' == substr($own_widget, 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['billing_paid_ri']['dashboard_info']['own_widget'] = $own_widget;
              $_SESSION['sc_session'][$this->sc_page]['billing_paid_ri']['dashboard_info']['under_dashboard'] = true;
              if (isset($dashboard_app)) {
                  $_SESSION['sc_session'][$this->sc_page]['billing_paid_ri']['dashboard_info']['dashboard_app'] = $dashboard_app;
              }
              if (isset($parent_widget)) {
                  $_SESSION['sc_session'][$this->sc_page]['billing_paid_ri']['dashboard_info']['parent_widget'] = $parent_widget;
              }
              if (isset($compact_mode)) {
                  $_SESSION['sc_session'][$this->sc_page]['billing_paid_ri']['dashboard_info']['compact_mode'] = 1 == $compact_mode;
              }
              if (isset($remove_margin)) {
                  $_SESSION['sc_session'][$this->sc_page]['billing_paid_ri']['dashboard_info']['remove_margin'] = 1 == $remove_margin;
              }
          }
      }
      if (!isset($_SESSION['sc_session'][$this->sc_page]['billing_paid_ri']['dashboard_info']['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['billing_paid_ri']['dashboard_info']['maximized'] = false;
      }
      if (isset($_GET['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['billing_paid_ri']['dashboard_info']['maximized'] = 1 == $_GET['maximized'];
      }
      if ($_SESSION['sc_session'][$this->sc_page]['billing_paid_ri']['dashboard_info']['under_dashboard'])
      {
          $sTmpDashboardApp = $_SESSION['sc_session'][$this->sc_page]['billing_paid_ri']['dashboard_info']['dashboard_app'];
          if ('' != $sTmpDashboardApp && isset($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["billing_paid_ri"]))
          {
              foreach ($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["billing_paid_ri"] as $sTmpTargetLink => $sTmpTargetWidget)
              {
      ...
      if (!is_file($this->root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
      {
          ...
          unset($_SESSION['scriptcase']['billing_paid_ri']['glo_nm_conexao']);
      }
      ...
      if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['billing_paid_ri']['session_timeout']['redir']))
      {
      ...
      $_SESSION['sc_session'][$this->sc_page]['billing_paid_ri']['path_doc'] = $this->path_doc; 
      ...
      if (!is_dir($this->root . $this->path_prod))
      {
          ...
          echo " </tr>";
          echo "</table>";
          if (!$_SESSION['sc_session'][$script_case_init]['billing_paid_ri']['iframe_menu'] && (!isset($_SESSION['sc_session'][$script_case_init]['billing_paid_ri']['sc_outra_jan']) || !$_SESSION['sc_session'][$script_case_init]['billing_paid_ri']['sc_outra_jan'])) 
          { 
...
// 
      include_once($this->path_aplicacao . "billing_paid_ri_erro.class.php"); 
      $this->Erro = new billing_paid_ri_erro();
      include_once($this->path_adodb . "/adodb.inc.php"); 
      $this->sc_Include($this->path_libs . "/nm_sec_prod.php", "F", "nm_reg_prod") ; 
      $this->sc_Include($this->path_libs . "/nm_ini_perfil.php", "F", "perfil_lib") ; 
// 
 if(function_exists('set_php_timezone')) set_php_timezone('billing_paid_ri'); 
// 
      ...
      if (isset($_SESSION['scriptcase']['billing_paid_ri']['session_timeout']['redir'])) {
          ...
          if ($_SESSION['scriptcase']['billing_paid_ri']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "  </HEAD>\r\n";
              $SS_cod_html .= "   <body>\r\n";
          }
          else {
              ...
              $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['billing_paid_ri']['session_timeout']['redir'] . "');\">\r\n";
              $SS_cod_html .= "     </form>\r\n";
          ...
          if ($_SESSION['scriptcase']['billing_paid_ri']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['billing_paid_ri']['session_timeout']['redir'] . "');\r\n";
          }
          ...
          $SS_cod_html .= " </body>\r\n";
          $SS_cod_html .= "</HTML>\r\n";
          unset($_SESSION['scriptcase']['billing_paid_ri']['session_timeout']);
          unset($_SESSION['sc_session']);
      }
      ...
      $_SESSION['sc_session'][$this->sc_page]['billing_paid_ri']['seq_dir'] = 0; 
      $_SESSION['sc_session'][$this->sc_page]['billing_paid_ri']['sub_dir'] = array(); 
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
      $this->conectDB();
   ...
   function prep_conect()
   {
      if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
      {
          ...
          {
              if (isset($_SESSION['scriptcase']['billing_paid_ri']['glo_nm_conexao']) && $_SESSION['scriptcase']['billing_paid_ri']['glo_nm_conexao'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['billing_paid_ri']['glo_nm_conexao'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['billing_paid_ri']['glo_nm_perfil']) && $_SESSION['scriptcase']['billing_paid_ri']['glo_nm_perfil'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['billing_paid_ri']['glo_nm_perfil'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['billing_paid_ri']['glo_con_' . $NM_con_orig]))
              {
                  $_SESSION['scriptcase']['billing_paid_ri']['glo_con_' . $NM_con_orig] = $NM_con_dest;
              }
          }
      }
      $con_devel             = (isset($_SESSION['scriptcase']['billing_paid_ri']['glo_nm_conexao'])) ? $_SESSION['scriptcase']['billing_paid_ri']['glo_nm_conexao'] : ""; 
      $perfil_trab           = ""; 
      $this->nm_falta_var    = ""; 
      $this->nm_falta_var_db = ""; 
      $nm_crit_perfil        = false;
      if (isset($_SESSION['scriptcase']['billing_paid_ri']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['billing_paid_ri']['glo_nm_conexao']))
      {
          ob_start();
      ...
      if (isset($_SESSION['scriptcase']['billing_paid_ri']['glo_nm_perfil']) && !empty($_SESSION['scriptcase']['billing_paid_ri']['glo_nm_perfil']))
      {
          $perfil_trab = $_SESSION['scriptcase']['billing_paid_ri']['glo_nm_perfil'];
      }
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['billing_paid_ri']['embutida_init']) || !$_SESSION['sc_session'][$this->sc_page]['billing_paid_ri']['embutida_init']) 
      {
          if (!isset($_SESSION['payno'])) 
          {
              $this->nm_falta_var .= "payno; ";
          }
...
// 
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['billing_paid_ri']['decimal_db'] = $_SESSION['scriptcase']['glo_decimal_db']; 
      }
      if (isset($_SESSION['scriptcase']['glo_date_separator']) && !empty($_SESSION['scriptcase']['glo_date_separator']))
      {
          ...
          if (strlen($SC_temp) == 2)
          {
              $_SESSION['sc_session'][$this->sc_page]['billing_paid_ri']['SC_sep_date']  = substr($SC_temp, 0, 1); 
              $_SESSION['sc_session'][$this->sc_page]['billing_paid_ri']['SC_sep_date1'] = substr($SC_temp, 1, 1); 
          }
          else
           {
              $_SESSION['sc_session'][$this->sc_page]['billing_paid_ri']['SC_sep_date']  = $SC_temp; 
              $_SESSION['sc_session'][$this->sc_page]['billing_paid_ri']['SC_sep_date1'] = $SC_temp; 
          }
          $this->date_delim  = $_SESSION['sc_session'][$this->sc_page]['billing_paid_ri']['SC_sep_date'];
          $this->date_delim1 = $_SESSION['sc_session'][$this->sc_page]['billing_paid_ri']['SC_sep_date1'];
      }
// 
...
<?php
   ...
   function conectDB()
   {
      ...
      if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['billing_paid_ri']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['billing_paid_ri']['glo_nm_conexao']))
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['billing_paid_ri']['glo_nm_conexao'], $this->root . $this->path_prod, 'simrskreatifmedia', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
...
// 
   ...
   function sc_Sql_Protect($var, $tp, $conex="")
   {
       ...
       if ($tp == "date")
       {
           ...
           if (isset($_SESSION['sc_session'][$this->sc_page]['billing_paid_ri']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->sc_page]['billing_paid_ri']['SC_sep_date']))
           {
               $delim  = $_SESSION['sc_session'][$this->sc_page]['billing_paid_ri']['SC_sep_date'];
               $delim1 = $_SESSION['sc_session'][$this->sc_page]['billing_paid_ri']['SC_sep_date1'];
           }
   ...
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['billing_paid_ri']['SC_Gb_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['billing_paid_ri']['SC_Gb_date_format'][$GB][$cmp] : "";
   }

   function Get_Gb_prefix_date_format($GB, $cmp)
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['billing_paid_ri']['SC_Gb_prefix_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['billing_paid_ri']['SC_Gb_prefix_date_format'][$GB][$cmp] : "";
   }
...
//----- 
   function controle()
   {
      ...
      $this->Ini = new billing_paid_ri_ini(); 
      $this->Ini->init();
      $this->Change_Menu = false;
      if (isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['billing_paid_ri']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['billing_paid_ri']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['billing_paid_ri']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['billing_paid_ri'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['billing_paid_ri']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['billing_paid_ri']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('billing_paid_ri') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['billing_paid_ri']['label'] = "" . $this->Ini->Nm_lang['lang_othr_blank_title'] . "";
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['billing_paid_ri']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['billing_paid_ri']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['billing_paid_ri']['exit'];
      ...
      $this->Db = $this->Ini->Db; 
      include_once($this->Ini->path_aplicacao . "billing_paid_ri_erro.class.php"); 
      $this->Erro      = new billing_paid_ri_erro();
      $this->Erro->Ini = $this->Ini;
//
      $_SESSION['scriptcase']['billing_paid_ri']['contr_erro'] = 'on';
if (!isset($_SESSION['usr_login'])) {$_SESSION['usr_login'] = "";}
if (!isset($this->sc_temp_usr_login)) {$this->sc_temp_usr_login = (isset($_SESSION['usr_login'])) ? $_SESSION['usr_login'] : "";}
if (!isset($_SESSION['payno'])) {$_SESSION['payno'] = "";}
if (!isset($this->sc_temp_payno)) {$this->sc_temp_payno = (isset($_SESSION['payno'])) ? $_SESSION['payno'] : "";}
  $nopayment = $this->sc_temp_payno;
...
$check_sql = "SELECT tranCode,jenisPayment, deposit, jmlTagihan, hrsDibayar, jmlBayar, paidDate"
   . " FROM tbpayment_ri"
   . " WHERE noPayment = '$nopayment'";
...
<html>
	<head>
	<title>BUKTI PEMBAYARAN : '.$nopayment.'</title>
	<style>
	 	body {
			width: 750px;
			border: #efefef;
	...
	<body>
		...
		<img width ="75px" height ="40px" src="'.($libHomeDir  . '/logo.png').'"/>
		<br>
			'.$conf['nama_institusi2'].'
			<br>
			'.$conf['alamat_institusi'].'
			<br>
			<br>BILLING RAWAT INAP : '.$nopayment.'
		</p>';

$check_sql5 = "SELECT
	a.tglMasuk AS Masuk,
	b.tglKeluar AS Keluar,
	a.pembayaran AS Bayar,
	a.kelas AS Kelas,
	concat(d.ruang,' - Bed ', d.noBed )  AS Bed,
	a.caraMasuk AS Mutasi,
	a.custCode AS RM,
	concat( c.`name`, ', ', c.salut ) AS Nama 
FROM
	tbadmrawatinap a
	LEFT JOIN tbdetailrawatinap b ON b.tranCode = a.tranCode
	LEFT JOIN tbcustomer c ON c.custCode = a.custCode
	LEFT JOIN tbbed d ON d.idBed = a.bed 
WHERE
	a.tranCode = '".$trancode."'";
...
$Masuk 	  = $this->rs5[0][0];
$Keluar	  = $this->rs5[0][1];
$Bayarnya = $this->rs5[0][2];
$Kelasnya = $this->rs5[0][3];
$Bednya   = $this->rs5[0][4];
$Mutasi   = $this->rs5[0][5];
$RMnya 	  = $this->rs5[0][6];
$Namanya  = $this->rs5[0][7];

$check_sql = "SELECT
	a.tranCode AS Kode,
	concat(c. NAME, ', ', c.salut,' (',c.custCode,')') AS Nama,
	concat(
		d.gelar,
		' ',
		d. NAME,
...
FROM
	tbdetailrawatinap a
LEFT JOIN tbadmrawatinap b ON b.struckNo = a.noStruk
LEFT JOIN tbcustomer c ON c.custcode = b.custCode
LEFT JOIN tbdoctor d ON d.docCode = a.dokter
LEFT JOIN tbpoli e on d.poli = e.polyCode
WHERE
	a.tranCode = '".$trancode."'";
...
{
	$bayar		= $this->rs2[0][0];
	$kembalian	= $this->rs2[0][1];
	$terimaDari = $this->rs2[0][2];
}else{
	$bayar = 0;
	$kembalian = 0;
	$terimaDari = '';
...
$desc_bayar = $this->terbilang($bayar, $style=1);
...
$html .= '<table width ="100%">			
			...
			<tr>
				<td><strong>CARA MASUK</strong></td>
				<td>: </td><td>'.$Mutasi.'</td>		
				<td></td>
				<td><strong>JENIS</strong></td>
				<td>: </td><td>'.$Bayarnya.'</td>
			</tr>
			<tr>
				<td><strong>NO PEMBAYARAN</strong></td>
				<td>: </td><td>'.$nopayment.'</td>		
				<td></td>
...
$check_sql = "SELECT b.unitAsal"
   . " FROM tbantrian a left join tbadmrawatinap b on b.unitAsal = a.struckNo"
   . " WHERE b.tranCode = '" . $trancode . "'";
...
$sSQLigd = "SELECT
										CONCAT(
											date_format( a.tglTindakan, '%d/%m/%Y' ),
											' - ',
											a.tindakan,
											' (',
											d.gelar,
										...
										a.biaya AS Biaya,
										a.diskon AS Diskon,
										a.biaya - (a.biaya*(a.diskon/100)) AS Total
									FROM
										tbtindakanigd a
										LEFT JOIN tbdetailigd b ON b.tranCode = a.tranCode
										LEFT JOIN tbadmrawatinap c ON c.unitAsal = b.noStruk
										LEFT JOIN tbdoctor d ON d.docCode = a.pelaksana where c.tranCode = '".$trancode."'";

 
      $nm_select = $sSQLigd; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->datasetigd = array();
      if ($rx = $this->Db->Execute($nm_select)) 
      { 
          $y = 0; 
          $nm_count = $rx->FieldCount();
          ...
          { 
                 for ($x = 0; $x < $nm_count; $x++)
                 { 
                        $this->datasetigd[$y] [$x] = $rx->fields[$x];
                 }
                 $y++; 
                 $rx->MoveNext();
          } 
      ...
      elseif (isset($GLOBALS["NM_ERRO_IBASE"]) && $GLOBALS["NM_ERRO_IBASE"] != 1)  
      { 
          $this->datasetigd = false;
          $this->datasetigd_erro = $this->Db->ErrorMsg();
      } 
;

if(!empty($this->datasetigd )){
$html .='<tr>
			<td colspan = "4"><strong>Mutasi dari IGD</strong></td>
		  </tr>';
	
	foreach($this->datasetigd  as $setigd){
		
$html .=' <tr>
			<td>'.$setigd[0].'</td>
			<td align="right">Rp '.number_format($setigd[1]).'</td>
			<td align="center">'.number_format($setigd[2]).'</td>
			<td align="right">Rp '.number_format($setigd[3]).'</td>
		  </tr>';
		}
}

$sSQL20 = "SELECT
	CONCAT( date_format( a.tranDate, '%d/%m/%Y' ), ' - ', d.namaItem,' (',a.jumlah,')' ) AS Deskripsi,
	a.biaya AS Biaya,
	a.diskon AS Diskon,
	(a.biaya*a.jumlah - ( (a.biaya * a.jumlah)*( a.diskon / 100 ) ))+(((a.biaya*a.jumlah) - ( (a.biaya *a.jumlah)* ( a.diskon / 100 ) ))*(10/100)) AS Total 
FROM
	tbreseprawatigd a
	LEFT JOIN tbdetailigd b ON b.tranCode = a.tranCode
	LEFT JOIN tbadmrawatinap c ON c.unitAsal = b.noStruk
	...
	c.tranCode = '".$trancode."'";
      ...
      { 
          ...
          { 
                 for ($x = 0; $x < $nm_count; $x++)
                 { 
                        $this->dataset20[$y] [$x] = $rx->fields[$x];
                 }
                 $y++; 
                 $rx->MoveNext();
          } 
      ...
      elseif (isset($GLOBALS["NM_ERRO_IBASE"]) && $GLOBALS["NM_ERRO_IBASE"] != 1)  
      { 
          $this->dataset20 = false;
          $this->dataset20_erro = $this->Db->ErrorMsg();
      } 
;

if(!empty($this->dataset20 )){
	
$html .='<tr>
			<td colspan = "4"><strong>Resep IGD</strong></td>
		  </tr>';
	
	foreach($this->dataset20  as $set20){
		
$html .=' <tr>
			<td>'.$set20[0].'</td>
			<td align="right">Rp. '.number_format($set20[1]).'</td>
			<td align="center">'.number_format($set20[2]).'</td>
			<td align="right">Rp. '.number_format($set20[3]).'</td>
		  </tr>';
		}
}
	...
	c.tranCode = '".$trancode."'";
      ...
      { 
          ...
          { 
                 for ($x = 0; $x < $nm_count; $x++)
                 { 
                        $this->dataset21[$y] [$x] = $rx->fields[$x];
                 }
                 $y++; 
                 $rx->MoveNext();
          } 
      ...
      elseif (isset($GLOBALS["NM_ERRO_IBASE"]) && $GLOBALS["NM_ERRO_IBASE"] != 1)  
      { 
          $this->dataset21 = false;
          $this->dataset21_erro = $this->Db->ErrorMsg();
      } 
;

if(!empty($this->dataset21 )){
$html .='<tr>
			<td colspan = "4"><strong>BHP IGD</strong></td>
		  </tr>';
	
	foreach($this->dataset21  as $set21){
		
$html .=' <tr>
			<td>'.$set21[0].'</td>
			<td align="right">Rp. '.number_format($set21[1]).'</td>
			<td align="center">'.number_format($set21[2]).'</td>
			<td align="right">Rp. '.number_format($set21[3]).'</td>
		  </tr>';
		}
}
...
$sSQLpoli = "SELECT
									...
									FROM
										...
										LEFT JOIN tbadmrawatinap c ON c.unitAsal = b.noStruk
										LEFT JOIN tbdoctor d ON d.docCode = b.dokter where c.tranCode = '".$trancode."'";

 
      $nm_select = $sSQLpoli; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->datasetpoli = array();
      if ($rx = $this->Db->Execute($nm_select)) 
      { 
          $y = 0; 
          $nm_count = $rx->FieldCount();
          ...
          { 
                 for ($x = 0; $x < $nm_count; $x++)
                 { 
                        $this->datasetpoli[$y] [$x] = $rx->fields[$x];
                 }
                 $y++; 
                 $rx->MoveNext();
          } 
      ...
      elseif (isset($GLOBALS["NM_ERRO_IBASE"]) && $GLOBALS["NM_ERRO_IBASE"] != 1)  
      { 
          $this->datasetpoli = false;
          $this->datasetpoli_erro = $this->Db->ErrorMsg();
      } 
;

if(!empty($this->datasetpoli )){
$html .='<tr>
			<td colspan = "4"><strong>Mutasi dari Poli</strong></td>
		  </tr>';
	
	foreach($this->datasetpoli  as $setpoli){
		
$html .=' <tr>
			<td>'.$setpoli[0].'</td>
			<td align="right">Rp '.number_format($setpoli[1]).'</td>
			<td align="center">'.number_format($setpoli[2]).'</td>
			<td align="right">Rp '.number_format($setpoli[3]).'</td>
		  </tr>';
		}
}
	...
	c.tranCode = '".$trancode."'";
      ...
      { 
          ...
          { 
                 for ($x = 0; $x < $nm_count; $x++)
                 { 
                        $this->dataset41[$y] [$x] = $rx->fields[$x];
                 }
                 $y++; 
                 $rx->MoveNext();
          } 
      ...
      elseif (isset($GLOBALS["NM_ERRO_IBASE"]) && $GLOBALS["NM_ERRO_IBASE"] != 1)  
      { 
          $this->dataset41 = false;
          $this->dataset41_erro = $this->Db->ErrorMsg();
      } 
;

if(!empty($this->dataset41 )){
	
$html .='<tr>
			<td colspan = "4"><strong>Resep Poli</strong></td>
		  </tr>';
	
	foreach($this->dataset41  as $set41){
		
$html .=' <tr>
			<td>'.$set41[0].'</td>
			<td align="right">Rp. '.number_format($set41[1]).'</td>
			<td align="center">'.number_format($set41[2]).'</td>
			<td align="right">Rp. '.number_format($set41[3]).'</td>
		  </tr>';
		}
}
	...
	c.tranCode = '".$trancode."'";
      ...
      { 
          ...
          { 
                 for ($x = 0; $x < $nm_count; $x++)
                 { 
                        $this->dataset42[$y] [$x] = $rx->fields[$x];
                 }
                 $y++; 
                 $rx->MoveNext();
          } 
      ...
      elseif (isset($GLOBALS["NM_ERRO_IBASE"]) && $GLOBALS["NM_ERRO_IBASE"] != 1)  
      { 
          $this->dataset42 = false;
          $this->dataset42_erro = $this->Db->ErrorMsg();
      } 
;

if(!empty($this->dataset42 )){
$html .='<tr>
			<td colspan = "4"><strong>BHP Poli</strong></td>
		  </tr>';
	
	foreach($this->dataset42  as $set42){
		
$html .=' <tr>
			<td>'.$set42[0].'</td>
			<td align="right">Rp. '.number_format($set42[1]).'</td>
			<td align="center">'.number_format($set42[2]).'</td>
			<td align="right">Rp. '.number_format($set42[3]).'</td>
		  </tr>';
		}
}

$sSQL22 = "SELECT tbl_sum.nama, tbl_sum.rate, tbl_sum.disc, tbl_sum.total FROM(
	SELECT
		c.nama as nama,
		b.rate as rate,
		b.disc as disc,
	...
	WHERE
		e.tranCode = '".$trancode."'
	GROUP BY concat(date_format(b.trandate, '%d/%m/%Y  %H:%i'), '-', b.labcode)
	) tbl_sum";
      ...
      { 
          ...
          { 
                 for ($x = 0; $x < $nm_count; $x++)
                 { 
                        $this->dataset22[$y] [$x] = $rx->fields[$x];
                 }
                 $y++; 
                 $rx->MoveNext();
          } 
      ...
      elseif (isset($GLOBALS["NM_ERRO_IBASE"]) && $GLOBALS["NM_ERRO_IBASE"] != 1)  
      { 
          $this->dataset22 = false;
          $this->dataset22_erro = $this->Db->ErrorMsg();
      } 
;

if(!empty($this->dataset22 )){
$html .='<tr>
			<td colspan = "4"><strong>Pemeriksaan Lab Rajal</strong></td>
		  </tr>';
	
	foreach($this->dataset22  as $set22){
		
$html .=' <tr>
			<td>'.$set22[0].'</td>
			<td align="right">Rp. '.number_format($set22[1]).'</td>
			<td align="center">'.number_format($set22[2]).'</td>
			<td align="right">Rp. '.number_format($set22[3]).'</td>
		  </tr>';
		}
}

$sSQL23 = "SELECT tbl_sum.nama, tbl_sum.rate, tbl_sum.disc, tbl_sum.total FROM(
	SELECT
		c.nama as nama,
		b.rate as rate,
		b.disc as disc,
	...
	WHERE
		e.tranCode = '".$trancode."'
	GROUP BY concat( date_format( b.trandate, '%d/%m/%Y %H:%i' ), ' - ',b.radcode) 
	) tbl_sum";
...
if(!empty($this->dataset23 )){
$html .='<tr>
			<td colspan = "4"><strong>Pemeriksaan Radiologi Rajal</strong></td>
		  </tr>';
	
	foreach($this->dataset23  as $set23){
		
$html .=' <tr>
			<td>'.$set23[0].'</td>
			<td align="right">Rp. '.number_format($set23[1]).'</td>
			<td align="center">'.number_format($set23[2]).'</td>
			<td align="right">Rp. '.number_format($set23[3]).'</td>
		  </tr>';
		}
}
...
if (isset($this->rs[0][0]))     
{
    $admin_igd = $this->rs[0][0];
}

if(!empty($admin_igd)){
$html .='<tr>
			<td>Administrasi IGD</td>
			<td></td>
			<td></td>
			<td align="right">Rp. '.number_format($admin_igd).'</td>
		  </tr>';	
}
$check_sql = "SELECT
				biaya 
...
if (isset($this->rs[0][0]))     
{
    $admin_poli = $this->rs[0][0];
}
	
if(!empty($admin_poli)){	
$html .='<tr>
			<td>Administrasi Poli</td>
			<td></td>
			<td></td>
			<td align="right">Rp. '.number_format($admin_poli).'</td>
		  </tr>';	
	}
}
...
$sSQL2 = "SELECT
	concat(
		...
		b.noBed,
		' (',
		date_format( a.check_in, '%d %M %Y %H:%i' ),
		' - ',
		date_format( a.check_out, '%d %M %Y %H:%i' ),
		')' 
	) AS Deskripsi,
	a.rate AS Biaya,
	a.disc AS Diskon,
...
$html .='<tr>
			<td colspan = "4"><strong>Kamar Rawat Inap</strong></td>
		  </tr>';
...
$html .=' <tr>
			<td>'.$set2[0].'</td>
			<td align="right">Rp. '.number_format($set2[1]).'</td>
			<td align="center">'.number_format($set2[2]).'</td>
			<td align="right">Rp. '.number_format($set2[3]).'</td>
		  </tr>';
		}
}

$sSQLp = "SELECT
	'Tindakan Keperawatan' AS Deskripsi,
	a.keperawatan AS Biaya,
	a.disc AS Diskon,
	(
...
WHERE
	a.tranCode = '".$trancode."'";
      ...
      { 
          $this->datasetp = false;
          $this->datasetp_erro = $this->Db->ErrorMsg();
      } 
;

if(!empty($this->datasetp )){
	
	foreach($this->datasetp  as $setp){
		
$html .=' <tr>
			<td>'.$setp[0].'</td>
			<td align="right">Rp. '.number_format($setp[1]).'</td>
			<td align="center">'.number_format($setp[2]).'</td>
			<td align="right">Rp. '.number_format($setp[3]).'</td>
		  </tr>';
		}
}
...
$sSQL3 = "SELECT
				...
				a.fee AS Biaya,
				a.disc AS Diskon,
				a.fee - (a.fee *(a.disc / 100)) AS Total
			FROM
				tbtim a
		LEFT JOIN tbdetailvk b ON b.tranCode = a.trancode
		LEFT JOIN tbdoctor c ON c.docCode = a. CODE LEFT JOIN tbtindakan d on d.kodeTindakan = a.actcode
		where b.inapCode = '".$trancode."'";
...
if(!empty($this->dataset3 )){
	
	$html .='<tr>
			<td colspan = "4"><strong>Biaya Tind. Persalinan</strong></td>
		  </tr>';
	
	foreach($this->dataset3  as $set3){
		
$html .=' <tr>
			<td>'.$set3[0].'</td>
			<td align="right">Rp. '.number_format($set3[1]).'</td>
			<td align="center">'.number_format($set3[2]).'</td>
			<td align="right">Rp. '.number_format($set3[3]).'</td>
		  </tr>';
		}
}
...
$sSQL4 = "SELECT
      ...
      { 
          $this->dataset4 = false;
          $this->dataset4_erro = $this->Db->ErrorMsg();
      } 
;

if(!empty($this->dataset4 )){
	
$html .='<tr>
			<td colspan = "4"><strong>Biaya Tind. Operasi</strong></td>
		  </tr>';
	
	foreach($this->dataset4  as $set4){
		
$html .='<tr>
			<td>'.$set4[0].'</td>
			<td align="right">Rp. '.number_format($set4[1]).'</td>
			<td align="center">'.number_format($set4[2]).'</td>
			<td align="right">Rp. '.number_format($set4[3]).'</td>
		  </tr>';
		}
}
...
$sSQL5 = "SELECT
      ...
      { 
          $this->dataset5 = false;
          $this->dataset5_erro = $this->Db->ErrorMsg();
      } 
;

if(!empty($this->dataset5 )){

$html .='<tr>
			<td colspan = "4"><strong>Tindakan Rawat Inap</strong></td>
		  </tr>';
	foreach($this->dataset5  as $set5){
$html .='<tr>
			<td>'.$set5[0].'</td>
			<td align="right">Rp. '.number_format($set5[1]).'</td>
			<td align="center">'.number_format($set5[2]).'</td>
			<td align="right">Rp. '.number_format($set5[3]).'</td>
		  </tr>';
		}
}

$sSQL6 = "SELECT
				concat(b.namaItem,' (',a.jumlah,' x ',a.biaya,')') AS Deskripsi,
				a.biaya AS Biaya,
				a.diskon AS Diskon,
				(a.jumlah * ( a.biaya - ( a.biaya * ( a.diskon / 100 ) ) ))+ ((a.jumlah * ( a.biaya - ( a.biaya * ( a.diskon / 100 ) ) ))*(10/100))  AS Total
					FROM
				tbdetailresepokvk a
				LEFT JOIN tbobat b ON b.kodeItem = a.item
				LEFT JOIN tbdetailok c ON c.tranCode = a.tranCode
			where c.inapCode = '".$trancode."'";
      ...
      { 
          $this->dataset6 = false;
          $this->dataset6_erro = $this->Db->ErrorMsg();
      } 
;

if(!empty($this->dataset6 )){

$html .='<tr>
			<td colspan = "4"><strong>Obat Operasi</strong></td>
		  </tr>';
	foreach($this->dataset6  as $set6){
$html .='<tr>
			<td>'.$set6[0].'</td>
			<td align="right">Rp. '.number_format($set6[1]).'</td>
			<td align="center">'.number_format($set6[2]).'</td>
			<td align="right">Rp. '.number_format($set6[3]).'</td>
		  </tr>';
		}
}
...
$sSQL7 = "SELECT
      ...
      { 
          $this->dataset7 = false;
          $this->dataset7_erro = $this->Db->ErrorMsg();
      } 
;

if(!empty($this->dataset7 )){
	
$html .='<td colspan = "4"><strong>Obat Persalinan</strong></td>
		  </tr>';
		foreach($this->dataset7  as $set7){
$html .='<tr>
			<td>'.$set7[0].'</td>
			<td align="right">Rp. '.number_format($set7[1]).'</td>
			<td align="center">'.number_format($set7[2]).'</td>
			<td align="right">Rp. '.number_format($set7[3]).'</td>
		  </tr>';
		}
}

$sSQL8 = "SELECT
			CONCAT( DATE_FORMAT( a.tranDate, '%d/%m/%Y' ), ' - ', b.namaItem,'(',a.jumlah,')' ) AS Deskripsi,
										a.biaya AS Biaya,
										a.diskon AS Diskon,
										(a.jumlah * ( a.biaya - ( a.biaya * ( a.diskon / 100 ) ) ))+((a.jumlah * ( a.biaya - ( a.biaya * ( a.diskon / 100 ) ) ))*10/100) AS Total
									FROM
										tbreseprawatinap a
										LEFT JOIN tbobat b ON b.kodeItem = a.item where a.tranCode = '".$trancode."'";
      ...
      { 
          $this->dataset8 = false;
          $this->dataset8_erro = $this->Db->ErrorMsg();
      } 
;

if(!empty($this->dataset8 )){

$html .='<td colspan = "4"><strong>Obat Rawat Inap</strong></td>
		  </tr>';
		foreach($this->dataset8  as $set8){
$html .='<tr>
			<td>'.$set8[0].'</td>
			<td align="right">Rp. '.number_format($set8[1]).'</td>
			<td align="center">'.number_format($set8[2]).'</td>
			<td align="right">Rp. '.number_format($set8[3]).'</td>
		  </tr>';
		}
}

$sSQL9 = "SELECT
	CONCAT( date_format( a.tranDate, '%d/%m/%Y' ), ' - ', b.namaItem ) AS Deskripsi,
	a.biaya AS Biaya,
	a.diskon AS Diskon, (a.biaya*a.jumlah-((a.biaya*a.jumlah)*(a.diskon/100))+ (
			(
				( a.biaya * a.jumlah ) - ( ( a.biaya * a.jumlah ) * a.diskon / 100 ) 
			) * ( 10 / 100 ) 
		))
   FROM tbbhprawatinap a LEFT JOIN tbobat b ON b.kodeItem = a.item 
WHERE
	a.tranCode = '".$trancode."'";
      ...
      { 
          $this->dataset9 = false;
          $this->dataset9_erro = $this->Db->ErrorMsg();
      } 
;

if(!empty($this->dataset9 )){

$html .='<td colspan = "4"><strong>BHP Rawat Inap</strong></td>
		  </tr>';
		foreach($this->dataset9  as $set9){
$html .='<tr>
			<td>'.$set9[0].'</td>
			<td align="right">Rp. '.number_format($set9[1]).'</td>
			<td align="center">'.number_format($set9[2]).'</td>
			<td align="right">Rp. '.number_format($set9[3]).'</td>
		  </tr>';
		}
}
...
FROM
	(
	SELECT
		concat( date_format( b.trandate, '%d/%m/%Y  %H:%i' ), ' - ', c.nama ) AS nama,
		b.rate AS rate,
		b.disc AS disc,
		b.rate - ( b.rate * ( b.disc / 100 ) ) AS total 
	FROM
...
GROUP BY
      ...
      { 
          ...
          { 
                 for ($x = 0; $x < $nm_count; $x++)
                 { 
                        $this->dataset10[$y] [$x] = $rx->fields[$x];
                 }
                 $y++; 
                 $rx->MoveNext();
          } 
      ...
      elseif (isset($GLOBALS["NM_ERRO_IBASE"]) && $GLOBALS["NM_ERRO_IBASE"] != 1)  
      { 
          $this->dataset10 = false;
          $this->dataset10_erro = $this->Db->ErrorMsg();
      } 
;

if(!empty($this->dataset10 )){
	
$html .='<tr>
			<td colspan = "4"><strong>Biaya Laboratorium</strong></td>
		  </tr>';
		  
	foreach($this->dataset10  as $set10){
		
$html .='<tr>
			<td>'.$set10[0].'</td>
			<td align="right">Rp. '.number_format($set10[1]).'</td>
			<td align="center">'.number_format($set10[2]).'</td>
			<td align="right">Rp. '.number_format($set10[3]).'</td>
		  </tr>';
		}
}
...
GROUP BY
      ...
      { 
          ...
          { 
                 for ($x = 0; $x < $nm_count; $x++)
                 { 
                        $this->dataset11[$y] [$x] = $rx->fields[$x];
                 }
                 $y++; 
                 $rx->MoveNext();
          } 
      ...
      elseif (isset($GLOBALS["NM_ERRO_IBASE"]) && $GLOBALS["NM_ERRO_IBASE"] != 1)  
      { 
          $this->dataset11 = false;
          $this->dataset11_erro = $this->Db->ErrorMsg();
      } 
;

if(!empty($this->dataset11 )){
$html .='<tr>
			<td colspan = "4"><strong>Biaya Radiologi</strong></td>
		  </tr>';
	
	foreach($this->dataset11  as $set11){
		
$html .='<tr>
			<td>'.$set11[0].'</td>
			<td align="right">Rp. '.number_format($set11[1]).'</td>
			<td align="center">'.number_format($set11[2]).'</td>
			<td align="right">Rp. '.number_format($set11[3]).'</td>
		  </tr>';
		}
}
...
$html .='<tr>
			<td colspan = "4"><strong>Biaya Administrasi</strong></td>
		  </tr>';	

$html .='<tr>
			<td>Registrasi Rawat Inap</td>
			<td></td>
			<td></td>
			<td align="right">Rp. '.number_format($admin).'</td>
		  </tr>';

$all = ($jmlTag/107)*7;

$semua = $jmlTag-$jmlDeposit;

$sisasemua = $jmlTag-$jmlDeposit;
...
$html .='<tr>
			<td>Administrasi Rawat Inap</td>
			<td></td>
			<td></td>
			<td align="right">Rp. '.number_format($all).'</td>
		  </tr>';

$html .='<tr>
			<td colspan="3"><b>TOTAL</b></td>
			<b><td align="right"><b>Rp. '.number_format($jmlTag).'</b></td></b>
		  </tr>';

$html .='<!--tr>
			<td colspan="3"><b>DEPOSIT</b></td>
			<b><td align="right">Rp. '.number_format($jmlDeposit).'</td></b>
		  </tr>';

$html .='<tr>
			<td colspan="3"><b>BAYAR</b></td>
			<b><td align="right">Rp. '.number_format($allBayar).'</td></b>
		  </tr>';

$html .='<tr>
			<td colspan="3"><b>'.$katak.'</b></td>
			<b><td align="right">Rp. '.number_format($hrsByr).'</td></b>
		  </tr-->
		  </table>';

$html .= '*) Total Obat, BHP / ALKES berlaku pengenaan Ppn 10%<br>
	...
	<p class="title_faktur">
		...
		<br>
			...
			'.$conf['alamat_institusi'].'
			<br>
			<br>RINCIAN BAYAR RAWAT INAP : '.$nopayment.'
		</p>
	<table width ="100%">			
			<tr>
				<td><strong>NAMA PASIEN</strong></td>
		...
		<table class="tagihan">
		  <tr>
			...
			<th align="center">JENIS BAYAR</th>
			<th align="center">JUMLAH BAYAR</th>
		  </tr>';


$sSQLbyr = "SELECT (jmlBayar+jmlDK1+jmlDK2+jmlAsr+jmlKary+deposit) as Jumlah, noPayment, paidDate, if(deposit = '0',jenisPayment,concat(jenisPayment,' (UM)'))
   			FROM tbpayment_ri
   		WHERE tranCode = '".$trancode."' and (deposit != '0' OR jmlBayar != '0')";

 
      $nm_select = $sSQLbyr; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->datasetbyr = array();
      if ($rx = $this->Db->Execute($nm_select)) 
      { 
          $y = 0; 
          $nm_count = $rx->FieldCount();
          ...
          { 
                 for ($x = 0; $x < $nm_count; $x++)
                 { 
                        $this->datasetbyr[$y] [$x] = $rx->fields[$x];
                 }
                 $y++; 
                 $rx->MoveNext();
          } 
      ...
      elseif (isset($GLOBALS["NM_ERRO_IBASE"]) && $GLOBALS["NM_ERRO_IBASE"] != 1)  
      { 
          $this->datasetbyr = false;
          $this->datasetbyr_erro = $this->Db->ErrorMsg();
      } 
;

if(!empty($this->datasetbyr )){
	
	foreach($this->datasetbyr  as $setbyr){
		
$html .=' <tr>
			<td>'.$setbyr[1].'</td>
			<td>'.$setbyr[2].'</td>
			<td>'.$setbyr[3].'</td>
			<td align="right">Rp. '.number_format($setbyr[0]).'</td>
		  </tr>';
		}
}

$sSQLtot = "SELECT sum(jmlBayar+jmlDK1+jmlDK2+jmlAsr+jmlKary+deposit)
   			FROM tbpayment_ri
   		WHERE tranCode = '".$trancode."' and (deposit != '0' OR jmlBayar != '0')";
...
$html .='<tr>
	...
	<td align="right"><b>Rp. '.number_format($this->rs[0][0]).'</b></td>
</tr></table>';

$html .= '<p class="btborder">(Rincian bayar ini sah jika dibubuhi cap/stempel '.$conf['nama_institusi2'].')</p>';
...
if (isset($this->sc_temp_payno)) {$_SESSION['payno'] = $this->sc_temp_payno;}
if (isset($this->sc_temp_usr_login)) {$_SESSION['usr_login'] = $this->sc_temp_usr_login;}
$_SESSION['scriptcase']['billing_paid_ri']['contr_erro'] = 'off'; 
//--- 
       $this->Db->Close(); 
       if ($this->Change_Menu)
       {
...
//======= =========================
   ...
   if (!empty($_POST))
   {
       foreach ($_POST as $nmgp_var => $nmgp_val)
       {
            ...
            nm_limpa_str_billing_paid_ri($nmgp_val);
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['billing_paid_ri']['glo_nm_path_imag_temp'] . "/sc_apl_default_simrskreatifmedia.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['billing_paid_ri']['glo_nm_path_imag_temp'] . "/sc_apl_default_simrskreatifmedia.txt"));
       }
       if (isset($apl_def)) {
           if ($apl_def[0] != "billing_paid_ri") {
               $_SESSION['scriptcase']['sem_session'] = true;
               if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                   $_SESSION['scriptcase']['billing_paid_ri']['session_timeout']['redir'] = $apl_def[0];
               }
               else {
                   $_SESSION['scriptcase']['billing_paid_ri']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
               }
               $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
               $_SESSION['scriptcase']['billing_paid_ri']['session_timeout']['redir_tp'] = $Redir_tp;
           }
           if (isset($_COOKIE['sc_actual_lang_simrskreatifmedia'])) {
               $_SESSION['scriptcase']['billing_paid_ri']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_simrskreatifmedia'];
           }
       }
   }
   ...
   if (isset($_POST["payno"])) 
   {
       ...
       nm_limpa_str_billing_paid_ri($_SESSION["payno"]);
   }
   if (isset($_GET["payno"])) 
   {
   ...
   if (isset($_POST["usr_login"])) 
   {
       ...
       nm_limpa_str_billing_paid_ri($_SESSION["usr_login"]);
   }
   ...
   $salva_iframe = false;
   if (isset($_SESSION['sc_session'][$script_case_init]['billing_paid_ri']['iframe_menu']))
   {
       $salva_iframe = $_SESSION['sc_session'][$script_case_init]['billing_paid_ri']['iframe_menu'];
       unset($_SESSION['sc_session'][$script_case_init]['billing_paid_ri']['iframe_menu']);
   }
   if (isset($nm_run_menu) && $nm_run_menu == 1)
   {
        ...
        $_SESSION['scriptcase']['sc_apl_menu_atual'] = "billing_paid_ri";
        $achou = false;
        if (isset($_SESSION['sc_session'][$script_case_init]))
        {
            foreach ($_SESSION['sc_session'][$script_case_init] as $nome_apl => $resto)
            {
                if ($nome_apl == 'billing_paid_ri' || $achou)
                {
        ...
        $_SESSION['sc_session'][$script_case_init]['billing_paid_ri']['iframe_menu'] = true;
   }
   else
   {
       $_SESSION['sc_session'][$script_case_init]['billing_paid_ri']['iframe_menu'] = $salva_iframe;
   }

   if (!isset($_SESSION['sc_session'][$script_case_init]['billing_paid_ri']['initialize']))
   {
       $_SESSION['sc_session'][$script_case_init]['billing_paid_ri']['initialize'] = true;
   }
   elseif (!isset($_SERVER['HTTP_REFERER']))
   {
       $_SESSION['sc_session'][$script_case_init]['billing_paid_ri']['initialize'] = false;
   }
   ...
   else
   {
       ...
       if ('billing_paid_ri' == $sReferer || 'billing_paid_ri_' == substr($sReferer, 0, 16))
       {
           $_SESSION['sc_session'][$script_case_init]['billing_paid_ri']['initialize'] = false;
       }
       else
   ...
   if (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'billing_paid_ri')
   {
       $_SESSION['sc_session'][$script_case_init]['billing_paid_ri']['sc_outra_jan'] = true;
        unset($_SESSION['scriptcase']['sc_outra_jan']);
   }
   $_SESSION['sc_session'][$script_case_init]['billing_paid_ri']['menu_desenv'] = false;   
   if (!defined("SC_ERROR_HANDLER"))
   {
       define("SC_ERROR_HANDLER", 1);
       include_once(dirname(__FILE__) . "/billing_paid_ri_erro.php");
   }
   if (!empty($nmgp_parms)) 
   { 
       ...
       while (!empty($todo[$ix]))
       {
            ...
            if (1 < sizeof($cadapar))
            {
                ...
                nm_limpa_str_billing_paid_ri($cadapar[1]);
   ...
   $contr_billing_paid_ri = new billing_paid_ri_apl();
   $contr_billing_paid_ri->controle();
//
   function nm_limpa_str_billing_paid_ri(&$str)
   {
