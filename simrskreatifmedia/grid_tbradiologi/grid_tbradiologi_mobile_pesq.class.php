...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "rate";$Nm_numeric[] = "deleted";$Nm_numeric[] = "rate";$Nm_numeric[] = "deleted";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_jenis_cond" name="jenis_cond" onChange="nm_campos_between(document.getElementById('id_vis_jenis'), this, 'jenis')">
