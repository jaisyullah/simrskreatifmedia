<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tbradiologi']['sc_process_barr'] = true;
require_once('../grid_tbradiologi/index.php');
unset($_SESSION['scriptcase']['grid_tbradiologi']['sc_process_barr']);
$ExportCtrl = new grid_tbradiologi_export_control;
$ExportCtrl->Export_barr();

class grid_tbradiologi_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_title'] ?> Radiologi :: Excel</TITLE>
