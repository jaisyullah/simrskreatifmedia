...
function displayChange_field_tarifrajal(row, status) {
	if ("on" == status && typeof $("#nmsc_iframe_liga_form_tbtarifrj")[0].contentWindow.scRecreateSelect2 === "function") {
		$("#nmsc_iframe_liga_form_tbtarifrj")[0].contentWindow.scRecreateSelect2();
	}
}

function displayChange_field_tarifinap(row, status) {
	if ("on" == status && typeof $("#nmsc_iframe_liga_form_tbtarifri")[0].contentWindow.scRecreateSelect2 === "function") {
		$("#nmsc_iframe_liga_form_tbtarifri")[0].contentWindow.scRecreateSelect2();
	}
}
...
function scHidePage(pageNo) {
	$("#id_form_tbtindakan_form" + pageNo).hide();
}
