  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbtindakan" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbtindakan_form();
	}

  // ---------- Validate jenistindakan
  function do_ajax_form_tbtindakan_validate_jenistindakan()
  {
    var nomeCampo_jenistindakan = "jenistindakan";
    var var_jenistindakan = scAjaxGetFieldSelect(nomeCampo_jenistindakan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtindakan_validate_jenistindakan(var_jenistindakan, var_script_case_init, do_ajax_form_tbtindakan_validate_jenistindakan_cb);
  } // do_ajax_form_tbtindakan_validate_jenistindakan

  function do_ajax_form_tbtindakan_validate_jenistindakan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "jenistindakan";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtindakan_validate_jenistindakan_cb

  // ---------- Validate kodetindakan
  function do_ajax_form_tbtindakan_validate_kodetindakan()
  {
    var nomeCampo_kodetindakan = "kodetindakan";
    var var_kodetindakan = scAjaxGetFieldText(nomeCampo_kodetindakan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtindakan_validate_kodetindakan(var_kodetindakan, var_script_case_init, do_ajax_form_tbtindakan_validate_kodetindakan_cb);
  } // do_ajax_form_tbtindakan_validate_kodetindakan

  function do_ajax_form_tbtindakan_validate_kodetindakan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "kodetindakan";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtindakan_validate_kodetindakan_cb

  // ---------- Validate kategori
  function do_ajax_form_tbtindakan_validate_kategori()
  {
    var nomeCampo_kategori = "kategori";
    var var_kategori = scAjaxGetFieldSelect(nomeCampo_kategori);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtindakan_validate_kategori(var_kategori, var_script_case_init, do_ajax_form_tbtindakan_validate_kategori_cb);
  } // do_ajax_form_tbtindakan_validate_kategori

  function do_ajax_form_tbtindakan_validate_kategori_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtindakan_validate_kategori_cb

  // ---------- Validate namatindakan
  function do_ajax_form_tbtindakan_validate_namatindakan()
  {
    var nomeCampo_namatindakan = "namatindakan";
    var var_namatindakan = scAjaxGetFieldText(nomeCampo_namatindakan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtindakan_validate_namatindakan(var_namatindakan, var_script_case_init, do_ajax_form_tbtindakan_validate_namatindakan_cb);
  } // do_ajax_form_tbtindakan_validate_namatindakan

  function do_ajax_form_tbtindakan_validate_namatindakan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "namatindakan";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtindakan_validate_namatindakan_cb

  // ---------- Validate keterangan
  function do_ajax_form_tbtindakan_validate_keterangan()
  {
    var nomeCampo_keterangan = "keterangan";
    var var_keterangan = scAjaxGetFieldText(nomeCampo_keterangan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtindakan_validate_keterangan(var_keterangan, var_script_case_init, do_ajax_form_tbtindakan_validate_keterangan_cb);
  } // do_ajax_form_tbtindakan_validate_keterangan

  function do_ajax_form_tbtindakan_validate_keterangan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtindakan_validate_keterangan_cb

  // ---------- Validate aktif
  function do_ajax_form_tbtindakan_validate_aktif()
  {
    var nomeCampo_aktif = "aktif";
    var var_aktif = scAjaxGetFieldRadio(nomeCampo_aktif);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtindakan_validate_aktif(var_aktif, var_script_case_init, do_ajax_form_tbtindakan_validate_aktif_cb);
  } // do_ajax_form_tbtindakan_validate_aktif

  function do_ajax_form_tbtindakan_validate_aktif_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "aktif";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtindakan_validate_aktif_cb

  // ---------- Validate tarifrajal
  function do_ajax_form_tbtindakan_validate_tarifrajal()
  {
    var nomeCampo_tarifrajal = "tarifrajal";
    var var_tarifrajal = scAjaxGetFieldText(nomeCampo_tarifrajal);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtindakan_validate_tarifrajal(var_tarifrajal, var_script_case_init, do_ajax_form_tbtindakan_validate_tarifrajal_cb);
  } // do_ajax_form_tbtindakan_validate_tarifrajal

  function do_ajax_form_tbtindakan_validate_tarifrajal_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tarifrajal";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtindakan_validate_tarifrajal_cb

  // ---------- Validate tarifinap
  function do_ajax_form_tbtindakan_validate_tarifinap()
  {
    var nomeCampo_tarifinap = "tarifinap";
    var var_tarifinap = scAjaxGetFieldText(nomeCampo_tarifinap);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtindakan_validate_tarifinap(var_tarifinap, var_script_case_init, do_ajax_form_tbtindakan_validate_tarifinap_cb);
  } // do_ajax_form_tbtindakan_validate_tarifinap

  function do_ajax_form_tbtindakan_validate_tarifinap_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tarifinap";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtindakan_validate_tarifinap_cb

  // ---------- Event onchange kategori
  function do_ajax_form_tbtindakan_event_kategori_onchange()
  {
    var var_kategori = scAjaxGetFieldSelect("kategori");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tbtindakan_event_kategori_onchange(var_kategori, var_script_case_init, do_ajax_form_tbtindakan_event_kategori_onchange_cb);
  } // do_ajax_form_tbtindakan_event_kategori_onchange

  function do_ajax_form_tbtindakan_event_kategori_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "kategori";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_tbtindakan_event_kategori_onchange_cb_after_alert);
  } // do_ajax_form_tbtindakan_event_kategori_onchange_cb
  function do_ajax_form_tbtindakan_event_kategori_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_tbtindakan_event_kategori_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tbtindakan_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tbtindakan_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_jenistindakan = scAjaxGetFieldSelect("jenistindakan");
    var var_kodetindakan = scAjaxGetFieldText("kodetindakan");
    var var_kategori = scAjaxGetFieldSelect("kategori");
    var var_namatindakan = scAjaxGetFieldText("namatindakan");
    ...
    scAjaxProcOn();
    x_ajax_form_tbtindakan_submit_form(var_jenistindakan, var_kodetindakan, var_kategori, var_namatindakan, var_keterangan, var_aktif, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbtindakan_submit_form_cb);
  } // do_ajax_form_tbtindakan_submit_form

  function do_ajax_form_tbtindakan_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("jenistindakan");
      scAjaxHideErrorDisplay("kodetindakan");
      scAjaxHideErrorDisplay("kategori");
      scAjaxHideErrorDisplay("namatindakan");
      scAjaxHideErrorDisplay("keterangan");
      scAjaxHideErrorDisplay("aktif");
      scAjaxHideErrorDisplay("tarifrajal");
      scAjaxHideErrorDisplay("tarifinap");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tbtindakan_submit_form_cb_after_alert);
  } // do_ajax_form_tbtindakan_submit_form_cb
  function do_ajax_form_tbtindakan_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbtindakan_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_tbtarifrj"] = "off";
  scStatusDetail["form_tbtarifri"] = "off";

  function do_ajax_form_tbtindakan_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    scStatusDetail["form_tbtarifrj"] = "on";
    scStatusDetail["form_tbtarifri"] = "on";
    x_ajax_form_tbtindakan_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbtindakan_navigate_form_cb);
  } // do_ajax_form_tbtindakan_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtindakan']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbtindakan_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_tbtarifrj"] && "nmsc_iframe_liga_form_tbtarifrj" != scMasterDetailIframe["nmsc_iframe_liga_form_tbtarifrj"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_tbtarifrj"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_tbtarifrj').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_tbtarifrj').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_tbtarifrj').style.display = "none";
    }
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_tbtarifri"] && "nmsc_iframe_liga_form_tbtarifri" != scMasterDetailIframe["nmsc_iframe_liga_form_tbtarifri"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_tbtarifri"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_tbtarifri').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_tbtarifri').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_tbtarifri').style.display = "none";
    }
    scAjaxSetBtnVars();
    sc_change_tabs(true, 'hidden_bloco_1', 'id_tabs_1_1');
    sc_change_tabs(false, 'hidden_bloco_2', 'id_tabs_1_2');
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbtindakan_navigate_form_cb_after_alert);
  } // do_ajax_form_tbtindakan_navigate_form_cb
  function do_ajax_form_tbtindakan_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_tbtindakan_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_tbtindakan_navigate_form_cb_after_alert
  function sc_hide_form_tbtindakan_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_tbtarifrj"] && "off" == scStatusDetail["form_tbtarifri"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[0] = "jenistindakan";
  ajax_field_list[1] = "kodetindakan";
  ajax_field_list[2] = "kategori";
  ajax_field_list[3] = "namatindakan";
  ajax_field_list[4] = "keterangan";
  ajax_field_list[5] = "aktif";
  ajax_field_list[6] = "tarifrajal";
  ajax_field_list[7] = "tarifinap";
  ...
  var ajax_error_list = {
    "jenistindakan": {"label": "Jenis Tindakan", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "kodetindakan": {"label": "Kode Tindakan", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "namatindakan": {"label": "Nama Tindakan", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "tarifrajal": {"label": "tarifrajal", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "tarifinap": {"label": "tarifinap", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "jenistindakan": new Array(),
    "kodetindakan": new Array(),
    "kategori": new Array(),
    "namatindakan": new Array(),
    "keterangan": new Array(),
    "aktif": new Array(),
    "tarifrajal": new Array(),
    "tarifinap": new Array()
  };
  ajax_field_mult["jenistindakan"][1] = "jenistindakan";
  ajax_field_mult["kodetindakan"][1] = "kodetindakan";
  ajax_field_mult["kategori"][1] = "kategori";
  ajax_field_mult["namatindakan"][1] = "namatindakan";
  ajax_field_mult["keterangan"][1] = "keterangan";
  ajax_field_mult["aktif"][1] = "aktif";
  ajax_field_mult["tarifrajal"][1] = "tarifrajal";
  ajax_field_mult["tarifinap"][1] = "tarifinap";

  var ajax_field_id = {
    "jenistindakan": new Array("hidden_field_label_jenistindakan", "hidden_field_data_jenistindakan"),
    "kodetindakan": new Array("hidden_field_label_kodetindakan", "hidden_field_data_kodetindakan"),
    "kategori": new Array("hidden_field_label_kategori", "hidden_field_data_kategori"),
    "namatindakan": new Array("hidden_field_label_namatindakan", "hidden_field_data_namatindakan"),
    ...
    "tarifrajal": new Array("hidden_field_label_tarifrajal", "hidden_field_data_tarifrajal"),
    "tarifinap": new Array("hidden_field_label_tarifinap", "hidden_field_data_tarifinap")
  };
