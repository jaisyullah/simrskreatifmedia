  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbtindakan_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbtindakan_mob_form();
	}

  // ---------- Validate jenistindakan
  function do_ajax_form_tbtindakan_mob_validate_jenistindakan()
  {
    var nomeCampo_jenistindakan = "jenistindakan";
    var var_jenistindakan = scAjaxGetFieldSelect(nomeCampo_jenistindakan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtindakan_mob_validate_jenistindakan(var_jenistindakan, var_script_case_init, do_ajax_form_tbtindakan_mob_validate_jenistindakan_cb);
  } // do_ajax_form_tbtindakan_mob_validate_jenistindakan

  function do_ajax_form_tbtindakan_mob_validate_jenistindakan_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtindakan_mob_validate_jenistindakan_cb

  // ---------- Validate kodetindakan
  function do_ajax_form_tbtindakan_mob_validate_kodetindakan()
  {
    var nomeCampo_kodetindakan = "kodetindakan";
    var var_kodetindakan = scAjaxGetFieldText(nomeCampo_kodetindakan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtindakan_mob_validate_kodetindakan(var_kodetindakan, var_script_case_init, do_ajax_form_tbtindakan_mob_validate_kodetindakan_cb);
  } // do_ajax_form_tbtindakan_mob_validate_kodetindakan

  function do_ajax_form_tbtindakan_mob_validate_kodetindakan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtindakan_mob_validate_kodetindakan_cb

  // ---------- Validate kategori
  function do_ajax_form_tbtindakan_mob_validate_kategori()
  {
    var nomeCampo_kategori = "kategori";
    var var_kategori = scAjaxGetFieldSelect(nomeCampo_kategori);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtindakan_mob_validate_kategori(var_kategori, var_script_case_init, do_ajax_form_tbtindakan_mob_validate_kategori_cb);
  } // do_ajax_form_tbtindakan_mob_validate_kategori

  function do_ajax_form_tbtindakan_mob_validate_kategori_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtindakan_mob_validate_kategori_cb

  // ---------- Validate namatindakan
  function do_ajax_form_tbtindakan_mob_validate_namatindakan()
  {
    var nomeCampo_namatindakan = "namatindakan";
    var var_namatindakan = scAjaxGetFieldText(nomeCampo_namatindakan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtindakan_mob_validate_namatindakan(var_namatindakan, var_script_case_init, do_ajax_form_tbtindakan_mob_validate_namatindakan_cb);
  } // do_ajax_form_tbtindakan_mob_validate_namatindakan

  function do_ajax_form_tbtindakan_mob_validate_namatindakan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtindakan_mob_validate_namatindakan_cb

  // ---------- Validate keterangan
  function do_ajax_form_tbtindakan_mob_validate_keterangan()
  {
    var nomeCampo_keterangan = "keterangan";
    var var_keterangan = scAjaxGetFieldText(nomeCampo_keterangan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtindakan_mob_validate_keterangan(var_keterangan, var_script_case_init, do_ajax_form_tbtindakan_mob_validate_keterangan_cb);
  } // do_ajax_form_tbtindakan_mob_validate_keterangan

  function do_ajax_form_tbtindakan_mob_validate_keterangan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtindakan_mob_validate_keterangan_cb

  // ---------- Validate aktif
  function do_ajax_form_tbtindakan_mob_validate_aktif()
  {
    var nomeCampo_aktif = "aktif";
    var var_aktif = scAjaxGetFieldRadio(nomeCampo_aktif);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtindakan_mob_validate_aktif(var_aktif, var_script_case_init, do_ajax_form_tbtindakan_mob_validate_aktif_cb);
  } // do_ajax_form_tbtindakan_mob_validate_aktif

  function do_ajax_form_tbtindakan_mob_validate_aktif_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "aktif";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtindakan_mob_validate_aktif_cb

  // ---------- Validate tarifrajal
  function do_ajax_form_tbtindakan_mob_validate_tarifrajal()
  {
    var nomeCampo_tarifrajal = "tarifrajal";
    var var_tarifrajal = scAjaxGetFieldText(nomeCampo_tarifrajal);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtindakan_mob_validate_tarifrajal(var_tarifrajal, var_script_case_init, do_ajax_form_tbtindakan_mob_validate_tarifrajal_cb);
  } // do_ajax_form_tbtindakan_mob_validate_tarifrajal

  function do_ajax_form_tbtindakan_mob_validate_tarifrajal_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtindakan_mob_validate_tarifrajal_cb

  // ---------- Validate tarifinap
  function do_ajax_form_tbtindakan_mob_validate_tarifinap()
  {
    var nomeCampo_tarifinap = "tarifinap";
    var var_tarifinap = scAjaxGetFieldText(nomeCampo_tarifinap);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbtindakan_mob_validate_tarifinap(var_tarifinap, var_script_case_init, do_ajax_form_tbtindakan_mob_validate_tarifinap_cb);
  } // do_ajax_form_tbtindakan_mob_validate_tarifinap

  function do_ajax_form_tbtindakan_mob_validate_tarifinap_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbtindakan_mob_validate_tarifinap_cb

  // ---------- Event onchange kategori
  function do_ajax_form_tbtindakan_mob_event_kategori_onchange()
  {
    var var_kategori = scAjaxGetFieldSelect("kategori");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tbtindakan_mob_event_kategori_onchange(var_kategori, var_script_case_init, do_ajax_form_tbtindakan_mob_event_kategori_onchange_cb);
  } // do_ajax_form_tbtindakan_mob_event_kategori_onchange

  function do_ajax_form_tbtindakan_mob_event_kategori_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "kategori";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_tbtindakan_mob_event_kategori_onchange_cb_after_alert);
  } // do_ajax_form_tbtindakan_mob_event_kategori_onchange_cb
  function do_ajax_form_tbtindakan_mob_event_kategori_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_tbtindakan_mob_event_kategori_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tbtindakan_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tbtindakan_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_tbtindakan_mob_submit_form(var_jenistindakan, var_kodetindakan, var_kategori, var_namatindakan, var_keterangan, var_aktif, var_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbtindakan_mob_submit_form_cb);
  } // do_ajax_form_tbtindakan_mob_submit_form

  function do_ajax_form_tbtindakan_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tbtindakan_mob_submit_form_cb_after_alert);
  } // do_ajax_form_tbtindakan_mob_submit_form_cb
  function do_ajax_form_tbtindakan_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbtindakan_mob_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_tbtarifrj_mob"] = "off";
  scStatusDetail["form_tbtarifri_mob"] = "off";

  function do_ajax_form_tbtindakan_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    scStatusDetail["form_tbtarifrj_mob"] = "on";
    scStatusDetail["form_tbtarifri_mob"] = "on";
    x_ajax_form_tbtindakan_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbtindakan_mob_navigate_form_cb);
  } // do_ajax_form_tbtindakan_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbtindakan_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbtindakan_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_tbtarifrj_mob"] && "nmsc_iframe_liga_form_tbtarifrj_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_tbtarifrj_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_tbtarifrj_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_tbtarifrj_mob').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_tbtarifrj_mob').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_tbtarifrj_mob').style.display = "none";
    }
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_tbtarifri_mob"] && "nmsc_iframe_liga_form_tbtarifri_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_tbtarifri_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_tbtarifri_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_tbtarifri_mob').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_tbtarifri_mob').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_tbtarifri_mob').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbtindakan_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_tbtindakan_mob_navigate_form_cb
  function do_ajax_form_tbtindakan_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_tbtindakan_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_tbtindakan_mob_navigate_form_cb_after_alert
  function sc_hide_form_tbtindakan_mob_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_tbtarifrj_mob"] && "off" == scStatusDetail["form_tbtarifri_mob"])
    {
      return true;
    }
    return false;
