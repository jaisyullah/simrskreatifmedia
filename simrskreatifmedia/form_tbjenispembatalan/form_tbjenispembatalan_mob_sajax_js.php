  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbjenispembatalan_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbjenispembatalan_mob_form();
	}

  // ---------- Validate jenisbatal
  function do_ajax_form_tbjenispembatalan_mob_validate_jenisbatal()
  {
    var nomeCampo_jenisbatal = "jenisbatal";
    var var_jenisbatal = scAjaxGetFieldText(nomeCampo_jenisbatal);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbjenispembatalan_mob_validate_jenisbatal(var_jenisbatal, var_script_case_init, do_ajax_form_tbjenispembatalan_mob_validate_jenisbatal_cb);
  } // do_ajax_form_tbjenispembatalan_mob_validate_jenisbatal

  function do_ajax_form_tbjenispembatalan_mob_validate_jenisbatal_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "jenisbatal";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbjenispembatalan_mob_validate_jenisbatal_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tbjenispembatalan_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tbjenispembatalan_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_jenisbatal = scAjaxGetFieldText("jenisbatal");
    ...
    scAjaxProcOn();
    x_ajax_form_tbjenispembatalan_mob_submit_form(var_jenisbatal, var_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbjenispembatalan_mob_submit_form_cb);
  } // do_ajax_form_tbjenispembatalan_mob_submit_form

  function do_ajax_form_tbjenispembatalan_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("jenisbatal");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tbjenispembatalan_mob_submit_form_cb_after_alert);
  } // do_ajax_form_tbjenispembatalan_mob_submit_form_cb
  function do_ajax_form_tbjenispembatalan_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbjenispembatalan_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tbjenispembatalan_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_tbjenispembatalan_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbjenispembatalan_mob_navigate_form_cb);
  } // do_ajax_form_tbjenispembatalan_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbjenispembatalan_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbjenispembatalan_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbjenispembatalan_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_tbjenispembatalan_mob_navigate_form_cb
  function do_ajax_form_tbjenispembatalan_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_tbjenispembatalan_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_tbjenispembatalan_mob_navigate_form_cb_after_alert
  function sc_hide_form_tbjenispembatalan_mob_form()
  {
  ...
  ajax_field_list[0] = "jenisbatal";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "jenisbatal": {"label": "Jenis Batal", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "jenisbatal": new Array()
  };
  ajax_field_mult["jenisbatal"][1] = "jenisbatal";

  var ajax_field_id = {
    "jenisbatal": new Array("hidden_field_label_jenisbatal", "hidden_field_data_jenisbatal")
  };
