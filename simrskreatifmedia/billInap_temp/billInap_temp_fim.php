...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____billInap_temp"]))
   {
      unset($_SESSION['session_sec_aplicacao']["simrskreatifmedia_____billInap_temp"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['billInap_temp']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['billInap_temp']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['billInap_temp']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['billInap_temp']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['billInap_temp']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['billInap_temp']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['billInap_temp']['embutida_filho'] as $ind => $sc_init)
          {
