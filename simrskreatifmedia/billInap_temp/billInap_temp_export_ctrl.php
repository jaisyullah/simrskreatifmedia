<?php
@session_start() ;
$_SESSION['scriptcase']['billInap_temp']['sc_process_barr'] = true;
require_once('../billInap_temp/index.php');
unset($_SESSION['scriptcase']['billInap_temp']['sc_process_barr']);
$ExportCtrl = new billInap_temp_export_control;
$ExportCtrl->Export_barr();

class billInap_temp_export_control
{
