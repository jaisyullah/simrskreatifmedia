  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_control_hta_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_control_hta_mob_form();
	}

  // ---------- Validate pasien
  function do_ajax_control_hta_mob_validate_pasien()
  {
    var nomeCampo_pasien = "pasien";
    var var_pasien = scAjaxGetFieldSelect(nomeCampo_pasien);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_hta_mob_validate_pasien(var_pasien, var_script_case_init, do_ajax_control_hta_mob_validate_pasien_cb);
  } // do_ajax_control_hta_mob_validate_pasien

  function do_ajax_control_hta_mob_validate_pasien_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_hta_mob_validate_pasien_cb

  // ---------- Validate hta
  function do_ajax_control_hta_mob_validate_hta()
  {
    var nomeCampo_hta = "hta";
    var var_hta = scAjaxGetFieldText(nomeCampo_hta);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_hta_mob_validate_hta(var_hta, var_script_case_init, do_ajax_control_hta_mob_validate_hta_cb);
  } // do_ajax_control_hta_mob_validate_hta

  function do_ajax_control_hta_mob_validate_hta_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "hta";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_hta_mob_validate_hta_cb

  // ---------- Validate tp
  function do_ajax_control_hta_mob_validate_tp()
  {
    var nomeCampo_tp = "tp";
    var var_tp = scAjaxGetFieldText(nomeCampo_tp);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_hta_mob_validate_tp(var_tp, var_script_case_init, do_ajax_control_hta_mob_validate_tp_cb);
  } // do_ajax_control_hta_mob_validate_tp

  function do_ajax_control_hta_mob_validate_tp_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tp";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_hta_mob_validate_tp_cb

  // ---------- Validate uk
  function do_ajax_control_hta_mob_validate_uk()
  {
    var nomeCampo_uk = "uk";
    var var_uk = scAjaxGetFieldText(nomeCampo_uk);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_hta_mob_validate_uk(var_uk, var_script_case_init, do_ajax_control_hta_mob_validate_uk_cb);
  } // do_ajax_control_hta_mob_validate_uk

  function do_ajax_control_hta_mob_validate_uk_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "uk";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_hta_mob_validate_uk_cb

  // ---------- Event onchange hta
  function do_ajax_control_hta_mob_event_hta_onchange()
  {
    ...
    scAjaxProcOn(true);
    x_ajax_control_hta_mob_event_hta_onchange(var_hta, var_uk, var_tp, var_script_case_init, do_ajax_control_hta_mob_event_hta_onchange_cb);
  } // do_ajax_control_hta_mob_event_hta_onchange

  function do_ajax_control_hta_mob_event_hta_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "hta";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_control_hta_mob_event_hta_onchange_cb_after_alert);
  } // do_ajax_control_hta_mob_event_hta_onchange_cb
  function do_ajax_control_hta_mob_event_hta_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_control_hta_mob_event_hta_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_control_hta_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_control_hta_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_pasien = scAjaxGetFieldSelect("pasien");
    var var_hta = scAjaxGetFieldText("hta");
    var var_tp = scAjaxGetFieldText("tp");
    var var_uk = scAjaxGetFieldText("uk");
    ...
    scAjaxProcOn();
    x_ajax_control_hta_mob_submit_form(var_pasien, var_hta, var_tp, var_uk, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_control_hta_mob_submit_form_cb);
  } // do_ajax_control_hta_mob_submit_form

  function do_ajax_control_hta_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_control_hta_mob_submit_form_cb_after_alert);
  } // do_ajax_control_hta_mob_submit_form_cb
  function do_ajax_control_hta_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_control_hta_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_control_hta_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_control_hta_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['control_hta_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_control_hta_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_control_hta_mob_navigate_form_cb_after_alert);
  } // do_ajax_control_hta_mob_navigate_form_cb
  function do_ajax_control_hta_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_control_hta_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_control_hta_mob_navigate_form_cb_after_alert
  function sc_hide_control_hta_mob_form()
  {
  ...
  ajax_field_list[0] = "pasien";
  ajax_field_list[1] = "hta";
  ajax_field_list[2] = "tp";
  ajax_field_list[3] = "uk";
