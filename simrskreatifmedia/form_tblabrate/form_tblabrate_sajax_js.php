  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tblabrate" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tblabrate_form();
	}

  // ---------- Validate kelas_
  function do_ajax_form_tblabrate_validate_kelas_(iNumLinha)
  {
    var nomeCampo_kelas_ = "kelas_" + iNumLinha;
    var var_kelas_ = scAjaxGetFieldSelect(nomeCampo_kelas_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblabrate_validate_kelas_(var_kelas_, iNumLinha, var_script_case_init, do_ajax_form_tblabrate_validate_kelas__cb);
  } // do_ajax_form_tblabrate_validate_kelas_

  function do_ajax_form_tblabrate_validate_kelas__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblabrate_validate_kelas__cb

  // ---------- Validate rate_
  function do_ajax_form_tblabrate_validate_rate_(iNumLinha)
  {
    var nomeCampo_rate_ = "rate_" + iNumLinha;
    var var_rate_ = scAjaxGetFieldText(nomeCampo_rate_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblabrate_validate_rate_(var_rate_, iNumLinha, var_script_case_init, do_ajax_form_tblabrate_validate_rate__cb);
  } // do_ajax_form_tblabrate_validate_rate_

  function do_ajax_form_tblabrate_validate_rate__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblabrate_validate_rate__cb

  // ---------- Validate share_
  function do_ajax_form_tblabrate_validate_share_(iNumLinha)
  {
    var nomeCampo_share_ = "share_" + iNumLinha;
    var var_share_ = scAjaxGetFieldText(nomeCampo_share_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblabrate_validate_share_(var_share_, iNumLinha, var_script_case_init, do_ajax_form_tblabrate_validate_share__cb);
  } // do_ajax_form_tblabrate_validate_share_

  function do_ajax_form_tblabrate_validate_share__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblabrate_validate_share__cb

  // ---------- Validate lastupdated_
  function do_ajax_form_tblabrate_validate_lastupdated_(iNumLinha)
  {
    var nomeCampo_lastupdated_ = "lastupdated_" + iNumLinha;
    var var_lastupdated_ = scAjaxGetFieldText(nomeCampo_lastupdated_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblabrate_validate_lastupdated_(var_lastupdated_, iNumLinha, var_script_case_init, do_ajax_form_tblabrate_validate_lastupdated__cb);
  } // do_ajax_form_tblabrate_validate_lastupdated_

  function do_ajax_form_tblabrate_validate_lastupdated__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblabrate_validate_lastupdated__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_tblabrate_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_tblabrate_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tblabrate_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_tblabrate_add_new_line_cb);
  } // do_ajax_form_tblabrate_add_new_line

  function do_ajax_form_tblabrate_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_tblabrate_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_tblabrate_backup_line(iNumLinha)
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblabrate_backup_line(var_labcode_, var_kelas_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_tblabrate_backup_line_cb);
  } // do_ajax_form_tblabrate_backup_line

  function do_ajax_form_tblabrate_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_tblabrate_backup_line_cb

  function do_ajax_form_tblabrate_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_tblabrate_cancel_insert

  function do_ajax_form_tblabrate_cancel_update(iSeqVert)
  {
    do_ajax_form_tblabrate_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_tblabrate_cancel_update

  function do_ajax_form_tblabrate_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_tblabrate_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_tblabrate_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_tblabrate_table_refresh(var_labcode_, var_kelas_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tblabrate_table_refresh_cb);
  } //  do_ajax_form_tblabrate_table_refresh

  function do_ajax_form_tblabrate_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_tblabrate_table_refresh_cb_after_alert);
  } // do_ajax_form_tblabrate_table_refresh_cb
  function do_ajax_form_tblabrate_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_tblabrate_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_tblabrate_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_tblabrate_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
...
?>
    x_ajax_form_tblabrate_submit_form(var_kelas_, var_rate_, var_share_, var_lastupdated_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tblabrate_submit_form_cb);
  } // do_ajax_form_tblabrate_submit_form

  function do_ajax_form_tblabrate_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_tblabrate_submit_form_cb_after_alert);
  } // do_ajax_form_tblabrate_submit_form_cb
  function do_ajax_form_tblabrate_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tblabrate_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tblabrate_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_tblabrate_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tblabrate_navigate_form(var_labcode_, var_kelas_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tblabrate_navigate_form_cb);
  } // do_ajax_form_tblabrate_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblabrate']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tblabrate_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tblabrate_navigate_form_cb_after_alert);
  } // do_ajax_form_tblabrate_navigate_form_cb
  function do_ajax_form_tblabrate_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_tblabrate_navigate_form_cb_after_alert
  function sc_hide_form_tblabrate_form()
  {
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    ajax_error_list["rate_" + iNumLinha] = {"label": "Rate<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["kelas_" + iRow] || "on" == ajax_error_count["rate_" + iRow] || "on" == ajax_error_count["share_" + iRow] || "on" == ajax_error_count["lastupdated_" + iRow]))
    {
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["kelas_" + iRow] && "off" == ajax_error_count["rate_" + iRow] && "off" == ajax_error_count["share_" + iRow] && "off" == ajax_error_count["lastupdated_" + iRow]))
    {
      if (bErrorRow)
      {
