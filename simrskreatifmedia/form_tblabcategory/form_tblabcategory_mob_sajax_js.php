  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tblabcategory_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tblabcategory_mob_form();
	}

  // ---------- Validate kategori
  function do_ajax_form_tblabcategory_mob_validate_kategori()
  {
    var nomeCampo_kategori = "kategori";
    var var_kategori = scAjaxGetFieldText(nomeCampo_kategori);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblabcategory_mob_validate_kategori(var_kategori, var_script_case_init, do_ajax_form_tblabcategory_mob_validate_kategori_cb);
  } // do_ajax_form_tblabcategory_mob_validate_kategori

  function do_ajax_form_tblabcategory_mob_validate_kategori_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblabcategory_mob_validate_kategori_cb

  // ---------- Validate jenis
  function do_ajax_form_tblabcategory_mob_validate_jenis()
  {
    var nomeCampo_jenis = "jenis";
    var var_jenis = scAjaxGetFieldText(nomeCampo_jenis);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblabcategory_mob_validate_jenis(var_jenis, var_script_case_init, do_ajax_form_tblabcategory_mob_validate_jenis_cb);
  } // do_ajax_form_tblabcategory_mob_validate_jenis

  function do_ajax_form_tblabcategory_mob_validate_jenis_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "jenis";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblabcategory_mob_validate_jenis_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tblabcategory_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tblabcategory_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_tblabcategory_mob_submit_form(var_kategori, var_jenis, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tblabcategory_mob_submit_form_cb);
  } // do_ajax_form_tblabcategory_mob_submit_form

  function do_ajax_form_tblabcategory_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tblabcategory_mob_submit_form_cb_after_alert);
  } // do_ajax_form_tblabcategory_mob_submit_form_cb
  function do_ajax_form_tblabcategory_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tblabcategory_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tblabcategory_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("kategori");
    scAjaxHideErrorDisplay("jenis");
    var var_kategori = document.F2.kategori.value;
    var var_jenis = document.F2.jenis.value;
    ...
    scAjaxProcOn();
    x_ajax_form_tblabcategory_mob_navigate_form(var_kategori, var_jenis, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tblabcategory_mob_navigate_form_cb);
  } // do_ajax_form_tblabcategory_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblabcategory_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tblabcategory_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.kategori.value = scAjaxGetKeyValue("kategori");
    document.F2.jenis.value = scAjaxGetKeyValue("jenis");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tblabcategory_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_tblabcategory_mob_navigate_form_cb
  function do_ajax_form_tblabcategory_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_tblabcategory_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_tblabcategory_mob_navigate_form_cb_after_alert
  function sc_hide_form_tblabcategory_mob_form()
  {
