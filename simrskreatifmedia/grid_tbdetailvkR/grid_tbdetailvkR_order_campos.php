...
<?php
   ...
   $Ord_Cmp = new grid_tbdetailvkR_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_tbdetailvkR_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbdetailvkR']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tbdetailvkR']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["trancode"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbdetailvkR']['labels']["trancode"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbdetailvkR']['labels']["trancode"] : "Kode Transaksi";
   $tab_ger_campos['custcode'] = "on";
   $tab_def_campos['custcode'] = "custCode";
   $tab_labels["custcode"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbdetailvkR']['labels']["custcode"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbdetailvkR']['labels']["custcode"] : "No. RM";
...
ORDER BY name, salut";
   ...
   $tab_labels["sc_field_0"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbdetailvkR']['labels']["sc_field_0"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbdetailvkR']['labels']["sc_field_0"] : "Nama Pasien";
   $tab_ger_campos['inapcode'] = "on";
   $tab_def_campos['inapcode'] = "inapCode";
   $tab_labels["inapcode"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbdetailvkR']['labels']["inapcode"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbdetailvkR']['labels']["inapcode"] : "Kode Inap";
   $tab_ger_campos['intime'] = "on";
   $tab_def_campos['intime'] = "inTime";
   $tab_labels["intime"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbdetailvkR']['labels']["intime"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbdetailvkR']['labels']["intime"] : "Tgl. Masuk VK";
   $tab_ger_campos['diagpre'] = "on";
   $tab_def_campos['diagpre'] = "diagPre";
   $tab_labels["diagpre"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbdetailvkR']['labels']["diagpre"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbdetailvkR']['labels']["diagpre"] : "Diagnosa Pre Tindakan";
   $tab_ger_campos['diagpost'] = "on";
   $tab_def_campos['diagpost'] = "diagPost";
   $tab_labels["diagpost"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbdetailvkR']['labels']["diagpost"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbdetailvkR']['labels']["diagpost"] : "Diagnosa Post Tindakan";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_tbdetailvkR']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_tbdetailvkR']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_tbdetailvkR']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbdetailvkR']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tbdetailvkR']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_tbdetailvkR']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_tbdetailvkR']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_tbdetailvkR']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_tbdetailvkR']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_tbdetailvkR_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_tbdetailvkR']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_tbdetailvkR']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_tbdetailvkR']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_tbdetailvkR']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_tbdetailvkR']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
