...
class grid_tbdetailvkR_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_tbdetailvkR_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_tbdetailvkR_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_tbdetailvkR_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_tbdetailvkR/grid_tbdetailvkR_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_tbdetailvkR_ajax_search.js"></script>
 <script type="text/javascript" src="grid_tbdetailvkR_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_tbdetailvkR_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_tbdetailvkR']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_tbdetailvkR']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<?php
   ...
   function monta_form()
   {
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_tbdetailvkR']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_tbdetailvkR']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['grid_tbdetailvkR']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("grid_tbdetailvkR", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $babybirth = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['babybirth']; 
          $babybirth_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['babybirth_cond']; 
          $id = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['id']; 
          $id_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['id_cond']; 
          $trancode = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['trancode']; 
          $trancode_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['trancode_cond']; 
          $custcode = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['custcode']; 
          $custcode_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['custcode_cond']; 
          $birthdate_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['birthdate_dia']; 
          $birthdate_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['birthdate_mes']; 
          $birthdate_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['birthdate_ano']; 
          $birthdate_hor = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['birthdate_hor']; 
          $birthdate_min = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['birthdate_min']; 
          $birthdate_seg = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['birthdate_seg']; 
          $birthdate_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['birthdate_cond']; 
          $birthtime = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['birthtime']; 
          $birthtime_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['birthtime_cond']; 
          $bb = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['bb']; 
          $bb_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['bb_cond']; 
          $tb = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['tb']; 
          $tb_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['tb_cond']; 
          $lingkar = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['lingkar']; 
          $lingkar_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['lingkar_cond']; 
          $hidup = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['hidup']; 
          $hidup_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['hidup_cond']; 
          $anestime_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['anestime_dia']; 
          $anestime_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['anestime_mes']; 
          $anestime_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['anestime_ano']; 
          $anestime_hor = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['anestime_hor']; 
          $anestime_min = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['anestime_min']; 
          $anestime_seg = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['anestime_seg']; 
          $anestime_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['anestime_cond']; 
          $intime_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['intime_dia']; 
          $intime_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['intime_mes']; 
          $intime_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['intime_ano']; 
          $intime_hor = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['intime_hor']; 
          $intime_min = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['intime_min']; 
          $intime_seg = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['intime_seg']; 
          $intime_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['intime_cond']; 
          $outtime_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['outtime_dia']; 
          $outtime_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['outtime_mes']; 
          $outtime_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['outtime_ano']; 
          $outtime_hor = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['outtime_hor']; 
          $outtime_min = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['outtime_min']; 
          $outtime_seg = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['outtime_seg']; 
          $outtime_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['outtime_cond']; 
          $pa = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['pa']; 
          $pa_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['pa_cond']; 
          $cito = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['cito']; 
          $cito_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['cito_cond']; 
          $citoproc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['citoproc']; 
          $citoproc_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['citoproc_cond']; 
          $diagpre = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['diagpre']; 
          $diagpre_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['diagpre_cond']; 
          $diagpost = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['diagpost']; 
          $diagpost_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['diagpost_cond']; 
          $trandate_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['trandate_dia']; 
          $trandate_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['trandate_mes']; 
          $trandate_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['trandate_ano']; 
          $trandate_hor = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['trandate_hor']; 
          $trandate_min = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['trandate_min']; 
          $trandate_seg = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['trandate_seg']; 
          $trandate_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['trandate_cond']; 
          $class = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['class']; 
          $class_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['class_cond']; 
          $awalobs_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['awalobs_dia']; 
          $awalobs_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['awalobs_mes']; 
          $awalobs_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['awalobs_ano']; 
          $awalobs_hor = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['awalobs_hor']; 
          $awalobs_min = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['awalobs_min']; 
          $awalobs_seg = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['awalobs_seg']; 
          $awalobs_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['awalobs_cond']; 
          $akhirobs_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['akhirobs_dia']; 
          $akhirobs_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['akhirobs_mes']; 
          $akhirobs_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['akhirobs_ano']; 
          $akhirobs_hor = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['akhirobs_hor']; 
          $akhirobs_min = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['akhirobs_min']; 
          $akhirobs_seg = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['akhirobs_seg']; 
          $akhirobs_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['akhirobs_cond']; 
          $inapcode = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['inapcode']; 
          $inapcode_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['inapcode_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['NM_operador']; 
      } 
...
?>
 ...
 <?php echo $date_format_show ?>         </SPAN>
      ...
      <TD id='SC_intime_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['intime'])) ? $this->New_label['intime'] : "Tgl. Masuk VK"; ?></TD>
...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_cito" name="cito_autocomp" size="15"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 15, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_citoproc_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['citoproc'])) ? $this->New_label['citoproc'] : "Cito Proc"; ?></TD>
      
      <INPUT type="hidden" id="SC_citoproc_cond" name="citoproc_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_citoproc" <?php echo $str_hide_citoproc?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
...
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_citoproc" name="citoproc_autocomp" size="12"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 12, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
      ...
      <TD id='SC_diagpre_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['diagpre'])) ? $this->New_label['diagpre'] : "Diagnosa Pre Tindakan"; ?></TD>
...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_diagpre" name="diagpre_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 200, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_diagpost_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['diagpost'])) ? $this->New_label['diagpost'] : "Diagnosa Post Tindakan"; ?></TD>
...
?>
 ...
 <?php echo $date_format_show ?>         </SPAN>
      ...
      <TD id='SC_class_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['class'])) ? $this->New_label['class'] : "Class"; ?></TD>
...
?>
 ...
 <?php echo $date_format_show ?>         </SPAN>
      ...
      <TD id='SC_inapcode_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['inapcode'])) ? $this->New_label['inapcode'] : "Kode Inap"; ?></TD>
...
?>
<?php
   if (is_file("grid_tbdetailvkR_help.txt"))
   {
      $Arq_WebHelp = file("grid_tbdetailvkR_help.txt"); 
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_tbdetailvkR']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_tbdetailvkR']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['orig_pesq'] == "grid")
   {
...
?>
 ...
 {
    $('#SC_akhirobs_dia').bind('change', function() {sc_grid_tbdetailvkR_valida_dia(this)});
    $('#SC_akhirobs_hor').bind('change', function() {sc_grid_tbdetailvkR_valida_hora(this)});
    $('#SC_akhirobs_mes').bind('change', function() {sc_grid_tbdetailvkR_valida_mes(this)});
    $('#SC_akhirobs_min').bind('change', function() {sc_grid_tbdetailvkR_valida_min(this)});
    $('#SC_akhirobs_seg').bind('change', function() {sc_grid_tbdetailvkR_valida_seg(this)});
    $('#SC_anestime_dia').bind('change', function() {sc_grid_tbdetailvkR_valida_dia(this)});
    $('#SC_anestime_hor').bind('change', function() {sc_grid_tbdetailvkR_valida_hora(this)});
    $('#SC_anestime_mes').bind('change', function() {sc_grid_tbdetailvkR_valida_mes(this)});
    $('#SC_anestime_min').bind('change', function() {sc_grid_tbdetailvkR_valida_min(this)});
    $('#SC_anestime_seg').bind('change', function() {sc_grid_tbdetailvkR_valida_seg(this)});
    $('#SC_awalobs_dia').bind('change', function() {sc_grid_tbdetailvkR_valida_dia(this)});
    $('#SC_awalobs_hor').bind('change', function() {sc_grid_tbdetailvkR_valida_hora(this)});
    $('#SC_awalobs_mes').bind('change', function() {sc_grid_tbdetailvkR_valida_mes(this)});
    $('#SC_awalobs_min').bind('change', function() {sc_grid_tbdetailvkR_valida_min(this)});
    $('#SC_awalobs_seg').bind('change', function() {sc_grid_tbdetailvkR_valida_seg(this)});
    $('#SC_birthdate_dia').bind('change', function() {sc_grid_tbdetailvkR_valida_dia(this)});
    $('#SC_birthdate_hor').bind('change', function() {sc_grid_tbdetailvkR_valida_hora(this)});
    $('#SC_birthdate_mes').bind('change', function() {sc_grid_tbdetailvkR_valida_mes(this)});
    $('#SC_birthdate_min').bind('change', function() {sc_grid_tbdetailvkR_valida_min(this)});
    $('#SC_birthdate_seg').bind('change', function() {sc_grid_tbdetailvkR_valida_seg(this)});
    $('#SC_intime_dia').bind('change', function() {sc_grid_tbdetailvkR_valida_dia(this)});
    $('#SC_intime_hor').bind('change', function() {sc_grid_tbdetailvkR_valida_hora(this)});
    $('#SC_intime_mes').bind('change', function() {sc_grid_tbdetailvkR_valida_mes(this)});
    $('#SC_intime_min').bind('change', function() {sc_grid_tbdetailvkR_valida_min(this)});
    $('#SC_intime_seg').bind('change', function() {sc_grid_tbdetailvkR_valida_seg(this)});
    $('#SC_outtime_dia').bind('change', function() {sc_grid_tbdetailvkR_valida_dia(this)});
    $('#SC_outtime_hor').bind('change', function() {sc_grid_tbdetailvkR_valida_hora(this)});
    $('#SC_outtime_mes').bind('change', function() {sc_grid_tbdetailvkR_valida_mes(this)});
    $('#SC_outtime_min').bind('change', function() {sc_grid_tbdetailvkR_valida_min(this)});
    $('#SC_outtime_seg').bind('change', function() {sc_grid_tbdetailvkR_valida_seg(this)});
    $('#SC_trandate_dia').bind('change', function() {sc_grid_tbdetailvkR_valida_dia(this)});
    $('#SC_trandate_hor').bind('change', function() {sc_grid_tbdetailvkR_valida_hora(this)});
    $('#SC_trandate_mes').bind('change', function() {sc_grid_tbdetailvkR_valida_mes(this)});
    $('#SC_trandate_min').bind('change', function() {sc_grid_tbdetailvkR_valida_min(this)});
    $('#SC_trandate_seg').bind('change', function() {sc_grid_tbdetailvkR_valida_seg(this)});
 }
 function sc_grid_tbdetailvkR_valida_dia(obj)
 {
 ...
 function sc_grid_tbdetailvkR_valida_mes(obj)
 {
 ...
 function sc_grid_tbdetailvkR_valida_hora(obj)
 {
 ...
 function sc_grid_tbdetailvkR_valida_min(obj)
 {
 ...
 function sc_grid_tbdetailvkR_valida_seg(obj)
 {
     if (obj.value != "" && (obj.value < 0 || obj.value > 59))
     {
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "simrskreatifmedia/grid_tbdetailvkR";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function trata_campos()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['babybirth'] = $babybirth; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['babybirth_cond'] = $babybirth_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['id'] = $id; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['id_cond'] = $id_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['trancode'] = $trancode; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['trancode_cond'] = $trancode_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['custcode'] = $custcode; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['custcode_cond'] = $custcode_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['birthdate_dia'] = $birthdate_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['birthdate_mes'] = $birthdate_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['birthdate_ano'] = $birthdate_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['birthdate_hor'] = $birthdate_hor; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['birthdate_min'] = $birthdate_min; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['birthdate_seg'] = $birthdate_seg; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['birthdate_cond'] = $birthdate_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['birthtime'] = $birthtime; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['birthtime_cond'] = $birthtime_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['bb'] = $bb; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['bb_cond'] = $bb_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['tb'] = $tb; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['tb_cond'] = $tb_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['lingkar'] = $lingkar; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['lingkar_cond'] = $lingkar_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['hidup'] = $hidup; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['hidup_cond'] = $hidup_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['anestime_dia'] = $anestime_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['anestime_mes'] = $anestime_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['anestime_ano'] = $anestime_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['anestime_hor'] = $anestime_hor; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['anestime_min'] = $anestime_min; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['anestime_seg'] = $anestime_seg; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['anestime_cond'] = $anestime_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['intime_dia'] = $intime_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['intime_mes'] = $intime_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['intime_ano'] = $intime_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['intime_hor'] = $intime_hor; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['intime_min'] = $intime_min; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['intime_seg'] = $intime_seg; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['intime_cond'] = $intime_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['outtime_dia'] = $outtime_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['outtime_mes'] = $outtime_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['outtime_ano'] = $outtime_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['outtime_hor'] = $outtime_hor; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['outtime_min'] = $outtime_min; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['outtime_seg'] = $outtime_seg; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['outtime_cond'] = $outtime_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['pa'] = $pa; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['pa_cond'] = $pa_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['cito'] = $cito; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['cito_cond'] = $cito_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['citoproc'] = $citoproc; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['citoproc_cond'] = $citoproc_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['diagpre'] = $diagpre; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['diagpre_cond'] = $diagpre_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['diagpost'] = $diagpost; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['diagpost_cond'] = $diagpost_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['trandate_dia'] = $trandate_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['trandate_mes'] = $trandate_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['trandate_ano'] = $trandate_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['trandate_hor'] = $trandate_hor; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['trandate_min'] = $trandate_min; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['trandate_seg'] = $trandate_seg; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['trandate_cond'] = $trandate_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['class'] = $class; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['class_cond'] = $class_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['awalobs_dia'] = $awalobs_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['awalobs_mes'] = $awalobs_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['awalobs_ano'] = $awalobs_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['awalobs_hor'] = $awalobs_hor; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['awalobs_min'] = $awalobs_min; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['awalobs_seg'] = $awalobs_seg; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['awalobs_cond'] = $awalobs_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['akhirobs_dia'] = $akhirobs_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['akhirobs_mes'] = $akhirobs_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['akhirobs_ano'] = $akhirobs_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['akhirobs_hor'] = $akhirobs_hor; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['akhirobs_min'] = $akhirobs_min; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['akhirobs_seg'] = $akhirobs_seg; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['akhirobs_cond'] = $akhirobs_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['inapcode'] = $inapcode; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['inapcode_cond'] = $inapcode_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca'] = $Temp_Busca;
      }
   ...
   { 
      ...
      if ($birthdate_cond != "bi_TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['birthdate'] = $val[0];
          ...
          if ($birthdate_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['birthdate_input_2'] = $val[1];
      ...
      if ($anestime_cond != "bi_TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['anestime'] = $val[0];
          ...
          if ($anestime_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['anestime_input_2'] = $val[1];
      ...
      if ($intime_cond != "bi_TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['intime'] = $val[0];
          ...
          if ($intime_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['intime_input_2'] = $val[1];
      ...
      if ($outtime_cond != "bi_TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['outtime'] = $val[0];
          ...
          if ($outtime_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['outtime_input_2'] = $val[1];
      ...
      if ($trandate_cond != "bi_TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['trandate'] = $val[0];
          ...
          if ($trandate_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['trandate_input_2'] = $val[1];
      ...
      if ($awalobs_cond != "bi_TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['awalobs'] = $val[0];
          ...
          if ($awalobs_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['awalobs_input_2'] = $val[1];
      ...
      if ($akhirobs_cond != "bi_TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['akhirobs'] = $val[0];
          ...
          if ($akhirobs_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']['akhirobs_input_2'] = $val[1];
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbdetailvkR']['cond_pesq'] .= $this->NM_operador;
