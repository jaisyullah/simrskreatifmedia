<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tbdetailvkR']['sc_process_barr'] = true;
require_once('../grid_tbdetailvkR/index.php');
unset($_SESSION['scriptcase']['grid_tbdetailvkR']['sc_process_barr']);
$ExportCtrl = new grid_tbdetailvkR_export_control;
$ExportCtrl->Export_barr();

class grid_tbdetailvkR_export_control
{
