<?php
class form_tbreseprawatinap_new_form extends form_tbreseprawatinap_new_apl
{
function Form_Init()
{
...
<HEAD>
 <TITLE><?php if ('novo' == $this->nmgp_opcao) { echo strip_tags("" . $this->Ini->Nm_lang['lang_othr_frmi_title'] . " Resep Ranap"); } else { echo strip_tags("" . $this->Ini->Nm_lang['lang_othr_frmu_title'] . " Resep Ranap"); } ?></TITLE>
...
<?php
if ($this->Embutida_form && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatinap_new']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatinap_new']['sc_modal'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatinap_new']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatinap_new']['sc_redir_atualiz'] == 'ok')
{
?>
...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatinap_new']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_tbreseprawatinap_new/form_tbreseprawatinap_new_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
include_once('form_tbreseprawatinap_new_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatinap_new']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatinap_new']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatinap_new']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatinap_new']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatinap_new']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatinap_new']['recarga'];
}
if ('novo' == $opcao_botoes && $this->Embutida_form)
{
    $opcao_botoes = 'inicio';
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatinap_new']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatinap_new']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
?>
...
<?php
 include_once("form_tbreseprawatinap_new_js0.php");
?>
<script type="text/javascript"> 
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_tbreseprawatinap_new'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_tbreseprawatinap_new'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatinap_new']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatinap_new']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatinap_new']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatinap_new']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatinap_new']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<div class="scFormHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFormHeaderFont" style="float: left; text-transform: uppercase;"><?php if ($this->nmgp_opcao == "novo") { echo "" . $this->Ini->Nm_lang['lang_othr_frmi_title'] . " Resep Ranap"; } else { echo "" . $this->Ini->Nm_lang['lang_othr_frmu_title'] . " Resep Ranap"; } ?></div>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatinap_new']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatinap_new']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatinap_new']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatinap_new']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatinap_new']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatinap_new']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatinap_new']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatinap_new']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatinap_new']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatinap_new']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatinap_new']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatinap_new']['fast_search'][2] : "";
?> 
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatinap_new']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatinap_new']['run_iframe'] != "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatinap_new']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatinap_new']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatinap_new']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatinap_new']['run_iframe'] == "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatinap_new']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatinap_new']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatinap_new']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatinap_new']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatinap_new']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatinap_new']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatinap_new']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatinap_new']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatinap_new']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatinap_new']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatinap_new']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatinap_new']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
   ...
   if (!isset($this->nmgp_cmp_hidden['strukresep_']))
   {
...
<?php
 ...
 ?>
   ...
   <?php if (isset($this->nmgp_cmp_hidden['etiket_']) && $this->nmgp_cmp_hidden['etiket_'] == 'off') { $sStyleHidden_etiket_ = 'display: none'; }
      if (1 || !isset($this->nmgp_cmp_hidden['etiket_']) || $this->nmgp_cmp_hidden['etiket_'] == 'on') {
      if (!isset($this->nm_new_label['etiket_'])) {
          $this->nm_new_label['etiket_'] = "Etiket"; } ?>

    <TD class="scFormLabelOddMult css_etiket__label" id="hidden_field_label_etiket_" style="<?php echo $sStyleHidden_etiket_; ?>" > <?php echo $this->nm_new_label['etiket_'] ?> </TD>
   <?php } ?>
...
{ 
   ...
   { 
       ob_start();
       $iStart = sizeof($this->form_vert_form_tbreseprawatinap_new);
       $guarda_nmgp_opcao = $this->nmgp_opcao;
       $guarda_form_vert_form_tbreseprawatinap_new = $this->form_vert_form_tbreseprawatinap_new;
       $this->nmgp_opcao = 'novo';
   } 
   if ($this->Embutida_form && empty($this->form_vert_form_tbreseprawatinap_new))
   {
       $sc_seq_vert = 0;
   }
   ...
   foreach ($this->form_vert_form_tbreseprawatinap_new as $sc_seq_vert => $sc_lixo)
   {
       $this->loadRecordState($sc_seq_vert);
       $this->trandate_ = $this->form_vert_form_tbreseprawatinap_new[$sc_seq_vert]['trandate_'];
       if (isset($this->Embutida_ronly) && $this->Embutida_ronly && !$Line_Add)
       {
           ...
           $this->nmgp_cmp_readonly['etiket_'] = true;
       ...
       elseif ($Line_Add)
       {
           ...
           if (!isset($this->nmgp_cmp_readonly['etiket_']) || $this->nmgp_cmp_readonly['etiket_'] != "on") {$this->nmgp_cmp_readonly['etiket_'] = false;}
       ...
       $this->satuan_ = $this->form_vert_form_tbreseprawatinap_new[$sc_seq_vert]['satuan_']; 
       ...
       $this->jumlah_ = $this->form_vert_form_tbreseprawatinap_new[$sc_seq_vert]['jumlah_']; 
       ...
       $this->signa_ = $this->form_vert_form_tbreseprawatinap_new[$sc_seq_vert]['signa_']; 
       $signa_ = $this->signa_; 
       $sStyleHidden_signa_ = '';
       ...
       $this->jenisaturanpakai_ = $this->form_vert_form_tbreseprawatinap_new[$sc_seq_vert]['jenisaturanpakai_']; 
       ...
       $this->biaya_ = $this->form_vert_form_tbreseprawatinap_new[$sc_seq_vert]['biaya_']; 
       $biaya_ = $this->biaya_; 
       $sStyleHidden_biaya_ = '';
       ...
       $this->diskon_ = $this->form_vert_form_tbreseprawatinap_new[$sc_seq_vert]['diskon_']; 
       ...
       $this->retur_ = $this->form_vert_form_tbreseprawatinap_new[$sc_seq_vert]['retur_']; 
       $retur_ = $this->retur_; 
       $sStyleHidden_retur_ = '';
       ...
       $this->id_ = $this->form_vert_form_tbreseprawatinap_new[$sc_seq_vert]['id_']; 
       $id_ = $this->id_; 
       if (!isset($this->nmgp_cmp_hidden['id_']))
       {
           $this->nmgp_cmp_hidden['id_'] = 'off';
       ...
       $this->etiket_ = $this->form_vert_form_tbreseprawatinap_new[$sc_seq_vert]['etiket_']; 
       $etiket_ = $this->etiket_; 
       $sStyleHidden_etiket_ = '';
       if (isset($sCheckRead_etiket_))
       {
           unset($sCheckRead_etiket_);
       }
       if (isset($this->nmgp_cmp_readonly['etiket_']))
       {
           $sCheckRead_etiket_ = $this->nmgp_cmp_readonly['etiket_'];
       }
       if (isset($this->nmgp_cmp_hidden['etiket_']) && $this->nmgp_cmp_hidden['etiket_'] == 'off')
       {
           unset($this->nmgp_cmp_hidden['etiket_']);
           $sStyleHidden_etiket_ = 'display: none;';
       }
       $bTestReadOnly_etiket_ = true;
       $sStyleReadLab_etiket_ = 'display: none;';
       $sStyleReadInp_etiket_ = '';
       if (isset($this->nmgp_cmp_readonly['etiket_']) && $this->nmgp_cmp_readonly['etiket_'] == 'on')
       {
           $bTestReadOnly_etiket_ = false;
           unset($this->nmgp_cmp_readonly['etiket_']);
           $sStyleReadLab_etiket_ = '';
           $sStyleReadInp_etiket_ = 'display: none;';
       }
       $this->trancode_ = $this->form_vert_form_tbreseprawatinap_new[$sc_seq_vert]['trancode_']; 
       ...
       $this->strukresep_ = $this->form_vert_form_tbreseprawatinap_new[$sc_seq_vert]['strukresep_']; 
...
<?php echo nmButtonOutput($this->arr_buttons, "bmd_novo", "do_ajax_form_tbreseprawatinap_new_add_new_line(" . $sc_seq_vert . ")", "do_ajax_form_tbreseprawatinap_new_add_new_line(" . $sc_seq_vert . ")", "sc_new_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
<?php }?>
<?php
  $Style_add_line = (!$Line_Add) ? "display: none" : "";
?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_form_tbreseprawatinap_new_cancel_insert(" . $sc_seq_vert . ")", "do_ajax_form_tbreseprawatinap_new_cancel_insert(" . $sc_seq_vert . ")", "sc_canceli_line_" . $sc_seq_vert . "", "", "", "" . $Style_add_line . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_form_tbreseprawatinap_new_cancel_update(" . $sc_seq_vert . ")", "do_ajax_form_tbreseprawatinap_new_cancel_update(" . $sc_seq_vert . ")", "sc_cancelu_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
 </TD>
   <?php }?>
...
<span id="id_read_on_biaya_<?php echo $sc_seq_vert ?>" class="sc-ui-readonly-biaya_<?php echo $sc_seq_vert ?> css_biaya__line" style="<?php echo $sStyleReadLab_biaya_; ?>"><?php echo $this->biaya_; ?></span><span id="id_read_off_biaya_<?php echo $sc_seq_vert ?>" class="css_read_off_biaya_" style="white-space: nowrap;<?php echo $sStyleReadInp_biaya_; ?>">
 ...
 size=8 alt="{datatype: 'integer', maxLength: 8, thousandsSep: '<?php echo str_replace("'", "\'", $this->field_config['biaya_']['symbol_grp']); ?>', thousandsFormat: <?php echo $this->field_config['biaya_']['symbol_fmt']; ?>, allowNegative: false, onlyNegative: false, negativePos: <?php echo (4 == $this->field_config['biaya_']['format_neg'] ? "'suffix'" : "'prefix'") ?>, alignment: 'left', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddMultWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
...
<span id="id_read_on_retur_<?php echo $sc_seq_vert ?>" class="sc-ui-readonly-retur_<?php echo $sc_seq_vert ?> css_retur__line" style="<?php echo $sStyleReadLab_retur_; ?>"><?php echo $this->retur_; ?></span><span id="id_read_off_retur_<?php echo $sc_seq_vert ?>" class="css_read_off_retur_" style="white-space: nowrap;<?php echo $sStyleReadInp_retur_; ?>">
 <input class="sc-js-input scFormObjectOddMult scFormObjectOddMultSpin scSpin_retur__obj css_retur__obj" style="" id="id_sc_field_retur_<?php echo $sc_seq_vert ?>" type=text name="retur_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($retur_) ?>"
...
<?php }?>
   ...
   <?php if (isset($this->nmgp_cmp_hidden['etiket_']) && $this->nmgp_cmp_hidden['etiket_'] == 'off') { $sc_hidden_yes++;  ?>
<input type="hidden" name="etiket_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($etiket_) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormDataOddMult css_etiket__line" id="hidden_field_data_etiket_<?php echo $sc_seq_vert; ?>" style="<?php echo $sStyleHidden_etiket_; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOddMult css_etiket__line" style="vertical-align: top;padding: 0px">
<?php if ($bTestReadOnly_etiket_ && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["etiket_"]) &&  $this->nmgp_cmp_readonly["etiket_"] == "on") { 

 ?>
<input type="hidden" name="etiket_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($etiket_) . "\">" . $etiket_ . ""; ?>
<?php } else { ?>
<span id="id_read_on_etiket_<?php echo $sc_seq_vert ?>" class="sc-ui-readonly-etiket_<?php echo $sc_seq_vert ?> css_etiket__line" style="<?php echo $sStyleReadLab_etiket_; ?>"><?php echo $this->etiket_; ?></span><span id="id_read_off_etiket_<?php echo $sc_seq_vert ?>" class="css_read_off_etiket_" style="white-space: nowrap;<?php echo $sStyleReadInp_etiket_; ?>">
 <input class="sc-js-input scFormObjectOddMult css_etiket__obj" style="" id="id_sc_field_etiket_<?php echo $sc_seq_vert ?>" type=text name="etiket_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($etiket_) ?>"
...
</td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_etiket_<?php echo $sc_seq_vert; ?>_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_etiket_<?php echo $sc_seq_vert; ?>_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
<?php   
       ...
       if (isset($sCheckRead_etiket_))
       {
           $this->nmgp_cmp_readonly['etiket_'] = $sCheckRead_etiket_;
       }
       if ('display: none;' == $sStyleHidden_etiket_)
       {
           $this->nmgp_cmp_hidden['etiket_'] = 'off';
       }
       if (isset($sCheckRead_trancode_))
       {
   ...
   { 
       ...
       $this->form_vert_form_tbreseprawatinap_new = $guarda_form_vert_form_tbreseprawatinap_new;
   } 
   if ($Table_refresh) 
   { 
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatinap_new']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatinap_new']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatinap_new']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatinap_new']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatinap_new']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatinap_new']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatinap_new']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatinap_new']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatinap_new']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<?php
if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatinap_new']['run_modal']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatinap_new']['run_modal'])
{
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatinap_new']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatinap_new']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_tbreseprawatinap_new");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_tbreseprawatinap_new");
 parent.scAjaxDetailHeight("form_tbreseprawatinap_new", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
<script type="text/javascript">
	function scBtnFn_sys_format_inc() {
		if ($("#sc_b_new_t.sc-unique-btn-1").length && $("#sc_b_new_t.sc-unique-btn-1").is(":visible")) {
			do_ajax_form_tbreseprawatinap_new_add_new_line(); return false;
			 return;
		}
...
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_tbreseprawatinap_new']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
