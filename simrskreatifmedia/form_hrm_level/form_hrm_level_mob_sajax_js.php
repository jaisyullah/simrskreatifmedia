  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_hrm_level_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_hrm_level_mob_form();
	}

  // ---------- Validate level
  function do_ajax_form_hrm_level_mob_validate_level()
  {
    var nomeCampo_level = "level";
    var var_level = scAjaxGetFieldText(nomeCampo_level);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_level_mob_validate_level(var_level, var_script_case_init, do_ajax_form_hrm_level_mob_validate_level_cb);
  } // do_ajax_form_hrm_level_mob_validate_level

  function do_ajax_form_hrm_level_mob_validate_level_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_level_mob_validate_level_cb

  // ---------- Validate aktif
  function do_ajax_form_hrm_level_mob_validate_aktif()
  {
    var nomeCampo_aktif = "aktif";
    var var_aktif = scAjaxGetFieldSelect(nomeCampo_aktif);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_hrm_level_mob_validate_aktif(var_aktif, var_script_case_init, do_ajax_form_hrm_level_mob_validate_aktif_cb);
  } // do_ajax_form_hrm_level_mob_validate_aktif

  function do_ajax_form_hrm_level_mob_validate_aktif_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "aktif";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_hrm_level_mob_validate_aktif_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_hrm_level_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_hrm_level_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_level = scAjaxGetFieldText("level");
    ...
    scAjaxProcOn();
    x_ajax_form_hrm_level_mob_submit_form(var_level, var_aktif, var_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_hrm_level_mob_submit_form_cb);
  } // do_ajax_form_hrm_level_mob_submit_form

  function do_ajax_form_hrm_level_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_hrm_level_mob_submit_form_cb_after_alert);
  } // do_ajax_form_hrm_level_mob_submit_form_cb
  function do_ajax_form_hrm_level_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_hrm_level_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_hrm_level_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_hrm_level_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_hrm_level_mob_navigate_form_cb);
  } // do_ajax_form_hrm_level_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_hrm_level_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_hrm_level_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_hrm_level_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_hrm_level_mob_navigate_form_cb
  function do_ajax_form_hrm_level_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_hrm_level_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_hrm_level_mob_navigate_form_cb_after_alert
  function sc_hide_form_hrm_level_mob_form()
  {
  ...
  var ajax_error_list = {
    "level": {"label": "Level", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  ajax_field_mult["level"][1] = "level";
  ajax_field_mult["aktif"][1] = "aktif";

  var ajax_field_id = {
    "level": new Array("hidden_field_label_level", "hidden_field_data_level"),
