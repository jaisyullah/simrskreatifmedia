...
<input type="hidden" name="jenisdiagnosa_" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['jenisdiagnosa_']); ?>">
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_tbdiagnosarawatjalan"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
function scForm_inline_submit(y, z) {
	Nm_Proc_Atualiz = true;
	do_ajax_form_tbdiagnosarawatjalan_submit_form(y, z);
...
{
   nm_field_disabled("kodeicdx_=disabled", "");
