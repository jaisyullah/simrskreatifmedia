  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbdiagnosarawatjalan" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbdiagnosarawatjalan_form();
	}

  // ---------- Validate kodeicdx_
  function do_ajax_form_tbdiagnosarawatjalan_validate_kodeicdx_(iNumLinha)
  {
    var nomeCampo_kodeicdx_ = "kodeicdx_" + iNumLinha;
    var var_kodeicdx_ = scAjaxGetFieldSelect(nomeCampo_kodeicdx_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdiagnosarawatjalan_validate_kodeicdx_(var_kodeicdx_, iNumLinha, var_script_case_init, do_ajax_form_tbdiagnosarawatjalan_validate_kodeicdx__cb);
  } // do_ajax_form_tbdiagnosarawatjalan_validate_kodeicdx_

  function do_ajax_form_tbdiagnosarawatjalan_validate_kodeicdx__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "kodeicdx_" + iLineNumber;
    }
    else
    {
      sFieldValid = "kodeicdx_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "kodeicdx_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "kodeicdx_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdiagnosarawatjalan_validate_kodeicdx__cb

  // ---------- Validate namadiagnosa_
  function do_ajax_form_tbdiagnosarawatjalan_validate_namadiagnosa_(iNumLinha)
  {
  } // do_ajax_form_tbdiagnosarawatjalan_validate_namadiagnosa_

  function do_ajax_form_tbdiagnosarawatjalan_validate_namadiagnosa__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "namadiagnosa_" + iLineNumber;
    }
    else
    {
      sFieldValid = "namadiagnosa_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "namadiagnosa_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "namadiagnosa_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdiagnosarawatjalan_validate_namadiagnosa__cb

  // ---------- Validate jenisdiagnosa_
  function do_ajax_form_tbdiagnosarawatjalan_validate_jenisdiagnosa_(iNumLinha)
  {
    var nomeCampo_jenisdiagnosa_ = "jenisdiagnosa_" + iNumLinha;
    var var_jenisdiagnosa_ = scAjaxGetFieldSelect(nomeCampo_jenisdiagnosa_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdiagnosarawatjalan_validate_jenisdiagnosa_(var_jenisdiagnosa_, iNumLinha, var_script_case_init, do_ajax_form_tbdiagnosarawatjalan_validate_jenisdiagnosa__cb);
  } // do_ajax_form_tbdiagnosarawatjalan_validate_jenisdiagnosa_

  function do_ajax_form_tbdiagnosarawatjalan_validate_jenisdiagnosa__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "jenisdiagnosa_" + iLineNumber;
    }
    else
    {
      sFieldValid = "jenisdiagnosa_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "jenisdiagnosa_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "jenisdiagnosa_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdiagnosarawatjalan_validate_jenisdiagnosa__cb

  // ---------- Validate keterangan_
  function do_ajax_form_tbdiagnosarawatjalan_validate_keterangan_(iNumLinha)
  {
    var nomeCampo_keterangan_ = "keterangan_" + iNumLinha;
    var var_keterangan_ = scAjaxGetFieldText(nomeCampo_keterangan_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdiagnosarawatjalan_validate_keterangan_(var_keterangan_, iNumLinha, var_script_case_init, do_ajax_form_tbdiagnosarawatjalan_validate_keterangan__cb);
  } // do_ajax_form_tbdiagnosarawatjalan_validate_keterangan_

  function do_ajax_form_tbdiagnosarawatjalan_validate_keterangan__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdiagnosarawatjalan_validate_keterangan__cb

  // ---------- Validate tgldiagnosa_
  function do_ajax_form_tbdiagnosarawatjalan_validate_tgldiagnosa_(iNumLinha)
  {
    var nomeCampo_tgldiagnosa_ = "tgldiagnosa_" + iNumLinha;
    var var_tgldiagnosa_ = scAjaxGetFieldText(nomeCampo_tgldiagnosa_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdiagnosarawatjalan_validate_tgldiagnosa_(var_tgldiagnosa_, iNumLinha, var_script_case_init, do_ajax_form_tbdiagnosarawatjalan_validate_tgldiagnosa__cb);
  } // do_ajax_form_tbdiagnosarawatjalan_validate_tgldiagnosa_

  function do_ajax_form_tbdiagnosarawatjalan_validate_tgldiagnosa__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "tgldiagnosa_" + iLineNumber;
    }
    else
    {
      sFieldValid = "tgldiagnosa_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "tgldiagnosa_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "tgldiagnosa_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdiagnosarawatjalan_validate_tgldiagnosa__cb

  // ---------- Validate trancode_
  function do_ajax_form_tbdiagnosarawatjalan_validate_trancode_(iNumLinha)
  {
    var nomeCampo_trancode_ = "trancode_" + iNumLinha;
    var var_trancode_ = scAjaxGetFieldText(nomeCampo_trancode_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdiagnosarawatjalan_validate_trancode_(var_trancode_, iNumLinha, var_script_case_init, do_ajax_form_tbdiagnosarawatjalan_validate_trancode__cb);
  } // do_ajax_form_tbdiagnosarawatjalan_validate_trancode_

  function do_ajax_form_tbdiagnosarawatjalan_validate_trancode__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdiagnosarawatjalan_validate_trancode__cb

  // ---------- Refresh namadiagnosa_
  function do_ajax_form_tbdiagnosarawatjalan_refresh_namadiagnosa_(iSeqForm)
  {
    var var_namadiagnosa_ = scAjaxGetFieldText("namadiagnosa_" + iSeqForm);
    var var_nmgp_refresh_row = iSeqForm;
    var var_nmgp_refresh_fields = "kodeicdx_";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tbdiagnosarawatjalan_refresh_namadiagnosa_(var_namadiagnosa_, var_nmgp_refresh_row, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_tbdiagnosarawatjalan_refresh_namadiagnosa__cb);
  } // do_ajax_form_tbdiagnosarawatjalan_refresh_namadiagnosa_

  function do_ajax_form_tbdiagnosarawatjalan_refresh_namadiagnosa__cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbdiagnosarawatjalan_refresh_namadiagnosa__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_tbdiagnosarawatjalan_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_tbdiagnosarawatjalan_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tbdiagnosarawatjalan_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_tbdiagnosarawatjalan_add_new_line_cb);
  } // do_ajax_form_tbdiagnosarawatjalan_add_new_line

  function do_ajax_form_tbdiagnosarawatjalan_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
    ...
    nm_field_disabled("kodeicdx_=disabled", "", iAjaxNewLine);
  } // do_ajax_form_tbdiagnosarawatjalan_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_tbdiagnosarawatjalan_backup_line(iNumLinha)
  {
    var var_trancode_ = scAjaxGetFieldText("trancode_" + iNumLinha);
    var var_jenisdiagnosa_ = scAjaxGetFieldSelect("jenisdiagnosa_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbdiagnosarawatjalan_backup_line(var_trancode_, var_jenisdiagnosa_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_tbdiagnosarawatjalan_backup_line_cb);
  } // do_ajax_form_tbdiagnosarawatjalan_backup_line

  function do_ajax_form_tbdiagnosarawatjalan_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_tbdiagnosarawatjalan_backup_line_cb

  function do_ajax_form_tbdiagnosarawatjalan_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_tbdiagnosarawatjalan_cancel_insert

  function do_ajax_form_tbdiagnosarawatjalan_cancel_update(iSeqVert)
  {
    do_ajax_form_tbdiagnosarawatjalan_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_tbdiagnosarawatjalan_cancel_update

  function do_ajax_form_tbdiagnosarawatjalan_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_tbdiagnosarawatjalan_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_tbdiagnosarawatjalan_table_refresh()
  {
    var var_trancode_ = document.F2.trancode_.value;
    var var_jenisdiagnosa_ = document.F2.jenisdiagnosa_.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tbdiagnosarawatjalan_table_refresh(var_trancode_, var_jenisdiagnosa_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbdiagnosarawatjalan_table_refresh_cb);
  } //  do_ajax_form_tbdiagnosarawatjalan_table_refresh

  function do_ajax_form_tbdiagnosarawatjalan_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.jenisdiagnosa_.value = scAjaxGetKeyValue("jenisdiagnosa_");
    ...
    scAjaxAlert(do_ajax_form_tbdiagnosarawatjalan_table_refresh_cb_after_alert);
  } // do_ajax_form_tbdiagnosarawatjalan_table_refresh_cb
  function do_ajax_form_tbdiagnosarawatjalan_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxSetNavStatus("t");
    sc_insert_open = false;
  } // do_ajax_form_tbdiagnosarawatjalan_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_tbdiagnosarawatjalan_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_tbdiagnosarawatjalan_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    sc_num_ult_line = iNumLinha;
    sc_num_ult_tr   = indexTR;
    scAjaxHideMessage();
    var var_kodeicdx_ = scAjaxGetFieldSelect("kodeicdx_" + iNumLinha);
    var var_namadiagnosa_ = scAjaxGetFieldText("namadiagnosa_" + iNumLinha);
    var var_jenisdiagnosa_ = scAjaxGetFieldSelect("jenisdiagnosa_" + iNumLinha);
    var var_keterangan_ = scAjaxGetFieldText("keterangan_" + iNumLinha);
    var var_tgldiagnosa_ = scAjaxGetFieldText("tgldiagnosa_" + iNumLinha);
    var var_trancode_ = scAjaxGetFieldText("trancode_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_tbdiagnosarawatjalan_submit_form(var_kodeicdx_, var_namadiagnosa_, var_jenisdiagnosa_, var_keterangan_, var_tgldiagnosa_, var_trancode_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbdiagnosarawatjalan_submit_form_cb);
  } // do_ajax_form_tbdiagnosarawatjalan_submit_form

  function do_ajax_form_tbdiagnosarawatjalan_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("kodeicdx_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("namadiagnosa_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("jenisdiagnosa_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("keterangan_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("tgldiagnosa_" + sc_num_ult_line);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_tbdiagnosarawatjalan_submit_form_cb_after_alert);
  } // do_ajax_form_tbdiagnosarawatjalan_submit_form_cb
  function do_ajax_form_tbdiagnosarawatjalan_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbdiagnosarawatjalan_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tbdiagnosarawatjalan_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_tbdiagnosarawatjalan_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("kodeicdx_" + iNavForm);
      scAjaxHideErrorDisplay("namadiagnosa_" + iNavForm);
      scAjaxHideErrorDisplay("jenisdiagnosa_" + iNavForm);
      scAjaxHideErrorDisplay("keterangan_" + iNavForm);
      scAjaxHideErrorDisplay("tgldiagnosa_" + iNavForm);
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tbdiagnosarawatjalan_navigate_form(var_trancode_, var_jenisdiagnosa_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbdiagnosarawatjalan_navigate_form_cb);
  } // do_ajax_form_tbdiagnosarawatjalan_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbdiagnosarawatjalan']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbdiagnosarawatjalan_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.jenisdiagnosa_.value = scAjaxGetKeyValue("jenisdiagnosa_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbdiagnosarawatjalan_navigate_form_cb_after_alert);
  } // do_ajax_form_tbdiagnosarawatjalan_navigate_form_cb
  function do_ajax_form_tbdiagnosarawatjalan_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_tbdiagnosarawatjalan_navigate_form_cb_after_alert
  function sc_hide_form_tbdiagnosarawatjalan_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "kodeicdx_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "namadiagnosa_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "jenisdiagnosa_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "keterangan_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "tgldiagnosa_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "trancode_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["kodeicdx_" + iNumLinha] = {"label": "Kode ICDX<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["namadiagnosa_" + iNumLinha] = {"label": "Nama Diagnosa<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["jenisdiagnosa_" + iNumLinha] = {"label": "Jenis Diagnosa<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_error_list["tgldiagnosa_" + iNumLinha] = {"label": "Tgl Diagnosa<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_field_mult["kodeicdx_"][iNumLinha] = "kodeicdx_" + iNumLinha;
    ajax_field_mult["namadiagnosa_"][iNumLinha] = "namadiagnosa_" + iNumLinha;
    ajax_field_mult["jenisdiagnosa_"][iNumLinha] = "jenisdiagnosa_" + iNumLinha;
    ajax_field_mult["keterangan_"][iNumLinha] = "keterangan_" + iNumLinha;
    ajax_field_mult["tgldiagnosa_"][iNumLinha] = "tgldiagnosa_" + iNumLinha;
    ajax_field_mult["trancode_"][iNumLinha] = "trancode_" + iNumLinha;
    ajax_field_id["kodeicdx_" + iNumLinha] = new Array("hidden_field_label_kodeicdx_", "hidden_field_data_kodeicdx_" + iNumLinha);
    ajax_field_id["namadiagnosa_" + iNumLinha] = new Array("hidden_field_label_namadiagnosa_", "hidden_field_data_namadiagnosa_" + iNumLinha);
    ajax_field_id["jenisdiagnosa_" + iNumLinha] = new Array("hidden_field_label_jenisdiagnosa_", "hidden_field_data_jenisdiagnosa_" + iNumLinha);
    ajax_field_id["keterangan_" + iNumLinha] = new Array("hidden_field_label_keterangan_", "hidden_field_data_keterangan_" + iNumLinha);
    ajax_field_id["tgldiagnosa_" + iNumLinha] = new Array("hidden_field_label_tgldiagnosa_", "hidden_field_data_tgldiagnosa_" + iNumLinha);
    ajax_error_count["kodeicdx_" + iNumLinha] = "off";
    ajax_error_count["namadiagnosa_" + iNumLinha] = "off";
    ajax_error_count["jenisdiagnosa_" + iNumLinha] = "off";
    ajax_error_count["keterangan_" + iNumLinha] = "off";
    ajax_error_count["tgldiagnosa_" + iNumLinha] = "off";
    ajax_error_count["trancode_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["kodeicdx_" + iNumLinha] = "off";
    ajax_read_only["namadiagnosa_" + iNumLinha] = "off";
    ajax_read_only["jenisdiagnosa_" + iNumLinha] = "on";
    ajax_read_only["keterangan_" + iNumLinha] = "off";
    ajax_read_only["tgldiagnosa_" + iNumLinha] = "off";
...
{
?>
    ajax_read_only["kodeicdx_" + iNumLinha] = "on";
    ajax_read_only["namadiagnosa_" + iNumLinha] = "on";
    ajax_read_only["jenisdiagnosa_" + iNumLinha] = "on";
    ajax_read_only["keterangan_" + iNumLinha] = "on";
    ajax_read_only["tgldiagnosa_" + iNumLinha] = "on";
    ajax_read_only["trancode_" + iNumLinha] = "on";
<?php
}
?>
  ...
  {
    ajax_error_list["kodeicdx_" + iNumLinha] = null;
    ajax_error_list["namadiagnosa_" + iNumLinha] = null;
    ajax_error_list["jenisdiagnosa_" + iNumLinha] = null;
    ajax_error_list["keterangan_" + iNumLinha] = null;
    ajax_error_list["tgldiagnosa_" + iNumLinha] = null;
  ...
  var ajax_field_mult = {
    "kodeicdx_": new Array(),
    "namadiagnosa_": new Array(),
    "jenisdiagnosa_": new Array(),
    "keterangan_": new Array(),
    "tgldiagnosa_": new Array(),
    "trancode_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["kodeicdx_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["kodeicdx_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["kodeicdx_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["kodeicdx_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["kodeicdx_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["namadiagnosa_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["namadiagnosa_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["namadiagnosa_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["namadiagnosa_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["namadiagnosa_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["jenisdiagnosa_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["jenisdiagnosa_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["jenisdiagnosa_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["jenisdiagnosa_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["jenisdiagnosa_" + iNumLinha]["onfocus"] = new Array();
      ...
      ajax_error_list["tgldiagnosa_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["tgldiagnosa_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["tgldiagnosa_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["tgldiagnosa_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["tgldiagnosa_" + iNumLinha]["onfocus"] = new Array();
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['kodeicdx_'])) ? $this->nmgp_cmp_readonly['kodeicdx_'] : 'off';
?>
    scAjaxFieldRead("kodeicdx_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['namadiagnosa_'])) ? $this->nmgp_cmp_readonly['namadiagnosa_'] : 'off';
?>
    scAjaxFieldRead("namadiagnosa_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['jenisdiagnosa_'])) ? $this->nmgp_cmp_readonly['jenisdiagnosa_'] : 'on';
?>
    scAjaxFieldRead("jenisdiagnosa_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['tgldiagnosa_'])) ? $this->nmgp_cmp_readonly['tgldiagnosa_'] : 'off';
?>
    scAjaxFieldRead("tgldiagnosa_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
?>
  ...
  {
    scAjaxFieldRead("kodeicdx_" + iSeq, "on");
    scAjaxFieldRead("namadiagnosa_" + iSeq, "on");
    scAjaxFieldRead("jenisdiagnosa_" + iSeq, "on");
    scAjaxFieldRead("keterangan_" + iSeq, "on");
    scAjaxFieldRead("tgldiagnosa_" + iSeq, "on");
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["kodeicdx_" + iRow] || "on" == ajax_error_count["namadiagnosa_" + iRow] || "on" == ajax_error_count["jenisdiagnosa_" + iRow] || "on" == ajax_error_count["keterangan_" + iRow] || "on" == ajax_error_count["tgldiagnosa_" + iRow] || "on" == ajax_error_count["trancode_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_kodeicdx_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_namadiagnosa_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_jenisdiagnosa_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_keterangan_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_tgldiagnosa_" + iRow).addClass("scFormErrorLine");
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["kodeicdx_" + iRow] && "off" == ajax_error_count["namadiagnosa_" + iRow] && "off" == ajax_error_count["jenisdiagnosa_" + iRow] && "off" == ajax_error_count["keterangan_" + iRow] && "off" == ajax_error_count["tgldiagnosa_" + iRow] && "off" == ajax_error_count["trancode_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["kodeicdx_" + iRow] = "off";
        ajax_error_count["namadiagnosa_" + iRow] = "off";
        ajax_error_count["jenisdiagnosa_" + iRow] = "off";
        ajax_error_count["keterangan_" + iRow] = "off";
        ajax_error_count["tgldiagnosa_" + iRow] = "off";
      ...
      $("#hidden_field_data_kodeicdx_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_namadiagnosa_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_jenisdiagnosa_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_keterangan_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_tgldiagnosa_" + iRow).removeClass("scFormErrorLine");
